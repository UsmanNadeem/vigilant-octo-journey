; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/yacr2/main.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/yacr2/main.c"
...
for.body3:                                        ; preds = %for.body3.lr.ph, %for.body3
  ...
  %inc = add nuw i64 %net.097, 1
  %5 = load i64, ptr @channelNets, align 8, !tbaa !5
  %cmp2.not.not = icmp ult i64 %net.097, %5
  br i1 %cmp2.not.not, label %for.body3, label %do.body5.preheader, !llvm.loop !11
...
for.body25:                                       ; preds = %for.body25.lr.ph, %for.body25
  ...
  %inc29 = add nuw i64 %net.199, 1
  %11 = load i64, ptr @channelNets, align 8, !tbaa !5
  %cmp24.not.not = icmp ult i64 %net.199, %11
...
if.end34:                                         ; preds = %for.body25
  ...
  %or.cond = select i1 %tobool36.not, i1 true, i1 %cmp39.not100
...
for.inc47:                                        ; preds = %for.body40, %if.then43
  ...
  %inc48 = add nuw i64 %insert.0101, 1
  %cmp39.not.not = icmp ult i64 %insert.0101, %15
  br i1 %cmp39.not.not, label %for.body40, label %do.cond, !llvm.loop !14
