; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/load.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/load.c"
...
entry:
  ...
  %3 = load ptr, ptr %f_label, align 8, !tbaa !17
...
while.body:                                       ; preds = %if.end, %if.end22
  ...
  %6 = load ptr, ptr %l_next14, align 8, !tbaa !18
...
; Function Attrs: nounwind uwtable
define dso_local void @load_code(ptr noundef %code) local_unnamed_addr #0 {
entry:
...
long_val.exit:                                    ; preds = %while.body.i, %if.end.i295
  ...
  %53 = load ptr, ptr %f_label.i, align 8, !tbaa !17
...
while.body.i304:                                  ; preds = %if.end.i303, %if.end22.i
  ...
  %56 = load ptr, ptr %l_next14.i, align 8, !tbaa !18
