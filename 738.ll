; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/FreeBench/pcompress2/compress.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/FreeBench/pcompress2/compress.c"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1000, ptr nonnull %outname) #15
  call void @llvm.lifetime.start.p0(i64 144, ptr nonnull %buf) #15
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %filesize) #15
...
if.then:                                          ; preds = %entry
  ...
  %call = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str, ptr noundef %1) #16
...
if.end:                                           ; preds = %entry
  ...
  %call.i = call i32 @__xstat(i32 noundef 1, ptr noundef nonnull %2, ptr noundef nonnull %buf) #15
  ...
  %call3 = call ptr @fopen(ptr noundef nonnull %2, ptr noundef nonnull @.str.1)
...
if.then6:                                         ; preds = %if.end
  ...
  %call7 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %4, ptr noundef nonnull @.str.2, ptr noundef nonnull %2) #16
  call void @exit(i32 noundef 1) #17
  unreachable

if.end8:                                          ; preds = %if.end
  %call9 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %outname, ptr noundef nonnull dereferenceable(1) %2) #15
  ...
  %call13 = call ptr @fopen(ptr noundef nonnull %outname, ptr noundef nonnull @.str.4)
...
if.then16:                                        ; preds = %if.end8
  ...
  %6 = call i64 @fwrite(ptr nonnull @.str.5, i64 67, i64 1, ptr %5) #16
  call void @exit(i32 noundef 1) #17
  unreachable
...
if.end18:                                         ; preds = %if.end8
  ...
  %call22 = call noalias ptr @malloc(i64 noundef %conv20) #18
  store ptr %call22, ptr @in, align 8, !tbaa !5
  %conv23 = zext i32 %7 to i64
  %call25 = call noalias ptr @malloc(i64 noundef %conv23) #18
  store ptr %call25, ptr @bw, align 8, !tbaa !5
  %mul27 = shl nuw nsw i64 %conv23, 2
  %call28 = call noalias ptr @malloc(i64 noundef %mul27) #18
  store ptr %call28, ptr @rot, align 8, !tbaa !5
  %call32 = call noalias ptr @malloc(i64 noundef %conv20) #18
  store ptr %call32, ptr @rle, align 8, !tbaa !5
  %call36 = call noalias ptr @malloc(i64 noundef %conv20) #18
...
if.then44:                                        ; preds = %if.end18
  ...
  %16 = call i64 @fwrite(ptr nonnull @.str.6, i64 21, i64 1, ptr %15) #16
  call void @exit(i32 noundef 1) #17
  unreachable
...
if.end54:                                         ; preds = %if.end46
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %i.i) #15
...
for.body.i.preheader:                             ; preds = %if.end54
  ...
  br i1 %min.iters.check, label %for.body.i.preheader92, label %vector.ph
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %for.end.i, label %for.body.i.preheader92

for.body.i.preheader92:                           ; preds = %for.body.i.preheader, %middle.block
  %indvars.iv.i.ph = phi i64 [ 0, %for.body.i.preheader ], [ %n.vec, %middle.block ]
  br label %for.body.i

for.body.i:                                       ; preds = %for.body.i.preheader92, %for.body.i
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %for.body.i ], [ %indvars.iv.i.ph, %for.body.i.preheader92 ]
...
for.end.i:                                        ; preds = %for.body.i, %middle.block, %if.end54
  call void @qsort(ptr noundef %.pre.i, i64 noundef %conv23, i64 noundef 4, ptr noundef nonnull @compare) #15
...
if.then.i:                                        ; preds = %for.body19.i
  ...
  %call.i69 = call i64 @fwrite(ptr noundef nonnull %i.i, i64 noundef 4, i64 noundef 1, ptr noundef %41)
...
do_bwe.exit:                                      ; preds = %for.inc24.i, %if.then.i, %for.end.i
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %i.i) #15
...
for.body.i71:                                     ; preds = %if.end71.i, %for.body.lr.ph.i
  ...
  %arrayidx.i70 = getelementptr inbounds i8, ptr %45, i64 %idxprom.i
  %46 = load i8, ptr %arrayidx.i70, align 1, !tbaa !20
  br label %while.cond.i

while.cond.i:                                     ; preds = %while.body.i.2, %for.body.i71
  %indvars.iv.i72 = phi i64 [ 1, %for.body.i71 ], [ %indvars.iv.next.i74.2, %while.body.i.2 ]
  %47 = trunc i64 %indvars.iv.i72 to i32
  %add.i73 = add i32 %i.0126.i, %47
  %cmp1.i = icmp ult i32 %add.i73, %42
  br i1 %cmp1.i, label %land.rhs.i, label %while.end.i

land.rhs.i:                                       ; preds = %while.cond.i
  %idxprom3.i = zext i32 %add.i73 to i64
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  %49 = trunc i64 %indvars.iv.next.i74 to i32
  %add.i73.1 = add i32 %i.0126.i, %49
  %cmp1.i.1 = icmp ult i32 %add.i73.1, %42
  br i1 %cmp1.i.1, label %land.rhs.i.1, label %while.end.i

land.rhs.i.1:                                     ; preds = %while.body.i
  %idxprom3.i.1 = zext i32 %add.i73.1 to i64
  %arrayidx4.i.1 = getelementptr inbounds i8, ptr %45, i64 %idxprom3.i.1
  %50 = load i8, ptr %arrayidx4.i.1, align 1, !tbaa !20
  %cmp6.i.1 = icmp eq i8 %46, %50
...
while.body.i.1:                                   ; preds = %land.rhs.i.1
  ...
  %51 = trunc i64 %indvars.iv.next.i74.1 to i32
  %add.i73.2 = add i32 %i.0126.i, %51
  %cmp1.i.2 = icmp ult i32 %add.i73.2, %42
  br i1 %cmp1.i.2, label %land.rhs.i.2, label %while.end.i

land.rhs.i.2:                                     ; preds = %while.body.i.1
  %idxprom3.i.2 = zext i32 %add.i73.2 to i64
  %arrayidx4.i.2 = getelementptr inbounds i8, ptr %45, i64 %idxprom3.i.2
  %52 = load i8, ptr %arrayidx4.i.2, align 1, !tbaa !20
  %cmp6.i.2 = icmp eq i8 %46, %52
  br i1 %cmp6.i.2, label %while.body.i.2, label %while.end.i

while.body.i.2:                                   ; preds = %land.rhs.i.2
  %indvars.iv.next.i74.2 = add nuw nsw i64 %indvars.iv.i72, 3
  %exitcond.i.2 = icmp eq i64 %indvars.iv.next.i74.2, 127
...
while.end.i:                                      ; preds = %land.rhs.i.2, %while.body.i.1, %land.rhs.i.1, %while.body.i, %land.rhs.i, %while.cond.i
  %indvars.iv.i72.lcssa = phi i64 [ %indvars.iv.i72, %land.rhs.i ], [ %indvars.iv.i72, %while.cond.i ], [ %indvars.iv.next.i74, %while.body.i ], [ %indvars.iv.next.i74, %land.rhs.i.1 ], [ %indvars.iv.next.i74.1, %while.body.i.1 ], [ %indvars.iv.next.i74.1, %land.rhs.i.2 ]
  %53 = trunc i64 %indvars.iv.i72.lcssa to i32
  %cmp10.i = icmp eq i32 %53, 1
...
while.cond17.preheader.i:                         ; preds = %if.then12.i
  ...
  %54 = load i8, ptr %arrayidx24119.i, align 1, !tbaa !20
  %cmp26.not120.i = icmp eq i8 %46, %54
  br i1 %cmp26.not120.i, label %if.end44.i, label %land.rhs28.i

land.rhs28.i:                                     ; preds = %while.cond17.preheader.i, %while.body41.i
  %55 = phi i8 [ %58, %while.body41.i ], [ %54, %while.cond17.preheader.i ]
  ...
  %56 = load i8, ptr %arrayidx36.i, align 1, !tbaa !20
  %cmp38.not.i = icmp eq i8 %55, %56
...
while.body41.i:                                   ; preds = %land.rhs28.i
  ...
  %sub.i75 = add i32 %c.2121.i, %i.0126.i
  %idxprom19.i = zext i32 %sub.i75 to i64
  %arrayidx20.i = getelementptr inbounds i8, ptr %45, i64 %idxprom19.i
  %57 = load i8, ptr %arrayidx20.i, align 1, !tbaa !20
  %idxprom23.i = zext i32 %add18.i to i64
  %arrayidx24.i = getelementptr inbounds i8, ptr %45, i64 %idxprom23.i
  %58 = load i8, ptr %arrayidx24.i, align 1, !tbaa !20
  %cmp26.not.i = icmp eq i8 %57, %58
...
if.end44.i:                                       ; preds = %while.body41.i, %land.rhs28.i, %while.cond17.preheader.i, %if.then12.i
  ...
  %59 = trunc i32 %c.3.i to i8
  %conv47.i = and i8 %59, 127
  %60 = load ptr, ptr @rle, align 8, !tbaa !5
  %inc48.i = add i32 %rlepos.0125.i, 1
  %idxprom49.i = zext i32 %rlepos.0125.i to i64
  %arrayidx50.i = getelementptr inbounds i8, ptr %60, i64 %idxprom49.i
  store i8 %conv47.i, ptr %arrayidx50.i, align 1, !tbaa !20
  %61 = load ptr, ptr @rle, align 8, !tbaa !5
  %idx.ext.i76 = zext i32 %inc48.i to i64
  %add.ptr.i77 = getelementptr inbounds i8, ptr %61, i64 %idx.ext.i76
  %62 = load ptr, ptr @bw, align 8, !tbaa !5
  %add.ptr52.i = getelementptr inbounds i8, ptr %62, i64 %idxprom.i
  %conv53.i = zext i32 %c.3.i to i64
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %add.ptr.i77, ptr align 1 %add.ptr52.i, i64 %conv53.i, i1 false)
  %add54.i = add i32 %c.3.i, %inc48.i
  br label %if.end71.i

if.else.i:                                        ; preds = %while.body.i.2, %while.end.i
  %c.1110.i = phi i32 [ %53, %while.end.i ], [ 127, %while.body.i.2 ]
...
if.then59.i:                                      ; preds = %if.else.i
  ...
  %call.i78 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %63, ptr noundef nonnull @.str.8, i32 noundef %42) #16
  call void @exit(i32 noundef 1) #17
  unreachable

if.end60.i:                                       ; preds = %if.else.i
  %64 = trunc i32 %c.1110.i to i8
  %conv63.i = or i8 %64, -128
  %65 = load ptr, ptr @rle, align 8, !tbaa !5
  %idxprom64.i = zext i32 %rlepos.0125.i to i64
  %arrayidx65.i = getelementptr inbounds i8, ptr %65, i64 %idxprom64.i
  ...
  %arrayidx68.i = getelementptr inbounds i8, ptr %66, i64 %idxprom67.i
...
if.end71.i:                                       ; preds = %if.end60.i, %if.end44.i
  ...
  br i1 %cmp.i, label %for.body.i71, label %do_rle.exit, !llvm.loop !25

do_rle.exit:                                      ; preds = %if.end71.i, %do_bwe.exit
  %rlepos.0.lcssa.i = phi i32 [ 0, %do_bwe.exit ], [ %rlepos.1.i, %if.end71.i ]
  %67 = load ptr, ptr @bw, align 8, !tbaa !5
  call void @free(ptr noundef %67) #15
  %call56 = call i32 @do_ari(i32 noundef %rlepos.0.lcssa.i) #15
  %68 = load ptr, ptr @rle, align 8, !tbaa !5
  call void @free(ptr noundef %68) #15
  %69 = load ptr, ptr @ari, align 8, !tbaa !5
  %conv57 = zext i32 %call56 to i64
  %70 = load ptr, ptr @fpo, align 8, !tbaa !5
  %call58 = call i64 @fwrite(ptr noundef %69, i64 noundef 1, i64 noundef %conv57, ptr noundef %70)
  %71 = load ptr, ptr @ari, align 8, !tbaa !5
  call void @free(ptr noundef %71) #15
  %72 = load ptr, ptr @fpi, align 8, !tbaa !5
  %call59 = call i32 @fclose(ptr noundef %72)
  %73 = load ptr, ptr @fpo, align 8, !tbaa !5
  %call60 = call i32 @fclose(ptr noundef %73)
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %filesize) #15
  call void @llvm.lifetime.end.p0(i64 144, ptr nonnull %buf) #15
  call void @llvm.lifetime.end.p0(i64 1000, ptr nonnull %outname) #15
  ret void
}
...
define internal i32 @compare(ptr nocapture noundef readonly %a, ptr nocapture noundef readonly %b) #11 {
entry:
  ...
  %call = tail call i32 @memcmp(ptr noundef %add.ptr, ptr noundef %add.ptr2, i64 noundef %conv) #19
  ret i32 %call
}
