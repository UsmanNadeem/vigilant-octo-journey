; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_blob.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_blob.c"
...
if.end4:                                          ; preds = %if.end
  ...
  br i1 %cmp5, label %cleanup, label %blobGetData.exit27

blobGetData.exit27:                               ; preds = %if.end4
...
cleanup:                                          ; preds = %if.end4, %if.end, %entry, %blobGetData.exit27
  %retval.0 = phi i32 [ %call11, %blobGetData.exit27 ], [ 0, %entry ], [ 1, %if.end ], [ 0, %if.end4 ]
  ret i32 %retval.0
}
...
if.end27:                                         ; preds = %blobSetFilename.exit, %if.end18
  ...
  %call29 = call ptr @fdopen(i32 noundef %fd.090, ptr noundef nonnull @.str.22) #14
...
if.then43:                                        ; preds = %if.end40
  ...
  %call47 = call i32 @fileblobAddData(ptr noundef nonnull %fb, ptr noundef nonnull %7, i64 noundef %8)
...
if.then20:                                        ; preds = %if.end14
  ...
  %5 = load ptr, ptr %scanned, align 8, !tbaa !36
...
if.then22:                                        ; preds = %if.then20
  ...
  %add = add i64 %6, %div80
  store i64 %add, ptr %5, align 8, !tbaa !37
  %.pre83 = load i64, ptr %bytes_scanned15, align 8, !tbaa !32
  br label %if.end24

if.end24:                                         ; preds = %if.then22, %if.then20
  %7 = phi i64 [ %.pre83, %if.then22 ], [ %.pre, %if.then20 ]
  %add26 = add i64 %7, %len
  store i64 %add26, ptr %bytes_scanned15, align 8, !tbaa !32
...
land.lhs.true:                                    ; preds = %if.end24
  ...
  %9 = load ptr, ptr %engine, align 8, !tbaa !39
...
!29 = !{!11, !11, i64 0}
!30 = !{!31, !7, i64 32}
!31 = !{!"", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !7, i64 32, !11, i64 40, !11, i64 44, !11, i64 48, !11, i64 52, !7, i64 56}
!32 = !{!23, !10, i64 64}
!33 = !{!34, !10, i64 24}
!34 = !{!"cl_limits", !11, i64 0, !11, i64 4, !11, i64 8, !11, i64 12, !35, i64 16, !10, i64 24}
!35 = !{!"short", !8, i64 0}
!36 = !{!31, !7, i64 8}
!37 = !{!10, !10, i64 0}
!38 = !{!31, !7, i64 0}
