; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/print.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/print.c"
...
for.end:                                          ; preds = %for.body23, %while.end
  ...
  %call28 = tail call i32 @_IO_putc(i32 noundef 46, ptr noundef %18)
...
while.end38:                                      ; preds = %while.body33, %for.end
  ...
  %26 = load ptr, ptr @foutput, align 8, !tbaa !8
  %call40 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %26)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.end42:                                        ; preds = %while.end38, %for.cond.preheader
  ...
  %call43 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %27)
  br label %cleanup
...
if.then26:                                        ; preds = %for.end
  ...
  %call27 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %15)
  br label %if.end29
...
if.then54:                                        ; preds = %for.inc49
  %21 = load ptr, ptr @foutput, align 8, !tbaa !8
  %call55 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %21)
  br label %if.end58
...
for.end104:                                       ; preds = %for.inc102
  ...
  %call105 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %37)
  br label %cleanup
