; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20040703-1.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20040703-1.c"
...
if.else3.i:                                       ; preds = %num_trim.exit
  ...
  br i1 %cmp4.i, label %if.end19.i.thread98, label %if.else9.i

if.end19.i.thread98:                              ; preds = %if.else3.i
  %shl.i = shl nsw i32 %..i, %precision
  %or.i = or i32 %shl.i, %num.sroa.0.sroa.5.1.i
  %num.sroa.0.sroa.14.1.i103 = select i1 %cmp4, i32 %..i, i32 %or.i
  %6 = tail call i32 @llvm.fshr.i32(i32 %..i, i32 %num.sroa.0.sroa.14.1.i103, i32 %m.0)
...
if.end19.i:                                       ; preds = %if.else9.i
  %sub.i90 = add nsw i32 %precision, -32
  %shl15.i = shl nsw i32 %..i, %sub.i90
  %or17.i = or i32 %shl15.i, %num.sroa.0.sroa.0.0.i
  %num.sroa.0.sroa.0.0.i91.fr = freeze i32 %or17.i
  %num.sroa.0.sroa.0.1.i = select i1 %cmp4, i32 %..i, i32 %num.sroa.0.sroa.0.0.i91.fr
  %num.sroa.0.sroa.14.1.i = select i1 %cmp4, i32 %num.sroa.0.sroa.0.0.i91.fr, i32 %num.sroa.0.sroa.5.1.i
...
if.then.i.i:                                      ; preds = %if.else9.i
  %num.sroa.0.sroa.0.1.i96 = select i1 %cmp4, i32 %..i, i32 %num.sroa.0.sroa.0.0.i
  %num.sroa.0.sroa.14.1.i97 = select i1 %cmp4, i32 %num.sroa.0.sroa.0.0.i, i32 %num.sroa.0.sroa.5.1.i
  %8 = tail call i32 @llvm.fshr.i32(i32 %..i, i32 %num.sroa.0.sroa.0.1.i96, i32 %m.0)
  %9 = tail call i32 @llvm.fshr.i32(i32 %num.sroa.0.sroa.0.1.i96, i32 %num.sroa.0.sroa.14.1.i97, i32 %m.0)
...
if.then7.i.i:                                     ; preds = %if.end19.i
  ...
  %sub.i.i104 = add nsw i32 %precision, -32
  %notmask25.i.i = shl nsw i32 -1, %sub.i.i104
  %sub8.i.i = xor i32 %notmask25.i.i, -1
  %and.i.i = and i32 %10, %sub8.i.i
  br label %num_rshift.exit

if.else.i.i:                                      ; preds = %if.end19.i.thread98, %if.end19.i
  %11 = phi i32 [ %6, %if.end19.i.thread98 ], [ %7, %if.end19.i ]
...
num_rshift.exit:                                  ; preds = %if.then.i.i, %if.then7.i.i, %if.else.i.i
  ...
  %num.sroa.19.12.insert.shift69 = select i1 %.not, i64 4294967296, i64 0
  br label %if.end43

if.end43:                                         ; preds = %num_trim.exit, %num_rshift.exit, %if.then
  %num.sroa.19.1 = phi i64 [ %num.sroa.19.12.insert.insert, %if.then ], [ %num.sroa.19.12.insert.shift69, %num_rshift.exit ], [ %3, %num_trim.exit ]
  %num.sroa.0.sroa.0.0.insert.insert78 = phi i64 [ 0, %if.then ], [ %num.sroa.0.sroa.0.0.insert.insert.i, %num_rshift.exit ], [ %num.sroa.0.sroa.0.0.insert.insert.i, %num_trim.exit ]
  %.fca.0.insert = insertvalue { i64, i64 } poison, i64 %num.sroa.0.sroa.0.0.insert.insert78, 0
...
if.else3.i.i:                                     ; preds = %if.else.i
  ...
  %num.sroa.0.sroa.0.1.i96.i = select i1 %cmp4.i, i32 %.fr.lobit, i32 %.fr
  %num.sroa.0.sroa.14.1.i97.i = select i1 %cmp4.i, i32 %.fr, i32 %shl21.i
  %5 = tail call i32 @llvm.fshr.i32(i32 %.fr.lobit, i32 %num.sroa.0.sroa.0.1.i96.i, i32 %m.0.i)
  %6 = tail call i32 @llvm.fshr.i32(i32 %num.sroa.0.sroa.0.1.i96.i, i32 %num.sroa.0.sroa.14.1.i97.i, i32 %m.0.i)
  ...
  %num.sroa.19.12.insert.shift69.i = select i1 %.not.i, i64 4294967296, i64 0
  br label %num_lshift.exit

num_lshift.exit:                                  ; preds = %if.else.i, %if.else3.i.i
  %num.sroa.19.1.i = phi i64 [ %num.sroa.19.12.insert.shift69.i, %if.else3.i.i ], [ %4, %if.else.i ]
