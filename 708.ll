; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/zlib_inflate.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/zlib_inflate.c"
...
cleanup:                                          ; preds = %if.end.i, %lor.lhs.false6.i, %entry, %lor.lhs.false.i, %lor.lhs.false2.i, %inflateStateCheck.exit, %if.end5
...
define dso_local i32 @inflateReset(ptr noundef %strm) local_unnamed_addr #2 {
entry:
  %cmp.i = icmp eq ptr %strm, null
  br i1 %cmp.i, label %cleanup, label %lor.lhs.false.i
...
if.end.i7:                                        ; preds = %inflateStateCheck.exit
...
cleanup:                                          ; preds = %if.end.i, %lor.lhs.false6.i, %entry, %lor.lhs.false.i, %lor.lhs.false2.i, %if.end5.i, %inflateStateCheck.exit
  %retval.0 = phi i32 [ -2, %inflateStateCheck.exit ], [ 0, %if.end5.i ], [ -2, %lor.lhs.false2.i ], [ -2, %lor.lhs.false.i ], [ -2, %entry ], [ -2, %lor.lhs.false6.i ], [ -2, %if.end.i ]
  ret i32 %retval.0
}

; Function Attrs: nounwind uwtable
define dso_local i32 @inflateReset2(ptr noundef %strm, i32 noundef %windowBits) local_unnamed_addr #3 {
entry:
  %cmp.i = icmp eq ptr %strm, null
  br i1 %cmp.i, label %cleanup, label %lor.lhs.false.i
...
lor.lhs.false.i.i.thread:                         ; preds = %if.end11, %land.lhs.true13
  %wrap1946 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 3
  store i32 %wrap.0, ptr %wrap1946, align 8, !tbaa !19
  %wbits2047 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 10
  store i32 %windowBits.addr.0, ptr %wbits2047, align 8, !tbaa !36
...
lor.lhs.false6.i.i:                               ; preds = %if.end.i.i
  ...
  br i1 %cmp8.not.i.i, label %inflateStateCheck.exit.i, label %cleanup
...
if.end.i7.i:                                      ; preds = %inflateStateCheck.exit.i
...
cleanup:                                          ; preds = %if.end.i, %lor.lhs.false6.i, %entry, %lor.lhs.false.i, %lor.lhs.false2.i, %if.end5.i.i, %inflateStateCheck.exit.i, %lor.lhs.false6.i.i, %if.end.i.i, %lor.lhs.false2.i.i, %lor.lhs.false.i.i, %if.end6, %inflateStateCheck.exit
  %retval.0 = phi i32 [ -2, %inflateStateCheck.exit ], [ -2, %if.end6 ], [ -2, %inflateStateCheck.exit.i ], [ 0, %if.end5.i.i ], [ -2, %lor.lhs.false2.i.i ], [ -2, %lor.lhs.false.i.i ], [ -2, %lor.lhs.false6.i.i ], [ -2, %if.end.i.i ], [ -2, %lor.lhs.false2.i ], [ -2, %lor.lhs.false.i ], [ -2, %entry ], [ -2, %lor.lhs.false6.i ], [ -2, %if.end.i ]
  ret i32 %retval.0
}

; Function Attrs: nounwind uwtable
define dso_local i32 @inflateInit2_(ptr noundef %strm, i32 noundef %windowBits, ptr noundef readonly %version, i32 noundef %stream_size) local_unnamed_addr #3 {
entry:
...
if.end26:                                         ; preds = %if.end20
  ...
  %call29 = tail call i32 @inflateReset2(ptr noundef nonnull %strm, i32 noundef %windowBits)
...
declare ptr @zcalloc(ptr noundef, i32 noundef, i32 noundef) #4

declare void @zcfree(ptr noundef, ptr noundef) #4

; Function Attrs: nounwind uwtable
define dso_local i32 @inflateInit_(ptr noundef %strm, ptr noundef readonly %version, i32 noundef %stream_size) local_unnamed_addr #3 {
entry:
...
if.end26.i:                                       ; preds = %if.end20.i
  ...
  store i32 16180, ptr %mode.i, align 8, !tbaa !16
  %call29.i = tail call i32 @inflateReset2(ptr noundef nonnull %strm, i32 noundef 15)
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none) uwtable
define dso_local i32 @inflatePrime(ptr noundef readonly %strm, i32 noundef %bits, i32 noundef %value) local_unnamed_addr #0 {
entry:
  %cmp.i = icmp eq ptr %strm, null
  br i1 %cmp.i, label %cleanup, label %lor.lhs.false.i
...
cleanup:                                          ; preds = %if.end.i, %lor.lhs.false6.i, %entry, %lor.lhs.false.i, %lor.lhs.false2.i, %if.end4, %lor.lhs.false, %inflateStateCheck.exit, %if.end9, %if.then2
  %retval.0 = phi i32 [ 0, %if.then2 ], [ 0, %if.end9 ], [ -2, %inflateStateCheck.exit ], [ -2, %lor.lhs.false ], [ -2, %if.end4 ], [ -2, %lor.lhs.false2.i ], [ -2, %lor.lhs.false.i ], [ -2, %entry ], [ -2, %lor.lhs.false6.i ], [ -2, %if.end.i ]
  ret i32 %retval.0
}

; Function Attrs: nounwind uwtable
define dso_local i32 @inflate(ptr noundef %strm, i32 noundef %flush) local_unnamed_addr #3 {
entry:
...
do.body:                                          ; preds = %if.end, %if.then6
  ...
  %10 = load i32, ptr %avail_out, align 8, !tbaa !43
  %avail_in11 = getelementptr inbounds %struct.z_stream_s, ptr %strm, i64 0, i32 1
  %11 = load i32, ptr %avail_in11, align 8, !tbaa !42
...
for.cond:                                         ; preds = %sw.epilog1881, %do.body
  ...
  %put.04458 = ptrtoint ptr %put.0 to i64
  switch i32 %15, label %cleanup [
    ...
    i32 16208, label %do.body1882.loopexit4487
    i32 16209, label %do.body1882
    i32 16210, label %cleanup.loopexit
  ]

for.cond.sw.bb1621_crit_edge:                     ; preds = %for.cond
  %.pre3962 = load i32, ptr %extra1447, align 4, !tbaa !44
  br label %sw.bb1621

for.cond.sw.bb1449_crit_edge:                     ; preds = %for.cond
  %.pre3959 = load i32, ptr %extra1447, align 4, !tbaa !44
  br label %sw.bb1449

for.cond.sw.bb979_crit_edge:                      ; preds = %for.cond
  %have981.promoted3457.pre = load i32, ptr %have904, align 4, !tbaa !45
  br label %sw.bb979

for.cond.sw.bb1835_crit_edge:                     ; preds = %for.cond
  %.pre3954 = load i32, ptr %wrap1747, align 8, !tbaa !19
  br label %sw.bb1835

while.cond848.preheader:                          ; preds = %for.cond
  %cmp8493375 = icmp ult i32 %bits.0, 14
  br i1 %cmp8493375, label %do.body852.preheader, label %do.end868

do.body852.preheader:                             ; preds = %while.cond848.preheader
  %16 = zext i32 %bits.0 to i64
  %cmp853 = icmp eq i32 %have.0, 0
  br i1 %cmp853, label %do.body1882.loopexit3672.split.loop.exit4939, label %if.end856

while.cond634.preheader:                          ; preds = %for.cond
  %cmp6353586 = icmp ult i32 %bits.0, 32
  br i1 %cmp6353586, label %do.body638.preheader, label %do.end654

do.body638.preheader:                             ; preds = %while.cond634.preheader
  %17 = zext i32 %bits.0 to i64
  %cmp639 = icmp eq i32 %have.0, 0
  br i1 %cmp639, label %do.body1882.loopexit3663.split.loop.exit4989, label %if.end642

while.cond117.preheader:                          ; preds = %for.cond
  %cmp1183603 = icmp ult i32 %bits.0, 16
  br i1 %cmp1183603, label %do.body121.preheader, label %do.end137

do.body121.preheader:                             ; preds = %while.cond117.preheader
  %18 = zext i32 %bits.0 to i64
  %cmp122 = icmp eq i32 %have.0, 0
  br i1 %cmp122, label %do.body1882.loopexit3662.split.loop.exit4998, label %if.end125
...
while.cond.preheader:                             ; preds = %sw.bb
  %cmp203645 = icmp ult i32 %bits.0, 16
  br i1 %cmp203645, label %do.body21.preheader, label %do.end29

do.body21.preheader:                              ; preds = %while.cond.preheader
  %20 = zext i32 %bits.0 to i64
  %cmp22 = icmp eq i32 %have.0, 0
  br i1 %cmp22, label %do.body1882.loopexit3657.split.loop.exit4930, label %if.end24
...
if.end24:                                         ; preds = %do.body21.preheader
  ...
  %indvars.iv.next3951 = add nuw nsw i64 %20, 8
  %cmp20 = icmp ult i32 %bits.0, 8
  br i1 %cmp20, label %do.body21.1, label %do.end29.loopexit, !llvm.loop !46

do.body21.1:                                      ; preds = %if.end24
  %cmp22.1 = icmp eq i32 %dec, 0
  br i1 %cmp22.1, label %do.body1882.loopexit3657, label %if.end24.1
...
if.end24.1:                                       ; preds = %do.body21.1
  ...
  %shl.1 = shl nuw nsw i64 %conv.1, %indvars.iv.next3951
  %add.1 = add i64 %shl.1, %add
  %indvars.iv.next3951.1 = add nuw nsw i64 %20, 16
...
do.end29.loopexit:                                ; preds = %if.end24.1, %if.end24
  ...
  %indvars.iv.next3951.lcssa = phi i64 [ %indvars.iv.next3951, %if.end24 ], [ %indvars.iv.next3951.1, %if.end24.1 ]
  %23 = trunc i64 %indvars.iv.next3951.lcssa to i32
  br label %do.end29
...
if.end40:                                         ; preds = %if.then38, %if.then35
  ...
  store i64 %call41, ptr %check1786, align 8, !tbaa !48
  ...
  store i64 %call47, ptr %check1786, align 8, !tbaa !48
  store i32 16181, ptr %mode.i, align 8, !tbaa !16
  br label %sw.epilog1881

if.end55:                                         ; preds = %do.end29
  store i32 0, ptr %flags1783, align 8, !tbaa !49
...
if.then58:                                        ; preds = %if.end55
  ...
  store i32 -1, ptr %done, align 8, !tbaa !50
  br label %if.end60
...
if.end74:                                         ; preds = %lor.lhs.false64
  %and762902 = and i64 %hold.1.lcssa, 15
  %cmp77.not = icmp eq i64 %and762902, 8
...
if.end95:                                         ; preds = %if.then93, %do.body83
  ...
  %or.cond4241 = select i1 %cmp96, i1 true, i1 %cmp100
  br i1 %or.cond4241, label %if.then102, label %if.end105
...
if.end105:                                        ; preds = %if.end95
  ...
  store i64 %call107, ptr %check1786, align 8, !tbaa !48
...
if.end125:                                        ; preds = %do.body121.preheader
  ...
  %indvars.iv.next3930 = add nuw nsw i64 %18, 8
  %cmp118 = icmp ult i32 %bits.0, 8
  br i1 %cmp118, label %do.body121.1, label %do.end137.loopexit, !llvm.loop !52

do.body121.1:                                     ; preds = %if.end125
  %cmp122.1 = icmp eq i32 %dec126, 0
  br i1 %cmp122.1, label %do.body1882.loopexit3662, label %if.end125.1
...
if.end125.1:                                      ; preds = %do.body121.1
  ...
  %shl130.1 = shl nuw nsw i64 %conv128.1, %indvars.iv.next3930
  %add131.1 = add i64 %shl130.1, %add131
  %indvars.iv.next3930.1 = add nuw nsw i64 %18, 16
...
do.end137.loopexit:                               ; preds = %if.end125.1, %if.end125
  ...
  %indvars.iv.next3930.lcssa = phi i64 [ %indvars.iv.next3930, %if.end125 ], [ %indvars.iv.next3930.1, %if.end125.1 ]
  %31 = trunc i64 %indvars.iv.next3930.lcssa to i32
  br label %do.end137
...
do.end137:                                        ; preds = %do.end137.loopexit, %while.cond117.preheader
  ...
  store i32 %conv138, ptr %flags1783, align 8, !tbaa !49
...
if.then158:                                       ; preds = %if.end154
  ...
  store i32 %conv161, ptr %32, align 8, !tbaa !53
  br label %if.end163
...
do.body172:                                       ; preds = %land.lhs.true167
  ...
  %35 = load i64, ptr %check1786, align 8, !tbaa !48
  %call180 = call i64 @crc32(i64 noundef %35, ptr noundef nonnull %hbuf, i32 noundef 2) #10
  store i64 %call180, ptr %check1786, align 8, !tbaa !48
...
do.body190:                                       ; preds = %for.cond
  %cmp1923612 = icmp ult i32 %bits.0, 32
  br i1 %cmp1923612, label %do.body195.preheader, label %do.end211
...
do.body195.preheader:                             ; preds = %do.body190.thread, %do.body190
  ...
  br i1 %cmp196, label %do.body1882.loopexit3661.split.loop.exit5039, label %if.end199
...
if.end199:                                        ; preds = %do.body195.preheader
  ...
  %indvars.iv.next3933 = add nuw nsw i64 %36, 8
  %cmp192 = icmp ult i32 %bits.33975, 24
  br i1 %cmp192, label %do.body195.1, label %do.end211, !llvm.loop !54

do.body195.1:                                     ; preds = %if.end199
  %cmp196.1 = icmp eq i32 %dec200, 0
  br i1 %cmp196.1, label %do.body1882.loopexit3661, label %if.end199.1
...
if.end199.1:                                      ; preds = %do.body195.1
  ...
  %shl204.1 = shl nuw nsw i64 %conv202.1, %indvars.iv.next3933
  %add205.1 = add i64 %shl204.1, %add205
  %indvars.iv.next3933.1 = add nuw nsw i64 %36, 16
  %cmp192.1 = icmp ult i32 %bits.33975, 16
  br i1 %cmp192.1, label %do.body195.2, label %do.end211, !llvm.loop !54

do.body195.2:                                     ; preds = %if.end199.1
  %cmp196.2 = icmp eq i32 %dec200.1, 0
  br i1 %cmp196.2, label %do.body1882.loopexit3661, label %if.end199.2
...
if.end199.2:                                      ; preds = %do.body195.2
  ...
  %shl204.2 = shl nuw nsw i64 %conv202.2, %indvars.iv.next3933.1
  %add205.2 = add i64 %shl204.2, %add205.1
  %indvars.iv.next3933.2 = add nuw nsw i64 %36, 24
  %cmp192.2 = icmp ult i32 %bits.33975, 8
  br i1 %cmp192.2, label %do.body195.3, label %do.end211, !llvm.loop !54

do.body195.3:                                     ; preds = %if.end199.2
  %cmp196.3 = icmp eq i32 %dec200.2, 0
  br i1 %cmp196.3, label %do.body1882.loopexit3661, label %if.end199.3
...
if.end199.3:                                      ; preds = %do.body195.3
  ...
  %shl204.3 = shl nuw nsw i64 %conv202.3, %indvars.iv.next3933.2
...
if.then215:                                       ; preds = %do.end211
  ...
  store i64 %hold.4.lcssa, ptr %time, align 8, !tbaa !55
  br label %if.end217

if.end217:                                        ; preds = %if.then215, %do.end211
  %42 = load i32, ptr %flags1783, align 8, !tbaa !49
...
do.body226:                                       ; preds = %land.lhs.true221
  ...
  %44 = load i64, ptr %check1786, align 8, !tbaa !48
  %call240 = call i64 @crc32(i64 noundef %44, ptr noundef nonnull %hbuf, i32 noundef 4) #10
  store i64 %call240, ptr %check1786, align 8, !tbaa !48
...
do.body250:                                       ; preds = %for.cond
  %cmp2523620 = icmp ult i32 %bits.0, 16
  br i1 %cmp2523620, label %do.body255.preheader, label %do.end271
...
do.body255.preheader:                             ; preds = %do.body250.thread, %do.body250
  ...
  br i1 %cmp256, label %do.body1882.loopexit3660.split.loop.exit5015, label %if.end259
...
if.end259:                                        ; preds = %do.body255.preheader
  ...
  %indvars.iv.next3936 = add nuw nsw i64 %45, 8
  %cmp252 = icmp ult i32 %bits.53984, 8
  br i1 %cmp252, label %do.body255.1, label %do.end271, !llvm.loop !56

do.body255.1:                                     ; preds = %if.end259
  %cmp256.1 = icmp eq i32 %dec260, 0
  br i1 %cmp256.1, label %do.body1882.loopexit3660, label %if.end259.1
...
if.end259.1:                                      ; preds = %do.body255.1
  ...
  %shl264.1 = shl nuw nsw i64 %conv262.1, %indvars.iv.next3936
...
if.then275:                                       ; preds = %do.end271
  ...
  store i32 %conv277, ptr %xflags, align 8, !tbaa !57
  ...
  store i32 %conv280, ptr %os, align 4, !tbaa !58
  br label %if.end282

if.end282:                                        ; preds = %if.then275, %do.end271
  %50 = load i32, ptr %flags1783, align 8, !tbaa !49
...
do.body291:                                       ; preds = %land.lhs.true286
  ...
  %52 = load i64, ptr %check1786, align 8, !tbaa !48
  %call299 = call i64 @crc32(i64 noundef %52, ptr noundef nonnull %hbuf, i32 noundef 2) #10
  store i64 %call299, ptr %check1786, align 8, !tbaa !48
  br label %sw.bb308.thread

sw.bb308:                                         ; preds = %for.cond
  %53 = load i32, ptr %flags1783, align 8, !tbaa !49
...
sw.bb308.thread:                                  ; preds = %do.body291, %land.lhs.true286, %if.end282
  ...
  %54 = load i32, ptr %flags1783, align 8, !tbaa !49
...
while.cond314.preheader:                          ; preds = %sw.bb308
  %cmp3153628 = icmp ult i32 %bits.0, 16
  br i1 %cmp3153628, label %do.body318.preheader, label %do.end334
...
do.body318.preheader:                             ; preds = %sw.bb308.thread, %while.cond314.preheader
  ...
  br i1 %cmp319, label %do.body1882.loopexit3659.split.loop.exit5007, label %if.end322
...
if.end322:                                        ; preds = %do.body318.preheader
  ...
  %indvars.iv.next3939 = add nuw nsw i64 %56, 8
  %cmp315 = icmp ult i32 %bits.739984004, 8
  br i1 %cmp315, label %do.body318.1, label %do.end334, !llvm.loop !59

do.body318.1:                                     ; preds = %if.end322
  %cmp319.1 = icmp eq i32 %dec323, 0
  br i1 %cmp319.1, label %do.body1882.loopexit3659, label %if.end322.1
...
if.end322.1:                                      ; preds = %do.body318.1
  ...
  %shl327.1 = shl nuw nsw i64 %conv325.1, %indvars.iv.next3939
...
do.end334:                                        ; preds = %if.end322, %if.end322.1, %while.cond314.preheader
  ...
  store i32 %conv335, ptr %length1741, align 4, !tbaa !60
...
if.then339:                                       ; preds = %do.end334
  ...
  store i32 %conv335, ptr %extra_len, align 8, !tbaa !61
  br label %if.end342
...
do.body351:                                       ; preds = %land.lhs.true346
  ...
  %62 = load i64, ptr %check1786, align 8, !tbaa !48
  %call359 = call i64 @crc32(i64 noundef %62, ptr noundef nonnull %hbuf, i32 noundef 2) #10
  store i64 %call359, ptr %check1786, align 8, !tbaa !48
  br label %if.end373
...
if.then370:                                       ; preds = %if.else
  ...
  store ptr null, ptr %extra, align 8, !tbaa !62
  br label %if.end373
...
sw.bb375:                                         ; preds = %for.cond, %if.end373
  ...
  %64 = load i32, ptr %flags1783, align 8, !tbaa !49
...
if.then379:                                       ; preds = %sw.bb375
  %65 = load i32, ptr %length1741, align 4, !tbaa !60
...
land.lhs.true390:                                 ; preds = %if.then386
  ...
  %67 = load ptr, ptr %extra392, align 8, !tbaa !62
...
if.then395:                                       ; preds = %land.lhs.true390
  ...
  %68 = load i32, ptr %extra_len397, align 8, !tbaa !61
  ...
  %69 = load i32, ptr %extra_max, align 4, !tbaa !63
  ...
  %.pre3963 = load i32, ptr %flags1783, align 8, !tbaa !49
  br label %if.end411

if.end411:                                        ; preds = %if.then395, %land.lhs.true390, %if.then386
  %70 = phi i32 [ %.pre3963, %if.then395 ], [ %64, %land.lhs.true390 ], [ %64, %if.then386 ]
...
if.then419:                                       ; preds = %land.lhs.true415
  %72 = load i64, ptr %check1786, align 8, !tbaa !48
  %call421 = call i64 @crc32(i64 noundef %72, ptr noundef %next.10, i32 noundef %spec.select) #10
  store i64 %call421, ptr %check1786, align 8, !tbaa !48
  br label %if.end423
...
if.end423:                                        ; preds = %if.then419, %land.lhs.true415, %if.end411
  ...
  %73 = load i32, ptr %length1741, align 4, !tbaa !60
  %sub428 = sub i32 %73, %spec.select
  store i32 %sub428, ptr %length1741, align 4, !tbaa !60
  br label %if.end429
...
if.end429:                                        ; preds = %if.end423, %if.then379
  ...
  br i1 %tobool431.not, label %if.end434, label %do.body1882.loopexit4487
...
if.end434:                                        ; preds = %if.end429, %sw.bb375
  ...
  store i32 0, ptr %length1741, align 4, !tbaa !60
...
sw.bb437:                                         ; preds = %for.cond, %if.end434
  ...
  %75 = load i32, ptr %flags1783, align 8, !tbaa !49
...
if.then441:                                       ; preds = %sw.bb437
  ...
  br i1 %cmp442, label %do.body1882.loopexit4487, label %do.body446.preheader
...
do.body446:                                       ; preds = %do.body446.preheader, %do.cond470
  %indvars.iv3941 = phi i64 [ 0, %do.body446.preheader ], [ %indvars.iv.next3942, %do.cond470 ]
  %indvars.iv.next3942 = add nuw nsw i64 %indvars.iv3941, 1
  %arrayidx447 = getelementptr inbounds i8, ptr %next.13, i64 %indvars.iv3941
...
land.lhs.true452:                                 ; preds = %do.body446
  ...
  %79 = load ptr, ptr %name, align 8, !tbaa !64
...
land.lhs.true456:                                 ; preds = %land.lhs.true452
  %80 = load i32, ptr %length1741, align 4, !tbaa !60
  %name_max = getelementptr inbounds %struct.gz_header_s, ptr %78, i64 0, i32 8
  %81 = load i32, ptr %name_max, align 8, !tbaa !65
...
if.then461:                                       ; preds = %land.lhs.true456
  ...
  store i32 %inc466, ptr %length1741, align 4, !tbaa !60
...
do.cond470:                                       ; preds = %do.body446, %land.lhs.true452, %land.lhs.true456, %if.then461
  ...
  %cmp472 = icmp ult i64 %indvars.iv.next3942, %76
  %82 = select i1 %tobool471, i1 %cmp472, i1 false
  br i1 %82, label %do.body446, label %do.end474, !llvm.loop !66

do.end474:                                        ; preds = %do.cond470
  %83 = trunc i64 %indvars.iv.next3942 to i32
  %84 = load i32, ptr %flags1783, align 8, !tbaa !49
...
if.then497:                                       ; preds = %if.else493
  ...
  store ptr null, ptr %name499, align 8, !tbaa !64
  br label %if.end501
...
sw.bb504:                                         ; preds = %for.cond, %if.end501
  ...
  %88 = load i32, ptr %flags1783, align 8, !tbaa !49
...
if.then508:                                       ; preds = %sw.bb504
  ...
  br i1 %cmp509, label %do.body1882.loopexit4487, label %do.body513.preheader
...
do.body513:                                       ; preds = %do.body513.preheader, %do.cond539
  %indvars.iv3944 = phi i64 [ 0, %do.body513.preheader ], [ %indvars.iv.next3945, %do.cond539 ]
  %indvars.iv.next3945 = add nuw nsw i64 %indvars.iv3944, 1
  %arrayidx516 = getelementptr inbounds i8, ptr %next.15, i64 %indvars.iv3944
...
land.lhs.true521:                                 ; preds = %do.body513
  ...
  %92 = load ptr, ptr %comment, align 8, !tbaa !67
...
land.lhs.true525:                                 ; preds = %land.lhs.true521
  %93 = load i32, ptr %length1741, align 4, !tbaa !60
  %comm_max = getelementptr inbounds %struct.gz_header_s, ptr %91, i64 0, i32 10
  %94 = load i32, ptr %comm_max, align 8, !tbaa !68
...
if.then530:                                       ; preds = %land.lhs.true525
  ...
  store i32 %inc535, ptr %length1741, align 4, !tbaa !60
...
do.cond539:                                       ; preds = %do.body513, %land.lhs.true521, %land.lhs.true525, %if.then530
  ...
  %cmp542 = icmp ult i64 %indvars.iv.next3945, %89
  %95 = select i1 %tobool540, i1 %cmp542, i1 false
  br i1 %95, label %do.body513, label %do.end545, !llvm.loop !69

do.end545:                                        ; preds = %do.cond539
  %96 = trunc i64 %indvars.iv.next3945 to i32
  %97 = load i32, ptr %flags1783, align 8, !tbaa !49
...
if.then568:                                       ; preds = %if.else564
  ...
  store ptr null, ptr %comment570, align 8, !tbaa !67
  br label %if.end572
...
sw.bb574:                                         ; preds = %for.cond, %if.end572
  ...
  %101 = load i32, ptr %flags1783, align 8, !tbaa !49
...
while.cond580.preheader:                          ; preds = %sw.bb574
  %cmp5813636 = icmp ult i32 %bits.13, 16
  br i1 %cmp5813636, label %do.body584.preheader, label %do.end600

do.body584.preheader:                             ; preds = %while.cond580.preheader
  %102 = zext i32 %bits.13 to i64
  %cmp585 = icmp eq i32 %have.17, 0
  br i1 %cmp585, label %do.body1882.loopexit3658.split.loop.exit4922, label %if.end588
...
if.end588:                                        ; preds = %do.body584.preheader
  ...
  %indvars.iv.next3948 = add nuw nsw i64 %102, 8
  %cmp581 = icmp ult i32 %bits.13, 8
  br i1 %cmp581, label %do.body584.1, label %do.end600.loopexit, !llvm.loop !70

do.body584.1:                                     ; preds = %if.end588
  %cmp585.1 = icmp eq i32 %dec589, 0
  br i1 %cmp585.1, label %do.body1882.loopexit3658, label %if.end588.1
...
if.end588.1:                                      ; preds = %do.body584.1
  ...
  %shl593.1 = shl nuw nsw i64 %conv591.1, %indvars.iv.next3948
  %add594.1 = add i64 %shl593.1, %add594
  %indvars.iv.next3948.1 = add nuw nsw i64 %102, 16
...
do.end600.loopexit:                               ; preds = %if.end588.1, %if.end588
  ...
  %indvars.iv.next3948.lcssa = phi i64 [ %indvars.iv.next3948, %if.end588 ], [ %indvars.iv.next3948.1, %if.end588.1 ]
  %105 = trunc i64 %indvars.iv.next3948.lcssa to i32
  br label %do.end600
...
land.lhs.true604:                                 ; preds = %do.end600
  %107 = load i64, ptr %check1786, align 8, !tbaa !48
...
if.end642:                                        ; preds = %do.body638.preheader
  ...
  %indvars.iv.next3927 = add nuw nsw i64 %17, 8
  %cmp635 = icmp ult i32 %bits.0, 24
  br i1 %cmp635, label %do.body638.1, label %do.end654, !llvm.loop !72

do.body638.1:                                     ; preds = %if.end642
  %cmp639.1 = icmp eq i32 %dec643, 0
  br i1 %cmp639.1, label %do.body1882.loopexit3663, label %if.end642.1
...
if.end642.1:                                      ; preds = %do.body638.1
  ...
  %shl647.1 = shl nuw nsw i64 %conv645.1, %indvars.iv.next3927
  %add648.1 = add i64 %shl647.1, %add648
  %indvars.iv.next3927.1 = add nuw nsw i64 %17, 16
  %cmp635.1 = icmp ult i32 %bits.0, 16
  br i1 %cmp635.1, label %do.body638.2, label %do.end654, !llvm.loop !72

do.body638.2:                                     ; preds = %if.end642.1
  %cmp639.2 = icmp eq i32 %dec643.1, 0
  br i1 %cmp639.2, label %do.body1882.loopexit3663, label %if.end642.2
...
if.end642.2:                                      ; preds = %do.body638.2
  ...
  %shl647.2 = shl nuw nsw i64 %conv645.2, %indvars.iv.next3927.1
  %add648.2 = add i64 %shl647.2, %add648.1
  %indvars.iv.next3927.2 = add nuw nsw i64 %17, 24
  %cmp635.2 = icmp ult i32 %bits.0, 8
  br i1 %cmp635.2, label %do.body638.3, label %do.end654, !llvm.loop !72

do.body638.3:                                     ; preds = %if.end642.2
  %cmp639.3 = icmp eq i32 %dec643.2, 0
  br i1 %cmp639.3, label %do.body1882.loopexit3663, label %if.end642.3
...
if.end642.3:                                      ; preds = %do.body638.3
  ...
  %shl647.3 = shl nuw nsw i64 %conv645.3, %indvars.iv.next3927.2
...
do.end654:                                        ; preds = %if.end642, %if.end642.1, %if.end642.2, %if.end642.3, %while.cond634.preheader
  ...
  %trunc2899 = trunc i64 %hold.16.lcssa to i32
  %rev2900 = call i32 @llvm.bswap.i32(i32 %trunc2899)
  %add665 = zext i32 %rev2900 to i64
  store i64 %add665, ptr %check1786, align 8, !tbaa !48
...
do.body676:                                       ; preds = %sw.bb672
  store ptr %put.0, ptr %next_out, align 8, !tbaa !40
  store i32 %left.0, ptr %avail_out, align 8, !tbaa !43
  store ptr %next.21, ptr %strm, align 8, !tbaa !41
  store i32 %have.21, ptr %avail_in11, align 8, !tbaa !42
...
if.end685:                                        ; preds = %sw.bb672
  ...
  store i64 %call686, ptr %check1786, align 8, !tbaa !48
...
sw.bb690:                                         ; preds = %for.cond, %if.end685
  ...
  br i1 %or.cond2003, label %do.body1882.loopexit4487, label %sw.bb698
...
while.cond713.preheader:                          ; preds = %sw.bb698
  %cmp7143594 = icmp ult i32 %bits.19, 3
  br i1 %cmp7143594, label %do.body717, label %do.end733
...
sw.bb746:                                         ; preds = %do.end733
  ...
  store i32 9, ptr %lenbits, align 8, !tbaa !73
  store ptr @fixedtables.distfix, ptr %distcode, align 8, !tbaa !28
  store i32 5, ptr %distbits, align 4, !tbaa !74
...
do.body768:                                       ; preds = %for.cond
  ...
  %cmp7783577 = icmp ult i32 %sub773, 32
  br i1 %cmp7783577, label %do.body781.preheader, label %do.end797

do.body781.preheader:                             ; preds = %do.body768
  %117 = and i32 %bits.0, -8
  %118 = zext i32 %117 to i64
  %cmp782 = icmp eq i32 %have.0, 0
  br i1 %cmp782, label %do.body1882.loopexit3664.split.loop.exit4964, label %if.end785
...
if.end785:                                        ; preds = %do.body781.preheader
  ...
  %indvars.iv.next3925 = add nuw nsw i64 %118, 8
  %cmp778 = icmp ult i32 %117, 24
  br i1 %cmp778, label %do.body781.1, label %do.end797.loopexit, !llvm.loop !75

do.body781.1:                                     ; preds = %if.end785
  %cmp782.1 = icmp eq i32 %dec786, 0
  br i1 %cmp782.1, label %do.body1882.loopexit3664, label %if.end785.1
...
if.end785.1:                                      ; preds = %do.body781.1
  ...
  %shl790.1 = shl nuw nsw i64 %conv788.1, %indvars.iv.next3925
  %add791.1 = add i64 %shl790.1, %add791
  %indvars.iv.next3925.1 = add nuw nsw i64 %118, 16
  %cmp778.1 = icmp ult i32 %117, 16
  br i1 %cmp778.1, label %do.body781.2, label %do.end797.loopexit, !llvm.loop !75

do.body781.2:                                     ; preds = %if.end785.1
  %cmp782.2 = icmp eq i32 %dec786.1, 0
  br i1 %cmp782.2, label %do.body1882.loopexit3664, label %if.end785.2
...
if.end785.2:                                      ; preds = %do.body781.2
  ...
  %shl790.2 = shl nuw nsw i64 %conv788.2, %indvars.iv.next3925.1
  %add791.2 = add i64 %shl790.2, %add791.1
  %indvars.iv.next3925.2 = add nuw nsw i64 %118, 24
  %cmp778.2 = icmp eq i32 %117, 0
  br i1 %cmp778.2, label %do.body781.3, label %do.end797.loopexit, !llvm.loop !75

do.body781.3:                                     ; preds = %if.end785.2
  %cmp782.3 = icmp eq i32 %dec786.2, 0
  br i1 %cmp782.3, label %do.body1882.loopexit3664, label %if.end785.3
...
if.end785.3:                                      ; preds = %do.body781.3
  ...
  %shl790.3 = shl nuw nsw i64 %conv788.3, %indvars.iv.next3925.2
  %add791.3 = add i64 %shl790.3, %add791.2
  %indvars.iv.next3925.3 = add nuw nsw i64 %118, 32
...
do.end797.loopexit:                               ; preds = %if.end785.3, %if.end785.2, %if.end785.1, %if.end785
  ...
  %indvars.iv.next3925.lcssa = phi i64 [ %indvars.iv.next3925, %if.end785 ], [ %indvars.iv.next3925.1, %if.end785.1 ], [ %indvars.iv.next3925.2, %if.end785.2 ], [ %indvars.iv.next3925.3, %if.end785.3 ]
  %123 = trunc i64 %indvars.iv.next3925.lcssa to i32
  br label %do.end797
...
if.end805:                                        ; preds = %do.end797
  ...
  store i32 %and807, ptr %length1741, align 4, !tbaa !60
  store i32 16194, ptr %mode.i, align 8, !tbaa !16
  br i1 %cmp1269, label %do.body1882.loopexit4487, label %sw.bb817
...
sw.bb819:                                         ; preds = %for.cond, %sw.bb817
  ...
  %124 = load i32, ptr %length1741, align 4, !tbaa !60
  %tobool821.not = icmp eq i32 %124, 0
  br i1 %tobool821.not, label %if.end844, label %if.then822

if.then822:                                       ; preds = %sw.bb819
  %spec.select2903 = call i32 @llvm.umin.i32(i32 %124, i32 %have.27)
  %copy.4 = call i32 @llvm.umin.i32(i32 %spec.select2903, i32 %left.0)
  %cmp831 = icmp eq i32 %copy.4, 0
  br i1 %cmp831, label %do.body1882.loopexit4487, label %if.end834
...
if.end834:                                        ; preds = %if.then822
  ...
  %125 = load i32, ptr %length1741, align 4, !tbaa !60
  %sub843 = sub i32 %125, %copy.4
  store i32 %sub843, ptr %length1741, align 4, !tbaa !60
  br label %sw.epilog1881
...
if.end856:                                        ; preds = %do.body852.preheader
  ...
  %indvars.iv.next3885 = add nuw nsw i64 %16, 8
  %cmp849 = icmp ult i32 %bits.0, 6
  br i1 %cmp849, label %do.body852.1, label %do.end868.loopexit, !llvm.loop !76

do.body852.1:                                     ; preds = %if.end856
  %cmp853.1 = icmp eq i32 %dec857, 0
  br i1 %cmp853.1, label %do.body1882.loopexit3672, label %if.end856.1
...
if.end856.1:                                      ; preds = %do.body852.1
  ...
  %shl861.1 = shl nuw nsw i64 %conv859.1, %indvars.iv.next3885
  %add862.1 = add i64 %shl861.1, %add862
  %indvars.iv.next3885.1 = add nuw nsw i64 %16, 16
...
do.end868.loopexit:                               ; preds = %if.end856.1, %if.end856
  ...
  %indvars.iv.next3885.lcssa = phi i64 [ %indvars.iv.next3885, %if.end856 ], [ %indvars.iv.next3885.1, %if.end856.1 ]
  %128 = trunc i64 %indvars.iv.next3885.lcssa to i32
  br label %do.end868
...
do.end868:                                        ; preds = %do.end868.loopexit, %while.cond848.preheader
  ...
  %or.cond2921 = select i1 %cmp894, i1 true, i1 %cmp898
  br i1 %or.cond2921, label %if.then900, label %sw.bb906.thread
...
sw.bb906.thread:                                  ; preds = %do.end868
  store i32 0, ptr %have904, align 4, !tbaa !45
  store i32 16197, ptr %mode.i, align 8, !tbaa !16
  br label %while.cond914.preheader.preheader

sw.bb906:                                         ; preds = %for.cond
  %.pre3955 = load i32, ptr %ncode, align 8, !tbaa !79
  %have908.promoted.pre = load i32, ptr %have904, align 4, !tbaa !45
  %cmp9103394 = icmp ult i32 %have908.promoted.pre, %.pre3955
  br i1 %cmp9103394, label %while.cond914.preheader.preheader, label %while.cond950.preheader
...
while.cond914.preheader.preheader:                ; preds = %sw.bb906.thread, %sw.bb906
  ...
  %131 = phi i32 [ %add887, %sw.bb906.thread ], [ %.pre3955, %sw.bb906 ]
...
while.cond950.preheader:                          ; preds = %do.end934, %sw.bb906
  ...
  %cmp9523406 = icmp ult i32 %.lcssa, 19
  br i1 %cmp9523406, label %while.body954.preheader, label %while.end962
...
while.cond914.preheader:                          ; preds = %while.cond914.preheader.preheader, %do.end934
  %indvars.iv3887 = phi i64 [ %132, %while.cond914.preheader.preheader ], [ %indvars.iv.next3888, %do.end934 ]
  %bits.263399 = phi i32 [ %bits.254018, %while.cond914.preheader.preheader ], [ %sub946, %do.end934 ]
  %hold.263398 = phi i64 [ %hold.254017, %while.cond914.preheader.preheader ], [ %shr945, %do.end934 ]
  %have.303397 = phi i32 [ %have.294016, %while.cond914.preheader.preheader ], [ %have.31.lcssa, %do.end934 ]
  %next.303396 = phi ptr [ %next.294015, %while.cond914.preheader.preheader ], [ %next.31.lcssa, %do.end934 ]
  %cmp9153384 = icmp ult i32 %bits.263399, 3
  br i1 %cmp9153384, label %do.body918, label %do.end934

do.body918:                                       ; preds = %while.cond914.preheader
  %cmp919 = icmp eq i32 %have.303397, 0
  br i1 %cmp919, label %do.body1882, label %if.end922

if.end922:                                        ; preds = %do.body918
  %dec923 = add i32 %have.303397, -1
  %incdec.ptr924 = getelementptr inbounds i8, ptr %next.303396, i64 1
  %134 = load i8, ptr %next.303396, align 1, !tbaa !38
  %conv925 = zext i8 %134 to i64
  %sh_prom926 = zext i32 %bits.263399 to i64
  %shl927 = shl nuw nsw i64 %conv925, %sh_prom926
  %add928 = add i64 %shl927, %hold.263398
  %add929 = add nuw nsw i32 %bits.263399, 8
  br label %do.end934

do.end934:                                        ; preds = %if.end922, %while.cond914.preheader
  %next.31.lcssa = phi ptr [ %incdec.ptr924, %if.end922 ], [ %next.303396, %while.cond914.preheader ]
  %have.31.lcssa = phi i32 [ %dec923, %if.end922 ], [ %have.303397, %while.cond914.preheader ]
  %hold.27.lcssa = phi i64 [ %add928, %if.end922 ], [ %hold.263398, %while.cond914.preheader ]
  %bits.27.lcssa = phi i32 [ %add929, %if.end922 ], [ %bits.263399, %while.cond914.preheader ]
  %conv935 = trunc i64 %hold.27.lcssa to i16
  %and936 = and i16 %conv935, 7
  %indvars.iv.next3888 = add nuw nsw i64 %indvars.iv3887, 1
  %135 = trunc i64 %indvars.iv.next3888 to i32
  store i32 %135, ptr %have904, align 4, !tbaa !45
  %arrayidx941 = getelementptr inbounds [19 x i16], ptr @inflate.order, i64 0, i64 %indvars.iv3887
  %136 = load i16, ptr %arrayidx941, align 2, !tbaa !80
  %idxprom942 = zext i16 %136 to i64
  %arrayidx943 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %idxprom942
  store i16 %and936, ptr %arrayidx943, align 2, !tbaa !80
  %shr945 = lshr i64 %hold.27.lcssa, 3
  %sub946 = add i32 %bits.27.lcssa, -3
  %exitcond.not = icmp eq i64 %indvars.iv.next3888, %wide.trip.count
  br i1 %exitcond.not, label %while.cond950.preheader, label %while.cond914.preheader, !llvm.loop !82

while.body954:                                    ; preds = %while.body954.preheader, %while.body954
  %indvars.iv3890 = phi i64 [ %133, %while.body954.preheader ], [ %indvars.iv.next3891, %while.body954 ]
  %indvars.iv.next3891 = add nuw nsw i64 %indvars.iv3890, 1
  %arrayidx959 = getelementptr inbounds [19 x i16], ptr @inflate.order, i64 0, i64 %indvars.iv3890
  %137 = load i16, ptr %arrayidx959, align 2, !tbaa !80
  %idxprom960 = zext i16 %137 to i64
  %arrayidx961 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %idxprom960
  store i16 0, ptr %arrayidx961, align 2, !tbaa !80
  %138 = and i64 %indvars.iv.next3891, 4294967295
  %exitcond3893.not = icmp eq i64 %138, 19
  br i1 %exitcond3893.not, label %while.cond950.while.end962_crit_edge, label %while.body954, !llvm.loop !83

while.cond950.while.end962_crit_edge:             ; preds = %while.body954
  store i32 19, ptr %have904, align 4, !tbaa !45
...
while.end962:                                     ; preds = %while.cond950.while.end962_crit_edge, %while.cond950.preheader
  ...
  store ptr %codes, ptr %lencode, align 8, !tbaa !29
  store i32 7, ptr %lenbits, align 8, !tbaa !73
...
sw.bb979:                                         ; preds = %for.cond.sw.bb979_crit_edge, %if.end976
  %have981.promoted3457 = phi i32 [ %have981.promoted3457.pre, %for.cond.sw.bb979_crit_edge ], [ 0, %if.end976 ]
  ...
  %139 = load i32, ptr %nlen, align 4, !tbaa !77
  %140 = load i32, ptr %ndist, align 8, !tbaa !78
  %add984 = add i32 %140, %139
  %cmp9853460 = icmp ult i32 %have981.promoted3457, %add984
  br i1 %cmp9853460, label %for.cond988.preheader.lr.ph, label %if.end1222

for.cond988.preheader.lr.ph:                      ; preds = %sw.bb979
  %141 = load ptr, ptr %lencode, align 8, !tbaa !29
  %142 = load i32, ptr %lenbits, align 8, !tbaa !73
  %notmask2898 = shl nsw i32 -1, %142
  %sub993 = xor i32 %notmask2898, -1
  br label %for.cond988.preheader

for.cond988.preheader:                            ; preds = %for.cond988.preheader.lr.ph, %if.end1216
  %bits.293465 = phi i32 [ %bits.28, %for.cond988.preheader.lr.ph ], [ %bits.35, %if.end1216 ]
  %hold.293464 = phi i64 [ %hold.28, %for.cond988.preheader.lr.ph ], [ %hold.35, %if.end1216 ]
  %have.333463 = phi i32 [ %have.32, %for.cond988.preheader.lr.ph ], [ %have.39, %if.end1216 ]
  %next.333462 = phi ptr [ %next.32, %for.cond988.preheader.lr.ph ], [ %next.39, %if.end1216 ]
  %.lcssa345534583461 = phi i32 [ %have981.promoted3457, %for.cond988.preheader.lr.ph ], [ %.lcssa34553459, %if.end1216 ]
  %conv9903409 = trunc i64 %hold.293464 to i32
  %and9943410 = and i32 %sub993, %conv9903409
  %idxprom9953411 = zext i32 %and9943410 to i64
  %here.sroa.18.0.arrayidx996.sroa_idx3413 = getelementptr inbounds %struct.code, ptr %141, i64 %idxprom9953411, i32 1
  %here.sroa.18.0.copyload3414 = load i8, ptr %here.sroa.18.0.arrayidx996.sroa_idx3413, align 1, !tbaa.struct !84
  %conv9983415 = zext i8 %here.sroa.18.0.copyload3414 to i32
  %cmp999.not3416 = icmp ult i32 %bits.293465, %conv9983415
  br i1 %cmp999.not3416, label %do.body1003.preheader, label %for.end

do.body1003.preheader:                            ; preds = %for.cond988.preheader
  %143 = zext i32 %bits.293465 to i64
  br label %do.body1003

do.body1003:                                      ; preds = %do.body1003.preheader, %if.end1007
  %indvars.iv3894 = phi i64 [ %143, %do.body1003.preheader ], [ %indvars.iv.next3895, %if.end1007 ]
  %hold.303419 = phi i64 [ %hold.293464, %do.body1003.preheader ], [ %add1013, %if.end1007 ]
  %have.343418 = phi i32 [ %have.333463, %do.body1003.preheader ], [ %dec1008, %if.end1007 ]
  %next.343417 = phi ptr [ %next.333462, %do.body1003.preheader ], [ %incdec.ptr1009, %if.end1007 ]
  %cmp1004 = icmp eq i32 %have.343418, 0
  br i1 %cmp1004, label %do.body1882.loopexit4019, label %if.end1007

if.end1007:                                       ; preds = %do.body1003
  %dec1008 = add i32 %have.343418, -1
  %incdec.ptr1009 = getelementptr inbounds i8, ptr %next.343417, i64 1
  %144 = load i8, ptr %next.343417, align 1, !tbaa !38
  %conv1010 = zext i8 %144 to i64
  %shl1012 = shl i64 %conv1010, %indvars.iv3894
  %add1013 = add i64 %shl1012, %hold.303419
  %indvars.iv.next3895 = add nuw nsw i64 %indvars.iv3894, 8
  ...
  %here.sroa.18.0.copyload = load i8, ptr %here.sroa.18.0.arrayidx996.sroa_idx, align 1, !tbaa.struct !84
  %145 = zext i8 %here.sroa.18.0.copyload to i64
  %cmp999.not = icmp ult i64 %indvars.iv.next3895, %145
  br i1 %cmp999.not, label %do.body1003, label %for.end.loopexit

for.end.loopexit:                                 ; preds = %if.end1007
  %idxprom995.le = zext i32 %and994 to i64
  %conv998 = zext i8 %here.sroa.18.0.copyload to i32
  %146 = trunc i64 %indvars.iv.next3895 to i32
  br label %for.end

for.end:                                          ; preds = %for.end.loopexit, %for.cond988.preheader
  %conv998.le.pre-phi = phi i32 [ %conv998, %for.end.loopexit ], [ %conv9983415, %for.cond988.preheader ]
  %147 = phi i64 [ %idxprom995.le, %for.end.loopexit ], [ %idxprom9953411, %for.cond988.preheader ]
  %here.sroa.18.0.copyload.lcssa3408 = phi i8 [ %here.sroa.18.0.copyload, %for.end.loopexit ], [ %here.sroa.18.0.copyload3414, %for.cond988.preheader ]
  %next.34.lcssa = phi ptr [ %incdec.ptr1009, %for.end.loopexit ], [ %next.333462, %for.cond988.preheader ]
  %have.34.lcssa = phi i32 [ %dec1008, %for.end.loopexit ], [ %have.333463, %for.cond988.preheader ]
  %hold.30.lcssa = phi i64 [ %add1013, %for.end.loopexit ], [ %hold.293464, %for.cond988.preheader ]
  %bits.30.lcssa = phi i32 [ %146, %for.end.loopexit ], [ %bits.293465, %for.cond988.preheader ]
  %here.sroa.42.0.arrayidx996.sroa_idx.le = getelementptr inbounds %struct.code, ptr %141, i64 %147, i32 2
  %here.sroa.42.0.copyload.le = load i16, ptr %here.sroa.42.0.arrayidx996.sroa_idx.le, align 2, !tbaa.struct !85
...
do.body1021:                                      ; preds = %for.end
  %sh_prom1024 = zext i8 %here.sroa.18.0.copyload.lcssa3408 to i64
  %shr1025 = lshr i64 %hold.30.lcssa, %sh_prom1024
  %sub1028 = sub i32 %bits.30.lcssa, %conv998.le.pre-phi
  %inc1034 = add i32 %.lcssa345534583461, 1
  store i32 %inc1034, ptr %have904, align 4, !tbaa !45
  %idxprom1035 = zext i32 %.lcssa345534583461 to i64
  %arrayidx1036 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %idxprom1035
  store i16 %here.sroa.42.0.copyload.le, ptr %arrayidx1036, align 2, !tbaa !80
  br label %if.end1216
...
while.cond1106.preheader:                         ; preds = %if.else1037
  %add1109 = add nuw nsw i32 %conv998.le.pre-phi, 3
  %cmp11103428 = icmp ult i32 %bits.30.lcssa, %add1109
  br i1 %cmp11103428, label %do.body1113.preheader, label %do.body1130
...
while.cond1044.preheader:                         ; preds = %if.else1037
  %add1047 = add nuw nsw i32 %conv998.le.pre-phi, 2
  %cmp10483437 = icmp ult i32 %bits.30.lcssa, %add1047
  br i1 %cmp10483437, label %do.body1051.preheader, label %do.body1068
...
while.cond1150.preheader:                         ; preds = %if.else1037
  %add1153 = add nuw nsw i32 %conv998.le.pre-phi, 7
  %cmp11543446 = icmp ult i32 %bits.30.lcssa, %add1153
  br i1 %cmp11543446, label %do.body1157.preheader, label %do.body1174
...
do.body1051:                                      ; preds = %do.body1051.preheader, %if.end1055
  %indvars.iv3900 = phi i64 [ %150, %do.body1051.preheader ], [ %indvars.iv.next3901, %if.end1055 ]
  %hold.313440 = phi i64 [ %hold.30.lcssa, %do.body1051.preheader ], [ %add1061, %if.end1055 ]
  %have.353439 = phi i32 [ %have.34.lcssa, %do.body1051.preheader ], [ %dec1056, %if.end1055 ]
  %next.353438 = phi ptr [ %next.34.lcssa, %do.body1051.preheader ], [ %incdec.ptr1057, %if.end1055 ]
  %cmp1052 = icmp eq i32 %have.353439, 0
  br i1 %cmp1052, label %do.body1882.loopexit3654, label %if.end1055

if.end1055:                                       ; preds = %do.body1051
  %dec1056 = add i32 %have.353439, -1
  %incdec.ptr1057 = getelementptr inbounds i8, ptr %next.353438, i64 1
  %154 = load i8, ptr %next.353438, align 1, !tbaa !38
  %conv1058 = zext i8 %154 to i64
  %shl1060 = shl i64 %conv1058, %indvars.iv3900
  %add1061 = add i64 %shl1060, %hold.313440
  %indvars.iv.next3901 = add nuw nsw i64 %indvars.iv3900, 8
  %cmp1048 = icmp ult i64 %indvars.iv.next3901, %151
  br i1 %cmp1048, label %do.body1051, label %do.body1068.loopexit, !llvm.loop !86

do.body1068.loopexit:                             ; preds = %if.end1055
  %155 = trunc i64 %indvars.iv.next3901 to i32
...
do.body1068:                                      ; preds = %do.body1068.loopexit, %while.cond1044.preheader
  ...
  %sh_prom1071 = zext i8 %here.sroa.18.0.copyload.lcssa3408 to i64
  %shr1072 = lshr i64 %hold.31.lcssa, %sh_prom1071
  %sub1075 = sub i32 %bits.31.lcssa, %conv998.le.pre-phi
  %cmp1079 = icmp eq i32 %.lcssa345534583461, 0
...
if.end1084:                                       ; preds = %do.body1068
  %sub1087 = add i32 %.lcssa345534583461, -1
  ...
  %156 = load i16, ptr %arrayidx1089, align 2, !tbaa !80
...
do.body1113:                                      ; preds = %do.body1113.preheader, %if.end1117
  %indvars.iv3897 = phi i64 [ %148, %do.body1113.preheader ], [ %indvars.iv.next3898, %if.end1117 ]
  %hold.323431 = phi i64 [ %hold.30.lcssa, %do.body1113.preheader ], [ %add1123, %if.end1117 ]
  %have.363430 = phi i32 [ %have.34.lcssa, %do.body1113.preheader ], [ %dec1118, %if.end1117 ]
  %next.363429 = phi ptr [ %next.34.lcssa, %do.body1113.preheader ], [ %incdec.ptr1119, %if.end1117 ]
  %cmp1114 = icmp eq i32 %have.363430, 0
  br i1 %cmp1114, label %do.body1882.loopexit3655, label %if.end1117

if.end1117:                                       ; preds = %do.body1113
  %dec1118 = add i32 %have.363430, -1
  %incdec.ptr1119 = getelementptr inbounds i8, ptr %next.363429, i64 1
  %157 = load i8, ptr %next.363429, align 1, !tbaa !38
  %conv1120 = zext i8 %157 to i64
  %shl1122 = shl i64 %conv1120, %indvars.iv3897
  %add1123 = add i64 %shl1122, %hold.323431
  %indvars.iv.next3898 = add nuw nsw i64 %indvars.iv3897, 8
  %cmp1110 = icmp ult i64 %indvars.iv.next3898, %149
  br i1 %cmp1110, label %do.body1113, label %do.body1130.loopexit, !llvm.loop !87

do.body1130.loopexit:                             ; preds = %if.end1117
  %158 = trunc i64 %indvars.iv.next3898 to i32
...
do.body1130:                                      ; preds = %do.body1130.loopexit, %while.cond1106.preheader
  ...
  %sh_prom1133 = zext i8 %here.sroa.18.0.copyload.lcssa3408 to i64
  ...
  %sub1137 = sub nuw nsw i32 -3, %conv998.le.pre-phi
  %sub1145 = add i32 %sub1137, %bits.32.lcssa
  br label %if.end1193

do.body1157:                                      ; preds = %do.body1157.preheader, %if.end1161
  %indvars.iv3903 = phi i64 [ %152, %do.body1157.preheader ], [ %indvars.iv.next3904, %if.end1161 ]
  %hold.333449 = phi i64 [ %hold.30.lcssa, %do.body1157.preheader ], [ %add1167, %if.end1161 ]
  %have.373448 = phi i32 [ %have.34.lcssa, %do.body1157.preheader ], [ %dec1162, %if.end1161 ]
  %next.373447 = phi ptr [ %next.34.lcssa, %do.body1157.preheader ], [ %incdec.ptr1163, %if.end1161 ]
  %cmp1158 = icmp eq i32 %have.373448, 0
  br i1 %cmp1158, label %do.body1882.loopexit, label %if.end1161

if.end1161:                                       ; preds = %do.body1157
  %dec1162 = add i32 %have.373448, -1
  %incdec.ptr1163 = getelementptr inbounds i8, ptr %next.373447, i64 1
  %159 = load i8, ptr %next.373447, align 1, !tbaa !38
  %conv1164 = zext i8 %159 to i64
  %shl1166 = shl i64 %conv1164, %indvars.iv3903
  %add1167 = add i64 %shl1166, %hold.333449
  %indvars.iv.next3904 = add nuw nsw i64 %indvars.iv3903, 8
  %cmp1154 = icmp ult i64 %indvars.iv.next3904, %153
  br i1 %cmp1154, label %do.body1157, label %do.body1174.loopexit, !llvm.loop !88

do.body1174.loopexit:                             ; preds = %if.end1161
  %160 = trunc i64 %indvars.iv.next3904 to i32
...
do.body1174:                                      ; preds = %do.body1174.loopexit, %while.cond1150.preheader
  ...
  %sh_prom1177 = zext i8 %here.sroa.18.0.copyload.lcssa3408 to i64
  ...
  %sub1181 = sub nuw nsw i32 -7, %conv998.le.pre-phi
  %sub1189 = add i32 %sub1181, %bits.33.lcssa
  br label %if.end1193
...
if.end1193:                                       ; preds = %do.body1130, %do.body1174, %if.end1084
  ...
  %add1195 = add i32 %copy.5, %.lcssa345534583461
...
while.body1208.preheader:                         ; preds = %if.end1193
  %min.iters.check4470 = icmp ult i32 %copy.5, 16
  br i1 %min.iters.check4470, label %while.body1208.preheader4485, label %vector.scevcheck

vector.scevcheck:                                 ; preds = %while.body1208.preheader
  %161 = add nsw i32 %copy.5, -1
  %162 = xor i32 %.lcssa345534583461, -1
  %163 = icmp ugt i32 %161, %162
  br i1 %163, label %while.body1208.preheader4485, label %vector.ph4471

vector.ph4471:                                    ; preds = %vector.scevcheck
  %n.vec4473 = and i32 %copy.5, -16
  %ind.end4474 = and i32 %copy.5, 15
  %ind.end4476 = add i32 %.lcssa345534583461, %n.vec4473
  ...
  %broadcast.splatinsert4481 = insertelement <8 x i16> poison, i16 %len.0, i64 0
  %broadcast.splat4482 = shufflevector <8 x i16> %broadcast.splatinsert4481, <8 x i16> poison, <8 x i32> zeroinitializer
  %164 = zext i32 %.lcssa345534583461 to i64
  %165 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %164
  store <8 x i16> %broadcast.splat, ptr %165, align 2, !tbaa !80
  %166 = getelementptr inbounds i16, ptr %165, i64 8
  store <8 x i16> %broadcast.splat4482, ptr %166, align 2, !tbaa !80
  %167 = icmp eq i32 %n.vec4473, 16
  br i1 %167, label %middle.block4468, label %vector.body4479.1, !llvm.loop !89

vector.body4479.1:                                ; preds = %vector.ph4471
  %offset.idx.1 = add i32 %.lcssa345534583461, 16
  %168 = zext i32 %offset.idx.1 to i64
  %169 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %168
  store <8 x i16> %broadcast.splat, ptr %169, align 2, !tbaa !80
  %170 = getelementptr inbounds i16, ptr %169, i64 8
  store <8 x i16> %broadcast.splat4482, ptr %170, align 2, !tbaa !80
  %171 = icmp eq i32 %n.vec4473, 32
  br i1 %171, label %middle.block4468, label %vector.body4479.2, !llvm.loop !89

vector.body4479.2:                                ; preds = %vector.body4479.1
  %offset.idx.2 = add i32 %.lcssa345534583461, 32
  %172 = zext i32 %offset.idx.2 to i64
  %173 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %172
  store <8 x i16> %broadcast.splat, ptr %173, align 2, !tbaa !80
  %174 = getelementptr inbounds i16, ptr %173, i64 8
  store <8 x i16> %broadcast.splat4482, ptr %174, align 2, !tbaa !80
  %175 = icmp eq i32 %n.vec4473, 48
  br i1 %175, label %middle.block4468, label %vector.body4479.3, !llvm.loop !89

vector.body4479.3:                                ; preds = %vector.body4479.2
  %offset.idx.3 = add i32 %.lcssa345534583461, 48
  %176 = zext i32 %offset.idx.3 to i64
  %177 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %176
  store <8 x i16> %broadcast.splat, ptr %177, align 2, !tbaa !80
  %178 = getelementptr inbounds i16, ptr %177, i64 8
  store <8 x i16> %broadcast.splat4482, ptr %178, align 2, !tbaa !80
  %179 = icmp eq i32 %n.vec4473, 64
  br i1 %179, label %middle.block4468, label %vector.body4479.4, !llvm.loop !89

vector.body4479.4:                                ; preds = %vector.body4479.3
  %offset.idx.4 = add i32 %.lcssa345534583461, 64
  %180 = zext i32 %offset.idx.4 to i64
  %181 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %180
  store <8 x i16> %broadcast.splat, ptr %181, align 2, !tbaa !80
  %182 = getelementptr inbounds i16, ptr %181, i64 8
  store <8 x i16> %broadcast.splat4482, ptr %182, align 2, !tbaa !80
  %183 = icmp eq i32 %n.vec4473, 80
  br i1 %183, label %middle.block4468, label %vector.body4479.5, !llvm.loop !89

vector.body4479.5:                                ; preds = %vector.body4479.4
  %offset.idx.5 = add i32 %.lcssa345534583461, 80
  %184 = zext i32 %offset.idx.5 to i64
  %185 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %184
  store <8 x i16> %broadcast.splat, ptr %185, align 2, !tbaa !80
  %186 = getelementptr inbounds i16, ptr %185, i64 8
  store <8 x i16> %broadcast.splat4482, ptr %186, align 2, !tbaa !80
  %187 = icmp eq i32 %n.vec4473, 96
  br i1 %187, label %middle.block4468, label %vector.body4479.6, !llvm.loop !89

vector.body4479.6:                                ; preds = %vector.body4479.5
  %offset.idx.6 = add i32 %.lcssa345534583461, 96
  %188 = zext i32 %offset.idx.6 to i64
  %189 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %188
  store <8 x i16> %broadcast.splat, ptr %189, align 2, !tbaa !80
  %190 = getelementptr inbounds i16, ptr %189, i64 8
  store <8 x i16> %broadcast.splat4482, ptr %190, align 2, !tbaa !80
  %191 = icmp eq i32 %n.vec4473, 112
  br i1 %191, label %middle.block4468, label %vector.body4479.7, !llvm.loop !89

vector.body4479.7:                                ; preds = %vector.body4479.6
  %offset.idx.7 = add i32 %.lcssa345534583461, 112
  %192 = zext i32 %offset.idx.7 to i64
  %193 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 29, i64 %192
  store <8 x i16> %broadcast.splat, ptr %193, align 2, !tbaa !80
  %194 = getelementptr inbounds i16, ptr %193, i64 8
  store <8 x i16> %broadcast.splat4482, ptr %194, align 2, !tbaa !80
  br label %middle.block4468

middle.block4468:                                 ; preds = %vector.body4479.7, %vector.body4479.6, %vector.body4479.5, %vector.body4479.4, %vector.body4479.3, %vector.body4479.2, %vector.body4479.1, %vector.ph4471
  %cmp.n4478 = icmp eq i32 %copy.5, %n.vec4473
  br i1 %cmp.n4478, label %if.end1216.loopexit, label %while.body1208.preheader4485

while.body1208.preheader4485:                     ; preds = %vector.scevcheck, %while.body1208.preheader, %middle.block4468
  %copy.63456.ph = phi i32 [ %copy.5, %vector.scevcheck ], [ %copy.5, %while.body1208.preheader ], [ %ind.end4474, %middle.block4468 ]
  %.ph = phi i32 [ %.lcssa345534583461, %vector.scevcheck ], [ %.lcssa345534583461, %while.body1208.preheader ], [ %ind.end4476, %middle.block4468 ]
  %195 = add nsw i32 %copy.63456.ph, -1
  %xtraiter = and i32 %copy.63456.ph, 3
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %while.body1208.prol.loopexit, label %while.body1208.prol

while.body1208.prol:                              ; preds = %while.body1208.preheader4485, %while.body1208.prol
  %copy.63456.prol = phi i32 [ %dec1206.prol, %while.body1208.prol ], [ %copy.63456.ph, %while.body1208.preheader4485 ]
  %196 = phi i32 [ %inc1212.prol, %while.body1208.prol ], [ %.ph, %while.body1208.preheader4485 ]
  %prol.iter = phi i32 [ %prol.iter.next, %while.body1208.prol ], [ 0, %while.body1208.preheader4485 ]
  %dec1206.prol = add nsw i32 %copy.63456.prol, -1
  ...
  store i16 %len.0, ptr %arrayidx1214.prol, align 2, !tbaa !80
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %while.body1208.prol.loopexit, label %while.body1208.prol, !llvm.loop !92

while.body1208.prol.loopexit:                     ; preds = %while.body1208.prol, %while.body1208.preheader4485
  %inc1212.lcssa4510.unr = phi i32 [ undef, %while.body1208.preheader4485 ], [ %inc1212.prol, %while.body1208.prol ]
  %copy.63456.unr = phi i32 [ %copy.63456.ph, %while.body1208.preheader4485 ], [ %dec1206.prol, %while.body1208.prol ]
  %.unr = phi i32 [ %.ph, %while.body1208.preheader4485 ], [ %inc1212.prol, %while.body1208.prol ]
...
while.body1208:                                   ; preds = %while.body1208.prol.loopexit, %while.body1208
  %copy.63456 = phi i32 [ %dec1206.3, %while.body1208 ], [ %copy.63456.unr, %while.body1208.prol.loopexit ]
  ...
  store i16 %len.0, ptr %arrayidx1214, align 2, !tbaa !80
  ...
  store i16 %len.0, ptr %arrayidx1214.1, align 2, !tbaa !80
  ...
  store i16 %len.0, ptr %arrayidx1214.2, align 2, !tbaa !80
  %dec1206.3 = add nsw i32 %copy.63456, -4
  ...
  store i16 %len.0, ptr %arrayidx1214.3, align 2, !tbaa !80
  %tobool1207.not.3 = icmp eq i32 %dec1206.3, 0
  br i1 %tobool1207.not.3, label %if.end1216.loopexit, label %while.body1208, !llvm.loop !94

if.end1216.loopexit:                              ; preds = %while.body1208.prol.loopexit, %while.body1208, %middle.block4468
  %inc1212.lcssa = phi i32 [ %ind.end4476, %middle.block4468 ], [ %inc1212.lcssa4510.unr, %while.body1208.prol.loopexit ], [ %inc1212.3, %while.body1208 ]
  store i32 %inc1212.lcssa, ptr %have904, align 4, !tbaa !45
  br label %if.end1216

if.end1216:                                       ; preds = %if.end1216.loopexit, %do.body1021
  %.lcssa34553459 = phi i32 [ %inc1034, %do.body1021 ], [ %inc1212.lcssa, %if.end1216.loopexit ]
  ...
  %cmp985 = icmp ult i32 %.lcssa34553459, %add984
  br i1 %cmp985, label %for.cond988.preheader, label %if.end1222, !llvm.loop !95
...
if.end1222:                                       ; preds = %if.end1216, %sw.bb979
  ...
  %199 = load i16, ptr %arrayidx1224, align 8, !tbaa !80
...
if.end1250:                                       ; preds = %if.end1231
  ...
  store i32 6, ptr %distbits, align 4, !tbaa !74
  %201 = load i32, ptr %nlen, align 4, !tbaa !77
  %idx.ext1255 = zext i32 %201 to i64
  %add.ptr1256 = getelementptr inbounds i16, ptr %lens966, i64 %idx.ext1255
  %202 = load i32, ptr %ndist, align 8, !tbaa !78
...
if.end1267:                                       ; preds = %if.end1250
  store i32 16199, ptr %mode.i, align 8, !tbaa !16
  br i1 %cmp1269, label %do.body1882.loopexit4487, label %sw.bb1273
...
do.body1282:                                      ; preds = %sw.bb1275
  store ptr %put.0, ptr %next_out, align 8, !tbaa !40
  store i32 %left.0, ptr %avail_out, align 8, !tbaa !43
  store ptr %next.42, ptr %strm, align 8, !tbaa !41
  store i32 %have.42, ptr %avail_in11, align 8, !tbaa !42
  ...
  %203 = load ptr, ptr %next_out, align 8, !tbaa !40
  %204 = load i32, ptr %avail_out, align 8, !tbaa !43
  %205 = load ptr, ptr %strm, align 8, !tbaa !41
  %206 = load i32, ptr %avail_in11, align 8, !tbaa !42
...
if.end1305:                                       ; preds = %sw.bb1275
  ...
  %211 = load i32, ptr %lenbits, align 8, !tbaa !73
  %notmask2896 = shl nsw i32 -1, %211
  %sub1312 = xor i32 %notmask2896, -1
  %conv13093473 = trunc i64 %hold.38 to i32
  %and13133474 = and i32 %sub1312, %conv13093473
  %idxprom13143475 = zext i32 %and13133474 to i64
  %arrayidx13153476 = getelementptr inbounds %struct.code, ptr %210, i64 %idxprom13143475
  %here.sroa.18.0.arrayidx1315.sroa_idx3477 = getelementptr inbounds i8, ptr %arrayidx13153476, i64 1
  %here.sroa.18.0.copyload20583478 = load i8, ptr %here.sroa.18.0.arrayidx1315.sroa_idx3477, align 1, !tbaa.struct !84
  %conv13173479 = zext i8 %here.sroa.18.0.copyload20583478 to i32
  %cmp1318.not3480 = icmp ult i32 %bits.38, %conv13173479
  br i1 %cmp1318.not3480, label %do.body1322.preheader, label %for.end1336
...
do.body1322:                                      ; preds = %do.body1322.preheader, %if.end1326
  %indvars.iv3906 = phi i64 [ %212, %do.body1322.preheader ], [ %indvars.iv.next3907, %if.end1326 ]
  %hold.393483 = phi i64 [ %hold.38, %do.body1322.preheader ], [ %add1332, %if.end1326 ]
  %have.433482 = phi i32 [ %have.42, %do.body1322.preheader ], [ %dec1327, %if.end1326 ]
  %next.433481 = phi ptr [ %next.42, %do.body1322.preheader ], [ %incdec.ptr1328, %if.end1326 ]
  %cmp1323 = icmp eq i32 %have.433482, 0
  br i1 %cmp1323, label %do.body1882.loopexit4025, label %if.end1326

if.end1326:                                       ; preds = %do.body1322
  %dec1327 = add i32 %have.433482, -1
  %incdec.ptr1328 = getelementptr inbounds i8, ptr %next.433481, i64 1
  %213 = load i8, ptr %next.433481, align 1, !tbaa !38
  %conv1329 = zext i8 %213 to i64
  %shl1331 = shl i64 %conv1329, %indvars.iv3906
  %add1332 = add i64 %shl1331, %hold.393483
  %indvars.iv.next3907 = add nuw nsw i64 %indvars.iv3906, 8
  ...
  %here.sroa.18.0.copyload2058 = load i8, ptr %here.sroa.18.0.arrayidx1315.sroa_idx, align 1, !tbaa.struct !84
  %214 = zext i8 %here.sroa.18.0.copyload2058 to i64
  %cmp1318.not = icmp ult i64 %indvars.iv.next3907, %214
...
for.end1336.loopexit:                             ; preds = %if.end1326
  ...
  %215 = trunc i64 %indvars.iv.next3907 to i32
  br label %for.end1336

for.end1336:                                      ; preds = %for.end1336.loopexit, %if.end1305
  %conv1317.le.pre-phi = phi i32 [ %conv1317, %for.end1336.loopexit ], [ %conv13173479, %if.end1305 ]
  %arrayidx1315.lcssa3472 = phi ptr [ %arrayidx1315, %for.end1336.loopexit ], [ %arrayidx13153476, %if.end1305 ]
  %here.sroa.18.0.copyload2058.lcssa3471 = phi i8 [ %here.sroa.18.0.copyload2058, %for.end1336.loopexit ], [ %here.sroa.18.0.copyload20583478, %if.end1305 ]
  %next.43.lcssa = phi ptr [ %incdec.ptr1328, %for.end1336.loopexit ], [ %next.42, %if.end1305 ]
  %have.43.lcssa = phi i32 [ %dec1327, %for.end1336.loopexit ], [ %have.42, %if.end1305 ]
  %hold.39.lcssa = phi i64 [ %add1332, %for.end1336.loopexit ], [ %hold.38, %if.end1305 ]
  %bits.39.lcssa = phi i32 [ %215, %for.end1336.loopexit ], [ %bits.38, %if.end1305 ]
  %here.sroa.42.0.arrayidx1315.sroa_idx.le = getelementptr inbounds i8, ptr %arrayidx1315.lcssa3472, i64 2
  %here.sroa.42.0.copyload2083.le = load i16, ptr %here.sroa.42.0.arrayidx1315.sroa_idx.le, align 2, !tbaa.struct !85
  %here.sroa.0.0.copyload2054 = load i8, ptr %arrayidx1315.lcssa3472, align 2, !tbaa.struct !96
  %216 = add i8 %here.sroa.0.0.copyload2054, -1
  %or.cond2904 = icmp ult i8 %216, 15
  br i1 %or.cond2904, label %for.cond1346.preheader, label %do.body1404

for.cond1346.preheader:                           ; preds = %for.end1336
  %conv1337 = zext i8 %here.sroa.0.0.copyload2054 to i32
  %conv1349 = zext i16 %here.sroa.42.0.copyload2083.le to i32
  %add1355 = add nuw nsw i32 %conv1317.le.pre-phi, %conv1337
  %notmask2897 = shl nsw i32 -1, %add1355
  %sub1357 = xor i32 %notmask2897, -1
  %conv13503494 = trunc i64 %hold.39.lcssa to i32
  %and13583495 = and i32 %conv13503494, %sub1357
  %shr13613496 = lshr i32 %and13583495, %conv1317.le.pre-phi
  %add13623497 = add i32 %shr13613496, %conv1349
  %idxprom13633498 = zext i32 %add13623497 to i64
  %arrayidx13643499 = getelementptr inbounds %struct.code, ptr %210, i64 %idxprom13633498
  %here.sroa.18.0.arrayidx1364.sroa_idx3500 = getelementptr inbounds i8, ptr %arrayidx13643499, i64 1
  %here.sroa.18.0.copyload20593501 = load i8, ptr %here.sroa.18.0.arrayidx1364.sroa_idx3500, align 1, !tbaa.struct !84
  %conv13683502 = zext i8 %here.sroa.18.0.copyload20593501 to i32
  %add13693503 = add nuw nsw i32 %conv1317.le.pre-phi, %conv13683502
  %cmp1370.not3504 = icmp ugt i32 %add13693503, %bits.39.lcssa
  br i1 %cmp1370.not3504, label %do.body1374.preheader, label %do.body1389
...
do.body1374:                                      ; preds = %do.body1374.preheader, %if.end1378
  %indvars.iv3910 = phi i64 [ %217, %do.body1374.preheader ], [ %indvars.iv.next3911, %if.end1378 ]
  %hold.403507 = phi i64 [ %hold.39.lcssa, %do.body1374.preheader ], [ %add1384, %if.end1378 ]
  %have.443506 = phi i32 [ %have.43.lcssa, %do.body1374.preheader ], [ %dec1379, %if.end1378 ]
  %next.443505 = phi ptr [ %next.43.lcssa, %do.body1374.preheader ], [ %incdec.ptr1380, %if.end1378 ]
  %cmp1375 = icmp eq i32 %have.443506, 0
  br i1 %cmp1375, label %do.body1882.loopexit4024, label %if.end1378

if.end1378:                                       ; preds = %do.body1374
  %dec1379 = add i32 %have.443506, -1
  %incdec.ptr1380 = getelementptr inbounds i8, ptr %next.443505, i64 1
  %218 = load i8, ptr %next.443505, align 1, !tbaa !38
  %conv1381 = zext i8 %218 to i64
  %shl1383 = shl i64 %conv1381, %indvars.iv3910
  %add1384 = add i64 %shl1383, %hold.403507
  %indvars.iv.next3911 = add nuw nsw i64 %indvars.iv3910, 8
  %conv1350 = trunc i64 %add1384 to i32
  %and1358 = and i32 %conv1350, %sub1357
  %shr1361 = lshr i32 %and1358, %conv1317.le.pre-phi
  ...
  %here.sroa.18.0.copyload2059 = load i8, ptr %here.sroa.18.0.arrayidx1364.sroa_idx, align 1, !tbaa.struct !84
  %conv1368 = zext i8 %here.sroa.18.0.copyload2059 to i32
  %add1369 = add nuw nsw i32 %conv1317.le.pre-phi, %conv1368
  %219 = zext i32 %add1369 to i64
  %cmp1370.not = icmp ult i64 %indvars.iv.next3911, %219
  br i1 %cmp1370.not, label %do.body1374, label %do.body1389.loopexit

do.body1389.loopexit:                             ; preds = %if.end1378
  %conv1368.le = zext i8 %here.sroa.18.0.copyload2059 to i32
  %220 = trunc i64 %indvars.iv.next3911 to i32
  br label %do.body1389

do.body1389:                                      ; preds = %do.body1389.loopexit, %for.cond1346.preheader
  %.pre3964.pre-phi = phi i32 [ %conv1368.le, %do.body1389.loopexit ], [ %conv13683502, %for.cond1346.preheader ]
  %next.44.lcssa = phi ptr [ %incdec.ptr1380, %do.body1389.loopexit ], [ %next.43.lcssa, %for.cond1346.preheader ]
  %have.44.lcssa = phi i32 [ %dec1379, %do.body1389.loopexit ], [ %have.43.lcssa, %for.cond1346.preheader ]
  %hold.40.lcssa = phi i64 [ %add1384, %do.body1389.loopexit ], [ %hold.39.lcssa, %for.cond1346.preheader ]
  %bits.40.lcssa = phi i32 [ %220, %do.body1389.loopexit ], [ %bits.39.lcssa, %for.cond1346.preheader ]
  %arrayidx1364.lcssa = phi ptr [ %arrayidx1364, %do.body1389.loopexit ], [ %arrayidx13643499, %for.cond1346.preheader ]
  %here.sroa.18.0.copyload2059.lcssa = phi i8 [ %here.sroa.18.0.copyload2059, %do.body1389.loopexit ], [ %here.sroa.18.0.copyload20593501, %for.cond1346.preheader ]
  %here.sroa.42.0.arrayidx1364.sroa_idx = getelementptr inbounds i8, ptr %arrayidx1364.lcssa, i64 2
  %here.sroa.42.0.copyload2084 = load i16, ptr %here.sroa.42.0.arrayidx1364.sroa_idx, align 2, !tbaa.struct !85
  %here.sroa.0.0.copyload2055 = load i8, ptr %arrayidx1364.lcssa, align 2, !tbaa.struct !96
  %sh_prom1392 = zext i8 %here.sroa.18.0.copyload2058.lcssa3471 to i64
  %shr1393 = lshr i64 %hold.40.lcssa, %sh_prom1392
  %sub1396 = sub i32 %bits.40.lcssa, %conv1317.le.pre-phi
  br label %do.body1404

do.body1404:                                      ; preds = %for.end1336, %do.body1389
  %conv1406.pre-phi = phi i32 [ %conv1317.le.pre-phi, %for.end1336 ], [ %.pre3964.pre-phi, %do.body1389 ]
  %221 = phi i32 [ 0, %for.end1336 ], [ %conv1317.le.pre-phi, %do.body1389 ]
  %next.45 = phi ptr [ %next.43.lcssa, %for.end1336 ], [ %next.44.lcssa, %do.body1389 ]
  %have.45 = phi i32 [ %have.43.lcssa, %for.end1336 ], [ %have.44.lcssa, %do.body1389 ]
  %hold.41 = phi i64 [ %hold.39.lcssa, %for.end1336 ], [ %shr1393, %do.body1389 ]
  %bits.41 = phi i32 [ %bits.39.lcssa, %for.end1336 ], [ %sub1396, %do.body1389 ]
  %here.sroa.42.0 = phi i16 [ %here.sroa.42.0.copyload2083.le, %for.end1336 ], [ %here.sroa.42.0.copyload2084, %do.body1389 ]
  %here.sroa.18.0 = phi i8 [ %here.sroa.18.0.copyload2058.lcssa3471, %for.end1336 ], [ %here.sroa.18.0.copyload2059.lcssa, %do.body1389 ]
  %here.sroa.0.0 = phi i8 [ %here.sroa.0.0.copyload2054, %for.end1336 ], [ %here.sroa.0.0.copyload2055, %do.body1389 ]
  %sh_prom1407 = zext i8 %here.sroa.18.0 to i64
  %shr1408 = lshr i64 %hold.41, %sh_prom1407
  %sub1411 = sub i32 %bits.41, %conv1406.pre-phi
  %add1417 = add nuw nsw i32 %221, %conv1406.pre-phi
  store i32 %add1417, ptr %back1306, align 4, !tbaa !31
  %conv1419 = zext i16 %here.sroa.42.0 to i32
  store i32 %conv1419, ptr %length1741, align 4, !tbaa !60
...
if.end1443:                                       ; preds = %if.end1435
  ...
  store i32 %and1446, ptr %extra1447, align 4, !tbaa !44
  store i32 16201, ptr %mode.i, align 8, !tbaa !16
  br label %sw.bb1449

sw.bb1449:                                        ; preds = %for.cond.sw.bb1449_crit_edge, %if.end1443
  %222 = phi i32 [ %.pre3959, %for.cond.sw.bb1449_crit_edge ], [ %and1446, %if.end1443 ]
...
sw.bb1449.if.end1494_crit_edge:                   ; preds = %sw.bb1449
  %.pre3960 = load i32, ptr %length1741, align 4, !tbaa !60
  br label %if.end1494

while.cond1454.preheader:                         ; preds = %sw.bb1449
  %cmp14563515 = icmp ult i32 %bits.42, %222
  br i1 %cmp14563515, label %do.body1459, label %do.end1475

do.body1459:                                      ; preds = %while.cond1454.preheader, %if.end1463
  %bits.433519 = phi i32 [ %add1470, %if.end1463 ], [ %bits.42, %while.cond1454.preheader ]
  %hold.433518 = phi i64 [ %add1469, %if.end1463 ], [ %hold.42, %while.cond1454.preheader ]
  %have.473517 = phi i32 [ %dec1464, %if.end1463 ], [ %have.46, %while.cond1454.preheader ]
  %next.473516 = phi ptr [ %incdec.ptr1465, %if.end1463 ], [ %next.46, %while.cond1454.preheader ]
  %cmp1460 = icmp eq i32 %have.473517, 0
  br i1 %cmp1460, label %do.body1882.loopexit4023, label %if.end1463

if.end1463:                                       ; preds = %do.body1459
  %dec1464 = add i32 %have.473517, -1
  %incdec.ptr1465 = getelementptr inbounds i8, ptr %next.473516, i64 1
  %223 = load i8, ptr %next.473516, align 1, !tbaa !38
  %conv1466 = zext i8 %223 to i64
  %sh_prom1467 = zext i32 %bits.433519 to i64
  %shl1468 = shl i64 %conv1466, %sh_prom1467
  %add1469 = add i64 %shl1468, %hold.433518
  %add1470 = add i32 %bits.433519, 8
  %cmp1456 = icmp ult i32 %add1470, %222
  br i1 %cmp1456, label %do.body1459, label %do.end1475, !llvm.loop !97
...
do.end1475:                                       ; preds = %if.end1463, %while.cond1454.preheader
  ...
  %notmask2895 = shl nsw i32 -1, %222
  %sub1479 = xor i32 %notmask2895, -1
  %and1480 = and i32 %conv1476, %sub1479
  %224 = load i32, ptr %length1741, align 4, !tbaa !60
  %add1482 = add i32 %224, %and1480
  store i32 %add1482, ptr %length1741, align 4, !tbaa !60
...
if.end1494:                                       ; preds = %sw.bb1449.if.end1494_crit_edge, %do.end1475
  %226 = phi i32 [ %add1482, %do.end1475 ], [ %.pre3960, %sw.bb1449.if.end1494_crit_edge ]
  ...
  store i32 %226, ptr %was, align 8, !tbaa !98
...
sw.bb1497:                                        ; preds = %for.cond, %if.end1494
  ...
  %228 = load i32, ptr %distbits, align 4, !tbaa !74
  %notmask2893 = shl nsw i32 -1, %228
  %sub1503 = xor i32 %notmask2893, -1
  %conv15003526 = trunc i64 %hold.45 to i32
  %and15043527 = and i32 %sub1503, %conv15003526
  %idxprom15053528 = zext i32 %and15043527 to i64
  %arrayidx15063529 = getelementptr inbounds %struct.code, ptr %227, i64 %idxprom15053528
  %here.sroa.18.0.arrayidx1506.sroa_idx3530 = getelementptr inbounds i8, ptr %arrayidx15063529, i64 1
  %here.sroa.18.0.copyload20603531 = load i8, ptr %here.sroa.18.0.arrayidx1506.sroa_idx3530, align 1, !tbaa.struct !84
  %conv15083532 = zext i8 %here.sroa.18.0.copyload20603531 to i32
  %cmp1509.not3533 = icmp ult i32 %bits.45, %conv15083532
  br i1 %cmp1509.not3533, label %do.body1513.preheader, label %for.end1527
...
do.body1513:                                      ; preds = %do.body1513.preheader, %if.end1517
  %indvars.iv3915 = phi i64 [ %229, %do.body1513.preheader ], [ %indvars.iv.next3916, %if.end1517 ]
  %hold.463536 = phi i64 [ %hold.45, %do.body1513.preheader ], [ %add1523, %if.end1517 ]
  %have.503535 = phi i32 [ %have.49, %do.body1513.preheader ], [ %dec1518, %if.end1517 ]
  %next.503534 = phi ptr [ %next.49, %do.body1513.preheader ], [ %incdec.ptr1519, %if.end1517 ]
  %cmp1514 = icmp eq i32 %have.503535, 0
  br i1 %cmp1514, label %do.body1882.loopexit4022, label %if.end1517

if.end1517:                                       ; preds = %do.body1513
  %dec1518 = add i32 %have.503535, -1
  %incdec.ptr1519 = getelementptr inbounds i8, ptr %next.503534, i64 1
  %230 = load i8, ptr %next.503534, align 1, !tbaa !38
  %conv1520 = zext i8 %230 to i64
  %shl1522 = shl i64 %conv1520, %indvars.iv3915
  %add1523 = add i64 %shl1522, %hold.463536
  %indvars.iv.next3916 = add nuw nsw i64 %indvars.iv3915, 8
  ...
  %here.sroa.18.0.copyload2060 = load i8, ptr %here.sroa.18.0.arrayidx1506.sroa_idx, align 1, !tbaa.struct !84
  %231 = zext i8 %here.sroa.18.0.copyload2060 to i64
  %cmp1509.not = icmp ult i64 %indvars.iv.next3916, %231
...
for.end1527.loopexit:                             ; preds = %if.end1517
  ...
  %232 = trunc i64 %indvars.iv.next3916 to i32
  br label %for.end1527

for.end1527:                                      ; preds = %for.end1527.loopexit, %sw.bb1497
  %conv1508.le.pre-phi = phi i32 [ %conv1508, %for.end1527.loopexit ], [ %conv15083532, %sw.bb1497 ]
  %arrayidx1506.lcssa3525 = phi ptr [ %arrayidx1506, %for.end1527.loopexit ], [ %arrayidx15063529, %sw.bb1497 ]
  %here.sroa.18.0.copyload2060.lcssa3524 = phi i8 [ %here.sroa.18.0.copyload2060, %for.end1527.loopexit ], [ %here.sroa.18.0.copyload20603531, %sw.bb1497 ]
  %next.50.lcssa = phi ptr [ %incdec.ptr1519, %for.end1527.loopexit ], [ %next.49, %sw.bb1497 ]
  %have.50.lcssa = phi i32 [ %dec1518, %for.end1527.loopexit ], [ %have.49, %sw.bb1497 ]
  %hold.46.lcssa = phi i64 [ %add1523, %for.end1527.loopexit ], [ %hold.45, %sw.bb1497 ]
  %bits.46.lcssa = phi i32 [ %232, %for.end1527.loopexit ], [ %bits.45, %sw.bb1497 ]
  %here.sroa.42.0.arrayidx1506.sroa_idx.le = getelementptr inbounds i8, ptr %arrayidx1506.lcssa3525, i64 2
  %here.sroa.42.0.copyload2085.le = load i16, ptr %here.sroa.42.0.arrayidx1506.sroa_idx.le, align 2, !tbaa.struct !85
  %here.sroa.0.0.copyload2056 = load i8, ptr %arrayidx1506.lcssa3525, align 2, !tbaa.struct !96
...
for.end1527.do.body1592_crit_edge:                ; preds = %for.end1527
  %.pre3961 = load i32, ptr %back1306, align 4, !tbaa !31
...
for.cond1534.preheader:                           ; preds = %for.end1527
  ...
  %add1543 = add nuw nsw i32 %conv1508.le.pre-phi, %conv1529
  %notmask2894 = shl nsw i32 -1, %add1543
  %sub1545 = xor i32 %notmask2894, -1
  %conv15383547 = trunc i64 %hold.46.lcssa to i32
  %and15463548 = and i32 %conv15383547, %sub1545
  %shr15493549 = lshr i32 %and15463548, %conv1508.le.pre-phi
  %add15503550 = add i32 %shr15493549, %conv1537
  %idxprom15513551 = zext i32 %add15503550 to i64
  %arrayidx15523552 = getelementptr inbounds %struct.code, ptr %227, i64 %idxprom15513551
  %here.sroa.18.0.arrayidx1552.sroa_idx3553 = getelementptr inbounds i8, ptr %arrayidx15523552, i64 1
  %here.sroa.18.0.copyload20613554 = load i8, ptr %here.sroa.18.0.arrayidx1552.sroa_idx3553, align 1, !tbaa.struct !84
  %conv15563555 = zext i8 %here.sroa.18.0.copyload20613554 to i32
  %add15573556 = add nuw nsw i32 %conv1508.le.pre-phi, %conv15563555
  %cmp1558.not3557 = icmp ugt i32 %add15573556, %bits.46.lcssa
  br i1 %cmp1558.not3557, label %do.body1562.preheader, label %do.body1577
...
do.body1562:                                      ; preds = %do.body1562.preheader, %if.end1566
  %indvars.iv3919 = phi i64 [ %233, %do.body1562.preheader ], [ %indvars.iv.next3920, %if.end1566 ]
  %hold.473560 = phi i64 [ %hold.46.lcssa, %do.body1562.preheader ], [ %add1572, %if.end1566 ]
  %have.513559 = phi i32 [ %have.50.lcssa, %do.body1562.preheader ], [ %dec1567, %if.end1566 ]
  %next.513558 = phi ptr [ %next.50.lcssa, %do.body1562.preheader ], [ %incdec.ptr1568, %if.end1566 ]
  %cmp1563 = icmp eq i32 %have.513559, 0
  br i1 %cmp1563, label %do.body1882.loopexit4021, label %if.end1566

if.end1566:                                       ; preds = %do.body1562
  %dec1567 = add i32 %have.513559, -1
  %incdec.ptr1568 = getelementptr inbounds i8, ptr %next.513558, i64 1
  %234 = load i8, ptr %next.513558, align 1, !tbaa !38
  %conv1569 = zext i8 %234 to i64
  %shl1571 = shl i64 %conv1569, %indvars.iv3919
  %add1572 = add i64 %shl1571, %hold.473560
  %indvars.iv.next3920 = add nuw nsw i64 %indvars.iv3919, 8
  %conv1538 = trunc i64 %add1572 to i32
  %and1546 = and i32 %conv1538, %sub1545
  %shr1549 = lshr i32 %and1546, %conv1508.le.pre-phi
  ...
  %here.sroa.18.0.copyload2061 = load i8, ptr %here.sroa.18.0.arrayidx1552.sroa_idx, align 1, !tbaa.struct !84
  %conv1556 = zext i8 %here.sroa.18.0.copyload2061 to i32
  %add1557 = add nuw nsw i32 %conv1508.le.pre-phi, %conv1556
  %235 = zext i32 %add1557 to i64
  %cmp1558.not = icmp ult i64 %indvars.iv.next3920, %235
  br i1 %cmp1558.not, label %do.body1562, label %do.body1577.loopexit

do.body1577.loopexit:                             ; preds = %if.end1566
  %conv1556.le = zext i8 %here.sroa.18.0.copyload2061 to i32
  %236 = trunc i64 %indvars.iv.next3920 to i32
  br label %do.body1577

do.body1577:                                      ; preds = %do.body1577.loopexit, %for.cond1534.preheader
  %.pre3965.pre-phi = phi i32 [ %conv1556.le, %do.body1577.loopexit ], [ %conv15563555, %for.cond1534.preheader ]
  %next.51.lcssa = phi ptr [ %incdec.ptr1568, %do.body1577.loopexit ], [ %next.50.lcssa, %for.cond1534.preheader ]
  %have.51.lcssa = phi i32 [ %dec1567, %do.body1577.loopexit ], [ %have.50.lcssa, %for.cond1534.preheader ]
  %hold.47.lcssa = phi i64 [ %add1572, %do.body1577.loopexit ], [ %hold.46.lcssa, %for.cond1534.preheader ]
  %bits.47.lcssa = phi i32 [ %236, %do.body1577.loopexit ], [ %bits.46.lcssa, %for.cond1534.preheader ]
  %arrayidx1552.lcssa = phi ptr [ %arrayidx1552, %do.body1577.loopexit ], [ %arrayidx15523552, %for.cond1534.preheader ]
  %here.sroa.18.0.copyload2061.lcssa = phi i8 [ %here.sroa.18.0.copyload2061, %do.body1577.loopexit ], [ %here.sroa.18.0.copyload20613554, %for.cond1534.preheader ]
  %here.sroa.42.0.arrayidx1552.sroa_idx = getelementptr inbounds i8, ptr %arrayidx1552.lcssa, i64 2
  %here.sroa.42.0.copyload2086 = load i16, ptr %here.sroa.42.0.arrayidx1552.sroa_idx, align 2, !tbaa.struct !85
  %here.sroa.0.0.copyload2057 = load i8, ptr %arrayidx1552.lcssa, align 2, !tbaa.struct !96
  %sh_prom1580 = zext i8 %here.sroa.18.0.copyload2060.lcssa3524 to i64
  %shr1581 = lshr i64 %hold.47.lcssa, %sh_prom1580
  %sub1584 = sub i32 %bits.47.lcssa, %conv1508.le.pre-phi
  %237 = load i32, ptr %back1306, align 4, !tbaa !31
  %add1590 = add nsw i32 %237, %conv1508.le.pre-phi
  br label %do.body1592

do.body1592:                                      ; preds = %for.end1527.do.body1592_crit_edge, %do.body1577
  %conv1594.pre-phi = phi i32 [ %conv1508.le.pre-phi, %for.end1527.do.body1592_crit_edge ], [ %.pre3965.pre-phi, %do.body1577 ]
  %238 = phi i32 [ %.pre3961, %for.end1527.do.body1592_crit_edge ], [ %add1590, %do.body1577 ]
  %next.52 = phi ptr [ %next.50.lcssa, %for.end1527.do.body1592_crit_edge ], [ %next.51.lcssa, %do.body1577 ]
  %have.52 = phi i32 [ %have.50.lcssa, %for.end1527.do.body1592_crit_edge ], [ %have.51.lcssa, %do.body1577 ]
  %hold.48 = phi i64 [ %hold.46.lcssa, %for.end1527.do.body1592_crit_edge ], [ %shr1581, %do.body1577 ]
  %bits.48 = phi i32 [ %bits.46.lcssa, %for.end1527.do.body1592_crit_edge ], [ %sub1584, %do.body1577 ]
  %here.sroa.42.1 = phi i16 [ %here.sroa.42.0.copyload2085.le, %for.end1527.do.body1592_crit_edge ], [ %here.sroa.42.0.copyload2086, %do.body1577 ]
  %here.sroa.18.1 = phi i8 [ %here.sroa.18.0.copyload2060.lcssa3524, %for.end1527.do.body1592_crit_edge ], [ %here.sroa.18.0.copyload2061.lcssa, %do.body1577 ]
  %here.sroa.0.1 = phi i8 [ %here.sroa.0.0.copyload2056, %for.end1527.do.body1592_crit_edge ], [ %here.sroa.0.0.copyload2057, %do.body1577 ]
  %sh_prom1595 = zext i8 %here.sroa.18.1 to i64
  %shr1596 = lshr i64 %hold.48, %sh_prom1595
  %sub1599 = sub i32 %bits.48, %conv1594.pre-phi
  %add1605 = add nsw i32 %238, %conv1594.pre-phi
...
if.end1613:                                       ; preds = %do.body1592
  ...
  store i32 %conv1615, ptr %offset, align 8, !tbaa !99
  %and1618 = and i32 %conv1607, 15
  store i32 %and1618, ptr %extra1447, align 4, !tbaa !44
  store i32 16203, ptr %mode.i, align 8, !tbaa !16
  br label %sw.bb1621

sw.bb1621:                                        ; preds = %for.cond.sw.bb1621_crit_edge, %if.end1613
  %239 = phi i32 [ %.pre3962, %for.cond.sw.bb1621_crit_edge ], [ %and1618, %if.end1613 ]
...
while.cond1626.preheader:                         ; preds = %sw.bb1621
  %cmp16283568 = icmp ult i32 %bits.49, %239
  br i1 %cmp16283568, label %do.body1631, label %do.end1647

do.body1631:                                      ; preds = %while.cond1626.preheader, %if.end1635
  %bits.503572 = phi i32 [ %add1642, %if.end1635 ], [ %bits.49, %while.cond1626.preheader ]
  %hold.503571 = phi i64 [ %add1641, %if.end1635 ], [ %hold.49, %while.cond1626.preheader ]
  %have.543570 = phi i32 [ %dec1636, %if.end1635 ], [ %have.53, %while.cond1626.preheader ]
  %next.543569 = phi ptr [ %incdec.ptr1637, %if.end1635 ], [ %next.53, %while.cond1626.preheader ]
  %cmp1632 = icmp eq i32 %have.543570, 0
  br i1 %cmp1632, label %do.body1882.loopexit4020, label %if.end1635

if.end1635:                                       ; preds = %do.body1631
  %dec1636 = add i32 %have.543570, -1
  %incdec.ptr1637 = getelementptr inbounds i8, ptr %next.543569, i64 1
  %240 = load i8, ptr %next.543569, align 1, !tbaa !38
  %conv1638 = zext i8 %240 to i64
  %sh_prom1639 = zext i32 %bits.503572 to i64
  %shl1640 = shl i64 %conv1638, %sh_prom1639
  %add1641 = add i64 %shl1640, %hold.503571
  %add1642 = add i32 %bits.503572, 8
  %cmp1628 = icmp ult i32 %add1642, %239
  br i1 %cmp1628, label %do.body1631, label %do.end1647, !llvm.loop !100
...
do.end1647:                                       ; preds = %if.end1635, %while.cond1626.preheader
  ...
  %241 = load i32, ptr %offset, align 8, !tbaa !99
  %add1654 = add i32 %241, %and1652
  store i32 %add1654, ptr %offset, align 8, !tbaa !99
...
sw.bb1668:                                        ; preds = %for.cond, %if.end1666
  ...
  br i1 %cmp1669, label %do.body1882.loopexit4487, label %if.end1672

if.end1672:                                       ; preds = %sw.bb1668
  %sub1673 = sub i32 %out.0, %left.0
  %243 = load i32, ptr %offset, align 8, !tbaa !99
...
if.end1703:                                       ; preds = %if.else1697, %if.then1691
  ...
  %.sink4242 = load ptr, ptr %window1698, align 8, !tbaa !35
  %idx.ext1701 = zext i32 %sub1700.sink to i64
  %add.ptr1702 = getelementptr inbounds i8, ptr %.sink4242, i64 %idx.ext1701
  %248 = load i32, ptr %length1741, align 4, !tbaa !60
  %spec.select2905 = call i32 @llvm.umin.i32(i32 %copy.7, i32 %248)
  br label %if.end1715
...
if.else1710:                                      ; preds = %if.end1672
  ...
  %249 = load i32, ptr %length1741, align 4, !tbaa !60
  br label %if.end1715

if.end1715:                                       ; preds = %if.end1703, %if.else1710
  %250 = phi i32 [ %249, %if.else1710 ], [ %248, %if.end1703 ]
  %copy.8 = phi i32 [ %249, %if.else1710 ], [ %spec.select2905, %if.end1703 ]
  %from.1 = phi ptr [ %add.ptr1713, %if.else1710 ], [ %add.ptr1702, %if.end1703 ]
  %spec.select2906 = call i32 @llvm.umin.i32(i32 %copy.8, i32 %left.0)
  %sub1722 = sub i32 %250, %spec.select2906
  store i32 %sub1722, ptr %length1741, align 4, !tbaa !60
  %251 = add i32 %spec.select2906, -1
  %252 = zext i32 %251 to i64
  %253 = add nuw nsw i64 %252, 1
  %min.iters.check = icmp ult i32 %251, 31
  %from.14459 = ptrtoint ptr %from.1 to i64
  %254 = sub i64 %put.04458, %from.14459
  %diff.check = icmp ult i64 %254, 32
  %or.cond4484 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond4484, label %do.body1723.preheader, label %vector.ph

vector.ph:                                        ; preds = %if.end1715
  %n.vec = and i64 %253, -32
  %ind.end = getelementptr i8, ptr %put.0, i64 %n.vec
  %.cast = trunc i64 %n.vec to i32
  %ind.end4460 = sub i32 %spec.select2906, %.cast
  %ind.end4462 = getelementptr i8, ptr %from.1, i64 %n.vec
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %next.gep = getelementptr i8, ptr %put.0, i64 %index
  %next.gep4465 = getelementptr i8, ptr %from.1, i64 %index
  %wide.load = load <16 x i8>, ptr %next.gep4465, align 1, !tbaa !38
  %255 = getelementptr i8, ptr %next.gep4465, i64 16
  %wide.load4467 = load <16 x i8>, ptr %255, align 1, !tbaa !38
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !38
  %256 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load4467, ptr %256, align 1, !tbaa !38
  %index.next = add nuw i64 %index, 32
  %257 = icmp eq i64 %index.next, %n.vec
  br i1 %257, label %middle.block, label %vector.body, !llvm.loop !101
...
do.body1723.preheader:                            ; preds = %if.end1715, %middle.block
  ...
  %copy.10.ph = phi i32 [ %spec.select2906, %if.end1715 ], [ %ind.end4460, %middle.block ]
  %from.2.ph = phi ptr [ %from.1, %if.end1715 ], [ %ind.end4462, %middle.block ]
  %258 = add i32 %copy.10.ph, -1
  %xtraiter4697 = and i32 %copy.10.ph, 7
  %lcmp.mod4698.not = icmp eq i32 %xtraiter4697, 0
  br i1 %lcmp.mod4698.not, label %do.body1723.prol.loopexit, label %do.body1723.prol
...
do.body1723.prol:                                 ; preds = %do.body1723.preheader, %do.body1723.prol
  ...
  %prol.iter4699 = phi i32 [ %prol.iter4699.next, %do.body1723.prol ], [ 0, %do.body1723.preheader ]
  ...
  %prol.iter4699.next = add i32 %prol.iter4699, 1
  %prol.iter4699.cmp.not = icmp eq i32 %prol.iter4699.next, %xtraiter4697
  br i1 %prol.iter4699.cmp.not, label %do.body1723.prol.loopexit, label %do.body1723.prol, !llvm.loop !102

do.body1723.prol.loopexit:                        ; preds = %do.body1723.prol, %do.body1723.preheader
  %incdec.ptr1725.lcssa4539.unr = phi ptr [ undef, %do.body1723.preheader ], [ %incdec.ptr1725.prol, %do.body1723.prol ]
...
do.body1723:                                      ; preds = %do.body1723.prol.loopexit, %do.body1723
  ...
  br i1 %tobool1728.not.7, label %do.end1729, label %do.body1723, !llvm.loop !103

do.end1729:                                       ; preds = %do.body1723.prol.loopexit, %do.body1723, %middle.block
  %incdec.ptr1725.lcssa = phi ptr [ %ind.end, %middle.block ], [ %incdec.ptr1725.lcssa4539.unr, %do.body1723.prol.loopexit ], [ %incdec.ptr1725.7, %do.body1723 ]
  %sub1720 = sub i32 %left.0, %spec.select2906
  %269 = load i32, ptr %length1741, align 4, !tbaa !60
...
sw.bb1736:                                        ; preds = %for.cond
  ...
  br i1 %cmp1737, label %do.body1882.loopexit4487, label %if.end1740

if.end1740:                                       ; preds = %sw.bb1736
  %270 = load i32, ptr %length1741, align 4, !tbaa !60
...
while.cond1751.preheader:                         ; preds = %sw.bb1746
  %cmp17523358 = icmp ult i32 %bits.0, 32
  br i1 %cmp17523358, label %do.body1755.preheader, label %do.end1771

do.body1755.preheader:                            ; preds = %while.cond1751.preheader
  %272 = zext i32 %bits.0 to i64
  %cmp1756 = icmp eq i32 %have.0, 0
  br i1 %cmp1756, label %do.body1882.loopexit3674.split.loop.exit4914, label %if.end1759
...
if.end1759:                                       ; preds = %do.body1755.preheader
  ...
  br i1 %cmp1752, label %do.body1755.1, label %do.end1771.loopexit, !llvm.loop !104

do.body1755.1:                                    ; preds = %if.end1759
  %cmp1756.1 = icmp eq i32 %dec1760, 0
  br i1 %cmp1756.1, label %do.body1882.loopexit3674, label %if.end1759.1
...
if.end1759.1:                                     ; preds = %do.body1755.1
  ...
  br i1 %cmp1752.1, label %do.body1755.2, label %do.end1771.loopexit, !llvm.loop !104

do.body1755.2:                                    ; preds = %if.end1759.1
  %cmp1756.2 = icmp eq i32 %dec1760.1, 0
  br i1 %cmp1756.2, label %do.body1882.loopexit3674, label %if.end1759.2
...
if.end1759.2:                                     ; preds = %do.body1755.2
  ...
  br i1 %cmp1752.2, label %do.body1755.3, label %do.end1771.loopexit, !llvm.loop !104

do.body1755.3:                                    ; preds = %if.end1759.2
  %cmp1756.3 = icmp eq i32 %dec1760.2, 0
  br i1 %cmp1756.3, label %do.body1882.loopexit3674, label %if.end1759.3
...
do.end1771:                                       ; preds = %do.end1771.loopexit, %while.cond1751.preheader
  ...
  %278 = load i64, ptr %total_out, align 8, !tbaa !105
  %add1774 = add i64 %278, %conv1773
  store i64 %add1774, ptr %total_out, align 8, !tbaa !105
...
if.then1782:                                      ; preds = %do.end1771
  %280 = load i32, ptr %flags1783, align 8, !tbaa !49
  %tobool1784.not = icmp eq i32 %280, 0
  %281 = load i64, ptr %check1786, align 8, !tbaa !48
...
cond.end1797:                                     ; preds = %cond.false1791, %cond.true1785
  ...
  store i64 %cond1798, ptr %check1786, align 8, !tbaa !48
  store i64 %cond1798, ptr %adler1800, align 8, !tbaa !20
  %.pre3953 = load i32, ptr %wrap1747, align 8, !tbaa !19
  %.pre3966 = and i32 %.pre3953, 4
  br label %if.end1801

if.end1801:                                       ; preds = %cond.end1797, %do.end1771
  %and1803.pre-phi = phi i32 [ %.pre3966, %cond.end1797 ], [ %and1778, %do.end1771 ]
  %282 = phi i32 [ %.pre3953, %cond.end1797 ], [ %271, %do.end1771 ]
...
land.lhs.true1805:                                ; preds = %if.end1801
  %283 = load i32, ptr %flags1783, align 8, !tbaa !49
  ...
  %284 = load i64, ptr %check1786, align 8, !tbaa !48
...
sw.bb1835:                                        ; preds = %for.cond.sw.bb1835_crit_edge, %if.end1833
  %286 = phi i32 [ %.pre3954, %for.cond.sw.bb1835_crit_edge ], [ %285, %if.end1833 ]
...
land.lhs.true1838:                                ; preds = %sw.bb1835
  %287 = load i32, ptr %flags1783, align 8, !tbaa !49
...
while.cond1843.preheader:                         ; preds = %land.lhs.true1838
  %cmp18443366 = icmp ult i32 %bits.55, 32
  br i1 %cmp18443366, label %do.body1847.preheader, label %do.end1863

do.body1847.preheader:                            ; preds = %while.cond1843.preheader
  %288 = zext i32 %bits.55 to i64
  %cmp1848 = icmp eq i32 %have.59, 0
  br i1 %cmp1848, label %do.body1882.loopexit3673.split.loop.exit4890, label %if.end1851
...
if.end1851:                                       ; preds = %do.body1847.preheader
  ...
  %indvars.iv.next3882 = add nuw nsw i64 %288, 8
  %cmp1844 = icmp ult i32 %bits.55, 24
  br i1 %cmp1844, label %do.body1847.1, label %do.end1863.loopexit, !llvm.loop !106

do.body1847.1:                                    ; preds = %if.end1851
  %cmp1848.1 = icmp eq i32 %dec1852, 0
  br i1 %cmp1848.1, label %do.body1882.loopexit3673, label %if.end1851.1
...
if.end1851.1:                                     ; preds = %do.body1847.1
  ...
  %shl1856.1 = shl nuw nsw i64 %conv1854.1, %indvars.iv.next3882
  %add1857.1 = add i64 %shl1856.1, %add1857
  %indvars.iv.next3882.1 = add nuw nsw i64 %288, 16
  %cmp1844.1 = icmp ult i32 %bits.55, 16
  br i1 %cmp1844.1, label %do.body1847.2, label %do.end1863.loopexit, !llvm.loop !106

do.body1847.2:                                    ; preds = %if.end1851.1
  %cmp1848.2 = icmp eq i32 %dec1852.1, 0
  br i1 %cmp1848.2, label %do.body1882.loopexit3673, label %if.end1851.2
...
if.end1851.2:                                     ; preds = %do.body1847.2
  ...
  %shl1856.2 = shl nuw nsw i64 %conv1854.2, %indvars.iv.next3882.1
  %add1857.2 = add i64 %shl1856.2, %add1857.1
  %indvars.iv.next3882.2 = add nuw nsw i64 %288, 24
  %cmp1844.2 = icmp ult i32 %bits.55, 8
  br i1 %cmp1844.2, label %do.body1847.3, label %do.end1863.loopexit, !llvm.loop !106

do.body1847.3:                                    ; preds = %if.end1851.2
  %cmp1848.3 = icmp eq i32 %dec1852.2, 0
  br i1 %cmp1848.3, label %do.body1882.loopexit3673, label %if.end1851.3
...
if.end1851.3:                                     ; preds = %do.body1847.3
  ...
  %shl1856.3 = shl nuw nsw i64 %conv1854.3, %indvars.iv.next3882.2
  %add1857.3 = add i64 %shl1856.3, %add1857.2
  %indvars.iv.next3882.3 = add nuw nsw i64 %288, 32
...
do.end1863.loopexit:                              ; preds = %if.end1851.3, %if.end1851.2, %if.end1851.1, %if.end1851
  ...
  %indvars.iv.next3882.lcssa = phi i64 [ %indvars.iv.next3882, %if.end1851 ], [ %indvars.iv.next3882.1, %if.end1851.1 ], [ %indvars.iv.next3882.2, %if.end1851.2 ], [ %indvars.iv.next3882.3, %if.end1851.3 ]
  %293 = trunc i64 %indvars.iv.next3882.lcssa to i32
  br label %do.end1863
...
do.body1882.loopexit:                             ; preds = %do.body1157
  %295 = trunc i64 %indvars.iv3903 to i32
  br label %do.body1882

do.body1882.loopexit3654:                         ; preds = %do.body1051
  %296 = trunc i64 %indvars.iv3900 to i32
  br label %do.body1882

do.body1882.loopexit3655:                         ; preds = %do.body1113
  %297 = trunc i64 %indvars.iv3897 to i32
  br label %do.body1882

do.body1882.loopexit3657.split.loop.exit4930:     ; preds = %do.body21.preheader
  %298 = zext i32 %bits.0 to i64
  br label %do.body1882.loopexit3657

do.body1882.loopexit3657:                         ; preds = %do.body21.1, %do.body1882.loopexit3657.split.loop.exit4930
  %indvars.iv3950.lcssa = phi i64 [ %298, %do.body1882.loopexit3657.split.loop.exit4930 ], [ %indvars.iv.next3951, %do.body21.1 ]
  %hold.13648.lcssa = phi i64 [ %hold.0, %do.body1882.loopexit3657.split.loop.exit4930 ], [ %add, %do.body21.1 ]
  %next.13646.lcssa = phi ptr [ %next.0, %do.body1882.loopexit3657.split.loop.exit4930 ], [ %incdec.ptr, %do.body21.1 ]
  %299 = trunc i64 %indvars.iv3950.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3658.split.loop.exit4922:     ; preds = %do.body584.preheader
  %300 = zext i32 %bits.13 to i64
  br label %do.body1882.loopexit3658

do.body1882.loopexit3658:                         ; preds = %do.body584.1, %do.body1882.loopexit3658.split.loop.exit4922
  %indvars.iv3947.lcssa = phi i64 [ %300, %do.body1882.loopexit3658.split.loop.exit4922 ], [ %indvars.iv.next3948, %do.body584.1 ]
  %hold.143639.lcssa = phi i64 [ %hold.13, %do.body1882.loopexit3658.split.loop.exit4922 ], [ %add594, %do.body584.1 ]
  %next.183637.lcssa = phi ptr [ %next.17, %do.body1882.loopexit3658.split.loop.exit4922 ], [ %incdec.ptr590, %do.body584.1 ]
  %301 = trunc i64 %indvars.iv3947.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3659.split.loop.exit5007:     ; preds = %do.body318.preheader
  %302 = zext i32 %bits.739984004 to i64
  br label %do.body1882.loopexit3659

do.body1882.loopexit3659:                         ; preds = %do.body318.1, %do.body1882.loopexit3659.split.loop.exit5007
  %indvars.iv3938.lcssa = phi i64 [ %302, %do.body1882.loopexit3659.split.loop.exit5007 ], [ %indvars.iv.next3939, %do.body318.1 ]
  %hold.83631.lcssa = phi i64 [ %hold.739964005, %do.body1882.loopexit3659.split.loop.exit5007 ], [ %add328, %do.body318.1 ]
  %next.83629.lcssa = phi ptr [ %next.739924007, %do.body1882.loopexit3659.split.loop.exit5007 ], [ %incdec.ptr324, %do.body318.1 ]
  %303 = trunc i64 %indvars.iv3938.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3660.split.loop.exit5015:     ; preds = %do.body255.preheader
  %304 = zext i32 %bits.53984 to i64
  br label %do.body1882.loopexit3660

do.body1882.loopexit3660:                         ; preds = %do.body255.1, %do.body1882.loopexit3660.split.loop.exit5015
  %indvars.iv3935.lcssa = phi i64 [ %304, %do.body1882.loopexit3660.split.loop.exit5015 ], [ %indvars.iv.next3936, %do.body255.1 ]
  %hold.63623.lcssa = phi i64 [ %hold.53983, %do.body1882.loopexit3660.split.loop.exit5015 ], [ %add265, %do.body255.1 ]
  %next.63621.lcssa = phi ptr [ %next.53981, %do.body1882.loopexit3660.split.loop.exit5015 ], [ %incdec.ptr261, %do.body255.1 ]
  %305 = trunc i64 %indvars.iv3935.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3661.split.loop.exit5039:     ; preds = %do.body195.preheader
  %306 = zext i32 %bits.33975 to i64
  br label %do.body1882.loopexit3661

do.body1882.loopexit3661:                         ; preds = %do.body195.1, %do.body195.2, %do.body195.3, %do.body1882.loopexit3661.split.loop.exit5039
  %indvars.iv3932.lcssa = phi i64 [ %306, %do.body1882.loopexit3661.split.loop.exit5039 ], [ %indvars.iv.next3933.2, %do.body195.3 ], [ %indvars.iv.next3933.1, %do.body195.2 ], [ %indvars.iv.next3933, %do.body195.1 ]
  %hold.43615.lcssa = phi i64 [ %hold.33974, %do.body1882.loopexit3661.split.loop.exit5039 ], [ %add205.2, %do.body195.3 ], [ %add205.1, %do.body195.2 ], [ %add205, %do.body195.1 ]
  %next.43613.lcssa = phi ptr [ %next.33972, %do.body1882.loopexit3661.split.loop.exit5039 ], [ %incdec.ptr201.2, %do.body195.3 ], [ %incdec.ptr201.1, %do.body195.2 ], [ %incdec.ptr201, %do.body195.1 ]
  %307 = trunc i64 %indvars.iv3932.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3662.split.loop.exit4998:     ; preds = %do.body121.preheader
  %308 = zext i32 %bits.0 to i64
  br label %do.body1882.loopexit3662

do.body1882.loopexit3662:                         ; preds = %do.body121.1, %do.body1882.loopexit3662.split.loop.exit4998
  %indvars.iv3929.lcssa = phi i64 [ %308, %do.body1882.loopexit3662.split.loop.exit4998 ], [ %indvars.iv.next3930, %do.body121.1 ]
  %hold.23606.lcssa = phi i64 [ %hold.0, %do.body1882.loopexit3662.split.loop.exit4998 ], [ %add131, %do.body121.1 ]
  %next.23604.lcssa = phi ptr [ %next.0, %do.body1882.loopexit3662.split.loop.exit4998 ], [ %incdec.ptr127, %do.body121.1 ]
  %309 = trunc i64 %indvars.iv3929.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3663.split.loop.exit4989:     ; preds = %do.body638.preheader
  %310 = zext i32 %bits.0 to i64
  br label %do.body1882.loopexit3663

do.body1882.loopexit3663:                         ; preds = %do.body638.1, %do.body638.2, %do.body638.3, %do.body1882.loopexit3663.split.loop.exit4989
  %indvars.iv3926.lcssa = phi i64 [ %310, %do.body1882.loopexit3663.split.loop.exit4989 ], [ %indvars.iv.next3927.2, %do.body638.3 ], [ %indvars.iv.next3927.1, %do.body638.2 ], [ %indvars.iv.next3927, %do.body638.1 ]
  %hold.163589.lcssa = phi i64 [ %hold.0, %do.body1882.loopexit3663.split.loop.exit4989 ], [ %add648.2, %do.body638.3 ], [ %add648.1, %do.body638.2 ], [ %add648, %do.body638.1 ]
  %next.203587.lcssa = phi ptr [ %next.0, %do.body1882.loopexit3663.split.loop.exit4989 ], [ %incdec.ptr644.2, %do.body638.3 ], [ %incdec.ptr644.1, %do.body638.2 ], [ %incdec.ptr644, %do.body638.1 ]
  %311 = trunc i64 %indvars.iv3926.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3664.split.loop.exit4964:     ; preds = %do.body781.preheader
  %312 = zext i32 %117 to i64
  br label %do.body1882.loopexit3664

do.body1882.loopexit3664:                         ; preds = %do.body781.1, %do.body781.2, %do.body781.3, %do.body1882.loopexit3664.split.loop.exit4964
  %indvars.iv3924.lcssa = phi i64 [ %312, %do.body1882.loopexit3664.split.loop.exit4964 ], [ %indvars.iv.next3925.2, %do.body781.3 ], [ %indvars.iv.next3925.1, %do.body781.2 ], [ %indvars.iv.next3925, %do.body781.1 ]
  %hold.213580.lcssa = phi i64 [ %shr771, %do.body1882.loopexit3664.split.loop.exit4964 ], [ %add791.2, %do.body781.3 ], [ %add791.1, %do.body781.2 ], [ %add791, %do.body781.1 ]
  %next.253578.lcssa = phi ptr [ %next.0, %do.body1882.loopexit3664.split.loop.exit4964 ], [ %incdec.ptr787.2, %do.body781.3 ], [ %incdec.ptr787.1, %do.body781.2 ], [ %incdec.ptr787, %do.body781.1 ]
  %313 = trunc i64 %indvars.iv3924.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3672.split.loop.exit4939:     ; preds = %do.body852.preheader
  %314 = zext i32 %bits.0 to i64
  br label %do.body1882.loopexit3672

do.body1882.loopexit3672:                         ; preds = %do.body852.1, %do.body1882.loopexit3672.split.loop.exit4939
  %indvars.iv3884.lcssa = phi i64 [ %314, %do.body1882.loopexit3672.split.loop.exit4939 ], [ %indvars.iv.next3885, %do.body852.1 ]
  %hold.243378.lcssa = phi i64 [ %hold.0, %do.body1882.loopexit3672.split.loop.exit4939 ], [ %add862, %do.body852.1 ]
  %next.283376.lcssa = phi ptr [ %next.0, %do.body1882.loopexit3672.split.loop.exit4939 ], [ %incdec.ptr858, %do.body852.1 ]
  %315 = trunc i64 %indvars.iv3884.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3673.split.loop.exit4890:     ; preds = %do.body1847.preheader
  %316 = zext i32 %bits.55 to i64
  br label %do.body1882.loopexit3673

do.body1882.loopexit3673:                         ; preds = %do.body1847.1, %do.body1847.2, %do.body1847.3, %do.body1882.loopexit3673.split.loop.exit4890
  %indvars.iv3881.lcssa = phi i64 [ %316, %do.body1882.loopexit3673.split.loop.exit4890 ], [ %indvars.iv.next3882.2, %do.body1847.3 ], [ %indvars.iv.next3882.1, %do.body1847.2 ], [ %indvars.iv.next3882, %do.body1847.1 ]
  %hold.563369.lcssa = phi i64 [ %hold.55, %do.body1882.loopexit3673.split.loop.exit4890 ], [ %add1857.2, %do.body1847.3 ], [ %add1857.1, %do.body1847.2 ], [ %add1857, %do.body1847.1 ]
  %next.603367.lcssa = phi ptr [ %next.59, %do.body1882.loopexit3673.split.loop.exit4890 ], [ %incdec.ptr1853.2, %do.body1847.3 ], [ %incdec.ptr1853.1, %do.body1847.2 ], [ %incdec.ptr1853, %do.body1847.1 ]
  %317 = trunc i64 %indvars.iv3881.lcssa to i32
  br label %do.body1882

do.body1882.loopexit3674.split.loop.exit4914:     ; preds = %do.body1755.preheader
  %318 = zext i32 %bits.0 to i64
  br label %do.body1882.loopexit3674

do.body1882.loopexit3674:                         ; preds = %do.body1755.1, %do.body1755.2, %do.body1755.3, %do.body1882.loopexit3674.split.loop.exit4914
  %indvars.iv.lcssa = phi i64 [ %318, %do.body1882.loopexit3674.split.loop.exit4914 ], [ %indvars.iv.next.2, %do.body1755.3 ], [ %indvars.iv.next.1, %do.body1755.2 ], [ %indvars.iv.next, %do.body1755.1 ]
  %hold.533361.lcssa = phi i64 [ %hold.0, %do.body1882.loopexit3674.split.loop.exit4914 ], [ %add1765.2, %do.body1755.3 ], [ %add1765.1, %do.body1755.2 ], [ %add1765, %do.body1755.1 ]
  %next.573359.lcssa = phi ptr [ %next.0, %do.body1882.loopexit3674.split.loop.exit4914 ], [ %incdec.ptr1761.2, %do.body1755.3 ], [ %incdec.ptr1761.1, %do.body1755.2 ], [ %incdec.ptr1761, %do.body1755.1 ]
  %319 = trunc i64 %indvars.iv.lcssa to i32
  br label %do.body1882

do.body1882.loopexit4019:                         ; preds = %do.body1003
  %320 = zext i32 %have.333463 to i64
  %321 = shl i32 %have.333463, 3
  %322 = add i32 %321, %bits.293465
  %uglygep.le = getelementptr i8, ptr %next.333462, i64 %320
  br label %do.body1882

do.body1882.loopexit4020:                         ; preds = %do.body1631
  %323 = shl i32 %have.53, 3
  %324 = add i32 %bits.49, %323
  %325 = zext i32 %have.53 to i64
  %uglygep3923.le = getelementptr i8, ptr %next.53, i64 %325
  br label %do.body1882

do.body1882.loopexit4021:                         ; preds = %do.body1562
  %326 = zext i32 %have.50.lcssa to i64
  %327 = shl i32 %have.50.lcssa, 3
  %328 = add i32 %327, %bits.46.lcssa
  %uglygep3921.le = getelementptr i8, ptr %next.50.lcssa, i64 %326
  br label %do.body1882

do.body1882.loopexit4022:                         ; preds = %do.body1513
  %329 = zext i32 %have.49 to i64
  %330 = shl i32 %have.49, 3
  %331 = add i32 %330, %bits.45
  %uglygep3917.le = getelementptr i8, ptr %next.49, i64 %329
  br label %do.body1882

do.body1882.loopexit4023:                         ; preds = %do.body1459
  %332 = shl i32 %have.46, 3
  %333 = add i32 %bits.42, %332
  %334 = zext i32 %have.46 to i64
  %uglygep3914.le = getelementptr i8, ptr %next.46, i64 %334
  br label %do.body1882

do.body1882.loopexit4024:                         ; preds = %do.body1374
  %335 = zext i32 %have.43.lcssa to i64
  %336 = shl i32 %have.43.lcssa, 3
  %337 = add i32 %336, %bits.39.lcssa
  %uglygep3912.le = getelementptr i8, ptr %next.43.lcssa, i64 %335
  br label %do.body1882

do.body1882.loopexit4025:                         ; preds = %do.body1322
  %338 = zext i32 %have.42 to i64
  %339 = shl i32 %have.42, 3
  %340 = add i32 %339, %bits.38
  %uglygep3908.le = getelementptr i8, ptr %next.42, i64 %338
  br label %do.body1882

do.body1882.loopexit4487:                         ; preds = %sw.bb1736, %sw.bb1668, %if.end1267, %if.then822, %if.end805, %sw.bb690, %if.end557, %if.then508, %if.end486, %if.then441, %if.end429, %for.cond
  %left.03849.ph = phi i32 [ 0, %sw.bb1736 ], [ 0, %sw.bb1668 ], [ %left.0, %if.end1267 ], [ %left.0, %if.then822 ], [ %left.0, %if.end805 ], [ %left.0, %sw.bb690 ], [ %left.0, %if.end557 ], [ %left.0, %if.then508 ], [ %left.0, %if.end486 ], [ %left.0, %if.then441 ], [ %left.0, %if.end429 ], [ %left.0, %for.cond ]
...
do.body1882:                                      ; preds = %do.body918, %do.body717, %for.cond, %do.body1882.loopexit4487, %do.body1882.loopexit4025, %do.body1882.loopexit4024, %do.body1882.loopexit4023, %do.body1882.loopexit4022, %do.body1882.loopexit4021, %do.body1882.loopexit4020, %do.body1882.loopexit4019, %do.body1882.loopexit3674, %do.body1882.loopexit3673, %do.body1882.loopexit3672, %do.body1882.loopexit3664, %do.body1882.loopexit3663, %do.body1882.loopexit3662, %do.body1882.loopexit3661, %do.body1882.loopexit3660, %do.body1882.loopexit3659, %do.body1882.loopexit3658, %do.body1882.loopexit3657, %do.body1882.loopexit3655, %do.body1882.loopexit3654, %do.body1882.loopexit, %if.end1875, %do.body751
  %left.03849 = phi i32 [ %left.0, %do.body751 ], [ %left.0, %if.end1875 ], [ %left.0, %do.body1882.loopexit ], [ %left.0, %do.body1882.loopexit3654 ], [ %left.0, %do.body1882.loopexit3655 ], [ %left.0, %do.body1882.loopexit3657 ], [ %left.0, %do.body1882.loopexit3658 ], [ %left.0, %do.body1882.loopexit3659 ], [ %left.0, %do.body1882.loopexit3660 ], [ %left.0, %do.body1882.loopexit3661 ], [ %left.0, %do.body1882.loopexit3662 ], [ %left.0, %do.body1882.loopexit3663 ], [ %left.0, %do.body1882.loopexit3664 ], [ %left.0, %do.body1882.loopexit3672 ], [ %left.0, %do.body1882.loopexit3673 ], [ %left.0, %do.body1882.loopexit3674 ], [ %left.0, %do.body1882.loopexit4019 ], [ %left.0, %do.body1882.loopexit4020 ], [ %left.0, %do.body1882.loopexit4021 ], [ %left.0, %do.body1882.loopexit4022 ], [ %left.0, %do.body1882.loopexit4023 ], [ %left.0, %do.body1882.loopexit4024 ], [ %left.0, %do.body1882.loopexit4025 ], [ %left.03849.ph, %do.body1882.loopexit4487 ], [ %left.0, %for.cond ], [ %left.0, %do.body717 ], [ %left.0, %do.body918 ]
  %next.64 = phi ptr [ %next.24.lcssa, %do.body751 ], [ %next.61, %if.end1875 ], [ %next.373447, %do.body1882.loopexit ], [ %next.353438, %do.body1882.loopexit3654 ], [ %next.363429, %do.body1882.loopexit3655 ], [ %next.13646.lcssa, %do.body1882.loopexit3657 ], [ %next.183637.lcssa, %do.body1882.loopexit3658 ], [ %next.83629.lcssa, %do.body1882.loopexit3659 ], [ %next.63621.lcssa, %do.body1882.loopexit3660 ], [ %next.43613.lcssa, %do.body1882.loopexit3661 ], [ %next.23604.lcssa, %do.body1882.loopexit3662 ], [ %next.203587.lcssa, %do.body1882.loopexit3663 ], [ %next.253578.lcssa, %do.body1882.loopexit3664 ], [ %next.283376.lcssa, %do.body1882.loopexit3672 ], [ %next.603367.lcssa, %do.body1882.loopexit3673 ], [ %next.573359.lcssa, %do.body1882.loopexit3674 ], [ %uglygep.le, %do.body1882.loopexit4019 ], [ %uglygep3923.le, %do.body1882.loopexit4020 ], [ %uglygep3921.le, %do.body1882.loopexit4021 ], [ %uglygep3917.le, %do.body1882.loopexit4022 ], [ %uglygep3914.le, %do.body1882.loopexit4023 ], [ %uglygep3912.le, %do.body1882.loopexit4024 ], [ %uglygep3908.le, %do.body1882.loopexit4025 ], [ %next.64.ph, %do.body1882.loopexit4487 ], [ %next.23, %do.body717 ], [ %next.0, %for.cond ], [ %next.303396, %do.body918 ]
  %have.64 = phi i32 [ %have.24.lcssa, %do.body751 ], [ %have.61, %if.end1875 ], [ 0, %do.body1882.loopexit ], [ 0, %do.body1882.loopexit3654 ], [ 0, %do.body1882.loopexit3655 ], [ 0, %do.body1882.loopexit3657 ], [ 0, %do.body1882.loopexit3658 ], [ 0, %do.body1882.loopexit3659 ], [ 0, %do.body1882.loopexit3660 ], [ 0, %do.body1882.loopexit3661 ], [ 0, %do.body1882.loopexit3662 ], [ 0, %do.body1882.loopexit3663 ], [ 0, %do.body1882.loopexit3664 ], [ 0, %do.body1882.loopexit3672 ], [ 0, %do.body1882.loopexit3673 ], [ 0, %do.body1882.loopexit3674 ], [ 0, %do.body1882.loopexit4019 ], [ 0, %do.body1882.loopexit4020 ], [ 0, %do.body1882.loopexit4021 ], [ 0, %do.body1882.loopexit4022 ], [ 0, %do.body1882.loopexit4023 ], [ 0, %do.body1882.loopexit4024 ], [ 0, %do.body1882.loopexit4025 ], [ %have.64.ph, %do.body1882.loopexit4487 ], [ 0, %do.body717 ], [ %have.0, %for.cond ], [ 0, %do.body918 ]
  %hold.60 = phi i64 [ %shr752, %do.body751 ], [ %hold.57, %if.end1875 ], [ %hold.333449, %do.body1882.loopexit ], [ %hold.313440, %do.body1882.loopexit3654 ], [ %hold.323431, %do.body1882.loopexit3655 ], [ %hold.13648.lcssa, %do.body1882.loopexit3657 ], [ %hold.143639.lcssa, %do.body1882.loopexit3658 ], [ %hold.83631.lcssa, %do.body1882.loopexit3659 ], [ %hold.63623.lcssa, %do.body1882.loopexit3660 ], [ %hold.43615.lcssa, %do.body1882.loopexit3661 ], [ %hold.23606.lcssa, %do.body1882.loopexit3662 ], [ %hold.163589.lcssa, %do.body1882.loopexit3663 ], [ %hold.213580.lcssa, %do.body1882.loopexit3664 ], [ %hold.243378.lcssa, %do.body1882.loopexit3672 ], [ %hold.563369.lcssa, %do.body1882.loopexit3673 ], [ %hold.533361.lcssa, %do.body1882.loopexit3674 ], [ %hold.303419, %do.body1882.loopexit4019 ], [ %hold.503571, %do.body1882.loopexit4020 ], [ %hold.473560, %do.body1882.loopexit4021 ], [ %hold.463536, %do.body1882.loopexit4022 ], [ %hold.433518, %do.body1882.loopexit4023 ], [ %hold.403507, %do.body1882.loopexit4024 ], [ %hold.393483, %do.body1882.loopexit4025 ], [ %hold.60.ph, %do.body1882.loopexit4487 ], [ %hold.19, %do.body717 ], [ %hold.0, %for.cond ], [ %hold.263398, %do.body918 ]
  %bits.60 = phi i32 [ %sub753, %do.body751 ], [ %bits.57, %if.end1875 ], [ %295, %do.body1882.loopexit ], [ %296, %do.body1882.loopexit3654 ], [ %297, %do.body1882.loopexit3655 ], [ %299, %do.body1882.loopexit3657 ], [ %301, %do.body1882.loopexit3658 ], [ %303, %do.body1882.loopexit3659 ], [ %305, %do.body1882.loopexit3660 ], [ %307, %do.body1882.loopexit3661 ], [ %309, %do.body1882.loopexit3662 ], [ %311, %do.body1882.loopexit3663 ], [ %313, %do.body1882.loopexit3664 ], [ %315, %do.body1882.loopexit3672 ], [ %317, %do.body1882.loopexit3673 ], [ %319, %do.body1882.loopexit3674 ], [ %322, %do.body1882.loopexit4019 ], [ %324, %do.body1882.loopexit4020 ], [ %328, %do.body1882.loopexit4021 ], [ %331, %do.body1882.loopexit4022 ], [ %333, %do.body1882.loopexit4023 ], [ %337, %do.body1882.loopexit4024 ], [ %340, %do.body1882.loopexit4025 ], [ %bits.60.ph, %do.body1882.loopexit4487 ], [ %bits.19, %do.body717 ], [ %bits.0, %for.cond ], [ %bits.263399, %do.body918 ]
  %out.5 = phi i32 [ %out.0, %do.body751 ], [ %out.2, %if.end1875 ], [ %out.0, %do.body1882.loopexit ], [ %out.0, %do.body1882.loopexit3654 ], [ %out.0, %do.body1882.loopexit3655 ], [ %out.0, %do.body1882.loopexit3657 ], [ %out.0, %do.body1882.loopexit3658 ], [ %out.0, %do.body1882.loopexit3659 ], [ %out.0, %do.body1882.loopexit3660 ], [ %out.0, %do.body1882.loopexit3661 ], [ %out.0, %do.body1882.loopexit3662 ], [ %out.0, %do.body1882.loopexit3663 ], [ %out.0, %do.body1882.loopexit3664 ], [ %out.0, %do.body1882.loopexit3672 ], [ %out.2, %do.body1882.loopexit3673 ], [ %out.0, %do.body1882.loopexit3674 ], [ %out.0, %do.body1882.loopexit4019 ], [ %out.0, %do.body1882.loopexit4020 ], [ %out.0, %do.body1882.loopexit4021 ], [ %out.0, %do.body1882.loopexit4022 ], [ %out.0, %do.body1882.loopexit4023 ], [ %out.0, %do.body1882.loopexit4024 ], [ %out.0, %do.body1882.loopexit4025 ], [ %out.0, %do.body1882.loopexit4487 ], [ %out.0, %for.cond ], [ %out.0, %do.body717 ], [ %out.0, %do.body918 ]
  %ret.9 = phi i32 [ %ret.0, %do.body751 ], [ 1, %if.end1875 ], [ %ret.1, %do.body1882.loopexit ], [ %ret.1, %do.body1882.loopexit3654 ], [ %ret.1, %do.body1882.loopexit3655 ], [ %ret.0, %do.body1882.loopexit3657 ], [ %ret.0, %do.body1882.loopexit3658 ], [ %ret.0, %do.body1882.loopexit3659 ], [ %ret.0, %do.body1882.loopexit3660 ], [ %ret.0, %do.body1882.loopexit3661 ], [ %ret.0, %do.body1882.loopexit3662 ], [ %ret.0, %do.body1882.loopexit3663 ], [ %ret.0, %do.body1882.loopexit3664 ], [ %ret.0, %do.body1882.loopexit3672 ], [ %ret.0, %do.body1882.loopexit3673 ], [ %ret.0, %do.body1882.loopexit3674 ], [ %ret.1, %do.body1882.loopexit4019 ], [ %ret.6, %do.body1882.loopexit4020 ], [ %ret.5, %do.body1882.loopexit4021 ], [ %ret.5, %do.body1882.loopexit4022 ], [ %ret.4, %do.body1882.loopexit4023 ], [ %ret.3, %do.body1882.loopexit4024 ], [ %ret.3, %do.body1882.loopexit4025 ], [ %ret.9.ph, %do.body1882.loopexit4487 ], [ %ret.0, %do.body717 ], [ -3, %for.cond ], [ %ret.0, %do.body918 ]
  store ptr %put.0, ptr %next_out, align 8, !tbaa !40
  store i32 %left.03849, ptr %avail_out, align 8, !tbaa !43
  store ptr %next.64, ptr %strm, align 8, !tbaa !41
  store i32 %have.64, ptr %avail_in11, align 8, !tbaa !42
  store i64 %hold.60, ptr %hold12, align 8, !tbaa !25
  store i32 %bits.60, ptr %bits13, align 8, !tbaa !26
  %341 = load i32, ptr %wsize, align 4, !tbaa !32
  %tobool1892.not = icmp eq i32 %341, 0
  br i1 %tobool1892.not, label %lor.lhs.false1893, label %if.then1908

lor.lhs.false1893:                                ; preds = %do.body1882
  %cmp1895.not = icmp eq i32 %out.5, %left.03849
  br i1 %cmp1895.not, label %if.end1917, label %land.lhs.true1897

land.lhs.true1897:                                ; preds = %lor.lhs.false1893
  %342 = load i32, ptr %mode.i, align 8, !tbaa !16
  %cmp1899 = icmp ult i32 %342, 16209
  br i1 %cmp1899, label %land.lhs.true1901, label %if.end1917

land.lhs.true1901:                                ; preds = %land.lhs.true1897
  %cmp1903 = icmp ult i32 %342, 16206
...
if.then1908:                                      ; preds = %land.lhs.true1901, %do.body1882
  %sub1911 = sub i32 %out.5, %left.03849
  %343 = load ptr, ptr %state4.i, align 8, !tbaa !13
  %window.i = getelementptr inbounds %struct.inflate_state, ptr %343, i64 0, i32 14
  %344 = load ptr, ptr %window.i, align 8, !tbaa !35
  %cmp.i2907 = icmp eq ptr %344, null
  br i1 %cmp.i2907, label %if.then.i, label %if.end6.i

if.then.i:                                        ; preds = %if.then1908
  %345 = load ptr, ptr %zalloc.i, align 8, !tbaa !5
  %opaque.i = getelementptr inbounds %struct.z_stream_s, ptr %strm, i64 0, i32 10
  %346 = load ptr, ptr %opaque.i, align 8, !tbaa !37
  %wbits.i = getelementptr inbounds %struct.inflate_state, ptr %343, i64 0, i32 10
  %347 = load i32, ptr %wbits.i, align 8, !tbaa !36
  %shl.i = shl nuw i32 1, %347
  %call.i = call ptr %345(ptr noundef %346, i32 noundef %shl.i, i32 noundef 1) #10
  store ptr %call.i, ptr %window.i, align 8, !tbaa !35
  %cmp4.i = icmp eq ptr %call.i, null
  br i1 %cmp4.i, label %if.then1914, label %if.end6.i

if.end6.i:                                        ; preds = %if.then.i, %if.then1908
  %348 = phi ptr [ %call.i, %if.then.i ], [ %344, %if.then1908 ]
  %wsize.i = getelementptr inbounds %struct.inflate_state, ptr %343, i64 0, i32 11
  %349 = load i32, ptr %wsize.i, align 4, !tbaa !32
  %cmp7.i = icmp eq i32 %349, 0
  br i1 %cmp7.i, label %if.then8.i, label %if.end12.i

if.then8.i:                                       ; preds = %if.end6.i
  %wbits9.i = getelementptr inbounds %struct.inflate_state, ptr %343, i64 0, i32 10
  %350 = load i32, ptr %wbits9.i, align 8, !tbaa !36
  %shl10.i = shl nuw i32 1, %350
  store i32 %shl10.i, ptr %wsize.i, align 4, !tbaa !32
  %wnext.i = getelementptr inbounds %struct.inflate_state, ptr %343, i64 0, i32 13
  store i32 0, ptr %wnext.i, align 4, !tbaa !34
  %whave.i = getelementptr inbounds %struct.inflate_state, ptr %343, i64 0, i32 12
  store i32 0, ptr %whave.i, align 8, !tbaa !33
  br label %if.end12.i

if.end12.i:                                       ; preds = %if.then8.i, %if.end6.i
  %351 = phi i32 [ %shl10.i, %if.then8.i ], [ %349, %if.end6.i ]
  %cmp14.not.i = icmp ugt i32 %351, %sub1911
  br i1 %cmp14.not.i, label %if.else.i, label %if.then15.i

if.then15.i:                                      ; preds = %if.end12.i
  %idx.ext.i = zext i32 %351 to i64
  %idx.neg.i = sub nsw i64 0, %idx.ext.i
  %add.ptr.i = getelementptr inbounds i8, ptr %put.0, i64 %idx.neg.i
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %348, ptr align 1 %add.ptr.i, i64 %idx.ext.i, i1 false)
  %wnext19.i = getelementptr inbounds %struct.inflate_state, ptr %343, i64 0, i32 13
  store i32 0, ptr %wnext19.i, align 4, !tbaa !34
  %352 = load i32, ptr %wsize.i, align 4, !tbaa !32
  %whave21.i = getelementptr inbounds %struct.inflate_state, ptr %343, i64 0, i32 12
  store i32 %352, ptr %whave21.i, align 8, !tbaa !33
  br label %if.end1917

if.else.i:                                        ; preds = %if.end12.i
  %wnext23.i = getelementptr inbounds %struct.inflate_state, ptr %343, i64 0, i32 13
  %353 = load i32, ptr %wnext23.i, align 4, !tbaa !34
  %sub.i = sub i32 %351, %353
  %spec.select.i2909 = call i32 @llvm.umin.i32(i32 %sub.i, i32 %sub1911)
  %idx.ext30.i = zext i32 %353 to i64
  %add.ptr31.i = getelementptr inbounds i8, ptr %348, i64 %idx.ext30.i
  ...
  %conv35.i = zext i32 %spec.select.i2909 to i64
...
if.then37.i:                                      ; preds = %if.else.i
  %sub36.i = sub i32 %sub1911, %spec.select.i2909
  %354 = load ptr, ptr %window.i, align 8, !tbaa !35
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %354, ptr align 1 %add.ptr41.i, i64 %idx.ext39.i, i1 false)
  store i32 %sub36.i, ptr %wnext23.i, align 4, !tbaa !34
  %355 = load i32, ptr %wsize.i, align 4, !tbaa !32
  %whave45.i = getelementptr inbounds %struct.inflate_state, ptr %343, i64 0, i32 12
  store i32 %355, ptr %whave45.i, align 8, !tbaa !33
  br label %if.end1917

if.else46.i:                                      ; preds = %if.else.i
  %356 = load i32, ptr %wnext23.i, align 4, !tbaa !34
  %add.i = add i32 %356, %spec.select.i2909
  %357 = load i32, ptr %wsize.i, align 4, !tbaa !32
  %cmp50.i = icmp eq i32 %add.i, %357
  %spec.store.select.i = select i1 %cmp50.i, i32 0, i32 %add.i
  store i32 %spec.store.select.i, ptr %wnext23.i, align 4
  %whave55.i = getelementptr inbounds %struct.inflate_state, ptr %343, i64 0, i32 12
  %358 = load i32, ptr %whave55.i, align 8, !tbaa !33
  %cmp57.i = icmp ult i32 %358, %357
  br i1 %cmp57.i, label %if.then59.i, label %if.end1917

if.then59.i:                                      ; preds = %if.else46.i
  %add61.i = add i32 %358, %spec.select.i2909
  store i32 %add61.i, ptr %whave55.i, align 8, !tbaa !33
  br label %if.end1917

if.then1914:                                      ; preds = %if.then.i
  store i32 16210, ptr %mode.i, align 8, !tbaa !16
  br label %cleanup

if.end1917:                                       ; preds = %if.then15.i, %if.else46.i, %if.then59.i, %if.then37.i, %land.lhs.true1901, %land.lhs.true1897, %lor.lhs.false1893
  %359 = load i32, ptr %avail_in11, align 8, !tbaa !42
  %sub1919 = sub i32 %11, %359
  %360 = load i32, ptr %avail_out, align 8, !tbaa !43
  %sub1921 = sub i32 %out.5, %360
  %conv1922 = zext i32 %sub1919 to i64
  %total_in = getelementptr inbounds %struct.z_stream_s, ptr %strm, i64 0, i32 2
  %361 = load i64, ptr %total_in, align 8, !tbaa !18
  %add1923 = add i64 %361, %conv1922
  store i64 %add1923, ptr %total_in, align 8, !tbaa !18
  %conv1924 = zext i32 %sub1921 to i64
  %362 = load i64, ptr %total_out, align 8, !tbaa !105
  %add1926 = add i64 %362, %conv1924
  store i64 %add1926, ptr %total_out, align 8, !tbaa !105
  %363 = load i64, ptr %total, align 8, !tbaa !17
  %add1929 = add i64 %363, %conv1924
  store i64 %add1929, ptr %total, align 8, !tbaa !17
  %364 = load i32, ptr %wrap1747, align 8, !tbaa !19
  %and1931 = and i32 %364, 4
  %tobool1932 = icmp ne i32 %and1931, 0
  %tobool1934 = icmp ne i32 %out.5, %360
...
if.then1935:                                      ; preds = %if.end1917
  %365 = load i32, ptr %flags1783, align 8, !tbaa !49
  %tobool1937.not = icmp eq i32 %365, 0
  %366 = load i64, ptr %check1786, align 8, !tbaa !48
  %367 = load ptr, ptr %next_out, align 8, !tbaa !40
  %idx.neg1949 = sub nsw i64 0, %conv1924
  %add.ptr1950 = getelementptr inbounds i8, ptr %367, i64 %idx.neg1949
  br i1 %tobool1937.not, label %cond.false1945, label %cond.true1938

cond.true1938:                                    ; preds = %if.then1935
  %call1944 = call i64 @crc32(i64 noundef %366, ptr noundef %add.ptr1950, i32 noundef %sub1921) #10
  br label %cond.end1952

cond.false1945:                                   ; preds = %if.then1935
  %call1951 = call i64 @adler32(i64 noundef %366, ptr noundef %add.ptr1950, i32 noundef %sub1921) #10
  br label %cond.end1952

cond.end1952:                                     ; preds = %cond.false1945, %cond.true1938
  %cond1953 = phi i64 [ %call1944, %cond.true1938 ], [ %call1951, %cond.false1945 ]
  store i64 %cond1953, ptr %check1786, align 8, !tbaa !48
  store i64 %cond1953, ptr %adler1800, align 8, !tbaa !20
  br label %if.end1956

if.end1956:                                       ; preds = %cond.end1952, %if.end1917
  %368 = load i32, ptr %bits13, align 8, !tbaa !26
  %369 = load i32, ptr %last699, align 4, !tbaa !21
  %tobool1959.not = icmp eq i32 %369, 0
  %cond1960 = select i1 %tobool1959.not, i32 0, i32 64
  %add1961 = add nsw i32 %cond1960, %368
  %370 = load i32, ptr %mode.i, align 8, !tbaa !16
  %cmp1963 = icmp eq i32 %370, 16191
  %cond1965 = select i1 %cmp1963, i32 128, i32 0
  %add1966 = add nsw i32 %add1961, %cond1965
  %cmp1968 = icmp eq i32 %370, 16199
  %cmp1971 = icmp eq i32 %370, 16194
  %371 = or i1 %cmp1968, %cmp1971
  %cond1973 = select i1 %371, i32 256, i32 0
  %add1974 = add nsw i32 %add1966, %cond1973
  %data_type = getelementptr inbounds %struct.z_stream_s, ptr %strm, i64 0, i32 11
  store i32 %add1974, ptr %data_type, align 8, !tbaa !107
  %cmp1975 = icmp eq i32 %11, %359
  %cmp1978 = icmp eq i32 %out.5, %360
...
cleanup:                                          ; preds = %for.cond, %cleanup.loopexit, %if.end.i, %lor.lhs.false6.i, %entry, %lor.lhs.false.i, %lor.lhs.false2.i, %inflateStateCheck.exit, %lor.lhs.false, %land.lhs.true, %if.end1956, %if.then1914, %do.body676
  %retval.0 = phi i32 [ -4, %if.then1914 ], [ %spec.store.select, %if.end1956 ], [ 2, %do.body676 ], [ -2, %land.lhs.true ], [ -2, %lor.lhs.false ], [ -2, %inflateStateCheck.exit ], [ -2, %lor.lhs.false2.i ], [ -2, %lor.lhs.false.i ], [ -2, %entry ], [ -2, %lor.lhs.false6.i ], [ -2, %if.end.i ], [ -4, %cleanup.loopexit ], [ -2, %for.cond ]
...
declare i32 @inflate_table(i32 noundef, ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef) local_unnamed_addr #4

declare void @inflate_fast(ptr noundef, i32 noundef) local_unnamed_addr #4

; Function Attrs: nounwind uwtable
define dso_local i32 @inflateEnd(ptr noundef %strm) local_unnamed_addr #3 {
entry:
  %cmp.i = icmp eq ptr %strm, null
  br i1 %cmp.i, label %cleanup, label %lor.lhs.false.i
...
if.then2:                                         ; preds = %if.end
  ...
  %.pre19 = load ptr, ptr %state4.i, align 8, !tbaa !13
  br label %if.end4

if.end4:                                          ; preds = %if.then2, %if.end
  %8 = phi ptr [ %.pre19, %if.then2 ], [ %2, %if.end ]
...
cleanup:                                          ; preds = %if.end.i, %lor.lhs.false6.i, %entry, %lor.lhs.false.i, %lor.lhs.false2.i, %inflateStateCheck.exit, %if.end4
...
; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(readwrite, inaccessiblemem: none) uwtable
define dso_local i32 @inflateGetDictionary(ptr noundef readonly %strm, ptr noundef writeonly %dictionary, ptr noundef writeonly %dictLength) local_unnamed_addr #2 {
entry:
  %cmp.i = icmp eq ptr %strm, null
  br i1 %cmp.i, label %cleanup, label %lor.lhs.false.i
...
if.then18:                                        ; preds = %if.end15
  ...
  store i32 %12, ptr %dictLength, align 4, !tbaa !108
  br label %cleanup

cleanup:                                          ; preds = %if.end.i, %lor.lhs.false6.i, %entry, %lor.lhs.false.i, %lor.lhs.false2.i, %if.end15, %if.then18, %inflateStateCheck.exit
...
; Function Attrs: nounwind uwtable
define dso_local i32 @inflateSetDictionary(ptr noundef readonly %strm, ptr noundef %dictionary, i32 noundef %dictLength) local_unnamed_addr #3 {
entry:
  %cmp.i = icmp eq ptr %strm, null
  br i1 %cmp.i, label %cleanup, label %lor.lhs.false.i
...
if.then7:                                         ; preds = %land.lhs.true, %if.end4
  ...
  %7 = load i64, ptr %check, align 8, !tbaa !48
...
cleanup:                                          ; preds = %if.end.i, %lor.lhs.false6.i, %entry, %lor.lhs.false.i, %lor.lhs.false2.i, %if.then7, %land.lhs.true, %inflateStateCheck.exit, %if.end18, %if.then16
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none) uwtable
define dso_local i32 @inflateGetHeader(ptr noundef readonly %strm, ptr noundef %head) local_unnamed_addr #0 {
entry:
  %cmp.i = icmp eq ptr %strm, null
  br i1 %cmp.i, label %cleanup, label %lor.lhs.false.i
...
if.end3:                                          ; preds = %if.end
  ...
  store i32 0, ptr %done, align 8, !tbaa !50
  br label %cleanup

cleanup:                                          ; preds = %if.end.i, %lor.lhs.false6.i, %entry, %lor.lhs.false.i, %lor.lhs.false2.i, %if.end, %inflateStateCheck.exit, %if.end3
...
if.end:                                           ; preds = %inflateStateCheck.exit
  %avail_in = getelementptr inbounds %struct.z_stream_s, ptr %strm, i64 0, i32 1
  %6 = load i32, ptr %avail_in, align 8, !tbaa !42
  %cmp = icmp eq i32 %6, 0
...
if.end4.if.end20_crit_edge:                       ; preds = %if.end4
  ...
  %.pre108 = load i32, ptr %have21.phi.trans.insert, align 4, !tbaa !108
  br label %if.end20
...
if.then6:                                         ; preds = %if.end4
  ...
  %cmp13.not102 = icmp ult i32 %8, 8
  br i1 %cmp13.not102, label %while.end.thread, label %while.body.preheader
...
while.body:                                       ; preds = %while.body, %while.body.preheader.new
  ...
  %shr.3 = lshr i64 %shr106, 32
  %niter.next.3 = add i32 %niter, 4
  %niter.ncmp.3 = icmp eq i32 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %while.end.unr-lcssa, label %while.body, !llvm.loop !109
...
while.end.unr-lcssa:                              ; preds = %while.body, %while.body.preheader
  ...
  %shr106.unr = phi i64 [ %shl, %while.body.preheader ], [ %shr.3, %while.body ]
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
...
while.body.epil:                                  ; preds = %while.end.unr-lcssa, %while.body.epil
  ...
  %shr106.epil = phi i64 [ %shr.epil, %while.body.epil ], [ %shr106.unr, %while.end.unr-lcssa ]
  %epil.iter = phi i32 [ %epil.iter.next, %while.body.epil ], [ 0, %while.end.unr-lcssa ]
  %conv.epil = trunc i64 %shr106.epil to i8
  ...
  %shr.epil = lshr i64 %shr106.epil, 8
  %epil.iter.next = add i32 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %while.end, label %while.body.epil, !llvm.loop !110
...
while.body.i:                                     ; preds = %while.body.i, %while.body.preheader.i
  ...
  br i1 %17, label %while.body.i, label %syncsearch.exit, !llvm.loop !111
...
syncsearch.exit:                                  ; preds = %while.body.i, %while.end.thread, %while.end
  ...
  %have112 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 27
  store i32 %got.0.lcssa.i, ptr %have112, align 4, !tbaa !108
  %.pre = load i32, ptr %avail_in, align 8, !tbaa !42
  br label %if.end20

if.end20:                                         ; preds = %if.end4.if.end20_crit_edge, %syncsearch.exit
  %18 = phi i32 [ %got.0.lcssa.i, %syncsearch.exit ], [ %.pre108, %if.end4.if.end20_crit_edge ]
  ...
  %20 = load ptr, ptr %strm, align 8, !tbaa !41
...
while.body.i94:                                   ; preds = %while.body.i94, %while.body.preheader.i78
  ...
  br i1 %24, label %while.body.i94, label %while.end.loopexit.i95, !llvm.loop !111
...
syncsearch.exit98:                                ; preds = %if.end20, %while.end.loopexit.i95
  ...
  store i32 %got.0.lcssa.i96, ptr %have21, align 4, !tbaa !108
  %26 = load i32, ptr %avail_in, align 8, !tbaa !42
  %sub25 = sub i32 %26, %next.0.lcssa.i97
  store i32 %sub25, ptr %avail_in, align 8, !tbaa !42
  %idx.ext = zext i32 %next.0.lcssa.i97 to i64
  %add.ptr = getelementptr inbounds i8, ptr %20, i64 %idx.ext
  store ptr %add.ptr, ptr %strm, align 8, !tbaa !41
  %total_in = getelementptr inbounds %struct.z_stream_s, ptr %strm, i64 0, i32 2
...
if.end.i7.i:                                      ; preds = %syncsearch.exit98
  %total_out = getelementptr inbounds %struct.z_stream_s, ptr %strm, i64 0, i32 5
  %28 = load i64, ptr %total_out, align 8, !tbaa !105
...
inflateReset.exit:                                ; preds = %if.end.i7.i, %if.then3.i.i
  ...
  store i32 -1, ptr %back.i.i, align 4, !tbaa !31
  store i64 %add, ptr %total_in, align 8, !tbaa !18
  store i64 %28, ptr %total_out, align 8, !tbaa !105
  store i32 16191, ptr %mode.i, align 8, !tbaa !16
  br label %cleanup

cleanup:                                          ; preds = %if.end.i, %lor.lhs.false6.i, %entry, %lor.lhs.false.i, %lor.lhs.false2.i, %syncsearch.exit98, %land.lhs.true, %inflateStateCheck.exit, %inflateReset.exit
  %retval.0 = phi i32 [ 0, %inflateReset.exit ], [ -2, %inflateStateCheck.exit ], [ -5, %land.lhs.true ], [ -3, %syncsearch.exit98 ], [ -2, %lor.lhs.false2.i ], [ -2, %lor.lhs.false.i ], [ -2, %entry ], [ -2, %lor.lhs.false6.i ], [ -2, %if.end.i ]
...
cleanup:                                          ; preds = %if.end.i, %lor.lhs.false6.i, %entry, %lor.lhs.false.i, %lor.lhs.false2.i, %if.end, %land.rhs, %inflateStateCheck.exit
...
; Function Attrs: nounwind uwtable
define dso_local i32 @inflateCopy(ptr noundef %dest, ptr noundef readonly %source) local_unnamed_addr #3 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none) uwtable
define dso_local i32 @inflateUndermine(ptr noundef readonly %strm, i32 noundef %subvert) local_unnamed_addr #0 {
entry:
  %cmp.i = icmp eq ptr %strm, null
  br i1 %cmp.i, label %cleanup, label %lor.lhs.false.i
...
cleanup:                                          ; preds = %if.end.i, %lor.lhs.false6.i, %entry, %lor.lhs.false.i, %lor.lhs.false2.i, %inflateStateCheck.exit, %if.end
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none) uwtable
define dso_local i32 @inflateValidate(ptr noundef readonly %strm, i32 noundef %check) local_unnamed_addr #0 {
entry:
  %cmp.i = icmp eq ptr %strm, null
  br i1 %cmp.i, label %cleanup, label %lor.lhs.false.i
...
cleanup:                                          ; preds = %if.end, %if.end.i, %lor.lhs.false6.i, %entry, %lor.lhs.false.i, %lor.lhs.false2.i, %inflateStateCheck.exit
  %retval.0 = phi i32 [ -2, %inflateStateCheck.exit ], [ -2, %lor.lhs.false2.i ], [ -2, %lor.lhs.false.i ], [ -2, %entry ], [ -2, %lor.lhs.false6.i ], [ -2, %if.end.i ], [ 0, %if.end ]
  ret i32 %retval.0
}
...
cond.true:                                        ; preds = %if.end
  ...
  %7 = load i32, ptr %length, align 4, !tbaa !60
  br label %cond.end9

cond.true6:                                       ; preds = %if.end
  %was = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 34
  %8 = load i32, ptr %was, align 8, !tbaa !98
  %length7 = getelementptr inbounds %struct.inflate_state, ptr %2, i64 0, i32 17
  %9 = load i32, ptr %length7, align 4, !tbaa !60
  %sub = sub i32 %8, %9
  br label %cond.end9
...
cleanup:                                          ; preds = %if.end.i, %lor.lhs.false6.i, %entry, %lor.lhs.false.i, %lor.lhs.false2.i, %inflateStateCheck.exit, %cond.end9
...
!82 = distinct !{!82, !47}
!83 = distinct !{!83, !47}
!84 = !{i64 0, i64 1, !38, i64 1, i64 2, !80}
!85 = !{i64 0, i64 2, !80}
!86 = distinct !{!86, !47}
!87 = distinct !{!87, !47}
!88 = distinct !{!88, !47}
...
!95 = distinct !{!95, !47}
!96 = !{i64 0, i64 1, !38, i64 1, i64 1, !38, i64 2, i64 2, !80}
!97 = distinct !{!97, !47}
!98 = !{!15, !10, i64 7152}
!99 = !{!15, !10, i64 96}
!100 = distinct !{!100, !47}
