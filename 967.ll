; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/HPCCG/ddot.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/HPCCG/ddot.cpp"
...
for.body:                                         ; preds = %for.body, %for.body.preheader.new
  ...
  %arrayidx.3 = getelementptr inbounds double, ptr %x, i64 %indvars.iv.next42.2
...
for.body.epil:                                    ; preds = %if.end.loopexit.unr-lcssa, %for.body.epil
  ...
  %arrayidx.epil = getelementptr inbounds double, ptr %x, i64 %indvars.iv41.epil
