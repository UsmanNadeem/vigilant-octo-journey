; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/7z/7zEncode.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/7z/7zEncode.cpp"
...
vector.memcheck:                                  ; preds = %for.body116.lr.ph
  ...
  %uglygep = getelementptr i8, ptr %call.i286287, i64 %41
  %42 = shl nuw nsw i64 %wide.trip.count, 2
  %uglygep471 = getelementptr i8, ptr %40, i64 %42
  %bound0 = icmp ult ptr %call.i286287, %uglygep471
  %bound1 = icmp ult ptr %40, %uglygep
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %for.body116.preheader, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %wide.trip.count, 4294967288
  %43 = getelementptr i8, ptr %call.i286287, i64 -1
  %44 = getelementptr i8, ptr %call.i286287, i64 -1
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %45 = getelementptr inbounds i32, ptr %40, i64 %index
  %wide.load = load <4 x i32>, ptr %45, align 4, !tbaa !53, !alias.scope !55
  %46 = getelementptr inbounds i32, ptr %45, i64 4
  %wide.load472 = load <4 x i32>, ptr %46, align 4, !tbaa !53, !alias.scope !55
  %47 = trunc <4 x i32> %wide.load to <4 x i8>
  %48 = trunc <4 x i32> %wide.load472 to <4 x i8>
  %49 = shl nuw nsw i64 %index, 1
  %50 = shl i64 %index, 1
  %51 = lshr <4 x i32> %wide.load, <i32 8, i32 8, i32 8, i32 8>
  %52 = lshr <4 x i32> %wide.load472, <i32 8, i32 8, i32 8, i32 8>
  %53 = trunc <4 x i32> %51 to <4 x i8>
  %54 = trunc <4 x i32> %52 to <4 x i8>
  %55 = or i64 %49, 1
  %56 = or i64 %50, 9
  %57 = getelementptr i8, ptr %43, i64 %55
  %58 = getelementptr i8, ptr %44, i64 %56
  %interleaved.vec = shufflevector <4 x i8> %47, <4 x i8> %53, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x i8> %interleaved.vec, ptr %57, align 1, !tbaa !58
  %interleaved.vec473 = shufflevector <4 x i8> %48, <4 x i8> %54, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x i8> %interleaved.vec473, ptr %58, align 1, !tbaa !58
  %index.next = add nuw i64 %index, 8
  %59 = icmp eq i64 %index.next, %n.vec
  br i1 %59, label %middle.block, label %vector.body, !llvm.loop !59
...
for.body116.prol:                                 ; preds = %for.body116.preheader
  ...
  %61 = load i32, ptr %arrayidx.prol, align 4, !tbaa !53
  %conv122.prol = trunc i32 %61 to i8
  %62 = shl nuw nsw i64 %indvars.iv.ph, 1
  %arrayidx127.prol = getelementptr inbounds i8, ptr %call.i286287, i64 %62
  store i8 %conv122.prol, ptr %arrayidx127.prol, align 1, !tbaa !58
  %63 = lshr i32 %61, 8
  %conv128.prol = trunc i32 %63 to i8
  %64 = or i64 %62, 1
  %arrayidx133.prol = getelementptr inbounds i8, ptr %call.i286287, i64 %64
...
for.body116.prol.loopexit:                        ; preds = %for.body116.prol, %for.body116.preheader
  ...
  %65 = sub nsw i64 0, %wide.trip.count
  %66 = icmp eq i64 %60, %65
  br i1 %66, label %for.cond.cleanup115, label %for.body116
...
for.cond.cleanup115:                              ; preds = %for.body116.prol.loopexit, %for.body116, %middle.block, %if.then99, %_ZN7CBufferIhE11SetCapacityEm.exit
  ...
  %67 = load ptr, ptr %vfn144, align 8
  %call146 = invoke noundef i32 %67(ptr noundef nonnull align 8 dereferenceable(8) %38, ptr noundef %buffer.sroa.9.1446, i32 noundef %mul)
...
for.body116:                                      ; preds = %for.body116.prol.loopexit, %for.body116
  ...
  %70 = load i32, ptr %arrayidx, align 4, !tbaa !53
  %conv122 = trunc i32 %70 to i8
  %71 = shl nuw nsw i64 %indvars.iv, 1
  %arrayidx127 = getelementptr inbounds i8, ptr %call.i286287, i64 %71
  store i8 %conv122, ptr %arrayidx127, align 1, !tbaa !58
  %72 = lshr i32 %70, 8
  %conv128 = trunc i32 %72 to i8
  %73 = or i64 %71, 1
  %arrayidx133 = getelementptr inbounds i8, ptr %call.i286287, i64 %73
  store i8 %conv128, ptr %arrayidx133, align 1, !tbaa !58
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx.1 = getelementptr inbounds i32, ptr %40, i64 %indvars.iv.next
  %74 = load i32, ptr %arrayidx.1, align 4, !tbaa !53
  %conv122.1 = trunc i32 %74 to i8
  %75 = shl nuw nsw i64 %indvars.iv.next, 1
  %arrayidx127.1 = getelementptr inbounds i8, ptr %call.i286287, i64 %75
  store i8 %conv122.1, ptr %arrayidx127.1, align 1, !tbaa !58
  %76 = lshr i32 %74, 8
  %conv128.1 = trunc i32 %76 to i8
  %77 = or i64 %75, 1
  %arrayidx133.1 = getelementptr inbounds i8, ptr %call.i286287, i64 %77
...
if.end162:                                        ; preds = %_ZN7CBufferIhED2Ev.exit, %invoke.cont94
  ...
  %79 = load ptr, ptr %encoder, align 8, !tbaa !44
  %tobool165.not = icmp eq ptr %79, null
  %80 = load ptr, ptr %this, align 8, !tbaa !16
  br i1 %tobool165.not, label %if.else, label %if.then166

if.then166:                                       ; preds = %if.end162
  invoke void @_ZN11NCoderMixer14CCoderMixer2MT8AddCoderEP14ICompressCoder(ptr noundef nonnull align 8 dereferenceable(224) %80, ptr noundef nonnull %79)
          to label %cleanup176 unwind label %lpad91

if.else:                                          ; preds = %if.end162
  %81 = load ptr, ptr %encoder2, align 8, !tbaa !31
  invoke void @_ZN11NCoderMixer14CCoderMixer2MT9AddCoder2EP15ICompressCoder2(ptr noundef nonnull align 8 dereferenceable(224) %80, ptr noundef %81)
          to label %cleanup176 unwind label %lpad91
...
cleanup176:                                       ; preds = %if.then166, %if.else, %_ZN7CBufferIhED2Ev.exit
  ...
  %82 = load ptr, ptr %cryptoSetPassword, align 8, !tbaa !49
...
if.then.i305:                                     ; preds = %cleanup176
  %vtable.i302 = load ptr, ptr %82, align 8, !tbaa !10
  %vfn.i303 = getelementptr inbounds ptr, ptr %vtable.i302, i64 2
  %83 = load ptr, ptr %vfn.i303, align 8
  %call.i304 = invoke noundef i32 %83(ptr noundef nonnull align 8 dereferenceable(8) %82)
...
if.then.i312:                                     ; preds = %_ZN9CMyComPtrI18ICryptoSetPasswordED2Ev.exit, %_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit, %invoke.cont80
  ...
  %86 = load ptr, ptr %vfn.i310, align 8
  %call.i311 = invoke noundef i32 %86(ptr noundef nonnull align 8 dereferenceable(8) %cond377)
...
if.then.i319:                                     ; preds = %cleanup184
  ...
  %89 = load ptr, ptr %vfn.i317, align 8
  %call.i318 = invoke noundef i32 %89(ptr noundef nonnull align 8 dereferenceable(8) %.pr)
...
if.then.i326:                                     ; preds = %_ZN9CMyComPtrI15ICompressCoder2ED2Ev.exit
  ...
  %92 = load ptr, ptr %vfn.i324, align 8
  %call.i325 = invoke noundef i32 %92(ptr noundef nonnull align 8 dereferenceable(8) %.pr393)
...
ehcleanup177:                                     ; preds = %delete.notnull.i298, %ehcleanup155, %ehcleanup155.thread, %lpad91
  %.pn237 = phi { ptr, i32 } [ %68, %lpad91 ], [ %69, %ehcleanup155.thread ], [ %78, %ehcleanup155 ], [ %78, %delete.notnull.i298 ]
  %95 = load ptr, ptr %cryptoSetPassword, align 8, !tbaa !49
  %tobool.not.i329 = icmp eq ptr %95, null
...
if.then.i333:                                     ; preds = %ehcleanup177
  %vtable.i330 = load ptr, ptr %95, align 8, !tbaa !10
  %vfn.i331 = getelementptr inbounds ptr, ptr %vtable.i330, i64 2
  %96 = load ptr, ptr %vfn.i331, align 8
  %call.i332 = invoke noundef i32 %96(ptr noundef nonnull align 8 dereferenceable(8) %95)
...
if.then.i341:                                     ; preds = %_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit280, %lpad77, %_ZN9CMyComPtrI18ICryptoSetPasswordED2Ev.exit336
  ...
  %99 = load ptr, ptr %vfn.i339, align 8
  %call.i340 = invoke noundef i32 %99(ptr noundef nonnull align 8 dereferenceable(8) %cond377)
...
ehcleanup185:                                     ; preds = %lpad36, %if.then.i341, %lpad20
  ...
  %102 = load ptr, ptr %encoder2, align 8, !tbaa !31
...
if.then.i349:                                     ; preds = %ehcleanup185
  %vtable.i346 = load ptr, ptr %102, align 8, !tbaa !10
  %vfn.i347 = getelementptr inbounds ptr, ptr %vtable.i346, i64 2
  %103 = load ptr, ptr %vfn.i347, align 8
  %call.i348 = invoke noundef i32 %103(ptr noundef nonnull align 8 dereferenceable(8) %102)
...
_ZN9CMyComPtrI15ICompressCoder2ED2Ev.exit352:     ; preds = %ehcleanup185, %if.then.i349
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %encoder2) #17
  %106 = load ptr, ptr %encoder, align 8, !tbaa !44
  %tobool.not.i353 = icmp eq ptr %106, null
...
if.then.i357:                                     ; preds = %_ZN9CMyComPtrI15ICompressCoder2ED2Ev.exit352
  %vtable.i354 = load ptr, ptr %106, align 8, !tbaa !10
  %vfn.i355 = getelementptr inbounds ptr, ptr %vtable.i354, i64 2
  %107 = load ptr, ptr %vfn.i355, align 8
  %call.i356 = invoke noundef i32 %107(ptr noundef nonnull align 8 dereferenceable(8) %106)
