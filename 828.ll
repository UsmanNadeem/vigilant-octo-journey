; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/testloop.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/testloop.c"
...
lor.lhs.false:                                    ; preds = %if.else217
  ...
  %or.cond506 = select i1 %cmp224, i1 %cmp229.not, i1 false
  br i1 %or.cond506, label %if.end232, label %do.body.backedge

if.end232:                                        ; preds = %lor.lhs.false
  %orient.le563 = getelementptr inbounds %struct.cellbox, ptr %32, i64 0, i32 5
  %68 = load i32, ptr %orient.le563, align 8, !tbaa !20
