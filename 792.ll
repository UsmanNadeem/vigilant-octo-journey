; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/mgrep.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/mgrep.c"
...
entry:
  ...
  %add.ptr6 = getelementptr inbounds i8, ptr %add.ptr2, i64 -1
  %incdec.ptr186 = getelementptr inbounds i8, ptr %add.ptr6, i64 1
  %cmp.not187 = icmp ugt ptr %incdec.ptr186, %add.ptr
  br i1 %cmp.not187, label %while.end106, label %while.body

while.body:                                       ; preds = %entry, %while.end105
  %incdec.ptr189 = phi ptr [ %incdec.ptr, %while.end105 ], [ %incdec.ptr186, %entry ]
...
while.body9:                                      ; preds = %while.body9.preheader, %if.end101
  %5 = phi i8 [ %32, %if.end101 ], [ %0, %while.body9.preheader ]
  ...
  %idxprom15171 = zext i8 %9 to i64
  %arrayidx16172 = getelementptr inbounds [256 x i8], ptr @tr, i64 0, i64 %idxprom15171
  %10 = load i8, ptr %arrayidx16172, align 1, !tbaa !9
  %idxprom18173 = zext i8 %5 to i64
  %arrayidx19174 = getelementptr inbounds [256 x i8], ptr @tr, i64 0, i64 %idxprom18173
  %11 = load i8, ptr %arrayidx19174, align 1, !tbaa !9
  %cmp21175 = icmp eq i8 %10, %11
  br i1 %cmp21175, label %while.body23, label %while.end

while.body23:                                     ; preds = %while.body9, %while.body23
  %indvars.iv = phi i64 [ %indvars.iv.next, %while.body23 ], [ 0, %while.body9 ]
  %qx.0177 = phi ptr [ %incdec.ptr17, %while.body23 ], [ %text.addr.1, %while.body9 ]
  %incdec.ptr17 = getelementptr inbounds i8, ptr %qx.0177, i64 1
...
while.body62:                                     ; preds = %while.cond57.preheader, %while.body62
  ...
  %call.i = tail call i32 @_IO_putc(i32 noundef %conv59, ptr noundef %24)
...
while.end65:                                      ; preds = %while.body62, %while.cond57.preheader
  ...
  %call.i157 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %26)
...
while.cond68:                                     ; preds = %if.end47, %while.cond68
  ...
  %27 = load i8, ptr %incdec.ptr69, align 1, !tbaa !9
  %cmp71.not = icmp eq i8 %27, 10
...
while.body82:                                     ; preds = %while.end74, %while.body82
  ...
  %28 = load i8, ptr %lastout.2181, align 1, !tbaa !9
  %conv84 = zext i8 %28 to i32
  %29 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call.i158 = tail call i32 @_IO_putc(i32 noundef %conv84, ptr noundef %29)
...
if.then88:                                        ; preds = %while.end86
  ...
  %call.i159 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %30)
...
while.cond91:                                     ; preds = %while.cond91.preheader, %while.cond91
  ...
  %31 = load i8, ptr %incdec.ptr92, align 1, !tbaa !9
  %cmp94.not = icmp eq i8 %31, 10
...
if.end101:                                        ; preds = %while.cond38, %while.end
  %32 = phi i8 [ %5, %while.end ], [ 10, %while.cond38 ]
...
while.end106:                                     ; preds = %while.end105, %entry
  ...
  %33 = load i32, ptr @INVERSE, align 4, !tbaa !5
  %tobool107 = icmp eq i32 %33, 0
  %34 = load i32, ptr @COUNT, align 4
  %tobool108 = icmp ne i32 %34, 0
...
while.body113:                                    ; preds = %while.end106, %while.body113
  ...
  %35 = load i8, ptr %lastout.5192, align 1, !tbaa !9
  %conv115 = zext i8 %35 to i32
  %36 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call.i160 = tail call i32 @_IO_putc(i32 noundef %conv115, ptr noundef %36)
...
define dso_local void @f_prep(i32 noundef %pat_index, ptr nocapture noundef readonly %Pattern) local_unnamed_addr #4 {
entry:
...
for.body:                                         ; preds = %for.body.preheader, %for.inc
  ...
  %16 = load i8, ptr %arrayidx3, align 1, !tbaa !9
  %17 = and i8 %16, 15
  %add677 = or i8 %17, %15
  %add6 = zext i8 %add677 to i64
  %shl7 = shl nuw nsw i64 %add6, 4
  %18 = add nsw i64 %indvars.iv, -2
  %arrayidx10 = getelementptr inbounds i8, ptr %Pattern, i64 %18
  %19 = load i8, ptr %arrayidx10, align 1, !tbaa !9
  %20 = and i8 %19, 15
  %and12 = zext i8 %20 to i64
  %add13 = or i64 %shl7, %and12
  %arrayidx15 = getelementptr inbounds [4096 x i8], ptr @SHIFT1, i64 0, i64 %add13
  %21 = load i8, ptr %arrayidx15, align 1, !tbaa !9
  %22 = sub nsw i64 %5, %indvars.iv
  %23 = zext i8 %21 to i64
  %cmp19.not = icmp ugt i64 %22, %23
...
for.body35.preheader:                             ; preds = %for.end
  %25 = zext i32 %sub to i64
  %26 = zext i32 %0 to i64
  %xtraiter = and i64 %26, 3
  %27 = icmp ult i32 %0, 4
  br i1 %27, label %for.end46.loopexit.unr-lcssa, label %for.body35.preheader.new
...
for.body35:                                       ; preds = %for.body35, %for.body35.preheader.new
  %indvars.iv91 = phi i64 [ %25, %for.body35.preheader.new ], [ %indvars.iv.next92.3, %for.body35 ]
  ...
  %28 = load i8, ptr %arrayidx38, align 1, !tbaa !9
  %idxprom39 = zext i8 %28 to i64
  %arrayidx40 = getelementptr inbounds [256 x i8], ptr @tr, i64 0, i64 %idxprom39
  %29 = load i8, ptr %arrayidx40, align 1, !tbaa !9
  %conv41 = zext i8 %29 to i32
  %and42 = and i32 %spec.select, %conv41
  %indvars.iv.next92 = add nsw i64 %indvars.iv91, -1
  %30 = shl i32 %hash.182, 8
  %31 = shl nuw nsw i32 %and42, 4
  %shl36.1 = add i32 %30, %31
  %arrayidx38.1 = getelementptr inbounds i8, ptr %Pattern, i64 %indvars.iv.next92
  %32 = load i8, ptr %arrayidx38.1, align 1, !tbaa !9
  %idxprom39.1 = zext i8 %32 to i64
  %arrayidx40.1 = getelementptr inbounds [256 x i8], ptr @tr, i64 0, i64 %idxprom39.1
  %33 = load i8, ptr %arrayidx40.1, align 1, !tbaa !9
  %conv41.1 = zext i8 %33 to i32
  ...
  %34 = load i8, ptr %arrayidx38.2, align 1, !tbaa !9
  %idxprom39.2 = zext i8 %34 to i64
  %arrayidx40.2 = getelementptr inbounds [256 x i8], ptr @tr, i64 0, i64 %idxprom39.2
  %35 = load i8, ptr %arrayidx40.2, align 1, !tbaa !9
  %conv41.2 = zext i8 %35 to i32
  %and42.2 = and i32 %spec.select, %conv41.2
  %indvars.iv.next92.2 = add nsw i64 %indvars.iv91, -3
  %36 = shl i32 %add43.1, 8
  %37 = shl nuw nsw i32 %and42.2, 4
  %shl36.3 = add i32 %36, %37
  %arrayidx38.3 = getelementptr inbounds i8, ptr %Pattern, i64 %indvars.iv.next92.2
  %38 = load i8, ptr %arrayidx38.3, align 1, !tbaa !9
  %idxprom39.3 = zext i8 %38 to i64
  %arrayidx40.3 = getelementptr inbounds [256 x i8], ptr @tr, i64 0, i64 %idxprom39.3
  %39 = load i8, ptr %arrayidx40.3, align 1, !tbaa !9
  %conv41.3 = zext i8 %39 to i32
...
for.end46.loopexit.unr-lcssa:                     ; preds = %for.body35, %for.body35.preheader
  ...
  %indvars.iv91.unr = phi i64 [ %25, %for.body35.preheader ], [ %indvars.iv.next92.3, %for.body35 ]
...
for.body35.epil:                                  ; preds = %for.end46.loopexit.unr-lcssa, %for.body35.epil
  ...
  %40 = load i8, ptr %arrayidx38.epil, align 1, !tbaa !9
  %idxprom39.epil = zext i8 %40 to i64
  %arrayidx40.epil = getelementptr inbounds [256 x i8], ptr @tr, i64 0, i64 %idxprom39.epil
  %41 = load i8, ptr %arrayidx40.epil, align 1, !tbaa !9
  %conv41.epil = zext i8 %41 to i32
...
for.end46.loopexit:                               ; preds = %for.body35.epil, %for.end46.loopexit.unr-lcssa
  ...
  %42 = and i32 %add43.lcssa, 8191
  %43 = zext i32 %42 to i64
  br label %for.end46

for.end46:                                        ; preds = %for.end46.loopexit, %for.end
  %hash.1.lcssa = phi i64 [ 0, %for.end ], [ %43, %for.end46.loopexit ]
  ...
  %44 = load ptr, ptr %arrayidx49, align 8, !tbaa !12
  store ptr %44, ptr @pt, align 8, !tbaa !12
  %next = getelementptr inbounds %struct.pat_list, ptr %call, i64 0, i32 1
  store ptr %44, ptr %next, align 8, !tbaa !16
...
define dso_local void @prepf(i32 noundef %fp) local_unnamed_addr #6 {
entry:
  br label %while.cond
...
while.cond:                                       ; preds = %while.body, %entry
  ...
  %call = tail call i64 @read(i32 noundef %fp, ptr noundef nonnull %add.ptr, i64 noundef 8192) #16
...
if.then:                                          ; preds = %while.body
  ...
  %call4 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.2, ptr noundef nonnull @Progname, i32 noundef 260000) #17
...
if.then39:                                        ; preds = %while.end36
  ...
  %call40 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %10, ptr noundef nonnull @.str.3, ptr noundef nonnull @Progname, i32 noundef 30000) #17
  tail call void @exit(i32 noundef 2) #18
  unreachable
...
for.cond72.preheader:                             ; preds = %if.end69
  %call76 = tail call ptr @__ctype_b_loc() #19
  br label %for.body75
...
for.body107:                                      ; preds = %for.body107.preheader, %for.inc121
  ...
  %call110 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %35) #20
...
if.then126:                                       ; preds = %for.end123
  ...
  %38 = tail call i64 @fwrite(ptr nonnull @.str.4, i64 26, i64 1, ptr %37) #17
  tail call void @exit(i32 noundef 2) #18
  unreachable
...
if.end128:                                        ; preds = %for.end123
  ...
  %or.cond = select i1 %cmp129, i1 %cmp132, i1 false
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end155
  ...
  %4 = load i8, ptr %text.addr.0272, align 1, !tbaa !9
  ...
  %6 = load i8, ptr %add.ptr8, align 1, !tbaa !9
...
if.then:                                          ; preds = %while.body
  ...
  %8 = load i8, ptr %add.ptr13, align 1, !tbaa !9
...
for.body.preheader:                               ; preds = %if.end
  br i1 %3, label %for.end.unr-lcssa, label %for.body

for.body:                                         ; preds = %for.body.preheader, %for.body
  %indvars.iv = phi i64 [ %indvars.iv.next.3, %for.body ], [ 0, %for.body.preheader ]
  %hash.1256 = phi i32 [ %add32.3, %for.body ], [ 0, %for.body.preheader ]
  ...
  %11 = load i8, ptr %add.ptr28, align 1, !tbaa !9
  ...
  %13 = shl i32 %hash.1256, 8
  %14 = shl nuw nsw i32 %conv31, 4
  %shl26.1 = add i32 %13, %14
  %idx.neg.1 = xor i64 %indvars.iv, -1
  %add.ptr28.1 = getelementptr inbounds i8, ptr %text.addr.0272, i64 %idx.neg.1
  %15 = load i8, ptr %add.ptr28.1, align 1, !tbaa !9
  %idxprom29.1 = zext i8 %15 to i64
  %arrayidx30.1 = getelementptr inbounds [256 x i8], ptr @tr1, i64 0, i64 %idxprom29.1
  %16 = load i8, ptr %arrayidx30.1, align 1, !tbaa !9
  %conv31.1 = zext i8 %16 to i32
  ...
  %17 = load i8, ptr %add.ptr28.2, align 1, !tbaa !9
  %idxprom29.2 = zext i8 %17 to i64
  %arrayidx30.2 = getelementptr inbounds [256 x i8], ptr @tr1, i64 0, i64 %idxprom29.2
  %18 = load i8, ptr %arrayidx30.2, align 1, !tbaa !9
  %conv31.2 = zext i8 %18 to i32
  %19 = shl i32 %add32.1, 8
  %20 = shl nuw nsw i32 %conv31.2, 4
  %shl26.3 = add i32 %19, %20
  %idx.neg.3 = sub nuw nsw i64 -3, %indvars.iv
  %add.ptr28.3 = getelementptr inbounds i8, ptr %text.addr.0272, i64 %idx.neg.3
  %21 = load i8, ptr %add.ptr28.3, align 1, !tbaa !9
  %idxprom29.3 = zext i8 %21 to i64
  %arrayidx30.3 = getelementptr inbounds [256 x i8], ptr @tr1, i64 0, i64 %idxprom29.3
  %22 = load i8, ptr %arrayidx30.3, align 1, !tbaa !9
  %conv31.3 = zext i8 %22 to i32
...
for.end.unr-lcssa:                                ; preds = %for.body, %for.body.preheader
  ...
  %hash.1256.unr = phi i32 [ 0, %for.body.preheader ], [ %add32.3, %for.body ]
  br i1 %lcmp.mod.not, label %for.end, label %for.body.epil
...
for.body.epil:                                    ; preds = %for.end.unr-lcssa, %for.body.epil
  ...
  %hash.1256.epil = phi i32 [ %add32.epil, %for.body.epil ], [ %hash.1256.unr, %for.end.unr-lcssa ]
  %epil.iter = phi i64 [ %epil.iter.next, %for.body.epil ], [ 0, %for.end.unr-lcssa ]
  %shl26.epil = shl i32 %hash.1256.epil, 4
  %idx.neg.epil = sub nsw i64 0, %indvars.iv.epil
  %add.ptr28.epil = getelementptr inbounds i8, ptr %text.addr.0272, i64 %idx.neg.epil
  %23 = load i8, ptr %add.ptr28.epil, align 1, !tbaa !9
  %idxprom29.epil = zext i8 %23 to i64
  %arrayidx30.epil = getelementptr inbounds [256 x i8], ptr @tr1, i64 0, i64 %idxprom29.epil
  %24 = load i8, ptr %arrayidx30.epil, align 1, !tbaa !9
  %conv31.epil = zext i8 %24 to i32
...
for.end:                                          ; preds = %for.body.epil, %for.end.unr-lcssa
  ...
  %25 = load ptr, ptr %arrayidx34, align 8, !tbaa !12
  %cmp36.old.not = icmp eq ptr %25, null
...
while.body38.preheader:                           ; preds = %for.end
  ...
  %26 = load i8, ptr %add.ptr41, align 1, !tbaa !9
  %idxprom50260 = zext i8 %26 to i64
  %arrayidx51261 = getelementptr inbounds [256 x i8], ptr @tr, i64 0, i64 %idxprom50260
  %27 = load i8, ptr %arrayidx51261, align 1, !tbaa !9
  br label %while.body38

while.body38:                                     ; preds = %while.body38.preheader, %if.end145
  %p.0 = phi ptr [ %29, %if.end145 ], [ %25, %while.body38.preheader ]
  %28 = load i32, ptr %p.0, align 8, !tbaa !14
  %next = getelementptr inbounds %struct.pat_list, ptr %p.0, i64 0, i32 1
  %29 = load ptr, ptr %next, align 8, !tbaa !16
  %idxprom43 = sext i32 %28 to i64
  %arrayidx44 = getelementptr inbounds [30000 x ptr], ptr @patt, i64 0, i64 %idxprom43
  %30 = load ptr, ptr %arrayidx44, align 8, !tbaa !12
  %31 = load i8, ptr %30, align 1, !tbaa !9
  %idxprom47258 = zext i8 %31 to i64
  %arrayidx48259 = getelementptr inbounds [256 x i8], ptr @tr, i64 0, i64 %idxprom47258
  %32 = load i8, ptr %arrayidx48259, align 1, !tbaa !9
  %cmp53262 = icmp eq i8 %32, %27
  br i1 %cmp53262, label %while.body55, label %while.end

while.body55:                                     ; preds = %while.body38, %while.body55
  %indvars.iv282 = phi i64 [ %indvars.iv.next283, %while.body55 ], [ 0, %while.body38 ]
  %qx.0264 = phi ptr [ %incdec.ptr, %while.body55 ], [ %add.ptr41, %while.body38 ]
  %incdec.ptr = getelementptr inbounds i8, ptr %qx.0264, i64 1
  %indvars.iv.next283 = add nuw nsw i64 %indvars.iv282, 1
  %arrayidx46 = getelementptr inbounds i8, ptr %30, i64 %indvars.iv.next283
  %33 = load i8, ptr %arrayidx46, align 1, !tbaa !9
  %idxprom47 = zext i8 %33 to i64
  %arrayidx48 = getelementptr inbounds [256 x i8], ptr @tr, i64 0, i64 %idxprom47
  %34 = load i8, ptr %arrayidx48, align 1, !tbaa !9
  %35 = load i8, ptr %incdec.ptr, align 1, !tbaa !9
  %idxprom50 = zext i8 %35 to i64
  %arrayidx51 = getelementptr inbounds [256 x i8], ptr @tr, i64 0, i64 %idxprom50
  %36 = load i8, ptr %arrayidx51, align 1, !tbaa !9
  %cmp53 = icmp eq i8 %34, %36
  br i1 %cmp53, label %while.body55, label %while.end.loopexit, !llvm.loop !41

while.end.loopexit:                               ; preds = %while.body55
  %37 = trunc i64 %indvars.iv.next283 to i32
  br label %while.end

while.end:                                        ; preds = %while.end.loopexit, %while.body38
  %j.0.lcssa = phi i32 [ 0, %while.body38 ], [ %37, %while.end.loopexit ]
...
if.then59:                                        ; preds = %while.end
  ...
  %38 = load i8, ptr %arrayidx61, align 1, !tbaa !9
...
if.end69:                                         ; preds = %if.then65
  %39 = load i32, ptr @num_of_matched, align 4, !tbaa !5
  %inc70 = add nsw i32 %39, 1
  store i32 %inc70, ptr @num_of_matched, align 4, !tbaa !5
  %40 = load i32, ptr @FILENAMEONLY, align 4, !tbaa !5
  %tobool71 = icmp ne i32 %40, 0
  %41 = load i32, ptr @SILENT, align 4
...
while.cond77:                                     ; preds = %if.end74, %while.cond77
  ...
  %43 = load i8, ptr %text.addr.2, align 1, !tbaa !9
  %cmp79.not = icmp eq i8 %43, 10
...
if.else:                                          ; preds = %if.end74
  %44 = load i32, ptr @INVERSE, align 4, !tbaa !5
  %tobool84.not = icmp eq i32 %44, 0
  %45 = load i32, ptr @FNAME, align 4, !tbaa !5
  %tobool86.not = icmp eq i32 %45, 0
...
while.body101:                                    ; preds = %while.cond96.preheader, %while.body101
  ...
  %call.i = tail call i32 @_IO_putc(i32 noundef %conv98, ptr noundef %49)
  %incdec.ptr97 = getelementptr inbounds i8, ptr %incdec.ptr97269, i64 1
  %50 = load i8, ptr %incdec.ptr97, align 1, !tbaa !9
  %cmp99.not = icmp eq i8 %50, 10
...
while.end104:                                     ; preds = %while.body101, %while.cond96.preheader
  ...
  %call.i234 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %51)
  br label %if.end155
...
while.cond111:                                    ; preds = %while.cond111.preheader, %while.cond111
  ...
  %52 = load i8, ptr %incdec.ptr112, align 1, !tbaa !9
  %cmp114.not = icmp eq i8 %52, 10
...
while.body125:                                    ; preds = %while.end117, %while.body125
  ...
  %53 = load i8, ptr %lastout.2266, align 1, !tbaa !9
  %conv127 = zext i8 %53 to i32
  %54 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call.i235 = tail call i32 @_IO_putc(i32 noundef %conv127, ptr noundef %54)
...
if.then131:                                       ; preds = %while.end129
  %55 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call.i236 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %55)
...
while.cond134:                                    ; preds = %while.cond134.preheader, %while.cond134
  ...
  %56 = load i8, ptr %incdec.ptr135, align 1, !tbaa !9
  %cmp137.not = icmp eq i8 %56, 10
...
if.end155:                                        ; preds = %if.end145, %while.cond77, %while.end104, %while.end140, %for.end, %if.end
  %shift.0 = phi i8 [ %10, %if.end ], [ 1, %for.end ], [ %conv153, %while.end140 ], [ %conv153, %while.end104 ], [ %conv153, %while.cond77 ], [ 1, %if.end145 ]
...
while.end159:                                     ; preds = %if.end155, %entry
  ...
  %57 = load i32, ptr @INVERSE, align 4, !tbaa !5
  %tobool160 = icmp eq i32 %57, 0
...
while.body166:                                    ; preds = %while.end159, %while.body166
  ...
  %59 = load i8, ptr %lastout.6276, align 1, !tbaa !9
  %conv168 = zext i8 %59 to i32
  %60 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call.i237 = tail call i32 @_IO_putc(i32 noundef %conv168, ptr noundef %60)
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 17408, ptr nonnull %text) #16
  ...
  %call86 = call i64 @read(i32 noundef %fd, ptr noundef nonnull %add.ptr, i64 noundef 8192) #16
...
while.cond5:                                      ; preds = %while.cond5, %if.end
  ...
  %8 = select i1 %cmp9, i1 %cmp11, i1 false
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
...
if.end29:                                         ; preds = %if.end23
  ...
  %call41 = call ptr @strncpy(ptr noundef nonnull %add.ptr36, ptr noundef nonnull %arrayidx6.le, i64 noundef %conv40) #16
  %call = call i64 @read(i32 noundef %fd, ptr noundef nonnull %add.ptr, i64 noundef 8192) #16
  %conv = trunc i64 %call to i32
  %cmp = icmp sgt i32 %conv, 0
...
while.end42:                                      ; preds = %if.end29
  ...
  br i1 %14, label %if.then49, label %cleanup

if.then49:                                        ; preds = %while.end42
  %15 = load i32, ptr @SHORT, align 4, !tbaa !5
  %tobool50.not = icmp eq i32 %15, 0
  br i1 %tobool50.not, label %if.else53, label %if.then51

if.then51:                                        ; preds = %if.then49
  call void @m_short(ptr noundef nonnull %text, i32 noundef %spec.store.select, i32 noundef %13)
  br label %cleanup

if.else53:                                        ; preds = %if.then49
  call void @monkey1(ptr noundef nonnull %text, i32 noundef %spec.store.select, i32 noundef %13)
  br label %cleanup

cleanup:                                          ; preds = %entry, %while.end42, %if.else53, %if.then51, %if.then27
  call void @llvm.lifetime.end.p0(i64 17408, ptr nonnull %text) #16
  ret void
}
