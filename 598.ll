; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/hexxagon/hexxagonmove.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/hexxagon/hexxagonmove.cpp"
...
define dso_local void @_ZN16HexxagonMoveList7addMoveER12HexxagonMove(ptr nocapture noundef nonnull align 8 dereferenceable(16) %this, ptr nocapture noundef nonnull readonly align 4 dereferenceable(8) %move) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
entry:
...
if.then5:                                         ; preds = %for.body
  ...
  %call = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %4) #13
  %5 = load ptr, ptr %moves, align 8, !tbaa !11
  %conv6 = sext i32 %1 to i64
  %mul7 = shl nsw i64 %conv6, 3
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %call, ptr align 4 %5, i64 %mul7, i1 false)
...
define dso_local noundef i32 @_Z7comparePKvS0_(ptr nocapture noundef readonly %mp1, ptr nocapture noundef readonly %mp2) #5 {
entry:
...
define dso_local void @_ZN16HexxagonMoveList13sortListQuickEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) %this) local_unnamed_addr #6 align 2 {
entry:
  %moves = getelementptr inbounds %class.HexxagonMoveList, ptr %this, i64 0, i32 1
...
define dso_local void @_ZN16HexxagonMoveList8sortListEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) %this) local_unnamed_addr #8 align 2 {
entry:
  %moves = getelementptr inbounds %class.HexxagonMoveList, ptr %this, i64 0, i32 1
...
define dso_local noundef i32 @_Z7getTimev() local_unnamed_addr #9 {
entry:
...
declare i32 @ftime(ptr noundef) local_unnamed_addr #10

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local noundef ptr @_ZN16HexxagonMoveList7getMoveEi(ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) %this, i32 noundef %i) local_unnamed_addr #5 align 2 {
entry:
  %moves = getelementptr inbounds %class.HexxagonMoveList, ptr %this, i64 0, i32 1
  %0 = load ptr, ptr %moves, align 8, !tbaa !11
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local noundef i32 @_ZN16HexxagonMoveList10getNrMovesEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) %this) local_unnamed_addr #5 align 2 {
entry:
  %0 = load i32, ptr %this, align 8, !tbaa !5
  ret i32 %0
}
...
; Function Attrs: uwtable
define dso_local noundef i32 @_Z9alphaBetaR13HexxagonBoardiiiPFvvE(ptr noundef nonnull align 4 dereferenceable(16) %board, i32 noundef %level, i32 noundef %alpha, i32 noundef %beta, ptr noundef %callback) local_unnamed_addr #0 {
entry:
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %newboard) #15
  ...
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %newboard) #15
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
declare noundef i32 @_ZN13HexxagonBoard8evaluateEv(ptr noundef nonnull align 4 dereferenceable(16)) local_unnamed_addr #10

declare noundef ptr @_ZN13HexxagonBoard16generateMoveListEv(ptr noundef nonnull align 4 dereferenceable(16)) local_unnamed_addr #10

declare noundef i32 @_ZN13HexxagonBoard11countBricksEi(ptr noundef nonnull align 4 dereferenceable(16), i32 noundef) local_unnamed_addr #10

declare void @_ZN13HexxagonBoardC1ERKS_(ptr noundef nonnull align 4 dereferenceable(16), ptr noundef nonnull align 4 dereferenceable(16)) unnamed_addr #10

declare noundef i32 @_ZN13HexxagonBoard9applyMoveER12HexxagonMove(ptr noundef nonnull align 4 dereferenceable(16), ptr noundef nonnull align 4 dereferenceable(8)) local_unnamed_addr #10

; Function Attrs: uwtable
define dso_local void @_ZN16HexxagonMoveList13scoreAllMovesE13HexxagonBoardiPFvvEi(ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) %this, ptr noundef %board, i32 noundef %depth, ptr noundef %callback, i32 noundef %maxtime) local_unnamed_addr #0 align 2 {
entry:
  %tb.i = alloca %struct.timeb, align 8
  %newboard = alloca %class.HexxagonBoard, align 4
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %tb.i) #15
  %call.i = call i32 @ftime(ptr noundef nonnull %tb.i)
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %tb.i) #15
...
; Function Attrs: mustprogress uwtable
define dso_local noundef ptr @_ZN16HexxagonMoveList11getBestMoveEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) %this) local_unnamed_addr #9 align 2 {
entry:
  %tb.i = alloca %struct.timeb, align 8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %tb.i) #15
  %call.i = call i32 @ftime(ptr noundef nonnull %tb.i)
  ...
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %tb.i) #15
  call void @srandom(i32 noundef %conv1.i) #15
...
declare void @srandom(i32 noundef) local_unnamed_addr #11
...
attributes #6 = { mustprogress nofree uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
