; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/getpic.c"
...
if.then2:                                         ; preds = %Update_Picture_Buffers.exit
  tail call void @Substitute_Frame_Buffer(i32 noundef %bitstream_framenum, i32 noundef %sequence_framenum) #8
...
if.then7:                                         ; preds = %if.end3
  tail call void @Spatial_Prediction() #8
  br label %if.end8
...
if.end8:                                          ; preds = %if.then7, %if.end3
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %macroblock_type.i.i) #8
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %motion_type.i.i) #8
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %dct_type.i.i) #8
  call void @llvm.lifetime.start.p0(i64 12, ptr nonnull %dc_dct_pred.i.i) #8
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %PMV.i.i) #8
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %motion_vertical_field_select.i.i) #8
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %dmvector.i.i) #8
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %stwtype.i.i) #8
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %stwclass.i.i) #8
  store ptr @base, ptr @ld, align 8, !tbaa !9
  store i32 0, ptr @Fault_Flag, align 4, !tbaa !5
  tail call void @next_start_code() #8
  %call.i.i9.i = tail call i32 @Show_Bits(i32 noundef 32) #8
...
if.end4.i.i.i:                                    ; preds = %slice.exit.i, %if.end4.i.i.lr.ph.i
  ...
  call void @Flush_Buffer32() #8
  %call5.i.i.i = call i32 @slice_header() #8
...
if.then7.i.i.i:                                   ; preds = %if.end4.i.i.i
  ...
  call void @next_start_code() #8
  %call8.i.i.i = call i32 @Show_Bits(i32 noundef 32) #8
...
if.end17.i.i.i:                                   ; preds = %if.then7.i.i.i
  call void @Flush_Buffer32() #8
  %call18.i.i.i = call i32 @slice_header() #8
...
if.end22.i.i.i:                                   ; preds = %if.then20.i.i.i, %if.end17.i.i.i, %if.end4.i.i.i
  ...
  %call23.i.i.i = call i32 @Get_macroblock_address_increment() #8
...
if.end14.i.i:                                     ; preds = %if.then13.i.i, %if.then9.i.i
  %call15.i.i = call i32 @Show_Bits(i32 noundef 23) #8
...
if.end23.i.i:                                     ; preds = %if.then22.i.i, %if.else.i.i
  %call24.i.i = call i32 @Get_macroblock_address_increment() #8
...
if.then38.i.i:                                    ; preds = %if.end36.i.i
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %motion_vector_count.i.i.i) #8
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %mv_format.i.i.i) #8
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %dmv.i.i.i) #8
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %mvscale.i.i.i) #8
...
if.then7.i102.i.i:                                ; preds = %if.end5.i.i.i
  %call.i101.i.i = call i32 @Get_Bits(i32 noundef 5) #8
...
if.then28.i.i.i:                                  ; preds = %if.then25.i106.i.i
  ...
  call void @motion_vectors(ptr noundef nonnull %PMV.i.i, ptr noundef nonnull %dmvector.i.i, ptr noundef nonnull %motion_vertical_field_select.i.i, i32 noundef 0, i32 noundef %64, i32 noundef %65, i32 noundef %sub.i107.i.i, i32 noundef %sub29.i108.i.i, i32 noundef %68, i32 noundef %69) #8
...
if.else30.i.i.i:                                  ; preds = %if.then25.i106.i.i
  ...
  call void @motion_vector(ptr noundef nonnull %PMV.i.i, ptr noundef nonnull %dmvector.i.i, i32 noundef %sub33.i.i.i, i32 noundef %sub33.i.i.i, i32 noundef 0, i32 noundef 0, i32 noundef %71) #8
  br label %if.end36.i.i.i
...
if.then45.i.i.i:                                  ; preds = %if.then42.i.i.i
  ...
  call void @motion_vectors(ptr noundef nonnull %PMV.i.i, ptr noundef nonnull %dmvector.i.i, ptr noundef nonnull %motion_vertical_field_select.i.i, i32 noundef 1, i32 noundef %75, i32 noundef %76, i32 noundef %sub46.i.i.i, i32 noundef %sub47.i.i.i, i32 noundef 0, i32 noundef %79) #8
...
if.else48.i.i.i:                                  ; preds = %if.then42.i.i.i
  ...
  call void @motion_vector(ptr noundef nonnull %arrayidx50.i.i.i, ptr noundef nonnull %dmvector.i.i, i32 noundef %sub52.i.i.i, i32 noundef %sub52.i.i.i, i32 noundef 0, i32 noundef 0, i32 noundef %81) #8
  br label %if.end55.i.i.i
...
if.then63.i.i.i:                                  ; preds = %if.end58.i.i.i
  call void @Flush_Buffer(i32 noundef 1) #8
...
if.then74.i.i.i:                                  ; preds = %if.end71.i.i.i
  %call75.i.i.i = call i32 @Get_coded_block_pattern() #8
...
if.then78.i.i.i:                                  ; preds = %if.then74.i.i.i
  ...
  %call80.i.i.i = call i32 @Get_Bits(i32 noundef 2) #8
...
if.then84.i.i.i:                                  ; preds = %if.then74.i.i.i
  ...
  %call86.i.i.i = call i32 @Get_Bits(i32 noundef 6) #8
...
if.then120.i.i.i:                                 ; preds = %if.then117.i.i.i
  call void @Decode_MPEG2_Intra_Block(i32 noundef %indvars300.i.i.i, ptr noundef nonnull %dc_dct_pred.i.i) #8
  br label %if.end129.i.i.i

if.else121.i.i.i:                                 ; preds = %if.then117.i.i.i
  call void @Decode_MPEG1_Intra_Block(i32 noundef %indvars300.i.i.i, ptr noundef nonnull %dc_dct_pred.i.i) #8
  br label %if.end129.i.i.i
...
if.then126.i.i.i:                                 ; preds = %if.else123.i.i.i
  call void @Decode_MPEG2_Non_Intra_Block(i32 noundef %indvars300.i.i.i) #8
  br label %if.end129.i.i.i

if.else127.i.i.i:                                 ; preds = %if.else123.i.i.i
  call void @Decode_MPEG1_Non_Intra_Block(i32 noundef %indvars300.i.i.i) #8
  br label %if.end129.i.i.i
...
if.then136.i.i.i:                                 ; preds = %for.end.i.i.i
  call void @marker_bit(ptr noundef nonnull @.str.6) #8
...
if.end174.i.i.i:                                  ; preds = %if.then149.i.i.i, %if.end144.i.i.i, %if.end144.i.thread.i.i
  ...
  %or.cond.i.i = select i1 %cmp175.i.i.i, i1 %tobool179.not.i.i.i, i1 false
...
decode_macroblock.exit.thread.i.i:                ; preds = %if.end99.i.i.i, %if.end55.i.i.i, %if.end36.i.i.i, %if.end3.i.i.i, %if.end129.i.i.i
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %mvscale.i.i.i) #8
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %dmv.i.i.i) #8
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %mv_format.i.i.i) #8
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %motion_vector_count.i.i.i) #8
  br label %slice.exit.i
...
for.body.lr.ph.i.i.i:                             ; preds = %if.end.i.i.i
  ...
  %uglygep.i.i.i = getelementptr i8, ptr %104, i64 3176
  %105 = zext i32 %103 to i64
  %106 = shl nuw nsw i64 %105, 7
  call void @llvm.memset.p0.i64(ptr align 2 %uglygep.i.i.i, i8 0, i64 %106, i1 false), !tbaa !19
...
if.then58.i.i:                                    ; preds = %if.end54.i.i
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %SNRmacroblock_type.i.i.i) #8
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %SNRdct_type.i.i.i) #8
...
if.then.i120.i.i:                                 ; preds = %if.then58.i.i
  %call.i118.i.i = call i32 @Show_Bits(i32 noundef 23) #8
...
if.then1.i.i.i:                                   ; preds = %if.then.i120.i.i
  call void @next_start_code() #8
  %call2.i.i.i = call i32 @Show_Bits(i32 noundef 32) #8
...
if.end20.i.i.i:                                   ; preds = %if.else.i125.i.i
  %call21.i.i.i = call i32 @Get_macroblock_address_increment() #8
...
if.end23.thread.i.i.i:                            ; preds = %if.then1.i.i.i
  call void @Flush_Buffer32() #8
  %call10.i.i.i = call i32 @slice_header() #8
  %call11.i.i.i = call i32 @Get_macroblock_address_increment() #8
...
for.body77.lr.ph.i.i.i:                           ; preds = %for.cond74.preheader.i.i.i
  ...
  %uglygep.i133.i.i = getelementptr i8, ptr %119, i64 3176
  %120 = zext i32 %118 to i64
  %121 = shl nuw nsw i64 %120, 7
  call void @llvm.memset.p0.i64(ptr align 2 %uglygep.i133.i.i, i8 0, i64 %121, i1 false), !tbaa !19
...
if.then39.i.i.i:                                  ; preds = %if.end36.i134.i.i
  %call40.i.i.i = call i32 @Get_Bits(i32 noundef 5) #8
...
if.then46.i.i.i:                                  ; preds = %if.end43.i.i.i
  %call47.i.i.i = call i32 @Get_coded_block_pattern() #8
...
if.end63.sink.split.i.i.i:                        ; preds = %if.then56.i.i.i, %if.then46.i.i.i
  ...
  %call52.i.i.i = call i32 @Get_Bits(i32 noundef %.sink124.i.i.i) #8
...
if.then71.i.i.i:                                  ; preds = %for.body.i146.i.i
  call void @Decode_MPEG2_Non_Intra_Block(i32 noundef %indvars119.i.i.i) #8
...
Decode_SNR_Macroblock.exit.i.i:                   ; preds = %if.end81.i.i.i, %if.then27.i.i.i, %if.then25.i131.i.i, %if.then17.i.i.i, %if.then15.i.i.i, %if.then7.i124.i.i, %if.then5.i123.i.i
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %SNRdct_type.i.i.i) #8
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %SNRmacroblock_type.i.i.i) #8
...
if.then.i153.i.i:                                 ; preds = %if.end59.i.i
  ...
  call void @form_predictions(i32 noundef %mul.i150.i.i, i32 noundef %mul1.i.i.i, i32 noundef %110, i32 noundef %138, ptr noundef nonnull %PMV.i.i, ptr noundef nonnull %motion_vertical_field_select.i.i, ptr noundef nonnull %dmvector.i.i, i32 noundef %137) #8
...
if.then16.i170.i.i:                               ; preds = %if.end14.i.i.i
  call void @Reference_IDCT(ptr noundef nonnull %arrayidx23.i169.i.i) #8
  br label %if.end25.i.i.i

if.else.i171.i.i:                                 ; preds = %if.end14.i.i.i
  call void @Fast_IDCT(ptr noundef nonnull %arrayidx23.i169.i.i) #8
  br label %if.end25.i.i.i
...
if.then3.i.i.i.i:                                 ; preds = %if.then.i.i.i.i
  ...
  %add.ptr18.i.i.i16.i = getelementptr i8, ptr %207, i64 %idx.ext34.i.i.i.i
...
if.then4.i.i.i.i:                                 ; preds = %if.then3.i.i.i.i
  ...
  %add.ptr8.i.i.i.i = getelementptr i8, ptr %add.ptr18.i.i.i16.i, i64 %idx.ext.i.i.i.i
...
if.else.i46.i.i.i:                                ; preds = %if.then3.i.i.i.i
  ...
  %add.ptr20.i.i.i.i = getelementptr i8, ptr %add.ptr18.i.i.i16.i, i64 %idx.ext17.i.i.i.i
...
if.else26.i.i.i.i:                                ; preds = %if.then.i.i.i.i
  ...
  %add.ptr33.i.i.i14.i = getelementptr i8, ptr %207, i64 %idx.ext34.i.i.i.i
  %add.ptr35.i.i.i.i = getelementptr i8, ptr %add.ptr33.i.i.i14.i, i64 %idx.ext32.i.i.i.i
...
if.else43.i.i.i.i:                                ; preds = %if.end25.i.i.i
  %209 = load i32, ptr @chroma_format, align 4, !tbaa !5
...
slice.exit.i:                                     ; preds = %if.end23.i.i, %if.end14.i.i, %decode_macroblock.exit.thread.i.i, %if.then25.i.i.i
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %stwclass.i.i) #8
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %stwtype.i.i) #8
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %dmvector.i.i) #8
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %motion_vertical_field_select.i.i) #8
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %PMV.i.i) #8
  call void @llvm.lifetime.end.p0(i64 12, ptr nonnull %dc_dct_pred.i.i) #8
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %dct_type.i.i) #8
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %motion_type.i.i) #8
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %macroblock_type.i.i) #8
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %macroblock_type.i.i) #8
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %motion_type.i.i) #8
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %dct_type.i.i) #8
  call void @llvm.lifetime.start.p0(i64 12, ptr nonnull %dc_dct_pred.i.i) #8
  ...
  store i32 0, ptr @Fault_Flag, align 4, !tbaa !5
  call void @next_start_code() #8
  %call.i.i.i = call i32 @Show_Bits(i32 noundef 32) #8
...
if.then4.i:                                       ; preds = %if.then2.i
  ...
  call void @Write_Frame(ptr noundef nonnull @auxframe, i32 noundef %sub.i) #8
...
if.else.i:                                        ; preds = %if.then2.i
  ...
  call void @Write_Frame(ptr noundef nonnull @forward_reference_frame, i32 noundef %sub5.i) #8
...
if.else:                                          ; preds = %entry
  ...
  tail call void @Write_Frame(ptr noundef nonnull @backward_reference_frame, i32 noundef %sub) #8
  br label %if.end
...
entry:
  %call = tail call i32 @Get_macroblock_type() #8
...
if.else:                                          ; preds = %if.then2
  %call4 = tail call i32 @Get_Bits(i32 noundef 2) #8
...
if.end36thread-pre-split.sink.split:              ; preds = %if.then17
  %call25 = tail call i32 @Get_Bits(i32 noundef 2) #8
...
if.end52:                                         ; preds = %if.else48, %if.then39
  ...
  %13 = phi i32 [ 3, %if.then39 ], [ %9, %if.else48 ]
  ...
  %14 = and i1 %cmp37100, %cmp55
  %land.ext = zext i1 %14 to i32
  %cmp61 = icmp ne i32 %13, 3
  %15 = load i32, ptr @frame_pred_frame_dct, align 4
  %tobool64 = icmp ne i32 %15, 0
...
cond.true68:                                      ; preds = %if.end52
  %call69 = tail call i32 @Get_Bits(i32 noundef 1) #8
  br label %cond.end71
