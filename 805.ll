; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/23tree.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/23tree.c"
...
if.end:                                           ; preds = %entry
  %call = tail call noalias dereferenceable_or_null(80008) ptr @malloc(i64 noundef 80008) #15
...
; Function Attrs: nounwind uwtable
define dso_local void @tpop(ptr noundef %root, ptr nocapture noundef writeonly %node, ptr nocapture noundef %value, ptr nocapture noundef writeonly %property) local_unnamed_addr #0 {
entry:
...
; Function Attrs: nounwind uwtable
define dso_local void @tdelete(ptr noundef %root, i32 noundef %value, i32 noundef %property) local_unnamed_addr #0 {
entry:
  %0 = load ptr, ptr %root, align 8, !tbaa !5
  %cmp = icmp eq ptr %0, null
...
if.then6:                                         ; preds = %while.body.i
  ...
  tail call void @free(ptr noundef nonnull %plptr.0.i) #16
  br label %if.end371
...
if.then11:                                        ; preds = %if.else8
  ...
  tail call void @free(ptr noundef nonnull %plptr.08.i) #16
  br label %if.end371
...
if.then24:                                        ; preds = %while.body.i660
  ...
  tail call void @free(ptr noundef nonnull %plptr.0.i662) #16
  br label %if.end371
...
if.then30:                                        ; preds = %if.else27
  ...
  tail call void @free(ptr noundef nonnull %plptr.08.i656) #16
  br label %if.end371
...
; Function Attrs: nounwind uwtable
define dso_local void @ttrim(ptr noundef %root, i32 noundef %threshold) local_unnamed_addr #0 {
entry:
  %0 = load ptr, ptr %root, align 8, !tbaa !5
...
; Function Attrs: nounwind uwtable
define dso_local void @tdiscard(ptr noundef %root, i32 noundef %count) local_unnamed_addr #0 {
entry:
...
tailrecurse:                                      ; preds = %if.end104, %entry
  ...
  %call = tail call noalias dereferenceable_or_null(64) ptr @malloc(i64 noundef 64) #15
...
if.then67:                                        ; preds = %if.end64
  ...
  %call68 = tail call noalias dereferenceable_or_null(64) ptr @malloc(i64 noundef 64) #15
...
if.then:                                          ; preds = %entry
  %call.i = tail call noalias dereferenceable_or_null(64) ptr @malloc(i64 noundef 64) #15
  ...
  %call2.i = tail call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #15
...
if.then5:                                         ; preds = %if.then2
  %call.i190 = tail call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #15
...
if.else6:                                         ; preds = %if.then2
  %call.i193 = tail call noalias dereferenceable_or_null(64) ptr @malloc(i64 noundef 64) #15
  ...
  %call2.i196 = tail call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #15
...
if.then28:                                        ; preds = %tsearch.exit, %if.else.i204, %if.then9.i
  ...
  %call.i207 = tail call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #15
...
if.else29:                                        ; preds = %if.then9.i, %if.else7.i
  %call.i210 = tail call noalias dereferenceable_or_null(64) ptr @malloc(i64 noundef 64) #15
  ...
  %call2.i213 = tail call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #15
...
define dso_local void @makenode(ptr nocapture noundef %v, i32 noundef %value, i32 noundef %property) local_unnamed_addr #8 {
entry:
  %call = tail call noalias dereferenceable_or_null(64) ptr @malloc(i64 noundef 64) #15
  ...
  %call2 = tail call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #15
...
; Function Attrs: nounwind uwtable
define dso_local void @tsubson(ptr noundef %root, ptr noundef %l) local_unnamed_addr #0 {
entry:
...
if.end:                                           ; preds = %if.then, %if.then2
  ...
  tail call void @free(ptr noundef nonnull %l.tr.lcssa) #16
...
if.then24:                                        ; preds = %if.then21
  ...
  tail call void @free(ptr noundef nonnull %l.tr608) #16
...
tpatch.exit:                                      ; preds = %if.then4.i, %tailrecurse.backedge.i, %if.else147, %if.then2.i
  tail call void @free(ptr noundef %l.tr608) #16
  br label %if.end267
...
define dso_local i32 @tprop(ptr noundef readonly %r, i32 noundef %value) local_unnamed_addr #12 {
entry:
...
; Function Attrs: nofree norecurse nosync nounwind memory(read, inaccessiblemem: none) uwtable
define dso_local ptr @tplist(ptr noundef readonly %r, i32 noundef %value) local_unnamed_addr #12 {
entry:
  %cmp = icmp eq ptr %r, null
  br i1 %cmp, label %cleanup, label %if.else
...
attributes #8 = { mustprogress nofree nounwind willreturn uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #10 = { nofree nosync nounwind memory(argmem: read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
