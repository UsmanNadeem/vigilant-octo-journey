; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/football/sort.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/football/sort.c"
...
if.end:                                           ; preds = %cond.end61
  ...
  %cmp151 = icmp eq i32 %5, 0
  %or.cond = select i1 %cmp146, i1 %cmp151, i1 false
...
if.end162:                                        ; preds = %if.end
  ...
  %cmp172 = icmp eq i32 %4, 0
  %or.cond307 = select i1 %cmp166, i1 %cmp172, i1 false
...
if.end:                                           ; preds = %entry
  %call = tail call i32 @net_nfl_lt(ptr noundef %info, i32 noundef %team1, i32 noundef %team2)
  br label %return
...
if.end:                                           ; preds = %cond.end61
  ...
  %cmp73 = icmp eq i32 %5, 0
  %or.cond = select i1 %cmp68, i1 %cmp73, i1 false
...
if.end84:                                         ; preds = %if.end
  %cmp88 = icmp ne i32 %0, 0
  %cmp94 = icmp ne i32 %4, 0
  %or.cond151.not = select i1 %cmp88, i1 true, i1 %cmp94
  %cmp103 = icmp eq i32 %1, %5
  %spec.select = select i1 %or.cond151.not, i1 true, i1 %cmp103
  br label %return
...
if.end.i:                                         ; preds = %cond.end61.i
  %cmp68.i = icmp eq i32 %4, 0
  %cmp73.i = icmp eq i32 %8, 0
  %or.cond.i = select i1 %cmp68.i, i1 %cmp73.i, i1 false
...
tied.exit:                                        ; preds = %if.end.i
  %cmp88.i = icmp ne i32 %3, 0
  %cmp94.i = icmp ne i32 %7, 0
  %or.cond151.not.i = select i1 %cmp88.i, i1 true, i1 %cmp94.i
  %cmp103.i = icmp eq i32 %4, %8
  %spec.select.i = select i1 %or.cond151.not.i, i1 true, i1 %cmp103.i
...
land.lhs.true26:                                  ; preds = %cond.true13
  ...
  %13 = load i32, ptr %arrayidx17, align 8, !tbaa !12
  %14 = load i32, ptr %arrayidx23, align 8, !tbaa !12
  %cmp38 = icmp eq i32 %13, %14
...
cond.true41:                                      ; preds = %cond.true11
  ...
  %15 = load i32, ptr %arrayidx45, align 8, !tbaa !12
  %arrayidx51 = getelementptr inbounds [29 x [2 x i32]], ptr @divisions, i64 0, i64 %idxprom25.i
  %16 = load i32, ptr %arrayidx51, align 8, !tbaa !12
...
land.lhs.true54:                                  ; preds = %cond.true41
  ...
  %17 = load i32, ptr %arrayidx9, align 4, !tbaa !12
  %call61 = tail call i32 @a_champ(i32 noundef %17) #6
...
cond.false63:                                     ; preds = %cond.true11
  ...
  %18 = load i32, ptr %arrayidx9, align 4, !tbaa !12
  %call70 = tail call i32 @a_champ(i32 noundef %18) #6
  %cmp71 = icmp eq i32 %call66, %call70
  br i1 %cmp71, label %land.lhs.true72, label %if.then82

land.lhs.true72:                                  ; preds = %cond.false63
  %19 = load i32, ptr %arrayidx, align 4, !tbaa !12
  %call75 = tail call i32 @a_wild_card(i32 noundef %19) #6
  %20 = load i32, ptr %arrayidx9, align 4, !tbaa !12
  %call79 = tail call i32 @a_wild_card(i32 noundef %20) #6
...
if.then82:                                        ; preds = %if.then75.i, %cond.end61.i, %tied.exit, %for.body, %land.lhs.true72, %cond.false63, %land.lhs.true54, %cond.true41, %land.lhs.true26, %cond.true13
  %21 = zext i32 %first_of_equals.0407 to i64
  %cmp83.not = icmp eq i64 %indvars.iv, %21
...
if.then84:                                        ; preds = %if.then82
  ...
  %add87 = sub i32 %23, %first_of_equals.0407
...
if.then89:                                        ; preds = %if.then84
  ...
  tail call void @prompt(ptr noundef %24, ptr noundef %25) #6
  %26 = load i32, ptr @got_unused_responce, align 4, !tbaa !12
...
for.inc:                                          ; preds = %if.then84, %if.then89, %if.then82.if.end94_crit_edge, %land.lhs.true26, %land.lhs.true54, %land.lhs.true72
  %indvars.iv.next.pre-phi = phi i64 [ %1, %land.lhs.true26 ], [ %1, %land.lhs.true54 ], [ %1, %land.lhs.true72 ], [ %.pre, %if.then82.if.end94_crit_edge ], [ %22, %if.then89 ], [ %22, %if.then84 ]
  ...
  %first_of_equals.1 = phi i32 [ %first_of_equals.0407, %land.lhs.true26 ], [ %first_of_equals.0407, %land.lhs.true54 ], [ %first_of_equals.0407, %land.lhs.true72 ], [ %.pre425, %if.then82.if.end94_crit_edge ], [ %23, %if.then89 ], [ %23, %if.then84 ]
...
for.body101:                                      ; preds = %for.cond99.preheader, %for.inc216
  ...
  %27 = phi i32 [ %nfc_east_champ.promoted, %for.cond99.preheader ], [ %36, %for.inc216 ]
  %28 = phi i32 [ %nfc_central_champ.promoted, %for.cond99.preheader ], [ %40, %for.inc216 ]
  %29 = phi i32 [ %nfc_west_champ.promoted, %for.cond99.preheader ], [ %44, %for.inc216 ]
  %30 = phi i32 [ %afc_east_champ.promoted, %for.cond99.preheader ], [ %48, %for.inc216 ]
  %31 = phi i32 [ %afc_central_champ.promoted, %for.cond99.preheader ], [ %52, %for.inc216 ]
  %32 = phi i32 [ %afc_west_champ.promoted, %for.cond99.preheader ], [ %56, %for.inc216 ]
  %cmp102 = icmp eq i32 %27, 0
...
land.lhs.true122:                                 ; preds = %if.end120
  ...
  %37 = load i32, ptr %arrayidx124, align 4, !tbaa !12
  %idxprom125 = sext i32 %37 to i64
  %arrayidx126 = getelementptr inbounds [29 x [2 x i32]], ptr @divisions, i64 0, i64 %idxprom125
  %38 = load i32, ptr %arrayidx126, align 8, !tbaa !12
  %cmp128 = icmp eq i32 %38, 0
...
land.lhs.true129:                                 ; preds = %land.lhs.true122
  ...
  %39 = load i32, ptr %arrayidx134, align 4, !tbaa !12
  %cmp135 = icmp eq i32 %39, 1
  br i1 %cmp135, label %if.then136, label %if.end139

if.then136:                                       ; preds = %land.lhs.true129
  store i32 %37, ptr @nfc_central_champ, align 4, !tbaa !12
  br label %if.end139

if.end139:                                        ; preds = %if.then136, %land.lhs.true129, %land.lhs.true122, %if.end120
  %40 = phi i32 [ %37, %if.then136 ], [ 0, %land.lhs.true129 ], [ 0, %land.lhs.true122 ], [ %28, %if.end120 ]
  %cmp140 = icmp eq i32 %29, 0
...
land.lhs.true148:                                 ; preds = %land.lhs.true141
  ...
  %43 = load i32, ptr %arrayidx153, align 4, !tbaa !12
  %cmp154 = icmp eq i32 %43, 2
  br i1 %cmp154, label %if.then155, label %if.end158

if.then155:                                       ; preds = %land.lhs.true148
  store i32 %41, ptr @nfc_west_champ, align 4, !tbaa !12
  br label %if.end158

if.end158:                                        ; preds = %if.then155, %land.lhs.true148, %land.lhs.true141, %if.end139
  %44 = phi i32 [ %41, %if.then155 ], [ 0, %land.lhs.true148 ], [ 0, %land.lhs.true141 ], [ %29, %if.end139 ]
  %cmp159 = icmp eq i32 %30, 0
...
land.lhs.true160:                                 ; preds = %if.end158
  ...
  %45 = load i32, ptr %arrayidx162, align 4, !tbaa !12
  %idxprom163 = sext i32 %45 to i64
  %arrayidx164 = getelementptr inbounds [29 x [2 x i32]], ptr @divisions, i64 0, i64 %idxprom163
  %46 = load i32, ptr %arrayidx164, align 8, !tbaa !12
  %cmp166 = icmp eq i32 %46, 1
...
land.lhs.true167:                                 ; preds = %land.lhs.true160
  ...
  %47 = load i32, ptr %arrayidx172, align 4, !tbaa !12
  %cmp173 = icmp eq i32 %47, 0
  br i1 %cmp173, label %if.then174, label %if.end177

if.then174:                                       ; preds = %land.lhs.true167
  store i32 %45, ptr @afc_east_champ, align 4, !tbaa !12
  br label %if.end177

if.end177:                                        ; preds = %if.then174, %land.lhs.true167, %land.lhs.true160, %if.end158
  %48 = phi i32 [ %45, %if.then174 ], [ 0, %land.lhs.true167 ], [ 0, %land.lhs.true160 ], [ %30, %if.end158 ]
  %cmp178 = icmp eq i32 %31, 0
...
land.lhs.true186:                                 ; preds = %land.lhs.true179
  ...
  %51 = load i32, ptr %arrayidx191, align 4, !tbaa !12
  %cmp192 = icmp eq i32 %51, 1
  br i1 %cmp192, label %if.then193, label %if.end196

if.then193:                                       ; preds = %land.lhs.true186
  store i32 %49, ptr @afc_central_champ, align 4, !tbaa !12
  br label %if.end196

if.end196:                                        ; preds = %if.then193, %land.lhs.true186, %land.lhs.true179, %if.end177
  %52 = phi i32 [ %49, %if.then193 ], [ 0, %land.lhs.true186 ], [ 0, %land.lhs.true179 ], [ %31, %if.end177 ]
  %cmp197 = icmp eq i32 %32, 0
...
land.lhs.true198:                                 ; preds = %if.end196
  ...
  %53 = load i32, ptr %arrayidx200, align 4, !tbaa !12
  %idxprom201 = sext i32 %53 to i64
  %arrayidx202 = getelementptr inbounds [29 x [2 x i32]], ptr @divisions, i64 0, i64 %idxprom201
  %54 = load i32, ptr %arrayidx202, align 8, !tbaa !12
  %cmp204 = icmp eq i32 %54, 1
...
land.lhs.true205:                                 ; preds = %land.lhs.true198
  ...
  %55 = load i32, ptr %arrayidx210, align 4, !tbaa !12
  %cmp211 = icmp eq i32 %55, 2
  br i1 %cmp211, label %if.then212, label %for.inc216

if.then212:                                       ; preds = %land.lhs.true205
  store i32 %53, ptr @afc_west_champ, align 4, !tbaa !12
  br label %for.inc216

for.inc216:                                       ; preds = %if.end196, %land.lhs.true198, %land.lhs.true205, %if.then212
  %56 = phi i32 [ %32, %if.end196 ], [ 0, %land.lhs.true198 ], [ 0, %land.lhs.true205 ], [ %53, %if.then212 ]
  %indvars.iv.next422 = add nuw nsw i64 %indvars.iv421, 1
  %exitcond424.not = icmp eq i64 %indvars.iv.next422, 29
  br i1 %exitcond424.not, label %if.end296, label %for.body101, !llvm.loop !19
...
for.body223:                                      ; preds = %for.end, %for.inc292
  ...
  %57 = load i32, ptr %arrayidx225, align 4, !tbaa !12
  %idxprom226 = sext i32 %57 to i64
  %arrayidx227 = getelementptr inbounds [29 x [2 x i32]], ptr @divisions, i64 0, i64 %idxprom226
  %58 = load i32, ptr %arrayidx227, align 8, !tbaa !12
  %cmp229 = icmp eq i32 %58, 0
  %call233 = tail call i32 @a_champ(i32 noundef %57) #6
...
land.lhs.true249:                                 ; preds = %if.then235
  %59 = load i32, ptr @iyear, align 4, !tbaa !12
  %60 = add i32 %59, -90
  %or.cond298 = icmp ult i32 %60, -19
...
land.lhs.true279:                                 ; preds = %if.then265
  %61 = load i32, ptr @iyear, align 4, !tbaa !12
  %62 = add i32 %61, -90
  %or.cond299 = icmp ult i32 %62, -19
...
for.inc292.sink.split:                            ; preds = %land.lhs.true279, %if.then265, %land.lhs.true249, %if.then235, %if.then273, %if.then243
  ...
  %63 = load i32, ptr %arrayidx225, align 4, !tbaa !12
  store i32 %63, ptr %nfc_wild_card1.sink, align 4, !tbaa !12
  br label %for.inc292
...
for.inc292:                                       ; preds = %for.inc292.sink.split, %if.then265, %if.then235, %land.lhs.true249, %if.then230, %land.lhs.true279, %if.else260
  ...
  br i1 %exitcond420.not, label %if.end296, label %for.body223, !llvm.loop !20
...
for.inc:                                          ; preds = %standing_lt.exit, %if.then
  ...
  br i1 %cmp2, label %for.body3, label %for.inc17, !llvm.loop !21

for.inc17:                                        ; preds = %for.inc
  %indvars.iv.next669 = add nuw nsw i64 %indvars.iv668, 1
  %tobool = icmp ne i32 %flag.2, 0
  %8 = select i1 %cmp2623, i1 %tobool, i1 false
  br i1 %8, label %for.cond1.preheader, label %for.end18, !llvm.loop !22
...
for.inc51:                                        ; preds = %conf_standing_lt.exit, %if.then39
  ...
  br i1 %cmp30, label %for.body31, label %for.inc54, !llvm.loop !23

for.inc54:                                        ; preds = %for.inc51
  %indvars.iv.next675 = add nuw nsw i64 %indvars.iv674, 1
  %tobool26 = icmp ne i32 %flag21.2, 0
  %15 = select i1 %cmp30627, i1 %tobool26, i1 false
  br i1 %15, label %for.cond29.preheader, label %for.end56, !llvm.loop !24
...
for.inc89:                                        ; preds = %for.body69, %if.then77
  ...
  br i1 %cmp68, label %for.body69, label %for.inc92, !llvm.loop !25
...
for.inc92:                                        ; preds = %for.inc89
  ...
  br i1 %20, label %for.cond67.preheader, label %for.end94, !llvm.loop !26
...
for.inc127:                                       ; preds = %cond.end139.i, %if.then.i421, %defence_lt.exit, %if.then115
  ...
  br i1 %cmp106, label %for.body107, label %for.inc130, !llvm.loop !27
...
for.inc130:                                       ; preds = %for.inc127
  ...
  br i1 %36, label %for.cond105.preheader, label %for.cond143.preheader.preheader, !llvm.loop !28
...
for.inc165:                                       ; preds = %cond.end122.i, %defence_nfl_lt.exit, %if.then153
  ...
  br i1 %cmp144, label %for.body145, label %for.inc168, !llvm.loop !29

for.inc168:                                       ; preds = %for.inc165
  %indvars.iv.next693 = add nuw nsw i64 %indvars.iv692, 1
  %tobool140 = icmp ne i32 %flag135.2, 0
  %50 = select i1 %cmp144642, i1 %tobool140, i1 false
  br i1 %50, label %for.cond143.preheader, label %for.cond181.preheader.preheader, !llvm.loop !30
...
for.inc203:                                       ; preds = %cond.end139.i485, %if.then.i445, %offence_lt.exit, %if.then191
  ...
  br i1 %cmp182, label %for.body183, label %for.inc206, !llvm.loop !31

for.inc206:                                       ; preds = %for.inc203
  %indvars.iv.next699 = add nuw nsw i64 %indvars.iv698, 1
  %tobool178 = icmp ne i32 %flag173.2, 0
  %66 = select i1 %cmp182647, i1 %tobool178, i1 false
  br i1 %66, label %for.cond181.preheader, label %for.cond219.preheader.preheader, !llvm.loop !32
...
for.inc241:                                       ; preds = %cond.end122.i531, %offence_nfl_lt.exit, %if.then229
  ...
  br i1 %cmp220, label %for.body221, label %for.inc244, !llvm.loop !33

for.inc244:                                       ; preds = %for.inc241
  %indvars.iv.next705 = add nuw nsw i64 %indvars.iv704, 1
  %tobool216 = icmp ne i32 %flag211.2, 0
  %80 = select i1 %cmp220652, i1 %tobool216, i1 false
  br i1 %80, label %for.cond219.preheader, label %for.cond257.preheader.preheader, !llvm.loop !34
...
for.inc279:                                       ; preds = %cond.end136.i617, %if.then.i543, %net_lt.exit, %if.then267
  ...
  br i1 %cmp258, label %for.body259, label %for.inc282, !llvm.loop !35

for.inc282:                                       ; preds = %for.inc279
  %indvars.iv.next711 = add nuw nsw i64 %indvars.iv710, 1
  %tobool254 = icmp ne i32 %flag249.2, 0
  %100 = select i1 %cmp258657, i1 %tobool254, i1 false
  br i1 %100, label %for.cond257.preheader, label %for.cond295.preheader.preheader, !llvm.loop !36
...
for.inc317:                                       ; preds = %cond.end136.i, %net_nfl_lt.exit, %if.then305
  ...
  br i1 %cmp296, label %for.body297, label %for.inc320, !llvm.loop !37
...
for.inc320:                                       ; preds = %for.inc317
  ...
  br i1 %118, label %for.cond295.preheader, label %for.end322, !llvm.loop !38
