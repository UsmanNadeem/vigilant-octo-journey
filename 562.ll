; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/sei.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/sei.c"
...
entry:
  %call = tail call noalias dereferenceable_or_null(65496) ptr @malloc(i64 noundef 65496) #20
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call.1 = tail call noalias dereferenceable_or_null(65496) ptr @malloc(i64 noundef 65496) #20
...
if.then.i:                                        ; preds = %if.end.1
  tail call void @no_mem_exit(ptr noundef nonnull @.str.7) #21
...
if.end.i:                                         ; preds = %if.then.i, %if.end.1
  ...
  %call1.i = tail call noalias dereferenceable_or_null(65496) ptr @malloc(i64 noundef 65496) #20
...
if.then4.i:                                       ; preds = %if.end.i
  tail call void @no_mem_exit(ptr noundef nonnull @.str.8) #21
...
if.end9:                                          ; preds = %if.then8, %InitSubseqChar.exit
  ...
  %call.i16 = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #20
...
if.then.i19:                                      ; preds = %if.end9
  tail call void @no_mem_exit(ptr noundef nonnull @.str.9) #21
...
if.end.i23:                                       ; preds = %if.then.i19, %if.end9
  ...
  %call1.i20 = tail call noalias dereferenceable_or_null(65496) ptr @malloc(i64 noundef 65496) #20
...
if.then4.i26:                                     ; preds = %if.end.i23
  tail call void @no_mem_exit(ptr noundef nonnull @.str.10) #21
...
InitSceneInformation.exit:                        ; preds = %if.end.i23, %if.then4.i26
  ...
  %call.i27 = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #20
...
if.then.i30:                                      ; preds = %InitSceneInformation.exit
  tail call void @no_mem_exit(ptr noundef nonnull @.str.11) #21
...
if.end.i34:                                       ; preds = %if.then.i30, %InitSceneInformation.exit
  ...
  %call1.i31 = tail call noalias dereferenceable_or_null(65496) ptr @malloc(i64 noundef 65496) #20
...
if.then4.i37:                                     ; preds = %if.end.i34
  tail call void @no_mem_exit(ptr noundef nonnull @.str.12) #21
...
InitPanScanRectInfo.exit:                         ; preds = %if.end.i34, %if.then4.i37
  ...
  %call.i40 = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #20
...
if.then.i43:                                      ; preds = %InitPanScanRectInfo.exit
  tail call void @no_mem_exit(ptr noundef nonnull @.str.19) #21
...
if.end.i47:                                       ; preds = %if.then.i43, %InitPanScanRectInfo.exit
  ...
  %call1.i44 = tail call noalias dereferenceable_or_null(65496) ptr @malloc(i64 noundef 65496) #20
...
if.then4.i51:                                     ; preds = %if.end.i47
  tail call void @no_mem_exit(ptr noundef nonnull @.str.20) #21
...
entry:
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(65496) %0, i8 0, i64 65496, i1 false)
  store <2 x i32> zeroinitializer, ptr %arrayidx, align 8, !tbaa !24
  ret void
}
...
; Function Attrs: nounwind uwtable
define dso_local void @CloseSEIMessages() local_unnamed_addr #0 {
entry:
...
define dso_local i32 @HaveAggregationSEI() local_unnamed_addr #6 {
entry:
...
define dso_local void @write_sei_message(i32 noundef %id, ptr nocapture noundef readonly %payload, i32 noundef %payload_size, i32 noundef %payload_type) local_unnamed_addr #7 {
entry:
  %idxprom = sext i32 %id to i64
...
define dso_local void @finalize_sei_message(i32 noundef %id) local_unnamed_addr #9 {
entry:
  %idxprom = sext i32 %id to i64
  %arrayidx = getelementptr inbounds [2 x %struct.sei_struct], ptr @sei_message, i64 0, i64 %idxprom
  %payloadSize = getelementptr inbounds [2 x %struct.sei_struct], ptr @sei_message, i64 0, i64 %idxprom, i32 1
...
define dso_local void @AppendTmpbits2Buf(ptr nocapture noundef %dest, ptr nocapture noundef readonly %source) local_unnamed_addr #11 {
entry:
...
if.end:                                           ; preds = %CloseSparePicture.exit, %entry
  %call = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #20
...
if.end3:                                          ; preds = %if.then2, %if.end
  ...
  %call4 = tail call noalias dereferenceable_or_null(65496) ptr @malloc(i64 noundef 65496) #20
...
define dso_local void @CloseSparePicture() local_unnamed_addr #12 {
entry:
  %0 = load ptr, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 3), align 8, !tbaa !14
...
define dso_local void @CalculateSparePicture() local_unnamed_addr #13 {
entry:
  ret void
}
...
entry:
  ...
  %0 = load ptr, ptr getelementptr inbounds (%struct.spare_picture_struct, ptr @seiSparePicturePayload, i64 0, i32 3), align 8, !tbaa !14
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %sym) #21
  ...
  %call = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #21
  store i32 %ref_area_indicator, ptr %value1, align 4, !tbaa !74
  %call2 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #21
  call void @AppendTmpbits2Buf(ptr noundef %0, ptr noundef %tmpBitstream)
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %sym) #21
  ret void
}
...
if.else:                                          ; preds = %for.body15
  ...
  %call = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %bitstream) #21
...
if.then137:                                       ; preds = %for.end134
  ...
  %call139 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %bitstream) #21
...
if.end:                                           ; preds = %if.then, %entry
  %call1 = tail call noalias dereferenceable_or_null(65496) ptr @malloc(i64 noundef 65496) #20
...
if.end5:                                          ; preds = %if.then4, %if.end
  ...
  %call10 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef nonnull %call) #21
  ...
  %call13 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef nonnull %call) #21
...
entry:
  ...
  store <2 x i32> <i32 0, i32 -1>, ptr %last_picture_flag, align 8, !tbaa !84
  %payloadSize = getelementptr inbounds [2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 %idxprom, i32 4
  store i32 0, ptr %payloadSize, align 16, !tbaa !85
  %call = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #20
  %data = getelementptr inbounds [2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 %idxprom, i32 5
  store ptr %call, ptr %data, align 8, !tbaa !86
  %cmp = icmp eq ptr %call, null
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  tail call void @no_mem_exit(ptr noundef nonnull @.str.5) #21
  %.pre = load ptr, ptr %data, align 8, !tbaa !86
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %1 = phi ptr [ %.pre, %if.then ], [ %call, %entry ]
  %call15 = tail call noalias dereferenceable_or_null(65496) ptr @malloc(i64 noundef 65496) #20
...
if.then25:                                        ; preds = %if.end
  tail call void @no_mem_exit(ptr noundef nonnull @.str.6) #21
  %.pre53 = load ptr, ptr %data, align 8, !tbaa !86
...
define dso_local void @UpdateSubseqInfo(i32 noundef %currLayer) local_unnamed_addr #14 {
entry:
  %0 = load ptr, ptr @img, align 8, !tbaa !25
...
if.then:                                          ; preds = %entry
  ...
  %2 = load i32, ptr %stored_frame_cnt, align 4, !tbaa !87
  %inc = add i32 %2, 1
  %rem = and i32 %inc, 255
  store i32 %rem, ptr %stored_frame_cnt, align 4, !tbaa !87
  br label %if.end
...
if.then10:                                        ; preds = %if.then8
  store i32 1, ptr getelementptr inbounds ([2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 0, i32 2), align 8, !tbaa !89
  br label %if.end48

if.else:                                          ; preds = %if.then8
  store i32 0, ptr getelementptr inbounds ([2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 0, i32 2), align 8, !tbaa !89
  br label %if.end48

if.then19:                                        ; preds = %if.end
  %6 = load i32, ptr %0, align 8, !tbaa !65
  %7 = load i32, ptr @start_frame_no_in_this_IGOP, align 4, !tbaa !84
...
if.then39:                                        ; preds = %land.lhs.true, %land.lhs.true36
  store i32 1, ptr getelementptr inbounds ([2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 1, i32 2), align 8, !tbaa !89
  br label %if.end48

if.else43:                                        ; preds = %land.lhs.true36, %lor.lhs.false
  store i32 0, ptr getelementptr inbounds ([2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 1, i32 2), align 8, !tbaa !89
  br label %if.end48
...
entry:
  ...
  %arrayidx = getelementptr inbounds [2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 %idxprom
  %data = getelementptr inbounds [2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 %idxprom, i32 5
  %0 = load ptr, ptr %data, align 8, !tbaa !86
  store i32 0, ptr %sym, align 8, !tbaa !71
  %mapping = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 7
  store ptr @ue_linfo, ptr %mapping, align 8, !tbaa !73
  ...
  %call6 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #21
  %last_picture_flag = getelementptr inbounds [2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 %idxprom, i32 2
  %3 = load i32, ptr %last_picture_flag, align 8, !tbaa !89
  ...
  %call9 = call i32 @writeSyntaxElement2Buf_Fixed(ptr noundef nonnull %sym, ptr noundef %0) #21
  %stored_frame_cnt = getelementptr inbounds [2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 %idxprom, i32 3
  %4 = load i32, ptr %stored_frame_cnt, align 4, !tbaa !87
  store i32 %4, ptr %value1, align 4, !tbaa !74
  %call13 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #21
...
if.end33:                                         ; preds = %if.then, %entry
  ...
  %payloadSize = getelementptr inbounds [2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 %idxprom, i32 4
  store i32 %11, ptr %payloadSize, align 16, !tbaa !85
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %sym) #21
  ret void
}
...
define dso_local void @ClearSubseqInfoPayload(i32 noundef %currLayer) local_unnamed_addr #15 {
entry:
  %idxprom = sext i32 %currLayer to i64
  %data = getelementptr inbounds [2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 %idxprom, i32 5
  %0 = load ptr, ptr %data, align 8, !tbaa !86
...
; Function Attrs: mustprogress nounwind willreturn uwtable
define dso_local void @CloseSubseqInfo(i32 noundef %currLayer) local_unnamed_addr #12 {
entry:
  %idxprom = sext i32 %currLayer to i64
  %stored_frame_cnt = getelementptr inbounds [2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 %idxprom, i32 3
  store <2 x i32> <i32 -1, i32 0>, ptr %stored_frame_cnt, align 4, !tbaa !84
  %data = getelementptr inbounds [2 x %struct.subseq_information_struct], ptr @seiSubseqInfo, i64 0, i64 %idxprom, i32 5
  %0 = load ptr, ptr %data, align 8, !tbaa !86
  %streamBuffer = getelementptr inbounds %struct.Bitstream, ptr %0, i64 0, i32 9
  %1 = load ptr, ptr %streamBuffer, align 8, !tbaa !18
  tail call void @free(ptr noundef %1) #21
  %2 = load ptr, ptr %data, align 8, !tbaa !86
  tail call void @free(ptr noundef %2) #21
  ret void
}

; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, argmem: none, inaccessiblemem: none) uwtable
define dso_local void @InitSubseqLayerInfo() local_unnamed_addr #16 {
entry:
  store i32 1, ptr @seiHasSubseqLayerInfo, align 4, !tbaa !24
  store i32 0, ptr @seiSubseqLayerInfo, align 4
  store i32 0, ptr getelementptr inbounds (%struct.subseq_layer_information_struct, ptr @seiSubseqLayerInfo, i64 0, i32 1, i64 0), align 4
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local void @CloseSubseqLayerInfo() local_unnamed_addr #13 {
entry:
  ret void
}
...
; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @ClearSubseqCharPayload() local_unnamed_addr #15 {
entry:
  %0 = load ptr, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 10), align 8, !tbaa !16
  %streamBuffer = getelementptr inbounds %struct.Bitstream, ptr %0, i64 0, i32 9
  %1 = load ptr, ptr %streamBuffer, align 8, !tbaa !18
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, argmem: read, inaccessiblemem: none) uwtable
define dso_local void @UpdateSubseqChar() local_unnamed_addr #14 {
entry:
  %0 = load ptr, ptr @img, align 8, !tbaa !25
  ...
  store i32 0, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 2), align 8, !tbaa !35
  store <4 x i32> <i32 0, i32 100, i32 30, i32 0>, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 4), align 8, !tbaa !84
  store i32 1, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 8), align 8, !tbaa !84
  store i32 2, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 9), align 4, !tbaa !84
  store i32 3, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 8, i64 1), align 4, !tbaa !84
  store i32 4, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 9, i64 1), align 8, !tbaa !84
...
entry:
  ...
  %len = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 3
  store i32 1, ptr %len, align 4, !tbaa !92
  %call3 = call i32 @writeSyntaxElement2Buf_Fixed(ptr noundef nonnull %sym, ptr noundef %0) #21
...
if.then:                                          ; preds = %entry
  ...
  %call6 = call i32 @writeSyntaxElement2Buf_Fixed(ptr noundef nonnull %sym, ptr noundef %0) #21
  br label %if.end
...
if.then11:                                        ; preds = %if.end
  ...
  %call14 = call i32 @writeSyntaxElement2Buf_Fixed(ptr noundef nonnull %sym, ptr noundef %0) #21
  ...
  store i32 16, ptr %len, align 4, !tbaa !92
  %call17 = call i32 @writeSyntaxElement2Buf_Fixed(ptr noundef nonnull %sym, ptr noundef %0) #21
  br label %if.end18
...
if.end18:                                         ; preds = %if.then11, %if.end
  ...
  %call20 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #21
...
for.body:                                         ; preds = %if.end18, %for.body
  ...
  %12 = load i32, ptr %arrayidx, align 4, !tbaa !84
  store i32 %12, ptr %value1, align 4, !tbaa !74
  %call22 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #21
  %arrayidx24 = getelementptr inbounds %struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 9, i64 %indvars.iv
  %13 = load i32, ptr %arrayidx24, align 4, !tbaa !84
  store i32 %13, ptr %value1, align 4, !tbaa !74
  %call26 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #21
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
; Function Attrs: mustprogress nounwind willreturn uwtable
define dso_local void @CloseSubseqChar() local_unnamed_addr #12 {
entry:
  %0 = load ptr, ptr getelementptr inbounds (%struct.subseq_char_information_struct, ptr @seiSubseqChar, i64 0, i32 10), align 8, !tbaa !16
...
; Function Attrs: mustprogress nounwind willreturn uwtable
define dso_local void @CloseSceneInformation() local_unnamed_addr #12 {
entry:
...
entry:
  ...
  %call = call i32 @writeSyntaxElement2Buf_Fixed(ptr noundef nonnull %sym, ptr noundef %0) #21
  ...
  %value1 = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 1
  store i32 %2, ptr %value1, align 4, !tbaa !74
  %call1 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #21
...
if.then:                                          ; preds = %entry
  ...
  store i32 8, ptr %len, align 4, !tbaa !92
  %call4 = call i32 @writeSyntaxElement2Buf_Fixed(ptr noundef nonnull %sym, ptr noundef %0) #21
  br label %if.end
...
define dso_local void @UpdateSceneInformation(i32 noundef %HasSceneInformation, i32 noundef %sceneID, i32 noundef %sceneTransType, i32 noundef %secondSceneID) local_unnamed_addr #17 {
entry:
...
; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @ClearPanScanRectInfoPayload() local_unnamed_addr #15 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(write, argmem: none, inaccessiblemem: none) uwtable
define dso_local void @UpdatePanScanRectInfo() local_unnamed_addr #17 {
entry:
  store <4 x i32> <i32 3, i32 10, i32 40, i32 20>, ptr @seiPanScanRectInfo, align 8, !tbaa !84
...
entry:
  ...
  %call4 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #21
  ...
  %call8 = call i32 @writeSyntaxElement2Buf_UVLC(ptr noundef nonnull %sym, ptr noundef %0) #21
  %bits_to_go = getelementptr inbounds %struct.Bitstream, ptr %0, i64 0, i32 1
...
; Function Attrs: mustprogress nounwind willreturn uwtable
define dso_local void @ClosePanScanRectInfo() local_unnamed_addr #12 {
entry:
  %0 = load ptr, ptr getelementptr inbounds (%struct.panscanrect_information_struct, ptr @seiPanScanRectInfo, i64 0, i32 5), align 8, !tbaa !47
  %tobool.not = icmp eq ptr %0, null
  br i1 %tobool.not, label %if.end, label %if.then
...
if.then:                                          ; preds = %entry
  tail call void @no_mem_exit(ptr noundef nonnull @.str.13) #21
...
if.then4:                                         ; preds = %if.end
  tail call void @no_mem_exit(ptr noundef nonnull @.str.14) #21
  br label %if.end5

if.end5:                                          ; preds = %if.then4, %if.end
  %call6 = tail call noalias dereferenceable_or_null(65496) ptr @malloc(i64 noundef 65496) #20
  store ptr %call6, ptr @seiUser_data_unregistered, align 8, !tbaa !60
  %cmp7 = icmp eq ptr %call6, null
  br i1 %cmp7, label %if.then8, label %if.end9

if.then8:                                         ; preds = %if.end5
  tail call void @no_mem_exit(ptr noundef nonnull @.str.15) #21
  br label %if.end9
...
; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @ClearUser_data_unregistered() local_unnamed_addr #15 {
entry:
...
define dso_local void @UpdateUser_data_unregistered() local_unnamed_addr #18 {
entry:
...
; Function Attrs: mustprogress nounwind willreturn uwtable
define dso_local void @CloseUser_data_unregistered() local_unnamed_addr #12 {
entry:
  %0 = load ptr, ptr getelementptr inbounds (%struct.user_data_unregistered_information_struct, ptr @seiUser_data_unregistered, i64 0, i32 2), align 8, !tbaa !58
  %tobool.not = icmp eq ptr %0, null
  br i1 %tobool.not, label %if.end, label %if.then
...
if.then:                                          ; preds = %entry
  tail call void @no_mem_exit(ptr noundef nonnull @.str.16) #21
...
if.end5.thread:                                   ; preds = %if.end
  %call610 = tail call noalias dereferenceable_or_null(65496) ptr @malloc(i64 noundef 65496) #20
  store ptr %call610, ptr @seiUser_data_registered_itu_t_t35, align 8, !tbaa !63
  br label %if.end9

if.end5:                                          ; preds = %if.end
  tail call void @no_mem_exit(ptr noundef nonnull @.str.17) #21
...
if.then8:                                         ; preds = %if.end5
  tail call void @no_mem_exit(ptr noundef nonnull @.str.18) #21
...
; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @ClearUser_data_registered_itu_t_t35() local_unnamed_addr #15 {
entry:
...
; Function Attrs: nofree nosync nounwind memory(readwrite, argmem: write, inaccessiblemem: none) uwtable
define dso_local void @UpdateUser_data_registered_itu_t_t35() local_unnamed_addr #18 {
entry:
...
for.body:                                         ; preds = %if.end, %for.body
  ...
  store i32 %conv, ptr %bitpattern, align 4, !tbaa !91
  store i32 8, ptr %len, align 4, !tbaa !92
  %call7 = call i32 @writeSyntaxElement2Buf_Fixed(ptr noundef nonnull %sym, ptr noundef %0) #21
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
; Function Attrs: mustprogress nounwind willreturn uwtable
define dso_local void @CloseUser_data_registered_itu_t_t35() local_unnamed_addr #12 {
entry:
  %0 = load ptr, ptr getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, ptr @seiUser_data_registered_itu_t_t35, i64 0, i32 4), align 8, !tbaa !61
  %tobool.not = icmp eq ptr %0, null
  br i1 %tobool.not, label %if.end, label %if.then
...
; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @ClearRandomAccess() local_unnamed_addr #15 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, argmem: read, inaccessiblemem: none) uwtable
define dso_local void @UpdateRandomAccess() local_unnamed_addr #14 {
entry:
  %0 = load ptr, ptr @img, align 8, !tbaa !25
  %type = getelementptr inbounds %struct.ImageParameters, ptr %0, i64 0, i32 5
  %1 = load i32, ptr %type, align 4, !tbaa !64
...
entry:
  ...
  %call = tail call i32 @ue_v(ptr noundef nonnull @.str.21, i32 noundef %1, ptr noundef %0) #21
  ...
  %call1 = tail call i32 @u_1(ptr noundef nonnull @.str.22, i32 noundef %conv, ptr noundef %0) #21
  ...
  %call3 = tail call i32 @u_1(ptr noundef nonnull @.str.23, i32 noundef %conv2, ptr noundef %0) #21
  ...
  %call5 = tail call i32 @u_v(i32 noundef 2, ptr noundef nonnull @.str.24, i32 noundef %conv4, ptr noundef %0) #21
  %bits_to_go = getelementptr inbounds %struct.Bitstream, ptr %0, i64 0, i32 1
  %5 = load i32, ptr %bits_to_go, align 4, !tbaa !20
  %cmp.not = icmp eq i32 %5, 8
...
; Function Attrs: mustprogress nounwind willreturn uwtable
define dso_local void @CloseRandomAccess() local_unnamed_addr #12 {
entry:
  %0 = load ptr, ptr getelementptr inbounds (%struct.recovery_point_information_struct, ptr @seiRecoveryPoint, i64 0, i32 4), align 8, !tbaa !50
  %tobool.not = icmp eq ptr %0, null
  br i1 %tobool.not, label %if.end, label %if.then
...
attributes #9 = { mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, argmem: write, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #14 = { mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, argmem: read, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #15 = { mustprogress nofree nosync nounwind willreturn memory(readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #18 = { nofree nosync nounwind memory(readwrite, argmem: write, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
