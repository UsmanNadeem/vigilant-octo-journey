; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Compress/DeflateEncoder.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Compress/DeflateEncoder.cpp"
...
if.end:                                           ; preds = %sw.bb
  ...
  %spec.select = select i1 %cmp6, i32 1, i32 %4
  store i32 %spec.select, ptr %m_NumDivPasses, align 8, !tbaa !30
  %cmp11 = icmp eq i32 %spec.select, 1
...
vector.ph:                                        ; preds = %for.body.preheader
  ...
  %11 = getelementptr i16, ptr %6, i64 -1
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %offset.idx = shl i64 %index, 1
  %12 = getelementptr inbounds [519 x i32], ptr %distanceTmp, i64 0, i64 %offset.idx
  %wide.vec = load <8 x i32>, ptr %12, align 16, !tbaa !53
  %strided.vec = shufflevector <8 x i32> %wide.vec, <8 x i32> poison, <4 x i32> <i32 0, i32 2, i32 4, i32 6>
  %strided.vec118 = shufflevector <8 x i32> %wide.vec, <8 x i32> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %13 = trunc <4 x i32> %strided.vec to <4 x i16>
  %14 = trunc <4 x i32> %strided.vec118 to <4 x i16>
  %15 = or i64 %offset.idx, 2
  %16 = getelementptr i16, ptr %11, i64 %15
  %interleaved.vec = shufflevector <4 x i16> %13, <4 x i16> %14, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x i16> %interleaved.vec, ptr %16, align 2, !tbaa !61
...
for.body:                                         ; preds = %for.body.preheader120, %for.body
  ...
  %18 = load i32, ptr %arrayidx, align 8, !tbaa !53
  %conv16 = trunc i32 %18 to i16
  %19 = or i64 %indvars.iv, 1
  %arrayidx20 = getelementptr inbounds i16, ptr %6, i64 %19
  store i16 %conv16, ptr %arrayidx20, align 2, !tbaa !61
  %arrayidx23 = getelementptr inbounds [519 x i32], ptr %distanceTmp, i64 0, i64 %19
  %20 = load i32, ptr %arrayidx23, align 4, !tbaa !53
...
for.end:                                          ; preds = %for.body, %middle.block
  ...
  %21 = load i32, ptr %arrayidx31, align 4, !tbaa !53
  %m_NumFastBytes = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 5
  %22 = load i32, ptr %m_NumFastBytes, align 8, !tbaa !18
  %cmp32 = icmp eq i32 %21, %22
  br i1 %cmp32, label %land.lhs.true, label %if.end71

land.lhs.true:                                    ; preds = %for.end
  %m_MatchMaxLen = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 19
  %23 = load i32, ptr %m_MatchMaxLen, align 8, !tbaa !35
...
if.then35:                                        ; preds = %land.lhs.true
  ...
  %24 = load i32, ptr %streamPos, align 8, !tbaa !66
  %pos = getelementptr inbounds %struct._CMatchFinder, ptr %this, i64 0, i32 1
  %25 = load i32, ptr %pos, align 8, !tbaa !67
  %sub38 = add i32 %24, 1
  %add39 = sub i32 %sub38, %25
  %26 = load ptr, ptr %this, align 8, !tbaa !68
  %add.ptr41 = getelementptr inbounds i8, ptr %26, i64 -1
  ...
  %27 = load i32, ptr %arrayidx44, align 4, !tbaa !53
  %add45 = add i32 %27, 1
  ...
  %spec.select = call i32 @llvm.umin.i32(i32 %add39, i32 %23)
  %cmp54106 = icmp ult i32 %21, %spec.select
...
land.rhs:                                         ; preds = %land.rhs.preheader, %for.inc63
  %indvars.iv112 = phi i64 [ %28, %land.rhs.preheader ], [ %indvars.iv.next113, %for.inc63 ]
  %arrayidx56 = getelementptr inbounds i8, ptr %add.ptr41, i64 %indvars.iv112
  %29 = load i8, ptr %arrayidx56, align 1, !tbaa !5
  %arrayidx59 = getelementptr inbounds i8, ptr %add.ptr47, i64 %indvars.iv112
  %30 = load i8, ptr %arrayidx59, align 1, !tbaa !5
  %cmp61 = icmp eq i8 %29, %30
...
for.end64.loopexit.split.loop.exit115:            ; preds = %land.rhs
  %31 = trunc i64 %indvars.iv112 to i32
  br label %for.end64

for.end64:                                        ; preds = %for.inc63, %for.end64.loopexit.split.loop.exit115, %if.then35
  %len.0.lcssa = phi i32 [ %21, %if.then35 ], [ %31, %for.end64.loopexit.split.loop.exit115 ], [ %spec.select, %for.inc63 ]
...
if.end71:                                         ; preds = %for.end, %land.lhs.true, %for.end64, %cond.end
  %32 = load i8, ptr %m_IsMultiPass, align 1, !tbaa !44, !range !45, !noundef !46
...
if.then74:                                        ; preds = %if.end71
  ...
  %33 = load i32, ptr %m_Pos76, align 8, !tbaa !59
  %add77 = add i32 %add75, %33
...
if.end78:                                         ; preds = %if.then74, %if.end71
  ...
  %34 = load i8, ptr %m_SecondPass79, align 8, !tbaa !60, !range !45, !noundef !46
...
if.then81:                                        ; preds = %if.end78
  ...
  %35 = load i32, ptr %m_AdditionalOffset, align 4, !tbaa !70
  %inc82 = add i32 %35, 1
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable
define dso_local noundef i32 @_ZN9NCompress8NDeflate8NEncoder6CCoder8BackwardERjj(ptr nocapture noundef nonnull align 8 dereferenceable(39764) %this, ptr nocapture noundef nonnull writeonly align 4 dereferenceable(4) %backRes, i32 noundef %cur) local_unnamed_addr #7 align 2 {
entry:
  ...
  %0 = load <2 x i16>, ptr %PosPrev, align 4, !tbaa !61
  %1 = trunc i32 %cur to i16
  br label %do.body

do.body:                                          ; preds = %do.body, %entry
  %cur.addr.0 = phi i16 [ %1, %entry ], [ %3, %do.body ]
  %2 = phi <2 x i16> [ %0, %entry ], [ %4, %do.body ]
  ...
  %4 = load <2 x i16>, ptr %PosPrev12, align 4, !tbaa !61
  %5 = extractelement <2 x i16> %2, i64 1
  store i16 %5, ptr %BackPrev8, align 2, !tbaa !72
  store i16 %cur.addr.0, ptr %PosPrev12, align 4, !tbaa !74
...
do.end:                                           ; preds = %do.body
  ...
  %6 = load i16, ptr %BackPrev25, align 2, !tbaa !72
  ...
  %7 = load i16, ptr %PosPrev29, align 4, !tbaa !74
...
if.then:                                          ; preds = %entry
  ...
  %5 = load i16, ptr %PosPrev13, align 4, !tbaa !74
...
if.end35:                                         ; preds = %if.end22
  ...
  store i16 0, ptr %PosPrev46, align 4, !tbaa !74
  ...
  store i16 1, ptr %PosPrev52, align 4, !tbaa !74
...
for.cond85.preheader:                             ; preds = %_ZN9NCompress8NDeflate8NEncoder10GetPosSlotEj.exit, %if.end35
  %m_Pos = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 11
  %cmp87406 = icmp eq i16 %8, 1
  %19 = load i32, ptr %m_Pos, align 8
  %cmp90407 = icmp ugt i32 %19, 653285
  %or.cond313408 = select i1 %cmp87406, i1 true, i1 %cmp90407
  br i1 %or.cond313408, label %if.then91, label %if.end93
...
if.then91.loopexit:                               ; preds = %cleanup231
  %29 = trunc i64 %indvars.iv.next426 to i32
  br label %if.then91
...
if.then91:                                        ; preds = %if.then91.loopexit, %for.cond85.preheader
  ...
  %30 = load <2 x i16>, ptr %PosPrev.i, align 4, !tbaa !61
  %31 = trunc i32 %inc86.lcssa to i16
  br label %do.body.i

do.body.i:                                        ; preds = %do.body.i, %if.then91
  %cur.addr.0.i = phi i16 [ %31, %if.then91 ], [ %33, %do.body.i ]
  %32 = phi <2 x i16> [ %30, %if.then91 ], [ %34, %do.body.i ]
  %33 = extractelement <2 x i16> %32, i64 0
  %idxprom6.i = zext i16 %33 to i64
  ...
  %34 = load <2 x i16>, ptr %PosPrev12.i, align 4, !tbaa !61
  %35 = extractelement <2 x i16> %32, i64 1
  store i16 %35, ptr %BackPrev8.i, align 2, !tbaa !72
  store i16 %cur.addr.0.i, ptr %PosPrev12.i, align 4, !tbaa !74
...
_ZN9NCompress8NDeflate8NEncoder6CCoder8BackwardERjj.exit: ; preds = %do.body.i
  ...
  %36 = load i16, ptr %BackPrev25.i, align 2, !tbaa !72
  ...
  %37 = load i16, ptr %PosPrev29.i, align 4, !tbaa !74
...
if.end93:                                         ; preds = %for.cond85.preheader, %cleanup231
  %indvars.iv427 = phi i64 [ %indvars.iv.next428, %cleanup231 ], [ 0, %for.cond85.preheader ]
  %indvars.iv425 = phi i64 [ %indvars.iv.next426, %cleanup231 ], [ 1, %for.cond85.preheader ]
  %lenEnd.0409 = phi i32 [ %lenEnd.3, %cleanup231 ], [ %conv27, %for.cond85.preheader ]
  %indvars.iv.next428 = add nuw nsw i64 %indvars.iv427, 1
  %indvars431 = trunc i64 %indvars.iv.next428 to i32
  tail call void @_ZN9NCompress8NDeflate8NEncoder6CCoder10GetMatchesEv(ptr noundef nonnull align 8 dereferenceable(39764) %this)
  %38 = load ptr, ptr %m_MatchDistances, align 8, !tbaa !49
  %add.ptr95 = getelementptr inbounds i16, ptr %38, i64 1
  %39 = load i16, ptr %38, align 2, !tbaa !61
  %conv99 = zext i16 %39 to i32
  %cmp100.not = icmp eq i16 %39, 0
...
if.then101:                                       ; preds = %if.end93
  ...
  %40 = load i16, ptr %arrayidx104, align 2, !tbaa !61
  %conv105 = zext i16 %40 to i32
  %41 = load i32, ptr %m_NumFastBytes, align 8, !tbaa !18
  %cmp107 = icmp ult i32 %41, %conv105
  br i1 %cmp107, label %if.then108, label %if.end128

if.then108:                                       ; preds = %if.then101
  %conv105.le = zext i16 %40 to i32
  %42 = trunc i64 %indvars.iv425 to i32
  %conv99.le = zext i16 %39 to i64
  %idxprom.i320 = and i64 %indvars.iv425, 4294967295
  ...
  %43 = load i16, ptr %PosPrev.i321, align 4, !tbaa !74
  ...
  %44 = load i16, ptr %BackPrev.i322, align 2, !tbaa !72
  %45 = trunc i64 %indvars.iv425 to i16
  br label %do.body.i330

do.body.i330:                                     ; preds = %do.body.i330, %if.then108
  %backMem.0.i323 = phi i16 [ %44, %if.then108 ], [ %46, %do.body.i330 ]
  %posMem.0.in.i324 = phi i16 [ %43, %if.then108 ], [ %47, %do.body.i330 ]
  %cur.addr.0.i325 = phi i16 [ %45, %if.then108 ], [ %posMem.0.in.i324, %do.body.i330 ]
  ...
  %46 = load i16, ptr %BackPrev8.i327, align 2, !tbaa !72
  ...
  %47 = load i16, ptr %PosPrev12.i328, align 4, !tbaa !74
  store i16 %backMem.0.i323, ptr %BackPrev8.i327, align 2, !tbaa !72
  store i16 %cur.addr.0.i325, ptr %PosPrev12.i328, align 4, !tbaa !74
...
_ZN9NCompress8NDeflate8NEncoder6CCoder8BackwardERjj.exit336: ; preds = %do.body.i330
  ...
  %48 = load i16, ptr %BackPrev25.i331, align 2, !tbaa !72
  %conv26.i332 = zext i16 %48 to i32
  ...
  %49 = load i16, ptr %PosPrev29.i333, align 4, !tbaa !74
  %conv30.i334 = zext i16 %49 to i32
  store i32 %conv30.i334, ptr %m_OptimumCurrentIndex, align 4, !tbaa !76
  %sub111 = add nuw nsw i64 %conv99.le, 4294967295
  %idxprom112 = and i64 %sub111, 4294967295
  %arrayidx113 = getelementptr inbounds i16, ptr %add.ptr95, i64 %idxprom112
  %50 = load i16, ptr %arrayidx113, align 2, !tbaa !61
  store i16 %50, ptr %BackPrev.i322, align 2, !tbaa !72
  %add118 = add i32 %42, %conv105.le
  store i32 %add118, ptr %m_OptimumEndIndex, align 8, !tbaa !71
  %conv121 = trunc i32 %add118 to i16
  store i16 %conv121, ptr %PosPrev.i321, align 4, !tbaa !74
  %sub126 = add nsw i32 %conv105.le, -1
  %m_SecondPass.i337 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 31
  %51 = load i8, ptr %m_SecondPass.i337, align 8, !tbaa !60, !range !45, !noundef !46
  %tobool.not9.i338 = icmp eq i8 %51, 0
...
if.then.i343:                                     ; preds = %_ZN9NCompress8NDeflate8NEncoder6CCoder8BackwardERjj.exit336
  ...
  %52 = load i8, ptr %_btMode.i341, align 1, !tbaa !28, !range !45, !noundef !46
  %tobool2.not.i342 = icmp eq i8 %52, 0
...
if.end.i348:                                      ; preds = %if.else.i345, %if.then3.i344
  %53 = load i32, ptr %m_AdditionalOffset, align 4, !tbaa !70
  %add.i347 = add i32 %53, %sub126
...
if.end128:                                        ; preds = %if.then101, %if.end93
  ...
  %arrayidx131 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 50, i64 %indvars.iv425
  %54 = load i32, ptr %arrayidx131, align 8, !tbaa !77
  %55 = load ptr, ptr %this, align 8, !tbaa !68
  %56 = load i32, ptr %m_AdditionalOffset, align 4, !tbaa !70
  %57 = trunc i64 %indvars.iv425 to i32
  %sub137 = sub i32 %57, %56
  %idxprom138 = sext i32 %sub137 to i64
  %arrayidx139 = getelementptr inbounds i8, ptr %55, i64 %idxprom138
  %58 = load i8, ptr %arrayidx139, align 1, !tbaa !5
  %idxprom140 = zext i8 %58 to i64
  %arrayidx141 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 36, i64 %idxprom140
  %59 = load i8, ptr %arrayidx141, align 1, !tbaa !5
  %conv142 = zext i8 %59 to i32
  %add143 = add i32 %54, %conv142
  %60 = add nuw nsw i64 %indvars.iv427, 2
  %arrayidx147 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 50, i64 %60
  %61 = load i32, ptr %arrayidx147, align 8, !tbaa !77
  %cmp149 = icmp ult i32 %add143, %61
  br i1 %cmp149, label %if.then150, label %if.end154

if.then150:                                       ; preds = %if.end128
  store i32 %add143, ptr %arrayidx147, align 8, !tbaa !77
  %conv152 = trunc i64 %indvars.iv.next428 to i16
  %PosPrev153 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 50, i64 %60, i32 1
  store i16 %conv152, ptr %PosPrev153, align 4, !tbaa !74
  br label %if.end154
...
while.cond.preheader:                             ; preds = %if.end154
  %add158 = add i32 %newLen.0, %indvars431
  %cmp159403 = icmp ult i32 %lenEnd.0409, %add158
  br i1 %cmp159403, label %while.body.preheader, label %while.end

while.body.preheader:                             ; preds = %while.cond.preheader
  %62 = zext i32 %lenEnd.0409 to i64
  %63 = add i32 %newLen.0, %57
  %wide.trip.count423 = zext i32 %63 to i64
  %64 = sub nsw i64 %wide.trip.count423, %62
  %65 = xor i64 %62, -1
  %66 = add nsw i64 %65, %wide.trip.count423
  %xtraiter = and i64 %64, 7
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %while.body.prol.loopexit, label %while.body.prol

while.body.prol:                                  ; preds = %while.body.preheader, %while.body.prol
  %indvars.iv420.prol = phi i64 [ %indvars.iv.next421.prol, %while.body.prol ], [ %62, %while.body.preheader ]
  %prol.iter = phi i64 [ %prol.iter.next, %while.body.prol ], [ 0, %while.body.preheader ]
  %indvars.iv.next421.prol = add nuw nsw i64 %indvars.iv420.prol, 1
  %arrayidx163.prol = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 50, i64 %indvars.iv.next421.prol
...
while.body.prol.loopexit:                         ; preds = %while.body.prol, %while.body.preheader
  %indvars.iv420.unr = phi i64 [ %62, %while.body.preheader ], [ %indvars.iv.next421.prol, %while.body.prol ]
  %67 = icmp ult i64 %66, 7
  br i1 %67, label %while.end, label %while.body

while.body:                                       ; preds = %while.body.prol.loopexit, %while.body
  %indvars.iv420 = phi i64 [ %indvars.iv.next421.7, %while.body ], [ %indvars.iv420.unr, %while.body.prol.loopexit ]
  %indvars.iv.next421 = add nuw nsw i64 %indvars.iv420, 1
  %arrayidx163 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 50, i64 %indvars.iv.next421
  store i32 268435455, ptr %arrayidx163, align 8, !tbaa !77
  %indvars.iv.next421.1 = add nuw nsw i64 %indvars.iv420, 2
  %arrayidx163.1 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 50, i64 %indvars.iv.next421.1
  store i32 268435455, ptr %arrayidx163.1, align 8, !tbaa !77
  %indvars.iv.next421.2 = add nuw nsw i64 %indvars.iv420, 3
  %arrayidx163.2 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 50, i64 %indvars.iv.next421.2
  store i32 268435455, ptr %arrayidx163.2, align 8, !tbaa !77
  %indvars.iv.next421.3 = add nuw nsw i64 %indvars.iv420, 4
  %arrayidx163.3 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 50, i64 %indvars.iv.next421.3
  store i32 268435455, ptr %arrayidx163.3, align 8, !tbaa !77
  %indvars.iv.next421.4 = add nuw nsw i64 %indvars.iv420, 5
  %arrayidx163.4 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 50, i64 %indvars.iv.next421.4
  store i32 268435455, ptr %arrayidx163.4, align 8, !tbaa !77
  %indvars.iv.next421.5 = add nuw nsw i64 %indvars.iv420, 6
  %arrayidx163.5 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 50, i64 %indvars.iv.next421.5
  store i32 268435455, ptr %arrayidx163.5, align 8, !tbaa !77
  %indvars.iv.next421.6 = add nuw nsw i64 %indvars.iv420, 7
  %arrayidx163.6 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 50, i64 %indvars.iv.next421.6
  store i32 268435455, ptr %arrayidx163.6, align 8, !tbaa !77
  %indvars.iv.next421.7 = add nuw nsw i64 %indvars.iv420, 8
  %arrayidx163.7 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 50, i64 %indvars.iv.next421.7
  store i32 268435455, ptr %arrayidx163.7, align 8, !tbaa !77
  %exitcond424.not.7 = icmp eq i64 %indvars.iv.next421.7, %wide.trip.count423
  br i1 %exitcond424.not.7, label %while.end, label %while.body, !llvm.loop !82

while.end:                                        ; preds = %while.body.prol.loopexit, %while.body, %while.cond.preheader
  %lenEnd.1.lcssa = phi i32 [ %lenEnd.0409, %while.cond.preheader ], [ %63, %while.body ], [ %63, %while.body.prol.loopexit ]
  %arrayidx168 = getelementptr inbounds i16, ptr %38, i64 2
  %68 = load i16, ptr %arrayidx168, align 2, !tbaa !61
  %conv169 = zext i16 %68 to i32
  %cmp.i350 = icmp ult i16 %68, 512
  br i1 %cmp.i350, label %if.then.i354, label %if.end.i360

if.then.i354:                                     ; preds = %while.end
  %idxprom.i351 = zext i16 %68 to i64
  %arrayidx.i352 = getelementptr inbounds [512 x i8], ptr @_ZN9NCompress8NDeflate8NEncoderL9g_FastPosE, i64 0, i64 %idxprom.i351
  %69 = load i8, ptr %arrayidx.i352, align 1, !tbaa !5
  %conv.i353 = zext i8 %69 to i64
...
if.end.i360:                                      ; preds = %while.end
  ...
  %70 = load i8, ptr %arrayidx2.i357, align 1, !tbaa !5
  %conv3.i358 = zext i8 %70 to i64
...
_ZN9NCompress8NDeflate8NEncoder10GetPosSlotEj.exit362: ; preds = %if.then.i354, %if.end.i360
  ...
  %71 = load i8, ptr %arrayidx173, align 1, !tbaa !5
  %conv174 = zext i8 %71 to i32
  %add175 = add i32 %54, %conv174
  %conv192 = trunc i64 %indvars.iv.next428 to i16
...
for.cond176:                                      ; preds = %for.inc224, %_ZN9NCompress8NDeflate8NEncoder10GetPosSlotEj.exit362
  ...
  %72 = load i8, ptr %arrayidx180, align 1, !tbaa !5
  %conv181 = zext i8 %72 to i32
  %add182 = add i32 %curPrice.0, %conv181
  %add185 = add i32 %lenTest.0, %57
  ...
  %73 = load i32, ptr %arrayidx187, align 8, !tbaa !77
  %cmp189 = icmp ult i32 %add182, %73
...
if.then190:                                       ; preds = %for.cond176
  ...
  store i16 %conv192, ptr %PosPrev193, align 4, !tbaa !74
  ...
  store i16 %conv194, ptr %BackPrev195, align 2, !tbaa !72
  br label %if.end196
...
if.end196:                                        ; preds = %if.then190, %for.cond176
  ...
  %74 = load i16, ptr %arrayidx198, align 2, !tbaa !61
  %conv199 = zext i16 %74 to i32
...
if.then.i367:                                     ; preds = %if.end205
  ...
  %75 = load i8, ptr %arrayidx.i365, align 1, !tbaa !5
  %conv.i366 = zext i8 %75 to i64
...
if.end.i373:                                      ; preds = %if.end205
  ...
  %76 = load i8, ptr %arrayidx2.i370, align 1, !tbaa !5
  %conv3.i371 = zext i8 %76 to i64
...
_ZN9NCompress8NDeflate8NEncoder10GetPosSlotEj.exit375: ; preds = %if.then.i367, %if.end.i373
  ...
  %77 = load i8, ptr %arrayidx209, align 1, !tbaa !5
  ...
  %78 = load i16, ptr %arrayidx214, align 2, !tbaa !61
  %conv215 = zext i16 %78 to i32
  %cmp.i376 = icmp ult i16 %78, 512
...
if.end.i386:                                      ; preds = %_ZN9NCompress8NDeflate8NEncoder10GetPosSlotEj.exit375
  ...
  %80 = load i8, ptr %arrayidx2.i383, align 1, !tbaa !5
  %conv3.i384 = zext i8 %80 to i64
...
_ZN9NCompress8NDeflate8NEncoder10GetPosSlotEj.exit388: ; preds = %if.then.i380, %if.end.i386
  ...
  %81 = load i8, ptr %arrayidx219, align 1, !tbaa !5
  %conv220 = zext i8 %81 to i32
...
cleanup231:                                       ; preds = %if.then201, %if.end154
  %lenEnd.3 = phi i32 [ %lenEnd.0409, %if.end154 ], [ %lenEnd.1.lcssa, %if.then201 ]
  %indvars.iv.next426 = add nuw nsw i64 %indvars.iv425, 1
  %82 = zext i32 %lenEnd.3 to i64
  %cmp87 = icmp eq i64 %indvars.iv.next426, %82
  %cmp88 = icmp eq i64 %indvars.iv.next426, 4096
  %or.cond = or i1 %cmp87, %cmp88
  %83 = load i32, ptr %m_Pos, align 8
  %cmp90 = icmp ugt i32 %83, 653285
...
define dso_local void @_ZN9NCompress8NDeflate8NEncoder7CTables14InitStructuresEv(ptr nocapture noundef nonnull writeonly align 4 dereferenceable(332) %this) local_unnamed_addr #9 align 2 {
for.cond15.preheader:
  ...
  %uglygep = getelementptr i8, ptr %this, i64 257
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(63) %uglygep, i8 5, i64 63, i1 false)
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable
define dso_local void @_ZN9NCompress8NDeflate8NEncoder6CCoder15LevelTableDummyEPKhiPj(ptr nocapture noundef nonnull readnone align 8 dereferenceable(39764) %this, ptr nocapture noundef readonly %levels, i32 noundef %numLevels, ptr nocapture noundef %freqs) local_unnamed_addr #7 align 2 {
entry:
...
define dso_local noundef i32 @_ZN9NCompress8NDeflate8NEncoder16Huffman_GetPriceEPKjPKhj(ptr nocapture noundef readonly %freqs, ptr nocapture noundef readonly %lens, i32 noundef %num) local_unnamed_addr #10 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local noundef i32 @_ZN9NCompress8NDeflate8NEncoder21Huffman_GetPrice_SpecEPKjPKhjS5_j(ptr nocapture noundef readonly %freqs, ptr nocapture noundef readonly %lens, i32 noundef %num, ptr nocapture noundef readonly %extraBits, i32 noundef %extraBase) local_unnamed_addr #10 {
entry:
...
define dso_local noundef i32 @_ZNK9NCompress8NDeflate8NEncoder6CCoder15GetLzBlockPriceEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(39764) %this) local_unnamed_addr #11 align 2 {
entry:
  %mainFreqs = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 40
  %m_NewLevels = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39
  %m_LenDirectBits = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 22
...
middle.block:                                     ; preds = %vector.body
  ...
  %45 = shufflevector <4 x i32> %44, <4 x i32> poison, <8 x i32> <i32 3, i32 2, i32 1, i32 0, i32 undef, i32 undef, i32 undef, i32 undef>
  %46 = shufflevector <4 x i32> %43, <4 x i32> poison, <8 x i32> <i32 3, i32 2, i32 1, i32 0, i32 undef, i32 undef, i32 undef, i32 undef>
  %47 = shufflevector <8 x i32> %45, <8 x i32> %46, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
  %48 = mul <8 x i32> %47, <i32 10, i32 10, i32 9, i32 9, i32 7, i32 7, i32 6, i32 6>
  %49 = load <8 x i32>, ptr %arrayidx2.i.i11.24, align 8, !tbaa !53
  %50 = mul <8 x i32> %49, <i32 11, i32 11, i32 12, i32 12, i32 13, i32 13, i32 14, i32 14>
  %51 = load <32 x i8>, ptr %distLevels, align 8, !tbaa !5
  %52 = load <32 x i32>, ptr %distFreqs, align 8, !tbaa !53
  %53 = zext <32 x i8> %51 to <32 x i32>
  %54 = mul <32 x i32> %52, %53
  %55 = tail call i32 @llvm.vector.reduce.add.v32i32(<32 x i32> %54)
  %56 = tail call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> %30)
  %57 = tail call i32 @llvm.vector.reduce.add.v8i32(<8 x i32> %16)
  %58 = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %20)
  %59 = tail call i32 @llvm.vector.reduce.add.v8i32(<8 x i32> %50)
  %60 = tail call i32 @llvm.vector.reduce.add.v8i32(<8 x i32> %48)
  %op.rdx68 = add i32 %59, %60
  %op.rdx69 = add i32 %op.rdx68, %mul.i13.i.30
  %op.rdx70 = add i32 %mul.i13.i.29, %mul.i13.i.28
  %mul.i13.i23.1389 = add i32 %40, %39
  %op.rdx71 = mul i32 %mul.i13.i23.1389, 5
  %mul.i13.i23.990 = add i32 %36, %35
  %op.rdx72 = mul i32 %mul.i13.i23.990, 3
  %mul.i13.i23.1991 = add i32 %42, %41
  %op.rdx73 = shl i32 %mul.i13.i23.1991, 3
  %mul.i13.i23.1192 = add i32 %38, %37
  %op.rdx74 = shl i32 %mul.i13.i23.1192, 2
  %mul.i13.i23.793 = add i32 %34, %33
  %op.rdx75 = shl i32 %mul.i13.i23.793, 1
  %op.rdx76 = add i32 %32, %31
  %op.rdx77 = add i32 %12, %58
  %op.rdx78 = add i32 %57, %55
  %op.rdx79 = add i32 %op.rdx69, %op.rdx70
  %op.rdx80 = add i32 %op.rdx71, %op.rdx72
  %op.rdx81 = add i32 %op.rdx73, %op.rdx74
  %op.rdx82 = add i32 %op.rdx75, %op.rdx76
  %op.rdx83 = add i32 %op.rdx77, %op.rdx78
  %op.rdx84 = add i32 %op.rdx79, %op.rdx80
  %op.rdx85 = add i32 %op.rdx81, %op.rdx82
  %op.rdx86 = add i32 %op.rdx83, %56
  %op.rdx87 = add i32 %op.rdx84, %op.rdx85
  %op.rdx88 = add i32 %op.rdx87, %op.rdx86
  ret i32 %op.rdx88
}
...
define dso_local void @_ZN9NCompress8NDeflate8NEncoder6CCoder9SetPricesERKNS0_7CLevelsE(ptr nocapture noundef nonnull align 8 dereferenceable(39764) %this, ptr nocapture noundef nonnull readonly align 1 dereferenceable(320) %levels) local_unnamed_addr #13 align 2 {
entry:
  %_fastMode = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 6
...
vector.memcheck:                                  ; preds = %entry
  %this113 = ptrtoint ptr %this to i64
  %levels114 = ptrtoint ptr %levels to i64
  %1 = add i64 %this113, 1392
  %2 = sub i64 %1, %levels114
...
vector.body:                                      ; preds = %vector.memcheck
  ...
  %wide.load115 = load <16 x i8>, ptr %3, align 1, !tbaa !5
  %4 = icmp eq <16 x i8> %wide.load, zeroinitializer
  %5 = icmp eq <16 x i8> %wide.load115, zeroinitializer
  ...
  %7 = select <16 x i1> %5, <16 x i8> <i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11>, <16 x i8> %wide.load115
  ...
  %wide.load115.1 = load <16 x i8>, ptr %11, align 1, !tbaa !5
  %12 = icmp eq <16 x i8> %wide.load.1, zeroinitializer
  %13 = icmp eq <16 x i8> %wide.load115.1, zeroinitializer
  ...
  %15 = select <16 x i1> %13, <16 x i8> <i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11>, <16 x i8> %wide.load115.1
  ...
  %wide.load115.2 = load <16 x i8>, ptr %19, align 1, !tbaa !5
  %20 = icmp eq <16 x i8> %wide.load.2, zeroinitializer
  %21 = icmp eq <16 x i8> %wide.load115.2, zeroinitializer
  ...
  %23 = select <16 x i1> %21, <16 x i8> <i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11>, <16 x i8> %wide.load115.2
  ...
  %wide.load115.3 = load <16 x i8>, ptr %27, align 1, !tbaa !5
  %28 = icmp eq <16 x i8> %wide.load.3, zeroinitializer
  %29 = icmp eq <16 x i8> %wide.load115.3, zeroinitializer
  ...
  %31 = select <16 x i1> %29, <16 x i8> <i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11>, <16 x i8> %wide.load115.3
  ...
  %wide.load115.4 = load <16 x i8>, ptr %35, align 1, !tbaa !5
  %36 = icmp eq <16 x i8> %wide.load.4, zeroinitializer
  %37 = icmp eq <16 x i8> %wide.load115.4, zeroinitializer
  ...
  %39 = select <16 x i1> %37, <16 x i8> <i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11>, <16 x i8> %wide.load115.4
  ...
  %wide.load115.5 = load <16 x i8>, ptr %43, align 1, !tbaa !5
  %44 = icmp eq <16 x i8> %wide.load.5, zeroinitializer
  %45 = icmp eq <16 x i8> %wide.load115.5, zeroinitializer
  ...
  %47 = select <16 x i1> %45, <16 x i8> <i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11>, <16 x i8> %wide.load115.5
  ...
  %wide.load115.6 = load <16 x i8>, ptr %51, align 1, !tbaa !5
  %52 = icmp eq <16 x i8> %wide.load.6, zeroinitializer
  %53 = icmp eq <16 x i8> %wide.load115.6, zeroinitializer
  ...
  %55 = select <16 x i1> %53, <16 x i8> <i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11>, <16 x i8> %wide.load115.6
  ...
  %wide.load115.7 = load <16 x i8>, ptr %59, align 1, !tbaa !5
  %60 = icmp eq <16 x i8> %wide.load.7, zeroinitializer
  %61 = icmp eq <16 x i8> %wide.load115.7, zeroinitializer
  ...
  %63 = select <16 x i1> %61, <16 x i8> <i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11, i8 11>, <16 x i8> %wide.load115.7
...
for.cond32.preheader:                             ; preds = %for.body7.epil, %for.cond32.preheader.loopexit.unr-lcssa, %for.cond5.preheader
  ...
  %.op = add i8 %80, 1
  %add48.4 = select i1 %cmp39.not.4, i8 7, i8 %.op
  ...
  %81 = load i8, ptr %arrayidx37.5, align 1, !tbaa !5
  %cmp39.not.5 = icmp eq i8 %81, 0
  %.op86 = add i8 %81, 1
  %add48.5 = select i1 %cmp39.not.5, i8 7, i8 %.op86
  ...
  %82 = load i8, ptr %arrayidx37.6, align 1, !tbaa !5
  %cmp39.not.6 = icmp eq i8 %82, 0
  %.op87 = add i8 %82, 2
  %add48.6 = select i1 %cmp39.not.6, i8 8, i8 %.op87
  ...
  %83 = load i8, ptr %arrayidx37.7, align 1, !tbaa !5
  %cmp39.not.7 = icmp eq i8 %83, 0
  %.op88 = add i8 %83, 2
  %add48.7 = select i1 %cmp39.not.7, i8 8, i8 %.op88
  ...
  %84 = load i8, ptr %arrayidx37.8, align 1, !tbaa !5
  %cmp39.not.8 = icmp eq i8 %84, 0
  %.op89 = add i8 %84, 3
  %add48.8 = select i1 %cmp39.not.8, i8 9, i8 %.op89
  ...
  %85 = load i8, ptr %arrayidx37.9, align 1, !tbaa !5
  %cmp39.not.9 = icmp eq i8 %85, 0
  %.op90 = add i8 %85, 3
  %add48.9 = select i1 %cmp39.not.9, i8 9, i8 %.op90
  ...
  %86 = load i8, ptr %arrayidx37.10, align 1, !tbaa !5
  %cmp39.not.10 = icmp eq i8 %86, 0
  %.op91 = add i8 %86, 4
  %add48.10 = select i1 %cmp39.not.10, i8 10, i8 %.op91
  ...
  %87 = load i8, ptr %arrayidx37.11, align 1, !tbaa !5
  %cmp39.not.11 = icmp eq i8 %87, 0
  %.op92 = add i8 %87, 4
  %add48.11 = select i1 %cmp39.not.11, i8 10, i8 %.op92
  ...
  %88 = load i8, ptr %arrayidx37.12, align 1, !tbaa !5
  %cmp39.not.12 = icmp eq i8 %88, 0
  %.op93 = add i8 %88, 5
  %add48.12 = select i1 %cmp39.not.12, i8 11, i8 %.op93
  ...
  %89 = load i8, ptr %arrayidx37.13, align 1, !tbaa !5
  %cmp39.not.13 = icmp eq i8 %89, 0
  %.op94 = add i8 %89, 5
  %add48.13 = select i1 %cmp39.not.13, i8 11, i8 %.op94
  ...
  %90 = load i8, ptr %arrayidx37.14, align 1, !tbaa !5
  %cmp39.not.14 = icmp eq i8 %90, 0
  %.op95 = add i8 %90, 6
  %add48.14 = select i1 %cmp39.not.14, i8 12, i8 %.op95
  ...
  %91 = load i8, ptr %arrayidx37.15, align 1, !tbaa !5
  %cmp39.not.15 = icmp eq i8 %91, 0
  %.op96 = add i8 %91, 6
  %add48.15 = select i1 %cmp39.not.15, i8 12, i8 %.op96
  ...
  %92 = load i8, ptr %arrayidx37.16, align 1, !tbaa !5
  %cmp39.not.16 = icmp eq i8 %92, 0
  %.op97 = add i8 %92, 7
  %add48.16 = select i1 %cmp39.not.16, i8 13, i8 %.op97
  ...
  %93 = load i8, ptr %arrayidx37.17, align 1, !tbaa !5
  %cmp39.not.17 = icmp eq i8 %93, 0
  %.op98 = add i8 %93, 7
  %add48.17 = select i1 %cmp39.not.17, i8 13, i8 %.op98
  ...
  %94 = load i8, ptr %arrayidx37.18, align 1, !tbaa !5
  %cmp39.not.18 = icmp eq i8 %94, 0
  %.op99 = add i8 %94, 8
  %add48.18 = select i1 %cmp39.not.18, i8 14, i8 %.op99
  ...
  %95 = load i8, ptr %arrayidx37.19, align 1, !tbaa !5
  %cmp39.not.19 = icmp eq i8 %95, 0
  %.op100 = add i8 %95, 8
  %add48.19 = select i1 %cmp39.not.19, i8 14, i8 %.op100
  ...
  %96 = load i8, ptr %arrayidx37.20, align 1, !tbaa !5
  %cmp39.not.20 = icmp eq i8 %96, 0
  %.op101 = add i8 %96, 9
  %add48.20 = select i1 %cmp39.not.20, i8 15, i8 %.op101
  ...
  %97 = load i8, ptr %arrayidx37.21, align 1, !tbaa !5
  %cmp39.not.21 = icmp eq i8 %97, 0
  %.op102 = add i8 %97, 9
  %add48.21 = select i1 %cmp39.not.21, i8 15, i8 %.op102
  ...
  %98 = load i8, ptr %arrayidx37.22, align 1, !tbaa !5
  %cmp39.not.22 = icmp eq i8 %98, 0
  %.op103 = add i8 %98, 10
  %add48.22 = select i1 %cmp39.not.22, i8 16, i8 %.op103
  ...
  %99 = load i8, ptr %arrayidx37.23, align 1, !tbaa !5
  %cmp39.not.23 = icmp eq i8 %99, 0
  %.op104 = add i8 %99, 10
  %add48.23 = select i1 %cmp39.not.23, i8 16, i8 %.op104
  ...
  %100 = load i8, ptr %arrayidx37.24, align 1, !tbaa !5
  %cmp39.not.24 = icmp eq i8 %100, 0
  %.op105 = add i8 %100, 11
  %add48.24 = select i1 %cmp39.not.24, i8 17, i8 %.op105
  ...
  %101 = load i8, ptr %arrayidx37.25, align 1, !tbaa !5
  %cmp39.not.25 = icmp eq i8 %101, 0
  %.op106 = add i8 %101, 11
  %add48.25 = select i1 %cmp39.not.25, i8 17, i8 %.op106
  ...
  %102 = load i8, ptr %arrayidx37.26, align 1, !tbaa !5
  %cmp39.not.26 = icmp eq i8 %102, 0
  %.op107 = add i8 %102, 12
  %add48.26 = select i1 %cmp39.not.26, i8 18, i8 %.op107
  ...
  %103 = load i8, ptr %arrayidx37.27, align 1, !tbaa !5
  %cmp39.not.27 = icmp eq i8 %103, 0
  %.op108 = add i8 %103, 12
  %add48.27 = select i1 %cmp39.not.27, i8 18, i8 %.op108
  ...
  %104 = load i8, ptr %arrayidx37.28, align 1, !tbaa !5
  %cmp39.not.28 = icmp eq i8 %104, 0
  %.op109 = add i8 %104, 13
  %add48.28 = select i1 %cmp39.not.28, i8 19, i8 %.op109
  ...
  %105 = load i8, ptr %arrayidx37.29, align 1, !tbaa !5
  %cmp39.not.29 = icmp eq i8 %105, 0
  %.op110 = add i8 %105, 13
  %add48.29 = select i1 %cmp39.not.29, i8 19, i8 %.op110
  ...
  %106 = load i8, ptr %arrayidx37.30, align 1, !tbaa !5
  %cmp39.not.30 = icmp eq i8 %106, 0
  %.op111 = add i8 %106, 14
  %add48.30 = select i1 %cmp39.not.30, i8 20, i8 %.op111
  ...
  %107 = load i8, ptr %arrayidx37.31, align 1, !tbaa !5
  %cmp39.not.31 = icmp eq i8 %107, 0
  %.op112 = add i8 %107, 14
  %add48.31 = select i1 %cmp39.not.31, i8 20, i8 %.op112
...
for.body7:                                        ; preds = %for.body7, %for.body7.lr.ph.new
  ...
  %108 = load i8, ptr %arrayidx9, align 2, !tbaa !5
  %conv10 = zext i8 %108 to i64
  %add = add nuw nsw i64 %conv10, 257
  %arrayidx14 = getelementptr inbounds [288 x i8], ptr %levels, i64 0, i64 %add
  %109 = load i8, ptr %arrayidx14, align 1, !tbaa !5
  %cmp16.not = icmp eq i8 %109, 0
  %cond20 = select i1 %cmp16.not, i8 11, i8 %109
  %arrayidx23 = getelementptr inbounds i8, ptr %67, i64 %conv10
  %110 = load i8, ptr %arrayidx23, align 1, !tbaa !5
  %add25 = add i8 %cond20, %110
  ...
  %111 = load i8, ptr %arrayidx9.1, align 1, !tbaa !5
  %conv10.1 = zext i8 %111 to i64
  %add.1 = add nuw nsw i64 %conv10.1, 257
  %arrayidx14.1 = getelementptr inbounds [288 x i8], ptr %levels, i64 0, i64 %add.1
  %112 = load i8, ptr %arrayidx14.1, align 1, !tbaa !5
  %cmp16.not.1 = icmp eq i8 %112, 0
  %cond20.1 = select i1 %cmp16.not.1, i8 11, i8 %112
  %arrayidx23.1 = getelementptr inbounds i8, ptr %67, i64 %conv10.1
  %113 = load i8, ptr %arrayidx23.1, align 1, !tbaa !5
  %add25.1 = add i8 %cond20.1, %113
...
define dso_local void @_ZN9NCompress8NDeflate8NEncoder19Huffman_ReverseBitsEPjPKhj(ptr nocapture noundef %codes, ptr nocapture noundef readonly %lens, i32 noundef %num) local_unnamed_addr #14 {
entry:
...
vector.memcheck:                                  ; preds = %for.body.preheader
  ...
  %uglygep = getelementptr i8, ptr %codes, i64 %0
  %uglygep37 = getelementptr i8, ptr %lens, i64 %wide.trip.count
  %bound0 = icmp ugt ptr %uglygep37, %codes
  %bound1 = icmp ugt ptr %uglygep, %lens
...
for.body.prol:                                    ; preds = %for.body.preheader39
  %arrayidx.prol = getelementptr inbounds i32, ptr %codes, i64 %indvars.iv.ph
  %11 = load i32, ptr %arrayidx.prol, align 4, !tbaa !53
  %trunc.prol = trunc i32 %11 to i16
  %rev.prol = tail call i16 @llvm.bitreverse.i16(i16 %trunc.prol)
  %or16.prol = zext i16 %rev.prol to i32
  %arrayidx18.prol = getelementptr inbounds i8, ptr %lens, i64 %indvars.iv.ph
  %12 = load i8, ptr %arrayidx18.prol, align 1, !tbaa !5
  %conv.prol = zext i8 %12 to i32
  %sub.prol = sub nsw i32 16, %conv.prol
  %shr19.prol = lshr i32 %or16.prol, %sub.prol
  store i32 %shr19.prol, ptr %arrayidx.prol, align 4, !tbaa !53
  %indvars.iv.next.prol = or i64 %indvars.iv.ph, 1
  br label %for.body.prol.loopexit

for.body.prol.loopexit:                           ; preds = %for.body.prol, %for.body.preheader39
  %indvars.iv.unr = phi i64 [ %indvars.iv.ph, %for.body.preheader39 ], [ %indvars.iv.next.prol, %for.body.prol ]
  %13 = sub nsw i64 0, %wide.trip.count
  %14 = icmp eq i64 %10, %13
  br i1 %14, label %for.cond.cleanup, label %for.body
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.body
  ...
  %15 = load i32, ptr %arrayidx, align 4, !tbaa !53
  ...
  %16 = load i8, ptr %arrayidx18, align 1, !tbaa !5
  %conv = zext i8 %16 to i32
  %sub = sub nsw i32 16, %conv
  %shr19 = lshr i32 %or16, %sub
  store i32 %shr19, ptr %arrayidx, align 4, !tbaa !53
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx.1 = getelementptr inbounds i32, ptr %codes, i64 %indvars.iv.next
  %17 = load i32, ptr %arrayidx.1, align 4, !tbaa !53
  %trunc.1 = trunc i32 %17 to i16
  %rev.1 = tail call i16 @llvm.bitreverse.i16(i16 %trunc.1)
  %or16.1 = zext i16 %rev.1 to i32
  %arrayidx18.1 = getelementptr inbounds i8, ptr %lens, i64 %indvars.iv.next
  %18 = load i8, ptr %arrayidx18.1, align 1, !tbaa !5
  %conv.1 = zext i8 %18 to i32
  %sub.1 = sub nsw i32 16, %conv.1
  %shr19.1 = lshr i32 %or16.1, %sub.1
  store i32 %shr19.1, ptr %arrayidx.1, align 4, !tbaa !53
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, %wide.trip.count
  br i1 %exitcond.not.1, label %for.cond.cleanup, label %for.body, !llvm.loop !114
}
...
entry:
  %mainCodes = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 42
  %m_NewLevels = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39
  %uglygep = getelementptr i8, ptr %this, i64 4688
  %uglygep372 = getelementptr i8, ptr %this, i64 2224
  %bound0 = icmp ult ptr %mainCodes, %uglygep372
  %bound1 = icmp ult ptr %m_NewLevels, %uglygep
  %found.conflict = and i1 %bound0, %bound1
...
for.body.i:                                       ; preds = %entry, %for.body.i
  ...
  %9 = load i32, ptr %arrayidx.i, align 8, !tbaa !53
  ...
  %10 = load i8, ptr %arrayidx18.i, align 2, !tbaa !5
  %conv.i = zext i8 %10 to i32
  %sub.i = sub nsw i32 16, %conv.i
  %shr19.i = lshr i32 %or16.i, %sub.i
  store i32 %shr19.i, ptr %arrayidx.i, align 8, !tbaa !53
  %indvars.iv.next.i = or i64 %indvars.iv.i, 1
  %arrayidx.i.1 = getelementptr inbounds i32, ptr %mainCodes, i64 %indvars.iv.next.i
  %11 = load i32, ptr %arrayidx.i.1, align 4, !tbaa !53
  %trunc.i.1 = trunc i32 %11 to i16
  %rev.i.1 = tail call i16 @llvm.bitreverse.i16(i16 %trunc.i.1)
  %or16.i.1 = zext i16 %rev.i.1 to i32
  %arrayidx18.i.1 = getelementptr inbounds i8, ptr %m_NewLevels, i64 %indvars.iv.next.i
  %12 = load i8, ptr %arrayidx18.i.1, align 1, !tbaa !5
  ...
  br i1 %exitcond.not.i.1, label %_ZN9NCompress8NDeflate8NEncoder19Huffman_ReverseBitsEPjPKhj.exit, label %for.body.i, !llvm.loop !121

_ZN9NCompress8NDeflate8NEncoder19Huffman_ReverseBitsEPjPKhj.exit: ; preds = %vector.body, %for.body.i
  %distCodes = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 43
  %distLevels = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39, i32 1
  %13 = load <4 x i32>, ptr %distCodes, align 8, !tbaa !53
  %14 = trunc <4 x i32> %13 to <4 x i16>
  %15 = tail call <4 x i16> @llvm.bitreverse.v4i16(<4 x i16> %14)
  %16 = zext <4 x i16> %15 to <4 x i32>
  %17 = load <4 x i8>, ptr %distLevels, align 8, !tbaa !5
  %18 = zext <4 x i8> %17 to <4 x i32>
  %19 = sub nsw <4 x i32> <i32 16, i32 16, i32 16, i32 16>, %18
  %20 = lshr <4 x i32> %16, %19
  store <4 x i32> %20, ptr %distCodes, align 8, !tbaa !53
  %arrayidx.i76.4 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 43, i64 4
  %arrayidx18.i80.4 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39, i32 1, i64 4
  %21 = load <4 x i32>, ptr %arrayidx.i76.4, align 8, !tbaa !53
  %22 = trunc <4 x i32> %21 to <4 x i16>
  %23 = tail call <4 x i16> @llvm.bitreverse.v4i16(<4 x i16> %22)
  %24 = zext <4 x i16> %23 to <4 x i32>
  %25 = load <4 x i8>, ptr %arrayidx18.i80.4, align 4, !tbaa !5
  %26 = zext <4 x i8> %25 to <4 x i32>
  %27 = sub nsw <4 x i32> <i32 16, i32 16, i32 16, i32 16>, %26
  %28 = lshr <4 x i32> %24, %27
  store <4 x i32> %28, ptr %arrayidx.i76.4, align 8, !tbaa !53
  %arrayidx.i76.8 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 43, i64 8
  %arrayidx18.i80.8 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39, i32 1, i64 8
  %29 = load <4 x i32>, ptr %arrayidx.i76.8, align 8, !tbaa !53
  %30 = trunc <4 x i32> %29 to <4 x i16>
  %31 = tail call <4 x i16> @llvm.bitreverse.v4i16(<4 x i16> %30)
  %32 = zext <4 x i16> %31 to <4 x i32>
  %33 = load <4 x i8>, ptr %arrayidx18.i80.8, align 8, !tbaa !5
  %34 = zext <4 x i8> %33 to <4 x i32>
  %35 = sub nsw <4 x i32> <i32 16, i32 16, i32 16, i32 16>, %34
  %36 = lshr <4 x i32> %32, %35
  store <4 x i32> %36, ptr %arrayidx.i76.8, align 8, !tbaa !53
  %arrayidx.i76.12 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 43, i64 12
  %arrayidx18.i80.12 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39, i32 1, i64 12
  %37 = load <4 x i32>, ptr %arrayidx.i76.12, align 8, !tbaa !53
  %38 = trunc <4 x i32> %37 to <4 x i16>
  %39 = tail call <4 x i16> @llvm.bitreverse.v4i16(<4 x i16> %38)
  %40 = zext <4 x i16> %39 to <4 x i32>
  %41 = load <4 x i8>, ptr %arrayidx18.i80.12, align 4, !tbaa !5
  %42 = zext <4 x i8> %41 to <4 x i32>
  %43 = sub nsw <4 x i32> <i32 16, i32 16, i32 16, i32 16>, %42
  %44 = lshr <4 x i32> %40, %43
  store <4 x i32> %44, ptr %arrayidx.i76.12, align 8, !tbaa !53
  %arrayidx.i76.16 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 43, i64 16
  %arrayidx18.i80.16 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39, i32 1, i64 16
  %45 = load <4 x i32>, ptr %arrayidx.i76.16, align 8, !tbaa !53
  %46 = trunc <4 x i32> %45 to <4 x i16>
  %47 = tail call <4 x i16> @llvm.bitreverse.v4i16(<4 x i16> %46)
  %48 = zext <4 x i16> %47 to <4 x i32>
  %49 = load <4 x i8>, ptr %arrayidx18.i80.16, align 8, !tbaa !5
  %50 = zext <4 x i8> %49 to <4 x i32>
  %51 = sub nsw <4 x i32> <i32 16, i32 16, i32 16, i32 16>, %50
  %52 = lshr <4 x i32> %48, %51
  store <4 x i32> %52, ptr %arrayidx.i76.16, align 8, !tbaa !53
  %arrayidx.i76.20 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 43, i64 20
  %arrayidx18.i80.20 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39, i32 1, i64 20
  %53 = load <4 x i32>, ptr %arrayidx.i76.20, align 8, !tbaa !53
  %54 = trunc <4 x i32> %53 to <4 x i16>
  %55 = tail call <4 x i16> @llvm.bitreverse.v4i16(<4 x i16> %54)
  %56 = zext <4 x i16> %55 to <4 x i32>
  %57 = load <4 x i8>, ptr %arrayidx18.i80.20, align 4, !tbaa !5
  %58 = zext <4 x i8> %57 to <4 x i32>
  %59 = sub nsw <4 x i32> <i32 16, i32 16, i32 16, i32 16>, %58
  %60 = lshr <4 x i32> %56, %59
  store <4 x i32> %60, ptr %arrayidx.i76.20, align 8, !tbaa !53
  %arrayidx.i76.24 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 43, i64 24
  %arrayidx18.i80.24 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39, i32 1, i64 24
  %61 = load <4 x i32>, ptr %arrayidx.i76.24, align 8, !tbaa !53
  %62 = trunc <4 x i32> %61 to <4 x i16>
  %63 = tail call <4 x i16> @llvm.bitreverse.v4i16(<4 x i16> %62)
  %64 = zext <4 x i16> %63 to <4 x i32>
  %65 = load <4 x i8>, ptr %arrayidx18.i80.24, align 8, !tbaa !5
  %66 = zext <4 x i8> %65 to <4 x i32>
  %67 = sub nsw <4 x i32> <i32 16, i32 16, i32 16, i32 16>, %66
  %68 = lshr <4 x i32> %64, %67
  store <4 x i32> %68, ptr %arrayidx.i76.24, align 8, !tbaa !53
  %arrayidx.i76.28 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 43, i64 28
  %arrayidx18.i80.28 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39, i32 1, i64 28
  %69 = load <4 x i32>, ptr %arrayidx.i76.28, align 8, !tbaa !53
  %70 = trunc <4 x i32> %69 to <4 x i16>
  %71 = tail call <4 x i16> @llvm.bitreverse.v4i16(<4 x i16> %70)
  %72 = zext <4 x i16> %71 to <4 x i32>
  %73 = load <4 x i8>, ptr %arrayidx18.i80.28, align 4, !tbaa !5
  %74 = zext <4 x i8> %73 to <4 x i32>
  %75 = sub nsw <4 x i32> <i32 16, i32 16, i32 16, i32 16>, %74
  %76 = lshr <4 x i32> %72, %75
  store <4 x i32> %76, ptr %arrayidx.i76.28, align 8, !tbaa !53
  %m_ValueIndex = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 30
  %77 = load i32, ptr %m_ValueIndex, align 4, !tbaa !100
  %cmp284.not = icmp eq i32 %77, 0
  br i1 %cmp284.not, label %for.cond.cleanup, label %for.body.lr.ph

for.body.lr.ph:                                   ; preds = %_ZN9NCompress8NDeflate8NEncoder19Huffman_ReverseBitsEPjPKhj.exit
  %m_Values = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 3
...
for.cond.cleanup:                                 ; preds = %if.end, %_ZN9NCompress8NDeflate8NEncoder19Huffman_ReverseBitsEPjPKhj.exit
  ...
  %78 = load i8, ptr %arrayidx59, align 8, !tbaa !5
  %cmp.not29.i = icmp eq i8 %78, 0
  br i1 %cmp.not29.i, label %_ZN12CBitlEncoder9WriteBitsEjj.exit, label %while.body.lr.ph.i
...
while.body.lr.ph.i:                               ; preds = %for.cond.cleanup
  ...
  %79 = load i32, ptr %arrayidx56, align 8, !tbaa !53
  %m_BitPos.i = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 1, i32 1
  %m_CurByte11.i = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 1, i32 2
  %_pos.i.i = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 1, i32 0, i32 1
  %_limitPos.i.i = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 1, i32 0, i32 2
...
if.end.i.peel:                                    ; preds = %while.body.lr.ph.i
  ...
  %80 = load i8, ptr %m_CurByte11.i, align 4, !tbaa !86
  %sub14.i.peel = sub i32 8, %.pre.i
  %shl15.i.peel = shl i32 %79, %sub14.i.peel
  %81 = trunc i32 %shl15.i.peel to i8
  %conv17.i.peel = or i8 %80, %81
  %82 = load ptr, ptr %m_OutStream54, align 8, !tbaa !8
  %83 = load i32, ptr %_pos.i.i, align 8, !tbaa !15
  %inc.i.i.peel = add i32 %83, 1
  store i32 %inc.i.i.peel, ptr %_pos.i.i, align 8, !tbaa !15
  %idxprom.i.i.peel = zext i32 %83 to i64
  %arrayidx.i.i.peel = getelementptr inbounds i8, ptr %82, i64 %idxprom.i.i.peel
  store i8 %conv17.i.peel, ptr %arrayidx.i.i.peel, align 1, !tbaa !5
  %84 = load i32, ptr %_pos.i.i, align 8, !tbaa !15
  %85 = load i32, ptr %_limitPos.i.i, align 4, !tbaa !87
  %cmp.i.i.peel = icmp eq i32 %84, %85
  br i1 %cmp.i.i.peel, label %if.then.i.i.peel, label %_ZN10COutBuffer9WriteByteEh.exit.i.peel
...
_ZN10COutBuffer9WriteByteEh.exit.i.peel:          ; preds = %if.then.i.i.peel, %if.end.i.peel
  %86 = load i32, ptr %m_BitPos.i, align 8, !tbaa !85
  store i32 8, ptr %m_BitPos.i, align 8, !tbaa !85
  store i8 0, ptr %m_CurByte11.i, align 4, !tbaa !86
  %cmp.not.i.peel = icmp eq i32 %sub10.i.peel, 0
  br i1 %cmp.not.i.peel, label %_ZN12CBitlEncoder9WriteBitsEjj.exit, label %while.body.i.peel.next
...
if.then.i:                                        ; preds = %while.body.i, %while.body.lr.ph.i.if.then.i_crit_edge
  %87 = phi i8 [ %.pre321, %while.body.lr.ph.i.if.then.i_crit_edge ], [ 0, %while.body.i ]
  %.lcssa = phi i32 [ %.pre.i, %while.body.lr.ph.i.if.then.i_crit_edge ], [ 8, %while.body.i ]
  %numBits.addr.031.i.lcssa = phi i32 [ %conv60, %while.body.lr.ph.i.if.then.i_crit_edge ], [ %numBits.addr.031.i, %while.body.i ]
  %value.addr.030.i.lcssa = phi i32 [ %79, %while.body.lr.ph.i.if.then.i_crit_edge ], [ %value.addr.030.i, %while.body.i ]
  %notmask.i = shl nsw i32 -1, %numBits.addr.031.i.lcssa
  %sub.i88 = xor i32 %notmask.i, -1
  %and.i = and i32 %value.addr.030.i.lcssa, %sub.i88
  %sub4.i = sub i32 8, %.lcssa
  %shl5.i = shl i32 %and.i, %sub4.i
  %88 = trunc i32 %shl5.i to i8
  %conv6.i = or i8 %87, %88
  store i8 %conv6.i, ptr %m_CurByte11.i, align 4, !tbaa !86
  %sub8.i = sub i32 %.lcssa, %numBits.addr.031.i.lcssa
  store i32 %sub8.i, ptr %m_BitPos.i, align 8, !tbaa !85
...
if.end.i:                                         ; preds = %while.body.i
  %sub10.i = add i32 %numBits.addr.031.i, -8
  %89 = trunc i32 %value.addr.030.i to i8
  %90 = load ptr, ptr %m_OutStream54, align 8, !tbaa !8
  %91 = load i32, ptr %_pos.i.i, align 8, !tbaa !15
  %inc.i.i = add i32 %91, 1
  store i32 %inc.i.i, ptr %_pos.i.i, align 8, !tbaa !15
  %idxprom.i.i = zext i32 %91 to i64
  %arrayidx.i.i = getelementptr inbounds i8, ptr %90, i64 %idxprom.i.i
  store i8 %89, ptr %arrayidx.i.i, align 1, !tbaa !5
  %92 = load i32, ptr %_pos.i.i, align 8, !tbaa !15
  %93 = load i32, ptr %_limitPos.i.i, align 4, !tbaa !87
...
_ZN10COutBuffer9WriteByteEh.exit.i:               ; preds = %if.then.i.i, %if.end.i
  %94 = load i32, ptr %m_BitPos.i, align 8, !tbaa !85
  %shr.i = lshr i32 %value.addr.030.i, %94
  store i32 8, ptr %m_BitPos.i, align 8, !tbaa !85
  store i8 0, ptr %m_CurByte11.i, align 4, !tbaa !86
  %cmp.not.i = icmp eq i32 %sub10.i, 0
  br i1 %cmp.not.i, label %_ZN12CBitlEncoder9WriteBitsEjj.exit, label %while.body.i, !llvm.loop !122
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end
  ...
  %95 = load ptr, ptr %m_Values, align 8, !tbaa !42
  %arrayidx = getelementptr inbounds %"struct.NCompress::NDeflate::NEncoder::CCodeValue", ptr %95, i64 %indvars.iv
  %96 = load i16, ptr %arrayidx, align 2, !tbaa !102
  %cmp.i = icmp slt i16 %96, 0
  br i1 %cmp.i, label %if.then, label %if.else

if.then:                                          ; preds = %for.body
  %Pos = getelementptr inbounds %"struct.NCompress::NDeflate::NEncoder::CCodeValue", ptr %95, i64 %indvars.iv, i32 1
  %97 = load i16, ptr %Pos, align 2, !tbaa !104
  %idxprom7 = zext i16 %97 to i64
  %arrayidx13 = getelementptr inbounds [288 x i8], ptr %m_NewLevels, i64 0, i64 %idxprom7
  %98 = load i8, ptr %arrayidx13, align 1, !tbaa !5
  %cmp.not29.i89 = icmp eq i8 %98, 0
...
while.body.lr.ph.i95:                             ; preds = %if.then
  ...
  %99 = load i32, ptr %arrayidx8, align 4, !tbaa !53
...
if.end.i116.peel:                                 ; preds = %while.body.lr.ph.i95
  ...
  %100 = load i8, ptr %m_CurByte11.i124, align 4, !tbaa !86
  %sub14.i109.peel = sub i32 8, %.pre.i94
  %shl15.i110.peel = shl i32 %99, %sub14.i109.peel
  %101 = trunc i32 %shl15.i110.peel to i8
  %conv17.i111.peel = or i8 %100, %101
  %102 = load ptr, ptr %m_OutStream18, align 8, !tbaa !8
  %103 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %inc.i.i112.peel = add i32 %103, 1
  store i32 %inc.i.i112.peel, ptr %_pos.i.i125, align 8, !tbaa !15
  %idxprom.i.i113.peel = zext i32 %103 to i64
  %arrayidx.i.i114.peel = getelementptr inbounds i8, ptr %102, i64 %idxprom.i.i113.peel
  store i8 %conv17.i111.peel, ptr %arrayidx.i.i114.peel, align 1, !tbaa !5
  %104 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %105 = load i32, ptr %_limitPos.i.i126, align 4, !tbaa !87
  %cmp.i.i115.peel = icmp eq i32 %104, %105
...
_ZN10COutBuffer9WriteByteEh.exit.i120.peel:       ; preds = %if.then.i.i117.peel, %if.end.i116.peel
  %106 = load i32, ptr %m_BitPos.i123, align 8, !tbaa !85
...
if.then.i107:                                     ; preds = %while.body.i99, %while.body.lr.ph.i95.if.then.i107_crit_edge
  %107 = phi i8 [ %.pre320, %while.body.lr.ph.i95.if.then.i107_crit_edge ], [ 0, %while.body.i99 ]
  ...
  %value.addr.030.i97.lcssa = phi i32 [ %99, %while.body.lr.ph.i95.if.then.i107_crit_edge ], [ %value.addr.030.i97, %while.body.i99 ]
  ...
  %108 = trunc i32 %shl5.i104 to i8
  %conv6.i105 = or i8 %107, %108
...
if.end.i116:                                      ; preds = %while.body.i99
  ...
  %109 = trunc i32 %value.addr.030.i97 to i8
  %110 = load ptr, ptr %m_OutStream18, align 8, !tbaa !8
  %111 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %inc.i.i112 = add i32 %111, 1
  store i32 %inc.i.i112, ptr %_pos.i.i125, align 8, !tbaa !15
  %idxprom.i.i113 = zext i32 %111 to i64
  %arrayidx.i.i114 = getelementptr inbounds i8, ptr %110, i64 %idxprom.i.i113
  store i8 %109, ptr %arrayidx.i.i114, align 1, !tbaa !5
  %112 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %113 = load i32, ptr %_limitPos.i.i126, align 4, !tbaa !87
  %cmp.i.i115 = icmp eq i32 %112, %113
...
_ZN10COutBuffer9WriteByteEh.exit.i120:            ; preds = %if.then.i.i117, %if.end.i116
  %114 = load i32, ptr %m_BitPos.i123, align 8, !tbaa !85
  %shr.i118 = lshr i32 %value.addr.030.i97, %114
  store i32 8, ptr %m_BitPos.i123, align 8, !tbaa !85
  store i8 0, ptr %m_CurByte11.i124, align 4, !tbaa !86
  %cmp.not.i119 = icmp eq i32 %sub10.i108, 0
  br i1 %cmp.not.i119, label %if.end, label %while.body.i99, !llvm.loop !123

if.else:                                          ; preds = %for.body
  %conv14 = zext i16 %96 to i32
  %idxprom15 = zext i16 %96 to i64
  %arrayidx16 = getelementptr inbounds [256 x i8], ptr @_ZN9NCompress8NDeflate8NEncoderL10g_LenSlotsE, i64 0, i64 %idxprom15
  %115 = load i8, ptr %arrayidx16, align 1, !tbaa !5
  %conv17 = zext i8 %115 to i64
  %add = add nuw nsw i64 %conv17, 257
  %arrayidx26 = getelementptr inbounds [288 x i8], ptr %m_NewLevels, i64 0, i64 %add
  %116 = load i8, ptr %arrayidx26, align 1, !tbaa !5
  %cmp.not29.i122 = icmp eq i8 %116, 0
...
if.end.i149.peel:                                 ; preds = %while.body.lr.ph.i128
  ...
  %118 = load i8, ptr %m_CurByte11.i124, align 4, !tbaa !86
  %sub14.i142.peel = sub i32 8, %.pre.i127
  %shl15.i143.peel = shl i32 %117, %sub14.i142.peel
  %119 = trunc i32 %shl15.i143.peel to i8
  %conv17.i144.peel = or i8 %118, %119
  %120 = load ptr, ptr %m_OutStream18, align 8, !tbaa !8
  %121 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %inc.i.i145.peel = add i32 %121, 1
  store i32 %inc.i.i145.peel, ptr %_pos.i.i125, align 8, !tbaa !15
  %idxprom.i.i146.peel = zext i32 %121 to i64
  %arrayidx.i.i147.peel = getelementptr inbounds i8, ptr %120, i64 %idxprom.i.i146.peel
  store i8 %conv17.i144.peel, ptr %arrayidx.i.i147.peel, align 1, !tbaa !5
  %122 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %123 = load i32, ptr %_limitPos.i.i126, align 4, !tbaa !87
  %cmp.i.i148.peel = icmp eq i32 %122, %123
...
_ZN10COutBuffer9WriteByteEh.exit.i153.peel:       ; preds = %if.then.i.i150.peel, %if.end.i149.peel
  %124 = load i32, ptr %m_BitPos.i123, align 8, !tbaa !85
  store i32 8, ptr %m_BitPos.i123, align 8, !tbaa !85
  store i8 0, ptr %m_CurByte11.i124, align 4, !tbaa !86
...
while.body.i132.peel.next:                        ; preds = %_ZN10COutBuffer9WriteByteEh.exit.i153.peel
  %shr.i151.peel = lshr i32 %117, %124
...
if.then.i140:                                     ; preds = %while.body.i132, %while.body.lr.ph.i128.if.then.i140_crit_edge
  %125 = phi i8 [ %.pre, %while.body.lr.ph.i128.if.then.i140_crit_edge ], [ 0, %while.body.i132 ]
  ...
  %value.addr.030.i130.lcssa = phi i32 [ %117, %while.body.lr.ph.i128.if.then.i140_crit_edge ], [ %value.addr.030.i130, %while.body.i132 ]
  ...
  %126 = trunc i32 %shl5.i137 to i8
  %conv6.i138 = or i8 %125, %126
...
if.end.i149:                                      ; preds = %while.body.i132
  ...
  %127 = trunc i32 %value.addr.030.i130 to i8
  %128 = load ptr, ptr %m_OutStream18, align 8, !tbaa !8
  %129 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %inc.i.i145 = add i32 %129, 1
  store i32 %inc.i.i145, ptr %_pos.i.i125, align 8, !tbaa !15
  %idxprom.i.i146 = zext i32 %129 to i64
  %arrayidx.i.i147 = getelementptr inbounds i8, ptr %128, i64 %idxprom.i.i146
  store i8 %127, ptr %arrayidx.i.i147, align 1, !tbaa !5
  %130 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %131 = load i32, ptr %_limitPos.i.i126, align 4, !tbaa !87
  %cmp.i.i148 = icmp eq i32 %130, %131
...
_ZN10COutBuffer9WriteByteEh.exit.i153:            ; preds = %if.then.i.i150, %if.end.i149
  %132 = load i32, ptr %m_BitPos.i123, align 8, !tbaa !85
  %shr.i151 = lshr i32 %value.addr.030.i130, %132
  store i32 8, ptr %m_BitPos.i123, align 8, !tbaa !85
  store i8 0, ptr %m_CurByte11.i124, align 4, !tbaa !86
  %cmp.not.i152 = icmp eq i32 %sub10.i141, 0
  br i1 %cmp.not.i152, label %_ZN12CBitlEncoder9WriteBitsEjj.exit154, label %while.body.i132, !llvm.loop !124
...
_ZN12CBitlEncoder9WriteBitsEjj.exit154:           ; preds = %_ZN10COutBuffer9WriteByteEh.exit.i153, %_ZN10COutBuffer9WriteByteEh.exit.i153.peel, %if.else, %if.then.i140
  %133 = load ptr, ptr %m_LenDirectBits, align 8, !tbaa !38
  %arrayidx33 = getelementptr inbounds i8, ptr %133, i64 %conv17
  %134 = load i8, ptr %arrayidx33, align 1, !tbaa !5
  %cmp.not29.i155 = icmp eq i8 %134, 0
...
while.body.lr.ph.i161:                            ; preds = %_ZN12CBitlEncoder9WriteBitsEjj.exit154
  %conv34 = zext i8 %134 to i32
  %135 = load ptr, ptr %m_LenStart, align 8, !tbaa !37
  %arrayidx30 = getelementptr inbounds i8, ptr %135, i64 %conv17
  %136 = load i8, ptr %arrayidx30, align 1, !tbaa !5
  %conv31 = zext i8 %136 to i32
...
if.end.i182.peel:                                 ; preds = %while.body.lr.ph.i161
  ...
  %137 = load i8, ptr %m_CurByte11.i124, align 4, !tbaa !86
  %sub14.i175.peel = sub i32 8, %.pre.i160
  %shl15.i176.peel = shl i32 %sub, %sub14.i175.peel
  %138 = trunc i32 %shl15.i176.peel to i8
  %conv17.i177.peel = or i8 %137, %138
  %139 = load ptr, ptr %m_OutStream18, align 8, !tbaa !8
  %140 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %inc.i.i178.peel = add i32 %140, 1
  store i32 %inc.i.i178.peel, ptr %_pos.i.i125, align 8, !tbaa !15
  %idxprom.i.i179.peel = zext i32 %140 to i64
  %arrayidx.i.i180.peel = getelementptr inbounds i8, ptr %139, i64 %idxprom.i.i179.peel
  store i8 %conv17.i177.peel, ptr %arrayidx.i.i180.peel, align 1, !tbaa !5
  %141 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %142 = load i32, ptr %_limitPos.i.i126, align 4, !tbaa !87
  %cmp.i.i181.peel = icmp eq i32 %141, %142
...
_ZN10COutBuffer9WriteByteEh.exit.i186.peel:       ; preds = %if.then.i.i183.peel, %if.end.i182.peel
  %143 = load i32, ptr %m_BitPos.i123, align 8, !tbaa !85
  store i32 8, ptr %m_BitPos.i123, align 8, !tbaa !85
  store i8 0, ptr %m_CurByte11.i124, align 4, !tbaa !86
...
while.body.i165.peel.next:                        ; preds = %_ZN10COutBuffer9WriteByteEh.exit.i186.peel
  %shr.i184.peel = lshr i32 %sub, %143
...
if.then.i173:                                     ; preds = %while.body.i165, %while.body.lr.ph.i161.if.then.i173_crit_edge
  %144 = phi i8 [ %.pre317, %while.body.lr.ph.i161.if.then.i173_crit_edge ], [ 0, %while.body.i165 ]
  ...
  %145 = trunc i32 %shl5.i170 to i8
  %conv6.i171 = or i8 %144, %145
...
if.end.i182:                                      ; preds = %while.body.i165
  ...
  %146 = trunc i32 %value.addr.030.i163 to i8
  %147 = load ptr, ptr %m_OutStream18, align 8, !tbaa !8
  %148 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %inc.i.i178 = add i32 %148, 1
  store i32 %inc.i.i178, ptr %_pos.i.i125, align 8, !tbaa !15
  %idxprom.i.i179 = zext i32 %148 to i64
  %arrayidx.i.i180 = getelementptr inbounds i8, ptr %147, i64 %idxprom.i.i179
  store i8 %146, ptr %arrayidx.i.i180, align 1, !tbaa !5
  %149 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %150 = load i32, ptr %_limitPos.i.i126, align 4, !tbaa !87
  %cmp.i.i181 = icmp eq i32 %149, %150
...
_ZN10COutBuffer9WriteByteEh.exit.i186:            ; preds = %if.then.i.i183, %if.end.i182
  %151 = load i32, ptr %m_BitPos.i123, align 8, !tbaa !85
  %shr.i184 = lshr i32 %value.addr.030.i163, %151
  store i32 8, ptr %m_BitPos.i123, align 8, !tbaa !85
  store i8 0, ptr %m_CurByte11.i124, align 4, !tbaa !86
  %cmp.not.i185 = icmp eq i32 %sub10.i174, 0
  br i1 %cmp.not.i185, label %_ZN12CBitlEncoder9WriteBitsEjj.exit187, label %while.body.i165, !llvm.loop !125
...
_ZN12CBitlEncoder9WriteBitsEjj.exit187:           ; preds = %_ZN10COutBuffer9WriteByteEh.exit.i186, %_ZN10COutBuffer9WriteByteEh.exit.i186.peel, %_ZN12CBitlEncoder9WriteBitsEjj.exit154, %if.then.i173
  %Pos35 = getelementptr inbounds %"struct.NCompress::NDeflate::NEncoder::CCodeValue", ptr %95, i64 %indvars.iv, i32 1
  %152 = load i16, ptr %Pos35, align 2, !tbaa !104
  %conv36 = zext i16 %152 to i32
  %cmp.i188 = icmp ult i16 %152, 512
  br i1 %cmp.i188, label %if.then.i191, label %if.end.i193

if.then.i191:                                     ; preds = %_ZN12CBitlEncoder9WriteBitsEjj.exit187
  %idxprom.i = zext i16 %152 to i64
  %arrayidx.i189 = getelementptr inbounds [512 x i8], ptr @_ZN9NCompress8NDeflate8NEncoderL9g_FastPosE, i64 0, i64 %idxprom.i
  %153 = load i8, ptr %arrayidx.i189, align 1, !tbaa !5
  %conv.i190 = zext i8 %153 to i64
  br label %_ZN9NCompress8NDeflate8NEncoder10GetPosSlotEj.exit
...
if.end.i193:                                      ; preds = %_ZN12CBitlEncoder9WriteBitsEjj.exit187
  ...
  %arrayidx2.i = getelementptr inbounds [512 x i8], ptr @_ZN9NCompress8NDeflate8NEncoderL9g_FastPosE, i64 0, i64 %idxprom1.i
  %154 = load i8, ptr %arrayidx2.i, align 1, !tbaa !5
  %conv3.i = zext i8 %154 to i64
  %add.i = add nuw nsw i64 %conv3.i, 16
  br label %_ZN9NCompress8NDeflate8NEncoder10GetPosSlotEj.exit
...
_ZN9NCompress8NDeflate8NEncoder10GetPosSlotEj.exit: ; preds = %if.then.i191, %if.end.i193
  ...
  %155 = load i8, ptr %arrayidx45, align 1, !tbaa !5
  %cmp.not29.i194 = icmp eq i8 %155, 0
...
if.end.i221.peel:                                 ; preds = %while.body.lr.ph.i200
  ...
  %157 = load i8, ptr %m_CurByte11.i124, align 4, !tbaa !86
  %sub14.i214.peel = sub i32 8, %.pre.i199
  %shl15.i215.peel = shl i32 %156, %sub14.i214.peel
  %158 = trunc i32 %shl15.i215.peel to i8
  %conv17.i216.peel = or i8 %157, %158
  %159 = load ptr, ptr %m_OutStream18, align 8, !tbaa !8
  %160 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %inc.i.i217.peel = add i32 %160, 1
  store i32 %inc.i.i217.peel, ptr %_pos.i.i125, align 8, !tbaa !15
  %idxprom.i.i218.peel = zext i32 %160 to i64
  %arrayidx.i.i219.peel = getelementptr inbounds i8, ptr %159, i64 %idxprom.i.i218.peel
  store i8 %conv17.i216.peel, ptr %arrayidx.i.i219.peel, align 1, !tbaa !5
  %161 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %162 = load i32, ptr %_limitPos.i.i126, align 4, !tbaa !87
  %cmp.i.i220.peel = icmp eq i32 %161, %162
...
_ZN10COutBuffer9WriteByteEh.exit.i225.peel:       ; preds = %if.then.i.i222.peel, %if.end.i221.peel
  %163 = load i32, ptr %m_BitPos.i123, align 8, !tbaa !85
  store i32 8, ptr %m_BitPos.i123, align 8, !tbaa !85
  store i8 0, ptr %m_CurByte11.i124, align 4, !tbaa !86
...
while.body.i204.peel.next:                        ; preds = %_ZN10COutBuffer9WriteByteEh.exit.i225.peel
  %shr.i223.peel = lshr i32 %156, %163
...
if.then.i212:                                     ; preds = %while.body.i204, %while.body.lr.ph.i200.if.then.i212_crit_edge
  %164 = phi i8 [ %.pre318, %while.body.lr.ph.i200.if.then.i212_crit_edge ], [ 0, %while.body.i204 ]
  ...
  %value.addr.030.i202.lcssa = phi i32 [ %156, %while.body.lr.ph.i200.if.then.i212_crit_edge ], [ %value.addr.030.i202, %while.body.i204 ]
  ...
  %165 = trunc i32 %shl5.i209 to i8
  %conv6.i210 = or i8 %164, %165
...
if.end.i221:                                      ; preds = %while.body.i204
  ...
  %166 = trunc i32 %value.addr.030.i202 to i8
  %167 = load ptr, ptr %m_OutStream18, align 8, !tbaa !8
  %168 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %inc.i.i217 = add i32 %168, 1
  store i32 %inc.i.i217, ptr %_pos.i.i125, align 8, !tbaa !15
  %idxprom.i.i218 = zext i32 %168 to i64
  %arrayidx.i.i219 = getelementptr inbounds i8, ptr %167, i64 %idxprom.i.i218
  store i8 %166, ptr %arrayidx.i.i219, align 1, !tbaa !5
  %169 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %170 = load i32, ptr %_limitPos.i.i126, align 4, !tbaa !87
  %cmp.i.i220 = icmp eq i32 %169, %170
...
_ZN10COutBuffer9WriteByteEh.exit.i225:            ; preds = %if.then.i.i222, %if.end.i221
  %171 = load i32, ptr %m_BitPos.i123, align 8, !tbaa !85
  %shr.i223 = lshr i32 %value.addr.030.i202, %171
  store i32 8, ptr %m_BitPos.i123, align 8, !tbaa !85
  store i8 0, ptr %m_CurByte11.i124, align 4, !tbaa !86
  %cmp.not.i224 = icmp eq i32 %sub10.i213, 0
  br i1 %cmp.not.i224, label %_ZN12CBitlEncoder9WriteBitsEjj.exit226, label %while.body.i204, !llvm.loop !126
...
while.body.lr.ph.i233:                            ; preds = %_ZN12CBitlEncoder9WriteBitsEjj.exit226
  ...
  %172 = load i8, ptr %arrayidx52, align 1, !tbaa !5
  %conv53 = zext i8 %172 to i32
  %arrayidx49 = getelementptr inbounds [32 x i32], ptr @_ZN9NCompress8NDeflateL10kDistStartE, i64 0, i64 %retval.0.i
  %173 = load i32, ptr %arrayidx49, align 4, !tbaa !53
  %sub50 = sub i32 %conv36, %173
...
if.end.i254.peel:                                 ; preds = %while.body.lr.ph.i233
  ...
  %174 = load i8, ptr %m_CurByte11.i124, align 4, !tbaa !86
  %sub14.i247.peel = sub i32 8, %.pre.i232
  %shl15.i248.peel = shl i32 %sub50, %sub14.i247.peel
  %175 = trunc i32 %shl15.i248.peel to i8
  %conv17.i249.peel = or i8 %174, %175
  %176 = load ptr, ptr %m_OutStream18, align 8, !tbaa !8
  %177 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %inc.i.i250.peel = add i32 %177, 1
  store i32 %inc.i.i250.peel, ptr %_pos.i.i125, align 8, !tbaa !15
  %idxprom.i.i251.peel = zext i32 %177 to i64
  %arrayidx.i.i252.peel = getelementptr inbounds i8, ptr %176, i64 %idxprom.i.i251.peel
  store i8 %conv17.i249.peel, ptr %arrayidx.i.i252.peel, align 1, !tbaa !5
  %178 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %179 = load i32, ptr %_limitPos.i.i126, align 4, !tbaa !87
  %cmp.i.i253.peel = icmp eq i32 %178, %179
...
_ZN10COutBuffer9WriteByteEh.exit.i258.peel:       ; preds = %if.then.i.i255.peel, %if.end.i254.peel
  %180 = load i32, ptr %m_BitPos.i123, align 8, !tbaa !85
  store i32 8, ptr %m_BitPos.i123, align 8, !tbaa !85
  store i8 0, ptr %m_CurByte11.i124, align 4, !tbaa !86
...
while.body.i237.peel.next:                        ; preds = %_ZN10COutBuffer9WriteByteEh.exit.i258.peel
  %shr.i256.peel = lshr i32 %sub50, %180
...
if.then.i245:                                     ; preds = %while.body.i237, %while.body.lr.ph.i233.if.then.i245_crit_edge
  %181 = phi i8 [ %.pre319, %while.body.lr.ph.i233.if.then.i245_crit_edge ], [ 0, %while.body.i237 ]
  ...
  %182 = trunc i32 %shl5.i242 to i8
  %conv6.i243 = or i8 %181, %182
...
if.end.i254:                                      ; preds = %while.body.i237
  ...
  %183 = trunc i32 %value.addr.030.i235 to i8
  %184 = load ptr, ptr %m_OutStream18, align 8, !tbaa !8
  %185 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %inc.i.i250 = add i32 %185, 1
  store i32 %inc.i.i250, ptr %_pos.i.i125, align 8, !tbaa !15
  %idxprom.i.i251 = zext i32 %185 to i64
  %arrayidx.i.i252 = getelementptr inbounds i8, ptr %184, i64 %idxprom.i.i251
  store i8 %183, ptr %arrayidx.i.i252, align 1, !tbaa !5
  %186 = load i32, ptr %_pos.i.i125, align 8, !tbaa !15
  %187 = load i32, ptr %_limitPos.i.i126, align 4, !tbaa !87
  %cmp.i.i253 = icmp eq i32 %186, %187
...
_ZN10COutBuffer9WriteByteEh.exit.i258:            ; preds = %if.then.i.i255, %if.end.i254
  %188 = load i32, ptr %m_BitPos.i123, align 8, !tbaa !85
  %shr.i256 = lshr i32 %value.addr.030.i235, %188
  store i32 8, ptr %m_BitPos.i123, align 8, !tbaa !85
  store i8 0, ptr %m_CurByte11.i124, align 4, !tbaa !86
  %cmp.not.i257 = icmp eq i32 %sub10.i246, 0
  br i1 %cmp.not.i257, label %if.end, label %while.body.i237, !llvm.loop !127
...
if.end:                                           ; preds = %_ZN10COutBuffer9WriteByteEh.exit.i258, %_ZN10COutBuffer9WriteByteEh.exit.i120, %if.end.sink.split, %_ZN10COutBuffer9WriteByteEh.exit.i258.peel, %_ZN10COutBuffer9WriteByteEh.exit.i120.peel, %_ZN12CBitlEncoder9WriteBitsEjj.exit226, %if.then
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %189 = load i32, ptr %m_ValueIndex, align 4, !tbaa !100
  %190 = zext i32 %189 to i64
  %cmp = icmp ult i64 %indvars.iv.next, %190
...
for.cond.cleanup:                                 ; preds = %_ZN12CBitlEncoder9WriteByteEh.exit, %_ZN12CBitlEncoder9FlushByteEv.exit
  ...
  br i1 %cmp2, label %do.end, label %do.body, !llvm.loop !129
...
entry:
  ...
  %1 = load i32, ptr %BlockSizeRes, align 4, !tbaa !131
  ...
  %2 = load i32, ptr %m_Pos, align 4, !tbaa !133
...
for.cond.cleanup:                                 ; preds = %cond.end12, %entry
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(320) %arrayidx, ptr noundef nonnull align 8 dereferenceable(320) %m_NewLevels14, i64 320, i1 false), !tbaa.struct !134
  %m_NumLitLenLevels = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 27
  store i32 286, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21, label %while.cond.1, label %while.end, !llvm.loop !136
...
while.cond.1:                                     ; preds = %for.cond.cleanup
  store i32 285, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.1, label %while.cond.2, label %while.end, !llvm.loop !136

while.cond.2:                                     ; preds = %while.cond.1
  store i32 284, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.2, label %while.cond.3, label %while.end, !llvm.loop !136

while.cond.3:                                     ; preds = %while.cond.2
  store i32 283, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.3, label %while.cond.4, label %while.end, !llvm.loop !136

while.cond.4:                                     ; preds = %while.cond.3
  store i32 282, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.4, label %while.cond.5, label %while.end, !llvm.loop !136

while.cond.5:                                     ; preds = %while.cond.4
  store i32 281, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.5, label %while.cond.6, label %while.end, !llvm.loop !136

while.cond.6:                                     ; preds = %while.cond.5
  store i32 280, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.6, label %while.cond.7, label %while.end, !llvm.loop !136

while.cond.7:                                     ; preds = %while.cond.6
  store i32 279, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.7, label %while.cond.8, label %while.end, !llvm.loop !136

while.cond.8:                                     ; preds = %while.cond.7
  store i32 278, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.8, label %while.cond.9, label %while.end, !llvm.loop !136

while.cond.9:                                     ; preds = %while.cond.8
  store i32 277, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.9, label %while.cond.10, label %while.end, !llvm.loop !136

while.cond.10:                                    ; preds = %while.cond.9
  store i32 276, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.10, label %while.cond.11, label %while.end, !llvm.loop !136

while.cond.11:                                    ; preds = %while.cond.10
  store i32 275, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.11, label %while.cond.12, label %while.end, !llvm.loop !136

while.cond.12:                                    ; preds = %while.cond.11
  store i32 274, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.12, label %while.cond.13, label %while.end, !llvm.loop !136

while.cond.13:                                    ; preds = %while.cond.12
  store i32 273, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.13, label %while.cond.14, label %while.end, !llvm.loop !136

while.cond.14:                                    ; preds = %while.cond.13
  store i32 272, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.14, label %while.cond.15, label %while.end, !llvm.loop !136

while.cond.15:                                    ; preds = %while.cond.14
  store i32 271, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.15, label %while.cond.16, label %while.end, !llvm.loop !136

while.cond.16:                                    ; preds = %while.cond.15
  store i32 270, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.16, label %while.cond.17, label %while.end, !llvm.loop !136

while.cond.17:                                    ; preds = %while.cond.16
  store i32 269, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.17, label %while.cond.18, label %while.end, !llvm.loop !136

while.cond.18:                                    ; preds = %while.cond.17
  store i32 268, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.18, label %while.cond.19, label %while.end, !llvm.loop !136

while.cond.19:                                    ; preds = %while.cond.18
  store i32 267, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.19, label %while.cond.20, label %while.end, !llvm.loop !136

while.cond.20:                                    ; preds = %while.cond.19
  store i32 266, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.20, label %while.cond.21, label %while.end, !llvm.loop !136

while.cond.21:                                    ; preds = %while.cond.20
  store i32 265, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.21, label %while.cond.22, label %while.end, !llvm.loop !136

while.cond.22:                                    ; preds = %while.cond.21
  store i32 264, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.22, label %while.cond.23, label %while.end, !llvm.loop !136

while.cond.23:                                    ; preds = %while.cond.22
  store i32 263, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.23, label %while.cond.24, label %while.end, !llvm.loop !136

while.cond.24:                                    ; preds = %while.cond.23
  store i32 262, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.24, label %while.cond.25, label %while.end, !llvm.loop !136

while.cond.25:                                    ; preds = %while.cond.24
  store i32 261, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.25, label %while.cond.26, label %while.end, !llvm.loop !136

while.cond.26:                                    ; preds = %while.cond.25
  store i32 260, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.26, label %while.cond.27, label %while.end, !llvm.loop !136

while.cond.27:                                    ; preds = %while.cond.26
  store i32 259, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br i1 %cmp21.27, label %while.cond.28, label %while.end, !llvm.loop !136

while.cond.28:                                    ; preds = %while.cond.27
  store i32 258, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  br label %while.end, !llvm.loop !136
...
while.end:                                        ; preds = %while.cond.28, %while.cond.27, %while.cond.26, %while.cond.25, %while.cond.24, %while.cond.23, %while.cond.22, %while.cond.21, %while.cond.20, %while.cond.19, %while.cond.18, %while.cond.17, %while.cond.16, %while.cond.15, %while.cond.14, %while.cond.13, %while.cond.12, %while.cond.11, %while.cond.10, %while.cond.9, %while.cond.8, %while.cond.7, %while.cond.6, %while.cond.5, %while.cond.4, %while.cond.3, %while.cond.2, %while.cond.1, %for.cond.cleanup
  ...
  store i32 32, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33, label %while.cond23.1, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.1:                                   ; preds = %while.end
  store i32 31, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.1, label %while.cond23.2, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.2:                                   ; preds = %while.cond23.1
  store i32 30, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.2, label %while.cond23.3, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.3:                                   ; preds = %while.cond23.2
  store i32 29, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.3, label %while.cond23.4, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.4:                                   ; preds = %while.cond23.3
  store i32 28, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.4, label %while.cond23.5, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.5:                                   ; preds = %while.cond23.4
  store i32 27, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.5, label %while.cond23.6, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.6:                                   ; preds = %while.cond23.5
  store i32 26, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.6, label %while.cond23.7, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.7:                                   ; preds = %while.cond23.6
  store i32 25, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.7, label %while.cond23.8, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.8:                                   ; preds = %while.cond23.7
  store i32 24, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.8, label %while.cond23.9, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.9:                                   ; preds = %while.cond23.8
  store i32 23, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.9, label %while.cond23.10, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.10:                                  ; preds = %while.cond23.9
  store i32 22, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.10, label %while.cond23.11, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.11:                                  ; preds = %while.cond23.10
  store i32 21, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.11, label %while.cond23.12, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.12:                                  ; preds = %while.cond23.11
  store i32 20, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.12, label %while.cond23.13, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.13:                                  ; preds = %while.cond23.12
  store i32 19, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.13, label %while.cond23.14, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.14:                                  ; preds = %while.cond23.13
  store i32 18, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.14, label %while.cond23.15, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.15:                                  ; preds = %while.cond23.14
  store i32 17, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.15, label %while.cond23.16, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.16:                                  ; preds = %while.cond23.15
  store i32 16, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.16, label %while.cond23.17, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.17:                                  ; preds = %while.cond23.16
  store i32 15, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.17, label %while.cond23.18, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.18:                                  ; preds = %while.cond23.17
  store i32 14, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.18, label %while.cond23.19, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.19:                                  ; preds = %while.cond23.18
  store i32 13, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.19, label %while.cond23.20, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.20:                                  ; preds = %while.cond23.19
  store i32 12, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.20, label %while.cond23.21, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.21:                                  ; preds = %while.cond23.20
  store i32 11, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.21, label %while.cond23.22, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.22:                                  ; preds = %while.cond23.21
  store i32 10, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.22, label %while.cond23.23, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.23:                                  ; preds = %while.cond23.22
  store i32 9, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.23, label %while.cond23.24, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.24:                                  ; preds = %while.cond23.23
  store i32 8, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.24, label %while.cond23.25, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.25:                                  ; preds = %while.cond23.24
  store i32 7, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.25, label %while.cond23.26, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.26:                                  ; preds = %while.cond23.25
  store i32 6, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.26, label %while.cond23.27, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.27:                                  ; preds = %while.cond23.26
  store i32 5, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.27, label %while.cond23.28, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.28:                                  ; preds = %while.cond23.27
  store i32 4, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.28, label %while.cond23.29, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.29:                                  ; preds = %while.cond23.28
  store i32 3, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br i1 %cmp33.29, label %while.cond23.30, label %for.body.lr.ph.i, !llvm.loop !139

while.cond23.30:                                  ; preds = %while.cond23.29
  store i32 2, ptr %m_NumDistLevels, align 4, !tbaa !138
  ...
  br label %for.body.lr.ph.i, !llvm.loop !139
...
if.end.3:                                         ; preds = %cleanup.i153
  ...
  store i32 4, ptr %m_NumLevelCodes, align 8, !tbaa !140
...
if.then.4:                                        ; preds = %if.end.3
  store i32 5, ptr %m_NumLevelCodes, align 8, !tbaa !140
  br label %if.end.4
...
if.then.5:                                        ; preds = %if.end.4
  store i32 6, ptr %m_NumLevelCodes, align 8, !tbaa !140
  br label %if.end.5
...
if.then.6:                                        ; preds = %if.end.5
  store i32 7, ptr %m_NumLevelCodes, align 8, !tbaa !140
  br label %if.end.6
...
if.then.7:                                        ; preds = %if.end.6
  store i32 8, ptr %m_NumLevelCodes, align 8, !tbaa !140
  br label %if.end.7
...
if.then.8:                                        ; preds = %if.end.7
  store i32 9, ptr %m_NumLevelCodes, align 8, !tbaa !140
  br label %if.end.8
...
if.then.9:                                        ; preds = %if.end.8
  store i32 10, ptr %m_NumLevelCodes, align 8, !tbaa !140
  br label %if.end.9
...
if.then.10:                                       ; preds = %if.end.9
  store i32 11, ptr %m_NumLevelCodes, align 8, !tbaa !140
  br label %if.end.10
...
if.then.11:                                       ; preds = %if.end.10
  store i32 12, ptr %m_NumLevelCodes, align 8, !tbaa !140
  br label %if.end.11
...
if.then.12:                                       ; preds = %if.end.11
  store i32 13, ptr %m_NumLevelCodes, align 8, !tbaa !140
  br label %if.end.12
...
if.then.13:                                       ; preds = %if.end.12
  store i32 14, ptr %m_NumLevelCodes, align 8, !tbaa !140
  br label %if.end.13
...
if.then.14:                                       ; preds = %if.end.13
  store i32 15, ptr %m_NumLevelCodes, align 8, !tbaa !140
  br label %if.end.14
...
if.then.15:                                       ; preds = %if.end.14
  store i32 16, ptr %m_NumLevelCodes, align 8, !tbaa !140
  br label %if.end.15
...
if.then.16:                                       ; preds = %if.end.15
  store i32 17, ptr %m_NumLevelCodes, align 8, !tbaa !140
  br label %if.end.16
...
if.then.17:                                       ; preds = %if.end.16
  store i32 18, ptr %m_NumLevelCodes, align 8, !tbaa !140
  br label %if.end.17
...
if.then.18:                                       ; preds = %if.end.17
  store i32 19, ptr %m_NumLevelCodes, align 8, !tbaa !140
  br label %if.end.18
...
if.end.18:                                        ; preds = %if.then.18, %if.end.17
  ...
  %116 = load i32, ptr %m_NumLevelCodes, align 8, !tbaa !140
  %mul = mul i32 %116, 3
...
entry:
  ...
  %uglygep.i = getelementptr %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39, i32 0, i64 144
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(112) %uglygep.i, i8 9, i64 112, i1 false), !tbaa !5
  %uglygep62.i = getelementptr %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39, i32 0, i64 256
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %uglygep62.i, i8 7, i64 24, i1 false), !tbaa !5
  %uglygep64.i = getelementptr %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39, i32 0, i64 280
  store i64 578721382704613384, ptr %uglygep64.i, align 8
  %uglygep66.i = getelementptr %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %uglygep66.i, i8 5, i64 32, i1 false), !tbaa !5
...
entry:
  ...
  store i8 0, ptr %StaticMode, align 2, !tbaa !141
  %m_NumPasses = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 12
  ...
  store i32 %2, ptr %BlockSizeRes2, align 4, !tbaa !131
  %m_ValueIndex = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 30
  ...
  %6 = load i8, ptr %m_CheckStatic, align 4, !tbaa !142, !range !45, !noundef !46
...
if.then:                                          ; preds = %entry
  ...
  %8 = load i32, ptr %BlockSizeRes.i, align 4, !tbaa !131
  ...
  %9 = load i32, ptr %m_Pos.i, align 4, !tbaa !133
  ...
  %uglygep.i.i = getelementptr %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39, i32 0, i64 144
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(112) %uglygep.i.i, i8 9, i64 112, i1 false), !tbaa !5
  %uglygep62.i.i = getelementptr %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39, i32 0, i64 256
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %uglygep62.i.i, i8 7, i64 24, i1 false), !tbaa !5
  %uglygep64.i.i = getelementptr %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39, i32 0, i64 280
  store i64 578721382704613384, ptr %uglygep64.i.i, align 8
  %uglygep66.i.i = getelementptr %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %uglygep66.i.i, i8 5, i64 32, i1 false), !tbaa !5
  tail call void @_ZN9NCompress8NDeflate8NEncoder6CCoder9SetPricesERKNS0_7CLevelsE(ptr noundef nonnull align 8 dereferenceable(39764) %this, ptr noundef nonnull align 1 dereferenceable(320) %m_NewLevels.i)
  tail call void @_ZN9NCompress8NDeflate8NEncoder6CCoder8TryBlockEv(ptr noundef nonnull align 8 dereferenceable(39764) %this)
  ...
  store i8 %frombool, ptr %StaticMode, align 2, !tbaa !141
...
do.body.i:                                        ; preds = %do.body.i, %if.end10
  ...
  br i1 %cmp12.not.i, label %_ZN9NCompress8NDeflate8NEncoderL13GetStorePriceEji.exit, label %do.body.i, !llvm.loop !143
...
_ZN9NCompress8NDeflate8NEncoderL13GetStorePriceEji.exit: ; preds = %do.body.i
  ...
  store i8 %frombool14, ptr %StoreMode, align 1, !tbaa !144
  ...
  store i8 0, ptr %UseSubBlocks, align 4, !tbaa !145
...
if.then22:                                        ; preds = %_ZN9NCompress8NDeflate8NEncoderL13GetStorePriceEji.exit
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(320) %arrayidx25, ptr noundef nonnull align 4 dereferenceable(320) %arrayidx, i64 320, i1 false), !tbaa.struct !134
  %12 = load i32, ptr %BlockSizeRes2, align 4, !tbaa !131
  %shr = lshr i32 %12, 1
  %BlockSizeRes27 = getelementptr inbounds %"struct.NCompress::NDeflate::NEncoder::CTables", ptr %11, i64 %idxprom24, i32 4
  store i32 %shr, ptr %BlockSizeRes27, align 4, !tbaa !131
  %m_Pos28 = getelementptr inbounds %"struct.NCompress::NDeflate::NEncoder::CTables", ptr %0, i64 %idxprom, i32 5
  %13 = load i32, ptr %m_Pos28, align 4, !tbaa !133
  %m_Pos29 = getelementptr inbounds %"struct.NCompress::NDeflate::NEncoder::CTables", ptr %11, i64 %idxprom24, i32 5
  store i32 %13, ptr %m_Pos29, align 4, !tbaa !133
  ...
  %14 = load i32, ptr %BlockSizeRes2, align 4, !tbaa !131
  %15 = load i32, ptr %BlockSizeRes27, align 4, !tbaa !131
  %sub34 = sub i32 %14, %15
...
if.then39:                                        ; preds = %if.then22
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(320) %arrayidx43, ptr noundef nonnull align 4 dereferenceable(320) %arrayidx, i64 320, i1 false), !tbaa.struct !134
  %BlockSizeRes44 = getelementptr inbounds %"struct.NCompress::NDeflate::NEncoder::CTables", ptr %16, i64 %idxprom42, i32 4
  store i32 %sub34, ptr %BlockSizeRes44, align 4, !tbaa !131
  ...
  store i32 %17, ptr %m_Pos46, align 4, !tbaa !133
  %18 = load i32, ptr %BlockSizeRes27, align 4, !tbaa !131
  ...
  store i8 %frombool57, ptr %UseSubBlocks, align 4, !tbaa !145
...
entry:
  ...
  %1 = load i8, ptr %UseSubBlocks93, align 4, !tbaa !145, !range !45, !noundef !46
...
if.then:                                          ; preds = %entry, %if.then
  ...
  %3 = load i8, ptr %UseSubBlocks, align 4, !tbaa !145, !range !45, !noundef !46
...
if.else:                                          ; preds = %if.then, %entry
  ...
  %4 = load i8, ptr %StoreMode, align 1, !tbaa !144, !range !45, !noundef !46
...
if.then5:                                         ; preds = %if.else
  ...
  %5 = load i32, ptr %BlockSizeRes, align 4, !tbaa !131
  %m_AdditionalOffset = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 33
...
if.else7:                                         ; preds = %if.else
  ...
  %7 = load i8, ptr %StaticMode, align 2, !tbaa !141, !range !45, !noundef !46
...
if.then10:                                        ; preds = %if.else7
  ...
  %9 = load i32, ptr %BlockSizeRes.i, align 4, !tbaa !131
  ...
  %10 = load i32, ptr %m_Pos.i, align 4, !tbaa !133
...
for.body:                                         ; preds = %for.body, %if.then10
  ...
  br i1 %exitcond.not.3, label %for.body18.preheader, label %for.body, !llvm.loop !146

for.body18.preheader:                             ; preds = %for.body
  %15 = load i8, ptr %uglygep66.i.i, align 8, !tbaa !5
  ...
  %distCodes.i = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 43
  tail call void @Huffman_Generate(ptr noundef nonnull %arrayidx26, ptr noundef nonnull %distCodes.i, ptr noundef nonnull %uglygep66.i.i, i32 noundef 32, i32 noundef 9)
  br label %if.end66
...
if.end:                                           ; preds = %if.else30, %if.then33
  ...
  %m_NumLitLenLevels = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 27
  %49 = load i32, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  ...
  %m_NumDistLevels = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 28
  %50 = load i32, ptr %m_NumDistLevels, align 4, !tbaa !138
  %sub36 = add i32 %50, -1
  ...
  %m_NumLevelCodes = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 29
  %51 = load i32, ptr %m_NumLevelCodes, align 8, !tbaa !140
  %sub37 = add i32 %51, -4
  ...
  %52 = load i32, ptr %m_NumLevelCodes, align 8, !tbaa !140
...
for.cond.cleanup:                                 ; preds = %for.body42, %if.end
  %levelCodes = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 44
  %levelLens = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 45
  %53 = load <4 x i32>, ptr %levelCodes, align 8, !tbaa !53
  %54 = trunc <4 x i32> %53 to <4 x i16>
  %55 = tail call <4 x i16> @llvm.bitreverse.v4i16(<4 x i16> %54)
  %56 = zext <4 x i16> %55 to <4 x i32>
  %57 = load <4 x i8>, ptr %levelLens, align 4, !tbaa !5
  %58 = zext <4 x i8> %57 to <4 x i32>
  %59 = sub nsw <4 x i32> <i32 16, i32 16, i32 16, i32 16>, %58
  %60 = lshr <4 x i32> %56, %59
  store <4 x i32> %60, ptr %levelCodes, align 8, !tbaa !53
  %arrayidx.i.4 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 44, i64 4
  %arrayidx18.i.4 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 45, i64 4
  %61 = load <4 x i32>, ptr %arrayidx.i.4, align 8, !tbaa !53
  %62 = trunc <4 x i32> %61 to <4 x i16>
  %63 = tail call <4 x i16> @llvm.bitreverse.v4i16(<4 x i16> %62)
  %64 = zext <4 x i16> %63 to <4 x i32>
  %65 = load <4 x i8>, ptr %arrayidx18.i.4, align 8, !tbaa !5
  %66 = zext <4 x i8> %65 to <4 x i32>
  %67 = sub nsw <4 x i32> <i32 16, i32 16, i32 16, i32 16>, %66
  %68 = lshr <4 x i32> %64, %67
  store <4 x i32> %68, ptr %arrayidx.i.4, align 8, !tbaa !53
  %arrayidx.i.8 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 44, i64 8
  %arrayidx18.i.8 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 45, i64 8
  %69 = load <4 x i32>, ptr %arrayidx.i.8, align 8, !tbaa !53
  %70 = trunc <4 x i32> %69 to <4 x i16>
  %71 = tail call <4 x i16> @llvm.bitreverse.v4i16(<4 x i16> %70)
  %72 = zext <4 x i16> %71 to <4 x i32>
  %73 = load <4 x i8>, ptr %arrayidx18.i.8, align 4, !tbaa !5
  %74 = zext <4 x i8> %73 to <4 x i32>
  %75 = sub nsw <4 x i32> <i32 16, i32 16, i32 16, i32 16>, %74
  %76 = lshr <4 x i32> %72, %75
  store <4 x i32> %76, ptr %arrayidx.i.8, align 8, !tbaa !53
  %arrayidx.i.12 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 44, i64 12
  %arrayidx18.i.12 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 45, i64 12
  %77 = load <4 x i32>, ptr %arrayidx.i.12, align 8, !tbaa !53
  %78 = trunc <4 x i32> %77 to <4 x i16>
  %79 = tail call <4 x i16> @llvm.bitreverse.v4i16(<4 x i16> %78)
  %80 = zext <4 x i16> %79 to <4 x i32>
  %81 = load <4 x i8>, ptr %arrayidx18.i.12, align 8, !tbaa !5
  %82 = zext <4 x i8> %81 to <4 x i32>
  %83 = sub nsw <4 x i32> <i32 16, i32 16, i32 16, i32 16>, %82
  %84 = lshr <4 x i32> %80, %83
  store <4 x i32> %84, ptr %arrayidx.i.12, align 8, !tbaa !53
  %arrayidx.i.16 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 44, i64 16
  %85 = load i32, ptr %arrayidx.i.16, align 8, !tbaa !53
  %trunc.i.16 = trunc i32 %85 to i16
  %rev.i.16 = tail call i16 @llvm.bitreverse.i16(i16 %trunc.i.16)
  %or16.i.16 = zext i16 %rev.i.16 to i32
  %arrayidx18.i.16 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 45, i64 16
  %86 = load i8, ptr %arrayidx18.i.16, align 4, !tbaa !5
  %conv.i.16 = zext i8 %86 to i32
  %sub.i.16 = sub nsw i32 16, %conv.i.16
  %shr19.i.16 = lshr i32 %or16.i.16, %sub.i.16
  store i32 %shr19.i.16, ptr %arrayidx.i.16, align 8, !tbaa !53
  %arrayidx.i.17 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 44, i64 17
  %87 = load i32, ptr %arrayidx.i.17, align 4, !tbaa !53
  %trunc.i.17 = trunc i32 %87 to i16
  %rev.i.17 = tail call i16 @llvm.bitreverse.i16(i16 %trunc.i.17)
  %or16.i.17 = zext i16 %rev.i.17 to i32
  %arrayidx18.i.17 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 45, i64 17
  %88 = load i8, ptr %arrayidx18.i.17, align 1, !tbaa !5
  %conv.i.17 = zext i8 %88 to i32
  %sub.i.17 = sub nsw i32 16, %conv.i.17
  %shr19.i.17 = lshr i32 %or16.i.17, %sub.i.17
  store i32 %shr19.i.17, ptr %arrayidx.i.17, align 4, !tbaa !53
  %arrayidx.i.18 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 44, i64 18
  %89 = load i32, ptr %arrayidx.i.18, align 8, !tbaa !53
  %trunc.i.18 = trunc i32 %89 to i16
  %rev.i.18 = tail call i16 @llvm.bitreverse.i16(i16 %trunc.i.18)
  %or16.i.18 = zext i16 %rev.i.18 to i32
  %arrayidx18.i.18 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 45, i64 18
  %90 = load i8, ptr %arrayidx18.i.18, align 2, !tbaa !5
  %conv.i.18 = zext i8 %90 to i32
  %sub.i.18 = sub nsw i32 16, %conv.i.18
  %shr19.i.18 = lshr i32 %or16.i.18, %sub.i.18
  store i32 %shr19.i.18, ptr %arrayidx.i.18, align 8, !tbaa !53
  %m_NewLevels50 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39
  %91 = load i32, ptr %m_NumLitLenLevels, align 8, !tbaa !135
  tail call void @_ZN9NCompress8NDeflate8NEncoder6CCoder14LevelTableCodeEPKhiS4_PKj(ptr noundef nonnull align 8 dereferenceable(39764) %this, ptr noundef nonnull %m_NewLevels50, i32 noundef %91, ptr noundef nonnull %levelLens, ptr noundef nonnull %levelCodes)
  %distLevels59 = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 39, i32 1
  %92 = load i32, ptr %m_NumDistLevels, align 4, !tbaa !138
  tail call void @_ZN9NCompress8NDeflate8NEncoder6CCoder14LevelTableCodeEPKhiS4_PKj(ptr noundef nonnull align 8 dereferenceable(39764) %this, ptr noundef nonnull %distLevels59, i32 noundef %92, ptr noundef nonnull %levelLens, ptr noundef nonnull %levelCodes)
  br label %if.end66
...
for.body42:                                       ; preds = %if.end, %for.body42
  ...
  %93 = load i8, ptr %arrayidx44, align 1, !tbaa !5
  %conv45 = zext i8 %93 to i32
  ...
  %94 = load i32, ptr %m_NumLevelCodes, align 8, !tbaa !140
  %95 = zext i32 %94 to i64
  %cmp41 = icmp ult i64 %indvars.iv.next110, %95
  br i1 %cmp41, label %for.body42, label %for.cond.cleanup, !llvm.loop !147
...
entry:
  ...
  %0 = load i64, ptr %size, align 8, !tbaa !148
  ...
  store i64 %conv2, ptr %size, align 8, !tbaa !148
...
entry:
  ...
  %m_NumPasses = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 12
  %2 = load i32, ptr %m_NumPasses, align 4, !tbaa !29
  ...
  store i8 %frombool, ptr %m_CheckStatic, align 4, !tbaa !142
  %m_IsMultiPass = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 15
  store i8 %frombool, ptr %m_IsMultiPass, align 1, !tbaa !44
  %call = tail call noundef i32 @_ZN9NCompress8NDeflate8NEncoder6CCoder6CreateEv(ptr noundef nonnull align 8 dereferenceable(39764) %this), !range !149
...
cleanup.cont:                                     ; preds = %entry
  ...
  %m_ValueBlockSize = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 17
  store i32 %add, ptr %m_ValueBlockSize, align 8, !tbaa !150
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %nowPos) #22
  store i64 0, ptr %nowPos, align 8, !tbaa !151
...
_ZN9CMyComPtrI19ISequentialInStreamEaSEPS0_.exit: ; preds = %if.end.i, %if.then2.i
  ...
  store ptr @_ZN9NCompress8NDeflate8NEncoder4ReadEPvS2_Pm, ptr %_seqInStream, align 8, !tbaa !152
  %stream = getelementptr inbounds %struct._CMatchFinder, ptr %this, i64 0, i32 13
  store ptr %_seqInStream, ptr %stream, align 8, !tbaa !153
  ...
  store ptr %this, ptr %coderReleaser, align 8, !tbaa !154
  %m_OptimumCurrentIndex = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 35
  store i32 0, ptr %m_OptimumCurrentIndex, align 4, !tbaa !76
  %m_OptimumEndIndex = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 34
  store i32 0, ptr %m_OptimumEndIndex, align 8, !tbaa !71
  ...
  store i32 0, ptr %m_Pos, align 4, !tbaa !133
  ...
  %uglygep.i = getelementptr %"struct.NCompress::NDeflate::NEncoder::CTables", ptr %9, i64 1, i32 0, i32 0, i64 257
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(63) %uglygep.i, i8 5, i64 63, i1 false)
  %m_AdditionalOffset = getelementptr inbounds %"class.NCompress::NDeflate::NEncoder::CCoder", ptr %this, i64 0, i32 33
...
do.body.us:                                       ; preds = %_ZN9CMyComPtrI19ISequentialInStreamEaSEPS0_.exit, %invoke.cont27.us
  ...
  store i32 60923, ptr %BlockSizeRes, align 4, !tbaa !131
...
invoke.cont27:                                    ; preds = %invoke.cont
  ...
  %22 = load i32, ptr %BlockSizeRes30, align 4, !tbaa !131
  %conv = zext i32 %22 to i64
  %23 = load i64, ptr %nowPos, align 8, !tbaa !151
  %add31 = add i64 %23, %conv
  store i64 %add31, ptr %nowPos, align 8, !tbaa !151
...
invoke.cont36:                                    ; preds = %invoke.cont27
  ...
  store i64 %add2.i, ptr %packSize, align 8, !tbaa !151
...
_ZN12CBitlEncoder9FlushByteEv.exit.i.cleanup67_crit_edge: ; preds = %_ZN12CBitlEncoder9FlushByteEv.exit.i
  %.pre = load ptr, ptr %coderReleaser, align 8, !tbaa !154
  br label %cleanup67
...
define dso_local noundef i32 @_ZThn8_N9NCompress8NDeflate8NEncoder9CCOMCoder18SetCoderPropertiesEPKjPK14tagPROPVARIANTj(ptr nocapture noundef %this, ptr nocapture noundef readonly %propIDs, ptr nocapture noundef readonly %props, i32 noundef %numProps) unnamed_addr #16 align 2 {
entry:
...
; Function Attrs: nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable
define dso_local noundef i32 @_ZThn8_N9NCompress8NDeflate8NEncoder11CCOMCoder6418SetCoderPropertiesEPKjPK14tagPROPVARIANTj(ptr nocapture noundef %this, ptr nocapture noundef readonly %propIDs, ptr nocapture noundef readonly %props, i32 noundef %numProps) unnamed_addr #16 align 2 {
entry:
  %add.ptr.i = getelementptr inbounds i8, ptr %this, i64 16
  %call.i = tail call noundef i32 @_ZN9NCompress8NDeflate8NEncoder6CCoder25BaseSetEncoderProperties2EPKjPK14tagPROPVARIANTj(ptr noundef nonnull align 8 dereferenceable(39764) %add.ptr.i, ptr noundef %propIDs, ptr noundef %props, i32 noundef %numProps)
  ret i32 %call.i
...
define linkonce_odr dso_local noundef i32 @_ZN9NCompress8NDeflate8NEncoder9CCOMCoder6AddRefEv(ptr noundef nonnull align 8 dereferenceable(39788) %this) unnamed_addr #17 comdat align 2 {
entry:
  %add.ptr = getelementptr inbounds i8, ptr %this, i64 16
  %0 = load i32, ptr %add.ptr, align 8, !tbaa !160
  %inc = add i32 %0, 1
  store i32 %inc, ptr %add.ptr, align 8, !tbaa !160
  ret i32 %inc
}

; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local noundef i32 @_ZN9NCompress8NDeflate8NEncoder9CCOMCoder7ReleaseEv(ptr noundef nonnull align 8 dereferenceable(39788) %this) unnamed_addr #17 comdat align 2 {
entry:
  %add.ptr = getelementptr inbounds i8, ptr %this, i64 16
  %0 = load i32, ptr %add.ptr, align 8, !tbaa !160
  %dec = add i32 %0, -1
  store i32 %dec, ptr %add.ptr, align 8, !tbaa !160
...
entry:
  ...
  %0 = load i32, ptr %add.ptr.i, align 8, !tbaa !160
  %inc.i = add i32 %0, 1
  store i32 %inc.i, ptr %add.ptr.i, align 8, !tbaa !160
  ret i32 %inc.i
}
...
entry:
  ...
  %0 = load i32, ptr %add.ptr.i, align 8, !tbaa !160
  %dec.i = add i32 %0, -1
  store i32 %dec.i, ptr %add.ptr.i, align 8, !tbaa !160
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local noundef i32 @_ZN9NCompress8NDeflate8NEncoder11CCOMCoder646AddRefEv(ptr noundef nonnull align 8 dereferenceable(39788) %this) unnamed_addr #17 comdat align 2 {
entry:
  %add.ptr = getelementptr inbounds i8, ptr %this, i64 16
  %0 = load i32, ptr %add.ptr, align 8, !tbaa !160
  %inc = add i32 %0, 1
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local noundef i32 @_ZN9NCompress8NDeflate8NEncoder11CCOMCoder647ReleaseEv(ptr noundef nonnull align 8 dereferenceable(39788) %this) unnamed_addr #17 comdat align 2 {
entry:
  %add.ptr = getelementptr inbounds i8, ptr %this, i64 16
  %0 = load i32, ptr %add.ptr, align 8, !tbaa !160
  %dec = add i32 %0, -1
...
declare i16 @llvm.bitreverse.i16(i16) #19
...
; Function Attrs: nocallback nofree nosync nounwind speculatable willreturn memory(none)
declare <4 x i16> @llvm.bitreverse.v4i16(<4 x i16>) #19
...
attributes #9 = { mustprogress nofree norecurse nosync nounwind memory(argmem: write) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #14 = { mustprogress nofree nosync nounwind memory(argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #15 = { mustprogress nocallback nofree nounwind willreturn memory(argmem: readwrite) }
attributes #16 = { nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!130 = distinct !{!130, !58}
!131 = !{!132, !11, i64 324}
!132 = !{!"_ZTSN9NCompress8NDeflate8NEncoder7CTablesE", !26, i64 0, !14, i64 320, !14, i64 321, !14, i64 322, !11, i64 324, !11, i64 328}
!133 = !{!132, !11, i64 328}
!134 = !{i64 0, i64 288, !5, i64 288, i64 32, !5}
!135 = !{!19, !11, i64 1360}
!136 = distinct !{!136, !58}
!137 = distinct !{!137, !58}
!138 = !{!19, !11, i64 1364}
