; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Benchmarks/BenchmarkGame/fannkuch.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Benchmarks/BenchmarkGame/fannkuch.c"
...
entry:
  ...
  %uglygep.i = getelementptr i8, ptr %call.i, i64 4
...
for.body44.preheader.i:                           ; preds = %lor.lhs.false.i
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(40) %uglygep.i, ptr noundef nonnull align 4 dereferenceable(40) %arrayidx.1.i, i64 40, i1 false), !tbaa !5
  br label %do.body.i
