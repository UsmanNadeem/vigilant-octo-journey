; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SIBsim4/sim4.init.c"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4160, ptr nonnull %seq1) #19
  call void @llvm.lifetime.start.p0(i64 4160, ptr nonnull %seq2) #19
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %he) #19
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %res) #19
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %rev_res) #19
  %0 = load ptr, ptr %argv, align 8, !tbaa !5
  store ptr %0, ptr @argv0, align 8, !tbaa !5
  %call = tail call ptr @setlocale(i32 noundef 6, ptr noundef nonnull @.str) #19
...
if.then:                                          ; preds = %entry
  ...
  %call2 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str.1, ptr noundef %2) #20
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %call3 = tail call ptr @signal(i32 noundef 11, ptr noundef nonnull @bug_handler) #19
  %call4 = tail call ptr @signal(i32 noundef 7, ptr noundef nonnull @bug_handler) #19
...
while.cond:                                       ; preds = %while.cond.backedge, %if.end
  %call5 = tail call i32 @getopt(i32 noundef %argc, ptr noundef nonnull %argv, ptr noundef nonnull @.str.3) #19
...
sw.bb:                                            ; preds = %while.cond
  ...
  %call.i = tail call i64 @strtol(ptr nocapture noundef nonnull %3, ptr noundef null, i32 noundef 10) #19
...
if.then12:                                        ; preds = %sw.bb
  tail call void (ptr, ...) @fatal(ptr noundef nonnull @.str.4) #21
  unreachable

sw.bb14:                                          ; preds = %while.cond
  %4 = load ptr, ptr @optarg, align 8, !tbaa !5
  %call.i342 = tail call i64 @strtol(ptr nocapture noundef nonnull %4, ptr noundef null, i32 noundef 10) #19
  %conv.i343 = trunc i64 %call.i342 to i32
  %cmp16 = icmp slt i32 %conv.i343, 0
  br i1 %cmp16, label %if.then17, label %if.end18

if.then17:                                        ; preds = %sw.bb14
  tail call void (ptr, ...) @fatal(ptr noundef nonnull @.str.5) #21
  unreachable
...
sw.bb19:                                          ; preds = %while.cond
  ...
  %call.i344 = tail call i64 @strtol(ptr nocapture noundef nonnull %5, ptr noundef null, i32 noundef 10) #19
  %conv.i345 = trunc i64 %call.i344 to i32
  %cmp22 = icmp slt i32 %conv.i345, 0
  br i1 %cmp22, label %if.then23, label %if.end24

if.then23:                                        ; preds = %sw.bb19
  tail call void (ptr, ...) @fatal(ptr noundef nonnull @.str.6) #21
  unreachable
...
sw.bb25:                                          ; preds = %while.cond
  ...
  %call.i346 = tail call i64 @strtol(ptr nocapture noundef nonnull %6, ptr noundef null, i32 noundef 10) #19
...
if.then30:                                        ; preds = %sw.bb25
  tail call void (ptr, ...) @fatal(ptr noundef nonnull @.str.7) #21
  unreachable

sw.bb32:                                          ; preds = %while.cond
  %8 = load ptr, ptr @optarg, align 8, !tbaa !5
  %call.i348 = tail call i64 @strtol(ptr nocapture noundef nonnull %8, ptr noundef null, i32 noundef 10) #19
...
if.then35:                                        ; preds = %sw.bb32
  tail call void (ptr, ...) @fatal(ptr noundef nonnull @.str.8) #21
  unreachable

sw.bb37:                                          ; preds = %while.cond
  %9 = load ptr, ptr @optarg, align 8, !tbaa !5
  %call.i350 = tail call i64 @strtol(ptr nocapture noundef nonnull %9, ptr noundef null, i32 noundef 10) #19
...
sw.bb39:                                          ; preds = %while.cond
  ...
  %call.i352 = tail call i64 @strtol(ptr nocapture noundef nonnull %10, ptr noundef null, i32 noundef 10) #19
...
sw.bb41:                                          ; preds = %while.cond
  ...
  %call.i354 = tail call i64 @strtol(ptr nocapture noundef nonnull %11, ptr noundef null, i32 noundef 10) #19
  %conv.i355 = trunc i64 %call.i354 to i32
  %cmp44 = icmp slt i32 %conv.i355, 0
  br i1 %cmp44, label %if.then45, label %if.end46

if.then45:                                        ; preds = %sw.bb41
  tail call void (ptr, ...) @fatal(ptr noundef nonnull @.str.9) #21
  unreachable
...
sw.bb47:                                          ; preds = %while.cond
  ...
  %call48 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %12) #22
...
if.then50:                                        ; preds = %sw.bb47
  tail call void (ptr, ...) @fatal(ptr noundef nonnull @.str.10, i64 noundef %call48) #21
  unreachable
...
if.then59:                                        ; preds = %if.then55
  ...
  tail call void (ptr, ...) @fatal(ptr noundef nonnull @.str.11, i32 noundef %conv, i64 noundef %i.0403) #21
  unreachable
...
if.then81:                                        ; preds = %if.else
  ...
  tail call void (ptr, ...) @fatal(ptr noundef nonnull @.str.12, i32 noundef %conv64, i64 noundef %i.0403) #21
  unreachable
...
sw.bb86:                                          ; preds = %while.cond
  ...
  %call.i356 = tail call i64 @strtol(ptr nocapture noundef nonnull %14, ptr noundef null, i32 noundef 10) #19
  %conv.i357 = trunc i64 %call.i356 to i32
  %cmp89 = icmp slt i32 %conv.i357, 0
  br i1 %cmp89, label %if.then91, label %if.end92

if.then91:                                        ; preds = %sw.bb86
  tail call void (ptr, ...) @fatal(ptr noundef nonnull @.str.13) #21
  unreachable
...
sw.bb93:                                          ; preds = %while.cond
  ...
  %call.i358 = tail call i64 @strtol(ptr nocapture noundef nonnull %15, ptr noundef null, i32 noundef 10) #19
...
sw.bb95:                                          ; preds = %while.cond
  ...
  %call.i360 = tail call i64 @strtol(ptr nocapture noundef nonnull %16, ptr noundef null, i32 noundef 10) #19
...
sw.bb97:                                          ; preds = %while.cond
  ...
  %call.i362 = tail call i64 @strtol(ptr nocapture noundef nonnull %17, ptr noundef null, i32 noundef 10) #19
...
if.then104:                                       ; preds = %sw.bb97
  tail call void (ptr, ...) @fatal(ptr noundef nonnull @.str.14) #21
  unreachable

sw.bb106:                                         ; preds = %while.cond
  %18 = load ptr, ptr @optarg, align 8, !tbaa !5
  %call.i364 = tail call i64 @strtol(ptr nocapture noundef nonnull %18, ptr noundef null, i32 noundef 10) #19
...
sw.bb108:                                         ; preds = %while.cond
  ...
  %call.i366 = tail call i64 @strtol(ptr nocapture noundef nonnull %19, ptr noundef null, i32 noundef 10) #19
...
if.then115:                                       ; preds = %sw.bb108
  tail call void (ptr, ...) @fatal(ptr noundef nonnull @.str.15) #21
  unreachable

sw.bb117:                                         ; preds = %while.cond
  %21 = load ptr, ptr @optarg, align 8, !tbaa !5
  %call.i368 = tail call i64 @strtol(ptr nocapture noundef nonnull %21, ptr noundef null, i32 noundef 10) #19
...
if.then121:                                       ; preds = %sw.bb117
  tail call void (ptr, ...) @fatal(ptr noundef nonnull @.str.16) #21
  unreachable

sw.default:                                       ; preds = %while.cond
  %22 = load ptr, ptr @stderr, align 8, !tbaa !5
  %call123 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %22, ptr noundef nonnull @.str.17, i32 noundef %call5) #20
  br label %while.cond.backedge
...
if.end130:                                        ; preds = %while.end
  ...
  %call132 = call fastcc i32 @get_next_seq(ptr noundef nonnull %seq1, i32 noundef %43, i32 noundef 1)
...
if.then135:                                       ; preds = %if.end130
  ...
  tail call void (ptr, ...) @fatal(ptr noundef nonnull @.str.18, ptr noundef %45) #21
  unreachable

if.end138:                                        ; preds = %if.end130
  %header = getelementptr inbounds %struct._seq_t, ptr %seq1, i64 0, i32 1
  %46 = load ptr, ptr %header, align 8, !tbaa !32
  %call139 = tail call ptr @strncpy(ptr noundef nonnull dereferenceable(1) @dna_seq_head, ptr noundef nonnull dereferenceable(1) %46, i64 noundef 256) #19
  ...
  %call143 = call fastcc i32 @get_next_seq(ptr noundef nonnull %seq2, i32 noundef 0, i32 noundef 0)
...
if.then146:                                       ; preds = %if.end138
  ...
  tail call void (ptr, ...) @fatal(ptr noundef nonnull @.str.18, ptr noundef %50) #21
  unreachable

if.end150:                                        ; preds = %if.end138
  tail call void @init_encoding() #19
  ...
  %52 = load ptr, ptr %seq, align 8, !tbaa !35
  %len151 = getelementptr inbounds %struct._seq_t, ptr %seq1, i64 0, i32 5
  %53 = load i32, ptr %len151, align 4, !tbaa !36
  call void @init_hash_env(ptr noundef nonnull %he, i32 noundef %51, ptr noundef %52, i32 noundef %53) #19
  call void @init_col(ptr noundef nonnull %res, i32 noundef 1) #19
  call void @init_col(ptr noundef nonnull %rev_res, i32 noundef 1) #19
  call void @bld_table(ptr noundef nonnull %he) #19
  ...
  %call.i371 = call ptr @xmalloc(i64 noundef %mul.i) #19
  store ptr %call.i371, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 1), align 8, !tbaa !37
...
for.cond2.preheader.i:                            ; preds = %if.end150, %for.cond2.preheader.i
  ...
  %59 = load ptr, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 1), align 8, !tbaa !37
  ...
  %61 = load ptr, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 1), align 8, !tbaa !37
  ...
  %64 = load ptr, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 1), align 8, !tbaa !37
  ...
  %66 = load ptr, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 1), align 8, !tbaa !37
  ...
  %69 = load ptr, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 1), align 8, !tbaa !37
  ...
  %71 = load ptr, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 1), align 8, !tbaa !37
  ...
  %74 = load ptr, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 1), align 8, !tbaa !37
  ...
  %76 = load ptr, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 1), align 8, !tbaa !37
  ...
  br i1 %cmp.i, label %for.cond2.preheader.i, label %init_splice_junctions.exit, !llvm.loop !38
...
lor.rhs:                                          ; preds = %while.cond152
  %call153 = call fastcc i32 @get_next_seq(ptr noundef nonnull %seq2, i32 noundef 0, i32 noundef 0)
  %cmp154 = icmp eq i32 %call153, 0
  br i1 %cmp154, label %while.body156, label %cleanup274

while.body156:                                    ; preds = %while.cond152, %lor.rhs
  %81 = load ptr, ptr %header157, align 8, !tbaa !32
  %call158 = call ptr @strncpy(ptr noundef nonnull dereferenceable(1) @rna_seq_head, ptr noundef nonnull dereferenceable(1) %81, i64 noundef 256) #19
...
sw.bb161:                                         ; preds = %while.body156
  call void @SIM4(ptr noundef nonnull %he, ptr noundef nonnull %seq2, ptr noundef nonnull %res) #19
  br label %sw.bb162

sw.bb162:                                         ; preds = %while.body156, %sw.bb161
  %seq2.val341 = load i32, ptr %79, align 4, !tbaa !36
...
while.body.preheader.i:                           ; preds = %sw.bb162
  %seq2.val340 = load ptr, ptr %80, align 8, !tbaa !35
...
while.body.i:                                     ; preds = %while.body.i, %while.body.preheader.i
  ...
  br i1 %cmp.i374, label %while.body.i, label %sw.epilog164, !llvm.loop !39
...
sw.epilog164:                                     ; preds = %while.body.i, %sw.bb162, %while.body156
  ...
  call void @SIM4(ptr noundef nonnull %he, ptr noundef nonnull %seq2, ptr noundef nonnull %rev_res.sink) #19
  ...
  %.pre = load i32, ptr %nb, align 8, !tbaa !40
...
for.body171.epil:                                 ; preds = %for.cond183.preheader.loopexit.unr-lcssa, %for.body171.epil
  ...
  %91 = load i32, ptr %st.epil, align 4, !tbaa !42
  %spec.select.epil = call i32 @llvm.umax.i32(i32 %91, i32 %max_nmatches.0406.epil)
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %for.cond183.preheader, label %for.body171.epil, !llvm.loop !45
...
for.cond183.preheader:                            ; preds = %for.cond183.preheader.loopexit.unr-lcssa, %for.body171.epil, %for.cond168.preheader
  ...
  %92 = load i32, ptr %nb184, align 8, !tbaa !40
...
for.body171:                                      ; preds = %for.body171, %for.body171.lr.ph.new
  ...
  %96 = load i32, ptr %st, align 4, !tbaa !42
  ...
  %98 = load i32, ptr %st.1, align 4, !tbaa !42
  ...
  %100 = load i32, ptr %st.2, align 4, !tbaa !42
  ...
  %102 = load i32, ptr %st.3, align 4, !tbaa !42
  %spec.select.3 = call i32 @llvm.umax.i32(i32 %102, i32 %spec.select.2)
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %niter.next.3 = add i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %for.cond183.preheader.loopexit.unr-lcssa, label %for.body171, !llvm.loop !47
...
for.body187:                                      ; preds = %for.body187, %for.body187.lr.ph.new
  ...
  %104 = load i32, ptr %st192, align 4, !tbaa !42
  ...
  %106 = load i32, ptr %st192.1, align 4, !tbaa !42
  ...
  %108 = load i32, ptr %st192.2, align 4, !tbaa !42
  ...
  %110 = load i32, ptr %st192.3, align 4, !tbaa !42
  ...
  br i1 %niter472.ncmp.3, label %for.end202.loopexit.unr-lcssa, label %for.body187, !llvm.loop !48
...
for.body187.epil:                                 ; preds = %for.end202.loopexit.unr-lcssa, %for.body187.epil
  ...
  %112 = load i32, ptr %st192.epil, align 4, !tbaa !42
  ...
  br i1 %epil.iter468.cmp.not, label %for.end202, label %for.body187.epil, !llvm.loop !49
...
for.body207.epil:                                 ; preds = %for.cond223.preheader.loopexit.unr-lcssa
  ...
  %116 = load i32, ptr %st212.epil, align 4, !tbaa !42
...
if.then216.epil:                                  ; preds = %for.body207.epil
  store i32 0, ptr %st212.epil, align 4, !tbaa !42
...
if.end219.1:                                      ; preds = %if.then216.1, %if.end219
  ...
  br i1 %niter477.ncmp.1, label %for.cond223.preheader.loopexit.unr-lcssa, label %for.body207, !llvm.loop !50
...
if.end239.1:                                      ; preds = %if.then236.1, %if.end239
  ...
  br i1 %niter482.ncmp.1, label %if.end243.loopexit.unr-lcssa, label %for.body227, !llvm.loop !51
...
for.body227.epil:                                 ; preds = %if.end243.loopexit.unr-lcssa
  ...
  %128 = load i32, ptr %st232.epil, align 4, !tbaa !42
...
if.then236.epil:                                  ; preds = %for.body227.epil
  store i32 0, ptr %st232.epil, align 4, !tbaa !42
  br label %if.end243
...
for.body248:                                      ; preds = %if.end243, %for.body248
  ...
  %131 = load i32, ptr %nb, align 8, !tbaa !40
  %132 = zext i32 %131 to i64
  %cmp246 = icmp ult i64 %indvars.iv.next444, %132
  br i1 %cmp246, label %for.body248, label %for.end254, !llvm.loop !52

for.end254:                                       ; preds = %for.body248, %if.end243
  store i32 0, ptr %nb, align 8, !tbaa !40
...
if.then259:                                       ; preds = %for.end254
  %seq2.val339 = load i32, ptr %79, align 4, !tbaa !36
...
while.body.preheader.i378:                        ; preds = %if.then259
  %seq2.val = load ptr, ptr %80, align 8, !tbaa !35
...
while.body.i388:                                  ; preds = %while.body.i388, %while.body.preheader.i378
  ...
  br i1 %cmp.i387, label %while.body.i388, label %if.end260, !llvm.loop !39

if.end260:                                        ; preds = %while.body.i388, %if.then259, %for.end254
  %139 = load i32, ptr %nb184, align 8, !tbaa !40
...
for.body265:                                      ; preds = %if.end260, %for.body265
  ...
  %142 = load i32, ptr %nb184, align 8, !tbaa !40
  %143 = zext i32 %142 to i64
  %cmp263 = icmp ult i64 %indvars.iv.next447, %143
  br i1 %cmp263, label %for.body265, label %for.end271, !llvm.loop !53

for.end271:                                       ; preds = %for.body265, %if.end260
  store i32 0, ptr %nb184, align 8, !tbaa !40
  br label %while.cond152, !llvm.loop !54

cleanup274:                                       ; preds = %lor.rhs, %if.then127
  %retval.0 = phi i32 [ 1, %if.then127 ], [ 0, %lor.rhs ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %rev_res) #19
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %res) #19
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %he) #19
  call void @llvm.lifetime.end.p0(i64 4160, ptr nonnull %seq2) #19
  call void @llvm.lifetime.end.p0(i64 4160, ptr nonnull %seq1) #19
  ret i32 %retval.0
}
...
entry:
  ...
  %call2 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %2, ptr noundef nonnull @.str.38, i32 noundef %signum, ptr noundef nonnull @dna_seq_head, ptr noundef nonnull @rna_seq_head) #20
...
entry:
  store ptr %fName, ptr %sp, align 8, !tbaa !55
  ...
  %call.i = tail call ptr @xmalloc(i64 noundef 4096) #19
  store ptr %call.i, ptr %rb, align 8, !tbaa !56
  %lmax.i = getelementptr inbounds %struct._seq_t, ptr %sp, i64 0, i32 3, i32 1
  store i32 4096, ptr %lmax.i, align 8, !tbaa !57
  %lc.i = getelementptr inbounds %struct._seq_t, ptr %sp, i64 0, i32 3, i32 2
  store i32 0, ptr %lc.i, align 4, !tbaa !58
  %ic.i = getelementptr inbounds %struct._seq_t, ptr %sp, i64 0, i32 3, i32 3
  store i32 0, ptr %ic.i, align 8, !tbaa !59
  %cmp.not = icmp eq ptr %fName, null
  br i1 %cmp.not, label %if.else, label %if.then

if.then:                                          ; preds = %entry
  %call = tail call i32 (ptr, i32, ...) @open(ptr noundef nonnull %fName, i32 noundef 0) #19
  %fd = getelementptr inbounds %struct._seq_t, ptr %sp, i64 0, i32 4
  store i32 %call, ptr %fd, align 8, !tbaa !60
...
land.rhs:                                         ; preds = %while.body
  ...
  br i1 %cmp2.not, label %if.end, label %while.body, !llvm.loop !65

while.body:                                       ; preds = %land.rhs.lr.ph, %land.rhs
  %4 = load i32, ptr %fd, align 8, !tbaa !60
  %call = tail call fastcc ptr @read_line_buf(ptr noundef nonnull %rb, i32 noundef %4)
  %5 = load i32, ptr %lc, align 4, !tbaa !63
  %cmp.not = icmp eq i32 %5, 0
  br i1 %cmp.not, label %cleanup, label %land.rhs, !llvm.loop !65
...
if.end:                                           ; preds = %land.rhs, %land.rhs.lr.ph
  ...
  %maxHead = getelementptr inbounds %struct._seq_t, ptr %sp, i64 0, i32 6
  %6 = load i32, ptr %maxHead, align 8, !tbaa !61
...
if.end.if.end24_crit_edge:                        ; preds = %if.end
  ...
  %.pre277 = load ptr, ptr %header27.phi.trans.insert, align 8, !tbaa !32
  br label %if.end24

if.then14:                                        ; preds = %if.end
  store i32 %add11, ptr %maxHead, align 8, !tbaa !61
  %header = getelementptr inbounds %struct._seq_t, ptr %sp, i64 0, i32 1
  %7 = load ptr, ptr %header, align 8, !tbaa !32
  %conv21 = zext i32 %add11 to i64
  %call22 = tail call ptr @xrealloc(ptr noundef %7, i64 noundef %conv21) #19
  store ptr %call22, ptr %header, align 8, !tbaa !32
  %.pre = load i32, ptr %lc, align 4, !tbaa !63
  br label %if.end24
...
while.body47:                                     ; preds = %land.rhs41
  %14 = load i32, ptr %len, align 4, !tbaa !36
  %add51 = add i32 %12, 1
  %add52 = add i32 %add51, %14
  %15 = load i32, ptr %max, align 4, !tbaa !62
...
if.then55:                                        ; preds = %while.body47
  ...
  store i32 %add62.add52, ptr %max, align 4, !tbaa !62
  %16 = load ptr, ptr %seq, align 8, !tbaa !35
  %conv74 = zext i32 %add62.add52 to i64
  %call76 = tail call ptr @xrealloc(ptr noundef %16, i64 noundef %conv74) #19
  store ptr %call76, ptr %seq, align 8, !tbaa !35
...
while.body83.lr.ph:                               ; preds = %if.end78
  %call84 = tail call ptr @__ctype_b_loc() #23
...
while.body83:                                     ; preds = %while.body83.lr.ph, %if.end112
  ...
  %20 = load i16, ptr %arrayidx86, align 2, !tbaa !66
...
if.then100:                                       ; preds = %if.else
  %call101 = tail call ptr @__ctype_toupper_loc() #23
...
if.end112.sink.split:                             ; preds = %while.body83, %if.then100
  ...
  %23 = load ptr, ptr %seq, align 8, !tbaa !35
  %24 = load i32, ptr %len, align 4, !tbaa !36
  %inc108 = add i32 %24, 1
  store i32 %inc108, ptr %len, align 4, !tbaa !36
...
if.end112:                                        ; preds = %if.end112.sink.split, %if.else
  ...
  br i1 %cmp81.not, label %while.end113, label %while.body83, !llvm.loop !68

while.end113:                                     ; preds = %if.end112, %if.end78
  %26 = load i32, ptr %fd, align 8, !tbaa !60
  %call116 = tail call fastcc ptr @read_line_buf(ptr noundef nonnull %rb, i32 noundef %26)
  %27 = load i32, ptr %lc, align 4, !tbaa !63
  %cmp39.not = icmp eq i32 %27, 0
  br i1 %cmp39.not, label %if.end125, label %land.rhs41, !llvm.loop !69
...
if.then123:                                       ; preds = %while.end117.thread
  ...
  %29 = tail call i64 @fwrite(ptr nonnull @.str.34, i64 238, i64 1, ptr %28) #20
  br label %if.end125
...
if.end125:                                        ; preds = %while.end113, %if.end24, %while.end117.thread, %if.then123
  ...
  %30 = load ptr, ptr %seq126, align 8, !tbaa !35
  %31 = load i32, ptr %len, align 4, !tbaa !36
  ...
  %32 = load ptr, ptr %header27, align 8, !tbaa !32
  %call131 = tail call ptr @strstr(ptr noundef nonnull dereferenceable(1) %32, ptr noundef nonnull dereferenceable(1) @.str.35) #22
...
if.then133:                                       ; preds = %if.end125
  ...
  %35 = load i16, ptr %arrayidx138267, align 2, !tbaa !66
  %36 = and i16 %35, 2048
...
while.body142:                                    ; preds = %if.then133, %while.body142
  ...
  %39 = load i16, ptr %arrayidx138, align 2, !tbaa !66
  %40 = and i16 %39, 2048
  %tobool141.not = icmp eq i16 %40, 0
  br i1 %tobool141.not, label %while.cond146.preheader, label %while.body142, !llvm.loop !70
...
while.body148:                                    ; preds = %while.cond146.preheader, %while.body148
  ...
  br i1 %tobool147.not, label %if.end152.loopexit, label %while.body148, !llvm.loop !71

if.end152.loopexit:                               ; preds = %while.body148
  %.pre279 = load ptr, ptr %header27, align 8, !tbaa !32
  br label %if.end152
...
while.cond156:                                    ; preds = %while.cond156, %if.end152
  ...
  %46 = load i16, ptr %arrayidx160, align 2, !tbaa !66
  %47 = and i16 %46, 8194
  %or.cond254 = icmp eq i16 %47, 0
  br i1 %or.cond254, label %while.end173, label %while.cond156, !llvm.loop !72

while.end173:                                     ; preds = %while.cond156
  %48 = load i32, ptr %len, align 4, !tbaa !36
  %add176 = add i32 %48, %offset
  %call177 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %add.ptr154.pn, i64 noundef 24, ptr noundef nonnull @.str.36, i32 noundef %add176) #19
  %or.cond = icmp ugt i32 %call177, 23
  br i1 %or.cond, label %if.then182, label %cleanup

if.then182:                                       ; preds = %while.end173
  %49 = load i32, ptr %len, align 4, !tbaa !36
  tail call void (ptr, ...) @fatal(ptr noundef nonnull @.str.37, i32 noundef %49) #21
  unreachable
...
entry:
  ...
  %0 = load i32, ptr %st, align 4, !tbaa !42
...
if.then:                                          ; preds = %entry
  %header = getelementptr inbounds %struct._seq_t, ptr %seq1, i64 0, i32 1
  %2 = load ptr, ptr %header, align 8, !tbaa !32
  %header1 = getelementptr inbounds %struct._seq_t, ptr %seq2, i64 0, i32 1
  %3 = load ptr, ptr %header1, align 8, !tbaa !32
...
sw.bb:                                            ; preds = %if.end
  ...
  %5 = load i32, ptr %direction, align 8, !tbaa !73
  tail call void @print_exons(ptr noundef nonnull %eCol, i32 noundef %5) #19
  br label %sw.epilog

sw.bb4:                                           ; preds = %if.end
  %seq = getelementptr inbounds %struct._seq_t, ptr %seq1, i64 0, i32 2
  %6 = load ptr, ptr %seq, align 8, !tbaa !35
  %seq5 = getelementptr inbounds %struct._seq_t, ptr %seq2, i64 0, i32 2
  %7 = load ptr, ptr %seq5, align 8, !tbaa !35
...
sw.bb6:                                           ; preds = %if.end
  ...
  %8 = load i32, ptr %direction8, align 8, !tbaa !73
  tail call void @print_exons(ptr noundef nonnull %eCol7, i32 noundef %8) #19
  %seq9 = getelementptr inbounds %struct._seq_t, ptr %seq1, i64 0, i32 2
  %9 = load ptr, ptr %seq9, align 8, !tbaa !35
  %seq10 = getelementptr inbounds %struct._seq_t, ptr %seq2, i64 0, i32 2
  %10 = load ptr, ptr %seq10, align 8, !tbaa !35
...
if.then.i:                                        ; preds = %sw.bb11
  ...
  %16 = load i32, ptr %to2.i, align 4, !tbaa !75
  %len.i = getelementptr inbounds %struct._seq_t, ptr %seq2, i64 0, i32 5
  %17 = load i32, ptr %len.i, align 4, !tbaa !36
...
for.body.i:                                       ; preds = %if.then.i
  %20 = load ptr, ptr %seq.i, align 8, !tbaa !35
...
land.rhs16.lr.ph.i:                               ; preds = %for.end.i
  %40 = load ptr, ptr %seq.i, align 8, !tbaa !35
  %41 = sub i32 %17, %16
...
while.body.i:                                     ; preds = %land.rhs16.i
  ...
  br i1 %cmp14.i, label %land.rhs16.i, label %while.end.i, !llvm.loop !77
...
while.end.i:                                      ; preds = %while.body.i, %land.rhs16.i, %for.end.i
  ...
  %43 = load i32, ptr %len29.i, align 4, !tbaa !36
  %cmp30345.i = icmp ne i32 %43, 0
  %cmp33346.i = icmp ne i32 %pos.1.lcssa.i, 0
  %44 = select i1 %cmp30345.i, i1 %cmp33346.i, i1 false
  br i1 %44, label %for.body36.lr.ph.i, label %while.end.for.end49_crit_edge.i
...
while.end.for.end49_crit_edge.i:                  ; preds = %while.end.i
  ...
  %.pre.i = load i32, ptr %to150.phi.trans.insert.i, align 4, !tbaa !78
  %seq57.phi.trans.insert.i = getelementptr inbounds %struct._seq_t, ptr %seq1, i64 0, i32 2
  %.pre394.i = load ptr, ptr %seq57.phi.trans.insert.i, align 8, !tbaa !35
...
for.body36.lr.ph.i:                               ; preds = %while.end.i
  ...
  %45 = load ptr, ptr %seq37.i, align 8, !tbaa !35
  %to1.i = getelementptr inbounds %struct._exon_t, ptr %15, i64 0, i32 2
  %46 = load i32, ptr %to1.i, align 4, !tbaa !78
  %47 = add i32 %pos.1.lcssa.i, -1
  %48 = add i32 %43, -1
  %umin.i = tail call i32 @llvm.umin.i32(i32 %47, i32 %48)
  %49 = add nuw i32 %umin.i, 1
  %wide.trip.count373.i = zext i32 %49 to i64
  %min.iters.check = icmp ult i32 %umin.i, 7
  br i1 %min.iters.check, label %for.body36.i.preheader, label %vector.scevcheck

vector.scevcheck:                                 ; preds = %for.body36.lr.ph.i
  %50 = add nsw i64 %wide.trip.count373.i, -1
  %51 = trunc i64 %50 to i32
  %52 = xor i32 %46, -1
  %53 = icmp ult i32 %52, %51
  %54 = icmp ugt i64 %50, 4294967295
  %55 = or i1 %53, %54
  br i1 %55, label %for.body36.i.preheader, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi71 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %66, %vector.body ]
  %56 = trunc i64 %offset.idx to i32
  %57 = add i32 %46, %56
  %58 = zext i32 %57 to i64
  %59 = getelementptr inbounds i8, ptr %45, i64 %58
  %wide.load = load <4 x i8>, ptr %59, align 1, !tbaa !25
  %60 = getelementptr inbounds i8, ptr %59, i64 4
  %wide.load72 = load <4 x i8>, ptr %60, align 1, !tbaa !25
  %61 = icmp eq <4 x i8> %wide.load, <i8 65, i8 65, i8 65, i8 65>
  %62 = icmp eq <4 x i8> %wide.load72, <i8 65, i8 65, i8 65, i8 65>
  %63 = zext <4 x i1> %61 to <4 x i32>
  %64 = zext <4 x i1> %62 to <4 x i32>
  %65 = add <4 x i32> %vec.phi, %63
  %66 = add <4 x i32> %vec.phi71, %64
  %index.next = add nuw i64 %offset.idx, 8
  %67 = icmp eq i64 %index.next, %n.vec
  br i1 %67, label %middle.block, label %vector.body, !llvm.loop !79

middle.block:                                     ; preds = %vector.body
  %bin.rdx = add <4 x i32> %66, %65
  %68 = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx)
...
for.body36.i.preheader:                           ; preds = %vector.scevcheck, %for.body36.lr.ph.i, %middle.block
  ...
  %cntDna.0348.i.ph = phi i32 [ 0, %vector.scevcheck ], [ 0, %for.body36.lr.ph.i ], [ %68, %middle.block ]
  %69 = xor i64 %indvars.iv.i.ph, -1
  %70 = add nsw i64 %69, %wide.trip.count373.i
...
for.body36.i.prol:                                ; preds = %for.body36.i.preheader, %for.body36.i.prol
  ...
  %cntDna.0348.i.prol = phi i32 [ %spec.select322.i.prol, %for.body36.i.prol ], [ %cntDna.0348.i.ph, %for.body36.i.preheader ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body36.i.prol ], [ 0, %for.body36.i.preheader ]
  %71 = trunc i64 %indvars.iv.i.prol to i32
  %add38.i.prol = add i32 %46, %71
  %idxprom39.i.prol = zext i32 %add38.i.prol to i64
  %arrayidx40.i.prol = getelementptr inbounds i8, ptr %45, i64 %idxprom39.i.prol
  %72 = load i8, ptr %arrayidx40.i.prol, align 1, !tbaa !25
  %cmp42.i.prol = icmp eq i8 %72, 65
  %add45.i.prol = zext i1 %cmp42.i.prol to i32
  %spec.select322.i.prol = add i32 %cntDna.0348.i.prol, %add45.i.prol
  %indvars.iv.next.i.prol = add nuw nsw i64 %indvars.iv.i.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body36.i.prol.loopexit, label %for.body36.i.prol, !llvm.loop !82
...
for.body36.i.prol.loopexit:                       ; preds = %for.body36.i.prol, %for.body36.i.preheader
  ...
  %cntDna.0348.i.unr = phi i32 [ %cntDna.0348.i.ph, %for.body36.i.preheader ], [ %spec.select322.i.prol, %for.body36.i.prol ]
  %73 = icmp ult i64 %70, 3
  br i1 %73, label %for.end49.i, label %for.body36.i
...
for.body36.i:                                     ; preds = %for.body36.i.prol.loopexit, %for.body36.i
  ...
  %cntDna.0348.i = phi i32 [ %spec.select322.i.3, %for.body36.i ], [ %cntDna.0348.i.unr, %for.body36.i.prol.loopexit ]
  %74 = trunc i64 %indvars.iv.i to i32
  %add38.i = add i32 %46, %74
  %idxprom39.i = zext i32 %add38.i to i64
  %arrayidx40.i = getelementptr inbounds i8, ptr %45, i64 %idxprom39.i
  %75 = load i8, ptr %arrayidx40.i, align 1, !tbaa !25
  %cmp42.i = icmp eq i8 %75, 65
  %add45.i = zext i1 %cmp42.i to i32
  %spec.select322.i = add i32 %cntDna.0348.i, %add45.i
  %76 = trunc i64 %indvars.iv.i to i32
  %77 = add i32 %76, 1
  %add38.i.1 = add i32 %46, %77
  %idxprom39.i.1 = zext i32 %add38.i.1 to i64
  %arrayidx40.i.1 = getelementptr inbounds i8, ptr %45, i64 %idxprom39.i.1
  %78 = load i8, ptr %arrayidx40.i.1, align 1, !tbaa !25
  %cmp42.i.1 = icmp eq i8 %78, 65
  %add45.i.1 = zext i1 %cmp42.i.1 to i32
  %spec.select322.i.1 = add i32 %spec.select322.i, %add45.i.1
  %79 = trunc i64 %indvars.iv.i to i32
  %80 = add i32 %79, 2
  %add38.i.2 = add i32 %46, %80
  %idxprom39.i.2 = zext i32 %add38.i.2 to i64
  %arrayidx40.i.2 = getelementptr inbounds i8, ptr %45, i64 %idxprom39.i.2
  %81 = load i8, ptr %arrayidx40.i.2, align 1, !tbaa !25
  %cmp42.i.2 = icmp eq i8 %81, 65
  ...
  %83 = add i32 %82, 3
  %add38.i.3 = add i32 %46, %83
  %idxprom39.i.3 = zext i32 %add38.i.3 to i64
  %arrayidx40.i.3 = getelementptr inbounds i8, ptr %45, i64 %idxprom39.i.3
  %84 = load i8, ptr %arrayidx40.i.3, align 1, !tbaa !25
  %cmp42.i.3 = icmp eq i8 %84, 65
  ...
  br i1 %exitcond374.not.i.3, label %for.end49.i, label %for.body36.i, !llvm.loop !83

for.end49.i:                                      ; preds = %for.body36.i.prol.loopexit, %for.body36.i, %middle.block, %while.end.for.end49_crit_edge.i
  %85 = phi ptr [ %.pre394.i, %while.end.for.end49_crit_edge.i ], [ %45, %middle.block ], [ %45, %for.body36.i ], [ %45, %for.body36.i.prol.loopexit ]
  %86 = phi i32 [ %.pre.i, %while.end.for.end49_crit_edge.i ], [ %46, %middle.block ], [ %46, %for.body36.i ], [ %46, %for.body36.i.prol.loopexit ]
  %i.0.lcssa.i = phi i32 [ 0, %while.end.for.end49_crit_edge.i ], [ %49, %middle.block ], [ %49, %for.body36.i ], [ %49, %for.body36.i.prol.loopexit ]
  %cntDna.0.lcssa.i = phi i32 [ 0, %while.end.for.end49_crit_edge.i ], [ %68, %middle.block ], [ %spec.select322.i.lcssa.unr, %for.body36.i.prol.loopexit ], [ %spec.select322.i.3, %for.body36.i ]
  %to150.i = getelementptr inbounds %struct._exon_t, ptr %15, i64 0, i32 2
  %add51.i = add i32 %86, 1
  %87 = load i32, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 15), align 4, !tbaa !29
  %add52.i = add i32 %add51.i, %87
  %88 = load ptr, ptr %seq.i, align 8, !tbaa !35
  %add.ptr.i = getelementptr inbounds i8, ptr %88, i64 %18
  %add56.i = add i32 %16, 1
  %seq57.i = getelementptr inbounds %struct._seq_t, ptr %seq1, i64 0, i32 2
  %idx.ext59.i = zext i32 %86 to i64
  %add.ptr60.i = getelementptr inbounds i8, ptr %85, i64 %idx.ext59.i
  %call.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.24, i32 noundef %pos.1.lcssa.i, i32 noundef %cnt.2.lcssa.i, i32 noundef %cntDna.0.lcssa.i, i32 noundef %add52.i, i32 noundef %pos.1.lcssa.i, ptr noundef %add.ptr.i, i32 noundef %add56.i, i32 noundef %pos.1.lcssa.i, i32 noundef %i.0.lcssa.i, ptr noundef %add.ptr60.i, i32 noundef %add52.i)
  %89 = load i32, ptr %to150.i, align 4, !tbaa !78
  %90 = zext i32 %89 to i64
  %spec.select323332.i = tail call i32 @llvm.umin.i32(i32 %89, i32 50)
  %spec.select323.i = zext i32 %spec.select323332.i to i64
  %idx.neg.i = sub nsw i64 0, %spec.select323.i
  %91 = load ptr, ptr %seq57.i, align 8, !tbaa !35
  %add.ptr73.i = getelementptr inbounds i8, ptr %91, i64 %90
  %add.ptr75.i = getelementptr inbounds i8, ptr %add.ptr73.i, i64 %idx.neg.i
  %call77.i = call ptr @strncpy(ptr noundef nonnull %buf.i, ptr noundef %add.ptr75.i, i64 noundef %spec.select323.i) #19
  ...
  %call81.i = call ptr @strstr(ptr noundef nonnull dereferenceable(1) %buf.i, ptr noundef nonnull dereferenceable(1) @.str.25) #22
  %cmp82.i = icmp eq ptr %call81.i, null
  br i1 %cmp82.i, label %if.end87.i, label %if.then90.i

if.end87.i:                                       ; preds = %for.end49.i
  %call86.i = call ptr @strstr(ptr noundef nonnull dereferenceable(1) %buf.i, ptr noundef nonnull dereferenceable(1) @.str.26) #22
...
if.then90.i:                                      ; preds = %if.end87.i, %for.end49.i
  ...
  %92 = load i32, ptr %to150.i, align 4, !tbaa !78
  %93 = add i64 %spec.select323.i, %sub.ptr.rhs.cast.i
  %94 = sub i64 %sub.ptr.lhs.cast.i, %93
  %95 = load i32, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 15), align 4, !tbaa !29
  %96 = trunc i64 %94 to i32
  %97 = add i32 %92, 1
  %98 = add i32 %97, %95
  %conv100.i = add i32 %98, %96
...
if.end102.i:                                      ; preds = %if.then90.i, %if.end87.i
  call void @llvm.lifetime.end.p0(i64 51, ptr nonnull %buf.i) #19
  br label %if.end103.i

if.end103.i:                                      ; preds = %if.end102.i, %sw.bb11
  %polyT_cut.i = getelementptr inbounds %struct._result_t, ptr %res, i64 0, i32 5, i32 2
  %99 = load i32, ptr %polyT_cut.i, align 4, !tbaa !84
  %tobool104.not.i = icmp eq i32 %99, 0
  br i1 %tobool104.not.i, label %print_polyA_info.exit, label %if.then105.i

if.then105.i:                                     ; preds = %if.end103.i
  call void @llvm.lifetime.start.p0(i64 51, ptr nonnull %buf111.i) #19
  %100 = load ptr, ptr %eCol12, align 8, !tbaa !25
  %101 = load ptr, ptr %100, align 8, !tbaa !5
  %from2.i = getelementptr inbounds %struct._exon_t, ptr %101, i64 0, i32 1
  %102 = load i32, ptr %from2.i, align 4, !tbaa !85
  %sub119.i = add i32 %102, -1
  %seq124.i = getelementptr inbounds %struct._seq_t, ptr %seq2, i64 0, i32 2
  %umin378.i = call i32 @llvm.umin.i32(i32 %sub119.i, i32 9)
  %103 = add nuw nsw i32 %umin378.i, 1
  %exitcond381.not.i = icmp eq i32 %sub119.i, 0
  br i1 %exitcond381.not.i, label %for.end138.i, label %for.body123.i

for.body123.i:                                    ; preds = %if.then105.i
  %104 = load ptr, ptr %seq124.i, align 8, !tbaa !35
  %sub127.i = add i32 %102, -2
  %idxprom128.i = zext i32 %sub127.i to i64
  %arrayidx129.i = getelementptr inbounds i8, ptr %104, i64 %idxprom128.i
  %105 = load i8, ptr %arrayidx129.i, align 1, !tbaa !25
  %cmp131.i = icmp eq i8 %105, 84
  %add134.i = zext i1 %cmp131.i to i32
  %exitcond381.1.not.i = icmp eq i32 %sub119.i, 1
  br i1 %exitcond381.1.not.i, label %for.end138.i, label %for.body123.1.i

for.body123.1.i:                                  ; preds = %for.body123.i
  %sub127.1.i = add i32 %102, -3
  %idxprom128.1.i = zext i32 %sub127.1.i to i64
  %arrayidx129.1.i = getelementptr inbounds i8, ptr %104, i64 %idxprom128.1.i
  %106 = load i8, ptr %arrayidx129.1.i, align 1, !tbaa !25
  %cmp131.1.i = icmp eq i8 %106, 84
  %add134.1.i = zext i1 %cmp131.1.i to i32
  %spec.select324.1.i = add nuw nsw i32 %add134.1.i, %add134.i
  %exitcond381.2.not.i = icmp eq i32 %sub119.i, 2
  br i1 %exitcond381.2.not.i, label %for.end138.i, label %for.body123.2.i

for.body123.2.i:                                  ; preds = %for.body123.1.i
  %sub127.2.i = add i32 %102, -4
  %idxprom128.2.i = zext i32 %sub127.2.i to i64
  %arrayidx129.2.i = getelementptr inbounds i8, ptr %104, i64 %idxprom128.2.i
  %107 = load i8, ptr %arrayidx129.2.i, align 1, !tbaa !25
  %cmp131.2.i = icmp eq i8 %107, 84
  %add134.2.i = zext i1 %cmp131.2.i to i32
  %spec.select324.2.i = add nuw nsw i32 %spec.select324.1.i, %add134.2.i
  %exitcond381.3.not.i = icmp eq i32 %sub119.i, 3
  br i1 %exitcond381.3.not.i, label %for.end138.i, label %for.body123.3.i

for.body123.3.i:                                  ; preds = %for.body123.2.i
  %sub127.3.i = add i32 %102, -5
  %idxprom128.3.i = zext i32 %sub127.3.i to i64
  %arrayidx129.3.i = getelementptr inbounds i8, ptr %104, i64 %idxprom128.3.i
  %108 = load i8, ptr %arrayidx129.3.i, align 1, !tbaa !25
  %cmp131.3.i = icmp eq i8 %108, 84
  %add134.3.i = zext i1 %cmp131.3.i to i32
  %spec.select324.3.i = add nuw nsw i32 %spec.select324.2.i, %add134.3.i
  %exitcond381.4.not.i = icmp eq i32 %sub119.i, 4
  br i1 %exitcond381.4.not.i, label %for.end138.i, label %for.body123.4.i

for.body123.4.i:                                  ; preds = %for.body123.3.i
  %sub127.4.i = add i32 %102, -6
  %idxprom128.4.i = zext i32 %sub127.4.i to i64
  %arrayidx129.4.i = getelementptr inbounds i8, ptr %104, i64 %idxprom128.4.i
  %109 = load i8, ptr %arrayidx129.4.i, align 1, !tbaa !25
  %cmp131.4.i = icmp eq i8 %109, 84
  %add134.4.i = zext i1 %cmp131.4.i to i32
  %spec.select324.4.i = add nuw nsw i32 %spec.select324.3.i, %add134.4.i
  %exitcond381.5.not.i = icmp eq i32 %sub119.i, 5
  br i1 %exitcond381.5.not.i, label %for.end138.i, label %for.body123.5.i

for.body123.5.i:                                  ; preds = %for.body123.4.i
  %sub127.5.i = add i32 %102, -7
  %idxprom128.5.i = zext i32 %sub127.5.i to i64
  %arrayidx129.5.i = getelementptr inbounds i8, ptr %104, i64 %idxprom128.5.i
  %110 = load i8, ptr %arrayidx129.5.i, align 1, !tbaa !25
  %cmp131.5.i = icmp eq i8 %110, 84
  %add134.5.i = zext i1 %cmp131.5.i to i32
  %spec.select324.5.i = add nuw nsw i32 %spec.select324.4.i, %add134.5.i
  %exitcond381.6.not.i = icmp eq i32 %sub119.i, 6
  br i1 %exitcond381.6.not.i, label %for.end138.i, label %for.body123.6.i

for.body123.6.i:                                  ; preds = %for.body123.5.i
  %sub127.6.i = add i32 %102, -8
  %idxprom128.6.i = zext i32 %sub127.6.i to i64
  %arrayidx129.6.i = getelementptr inbounds i8, ptr %104, i64 %idxprom128.6.i
  %111 = load i8, ptr %arrayidx129.6.i, align 1, !tbaa !25
  %cmp131.6.i = icmp eq i8 %111, 84
  %add134.6.i = zext i1 %cmp131.6.i to i32
  %spec.select324.6.i = add nuw nsw i32 %spec.select324.5.i, %add134.6.i
  %exitcond381.7.not.i = icmp eq i32 %sub119.i, 7
  br i1 %exitcond381.7.not.i, label %for.end138.i, label %for.body123.7.i

for.body123.7.i:                                  ; preds = %for.body123.6.i
  %sub127.7.i = add i32 %102, -9
  %idxprom128.7.i = zext i32 %sub127.7.i to i64
  %arrayidx129.7.i = getelementptr inbounds i8, ptr %104, i64 %idxprom128.7.i
  %112 = load i8, ptr %arrayidx129.7.i, align 1, !tbaa !25
  %cmp131.7.i = icmp eq i8 %112, 84
  %add134.7.i = zext i1 %cmp131.7.i to i32
  %spec.select324.7.i = add nuw nsw i32 %spec.select324.6.i, %add134.7.i
  %exitcond381.8.not.i = icmp eq i32 %sub119.i, 8
  br i1 %exitcond381.8.not.i, label %for.end138.i, label %for.body123.8.i

for.body123.8.i:                                  ; preds = %for.body123.7.i
  %sub127.8.i = add i32 %102, -10
  %idxprom128.8.i = zext i32 %sub127.8.i to i64
  %arrayidx129.8.i = getelementptr inbounds i8, ptr %104, i64 %idxprom128.8.i
  %113 = load i8, ptr %arrayidx129.8.i, align 1, !tbaa !25
  %cmp131.8.i = icmp eq i8 %113, 84
  %add134.8.i = zext i1 %cmp131.8.i to i32
  %spec.select324.8.i = add nuw nsw i32 %spec.select324.7.i, %add134.8.i
  %exitcond381.9.not.i = icmp eq i32 %sub119.i, 9
  br i1 %exitcond381.9.not.i, label %for.end138.i, label %for.body123.9.i

for.body123.9.i:                                  ; preds = %for.body123.8.i
  %sub127.9.i = add i32 %102, -11
  %idxprom128.9.i = zext i32 %sub127.9.i to i64
  %arrayidx129.9.i = getelementptr inbounds i8, ptr %104, i64 %idxprom128.9.i
  %114 = load i8, ptr %arrayidx129.9.i, align 1, !tbaa !25
  %cmp131.9.i = icmp eq i8 %114, 84
...
for.end138.i:                                     ; preds = %for.body123.9.i, %for.body123.8.i, %for.body123.7.i, %for.body123.6.i, %for.body123.5.i, %for.body123.4.i, %for.body123.3.i, %for.body123.2.i, %for.body123.1.i, %for.body123.i, %if.then105.i
  ...
  %pos108.0.lcssa.i = phi i32 [ %umin378.i, %if.then105.i ], [ %umin378.i, %for.body123.i ], [ %umin378.i, %for.body123.1.i ], [ %umin378.i, %for.body123.2.i ], [ %umin378.i, %for.body123.3.i ], [ %umin378.i, %for.body123.4.i ], [ %umin378.i, %for.body123.5.i ], [ %umin378.i, %for.body123.6.i ], [ %umin378.i, %for.body123.7.i ], [ %umin378.i, %for.body123.8.i ], [ %103, %for.body123.9.i ]
  %cmp142353.i = icmp ugt i32 %sub119.i, %pos108.0.lcssa.i
  br i1 %cmp142353.i, label %land.rhs144.lr.ph.i, label %while.end158.i

land.rhs144.lr.ph.i:                              ; preds = %for.end138.i
  %115 = load ptr, ptr %seq124.i, align 8, !tbaa !35
  %116 = zext i32 %pos108.0.lcssa.i to i64
  %117 = add i32 %cnt106.0.lcssa.i, %102
  %118 = xor i32 %pos108.0.lcssa.i, -1
  %119 = add i32 %117, %118
  %sub147.i = add i32 %102, -2
  br label %land.rhs144.i

land.rhs144.i:                                    ; preds = %while.body155.i, %land.rhs144.lr.ph.i
  %indvars.iv383.i = phi i64 [ %116, %land.rhs144.lr.ph.i ], [ %indvars.iv.next384.i, %while.body155.i ]
  %cnt106.2354.i = phi i32 [ %cnt106.0.lcssa.i, %land.rhs144.lr.ph.i ], [ %add157.i, %while.body155.i ]
  %120 = trunc i64 %indvars.iv383.i to i32
  %sub148.i = sub i32 %sub147.i, %120
  %idxprom149.i = zext i32 %sub148.i to i64
  %arrayidx150.i = getelementptr inbounds i8, ptr %115, i64 %idxprom149.i
  %121 = load i8, ptr %arrayidx150.i, align 1, !tbaa !25
  %cmp152.i = icmp eq i8 %121, 84
  br i1 %cmp152.i, label %while.body155.i, label %while.end158.i.loopexit.split.loop.exit

while.body155.i:                                  ; preds = %land.rhs144.i
  %indvars.iv.next384.i = add nuw nsw i64 %indvars.iv383.i, 1
  %add157.i = add i32 %cnt106.2354.i, 1
  %lftr.wideiv.i = trunc i64 %indvars.iv.next384.i to i32
  %exitcond386.not.i = icmp eq i32 %sub119.i, %lftr.wideiv.i
  br i1 %exitcond386.not.i, label %while.end158.i, label %land.rhs144.i, !llvm.loop !86

while.end158.i.loopexit.split.loop.exit:          ; preds = %land.rhs144.i
  %122 = trunc i64 %indvars.iv383.i to i32
  br label %while.end158.i

while.end158.i:                                   ; preds = %while.body155.i, %while.end158.i.loopexit.split.loop.exit, %for.end138.i
  %cnt106.2.lcssa.i = phi i32 [ %cnt106.0.lcssa.i, %for.end138.i ], [ %cnt106.2354.i, %while.end158.i.loopexit.split.loop.exit ], [ %119, %while.body155.i ]
  %pos108.1.lcssa.i = phi i32 [ %pos108.0.lcssa.i, %for.end138.i ], [ %122, %while.end158.i.loopexit.split.loop.exit ], [ %sub119.i, %while.body155.i ]
  %123 = load i32, ptr %101, align 4, !tbaa !87
  %sub160.i = add i32 %123, -1
  %cmp161362.i = icmp ne i32 %sub160.i, 0
  %cmp164363.i = icmp ne i32 %pos108.1.lcssa.i, 0
  %124 = select i1 %cmp161362.i, i1 %cmp164363.i, i1 false
  %seq168.i = getelementptr inbounds %struct._seq_t, ptr %seq1, i64 0, i32 2
  %125 = load ptr, ptr %seq168.i, align 8, !tbaa !35
  br i1 %124, label %for.body167.lr.ph.i, label %for.end182.i

for.body167.lr.ph.i:                              ; preds = %while.end158.i
  %126 = add i32 %pos108.1.lcssa.i, -1
  %127 = add i32 %123, -2
  %umin391.i = call i32 @llvm.umin.i32(i32 %126, i32 %127)
  %128 = add nuw i32 %umin391.i, 1
  %wide.trip.count392.i = zext i32 %128 to i64
  %min.iters.check76 = icmp ult i32 %umin391.i, 11
  br i1 %min.iters.check76, label %for.body167.i.preheader, label %vector.scevcheck73

vector.scevcheck73:                               ; preds = %for.body167.lr.ph.i
  %129 = add nsw i64 %wide.trip.count392.i, -1
  %130 = trunc i64 %129 to i32
  %131 = icmp ult i32 %127, %130
  %132 = icmp ugt i64 %129, 4294967295
  %133 = or i1 %131, %132
  br i1 %133, label %for.body167.i.preheader, label %vector.ph77

vector.ph77:                                      ; preds = %vector.scevcheck73
  %n.vec79 = and i64 %wide.trip.count392.i, 4294967288
  br label %vector.body82

vector.body82:                                    ; preds = %vector.body82, %vector.ph77
  %offset.idx85 = phi i64 [ 0, %vector.ph77 ], [ %index.next89, %vector.body82 ]
  %vec.phi83 = phi <4 x i32> [ zeroinitializer, %vector.ph77 ], [ %145, %vector.body82 ]
  %vec.phi84 = phi <4 x i32> [ zeroinitializer, %vector.ph77 ], [ %146, %vector.body82 ]
  %134 = trunc i64 %offset.idx85 to i32
  %135 = sub i32 %127, %134
  %136 = zext i32 %135 to i64
  %137 = getelementptr inbounds i8, ptr %125, i64 %136
  %138 = getelementptr inbounds i8, ptr %137, i64 -3
  %wide.load86 = load <4 x i8>, ptr %138, align 1, !tbaa !25
  %reverse = shufflevector <4 x i8> %wide.load86, <4 x i8> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %139 = getelementptr inbounds i8, ptr %137, i64 -4
  %140 = getelementptr inbounds i8, ptr %139, i64 -3
  %wide.load87 = load <4 x i8>, ptr %140, align 1, !tbaa !25
  %reverse88 = shufflevector <4 x i8> %wide.load87, <4 x i8> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %141 = icmp eq <4 x i8> %reverse, <i8 84, i8 84, i8 84, i8 84>
  %142 = icmp eq <4 x i8> %reverse88, <i8 84, i8 84, i8 84, i8 84>
  %143 = zext <4 x i1> %141 to <4 x i32>
  %144 = zext <4 x i1> %142 to <4 x i32>
  %145 = add <4 x i32> %vec.phi83, %143
  %146 = add <4 x i32> %vec.phi84, %144
  %index.next89 = add nuw i64 %offset.idx85, 8
  %147 = icmp eq i64 %index.next89, %n.vec79
  br i1 %147, label %middle.block74, label %vector.body82, !llvm.loop !88

middle.block74:                                   ; preds = %vector.body82
  %bin.rdx90 = add <4 x i32> %146, %145
  %148 = call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx90)
  %cmp.n81 = icmp eq i64 %n.vec79, %wide.trip.count392.i
  br i1 %cmp.n81, label %for.end182.i, label %for.body167.i.preheader

for.body167.i.preheader:                          ; preds = %vector.scevcheck73, %for.body167.lr.ph.i, %middle.block74
  %indvars.iv387.i.ph = phi i64 [ 0, %vector.scevcheck73 ], [ 0, %for.body167.lr.ph.i ], [ %n.vec79, %middle.block74 ]
  %cntDna107.0364.i.ph = phi i32 [ 0, %vector.scevcheck73 ], [ 0, %for.body167.lr.ph.i ], [ %148, %middle.block74 ]
  %149 = xor i64 %indvars.iv387.i.ph, -1
  %150 = add nsw i64 %149, %wide.trip.count392.i
  %xtraiter97 = and i64 %wide.trip.count392.i, 3
  %lcmp.mod98.not = icmp eq i64 %xtraiter97, 0
  br i1 %lcmp.mod98.not, label %for.body167.i.prol.loopexit, label %for.body167.i.prol

for.body167.i.prol:                               ; preds = %for.body167.i.preheader, %for.body167.i.prol
  %indvars.iv387.i.prol = phi i64 [ %indvars.iv.next388.i.prol, %for.body167.i.prol ], [ %indvars.iv387.i.ph, %for.body167.i.preheader ]
  %cntDna107.0364.i.prol = phi i32 [ %spec.select325.i.prol, %for.body167.i.prol ], [ %cntDna107.0364.i.ph, %for.body167.i.preheader ]
  %prol.iter99 = phi i64 [ %prol.iter99.next, %for.body167.i.prol ], [ 0, %for.body167.i.preheader ]
  %151 = trunc i64 %indvars.iv387.i.prol to i32
  %sub171.i.prol = sub i32 %127, %151
  %idxprom172.i.prol = zext i32 %sub171.i.prol to i64
  %arrayidx173.i.prol = getelementptr inbounds i8, ptr %125, i64 %idxprom172.i.prol
  %152 = load i8, ptr %arrayidx173.i.prol, align 1, !tbaa !25
  %cmp175.i.prol = icmp eq i8 %152, 84
  %add178.i.prol = zext i1 %cmp175.i.prol to i32
  %spec.select325.i.prol = add i32 %cntDna107.0364.i.prol, %add178.i.prol
  %indvars.iv.next388.i.prol = add nuw nsw i64 %indvars.iv387.i.prol, 1
  %prol.iter99.next = add i64 %prol.iter99, 1
  %prol.iter99.cmp.not = icmp eq i64 %prol.iter99.next, %xtraiter97
  br i1 %prol.iter99.cmp.not, label %for.body167.i.prol.loopexit, label %for.body167.i.prol, !llvm.loop !89
...
for.body167.i.prol.loopexit:                      ; preds = %for.body167.i.prol, %for.body167.i.preheader
  ...
  %indvars.iv387.i.unr = phi i64 [ %indvars.iv387.i.ph, %for.body167.i.preheader ], [ %indvars.iv.next388.i.prol, %for.body167.i.prol ]
  %cntDna107.0364.i.unr = phi i32 [ %cntDna107.0364.i.ph, %for.body167.i.preheader ], [ %spec.select325.i.prol, %for.body167.i.prol ]
  %153 = icmp ult i64 %150, 3
  br i1 %153, label %for.end182.i, label %for.body167.i

for.body167.i:                                    ; preds = %for.body167.i.prol.loopexit, %for.body167.i
  %indvars.iv387.i = phi i64 [ %indvars.iv.next388.i.3, %for.body167.i ], [ %indvars.iv387.i.unr, %for.body167.i.prol.loopexit ]
  %cntDna107.0364.i = phi i32 [ %spec.select325.i.3, %for.body167.i ], [ %cntDna107.0364.i.unr, %for.body167.i.prol.loopexit ]
  %154 = trunc i64 %indvars.iv387.i to i32
  %sub171.i = sub i32 %127, %154
  %idxprom172.i = zext i32 %sub171.i to i64
  %arrayidx173.i = getelementptr inbounds i8, ptr %125, i64 %idxprom172.i
  %155 = load i8, ptr %arrayidx173.i, align 1, !tbaa !25
  %cmp175.i = icmp eq i8 %155, 84
  %add178.i = zext i1 %cmp175.i to i32
  %spec.select325.i = add i32 %cntDna107.0364.i, %add178.i
  %156 = trunc i64 %indvars.iv387.i to i32
  %.neg = xor i32 %156, -1
  %sub171.i.1 = add i32 %127, %.neg
  %idxprom172.i.1 = zext i32 %sub171.i.1 to i64
  %arrayidx173.i.1 = getelementptr inbounds i8, ptr %125, i64 %idxprom172.i.1
  %157 = load i8, ptr %arrayidx173.i.1, align 1, !tbaa !25
  %cmp175.i.1 = icmp eq i8 %157, 84
  %add178.i.1 = zext i1 %cmp175.i.1 to i32
  %spec.select325.i.1 = add i32 %spec.select325.i, %add178.i.1
  %158 = trunc i64 %indvars.iv387.i to i32
  %159 = add i32 %158, 2
  %sub171.i.2 = sub i32 %127, %159
  %idxprom172.i.2 = zext i32 %sub171.i.2 to i64
  %arrayidx173.i.2 = getelementptr inbounds i8, ptr %125, i64 %idxprom172.i.2
  %160 = load i8, ptr %arrayidx173.i.2, align 1, !tbaa !25
  %cmp175.i.2 = icmp eq i8 %160, 84
  %add178.i.2 = zext i1 %cmp175.i.2 to i32
  %spec.select325.i.2 = add i32 %spec.select325.i.1, %add178.i.2
  %161 = trunc i64 %indvars.iv387.i to i32
  %162 = add i32 %161, 3
  %sub171.i.3 = sub i32 %127, %162
  %idxprom172.i.3 = zext i32 %sub171.i.3 to i64
  %arrayidx173.i.3 = getelementptr inbounds i8, ptr %125, i64 %idxprom172.i.3
  %163 = load i8, ptr %arrayidx173.i.3, align 1, !tbaa !25
  %cmp175.i.3 = icmp eq i8 %163, 84
  %add178.i.3 = zext i1 %cmp175.i.3 to i32
  %spec.select325.i.3 = add i32 %spec.select325.i.2, %add178.i.3
  %indvars.iv.next388.i.3 = add nuw nsw i64 %indvars.iv387.i, 4
  %exitcond393.not.i.3 = icmp eq i64 %indvars.iv.next388.i.3, %wide.trip.count392.i
  br i1 %exitcond393.not.i.3, label %for.end182.i, label %for.body167.i, !llvm.loop !90

for.end182.i:                                     ; preds = %for.body167.i.prol.loopexit, %for.body167.i, %middle.block74, %while.end158.i
  %cntDna107.0.lcssa.i = phi i32 [ 0, %while.end158.i ], [ %148, %middle.block74 ], [ %spec.select325.i.lcssa.unr, %for.body167.i.prol.loopexit ], [ %spec.select325.i.3, %for.body167.i ]
  %i109.0.lcssa.i = phi i32 [ 0, %while.end158.i ], [ %128, %middle.block74 ], [ %128, %for.body167.i ], [ %128, %for.body167.i.prol.loopexit ]
  %164 = load i32, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 15), align 4, !tbaa !29
  %add185.i = add i32 %164, %sub160.i
  %165 = load ptr, ptr %seq124.i, align 8, !tbaa !35
  %sub189.i = sub i32 %sub119.i, %pos108.1.lcssa.i
  %idx.ext190.i = zext i32 %sub189.i to i64
  %add.ptr191.i = getelementptr inbounds i8, ptr %165, i64 %idx.ext190.i
  %sub197.i = sub i32 %sub160.i, %i109.0.lcssa.i
  %idx.ext198.i = zext i32 %sub197.i to i64
  %add.ptr199.i = getelementptr inbounds i8, ptr %125, i64 %idx.ext198.i
  %call203.i = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.28, i32 noundef %pos108.1.lcssa.i, i32 noundef %cnt106.2.lcssa.i, i32 noundef %cntDna107.0.lcssa.i, i32 noundef %add185.i, i32 noundef %pos108.1.lcssa.i, ptr noundef %add.ptr191.i, i32 noundef %sub119.i, i32 noundef %pos108.1.lcssa.i, i32 noundef %i109.0.lcssa.i, ptr noundef %add.ptr199.i, i32 noundef %add185.i)
  %166 = load ptr, ptr %seq168.i, align 8, !tbaa !35
  %167 = load i32, ptr %101, align 4, !tbaa !87
  %idx.ext207.i = zext i32 %167 to i64
  %add.ptr208.i = getelementptr inbounds i8, ptr %166, i64 %idx.ext207.i
  %add.ptr209.i = getelementptr inbounds i8, ptr %add.ptr208.i, i64 -1
  %call210.i = call ptr @strncpy(ptr noundef nonnull dereferenceable(1) %buf111.i, ptr noundef nonnull dereferenceable(1) %add.ptr209.i, i64 noundef 50) #19
  %arrayidx211.i = getelementptr inbounds [51 x i8], ptr %buf111.i, i64 0, i64 50
  store i8 0, ptr %arrayidx211.i, align 2, !tbaa !25
  %call213.i = call ptr @strstr(ptr noundef nonnull dereferenceable(1) %buf111.i, ptr noundef nonnull dereferenceable(1) @.str.29) #22
  %cmp214.i = icmp eq ptr %call213.i, null
  br i1 %cmp214.i, label %if.end219.i, label %if.then222.i

if.end219.i:                                      ; preds = %for.end182.i
  %call218.i = call ptr @strstr(ptr noundef nonnull dereferenceable(1) %buf111.i, ptr noundef nonnull dereferenceable(1) @.str.30) #22
...
if.then222.i:                                     ; preds = %if.end219.i, %for.end182.i
  ...
  %168 = load i32, ptr %101, align 4, !tbaa !87
  %169 = load i32, ptr getelementptr inbounds (%struct._options_t, ptr @options, i64 0, i32 15), align 4, !tbaa !29
  %170 = trunc i64 %sub.ptr.sub226.i to i32
  %171 = add i32 %168, 5
  %172 = add i32 %171, %169
  %conv233.i = add i32 %172, %170
...
if.end235.i:                                      ; preds = %if.then222.i, %if.end219.i
  call void @llvm.lifetime.end.p0(i64 51, ptr nonnull %buf111.i) #19
...
print_polyA_info.exit:                            ; preds = %if.end103.i, %if.end235.i
  ...
  %173 = load ptr, ptr %seq16, align 8, !tbaa !35
  %seq17 = getelementptr inbounds %struct._seq_t, ptr %seq2, i64 0, i32 2
  %174 = load ptr, ptr %seq17, align 8, !tbaa !35
  call fastcc void @print_align_lat(ptr noundef %173, ptr noundef %174, ptr noundef %res)
  br label %sw.epilog

sw.default:                                       ; preds = %if.end
  tail call void (ptr, ...) @fatal(ptr noundef nonnull @.str.22) #21
  unreachable
...
if.end19:                                         ; preds = %sw.epilog, %entry
  ...
  %175 = load i32, ptr %nb, align 8, !tbaa !91
  %cmp2161.not = icmp eq i32 %175, 0
  br i1 %cmp2161.not, label %for.end, label %for.body

for.body:                                         ; preds = %if.end19, %for.body
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body ], [ 0, %if.end19 ]
  %176 = load ptr, ptr %eCol20, align 8, !tbaa !25
  %arrayidx = getelementptr inbounds ptr, ptr %176, i64 %indvars.iv
  %177 = load ptr, ptr %arrayidx, align 8, !tbaa !5
  call void @free(ptr noundef %177) #19
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %178 = load i32, ptr %nb, align 8, !tbaa !91
  %179 = zext i32 %178 to i64
  %cmp21 = icmp ult i64 %indvars.iv.next, %179
  br i1 %cmp21, label %for.body, label %for.end, !llvm.loop !92

for.end:                                          ; preds = %for.body, %if.end19
  %180 = load ptr, ptr %eCol20, align 8, !tbaa !25
  call void @free(ptr noundef %180) #19
  %181 = load ptr, ptr %res, align 8, !tbaa !93
  %tobool25.not = icmp eq ptr %181, null
  br i1 %tobool25.not, label %if.end28, label %if.then26

if.then26:                                        ; preds = %for.end
  call void @free_align(ptr noundef nonnull %181) #19
  br label %if.end28

if.end28:                                         ; preds = %if.then26, %for.end
  call void @free(ptr noundef nonnull %res) #19
  ret void
}
...
entry:
  %0 = load ptr, ptr %r, align 8, !tbaa !93
...
while.body.lr.ph:                                 ; preds = %entry
  ...
  %add.ptr640 = getelementptr i8, ptr %seq1, i64 -2
  %add.ptr1042 = getelementptr i8, ptr %seq2, i64 -2
  br label %while.body

while.body:                                       ; preds = %while.body.lr.ph, %while.body
  %aligns.038 = phi ptr [ %0, %while.body.lr.ph ], [ %1, %while.body ]
  %1 = load ptr, ptr %aligns.038, align 8, !tbaa !94
  %len2 = getelementptr inbounds %struct._edit_script_list, ptr %aligns.038, i64 0, i32 5
  %2 = load i32, ptr %len2, align 4, !tbaa !96
  %mul = shl i32 %2, 1
  %add3 = add i32 %mul, 2
  %conv = zext i32 %add3 to i64
  %mul4 = shl nuw nsw i64 %conv, 2
  %call = tail call ptr @xmalloc(i64 noundef %mul4) #19
  %incdec.ptr = getelementptr inbounds i32, ptr %call, i64 1
  %script = getelementptr inbounds %struct._edit_script_list, ptr %aligns.038, i64 0, i32 1
  %3 = load ptr, ptr %script, align 8, !tbaa !97
  tail call void @S2A(ptr noundef %3, ptr noundef nonnull %incdec.ptr, i32 noundef 0) #19
  %4 = load ptr, ptr %script, align 8, !tbaa !97
  tail call void @Free_script(ptr noundef %4) #19
  %offset1 = getelementptr inbounds %struct._edit_script_list, ptr %aligns.038, i64 0, i32 2
  %5 = load i32, ptr %offset1, align 8, !tbaa !98
  %idx.ext = zext i32 %5 to i64
  %add.ptr7 = getelementptr i8, ptr %add.ptr640, i64 %idx.ext
  %offset2 = getelementptr inbounds %struct._edit_script_list, ptr %aligns.038, i64 0, i32 3
  %6 = load i32, ptr %offset2, align 4, !tbaa !99
  %idx.ext8 = zext i32 %6 to i64
  %add.ptr11 = getelementptr i8, ptr %add.ptr1042, i64 %idx.ext8
  %len1 = getelementptr inbounds %struct._edit_script_list, ptr %aligns.038, i64 0, i32 4
  %7 = load i32, ptr %len1, align 8, !tbaa !100
  %8 = load i32, ptr %len2, align 4, !tbaa !96
  %9 = load i32, ptr %direction, align 8, !tbaa !73
  tail call void @IDISPLAY(ptr noundef nonnull %add.ptr7, ptr noundef nonnull %add.ptr11, i32 noundef %7, i32 noundef %8, ptr noundef nonnull %incdec.ptr, i32 noundef %5, i32 noundef %6, ptr noundef nonnull %eCol, i32 noundef %9) #19
  tail call void @free(ptr noundef %call) #19
  tail call void @free(ptr noundef nonnull %aligns.038) #19
  %cmp2.not = icmp eq ptr %1, null
  br i1 %cmp2.not, label %while.end, label %while.body, !llvm.loop !101

while.end:                                        ; preds = %while.body
  store ptr null, ptr %r, align 8, !tbaa !93
  br label %cleanup
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %cur) #19
  store i64 0, ptr %cur, align 8, !tbaa !102
  %lc = getelementptr inbounds %struct._read_buf_t, ptr %b, i64 0, i32 2
  store i32 0, ptr %lc, align 4, !tbaa !58
...
do.body:                                          ; preds = %do.body.preheader, %do.cond
  %0 = load i32, ptr %ic, align 8, !tbaa !59
  %idx.ext = zext i32 %0 to i64
  %add.ptr = getelementptr inbounds i8, ptr %in, i64 %idx.ext
  %sub2 = sub i32 4095, %0
  %conv = zext i32 %sub2 to i64
  %call3 = tail call i64 @read(i32 noundef %fd, ptr noundef nonnull %add.ptr, i64 noundef %conv) #19
  %cmp4 = icmp eq i64 %call3, -1
  br i1 %cmp4, label %if.then6, label %if.else

if.then6:                                         ; preds = %do.body
  %call7 = tail call ptr @__errno_location() #23
  %1 = load i32, ptr %call7, align 4, !tbaa !9
  %cmp8.not = icmp eq i32 %1, 4
  br i1 %cmp8.not, label %if.end18, label %if.then10

if.then10:                                        ; preds = %if.then6
  %call12 = tail call ptr @strerror(i32 noundef %1) #19
  %2 = load i32, ptr %call7, align 4, !tbaa !9
  tail call void (ptr, ...) @fatal(ptr noundef nonnull @.str.33, i32 noundef %fd, ptr noundef %call12, i32 noundef %2) #21
  unreachable

if.else:                                          ; preds = %do.body
  %3 = load i32, ptr %ic, align 8, !tbaa !59
  %4 = trunc i64 %call3 to i32
  %conv17 = add i32 %3, %4
  store i32 %conv17, ptr %ic, align 8, !tbaa !59
  br label %if.end18
...
lor.lhs.false:                                    ; preds = %entry
  %1 = load i64, ptr %cur, align 8, !tbaa !102
...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %2 = load i32, ptr %lmax, align 8, !tbaa !57
  %conv4 = zext i32 %2 to i64
  %lc = getelementptr inbounds %struct._read_buf_t, ptr %b, i64 0, i32 2
  %3 = load i32, ptr %lc, align 4, !tbaa !58
...
if.then10:                                        ; preds = %if.end
  ...
  store i32 %add.i, ptr %lmax, align 8, !tbaa !57
  %4 = load ptr, ptr %b, align 8, !tbaa !56
  %conv.i = zext i32 %add.i to i64
  %call.i = tail call ptr @xrealloc(ptr noundef %4, i64 noundef %conv.i) #19
  store ptr %call.i, ptr %b, align 8, !tbaa !56
  %.pre = load i64, ptr %cur, align 8, !tbaa !102
  %.pre105 = load i32, ptr %ic, align 8, !tbaa !59
...
land.rhs:                                         ; preds = %if.end11, %while.body
  ...
  store i64 %inc30, ptr %cur, align 8, !tbaa !102
  %8 = load i8, ptr %arrayidx, align 1, !tbaa !25
  %9 = load ptr, ptr %b, align 8, !tbaa !56
  %10 = load i32, ptr %lc, align 4, !tbaa !58
  %inc34 = add i32 %10, 1
  store i32 %inc34, ptr %lc, align 4, !tbaa !58
...
while.body:                                       ; preds = %land.rhs
  %11 = load i64, ptr %cur, align 8, !tbaa !102
  %12 = load i32, ptr %ic, align 8, !tbaa !59
  %conv13 = zext i32 %12 to i64
  %cmp14 = icmp ult i64 %11, %conv13
  br i1 %cmp14, label %land.rhs, label %if.end59, !llvm.loop !105

if.then28:                                        ; preds = %land.rhs
  %13 = load ptr, ptr %b, align 8, !tbaa !56
  %14 = load i32, ptr %lc, align 4, !tbaa !58
  ...
  %15 = load i64, ptr %cur, align 8, !tbaa !102
  %16 = load i32, ptr %ic, align 8, !tbaa !59
...
if.then45:                                        ; preds = %if.then28
  ...
  %17 = load i64, ptr %cur, align 8, !tbaa !102
...
if.end57:                                         ; preds = %if.then28, %if.then45
  ...
  store i32 %storemerge, ptr %ic, align 8, !tbaa !59
  store i64 0, ptr %cur, align 8, !tbaa !102
  %19 = load ptr, ptr %b, align 8, !tbaa !56
  br label %return

if.end59:                                         ; preds = %while.body, %if.end11
  store i32 0, ptr %ic, align 8, !tbaa !59
  store i64 0, ptr %cur, align 8, !tbaa !102
  br label %return
...
!31 = !{!12, !10, i64 52}
!32 = !{!33, !6, i64 8}
!33 = !{!"_seq_t", !6, i64 0, !6, i64 8, !6, i64 16, !34, i64 24, !10, i64 4144, !10, i64 4148, !10, i64 4152, !10, i64 4156}
!34 = !{!"_read_buf_t", !6, i64 0, !10, i64 8, !10, i64 12, !10, i64 16, !7, i64 20}
!35 = !{!33, !6, i64 16}
!36 = !{!33, !10, i64 4148}
!37 = !{!12, !6, i64 8}
!38 = distinct !{!38, !27}
!39 = distinct !{!39, !27}
!40 = !{!41, !10, i64 8}
!41 = !{!"_collec_t", !7, i64 0, !10, i64 8, !10, i64 12}
!42 = !{!43, !10, i64 36}
!43 = !{!"_result_t", !6, i64 0, !41, i64 8, !10, i64 24, !10, i64 28, !10, i64 32, !44, i64 36}
!44 = !{!"_sim4_stats", !10, i64 0, !10, i64 4, !10, i64 8}
!45 = distinct !{!45, !46}
...
!74 = !{!44, !10, i64 4}
!75 = !{!76, !10, i64 12}
!76 = !{!"_exon_t", !10, i64 0, !10, i64 4, !10, i64 8, !10, i64 12, !10, i64 16, !10, i64 20, !10, i64 24, !10, i64 24, !10, i64 24, !10, i64 28, !10, i64 28, !10, i64 31}
!77 = distinct !{!77, !27}
!78 = !{!76, !10, i64 8}
!79 = distinct !{!79, !27, !80, !81}
!80 = !{!"llvm.loop.isvectorized", i32 1}
!81 = !{!"llvm.loop.unroll.runtime.disable"}
!82 = distinct !{!82, !46}
!83 = distinct !{!83, !27, !80}
!84 = !{!44, !10, i64 8}
!85 = !{!76, !10, i64 4}
!86 = distinct !{!86, !27}
!87 = !{!76, !10, i64 0}
!88 = distinct !{!88, !27, !80, !81}
!89 = distinct !{!89, !46}
!90 = distinct !{!90, !27, !80}
!91 = !{!43, !10, i64 16}
!92 = distinct !{!92, !27}
!93 = !{!43, !6, i64 0}
!94 = !{!95, !6, i64 0}
!95 = !{!"_edit_script_list", !6, i64 0, !6, i64 8, !10, i64 16, !10, i64 20, !10, i64 24, !10, i64 28, !10, i64 32}
!96 = !{!95, !10, i64 28}
!97 = !{!95, !6, i64 8}
!98 = !{!95, !10, i64 16}
!99 = !{!95, !10, i64 20}
