; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxcache.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxcache.c"
...
if.end28:                                         ; preds = %while.end.if.end28_crit_edge, %if.then27
  ...
  %18 = insertelement <4 x float> poison, float %0, i64 0
  %19 = insertelement <4 x float> %18, float %1, i64 1
  %20 = insertelement <4 x float> %19, float %2, i64 2
  %21 = insertelement <4 x float> %20, float %3, i64 3
  store <4 x float> %21, ptr %mxx42, align 8, !tbaa !59
  %num_chars = getelementptr inbounds %struct.cached_fm_pair_s, ptr %6, i64 %idx.ext32, i32 5
  store i32 0, ptr %num_chars, align 8, !tbaa !60
  br label %cleanup
...
entry:
  ...
  %0 = load i32, ptr %code, align 8, !tbaa !61
  %and = and i32 %0, 127
...
while.cond:                                       ; preds = %while.cond, %entry
  ...
  %1 = load ptr, ptr %head.0, align 8, !tbaa !62
  %cmp.not = icmp eq ptr %1, null
  br i1 %cmp.not, label %while.end, label %while.cond, !llvm.loop !63

while.end:                                        ; preds = %while.cond
  store ptr %cc, ptr %head.0, align 8, !tbaa !62
  store ptr null, ptr %cc, align 8, !tbaa !64
  %pair2 = getelementptr inbounds %struct.cached_char_s, ptr %cc, i64 0, i32 2
  store ptr %pair, ptr %pair2, align 8, !tbaa !65
  %num_chars = getelementptr inbounds %struct.cached_fm_pair_s, ptr %pair, i64 0, i32 5
  %2 = load i32, ptr %num_chars, align 8, !tbaa !60
  %inc = add nsw i32 %2, 1
  store i32 %inc, ptr %num_chars, align 8, !tbaa !60
  ret void
}
...
entry:
  ...
  %cc.09 = load ptr, ptr %arrayidx, align 8, !tbaa !62
...
if.then10:                                        ; preds = %if.end
  ...
  %6 = load ptr, ptr %dev_color, align 8, !tbaa !78
  %color = getelementptr inbounds %struct.gs_state_s, ptr %0, i64 0, i32 13
  %7 = load ptr, ptr %color, align 8, !tbaa !79
...
if.end15:                                         ; preds = %if.end13, %if.end
  ...
  %15 = load i32, ptr %cxmin, align 4, !tbaa !84
...
lor.lhs.false:                                    ; preds = %if.end15
  ...
  %16 = load i32, ptr %cxmax, align 4, !tbaa !85
...
lor.lhs.false34:                                  ; preds = %lor.lhs.false
  ...
  %17 = load i32, ptr %cymin, align 8, !tbaa !86
...
lor.lhs.false37:                                  ; preds = %lor.lhs.false34
  ...
  %18 = load i32, ptr %cymax, align 8, !tbaa !87
...
if.then41:                                        ; preds = %lor.lhs.false37, %lor.lhs.false34, %lor.lhs.false, %if.end15
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(96) %mat, ptr noundef nonnull align 8 dereferenceable(96) %ctm, i64 96, i1 false), !tbaa.struct !88
...
if.else:                                          ; preds = %lor.lhs.false37
  ...
  %29 = load ptr, ptr %dev_color57, align 8, !tbaa !78
...
!66 = distinct !{!66, !58}
!67 = !{!68, !10, i64 0}
!68 = !{!"gs_show_enum_s", !10, i64 0, !10, i64 8, !7, i64 16, !11, i64 20, !11, i64 24, !7, i64 28, !11, i64 32, !11, i64 36, !7, i64 40, !7, i64 44, !7, i64 48, !7, i64 52, !7, i64 56, !7, i64 60, !7, i64 64, !7, i64 68, !7, i64 72, !6, i64 80, !69, i64 280, !7, i64 312, !7, i64 316, !31, i64 320, !10, i64 336, !70, i64 344, !8, i64 352, !7, i64 356, !10, i64 360}
!69 = !{!"device_s", !10, i64 0, !7, i64 8, !14, i64 16, !14, i64 24}
!70 = !{!"gs_point_s", !11, i64 0, !11, i64 4}
!71 = !{!40, !10, i64 256}
!72 = !{!73, !8, i64 136}
!73 = !{!"gx_path_s", !41, i64 0, !74, i64 16, !10, i64 48, !74, i64 56, !10, i64 88, !10, i64 96, !7, i64 104, !7, i64 108, !7, i64 112, !31, i64 120, !8, i64 136, !8, i64 137, !8, i64 138}
!74 = !{!"gs_fixed_rect_s", !31, i64 0, !31, i64 16}
!75 = !{!73, !14, i64 120}
!76 = !{!73, !14, i64 128}
!77 = !{!68, !7, i64 356}
!78 = !{!40, !10, i64 312}
!79 = !{!40, !10, i64 304}
!80 = !{!81, !7, i64 16}
!81 = !{!"gx_device_color_s", !14, i64 0, !14, i64 8, !7, i64 16, !10, i64 24}
!82 = !{!30, !14, i64 48}
!83 = !{!30, !14, i64 56}
!84 = !{!68, !7, i64 60}
!85 = !{!68, !7, i64 68}
!86 = !{!68, !7, i64 64}
!87 = !{!68, !7, i64 72}
!88 = !{i64 0, i64 4, !59, i64 8, i64 8, !89, i64 16, i64 4, !59, i64 24, i64 8, !89, i64 32, i64 4, !59, i64 40, i64 8, !89, i64 48, i64 4, !59, i64 56, i64 8, !89, i64 64, i64 4, !59, i64 72, i64 8, !89, i64 80, i64 4, !59, i64 88, i64 8, !89}
!89 = !{!14, !14, i64 0}
!90 = !{!13, !11, i64 64}
!91 = !{!13, !11, i64 80}
!92 = !{!40, !10, i64 448}
