; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Common/FilePathAutoRename.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Common/FilePathAutoRename.cpp"
...
_ZN11CStringBaseIwEpLEw.exit:                     ; preds = %if.end, %if.end.i.i166, %if.end9.i.i.i
  ...
  store <2 x i32> <i32 95, i32 0>, ptr %arrayidx.i, align 4, !tbaa !11
  br label %while.body
