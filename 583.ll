; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/spiff/parse.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/spiff/parse.c"
...
if.then.i:                                        ; preds = %while.cond.i
  %call1.i = call fastcc i32 @_P_nextline()
...
if.then4.i.i:                                     ; preds = %while.body.i.i
  %call5.i.i = call fastcc i32 @_P_nextline()
...
land.lhs.true.i:                                  ; preds = %if.end14.i
  ...
  %20 = load i16, ptr %arrayidx.i, align 2, !tbaa !12
  %21 = and i16 %20, 8192
...
if.end105.i:                                      ; preds = %cond.false90.i, %cond.true77.i, %cond.false37.i, %cond.true.i
  ...
  store i32 %cond131.i, ptr %call126.i, align 8, !tbaa !14
  %pos.i = getelementptr inbounds %struct._K_str, ptr %call126.i, i64 0, i32 1
  store i32 %conv125.i, ptr %pos.i, align 4, !tbaa !16
...
if.then9.i.i:                                     ; preds = %while.body.i449.i
  %call10.i.i = call fastcc i32 @_P_nextline()
...
_P_litsnarf.exit.i:                               ; preds = %_P_litsnarf.exit.loopexit.i, %if.then63.i.i, %if.then135.i
  ...
  store i32 1, ptr %type.i, align 8, !tbaa !17
...
if.end210.i:                                      ; preds = %if.else.i, %for.end.i
  ...
  store ptr %100, ptr %text.i, align 8, !tbaa !20
...
if.then217.i:                                     ; preds = %if.else211.i
  ...
  store i32 2, ptr %type219.i, align 8, !tbaa !17
...
if.then222.i:                                     ; preds = %if.then217.i
  %105 = load ptr, ptr %text218.i, align 8, !tbaa !20
  ...
  store ptr %call224.i, ptr %flo_num.i, align 8, !tbaa !21
  ...
  store ptr %call225.i, ptr %tolerance.i, align 8, !tbaa !22
...
if.else234.i:                                     ; preds = %if.else211.i
  ...
  %113 = load i16, ptr %arrayidx238.i, align 2, !tbaa !12
...
for.end254.i:                                     ; preds = %for.cond243.i
  ...
  store i32 1, ptr %type259.i, align 8, !tbaa !17
...
for.cond272.i:                                    ; preds = %for.cond272.i.preheader, %for.inc292.i
  ...
  %123 = load i16, ptr %arrayidx276.i, align 2, !tbaa !12
...
for.inc292.i:                                     ; preds = %_P_in_alpha.exit471.i, %for.cond272.i
  ...
  br label %for.cond272.i, !llvm.loop !24
...
for.end294.i:                                     ; preds = %_P_in_alpha.exit471.i, %lor.rhs.i
  ...
  store i32 1, ptr %type299.i, align 8, !tbaa !17
...
if.else300.i:                                     ; preds = %_P_in_alpha.exit.i, %lor.lhs.false.i
  ...
  store i32 1, ptr %type302.i, align 8, !tbaa !17
...
!13 = !{!"short", !7, i64 0}
!14 = !{!15, !6, i64 0}
!15 = !{!"", !6, i64 0, !6, i64 4, !6, i64 8, !11, i64 16, !11, i64 24, !11, i64 32}
!16 = !{!15, !6, i64 4}
!17 = !{!15, !6, i64 8}
!18 = distinct !{!18, !19}
