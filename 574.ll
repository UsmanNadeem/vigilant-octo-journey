; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/d/parse.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/d/parse.c"
...
if.end:                                           ; preds = %for.body, %entry
  ...
  tail call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.6, i32 noundef %3, ptr noundef %4) #22
...
if.then:                                          ; preds = %entry
  tail call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.7, i32 noundef %pass_number) #22
...
if.then.i:                                        ; preds = %land.lhs.true2.i
  ...
  %call.i = tail call i32 %9(ptr noundef nonnull %add.ptr, ptr noundef %10, i32 noundef %11, i32 noundef 152, ptr noundef nonnull %ap) #22
  br label %if.end14
...
if.then.i:                                        ; preds = %land.lhs.true2.i
  ...
  %call.i = tail call i32 %5(ptr noundef nonnull %pn, ptr noundef %6, i32 noundef %7, i32 noundef 152, ptr noundef %p) #22
...
if.then.i:                                        ; preds = %land.lhs.true2.i
  ...
  %call.i = tail call i32 %16(ptr noundef nonnull %pn, ptr noundef %17, i32 noundef %18, i32 noundef 152, ptr noundef %p) #22
  br label %pass_call.exit
...
entry:
  ...
  %call = tail call ptr @d_dup_pathname_str(ptr noundef %0) #22
  ...
  %call2 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %1, ptr noundef nonnull @.str.10, ptr noundef %call, i32 noundef %2) #23
...
entry:
  ...
  %call = tail call fastcc i32 @exhaustive_parse(ptr noundef %0, i32 noundef %3)
  %tobool.not = icmp eq i32 %call, 0
  br i1 %tobool.not, label %if.then, label %if.end11

if.then:                                          ; preds = %entry
  %accept = getelementptr inbounds %struct.Parser, ptr %0, i64 0, i32 16
  %4 = load ptr, ptr %accept, align 8, !tbaa !98
  %tobool1.not = icmp eq ptr %4, null
  br i1 %tobool1.not, label %if.end11, label %if.then2

if.then2:                                         ; preds = %if.then
  %loc4 = getelementptr inbounds %struct.SNode, ptr %4, i64 0, i32 3
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %loc, ptr noundef nonnull align 8 dereferenceable(32) %loc4, i64 32, i1 false), !tbaa.struct !99
  %5 = load ptr, ptr %accept, align 8, !tbaa !98
  %refcount = getelementptr inbounds %struct.SNode, ptr %5, i64 0, i32 7
  %6 = load i32, ptr %refcount, align 8, !tbaa !100
  %dec = add i32 %6, -1
  store i32 %dec, ptr %refcount, align 8, !tbaa !100
...
do.end:                                           ; preds = %if.then7, %if.then2
  store ptr null, ptr %accept, align 8, !tbaa !98
  br label %if.end11
...
entry:
  ...
  %1 = load ptr, ptr %loc2, align 8, !tbaa !101
  %cmp = icmp eq ptr %1, %0
  %. = select i1 %cmp, ptr %0, ptr null
  %2 = load i8, ptr %0, align 1, !tbaa !21
  %cmp4 = icmp eq i8 %2, 35
  br i1 %cmp4, label %land.lhs.true, label %if.end207

land.lhs.true:                                    ; preds = %entry
  %previous_col = getelementptr inbounds %struct.d_loc_t, ptr %loc, i64 0, i32 2
  %3 = load i32, ptr %previous_col, align 8, !tbaa !102
  %cmp6 = icmp eq i32 %3, 0
  br i1 %cmp6, label %Ldirective, label %if.end207

Ldirective:                                       ; preds = %if.then218, %land.lhs.true
  %s.0 = phi ptr [ %0, %land.lhs.true ], [ %incdec.ptr213, %if.then218 ]
  %scol.1 = phi ptr [ %., %land.lhs.true ], [ %incdec.ptr213, %if.then218 ]
  br label %while.cond
...
while.cond:                                       ; preds = %while.cond, %Ldirective
  ...
  br i1 %tobool.not, label %cond.false143, label %while.cond, !llvm.loop !103

cond.false143:                                    ; preds = %while.cond
  %call144 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(5) @.str.11, ptr noundef nonnull dereferenceable(1) %s.1, i64 noundef 4) #24
  %tobool145.not = icmp eq i32 %call144, 0
  br i1 %tobool145.not, label %if.then146, label %if.end161

if.then146:                                       ; preds = %cond.false143
  %arrayidx147 = getelementptr inbounds i8, ptr %s.0.pn, i64 5
  %6 = load i8, ptr %arrayidx147, align 1, !tbaa !21
  %idxprom148 = zext i8 %6 to i64
  %arrayidx149 = getelementptr inbounds [256 x i8], ptr @_wspace, i64 0, i64 %idxprom148
  %7 = load i8, ptr %arrayidx149, align 1, !tbaa !21
  %tobool150.not = icmp eq i8 %7, 0
  br i1 %tobool150.not, label %if.end161, label %if.then151

if.then151:                                       ; preds = %if.then146
  %add.ptr152 = getelementptr inbounds i8, ptr %s.0.pn, i64 6
  br label %while.cond153

while.cond153:                                    ; preds = %while.cond153, %if.then151
  %s.2 = phi ptr [ %add.ptr152, %if.then151 ], [ %incdec.ptr158, %while.cond153 ]
  %8 = load i8, ptr %s.2, align 1, !tbaa !21
  %idxprom154 = zext i8 %8 to i64
  %arrayidx155 = getelementptr inbounds [256 x i8], ptr @_wspace, i64 0, i64 %idxprom154
  %9 = load i8, ptr %arrayidx155, align 1, !tbaa !21
  %tobool156.not = icmp eq i8 %9, 0
  %incdec.ptr158 = getelementptr inbounds i8, ptr %s.2, i64 1
  br i1 %tobool156.not, label %if.end161, label %while.cond153, !llvm.loop !104

if.end161:                                        ; preds = %while.cond153, %if.then146, %cond.false143
  %10 = phi i8 [ %4, %cond.false143 ], [ %4, %if.then146 ], [ %8, %while.cond153 ]
  %s.3 = phi ptr [ %s.1, %cond.false143 ], [ %s.1, %if.then146 ], [ %s.2, %while.cond153 ]
  %call162 = tail call ptr @__ctype_b_loc() #25
  %11 = load ptr, ptr %call162, align 8, !tbaa !16
  %idxprom164 = sext i8 %10 to i64
  %arrayidx165 = getelementptr inbounds i16, ptr %11, i64 %idxprom164
  %12 = load i16, ptr %arrayidx165, align 2, !tbaa !105
  %13 = and i16 %12, 2048
  %tobool167.not = icmp eq i16 %13, 0
  br i1 %tobool167.not, label %Ldone, label %if.then168

if.then168:                                       ; preds = %if.end161
  %call.i = tail call i64 @strtol(ptr nocapture noundef nonnull %s.3, ptr noundef null, i32 noundef 10) #22
  %conv.i = trunc i64 %call.i to i32
  %sub170 = add nsw i32 %conv.i, -1
  %line = getelementptr inbounds %struct.d_loc_t, ptr %loc, i64 0, i32 4
  store i32 %sub170, ptr %line, align 8, !tbaa !106
  %14 = load ptr, ptr %call162, align 8, !tbaa !16
  br label %while.cond171

while.cond171:                                    ; preds = %while.cond171, %if.then168
  %s.4 = phi ptr [ %s.3, %if.then168 ], [ %incdec.ptr180, %while.cond171 ]
  %15 = load i8, ptr %s.4, align 1, !tbaa !21
  %idxprom174 = sext i8 %15 to i64
  %arrayidx175 = getelementptr inbounds i16, ptr %14, i64 %idxprom174
  %16 = load i16, ptr %arrayidx175, align 2, !tbaa !105
  %17 = and i16 %16, 2048
  %tobool178.not = icmp eq i16 %17, 0
  %incdec.ptr180 = getelementptr inbounds i8, ptr %s.4, i64 1
  br i1 %tobool178.not, label %while.cond182, label %while.cond171, !llvm.loop !107

while.cond182:                                    ; preds = %while.cond171, %while.cond182
  %s.5 = phi ptr [ %incdec.ptr187, %while.cond182 ], [ %s.4, %while.cond171 ]
  %18 = load i8, ptr %s.5, align 1, !tbaa !21
  %idxprom183 = zext i8 %18 to i64
  %arrayidx184 = getelementptr inbounds [256 x i8], ptr @_wspace, i64 0, i64 %idxprom183
  %19 = load i8, ptr %arrayidx184, align 1, !tbaa !21
  %tobool185.not = icmp eq i8 %19, 0
  %incdec.ptr187 = getelementptr inbounds i8, ptr %s.5, i64 1
  br i1 %tobool185.not, label %while.end188, label %while.cond182, !llvm.loop !108

while.end188:                                     ; preds = %while.cond182
  %cmp190 = icmp eq i8 %18, 34
  br i1 %cmp190, label %if.then192, label %while.cond196.preheader

if.then192:                                       ; preds = %while.end188
  %pathname = getelementptr inbounds %struct.d_loc_t, ptr %loc, i64 0, i32 1
  store ptr %s.5, ptr %pathname, align 8, !tbaa !109
  br label %while.cond196.preheader

while.cond196.preheader:                          ; preds = %if.then192, %while.end188
  br label %while.cond196

while.cond196:                                    ; preds = %while.cond196.preheader, %while.body204
  %s.7 = phi ptr [ %incdec.ptr205, %while.body204 ], [ %s.5, %while.cond196.preheader ]
  %20 = load i8, ptr %s.7, align 1, !tbaa !21
  switch i8 %20, label %while.body204 [
    i8 0, label %if.end207
    i8 10, label %if.end207
  ]

while.body204:                                    ; preds = %while.cond196
  %incdec.ptr205 = getelementptr inbounds i8, ptr %s.7, i64 1
  br label %while.cond196, !llvm.loop !110

if.end207:                                        ; preds = %while.cond196, %while.cond196, %land.lhs.true, %entry
  %s.8 = phi ptr [ %0, %land.lhs.true ], [ %0, %entry ], [ %s.7, %while.cond196 ], [ %s.7, %while.cond196 ]
  %scol.2 = phi ptr [ %., %land.lhs.true ], [ %., %entry ], [ %scol.1, %while.cond196 ], [ %scol.1, %while.cond196 ]
  %line249 = getelementptr inbounds %struct.d_loc_t, ptr %loc, i64 0, i32 4
  br label %Lmore.outer

Lmore.outer:                                      ; preds = %Lmore.outer.backedge, %if.end207
  %s.9.ph = phi ptr [ %s.8, %if.end207 ], [ %s.9.ph.be, %Lmore.outer.backedge ]
  %scol.3.ph = phi ptr [ %scol.2, %if.end207 ], [ %scol.3.ph.be, %Lmore.outer.backedge ]
  br label %while.cond208

while.cond208:                                    ; preds = %while.cond208.backedge, %Lmore.outer
  %s.10 = phi ptr [ %s.9.ph, %Lmore.outer ], [ %s.10.be, %while.cond208.backedge ]
  %21 = load i8, ptr %s.10, align 1, !tbaa !21
  %idxprom209 = zext i8 %21 to i64
  %arrayidx210 = getelementptr inbounds [256 x i8], ptr @_wspace, i64 0, i64 %idxprom209
  %22 = load i8, ptr %arrayidx210, align 1, !tbaa !21
  %tobool211.not = icmp eq i8 %22, 0
  %incdec.ptr213 = getelementptr inbounds i8, ptr %s.10, i64 1
  br i1 %tobool211.not, label %while.end214, label %while.cond208.backedge

while.cond208.backedge:                           ; preds = %while.cond208, %while.end248
  %s.10.be = phi ptr [ %incdec.ptr213, %while.cond208 ], [ %incdec.ptr251, %while.end248 ]
  br label %while.cond208, !llvm.loop !111

while.end214:                                     ; preds = %while.cond208
  switch i8 %21, label %Ldone [
    i8 10, label %if.then218
    i8 47, label %if.then232
  ]

if.then218:                                       ; preds = %while.end214
  %23 = load i32, ptr %line249, align 8, !tbaa !106
  %inc = add nsw i32 %23, 1
  store i32 %inc, ptr %line249, align 8, !tbaa !106
  %24 = load i8, ptr %incdec.ptr213, align 1, !tbaa !21
  %cmp223 = icmp eq i8 %24, 35
  br i1 %cmp223, label %Ldirective, label %Lmore.outer.backedge

Lmore.outer.backedge:                             ; preds = %if.then272, %if.then218
  %s.9.ph.be = phi ptr [ %incdec.ptr213, %if.then218 ], [ %add.ptr273, %if.then272 ]
  %scol.3.ph.be = phi ptr [ %incdec.ptr213, %if.then218 ], [ %scol.6, %if.then272 ]
  br label %Lmore.outer

if.then232:                                       ; preds = %while.end214
  %25 = load i8, ptr %incdec.ptr213, align 1, !tbaa !21
  switch i8 %25, label %Ldone [
    i8 47, label %while.cond238
    i8 42, label %LnestComment
  ]

while.cond238:                                    ; preds = %if.then232, %while.body246
  %26 = phi i8 [ %.pre, %while.body246 ], [ %25, %if.then232 ]
  %s.11 = phi ptr [ %incdec.ptr247, %while.body246 ], [ %s.10, %if.then232 ]
  switch i8 %26, label %while.body246 [
    i8 0, label %while.end248
    i8 10, label %while.end248
  ]

while.body246:                                    ; preds = %while.cond238
  %incdec.ptr247 = getelementptr inbounds i8, ptr %s.11, i64 1
  %.pre = load i8, ptr %incdec.ptr247, align 1, !tbaa !21
  br label %while.cond238, !llvm.loop !112

while.end248:                                     ; preds = %while.cond238, %while.cond238
  %27 = load i32, ptr %line249, align 8, !tbaa !106
  %inc250 = add nsw i32 %27, 1
  store i32 %inc250, ptr %line249, align 8, !tbaa !106
  %incdec.ptr251 = getelementptr inbounds i8, ptr %s.11, i64 1
  br label %while.cond208.backedge

LnestComment:                                     ; preds = %land.lhs.true282, %if.then232
  %s.10.pn = phi ptr [ %s.10, %if.then232 ], [ %s.14, %land.lhs.true282 ]
  %scol.4 = phi ptr [ %scol.3.ph, %if.then232 ], [ %scol.6, %land.lhs.true282 ]
  %rec.3 = phi i32 [ 0, %if.then232 ], [ %rec.4, %land.lhs.true282 ]
  %s.12 = getelementptr inbounds i8, ptr %s.10.pn, i64 2
  %inc259 = add nsw i32 %rec.3, 1
  br label %LmoreComment

LmoreComment:                                     ; preds = %if.then272, %LnestComment
  %s.13 = phi ptr [ %s.12, %LnestComment ], [ %add.ptr273, %if.then272 ]
  %scol.5 = phi ptr [ %scol.4, %LnestComment ], [ %scol.6, %if.then272 ]
  %rec.4 = phi i32 [ %inc259, %LnestComment ], [ %dec, %if.then272 ]
  br label %while.cond260

while.cond260:                                    ; preds = %if.end297, %LmoreComment
  %s.14 = phi ptr [ %s.13, %LmoreComment ], [ %incdec.ptr298, %if.end297 ]
  %scol.6 = phi ptr [ %scol.5, %LmoreComment ], [ %scol.7, %if.end297 ]
  %28 = load i8, ptr %s.14, align 1, !tbaa !21
  switch i8 %28, label %if.end297 [
    i8 0, label %Ldone
    i8 42, label %land.lhs.true267
    i8 47, label %land.lhs.true282
    i8 10, label %if.then293
  ]

land.lhs.true267:                                 ; preds = %while.cond260
  %arrayidx268 = getelementptr inbounds i8, ptr %s.14, i64 1
  %29 = load i8, ptr %arrayidx268, align 1, !tbaa !21
  %cmp270 = icmp eq i8 %29, 47
  br i1 %cmp270, label %if.then272, label %if.end297

if.then272:                                       ; preds = %land.lhs.true267
  %add.ptr273 = getelementptr inbounds i8, ptr %s.14, i64 2
  %dec = add nsw i32 %rec.4, -1
  %tobool274.not = icmp eq i32 %dec, 0
  br i1 %tobool274.not, label %Lmore.outer.backedge, label %LmoreComment

land.lhs.true282:                                 ; preds = %while.cond260
  %arrayidx283 = getelementptr inbounds i8, ptr %s.14, i64 1
  %30 = load i8, ptr %arrayidx283, align 1, !tbaa !21
  %cmp285 = icmp eq i8 %30, 42
  br i1 %cmp285, label %LnestComment, label %if.end297

if.then293:                                       ; preds = %while.cond260
  %31 = load i32, ptr %line249, align 8, !tbaa !106
  %inc295 = add nsw i32 %31, 1
  store i32 %inc295, ptr %line249, align 8, !tbaa !106
  %add.ptr296 = getelementptr inbounds i8, ptr %s.14, i64 1
  br label %if.end297

if.end297:                                        ; preds = %while.cond260, %land.lhs.true267, %land.lhs.true282, %if.then293
  %scol.7 = phi ptr [ %add.ptr296, %if.then293 ], [ %scol.6, %land.lhs.true282 ], [ %scol.6, %land.lhs.true267 ], [ %scol.6, %while.cond260 ]
  %incdec.ptr298 = getelementptr inbounds i8, ptr %s.14, i64 1
  br label %while.cond260, !llvm.loop !113

Ldone:                                            ; preds = %if.then232, %while.end214, %while.cond260, %if.end161
  %s.15 = phi ptr [ %s.0, %if.end161 ], [ %s.14, %while.cond260 ], [ %s.10, %while.end214 ], [ %s.10, %if.then232 ]
  %scol.8 = phi ptr [ %scol.1, %if.end161 ], [ %scol.6, %while.cond260 ], [ %scol.3.ph, %while.end214 ], [ %scol.3.ph, %if.then232 ]
  %tobool302.not = icmp eq ptr %scol.8, null
  %sub.ptr.lhs.cast = ptrtoint ptr %s.15 to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %scol.8 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %conv304 = trunc i64 %sub.ptr.sub to i32
  %conv304.sink = select i1 %tobool302.not, i32 -1, i32 %conv304
  %32 = getelementptr inbounds %struct.d_loc_t, ptr %loc, i64 0, i32 3
  store i32 %conv304.sink, ptr %32, align 4
...
entry:
  ...
  %0 = load ptr, ptr %top_scope, align 8, !tbaa !114
  %tobool.not = icmp eq ptr %0, null
  br i1 %tobool.not, label %if.end, label %land.lhs.true

land.lhs.true:                                    ; preds = %entry
  %initial_scope = getelementptr inbounds %struct.D_Parser, ptr %ap, i64 0, i32 2
  %1 = load ptr, ptr %initial_scope, align 8, !tbaa !115
  %tobool1.not = icmp eq ptr %1, null
  br i1 %tobool1.not, label %if.then, label %if.end

if.then:                                          ; preds = %land.lhs.true
  tail call void @free_D_Scope(ptr noundef nonnull %0, i32 noundef 0) #22
  br label %if.end
...
if.end6:                                          ; preds = %if.then4, %if.end
  tail call void @free(ptr noundef nonnull %ap) #22
  ret void
}
...
entry:
  ...
  %0 = load ptr, ptr %free_node_fn, align 8, !tbaa !116
  %tobool.not = icmp eq ptr %0, null
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %parse_node = getelementptr inbounds %struct.PNode, ptr %pn, i64 0, i32 19
  tail call void %0(ptr noundef nonnull %parse_node) #22
  br label %if.end
...
for.inc:                                          ; preds = %do.body, %if.then5
  ...
  br i1 %cmp, label %do.body, label %do.body11, !llvm.loop !117
...
if.end35:                                         ; preds = %if.then33, %do.body23
  ...
  %10 = load ptr, ptr %latest, align 8, !tbaa !118
...
if.end48:                                         ; preds = %do.body38, %if.then43, %if.end35
  ...
  %12 = load ptr, ptr %free_pnodes, align 8, !tbaa !119
  %all_next = getelementptr inbounds %struct.PNode, ptr %pn, i64 0, i32 11
  store ptr %12, ptr %all_next, align 8, !tbaa !120
  store ptr %pn, ptr %free_pnodes, align 8, !tbaa !119
  ret void
}
...
entry:
  ...
  tail call fastcc void @free_old_nodes(ptr noundef %p)
  %pnode_hash = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 11
  %0 = load ptr, ptr %pnode_hash, align 8, !tbaa !121
  %tobool.not = icmp eq ptr %0, null
  br i1 %tobool.not, label %if.end, label %if.then
...
if.end:                                           ; preds = %if.then, %entry
  %snode_hash = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 12
  %1 = load ptr, ptr %snode_hash, align 8, !tbaa !122
...
if.end8:                                          ; preds = %if.then5, %if.end
  ...
  %2 = load ptr, ptr %reductions_todo, align 8, !tbaa !123
...
while.body22.lr.ph:                               ; preds = %while.cond20.preheader
  ...
  %.pre186 = load ptr, ptr %free_shifts, align 8, !tbaa !126
...
if.then14:                                        ; preds = %while.body
  ...
  %.pre185 = load ptr, ptr %free_reductions, align 8, !tbaa !124
  br label %do.end

do.end:                                           ; preds = %if.then14, %while.body
  %9 = phi ptr [ %.pre185, %if.then14 ], [ %4, %while.body ]
  tail call void @free(ptr noundef %9) #22
  store ptr %6, ptr %free_reductions, align 8, !tbaa !124
  %10 = load ptr, ptr %reductions_todo, align 8, !tbaa !123
  %tobool11.not = icmp eq ptr %10, null
  br i1 %tobool11.not, label %while.cond20.preheader, label %while.body, !llvm.loop !130
...
while.cond39.preheader:                           ; preds = %do.end35, %while.cond20.preheader
  ...
  %11 = load ptr, ptr %free_reductions40, align 8, !tbaa !124
...
while.body22:                                     ; preds = %while.body22.lr.ph, %do.end35
  ...
  %14 = load ptr, ptr %next23, align 8, !tbaa !131
  %15 = load ptr, ptr %13, align 8, !tbaa !133
  %refcount27 = getelementptr inbounds %struct.SNode, ptr %15, i64 0, i32 7
  %16 = load i32, ptr %refcount27, align 8, !tbaa !100
  %dec28 = add i32 %16, -1
  store i32 %dec28, ptr %refcount27, align 8, !tbaa !100
...
if.then30:                                        ; preds = %while.body22
  ...
  %.pre187 = load ptr, ptr %free_shifts, align 8, !tbaa !126
  br label %do.end35

do.end35:                                         ; preds = %if.then30, %while.body22
  %17 = phi ptr [ %.pre187, %if.then30 ], [ %12, %while.body22 ]
  tail call void @free(ptr noundef %17) #22
  store ptr %14, ptr %free_shifts, align 8, !tbaa !126
  %18 = load ptr, ptr %shifts_todo, align 8, !tbaa !125
  %tobool21.not = icmp eq ptr %18, null
  br i1 %tobool21.not, label %while.cond39.preheader, label %while.body22, !llvm.loop !134
...
while.cond49.preheader:                           ; preds = %while.body42, %while.cond39.preheader
  ...
  %19 = load ptr, ptr %free_shifts50, align 8, !tbaa !126
...
while.body42:                                     ; preds = %while.cond39.preheader, %while.body42
  ...
  %21 = load ptr, ptr %next45, align 8, !tbaa !127
  tail call void @free(ptr noundef nonnull %20) #22
  store ptr %21, ptr %free_reductions40, align 8, !tbaa !124
  %tobool41.not = icmp eq ptr %21, null
  br i1 %tobool41.not, label %while.cond49.preheader, label %while.body42, !llvm.loop !135

while.cond59.preheader:                           ; preds = %while.body52, %while.cond49.preheader
  %free_pnodes = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 21
  %22 = load ptr, ptr %free_pnodes, align 8, !tbaa !119
...
while.body52:                                     ; preds = %while.cond49.preheader, %while.body52
  ...
  %24 = load ptr, ptr %next55, align 8, !tbaa !131
  tail call void @free(ptr noundef nonnull %23) #22
  store ptr %24, ptr %free_shifts50, align 8, !tbaa !126
  %tobool51.not = icmp eq ptr %24, null
  br i1 %tobool51.not, label %while.cond59.preheader, label %while.body52, !llvm.loop !136
...
while.cond66.preheader:                           ; preds = %while.body61, %while.cond59.preheader
  ...
  %25 = load ptr, ptr %free_znodes, align 8, !tbaa !137
...
while.body61:                                     ; preds = %while.cond59.preheader, %while.body61
  ...
  %27 = load ptr, ptr %all_next, align 8, !tbaa !120
  tail call void @free(ptr noundef nonnull %26) #22
  store ptr %27, ptr %free_pnodes, align 8, !tbaa !119
  %tobool60.not = icmp eq ptr %27, null
  br i1 %tobool60.not, label %while.cond66.preheader, label %while.body61, !llvm.loop !138
...
while.cond74.preheader:                           ; preds = %while.body68, %while.cond66.preheader
  ...
  %28 = load ptr, ptr %free_snodes, align 8, !tbaa !139
...
while.body68:                                     ; preds = %while.cond66.preheader, %while.body68
  ...
  store ptr %30, ptr %free_znodes, align 8, !tbaa !137
  %tobool67.not = icmp eq ptr %30, null
  br i1 %tobool67.not, label %while.cond74.preheader, label %while.body68, !llvm.loop !140
...
for.cond.preheader:                               ; preds = %while.body76, %while.cond74.preheader
  ...
  %31 = load i32, ptr %error_reductions, align 8, !tbaa !141
...
while.body76:                                     ; preds = %while.cond74.preheader, %while.body76
  ...
  %33 = load ptr, ptr %all_next78, align 8, !tbaa !142
  tail call void @free(ptr noundef nonnull %32) #22
  store ptr %33, ptr %free_snodes, align 8, !tbaa !139
  %tobool75.not = icmp eq ptr %33, null
  br i1 %tobool75.not, label %for.cond.preheader, label %while.body76, !llvm.loop !143

for.body:                                         ; preds = %for.body.lr.ph, %for.body
  %indvars.iv = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next, %for.body ]
  %34 = load ptr, ptr %v83, align 8, !tbaa !144
...
do.body96:                                        ; preds = %do.body84, %if.then92
  store i32 0, ptr %error_reductions, align 8, !tbaa !141
  store ptr null, ptr %v86, align 8, !tbaa !144
...
if.end108:                                        ; preds = %if.then106, %do.body96
  ...
  %40 = load ptr, ptr %shift_results, align 8, !tbaa !146
  tail call void @free(ptr noundef %40) #22
  store ptr null, ptr %shift_results, align 8, !tbaa !146
  ret void
}

; Function Attrs: mustprogress nofree nounwind willreturn memory(readwrite, argmem: read) uwtable
define dso_local noalias ptr @new_subparser(ptr nocapture noundef readonly %p) local_unnamed_addr #14 {
entry:
  %t = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 3
  %0 = load ptr, ptr %t, align 8, !tbaa !23
...
new_D_Parser.exit:                                ; preds = %if.then.i, %if.then15.i, %if.else18.i
  ...
  store i32 10, ptr %i.i, align 8, !tbaa !149
  ...
  store i32 %7, ptr %m.i, align 4, !tbaa !150
  %conv.i = zext i32 %7 to i64
  %mul.i = shl nuw nsw i64 %conv.i, 3
  %calloc.i9 = tail call ptr @calloc(i64 1, i64 %mul.i)
  store ptr %calloc.i9, ptr %pnode_hash.i, align 8, !tbaa !121
  ...
  store i32 8, ptr %i13.i, align 8, !tbaa !151
...
entry:
  ...
  store i32 0, ptr %states, align 8, !tbaa !154
  ...
  store ptr %add.ptr, ptr %end, align 8, !tbaa !147
...
if.then.i:                                        ; preds = %entry
  ...
  store i32 1, ptr %partial_parses.i, align 8, !tbaa !155
...
initialize_whitespace_parser.exit:                ; preds = %entry, %if.then.i
  ...
  store i32 %3, ptr %m.i, align 4, !tbaa !150
  %conv.i = zext i32 %3 to i64
  %mul.i = shl nuw nsw i64 %conv.i, 3
  %calloc.i = tail call ptr @calloc(i64 1, i64 %mul.i)
  store ptr %calloc.i, ptr %pnode_hash.i, align 8, !tbaa !121
  ...
  store ptr %call35.i, ptr %shift_results.i, align 8, !tbaa !146
  %initial_scope = getelementptr inbounds %struct.D_Parser, ptr %ap, i64 0, i32 2
  %6 = load ptr, ptr %initial_scope, align 8, !tbaa !115
  %tobool.not = icmp eq ptr %6, null
  %top_scope3 = getelementptr inbounds %struct.Parser, ptr %ap, i64 0, i32 15
  br i1 %tobool.not, label %if.else, label %if.then

if.then:                                          ; preds = %initialize_whitespace_parser.exit
  store ptr %6, ptr %top_scope3, align 8, !tbaa !114
  br label %if.end9

if.else:                                          ; preds = %initialize_whitespace_parser.exit
  %7 = load ptr, ptr %top_scope3, align 8, !tbaa !114
  %tobool4.not = icmp eq ptr %7, null
  br i1 %tobool4.not, label %if.end, label %if.then5

if.then5:                                         ; preds = %if.else
  tail call void @free_D_Scope(ptr noundef nonnull %7, i32 noundef 0) #22
  br label %if.end

if.end:                                           ; preds = %if.then5, %if.else
  %call = tail call ptr @new_D_Scope(ptr noundef null) #22
  store ptr %call, ptr %top_scope3, align 8, !tbaa !114
...
if.end9:                                          ; preds = %if.end, %if.then
  ...
  %8 = load i32, ptr %start_state, align 8, !tbaa !156
  %call11 = tail call fastcc i32 @exhaustive_parse(ptr noundef nonnull %ap, i32 noundef %8)
...
if.then13:                                        ; preds = %if.end9
  %9 = load ptr, ptr %accept, align 8, !tbaa !98
  %zns = getelementptr inbounds %struct.SNode, ptr %9, i64 0, i32 6
  %10 = load i32, ptr %zns, align 8, !tbaa !157
...
lor.lhs.false:                                    ; preds = %if.then13
  ...
  %11 = load ptr, ptr %v, align 8, !tbaa !158
...
if.then18:                                        ; preds = %lor.lhs.false, %if.then13
  tail call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.8) #22
  %v21.phi.trans.insert = getelementptr inbounds %struct.SNode, ptr %9, i64 0, i32 6, i32 2
  %.pre108 = load ptr, ptr %v21.phi.trans.insert, align 8, !tbaa !158
  %.pre109 = load ptr, ptr %.pre108, align 8, !tbaa !16
  %.pre110 = load ptr, ptr %.pre109, align 8, !tbaa !159
  br label %if.end19
...
if.end19:                                         ; preds = %if.then18, %lor.lhs.false
  ...
  %16 = load ptr, ptr %latest, align 8, !tbaa !118
...
if.then29:                                        ; preds = %if.end19
  %20 = load i32, ptr %states, align 8, !tbaa !154
  %21 = load i32, ptr %scans, align 8, !tbaa !161
  %22 = load i32, ptr %shifts, align 4, !tbaa !162
  %23 = load i32, ptr %reductions, align 8, !tbaa !163
  %24 = load i32, ptr %compares, align 4, !tbaa !164
...
do.body52:                                        ; preds = %if.end45, %do.body
  ...
  %30 = load ptr, ptr %accept, align 8, !tbaa !98
  %refcount54 = getelementptr inbounds %struct.SNode, ptr %30, i64 0, i32 7
  %31 = load i32, ptr %refcount54, align 8, !tbaa !100
  %dec = add i32 %31, -1
  store i32 %dec, ptr %refcount54, align 8, !tbaa !100
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 240, ptr nonnull %tpn) #22
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %loc) #22
  ...
  store ptr %0, ptr %loc1, align 8, !tbaa !165
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %loc, ptr noundef nonnull align 8 dereferenceable(32) %loc1, i64 32, i1 false), !tbaa.struct !99
  ...
  call void %1(ptr noundef %p, ptr noundef nonnull %loc, ptr noundef %p) #22
  %t = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 3
  %2 = load ptr, ptr %t, align 8, !tbaa !23
  ...
  %4 = load ptr, ptr %top_scope, align 8, !tbaa !114
  %5 = load ptr, ptr %p, align 8, !tbaa !166
  %call = call fastcc ptr @add_SNode(ptr noundef nonnull %p, ptr noundef %arrayidx, ptr noundef nonnull %loc, ptr noundef %4, ptr noundef %5)
  ...
  %8 = load ptr, ptr %top_scope, align 8, !tbaa !114
  %scope = getelementptr inbounds %struct.PNode, ptr %tpn, i64 0, i32 19, i32 4
  store ptr %8, ptr %scope, align 8, !tbaa !167
  ...
  store ptr %9, ptr %end, align 8, !tbaa !168
  ...
  store ptr %call20, ptr %last_pn, align 8, !tbaa !169
  ...
  %10 = load ptr, ptr %free_znodes.i, align 8, !tbaa !137
  %tobool.not.i = icmp eq ptr %10, null
  br i1 %tobool.not.i, label %if.then.i, label %if.else.i

if.then.i:                                        ; preds = %entry
  %call.i = call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #26
  br label %new_ZNode.exit

if.else.i:                                        ; preds = %entry
  %11 = load ptr, ptr %10, align 8, !tbaa !16
  store ptr %11, ptr %free_znodes.i, align 8, !tbaa !137
  br label %new_ZNode.exit

new_ZNode.exit:                                   ; preds = %if.then.i, %if.else.i
  %z.0.i = phi ptr [ %10, %if.else.i ], [ %call.i, %if.then.i ]
  store ptr %call20, ptr %z.0.i, align 8, !tbaa !159
  %sns.i = getelementptr inbounds %struct.ZNode, ptr %z.0.i, i64 0, i32 1
  store i32 0, ptr %sns.i, align 8, !tbaa !170
  %v.i = getelementptr inbounds %struct.ZNode, ptr %z.0.i, i64 0, i32 1, i32 2
  store ptr null, ptr %v.i, align 8, !tbaa !171
...
while.cond:                                       ; preds = %while.cond.outer, %error_recovery.exit
  ...
  %13 = load ptr, ptr %reductions_todo, align 8, !tbaa !123
...
while.body23:                                     ; preds = %land.rhs, %while.cond
  ...
  %15 = load ptr, ptr %snode, align 8, !tbaa !129
  %loc25 = getelementptr inbounds %struct.SNode, ptr %15, i64 0, i32 3
  %16 = load ptr, ptr %loc25, align 8, !tbaa !172
  %17 = load ptr, ptr %shifts_todo, align 8, !tbaa !125
...
land.lhs.true:                                    ; preds = %while.body23
  ...
  %19 = load ptr, ptr %loc30, align 8, !tbaa !172
...
if.end34:                                         ; preds = %if.end
  ...
  %.pre = load ptr, ptr %reductions_todo, align 8, !tbaa !123
...
land.rhs:                                         ; preds = %land.rhs.preheader, %for.body
  ...
  %22 = load ptr, ptr %snode37, align 8, !tbaa !129
  %loc38 = getelementptr inbounds %struct.SNode, ptr %22, i64 0, i32 3
  %23 = load ptr, ptr %loc38, align 8, !tbaa !172
  %cmp40 = icmp eq ptr %23, %16
  br i1 %cmp40, label %for.body, label %while.body23, !llvm.loop !173

for.body:                                         ; preds = %land.rhs
  %next = getelementptr inbounds %struct.Reduction, ptr %21, i64 0, i32 5
  %24 = load ptr, ptr %next, align 8, !tbaa !127
  store ptr %24, ptr %reductions_todo, align 8, !tbaa !123
  call fastcc void @reduce_one(ptr noundef nonnull %p, ptr noundef nonnull %21)
  %25 = load ptr, ptr %reductions_todo, align 8, !tbaa !123
  %tobool36.not = icmp eq ptr %25, null
  br i1 %tobool36.not, label %while.end, label %land.rhs, !llvm.loop !174
...
land.lhs.true47:                                  ; preds = %if.then45
  ...
  %28 = load ptr, ptr %loc49, align 8, !tbaa !172
  %29 = load ptr, ptr %end51, align 8, !tbaa !147
  %cmp52 = icmp eq ptr %28, %29
  br i1 %cmp52, label %cleanup, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %land.lhs.true47
  %30 = load i32, ptr %partial_parses, align 8, !tbaa !155
  %tobool54.not = icmp eq i32 %30, 0
  br i1 %tobool54.not, label %if.else, label %cleanup

if.else:                                          ; preds = %lor.lhs.false, %if.then45
  %call.i196 = call noalias dereferenceable_or_null(80000) ptr @malloc(i64 noundef 80000) #26
  %31 = load ptr, ptr %last_all.i, align 8, !tbaa !175
...
if.end.i:                                         ; preds = %if.else
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %loc1, ptr noundef nonnull align 8 dereferenceable(32) %loc3.i, i64 32, i1 false), !tbaa.struct !99
...
if.end17.i:                                       ; preds = %if.end7.i
  ...
  call void %36(ptr noundef nonnull %p) #22
...
for.end.i:                                        ; preds = %for.inc.i
  ...
  %38 = load ptr, ptr %loc27.i, align 8, !tbaa !172
...
for.cond35.preheader.i:                           ; preds = %while.body.i
  ...
  %tobool.not206.i.i = icmp eq i8 %44, 0
...
for.body40.i:                                     ; preds = %if.end68.i, %for.cond35.preheader.i
  ...
  %call.i.i = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %45) #24
...
while.body14.i.i:                                 ; preds = %if.end185.i.i, %while.body14.lr.ph.i.i
  %str.addr.1205.i.i = phi ptr [ %38, %while.body14.lr.ph.i.i ], [ %incdec.ptr186.i.i, %if.end185.i.i ]
  %call181.i.i = call i32 @strncmp(ptr noundef %45, ptr noundef nonnull %str.addr.1205.i.i, i64 noundef %conv180.i.i) #24
  %tobool182.not.i.i = icmp eq i32 %call181.i.i, 0
  br i1 %tobool182.not.i.i, label %find_substr.exit.i, label %if.end185.i.i

if.end185.i.i:                                    ; preds = %while.body14.i.i
  %incdec.ptr186.i.i = getelementptr inbounds i8, ptr %str.addr.1205.i.i, i64 1
  %49 = load i8, ptr %incdec.ptr186.i.i, align 1, !tbaa !21
...
find_substr.exit.i:                               ; preds = %while.body14.i.i
  %add.ptr184.i.i = getelementptr inbounds i8, ptr %str.addr.1205.i.i, i64 %conv180.i.i
  br label %if.then47.i

if.then47.i:                                      ; preds = %land.rhs.i.i, %find_substr.exit.i, %while.end.i.i
  %retval.0.i470.i = phi ptr [ %add.ptr184.i.i, %find_substr.exit.i ], [ %add.ptr.i.i, %while.end.i.i ], [ %add.ptr.i474.i, %land.rhs.i.i ]
...
if.end68.i:                                       ; preds = %if.end185.i.i, %if.then66.i, %land.lhs.true60.i, %lor.lhs.false56.i, %land.lhs.true.i, %while.end.i.i, %while.cond12.preheader.i.i
  %best_er.2.i = phi ptr [ %arrayidx44.i, %if.then66.i ], [ %best_er.1483.i, %land.lhs.true60.i ], [ %best_er.1483.i, %lor.lhs.false56.i ], [ %best_er.1483.i, %land.lhs.true.i ], [ %best_er.1483.i, %while.end.i.i ], [ %best_er.1483.i, %while.cond12.preheader.i.i ], [ %best_er.1483.i, %if.end185.i.i ]
  %best_s.2.i = phi ptr [ %retval.0.i470.i, %if.then66.i ], [ %best_s.1485.i, %land.lhs.true60.i ], [ %best_s.1485.i, %lor.lhs.false56.i ], [ %best_s.1485.i, %land.lhs.true.i ], [ %best_s.1485.i, %while.end.i.i ], [ %best_s.1485.i, %while.cond12.preheader.i.i ], [ %best_s.1485.i, %if.end185.i.i ]
  %best_sn.2.i = phi ptr [ %40, %if.then66.i ], [ %best_sn.1486.i, %land.lhs.true60.i ], [ %best_sn.1486.i, %lor.lhs.false56.i ], [ %best_sn.1486.i, %land.lhs.true.i ], [ %best_sn.1486.i, %while.end.i.i ], [ %best_sn.1486.i, %while.cond12.preheader.i.i ], [ %best_sn.1486.i, %if.end185.i.i ]
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
...
if.end72.i:                                       ; preds = %if.end68.i, %while.body.i
  ...
  %54 = load i32, ptr %zns.i, align 8, !tbaa !157
...
for.body77.lr.ph.i:                               ; preds = %if.end72.i
  ...
  %55 = load ptr, ptr %v79.i, align 8, !tbaa !158
...
for.cond84.preheader.i:                           ; preds = %for.body77.i
  ...
  %57 = load i32, ptr %sns.i199, align 8, !tbaa !170
...
if.then95.i:                                      ; preds = %for.body92.i
  %59 = load ptr, ptr %v101.i, align 8, !tbaa !171
...
if.then95.i.1:                                    ; preds = %for.inc108.i
  ...
  %61 = load ptr, ptr %v101.i, align 8, !tbaa !171
...
if.then95.i.epil:                                 ; preds = %for.body92.i.epil
  %63 = load ptr, ptr %v101.i, align 8, !tbaa !171
...
if.then116.i:                                     ; preds = %while.end.i
  ...
  %call118.i = call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #26
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %best_loc.i) #22
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %best_loc.i, ptr noundef nonnull align 8 dereferenceable(32) %loc1, i64 32, i1 false), !tbaa.struct !99
  %65 = load ptr, ptr %v121.i, align 8, !tbaa !144
...
if.then123.i:                                     ; preds = %if.then116.i
  store ptr %e.i, ptr %v121.i, align 8, !tbaa !144
  %66 = load i32, ptr %error_reductions.i, align 8, !tbaa !141
  %inc129.i = add i32 %66, 1
  store i32 %inc129.i, ptr %error_reductions.i, align 8, !tbaa !141
...
if.else.i200:                                     ; preds = %if.then116.i
  ...
  %67 = load i32, ptr %error_reductions.i, align 8, !tbaa !141
...
if.then157.i:                                     ; preds = %if.else153.i
  ...
  store i32 %inc162.i, ptr %error_reductions.i, align 8, !tbaa !141
...
if.end167.i:                                      ; preds = %if.else153.i, %if.then139.i
  call void @vec_add_internal(ptr noundef nonnull %error_reductions.i, ptr noundef nonnull %calloc.i) #22
  br label %do.end.i
...
for.body.preheader.i.i:                           ; preds = %do.end.i
  ...
  %uglygep.i.i = getelementptr i8, ptr %70, i64 %71
...
for.inc.i.i.3:                                    ; preds = %if.then.i.i.3, %for.inc.i.i.2
  ...
  %exitcond.not.i.i.3 = icmp eq ptr %incdec.ptr.i461.i.3, %uglygep.i.i
...
update_line.exit.i:                               ; preds = %for.body.i.i.prol.loopexit, %for.inc.i.i.3, %do.end.i
  ...
  %80 = load ptr, ptr %v177.i, align 8, !tbaa !158
  ...
  call void %83(ptr noundef nonnull %p, ptr noundef nonnull %best_loc.i, ptr noundef nonnull %globals.i) #22
  %refcount.i = getelementptr inbounds %struct.SNode, ptr %best_sn.3.i, i64 0, i32 7
  %84 = load i32, ptr %refcount.i, align 8, !tbaa !100
  %inc181.i = add i32 %84, 1
  store i32 %inc181.i, ptr %refcount.i, align 8, !tbaa !100
  ...
  store ptr %call187.i, ptr %last_pn.i, align 8, !tbaa !169
  %zns190.i = getelementptr inbounds %struct.SNode, ptr %call189.i, i64 0, i32 6
  %89 = load ptr, ptr %free_znodes.i, align 8, !tbaa !137
...
new_ZNode.exit.i:                                 ; preds = %if.else.i.i, %if.then.i464.i
  ...
  %92 = load ptr, ptr %v.i.i, align 8, !tbaa !171
...
if.then201.i:                                     ; preds = %new_ZNode.exit.i
  store ptr %e203.i, ptr %v.i.i, align 8, !tbaa !171
  %93 = load i32, ptr %sns.i.i, align 8, !tbaa !170
  %inc209.i = add i32 %93, 1
  store i32 %inc209.i, ptr %sns.i.i, align 8, !tbaa !170
...
if.else212.i:                                     ; preds = %new_ZNode.exit.i
  ...
  %94 = load i32, ptr %sns.i.i, align 8, !tbaa !170
...
if.then225.i:                                     ; preds = %if.then220.i
  ...
  store i32 %inc230.i, ptr %sns.i.i, align 8, !tbaa !170
...
if.then239.i:                                     ; preds = %if.else234.i
  ...
  store i32 %inc244.i, ptr %sns.i.i, align 8, !tbaa !170
...
if.end249.i:                                      ; preds = %if.else234.i, %if.then220.i
  call void @vec_add_internal(ptr noundef nonnull %sns.i.i, ptr noundef nonnull %best_sn.3.i) #22
  br label %do.end252.i
...
do.end252.i:                                      ; preds = %if.end249.i, %if.then239.i, %if.then225.i, %if.then201.i
  ...
  store ptr %call189.i, ptr %snode.i, align 8, !tbaa !129
  %95 = load i32, ptr %refcount.i, align 8, !tbaa !100
  %inc255.i = add i32 %95, 1
  store i32 %inc255.i, ptr %refcount.i, align 8, !tbaa !100
  ...
  store ptr null, ptr %next.i, align 8, !tbaa !127
  call fastcc void @free_old_nodes(ptr noundef nonnull %p)
...
for.body261.lr.ph.i:                              ; preds = %do.end252.i
  %98 = load ptr, ptr %snode_hash.i, align 8, !tbaa !122
...
for.cond269.preheader.i:                          ; preds = %for.body261.i, %for.inc294.i
  ...
  %99 = load i32, ptr %zns270.i, align 8, !tbaa !157
...
for.body274.lr.ph.i:                              ; preds = %for.cond269.preheader.i
  ...
  %100 = load ptr, ptr %v276.i, align 8, !tbaa !158
...
for.end298.i:                                     ; preds = %for.inc296.i, %do.end252.i
  %111 = load ptr, ptr %shifts_todo, align 8, !tbaa !125
...
lor.lhs.false300.i:                               ; preds = %for.end298.i
  %112 = load ptr, ptr %reductions_todo, align 8, !tbaa !123
...
error_recovery.exit.thread262:                    ; preds = %lor.lhs.false300.i
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %best_loc.i) #22
  br label %cleanup.sink.split

error_recovery.exit:                              ; preds = %for.end298.i, %lor.lhs.false300.i
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %best_loc.i) #22
  call void @free(ptr noundef %call.i196) #22
  br label %while.cond
...
land.lhs.true63:                                  ; preds = %if.else60
  ...
  %114 = load ptr, ptr %next65, align 8, !tbaa !131
  %tobool66.not = icmp eq ptr %114, null
  br i1 %tobool66.not, label %if.end69, label %if.then67

if.then67:                                        ; preds = %land.lhs.true63
  %115 = load ptr, ptr %26, align 8, !tbaa !133
  %loc.i202 = getelementptr inbounds %struct.SNode, ptr %115, i64 0, i32 3
  %116 = load ptr, ptr %loc.i202, align 8, !tbaa !172
  br label %land.rhs.i

land.rhs.i:                                       ; preds = %for.inc82.i, %if.then67
  %a.0168.i = phi ptr [ %26, %if.then67 ], [ %167, %for.inc82.i ]
  %al.0167.i = phi ptr [ %shifts_todo, %if.then67 ], [ %next83.i, %for.inc82.i ]
  %117 = load ptr, ptr %a.0168.i, align 8, !tbaa !133
  %loc3.i204 = getelementptr inbounds %struct.SNode, ptr %117, i64 0, i32 3
  %118 = load ptr, ptr %loc3.i204, align 8, !tbaa !172
...
for.body.i206:                                    ; preds = %land.rhs.i
  ...
  %119 = load i32, ptr %zns.i.i, align 8, !tbaa !157
...
if.end.i.i:                                       ; preds = %for.body.i206
  ...
  %120 = load ptr, ptr %v.i.i207, align 8, !tbaa !158
...
if.then3.i.i:                                     ; preds = %if.end.i.i
  ...
  %124 = load i32, ptr %sns.i.i208, align 8, !tbaa !170
...
if.end7.i.i:                                      ; preds = %if.then3.i.i
  ...
  %125 = load ptr, ptr %v9.i.i, align 8, !tbaa !171
  %126 = load ptr, ptr %125, align 8, !tbaa !16
  %zns11.i.i = getelementptr inbounds %struct.SNode, ptr %126, i64 0, i32 6
  %127 = load i32, ptr %zns11.i.i, align 8, !tbaa !157
...
if.end15.i.i:                                     ; preds = %if.end7.i.i
  ...
  %128 = load ptr, ptr %v17.i.i, align 8, !tbaa !158
  %129 = load ptr, ptr %128, align 8, !tbaa !16
  %.pre.i.i210 = load ptr, ptr %129, align 8, !tbaa !159
...
if.end.i214:                                      ; preds = %if.end19.i.i
  %next.i213 = getelementptr inbounds %struct.Shift, ptr %a.0168.i, i64 0, i32 1
  %b.0162.i = load ptr, ptr %next.i213, align 8, !tbaa !131
  %tobool9.not163.i = icmp eq ptr %b.0162.i, null
  br i1 %tobool9.not163.i, label %for.inc82.i, label %land.rhs10.lr.ph.i
...
land.rhs10.i:                                     ; preds = %for.inc.i220, %land.rhs10.lr.ph.i
  %b.0165.i = phi ptr [ %b.0162.i, %land.rhs10.lr.ph.i ], [ %b.0.i, %for.inc.i220 ]
  %bl.0164.i = phi ptr [ %next.i213, %land.rhs10.lr.ph.i ], [ %next80.i, %for.inc.i220 ]
  %132 = load ptr, ptr %b.0165.i, align 8, !tbaa !133
  %loc12.i = getelementptr inbounds %struct.SNode, ptr %132, i64 0, i32 3
  %133 = load ptr, ptr %loc12.i, align 8, !tbaa !172
...
for.body16.i:                                     ; preds = %land.rhs10.i
  ...
  %134 = load i32, ptr %zns.i123.i, align 8, !tbaa !157
...
if.end.i128.i:                                    ; preds = %for.body16.i
  ...
  %135 = load ptr, ptr %v.i125.i, align 8, !tbaa !158
...
if.then3.i131.i:                                  ; preds = %if.end.i128.i
  ...
  %139 = load i32, ptr %sns.i129.i, align 8, !tbaa !170
...
if.end15.i140.i:                                  ; preds = %if.end7.i135.i
  ...
  %143 = load ptr, ptr %v17.i136.i, align 8, !tbaa !158
  %144 = load ptr, ptr %143, align 8, !tbaa !16
  %.pre.i137.i = load ptr, ptr %144, align 8, !tbaa !159
...
if.then53.i:                                      ; preds = %if.end48.i
  %next54.i = getelementptr inbounds %struct.Shift, ptr %b.0165.i, i64 0, i32 1
  %161 = load ptr, ptr %next54.i, align 8, !tbaa !131
  store ptr %161, ptr %bl.0164.i, align 8, !tbaa !16
  %162 = load ptr, ptr %b.0165.i, align 8, !tbaa !133
  %refcount.i218 = getelementptr inbounds %struct.SNode, ptr %162, i64 0, i32 7
  %163 = load i32, ptr %refcount.i218, align 8, !tbaa !100
  %dec.i = add i32 %163, -1
  store i32 %dec.i, ptr %refcount.i218, align 8, !tbaa !100
...
do.end.i219:                                      ; preds = %if.then57.i, %if.then53.i
  call void @free(ptr noundef nonnull %b.0165.i) #22
...
if.then67.i:                                      ; preds = %if.end60.i
  store ptr %b.0162.i, ptr %al.0167.i, align 8, !tbaa !16
  %164 = load ptr, ptr %a.0168.i, align 8, !tbaa !133
  %refcount71.i = getelementptr inbounds %struct.SNode, ptr %164, i64 0, i32 7
  %165 = load i32, ptr %refcount71.i, align 8, !tbaa !100
  %dec72.i = add i32 %165, -1
  store i32 %dec72.i, ptr %refcount71.i, align 8, !tbaa !100
...
do.end78.i:                                       ; preds = %if.then74.i, %if.then67.i
  call void @free(ptr noundef nonnull %a.0168.i) #22
  %166 = load ptr, ptr %al.0167.i, align 8, !tbaa !16
  br label %for.inc82.i
...
for.inc.i220:                                     ; preds = %for.cond4.i.i, %if.end60.i, %land.lhs.true.i217, %if.end21.i, %if.end19.i145.i, %if.end7.i135.i, %if.then3.i131.i, %for.body16.i
  %next80.i = getelementptr inbounds %struct.Shift, ptr %b.0165.i, i64 0, i32 1
  %b.0.i = load ptr, ptr %next80.i, align 8, !tbaa !131
...
for.inc82.i:                                      ; preds = %for.inc.i220, %land.rhs10.i, %do.end78.i, %do.end.i219, %if.end.i214, %if.end19.i.i, %if.end7.i.i, %if.then3.i.i, %for.body.i206
  %a.1.i = phi ptr [ %a.0168.i, %do.end.i219 ], [ %166, %do.end78.i ], [ %a.0168.i, %for.body.i206 ], [ %a.0168.i, %if.then3.i.i ], [ %a.0168.i, %if.end7.i.i ], [ %a.0168.i, %if.end19.i.i ], [ %a.0168.i, %if.end.i214 ], [ %a.0168.i, %land.rhs10.i ], [ %a.0168.i, %for.inc.i220 ]
  %next83.i = getelementptr inbounds %struct.Shift, ptr %a.1.i, i64 0, i32 1
  %167 = load ptr, ptr %next83.i, align 8, !tbaa !131
...
if.end69.loopexit:                                ; preds = %land.rhs.i, %for.inc82.i
  %.pre308 = load ptr, ptr %shifts_todo, align 8, !tbaa !125
  br label %if.end69
...
if.end69:                                         ; preds = %if.end69.loopexit, %if.else60, %land.lhs.true63
  ...
  %170 = load ptr, ptr %loc72, align 8, !tbaa !172
...
land.lhs.true81:                                  ; preds = %if.end76
  %172 = load ptr, ptr %shifts_todo, align 8, !tbaa !125
  %next83 = getelementptr inbounds %struct.Shift, ptr %172, i64 0, i32 1
  %173 = load ptr, ptr %next83, align 8, !tbaa !131
...
if.then85:                                        ; preds = %land.lhs.true81
  %174 = load ptr, ptr %172, align 8, !tbaa !133
  %call88 = call fastcc i32 @commit_stack(ptr noundef nonnull %p, ptr noundef %174)
  br label %if.end89

if.end89:                                         ; preds = %if.then85, %if.end76
  %progress.1.ph = phi i32 [ %inc77, %if.end76 ], [ 0, %if.then85 ]
  %.pr = load ptr, ptr %shifts_todo, align 8, !tbaa !125
...
land.rhs93:                                       ; preds = %land.rhs93.preheader, %shift_one.exit
  ...
  %178 = load ptr, ptr %loc95, align 8, !tbaa !172
...
for.body100:                                      ; preds = %land.rhs93
  ...
  %179 = load ptr, ptr %next102, align 8, !tbaa !131
  store ptr %179, ptr %shifts_todo, align 8, !tbaa !125
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %loc.i222) #22
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %skip_loc.i) #22
  %180 = load ptr, ptr %177, align 8, !tbaa !43
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %loc.i222, ptr noundef nonnull align 8 dereferenceable(32) %loc95, i64 32, i1 false), !tbaa.struct !99
  store ptr null, ptr %skip_loc.i, align 8, !tbaa !96
  %181 = load i32, ptr %scans.i, align 8, !tbaa !161
  %inc.i224 = add nsw i32 %181, 1
  store i32 %inc.i224, ptr %scans.i, align 8, !tbaa !161
  %scanner_code.i = getelementptr inbounds %struct.D_State, ptr %180, i64 0, i32 6
  %182 = load ptr, ptr %scanner_code.i, align 8, !tbaa !218
...
if.then.i229:                                     ; preds = %for.body100
  store i32 0, ptr %term_priority.i, align 8, !tbaa !219
  store i8 0, ptr %op_assoc.i, align 1, !tbaa !220
  %183 = load ptr, ptr %shift_results.i, align 8, !tbaa !146
  %loc6.i = getelementptr inbounds %struct.ShiftResult, ptr %183, i64 0, i32 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %loc6.i, ptr noundef nonnull align 8 dereferenceable(32) %loc.i222, i64 32, i1 false), !tbaa.struct !99
  %184 = load ptr, ptr %scanner_code.i, align 8, !tbaa !218
  %185 = load ptr, ptr %shift_results.i, align 8, !tbaa !146
  ...
  %call.i228 = call i32 %184(ptr noundef nonnull %loc11.i, ptr noundef nonnull %col.i, ptr noundef nonnull %line.i226, ptr noundef nonnull %code_shift.i, ptr noundef nonnull %term_priority.i, ptr noundef nonnull %op_assoc.i, ptr noundef nonnull %op_priority.i227) #22
...
if.then28.i:                                      ; preds = %if.then.i229
  %186 = load ptr, ptr %shift_results.i, align 8, !tbaa !146
  store ptr %code_shift.i, ptr %186, align 8, !tbaa !221
  br label %if.end34.i
...
for.body.i236:                                    ; preds = %for.inc.i251, %for.body.lr.ph.i
  ...
  %189 = load ptr, ptr %shift_results.i, align 8, !tbaa !146
  %arrayidx44.i233 = getelementptr inbounds %struct.ShiftResult, ptr %189, i64 %indvars.iv.i232
  %190 = load i32, ptr %shifts.i, align 4, !tbaa !162
  %inc45.i = add nsw i32 %190, 1
  store i32 %inc45.i, ptr %shifts.i, align 4, !tbaa !162
  %191 = load ptr, ptr %arrayidx44.i233, align 8, !tbaa !221
  %192 = load i16, ptr %191, align 8, !tbaa !224
  %conv.i234 = zext i16 %192 to i32
  %193 = load ptr, ptr %176, align 8, !tbaa !133
  ...
  %194 = load ptr, ptr %loc50.i, align 8, !tbaa !225
  %last_pn.i235 = getelementptr inbounds %struct.SNode, ptr %193, i64 0, i32 5
  %195 = load ptr, ptr %last_pn.i235, align 8, !tbaa !169
...
lor.lhs.false.i:                                  ; preds = %if.then56.i
  %197 = load ptr, ptr %loc50.i, align 8, !tbaa !225
...
lor.lhs.false64.if.end89_crit_edge.i:             ; preds = %lor.lhs.false64.i
  %.pre.i = load ptr, ptr %176, align 8, !tbaa !133
  br label %if.end89.i

if.then67.i239:                                   ; preds = %lor.lhs.false64.i, %lor.lhs.false.i, %if.then56.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %skip_loc.i, ptr noundef nonnull align 8 dereferenceable(32) %loc50.i, i64 32, i1 false), !tbaa.struct !99
  ...
  call void %199(ptr noundef nonnull %p, ptr noundef nonnull %skip_loc.i, ptr noundef nonnull %globals.i238) #22
  %200 = load ptr, ptr %176, align 8, !tbaa !133
  %col76.i = getelementptr inbounds %struct.SNode, ptr %200, i64 0, i32 3, i32 3
  %201 = load i32, ptr %col76.i, align 4, !tbaa !226
...
land.rhs.i.i242:                                  ; preds = %cond.end.i, %cond.end15.i.i
  ...
  %205 = load ptr, ptr %zn.addr.029.i.i, align 8, !tbaa !159
  ...
  %207 = load ptr, ptr %end.i.i, align 8, !tbaa !168
...
while.body.i.i244:                                ; preds = %land.rhs.i.i242
  ...
  %208 = load i32, ptr %sns.i.i243, align 8, !tbaa !170
...
cond.end15.i.i:                                   ; preds = %cond.true.i.i
  ...
  %212 = load ptr, ptr %v12.i.i, align 8, !tbaa !158
  %213 = load ptr, ptr %212, align 8, !tbaa !16
  %tobool.not.i.i247 = icmp eq ptr %213, null
  br i1 %tobool.not.i.i247, label %if.else.i.i248, label %land.rhs.i.i242, !llvm.loop !228
...
for.inc.i251:                                     ; preds = %if.end89.i, %for.body.i236
  ...
  br i1 %exitcond.not.i250, label %do.body.i, label %for.body.i236, !llvm.loop !229

do.body.i:                                        ; preds = %for.inc.i251, %if.end41.i
  %216 = load ptr, ptr %176, align 8, !tbaa !133
  %refcount.i252 = getelementptr inbounds %struct.SNode, ptr %216, i64 0, i32 7
  %217 = load i32, ptr %refcount.i252, align 8, !tbaa !100
  %dec.i253 = add i32 %217, -1
  store i32 %dec.i253, ptr %refcount.i252, align 8, !tbaa !100
...
shift_one.exit:                                   ; preds = %do.body.i, %if.then96.i
  %218 = load ptr, ptr %free_shifts.i, align 8, !tbaa !126
  store ptr %218, ptr %next102, align 8, !tbaa !131
  store ptr %176, ptr %free_shifts.i, align 8, !tbaa !126
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %skip_loc.i) #22
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %loc.i222) #22
  %219 = load ptr, ptr %shifts_todo, align 8, !tbaa !125
  %tobool92.not = icmp eq ptr %219, null
  br i1 %tobool92.not, label %for.end104, label %land.rhs93, !llvm.loop !230
...
land.lhs.true106:                                 ; preds = %for.end104
  %220 = load ptr, ptr %reductions_todo, align 8, !tbaa !123
...
land.lhs.true109:                                 ; preds = %land.lhs.true106
  ...
  %221 = load ptr, ptr %next111, align 8, !tbaa !127
...
if.then113:                                       ; preds = %land.lhs.true109
  ...
  %222 = load ptr, ptr %snode115, align 8, !tbaa !129
  %call116 = call fastcc i32 @commit_stack(ptr noundef nonnull %p, ptr noundef %222)
...
cleanup:                                          ; preds = %if.end.i, %if.else, %land.lhs.true47, %lor.lhs.false, %cleanup.sink.split
  ...
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %loc) #22
  call void @llvm.lifetime.end.p0(i64 240, ptr nonnull %tpn) #22
  ret i32 %retval.0
}
...
if.end:                                           ; preds = %entry
  ...
  %2 = load ptr, ptr %end, align 8, !tbaa !168
  %cmp = icmp eq ptr %1, %2
...
land.lhs.true3:                                   ; preds = %land.lhs.true
  ...
  %4 = load ptr, ptr %final_code, align 8, !tbaa !231
...
if.then10.thread:                                 ; preds = %if.end8.thread
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %pns.i) #22
...
for.body.lr.ph.i:                                 ; preds = %if.then10, %if.then10.thread
  ...
  %call.i = tail call fastcc i32 @final_actionless(ptr noundef nonnull %pn)
...
if.end95.us.i:                                    ; preds = %if.then71.us.i, %if.else82.us.i
  ...
  call void @vec_add_internal(ptr noundef nonnull %pns.i, ptr noundef nonnull %parse_node96.us.i) #22
  br label %for.inc.us.i
...
for.inc.us.i:                                     ; preds = %if.then57.us.i, %if.then74.us.i, %if.end95.us.i, %if.then86.us.i
  ...
  br i1 %tobool38.not.us.i, label %for.end.i, label %for.body.us.i, !llvm.loop !232

for.body.i:                                       ; preds = %for.body.lr.ph.i, %for.inc.i
  %amb.0154.i = phi ptr [ %amb.0.i, %for.inc.i ], [ %8, %for.body.lr.ph.i ]
  %13 = load i32, ptr %dont_merge_epsilon_trees.i, align 4, !tbaa !233
...
if.end95.i:                                       ; preds = %if.else82.i, %if.then71.i
  ...
  call void @vec_add_internal(ptr noundef nonnull %pns.i, ptr noundef nonnull %parse_node96.i) #22
  br label %for.inc.i
...
for.inc.i:                                        ; preds = %if.end95.i, %if.then86.i, %if.then74.i, %if.then57.i, %land.lhs.true48.i
  ...
  br i1 %tobool38.not.i, label %for.end.i, label %for.body.i, !llvm.loop !232
...
if.then102.i:                                     ; preds = %for.end.i
  %19 = load ptr, ptr %v.i148, align 8, !tbaa !211
...
if.end105.i:                                      ; preds = %for.end.i
  ...
  %call109.i = call ptr %21(ptr noundef %p, i32 noundef %.pr.i, ptr noundef %22) #22
  %.pre.i = load ptr, ptr %v.i148, align 8, !tbaa !211
  br label %do.body110.i
...
resolve_ambiguities.exit:                         ; preds = %do.body110.i, %if.then118.i
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %pns.i) #22
  br label %if.end11
...
if.end11:                                         ; preds = %if.end8.thread151, %if.end8.thread, %resolve_ambiguities.exit, %if.end8
  ...
  %27 = load i32, ptr %arrayidx, align 8, !tbaa !234
...
for.body.lr.ph:                                   ; preds = %if.end11
  ...
  %29 = load i32, ptr %dont_fixup_internal_productions, align 8, !tbaa !235
...
for.body.us:                                      ; preds = %for.body.lr.ph, %for.inc.us
  ...
  %39 = load i32, ptr %arrayidx44.us, align 8, !tbaa !234
...
if.then.i.us:                                     ; preds = %if.then48.us
  call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.12) #22
...
for.body.i123.us.prol:                            ; preds = %for.body.preheader.i.us, %for.body.i123.us.prol
  ...
  br i1 %prol.iter.cmp.not, label %for.body.i123.us.prol.loopexit, label %for.body.i123.us.prol, !llvm.loop !236
...
for.body.i123.us:                                 ; preds = %for.body.i123.us.prol.loopexit, %for.body.i123.us
  ...
  br i1 %exitcond.not.i.us.3, label %for.end.i124.us, label %for.body.i123.us, !llvm.loop !237
...
if.end82.i.us:                                    ; preds = %if.then55.i.us, %if.else68.i.us
  call void @vec_add_internal(ptr noundef nonnull %children, ptr noundef null) #22
  br label %for.inc86.i.us
...
for.inc86.i.us:                                   ; preds = %if.then39.i.us, %if.then59.i.us, %if.end82.i.us, %if.then72.i.us
  ...
  br i1 %exitcond204.not.i.us, label %for.cond90.preheader.i.us, label %do.body36.i.us, !llvm.loop !238
...
for.body93.i.us:                                  ; preds = %for.body93.i.us.prol.loopexit, %for.body93.i.us
  ...
  br i1 %cmp92.not.not.i.us.1, label %for.body93.i.us, label %for.cond107.preheader.i.us, !llvm.loop !239
...
do.body110.i126.us:                               ; preds = %do.body110.i126.us, %do.body110.lr.ph.i.us.new
  ...
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %do.body133.i.us.loopexit.unr-lcssa, label %do.body110.i126.us, !llvm.loop !240
...
for.inc.us:                                       ; preds = %fixup_internal_symbol.exit.us, %for.body.us
  ...
  br i1 %cmp17.us, label %for.body.us, label %for.end, !llvm.loop !241
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  br i1 %cmp17, label %for.body, label %for.end, !llvm.loop !241
...
land.lhs.true52:                                  ; preds = %for.end
  ...
  %103 = load ptr, ptr %final_code54, align 8, !tbaa !231
...
if.then56:                                        ; preds = %land.lhs.true52
  ...
  %call63 = call i32 %103(ptr noundef nonnull %pn.addr.0, ptr noundef %104, i32 noundef %.lcssa, i32 noundef 152, ptr noundef %p) #22
  br label %if.end64
...
cleanup:                                          ; preds = %if.then28.i, %do.body18.i, %if.end64, %if.then67, %entry
  %retval.0 = phi ptr [ %pn, %entry ], [ %pn.addr.0, %if.then67 ], [ %pn.addr.0, %if.end64 ], [ %pn.addr.0, %do.body18.i ], [ %pn.addr.0, %if.then28.i ]
  ret ptr %retval.0
}
...
entry:
  ...
  %0 = load i32, ptr %zns, align 8, !tbaa !157
  %cmp44.not = icmp eq i32 %0, 0
  br i1 %cmp44.not, label %do.body, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %indvars.iv47 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next48, %for.inc ]
  %2 = load ptr, ptr %v, align 8, !tbaa !158
  %arrayidx = getelementptr inbounds ptr, ptr %2, i64 %indvars.iv47
  %3 = load ptr, ptr %arrayidx, align 8, !tbaa !16
...
do.end.i:                                         ; preds = %if.then.i, %if.then
  ...
  %6 = load i32, ptr %sns.i, align 8, !tbaa !170
  %cmp.i42.not = icmp eq i32 %6, 0
  br i1 %cmp.i42.not, label %do.body22.i, label %for.body.i.lr.ph
...
for.inc.i:                                        ; preds = %if.then13.i, %do.body5.i, %for.body.i
  ...
  br i1 %cmp.i, label %for.body.i, label %do.body22.i, !llvm.loop !242

do.body22.i:                                      ; preds = %for.inc.i, %do.end.i
  %v24.i = getelementptr inbounds %struct.ZNode, ptr %3, i64 0, i32 1, i32 2
  %13 = load ptr, ptr %v24.i, align 8, !tbaa !171
  %tobool25.not.i = icmp eq ptr %13, null
  %e.i = getelementptr inbounds %struct.ZNode, ptr %3, i64 0, i32 1, i32 3
  %cmp29.not.i = icmp eq ptr %13, %e.i
  %or.cond.i = select i1 %tobool25.not.i, i1 true, i1 %cmp29.not.i
  br i1 %or.cond.i, label %free_ZNode.exit, label %if.then30.i
...
free_ZNode.exit:                                  ; preds = %do.body22.i, %if.then30.i
  store i32 0, ptr %sns.i, align 8, !tbaa !170
  store ptr null, ptr %v24.i, align 8, !tbaa !171
  %14 = load ptr, ptr %free_znodes.i, align 8, !tbaa !137
  store ptr %14, ptr %3, align 8, !tbaa !16
  store ptr %3, ptr %free_znodes.i, align 8, !tbaa !137
  %.pre50 = load i32, ptr %zns, align 8, !tbaa !157
  br label %for.inc

for.inc:                                          ; preds = %for.body, %free_ZNode.exit
  %15 = phi i32 [ %1, %for.body ], [ %.pre50, %free_ZNode.exit ]
  %indvars.iv.next48 = add nuw nsw i64 %indvars.iv47, 1
  %16 = zext i32 %15 to i64
  %cmp = icmp ult i64 %indvars.iv.next48, %16
  br i1 %cmp, label %for.body, label %do.body, !llvm.loop !243

do.body:                                          ; preds = %for.inc, %entry
  %v7 = getelementptr inbounds %struct.SNode, ptr %s, i64 0, i32 6, i32 2
  %17 = load ptr, ptr %v7, align 8, !tbaa !158
  %tobool8.not = icmp eq ptr %17, null
  %e = getelementptr inbounds %struct.SNode, ptr %s, i64 0, i32 6, i32 3
  %cmp12.not = icmp eq ptr %17, %e
  %or.cond = select i1 %tobool8.not, i1 true, i1 %cmp12.not
  br i1 %or.cond, label %do.body17, label %if.then13
...
do.body17:                                        ; preds = %do.body, %if.then13
  store i32 0, ptr %zns, align 8, !tbaa !157
  store ptr null, ptr %v7, align 8, !tbaa !158
  %free_snodes = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 22
  %18 = load ptr, ptr %free_snodes, align 8, !tbaa !139
  %all_next = getelementptr inbounds %struct.SNode, ptr %s, i64 0, i32 9
  store ptr %18, ptr %all_next, align 8, !tbaa !142
  store ptr %s, ptr %free_snodes, align 8, !tbaa !139
  ret void
}
...
entry:
  ...
  %0 = load ptr, ptr %all, align 8, !tbaa !244
  %snode_hash = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 12
  %all1 = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 12, i32 4
  %1 = load ptr, ptr %all1, align 8, !tbaa !245
...
while.body.lr.ph:                                 ; preds = %entry
  %t = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 3
  %m = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 12, i32 2
  %2 = load i32, ptr %m, align 4, !tbaa !152
  br label %while.body
...
while.body:                                       ; preds = %while.body.lr.ph, %while.end
  ...
  %12 = load ptr, ptr %snode_hash, align 8, !tbaa !122
  %rem = urem i32 %add3, %2
  %idxprom = zext i32 %rem to i64
  ...
  %13 = load ptr, ptr %all_next, align 8, !tbaa !142
...
while.end10:                                      ; preds = %while.end, %entry
  ...
  %16 = load ptr, ptr %last_all, align 8, !tbaa !175
...
while.body14:                                     ; preds = %while.end10, %do.end
  ...
  %17 = load ptr, ptr %all_next15, align 8, !tbaa !142
  %refcount = getelementptr inbounds %struct.SNode, ptr %sn.1178, i64 0, i32 7
  %18 = load i32, ptr %refcount, align 8, !tbaa !100
  %dec = add i32 %18, -1
  store i32 %dec, ptr %refcount, align 8, !tbaa !100
...
do.end:                                           ; preds = %if.then, %while.body14
  ...
  br i1 %tobool13.not, label %while.end17, label %while.body14, !llvm.loop !248

while.end17:                                      ; preds = %do.end, %while.end10
  %19 = load ptr, ptr %all1, align 8, !tbaa !245
  store ptr %19, ptr %last_all, align 8, !tbaa !175
  store ptr null, ptr %all1, align 8, !tbaa !245
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %24 = load ptr, ptr %latest, align 8, !tbaa !118
...
if.then57:                                        ; preds = %do.body40
  ...
  %.pre186 = load ptr, ptr %latest69.phi.trans.insert, align 8, !tbaa !118
...
for.inc:                                          ; preds = %for.body, %do.end64
  ...
  br i1 %cmp27, label %for.body, label %for.end, !llvm.loop !249
...
for.end:                                          ; preds = %for.inc, %for.cond.preheader
  ...
  %44 = load ptr, ptr %pnode_hash, align 8, !tbaa !121
  %45 = load i32, ptr %m89, align 4, !tbaa !150
  ...
  %46 = load ptr, ptr %all_next93, align 8, !tbaa !120
...
do.end108:                                        ; preds = %if.then105, %while.end99
  ...
  br i1 %tobool25.not, label %while.end109, label %for.cond.preheader, !llvm.loop !251

while.end109:                                     ; preds = %do.end108, %while.end17
  %n111 = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 11, i32 3
  store i32 0, ptr %n111, align 8, !tbaa !252
  store ptr null, ptr %all, align 8, !tbaa !244
  ret void
}
...
if.end:                                           ; preds = %for.inc.i, %entry, %if.then.i
  ...
  %12 = load ptr, ptr %shifts, align 8, !tbaa !253
...
if.then5:                                         ; preds = %if.end
  ...
  %free_shifts.i = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 19
  %13 = load ptr, ptr %free_shifts.i, align 8, !tbaa !126
  %tobool.not.i39 = icmp eq ptr %13, null
  br i1 %tobool.not.i39, label %if.then.i40, label %if.else.i

if.then.i40:                                      ; preds = %if.then5
  %call.i = tail call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #26
  br label %if.end.i

if.else.i:                                        ; preds = %if.then5
  %next.i = getelementptr inbounds %struct.Shift, ptr %13, i64 0, i32 1
  %14 = load ptr, ptr %next.i, align 8, !tbaa !131
  store ptr %14, ptr %free_shifts.i, align 8, !tbaa !126
  br label %if.end.i

if.end.i:                                         ; preds = %if.else.i, %if.then.i40
  %s.0.i = phi ptr [ %13, %if.else.i ], [ %call.i, %if.then.i40 ]
  store ptr %call2, ptr %s.0.i, align 8, !tbaa !133
  %refcount.i = getelementptr inbounds %struct.SNode, ptr %call2, i64 0, i32 7
  %15 = load i32, ptr %refcount.i, align 8, !tbaa !100
  %inc.i = add i32 %15, 1
  store i32 %inc.i, ptr %refcount.i, align 8, !tbaa !100
...
for.body.lr.ph.i41:                               ; preds = %if.end.i
  ...
  %16 = load ptr, ptr %loc.i, align 8, !tbaa !172
  %17 = load ptr, ptr %x.028.i, align 8, !tbaa !133
  %loc8.i48 = getelementptr inbounds %struct.SNode, ptr %17, i64 0, i32 3
  %18 = load ptr, ptr %loc8.i48, align 8, !tbaa !172
  %cmp.not.i49 = icmp ugt ptr %16, %18
  br i1 %cmp.not.i49, label %for.inc.i43, label %add_Shift.exit

for.body.i42:                                     ; preds = %for.inc.i43
  %19 = load ptr, ptr %x.0.i, align 8, !tbaa !133
  %loc8.i = getelementptr inbounds %struct.SNode, ptr %19, i64 0, i32 3
  %20 = load ptr, ptr %loc8.i, align 8, !tbaa !172
  %cmp.not.i = icmp ugt ptr %16, %20
  br i1 %cmp.not.i, label %for.inc.i43, label %add_Shift.exit.loopexit, !llvm.loop !254
...
for.inc.i43:                                      ; preds = %for.body.lr.ph.i41, %for.body.i42
  ...
  br i1 %tobool5.not.i, label %add_Shift.exit.loopexit, label %for.body.i42, !llvm.loop !254
...
add_Shift.exit:                                   ; preds = %add_Shift.exit.loopexit, %for.body.lr.ph.i41, %if.end.i
  ...
  store ptr %x.0.lcssa.i, ptr %next14.i, align 8, !tbaa !131
...
if.end6:                                          ; preds = %add_Shift.exit, %if.end
  ...
  %22 = load i32, ptr %reductions54, align 8, !tbaa !255
...
for.body:                                         ; preds = %if.end6, %for.inc
  ...
  %24 = load ptr, ptr %v, align 8, !tbaa !256
...
for.inc:                                          ; preds = %for.body, %if.then12
  ...
  %28 = load i32, ptr %reductions, align 8, !tbaa !255
  %29 = zext i32 %28 to i64
  %cmp = icmp ult i64 %indvars.iv.next, %29
  br i1 %cmp, label %for.body, label %cleanup, !llvm.loop !257
...
for.cond.i:                                       ; preds = %for.body.i57
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %cleanup, label %for.body.i57, !llvm.loop !258
...
for.body.i57:                                     ; preds = %for.cond.i, %for.body.lr.ph.i
  ...
  %24 = load ptr, ptr %latest.i, align 8, !tbaa !118
  ...
  %29 = load ptr, ptr %latest22.i, align 8, !tbaa !118
...
PNode_equal.exit:                                 ; preds = %land.lhs.true
  ...
  %30 = load ptr, ptr %shift.i, align 8, !tbaa !259
...
if.end:                                           ; preds = %for.inc.i, %for.body.i57, %if.end9.i, %if.end.i, %if.then.i, %entry, %PNode_equal.exit
  %tobool.not116 = phi i1 [ false, %PNode_equal.exit ], [ true, %entry ], [ true, %if.then.i ], [ false, %if.end.i ], [ false, %if.end9.i ], [ false, %for.body.i57 ], [ true, %for.inc.i ]
  %retval.0.i115 = phi ptr [ %pn.038.i, %PNode_equal.exit ], [ null, %entry ], [ null, %if.then.i ], [ %pn.038.i, %if.end.i ], [ %pn.038.i, %if.end9.i ], [ %pn.038.i, %for.body.i57 ], [ null, %for.inc.i ]
  ...
  %32 = load ptr, ptr %free_pnodes.i, align 8, !tbaa !119
...
if.then.i61:                                      ; preds = %if.end
  ...
  %call.i = tail call noalias ptr @malloc(i64 noundef %conv2.i) #26
  br label %if.end.i64

if.else.i:                                        ; preds = %if.end
  %all_next.i = getelementptr inbounds %struct.PNode, ptr %32, i64 0, i32 11
  %33 = load ptr, ptr %all_next.i, align 8, !tbaa !120
  store ptr %33, ptr %free_pnodes.i, align 8, !tbaa !119
...
if.end.i64:                                       ; preds = %if.else.i, %if.then.i61
  ...
  %34 = load i32, ptr %pnodes.i, align 4, !tbaa !260
  %inc.i = add nsw i32 %34, 1
  store i32 %inc.i, ptr %pnodes.i, align 4, !tbaa !260
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %start_loc7.i, ptr noundef nonnull align 8 dereferenceable(32) %start_loc, i64 32, i1 false), !tbaa.struct !99
...
if.else12.i:                                      ; preds = %if.end.i64
  ...
  %39 = load ptr, ptr %v17.i68, align 8, !tbaa !171
  %40 = load ptr, ptr %39, align 8, !tbaa !16
  %v19.i = getelementptr inbounds %struct.SNode, ptr %40, i64 0, i32 6, i32 2
  %41 = load ptr, ptr %v19.i, align 8, !tbaa !158
...
land.rhs.i.i:                                     ; preds = %if.else12.i, %cond.end15.i.i
  ...
  %43 = load ptr, ptr %zn.addr.029.i.i, align 8, !tbaa !159
  ...
  %45 = load ptr, ptr %end.i.i, align 8, !tbaa !168
...
while.body.i.i:                                   ; preds = %land.rhs.i.i
  ...
  %46 = load i32, ptr %sns.i.i, align 8, !tbaa !170
...
cond.true.i.i:                                    ; preds = %while.body.i.i
  ...
  %47 = load ptr, ptr %v.i.i, align 8, !tbaa !171
  %48 = load ptr, ptr %47, align 8, !tbaa !16
  %zns.i.i = getelementptr inbounds %struct.SNode, ptr %48, i64 0, i32 6
  %49 = load i32, ptr %zns.i.i, align 8, !tbaa !157
...
cond.end15.i.i:                                   ; preds = %cond.true.i.i
  ...
  %50 = load ptr, ptr %v12.i.i, align 8, !tbaa !158
  %51 = load ptr, ptr %50, align 8, !tbaa !16
  %tobool.not.i.i = icmp eq ptr %51, null
  br i1 %tobool.not.i.i, label %if.else.i.i, label %land.rhs.i.i, !llvm.loop !228
...
if.end23.i:                                       ; preds = %land.rhs.i.i, %if.else.i.i, %if.then10.i
  ...
  store ptr %sh, ptr %shift.i69, align 8, !tbaa !259
  ...
  %52 = load ptr, ptr %scope.i, align 8, !tbaa !167
  %scope27.i = getelementptr inbounds %struct.PNode, ptr %new_pn.0.i, i64 0, i32 19, i32 4
  store ptr %52, ptr %scope27.i, align 8, !tbaa !167
  ...
  %53 = load ptr, ptr %globals.i, align 8, !tbaa !261
  %globals32.i = getelementptr inbounds %struct.PNode, ptr %new_pn.0.i, i64 0, i32 19, i32 6
  store ptr %53, ptr %globals32.i, align 8, !tbaa !261
  ...
  store ptr %new_pn.0.i, ptr %latest.i73, align 8, !tbaa !118
...
if.then39.i:                                      ; preds = %if.end23.i
  ...
  %55 = load i8, ptr %op_assoc.i, align 1, !tbaa !262
  ...
  %56 = load i32, ptr %op_priority.i, align 4, !tbaa !263
  ...
  %57 = load ptr, ptr %speculative_code.i, align 8, !tbaa !264
...
if.then44.i:                                      ; preds = %if.then39.i
  ...
  %call50.i = tail call i32 %57(ptr noundef nonnull %pn, ptr noundef %58, i32 noundef %59, i32 noundef 152, ptr noundef %p) #22
...
if.then59.i:                                      ; preds = %if.then57.i
  ...
  %i.0280.i = add i32 %60, -1
  %cmp281.i = icmp sgt i32 %i.0280.i, -1
  br i1 %cmp281.i, label %for.body.lr.ph.i75, label %if.end124.i
...
for.body.i76:                                     ; preds = %do.body120.i, %for.body.lr.ph.i75
  %i.0282.i = phi i32 [ %i.0280.i, %for.body.lr.ph.i75 ], [ %i.0.i, %do.body120.i ]
  %61 = load ptr, ptr %v64.i, align 8, !tbaa !211
  %idxprom65.i = zext i32 %i.0282.i to i64
  %arrayidx66.i = getelementptr inbounds ptr, ptr %61, i64 %idxprom65.i
  %62 = load ptr, ptr %arrayidx66.i, align 8, !tbaa !16
  %63 = load ptr, ptr %62, align 8, !tbaa !159
  %latest68.i = getelementptr inbounds %struct.PNode, ptr %63, i64 0, i32 14
  %64 = load ptr, ptr %latest68.i, align 8, !tbaa !118
  %65 = load ptr, ptr %v70.i, align 8, !tbaa !15
  %tobool71.not.i = icmp eq ptr %65, null
...
if.then72.i:                                      ; preds = %for.body.i76
  ...
  %66 = load i32, ptr %children69.i, align 8, !tbaa !14
  %inc79.i = add i32 %66, 1
  store i32 %inc79.i, ptr %children69.i, align 8, !tbaa !14
  %idxprom80.i = zext i32 %66 to i64
  %arrayidx81.i = getelementptr inbounds ptr, ptr %e86.i, i64 %idxprom80.i
  store ptr %64, ptr %arrayidx81.i, align 8, !tbaa !16
  br label %do.body120.i

if.else82.i:                                      ; preds = %for.body.i76
  %cmp88.i = icmp eq ptr %65, %e86.i
...
if.then108.i:                                     ; preds = %if.else104.i
  %inc113.i = add i32 %67, 1
  store i32 %inc113.i, ptr %children69.i, align 8, !tbaa !14
  %idxprom114.i = zext i32 %67 to i64
  %arrayidx115.i = getelementptr inbounds ptr, ptr %65, i64 %idxprom114.i
  store ptr %64, ptr %arrayidx115.i, align 8, !tbaa !16
  br label %do.body120.i

if.end118.i:                                      ; preds = %if.else104.i, %if.then90.i
  tail call void @vec_add_internal(ptr noundef nonnull %children69.i, ptr noundef %64) #22
  br label %do.body120.i

do.body120.i:                                     ; preds = %if.end118.i, %if.then108.i, %if.then95.i, %if.then72.i
  %refcount.i = getelementptr inbounds %struct.PNode, ptr %64, i64 0, i32 6
  %68 = load i32, ptr %refcount.i, align 8, !tbaa !64
  %inc121.i = add i32 %68, 1
  store i32 %inc121.i, ptr %refcount.i, align 8, !tbaa !64
  %i.0.i = add i32 %i.0282.i, -1
  %cmp.i77 = icmp sgt i32 %i.0.i, -1
  br i1 %cmp.i77, label %for.body.i76, label %if.end124.i, !llvm.loop !265
...
if.end124.i:                                      ; preds = %do.body120.i, %if.then59.i, %if.then57.i
  ...
  %69 = load i32, ptr %children.i.i, align 8, !tbaa !14
  %cmp58.not.i.i = icmp eq i32 %69, 0
...
for.body.i.i:                                     ; preds = %if.end.i.i.1, %for.body.lr.ph.i.i.new
  ...
  %arrayidx.i.i = getelementptr inbounds ptr, ptr %70, i64 %indvars.iv.i.i
  %72 = load ptr, ptr %arrayidx.i.i, align 8, !tbaa !16
  %op_assoc.i.i = getelementptr inbounds %struct.PNode, ptr %72, i64 0, i32 2
  %73 = load i32, ptr %op_assoc.i.i, align 8, !tbaa !209
  %tobool.not.i273.i = icmp eq i32 %73, 0
  br i1 %tobool.not.i273.i, label %if.end.i.i, label %if.then.i.i

if.then.i.i:                                      ; preds = %for.body.i.i
  store i32 %73, ptr %new_pn.0.i, align 8, !tbaa !266
  %op_priority.i.i = getelementptr inbounds %struct.PNode, ptr %72, i64 0, i32 3
  %74 = load i32, ptr %op_priority.i.i, align 4, !tbaa !215
  store i32 %74, ptr %priority.i.i, align 4, !tbaa !267
  br label %if.end.i.i

if.end.i.i:                                       ; preds = %if.then.i.i, %for.body.i.i
  %height3.i.i = getelementptr inbounds %struct.PNode, ptr %72, i64 0, i32 8
  %75 = load i32, ptr %height3.i.i, align 8, !tbaa !268
  %cmp4.not.i.i = icmp ult i32 %75, %height.060.i.i
  ...
  %arrayidx.i.i.1 = getelementptr inbounds ptr, ptr %70, i64 %indvars.iv.next.i.i
  %76 = load ptr, ptr %arrayidx.i.i.1, align 8, !tbaa !16
  %op_assoc.i.i.1 = getelementptr inbounds %struct.PNode, ptr %76, i64 0, i32 2
  %77 = load i32, ptr %op_assoc.i.i.1, align 8, !tbaa !209
  %tobool.not.i273.i.1 = icmp eq i32 %77, 0
  br i1 %tobool.not.i273.i.1, label %if.end.i.i.1, label %if.then.i.i.1

if.then.i.i.1:                                    ; preds = %if.end.i.i
  store i32 %77, ptr %new_pn.0.i, align 8, !tbaa !266
  %op_priority.i.i.1 = getelementptr inbounds %struct.PNode, ptr %76, i64 0, i32 3
  %78 = load i32, ptr %op_priority.i.i.1, align 4, !tbaa !215
  store i32 %78, ptr %priority.i.i, align 4, !tbaa !267
  br label %if.end.i.i.1

if.end.i.i.1:                                     ; preds = %if.then.i.i.1, %if.end.i.i
  %height3.i.i.1 = getelementptr inbounds %struct.PNode, ptr %76, i64 0, i32 8
  %79 = load i32, ptr %height3.i.i.1, align 8, !tbaa !268
  %cmp4.not.i.i.1 = icmp ult i32 %79, %spec.select.i.i
  %add.i.i.1 = add i32 %79, 1
  %spec.select.i.i.1 = select i1 %cmp4.not.i.i.1, i32 %spec.select.i.i, i32 %add.i.i.1
  %indvars.iv.next.i.i.1 = add nuw nsw i64 %indvars.iv.i.i, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %for.end.i.i.loopexit.unr-lcssa, label %for.body.i.i, !llvm.loop !269
...
for.body.i.i.epil:                                ; preds = %for.end.i.i.loopexit.unr-lcssa
  %arrayidx.i.i.epil = getelementptr inbounds ptr, ptr %70, i64 %indvars.iv.i.i.unr
  %80 = load ptr, ptr %arrayidx.i.i.epil, align 8, !tbaa !16
  %op_assoc.i.i.epil = getelementptr inbounds %struct.PNode, ptr %80, i64 0, i32 2
  %81 = load i32, ptr %op_assoc.i.i.epil, align 8, !tbaa !209
  %tobool.not.i273.i.epil = icmp eq i32 %81, 0
  br i1 %tobool.not.i273.i.epil, label %if.end.i.i.epil, label %if.then.i.i.epil

if.then.i.i.epil:                                 ; preds = %for.body.i.i.epil
  store i32 %81, ptr %new_pn.0.i, align 8, !tbaa !266
  %op_priority.i.i.epil = getelementptr inbounds %struct.PNode, ptr %80, i64 0, i32 3
  %82 = load i32, ptr %op_priority.i.i.epil, align 4, !tbaa !215
  store i32 %82, ptr %priority.i.i, align 4, !tbaa !267
  br label %if.end.i.i.epil

if.end.i.i.epil:                                  ; preds = %if.then.i.i.epil, %for.body.i.i.epil
  %height3.i.i.epil = getelementptr inbounds %struct.PNode, ptr %80, i64 0, i32 8
  %83 = load i32, ptr %height3.i.i.epil, align 8, !tbaa !268
  %cmp4.not.i.i.epil = icmp ult i32 %83, %height.060.i.i.unr
  %add.i.i.epil = add i32 %83, 1
...
for.end.i.i:                                      ; preds = %if.end.i.i.epil, %for.end.i.i.loopexit.unr-lcssa, %if.end124.i
  ...
  %84 = load i16, ptr %op_assoc8.i.i, align 8, !tbaa !270
...
if.end19.i.i:                                     ; preds = %if.then14.i.i, %for.end.i.i
  ...
  %88 = load ptr, ptr %speculative_code.i.i, align 8, !tbaa !274
  %tobool20.not.i.i = icmp eq ptr %88, null
  br i1 %tobool20.not.i.i, label %if.end128.i, label %reduce_actions.exit.i

reduce_actions.exit.i:                            ; preds = %if.end19.i.i
  %v24.i.i = getelementptr inbounds %struct.PNode, ptr %new_pn.0.i, i64 0, i32 7, i32 2
  %89 = load ptr, ptr %v24.i.i, align 8, !tbaa !15
  %call.i.i = tail call i32 %88(ptr noundef nonnull %new_pn.0.i, ptr noundef %89, i32 noundef %69, i32 noundef 152, ptr noundef %p) #22
  %tobool126.not.i = icmp eq i32 %call.i.i, 0
  br i1 %tobool126.not.i, label %if.end128.i, label %make_PNode.exit.thread

if.end128.i:                                      ; preds = %reduce_actions.exit.i, %if.end19.i.i
  br i1 %tobool9.i, label %land.lhs.true.i78, label %make_PNode.exit

land.lhs.true.i78:                                ; preds = %if.end128.i
  %90 = load i32, ptr %path, align 8, !tbaa !210
  %or.cond285.i = icmp sgt i32 %90, 1
  br i1 %or.cond285.i, label %for.body139.lr.ph.i, label %make_PNode.exit

for.body139.lr.ph.i:                              ; preds = %land.lhs.true.i78
  %v141.i = getelementptr inbounds %struct.PNode, ptr %new_pn.0.i, i64 0, i32 7, i32 2
  %91 = load ptr, ptr %v141.i, align 8, !tbaa !15
  %priority.i = getelementptr inbounds %struct.PNode, ptr %new_pn.0.i, i64 0, i32 1
  %sub151.i = add nsw i32 %90, -1
  %92 = zext i32 %sub151.i to i64
...
for.body139.i:                                    ; preds = %for.inc158.i, %for.body139.lr.ph.i
  ...
  %arrayidx143.i = getelementptr inbounds ptr, ptr %91, i64 %indvars.iv.i79
  %94 = load ptr, ptr %arrayidx143.i, align 8, !tbaa !16
  %95 = load i32, ptr %94, align 8, !tbaa !266
  %tobool144.not.i = icmp eq i32 %95, 0
  br i1 %tobool144.not.i, label %for.inc158.i, label %land.lhs.true145.i

land.lhs.true145.i:                               ; preds = %for.body139.i
  %96 = load i32, ptr %priority.i, align 4, !tbaa !267
  %97 = load i32, ptr %new_pn.0.i, align 8, !tbaa !266
  %priority147.i = getelementptr inbounds %struct.PNode, ptr %94, i64 0, i32 1
  %98 = load i32, ptr %priority147.i, align 4, !tbaa !267
  %99 = icmp eq i64 %indvars.iv.i79, %92
  %cmp17.i.i = icmp sgt i32 %98, %96
  br i1 %cmp17.i.i, label %check_child.exit.i, label %cond.false19.i.i

cond.false19.i.i:                                 ; preds = %land.lhs.true145.i
  %cmp20.i.i = icmp slt i32 %98, %96
  br i1 %cmp20.i.i, label %check_child.exit.i, label %cond.false22.i.i

cond.false22.i.i:                                 ; preds = %cond.false19.i.i
  %and23.i.i = and i32 %95, 2
  %and26.i.i = lshr i32 %97, 1
  %and26.lobit.i.i = and i32 %and26.i.i, 1
  %add.i275.i = add nuw nsw i32 %and23.i.i, 2
  %add29.i.i = or i32 %and26.lobit.i.i, %add.i275.i
  %100 = zext i32 %add29.i.i to i64
  br label %check_child.exit.i

check_child.exit.i:                               ; preds = %cond.false22.i.i, %cond.false19.i.i, %land.lhs.true145.i
  %cond33.i.i = phi i64 [ 0, %land.lhs.true145.i ], [ %100, %cond.false22.i.i ], [ 1, %cond.false19.i.i ]
  %101 = and i32 %95, 20
  %or.cond46.i.i = icmp eq i32 %101, 0
  %cmp13.i.i = icmp eq i32 %95, 9
  %cond14.i.i = select i1 %cmp13.i.i, i64 1, i64 2
  %cond16.i.i = select i1 %or.cond46.i.i, i64 %cond14.i.i, i64 0
  %102 = and i32 %97, 20
  %or.cond.i.i = icmp eq i32 %102, 0
  %cmp.i276.i = icmp eq i32 %97, 9
  %cond4.i.i = select i1 %cmp.i276.i, i64 2, i64 3
  %cond.i.i = zext i1 %99 to i64
  ...
  %103 = load i32, ptr %arrayidx37.i.i, align 4, !tbaa !50
  %tobool155.not.i = icmp eq i32 %103, 0
  br i1 %tobool155.not.i, label %make_PNode.exit.thread, label %for.inc158.i

for.inc158.i:                                     ; preds = %check_child.exit.i, %for.body139.i
  %indvars.iv.next.i80 = add i64 %indvars.iv.i79, %92
  %cmp137.not.i = icmp slt i64 %indvars.iv.next.i80, %93
  br i1 %cmp137.not.i, label %for.body139.i, label %make_PNode.exit, !llvm.loop !275
...
make_PNode.exit:                                  ; preds = %for.inc158.i, %if.then39.i, %if.then44.i, %if.else55.i, %if.end128.i, %land.lhs.true.i78
  ...
  br i1 %tobool.not116, label %if.then5, label %if.end9

make_PNode.exit.thread:                           ; preds = %check_child.exit.i, %if.then44.i, %reduce_actions.exit.i
  tail call fastcc void @free_PNode(ptr noundef %p, ptr noundef nonnull %new_pn.0.i)
  %spec.select = select i1 %tobool.not116, ptr null, ptr %retval.0.i115
  br label %cleanup
...
if.end8:                                          ; preds = %if.then5
  ...
  %104 = load i32, ptr %refcount.i81, align 8, !tbaa !64
  %inc.i82 = add i32 %104, 1
  store i32 %inc.i82, ptr %refcount.i81, align 8, !tbaa !64
  %all.i = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 11, i32 4
  %105 = load ptr, ptr %all.i, align 8, !tbaa !244
  %all_next.i83 = getelementptr inbounds %struct.PNode, ptr %new_pn.0.i, i64 0, i32 11
  store ptr %105, ptr %all_next.i83, align 8, !tbaa !120
  store ptr %new_pn.0.i, ptr %all.i, align 8, !tbaa !244
  br label %cleanup
...
if.end12:                                         ; preds = %if.end9
  ...
  %106 = load i32, ptr %compares, align 4, !tbaa !164
  %inc = add nsw i32 %106, 1
  store i32 %inc, ptr %compares, align 4, !tbaa !164
  ...
  call void @llvm.lifetime.start.p0(i64 88, ptr nonnull %psx.i) #22
  call void @llvm.lifetime.start.p0(i64 88, ptr nonnull %psy.i) #22
  call void @llvm.lifetime.start.p0(i64 56, ptr nonnull %isx.i) #22
  call void @llvm.lifetime.start.p0(i64 56, ptr nonnull %isy.i) #22
  %107 = load i32, ptr %new_pn.0.i, align 8, !tbaa !266
  %tobool.not.i84 = icmp eq i32 %107, 0
  br i1 %tobool.not.i84, label %if.end163.i, label %land.lhs.true.i85

land.lhs.true.i85:                                ; preds = %if.end12
  %108 = load i32, ptr %retval.0.i115, align 8, !tbaa !266
  %tobool2.not.i = icmp eq i32 %108, 0
  br i1 %tobool2.not.i, label %if.end163.i, label %if.then.i88

if.then.i88:                                      ; preds = %land.lhs.true.i85
  %and.i86 = and i32 %107, 4
  %tobool4.not.i = icmp eq i32 %and.i86, 0
  %and7.i = and i32 %108, 4
  %tobool8.not.i = icmp eq i32 %and7.i, 0
  %or.cond.i87 = select i1 %tobool4.not.i, i1 %tobool8.not.i, i1 false
  br i1 %or.cond.i87, label %if.then9.i, label %do.body.i

if.then9.i:                                       ; preds = %if.then.i88
  %priority.i89 = getelementptr inbounds %struct.PNode, ptr %new_pn.0.i, i64 0, i32 1
  %109 = load i32, ptr %priority.i89, align 4, !tbaa !267
  %priority10.i = getelementptr inbounds %struct.PNode, ptr %retval.0.i115, i64 0, i32 1
  %110 = load i32, ptr %priority10.i, align 4, !tbaa !267
  %cmp.i90 = icmp sgt i32 %109, %110
  br i1 %cmp.i90, label %cmp_pnodes.exit.thread, label %if.end.i91

if.end.i91:                                       ; preds = %if.then9.i
  %cmp14.i = icmp slt i32 %109, %110
  br i1 %cmp14.i, label %cmp_pnodes.exit.thread132, label %do.body.i

do.body.i:                                        ; preds = %if.end.i91, %if.then.i88
  %initial.i = getelementptr inbounds %struct.StackPNode, ptr %psx.i, i64 0, i32 3
  %end.i92 = getelementptr inbounds %struct.StackPNode, ptr %psx.i, i64 0, i32 1
  store ptr %initial.i, ptr %psx.sroa.gep.i, align 8, !tbaa !276
  store ptr %initial.i, ptr %psx.i, align 8, !tbaa !278
  %add.ptr.i = getelementptr inbounds %struct.StackPNode, ptr %psx.i, i64 1
  store ptr %add.ptr.i, ptr %end.i92, align 8, !tbaa !279
  ...
  store ptr %initial20.i, ptr %psy.sroa.gep252.i, align 8, !tbaa !276
  store ptr %initial20.i, ptr %psy.i, align 8, !tbaa !278
  %add.ptr26.i = getelementptr inbounds %struct.StackPNode, ptr %psy.i, i64 1
  store ptr %add.ptr26.i, ptr %end22.i, align 8, !tbaa !279
  ...
  store ptr %initial30.i, ptr %cur33.i, align 8, !tbaa !276
  store ptr %initial30.i, ptr %isx.i, align 8, !tbaa !278
  %add.ptr36.i = getelementptr inbounds %struct.StackInt, ptr %isx.i, i64 1
  store ptr %add.ptr36.i, ptr %end32.i, align 8, !tbaa !279
  ...
  store ptr %initial40.i, ptr %cur43.i, align 8, !tbaa !276
  store ptr %initial40.i, ptr %isy.i, align 8, !tbaa !278
  %add.ptr46.i = getelementptr inbounds %struct.StackInt, ptr %isy.i, i64 1
  store ptr %add.ptr46.i, ptr %end42.i, align 8, !tbaa !279
  call fastcc void @get_exp_one(ptr noundef nonnull %new_pn.0.i, ptr noundef nonnull %psx.i, ptr noundef nonnull %isx.i)
  call fastcc void @get_exp_one(ptr noundef nonnull %retval.0.i115, ptr noundef nonnull %psy.i, ptr noundef nonnull %isy.i)
  %111 = load ptr, ptr %psx.sroa.gep.i, align 8, !tbaa !276
  %112 = load ptr, ptr %psx.i, align 8, !tbaa !278
  %cmp127.i.i = icmp eq ptr %111, %112
  br i1 %cmp127.i.i, label %while.end.i.i, label %if.else.i.i93

if.else.i.i93:                                    ; preds = %do.body.i, %while.cond.backedge.i.i
  %113 = phi ptr [ %120, %while.cond.backedge.i.i ], [ %111, %do.body.i ]
  %114 = load ptr, ptr %psy.sroa.gep252.i, align 8, !tbaa !276
  %115 = load ptr, ptr %psy.i, align 8, !tbaa !278
  %cmp3.i.i = icmp eq ptr %114, %115
  br i1 %cmp3.i.i, label %while.end.i.i, label %if.end5.i.i

if.end5.i.i:                                      ; preds = %if.else.i.i93
  %arrayidx.i.i94 = getelementptr inbounds ptr, ptr %113, i64 -1
  %116 = load ptr, ptr %arrayidx.i.i94, align 8, !tbaa !16
  %height.i.i = getelementptr inbounds %struct.PNode, ptr %116, i64 0, i32 8
  %117 = load i32, ptr %height.i.i, align 8, !tbaa !268
  %arrayidx8.i.i = getelementptr inbounds ptr, ptr %114, i64 -1
  %118 = load ptr, ptr %arrayidx8.i.i, align 8, !tbaa !16
  %height9.i.i = getelementptr inbounds %struct.PNode, ptr %118, i64 0, i32 8
  %119 = load i32, ptr %height9.i.i, align 8, !tbaa !268
  %cmp10.i.i = icmp ugt i32 %117, %119
  br i1 %cmp10.i.i, label %if.end42.thread.i.i, label %if.else12.i.i

if.else12.i.i:                                    ; preds = %if.end5.i.i
  %cmp19.i.i = icmp ult i32 %117, %119
  br i1 %cmp19.i.i, label %if.end42.i.i, label %if.else21.i.i

if.else21.i.i:                                    ; preds = %if.else12.i.i
  %cmp26.i.i = icmp ugt ptr %116, %118
  br i1 %cmp26.i.i, label %if.end42.thread.i.i, label %if.else28.i.i

if.else28.i.i:                                    ; preds = %if.else21.i.i
  %cmp33.i.i = icmp ult ptr %116, %118
  br i1 %cmp33.i.i, label %if.end42.i.i, label %if.else35.i.i

if.else35.i.i:                                    ; preds = %if.else28.i.i
  store ptr %arrayidx.i.i94, ptr %psx.sroa.gep.i, align 8, !tbaa !276
  store ptr %arrayidx8.i.i, ptr %psy.sroa.gep252.i, align 8, !tbaa !276
...
while.cond.backedge.i.i:                          ; preds = %for.inc.i120.i.i, %for.inc.i.i.i, %cond.end.i109.i.i, %cond.end.i.i.i, %if.else35.i.i
  %120 = load ptr, ptr %psx.sroa.gep.i, align 8, !tbaa !276
  %121 = load ptr, ptr %psx.i, align 8, !tbaa !278
  %cmp.i.i95 = icmp eq ptr %120, %121
  br i1 %cmp.i.i95, label %while.end.i.i, label %if.else.i.i93

if.end42.thread.i.i:                              ; preds = %if.else21.i.i, %if.end5.i.i
  store ptr %arrayidx.i.i94, ptr %psx.sroa.gep.i, align 8, !tbaa !276
  %122 = load ptr, ptr %arrayidx.i.i94, align 8, !tbaa !16
  %123 = load ptr, ptr %cur33.i, align 8, !tbaa !276
  %124 = load ptr, ptr %end32.i, align 8, !tbaa !279
  %cmp.i.i.i = icmp eq ptr %123, %124
  %priority.i.i.i = getelementptr inbounds %struct.PNode, ptr %122, i64 0, i32 1
  %125 = load i32, ptr %priority.i.i.i, align 4, !tbaa !267
  br i1 %cmp.i.i.i, label %cond.true.i.i.i, label %cond.false.i.i.i

if.end42.i.i:                                     ; preds = %if.else28.i.i, %if.else12.i.i
  store ptr %arrayidx8.i.i, ptr %psy.sroa.gep252.i, align 8, !tbaa !276
  %126 = load ptr, ptr %arrayidx8.i.i, align 8, !tbaa !16
  %127 = load ptr, ptr %cur43.i, align 8, !tbaa !276
  %128 = load ptr, ptr %end42.i, align 8, !tbaa !279
  %cmp.i100.i.i = icmp eq ptr %127, %128
  %priority.i101.i.i = getelementptr inbounds %struct.PNode, ptr %126, i64 0, i32 1
  %129 = load i32, ptr %priority.i101.i.i, align 4, !tbaa !267
  br i1 %cmp.i100.i.i, label %cond.true.i104.i.i, label %cond.false.i106.i.i

cond.true.i.i.i:                                  ; preds = %if.end42.thread.i.i
  %conv.i.i.i = sext i32 %125 to i64
  %130 = inttoptr i64 %conv.i.i.i to ptr
  %call.i.i.i = call ptr @stack_push_internal(ptr noundef nonnull %isx.i, ptr noundef %130) #22
  br label %cond.end.i.i.i

cond.false.i.i.i:                                 ; preds = %if.end42.thread.i.i
  %incdec.ptr.i.i.i = getelementptr inbounds i32, ptr %123, i64 1
  store ptr %incdec.ptr.i.i.i, ptr %cur33.i, align 8, !tbaa !276
  store i32 %125, ptr %123, align 4, !tbaa !50
  br label %cond.end.i.i.i

cond.end.i.i.i:                                   ; preds = %cond.false.i.i.i, %cond.true.i.i.i
  %children.i.i.i = getelementptr inbounds %struct.PNode, ptr %122, i64 0, i32 7
  %131 = load i32, ptr %children.i.i.i, align 8, !tbaa !14
  %cmp422.not.i.i.i = icmp eq i32 %131, 0
  br i1 %cmp422.not.i.i.i, label %while.cond.backedge.i.i, label %for.body.lr.ph.i.i.i

for.body.lr.ph.i.i.i:                             ; preds = %cond.end.i.i.i
  %v.i.i.i = getelementptr inbounds %struct.PNode, ptr %122, i64 0, i32 7, i32 2
  br label %for.body.i.i.i

for.body.i.i.i:                                   ; preds = %for.inc.i.i.i, %for.body.lr.ph.i.i.i
  %132 = phi i32 [ %131, %for.body.lr.ph.i.i.i ], [ %136, %for.inc.i.i.i ]
  %indvars.iv.i.i.i = phi i64 [ 0, %for.body.lr.ph.i.i.i ], [ %indvars.iv.next.i.i.i, %for.inc.i.i.i ]
  %133 = load ptr, ptr %v.i.i.i, align 8, !tbaa !15
  %arrayidx.i.i.i = getelementptr inbounds ptr, ptr %133, i64 %indvars.iv.i.i.i
  %134 = load ptr, ptr %arrayidx.i.i.i, align 8, !tbaa !16
  %135 = load i32, ptr %134, align 8, !tbaa !266
  %tobool.not.i.i.i = icmp eq i32 %135, 0
  br i1 %tobool.not.i.i.i, label %for.inc.i.i.i, label %if.then.i.i.i

if.then.i.i.i:                                    ; preds = %for.body.i.i.i
  call fastcc void @get_exp_one(ptr noundef nonnull %134, ptr noundef nonnull %psx.i, ptr noundef nonnull %isx.i)
  %.pre.i.i.i = load i32, ptr %children.i.i.i, align 8, !tbaa !14
  br label %for.inc.i.i.i

for.inc.i.i.i:                                    ; preds = %if.then.i.i.i, %for.body.i.i.i
  %136 = phi i32 [ %132, %for.body.i.i.i ], [ %.pre.i.i.i, %if.then.i.i.i ]
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1
  %137 = zext i32 %136 to i64
  %cmp4.i.i.i = icmp ult i64 %indvars.iv.next.i.i.i, %137
  br i1 %cmp4.i.i.i, label %for.body.i.i.i, label %while.cond.backedge.i.i, !llvm.loop !280

cond.true.i104.i.i:                               ; preds = %if.end42.i.i
  %conv.i102.i.i = sext i32 %129 to i64
  %138 = inttoptr i64 %conv.i102.i.i to ptr
  %call.i103.i.i = call ptr @stack_push_internal(ptr noundef nonnull %isy.i, ptr noundef %138) #22
  br label %cond.end.i109.i.i

cond.false.i106.i.i:                              ; preds = %if.end42.i.i
  %incdec.ptr.i105.i.i = getelementptr inbounds i32, ptr %127, i64 1
  store ptr %incdec.ptr.i105.i.i, ptr %cur43.i, align 8, !tbaa !276
  store i32 %129, ptr %127, align 4, !tbaa !50
  br label %cond.end.i109.i.i

cond.end.i109.i.i:                                ; preds = %cond.false.i106.i.i, %cond.true.i104.i.i
  %children.i107.i.i = getelementptr inbounds %struct.PNode, ptr %126, i64 0, i32 7
  %139 = load i32, ptr %children.i107.i.i, align 8, !tbaa !14
  %cmp422.not.i108.i.i = icmp eq i32 %139, 0
...
for.body.lr.ph.i111.i.i:                          ; preds = %cond.end.i109.i.i
  %v.i110.i.i = getelementptr inbounds %struct.PNode, ptr %126, i64 0, i32 7, i32 2
  br label %for.body.i115.i.i

for.body.i115.i.i:                                ; preds = %for.inc.i120.i.i, %for.body.lr.ph.i111.i.i
  %140 = phi i32 [ %139, %for.body.lr.ph.i111.i.i ], [ %144, %for.inc.i120.i.i ]
  %indvars.iv.i112.i.i = phi i64 [ 0, %for.body.lr.ph.i111.i.i ], [ %indvars.iv.next.i118.i.i, %for.inc.i120.i.i ]
  %141 = load ptr, ptr %v.i110.i.i, align 8, !tbaa !15
  %arrayidx.i113.i.i = getelementptr inbounds ptr, ptr %141, i64 %indvars.iv.i112.i.i
  %142 = load ptr, ptr %arrayidx.i113.i.i, align 8, !tbaa !16
  %143 = load i32, ptr %142, align 8, !tbaa !266
  %tobool.not.i114.i.i = icmp eq i32 %143, 0
  br i1 %tobool.not.i114.i.i, label %for.inc.i120.i.i, label %if.then.i117.i.i

if.then.i117.i.i:                                 ; preds = %for.body.i115.i.i
  call fastcc void @get_exp_one(ptr noundef nonnull %142, ptr noundef nonnull %psy.i, ptr noundef nonnull %isy.i)
...
for.inc.i120.i.i:                                 ; preds = %if.then.i117.i.i, %for.body.i115.i.i
  %144 = phi i32 [ %140, %for.body.i115.i.i ], [ %.pre.i116.i.i, %if.then.i117.i.i ]
  %indvars.iv.next.i118.i.i = add nuw nsw i64 %indvars.iv.i112.i.i, 1
  %145 = zext i32 %144 to i64
  %cmp4.i119.i.i = icmp ult i64 %indvars.iv.next.i118.i.i, %145
  br i1 %cmp4.i119.i.i, label %for.body.i115.i.i, label %while.cond.backedge.i.i, !llvm.loop !280

while.end.i.i:                                    ; preds = %while.cond.backedge.i.i, %if.else.i.i93, %do.body.i
  %psr.1.i.i = phi ptr [ %psy.i, %do.body.i ], [ %psx.i, %if.else.i.i93 ], [ %psy.i, %while.cond.backedge.i.i ]
  %psr.1.i.sroa.phi.i = phi ptr [ %psy.sroa.gep252.i, %do.body.i ], [ %psx.sroa.gep.i, %if.else.i.i93 ], [ %psy.sroa.gep252.i, %while.cond.backedge.i.i ]
  %146 = load ptr, ptr %psr.1.i.sroa.phi.i, align 8, !tbaa !276
  %147 = load ptr, ptr %psr.1.i.i, align 8, !tbaa !278
  %cmp52.not129.i.i = icmp eq ptr %146, %147
...
while.body53.us.i.i:                              ; preds = %while.body53.lr.ph.i.i, %while.body53.us.i.i
  %148 = phi ptr [ %150, %while.body53.us.i.i ], [ %146, %while.body53.lr.ph.i.i ]
  %incdec.ptr55.us.i.i = getelementptr inbounds ptr, ptr %148, i64 -1
  store ptr %incdec.ptr55.us.i.i, ptr %psr.1.i.sroa.phi.i, align 8, !tbaa !276
...
while.body53.i.i:                                 ; preds = %while.body53.lr.ph.i.i, %while.body53.i.i
  %152 = phi ptr [ %154, %while.body53.i.i ], [ %146, %while.body53.lr.ph.i.i ]
  %incdec.ptr55.i.i = getelementptr inbounds ptr, ptr %152, i64 -1
  store ptr %incdec.ptr55.i.i, ptr %psr.1.i.sroa.phi.i, align 8, !tbaa !276
  %153 = load ptr, ptr %incdec.ptr55.i.i, align 8, !tbaa !16
  call fastcc void @get_exp_all(ptr noundef %153, ptr noundef nonnull %isy.i)
  %154 = load ptr, ptr %psr.1.i.sroa.phi.i, align 8, !tbaa !276
  %155 = load ptr, ptr %psr.1.i.i, align 8, !tbaa !278
  %cmp52.not.i.i = icmp eq ptr %154, %155
  br i1 %cmp52.not.i.i, label %get_unshared_priorities.exit.i, label %while.body53.i.i, !llvm.loop !281

get_unshared_priorities.exit.i:                   ; preds = %while.body53.i.i, %while.body53.us.i.i, %while.end.i.i
  %156 = load ptr, ptr %isx.i, align 8, !tbaa !278
  %157 = load ptr, ptr %cur33.i, align 8, !tbaa !276
  %sub.ptr.lhs.cast.i = ptrtoint ptr %157 to i64
  %sub.ptr.rhs.cast.i = ptrtoint ptr %156 to i64
  %sub.ptr.sub.i = sub i64 %sub.ptr.lhs.cast.i, %sub.ptr.rhs.cast.i
  %158 = lshr exact i64 %sub.ptr.sub.i, 2
  %conv.i96 = trunc i64 %158 to i32
  %cmp27.i.i = icmp sgt i32 %conv.i96, 1
...
for.cond.preheader.us.preheader.i.i:              ; preds = %get_unshared_priorities.exit.i
  %sub.i.i = add nuw nsw i64 %158, 4294967295
  %wide.trip.count.i.i97 = and i64 %sub.i.i, 4294967295
  %xtraiter162 = and i64 %sub.i.i, 1
  %159 = icmp eq i64 %wide.trip.count.i.i97, 1
  %unroll_iter165 = sub nsw i64 %wide.trip.count.i.i97, %xtraiter162
...
for.cond.preheader.us.i.i:                        ; preds = %for.cond.while.cond.loopexit_crit_edge.us.i.i, %for.cond.preheader.us.preheader.i.i
  %.pre.i.i = load i32, ptr %156, align 4, !tbaa !50
  br i1 %159, label %for.cond.while.cond.loopexit_crit_edge.us.i.i.unr-lcssa, label %for.body.us.i.i

for.body.us.i.i:                                  ; preds = %for.cond.preheader.us.i.i, %for.inc.us.i.i.1
  %160 = phi i32 [ %164, %for.inc.us.i.i.1 ], [ %.pre.i.i, %for.cond.preheader.us.i.i ]
  %indvars.iv.i.i98 = phi i64 [ %indvars.iv.next.i.i99.1, %for.inc.us.i.i.1 ], [ 0, %for.cond.preheader.us.i.i ]
  ...
  %indvars.iv.next.i.i99 = or i64 %indvars.iv.i.i98, 1
  %arrayidx2.us.i.i = getelementptr inbounds i32, ptr %156, i64 %indvars.iv.next.i.i99
  %161 = load i32, ptr %arrayidx2.us.i.i, align 4, !tbaa !50
  %cmp3.us.i.i = icmp sgt i32 %160, %161
  br i1 %cmp3.us.i.i, label %if.then.us.i.i, label %for.inc.us.i.i

if.then.us.i.i:                                   ; preds = %for.body.us.i.i
  %arrayidx.us.i.i = getelementptr inbounds i32, ptr %156, i64 %indvars.iv.i.i98
  store i32 %161, ptr %arrayidx.us.i.i, align 4, !tbaa !50
  store i32 %160, ptr %arrayidx2.us.i.i, align 4, !tbaa !50
  br label %for.inc.us.i.i

for.inc.us.i.i:                                   ; preds = %if.then.us.i.i, %for.body.us.i.i
  %162 = phi i32 [ %160, %if.then.us.i.i ], [ %161, %for.body.us.i.i ]
  %again.2.us.i.i = phi i32 [ 1, %if.then.us.i.i ], [ %again.129.us.i.i, %for.body.us.i.i ]
  %indvars.iv.next.i.i99.1 = add nuw nsw i64 %indvars.iv.i.i98, 2
  %arrayidx2.us.i.i.1 = getelementptr inbounds i32, ptr %156, i64 %indvars.iv.next.i.i99.1
  %163 = load i32, ptr %arrayidx2.us.i.i.1, align 4, !tbaa !50
  %cmp3.us.i.i.1 = icmp sgt i32 %162, %163
  br i1 %cmp3.us.i.i.1, label %if.then.us.i.i.1, label %for.inc.us.i.i.1

if.then.us.i.i.1:                                 ; preds = %for.inc.us.i.i
  %arrayidx.us.i.i.1 = getelementptr inbounds i32, ptr %156, i64 %indvars.iv.next.i.i99
  store i32 %163, ptr %arrayidx.us.i.i.1, align 4, !tbaa !50
  store i32 %162, ptr %arrayidx2.us.i.i.1, align 4, !tbaa !50
  br label %for.inc.us.i.i.1

for.inc.us.i.i.1:                                 ; preds = %if.then.us.i.i.1, %for.inc.us.i.i
  %164 = phi i32 [ %162, %if.then.us.i.i.1 ], [ %163, %for.inc.us.i.i ]
  ...
  br i1 %niter166.ncmp.1, label %for.cond.while.cond.loopexit_crit_edge.us.i.i.unr-lcssa, label %for.body.us.i.i, !llvm.loop !282
...
for.cond.while.cond.loopexit_crit_edge.us.i.i.unr-lcssa: ; preds = %for.inc.us.i.i.1, %for.cond.preheader.us.i.i
  ...
  %.unr = phi i32 [ %.pre.i.i, %for.cond.preheader.us.i.i ], [ %164, %for.inc.us.i.i.1 ]
  %indvars.iv.i.i98.unr = phi i64 [ 0, %for.cond.preheader.us.i.i ], [ %indvars.iv.next.i.i99.1, %for.inc.us.i.i.1 ]
...
for.body.us.i.i.epil:                             ; preds = %for.cond.while.cond.loopexit_crit_edge.us.i.i.unr-lcssa
  %indvars.iv.next.i.i99.epil = add nuw nsw i64 %indvars.iv.i.i98.unr, 1
  %arrayidx2.us.i.i.epil = getelementptr inbounds i32, ptr %156, i64 %indvars.iv.next.i.i99.epil
  %165 = load i32, ptr %arrayidx2.us.i.i.epil, align 4, !tbaa !50
  %cmp3.us.i.i.epil = icmp sgt i32 %.unr, %165
...
if.then.us.i.i.epil:                              ; preds = %for.body.us.i.i.epil
  %arrayidx.us.i.i.epil = getelementptr inbounds i32, ptr %156, i64 %indvars.iv.i.i98.unr
  store i32 %165, ptr %arrayidx.us.i.i.epil, align 4, !tbaa !50
...
for.cond.while.cond.loopexit_crit_edge.us.i.i:    ; preds = %for.body.us.i.i.epil, %if.then.us.i.i.epil, %for.cond.while.cond.loopexit_crit_edge.us.i.i.unr-lcssa
  ...
  br i1 %tobool.not.us.i.i, label %intsort.exit.i, label %for.cond.preheader.us.i.i, !llvm.loop !283

intsort.exit.i:                                   ; preds = %for.cond.while.cond.loopexit_crit_edge.us.i.i, %get_unshared_priorities.exit.i
  %166 = load ptr, ptr %isy.i, align 8, !tbaa !278
  %167 = load ptr, ptr %cur43.i, align 8, !tbaa !276
  %sub.ptr.lhs.cast55.i = ptrtoint ptr %167 to i64
  %sub.ptr.rhs.cast56.i = ptrtoint ptr %166 to i64
  %sub.ptr.sub57.i = sub i64 %sub.ptr.lhs.cast55.i, %sub.ptr.rhs.cast56.i
  %168 = lshr exact i64 %sub.ptr.sub57.i, 2
  %conv59.i = trunc i64 %168 to i32
...
for.cond.preheader.us.i223.i:                     ; preds = %for.cond.while.cond.loopexit_crit_edge.us.i236.i, %for.cond.preheader.us.preheader.i221.i
  %.pre.i222.i = load i32, ptr %166, align 4, !tbaa !50
  br i1 %169, label %for.cond.while.cond.loopexit_crit_edge.us.i236.i.unr-lcssa, label %for.body.us.i229.i

for.body.us.i229.i:                               ; preds = %for.cond.preheader.us.i223.i, %for.inc.us.i234.i.1
  %170 = phi i32 [ %174, %for.inc.us.i234.i.1 ], [ %.pre.i222.i, %for.cond.preheader.us.i223.i ]
  ...
  %arrayidx2.us.i227.i = getelementptr inbounds i32, ptr %166, i64 %indvars.iv.next.i226.i
  %171 = load i32, ptr %arrayidx2.us.i227.i, align 4, !tbaa !50
  %cmp3.us.i228.i = icmp sgt i32 %170, %171
  br i1 %cmp3.us.i228.i, label %if.then.us.i231.i, label %for.inc.us.i234.i

if.then.us.i231.i:                                ; preds = %for.body.us.i229.i
  %arrayidx.us.i230.i = getelementptr inbounds i32, ptr %166, i64 %indvars.iv.i224.i
  store i32 %171, ptr %arrayidx.us.i230.i, align 4, !tbaa !50
  store i32 %170, ptr %arrayidx2.us.i227.i, align 4, !tbaa !50
  br label %for.inc.us.i234.i

for.inc.us.i234.i:                                ; preds = %if.then.us.i231.i, %for.body.us.i229.i
  %172 = phi i32 [ %170, %if.then.us.i231.i ], [ %171, %for.body.us.i229.i ]
  ...
  %arrayidx2.us.i227.i.1 = getelementptr inbounds i32, ptr %166, i64 %indvars.iv.next.i226.i.1
  %173 = load i32, ptr %arrayidx2.us.i227.i.1, align 4, !tbaa !50
  %cmp3.us.i228.i.1 = icmp sgt i32 %172, %173
  br i1 %cmp3.us.i228.i.1, label %if.then.us.i231.i.1, label %for.inc.us.i234.i.1

if.then.us.i231.i.1:                              ; preds = %for.inc.us.i234.i
  %arrayidx.us.i230.i.1 = getelementptr inbounds i32, ptr %166, i64 %indvars.iv.next.i226.i
  store i32 %173, ptr %arrayidx.us.i230.i.1, align 4, !tbaa !50
  store i32 %172, ptr %arrayidx2.us.i227.i.1, align 4, !tbaa !50
  br label %for.inc.us.i234.i.1

for.inc.us.i234.i.1:                              ; preds = %if.then.us.i231.i.1, %for.inc.us.i234.i
  %174 = phi i32 [ %172, %if.then.us.i231.i.1 ], [ %173, %for.inc.us.i234.i ]
  ...
  br i1 %niter172.ncmp.1, label %for.cond.while.cond.loopexit_crit_edge.us.i236.i.unr-lcssa, label %for.body.us.i229.i, !llvm.loop !282
...
for.cond.while.cond.loopexit_crit_edge.us.i236.i.unr-lcssa: ; preds = %for.inc.us.i234.i.1, %for.cond.preheader.us.i223.i
  ...
  %.unr168 = phi i32 [ %.pre.i222.i, %for.cond.preheader.us.i223.i ], [ %174, %for.inc.us.i234.i.1 ]
...
for.body.us.i229.i.epil:                          ; preds = %for.cond.while.cond.loopexit_crit_edge.us.i236.i.unr-lcssa
  ...
  %arrayidx2.us.i227.i.epil = getelementptr inbounds i32, ptr %166, i64 %indvars.iv.next.i226.i.epil
  %175 = load i32, ptr %arrayidx2.us.i227.i.epil, align 4, !tbaa !50
  %cmp3.us.i228.i.epil = icmp sgt i32 %.unr168, %175
...
if.then.us.i231.i.epil:                           ; preds = %for.body.us.i229.i.epil
  %arrayidx.us.i230.i.epil = getelementptr inbounds i32, ptr %166, i64 %indvars.iv.i224.i.unr
  store i32 %175, ptr %arrayidx.us.i230.i.epil, align 4, !tbaa !50
...
for.cond.while.cond.loopexit_crit_edge.us.i236.i: ; preds = %for.body.us.i229.i.epil, %if.then.us.i231.i.epil, %for.cond.while.cond.loopexit_crit_edge.us.i236.i.unr-lcssa
  ...
  br i1 %tobool.not.us.i235.i, label %intsort.exit238.i, label %for.cond.preheader.us.i223.i, !llvm.loop !283

intsort.exit238.i:                                ; preds = %for.cond.while.cond.loopexit_crit_edge.us.i236.i, %intsort.exit.i
  %cmp21.i.i = icmp sgt i32 %conv.i96, 0
  %cmp122.i.i = icmp sgt i32 %conv59.i, 0
  %176 = and i1 %cmp21.i.i, %cmp122.i.i
  br i1 %176, label %while.body.preheader.i.i, label %cmp_priorities.exit.i

while.body.preheader.i.i:                         ; preds = %intsort.exit238.i
  %177 = add nsw i32 %conv59.i, -1
  %178 = add nsw i32 %conv.i96, -1
  %umin.i.i = call i32 @llvm.umin.i32(i32 %177, i32 %178)
  %179 = add nuw nsw i32 %umin.i.i, 1
  %wide.trip.count.i239.i = zext i32 %179 to i64
  br label %while.body.i.i101

while.cond.i.i:                                   ; preds = %if.end.i.i102
  ...
  br i1 %exitcond.not.i241.i, label %cmp_priorities.exit.i, label %while.body.i.i101, !llvm.loop !284

while.body.i.i101:                                ; preds = %while.cond.i.i, %while.body.preheader.i.i
  %indvars.iv.i242.i = phi i64 [ 0, %while.body.preheader.i.i ], [ %indvars.iv.next.i240.i, %while.cond.i.i ]
  %arrayidx.i243.i = getelementptr inbounds i32, ptr %156, i64 %indvars.iv.i242.i
  %180 = load i32, ptr %arrayidx.i243.i, align 4, !tbaa !50
  %arrayidx3.i.i = getelementptr inbounds i32, ptr %166, i64 %indvars.iv.i242.i
  %181 = load i32, ptr %arrayidx3.i.i, align 4, !tbaa !50
  %cmp4.i.i = icmp sgt i32 %180, %181
  br i1 %cmp4.i.i, label %cmp_priorities.exit.i, label %if.end.i.i102

if.end.i.i102:                                    ; preds = %while.body.i.i101
  %cmp9.i.i = icmp slt i32 %180, %181
  br i1 %cmp9.i.i, label %cmp_priorities.exit.i, label %while.cond.i.i

cmp_priorities.exit.i:                            ; preds = %if.end.i.i102, %while.body.i.i101, %while.cond.i.i, %intsort.exit238.i
  %tobool160.not.i = phi i1 [ true, %intsort.exit238.i ], [ true, %while.cond.i.i ], [ false, %while.body.i.i101 ], [ false, %if.end.i.i102 ]
  %retval.0.i.i = phi i32 [ 0, %intsort.exit238.i ], [ 0, %while.cond.i.i ], [ -1, %while.body.i.i101 ], [ 1, %if.end.i.i102 ]
  %182 = load ptr, ptr %psx.i, align 8, !tbaa !278
  %cmp80.not.i = icmp eq ptr %182, %initial.i
...
do.body85.i:                                      ; preds = %if.then82.i, %cmp_priorities.exit.i
  ...
  store ptr %initial.i, ptr %psx.i, align 8, !tbaa !278
  store ptr %add.ptr.i, ptr %end.i92, align 8, !tbaa !279
  %183 = load ptr, ptr %psy.i, align 8, !tbaa !278
  %cmp101.not.i = icmp eq ptr %183, %initial20.i
...
do.body106.i:                                     ; preds = %if.then103.i, %do.body85.i
  ...
  store ptr %initial20.i, ptr %psy.i, align 8, !tbaa !278
  store ptr %add.ptr26.i, ptr %end22.i, align 8, !tbaa !279
  %184 = load ptr, ptr %isx.i, align 8, !tbaa !278
  %cmp122.not.i = icmp eq ptr %184, %initial30.i
...
do.body127.i:                                     ; preds = %if.then124.i, %do.body106.i
  ...
  store ptr %initial30.i, ptr %isx.i, align 8, !tbaa !278
  store ptr %add.ptr36.i, ptr %end32.i, align 8, !tbaa !279
  %185 = load ptr, ptr %isy.i, align 8, !tbaa !278
  %cmp143.not.i = icmp eq ptr %185, %initial40.i
...
if.end163.i:                                      ; preds = %do.body148.i, %land.lhs.true.i85, %if.end12
  ...
  %186 = load i32, ptr %dont_use_eagerness_for_disambiguation.i, align 8, !tbaa !285
  %tobool164.not.i = icmp eq i32 %186, 0
  br i1 %tobool164.not.i, label %if.then165.i, label %if.end170.i

if.then165.i:                                     ; preds = %if.end163.i
  %children.i.i103 = getelementptr inbounds %struct.PNode, ptr %new_pn.0.i, i64 0, i32 7
  %187 = load i32, ptr %children.i.i103, align 8, !tbaa !14
  %children2.i.i = getelementptr inbounds %struct.PNode, ptr %retval.0.i115, i64 0, i32 7
  %188 = load i32, ptr %children2.i.i, align 8, !tbaa !14
  %..i.i = call i32 @llvm.umin.i32(i32 %187, i32 %188)
  %cmp860.i.i = icmp sgt i32 %..i.i, 0
  br i1 %cmp860.i.i, label %for.body.lr.ph.i.i105, label %if.end170.i

for.body.lr.ph.i.i105:                            ; preds = %if.then165.i
  %v11.i.i = getelementptr inbounds %struct.PNode, ptr %retval.0.i115, i64 0, i32 7, i32 2
  %189 = load ptr, ptr %v11.i.i, align 8, !tbaa !15
  %sub.i244.i = add i32 %187, -1
  %v.i.i104 = getelementptr inbounds %struct.PNode, ptr %new_pn.0.i, i64 0, i32 7, i32 2
  %sub27.i.i = add i32 %188, -1
  %end_skip31.i.i = getelementptr inbounds %struct.PNode, ptr %retval.0.i115, i64 0, i32 19, i32 3
  %190 = zext i32 %sub.i244.i to i64
  %191 = zext i32 %sub27.i.i to i64
...
for.cond.i.i:                                     ; preds = %if.end.i250.i
  ...
  br i1 %exitcond.not.i247.i, label %if.end170.i, label %for.body.i.i106, !llvm.loop !286

for.body.i.i106:                                  ; preds = %for.cond.i.i, %for.body.lr.ph.i.i105
  %indvars.iv.i248.i = phi i64 [ 0, %for.body.lr.ph.i.i105 ], [ %indvars.iv.next.i246.i, %for.cond.i.i ]
  %arrayidx13.i.i = getelementptr inbounds ptr, ptr %189, i64 %indvars.iv.i248.i
  %192 = load ptr, ptr %arrayidx13.i.i, align 8, !tbaa !16
  %end_skip15.i.i = getelementptr inbounds %struct.PNode, ptr %192, i64 0, i32 19, i32 3
  %193 = load ptr, ptr %end_skip15.i.i, align 8, !tbaa !20
  %cmp18.i.i = icmp eq i64 %indvars.iv.i248.i, %190
  br i1 %cmp18.i.i, label %cond.end23.i.i, label %cond.false22.i.i107

cond.false22.i.i107:                              ; preds = %for.body.i.i106
  %194 = load ptr, ptr %v.i.i104, align 8, !tbaa !15
  %arrayidx.i249.i = getelementptr inbounds ptr, ptr %194, i64 %indvars.iv.i248.i
  %195 = load ptr, ptr %arrayidx.i249.i, align 8, !tbaa !16
  br label %cond.end23.i.i

cond.end23.i.i:                                   ; preds = %cond.false22.i.i107, %for.body.i.i106
  %x.pn.i.i = phi ptr [ %195, %cond.false22.i.i107 ], [ %new_pn.0.i, %for.body.i.i106 ]
...
if.end.i250.i:                                    ; preds = %cond.end33.i.i
  ...
  br i1 %cmp36.i.i, label %cmp_pnodes.exit.thread132, label %for.cond.i.i
...
if.end170.i:                                      ; preds = %for.cond.i.i, %if.then165.i, %if.end163.i
  ...
  %197 = load i32, ptr %dont_use_height_for_disambiguation.i, align 4, !tbaa !287
  %tobool172.not.i = icmp eq i32 %197, 0
  br i1 %tobool172.not.i, label %if.then173.i, label %cmp_pnodes.exit.thread134

if.then173.i:                                     ; preds = %if.end170.i
  %height.i = getelementptr inbounds %struct.PNode, ptr %new_pn.0.i, i64 0, i32 8
  %198 = load i32, ptr %height.i, align 8, !tbaa !268
  %height174.i = getelementptr inbounds %struct.PNode, ptr %retval.0.i115, i64 0, i32 8
  %199 = load i32, ptr %height174.i, align 8, !tbaa !268
  %cmp175.i = icmp ult i32 %198, %199
  br i1 %cmp175.i, label %cmp_pnodes.exit.thread, label %if.end178.i

if.end178.i:                                      ; preds = %if.then173.i
  %cmp181.i = icmp ugt i32 %198, %199
  br i1 %cmp181.i, label %cmp_pnodes.exit.thread132, label %cmp_pnodes.exit.thread134

cmp_pnodes.exit.thread134:                        ; preds = %if.end170.i, %if.end178.i
  call void @llvm.lifetime.end.p0(i64 56, ptr nonnull %isy.i) #22
  call void @llvm.lifetime.end.p0(i64 56, ptr nonnull %isx.i) #22
  call void @llvm.lifetime.end.p0(i64 88, ptr nonnull %psy.i) #22
  call void @llvm.lifetime.end.p0(i64 88, ptr nonnull %psx.i) #22
  br label %sw.bb
...
cmp_pnodes.exit.thread132:                        ; preds = %if.end.i250.i, %if.end.i91, %if.end178.i
  call void @llvm.lifetime.end.p0(i64 56, ptr nonnull %isy.i) #22
  call void @llvm.lifetime.end.p0(i64 56, ptr nonnull %isx.i) #22
  call void @llvm.lifetime.end.p0(i64 88, ptr nonnull %psy.i) #22
  call void @llvm.lifetime.end.p0(i64 88, ptr nonnull %psx.i) #22
...
sw.bb:                                            ; preds = %cmp_pnodes.exit.thread134, %cmp_pnodes.exit
  %ambiguities = getelementptr inbounds %struct.PNode, ptr %retval.0.i115, i64 0, i32 13
  %200 = load ptr, ptr %ambiguities, align 8, !tbaa !66
  %ambiguities14 = getelementptr inbounds %struct.PNode, ptr %new_pn.0.i, i64 0, i32 13
  store ptr %200, ptr %ambiguities14, align 8, !tbaa !66
...
sw.bb16:                                          ; preds = %cmp_pnodes.exit.thread, %cmp_pnodes.exit
  ...
  %refcount.i109 = getelementptr inbounds %struct.PNode, ptr %new_pn.0.i, i64 0, i32 6
  %201 = load i32, ptr %refcount.i109, align 8, !tbaa !64
  %all.i111 = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 11, i32 4
  %202 = load ptr, ptr %all.i111, align 8, !tbaa !244
  %all_next.i112 = getelementptr inbounds %struct.PNode, ptr %new_pn.0.i, i64 0, i32 11
  store ptr %202, ptr %all_next.i112, align 8, !tbaa !120
  store ptr %new_pn.0.i, ptr %all.i111, align 8, !tbaa !244
  %latest = getelementptr inbounds %struct.PNode, ptr %retval.0.i115, i64 0, i32 14
  store ptr %new_pn.0.i, ptr %latest, align 8, !tbaa !118
  %inc17 = add i32 %201, 2
  store i32 %inc17, ptr %refcount.i109, align 8, !tbaa !64
  br label %cleanup

sw.bb18:                                          ; preds = %cmp_pnodes.exit.thread132, %cmp_pnodes.exit
...
cleanup:                                          ; preds = %for.cond.i, %make_PNode.exit.thread, %for.cond.preheader.i, %if.end5.i, %if.end8, %if.end9, %cmp_pnodes.exit, %sw.bb18, %sw.bb16, %sw.bb, %if.then5, %PNode_equal.exit
  %retval.0 = phi ptr [ %pn.038.i, %PNode_equal.exit ], [ null, %if.then5 ], [ %retval.0.i115, %cmp_pnodes.exit ], [ %retval.0.i115, %sw.bb18 ], [ %new_pn.0.i, %sw.bb16 ], [ %retval.0.i115, %sw.bb ], [ %retval.0.i115, %if.end9 ], [ %new_pn.0.i, %if.end8 ], [ %pn.038.i, %if.end5.i ], [ %pn.038.i, %for.cond.preheader.i ], [ %spec.select, %make_PNode.exit.thread ], [ %pn.038.i, %for.cond.i ]
  ret ptr %retval.0
}
...
if.end30:                                         ; preds = %if.then10, %if.else19
  tail call void @vec_add_internal(ptr noundef nonnull %v, ptr noundef %z) #22
  br label %cleanup
...
if.then33:                                        ; preds = %if.end31
  ...
  %vv.sroa.3.0.copyload = load ptr, ptr %vv.sroa.3.0..sroa_idx, align 8, !tbaa.struct !288
...
entry:
  ...
  %0 = load ptr, ptr %snode, align 8, !tbaa !129
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %paths) #22
...
if.then:                                          ; preds = %entry
  ...
  %5 = load ptr, ptr %loc, align 8, !tbaa !172
  %last_pn4 = getelementptr inbounds %struct.SNode, ptr %0, i64 0, i32 5
  %6 = load ptr, ptr %last_pn4, align 8, !tbaa !169
...
for.cond17.preheader:                             ; preds = %for.body
  ...
  %11 = load i32, ptr %new_depth, align 8, !tbaa !289
  ...
  %13 = load i32, ptr %sns, align 8, !tbaa !170
...
for.body24.lr.ph:                                 ; preds = %for.cond17.preheader
  ...
  %14 = load ptr, ptr %v30, align 8, !tbaa !171
...
for.cond17:                                       ; preds = %for.body24
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.inc99, label %for.body24, !llvm.loop !290
...
if.end14.i:                                       ; preds = %lor.lhs.false
  %24 = load i32, ptr %19, align 8, !tbaa !266
...
if.then16.i:                                      ; preds = %if.end14.i
  ...
  %26 = load i32, ptr %priority.i, align 4, !tbaa !267
...
for.cond.preheader.i:                             ; preds = %if.then27.i
  ...
  %34 = load i32, ptr %sns.i, align 8, !tbaa !170
...
for.cond49.preheader.lr.ph.i:                     ; preds = %for.cond.preheader.i
  ...
  %35 = load ptr, ptr %v51.i, align 8, !tbaa !171
...
if.then36.i:                                      ; preds = %if.then27.i
  ...
  %call42.i = call fastcc i32 @check_assoc_priority(ptr noundef nonnull %pn0.0.i, ptr noundef %33, ptr noundef %37)
...
for.cond49.preheader.i:                           ; preds = %for.cond49.preheader.i.outer, %for.inc71.i
  ...
  %39 = load i32, ptr %zns.i, align 8, !tbaa !157
...
for.body56.lr.ph.i:                               ; preds = %for.cond49.preheader.i
  ...
  %40 = load ptr, ptr %v62.i, align 8, !tbaa !158
...
land.lhs.true.i:                                  ; preds = %for.body56.i
  ...
  %call67.i = call fastcc i32 @check_assoc_priority(ptr noundef %pn0.0.i, ptr noundef %33, ptr noundef %42)
...
for.inc.i:                                        ; preds = %land.lhs.true.i, %for.body56.i
  ...
  br i1 %exitcond266.not.i, label %for.inc71.i.thread, label %for.body56.i, !llvm.loop !291
...
for.inc71.i:                                      ; preds = %for.cond49.preheader.i
  ...
  br i1 %exitcond271.not.i, label %for.end73.i, label %for.cond49.preheader.i, !llvm.loop !292
...
for.inc71.i.thread:                               ; preds = %for.inc.i
  ...
  br i1 %exitcond271.not.i173, label %for.inc99, label %for.cond49.preheader.i.outer, !llvm.loop !292
...
if.then75.i:                                      ; preds = %for.end73.i, %for.cond.preheader.i
  %call76.i = call fastcc i32 @check_assoc_priority(ptr noundef %pn0.0.i, ptr noundef %33, ptr noundef null)
  br label %check_path_priorities_internal.exit

if.else79.i:                                      ; preds = %if.end23.i
  %sns84.i = getelementptr inbounds %struct.ZNode, ptr %31, i64 0, i32 1
  %43 = load i32, ptr %sns84.i, align 8, !tbaa !170
...
for.cond88.preheader.lr.ph.i:                     ; preds = %if.else79.i
  ...
  %44 = load ptr, ptr %v90.i, align 8, !tbaa !171
...
for.cond88.preheader.i:                           ; preds = %for.inc147.i, %for.cond88.preheader.lr.ph.i
  ...
  %46 = load i32, ptr %zns93.i, align 8, !tbaa !157
...
for.body96.lr.ph.i:                               ; preds = %for.cond88.preheader.i
  ...
  %47 = load ptr, ptr %v102.i, align 8, !tbaa !158
...
for.cond107.preheader.i:                          ; preds = %for.body96.i
  ...
  %49 = load i32, ptr %sns108.i, align 8, !tbaa !170
...
for.cond112.preheader.lr.ph.i:                    ; preds = %for.cond107.preheader.i
  ...
  %50 = load ptr, ptr %v114.i, align 8, !tbaa !171
...
for.cond112.preheader.i:                          ; preds = %for.inc140.i, %for.cond112.preheader.lr.ph.i
  ...
  %52 = load i32, ptr %zns117.i, align 8, !tbaa !157
...
for.body120.lr.ph.i:                              ; preds = %for.cond112.preheader.i
  ...
  %53 = load ptr, ptr %v126.i, align 8, !tbaa !158
...
land.lhs.true130.i:                               ; preds = %for.body120.i
  ...
  %call133.i = call fastcc i32 @check_assoc_priority(ptr noundef %pn0.0.i, ptr noundef %55, ptr noundef %56)
...
for.inc137.i:                                     ; preds = %land.lhs.true130.i, %for.body120.i
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %for.inc140.i, label %for.body120.i, !llvm.loop !293
...
for.inc140.i:                                     ; preds = %for.inc137.i, %for.cond112.preheader.i
  ...
  br i1 %exitcond251.not.i, label %for.inc144.i, label %for.cond112.preheader.i, !llvm.loop !294
...
for.inc144.i:                                     ; preds = %for.inc140.i, %for.cond107.preheader.i, %for.body96.i
  ...
  br i1 %exitcond256.not.i, label %for.inc147.i, label %for.body96.i, !llvm.loop !295
...
for.inc147.i:                                     ; preds = %for.inc144.i, %for.cond88.preheader.i
  ...
  br i1 %exitcond261.not.i, label %if.end65, label %for.cond88.preheader.i, !llvm.loop !296
...
if.end65:                                         ; preds = %for.inc147.i, %land.lhs.true.i, %land.lhs.true130.i, %if.end48, %if.else79.i, %check_path_priorities_internal.exit, %lor.lhs.false
  %57 = load i32, ptr %reductions, align 8, !tbaa !163
  %inc66 = add nsw i32 %57, 1
  store i32 %inc66, ptr %reductions, align 8, !tbaa !163
  ...
  %61 = load ptr, ptr %58, align 8, !tbaa !159
  %start_loc = getelementptr inbounds %struct.PNode, ptr %61, i64 0, i32 19, i32 1
  %62 = load ptr, ptr %loc77, align 8, !tbaa !172
...
for.cond83.preheader:                             ; preds = %if.end65
  ...
  %63 = load i32, ptr %sns84, align 8, !tbaa !170
...
for.body88:                                       ; preds = %for.body88.lr.ph, %for.body88
  ...
  %64 = load ptr, ptr %v91, align 8, !tbaa !171
  ...
  %66 = load i32, ptr %sns84, align 8, !tbaa !170
  %67 = zext i32 %66 to i64
  %cmp86 = icmp ult i64 %indvars.iv.next211, %67
  br i1 %cmp86, label %for.body88, label %for.inc99, !llvm.loop !297
...
for.inc99:                                        ; preds = %for.cond17, %for.inc71.i.thread, %for.body88, %for.cond17.preheader, %for.cond83.preheader, %for.end73.i, %check_child.exit.i, %if.end65, %check_path_priorities_internal.exit
  ...
  br i1 %cmp, label %for.body, label %for.end101, !llvm.loop !298

for.end101:                                       ; preds = %for.inc99, %do.body, %build_paths.exit
  %70 = phi i32 [ 0, %build_paths.exit ], [ 0, %do.body ], [ %68, %for.inc99 ]
  %71 = load ptr, ptr getelementptr inbounds (%struct.VecZNode, ptr @path1, i64 0, i32 2), align 8, !tbaa !211
...
do.body23.i:                                      ; preds = %if.then17.i, %do.body5.i
  ...
  br i1 %cmp4.i170, label %do.body5.i, label %do.body39.i, !llvm.loop !299
...
do.body103:                                       ; preds = %free_paths.exit, %if.then7, %if.then
  ...
  %82 = load i32, ptr %refcount, align 8, !tbaa !100
  %dec = add i32 %82, -1
  store i32 %dec, ptr %refcount, align 8, !tbaa !100
...
do.end108:                                        ; preds = %if.then105, %do.body103
  %free_reductions = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 18
  %83 = load ptr, ptr %free_reductions, align 8, !tbaa !124
  %next = getelementptr inbounds %struct.Reduction, ptr %r, i64 0, i32 5
  store ptr %83, ptr %next, align 8, !tbaa !127
  store ptr %r, ptr %free_reductions, align 8, !tbaa !124
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %paths) #22
  ret void
}
...
if.end5:                                          ; preds = %if.end
  ...
  %6 = load ptr, ptr %end, align 8, !tbaa !168
...
land.lhs.true19:                                  ; preds = %land.lhs.true
  ...
  %8 = load ptr, ptr %final_code, align 8, !tbaa !231
...
if.then34:                                        ; preds = %if.end27
  ...
  %9 = load ptr, ptr %v39, align 8, !tbaa !171
  %10 = load ptr, ptr %9, align 8, !tbaa !16
  %call = tail call fastcc i32 @commit_stack(ptr noundef %p, ptr noundef %10)
...
if.then34.if.end44_crit_edge:                     ; preds = %if.then34
  %.pre = load ptr, ptr %v, align 8, !tbaa !158
  %.pre65 = load ptr, ptr %.pre, align 8, !tbaa !16
  %.pre66 = load ptr, ptr %.pre65, align 8, !tbaa !159
  br label %if.end44
...
if.end44:                                         ; preds = %if.then34.if.end44_crit_edge, %if.end27
  ...
  %12 = load ptr, ptr %v, align 8, !tbaa !158
  %13 = load ptr, ptr %12, align 8, !tbaa !16
  store ptr %call49, ptr %13, align 8, !tbaa !159
  br label %cleanup
...
entry:
  %free_snodes = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 22
  %0 = load ptr, ptr %free_snodes, align 8, !tbaa !139
  %tobool.not = icmp eq ptr %0, null
  br i1 %tobool.not, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  %call = tail call noalias dereferenceable_or_null(136) ptr @malloc(i64 noundef 136) #26
  br label %if.end

if.else:                                          ; preds = %entry
  %all_next = getelementptr inbounds %struct.SNode, ptr %0, i64 0, i32 9
  %1 = load ptr, ptr %all_next, align 8, !tbaa !142
  store ptr %1, ptr %free_snodes, align 8, !tbaa !139
  br label %if.end
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  store ptr null, ptr %v, align 8, !tbaa !158
  %refcount = getelementptr inbounds %struct.SNode, ptr %sn.0, i64 0, i32 7
  store i32 0, ptr %refcount, align 8, !tbaa !100
  %all_next3 = getelementptr inbounds %struct.SNode, ptr %sn.0, i64 0, i32 9
  store ptr null, ptr %all_next3, align 8, !tbaa !142
  %states = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 4
  %2 = load i32, ptr %states, align 8, !tbaa !154
  %inc = add nsw i32 %2, 1
  store i32 %inc, ptr %states, align 8, !tbaa !154
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %loc5, ptr noundef nonnull align 8 dereferenceable(32) %loc, i64 32, i1 false), !tbaa.struct !99
  tail call void @insert_SNode_internal(ptr noundef nonnull %p, ptr noundef nonnull %sn.0)
  %3 = load i32, ptr %refcount, align 8, !tbaa !100
  %inc.i = add i32 %3, 1
  store i32 %inc.i, ptr %refcount, align 8, !tbaa !100
  %all.i = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 12, i32 4
  %4 = load ptr, ptr %all.i, align 8, !tbaa !245
  store ptr %4, ptr %all_next3, align 8, !tbaa !142
  store ptr %sn.0, ptr %all.i, align 8, !tbaa !245
  %5 = load ptr, ptr %sn.0, align 8, !tbaa !43
  %accept = getelementptr inbounds %struct.D_State, ptr %5, i64 0, i32 9
  %6 = load i8, ptr %accept, align 1, !tbaa !300
...
if.end41.sink.split:                              ; preds = %do.body24, %if.then33, %do.body12
  store ptr %sn.0, ptr %accept9, align 8, !tbaa !98
  br label %if.end41
...
for.cond.preheader.i:                             ; preds = %entry
  ...
  %0 = load i32, ptr %sns.i, align 8, !tbaa !170
...
for.body.lr.ph.i:                                 ; preds = %for.cond.preheader.i
  ...
  %1 = load ptr, ptr %v.i, align 8, !tbaa !171
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i.new
  ...
  br i1 %niter.ncmp.3, label %znode_depth.exit.loopexit.unr-lcssa, label %for.body.i, !llvm.loop !301
...
for.body.i.epil:                                  ; preds = %znode_depth.exit.loopexit.unr-lcssa, %for.body.i.epil
  ...
  br i1 %epil.iter.cmp.not, label %znode_depth.exit, label %for.body.i.epil, !llvm.loop !302
...
for.body.lr.ph:                                   ; preds = %znode_depth.exit
  ...
  %13 = load ptr, ptr %loc, align 8, !tbaa !172
  br label %for.body
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %14 = load ptr, ptr %snode, align 8, !tbaa !129
  %loc2 = getelementptr inbounds %struct.SNode, ptr %14, i64 0, i32 3
  %15 = load ptr, ptr %loc2, align 8, !tbaa !172
...
for.cond.preheader.i78:                           ; preds = %if.end
  ...
  %17 = load i32, ptr %sns.i76, align 8, !tbaa !170
...
for.body.lr.ph.i81:                               ; preds = %for.cond.preheader.i78
  ...
  %18 = load ptr, ptr %v.i79, align 8, !tbaa !171
...
for.body.i89:                                     ; preds = %for.body.i89, %for.body.lr.ph.i81.new
  ...
  br i1 %niter119.ncmp.3, label %znode_depth.exit91.loopexit.unr-lcssa, label %for.body.i89, !llvm.loop !301
...
for.body.i89.epil:                                ; preds = %znode_depth.exit91.loopexit.unr-lcssa, %for.body.i89.epil
  ...
  br i1 %epil.iter115.cmp.not, label %znode_depth.exit91, label %for.body.i89.epil, !llvm.loop !303
...
while.body:                                       ; preds = %if.then12, %if.end25
  ...
  %30 = load ptr, ptr %snode16, align 8, !tbaa !129
...
if.end25:                                         ; preds = %land.lhs.true21, %land.lhs.true18, %while.body
  ...
  %33 = load ptr, ptr %next, align 8, !tbaa !127
...
for.inc:                                          ; preds = %znode_depth.exit91
  ...
  br i1 %tobool.not, label %for.end, label %for.body, !llvm.loop !304
...
for.end:                                          ; preds = %for.inc, %for.body, %if.end25, %znode_depth.exit, %if.then12
  ...
  %free_reductions = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 18
  %34 = load ptr, ptr %free_reductions, align 8, !tbaa !124
  %tobool30.not = icmp eq ptr %34, null
  br i1 %tobool30.not, label %if.then31, label %if.else

if.then31:                                        ; preds = %for.end
  %call32 = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #26
  br label %if.end35

if.else:                                          ; preds = %for.end
  %next33 = getelementptr inbounds %struct.Reduction, ptr %34, i64 0, i32 5
  %35 = load ptr, ptr %next33, align 8, !tbaa !127
  store ptr %35, ptr %free_reductions, align 8, !tbaa !124
  br label %if.end35
...
if.end35:                                         ; preds = %if.else, %if.then31
  ...
  store ptr %sn, ptr %snode37, align 8, !tbaa !129
  ...
  %36 = load i32, ptr %refcount, align 8, !tbaa !100
  %inc = add i32 %36, 1
  store i32 %inc, ptr %refcount, align 8, !tbaa !100
  ...
  store ptr %37, ptr %next39, align 8, !tbaa !127
...
entry:
  %0 = load i32, ptr %x, align 8, !tbaa !266
  %and = and i32 %0, 4
  %tobool.not = icmp eq i32 %and, 0
  br i1 %tobool.not, label %if.then, label %if.else
...
if.then:                                          ; preds = %entry
  ...
  %1 = load ptr, ptr %cur1.i, align 8, !tbaa !276
  %end.i = getelementptr inbounds %struct.StackPNode, ptr %psx, i64 0, i32 1
  %2 = load ptr, ptr %end.i, align 8, !tbaa !279
  %cmp.i = icmp eq ptr %1, %2
  br i1 %cmp.i, label %cond.true.i, label %cond.false.i

cond.true.i:                                      ; preds = %if.then
  %call.i = tail call ptr @stack_push_internal(ptr noundef nonnull %psx, ptr noundef nonnull %x) #22
  br label %cond.end.i

cond.false.i:                                     ; preds = %if.then
  %incdec.ptr.i = getelementptr inbounds ptr, ptr %1, i64 1
  store ptr %incdec.ptr.i, ptr %cur1.i, align 8, !tbaa !276
  store ptr %x, ptr %1, align 8, !tbaa !16
  br label %cond.end.i

cond.end.i:                                       ; preds = %cond.false.i, %cond.true.i
  %3 = load ptr, ptr %psx, align 8, !tbaa !278
  %4 = load ptr, ptr %cur1.i, align 8, !tbaa !276
...
for.body.i:                                       ; preds = %cond.end.i, %for.inc.i
  ...
  %6 = load i32, ptr %height.i, align 8, !tbaa !268
  ...
  %8 = load i32, ptr %height7.i, align 8, !tbaa !268
...
for.inc:                                          ; preds = %for.body, %if.then9
  ...
  br i1 %cmp4, label %for.body, label %if.end14, !llvm.loop !306
...
if.then:                                          ; preds = %entry
  ...
  %1 = load ptr, ptr %cur, align 8, !tbaa !276
  %end = getelementptr inbounds %struct.StackInt, ptr %psx, i64 0, i32 1
  %2 = load ptr, ptr %end, align 8, !tbaa !279
  %cmp = icmp eq ptr %1, %2
  %priority = getelementptr inbounds %struct.PNode, ptr %x, i64 0, i32 1
  %3 = load i32, ptr %priority, align 4, !tbaa !267
  br i1 %cmp, label %cond.true, label %cond.false

cond.true:                                        ; preds = %if.then
  %conv = sext i32 %3 to i64
  %4 = inttoptr i64 %conv to ptr
  %call = tail call ptr @stack_push_internal(ptr noundef nonnull %psx, ptr noundef %4) #22
  br label %if.end
...
entry:
  ...
  %e7.i88 = getelementptr inbounds %struct.VecZNode, ptr %v, i64 0, i32 3
...
if.then:                                          ; preds = %tailrecurse
  %1 = load ptr, ptr %z, align 8, !tbaa !159
...
for.inc:                                          ; preds = %if.then
  ...
  br i1 %cmp.not, label %for.body.1, label %if.else, !llvm.loop !308
...
for.inc.1:                                        ; preds = %for.body.1
  ...
  br i1 %cmp.1.not, label %for.body.2, label %if.else, !llvm.loop !308
...
for.inc.2:                                        ; preds = %for.body.2
  ...
  br i1 %cmp.2.not, label %for.body.3, label %if.else, !llvm.loop !308
...
for.inc.3:                                        ; preds = %for.body.3
  ...
  br i1 %cmp.3.not, label %for.body.4, label %if.else, !llvm.loop !308
...
if.else:                                          ; preds = %for.body.4, %for.inc.3, %for.inc.2, %for.inc.1, %for.inc
  %10 = load i32, ptr %i20, align 4, !tbaa !309
  %add21 = add i32 %10, 2
  br label %if.end23

if.end23:                                         ; preds = %tailrecurse, %if.else
  %storemerge = phi i32 [ %add21, %if.else ], [ 2, %tailrecurse ]
  %vv.sroa.4120.0 = phi ptr [ %4, %if.else ], [ null, %tailrecurse ]
  store i32 %storemerge, ptr %i20, align 4, !tbaa !309
  %idxprom25 = zext i32 %storemerge to i64
  %arrayidx26 = getelementptr inbounds [0 x i32], ptr @prime2, i64 0, i64 %idxprom25
  %11 = load i32, ptr %arrayidx26, align 4, !tbaa !50
  store i32 %11, ptr %v, align 8, !tbaa !210
  %conv = zext i32 %11 to i64
  %mul = shl nuw nsw i64 %conv, 3
  %calloc = tail call ptr @calloc(i64 1, i64 %mul)
  store ptr %calloc, ptr %v4, align 8, !tbaa !211
  %tobool35.not = icmp eq ptr %vv.sroa.4120.0, null
...
for.body.i:                                       ; preds = %for.body.i.preheader, %for.inc.i
  ...
  %arrayidx.i = getelementptr inbounds ptr, ptr %vv.sroa.4120.0, i64 %indvars.iv
  %12 = load ptr, ptr %arrayidx.i, align 8, !tbaa !16
  %tobool.not.i = icmp eq ptr %12, null
  br i1 %tobool.not.i, label %for.inc.i, label %if.then.i

if.then.i:                                        ; preds = %for.body.i
  %13 = load i32, ptr %v, align 8, !tbaa !210
  %cmp.i79 = icmp slt i32 %13, 3
  br i1 %cmp.i79, label %do.body.i82, label %if.end31.i106

do.body.i82:                                      ; preds = %if.then.i
  %14 = load ptr, ptr %v4, align 8, !tbaa !211
  %tobool.not.i81 = icmp eq ptr %14, null
  br i1 %tobool.not.i81, label %if.then3.i87, label %if.else.i90

if.then3.i87:                                     ; preds = %do.body.i82
  store ptr %e7.i88, ptr %v4, align 8, !tbaa !211
  %inc.i84 = add nsw i32 %13, 1
  store i32 %inc.i84, ptr %v, align 8, !tbaa !210
  %idxprom.i85 = zext i32 %13 to i64
  %arrayidx.i86 = getelementptr inbounds ptr, ptr %e7.i88, i64 %idxprom.i85
  store ptr %12, ptr %arrayidx.i86, align 8, !tbaa !16
  br label %for.inc.i

if.else.i90:                                      ; preds = %do.body.i82
  %cmp9.i89 = icmp eq ptr %14, %e7.i88
  br i1 %cmp9.i89, label %if.then10.i92, label %if.else19.i99

if.then10.i92:                                    ; preds = %if.else.i90
  %cmp12.i91 = icmp ult i32 %13, 3
  br i1 %cmp12.i91, label %if.then13.i96, label %if.end30.i104

if.then13.i96:                                    ; preds = %if.then10.i92
...
if.else19.i99:                                    ; preds = %if.else.i90
  %and.i97 = and i32 %13, 7
  %tobool21.not.i98 = icmp eq i32 %and.i97, 0
  br i1 %tobool21.not.i98, label %if.end30.i104, label %if.then22.i103

if.then22.i103:                                   ; preds = %if.else19.i99
  %inc25.i100 = add nsw i32 %13, 1
  store i32 %inc25.i100, ptr %v, align 8, !tbaa !210
  %idxprom26.i101 = zext i32 %13 to i64
  %arrayidx27.i102 = getelementptr inbounds ptr, ptr %14, i64 %idxprom26.i101
  store ptr %12, ptr %arrayidx27.i102, align 8, !tbaa !16
  br label %for.inc.i

if.end30.i104:                                    ; preds = %if.else19.i99, %if.then10.i92
  tail call void @vec_add_internal(ptr noundef nonnull %v, ptr noundef nonnull %12) #22
  br label %for.inc.i

if.end31.i106:                                    ; preds = %if.then.i
  %cmp32.i105 = icmp eq i32 %13, 3
  br i1 %cmp32.i105, label %if.then33.i110, label %if.end44.i118

if.then33.i110:                                   ; preds = %if.end31.i106
  %vv.sroa.3.0.copyload.i108 = load ptr, ptr %v4, align 8, !tbaa.struct !288
  store i32 0, ptr %v, align 8, !tbaa !210
  store ptr null, ptr %v4, align 8, !tbaa !211
  %15 = load ptr, ptr %vv.sroa.3.0.copyload.i108, align 8, !tbaa !16
  tail call fastcc void @set_add_znode_hash(ptr noundef nonnull %v, ptr noundef %15)
  %arrayidx42.i115.1 = getelementptr inbounds ptr, ptr %vv.sroa.3.0.copyload.i108, i64 1
  %16 = load ptr, ptr %arrayidx42.i115.1, align 8, !tbaa !16
  tail call fastcc void @set_add_znode_hash(ptr noundef nonnull %v, ptr noundef %16)
  %arrayidx42.i115.2 = getelementptr inbounds ptr, ptr %vv.sroa.3.0.copyload.i108, i64 2
  %17 = load ptr, ptr %arrayidx42.i115.2, align 8, !tbaa !16
  tail call fastcc void @set_add_znode_hash(ptr noundef nonnull %v, ptr noundef %17)
  br label %if.end44.i118

if.end44.i118:                                    ; preds = %if.then33.i110, %if.end31.i106
  tail call fastcc void @set_add_znode_hash(ptr noundef nonnull %v, ptr noundef nonnull %12)
  br label %for.inc.i

for.inc.i:                                        ; preds = %if.end44.i118, %if.end30.i104, %if.then22.i103, %if.then13.i96, %if.then3.i87, %for.body.i
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %set_union_znode.exit, label %for.body.i, !llvm.loop !310

set_union_znode.exit:                             ; preds = %for.inc.i, %for.cond.i.preheader
  tail call void @free(ptr noundef nonnull %vv.sroa.4120.0) #22
  %.pre = load i32, ptr %v, align 8, !tbaa !210
  br label %if.end38

if.end38:                                         ; preds = %set_union_znode.exit, %if.end23
  %18 = phi i32 [ %.pre, %set_union_znode.exit ], [ %11, %if.end23 ]
  %cmp.i71 = icmp slt i32 %18, 3
  br i1 %cmp.i71, label %do.body.i, label %if.end31.i

do.body.i:                                        ; preds = %if.end38
  %19 = load ptr, ptr %v4, align 8, !tbaa !211
  %tobool.not.i72 = icmp eq ptr %19, null
  br i1 %tobool.not.i72, label %if.then3.i, label %if.else.i

if.then3.i:                                       ; preds = %do.body.i
  store ptr %e7.i88, ptr %v4, align 8, !tbaa !211
  %inc.i73 = add nsw i32 %18, 1
  store i32 %inc.i73, ptr %v, align 8, !tbaa !210
  %idxprom.i74 = zext i32 %18 to i64
  %arrayidx.i75 = getelementptr inbounds ptr, ptr %e7.i88, i64 %idxprom.i74
  store ptr %z, ptr %arrayidx.i75, align 8, !tbaa !16
  br label %cleanup39

if.else.i:                                        ; preds = %do.body.i
  %cmp9.i = icmp eq ptr %19, %e7.i88
  br i1 %cmp9.i, label %if.then10.i, label %if.else19.i

if.then10.i:                                      ; preds = %if.else.i
  %cmp12.i = icmp ult i32 %18, 3
  br i1 %cmp12.i, label %if.then13.i, label %if.end30.i
...
if.then22.i:                                      ; preds = %if.else19.i
  %inc25.i = add nsw i32 %18, 1
  store i32 %inc25.i, ptr %v, align 8, !tbaa !210
  %idxprom26.i = zext i32 %18 to i64
  %arrayidx27.i = getelementptr inbounds ptr, ptr %19, i64 %idxprom26.i
  store ptr %z, ptr %arrayidx27.i, align 8, !tbaa !16
  br label %cleanup39

if.end30.i:                                       ; preds = %if.else19.i, %if.then10.i
  tail call void @vec_add_internal(ptr noundef nonnull %v, ptr noundef %z) #22
  br label %cleanup39

if.end31.i:                                       ; preds = %if.end38
  %cmp32.i = icmp eq i32 %18, 3
  br i1 %cmp32.i, label %if.then33.i, label %tailrecurse.backedge

if.then33.i:                                      ; preds = %if.end31.i
  %vv.sroa.3.0.copyload.i = load ptr, ptr %v4, align 8, !tbaa.struct !288
  store i32 0, ptr %v, align 8, !tbaa !210
  store ptr null, ptr %v4, align 8, !tbaa !211
  %20 = load ptr, ptr %vv.sroa.3.0.copyload.i, align 8, !tbaa !16
  tail call fastcc void @set_add_znode_hash(ptr noundef nonnull %v, ptr noundef %20)
  %arrayidx42.i.1 = getelementptr inbounds ptr, ptr %vv.sroa.3.0.copyload.i, i64 1
  %21 = load ptr, ptr %arrayidx42.i.1, align 8, !tbaa !16
  tail call fastcc void @set_add_znode_hash(ptr noundef nonnull %v, ptr noundef %21)
  %arrayidx42.i.2 = getelementptr inbounds ptr, ptr %vv.sroa.3.0.copyload.i, i64 2
  %22 = load ptr, ptr %arrayidx42.i.2, align 8, !tbaa !16
  tail call fastcc void @set_add_znode_hash(ptr noundef nonnull %v, ptr noundef %22)
  br label %tailrecurse.backedge

tailrecurse.backedge:                             ; preds = %if.then33.i, %if.end31.i
  br label %tailrecurse

cleanup39:                                        ; preds = %if.end30.i, %if.then22.i, %if.then13.i, %if.then3.i, %if.then6
  ret void
}
...
entry:
  ...
  %1 = load ptr, ptr %0, align 8, !tbaa !311
  %parse_node = getelementptr inbounds %struct.PNode, ptr %pn, i64 0, i32 19
  %2 = load i32, ptr %parse_node, align 8, !tbaa !32
  %div = sdiv i32 %2, 8
...
if.end:                                           ; preds = %entry
  ...
  %last_pn = getelementptr inbounds %struct.SNode, ptr %call, i64 0, i32 5
  store ptr %pn, ptr %last_pn, align 8, !tbaa !169
...
for.cond.i:                                       ; preds = %for.body.lr.ph.i
  ...
  br i1 %exitcond.not.i, label %if.then26, label %for.body.i.1, !llvm.loop !314
...
for.cond.i.1:                                     ; preds = %for.body.i.1
  %exitcond.not.i.1 = icmp eq i32 %13, 2
  br i1 %exitcond.not.i.1, label %if.then26, label %for.body.i.2, !llvm.loop !314
...
if.then26:                                        ; preds = %for.cond.i, %for.cond.i.1, %for.body.i.2, %for.cond.preheader.i, %if.end10.i, %for.inc31.i, %for.inc31.1.i, %for.inc31.2.i, %for.inc31.3.i, %if.else.4.i
  %free_znodes.i = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 23
  %34 = load ptr, ptr %free_znodes.i, align 8, !tbaa !137
  %tobool.not.i271 = icmp eq ptr %34, null
  br i1 %tobool.not.i271, label %if.then.i, label %if.else.i272

if.then.i:                                        ; preds = %if.then26
  %call.i = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #26
  br label %new_ZNode.exit

if.else.i272:                                     ; preds = %if.then26
  %35 = load ptr, ptr %34, align 8, !tbaa !16
  store ptr %35, ptr %free_znodes.i, align 8, !tbaa !137
  br label %new_ZNode.exit

new_ZNode.exit:                                   ; preds = %if.then.i, %if.else.i272
  %z.0.i = phi ptr [ %34, %if.else.i272 ], [ %call.i, %if.then.i ]
  store ptr %pn, ptr %z.0.i, align 8, !tbaa !159
  %sns.i = getelementptr inbounds %struct.ZNode, ptr %z.0.i, i64 0, i32 1
  store i32 0, ptr %sns.i, align 8, !tbaa !170
  %v.i = getelementptr inbounds %struct.ZNode, ptr %z.0.i, i64 0, i32 1, i32 2
  store ptr null, ptr %v.i, align 8, !tbaa !171
  ...
  %36 = load i32, ptr %refcount, align 8, !tbaa !64
  %inc = add i32 %36, 1
  store i32 %inc, ptr %refcount, align 8, !tbaa !64
  %37 = load ptr, ptr %call, align 8, !tbaa !43
  %reductions292 = getelementptr inbounds %struct.D_State, ptr %37, i64 0, i32 2
  %38 = load i32, ptr %reductions292, align 8, !tbaa !255
  %cmp30293.not = icmp eq i32 %38, 0
  br i1 %cmp30293.not, label %for.end, label %for.body

for.body:                                         ; preds = %new_ZNode.exit, %for.inc
  %39 = phi ptr [ %43, %for.inc ], [ %37, %new_ZNode.exit ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %new_ZNode.exit ]
  %v = getelementptr inbounds %struct.D_State, ptr %39, i64 0, i32 2, i32 1
  %40 = load ptr, ptr %v, align 8, !tbaa !256
  %arrayidx35 = getelementptr inbounds ptr, ptr %40, i64 %indvars.iv
  %41 = load ptr, ptr %arrayidx35, align 8, !tbaa !16
  %42 = load i16, ptr %41, align 8, !tbaa !193
  %tobool36.not = icmp eq i16 %42, 0
  br i1 %tobool36.not, label %for.inc, label %if.then37

if.then37:                                        ; preds = %for.body
  %call43 = tail call fastcc ptr @add_Reduction(ptr noundef %p, ptr noundef nonnull %z.0.i, ptr noundef nonnull %call, ptr noundef nonnull %41)
  %.pre = load ptr, ptr %call, align 8, !tbaa !43
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.then37
  %43 = phi ptr [ %39, %for.body ], [ %.pre, %if.then37 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %reductions = getelementptr inbounds %struct.D_State, ptr %43, i64 0, i32 2
  %44 = load i32, ptr %reductions, align 8, !tbaa !255
  %45 = zext i32 %44 to i64
  %cmp30 = icmp ult i64 %indvars.iv.next, %45
  br i1 %cmp30, label %for.body, label %for.end, !llvm.loop !315

for.end:                                          ; preds = %for.inc, %new_ZNode.exit
  %46 = phi ptr [ %37, %new_ZNode.exit ], [ %43, %for.inc ]
  %shift = getelementptr inbounds %struct.PNode, ptr %pn, i64 0, i32 5
  %47 = load ptr, ptr %shift, align 8, !tbaa !259
...
for.cond48.preheader:                             ; preds = %for.end
  %right_epsilon_hints297 = getelementptr inbounds %struct.D_State, ptr %46, i64 0, i32 3
  %48 = load i32, ptr %right_epsilon_hints297, align 8, !tbaa !316
  %cmp51298.not = icmp eq i32 %48, 0
...
for.body53.lr.ph:                                 ; preds = %for.cond48.preheader
  ...
  %snode_hash.i = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 12
  %m.i = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 12, i32 2
  %49 = load ptr, ptr %snode_hash.i, align 8, !tbaa !40
  %50 = icmp eq ptr %49, null
  br i1 %50, label %if.end96, label %for.body53

for.body53:                                       ; preds = %for.body53.lr.ph, %cleanup
  %51 = phi ptr [ %74, %cleanup ], [ %46, %for.body53.lr.ph ]
  %indvars.iv311 = phi i64 [ %indvars.iv.next312, %cleanup ], [ 0, %for.body53.lr.ph ]
  %v56 = getelementptr inbounds %struct.D_State, ptr %51, i64 0, i32 3, i32 1
  %52 = load ptr, ptr %v56, align 8, !tbaa !317
  %arrayidx58 = getelementptr inbounds %struct.D_RightEpsilonHint, ptr %52, i64 %indvars.iv311
  %preceeding_state = getelementptr inbounds %struct.D_RightEpsilonHint, ptr %52, i64 %indvars.iv311, i32 1
  %53 = load i16, ptr %preceeding_state, align 2, !tbaa !318
  %54 = load ptr, ptr %initial_scope60, align 8, !tbaa !45
  %55 = load ptr, ptr %initial_globals61, align 8, !tbaa !46
  %56 = load ptr, ptr %snode_hash.i, align 8, !tbaa !40
  %tobool.not.i273 = icmp eq ptr %56, null
  br i1 %tobool.not.i273, label %cleanup, label %if.then.i276

if.then.i276:                                     ; preds = %for.body53
  %conv59 = zext i16 %53 to i32
  %shl.i = shl nuw nsw i32 %conv59, 12
  %57 = ptrtoint ptr %54 to i64
  %58 = trunc i64 %57 to i32
  %add.i274 = add i32 %shl.i, %58
  %59 = ptrtoint ptr %55 to i64
  %60 = trunc i64 %59 to i32
  %add1.i = add i32 %add.i274, %60
  %61 = load i32, ptr %m.i, align 4, !tbaa !41
  %rem.i = urem i32 %add1.i, %61
  %idxprom.i = zext i32 %rem.i to i64
  %arrayidx.i275 = getelementptr inbounds ptr, ptr %56, i64 %idxprom.i
  %sn.027.i = load ptr, ptr %arrayidx.i275, align 8, !tbaa !16
  %tobool3.not28.i = icmp eq ptr %sn.027.i, null
  br i1 %tobool3.not28.i, label %cleanup, label %for.body.lr.ph.i277

for.body.lr.ph.i277:                              ; preds = %if.then.i276
  %62 = load ptr, ptr %t, align 8, !tbaa !23
  %state5.i = getelementptr inbounds %struct.D_ParserTables, ptr %62, i64 0, i32 1
  %63 = load ptr, ptr %state5.i, align 8, !tbaa !42
  %sub.ptr.rhs.cast.i = ptrtoint ptr %63 to i64
  %conv.i = zext i16 %53 to i64
  br label %for.body.i279

for.body.i279:                                    ; preds = %for.inc.i, %for.body.lr.ph.i277
  %sn.029.i = phi ptr [ %sn.027.i, %for.body.lr.ph.i277 ], [ %sn.0.i, %for.inc.i ]
  %64 = load ptr, ptr %sn.029.i, align 8, !tbaa !43
  %sub.ptr.lhs.cast.i = ptrtoint ptr %64 to i64
  %sub.ptr.sub.i = sub i64 %sub.ptr.lhs.cast.i, %sub.ptr.rhs.cast.i
  %sub.ptr.div.i = sdiv exact i64 %sub.ptr.sub.i, 120
  %cmp.i278 = icmp eq i64 %sub.ptr.div.i, %conv.i
  br i1 %cmp.i278, label %land.lhs.true.i, label %for.inc.i

land.lhs.true.i:                                  ; preds = %for.body.i279
  %initial_scope.i = getelementptr inbounds %struct.SNode, ptr %sn.029.i, i64 0, i32 1
  %65 = load ptr, ptr %initial_scope.i, align 8, !tbaa !45
  %cmp7.i = icmp eq ptr %65, %54
  br i1 %cmp7.i, label %land.lhs.true9.i, label %for.inc.i

land.lhs.true9.i:                                 ; preds = %land.lhs.true.i
  %initial_globals.i = getelementptr inbounds %struct.SNode, ptr %sn.029.i, i64 0, i32 2
  %66 = load ptr, ptr %initial_globals.i, align 8, !tbaa !46
  %cmp10.i = icmp eq ptr %66, %55
...
for.cond66.preheader:                             ; preds = %land.lhs.true9.i
  ...
  %67 = load i32, ptr %zns67, align 8, !tbaa !157
  %cmp69295.not = icmp eq i32 %67, 0
...
for.body71.lr.ph:                                 ; preds = %for.cond66.preheader
  ...
  %reduction = getelementptr inbounds %struct.D_RightEpsilonHint, ptr %52, i64 %indvars.iv311, i32 2
  br label %for.body71

for.inc.i:                                        ; preds = %land.lhs.true9.i, %land.lhs.true.i, %for.body.i279
  %bucket_next.i = getelementptr inbounds %struct.SNode, ptr %sn.029.i, i64 0, i32 8
  %sn.0.i = load ptr, ptr %bucket_next.i, align 8, !tbaa !16
  %tobool3.not.i = icmp eq ptr %sn.0.i, null
  br i1 %tobool3.not.i, label %cleanup, label %for.body.i279, !llvm.loop !47

for.body71:                                       ; preds = %for.body71.lr.ph, %for.inc89
  %indvars.iv308 = phi i64 [ 0, %for.body71.lr.ph ], [ %indvars.iv.next309, %for.inc89 ]
  %68 = load ptr, ptr %v73, align 8, !tbaa !158
  %arrayidx75 = getelementptr inbounds ptr, ptr %68, i64 %indvars.iv308
  %69 = load ptr, ptr %arrayidx75, align 8, !tbaa !16
  %tobool76.not = icmp eq ptr %69, null
  br i1 %tobool76.not, label %for.inc89, label %if.then77

if.then77:                                        ; preds = %for.body71
  %70 = load ptr, ptr %reduction, align 8, !tbaa !320
  %call82 = tail call fastcc ptr @add_Reduction(ptr noundef %p, ptr noundef nonnull %69, ptr noundef nonnull %sn.029.i, ptr noundef %70)
...
if.then84:                                        ; preds = %if.then77
  ...
  %71 = load i16, ptr %arrayidx58, align 8, !tbaa !321
  %conv86 = zext i16 %71 to i32
  %new_depth = getelementptr inbounds %struct.Reduction, ptr %call82, i64 0, i32 4
  store i32 %conv86, ptr %new_depth, align 8, !tbaa !289
  br label %for.inc89

for.inc89:                                        ; preds = %if.then77, %if.then84, %for.body71
  %indvars.iv.next309 = add nuw nsw i64 %indvars.iv308, 1
  %72 = load i32, ptr %zns67, align 8, !tbaa !157
  %73 = zext i32 %72 to i64
  %cmp69 = icmp ult i64 %indvars.iv.next309, %73
  br i1 %cmp69, label %for.body71, label %cleanup.loopexit, !llvm.loop !322

cleanup.loopexit:                                 ; preds = %for.inc89
  %.pre317 = load ptr, ptr %call, align 8, !tbaa !43
  br label %cleanup

cleanup:                                          ; preds = %for.inc.i, %cleanup.loopexit, %for.cond66.preheader, %if.then.i276, %for.body53
  %74 = phi ptr [ %.pre317, %cleanup.loopexit ], [ %51, %for.cond66.preheader ], [ %51, %if.then.i276 ], [ %51, %for.body53 ], [ %51, %for.inc.i ]
  %indvars.iv.next312 = add nuw nsw i64 %indvars.iv311, 1
  %right_epsilon_hints = getelementptr inbounds %struct.D_State, ptr %74, i64 0, i32 3
  %75 = load i32, ptr %right_epsilon_hints, align 8, !tbaa !316
  %76 = zext i32 %75 to i64
  %cmp51 = icmp ult i64 %indvars.iv.next312, %76
  br i1 %cmp51, label %for.body53, label %if.end96, !llvm.loop !323
...
if.end96:                                         ; preds = %for.body.lr.ph.i, %for.body.i.1, %for.body.i.2, %cleanup, %for.body53.lr.ph, %for.cond48.preheader, %if.else.4.i, %if.else.3.i, %if.else.2.i, %if.else.1.i, %if.else.i, %for.end
  %z.0 = phi ptr [ %z.0.i, %for.end ], [ %24, %if.else.i ], [ %26, %if.else.1.i ], [ %28, %if.else.2.i ], [ %30, %if.else.3.i ], [ %32, %if.else.4.i ], [ %z.0.i, %for.cond48.preheader ], [ %z.0.i, %for.body53.lr.ph ], [ %z.0.i, %cleanup ], [ %15, %for.body.lr.ph.i ], [ %17, %for.body.i.1 ], [ %19, %for.body.i.2 ]
  %sns = getelementptr inbounds %struct.ZNode, ptr %z.0, i64 0, i32 1
  %77 = load i32, ptr %sns, align 8, !tbaa !170
  %cmp99300.not = icmp eq i32 %77, 0
  %v120.phi.trans.insert = getelementptr inbounds %struct.ZNode, ptr %z.0, i64 0, i32 1, i32 2
  %.pre318 = load ptr, ptr %v120.phi.trans.insert, align 8, !tbaa !171
...
for.cond97:                                       ; preds = %for.body101
  ...
  br i1 %exitcond.not, label %if.else, label %for.body101, !llvm.loop !325
...
for.body101:                                      ; preds = %for.body101.lr.ph, %for.cond97
  ...
  %78 = load ptr, ptr %arrayidx105, align 8, !tbaa !16
  %cmp106 = icmp eq ptr %78, %ps
...
if.then122:                                       ; preds = %do.body118
  ...
  store ptr %e, ptr %v120, align 8, !tbaa !171
  %inc128 = add nuw nsw i32 %77, 1
  store i32 %inc128, ptr %sns, align 8, !tbaa !170
  %idxprom129 = zext i32 %77 to i64
...
if.then138:                                       ; preds = %if.else
  %cmp141 = icmp ult i32 %77, 3
  br i1 %cmp141, label %if.then143, label %if.end167

if.then143:                                       ; preds = %if.else.thread, %if.then138
  %inc148 = add nuw nsw i32 %77, 1
  store i32 %inc148, ptr %sns, align 8, !tbaa !170
  %idxprom149 = zext i32 %77 to i64
...
if.then157:                                       ; preds = %if.else152
  %inc162 = add i32 %77, 1
  store i32 %inc162, ptr %sns, align 8, !tbaa !170
  %idxprom163 = zext i32 %77 to i64
...
if.end167:                                        ; preds = %if.else.thread, %if.then138, %if.else152
  tail call void @vec_add_internal(ptr noundef nonnull %sns, ptr noundef nonnull %ps) #22
  br label %do.end170
...
do.body174:                                       ; preds = %do.end170
  ...
  %79 = load i32, ptr %refcount175, align 8, !tbaa !100
  %inc176 = add i32 %79, 1
  store i32 %inc176, ptr %refcount175, align 8, !tbaa !100
  br label %cleanup181
...
if.else:                                          ; preds = %entry
  %call = tail call noalias dereferenceable_or_null(40) ptr @malloc(i64 noundef 40) #26
  br label %do.body
...
if.end55:                                         ; preds = %if.then22, %if.else38
  ...
  tail call void @vec_add_internal(ptr noundef nonnull %pv.0, ptr noundef %19) #22
  br label %for.inc

for.inc:                                          ; preds = %if.then8, %if.then25, %if.then41, %if.end55
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %if.end65, label %do.body5, !llvm.loop !326
...
if.end62:                                         ; preds = %if.then24, %if.else42
  tail call void @vec_add_internal(ptr noundef nonnull %1, ptr noundef %z) #22
  br label %do.end
...
for.cond.preheader:                               ; preds = %do.end
  ...
  %7 = load i32, ptr %sns, align 8, !tbaa !170
...
for.cond71.preheader.lr.ph:                       ; preds = %for.cond.preheader
  ...
  %.pre = load ptr, ptr %v73, align 8, !tbaa !171
  br label %for.cond71.preheader

for.cond71.preheader:                             ; preds = %for.cond71.preheader.lr.ph, %for.inc157
  %8 = phi i32 [ %7, %for.cond71.preheader.lr.ph ], [ %35, %for.inc157 ]
  %9 = phi ptr [ %.pre, %for.cond71.preheader.lr.ph ], [ %36, %for.inc157 ]
  %10 = phi ptr [ %.pre, %for.cond71.preheader.lr.ph ], [ %37, %for.inc157 ]
  ...
  %12 = load i32, ptr %zns238, align 8, !tbaa !157
...
for.body78:                                       ; preds = %for.cond71.preheader, %for.inc
  %13 = phi ptr [ %31, %for.inc ], [ %9, %for.cond71.preheader ]
  %14 = phi ptr [ %31, %for.inc ], [ %10, %for.cond71.preheader ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %for.cond71.preheader ]
  %15 = phi ptr [ %32, %for.inc ], [ %11, %for.cond71.preheader ]
  ...
  %16 = load ptr, ptr %v84, align 8, !tbaa !158
...
if.then111:                                       ; preds = %if.then108
  ...
  %23 = load i32, ptr %paths, align 8, !tbaa !210
  %inc117 = add i32 %23, 1
  store i32 %inc117, ptr %paths, align 8, !tbaa !210
  %idxprom118 = zext i32 %23 to i64
  %arrayidx119 = getelementptr inbounds ptr, ptr %22, i64 %idxprom118
...
if.then125:                                       ; preds = %if.else121
  ...
  %24 = load ptr, ptr %v, align 8, !tbaa !211
  %25 = load i32, ptr %paths, align 8, !tbaa !210
  %inc131 = add i32 %25, 1
  store i32 %inc131, ptr %paths, align 8, !tbaa !210
  %idxprom132 = zext i32 %25 to i64
  %arrayidx133 = getelementptr inbounds ptr, ptr %24, i64 %idxprom132
...
if.end136:                                        ; preds = %if.then108, %if.else121
  ...
  tail call void @vec_add_internal(ptr noundef nonnull %paths, ptr noundef %call139) #22
  %.pre250 = load i32, ptr %paths, align 8, !tbaa !210
  br label %do.end141

do.end141:                                        ; preds = %if.end136, %if.then125, %if.then111, %if.then94
  %26 = phi i32 [ %.pre250, %if.end136 ], [ %inc131, %if.then125 ], [ %inc117, %if.then111 ], [ %inc100, %if.then94 ]
  %sub143 = add i32 %26, -1
  %.pre251 = load ptr, ptr %v73, align 8, !tbaa !171
  br label %if.end144

if.end144:                                        ; preds = %do.end141, %if.then88
  %27 = phi ptr [ %.pre251, %do.end141 ], [ %14, %if.then88 ]
  %parent.addr.2 = phi i32 [ %sub143, %do.end141 ], [ %parent.addr.1240, %if.then88 ]
  %arrayidx148 = getelementptr inbounds ptr, ptr %27, i64 %indvars.iv247
  %28 = load ptr, ptr %arrayidx148, align 8, !tbaa !16
  %v150 = getelementptr inbounds %struct.SNode, ptr %28, i64 0, i32 6, i32 2
  %29 = load ptr, ptr %v150, align 8, !tbaa !158
  %arrayidx152 = getelementptr inbounds ptr, ptr %29, i64 %indvars.iv
  %30 = load ptr, ptr %arrayidx152, align 8, !tbaa !16
  tail call fastcc void @build_paths_internal(ptr noundef %30, ptr noundef %paths, i32 noundef %parent.addr.2, i32 noundef %n, i32 noundef %sub153)
  %inc154 = add nsw i32 %l.0242, 1
  %.pre252 = load ptr, ptr %v73, align 8, !tbaa !171
  br label %for.inc

for.inc:                                          ; preds = %for.body78, %if.end144
  %31 = phi ptr [ %.pre252, %if.end144 ], [ %13, %for.body78 ]
  %parent.addr.3 = phi i32 [ %parent.addr.2, %if.end144 ], [ %parent.addr.1240, %for.body78 ]
  %l.1 = phi i32 [ %inc154, %if.end144 ], [ %l.0242, %for.body78 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %arrayidx75 = getelementptr inbounds ptr, ptr %31, i64 %indvars.iv247
  %32 = load ptr, ptr %arrayidx75, align 8, !tbaa !16
  %zns = getelementptr inbounds %struct.SNode, ptr %32, i64 0, i32 6
  %33 = load i32, ptr %zns, align 8, !tbaa !157
  %34 = zext i32 %33 to i64
  %cmp77 = icmp ult i64 %indvars.iv.next, %34
  br i1 %cmp77, label %for.body78, label %for.inc157.loopexit, !llvm.loop !327

for.inc157.loopexit:                              ; preds = %for.inc
  %.pre253 = load i32, ptr %sns, align 8, !tbaa !170
  br label %for.inc157

for.inc157:                                       ; preds = %for.inc157.loopexit, %for.cond71.preheader
  %35 = phi i32 [ %8, %for.cond71.preheader ], [ %.pre253, %for.inc157.loopexit ]
  %36 = phi ptr [ %9, %for.cond71.preheader ], [ %31, %for.inc157.loopexit ]
  %37 = phi ptr [ %10, %for.cond71.preheader ], [ %31, %for.inc157.loopexit ]
  %parent.addr.1.lcssa = phi i32 [ %parent.addr.0244, %for.cond71.preheader ], [ %parent.addr.3, %for.inc157.loopexit ]
  %indvars.iv.next248 = add nuw nsw i64 %indvars.iv247, 1
  %38 = zext i32 %35 to i64
  %cmp70 = icmp ult i64 %indvars.iv.next248, %38
  br i1 %cmp70, label %for.cond71.preheader, label %cleanup, !llvm.loop !328
...
if.then:                                          ; preds = %entry
  %3 = and i32 %2, 24
  %or.cond84 = icmp eq i32 %3, 0
  br i1 %or.cond84, label %if.end58, label %if.then11

if.then11:                                        ; preds = %if.then
  %4 = load i32, ptr %pn0, align 8, !tbaa !266
...
if.then13:                                        ; preds = %if.then11
  ...
  %6 = load i32, ptr %priority, align 4, !tbaa !267
...
if.then22:                                        ; preds = %if.else
  ...
  %cmp17.i85 = icmp sgt i32 %12, %11
  br i1 %cmp17.i85, label %check_child.exit104, label %cond.false19.i87

cond.false19.i87:                                 ; preds = %if.then22
  %cmp20.i86 = icmp slt i32 %12, %11
  br i1 %cmp20.i86, label %check_child.exit104, label %cond.false22.i93

cond.false22.i93:                                 ; preds = %cond.false19.i87
  %and23.i88 = and i32 %0, 2
  %and26.i89 = lshr i32 %2, 1
  %and26.lobit.i90 = and i32 %and26.i89, 1
  %add.i91 = add nuw nsw i32 %and23.i88, 2
  %add29.i92 = or i32 %add.i91, %and26.lobit.i90
  %13 = zext i32 %add29.i92 to i64
  br label %check_child.exit104

check_child.exit104:                              ; preds = %if.then22, %cond.false19.i87, %cond.false22.i93
  %cond33.i94 = phi i64 [ 0, %if.then22 ], [ %13, %cond.false22.i93 ], [ 1, %cond.false19.i87 ]
  %14 = and i32 %0, 20
  %or.cond46.i95 = icmp eq i32 %14, 0
  %cmp13.i96 = icmp eq i32 %0, 9
  %cond14.i97 = select i1 %cmp13.i96, i64 1, i64 2
  %cond16.i98 = select i1 %or.cond46.i95, i64 %cond14.i97, i64 0
  %15 = and i32 %2, 20
  %or.cond.i99 = icmp eq i32 %15, 0
  %cmp.i100 = icmp eq i32 %2, 9
  %cond4.i101 = select i1 %cmp.i100, i64 2, i64 3
  %cond5.i102 = select i1 %or.cond.i99, i64 %cond4.i101, i64 1
  %arrayidx37.i103 = getelementptr inbounds [4 x [3 x [6 x i32]]], ptr @child_table, i64 0, i64 %cond5.i102, i64 %cond16.i98, i64 %cond33.i94
  %16 = load i32, ptr %arrayidx37.i103, align 4, !tbaa !50
...
land.lhs.true:                                    ; preds = %if.then33
  ...
  %cmp17.i105 = icmp sgt i32 %19, %18
  br i1 %cmp17.i105, label %check_child.exit124, label %cond.false19.i107

cond.false19.i107:                                ; preds = %land.lhs.true
  %cmp20.i106 = icmp slt i32 %19, %18
  br i1 %cmp20.i106, label %check_child.exit124, label %cond.false22.i113

cond.false22.i113:                                ; preds = %cond.false19.i107
  %and23.i108 = and i32 %0, 2
  %and26.i109 = lshr i32 %17, 1
  %and26.lobit.i110 = and i32 %and26.i109, 1
  %add.i111 = add nuw nsw i32 %and23.i108, 2
  %add29.i112 = or i32 %add.i111, %and26.lobit.i110
  %20 = zext i32 %add29.i112 to i64
  br label %check_child.exit124

check_child.exit124:                              ; preds = %land.lhs.true, %cond.false19.i107, %cond.false22.i113
  %cond33.i114 = phi i64 [ 0, %land.lhs.true ], [ %20, %cond.false22.i113 ], [ 1, %cond.false19.i107 ]
  %21 = and i32 %0, 20
  %or.cond46.i115 = icmp eq i32 %21, 0
  %cmp13.i116 = icmp eq i32 %0, 9
  %cond14.i117 = select i1 %cmp13.i116, i64 1, i64 2
  %cond16.i118 = select i1 %or.cond46.i115, i64 %cond14.i117, i64 0
  %22 = and i32 %17, 20
  %or.cond.i119 = icmp eq i32 %22, 0
  %cmp.i120 = icmp eq i32 %17, 9
  %cond4.i121 = select i1 %cmp.i120, i64 2, i64 3
  %cond5.i122 = select i1 %or.cond.i119, i64 %cond4.i121, i64 1
  %arrayidx37.i123 = getelementptr inbounds [4 x [3 x [6 x i32]]], ptr @child_table, i64 0, i64 %cond5.i122, i64 %cond16.i118, i64 %cond33.i114
  %23 = load i32, ptr %arrayidx37.i123, align 4, !tbaa !50
  %tobool41.not = icmp eq i32 %23, 0
  br i1 %tobool41.not, label %return, label %if.end45

if.end45:                                         ; preds = %if.else31, %check_child.exit124, %if.then33, %check_child.exit104
  %24 = load i32, ptr %pn1, align 8, !tbaa !266
...
if.then48:                                        ; preds = %if.end45
  ...
  %26 = load i32, ptr %priority51, align 4, !tbaa !267
  %cmp17.i125 = icmp sgt i32 %26, %25
  br i1 %cmp17.i125, label %check_child.exit144, label %cond.false19.i127

cond.false19.i127:                                ; preds = %if.then48
  %cmp20.i126 = icmp slt i32 %26, %25
  br i1 %cmp20.i126, label %check_child.exit144, label %cond.false22.i133

cond.false22.i133:                                ; preds = %cond.false19.i127
  %and23.i128 = and i32 %24, 2
  %and26.i129 = lshr i32 %0, 1
  %and26.lobit.i130 = and i32 %and26.i129, 1
  %add.i131 = or i32 %and26.lobit.i130, 2
  %add29.i132 = add nuw nsw i32 %add.i131, %and23.i128
  %27 = zext i32 %add29.i132 to i64
  br label %check_child.exit144

check_child.exit144:                              ; preds = %if.then48, %cond.false19.i127, %cond.false22.i133
  %cond33.i134 = phi i64 [ 0, %if.then48 ], [ %27, %cond.false22.i133 ], [ 1, %cond.false19.i127 ]
  %28 = and i32 %24, 20
  %or.cond46.i135 = icmp eq i32 %28, 0
  %cmp13.i136 = icmp eq i32 %24, 9
  %cond14.i137 = select i1 %cmp13.i136, i64 1, i64 2
  %cond16.i138 = select i1 %or.cond46.i135, i64 %cond14.i137, i64 0
  %29 = and i32 %0, 20
  %or.cond.i139 = icmp eq i32 %29, 0
  %cmp.i140 = icmp eq i32 %0, 9
  %cond4.i141 = select i1 %cmp.i140, i64 2, i64 3
  %cond5.i142 = select i1 %or.cond.i139, i64 %cond4.i141, i64 0
  %arrayidx37.i143 = getelementptr inbounds [4 x [3 x [6 x i32]]], ptr @child_table, i64 0, i64 %cond5.i142, i64 %cond16.i138, i64 %cond33.i134
  %30 = load i32, ptr %arrayidx37.i143, align 4, !tbaa !50
  %tobool54.not = icmp eq i32 %30, 0
  br i1 %tobool54.not, label %return, label %if.end58

if.end58:                                         ; preds = %if.then, %if.end45, %check_child.exit144, %check_child.exit, %if.then11
  br label %return

return:                                           ; preds = %check_child.exit144, %check_child.exit124, %check_child.exit104, %check_child.exit, %if.end58
  %retval.0 = phi i32 [ 0, %if.end58 ], [ -1, %check_child.exit ], [ -1, %check_child.exit104 ], [ -1, %check_child.exit124 ], [ -1, %check_child.exit144 ]
  ret i32 %retval.0
}
...
land.lhs.true:                                    ; preds = %entry
  ...
  %1 = load ptr, ptr %final_code, align 8, !tbaa !231
...
for.cond:                                         ; preds = %for.body
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %cleanup, label %for.body, !llvm.loop !329

for.body:                                         ; preds = %for.body.lr.ph, %for.cond
  %indvars.iv = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next, %for.cond ]
  %arrayidx = getelementptr inbounds ptr, ptr %3, i64 %indvars.iv
  %4 = load ptr, ptr %arrayidx, align 8, !tbaa !16
  %call = tail call fastcc i32 @final_actionless(ptr noundef %4)
...
attributes #14 = { mustprogress nofree nounwind willreturn memory(readwrite, argmem: read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #17 = { mustprogress nofree nosync nounwind willreturn memory(none) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!97 = !{!24, !10, i64 128}
!98 = !{!24, !10, i64 280}
!99 = !{i64 0, i64 8, !16, i64 8, i64 8, !16, i64 16, i64 4, !50, i64 20, i64 4, !50, i64 24, i64 4, !50}
!100 = !{!44, !9, i64 112}
!101 = !{!25, !10, i64 48}
!102 = !{!13, !9, i64 16}
!103 = distinct !{!103, !18}
...
!126 = !{!24, !10, i64 304}
!127 = !{!128, !10, i64 40}
!128 = !{!"Reduction", !10, i64 0, !10, i64 8, !10, i64 16, !10, i64 24, !9, i64 32, !10, i64 40}
!129 = !{!128, !10, i64 8}
!130 = distinct !{!130, !18}
!131 = !{!132, !10, i64 8}
!132 = !{!"Shift", !10, i64 0, !10, i64 8}
!133 = !{!132, !10, i64 0}
!134 = distinct !{!134, !18}
!135 = distinct !{!135, !18}
!136 = distinct !{!136, !18}
...
!220 = !{!24, !7, i64 395}
!221 = !{!222, !10, i64 0}
!222 = !{!"ShiftResult", !10, i64 0, !13, i64 8}
!223 = !{!181, !10, i64 80}
!224 = !{!28, !29, i64 0}
!225 = !{!222, !10, i64 8}
!226 = !{!44, !9, i64 44}
...
!275 = distinct !{!275, !18}
!276 = !{!277, !10, i64 16}
!277 = !{!"", !10, i64 0, !10, i64 8, !10, i64 16, !7, i64 24}
!278 = !{!277, !10, i64 0}
!279 = !{!277, !10, i64 8}
!280 = distinct !{!280, !18}
!281 = distinct !{!281, !18}
...
!286 = distinct !{!286, !18}
!287 = !{!24, !9, i64 108}
!288 = !{i64 0, i64 8, !16, i64 8, i64 24, !21}
!289 = !{!128, !9, i64 32}
!290 = distinct !{!290, !18}
!291 = distinct !{!291, !18}
!292 = distinct !{!292, !18}
...
!317 = !{!181, !10, i64 40}
!318 = !{!319, !29, i64 2}
!319 = !{!"D_RightEpsilonHint", !29, i64 0, !29, i64 2, !10, i64 8}
!320 = !{!319, !10, i64 8}
!321 = !{!319, !29, i64 0}
!322 = distinct !{!322, !18}
!323 = distinct !{!323, !18, !324}
