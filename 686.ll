; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_pe.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_pe.c"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 2, ptr nonnull %e_magic) #14
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %e_lfanew) #14
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %timestamp) #14
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %file_hdr) #14
  call void @llvm.lifetime.start.p0(i64 240, ptr nonnull %pe_opt) #14
  call void @llvm.lifetime.start.p0(i64 144, ptr nonnull %sb) #14
  call void @llvm.lifetime.start.p0(i64 9, ptr nonnull %sname) #14
  call void @llvm.lifetime.start.p0(i64 4096, ptr nonnull %buff) #14
  call void @llvm.lifetime.start.p0(i64 4096, ptr nonnull %epbuff) #14
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %err) #14
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %dsize) #14
...
if.end:                                           ; preds = %entry
  %call = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %e_magic, i32 noundef 2) #14
  %cmp.not = icmp eq i32 %call, 2
  br i1 %cmp.not, label %if.end3, label %if.then2

if.then2:                                         ; preds = %if.end
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.1) #14
  br label %cleanup4880

if.end3:                                          ; preds = %if.end
  %0 = load i16, ptr %e_magic, align 2, !tbaa !9
...
if.then10:                                        ; preds = %if.end3
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.2) #14
  br label %cleanup4880

if.end11:                                         ; preds = %if.end3, %if.end3
  %call12 = call i64 @lseek(i32 noundef %desc, i64 noundef 58, i32 noundef 1) #14
  %call13 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %e_lfanew, i32 noundef 4) #14
  %cmp15.not = icmp eq i32 %call13, 4
  br i1 %cmp15.not, label %if.end25, label %if.then17

if.then17:                                        ; preds = %if.end11
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.3) #14
  %options = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 5
  %1 = load i32, ptr %options, align 8, !tbaa !11
  %and = and i32 %1, 64
  %tobool18.not = icmp eq i32 %and, 0
  br i1 %tobool18.not, label %cleanup4880, label %if.then19

if.then19:                                        ; preds = %if.then17
  %2 = load ptr, ptr %ctx, align 8, !tbaa !14
  %tobool20.not = icmp eq ptr %2, null
  br i1 %tobool20.not, label %cleanup4880, label %if.then21

if.then21:                                        ; preds = %if.then19
  store ptr @.str.4, ptr %2, align 8, !tbaa !15
  br label %cleanup4880

if.end25:                                         ; preds = %if.end11
  %3 = load i32, ptr %e_lfanew, align 4, !tbaa !5
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.5, i32 noundef %3) #14
...
if.end28:                                         ; preds = %if.end25
  ...
  %call30 = call i64 @lseek(i32 noundef %desc, i64 noundef %conv29, i32 noundef 0) #14
...
if.end34:                                         ; preds = %if.end28
  %call35 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %file_hdr, i32 noundef 24) #14
  %cmp37.not = icmp eq i32 %call35, 24
  br i1 %cmp37.not, label %if.end40, label %if.then39

if.then39:                                        ; preds = %if.end34
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.8) #14
  br label %cleanup4880

if.end40:                                         ; preds = %if.end34
  %5 = load i32, ptr %file_hdr, align 4, !tbaa !16
...
if.end44:                                         ; preds = %if.end40
  ...
  %6 = load i16, ptr %Characteristics, align 2, !tbaa !18
...
if.end55.sink.split:                              ; preds = %if.else, %if.end44
  ...
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull %.str.11.sink) #14
  br label %if.end55
...
if.end55:                                         ; preds = %if.end55.sink.split, %if.else
  ...
  %7 = load i16, ptr %Machine, align 4, !tbaa !19
...
sw.bb59:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.15) #14
  br label %sw.epilog

sw.bb60:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.16) #14
  br label %sw.epilog
...
sw.bb62:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.18) #14
  br label %sw.epilog
...
sw.bb66:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.22) #14
  br label %sw.epilog
...
sw.bb68:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.24) #14
  br label %sw.epilog

sw.bb69:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.25) #14
  br label %sw.epilog

sw.bb70:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.26) #14
  br label %sw.epilog

sw.bb71:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.27) #14
  br label %sw.epilog
...
sw.bb74:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.30) #14
  br label %sw.epilog

sw.bb75:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.31) #14
  br label %sw.epilog
...
sw.bb77:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.33) #14
  br label %sw.epilog

sw.bb78:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.34) #14
  br label %sw.epilog

sw.bb79:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.35) #14
  br label %sw.epilog

sw.bb80:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.36) #14
  br label %sw.epilog

sw.bb81:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.37) #14
  br label %sw.epilog

sw.bb82:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.38) #14
  br label %sw.epilog

sw.bb83:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.39) #14
  br label %sw.epilog

sw.bb84:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.40) #14
  br label %sw.epilog

sw.bb85:                                          ; preds = %if.end55
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.41) #14
  br label %sw.epilog

sw.default:                                       ; preds = %if.end55
  %conv56 = zext i16 %7 to i32
  call void (ptr, ...) @cli_warnmsg(ptr noundef nonnull @.str.42, i32 noundef %conv56) #14
  br label %sw.epilog
...
sw.epilog:                                        ; preds = %sw.default, %sw.bb85, %sw.bb84, %sw.bb83, %sw.bb82, %sw.bb81, %sw.bb80, %sw.bb79, %sw.bb78, %sw.bb77, %sw.bb76, %sw.bb75, %sw.bb74, %sw.bb73, %sw.bb72, %sw.bb71, %sw.bb70, %sw.bb69, %sw.bb68, %sw.bb67, %sw.bb66, %sw.bb65, %sw.bb64, %sw.bb63, %sw.bb62, %sw.bb61, %sw.bb60, %sw.bb59, %sw.bb58, %sw.bb57, %sw.bb
  ...
  %8 = load i16, ptr %NumberOfSections, align 2, !tbaa !20
...
if.then94:                                        ; preds = %sw.epilog
  ...
  %10 = load i32, ptr %options95, align 8, !tbaa !11
  %and96 = and i32 %10, 64
...
if.then101:                                       ; preds = %if.then98
  store ptr @.str.4, ptr %11, align 8, !tbaa !15
  br label %cleanup4880
...
if.then106:                                       ; preds = %if.end104
  call void (ptr, ...) @cli_warnmsg(ptr noundef nonnull @.str.43, i32 noundef %conv88) #14
  br label %cleanup4880

if.else108:                                       ; preds = %if.end104
  call void (ptr, ...) @cli_warnmsg(ptr noundef nonnull @.str.44) #14
  br label %cleanup4880

if.end110:                                        ; preds = %sw.epilog
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.45, i32 noundef %conv88) #14
  %TimeDateStamp = getelementptr inbounds %struct.pe_image_file_hdr, ptr %file_hdr, i64 0, i32 3
  %12 = load i32, ptr %TimeDateStamp, align 4, !tbaa !21
  %conv112 = zext i32 %12 to i64
  store i64 %conv112, ptr %timestamp, align 8, !tbaa !22
  %call113 = call ptr @ctime(ptr noundef nonnull %timestamp) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.46, ptr noundef %call113) #14
  %SizeOfOptionalHeader = getelementptr inbounds %struct.pe_image_file_hdr, ptr %file_hdr, i64 0, i32 6
  %13 = load i16, ptr %SizeOfOptionalHeader, align 4, !tbaa !24
  %conv114 = zext i16 %13 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.47, i32 noundef %conv114) #14
  %14 = load i16, ptr %SizeOfOptionalHeader, align 4, !tbaa !24
  %cmp117 = icmp ult i16 %14, 224
  br i1 %cmp117, label %if.then119, label %if.end130

if.then119:                                       ; preds = %if.end110
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.48) #14
  %options120 = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 5
  %15 = load i32, ptr %options120, align 8, !tbaa !11
...
if.then173:                                       ; preds = %if.else168
  ...
  %23 = load i32, ptr %options174, align 8, !tbaa !11
...
if.then177:                                       ; preds = %if.then173
  %24 = load ptr, ptr %ctx, align 8, !tbaa !14
  %tobool179.not = icmp eq ptr %24, null
  br i1 %tobool179.not, label %cleanup4880, label %if.then180

if.then180:                                       ; preds = %if.then177
  store ptr @.str.4, ptr %24, align 8, !tbaa !15
  br label %cleanup4880

if.end183:                                        ; preds = %if.then173
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.52) #14
  br label %if.then187

if.then187:                                       ; preds = %if.else168, %if.end183
  %25 = load i16, ptr %SizeOfOptionalHeader, align 4, !tbaa !24
...
if.then192:                                       ; preds = %if.then187
  ...
  %call195 = call i64 @lseek(i32 noundef %desc, i64 noundef %sub, i32 noundef 1) #14
...
if.end196:                                        ; preds = %if.then192, %if.then187
  ...
  %27 = load ptr, ptr %dconf, align 8, !tbaa !26
  ...
  %29 = load i32, ptr %AddressOfEntryPoint, align 8, !tbaa !25
  %SizeOfHeaders = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 20
  %30 = load i32, ptr %SizeOfHeaders, align 4, !tbaa !25
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.53) #14
  %MajorLinkerVersion = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 1
  %31 = load i8, ptr %MajorLinkerVersion, align 2, !tbaa !25
  %conv205 = zext i8 %31 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.54, i32 noundef %conv205) #14
  %MinorLinkerVersion = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 2
  %32 = load i8, ptr %MinorLinkerVersion, align 1, !tbaa !25
  %conv206 = zext i8 %32 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.55, i32 noundef %conv206) #14
  %SizeOfCode = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 3
  %33 = load i32, ptr %SizeOfCode, align 4, !tbaa !25
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.56, i32 noundef %33) #14
  %SizeOfInitializedData = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 4
  %34 = load i32, ptr %SizeOfInitializedData, align 8, !tbaa !25
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.57, i32 noundef %34) #14
  %SizeOfUninitializedData = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 5
  %35 = load i32, ptr %SizeOfUninitializedData, align 4, !tbaa !25
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.58, i32 noundef %35) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.59, i32 noundef %29) #14
  %BaseOfCode = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 7
  %36 = load i32, ptr %BaseOfCode, align 4, !tbaa !25
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.60, i32 noundef %36) #14
  %SectionAlignment = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 10
  %37 = load i32, ptr %SectionAlignment, align 8, !tbaa !25
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.61, i32 noundef %37) #14
  %FileAlignment = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 11
  %38 = load i32, ptr %FileAlignment, align 4, !tbaa !25
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.62, i32 noundef %38) #14
  %MajorSubsystemVersion = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 16
  %39 = load i16, ptr %MajorSubsystemVersion, align 8, !tbaa !25
  %conv207 = zext i16 %39 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.63, i32 noundef %conv207) #14
  %MinorSubsystemVersion = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 17
  %40 = load i16, ptr %MinorSubsystemVersion, align 2, !tbaa !25
  %conv208 = zext i16 %40 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.64, i32 noundef %conv208) #14
  %SizeOfImage = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 19
  %41 = load i32, ptr %SizeOfImage, align 8, !tbaa !25
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.65, i32 noundef %41) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.66, i32 noundef %30) #14
...
if.else209:                                       ; preds = %if.then151
  ...
  %call210 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %add.ptr, i32 noundef 16) #14
...
if.then214:                                       ; preds = %if.else209
  ...
  %42 = load i32, ptr %options215, align 8, !tbaa !11
...
if.end225:                                        ; preds = %if.else209
  ...
  %44 = load i32, ptr %AddressOfEntryPoint226, align 8, !tbaa !25
  %SizeOfHeaders227 = getelementptr inbounds %struct.pe_image_optional_hdr64, ptr %pe_opt, i64 0, i32 19
  %45 = load i32, ptr %SizeOfHeaders227, align 4, !tbaa !25
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.68) #14
  %MajorLinkerVersion228 = getelementptr inbounds %struct.pe_image_optional_hdr64, ptr %pe_opt, i64 0, i32 1
  %46 = load i8, ptr %MajorLinkerVersion228, align 2, !tbaa !25
  %conv229 = zext i8 %46 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.54, i32 noundef %conv229) #14
  %MinorLinkerVersion230 = getelementptr inbounds %struct.pe_image_optional_hdr64, ptr %pe_opt, i64 0, i32 2
  %47 = load i8, ptr %MinorLinkerVersion230, align 1, !tbaa !25
  %conv231 = zext i8 %47 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.55, i32 noundef %conv231) #14
  %SizeOfCode232 = getelementptr inbounds %struct.pe_image_optional_hdr64, ptr %pe_opt, i64 0, i32 3
  %48 = load i32, ptr %SizeOfCode232, align 4, !tbaa !25
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.56, i32 noundef %48) #14
  %SizeOfInitializedData233 = getelementptr inbounds %struct.pe_image_optional_hdr64, ptr %pe_opt, i64 0, i32 4
  %49 = load i32, ptr %SizeOfInitializedData233, align 8, !tbaa !25
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.57, i32 noundef %49) #14
  %SizeOfUninitializedData234 = getelementptr inbounds %struct.pe_image_optional_hdr64, ptr %pe_opt, i64 0, i32 5
  %50 = load i32, ptr %SizeOfUninitializedData234, align 4, !tbaa !25
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.58, i32 noundef %50) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.59, i32 noundef %44) #14
  %BaseOfCode235 = getelementptr inbounds %struct.pe_image_optional_hdr64, ptr %pe_opt, i64 0, i32 7
  %51 = load i32, ptr %BaseOfCode235, align 4, !tbaa !25
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.60, i32 noundef %51) #14
  %SectionAlignment236 = getelementptr inbounds %struct.pe_image_optional_hdr64, ptr %pe_opt, i64 0, i32 9
  %52 = load i32, ptr %SectionAlignment236, align 8, !tbaa !25
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.61, i32 noundef %52) #14
  %FileAlignment237 = getelementptr inbounds %struct.pe_image_optional_hdr64, ptr %pe_opt, i64 0, i32 10
  %53 = load i32, ptr %FileAlignment237, align 4, !tbaa !25
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.62, i32 noundef %53) #14
  %MajorSubsystemVersion238 = getelementptr inbounds %struct.pe_image_optional_hdr64, ptr %pe_opt, i64 0, i32 15
  %54 = load i16, ptr %MajorSubsystemVersion238, align 8, !tbaa !25
  %conv239 = zext i16 %54 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.63, i32 noundef %conv239) #14
  %MinorSubsystemVersion240 = getelementptr inbounds %struct.pe_image_optional_hdr64, ptr %pe_opt, i64 0, i32 16
  %55 = load i16, ptr %MinorSubsystemVersion240, align 2, !tbaa !25
  %conv241 = zext i16 %55 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.64, i32 noundef %conv241) #14
  %SizeOfImage242 = getelementptr inbounds %struct.pe_image_optional_hdr64, ptr %pe_opt, i64 0, i32 18
  %56 = load i32, ptr %SizeOfImage242, align 8, !tbaa !25
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.65, i32 noundef %56) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.66, i32 noundef %45) #14
...
if.end244:                                        ; preds = %if.end225, %if.end196
  ...
  %57 = load i32, ptr %NumberOfRvaAndSizes243.sink, align 4, !tbaa !25
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.67, i32 noundef %57) #14
...
sw.bb249:                                         ; preds = %if.end244
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.69) #14
  br label %sw.epilog270

sw.bb250:                                         ; preds = %if.end244
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.70) #14
  br label %sw.epilog270

sw.bb251:                                         ; preds = %if.end244
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.71) #14
  br label %sw.epilog270

sw.bb252:                                         ; preds = %if.end244
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.72) #14
  br label %sw.epilog270
...
sw.bb254:                                         ; preds = %if.end244
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.74) #14
  br label %sw.epilog270

sw.bb255:                                         ; preds = %if.end244
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.75) #14
  br label %sw.epilog270
...
sw.bb257:                                         ; preds = %if.end244
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.77) #14
  br label %sw.epilog270
...
sw.bb259:                                         ; preds = %if.end244
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.79) #14
  br label %sw.epilog270

sw.default260:                                    ; preds = %if.end244
  %cond = zext i16 %58 to i32
  call void (ptr, ...) @cli_warnmsg(ptr noundef nonnull @.str.80, i32 noundef %cond) #14
  br label %sw.epilog270
...
sw.epilog270:                                     ; preds = %sw.default260, %sw.bb259, %sw.bb258, %sw.bb257, %sw.bb256, %sw.bb255, %sw.bb254, %sw.bb253, %sw.bb252, %sw.bb251, %sw.bb250, %sw.bb249
  ...
  %59 = load i32, ptr %options271, align 8, !tbaa !11
...
cond.true278:                                     ; preds = %land.lhs.true276
  ...
  %60 = load i32, ptr %SectionAlignment279, align 8, !tbaa !25
  %tobool280.not = icmp ne i32 %60, 0
  %rem = and i32 %60, 4095
  %tobool292.not = icmp eq i32 %rem, 0
  %or.cond7605 = and i1 %tobool280.not, %tobool292.not
  br i1 %or.cond7605, label %cond.true307, label %if.then293
...
cond.false281:                                    ; preds = %land.lhs.true276
  ...
  %61 = load i32, ptr %SectionAlignment282, align 8, !tbaa !25
  %tobool283.not = icmp ne i32 %61, 0
  %rem7133 = and i32 %61, 4095
  %tobool292.not7134 = icmp eq i32 %rem7133, 0
  %or.cond7606 = and i1 %tobool283.not, %tobool292.not7134
  br i1 %or.cond7606, label %cond.false310, label %if.then293

if.then293:                                       ; preds = %cond.false281, %cond.true278
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.82) #14
  %62 = load ptr, ptr %ctx, align 8, !tbaa !14
  %tobool295.not = icmp eq ptr %62, null
  br i1 %tobool295.not, label %cleanup4880, label %if.then296

if.then296:                                       ; preds = %if.then293
  store ptr @.str.4, ptr %62, align 8, !tbaa !15
  br label %cleanup4880
...
cond.true307:                                     ; preds = %cond.true278
  ...
  %63 = load i32, ptr %FileAlignment308, align 4, !tbaa !25
...
cond.false310:                                    ; preds = %cond.false281
  ...
  %64 = load i32, ptr %FileAlignment311, align 4, !tbaa !25
...
if.end344:                                        ; preds = %if.end339
  ...
  %call361 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %call336, i32 noundef %conv360) #14
  %cmp365.not = icmp eq i32 %call361, %conv360
  br i1 %cmp365.not, label %if.end378, label %if.then367

if.then367:                                       ; preds = %if.end344
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.86) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.87) #14
  call void @free(ptr noundef nonnull %call336) #14
  call void @free(ptr noundef nonnull %call341) #14
  %70 = load i32, ptr %options271, align 8, !tbaa !11
...
land.lhs.true385:                                 ; preds = %for.body
  ...
  %73 = load i32, ptr %SizeOfRawData, align 4, !tbaa !32
...
land.lhs.true387:                                 ; preds = %land.lhs.true385
  ...
  %74 = load i32, ptr %PointerToRawData, align 4, !tbaa !34
...
for.inc.thread:                                   ; preds = %land.lhs.true387
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.88) #14
  br label %for.end

for.inc:                                          ; preds = %for.body, %land.lhs.true385, %land.lhs.true387
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %cmp382 = icmp ult i64 %indvars.iv.next, %72
  br i1 %cmp382, label %for.body, label %for.end, !llvm.loop !35

for.end:                                          ; preds = %for.inc, %for.inc.thread, %if.end378
  %falign.0.lcssa = phi i32 [ %69, %if.end378 ], [ 512, %for.inc.thread ], [ %69, %for.inc ]
...
for.body413.lr.ph:                                ; preds = %cond.end407
  ...
  %cmp563.not = icmp eq i32 %conv562, 0
  ...
  %wide.trip.count7469 = zext i16 %8 to i64
  br label %for.body413

for.body413:                                      ; preds = %for.body413.lr.ph, %for.inc881
  %indvars.iv7466 = phi i64 [ 0, %for.body413.lr.ph ], [ %indvars.iv.next7467, %for.inc881 ]
  ...
  %arrayidx415 = getelementptr inbounds %struct.pe_image_section_hdr, ptr %call336, i64 %indvars.iv7466
  %call417 = call ptr @strncpy(ptr noundef nonnull dereferenceable(1) %sname, ptr noundef nonnull dereferenceable(1) %arrayidx415, i64 noundef 8) #14
  store i8 0, ptr %arrayidx418, align 1, !tbaa !25
  %VirtualAddress428 = getelementptr inbounds %struct.pe_image_section_hdr, ptr %call336, i64 %indvars.iv7466, i32 2
  %75 = load i32, ptr %VirtualAddress428, align 4, !tbaa !37
...
cond.true434:                                     ; preds = %for.body413
  ...
  %arrayidx432 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7466
  store i32 %mul424, ptr %arrayidx432, align 4, !tbaa !38
  %VirtualSize = getelementptr inbounds %struct.pe_image_section_hdr, ptr %call336, i64 %indvars.iv7466, i32 1
  %77 = load i32, ptr %VirtualSize, align 4, !tbaa !40
...
cond.false446:                                    ; preds = %for.body413
  %arrayidx4327136 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7466
  store i32 %.fr7061, ptr %arrayidx4327136, align 4, !tbaa !38
  %VirtualSize449 = getelementptr inbounds %struct.pe_image_section_hdr, ptr %call336, i64 %indvars.iv7466, i32 1
  %78 = load i32, ptr %VirtualSize449, align 4, !tbaa !40
  br label %cond.end450
...
cond.end450:                                      ; preds = %cond.false446, %cond.true434
  ...
  %vsz = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7466, i32 1
  store i32 %cond451, ptr %vsz, align 4, !tbaa !41
  %PointerToRawData464 = getelementptr inbounds %struct.pe_image_section_hdr, ptr %call336, i64 %indvars.iv7466, i32 4
  %80 = load i32, ptr %PointerToRawData464, align 4, !tbaa !34
  %.fr = freeze i32 %80
...
cond.true470:                                     ; preds = %cond.end450
  ...
  %raw = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7466, i32 2
  store i32 %mul460, ptr %raw, align 4, !tbaa !42
  %SizeOfRawData473 = getelementptr inbounds %struct.pe_image_section_hdr, ptr %call336, i64 %indvars.iv7466, i32 3
  %82 = load i32, ptr %SizeOfRawData473, align 4, !tbaa !32
...
cond.false483:                                    ; preds = %cond.end450
  %raw7140 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7466, i32 2
  store i32 %.fr, ptr %raw7140, align 4, !tbaa !42
  %SizeOfRawData486 = getelementptr inbounds %struct.pe_image_section_hdr, ptr %call336, i64 %indvars.iv7466, i32 3
  %83 = load i32, ptr %SizeOfRawData486, align 4, !tbaa !32
  br label %cond.end487
...
cond.end487:                                      ; preds = %cond.false483, %cond.true470
  ...
  %rsz = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7466, i32 3
  store i32 %cond488, ptr %rsz, align 4, !tbaa !43
  %Characteristics493 = getelementptr inbounds %struct.pe_image_section_hdr, ptr %call336, i64 %indvars.iv7466, i32 9
  %85 = load i32, ptr %Characteristics493, align 4, !tbaa !44
  %chr = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7466, i32 4
  store i32 %85, ptr %chr, align 4, !tbaa !45
  %urva = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7466, i32 5
  store i32 %.fr7061, ptr %urva, align 4, !tbaa !46
  %uvsz = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7466, i32 6
  store i32 %79, ptr %uvsz, align 4, !tbaa !47
  %uraw = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7466, i32 7
  store i32 %.fr, ptr %uraw, align 4, !tbaa !48
  %ursz = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7466, i32 8
  store i32 %84, ptr %ursz, align 4, !tbaa !49
...
if.end549.thread7146:                             ; preds = %cond.true527, %if.then525
  ...
  store i32 %cond545, ptr %vsz, align 4, !tbaa !41
...
land.lhs.true561:                                 ; preds = %if.end549, %if.end549.thread7146
  ...
  %or.cond7062 = select i1 %cmp563.not, i1 true, i1 %cmp576.not
  br i1 %or.cond7062, label %if.then606, label %land.lhs.true584
...
if.then606:                                       ; preds = %land.lhs.true584, %land.lhs.true561
  ...
  store i32 %conv612, ptr %rsz, align 4, !tbaa !43
  br label %if.end616

if.end616:                                        ; preds = %land.lhs.true520, %land.lhs.true584, %if.then606, %if.end549.thread7146, %if.end549
  %87 = trunc i64 %indvars.iv7466 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.89, i32 noundef %87) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.90, ptr noundef nonnull %sname) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.91) #14
  %88 = load i32, ptr %uvsz, align 4, !tbaa !47
  %89 = load i32, ptr %vsz, align 4, !tbaa !41
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.92, i32 noundef %88, i32 noundef %89) #14
  %90 = load i32, ptr %urva, align 4, !tbaa !46
  %91 = load i32, ptr %arrayidx4327137, align 4, !tbaa !38
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.93, i32 noundef %90, i32 noundef %91) #14
  %92 = load i32, ptr %ursz, align 4, !tbaa !49
  %93 = load i32, ptr %rsz, align 4, !tbaa !43
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.94, i32 noundef %92, i32 noundef %93) #14
  %94 = load i32, ptr %uraw, align 4, !tbaa !48
  %95 = load i32, ptr %raw7143, align 4, !tbaa !42
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.95, i32 noundef %94, i32 noundef %95) #14
  %96 = load i32, ptr %chr, align 4, !tbaa !45
...
if.then647:                                       ; preds = %if.end616
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.96) #14
  %97 = load i32, ptr %vsz, align 4, !tbaa !41
  %98 = load i32, ptr %rsz, align 4, !tbaa !43
  %cmp654 = icmp ult i32 %97, %98
  br i1 %cmp654, label %if.then656, label %if.end658

if.then656:                                       ; preds = %if.then647
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.97) #14
  br label %if.end658

if.end658:                                        ; preds = %if.then647, %if.then656, %if.end616
  %99 = load i32, ptr %chr, align 4, !tbaa !45
...
if.then664:                                       ; preds = %if.end658
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.98) #14
  %.pr = load i32, ptr %chr, align 4, !tbaa !45
  br label %if.end665
...
if.then671:                                       ; preds = %if.end665
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.99) #14
  br label %if.end672

if.end672:                                        ; preds = %if.then671, %if.end665
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.81) #14
  %101 = load i32, ptr %options271, align 8, !tbaa !11
...
land.lhs.true676:                                 ; preds = %if.end672
  %102 = load i32, ptr %urva, align 4, !tbaa !46
...
if.then682:                                       ; preds = %land.lhs.true676
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.100) #14
  %103 = load ptr, ptr %ctx, align 8, !tbaa !14
  %tobool684.not = icmp eq ptr %103, null
  br i1 %tobool684.not, label %if.end687, label %if.then685

if.then685:                                       ; preds = %if.then682
  store ptr @.str.4, ptr %103, align 8, !tbaa !15
  br label %if.end687
...
if.then700:                                       ; preds = %if.then693
  %106 = trunc i64 %indvars.iv7466 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.101, i32 noundef %106, i32 noundef %105, i64 noundef %67) #14
  call void @free(ptr noundef nonnull %call336) #14
  call void @free(ptr noundef nonnull %call341) #14
  %107 = load i32, ptr %options271, align 8, !tbaa !11
  %and705 = and i32 %107, 64
  %tobool706.not = icmp eq i32 %and705, 0
  br i1 %tobool706.not, label %cleanup4880, label %if.then707

if.then707:                                       ; preds = %if.then700
  %108 = load ptr, ptr %ctx, align 8, !tbaa !14
  %tobool709.not = icmp eq ptr %108, null
  br i1 %tobool709.not, label %cleanup4880, label %if.then710

if.then710:                                       ; preds = %if.then707
  store ptr @.str.4, ptr %108, align 8, !tbaa !15
  br label %cleanup4880

if.end714:                                        ; preds = %if.then693
  %and716 = and i32 %101, 512
  %tobool717.not = icmp eq i32 %and716, 0
  %.pre7526 = load ptr, ptr %dconf719, align 8, !tbaa !26
  %.pre7527 = load i32, ptr %.pre7526, align 4, !tbaa !27
  br i1 %tobool717.not, label %if.end746, label %land.lhs.true718

land.lhs.true718:                                 ; preds = %if.end714
  %and721 = and i32 %.pre7527, 8
  %tobool722 = icmp eq i32 %and721, 0
  %109 = load i8, ptr %sname, align 1
  %tobool725 = icmp ne i8 %109, 0
...
land.lhs.true726:                                 ; preds = %land.lhs.true718
  %110 = load i32, ptr %vsz, align 4, !tbaa !41
  %111 = add i32 %110, -40001
  %or.cond7064 = icmp ult i32 %111, 29999
  br i1 %or.cond7064, label %land.lhs.true738, label %if.end746

land.lhs.true738:                                 ; preds = %land.lhs.true726
  %112 = load i32, ptr %chr, align 4, !tbaa !45
  %cmp742 = icmp eq i32 %112, -536870816
  %conv745 = trunc i64 %indvars.iv7466 to i8
...
if.end746:                                        ; preds = %if.end714, %land.lhs.true738, %land.lhs.true726, %land.lhs.true718
  ...
  %113 = load ptr, ptr %engine, align 8, !tbaa !50
  %md5_sect747 = getelementptr inbounds %struct.cl_engine, ptr %113, i64 0, i32 5
  %114 = load ptr, ptr %md5_sect747, align 8, !tbaa !51
  %and750 = and i32 %.pre7527, 16
  %tobool751 = icmp ne i32 %and750, 0
  %tobool753 = icmp ne ptr %114, null
...
for.cond755.preheader:                            ; preds = %if.end746
  %soff_len = getelementptr inbounds %struct.cli_matcher, ptr %114, i64 0, i32 5
  %115 = load i32, ptr %soff_len, align 8, !tbaa !53
  %cmp7567370.not = icmp eq i32 %115, 0
  br i1 %cmp7567370.not, label %if.end797, label %land.rhs758.lr.ph

land.rhs758.lr.ph:                                ; preds = %for.cond755.preheader
  %soff = getelementptr inbounds %struct.cli_matcher, ptr %114, i64 0, i32 4
  %116 = load ptr, ptr %soff, align 8, !tbaa !55
  %wide.trip.count = zext i32 %115 to i64
  br label %land.rhs758

for.cond755:                                      ; preds = %for.body767
  %indvars.iv.next7464 = add nuw nsw i64 %indvars.iv7463, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next7464, %wide.trip.count
  br i1 %exitcond.not, label %if.end797, label %land.rhs758, !llvm.loop !56

land.rhs758:                                      ; preds = %land.rhs758.lr.ph, %for.cond755
  %indvars.iv7463 = phi i64 [ 0, %land.rhs758.lr.ph ], [ %indvars.iv.next7464, %for.cond755 ]
  %arrayidx760 = getelementptr inbounds i32, ptr %116, i64 %indvars.iv7463
  %117 = load i32, ptr %arrayidx760, align 4, !tbaa !5
  %cmp764.not = icmp ugt i32 %117, %104
  br i1 %cmp764.not, label %if.end797, label %for.body767

for.body767:                                      ; preds = %land.rhs758
  %cmp774 = icmp eq i32 %117, %104
  br i1 %cmp774, label %if.then776, label %for.cond755

if.then776:                                       ; preds = %for.body767
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %md5_dig) #14
  %call780 = call fastcc i32 @cli_md5sect(i32 noundef %desc, ptr noundef nonnull %arrayidx4327137, ptr noundef nonnull %md5_dig)
...
land.lhs.true782:                                 ; preds = %if.then776
  %118 = load ptr, ptr %ctx, align 8, !tbaa !14
  %119 = load ptr, ptr %engine, align 8, !tbaa !50
  %md5_sect786 = getelementptr inbounds %struct.cl_engine, ptr %119, i64 0, i32 5
  %120 = load ptr, ptr %md5_sect786, align 8, !tbaa !51
  %call787 = call i32 @cli_bm_scanbuff(ptr noundef nonnull %md5_dig, i32 noundef 16, ptr noundef %118, ptr noundef %120, i32 noundef 0, i32 noundef 0, i32 noundef -1) #14
  %cmp788 = icmp eq i32 %call787, 1
  br i1 %cmp788, label %if.then790, label %cleanup

if.then790:                                       ; preds = %land.lhs.true782
  call void @free(ptr noundef %call336) #14
  call void @free(ptr noundef %call341) #14
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %md5_dig) #14
  br label %cleanup4880
...
if.end797:                                        ; preds = %land.rhs758, %for.cond755, %for.cond755.preheader, %cleanup, %if.end746, %if.end688
  ...
  %tobool798.not = icmp eq i64 %indvars.iv7466, 0
  %121 = load i32, ptr %options271, align 8, !tbaa !11
  %and801 = and i32 %121, 64
...
land.lhs.true803:                                 ; preds = %if.then799
  %122 = load i32, ptr %urva, align 4, !tbaa !46
  %cmp807.not = icmp eq i32 %122, %cond408
  br i1 %cmp807.not, label %if.end815, label %if.then809

if.then809:                                       ; preds = %land.lhs.true803
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.102) #14
  %123 = load ptr, ptr %ctx, align 8, !tbaa !14
  %tobool811.not = icmp eq ptr %123, null
  br i1 %tobool811.not, label %if.end814, label %if.then812

if.then812:                                       ; preds = %if.then809
  store ptr @.str.4, ptr %123, align 8, !tbaa !15
  br label %if.end814
...
if.end815:                                        ; preds = %land.lhs.true803, %if.then799
  %124 = load i32, ptr %arrayidx4327137, align 4, !tbaa !38
  %125 = load i32, ptr %rsz, align 4, !tbaa !43
  %add825 = add i32 %125, %124
  br label %for.inc881
...
land.lhs.true830:                                 ; preds = %if.else826
  %126 = load i32, ptr %urva, align 4, !tbaa !46
  %127 = add nuw i64 %indvars.iv7466, 4294967295
  %idxprom835 = and i64 %127, 4294967295
  %urva837 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %idxprom835, i32 5
  %128 = load i32, ptr %urva837, align 4, !tbaa !46
  %sub838 = sub i32 %126, %128
  %vsz842 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %idxprom835, i32 1
  %129 = load i32, ptr %vsz842, align 4, !tbaa !41
  %cmp843.not = icmp eq i32 %sub838, %129
  br i1 %cmp843.not, label %if.end851, label %if.then845

if.then845:                                       ; preds = %land.lhs.true830
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.103) #14
  %130 = load ptr, ptr %ctx, align 8, !tbaa !14
  %tobool847.not = icmp eq ptr %130, null
  br i1 %tobool847.not, label %if.end850, label %if.then848

if.then848:                                       ; preds = %if.then845
  store ptr @.str.4, ptr %130, align 8, !tbaa !15
  br label %if.end850
...
if.end851:                                        ; preds = %land.lhs.true830, %if.else826
  %131 = load i32, ptr %arrayidx4327137, align 4, !tbaa !38
  %spec.select7065 = call i32 @llvm.umin.i32(i32 %131, i32 %min.07374)
  %132 = load i32, ptr %rsz, align 4, !tbaa !43
  %add868 = add i32 %132, %131
...
for.inc881:                                       ; preds = %if.end851, %if.end815
  ...
  %min.2 = phi i32 [ %124, %if.end815 ], [ %spec.select7065, %if.end851 ]
  %indvars.iv.next7467 = add nuw nsw i64 %indvars.iv7466, 1
  %exitcond7470.not = icmp eq i64 %indvars.iv.next7467, %wide.trip.count7469
  br i1 %exitcond7470.not, label %for.end883, label %for.body413, !llvm.loop !57
...
if.then888:                                       ; preds = %for.end883
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.104) #14
  call void @free(ptr noundef %call341) #14
  %134 = load i32, ptr %options271, align 8, !tbaa !11
  %and890 = and i32 %134, 64
  %tobool891.not = icmp eq i32 %and890, 0
  br i1 %tobool891.not, label %cleanup4880, label %if.then892

if.then892:                                       ; preds = %if.then888
  %135 = load ptr, ptr %ctx, align 8, !tbaa !14
  %tobool894.not = icmp eq ptr %135, null
  br i1 %tobool894.not, label %cleanup4880, label %if.then895

if.then895:                                       ; preds = %if.then892
  store ptr @.str.4, ptr %135, align 8, !tbaa !15
  br label %cleanup4880

if.end899:                                        ; preds = %for.end883
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.105, i32 noundef %call884, i32 noundef %call884) #14
...
if.end902:                                        ; preds = %if.end899
  ...
  %call904 = call i64 @lseek(i32 noundef %desc, i64 noundef %conv903, i32 noundef 0) #14
  %call906 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %epbuff, i32 noundef 4096) #14
  %136 = load i32, ptr %options271, align 8, !tbaa !11
  %and908 = and i32 %136, 512
...
land.lhs.true910:                                 ; preds = %if.end902
  ...
  %137 = load ptr, ptr %dconf911, align 8, !tbaa !26
  %138 = load i32, ptr %137, align 4, !tbaa !27
  %and913 = and i32 %138, 1
...
land.lhs.true920:                                 ; preds = %land.lhs.true910
  ...
  %139 = load i32, ptr %raw925, align 4, !tbaa !42
  %cmp926 = icmp eq i32 %call884, %139
  br i1 %cmp926, label %if.then928, label %if.end961

if.then928:                                       ; preds = %land.lhs.true920
  %call930 = call ptr @cli_memstr(ptr noundef nonnull %epbuff, i32 noundef 4040, ptr noundef nonnull @.str.106, i32 noundef 15) #14
...
if.then955:                                       ; preds = %land.lhs.true947
  %140 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr @.str.107, ptr %140, align 8, !tbaa !15
  call void @free(ptr noundef nonnull %call341) #14
  br label %cleanup4880

if.end961:                                        ; preds = %if.then932, %land.lhs.true939, %land.lhs.true947, %if.then928, %land.lhs.true920, %land.lhs.true910, %if.end902
  %141 = load i32, ptr %options271, align 8, !tbaa !11
  %and963 = and i32 %141, 512
...
land.lhs.true965:                                 ; preds = %if.end961
  ...
  %142 = load ptr, ptr %dconf966, align 8, !tbaa !26
  %143 = load i32, ptr %142, align 4, !tbaa !27
  %and968 = and i32 %143, 2
...
land.lhs.true973:                                 ; preds = %land.lhs.true965
  ...
  %144 = load i32, ptr %rsz978, align 4, !tbaa !43
  %cmp987 = icmp ugt i32 %144, 4049
...
land.lhs.true989:                                 ; preds = %land.lhs.true973
  ...
  %145 = load i32, ptr %raw994, align 4, !tbaa !42
  %cmp995.not = icmp ult i32 %call884, %145
...
if.end1041.preheader:                             ; preds = %land.lhs.true1012
  call void @llvm.lifetime.start.p0(i64 12, ptr nonnull %kzs) #14
  ...
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.108) #14
  %add.ptr1034 = getelementptr inbounds i8, ptr %epbuff, i64 3
  br label %if.end1041

if.end1041:                                       ; preds = %if.end1041.preheader, %cleanup1184
  %148 = phi i8 [ %155, %cleanup1184 ], [ 0, %if.end1041.preheader ]
  ...
  %149 = load i8, ptr %kzcode.07388, align 1, !tbaa !25
  %dec = add nsw i32 %kzlen.07384, -1
  switch i8 %148, label %cleanup1184 [
...
sw.bb1043:                                        ; preds = %if.end1041, %if.end1041
  switch i8 %149, label %sw.default1081 [
...
if.then1056:                                      ; preds = %land.lhs.true1052
  ...
  %sub1059 = add nsw i8 %149, 72
  %incdec.ptr1061 = getelementptr inbounds i8, ptr %kzstate.07389, i64 1
  %conv1062 = zext i8 %sub1059 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.109, i32 noundef %conv1062) #14
  br label %sw.bb1064
...
sw.bb1064:                                        ; preds = %sw.bb1048, %land.lhs.true1052, %if.then1056, %sw.bb1043, %sw.bb1043, %sw.bb1043, %sw.bb1043, %sw.bb1043, %sw.bb1043, %sw.bb1043
  ...
  %op.1 = phi i8 [ %149, %sw.bb1043 ], [ %149, %sw.bb1043 ], [ %149, %sw.bb1043 ], [ %149, %sw.bb1043 ], [ %149, %sw.bb1043 ], [ %149, %sw.bb1043 ], [ %149, %sw.bb1043 ], [ 4, %if.then1056 ], [ %149, %land.lhs.true1052 ], [ %149, %sw.bb1048 ]
  ...
  %150 = and i8 %op.1, 7
  %cmp1070.not = icmp eq i8 %150, %kzdptr.07387
  %cmp1075.not = icmp eq i8 %150, %kzdsize.2
...
if.then1118:                                      ; preds = %land.lhs.true1111
  ...
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.110, i32 noundef %conv1115) #14
  br label %cleanup1184
...
sw.bb1130:                                        ; preds = %sw.bb1123, %if.end1041
  ...
  %cmp1132 = icmp eq i8 %149, -128
  br i1 %cmp1132, label %land.lhs.true1134, label %if.else1144

land.lhs.true1134:                                ; preds = %sw.bb1130
  %152 = load i8, ptr %incdec.ptr, align 1, !tbaa !25
  %conv1135 = zext i8 %152 to i32
...
if.else1144:                                      ; preds = %land.lhs.true1134, %sw.bb1130
  store i8 8, ptr %kzstate.5, align 1, !tbaa !25
  br label %cleanup1184

sw.bb1146:                                        ; preds = %if.end1041
  %conv1147 = zext i8 %149 to i32
...
land.lhs.true1162:                                ; preds = %sw.bb1156
  %153 = load i8, ptr %incdec.ptr, align 1, !tbaa !25
  %cmp1164 = icmp eq i8 %153, 117
...
land.lhs.true1166:                                ; preds = %land.lhs.true1162
  ...
  %154 = load i8, ptr %arrayidx1167, align 1, !tbaa !25
  %conv1168 = sext i8 %154 to i32
...
if.end1181:                                       ; preds = %land.lhs.true1166, %land.lhs.true1162, %sw.bb1156
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.112) #14
...
cleanup1184:                                      ; preds = %if.end1041, %if.end1181, %if.else1104, %if.then1095, %if.else1121, %if.then1118, %sw.bb1123, %if.else1144, %if.then1140, %if.else1154, %if.then1152, %sw.default1081, %if.then1077, %sw.bb1045
  ...
  %155 = load i8, ptr %kzstate.7, align 1, !tbaa !25
  %cmp1036.not = icmp eq i8 %155, 8
...
cleanup1187:                                      ; preds = %land.lhs.true1166
  %156 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr @.str.111, ptr %156, align 8, !tbaa !15
  call void @free(ptr noundef %call341) #14
  call void @llvm.lifetime.end.p0(i64 12, ptr nonnull %kzs) #14
  br label %cleanup4880

if.end1197:                                       ; preds = %cleanup1184
  call void @llvm.lifetime.end.p0(i64 12, ptr nonnull %kzs) #14
  %.pre7528 = load i32, ptr %options271, align 8, !tbaa !11
  %.pre7535 = and i32 %.pre7528, 512
  %tobool1200.not = icmp eq i32 %.pre7535, 0
...
land.lhs.true1201:                                ; preds = %land.lhs.true965, %land.lhs.true973, %land.lhs.true989, %land.lhs.true997, %land.lhs.true1012, %if.end1197
  ...
  %157 = load ptr, ptr %dconf1202, align 8, !tbaa !26
  %158 = load i32, ptr %157, align 4, !tbaa !27
  %and1204 = and i32 %158, 4
  %tobool1205 = icmp ne i32 %and1204, 0
  %or.cond4955.not7059 = and i1 %tobool47.not, %tobool1205
  %cmp1210 = icmp ugt i16 %8, 1
  %or.cond4956 = select i1 %or.cond4955.not7059, i1 %cmp1210, i1 false
...
land.lhs.true1212:                                ; preds = %land.lhs.true1201
  ...
  %159 = load i32, ptr %chr1217, align 4, !tbaa !45
...
if.then1220:                                      ; preds = %land.lhs.true1212
  ...
  %or.cond4957 = select i1 %cmp1245, i1 %cmp1248, i1 false
...
if.then1254:                                      ; preds = %if.then1220
  ...
  %163 = load i32, ptr %raw1265, align 4, !tbaa !42
  %164 = call i32 @llvm.usub.sat.i32(i32 %spec.select7069, i32 28672)
  %sub1267 = add i32 %163, %164
  %conv1268 = zext i32 %sub1267 to i64
  %call1269 = call i64 @lseek(i32 noundef %desc, i64 noundef %conv1268, i32 noundef 0) #14
  %call1271 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %buff, i32 noundef 4096) #14
  %cmp1272 = icmp eq i32 %call1271, 4096
  br i1 %cmp1272, label %if.then1274, label %while.cond1339

if.then1274:                                      ; preds = %if.then1254
  %call1276 = call ptr @cli_memstr(ptr noundef nonnull %buff, i32 noundef 4091, ptr noundef nonnull @.str.113, i32 noundef 5) #14
...
if.then1278:                                      ; preds = %if.then1274
  ...
  %165 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr %cond1280, ptr %165, align 8, !tbaa !15
  call void @free(ptr noundef nonnull %call341) #14
  br label %cleanup4880
...
if.else1287:                                      ; preds = %if.then1220
  ...
  %or.cond4958 = select i1 %cmp1288, i1 %cmp1291, i1 false
  %cmp1295 = icmp eq i32 %and1251, 237
  %or.cond7071 = select i1 %or.cond4958, i1 %cmp1295, i1 false
...
if.then1297:                                      ; preds = %if.else1287
  ...
  %166 = load i32, ptr %raw1309, align 4, !tbaa !42
  %167 = call i32 @llvm.usub.sat.i32(i32 %spec.select7069, i32 32768)
  %sub1311 = add i32 %166, %167
  %conv1312 = zext i32 %sub1311 to i64
  %call1313 = call i64 @lseek(i32 noundef %desc, i64 noundef %conv1312, i32 noundef 0) #14
  %call1315 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %buff, i32 noundef 4096) #14
  %cmp1316 = icmp eq i32 %call1315, 4096
  br i1 %cmp1316, label %if.then1318, label %while.cond1339

if.then1318:                                      ; preds = %if.then1297
  %call1320 = call ptr @cli_memstr(ptr noundef nonnull %buff, i32 noundef 4091, ptr noundef nonnull @.str.116, i32 noundef 5) #14
...
if.then1322:                                      ; preds = %if.then1318
  ...
  %168 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr %cond1324, ptr %168, align 8, !tbaa !15
  call void @free(ptr noundef nonnull %call341) #14
  br label %cleanup4880
...
while.cond1339:                                   ; preds = %if.end961, %if.then1318, %if.then1297, %if.then1274, %if.then1254, %if.else1287, %if.end1197, %land.lhs.true1201, %land.lhs.true1212
  ...
  %or.cond4959.not7053 = and i1 %tobool47.not, %tobool1341
  %cmp1346 = icmp ugt i16 %8, 2
  %or.cond4960 = select i1 %or.cond4959.not7053, i1 %cmp1346, i1 false
  %cmp1350 = icmp ult i16 %8, 13
  %or.cond4961 = select i1 %or.cond4960, i1 %cmp1350, i1 false
  %169 = load i32, ptr %e_lfanew, align 4
  %cmp1353 = icmp ult i32 %169, 2049
...
land.lhs.true1355:                                ; preds = %while.cond1339
  %170 = load i16, ptr %Subsystem, align 4, !tbaa !25
  %171 = and i16 %170, -2
  %or.cond4963 = icmp eq i16 %171, 2
  %172 = load i16, ptr %Machine, align 4
  %cmp1368 = icmp eq i16 %172, 332
  ...
  %173 = load i32, ptr %SizeOfStackReserve, align 8
  %cmp1371 = icmp ugt i32 %173, 524287
...
while.body1374:                                   ; preds = %land.lhs.true1355
  ...
  %174 = load i32, ptr %rsz1376, align 4, !tbaa !43
  %cmp1377 = icmp ugt i32 %174, 184549376
...
if.end1385:                                       ; preds = %if.end1380
  %175 = load i32, ptr %rsz1376, align 4, !tbaa !43
  %conv1388 = zext i32 %175 to i64
  %call1389 = call ptr @cli_malloc(i64 noundef %conv1388) #14
...
if.end1392:                                       ; preds = %if.end1385
  %176 = load i32, ptr %rsz1376, align 4, !tbaa !43
  %call1395 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %call1389, i32 noundef %176) #14
  %177 = load i32, ptr %rsz1376, align 4, !tbaa !43
  %cmp1398.not = icmp eq i32 %call1395, %177
...
for.body1408:                                     ; preds = %for.body1408.lr.ph, %for.inc1511
  %178 = phi i32 [ %call1395, %for.body1408.lr.ph ], [ %189, %for.inc1511 ]
  %indvars.iv7476 = phi i64 [ 0, %for.body1408.lr.ph ], [ %indvars.iv.next7477.pre-phi, %for.inc1511 ]
  ...
  %arrayidx1410 = getelementptr inbounds i8, ptr %call1389, i64 %indvars.iv7476
  %179 = load i8, ptr %arrayidx1410, align 1, !tbaa !25
  %180 = and i8 %179, -2
  %cmp1415.not = icmp eq i8 %180, -24
...
for.body1408.for.inc1511_crit_edge:               ; preds = %for.body1408
  %.pre7541 = add nuw nsw i64 %indvars.iv7476, 1
  br label %for.inc1511

if.end1418:                                       ; preds = %for.body1408
  %181 = load i32, ptr %call341, align 4, !tbaa !38
  %182 = add nuw nsw i64 %indvars.iv7476, 1
  %arrayidx1425 = getelementptr inbounds i8, ptr %call1389, i64 %182
  %arrayidx1425.val = load i32, ptr %arrayidx1425, align 1
  %183 = trunc i64 %indvars.iv7476 to i32
  %add1421 = add i32 %183, 5
  %add1422 = add i32 %add1421, %181
  ...
  %184 = load i32, ptr %err, align 4, !tbaa !5
  %tobool1429.not = icmp eq i32 %184, 0
  br i1 %tobool1429.not, label %lor.lhs.false1430, label %for.inc1511

lor.lhs.false1430:                                ; preds = %if.end1418
  %185 = load i32, ptr %rsz1433, align 4, !tbaa !43
  %cmp1440 = icmp ugt i32 %185, 8
  br i1 %cmp1440, label %land.lhs.true1442, label %for.inc1511

land.lhs.true1442:                                ; preds = %lor.lhs.false1430
  %186 = load i32, ptr %raw1445, align 4, !tbaa !42
  %cmp1446.not = icmp ult i32 %call1428, %186
...
land.lhs.true1448:                                ; preds = %land.lhs.true1442
  ...
  %add1456 = add i32 %186, %185
  %cmp1457.not = icmp ule i32 %add1449, %add1456
  %cmp1464 = icmp ugt i32 %add1449, %186
...
for.end1513.thread:                               ; preds = %if.then1471
  call void @free(ptr noundef nonnull %call1389) #14
...
if.end1475:                                       ; preds = %if.then1471
  ...
  %call1479 = call ptr @cli_realloc2(ptr noundef %jumps.07397, i64 noundef %mul1478) #14
...
for.body1487.preheader:                           ; preds = %if.end1467, %if.end1483
  %jumps.17554 = phi ptr [ %call1479, %if.end1483 ], [ %jumps.07397, %if.end1467 ]
  %wide.trip.count7474 = zext i32 %xsjs.07398 to i64
  br label %for.body1487

for.body1487:                                     ; preds = %for.body1487.preheader, %for.inc1505
  %indvars.iv7471 = phi i64 [ 0, %for.body1487.preheader ], [ %indvars.iv.next7472, %for.inc1505 ]
  %jump.07391 = phi i32 [ %call1428, %for.body1487.preheader ], [ %jump.1, %for.inc1505 ]
  %arrayidx1489 = getelementptr inbounds i32, ptr %jumps.17554, i64 %indvars.iv7471
  %187 = load i32, ptr %arrayidx1489, align 4, !tbaa !5
  %cmp1490 = icmp ult i32 %187, %jump.07391
  br i1 %cmp1490, label %for.inc1505, label %if.end1493

if.end1493:                                       ; preds = %for.body1487
  %cmp1496 = icmp eq i32 %187, %jump.07391
  br i1 %cmp1496, label %if.then1498, label %if.end1500

if.then1498:                                      ; preds = %if.end1493
  %188 = trunc i64 %indvars.iv7471 to i32
...
for.inc1505:                                      ; preds = %for.body1487, %if.end1500
  %jump.1 = phi i32 [ %jump.07391, %for.body1487 ], [ %187, %if.end1500 ]
  %indvars.iv.next7472 = add nuw nsw i64 %indvars.iv7471, 1
  %exitcond7475.not = icmp eq i64 %indvars.iv.next7472, %wide.trip.count7474
  br i1 %exitcond7475.not, label %for.end1507, label %for.body1487, !llvm.loop !58

for.end1507:                                      ; preds = %for.inc1505, %if.end1483, %if.then1498
  %jumps.17555 = phi ptr [ %jumps.17554, %if.then1498 ], [ %call1479, %if.end1483 ], [ %jumps.17554, %for.inc1505 ]
  %jump.07335 = phi i32 [ %jump.07391, %if.then1498 ], [ %call1428, %if.end1483 ], [ %jump.1, %for.inc1505 ]
  %j.17333 = phi i32 [ %188, %if.then1498 ], [ 0, %if.end1483 ], [ %xsjs.07398, %for.inc1505 ]
  %xsjs.1 = phi i32 [ %dec1499, %if.then1498 ], [ 0, %if.end1483 ], [ %xsjs.07398, %for.inc1505 ]
  %idxprom1508 = zext i32 %j.17333 to i64
  %arrayidx1509 = getelementptr inbounds i32, ptr %jumps.17555, i64 %idxprom1508
  store i32 %jump.07335, ptr %arrayidx1509, align 4, !tbaa !5
  %inc1510 = add i32 %xsjs.1, 1
  %.pre7529 = load i32, ptr %rsz1376, align 4, !tbaa !43
  br label %for.inc1511
...
for.inc1511:                                      ; preds = %for.body1408.for.inc1511_crit_edge, %if.end1418, %lor.lhs.false1430, %land.lhs.true1442, %land.lhs.true1448, %for.end1507
  %indvars.iv.next7477.pre-phi = phi i64 [ %.pre7541, %for.body1408.for.inc1511_crit_edge ], [ %182, %if.end1418 ], [ %182, %lor.lhs.false1430 ], [ %182, %land.lhs.true1442 ], [ %182, %land.lhs.true1448 ], [ %182, %for.end1507 ]
  %189 = phi i32 [ %178, %for.body1408.for.inc1511_crit_edge ], [ %178, %if.end1418 ], [ %178, %lor.lhs.false1430 ], [ %178, %land.lhs.true1442 ], [ %178, %land.lhs.true1448 ], [ %.pre7529, %for.end1507 ]
  %jumps.2 = phi ptr [ %jumps.07397, %for.body1408.for.inc1511_crit_edge ], [ %jumps.07397, %if.end1418 ], [ %jumps.07397, %lor.lhs.false1430 ], [ %jumps.07397, %land.lhs.true1442 ], [ %jumps.07397, %land.lhs.true1448 ], [ %jumps.17555, %for.end1507 ]
  ...
  %sub1405 = add i32 %189, -5
  %190 = zext i32 %sub1405 to i64
  %cmp1406 = icmp ult i64 %indvars.iv.next7477.pre-phi, %190
  br i1 %cmp1406, label %for.body1408, label %for.end1513, !llvm.loop !59

for.end1513:                                      ; preds = %for.inc1511
  %191 = trunc i64 %indvars.iv.next7477.pre-phi to i32
  call void @free(ptr noundef %call1389) #14
...
for.body1520.lr.ph:                               ; preds = %for.end1513, %for.end1513.thread
  ...
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.119, i32 noundef %xsjs.07340) #14
  ...
  %wide.trip.count7483 = zext i32 %xsjs.07340 to i64
  br label %for.body1520

for.body1520:                                     ; preds = %for.body1520.lr.ph, %for.inc1560
  %indvars.iv7480 = phi i64 [ 0, %for.body1520.lr.ph ], [ %indvars.iv.next7481, %for.inc1560 ]
  %arrayidx1522 = getelementptr inbounds i32, ptr %jumps.07343, i64 %indvars.iv7480
  %192 = load i32, ptr %arrayidx1522, align 4, !tbaa !5
  %conv1523 = zext i32 %192 to i64
  %call1524 = call i64 @lseek(i32 noundef %desc, i64 noundef %conv1523, i32 noundef 0) #14
  %call1526 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %buff, i32 noundef 9) #14
...
lor.lhs.false1535:                                ; preds = %if.end1530
  %193 = load i8, ptr %arrayidx1536, align 4, !tbaa !25
  %cmp1538 = icmp eq i8 %193, -20
...
land.lhs.true1540:                                ; preds = %lor.lhs.false1535
  ...
  %194 = load i8, ptr %arrayidx1544, align 2
  %cmp1546 = icmp eq i8 %194, 96
...
lor.lhs.false1548:                                ; preds = %land.lhs.true1540
  ...
  %195 = load i8, ptr %arrayidx1552, align 1
  %tobool1553 = icmp ne i8 %195, 0
  %or.cond4966 = select i1 %cmp1549, i1 true, i1 %tobool1553
  %196 = load i8, ptr %arrayidx1555, align 8
  %tobool1556 = icmp ne i8 %196, 0
...
if.then1557:                                      ; preds = %lor.lhs.false1548, %land.lhs.true1540, %if.end1530
  %197 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr @.str.120, ptr %197, align 8, !tbaa !15
  call void @free(ptr noundef nonnull %jumps.07343) #14
  call void @free(ptr noundef %call341) #14
  br label %cleanup4880

for.inc1560:                                      ; preds = %lor.lhs.false1535, %lor.lhs.false1548, %for.body1520
  %indvars.iv.next7481 = add nuw nsw i64 %indvars.iv7480, 1
  %exitcond7484.not = icmp eq i64 %indvars.iv.next7481, %wide.trip.count7483
  br i1 %exitcond7484.not, label %while.end1569.sink.split, label %for.body1520, !llvm.loop !60
...
while.end1569.sink.split:                         ; preds = %for.inc1560, %for.cond1402.preheader
  ...
  call void @free(ptr noundef nonnull %call1389.sink) #14
...
while.end1569:                                    ; preds = %while.end1569.sink.split, %for.end1513, %if.end1380, %while.body1374, %while.cond1339, %land.lhs.true1355
  %i.5 = phi i32 [ %conv88, %land.lhs.true1355 ], [ %conv88, %while.cond1339 ], [ %191, %for.end1513 ], [ %conv88, %if.end1380 ], [ %conv88, %while.body1374 ], [ %i.5.ph, %while.end1569.sink.split ]
  %dconf1570 = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 9
  %198 = load ptr, ptr %dconf1570, align 8, !tbaa !26
  %199 = load i32, ptr %198, align 4, !tbaa !27
  %and1572 = and i32 %199, 8288
...
for.body1580.preheader:                           ; preds = %for.cond1575.preheader
  %200 = add nsw i32 %conv88, -1
  %wide.trip.count7489 = zext i32 %sub1577 to i64
  br label %for.body1580

for.body1580:                                     ; preds = %for.body1580.preheader, %for.inc1604
  %indvars.iv7485 = phi i64 [ 0, %for.body1580.preheader ], [ %indvars.iv.next7486, %for.inc1604 ]
  %rsz1583 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7485, i32 3
  %201 = load i32, ptr %rsz1583, align 4, !tbaa !43
  %tobool1584.not = icmp eq i32 %201, 0
  br i1 %tobool1584.not, label %land.lhs.true1585, label %for.inc1604

land.lhs.true1585:                                ; preds = %for.body1580
  %vsz1588 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7485, i32 1
  %202 = load i32, ptr %vsz1588, align 4, !tbaa !41
  %tobool1589.not = icmp eq i32 %202, 0
  br i1 %tobool1589.not, label %for.inc1604, label %land.lhs.true1590

land.lhs.true1590:                                ; preds = %land.lhs.true1585
  %203 = add nuw nsw i64 %indvars.iv7485, 1
  %rsz1594 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %203, i32 3
  %204 = load i32, ptr %rsz1594, align 4, !tbaa !43
  %tobool1595.not = icmp eq i32 %204, 0
  br i1 %tobool1595.not, label %for.inc1604, label %land.lhs.true1596

land.lhs.true1596:                                ; preds = %land.lhs.true1590
  %vsz1600 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %203, i32 1
  %205 = load i32, ptr %vsz1600, align 4, !tbaa !41
  %tobool1601.not = icmp eq i32 %205, 0
...
for.inc1604:                                      ; preds = %for.body1580, %land.lhs.true1585, %land.lhs.true1590, %land.lhs.true1596
  %indvars.iv.next7486 = add nuw nsw i64 %indvars.iv7485, 1
  %exitcond7490.not = icmp eq i64 %indvars.iv.next7486, %wide.trip.count7489
  br i1 %exitcond7490.not, label %if.end1943, label %for.body1580, !llvm.loop !61

land.lhs.true1609:                                ; preds = %land.lhs.true1596
  %206 = trunc i64 %indvars.iv7485 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.121) #14
  %207 = load ptr, ptr %dconf1570, align 8, !tbaa !26
  %208 = load i32, ptr %207, align 4, !tbaa !27
  %and1612 = and i32 %208, 8192
  %tobool1613 = icmp ne i32 %and1612, 0
  %cmp1615 = icmp ugt i32 %call906, 15
  %or.cond4968 = select i1 %tobool1613, i1 %cmp1615, i1 false
  %209 = load i8, ptr %epbuff, align 16
  %cmp1620 = icmp eq i8 %209, -23
...
while.body1633:                                   ; preds = %if.then1622, %if.then1622
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.122, i32 noundef %add.ptr1624.val7115, i32 noundef %vep.0, i32 noundef %add1627) #14
  %conv1642 = zext i32 %add1627 to i64
  %call1643 = call i64 @lseek(i32 noundef %desc, i64 noundef %conv1642, i32 noundef 0) #14
  %cmp1644 = icmp eq i64 %call1643, -1
  br i1 %cmp1644, label %if.then1646, label %if.end1647

if.then1646:                                      ; preds = %while.body1633
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.123) #14
  call void @free(ptr noundef nonnull %call341) #14
  br label %cleanup4880

if.end1647:                                       ; preds = %while.body1633
  %call1649 = call i64 @read(i32 noundef %desc, ptr noundef nonnull %buff, i64 noundef 176) #14
  %cmp1650.not = icmp eq i64 %call1649, 176
  br i1 %cmp1650.not, label %if.end1653, label %if.then1652

if.then1652:                                      ; preds = %if.end1647
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.124, i32 noundef %add1627, i32 noundef %add1627, i64 noundef %call1649) #14
  br label %if.end1943

if.end1653:                                       ; preds = %if.end1647
  %.str.125..str.126 = select i1 %cmp1629, ptr @.str.125, ptr @.str.126
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull %.str.125..str.126) #14
  ...
  %210 = load i32, ptr %ImageBase, align 4, !tbaa !25
  %sub1662 = sub i32 %add.ptr1660.val, %210
  %add1663 = add nuw i64 %indvars.iv7485, 1
  ...
  %211 = load i32, ptr %arrayidx1665, align 4, !tbaa !38
  %cmp1667.not = icmp ugt i32 %sub1662, %211
...
lor.lhs.false1669:                                ; preds = %if.end1653
  ...
  %212 = load i32, ptr %raw1677, align 4, !tbaa !42
  %add1678 = add i32 %211, -4
  %sub1679 = add i32 %add1678, %212
...
if.then1682:                                      ; preds = %lor.lhs.false1669, %if.end1653
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.127) #14
  br label %if.end1943

if.end1683:                                       ; preds = %lor.lhs.false1669
  %sub1688 = sub i32 %sub1662, %211
...
if.end1695:                                       ; preds = %if.end1683
  ...
  %213 = load i32, ptr %vsz1699, align 4, !tbaa !41
  %idxprom1700 = and i64 %indvars.iv7485, 4294967295
  %vsz1702 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %idxprom1700, i32 1
  %214 = load i32, ptr %vsz1702, align 4, !tbaa !41
  store i32 %214, ptr %dsize, align 4, !tbaa !5
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.128, i32 noundef %213, i32 noundef %214, i32 noundef %sub1688) #14
  %limits = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 4
  %215 = load ptr, ptr %limits, align 8, !tbaa !62
  %tobool1703.not = icmp eq ptr %215, null
  br i1 %tobool1703.not, label %if.end1788, label %land.lhs.true1704

land.lhs.true1704:                                ; preds = %if.end1695
  %maxfilesize = getelementptr inbounds %struct.cl_limits, ptr %215, i64 0, i32 5
  %216 = load i64, ptr %maxfilesize, align 8, !tbaa !63
  %tobool1706.not = icmp eq i64 %216, 0
  br i1 %tobool1706.not, label %if.end1788, label %land.lhs.true1707

land.lhs.true1707:                                ; preds = %land.lhs.true1704
  %217 = load i32, ptr %dsize, align 4, !tbaa !5
  %cond1713 = call i32 @llvm.umax.i32(i32 %213, i32 %217)
  %conv1714 = zext i32 %cond1713 to i64
  %cmp1717 = icmp ult i64 %216, %conv1714
  br i1 %cmp1717, label %if.then1719, label %land.lhs.true1741

if.then1719:                                      ; preds = %land.lhs.true1707
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.129, i32 noundef %cond1713, i64 noundef %216) #14
  call void @free(ptr noundef nonnull %call341) #14
  %218 = load i32, ptr %options271, align 8, !tbaa !11
  %and1729 = and i32 %218, 256
...
if.then1731:                                      ; preds = %if.then1719
  %219 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr @.str.130, ptr %219, align 8, !tbaa !15
  br label %cleanup4880

land.lhs.true1741:                                ; preds = %land.lhs.true1707
  %220 = load i32, ptr %dsize, align 4, !tbaa !5
  %add1742 = add i32 %220, %213
  %rsz1746 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %idxprom1664, i32 3
  %221 = load i32, ptr %rsz1746, align 4, !tbaa !43
  %add1742. = call i32 @llvm.umax.i32(i32 %add1742, i32 %221)
  %conv1758 = zext i32 %add1742. to i64
  %cmp1761 = icmp ult i64 %216, %conv1758
  br i1 %cmp1761, label %if.then1763, label %if.end1788

if.then1763:                                      ; preds = %land.lhs.true1741
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.129, i32 noundef %add1742., i64 noundef %216) #14
  call void @free(ptr noundef nonnull %call341) #14
  %222 = load i32, ptr %options271, align 8, !tbaa !11
  %and1783 = and i32 %222, 256
...
if.then1785:                                      ; preds = %if.then1763
  %223 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr @.str.130, ptr %223, align 8, !tbaa !15
  br label %cleanup4880

if.end1788:                                       ; preds = %land.lhs.true1704, %if.end1695, %land.lhs.true1741
  %224 = load i32, ptr %dsize, align 4, !tbaa !5
  %add1789 = add i32 %224, %213
  %conv1790 = zext i32 %add1789 to i64
  %call1791 = call ptr @cli_calloc(i64 noundef %conv1790, i64 noundef 1) #14
...
if.end1794:                                       ; preds = %if.end1788
  ...
  %225 = load i32, ptr %rsz1798, align 4, !tbaa !43
  %add1799 = add i32 %sub1688, 12
  %cmp1800 = icmp ult i32 %225, %add1799
  %cmp1807 = icmp ugt i32 %225, %213
  %or.cond7074 = or i1 %cmp1800, %cmp1807
  br i1 %or.cond7074, label %if.then1809, label %if.end1814

if.then1809:                                      ; preds = %if.end1794
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.131, i32 noundef %225) #14
  call void @free(ptr noundef nonnull %call1791) #14
  br label %if.end1943

if.end1814:                                       ; preds = %if.end1794
  %226 = load i32, ptr %dsize, align 4, !tbaa !5
  %idx.ext1815 = zext i32 %226 to i64
  %add.ptr1816 = getelementptr inbounds i8, ptr %call1791, i64 %idx.ext1815
  %conv1821 = zext i32 %225 to i64
  %call1822 = call i64 @read(i32 noundef %desc, ptr noundef nonnull %add.ptr1816, i64 noundef %conv1821) #14
  %227 = load i32, ptr %rsz1798, align 4, !tbaa !43
  %conv1827 = zext i32 %227 to i64
...
if.then1830:                                      ; preds = %if.end1814
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.132, i32 noundef %227, i64 noundef %call1822) #14
  call void @free(ptr noundef nonnull %call341) #14
  call void @free(ptr noundef nonnull %call1791) #14
  br label %cleanup4880

if.end1835:                                       ; preds = %if.end1814
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.133, i64 noundef %call1822, i64 noundef %call1822) #14
  %arrayidx1836 = getelementptr inbounds [4096 x i8], ptr %buff, i64 0, i64 123
  %228 = load i8, ptr %arrayidx1836, align 1, !tbaa !25
  %cmp1838 = icmp eq i8 %228, -24
...
if.then1840:                                      ; preds = %if.end1835
  ...
  %229 = load i32, ptr %vsz1842, align 4, !tbaa !41
  %switch7104 = icmp ult i32 %229, 4
...
land.lhs.true1850:                                ; preds = %if.then1840
  ...
  %230 = load i32, ptr %arrayidx1841, align 4, !tbaa !38
  %cmp1858.not = icmp ult i32 %add1855, %230
...
land.lhs.true1860:                                ; preds = %land.lhs.true1850
  ...
  %add1871 = add i32 %230, %229
  %cmp1872.not = icmp ule i32 %add1866, %add1871
  %cmp1883 = icmp ugt i32 %add1866, %230
...
if.end1900:                                       ; preds = %if.end1896
  %call1901 = call i32 (ptr, i32, ...) @open(ptr noundef nonnull %call1897, i32 noundef 578, i32 noundef 448) #14
  %cmp1902 = icmp slt i32 %call1901, 0
  br i1 %cmp1902, label %if.then1904, label %if.end1905

if.then1904:                                      ; preds = %if.end1900
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.135, ptr noundef nonnull %call1897) #14
  call void @free(ptr noundef nonnull %call1897) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call1791, ptr noundef nonnull %call341, i32 noundef 0)
  br label %cleanup4880

if.end1905:                                       ; preds = %if.end1900
  %232 = load i32, ptr %dsize, align 4, !tbaa !5
  %233 = load i32, ptr %ImageBase, align 4, !tbaa !25
  %234 = load i32, ptr %call341, align 4, !tbaa !38
  %call1909 = call i32 @unmew11(i32 noundef %206, ptr noundef nonnull %call1791, i32 noundef %sub1688, i32 noundef %213, i32 noundef %232, i32 noundef %233, i32 noundef %234, i32 noundef %uselzma.0, ptr noundef null, ptr noundef null, i32 noundef %call1901) #14
  %cond4936 = icmp eq i32 %call1909, 1
  br i1 %cond4936, label %sw.bb1910, label %sw.default1932

sw.bb1910:                                        ; preds = %if.end1905
  %235 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool1911.not = icmp eq i8 %235, 0
  br i1 %tobool1911.not, label %if.else1913, label %if.then1912

if.then1912:                                      ; preds = %sw.bb1910
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.136, ptr noundef nonnull %call1897) #14
  br label %if.end1914

if.else1913:                                      ; preds = %sw.bb1910
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.137) #14
  br label %if.end1914

if.end1914:                                       ; preds = %if.else1913, %if.then1912
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call1791, i32 noundef 0)
  call void @free(ptr noundef nonnull %call341) #14
  %call1915 = call i32 @fsync(i32 noundef %call1901) #14
  %call1916 = call i64 @lseek(i32 noundef %call1901, i64 noundef 0, i32 noundef 0) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.138) #14
  %call1917 = call i32 @cli_magic_scandesc(i32 noundef %call1901, ptr noundef nonnull %ctx) #14
  %cmp1918 = icmp eq i32 %call1917, 1
  %call1921 = call i32 @close(i32 noundef %call1901) #14
  %236 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool1922.not = icmp eq i8 %236, 0
...
if.then1923:                                      ; preds = %if.then1920
  %call1924 = call i32 @unlink(ptr noundef nonnull %call1897) #14
  br label %if.end1925
...
if.then1929:                                      ; preds = %if.end1926
  %call1930 = call i32 @unlink(ptr noundef nonnull %call1897) #14
  br label %if.end1931
...
sw.default1932:                                   ; preds = %if.end1905
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.139) #14
  %call1933 = call i32 @close(i32 noundef %call1901) #14
  %call1934 = call i32 @unlink(ptr noundef nonnull %call1897) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call1791, i32 noundef 0)
  call void @free(ptr noundef nonnull %call1897) #14
  br label %if.end1943
...
if.end1943:                                       ; preds = %for.inc1604, %for.cond1575.preheader, %if.then1622, %sw.default1932, %if.then1885, %if.then1809, %if.then1682, %if.then1652, %while.end1569, %land.lhs.true1609
  %i.77174 = phi i32 [ %206, %land.lhs.true1609 ], [ %i.5, %while.end1569 ], [ %206, %if.then1652 ], [ %206, %if.then1682 ], [ %206, %if.then1809 ], [ %206, %if.then1885 ], [ %206, %sw.default1932 ], [ %206, %if.then1622 ], [ 0, %for.cond1575.preheader ], [ %200, %for.inc1604 ]
...
while.cond1952:                                   ; preds = %if.end1947
  ...
  %or.cond4971 = select i1 %tobool1950, i1 %cmp1956, i1 false
  br i1 %or.cond4971, label %land.lhs.true1958, label %lor.rhs2004

land.lhs.true1958:                                ; preds = %while.cond1952
  %237 = load i8, ptr %epbuff, align 16, !tbaa !25
  %cmp1961 = icmp eq i8 %237, -66
...
land.lhs.true1986:                                ; preds = %land.lhs.true1963
  %cmp1997 = icmp eq i8 %239, -1
  %or.cond4974 = select i1 %cmp1969, i1 %cmp1997, i1 false
  %cmp2002 = icmp eq i8 %240, 54
...
lor.rhs2004:                                      ; preds = %while.cond1952
  ...
  %or.cond4976 = select i1 %tobool2005, i1 %cmp2008, i1 false
  br i1 %or.cond4976, label %land.rhs2010, label %while.cond2299

land.rhs2010:                                     ; preds = %lor.rhs2004
  %241 = load i8, ptr %epbuff, align 16, !tbaa !25
  %cmp2013 = icmp eq i8 %241, 96
  %arrayidx2016 = getelementptr inbounds [4096 x i8], ptr %epbuff, i64 0, i64 1
  %242 = load i8, ptr %arrayidx2016, align 1
  %cmp2018 = icmp eq i8 %242, -24
...
land.lhs.true2031:                                ; preds = %lor.rhs2026
  ...
  %243 = load i32, ptr %ImageBase2035, align 4, !tbaa !25
  %sub2036 = sub i32 %add.ptr2033.val7110, %243
...
land.lhs.true2039:                                ; preds = %land.lhs.true2031
  ...
  %246 = load i8, ptr %arrayidx2058, align 1
  %cmp2060 = icmp eq i8 %246, -8
...
if.then2072:                                      ; preds = %land.lhs.true1963, %land.lhs.true1986
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.140) #14
  %vsz20687185 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 0, i32 1
  %247 = load i32, ptr %vsz20687185, align 4, !tbaa !41
  ...
  %248 = load i32, ptr %vsz20707187, align 4, !tbaa !41
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.141) #14
  %vsz2074 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 2, i32 1
  %249 = load i32, ptr %vsz2074, align 4, !tbaa !41
  %ursz2076 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 0, i32 8
  %250 = load i32, ptr %ursz2076, align 4, !tbaa !49
  %uraw2078 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 0, i32 7
  %251 = load i32, ptr %uraw2078, align 4, !tbaa !48
  %add2079 = add i32 %251, %250
  %252 = load i32, ptr %call341, align 4, !tbaa !38
  %253 = load i32, ptr %ImageBase1967, align 4, !tbaa !25
  %add2085 = add i32 %253, %252
  br label %if.end2096
...
if.else2086:                                      ; preds = %land.lhs.true2039, %land.lhs.true2020
  ...
  %254 = load i32, ptr %vsz2068, align 4, !tbaa !41
  ...
  %255 = load i32, ptr %vsz2070, align 4, !tbaa !41
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.142) #14
  %256 = load i32, ptr %arrayidx2069, align 4, !tbaa !38
  %uraw2090 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 1, i32 7
  %257 = load i32, ptr %uraw2090, align 4, !tbaa !48
  %sub2095 = sub i32 %256, %257
  br label %if.end2096

if.end2096:                                       ; preds = %if.else2086, %if.then2072
  %258 = phi i32 [ %248, %if.then2072 ], [ %255, %if.else2086 ]
  %arrayidx20697188 = phi ptr [ %arrayidx20697186, %if.then2072 ], [ %arrayidx2069, %if.else2086 ]
  %259 = phi i32 [ %247, %if.then2072 ], [ %254, %if.else2086 ]
  %vma.0 = phi i32 [ %add2085, %if.then2072 ], [ %sub2095, %if.else2086 ]
  %off.0 = phi i32 [ %252, %if.then2072 ], [ 0, %if.else2086 ]
  %c.0 = phi i32 [ %249, %if.then2072 ], [ %256, %if.else2086 ]
  %ssize.0 = phi i32 [ %add2079, %if.then2072 ], [ %257, %if.else2086 ]
  %add2097 = add nsw i32 %259, %258
  ...
  %260 = load ptr, ptr %limits2099, align 8, !tbaa !62
  %tobool2100.not = icmp eq ptr %260, null
  br i1 %tobool2100.not, label %if.end2164, label %land.lhs.true2101

land.lhs.true2101:                                ; preds = %if.end2096
  %maxfilesize2103 = getelementptr inbounds %struct.cl_limits, ptr %260, i64 0, i32 5
  %261 = load i64, ptr %maxfilesize2103, align 8, !tbaa !63
  %tobool2104.not = icmp eq i64 %261, 0
...
land.lhs.true2105:                                ; preds = %land.lhs.true2101
  ...
  %262 = load i32, ptr %ursz2113, align 4, !tbaa !49
  %cond2111. = call i32 @llvm.umax.i32(i32 %cond2111, i32 %262)
  %conv2128 = zext i32 %cond2111. to i64
  %cmp2131 = icmp ult i64 %261, %conv2128
  br i1 %cmp2131, label %if.then2133, label %if.end2164

if.then2133:                                      ; preds = %land.lhs.true2105
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.143, i32 noundef %cond2111., i64 noundef %261) #14
  call void @free(ptr noundef nonnull %call341) #14
  %263 = load i32, ptr %options271, align 8, !tbaa !11
  %and2159 = and i32 %263, 256
...
if.then2161:                                      ; preds = %if.then2133
  %264 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr @.str.144, ptr %264, align 8, !tbaa !15
  br label %cleanup4880

if.end2164:                                       ; preds = %land.lhs.true2105, %land.lhs.true2101, %if.end2096
  %265 = load i32, ptr %arrayidx20697188, align 4, !tbaa !38
  %sub2167 = sub i32 %265, %off.0
...
lor.lhs.false2170:                                ; preds = %if.end2164
  ...
  %266 = load i32, ptr %ursz2175, align 4, !tbaa !49
  %sub2176 = sub i32 %add2098, %266
...
land.lhs.true2181:                                ; preds = %lor.lhs.false2179
  ...
  %267 = load i32, ptr %arrayidx2182, align 4, !tbaa !38
  %268 = load i32, ptr %call341, align 4, !tbaa !38
  %sub2186 = sub i32 %267, %268
...
if.then2201:                                      ; preds = %lor.lhs.false2198, %land.lhs.true2181, %lor.lhs.false2170, %if.end2164
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.145) #14
  br label %while.cond2299

if.end2202:                                       ; preds = %land.lhs.true2181, %lor.lhs.false2198
  %conv2203 = zext i32 %add2098 to i64
  %call2204 = call ptr @cli_calloc(i64 noundef %conv2203, i64 noundef 1) #14
...
if.end2208:                                       ; preds = %if.end2202
  %call2209 = call i64 @lseek(i32 noundef %desc, i64 noundef 0, i32 noundef 0) #14
  %conv2210 = zext i32 %ssize.0 to i64
  %call2211 = call i64 @read(i32 noundef %desc, ptr noundef nonnull %call2204, i64 noundef %conv2210) #14
...
if.then2215:                                      ; preds = %if.end2208
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.146) #14
  call void @free(ptr noundef nonnull %call341) #14
  call void @free(ptr noundef nonnull %call2204) #14
  br label %cleanup4880
...
if.then2218:                                      ; preds = %if.end2216
  ...
  %269 = load i32, ptr %arrayidx2219, align 4, !tbaa !38
  %idx.ext2221 = zext i32 %269 to i64
  %add.ptr2222 = getelementptr inbounds i8, ptr %call2204, i64 %idx.ext2221
  %270 = load i32, ptr %call341, align 4, !tbaa !38
  %idx.ext2225 = zext i32 %270 to i64
...
if.end2228:                                       ; preds = %if.then2218, %if.end2216
  ...
  %271 = load i32, ptr %uraw2230, align 4, !tbaa !48
  %conv2231 = zext i32 %271 to i64
  %call2232 = call i64 @lseek(i32 noundef %desc, i64 noundef %conv2231, i32 noundef 0) #14
  %272 = load i32, ptr %arrayidx20697188, align 4, !tbaa !38
  %idx.ext2235 = zext i32 %272 to i64
  ...
  %273 = load i32, ptr %ursz2175, align 4, !tbaa !49
  %conv2242 = zext i32 %273 to i64
  %call2243 = call i64 @read(i32 noundef %desc, ptr noundef nonnull %add.ptr2239, i64 noundef %conv2242) #14
  %274 = load i32, ptr %ursz2175, align 4, !tbaa !49
  %conv2246 = zext i32 %274 to i64
...
if.then2249:                                      ; preds = %if.end2228
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.147) #14
  call void @free(ptr noundef nonnull %call341) #14
  call void @free(ptr noundef nonnull %call2204) #14
  br label %cleanup4880

if.end2250:                                       ; preds = %if.end2228
  %call2251 = call ptr @cli_gentemp(ptr noundef null) #14
...
if.end2254:                                       ; preds = %if.end2250
  %call2255 = call i32 (ptr, i32, ...) @open(ptr noundef nonnull %call2251, i32 noundef 578, i32 noundef 448) #14
  %cmp2256 = icmp slt i32 %call2255, 0
  br i1 %cmp2256, label %if.then2258, label %if.end2259

if.then2258:                                      ; preds = %if.end2254
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.148, ptr noundef nonnull %call2251) #14
  call void @free(ptr noundef nonnull %call2251) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call2204, ptr noundef nonnull %call341, i32 noundef 0)
  br label %cleanup4880

if.end2259:                                       ; preds = %if.end2254
  %275 = load i32, ptr %dsize, align 4, !tbaa !5
  %ImageBase2261 = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 9
  %276 = load i32, ptr %ImageBase2261, align 4, !tbaa !25
  %277 = load i32, ptr %call341, align 4, !tbaa !38
  %call2264 = call i32 @unupack(i32 noundef %upack.1, ptr noundef nonnull %call2204, i32 noundef %275, ptr noundef nonnull %epbuff, i32 noundef %vma.0, i32 noundef %call884, i32 noundef %276, i32 noundef %277, i32 noundef %call2255) #14
...
sw.bb2265:                                        ; preds = %if.end2259
  ...
  %tobool2266.not = icmp eq i8 %278, 0
  br i1 %tobool2266.not, label %if.else2268, label %if.then2267

if.then2267:                                      ; preds = %sw.bb2265
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.149, ptr noundef nonnull %call2251) #14
  br label %if.end2269
...
if.end2269:                                       ; preds = %if.else2268, %if.then2267
  ...
  call void @free(ptr noundef nonnull %call341) #14
  %call2270 = call i32 @fsync(i32 noundef %call2255) #14
  %call2271 = call i64 @lseek(i32 noundef %call2255, i64 noundef 0, i32 noundef 0) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.138) #14
  %call2272 = call i32 @cli_magic_scandesc(i32 noundef %call2255, ptr noundef nonnull %ctx) #14
  %cmp2273 = icmp eq i32 %call2272, 1
  %call2276 = call i32 @close(i32 noundef %call2255) #14
  %279 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool2277.not = icmp eq i8 %279, 0
...
if.then2278:                                      ; preds = %if.then2275
  %call2279 = call i32 @unlink(ptr noundef nonnull %call2251) #14
  br label %if.end2280
...
if.then2284:                                      ; preds = %if.end2281
  %call2285 = call i32 @unlink(ptr noundef nonnull %call2251) #14
  br label %if.end2286
...
sw.default2287:                                   ; preds = %if.end2259
  ...
  %call2288 = call i32 @close(i32 noundef %call2255) #14
  %call2289 = call i32 @unlink(ptr noundef nonnull %call2251) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call2204, i32 noundef 0)
  call void @free(ptr noundef nonnull %call2251) #14
  br label %while.cond2299
...
while.body2317:                                   ; preds = %land.lhs.true2301
  ...
  %284 = load i32, ptr %rsz2321, align 4, !tbaa !43
  ...
  %285 = load i32, ptr %vsz2324, align 4, !tbaa !41
  store i32 %285, ptr %dsize, align 4, !tbaa !5
  %limits2325 = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 4
  %286 = load ptr, ptr %limits2325, align 8, !tbaa !62
  %tobool2326.not = icmp eq ptr %286, null
  br i1 %tobool2326.not, label %if.end2358, label %land.lhs.true2327

land.lhs.true2327:                                ; preds = %while.body2317
  %maxfilesize2329 = getelementptr inbounds %struct.cl_limits, ptr %286, i64 0, i32 5
  %287 = load i64, ptr %maxfilesize2329, align 8, !tbaa !63
  %tobool2330.not = icmp eq i64 %287, 0
  br i1 %tobool2330.not, label %if.end2358, label %land.lhs.true2331

land.lhs.true2331:                                ; preds = %land.lhs.true2327
  %cond2337 = call i32 @llvm.umax.i32(i32 %285, i32 %284)
  %conv2338 = zext i32 %cond2337 to i64
  %cmp2341 = icmp ult i64 %287, %conv2338
  br i1 %cmp2341, label %if.then2343, label %if.end2358

if.then2343:                                      ; preds = %land.lhs.true2331
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.152, i32 noundef %cond2337, i64 noundef %287) #14
  call void @free(ptr noundef nonnull %call341) #14
  %288 = load i32, ptr %options271, align 8, !tbaa !11
  %and2353 = and i32 %288, 256
...
if.then2355:                                      ; preds = %if.then2343
  %289 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr @.str.153, ptr %289, align 8, !tbaa !15
  br label %cleanup4880

if.end2358:                                       ; preds = %land.lhs.true2331, %land.lhs.true2327, %while.body2317
  %cmp2359 = icmp ugt i32 %284, 25
  %cmp2362.not = icmp ugt i32 %285, %284
...
if.then2364:                                      ; preds = %if.end2358
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.154, i32 noundef %284, i32 noundef %285) #14
  call void @free(ptr noundef nonnull %call341) #14
  br label %cleanup4880
...
if.end2365:                                       ; preds = %if.end2358
  ...
  %290 = load i32, ptr %ImageBase2369, align 4, !tbaa !25
  %sub2370 = sub i32 %add.ptr2367.val, %290
  %291 = load i32, ptr %rsz2321, align 4, !tbaa !43
  %switch7105 = icmp ult i32 %291, 4
  br i1 %switch7105, label %if.then2412, label %land.lhs.true2384

land.lhs.true2384:                                ; preds = %if.end2365
  %292 = load i32, ptr %arrayidx2320, align 4, !tbaa !38
  %cmp2389.not = icmp ult i32 %sub2370, %292
...
land.lhs.true2391:                                ; preds = %land.lhs.true2384
  ...
  %add2401 = add i32 %292, %291
  %cmp2402.not = icmp ule i32 %add2392, %add2401
  %cmp2410 = icmp ugt i32 %add2392, %292
...
if.then2412:                                      ; preds = %if.end2365, %land.lhs.true2391, %land.lhs.true2384
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.155, i32 noundef %sub2370) #14
  br label %land.lhs.true2707

if.end2413:                                       ; preds = %land.lhs.true2391
  %conv2414 = zext i32 %284 to i64
  %call2415 = call ptr @cli_malloc(i64 noundef %conv2414) #14
...
lor.lhs.false2425:                                ; preds = %if.end2419
  %call2426 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %call2415, i32 noundef %284) #14
  %cmp2427.not = icmp eq i32 %call2426, %284
  br i1 %cmp2427.not, label %if.end2431, label %if.then2429

if.then2429:                                      ; preds = %lor.lhs.false2425, %if.end2419
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.156, i32 noundef %add2318) #14
  call void @free(ptr noundef nonnull %call341) #14
  call void @free(ptr noundef nonnull %call2415) #14
  br label %cleanup4880
...
if.end2431:                                       ; preds = %lor.lhs.false2425
  ...
  %293 = load i32, ptr %arrayidx2320, align 4, !tbaa !38
  %idx.ext2438 = zext i32 %293 to i64
  %idx.neg2439 = sub nsw i64 0, %idx.ext2438
  %add.ptr2440 = getelementptr inbounds i8, ptr %add.ptr2433, i64 %idx.neg2439
  %cmp2445.not = icmp ult i32 %sub2370, %293
...
if.then2466:                                      ; preds = %land.lhs.true2456, %if.end2431
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.157) #14
  call void @free(ptr noundef nonnull %call2415) #14
  br label %land.lhs.true2707

if.end2467:                                       ; preds = %land.lhs.true2456
  %add.ptr2440.val = load i32, ptr %add.ptr2440, align 1
  %294 = load i32, ptr %ImageBase2369, align 4, !tbaa !25
  %sub2470 = sub i32 %add.ptr2440.val, %294
  %295 = load i32, ptr %rsz2321, align 4, !tbaa !43
  %switch7106 = icmp ult i32 %295, 4
  %cmp2489.not = icmp ult i32 %sub2470, %293
...
land.lhs.true2491:                                ; preds = %if.end2467
  ...
  %add2501 = add i32 %295, %293
  %cmp2502.not = icmp ule i32 %add2492, %add2501
  %cmp2510 = icmp ugt i32 %add2492, %293
...
if.then2512:                                      ; preds = %if.end2467, %land.lhs.true2491
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.158, i32 noundef %sub2470) #14
  call void @free(ptr noundef nonnull %call2415) #14
  br label %land.lhs.true2707
...
if.then2541:                                      ; preds = %land.lhs.true2531, %if.end2513
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.159) #14
  call void @free(ptr noundef nonnull %call2415) #14
  br label %land.lhs.true2707

if.end2542:                                       ; preds = %land.lhs.true2531
  %add.ptr2522.val = load i32, ptr %add.ptr2522, align 1
  %sub2545 = sub i32 %add.ptr2522.val, %294
  %add.ptr2546 = getelementptr inbounds i8, ptr %add.ptr2522, i64 4
  %add.ptr2546.val = load i32, ptr %add.ptr2546, align 1
  %sub2549 = sub i32 %add.ptr2546.val, %294
  %add.ptr2550 = getelementptr inbounds i8, ptr %add.ptr2522, i64 16
  %add.ptr2550.val = load i32, ptr %add.ptr2550, align 1
  %sub2553 = sub i32 %add.ptr2550.val, %294
  %296 = load i32, ptr %arrayidx2323, align 4, !tbaa !38
  %cmp2559.not = icmp eq i32 %sub2545, %296
  br i1 %cmp2559.not, label %if.end2565, label %if.then2561

if.then2561:                                      ; preds = %if.end2542
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.160, i32 noundef %sub2545, i32 noundef %296) #14
  call void @free(ptr noundef nonnull %call2415) #14
  br label %land.lhs.true2707

if.end2565:                                       ; preds = %if.end2542
  %cmp2570 = icmp uge i32 %sub2549, %293
  %sub2577 = sub i32 %sub2549, %293
  %cmp2582.not = icmp ult i32 %sub2577, %295
  %or.cond7311 = select i1 %cmp2570, i1 %cmp2582.not, i1 false
  br i1 %or.cond7311, label %land.lhs.true2592, label %if.then2584

if.then2584:                                      ; preds = %if.end2565
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.161) #14
  call void @free(ptr noundef nonnull %call2415) #14
  br label %land.lhs.true2707

land.lhs.true2592:                                ; preds = %if.end2565
  %cmp2597 = icmp ult i32 %295, 16
  %cmp2604.not = icmp ult i32 %sub2553, %293
...
land.lhs.true2606:                                ; preds = %land.lhs.true2592
  ...
  %cmp2625 = icmp ugt i32 %add2607, %293
...
if.then2627:                                      ; preds = %land.lhs.true2606, %land.lhs.true2592
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.162) #14
  call void @free(ptr noundef nonnull %call2415) #14
  br label %land.lhs.true2707

if.end2628:                                       ; preds = %land.lhs.true2606
  %add2629 = sub i32 12, %293
  %sub2634 = add i32 %add2629, %sub2553
  ...
  %sub2639 = sub i32 %add.ptr2636.val, %294
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.163, i32 noundef %sub2639) #14
  %297 = load i32, ptr %dsize, align 4, !tbaa !5
  %conv2640 = zext i32 %297 to i64
  %call2641 = call ptr @cli_calloc(i64 noundef %conv2640, i64 noundef 1) #14
...
if.end2645:                                       ; preds = %if.end2628
  %call2646 = call ptr @cli_gentemp(ptr noundef null) #14
...
if.end2649:                                       ; preds = %if.end2645
  %call2650 = call i32 (ptr, i32, ...) @open(ptr noundef nonnull %call2646, i32 noundef 578, i32 noundef 448) #14
  %cmp2651 = icmp slt i32 %call2650, 0
  br i1 %cmp2651, label %if.then2653, label %if.end2654

if.then2653:                                      ; preds = %if.end2649
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.164, ptr noundef nonnull %call2646) #14
  call void @free(ptr noundef nonnull %call2646) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call2415, ptr noundef nonnull %call2641, ptr noundef nonnull %call341, i32 noundef 0)
  br label %cleanup4880

if.end2654:                                       ; preds = %if.end2649
  %298 = load i32, ptr %arrayidx2320, align 4, !tbaa !38
  %sub2659 = sub i32 %sub2549, %298
  %idx.ext2660 = zext i32 %sub2659 to i64
  %add.ptr2661 = getelementptr inbounds i8, ptr %call2415, i64 %idx.ext2660
  %add2666 = sub i32 %284, %sub2549
  %sub2667 = add i32 %add2666, %298
  %299 = load i32, ptr %dsize, align 4, !tbaa !5
  %300 = load i32, ptr %ImageBase2369, align 4, !tbaa !25
  %call2669 = call i32 @unfsg_200(ptr noundef %add.ptr2661, ptr noundef nonnull %call2641, i32 noundef %sub2667, i32 noundef %299, i32 noundef %sub2545, i32 noundef %300, i32 noundef %sub2639, i32 noundef %call2650) #14
...
sw.bb2670:                                        ; preds = %if.end2654
  %301 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool2671.not = icmp eq i8 %301, 0
  br i1 %tobool2671.not, label %if.else2673, label %if.then2672

if.then2672:                                      ; preds = %sw.bb2670
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.165, ptr noundef nonnull %call2646) #14
  br label %if.end2674

if.else2673:                                      ; preds = %sw.bb2670
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.166) #14
  br label %if.end2674
...
if.end2674:                                       ; preds = %if.else2673, %if.then2672
  ...
  call void @free(ptr noundef nonnull %call341) #14
  %call2675 = call i32 @fsync(i32 noundef %call2650) #14
  %call2676 = call i64 @lseek(i32 noundef %call2650, i64 noundef 0, i32 noundef 0) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.138) #14
  %call2677 = call i32 @cli_magic_scandesc(i32 noundef %call2650, ptr noundef nonnull %ctx) #14
  %cmp2678 = icmp eq i32 %call2677, 1
  %call2681 = call i32 @close(i32 noundef %call2650) #14
  %302 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool2682.not = icmp eq i8 %302, 0
...
if.then2683:                                      ; preds = %if.then2680
  %call2684 = call i32 @unlink(ptr noundef nonnull %call2646) #14
  br label %if.end2685
...
if.then2689:                                      ; preds = %if.end2686
  %call2690 = call i32 @unlink(ptr noundef nonnull %call2646) #14
  br label %if.end2691
...
sw.bb2692:                                        ; preds = %if.end2654
  ...
  %call2693 = call i32 @close(i32 noundef %call2650) #14
  %call2694 = call i32 @unlink(ptr noundef nonnull %call2646) #14
  call void @free(ptr noundef nonnull %call2646) #14
  br label %if.then3742

sw.default2695:                                   ; preds = %if.end2654
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.168) #14
  %call2696 = call i32 @close(i32 noundef %call2650) #14
  %call2697 = call i32 @unlink(ptr noundef nonnull %call2646) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call2415, ptr noundef nonnull %call2641, i32 noundef 0)
  call void @free(ptr noundef nonnull %call2646) #14
  br label %land.lhs.true2707
...
land.lhs.true2707:                                ; preds = %land.lhs.true2301, %if.then2627, %if.then2584, %if.then2561, %if.then2541, %if.then2512, %if.then2466, %if.then2412, %sw.default2695
  %303 = load ptr, ptr %dconf1570, align 8, !tbaa !26
  %304 = load i32, ptr %303, align 4, !tbaa !27
  %and2710 = and i32 %304, 64
  %tobool2711 = icmp ne i32 %and2710, 0
  %305 = load i8, ptr %epbuff, align 16
  %cmp2715 = icmp eq i8 %305, -66
...
land.rhs2717:                                     ; preds = %land.lhs.true2707
  ...
  %306 = load i32, ptr %ImageBase2721, align 4, !tbaa !25
  %sub2722 = sub i32 %add.ptr2719.val7109, %306
...
while.body2726:                                   ; preds = %land.rhs2717
  ...
  %307 = load i32, ptr %rsz2732, align 4, !tbaa !43
  ...
  %308 = load i32, ptr %vsz2735, align 4, !tbaa !41
  store i32 %308, ptr %dsize, align 4, !tbaa !5
  %limits2736 = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 4
  %309 = load ptr, ptr %limits2736, align 8, !tbaa !62
  %tobool2737.not = icmp eq ptr %309, null
  br i1 %tobool2737.not, label %if.end2769, label %land.lhs.true2738

land.lhs.true2738:                                ; preds = %while.body2726
  %maxfilesize2740 = getelementptr inbounds %struct.cl_limits, ptr %309, i64 0, i32 5
  %310 = load i64, ptr %maxfilesize2740, align 8, !tbaa !63
  %tobool2741.not = icmp eq i64 %310, 0
  br i1 %tobool2741.not, label %if.end2769, label %land.lhs.true2742

land.lhs.true2742:                                ; preds = %land.lhs.true2738
  %cond2748 = call i32 @llvm.umax.i32(i32 %308, i32 %307)
  %conv2749 = zext i32 %cond2748 to i64
  %cmp2752 = icmp ult i64 %310, %conv2749
  br i1 %cmp2752, label %if.then2754, label %if.end2769

if.then2754:                                      ; preds = %land.lhs.true2742
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.152, i32 noundef %cond2748, i64 noundef %310) #14
  call void @free(ptr noundef nonnull %call341) #14
  %311 = load i32, ptr %options271, align 8, !tbaa !11
  %and2764 = and i32 %311, 256
...
if.then2766:                                      ; preds = %if.then2754
  %312 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr @.str.153, ptr %312, align 8, !tbaa !15
  br label %cleanup4880

if.end2769:                                       ; preds = %land.lhs.true2742, %land.lhs.true2738, %while.body2726
  %cmp2770 = icmp ugt i32 %307, 25
  %cmp2773.not = icmp ugt i32 %308, %307
...
if.then2775:                                      ; preds = %if.end2769
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.154, i32 noundef %307, i32 noundef %308) #14
  call void @free(ptr noundef nonnull %call341) #14
  br label %cleanup4880
...
if.end2787:                                       ; preds = %if.end2776
  ...
  %call2789 = call i64 @lseek(i32 noundef %desc, i64 noundef %conv2788, i32 noundef 0) #14
  %raw2793 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %idxprom2730, i32 2
  %313 = load i32, ptr %raw2793, align 4, !tbaa !42
  %sub2794 = sub i32 %313, %retval.0.i
  %314 = load ptr, ptr %limits2736, align 8, !tbaa !62
  %tobool2796.not = icmp eq ptr %314, null
...
if.end2787.if.end2816_crit_edge:                  ; preds = %if.end2787
  %.pre7540 = zext i32 %sub2794 to i64
  br label %if.end2816

land.lhs.true2797:                                ; preds = %if.end2787
  %maxfilesize2799 = getelementptr inbounds %struct.cl_limits, ptr %314, i64 0, i32 5
  %315 = load i64, ptr %maxfilesize2799, align 8, !tbaa !63
  %tobool2800.not = icmp ne i64 %315, 0
  %conv2802 = zext i32 %sub2794 to i64
  %cmp2805 = icmp ult i64 %315, %conv2802
...
if.then2807:                                      ; preds = %land.lhs.true2797
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.152, i32 noundef %sub2794, i64 noundef %315) #14
  call void @free(ptr noundef nonnull %call341) #14
  %316 = load i32, ptr %options271, align 8, !tbaa !11
  %and2811 = and i32 %316, 256
...
if.then2813:                                      ; preds = %if.then2807
  %317 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr @.str.153, ptr %317, align 8, !tbaa !15
  br label %cleanup4880

if.end2816:                                       ; preds = %if.end2787.if.end2816_crit_edge, %land.lhs.true2797
  %conv2817.pre-phi = phi i64 [ %.pre7540, %if.end2787.if.end2816_crit_edge ], [ %conv2802, %land.lhs.true2797 ]
  %call2818 = call ptr @cli_malloc(i64 noundef %conv2817.pre-phi) #14
...
if.end2822:                                       ; preds = %if.end2816
  %call2823 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %call2818, i32 noundef %sub2794) #14
  %cmp2824.not = icmp eq i32 %call2823, %sub2794
  br i1 %cmp2824.not, label %if.end2827, label %if.then2826

if.then2826:                                      ; preds = %if.end2822
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.170, i32 noundef %sub2794) #14
  call void @free(ptr noundef nonnull %call341) #14
  call void @free(ptr noundef nonnull %call2818) #14
  br label %cleanup4880
...
if.end2827:                                       ; preds = %if.end2822
  ...
  %318 = load i32, ptr %ImageBase2721, align 4, !tbaa !25
  %sub2831 = sub i32 %add.ptr2828.val, %318
  %add.ptr2832 = getelementptr inbounds i8, ptr %call2818, i64 8
  %add.ptr2832.val = load i32, ptr %add.ptr2832, align 1
  %sub2835 = sub i32 %add.ptr2832.val, %318
  %319 = load i32, ptr %arrayidx2731, align 4, !tbaa !38
  %cmp2840 = icmp ult i32 %sub2835, %319
  br i1 %cmp2840, label %if.then2854, label %lor.lhs.false2842

lor.lhs.false2842:                                ; preds = %if.end2827
  %sub2847 = sub i32 %sub2835, %319
  %320 = load i32, ptr %rsz2732, align 4, !tbaa !43
  %cmp2852.not = icmp ult i32 %sub2847, %320
...
if.end2855:                                       ; preds = %lor.lhs.false2842
  %321 = load i32, ptr %arrayidx2734, align 4, !tbaa !38
  %cmp2859.not = icmp eq i32 %sub2831, %321
...
if.then2861:                                      ; preds = %if.end2855
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.171, i32 noundef %sub2831, i32 noundef %321) #14
  call void @free(ptr noundef nonnull %call2818) #14
  br label %land.lhs.true3043

for.body2870:                                     ; preds = %for.cond2866.preheader, %for.inc2906
  %322 = phi i32 [ %324, %for.inc2906 ], [ %sub2831, %for.cond2866.preheader ]
...
if.end2877:                                       ; preds = %for.body2870
  %323 = load i32, ptr %ImageBase2721, align 4, !tbaa !25
  %add2879.neg = xor i32 %323, -1
...
if.then2884:                                      ; preds = %if.end2877
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.172, i32 noundef %inc2881) #14
  %.pre7530 = load i32, ptr %arrayidx2734, align 4, !tbaa !38
  br label %if.end2885

if.end2885:                                       ; preds = %if.then2884, %if.end2877
  %324 = phi i32 [ %.pre7530, %if.then2884 ], [ %322, %if.end2877 ]
  %cmp2889 = icmp ult i32 %sub2880, %324
  br i1 %cmp2889, label %lor.lhs.false2912, label %lor.lhs.false2891

lor.lhs.false2891:                                ; preds = %if.end2885
  %sub2895 = sub i32 %sub2880, %324
  %325 = load i32, ptr %vsz2735, align 4, !tbaa !41
  %cmp2899.not = icmp ult i32 %sub2895, %325
...
lor.lhs.false2912:                                ; preds = %if.end2885, %lor.lhs.false2891
  %idx.ext2872.le = zext i32 %t.07411 to i64
  %add.ptr2873.le = getelementptr inbounds i8, ptr %call2818, i64 %idx.ext2872.le
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.173, i32 noundef %inc2881) #14
...
if.end2918:                                       ; preds = %for.body2870, %lor.lhs.false2912
  %sectcnt.1.ph7564 = phi i32 [ %inc2881, %lor.lhs.false2912 ], [ %sectcnt.07410, %for.body2870 ]
  %add2919 = add i32 %sectcnt.1.ph7564, 1
  %conv2920 = sext i32 %add2919 to i64
  %mul2921 = mul nsw i64 %conv2920, 36
  %call2922 = call ptr @cli_malloc(i64 noundef %mul2921) #14
...
if.end2926:                                       ; preds = %if.end2918
  store i32 %sub2831, ptr %call2922, align 4, !tbaa !38
  %cmp2930.not7412 = icmp eq i32 %sectcnt.1.ph7564, 0
  br i1 %cmp2930.not7412, label %for.end2946, label %for.body2932.preheader

for.body2932.preheader:                           ; preds = %if.end2926
  %wide.trip.count7494 = zext i32 %add2919 to i64
  %326 = add nsw i64 %wide.trip.count7494, -1
  %xtraiter = and i64 %326, 1
  %327 = icmp eq i32 %add2919, 2
  br i1 %327, label %for.end2946.loopexit.unr-lcssa, label %for.body2932.preheader.new

for.body2932.preheader.new:                       ; preds = %for.body2932.preheader
  %unroll_iter = and i64 %326, -2
  br label %for.body2932

for.body2932:                                     ; preds = %for.body2932, %for.body2932.preheader.new
  %indvars.iv7491 = phi i64 [ 1, %for.body2932.preheader.new ], [ %indvars.iv.next7492.1, %for.body2932 ]
  %niter = phi i64 [ 0, %for.body2932.preheader.new ], [ %niter.next.1, %for.body2932 ]
  %mul2934 = shl i64 %indvars.iv7491, 2
  ...
  %328 = load i32, ptr %ImageBase2721, align 4, !tbaa !25
  %329 = xor i32 %328, -1
  %sub2940 = add i32 %add.ptr2936.val, %329
  %arrayidx2942 = getelementptr inbounds %struct.cli_exe_section, ptr %call2922, i64 %indvars.iv7491
  store i32 %sub2940, ptr %arrayidx2942, align 4, !tbaa !38
  %indvars.iv.next7492 = add nuw nsw i64 %indvars.iv7491, 1
  %mul2934.1 = shl i64 %indvars.iv.next7492, 2
  ...
  %330 = load i32, ptr %ImageBase2721, align 4, !tbaa !25
  %331 = xor i32 %330, -1
  %sub2940.1 = add i32 %add.ptr2936.val.1, %331
  %arrayidx2942.1 = getelementptr inbounds %struct.cli_exe_section, ptr %call2922, i64 %indvars.iv.next7492
  store i32 %sub2940.1, ptr %arrayidx2942.1, align 4, !tbaa !38
  %indvars.iv.next7492.1 = add nuw nsw i64 %indvars.iv7491, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %for.end2946.loopexit.unr-lcssa, label %for.body2932, !llvm.loop !66

for.end2946.loopexit.unr-lcssa:                   ; preds = %for.body2932, %for.body2932.preheader
  %indvars.iv7491.unr = phi i64 [ 1, %for.body2932.preheader ], [ %indvars.iv.next7492.1, %for.body2932 ]
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %for.end2946, label %for.body2932.epil

for.body2932.epil:                                ; preds = %for.end2946.loopexit.unr-lcssa
  %mul2934.epil = shl i64 %indvars.iv7491.unr, 2
  %idx.ext2935.epil = and i64 %mul2934.epil, 4294967292
  %add.ptr2936.epil = getelementptr inbounds i8, ptr %add.ptr2832, i64 %idx.ext2935.epil
  %add.ptr2936.val.epil = load i32, ptr %add.ptr2936.epil, align 1
  %332 = load i32, ptr %ImageBase2721, align 4, !tbaa !25
  %333 = xor i32 %332, -1
  %sub2940.epil = add i32 %add.ptr2936.val.epil, %333
  %arrayidx2942.epil = getelementptr inbounds %struct.cli_exe_section, ptr %call2922, i64 %indvars.iv7491.unr
  store i32 %sub2940.epil, ptr %arrayidx2942.epil, align 4, !tbaa !38
  br label %for.end2946

for.end2946:                                      ; preds = %for.body2932.epil, %for.end2946.loopexit.unr-lcssa, %if.end2926
  call void @free(ptr noundef nonnull %call2818) #14
  %conv2947 = zext i32 %307 to i64
  %call2948 = call ptr @cli_malloc(i64 noundef %conv2947) #14
  %cmp2949 = icmp eq ptr %call2948, null
  br i1 %cmp2949, label %if.then2951, label %if.end2952

if.then2951:                                      ; preds = %for.end2946
  call void @free(ptr noundef %call341) #14
  call void @free(ptr noundef nonnull %call2922) #14
  br label %cleanup4880
...
lor.lhs.false2958:                                ; preds = %if.end2952
  %call2959 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %call2948, i32 noundef %307) #14
  %cmp2960.not = icmp eq i32 %call2959, %307
  br i1 %cmp2960.not, label %if.end2963, label %if.then2962

if.then2962:                                      ; preds = %lor.lhs.false2958, %if.end2952
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.156, i32 noundef %i.77174) #14
  call void @free(ptr noundef %call341) #14
  call void @free(ptr noundef nonnull %call2922) #14
  call void @free(ptr noundef nonnull %call2948) #14
  br label %cleanup4880

if.end2963:                                       ; preds = %lor.lhs.false2958
  %334 = load i32, ptr %dsize, align 4, !tbaa !5
  %conv2964 = zext i32 %334 to i64
  %call2965 = call ptr @cli_calloc(i64 noundef %conv2964, i64 noundef 1) #14
...
if.end2969:                                       ; preds = %if.end2963
  ...
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.163, i32 noundef %add2975) #14
  %call2976 = call ptr @cli_gentemp(ptr noundef null) #14
...
if.end2979:                                       ; preds = %if.end2969
  %call2980 = call i32 (ptr, i32, ...) @open(ptr noundef nonnull %call2976, i32 noundef 578, i32 noundef 448) #14
  %cmp2981 = icmp slt i32 %call2980, 0
  br i1 %cmp2981, label %if.then2983, label %if.end2984

if.then2983:                                      ; preds = %if.end2979
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.164, ptr noundef nonnull %call2976) #14
  call void @free(ptr noundef nonnull %call2976) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call2948, ptr noundef nonnull %call2965, ptr noundef nonnull %call2922, ptr noundef %call341, i32 noundef 0)
  br label %cleanup4880
...
if.end2984:                                       ; preds = %if.end2979
  ...
  %335 = load i32, ptr %arrayidx2731, align 4, !tbaa !38
  %idx.ext2991 = zext i32 %335 to i64
  %idx.neg2992 = sub nsw i64 0, %idx.ext2991
  %add.ptr2993 = getelementptr inbounds i8, ptr %add.ptr2986, i64 %idx.neg2992
  %add2998 = sub i32 %307, %sub2835
  %sub2999 = add i32 %add2998, %335
  %336 = load i32, ptr %dsize, align 4, !tbaa !5
  %337 = load i32, ptr %ImageBase2721, align 4, !tbaa !25
  %call3001 = call i32 @unfsg_133(ptr noundef nonnull %add.ptr2993, ptr noundef nonnull %call2965, i32 noundef %sub2999, i32 noundef %336, ptr noundef nonnull %call2922, i32 noundef %sectcnt.1.ph7564, i32 noundef %337, i32 noundef %add2975, i32 noundef %call2980) #14
...
sw.bb3002:                                        ; preds = %if.end2984
  %338 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool3003.not = icmp eq i8 %338, 0
  br i1 %tobool3003.not, label %if.else3005, label %if.then3004

if.then3004:                                      ; preds = %sw.bb3002
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.165, ptr noundef nonnull %call2976) #14
  br label %if.end3006
...
if.end3006:                                       ; preds = %if.else3005, %if.then3004
  ...
  call void @free(ptr noundef nonnull %call341) #14
  %call3007 = call i32 @fsync(i32 noundef %call2980) #14
  %call3008 = call i64 @lseek(i32 noundef %call2980, i64 noundef 0, i32 noundef 0) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.138) #14
  %call3009 = call i32 @cli_magic_scandesc(i32 noundef %call2980, ptr noundef %ctx) #14
  %cmp3010 = icmp eq i32 %call3009, 1
  %call3013 = call i32 @close(i32 noundef %call2980) #14
  %339 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool3014.not = icmp eq i8 %339, 0
...
if.then3015:                                      ; preds = %if.then3012
  %call3016 = call i32 @unlink(ptr noundef nonnull %call2976) #14
  br label %if.end3017
...
if.then3021:                                      ; preds = %if.end3018
  %call3022 = call i32 @unlink(ptr noundef nonnull %call2976) #14
  br label %if.end3023
...
sw.bb3024:                                        ; preds = %if.end2984
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.167) #14
  %call3025 = call i32 @close(i32 noundef %call2980) #14
  %call3026 = call i32 @unlink(ptr noundef nonnull %call2976) #14
  call void @free(ptr noundef nonnull %call2976) #14
  call void @free(ptr noundef nonnull %call2922) #14
  br label %if.then3742
...
sw.default3027:                                   ; preds = %if.end2984
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.168) #14
  %call3028 = call i32 @close(i32 noundef %call2980) #14
  %call3029 = call i32 @unlink(ptr noundef nonnull %call2976) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call2948, ptr noundef nonnull %call2965, ptr noundef nonnull %call2922, i32 noundef 0)
  call void @free(ptr noundef nonnull %call2976) #14
  br label %land.lhs.true3043

land.lhs.true3043:                                ; preds = %land.rhs2717, %land.lhs.true2707, %if.then2917, %if.then2861, %if.then2854, %if.then2786, %sw.default3027
  %340 = load ptr, ptr %dconf1570, align 8, !tbaa !26
  %341 = load i32, ptr %340, align 4, !tbaa !27
  %and3046 = and i32 %341, 64
  %tobool3047 = icmp ne i32 %and3046, 0
  %342 = load i8, ptr %epbuff, align 16
  %cmp3051 = icmp eq i8 %342, -69
...
land.lhs.true3071:                                ; preds = %land.lhs.true3053
  ...
  %346 = load i32, ptr %arrayidx3074, align 4, !tbaa !38
  %cmp3076.not = icmp ult i32 %vep.0, %346
  br i1 %cmp3076.not, label %land.lhs.true3444, label %land.rhs3078

land.rhs3078:                                     ; preds = %land.lhs.true3071
  %sub3083 = sub i32 %vep.0, %346
  %sub3088 = add i32 %346, -224
...
while.body3092:                                   ; preds = %land.rhs3078
  ...
  %348 = load i32, ptr %vsz3128, align 4, !tbaa !41
  store i32 %348, ptr %dsize, align 4, !tbaa !5
...
if.end3131:                                       ; preds = %while.body3092
  %349 = load i32, ptr %arrayidx3074, align 4, !tbaa !38
  %cmp3136 = icmp ult i32 %sub3108, %349
  br i1 %cmp3136, label %if.then3150, label %lor.lhs.false3138

lor.lhs.false3138:                                ; preds = %if.end3131
  %sub3143 = sub i32 %sub3108, %349
  %raw3147 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %idxprom3073, i32 2
  %350 = load i32, ptr %raw3147, align 4, !tbaa !42
  %cmp3148.not = icmp ult i32 %sub3143, %350
...
if.end3151:                                       ; preds = %lor.lhs.false3138
  %351 = load i32, ptr %arrayidx3127, align 4, !tbaa !38
  %cmp3155.not = icmp eq i32 %sub3114, %351
  br i1 %cmp3155.not, label %if.end3161, label %if.then3157

if.then3157:                                      ; preds = %if.end3151
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.171, i32 noundef %sub3114, i32 noundef %351) #14
  br label %land.lhs.true3444

if.end3161:                                       ; preds = %if.end3151
  %limits3162 = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 4
  %352 = load ptr, ptr %limits3162, align 8, !tbaa !62
  %tobool3163.not = icmp eq ptr %352, null
  br i1 %tobool3163.not, label %if.end3195, label %land.lhs.true3164

land.lhs.true3164:                                ; preds = %if.end3161
  %maxfilesize3166 = getelementptr inbounds %struct.cl_limits, ptr %352, i64 0, i32 5
  %353 = load i64, ptr %maxfilesize3166, align 8, !tbaa !63
  %tobool3167.not = icmp eq i64 %353, 0
  br i1 %tobool3167.not, label %if.end3195, label %land.lhs.true3168

land.lhs.true3168:                                ; preds = %land.lhs.true3164
  %cond3174 = call i32 @llvm.umax.i32(i32 %348, i32 %347)
  %conv3175 = zext i32 %cond3174 to i64
  %cmp3178 = icmp ult i64 %353, %conv3175
  br i1 %cmp3178, label %if.then3180, label %if.end3195

if.then3180:                                      ; preds = %land.lhs.true3168
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.152, i32 noundef %cond3174, i64 noundef %353) #14
  call void @free(ptr noundef nonnull %call341) #14
  %354 = load i32, ptr %options271, align 8, !tbaa !11
  %and3190 = and i32 %354, 256
...
if.then3192:                                      ; preds = %if.then3180
  %355 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr @.str.153, ptr %355, align 8, !tbaa !15
  br label %cleanup4880

if.end3195:                                       ; preds = %land.lhs.true3168, %land.lhs.true3164, %if.end3161
  %cmp3196 = icmp ugt i32 %347, 25
  %cmp3199.not = icmp ugt i32 %348, %347
...
if.then3201:                                      ; preds = %if.end3195
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.154, i32 noundef %347, i32 noundef %348) #14
  call void @free(ptr noundef nonnull %call341) #14
  br label %cleanup4880

if.end3202:                                       ; preds = %if.end3195
  %conv3203 = zext i32 %retval.0.i7125 to i64
  %call3204 = call i64 @lseek(i32 noundef %desc, i64 noundef %conv3203, i32 noundef 0) #14
  %356 = load i32, ptr %raw3147, align 4, !tbaa !42
  %sub3209 = sub i32 %356, %retval.0.i7125
  %357 = load ptr, ptr %limits3162, align 8, !tbaa !62
  %tobool3211.not = icmp eq ptr %357, null
...
if.end3202.if.end3231_crit_edge:                  ; preds = %if.end3202
  %.pre7539 = zext i32 %sub3209 to i64
  br label %if.end3231

land.lhs.true3212:                                ; preds = %if.end3202
  %maxfilesize3214 = getelementptr inbounds %struct.cl_limits, ptr %357, i64 0, i32 5
  %358 = load i64, ptr %maxfilesize3214, align 8, !tbaa !63
  %tobool3215.not = icmp ne i64 %358, 0
  %conv3217 = zext i32 %sub3209 to i64
  %cmp3220 = icmp ult i64 %358, %conv3217
...
if.then3222:                                      ; preds = %land.lhs.true3212
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.152, i32 noundef %sub3209, i64 noundef %358) #14
  call void @free(ptr noundef nonnull %call341) #14
  %359 = load i32, ptr %options271, align 8, !tbaa !11
  %and3226 = and i32 %359, 256
...
if.then3228:                                      ; preds = %if.then3222
  %360 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr @.str.153, ptr %360, align 8, !tbaa !15
  br label %cleanup4880

if.end3231:                                       ; preds = %if.end3202.if.end3231_crit_edge, %land.lhs.true3212
  %conv3232.pre-phi = phi i64 [ %.pre7539, %if.end3202.if.end3231_crit_edge ], [ %conv3217, %land.lhs.true3212 ]
  %call3233 = call ptr @cli_malloc(i64 noundef %conv3232.pre-phi) #14
...
if.end3237:                                       ; preds = %if.end3231
  %call3238 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %call3233, i32 noundef %sub3209) #14
...
for.body3247.lr.ph:                               ; preds = %for.cond3243.preheader
  %361 = load i32, ptr %ImageBase3057, align 4
  br label %for.body3247

if.then3241:                                      ; preds = %if.end3237
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.170, i32 noundef %sub3209) #14
  call void @free(ptr noundef nonnull %call341) #14
  call void @free(ptr noundef nonnull %call3233) #14
  br label %cleanup4880
...
for.body3247:                                     ; preds = %for.body3247.lr.ph, %for.inc3288
  ...
  %362 = load i8, ptr %arrayidx3250, align 1, !tbaa !25
  %conv3251 = sext i8 %362 to i32
  ...
  %363 = load i8, ptr %arrayidx3254, align 1, !tbaa !25
  %conv3255 = sext i8 %363 to i32
  %shl = shl nsw i32 %conv3255, 8
  %or = or i32 %shl, %conv3251
  %364 = add nsw i32 %or, -1
  %or.cond4989 = icmp ult i32 %364, 2
...
if.end3302:                                       ; preds = %lor.lhs.false3294
  ...
  %call3306 = call ptr @cli_malloc(i64 noundef %mul3305) #14
...
if.end3310:                                       ; preds = %if.end3302
  store i32 %sub3114, ptr %call3306, align 4, !tbaa !38
  %umax = call i32 @llvm.umax.i32(i32 %sectcnt3093.2, i32 1)
  %wide.trip.count7499 = zext i32 %umax to i64
  br label %for.body3317

for.body3317:                                     ; preds = %if.end3310, %for.body3317
  %indvars.iv7496 = phi i64 [ 0, %if.end3310 ], [ %indvars.iv.next7497, %for.body3317 ]
  %367 = trunc i64 %indvars.iv7496 to i32
  %mul3318 = shl i32 %367, 1
  %idxprom3319 = zext i32 %mul3318 to i64
  %arrayidx3320 = getelementptr inbounds i8, ptr %call3233, i64 %idxprom3319
  %368 = load i8, ptr %arrayidx3320, align 1, !tbaa !25
  %conv3321 = sext i8 %368 to i32
  ...
  %369 = load i8, ptr %arrayidx3325, align 1, !tbaa !25
  %conv3326 = sext i8 %369 to i32
  %370 = shl nsw i32 %conv3326, 20
  %371 = shl nsw i32 %conv3321, 12
  %sub3329 = or i32 %370, %371
  %372 = load i32, ptr %ImageBase3057, align 4, !tbaa !25
  %shl3330 = sub i32 -8192, %372
  %sub3332 = add i32 %shl3330, %sub3329
  %indvars.iv.next7497 = add nuw nsw i64 %indvars.iv7496, 1
  %arrayidx3335 = getelementptr inbounds %struct.cli_exe_section, ptr %call3306, i64 %indvars.iv.next7497
  store i32 %sub3332, ptr %arrayidx3335, align 4, !tbaa !38
  %exitcond7500 = icmp eq i64 %indvars.iv.next7497, %wide.trip.count7499
  br i1 %exitcond7500, label %for.end3339, label %for.body3317, !llvm.loop !68

for.end3339:                                      ; preds = %for.body3317
  call void @free(ptr noundef nonnull %call3233) #14
  %conv3340 = zext i32 %347 to i64
  %call3341 = call ptr @cli_malloc(i64 noundef %conv3340) #14
  %cmp3342 = icmp eq ptr %call3341, null
  br i1 %cmp3342, label %if.then3344, label %if.end3345

if.then3344:                                      ; preds = %for.end3339
  call void @free(ptr noundef %call341) #14
  call void @free(ptr noundef nonnull %call3306) #14
  br label %cleanup4880
...
lor.lhs.false3351:                                ; preds = %if.end3345
  %call3352 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %call3341, i32 noundef %347) #14
  %cmp3353.not = icmp eq i32 %call3352, %347
  br i1 %cmp3353.not, label %if.end3356, label %if.then3355

if.then3355:                                      ; preds = %lor.lhs.false3351, %if.end3345
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.174, i32 noundef %i.77174) #14
  call void @free(ptr noundef %call341) #14
  call void @free(ptr noundef nonnull %call3306) #14
  call void @free(ptr noundef nonnull %call3341) #14
  br label %cleanup4880

if.end3356:                                       ; preds = %lor.lhs.false3351
  %373 = load i32, ptr %dsize, align 4, !tbaa !5
  %conv3357 = zext i32 %373 to i64
  %call3358 = call ptr @cli_calloc(i64 noundef %conv3357, i64 noundef 1) #14
...
if.end3362:                                       ; preds = %if.end3356
  ...
  %374 = load i8, ptr %arrayidx3363, align 16, !tbaa !25
  %cmp3365 = icmp eq i8 %374, -24
  ...
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.163, i32 noundef %add3377) #14
  %call3378 = call ptr @cli_gentemp(ptr noundef null) #14
...
if.end3381:                                       ; preds = %if.end3362
  %call3382 = call i32 (ptr, i32, ...) @open(ptr noundef nonnull %call3378, i32 noundef 578, i32 noundef 448) #14
  %cmp3383 = icmp slt i32 %call3382, 0
  br i1 %cmp3383, label %if.then3385, label %if.end3386

if.then3385:                                      ; preds = %if.end3381
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.164, ptr noundef nonnull %call3378) #14
  call void @free(ptr noundef nonnull %call3378) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call3341, ptr noundef nonnull %call3358, ptr noundef nonnull %call3306, ptr noundef %call341, i32 noundef 0)
  br label %cleanup4880
...
if.end3386:                                       ; preds = %if.end3381
  ...
  %375 = load i32, ptr %arrayidx3074, align 4, !tbaa !38
  %idx.ext3393 = zext i32 %375 to i64
  %idx.neg3394 = sub nsw i64 0, %idx.ext3393
  %add.ptr3395 = getelementptr inbounds i8, ptr %add.ptr3388, i64 %idx.neg3394
  %add3400 = sub i32 %347, %sub3108
  %sub3401 = add i32 %add3400, %375
  %376 = load i32, ptr %dsize, align 4, !tbaa !5
  %377 = load i32, ptr %ImageBase3057, align 4, !tbaa !25
  %call3403 = call i32 @unfsg_133(ptr noundef nonnull %add.ptr3395, ptr noundef nonnull %call3358, i32 noundef %sub3401, i32 noundef %376, ptr noundef nonnull %call3306, i32 noundef %sectcnt3093.2, i32 noundef %377, i32 noundef %add3377, i32 noundef %call3382) #14
...
sw.bb3404:                                        ; preds = %if.end3386
  %378 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool3405.not = icmp eq i8 %378, 0
  br i1 %tobool3405.not, label %if.else3407, label %if.then3406

if.then3406:                                      ; preds = %sw.bb3404
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.165, ptr noundef nonnull %call3378) #14
  br label %if.end3408
...
if.end3408:                                       ; preds = %if.else3407, %if.then3406
  ...
  call void @free(ptr noundef nonnull %call341) #14
  %call3409 = call i32 @fsync(i32 noundef %call3382) #14
  %call3410 = call i64 @lseek(i32 noundef %call3382, i64 noundef 0, i32 noundef 0) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.138) #14
  %call3411 = call i32 @cli_magic_scandesc(i32 noundef %call3382, ptr noundef %ctx) #14
  %cmp3412 = icmp eq i32 %call3411, 1
  %call3415 = call i32 @close(i32 noundef %call3382) #14
  %379 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool3416.not = icmp eq i8 %379, 0
...
if.then3417:                                      ; preds = %if.then3414
  %call3418 = call i32 @unlink(ptr noundef nonnull %call3378) #14
  br label %if.end3419
...
if.then3423:                                      ; preds = %if.end3420
  %call3424 = call i32 @unlink(ptr noundef nonnull %call3378) #14
  br label %if.end3425
...
sw.bb3426:                                        ; preds = %if.end3386
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.167) #14
  %call3427 = call i32 @close(i32 noundef %call3382) #14
  %call3428 = call i32 @unlink(ptr noundef nonnull %call3378) #14
  call void @free(ptr noundef nonnull %call3378) #14
  call void @free(ptr noundef nonnull %call3306) #14
  br label %if.then3742
...
sw.default3429:                                   ; preds = %if.end3386
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.168) #14
  %call3430 = call i32 @close(i32 noundef %call3382) #14
  %call3431 = call i32 @unlink(ptr noundef nonnull %call3378) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call3341, ptr noundef nonnull %call3358, ptr noundef nonnull %call3306, i32 noundef 0)
  call void @free(ptr noundef nonnull %call3378) #14
  br label %land.lhs.true3444
...
land.lhs.true3444:                                ; preds = %land.rhs3078, %land.lhs.true3071, %land.lhs.true3053, %land.lhs.true3043, %if.then3301, %if.then3157, %if.then3150, %if.then3130, %sw.default3429
  %380 = load ptr, ptr %dconf1570, align 8, !tbaa !26
  %381 = load i32, ptr %380, align 4, !tbaa !27
  %and3447 = and i32 %381, 32
...
if.then3449:                                      ; preds = %land.lhs.true3444
  ...
  %382 = load i32, ptr %rsz3453, align 4, !tbaa !43
  ...
  %383 = load i32, ptr %vsz3456, align 4, !tbaa !41
  %vsz3460 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %idxprom3451, i32 1
  %384 = load i32, ptr %vsz3460, align 4, !tbaa !41
  %add3461 = add i32 %384, %383
  store i32 %add3461, ptr %dsize, align 4, !tbaa !5
  %limits3462 = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 4
  %385 = load ptr, ptr %limits3462, align 8, !tbaa !62
  %tobool3463.not = icmp eq ptr %385, null
  br i1 %tobool3463.not, label %if.end3495, label %land.lhs.true3464

land.lhs.true3464:                                ; preds = %if.then3449
  %maxfilesize3466 = getelementptr inbounds %struct.cl_limits, ptr %385, i64 0, i32 5
  %386 = load i64, ptr %maxfilesize3466, align 8, !tbaa !63
  %tobool3467.not = icmp eq i64 %386, 0
  br i1 %tobool3467.not, label %if.end3495, label %land.lhs.true3468

land.lhs.true3468:                                ; preds = %land.lhs.true3464
  %cond3474 = call i32 @llvm.umax.i32(i32 %add3461, i32 %382)
  %conv3475 = zext i32 %cond3474 to i64
  %cmp3478 = icmp ult i64 %386, %conv3475
  br i1 %cmp3478, label %if.then3480, label %if.end3495

if.then3480:                                      ; preds = %land.lhs.true3468
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.175, i32 noundef %cond3474, i64 noundef %386) #14
  call void @free(ptr noundef nonnull %call341) #14
  %387 = load i32, ptr %options271, align 8, !tbaa !11
  %and3490 = and i32 %387, 256
...
if.then3504:                                      ; preds = %lor.lhs.false3498, %if.end3495
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.177, i32 noundef %382, i32 noundef %add3461) #14
  call void @free(ptr noundef nonnull %call341) #14
  br label %cleanup4880

if.end3505:                                       ; preds = %lor.lhs.false3498
  %conv3506 = zext i32 %382 to i64
  %call3507 = call ptr @cli_malloc(i64 noundef %conv3506) #14
...
if.end3511:                                       ; preds = %if.end3505
  %389 = load i32, ptr %dsize, align 4, !tbaa !5
  %add3512 = add i32 %389, 8192
  %conv3513 = zext i32 %add3512 to i64
  %call3514 = call ptr @cli_calloc(i64 noundef %conv3513, i64 noundef 1) #14
  %cmp3515 = icmp eq ptr %call3514, null
  br i1 %cmp3515, label %if.then3517, label %if.end3518

if.then3517:                                      ; preds = %if.end3511
  call void @free(ptr noundef nonnull %call341) #14
  call void @free(ptr noundef nonnull %call3507) #14
  br label %cleanup4880
...
lor.lhs.false3524:                                ; preds = %if.end3518
  %call3525 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %call3507, i32 noundef %382) #14
  %cmp3526.not = icmp eq i32 %call3525, %382
  br i1 %cmp3526.not, label %if.end3530, label %if.then3528

if.then3528:                                      ; preds = %lor.lhs.false3524, %if.end3518
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.178, i32 noundef %add3450) #14
  call void @free(ptr noundef nonnull %call341) #14
  call void @free(ptr noundef nonnull %call3507) #14
  call void @free(ptr noundef nonnull %call3514) #14
  br label %cleanup4880

if.end3530:                                       ; preds = %lor.lhs.false3524
  %add.ptr3532 = getelementptr inbounds i8, ptr %epbuff, i64 105
  %call3533 = call ptr @cli_memstr(ptr noundef nonnull @.str.179, i32 noundef 24, ptr noundef nonnull %add.ptr3532, i32 noundef 13) #14
...
lor.lhs.false3535:                                ; preds = %if.end3530
  ...
  %call3539 = call ptr @cli_memstr(ptr noundef nonnull @.str.179, i32 noundef 24, ptr noundef nonnull %add.ptr3538, i32 noundef 13) #14
...
if.else3542:                                      ; preds = %lor.lhs.false3535
  %call3545 = call ptr @cli_memstr(ptr noundef nonnull @.str.181, i32 noundef 24, ptr noundef nonnull %add.ptr3532, i32 noundef 13) #14
...
lor.lhs.false3547:                                ; preds = %if.else3542
  %call3551 = call ptr @cli_memstr(ptr noundef nonnull @.str.181, i32 noundef 24, ptr noundef nonnull %add.ptr3538, i32 noundef 13) #14
...
if.else3554:                                      ; preds = %lor.lhs.false3547
  %call3557 = call ptr @cli_memstr(ptr noundef nonnull @.str.183, i32 noundef 24, ptr noundef nonnull %add.ptr3532, i32 noundef 13) #14
...
lor.lhs.false3559:                                ; preds = %if.else3554
  %call3563 = call ptr @cli_memstr(ptr noundef nonnull @.str.183, i32 noundef 24, ptr noundef nonnull %add.ptr3538, i32 noundef 13) #14
...
if.then3570:                                      ; preds = %if.else3554, %lor.lhs.false3559, %if.else3542, %lor.lhs.false3547, %if.end3530, %lor.lhs.false3535
  ...
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull %.str.182.sink) #14
  ...
  %390 = load i32, ptr %ImageBase3574, align 4, !tbaa !25
  %391 = load i32, ptr %arrayidx3452, align 4, !tbaa !38
  %392 = add i32 %390, %391
  %sub3580 = sub i32 %add.ptr3572.val, %392
  %393 = load i8, ptr %arrayidx2312, align 1, !tbaa !25
  %cmp3583 = icmp ne i8 %393, -66
...
if.then3591:                                      ; preds = %if.then3570
  %394 = load i32, ptr %arrayidx3455, align 4, !tbaa !38
  %call3599 = call i32 %upxfn.0.ph(ptr noundef nonnull %call3507, i32 noundef %382, ptr noundef nonnull %call3514, ptr noundef nonnull %dsize, i32 noundef %394, i32 noundef %391, i32 noundef %vep.0) #14, !callees !69
  %cmp3600 = icmp sgt i32 %call3599, -1
  br i1 %cmp3600, label %if.end3637.thread, label %if.end3637

if.else3604:                                      ; preds = %if.then3570
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.185, i32 noundef %sub3580) #14
  %idx.ext3605 = zext i32 %sub3580 to i64
  %add.ptr3606 = getelementptr inbounds i8, ptr %call3507, i64 %idx.ext3605
  %sub3607 = sub i32 %382, %sub3580
  %395 = load i32, ptr %arrayidx3455, align 4, !tbaa !38
  %396 = load i32, ptr %arrayidx3452, align 4, !tbaa !38
  %sub3615 = sub i32 %vep.0, %sub3580
  %call3616 = call i32 %upxfn.0.ph(ptr noundef nonnull %add.ptr3606, i32 noundef %sub3607, ptr noundef nonnull %call3514, ptr noundef nonnull %dsize, i32 noundef %395, i32 noundef %396, i32 noundef %sub3615) #14, !callees !69
...
lor.lhs.false3619:                                ; preds = %if.else3604
  %397 = load i32, ptr %arrayidx3455, align 4, !tbaa !38
  %398 = load i32, ptr %arrayidx3452, align 4, !tbaa !38
  %call3627 = call i32 %upxfn.0.ph(ptr noundef nonnull %call3507, i32 noundef %382, ptr noundef nonnull %call3514, ptr noundef nonnull %dsize, i32 noundef %397, i32 noundef %398, i32 noundef %vep.0) #14, !callees !69
...
if.end3637.thread:                                ; preds = %lor.lhs.false3619, %if.else3604, %if.then3591
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.186) #14
  br label %if.then3742

if.end3637:                                       ; preds = %if.then3591, %lor.lhs.false3619
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.187) #14
  br i1 %cmp3640.ph, label %if.then3642, label %if.end3670

if.then3642:                                      ; preds = %lor.lhs.false3559, %if.end3637
  %cmp367372587572 = phi i1 [ %cmp3673.ph, %if.end3637 ], [ true, %lor.lhs.false3559 ]
  %cmp370672607570 = phi i1 [ %cmp3706.ph, %if.end3637 ], [ true, %lor.lhs.false3559 ]
  %399 = load i32, ptr %arrayidx3455, align 4, !tbaa !38
  %400 = load i32, ptr %arrayidx3452, align 4, !tbaa !38
  %call3650 = call i32 @upx_inflate2b(ptr noundef nonnull %call3507, i32 noundef %382, ptr noundef nonnull %call3514, ptr noundef nonnull %dsize, i32 noundef %399, i32 noundef %400, i32 noundef %vep.0) #14
...
land.lhs.true3653:                                ; preds = %if.then3642
  ...
  %sub3655 = add i32 %382, -21
  %401 = load i32, ptr %arrayidx3455, align 4, !tbaa !38
  %402 = load i32, ptr %arrayidx3452, align 4, !tbaa !38
  %sub3663 = add i32 %vep.0, -21
  %call3664 = call i32 @upx_inflate2b(ptr noundef nonnull %add.ptr3654, i32 noundef %sub3655, ptr noundef nonnull %call3514, ptr noundef nonnull %dsize, i32 noundef %401, i32 noundef %402, i32 noundef %sub3663) #14
  %cmp3665 = icmp eq i32 %call3664, -1
  br i1 %cmp3665, label %if.then3667, label %if.else3668

if.then3667:                                      ; preds = %land.lhs.true3653
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.188) #14
  br i1 %cmp367372587572, label %if.then3675, label %if.end3703
...
if.then3675:                                      ; preds = %if.then3667, %if.end3670
  %cmp3706726075697574 = phi i1 [ %cmp370672607570, %if.then3667 ], [ %cmp3706.ph, %if.end3670 ]
  %403 = load i32, ptr %arrayidx3455, align 4, !tbaa !38
  %404 = load i32, ptr %arrayidx3452, align 4, !tbaa !38
  %call3683 = call i32 @upx_inflate2d(ptr noundef nonnull %call3507, i32 noundef %382, ptr noundef nonnull %call3514, ptr noundef nonnull %dsize, i32 noundef %403, i32 noundef %404, i32 noundef %vep.0) #14
...
land.lhs.true3686:                                ; preds = %if.then3675
  ...
  %sub3688 = add i32 %382, -21
  %405 = load i32, ptr %arrayidx3455, align 4, !tbaa !38
  %406 = load i32, ptr %arrayidx3452, align 4, !tbaa !38
  %sub3696 = add i32 %vep.0, -21
  %call3697 = call i32 @upx_inflate2d(ptr noundef nonnull %add.ptr3687, i32 noundef %sub3688, ptr noundef nonnull %call3514, ptr noundef nonnull %dsize, i32 noundef %405, i32 noundef %406, i32 noundef %sub3696) #14
  %cmp3698 = icmp eq i32 %call3697, -1
  br i1 %cmp3698, label %if.then3700, label %if.else3701

if.then3700:                                      ; preds = %land.lhs.true3686
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.190) #14
  br i1 %cmp3706726075697574, label %if.then3708, label %if.then3738

if.else3701:                                      ; preds = %land.lhs.true3686, %if.then3675
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.191) #14
  br label %if.then3742

if.end3703:                                       ; preds = %if.then3667, %if.end3670
  %cmp3706726075697573 = phi i1 [ %cmp370672607570, %if.then3667 ], [ %cmp3706.ph, %if.end3670 ]
  br i1 %cmp3706726075697573, label %if.then3708, label %if.then3738

if.then3708:                                      ; preds = %if.then3700, %if.end3703
  %407 = load i32, ptr %arrayidx3455, align 4, !tbaa !38
  %408 = load i32, ptr %arrayidx3452, align 4, !tbaa !38
  %call3716 = call i32 @upx_inflate2e(ptr noundef nonnull %call3507, i32 noundef %382, ptr noundef nonnull %call3514, ptr noundef nonnull %dsize, i32 noundef %407, i32 noundef %408, i32 noundef %vep.0) #14
...
land.lhs.true3719:                                ; preds = %if.then3708
  ...
  %sub3721 = add i32 %382, -21
  %409 = load i32, ptr %arrayidx3455, align 4, !tbaa !38
  %410 = load i32, ptr %arrayidx3452, align 4, !tbaa !38
  %sub3729 = add i32 %vep.0, -21
  %call3730 = call i32 @upx_inflate2e(ptr noundef nonnull %add.ptr3720, i32 noundef %sub3721, ptr noundef nonnull %call3514, ptr noundef nonnull %dsize, i32 noundef %409, i32 noundef %410, i32 noundef %sub3729) #14
  %cmp3731 = icmp eq i32 %call3730, -1
  br i1 %cmp3731, label %if.then3733, label %if.else3734

if.then3733:                                      ; preds = %land.lhs.true3719
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.192) #14
  br label %if.then3738

if.else3734:                                      ; preds = %land.lhs.true3719, %if.then3708
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.193) #14
  br label %if.then3742
...
if.then3742:                                      ; preds = %if.end3637.thread, %if.else3668, %if.else3701, %sw.bb2692, %sw.bb3024, %sw.bb3426, %if.else3734
  ...
  call void @free(ptr noundef nonnull %src.10.ph) #14
  call void @free(ptr noundef nonnull %call341) #14
  %call3743 = call ptr @cli_gentemp(ptr noundef null) #14
...
if.end3746:                                       ; preds = %if.then3742
  %call3747 = call i32 (ptr, i32, ...) @open(ptr noundef nonnull %call3743, i32 noundef 578, i32 noundef 448) #14
  %cmp3748 = icmp slt i32 %call3747, 0
  br i1 %cmp3748, label %if.then3750, label %if.end3751

if.then3750:                                      ; preds = %if.end3746
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.195, ptr noundef nonnull %call3743) #14
  call void @free(ptr noundef nonnull %call3743) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %dest.8.ph, i32 noundef 0)
  br label %cleanup4880

if.end3751:                                       ; preds = %if.end3746
  %411 = load i32, ptr %dsize, align 4, !tbaa !5
  %conv3752 = zext i32 %411 to i64
  %call3753 = call i64 @write(i32 noundef %call3747, ptr noundef nonnull %dest.8.ph, i64 noundef %conv3752) #14
  %conv3754 = trunc i64 %call3753 to i32
  %412 = load i32, ptr %dsize, align 4, !tbaa !5
  %cmp3755.not = icmp eq i32 %412, %conv3754
  br i1 %cmp3755.not, label %if.end3759, label %if.then3757

if.then3757:                                      ; preds = %if.end3751
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.196, i32 noundef %412) #14
  call void @free(ptr noundef nonnull %call3743) #14
  call void @free(ptr noundef nonnull %dest.8.ph) #14
  %call3758 = call i32 @close(i32 noundef %call3747) #14
  br label %cleanup4880

if.end3759:                                       ; preds = %if.end3751
  call void @free(ptr noundef nonnull %dest.8.ph) #14
  %call3760 = call i32 @fsync(i32 noundef %call3747) #14
  %call3761 = call i64 @lseek(i32 noundef %call3747, i64 noundef 0, i32 noundef 0) #14
  %413 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool3762.not = icmp eq i8 %413, 0
  br i1 %tobool3762.not, label %if.end3764, label %if.then3763

if.then3763:                                      ; preds = %if.end3759
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.197, ptr noundef nonnull %call3743) #14
  br label %if.end3764

if.end3764:                                       ; preds = %if.then3763, %if.end3759
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.198) #14
  %call3765 = call i32 @cli_magic_scandesc(i32 noundef %call3747, ptr noundef %ctx) #14
  %cmp3766 = icmp eq i32 %call3765, 1
  %call3769 = call i32 @close(i32 noundef %call3747) #14
  %414 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool3770.not = icmp eq i8 %414, 0
...
if.then3771:                                      ; preds = %if.then3768
  %call3772 = call i32 @unlink(ptr noundef nonnull %call3743) #14
  br label %if.end3773
...
if.then3777:                                      ; preds = %if.end3774
  %call3778 = call i32 @unlink(ptr noundef nonnull %call3743) #14
  br label %if.end3779
...
if.end3784:                                       ; preds = %if.end3780
  %415 = load i8, ptr %epbuff, align 16, !tbaa !25
  %cmp3787.not = icmp eq i8 %415, -72
...
lor.lhs.false3789:                                ; preds = %if.end3784
  ...
  %416 = load i32, ptr %arrayidx3796, align 4, !tbaa !38
  %ImageBase3798 = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 9
  %417 = load i32, ptr %ImageBase3798, align 4, !tbaa !25
  %add3799 = add i32 %417, %416
...
if.then3802:                                      ; preds = %lor.lhs.false3789
  ...
  br i1 %cmp3804, label %if.end4082, label %lor.lhs.false3811
...
lor.lhs.false3811:                                ; preds = %if.then3802
  ...
  %418 = load i32, ptr %arrayidx3818, align 4, !tbaa !38
  %add3821 = add i32 %417, %418
...
land.lhs.true3829:                                ; preds = %lor.lhs.false3811, %lor.lhs.false3789
  ...
  %419 = load ptr, ptr %dconf1570, align 8, !tbaa !26
  %420 = load i32, ptr %419, align 4, !tbaa !27
  %and3832 = and i32 %420, 256
...
if.then3834:                                      ; preds = %land.lhs.true3829
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.199, i32 noundef %found.10) #14
...
if.then3840:                                      ; preds = %if.then3834
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.200) #14
  br label %if.end3957
...
if.else3841:                                      ; preds = %if.then3834
  ...
  %421 = load ptr, ptr %limits3843, align 8, !tbaa !62
  %tobool3844.not = icmp eq ptr %421, null
...
if.else3841.if.end3864_crit_edge:                 ; preds = %if.else3841
  %.pre7538 = zext i32 %sub3842 to i64
  br label %if.end3864

land.lhs.true3845:                                ; preds = %if.else3841
  %maxfilesize3847 = getelementptr inbounds %struct.cl_limits, ptr %421, i64 0, i32 5
  %422 = load i64, ptr %maxfilesize3847, align 8, !tbaa !63
  %tobool3848.not = icmp ne i64 %422, 0
  %conv3850 = zext i32 %sub3842 to i64
  %cmp3853 = icmp ult i64 %422, %conv3850
...
if.then3855:                                      ; preds = %land.lhs.true3845
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.201, i32 noundef %sub3842, i64 noundef %422) #14
  call void @free(ptr noundef nonnull %call341) #14
  %423 = load i32, ptr %options271, align 8, !tbaa !11
  %and3859 = and i32 %423, 256
...
if.then3861:                                      ; preds = %if.then3855
  %424 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr @.str.202, ptr %424, align 8, !tbaa !15
  br label %cleanup4880

if.end3864:                                       ; preds = %if.else3841.if.end3864_crit_edge, %land.lhs.true3845
  %conv3865.pre-phi = phi i64 [ %.pre7538, %if.else3841.if.end3864_crit_edge ], [ %conv3850, %land.lhs.true3845 ]
  %call3866 = call ptr @cli_calloc(i64 noundef %conv3865.pre-phi, i64 noundef 1) #14
...
for.body3875.lr.ph:                               ; preds = %for.cond3871.preheader
  ...
  %wide.trip.count7504 = zext i16 %8 to i64
  %add.ptr38907629 = getelementptr i8, ptr %call3866, i64 %idx.neg3892
  br label %for.body3875

if.then3869:                                      ; preds = %if.end3864
  %425 = load i32, ptr %dsize, align 4, !tbaa !5
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.203, i32 noundef %425) #14
  call void @free(ptr noundef nonnull %call341) #14
  br label %cleanup4880

for.body3875:                                     ; preds = %for.body3875.lr.ph, %for.inc3906
  %indvars.iv7501 = phi i64 [ 0, %for.body3875.lr.ph ], [ %indvars.iv.next7502, %for.inc3906 ]
  %arrayidx3877 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7501
  %raw3878 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7501, i32 2
  %426 = load i32, ptr %raw3878, align 4, !tbaa !42
  %tobool3879.not = icmp eq i32 %426, 0
...
lor.lhs.false3885:                                ; preds = %if.then3880
  %427 = load i32, ptr %arrayidx3877, align 4, !tbaa !38
  %idx.ext3889 = zext i32 %427 to i64
  %add.ptr3893 = getelementptr i8, ptr %add.ptr38907629, i64 %idx.ext3889
  %ursz3896 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7501, i32 8
  %428 = load i32, ptr %ursz3896, align 4, !tbaa !49
  %call3897 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %add.ptr3893, i32 noundef %428) #14
  %429 = load i32, ptr %ursz3896, align 4, !tbaa !49
  %cmp3901.not = icmp eq i32 %call3897, %429
  br i1 %cmp3901.not, label %for.inc3906, label %if.then3903

if.then3903:                                      ; preds = %lor.lhs.false3885, %if.then3880
  call void @free(ptr noundef nonnull %call341) #14
  call void @free(ptr noundef %call3866) #14
  br label %cleanup4880

for.inc3906:                                      ; preds = %for.body3875, %lor.lhs.false3885
  %indvars.iv.next7502 = add nuw nsw i64 %indvars.iv7501, 1
  %exitcond7505.not = icmp eq i64 %indvars.iv.next7502, %wide.trip.count7504
  br i1 %exitcond7505.not, label %for.end3908, label %for.body3875, !llvm.loop !70

for.end3908:                                      ; preds = %for.inc3906, %for.cond3871.preheader
  %call3909 = call ptr @cli_gentemp(ptr noundef null) #14
...
if.end3912:                                       ; preds = %for.end3908
  %call3913 = call i32 (ptr, i32, ...) @open(ptr noundef nonnull %call3909, i32 noundef 578, i32 noundef 448) #14
  %cmp3914 = icmp slt i32 %call3913, 0
  br i1 %cmp3914, label %if.then3916, label %if.end3917

if.then3916:                                      ; preds = %if.end3912
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.204, ptr noundef nonnull %call3909) #14
  call void @free(ptr noundef nonnull %call3909) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call3866, ptr noundef nonnull %call341, i32 noundef 0)
  br label %cleanup4880

if.end3917:                                       ; preds = %if.end3912
  %sub3923 = add nsw i32 %cmp3920.neg, %conv88
  %430 = load i32, ptr %ImageBase3798, align 4, !tbaa !25
  %arrayidx3925 = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 30, i64 2
  %431 = load i32, ptr %arrayidx3925, align 8, !tbaa !25
  %Size = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 30, i64 2, i32 1
  %432 = load i32, ptr %Size, align 4, !tbaa !25
  %call3929 = call i32 @petite_inflate2x_1to9(ptr noundef nonnull %call3866, i32 noundef %min.0.lcssa, i32 noundef %sub3842, ptr noundef nonnull %call341, i32 noundef %sub3923, i32 noundef %430, i32 noundef %vep.0, i32 noundef %call3913, i32 noundef %found.10, i32 noundef %431, i32 noundef %432) #14
  %cond4928 = icmp eq i32 %call3929, 0
  br i1 %cond4928, label %sw.bb3930, label %sw.default3952

sw.bb3930:                                        ; preds = %if.end3917
  %433 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool3931.not = icmp eq i8 %433, 0
  br i1 %tobool3931.not, label %if.else3933, label %if.then3932

if.then3932:                                      ; preds = %sw.bb3930
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.205, ptr noundef nonnull %call3909) #14
  br label %if.end3934

if.else3933:                                      ; preds = %sw.bb3930
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.206) #14
  br label %if.end3934

if.end3934:                                       ; preds = %if.else3933, %if.then3932
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call3866, i32 noundef 0)
  call void @free(ptr noundef nonnull %call341) #14
  %call3935 = call i32 @fsync(i32 noundef %call3913) #14
  %call3936 = call i64 @lseek(i32 noundef %call3913, i64 noundef 0, i32 noundef 0) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.138) #14
  %call3937 = call i32 @cli_magic_scandesc(i32 noundef %call3913, ptr noundef %ctx) #14
  %cmp3938 = icmp eq i32 %call3937, 1
  %call3941 = call i32 @close(i32 noundef %call3913) #14
  %434 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool3942.not = icmp eq i8 %434, 0
...
if.then3943:                                      ; preds = %if.then3940
  %call3944 = call i32 @unlink(ptr noundef nonnull %call3909) #14
  br label %if.end3945
...
if.then3949:                                      ; preds = %if.end3946
  %call3950 = call i32 @unlink(ptr noundef nonnull %call3909) #14
  br label %if.end3951
...
sw.default3952:                                   ; preds = %if.end3917
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.207) #14
  %call3953 = call i32 @close(i32 noundef %call3913) #14
  %call3954 = call i32 @unlink(ptr noundef nonnull %call3909) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call3866, i32 noundef 0)
  call void @free(ptr noundef nonnull %call3909) #14
  br label %if.end3957

if.end3957:                                       ; preds = %if.end3784, %lor.lhs.false3811, %if.then3840, %sw.default3952, %land.lhs.true3829
  %435 = load ptr, ptr %dconf1570, align 8, !tbaa !26
  %436 = load i32, ptr %435, align 4, !tbaa !27
  %and3960 = and i32 %436, 512
  %tobool3961 = icmp ne i32 %and3960, 0
  %cmp3964 = icmp ugt i16 %8, 1
  %or.cond4997 = select i1 %tobool3961, i1 %cmp3964, i1 false
...
land.lhs.true3966:                                ; preds = %if.end3957
  ...
  %437 = load i32, ptr %arrayidx3970, align 4, !tbaa !38
  %cmp3972.not = icmp ult i32 %vep.0, %437
...
land.lhs.true3974:                                ; preds = %land.lhs.true3966
  ...
  %438 = load i32, ptr %rsz3984, align 4, !tbaa !43
  %add3985 = add i32 %437, -12827
  %sub3987 = add i32 %add3985, %438
...
if.then3996:                                      ; preds = %land.lhs.true3990
  ...
  %439 = load ptr, ptr %limits3997, align 8, !tbaa !62
  %tobool3998.not = icmp eq ptr %439, null
  br i1 %tobool3998.not, label %if.end4017, label %land.lhs.true3999

land.lhs.true3999:                                ; preds = %if.then3996
  %maxfilesize4001 = getelementptr inbounds %struct.cl_limits, ptr %439, i64 0, i32 5
  %440 = load i64, ptr %maxfilesize4001, align 8, !tbaa !63
  %tobool4002.not = icmp ne i64 %440, 0
  %cmp4006 = icmp ugt i64 %67, %440
...
if.then4008:                                      ; preds = %land.lhs.true3999
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.209, i64 noundef %67, i64 noundef %440) #14
  call void @free(ptr noundef nonnull %call341) #14
  %441 = load i32, ptr %options271, align 8, !tbaa !11
  %and4012 = and i32 %441, 256
...
if.then4014:                                      ; preds = %if.then4008
  %442 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr @.str.210, ptr %442, align 8, !tbaa !15
  br label %cleanup4880

if.end4017:                                       ; preds = %land.lhs.true3999, %if.then3996
  %call4018 = call ptr @cli_malloc(i64 noundef %67) #14
...
if.end4022:                                       ; preds = %if.end4017
  %call4023 = call i64 @lseek(i32 noundef %desc, i64 noundef 0, i32 noundef 0) #14
  %conv4024 = trunc i64 %67 to i32
  %call4025 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %call4018, i32 noundef %conv4024) #14
...
if.then4029:                                      ; preds = %if.end4022
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.211, i64 noundef %67) #14
  call void @free(ptr noundef nonnull %call4018) #14
  call void @free(ptr noundef nonnull %call341) #14
  br label %cleanup4880

if.end4030:                                       ; preds = %if.end4022
  %call4031 = call ptr @cli_gentemp(ptr noundef null) #14
...
if.end4034:                                       ; preds = %if.end4030
  %call4035 = call i32 (ptr, i32, ...) @open(ptr noundef nonnull %call4031, i32 noundef 578, i32 noundef 448) #14
  %cmp4036 = icmp slt i32 %call4035, 0
  br i1 %cmp4036, label %if.then4038, label %if.end4039

if.then4038:                                      ; preds = %if.end4034
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.212, ptr noundef nonnull %call4031) #14
  call void @free(ptr noundef nonnull %call4031) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call4018, ptr noundef nonnull %call341, i32 noundef 0)
  br label %cleanup4880

if.end4039:                                       ; preds = %if.end4034
  %call4043 = call i32 @unspin(ptr noundef nonnull %call4018, i32 noundef %conv4024, ptr noundef nonnull %call341, i32 noundef %sub3968, i32 noundef %vep.0, i32 noundef %call4035, ptr noundef nonnull %ctx) #14
...
sw.bb4044:                                        ; preds = %if.end4039
  %443 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool4045.not = icmp eq i8 %443, 0
  br i1 %tobool4045.not, label %if.else4047, label %if.then4046

if.then4046:                                      ; preds = %sw.bb4044
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.213, ptr noundef nonnull %call4031) #14
  br label %if.end4048

if.else4047:                                      ; preds = %sw.bb4044
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.214) #14
  br label %if.end4048

if.end4048:                                       ; preds = %if.else4047, %if.then4046
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call4018, i32 noundef 0)
  call void @free(ptr noundef nonnull %call341) #14
  %call4049 = call i32 @fsync(i32 noundef %call4035) #14
  %call4050 = call i64 @lseek(i32 noundef %call4035, i64 noundef 0, i32 noundef 0) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.138) #14
  %call4051 = call i32 @cli_magic_scandesc(i32 noundef %call4035, ptr noundef nonnull %ctx) #14
  %cmp4052 = icmp eq i32 %call4051, 1
  %call4055 = call i32 @close(i32 noundef %call4035) #14
  %444 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool4056.not = icmp eq i8 %444, 0
...
if.then4057:                                      ; preds = %if.then4054
  %call4058 = call i32 @unlink(ptr noundef nonnull %call4031) #14
  br label %if.end4059
...
if.then4063:                                      ; preds = %if.end4060
  %call4064 = call i32 @unlink(ptr noundef nonnull %call4031) #14
  br label %if.end4065
...
sw.bb4066:                                        ; preds = %if.end4039
  call void @free(ptr noundef nonnull %call4018) #14
  %call4067 = call i32 @close(i32 noundef %call4035) #14
  %call4068 = call i32 @unlink(ptr noundef nonnull %call4031) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.215) #14
  %445 = load i32, ptr %options271, align 8, !tbaa !11
  %and4070 = and i32 %445, 256
...
if.then4072:                                      ; preds = %sw.bb4066
  call void @free(ptr noundef nonnull %call341) #14
  %446 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr @.str.216, ptr %446, align 8, !tbaa !15
  br label %cleanup4880

sw.default4075:                                   ; preds = %if.end4039
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.217) #14
  %call4076 = call i32 @close(i32 noundef %call4035) #14
  %call4077 = call i32 @unlink(ptr noundef nonnull %call4031) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call4018, i32 noundef 0)
  call void @free(ptr noundef nonnull %call4031) #14
  br label %if.end4082

if.end4082:                                       ; preds = %sw.bb4066, %if.then3802, %sw.default4075, %land.lhs.true3990, %land.lhs.true3974, %land.lhs.true3966, %if.end3957
  %cmp39647579 = phi i1 [ %cmp3964, %sw.default4075 ], [ %cmp3964, %land.lhs.true3990 ], [ %cmp3964, %land.lhs.true3974 ], [ %cmp3964, %land.lhs.true3966 ], [ %cmp3964, %if.end3957 ], [ false, %if.then3802 ], [ %cmp3964, %sw.bb4066 ]
  %447 = load ptr, ptr %dconf1570, align 8, !tbaa !26
  %448 = load i32, ptr %447, align 4, !tbaa !27
  %and4085 = and i32 %448, 1024
  %tobool4086 = icmp ne i32 %and4085, 0
  %or.cond4998 = select i1 %tobool4086, i1 %cmp39647579, i1 false
...
land.lhs.true4091:                                ; preds = %if.end4082
  ...
  %449 = load i32, ptr %AddressOfEntryPoint4092, align 8, !tbaa !25
  ...
  %450 = load i32, ptr %arrayidx4096, align 4, !tbaa !38
  %add4098 = add i32 %450, 96
  %cmp4099 = icmp eq i32 %449, %add4098
...
land.lhs.true4106:                                ; preds = %land.lhs.true4101
  ...
  %451 = load i32, ptr %raw4111, align 4, !tbaa !42
  %add4113 = add i32 %451, 3165
...
if.then4117:                                      ; preds = %land.lhs.true4106
  %call4119 = call ptr @cli_malloc(i64 noundef %67) #14
...
if.end4123:                                       ; preds = %if.then4117
  %call4124 = call i64 @lseek(i32 noundef %desc, i64 noundef 0, i32 noundef 0) #14
  %conv4125 = trunc i64 %67 to i32
  %call4126 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %call4119, i32 noundef %conv4125) #14
...
if.then4130:                                      ; preds = %if.end4123
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.219, i64 noundef %67) #14
  call void @free(ptr noundef nonnull %call4119) #14
  call void @free(ptr noundef nonnull %call341) #14
  br label %cleanup4880

if.end4131:                                       ; preds = %if.end4123
  %call4132 = call ptr @cli_gentemp(ptr noundef null) #14
...
if.end4135:                                       ; preds = %if.end4131
  %call4136 = call i32 (ptr, i32, ...) @open(ptr noundef nonnull %call4132, i32 noundef 578, i32 noundef 448) #14
  %cmp4137 = icmp slt i32 %call4136, 0
  br i1 %cmp4137, label %if.then4139, label %if.end4140

if.then4139:                                      ; preds = %if.end4135
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.220, ptr noundef nonnull %call4132) #14
  call void @free(ptr noundef nonnull %call4132) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call4119, ptr noundef nonnull %call341, i32 noundef 0)
  br label %cleanup4880

if.end4140:                                       ; preds = %if.end4135
  %452 = load i32, ptr %e_lfanew, align 4, !tbaa !5
  %call4144 = call i32 @yc_decrypt(ptr noundef nonnull %call4119, i32 noundef %conv4125, ptr noundef nonnull %call341, i32 noundef %sub4094, i32 noundef %452, i32 noundef %call4136) #14
  %cond4926 = icmp eq i32 %call4144, 0
  br i1 %cond4926, label %sw.bb4145, label %cleanup4171

sw.bb4145:                                        ; preds = %if.end4140
  %453 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool4146.not = icmp eq i8 %453, 0
  br i1 %tobool4146.not, label %if.else4148, label %if.then4147

if.then4147:                                      ; preds = %sw.bb4145
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.221, ptr noundef nonnull %call4132) #14
  br label %if.end4149
...
if.end4149:                                       ; preds = %if.else4148, %if.then4147
  ...
  call void @free(ptr noundef nonnull %call341) #14
  %call4150 = call i32 @fsync(i32 noundef %call4136) #14
  %call4151 = call i64 @lseek(i32 noundef %call4136, i64 noundef 0, i32 noundef 0) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.138) #14
  %call4152 = call i32 @cli_magic_scandesc(i32 noundef %call4136, ptr noundef nonnull %ctx) #14
  %cmp4153 = icmp eq i32 %call4152, 1
  %call4156 = call i32 @close(i32 noundef %call4136) #14
  %454 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool4157.not = icmp eq i8 %454, 0
...
if.then4158:                                      ; preds = %if.then4155
  %call4159 = call i32 @unlink(ptr noundef nonnull %call4132) #14
  br label %if.end4160
...
if.then4164:                                      ; preds = %if.end4161
  %call4165 = call i32 @unlink(ptr noundef nonnull %call4132) #14
  br label %if.end4166
...
cleanup4171:                                      ; preds = %if.end4140
  ...
  %call4168 = call i32 @close(i32 noundef %call4136) #14
  %call4169 = call i32 @unlink(ptr noundef nonnull %call4132) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call4119, i32 noundef 0)
  call void @free(ptr noundef nonnull %call4132) #14
  %.pre7532 = load ptr, ptr %dconf1570, align 8, !tbaa !26
  %.pre7533 = load i32, ptr %.pre7532, align 4, !tbaa !27
  br label %if.end4174

if.end4174:                                       ; preds = %cleanup4171, %land.lhs.true4106, %land.lhs.true4101, %land.lhs.true4091, %if.end4082
  %455 = phi i32 [ %.pre7533, %cleanup4171 ], [ %448, %land.lhs.true4106 ], [ %448, %land.lhs.true4101 ], [ %448, %land.lhs.true4091 ], [ %448, %if.end4082 ]
  %and4177 = and i32 %455, 2048
  %tobool4178 = icmp ne i32 %and4177, 0
  %or.cond4999 = select i1 %tobool4178, i1 %cmp39647579, i1 false
...
land.lhs.true4183:                                ; preds = %if.end4174
  ...
  %456 = load i32, ptr %raw4188, align 4, !tbaa !42
  %cmp4189 = icmp ugt i32 %456, 689
  br i1 %cmp4189, label %land.lhs.true4191, label %while.cond4442

land.lhs.true4191:                                ; preds = %land.lhs.true4183
  %457 = load i32, ptr %arrayidx4187, align 4, !tbaa !38
  %cmp4197 = icmp eq i32 %vep.0, %457
...
land.lhs.true4199:                                ; preds = %land.lhs.true4191
  ...
  %458 = load i32, ptr %rsz4209, align 4, !tbaa !43
  %add4210 = add i32 %458, %vep.0
...
for.body4236.preheader:                           ; preds = %for.cond4231.preheader
  %min.iters.check = icmp ult i32 %sub4185, 8
  br i1 %min.iters.check, label %for.body4236.preheader7631, label %vector.ph

vector.ph:                                        ; preds = %for.body4236.preheader
  %n.vec = and i64 %idxprom4186, 4294967288
  %minmax.ident.splatinsert = insertelement <4 x i32> poison, i32 %456, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi = phi <4 x i32> [ %minmax.ident.splat, %vector.ph ], [ %490, %vector.body ]
  %vec.phi7627 = phi <4 x i32> [ %minmax.ident.splat, %vector.ph ], [ %491, %vector.body ]
  %459 = or i64 %index, 1
  %460 = or i64 %index, 2
  %461 = or i64 %index, 3
  %462 = or i64 %index, 4
  ...
  %464 = or i64 %index, 6
  %465 = or i64 %index, 7
  %466 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %index, i32 2
  %467 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %459, i32 2
  %468 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %460, i32 2
  %469 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %461, i32 2
  %470 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %462, i32 2
  %471 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %463, i32 2
  %472 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %464, i32 2
  %473 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %465, i32 2
  %474 = load i32, ptr %466, align 4, !tbaa !42
  %475 = load i32, ptr %467, align 4, !tbaa !42
  %476 = load i32, ptr %468, align 4, !tbaa !42
  %477 = load i32, ptr %469, align 4, !tbaa !42
  %478 = insertelement <4 x i32> poison, i32 %474, i64 0
  %479 = insertelement <4 x i32> %478, i32 %475, i64 1
  %480 = insertelement <4 x i32> %479, i32 %476, i64 2
  %481 = insertelement <4 x i32> %480, i32 %477, i64 3
  %482 = load i32, ptr %470, align 4, !tbaa !42
  %483 = load i32, ptr %471, align 4, !tbaa !42
  %484 = load i32, ptr %472, align 4, !tbaa !42
  %485 = load i32, ptr %473, align 4, !tbaa !42
  %486 = insertelement <4 x i32> poison, i32 %482, i64 0
  %487 = insertelement <4 x i32> %486, i32 %483, i64 1
  %488 = insertelement <4 x i32> %487, i32 %484, i64 2
  %489 = insertelement <4 x i32> %488, i32 %485, i64 3
  %490 = call <4 x i32> @llvm.umin.v4i32(<4 x i32> %481, <4 x i32> %vec.phi)
  %491 = call <4 x i32> @llvm.umin.v4i32(<4 x i32> %489, <4 x i32> %vec.phi7627)
  %index.next = add nuw i64 %index, 8
  %492 = icmp eq i64 %index.next, %n.vec
  br i1 %492, label %middle.block, label %vector.body, !llvm.loop !71

middle.block:                                     ; preds = %vector.body
  %rdx.minmax.select = call <4 x i32> @llvm.umin.v4i32(<4 x i32> %490, <4 x i32> %491)
  %493 = call i32 @llvm.vector.reduce.umin.v4i32(<4 x i32> %rdx.minmax.select)
  %cmp.n = icmp eq i64 %n.vec, %idxprom4186
  br i1 %cmp.n, label %for.end4249, label %for.body4236.preheader7631

for.body4236.preheader7631:                       ; preds = %for.body4236.preheader, %middle.block
  %indvars.iv7506.ph = phi i64 [ 0, %for.body4236.preheader ], [ %n.vec, %middle.block ]
  %headsize.07425.ph = phi i32 [ %456, %for.body4236.preheader ], [ %493, %middle.block ]
  br label %for.body4236

for.body4236:                                     ; preds = %for.body4236.preheader7631, %for.body4236
  %indvars.iv7506 = phi i64 [ %indvars.iv.next7507, %for.body4236 ], [ %indvars.iv7506.ph, %for.body4236.preheader7631 ]
  %headsize.07425 = phi i32 [ %spec.select7096, %for.body4236 ], [ %headsize.07425.ph, %for.body4236.preheader7631 ]
  %raw4239 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7506, i32 2
  %494 = load i32, ptr %raw4239, align 4, !tbaa !42
  %spec.select7096 = call i32 @llvm.umin.i32(i32 %494, i32 %headsize.07425)
  %indvars.iv.next7507 = add nuw nsw i64 %indvars.iv7506, 1
  %exitcond7510.not = icmp eq i64 %indvars.iv.next7507, %idxprom4186
  br i1 %exitcond7510.not, label %for.end4249, label %for.body4236, !llvm.loop !74

for.end4249:                                      ; preds = %for.body4236, %middle.block, %for.cond4231.preheader
  %headsize.0.lcssa = phi i32 [ %456, %for.cond4231.preheader ], [ %493, %middle.block ], [ %spec.select7096, %for.body4236 ]
  %495 = add i32 %min.0.lcssa, %458
  %496 = sub i32 %max.0.lcssa, %495
  %sub4257 = add i32 %496, %headsize.0.lcssa
  store i32 %sub4257, ptr %dsize, align 4, !tbaa !5
  %limits4258 = getelementptr inbounds %struct.cli_ctx, ptr %ctx, i64 0, i32 4
  %497 = load ptr, ptr %limits4258, align 8, !tbaa !62
  %tobool4259.not = icmp eq ptr %497, null
...
for.end4249.if.end4279_crit_edge:                 ; preds = %for.end4249
  %.pre7536 = zext i32 %sub4257 to i64
  br label %if.end4279

land.lhs.true4260:                                ; preds = %for.end4249
  %maxfilesize4262 = getelementptr inbounds %struct.cl_limits, ptr %497, i64 0, i32 5
  %498 = load i64, ptr %maxfilesize4262, align 8, !tbaa !63
  %tobool4263.not = icmp ne i64 %498, 0
  %conv4265 = zext i32 %sub4257 to i64
  %cmp4268 = icmp ult i64 %498, %conv4265
...
if.then4270:                                      ; preds = %land.lhs.true4260
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.226, i32 noundef %sub4257, i64 noundef %498) #14
  call void @free(ptr noundef nonnull %call341) #14
  %499 = load i32, ptr %options271, align 8, !tbaa !11
  %and4274 = and i32 %499, 256
...
if.then4276:                                      ; preds = %if.then4270
  %500 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr @.str.227, ptr %500, align 8, !tbaa !15
  br label %cleanup4880

if.end4279:                                       ; preds = %for.end4249.if.end4279_crit_edge, %land.lhs.true4260
  %conv4280.pre-phi = phi i64 [ %.pre7536, %for.end4249.if.end4279_crit_edge ], [ %conv4265, %land.lhs.true4260 ]
  %call4281 = call ptr @cli_calloc(i64 noundef %conv4280.pre-phi, i64 noundef 1) #14
  %cmp4282 = icmp eq ptr %call4281, null
  br i1 %cmp4282, label %if.then4284, label %if.end4285

if.then4284:                                      ; preds = %if.end4279
  %501 = load i32, ptr %dsize, align 4, !tbaa !5
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.228, i32 noundef %501) #14
  call void @free(ptr noundef nonnull %call341) #14
  br label %cleanup4880

if.end4285:                                       ; preds = %if.end4279
  %call4286 = call i64 @lseek(i32 noundef %desc, i64 noundef 0, i32 noundef 0) #14
  %call4287 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %call4281, i32 noundef %headsize.0.lcssa) #14
...
for.body4299.lr.ph:                               ; preds = %for.cond4294.preheader
  ...
  %add.ptr43167628 = getelementptr i8, ptr %add.ptr4311, i64 %idx.neg4318
  br label %for.body4299

if.then4292:                                      ; preds = %if.end4285
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.229, i32 noundef %headsize.0.lcssa) #14
  call void @free(ptr noundef nonnull %call4281) #14
  call void @free(ptr noundef nonnull %call341) #14
  br label %cleanup4880

for.body4299:                                     ; preds = %for.body4299.lr.ph, %for.inc4332
  %indvars.iv7511 = phi i64 [ 0, %for.body4299.lr.ph ], [ %indvars.iv.next7512, %for.inc4332 ]
  %arrayidx4301 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7511
  %rsz4302 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7511, i32 3
  %502 = load i32, ptr %rsz4302, align 4, !tbaa !43
  %tobool4303.not = icmp eq i32 %502, 0
...
lor.lhs.false4309:                                ; preds = %if.then4304
  %503 = load i32, ptr %arrayidx4301, align 4, !tbaa !38
  %idx.ext4315 = zext i32 %503 to i64
  %add.ptr4319 = getelementptr i8, ptr %add.ptr43167628, i64 %idx.ext4315
  %504 = load i32, ptr %rsz4302, align 4, !tbaa !43
  %call4323 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %add.ptr4319, i32 noundef %504) #14
  %505 = load i32, ptr %rsz4302, align 4, !tbaa !43
  %cmp4327.not = icmp eq i32 %call4323, %505
  br i1 %cmp4327.not, label %for.inc4332, label %if.then4329

if.then4329:                                      ; preds = %lor.lhs.false4309, %if.then4304
  call void @free(ptr noundef %call4281) #14
  call void @free(ptr noundef nonnull %call341) #14
  br label %cleanup4880
...
for.inc4332:                                      ; preds = %for.body4299, %lor.lhs.false4309
  ...
  br i1 %exitcond7515.not, label %for.end4334, label %for.body4299, !llvm.loop !75

for.end4334:                                      ; preds = %for.inc4332, %for.cond4294.preheader
  %506 = load i32, ptr %rsz4209, align 4, !tbaa !43
  %conv4340 = zext i32 %506 to i64
  %call4341 = call ptr @cli_calloc(i64 noundef %conv4340, i64 noundef 1) #14
  %cmp4342 = icmp eq ptr %call4341, null
  br i1 %cmp4342, label %if.then4344, label %if.end4350

if.then4344:                                      ; preds = %for.end4334
  %507 = load i32, ptr %rsz4209, align 4, !tbaa !43
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.228, i32 noundef %507) #14
  call void @free(ptr noundef %call4281) #14
  call void @free(ptr noundef nonnull %call341) #14
  br label %cleanup4880
...
if.end4350:                                       ; preds = %for.end4334
  ...
  %.pre7534 = load i32, ptr %rsz4209, align 4, !tbaa !43
  br i1 %tobool4356.not, label %if.then4373, label %lor.lhs.false4357

lor.lhs.false4357:                                ; preds = %if.end4350
  %call4363 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %call4341, i32 noundef %.pre7534) #14
  %conv4364 = sext i32 %call4363 to i64
  %508 = load i32, ptr %rsz4209, align 4, !tbaa !43
  %conv4370 = zext i32 %508 to i64
...
if.then4373:                                      ; preds = %if.end4350, %lor.lhs.false4357
  %509 = phi i32 [ %508, %lor.lhs.false4357 ], [ %.pre7534, %if.end4350 ]
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.230, i32 noundef %509) #14
  call void @free(ptr noundef %call4281) #14
  call void @free(ptr noundef nonnull %call4341) #14
  call void @free(ptr noundef nonnull %call341) #14
  br label %cleanup4880

if.end4379:                                       ; preds = %lor.lhs.false4357
  %510 = load i32, ptr %dsize, align 4, !tbaa !5
  %511 = load i32, ptr %arrayidx4187, align 4, !tbaa !38
  %512 = load i32, ptr %e_lfanew, align 4, !tbaa !5
  %conv4392 = trunc i32 %sub4185 to i16
  %call4393 = call i32 @wwunpack(ptr noundef nonnull %call4281, i32 noundef %510, i32 noundef %headsize.0.lcssa, i32 noundef %min.0.lcssa, i32 noundef %511, i32 noundef %512, ptr noundef nonnull %call4341, i32 noundef %508, i16 noundef zeroext %conv4392) #14
...
if.then4395:                                      ; preds = %if.end4379
  %call4396 = call ptr @cli_gentemp(ptr noundef null) #14
...
if.end4399:                                       ; preds = %if.then4395
  %call4400 = call i32 (ptr, i32, ...) @open(ptr noundef nonnull %call4396, i32 noundef 578, i32 noundef 448) #14
  %cmp4401 = icmp slt i32 %call4400, 0
  br i1 %cmp4401, label %if.then4403, label %if.end4404

if.then4403:                                      ; preds = %if.end4399
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.231, ptr noundef nonnull %call4396) #14
  call void @free(ptr noundef nonnull %call4396) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call4281, ptr noundef nonnull %call341, i32 noundef 0)
  br label %cleanup4880

if.end4404:                                       ; preds = %if.end4399
  %513 = load i32, ptr %dsize, align 4, !tbaa !5
  %conv4405 = zext i32 %513 to i64
  %call4406 = call i64 @write(i32 noundef %call4400, ptr noundef nonnull %call4281, i64 noundef %conv4405) #14
  %conv4407 = trunc i64 %call4406 to i32
  %514 = load i32, ptr %dsize, align 4, !tbaa !5
  %cmp4408.not = icmp eq i32 %514, %conv4407
  br i1 %cmp4408.not, label %if.end4412, label %if.then4410

if.then4410:                                      ; preds = %if.end4404
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.232, i32 noundef %514) #14
  %call4411 = call i32 @close(i32 noundef %call4400) #14
  call void @free(ptr noundef nonnull %call4396) #14
  call void @free(ptr noundef %call4281) #14
  call void @free(ptr noundef nonnull %call341) #14
  br label %cleanup4880
...
if.end4412:                                       ; preds = %if.end4404
  call void @free(ptr noundef %call4281) #14
  %515 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool4413.not = icmp eq i8 %515, 0
  br i1 %tobool4413.not, label %if.else4415, label %if.then4414

if.then4414:                                      ; preds = %if.end4412
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.233, ptr noundef nonnull %call4396) #14
  br label %if.end4416

if.else4415:                                      ; preds = %if.end4412
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.234) #14
  br label %if.end4416

if.end4416:                                       ; preds = %if.else4415, %if.then4414
  %call4417 = call i32 @fsync(i32 noundef %call4400) #14
  %call4418 = call i64 @lseek(i32 noundef %call4400, i64 noundef 0, i32 noundef 0) #14
  %call4419 = call i32 @cli_magic_scandesc(i32 noundef %call4400, ptr noundef %ctx) #14
  %cmp4420 = icmp eq i32 %call4419, 1
  br i1 %cmp4420, label %if.then4422, label %if.end4428

if.then4422:                                      ; preds = %if.end4416
  call void @free(ptr noundef nonnull %call341) #14
  %call4423 = call i32 @close(i32 noundef %call4400) #14
  %516 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool4424.not = icmp eq i8 %516, 0
  br i1 %tobool4424.not, label %if.then4425, label %if.end4427

if.then4425:                                      ; preds = %if.then4422
  %call4426 = call i32 @unlink(ptr noundef nonnull %call4396) #14
  br label %if.end4427
...
if.end4428:                                       ; preds = %if.end4416
  %call4429 = call i32 @close(i32 noundef %call4400) #14
  %517 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool4430.not = icmp eq i8 %517, 0
  br i1 %tobool4430.not, label %if.then4431, label %if.end4433

if.then4431:                                      ; preds = %if.end4428
  %call4432 = call i32 @unlink(ptr noundef nonnull %call4396) #14
  br label %if.end4433
...
if.else4434:                                      ; preds = %if.end4379
  call void @free(ptr noundef %call4281) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.235) #14
  br label %while.cond4442

while.cond4442:                                   ; preds = %if.else4434, %if.end4433, %if.end4174, %land.lhs.true4183, %land.lhs.true4191, %land.lhs.true4199, %land.lhs.true4213, %land.lhs.true4218
  %518 = load ptr, ptr %dconf1570, align 8, !tbaa !26
  %519 = load i32, ptr %518, align 4, !tbaa !27
  %and4445 = and i32 %519, 32768
...
land.rhs4453:                                     ; preds = %while.cond4442
  ...
  %520 = icmp ne i64 %lhsv, -1447625805222647712
  %cmp4459 = icmp ult i32 %call906, 959
  %or.cond5006 = select i1 %520, i1 true, i1 %cmp4459
...
for.body4472.preheader:                           ; preds = %lor.lhs.false4461
  %wide.trip.count7519 = zext i16 %8 to i64
  %xtraiter7653 = and i64 %wide.trip.count7519, 1
  %521 = icmp eq i16 %8, 1
  br i1 %521, label %for.end4493.unr-lcssa, label %for.body4472.preheader.new

for.body4472.preheader.new:                       ; preds = %for.body4472.preheader
  %unroll_iter7656 = and i64 %wide.trip.count7519, 65534
  br label %for.body4472

for.body4472:                                     ; preds = %for.body4472, %for.body4472.preheader.new
  %indvars.iv7516 = phi i64 [ 0, %for.body4472.preheader.new ], [ %indvars.iv.next7517.1, %for.body4472 ]
  %522 = phi i32 [ 0, %for.body4472.preheader.new ], [ %spec.select7099.1, %for.body4472 ]
  %niter7657 = phi i64 [ 0, %for.body4472.preheader.new ], [ %niter7657.next.1, %for.body4472 ]
  %arrayidx4474 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7516
  %523 = load i32, ptr %arrayidx4474, align 4, !tbaa !38
  %vsz4478 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7516, i32 1
  %524 = load i32, ptr %vsz4478, align 4, !tbaa !41
  %add4479 = add i32 %524, %523
  %add4479.fr = freeze i32 %add4479
  %spec.select7099 = call i32 @llvm.umax.i32(i32 %522, i32 %add4479.fr)
  %indvars.iv.next7517 = or i64 %indvars.iv7516, 1
  %arrayidx4474.1 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv.next7517
  %525 = load i32, ptr %arrayidx4474.1, align 4, !tbaa !38
  %vsz4478.1 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv.next7517, i32 1
  %526 = load i32, ptr %vsz4478.1, align 4, !tbaa !41
  %add4479.1 = add i32 %526, %525
  %add4479.fr.1 = freeze i32 %add4479.1
  %spec.select7099.1 = call i32 @llvm.umax.i32(i32 %spec.select7099, i32 %add4479.fr.1)
  %indvars.iv.next7517.1 = add nuw nsw i64 %indvars.iv7516, 2
  %niter7657.next.1 = add i64 %niter7657, 2
  %niter7657.ncmp.1 = icmp eq i64 %niter7657.next.1, %unroll_iter7656
  br i1 %niter7657.ncmp.1, label %for.end4493.unr-lcssa, label %for.body4472, !llvm.loop !76
...
for.end4493.unr-lcssa:                            ; preds = %for.body4472, %for.body4472.preheader
  ...
  %indvars.iv7516.unr = phi i64 [ 0, %for.body4472.preheader ], [ %indvars.iv.next7517.1, %for.body4472 ]
  %.unr = phi i32 [ 0, %for.body4472.preheader ], [ %spec.select7099.1, %for.body4472 ]
  %lcmp.mod7654.not = icmp eq i64 %xtraiter7653, 0
  br i1 %lcmp.mod7654.not, label %for.end4493, label %for.body4472.epil

for.body4472.epil:                                ; preds = %for.end4493.unr-lcssa
  %arrayidx4474.epil = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7516.unr
  %527 = load i32, ptr %arrayidx4474.epil, align 4, !tbaa !38
  %vsz4478.epil = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7516.unr, i32 1
  %528 = load i32, ptr %vsz4478.epil, align 4, !tbaa !41
  %add4479.epil = add i32 %528, %527
...
if.end4496:                                       ; preds = %for.end4493
  ...
  %529 = load ptr, ptr %limits4497, align 8, !tbaa !62
  %tobool4498.not = icmp eq ptr %529, null
...
if.end4496.if.end4518_crit_edge:                  ; preds = %if.end4496
  %.pre7537 = zext i32 %spec.select7099.lcssa to i64
  br label %if.end4518

land.lhs.true4499:                                ; preds = %if.end4496
  %maxfilesize4501 = getelementptr inbounds %struct.cl_limits, ptr %529, i64 0, i32 5
  %530 = load i64, ptr %maxfilesize4501, align 8, !tbaa !63
  %tobool4502.not = icmp ne i64 %530, 0
  %conv4504 = zext i32 %spec.select7099.lcssa to i64
  %cmp4507 = icmp ult i64 %530, %conv4504
...
if.then4509:                                      ; preds = %land.lhs.true4499
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.238, i32 noundef %spec.select7099.lcssa, i64 noundef %530) #14
  call void @free(ptr noundef nonnull %call341) #14
  %531 = load i32, ptr %options271, align 8, !tbaa !11
  %and4513 = and i32 %531, 256
...
if.then4515:                                      ; preds = %if.then4509
  %532 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr @.str.239, ptr %532, align 8, !tbaa !15
  br label %cleanup4880

if.end4518:                                       ; preds = %if.end4496.if.end4518_crit_edge, %land.lhs.true4499
  %conv4519.pre-phi = phi i64 [ %.pre7537, %if.end4496.if.end4518_crit_edge ], [ %conv4504, %land.lhs.true4499 ]
  %call4520 = call ptr @cli_calloc(i64 noundef %conv4519.pre-phi, i64 noundef 1) #14
...
for.body4528:                                     ; preds = %for.body4528.lr.ph, %for.inc4609
  %indvars.iv7521 = phi i64 [ 0, %for.body4528.lr.ph ], [ %indvars.iv.next7522, %for.inc4609 ]
  %arrayidx4530 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7521
  %rsz4531 = getelementptr inbounds %struct.cli_exe_section, ptr %call341, i64 %indvars.iv7521, i32 3
  %533 = load i32, ptr %rsz4531, align 4, !tbaa !43
  %tobool4532.not = icmp eq i32 %533, 0
...
land.lhs.true4543:                                ; preds = %if.end4534
  %534 = load i32, ptr %rsz4531, align 4, !tbaa !43
  %535 = add i32 %534, -1
  %or.cond7101.not = icmp ult i32 %535, %spec.select7099.lcssa
  br i1 %or.cond7101.not, label %land.lhs.true4555, label %for.end4611.loopexit

land.lhs.true4555:                                ; preds = %land.lhs.true4543
  %536 = load i32, ptr %arrayidx4530, align 4, !tbaa !38
  %idx.ext4559 = zext i32 %536 to i64
  %add.ptr4560 = getelementptr inbounds i8, ptr %call4520, i64 %idx.ext4559
  %idx.ext4572 = zext i32 %534 to i64
...
if.end4592:                                       ; preds = %land.lhs.true4555
  %call4601 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %add.ptr4560, i32 noundef %534) #14
  %537 = load i32, ptr %rsz4531, align 4, !tbaa !43
  %cmp4605.not = icmp eq i32 %call4601, %537
...
for.inc4609:                                      ; preds = %if.end4592, %for.body4528
  ...
  br i1 %exitcond7525.not, label %if.end4616, label %for.body4528, !llvm.loop !77

for.end4611.loopexit:                             ; preds = %if.end4592, %land.lhs.true4543, %land.lhs.true4555, %if.end4534
  %538 = trunc i64 %indvars.iv7521 to i32
  br label %for.end4611

for.end4611:                                      ; preds = %for.end4611.loopexit, %for.cond4524.preheader
  %i.12.lcssa = phi i32 [ 0, %for.cond4524.preheader ], [ %538, %for.end4611.loopexit ]
...
if.then4615:                                      ; preds = %for.end4611
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.240) #14
  call void @free(ptr noundef %call4520) #14
  br label %while.cond4656

if.end4616:                                       ; preds = %for.inc4609, %for.end4611
  %call4617 = call ptr @cli_gentemp(ptr noundef null) #14
...
if.end4620:                                       ; preds = %if.end4616
  %call4621 = call i32 (ptr, i32, ...) @open(ptr noundef nonnull %call4617, i32 noundef 578, i32 noundef 448) #14
  %cmp4622 = icmp slt i32 %call4621, 0
  br i1 %cmp4622, label %if.then4624, label %if.end4625

if.then4624:                                      ; preds = %if.end4620
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.241, ptr noundef nonnull %call4617) #14
  call void @free(ptr noundef nonnull %call4617) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call4520, ptr noundef nonnull %call341, i32 noundef 0)
  br label %cleanup4880
...
if.end4625:                                       ; preds = %if.end4620
  ...
  %539 = load i32, ptr %ImageBase4627, align 4, !tbaa !25
  %call4628 = call i32 @unaspack212(ptr noundef nonnull %call4520, i32 noundef %spec.select7099.lcssa, ptr noundef nonnull %call341, i16 noundef zeroext %8, i32 noundef %sub4626, i32 noundef %539, i32 noundef %call4621) #14
  %cond4923 = icmp eq i32 %call4628, 1
  br i1 %cond4923, label %sw.bb4629, label %sw.default4651

sw.bb4629:                                        ; preds = %if.end4625
  %540 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool4630.not = icmp eq i8 %540, 0
  br i1 %tobool4630.not, label %if.else4632, label %if.then4631

if.then4631:                                      ; preds = %sw.bb4629
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.242, ptr noundef nonnull %call4617) #14
  br label %if.end4633

if.else4632:                                      ; preds = %sw.bb4629
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.243) #14
  br label %if.end4633

if.end4633:                                       ; preds = %if.else4632, %if.then4631
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call4520, i32 noundef 0)
  call void @free(ptr noundef nonnull %call341) #14
  %call4634 = call i32 @fsync(i32 noundef %call4621) #14
  %call4635 = call i64 @lseek(i32 noundef %call4621, i64 noundef 0, i32 noundef 0) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.138) #14
  %call4636 = call i32 @cli_magic_scandesc(i32 noundef %call4621, ptr noundef %ctx) #14
  %cmp4637 = icmp eq i32 %call4636, 1
  %call4640 = call i32 @close(i32 noundef %call4621) #14
  %541 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool4641.not = icmp eq i8 %541, 0
...
if.then4642:                                      ; preds = %if.then4639
  %call4643 = call i32 @unlink(ptr noundef nonnull %call4617) #14
  br label %if.end4644
...
if.then4648:                                      ; preds = %if.end4645
  %call4649 = call i32 @unlink(ptr noundef nonnull %call4617) #14
  br label %if.end4650
...
sw.default4651:                                   ; preds = %if.end4625
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.244) #14
  %call4652 = call i32 @close(i32 noundef %call4621) #14
  %call4653 = call i32 @unlink(ptr noundef nonnull %call4617) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call4520, i32 noundef 0)
  call void @free(ptr noundef nonnull %call4617) #14
  br label %while.cond4656

while.cond4656:                                   ; preds = %lor.lhs.false4461, %land.rhs4453, %if.then4615, %sw.default4651, %for.end4493, %while.cond4442
  %542 = load ptr, ptr %dconf1570, align 8, !tbaa !26
  %543 = load i32, ptr %542, align 4, !tbaa !27
  %and4659 = and i32 %543, 4096
...
while.body4661:                                   ; preds = %while.cond4656
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %nbuff) #14
  %544 = load i8, ptr %epbuff, align 16, !tbaa !25
  %cmp4669 = icmp eq i8 %544, -23
...
if.then4671:                                      ; preds = %while.body4661
  ...
  %545 = load i32, ptr %err, align 4
  %tobool4680 = icmp ne i32 %545, 0
...
if.end4682:                                       ; preds = %if.then4671
  ...
  %call4684 = call i64 @lseek(i32 noundef %desc, i64 noundef %conv4683, i32 noundef 0) #14
  %cmp4685 = icmp eq i64 %call4684, -1
  br i1 %cmp4685, label %cleanup4869.thread, label %if.end4688

if.end4688:                                       ; preds = %if.end4682
  %call4690 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %nbuff, i32 noundef 24) #14
...
if.end4700:                                       ; preds = %if.end4696
  ...
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.246, i32 noundef %sub4703) #14
  %sub4704 = sub i32 %rep.0, %sub4703
  %conv4705 = zext i32 %sub4704 to i64
  %call4706 = call i64 @lseek(i32 noundef %desc, i64 noundef %conv4705, i32 noundef 0) #14
  %cmp4707 = icmp eq i64 %call4706, -1
  br i1 %cmp4707, label %cleanup4869.thread, label %if.end4710

if.end4710:                                       ; preds = %if.end4700
  %call4712 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %nbuff, i32 noundef 4) #14
...
if.end4716:                                       ; preds = %if.end4710
  ...
  %call4721 = call i64 @lseek(i32 noundef %desc, i64 noundef %conv4720, i32 noundef 0) #14
  %cmp4722 = icmp eq i64 %call4721, -1
  br i1 %cmp4722, label %cleanup4869.thread, label %if.end4725

if.end4725:                                       ; preds = %if.end4716
  %call4727 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %nbuff, i32 noundef 20) #14
...
if.end4731:                                       ; preds = %if.end4725
  ...
  %546 = load ptr, ptr %limits4745, align 8, !tbaa !62
  %tobool4746.not = icmp eq ptr %546, null
  br i1 %tobool4746.not, label %if.end4778, label %land.lhs.true4747

land.lhs.true4747:                                ; preds = %if.end4731
  %maxfilesize4749 = getelementptr inbounds %struct.cl_limits, ptr %546, i64 0, i32 5
  %547 = load i64, ptr %maxfilesize4749, align 8, !tbaa !63
  %tobool4750.not = icmp eq i64 %547, 0
...
land.lhs.true4751:                                ; preds = %land.lhs.true4747
  ...
  %cmp4761 = icmp ult i64 %547, %conv4758
  br i1 %cmp4761, label %if.then4763, label %if.end4778

if.then4763:                                      ; preds = %land.lhs.true4751
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.247, i32 noundef %cond4757, i64 noundef %547) #14
  call void @free(ptr noundef %call341) #14
  %548 = load i32, ptr %options271, align 8, !tbaa !11
  %and4773 = and i32 %548, 256
...
if.then4775:                                      ; preds = %if.then4763
  %549 = load ptr, ptr %ctx, align 8, !tbaa !14
  store ptr @.str.248, ptr %549, align 8, !tbaa !15
...
lor.lhs.false4782:                                ; preds = %if.end4778
  ...
  %550 = load i32, ptr %vsz4784, align 4, !tbaa !41
  %cmp4785.not = icmp eq i32 %add.ptr4743.val, %550
...
if.end4788:                                       ; preds = %lor.lhs.false4782
  ...
  %call4790 = call i64 @lseek(i32 noundef %desc, i64 noundef %conv4789, i32 noundef 0) #14
...
if.end4794:                                       ; preds = %if.end4788
  ...
  %call4796 = call ptr @cli_malloc(i64 noundef %conv4795) #14
...
if.end4799:                                       ; preds = %if.end4794
  ...
  %call4801 = call ptr @cli_malloc(i64 noundef %conv4800) #14
...
if.end4804:                                       ; preds = %if.end4799
  %call4805 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %call4801, i32 noundef %or4742) #14
  ...
  %551 = load i32, ptr %err, align 4
  %tobool4810 = icmp ne i32 %551, 0
...
if.then4811:                                      ; preds = %if.end4804
  call void @free(ptr noundef nonnull %call4796) #14
  br label %cleanup4869.thread.sink.split

if.end4812:                                       ; preds = %if.end4804
  %conv4813 = zext i32 %call4807 to i64
  %call4814 = call i64 @lseek(i32 noundef %desc, i64 noundef %conv4813, i32 noundef 0) #14
...
if.end4818:                                       ; preds = %if.end4812
  %call4820 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %nbuff, i32 noundef 5) #14
...
if.end4824:                                       ; preds = %if.end4818
  ...
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.249, i32 noundef %add4829) #14
  %call4830 = call ptr @cli_gentemp(ptr noundef null) #14
...
if.end4833:                                       ; preds = %if.end4824
  %call4834 = call i32 (ptr, i32, ...) @open(ptr noundef nonnull %call4830, i32 noundef 578, i32 noundef 448) #14
  %cmp4835 = icmp slt i32 %call4834, 0
  br i1 %cmp4835, label %if.then4837, label %if.end4838

if.then4837:                                      ; preds = %if.end4833
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.250, ptr noundef nonnull %call4830) #14
  call void @free(ptr noundef nonnull %call4830) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call4801, ptr noundef nonnull %call4796, ptr noundef nonnull %call341, i32 noundef 0)
  br label %cleanup4869

if.end4838:                                       ; preds = %if.end4833
  %552 = load i32, ptr %call341, align 4, !tbaa !38
  %ImageBase4841 = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 0, i32 9
  %553 = load i32, ptr %ImageBase4841, align 4, !tbaa !25
  %call4842 = call i32 @unspack(ptr noundef nonnull %call4801, ptr noundef nonnull %call4796, ptr noundef nonnull %ctx, i32 noundef %552, i32 noundef %553, i32 noundef %add4829, i32 noundef %call4834) #14
  %cond4922 = icmp eq i32 %call4842, 0
  br i1 %cond4922, label %sw.bb4843, label %sw.default4865

sw.bb4843:                                        ; preds = %if.end4838
  %554 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool4844.not = icmp eq i8 %554, 0
  br i1 %tobool4844.not, label %if.else4846, label %if.then4845

if.then4845:                                      ; preds = %sw.bb4843
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.251, ptr noundef nonnull %call4830) #14
  br label %if.end4847

if.else4846:                                      ; preds = %sw.bb4843
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.252) #14
  br label %if.end4847
...
if.end4847:                                       ; preds = %if.else4846, %if.then4845
  ...
  call void @free(ptr noundef nonnull %call341) #14
  %call4848 = call i32 @fsync(i32 noundef %call4834) #14
  %call4849 = call i64 @lseek(i32 noundef %call4834, i64 noundef 0, i32 noundef 0) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.138) #14
  %call4850 = call i32 @cli_magic_scandesc(i32 noundef %call4834, ptr noundef nonnull %ctx) #14
  %cmp4851 = icmp eq i32 %call4850, 1
  %call4854 = call i32 @close(i32 noundef %call4834) #14
  %555 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
  %tobool4855.not = icmp eq i8 %555, 0
...
if.then4856:                                      ; preds = %if.then4853
  %call4857 = call i32 @unlink(ptr noundef nonnull %call4830) #14
  br label %if.end4858
...
if.then4862:                                      ; preds = %if.end4859
  %call4863 = call i32 @unlink(ptr noundef nonnull %call4830) #14
  br label %if.end4864
...
sw.default4865:                                   ; preds = %if.end4838
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.253) #14
  %call4866 = call i32 @close(i32 noundef %call4834) #14
  %call4867 = call i32 @unlink(ptr noundef nonnull %call4830) #14
  call void (ptr, ...) @cli_multifree(ptr noundef nonnull %call4801, ptr noundef nonnull %call4796, i32 noundef 0)
  br label %cleanup4869.thread.sink.split
...
cleanup4869.thread.sink.split:                    ; preds = %if.end4799, %if.then4811, %if.then4817, %if.then4823, %sw.default4865
  ...
  call void @free(ptr noundef nonnull %call4830.sink) #14
...
cleanup4869.thread:                               ; preds = %cleanup4869.thread.sink.split, %if.then4671, %if.end4682, %if.end4688, %if.end4696, %if.end4700, %if.end4710, %if.end4716, %if.end4725, %lor.lhs.false4782, %if.end4778, %if.end4788, %if.end4794
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %nbuff) #14
...
cleanup4880:                                      ; preds = %if.then4270, %if.then4276, %if.then4284, %if.then4292, %if.then4329, %if.then4344, %if.then4373, %if.then4398, %if.then4403, %if.then4410, %if.end4427, %if.then4122, %if.then4130, %if.then4134, %if.then4139, %if.end4160, %if.end4166, %if.then4008, %if.then4014, %if.then4021, %if.then4029, %if.then4033, %if.then4038, %if.end4059, %if.end4065, %if.then4072, %if.then3222, %if.then3180, %if.then3192, %if.then3201, %if.then3228, %if.then3236, %if.then3241, %if.then3309, %if.then3344, %if.then3355, %if.then3361, %if.then3380, %if.then3385, %if.end3419, %if.end3425, %if.then2807, %if.then2754, %if.then2766, %if.then2775, %if.then2813, %if.then2821, %if.then2826, %if.then2925, %if.then2951, %if.then2962, %if.then2968, %if.then2978, %if.then2983, %if.end3017, %if.end3023, %if.then2343, %if.then2355, %if.then2364, %if.then2418, %if.then2429, %if.then2644, %if.then2648, %if.then2653, %if.end2685, %if.end2691, %if.then2133, %if.then2161, %if.then2207, %if.then2215, %if.then2249, %if.then2253, %if.then2258, %if.end2280, %if.end2286, %cleanup4869, %if.then1763, %if.then1719, %if.then1646, %if.then1694, %if.then1731, %if.then1785, %if.then1793, %if.then1830, %if.then1899, %if.then1904, %if.end1925, %if.end1931, %if.then1391, %if.then1400, %if.then1481, %if.then1557, %cleanup1187, %if.then1278, %if.then1322, %if.then4509, %if.then3855, %if.then3480, %if.then955, %if.then888, %if.then892, %if.then895, %if.then790, %if.then700, %if.then707, %if.then710, %if.then367, %if.then371, %if.then374, %if.then323, %if.then326, %if.then293, %if.then296, %if.then214, %if.then218, %if.then221, %if.then177, %if.then180, %if.then156, %if.then160, %if.then163, %if.then135, %if.then139, %if.then142, %if.then119, %if.then123, %if.then126, %if.then106, %if.else108, %if.then98, %if.then101, %if.then17, %if.then19, %if.then21, %while.end4879, %if.end4650, %if.end4644, %if.then4624, %if.then4619, %if.then4522, %if.then4515, %if.end3951, %if.end3945, %if.then3916, %if.then3911, %if.then3903, %if.then3869, %if.then3861, %if.then3783, %if.end3779, %if.end3773, %if.then3757, %if.then3750, %if.then3745, %if.then3528, %if.then3517, %if.then3510, %if.then3504, %if.then3492, %if.then1946, %if.then901, %if.end850, %if.end814, %if.end687, %if.then343, %if.then338, %if.then333, %if.then43, %if.then39, %if.then33, %if.then27, %if.then10, %if.then2, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %dsize) #14
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %err) #14
  call void @llvm.lifetime.end.p0(i64 4096, ptr nonnull %epbuff) #14
  call void @llvm.lifetime.end.p0(i64 4096, ptr nonnull %buff) #14
  call void @llvm.lifetime.end.p0(i64 9, ptr nonnull %sname) #14
  call void @llvm.lifetime.end.p0(i64 144, ptr nonnull %sb) #14
  call void @llvm.lifetime.end.p0(i64 240, ptr nonnull %pe_opt) #14
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %file_hdr) #14
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %timestamp) #14
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %e_lfanew) #14
  call void @llvm.lifetime.end.p0(i64 2, ptr nonnull %e_magic) #14
  ret i32 %retval.36
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 152, ptr nonnull %md5) #14
  %rsz = getelementptr inbounds %struct.cli_exe_section, ptr %s, i64 0, i32 3
  %0 = load i32, ptr %rsz, align 4, !tbaa !43
  %cmp = icmp ugt i32 %0, 184549376
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.256) #14
  br label %cleanup
...
if.end.i:                                         ; preds = %if.end
  ...
  %1 = load i32, ptr %raw.i, align 4, !tbaa !42
  %conv.i = zext i32 %1 to i64
  %call.i = tail call i64 @lseek(i32 noundef %fd, i64 noundef %conv.i, i32 noundef 0) #14
...
cli_seeksect.exit.thread28:                       ; preds = %if.end.i
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.259) #14
  br label %cleanup

if.end2:                                          ; preds = %if.end.i
  %2 = load i32, ptr %rsz, align 4, !tbaa !43
  %conv = zext i32 %2 to i64
  %call4 = tail call ptr @cli_malloc(i64 noundef %conv) #14
  %tobool5.not = icmp eq ptr %call4, null
  br i1 %tobool5.not, label %if.then6, label %if.end7

if.then6:                                         ; preds = %if.end2
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.257) #14
  br label %cleanup

if.end7:                                          ; preds = %if.end2
  %3 = load i32, ptr %rsz, align 4, !tbaa !43
  %call9 = tail call i32 @cli_readn(i32 noundef %fd, ptr noundef nonnull %call4, i32 noundef %3) #14
  %4 = load i32, ptr %rsz, align 4, !tbaa !43
  %cmp11.not = icmp eq i32 %call9, %4
  br i1 %cmp11.not, label %if.end14, label %if.then13

if.then13:                                        ; preds = %if.end7
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.258) #14
  br label %cleanup

if.end14:                                         ; preds = %if.end7
  call void @cli_md5_init(ptr noundef nonnull %md5) #14
  %5 = load i32, ptr %rsz, align 4, !tbaa !43
  %conv16 = zext i32 %5 to i64
  call void @cli_md5_update(ptr noundef nonnull %md5, ptr noundef nonnull %call4, i64 noundef %conv16) #14
  call void @free(ptr noundef nonnull %call4) #14
  call void @cli_md5_final(ptr noundef %digest, ptr noundef nonnull %md5) #14
  br label %cleanup
...
cleanup:                                          ; preds = %if.end, %cli_seeksect.exit.thread28, %if.end14, %if.then13, %if.then6, %if.then
  ...
  call void @llvm.lifetime.end.p0(i64 152, ptr nonnull %md5) #14
  ret i32 %retval.0
}
...
define internal fastcc i32 @cli_rawaddr(i32 noundef %rva, ptr nocapture noundef readonly %shp, i16 noundef zeroext %nos, ptr nocapture noundef writeonly %err, i64 noundef %fsize, i32 noundef %hdr_size) unnamed_addr #6 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %1 = load i32, ptr %raw, align 4, !tbaa !42
  %conv = zext i32 %1 to i64
  %call = tail call i64 @lseek(i32 noundef %fd, i64 noundef %conv, i32 noundef 0) #14
...
entry:
  ...
  tail call void @free(ptr noundef %f) #14
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 144, ptr nonnull %sb) #14
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %err) #14
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.254) #14
  %call.i = call i32 @__fxstat(i32 noundef 1, i32 noundef %desc, ptr noundef nonnull %sb) #14
...
if.end:                                           ; preds = %entry
  %st_size = getelementptr inbounds %struct.stat, ptr %sb, i64 0, i32 8
  %0 = load i64, ptr %st_size, align 8, !tbaa !29
  %offset = getelementptr inbounds %struct.cli_exe_info, ptr %peinfo, i64 0, i32 2
  %1 = load i64, ptr %offset, align 8, !tbaa !80
  %sub = sub nsw i64 %0, %1
  %call1 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %e_magic, i32 noundef 2) #14
...
if.end5:                                          ; preds = %if.end
  %2 = load i16, ptr %e_magic, align 2, !tbaa !9
...
if.end13:                                         ; preds = %if.end5, %if.end5
  %call14 = call i64 @lseek(i32 noundef %desc, i64 noundef 58, i32 noundef 1) #14
  %call15 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %e_lfanew, i32 noundef 4) #14
...
if.end22:                                         ; preds = %if.end20
  %4 = load i64, ptr %offset, align 8, !tbaa !80
  %conv24 = zext i32 %3 to i64
  %add = add nsw i64 %4, %conv24
  %call25 = call i64 @lseek(i32 noundef %desc, i64 noundef %add, i32 noundef 0) #14
...
if.end29:                                         ; preds = %if.end22
  %call30 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %file_hdr, i32 noundef 24) #14
...
if.end39:                                         ; preds = %if.end35
  %NumberOfSections = getelementptr inbounds %struct.pe_image_file_hdr, ptr %file_hdr, i64 0, i32 2
  %6 = load i16, ptr %NumberOfSections, align 2, !tbaa !20
  %nsections = getelementptr inbounds %struct.cli_exe_info, ptr %peinfo, i64 0, i32 1
  store i16 %6, ptr %nsections, align 4, !tbaa !82
  %7 = add i16 %6, -97
...
if.end48:                                         ; preds = %if.end39
  %SizeOfOptionalHeader = getelementptr inbounds %struct.pe_image_file_hdr, ptr %file_hdr, i64 0, i32 6
  %8 = load i16, ptr %SizeOfOptionalHeader, align 4, !tbaa !24
...
if.end53:                                         ; preds = %if.end48
  %call54 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %pe_opt, i32 noundef 224) #14
...
if.end59:                                         ; preds = %if.end53
  %9 = load i16, ptr %pe_opt, align 8, !tbaa !25
  %cmp62.not = icmp eq i16 %9, 523
  %10 = load i16, ptr %SizeOfOptionalHeader, align 4, !tbaa !24
...
if.end70:                                         ; preds = %if.then64
  %add.ptr = getelementptr inbounds %struct.pe_image_optional_hdr32, ptr %pe_opt, i64 1
  %call71 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %add.ptr, i32 noundef 16) #14
...
if.then81:                                        ; preds = %if.else
  ...
  %call85 = call i64 @lseek(i32 noundef %desc, i64 noundef %sub84, i32 noundef 1) #14
  br label %if.end86
...
if.end88:                                         ; preds = %if.end86, %if.end76
  ...
  %11 = load i32, ptr %SizeOfHeaders87.sink, align 4, !tbaa !25
...
cond.end103:                                      ; preds = %if.end88, %cond.true98
  ...
  %14 = load i16, ptr %nsections, align 4, !tbaa !82
  %conv106 = zext i16 %14 to i64
  %call107 = call ptr @cli_calloc(i64 noundef %conv106, i64 noundef 36) #14
  %section = getelementptr inbounds %struct.cli_exe_info, ptr %peinfo, i64 0, i32 3
  store ptr %call107, ptr %section, align 8, !tbaa !83
...
if.end111:                                        ; preds = %cond.end103
  %15 = load i16, ptr %nsections, align 4, !tbaa !82
  %conv113 = zext i16 %15 to i64
  %call114 = call ptr @cli_calloc(i64 noundef %conv113, i64 noundef 40) #14
  %tobool115.not = icmp eq ptr %call114, null
  br i1 %tobool115.not, label %if.then116, label %if.end119

if.then116:                                       ; preds = %if.end111
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.85) #14
  %16 = load ptr, ptr %section, align 8, !tbaa !83
  call void @free(ptr noundef %16) #14
  store ptr null, ptr %section, align 8, !tbaa !83
  br label %cleanup

if.end119:                                        ; preds = %if.end111
  %17 = load i16, ptr %nsections, align 4, !tbaa !82
  %conv121 = zext i16 %17 to i32
  %mul122 = mul nuw nsw i32 %conv121, 40
  %call124 = call i32 @cli_readn(i32 noundef %desc, ptr noundef nonnull %call114, i32 noundef %mul122) #14
  %conv125 = sext i32 %call124 to i64
  %18 = load i16, ptr %nsections, align 4, !tbaa !82
...
for.cond.preheader:                               ; preds = %if.end119
  ...
  %or.cond546549 = select i1 %cmp135.not547, i1 %cmp139548, i1 false
...
if.then131:                                       ; preds = %if.end119
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.86) #14
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.87) #14
  call void @free(ptr noundef nonnull %call114) #14
  %20 = load ptr, ptr %section, align 8, !tbaa !83
...
for.body162.lr.ph:                                ; preds = %for.cond157.preheader
  ...
  %cmp283.not = icmp eq i32 %conv282, 0
...
land.lhs.true142:                                 ; preds = %for.body
  ...
  %21 = load i32, ptr %SizeOfRawData, align 4, !tbaa !32
...
land.lhs.true144:                                 ; preds = %land.lhs.true142
  ...
  %22 = load i32, ptr %PointerToRawData, align 4, !tbaa !34
...
for.inc:                                          ; preds = %land.lhs.true144, %for.body, %land.lhs.true142
  ...
  br i1 %or.cond546, label %for.body, label %for.cond157.preheader, !llvm.loop !84
...
for.body162:                                      ; preds = %for.body162.lr.ph, %for.inc355
  ...
  %23 = load i32, ptr %VirtualAddress172, align 4, !tbaa !37
  %.fr530 = freeze i32 %23
...
cond.true217:                                     ; preds = %cond.end195
  ...
  %32 = load i32, ptr %SizeOfRawData220, align 4, !tbaa !32
...
cond.false230:                                    ; preds = %cond.end195
  ...
  %33 = load i32, ptr %SizeOfRawData233, align 4, !tbaa !32
  br label %cond.end234
...
cond.end234:                                      ; preds = %cond.false230, %cond.true217
  ...
  store i32 %cond235, ptr %rsz, align 4, !tbaa !43
...
if.then250:                                       ; preds = %land.lhs.true244
  ...
  %35 = load i32, ptr %SizeOfRawData268, align 4, !tbaa !32
...
if.end275.thread544:                              ; preds = %if.then250, %cond.true252
  ...
  store i32 %cond270, ptr %vsz, align 4, !tbaa !41
...
land.lhs.true281:                                 ; preds = %if.end275.thread544, %if.end275
  ...
  %or.cond532 = select i1 %cmp283.not, i1 true, i1 %cmp298.not
  br i1 %or.cond532, label %if.then333, label %land.lhs.true307
...
if.then333:                                       ; preds = %land.lhs.true307, %land.lhs.true281
  ...
  store i32 %conv349, ptr %rsz, align 4, !tbaa !43
  br label %for.inc355
...
for.inc355:                                       ; preds = %land.lhs.true244, %land.lhs.true307, %if.end275, %if.then333
  ...
  br i1 %exitcond.not, label %for.end357, label %for.body162, !llvm.loop !85
...
for.end357:                                       ; preds = %for.inc355, %for.cond157.preheader
  ...
  store i32 %37, ptr %peinfo, align 8, !tbaa !86
  %38 = load ptr, ptr %section, align 8, !tbaa !83
  ...
  store i32 %call367, ptr %peinfo, align 8, !tbaa !86
...
if.then372:                                       ; preds = %for.end357
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.255) #14
  call void @free(ptr noundef %call114) #14
  %40 = load ptr, ptr %section, align 8, !tbaa !83
...
declare i32 @llvm.vector.reduce.umin.v4i32(<4 x i32>) #13
...
!62 = !{!12, !13, i64 32}
!63 = !{!64, !23, i64 24}
!64 = !{!"cl_limits", !6, i64 0, !6, i64 4, !6, i64 8, !6, i64 12, !10, i64 16, !23, i64 24}
!65 = distinct !{!65, !36}
!66 = distinct !{!66, !36}
!67 = distinct !{!67, !36}
!68 = distinct !{!68, !36}
!69 = !{ptr @upx_inflate2b, ptr @upx_inflate2d, ptr @upx_inflate2e}
!70 = distinct !{!70, !36}
!71 = distinct !{!71, !36, !72, !73}
!72 = !{!"llvm.loop.isvectorized", i32 1}
!73 = !{!"llvm.loop.unroll.runtime.disable"}
!74 = distinct !{!74, !36, !73, !72}
!75 = distinct !{!75, !36}
!76 = distinct !{!76, !36}
!77 = distinct !{!77, !36}
!78 = distinct !{!78, !36}
!79 = distinct !{!79, !36}
!80 = !{!81, !23, i64 8}
!81 = !{!"cli_exe_info", !6, i64 0, !10, i64 4, !23, i64 8, !13, i64 16}
!82 = !{!81, !10, i64 4}
!83 = !{!81, !13, i64 16}
!84 = distinct !{!84, !36}
!85 = distinct !{!85, !36}
