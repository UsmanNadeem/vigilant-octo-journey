; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/yacr2/vcg.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/yacr2/vcg.c"
...
entry:
  ...
  %mul4 = shl i64 %mul3, 5
  %call5 = tail call noalias ptr @malloc(i64 noundef %mul4) #14
  ...
  %call14 = tail call noalias ptr @malloc(i64 noundef %mul10) #14
  store ptr %call14, ptr @perSCC, align 8, !tbaa !9
  %mul18 = shl i64 %mul3, 3
  %call19 = tail call noalias ptr @malloc(i64 noundef %mul18) #14
...
entry:
  ...
  %call5.i = tail call noalias ptr @malloc(i64 noundef %mul4.i) #14
  ...
  %call11.i = tail call noalias ptr @malloc(i64 noundef %mul10.i) #14
  store ptr %call11.i, ptr @SCC, align 8, !tbaa !9
  %call14.i = tail call noalias ptr @malloc(i64 noundef %mul10.i) #14
  store ptr %call14.i, ptr @perSCC, align 8, !tbaa !9
  %mul18.i = shl i64 %mul3.i, 3
  %call19.i = tail call noalias ptr @malloc(i64 noundef %mul18.i) #14
...
for.inc40:                                        ; preds = %for.body13, %for.body3, %land.lhs.true, %if.then20
  ...
  %inc41 = add nuw i64 %col.0166, 1
  %cmp2.not.not = icmp ult i64 %col.0166, %13
  br i1 %cmp2.not.not, label %for.body3, label %for.end42, !llvm.loop !20
...
for.inc96:                                        ; preds = %for.body59, %for.body47, %land.lhs.true50, %if.then72
  ...
  %inc97 = add nuw i64 %col.1175, 1
  %cmp46.not.not = icmp ult i64 %col.1175, %26
  br i1 %cmp46.not.not, label %for.body47, label %for.end98, !llvm.loop !24
...
for.end98:                                        ; preds = %for.inc96, %for.end42
  ...
  %inc101 = add nuw i64 %net.0179, 1
  %28 = load i64, ptr @channelNets, align 8, !tbaa !5
  %cmp.not.not = icmp ult i64 %net.0179, %28
  br i1 %cmp.not.not, label %for.body, label %for.end102, !llvm.loop !26
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %cmp.not.not = icmp ult i64 %net.013, %1
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %label) #15
...
do.body.preheader:                                ; preds = %for.inc, %entry
  ...
  %cmp2.not90114 = icmp eq i64 %1, 0
  br i1 %cmp2.not90114, label %do.end.thread, label %for.body3.preheader
...
for.body3.preheader:                              ; preds = %do.body.preheader, %do.cond
  %cmp2.not90116 = phi i1 [ %cmp2.not90, %do.cond ], [ %cmp2.not90114, %do.body.preheader ]
  %which.0115 = phi i64 [ %inc19, %do.cond ], [ 0, %do.body.preheader ]
  %5 = phi i64 [ %.pre105, %do.cond ], [ %1, %do.body.preheader ]
  %xtraiter = and i64 %5, 1
  %6 = icmp eq i64 %5, 1
  br i1 %6, label %for.end16.unr-lcssa, label %for.body3.preheader.new
...
for.body3:                                        ; preds = %for.inc14.1, %for.body3.preheader.new
  ...
  %7 = load i64, ptr %netsBelowReached, align 8, !tbaa !33
...
if.then6:                                         ; preds = %for.body3
  ...
  %8 = load i64, ptr %netsAboveLabel, align 8, !tbaa !36
  %cmp8 = icmp ugt i64 %8, %large.093
...
for.inc14:                                        ; preds = %for.body3, %if.then9, %if.then6
  ...
  %large.1 = phi i64 [ %large.093, %for.body3 ], [ %8, %if.then9 ], [ %large.093, %if.then6 ]
  ...
  %9 = load i64, ptr %netsBelowReached.1, align 8, !tbaa !33
  %tobool5.not.1 = icmp eq i64 %9, 0
...
if.then6.1:                                       ; preds = %for.inc14
  ...
  %10 = load i64, ptr %netsAboveLabel.1, align 8, !tbaa !36
  %cmp8.1 = icmp ugt i64 %10, %large.1
...
for.inc14.1:                                      ; preds = %if.then9.1, %if.then6.1, %for.inc14
  ...
  %large.1.1 = phi i64 [ %large.1, %for.inc14 ], [ %10, %if.then9.1 ], [ %large.1, %if.then6.1 ]
...
for.body3.epil:                                   ; preds = %for.end16.unr-lcssa
  ...
  %11 = load i64, ptr %netsBelowReached.epil, align 8, !tbaa !33
  %tobool5.not.epil = icmp eq i64 %11, 0
...
if.then6.epil:                                    ; preds = %for.body3.epil
  ...
  %12 = load i64, ptr %netsAboveLabel.epil, align 8, !tbaa !36
  %cmp8.epil = icmp ugt i64 %12, %large.093.unr
  %spec.select132 = select i1 %cmp8.epil, i64 %net.191.unr, i64 %choose.092.unr
  %spec.select133 = select i1 %cmp8.epil, i64 0, i64 %done.094.unr
  br label %for.end16

for.end16:                                        ; preds = %if.then6.epil, %for.body3.epil, %for.end16.unr-lcssa
  %choose.1.lcssa = phi i64 [ %choose.1.lcssa.ph, %for.end16.unr-lcssa ], [ %choose.092.unr, %for.body3.epil ], [ %spec.select132, %if.then6.epil ]
  %done.1.lcssa = phi i64 [ %done.1.lcssa.ph, %for.end16.unr-lcssa ], [ %done.094.unr, %for.body3.epil ], [ %spec.select133, %if.then6.epil ]
  %tobool17.not = icmp eq i64 %done.1.lcssa, 0
  br i1 %tobool17.not, label %do.cond, label %do.end

do.cond:                                          ; preds = %for.end16
  %inc19 = add i64 %which.0115, 1
  tail call void @SCC_DFSBelowVCG(ptr noundef nonnull %VCG, i64 noundef %choose.1.lcssa, i64 noundef %inc19)
  %.pre105 = load i64, ptr @channelNets, align 8, !tbaa !5
  %cmp2.not90 = icmp eq i64 %.pre105, 0
  br i1 %cmp2.not90, label %do.end.thread, label %for.body3.preheader, !llvm.loop !38

do.end:                                           ; preds = %for.end16
  store i64 0, ptr @totalSCC, align 8, !tbaa !5
  br i1 %cmp2.not90116, label %for.end52, label %for.body24

for.cond35.preheader:                             ; preds = %for.inc32
  %cmp36.not102 = icmp eq i64 %15, 0
...
for.body24:                                       ; preds = %do.end, %for.inc32
  ...
  %13 = load i64, ptr %netsBelowLabel, align 8, !tbaa !39
  %arrayidx26 = getelementptr inbounds i64, ptr %SCC, i64 %net.297
  store i64 %13, ptr %arrayidx26, align 8, !tbaa !5
  %14 = load i64, ptr @totalSCC, align 8, !tbaa !5
  %cmp28 = icmp ugt i64 %13, %14
  br i1 %cmp28, label %if.then29, label %for.inc32

if.then29:                                        ; preds = %for.body24
  store i64 %13, ptr @totalSCC, align 8, !tbaa !5
  br label %for.inc32

for.inc32:                                        ; preds = %for.body24, %if.then29
  %15 = phi i64 [ %14, %for.body24 ], [ 1, %if.then29 ]
  %inc33 = add nuw i64 %net.297, 1
  %16 = load i64, ptr @channelNets, align 8, !tbaa !5
  %cmp23.not.not = icmp ult i64 %net.297, %16
  br i1 %cmp23.not.not, label %for.body24, label %for.cond35.preheader, !llvm.loop !40
...
for.body40.preheader:                             ; preds = %for.cond38.preheader
  ...
  br i1 %min.iters.check, label %for.body40.preheader121, label %vector.ph
...
vector.ph:                                        ; preds = %for.body40.preheader
  ...
  %broadcast.splatinsert119 = insertelement <2 x i64> poison, i64 %scc.0103, i64 0
  %broadcast.splat120 = shufflevector <2 x i64> %broadcast.splatinsert119, <2 x i64> poison, <2 x i32> zeroinitializer
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %vec.phi = phi <2 x i64> [ zeroinitializer, %vector.ph ], [ %24, %vector.body ]
  %vec.phi117 = phi <2 x i64> [ zeroinitializer, %vector.ph ], [ %25, %vector.body ]
  %offset.idx = or i64 %index, 1
  %18 = getelementptr inbounds i64, ptr %SCC, i64 %offset.idx
  %wide.load = load <2 x i64>, ptr %18, align 8, !tbaa !5
  %19 = getelementptr inbounds i64, ptr %18, i64 2
  %wide.load118 = load <2 x i64>, ptr %19, align 8, !tbaa !5
  %20 = icmp eq <2 x i64> %wide.load, %broadcast.splat
  %21 = icmp eq <2 x i64> %wide.load118, %broadcast.splat120
  %22 = zext <2 x i1> %20 to <2 x i64>
  %23 = zext <2 x i1> %21 to <2 x i64>
  %24 = add <2 x i64> %vec.phi, %22
  %25 = add <2 x i64> %vec.phi117, %23
...
middle.block:                                     ; preds = %vector.body
  ...
  %27 = tail call i64 @llvm.vector.reduce.add.v2i64(<2 x i64> %bin.rdx)
  %cmp.n = icmp eq i64 %17, %n.vec
  br i1 %cmp.n, label %for.end48, label %for.body40.preheader121

for.body40.preheader121:                          ; preds = %for.body40.preheader, %middle.block
  %per.0100.ph = phi i64 [ 0, %for.body40.preheader ], [ %27, %middle.block ]
  %net.399.ph = phi i64 [ 1, %for.body40.preheader ], [ %ind.end, %middle.block ]
  br label %for.body40

for.body40:                                       ; preds = %for.body40.preheader121, %for.body40
  %per.0100 = phi i64 [ %spec.select, %for.body40 ], [ %per.0100.ph, %for.body40.preheader121 ]
  %net.399 = phi i64 [ %inc47, %for.body40 ], [ %net.399.ph, %for.body40.preheader121 ]
  %arrayidx41 = getelementptr inbounds i64, ptr %SCC, i64 %net.399
  %28 = load i64, ptr %arrayidx41, align 8, !tbaa !5
  %cmp42 = icmp eq i64 %28, %scc.0103
  %inc44 = zext i1 %cmp42 to i64
  %spec.select = add i64 %per.0100, %inc44
  %inc47 = add nuw i64 %net.399, 1
  %exitcond104 = icmp eq i64 %net.399, %17
  br i1 %exitcond104, label %for.end48, label %for.body40, !llvm.loop !44

for.end48:                                        ; preds = %for.body40, %middle.block, %for.cond38.preheader
  %per.0.lcssa = phi i64 [ 0, %for.cond38.preheader ], [ %27, %middle.block ], [ %spec.select, %for.body40 ]
  %arrayidx49 = getelementptr inbounds i64, ptr %perSCC, i64 %scc.0103
  store i64 %per.0.lcssa, ptr %arrayidx49, align 8, !tbaa !5
  %inc51 = add nuw i64 %scc.0103, 1
  %29 = load i64, ptr @totalSCC, align 8, !tbaa !5
  %cmp36.not.not = icmp ult i64 %scc.0103, %29
  br i1 %cmp36.not.not, label %for.cond38.preheader, label %for.end52, !llvm.loop !45

for.end52:                                        ; preds = %for.end48, %do.end.thread, %do.end, %for.cond35.preheader
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %label) #15
  ret void
}
...
for.inc16:                                        ; preds = %for.inc16.loopexit.unr-lcssa, %for.body9.epil, %for.cond6.preheader
  %inc17 = add nuw i64 %net.0214, 1
  %8 = load i64, ptr @channelNets, align 8, !tbaa !5
  %cmp.not.not = icmp ult i64 %net.0214, %8
  br i1 %cmp.not.not, label %for.cond1.preheader, label %for.end18, !llvm.loop !55
...
for.body.i:                                       ; preds = %do.body, %for.body.i
  ...
  %cmp.not.not.i = icmp ult i64 %net.013.i, %11
  br i1 %cmp.not.not.i, label %for.body.i, label %DFSClearVCG.exit, !llvm.loop !27
...
for.body.i192:                                    ; preds = %for.end74, %for.body.i192
  ...
  %inc.i190 = add nuw i64 %net.013.i187, 1
  ...
  %cmp.not.not.i191 = icmp ult i64 %net.013.i187, %33
  br i1 %cmp.not.not.i191, label %for.body.i192, label %DFSClearVCG.exit193, !llvm.loop !27
...
for.cond8.preheader:                              ; preds = %for.body4
  ...
  %7 = load i64, ptr %netsAbove, align 8, !tbaa !21
  %cmp10219.not = icmp eq i64 %7, 0
...
for.body11.lr.ph:                                 ; preds = %for.cond8.preheader
  ...
  %8 = load ptr, ptr %arrayidx9, align 8, !tbaa !11
  br label %for.body11
...
for.body11:                                       ; preds = %for.body11.lr.ph, %for.inc
  ...
  %bot14 = getelementptr inbounds %struct._constraintVCGType, ptr %8, i64 %which.0220, i32 1
  %9 = load i64, ptr %bot14, align 8, !tbaa !15
  %arrayidx15 = getelementptr inbounds i64, ptr %SCC, i64 %9
  %10 = load i64, ptr %arrayidx15, align 8, !tbaa !5
  %cmp16 = icmp eq i64 %10, %scc.0233
  br i1 %cmp16, label %land.lhs.true, label %for.inc

land.lhs.true:                                    ; preds = %for.body11
  %removed = getelementptr inbounds %struct._constraintVCGType, ptr %8, i64 %which.0220, i32 3
  %11 = load i64, ptr %removed, align 8, !tbaa !19
  %tobool.not = icmp eq i64 %11, 0
  br i1 %tobool.not, label %if.then20, label %for.inc

if.then20:                                        ; preds = %land.lhs.true
  %col24 = getelementptr inbounds %struct._constraintVCGType, ptr %8, i64 %which.0220, i32 2
  %12 = load i64, ptr %col24, align 8, !tbaa !18
  %cmp25 = icmp eq i64 %12, 1
  br i1 %cmp25, label %if.then26, label %if.else46

if.then26:                                        ; preds = %if.then20
  %13 = load i64, ptr %arrayidx28, align 8, !tbaa !5
  %tobool29.not = icmp eq i64 %13, 0
  %14 = load i64, ptr %arrayidx32, align 8, !tbaa !5
...
if.else46:                                        ; preds = %if.then20
  %cmp47 = icmp eq i64 %12, %3
  br i1 %cmp47, label %if.then48, label %if.else71

if.then48:                                        ; preds = %if.else46
  %15 = load i64, ptr %arrayidx50, align 8, !tbaa !5
...
if.else71:                                        ; preds = %if.else46
  ...
  %18 = load i64, ptr %arrayidx73, align 8, !tbaa !5
  %tobool74.not = icmp eq i64 %18, 0
  %arrayidx87 = getelementptr inbounds i64, ptr %5, i64 %sub72
  %19 = load i64, ptr %arrayidx87, align 8, !tbaa !5
  %tobool88.not = icmp eq i64 %19, 0
...
if.end93:                                         ; preds = %land.lhs.true75, %if.else90, %lor.lhs.false85
  ...
  %20 = load i64, ptr %arrayidx95, align 8, !tbaa !5
  %tobool96.not = icmp eq i64 %20, 0
  %arrayidx109 = getelementptr inbounds i64, ptr %5, i64 %add94
  %21 = load i64, ptr %arrayidx109, align 8, !tbaa !5
  %tobool110.not = icmp eq i64 %21, 0
...
if.end117:                                        ; preds = %land.lhs.true52, %land.lhs.true30, %if.else67, %lor.lhs.false62, %if.else112, %lor.lhs.false107, %if.then101, %lor.lhs.false, %if.else43
  ...
  %arrayidx122 = getelementptr inbounds %struct._constraintVCGType, ptr %8, i64 %which.0220
...
for.inc126:                                       ; preds = %for.inc, %for.cond8.preheader, %for.body4
  ...
  %exitcond236 = icmp eq i64 %net.0226, %2
...
for.end128:                                       ; preds = %for.inc126, %for.cond2.preheader
  ...
  %call = tail call i32 @fflush(ptr noundef %22)
  %23 = load i64, ptr @removeTotalVCG, align 8, !tbaa !5
  %arrayidx129 = getelementptr inbounds ptr, ptr %removeVCG, i64 %23
  store ptr %remove.0.lcssa, ptr %arrayidx129, align 8, !tbaa !9
  %inc130 = add i64 %23, 1
  store i64 %inc130, ptr @removeTotalVCG, align 8, !tbaa !5
  %24 = load i64, ptr %remove.0.lcssa, align 8, !tbaa !17
  %bot132 = getelementptr inbounds %struct._constraintVCGType, ptr %remove.0.lcssa, i64 0, i32 1
  %25 = load i64, ptr %bot132, align 8, !tbaa !15
  ...
  %netsBelow = getelementptr inbounds %struct._nodeVCGType, ptr %VCG, i64 %25, i32 5
  %26 = load i64, ptr %netsBelow, align 8, !tbaa !25
  %cmp136230.not = icmp eq i64 %26, 0
  br i1 %cmp136230.not, label %for.inc152, label %for.body137.lr.ph

for.body137.lr.ph:                                ; preds = %for.end128
  %netsBelowHook = getelementptr inbounds %struct._nodeVCGType, ptr %VCG, i64 %25, i32 4
  %27 = load ptr, ptr %netsBelowHook, align 8, !tbaa !22
  br label %for.body137

for.body137:                                      ; preds = %for.body137.lr.ph, %for.inc148
  %which.1231 = phi i64 [ 0, %for.body137.lr.ph ], [ %inc149, %for.inc148 ]
  %arrayidx139 = getelementptr inbounds %struct._constraintVCGType, ptr %27, i64 %which.1231
  %28 = load i64, ptr %arrayidx139, align 8, !tbaa !17
  %cmp141 = icmp eq i64 %28, %24
  br i1 %cmp141, label %if.then142, label %for.inc148

if.then142:                                       ; preds = %for.body137
  %removed146 = getelementptr inbounds %struct._constraintVCGType, ptr %27, i64 %which.1231, i32 3
  store i64 1, ptr %removed146, align 8, !tbaa !19
  br label %for.inc152

for.inc148:                                       ; preds = %for.body137
  %inc149 = add nuw i64 %which.1231, 1
  %exitcond237.not = icmp eq i64 %inc149, %26
...
for.inc152:                                       ; preds = %for.inc148, %for.end128, %for.body, %if.then142
  ...
  %29 = load i64, ptr @totalSCC, align 8, !tbaa !5
  %cmp.not = icmp ugt i64 %inc153, %29
...
for.body.i:                                       ; preds = %entry, %for.body.i
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %netsBelowLabel.i, i8 0, i64 16, i1 false)
  %1 = load i64, ptr @channelNets, align 8, !tbaa !5
  %cmp.not.not.i = icmp ult i64 %net.013.i, %1
  br i1 %cmp.not.not.i, label %for.body.i, label %DFSClearVCG.exit, !llvm.loop !27
...
for.body.i59:                                     ; preds = %for.end, %for.body.i59
  ...
  %inc.i57 = add nuw i64 %net.013.i54, 1
  ...
  %cmp.not.not.i58 = icmp ult i64 %net.013.i54, %9
  br i1 %cmp.not.not.i58, label %for.body.i59, label %DFSClearVCG.exit60, !llvm.loop !27
...
for.body8:                                        ; preds = %for.body8.lr.ph, %for.body8
  ...
  %inc = add nuw i64 %track.165, 1
  %17 = load i64, ptr @channelTracks, align 8, !tbaa !5
  %cmp7.not.not = icmp ult i64 %track.165, %17
  br i1 %cmp7.not.not, label %for.body8, label %for.cond18.preheader, !llvm.loop !69
...
for.inc30:                                        ; preds = %if.then24, %if.else27
  ...
  %inc31 = add nuw i64 %track.268, 1
  %20 = load i64, ptr @channelTracks, align 8, !tbaa !5
  %cmp19.not.not = icmp ult i64 %track.268, %20
  br i1 %cmp19.not.not, label %for.body20, label %for.end32, !llvm.loop !70
...
for.body.i.i:                                     ; preds = %if.then3, %for.body.i.i
  ...
  %inc.i.i = add nuw i64 %net.013.i.i, 1
  ...
  %cmp.not.not.i.i = icmp ult i64 %net.013.i.i, %3
  br i1 %cmp.not.not.i.i, label %for.body.i.i, label %ExistPathAboveVCG.exit, !llvm.loop !27
...
for.body.i.i53:                                   ; preds = %if.then8, %for.body.i.i53
  ...
  %inc.i.i51 = add nuw i64 %net.013.i.i48, 1
  ...
  %cmp.not.not.i.i52 = icmp ult i64 %net.013.i.i48, %5
  br i1 %cmp.not.not.i.i52, label %for.body.i.i53, label %ExistPathAboveVCG.exit55, !llvm.loop !27
...
for.body.i.i62:                                   ; preds = %if.else14, %for.body.i.i62
  ...
  %inc.i.i60 = add nuw i64 %net.013.i.i57, 1
  ...
  %cmp.not.not.i.i61 = icmp ult i64 %net.013.i.i57, %7
  br i1 %cmp.not.not.i.i61, label %for.body.i.i62, label %ExistPathAboveVCG.exit64, !llvm.loop !27
...
for.body.i.i71:                                   ; preds = %lor.lhs.false, %for.body.i.i71
  ...
  %inc.i.i69 = add nuw i64 %net.013.i.i66, 1
  ...
  %cmp.not.not.i.i70 = icmp ult i64 %net.013.i.i66, %10
  br i1 %cmp.not.not.i.i70, label %for.body.i.i71, label %ExistPathAboveVCG.exit73, !llvm.loop !27
...
attributes #6 = { nofree norecurse nosync nounwind memory(read, argmem: write, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
