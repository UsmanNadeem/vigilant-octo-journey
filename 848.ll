; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t4.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/t4.c"
...
sw.bb5:                                           ; preds = %while.cond, %while.cond, %sw.bb1
  ...
  %2 = load i32, ptr @nclin, align 4, !tbaa !5
...
sw.bb59:                                          ; preds = %while.cond, %while.cond, %while.cond, %while.cond, %while.cond, %while.cond, %while.cond, %while.cond, %while.cond, %68
  ...
  %70 = load i32, ptr @nclin, align 4, !tbaa !5
...
if.end99:                                         ; preds = %if.end68
  ...
  %or.cond427 = select i1 %cmp101, i1 %cmp103, i1 false
...
if.end344:                                        ; preds = %while.body333
  ...
  %or.cond568 = select i1 %tobool345.not, i1 %cmp356, i1 %or.cond435
