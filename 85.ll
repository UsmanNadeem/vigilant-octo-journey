; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/zlib_gzread.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/zlib_gzread.c"
...
if.else19.i:                                      ; preds = %land.lhs.true.i, %if.else.i
  %call.i = tail call fastcc i32 @gz_fetch(ptr noundef nonnull %state)
...
if.end24.i:                                       ; preds = %if.else19.i, %if.then.i
  ...
  br i1 %tobool.not.i, label %if.end6, label %while.body.i, !llvm.loop !22
...
do.body:                                          ; preds = %do.cond, %if.end6
  ...
  %spec.select131 = tail call i64 @llvm.umin.i64(i64 %len.addr.0, i64 4294967295)
  %spec.select = trunc i64 %spec.select131 to i32
  %7 = load i32, ptr %state, align 8, !tbaa !17
  %tobool12.not = icmp eq i32 %7, 0
  br i1 %tobool12.not, label %if.else, label %if.then13

if.then13:                                        ; preds = %do.body
  %spec.select130 = tail call i32 @llvm.umin.i32(i32 %7, i32 %spec.select)
  %8 = load ptr, ptr %next, align 8, !tbaa !18
  %conv23 = zext i32 %spec.select130 to i64
...
do.body.i:                                        ; preds = %if.else43, %if.end5.i
  %n.1 = phi i32 [ %add.i117, %if.end5.i ], [ 0, %if.else43 ]
  %sub.i112 = sub i32 %spec.select, %n.1
  %spec.select.i = tail call i32 @llvm.umin.i32(i32 %sub.i112, i32 1073741824)
  %15 = load i32, ptr %fd.i, align 4, !tbaa !27
  %idx.ext.i113 = zext i32 %n.1 to i64
...
if.end5.i:                                        ; preds = %do.body.i
  %add.i117 = add i32 %n.1, %conv1.i
  %cmp6.i = icmp ult i32 %add.i117, %spec.select
  br i1 %cmp6.i, label %do.body.i, label %if.end68, !llvm.loop !28

do.end.i:                                         ; preds = %do.body.i
  %16 = and i64 %call.i116, 2147483648
  %cmp8.not.i = icmp eq i64 %16, 0
  br i1 %cmp8.not.i, label %if.then16.i, label %gz_load.exit
...
gz_load.exit:                                     ; preds = %do.end.i
  ...
  %17 = load i32, ptr %call11.i, align 4, !tbaa !29
  %call12.i = tail call ptr @strerror(i32 noundef %17) #12
  tail call void @gz_error(ptr noundef nonnull %state, i32 noundef -1, ptr noundef %call12.i) #12
  br label %cleanup

if.else53:                                        ; preds = %if.else43
  store i32 %spec.select, ptr %avail_out, align 8, !tbaa !30
  store ptr %buf.addr.0, ptr %next_out, align 8, !tbaa !31
  %call56 = tail call fastcc i32 @gz_decomp(ptr noundef nonnull %state)
  %cmp57 = icmp eq i32 %call56, -1
  br i1 %cmp57, label %cleanup, label %if.end60

if.end60:                                         ; preds = %if.else53
  %18 = load i32, ptr %state, align 8, !tbaa !17
  store i32 0, ptr %state, align 8, !tbaa !17
  br label %if.end68

if.end68:                                         ; preds = %if.end5.i, %if.then16.i, %if.end60, %if.then13
  %n.3 = phi i32 [ %18, %if.end60 ], [ %spec.select130, %if.then13 ], [ %n.1, %if.then16.i ], [ %add.i117, %if.end5.i ]
  ...
  %19 = load i64, ptr %pos, align 8, !tbaa !19
  %add76 = add nsw i64 %19, %conv69
...
do.cond:                                          ; preds = %if.then37, %if.end68
  ...
  br i1 %tobool77.not, label %cleanup, label %do.body, !llvm.loop !32
...
if.then7:                                         ; preds = %if.end6
  ...
  br i1 %tobool.not39.i, label %gz_skip.exit, label %while.body.lr.ph.i
...
if.end24.i:                                       ; preds = %if.else19.i, %if.then.i
  %len.addr.1.i = phi i64 [ %sub14.i, %if.then.i ], [ %len.addr.040.i, %if.else19.i ]
  %tobool.not.i = icmp eq i64 %len.addr.1.i, 0
  br i1 %tobool.not.i, label %gz_skip.exit, label %while.body.i, !llvm.loop !22
...
if.end12:                                         ; preds = %if.end6
  ...
  br i1 %cmp13.old, label %cleanup, label %if.end15
...
if.then17:                                        ; preds = %if.end15
  ...
  %10 = load ptr, ptr %out, align 8, !tbaa !34
  %size = getelementptr inbounds %struct.gz_state, ptr %file, i64 0, i32 4
  %11 = load i32, ptr %size, align 8, !tbaa !26
  %shl = shl i32 %11, 1
  ...
  store i8 %conv, ptr %add.ptr20, align 1, !tbaa !33
  %pos = getelementptr inbounds %struct.gzFile_s, ptr %file, i64 0, i32 2
  ...
  store i32 0, ptr %past, align 4, !tbaa !24
  br label %cleanup

if.end25:                                         ; preds = %if.end15
  %size28 = getelementptr inbounds %struct.gz_state, ptr %file, i64 0, i32 4
  %13 = load i32, ptr %size28, align 8, !tbaa !26
  %shl29 = shl i32 %13, 1
...
if.end33:                                         ; preds = %if.end25
  ...
  %15 = load ptr, ptr %out36, align 8, !tbaa !34
...
if.then39:                                        ; preds = %if.end33
  ...
  %cmp51113 = icmp ugt ptr %add.ptr44, %14
  br i1 %cmp51113, label %while.body, label %if.end56

while.body:                                       ; preds = %if.then39, %while.body
  %dest.0115 = phi ptr [ %incdec.ptr53, %while.body ], [ %add.ptr49, %if.then39 ]
  %src.0114 = phi ptr [ %incdec.ptr, %while.body ], [ %add.ptr44, %if.then39 ]
  %incdec.ptr = getelementptr inbounds i8, ptr %src.0114, i64 -1
  %16 = load i8, ptr %incdec.ptr, align 1, !tbaa !33
  %incdec.ptr53 = getelementptr inbounds i8, ptr %dest.0115, i64 -1
  store i8 %16, ptr %incdec.ptr53, align 1, !tbaa !33
  %17 = load ptr, ptr %out36, align 8, !tbaa !34
  %cmp51 = icmp ugt ptr %incdec.ptr, %17
  br i1 %cmp51, label %while.body, label %while.end.loopexit, !llvm.loop !35
...
if.end56:                                         ; preds = %if.then39, %while.end.loopexit, %if.end33
  ...
  store i8 %conv62, ptr %incdec.ptr61, align 1, !tbaa !33
  ...
  store i32 0, ptr %past69, align 4, !tbaa !24
  br label %cleanup

cleanup:                                          ; preds = %if.else19.i, %if.end12, %gz_skip.exit, %if.end, %lor.lhs.false, %entry, %if.end56, %if.then32, %if.then17
...
if.end24.i:                                       ; preds = %if.else19.i, %if.then.i
  %len.addr.1.i = phi i64 [ %sub14.i, %if.then.i ], [ %len.addr.040.i, %if.else19.i ]
  %tobool.not.i = icmp eq i64 %len.addr.1.i, 0
  br i1 %tobool.not.i, label %if.end16, label %while.body.i, !llvm.loop !22
...
land.lhs.true20:                                  ; preds = %do.body
  %call21 = tail call fastcc i32 @gz_fetch(ptr noundef nonnull %file)
...
if.end29:                                         ; preds = %do.body, %if.end24
  ...
  %15 = select i1 %tobool58, i1 %cmp37.not, i1 false
  br i1 %15, label %do.body, label %if.end61, !llvm.loop !36
...
if.end65:                                         ; preds = %if.end61
  store i8 0, ptr %buf.addr.1, align 1, !tbaa !33
  br label %cleanup
...
do.body:                                          ; preds = %do.body.backedge, %entry
  %0 = load i32, ptr %how, align 4, !tbaa !25
...
sw.bb:                                            ; preds = %do.body
  %call = tail call fastcc i32 @gz_look(ptr noundef nonnull %state)
  %cmp = icmp eq i32 %call, -1
  br i1 %cmp, label %cleanup, label %if.end

if.end:                                           ; preds = %sw.bb
  %1 = load i32, ptr %how, align 4, !tbaa !25
  %cmp3 = icmp eq i32 %1, 0
  br i1 %cmp3, label %cleanup, label %do.cond

sw.bb6:                                           ; preds = %do.body
  %2 = load ptr, ptr %out16, align 8, !tbaa !34
  %3 = load i32, ptr %size14, align 8, !tbaa !26
  %shl = shl i32 %3, 1
  store i32 0, ptr %state, align 4, !tbaa !29
  %fd.i = getelementptr inbounds %struct.gz_state, ptr %state, i64 0, i32 2
  br label %do.body.i
...
do.body.i:                                        ; preds = %if.end5.i, %sw.bb6
  ...
  %5 = load i32, ptr %fd.i, align 4, !tbaa !27
...
if.end5.i:                                        ; preds = %do.body.i
  %6 = load i32, ptr %state, align 4, !tbaa !29
  %add.i = add i32 %6, %conv1.i
  store i32 %add.i, ptr %state, align 4, !tbaa !29
  %cmp6.i = icmp ult i32 %add.i, %shl
  br i1 %cmp6.i, label %do.body.i, label %if.end10, !llvm.loop !28

do.end.i:                                         ; preds = %do.body.i
  %7 = and i64 %call.i, 2147483648
  %cmp8.not.i = icmp eq i64 %7, 0
  br i1 %cmp8.not.i, label %if.then16.i, label %gz_load.exit
...
gz_load.exit:                                     ; preds = %do.end.i
  %call11.i = tail call ptr @__errno_location() #13
  %8 = load i32, ptr %call11.i, align 4, !tbaa !29
  %call12.i = tail call ptr @strerror(i32 noundef %8) #12
  tail call void @gz_error(ptr noundef nonnull %state, i32 noundef -1, ptr noundef %call12.i) #12
  br label %cleanup

if.end10:                                         ; preds = %if.end5.i, %if.then16.i
  %9 = load ptr, ptr %out16, align 8, !tbaa !34
  %next = getelementptr inbounds %struct.gzFile_s, ptr %state, i64 0, i32 1
  store ptr %9, ptr %next, align 8, !tbaa !18
  br label %cleanup

sw.bb13:                                          ; preds = %do.body
  %10 = load i32, ptr %size14, align 8, !tbaa !26
  %shl15 = shl i32 %10, 1
  store i32 %shl15, ptr %avail_out, align 8, !tbaa !37
  %11 = load ptr, ptr %out16, align 8, !tbaa !34
  store ptr %11, ptr %next_out, align 8, !tbaa !38
  %call17 = tail call fastcc i32 @gz_decomp(ptr noundef nonnull %state)
  %cmp18 = icmp eq i32 %call17, -1
  br i1 %cmp18, label %cleanup, label %do.cond

do.cond:                                          ; preds = %do.body, %if.end, %sw.bb13
  %12 = load i32, ptr %state, align 8, !tbaa !17
  %cmp23 = icmp eq i32 %12, 0
  br i1 %cmp23, label %land.rhs, label %cleanup

land.rhs:                                         ; preds = %do.cond
  %13 = load i32, ptr %eof, align 8, !tbaa !20
  %tobool.not = icmp eq i32 %13, 0
  br i1 %tobool.not, label %do.body.backedge, label %lor.rhs

lor.rhs:                                          ; preds = %land.rhs
  %14 = load i32, ptr %avail_in, align 8, !tbaa !39
...
cleanup:                                          ; preds = %lor.rhs, %do.cond, %sw.bb13, %if.end, %sw.bb, %gz_load.exit, %if.end10
...
if.then5:                                         ; preds = %land.lhs.true3
  %call = tail call fastcc i32 @gz_look(ptr noundef nonnull %file)
  br label %if.end6
...
if.end6:                                          ; preds = %if.then5, %land.lhs.true3, %land.lhs.true, %if.end
  ...
  %3 = load i32, ptr %direct, align 8, !tbaa !41
  br label %cleanup
...
if.then:                                          ; preds = %entry
  ...
  store ptr %call4, ptr %out, align 8, !tbaa !34
...
land.lhs.true:                                    ; preds = %if.end39, %if.end30
  ...
  %7 = load ptr, ptr %strm1, align 8, !tbaa !45
...
land.lhs.true53:                                  ; preds = %land.lhs.true
  ...
  %9 = load i8, ptr %arrayidx55, align 1, !tbaa !33
...
if.then59:                                        ; preds = %land.lhs.true53
  ...
  %how = getelementptr inbounds %struct.gz_state, ptr %state, i64 0, i32 9
  store i32 2, ptr %how, align 4, !tbaa !25
  %direct = getelementptr inbounds %struct.gz_state, ptr %state, i64 0, i32 8
  store i32 0, ptr %direct, align 8, !tbaa !41
  br label %cleanup
...
if.end61:                                         ; preds = %if.end39, %land.lhs.true53, %land.lhs.true
  ...
  %11 = load i32, ptr %direct62, align 8, !tbaa !41
  %cmp63 = icmp eq i32 %11, 0
  br i1 %cmp63, label %if.then65, label %if.end81

if.then65:                                        ; preds = %if.end61
  store i32 0, ptr %avail_in31, align 8, !tbaa !39
  %eof = getelementptr inbounds %struct.gz_state, ptr %state, i64 0, i32 11
  store i32 1, ptr %eof, align 8, !tbaa !20
  store i32 0, ptr %state, align 8, !tbaa !17
  br label %cleanup
...
if.end3:                                          ; preds = %if.end
  %size = getelementptr inbounds %struct.gz_state, ptr %file, i64 0, i32 4
  %1 = load i32, ptr %size, align 8, !tbaa !26
...
entry:
  %strm1 = getelementptr inbounds %struct.gz_state, ptr %state, i64 0, i32 19
  %avail_out = getelementptr inbounds %struct.gz_state, ptr %state, i64 0, i32 19, i32 4
  %0 = load i32, ptr %avail_out, align 8, !tbaa !37
  %avail_in = getelementptr inbounds %struct.gz_state, ptr %state, i64 0, i32 19, i32 1
  br label %do.body

do.body:                                          ; preds = %do.cond, %entry
  %ret.0 = phi i32 [ 0, %entry ], [ %call7, %do.cond ]
  %1 = load i32, ptr %avail_in, align 8, !tbaa !39
  %cmp = icmp eq i32 %1, 0
  br i1 %cmp, label %land.lhs.true, label %if.end6

land.lhs.true:                                    ; preds = %do.body
  %call = tail call fastcc i32 @gz_avail(ptr noundef nonnull %state)
  %cmp2 = icmp eq i32 %call, -1
  br i1 %cmp2, label %cleanup, label %if.end

if.end:                                           ; preds = %land.lhs.true
  %.pr = load i32, ptr %avail_in, align 8, !tbaa !39
  %cmp4 = icmp eq i32 %.pr, 0
  br i1 %cmp4, label %if.then5, label %if.end6

if.then5:                                         ; preds = %if.end
  tail call void @gz_error(ptr noundef nonnull %state, i32 noundef -5, ptr noundef nonnull @.str.3) #12
  %.pre = load i32, ptr %avail_out, align 8, !tbaa !37
  br label %do.end
...
if.then16:                                        ; preds = %if.end6
  ...
  %2 = load ptr, ptr %msg, align 8, !tbaa !47
...
do.cond:                                          ; preds = %if.end6
  %3 = load i32, ptr %avail_out, align 8, !tbaa !37
...
do.end:                                           ; preds = %do.cond, %if.then5
  ...
  store i32 %sub, ptr %state, align 8, !tbaa !17
  %next_out = getelementptr inbounds %struct.gz_state, ptr %state, i64 0, i32 19, i32 3
  %6 = load ptr, ptr %next_out, align 8, !tbaa !38
...
if.then27:                                        ; preds = %do.end
  %how = getelementptr inbounds %struct.gz_state, ptr %state, i64 0, i32 9
  store i32 0, ptr %how, align 4, !tbaa !25
  br label %cleanup
...
if.then5:                                         ; preds = %if.end
  %avail_in = getelementptr inbounds %struct.gz_state, ptr %state, i64 0, i32 19, i32 1
  %2 = load i32, ptr %avail_in, align 8, !tbaa !39
  %tobool.not = icmp eq i32 %2, 0
...
iter.check:                                       ; preds = %if.then5
  %in = getelementptr inbounds %struct.gz_state, ptr %state, i64 0, i32 6
  %3 = load ptr, ptr %in, align 8, !tbaa !43
  %4 = load ptr, ptr %strm1, align 8, !tbaa !45
  %5 = zext i32 %2 to i64
...
vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check50 = icmp ult i32 %2, 32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep52 = getelementptr i8, ptr %4, i64 %index
  %wide.load = load <16 x i8>, ptr %next.gep52, align 1, !tbaa !33
  %9 = getelementptr i8, ptr %next.gep52, i64 16
  %wide.load54 = load <16 x i8>, ptr %9, align 1, !tbaa !33
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !33
  %10 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load54, ptr %10, align 1, !tbaa !33
  %index.next = add nuw i64 %index, 32
  %11 = icmp eq i64 %index.next, %n.vec
  br i1 %11, label %middle.block, label %vector.body, !llvm.loop !49
...
vec.epilog.iter.check:                            ; preds = %middle.block
  %.cast66 = trunc i64 %n.vec to i32
  %ind.end67 = sub i32 %2, %.cast66
  %ind.end63 = getelementptr i8, ptr %4, i64 %n.vec
  %ind.end60 = getelementptr i8, ptr %3, i64 %n.vec
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec58 = and i64 %5, 4294967288
  %ind.end59 = getelementptr i8, ptr %3, i64 %n.vec58
  %ind.end62 = getelementptr i8, ptr %4, i64 %n.vec58
  %.cast = trunc i64 %n.vec58 to i32
  %ind.end65 = sub i32 %2, %.cast
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index70 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next74, %vec.epilog.vector.body ]
  %next.gep71 = getelementptr i8, ptr %3, i64 %index70
  %next.gep72 = getelementptr i8, ptr %4, i64 %index70
  %wide.load73 = load <8 x i8>, ptr %next.gep72, align 1, !tbaa !33
  store <8 x i8> %wide.load73, ptr %next.gep71, align 1, !tbaa !33
  %index.next74 = add nuw i64 %index70, 8
  %12 = icmp eq i64 %index.next74, %n.vec58
  br i1 %12, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !52

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n69 = icmp eq i64 %n.vec58, %5
  br i1 %cmp.n69, label %if.end10.loopexit, label %do.body.preheader

do.body.preheader:                                ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %p.0.ph = phi ptr [ %3, %iter.check ], [ %ind.end60, %vec.epilog.iter.check ], [ %ind.end59, %vec.epilog.middle.block ]
  %q.0.ph = phi ptr [ %4, %iter.check ], [ %ind.end63, %vec.epilog.iter.check ], [ %ind.end62, %vec.epilog.middle.block ]
  %n.0.ph = phi i32 [ %2, %iter.check ], [ %ind.end67, %vec.epilog.iter.check ], [ %ind.end65, %vec.epilog.middle.block ]
  %13 = add i32 %n.0.ph, -1
...
do.body.prol:                                     ; preds = %do.body.preheader, %do.body.prol
  ...
  %14 = load i8, ptr %q.0.prol, align 1, !tbaa !33
  %incdec.ptr8.prol = getelementptr inbounds i8, ptr %p.0.prol, i64 1
  store i8 %14, ptr %p.0.prol, align 1, !tbaa !33
  %dec.prol = add i32 %n.0.prol, -1
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %do.body.prol.loopexit, label %do.body.prol, !llvm.loop !53
...
do.body.i:                                        ; preds = %if.end5.i, %if.end10
  ...
  %spec.select.i = tail call i32 @llvm.umin.i32(i32 %sub.i, i32 1073741824)
  %27 = load i32, ptr %fd.i, align 4, !tbaa !27
...
if.end5.i:                                        ; preds = %do.body.i
  ...
  br i1 %cmp6.i, label %do.body.i, label %if.end16, !llvm.loop !28

do.end.i:                                         ; preds = %do.body.i
  %28 = and i64 %call.i, 2147483648
  %cmp8.not.i = icmp eq i64 %28, 0
  br i1 %cmp8.not.i, label %if.then16.i, label %gz_load.exit
...
gz_load.exit:                                     ; preds = %do.end.i
  %call11.i = tail call ptr @__errno_location() #13
  %29 = load i32, ptr %call11.i, align 4, !tbaa !29
  %call12.i = tail call ptr @strerror(i32 noundef %29) #12
  tail call void @gz_error(ptr noundef nonnull %state, i32 noundef -1, ptr noundef %call12.i) #12
  br label %cleanup

if.end16:                                         ; preds = %if.end5.i, %if.then16.i
  %got.1.ph = phi i32 [ %got.0, %if.then16.i ], [ %add.i, %if.end5.i ]
  %30 = load i32, ptr %avail_in, align 8, !tbaa !39
  %add = add i32 %30, %got.1.ph
  store i32 %add, ptr %avail_in, align 8, !tbaa !39
  %31 = load ptr, ptr %in11, align 8, !tbaa !43
  store ptr %31, ptr %strm1, align 8, !tbaa !45
  br label %cleanup
...
!47 = !{!13, !11, i64 48}
!48 = distinct !{!48, !23}
!49 = distinct !{!49, !23, !50, !51}
!50 = !{!"llvm.loop.isvectorized", i32 1}
!51 = !{!"llvm.loop.unroll.runtime.disable"}
!52 = distinct !{!52, !23, !50, !51}
!53 = distinct !{!53, !54}
!54 = !{!"llvm.loop.unroll.disable"}
!55 = distinct !{!55, !23, !50}
