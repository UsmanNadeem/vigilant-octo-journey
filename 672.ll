; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_hashtab.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_hashtab.c"
...
do.body:                                          ; preds = %if.else181, %hash.exit
  %tries.0 = phi i64 [ 1, %hash.exit ], [ %inc, %if.else181 ]
  %idx.0 = phi i64 [ %Hash.0.lcssa.i, %hash.exit ], [ %rem, %if.else181 ]
...
if.else:                                          ; preds = %do.body
  ...
  br i1 %cmp.not, label %if.else181, label %land.lhs.true

land.lhs.true:                                    ; preds = %if.else
  %call175 = tail call i32 @strncmp(ptr noundef %key, ptr noundef nonnull %7, i64 noundef %len) #13
  %cmp178 = icmp eq i32 %call175, 0
  br i1 %cmp178, label %cleanup, label %if.else181

if.else181:                                       ; preds = %land.lhs.true, %if.else
  %inc = add i64 %tries.0, 1
  %add = add i64 %idx.0, %tries.0
  %rem = urem i64 %add, %0
  %cmp188.not = icmp ugt i64 %inc, %0
  br i1 %cmp188.not, label %cleanup, label %do.body, !llvm.loop !19

cleanup:                                          ; preds = %if.else181, %land.lhs.true, %do.body, %entry
  %retval.0 = phi ptr [ null, %entry ], [ null, %if.else181 ], [ %element.0, %land.lhs.true ], [ null, %do.body ]
  ret ptr %retval.0
}
...
entry:
  %tobool.not = icmp eq ptr %s, null
  br i1 %tobool.not, label %cleanup220, label %do.body.preheader

do.body.preheader:                                ; preds = %entry
  %capacity = getelementptr inbounds %struct.hashtable, ptr %s, i64 0, i32 1
  %cmp.not4.i = icmp eq i64 %len, 0
  br i1 %cmp.not4.i, label %do.body.us.preheader, label %do.body.preheader319

do.body.preheader319:                             ; preds = %do.body.preheader
  %xtraiter = and i64 %len, 1
  %0 = icmp eq i64 %len, 1
  %unroll_iter = and i64 %len, -2
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
...
do.body.us.preheader:                             ; preds = %do.body.preheader
  ...
  %tobool3.not.us304 = icmp eq ptr %2, null
  br i1 %tobool3.not.us304, label %if.then4, label %if.else21.us.lr.ph
...
if.else21.us.lr.ph:                               ; preds = %do.body.us.preheader, %do.body.us
  %cmp23.us308.in = phi ptr [ %4, %do.body.us ], [ %2, %do.body.us.preheader ]
  %tobool3.not.us307 = phi i1 [ %tobool3.not.us, %do.body.us ], [ %tobool3.not.us304, %do.body.us.preheader ]
  %5 = phi ptr [ %3, %do.body.us ], [ %1, %do.body.us.preheader ]
  %6 = load i64, ptr %capacity, align 8, !tbaa !11
  %cmp23.us308 = icmp eq ptr %cmp23.us308.in, @DELETED_KEY
  %cmp212.not.us309 = icmp eq i64 %6, 0
  br label %if.else21.us

do.body1.us:                                      ; preds = %do.cond.us
  br i1 %tobool3.not.us307, label %if.then4, label %if.else21.us, !llvm.loop !21

if.else21.us:                                     ; preds = %if.else21.us.lr.ph, %do.body1.us
  br i1 %cmp23.us308, label %do.cond.us, label %if.then200

do.cond.us:                                       ; preds = %if.else21.us
  br i1 %cmp212.not.us309, label %do.end.us, label %do.body1.us, !llvm.loop !21

do.end.us:                                        ; preds = %do.cond.us
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.1, ptr noundef nonnull %s, i64 noundef %6) #12
  %call216.us = tail call fastcc i32 @hashtab_grow(ptr noundef nonnull %s)
  %cmp217.us = icmp sgt i32 %call216.us, -1
  br i1 %cmp217.us, label %do.body.us, label %do.end219, !llvm.loop !20

do.body:                                          ; preds = %do.body.preheader319, %do.end
  %deleted_element.0 = phi ptr [ %deleted_element.2, %do.end ], [ null, %do.body.preheader319 ]
  %tries.0 = phi i64 [ %tries.2, %do.end ], [ 1, %do.body.preheader319 ]
...
if.then4:                                         ; preds = %do.body1, %do.body.us, %do.body1.us, %do.body.us.preheader
  ...
  %.us-phi264 = phi ptr [ null, %do.body.us.preheader ], [ %5, %do.body1.us ], [ %5, %do.body.us ], [ %deleted_element.1, %do.body1 ]
  %add = add i64 %len, 1
  %call8 = tail call ptr @cli_malloc(i64 noundef %add) #12
  %tobool9.not = icmp eq ptr %call8, null
  br i1 %tobool9.not, label %cleanup220, label %if.end11

if.end11:                                         ; preds = %if.then4
  %tobool5.not = icmp eq ptr %.us-phi264, null
  %spec.select = select i1 %tobool5.not, ptr %.us-phi, ptr %.us-phi264
  ...
  br i1 %cmp, label %if.then17, label %cleanup220
...
if.else25:                                        ; preds = %if.else21
  %call195 = tail call i32 @strncmp(ptr noundef %key, ptr noundef nonnull %12, i64 noundef %len) #13
  %cmp198 = icmp eq i32 %call195, 0
  br i1 %cmp198, label %if.then200, label %if.else202

if.then200:                                       ; preds = %if.else25, %if.else21.us
  %.us-phi265 = phi ptr [ %5, %if.else21.us ], [ %element.0, %if.else25 ]
  %data201 = getelementptr inbounds %struct.element, ptr %.us-phi265, i64 0, i32 1
  store i64 %data, ptr %data201, align 8, !tbaa !22
  br label %cleanup220

if.else202:                                       ; preds = %if.else25
  %inc203 = add i64 %tries.1, 1
  %add204 = add i64 %idx.0, %tries.1
  %rem = urem i64 %add204, %7
  %arrayidx207 = getelementptr inbounds %struct.element, ptr %11, i64 %rem
  br label %do.cond

do.cond:                                          ; preds = %if.else21, %if.else202
  %element.2 = phi ptr [ %arrayidx207, %if.else202 ], [ %element.0, %if.else21 ]
  %deleted_element.2 = phi ptr [ %deleted_element.1, %if.else202 ], [ %element.0, %if.else21 ]
  %tries.2 = phi i64 [ %inc203, %if.else202 ], [ %tries.1, %if.else21 ]
  %idx.1 = phi i64 [ %rem, %if.else202 ], [ %idx.0, %if.else21 ]
  %cmp212.not = icmp ugt i64 %tries.2, %7
  br i1 %cmp212.not, label %do.end, label %do.body1, !llvm.loop !21

do.end:                                           ; preds = %do.cond
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.1, ptr noundef nonnull %s, i64 noundef %7) #12
  %call216 = tail call fastcc i32 @hashtab_grow(ptr noundef nonnull %s)
  %cmp217 = icmp sgt i32 %call216, -1
  br i1 %cmp217, label %do.body, label %do.end219, !llvm.loop !20

do.end219:                                        ; preds = %do.end, %do.end.us
  tail call void (ptr, ...) @cli_warnmsg(ptr noundef nonnull @.str.2) #12
  br label %cleanup220

cleanup220:                                       ; preds = %if.then4, %if.then17, %if.end11, %entry, %do.end219, %if.then200
  %retval.1 = phi i32 [ -114, %do.end219 ], [ 0, %if.then200 ], [ -111, %entry ], [ -114, %if.then4 ], [ 0, %if.then17 ], [ 0, %if.end11 ]
  ret i32 %retval.1
}
...
while.body:                                       ; preds = %hash.exit, %while.body
  ...
  %17 = select i1 %tobool22, i1 %cmp23, i1 false
...
do.body.i:                                        ; preds = %if.else181.i, %hash.exit.i
  %tries.0.i = phi i64 [ 1, %hash.exit.i ], [ %inc.i, %if.else181.i ]
  %idx.0.i = phi i64 [ %Hash.0.lcssa.i.i, %hash.exit.i ], [ %rem.i, %if.else181.i ]
...
if.else.i:                                        ; preds = %do.body.i
  ...
  br i1 %cmp.not.i, label %if.else181.i, label %land.lhs.true.i

land.lhs.true.i:                                  ; preds = %if.else.i
  %call175.i = tail call i32 @strncmp(ptr noundef %key, ptr noundef nonnull %7, i64 noundef %len) #13
  %cmp178.i = icmp eq i32 %call175.i, 0
  br i1 %cmp178.i, label %if.then, label %if.else181.i

if.else181.i:                                     ; preds = %land.lhs.true.i, %if.else.i
  %inc.i = add i64 %tries.0.i, 1
  %add.i = add i64 %idx.0.i, %tries.0.i
  %rem.i = urem i64 %add.i, %0
  %cmp188.not.i = icmp ugt i64 %inc.i, %0
  br i1 %cmp188.not.i, label %if.end, label %do.body.i, !llvm.loop !19
...
if.end:                                           ; preds = %do.body.i, %if.else181.i, %entry, %if.then
  ret void
}
...
while.body:                                       ; preds = %entry, %while.body
  ...
  %call7 = call i32 @hashtab_insert(ptr noundef %s, ptr noundef nonnull %l, i64 noundef %call6, i64 noundef %conv)
