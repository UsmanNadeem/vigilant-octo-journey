; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Common/CreateCoder.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Common/CreateCoder.cpp"
...
for.cond:                                         ; preds = %for.body.preheader, %for.body
  ...
  br i1 %exitcond.not, label %cleanup2.loopexit, label %for.body, !llvm.loop !22
...
cleanup2.loopexit:                                ; preds = %for.cond
  %cmp.le25 = icmp ult i64 %indvars.iv.next, %1
  br label %cleanup2

cleanup2:                                         ; preds = %cleanup2.loopexit, %entry, %_ZN11CStringBaseIwEaSEPKw.exit
  %cmp7 = phi i1 [ %cmp10.lcssa, %_ZN11CStringBaseIwEaSEPKw.exit ], [ false, %entry ], [ %cmp.le25, %cleanup2.loopexit ]
  ret i1 %cmp7
}
