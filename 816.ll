; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/makesite.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/makesite.c"
...
for.cond.preheader:                               ; preds = %if.then27
  ...
  %uglygep338 = getelementptr i8, ptr %6, i64 20
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1000) %uglygep338, i8 0, i64 1000, i1 false), !tbaa !15
...
for.body94.lr.ph:                                 ; preds = %for.cond69.preheader
  ...
  %uglygep = getelementptr i8, ptr %17, i64 20
  %18 = zext i32 %sub26 to i64
  %19 = mul nuw nsw i64 %18, 20
  tail call void @llvm.memset.p0.i64(ptr align 4 %uglygep, i8 0, i64 %19, i1 false), !tbaa !15
...
for.body120.preheader:                            ; preds = %for.body120.lr.ph, %middle.block367
  ...
  %116 = insertelement <2 x i32> poison, i32 %xx1, i64 1
  br label %for.body120
...
for.body120:                                      ; preds = %for.body120.preheader, %for.body120
  ...
  %117 = insertelement <2 x i64> poison, i64 %indvars.iv.next357, i64 0
  %118 = insertelement <2 x i64> %117, i64 %indvars.iv356, i64 1
  %119 = trunc <2 x i64> %118 to <2 x i32>
  %120 = sitofp <2 x i32> %119 to <2 x double>
  %121 = fmul <2 x double> %115, %120
  %122 = fptosi <2 x double> %121 to <2 x i32>
  %123 = sitofp <2 x i32> %122 to <2 x double>
  %124 = fsub <2 x double> %121, %123
  %125 = fcmp oge <2 x double> %124, <double 5.000000e-01, double 5.000000e-01>
  %126 = zext <2 x i1> %125 to <2 x i32>
  %127 = add nsw <2 x i32> %126, %122
  %128 = shufflevector <2 x i32> %116, <2 x i32> %127, <2 x i32> <i32 3, i32 1>
  %129 = sub <2 x i32> %127, %128
  %130 = add nsw <2 x i32> %127, %128
...
for.cond117.if.end243.loopexit_crit_edge.loopexit: ; preds = %for.body120
  %145 = extractelement <2 x double> %121, i64 1
  %146 = extractelement <2 x double> %121, i64 0
  br label %for.cond117.if.end243.loopexit_crit_edge
