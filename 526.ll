; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/ldecod/header.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/ldecod/header.c"
...
entry:
  ...
  %call = tail call i32 @ue_v(ptr noundef nonnull @.str, ptr noundef %5) #11
  %start_mb_nr = getelementptr inbounds %struct.Slice, ptr %1, i64 0, i32 5
  store i32 %call, ptr %start_mb_nr, align 4, !tbaa !26
  %call5 = tail call i32 @ue_v(ptr noundef nonnull @.str.1, ptr noundef %5) #11
  ...
  %call6 = tail call i32 @ue_v(ptr noundef nonnull @.str.2, ptr noundef %5) #11
...
entry:
  ...
  %add = add i32 %7, 4
  %call = tail call i32 @u_v(i32 noundef %add, ptr noundef nonnull @.str.3, ptr noundef %5) #11
...
if.else:                                          ; preds = %if.end
  %call7 = tail call i32 @u_1(ptr noundef nonnull @.str.4, ptr noundef %5) #11
...
if.then11:                                        ; preds = %if.else
  %call12 = tail call i32 @u_1(ptr noundef nonnull @.str.5, ptr noundef %5) #11
...
if.then39:                                        ; preds = %land.end
  %call40 = tail call i32 @ue_v(ptr noundef nonnull @.str.6, ptr noundef %5) #11
...
if.then43:                                        ; preds = %if.end41
  ...
  %add44 = add i32 %25, 4
  %call45 = tail call i32 @u_v(i32 noundef %add44, ptr noundef nonnull @.str.7, ptr noundef %5) #11
...
if.then49:                                        ; preds = %land.lhs.true
  %call50 = tail call i32 @se_v(ptr noundef nonnull @.str.8, ptr noundef %5) #11
...
if.then59:                                        ; preds = %land.lhs.true57
  %call60 = tail call i32 @se_v(ptr noundef nonnull @.str.9, ptr noundef %5) #11
...
if.then67:                                        ; preds = %land.lhs.true64
  %call68 = tail call i32 @se_v(ptr noundef nonnull @.str.10, ptr noundef %5) #11
...
if.then83:                                        ; preds = %if.end81
  %call84 = tail call i32 @ue_v(ptr noundef nonnull @.str.11, ptr noundef %5) #11
...
if.then87:                                        ; preds = %if.end85
  %call88 = tail call i32 @u_1(ptr noundef nonnull @.str.12, ptr noundef %5) #11
...
if.then99:                                        ; preds = %if.end89, %if.end89, %if.end89
  %call100 = tail call i32 @u_1(ptr noundef nonnull @.str.13, ptr noundef %5) #11
...
if.then102:                                       ; preds = %if.then99
  %call103 = tail call i32 @ue_v(ptr noundef nonnull @.str.14, ptr noundef %5) #11
...
if.then108:                                       ; preds = %if.then102
  %call109 = tail call i32 @ue_v(ptr noundef nonnull @.str.15, ptr noundef %5) #11
...
if.end119:                                        ; preds = %if.then117, %if.end114
  ...
  tail call void @alloc_ref_pic_list_reordering_buffer(ptr noundef %57) #11
...
if.then.i:                                        ; preds = %if.end119
  %call.i = tail call i32 @u_1(ptr noundef nonnull @.str.58, ptr noundef %61) #11
...
do.body.i:                                        ; preds = %if.end21.i, %do.body.preheader.i
  ...
  %call7.i = tail call i32 @ue_v(ptr noundef nonnull @.str.59, ptr noundef %61) #11
...
if.end21.sink.split.i:                            ; preds = %if.else.i, %do.body.i
  ...
  %call18.i = tail call i32 @ue_v(ptr noundef nonnull %.str.61.sink.i, ptr noundef %61) #11
...
if.then27.i:                                      ; preds = %if.end24.i
  %call28.i = tail call i32 @u_1(ptr noundef nonnull @.str.62, ptr noundef %61) #11
...
do.body31.i:                                      ; preds = %if.end49.i, %do.body31.preheader.i
  ...
  %call32.i = tail call i32 @ue_v(ptr noundef nonnull @.str.63, ptr noundef %61) #11
...
if.end49.sink.split.i:                            ; preds = %if.else42.i, %do.body31.i
  ...
  %call45.i = tail call i32 @ue_v(ptr noundef nonnull %.str.65.sink.i, ptr noundef %61) #11
...
if.then146:                                       ; preds = %land.lhs.true134, %land.lhs.true134, %land.lhs.true143
  ...
  %call.i306 = tail call i32 @ue_v(ptr noundef nonnull @.str.66, ptr noundef %87) #11
...
if.then.i308:                                     ; preds = %if.then146
  %call6.i = tail call i32 @ue_v(ptr noundef nonnull @.str.67, ptr noundef %87) #11
...
if.end.i:                                         ; preds = %if.then.i308, %if.then146
  ...
  tail call void @reset_wp_params(ptr noundef nonnull %92) #11
...
for.body.i:                                       ; preds = %if.end.i, %for.inc83.i
  ...
  %call17.i = tail call i32 @u_1(ptr noundef nonnull @.str.68, ptr noundef %87) #11
  %tobool18.not.i = icmp eq i32 %call17.i, 0
  br i1 %tobool18.not.i, label %if.else.i310, label %if.then19.i

if.then19.i:                                      ; preds = %for.body.i
  %call20.i = tail call i32 @se_v(ptr noundef nonnull @.str.69, ptr noundef %87) #11
  ...
  %call25.i = tail call i32 @se_v(ptr noundef nonnull @.str.70, ptr noundef %87) #11
...
if.then45.i:                                      ; preds = %if.end42.i
  %call46.i = tail call i32 @u_1(ptr noundef nonnull @.str.71, ptr noundef %87) #11
...
for.body49.preheader.i:                           ; preds = %if.then45.i
  %call52.i = tail call i32 @se_v(ptr noundef nonnull @.str.72, ptr noundef %87) #11
  ...
  %call59.i = tail call i32 @se_v(ptr noundef nonnull @.str.73, ptr noundef %87) #11
  ...
  %call52.1.i = tail call i32 @se_v(ptr noundef nonnull @.str.72, ptr noundef %87) #11
  ...
  %call59.1.i = tail call i32 @se_v(ptr noundef nonnull @.str.73, ptr noundef %87) #11
...
for.body91.i:                                     ; preds = %for.cond89.preheader.i, %for.inc164.i
  ...
  %call92.i = tail call i32 @u_1(ptr noundef nonnull @.str.74, ptr noundef %87) #11
...
if.then94.i:                                      ; preds = %for.body91.i
  %call95.i = tail call i32 @se_v(ptr noundef nonnull @.str.75, ptr noundef %87) #11
  ...
  %call101.i = tail call i32 @se_v(ptr noundef nonnull @.str.76, ptr noundef %87) #11
...
if.then123.i:                                     ; preds = %if.end120.i
  %call124.i = tail call i32 @u_1(ptr noundef nonnull @.str.77, ptr noundef %87) #11
...
for.body127.preheader.i:                          ; preds = %if.then123.i
  %call130.i = tail call i32 @se_v(ptr noundef nonnull @.str.78, ptr noundef %87) #11
  ...
  %call137.i = tail call i32 @se_v(ptr noundef nonnull @.str.79, ptr noundef %87) #11
  ...
  %call130.1.i = tail call i32 @se_v(ptr noundef nonnull @.str.78, ptr noundef %87) #11
  ...
  %call137.1.i = tail call i32 @se_v(ptr noundef nonnull @.str.79, ptr noundef %87) #11
...
if.then158:                                       ; preds = %land.lhs.true152
  %call159 = tail call i32 @ue_v(ptr noundef nonnull @.str.16, ptr noundef %5) #11
...
if.end162:                                        ; preds = %land.lhs.true152, %land.lhs.true152, %if.end150, %if.then158
  ...
  %call163 = tail call i32 @se_v(ptr noundef nonnull @.str.17, ptr noundef %5) #11
...
if.then172:                                       ; preds = %if.end162
  tail call void @error(ptr noundef nonnull @.str.18, i32 noundef 500) #11
...
if.then182:                                       ; preds = %if.then179
  %call183 = tail call i32 @u_1(ptr noundef nonnull @.str.19, ptr noundef %5) #11
...
if.end184:                                        ; preds = %if.then182, %if.then179
  %call185 = tail call i32 @se_v(ptr noundef nonnull @.str.20, ptr noundef %5) #11
...
if.then193:                                       ; preds = %if.end184
  tail call void @error(ptr noundef nonnull @.str.21, i32 noundef 500) #11
  br label %if.end195
...
if.then197:                                       ; preds = %if.end195
  %call198 = tail call i32 @ue_v(ptr noundef nonnull @.str.22, ptr noundef %5) #11
...
if.then201:                                       ; preds = %if.then197
  %call202 = tail call i32 @se_v(ptr noundef nonnull @.str.23, ptr noundef %5) #11
  %mul = shl nsw i32 %call202, 1
  store i32 %mul, ptr %LFAlphaC0Offset207, align 4, !tbaa !90
  %call203 = tail call i32 @se_v(ptr noundef nonnull @.str.24, ptr noundef %5) #11
...
CeilLog2.exit:                                    ; preds = %while.body.i, %if.then220
  ...
  %call238 = tail call i32 @u_v(i32 noundef %uiRet.0.lcssa.i, ptr noundef nonnull @.str.25, ptr noundef %5) #11
...
if.then:                                          ; preds = %while.end
  %call = tail call i32 @u_1(ptr noundef nonnull @.str.26, ptr noundef %currStream) #11
  %7 = load ptr, ptr @img, align 8, !tbaa !7
  ...
  %call4 = tail call i32 @u_1(ptr noundef nonnull @.str.27, ptr noundef %currStream) #11
  %8 = load ptr, ptr @img, align 8, !tbaa !7
...
if.else:                                          ; preds = %while.end
  %call5 = tail call i32 @u_1(ptr noundef nonnull @.str.28, ptr noundef %currStream) #11
...
do.body:                                          ; preds = %if.else, %do.cond
  %call9 = tail call noalias dereferenceable_or_null(32) ptr @calloc(i64 noundef 1, i64 noundef 32) #12
  %Next10 = getelementptr inbounds %struct.DecRefPicMarking_s, ptr %call9, i64 0, i32 5
  store ptr null, ptr %Next10, align 8, !tbaa !104
  %call11 = tail call i32 @ue_v(ptr noundef nonnull @.str.29, ptr noundef %currStream) #11
...
if.then13:                                        ; preds = %do.body, %do.body
  %call14 = tail call i32 @ue_v(ptr noundef nonnull @.str.30, ptr noundef %currStream) #11
...
if.then16:                                        ; preds = %do.body, %if.then13
  %call17 = tail call i32 @ue_v(ptr noundef nonnull @.str.31, ptr noundef %currStream) #11
...
if.then22:                                        ; preds = %if.then13, %do.body
  %call23 = tail call i32 @ue_v(ptr noundef nonnull @.str.32, ptr noundef %currStream) #11
...
if.then26:                                        ; preds = %do.body
  %call27 = tail call i32 @ue_v(ptr noundef nonnull @.str.33, ptr noundef %currStream) #11
...
if.then87:                                        ; preds = %if.then84
  tail call void @error(ptr noundef nonnull @.str.34, i32 noundef -1020) #11
...
vector.memcheck:                                  ; preds = %for.body.lr.ph
  %uglygep = getelementptr i8, ptr %img, i64 5748
  %uglygep508 = getelementptr i8, ptr %30, i64 1036
  %39 = shl nuw nsw i64 %wide.trip.count, 2
  %40 = add nuw nsw i64 %39, 1036
  %uglygep509 = getelementptr i8, ptr %30, i64 %40
  %bound0 = icmp ult ptr %ExpectedDeltaPerPicOrderCntCycle, %uglygep509
  %bound1 = icmp ult ptr %uglygep508, %uglygep
...
vector.memcheck512:                               ; preds = %for.body147.lr.ph
  %uglygep513 = getelementptr i8, ptr %img, i64 5728
  %uglygep514 = getelementptr i8, ptr %30, i64 1036
  %60 = shl nuw nsw i64 %wide.trip.count477, 2
  %61 = add nuw nsw i64 %60, 1036
  %uglygep515 = getelementptr i8, ptr %30, i64 %61
  %bound0516 = icmp ult ptr %ExpectedPicOrderCnt, %uglygep515
  %bound1517 = icmp ult ptr %uglygep514, %uglygep513
