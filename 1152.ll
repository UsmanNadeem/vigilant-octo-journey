; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/C/LzmaDec.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/C/LzmaDec.c"
...
entry:
  ...
  %needInitState.i = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 14
  store i32 1, ptr %needInitState.i, align 4, !tbaa !17
  ret void
}
...
LzmaDec_WriteRem.exit:                            ; preds = %entry, %while.end.i
  ...
  %cmp.not330 = icmp eq i32 %15, 274
  br i1 %cmp.not330, label %while.end153, label %while.body.lr.ph
...
while.body.lr.ph:                                 ; preds = %LzmaDec_WriteRem.exit
  ...
  %arrayidx4.i274 = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 11, i64 3
...
while.body:                                       ; preds = %while.body.lr.ph, %cleanup150
  %17 = phi i32 [ %15, %while.body.lr.ph ], [ %76, %cleanup150 ]
  %src.addr.0332 = phi ptr [ %src, %while.body.lr.ph ], [ %src.addr.6, %cleanup150 ]
  %inSize.0331 = phi i64 [ %0, %while.body.lr.ph ], [ %inSize.6, %cleanup150 ]
...
for.cond.preheader:                               ; preds = %while.body
  %cmp2.not313 = icmp eq i64 %inSize.0331, 0
  %.pre = load i32, ptr %tempBufSize, align 4, !tbaa !14
  br i1 %cmp2.not313, label %for.end, label %land.rhs.lr.ph

land.rhs.lr.ph:                                   ; preds = %for.cond.preheader
  %umax = tail call i32 @llvm.umax.i32(i32 %.pre, i32 5)
  %wide.trip.count = zext i32 %umax to i64
  %exitcond.not398 = icmp ugt i32 %.pre, 4
  br i1 %exitcond.not398, label %for.end, label %for.body
...
for.body.1:                                       ; preds = %land.rhs
  %incdec.ptr.1 = getelementptr inbounds i8, ptr %src.addr.0332, i64 2
  %19 = load i8, ptr %incdec.ptr, align 1, !tbaa !24
  %indvars.iv.next.1 = add nuw nsw i64 %31, 2
  ...
  %dec.1 = add i64 %inSize.0331, -2
  %cmp2.not.1 = icmp eq i64 %dec.1, 0
  br i1 %cmp2.not.1, label %for.end.loopexit.split.loop.exit, label %land.rhs.1, !llvm.loop !27
...
for.body.2:                                       ; preds = %land.rhs.1
  %incdec.ptr.2 = getelementptr inbounds i8, ptr %src.addr.0332, i64 3
  %22 = load i8, ptr %incdec.ptr.1, align 1, !tbaa !24
  %indvars.iv.next.2 = add nuw nsw i64 %31, 3
  ...
  %dec.2 = add i64 %inSize.0331, -3
  %cmp2.not.2 = icmp eq i64 %dec.2, 0
  br i1 %cmp2.not.2, label %for.end.loopexit.split.loop.exit, label %land.rhs.2, !llvm.loop !27
...
for.body.3:                                       ; preds = %land.rhs.2
  %incdec.ptr.3 = getelementptr inbounds i8, ptr %src.addr.0332, i64 4
  %25 = load i8, ptr %incdec.ptr.2, align 1, !tbaa !24
  %indvars.iv.next.3 = add nuw nsw i64 %31, 4
  ...
  %dec.3 = add i64 %inSize.0331, -4
  %cmp2.not.3 = icmp eq i64 %dec.3, 0
  br i1 %cmp2.not.3, label %for.end.loopexit.split.loop.exit, label %land.rhs.3, !llvm.loop !27
...
for.body.4:                                       ; preds = %land.rhs.3
  %incdec.ptr.4 = getelementptr inbounds i8, ptr %src.addr.0332, i64 5
  %28 = load i8, ptr %incdec.ptr.3, align 1, !tbaa !24
  %indvars.iv.next.4 = add nuw nsw i64 %31, 5
  %29 = trunc i64 %indvars.iv.next.4 to i32
  store i32 %29, ptr %tempBufSize, align 4, !tbaa !14
  ...
  %30 = load i64, ptr %srcLen, align 8, !tbaa !19
  %inc5.4 = add i64 %30, 1
  store i64 %inc5.4, ptr %srcLen, align 8, !tbaa !19
  %dec.4 = add i64 %inSize.0331, -5
  %cmp2.not.4 = icmp eq i64 %dec.4, 0
  br i1 %cmp2.not.4, label %for.end.loopexit.split.loop.exit, label %for.end, !llvm.loop !27

for.body:                                         ; preds = %land.rhs.lr.ph
  %31 = zext i32 %.pre to i64
  %incdec.ptr = getelementptr inbounds i8, ptr %src.addr.0332, i64 1
  %32 = load i8, ptr %src.addr.0332, align 1, !tbaa !24
  %indvars.iv.next = add nuw nsw i64 %31, 1
  %33 = trunc i64 %indvars.iv.next to i32
  store i32 %33, ptr %tempBufSize, align 4, !tbaa !14
  %arrayidx = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 17, i64 %31
  store i8 %32, ptr %arrayidx, align 1, !tbaa !24
  %34 = load i64, ptr %srcLen, align 8, !tbaa !19
  %inc5 = add i64 %34, 1
  store i64 %inc5, ptr %srcLen, align 8, !tbaa !19
  %dec = add i64 %inSize.0331, -1
  %cmp2.not = icmp eq i64 %dec, 0
  br i1 %cmp2.not, label %for.end.loopexit.split.loop.exit, label %land.rhs, !llvm.loop !27

for.end.loopexit.split.loop.exit:                 ; preds = %for.body.4, %for.body.3, %for.body.2, %for.body.1, %for.body
  ...
  %indvars.iv.next.lcssa = phi i64 [ %indvars.iv.next, %for.body ], [ %indvars.iv.next.1, %for.body.1 ], [ %indvars.iv.next.2, %for.body.2 ], [ %indvars.iv.next.3, %for.body.3 ], [ %indvars.iv.next.4, %for.body.4 ]
  %35 = trunc i64 %indvars.iv.next.lcssa to i32
  br label %for.end

for.end:                                          ; preds = %land.rhs, %land.rhs.1, %land.rhs.2, %land.rhs.3, %for.body.4, %land.rhs.lr.ph, %for.end.loopexit.split.loop.exit, %for.cond.preheader
  %36 = phi i32 [ %.pre, %for.cond.preheader ], [ %35, %for.end.loopexit.split.loop.exit ], [ %.pre, %land.rhs.lr.ph ], [ %33, %land.rhs ], [ %20, %land.rhs.1 ], [ %23, %land.rhs.2 ], [ %26, %land.rhs.3 ], [ %29, %for.body.4 ]
  %inSize.1.lcssa = phi i64 [ 0, %for.cond.preheader ], [ 0, %for.end.loopexit.split.loop.exit ], [ %inSize.0331, %land.rhs.lr.ph ], [ %dec, %land.rhs ], [ %dec.1, %land.rhs.1 ], [ %dec.2, %land.rhs.2 ], [ %dec.3, %land.rhs.3 ], [ %dec.4, %for.body.4 ]
  %src.addr.1.lcssa = phi ptr [ %src.addr.0332, %for.cond.preheader ], [ %incdec.ptr.lcssa, %for.end.loopexit.split.loop.exit ], [ %src.addr.0332, %land.rhs.lr.ph ], [ %incdec.ptr, %land.rhs ], [ %incdec.ptr.1, %land.rhs.1 ], [ %incdec.ptr.2, %land.rhs.2 ], [ %incdec.ptr.3, %land.rhs.3 ], [ %incdec.ptr.4, %for.body.4 ]
  %cmp7 = icmp ult i32 %36, 5
...
if.end:                                           ; preds = %for.end
  %37 = load i8, ptr %tempBuf9, align 8, !tbaa !24
  %cmp11.not = icmp eq i8 %37, 0
  br i1 %cmp11.not, label %if.end14, label %cleanup162

if.end14:                                         ; preds = %if.end
  %38 = load i8, ptr %arrayidx.i, align 1, !tbaa !24
  %conv.i269 = zext i8 %38 to i32
  %shl.i = shl nuw i32 %conv.i269, 24
  %39 = load i8, ptr %arrayidx1.i, align 1, !tbaa !24
  %conv2.i = zext i8 %39 to i32
  %shl3.i = shl nuw nsw i32 %conv2.i, 16
  %or.i = or i32 %shl3.i, %shl.i
  %40 = load i8, ptr %arrayidx4.i, align 1, !tbaa !24
  %conv5.i = zext i8 %40 to i32
  %shl6.i = shl nuw nsw i32 %conv5.i, 8
  %or7.i = or i32 %or.i, %shl6.i
  %41 = load i8, ptr %arrayidx8.i, align 1, !tbaa !24
...
if.end17:                                         ; preds = %if.end14, %while.body
  %inSize.2 = phi i64 [ %inSize.1.lcssa, %if.end14 ], [ %inSize.0331, %while.body ]
  %src.addr.2 = phi ptr [ %src.addr.1.lcssa, %if.end14 ], [ %src.addr.0332, %while.body ]
  %inSize.2.fr = freeze i64 %inSize.2
  %src.addr.2405 = ptrtoint ptr %src.addr.2 to i64
  %42 = load i64, ptr %dicPos, align 8, !tbaa !18
  %cmp18.not = icmp uge i64 %42, %dicLimit
...
land.lhs.true:                                    ; preds = %if.then20
  %43 = load i32, ptr %code.i, align 4, !tbaa !28
...
if.end37:                                         ; preds = %if.end27, %if.end17
  %44 = load i32, ptr %needInitState, align 4, !tbaa !17
  %tobool.not = icmp eq i32 %44, 0
  br i1 %tobool.not, label %if.end39, label %if.then38

if.then38:                                        ; preds = %if.end37
  %45 = load i32, ptr %p, align 8, !tbaa !30
  %46 = load i32, ptr %lp.i, align 4, !tbaa !31
  %add.i270 = add i32 %46, %45
  %shl.i271 = shl i32 768, %add.i270
  %add2.i = add i32 %shl.i271, 1846
  %47 = load ptr, ptr %probs3.i, align 8, !tbaa !32
  %umax.i = tail call i32 @llvm.umax.i32(i32 %add2.i, i32 1)
  %wide.trip.count.i = zext i32 %umax.i to i64
  %n.vec412 = add nsw i64 %wide.trip.count.i, -6
  br label %vector.body415

vector.body415:                                   ; preds = %vector.body415, %if.then38
  %index416 = phi i64 [ 0, %if.then38 ], [ %index.next417, %vector.body415 ]
  %48 = getelementptr inbounds i16, ptr %47, i64 %index416
  store <8 x i16> <i16 1024, i16 1024, i16 1024, i16 1024, i16 1024, i16 1024, i16 1024, i16 1024>, ptr %48, align 2, !tbaa !33
  %49 = getelementptr inbounds i16, ptr %48, i64 8
  store <8 x i16> <i16 1024, i16 1024, i16 1024, i16 1024, i16 1024, i16 1024, i16 1024, i16 1024>, ptr %49, align 2, !tbaa !33
  %index.next417 = add nuw i64 %index416, 16
  %50 = icmp eq i64 %index.next417, %n.vec412
  br i1 %50, label %for.body.i, label %vector.body415, !llvm.loop !35

for.body.i:                                       ; preds = %vector.body415
  %arrayidx.i272 = getelementptr inbounds i16, ptr %47, i64 %n.vec412
  store i16 1024, ptr %arrayidx.i272, align 2, !tbaa !33
  %indvars.iv.next.i = add nsw i64 %wide.trip.count.i, -5
  %arrayidx.i272.1 = getelementptr inbounds i16, ptr %47, i64 %indvars.iv.next.i
  store i16 1024, ptr %arrayidx.i272.1, align 2, !tbaa !33
  %indvars.iv.next.i.1 = add nsw i64 %wide.trip.count.i, -4
  %arrayidx.i272.2 = getelementptr inbounds i16, ptr %47, i64 %indvars.iv.next.i.1
  store i16 1024, ptr %arrayidx.i272.2, align 2, !tbaa !33
  %indvars.iv.next.i.2 = add nsw i64 %wide.trip.count.i, -3
  %arrayidx.i272.3 = getelementptr inbounds i16, ptr %47, i64 %indvars.iv.next.i.2
  store i16 1024, ptr %arrayidx.i272.3, align 2, !tbaa !33
  %indvars.iv.next.i.3 = add nsw i64 %wide.trip.count.i, -2
  %arrayidx.i272.4 = getelementptr inbounds i16, ptr %47, i64 %indvars.iv.next.i.3
  store i16 1024, ptr %arrayidx.i272.4, align 2, !tbaa !33
  %indvars.iv.next.i.4 = add nsw i64 %wide.trip.count.i, -1
  %arrayidx.i272.5 = getelementptr inbounds i16, ptr %47, i64 %indvars.iv.next.i.4
  store i16 1024, ptr %arrayidx.i272.5, align 2, !tbaa !33
  store i32 1, ptr %arrayidx4.i274, align 4, !tbaa !22
...
if.end39:                                         ; preds = %for.body.i, %if.end37
  %51 = load i32, ptr %tempBufSize, align 4, !tbaa !14
  %cmp41 = icmp eq i32 %51, 0
  br i1 %cmp41, label %if.then43, label %while.cond78.preheader

while.cond78.preheader:                           ; preds = %if.end39
  %cmp79321 = icmp ult i32 %51, 20
  %cmp83322 = icmp ne i64 %inSize.2.fr, 0
  %52 = and i1 %cmp79321, %cmp83322
  br i1 %52, label %while.body86.preheader, label %while.end

while.body86.preheader:                           ; preds = %while.cond78.preheader
  %53 = zext i32 %51 to i64
  %54 = add i64 %inSize.2.fr, -1
  %55 = sub nsw i64 19, %53
  %umin = tail call i64 @llvm.umin.i64(i64 %54, i64 %55)
  %56 = add i64 %umin, 1
  %min.iters.check = icmp ult i64 %56, 16
  br i1 %min.iters.check, label %while.body86.preheader418, label %vector.memcheck

vector.memcheck:                                  ; preds = %while.body86.preheader
  %57 = add i64 %16, %53
  %58 = sub i64 %57, %src.addr.2405
  %diff.check = icmp ult i64 %58, 16
  br i1 %diff.check, label %while.body86.preheader418, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %56, -16
  %ind.end = add i64 %n.vec, %53
  %59 = add nuw nsw i64 %53, 15
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %60 = phi i64 [ %59, %vector.ph ], [ %63, %vector.body ]
  %offset.idx = add i64 %index, %53
  %61 = getelementptr inbounds i8, ptr %src.addr.2, i64 %index
  %wide.load = load <16 x i8>, ptr %61, align 1, !tbaa !24
  %62 = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 17, i64 %offset.idx
  store <16 x i8> %wide.load, ptr %62, align 1, !tbaa !24
  %index.next = add nuw i64 %index, 16
  %63 = add i64 %60, 16
  %64 = icmp eq i64 %index.next, %n.vec
  br i1 %64, label %middle.block, label %vector.body, !llvm.loop !38

middle.block:                                     ; preds = %vector.body
  %65 = icmp ult i64 %60, 19
  %cmp.n = icmp eq i64 %56, %n.vec
  br i1 %cmp.n, label %while.end.loopexit, label %while.body86.preheader418

while.body86.preheader418:                        ; preds = %vector.memcheck, %while.body86.preheader, %middle.block
  %indvars.iv353.ph = phi i64 [ %53, %vector.memcheck ], [ %53, %while.body86.preheader ], [ %ind.end, %middle.block ]
...
if.then50:                                        ; preds = %if.then47
  %inSize.2.fr.le = freeze i64 %inSize.2
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %tempBuf9, ptr align 1 %src.addr.2, i64 %inSize.2.fr.le, i1 false)
  %conv53 = trunc i64 %inSize.2.fr.le to i32
  store i32 %conv53, ptr %tempBufSize, align 4, !tbaa !14
  %66 = load i64, ptr %srcLen, align 8, !tbaa !19
  %add = add i64 %66, %inSize.2.fr.le
...
if.end55:                                         ; preds = %if.then47
  ...
  %or.cond168 = select i1 %cmp18.not, i1 %cmp58, i1 false
...
if.else:                                          ; preds = %if.then43
  %add.ptr268 = getelementptr i8, ptr %src.addr.2, i64 -20
  %add.ptr62 = getelementptr i8, ptr %add.ptr268, i64 %inSize.2.fr
  br label %if.end63
...
cleanup72:                                        ; preds = %if.end63
  %67 = load ptr, ptr %buf123, align 8, !tbaa !39
  %sub.ptr.lhs.cast = ptrtoint ptr %67 to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %src.addr.2 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %68 = load i64, ptr %srcLen, align 8, !tbaa !19
  %add70 = add i64 %sub.ptr.sub, %68
  store i64 %add70, ptr %srcLen, align 8, !tbaa !19
  br label %cleanup150

while.body86:                                     ; preds = %while.body86.preheader418, %while.body86
  %indvars.iv353 = phi i64 [ %indvars.iv.next354, %while.body86 ], [ %indvars.iv353.ph, %while.body86.preheader418 ]
  %indvars.iv351 = phi i64 [ %indvars.iv.next352, %while.body86 ], [ %indvars.iv351.ph, %while.body86.preheader418 ]
  %indvars.iv.next352 = add nuw nsw i64 %indvars.iv351, 1
  %arrayidx89 = getelementptr inbounds i8, ptr %src.addr.2, i64 %indvars.iv351
  %69 = load i8, ptr %arrayidx89, align 1, !tbaa !24
  %indvars.iv.next354 = add nuw nsw i64 %indvars.iv353, 1
  %arrayidx93 = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 17, i64 %indvars.iv353
  store i8 %69, ptr %arrayidx93, align 1, !tbaa !24
  %cmp79 = icmp ult i64 %indvars.iv353, 19
  %cmp83 = icmp ugt i64 %inSize.2.fr, %indvars.iv.next352
  %70 = select i1 %cmp79, i1 %cmp83, i1 false
  br i1 %70, label %while.body86, label %while.end.loopexit, !llvm.loop !40
...
while.end.loopexit:                               ; preds = %while.body86, %middle.block
  ...
  %cmp79.lcssa382 = phi i1 [ %65, %middle.block ], [ %cmp79, %while.body86 ]
  %71 = trunc i64 %indvars.iv.next354.lcssa to i32
  %72 = trunc i64 %indvars.iv.next352.lcssa to i32
  br label %while.end

while.end:                                        ; preds = %while.end.loopexit, %while.cond78.preheader
  %lookAhead.0.lcssa320 = phi i32 [ 0, %while.cond78.preheader ], [ %72, %while.end.loopexit ]
  %rem.0.lcssa = phi i32 [ %51, %while.cond78.preheader ], [ %71, %while.end.loopexit ]
  %cmp79.lcssa = phi i1 [ %cmp79321, %while.cond78.preheader ], [ %cmp79.lcssa382, %while.end.loopexit ]
...
if.then107:                                       ; preds = %if.then99
  %conv82.le.le = zext i32 %lookAhead.0.lcssa320 to i64
  %73 = load i64, ptr %srcLen, align 8, !tbaa !19
  %add109 = add i64 %73, %conv82.le.le
...
if.end110:                                        ; preds = %if.then99
  ...
  %or.cond170 = select i1 %cmp18.not, i1 %cmp113, i1 false
...
cleanup145:                                       ; preds = %if.end120
  %74 = load ptr, ptr %buf123, align 8, !tbaa !39
  %sub.ptr.lhs.cast133 = ptrtoint ptr %74 to i64
  %sub.ptr.sub135.neg.neg = sub i64 %sub.ptr.lhs.cast133, %sub.ptr.rhs.cast134
  %conv136.neg.neg333 = trunc i64 %sub.ptr.sub135.neg.neg to i32
  %sub137.neg = sub i32 %lookAhead.0.lcssa320, %rem.0.lcssa
  %sub138 = add i32 %sub137.neg, %conv136.neg.neg333
  %conv139 = zext i32 %sub138 to i64
  %75 = load i64, ptr %srcLen, align 8, !tbaa !19
  %add140 = add i64 %75, %conv139
...
cleanup150:                                       ; preds = %cleanup72, %cleanup145
  ...
  %76 = load i32, ptr %remainLen.i, align 4, !tbaa !13
  %cmp.not = icmp eq i32 %76, 274
...
while.end153:                                     ; preds = %cleanup150, %LzmaDec_WriteRem.exit
  ...
  %77 = load i32, ptr %code154, align 4, !tbaa !28
...
if.end158:                                        ; preds = %if.then157, %while.end153
  %78 = phi i32 [ %.pre358, %if.then157 ], [ %77, %while.end153 ]
  %cmp160 = icmp ne i32 %78, 0
...
if.then20:                                        ; preds = %if.end17
  ...
  %or.cond943 = select i1 %cmp22.not, i1 %cmp25.not, i1 false
...
if.then27:                                        ; preds = %if.then20
  ...
  %9 = load i32, ptr %lp, align 4, !tbaa !31
  %notmask900 = shl nsw i32 -1, %9
  %sub31 = xor i32 %notmask900, -1
  %and32 = and i32 %4, %sub31
  %10 = load i32, ptr %p, align 8, !tbaa !30
  %shl34 = shl i32 %and32, %10
  %dic = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 2
  %11 = load ptr, ptr %dic, align 8, !tbaa !20
  %dicPos = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 6
  %12 = load i64, ptr %dicPos, align 8, !tbaa !18
...
cond.true:                                        ; preds = %if.then27
  ...
  %13 = load i64, ptr %dicBufSize, align 8, !tbaa !21
  br label %cond.end

cond.end:                                         ; preds = %if.then27, %cond.true
  %cond = phi i64 [ %13, %cond.true ], [ %12, %if.then27 ]
  %sub38 = add i64 %cond, -1
  %arrayidx = getelementptr inbounds i8, ptr %11, i64 %sub38
  %14 = load i8, ptr %arrayidx, align 1, !tbaa !24
...
do.body:                                          ; preds = %if.end47, %do.cond
  ...
  %15 = load i16, ptr %add.ptr52, align 2, !tbaa !33
...
if.end60:                                         ; preds = %if.then56
  ...
  %16 = load i8, ptr %buf.addr.1, align 1, !tbaa !24
...
if.else80:                                        ; preds = %if.end47
  ...
  %17 = load ptr, ptr %dic81, align 8, !tbaa !20
  %dicPos82 = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 6
  %18 = load i64, ptr %dicPos82, align 8, !tbaa !18
  %reps = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 11
  %19 = load i32, ptr %reps, align 4, !tbaa !22
  %conv84 = zext i32 %19 to i64
  %sub85 = sub i64 %18, %conv84
  %cmp90 = icmp ult i64 %18, %conv84
...
cond.true92:                                      ; preds = %if.else80
  ...
  %20 = load i64, ptr %dicBufSize93, align 8, !tbaa !21
  br label %cond.end95

cond.end95:                                       ; preds = %if.else80, %cond.true92
  %cond96 = phi i64 [ %20, %cond.true92 ], [ 0, %if.else80 ]
  %add97 = add i64 %sub85, %cond96
  %arrayidx98 = getelementptr inbounds i8, ptr %17, i64 %add97
  %21 = load i8, ptr %arrayidx98, align 1, !tbaa !24
  %conv99 = zext i8 %21 to i32
  br label %do.body101
...
do.body101:                                       ; preds = %do.cond142, %cond.end95
  ...
  %22 = load i16, ptr %add.ptr109, align 2, !tbaa !33
  %conv110 = zext i16 %22 to i32
...
if.end117:                                        ; preds = %if.then113
  ...
  %23 = load i8, ptr %buf.addr.4, align 1, !tbaa !24
...
if.else152:                                       ; preds = %if.end17
  ...
  %24 = load i16, ptr %add.ptr157, align 2, !tbaa !33
  %conv158 = zext i16 %24 to i32
...
if.end165:                                        ; preds = %if.then161
  ...
  %25 = load i8, ptr %buf.addr.0, align 1, !tbaa !24
  %conv169 = zext i8 %25 to i32
...
if.else178:                                       ; preds = %if.end171
  ...
  %26 = load i16, ptr %add.ptr183, align 2, !tbaa !33
  %conv184 = zext i16 %26 to i32
...
if.end191:                                        ; preds = %if.then187
  ...
  %27 = load i8, ptr %buf.addr.8, align 1, !tbaa !24
  %conv195 = zext i8 %27 to i32
...
if.then202:                                       ; preds = %if.end197
  ...
  %28 = load i16, ptr %add.ptr208, align 2, !tbaa !33
  %conv209 = zext i16 %28 to i32
...
if.end216:                                        ; preds = %if.then212
  ...
  %29 = load i8, ptr %buf.addr.9, align 1, !tbaa !24
  %conv220 = zext i8 %29 to i32
...
if.else245:                                       ; preds = %if.end197
  ...
  %30 = load i16, ptr %add.ptr250, align 2, !tbaa !33
  %conv251 = zext i16 %30 to i32
...
if.end258:                                        ; preds = %if.then254
  ...
  %31 = load i8, ptr %buf.addr.9, align 1, !tbaa !24
  %conv262 = zext i8 %31 to i32
...
if.else270:                                       ; preds = %if.end264
  ...
  %32 = load i16, ptr %add.ptr275, align 2, !tbaa !33
  %conv276 = zext i16 %32 to i32
...
if.end283:                                        ; preds = %if.then279
  ...
  %33 = load i8, ptr %buf.addr.12, align 1, !tbaa !24
  %conv287 = zext i8 %33 to i32
...
if.end302:                                        ; preds = %if.else241, %if.else295, %if.end264, %if.end289, %if.end171
  ...
  %34 = load i16, ptr %add.ptr301, align 2, !tbaa !33
  %conv304 = zext i16 %34 to i32
...
if.end311:                                        ; preds = %if.then307
  ...
  %35 = load i8, ptr %buf.addr.15, align 1, !tbaa !24
...
if.else327:                                       ; preds = %if.end317
  ...
  %36 = load i16, ptr %add.ptr330, align 2, !tbaa !33
  %conv331 = zext i16 %36 to i32
...
if.end338:                                        ; preds = %if.then334
  ...
  %37 = load i8, ptr %buf.addr.16, align 1, !tbaa !24
  %conv342 = zext i8 %37 to i32
...
do.body360:                                       ; preds = %do.cond389, %if.end359
  ...
  %38 = load i16, ptr %add.ptr362, align 2, !tbaa !33
  %conv363 = zext i16 %38 to i32
...
if.end370:                                        ; preds = %if.then366
  ...
  %39 = load i8, ptr %buf.addr.19, align 1, !tbaa !24
...
do.body413:                                       ; preds = %do.cond442, %if.then402
  ...
  %40 = load i16, ptr %add.ptr415, align 2, !tbaa !33
  %conv416 = zext i16 %40 to i32
...
if.end423:                                        ; preds = %if.then419
  ...
  %41 = load i8, ptr %buf.addr.22, align 1, !tbaa !24
  %conv427 = zext i8 %41 to i32
...
if.end473:                                        ; preds = %if.then469
  ...
  %42 = load i8, ptr %buf.addr.24, align 1, !tbaa !24
...
do.body492:                                       ; preds = %do.cond521, %if.end491
  ...
  %43 = load i16, ptr %add.ptr494, align 2, !tbaa !33
  %conv495 = zext i16 %43 to i32
...
if.end502:                                        ; preds = %if.then498
  ...
  %44 = load i8, ptr %buf.addr.27, align 1, !tbaa !24
  %conv506 = zext i8 %44 to i32
...
cleanup541:                                       ; preds = %if.then366, %if.then419, %if.then469, %if.then498, %if.then113, %if.then56, %if.then230, %if.then, %if.then161, %if.then187, %if.then212, %if.then227, %if.then254, %if.then279, %if.then307, %if.then334, %cleanup.thread
  %45 = phi i32 [ %spec.select941, %cleanup.thread ], [ 0, %if.then ], [ 0, %if.then279 ], [ 0, %if.then254 ], [ 3, %if.then227 ], [ 0, %if.then212 ], [ 0, %if.then187 ], [ 0, %if.then161 ], [ 0, %if.then307 ], [ 0, %if.then334 ], [ %spec.select, %if.then230 ], [ 0, %if.then56 ], [ 0, %if.then113 ], [ 0, %if.then498 ], [ 0, %if.then469 ], [ 0, %if.then419 ], [ 0, %if.then366 ]
  ret i32 %45
}
...
if.end7:                                          ; preds = %do.body.if.end7_crit_edge, %if.then
  ...
  %add.ptr6951892.i = getelementptr i16, ptr %5, i64 687
  br label %do.body.i
...
if.then32.i:                                      ; preds = %if.end.i
  ...
  %cmp39.i = icmp ne i32 %processedPos.0.i, 0
  %or.cond.i = select i1 %cmp37.i, i1 true, i1 %cmp39.i
  br i1 %or.cond.i, label %if.then41.i, label %if.end55.i
...
if.then41.i:                                      ; preds = %if.then32.i
  ...
  %23 = load i8, ptr %arrayidx47.i, align 1, !tbaa !24
  %conv48.i = zext i8 %23 to i32
...
do.body66.i:                                      ; preds = %if.end55.i, %do.cond.i
  ...
  %24 = load i16, ptr %add.ptr68.i, align 2, !tbaa !33
  %conv69.i = zext i16 %24 to i32
...
if.then72.i:                                      ; preds = %do.body66.i
  ...
  %25 = load i8, ptr %buf.2.i, align 1, !tbaa !24
  %conv76.i = zext i8 %25 to i32
...
if.then83.i:                                      ; preds = %if.end78.i
  ...
  %26 = trunc i32 %shr85.i to i16
  %conv87.i = add i16 %24, %26
  br label %do.cond.i

if.else.i:                                        ; preds = %if.end78.i
  %sub91.i = sub i32 %range.3.i, %mul80.i
  %sub92.i = sub i32 %code.3.i, %mul80.i
  %shr93.i = lshr i16 %24, 5
  %sub94.i = sub i16 %24, %shr93.i
...
if.else103.i:                                     ; preds = %if.end55.i
  %27 = load ptr, ptr %dic14.i, align 8, !tbaa !20
  ...
  %arrayidx115.i = getelementptr inbounds i8, ptr %27, i64 %add114.i
  %28 = load i8, ptr %arrayidx115.i, align 1, !tbaa !24
  %conv116.i = zext i8 %28 to i32
...
do.body121.i:                                     ; preds = %if.end160.i, %if.else103.i
  ...
  %29 = load i16, ptr %add.ptr129.i, align 2, !tbaa !33
  %conv130.i = zext i16 %29 to i32
...
if.then133.i:                                     ; preds = %do.body121.i
  ...
  %30 = load i8, ptr %buf.4.i, align 1, !tbaa !24
  %conv137.i = zext i8 %30 to i32
...
if.then144.i:                                     ; preds = %if.end139.i
  ...
  %31 = trunc i32 %shr146.i to i16
  %conv148.i = add i16 %29, %31
...
if.else151.i:                                     ; preds = %if.end139.i
  ...
  %shr154.i = lshr i16 %29, 5
  %sub155.i = sub i16 %29, %shr154.i
...
if.else169.i:                                     ; preds = %if.end.i
  ...
  %32 = load i16, ptr %add.ptr177.i, align 2, !tbaa !33
  %conv178.i = zext i16 %32 to i32
...
if.then181.i:                                     ; preds = %if.else169.i
  ...
  %33 = load i8, ptr %buf.1.i, align 1, !tbaa !24
  %conv185.i = zext i8 %33 to i32
...
if.then192.i:                                     ; preds = %if.end187.i
  ...
  %34 = trunc i32 %shr194.i to i16
  %conv196.i = add i16 %32, %34
...
if.else199.i:                                     ; preds = %if.end187.i
  ...
  %shr202.i = lshr i16 %32, 5
  %sub203.i = sub i16 %32, %shr202.i
  store i16 %sub203.i, ptr %add.ptr177.i, align 2, !tbaa !33
  %cmp207.i = icmp eq i32 %processedPos.0.i, 0
  %or.cond1060.i = select i1 %cmp, i1 %cmp207.i, i1 false
...
if.end210.i:                                      ; preds = %if.else199.i
  ...
  %35 = load i16, ptr %add.ptr213.i, align 2, !tbaa !33
  %conv214.i = zext i16 %35 to i32
...
if.then217.i:                                     ; preds = %if.end210.i
  ...
  %36 = load i8, ptr %buf.7.i, align 1, !tbaa !24
  %conv221.i = zext i8 %36 to i32
...
if.then228.i:                                     ; preds = %if.end223.i
  ...
  %37 = trunc i32 %shr230.i to i16
  %conv232.i = add i16 %35, %37
  ...
  %38 = load i16, ptr %add.ptr238.i, align 2, !tbaa !33
  %conv239.i = zext i16 %38 to i32
...
if.then242.i:                                     ; preds = %if.then228.i
  ...
  %39 = load i8, ptr %buf.8.i, align 1, !tbaa !24
  %conv246.i = zext i8 %39 to i32
...
if.then253.i:                                     ; preds = %if.end248.i
  ...
  %40 = trunc i32 %shr255.i to i16
  %conv257.i = add i16 %38, %40
  ...
  %41 = load i8, ptr %arrayidx268.i, align 1, !tbaa !24
  %arrayidx269.i = getelementptr inbounds i8, ptr %14, i64 %dicPos.0.i
  store i8 %41, ptr %arrayidx269.i, align 1, !tbaa !24
...
if.end275.i:                                      ; preds = %if.end248.i
  ...
  %shr278.i = lshr i16 %38, 5
  %sub279.i = sub i16 %38, %shr278.i
...
if.else281.i:                                     ; preds = %if.end223.i
  ...
  %shr284.i = lshr i16 %35, 5
  %sub285.i = sub i16 %35, %shr284.i
  ...
  %42 = load i16, ptr %add.ptr289.i, align 2, !tbaa !33
  %conv290.i = zext i16 %42 to i32
...
if.then293.i:                                     ; preds = %if.else281.i
  ...
  %43 = load i8, ptr %buf.8.i, align 1, !tbaa !24
  %conv297.i = zext i8 %43 to i32
...
if.then304.i:                                     ; preds = %if.end299.i
  ...
  %44 = trunc i32 %shr306.i to i16
  %conv308.i = add i16 %42, %44
...
if.else309.i:                                     ; preds = %if.end299.i
  ...
  %shr312.i = lshr i16 %42, 5
  %sub313.i = sub i16 %42, %shr312.i
  ...
  %45 = load i16, ptr %add.ptr317.i, align 2, !tbaa !33
  %conv318.i = zext i16 %45 to i32
...
if.then321.i:                                     ; preds = %if.else309.i
  ...
  %46 = load i8, ptr %buf.10.i, align 1, !tbaa !24
  %conv325.i = zext i8 %46 to i32
...
if.then332.i:                                     ; preds = %if.end327.i
  ...
  %47 = trunc i32 %shr334.i to i16
  %conv336.i = add i16 %45, %47
...
if.else337.i:                                     ; preds = %if.end327.i
  ...
  %shr340.i = lshr i16 %45, 5
  %sub341.i = sub i16 %45, %shr340.i
  br label %if.end343.i
...
if.end350.i:                                      ; preds = %if.end345.i, %if.then192.i
  ...
  %48 = load i16, ptr %prob.1.i, align 2, !tbaa !33
...
if.then356.i:                                     ; preds = %if.end350.i
  ...
  %49 = load i8, ptr %buf.14.i, align 1, !tbaa !24
  %conv360.i = zext i8 %49 to i32
...
if.then367.i:                                     ; preds = %if.end362.i
  ...
  %50 = trunc i32 %shr369.i to i16
  %conv371.i = add i16 %48, %50
...
if.else376.i:                                     ; preds = %if.end362.i
  ...
  %shr379.i = lshr i16 %48, 5
  %sub380.i = sub i16 %48, %shr379.i
  store i16 %sub380.i, ptr %prob.1.i, align 2, !tbaa !33
  %add.ptr382.i = getelementptr inbounds i16, ptr %prob.1.i, i64 1
  %51 = load i16, ptr %add.ptr382.i, align 2, !tbaa !33
  %conv383.i = zext i16 %51 to i32
...
if.then386.i:                                     ; preds = %if.else376.i
  ...
  %52 = load i8, ptr %buf.15.i, align 1, !tbaa !24
  %conv390.i = zext i8 %52 to i32
...
if.then397.i:                                     ; preds = %if.end392.i
  ...
  %53 = trunc i32 %shr399.i to i16
  %conv401.i = add i16 %51, %53
...
if.else406.i:                                     ; preds = %if.end392.i
  ...
  %shr409.i = lshr i16 %51, 5
  %sub410.i = sub i16 %51, %shr409.i
...
do.body415.i:                                     ; preds = %do.cond451.i, %if.end414.i
  ...
  %54 = load i16, ptr %add.ptr417.i, align 2, !tbaa !33
  %conv418.i = zext i16 %54 to i32
...
if.then421.i:                                     ; preds = %do.body415.i
  ...
  %55 = load i8, ptr %buf.18.i, align 1, !tbaa !24
  %conv425.i = zext i8 %55 to i32
...
if.then432.i:                                     ; preds = %if.end427.i
  ...
  %56 = trunc i32 %shr434.i to i16
  %conv436.i = add i16 %54, %56
...
if.else440.i:                                     ; preds = %if.end427.i
  ...
  %shr443.i = lshr i16 %54, 5
  %sub444.i = sub i16 %54, %shr443.i
...
if.then459.i:                                     ; preds = %do.end454.i
  ...
  %57 = load i16, ptr %add.ptr472.i, align 2, !tbaa !33
  %conv473.i = zext i16 %57 to i32
...
if.then476.i:                                     ; preds = %if.then459.i
  ...
  %58 = load i8, ptr %buf.19.i, align 1, !tbaa !24
  %conv480.i = zext i8 %58 to i32
...
if.then487.i:                                     ; preds = %if.end482.i
  ...
  %59 = trunc i32 %shr489.i to i16
  %conv491.i = add i16 %57, %59
...
if.else495.i:                                     ; preds = %if.end482.i
  ...
  %shr498.i = lshr i16 %57, 5
  %sub499.i = sub i16 %57, %shr498.i
  br label %if.end505.i
...
if.end505.i:                                      ; preds = %if.else495.i, %if.then487.i
  ...
  %60 = load i16, ptr %add.ptr507.i, align 2, !tbaa !33
  %conv508.i = zext i16 %60 to i32
...
if.then511.i:                                     ; preds = %if.end505.i
  ...
  %61 = load i8, ptr %buf.20.i, align 1, !tbaa !24
  %conv515.i = zext i8 %61 to i32
...
if.then522.i:                                     ; preds = %if.end517.i
  ...
  %62 = trunc i32 %shr524.i to i16
  %conv526.i = add i16 %60, %62
...
if.else530.i:                                     ; preds = %if.end517.i
  ...
  %shr533.i = lshr i16 %60, 5
  %sub534.i = sub i16 %60, %shr533.i
...
if.end540.i:                                      ; preds = %if.else530.i, %if.then522.i
  ...
  %63 = load i16, ptr %add.ptr542.i, align 2, !tbaa !33
  %conv543.i = zext i16 %63 to i32
...
if.then546.i:                                     ; preds = %if.end540.i
  ...
  %64 = load i8, ptr %buf.21.i, align 1, !tbaa !24
  %conv550.i = zext i8 %64 to i32
...
if.then557.i:                                     ; preds = %if.end552.i
  ...
  %65 = trunc i32 %shr559.i to i16
  %conv561.i = add i16 %63, %65
...
if.else565.i:                                     ; preds = %if.end552.i
  ...
  %shr568.i = lshr i16 %63, 5
  %sub569.i = sub i16 %63, %shr568.i
...
if.end575.i:                                      ; preds = %if.else565.i, %if.then557.i
  ...
  %66 = load i16, ptr %add.ptr577.i, align 2, !tbaa !33
  %conv578.i = zext i16 %66 to i32
...
if.then581.i:                                     ; preds = %if.end575.i
  ...
  %67 = load i8, ptr %buf.22.i, align 1, !tbaa !24
  %conv585.i = zext i8 %67 to i32
...
if.then592.i:                                     ; preds = %if.end587.i
  ...
  %68 = trunc i32 %shr594.i to i16
  %conv596.i = add i16 %66, %68
...
if.else600.i:                                     ; preds = %if.end587.i
  ...
  %shr603.i = lshr i16 %66, 5
  %sub604.i = sub i16 %66, %shr603.i
...
if.end610.i:                                      ; preds = %if.else600.i, %if.then592.i
  ...
  %69 = load i16, ptr %add.ptr612.i, align 2, !tbaa !33
  %conv613.i = zext i16 %69 to i32
...
if.then616.i:                                     ; preds = %if.end610.i
  ...
  %70 = load i8, ptr %buf.23.i, align 1, !tbaa !24
  %conv620.i = zext i8 %70 to i32
...
if.then627.i:                                     ; preds = %if.end622.i
  ...
  %71 = trunc i32 %shr629.i to i16
  %conv631.i = add i16 %69, %71
...
if.else635.i:                                     ; preds = %if.end622.i
  ...
  %shr638.i = lshr i16 %69, 5
  %sub639.i = sub i16 %69, %shr638.i
...
if.end645.i:                                      ; preds = %if.else635.i, %if.then627.i
  ...
  %72 = load i16, ptr %add.ptr647.i, align 2, !tbaa !33
  %conv648.i = zext i16 %72 to i32
...
if.then651.i:                                     ; preds = %if.end645.i
  ...
  %73 = load i8, ptr %buf.24.i, align 1, !tbaa !24
  %conv655.i = zext i8 %73 to i32
...
if.then662.i:                                     ; preds = %if.end657.i
  ...
  %74 = trunc i32 %shr664.i to i16
  %conv666.i = add i16 %72, %74
...
if.else670.i:                                     ; preds = %if.end657.i
  ...
  %shr673.i = lshr i16 %72, 5
  %sub674.i = sub i16 %72, %shr673.i
...
if.then691.i:                                     ; preds = %if.then684.i
  ...
  %add.ptr6971891.i = getelementptr i16, ptr %add.ptr6951892.i, i64 %idx.ext694.i
  %add.ptr698.i = getelementptr i16, ptr %add.ptr6971891.i, i64 %idx.neg.i
...
do.body699.i:                                     ; preds = %if.end735.i, %if.then691.i
  ...
  %75 = load i16, ptr %add.ptr701.i, align 2, !tbaa !33
  %conv702.i = zext i16 %75 to i32
...
if.then705.i:                                     ; preds = %do.body699.i
  ...
  %76 = load i8, ptr %buf.26.i, align 1, !tbaa !24
  %conv709.i = zext i8 %76 to i32
...
if.then716.i:                                     ; preds = %if.end711.i
  ...
  %77 = trunc i32 %shr718.i to i16
  %conv720.i = add i16 %75, %77
...
if.else724.i:                                     ; preds = %if.end711.i
  ...
  %shr727.i = lshr i16 %75, 5
  %sub728.i = sub i16 %75, %shr727.i
...
if.then746.i:                                     ; preds = %do.body743.i
  ...
  %78 = load i8, ptr %buf.28.i, align 1, !tbaa !24
  %conv750.i = zext i8 %78 to i32
...
do.end766.i:                                      ; preds = %if.end752.i
  ...
  %79 = load i16, ptr %add.ptr771.i, align 2, !tbaa !33
  %conv772.i = zext i16 %79 to i32
...
if.then775.i:                                     ; preds = %do.end766.i
  ...
  %80 = load i8, ptr %buf.29.i, align 1, !tbaa !24
  %conv779.i = zext i8 %80 to i32
...
if.then786.i:                                     ; preds = %if.end781.i
  ...
  %81 = trunc i32 %shr788.i to i16
  %conv790.i = add i16 %79, %81
...
if.else794.i:                                     ; preds = %if.end781.i
  ...
  %shr797.i = lshr i16 %79, 5
  %sub798.i = sub i16 %79, %shr797.i
...
if.end805.i:                                      ; preds = %if.else794.i, %if.then786.i
  ...
  %82 = load i16, ptr %add.ptr807.i, align 2, !tbaa !33
  %conv808.i = zext i16 %82 to i32
...
if.then811.i:                                     ; preds = %if.end805.i
  ...
  %83 = load i8, ptr %buf.30.i, align 1, !tbaa !24
  %conv815.i = zext i8 %83 to i32
...
if.then822.i:                                     ; preds = %if.end817.i
  ...
  %84 = trunc i32 %shr824.i to i16
  %conv826.i = add i16 %82, %84
...
if.else830.i:                                     ; preds = %if.end817.i
  ...
  %shr833.i = lshr i16 %82, 5
  %sub834.i = sub i16 %82, %shr833.i
...
if.end841.i:                                      ; preds = %if.else830.i, %if.then822.i
  ...
  %85 = load i16, ptr %add.ptr843.i, align 2, !tbaa !33
  %conv844.i = zext i16 %85 to i32
...
if.then847.i:                                     ; preds = %if.end841.i
  ...
  %86 = load i8, ptr %buf.31.i, align 1, !tbaa !24
  %conv851.i = zext i8 %86 to i32
...
if.then858.i:                                     ; preds = %if.end853.i
  ...
  %87 = trunc i32 %shr860.i to i16
  %conv862.i = add i16 %85, %87
...
if.else866.i:                                     ; preds = %if.end853.i
  ...
  %shr869.i = lshr i16 %85, 5
  %sub870.i = sub i16 %85, %shr869.i
...
if.end877.i:                                      ; preds = %if.else866.i, %if.then858.i
  ...
  %88 = load i16, ptr %add.ptr879.i, align 2, !tbaa !33
  %conv880.i = zext i16 %88 to i32
...
if.then883.i:                                     ; preds = %if.end877.i
  ...
  %89 = load i8, ptr %buf.32.i, align 1, !tbaa !24
  %conv887.i = zext i8 %89 to i32
...
if.then894.i:                                     ; preds = %if.end889.i
  ...
  %90 = trunc i32 %shr896.i to i16
  %conv898.i = add i16 %88, %90
...
if.else902.i:                                     ; preds = %if.end889.i
  ...
  %shr905.i = lshr i16 %88, 5
  %sub906.i = sub i16 %88, %shr905.i
...
do.body989.i.prol.loopexit:                       ; preds = %do.body989.i.prol, %do.body989.i.preheader
  ...
  %92 = icmp eq i32 %cond957.i, 1
  br i1 %92, label %do.cond1011.i, label %do.body989.i
...
vector.memcheck:                                  ; preds = %iter.check
  %93 = add i64 %dicPos.0.i, %15
  %94 = add i64 %cond966.i, %15
  %95 = add i64 %94, %dicPos.0.i
  %.neg = sub i64 %conv958.i, %95
  %96 = add i64 %.neg, %93
  %diff.check = icmp ult i64 %96, 32
  br i1 %diff.check, label %do.body981.i.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %vector.memcheck
  %min.iters.check95 = icmp ult i32 %cond957.i, 32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %97 = getelementptr inbounds i8, ptr %next.gep, i64 %sub976.i
  %wide.load = load <16 x i8>, ptr %97, align 1, !tbaa !24
  %98 = getelementptr inbounds i8, ptr %97, i64 16
  %wide.load97 = load <16 x i8>, ptr %98, align 1, !tbaa !24
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !24
  %99 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load97, ptr %99, align 1, !tbaa !24
  %index.next = add nuw i64 %index, 32
  %100 = icmp eq i64 %index.next, %n.vec
  br i1 %100, label %middle.block, label %vector.body, !llvm.loop !55
...
vec.epilog.iter.check:                            ; preds = %middle.block
  %ind.end101 = getelementptr i8, ptr %add.ptr975.i, i64 %n.vec
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec99 = and i64 %conv970.i, 4294967288
  %ind.end100 = getelementptr i8, ptr %add.ptr975.i, i64 %n.vec99
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index104 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next107, %vec.epilog.vector.body ]
  %next.gep105 = getelementptr i8, ptr %add.ptr975.i, i64 %index104
  %101 = getelementptr inbounds i8, ptr %next.gep105, i64 %sub976.i
  %wide.load106 = load <8 x i8>, ptr %101, align 1, !tbaa !24
  store <8 x i8> %wide.load106, ptr %next.gep105, align 1, !tbaa !24
  %index.next107 = add nuw i64 %index104, 8
  %102 = icmp eq i64 %index.next107, %n.vec99
  br i1 %102, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !56

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n103 = icmp eq i64 %n.vec99, %conv970.i
  br i1 %cmp.n103, label %do.cond1011.loopexit1886.i, label %do.body981.i.preheader

do.body981.i.preheader:                           ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %dest.0.i.ph = phi ptr [ %add.ptr975.i, %iter.check ], [ %add.ptr975.i, %vector.memcheck ], [ %ind.end101, %vec.epilog.iter.check ], [ %ind.end100, %vec.epilog.middle.block ]
...
do.body981.i:                                     ; preds = %do.body981.i.preheader, %do.body981.i
  ...
  %103 = load i8, ptr %add.ptr982.i, align 1, !tbaa !24
  store i8 %103, ptr %dest.0.i, align 1, !tbaa !24
...
do.body989.i:                                     ; preds = %do.body989.i.prol.loopexit, %do.body989.i
  ...
  %104 = load i8, ptr %arrayidx990.i, align 1, !tbaa !24
  %inc991.i = add i64 %dicPos.1.i, 1
  %arrayidx992.i = getelementptr inbounds i8, ptr %14, i64 %dicPos.1.i
  store i8 %104, ptr %arrayidx992.i, align 1, !tbaa !24
  ...
  %105 = load i8, ptr %arrayidx990.i.1, align 1, !tbaa !24
  %inc991.i.1 = add i64 %dicPos.1.i, 2
  %arrayidx992.i.1 = getelementptr inbounds i8, ptr %14, i64 %inc991.i
  store i8 %105, ptr %arrayidx992.i.1, align 1, !tbaa !24
...
do.cond1011.i:                                    ; preds = %do.body989.i.prol.loopexit, %do.body989.i, %do.cond1011.loopexit1886.i, %if.then253.i, %if.end165.i
  ...
  %cond957.pn.i = phi i32 [ 1, %if.then253.i ], [ 1, %if.end165.i ], [ %cond957.i, %do.cond1011.loopexit1886.i ], [ %cond957.i, %do.body989.i ], [ %cond957.i, %do.body989.i.prol.loopexit ]
  ...
  %processedPos.1.ph.i = add i32 %cond957.pn.i, %processedPos.0.i
  %cmp1012.i = icmp ult i64 %dicPos.3.ph.i, %limit2.1
  %cmp1014.i = icmp ult ptr %buf.39.ph.i, %bufLimit
  %106 = select i1 %cmp1012.i, i1 %cmp1014.i, i1 false
  br i1 %106, label %do.body.i, label %do.end1016.i, !llvm.loop !59

do.end1016.i:                                     ; preds = %do.cond1011.i, %cleanup1005.i
  %state.71841.i = phi i32 [ %sub918.i, %cleanup1005.i ], [ %state.7.ph.i, %do.cond1011.i ]
  %107 = phi i32 [ %rep0.2.i, %cleanup1005.i ], [ %rep0.5.ph.i, %do.cond1011.i ]
  ...
  %108 = phi i64 [ %dicPos.0.i, %cleanup1005.i ], [ %dicPos.3.ph.i, %do.cond1011.i ]
  ...
  %109 = phi i32 [ %add917.i, %cleanup1005.i ], [ %len.7.ph.i, %do.cond1011.i ]
...
if.then1019.i:                                    ; preds = %do.end1016.i
  ...
  %110 = load i8, ptr %buf.391821.i, align 1, !tbaa !24
  %conv1023.i = zext i8 %110 to i32
  %or1024.i = or i32 %shl1021.i, %conv1023.i
  br label %cleanup.cont

cleanup.cont:                                     ; preds = %if.then1019.i, %do.end1016.i
  ...
  store i32 %109, ptr %remainLen.i, align 4, !tbaa !13
  store i64 %108, ptr %dicPos16.i, align 8, !tbaa !18
  store i32 %processedPos.11828.i, ptr %processedPos17.i, align 8, !tbaa !15
  store i32 %107, ptr %reps.i, align 4, !tbaa !22
  ...
  %111 = load i32, ptr %dicSize, align 4, !tbaa !23
  %cmp15.not = icmp ugt i32 %111, %processedPos.11828.i
  br i1 %cmp15.not, label %if.end21, label %if.then17

if.then17:                                        ; preds = %cleanup.cont
  store i32 %111, ptr %checkDicSize, align 4, !tbaa !16
  br label %if.end21

if.end21:                                         ; preds = %if.then17, %cleanup.cont
  %112 = add i32 %109, -1
  %or.cond.i61 = icmp ult i32 %112, 273
  br i1 %or.cond.i61, label %if.then.i65, label %do.cond

if.then.i65:                                      ; preds = %if.end21
  %113 = load ptr, ptr %dic14.i, align 8, !tbaa !20
  %114 = load i64, ptr %dicBufSize15.i, align 8, !tbaa !21
  %sub.i63 = sub i64 %limit, %108
  %conv.i64 = zext i32 %109 to i64
  %cmp7.i = icmp ult i64 %sub.i63, %conv.i64
  %conv11.i = trunc i64 %sub.i63 to i32
  %spec.select.i = select i1 %cmp7.i, i32 %conv11.i, i32 %109
  %115 = load i32, ptr %checkDicSize, align 4, !tbaa !16
  %cmp12.i = icmp ne i32 %115, 0
  %sub15.i = sub i32 %111, %processedPos.11828.i
  %cmp16.not.i = icmp ugt i32 %sub15.i, %spec.select.i
  %or.cond = select i1 %cmp12.i, i1 true, i1 %cmp16.not.i
  br i1 %or.cond, label %if.end22.i, label %if.then18.i

if.then18.i:                                      ; preds = %if.then.i65
  store i32 %111, ptr %checkDicSize, align 4, !tbaa !16
  br label %if.end22.i

if.end22.i:                                       ; preds = %if.then.i65, %if.then18.i
  %add.i = add i32 %spec.select.i, %processedPos.11828.i
  store i32 %add.i, ptr %processedPos17.i, align 8, !tbaa !15
  %sub25.i = sub i32 %109, %spec.select.i
  store i32 %sub25.i, ptr %remainLen.i, align 4, !tbaa !13
  %cmp26.not65.i = icmp eq i32 %spec.select.i, 0
  br i1 %cmp26.not65.i, label %while.end.i, label %while.body.lr.ph.i

while.body.lr.ph.i:                               ; preds = %if.end22.i
  %conv28.i = zext i32 %107 to i64
  %xtraiter112 = and i32 %spec.select.i, 1
  %lcmp.mod113.not = icmp eq i32 %xtraiter112, 0
  br i1 %lcmp.mod113.not, label %while.body.i.prol.loopexit, label %while.body.i.prol

while.body.i.prol:                                ; preds = %while.body.lr.ph.i
  %dec.i66.prol = add i32 %spec.select.i, -1
  %sub29.i.prol = sub i64 %108, %conv28.i
  %cmp31.i.prol = icmp ult i64 %108, %conv28.i
  %cond.i67.prol = select i1 %cmp31.i.prol, i64 %114, i64 0
  %add33.i.prol = add i64 %sub29.i.prol, %cond.i67.prol
  %arrayidx34.i.prol = getelementptr inbounds i8, ptr %113, i64 %add33.i.prol
  %116 = load i8, ptr %arrayidx34.i.prol, align 1, !tbaa !24
  %arrayidx35.i.prol = getelementptr inbounds i8, ptr %113, i64 %108
  store i8 %116, ptr %arrayidx35.i.prol, align 1, !tbaa !24
  %inc.i68.prol = add i64 %108, 1
  br label %while.body.i.prol.loopexit

while.body.i.prol.loopexit:                       ; preds = %while.body.i.prol, %while.body.lr.ph.i
  %inc.i68.lcssa.unr = phi i64 [ undef, %while.body.lr.ph.i ], [ %inc.i68.prol, %while.body.i.prol ]
  %dicPos.067.i.unr = phi i64 [ %108, %while.body.lr.ph.i ], [ %inc.i68.prol, %while.body.i.prol ]
  %len.166.i.unr = phi i32 [ %spec.select.i, %while.body.lr.ph.i ], [ %dec.i66.prol, %while.body.i.prol ]
  %117 = icmp eq i32 %spec.select.i, 1
  br i1 %117, label %while.end.i, label %while.body.i

while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  %dicPos.067.i = phi i64 [ %inc.i68.1, %while.body.i ], [ %dicPos.067.i.unr, %while.body.i.prol.loopexit ]
  %len.166.i = phi i32 [ %dec.i66.1, %while.body.i ], [ %len.166.i.unr, %while.body.i.prol.loopexit ]
  %sub29.i = sub i64 %dicPos.067.i, %conv28.i
  %cmp31.i = icmp ult i64 %dicPos.067.i, %conv28.i
  %cond.i67 = select i1 %cmp31.i, i64 %114, i64 0
  %add33.i = add i64 %sub29.i, %cond.i67
  %arrayidx34.i = getelementptr inbounds i8, ptr %113, i64 %add33.i
  %118 = load i8, ptr %arrayidx34.i, align 1, !tbaa !24
  %arrayidx35.i = getelementptr inbounds i8, ptr %113, i64 %dicPos.067.i
  store i8 %118, ptr %arrayidx35.i, align 1, !tbaa !24
  %inc.i68 = add i64 %dicPos.067.i, 1
  %dec.i66.1 = add i32 %len.166.i, -2
  %sub29.i.1 = sub i64 %inc.i68, %conv28.i
  %cmp31.i.1 = icmp ult i64 %inc.i68, %conv28.i
  %cond.i67.1 = select i1 %cmp31.i.1, i64 %114, i64 0
  %add33.i.1 = add i64 %sub29.i.1, %cond.i67.1
  %arrayidx34.i.1 = getelementptr inbounds i8, ptr %113, i64 %add33.i.1
  %119 = load i8, ptr %arrayidx34.i.1, align 1, !tbaa !24
  %arrayidx35.i.1 = getelementptr inbounds i8, ptr %113, i64 %inc.i68
  store i8 %119, ptr %arrayidx35.i.1, align 1, !tbaa !24
  %inc.i68.1 = add i64 %dicPos.067.i, 2
  %cmp26.not.i.1 = icmp eq i32 %dec.i66.1, 0
  br i1 %cmp26.not.i.1, label %while.end.i, label %while.body.i, !llvm.loop !25

while.end.i:                                      ; preds = %while.body.i.prol.loopexit, %while.body.i, %if.end22.i
  %dicPos.0.lcssa.i = phi i64 [ %108, %if.end22.i ], [ %inc.i68.lcssa.unr, %while.body.i.prol.loopexit ], [ %inc.i68.1, %while.body.i ]
  store i64 %dicPos.0.lcssa.i, ptr %dicPos16.i, align 8, !tbaa !18
  br label %do.cond

do.cond:                                          ; preds = %if.end21, %while.end.i
  %120 = phi i64 [ %108, %if.end21 ], [ %dicPos.0.lcssa.i, %while.end.i ]
  %cmp26 = icmp ult i64 %120, %limit
  br i1 %cmp26, label %land.lhs.true, label %do.endthread-pre-split

land.lhs.true:                                    ; preds = %do.cond
  %121 = load ptr, ptr %buf19.i, align 8, !tbaa !39
  %cmp28 = icmp ult ptr %121, %bufLimit
  br i1 %cmp28, label %land.rhs, label %do.endthread-pre-split

land.rhs:                                         ; preds = %land.lhs.true
  %122 = load i32, ptr %remainLen.i, align 4, !tbaa !13
  %cmp30 = icmp ult i32 %122, 274
...
do.end:                                           ; preds = %land.rhs, %do.endthread-pre-split
  %123 = phi i32 [ %.pr, %do.endthread-pre-split ], [ %122, %land.rhs ]
  %cmp33 = icmp ugt i32 %123, 274
...
return:                                           ; preds = %if.then926.i, %if.else931.i, %if.end943.i, %if.else199.i, %do.end, %if.then35
  %retval.2 = phi i32 [ 0, %if.then35 ], [ 0, %do.end ], [ 1, %if.else199.i ], [ 1, %if.end943.i ], [ 1, %if.else931.i ], [ 1, %if.then926.i ]
  ret i32 %retval.2
}
...
cleanup.cont8:                                    ; preds = %lor.lhs.false.i, %if.then.i
...
cleanup9:                                         ; preds = %if.then.i, %if.else.i, %entry, %cleanup.cont8
  %retval.2 = phi i32 [ 0, %cleanup.cont8 ], [ 4, %entry ], [ 4, %if.else.i ], [ 2, %if.then.i ]
  ret i32 %retval.2
}
...
cleanup24:                                        ; preds = %if.then.i, %if.else.i, %entry, %if.end22, %if.then20
  %retval.2 = phi i32 [ 2, %if.then20 ], [ 0, %if.end22 ], [ 4, %entry ], [ 4, %if.else.i ], [ 2, %if.then.i ]
  ret i32 %retval.2
}
...
if.then.i.i:                                      ; preds = %if.else.i.i
  ...
  %numProbs5.i.i = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 15
  store i32 %add1.i.i, ptr %numProbs5.i.i, align 8, !tbaa !67
...
if.end3:                                          ; preds = %if.then.i.i
  ...
  %needInitState.i.i = getelementptr inbounds %struct.CLzmaDec, ptr %p, i64 0, i32 14
  store i32 1, ptr %needInitState.i.i, align 4, !tbaa !17
  store i64 %0, ptr %srcLen, align 8, !tbaa !19
