; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iutil.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/iutil.c"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %nref) #11
...
if.end69.sink.split:                              ; preds = %sw.bb59, %sw.bb51
  ...
  %call = call ptr @name_string_ref(ptr noundef nonnull %pref1.sink, ptr noundef nonnull %nref) #11
  br label %if.end69
...
cleanup:                                          ; preds = %sw.bb153, %land.lhs.true, %land.rhs166, %if.end69, %if.end69, %sw.bb84, %land.rhs89, %if.then, %sw.bb59, %sw.bb51, %sw.bb36, %land.rhs43, %sw.bb, %land.rhs, %sw.epilog179, %sw.bb174, %bytes_compare.exit, %sw.bb140, %sw.bb135, %sw.bb130, %sw.bb125, %sw.bb119, %sw.bb114, %sw.bb109, %sw.bb104, %sw.bb97
  ...
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %nref) #11
  ret i32 %retval.0
}
...
; Function Attrs: nofree norecurse nosync nounwind memory(read, inaccessiblemem: none) uwtable
define dso_local i32 @string_hash(ptr nocapture noundef readonly %ptr, i32 noundef %len) local_unnamed_addr #5 {
entry:
...
entry:
  %call = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %cstr) #12
  %conv = trunc i64 %call to i32
  %call1 = tail call ptr @alloc(i32 noundef %conv, i32 noundef 1, ptr noundef %cname) #11
...
entry:
  ...
  %call = tail call ptr @alloc(i32 noundef %add, i32 noundef 1, ptr noundef %client_name) #11
...
define dso_local i32 @num_params(ptr nocapture noundef readonly %op, i32 noundef %count, ptr noundef writeonly %pval) local_unnamed_addr #7 {
entry:
...
define dso_local i32 @real_param(ptr nocapture noundef readonly %op, ptr nocapture noundef writeonly %pparam, i32 noundef %unit) local_unnamed_addr #8 {
entry:
...
; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local i32 @read_matrix(ptr nocapture noundef readonly %op, ptr nocapture noundef %pmat) local_unnamed_addr #0 {
entry:
  %type_attrs = getelementptr inbounds %struct.ref_s, ptr %op, i64 0, i32 1
  %0 = load i16, ptr %type_attrs, align 8, !tbaa !20
  %1 = lshr i16 %0, 2
...
define dso_local i32 @write_matrix(ptr nocapture noundef readonly %op) local_unnamed_addr #9 {
entry:
  %type_attrs = getelementptr inbounds %struct.ref_s, ptr %op, i64 0, i32 1
  %0 = load i16, ptr %type_attrs, align 8, !tbaa !20
  %conv = zext i16 %0 to i32
