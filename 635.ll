; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c"
...
@.str.27 = private unnamed_addr constant [92 x i8] c"/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/foldfg.c\00", align 1
...
for.body:                                         ; preds = %for.cond
  ...
  %call129.i = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %String, ptr noundef nonnull dereferenceable(1) %6) #18
  %cmp136.i.not = icmp eq i32 %call129.i, 0
  br i1 %cmp136.i.not, label %cleanup.split.loop.exit15, label %for.cond, !llvm.loop !5

cleanup.split.loop.exit15:                        ; preds = %for.body
  %7 = ptrtoint ptr %Scan.0.val11 to i64
  %8 = trunc i64 %7 to i32
  br label %cleanup

cleanup:                                          ; preds = %for.cond, %cleanup.split.loop.exit15
  %retval.0 = phi i32 [ %8, %cleanup.split.loop.exit15 ], [ 0, %for.cond ]
  ret i32 %retval.0
}
...
land.lhs.true:                                    ; preds = %if.else50
  ...
  %cmp.i156.not = icmp ugt i32 %3, %23
  %cmp.i160.not = icmp ugt i32 %2, %23
  %or.cond = select i1 %cmp.i156.not, i1 %cmp.i160.not, i1 false
...
sw.default:                                       ; preds = %entry
  ...
  %call17 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %15, ptr noundef nonnull @.str.26, ptr noundef nonnull @.str.27, i32 noundef 575) #19
  tail call void (ptr, ...) @misc_ErrorReport(ptr noundef nonnull @.str.28, i32 noundef %Options) #18
  %16 = load ptr, ptr @stderr, align 8
  %17 = tail call i64 @fwrite(ptr nonnull @.str.29, i64 132, i64 1, ptr %16) #19
...
entry:
  ...
  %1 = tail call i64 @fwrite(ptr nonnull @.str.30, i64 2, i64 1, ptr %0) #19
...
if.then4:                                         ; preds = %if.then
  ...
  %call10 = tail call i32 @_IO_putc(i32 noundef 41, ptr noundef %File)
  br label %common.ret42

if.else:                                          ; preds = %if.then
  %call12 = tail call i32 @_IO_putc(i32 noundef 40, ptr noundef %File)
  %Term.val38 = load ptr, ptr %0, align 8
  tail call fastcc void @fol_TermListFPrintDFG(ptr noundef %File, ptr noundef %Term.val38)
  %call14 = tail call i32 @_IO_putc(i32 noundef 41, ptr noundef %File)
  br label %common.ret42
...
for.body19:                                       ; preds = %for.body19.lr.ph, %for.inc49
  ...
  %call23 = tail call i32 @_IO_putc(i32 noundef 40, ptr noundef %File)
  %21 = load ptr, ptr %20, align 8
  %call24 = tail call i32 @fputs(ptr noundef %21, ptr noundef %File)
  %call25 = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %File)
  ...
  %call27 = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %File)
  ...
  %call35 = tail call i32 @_IO_putc(i32 noundef %cond34, ptr noundef %File)
  %call36 = tail call i32 @_IO_putc(i32 noundef 41, ptr noundef %File)
...
if.then40:                                        ; preds = %for.body19
  %call41 = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %File)
  br label %if.end42
...
symbol_IsFunction.exit:                           ; preds = %land.rhs.i
  ...
  %or.cond186 = select i1 %cmp3.i, i1 true, i1 %tobool.not.i139
...
if.then12:                                        ; preds = %if.then9
  ...
  %call.i = tail call i32 @_IO_putc(i32 noundef 40, ptr noundef %10)
  %11 = load i32, ptr @fol_ALL, align 4
...
if.then16:                                        ; preds = %if.then12
  ...
  %call.i80 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %13)
  br label %if.end
...
for.end32:                                        ; preds = %for.body22, %for.inc30, %if.end
  ...
  %call.i85 = tail call i32 @_IO_putc(i32 noundef 41, ptr noundef %17)
  br label %if.end50
...
if.else38:                                        ; preds = %if.else34
  ...
  %call.i86 = tail call i32 @_IO_putc(i32 noundef 40, ptr noundef %18)
  tail call void @symbol_Print(i32 noundef %Term.val) #18
  %19 = load ptr, ptr @stdout, align 8
  %call.i87 = tail call i32 @_IO_putc(i32 noundef 41, ptr noundef %19)
  br label %if.end50
...
if.else46:                                        ; preds = %entry
  %20 = load ptr, ptr @stdout, align 8
  %call.i88 = tail call i32 @_IO_putc(i32 noundef 91, ptr noundef %20)
  ...
  %call.i89 = tail call i32 @_IO_putc(i32 noundef 93, ptr noundef %22)
  br label %if.end50
...
for.inc24:                                        ; preds = %for.body16
  ...
  %call.i = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %11)
...
for.end47:                                        ; preds = %for.body36, %for.inc45, %if.else
  %19 = load ptr, ptr @stdout, align 8
  %call.i107 = tail call i32 @_IO_putc(i32 noundef 41, ptr noundef %19)
  br label %if.end62

if.else55:                                        ; preds = %if.then
  %20 = load ptr, ptr @stdout, align 8
  %call.i108 = tail call i32 @_IO_putc(i32 noundef 40, ptr noundef %20)
  %Term.val = load i32, ptr %Term.tr, align 8
  tail call void @symbol_Print(i32 noundef %Term.val) #18
  %21 = load ptr, ptr @stdout, align 8
  %call.i109 = tail call i32 @_IO_putc(i32 noundef 41, ptr noundef %21)
  br label %if.end62
...
; Function Attrs: nofree nosync nounwind memory(read, inaccessiblemem: none) uwtable
define dso_local ptr @fol_GetBindingQuantifier(ptr noundef readonly %Term, i32 noundef %Symbol) local_unnamed_addr #10 {
entry:
  %0 = load i32, ptr @fol_ALL, align 4
  %1 = load i32, ptr @fol_EXIST, align 4
  br label %tailrecurse
...
cleanup:                                          ; preds = %if.end31
  ...
  %call44 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %14, ptr noundef nonnull @.str.26, ptr noundef nonnull @.str.27, i32 noundef 1527) #19
  tail call void (ptr, ...) @misc_ErrorReport(ptr noundef nonnull @.str.58) #18
  %15 = load ptr, ptr @stderr, align 8
  %16 = tail call i64 @fwrite(ptr nonnull @.str.29, i64 132, i64 1, ptr %15) #19
  tail call fastcc void @misc_DumpCore()
  unreachable
}
...
lor.lhs.false4.i.i40:                             ; preds = %if.end3.i36
  ...
  %narrow.i.not.i.i39 = select i1 %cmp.i.not.i.i.i37, i1 %cmp.i4.i.i.i38, i1 false
...
for.body:                                         ; preds = %if.then6, %for.body
  ...
  %Scan.0.val = load ptr, ptr %6, align 8
  %call11 = tail call i32 @fol_PropagateFreeness(ptr noundef %Scan.0.val)
  %tobool12.not = icmp eq i32 %call11, 0
  %spec.select = select i1 %tobool12.not, i32 %Free.081, i32 1
  %Scan.0 = load ptr, ptr %Scan.082, align 8
  %cmp.i.not = icmp eq ptr %Scan.0, null
  br i1 %cmp.i.not, label %cleanup, label %for.body, !llvm.loop !57
...
for.body.i:                                       ; preds = %if.then32, %for.body.i
  ...
  br i1 %cmp.i.not.i69, label %for.end.i, label %for.body.i, !llvm.loop !58
...
if.end37.sink.split:                              ; preds = %if.then24, %if.then16
  ...
  %call19 = tail call fastcc i32 @fol_PropagateWitnessIntern(ptr noundef nonnull %Term.tr.lcssa, i32 noundef %call17.val)
  br label %if.end37
...
for.body:                                         ; preds = %if.end42, %for.body
  ...
  %Scan.0.val = load ptr, ptr %11, align 8
  %call47 = tail call i32 @fol_PropagateWitness(ptr noundef %Scan.0.val)
  ...
  br i1 %cmp.i85.not, label %cleanup, label %for.body, !llvm.loop !59
...
fol_AlphaEqual.exit:                              ; preds = %for.body.i.i, %land.lhs.true
  ...
  %call1.i = tail call fastcc i32 @fol_AlphaEqualIntern(ptr noundef %call37.val.val, ptr noundef %Bscan.0.val100, i32 noundef %17)
...
for.inc:                                          ; preds = %for.body34, %fol_AlphaEqual.exit
  ...
  br i1 %cmp.i120.not, label %for.inc51, label %for.body34, !llvm.loop !60

for.inc51:                                        ; preds = %for.inc, %for.body
  %Scan.0.val104 = load ptr, ptr %Scan.0142, align 8
  %cmp.i116.not = icmp eq ptr %Scan.0.val104, null
  br i1 %cmp.i116.not, label %if.end54, label %for.body, !llvm.loop !61
...
for.body62:                                       ; preds = %if.end54, %for.body62
  ...
  %call64 = tail call i32 @fol_PropagateTautologies(ptr noundef %Scan.1.val)
  ...
  br i1 %cmp.i127.not, label %cleanup, label %for.body62, !llvm.loop !62
...
term_ActMark.exit:                                ; preds = %for.body.i, %entry
  ...
  %inc4.i = add nuw i32 %1, 1
  store i32 %inc4.i, ptr @term_MARK, align 4
  %call1 = tail call fastcc i32 @fol_AlphaEqualIntern(ptr noundef %Term1, ptr noundef %Term2, i32 noundef %1)
  ret i32 %call1
}
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  br i1 %cmp.i146.not, label %for.end.loopexit, label %for.body, !llvm.loop !63
...
for.end:                                          ; preds = %for.end.loopexit, %if.end23
  ...
  %call36 = tail call fastcc i32 @fol_AlphaEqualIntern(ptr noundef %Term1.val129.val.val, ptr noundef %Term2.val128.val.val, i32 noundef %Mark)
...
for.body46:                                       ; preds = %for.body46.preheader, %for.body46
  ...
  br i1 %cmp.i150.not, label %cleanup, label %for.body46, !llvm.loop !64
...
for.body69:                                       ; preds = %for.cond65
  ...
  %call72 = tail call fastcc i32 @fol_AlphaEqualIntern(ptr noundef %Scan.2.val, ptr noundef %Bscan.2.val, i32 noundef %Mark)
  %tobool73.not = icmp eq i32 %call72, 0
  br i1 %tobool73.not, label %cleanup, label %for.cond65, !llvm.loop !65
...
term_ActMark.exit:                                ; preds = %for.body.i, %entry
  ...
  %inc4.i = add nuw i32 %1, 1
  store i32 %inc4.i, ptr @term_MARK, align 4
  %call1 = tail call fastcc i32 @fol_VarBoundTwiceIntern(ptr noundef %Term, i32 noundef %1)
  ret i32 %call1
}
...
for.body:                                         ; preds = %for.cond
  ...
  %call12 = tail call fastcc i32 @fol_VarBoundTwiceIntern(ptr noundef %Scan.0.val, i32 noundef %Mark)
  %tobool13.not = icmp eq i32 %call12, 0
  br i1 %tobool13.not, label %for.cond, label %cleanup, !llvm.loop !66
...
if.then27:                                        ; preds = %for.body22
  ...
  br i1 %cmp.i80.not, label %for.end34.loopexit, label %for.body22, !llvm.loop !67
...
for.end34:                                        ; preds = %for.end34.loopexit, %if.else
  ...
  %call36 = tail call fastcc i32 @fol_VarBoundTwiceIntern(ptr noundef %Term.val77.val.val, i32 noundef %Mark)
  %tobool37.not = icmp eq i32 %call36, 0
...
for.body45:                                       ; preds = %if.end39, %for.body45
  ...
  br i1 %cmp.i85.not, label %cleanup, label %for.body45, !llvm.loop !68
...
for.body:                                         ; preds = %if.end8, %for.body
  ...
  br i1 %cmp.i31.not, label %for.end.loopexit, label %for.body, !llvm.loop !69
...
entry:
  %call = tail call fastcc i32 @fol_CheckApplyContextToTerm(ptr noundef %Context, ptr noundef %Term)
  %tobool.not = icmp eq i32 %call, 0
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %cmp.i62.not, label %for.cond, label %cleanup, !llvm.loop !70
...
for.body17:                                       ; preds = %for.end, %for.body17
  ...
  %Scan.1.val = load ptr, ptr %9, align 8
  %call19 = tail call fastcc i32 @fol_CheckApplyContextToTerm(ptr noundef %Context, ptr noundef %Scan.1.val)
  ...
  br i1 %cmp.i64.not, label %cleanup, label %for.body17, !llvm.loop !71
...
for.body31:                                       ; preds = %if.else, %for.body31
  ...
  %call33 = tail call fastcc i32 @fol_CheckApplyContextToTerm(ptr noundef %Context, ptr noundef %Scan.2.val)
  ...
  br i1 %cmp.i66.not, label %cleanup, label %for.body31, !llvm.loop !72
...
for.body:                                         ; preds = %if.else12, %for.body
  ...
  %cmp.i37.not = icmp eq ptr %Scan.0, null
  br i1 %cmp.i37.not, label %if.end19, label %for.body, !llvm.loop !73
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i177.not, label %cleanup, label %land.rhs, !llvm.loop !74
...
for.cond.i.4:                                     ; preds = %for.cond.i.3
  ...
  br i1 %exitcond.not.i.4, label %if.then21, label %for.body.i, !llvm.loop !76
...
while.body:                                       ; preds = %land.rhs
  ...
  br i1 %cmp.i193.not, label %cleanup, label %land.rhs, !llvm.loop !77
