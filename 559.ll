; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/q_offsets.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/q_offsets.c"
...
entry:
  ...
  %call7 = tail call i32 @get_mem4Dint(ptr noundef nonnull @LevelOffset4x4Luma, i32 noundef 2, i32 noundef %cond.i, i32 noundef 4, i32 noundef 4) #11
  %call8 = tail call i32 @get_mem5Dint(ptr noundef nonnull @LevelOffset4x4Chroma, i32 noundef 2, i32 noundef 2, i32 noundef %cond.i, i32 noundef 4, i32 noundef 4) #11
  %call9 = tail call i32 @get_mem4Dint(ptr noundef nonnull @LevelOffset8x8Luma, i32 noundef 2, i32 noundef %cond.i, i32 noundef 8, i32 noundef 8) #11
  %call10 = tail call i32 @get_mem2Dshort(ptr noundef nonnull @OffsetList4x4input, i32 noundef 15, i32 noundef 16) #11
  %call11 = tail call i32 @get_mem2Dshort(ptr noundef nonnull @OffsetList8x8input, i32 noundef 5, i32 noundef 64) #11
  %call12 = tail call i32 @get_mem2Dshort(ptr noundef nonnull @OffsetList4x4, i32 noundef 15, i32 noundef 16) #11
  %call13 = tail call i32 @get_mem2Dshort(ptr noundef nonnull @OffsetList8x8, i32 noundef 5, i32 noundef 64) #11
  ret void
}
...
entry:
  ...
  tail call void @free_mem4Dint(ptr noundef %3, i32 noundef 2, i32 noundef %cond.i) #11
  %4 = load ptr, ptr @LevelOffset4x4Chroma, align 8, !tbaa !5
  tail call void @free_mem5Dint(ptr noundef %4, i32 noundef 2, i32 noundef 2, i32 noundef %cond.i) #11
  %5 = load ptr, ptr @LevelOffset8x8Luma, align 8, !tbaa !5
  tail call void @free_mem4Dint(ptr noundef %5, i32 noundef 2, i32 noundef %cond.i) #11
  %6 = load ptr, ptr @OffsetList8x8, align 8, !tbaa !5
  tail call void @free_mem2Dshort(ptr noundef %6) #11
  %7 = load ptr, ptr @OffsetList4x4, align 8, !tbaa !5
  tail call void @free_mem2Dshort(ptr noundef %7) #11
  %8 = load ptr, ptr @OffsetList8x8input, align 8, !tbaa !5
  tail call void @free_mem2Dshort(ptr noundef %8) #11
  %9 = load ptr, ptr @OffsetList4x4input, align 8, !tbaa !5
  tail call void @free_mem2Dshort(ptr noundef %9) #11
  ret void
}
...
entry:
  ...
  %call185 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(20) @OffsetType4x4, ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp192 = icmp eq i32 %call185, 0
  br i1 %cmp192, label %cleanup, label %if.else

if.else:                                          ; preds = %entry
  %call185.1 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(23) getelementptr inbounds ([15 x [24 x i8]], ptr @OffsetType4x4, i64 0, i64 1), ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp192.1 = icmp eq i32 %call185.1, 0
  br i1 %cmp192.1, label %cleanup, label %if.else.1

if.else.1:                                        ; preds = %if.else
  %call185.2 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(23) getelementptr inbounds ([15 x [24 x i8]], ptr @OffsetType4x4, i64 0, i64 2), ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp192.2 = icmp eq i32 %call185.2, 0
  br i1 %cmp192.2, label %cleanup, label %if.else.2

if.else.2:                                        ; preds = %if.else.1
  %call185.3 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(21) getelementptr inbounds ([15 x [24 x i8]], ptr @OffsetType4x4, i64 0, i64 3), ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp192.3 = icmp eq i32 %call185.3, 0
  br i1 %cmp192.3, label %cleanup, label %if.else.3

if.else.3:                                        ; preds = %if.else.2
  %call185.4 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(24) getelementptr inbounds ([15 x [24 x i8]], ptr @OffsetType4x4, i64 0, i64 4), ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp192.4 = icmp eq i32 %call185.4, 0
  br i1 %cmp192.4, label %cleanup, label %if.else.4

if.else.4:                                        ; preds = %if.else.3
  %call185.5 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(24) getelementptr inbounds ([15 x [24 x i8]], ptr @OffsetType4x4, i64 0, i64 5), ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp192.5 = icmp eq i32 %call185.5, 0
  br i1 %cmp192.5, label %cleanup, label %if.else.5

if.else.5:                                        ; preds = %if.else.4
  %call185.6 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(21) getelementptr inbounds ([15 x [24 x i8]], ptr @OffsetType4x4, i64 0, i64 6), ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp192.6 = icmp eq i32 %call185.6, 0
  br i1 %cmp192.6, label %cleanup, label %if.else.6

if.else.6:                                        ; preds = %if.else.5
  %call185.7 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(24) getelementptr inbounds ([15 x [24 x i8]], ptr @OffsetType4x4, i64 0, i64 7), ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp192.7 = icmp eq i32 %call185.7, 0
  br i1 %cmp192.7, label %cleanup, label %if.else.7

if.else.7:                                        ; preds = %if.else.6
  %call185.8 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(24) getelementptr inbounds ([15 x [24 x i8]], ptr @OffsetType4x4, i64 0, i64 8), ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp192.8 = icmp eq i32 %call185.8, 0
  br i1 %cmp192.8, label %cleanup, label %if.else.8

if.else.8:                                        ; preds = %if.else.7
  %call185.9 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(21) getelementptr inbounds ([15 x [24 x i8]], ptr @OffsetType4x4, i64 0, i64 9), ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp192.9 = icmp eq i32 %call185.9, 0
  br i1 %cmp192.9, label %cleanup, label %if.else.9

if.else.9:                                        ; preds = %if.else.8
  %call185.10 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(24) getelementptr inbounds ([15 x [24 x i8]], ptr @OffsetType4x4, i64 0, i64 10), ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp192.10 = icmp eq i32 %call185.10, 0
  br i1 %cmp192.10, label %cleanup, label %if.else.10

if.else.10:                                       ; preds = %if.else.9
  %call185.11 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(24) getelementptr inbounds ([15 x [24 x i8]], ptr @OffsetType4x4, i64 0, i64 11), ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp192.11 = icmp eq i32 %call185.11, 0
  br i1 %cmp192.11, label %cleanup, label %if.else.11

if.else.11:                                       ; preds = %if.else.10
  %call185.12 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(21) getelementptr inbounds ([15 x [24 x i8]], ptr @OffsetType4x4, i64 0, i64 12), ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp192.12 = icmp eq i32 %call185.12, 0
  br i1 %cmp192.12, label %cleanup, label %if.else.12

if.else.12:                                       ; preds = %if.else.11
  %call185.13 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(24) getelementptr inbounds ([15 x [24 x i8]], ptr @OffsetType4x4, i64 0, i64 13), ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp192.13 = icmp eq i32 %call185.13, 0
  br i1 %cmp192.13, label %cleanup, label %if.else.13

if.else.13:                                       ; preds = %if.else.12
  %call185.14 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(24) getelementptr inbounds ([15 x [24 x i8]], ptr @OffsetType4x4, i64 0, i64 14), ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp192.14 = icmp eq i32 %call185.14, 0
  br i1 %cmp192.14, label %cleanup, label %if.else.14

if.else.14:                                       ; preds = %if.else.13
  store i32 1, ptr %type, align 4, !tbaa !14
  %call416 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(20) @OffsetType8x8, ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp423 = icmp eq i32 %call416, 0
  br i1 %cmp423, label %cleanup, label %if.else426

if.else426:                                       ; preds = %if.else.14
  %call416.1 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(21) getelementptr inbounds ([5 x [24 x i8]], ptr @OffsetType8x8, i64 0, i64 1), ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp423.1 = icmp eq i32 %call416.1, 0
  br i1 %cmp423.1, label %cleanup, label %if.else426.1

if.else426.1:                                     ; preds = %if.else426
  %call416.2 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(21) getelementptr inbounds ([5 x [24 x i8]], ptr @OffsetType8x8, i64 0, i64 2), ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp423.2 = icmp eq i32 %call416.2, 0
  br i1 %cmp423.2, label %cleanup, label %if.else426.2

if.else426.2:                                     ; preds = %if.else426.1
  %call416.3 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(21) getelementptr inbounds ([5 x [24 x i8]], ptr @OffsetType8x8, i64 0, i64 3), ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp423.3 = icmp eq i32 %call416.3, 0
  br i1 %cmp423.3, label %cleanup, label %if.else426.3

if.else426.3:                                     ; preds = %if.else426.2
  %call416.4 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(21) getelementptr inbounds ([5 x [24 x i8]], ptr @OffsetType8x8, i64 0, i64 4), ptr noundef nonnull dereferenceable(1) %s) #11
  %cmp423.4 = icmp eq i32 %call416.4, 0
  %spec.select = select i1 %cmp423.4, i32 4, i32 -1
  br label %cleanup

cleanup:                                          ; preds = %if.else426.3, %entry, %if.else, %if.else.1, %if.else.2, %if.else.3, %if.else.4, %if.else.5, %if.else.6, %if.else.7, %if.else.8, %if.else.9, %if.else.10, %if.else.11, %if.else.12, %if.else.13, %if.else.14, %if.else426, %if.else426.1, %if.else426.2
  %retval.0 = phi i32 [ 0, %if.else.14 ], [ 1, %if.else426 ], [ 2, %if.else426.1 ], [ 3, %if.else426.2 ], [ 0, %entry ], [ 1, %if.else ], [ 2, %if.else.1 ], [ 3, %if.else.2 ], [ 4, %if.else.3 ], [ 5, %if.else.4 ], [ 6, %if.else.5 ], [ 7, %if.else.6 ], [ 8, %if.else.7 ], [ 9, %if.else.8 ], [ 10, %if.else.9 ], [ 11, %if.else.10 ], [ 12, %if.else.11 ], [ 13, %if.else.12 ], [ 14, %if.else.13 ], [ %spec.select, %if.else426.3 ]
  ret i32 %retval.0
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8000, ptr nonnull %items) #11
  %idxprom = sext i32 %bufsize to i64
  %arrayidx = getelementptr inbounds i8, ptr %buf, i64 %idxprom
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %IntContent) #11
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %type) #11
  %cmp333 = icmp sgt i32 %bufsize, 0
  br i1 %cmp333, label %while.body, label %for.end273

while.body:                                       ; preds = %entry, %sw.epilog
  %item.0337 = phi i32 [ %item.3, %sw.epilog ], [ 0, %entry ]
  %InString.0336 = phi i32 [ %InString.1, %sw.epilog ], [ 0, %entry ]
  %InItem.0335 = phi i32 [ %InItem.3, %sw.epilog ], [ 0, %entry ]
  %p.0334 = phi ptr [ %p.2, %sw.epilog ], [ %buf, %entry ]
  %0 = load i8, ptr %p.0334, align 1, !tbaa !15
...
sw.bb:                                            ; preds = %while.body
  %incdec.ptr = getelementptr inbounds i8, ptr %p.0334, i64 1
  br label %sw.epilog

sw.bb1:                                           ; preds = %while.body
  store i8 0, ptr %p.0334, align 1, !tbaa !15
  br label %while.cond2

while.cond2:                                      ; preds = %while.cond2, %sw.bb1
  %p.1 = phi ptr [ %p.0334, %sw.bb1 ], [ %incdec.ptr9, %while.cond2 ]
...
sw.bb10:                                          ; preds = %while.body
  %incdec.ptr11 = getelementptr inbounds i8, ptr %p.0334, i64 1
  store i8 0, ptr %p.0334, align 1, !tbaa !15
  br label %sw.epilog

sw.bb12:                                          ; preds = %while.body, %while.body
  %tobool.not = icmp eq i32 %InString.0336, 0
  %incdec.ptr14 = getelementptr inbounds i8, ptr %p.0334, i64 1
...
sw.bb15:                                          ; preds = %while.body
  %incdec.ptr16 = getelementptr inbounds i8, ptr %p.0334, i64 1
  store i8 0, ptr %p.0334, align 1, !tbaa !15
  %tobool17.not = icmp eq i32 %InString.0336, 0
  br i1 %tobool17.not, label %if.then18, label %if.end22

if.then18:                                        ; preds = %sw.bb15
  %inc = add nsw i32 %item.0337, 1
  %idxprom19 = sext i32 %item.0337 to i64
  ...
  %not = xor i32 %InItem.0335, -1
  br label %if.end22

if.end22:                                         ; preds = %sw.bb15, %if.then18
  %InItem.1 = phi i32 [ %not, %if.then18 ], [ 0, %sw.bb15 ]
  %item.1 = phi i32 [ %inc, %if.then18 ], [ %item.0337, %sw.bb15 ]
  %not23 = xor i32 %InString.0336, -1
  br label %sw.epilog

sw.bb24:                                          ; preds = %while.body
  %incdec.ptr25 = getelementptr inbounds i8, ptr %p.0334, i64 1
  br label %sw.epilog

sw.default:                                       ; preds = %while.body
  %tobool26.not = icmp eq i32 %InItem.0335, 0
  br i1 %tobool26.not, label %if.then27, label %if.end32

if.then27:                                        ; preds = %sw.default
  %inc28 = add nsw i32 %item.0337, 1
  %idxprom29 = sext i32 %item.0337 to i64
  %arrayidx30 = getelementptr inbounds [1000 x ptr], ptr %items, i64 0, i64 %idxprom29
  store ptr %p.0334, ptr %arrayidx30, align 8, !tbaa !5
  br label %if.end32

if.end32:                                         ; preds = %if.then27, %sw.default
  %item.2 = phi i32 [ %item.0337, %sw.default ], [ %inc28, %if.then27 ]
  %incdec.ptr33 = getelementptr inbounds i8, ptr %p.0334, i64 1
  br label %sw.epilog
...
sw.epilog:                                        ; preds = %while.cond2, %sw.bb12, %if.else, %if.end32, %sw.bb24, %if.end22, %sw.bb10, %sw.bb
  ...
  %InItem.3 = phi i32 [ -1, %if.end32 ], [ 0, %sw.bb24 ], [ %InItem.1, %if.end22 ], [ 0, %if.else ], [ 0, %sw.bb10 ], [ %InItem.0335, %sw.bb ], [ %InItem.0335, %sw.bb12 ], [ 0, %while.cond2 ]
  %InString.1 = phi i32 [ %InString.0336, %if.end32 ], [ %InString.0336, %sw.bb24 ], [ %not23, %if.end22 ], [ 0, %if.else ], [ 0, %sw.bb10 ], [ %InString.0336, %sw.bb ], [ -1, %sw.bb12 ], [ 0, %while.cond2 ]
  %item.3 = phi i32 [ %item.2, %if.end32 ], [ %item.0337, %sw.bb24 ], [ %item.1, %if.end22 ], [ %item.0337, %if.else ], [ %item.0337, %sw.bb10 ], [ %item.0337, %sw.bb ], [ %item.0337, %sw.bb12 ], [ %item.0337, %while.cond2 ]
...
while.end34:                                      ; preds = %sw.epilog
  ...
  %cmp35339 = icmp sgt i32 %item.3, 1
  br i1 %cmp35339, label %for.body, label %for.end273

for.body:                                         ; preds = %while.end34, %for.end
  %i.0340 = phi i32 [ %add272, %for.end ], [ 0, %while.end34 ]
  %idxprom37 = zext i32 %i.0340 to i64
  ...
  br i1 %cmp39, label %if.then41, label %cond.false90

if.then41:                                        ; preds = %for.body
  %call45 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str, ptr noundef %3) #11
  call void @error(ptr noundef nonnull @errortext, i32 noundef 300) #11
  br label %cond.false90

cond.false90:                                     ; preds = %if.then41, %for.body
  %add91 = add nuw nsw i32 %i.0340, 1
  %idxprom92 = zext i32 %add91 to i64
  %arrayidx93 = getelementptr inbounds [1000 x ptr], ptr %items, i64 0, i64 %idxprom92
  %4 = load ptr, ptr %arrayidx93, align 8, !tbaa !5
  %5 = load i8, ptr %4, align 1, !tbaa !15
  %conv96 = zext i8 %5 to i32
  %sub97 = sub nsw i32 61, %conv96
  %cmp101 = icmp eq i8 %5, 61
  br i1 %cmp101, label %if.then103, label %cond.end226

if.then103:                                       ; preds = %cond.false90
  %arrayidx105 = getelementptr inbounds i8, ptr %4, i64 1
  %6 = load i8, ptr %arrayidx105, align 1, !tbaa !15
  %conv106 = zext i8 %6 to i32
  %sub107 = sub nsw i32 0, %conv106
  br label %cond.end226

cond.end226:                                      ; preds = %cond.false90, %if.then103
  %__result.0 = phi i32 [ %sub107, %if.then103 ], [ %sub97, %cond.false90 ]
  %tobool228.not = icmp eq i32 %__result.0, 0
  br i1 %tobool228.not, label %if.end231, label %if.then229

if.then229:                                       ; preds = %cond.end226
...
if.end231:                                        ; preds = %if.then229, %cond.end226
  %7 = load i32, ptr %type, align 4, !tbaa !14
  %tobool233.not = icmp eq i32 %7, 0
  %idxprom235 = sext i32 %call to i64
  %arrayidx243 = getelementptr inbounds [2 x i32], ptr @offset8x8_check, i64 0, i64 %idxprom235
  %arrayidx238 = getelementptr inbounds [6 x i32], ptr @offset4x4_check, i64 0, i64 %idxprom235
  %arrayidx243.sink = select i1 %tobool233.not, ptr %arrayidx238, ptr %arrayidx243
  %range.0 = select i1 %tobool233.not, i32 16, i32 64
  ...
  %.pn = select i1 %tobool233.not, ptr %OffsetList4x4input.val, ptr %OffsetList8x8input.val
  %OffsetList.0.in = getelementptr inbounds ptr, ptr %.pn, i64 %idxprom235
  %OffsetList.0 = load ptr, ptr %OffsetList.0.in, align 8, !tbaa !5
  store i32 1, ptr %arrayidx243.sink, align 4, !tbaa !14
  %add249 = add i32 %i.0340, 2
  %8 = zext i32 %add249 to i64
  %wide.trip.count = zext i32 %range.0 to i64
  br label %for.body248

for.body248:                                      ; preds = %if.end231, %if.end264
  %indvars.iv = phi i64 [ 0, %if.end231 ], [ %indvars.iv.next, %if.end264 ]
  %9 = add nuw nsw i64 %indvars.iv, %8
  %arrayidx252 = getelementptr inbounds [1000 x ptr], ptr %items, i64 0, i64 %9
  %10 = load ptr, ptr %arrayidx252, align 8, !tbaa !5
  %call253 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef %10, ptr noundef nonnull @.str.3, ptr noundef nonnull %IntContent) #11
  %cmp254.not = icmp eq i32 %call253, 1
  br i1 %cmp254.not, label %if.end264, label %if.then256

if.then256:                                       ; preds = %for.body248
  %call263 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.4, ptr noundef %3, ptr noundef %10) #11
  call void @error(ptr noundef nonnull @errortext, i32 noundef 300) #11
  br label %if.end264

if.end264:                                        ; preds = %if.then256, %for.body248
  %11 = load i32, ptr %IntContent, align 4, !tbaa !14
  %conv265 = trunc i32 %11 to i16
  %arrayidx267 = getelementptr inbounds i16, ptr %OffsetList.0, i64 %indvars.iv
  store i16 %conv265, ptr %arrayidx267, align 2, !tbaa !19
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.body248, !llvm.loop !21

for.end:                                          ; preds = %if.end264
  %putchar = call i32 @putchar(i32 46)
  %add272 = add i32 %add249, %range.0
  %cmp35 = icmp slt i32 %add272, %dec
  br i1 %cmp35, label %for.body, label %for.end273, !llvm.loop !22

for.end273:                                       ; preds = %for.end, %entry, %while.end34
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %type) #11
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %IntContent) #11
  call void @llvm.lifetime.end.p0(i64 8000, ptr nonnull %items) #11
  ret void
}
...
if.then:                                          ; preds = %entry
  ...
  %call3 = tail call ptr @GetConfigFileContent(ptr noundef nonnull %QOffsetMatrixFile1, i32 noundef 0) #11
  %cmp.not = icmp eq ptr %call3, null
  br i1 %cmp.not, label %if.else, label %if.then4

if.then4:                                         ; preds = %if.then
  %call5 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call3) #12
...
; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @CalculateOffsetParam() local_unnamed_addr #7 {
entry:
...
; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @CalculateOffset8Param() local_unnamed_addr #7 {
entry:
...
attributes #3 = { nofree nounwind memory(argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
