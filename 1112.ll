; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/UI/Common/Update.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/UI/Common/Update.cpp"
...
entry:
  ...
  %typeExt = alloca %class.CStringBase, align 8
...
if.end30:                                         ; preds = %if.end25
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %typeExt) #18
...
if.end9.i.i98.thread:                             ; preds = %if.end30
  %_capacity.i.i = getelementptr inbounds %class.CStringBase, ptr %typeExt, i64 0, i32 2
  %11 = getelementptr inbounds i8, ptr %typeExt, i64 8
  store i64 0, ptr %11, align 8
  %call.i.i.i = call noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #19, !noalias !80
  store ptr %call.i.i.i, ptr %typeExt, align 8, !tbaa !31, !alias.scope !80
  store i32 0, ptr %call.i.i.i, align 4, !tbaa !32, !noalias !80
  store i32 4, ptr %_capacity.i.i, align 4, !tbaa !34, !alias.scope !80
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ext) #18
  %_length2.i252 = getelementptr inbounds %class.CStringBase, ptr %typeExt, i64 0, i32 1
  %12 = getelementptr inbounds i8, ptr %ext, i64 8
  store i64 0, ptr %12, align 8
  br label %24

if.end.i:                                         ; preds = %if.end30
  %_items.i.i.i = getelementptr inbounds %struct.CArcInfoEx, ptr %8, i64 0, i32 5, i32 0, i32 0, i32 3
  %13 = load ptr, ptr %_items.i.i.i, align 8, !tbaa !12, !noalias !80
  %14 = load ptr, ptr %13, align 8, !tbaa !13, !noalias !80
  %_length2.i.i = getelementptr inbounds %class.CStringBase, ptr %14, i64 0, i32 1
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %typeExt, i8 0, i64 16, i1 false), !alias.scope !80
  %15 = load i32, ptr %_length2.i.i, align 8, !tbaa !41, !noalias !80
  %.fr = freeze i32 %15
...
if.end9.i.i.i:                                    ; preds = %if.end.i
  %_capacity.i4.i = getelementptr inbounds %class.CStringBase, ptr %typeExt, i64 0, i32 2
  %conv.i.i.i = zext i32 %add.i.i.i to i64
  %16 = icmp slt i32 %.fr, -1
  %17 = shl nuw nsw i64 %conv.i.i.i, 2
  %18 = select i1 %16, i64 -1, i64 %17
  %call.i.i5.i = call noalias noundef nonnull ptr @_Znam(i64 noundef %18) #19, !noalias !80
  store ptr %call.i.i5.i, ptr %typeExt, align 8, !tbaa !31, !alias.scope !80
  store i32 0, ptr %call.i.i5.i, align 4, !tbaa !32, !noalias !80
  store i32 %add.i.i.i, ptr %_capacity.i4.i, align 4, !tbaa !34, !alias.scope !80
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i

_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i:      ; preds = %if.end9.i.i.i, %if.end.i
  %19 = phi ptr [ null, %if.end.i ], [ %call.i.i5.i, %if.end9.i.i.i ]
  %20 = load ptr, ptr %14, align 8, !tbaa !31, !noalias !80
  br label %while.cond.i.i.i

while.cond.i.i.i:                                 ; preds = %while.cond.i.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i
  %src.addr.0.i.i.i = phi ptr [ %20, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i ], [ %incdec.ptr.i.i.i, %while.cond.i.i.i ]
  %dest.addr.0.i.i.i = phi ptr [ %19, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i ], [ %incdec.ptr1.i.i.i, %while.cond.i.i.i ]
  %incdec.ptr.i.i.i = getelementptr inbounds i32, ptr %src.addr.0.i.i.i, i64 1
  %21 = load i32, ptr %src.addr.0.i.i.i, align 4, !tbaa !32, !noalias !80
  %incdec.ptr1.i.i.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i, i64 1
  store i32 %21, ptr %dest.addr.0.i.i.i, align 4, !tbaa !32, !noalias !80
...
_ZNK10CArcInfoEx10GetMainExtEv.exit:              ; preds = %while.cond.i.i.i
  %_length.i.i = getelementptr inbounds %class.CStringBase, ptr %typeExt, i64 0, i32 1
  store i32 %.fr, ptr %_length.i.i, align 8, !tbaa !41, !alias.scope !80
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ext) #18
  %_length2.i = getelementptr inbounds %class.CStringBase, ptr %typeExt, i64 0, i32 1
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %ext, i8 0, i64 16, i1 false)
...
if.end9.i.i98:                                    ; preds = %_ZNK10CArcInfoEx10GetMainExtEv.exit
  ...
  %22 = icmp slt i32 %.fr, -1
  %23 = shl nuw nsw i64 %conv.i.i96, 2
  %spec.select = select i1 %22, i64 -1, i64 %23
  br label %24

24:                                               ; preds = %if.end9.i.i98, %if.end9.i.i98.thread
  %25 = phi ptr [ %call.i.i.i, %if.end9.i.i98.thread ], [ %19, %if.end9.i.i98 ]
  %26 = phi i32 [ 0, %if.end9.i.i98.thread ], [ %.fr, %if.end9.i.i98 ]
  %_length2.i255263 = phi ptr [ %_length2.i252, %if.end9.i.i98.thread ], [ %_length2.i, %if.end9.i.i98 ]
  %add.i.i93257262 = phi i32 [ 1, %if.end9.i.i98.thread ], [ %add.i.i93, %if.end9.i.i98 ]
  %27 = phi i64 [ 4, %if.end9.i.i98.thread ], [ %spec.select, %if.end9.i.i98 ]
  %call.i.i97107 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %27) #19
          to label %call.i.i97.noexc unwind label %lpad31

call.i.i97.noexc:                                 ; preds = %24
  %_capacity.i95 = getelementptr inbounds %class.CStringBase, ptr %ext, i64 0, i32 2
  store ptr %call.i.i97107, ptr %ext, align 8, !tbaa !31
  store i32 0, ptr %call.i.i97107, align 4, !tbaa !32
  store i32 %add.i.i93257262, ptr %_capacity.i95, align 4, !tbaa !34
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i99:      ; preds = %call.i.i97.noexc, %_ZNK10CArcInfoEx10GetMainExtEv.exit
  %_length2.i256 = phi ptr [ %_length2.i, %_ZNK10CArcInfoEx10GetMainExtEv.exit ], [ %_length2.i255263, %call.i.i97.noexc ]
  %28 = phi i32 [ -1, %_ZNK10CArcInfoEx10GetMainExtEv.exit ], [ %26, %call.i.i97.noexc ]
  %29 = phi ptr [ %19, %_ZNK10CArcInfoEx10GetMainExtEv.exit ], [ %25, %call.i.i97.noexc ]
  %30 = phi i32 [ 0, %_ZNK10CArcInfoEx10GetMainExtEv.exit ], [ %add.i.i93257262, %call.i.i97.noexc ]
  %31 = phi ptr [ null, %_ZNK10CArcInfoEx10GetMainExtEv.exit ], [ %call.i.i97107, %call.i.i97.noexc ]
  br label %while.cond.i.i105

while.cond.i.i105:                                ; preds = %while.cond.i.i105, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i99
  %src.addr.0.i.i100 = phi ptr [ %29, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i99 ], [ %incdec.ptr.i.i102, %while.cond.i.i105 ]
  %dest.addr.0.i.i101 = phi ptr [ %31, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i99 ], [ %incdec.ptr1.i.i103, %while.cond.i.i105 ]
  %incdec.ptr.i.i102 = getelementptr inbounds i32, ptr %src.addr.0.i.i100, i64 1
  %32 = load i32, ptr %src.addr.0.i.i100, align 4, !tbaa !32
  %incdec.ptr1.i.i103 = getelementptr inbounds i32, ptr %dest.addr.0.i.i101, i64 1
  store i32 %32, ptr %dest.addr.0.i.i101, align 4, !tbaa !32
  %cmp.not.i.i104 = icmp eq i32 %32, 0
  br i1 %cmp.not.i.i104, label %invoke.cont32, label %while.cond.i.i105, !llvm.loop !36

invoke.cont32:                                    ; preds = %while.cond.i.i105
  %_length.i106 = getelementptr inbounds %class.CStringBase, ptr %ext, i64 0, i32 1
  store i32 %28, ptr %_length.i106, align 8, !tbaa !41
  %SfxMode = getelementptr inbounds %struct.CUpdateOptions, ptr %this, i64 0, i32 4
  %33 = load i8, ptr %SfxMode, align 8, !tbaa !83, !range !78, !noundef !79
  %tobool33.not = icmp eq i8 %33, 0
  br i1 %tobool33.not, label %if.end38, label %if.then34

if.then34:                                        ; preds = %invoke.cont32
  store i32 0, ptr %_length.i106, align 8, !tbaa !41
  store i32 0, ptr %31, align 4, !tbaa !32
  %_capacity.i.i115 = getelementptr inbounds %class.CStringBase, ptr %ext, i64 0, i32 2
  %cmp.i.i116 = icmp eq i32 %30, 1
  br i1 %cmp.i.i116, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i121, label %if.end.i.i

if.end.i.i:                                       ; preds = %if.then34
  %call.i.i119127 = invoke noalias noundef nonnull dereferenceable(4) ptr @_Znam(i64 noundef 4) #19
          to label %call.i.i119.noexc unwind label %lpad35

call.i.i119.noexc:                                ; preds = %if.end.i.i
  %cmp3.i.i = icmp sgt i32 %30, 0
  br i1 %cmp3.i.i, label %delete.notnull.i.i, label %if.end9.i.i120

delete.notnull.i.i:                               ; preds = %call.i.i119.noexc
  call void @_ZdaPv(ptr noundef nonnull %31) #20
  %.pre.i = load i32, ptr %_length.i106, align 8, !tbaa !41
  %34 = sext i32 %.pre.i to i64
  br label %if.end9.i.i120

if.end9.i.i120:                                   ; preds = %delete.notnull.i.i, %call.i.i119.noexc
  %idxprom13.i.i = phi i64 [ %34, %delete.notnull.i.i ], [ 0, %call.i.i119.noexc ]
  store ptr %call.i.i119127, ptr %ext, align 8, !tbaa !31
  %arrayidx14.i.i = getelementptr inbounds i32, ptr %call.i.i119127, i64 %idxprom13.i.i
  store i32 0, ptr %arrayidx14.i.i, align 4, !tbaa !32
  store i32 1, ptr %_capacity.i.i115, align 4, !tbaa !34
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i121

_ZN11CStringBaseIwE11SetCapacityEi.exit.i121:     ; preds = %if.end9.i.i120, %if.then34
  %35 = phi ptr [ %31, %if.then34 ], [ %call.i.i119127, %if.end9.i.i120 ]
...
lpad35:                                           ; preds = %if.end.i.i161, %if.end.i.i137, %if.end.i.i, %invoke.cont42
  %37 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup64

if.end38:                                         ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i121, %invoke.cont32
  %38 = phi ptr [ %35, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i121 ], [ %31, %invoke.cont32 ]
  %39 = phi i32 [ 0, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i121 ], [ %28, %invoke.cont32 ]
  ...
  %cmp.i = icmp eq ptr %ext, %BaseExtension
  br i1 %cmp.i, label %invoke.cont39, label %if.end.i133

if.end.i133:                                      ; preds = %if.end38
  %_length.i.i128 = getelementptr inbounds %struct.CUpdateOptions, ptr %this, i64 0, i32 3, i32 3, i32 1
  store i32 0, ptr %_length.i.i128, align 8, !tbaa !41
  %40 = load ptr, ptr %BaseExtension, align 8, !tbaa !31
  store i32 0, ptr %40, align 4, !tbaa !32
  %add.i.i130 = add nsw i32 %39, 1
  %_capacity.i.i131 = getelementptr inbounds %struct.CUpdateOptions, ptr %this, i64 0, i32 3, i32 3, i32 2
  %41 = load i32, ptr %_capacity.i.i131, align 4, !tbaa !34
  %cmp.i.i132 = icmp eq i32 %add.i.i130, %41
  br i1 %cmp.i.i132, label %while.cond.i.i149.preheader, label %if.end.i.i137

if.end.i.i137:                                    ; preds = %if.end.i133
  %conv.i.i134 = zext i32 %add.i.i130 to i64
  %42 = icmp slt i32 %39, -1
  %43 = shl nuw nsw i64 %conv.i.i134, 2
  %44 = select i1 %42, i64 -1, i64 %43
  %call.i.i135150 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %44) #19
          to label %call.i.i135.noexc unwind label %lpad35

call.i.i135.noexc:                                ; preds = %if.end.i.i137
  %cmp3.i.i136 = icmp sgt i32 %41, 0
  br i1 %cmp3.i.i136, label %delete.notnull.i.i139, label %if.end9.i.i142

delete.notnull.i.i139:                            ; preds = %call.i.i135.noexc
  call void @_ZdaPv(ptr noundef nonnull %40) #20
  %.pre.i138 = load i32, ptr %_length.i.i128, align 8, !tbaa !41
  %45 = sext i32 %.pre.i138 to i64
  %.pre.pre = load ptr, ptr %ext, align 8, !tbaa !31
  br label %if.end9.i.i142

if.end9.i.i142:                                   ; preds = %delete.notnull.i.i139, %call.i.i135.noexc
  %.pre = phi ptr [ %.pre.pre, %delete.notnull.i.i139 ], [ %38, %call.i.i135.noexc ]
  %idxprom13.i.i140 = phi i64 [ %45, %delete.notnull.i.i139 ], [ 0, %call.i.i135.noexc ]
  store ptr %call.i.i135150, ptr %BaseExtension, align 8, !tbaa !31
  %arrayidx14.i.i141 = getelementptr inbounds i32, ptr %call.i.i135150, i64 %idxprom13.i.i140
  store i32 0, ptr %arrayidx14.i.i141, align 4, !tbaa !32
  store i32 %add.i.i130, ptr %_capacity.i.i131, align 4, !tbaa !34
  br label %while.cond.i.i149.preheader

while.cond.i.i149.preheader:                      ; preds = %if.end9.i.i142, %if.end.i133
  %src.addr.0.i.i144.ph = phi ptr [ %.pre, %if.end9.i.i142 ], [ %38, %if.end.i133 ]
  %dest.addr.0.i.i145.ph = phi ptr [ %call.i.i135150, %if.end9.i.i142 ], [ %40, %if.end.i133 ]
  br label %while.cond.i.i149

while.cond.i.i149:                                ; preds = %while.cond.i.i149.preheader, %while.cond.i.i149
  %src.addr.0.i.i144 = phi ptr [ %incdec.ptr.i.i146, %while.cond.i.i149 ], [ %src.addr.0.i.i144.ph, %while.cond.i.i149.preheader ]
  %dest.addr.0.i.i145 = phi ptr [ %incdec.ptr1.i.i147, %while.cond.i.i149 ], [ %dest.addr.0.i.i145.ph, %while.cond.i.i149.preheader ]
  %incdec.ptr.i.i146 = getelementptr inbounds i32, ptr %src.addr.0.i.i144, i64 1
  %46 = load i32, ptr %src.addr.0.i.i144, align 4, !tbaa !32
  %incdec.ptr1.i.i147 = getelementptr inbounds i32, ptr %dest.addr.0.i.i145, i64 1
  store i32 %46, ptr %dest.addr.0.i.i145, align 4, !tbaa !32
  %cmp.not.i.i148 = icmp eq i32 %46, 0
  br i1 %cmp.not.i.i148, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i, label %while.cond.i.i149, !llvm.loop !36

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i:            ; preds = %while.cond.i.i149
  %47 = load i32, ptr %_length.i106, align 8, !tbaa !41
  store i32 %47, ptr %_length.i.i128, align 8, !tbaa !41
  br label %invoke.cont39

invoke.cont39:                                    ; preds = %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i, %if.end38
  %VolExtension = getelementptr inbounds %struct.CUpdateOptions, ptr %this, i64 0, i32 3, i32 4
  %cmp.i151 = icmp eq ptr %typeExt, %VolExtension
  br i1 %cmp.i151, label %invoke.cont42, label %if.end.i157

if.end.i157:                                      ; preds = %invoke.cont39
  %_length.i.i152 = getelementptr inbounds %struct.CUpdateOptions, ptr %this, i64 0, i32 3, i32 4, i32 1
  store i32 0, ptr %_length.i.i152, align 8, !tbaa !41
  %48 = load ptr, ptr %VolExtension, align 8, !tbaa !31
  store i32 0, ptr %48, align 4, !tbaa !32
  %49 = load i32, ptr %_length2.i256, align 8, !tbaa !41
  %add.i.i154 = add nsw i32 %49, 1
  %_capacity.i.i155 = getelementptr inbounds %struct.CUpdateOptions, ptr %this, i64 0, i32 3, i32 4, i32 2
  %50 = load i32, ptr %_capacity.i.i155, align 4, !tbaa !34
  %cmp.i.i156 = icmp eq i32 %add.i.i154, %50
  br i1 %cmp.i.i156, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i167, label %if.end.i.i161

if.end.i.i161:                                    ; preds = %if.end.i157
  %conv.i.i158 = zext i32 %add.i.i154 to i64
  %51 = icmp slt i32 %49, -1
  %52 = shl nuw nsw i64 %conv.i.i158, 2
  %53 = select i1 %51, i64 -1, i64 %52
  %call.i.i159175 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %53) #19
          to label %call.i.i159.noexc unwind label %lpad35

call.i.i159.noexc:                                ; preds = %if.end.i.i161
  %cmp3.i.i160 = icmp sgt i32 %50, 0
  br i1 %cmp3.i.i160, label %delete.notnull.i.i163, label %if.end9.i.i166

delete.notnull.i.i163:                            ; preds = %call.i.i159.noexc
  call void @_ZdaPv(ptr noundef nonnull %48) #20
  %.pre.i162 = load i32, ptr %_length.i.i152, align 8, !tbaa !41
  %54 = sext i32 %.pre.i162 to i64
  br label %if.end9.i.i166

if.end9.i.i166:                                   ; preds = %delete.notnull.i.i163, %call.i.i159.noexc
  %idxprom13.i.i164 = phi i64 [ %54, %delete.notnull.i.i163 ], [ 0, %call.i.i159.noexc ]
  store ptr %call.i.i159175, ptr %VolExtension, align 8, !tbaa !31
  %arrayidx14.i.i165 = getelementptr inbounds i32, ptr %call.i.i159175, i64 %idxprom13.i.i164
  store i32 0, ptr %arrayidx14.i.i165, align 4, !tbaa !32
  store i32 %add.i.i154, ptr %_capacity.i.i155, align 4, !tbaa !34
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i167

_ZN11CStringBaseIwE11SetCapacityEi.exit.i167:     ; preds = %if.end9.i.i166, %if.end.i157
  %55 = phi ptr [ %48, %if.end.i157 ], [ %call.i.i159175, %if.end9.i.i166 ]
  %56 = load ptr, ptr %typeExt, align 8, !tbaa !31
  br label %while.cond.i.i173

while.cond.i.i173:                                ; preds = %while.cond.i.i173, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i167
  %src.addr.0.i.i168 = phi ptr [ %56, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i167 ], [ %incdec.ptr.i.i170, %while.cond.i.i173 ]
  %dest.addr.0.i.i169 = phi ptr [ %55, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i167 ], [ %incdec.ptr1.i.i171, %while.cond.i.i173 ]
  %incdec.ptr.i.i170 = getelementptr inbounds i32, ptr %src.addr.0.i.i168, i64 1
  %57 = load i32, ptr %src.addr.0.i.i168, align 4, !tbaa !32
  %incdec.ptr1.i.i171 = getelementptr inbounds i32, ptr %dest.addr.0.i.i169, i64 1
  store i32 %57, ptr %dest.addr.0.i.i169, align 4, !tbaa !32
  %cmp.not.i.i172 = icmp eq i32 %57, 0
  br i1 %cmp.not.i.i172, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i174, label %while.cond.i.i173, !llvm.loop !36

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i174:         ; preds = %while.cond.i.i173
  %58 = load i32, ptr %_length2.i256, align 8, !tbaa !41
  store i32 %58, ptr %_length.i.i152, align 8, !tbaa !41
  br label %invoke.cont42

invoke.cont42:                                    ; preds = %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i174, %invoke.cont39
...
for.cond.preheader:                               ; preds = %invoke.cont42
  %_size.i177 = getelementptr inbounds %struct.CUpdateOptions, ptr %this, i64 0, i32 1, i32 0, i32 0, i32 2
  %59 = load i32, ptr %_size.i177, align 4, !tbaa !5
  %cmp49248 = icmp sgt i32 %59, 0
  br i1 %cmp49248, label %for.body.lr.ph, label %for.cond.cleanup

for.body.lr.ph:                                   ; preds = %for.cond.preheader
  %_items.i.i184 = getelementptr inbounds %struct.CUpdateOptions, ptr %this, i64 0, i32 1, i32 0, i32 0, i32 3
  br label %for.body

for.cond.cleanup:                                 ; preds = %invoke.cont63, %for.cond.preheader
  %60 = load ptr, ptr %ext, align 8, !tbaa !31
  %isnull.i178 = icmp eq ptr %60, null
  br i1 %isnull.i178, label %_ZN11CStringBaseIwED2Ev.exit180, label %delete.notnull.i179

delete.notnull.i179:                              ; preds = %for.cond.cleanup
  call void @_ZdaPv(ptr noundef nonnull %60) #20
  br label %_ZN11CStringBaseIwED2Ev.exit180

_ZN11CStringBaseIwED2Ev.exit180:                  ; preds = %for.cond.cleanup, %delete.notnull.i179
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ext) #18
  %61 = load ptr, ptr %typeExt, align 8, !tbaa !31
  %isnull.i181 = icmp eq ptr %61, null
  br i1 %isnull.i181, label %_ZN11CStringBaseIwED2Ev.exit183, label %delete.notnull.i182

delete.notnull.i182:                              ; preds = %_ZN11CStringBaseIwED2Ev.exit180
  call void @_ZdaPv(ptr noundef nonnull %61) #20
  br label %_ZN11CStringBaseIwED2Ev.exit183

_ZN11CStringBaseIwED2Ev.exit183:                  ; preds = %_ZN11CStringBaseIwED2Ev.exit180, %delete.notnull.i182
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %typeExt) #18
  br label %return

for.body:                                         ; preds = %for.body.lr.ph, %invoke.cont63
  %indvars.iv = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next, %invoke.cont63 ]
  %62 = load ptr, ptr %_items.i.i184, align 8, !tbaa !12
  %arrayidx.i.i186 = getelementptr inbounds ptr, ptr %62, i64 %indvars.iv
  %63 = load ptr, ptr %arrayidx.i.i186, align 8, !tbaa !13
  %ArchivePath54 = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %63, i64 0, i32 1
  %BaseExtension55 = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %63, i64 0, i32 1, i32 3
  %cmp.i187 = icmp eq ptr %ext, %BaseExtension55
  br i1 %cmp.i187, label %invoke.cont56, label %if.end.i193

if.end.i193:                                      ; preds = %for.body
  %_length.i.i188 = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %63, i64 0, i32 1, i32 3, i32 1
  store i32 0, ptr %_length.i.i188, align 8, !tbaa !41
  %64 = load ptr, ptr %BaseExtension55, align 8, !tbaa !31
  store i32 0, ptr %64, align 4, !tbaa !32
  %65 = load i32, ptr %_length.i106, align 8, !tbaa !41
  %add.i.i190 = add nsw i32 %65, 1
  %_capacity.i.i191 = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %63, i64 0, i32 1, i32 3, i32 2
  %66 = load i32, ptr %_capacity.i.i191, align 4, !tbaa !34
  %cmp.i.i192 = icmp eq i32 %add.i.i190, %66
  br i1 %cmp.i.i192, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i203, label %if.end.i.i197

if.end.i.i197:                                    ; preds = %if.end.i193
  %conv.i.i194 = zext i32 %add.i.i190 to i64
  %67 = icmp slt i32 %65, -1
  %68 = shl nuw nsw i64 %conv.i.i194, 2
  %69 = select i1 %67, i64 -1, i64 %68
  %call.i.i195211 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %69) #19
          to label %call.i.i195.noexc unwind label %lpad51

call.i.i195.noexc:                                ; preds = %if.end.i.i197
  %cmp3.i.i196 = icmp sgt i32 %66, 0
  br i1 %cmp3.i.i196, label %delete.notnull.i.i199, label %if.end9.i.i202

delete.notnull.i.i199:                            ; preds = %call.i.i195.noexc
  call void @_ZdaPv(ptr noundef nonnull %64) #20
  %.pre.i198 = load i32, ptr %_length.i.i188, align 8, !tbaa !41
  %70 = sext i32 %.pre.i198 to i64
  br label %if.end9.i.i202

if.end9.i.i202:                                   ; preds = %delete.notnull.i.i199, %call.i.i195.noexc
  %idxprom13.i.i200 = phi i64 [ %70, %delete.notnull.i.i199 ], [ 0, %call.i.i195.noexc ]
  store ptr %call.i.i195211, ptr %BaseExtension55, align 8, !tbaa !31
  %arrayidx14.i.i201 = getelementptr inbounds i32, ptr %call.i.i195211, i64 %idxprom13.i.i200
  store i32 0, ptr %arrayidx14.i.i201, align 4, !tbaa !32
  store i32 %add.i.i190, ptr %_capacity.i.i191, align 4, !tbaa !34
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i203

_ZN11CStringBaseIwE11SetCapacityEi.exit.i203:     ; preds = %if.end9.i.i202, %if.end.i193
  %71 = phi ptr [ %64, %if.end.i193 ], [ %call.i.i195211, %if.end9.i.i202 ]
  %72 = load ptr, ptr %ext, align 8, !tbaa !31
  br label %while.cond.i.i209

while.cond.i.i209:                                ; preds = %while.cond.i.i209, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i203
  %src.addr.0.i.i204 = phi ptr [ %72, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i203 ], [ %incdec.ptr.i.i206, %while.cond.i.i209 ]
  %dest.addr.0.i.i205 = phi ptr [ %71, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i203 ], [ %incdec.ptr1.i.i207, %while.cond.i.i209 ]
  %incdec.ptr.i.i206 = getelementptr inbounds i32, ptr %src.addr.0.i.i204, i64 1
  %73 = load i32, ptr %src.addr.0.i.i204, align 4, !tbaa !32
  %incdec.ptr1.i.i207 = getelementptr inbounds i32, ptr %dest.addr.0.i.i205, i64 1
  store i32 %73, ptr %dest.addr.0.i.i205, align 4, !tbaa !32
  %cmp.not.i.i208 = icmp eq i32 %73, 0
  br i1 %cmp.not.i.i208, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i210, label %while.cond.i.i209, !llvm.loop !36

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i210:         ; preds = %while.cond.i.i209
  %74 = load i32, ptr %_length.i106, align 8, !tbaa !41
  store i32 %74, ptr %_length.i.i188, align 8, !tbaa !41
  br label %invoke.cont56

invoke.cont56:                                    ; preds = %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i210, %for.body
  %VolExtension59 = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %63, i64 0, i32 1, i32 4
  %cmp.i213 = icmp eq ptr %typeExt, %VolExtension59
  br i1 %cmp.i213, label %invoke.cont60, label %if.end.i219

if.end.i219:                                      ; preds = %invoke.cont56
  %_length.i.i214 = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %63, i64 0, i32 1, i32 4, i32 1
  store i32 0, ptr %_length.i.i214, align 8, !tbaa !41
  %75 = load ptr, ptr %VolExtension59, align 8, !tbaa !31
  store i32 0, ptr %75, align 4, !tbaa !32
  %76 = load i32, ptr %_length2.i256, align 8, !tbaa !41
  %add.i.i216 = add nsw i32 %76, 1
  %_capacity.i.i217 = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %63, i64 0, i32 1, i32 4, i32 2
  %77 = load i32, ptr %_capacity.i.i217, align 4, !tbaa !34
  %cmp.i.i218 = icmp eq i32 %add.i.i216, %77
  br i1 %cmp.i.i218, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i229, label %if.end.i.i223

if.end.i.i223:                                    ; preds = %if.end.i219
  %conv.i.i220 = zext i32 %add.i.i216 to i64
  %78 = icmp slt i32 %76, -1
  %79 = shl nuw nsw i64 %conv.i.i220, 2
  %80 = select i1 %78, i64 -1, i64 %79
  %call.i.i221237 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %80) #19
          to label %call.i.i221.noexc unwind label %lpad51

call.i.i221.noexc:                                ; preds = %if.end.i.i223
  %cmp3.i.i222 = icmp sgt i32 %77, 0
  br i1 %cmp3.i.i222, label %delete.notnull.i.i225, label %if.end9.i.i228

delete.notnull.i.i225:                            ; preds = %call.i.i221.noexc
  call void @_ZdaPv(ptr noundef nonnull %75) #20
  %.pre.i224 = load i32, ptr %_length.i.i214, align 8, !tbaa !41
  %81 = sext i32 %.pre.i224 to i64
  br label %if.end9.i.i228

if.end9.i.i228:                                   ; preds = %delete.notnull.i.i225, %call.i.i221.noexc
  %idxprom13.i.i226 = phi i64 [ %81, %delete.notnull.i.i225 ], [ 0, %call.i.i221.noexc ]
  store ptr %call.i.i221237, ptr %VolExtension59, align 8, !tbaa !31
  %arrayidx14.i.i227 = getelementptr inbounds i32, ptr %call.i.i221237, i64 %idxprom13.i.i226
  store i32 0, ptr %arrayidx14.i.i227, align 4, !tbaa !32
  store i32 %add.i.i216, ptr %_capacity.i.i217, align 4, !tbaa !34
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i229

_ZN11CStringBaseIwE11SetCapacityEi.exit.i229:     ; preds = %if.end9.i.i228, %if.end.i219
  %82 = phi ptr [ %75, %if.end.i219 ], [ %call.i.i221237, %if.end9.i.i228 ]
  %83 = load ptr, ptr %typeExt, align 8, !tbaa !31
  br label %while.cond.i.i235

while.cond.i.i235:                                ; preds = %while.cond.i.i235, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i229
  %src.addr.0.i.i230 = phi ptr [ %83, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i229 ], [ %incdec.ptr.i.i232, %while.cond.i.i235 ]
  %dest.addr.0.i.i231 = phi ptr [ %82, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i229 ], [ %incdec.ptr1.i.i233, %while.cond.i.i235 ]
  %incdec.ptr.i.i232 = getelementptr inbounds i32, ptr %src.addr.0.i.i230, i64 1
  %84 = load i32, ptr %src.addr.0.i.i230, align 4, !tbaa !32
  %incdec.ptr1.i.i233 = getelementptr inbounds i32, ptr %dest.addr.0.i.i231, i64 1
  store i32 %84, ptr %dest.addr.0.i.i231, align 4, !tbaa !32
  %cmp.not.i.i234 = icmp eq i32 %84, 0
  br i1 %cmp.not.i.i234, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i236, label %while.cond.i.i235, !llvm.loop !36

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i236:         ; preds = %while.cond.i.i235
  %85 = load i32, ptr %_length2.i256, align 8, !tbaa !41
  store i32 %85, ptr %_length.i.i214, align 8, !tbaa !41
  br label %invoke.cont60

invoke.cont60:                                    ; preds = %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i236, %invoke.cont56
  invoke void @_ZN12CArchivePath13ParseFromPathERK11CStringBaseIwE(ptr noundef nonnull align 8 dereferenceable(120) %ArchivePath54, ptr noundef nonnull align 8 dereferenceable(16) %63)
          to label %invoke.cont63 unwind label %lpad51

invoke.cont63:                                    ; preds = %invoke.cont60
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %86 = load i32, ptr %_size.i177, align 4, !tbaa !5
  %87 = sext i32 %86 to i64
  %cmp49 = icmp slt i64 %indvars.iv.next, %87
  br i1 %cmp49, label %for.body, label %for.cond.cleanup, !llvm.loop !84

lpad51:                                           ; preds = %if.end.i.i223, %if.end.i.i197, %invoke.cont60
  %88 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup64

ehcleanup64:                                      ; preds = %lpad51, %lpad35
  %.pn = phi { ptr, i32 } [ %88, %lpad51 ], [ %37, %lpad35 ]
  %89 = load ptr, ptr %ext, align 8, !tbaa !31
  %isnull.i239 = icmp eq ptr %89, null
  br i1 %isnull.i239, label %ehcleanup65, label %delete.notnull.i240

delete.notnull.i240:                              ; preds = %ehcleanup64
  call void @_ZdaPv(ptr noundef nonnull %89) #20
  br label %ehcleanup65

ehcleanup65:                                      ; preds = %delete.notnull.i240, %ehcleanup64, %lpad31
  %.pn.pn = phi { ptr, i32 } [ %36, %lpad31 ], [ %.pn, %ehcleanup64 ], [ %.pn, %delete.notnull.i240 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ext) #18
  %90 = load ptr, ptr %typeExt, align 8, !tbaa !31
  %isnull.i242 = icmp eq ptr %90, null
  br i1 %isnull.i242, label %_ZN11CStringBaseIwED2Ev.exit244, label %delete.notnull.i243

delete.notnull.i243:                              ; preds = %ehcleanup65
  call void @_ZdaPv(ptr noundef nonnull %90) #20
  br label %_ZN11CStringBaseIwED2Ev.exit244

_ZN11CStringBaseIwED2Ev.exit244:                  ; preds = %ehcleanup65, %delete.notnull.i243
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %typeExt) #18
  br label %ehcleanup70

ehcleanup70:                                      ; preds = %_ZN11CStringBaseIwED2Ev.exit244, %_ZN11CStringBaseIwED2Ev.exit90
  %.pn.pn.pn = phi { ptr, i32 } [ %.pn.pn, %_ZN11CStringBaseIwED2Ev.exit244 ], [ %4, %_ZN11CStringBaseIwED2Ev.exit90 ]
  resume { ptr, i32 } %.pn.pn.pn

return:                                           ; preds = %if.end20, %if.end25, %_ZN11CStringBaseIwED2Ev.exit183, %entry
  %retval.2 = phi i1 [ false, %entry ], [ false, %if.end20 ], [ false, %if.end25 ], [ true, %_ZN11CStringBaseIwED2Ev.exit183 ]
  ret i1 %retval.2
}
...
if.end45:                                         ; preds = %land.lhs.true2, %_ZN9CPropertyD2Ev.exit, %if.end7
  %SfxMode81392 = getelementptr inbounds %struct.CUpdateOptions, ptr %options, i64 0, i32 4
...
for.cond.preheader:                               ; preds = %invoke.cont139
  ...
  %cmp1591220 = icmp sgt i32 %59, 0
  br i1 %cmp1591220, label %for.body.lr.ph, label %invoke.cont269
...
for.body:                                         ; preds = %for.body.lr.ph, %for.cond
  ...
  %needScanning.01222 = phi i8 [ 0, %for.body.lr.ph ], [ %95, %for.cond ]
...
_ZNK14NUpdateArchive10CActionSet12NeedScanningEv.exit: ; preds = %for.cond.4.i
  ...
  %cmp2.6.i = icmp eq i32 %94, 2
  %cmp9.not.i = icmp ne i32 %89, 0
  %or.cond.not.i = select i1 %cmp2.6.i, i1 true, i1 %cmp9.not.i
  %cmp9.not.1.i = icmp ne i32 %90, 0
  %or.cond26.i = select i1 %or.cond.not.i, i1 true, i1 %cmp9.not.1.i
  %cmp9.not.2.i = icmp ne i32 %91, 0
  %or.cond27.i = select i1 %or.cond26.i, i1 true, i1 %cmp9.not.2.i
  %cmp9.not.3.i = icmp ne i32 %92, 0
  %or.cond28.i = select i1 %or.cond27.i, i1 true, i1 %cmp9.not.3.i
  %cmp9.not.4.i = icmp ne i32 %93, 0
  %or.cond29.i = select i1 %or.cond28.i, i1 true, i1 %cmp9.not.4.i
  %cmp9.not.5.i = icmp ne i32 %94, 0
  %or.cond30.i = select i1 %or.cond29.i, i1 true, i1 %cmp9.not.5.i
  %cond.fr = freeze i1 %or.cond30.i
  br i1 %cond.fr, label %_ZNK14NUpdateArchive10CActionSet12NeedScanningEv.exit.thread, label %for.cond
...
for.cond:                                         ; preds = %_ZNK14NUpdateArchive10CActionSet12NeedScanningEv.exit, %_ZNK14NUpdateArchive10CActionSet12NeedScanningEv.exit.thread
  %95 = phi i8 [ 1, %_ZNK14NUpdateArchive10CActionSet12NeedScanningEv.exit.thread ], [ %needScanning.01222, %_ZNK14NUpdateArchive10CActionSet12NeedScanningEv.exit ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
if.then170:                                       ; preds = %for.cond.cleanup
  ...
  %96 = load ptr, ptr %vfn173, align 8
  %call176 = invoke noundef i32 %96(ptr noundef nonnull align 8 dereferenceable(8) %callback)
...
for.cond192.preheader:                            ; preds = %invoke.cont185
  ...
  %98 = load i32, ptr %_size.i875, align 4, !tbaa !5
  %cmp196.not1223 = icmp sgt i32 %98, 0
  br i1 %cmp196.not1223, label %for.body198.lr.ph, label %for.end223
...
for.cond192:                                      ; preds = %invoke.cont209
  ...
  %99 = load i32, ptr %_size.i875, align 4, !tbaa !5
  %100 = sext i32 %99 to i64
  %cmp196.not = icmp slt i64 %indvars.iv.next1380, %100
...
for.body198:                                      ; preds = %for.body198.lr.ph, %for.cond192
  %indvars.iv1379 = phi i64 [ 0, %for.body198.lr.ph ], [ %indvars.iv.next1380, %for.cond192 ]
  %102 = load ptr, ptr %_items.i.i876, align 8, !tbaa !12
  %arrayidx.i.i878 = getelementptr inbounds ptr, ptr %102, i64 %indvars.iv1379
  %103 = load ptr, ptr %arrayidx.i.i878, align 8, !tbaa !13
  %104 = load ptr, ptr %103, align 8, !tbaa !31
  %105 = load ptr, ptr %_items.i879, align 8, !tbaa !12
  %arrayidx.i881 = getelementptr inbounds i32, ptr %105, i64 %indvars.iv1379
  %106 = load i32, ptr %arrayidx.i881, align 4, !tbaa !21
  %vtable207 = load ptr, ptr %callback, align 8, !tbaa !46
  %vfn208 = getelementptr inbounds ptr, ptr %vtable207, i64 14
  %107 = load ptr, ptr %vfn208, align 8
  %call210 = invoke noundef i32 %107(ptr noundef nonnull align 8 dereferenceable(8) %callback, ptr noundef %104, i32 noundef %106)
...
if.end232:                                        ; preds = %for.end223
  ...
  %109 = load ptr, ptr %vfn235, align 8
  %call238 = invoke noundef i32 %109(ptr noundef nonnull align 8 dereferenceable(8) %callback)
          to label %invoke.cont237 unwind label %lpad236

invoke.cont237:                                   ; preds = %if.end232
  %cmp239.not = icmp eq i32 %call238, 0
  %spec.select1059 = select i1 %cmp239.not, i32 %retval.8, i32 %call238
  br label %cleanup256
...
ehcleanup247:                                     ; preds = %lpad236, %lpad200, %lpad188
  %.pn648 = phi { ptr, i32 } [ %101, %lpad188 ], [ %110, %lpad236 ], [ %108, %lpad200 ]
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %errorCodes) #18
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %errorCodes) #18
  call void @_ZN13CObjectVectorI11CStringBaseIwEED2Ev(ptr noundef nonnull align 8 dereferenceable(32) %errorPaths) #18
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %errorPaths) #18
...
ehcleanup259:                                     ; preds = %ehcleanup247, %lpad174
  %.pn648.pn.pn = phi { ptr, i32 } [ %.pn648, %ehcleanup247 ], [ %97, %lpad174 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %enumCallback) #18
  br label %ehcleanup504
...
invoke.cont269:                                   ; preds = %for.cond.preheader, %_ZN8CDirItemD2Ev.exit, %for.cond.cleanup, %cleanup256
  ...
  %111 = load i8, ptr %IsOpen.i, align 8, !tbaa !112, !range !78, !noundef !79
  %tobool270.not = icmp ne i8 %111, 0
  %112 = load i8, ptr %StdOutMode, align 8, !tbaa !104, !range !78, !noundef !79
  %tobool273.not = icmp ne i8 %112, 0
  %UpdateArchiveItself = getelementptr inbounds %struct.CUpdateOptions, ptr %options, i64 0, i32 2
  %113 = load i8, ptr %UpdateArchiveItself, align 8
  %tobool275.not = icmp eq i8 %113, 0
...
if.then276:                                       ; preds = %invoke.cont269
  ...
  %114 = load ptr, ptr %_items.i.i888, align 8, !tbaa !12
  %115 = load ptr, ptr %114, align 8, !tbaa !13
  %ArchivePath281 = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %115, i64 0, i32 1
...
invoke.cont283:                                   ; preds = %if.then276
  ...
  %116 = load i32, ptr %_length.i889, align 8
  %cmp.i890 = icmp ne i32 %116, 0
  %or.cond1060.not1062 = select i1 %tobool270.not, i1 true, i1 %cmp.i890
  %117 = load i32, ptr %_size.i, align 4
  %cmp295 = icmp eq i32 %117, 0
...
if.then296:                                       ; preds = %invoke.cont283
  %Temp = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %115, i64 0, i32 1, i32 5
  store i8 1, ptr %Temp, align 8, !tbaa !131
  %cmp.i893 = icmp eq i32 %116, 0
...
if.then300:                                       ; preds = %if.then296
  ...
  %TempPrefix = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %115, i64 0, i32 1, i32 6
...
if.end309:                                        ; preds = %invoke.cont283, %invoke.cont302, %if.then296, %invoke.cont269
  ...
  %119 = load i32, ptr %_size.i894, align 4, !tbaa !5
  %cmp316.not1225 = icmp sgt i32 %119, 0
  br i1 %cmp316.not1225, label %for.body318.lr.ph, label %invoke.cont373
...
for.body318:                                      ; preds = %for.body318.lr.ph, %for.inc366
  %120 = phi i32 [ %119, %for.body318.lr.ph ], [ %144, %for.inc366 ]
  %indvars.iv1382 = phi i64 [ 0, %for.body318.lr.ph ], [ %indvars.iv.next1383, %for.inc366 ]
  %retval.191227 = phi i32 [ %retval.18, %for.body318.lr.ph ], [ %retval.21, %for.inc366 ]
  %121 = load i8, ptr %StdOutMode, align 8, !tbaa !104, !range !78, !noundef !79
  %tobool331.not = icmp eq i8 %121, 0
  %cmp333.not = icmp ne i64 %indvars.iv1382, 0
  %or.cond671 = or i1 %tobool422.not, %cmp333.not
  %or.cond1063 = select i1 %tobool331.not, i1 %or.cond671, i1 false
  br i1 %or.cond1063, label %if.then336, label %for.inc366

if.then336:                                       ; preds = %for.body318
  %122 = load ptr, ptr %_items.i.i895, align 8, !tbaa !12
  %arrayidx.i.i897 = getelementptr inbounds ptr, ptr %122, i64 %indvars.iv1382
  %123 = load ptr, ptr %arrayidx.i.i897, align 8, !tbaa !13
  %ArchivePath324 = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %123, i64 0, i32 1
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp) #18
...
invoke.cont338:                                   ; preds = %if.then336
  %124 = load ptr, ptr %ref.tmp, align 8, !tbaa !31
  %call343 = invoke noundef zeroext i1 @_ZN8NWindows5NFile5NFind18DoesFileOrDirExistEPKw(ptr noundef %124)
...
if.then344:                                       ; preds = %invoke.cont342
  ...
  %125 = load ptr, ptr %Message346, align 8, !tbaa !31
  store i32 0, ptr %125, align 4, !tbaa !32
  %126 = load i32, ptr %_capacity.i.i905, align 4, !tbaa !34
  %cmp.i.i906 = icmp eq i32 %126, 24
...
call.i.i.noexc924:                                ; preds = %if.end.i.i910
  %cmp3.i.i909 = icmp sgt i32 %126, 0
...
delete.notnull.i.i912:                            ; preds = %call.i.i.noexc924
  ...
  %127 = sext i32 %.pre.i911 to i64
  br label %if.end9.i.i915

if.end9.i.i915:                                   ; preds = %delete.notnull.i.i912, %call.i.i.noexc924
  %idxprom13.i.i913 = phi i64 [ %127, %delete.notnull.i.i912 ], [ 0, %call.i.i.noexc924 ]
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i916:     ; preds = %if.end9.i.i915, %if.then344
  %128 = phi ptr [ %125, %if.then344 ], [ %call.i.i925, %if.end9.i.i915 ]
  %incdec.ptr1.i.i920.3 = getelementptr inbounds i32, ptr %128, i64 4
  store <4 x i32> <i32 84, i32 104, i32 101, i32 32>, ptr %128, align 4, !tbaa !32
  %incdec.ptr1.i.i920.7 = getelementptr inbounds i32, ptr %128, i64 8
  store <4 x i32> <i32 102, i32 105, i32 108, i32 101>, ptr %incdec.ptr1.i.i920.3, align 4, !tbaa !32
  %incdec.ptr1.i.i920.11 = getelementptr inbounds i32, ptr %128, i64 12
  store <4 x i32> <i32 32, i32 97, i32 108, i32 114>, ptr %incdec.ptr1.i.i920.7, align 4, !tbaa !32
  %incdec.ptr1.i.i920.15 = getelementptr inbounds i32, ptr %128, i64 16
  store <4 x i32> <i32 101, i32 97, i32 100, i32 121>, ptr %incdec.ptr1.i.i920.11, align 4, !tbaa !32
  %incdec.ptr1.i.i920.19 = getelementptr inbounds i32, ptr %128, i64 20
...
if.end.i933:                                      ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i916
  ...
  %129 = load ptr, ptr %FileName349, align 8, !tbaa !31
  store i32 0, ptr %129, align 4, !tbaa !32
  %130 = load i32, ptr %_length.i929, align 8, !tbaa !41
  %add.i.i930 = add nsw i32 %130, 1
  %131 = load i32, ptr %_capacity.i.i931, align 4, !tbaa !34
  %cmp.i.i932 = icmp eq i32 %add.i.i930, %131
...
if.end.i.i936:                                    ; preds = %if.end.i933
  ...
  %133 = shl nuw nsw i64 %conv.i.i934, 2
  %134 = select i1 %132, i64 -1, i64 %133
  %call.i.i951 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %134) #19
          to label %call.i.i.noexc950 unwind label %lpad339

call.i.i.noexc950:                                ; preds = %if.end.i.i936
  %cmp3.i.i935 = icmp sgt i32 %131, 0
...
delete.notnull.i.i938:                            ; preds = %call.i.i.noexc950
  ...
  %135 = sext i32 %.pre.i937 to i64
  br label %if.end9.i.i941

if.end9.i.i941:                                   ; preds = %delete.notnull.i.i938, %call.i.i.noexc950
  %idxprom13.i.i939 = phi i64 [ %135, %delete.notnull.i.i938 ], [ 0, %call.i.i.noexc950 ]
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i942:     ; preds = %if.end9.i.i941, %if.end.i933
  %136 = phi ptr [ %129, %if.end.i933 ], [ %call.i.i951, %if.end9.i.i941 ]
  %137 = load ptr, ptr %ref.tmp, align 8, !tbaa !31
  br label %while.cond.i.i948

while.cond.i.i948:                                ; preds = %while.cond.i.i948, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i942
  %src.addr.0.i.i943 = phi ptr [ %137, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i942 ], [ %incdec.ptr.i.i945, %while.cond.i.i948 ]
  %dest.addr.0.i.i944 = phi ptr [ %136, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i942 ], [ %incdec.ptr1.i.i946, %while.cond.i.i948 ]
  %incdec.ptr.i.i945 = getelementptr inbounds i32, ptr %src.addr.0.i.i943, i64 1
  %138 = load i32, ptr %src.addr.0.i.i943, align 4, !tbaa !32
  %incdec.ptr1.i.i946 = getelementptr inbounds i32, ptr %dest.addr.0.i.i944, i64 1
  store i32 %138, ptr %dest.addr.0.i.i944, align 4, !tbaa !32
  %cmp.not.i.i947 = icmp eq i32 %138, 0
...
_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i949:         ; preds = %while.cond.i.i948
  %139 = load i32, ptr %_length.i929, align 8, !tbaa !41
  store i32 %139, ptr %_length.i.i928, align 8, !tbaa !41
  br label %cleanup353
...
lpad339:                                          ; preds = %if.end.i.i936, %if.end.i.i910, %invoke.cont338
  ...
  %isnull.i953 = icmp eq ptr %142, null
...
cleanup353:                                       ; preds = %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i949, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i916, %invoke.cont342
  %retval.20 = phi i32 [ %retval.191227, %invoke.cont342 ], [ -2147467259, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i916 ], [ -2147467259, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i949 ]
  %143 = load ptr, ptr %ref.tmp, align 8, !tbaa !31
  %isnull.i956 = icmp eq ptr %143, null
...
_ZN11CStringBaseIwED2Ev.exit958.for.inc366_crit_edge: ; preds = %_ZN11CStringBaseIwED2Ev.exit958
  %.pre1389 = load i32, ptr %_size.i894, align 4, !tbaa !5
  br label %for.inc366

for.inc366:                                       ; preds = %_ZN11CStringBaseIwED2Ev.exit958.for.inc366_crit_edge, %for.body318
  %144 = phi i32 [ %120, %for.body318 ], [ %.pre1389, %_ZN11CStringBaseIwED2Ev.exit958.for.inc366_crit_edge ]
  %retval.21 = phi i32 [ %retval.191227, %for.body318 ], [ %retval.20, %_ZN11CStringBaseIwED2Ev.exit958.for.inc366_crit_edge ]
  %indvars.iv.next1383 = add nuw nsw i64 %indvars.iv1382, 1
  %145 = sext i32 %144 to i64
  %cmp316.not = icmp slt i64 %indvars.iv.next1383, %145
  br i1 %cmp316.not, label %for.body318, label %invoke.cont373, !llvm.loop !132

invoke.cont373:                                   ; preds = %for.inc366, %if.end309
  %retval.231053 = phi i32 [ %retval.18, %if.end309 ], [ %retval.21, %for.inc366 ]
...
invoke.cont379:                                   ; preds = %invoke.cont373
  ...
  %146 = load i32, ptr %_size.i961, align 4, !tbaa !5
  %sub.i962 = add nsw i32 %146, -1
  %_items.i.i.i963 = getelementptr inbounds %class.CBaseRecordVector, ptr %arcLink, i64 0, i32 3
  %147 = load ptr, ptr %_items.i.i.i963, align 8, !tbaa !12
  %idxprom.i.i.i964 = sext i32 %sub.i962 to i64
  %arrayidx.i.i.i965 = getelementptr inbounds ptr, ptr %147, i64 %idxprom.i.i.i964
  %148 = load ptr, ptr %arrayidx.i.i.i965, align 8, !tbaa !13
  %call382 = invoke noundef i32 @_Z23EnumerateInArchiveItemsRKN9NWildcard7CCensorERK4CArcR13CObjectVectorI8CArcItemE(ptr noundef nonnull align 8 dereferenceable(32) %censor, ptr noundef nonnull align 8 dereferenceable(80) %148, ptr noundef nonnull align 8 dereferenceable(32) %arcItems)
...
cond.true:                                        ; preds = %invoke.cont381
  %150 = load i32, ptr %_size.i961, align 4, !tbaa !5
  %sub.i.i = add nsw i32 %150, -1
  %151 = load ptr, ptr %_items.i.i.i963, align 8, !tbaa !12
  %idxprom.i.i.i.i = sext i32 %sub.i.i to i64
  %arrayidx.i.i.i.i = getelementptr inbounds ptr, ptr %151, i64 %idxprom.i.i.i.i
  %152 = load ptr, ptr %arrayidx.i.i.i.i, align 8, !tbaa !13
  %153 = load ptr, ptr %152, align 8, !tbaa !89
  br label %cond.end

cond.end:                                         ; preds = %invoke.cont373, %cond.true
  %cond = phi ptr [ %153, %cond.true ], [ null, %invoke.cont373 ]
  %154 = load i32, ptr %_size.i894, align 4, !tbaa !5
  %cmp.not511.i = icmp sgt i32 %154, 0
...
for.body.lr.ph.i:                                 ; preds = %cond.end
  ...
  %155 = load ptr, ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV17CStdOutFileStream, i64 0, inrange i32 0, i64 3), align 8
  %156 = getelementptr inbounds i8, ptr %resultPath.i.i, i64 8
  ...
  %157 = load ptr, ptr getelementptr inbounds ({ [10 x ptr] }, ptr @_ZTV14COutFileStream, i64 0, inrange i32 0, i64 3), align 8
  ...
  %158 = load ptr, ptr getelementptr inbounds ({ [10 x ptr], [8 x ptr] }, ptr @_ZTV13CInFileStream, i64 0, inrange i32 0, i64 3), align 8
...
for.cond.i977:                                    ; preds = %call40.i.noexc
  ...
  %cmp.not.i = icmp slt i64 %indvars.iv.next.i, %160
...
for.body.i:                                       ; preds = %for.cond.i977, %for.body.lr.ph.i
  ...
  %161 = load ptr, ptr %_items.i.i.i968, align 8, !tbaa !12
  %arrayidx.i.i.i978 = getelementptr inbounds ptr, ptr %161, i64 %indvars.iv.i
  %162 = load ptr, ptr %arrayidx.i.i.i978, align 8, !tbaa !13
  %163 = load i8, ptr %StdOutMode, align 8, !tbaa !104, !range !78, !noundef !79
...
if.then.i:                                        ; preds = %for.body.i
  ...
  %call4.i1004 = invoke noundef i32 %164(ptr noundef nonnull align 8 dereferenceable(8) %callback, ptr noundef nonnull @.str.12, i1 noundef zeroext %cmp3.i)
          to label %call4.i.noexc unwind label %lpad393

call4.i.noexc:                                    ; preds = %if.then.i
  %cmp5.not.i = icmp eq i32 %call4.i1004, 0
  br i1 %cmp5.not.i, label %if.end22.i, label %cleanup485

if.else.i:                                        ; preds = %for.body.i
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp.i) #18
  %ArchivePath.i = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %162, i64 0, i32 1
...
.noexc:                                           ; preds = %if.else.i
  %165 = load ptr, ptr %ref.tmp.i, align 8, !tbaa !31
  %cmp9.i = icmp eq i64 %indvars.iv.i, 0
  %166 = load i8, ptr %UpdateArchiveItself, align 8
  %tobool10.not.i = icmp ne i8 %166, 0
  %or.cond.not.i979 = select i1 %cmp9.i, i1 %tobool10.not.i, i1 false
  %spec.select86.i = and i1 %cmp3.i, %or.cond.not.i979
  %vtable12.i = load ptr, ptr %callback, align 8, !tbaa !46
  %vfn13.i = getelementptr inbounds ptr, ptr %vtable12.i, i64 16
  %167 = load ptr, ptr %vfn13.i, align 8
  %call15.i = invoke noundef i32 %167(ptr noundef nonnull align 8 dereferenceable(8) %callback, ptr noundef %165, i1 noundef zeroext %spec.select86.i)
          to label %invoke.cont14.i unwind label %lpad.i983

invoke.cont14.i:                                  ; preds = %.noexc
  %168 = load ptr, ptr %ref.tmp.i, align 8, !tbaa !31
  %isnull.i.i980 = icmp eq ptr %168, null
  br i1 %isnull.i.i980, label %_ZN11CStringBaseIwED2Ev.exit.i982, label %delete.notnull.i.i981

delete.notnull.i.i981:                            ; preds = %invoke.cont14.i
  call void @_ZdaPv(ptr noundef nonnull %168) #20
  br label %_ZN11CStringBaseIwED2Ev.exit.i982

_ZN11CStringBaseIwED2Ev.exit.i982:                ; preds = %delete.notnull.i.i981, %invoke.cont14.i
...
lpad.i983:                                        ; preds = %.noexc
  %169 = landingpad { ptr, i32 }
          cleanup
  %170 = load ptr, ptr %ref.tmp.i, align 8, !tbaa !31
  %isnull.i87.i = icmp eq ptr %170, null
  br i1 %isnull.i87.i, label %_ZN11CStringBaseIwED2Ev.exit89.i, label %delete.notnull.i88.i

delete.notnull.i88.i:                             ; preds = %lpad.i983
  call void @_ZdaPv(ptr noundef nonnull %170) #20
  br label %_ZN11CStringBaseIwED2Ev.exit89.i

_ZN11CStringBaseIwED2Ev.exit89.i:                 ; preds = %delete.notnull.i88.i, %lpad.i983
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp.i) #18
  br label %ehcleanup486

if.end22.i:                                       ; preds = %_ZN11CStringBaseIwED2Ev.exit.i982, %call4.i.noexc
  %ActionSet.i = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %162, i64 0, i32 2
  %ArchivePath24.i = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %162, i64 0, i32 1
  %171 = load i8, ptr %OpenShareForWrite.i, align 8, !tbaa !134, !range !78, !noundef !79
  %172 = load i8, ptr %StdInMode, align 1, !tbaa !118, !range !78, !noundef !79
  %173 = load i8, ptr %StdOutMode, align 8, !tbaa !104, !range !78, !noundef !79
  %tobool28.not.i = icmp eq i8 %173, 0
  %174 = load i8, ptr %SfxMode81392, align 8, !tbaa !83, !range !78, !noundef !79
  %tobool29.not.i = icmp eq i8 %174, 0
...
if.then.i.i.i:                                    ; preds = %if.end22.i
  ...
  %call.i550.i.i = invoke noundef i32 %175(ptr noundef nonnull align 8 dereferenceable(8) %cond)
          to label %invoke.cont.i.i unwind label %lpad.i.i

invoke.cont.i.i:                                  ; preds = %if.then.i.i.i
  %vtable.i551.i.i = load ptr, ptr %cond, align 8, !tbaa !46
  %176 = load ptr, ptr %vtable.i551.i.i, align 8
  %call.i553.i.i = invoke noundef i32 %176(ptr noundef nonnull align 8 dereferenceable(8) %cond, ptr noundef nonnull align 4 dereferenceable(16) @IID_IOutArchive, ptr noundef nonnull %outArchive.i.i)
...
if.then.i556.i.i:                                 ; preds = %if.then.i556.i.loopexit.split-lp.i, %if.then.i556.i.loopexit.i
  ...
  %178 = load ptr, ptr %vfn.i555.i.i, align 8
  %call.i.i.i984 = invoke noundef i32 %178(ptr noundef nonnull align 8 dereferenceable(8) %cond)
...
if.then.i561.i.i:                                 ; preds = %invoke.cont6.i.i
  ...
  %181 = load ptr, ptr %vfn.i559.i.i, align 8
  %call.i560.i.i = invoke noundef i32 %181(ptr noundef nonnull align 8 dereferenceable(8) %cond)
...
if.else.i.i:                                      ; preds = %if.end22.i
  %184 = load i32, ptr %options, align 8, !tbaa !137
  %185 = load ptr, ptr %_items.i.i.i.i.i, align 8, !tbaa !12
  %idxprom.i.i.i.i.i = sext i32 %184 to i64
  %arrayidx.i.i.i.i.i = getelementptr inbounds ptr, ptr %185, i64 %idxprom.i.i.i.i.i
  %186 = load ptr, ptr %arrayidx.i.i.i.i.i, align 8, !tbaa !13
  %CreateOutArchive.i.i.i = getelementptr inbounds %struct.CArcInfoEx, ptr %186, i64 0, i32 3
  %187 = load ptr, ptr %CreateOutArchive.i.i.i, align 8, !tbaa !138
  %call2.i564.i.i = invoke noundef ptr %187()
          to label %call2.i.noexc.i.i unwind label %lpad10.i.i

call2.i.noexc.i.i:                                ; preds = %if.else.i.i
  %cmp.not.i.i.i.i985 = icmp eq ptr %call2.i564.i.i, null
  br i1 %cmp.not.i.i.i.i985, label %if.end.i.i.i.i, label %if.then.i.i.i.i
...
if.then.i.i.i.i:                                  ; preds = %call2.i.noexc.i.i
  ...
  %call.i.i565.i.i = invoke noundef i32 %188(ptr noundef nonnull align 8 dereferenceable(8) %call2.i564.i.i)
          to label %if.end.i.i.i.i unwind label %lpad10.i.i

if.end.i.i.i.i:                                   ; preds = %if.then.i.i.i.i, %call2.i.noexc.i.i
  %189 = load ptr, ptr %outArchive.i.i, align 8, !tbaa !135
  %tobool.not.i.i.i.i = icmp eq ptr %189, null
  br i1 %tobool.not.i.i.i.i, label %invoke.cont11.i.i, label %if.then2.i.i.i.i

if.then2.i.i.i.i:                                 ; preds = %if.end.i.i.i.i
  %vtable4.i.i.i.i = load ptr, ptr %189, align 8, !tbaa !46
  %vfn5.i.i.i.i = getelementptr inbounds ptr, ptr %vtable4.i.i.i.i, i64 2
  %190 = load ptr, ptr %vfn5.i.i.i.i, align 8
  %call6.i.i566.i.i = invoke noundef i32 %190(ptr noundef nonnull align 8 dereferenceable(8) %189)
...
if.end17.i.i:                                     ; preds = %if.end17thread-pre-split.i.i, %invoke.cont11.i.i
  %192 = phi ptr [ %.pr.i.i, %if.end17thread-pre-split.i.i ], [ %call2.i564.i.i, %invoke.cont11.i.i ]
  %cmp21.i.i = icmp eq ptr %192, null
...
if.end24.i.i:                                     ; preds = %if.end17.i.i
  ...
  %vtable.i.i = load ptr, ptr %192, align 8, !tbaa !46
  %vfn.i.i = getelementptr inbounds ptr, ptr %vtable.i.i, i64 6
  %194 = load ptr, ptr %vfn.i.i, align 8
  %call30.i.i = invoke noundef i32 %194(ptr noundef nonnull align 8 dereferenceable(8) %192, ptr noundef nonnull %value.i.i)
...
cleanup.cont36.i.i:                               ; preds = %invoke.cont29.i.i
  %196 = load i32, ptr %value.i.i, align 4, !tbaa !21
  %switch.i.i = icmp ult i32 %196, 3
...
sw.bb.i.i:                                        ; preds = %cleanup.cont36.i.i
  ...
  invoke void @_Z21GetUpdatePairInfoListRK9CDirItemsRK13CObjectVectorI8CArcItemEN13NFileTimeType5EEnumER13CRecordVectorI11CUpdatePairE(ptr noundef nonnull align 8 dereferenceable(128) %dirItems, ptr noundef nonnull align 8 dereferenceable(32) %arcItems, i32 noundef %196, ptr noundef nonnull align 8 dereferenceable(32) %updatePairs.i.i)
...
invoke.cont44.i.i:                                ; preds = %invoke.cont43.i.i
  ...
  %197 = load i32, ptr %_size.i.i.i, align 4, !tbaa !5
  %cmp48884.i.i = icmp sgt i32 %197, 0
  br i1 %cmp48884.i.i, label %for.body.lr.ph.i.i, label %for.cond.cleanup.i.i

for.body.lr.ph.i.i:                               ; preds = %invoke.cont44.i.i
  %198 = load ptr, ptr %_items.i.i90.i, align 8, !tbaa !12
  %wide.trip.count.i.i = zext i32 %197 to i64
  %xtraiter = and i64 %wide.trip.count.i.i, 3
  %199 = icmp ult i32 %197, 4
  br i1 %199, label %for.cond.cleanup.i.i.loopexit.unr-lcssa, label %for.body.lr.ph.i.i.new
...
for.cond.cleanup.i.i.loopexit.unr-lcssa:          ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  %indvars.iv.i.i987.unr = phi i64 [ 0, %for.body.lr.ph.i.i ], [ %indvars.iv.next.i.i989.3, %for.body.i.i ]
...
for.body.i.i.epil:                                ; preds = %for.cond.cleanup.i.i.loopexit.unr-lcssa, %for.body.i.i.epil
  %indvars.iv.i.i987.epil = phi i64 [ %indvars.iv.next.i.i989.epil, %for.body.i.i.epil ], [ %indvars.iv.i.i987.unr, %for.cond.cleanup.i.i.loopexit.unr-lcssa ]
  ...
  %arrayidx.i.i91.i.epil = getelementptr inbounds %struct.CUpdatePair2, ptr %198, i64 %indvars.iv.i.i987.epil
  %200 = load i8, ptr %arrayidx.i.i91.i.epil, align 4, !tbaa !139, !range !78, !noundef !79
  %inc.i.i988.epil = zext i8 %200 to i32
  %spec.select.i.i.epil = add i32 %numFiles.0886.i.i.epil, %inc.i.i988.epil
  %indvars.iv.next.i.i989.epil = add nuw nsw i64 %indvars.iv.i.i987.epil, 1
...
for.cond.cleanup.i.i:                             ; preds = %for.cond.cleanup.i.i.loopexit.unr-lcssa, %for.body.i.i.epil, %invoke.cont44.i.i
  ...
  %conv.i.i986 = zext i32 %numFiles.0.lcssa.i.i to i64
  %vtable58.i.i = load ptr, ptr %callback, align 8, !tbaa !46
  %vfn59.i.i = getelementptr inbounds ptr, ptr %vtable58.i.i, i64 5
  %201 = load ptr, ptr %vfn59.i.i, align 8
  %call62.i.i = invoke noundef i32 %201(ptr noundef nonnull align 8 dereferenceable(8) %callback, i64 noundef %conv.i.i986)
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i.new
  %indvars.iv.i.i987 = phi i64 [ 0, %for.body.lr.ph.i.i.new ], [ %indvars.iv.next.i.i989.3, %for.body.i.i ]
  ...
  %arrayidx.i.i91.i = getelementptr inbounds %struct.CUpdatePair2, ptr %198, i64 %indvars.iv.i.i987
  %203 = load i8, ptr %arrayidx.i.i91.i, align 4, !tbaa !139, !range !78, !noundef !79
  %inc.i.i988 = zext i8 %203 to i32
  %spec.select.i.i = add i32 %numFiles.0886.i.i, %inc.i.i988
  %indvars.iv.next.i.i989 = or i64 %indvars.iv.i.i987, 1
  %arrayidx.i.i91.i.1 = getelementptr inbounds %struct.CUpdatePair2, ptr %198, i64 %indvars.iv.next.i.i989
  %204 = load i8, ptr %arrayidx.i.i91.i.1, align 4, !tbaa !139, !range !78, !noundef !79
  %inc.i.i988.1 = zext i8 %204 to i32
  %spec.select.i.i.1 = add i32 %spec.select.i.i, %inc.i.i988.1
  %indvars.iv.next.i.i989.1 = or i64 %indvars.iv.i.i987, 2
  %arrayidx.i.i91.i.2 = getelementptr inbounds %struct.CUpdatePair2, ptr %198, i64 %indvars.iv.next.i.i989.1
  %205 = load i8, ptr %arrayidx.i.i91.i.2, align 4, !tbaa !139, !range !78, !noundef !79
  %inc.i.i988.2 = zext i8 %205 to i32
  %spec.select.i.i.2 = add i32 %spec.select.i.i.1, %inc.i.i988.2
  %indvars.iv.next.i.i989.2 = or i64 %indvars.iv.i.i987, 3
  %arrayidx.i.i91.i.3 = getelementptr inbounds %struct.CUpdatePair2, ptr %198, i64 %indvars.iv.next.i.i989.2
  %206 = load i8, ptr %arrayidx.i.i91.i.3, align 4, !tbaa !139, !range !78, !noundef !79
  %inc.i.i988.3 = zext i8 %206 to i32
  %spec.select.i.i.3 = add i32 %spec.select.i.i.2, %inc.i.i988.3
  %indvars.iv.next.i.i989.3 = add nuw nsw i64 %indvars.iv.i.i987, 4
...
invoke.cont74.i.i:                                ; preds = %invoke.cont71.i.i
  ...
  %208 = load ptr, ptr %vfn.i570.i.i, align 8
  %call.i571573.i.i = invoke noundef i32 %208(ptr noundef nonnull align 8 dereferenceable(8) %call72.i.i)
...
invoke.cont77.i.i:                                ; preds = %invoke.cont74.i.i
  ...
  store i8 %171, ptr %ShareForWrite.i.i, align 8, !tbaa !144
  %StdInMode.i.i = getelementptr inbounds %class.CArchiveUpdateCallback, ptr %call72.i.i, i64 0, i32 10
  store i8 %172, ptr %StdInMode.i.i, align 1, !tbaa !152
...
invoke.cont89.i.i:                                ; preds = %invoke.cont87.i.i
  %209 = load ptr, ptr %ref.tmp.i.i, align 8, !tbaa !31
  %call94.i.i = invoke noundef zeroext i1 @_ZN8NWindows5NFile10NDirectory17MyGetFullPathNameEPKwR11CStringBaseIwERi(ptr noundef %209, ptr noundef nonnull align 8 dereferenceable(16) %resultPath.i.i, ptr noundef nonnull align 4 dereferenceable(4) %pos.i.i)
          to label %invoke.cont93.i.i unwind label %lpad90.i.i

invoke.cont93.i.i:                                ; preds = %invoke.cont89.i.i
  %210 = load ptr, ptr %ref.tmp.i.i, align 8, !tbaa !31
  %isnull.i.i.i = icmp eq ptr %210, null
...
lpad90.i.i:                                       ; preds = %invoke.cont89.i.i
  %216 = landingpad { ptr, i32 }
          cleanup
  %217 = load ptr, ptr %ref.tmp.i.i, align 8, !tbaa !31
  %isnull.i576.i.i = icmp eq ptr %217, null
...
ehcleanup96.i.i:                                  ; preds = %delete.notnull.i577.i.i, %lpad90.i.i, %lpad88.i.i
  %.pn.i.i = phi { ptr, i32 } [ %215, %lpad88.i.i ], [ %216, %lpad90.i.i ], [ %216, %delete.notnull.i577.i.i ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp.i.i) #18
...
if.end100.i.i:                                    ; preds = %_ZN11CStringBaseIwED2Ev.exit.i.i
  ...
  %219 = load i32, ptr %pos.i.i, align 4, !tbaa !21
  invoke void @_ZNK11CStringBaseIwE3MidEii(ptr nonnull sret(%class.CStringBase) align 8 %ref.tmp101.i.i, ptr noundef nonnull align 8 dereferenceable(16) %resultPath.i.i, i32 noundef 0, i32 noundef %219)
          to label %invoke.cont103.i.i unwind label %lpad102.i.i

invoke.cont103.i.i:                               ; preds = %if.end100.i.i
  %220 = load ptr, ptr %ref.tmp101.i.i, align 8, !tbaa !31
  %call108.i.i = invoke noundef zeroext i1 @_ZN8NWindows5NFile10NDirectory22CreateComplexDirectoryEPKw(ptr noundef %220)
          to label %invoke.cont107.i.i unwind label %lpad104.i.i

invoke.cont107.i.i:                               ; preds = %invoke.cont103.i.i
  %221 = load ptr, ptr %ref.tmp101.i.i, align 8, !tbaa !31
  %isnull.i579.i.i = icmp eq ptr %221, null
...
_ZN11CStringBaseIwED2Ev.exit581.i.i:              ; preds = %delete.notnull.i580.i.i, %invoke.cont107.i.i
  ...
  %222 = load ptr, ptr %resultPath.i.i, align 8, !tbaa !31
  %isnull.i582.i.i = icmp eq ptr %222, null
...
lpad104.i.i:                                      ; preds = %invoke.cont103.i.i
  ...
  %isnull.i585.i.i = icmp eq ptr %225, null
  br i1 %isnull.i585.i.i, label %ehcleanup110.i.i, label %delete.notnull.i586.i.i

delete.notnull.i586.i.i:                          ; preds = %lpad104.i.i
  call void @_ZdaPv(ptr noundef nonnull %225) #20
  br label %ehcleanup110.i.i

ehcleanup110.i.i:                                 ; preds = %delete.notnull.i586.i.i, %lpad104.i.i, %lpad102.i.i
  %.pn514.i.i = phi { ptr, i32 } [ %223, %lpad102.i.i ], [ %224, %lpad104.i.i ], [ %224, %delete.notnull.i586.i.i ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp101.i.i) #18
  br label %ehcleanup111.i.i

ehcleanup111.i.i:                                 ; preds = %ehcleanup110.i.i, %lpad99.i.i, %ehcleanup96.i.i
  %.pn515.i.i = phi { ptr, i32 } [ %218, %lpad99.i.i ], [ %.pn514.i.i, %ehcleanup110.i.i ], [ %.pn.i.i, %ehcleanup96.i.i ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %pos.i.i) #18
  %226 = load ptr, ptr %resultPath.i.i, align 8, !tbaa !31
  %isnull.i588.i.i = icmp eq ptr %226, null
...
ehcleanup113.i.i:                                 ; preds = %delete.notnull.i589.i.i, %ehcleanup111.i.i, %lpad86.i.i
  %.pn515.pn.i.i = phi { ptr, i32 } [ %214, %lpad86.i.i ], [ %.pn515.i.i, %ehcleanup111.i.i ], [ %.pn515.i.i, %delete.notnull.i589.i.i ]
...
if.end114.i.i:                                    ; preds = %invoke.cont77.i.i
  %227 = load i32, ptr %_size.i, align 4, !tbaa !5
  %cmp116.i.i = icmp eq i32 %227, 0
...
if.end114.thread.i.i:                             ; preds = %delete.notnull.i583.i.i, %_ZN11CStringBaseIwED2Ev.exit581.i.i
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %resultPath.i.i) #18
  %228 = load i32, ptr %_size.i, align 4, !tbaa !5
  %cmp116844.i.i = icmp eq i32 %228, 0
...
invoke.cont121.i.i:                               ; preds = %if.then119.i.i
  %229 = getelementptr inbounds i8, ptr %call122.i.i, i64 8
  ...
  %call.i594597.i.i = invoke noundef i32 %155(ptr noundef nonnull align 8 dereferenceable(8) %call122.i.i)
...
invoke.cont129.i.i:                               ; preds = %if.else128.i.i
  %230 = getelementptr inbounds i8, ptr %call130.i.i, i64 8
  store i32 0, ptr %230, align 8, !tbaa !45
...
invoke.cont132.i.i:                               ; preds = %invoke.cont129.i.i
  ...
  %call.i601607.i.i = invoke noundef i32 %157(ptr noundef nonnull align 8 dereferenceable(8) %call130.i.i)
...
_ZN11CStringBaseIwEC2Ev.exit614.i.i:              ; preds = %invoke.cont134.i.i
  ...
  %Temp.i.i = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %162, i64 0, i32 1, i32 5
  %TempPostfix.i.i = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %162, i64 0, i32 1, i32 7
  %_length.i.i.i.i = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %162, i64 0, i32 1, i32 7, i32 1
  %_capacity.i.i616.i.i = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %162, i64 0, i32 1, i32 7, i32 2
...
for.body142.i.i:                                  ; preds = %if.end180.i.i, %_ZN11CStringBaseIwEC2Ev.exit614.i.i
  ...
  %233 = phi i8 [ %.pre.i.i, %_ZN11CStringBaseIwEC2Ev.exit614.i.i ], [ %272, %if.end180.i.i ]
  %i138.0887.i.i = phi i32 [ 0, %_ZN11CStringBaseIwEC2Ev.exit614.i.i ], [ %inc190.i.i, %if.end180.i.i ]
  %tobool143.not.i.i = icmp eq i8 %233, 0
...
invoke.cont148.i.i:                               ; preds = %if.then146.i.i
  ...
  %234 = load ptr, ptr %TempPostfix.i.i, align 8, !tbaa !31
...
for.cond.i.i.i.i:                                 ; preds = %for.cond.i.i.i.i, %invoke.cont148.i.i
  ...
  %arrayidx.i.i.i.i990 = getelementptr inbounds i32, ptr %s.i.i, i64 %indvars.iv.i.i.i.i
  %235 = load i32, ptr %arrayidx.i.i.i.i990, align 4, !tbaa !32
  %cmp.not.i.i615.i.i = icmp eq i32 %235, 0
...
_Z11MyStringLenIwEiPKT_.exit.i.i.i:               ; preds = %for.cond.i.i.i.i
  %236 = trunc i64 %indvars.iv.i.i.i.i to i32
  %add.i.i.i.i991 = add nsw i32 %236, 1
  %237 = load i32, ptr %_capacity.i.i616.i.i, align 4, !tbaa !34
  %cmp.i.i.i.i992 = icmp eq i32 %add.i.i.i.i991, %237
  br i1 %cmp.i.i.i.i992, label %while.cond.i.i.i.i1000.preheader, label %if.end.i.i617.i.i

if.end.i.i617.i.i:                                ; preds = %_Z11MyStringLenIwEiPKT_.exit.i.i.i
  %conv.i.i.i.i993 = zext i32 %add.i.i.i.i991 to i64
  %238 = icmp slt i32 %236, -1
  %239 = shl nuw nsw i64 %conv.i.i.i.i993, 2
  %240 = select i1 %238, i64 -1, i64 %239
  %call.i.i619.i.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %240) #19
          to label %call.i.i.noexc618.i.i unwind label %lpad147.i.i

call.i.i.noexc618.i.i:                            ; preds = %if.end.i.i617.i.i
  %cmp3.i.i.i.i = icmp sgt i32 %237, 0
  br i1 %cmp3.i.i.i.i, label %delete.notnull.i.i.i.i, label %if.end9.i.i.i.i994
...
delete.notnull.i.i.i.i:                           ; preds = %call.i.i.noexc618.i.i
  ...
  %241 = sext i32 %.pre.i.i.i to i64
  br label %if.end9.i.i.i.i994

if.end9.i.i.i.i994:                               ; preds = %delete.notnull.i.i.i.i, %call.i.i.noexc618.i.i
  %idxprom13.i.i.i.i = phi i64 [ %241, %delete.notnull.i.i.i.i ], [ 0, %call.i.i.noexc618.i.i ]
  ...
  store i32 %add.i.i.i.i991, ptr %_capacity.i.i616.i.i, align 4, !tbaa !34
  br label %while.cond.i.i.i.i1000.preheader

while.cond.i.i.i.i1000.preheader:                 ; preds = %if.end9.i.i.i.i994, %_Z11MyStringLenIwEiPKT_.exit.i.i.i
  %dest.addr.0.i.i.i.i997.ph = phi ptr [ %234, %_Z11MyStringLenIwEiPKT_.exit.i.i.i ], [ %call.i.i619.i.i, %if.end9.i.i.i.i994 ]
  br label %while.cond.i.i.i.i1000

while.cond.i.i.i.i1000:                           ; preds = %while.cond.i.i.i.i1000.preheader, %while.cond.i.i.i.i1000
  %src.addr.0.i.i.i.i996 = phi ptr [ %incdec.ptr.i.i.i.i998, %while.cond.i.i.i.i1000 ], [ %s.i.i, %while.cond.i.i.i.i1000.preheader ]
  %dest.addr.0.i.i.i.i997 = phi ptr [ %incdec.ptr1.i.i.i.i999, %while.cond.i.i.i.i1000 ], [ %dest.addr.0.i.i.i.i997.ph, %while.cond.i.i.i.i1000.preheader ]
  %incdec.ptr.i.i.i.i998 = getelementptr inbounds i32, ptr %src.addr.0.i.i.i.i996, i64 1
  %242 = load i32, ptr %src.addr.0.i.i.i.i996, align 4, !tbaa !32
  %incdec.ptr1.i.i.i.i999 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i.i997, i64 1
  store i32 %242, ptr %dest.addr.0.i.i.i.i997, align 4, !tbaa !32
  %cmp.not.i9.i.i.i = icmp eq i32 %242, 0
  br i1 %cmp.not.i9.i.i.i, label %invoke.cont150.i.i, label %while.cond.i.i.i.i1000, !llvm.loop !36

invoke.cont150.i.i:                               ; preds = %while.cond.i.i.i.i1000
  store i32 %236, ptr %_length.i.i.i.i, align 8, !tbaa !41
...
invoke.cont156.i.i:                               ; preds = %if.end153.i.i
  ...
  %244 = load i32, ptr %_length.i.i.i974, align 8, !tbaa !41
  %add.i.i621.i.i = add nsw i32 %244, 1
...
if.end.i.i626.i.i:                                ; preds = %invoke.cont156.i.i
  ...
  %246 = shl nuw nsw i64 %conv.i.i624.i.i, 2
  %247 = select i1 %245, i64 -1, i64 %246
  %call.i.i640.i.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %247) #19
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i632.i.i: ; preds = %if.end9.i.i631.i.i, %invoke.cont156.i.i
  ...
  %248 = load ptr, ptr %ref.tmp154.i.i, align 8, !tbaa !31
...
while.cond.i.i638.i.i:                            ; preds = %while.cond.i.i638.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i632.i.i
  %src.addr.0.i.i633.i.i = phi ptr [ %248, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i632.i.i ], [ %incdec.ptr.i.i635.i.i, %while.cond.i.i638.i.i ]
  ...
  %249 = load i32, ptr %src.addr.0.i.i633.i.i, align 4, !tbaa !32
  %incdec.ptr1.i.i636.i.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i634.i.i, i64 1
  store i32 %249, ptr %dest.addr.0.i.i634.i.i, align 4, !tbaa !32
  %cmp.not.i.i637.i.i = icmp eq i32 %249, 0
...
invoke.cont158.i.i:                               ; preds = %while.cond.i.i638.i.i
  %250 = load i32, ptr %_length.i.i.i974, align 8, !tbaa !41
  %isnull.i641.i.i = icmp eq ptr %248, null
...
lpad157.i.i:                                      ; preds = %if.end.i.i626.i.i
  ...
  %isnull.i644.i.i = icmp eq ptr %253, null
...
ehcleanup161.i.i:                                 ; preds = %delete.notnull.i645.i.i, %lpad157.i.i, %lpad155.i.i
  %.pn532.i.i = phi { ptr, i32 } [ %251, %lpad155.i.i ], [ %252, %lpad157.i.i ], [ %252, %delete.notnull.i645.i.i ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp154.i.i) #18
  br label %delete.notnull.i684.i.i
...
invoke.cont165.i.i:                               ; preds = %if.else162.i.i
  store i32 0, ptr %call.i.i668.i488.i, align 4, !tbaa !32
  %254 = load i32, ptr %_length.i648.i.i, align 8, !tbaa !41
  %add.i.i649.i.i = add nsw i32 %254, 1
...
if.end.i.i654.i.i:                                ; preds = %invoke.cont165.i.i
  ...
  %256 = shl nuw nsw i64 %conv.i.i652.i.i, 2
  %257 = select i1 %255, i64 -1, i64 %256
  %call.i.i668.i.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %257) #19
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i660.i.i: ; preds = %if.end9.i.i659.i.i, %invoke.cont165.i.i
  ...
  %258 = load ptr, ptr %ref.tmp163.i.i, align 8, !tbaa !31
...
while.cond.i.i666.i.i:                            ; preds = %while.cond.i.i666.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i660.i.i
  %src.addr.0.i.i661.i.i = phi ptr [ %258, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i660.i.i ], [ %incdec.ptr.i.i663.i.i, %while.cond.i.i666.i.i ]
  ...
  %259 = load i32, ptr %src.addr.0.i.i661.i.i, align 4, !tbaa !32
  %incdec.ptr1.i.i664.i.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i662.i.i, i64 1
  store i32 %259, ptr %dest.addr.0.i.i662.i.i, align 4, !tbaa !32
  %cmp.not.i.i665.i.i = icmp eq i32 %259, 0
...
invoke.cont167.i.i:                               ; preds = %while.cond.i.i666.i.i
  %260 = load i32, ptr %_length.i648.i.i, align 8, !tbaa !41
  %isnull.i670.i.i = icmp eq ptr %258, null
...
lpad166.i.i:                                      ; preds = %if.end.i.i654.i.i
  ...
  %isnull.i673.i.i = icmp eq ptr %263, null
...
ehcleanup170.i.i:                                 ; preds = %delete.notnull.i674.i.i, %lpad166.i.i, %lpad164.i.i
  %.pn530.i.i = phi { ptr, i32 } [ %261, %lpad164.i.i ], [ %262, %lpad166.i.i ], [ %262, %delete.notnull.i674.i.i ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp163.i.i) #18
  br label %delete.notnull.i684.i.i
...
if.end171.i.i:                                    ; preds = %_ZN11CStringBaseIwED2Ev.exit672.i.i, %_ZN11CStringBaseIwED2Ev.exit643.i.i
  ...
  %.pre.i655.i475.i = phi i32 [ %260, %_ZN11CStringBaseIwED2Ev.exit672.i.i ], [ %250, %_ZN11CStringBaseIwED2Ev.exit643.i.i ]
...
call.i254.noexc.i:                                ; preds = %if.then177.i.i
  ...
  %264 = icmp slt i32 %.pre.i655.i475.i, -1
  %265 = shl nuw nsw i64 %conv.i.i.i258.i, 2
  %266 = select i1 %264, i64 -1, i64 %265
  %call.i.i4.i.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %266) #19
...
while.cond.i.i.i267.i:                            ; preds = %call.i.i.noexc.i.i, %while.cond.i.i.i267.i
  ...
  %267 = load i32, ptr %src.addr.0.i.i.i262.i, align 4, !tbaa !32
  %incdec.ptr1.i.i.i265.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i263.i, i64 1
  store i32 %267, ptr %dest.addr.0.i.i.i263.i, align 4, !tbaa !32
  %cmp.not.i.i.i266.i = icmp eq i32 %267, 0
...
_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit.i: ; preds = %invoke.cont.i273.i
  %269 = load ptr, ptr %_items.i.i269.i, align 8, !tbaa !12
  %270 = load i32, ptr %_size.i.i270.i, align 4, !tbaa !5
  %idxprom.i.i271.i = sext i32 %270 to i64
  %arrayidx.i.i272.i = getelementptr inbounds ptr, ptr %269, i64 %idxprom.i.i271.i
  store ptr %call.i254275.i, ptr %arrayidx.i.i272.i, align 8, !tbaa !13
  %inc.i.i.i = add nsw i32 %270, 1
...
if.end180.i.i:                                    ; preds = %invoke.cont175.i.i
  ...
  %271 = load i32, ptr %call.i678.i.i, align 4, !tbaa !21
  %cmp182.not.i.i = icmp ne i32 %271, 17
  %272 = load i8, ptr %Temp.i.i, align 8
  %tobool186.not.i.i = icmp eq i8 %272, 0
...
if.then195.i.i:                                   ; preds = %if.end180.i.i
  store i32 %271, ptr %errorInfo, align 8, !tbaa !105
  store i32 0, ptr %_length.i.i229.i, align 8, !tbaa !41
  %273 = load ptr, ptr %FileName.i.i, align 8, !tbaa !31
  store i32 0, ptr %273, align 4, !tbaa !32
  %add.i.i231.i = add nsw i32 %.pre.i655.i475.i, 1
  %274 = load i32, ptr %_capacity.i.i232.i, align 4, !tbaa !34
  %cmp.i.i233.i = icmp eq i32 %add.i.i231.i, %274
...
if.end.i.i238.i:                                  ; preds = %if.then195.i.i
  ...
  %275 = icmp slt i32 %.pre.i655.i475.i, -1
  %276 = shl nuw nsw i64 %conv.i.i235.i, 2
  %277 = select i1 %275, i64 -1, i64 %276
  %call.i.i236252.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %277) #19
          to label %call.i.i236.noexc.i unwind label %lpad197.i.i

call.i.i236.noexc.i:                              ; preds = %if.end.i.i238.i
  %cmp3.i.i237.i = icmp sgt i32 %274, 0
...
delete.notnull.i.i240.i:                          ; preds = %call.i.i236.noexc.i
  ...
  %278 = sext i32 %.pre.i239.i to i64
  br label %if.end9.i.i243.i

if.end9.i.i243.i:                                 ; preds = %delete.notnull.i.i240.i, %call.i.i236.noexc.i
  %idxprom13.i.i241.i = phi i64 [ %278, %delete.notnull.i.i240.i ], [ 0, %call.i.i236.noexc.i ]
...
while.cond.i.i250.i.preheader:                    ; preds = %if.end9.i.i243.i, %if.then195.i.i
  %dest.addr.0.i.i246.i.ph = phi ptr [ %273, %if.then195.i.i ], [ %call.i.i236252.i, %if.end9.i.i243.i ]
...
while.cond.i.i250.i:                              ; preds = %while.cond.i.i250.i.preheader, %while.cond.i.i250.i
  ...
  %279 = load i32, ptr %src.addr.0.i.i245.i, align 4, !tbaa !32
  %incdec.ptr1.i.i248.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i246.i, i64 1
  store i32 %279, ptr %dest.addr.0.i.i246.i, align 4, !tbaa !32
  %cmp.not.i.i249.i = icmp eq i32 %279, 0
...
_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i251.i:       ; preds = %while.cond.i.i250.i
  ...
  %280 = load ptr, ptr %Message.i.i, align 8, !tbaa !31
  store i32 0, ptr %280, align 4, !tbaa !32
  %281 = load i32, ptr %_capacity.i.i206.i, align 4, !tbaa !34
  %cmp.i.i207.i = icmp eq i32 %281, 23
...
call.i.i210.noexc.i:                              ; preds = %if.end.i.i212.i
  %cmp3.i.i211.i = icmp sgt i32 %281, 0
...
delete.notnull.i.i214.i:                          ; preds = %call.i.i210.noexc.i
  ...
  %282 = sext i32 %.pre.i213.i to i64
  br label %if.end9.i.i217.i

if.end9.i.i217.i:                                 ; preds = %delete.notnull.i.i214.i, %call.i.i210.noexc.i
  %idxprom13.i.i215.i = phi i64 [ %282, %delete.notnull.i.i214.i ], [ 0, %call.i.i210.noexc.i ]
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i218.i:   ; preds = %if.end9.i.i217.i, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i251.i
  %283 = phi ptr [ %280, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i251.i ], [ %call.i.i210226.i, %if.end9.i.i217.i ]
  %incdec.ptr1.i.i222.3.i = getelementptr inbounds i32, ptr %283, i64 4
  store <4 x i32> <i32 55, i32 45, i32 90, i32 105>, ptr %283, align 4, !tbaa !32
  %incdec.ptr1.i.i222.7.i = getelementptr inbounds i32, ptr %283, i64 8
  store <4 x i32> <i32 112, i32 32, i32 99, i32 97>, ptr %incdec.ptr1.i.i222.3.i, align 4, !tbaa !32
  %incdec.ptr1.i.i222.11.i = getelementptr inbounds i32, ptr %283, i64 12
  store <4 x i32> <i32 110, i32 110, i32 111, i32 116>, ptr %incdec.ptr1.i.i222.7.i, align 4, !tbaa !32
  %incdec.ptr1.i.i222.15.i = getelementptr inbounds i32, ptr %283, i64 16
  store <4 x i32> <i32 32, i32 111, i32 112, i32 101>, ptr %incdec.ptr1.i.i222.11.i, align 4, !tbaa !32
  %incdec.ptr1.i.i222.19.i = getelementptr inbounds i32, ptr %283, i64 20
  store <4 x i32> <i32 110, i32 32, i32 102, i32 105>, ptr %incdec.ptr1.i.i222.15.i, align 4, !tbaa !32
  %incdec.ptr1.i.i222.20.i = getelementptr inbounds i32, ptr %283, i64 21
  store i32 108, ptr %incdec.ptr1.i.i222.19.i, align 4, !tbaa !32
  %incdec.ptr1.i.i222.21.i = getelementptr inbounds i32, ptr %283, i64 22
...
delete.notnull.i684.i.i:                          ; preds = %lpad197.i.i, %lpad172.loopexit.split-lp.i.i, %lpad172.loopexit.i.i, %lpad.i274.i, %ehcleanup170.i.i, %ehcleanup161.i.i, %lpad147.i.i
  ...
  %.pn534.i.i = phi { ptr, i32 } [ %lpad.loopexit.split-lp.i.i, %lpad172.loopexit.split-lp.i.i ], [ %268, %lpad.i274.i ], [ %284, %lpad197.i.i ], [ %lpad.loopexit.i.i, %lpad172.loopexit.i.i ], [ %.pn530.i.i, %ehcleanup170.i.i ], [ %.pn532.i.i, %ehcleanup161.i.i ], [ %243, %lpad147.i.i ]
...
invoke.cont216.i.i:                               ; preds = %if.end215.i.i
  %285 = getelementptr inbounds i8, ptr %call217.i.i, i64 8
  store i32 0, ptr %285, align 8, !tbaa !45
...
invoke.cont219.i.i:                               ; preds = %invoke.cont216.i.i
  ...
  store i32 1, ptr %285, align 8, !tbaa !45
...
.noexc.i:                                         ; preds = %invoke.cont219.i.i
  %287 = load i32, ptr %_size.i, align 4, !tbaa !5
  %_size.i9.i.i.i = getelementptr inbounds %class.COutMultiVolStream, ptr %call217.i.i, i64 0, i32 7, i32 0, i32 2
  %288 = load i32, ptr %_size.i9.i.i.i, align 4, !tbaa !5
  %add.i.i185.i = add nsw i32 %288, %287
...
.noexc189.i:                                      ; preds = %.noexc.i
  %cmp14.i.i.i = icmp sgt i32 %287, 0
...
for.body.lr.ph.i.i.i:                             ; preds = %.noexc189.i
  ...
  %wide.trip.count.i.i.i = zext i32 %287 to i64
...
for.body.i.i.i:                                   ; preds = %.noexc190.i, %for.body.lr.ph.i.i.i
  ...
  %289 = load ptr, ptr %_items.i.i.i.i972, align 8, !tbaa !12
  %arrayidx.i.i.i187.i = getelementptr inbounds i64, ptr %289, i64 %indvars.iv.i.i186.i
  %290 = load i64, ptr %arrayidx.i.i.i187.i, align 8, !tbaa !60
...
.noexc190.i:                                      ; preds = %for.body.i.i.i
  %291 = load ptr, ptr %_items.i10.i.i.i, align 8, !tbaa !12
  %292 = load i32, ptr %_size.i9.i.i.i, align 4, !tbaa !5
  %idxprom.i12.i.i.i = sext i32 %292 to i64
  %arrayidx.i13.i.i.i = getelementptr inbounds i64, ptr %291, i64 %idxprom.i12.i.i.i
  store i64 %290, ptr %arrayidx.i13.i.i.i, align 8, !tbaa !60
  %inc.i.i.i.i = add nsw i32 %292, 1
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i176.i:   ; preds = %if.end9.i.i175.i
  ...
  %293 = load i32, ptr %_length2.i.i.i973, align 8, !tbaa !41, !noalias !159
  %add.i.i.i147.i = add nsw i32 %293, 1
...
if.end9.i.i.i151.i:                               ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i176.i
  ...
  %295 = shl nuw nsw i64 %conv.i.i.i150.i, 2
  %296 = select i1 %294, i64 -1, i64 %295
  %call.i.i.i164.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %296) #19
          to label %call.i.i.i.noexc.i1001 unwind label %lpad232.i.i

call.i.i.i.noexc.i1001:                           ; preds = %if.end9.i.i.i151.i
  store i32 0, ptr %call.i.i.i164.i, align 4, !tbaa !32, !noalias !159
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i152.i

_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i152.i: ; preds = %call.i.i.i.noexc.i1001, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i176.i
  %ref.tmp225.i.sroa.0.1.i = phi ptr [ null, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i176.i ], [ %call.i.i.i164.i, %call.i.i.i.noexc.i1001 ]
  %297 = load ptr, ptr %ref.tmp226.i.i, align 8, !tbaa !31, !noalias !159
...
while.cond.i.i.i158.i:                            ; preds = %while.cond.i.i.i158.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i152.i
  %src.addr.0.i.i.i153.i = phi ptr [ %297, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i152.i ], [ %incdec.ptr.i.i.i155.i, %while.cond.i.i.i158.i ]
  ...
  %298 = load i32, ptr %src.addr.0.i.i.i153.i, align 4, !tbaa !32, !noalias !159
  %incdec.ptr1.i.i.i156.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i154.i, i64 1
  store i32 %298, ptr %dest.addr.0.i.i.i154.i, align 4, !tbaa !32, !noalias !159
  %cmp.not.i.i.i157.i = icmp eq i32 %298, 0
...
if.end.i.i290.i:                                  ; preds = %while.cond.i.i.i158.i
  %cmp4.i.i.i = icmp sgt i32 %293, 63
  %div24.i.i.i = lshr i32 %add.i.i.i147.i, 1
  %cmp8.i.i.i = icmp sgt i32 %293, 7
  ...
  %cmp.i.i.i289.i = icmp eq i32 %add18.i.i.i, %293
...
if.end.i.i.i293.i:                                ; preds = %if.end.i.i290.i
  ...
  %299 = icmp slt i32 %add18.i.i.i, -1
  %300 = shl nuw nsw i64 %conv.i.i.i291.i, 2
  %301 = select i1 %299, i64 -1, i64 %300
  %call.i.i.i309.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %301) #19
          to label %call.i.i.i.noexc308.i unwind label %lpad.i161.i

call.i.i.i.noexc308.i:                            ; preds = %if.end.i.i.i293.i
  %cmp3.i.i.i292.i = icmp sgt i32 %293, -1
...
for.cond.preheader.i.i.i.i:                       ; preds = %call.i.i.i.noexc308.i
  %cmp522.i.i.i.not.i = icmp eq i32 %293, 0
...
for.body.lr.ph.i.i.i.i:                           ; preds = %for.cond.preheader.i.i.i.i
  ...
  %302 = shl nuw nsw i64 %wide.trip.count.i.i.i.i, 2
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %call.i.i.i309.i, ptr align 4 %ref.tmp225.i.sroa.0.1.i, i64 %302, i1 false), !tbaa !32
...
if.end9.i.i.i301.i:                               ; preds = %delete.notnull.i.i.i298.i, %for.cond.cleanup.i.i.i.i, %call.i.i.i.noexc308.i
  %idxprom13.i.i.i299.i = sext i32 %293 to i64
...
_ZN11CStringBaseIwE10GrowLengthEi.exit.i.i:       ; preds = %if.end9.i.i.i301.i, %if.end.i.i290._ZN11CStringBaseIwE10GrowLengthEi.exit.i_crit_edge.i
  %idx.ext.i.pre-phi.i = phi i64 [ %.pre.i1002, %if.end.i.i290._ZN11CStringBaseIwE10GrowLengthEi.exit.i_crit_edge.i ], [ %idxprom13.i.i.i299.i, %if.end9.i.i.i301.i ]
...
while.cond.i.i306.i:                              ; preds = %while.cond.i.i306.i, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i.i
  ...
  %303 = load i32, ptr %src.addr.0.i.i302.i, align 4, !tbaa !32
  %incdec.ptr1.i.i305.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i303.i, i64 1
  store i32 %303, ptr %dest.addr.0.i.i303.i, align 4, !tbaa !32
  %cmp.not.i8.i.i = icmp eq i32 %303, 0
...
invoke.cont233.i.i:                               ; preds = %while.cond.i.i306.i
  ...
  %305 = load ptr, ptr %Prefix.i195.i, align 8, !tbaa !31
  store i32 0, ptr %305, align 4, !tbaa !32
  %add.i.i124.i = add nsw i32 %293, 2
  %306 = load i32, ptr %_capacity.i.i197.i, align 4, !tbaa !34
  %cmp.i.i126.i = icmp eq i32 %add.i.i124.i, %306
...
if.end.i.i131.i:                                  ; preds = %invoke.cont233.i.i
  ...
  %307 = icmp slt i32 %293, -2
  %308 = shl nuw nsw i64 %conv.i.i128.i, 2
  %309 = select i1 %307, i64 -1, i64 %308
  %call.i.i129145.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %309) #19
          to label %call.i.i129.noexc.i unwind label %lpad234.i.i

call.i.i129.noexc.i:                              ; preds = %if.end.i.i131.i
  %cmp3.i.i130.i = icmp sgt i32 %306, 0
...
delete.notnull.i.i133.i:                          ; preds = %call.i.i129.noexc.i
  ...
  %310 = sext i32 %.pre.i132.i to i64
  br label %if.end9.i.i136.i

if.end9.i.i136.i:                                 ; preds = %delete.notnull.i.i133.i, %call.i.i129.noexc.i
  %idxprom13.i.i134.i = phi i64 [ %310, %delete.notnull.i.i133.i ], [ 0, %call.i.i129.noexc.i ]
...
while.cond.i.i143.i.preheader:                    ; preds = %if.end9.i.i136.i, %invoke.cont233.i.i
  %dest.addr.0.i.i139.i.ph = phi ptr [ %305, %invoke.cont233.i.i ], [ %call.i.i129145.i, %if.end9.i.i136.i ]
...
while.cond.i.i143.i:                              ; preds = %while.cond.i.i143.i.preheader, %while.cond.i.i143.i
  ...
  %311 = load i32, ptr %src.addr.0.i.i138.i, align 4, !tbaa !32
  %incdec.ptr1.i.i141.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i139.i, i64 1
  store i32 %311, ptr %dest.addr.0.i.i139.i, align 4, !tbaa !32
  %cmp.not.i.i142.i = icmp eq i32 %311, 0
...
_ZN11CStringBaseIwED2Ev.exit703.i.i:              ; preds = %delete.notnull.i699.i.i, %invoke.cont235.i.i
  ...
  %312 = load ptr, ptr %ref.tmp226.i.i, align 8, !tbaa !31
  %isnull.i704.i.i = icmp eq ptr %312, null
...
delete.notnull.i711.i.i:                          ; preds = %delete.notnull.i708.i.i, %lpad234.i.i, %lpad232.i.i, %delete.notnull.i.i162.i, %lpad.i161.i
  %.pn519.i.i = phi { ptr, i32 } [ %316, %lpad234.i.i ], [ %316, %delete.notnull.i708.i.i ], [ %315, %lpad232.i.i ], [ %304, %delete.notnull.i.i162.i ], [ %304, %lpad.i161.i ]
  call void @_ZdaPv(ptr noundef nonnull %call.i.i174184.i) #20
  br label %ehcleanup239.i.i

ehcleanup239.i.i:                                 ; preds = %delete.notnull.i711.i.i, %lpad230.i.i
  %.pn519.pn.i.i = phi { ptr, i32 } [ %314, %lpad230.i.i ], [ %.pn519.i.i, %delete.notnull.i711.i.i ]
  %317 = load ptr, ptr %ref.tmp226.i.i, align 8, !tbaa !31
  %isnull.i713.i.i = icmp eq ptr %317, null
...
ehcleanup241.i.i:                                 ; preds = %delete.notnull.i714.i.i, %ehcleanup239.i.i, %lpad227.i.i
  %.pn519.pn.pn.i.i = phi { ptr, i32 } [ %313, %lpad227.i.i ], [ %.pn519.pn.i.i, %ehcleanup239.i.i ], [ %.pn519.pn.i.i, %delete.notnull.i714.i.i ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp226.i.i) #18
  br label %if.then.i804.i.i
...
if.end244.i.i:                                    ; preds = %_ZN11CStringBaseIwED2Ev.exit706.i.i, %_ZN11CStringBaseIwED2Ev.exit682.i.i, %invoke.cont121.i.i
  ...
  %318 = load ptr, ptr %outArchive.i.i, align 8, !tbaa !135
  %call250.i.i = invoke noundef i32 @_Z13SetPropertiesP8IUnknownRK13CObjectVectorI9CPropertyE(ptr noundef %318, ptr noundef nonnull align 8 dereferenceable(32) %Properties.i.i)
...
invoke.cont261.i.i:                               ; preds = %if.then259.i.i
  %320 = getelementptr inbounds i8, ptr %call262.i.i, i64 8
  %321 = getelementptr inbounds i8, ptr %call262.i.i, i64 16
  store i32 0, ptr %321, align 8, !tbaa !45
  ...
  store ptr getelementptr inbounds ({ [10 x ptr], [8 x ptr] }, ptr @_ZTV13CInFileStream, i64 0, inrange i32 1, i64 2), ptr %320, align 8, !tbaa !46
...
invoke.cont264.i.i:                               ; preds = %invoke.cont261.i.i
  ...
  %call.i718720.i.i = invoke noundef i32 %158(ptr noundef nonnull align 8 dereferenceable(8) %call262.i.i)
          to label %invoke.cont267.i.i unwind label %lpad266.i.i

invoke.cont267.i.i:                               ; preds = %invoke.cont264.i.i
  %322 = load ptr, ptr %SfxModule.i, align 8, !tbaa !31
  %call272.i.i = invoke noundef zeroext i1 @_ZN13CInFileStream4OpenEPKw(ptr noundef nonnull align 8 dereferenceable(1112) %call262.i.i, ptr noundef %322)
...
if.then273.i.i:                                   ; preds = %invoke.cont271.i.i
  ...
  %323 = load i32, ptr %call.i721.i.i, align 4, !tbaa !21
  store i32 %323, ptr %errorInfo, align 8, !tbaa !105
  store i32 0, ptr %_length.i.i199.i, align 8, !tbaa !41
  %324 = load ptr, ptr %Message.i.i, align 8, !tbaa !31
  store i32 0, ptr %324, align 4, !tbaa !32
  %325 = load i32, ptr %_capacity.i.i206.i, align 4, !tbaa !34
  %cmp.i.i103.i = icmp eq i32 %325, 29
...
call.i.i105.noexc.i:                              ; preds = %if.end.i.i107.i
  %cmp3.i.i106.i = icmp sgt i32 %325, 0
...
delete.notnull.i.i109.i:                          ; preds = %call.i.i105.noexc.i
  ...
  %326 = sext i32 %.pre.i108.i to i64
  br label %if.end9.i.i112.i

if.end9.i.i112.i:                                 ; preds = %delete.notnull.i.i109.i, %call.i.i105.noexc.i
  %idxprom13.i.i110.i = phi i64 [ %326, %delete.notnull.i.i109.i ], [ 0, %call.i.i105.noexc.i ]
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i113.i:   ; preds = %if.end9.i.i112.i, %if.then273.i.i
  %327 = phi ptr [ %324, %if.then273.i.i ], [ %call.i.i105120.i, %if.end9.i.i112.i ]
  %incdec.ptr1.i.i117.3.i = getelementptr inbounds i32, ptr %327, i64 4
  store <4 x i32> <i32 55, i32 45, i32 90, i32 105>, ptr %327, align 4, !tbaa !32
  %incdec.ptr1.i.i117.7.i = getelementptr inbounds i32, ptr %327, i64 8
  store <4 x i32> <i32 112, i32 32, i32 99, i32 97>, ptr %incdec.ptr1.i.i117.3.i, align 4, !tbaa !32
  %incdec.ptr1.i.i117.11.i = getelementptr inbounds i32, ptr %327, i64 12
  store <4 x i32> <i32 110, i32 110, i32 111, i32 116>, ptr %incdec.ptr1.i.i117.7.i, align 4, !tbaa !32
  %incdec.ptr1.i.i117.15.i = getelementptr inbounds i32, ptr %327, i64 16
  store <4 x i32> <i32 32, i32 111, i32 112, i32 101>, ptr %incdec.ptr1.i.i117.11.i, align 4, !tbaa !32
  %incdec.ptr1.i.i117.19.i = getelementptr inbounds i32, ptr %327, i64 20
  store <4 x i32> <i32 110, i32 32, i32 83, i32 70>, ptr %incdec.ptr1.i.i117.15.i, align 4, !tbaa !32
  %incdec.ptr1.i.i117.23.i = getelementptr inbounds i32, ptr %327, i64 24
  store <4 x i32> <i32 88, i32 32, i32 109, i32 111>, ptr %incdec.ptr1.i.i117.19.i, align 4, !tbaa !32
  %incdec.ptr1.i.i117.27.i = getelementptr inbounds i32, ptr %327, i64 28
  ...
  br i1 %cmp.i.i975, label %if.then.i770.i.i, label %if.end.i.i1003

if.end.i.i1003:                                   ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i113.i
  store i32 0, ptr %_length.i.i229.i, align 8, !tbaa !41
  %328 = load ptr, ptr %FileName.i.i, align 8, !tbaa !31
  store i32 0, ptr %328, align 4, !tbaa !32
  %329 = load i32, ptr %_length.i.i976, align 8, !tbaa !41
  %add.i.i.i = add nsw i32 %329, 1
  %330 = load i32, ptr %_capacity.i.i232.i, align 4, !tbaa !34
  %cmp.i.i.i = icmp eq i32 %add.i.i.i, %330
  br i1 %cmp.i.i.i, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i, label %if.end.i.i.i

if.end.i.i.i:                                     ; preds = %if.end.i.i1003
  %conv.i.i.i = zext i32 %add.i.i.i to i64
  %331 = icmp slt i32 %329, -1
  %332 = shl nuw nsw i64 %conv.i.i.i, 2
  %333 = select i1 %331, i64 -1, i64 %332
  %call.i.i9497.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %333) #19
          to label %call.i.i94.noexc.i unwind label %lpad268.i.i

call.i.i94.noexc.i:                               ; preds = %if.end.i.i.i
  %cmp3.i.i.i = icmp sgt i32 %330, 0
...
delete.notnull.i.i96.i:                           ; preds = %call.i.i94.noexc.i
  ...
  %334 = sext i32 %.pre.i95.i to i64
  br label %if.end9.i.i.i

if.end9.i.i.i:                                    ; preds = %delete.notnull.i.i96.i, %call.i.i94.noexc.i
  %idxprom13.i.i.i = phi i64 [ %334, %delete.notnull.i.i96.i ], [ 0, %call.i.i94.noexc.i ]
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i:      ; preds = %if.end9.i.i.i, %if.end.i.i1003
  %335 = phi ptr [ %328, %if.end.i.i1003 ], [ %call.i.i9497.i, %if.end9.i.i.i ]
  %336 = load ptr, ptr %SfxModule.i, align 8, !tbaa !31
  br label %while.cond.i.i.i

while.cond.i.i.i:                                 ; preds = %while.cond.i.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i
  %src.addr.0.i.i.i = phi ptr [ %336, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i ], [ %incdec.ptr.i.i.i, %while.cond.i.i.i ]
  %dest.addr.0.i.i.i = phi ptr [ %335, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i ], [ %incdec.ptr1.i.i.i, %while.cond.i.i.i ]
  %incdec.ptr.i.i.i = getelementptr inbounds i32, ptr %src.addr.0.i.i.i, i64 1
  %337 = load i32, ptr %src.addr.0.i.i.i, align 4, !tbaa !32
  %incdec.ptr1.i.i.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i, i64 1
  store i32 %337, ptr %dest.addr.0.i.i.i, align 4, !tbaa !32
  %cmp.not.i.i.i = icmp eq i32 %337, 0
...
_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i.i:          ; preds = %while.cond.i.i.i
  %338 = load i32, ptr %_length.i.i976, align 8, !tbaa !41
  store i32 %338, ptr %_length.i.i229.i, align 8, !tbaa !41
...
if.end282.i.i:                                    ; preds = %invoke.cont271.i.i
  %343 = load i32, ptr %_size.i, align 4, !tbaa !5
  %cmp287.i.i = icmp eq i32 %343, 0
...
if.then.i.i726.i.i:                               ; preds = %if.end282.i.i
  ...
  %344 = load ptr, ptr %vfn.i.i725.i.i, align 8
  %call.i.i733.i.i = invoke noundef i32 %344(ptr noundef nonnull align 8 dereferenceable(8) %outStream.sroa.0.1.i.i)
...
invoke.cont296.i.i:                               ; preds = %invoke.cont293.i.i
  ...
  %346 = load ptr, ptr %vfn.i737.i.i, align 8
  %call.i738744.i.i = invoke noundef i32 %346(ptr noundef nonnull align 8 dereferenceable(8) %call294.i.i)
...
invoke.cont302.i.i:                               ; preds = %invoke.cont298.i.i
  %347 = load ptr, ptr %realPath300.i.i, align 8, !tbaa !31
  ...
  %call.i750751.i.i = invoke noundef zeroext i1 @_ZN8NWindows5NFile3NIO8COutFile6CreateEPKwb(ptr noundef nonnull align 8 dereferenceable(1084) %File.i749.i.i, ptr noundef %347, i1 noundef zeroext false)
...
if.then308.i.i:                                   ; preds = %invoke.cont306.i.i
  ...
  %348 = load i32, ptr %call.i753.i.i, align 4, !tbaa !21
  store i32 %348, ptr %errorInfo, align 8, !tbaa !105
...
lpad303.i.i:                                      ; preds = %invoke.cont312.i.i, %if.then308.i.i, %invoke.cont302.i.i
  ...
  %isnull.i754.i.i = icmp eq ptr %352, null
...
cleanup318.i.i:                                   ; preds = %invoke.cont312.i.i, %invoke.cont306.i.i
  ...
  %353 = load ptr, ptr %realPath300.i.i, align 8, !tbaa !31
  %isnull.i757.i.i = icmp eq ptr %353, null
...
ehcleanup323.i.i:                                 ; preds = %delete.notnull.i755.i.i, %lpad303.i.i, %lpad301.i.i
  %.pn523.i.i = phi { ptr, i32 } [ %350, %lpad301.i.i ], [ %351, %lpad303.i.i ], [ %351, %delete.notnull.i755.i.i ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %realPath300.i.i) #18
...
if.then.i764.i.i:                                 ; preds = %if.end353.i.i, %invoke.cont344.i.i, %invoke.cont331.i.i, %_ZN11CStringBaseIwED2Ev.exit759.i.i
  ...
  %356 = load ptr, ptr %vfn.i762.i.i, align 8
  %call.i763.i.i = invoke noundef i32 %356(ptr noundef nonnull align 8 dereferenceable(8) %sfxOutStream.sroa.0.1.i.i)
...
if.then.i770.i.i:                                 ; preds = %if.then.i764.i.i, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i113.i
  ...
  %359 = load ptr, ptr %vfn.i768.i.i, align 8
  %call.i769.i.i = invoke noundef i32 %359(ptr noundef nonnull align 8 dereferenceable(8) %call262.i.i)
...
if.then.i776.i.i:                                 ; preds = %lpad343.i.i, %lpad326.i.i, %ehcleanup323.i.i
  ...
  %.pn524.ph.i.i = phi { ptr, i32 } [ %.pn523.i.i, %ehcleanup323.i.i ], [ %354, %lpad326.i.i ], [ %355, %lpad343.i.i ]
  ...
  %362 = load ptr, ptr %vfn.i774.i.i, align 8
  %call.i775.i.i = invoke noundef i32 %362(ptr noundef nonnull align 8 dereferenceable(8) %sfxOutStream.sroa.0.2.ph.i.i)
...
if.then.i783.i.i:                                 ; preds = %if.then.i776.i.i, %lpad295.i.i, %lpad289.i.i, %lpad268.i.i
  %.pn524.pn.i.i = phi { ptr, i32 } [ %342, %lpad268.i.i ], [ %.pn524.ph.i.i, %if.then.i776.i.i ], [ %345, %lpad289.i.i ], [ %349, %lpad295.i.i ]
  ...
  %365 = load ptr, ptr %vfn.i781.i.i, align 8
  %call.i782.i.i = invoke noundef i32 %365(ptr noundef nonnull align 8 dereferenceable(8) %call262.i.i)
...
if.end368.i.i:                                    ; preds = %_ZN9CMyComPtrI9IInStreamED2Ev.exit.i.i, %cleanup.cont256.i.i
  %368 = load ptr, ptr %outArchive.i.i, align 8, !tbaa !135
  %369 = load i32, ptr %_size.i.i.i, align 4, !tbaa !5
  %vtable378.i.i = load ptr, ptr %368, align 8, !tbaa !46
  %vfn379.i.i = getelementptr inbounds ptr, ptr %vtable378.i.i, i64 5
  %370 = load ptr, ptr %vfn379.i.i, align 8
  %call381.i.i = invoke noundef i32 %370(ptr noundef nonnull align 8 dereferenceable(8) %368, ptr noundef nonnull %outStream.sroa.0.1.i.i, i32 noundef %369, ptr noundef nonnull %call72.i.i)
...
invoke.cont380.i.i:                               ; preds = %if.end368.i.i
  ...
  %371 = load ptr, ptr %vfn383.i.i, align 8
  %call385.i.i = invoke noundef i32 %371(ptr noundef nonnull align 8 dereferenceable(8) %callback)
...
if.then.i791.i.i:                                 ; preds = %if.then399.i.i, %if.else397.i.i, %if.then394.i.i, %invoke.cont384.i.i, %_ZN9CMyComPtrI9IInStreamED2Ev.exit.i.i, %invoke.cont249.i.i, %_ZN11CStringBaseIwED2Ev.exit682.i.i
  ...
  %373 = load ptr, ptr %vfn.i789.i.i, align 8
  %call.i790.i.i = invoke noundef i32 %373(ptr noundef nonnull align 8 dereferenceable(8) %outStream.sroa.0.2.ph.i.i)
...
if.then.i798.i.i:                                 ; preds = %if.then.i791.i.i, %if.end114.i.i
  ...
  %376 = load ptr, ptr %vfn.i796.i.i, align 8
  %call.i797.i.i = invoke noundef i32 %376(ptr noundef nonnull align 8 dereferenceable(8) %call72.i.i)
...
if.then.i804.i.i:                                 ; preds = %ehcleanup411.i.loopexit.split-lp.i, %ehcleanup411.i.loopexit.i, %lpad370.i.i, %if.then.i783.i.i, %lpad266.i.i, %lpad263.i.i, %lpad260.i.i, %lpad246.i.i, %ehcleanup241.i.i, %delete.notnull.i684.i.i, %lpad136.i.i
  %.pn535.pn871.i.i = phi { ptr, i32 } [ %.pn524.pn.i.i, %if.then.i783.i.i ], [ %341, %lpad266.i.i ], [ %339, %lpad260.i.i ], [ %340, %lpad263.i.i ], [ %.pn519.pn.pn.i.i, %ehcleanup241.i.i ], [ %319, %lpad246.i.i ], [ %372, %lpad370.i.i ], [ %lpad.loopexit.i, %ehcleanup411.i.loopexit.i ], [ %lpad.loopexit.split-lp.i, %ehcleanup411.i.loopexit.split-lp.i ], [ %232, %lpad136.i.i ], [ %.pn534.i.i, %delete.notnull.i684.i.i ]
  ...
  %379 = load ptr, ptr %vfn.i802.i.i, align 8
  %call.i803.i.i = invoke noundef i32 %379(ptr noundef nonnull align 8 dereferenceable(8) %outStream.sroa.0.3870.i.i)
...
if.then.i811.i.i:                                 ; preds = %if.then.i804.i.i, %ehcleanup411.thread880.i.i, %lpad4.i.i, %lpad131.i.i, %ehcleanup113.i.i
  %.pn535.pn872.i.i = phi { ptr, i32 } [ %.pn535.pn871.i.i, %if.then.i804.i.i ], [ %lpad.thr_comm.i.i, %ehcleanup411.thread880.i.i ], [ %286, %lpad4.i.i ], [ %231, %lpad131.i.i ], [ %.pn515.pn.i.i, %ehcleanup113.i.i ]
  %vtable.i808.i.i = load ptr, ptr %call72.i.i, align 8, !tbaa !46
  %vfn.i809.i.i = getelementptr inbounds ptr, ptr %vtable.i808.i.i, i64 2
  %382 = load ptr, ptr %vfn.i809.i.i, align 8
  %call.i810.i.i = invoke noundef i32 %382(ptr noundef nonnull align 8 dereferenceable(8) %call72.i.i)
...
ehcleanup423.i.i:                                 ; preds = %if.then.i811.i.i, %lpad76.i.i, %lpad73.i.i, %lpad70.i.i, %lpad60.i.i, %lpad42.i.i
  %.pn535.pn.pn.pn.pn.pn.i.i = phi { ptr, i32 } [ %202, %lpad42.i.i ], [ %207, %lpad60.i.i ], [ %212, %lpad73.i.i ], [ %211, %lpad70.i.i ], [ %213, %lpad76.i.i ], [ %.pn535.pn872.i.i, %if.then.i811.i.i ]
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %updatePairs2.i.i) #18
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %updatePairs2.i.i) #18
  br label %ehcleanup427.i.i

ehcleanup427.i.i:                                 ; preds = %ehcleanup423.i.i, %lpad26.i.i
  %.pn535.pn.pn.pn.pn.pn.pn.i.i = phi { ptr, i32 } [ %.pn535.pn.pn.pn.pn.pn.i.i, %ehcleanup423.i.i ], [ %195, %lpad26.i.i ]
...
cleanup430.i.i:                                   ; preds = %cleanup420.i.i, %cleanup.cont36.i.i, %invoke.cont29.i.i
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %value.i.i) #18
  %385 = load ptr, ptr %outArchive.i.i, align 8, !tbaa !135
  %tobool.not.i814.i.i = icmp eq ptr %385, null
...
if.then.i818.i.i:                                 ; preds = %cleanup430.i.i
  %vtable.i815.i.i = load ptr, ptr %385, align 8, !tbaa !46
  %vfn.i816.i.i = getelementptr inbounds ptr, ptr %vtable.i815.i.i, i64 2
  %386 = load ptr, ptr %vfn.i816.i.i, align 8
  %call.i817.i.i = invoke noundef i32 %386(ptr noundef nonnull align 8 dereferenceable(8) %385)
...
ehcleanup431.i.i:                                 ; preds = %ehcleanup427.i.i, %lpad18.i.i, %lpad10.i.i, %if.then.i556.i.i, %lpad.i.i
  %.pn547.pn.i.i = phi { ptr, i32 } [ %193, %lpad18.i.i ], [ %.pn535.pn.pn.pn.pn.pn.pn.i.i, %ehcleanup427.i.i ], [ %191, %lpad10.i.i ], [ %177, %lpad.i.i ], [ %lpad.phi335.i, %if.then.i556.i.i ]
  %389 = load ptr, ptr %outArchive.i.i, align 8, !tbaa !135
  %tobool.not.i820.i.i = icmp eq ptr %389, null
...
if.then.i824.i.i:                                 ; preds = %ehcleanup431.i.i
  %vtable.i821.i.i = load ptr, ptr %389, align 8, !tbaa !46
  %vfn.i822.i.i = getelementptr inbounds ptr, ptr %vtable.i821.i.i, i64 2
  %390 = load ptr, ptr %vfn.i822.i.i, align 8
  %call.i823.i.i = invoke noundef i32 %390(ptr noundef nonnull align 8 dereferenceable(8) %389)
...
cleanup.cont36.i:                                 ; preds = %_ZL8CompressP7CCodecsRKN14NUpdateArchive10CActionSetEP10IInArchiveRK22CCompressionMethodModeR12CArchivePathRK13CObjectVectorI8CArcItemEbbbRK9CDirItemsbRK11CStringBaseIwERK13CRecordVectorIyER10CTempFilesR16CUpdateErrorInfoP17IUpdateCallbackUI.exit.i
  ...
  %393 = load ptr, ptr %vfn39.i, align 8
  %call40.i1006 = invoke noundef i32 %393(ptr noundef nonnull align 8 dereferenceable(8) %callback)
          to label %call40.i.noexc unwind label %lpad393

call40.i.noexc:                                   ; preds = %cleanup.cont36.i
  %cmp41.not.i = icmp eq i32 %call40.i1006, 0
...
if.then423:                                       ; preds = %invoke.cont421
  %_items.i.i1007 = getelementptr inbounds %struct.CUpdateOptions, ptr %options, i64 0, i32 1, i32 0, i32 0, i32 3
  %397 = load ptr, ptr %_items.i.i1007, align 8, !tbaa !12
  %398 = load ptr, ptr %397, align 8, !tbaa !13
  %ArchivePath429 = getelementptr inbounds %struct.CUpdateArchiveCommand, ptr %398, i64 0, i32 1
...
if.then434:                                       ; preds = %invoke.cont432
  %399 = load ptr, ptr %arcPath, align 8, !tbaa !31
  %call439 = invoke noundef zeroext i1 @_ZN8NWindows5NFile10NDirectory16DeleteFileAlwaysEPKw(ptr noundef %399)
...
if.then440:                                       ; preds = %invoke.cont438
  %call.i1008 = tail call ptr @__errno_location() #21
  %400 = load i32, ptr %call.i1008, align 4, !tbaa !21
  store i32 %400, ptr %errorInfo, align 8, !tbaa !105
...
lpad435:                                          ; preds = %invoke.cont466.invoke, %invoke.cont463, %if.then458, %if.end451, %if.then440, %if.then434
  ...
  %403 = load ptr, ptr %ref.tmp430, align 8, !tbaa !31
  %isnull.i1009 = icmp eq ptr %403, null
  br i1 %isnull.i1009, label %_ZN11CStringBaseIwED2Ev.exit1011, label %delete.notnull.i1010

delete.notnull.i1010:                             ; preds = %lpad435
  call void @_ZdaPv(ptr noundef nonnull %403) #20
  br label %_ZN11CStringBaseIwED2Ev.exit1011

_ZN11CStringBaseIwED2Ev.exit1011:                 ; preds = %lpad435, %delete.notnull.i1010
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp430) #18
  br label %ehcleanup476

if.end451:                                        ; preds = %invoke.cont438, %invoke.cont432
  %404 = load ptr, ptr %ref.tmp430, align 8, !tbaa !31
  %405 = load ptr, ptr %arcPath, align 8, !tbaa !31
  %call457 = invoke noundef zeroext i1 @_ZN8NWindows5NFile10NDirectory10MyMoveFileEPKwS3_(ptr noundef %404, ptr noundef %405)
...
if.then458:                                       ; preds = %invoke.cont456
  %call.i1012 = tail call ptr @__errno_location() #21
  %406 = load i32, ptr %call.i1012, align 4, !tbaa !21
  store i32 %406, ptr %errorInfo, align 8, !tbaa !105
...
invoke.cont466.invoke:                            ; preds = %invoke.cont445, %invoke.cont466
  %407 = phi ptr [ %FileName2, %invoke.cont466 ], [ %FileName447, %invoke.cont445 ]
  %408 = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN11CStringBaseIwEaSERKS0_(ptr noundef nonnull align 8 dereferenceable(16) %407, ptr noundef nonnull align 8 dereferenceable(16) %arcPath)
...
cleanup471:                                       ; preds = %invoke.cont466.invoke, %invoke.cont456
  ...
  %retval.29 = phi i32 [ %retval.231053, %invoke.cont456 ], [ -2147467259, %invoke.cont466.invoke ]
  %409 = load ptr, ptr %ref.tmp430, align 8, !tbaa !31
  %isnull.i1013 = icmp eq ptr %409, null
  br i1 %isnull.i1013, label %_ZN11CStringBaseIwED2Ev.exit1015, label %delete.notnull.i1014

delete.notnull.i1014:                             ; preds = %cleanup471
  call void @_ZdaPv(ptr noundef nonnull %409) #20
  br label %_ZN11CStringBaseIwED2Ev.exit1015

_ZN11CStringBaseIwED2Ev.exit1015:                 ; preds = %cleanup471, %delete.notnull.i1014
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp430) #18
  br i1 %cond521, label %if.end484, label %cleanup485

ehcleanup476:                                     ; preds = %_ZN11CStringBaseIwED2Ev.exit1011, %lpad431
  %.pn642 = phi { ptr, i32 } [ %402, %_ZN11CStringBaseIwED2Ev.exit1011 ], [ %401, %lpad431 ]
  %exn.slot.12 = extractvalue { ptr, i32 } %.pn642, 0
  %410 = call ptr @__cxa_begin_catch(ptr %exn.slot.12) #18
...
if.end484:                                        ; preds = %_ZN11CStringBaseIwED2Ev.exit1015, %invoke.cont421
  br label %cleanup485

cleanup485:                                       ; preds = %_ZN11CStringBaseIwED2Ev.exit.i982, %call4.i.noexc, %_ZL8CompressP7CCodecsRKN14NUpdateArchive10CActionSetEP10IInArchiveRK22CCompressionMethodModeR12CArchivePathRK13CObjectVectorI8CArcItemEbbbRK9CDirItemsbRK11CStringBaseIwERK13CRecordVectorIyER10CTempFilesR16CUpdateErrorInfoP17IUpdateCallbackUI.exit.i, %call40.i.noexc, %invoke.cont381, %invoke.cont409, %_ZN11CStringBaseIwED2Ev.exit1015, %if.end484
  %retval.30 = phi i32 [ 0, %if.end484 ], [ %retval.29, %_ZN11CStringBaseIwED2Ev.exit1015 ], [ %call410, %invoke.cont409 ], [ %call382, %invoke.cont381 ], [ %call40.i1006, %call40.i.noexc ], [ %retval.19.i.i, %_ZL8CompressP7CCodecsRKN14NUpdateArchive10CActionSetEP10IInArchiveRK22CCompressionMethodModeR12CArchivePathRK13CObjectVectorI8CArcItemEbbbRK9CDirItemsbRK11CStringBaseIwERK13CRecordVectorIyER10CTempFilesR16CUpdateErrorInfoP17IUpdateCallbackUI.exit.i ], [ %call4.i1004, %call4.i.noexc ], [ %call15.i, %_ZN11CStringBaseIwED2Ev.exit.i982 ]
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorI8CArcItemE, i64 0, inrange i32 0, i64 2), ptr %arcItems, align 8, !tbaa !46
...
ehcleanup486:                                     ; preds = %lpad393, %_ZN9CMyComPtrI11IOutArchiveED2Ev.exit826.i.i, %_ZN11CStringBaseIwED2Ev.exit89.i, %lpad481, %lpad418, %lpad408, %lpad378
  %.pn = phi { ptr, i32 } [ %411, %lpad481 ], [ %396, %lpad418 ], [ %395, %lpad408 ], [ %149, %lpad378 ], [ %394, %lpad393 ], [ %169, %_ZN11CStringBaseIwED2Ev.exit89.i ], [ %.pn547.pn.i.i, %_ZN9CMyComPtrI11IOutArchiveED2Ev.exit826.i.i ]
...
cleanup489:                                       ; preds = %_ZN11CStringBaseIwED2Ev.exit958, %_ZN13CObjectVectorI8CArcItemED2Ev.exit
  ...
  invoke void @_ZN10CTempFiles5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %tempFiles)
          to label %invoke.cont.i1017 unwind label %terminate.lpad.i1018

invoke.cont.i1017:                                ; preds = %cleanup489
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorI11CStringBaseIwEE, i64 0, inrange i32 0, i64 2), ptr %tempFiles, align 8, !tbaa !46
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %tempFiles)
          to label %_ZN11CStringBaseIwED2Ev.exit1021 unwind label %terminate.lpad.i.i

terminate.lpad.i.i:                               ; preds = %invoke.cont.i1017
...
terminate.lpad.i1018:                             ; preds = %cleanup489
...
_ZN11CStringBaseIwED2Ev.exit1021:                 ; preds = %invoke.cont.i1017
...
ehcleanup490:                                     ; preds = %_ZN11CStringBaseIwED2Ev.exit955, %lpad337, %ehcleanup486, %lpad278
  %.pn.pn.pn = phi { ptr, i32 } [ %.pn, %ehcleanup486 ], [ %118, %lpad278 ], [ %141, %_ZN11CStringBaseIwED2Ev.exit955 ], [ %140, %lpad337 ]
  call void @_ZN10CTempFilesD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %tempFiles) #18
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %tempFiles) #18
  br label %ehcleanup504

cleanup503:                                       ; preds = %cleanup256.thread, %cleanup256, %_ZN11CStringBaseIwED2Ev.exit1021
  %retval.32 = phi i32 [ %retval.31, %_ZN11CStringBaseIwED2Ev.exit1021 ], [ %call176, %cleanup256.thread ], [ %retval.14, %cleanup256 ]
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorI8CDirItemE, i64 0, inrange i32 0, i64 2), ptr %Items.i, align 8, !tbaa !46
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %Items.i)
          to label %_ZN13CObjectVectorI8CDirItemED2Ev.exit.i unwind label %terminate.lpad.i.i1026

terminate.lpad.i.i1026:                           ; preds = %cleanup503
...
cleanup507:                                       ; preds = %_ZN8NWindows5NFile5NFind10CFileInfoWD2Ev.exit, %_ZN9CDirItemsD2Ev.exit
  ...
  %422 = load ptr, ptr %arcPath, align 8, !tbaa !31
  %isnull.i1029 = icmp eq ptr %422, null
  br i1 %isnull.i1029, label %_ZN11CStringBaseIwED2Ev.exit1031, label %delete.notnull.i1030

delete.notnull.i1030:                             ; preds = %cleanup507
  call void @_ZdaPv(ptr noundef nonnull %422) #20
  br label %_ZN11CStringBaseIwED2Ev.exit1031

_ZN11CStringBaseIwED2Ev.exit1031:                 ; preds = %cleanup507, %delete.notnull.i1030
...
ehcleanup508:                                     ; preds = %ehcleanup504, %ehcleanup136
  ...
  %423 = load ptr, ptr %arcPath, align 8, !tbaa !31
  %isnull.i1032 = icmp eq ptr %423, null
  br i1 %isnull.i1032, label %ehcleanup510, label %delete.notnull.i1033

delete.notnull.i1033:                             ; preds = %ehcleanup508
  call void @_ZdaPv(ptr noundef nonnull %423) #20
  br label %ehcleanup510

ehcleanup510:                                     ; preds = %delete.notnull.i1033, %ehcleanup508, %lpad46
  %.pn.pn.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %37, %lpad46 ], [ %.pn.pn.pn.pn.pn.pn.pn.pn, %ehcleanup508 ], [ %.pn.pn.pn.pn.pn.pn.pn.pn, %delete.notnull.i1033 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %arcPath) #18
  call void @_ZN12CArchiveLinkD2Ev(ptr noundef nonnull align 8 dereferenceable(73) %arcLink) #18
  call void @llvm.lifetime.end.p0(i64 80, ptr nonnull %arcLink) #18
  br label %common.resume

return:                                           ; preds = %_ZN9CPropertyD2Ev.exit, %land.lhs.true2, %entry, %_ZN11CStringBaseIwED2Ev.exit1031
  %retval.34 = phi i32 [ -2147467259, %_ZN9CPropertyD2Ev.exit ], [ %retval.33, %_ZN11CStringBaseIwED2Ev.exit1031 ], [ -2147467259, %entry ], [ -2147467263, %land.lhs.true2 ]
  ret i32 %retval.34
...
declare void @_ZN8NWindows5NFile3NIO9CFileBaseD2Ev(ptr noundef nonnull align 8 dereferenceable(1084)) unnamed_addr #13
