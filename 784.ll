; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Olden/bh/newbh.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Olden/bh/newbh.c"
...
entry:
  %call = tail call i32 (i32, ptr, ...) @dealwithargs(i32 noundef %argc, ptr noundef %argv) #26
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %bodiesper) #26
  call void @llvm.lifetime.start.p0(i64 512, ptr nonnull %ptrper) #26
  tail call void @srand(i32 noundef 123) #26
  %call = tail call noalias dereferenceable_or_null(1064) ptr @malloc(i64 noundef 1064) #27
...
for.body18:                                       ; preds = %entry, %if.end
  ...
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %tmp21) #26
  ...
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %tmp21) #26
...
while.end:                                        ; preds = %while.body
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %ptrper) #26
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %bodiesper) #26
  ret ptr %call
}
...
; Function Attrs: nounwind uwtable
define dso_local void @uniform_testdata(ptr noalias nocapture sret(%struct.datapoints) align 8 %agg.result, i32 noundef %proc, i32 noundef %nbodyx, i32 noundef %seedfactor) local_unnamed_addr #0 {
entry:
  %uglygep = getelementptr i8, ptr %agg.result, i64 24
  %call.i = tail call noalias dereferenceable_or_null(144) ptr @malloc(i64 noundef 144) #27
...
if.end:                                           ; preds = %if.end.lr.ph, %do.end104
  ...
  %call.i203 = tail call noalias dereferenceable_or_null(144) ptr @malloc(i64 noundef 144) #27
  ...
  %call24 = tail call double (double, ...) @my_rand(double noundef %seed.0219) #26
  %call25 = tail call double (double, double, double, ...) @xrand(double noundef 0.000000e+00, double noundef 0x3FEFF7CED916872B, double noundef %call24) #26
  %call26 = tail call double @pow(double noundef %call25, double noundef 0xBFE5555555555555) #26
  %sub = fadd double %call26, -1.000000e+00
  %call27 = tail call double @sqrt(double noundef %sub) #26
  %call33 = tail call double (double, ...) @my_rand(double noundef %call24) #26
  %call34 = tail call double (double, double, double, ...) @xrand(double noundef 0.000000e+00, double noundef 0x3FEFF7CED916872B, double noundef %call33) #26
  ...
  %call33.1 = tail call double (double, ...) @my_rand(double noundef %call33) #26
  %call34.1 = tail call double (double, double, double, ...) @xrand(double noundef 0.000000e+00, double noundef 0x3FEFF7CED916872B, double noundef %call33.1) #26
  ...
  %call33.2 = tail call double (double, ...) @my_rand(double noundef %call33.1) #26
  %call34.2 = tail call double (double, double, double, ...) @xrand(double noundef 0.000000e+00, double noundef 0x3FEFF7CED916872B, double noundef %call33.2) #26
...
do.body:                                          ; preds = %if.end, %do.body
  ...
  %call58 = tail call double (double, ...) @my_rand(double noundef %seed.2) #26
  %call59 = tail call double (double, double, double, ...) @xrand(double noundef 0.000000e+00, double noundef 1.000000e+00, double noundef %call58) #26
  %call60 = tail call double (double, ...) @my_rand(double noundef %call58) #26
  %call61 = tail call double (double, double, double, ...) @xrand(double noundef 0.000000e+00, double noundef 1.000000e-01, double noundef %call60) #26
  ...
  %call64 = tail call double @pow(double noundef %6, double noundef 3.500000e+00) #26
...
do.end:                                           ; preds = %do.body
  ...
  %call71 = tail call double @pow(double noundef %7, double noundef 2.500000e-01) #26
...
do.body74:                                        ; preds = %do.body74, %do.end
  ...
  %call79 = tail call double (double, ...) @my_rand(double noundef %seed.3) #26
  %call80 = tail call double (double, double, double, ...) @xrand(double noundef -1.000000e+00, double noundef 1.000000e+00, double noundef %call79) #26
  store double %call80, ptr %arrayidx93, align 8, !tbaa !13
  %call79.1 = tail call double (double, ...) @my_rand(double noundef %call79) #26
  %call80.1 = tail call double (double, double, double, ...) @xrand(double noundef -1.000000e+00, double noundef 1.000000e+00, double noundef %call79.1) #26
  store double %call80.1, ptr %arrayidx82.1, align 8, !tbaa !13
  %call79.2 = tail call double (double, ...) @my_rand(double noundef %call79.1) #26
  %call80.2 = tail call double (double, double, double, ...) @xrand(double noundef -1.000000e+00, double noundef 1.000000e+00, double noundef %call79.2) #26
...
do.end104:                                        ; preds = %do.body74
  ...
  %call105 = tail call double @sqrt(double noundef %12) #26
  ...
  store <2 x double> %18, ptr %uglygep, align 8, !tbaa !13
...
for.body.lr.ph.i:                                 ; preds = %if.end
  ...
  %uglygep.i.i.i.i = getelementptr inbounds i8, ptr %hg.i.i.i.i, i64 8
  %phi0.i.i.i.i = getelementptr inbounds %struct.hgstruct, ptr %hg.i.i.i.i, i64 0, i32 2
  %uglygep42.i.i.i.i = getelementptr inbounds i8, ptr %hg.i.i.i.i, i64 40
...
while.body.i.i:                                   ; preds = %for.body.i, %while.body.i.i
  ...
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %hg.i.i.i.i) #26
  store ptr %q.07.i.i, ptr %hg.i.i.i.i, align 8, !tbaa !40
  %uglygep40.i.i.i.i = getelementptr i8, ptr %q.07.i.i, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %uglygep.i.i.i.i, ptr noundef nonnull align 8 dereferenceable(24) %uglygep40.i.i.i.i, i64 24, i1 false), !tbaa !13
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %phi0.i.i.i.i, i8 0, i64 32, i1 false)
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %tmp.i.i.i.i) #26
  call void @walksub(ptr nonnull sret(%struct.hgstruct) align 8 %tmp.i.i.i.i, ptr noundef %5, double noundef %mul.i.i.i.i, double noundef 1.000000e+00, ptr noundef nonnull byval(%struct.hgstruct) align 8 %hg.i.i.i.i, i32 noundef 0) #26
  ...
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %tmp.i.i.i.i) #26
  ...
  %uglygep44.i.i.i.i = getelementptr i8, ptr %q.07.i.i, i64 96
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %uglygep44.i.i.i.i, ptr noundef nonnull align 8 dereferenceable(24) %uglygep42.i.i.i.i, i64 24, i1 false), !tbaa !13
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %hg.i.i.i.i) #26
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %uglygep.i.i.i = getelementptr inbounds i8, ptr %hg.i.i.i, i64 8
  %phi0.i.i.i = getelementptr inbounds %struct.hgstruct, ptr %hg.i.i.i, i64 0, i32 2
  %uglygep42.i.i.i = getelementptr inbounds i8, ptr %hg.i.i.i, i64 40
...
while.body.i:                                     ; preds = %for.body, %while.body.i
  ...
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %hg.i.i.i) #26
  store ptr %q.07.i, ptr %hg.i.i.i, align 8, !tbaa !40
  %uglygep40.i.i.i = getelementptr i8, ptr %q.07.i, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %uglygep.i.i.i, ptr noundef nonnull align 8 dereferenceable(24) %uglygep40.i.i.i, i64 24, i1 false), !tbaa !13
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %phi0.i.i.i, i8 0, i64 32, i1 false)
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %tmp.i.i.i) #26
  call void @walksub(ptr nonnull sret(%struct.hgstruct) align 8 %tmp.i.i.i, ptr noundef %3, double noundef %mul.i.i.i, double noundef 1.000000e+00, ptr noundef nonnull byval(%struct.hgstruct) align 8 %hg.i.i.i, i32 noundef 0) #26
  ...
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %tmp.i.i.i) #26
  ...
  %uglygep44.i.i.i = getelementptr i8, ptr %q.07.i, i64 96
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %uglygep44.i.i.i, ptr noundef nonnull align 8 dereferenceable(24) %uglygep42.i.i.i, i64 24, i1 false), !tbaa !13
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %hg.i.i.i) #26
...
entry:
  %cmp1.not520 = icmp eq ptr %q, null
  br i1 %cmp1.not520, label %for.end428, label %for.cond2.preheader.lr.ph

for.cond2.preheader.lr.ph:                        ; preds = %entry
  %cmp7 = icmp sgt i32 %nstep, 0
  br label %for.cond2.preheader

for.cond2.preheader:                              ; preds = %for.cond2.preheader.lr.ph, %if.end426
  %q.addr.0521 = phi ptr [ %q, %for.cond2.preheader.lr.ph ], [ %37, %if.end426 ]
  %uglygep = getelementptr i8, ptr %q.addr.0521, i64 96
  %0 = load <2 x double>, ptr %uglygep, align 8, !tbaa !13
  %acc1.sroa.6.0.uglygep.sroa_idx = getelementptr i8, ptr %q.addr.0521, i64 112
  %acc1.sroa.6.0.copyload = load double, ptr %acc1.sroa.6.0.uglygep.sroa_idx, align 8, !tbaa !13
  br i1 %cmp7, label %for.body12.preheader, label %if.end58

for.body12.preheader:                             ; preds = %for.cond2.preheader
  %arrayidx16 = getelementptr inbounds %struct.bnode, ptr %q.addr.0521, i64 0, i32 6, i64 0
  %arrayidx16.2 = getelementptr inbounds %struct.bnode, ptr %q.addr.0521, i64 0, i32 6, i64 2
  ...
  %arrayidx38 = getelementptr %struct.bnode, ptr %q.addr.0521, i64 0, i32 5, i64 0
  %arrayidx38.2 = getelementptr inbounds %struct.bnode, ptr %q.addr.0521, i64 0, i32 5, i64 2
  ...
  %dvel.sroa.15.0.uglygep526.sroa_idx = getelementptr %struct.bnode, ptr %q.addr.0521, i64 0, i32 5, i64 2
  store double %add.2, ptr %dvel.sroa.15.0.uglygep526.sroa_idx, align 8, !tbaa !13
  br label %if.end58

if.end58:                                         ; preds = %for.body12.preheader, %for.cond2.preheader
  %pos = getelementptr %struct.bnode, ptr %q.addr.0521, i64 0, i32 2
  %8 = load <2 x double>, ptr %pos, align 8, !tbaa !13
  %arrayidx63 = getelementptr inbounds %struct.bnode, ptr %q.addr.0521, i64 0, i32 2, i64 2
  %9 = load double, ptr %arrayidx63, align 8, !tbaa !13
  %10 = extractelement <2 x double> %8, i64 0
  %call65 = tail call i32 @__isnan(double noundef %10) #29
  %tobool66.not = icmp eq i32 %call65, 0
  br i1 %tobool66.not, label %cond.true79, label %if.then71

if.then71:                                        ; preds = %if.end58
  %call72 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 99)
  tail call void @abort() #28
  unreachable

cond.true79:                                      ; preds = %if.end58
  %11 = extractelement <2 x double> %8, i64 1
  %call80 = tail call i32 @__isnan(double noundef %11) #29
  %tobool81.not = icmp eq i32 %call80, 0
  br i1 %tobool81.not, label %cond.true94, label %if.then86

if.then86:                                        ; preds = %cond.true79
  %call87 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 98)
  tail call void @abort() #28
  unreachable

cond.true94:                                      ; preds = %cond.true79
  %call95 = tail call i32 @__isnan(double noundef %9) #29
  %tobool96.not = icmp eq i32 %call95, 0
  br i1 %tobool96.not, label %if.end103, label %if.then101

if.then101:                                       ; preds = %cond.true94
  %call102 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 97)
  tail call void @abort() #28
  unreachable

if.end103:                                        ; preds = %cond.true94
  %12 = tail call double @llvm.fabs.f64(double %10)
  %cmp104 = fcmp olt double %12, 1.000000e+01
  br i1 %cmp104, label %if.end108, label %if.then106

if.then106:                                       ; preds = %if.end103
  %call107 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 96)
  tail call void @abort() #28
  unreachable

if.end108:                                        ; preds = %if.end103
  %13 = tail call double @llvm.fabs.f64(double %11)
  %cmp109 = fcmp olt double %13, 1.000000e+01
  br i1 %cmp109, label %if.end113, label %if.then111

if.then111:                                       ; preds = %if.end108
  %call112 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 95)
  tail call void @abort() #28
  unreachable

if.end113:                                        ; preds = %if.end108
  %14 = tail call double @llvm.fabs.f64(double %9)
  %cmp114 = fcmp olt double %14, 1.000000e+01
  br i1 %cmp114, label %for.body123.preheader, label %if.then116

for.body123.preheader:                            ; preds = %if.end113
  %uglygep528 = getelementptr i8, ptr %q.addr.0521, i64 72
  store <2 x double> %0, ptr %uglygep528, align 8, !tbaa !13
  %acc1.sroa.6.0.uglygep528.sroa_idx = getelementptr i8, ptr %q.addr.0521, i64 88
  store double %acc1.sroa.6.0.copyload, ptr %acc1.sroa.6.0.uglygep528.sroa_idx, align 8, !tbaa !13
  %15 = extractelement <2 x double> %0, i64 0
  %call147 = tail call i32 @__isnan(double noundef %15) #29
  %tobool148.not = icmp eq i32 %call147, 0
  br i1 %tobool148.not, label %cond.true161, label %if.then153

if.then116:                                       ; preds = %if.end113
  %call117 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 94)
  tail call void @abort() #28
  unreachable

if.then153:                                       ; preds = %for.body123.preheader
  %call154 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 89)
  tail call void @abort() #28
  unreachable

cond.true161:                                     ; preds = %for.body123.preheader
  %16 = extractelement <2 x double> %0, i64 1
  %call162 = tail call i32 @__isnan(double noundef %16) #29
  %tobool163.not = icmp eq i32 %call162, 0
  br i1 %tobool163.not, label %cond.true176, label %if.then168

if.then168:                                       ; preds = %cond.true161
  %call169 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 88)
  tail call void @abort() #28
  unreachable

cond.true176:                                     ; preds = %cond.true161
  %call177 = tail call i32 @__isnan(double noundef %acc1.sroa.6.0.copyload) #29
  %tobool178.not = icmp eq i32 %call177, 0
  br i1 %tobool178.not, label %if.end185, label %if.then183

if.then183:                                       ; preds = %cond.true176
  %call184 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 87)
  tail call void @abort() #28
  unreachable

if.end185:                                        ; preds = %cond.true176
  %17 = tail call double @llvm.fabs.f64(double %15)
  %cmp186 = fcmp olt double %17, 1.000000e+04
  br i1 %cmp186, label %if.end190, label %if.then188

if.then188:                                       ; preds = %if.end185
  %call189 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 86)
  tail call void @abort() #28
  unreachable

if.end190:                                        ; preds = %if.end185
  %18 = tail call double @llvm.fabs.f64(double %16)
  %cmp191 = fcmp olt double %18, 1.000000e+04
  br i1 %cmp191, label %if.end195, label %if.then193

if.then193:                                       ; preds = %if.end190
  %call194 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 85)
  tail call void @abort() #28
  unreachable

if.end195:                                        ; preds = %if.end190
  %19 = tail call double @llvm.fabs.f64(double %acc1.sroa.6.0.copyload)
  %cmp196 = fcmp olt double %19, 1.000000e+04
  br i1 %cmp196, label %for.body205.preheader, label %if.then198

for.body205.preheader:                            ; preds = %if.end195
  %20 = fmul <2 x double> %0, <double 6.250000e-03, double 6.250000e-03>
  %mul209.2 = fmul double %acc1.sroa.6.0.copyload, 6.250000e-03
  %vel218 = getelementptr inbounds %struct.bnode, ptr %q.addr.0521, i64 0, i32 5
  %21 = load <2 x double>, ptr %vel218, align 8, !tbaa !13
  %arrayidx223 = getelementptr inbounds %struct.bnode, ptr %q.addr.0521, i64 0, i32 5, i64 2
  %22 = load double, ptr %arrayidx223, align 8, !tbaa !13
  %23 = extractelement <2 x double> %21, i64 0
  %call230 = tail call i32 @__isnan(double noundef %23) #29
  %tobool231.not = icmp eq i32 %call230, 0
  br i1 %tobool231.not, label %cond.true244, label %if.then236

if.then198:                                       ; preds = %if.end195
  %call199 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 84)
  tail call void @abort() #28
  unreachable

if.then236:                                       ; preds = %for.body205.preheader
  %call237 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 79)
  tail call void @abort() #28
  unreachable

cond.true244:                                     ; preds = %for.body205.preheader
  %24 = extractelement <2 x double> %21, i64 1
  %call245 = tail call i32 @__isnan(double noundef %24) #29
  %tobool246.not = icmp eq i32 %call245, 0
  br i1 %tobool246.not, label %cond.true259, label %if.then251

if.then251:                                       ; preds = %cond.true244
  %call252 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 78)
  tail call void @abort() #28
  unreachable

cond.true259:                                     ; preds = %cond.true244
  %call260 = tail call i32 @__isnan(double noundef %22) #29
  %tobool261.not = icmp eq i32 %call260, 0
  br i1 %tobool261.not, label %if.end268, label %if.then266

if.then266:                                       ; preds = %cond.true259
  %call267 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 77)
  tail call void @abort() #28
  unreachable

if.end268:                                        ; preds = %cond.true259
  %25 = tail call double @llvm.fabs.f64(double %23)
  %cmp269 = fcmp olt double %25, 1.000000e+04
  br i1 %cmp269, label %if.end273, label %if.then271

if.then271:                                       ; preds = %if.end268
  %call272 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 76)
  tail call void @abort() #28
  unreachable

if.end273:                                        ; preds = %if.end268
  %26 = tail call double @llvm.fabs.f64(double %24)
  %cmp274 = fcmp olt double %26, 1.000000e+04
  br i1 %cmp274, label %if.end278, label %if.then276

if.then276:                                       ; preds = %if.end273
  %call277 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 75)
  tail call void @abort() #28
  unreachable

if.end278:                                        ; preds = %if.end273
  %27 = tail call double @llvm.fabs.f64(double %22)
  %cmp279 = fcmp olt double %27, 1.000000e+04
  br i1 %cmp279, label %for.body288.preheader, label %if.then281

for.body288.preheader:                            ; preds = %if.end278
  %28 = fadd <2 x double> %21, %20
  %add294.2 = fadd double %22, %mul209.2
  %mul307.2 = fmul double %add294.2, 1.250000e-02
  %add323.2 = fadd double %9, %mul307.2
  ...
  %dpos.sroa.9.0.uglygep534.sroa_idx = getelementptr %struct.bnode, ptr %q.addr.0521, i64 0, i32 2, i64 2
  store double %add323.2, ptr %dpos.sroa.9.0.uglygep534.sroa_idx, align 8, !tbaa !13
  %31 = fadd <2 x double> %28, %20
  store <2 x double> %31, ptr %vel218, align 8, !tbaa !13
  %add351.2 = fadd double %add294.2, %mul209.2
  store double %add351.2, ptr %arrayidx223, align 8, !tbaa !13
  %32 = extractelement <2 x double> %30, i64 0
  %call373 = tail call i32 @__isnan(double noundef %32) #29
  %tobool374.not = icmp eq i32 %call373, 0
  br i1 %tobool374.not, label %cond.true387, label %if.then379

if.then281:                                       ; preds = %if.end278
  %call282 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 74)
  tail call void @abort() #28
  unreachable

if.then379:                                       ; preds = %for.body288.preheader
  %call380 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 69)
  tail call void @abort() #28
  unreachable

cond.true387:                                     ; preds = %for.body288.preheader
  %33 = extractelement <2 x double> %30, i64 1
  %call388 = tail call i32 @__isnan(double noundef %33) #29
  %tobool389.not = icmp eq i32 %call388, 0
  br i1 %tobool389.not, label %cond.true402, label %if.then394

if.then394:                                       ; preds = %cond.true387
  %call395 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 68)
  tail call void @abort() #28
  unreachable

cond.true402:                                     ; preds = %cond.true387
  %call403 = tail call i32 @__isnan(double noundef %add323.2) #29
  %tobool404.not = icmp eq i32 %call403, 0
  br i1 %tobool404.not, label %if.end411, label %if.then409

if.then409:                                       ; preds = %cond.true402
  %call410 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 67)
  tail call void @abort() #28
  unreachable

if.end411:                                        ; preds = %cond.true402
  %34 = tail call double @llvm.fabs.f64(double %32)
  %cmp412 = fcmp olt double %34, 1.000000e+04
  br i1 %cmp412, label %if.end416, label %if.then414

if.then414:                                       ; preds = %if.end411
  %call415 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 66)
  tail call void @abort() #28
  unreachable

if.end416:                                        ; preds = %if.end411
  %35 = tail call double @llvm.fabs.f64(double %33)
  %cmp417 = fcmp olt double %35, 1.000000e+04
  br i1 %cmp417, label %if.end421, label %if.then419

if.then419:                                       ; preds = %if.end416
  %call420 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 65)
  tail call void @abort() #28
  unreachable

if.end421:                                        ; preds = %if.end416
  %36 = tail call double @llvm.fabs.f64(double %add323.2)
  %cmp422 = fcmp olt double %36, 1.000000e+04
  br i1 %cmp422, label %if.end426, label %if.then424

if.then424:                                       ; preds = %if.end421
  %call425 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef 64)
  tail call void @abort() #28
  unreachable

if.end426:                                        ; preds = %if.end421
  %proc_next = getelementptr inbounds %struct.bnode, ptr %q.addr.0521, i64 0, i32 10
  %37 = load ptr, ptr %proc_next, align 8, !tbaa !25
  %cmp1.not = icmp eq ptr %37, null
  br i1 %cmp1.not, label %for.end428, label %for.cond2.preheader, !llvm.loop !49

for.end428:                                       ; preds = %if.end426, %entry
  ret void
}
...
entry:
  %call = tail call noalias dereferenceable_or_null(144) ptr @malloc(i64 noundef 144) #27
...
if.else:                                          ; preds = %entry
  %call = tail call noalias dereferenceable_or_null(120) ptr @malloc(i64 noundef 120) #27
  br label %if.end
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %uglygep = getelementptr i8, ptr %tmp.0, i64 48
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(64) %uglygep, i8 0, i64 64, i1 false), !tbaa !16
  ret ptr %tmp.0
}
...
while.body.lr.ph:                                 ; preds = %entry
  %uglygep.i.i = getelementptr inbounds i8, ptr %hg.i.i, i64 8
  %phi0.i.i = getelementptr inbounds %struct.hgstruct, ptr %hg.i.i, i64 0, i32 2
  %uglygep42.i.i = getelementptr inbounds i8, ptr %hg.i.i, i64 40
  %mul.i.i = fmul double %rsize, %rsize
  br label %while.body

while.body:                                       ; preds = %while.body.lr.ph, %while.body
  %q.07 = phi ptr [ %bodies, %while.body.lr.ph ], [ %1, %while.body ]
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %hg.i.i) #26
  store ptr %q.07, ptr %hg.i.i, align 8, !tbaa !40
  %uglygep40.i.i = getelementptr i8, ptr %q.07, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %uglygep.i.i, ptr noundef nonnull align 8 dereferenceable(24) %uglygep40.i.i, i64 24, i1 false), !tbaa !13
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %phi0.i.i, i8 0, i64 32, i1 false)
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %tmp.i.i) #26
  call void @walksub(ptr nonnull sret(%struct.hgstruct) align 8 %tmp.i.i, ptr noundef %rt, double noundef %mul.i.i, double noundef 1.000000e+00, ptr noundef nonnull byval(%struct.hgstruct) align 8 %hg.i.i, i32 noundef 0) #26
  ...
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %tmp.i.i) #26
  ...
  %uglygep44.i.i = getelementptr i8, ptr %q.07, i64 96
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %uglygep44.i.i, ptr noundef nonnull align 8 dereferenceable(24) %uglygep42.i.i, i64 24, i1 false), !tbaa !13
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %hg.i.i) #26
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %hg.i) #26
  store ptr %p, ptr %hg.i, align 8, !tbaa !40
  %uglygep.i = getelementptr inbounds i8, ptr %hg.i, i64 8
  %uglygep40.i = getelementptr i8, ptr %p, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %uglygep.i, ptr noundef nonnull align 8 dereferenceable(24) %uglygep40.i, i64 24, i1 false), !tbaa !13
  %phi0.i = getelementptr inbounds %struct.hgstruct, ptr %hg.i, i64 0, i32 2
  %uglygep42.i = getelementptr inbounds i8, ptr %hg.i, i64 40
  ...
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %tmp.i) #26
  call void @walksub(ptr nonnull sret(%struct.hgstruct) align 8 %tmp.i, ptr noundef %rt, double noundef %mul.i, double noundef 1.000000e+00, ptr noundef nonnull byval(%struct.hgstruct) align 8 %hg.i, i32 noundef 0) #26
  ...
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %tmp.i) #26
  ...
  %uglygep44.i = getelementptr i8, ptr %p, i64 96
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %uglygep44.i, ptr noundef nonnull align 8 dereferenceable(24) %uglygep42.i, i64 24, i1 false), !tbaa !13
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %hg.i) #26
  ret void
}

; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(none)
declare i32 @__isnan(double noundef) local_unnamed_addr #17
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %hg) #26
  store ptr %p, ptr %hg, align 8, !tbaa !40
  %uglygep = getelementptr inbounds i8, ptr %hg, i64 8
  %uglygep40 = getelementptr i8, ptr %p, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %uglygep, ptr noundef nonnull align 8 dereferenceable(24) %uglygep40, i64 24, i1 false), !tbaa !13
  %phi0 = getelementptr inbounds %struct.hgstruct, ptr %hg, i64 0, i32 2
  %uglygep42 = getelementptr inbounds i8, ptr %hg, i64 40
  ...
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %tmp) #26
  call void @walksub(ptr nonnull sret(%struct.hgstruct) align 8 %tmp, ptr noundef %rt, double noundef %mul, double noundef 1.000000e+00, ptr noundef nonnull byval(%struct.hgstruct) align 8 %hg, i32 noundef 0) #26
  ...
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %tmp) #26
  ...
  %uglygep44 = getelementptr i8, ptr %p, i64 96
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %uglygep44, ptr noundef nonnull align 8 dereferenceable(24) %uglygep42, i64 24, i1 false), !tbaa !13
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %hg) #26
  ret void
}
...
define dso_local void @gravsub(ptr noalias nocapture writeonly sret(%struct.hgstruct) align 8 %agg.result, ptr nocapture noundef readonly %p, ptr nocapture noundef byval(%struct.hgstruct) align 8 %hg) local_unnamed_addr #18 {
entry:
  ...
  %call = tail call double @sqrt(double noundef %add) #26
...
define dso_local signext i16 @subdivp(ptr nocapture noundef readonly %p, double noundef %dsq, double noundef %tolsq, ptr nocapture noundef readonly byval(%struct.hgstruct) align 8 %hg) local_unnamed_addr #19 {
entry:
...
if.else.i:                                        ; preds = %if.then29
  %call.i = tail call noalias dereferenceable_or_null(120) ptr @malloc(i64 noundef 120) #27
  br label %cell_alloc.exit
...
cell_alloc.exit:                                  ; preds = %if.then.i, %if.else.i
  ...
  %uglygep.i = getelementptr i8, ptr %tmp.0.i, i64 48
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(64) %uglygep.i, i8 0, i64 64, i1 false), !tbaa !16
...
define dso_local double @hackcofm(ptr nocapture noundef %q) local_unnamed_addr #20 {
entry:
...
define dso_local i32 @ic_test(ptr nocapture noundef readonly %p, ptr nocapture noundef readonly %t) local_unnamed_addr #21 {
entry:
...
; Function Attrs: nofree nounwind uwtable
define dso_local void @printtree(ptr noundef %n) local_unnamed_addr #14 {
entry:
...
; Function Attrs: nofree nounwind uwtable
define dso_local void @ptree(ptr noundef %n, i32 noundef %level) local_unnamed_addr #14 {
entry:
...
; Function Attrs: nofree nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none) uwtable
define dso_local void @dis_number(ptr noundef %n) local_unnamed_addr #20 {
entry:
  %0 = load i32, ptr @nbody, align 4, !tbaa !5
...
define dso_local i32 @dis2_number(ptr noundef %n, i32 noundef %prev_bodies, i32 noundef %tnperproc) local_unnamed_addr #22 {
entry:
  br label %tailrecurse
...
declare <2 x double> @llvm.floor.v2f64(<2 x double>) #25
...
attributes #8 = { nofree norecurse nosync nounwind memory(none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #18 = { nofree nounwind memory(write, argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #19 = { nofree nosync nounwind memory(argmem: read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #20 = { nofree nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #22 = { nofree nosync nounwind memory(argmem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
