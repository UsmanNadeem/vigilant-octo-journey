; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/treecc/parse.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/treecc/parse.c"
...
do.body:                                          ; preds = %do.body.preheader, %do.cond238
  %1 = phi i32 [ %.pre434, %do.body.preheader ], [ %163, %do.cond238 ]
...
sw.bb3:                                           ; preds = %do.body, %do.body, %do.body, %do.body, %do.body
  %.off419 = add nsw i32 %1, -31
  %switch351420 = icmp ult i32 %.off419, 3
  br i1 %switch351420, label %while.body, label %while.end

while.body:                                       ; preds = %sw.bb3, %while.body
  %36 = phi i32 [ %39, %while.body ], [ %1, %sw.bb3 ]
  %37 = phi ptr [ %38, %while.body ], [ %2, %sw.bb3 ]
  %flags.0421 = phi i32 [ %or20, %while.body ], [ 0, %sw.bb3 ]
  %switch.selectcmp = icmp eq i32 %36, 32
  %switch.select = select i1 %switch.selectcmp, i32 2, i32 4
  %switch.selectcmp449 = icmp eq i32 %36, 31
  %switch.select450 = select i1 %switch.selectcmp449, i32 3, i32 %switch.select
  %or20 = or i32 %flags.0421, %switch.select450
...
while.end:                                        ; preds = %while.body, %sw.bb3
  ...
  %.lcssa411 = phi ptr [ %2, %sw.bb3 ], [ %38, %while.body ]
  %.lcssa410 = phi i32 [ %1, %sw.bb3 ], [ %39, %while.body ]
  %and = lshr i32 %flags.0.lcssa, 1
  %40 = and i32 %and, 1
  %41 = xor i32 %40, 1
  %spec.select = or i32 %41, %flags.0.lcssa
  switch i32 %.lcssa410, label %cleanup [
    i32 2, label %if.then34
    i32 4, label %if.then41
  ]

if.then34:                                        ; preds = %while.end
  %call36 = tail call ptr @TreeCCValue(ptr noundef nonnull %.lcssa411) #11
  tail call void @TreeCCAddLiteralDefn(ptr noundef nonnull %context, ptr noundef %call36, i32 noundef %spec.select) #11
  br label %sw.epilog

if.then41:                                        ; preds = %while.end
  %call43 = tail call ptr @TreeCCValue(ptr noundef nonnull %.lcssa411) #11
...
cleanup:                                          ; preds = %while.end
  tail call void (ptr, ptr, ...) @TreeCCError(ptr noundef nonnull %.lcssa411, ptr noundef nonnull @.str) #11
  br label %do.cond238
...
for.end.i363:                                     ; preds = %for.cond.i361
  ...
  %or.cond887.not.i = icmp eq i32 %59, 3
  br i1 %or.cond887.not.i, label %if.then20.i, label %if.end22.i
...
if.end49.i:                                       ; preds = %if.end45.i, %if.end37.i
  ...
  br i1 %cmp51.i, label %land.lhs.true52.i, label %if.end203.i

land.lhs.true52.i:                                ; preds = %if.end49.i
  %67 = load i32, ptr %language.i, align 4, !tbaa !45
  %cmp53.i = icmp eq i32 %67, 3
  br i1 %cmp53.i, label %if.then54.i, label %if.end203.i

if.then54.i:                                      ; preds = %land.lhs.true52.i
  %tobool55.not.i = icmp eq ptr %className.0.i, null
  br i1 %tobool55.not.i, label %if.end203.sink.split.i, label %if.else57.i

if.else57.i:                                      ; preds = %if.then54.i
  %call192.i = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %className.0.i, ptr noundef nonnull dereferenceable(1) %66) #11
  %tobool199.not.i = icmp eq i32 %call192.i, 0
  br i1 %tobool199.not.i, label %if.end203.sink.split.i, label %if.end203.i

if.end203.sink.split.i:                           ; preds = %if.else57.i, %if.then54.i
...
if.end203.i:                                      ; preds = %if.end203.sink.split.i, %if.else57.i, %land.lhs.true52.i, %if.end49.i
  %68 = load i32, ptr %2, align 8, !tbaa !11
  %cmp205.i = icmp eq i32 %68, 5
  br i1 %cmp205.i, label %if.then207.i, label %if.else433.i

if.then207.i:                                     ; preds = %if.end203.i
  %call208.i = tail call i32 @TreeCCNextToken(ptr noundef nonnull %2) #11
  br label %while.cond.i369

while.cond.i369:                                  ; preds = %while.cond.i369.backedge, %if.then207.i
  %numTriggers.0.i = phi i32 [ 0, %if.then207.i ], [ %numTriggers.1.i, %while.cond.i369.backedge ]
  %lastParam.0.i = phi ptr [ null, %if.then207.i ], [ %lastParam.1.i, %while.cond.i369.backedge ]
  %params.0.i = phi ptr [ null, %if.then207.i ], [ %params.2.i, %while.cond.i369.backedge ]
  %69 = load i32, ptr %2, align 8, !tbaa !11
  switch i32 %69, label %while.end.i374 [
    i32 1, label %while.body.i370
    i32 9, label %while.body.i370
  ]

while.body.i370:                                  ; preds = %while.cond.i369, %while.cond.i369
  %cmp218.i = icmp eq i32 %69, 1
  br i1 %cmp218.i, label %if.then220.i, label %if.else221.i

if.then220.i:                                     ; preds = %while.body.i370
...
if.else221.i:                                     ; preds = %while.body.i370
  %call222.i = tail call i32 @TreeCCNextToken(ptr noundef nonnull %2) #11
  call fastcc void @ParseTypeAndName(ptr noundef nonnull %2, ptr noundef nonnull %paramType.i, ptr noundef nonnull %paramName.i)
  %70 = load i32, ptr %2, align 8, !tbaa !11
  %cmp224.i = icmp eq i32 %70, 10
  br i1 %cmp224.i, label %if.then226.i, label %if.else228.i

if.then226.i:                                     ; preds = %if.else221.i
  %call227.i = tail call i32 @TreeCCNextToken(ptr noundef nonnull %2) #11
  br label %if.end229.i

if.else228.i:                                     ; preds = %if.else221.i
  tail call void (ptr, ptr, ...) @TreeCCError(ptr noundef nonnull %2, ptr noundef nonnull @.str.27) #11
  br label %if.end229.i

if.end229.i:                                      ; preds = %if.else228.i, %if.then226.i
  %inc.i = add nsw i32 %numTriggers.0.i, 1
  br label %if.end230.i

if.end230.i:                                      ; preds = %if.end229.i, %if.then220.i
  %paramFlags.0.i = phi i32 [ 0, %if.then220.i ], [ 1, %if.end229.i ]
  %numTriggers.1.i = phi i32 [ %numTriggers.0.i, %if.then220.i ], [ %inc.i, %if.end229.i ]
  %71 = load ptr, ptr %paramType.i, align 8, !tbaa !26
  %tobool231.not.i = icmp eq ptr %71, null
  br i1 %tobool231.not.i, label %if.then232.i, label %cond.end376.i
...
cond.end376.i:                                    ; preds = %if.end230.i
  %call371.i = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %71, ptr noundef nonnull dereferenceable(5) @.str.34) #11
  %tobool378.not.i = icmp eq i32 %call371.i, 0
  br i1 %tobool378.not.i, label %if.then379.i, label %if.else383.i

if.then379.i:                                     ; preds = %cond.end376.i
  tail call void @free(ptr noundef nonnull %71) #11
  %72 = load ptr, ptr %paramName.i, align 8, !tbaa !26
  %tobool380.not.i = icmp eq ptr %72, null
  br i1 %tobool380.not.i, label %if.end409.i, label %if.then381.i

if.then381.i:                                     ; preds = %if.then379.i
  tail call void @free(ptr noundef nonnull %72) #11
  br label %if.end409.i

if.else383.i:                                     ; preds = %cond.end376.i
  %call384.i = tail call noalias dereferenceable_or_null(32) ptr @malloc(i64 noundef 32) #12
  %tobool385.not.i = icmp eq ptr %call384.i, null
  br i1 %tobool385.not.i, label %if.then386.i, label %if.end387.i

if.then386.i:                                     ; preds = %if.else383.i
  tail call void @TreeCCOutOfMemory(ptr noundef nonnull %2) #11
  br label %if.end387.i

if.end387.i:                                      ; preds = %if.then386.i, %if.else383.i
  %73 = load ptr, ptr %paramName.i, align 8, !tbaa !26
  store ptr %73, ptr %call384.i, align 8, !tbaa !46
  %type.i = getelementptr inbounds %struct._tagTreeCCParam, ptr %call384.i, i64 0, i32 1
  store ptr %71, ptr %type.i, align 8, !tbaa !29
  %flags389.i = getelementptr inbounds %struct._tagTreeCCParam, ptr %call384.i, i64 0, i32 2
  store i32 %paramFlags.0.i, ptr %flags389.i, align 8, !tbaa !27
  %size.i = getelementptr inbounds %struct._tagTreeCCParam, ptr %call384.i, i64 0, i32 3
  store i32 0, ptr %size.i, align 4, !tbaa !47
  %next.i = getelementptr inbounds %struct._tagTreeCCParam, ptr %call384.i, i64 0, i32 4
  store ptr null, ptr %next.i, align 8, !tbaa !48
  %tobool390.not.i = icmp eq ptr %lastParam.0.i, null
  br i1 %tobool390.not.i, label %if.end394.i, label %if.then391.i

if.then391.i:                                     ; preds = %if.end387.i
  %next392.i = getelementptr inbounds %struct._tagTreeCCParam, ptr %lastParam.0.i, i64 0, i32 4
  store ptr %call384.i, ptr %next392.i, align 8, !tbaa !48
  br label %if.end394.i

if.end394.i:                                      ; preds = %if.then391.i, %if.end387.i
  %params.1.i = phi ptr [ %params.0.i, %if.then391.i ], [ %call384.i, %if.end387.i ]
  br i1 %cmp218.i, label %if.end409.i, label %if.then398.i

if.then398.i:                                     ; preds = %if.end394.i
  %call399.i = tail call ptr @TreeCCNodeFindByType(ptr noundef %context, ptr noundef nonnull %71) #11
  %cmp400.i = icmp eq ptr %call399.i, null
  br i1 %cmp400.i, label %if.then402.i, label %if.else403.i

if.then402.i:                                     ; preds = %if.then398.i
  tail call void (ptr, ptr, ...) @TreeCCError(ptr noundef nonnull %2, ptr noundef nonnull @.str.35, ptr noundef nonnull %71) #11
  br label %if.end409.i

if.else403.i:                                     ; preds = %if.then398.i
  %74 = load ptr, ptr %filename23.i, align 8, !tbaa !14
  %75 = load i64, ptr %linenum24.i, align 8, !tbaa !15
  %call.i.i371 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %71) #13
  %conv.i.i = trunc i64 %call.i.i371 to i32
  %76 = load i32, ptr %language.i, align 4, !tbaa !45
  %switch.i.i = icmp ult i32 %76, 2
  br i1 %switch.i.i, label %if.then.i.i373, label %if.end409.i

if.then.i.i373:                                   ; preds = %if.else403.i
  %flags.i.i372 = getelementptr inbounds %struct._tagTreeCCNode, ptr %call399.i, i64 0, i32 5
  %77 = load i32, ptr %flags.i.i372, align 8, !tbaa !49
  %78 = and i32 %77, 24
  %or.cond.i.i = icmp eq i32 %78, 0
  br i1 %or.cond.i.i, label %if.then11.i.i, label %if.end409.i

if.then11.i.i:                                    ; preds = %if.then.i.i373
...
lor.lhs.false14.i.i:                              ; preds = %if.then11.i.i
  %sub.i.i = add i64 %call.i.i371, 4294967295
...
lor.lhs.false18.i.i:                              ; preds = %lor.lhs.false14.i.i
  %sub19.i.i = add i64 %call.i.i371, 4294967294
  ...
  br i1 %cmp23.not.i.i, label %if.end409.i, label %if.then25.i.i
...
if.end409.i:                                      ; preds = %if.then25.i.i, %lor.lhs.false18.i.i, %if.then.i.i373, %if.else403.i, %if.then402.i, %if.end394.i, %if.then381.i, %if.then379.i, %if.then232.i
  %lastParam.1.i = phi ptr [ %call384.i, %if.then402.i ], [ %call384.i, %if.end394.i ], [ %lastParam.0.i, %if.then381.i ], [ %lastParam.0.i, %if.then379.i ], [ %lastParam.0.i, %if.then232.i ], [ %call384.i, %if.else403.i ], [ %call384.i, %if.then.i.i373 ], [ %call384.i, %lor.lhs.false18.i.i ], [ %call384.i, %if.then25.i.i ]
  %params.2.i = phi ptr [ %params.1.i, %if.then402.i ], [ %params.1.i, %if.end394.i ], [ %params.0.i, %if.then381.i ], [ %params.0.i, %if.then379.i ], [ %params.0.i, %if.then232.i ], [ %params.1.i, %if.else403.i ], [ %params.1.i, %if.then.i.i373 ], [ %params.1.i, %lor.lhs.false18.i.i ], [ %params.1.i, %if.then25.i.i ]
  %82 = load i32, ptr %2, align 8, !tbaa !11
  %cmp411.i = icmp eq i32 %82, 11
  br i1 %cmp411.i, label %if.then413.i, label %while.end.i374

if.then413.i:                                     ; preds = %if.end409.i
  %call414.i = tail call i32 @TreeCCNextToken(ptr noundef nonnull %2) #11
  %83 = load i32, ptr %2, align 8, !tbaa !11
  switch i32 %83, label %if.then422.i [
    i32 1, label %while.cond.i369.backedge
    i32 9, label %while.cond.i369.backedge
  ]

if.then422.i:                                     ; preds = %if.then413.i
  tail call void (ptr, ptr, ...) @TreeCCError(ptr noundef nonnull %2, ptr noundef nonnull @.str.33) #11
  br label %while.cond.i369.backedge

while.cond.i369.backedge:                         ; preds = %if.then422.i, %if.then413.i, %if.then413.i
  br label %while.cond.i369, !llvm.loop !51

while.end.i374:                                   ; preds = %if.end409.i, %while.cond.i369
  %84 = phi i32 [ %69, %while.cond.i369 ], [ %82, %if.end409.i ]
  %numTriggers.2.i = phi i32 [ %numTriggers.0.i, %while.cond.i369 ], [ %numTriggers.1.i, %if.end409.i ]
  %params.3.i = phi ptr [ %params.0.i, %while.cond.i369 ], [ %params.2.i, %if.end409.i ]
  %cmp427.i = icmp eq i32 %84, 6
  br i1 %cmp427.i, label %if.then429.i, label %if.else431.i

if.then429.i:                                     ; preds = %while.end.i374
  %call430.i = tail call i32 @TreeCCNextToken(ptr noundef nonnull %2) #11
  br label %if.end434.i

if.else431.i:                                     ; preds = %while.end.i374
  tail call void (ptr, ptr, ...) @TreeCCError(ptr noundef nonnull %2, ptr noundef nonnull @.str.13) #11
  br label %if.end434.i

if.else433.i:                                     ; preds = %if.end203.i
  tail call void (ptr, ptr, ...) @TreeCCError(ptr noundef nonnull %2, ptr noundef nonnull @.str.14) #11
  br label %if.end434.i

if.end434.i:                                      ; preds = %if.else433.i, %if.else431.i, %if.then429.i
  %numTriggers.3.i = phi i32 [ %numTriggers.2.i, %if.then429.i ], [ %numTriggers.2.i, %if.else431.i ], [ 0, %if.else433.i ]
  %params.4.i = phi ptr [ %params.3.i, %if.then429.i ], [ %params.3.i, %if.else431.i ], [ null, %if.else433.i ]
  %85 = load i32, ptr %2, align 8, !tbaa !11
  %cmp436.i = icmp eq i32 %85, 12
  br i1 %cmp436.i, label %if.then438.i, label %if.else448.i

if.then438.i:                                     ; preds = %if.end434.i
  %call439.i = tail call i32 @TreeCCNextToken(ptr noundef nonnull %2) #11
  %86 = load i32, ptr %2, align 8, !tbaa !11
  %cmp441.i = icmp eq i32 %86, 3
  br i1 %cmp441.i, label %if.then443.i, label %if.else446.i

if.then443.i:                                     ; preds = %if.then438.i
  %call444.i = tail call ptr @TreeCCValue(ptr noundef nonnull %2) #11
  %call445.i = tail call i32 @TreeCCNextToken(ptr noundef nonnull %2) #11
  br label %if.end601thread-pre-split.i

if.else446.i:                                     ; preds = %if.then438.i
  tail call void (ptr, ptr, ...) @TreeCCError(ptr noundef nonnull %2, ptr noundef nonnull @.str.36) #11
  br label %if.end601thread-pre-split.i

if.else448.i:                                     ; preds = %if.end434.i
  br i1 %cmp51.i, label %cond.end595.i, label %if.end601.i

cond.end595.i:                                    ; preds = %if.else448.i
  %call590.i = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %62, ptr noundef nonnull dereferenceable(5) @.str.34) #11
  %cmp597.not.i = icmp eq i32 %call590.i, 0
  br i1 %cmp597.not.i, label %if.end601thread-pre-split.i, label %if.then599.i

if.then599.i:                                     ; preds = %cond.end595.i
  tail call void (ptr, ptr, ...) @TreeCCError(ptr noundef nonnull %2, ptr noundef nonnull @.str.37) #11
  br label %if.end601thread-pre-split.i

if.end601thread-pre-split.i:                      ; preds = %if.then599.i, %cond.end595.i, %if.else446.i, %if.then443.i
  %defValue.0.ph.i = phi ptr [ null, %cond.end595.i ], [ null, %if.then599.i ], [ null, %if.else446.i ], [ %call444.i, %if.then443.i ]
  %.pr.i375 = load i32, ptr %2, align 8, !tbaa !11
  br label %if.end601.i

if.end601.i:                                      ; preds = %if.end601thread-pre-split.i, %if.else448.i
  %87 = phi i32 [ %.pr.i375, %if.end601thread-pre-split.i ], [ %85, %if.else448.i ]
  %defValue.0.i = phi ptr [ %defValue.0.ph.i, %if.end601thread-pre-split.i ], [ null, %if.else448.i ]
  %cmp603.i = icmp eq i32 %87, 15
  br i1 %cmp603.i, label %if.then605.i, label %if.end607.i

if.then605.i:                                     ; preds = %if.end601.i
  %call606.i = tail call i32 @TreeCCNextToken(ptr noundef nonnull %2) #11
  br label %if.end607.i

if.end607.i:                                      ; preds = %if.then605.i, %if.end601.i
  %cmp608.i = icmp eq i32 %numTriggers.3.i, 0
  %cmp611.i = icmp ne ptr %params.4.i, null
  %or.cond722.i = select i1 %cmp608.i, i1 %cmp611.i, i1 false
  br i1 %or.cond722.i, label %if.then613.i, label %if.end625.i

if.then613.i:                                     ; preds = %if.end607.i
  %flags614.i = getelementptr inbounds %struct._tagTreeCCParam, ptr %params.4.i, i64 0, i32 2
  %88 = load i32, ptr %flags614.i, align 8, !tbaa !27
  %or615.i = or i32 %88, 1
  store i32 %or615.i, ptr %flags614.i, align 8, !tbaa !27
  %type616.i = getelementptr inbounds %struct._tagTreeCCParam, ptr %params.4.i, i64 0, i32 1
  %89 = load ptr, ptr %type616.i, align 8, !tbaa !29
  %call617.i = tail call ptr @TreeCCNodeFindByType(ptr noundef %context, ptr noundef %89) #11
  %cmp618.i = icmp eq ptr %call617.i, null
  %90 = load ptr, ptr %type616.i, align 8, !tbaa !29
  br i1 %cmp618.i, label %if.then620.i, label %if.else622.i

if.then620.i:                                     ; preds = %if.then613.i
...
if.else622.i:                                     ; preds = %if.then613.i
  %call.i888.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %90) #13
  %conv.i889.i = trunc i64 %call.i888.i to i32
  %91 = load i32, ptr %language.i, align 4, !tbaa !45
  %switch.i891.i = icmp ult i32 %91, 2
  br i1 %switch.i891.i, label %if.then.i894.i, label %if.end625.i

if.then.i894.i:                                   ; preds = %if.else622.i
  %flags.i892.i = getelementptr inbounds %struct._tagTreeCCNode, ptr %call617.i, i64 0, i32 5
  %92 = load i32, ptr %flags.i892.i, align 8, !tbaa !49
  %93 = and i32 %92, 24
  %or.cond.i893.i = icmp eq i32 %93, 0
  br i1 %or.cond.i893.i, label %if.then11.i896.i, label %if.end625.i

if.then11.i896.i:                                 ; preds = %if.then.i894.i
  %cmp12.i895.i = icmp slt i32 %conv.i889.i, 2
  br i1 %cmp12.i895.i, label %if.then25.i908.i, label %lor.lhs.false14.i901.i

lor.lhs.false14.i901.i:                           ; preds = %if.then11.i896.i
  %sub.i897.i = add i64 %call.i888.i, 4294967295
  %idxprom.i898.i = and i64 %sub.i897.i, 4294967295
  %arrayidx.i899.i = getelementptr inbounds i8, ptr %90, i64 %idxprom.i898.i
  %94 = load i8, ptr %arrayidx.i899.i, align 1, !tbaa !50
  %cmp16.not.i900.i = icmp eq i8 %94, 42
  br i1 %cmp16.not.i900.i, label %lor.lhs.false18.i906.i, label %if.then25.i908.i

lor.lhs.false18.i906.i:                           ; preds = %lor.lhs.false14.i901.i
  %sub19.i902.i = add i64 %call.i888.i, 4294967294
  %idxprom20.i903.i = and i64 %sub19.i902.i, 4294967295
  %arrayidx21.i904.i = getelementptr inbounds i8, ptr %90, i64 %idxprom20.i903.i
  %95 = load i8, ptr %arrayidx21.i904.i, align 1, !tbaa !50
  %cmp23.not.i905.i = icmp eq i8 %95, 32
  br i1 %cmp23.not.i905.i, label %if.end625.i, label %if.then25.i908.i

if.then25.i908.i:                                 ; preds = %lor.lhs.false18.i906.i, %lor.lhs.false14.i901.i, %if.then11.i896.i
...
if.end625.i:                                      ; preds = %if.then25.i908.i, %lor.lhs.false18.i906.i, %if.then.i894.i, %if.else622.i, %if.then620.i, %if.end607.i
  %numTriggers.4.i = phi i32 [ 1, %if.then620.i ], [ %numTriggers.3.i, %if.end607.i ], [ 1, %if.else622.i ], [ 1, %if.then.i894.i ], [ 1, %lor.lhs.false18.i906.i ], [ 1, %if.then25.i908.i ]
  br i1 %cmp51.i, label %if.end662.i, label %if.then629.i

if.then629.i:                                     ; preds = %if.end625.i
  %tobool630.i = icmp eq ptr %params.4.i, null
  %cmp632.i = icmp ne i32 %numTriggers.4.i, 1
  %or.cond723.i = select i1 %tobool630.i, i1 true, i1 %cmp632.i
  br i1 %or.cond723.i, label %if.then639.i, label %lor.lhs.false634.i

lor.lhs.false634.i:                               ; preds = %if.then629.i
  %flags635.i = getelementptr inbounds %struct._tagTreeCCParam, ptr %params.4.i, i64 0, i32 2
  %97 = load i32, ptr %flags635.i, align 8, !tbaa !27
  %and636.i = and i32 %97, 1
  %cmp637.i = icmp eq i32 %and636.i, 0
  br i1 %cmp637.i, label %if.else642.i, label %if.else645.i

if.then639.i:                                     ; preds = %if.then629.i
  br i1 %cmp611.i, label %if.else642.i, label %if.end643.i

if.else642.i:                                     ; preds = %if.then639.i, %lor.lhs.false634.i
  br label %if.end643.i

if.end643.i:                                      ; preds = %if.else642.i, %if.then639.i
  %.str.39.sink.i = phi ptr [ @.str.39, %if.else642.i ], [ @.str.38, %if.then639.i ]
  tail call void (ptr, ptr, ...) @TreeCCError(ptr noundef nonnull %2, ptr noundef nonnull %.str.39.sink.i) #11
  %and644.i = and i32 %flags.2.i364, -2
  br label %if.end662.i

if.else645.i:                                     ; preds = %lor.lhs.false634.i
  %type646.i = getelementptr inbounds %struct._tagTreeCCParam, ptr %params.4.i, i64 0, i32 1
  %98 = load ptr, ptr %type646.i, align 8, !tbaa !29
  %call647.i = tail call ptr @TreeCCNodeFindByType(ptr noundef %context, ptr noundef %98) #11
  %cmp648.i = icmp eq ptr %call647.i, null
  br i1 %cmp648.i, label %if.then650.i, label %if.else652.i

if.then650.i:                                     ; preds = %if.else645.i
  %and651.i = and i32 %flags.2.i364, -2
  br label %if.end662.i

if.else652.i:                                     ; preds = %if.else645.i
  %flags653.i = getelementptr inbounds %struct._tagTreeCCNode, ptr %call647.i, i64 0, i32 5
  %99 = load i32, ptr %flags653.i, align 8, !tbaa !49
  %and654.i = and i32 %99, 8
  %cmp655.not.i = icmp eq i32 %and654.i, 0
  br i1 %cmp655.not.i, label %if.end662.i, label %if.then657.i

if.then657.i:                                     ; preds = %if.else652.i
  tail call void (ptr, ptr, ...) @TreeCCError(ptr noundef nonnull %2, ptr noundef nonnull @.str.40) #11
  %and658.i = and i32 %flags.2.i364, -2
  br label %if.end662.i

if.end662.i:                                      ; preds = %if.then657.i, %if.else652.i, %if.then650.i, %if.end643.i, %if.end625.i
  %flags.3.i = phi i32 [ %and644.i, %if.end643.i ], [ %and651.i, %if.then650.i ], [ %and658.i, %if.then657.i ], [ %flags.2.i364, %if.else652.i ], [ %flags.2.i364, %if.end625.i ]
  %call663.i = tail call ptr @TreeCCOperationFind(ptr noundef %context, ptr noundef %66) #11
  %cmp664.not.i = icmp eq ptr %call663.i, null
  br i1 %cmp664.not.i, label %if.end691.i, label %if.then666.i

if.then666.i:                                     ; preds = %if.end662.i
  ...
  %filename667.i = getelementptr inbounds %struct._tagTreeCCOperation, ptr %call663.i, i64 0, i32 7
  %100 = load ptr, ptr %filename667.i, align 8, !tbaa !24
  %linenum668.i = getelementptr inbounds %struct._tagTreeCCOperation, ptr %call663.i, i64 0, i32 8
  %101 = load i64, ptr %linenum668.i, align 8, !tbaa !25
  ...
  %tobool669.not.i = icmp eq ptr %className.0.i, null
  br i1 %tobool669.not.i, label %if.end671.i, label %if.then670.i

if.then670.i:                                     ; preds = %if.then666.i
  tail call void @free(ptr noundef nonnull %className.0.i) #11
  br label %if.end671.i

if.end671.i:                                      ; preds = %if.then670.i, %if.then666.i
  %tobool672.not.i = icmp eq ptr %defValue.0.i, null
  br i1 %tobool672.not.i, label %if.end674.i, label %if.then673.i

if.then673.i:                                     ; preds = %if.end671.i
  tail call void @free(ptr noundef nonnull %defValue.0.i) #11
  br label %if.end674.i

if.end674.i:                                      ; preds = %if.then673.i, %if.end671.i
  %cmp676.not911.i = icmp eq ptr %params.4.i, null
  br i1 %cmp676.not911.i, label %ParseOperation.exit, label %while.body678.i

while.body678.i:                                  ; preds = %if.end674.i, %if.end689.i
  %params.5912.i = phi ptr [ %102, %if.end689.i ], [ %params.4.i, %if.end674.i ]
  %next679.i = getelementptr inbounds %struct._tagTreeCCParam, ptr %params.5912.i, i64 0, i32 4
  %102 = load ptr, ptr %next679.i, align 8, !tbaa !48
  %103 = load ptr, ptr %params.5912.i, align 8, !tbaa !46
  %tobool681.not.i = icmp eq ptr %103, null
  br i1 %tobool681.not.i, label %if.end684.i, label %if.then682.i

if.then682.i:                                     ; preds = %while.body678.i
  tail call void @free(ptr noundef nonnull %103) #11
  br label %if.end684.i

if.end684.i:                                      ; preds = %if.then682.i, %while.body678.i
  %type685.i = getelementptr inbounds %struct._tagTreeCCParam, ptr %params.5912.i, i64 0, i32 1
  %104 = load ptr, ptr %type685.i, align 8, !tbaa !29
  %tobool686.not.i = icmp eq ptr %104, null
  br i1 %tobool686.not.i, label %if.end689.i, label %if.then687.i

if.then687.i:                                     ; preds = %if.end684.i
  tail call void @free(ptr noundef nonnull %104) #11
  br label %if.end689.i

if.end689.i:                                      ; preds = %if.then687.i, %if.end684.i
  tail call void @free(ptr noundef nonnull %params.5912.i) #11
  %cmp676.not.i = icmp eq ptr %102, null
  br i1 %cmp676.not.i, label %ParseOperation.exit, label %while.body678.i, !llvm.loop !52

if.end691.i:                                      ; preds = %if.end662.i
  %call692.i = tail call ptr @TreeCCOperationCreate(ptr noundef %context, ptr noundef nonnull %62, ptr noundef %66, ptr noundef %className.0.i, ptr noundef %defValue.0.i, ptr noundef %params.4.i, i32 noundef %flags.3.i, i32 noundef %numTriggers.4.i, ptr noundef %60, i64 noundef %61) #11
  %and693.i = and i32 %flags.3.i, 1
  %cmp694.not.i = icmp eq i32 %and693.i, 0
  br i1 %cmp694.not.i, label %ParseOperation.exit, label %if.then696.i

if.then696.i:                                     ; preds = %if.end691.i
  %type697.i = getelementptr inbounds %struct._tagTreeCCParam, ptr %params.4.i, i64 0, i32 1
  %105 = load ptr, ptr %type697.i, align 8, !tbaa !29
  %call698.i = tail call ptr @TreeCCNodeFindByType(ptr noundef %context, ptr noundef %105) #11
  tail call void @TreeCCNodeAddVirtual(ptr noundef %context, ptr noundef %call698.i, ptr noundef %call692.i) #11
  br label %ParseOperation.exit

ParseOperation.exit:                              ; preds = %if.end689.i, %if.end33.i, %if.then35.i, %if.then44.i, %if.end674.i, %if.end691.i, %if.then696.i
...
sw.bb51:                                          ; preds = %do.body
  %call.i377 = tail call i32 @TreeCCNextToken(ptr noundef nonnull %2) #11
  %106 = load i32, ptr %2, align 8, !tbaa !11
  %cmp.not.i378 = icmp eq i32 %106, 1
  br i1 %cmp.not.i378, label %if.end.i380, label %if.then.i379

if.then.i379:                                     ; preds = %sw.bb51
  tail call void (ptr, ptr, ...) @TreeCCError(ptr noundef nonnull %2, ptr noundef nonnull @.str.44) #11
  br label %do.cond238

if.end.i380:                                      ; preds = %sw.bb51
...
if.then8.i:                                       ; preds = %if.end.i380
  %call9.i381 = tail call i32 @TreeCCNextToken(ptr noundef nonnull %2) #11
...
if.end19.i:                                       ; preds = %if.else.i, %if.then14.i, %if.end.i380
  %value.0.i = phi ptr [ %call15.i, %if.then14.i ], [ null, %if.else.i ], [ null, %if.end.i380 ]
  %bf.load.i = load i16, ptr %debugMode.i, align 8
  %111 = and i16 %bf.load.i, 1
  %tobool.not.i382 = icmp eq i16 %111, 0
  br i1 %tobool.not.i382, label %if.end25.i, label %if.then20.i384

if.then20.i384:                                   ; preds = %if.end19.i
  %tobool21.not.i383 = icmp eq ptr %value.0.i, null
  br i1 %tobool21.not.i383, label %if.else23.i, label %if.then22.i

if.then22.i:                                      ; preds = %if.then20.i384
...
if.else23.i:                                      ; preds = %if.then20.i384
...
if.end25.i:                                       ; preds = %if.else23.i, %if.then22.i, %if.end19.i
  ...
  %switch.tableidx462 = add i32 %call26.i, -2
  %112 = icmp ult i32 %switch.tableidx462, 4
  br i1 %112, label %switch.lookup461, label %if.end41.i

switch.lookup461:                                 ; preds = %if.end25.i
  %113 = sext i32 %switch.tableidx462 to i64
...
if.end41.i:                                       ; preds = %if.end25.i, %switch.lookup461
  tail call void @free(ptr noundef %call2.i) #11
  %cmp42.i = icmp ne i32 %call26.i, 1
  %tobool43.i = icmp ne ptr %value.0.i, null
  %or.cond.i385 = select i1 %cmp42.i, i1 %tobool43.i, i1 false
  br i1 %or.cond.i385, label %if.then44.i386, label %do.cond238

if.then44.i386:                                   ; preds = %if.end41.i
...
sw.bb125:                                         ; preds = %do.body
  %call.i388 = tail call i32 @TreeCCNextToken(ptr noundef nonnull %2) #11
  %136 = load i32, ptr %2, align 8, !tbaa !11
  %cmp.not.i389 = icmp eq i32 %136, 1
  br i1 %cmp.not.i389, label %if.end.i395, label %if.then.i390

if.then.i390:                                     ; preds = %sw.bb125
  tail call void (ptr, ptr, ...) @TreeCCError(ptr noundef nonnull %2, ptr noundef nonnull @.str.52) #11
  br label %do.cond238

if.end.i395:                                      ; preds = %sw.bb125
  %call2.i391 = tail call ptr @TreeCCValue(ptr noundef nonnull %2) #11
  %linenum.i392 = getelementptr inbounds %struct.TreeCCInput, ptr %2, i64 0, i32 5
  %137 = load i64, ptr %linenum.i392, align 8, !tbaa !15
  %call3.i393 = tail call ptr @TreeCCNodeCreate(ptr noundef nonnull %context, i64 noundef %137, ptr noundef %call2.i391, ptr noundef null, i32 noundef 14) #11
  %call4.i394 = tail call i32 @TreeCCNextToken(ptr noundef nonnull %2) #11
  %138 = load i32, ptr %2, align 8, !tbaa !11
  %cmp6.not.i = icmp eq i32 %138, 12
  br i1 %cmp6.not.i, label %if.end8.i, label %if.then7.i396

if.then7.i396:                                    ; preds = %if.end.i395
  tail call void (ptr, ptr, ...) @TreeCCError(ptr noundef nonnull %2, ptr noundef nonnull @.str.53) #11
  br label %do.cond238

if.end8.i:                                        ; preds = %if.end.i395
  %parseLiteral.i397 = getelementptr inbounds %struct.TreeCCInput, ptr %2, i64 0, i32 9
  store i32 0, ptr %parseLiteral.i397, align 8, !tbaa !42
  %call9.i398 = tail call i32 @TreeCCNextToken(ptr noundef nonnull %2) #11
  store i32 1, ptr %parseLiteral.i397, align 8, !tbaa !42
  %139 = load i32, ptr %2, align 8, !tbaa !11
  %cmp12.not.i399 = icmp eq i32 %139, 7
  br i1 %cmp12.not.i399, label %if.end14.i, label %if.then13.i
...
if.end14.i:                                       ; preds = %if.end8.i
  %call15.i400 = tail call i32 @TreeCCNextToken(ptr noundef nonnull %2) #11
  %140 = load i32, ptr %2, align 8, !tbaa !11
  %cmp1779.not.i = icmp eq i32 %140, 1
  br i1 %cmp1779.not.i, label %while.body.lr.ph.i, label %while.end.i405

while.body.lr.ph.i:                               ; preds = %if.end14.i
  %name20.i = getelementptr inbounds %struct._tagTreeCCNode, ptr %call3.i393, i64 0, i32 4
  br label %while.body.i402

while.body.i402:                                  ; preds = %if.end33.i404, %while.body.lr.ph.i
  %141 = load i64, ptr %linenum.i392, align 8, !tbaa !15
  %call19.i401 = tail call ptr @TreeCCValue(ptr noundef nonnull %2) #11
  %142 = load ptr, ptr %name20.i, align 8, !tbaa !30
  %call21.i = tail call ptr @TreeCCDupString(ptr noundef %142) #11
  %call22.i = tail call ptr @TreeCCNodeCreate(ptr noundef %context, i64 noundef %141, ptr noundef %call19.i401, ptr noundef %call21.i, i32 noundef 16) #11
  %call23.i = tail call i32 @TreeCCNextToken(ptr noundef nonnull %2) #11
  %143 = load i32, ptr %2, align 8, !tbaa !11
  switch i32 %143, label %while.end.i405 [
    i32 11, label %if.then26.i403
    i32 1, label %if.then30.i
  ]

if.then26.i403:                                   ; preds = %while.body.i402
  %call27.i = tail call i32 @TreeCCNextToken(ptr noundef nonnull %2) #11
  br label %if.end33.i404

if.then30.i:                                      ; preds = %while.body.i402
  tail call void (ptr, ptr, ...) @TreeCCError(ptr noundef nonnull %2, ptr noundef nonnull @.str.7) #11
  br label %if.end33.i404

if.end33.i404:                                    ; preds = %if.then30.i, %if.then26.i403
  %144 = load i32, ptr %2, align 8, !tbaa !11
  %cmp17.i = icmp eq i32 %144, 1
  br i1 %cmp17.i, label %while.body.i402, label %while.end.i405, !llvm.loop !59

while.end.i405:                                   ; preds = %if.end33.i404, %while.body.i402, %if.end14.i
  %145 = phi i32 [ %140, %if.end14.i ], [ %144, %if.end33.i404 ], [ %143, %while.body.i402 ]
  %cmp35.i = icmp eq i32 %145, 11
  br i1 %cmp35.i, label %if.then36.i, label %if.end38.i

if.then36.i:                                      ; preds = %while.end.i405
  %call37.i = tail call i32 @TreeCCNextToken(ptr noundef nonnull %2) #11
  br label %if.end38.i

if.end38.i:                                       ; preds = %if.then36.i, %while.end.i405
...
if.end40.i:                                       ; preds = %if.then39.i, %if.end38.i
  ...
  %cmp42.i406 = icmp eq i32 %146, 8
  br i1 %cmp42.i406, label %if.then43.i, label %if.else45.i
...
if.end143:                                        ; preds = %if.then140, %sw.bb131
  %150 = phi i32 [ %.pre436, %if.then140 ], [ %149, %sw.bb131 ]
  %151 = phi ptr [ %.pre435, %if.then140 ], [ %148, %sw.bb131 ]
...
if.then147:                                       ; preds = %if.end143
  ...
  %call153 = tail call ptr @fopen(ptr noundef %call152, ptr noundef nonnull @.str.3)
...
if.end161:                                        ; preds = %if.then159, %if.then155
  %155 = phi ptr [ %.pre437, %if.then159 ], [ %154, %if.then155 ]
...
do.body173:                                       ; preds = %do.body173, %sw.bb171
  %158 = phi ptr [ %159, %do.body173 ], [ %.pre438, %sw.bb171 ]
...
do.cond238:                                       ; preds = %while.body25.i, %do.body173, %do.body173, %do.body173, %do.body173, %do.body173, %do.body173, %do.body173, %do.body173, %do.body173, %do.body173, %do.body173, %do.body173, %do.body173, %do.body173, %do.body173, %if.else45.i, %if.then43.i, %if.then13.i, %if.then7.i396, %if.then.i390, %if.then44.i386, %if.end41.i, %if.then.i379, %cleanup, %if.end20.i, %if.end20.thread.i, %sw.epilog, %if.else122, %if.else108, %if.else72, %ParseOperation.exit, %ParseNode.exit
