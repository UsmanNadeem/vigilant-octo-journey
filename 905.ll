; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/spatscal.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/spatscal.c"
...
entry:
  ...
  %call5 = call ptr @fopen(ptr noundef nonnull %fname, ptr noundef nonnull @.str)
...
for.body20.us.us:                                 ; preds = %if.then15.us.us, %for.body20.us.us
  ...
  %call21.us.us = call i32 @_IO_getc(ptr noundef nonnull %call5)
...
for.body9.us.us:                                  ; preds = %for.body9.us.us, %for.cond7.preheader.us.us
  ...
  %call10.us.us = call i32 @_IO_getc(ptr noundef nonnull %call5)
...
for.body9.us:                                     ; preds = %for.cond7.preheader.us, %for.body9.us
  ...
  %call10.us = call i32 @_IO_getc(ptr noundef nonnull %call5)
...
if.then22:                                        ; preds = %for.end19
  ...
  %call31 = call ptr @fopen(ptr noundef nonnull %fname, ptr noundef nonnull @.str)
...
for.body43.us:                                    ; preds = %for.cond40.preheader.us, %for.body43.us
  ...
  %call44.us = call i32 @_IO_getc(ptr noundef nonnull %call31)
...
for.body.us.preheader.i:                          ; preds = %for.body.lr.ph.i
  ...
  %uglygep326 = getelementptr i8, ptr %fld0, i64 %0
  %uglygep328 = getelementptr i8, ptr %fld0, i64 %0
...
vector.memcheck:                                  ; preds = %for.body.us.i
  ...
  %9 = add i64 %3, %8
  %uglygep325 = getelementptr i8, ptr %tmp, i64 %9
  %uglygep = getelementptr i8, ptr %tmp, i64 %8
  %10 = add nsw i64 %cond.idx.us.i, %idx.ext3.us.i
  %uglygep327 = getelementptr i8, ptr %uglygep326, i64 %10
  %uglygep329 = getelementptr i8, ptr %uglygep328, i64 %idx.ext3.us.i
  %bound0 = icmp ult ptr %uglygep, %uglygep327
  %bound1 = icmp ult ptr %cond.us.i, %uglygep325
  %found.conflict = and i1 %bound0, %bound1
  %bound0330 = icmp ult ptr %uglygep, %uglygep329
  %bound1331 = icmp ult ptr %add.ptr4.us.i, %uglygep325
...
for.body.us.preheader.i138:                       ; preds = %for.body.lr.ph.i136
  ...
  %uglygep339 = getelementptr i8, ptr %fld1, i64 %30
  %uglygep341 = getelementptr i8, ptr %fld1, i64 %30
...
vector.memcheck336:                               ; preds = %for.body.us.i154
  ...
  %39 = add i64 %33, %38
  %uglygep338 = getelementptr i8, ptr %tmp, i64 %39
  %uglygep337 = getelementptr i8, ptr %tmp, i64 %38
  %40 = add nsw i64 %cond.idx.us.i147, %idx.ext3.us.i143
  %uglygep340 = getelementptr i8, ptr %uglygep339, i64 %40
  %uglygep342 = getelementptr i8, ptr %uglygep341, i64 %idx.ext3.us.i143
  %bound0343 = icmp ult ptr %uglygep337, %uglygep340
  %bound1344 = icmp ult ptr %cond.us.i148, %uglygep338
  %found.conflict345 = and i1 %bound0343, %bound1344
  %bound0346 = icmp ult ptr %uglygep337, %uglygep342
  %bound1347 = icmp ult ptr %add.ptr4.us.i144, %uglygep338
...
for.body.us.preheader.i178:                       ; preds = %for.body.lr.ph.i176
  ...
  %uglygep370 = getelementptr i8, ptr %fld0, i64 %59
  %uglygep372 = getelementptr i8, ptr %fld0, i64 %59
...
vector.memcheck367:                               ; preds = %for.body.us.i194
  ...
  %68 = add i64 %62, %67
  %uglygep369 = getelementptr i8, ptr %tmp, i64 %68
  %uglygep368 = getelementptr i8, ptr %tmp, i64 %67
  %69 = add nsw i64 %cond.idx.us.i187, %idx.ext3.us.i183
  %uglygep371 = getelementptr i8, ptr %uglygep370, i64 %69
  %uglygep373 = getelementptr i8, ptr %uglygep372, i64 %idx.ext3.us.i183
  %bound0374 = icmp ult ptr %uglygep368, %uglygep371
  %bound1375 = icmp ult ptr %cond.us.i188, %uglygep369
  %found.conflict376 = and i1 %bound0374, %bound1375
  %bound0377 = icmp ult ptr %uglygep368, %uglygep373
  %bound1378 = icmp ult ptr %add.ptr4.us.i184, %uglygep369
...
for.body.us.preheader.i218:                       ; preds = %for.body.lr.ph.i216
  ...
  %uglygep401 = getelementptr i8, ptr %fld0, i64 %88
  %uglygep403 = getelementptr i8, ptr %fld0, i64 %88
...
vector.memcheck398:                               ; preds = %for.body.us.i234
  ...
  %97 = add i64 %91, %96
  %uglygep400 = getelementptr i8, ptr %tmp, i64 %97
  %uglygep399 = getelementptr i8, ptr %tmp, i64 %96
  %98 = add nsw i64 %cond.idx.us.i227, %idx.ext3.us.i223
  %uglygep402 = getelementptr i8, ptr %uglygep401, i64 %98
  %uglygep404 = getelementptr i8, ptr %uglygep403, i64 %idx.ext3.us.i223
  %bound0405 = icmp ult ptr %uglygep399, %uglygep402
  %bound1406 = icmp ult ptr %cond.us.i228, %uglygep400
  %found.conflict407 = and i1 %bound0405, %bound1406
  %bound0408 = icmp ult ptr %uglygep399, %uglygep404
  %bound1409 = icmp ult ptr %add.ptr4.us.i224, %uglygep400
...
for.body.us.preheader.i258:                       ; preds = %for.body.lr.ph.i256
  ...
  %uglygep434 = getelementptr i8, ptr %fld1, i64 %117
  %uglygep436 = getelementptr i8, ptr %fld1, i64 %117
...
vector.memcheck429:                               ; preds = %for.body.us.i274
  ...
  %127 = add i64 %121, %126
  %uglygep433 = getelementptr i8, ptr %tmp, i64 %127
  %128 = add i64 %119, %126
  %uglygep432 = getelementptr i8, ptr %tmp, i64 %128
  %129 = add nsw i64 %cond.idx.us.i267, %idx.ext3.us.i263
  %uglygep435 = getelementptr i8, ptr %uglygep434, i64 %129
  %uglygep437 = getelementptr i8, ptr %uglygep436, i64 %idx.ext3.us.i263
  %bound0438 = icmp ult ptr %uglygep432, %uglygep435
  %bound1439 = icmp ult ptr %cond.us.i268, %uglygep433
  %found.conflict440 = and i1 %bound0438, %bound1439
  %bound0441 = icmp ult ptr %uglygep432, %uglygep437
  %bound1442 = icmp ult ptr %add.ptr4.us.i264, %uglygep433
