; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/splay2.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/splay2.c"
...
define dso_local ptr @CHfind(ptr noundef readonly %root, ptr noundef readonly byval(%struct.key) align 8 %key) local_unnamed_addr #0 {
entry:
