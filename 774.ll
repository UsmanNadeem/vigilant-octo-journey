; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/McCat/05-eks/MM.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/McCat/05-eks/MM.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

; Function Attrs: nofree nounwind memory(readwrite, argmem: write) uwtable
define dso_local noalias ptr @MakeMatrix(i32 noundef %i) local_unnamed_addr #0 {
entry:
  %call = tail call ptr @newMatrix()
  %0 = sext i32 %i to i64
  br label %for.body3.lr.ph

for.body3.lr.ph:                                  ; preds = %for.inc28, %entry
  %indvars.iv = phi i64 [ 0, %entry ], [ %indvars.iv.next, %for.inc28 ]
  %arrayidx25 = getelementptr inbounds ptr, ptr %call, i64 %indvars.iv
  %1 = load ptr, ptr %arrayidx25, align 8, !tbaa !5
  br label %for.body3

for.body3:                                        ; preds = %for.body3.lr.ph, %for.inc
  %indvars.iv55 = phi i64 [ %indvars.iv, %for.body3.lr.ph ], [ %indvars.iv.next56, %for.inc ]
  %2 = sub nuw nsw i64 %indvars.iv55, %indvars.iv
  %cmp5 = icmp sgt i64 %2, %0
  br i1 %cmp5, label %for.inc, label %if.else

if.else:                                          ; preds = %for.body3
  %3 = sub nsw i64 %indvars.iv, %indvars.iv55
...
for.inc:                                          ; preds = %for.body3, %if.else
  ...
  %arrayidx7 = getelementptr inbounds double, ptr %5, i64 %indvars.iv
  store double %.sink63, ptr %arrayidx7, align 8, !tbaa !9
  %arrayidx11 = getelementptr inbounds double, ptr %1, i64 %indvars.iv55
...
for.inc28:                                        ; preds = %for.inc
  ...
  br i1 %exitcond61.not, label %for.end30, label %for.body3.lr.ph, !llvm.loop !13
...
define dso_local noalias ptr @newMatrix() local_unnamed_addr #1 {
entry:
...
; Function Attrs: nofree nounwind memory(readwrite, argmem: write) uwtable
define dso_local noalias ptr @newIdMatrix() local_unnamed_addr #0 {
entry:
  %call = tail call ptr @newMatrix()
  br label %for.body3.lr.ph.i

for.body3.lr.ph.i:                                ; preds = %for.inc15.i, %entry
...
for.body3.i:                                      ; preds = %for.inc.i, %for.body3.lr.ph.i
  %indvars.iv34.i = phi i64 [ %indvars.iv.i, %for.body3.lr.ph.i ], [ %indvars.iv.next35.i, %for.inc.i ]
...
for.inc.i:                                        ; preds = %if.else.i, %for.body3.i
  ...
  br i1 %exitcond.not.i, label %for.inc15.i, label %for.body3.i, !llvm.loop !19

for.inc15.i:                                      ; preds = %for.inc.i
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond38.not.i = icmp eq i64 %indvars.iv.next.i, 51
  br i1 %exitcond38.not.i, label %MakeID.exit, label %for.body3.lr.ph.i, !llvm.loop !20

MakeID.exit:                                      ; preds = %for.inc15.i
  ret ptr %call
}
...
for.body3:                                        ; preds = %for.body3.lr.ph, %for.inc
  %indvars.iv34 = phi i64 [ %indvars.iv, %for.body3.lr.ph ], [ %indvars.iv.next35, %for.inc ]
...
for.inc:                                          ; preds = %for.body3, %if.else
  ...
  br i1 %exitcond.not, label %for.inc15, label %for.body3, !llvm.loop !19

for.inc15:                                        ; preds = %for.inc
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond38.not = icmp eq i64 %indvars.iv.next, 51
  br i1 %exitcond38.not, label %for.end17, label %for.body3.lr.ph, !llvm.loop !20
...
define dso_local void @freeMatrix(ptr nocapture noundef %A) local_unnamed_addr #9 {
entry:
...
attributes #1 = { nofree nounwind memory(write, argmem: none, inaccessiblemem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
