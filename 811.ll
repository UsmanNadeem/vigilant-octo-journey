; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/fuloop.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/fuloop.c"
...
cond.end107:                                      ; preds = %cond.true99, %cond.false102, %cond.true92
  ...
  %39 = insertelement <2 x i32> poison, i32 %cond108, i64 0
  %40 = insertelement <2 x i32> %39, i32 %cond69, i64 1
  %41 = sub <2 x i32> <i32 1, i32 1>, %40
  %mul131 = mul nsw i32 %add, 1103515245
  %add132 = add nsw i32 %mul131, 12345
  %42 = insertelement <2 x i32> poison, i32 %cond127, i64 0
  %43 = insertelement <2 x i32> %42, i32 %cond88, i64 1
  %44 = add <2 x i32> %41, %43
