; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/UnitTests/conditional-gnu-ext-cxx.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/UnitTests/conditional-gnu-ext-cxx.cpp"
...
_Z4condv.exit.else:                               ; preds = %_Z4condv.exit
  %.op = add nsw i32 %2, 1
  store i32 %.op, ptr @global, align 4, !tbaa !5
  %3 = add nsw i32 %2, -1
  br label %_Z4condv.exit.cont

_Z4condv.exit.cont:                               ; preds = %_Z4condv.exit, %_Z4condv.exit.else
  %sub = phi i32 [ -2, %_Z4condv.exit ], [ %3, %_Z4condv.exit.else ]
  ret i32 %sub
}
