; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Bullet/btConvexConcaveCollisionAlgorithm.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Bullet/btConvexConcaveCollisionAlgorithm.cpp"
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil
  ...
  br i1 %epil.iter.cmp.not, label %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i, label %for.body.i.i.i.epil, !llvm.loop !34
...
_ZN20btAlignedObjectArrayIP20btPersistentManifoldE10deallocateEv.exit.i.i: ; preds = %if.then3.i.i.i, %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i
  ...
  %.pre = load ptr, ptr %m_manifoldPtr, align 8, !tbaa !33
...
_ZN20btAlignedObjectArrayIP20btPersistentManifoldE9push_backERKS1_.exit: ; preds = %if.then, %if.then.i, %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE10deallocateEv.exit.i.i
  ...
  store ptr %17, ptr %arrayidx.i, align 8, !tbaa !33
...
entry:
  %m_isSwapped = getelementptr inbounds %class.btConvexConcaveCollisionAlgorithm, ptr %this, i64 0, i32 1
  %0 = load i8, ptr %m_isSwapped, align 8, !tbaa !8, !range !67, !noundef !68
...
if.then12:                                        ; preds = %if.then
  ...
  %m_btConvexTriangleCallback = getelementptr inbounds %class.btConvexConcaveCollisionAlgorithm, ptr %this, i64 0, i32 2
  %m_manifoldPtr = getelementptr inbounds %class.btConvexConcaveCollisionAlgorithm, ptr %this, i64 0, i32 2, i32 10
  %8 = load ptr, ptr %m_manifoldPtr, align 8, !tbaa !27
  ...
  %9 = load ptr, ptr %m_manifoldPtr, align 8, !tbaa !27
...
; Function Attrs: uwtable
define dso_local noundef float @_ZN33btConvexConcaveCollisionAlgorithm21calculateTimeOfImpactEP17btCollisionObjectS1_RK16btDispatcherInfoP16btManifoldResult(ptr nocapture noundef nonnull readonly align 8 dereferenceable(120) %this, ptr noundef %body0, ptr noundef %body1, ptr nocapture nonnull readnone align 8 %dispatchInfo, ptr nocapture readnone %resultOut) unnamed_addr #4 align 2 personality ptr @__gxx_personality_v0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %96 = load <2 x float>, ptr %m_interpolationWorldTransform.i, align 4, !tbaa !39, !noalias !90
  %97 = load <2 x float>, ptr %arrayidx4.i.i.i99, align 4, !tbaa !39, !noalias !90
  %98 = load <2 x float>, ptr %arrayidx9.i.i.i102, align 4, !tbaa !39, !noalias !90
  ...
  %m_collisionShape.i = getelementptr inbounds %class.btCollisionObject, ptr %cond7, i64 0, i32 9
  %118 = load ptr, ptr %m_collisionShape.i, align 8, !tbaa !40
  %m_shapeType.i.i = getelementptr inbounds %class.btCollisionShape, ptr %118, i64 0, i32 1
  %119 = load i32, ptr %m_shapeType.i.i, align 8, !tbaa !44
  %120 = add i32 %119, -21
...
if.then19:                                        ; preds = %if.end
  ...
  store <2 x float> %95, ptr %rayAabbMin, align 8, !tbaa.struct !46
...
if.then.i.i:                                      ; preds = %if.then19
  store float %122, ptr %rayAabbMin, align 8, !tbaa !39
...
if.then.i18.i:                                    ; preds = %_Z8btSetMinIfEvRT_RKS0_.exit.i
  ...
  store float %125, ptr %arrayidx5.i154, align 4, !tbaa !39
...
_Z8btSetMinIfEvRT_RKS0_.exit19.i:                 ; preds = %if.then.i18.i, %_Z8btSetMinIfEvRT_RKS0_.exit.i
  ...
  %131 = load float, ptr %m_ccdSweptSphereRadius.i, align 8, !tbaa !96
  ...
  store <2 x float> %136, ptr %rayAabbMin, align 8, !tbaa !39
  ...
  store <2 x float> %138, ptr %rayAabbMax, align 8, !tbaa !39
  ...
  store <2 x float> %95, ptr %m_origin.i.i190, align 8, !tbaa.struct !46
  ...
  store float %106, ptr %convexToLocal.sroa.6.0.m_ccdSphereToTrans.i.sroa_idx, align 8, !tbaa.struct !65
  ...
  store float %111, ptr %convexToLocal.sroa.11.16.arrayidx8.i.i7.i.sroa_idx, align 8, !tbaa.struct !65
  ...
  store <2 x float> %112, ptr %m_origin.i10.i, align 8, !tbaa.struct !46
  ...
  store float %131, ptr %m_ccdSphereRadius.i, align 8, !tbaa !97
  ...
  %139 = load float, ptr %m_hitFraction.i191, align 4, !tbaa !99
  store float %139, ptr %m_hitFraction.i, align 4, !tbaa !100
