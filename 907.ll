; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/nbench/nbench0.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/nbench/nbench0.c"
...
sw.bb28.i:                                        ; preds = %for.end.i
  ...
  %call29.i = call ptr @fopen(ptr noundef nonnull %incdec.ptr25.i, ptr noundef nonnull @.str.79)
...
if.end34.i:                                       ; preds = %sw.bb28.i
  ...
  %call484.i.i = call ptr @fgets(ptr noundef nonnull %inbuf.i.i, i32 noundef 39, ptr noundef nonnull %call29.i)
  %cmp.not485.i.i = icmp eq ptr %call484.i.i, null
  br i1 %cmp.not485.i.i, label %read_comfile.exit.i, label %while.body.i.i
...
while.body.i.i:                                   ; preds = %if.end34.i, %skipswitch.i.i
  ...
  br i1 %cmp3.not.i.i, label %cond.false.i.i, label %if.then.i.i
...
cond.false.i.i:                                   ; preds = %if.then.i.i, %while.body.i.i
  %call9.i.i = call ptr @strchr(ptr noundef nonnull dereferenceable(1) %inbuf.i.i, i32 noundef 61) #11
  %cmp10.i.i = icmp eq ptr %call9.i.i, null
  br i1 %cmp10.i.i, label %if.then11.i.i, label %if.end14.i.i

if.then11.i.i:                                    ; preds = %cond.false.i.i
  %call13.i.i = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.81, ptr noundef nonnull %inbuf.i.i)
  br label %skipswitch.i.i

if.end14.i.i:                                     ; preds = %cond.false.i.i
  store i8 0, ptr %call9.i.i, align 1, !tbaa !30
  %.pre.i.i.i = load i8, ptr %inbuf.i.i, align 16, !tbaa !30
  br label %do.body.i.i.i

do.body.i.i.i:                                    ; preds = %do.body.i.i.i, %if.end14.i.i
  %5 = phi i8 [ %.pre.i.i.i, %if.end14.i.i ], [ %7, %do.body.i.i.i ]
  %s.addr.0.i.i.i = phi ptr [ %inbuf.i.i, %if.end14.i.i ], [ %incdec.ptr.i.i.i, %do.body.i.i.i ]
...
do.body.preheader.i.i:                            ; preds = %do.body.i.i.i
  %incdec.ptr.i.i = getelementptr inbounds i8, ptr %call9.i.i, i64 1
...
do.body.i.i:                                      ; preds = %do.cond.i.i, %do.body.preheader.i.i
  ...
  %arrayidx204.i.i = getelementptr inbounds [42 x ptr], ptr @paramnames, i64 0, i64 %indvars.iv.i.i
  %8 = load ptr, ptr %arrayidx204.i.i, align 8, !tbaa !28
  %call205.i.i = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %inbuf.i.i, ptr noundef nonnull dereferenceable(1) %8) #11
  %cmp212.i.i = icmp eq i32 %call205.i.i, 0
  br i1 %cmp212.i.i, label %if.end223.i.i, label %do.cond.i.i

do.cond.i.i:                                      ; preds = %do.body.i.i
  %indvars.iv.next.i.i = add nsw i64 %indvars.iv.i.i, -1
  %cmp216.not.i.i = icmp eq i64 %indvars.iv.i.i, 0
  br i1 %cmp216.not.i.i, label %if.then220.i.i, label %do.body.i.i, !llvm.loop !34

if.then220.i.i:                                   ; preds = %do.cond.i.i
  %call222.i.i = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.82, ptr noundef nonnull %inbuf.i.i)
  br label %skipswitch.i.i

if.end223.i.i:                                    ; preds = %do.body.i.i
  %9 = trunc i64 %indvars.iv.i.i to i32
  switch i32 %9, label %skipswitch.i.i [
    i32 0, label %sw.bb.i.i
    i32 1, label %sw.bb225.i.i
    i32 2, label %sw.bb227.i.i
    i32 3, label %sw.bb229.i.i
    i32 4, label %sw.bb237.i.i
    i32 5, label %sw.bb244.i.i
    i32 6, label %sw.bb246.i.i
    i32 7, label %sw.bb249.i.i
    i32 8, label %sw.bb251.i.i
    i32 9, label %sw.bb253.i.i
    i32 10, label %sw.bb255.i.i
    i32 11, label %sw.bb257.i.i
    i32 12, label %sw.bb260.i.i
    i32 13, label %sw.bb262.i.i
    i32 14, label %sw.bb264.i.i
    i32 15, label %sw.bb266.i.i
    i32 16, label %sw.bb268.i.i
    i32 17, label %sw.bb270.i.i
    i32 18, label %sw.bb272.i.i
    i32 19, label %sw.bb274.i.i
    i32 20, label %sw.bb276.i.i
    i32 21, label %sw.bb278.i.i
    i32 22, label %sw.bb280.i.i
    i32 23, label %sw.bb282.i.i
    i32 24, label %sw.bb284.i.i
    i32 25, label %sw.bb286.i.i
    i32 26, label %sw.bb288.i.i
    i32 27, label %sw.bb290.i.i
    i32 28, label %sw.bb292.i.i
    i32 29, label %sw.bb294.i.i
    i32 30, label %sw.bb296.i.i
    i32 31, label %sw.bb298.i.i
    i32 32, label %sw.bb300.i.i
    i32 33, label %sw.bb302.i.i
    i32 34, label %sw.bb304.i.i
    i32 35, label %sw.bb306.i.i
    i32 36, label %sw.bb308.i.i
    i32 37, label %sw.bb310.i.i
    i32 38, label %sw.bb312.i.i
    i32 39, label %sw.bb314.i.i
    i32 40, label %sw.bb316.i.i
    i32 41, label %sw.bb318.i.i
  ]

sw.bb.i.i:                                        ; preds = %if.end223.i.i
  %call.i379.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i379.i.i, ptr @global_min_ticks, align 8, !tbaa !5
  br label %skipswitch.i.i

sw.bb225.i.i:                                     ; preds = %if.end223.i.i
  %call.i380.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i380.i.i, ptr @global_min_seconds, align 8, !tbaa !5
  store i64 %call.i380.i.i, ptr getelementptr inbounds (%struct.SortStruct, ptr @global_numsortstruct, i64 0, i32 1), align 8, !tbaa !11
  store i64 %call.i380.i.i, ptr getelementptr inbounds (%struct.SortStruct, ptr @global_strsortstruct, i64 0, i32 1), align 8, !tbaa !11
  store i64 %call.i380.i.i, ptr getelementptr inbounds (%struct.BitOpStruct, ptr @global_bitopstruct, i64 0, i32 1), align 8, !tbaa !15
  store i64 %call.i380.i.i, ptr getelementptr inbounds (%struct.EmFloatStruct, ptr @global_emfloatstruct, i64 0, i32 1), align 8, !tbaa !17
  store i64 %call.i380.i.i, ptr getelementptr inbounds (%struct.FourierStruct, ptr @global_fourierstruct, i64 0, i32 1), align 8, !tbaa !19
  store i64 %call.i380.i.i, ptr getelementptr inbounds (%struct.AssignStruct, ptr @global_assignstruct, i64 0, i32 1), align 8, !tbaa !19
  store i64 %call.i380.i.i, ptr getelementptr inbounds (%struct.IDEAStruct, ptr @global_ideastruct, i64 0, i32 1), align 8, !tbaa !17
  store i64 %call.i380.i.i, ptr getelementptr inbounds (%struct.HuffStruct, ptr @global_huffstruct, i64 0, i32 1), align 8, !tbaa !17
  store i64 %call.i380.i.i, ptr getelementptr inbounds (%struct.NNetStruct, ptr @global_nnetstruct, i64 0, i32 1), align 8, !tbaa !19
  store i64 %call.i380.i.i, ptr getelementptr inbounds (%struct.LUStruct, ptr @global_lustruct, i64 0, i32 1), align 8, !tbaa !19
  br label %skipswitch.i.i

sw.bb227.i.i:                                     ; preds = %if.end223.i.i
  %incdec.ptr.val378.i.i = load i8, ptr %incdec.ptr.i.i, align 1, !tbaa !30
  %10 = load ptr, ptr %call14.i, align 8, !tbaa !28
  %idxprom.i382.i.i = sext i8 %incdec.ptr.val378.i.i to i64
  %arrayidx.i383.i.i = getelementptr inbounds i32, ptr %10, i64 %idxprom.i382.i.i
  %__res.0.i384.i.i = load i32, ptr %arrayidx.i383.i.i, align 4, !tbaa !9
  %cmp7.i.i.i = icmp eq i32 %__res.0.i384.i.i, 84
  %..i.i.i = zext i1 %cmp7.i.i.i to i32
  store i32 %..i.i.i, ptr @global_allstats, align 4, !tbaa !9
  br label %skipswitch.i.i

sw.bb229.i.i:                                     ; preds = %if.end223.i.i
  %call230.i.i = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) @global_ofile_name, ptr noundef nonnull dereferenceable(1) %incdec.ptr.i.i) #11
  %call231.i.i = call ptr @fopen(ptr noundef nonnull @global_ofile_name, ptr noundef nonnull @.str.83)
  store ptr %call231.i.i, ptr @global_ofile, align 8, !tbaa !28
  %cmp232.i.i = icmp eq ptr %call231.i.i, null
  br i1 %cmp232.i.i, label %if.then234.i.i, label %if.end236.i.i

if.then234.i.i:                                   ; preds = %sw.bb229.i.i
  %call235.i.i = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.84, ptr noundef nonnull @global_ofile_name)
  call void @ErrorExit() #11
  br label %if.end236.i.i

if.end236.i.i:                                    ; preds = %if.then234.i.i, %sw.bb229.i.i
  store i32 -1, ptr @write_to_file, align 4, !tbaa !9
  br label %skipswitch.i.i

sw.bb237.i.i:                                     ; preds = %if.end223.i.i
  %incdec.ptr.val377.i.i = load i8, ptr %incdec.ptr.i.i, align 1, !tbaa !30
  %11 = load ptr, ptr %call14.i, align 8, !tbaa !28
  %idxprom.i386.i.i = sext i8 %incdec.ptr.val377.i.i to i64
  %arrayidx.i387.i.i = getelementptr inbounds i32, ptr %11, i64 %idxprom.i386.i.i
  %__res.0.i388.i.i = load i32, ptr %arrayidx.i387.i.i, align 4, !tbaa !9
  %cmp7.i389.i.i = icmp eq i32 %__res.0.i388.i.i, 84
  %..i390.i.i = zext i1 %cmp7.i389.i.i to i32
  store i32 %..i390.i.i, ptr @global_custrun, align 4, !tbaa !9
  %not.cmp7.i389.i.i = xor i1 %cmp7.i389.i.i, true
  %sub241.i.i = zext i1 %not.cmp7.i389.i.i to i32
  %12 = insertelement <4 x i32> poison, i32 %sub241.i.i, i64 0
  ...
  store i32 %sub241.i.i, ptr getelementptr inbounds ([10 x i32], ptr @tests_to_do, i64 0, i64 8), align 16, !tbaa !9
  store i32 %sub241.i.i, ptr getelementptr inbounds ([10 x i32], ptr @tests_to_do, i64 0, i64 9), align 4, !tbaa !9
  br label %skipswitch.i.i

sw.bb244.i.i:                                     ; preds = %if.end223.i.i
  %incdec.ptr.val376.i.i = load i8, ptr %incdec.ptr.i.i, align 1, !tbaa !30
  %14 = load ptr, ptr %call14.i, align 8, !tbaa !28
  %idxprom.i392.i.i = sext i8 %incdec.ptr.val376.i.i to i64
  %arrayidx.i393.i.i = getelementptr inbounds i32, ptr %14, i64 %idxprom.i392.i.i
  %__res.0.i394.i.i = load i32, ptr %arrayidx.i393.i.i, align 4, !tbaa !9
  %cmp7.i395.i.i = icmp eq i32 %__res.0.i394.i.i, 84
  %..i396.i.i = zext i1 %cmp7.i395.i.i to i32
  store i32 %..i396.i.i, ptr @tests_to_do, align 16, !tbaa !9
  br label %skipswitch.i.i

sw.bb246.i.i:                                     ; preds = %if.end223.i.i
  %call.i397.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  %conv248.i.i = trunc i64 %call.i397.i.i to i16
  store i16 %conv248.i.i, ptr getelementptr inbounds (%struct.SortStruct, ptr @global_numsortstruct, i64 0, i32 3), align 8, !tbaa !35
  store i32 1, ptr @global_numsortstruct, align 8, !tbaa !21
  br label %skipswitch.i.i

sw.bb249.i.i:                                     ; preds = %if.end223.i.i
  %call.i398.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i398.i.i, ptr getelementptr inbounds (%struct.SortStruct, ptr @global_numsortstruct, i64 0, i32 4), align 8, !tbaa !22
  br label %skipswitch.i.i

sw.bb251.i.i:                                     ; preds = %if.end223.i.i
  %call.i399.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i399.i.i, ptr getelementptr inbounds (%struct.SortStruct, ptr @global_numsortstruct, i64 0, i32 1), align 8, !tbaa !11
  br label %skipswitch.i.i

sw.bb253.i.i:                                     ; preds = %if.end223.i.i
  %incdec.ptr.val375.i.i = load i8, ptr %incdec.ptr.i.i, align 1, !tbaa !30
  %15 = load ptr, ptr %call14.i, align 8, !tbaa !28
  %idxprom.i401.i.i = sext i8 %incdec.ptr.val375.i.i to i64
  %arrayidx.i402.i.i = getelementptr inbounds i32, ptr %15, i64 %idxprom.i401.i.i
  %__res.0.i403.i.i = load i32, ptr %arrayidx.i402.i.i, align 4, !tbaa !9
  %cmp7.i404.i.i = icmp eq i32 %__res.0.i403.i.i, 84
  %..i405.i.i = zext i1 %cmp7.i404.i.i to i32
  store i32 %..i405.i.i, ptr getelementptr inbounds ([10 x i32], ptr @tests_to_do, i64 0, i64 1), align 4, !tbaa !9
  br label %skipswitch.i.i

sw.bb255.i.i:                                     ; preds = %if.end223.i.i
  %call.i406.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i406.i.i, ptr getelementptr inbounds (%struct.SortStruct, ptr @global_strsortstruct, i64 0, i32 4), align 8, !tbaa !22
  br label %skipswitch.i.i

sw.bb257.i.i:                                     ; preds = %if.end223.i.i
  %call.i407.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  %conv259.i.i = trunc i64 %call.i407.i.i to i16
  store i16 %conv259.i.i, ptr getelementptr inbounds (%struct.SortStruct, ptr @global_strsortstruct, i64 0, i32 3), align 8, !tbaa !35
  store i32 1, ptr @global_strsortstruct, align 8, !tbaa !21
  br label %skipswitch.i.i

sw.bb260.i.i:                                     ; preds = %if.end223.i.i
  %call.i409.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i409.i.i, ptr getelementptr inbounds (%struct.SortStruct, ptr @global_strsortstruct, i64 0, i32 1), align 8, !tbaa !11
  br label %skipswitch.i.i

sw.bb262.i.i:                                     ; preds = %if.end223.i.i
  %incdec.ptr.val374.i.i = load i8, ptr %incdec.ptr.i.i, align 1, !tbaa !30
  %16 = load ptr, ptr %call14.i, align 8, !tbaa !28
  %idxprom.i411.i.i = sext i8 %incdec.ptr.val374.i.i to i64
  %arrayidx.i412.i.i = getelementptr inbounds i32, ptr %16, i64 %idxprom.i411.i.i
  %__res.0.i413.i.i = load i32, ptr %arrayidx.i412.i.i, align 4, !tbaa !9
  %cmp7.i414.i.i = icmp eq i32 %__res.0.i413.i.i, 84
  %..i415.i.i = zext i1 %cmp7.i414.i.i to i32
  store i32 %..i415.i.i, ptr getelementptr inbounds ([10 x i32], ptr @tests_to_do, i64 0, i64 2), align 8, !tbaa !9
  br label %skipswitch.i.i

sw.bb264.i.i:                                     ; preds = %if.end223.i.i
  %call.i416.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i416.i.i, ptr getelementptr inbounds (%struct.BitOpStruct, ptr @global_bitopstruct, i64 0, i32 3), align 8, !tbaa !36
  store i32 1, ptr @global_bitopstruct, align 8, !tbaa !23
  br label %skipswitch.i.i

sw.bb266.i.i:                                     ; preds = %if.end223.i.i
  %call.i417.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i417.i.i, ptr getelementptr inbounds (%struct.BitOpStruct, ptr @global_bitopstruct, i64 0, i32 4), align 8, !tbaa !24
  br label %skipswitch.i.i

sw.bb268.i.i:                                     ; preds = %if.end223.i.i
  %call.i418.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i418.i.i, ptr getelementptr inbounds (%struct.BitOpStruct, ptr @global_bitopstruct, i64 0, i32 1), align 8, !tbaa !15
  br label %skipswitch.i.i

sw.bb270.i.i:                                     ; preds = %if.end223.i.i
  %incdec.ptr.val373.i.i = load i8, ptr %incdec.ptr.i.i, align 1, !tbaa !30
  %17 = load ptr, ptr %call14.i, align 8, !tbaa !28
  %idxprom.i420.i.i = sext i8 %incdec.ptr.val373.i.i to i64
  %arrayidx.i421.i.i = getelementptr inbounds i32, ptr %17, i64 %idxprom.i420.i.i
  %__res.0.i422.i.i = load i32, ptr %arrayidx.i421.i.i, align 4, !tbaa !9
  %cmp7.i423.i.i = icmp eq i32 %__res.0.i422.i.i, 84
  %..i424.i.i = zext i1 %cmp7.i423.i.i to i32
  store i32 %..i424.i.i, ptr getelementptr inbounds ([10 x i32], ptr @tests_to_do, i64 0, i64 3), align 4, !tbaa !9
  br label %skipswitch.i.i

sw.bb272.i.i:                                     ; preds = %if.end223.i.i
  %call.i425.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i425.i.i, ptr getelementptr inbounds (%struct.EmFloatStruct, ptr @global_emfloatstruct, i64 0, i32 2), align 8, !tbaa !26
  br label %skipswitch.i.i

sw.bb274.i.i:                                     ; preds = %if.end223.i.i
  %call.i426.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i426.i.i, ptr getelementptr inbounds (%struct.EmFloatStruct, ptr @global_emfloatstruct, i64 0, i32 3), align 8, !tbaa !37
  br label %skipswitch.i.i

sw.bb276.i.i:                                     ; preds = %if.end223.i.i
  %call.i427.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i427.i.i, ptr getelementptr inbounds (%struct.EmFloatStruct, ptr @global_emfloatstruct, i64 0, i32 1), align 8, !tbaa !17
  br label %skipswitch.i.i

sw.bb278.i.i:                                     ; preds = %if.end223.i.i
  %incdec.ptr.val372.i.i = load i8, ptr %incdec.ptr.i.i, align 1, !tbaa !30
  %18 = load ptr, ptr %call14.i, align 8, !tbaa !28
  %idxprom.i429.i.i = sext i8 %incdec.ptr.val372.i.i to i64
  %arrayidx.i430.i.i = getelementptr inbounds i32, ptr %18, i64 %idxprom.i429.i.i
  %__res.0.i431.i.i = load i32, ptr %arrayidx.i430.i.i, align 4, !tbaa !9
  %cmp7.i432.i.i = icmp eq i32 %__res.0.i431.i.i, 84
  %..i433.i.i = zext i1 %cmp7.i432.i.i to i32
  store i32 %..i433.i.i, ptr getelementptr inbounds ([10 x i32], ptr @tests_to_do, i64 0, i64 4), align 16, !tbaa !9
  br label %skipswitch.i.i

sw.bb280.i.i:                                     ; preds = %if.end223.i.i
  %call.i434.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i434.i.i, ptr getelementptr inbounds (%struct.FourierStruct, ptr @global_fourierstruct, i64 0, i32 2), align 8, !tbaa !38
  store i32 1, ptr @global_fourierstruct, align 8, !tbaa !27
  br label %skipswitch.i.i

sw.bb282.i.i:                                     ; preds = %if.end223.i.i
  %call.i435.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i435.i.i, ptr getelementptr inbounds (%struct.FourierStruct, ptr @global_fourierstruct, i64 0, i32 1), align 8, !tbaa !19
  br label %skipswitch.i.i

sw.bb284.i.i:                                     ; preds = %if.end223.i.i
  %incdec.ptr.val371.i.i = load i8, ptr %incdec.ptr.i.i, align 1, !tbaa !30
  %19 = load ptr, ptr %call14.i, align 8, !tbaa !28
  %idxprom.i437.i.i = sext i8 %incdec.ptr.val371.i.i to i64
  %arrayidx.i438.i.i = getelementptr inbounds i32, ptr %19, i64 %idxprom.i437.i.i
  %__res.0.i439.i.i = load i32, ptr %arrayidx.i438.i.i, align 4, !tbaa !9
  %cmp7.i440.i.i = icmp eq i32 %__res.0.i439.i.i, 84
  %..i441.i.i = zext i1 %cmp7.i440.i.i to i32
  store i32 %..i441.i.i, ptr getelementptr inbounds ([10 x i32], ptr @tests_to_do, i64 0, i64 5), align 4, !tbaa !9
  br label %skipswitch.i.i

sw.bb286.i.i:                                     ; preds = %if.end223.i.i
  %call.i442.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i442.i.i, ptr getelementptr inbounds (%struct.AssignStruct, ptr @global_assignstruct, i64 0, i32 2), align 8, !tbaa !38
  br label %skipswitch.i.i

sw.bb288.i.i:                                     ; preds = %if.end223.i.i
  %call.i443.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i443.i.i, ptr getelementptr inbounds (%struct.AssignStruct, ptr @global_assignstruct, i64 0, i32 1), align 8, !tbaa !19
  br label %skipswitch.i.i

sw.bb290.i.i:                                     ; preds = %if.end223.i.i
  %incdec.ptr.val370.i.i = load i8, ptr %incdec.ptr.i.i, align 1, !tbaa !30
  %20 = load ptr, ptr %call14.i, align 8, !tbaa !28
  %idxprom.i445.i.i = sext i8 %incdec.ptr.val370.i.i to i64
  %arrayidx.i446.i.i = getelementptr inbounds i32, ptr %20, i64 %idxprom.i445.i.i
  %__res.0.i447.i.i = load i32, ptr %arrayidx.i446.i.i, align 4, !tbaa !9
  %cmp7.i448.i.i = icmp eq i32 %__res.0.i447.i.i, 84
  %..i449.i.i = zext i1 %cmp7.i448.i.i to i32
  store i32 %..i449.i.i, ptr getelementptr inbounds ([10 x i32], ptr @tests_to_do, i64 0, i64 6), align 8, !tbaa !9
  br label %skipswitch.i.i

sw.bb292.i.i:                                     ; preds = %if.end223.i.i
  %call.i450.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i450.i.i, ptr getelementptr inbounds (%struct.IDEAStruct, ptr @global_ideastruct, i64 0, i32 2), align 8, !tbaa !26
  br label %skipswitch.i.i

sw.bb294.i.i:                                     ; preds = %if.end223.i.i
  %call.i451.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i451.i.i, ptr getelementptr inbounds (%struct.IDEAStruct, ptr @global_ideastruct, i64 0, i32 3), align 8, !tbaa !37
  br label %skipswitch.i.i

sw.bb296.i.i:                                     ; preds = %if.end223.i.i
  %call.i452.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i452.i.i, ptr getelementptr inbounds (%struct.IDEAStruct, ptr @global_ideastruct, i64 0, i32 1), align 8, !tbaa !17
  br label %skipswitch.i.i

sw.bb298.i.i:                                     ; preds = %if.end223.i.i
  %incdec.ptr.val369.i.i = load i8, ptr %incdec.ptr.i.i, align 1, !tbaa !30
  %21 = load ptr, ptr %call14.i, align 8, !tbaa !28
  %idxprom.i454.i.i = sext i8 %incdec.ptr.val369.i.i to i64
  %arrayidx.i455.i.i = getelementptr inbounds i32, ptr %21, i64 %idxprom.i454.i.i
  %__res.0.i456.i.i = load i32, ptr %arrayidx.i455.i.i, align 4, !tbaa !9
  %cmp7.i457.i.i = icmp eq i32 %__res.0.i456.i.i, 84
  %..i458.i.i = zext i1 %cmp7.i457.i.i to i32
  store i32 %..i458.i.i, ptr getelementptr inbounds ([10 x i32], ptr @tests_to_do, i64 0, i64 7), align 4, !tbaa !9
  br label %skipswitch.i.i

sw.bb300.i.i:                                     ; preds = %if.end223.i.i
  %call.i459.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i459.i.i, ptr getelementptr inbounds (%struct.HuffStruct, ptr @global_huffstruct, i64 0, i32 2), align 8, !tbaa !26
  br label %skipswitch.i.i

sw.bb302.i.i:                                     ; preds = %if.end223.i.i
  %call.i460.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i460.i.i, ptr getelementptr inbounds (%struct.HuffStruct, ptr @global_huffstruct, i64 0, i32 3), align 8, !tbaa !37
  store i32 1, ptr @global_huffstruct, align 8, !tbaa !25
  br label %skipswitch.i.i

sw.bb304.i.i:                                     ; preds = %if.end223.i.i
  %call.i461.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i461.i.i, ptr getelementptr inbounds (%struct.HuffStruct, ptr @global_huffstruct, i64 0, i32 1), align 8, !tbaa !17
  br label %skipswitch.i.i

sw.bb306.i.i:                                     ; preds = %if.end223.i.i
  %incdec.ptr.val368.i.i = load i8, ptr %incdec.ptr.i.i, align 1, !tbaa !30
  %22 = load ptr, ptr %call14.i, align 8, !tbaa !28
  %idxprom.i463.i.i = sext i8 %incdec.ptr.val368.i.i to i64
  %arrayidx.i464.i.i = getelementptr inbounds i32, ptr %22, i64 %idxprom.i463.i.i
  %__res.0.i465.i.i = load i32, ptr %arrayidx.i464.i.i, align 4, !tbaa !9
  %cmp7.i466.i.i = icmp eq i32 %__res.0.i465.i.i, 84
  %..i467.i.i = zext i1 %cmp7.i466.i.i to i32
  store i32 %..i467.i.i, ptr getelementptr inbounds ([10 x i32], ptr @tests_to_do, i64 0, i64 8), align 16, !tbaa !9
  br label %skipswitch.i.i

sw.bb308.i.i:                                     ; preds = %if.end223.i.i
  %call.i468.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i468.i.i, ptr getelementptr inbounds (%struct.NNetStruct, ptr @global_nnetstruct, i64 0, i32 2), align 8, !tbaa !38
  store i32 1, ptr @global_nnetstruct, align 8, !tbaa !27
  br label %skipswitch.i.i

sw.bb310.i.i:                                     ; preds = %if.end223.i.i
  %call.i469.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i469.i.i, ptr getelementptr inbounds (%struct.NNetStruct, ptr @global_nnetstruct, i64 0, i32 1), align 8, !tbaa !19
  br label %skipswitch.i.i

sw.bb312.i.i:                                     ; preds = %if.end223.i.i
  %incdec.ptr.val.i.i = load i8, ptr %incdec.ptr.i.i, align 1, !tbaa !30
  %23 = load ptr, ptr %call14.i, align 8, !tbaa !28
  %idxprom.i471.i.i = sext i8 %incdec.ptr.val.i.i to i64
  %arrayidx.i472.i.i = getelementptr inbounds i32, ptr %23, i64 %idxprom.i471.i.i
  %__res.0.i473.i.i = load i32, ptr %arrayidx.i472.i.i, align 4, !tbaa !9
  %cmp7.i474.i.i = icmp eq i32 %__res.0.i473.i.i, 84
  %..i475.i.i = zext i1 %cmp7.i474.i.i to i32
  store i32 %..i475.i.i, ptr getelementptr inbounds ([10 x i32], ptr @tests_to_do, i64 0, i64 9), align 4, !tbaa !9
  br label %skipswitch.i.i

sw.bb314.i.i:                                     ; preds = %if.end223.i.i
  %call.i476.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i476.i.i, ptr getelementptr inbounds (%struct.LUStruct, ptr @global_lustruct, i64 0, i32 2), align 8, !tbaa !38
  store i32 1, ptr @global_lustruct, align 8, !tbaa !27
  br label %skipswitch.i.i

sw.bb316.i.i:                                     ; preds = %if.end223.i.i
  %call.i477.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  store i64 %call.i477.i.i, ptr getelementptr inbounds (%struct.LUStruct, ptr @global_lustruct, i64 0, i32 1), align 8, !tbaa !19
  br label %skipswitch.i.i

sw.bb318.i.i:                                     ; preds = %if.end223.i.i
  %call.i478.i.i = call i64 @strtol(ptr nocapture noundef nonnull %incdec.ptr.i.i, ptr noundef null, i32 noundef 10) #11
  %conv.i479.i.i = trunc i64 %call.i478.i.i to i32
  store i32 %conv.i479.i.i, ptr @global_align, align 4, !tbaa !9
  br label %skipswitch.i.i

skipswitch.i.i:                                   ; preds = %sw.bb318.i.i, %sw.bb316.i.i, %sw.bb314.i.i, %sw.bb312.i.i, %sw.bb310.i.i, %sw.bb308.i.i, %sw.bb306.i.i, %sw.bb304.i.i, %sw.bb302.i.i, %sw.bb300.i.i, %sw.bb298.i.i, %sw.bb296.i.i, %sw.bb294.i.i, %sw.bb292.i.i, %sw.bb290.i.i, %sw.bb288.i.i, %sw.bb286.i.i, %sw.bb284.i.i, %sw.bb282.i.i, %sw.bb280.i.i, %sw.bb278.i.i, %sw.bb276.i.i, %sw.bb274.i.i, %sw.bb272.i.i, %sw.bb270.i.i, %sw.bb268.i.i, %sw.bb266.i.i, %sw.bb264.i.i, %sw.bb262.i.i, %sw.bb260.i.i, %sw.bb257.i.i, %sw.bb255.i.i, %sw.bb253.i.i, %sw.bb251.i.i, %sw.bb249.i.i, %sw.bb246.i.i, %sw.bb244.i.i, %sw.bb237.i.i, %if.end236.i.i, %sw.bb227.i.i, %sw.bb225.i.i, %sw.bb.i.i, %if.end223.i.i, %if.then220.i.i, %if.then11.i.i
