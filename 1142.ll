; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Compress/DeflateDecoder.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Compress/DeflateDecoder.cpp"
...
entry:
  ...
  %uglygep163 = getelementptr i8, ptr %values, i64 -1
  br label %do.body
...
for.body.preheader:                               ; preds = %_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadBitsEi.exit
  ...
  %uglygep164 = getelementptr i8, ptr %uglygep163, i64 %12
  %load_initial = load i8, ptr %uglygep164, align 1
...
for.body31.preheader:                             ; preds = %if.end25
  ...
  %uglygep = getelementptr i8, ptr %values, i64 %39
  %40 = xor i32 %i.0, -1
  %41 = add i32 %40, %numSymbols
  %42 = add nsw i32 %num17.0, -1
  %umin = tail call i32 @llvm.umin.i32(i32 %41, i32 %42)
  %43 = zext i32 %umin to i64
  %44 = add nuw nsw i64 %43, 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %uglygep, i8 0, i64 %44, i1 false), !tbaa !45
  br label %for.body31
...
if.then16:                                        ; preds = %if.end13
  ...
  %uglygep.i = getelementptr inbounds i8, ptr %levels, i64 144
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(112) %uglygep.i, i8 9, i64 112, i1 false), !tbaa !45
  %uglygep62.i = getelementptr inbounds i8, ptr %levels, i64 256
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(24) %uglygep62.i, i8 7, i64 24, i1 false), !tbaa !45
  %uglygep64.i = getelementptr inbounds i8, ptr %levels, i64 280
  store i64 578721382704613384, ptr %uglygep64.i, align 1
  %uglygep66.i = getelementptr inbounds i8, ptr %levels, i64 288
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(32) %uglygep66.i, i8 5, i64 32, i1 false), !tbaa !45
  %_deflate64Mode = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 18
...
cleanup61.thread440:                              ; preds = %if.end46
  %uglygep.i364 = getelementptr inbounds i8, ptr %levels, i64 257
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(63) %uglygep.i364, i8 0, i64 63, i1 false)
...
if.end63:                                         ; preds = %cleanup61.thread440, %if.then16
  ...
  %uglygep.i365 = getelementptr inbounds i8, ptr %lenCounts.i, i64 4
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(60) %uglygep.i365, i8 0, i64 60, i1 false), !tbaa !53
...
for.end15.i:                                      ; preds = %if.end.i.1
  ...
  %uglygep138.i = getelementptr %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 9, i32 3
...
for.body54.lr.ph.i:                               ; preds = %if.then48.i
  ...
  %uglygep139.i = getelementptr i8, ptr %uglygep138.i, i64 %104
  %105 = xor i32 %index.0130.i, -1
  %106 = add i32 %shr.i, %105
  %107 = zext i32 %106 to i64
  %108 = add nuw nsw i64 %107, 1
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %uglygep139.i, i8 %conv55.i, i64 %108, i1 false), !tbaa !45
...
_ZN9NCompress8NHuffman8CDecoderILi15ELj288EE14SetCodeLengthsEPKh.exit: ; preds = %if.end80.i.1
  ...
  %uglygep.i369 = getelementptr inbounds i8, ptr %lenCounts.i367, i64 4
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(60) %uglygep.i369, i8 0, i64 60, i1 false), !tbaa !53
...
for.end15.i383:                                   ; preds = %if.end.i380.1
  ...
  %uglygep138.i382 = getelementptr %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 10, i32 3
...
for.body54.lr.ph.i412:                            ; preds = %if.then48.i408
  ...
  %uglygep139.i410 = getelementptr i8, ptr %uglygep138.i382, i64 %123
  %124 = xor i32 %index.0130.i387, -1
  %125 = add i32 %shr.i406, %124
  %126 = zext i32 %125 to i64
  %127 = add nuw nsw i64 %126, 1
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %uglygep139.i410, i8 %conv55.i409, i64 %127, i1 false), !tbaa !45
...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(60) %uglygep, i8 0, i64 60, i1 false), !tbaa !53
...
if.end.18:                                        ; preds = %if.end.17
  ...
  %uglygep138 = getelementptr i8, ptr %this, i64 204
  br label %for.body21
...
for.body54.lr.ph:                                 ; preds = %if.then48
  ...
  %uglygep139 = getelementptr i8, ptr %uglygep138, i64 %43
  %44 = xor i32 %index.0130, -1
  %45 = add i32 %shr, %44
  %46 = zext i32 %45 to i64
  %47 = add nuw nsw i64 %46, 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %uglygep139, i8 %conv55, i64 %47, i1 false), !tbaa !45
  br label %for.inc62
...
for.end:                                          ; preds = %if.end18, %cleanup.cont, %cleanup.cont.us178, %cleanup.cont.us, %if.end18.us, %cleanup.cont.us.us
  ...
  %ZlibMode = getelementptr inbounds %"class.NCompress::NDeflate::NDecoder::CCoder", ptr %this, i64 0, i32 24
  %44 = load i8, ptr %ZlibMode, align 1
