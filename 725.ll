; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/treecc/oper.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/treecc/oper.c"
...
entry:
  ...
  %idxprom = zext i32 %and to i64
  %arrayidx = getelementptr inbounds %struct._tagTreeCCContext, ptr %context, i64 0, i32 1, i64 %idxprom
  %oper.0163 = load ptr, ptr %arrayidx, align 8, !tbaa !41
  %cmp.not164 = icmp eq ptr %oper.0163, null
  br i1 %cmp.not164, label %cleanup, label %while.body

while.body:                                       ; preds = %entry, %if.end157
  %oper.0165 = phi ptr [ %oper.0, %if.end157 ], [ %oper.0163, %entry ]
  %0 = load ptr, ptr %oper.0165, align 8, !tbaa !5
  %call149 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %name) #13
  %tobool.not = icmp eq i32 %call149, 0
  br i1 %tobool.not, label %cleanup, label %if.end157

if.end157:                                        ; preds = %while.body
  %nextHash = getelementptr inbounds %struct._tagTreeCCOperation, ptr %oper.0165, i64 0, i32 9
...
cleanup:                                          ; preds = %while.body, %if.end157, %entry
  %oper.0.lcssa = phi ptr [ null, %entry ], [ null, %if.end157 ], [ %oper.0165, %while.body ]
...
while.end33.i.i:                                  ; preds = %if.end31.i.i, %if.then57.i
  ...
  %call34.i.i = tail call noalias ptr @calloc(i64 noundef %conv.i.i, i64 noundef 8) #15
...
while.end47.i.i:                                  ; preds = %MarkMultiCase.exit.i.i, %if.end39.i.i
  ...
  %call49.i.i = tail call noalias ptr @calloc(i64 noundef %conv48.i.i, i64 noundef 8) #15
...
entry:
  ...
  %oper.0163.i = load ptr, ptr %arrayidx.i, align 8, !tbaa !41
  %cmp.not164.i = icmp eq ptr %oper.0163.i, null
  br i1 %cmp.not164.i, label %cleanup, label %while.body.i

while.body.i:                                     ; preds = %entry, %if.end157.i
  %oper.0165.i = phi ptr [ %oper.0.i, %if.end157.i ], [ %oper.0163.i, %entry ]
  %0 = load ptr, ptr %oper.0165.i, align 8, !tbaa !5
  %call149.i = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %name) #13
  %tobool.not.i = icmp eq i32 %call149.i, 0
  br i1 %tobool.not.i, label %if.end, label %if.end157.i

if.end157.i:                                      ; preds = %while.body.i
  %nextHash.i = getelementptr inbounds %struct._tagTreeCCOperation, ptr %oper.0165.i, i64 0, i32 9
...
if.end:                                           ; preds = %while.body.i
  %firstCase = getelementptr inbounds %struct._tagTreeCCOperation, ptr %oper.0165.i, i64 0, i32 10
...
cleanup:                                          ; preds = %if.end157.i, %land.lhs.true, %if.end6, %if.end, %entry
  %retval.0 = phi ptr [ null, %entry ], [ null, %if.end ], [ %operCase.019, %land.lhs.true ], [ null, %if.end6 ], [ null, %if.end157.i ]
  ret ptr %retval.0
}
...
if.then.i:                                        ; preds = %for.body16
  %call.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %str.069) #16
  %call1.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %7) #16
...
while.cond.i:                                     ; preds = %land.rhs.i, %entry
  ...
  %cmp.not.i = icmp eq ptr %nextParam.addr.0.i, null
