; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/jdcoefct.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/jdcoefct.c"
...
for.body72:                                       ; preds = %for.body72.lr.ph, %for.end
  ...
  %or.cond = select i1 %cmp27.not, i1 %cmp76, i1 false
  br i1 %or.cond, label %if.end83, label %if.else79

if.else79:                                        ; preds = %for.body72
  %38 = add nsw i64 %indvars.iv, -1
  %arrayidx82 = getelementptr inbounds ptr, ptr %buffer.0, i64 %38
  %39 = load ptr, ptr %arrayidx82, align 8, !tbaa !31
  br label %if.end83

if.end83:                                         ; preds = %for.body72, %if.else79
  %prev_block_row.0 = phi ptr [ %39, %if.else79 ], [ %37, %for.body72 ]
...
if.else90:                                        ; preds = %if.end83
  ...
  %arrayidx93 = getelementptr inbounds ptr, ptr %buffer.0, i64 %40
  %41 = load ptr, ptr %arrayidx93, align 8, !tbaa !31
  br label %if.end94

if.end94:                                         ; preds = %if.end83, %if.else90
  %next_block_row.0 = phi ptr [ %41, %if.else90 ], [ %37, %if.end83 ]
  %42 = load i16, ptr %prev_block_row.0, align 2, !tbaa !48
  %conv97 = sext i16 %42 to i32
  %43 = load i16, ptr %37, align 2, !tbaa !48
  %conv100 = sext i16 %43 to i32
  %44 = load i16, ptr %next_block_row.0, align 2, !tbaa !48
  %conv103 = sext i16 %44 to i32
  %45 = load i32, ptr %width_in_blocks, align 4, !tbaa !28
  %sub104 = add i32 %45, -1
...
if.then111:                                       ; preds = %for.body108
  ...
  %46 = load i16, ptr %arrayidx112, align 2, !tbaa !48
  %conv114 = sext i16 %46 to i32
  %arrayidx115 = getelementptr inbounds [64 x i16], ptr %buffer_ptr.0648, i64 1
  %47 = load i16, ptr %arrayidx115, align 2, !tbaa !48
  %conv117 = sext i16 %47 to i32
  %arrayidx118 = getelementptr inbounds [64 x i16], ptr %next_block_row.1646, i64 1
  %48 = load i16, ptr %arrayidx118, align 2, !tbaa !48
...
if.end121:                                        ; preds = %if.then111, %for.body108
  ...
  %49 = load i32, ptr %arrayidx122, align 4, !tbaa !49
  %cmp123 = icmp ne i32 %49, 0
  %50 = load i16, ptr %arrayidx126, align 2
  %cmp128 = icmp eq i16 %50, 0
...
if.end171:                                        ; preds = %if.end168, %if.end121
  %51 = load i32, ptr %arrayidx172, align 4, !tbaa !49
  %cmp173 = icmp ne i32 %51, 0
  %52 = load i16, ptr %arrayidx176, align 16
  %cmp178 = icmp eq i16 %52, 0
...
if.end223:                                        ; preds = %if.end220, %if.end171
  %53 = load i32, ptr %arrayidx224, align 4, !tbaa !49
  %cmp225 = icmp ne i32 %53, 0
  %54 = load i16, ptr %arrayidx228, align 16
  %cmp230 = icmp eq i16 %54, 0
...
if.then232:                                       ; preds = %if.end223
  %55 = shl nsw i32 %DC6.0653, 1
  %add234 = sub i32 %DC3.0651, %55
...
if.end277:                                        ; preds = %if.end274, %if.end223
  %56 = load i32, ptr %arrayidx278, align 4, !tbaa !49
  %cmp279 = icmp ne i32 %56, 0
  %57 = load i16, ptr %arrayidx282, align 2
  %cmp284 = icmp eq i16 %57, 0
...
if.then286:                                       ; preds = %if.end277
  %58 = add nsw i32 %DC7.0654, %DC3.1
  %sub289 = sub nsw i32 %DC1.0650, %58
...
if.end331:                                        ; preds = %if.end328, %if.end277
  %59 = load i32, ptr %arrayidx332, align 4, !tbaa !49
  %cmp333 = icmp ne i32 %59, 0
  %60 = load i16, ptr %arrayidx336, align 4
  %cmp338 = icmp eq i16 %60, 0
...
if.end385:                                        ; preds = %if.end382, %if.end331
  ...
  %62 = load i32, ptr %DCT_scaled_size, align 4, !tbaa !78
  %add389 = add i32 %62, %output_col.0645
...
for.inc396:                                       ; preds = %for.end, %if.end44, %for.body
  ...
  %63 = load i32, ptr %num_components, align 8, !tbaa !22
  %64 = sext i32 %63 to i64
  %cmp13 = icmp slt i64 %indvars.iv.next669, %64
  br i1 %cmp13, label %for.body, label %for.end399, !llvm.loop !96

for.end399:                                       ; preds = %for.inc396, %while.end
  %65 = load i32, ptr %output_iMCU_row, align 8, !tbaa !51
  %inc401 = add i32 %65, 1
  store i32 %inc401, ptr %output_iMCU_row, align 8, !tbaa !51
  %66 = load i32, ptr %total_iMCU_rows, align 8, !tbaa !41
  %cmp403 = icmp ult i32 %inc401, %66
