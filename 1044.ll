; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z12.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z12.c"
...
if.end462.i:                                      ; preds = %for.cond430.i, %if.then460.i, %if.end454.i
  ...
  br i1 %cmp488.not1914.i, label %if.end917.i, label %for.cond494.preheader.i
...
for.end546.i:                                     ; preds = %for.inc542.i, %for.cond494.i, %for.cond494.i, %for.cond494.i, %for.cond494.i
  %end_link.01909.i = phi ptr [ %end_link.01915.i, %for.cond494.i ], [ %end_link.01915.i, %for.cond494.i ], [ %end_link.01915.i, %for.cond494.i ], [ %end_link.01915.i, %for.cond494.i ], [ %end_link.1.i, %for.inc542.i ]
...
if.end917.i:                                      ; preds = %cond.end799.i, %cond.false891.i, %cond.end882.i, %for.end546.i, %if.end462.i
...
if.end1261.i:                                     ; preds = %for.cond1242.i, %if.then1259.i
  ...
  br i1 %cmp1287.not1921.i, label %if.end1599, label %for.cond1293.preheader.i
...
for.end1345.i:                                    ; preds = %for.inc1341.i, %for.cond1293.i, %for.cond1293.i, %for.cond1293.i, %for.cond1293.i
  %end_link.21905.i = phi ptr [ %end_link.21922.i, %for.cond1293.i ], [ %end_link.21922.i, %for.cond1293.i ], [ %end_link.21922.i, %for.cond1293.i ], [ %end_link.21922.i, %for.cond1293.i ], [ %end_link.3.i, %for.inc1341.i ]
...
if.end1599:                                       ; preds = %cond.end1598.i, %if.end1261.i, %for.end1345.i, %cond.false1691.i, %cond.end1682.i, %land.lhs.true, %lor.lhs.false1515
...
for.end1673:                                      ; preds = %for.cond1662
  ...
  %or.cond9032 = select i1 %cmp1677, i1 true, i1 %cmp1683.not
...
lor.lhs.false1685:                                ; preds = %for.end1673
  ...
  %or.cond9163.not = select i1 %cmp1689, i1 %cmp1695.not, i1 false
...
if.then3008:                                      ; preds = %if.end3000
  ...
  %call3012 = tail call fastcc i32 @KernLength(i32 noundef %bf.clear3011, i8 noundef zeroext %619, i8 noundef zeroext %ch_right.0)
...
for.cond3044:                                     ; preds = %for.cond3044, %sw.bb3037
  ...
  br i1 %cmp3048, label %for.cond3044, label %for.end3055, !llvm.loop !51
...
for.cond3146:                                     ; preds = %for.cond3146, %sw.bb3139
  ...
  br i1 %cmp3150, label %for.cond3146, label %for.end3157, !llvm.loop !52
...
for.cond3275:                                     ; preds = %for.cond3275, %sw.bb3268
  ...
  br i1 %cmp3279, label %for.cond3275, label %for.end3286, !llvm.loop !53
...
for.cond3417:                                     ; preds = %for.cond3417, %sw.bb3401
  ...
  br i1 %cmp3421, label %for.cond3417, label %for.end3428, !llvm.loop !54
...
for.cond3457.preheader:                           ; preds = %sw.bb3446
  ...
  br i1 %cmp3461.not9254, label %for.end3684, label %for.cond3470.preheader
...
for.inc3680:                                      ; preds = %for.cond3470, %if.end3675
  ...
  br i1 %cmp3461.not, label %for.end3684.loopexit, label %for.cond3470.preheader, !llvm.loop !55

for.end3684.loopexit:                             ; preds = %for.inc3680
  %link.29256.pre = load ptr, ptr %osucc34609253, align 8, !tbaa !5
  br label %for.end3684

for.end3684:                                      ; preds = %for.end3684.loopexit, %for.cond3457.preheader
  %link.29256 = phi ptr [ %link.29256.pre, %for.end3684.loopexit ], [ %661, %for.cond3457.preheader ]
  %cmp3689.not9257 = icmp eq ptr %link.29256, %x
  br i1 %cmp3689.not9257, label %sw.bb5279, label %for.cond3695.preheader

for.cond3695.preheader:                           ; preds = %for.end3684, %for.inc3745
  %link.29259 = phi ptr [ %link.2, %for.inc3745 ], [ %link.29256, %for.end3684 ]
...
for.inc3745:                                      ; preds = %for.cond3695, %cond.false3728, %cond.true3725
  ...
  br i1 %cmp3689.not, label %sw.bb5279, label %for.cond3695.preheader, !llvm.loop !56
...
for.cond3756.preheader:                           ; preds = %cond.true3725, %cond.false3728
  ...
  br i1 %cmp3757.not9263, label %for.end3826, label %for.cond3763.preheader
...
for.inc3822:                                      ; preds = %for.cond3763, %cond.false3800, %cond.true3797
  ...
  br i1 %cmp3757.not, label %for.end3826, label %for.cond3763.preheader, !llvm.loop !57

for.end3826:                                      ; preds = %for.inc3822, %for.cond3756.preheader, %if.then3814, %if.then3817
  %g3455.09233 = phi ptr [ %g3455.09264, %if.then3814 ], [ null, %if.then3817 ], [ null, %for.cond3756.preheader ], [ %g3455.1, %for.inc3822 ]
  %link.39231 = phi ptr [ %link.39266, %if.then3814 ], [ %link.39266, %if.then3817 ], [ %link.39262, %for.cond3756.preheader ], [ %link.3, %for.inc3822 ]
  %cmp3828.not9276 = icmp eq ptr %link.39231, %x
...
while.body3830:                                   ; preds = %while.body3830.lr.ph, %for.end5168
  %link.49279 = phi ptr [ %link.39231, %while.body3830.lr.ph ], [ %link.59222, %for.end5168 ]
  %res.09278 = phi ptr [ null, %while.body3830.lr.ph ], [ %res.2, %for.end5168 ]
  %g3455.29277 = phi ptr [ %g3455.09233, %while.body3830.lr.ph ], [ %g3455.39224, %for.end5168 ]
...
if.end5094:                                       ; preds = %cond.end5006, %land.lhs.true3850, %lor.lhs.false3842, %while.body3830
  ...
  br i1 %cmp5099.not9270, label %for.end5168, label %for.cond5105.preheader
...
for.inc5164:                                      ; preds = %for.cond5105, %cond.false5142, %cond.true5139
  ...
  br i1 %cmp5099.not, label %for.end5168, label %for.cond5105.preheader, !llvm.loop !58

for.end5168:                                      ; preds = %for.inc5164, %if.end5094, %if.then5156, %if.then5159
  %g3455.39224 = phi ptr [ %g3455.39271, %if.then5156 ], [ null, %if.then5159 ], [ null, %if.end5094 ], [ %g3455.4, %for.inc5164 ]
  %link.59222 = phi ptr [ %link.59273, %if.then5156 ], [ %link.59273, %if.then5159 ], [ %link.59269, %if.end5094 ], [ %link.5, %for.inc5164 ]
  %cmp3828.not = icmp eq ptr %link.59222, %x
  br i1 %cmp3828.not, label %while.end5169, label %while.body3830, !llvm.loop !59

while.end5169:                                    ; preds = %for.end5168
...
sw.bb5279:                                        ; preds = %for.inc3745, %for.end3826, %for.end3684, %entry, %entry, %while.end5169, %cond.end5241, %cond.false5250, %sw.bb3446
  %x.addr.2 = phi ptr [ %x, %entry ], [ %x, %entry ], [ %x, %sw.bb3446 ], [ %x, %while.end5169 ], [ %res.2, %cond.end5241 ], [ %res.2, %cond.false5250 ], [ %x, %for.end3684 ], [ %x, %for.end3826 ], [ %x, %for.inc3745 ]
...
for.cond6498.preheader.lr.ph:                     ; preds = %for.cond6491.preheader
  %f.promoted = load i32, ptr %f, align 4, !tbaa !17
  %b.promoted = load i32, ptr %b, align 4, !tbaa !17
...
for.cond5304:                                     ; preds = %for.cond5304.preheader, %for.cond5304
  ...
  br i1 %cmp5308, label %for.cond5304, label %for.end5315, !llvm.loop !60
...
land.lhs.true5633:                                ; preds = %land.lhs.true5627
  ...
  %or.cond9165 = select i1 %tobool5639.not, i1 %cmp5644, i1 false
...
land.lhs.true5658:                                ; preds = %land.lhs.true5646
  ...
  %or.cond9171 = select i1 %cmp5666, i1 %or.cond9044, i1 false
...
for.inc6440:                                      ; preds = %if.then6272, %if.then6313, %if.then6432, %if.end6425, %if.else5602, %cond.end5365, %land.lhs.true6292, %if.then6300, %cond.end5562, %if.then5599, %if.then5327, %cond.false5374, %if.end6252
  ...
  br i1 %cmp5298.not, label %for.end6444, label %for.cond5304.preheader, !llvm.loop !61
...
if.then6447:                                      ; preds = %if.then5289, %for.end6444
  %will_expand.0.lcssa9473 = phi i32 [ %will_expand.3, %for.end6444 ], [ 0, %if.then5289 ]
...
if.else6448:                                      ; preds = %for.end6444
  ...
  %.pre9449 = load i32, ptr %b, align 4, !tbaa !17
  br label %if.end6454

if.end6454:                                       ; preds = %if.else6448, %if.then6447
  %will_expand.0.lcssa9472 = phi i32 [ %will_expand.3, %if.else6448 ], [ %will_expand.0.lcssa9473, %if.then6447 ]
  ...
  %tobool6481 = icmp ne i32 %will_expand.0.lcssa9472, 0
...
for.cond6498:                                     ; preds = %for.cond6498.preheader, %for.cond6498
  ...
  br i1 %cmp6502, label %for.cond6498, label %for.end6509, !llvm.loop !62
...
for.inc6886:                                      ; preds = %cond.end6559, %if.then6813, %if.end6806, %if.else6873, %if.then6844, %cond.end6756, %if.then6793, %if.then6521, %cond.false6568
  ...
  br i1 %cmp6492.not, label %for.end6890, label %for.cond6498.preheader, !llvm.loop !63
...
if.then6892:                                      ; preds = %for.cond6491.preheader, %for.end6890
  %dble_fwd.0.lcssa9481 = phi i32 [ %dble_fwd.1, %for.end6890 ], [ 0, %for.cond6491.preheader ]
  %dble_found.0.lcssa9479 = phi i32 [ %dble_found.1, %for.end6890 ], [ 0, %for.cond6491.preheader ]
...
if.end6894:                                       ; preds = %if.then6892, %for.end6890
  %dble_fwd.0.lcssa9480 = phi i32 [ %dble_fwd.0.lcssa9481, %if.then6892 ], [ %dble_fwd.1, %for.end6890 ]
  %dble_found.0.lcssa9478 = phi i32 [ %dble_found.0.lcssa9479, %if.then6892 ], [ %dble_found.1, %for.end6890 ]
  %tobool6895.not = icmp eq i32 %dble_found.0.lcssa9478, 0
...
if.then6896:                                      ; preds = %if.end6894
  ...
  %1087 = load i32, ptr %b, align 4, !tbaa !17
  %1088 = load i32, ptr %f, align 4, !tbaa !17
  %add6901 = add nsw i32 %1088, %1087
  %cond6908 = tail call i32 @llvm.smax.i32(i32 %dble_fwd.0.lcssa9480, i32 %add6901)
...
for.inc7034:                                      ; preds = %if.end6979, %if.end6979, %if.end6979, %if.end6979, %if.then7003
  ...
  br i1 %cmp6954.not, label %for.end7038, label %for.cond6960.preheader, !llvm.loop !64
...
for.inc7133:                                      ; preds = %if.end7078, %if.then7102
  ...
  br i1 %cmp7053.not, label %for.end7137, label %for.cond7059.preheader, !llvm.loop !65
...
for.inc7251:                                      ; preds = %if.end7196, %if.then7220
  ...
  br i1 %cmp7171.not, label %for.end7255, label %for.cond7177.preheader, !llvm.loop !66
...
for.inc7374:                                      ; preds = %if.end7295, %if.then7319
  ...
  br i1 %cmp7270.not, label %sw.epilog7697, label %for.cond7276.preheader, !llvm.loop !67
...
for.cond7391:                                     ; preds = %for.cond7391, %if.end7384
  ...
  br i1 %cmp7395, label %for.cond7391, label %for.end7402, !llvm.loop !68
...
while.cond7413.backedge:                          ; preds = %if.then7445, %land.lhs.true7427, %if.else7432, %land.lhs.true7437, %land.lhs.true7441
  ...
  br label %while.cond7413, !llvm.loop !69

if.then7450:                                      ; preds = %if.then7445
  %1125 = load float, ptr %fllx, align 4, !tbaa !70
  %1126 = load float, ptr %flly, align 4, !tbaa !70
  %1127 = load float, ptr %furx, align 4, !tbaa !70
  %1128 = load float, ptr %fury, align 4, !tbaa !70
  ...
  br label %while.cond7413.outer, !llvm.loop !69
...
for.cond7606:                                     ; preds = %for.cond7606, %sw.bb7599
  ...
  br i1 %cmp7610, label %for.cond7606, label %for.end7617, !llvm.loop !72
...
for.end7617:                                      ; preds = %for.cond7606
  ...
  %1147 = shufflevector <4 x i32> %.ph, <4 x i32> undef, <2 x i32> <i32 2, i32 3>
  %1148 = shufflevector <4 x i32> %.ph, <4 x i32> undef, <2 x i32> <i32 0, i32 1>
...
entry:
  ...
  %1 = load ptr, ptr %font_table, align 8, !tbaa !73
...
for.cond:                                         ; preds = %for.cond, %if.else
  ...
  br i1 %cmp20, label %for.cond, label %for.end, !llvm.loop !79
...
cond.true:                                        ; preds = %for.end
  %idxprom17.le = and i64 %indvars.iv, 4294967295
  %kern_sizes = getelementptr inbounds %struct.font_rec, ptr %0, i64 %idxprom, i32 12
  %10 = load ptr, ptr %kern_sizes, align 8, !tbaa !80
  %kern_value = getelementptr inbounds %struct.font_rec, ptr %0, i64 %idxprom, i32 11
  %11 = load ptr, ptr %kern_value, align 8, !tbaa !81
  %arrayidx32 = getelementptr inbounds i8, ptr %11, i64 %idxprom17.le
  ...
  %13 = load i16, ptr %arrayidx34, align 2, !tbaa !77
...
!72 = distinct !{!72, !11}
!73 = !{!74, !9, i64 40}
!74 = !{!"font_rec", !9, i64 0, !9, i64 8, !9, i64 16, !9, i64 24, !18, i64 32, !9, i64 40, !9, i64 48, !75, i64 56, !75, i64 58, !9, i64 64, !9, i64 72, !9, i64 80, !9, i64 88}
!75 = !{!"short", !6, i64 0}
!76 = !{!74, !9, i64 64}
!77 = !{!75, !75, i64 0}
!78 = !{!74, !9, i64 72}
