; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/rdppm.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/rdppm.c"
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call4 = tail call i32 @_IO_getc(ptr noundef %3)
...
if.end112:                                        ; preds = %sw.default, %if.then65, %if.else68, %if.then61, %if.then92, %if.else95, %if.then87
  ...
  %call111 = tail call ptr %21(ptr noundef nonnull %cinfo, i32 noundef 1, i64 noundef %mul109) #3
...
if.else119.sink.split:                            ; preds = %if.end23, %sw.bb32
  ...
  %22 = phi <2 x i32> [ <i32 3, i32 2>, %sw.bb32 ], [ <i32 1, i32 1>, %if.end23 ]
  %input_components33 = getelementptr inbounds %struct.jpeg_compress_struct, ptr %cinfo, i64 0, i32 8
  store <2 x i32> %22, ptr %input_components33, align 8, !tbaa !30
  %23 = load ptr, ptr %cinfo, align 8, !tbaa !21
  %msg_code25 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %23, i64 0, i32 5
  ...
  %arrayidx29 = getelementptr inbounds %struct.jpeg_error_mgr, ptr %24, i64 0, i32 6, i32 0, i64 1
  ...
  %26 = load ptr, ptr %emit_message, align 8, !tbaa !31
  tail call void %26(ptr noundef nonnull %cinfo, i32 noundef 1) #3
...
if.else119:                                       ; preds = %if.else119.sink.split, %if.end112
  ...
  %27 = load ptr, ptr %mem120, align 8, !tbaa !5
  %alloc_sarray = getelementptr inbounds %struct.jpeg_memory_mgr, ptr %27, i64 0, i32 2
  %28 = load ptr, ptr %alloc_sarray, align 8, !tbaa !35
  %input_components121 = getelementptr inbounds %struct.jpeg_compress_struct, ptr %cinfo, i64 0, i32 8
  %29 = load i32, ptr %input_components121, align 8, !tbaa !28
  %mul122 = mul i32 %29, %call7
  %call123 = tail call ptr %28(ptr noundef nonnull %cinfo, i32 noundef 1, i32 noundef %mul122, i32 noundef 1) #3
...
if.then130:                                       ; preds = %if.else119, %if.end128
  ...
  %30 = load ptr, ptr %mem131, align 8, !tbaa !5
  %31 = load ptr, ptr %30, align 8, !tbaa !13
  %conv133 = zext i32 %call13 to i64
  %add = add nuw nsw i64 %conv133, 1
  %call135 = tail call ptr %31(ptr noundef nonnull %cinfo, i32 noundef 1, i64 noundef %add) #3
  ...
  %32 = add nuw nsw i64 %conv133, 1
  %xtraiter = and i64 %32, 1
  %33 = icmp eq i32 %call13, 0
  br i1 %33, label %if.end147.loopexit.unr-lcssa, label %if.then130.new

if.then130.new:                                   ; preds = %if.then130
  %unroll_iter = and i64 %32, -2
  br label %for.body
...
for.body:                                         ; preds = %for.body, %if.then130.new
  ...
  %34 = load ptr, ptr %rescale, align 8, !tbaa !39
  %arrayidx146 = getelementptr inbounds i8, ptr %34, i64 %val.0259
  ...
  %arrayidx146.1 = getelementptr inbounds i8, ptr %35, i64 %inc
...
for.body.epil:                                    ; preds = %if.end147.loopexit.unr-lcssa
  ...
  %arrayidx146.epil = getelementptr inbounds i8, ptr %36, i64 %val.0259.unr
