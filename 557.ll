; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/parset.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/parset.c"
...
entry:
  %call = tail call ptr @AllocSPS() #11
...
for.end:                                          ; preds = %for.body, %if.end
  ...
  %sub39 = select i1 %narrow, i32 16, i32 32
...
lor.end51:                                        ; preds = %for.end, %lor.rhs49
  ...
  %mul61 = mul i32 %sub39, %div40243
  %call63 = tail call ptr @alloc_colocated(i32 noundef %mul60, i32 noundef %mul61, i32 noundef %conv44) #11
...
if.else79.6:                                      ; preds = %lor.end51
  ...
  %ScalingMatrixPresentFlag = getelementptr inbounds %struct.InputParameters, ptr %32, i64 0, i32 167
  %seq_scaling_matrix_present_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 9
  %Transform8x8Mode = getelementptr inbounds %struct.InputParameters, ptr %32, i64 0, i32 153
  %33 = load <2 x i32>, ptr %ScalingMatrixPresentFlag, align 8, !tbaa !29
  %34 = and <2 x i32> %33, <i32 1, i32 1>
  store <2 x i32> %34, ptr %seq_scaling_matrix_present_flag, align 4, !tbaa !39
  %arrayidx75.1 = getelementptr inbounds %struct.InputParameters, ptr %32, i64 0, i32 168, i64 1
  %35 = load i32, ptr %arrayidx75.1, align 4, !tbaa !29
  %and76.1 = and i32 %35, 1
  ...
  %arrayidx75.2 = getelementptr inbounds %struct.InputParameters, ptr %32, i64 0, i32 168, i64 2
  %36 = load i32, ptr %arrayidx75.2, align 4, !tbaa !29
  %and76.2 = and i32 %36, 1
  ...
  %arrayidx75.3 = getelementptr inbounds %struct.InputParameters, ptr %32, i64 0, i32 168, i64 3
  %37 = load i32, ptr %arrayidx75.3, align 4, !tbaa !29
  %and76.3 = and i32 %37, 1
  ...
  %arrayidx75.4 = getelementptr inbounds %struct.InputParameters, ptr %32, i64 0, i32 168, i64 4
  %38 = load i32, ptr %arrayidx75.4, align 4, !tbaa !29
  %and76.4 = and i32 %38, 1
  ...
  %arrayidx75.5 = getelementptr inbounds %struct.InputParameters, ptr %32, i64 0, i32 168, i64 5
  %39 = load i32, ptr %arrayidx75.5, align 4, !tbaa !29
  %and76.5 = and i32 %39, 1
  ...
  %40 = load i32, ptr %Transform8x8Mode, align 4, !tbaa !63
  %tobool80.not.6 = icmp eq i32 %40, 0
  br i1 %tobool80.not.6, label %if.else79.7, label %if.then81.6

if.then81.6:                                      ; preds = %if.else79.6
  %arrayidx84.6 = getelementptr inbounds %struct.InputParameters, ptr %32, i64 0, i32 168, i64 6
  %41 = load i32, ptr %arrayidx84.6, align 4, !tbaa !29
  %and85.6 = and i32 %41, 1
...
if.else79.7:                                      ; preds = %if.else79.6, %if.then81.6
  ...
  %42 = load i32, ptr %Transform8x8Mode, align 4, !tbaa !63
  %tobool80.not.7 = icmp eq i32 %42, 0
  br i1 %tobool80.not.7, label %if.else89.7, label %if.then81.7

if.then81.7:                                      ; preds = %if.else79.7
  %arrayidx84.7 = getelementptr inbounds %struct.InputParameters, ptr %32, i64 0, i32 168, i64 7
  %43 = load i32, ptr %arrayidx84.7, align 4, !tbaa !29
  %and85.7 = and i32 %43, 1
...
if.end110:                                        ; preds = %if.then81.7, %if.else89.7, %if.else98
  ...
  %auto_crop_right111 = getelementptr inbounds %struct.ImageParameters, ptr %44, i64 0, i32 166
  %45 = load i32, ptr %auto_crop_right111, align 8, !tbaa !50
  %tobool112.not = icmp eq i32 %45, 0
  %auto_crop_bottom114 = getelementptr inbounds %struct.ImageParameters, ptr %44, i64 0, i32 167
  %46 = load i32, ptr %auto_crop_bottom114, align 4, !tbaa !53
...
if.then116:                                       ; preds = %if.end110
  ...
  %47 = load i32, ptr %chroma_format_idc, align 4, !tbaa !62
  %idxprom119 = zext i32 %47 to i64
  %arrayidx120 = getelementptr inbounds [4 x i32], ptr @__const.GenerateSequenceParameterSet.SubWidthC, i64 0, i64 %idxprom119
  %48 = load i32, ptr %arrayidx120, align 4, !tbaa !29
  %div121 = sdiv i32 %45, %48
  ...
  %49 = load i32, ptr %arrayidx125, align 4, !tbaa !29
  %50 = load i32, ptr %frame_mbs_only_flag, align 4, !tbaa !48
  %sub127 = sub i32 2, %50
  %mul128 = mul i32 %sub127, %49
  %div129 = udiv i32 %46, %mul128
...
if.end136:                                        ; preds = %if.then135, %if.then116
  ...
  %51 = phi i32 [ %.pre234, %if.then135 ], [ %46, %if.then116 ]
  %rem144 = urem i32 %51, %mul143.pre-phi
...
entry:
  %pps280 = ptrtoint ptr %pps to i64
  %0 = load ptr, ptr @input, align 8, !tbaa !5
  %1 = load i32, ptr %0, align 8, !tbaa !22
  %switch.tableidx = add i32 %1, -100
  %2 = icmp ult i32 %switch.tableidx, 45
...
if.then53:                                        ; preds = %if.end48
  ...
  %call55 = tail call noalias ptr @calloc(i64 noundef %conv, i64 noundef 1) #12
...
sw.bb:                                            ; preds = %if.end59
  ...
  %36 = add nuw i32 %34, 1
  %wide.trip.count259 = zext i32 %36 to i64
  %min.iters.check283 = icmp ult i32 %34, 7
  br i1 %min.iters.check283, label %for.body65.preheader, label %vector.memcheck279

vector.memcheck279:                               ; preds = %sw.bb
  %37 = ptrtoint ptr %35 to i64
  %38 = add i64 %pps280, 68
  %39 = sub i64 %38, %37
  %diff.check = icmp ult i64 %39, 32
  br i1 %diff.check, label %for.body65.preheader, label %vector.ph284

vector.ph284:                                     ; preds = %vector.memcheck279
  %n.vec286 = and i64 %wide.trip.count259, 4294967288
...
vector.body289:                                   ; preds = %vector.body289, %vector.ph284
  ...
  %40 = getelementptr inbounds i32, ptr %35, i64 %index290
  %wide.load291 = load <4 x i32>, ptr %40, align 4, !tbaa !29
  %41 = getelementptr inbounds i32, ptr %40, i64 4
  %wide.load292 = load <4 x i32>, ptr %41, align 4, !tbaa !29
  %42 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 10, i64 %index290
  store <4 x i32> %wide.load291, ptr %42, align 4, !tbaa !29
  %43 = getelementptr inbounds i32, ptr %42, i64 4
  store <4 x i32> %wide.load292, ptr %43, align 4, !tbaa !29
  %index.next293 = add nuw i64 %index290, 8
  %44 = icmp eq i64 %index.next293, %n.vec286
  br i1 %44, label %middle.block281, label %vector.body289, !llvm.loop !83

middle.block281:                                  ; preds = %vector.body289
  %cmp.n288 = icmp eq i64 %n.vec286, %wide.trip.count259
  br i1 %cmp.n288, label %if.end124, label %for.body65.preheader

for.body65.preheader:                             ; preds = %vector.memcheck279, %sw.bb, %middle.block281
  %indvars.iv256.ph = phi i64 [ 0, %vector.memcheck279 ], [ 0, %sw.bb ], [ %n.vec286, %middle.block281 ]
  %45 = xor i64 %indvars.iv256.ph, -1
  %46 = add nsw i64 %45, %wide.trip.count259
  %xtraiter296 = and i64 %wide.trip.count259, 3
  %lcmp.mod297.not = icmp eq i64 %xtraiter296, 0
  br i1 %lcmp.mod297.not, label %for.body65.prol.loopexit, label %for.body65.prol

for.body65.prol:                                  ; preds = %for.body65.preheader, %for.body65.prol
  %indvars.iv256.prol = phi i64 [ %indvars.iv.next257.prol, %for.body65.prol ], [ %indvars.iv256.ph, %for.body65.preheader ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body65.prol ], [ 0, %for.body65.preheader ]
  %arrayidx67.prol = getelementptr inbounds i32, ptr %35, i64 %indvars.iv256.prol
  %47 = load i32, ptr %arrayidx67.prol, align 4, !tbaa !29
  %arrayidx70.prol = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 10, i64 %indvars.iv256.prol
  store i32 %47, ptr %arrayidx70.prol, align 4, !tbaa !29
  %indvars.iv.next257.prol = add nuw nsw i64 %indvars.iv256.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter296
...
for.body65.prol.loopexit:                         ; preds = %for.body65.prol, %for.body65.preheader
  %indvars.iv256.unr = phi i64 [ %indvars.iv256.ph, %for.body65.preheader ], [ %indvars.iv.next257.prol, %for.body65.prol ]
  %48 = icmp ult i64 %46, 3
  br i1 %48, label %if.end124, label %for.body65

for.body65:                                       ; preds = %for.body65.prol.loopexit, %for.body65
  %indvars.iv256 = phi i64 [ %indvars.iv.next257.3, %for.body65 ], [ %indvars.iv256.unr, %for.body65.prol.loopexit ]
  %arrayidx67 = getelementptr inbounds i32, ptr %35, i64 %indvars.iv256
  %49 = load i32, ptr %arrayidx67, align 4, !tbaa !29
  %arrayidx70 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 10, i64 %indvars.iv256
  store i32 %49, ptr %arrayidx70, align 4, !tbaa !29
  %indvars.iv.next257 = add nuw nsw i64 %indvars.iv256, 1
  %arrayidx67.1 = getelementptr inbounds i32, ptr %35, i64 %indvars.iv.next257
  %50 = load i32, ptr %arrayidx67.1, align 4, !tbaa !29
  %arrayidx70.1 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 10, i64 %indvars.iv.next257
  store i32 %50, ptr %arrayidx70.1, align 4, !tbaa !29
  %indvars.iv.next257.1 = add nuw nsw i64 %indvars.iv256, 2
  %arrayidx67.2 = getelementptr inbounds i32, ptr %35, i64 %indvars.iv.next257.1
  %51 = load i32, ptr %arrayidx67.2, align 4, !tbaa !29
  %arrayidx70.2 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 10, i64 %indvars.iv.next257.1
  store i32 %51, ptr %arrayidx70.2, align 4, !tbaa !29
  %indvars.iv.next257.2 = add nuw nsw i64 %indvars.iv256, 3
  %arrayidx67.3 = getelementptr inbounds i32, ptr %35, i64 %indvars.iv.next257.2
  %52 = load i32, ptr %arrayidx67.3, align 4, !tbaa !29
  %arrayidx70.3 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 10, i64 %indvars.iv.next257.2
  store i32 %52, ptr %arrayidx70.3, align 4, !tbaa !29
  %indvars.iv.next257.3 = add nuw nsw i64 %indvars.iv256, 4
  %exitcond260.3 = icmp eq i64 %indvars.iv.next257.3, %wide.trip.count259
  br i1 %exitcond260.3, label %if.end124, label %for.body65, !llvm.loop !88
...
vector.memcheck:                                  ; preds = %for.body82.lr.ph
  %uglygep = getelementptr i8, ptr %pps, i64 100
  %56 = shl nuw nsw i64 %wide.trip.count, 2
  %57 = add nuw nsw i64 %56, 132
  %uglygep272 = getelementptr i8, ptr %pps, i64 %57
  %uglygep273 = getelementptr i8, ptr %54, i64 %56
  %uglygep274 = getelementptr i8, ptr %55, i64 %56
  %bound0 = icmp ult ptr %uglygep, %uglygep273
  %bound1 = icmp ult ptr %54, %uglygep272
  %found.conflict = and i1 %bound0, %bound1
  %bound0275 = icmp ult ptr %uglygep, %uglygep274
  %bound1276 = icmp ult ptr %55, %uglygep272
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load278 = load <4 x i32>, ptr %60, align 4, !tbaa !29, !alias.scope !98
  %61 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 12, i64 %index
  store <4 x i32> %wide.load278, ptr %61, align 4, !tbaa !29, !alias.scope !94, !noalias !96
...
for.body82.preheader:                             ; preds = %vector.memcheck, %for.body82.lr.ph, %middle.block
  %indvars.iv252.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %for.body82.lr.ph ], [ %n.vec, %middle.block ]
  %63 = xor i64 %indvars.iv252.ph, -1
...
for.body82.prol:                                  ; preds = %for.body82.preheader
  %arrayidx84.prol = getelementptr inbounds i32, ptr %54, i64 %indvars.iv252.ph
  %64 = load i32, ptr %arrayidx84.prol, align 4, !tbaa !29
  %arrayidx87.prol = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 11, i64 %indvars.iv252.ph
  store i32 %64, ptr %arrayidx87.prol, align 4, !tbaa !29
  %arrayidx89.prol = getelementptr inbounds i32, ptr %55, i64 %indvars.iv252.ph
  %65 = load i32, ptr %arrayidx89.prol, align 4, !tbaa !29
  %arrayidx92.prol = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 12, i64 %indvars.iv252.ph
  store i32 %65, ptr %arrayidx92.prol, align 4, !tbaa !29
  %indvars.iv.next253.prol = or i64 %indvars.iv252.ph, 1
  br label %for.body82.prol.loopexit

for.body82.prol.loopexit:                         ; preds = %for.body82.prol, %for.body82.preheader
  %indvars.iv252.unr = phi i64 [ %indvars.iv252.ph, %for.body82.preheader ], [ %indvars.iv.next253.prol, %for.body82.prol ]
...
for.body82:                                       ; preds = %for.body82.prol.loopexit, %for.body82
  %indvars.iv252 = phi i64 [ %indvars.iv.next253.1, %for.body82 ], [ %indvars.iv252.unr, %for.body82.prol.loopexit ]
  %arrayidx84 = getelementptr inbounds i32, ptr %54, i64 %indvars.iv252
  %68 = load i32, ptr %arrayidx84, align 4, !tbaa !29
  %arrayidx87 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 11, i64 %indvars.iv252
  store i32 %68, ptr %arrayidx87, align 4, !tbaa !29
  %arrayidx89 = getelementptr inbounds i32, ptr %55, i64 %indvars.iv252
  %69 = load i32, ptr %arrayidx89, align 4, !tbaa !29
  %arrayidx92 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 12, i64 %indvars.iv252
  store i32 %69, ptr %arrayidx92, align 4, !tbaa !29
  %indvars.iv.next253 = add nuw nsw i64 %indvars.iv252, 1
  %arrayidx84.1 = getelementptr inbounds i32, ptr %54, i64 %indvars.iv.next253
  %70 = load i32, ptr %arrayidx84.1, align 4, !tbaa !29
  %arrayidx87.1 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 11, i64 %indvars.iv.next253
  store i32 %70, ptr %arrayidx87.1, align 4, !tbaa !29
  %arrayidx89.1 = getelementptr inbounds i32, ptr %55, i64 %indvars.iv.next253
  %71 = load i32, ptr %arrayidx89.1, align 4, !tbaa !29
  %arrayidx92.1 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 12, i64 %indvars.iv.next253
  store i32 %71, ptr %arrayidx92.1, align 4, !tbaa !29
  %indvars.iv.next253.1 = add nuw nsw i64 %indvars.iv252, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next253.1, %wide.trip.count
...
for.body113:                                      ; preds = %sw.bb101, %for.body113
  %indvars.iv = phi i64 [ 0, %sw.bb101 ], [ %indvars.iv.next, %for.body113 ]
  ...
  %arrayidx116 = getelementptr inbounds i8, ptr %80, i64 %indvars.iv
  %81 = load i8, ptr %arrayidx116, align 1, !tbaa !39
  %82 = load ptr, ptr %slice_group_id, align 8, !tbaa !79
  %arrayidx119 = getelementptr inbounds i8, ptr %82, i64 %indvars.iv
  store i8 %81, ptr %arrayidx119, align 1, !tbaa !39
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %83 = load i32, ptr %pic_size_in_map_units_minus1, align 4, !tbaa !101
  %84 = zext i32 %83 to i64
  %cmp111.not.not = icmp ult i64 %indvars.iv, %84
  br i1 %cmp111.not.not, label %for.body113, label %if.end124, !llvm.loop !103

sw.default:                                       ; preds = %if.end59
  %puts = tail call i32 @puts(ptr nonnull dereferenceable(1) @str)
  br label %if.end124

if.end124:                                        ; preds = %for.body113, %for.body82.prol.loopexit, %for.body82, %for.body65.prol.loopexit, %for.body65, %middle.block, %middle.block281, %sw.bb76, %sw.bb74, %sw.bb96, %sw.default, %if.end48
  %frame_mbs_only_flag125 = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 25
  %85 = load i32, ptr %frame_mbs_only_flag125, align 4, !tbaa !48
  %tobool126.not = icmp eq i32 %85, 0
  %num_ref_frames128 = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 21
  %86 = load i32, ptr %num_ref_frames128, align 4, !tbaa !44
  %mul129 = zext i1 %tobool126.not to i32
  %cond131.sink.in = shl i32 %86, %mul129
  %cond131.sink = add i32 %cond131.sink.in, -1
  %87 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 17
  store i32 %cond131.sink, ptr %87, align 8
  ...
  %88 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 24
  store i32 %cb_qp_index_offset, ptr %88, align 4
  %89 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 25
  store i32 %cb_qp_index_offset.sink, ptr %89, align 8
  %90 = load ptr, ptr @input, align 8, !tbaa !5
  %LFSendParameters = getelementptr inbounds %struct.InputParameters, ptr %90, i64 0, i32 132
  %91 = load i32, ptr %LFSendParameters, align 4, !tbaa !110
  %deblocking_filter_control_present_flag = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 26
  store i32 %91, ptr %deblocking_filter_control_present_flag, align 4, !tbaa !111
  %UseConstrainedIntraPred = getelementptr inbounds %struct.InputParameters, ptr %90, i64 0, i32 23
  %92 = load i32, ptr %UseConstrainedIntraPred, align 8, !tbaa !112
  %constrained_intra_pred_flag = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 27
  store i32 %92, ptr %constrained_intra_pred_flag, align 8, !tbaa !113
  %redundant_pic_flag = getelementptr inbounds %struct.InputParameters, ptr %90, i64 0, i32 149
  %93 = load i32, ptr %redundant_pic_flag, align 4, !tbaa !114
  %redundant_pic_cnt_present_flag = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 28
  store i32 %93, ptr %redundant_pic_cnt_present_flag, align 4, !tbaa !115
  ret void
}
...
if.then:                                          ; preds = %for.body
  tail call void @FreePPS(ptr noundef nonnull %0) #11
...
for.end:                                          ; preds = %for.inc
  ...
  tail call void @FreeSPS(ptr noundef %1) #11
  ret void
}
...
entry:
  ...
  %call = tail call ptr @AllocNALU(i32 noundef 64000) #11
  call void @llvm.lifetime.start.p0(i64 64000, ptr nonnull %rbsp) #11
  ...
  %call3 = call i32 @RBSPtoNALU(ptr noundef nonnull %rbsp, ptr noundef %call, i32 noundef %call1, i32 noundef 7, i32 noundef 3, i32 noundef 0, i32 noundef 1) #11
  store i32 4, ptr %call, align 8, !tbaa !117
  call void @llvm.lifetime.end.p0(i64 64000, ptr nonnull %rbsp) #11
  ret ptr %call
}
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call1 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.6, i32 noundef %0, ptr noundef %call) #11
  %constrained_set0_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 2
  %1 = load i32, ptr %constrained_set0_flag, align 4, !tbaa !25
  %call2 = tail call i32 @u_1(ptr noundef nonnull @.str.7, i32 noundef %1, ptr noundef %call) #11
  %constrained_set1_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 3
  %2 = load i32, ptr %constrained_set1_flag, align 4, !tbaa !26
  %call4 = tail call i32 @u_1(ptr noundef nonnull @.str.8, i32 noundef %2, ptr noundef %call) #11
  %constrained_set2_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 4
  %3 = load i32, ptr %constrained_set2_flag, align 4, !tbaa !27
  %call6 = tail call i32 @u_1(ptr noundef nonnull @.str.9, i32 noundef %3, ptr noundef %call) #11
  ...
  %call8 = tail call i32 @u_1(ptr noundef nonnull @.str.10, i32 noundef %4, ptr noundef %call) #11
  %call10 = tail call i32 @u_v(i32 noundef 4, ptr noundef nonnull @.str.11, i32 noundef 0, ptr noundef %call) #11
  %level_idc = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 6
  %5 = load i32, ptr %level_idc, align 4, !tbaa !24
  %call12 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.12, i32 noundef %5, ptr noundef %call) #11
  %seq_parameter_set_id = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 7
  %6 = load i32, ptr %seq_parameter_set_id, align 4, !tbaa !28
  %call14 = tail call i32 @ue_v(ptr noundef nonnull @.str.13, i32 noundef %6, ptr noundef %call) #11
...
if.then26:                                        ; preds = %if.end, %if.end, %if.end, %if.end
  ...
  %call27 = tail call i32 @ue_v(ptr noundef nonnull @.str.14, i32 noundef %8, ptr noundef nonnull %call) #11
...
if.then30:                                        ; preds = %if.then26
  %call31 = tail call i32 @u_1(ptr noundef nonnull @.str.15, i32 noundef 0, ptr noundef nonnull %call) #11
  br label %if.end33

if.end33:                                         ; preds = %if.then30, %if.then26
  %bit_depth_luma_minus8 = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 11
  %11 = load i32, ptr %bit_depth_luma_minus8, align 4, !tbaa !124
  %call34 = tail call i32 @ue_v(ptr noundef nonnull @.str.16, i32 noundef %11, ptr noundef nonnull %call) #11
  ...
  %call36 = tail call i32 @ue_v(ptr noundef nonnull @.str.17, i32 noundef %12, ptr noundef nonnull %call) #11
  ...
  %call38 = tail call i32 @u_1(ptr noundef nonnull @.str.18, i32 noundef %14, ptr noundef nonnull %call) #11
  %seq_scaling_matrix_present_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 9
  %15 = load i32, ptr %seq_scaling_matrix_present_flag, align 4, !tbaa !126
  %call40 = tail call i32 @u_1(ptr noundef nonnull @.str.19, i32 noundef %15, ptr noundef nonnull %call) #11
...
for.body:                                         ; preds = %if.end33, %for.inc
  ...
  %call45 = tail call i32 @u_1(ptr noundef nonnull @.str.20, i32 noundef %17, ptr noundef %call) #11
...
for.body.i:                                       ; preds = %for.cond.i, %if.then53
  %indvars.iv.i = phi i64 [ 0, %if.then53 ], [ %indvars.iv.next.i, %for.cond.i ]
  %nextScale.072.i = phi i32 [ 8, %if.then53 ], [ %nextScale.166.i, %for.cond.i ]
  %lastScale.071.i = phi i32 [ 8, %if.then53 ], [ %23, %for.cond.i ]
  %arrayidx.i = getelementptr inbounds [16 x i8], ptr @ZZ_SCAN, i64 0, i64 %indvars.iv.i
  %cond.in.i = load i8, ptr %arrayidx.i, align 1, !tbaa !39
  %cmp5.not.i = icmp eq i32 %nextScale.072.i, 0
  %.pre74.i = zext i8 %cond.in.i to i64
  br i1 %cmp5.not.i, label %if.end28.thread.i, label %if.end28.i

if.end28.i:                                       ; preds = %for.body.i
  %arrayidx8.i = getelementptr inbounds i16, ptr %arrayidx55, i64 %.pre74.i
  %19 = load i16, ptr %arrayidx8.i, align 2, !tbaa !127
  %conv9.i = sext i16 %19 to i32
  ...
  %call.i = tail call i32 @se_v(ptr noundef nonnull @.str.4, i32 noundef %delta_scale.0.i, ptr noundef %call) #11
  %20 = load i16, ptr %arrayidx8.i, align 2, !tbaa !127
  %.fr.i = freeze i16 %20
  %conv21.i = sext i16 %.fr.i to i32
  %cmp22.i = icmp eq i64 %indvars.iv.i, 0
  %cmp24.i = icmp eq i16 %.fr.i, 0
  %21 = and i1 %cmp22.i, %cmp24.i
  %land.ext.i = zext i1 %21 to i16
  %22 = load i16, ptr %arrayidx60, align 2, !tbaa !127
  %or.i = or i16 %22, %land.ext.i
  store i16 %or.i, ptr %arrayidx60, align 2, !tbaa !127
...
for.cond.i:                                       ; preds = %if.end28.thread.i, %if.end28.i
  ...
  %23 = phi i32 [ %conv21.i, %if.end28.i ], [ %lastScale.071.i, %if.end28.thread.i ]
  %conv35.i = trunc i32 %23 to i16
  %arrayidx37.i = getelementptr inbounds i16, ptr %arrayidx57, i64 %.pre74.i
...
for.body.i301:                                    ; preds = %for.cond.i328, %if.else
  %indvars.iv.i292 = phi i64 [ 0, %if.else ], [ %indvars.iv.next.i326, %for.cond.i328 ]
  %nextScale.072.i293 = phi i32 [ 8, %if.else ], [ %nextScale.166.i322, %for.cond.i328 ]
  %lastScale.071.i294 = phi i32 [ 8, %if.else ], [ %29, %for.cond.i328 ]
  %arrayidx3.i297 = getelementptr inbounds [64 x i8], ptr @ZZ_SCAN8, i64 0, i64 %indvars.iv.i292
  %cond.in.i298 = load i8, ptr %arrayidx3.i297, align 1, !tbaa !39
  %cmp5.not.i299 = icmp eq i32 %nextScale.072.i293, 0
  %.pre74.i300 = zext i8 %cond.in.i298 to i64
  br i1 %cmp5.not.i299, label %if.end28.thread.i321, label %if.end28.i319

if.end28.i319:                                    ; preds = %for.body.i301
  %arrayidx8.i302 = getelementptr inbounds i16, ptr %arrayidx64, i64 %.pre74.i300
  %25 = load i16, ptr %arrayidx8.i302, align 2, !tbaa !127
  %conv9.i303 = sext i16 %25 to i32
  %sub.i304 = sub nsw i32 %conv9.i303, %lastScale.071.i294
  %cmp10.i305 = icmp sgt i32 %sub.i304, 127
  %sub13.i306 = add nsw i32 %sub.i304, -256
  %cmp14.i307 = icmp slt i32 %sub.i304, -128
  %add.i308 = add nsw i32 %sub.i304, 256
  %spec.select.i309 = select i1 %cmp14.i307, i32 %add.i308, i32 %sub.i304
  %delta_scale.0.i310 = select i1 %cmp10.i305, i32 %sub13.i306, i32 %spec.select.i309
  %call.i311 = tail call i32 @se_v(ptr noundef nonnull @.str.4, i32 noundef %delta_scale.0.i310, ptr noundef %call) #11
  %26 = load i16, ptr %arrayidx8.i302, align 2, !tbaa !127
  %.fr.i313 = freeze i16 %26
  %conv21.i314 = sext i16 %.fr.i313 to i32
  %cmp22.i315 = icmp eq i64 %indvars.iv.i292, 0
  %cmp24.i316 = icmp eq i16 %.fr.i313, 0
  %27 = and i1 %cmp22.i315, %cmp24.i316
  %land.ext.i317 = zext i1 %27 to i16
  %28 = load i16, ptr %arrayidx72, align 2, !tbaa !127
  %or.i318 = or i16 %28, %land.ext.i317
  store i16 %or.i318, ptr %arrayidx72, align 2, !tbaa !127
  br i1 %cmp24.i316, label %if.end28.thread.i321, label %for.cond.i328

if.end28.thread.i321:                             ; preds = %if.end28.i319, %for.body.i301
  br label %for.cond.i328

for.cond.i328:                                    ; preds = %if.end28.thread.i321, %if.end28.i319
  %nextScale.166.i322 = phi i32 [ %conv21.i314, %if.end28.i319 ], [ 0, %if.end28.thread.i321 ]
  %29 = phi i32 [ %conv21.i314, %if.end28.i319 ], [ %lastScale.071.i294, %if.end28.thread.i321 ]
  %conv35.i324 = trunc i32 %29 to i16
  %arrayidx37.i325 = getelementptr inbounds i16, ptr %arrayidx68, i64 %.pre74.i300
  store i16 %conv35.i324, ptr %arrayidx37.i325, align 2, !tbaa !127
  %indvars.iv.next.i326 = add nuw nsw i64 %indvars.iv.i292, 1
  %exitcond.not.i327 = icmp eq i64 %indvars.iv.next.i326, 64
  br i1 %exitcond.not.i327, label %for.inc, label %for.body.i301, !llvm.loop !128

for.inc:                                          ; preds = %for.cond.i328, %for.cond.i, %for.body
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
if.end78:                                         ; preds = %for.inc, %if.end, %if.end33
  ...
  %call79 = tail call i32 @ue_v(ptr noundef nonnull @.str.21, i32 noundef %30, ptr noundef %call) #11
  ...
  %call81 = tail call i32 @ue_v(ptr noundef nonnull @.str.22, i32 noundef %31, ptr noundef %call) #11
...
if.then85:                                        ; preds = %if.end78
  ...
  %call86 = tail call i32 @ue_v(ptr noundef nonnull @.str.23, i32 noundef %33, ptr noundef %call) #11
  br label %if.end112
...
if.then91:                                        ; preds = %if.end78
  ...
  %call92 = tail call i32 @u_1(ptr noundef nonnull @.str.24, i32 noundef %34, ptr noundef %call) #11
  ...
  %call94 = tail call i32 @se_v(ptr noundef nonnull @.str.25, i32 noundef %35, ptr noundef %call) #11
  ...
  %call96 = tail call i32 @se_v(ptr noundef nonnull @.str.26, i32 noundef %36, ptr noundef %call) #11
  ...
  %call98 = tail call i32 @ue_v(ptr noundef nonnull @.str.27, i32 noundef %37, ptr noundef %call) #11
  %38 = load i32, ptr %num_ref_frames_in_pic_order_cnt_cycle, align 4, !tbaa !133
  %cmp102332.not = icmp eq i32 %38, 0
  br i1 %cmp102332.not, label %if.end112, label %for.body103

for.body103:                                      ; preds = %if.then91, %for.body103
  %indvars.iv336 = phi i64 [ %indvars.iv.next337, %for.body103 ], [ 0, %if.then91 ]
  %arrayidx105 = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 20, i64 %indvars.iv336
  %39 = load i32, ptr %arrayidx105, align 4, !tbaa !29
  %call106 = tail call i32 @se_v(ptr noundef nonnull @.str.28, i32 noundef %39, ptr noundef %call) #11
  %indvars.iv.next337 = add nuw nsw i64 %indvars.iv336, 1
  %40 = load i32, ptr %num_ref_frames_in_pic_order_cnt_cycle, align 4, !tbaa !133
  %41 = zext i32 %40 to i64
  %cmp102 = icmp ult i64 %indvars.iv.next337, %41
...
if.end112:                                        ; preds = %for.body103, %if.then91, %if.end78, %if.then85
  ...
  %call113 = tail call i32 @ue_v(ptr noundef nonnull @.str.29, i32 noundef %42, ptr noundef %call) #11
  %gaps_in_frame_num_value_allowed_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 22
  %43 = load i32, ptr %gaps_in_frame_num_value_allowed_flag, align 4, !tbaa !45
  %call115 = tail call i32 @u_1(ptr noundef nonnull @.str.30, i32 noundef %43, ptr noundef %call) #11
  %pic_width_in_mbs_minus1 = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 23
  %44 = load i32, ptr %pic_width_in_mbs_minus1, align 4, !tbaa !51
  %call117 = tail call i32 @ue_v(ptr noundef nonnull @.str.31, i32 noundef %44, ptr noundef %call) #11
  %pic_height_in_map_units_minus1 = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 24
  %45 = load i32, ptr %pic_height_in_map_units_minus1, align 4, !tbaa !54
  %call119 = tail call i32 @ue_v(ptr noundef nonnull @.str.32, i32 noundef %45, ptr noundef %call) #11
  %frame_mbs_only_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 25
  %46 = load i32, ptr %frame_mbs_only_flag, align 4, !tbaa !48
  %call121 = tail call i32 @u_1(ptr noundef nonnull @.str.33, i32 noundef %46, ptr noundef %call) #11
...
if.then125:                                       ; preds = %if.end112
  ...
  %call126 = tail call i32 @u_1(ptr noundef nonnull @.str.34, i32 noundef %48, ptr noundef %call) #11
  br label %if.end128

if.end128:                                        ; preds = %if.then125, %if.end112
  %direct_8x8_inference_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 27
  %49 = load i32, ptr %direct_8x8_inference_flag, align 4, !tbaa !57
  %call129 = tail call i32 @u_1(ptr noundef nonnull @.str.35, i32 noundef %49, ptr noundef %call) #11
  ...
  %call131 = tail call i32 @u_1(ptr noundef nonnull @.str.36, i32 noundef %50, ptr noundef %call) #11
...
if.then135:                                       ; preds = %if.end128
  ...
  %call136 = tail call i32 @ue_v(ptr noundef nonnull @.str.37, i32 noundef %52, ptr noundef %call) #11
  %frame_cropping_rect_right_offset = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 30
  %53 = load i32, ptr %frame_cropping_rect_right_offset, align 4, !tbaa !67
  %call138 = tail call i32 @ue_v(ptr noundef nonnull @.str.38, i32 noundef %53, ptr noundef %call) #11
  %frame_cropping_rect_top_offset = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 31
  %54 = load i32, ptr %frame_cropping_rect_top_offset, align 4, !tbaa !66
  %call140 = tail call i32 @ue_v(ptr noundef nonnull @.str.39, i32 noundef %54, ptr noundef %call) #11
  %frame_cropping_rect_bottom_offset = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 32
  %55 = load i32, ptr %frame_cropping_rect_bottom_offset, align 4, !tbaa !68
  %call142 = tail call i32 @ue_v(ptr noundef nonnull @.str.40, i32 noundef %55, ptr noundef %call) #11
  br label %if.end144

if.end144:                                        ; preds = %if.then135, %if.end128
  %vui_parameters_present_flag = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 33
  %56 = load i32, ptr %vui_parameters_present_flag, align 4, !tbaa !61
  %call145 = tail call i32 @u_1(ptr noundef nonnull @.str.41, i32 noundef %56, ptr noundef %call) #11
...
if.then.i:                                        ; preds = %land.lhs.true.i
  ...
  %call1.i = tail call i32 @u_1(ptr noundef nonnull @.str.77, i32 noundef 0, ptr noundef %call) #11
  %call2.i = tail call i32 @u_1(ptr noundef nonnull @.str.78, i32 noundef 0, ptr noundef %call) #11
  %call4.i = tail call i32 @u_1(ptr noundef nonnull @.str.79, i32 noundef 1, ptr noundef %call) #11
  %call6.i = tail call i32 @u_v(i32 noundef 3, ptr noundef nonnull @.str.80, i32 noundef 2, ptr noundef %call) #11
  %call8.i = tail call i32 @u_1(ptr noundef nonnull @.str.81, i32 noundef 1, ptr noundef %call) #11
  %call10.i = tail call i32 @u_1(ptr noundef nonnull @.str.82, i32 noundef 1, ptr noundef %call) #11
  %call12.i = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.83, i32 noundef 2, ptr noundef %call) #11
  %call14.i = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.84, i32 noundef 2, ptr noundef %call) #11
  %call16.i = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.85, i32 noundef 0, ptr noundef %call) #11
...
if.then31.i:                                      ; preds = %if.else.i
  %call32.i = tail call i32 @u_1(ptr noundef nonnull @.str.77, i32 noundef 0, ptr noundef %call) #11
  %call38.i = tail call i32 @u_1(ptr noundef nonnull @.str.78, i32 noundef 0, ptr noundef %call) #11
  %call40.i = tail call i32 @u_1(ptr noundef nonnull @.str.79, i32 noundef 0, ptr noundef %call) #11
  br label %if.end152.sink.split
...
if.end152.sink.split:                             ; preds = %if.then.i, %if.then31.i
  %call42.i = tail call i32 @u_1(ptr noundef nonnull @.str.86, i32 noundef 0, ptr noundef %call) #11
  %call44.i = tail call i32 @u_1(ptr noundef nonnull @.str.87, i32 noundef 0, ptr noundef %call) #11
  %call55.i = tail call i32 @u_1(ptr noundef nonnull @.str.88, i32 noundef 0, ptr noundef %call) #11
  %call57.i = tail call i32 @u_1(ptr noundef nonnull @.str.89, i32 noundef 0, ptr noundef %call) #11
  %call59.i = tail call i32 @u_1(ptr noundef nonnull @.str.90, i32 noundef 0, ptr noundef %call) #11
  %call61.i = tail call i32 @u_1(ptr noundef nonnull @.str.91, i32 noundef 0, ptr noundef %call) #11
  br label %if.end152

if.end152:                                        ; preds = %if.end152.sink.split, %if.end144
  tail call void @SODBtoRBSP(ptr noundef %call) #11
...
entry:
  ...
  %call3 = call i32 @RBSPtoNALU(ptr noundef nonnull %rbsp, ptr noundef %call, i32 noundef %call1, i32 noundef 8, i32 noundef 3, i32 noundef 0, i32 noundef 1) #11
  store i32 4, ptr %call, align 8, !tbaa !117
  call void @llvm.lifetime.end.p0(i64 64000, ptr nonnull %rbsp) #11
  ret ptr %call
}
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call2 = tail call i32 @ue_v(ptr noundef nonnull @.str.43, i32 noundef %2, ptr noundef %call) #11
  ...
  %call3 = tail call i32 @ue_v(ptr noundef nonnull @.str.44, i32 noundef %3, ptr noundef %call) #11
  %entropy_coding_mode_flag = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 3
  %4 = load i32, ptr %entropy_coding_mode_flag, align 4, !tbaa !73
  %call5 = tail call i32 @u_1(ptr noundef nonnull @.str.45, i32 noundef %4, ptr noundef %call) #11
  %5 = load i32, ptr %pic_order_present_flag1, align 8, !tbaa !76
  %call8 = tail call i32 @u_1(ptr noundef nonnull @.str.46, i32 noundef %5, ptr noundef %call) #11
  ...
  %call10 = tail call i32 @ue_v(ptr noundef nonnull @.str.47, i32 noundef %6, ptr noundef %call) #11
...
if.then14:                                        ; preds = %if.end
  ...
  %call15 = tail call i32 @ue_v(ptr noundef nonnull @.str.48, i32 noundef %8, ptr noundef nonnull %call) #11
...
for.cond27.preheader:                             ; preds = %if.then14
  ...
  %cmp29378.not = icmp eq i32 %10, 0
  br i1 %cmp29378.not, label %if.end91, label %for.body30

for.body:                                         ; preds = %if.then14, %for.body
  %i.0381 = phi i32 [ %inc, %for.body ], [ %9, %if.then14 ]
  %idxprom = zext i32 %i.0381 to i64
  ...
  %call22 = tail call i32 @ue_v(ptr noundef nonnull @.str.49, i32 noundef %11, ptr noundef %call) #11
...
for.body30:                                       ; preds = %for.cond27.preheader, %for.body30
  ...
  %call33 = tail call i32 @ue_v(ptr noundef nonnull @.str.50, i32 noundef %13, ptr noundef %call) #11
  ...
  %call37 = tail call i32 @ue_v(ptr noundef nonnull @.str.51, i32 noundef %14, ptr noundef %call) #11
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
if.then50:                                        ; preds = %if.then14, %if.then14, %if.then14
  ...
  %call51 = tail call i32 @u_1(ptr noundef nonnull @.str.52, i32 noundef %17, ptr noundef nonnull %call) #11
  ...
  %call53 = tail call i32 @ue_v(ptr noundef nonnull @.str.53, i32 noundef %18, ptr noundef nonnull %call) #11
  br label %if.end91
...
if.end73:                                         ; preds = %if.else66, %if.else62, %if.then58
  ...
  %call74 = tail call i32 @ue_v(ptr noundef nonnull @.str.54, i32 noundef %20, ptr noundef nonnull %call) #11
  %slice_group_id = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 16
  br label %for.body79

for.body79:                                       ; preds = %if.end73, %for.body79
  %i.2376 = phi i32 [ 0, %if.end73 ], [ %inc85, %for.body79 ]
  %21 = load ptr, ptr %slice_group_id, align 8, !tbaa !79
  %idxprom80 = zext i32 %i.2376 to i64
  %arrayidx81 = getelementptr inbounds i8, ptr %21, i64 %idxprom80
  %22 = load i8, ptr %arrayidx81, align 1, !tbaa !39
  %conv = zext i8 %22 to i32
  %call82 = tail call i32 @u_v(i32 noundef %NumberBitsPerSliceGroupId.0, ptr noundef nonnull @.str.55, i32 noundef %conv, ptr noundef %call) #11
  %inc85 = add i32 %i.2376, 1
...
if.end91:                                         ; preds = %for.body79, %for.body30, %for.body, %for.cond27.preheader, %if.then14, %if.then50, %if.end
  ...
  %call92 = tail call i32 @ue_v(ptr noundef nonnull @.str.56, i32 noundef %24, ptr noundef %call) #11
  %num_ref_idx_l1_active_minus1 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 18
  %25 = load i32, ptr %num_ref_idx_l1_active_minus1, align 4, !tbaa !104
  %call94 = tail call i32 @ue_v(ptr noundef nonnull @.str.57, i32 noundef %25, ptr noundef %call) #11
  %weighted_pred_flag = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 19
  %26 = load i32, ptr %weighted_pred_flag, align 8, !tbaa !105
  %call96 = tail call i32 @u_1(ptr noundef nonnull @.str.58, i32 noundef %26, ptr noundef %call) #11
  %weighted_bipred_idc = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 20
  %27 = load i32, ptr %weighted_bipred_idc, align 4, !tbaa !106
  %call98 = tail call i32 @u_v(i32 noundef 2, ptr noundef nonnull @.str.59, i32 noundef %27, ptr noundef %call) #11
  %pic_init_qp_minus26 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 21
  %28 = load i32, ptr %pic_init_qp_minus26, align 8, !tbaa !107
  %call100 = tail call i32 @se_v(ptr noundef nonnull @.str.60, i32 noundef %28, ptr noundef %call) #11
  %pic_init_qs_minus26 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 22
  %29 = load i32, ptr %pic_init_qs_minus26, align 4, !tbaa !108
  %call102 = tail call i32 @se_v(ptr noundef nonnull @.str.61, i32 noundef %29, ptr noundef %call) #11
...
if.end122:                                        ; preds = %if.else119, %if.then116
  ...
  %call120 = tail call i32 @se_v(ptr noundef nonnull @.str.62, i32 noundef %.sink, ptr noundef %call) #11
  %deblocking_filter_control_present_flag = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 26
  %32 = load i32, ptr %deblocking_filter_control_present_flag, align 4, !tbaa !111
  %call123 = tail call i32 @u_1(ptr noundef nonnull @.str.63, i32 noundef %32, ptr noundef %call) #11
  %constrained_intra_pred_flag = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 27
  %33 = load i32, ptr %constrained_intra_pred_flag, align 8, !tbaa !113
  %call125 = tail call i32 @u_1(ptr noundef nonnull @.str.64, i32 noundef %33, ptr noundef %call) #11
  %redundant_pic_cnt_present_flag = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 28
  %34 = load i32, ptr %redundant_pic_cnt_present_flag, align 4, !tbaa !115
  %call127 = tail call i32 @u_1(ptr noundef nonnull @.str.65, i32 noundef %34, ptr noundef %call) #11
...
if.then140:                                       ; preds = %if.end122, %if.end122, %if.end122, %if.end122
  ...
  %call141 = tail call i32 @u_1(ptr noundef nonnull @.str.66, i32 noundef %35, ptr noundef %call) #11
  %pic_scaling_matrix_present_flag = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 5
  %36 = load i32, ptr %pic_scaling_matrix_present_flag, align 4, !tbaa !142
  %call143 = tail call i32 @u_1(ptr noundef nonnull @.str.67, i32 noundef %36, ptr noundef %call) #11
...
if.then146:                                       ; preds = %if.then140
  ...
  %shl383.mask = and i32 %38, 2147483647
  %cmp150385.not = icmp eq i32 %shl383.mask, 2147483645
  br i1 %cmp150385.not, label %if.end192, label %for.body152

for.body152:                                      ; preds = %if.then146, %for.inc189
  %indvars.iv391 = phi i64 [ %indvars.iv.next392, %for.inc189 ], [ 0, %if.then146 ]
  %arrayidx154 = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 6, i64 %indvars.iv391
  %39 = load i32, ptr %arrayidx154, align 4, !tbaa !29
  %call155 = tail call i32 @u_1(ptr noundef nonnull @.str.68, i32 noundef %39, ptr noundef %call) #11
...
if.then161:                                       ; preds = %for.body152
  %cmp162 = icmp ult i64 %indvars.iv391, 6
  br i1 %cmp162, label %if.then164, label %if.else174

if.then164:                                       ; preds = %if.then161
  %arrayidx166 = getelementptr inbounds [6 x [16 x i16]], ptr @ScalingList4x4input, i64 0, i64 %indvars.iv391
  %arrayidx168 = getelementptr inbounds [6 x [16 x i16]], ptr @ScalingList4x4, i64 0, i64 %indvars.iv391
  %arrayidx171 = getelementptr inbounds [6 x i16], ptr @UseDefaultScalingMatrix4x4Flag, i64 0, i64 %indvars.iv391
  br label %for.body.i

for.body.i:                                       ; preds = %for.cond.i, %if.then164
  %indvars.iv.i = phi i64 [ 0, %if.then164 ], [ %indvars.iv.next.i, %for.cond.i ]
  %nextScale.072.i = phi i32 [ 8, %if.then164 ], [ %nextScale.166.i, %for.cond.i ]
  %lastScale.071.i = phi i32 [ 8, %if.then164 ], [ %45, %for.cond.i ]
  %arrayidx.i = getelementptr inbounds [16 x i8], ptr @ZZ_SCAN, i64 0, i64 %indvars.iv.i
  %cond.in.i = load i8, ptr %arrayidx.i, align 1, !tbaa !39
  %cmp5.not.i = icmp eq i32 %nextScale.072.i, 0
  %.pre74.i = zext i8 %cond.in.i to i64
...
if.end28.i:                                       ; preds = %for.body.i
  %arrayidx8.i = getelementptr inbounds i16, ptr %arrayidx166, i64 %.pre74.i
  %41 = load i16, ptr %arrayidx8.i, align 2, !tbaa !127
  %conv9.i = sext i16 %41 to i32
  %sub.i = sub nsw i32 %conv9.i, %lastScale.071.i
  %cmp10.i = icmp sgt i32 %sub.i, 127
  %sub13.i = add nsw i32 %sub.i, -256
  %cmp14.i = icmp slt i32 %sub.i, -128
  ...
  %delta_scale.0.i = select i1 %cmp10.i, i32 %sub13.i, i32 %spec.select.i
  %call.i = tail call i32 @se_v(ptr noundef nonnull @.str.4, i32 noundef %delta_scale.0.i, ptr noundef %call) #11
  %42 = load i16, ptr %arrayidx8.i, align 2, !tbaa !127
  %.fr.i = freeze i16 %42
  %conv21.i = sext i16 %.fr.i to i32
  %cmp22.i = icmp eq i64 %indvars.iv.i, 0
  %cmp24.i = icmp eq i16 %.fr.i, 0
  %43 = and i1 %cmp22.i, %cmp24.i
  %land.ext.i = zext i1 %43 to i16
  %44 = load i16, ptr %arrayidx171, align 2, !tbaa !127
  %or.i = or i16 %44, %land.ext.i
  store i16 %or.i, ptr %arrayidx171, align 2, !tbaa !127
  br i1 %cmp24.i, label %if.end28.thread.i, label %for.cond.i
...
for.cond.i:                                       ; preds = %if.end28.thread.i, %if.end28.i
  %nextScale.166.i = phi i32 [ %conv21.i, %if.end28.i ], [ 0, %if.end28.thread.i ]
  %45 = phi i32 [ %conv21.i, %if.end28.i ], [ %lastScale.071.i, %if.end28.thread.i ]
  %conv35.i = trunc i32 %45 to i16
  %arrayidx37.i = getelementptr inbounds i16, ptr %arrayidx168, i64 %.pre74.i
  store i16 %conv35.i, ptr %arrayidx37.i, align 2, !tbaa !127
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 16
...
if.else174:                                       ; preds = %if.then161
  %46 = add nsw i64 %indvars.iv391, -6
...
for.body.i345:                                    ; preds = %for.cond.i372, %if.else174
  %indvars.iv.i336 = phi i64 [ 0, %if.else174 ], [ %indvars.iv.next.i370, %for.cond.i372 ]
  %nextScale.072.i337 = phi i32 [ 8, %if.else174 ], [ %nextScale.166.i366, %for.cond.i372 ]
  %lastScale.071.i338 = phi i32 [ 8, %if.else174 ], [ %51, %for.cond.i372 ]
  %arrayidx3.i341 = getelementptr inbounds [64 x i8], ptr @ZZ_SCAN8, i64 0, i64 %indvars.iv.i336
  %cond.in.i342 = load i8, ptr %arrayidx3.i341, align 1, !tbaa !39
  %cmp5.not.i343 = icmp eq i32 %nextScale.072.i337, 0
  %.pre74.i344 = zext i8 %cond.in.i342 to i64
  br i1 %cmp5.not.i343, label %if.end28.thread.i365, label %if.end28.i363

if.end28.i363:                                    ; preds = %for.body.i345
  %arrayidx8.i346 = getelementptr inbounds i16, ptr %arrayidx176, i64 %.pre74.i344
  %47 = load i16, ptr %arrayidx8.i346, align 2, !tbaa !127
  %conv9.i347 = sext i16 %47 to i32
  %sub.i348 = sub nsw i32 %conv9.i347, %lastScale.071.i338
  %cmp10.i349 = icmp sgt i32 %sub.i348, 127
  %sub13.i350 = add nsw i32 %sub.i348, -256
  %cmp14.i351 = icmp slt i32 %sub.i348, -128
  %add.i352 = add nsw i32 %sub.i348, 256
  %spec.select.i353 = select i1 %cmp14.i351, i32 %add.i352, i32 %sub.i348
  %delta_scale.0.i354 = select i1 %cmp10.i349, i32 %sub13.i350, i32 %spec.select.i353
  %call.i355 = tail call i32 @se_v(ptr noundef nonnull @.str.4, i32 noundef %delta_scale.0.i354, ptr noundef %call) #11
  %48 = load i16, ptr %arrayidx8.i346, align 2, !tbaa !127
  %.fr.i357 = freeze i16 %48
  %conv21.i358 = sext i16 %.fr.i357 to i32
  %cmp22.i359 = icmp eq i64 %indvars.iv.i336, 0
  %cmp24.i360 = icmp eq i16 %.fr.i357, 0
  %49 = and i1 %cmp22.i359, %cmp24.i360
  %land.ext.i361 = zext i1 %49 to i16
  %50 = load i16, ptr %arrayidx184, align 2, !tbaa !127
  %or.i362 = or i16 %50, %land.ext.i361
  store i16 %or.i362, ptr %arrayidx184, align 2, !tbaa !127
  br i1 %cmp24.i360, label %if.end28.thread.i365, label %for.cond.i372

if.end28.thread.i365:                             ; preds = %if.end28.i363, %for.body.i345
  br label %for.cond.i372

for.cond.i372:                                    ; preds = %if.end28.thread.i365, %if.end28.i363
  %nextScale.166.i366 = phi i32 [ %conv21.i358, %if.end28.i363 ], [ 0, %if.end28.thread.i365 ]
  %51 = phi i32 [ %conv21.i358, %if.end28.i363 ], [ %lastScale.071.i338, %if.end28.thread.i365 ]
  %conv35.i368 = trunc i32 %51 to i16
  %arrayidx37.i369 = getelementptr inbounds i16, ptr %arrayidx180, i64 %.pre74.i344
  store i16 %conv35.i368, ptr %arrayidx37.i369, align 2, !tbaa !127
  %indvars.iv.next.i370 = add nuw nsw i64 %indvars.iv.i336, 1
  %exitcond.not.i371 = icmp eq i64 %indvars.iv.next.i370, 64
  br i1 %exitcond.not.i371, label %for.inc189, label %for.body.i345, !llvm.loop !128

for.inc189:                                       ; preds = %for.cond.i372, %for.cond.i, %for.body152
  %indvars.iv.next392 = add nuw nsw i64 %indvars.iv391, 1
  %52 = load i32, ptr %transform_8x8_mode_flag, align 8, !tbaa !74
  %shl = shl i32 %52, 1
  %add149 = add i32 %shl, 6
  %53 = zext i32 %add149 to i64
  %cmp150 = icmp ult i64 %indvars.iv.next392, %53
...
if.end192:                                        ; preds = %for.inc189, %if.then146, %if.then140
  ...
  %call193 = tail call i32 @se_v(ptr noundef nonnull @.str.69, i32 noundef %54, ptr noundef %call) #11
  br label %if.end195
...
for.body:                                         ; preds = %for.body.lr.ph, %for.cond
  ...
  %nextScale.072 = phi i32 [ 8, %for.body.lr.ph ], [ %nextScale.166, %for.cond ]
  %lastScale.071 = phi i32 [ 8, %for.body.lr.ph ], [ %4, %for.cond ]
  %len.070 = phi i32 [ 0, %for.body.lr.ph ], [ %len.164, %for.cond ]
  ...
  %cond.in = load i8, ptr %cond.in.in, align 1, !tbaa !39
  %cmp5.not = icmp eq i32 %nextScale.072, 0
  %.pre74 = zext i8 %cond.in to i64
  br i1 %cmp5.not, label %if.end28.thread, label %if.end28

if.end28:                                         ; preds = %for.body
  %arrayidx8 = getelementptr inbounds i16, ptr %scalingListinput, i64 %.pre74
  %0 = load i16, ptr %arrayidx8, align 2, !tbaa !127
  ...
  %call = tail call i32 @se_v(ptr noundef nonnull @.str.4, i32 noundef %delta_scale.0, ptr noundef %bitstream) #11
  %add18 = add nsw i32 %call, %len.070
  %1 = load i16, ptr %arrayidx8, align 2, !tbaa !127
  %.fr = freeze i16 %1
  %conv21 = sext i16 %.fr to i32
  %cmp22 = icmp eq i8 %cond.in, 0
  %cmp24 = icmp eq i16 %.fr, 0
  %2 = and i1 %cmp22, %cmp24
  %land.ext = zext i1 %2 to i16
  %3 = load i16, ptr %UseDefaultScalingMatrix, align 2, !tbaa !127
  %or = or i16 %3, %land.ext
...
for.cond:                                         ; preds = %if.end28, %if.end28.thread
  ...
  %4 = phi i32 [ %conv21, %if.end28 ], [ %lastScale.071, %if.end28.thread ]
  %conv35 = trunc i32 %4 to i16
  %arrayidx37 = getelementptr inbounds i16, ptr %scalingList, i64 %.pre74
...
for.end:                                          ; preds = %for.cond, %entry
  %len.0.lcssa = phi i32 [ 0, %entry ], [ %len.164, %for.cond ]
  ret i32 %len.0.lcssa
}
...
entry:
  ...
  %call3 = call i32 @RBSPtoNALU(ptr noundef nonnull %rbsp, ptr noundef %call, i32 noundef %call1, i32 noundef 6, i32 noundef 0, i32 noundef 0, i32 noundef 1) #11
  store i32 4, ptr %call, align 8, !tbaa !117
  call void @llvm.lifetime.end.p0(i64 64000, ptr nonnull %rbsp) #11
  ret ptr %call
}
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %bits_to_go = getelementptr inbounds %struct.Bitstream, ptr %call, i64 0, i32 1
  store i32 8, ptr %bits_to_go, align 4, !tbaa !121
  call void @llvm.lifetime.start.p0(i64 500, ptr nonnull %sei_message) #11
  %0 = load ptr, ptr @input, align 8, !tbaa !5
  %SEIMessageText = getelementptr inbounds %struct.InputParameters, ptr %0, i64 0, i32 36
  %call1 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %SEIMessageText) #14
  %conv = trunc i64 %call1 to i32
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %tstruct) #11
  %call2 = call i32 @ftime(ptr noundef nonnull %tstruct) #11
  %cmp3 = icmp eq i32 %conv, 0
  br i1 %cmp3, label %if.end14.thread, label %if.end14

if.end14.thread:                                  ; preds = %if.end
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(13) %sei_message, ptr noundef nonnull align 1 dereferenceable(14) @.str.70, i64 noundef 13, i1 false) #11
  %call15110 = call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.71, i32 noundef 5, ptr noundef nonnull %call) #11
  br label %while.end
...
if.end14:                                         ; preds = %if.end
  ...
  %call13 = call ptr @strncpy(ptr noundef nonnull %sei_message, ptr noundef nonnull %SEIMessageText10, i64 noundef %conv12) #11
  %2 = add i32 %conv, 17
  %call15 = call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.71, i32 noundef 5, ptr noundef nonnull %call) #11
...
while.body:                                       ; preds = %if.end14, %while.body
  ...
  %call19 = call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.72, i32 noundef 255, ptr noundef %call) #11
...
while.end:                                        ; preds = %while.body, %if.end14.thread, %if.end14
  ...
  %call21 = call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.73, i32 noundef %message_size.1.lcssa, ptr noundef %call) #11
  ...
  %call24 = call i32 @u_v(i32 noundef 32, ptr noundef nonnull @.str.74, i32 noundef %conv23, ptr noundef %call) #11
  ...
  %call29 = call i32 @u_v(i32 noundef 32, ptr noundef nonnull @.str.74, i32 noundef %add28, ptr noundef %call) #11
  %call44 = call i32 @u_v(i32 noundef 32, ptr noundef nonnull @.str.74, i32 noundef 1382116964, ptr noundef %call) #11
  %call61 = call i32 @u_v(i32 noundef 32, ptr noundef nonnull @.str.74, i32 noundef 1869434195, ptr noundef %call) #11
...
for.body:                                         ; preds = %while.end, %for.body
  ...
  %call70 = call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.75, i32 noundef %conv69, ptr noundef %call) #11
  %inc = add nuw nsw i64 %conv63108, 1
  %conv63 = and i64 %inc, 4294967295
  %call65 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %sei_message) #14
  %cmp66 = icmp ugt i64 %call65, %conv63
  br i1 %cmp66, label %for.body, label %for.end, !llvm.loop !151

for.end:                                          ; preds = %for.body, %while.end
  %call72 = call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.75, i32 noundef 0, ptr noundef %call) #11
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %tstruct) #11
  call void @llvm.lifetime.end.p0(i64 500, ptr nonnull %sei_message) #11
  call void @SODBtoRBSP(ptr noundef %call) #11
