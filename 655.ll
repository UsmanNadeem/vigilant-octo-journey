; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/sort.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/sort.c"
...
while.body.i:                                     ; preds = %entry, %while.body.i
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i ], [ %Sort, %entry ]
...
for.body:                                         ; preds = %entry, %for.inc
  ...
  %cmp.i9.not = icmp eq i32 %call1.val, %Symbol
  br i1 %cmp.i9.not, label %return, label %for.inc
...
for.body6:                                        ; preds = %for.body6.lr.ph, %for.inc
  ...
  %cmp.i26.not = icmp eq ptr %Scan1.0.val23, %Scan2.0.val22
  br i1 %cmp.i26.not, label %cleanup, label %for.inc
...
for.body9:                                        ; preds = %for.body9.lr.ph, %for.inc15
  ...
  %cmp.i34.not = icmp eq i32 %call10.val, %Theory.val29
  br i1 %cmp.i34.not, label %for.inc15, label %cleanup
...
while.body.i.i:                                   ; preds = %entry, %while.body.i.i
  %Current.06.i.i = phi ptr [ %Current.0.val.i.i, %while.body.i.i ], [ %Pair.val, %entry ]
...
while.body.i.i12:                                 ; preds = %if.then.i, %while.body.i.i12
  %Current.06.i.i6 = phi ptr [ %Current.0.val.i.i7, %while.body.i.i12 ], [ %C.val11.i, %if.then.i ]
  %Current.0.val.i.i7 = load ptr, ptr %Current.06.i.i6, align 8
  ...
  %cmp.i.not.i.i11 = icmp eq ptr %Current.0.val.i.i7, null
...
while.body.i:                                     ; preds = %if.then, %while.body.i
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i ], [ %C.val11, %if.then ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  %4 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
...
entry:
  ...
  %call.i.i = tail call i32 @_IO_putc(i32 noundef 40, ptr noundef %1)
...
if.then.i:                                        ; preds = %while.body.i.preheader, %if.then.i
  ...
  %call.i15.i = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %4)
...
sort_Print.exit:                                  ; preds = %if.then.i, %while.body.i.preheader, %entry
  ...
  %call.i16.i = tail call i32 @_IO_putc(i32 noundef 41, ptr noundef %7)
...
for.body.i:                                       ; preds = %sort_Print.exit, %for.body.i
  ...
  %call.i.i6 = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %11)
...
for.body11.i:                                     ; preds = %for.end.i, %for.body11.i
  ...
  %call.i65.i = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %14)
...
for.body22.i:                                     ; preds = %for.end16.i, %for.body22.i
  ...
  %call.i68.i = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %17)
...
sort_ConditionPrint.exit:                         ; preds = %for.body33.i, %for.end27.i
  ...
  %call.i = tail call i32 @_IO_putc(i32 noundef 93, ptr noundef %21)
  ret void
}
...
entry:
  ...
  %call.i = tail call i32 @_IO_putc(i32 noundef 40, ptr noundef %0)
...
if.then:                                          ; preds = %while.body.preheader, %if.then
  ...
  %call.i15 = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %3)
...
while.end:                                        ; preds = %if.then, %while.body.preheader, %entry
  ...
  %call.i16 = tail call i32 @_IO_putc(i32 noundef 41, ptr noundef %6)
  ret void
}
...
for.body:                                         ; preds = %entry, %for.inc
  ...
  %cmp.i15.not = icmp eq ptr %call3.val, null
  br i1 %cmp.i15.not, label %land.lhs.true, label %for.inc
...
for.body.i:                                       ; preds = %for.body, %for.inc.i
  ...
  %cmp.i109.not.i = icmp eq ptr %Scan.0.val96.i, null
  br i1 %cmp.i109.not.i, label %for.end.i, label %for.inc.i

for.inc.i:                                        ; preds = %for.body.i
  %15 = load ptr, ptr @stdout, align 8
  %call.i.i = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %15)
...
for.body19.i:                                     ; preds = %for.end.i, %for.inc27.i
  ...
  %cmp.i113.not.i = icmp eq ptr %Scan.1.val95.i, null
  br i1 %cmp.i113.not.i, label %for.end29.i, label %for.inc27.i

for.inc27.i:                                      ; preds = %for.body19.i
  %24 = load ptr, ptr @stdout, align 8
  %call.i115.i = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %24)
...
for.body36.i:                                     ; preds = %for.end29.i, %for.inc44.i
  ...
  %cmp.i118.not.i = icmp eq ptr %Scan.2.val94.i, null
  br i1 %cmp.i118.not.i, label %for.end46.i, label %for.inc44.i

for.inc44.i:                                      ; preds = %for.body36.i
  %29 = load ptr, ptr @stdout, align 8
  %call.i120.i = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %29)
...
for.body53.i:                                     ; preds = %for.end46.i, %for.inc61.i
  ...
  %cmp.i123.not.i = icmp eq ptr %Scan.3.val93.i, null
  br i1 %cmp.i123.not.i, label %sort_LinkPrint.exit, label %for.inc61.i

for.inc61.i:                                      ; preds = %for.body53.i
  %34 = load ptr, ptr @stdout, align 8
  %call.i125.i = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %34)
...
while.body.i.i:                                   ; preds = %for.end.i, %while.body.i.i
  %Current.06.i.i = phi ptr [ %Current.0.val.i.i, %while.body.i.i ], [ %S.val.pre.i, %for.end.i ]
  %Current.0.val.i.i = load ptr, ptr %Current.06.i.i, align 8
...
while.body.i:                                     ; preds = %sort_LinkDelete.exit, %while.body.i
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i ], [ %Scan.0.val72, %sort_LinkDelete.exit ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  ...
  %cmp.i.not.i79 = icmp eq ptr %Current.0.val.i, null
...
while.body.i87:                                   ; preds = %for.end, %while.body.i87
  %Current.06.i81 = phi ptr [ %Current.0.val.i82, %while.body.i87 ], [ %.pre, %for.end ]
  %Current.0.val.i82 = load ptr, ptr %Current.06.i81, align 8
  ...
  %cmp.i.not.i86 = icmp eq ptr %Current.0.val.i82, null
...
while.body.i98:                                   ; preds = %for.body10, %while.body.i98
  %Current.06.i92 = phi ptr [ %Current.0.val.i93, %while.body.i98 ], [ %call14.val, %for.body10 ]
  %Current.0.val.i93 = load ptr, ptr %Current.06.i92, align 8
  ...
  %cmp.i.not.i97 = icmp eq ptr %Current.0.val.i93, null
...
while.body.i107:                                  ; preds = %list_Delete.exit99, %while.body.i107
  %Current.06.i101 = phi ptr [ %Current.0.val.i102, %while.body.i107 ], [ %call12.val, %list_Delete.exit99 ]
  %Current.0.val.i102 = load ptr, ptr %Current.06.i101, align 8
  ...
  %cmp.i.not.i106 = icmp eq ptr %Current.0.val.i102, null
...
while.body.i117:                                  ; preds = %list_Delete.exit108, %while.body.i117
  %Current.06.i111 = phi ptr [ %Current.0.val.i112, %while.body.i117 ], [ %Scan.1.val71, %list_Delete.exit108 ]
  %Current.0.val.i112 = load ptr, ptr %Current.06.i111, align 8
  ...
  %cmp.i.not.i116 = icmp eq ptr %Current.0.val.i112, null
...
while.body.i126:                                  ; preds = %for.end27, %while.body.i126
  %Current.06.i120 = phi ptr [ %Current.0.val.i121, %while.body.i126 ], [ %.pre149, %for.end27 ]
  %Current.0.val.i121 = load ptr, ptr %Current.06.i120, align 8
  ...
  %cmp.i.not.i125 = icmp eq ptr %Current.0.val.i121, null
...
while.body.i.i135:                                ; preds = %if.then34, %while.body.i.i135
  %Current.06.i.i129 = phi ptr [ %Current.0.val.i.i130, %while.body.i.i135 ], [ %61, %if.then34 ]
  %Current.0.val.i.i130 = load ptr, ptr %Current.06.i.i129, align 8
  ...
  %cmp.i.not.i.i134 = icmp eq ptr %Current.0.val.i.i130, null
...
for.end39:                                        ; preds = %for.inc38, %list_Delete.exit127
  ...
  %RealSize.1.i.i.i = select i1 %tobool3.not.i.i.i, i32 32032, i32 %sub6.i.i.i.op
...
entry:
  ...
  %cmp.i.i = icmp slt i32 %call1.val, 1
...
if.then:                                          ; preds = %entry
  ...
  %Clause.val117176.i = load i32, ptr %7, align 8
  %cmp.not.not177.i = icmp sgt i32 %Clause.val117176.i, 0
  br i1 %cmp.not.not177.i, label %for.body.lr.ph.i, label %for.cond23.preheader.i
...
for.cond23.preheader.i:                           ; preds = %for.inc.i, %if.then
  ...
  %Clause.val127183.i = phi i32 [ %Clause.val117176.i, %if.then ], [ %Clause.val117.i, %for.inc.i ]
  %10 = getelementptr i8, ptr %Clause, i64 68
  %Clause.val128184.i = load i32, ptr %10, align 4
  %add.i.i185.i = add i32 %Clause.val128184.i, %Clause.val127183.i
  %sub.i144186.i = add i32 %add.i.i185.i, -1
  %cmp25.not187.i = icmp sgt i32 %Clause.val127183.i, %sub.i144186.i
  br i1 %cmp25.not187.i, label %for.end32.i, label %for.body26.lr.ph.i

for.body26.lr.ph.i:                               ; preds = %for.cond23.preheader.i
  %11 = getelementptr i8, ptr %Clause, i64 56
  %12 = sext i32 %Clause.val127183.i to i64
  br label %for.body26.i

for.body.i:                                       ; preds = %for.inc.i, %for.body.lr.ph.i
  %indvars.iv.i = phi i64 [ 0, %for.body.lr.ph.i ], [ %indvars.iv.next.i, %for.inc.i ]
  %Constraint.0180.i = phi ptr [ null, %for.body.lr.ph.i ], [ %Constraint.1.i, %for.inc.i ]
  %Input.0179.i = phi ptr [ null, %for.body.lr.ph.i ], [ %Input.1.i, %for.inc.i ]
  ...
  %cmp.i.not.i.i.i = icmp eq i32 %15, %L.val7.val.i.i.i
  ...
  br i1 %cmp.i.not.i.i.i, label %clause_GetLiteralAtom.exit.i, label %clause_GetLiteralAtom.exit.thread.i
...
clause_GetLiteralAtom.exit.i:                     ; preds = %for.body.i
  ...
  %cmp.i.not.i = icmp eq i32 %call4.val.i, %call12.val.i
  br i1 %cmp.i.not.i, label %if.then.i.i136.i, label %if.else.i

clause_GetLiteralAtom.exit.thread.i:              ; preds = %for.body.i
  %call12.val171.i = load i32, ptr %call1.val.val.i.i.i, align 8
  %cmp.i172.not.i = icmp eq i32 %call4.val.i, %call12.val171.i
  br i1 %cmp.i172.not.i, label %clause_GetLiteralAtom.exit138.i, label %if.else.i
...
clause_GetLiteralAtom.exit138.i:                  ; preds = %if.then.i.i136.i, %clause_GetLiteralAtom.exit.thread.i
  ...
  store ptr %Input.0179.i, ptr %call.i.i, align 8
  br label %for.inc.i
...
if.else.i:                                        ; preds = %clause_GetLiteralAtom.exit.thread.i, %clause_GetLiteralAtom.exit.i
  ...
  store ptr %Constraint.0180.i, ptr %call.i142.i, align 8
  br label %for.inc.i

for.inc.i:                                        ; preds = %if.else.i, %clause_GetLiteralAtom.exit138.i
  %Input.1.i = phi ptr [ %call.i.i, %clause_GetLiteralAtom.exit138.i ], [ %Input.0179.i, %if.else.i ]
  %Constraint.1.i = phi ptr [ %Constraint.0180.i, %clause_GetLiteralAtom.exit138.i ], [ %call.i142.i, %if.else.i ]
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
...
for.body26.i:                                     ; preds = %for.body26.i, %for.body26.lr.ph.i
  %indvars.iv209.i = phi i64 [ %12, %for.body26.lr.ph.i ], [ %indvars.iv.next210.i, %for.body26.i ]
  %Antecedent.0189.i = phi ptr [ null, %for.body26.lr.ph.i ], [ %call.i148.i, %for.body26.i ]
  %Clause.val122.i = load ptr, ptr %11, align 8
  %arrayidx.i.i146.i = getelementptr inbounds ptr, ptr %Clause.val122.i, i64 %indvars.iv209.i
  ...
  store ptr %Antecedent.0189.i, ptr %call.i148.i, align 8
  ...
  %cmp25.not.not.i = icmp slt i64 %indvars.iv209.i, %24
...
for.end32.i:                                      ; preds = %for.body26.i, %for.cond23.preheader.i
  %add.i.pre-phi.i = phi i32 [ %add.i.i185.i, %for.cond23.preheader.i ], [ %add.i.i.i, %for.body26.i ]
  %Antecedent.0.lcssa.i = phi ptr [ null, %for.cond23.preheader.i ], [ %call.i148.i, %for.body26.i ]
  %Clause.val.i.i193.i = phi i32 [ %Clause.val127183.i, %for.cond23.preheader.i ], [ %Clause.val127.i, %for.body26.i ]
  %Clause.val6.i.i194.i = phi i32 [ %Clause.val128184.i, %for.cond23.preheader.i ], [ %Clause.val128.i, %for.body26.i ]
  %25 = getelementptr i8, ptr %Clause, i64 72
  %Clause.val7.i.i195.i = load i32, ptr %25, align 8
  %add.i.i150196.i = add i32 %Clause.val.i.i193.i, -1
  %add3.i.i197.i = add i32 %add.i.i150196.i, %Clause.val6.i.i194.i
  %sub.i151198.i = add i32 %add3.i.i197.i, %Clause.val7.i.i195.i
  %cmp36.not199.i = icmp sgt i32 %add.i.pre-phi.i, %sub.i151198.i
  br i1 %cmp36.not199.i, label %for.end47.i, label %for.body37.lr.ph.i

for.body37.lr.ph.i:                               ; preds = %for.end32.i
  %26 = getelementptr i8, ptr %Clause, i64 56
  %27 = sext i32 %Clause.val.i.i193.i to i64
  %28 = sext i32 %Clause.val6.i.i194.i to i64
  %29 = add nsw i64 %28, %27
  br label %for.body37.i

for.body37.i:                                     ; preds = %for.inc45.i, %for.body37.lr.ph.i
  %Clause.val7.i.i220.i = phi i32 [ %Clause.val7.i.i195.i, %for.body37.lr.ph.i ], [ %Clause.val7.i.i.i, %for.inc45.i ]
  %Clause.val6.i.i218.i = phi i32 [ %Clause.val6.i.i194.i, %for.body37.lr.ph.i ], [ %Clause.val6.i.i.i, %for.inc45.i ]
  %Clause.val.i.i216.i = phi i32 [ %Clause.val.i.i193.i, %for.body37.lr.ph.i ], [ %Clause.val.i.i.i, %for.inc45.i ]
  %indvars.iv212.i = phi i64 [ %29, %for.body37.lr.ph.i ], [ %indvars.iv.next213.i, %for.inc45.i ]
  %Succedent.0201.i = phi ptr [ null, %for.body37.lr.ph.i ], [ %Succedent.1.i, %for.inc45.i ]
  %Clause.val118.i = load ptr, ptr %26, align 8
  %arrayidx.i153.i = getelementptr inbounds ptr, ptr %Clause.val118.i, i64 %indvars.iv212.i
...
if.then40.i:                                      ; preds = %for.body37.i
  ...
  store ptr %Succedent.0201.i, ptr %call.i157.i, align 8
...
for.inc45.i:                                      ; preds = %if.then40.i, %for.body37.i
  %Clause.val7.i.i.i = phi i32 [ %Clause.val7.i.i.pre.i, %if.then40.i ], [ %Clause.val7.i.i220.i, %for.body37.i ]
  %Clause.val6.i.i.i = phi i32 [ %Clause.val6.i.i.pre.i, %if.then40.i ], [ %Clause.val6.i.i218.i, %for.body37.i ]
  %Clause.val.i.i.i = phi i32 [ %Clause.val.i.i.pre.i, %if.then40.i ], [ %Clause.val.i.i216.i, %for.body37.i ]
  %Succedent.1.i = phi ptr [ %call.i157.i, %if.then40.i ], [ %Succedent.0201.i, %for.body37.i ]
  ...
  %cmp36.not.not.i = icmp slt i64 %indvars.iv212.i, %32
...
for.end47.i:                                      ; preds = %for.inc45.i, %for.end32.i
  ...
  %cmp.i164.not203.i = icmp eq ptr %Input.0.lcssa.i, null
  br i1 %cmp.i164.not203.i, label %sort_TheoryLinkCreate.exit, label %while.body.i

while.body.i:                                     ; preds = %for.end47.i, %while.body.i
  %Input.2204.i = phi ptr [ %Input.2.val.i, %while.body.i ], [ %Input.0.lcssa.i, %for.end47.i ]
  %35 = getelementptr i8, ptr %Input.2204.i, i64 8
  ...
  %Input.2.val.i = load ptr, ptr %Input.2204.i, align 8
...
sort_TheoryLinkCreate.exit:                       ; preds = %while.body.i, %for.end47.i
  ...
  %call.i.i42 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i43 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i42, i64 0, i32 1
  store ptr %call.i, ptr %car.i.i43, align 8
  store ptr null, ptr %call.i.i42, align 8
  %call.i44 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i44, i64 0, i32 1
  store ptr %call4, ptr %car.i, align 8
  store ptr %call.i.i42, ptr %call.i44, align 8
  %call.i45 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i46 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i45, i64 0, i32 1
  store ptr %Origin, ptr %car.i46, align 8
  store ptr %call.i44, ptr %call.i45, align 8
  %suborigcls = getelementptr inbounds %struct.SORTTHEORY_HELP, ptr %Theory, i64 0, i32 2
  %36 = load ptr, ptr %suborigcls, align 8
  %call.i47 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i48 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i47, i64 0, i32 1
  store ptr %call.i45, ptr %car.i48, align 8
  store ptr %36, ptr %call.i47, align 8
  store ptr %call.i47, ptr %suborigcls, align 8
...
if.end:                                           ; preds = %sort_TheoryLinkCreate.exit, %entry
  ...
  %call.i.i49 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i50 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i49, i64 0, i32 1
  store ptr %L, ptr %car.i.i50, align 8
  store ptr null, ptr %call.i.i49, align 8
  %super.i = getelementptr inbounds %struct.term, ptr %L.val, i64 0, i32 1
  store ptr %call.i.i49, ptr %super.i, align 8
  %call.i.i51 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i52 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i51, i64 0, i32 1
  store ptr %L.val, ptr %car.i.i52, align 8
  store ptr null, ptr %call.i.i51, align 8
  %super.i53 = getelementptr inbounds %struct.term, ptr %call.val.val, i64 0, i32 1
  store ptr %call.i.i51, ptr %super.i53, align 8
  ...
  %call.i.i54 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i55 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i54, i64 0, i32 1
  store ptr %call.val.val, ptr %car.i.i55, align 8
  store ptr null, ptr %call.i.i54, align 8
  %call.i56 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i57 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i56, i64 0, i32 1
  store ptr %Clause, ptr %car.i57, align 8
  store ptr %call.i.i54, ptr %call.i56, align 8
  %call.i58 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i59 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i58, i64 0, i32 1
  store ptr %Origin, ptr %car.i59, align 8
  store ptr %call.i56, ptr %call.i58, align 8
  %termorigcls = getelementptr inbounds %struct.SORTTHEORY_HELP, ptr %Theory, i64 0, i32 3
  %41 = load ptr, ptr %termorigcls, align 8
  %call.i60 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i61 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i60, i64 0, i32 1
  store ptr %call.i58, ptr %car.i61, align 8
  store ptr %41, ptr %call.i60, align 8
  store ptr %call.i60, ptr %termorigcls, align 8
  ret void
}
...
while.body.i:                                     ; preds = %sort_LinkDelete.exit, %while.body.i
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i ], [ %Scan.0.val68, %sort_LinkDelete.exit ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  ...
  %cmp.i.not.i77 = icmp eq ptr %Current.0.val.i, null
...
while.body.i88:                                   ; preds = %if.then17, %while.body.i88
  %Current.06.i82 = phi ptr [ %Current.0.val.i83, %while.body.i88 ], [ %call20.val, %if.then17 ]
  %Current.0.val.i83 = load ptr, ptr %Current.06.i82, align 8
  ...
  %cmp.i.not.i87 = icmp eq ptr %Current.0.val.i83, null
...
while.body.i97:                                   ; preds = %list_Delete.exit89, %while.body.i97
  %Current.06.i91 = phi ptr [ %Current.0.val.i92, %while.body.i97 ], [ %call18.val, %list_Delete.exit89 ]
  %Current.0.val.i92 = load ptr, ptr %Current.06.i91, align 8
  ...
  %cmp.i.not.i96 = icmp eq ptr %Current.0.val.i92, null
...
while.body.i107:                                  ; preds = %list_Delete.exit98, %while.body.i107
  %Current.06.i101 = phi ptr [ %Current.0.val.i102, %while.body.i107 ], [ %Scan.1.val67, %list_Delete.exit98 ]
  %Current.0.val.i102 = load ptr, ptr %Current.06.i101, align 8
  %45 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
...
for.end91:                                        ; preds = %for.body87, %for.end81
  ...
  %cmp.i.not.i = icmp eq ptr %Cond.val, null
  %brmerge = or i1 %cmp.i.not.i, %cmp.i.not224
  %call.i.mux = select i1 %cmp.i.not.i, ptr %call.i, ptr %Cond.val
...
list_Nconc.exit:                                  ; preds = %for.end91, %for.end.i
  ...
  %cmp.i.not.i203 = icmp eq ptr %Cond.val174, null
  %brmerge245 = or i1 %cmp.i.not.i203, %cmp.i187.not226
  %call.i185.mux = select i1 %cmp.i.not.i203, ptr %call.i185, ptr %Cond.val174
...
list_Nconc.exit212:                               ; preds = %list_Nconc.exit, %for.end.i210
  ...
  %cmp.i.not.i213 = icmp eq ptr %Cond.val176, null
  %brmerge246 = or i1 %cmp.i.not.i213, %cmp.i189.not228
  %call.i186.mux = select i1 %cmp.i.not.i213, ptr %call.i186, ptr %Cond.val176
...
for.end91:                                        ; preds = %for.body87, %for.end81
  ...
  %cmp.i.not.i = icmp eq ptr %Cond.val, null
  %brmerge = or i1 %cmp.i.not.i, %cmp.i.not234
  %call.i.mux = select i1 %cmp.i.not.i, ptr %call.i, ptr %Cond.val
  br i1 %brmerge, label %list_Nconc.exit, label %for.cond.i
...
list_Nconc.exit:                                  ; preds = %for.end91, %for.end.i
  ...
  %cmp.i.not.i204 = icmp eq ptr %Cond.val175, null
  %brmerge255 = or i1 %cmp.i.not.i204, %cmp.i188.not236
  %call.i186.mux = select i1 %cmp.i.not.i204, ptr %call.i186, ptr %Cond.val175
...
list_Nconc.exit213:                               ; preds = %list_Nconc.exit, %for.end.i211
  ...
  %cmp.i.not.i214 = icmp eq ptr %Cond.val178, null
  %brmerge256 = or i1 %cmp.i.not.i214, %cmp.i190.not238
  %call.i187.mux = select i1 %cmp.i.not.i214, ptr %call.i187, ptr %Cond.val178
...
list_Nconc.exit223:                               ; preds = %list_Nconc.exit213, %for.end.i221
  ...
  %cmp.i.not.i224 = icmp eq ptr %call99, null
  br i1 %cmp.i.not.i224, label %list_Nconc.exit233, label %if.end.i226

if.end.i226:                                      ; preds = %list_Nconc.exit223
  %cmp.i18.not.i225 = icmp eq ptr %Cond.val181, null
  br i1 %cmp.i18.not.i225, label %list_Nconc.exit233, label %for.cond.i230
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %1 = getelementptr i8, ptr %Link, i64 32
  %2 = getelementptr i8, ptr %Link, i64 40
  %3 = getelementptr i8, ptr %Link, i64 48
  %4 = getelementptr i8, ptr %Link, i64 56
  br label %for.body
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc121
  ...
  %cmp.i.not.i = icmp eq ptr %S.val.i, null
  br i1 %cmp.i.not.i, label %land.lhs.true.i, label %if.else

land.lhs.true.i:                                  ; preds = %for.body
  %S.val10.i = load ptr, ptr %1, align 8
  %cmp.i12.not.i = icmp eq ptr %S.val10.i, null
  br i1 %cmp.i12.not.i, label %sort_LinkNoResidues.exit, label %if.else
...
if.then:                                          ; preds = %sort_LinkNoResidues.exit
  ...
  %Link.val210 = load ptr, ptr %4, align 8
...
for.end52:                                        ; preds = %for.body47, %for.cond43.preheader
  %Link.val211 = load i32, ptr %3, align 8
...
list_Nconc.exit259:                               ; preds = %list_Nconc.exit249, %for.end.i257
  ...
  %Link.val209 = load ptr, ptr %4, align 8
...
entry:
  %cmp.i.not = icmp eq ptr %Conditions, null
...
for.body:                                         ; preds = %if.else, %list_Nconc.exit280
  ...
  %C.val.i = load ptr, ptr %6, align 8
  %cmp.i.not.i = icmp eq ptr %C.val.i, null
  br i1 %cmp.i.not.i, label %land.lhs.true.i, label %if.then23

land.lhs.true.i:                                  ; preds = %for.body
  %7 = getelementptr i8, ptr %Scan.0.val214, i64 16
  %C.val10.i = load ptr, ptr %7, align 8
  %cmp.i12.not.i = icmp eq ptr %C.val10.i, null
  br i1 %cmp.i12.not.i, label %sort_ConditionNoResidues.exit, label %if.then23
...
if.end118:                                        ; preds = %for.end.i268, %if.end.i263, %list_Nconc.exit260, %sort_ConditionNoResidues.exit
  ...
  %cmp.i.not.i271 = icmp eq ptr %call120, null
  br i1 %cmp.i.not.i271, label %list_Nconc.exit280, label %if.end.i273

if.end.i273:                                      ; preds = %if.end118
  %cmp.i18.not.i272 = icmp eq ptr %NewClauses.0312, null
  br i1 %cmp.i18.not.i272, label %list_Nconc.exit280, label %for.cond.i277
...
entry:
  ...
  br i1 %tobool.not.i, label %land.end, label %symbol_IsPredicate.exit
...
land.rhs:                                         ; preds = %symbol_IsPredicate.exit
...
land.end:                                         ; preds = %entry, %land.rhs, %symbol_IsPredicate.exit
  %land.ext = phi i32 [ 0, %symbol_IsPredicate.exit ], [ %5, %land.rhs ], [ 0, %entry ]
  ret i32 %land.ext
}
...
sort_TheoryIncrementMark.exit:                    ; preds = %for.body.i, %entry
  ...
  %Scan.0179 = load ptr, ptr %7, align 8
  %cmp.i124.not180 = icmp eq ptr %Scan.0179, null
  br i1 %cmp.i124.not180, label %for.cond5.preheader, label %for.body

for.cond5.preheader:                              ; preds = %for.body, %sort_TheoryIncrementMark.exit
  %cmp.i125.not182 = icmp eq ptr %Sort1, null
  br i1 %cmp.i125.not182, label %for.cond24.preheader, label %for.body9

for.body:                                         ; preds = %sort_TheoryIncrementMark.exit, %for.body
  %Scan.0181 = phi ptr [ %Scan.0, %for.body ], [ %Scan.0179, %sort_TheoryIncrementMark.exit ]
  %8 = getelementptr i8, ptr %Scan.0181, i64 8
  ...
  %Scan.0 = load ptr, ptr %Scan.0181, align 8
...
for.cond24.preheader:                             ; preds = %for.body9, %for.cond5.preheader
  %Scan.2184 = load ptr, ptr %7, align 8
  %cmp.i127.not185 = icmp eq ptr %Scan.2184, null
  br i1 %cmp.i127.not185, label %for.end45.thread, label %for.body28

for.end45.thread:                                 ; preds = %for.cond24.preheader
  %call.i142194 = tail call ptr @list_Copy(ptr noundef %Sort1) #12
  br label %sort_Intersect.exit

for.body9:                                        ; preds = %for.cond5.preheader, %for.body9
  %Scan.1183 = phi ptr [ %Scan.1.val, %for.body9 ], [ %Sort1, %for.cond5.preheader ]
  %11 = getelementptr i8, ptr %Scan.1183, i64 8
  ...
  %Scan.1.val = load ptr, ptr %Scan.1183, align 8
...
for.body28:                                       ; preds = %for.cond24.preheader, %for.inc43
  %Scan.2187 = phi ptr [ %Scan.2, %for.inc43 ], [ %Scan.2184, %for.cond24.preheader ]
  %Top.0186 = phi ptr [ %Top.1, %for.inc43 ], [ null, %for.cond24.preheader ]
  %13 = getelementptr i8, ptr %Scan.2187, i64 8
  ...
  %cmp.i129.not = icmp eq ptr %call30.val, null
  br i1 %cmp.i129.not, label %land.lhs.true, label %for.inc43

land.lhs.true:                                    ; preds = %for.body28
  %15 = getelementptr i8, ptr %call29.val.val.val, i64 24
  %S.val.i = load ptr, ptr %15, align 8
  %cmp.i.not.i = icmp eq ptr %S.val.i, null
  br i1 %cmp.i.not.i, label %land.lhs.true.i, label %for.inc43

land.lhs.true.i:                                  ; preds = %land.lhs.true
  %16 = getelementptr i8, ptr %call29.val.val.val, i64 32
  %S.val10.i = load ptr, ptr %16, align 8
  %cmp.i12.not.i = icmp eq ptr %S.val10.i, null
  br i1 %cmp.i12.not.i, label %sort_LinkNoResidues.exit, label %for.inc43
...
if.then:                                          ; preds = %sort_LinkNoResidues.exit
  ...
  store ptr %Top.0186, ptr %call.i.i131, align 8
...
for.inc43:                                        ; preds = %land.lhs.true, %land.lhs.true.i, %for.body28, %sort_LinkNoResidues.exit, %if.then
  %Top.1 = phi ptr [ %call.i.i131, %if.then ], [ %Top.0186, %sort_LinkNoResidues.exit ], [ %Top.0186, %for.body28 ], [ %Top.0186, %land.lhs.true.i ], [ %Top.0186, %land.lhs.true ]
  %Scan.2 = load ptr, ptr %Scan.2187, align 8
...
for.end45:                                        ; preds = %for.inc43
  ...
  %cmp.i.not.i.i = icmp eq ptr %Top.1, null
  br i1 %cmp.i.not.i.i, label %sort_Intersect.exit, label %if.end.i.i

if.end.i.i:                                       ; preds = %for.end45
  %cmp.i18.not.i.i = icmp eq ptr %call.i142, null
  br i1 %cmp.i18.not.i.i, label %while.body.i.preheader, label %for.cond.i.i
...
sort_Intersect.exit:                              ; preds = %for.end45.thread, %for.end45, %for.end.i.i
  %retval.0.i.i = phi ptr [ %Top.1, %for.end.i.i ], [ %call.i142, %for.end45 ], [ %call.i142194, %for.end45.thread ]
...
while.cond.loopexit.i:                            ; preds = %for.inc41.i, %while.body.i
  ...
  %cmp.i.not.i143 = icmp eq ptr %Nodes.addr.1.lcssa.i, null
  br i1 %cmp.i.not.i143, label %sort_EvalSubsortNoResidues.exit, label %while.body.i, !llvm.loop !85
...
while.body.i:                                     ; preds = %while.body.i.preheader, %while.cond.loopexit.i
  ...
  br i1 %cmp.i72.not91.i, label %while.cond.loopexit.i, label %for.body.i145

for.body.i145:                                    ; preds = %while.body.i, %for.inc41.i
  ...
  %cmp.i.not.i.i144 = icmp eq ptr %S.val.i.i, null
  br i1 %cmp.i.not.i.i144, label %land.lhs.true.i.i, label %for.inc41.i

land.lhs.true.i.i:                                ; preds = %for.body.i145
  %29 = getelementptr i8, ptr %Scan.0.val66.i, i64 32
  %S.val10.i.i = load ptr, ptr %29, align 8
  %cmp.i12.not.i.i = icmp eq ptr %S.val10.i.i, null
  br i1 %cmp.i12.not.i.i, label %sort_LinkNoResidues.exit.i, label %for.inc41.i
...
sort_LinkNoResidues.exit.i:                       ; preds = %land.lhs.true.i.i
  ...
  br i1 %cmp.i14.i.not.i, label %land.lhs.true.i147, label %for.inc41.i

land.lhs.true.i147:                               ; preds = %sort_LinkNoResidues.exit.i
  ...
  %cmp.i146 = icmp eq i32 %dec.i.i, 0
  br i1 %cmp.i146, label %if.then.i, label %for.inc41.i

if.then.i:                                        ; preds = %land.lhs.true.i147
  ...
  %cmp.i74.not.i = icmp eq i32 %call11.val71.i, %Theory.val70.i
  br i1 %cmp.i74.not.i, label %for.inc41.i, label %if.then14.i
...
for.body22.i:                                     ; preds = %if.then14.i, %for.inc.i
  ...
  %cmp.i78.not.i = icmp eq ptr %call23.val.i, null
  br i1 %cmp.i78.not.i, label %for.inc.i, label %if.then27.i
...
if.then27.i:                                      ; preds = %for.body22.i
  ...
  %cmp.i.not.i80.i = icmp eq ptr %call32.i, null
  br i1 %cmp.i.not.i80.i, label %for.inc.i, label %if.end.i.i149

if.end.i.i149:                                    ; preds = %if.then27.i
  %cmp.i18.not.i.i148 = icmp eq ptr %Clauses.088.i, null
  br i1 %cmp.i18.not.i.i148, label %for.inc.i, label %for.cond.i.i153

for.cond.i.i153:                                  ; preds = %if.end.i.i149, %for.cond.i.i153
  %List1.addr.0.i.i150 = phi ptr [ %List1.addr.0.val17.i.i151, %for.cond.i.i153 ], [ %call32.i, %if.end.i.i149 ]
  %List1.addr.0.val17.i.i151 = load ptr, ptr %List1.addr.0.i.i150, align 8
  %cmp.i20.not.i.i152 = icmp eq ptr %List1.addr.0.val17.i.i151, null
  br i1 %cmp.i20.not.i.i152, label %for.end.i.i154, label %for.cond.i.i153, !llvm.loop !52

for.end.i.i154:                                   ; preds = %for.cond.i.i153
  store ptr %Clauses.088.i, ptr %List1.addr.0.i.i150, align 8
  br label %for.inc.i

for.inc.i:                                        ; preds = %for.end.i.i154, %if.end.i.i149, %if.then27.i, %for.body22.i
  %Clauses.1.i = phi ptr [ %Clauses.088.i, %for.body22.i ], [ %call32.i, %for.end.i.i154 ], [ %Clauses.088.i, %if.then27.i ], [ %call32.i, %if.end.i.i149 ]
...
for.end.i:                                        ; preds = %for.inc.i, %if.then14.i
  ...
  %call.i.i155 = tail call ptr @memory_Malloc(i32 noundef 40) #12
  store i32 1, ptr %call.i.i155, align 8
  %constraint.i.i.i = getelementptr inbounds %struct.CONDITION_HELP, ptr %call.i.i155, i64 0, i32 1
  %clauses.i.i.i = getelementptr inbounds %struct.CONDITION_HELP, ptr %call.i.i155, i64 0, i32 4
  ...
  store ptr %call.i.i155, ptr %car.i.i82.i, align 8
  ...
  %car.i.i156 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i83.i, i64 0, i32 1
  store ptr %call7.val68.i, ptr %car.i.i156, align 8
  store ptr %Nodes.addr.192.i, ptr %call.i83.i, align 8
  br label %for.inc41.i

for.inc41.i:                                      ; preds = %for.end.i, %if.then.i, %land.lhs.true.i147, %sort_LinkNoResidues.exit.i, %land.lhs.true.i.i, %for.body.i145
  %Nodes.addr.2.i = phi ptr [ %Nodes.addr.192.i, %if.then.i ], [ %call.i83.i, %for.end.i ], [ %Nodes.addr.192.i, %land.lhs.true.i147 ], [ %Nodes.addr.192.i, %sort_LinkNoResidues.exit.i ], [ %Nodes.addr.192.i, %land.lhs.true.i.i ], [ %Nodes.addr.192.i, %for.body.i145 ]
  %Scan.0.i = load ptr, ptr %Scan.093.i, align 8
  %cmp.i72.not.i = icmp eq ptr %Scan.0.i, null
  br i1 %cmp.i72.not.i, label %while.cond.loopexit.i, label %for.body.i145, !llvm.loop !87

sort_EvalSubsortNoResidues.exit:                  ; preds = %while.cond.loopexit.i, %sort_Intersect.exit
  %cmp.i157.not188 = icmp eq ptr %Sort2, null
  br i1 %cmp.i157.not188, label %for.end72, label %for.body54

for.body54:                                       ; preds = %sort_EvalSubsortNoResidues.exit, %for.inc70
  %Clauses.0190 = phi ptr [ %Clauses.1, %for.inc70 ], [ null, %sort_EvalSubsortNoResidues.exit ]
  %Scan.3189 = phi ptr [ %Scan.3.val, %for.inc70 ], [ %Sort2, %sort_EvalSubsortNoResidues.exit ]
  %40 = getelementptr i8, ptr %Scan.3189, i64 8
  ...
  %cmp.i159.not = icmp eq i32 %call55.val123, %Theory.val122
  br i1 %cmp.i159.not, label %if.else, label %if.then58

if.then58:                                        ; preds = %for.body54
  %cmp.i.not5.i = icmp eq ptr %Clauses.0190, null
  br i1 %cmp.i.not5.i, label %cleanup, label %while.body.i165

while.body.i165:                                  ; preds = %if.then58, %while.body.i165
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i165 ], [ %Clauses.0190, %if.then58 ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  %42 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i161 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %42, i64 0, i32 4
  %43 = load i32, ptr %total_size.i.i.i161, align 8
  %conv26.i.i.i162 = sext i32 %43 to i64
  %44 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i163 = add i64 %44, %conv26.i.i.i162
  ...
  %cmp.i.not.i164 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i164, label %cleanup, label %while.body.i165, !llvm.loop !5

if.else:                                          ; preds = %for.body54
  %47 = getelementptr i8, ptr %Scan.3.val112, i64 24
  %call55.val119 = load ptr, ptr %47, align 8
  %cmp.i166.not = icmp eq ptr %call55.val119, null
  br i1 %cmp.i166.not, label %for.inc70, label %if.then62
...
if.then62:                                        ; preds = %if.else
  ...
  %cmp.i.not.i168 = icmp eq ptr %call66, null
  br i1 %cmp.i.not.i168, label %for.inc70, label %if.end.i

if.end.i:                                         ; preds = %if.then62
  %cmp.i18.not.i = icmp eq ptr %Clauses.0190, null
  br i1 %cmp.i18.not.i, label %for.inc70, label %for.cond.i

for.cond.i:                                       ; preds = %if.end.i, %for.cond.i
  %List1.addr.0.i = phi ptr [ %List1.addr.0.val17.i, %for.cond.i ], [ %call66, %if.end.i ]
  %List1.addr.0.val17.i = load ptr, ptr %List1.addr.0.i, align 8
  %cmp.i20.not.i = icmp eq ptr %List1.addr.0.val17.i, null
  br i1 %cmp.i20.not.i, label %for.end.i169, label %for.cond.i, !llvm.loop !52

for.end.i169:                                     ; preds = %for.cond.i
  store ptr %Clauses.0190, ptr %List1.addr.0.i, align 8
  br label %for.inc70

for.inc70:                                        ; preds = %for.end.i169, %if.end.i, %if.then62, %if.else
  %Clauses.1 = phi ptr [ %Clauses.0190, %if.else ], [ %call66, %for.end.i169 ], [ %Clauses.0190, %if.then62 ], [ %call66, %if.end.i ]
  %Scan.3.val = load ptr, ptr %Scan.3189, align 8
  %cmp.i157.not = icmp eq ptr %Scan.3.val, null
  br i1 %cmp.i157.not, label %for.end72, label %for.body54, !llvm.loop !88
...
for.end72:                                        ; preds = %for.inc70, %sort_EvalSubsortNoResidues.exit
  ...
  %call.i170 = tail call ptr @memory_Malloc(i32 noundef 40) #12
  store i32 1, ptr %call.i170, align 8
  %constraint.i.i171 = getelementptr inbounds %struct.CONDITION_HELP, ptr %call.i170, i64 0, i32 1
  %clauses.i.i172 = getelementptr inbounds %struct.CONDITION_HELP, ptr %call.i170, i64 0, i32 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %constraint.i.i171, i8 0, i64 24, i1 false)
  store ptr %Clauses.0.lcssa, ptr %clauses.i.i172, align 8
  br label %cleanup

cleanup:                                          ; preds = %while.body.i165, %if.then58, %for.end72
  %retval.0 = phi ptr [ %call.i170, %for.end72 ], [ null, %if.then58 ], [ null, %while.body.i165 ]
  ret ptr %retval.0
}
...
if.then.i:                                        ; preds = %for.body.i51
  ...
  %cmp.i25.not.i = icmp eq i32 %call8.val.i, %Theory.val22.i
  br i1 %cmp.i25.not.i, label %for.inc.i, label %if.then11.i
...
for.inc.i:                                        ; preds = %if.then11.i, %if.then.i, %for.body.i51
  %Nodes.addr.2.i = phi ptr [ %call.i.i, %if.then11.i ], [ %Nodes.addr.132.i, %if.then.i ], [ %Nodes.addr.132.i, %for.body.i51 ]
...
for.body19:                                       ; preds = %for.body19.lr.ph, %for.inc23
  ...
  %cmp.i54.not = icmp eq i32 %call20.val, %Theory.val46
  br i1 %cmp.i54.not, label %for.inc23, label %cleanup
...
for.inc.i:                                        ; preds = %if.then11.i, %if.then.i, %for.body.i55
  %Nodes.addr.2.i = phi ptr [ %call.i.i, %if.then11.i ], [ %Nodes.addr.132.i, %if.then.i ], [ %Nodes.addr.132.i, %for.body.i55 ]
  %Scan.0.i = load ptr, ptr %Scan.033.i, align 8
  %cmp.i23.not.i = icmp eq ptr %Scan.0.i, null
...
for.body19:                                       ; preds = %for.body19.lr.ph, %for.inc23
  ...
  %call20.val = load i32, ptr %24, align 8
  %cmp.i58.not = icmp eq i32 %call20.val, %Theory.val50
  br i1 %cmp.i58.not, label %for.inc23, label %cleanup
...
for.end25:                                        ; preds = %for.inc23
  ...
  %cmp.i.not11.i = icmp eq ptr %call.i60, null
  br i1 %cmp.i.not11.i, label %cleanup, label %while.body.lr.ph.i61

for.end25.thread:                                 ; preds = %sort_EvalSubsortSpecial.exit
  %call.i6093 = tail call ptr @list_Copy(ptr noundef %Extra) #12
  %cmp.i.not11.i94 = icmp eq ptr %call.i6093, null
  br i1 %cmp.i.not11.i94, label %cleanup, label %while.body.us.i.preheader
...
while.body.us.i.preheader:                        ; preds = %for.end25.thread, %while.body.lr.ph.i61
  %Nodes.addr.012.us.i.ph = phi ptr [ %call.i6093, %for.end25.thread ], [ %call.i60, %while.body.lr.ph.i61 ]
  br label %while.body.us.i

while.body.us.i:                                  ; preds = %while.body.us.i.preheader, %while.cond.loopexit.us.i
  %Nodes.addr.012.us.i = phi ptr [ %Nodes.addr.1.lcssa.us.i, %while.cond.loopexit.us.i ], [ %Nodes.addr.012.us.i.ph, %while.body.us.i.preheader ]
  %car.i.us.i = getelementptr inbounds %struct.LIST_HELP, ptr %Nodes.addr.012.us.i, i64 0, i32 1
  %25 = load ptr, ptr %car.i.us.i, align 8
  %26 = load ptr, ptr %Nodes.addr.012.us.i, align 8
  ...
  store ptr %30, ptr %Nodes.addr.012.us.i, align 8
  %31 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Nodes.addr.012.us.i, ptr %31, align 8
  %Scan.07.us.i = load ptr, ptr %25, align 8
  %cmp.i30.not8.us.i = icmp eq ptr %Scan.07.us.i, null
  br i1 %cmp.i30.not8.us.i, label %while.cond.loopexit.us.i, label %for.body.us.i

for.body.us.i:                                    ; preds = %while.body.us.i, %for.inc.us.i
  %Scan.010.us.i = phi ptr [ %Scan.0.us.i, %for.inc.us.i ], [ %Scan.07.us.i, %while.body.us.i ]
  %Nodes.addr.19.us.i = phi ptr [ %Nodes.addr.2.us.i, %for.inc.us.i ], [ %26, %while.body.us.i ]
  %32 = getelementptr i8, ptr %Scan.010.us.i, i64 8
...
if.then10.us.i:                                   ; preds = %for.body.us.i
  ...
  store ptr %Nodes.addr.19.us.i, ptr %call.i.us.i, align 8
  br label %for.inc.us.i

for.inc.us.i:                                     ; preds = %if.then10.us.i, %for.body.us.i
  %Nodes.addr.2.us.i = phi ptr [ %call.i.us.i, %if.then10.us.i ], [ %Nodes.addr.19.us.i, %for.body.us.i ]
  %Scan.0.us.i = load ptr, ptr %Scan.010.us.i, align 8
...
while.body.i69:                                   ; preds = %while.body.lr.ph.i61, %while.cond.loopexit.i64
  %Nodes.addr.012.i = phi ptr [ %Nodes.addr.1.lcssa.i62, %while.cond.loopexit.i64 ], [ %call.i60, %while.body.lr.ph.i61 ]
  %car.i.i65 = getelementptr inbounds %struct.LIST_HELP, ptr %Nodes.addr.012.i, i64 0, i32 1
  %35 = load ptr, ptr %car.i.i65, align 8
  %36 = load ptr, ptr %Nodes.addr.012.i, align 8
  ...
  store ptr %40, ptr %Nodes.addr.012.i, align 8
  %41 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Nodes.addr.012.i, ptr %41, align 8
...
while.body.i29.i:                                 ; preds = %if.then.i70, %while.body.i29.i
  %Current.06.i.i = phi ptr [ %Current.0.val.i.i, %while.body.i29.i ], [ %36, %if.then.i70 ]
  %Current.0.val.i.i = load ptr, ptr %Current.06.i.i, align 8
  %43 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
...
if.end.loopexit.i:                                ; preds = %if.end.i.i
  %Scan.07.i = load ptr, ptr %35, align 8
  %cmp.i30.not8.i = icmp eq ptr %Scan.07.i, null
  br i1 %cmp.i30.not8.i, label %while.cond.loopexit.i64, label %for.body.i72

for.body.i72:                                     ; preds = %if.end.loopexit.i, %for.inc.i77
  %Scan.010.i = phi ptr [ %Scan.0.i76, %for.inc.i77 ], [ %Scan.07.i, %if.end.loopexit.i ]
  %Nodes.addr.19.i = phi ptr [ %Nodes.addr.2.i75, %for.inc.i77 ], [ %36, %if.end.loopexit.i ]
  %48 = getelementptr i8, ptr %Scan.010.i, i64 8
...
if.then10.i:                                      ; preds = %for.body.i72
  ...
  store ptr %Nodes.addr.19.i, ptr %call.i.i74, align 8
  br label %for.inc.i77

for.inc.i77:                                      ; preds = %if.then10.i, %for.body.i72
  %Nodes.addr.2.i75 = phi ptr [ %call.i.i74, %if.then10.i ], [ %Nodes.addr.19.i, %for.body.i72 ]
  %Scan.0.i76 = load ptr, ptr %Scan.010.i, align 8
...
sort_TheoryIncrementMark.exit:                    ; preds = %for.body.i, %entry
  ...
  %cmp.i211.not273 = icmp eq ptr %Scan.0272, null
  br i1 %cmp.i211.not273, label %for.cond6.preheader, label %for.body

for.cond6.preheader:                              ; preds = %for.body, %sort_TheoryIncrementMark.exit
  %cmp.i212.not275 = icmp eq ptr %Sort1, null
  br i1 %cmp.i212.not275, label %for.end22, label %for.body10

for.body:                                         ; preds = %sort_TheoryIncrementMark.exit, %for.body
  %Scan.0274 = phi ptr [ %Scan.0, %for.body ], [ %Scan.0272, %sort_TheoryIncrementMark.exit ]
  %8 = getelementptr i8, ptr %Scan.0274, i64 8
...
for.body10:                                       ; preds = %for.cond6.preheader, %for.body10
  %Scan.1276 = phi ptr [ %Scan.1.val, %for.body10 ], [ %Sort1, %for.cond6.preheader ]
  %11 = getelementptr i8, ptr %Scan.1276, i64 8
  ...
  %Scan.1.val = load ptr, ptr %Scan.1276, align 8
...
if.then.i:                                        ; preds = %for.body.i217
  ...
  %cmp.i73.not.i = icmp eq i32 %call9.val70.i, %Theory.val69.i
  br i1 %cmp.i73.not.i, label %for.inc41.i, label %if.then12.i
...
for.body24.i:                                     ; preds = %if.then12.i, %for.inc.i
  ...
  %cmp.i77.not.i = icmp eq ptr %call25.val.i, null
  br i1 %cmp.i77.not.i, label %for.inc.i, label %if.then29.i
...
sort_EvalSubsort.exit:                            ; preds = %while.cond.loopexit.i, %for.end22
  %cmp.i220.not277 = icmp eq ptr %Sort2, null
  br i1 %cmp.i220.not277, label %while.body.preheader, label %for.body28.lr.ph
...
for.body28:                                       ; preds = %for.body28.lr.ph, %for.inc33
  %Scan.2278 = phi ptr [ %Sort2, %for.body28.lr.ph ], [ %Scan.2.val, %for.inc33 ]
  %27 = getelementptr i8, ptr %Scan.2278, i64 8
  %Scan.2.val195 = load ptr, ptr %27, align 8
  %28 = getelementptr i8, ptr %Scan.2.val195, i64 8
  %call29.val = load i32, ptr %28, align 8
  %cmp.i222.not = icmp eq i32 %call29.val, %Theory.val207
  br i1 %cmp.i222.not, label %for.inc33, label %cleanup

for.inc33:                                        ; preds = %for.body28
  %Scan.2.val = load ptr, ptr %Scan.2278, align 8
...
while.body:                                       ; preds = %while.body.preheader, %if.end123
  %Visited.0297 = phi ptr [ %Visited.1, %if.end123 ], [ null, %while.body.preheader ]
  %Search.0296 = phi ptr [ %Search.5, %if.end123 ], [ %call.i.i230, %while.body.preheader ]
  %Result.0295 = phi ptr [ %Result.3, %if.end123 ], [ null, %while.body.preheader ]
  %31 = getelementptr i8, ptr %Search.0296, i64 8
  %Search.0.val194 = load ptr, ptr %31, align 8
  %Search.0.val = load ptr, ptr %Search.0296, align 8
  ...
  store ptr %35, ptr %Search.0296, align 8
  %36 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Search.0296, ptr %36, align 8
  %37 = load ptr, ptr @stdout, align 8
  %call.i234 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %37)
  ...
  %cmp.i.not11.i = icmp eq ptr %Visited.0297, null
  br i1 %cmp.i.not11.i, label %if.then53, label %while.body.lr.ph.i235
...
while.body.us.i:                                  ; preds = %while.body.lr.ph.i235, %if.end.us.i
  %List.addr.012.us.i = phi ptr [ %List.addr.0.val.us.i, %if.end.us.i ], [ %Visited.0297, %while.body.lr.ph.i235 ]
...
if.end.us.i:                                      ; preds = %while.body.us.i
  %List.addr.0.val.us.i = load ptr, ptr %List.addr.012.us.i, align 8
  %cmp.i.not.us.i = icmp eq ptr %List.addr.0.val.us.i, null
  br i1 %cmp.i.not.us.i, label %if.then53, label %while.body.us.i, !llvm.loop !106

while.body.i237:                                  ; preds = %while.body.lr.ph.i235, %if.end.i
  %List.addr.012.i = phi ptr [ %List.addr.0.val.i, %if.end.i ], [ %Visited.0297, %while.body.lr.ph.i235 ]
  %48 = getelementptr i8, ptr %List.addr.012.i, i64 8
...
for.body9.i.i:                                    ; preds = %for.inc15.i.i, %for.cond5.preheader.i.i
  ...
  %cmp.i34.not.i.i = icmp eq i32 %call10.val.i.i, %Theory.val29.i.i
  br i1 %cmp.i34.not.i.i, label %for.inc15.i.i, label %if.end.i
...
if.end.i:                                         ; preds = %for.body9.i.i, %while.body.i237
  %List.addr.0.val.i = load ptr, ptr %List.addr.012.i, align 8
  %cmp.i.not.i238 = icmp eq ptr %List.addr.0.val.i, null
  br i1 %cmp.i.not.i238, label %if.then53, label %while.body.i237, !llvm.loop !106

if.then53:                                        ; preds = %if.end.i, %if.end.us.i, %while.body
  ...
  store ptr %Visited.0297, ptr %call.i240, align 8
  %call47.val199 = load ptr, ptr %38, align 8
  %cmp.i241.not279 = icmp eq ptr %call47.val199, null
  br i1 %cmp.i241.not279, label %if.then78, label %land.rhs

land.rhs:                                         ; preds = %if.then53, %for.inc72
  %ValidStart.0282 = phi i32 [ %ValidStart.1, %for.inc72 ], [ 1, %if.then53 ]
  %Valid.0281 = phi i32 [ %Valid.1, %for.inc72 ], [ 1, %if.then53 ]
  %Scan.3280 = phi ptr [ %Scan.3.val, %for.inc72 ], [ %call47.val199, %if.then53 ]
  %tobool61 = icmp ne i32 %ValidStart.0282, 0
  %tobool62 = icmp ne i32 %Valid.0281, 0
  %59 = select i1 %tobool61, i1 true, i1 %tobool62
  br i1 %59, label %for.body63, label %if.end122

for.body63:                                       ; preds = %land.rhs
  %60 = getelementptr i8, ptr %Scan.3280, i64 8
...
if.else:                                          ; preds = %for.body63
  ...
  %spec.select = select i1 %cmp68.not, i32 %ValidStart.0282, i32 0
  br label %for.inc72

for.inc72:                                        ; preds = %if.else, %for.body63
  %Valid.1 = phi i32 [ 0, %for.body63 ], [ %Valid.0281, %if.else ]
  %ValidStart.1 = phi i32 [ 0, %for.body63 ], [ %spec.select, %if.else ]
  %Scan.3.val = load ptr, ptr %Scan.3280, align 8
  %cmp.i241.not = icmp eq ptr %Scan.3.val, null
  br i1 %cmp.i241.not, label %for.end74, label %land.rhs, !llvm.loop !107
...
if.then78:                                        ; preds = %if.then53, %if.then76
  ...
  store ptr %Result.0295, ptr %call.i245, align 8
  %Scan.4289.pre = load ptr, ptr %38, align 8
  br label %if.end81

if.end81:                                         ; preds = %if.then78, %if.then76
  %Scan.4289 = phi ptr [ %Scan.4289.pre, %if.then78 ], [ %call47.val199, %if.then76 ]
  %Result.1 = phi ptr [ %call.i245, %if.then78 ], [ %Result.0295, %if.then76 ]
  %cmp.i247.not290 = icmp eq ptr %Scan.4289, null
  br i1 %cmp.i247.not290, label %if.end122, label %for.body87.lr.ph
...
for.cond83.loopexit:                              ; preds = %for.inc116, %for.body87
  %Search.2.lcssa = phi ptr [ %Search.1291, %for.body87 ], [ %Search.3, %for.inc116 ]
  %Scan.4 = load ptr, ptr %Scan.4292, align 8
...
for.body87thread-pre-split:                       ; preds = %for.cond83.loopexit
  %Scan2.0284.pr = load ptr, ptr %7, align 8
  br label %for.body87

for.body87:                                       ; preds = %for.body87.lr.ph, %for.body87thread-pre-split
  %Scan2.0284 = phi ptr [ %Scan2.0284.pr, %for.body87thread-pre-split ], [ %67, %for.body87.lr.ph ]
  %Scan.4292 = phi ptr [ %Scan.4, %for.body87thread-pre-split ], [ %Scan.4289, %for.body87.lr.ph ]
  %Search.1291 = phi ptr [ %Search.2.lcssa, %for.body87thread-pre-split ], [ %Search.0.val, %for.body87.lr.ph ]
  %69 = getelementptr i8, ptr %Scan.4292, i64 8
  %Scan.4.val192 = load ptr, ptr %69, align 8
  %cmp.i249.not285 = icmp eq ptr %Scan2.0284, null
  br i1 %cmp.i249.not285, label %for.cond83.loopexit, label %for.body94

for.body94:                                       ; preds = %for.body87, %for.inc116
  %Scan2.0287 = phi ptr [ %Scan2.0, %for.inc116 ], [ %Scan2.0284, %for.body87 ]
  %Search.2286 = phi ptr [ %Search.3, %for.inc116 ], [ %Search.1291, %for.body87 ]
  %70 = getelementptr i8, ptr %Scan2.0287, i64 8
...
land.lhs.true:                                    ; preds = %for.body94
  ...
  %cmp.i251.not = icmp eq ptr %call96.val204, null
  br i1 %cmp.i251.not, label %for.inc116, label %if.then102
...
if.then102:                                       ; preds = %land.lhs.true
  ...
  %cmp.i.not.i.i = icmp eq ptr %call.i254, null
  br i1 %cmp.i.not.i.i, label %sort_Intersect.exit, label %if.end.i.i256

if.end.i.i256:                                    ; preds = %if.then102
  %cmp.i18.not.i.i = icmp eq ptr %call.i255, null
  br i1 %cmp.i18.not.i.i, label %sort_Intersect.exit, label %for.cond.i.i

for.cond.i.i:                                     ; preds = %if.end.i.i256, %for.cond.i.i
  %List1.addr.0.i.i = phi ptr [ %List1.addr.0.val17.i.i, %for.cond.i.i ], [ %call.i254, %if.end.i.i256 ]
  %List1.addr.0.val17.i.i = load ptr, ptr %List1.addr.0.i.i, align 8
  %cmp.i20.not.i.i = icmp eq ptr %List1.addr.0.val17.i.i, null
  br i1 %cmp.i20.not.i.i, label %for.end.i.i, label %for.cond.i.i, !llvm.loop !52
...
sort_Intersect.exit:                              ; preds = %if.then102, %if.end.i.i256, %for.end.i.i
  %retval.0.i.i = phi ptr [ %call.i254, %for.end.i.i ], [ %call.i255, %if.then102 ], [ %call.i254, %if.end.i.i256 ]
  ...
  %call.i.i257 = tail call ptr @list_CopyWithElement(ptr noundef %C.val.i, ptr noundef nonnull @term_Copy) #12
  ...
  %constraint.i.i.i258 = getelementptr inbounds %struct.CONDITION_HELP, ptr %call.i20.i, i64 0, i32 1
  store ptr %call.i.i257, ptr %constraint.i.i.i258, align 8
  ...
  %call.i.i.i259 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i.i260 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i259, i64 0, i32 1
  store ptr %call109, ptr %car.i.i.i260, align 8
  store ptr %call.i20.i, ptr %call.i.i.i259, align 8
  %call.i261 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i262 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i261, i64 0, i32 1
  store ptr %call.i.i.i259, ptr %car.i262, align 8
  store ptr %Search.2286, ptr %call.i261, align 8
  br label %for.inc116

for.inc116:                                       ; preds = %for.body94, %land.lhs.true, %sort_Intersect.exit
  %Search.3 = phi ptr [ %Search.2286, %land.lhs.true ], [ %call.i261, %sort_Intersect.exit ], [ %Search.2286, %for.body94 ]
  %Scan2.0 = load ptr, ptr %Scan2.0287, align 8
...
if.end122:                                        ; preds = %land.rhs, %for.cond83.loopexit, %for.body87.lr.ph, %if.end81, %for.end74
  %Result.2 = phi ptr [ %Result.0295, %for.end74 ], [ %Result.1, %if.end81 ], [ %Result.1, %for.body87.lr.ph ], [ %Result.1, %for.cond83.loopexit ], [ %Result.0295, %land.rhs ]
...
if.end123:                                        ; preds = %for.body.i.us.i, %for.inc15.i.i, %sort_TheoryIncrementMark.exit.i.us.i, %if.end122
  %Result.3 = phi ptr [ %Result.2, %if.end122 ], [ %Result.0295, %sort_TheoryIncrementMark.exit.i.us.i ], [ %Result.0295, %for.inc15.i.i ], [ %Result.0295, %for.body.i.us.i ]
  ...
  %Visited.1 = phi ptr [ %call.i240, %if.end122 ], [ %Visited.0297, %sort_TheoryIncrementMark.exit.i.us.i ], [ %Visited.0297, %for.inc15.i.i ], [ %Visited.0297, %for.body.i.us.i ]
...
if.then:                                          ; preds = %while.body
  ...
  %cmp.i.i.i = icmp slt i32 %Term.val56.i, 1
  br i1 %cmp.i.i.i, label %if.else.i, label %if.then.i

if.then.i:                                        ; preds = %if.then
  %Clause.val2630.i.i = load i32, ptr %2, align 8
  %Clause.val2731.i.i = load i32, ptr %3, align 4
...
if.then.i.i:                                      ; preds = %for.body.i.i
  %Clause.val.i.i = load ptr, ptr %4, align 8
  ...
  %cmp.i.not.i.i.i = icmp eq i32 %11, %L.val7.val.i.i.i
...
clause_LiteralAtom.exit.i.i:                      ; preds = %if.then.i.i.i, %if.then.i.i
  ...
  %shr.i.i.i.i.i = ashr i32 %sub.i.i.i.i.i, %5
  ...
  br i1 %cmp.i.not.i.i, label %land.lhs.true.i.i, label %for.inc.i.i
...
if.then11.i.i:                                    ; preds = %land.lhs.true.i.i
  ...
  %cmp.i.not.i.i.i.i = icmp eq ptr %Result.036.i.i, null
  br i1 %cmp.i.not.i.i.i.i, label %for.inc.i.i, label %for.cond.i.i.i.i
...
for.inc.i.i:                                      ; preds = %for.end.i.i.i.i, %if.then11.i.i, %land.lhs.true.i.i, %clause_LiteralAtom.exit.i.i, %for.body.i.i
  ...
  %Clause.val26.i.i = load i32, ptr %2, align 8
  %Clause.val27.i.i = load i32, ptr %3, align 4
...
if.else.i:                                        ; preds = %if.then
  ...
  %cmp.i.not103.i = icmp eq ptr %call7.i, null
  br i1 %cmp.i.not103.i, label %sort_ComputeSortInternNoResidues.exit, label %for.body.i

for.body.i:                                       ; preds = %if.else.i, %if.end31.i
  %Sort.0106.i = phi ptr [ %Sort.1.i, %if.end31.i ], [ null, %if.else.i ]
  %Scan.0105.i = phi ptr [ %Scan.0.val.i, %if.end31.i ], [ %call7.i, %if.else.i ]
  %Clauses.0104.i = phi ptr [ %Clauses.2.i, %if.end31.i ], [ null, %if.else.i ]
  %22 = getelementptr i8, ptr %Scan.0105.i, i64 8
  %Scan.0.val53.i = load ptr, ptr %22, align 8
  %call10.val55.i = load i32, ptr %Scan.0.val53.i, align 8
  %cmp.i.i57.i = icmp slt i32 %call10.val55.i, 1
  br i1 %cmp.i.i57.i, label %if.then13.i, label %if.end31.i
...
land.lhs.true.i:                                  ; preds = %if.then13.i
  ...
  %arrayidx.i.i.i59.i = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i.i.i
  store i32 %31, ptr %arrayidx.i.i.i59.i, align 4
...
while.body.i.i.i:                                 ; preds = %while.body.i.i.i.prol.loopexit, %while.body.i.i.i
  ...
  %cmp.i.i60.i.1 = icmp ugt i32 %dec.i.i.i.i.i, 1
  br i1 %cmp.i.i60.i.1, label %while.body.i.i.i, label %while.end.i.i.i, !llvm.loop !113
...
while.end.i.i.i:                                  ; preds = %while.body.i.i.i.prol.loopexit, %while.body.i.i.i, %land.lhs.true.i
  ...
  %cmp.i.not.i.i61.i = icmp eq i32 %45, 0
  br i1 %cmp.i.not.i.i61.i, label %cont_BackTrack.exit.i.i, label %if.then.i.i62.i

if.then.i.i62.i:                                  ; preds = %while.end.i.i.i
...
cont_BackTrack.exit.i.i:                          ; preds = %if.then.i.i62.i, %while.end.i.i.i
  %cmp.i49.not108.i.i = icmp eq ptr %call4.i.i, null
...
for.body.i64.i:                                   ; preds = %sort_DeleteOne.exit91.i.i, %for.body.lr.ph.i63.i
  %scan.0110.i.i = phi ptr [ %call4.i.i, %for.body.lr.ph.i63.i ], [ %scan.0.val46.i.i, %sort_DeleteOne.exit91.i.i ]
  %NewClauses.0109.i.i = phi ptr [ null, %for.body.lr.ph.i63.i ], [ %retval.0.i67.i.i, %sort_DeleteOne.exit91.i.i ]
  %49 = getelementptr i8, ptr %scan.0110.i.i, i64 8
...
for.body.i.i.i:                                   ; preds = %for.body.i64.i, %for.inc.i.i.i
  %indvars.iv.i.i.i = phi i64 [ %indvars.iv.next.i.i.i, %for.inc.i.i.i ], [ 0, %for.body.i64.i ]
  %Result.036.i.i.i = phi ptr [ %Result.1.i.i.i, %for.inc.i.i.i ], [ null, %for.body.i64.i ]
...
if.then.i52.i.i:                                  ; preds = %for.body.i.i.i
  ...
  %cmp.i.not.i.i.i65.i = icmp eq i32 %52, %L.val7.val.i.i.i.i
  br i1 %cmp.i.not.i.i.i65.i, label %if.then.i.i.i.i, label %clause_LiteralAtom.exit.i.i.i
...
clause_LiteralAtom.exit.i.i.i:                    ; preds = %if.then.i.i.i.i, %if.then.i52.i.i
  ...
  %shr.i.i.i.i.i.i = ashr i32 %sub.i.i.i.i.i.i, %5
  ...
  %cmp.i.not.i53.i.i = icmp eq i32 %57, 1
  br i1 %cmp.i.not.i53.i.i, label %land.lhs.true.i.i.i, label %for.inc.i.i.i
...
if.then11.i.i.i:                                  ; preds = %land.lhs.true.i.i.i
  %arrayidx.i.i.i.i66.i = getelementptr inbounds %struct.SORTTHEORY_HELP, ptr %Theory, i64 0, i32 1, i64 %idxprom.i.i.i.i.i.i
  %60 = load ptr, ptr %arrayidx.i.i.i.i66.i, align 8
  ...
  %cmp.i.not.i.i.i.i.i = icmp eq ptr %Result.036.i.i.i, null
  br i1 %cmp.i.not.i.i.i.i.i, label %for.inc.i.i.i, label %for.cond.i.i.i.i.i
...
sort_VarSort.exit.i.i:                            ; preds = %for.inc.i.i.i, %for.body.i64.i
  %Result.0.lcssa.i.i.i = phi ptr [ null, %for.body.i64.i ], [ %Result.1.i.i.i, %for.inc.i.i.i ]
  %62 = getelementptr i8, ptr %scan.0110.i.i, i64 16
  ...
  %cmp.i67.i = icmp eq ptr %call12.i.i, null
  br i1 %cmp.i67.i, label %if.then.i68.i, label %if.else.i.i

if.then.i68.i:                                    ; preds = %sort_VarSort.exit.i.i
...
while.body.i.i.i.i:                               ; preds = %if.then.i68.i, %while.body.i.i.i.i
  %Current.06.i.i.i.i = phi ptr [ %Current.0.val.i.i.i.i, %while.body.i.i.i.i ], [ %Result.0.lcssa.i.i.i, %if.then.i68.i ]
  ...
  %cmp.i.not.i.i54.i.i = icmp eq ptr %Current.0.val.i.i.i.i, null
  br i1 %cmp.i.not.i.i54.i.i, label %sort_DeleteOne.exit.i.i, label %while.body.i.i.i.i, !llvm.loop !5

sort_DeleteOne.exit.i.i:                          ; preds = %while.body.i.i.i.i, %if.then.i68.i
  %cmp.i.not5.i.i.i = icmp eq ptr %NewClauses.0109.i.i, null
  br i1 %cmp.i.not5.i.i.i, label %sort_MatchNoResidues.exit.i, label %while.body.i56.i.i

while.body.i56.i.i:                               ; preds = %sort_DeleteOne.exit.i.i, %while.body.i56.i.i
  %Current.06.i.i.i = phi ptr [ %Current.0.val.i.i.i, %while.body.i56.i.i ], [ %NewClauses.0109.i.i, %sort_DeleteOne.exit.i.i ]
  ...
  %cmp.i.not.i55.i.i = icmp eq ptr %Current.0.val.i.i.i, null
  br i1 %cmp.i.not.i55.i.i, label %sort_MatchNoResidues.exit.i, label %while.body.i56.i.i, !llvm.loop !5
...
if.else.i.i:                                      ; preds = %sort_VarSort.exit.i.i
  ...
  %cmp.i.not.i58.i.i = icmp eq ptr %NewClauses.0109.i.i, null
  br i1 %cmp.i.not.i58.i.i, label %list_Nconc.exit.i.i, label %if.end.i.i.i

if.end.i.i.i:                                     ; preds = %if.else.i.i
  %cmp.i18.not.i.i.i = icmp eq ptr %call15.i.i, null
  br i1 %cmp.i18.not.i.i.i, label %list_Nconc.exit.thread.i.i, label %for.cond.i.i.i

list_Nconc.exit.thread.i.i:                       ; preds = %if.end.i.i.i
  %75 = getelementptr i8, ptr %call12.i.i, i64 32
  %call12.val103.i.i = load ptr, ptr %75, align 8
  br label %if.end.i61.i.i

for.cond.i.i.i:                                   ; preds = %if.end.i.i.i, %for.cond.i.i.i
  %List1.addr.0.i.i.i = phi ptr [ %List1.addr.0.val17.i.i.i, %for.cond.i.i.i ], [ %NewClauses.0109.i.i, %if.end.i.i.i ]
...
list_Nconc.exit.i.i:                              ; preds = %for.end.i.i.i, %if.else.i.i
  %retval.0.i.i69.i = phi ptr [ %NewClauses.0109.i.i, %for.end.i.i.i ], [ %call15.i.i, %if.else.i.i ]
  %76 = getelementptr i8, ptr %call12.i.i, i64 32
  %call12.val.i.i = load ptr, ptr %76, align 8
  %cmp.i.not.i59.i.i = icmp eq ptr %retval.0.i.i69.i, null
  br i1 %cmp.i.not.i59.i.i, label %if.then.i70.i.i, label %if.end.i61.i.i

if.end.i61.i.i:                                   ; preds = %list_Nconc.exit.i.i, %list_Nconc.exit.thread.i.i
  %call12.val106.i.i = phi ptr [ %call12.val103.i.i, %list_Nconc.exit.thread.i.i ], [ %call12.val.i.i, %list_Nconc.exit.i.i ]
  %77 = phi ptr [ %75, %list_Nconc.exit.thread.i.i ], [ %76, %list_Nconc.exit.i.i ]
  %retval.0.i105.i.i = phi ptr [ %NewClauses.0109.i.i, %list_Nconc.exit.thread.i.i ], [ %retval.0.i.i69.i, %list_Nconc.exit.i.i ]
  %cmp.i18.not.i60.i.i = icmp eq ptr %call12.val106.i.i, null
  br i1 %cmp.i18.not.i60.i.i, label %if.then.i70.i.i, label %for.cond.i65.i.i

for.cond.i65.i.i:                                 ; preds = %if.end.i61.i.i, %for.cond.i65.i.i
  %List1.addr.0.i62.i.i = phi ptr [ %List1.addr.0.val17.i63.i.i, %for.cond.i65.i.i ], [ %retval.0.i105.i.i, %if.end.i61.i.i ]
  %List1.addr.0.val17.i63.i.i = load ptr, ptr %List1.addr.0.i62.i.i, align 8
  %cmp.i20.not.i64.i.i = icmp eq ptr %List1.addr.0.val17.i63.i.i, null
  br i1 %cmp.i20.not.i64.i.i, label %for.end.i66.i.i, label %for.cond.i65.i.i, !llvm.loop !52

for.end.i66.i.i:                                  ; preds = %for.cond.i65.i.i
  store ptr %call12.val106.i.i, ptr %List1.addr.0.i62.i.i, align 8
  br label %if.then.i70.i.i

if.then.i70.i.i:                                  ; preds = %for.end.i66.i.i, %if.end.i61.i.i, %list_Nconc.exit.i.i
  %78 = phi ptr [ %77, %for.end.i66.i.i ], [ %76, %list_Nconc.exit.i.i ], [ %77, %if.end.i61.i.i ]
  %retval.0.i67.i.i = phi ptr [ %retval.0.i105.i.i, %for.end.i66.i.i ], [ %call12.val.i.i, %list_Nconc.exit.i.i ], [ %retval.0.i105.i.i, %if.end.i61.i.i ]
  ...
  %cmp.i.not5.i.i69.i.i = icmp eq ptr %C.val11.i.i.i, null
  br i1 %cmp.i.not5.i.i69.i.i, label %sort_ConditionDelete.exit.i.i, label %while.body.i.i77.i.i

while.body.i.i77.i.i:                             ; preds = %if.then.i70.i.i, %while.body.i.i77.i.i
  %Current.06.i.i71.i.i = phi ptr [ %Current.0.val.i.i72.i.i, %while.body.i.i77.i.i ], [ %C.val11.i.i.i, %if.then.i70.i.i ]
  %Current.0.val.i.i72.i.i = load ptr, ptr %Current.06.i.i71.i.i, align 8
  %82 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i73.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %82, i64 0, i32 4
  %83 = load i32, ptr %total_size.i.i.i.i73.i.i, align 8
  %conv26.i.i.i.i74.i.i = sext i32 %83 to i64
  %84 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i75.i.i = add i64 %84, %conv26.i.i.i.i74.i.i
  store i64 %add27.i.i.i.i75.i.i, ptr @memory_FREEDBYTES, align 8
  %85 = load ptr, ptr %82, align 8
  store ptr %85, ptr %Current.06.i.i71.i.i, align 8
  %86 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i71.i.i, ptr %86, align 8
  %cmp.i.not.i.i76.i.i = icmp eq ptr %Current.0.val.i.i72.i.i, null
  br i1 %cmp.i.not.i.i76.i.i, label %sort_ConditionDelete.exit.i.i, label %while.body.i.i77.i.i, !llvm.loop !5

sort_ConditionDelete.exit.i.i:                    ; preds = %while.body.i.i77.i.i, %if.then.i70.i.i
  %87 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 40), align 8
  %total_size.i.i.i78.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %87, i64 0, i32 4
  %88 = load i32, ptr %total_size.i.i.i78.i.i, align 8
  %conv26.i.i.i79.i.i = sext i32 %88 to i64
  %89 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i80.i.i = add i64 %89, %conv26.i.i.i79.i.i
  store i64 %add27.i.i.i80.i.i, ptr @memory_FREEDBYTES, align 8
  ...
  %cmp.i.not5.i.i82.i.i = icmp eq ptr %Result.0.lcssa.i.i.i, null
  br i1 %cmp.i.not5.i.i82.i.i, label %sort_DeleteOne.exit91.i.i, label %while.body.i.i89.i.i

while.body.i.i89.i.i:                             ; preds = %sort_ConditionDelete.exit.i.i, %while.body.i.i89.i.i
  %Current.06.i.i83.i.i = phi ptr [ %Current.0.val.i.i84.i.i, %while.body.i.i89.i.i ], [ %Result.0.lcssa.i.i.i, %sort_ConditionDelete.exit.i.i ]
  %Current.0.val.i.i84.i.i = load ptr, ptr %Current.06.i.i83.i.i, align 8
  %92 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i85.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %92, i64 0, i32 4
  %93 = load i32, ptr %total_size.i.i.i.i85.i.i, align 8
  %conv26.i.i.i.i86.i.i = sext i32 %93 to i64
  %94 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i87.i.i = add i64 %94, %conv26.i.i.i.i86.i.i
  store i64 %add27.i.i.i.i87.i.i, ptr @memory_FREEDBYTES, align 8
  %95 = load ptr, ptr %92, align 8
  store ptr %95, ptr %Current.06.i.i83.i.i, align 8
  %96 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i83.i.i, ptr %96, align 8
  %cmp.i.not.i.i88.i.i = icmp eq ptr %Current.0.val.i.i84.i.i, null
  br i1 %cmp.i.not.i.i88.i.i, label %sort_DeleteOne.exit91.i.i, label %while.body.i.i89.i.i, !llvm.loop !5

sort_DeleteOne.exit91.i.i:                        ; preds = %while.body.i.i89.i.i, %sort_ConditionDelete.exit.i.i
  %scan.0.val46.i.i = load ptr, ptr %scan.0110.i.i, align 8
  %cmp.i49.not.i.i = icmp eq ptr %scan.0.val46.i.i, null
  br i1 %cmp.i49.not.i.i, label %for.end.i.i, label %for.body.i64.i, !llvm.loop !114

for.end.i.i:                                      ; preds = %sort_DeleteOne.exit91.i.i
  tail call void @subst_Free(ptr noundef nonnull %call4.i.i) #12
  %cmp.i.not.i92.i.i = icmp eq ptr %retval.0.i67.i.i, null
  br i1 %cmp.i.not.i92.i.i, label %land.lhs.true24.i, label %if.end.i94.i.i

if.end.i94.i.i:                                   ; preds = %for.end.i.i
  %cmp.i18.not.i93.i.i = icmp eq ptr %Clauses.0104.i, null
  br i1 %cmp.i18.not.i93.i.i, label %land.lhs.true24.i, label %for.cond.i98.i.i

for.cond.i98.i.i:                                 ; preds = %if.end.i94.i.i, %for.cond.i98.i.i
  %List1.addr.0.i95.i.i = phi ptr [ %List1.addr.0.val17.i96.i.i, %for.cond.i98.i.i ], [ %retval.0.i67.i.i, %if.end.i94.i.i ]
  %List1.addr.0.val17.i96.i.i = load ptr, ptr %List1.addr.0.i95.i.i, align 8
  %cmp.i20.not.i97.i.i = icmp eq ptr %List1.addr.0.val17.i96.i.i, null
  br i1 %cmp.i20.not.i97.i.i, label %for.end.i99.i.i, label %for.cond.i98.i.i, !llvm.loop !52

for.end.i99.i.i:                                  ; preds = %for.cond.i98.i.i
  store ptr %Clauses.0104.i, ptr %List1.addr.0.i95.i.i, align 8
  br label %land.lhs.true24.i

sort_MatchNoResidues.exit.i:                      ; preds = %while.body.i56.i.i, %sort_DeleteOne.exit.i.i
  tail call void @subst_Free(ptr noundef nonnull %call4.i.i) #12
  br label %if.end31.i

land.lhs.true24.i:                                ; preds = %for.end.i99.i.i, %if.end.i94.i.i, %for.end.i.i, %for.end.thread.i.i
  %Clauses.1.ph.i = phi ptr [ %Clauses.0104.i, %for.end.thread.i.i ], [ %retval.0.i67.i.i, %if.end.i94.i.i ], [ %Clauses.0104.i, %for.end.i.i ], [ %retval.0.i67.i.i, %for.end.i99.i.i ]
  %cmp.i.not11.i.i = icmp eq ptr %Sort.0106.i, null
  br i1 %cmp.i.not11.i.i, label %if.then27.i, label %for.body.i70.i

for.body.i70.i:                                   ; preds = %land.lhs.true24.i, %for.inc.i72.i
  %Sort.addr.012.i.i = phi ptr [ %Sort.addr.0.val.i.i, %for.inc.i72.i ], [ %Sort.0106.i, %land.lhs.true24.i ]
  ...
  %cmp.i9.not.i.i = icmp eq i32 %call1.val.i.i, %call15.val54.i
  br i1 %cmp.i9.not.i.i, label %if.end31.i, label %for.inc.i72.i

for.inc.i72.i:                                    ; preds = %for.body.i70.i
  %Sort.addr.0.val.i.i = load ptr, ptr %Sort.addr.012.i.i, align 8
  %cmp.i.not.i71.i = icmp eq ptr %Sort.addr.0.val.i.i, null
  br i1 %cmp.i.not.i71.i, label %if.then27.i, label %for.body.i70.i, !llvm.loop !10

if.then27.i:                                      ; preds = %for.inc.i72.i, %land.lhs.true24.i
  %sub.i.i.i74.i = sub nsw i32 0, %call15.val54.i
  %shr.i.i.i.i = ashr i32 %sub.i.i.i74.i, %5
...
for.cond.i.i82.i:                                 ; preds = %if.then27.i, %for.cond.i.i82.i
  %List1.addr.0.i.i79.i = phi ptr [ %List1.addr.0.val17.i.i80.i, %for.cond.i.i82.i ], [ %Sort.0106.i, %if.then27.i ]
...
sort_Intersect.exit.i:                            ; preds = %for.end.i.i83.i, %if.then27.i
  %retval.0.i.i84.i = phi ptr [ %Sort.0106.i, %for.end.i.i83.i ], [ %call.i.i.i.i, %if.then27.i ]
  %call.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i, i64 0, i32 1
...
if.end31.i:                                       ; preds = %for.body.i70.i, %sort_Intersect.exit.i, %sort_MatchNoResidues.exit.i, %if.then13.i, %for.body.i
  %Clauses.2.i = phi ptr [ %Clauses.0104.i, %if.then13.i ], [ %Clauses.0104.i, %sort_MatchNoResidues.exit.i ], [ %call.i.i, %sort_Intersect.exit.i ], [ %Clauses.0104.i, %for.body.i ], [ %Clauses.1.ph.i, %for.body.i70.i ]
  %Sort.1.i = phi ptr [ %Sort.0106.i, %if.then13.i ], [ %Sort.0106.i, %sort_MatchNoResidues.exit.i ], [ %retval.0.i.i84.i, %sort_Intersect.exit.i ], [ %Sort.0106.i, %for.body.i ], [ %Sort.0106.i, %for.body.i70.i ]
  %Scan.0.val.i = load ptr, ptr %Scan.0105.i, align 8
...
while.body.i.i:                                   ; preds = %if.end31.i, %while.body.i.i
  %Current.06.i.i = phi ptr [ %Current.0.val.i.i, %while.body.i.i ], [ %call7.i, %if.end31.i ]
  %Current.0.val.i.i = load ptr, ptr %Current.06.i.i, align 8
  ...
  %cmp.i.not.i86.i = icmp eq ptr %Current.0.val.i.i, null
  br i1 %cmp.i.not.i86.i, label %sort_ComputeSortInternNoResidues.exit, label %while.body.i.i, !llvm.loop !5

sort_ComputeSortInternNoResidues.exit:            ; preds = %for.inc.i.i, %while.body.i.i, %if.then.i, %if.else.i
  %Clauses.3.i = phi ptr [ null, %if.then.i ], [ null, %if.else.i ], [ %Clauses.2.i, %while.body.i.i ], [ null, %for.inc.i.i ]
  %Sort.2.i = phi ptr [ null, %if.then.i ], [ null, %if.else.i ], [ %Sort.1.i, %while.body.i.i ], [ %Result.1.i.i, %for.inc.i.i ]
...
entry:
  ...
  %cmp104 = icmp sgt i32 %Clause.val7.i, 0
  br i1 %cmp104, label %for.body.lr.ph, label %for.end40
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc38
  %indvars.iv109 = phi i64 [ %6, %for.body.lr.ph ], [ %indvars.iv.next110, %for.inc38 ]
  %Result.0106 = phi ptr [ null, %for.body.lr.ph ], [ %Result.1, %for.inc38 ]
  %Clause.val73 = load ptr, ptr %3, align 8
  %arrayidx.i = getelementptr inbounds ptr, ptr %Clause.val73, i64 %indvars.iv109
  %8 = load ptr, ptr %arrayidx.i, align 8
...
land.lhs.true:                                    ; preds = %for.body
  ...
  br i1 %cmp.i.not, label %if.then, label %for.inc38
...
if.then:                                          ; preds = %land.lhs.true
  ...
  %cmp16.not.not101 = icmp sgt i32 %Clause.val70, 0
  br i1 %cmp16.not.not101, label %for.body17.preheader, label %if.end32
...
for.body17:                                       ; preds = %for.body17.preheader, %for.inc
  ...
  %NewConstraint.0103 = phi ptr [ null, %for.body17.preheader ], [ %NewConstraint.1, %for.inc ]
...
if.then21:                                        ; preds = %for.body17
  ...
  %cmp.i.not.i = icmp eq i32 %16, %L.val7.val.i
...
clause_LiteralAtom.exit:                          ; preds = %if.then21, %if.then.i
  ...
  store ptr %NewConstraint.0103, ptr %call.i, align 8
  br label %for.inc

for.inc:                                          ; preds = %for.body17, %clause_LiteralAtom.exit
  %NewConstraint.1 = phi ptr [ %call.i, %clause_LiteralAtom.exit ], [ %NewConstraint.0103, %for.body17 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.body17, !llvm.loop !117

for.end:                                          ; preds = %for.inc
  %cmp.i82.not = icmp eq ptr %NewConstraint.1, null
  br i1 %cmp.i82.not, label %if.end32, label %if.then28
...
if.end32:                                         ; preds = %if.then, %if.then28, %for.end
  ...
  %20 = inttoptr i64 %indvars.iv109 to ptr
  ...
  br i1 %cmp.i.not5.i, label %while.body.i97.preheader, label %while.body.i

while.body.i:                                     ; preds = %if.end32, %while.body.i
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i ], [ %NewConstraint.2, %if.end32 ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  %22 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %22, i64 0, i32 4
  %23 = load i32, ptr %total_size.i.i.i, align 8
  ...
  br i1 %cmp.i.not.i89, label %while.body.i97.preheader, label %while.body.i, !llvm.loop !5

while.body.i97.preheader:                         ; preds = %while.body.i, %if.end32
  br label %while.body.i97

while.body.i97:                                   ; preds = %while.body.i97.preheader, %while.body.i97
  %Current.06.i91 = phi ptr [ %Current.0.val.i92, %while.body.i97 ], [ %call.i.i, %while.body.i97.preheader ]
  %Current.0.val.i92 = load ptr, ptr %Current.06.i91, align 8
  %27 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i93 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %27, i64 0, i32 4
  %28 = load i32, ptr %total_size.i.i.i93, align 8
  %conv26.i.i.i94 = sext i32 %28 to i64
  %29 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i95 = add i64 %29, %conv26.i.i.i94
  store i64 %add27.i.i.i95, ptr @memory_FREEDBYTES, align 8
  %30 = load ptr, ptr %27, align 8
  store ptr %30, ptr %Current.06.i91, align 8
  %31 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i91, ptr %31, align 8
  %cmp.i.not.i96 = icmp eq ptr %Current.0.val.i92, null
  br i1 %cmp.i.not.i96, label %list_Delete.exit98, label %while.body.i97, !llvm.loop !5

list_Delete.exit98:                               ; preds = %while.body.i97
  %call.i99 = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i100 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i99, i64 0, i32 1
  store ptr %call34, ptr %car.i100, align 8
  store ptr %Result.0106, ptr %call.i99, align 8
  br label %for.inc38

for.inc38:                                        ; preds = %for.body, %land.lhs.true, %list_Delete.exit98
  %Result.1 = phi ptr [ %call.i99, %list_Delete.exit98 ], [ %Result.0106, %land.lhs.true ], [ %Result.0106, %for.body ]
...
entry:
  ...
  %cmp.i.not55 = icmp eq ptr %call, null
  br i1 %cmp.i.not55, label %list_Nconc.exit, label %for.body.lr.ph

for.body.lr.ph:                                   ; preds = %entry
  %cmp.i.not.i5165 = icmp eq ptr %Constraint, null
  %0 = getelementptr i8, ptr %Constraint, i64 8
  br i1 %cmp.i.not.i5165, label %for.body.us, label %for.body

for.body.us:                                      ; preds = %for.body.lr.ph, %for.body.us
  %Scan1.057.us = phi ptr [ %Scan1.0.val.us, %for.body.us ], [ %call, %for.body.lr.ph ]
  %1 = getelementptr i8, ptr %Scan1.057.us, i64 8
  ...
  %Scan1.0.val.us = load ptr, ptr %Scan1.057.us, align 8
  %cmp.i.not.us = icmp eq ptr %Scan1.0.val.us, null
...
for.body:                                         ; preds = %for.body.lr.ph, %for.cond8.for.inc25_crit_edge
  %Scan1.057 = phi ptr [ %Scan1.0.val, %for.cond8.for.inc25_crit_edge ], [ %call, %for.body.lr.ph ]
  %Lits.056 = phi ptr [ %.us-phi, %for.cond8.for.inc25_crit_edge ], [ null, %for.body.lr.ph ]
  %7 = getelementptr i8, ptr %Scan1.057, i64 8
...
for.body12:                                       ; preds = %for.body, %for.inc
  %Scan2.054 = phi ptr [ %Scan2.0.val, %for.inc ], [ %Constraint, %for.body ]
  %Lits.153 = phi ptr [ %Lits.2, %for.inc ], [ %Lits.056, %for.body ]
  ...
  %cmp.i46.not = icmp eq i32 %call14.val, %10
  br i1 %cmp.i46.not, label %if.then, label %for.inc
...
if.then:                                          ; preds = %for.body12
  ...
  store ptr %Lits.153, ptr %call.i, align 8
  br label %for.inc

for.inc:                                          ; preds = %for.body12, %if.then
  %Lits.2 = phi ptr [ %call.i, %if.then ], [ %Lits.153, %for.body12 ]
  %Scan2.0.val = load ptr, ptr %Scan2.054, align 8
...
for.cond8.for.inc25_crit_edge:                    ; preds = %for.inc, %for.body
  %.us-phi = phi ptr [ %Lits.056, %for.body ], [ %Lits.2, %for.inc ]
  %Scan1.0.val = load ptr, ptr %Scan1.057, align 8
...
for.end27:                                        ; preds = %for.cond8.for.inc25_crit_edge, %for.body.us
  ...
  br i1 %cmp.i.not55, label %list_Delete.exit, label %while.body.i

while.body.i:                                     ; preds = %for.end27, %while.body.i
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i ], [ %call, %for.end27 ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  %27 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
...
list_Delete.exit:                                 ; preds = %while.body.i, %for.end27
  %cmp.i.not.i51 = icmp eq ptr %Constraint, null
  br i1 %cmp.i.not.i51, label %list_Nconc.exit, label %if.end.i

if.end.i:                                         ; preds = %list_Delete.exit
  %cmp.i18.not.i = icmp eq ptr %Lits.0.lcssa, null
...
entry:
  %cmp.i.not55 = icmp eq ptr %Clauses, null
  br i1 %cmp.i.not55, label %for.end24, label %for.cond2.preheader.us

for.cond2.preheader.us:                           ; preds = %entry, %for.cond2.for.inc22_crit_edge.us
  %Scan.057.us = phi ptr [ %Scan.0.val.us, %for.cond2.for.inc22_crit_edge.us ], [ %Clauses, %entry ]
  %RedundantClauses.056.us = phi ptr [ %RedundantClauses.2.us64, %for.cond2.for.inc22_crit_edge.us ], [ null, %entry ]
  %0 = getelementptr i8, ptr %Scan.057.us, i64 8
  %cmp.i.not6.i.us = icmp eq ptr %RedundantClauses.056.us, null
  br label %for.body6.us

for.body6.us:                                     ; preds = %for.cond2.preheader.us, %for.inc.us
  %Iter.053.us = phi ptr [ %Clauses, %for.cond2.preheader.us ], [ %Iter.0.val.us, %for.inc.us ]
  %1 = getelementptr i8, ptr %Iter.053.us, i64 8
...
land.lhs.true.us:                                 ; preds = %for.body6.us
  br i1 %cmp.i.not6.i.us, label %land.lhs.true12.us, label %while.body.i.us

while.body.i.us:                                  ; preds = %land.lhs.true.us, %if.end.i.us
  %List.addr.07.i.us = phi ptr [ %List.addr.0.val.i.us, %if.end.i.us ], [ %RedundantClauses.056.us, %land.lhs.true.us ]
...
if.end.i.us:                                      ; preds = %while.body.i.us
  ...
  br i1 %cmp.i.not.i.us, label %land.lhs.true12.us, label %while.body.i.us, !llvm.loop !99

land.lhs.true12.us:                               ; preds = %if.end.i.us, %land.lhs.true.us
...
for.inc.us.thread:                                ; preds = %land.lhs.true12.us
  ...
  store ptr %RedundantClauses.056.us, ptr %call.i.us, align 8
  br label %for.cond2.for.inc22_crit_edge.us

for.inc.us:                                       ; preds = %while.body.i.us, %land.lhs.true12.us, %for.body6.us
  %Iter.0.val.us = load ptr, ptr %Iter.053.us, align 8
...
for.cond2.for.inc22_crit_edge.us:                 ; preds = %for.inc.us, %for.inc.us.thread
  %RedundantClauses.2.us64 = phi ptr [ %call.i.us, %for.inc.us.thread ], [ %RedundantClauses.056.us, %for.inc.us ]
  %Scan.0.val.us = load ptr, ptr %Scan.057.us, align 8
...
for.end24:                                        ; preds = %for.cond2.for.inc22_crit_edge.us, %entry
  %RedundantClauses.0.lcssa = phi ptr [ null, %entry ], [ %RedundantClauses.2.us64, %for.cond2.for.inc22_crit_edge.us ]
...
if.then.i.i:                                      ; preds = %land.lhs.true.i.i
  ...
  %cmp112.i.i = icmp sgt i32 %Clause.val7.i.i.i, 0
  br i1 %cmp112.i.i, label %for.body.lr.ph.i.i, label %list_Nconc.exit.i
...
for.body.lr.ph.i.i:                               ; preds = %if.then.i.i
  ...
  %.pre120.i.i = load ptr, ptr @symbol_SIGNATURE, align 8
  br label %for.body.i.i

for.body.i.i:                                     ; preds = %for.inc42.i.i, %for.body.lr.ph.i.i
  %17 = phi ptr [ %.pre120.i.i, %for.body.lr.ph.i.i ], [ %42, %for.inc42.i.i ]
  %indvars.iv117.i.i = phi i64 [ %15, %for.body.lr.ph.i.i ], [ %indvars.iv.next118.i.i, %for.inc42.i.i ]
  %Result.0114.i.i = phi ptr [ null, %for.body.lr.ph.i.i ], [ %Result.1.i.i, %for.inc42.i.i ]
  %Clause.val84.i.i = load ptr, ptr %13, align 8
  %arrayidx.i.i.i = getelementptr inbounds ptr, ptr %Clause.val84.i.i, i64 %indvars.iv117.i.i
...
if.then11.i.i:                                    ; preds = %for.body.i.i
  ...
  %cmp19.not.not109.i.i = icmp sgt i32 %Clause.val81.i.i, 0
  br i1 %cmp19.not.not109.i.i, label %for.body20.preheader.i.i, label %if.end35.i.i
...
for.body20.i.i:                                   ; preds = %for.inc.i.i, %for.body20.preheader.i.i
  ...
  %NewConstraint.0111.i.i = phi ptr [ null, %for.body20.preheader.i.i ], [ %NewConstraint.1.i.i, %for.inc.i.i ]
...
if.then24.i.i:                                    ; preds = %for.body20.i.i
  ...
  %cmp.i.not.i.i.i = icmp eq i32 %25, %L.val7.val.i.i.i
  br i1 %cmp.i.not.i.i.i, label %if.then.i.i.i, label %clause_LiteralAtom.exit.i.i
...
clause_LiteralAtom.exit.i.i:                      ; preds = %if.then.i.i.i, %if.then24.i.i
  ...
  store ptr %NewConstraint.0111.i.i, ptr %call.i.i.i, align 8
  br label %for.inc.i.i

for.inc.i.i:                                      ; preds = %clause_LiteralAtom.exit.i.i, %for.body20.i.i
  %NewConstraint.1.i.i = phi ptr [ %call.i.i.i, %clause_LiteralAtom.exit.i.i ], [ %NewConstraint.0111.i.i, %for.body20.i.i ]
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1
  %exitcond.not.i.i = icmp eq i64 %indvars.iv.next.i.i, %wide.trip.count.i.i
  br i1 %exitcond.not.i.i, label %for.end.i.i, label %for.body20.i.i, !llvm.loop !123

for.end.i.i:                                      ; preds = %for.inc.i.i
  %cmp.i.not.i.i = icmp eq ptr %NewConstraint.1.i.i, null
  br i1 %cmp.i.not.i.i, label %if.end35.i.i, label %if.then31.i.i
...
if.end35.i.i:                                     ; preds = %if.then31.i.i, %for.end.i.i, %if.then11.i.i
  ...
  %30 = inttoptr i64 %indvars.iv117.i.i to ptr
  ...
  br i1 %cmp.i.not5.i.i.i, label %while.body.i105.i.i.preheader, label %while.body.i.i.i

while.body.i.i.i:                                 ; preds = %if.end35.i.i, %while.body.i.i.i
  %Current.06.i.i.i = phi ptr [ %Current.0.val.i.i.i, %while.body.i.i.i ], [ %NewConstraint.2.i.i, %if.end35.i.i ]
  %Current.0.val.i.i.i = load ptr, ptr %Current.06.i.i.i, align 8
  %32 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  ...
  %cmp.i.not.i97.i.i = icmp eq ptr %Current.0.val.i.i.i, null
  br i1 %cmp.i.not.i97.i.i, label %while.body.i105.i.i.preheader, label %while.body.i.i.i, !llvm.loop !5

while.body.i105.i.i.preheader:                    ; preds = %while.body.i.i.i, %if.end35.i.i
  br label %while.body.i105.i.i

while.body.i105.i.i:                              ; preds = %while.body.i105.i.i.preheader, %while.body.i105.i.i
  %Current.06.i99.i.i = phi ptr [ %Current.0.val.i100.i.i, %while.body.i105.i.i ], [ %call.i.i.i.i, %while.body.i105.i.i.preheader ]
  %Current.0.val.i100.i.i = load ptr, ptr %Current.06.i99.i.i, align 8
  %37 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i101.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %37, i64 0, i32 4
  %38 = load i32, ptr %total_size.i.i.i101.i.i, align 8
  %conv26.i.i.i102.i.i = sext i32 %38 to i64
  %39 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i103.i.i = add i64 %39, %conv26.i.i.i102.i.i
  store i64 %add27.i.i.i103.i.i, ptr @memory_FREEDBYTES, align 8
  %40 = load ptr, ptr %37, align 8
  store ptr %40, ptr %Current.06.i99.i.i, align 8
  %41 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i99.i.i, ptr %41, align 8
  %cmp.i.not.i104.i.i = icmp eq ptr %Current.0.val.i100.i.i, null
  br i1 %cmp.i.not.i104.i.i, label %list_Delete.exit106.i.i, label %while.body.i105.i.i, !llvm.loop !5

list_Delete.exit106.i.i:                          ; preds = %while.body.i105.i.i
  %call.i107.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #12
  %car.i108.i.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i107.i.i, i64 0, i32 1
  store ptr %call37.i.i, ptr %car.i108.i.i, align 8
  store ptr %Result.0114.i.i, ptr %call.i107.i.i, align 8
  %.pre.i.i = load ptr, ptr @symbol_SIGNATURE, align 8
  br label %for.inc42.i.i

for.inc42.i.i:                                    ; preds = %list_Delete.exit106.i.i, %for.body.i.i
  %42 = phi ptr [ %.pre.i.i, %list_Delete.exit106.i.i ], [ %17, %for.body.i.i ]
  %Result.1.i.i = phi ptr [ %call.i107.i.i, %list_Delete.exit106.i.i ], [ %Result.0114.i.i, %for.body.i.i ]
  %indvars.iv.next118.i.i = add nsw i64 %indvars.iv117.i.i, 1
  %cmp.i11.i = icmp slt i64 %indvars.iv.next118.i.i, %16
...
if.end.i.i:                                       ; preds = %sort_ApproxHornClauses.exit.i
  %cmp.i18.not.i.i = icmp eq ptr %Result.017.i, null
...
sort_ApproxClauses.exit:                          ; preds = %list_Nconc.exit.i, %sort_TheoryCreate.exit
  ...
  %cmp.i39.not69 = icmp eq ptr %call2, null
  br i1 %cmp.i39.not69, label %while.end19.thread.i, label %for.body

for.body:                                         ; preds = %sort_ApproxClauses.exit, %for.body
  %Scan.070 = phi ptr [ %Scan.0.val, %for.body ], [ %call2, %sort_ApproxClauses.exit ]
  %43 = getelementptr i8, ptr %Scan.070, i64 8
  ...
  %Scan.0.val = load ptr, ptr %Scan.070, align 8
  %cmp.i39.not = icmp eq ptr %Scan.0.val, null
  br i1 %cmp.i39.not, label %for.end, label %for.body, !llvm.loop !126

for.end:                                          ; preds = %for.body
  br i1 %cmp.i39.not69, label %while.end19.thread.i, label %while.body.i43

while.cond11.preheader.i:                         ; preds = %for.end.i
  %cmp.i63.not89.i = icmp eq ptr %call10.i, null
  br i1 %cmp.i63.not89.i, label %while.end19.thread.i, label %while.body15.lr.ph.i
...
while.body.i43:                                   ; preds = %for.end, %for.end.i
  %Clauses.addr.087.i = phi ptr [ %Clauses.addr.0.val.i42, %for.end.i ], [ %call2, %for.end ]
  %Sorts.086.i = phi ptr [ %call10.i, %for.end.i ], [ null, %for.end ]
  %49 = getelementptr i8, ptr %Clauses.addr.087.i, i64 8
  ...
  %Clauses.addr.0.val.i42 = load ptr, ptr %Clauses.addr.087.i, align 8
  %cmp82.i = icmp sgt i32 %add3.i.i, 0
  br i1 %cmp82.i, label %for.body.lr.ph.i44, label %for.end.i
...
for.body.i48:                                     ; preds = %clause_LiteralAtom.exit.i, %for.body.lr.ph.i44
  ...
  %Sorts.183.i = phi ptr [ %Sorts.086.i, %for.body.lr.ph.i44 ], [ %call.i.i51, %clause_LiteralAtom.exit.i ]
  ...
  %cmp.i.not.i.i47 = icmp eq i32 %56, %L.val7.val.i.i
  br i1 %cmp.i.not.i.i47, label %if.then.i.i49, label %clause_LiteralAtom.exit.i
...
clause_LiteralAtom.exit.i:                        ; preds = %if.then.i.i49, %for.body.i48
  ...
  store ptr %Sorts.183.i, ptr %call.i.i51, align 8
...
for.end.i:                                        ; preds = %clause_LiteralAtom.exit.i, %while.body.i43
  %Sorts.1.lcssa.i = phi ptr [ %Sorts.086.i, %while.body.i43 ], [ %call.i.i51, %clause_LiteralAtom.exit.i ]
...
while.body15.i:                                   ; preds = %while.body15.i, %while.body15.lr.ph.i
  %Clauses.addr.190.i = phi ptr [ %call10.i, %while.body15.lr.ph.i ], [ %Clauses.addr.1.val.i, %while.body15.i ]
  %60 = getelementptr i8, ptr %Clauses.addr.190.i, i64 8
  ...
  %Clauses.addr.1.val.i = load ptr, ptr %Clauses.addr.190.i, align 8
...
while.end19.thread.i:                             ; preds = %sort_ApproxClauses.exit, %while.cond11.preheader.i, %for.end
  %call20103.i = tail call i32 @list_Length(ptr noundef null) #12
...
while.body25.i:                                   ; preds = %while.end19.i, %sort_DeleteOne.exit.i
  %Clauses.addr.293.i = phi ptr [ %Clauses.addr.2.val.i, %sort_DeleteOne.exit.i ], [ %call10.i, %while.end19.i ]
  %i.192.i = phi i32 [ %i.2.i, %sort_DeleteOne.exit.i ], [ 0, %while.end19.i ]
  %64 = getelementptr i8, ptr %Clauses.addr.293.i, i64 8
...
if.then.i68.i:                                    ; preds = %while.body25.i
  ...
  br i1 %cmp.i.not5.i.i.i59, label %sort_ConditionDelete.exit.i, label %while.body.i.i.i66

while.body.i.i.i66:                               ; preds = %if.then.i68.i, %while.body.i.i.i66
  %Current.06.i.i.i60 = phi ptr [ %Current.0.val.i.i.i61, %while.body.i.i.i66 ], [ %C.val11.i.i, %if.then.i68.i ]
  %Current.0.val.i.i.i61 = load ptr, ptr %Current.06.i.i.i60, align 8
  %69 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  ...
  %cmp.i.not.i.i.i65 = icmp eq ptr %Current.0.val.i.i.i61, null
  br i1 %cmp.i.not.i.i.i65, label %sort_ConditionDelete.exit.i, label %while.body.i.i.i66, !llvm.loop !5

sort_ConditionDelete.exit.i:                      ; preds = %while.body.i.i.i66, %if.then.i68.i
  ...
  %inc30.i = add nsw i32 %i.192.i, 1
  br label %if.end.i

if.end.i:                                         ; preds = %sort_ConditionDelete.exit.i, %while.body25.i
  %i.2.i = phi i32 [ %inc30.i, %sort_ConditionDelete.exit.i ], [ %i.192.i, %while.body25.i ]
...
while.body.i.i76.i:                               ; preds = %if.end.i, %while.body.i.i76.i
  %Current.06.i.i70.i = phi ptr [ %Current.0.val.i.i71.i, %while.body.i.i76.i ], [ %Clauses.addr.2.val59.i, %if.end.i ]
  %Current.0.val.i.i71.i = load ptr, ptr %Current.06.i.i70.i, align 8
  ...
  %cmp.i.not.i.i75.i = icmp eq ptr %Current.0.val.i.i71.i, null
...
sort_DeleteOne.exit.i:                            ; preds = %while.body.i.i76.i, %if.end.i
  %Clauses.addr.2.val.i = load ptr, ptr %Clauses.addr.293.i, align 8
...
while.body.i.i:                                   ; preds = %sort_DeleteOne.exit.i, %while.body.i.i
  %Current.06.i.i = phi ptr [ %Current.0.val.i.i, %while.body.i.i ], [ %call10.i, %sort_DeleteOne.exit.i ]
  %Current.0.val.i.i = load ptr, ptr %Current.06.i.i, align 8
  ...
  %cmp.i.not.i81.i = icmp eq ptr %Current.0.val.i.i, null
  br i1 %cmp.i.not.i81.i, label %sort_SortTheoryIsTrivial.exit, label %while.body.i.i, !llvm.loop !5

sort_SortTheoryIsTrivial.exit:                    ; preds = %while.body.i.i, %while.end19.thread.i
  %i.1.lcssa112.i = phi i32 [ 0, %while.end19.thread.i ], [ %i.2.i, %while.body.i.i ]
  %call20106111.i = phi i32 [ %call20103.i, %while.end19.thread.i ], [ %call20.i, %while.body.i.i ]
  %cmp34.i.not = icmp eq i32 %i.1.lcssa112.i, %call20106111.i
  br i1 %cmp34.i.not, label %if.then, label %if.end
...
if.end19:                                         ; preds = %if.then15, %if.else, %if.end
  br i1 %cmp.i39.not69, label %list_Delete.exit, label %while.body.i68

while.body.i68:                                   ; preds = %if.end19, %while.body.i68
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i68 ], [ %call2, %if.end19 ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  ...
  %cmp.i.not.i67 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i67, label %list_Delete.exit, label %while.body.i68, !llvm.loop !5

list_Delete.exit:                                 ; preds = %while.body.i68, %if.end19
  ret ptr %Result.0
}
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %Scan.0268 = phi ptr [ %Clauses, %for.body.lr.ph ], [ %Scan.0.val, %for.inc ]
  %9 = getelementptr i8, ptr %Scan.0268, i64 8
...
while.body.i:                                     ; preds = %if.then, %while.body.i
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i ], [ %call5.val165, %if.then ]
  %Current.0.val.i = load ptr, ptr %Current.06.i, align 8
  ...
  %cmp.i.not.i173 = icmp eq ptr %Current.0.val.i, null
...
while.body.i181:                                  ; preds = %list_Delete.exit, %while.body.i181
  %Current.06.i175 = phi ptr [ %Current.0.val.i176, %while.body.i181 ], [ %call5.val166, %list_Delete.exit ]
  %Current.0.val.i176 = load ptr, ptr %Current.06.i175, align 8
  ...
  %cmp.i.not.i180 = icmp eq ptr %Current.0.val.i176, null
...
for.inc:                                          ; preds = %for.body, %list_Delete.exit182
  %Scan.0.val = load ptr, ptr %Scan.0268, align 8
...
for.body21:                                       ; preds = %for.inc, %for.inc71
  %Decreasing.0277 = phi i32 [ %Decreasing.1.lcssa, %for.inc71 ], [ 1, %for.inc ]
  %ManySorted.0276 = phi i32 [ %ManySorted.1.lcssa.fr, %for.inc71 ], [ 1, %for.inc ]
  %Scan.1275 = phi ptr [ %Scan.1.val, %for.inc71 ], [ %Clauses, %for.inc ]
  %31 = getelementptr i8, ptr %Scan.1275, i64 8
  %Scan.1.val149 = load ptr, ptr %31, align 8
  %32 = getelementptr i8, ptr %Scan.1.val149, i64 72
  %Clause.val7.i = load i32, ptr %32, align 8
  %cmp269 = icmp sgt i32 %Clause.val7.i, 0
  br i1 %cmp269, label %for.body29.lr.ph, label %for.inc71
...
for.body29.lr.ph:                                 ; preds = %for.body21
  ...
  %.pre282 = load i32, ptr @fol_EQUALITY, align 4
  br label %for.body29

for.body29:                                       ; preds = %for.body29.lr.ph, %for.inc69
  %38 = phi i32 [ %.pre282, %for.body29.lr.ph ], [ %129, %for.inc69 ]
  %indvars.iv = phi i64 [ %36, %for.body29.lr.ph ], [ %indvars.iv.next, %for.inc69 ]
  %ManySorted.1272 = phi i32 [ %ManySorted.0276, %for.body29.lr.ph ], [ %ManySorted.3, %for.inc69 ]
  ...
  %cmp.i192.not = icmp eq i32 %38, %call30.val167
  br i1 %cmp.i192.not, label %if.then33, label %for.inc69
...
if.then33:                                        ; preds = %for.body29
  ...
  %cmp.i.i.not = icmp eq ptr %call37.val156, null
  br i1 %cmp.i.i.not, label %if.end67, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %if.then33
  %46 = getelementptr i8, ptr %call36, i64 8
  %call36.val155 = load ptr, ptr %46, align 8
  %cmp.i.i194.not = icmp eq ptr %call36.val155, null
  br i1 %cmp.i.i194.not, label %if.end67, label %if.else
...
if.else:                                          ; preds = %lor.lhs.false
  ...
  br i1 %cmp.not.i, label %for.cond3.preheader.us.i, label %if.then49
...
for.cond3.for.end_crit_edge.us.i:                 ; preds = %for.body8.us.i
  br i1 %cmp.i32.us.i, label %if.then49, label %for.inc16.us.i

if.then49:                                        ; preds = %for.cond3.for.end_crit_edge.us.i, %if.else
...
while.body.i.i:                                   ; preds = %if.then.i200, %while.body.i.i
  %Current.06.i.i = phi ptr [ %Current.0.val.i.i, %while.body.i.i ], [ %C.val11.i, %if.then.i200 ]
  %Current.0.val.i.i = load ptr, ptr %Current.06.i.i, align 8
  %56 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
...
if.then.i210:                                     ; preds = %land.lhs.true, %if.end61
  %Cond.0266 = phi ptr [ %call60, %if.end61 ], [ %call52, %land.lhs.true ]
  %66 = getelementptr i8, ptr %Cond.0266, i64 8
  ...
  %67 = getelementptr i8, ptr %Cond.0266, i64 16
  ...
  %68 = getelementptr i8, ptr %Cond.0266, i64 24
  ...
  %69 = getelementptr i8, ptr %Cond.0266, i64 32
  %C.val11.i208 = load ptr, ptr %69, align 8
  %cmp.i.not5.i.i209 = icmp eq ptr %C.val11.i208, null
  br i1 %cmp.i.not5.i.i209, label %sort_ConditionDelete.exit222, label %while.body.i.i217

while.body.i.i217:                                ; preds = %if.then.i210, %while.body.i.i217
  %Current.06.i.i211 = phi ptr [ %Current.0.val.i.i212, %while.body.i.i217 ], [ %C.val11.i208, %if.then.i210 ]
  %Current.0.val.i.i212 = load ptr, ptr %Current.06.i.i211, align 8
  ...
  %cmp.i.not.i.i216 = icmp eq ptr %Current.0.val.i.i212, null
  br i1 %cmp.i.not.i.i216, label %sort_ConditionDelete.exit222, label %while.body.i.i217, !llvm.loop !5

sort_ConditionDelete.exit222:                     ; preds = %while.body.i.i217, %if.then.i210
  ...
  store ptr %78, ptr %Cond.0266, align 8
  %79 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 40), align 8
  store ptr %Cond.0266, ptr %79, align 8
  br label %if.end67

if.end67:                                         ; preds = %for.inc16.us.i, %if.then49, %if.end61, %if.then33, %lor.lhs.false, %sort_ConditionDelete.exit222
  %ManySorted.2 = phi i32 [ 0, %sort_ConditionDelete.exit222 ], [ 0, %lor.lhs.false ], [ 0, %if.then33 ], [ 0, %if.end61 ], [ 0, %if.then49 ], [ %ManySorted.1272, %for.inc16.us.i ]
  %Decreasing.2 = phi i32 [ 1, %sort_ConditionDelete.exit222 ], [ 0, %lor.lhs.false ], [ 0, %if.then33 ], [ 0, %if.end61 ], [ 0, %if.then49 ], [ 1, %for.inc16.us.i ]
...
while.body.i.i.i:                                 ; preds = %if.end67, %while.body.i.i.i
  %Current.06.i.i.i = phi ptr [ %Current.0.val.i.i.i, %while.body.i.i.i ], [ %Pair.val.i, %if.end67 ]
  %Current.0.val.i.i.i = load ptr, ptr %Current.06.i.i.i, align 8
...
while.body.i.i12.i:                               ; preds = %if.then.i.i, %while.body.i.i12.i
  %Current.06.i.i6.i = phi ptr [ %Current.0.val.i.i7.i, %while.body.i.i12.i ], [ %C.val11.i.i, %if.then.i.i ]
  %Current.0.val.i.i7.i = load ptr, ptr %Current.06.i.i6.i, align 8
  ...
  %cmp.i.not.i.i11.i = icmp eq ptr %Current.0.val.i.i7.i, null
...
while.body.i.i.i234:                              ; preds = %sort_PairDelete.exit, %while.body.i.i.i234
  %Current.06.i.i.i228 = phi ptr [ %Current.0.val.i.i.i229, %while.body.i.i.i234 ], [ %Pair.val.i226, %sort_PairDelete.exit ]
  %Current.0.val.i.i.i229 = load ptr, ptr %Current.06.i.i.i228, align 8
  ...
  %cmp.i.not.i.i.i233 = icmp eq ptr %Current.0.val.i.i.i229, null
...
while.body.i.i12.i250:                            ; preds = %if.then.i.i243, %while.body.i.i12.i250
  %Current.06.i.i6.i244 = phi ptr [ %Current.0.val.i.i7.i245, %while.body.i.i12.i250 ], [ %C.val11.i.i241, %if.then.i.i243 ]
  %Current.0.val.i.i7.i245 = load ptr, ptr %Current.06.i.i6.i244, align 8
  ...
  %cmp.i.not.i.i11.i249 = icmp eq ptr %Current.0.val.i.i7.i245, null
...
for.inc69:                                        ; preds = %for.body29, %sort_PairDelete.exit258
  ...
  %ManySorted.3 = phi i32 [ %ManySorted.2, %sort_PairDelete.exit258 ], [ %ManySorted.1272, %for.body29 ]
...
for.inc71:                                        ; preds = %for.inc69, %for.body21
  %ManySorted.1.lcssa = phi i32 [ %ManySorted.0276, %for.body21 ], [ %ManySorted.3, %for.inc69 ]
  %Decreasing.1.lcssa = phi i32 [ %Decreasing.0277, %for.body21 ], [ %Decreasing.3, %for.inc69 ]
...
for.end73:                                        ; preds = %for.inc71
  %ManySorted.1.lcssa.fr.le = freeze i32 %ManySorted.1.lcssa
  %132 = select i1 %tobool20, i32 2, i32 1
  tail call void @sort_TheoryDelete(ptr noundef nonnull %call.i)
  %tobool74.not = icmp eq i32 %ManySorted.1.lcssa.fr.le, 0
...
; Function Attrs: nofree nounwind
declare noundef i32 @_IO_putc(i32 noundef, ptr nocapture noundef) local_unnamed_addr #7
