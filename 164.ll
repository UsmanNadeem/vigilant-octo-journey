...
land.rhs.i:                                       ; preds = %land.lhs.true
  %cmp.i.i.not13.i.i.i.i = icmp eq ptr %29, %li1
  br i1 %cmp.i.i.not13.i.i.i.i, label %cond.end, label %for.body.i.i.i.i

for.body.i.i.i.i:                                 ; preds = %land.rhs.i, %for.inc.i.i.i.i
  %__first1.sroa.0.014.i.i.i.i = phi ptr [ %34, %for.inc.i.i.i.i ], [ %29, %land.rhs.i ]
  %__first2.sroa.0.015.i.i.i.pn.i.sroa.phi = phi ptr [ %__first2.sroa.0.015.i.i.i.i.sroa.gep, %for.inc.i.i.i.i ], [ %li2.sroa.gep, %land.rhs.i ]
  %__first2.sroa.0.015.i.i.i.i = load ptr, ptr %__first2.sroa.0.015.i.i.i.pn.i.sroa.phi, align 8, !tbaa !10
  %__value_.i.i.i.i.i = getelementptr inbounds %"struct.std::__1::__list_node", ptr %__first1.sroa.0.014.i.i.i.i, i64 0, i32 1
  %__value_.i8.i.i.i.i = getelementptr inbounds %"struct.std::__1::__list_node", ptr %__first2.sroa.0.015.i.i.i.i, i64 0, i32 1
  %32 = load i64, ptr %__value_.i.i.i.i.i, align 8, !tbaa !14
  %33 = load i64, ptr %__value_.i8.i.i.i.i, align 8, !tbaa !14
  %cmp.i.i.i.i.i = icmp eq i64 %32, %33
  br i1 %cmp.i.i.i.i.i, label %for.inc.i.i.i.i, label %cond.end

for.inc.i.i.i.i:                                  ; preds = %for.body.i.i.i.i
  %__first2.sroa.0.015.i.i.i.i.sroa.gep = getelementptr inbounds %"struct.std::__1::__list_node_base", ptr %__first2.sroa.0.015.i.i.i.i, i64 0, i32 1
  %__next_.i.i.i.i.i = getelementptr inbounds %"struct.std::__1::__list_node_base", ptr %__first1.sroa.0.014.i.i.i.i, i64 0, i32 1
  %34 = load ptr, ptr %__next_.i.i.i.i.i, align 8, !tbaa !10
  %cmp.i.i.not.i.i.i.i = icmp eq ptr %34, %li1
  br i1 %cmp.i.i.not.i.i.i.i, label %cond.end, label %for.body.i.i.i.i, !llvm.loop !27

cond.end:                                         ; preds = %for.inc.i.i.i.i, %for.body.i.i.i.i, %land.rhs.i, %land.lhs.true, %_ZNSt3__14listImNS_9allocatorImEEE7reverseEv.exit
  %cond = phi i64 [ 0, %_ZNSt3__14listImNS_9allocatorImEEE7reverseEv.exit ], [ 0, %land.lhs.true ], [ %23, %land.rhs.i ], [ %23, %for.inc.i.i.i.i ], [ 0, %for.body.i.i.i.i ]
