; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_regexec.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_regex_regexec.c"
...
if.then8:                                         ; preds = %if.end3
  call void @llvm.lifetime.start.p0(i64 104, ptr nonnull %mv.i) #14
...
if.else.i:                                        ; preds = %if.then8
  %call.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %string) #15
  br label %if.end7.i
...
land.lhs.true58.i.i:                              ; preds = %lor.lhs.false55.i.i
  %call59.i.i = tail call ptr @__ctype_b_loc() #16
...
land.lhs.true66.land.lhs.true69_crit_edge.i.i:    ; preds = %land.lhs.true66.i.i
  %.pre241.i.i = tail call ptr @__ctype_b_loc() #16
...
if.end78.i:                                       ; preds = %if.end69.i
  ...
  %call76.i = call ptr @cli_malloc(i64 noundef %mul.i) #14
...
for.body89.preheader.i:                           ; preds = %for.cond84.preheader.i
  %uglygep.i = getelementptr i8, ptr %44, i64 16
  %46 = shl nuw i64 %45, 4
  call void @llvm.memset.p0.i64(ptr align 8 %uglygep.i, i8 -1, i64 %46, i1 false), !tbaa !44
  br label %for.end97.i

for.end97.i:                                      ; preds = %for.body89.preheader.i, %for.cond84.preheader.i
  %47 = load i32, ptr %backrefs.i, align 8, !tbaa !42
  %tobool99.not.i = icmp eq i32 %47, 0
  br i1 %tobool99.not.i, label %land.lhs.true100.i, label %if.else107.i

land.lhs.true100.i:                               ; preds = %for.end97.i
  %48 = load i32, ptr %eflags36.i, align 8, !tbaa !30
  %and102.i = and i32 %48, 1024
...
if.then104.i:                                     ; preds = %land.lhs.true100.i
  %49 = load ptr, ptr %coldp132.i.i, align 8, !tbaa !41
  %call106.i = call fastcc ptr @sdissect(ptr noundef nonnull %mv.i, ptr noundef %49, ptr noundef nonnull %call55.lcssa.i, i64 noundef %add.i, i64 noundef %6)
  br label %if.end133.i

if.else107.i:                                     ; preds = %land.lhs.true100.i, %for.end97.i
  %50 = load i64, ptr %nplus.i, align 8, !tbaa !45
  %cmp108.i = icmp sgt i64 %50, 0
  %51 = load ptr, ptr %lastpos.i, align 8
  %cmp112.i = icmp eq ptr %51, null
...
if.then114.i:                                     ; preds = %if.else107.i
  %add116.i = shl i64 %50, 3
  %mul117.i = add i64 %add116.i, 8
  %call118.i = call ptr @cli_malloc(i64 noundef %mul117.i) #14
...
if.end120.i:                                      ; preds = %if.then114.i, %if.else107.i
  %52 = phi ptr [ %call118.i, %if.then114.i ], [ %51, %if.else107.i ]
  %53 = phi i64 [ %.pre408.i, %if.then114.i ], [ %50, %if.else107.i ]
  %cmp122.i = icmp sgt i64 %53, 0
  %cmp126.i = icmp eq ptr %52, null
...
if.then128.i:                                     ; preds = %if.end120.i
  %54 = load ptr, ptr %pmatch37.i, align 8, !tbaa !31
  call void @free(ptr noundef %54) #14
  br label %smatcher.exit

if.end130.i:                                      ; preds = %if.end120.i
  %55 = load ptr, ptr %coldp132.i.i, align 8, !tbaa !41
  %call132.i = call fastcc ptr @sbackref(ptr noundef nonnull %mv.i, ptr noundef %55, ptr noundef nonnull %call55.lcssa.i, i64 noundef %add.i, i64 noundef %6, i64 noundef 0, i32 noundef 0)
  br label %if.end133.i
...
lor.lhs.false.i:                                  ; preds = %if.end133.i, %if.end152.i
  ...
  %56 = load ptr, ptr %coldp132.i.i, align 8, !tbaa !41
  %cmp142.not.i = icmp ugt ptr %endp.0396.i, %56
...
if.end145.i:                                      ; preds = %lor.lhs.false.i
  ...
  %call148.i = call fastcc ptr @sslow(ptr noundef nonnull %mv.i, ptr noundef %56, ptr noundef nonnull %add.ptr147.i, i64 noundef %add.i, i64 noundef %6)
  %cmp149.i = icmp eq ptr %call148.i, null
  br i1 %cmp149.i, label %if.end159.i, label %if.end152.i

if.end152.i:                                      ; preds = %if.end145.i
  %call154.i = call fastcc ptr @sbackref(ptr noundef nonnull %mv.i, ptr noundef %56, ptr noundef nonnull %call148.i, i64 noundef %add.i, i64 noundef %6, i64 noundef 0, i32 noundef 0)
...
if.end159.i:                                      ; preds = %if.end145.i, %lor.lhs.false.i
  ...
  %cmp161.i = icmp eq ptr %56, %stop.0.i
  %add.ptr166.i = getelementptr inbounds i8, ptr %56, i64 1
...
if.end184.i:                                      ; preds = %for.end167.i
  ...
  %57 = load ptr, ptr %offp.i, align 8, !tbaa !33
  %sub.ptr.lhs.cast173.i = ptrtoint ptr %.pre409.i to i64
  %sub.ptr.rhs.cast174.i = ptrtoint ptr %57 to i64
...
for.body191.lr.ph.i:                              ; preds = %if.end184.i
  %58 = load ptr, ptr %mv.i, align 8, !tbaa !28
  %nsub193.i = getelementptr inbounds %struct.re_guts, ptr %58, i64 0, i32 17
  %59 = load ptr, ptr %pmatch37.i, align 8
  %60 = add i64 %spec.select.i, -1
  %xtraiter212 = and i64 %60, 1
  %61 = icmp eq i64 %spec.select.i, 2
  br i1 %61, label %if.end209.i.loopexit.unr-lcssa, label %for.body191.lr.ph.i.new

for.body191.lr.ph.i.new:                          ; preds = %for.body191.lr.ph.i
  %unroll_iter214 = and i64 %60, -2
...
for.body191.i:                                    ; preds = %for.inc206.i.1, %for.body191.lr.ph.i.new
  ...
  %niter215 = phi i64 [ 0, %for.body191.lr.ph.i.new ], [ %niter215.next.1, %for.inc206.i.1 ]
  %62 = load i64, ptr %nsub193.i, align 8, !tbaa !43
  %cmp194.not.i = icmp ugt i64 %i.1398.i, %62
...
if.then196.i:                                     ; preds = %for.body191.i
  %arrayidx199.i = getelementptr inbounds %struct.regmatch_t, ptr %59, i64 %i.1398.i
...
for.inc206.i:                                     ; preds = %if.else200.i, %if.then196.i
  ...
  %63 = load i64, ptr %nsub193.i, align 8, !tbaa !43
  %cmp194.not.i.1.not = icmp ult i64 %i.1398.i, %63
...
if.then196.i.1:                                   ; preds = %for.inc206.i
  %arrayidx199.i.1 = getelementptr inbounds %struct.regmatch_t, ptr %59, i64 %inc207.i
...
for.inc206.i.1:                                   ; preds = %if.else200.i.1, %if.then196.i.1
  ...
  br i1 %niter215.ncmp.1, label %if.end209.i.loopexit.unr-lcssa, label %for.body191.i, !llvm.loop !47
...
if.end209.i.loopexit.unr-lcssa:                   ; preds = %for.inc206.i.1, %for.body191.lr.ph.i
  ...
  br i1 %lcmp.mod213.not, label %if.end209.i, label %for.body191.i.epil

for.body191.i.epil:                               ; preds = %if.end209.i.loopexit.unr-lcssa
  %64 = load i64, ptr %nsub193.i, align 8, !tbaa !43
  %cmp194.not.i.epil = icmp ugt i64 %i.1398.i.unr, %64
...
if.then196.i.epil:                                ; preds = %for.body191.i.epil
  %arrayidx199.i.epil = getelementptr inbounds %struct.regmatch_t, ptr %59, i64 %i.1398.i.unr
...
if.end209.i:                                      ; preds = %land.lhs.true50.i, %if.end209.i.loopexit.unr-lcssa, %if.else200.i.epil, %if.then196.i.epil, %if.end184.i, %for.end167.i, %if.end184.thread.i
  %65 = load ptr, ptr %pmatch37.i, align 8, !tbaa !31
  %cmp211.not.i = icmp eq ptr %65, null
...
if.end215.i:                                      ; preds = %if.then213.i, %if.end209.i
  %66 = load ptr, ptr %lastpos.i, align 8, !tbaa !32
  %cmp217.not.i = icmp eq ptr %66, null
...
smatcher.exit:                                    ; preds = %if.end78.i, %if.end7.i, %for.end.i, %if.then44.i, %if.then128.i, %if.end215.i, %if.then219.i
  ...
  call void @llvm.lifetime.end.p0(i64 104, ptr nonnull %mv.i) #14
  br label %cleanup

if.else:                                          ; preds = %if.end3
  call void @llvm.lifetime.start.p0(i64 112, ptr nonnull %mv.i21) #14
  %67 = load i64, ptr %firststate.i, align 8, !tbaa !17
  %add.i23 = add nsw i64 %67, 1
  %laststate.i24 = getelementptr inbounds %struct.re_guts, ptr %0, i64 0, i32 9
  %68 = load i64, ptr %laststate.i24, align 8, !tbaa !18
  %cflags.i25 = getelementptr inbounds %struct.re_guts, ptr %0, i64 0, i32 6
  %69 = load i32, ptr %cflags.i25, align 8, !tbaa !19
  %and.i26 = and i32 %69, 4
...
if.then3.i33:                                     ; preds = %if.else
  %70 = load i64, ptr %pmatch, align 8, !tbaa !20
  %add.ptr.i31 = getelementptr inbounds i8, ptr %string, i64 %70
  %rm_eo.i32 = getelementptr inbounds %struct.regmatch_t, ptr %pmatch, i64 0, i32 1
  %71 = load i64, ptr %rm_eo.i32, align 8, !tbaa !22
  br label %if.end7.i40

if.else.i35:                                      ; preds = %if.else
  %call.i34 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %string) #15
  br label %if.end7.i40

if.end7.i40:                                      ; preds = %if.else.i35, %if.then3.i33
  %start.0.i36 = phi ptr [ %add.ptr.i31, %if.then3.i33 ], [ %string, %if.else.i35 ]
  %.pn.i37 = phi i64 [ %71, %if.then3.i33 ], [ %call.i34, %if.else.i35 ]
...
if.end9.i43:                                      ; preds = %if.end7.i40
  ...
  %72 = load ptr, ptr %must.i41, align 8, !tbaa !23
  %cmp10.not.i42 = icmp eq ptr %72, null
...
for.body.i49:                                     ; preds = %for.inc.i60, %for.body.lr.ph.i47
  ...
  %74 = load i8, ptr %dp.0452.i, align 1, !tbaa !24
  %cmp16.i48 = icmp eq i8 %74, %73
...
land.lhs.true.i54:                                ; preds = %for.body.i49
  ...
  %75 = load i32, ptr %mlen.i46, align 8, !tbaa !25
  %conv18.i52 = sext i32 %75 to i64
...
land.lhs.true21.i57:                              ; preds = %land.lhs.true.i54
  %bcmp.i55 = tail call i32 @bcmp(ptr nonnull %dp.0452.i, ptr nonnull %72, i64 %conv18.i52)
...
if.end34.i71:                                     ; preds = %for.end.i63, %if.end9.i43
  ...
  %call40.i = tail call ptr @cli_malloc(i64 noundef %mul.i70) #14
...
if.end45.i:                                       ; preds = %if.end34.i71
  ...
  %76 = load i64, ptr %nstates, align 8, !tbaa !16
  %arrayidx58.i = getelementptr inbounds i8, ptr %call40.i, i64 %76
  %fresh.i = getelementptr inbounds %struct.lmat, ptr %mv.i21, i64 0, i32 11
  store ptr %arrayidx58.i, ptr %fresh.i, align 8, !tbaa !59
  %mul64.i = shl nsw i64 %76, 1
  ...
  tail call void @llvm.memset.p0.i64(ptr nonnull align 1 %arrayidx72.i, i8 0, i64 %76, i1 false)
...
for.cond76.i:                                     ; preds = %if.end200.i, %if.end45.i
  ...
  %77 = load ptr, ptr %st.i72, align 8, !tbaa !58
  %78 = load ptr, ptr %fresh.i, align 8, !tbaa !59
  %79 = load ptr, ptr %tmp.i, align 8, !tbaa !60
  %80 = load ptr, ptr %beginp.i68, align 8, !tbaa !55
  %cmp.i.i76 = icmp eq ptr %80, %start.1.i75
...
cond.false.i.i79:                                 ; preds = %for.cond76.i
  ...
  %81 = load i8, ptr %add.ptr.i.i77, align 1, !tbaa !24
  %conv.i.i78 = sext i8 %81 to i32
...
cond.end.i.i83:                                   ; preds = %cond.false.i.i79, %for.cond76.i
  ...
  %82 = load ptr, ptr %mv.i21, align 8, !tbaa !49
  %nstates.i.i = getelementptr inbounds %struct.re_guts, ptr %82, i64 0, i32 7
  %83 = load i64, ptr %nstates.i.i, align 8, !tbaa !16
  call void @llvm.memset.p0.i64(ptr align 1 %77, i8 0, i64 %83, i1 false)
  %arrayidx.i.i81 = getelementptr inbounds i8, ptr %77, i64 %add.i23
  store i8 1, ptr %arrayidx.i.i81, align 1, !tbaa !24
  %84 = load ptr, ptr %mv.i21, align 8, !tbaa !49
  %call.i.i82 = call fastcc ptr @lstep(ptr noundef %84, i64 noundef %add.i23, i64 noundef %68, ptr noundef %77, i32 noundef 132, ptr noundef %77)
  %85 = load ptr, ptr %mv.i21, align 8, !tbaa !49
  %nstates6.i.i = getelementptr inbounds %struct.re_guts, ptr %85, i64 0, i32 7
  %86 = load i64, ptr %nstates6.i.i, align 8, !tbaa !16
  call void @llvm.memmove.p0.p0.i64(ptr align 1 %78, ptr align 1 %77, i64 %86, i1 false)
  %arrayidx127.i.i = getelementptr inbounds i8, ptr %77, i64 %68
...
for.cond.i.i87:                                   ; preds = %if.end134.i.i, %cond.end.i.i83
  ...
  %87 = load ptr, ptr %endp38.i69, align 8, !tbaa !56
  %cmp7.i.i = icmp eq ptr %p.0.i.i84, %87
  br i1 %cmp7.i.i, label %cond.end12.i.i, label %cond.false10.i.i

cond.false10.i.i:                                 ; preds = %for.cond.i.i87
  %88 = load i8, ptr %p.0.i.i84, align 1, !tbaa !24
  %conv11.i.i = sext i8 %88 to i32
...
cond.end12.i.i:                                   ; preds = %cond.false10.i.i, %for.cond.i.i87
  ...
  %89 = load ptr, ptr %mv.i21, align 8, !tbaa !49
  %nstates15.i.i = getelementptr inbounds %struct.re_guts, ptr %89, i64 0, i32 7
  %90 = load i64, ptr %nstates15.i.i, align 8, !tbaa !16
  %bcmp.i.i = call i32 @bcmp(ptr nonnull %77, ptr %78, i64 %90)
...
land.lhs.true.i.i92:                              ; preds = %cond.end12.i.i
  %cflags.i.i89 = getelementptr inbounds %struct.re_guts, ptr %89, i64 0, i32 6
  %91 = load i32, ptr %cflags.i.i89, align 8, !tbaa !19
  %and.i.i90 = and i32 %91, 8
...
land.lhs.true24.i.i:                              ; preds = %cond.end12.i.i
  %92 = load i32, ptr %eflags36.i64, align 8, !tbaa !51
  %and25.i.i = and i32 %92, 1
...
if.then27.i.i:                                    ; preds = %land.lhs.true24.i.i, %land.lhs.true.i.i92
  %nbol.i.i93 = getelementptr inbounds %struct.re_guts, ptr %89, i64 0, i32 11
  %93 = load i32, ptr %nbol.i.i93, align 4, !tbaa !36
...
if.end29.i.i:                                     ; preds = %if.then27.i.i, %land.lhs.true24.i.i, %land.lhs.true.i.i92, %cond.end12.i.i
  ...
  %i.0.i.i95 = phi i32 [ %93, %if.then27.i.i ], [ 0, %land.lhs.true24.i.i ], [ 0, %cond.end12.i.i ], [ 0, %land.lhs.true.i.i92 ]
...
land.lhs.true32.i.i:                              ; preds = %if.end29.i.i
  %cflags34.i.i = getelementptr inbounds %struct.re_guts, ptr %89, i64 0, i32 6
  %94 = load i32, ptr %cflags34.i.i, align 8, !tbaa !19
  %and35.i.i = and i32 %94, 8
...
land.lhs.true40.i.i:                              ; preds = %if.end29.i.i
  %95 = load i32, ptr %eflags36.i64, align 8, !tbaa !51
  %and42.i.i = and i32 %95, 2
...
if.then44.i.i:                                    ; preds = %land.lhs.true40.i.i, %land.lhs.true32.i.i
  %neol.i.i96 = getelementptr inbounds %struct.re_guts, ptr %89, i64 0, i32 12
  %96 = load i32, ptr %neol.i.i96, align 8, !tbaa !37
  %add.i.i97 = add nsw i32 %96, %i.0.i.i95
...
for.body.i.i102:                                  ; preds = %if.end49.i.i, %for.body.i.i102
  ...
  %97 = load ptr, ptr %mv.i21, align 8, !tbaa !49
  %call57.i.i = call fastcc ptr @lstep(ptr noundef %97, i64 noundef %add.i23, i64 noundef %68, ptr noundef %77, i32 noundef %flagch.1.i.i98, ptr noundef %77)
...
land.lhs.true64.i.i:                              ; preds = %lor.lhs.false61.i.i
  %call65.i.i = tail call ptr @__ctype_b_loc() #16
  %98 = load ptr, ptr %call65.i.i, align 8, !tbaa !38
  %idxprom.i.i103 = sext i32 %c.0.i.i85 to i64
  %arrayidx66.i.i = getelementptr inbounds i16, ptr %98, i64 %idxprom.i.i103
  %99 = load i16, ptr %arrayidx66.i.i, align 2, !tbaa !39
  %100 = and i16 %99, 8
  %tobool69.i.i = icmp eq i16 %100, 0
...
land.lhs.true73.land.lhs.true76_crit_edge.i.i:    ; preds = %land.lhs.true73.i.i
  %.pre258.i.i = tail call ptr @__ctype_b_loc() #16
...
land.lhs.true76.i.i:                              ; preds = %land.lhs.true73.land.lhs.true76_crit_edge.i.i, %land.lhs.true64.i.i
  %101 = phi ptr [ %.pre.i105, %land.lhs.true73.land.lhs.true76_crit_edge.i.i ], [ %98, %land.lhs.true64.i.i ]
  %idxprom78.i.i = sext i32 %cond13.i.i to i64
  %arrayidx79.i.i = getelementptr inbounds i16, ptr %101, i64 %idxprom78.i.i
  %102 = load i16, ptr %arrayidx79.i.i, align 2, !tbaa !39
  %103 = and i16 %102, 8
  %tobool82.i.i = icmp ne i16 %103, 0
...
if.end87.land.lhs.true90_crit_edge.i.i:           ; preds = %if.end87.i.i
  %.pre.i.i107 = tail call ptr @__ctype_b_loc() #16
...
land.lhs.true90.i.i:                              ; preds = %if.end87.land.lhs.true90_crit_edge.i.i, %land.lhs.true64.i.i
  %.pre-phi.i108 = phi i16 [ %.pre473.i, %if.end87.land.lhs.true90_crit_edge.i.i ], [ %100, %land.lhs.true64.i.i ]
  %104 = phi ptr [ %.pre469.i, %if.end87.land.lhs.true90_crit_edge.i.i ], [ %98, %land.lhs.true64.i.i ]
...
land.lhs.true106.i.i:                             ; preds = %lor.lhs.false103.i.i
  ...
  %arrayidx109.i.i = getelementptr inbounds i16, ptr %104, i64 %idxprom108.i.i
  %105 = load i16, ptr %arrayidx109.i.i, align 2, !tbaa !39
  %106 = and i16 %105, 8
  %tobool112.i.i = icmp ne i16 %106, 0
...
if.end117.i.i:                                    ; preds = %land.lhs.true106.i.i, %lor.lhs.false103.i.i, %land.lhs.true90.i.i, %if.end87.i.i, %lor.lhs.false61.i.i
  ...
  %107 = add i32 %flagch.3.i.i109, -133
  %or.cond163.i.i = icmp ult i32 %107, 2
...
if.then123.i.i:                                   ; preds = %if.end117.i.i, %land.lhs.true106.i.i, %land.lhs.true100.i.i
  ...
  %108 = load ptr, ptr %mv.i21, align 8, !tbaa !49
  %call125.i.i = call fastcc ptr @lstep(ptr noundef %108, i64 noundef %add.i23, i64 noundef %68, ptr noundef %77, i32 noundef %flagch.3256.i.i, ptr noundef %77)
  br label %if.end126.i.i

if.end126.i.i:                                    ; preds = %if.then123.i.i, %if.end117.i.i
  %109 = load i8, ptr %arrayidx127.i.i, align 1, !tbaa !24
  %tobool129.not.i.i = icmp ne i8 %109, 0
...
if.end134.i.i:                                    ; preds = %if.end126.i.i
  ...
  %nstates136.i.i = getelementptr inbounds %struct.re_guts, ptr %110, i64 0, i32 7
  %111 = load i64, ptr %nstates136.i.i, align 8, !tbaa !16
  call void @llvm.memmove.p0.p0.i64(ptr align 1 %79, ptr nonnull align 1 %77, i64 %111, i1 false)
  %112 = load ptr, ptr %mv.i21, align 8, !tbaa !49
  %nstates138.i.i = getelementptr inbounds %struct.re_guts, ptr %112, i64 0, i32 7
  %113 = load i64, ptr %nstates138.i.i, align 8, !tbaa !16
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 1 %77, ptr align 1 %78, i64 %113, i1 false)
  %114 = load ptr, ptr %mv.i21, align 8, !tbaa !49
  %call140.i.i = call fastcc ptr @lstep(ptr noundef %114, i64 noundef %add.i23, i64 noundef %68, ptr noundef %79, i32 noundef %cond13.i.i, ptr noundef nonnull %77)
...
lfast.exit.i:                                     ; preds = %if.end126.i.i
  ...
  %115 = load i8, ptr %arrayidx127.i.i, align 1, !tbaa !24
  %tobool144.not.i.i = icmp eq i8 %115, 0
  br i1 %tobool144.not.i.i, label %if.then80.i, label %if.end84.i

if.then80.i:                                      ; preds = %lfast.exit.i
  %116 = load ptr, ptr %pmatch37.i65, align 8, !tbaa !52
  call void @free(ptr noundef %116) #14
  %117 = load ptr, ptr %lastpos.i66, align 8, !tbaa !53
...
land.lhs.true87.i:                                ; preds = %if.end84.i
  %118 = load i32, ptr %backrefs.i73, align 8, !tbaa !42
  %tobool88.not.i = icmp eq i32 %118, 0
  br i1 %tobool88.not.i, label %if.end250.i, label %if.end90.i

if.end90.i:                                       ; preds = %land.lhs.true87.i, %if.end84.i
  %call92454.i = call fastcc ptr @lslow(ptr noundef nonnull %mv.i21, ptr noundef %spec.select.i.i88, ptr noundef %stop.0.i38, i64 noundef %add.i23, i64 noundef %68)
...
if.end96.i:                                       ; preds = %if.end90.i, %if.end96.i
  %119 = load ptr, ptr %coldp142.i.i, align 8, !tbaa !63
  %incdec.ptr98.i = getelementptr inbounds i8, ptr %119, i64 1
  store ptr %incdec.ptr98.i, ptr %coldp142.i.i, align 8, !tbaa !63
  %call92.i = call fastcc ptr @lslow(ptr noundef nonnull %mv.i21, ptr noundef nonnull %incdec.ptr98.i, ptr noundef %stop.0.i38, i64 noundef %add.i23, i64 noundef %68)
...
land.lhs.true102.i:                               ; preds = %for.end99.i
  ...
  %tobool104.not.i = icmp eq i32 %120, 0
  br i1 %tobool104.not.i, label %if.end225.i, label %if.end106.i

if.end106.i:                                      ; preds = %land.lhs.true102.i, %for.end99.i
  %121 = load ptr, ptr %pmatch37.i65, align 8, !tbaa !52
  %cmp108.i112 = icmp eq ptr %121, null
  br i1 %cmp108.i112, label %if.end116.i, label %for.cond123.preheader.i

if.end116.i:                                      ; preds = %if.end106.i
  %122 = load ptr, ptr %mv.i21, align 8, !tbaa !49
  %nsub.i113 = getelementptr inbounds %struct.re_guts, ptr %122, i64 0, i32 17
  %123 = load i64, ptr %nsub.i113, align 8, !tbaa !43
  %add112.i = shl i64 %123, 4
  %mul113.i = add i64 %add112.i, 16
  %call114.i = call ptr @cli_malloc(i64 noundef %mul113.i) #14
...
for.cond123.preheader.i:                          ; preds = %if.end116.i, %if.end106.i
  %124 = phi ptr [ %call114.i, %if.end116.i ], [ %121, %if.end106.i ]
  %125 = load ptr, ptr %mv.i21, align 8, !tbaa !49
  %nsub125.i = getelementptr inbounds %struct.re_guts, ptr %125, i64 0, i32 17
  %126 = load i64, ptr %nsub125.i, align 8, !tbaa !43
  %cmp126.not457.i = icmp eq i64 %126, 0
...
for.body128.preheader.i:                          ; preds = %for.cond123.preheader.i
  %uglygep.i114 = getelementptr i8, ptr %124, i64 16
  %127 = shl nuw i64 %126, 4
  call void @llvm.memset.p0.i64(ptr align 8 %uglygep.i114, i8 -1, i64 %127, i1 false), !tbaa !44
  br label %for.end137.i

for.end137.i:                                     ; preds = %for.body128.preheader.i, %for.cond123.preheader.i
  %128 = load i32, ptr %backrefs.i73, align 8, !tbaa !42
  %tobool139.not.i = icmp eq i32 %128, 0
  br i1 %tobool139.not.i, label %land.lhs.true140.i, label %if.else147.i

land.lhs.true140.i:                               ; preds = %for.end137.i
  %129 = load i32, ptr %eflags36.i64, align 8, !tbaa !51
  %and142.i = and i32 %129, 1024
...
if.then144.i:                                     ; preds = %land.lhs.true140.i
  %130 = load ptr, ptr %coldp142.i.i, align 8, !tbaa !63
  %call146.i = call fastcc ptr @ldissect(ptr noundef nonnull %mv.i21, ptr noundef %130, ptr noundef nonnull %call92.lcssa.i, i64 noundef %add.i23, i64 noundef %68)
  br label %if.end174.i

if.else147.i:                                     ; preds = %land.lhs.true140.i, %for.end137.i
  %131 = load i64, ptr %nplus.i74, align 8, !tbaa !45
  %cmp148.i = icmp sgt i64 %131, 0
  %132 = load ptr, ptr %lastpos.i66, align 8
  %cmp152.i = icmp eq ptr %132, null
  %or.cond.i115 = select i1 %cmp148.i, i1 %cmp152.i, i1 false
  br i1 %or.cond.i115, label %if.then154.i, label %if.end160.i

if.then154.i:                                     ; preds = %if.else147.i
  %add156.i = shl i64 %131, 3
  %mul157.i = add i64 %add156.i, 8
  %call158.i = call ptr @cli_malloc(i64 noundef %mul157.i) #14
...
if.end160.i:                                      ; preds = %if.then154.i, %if.else147.i
  %133 = phi ptr [ %call158.i, %if.then154.i ], [ %132, %if.else147.i ]
  %134 = phi i64 [ %.pre471.i, %if.then154.i ], [ %131, %if.else147.i ]
  %cmp162.i = icmp sgt i64 %134, 0
  %cmp166.i = icmp eq ptr %133, null
...
if.then168.i:                                     ; preds = %if.end160.i
  %135 = load ptr, ptr %pmatch37.i65, align 8, !tbaa !52
  call void @free(ptr noundef %135) #14
  br label %cleanup.sink.split.i

if.end171.i:                                      ; preds = %if.end160.i
  %136 = load ptr, ptr %coldp142.i.i, align 8, !tbaa !63
  %call173.i = call fastcc ptr @lbackref(ptr noundef nonnull %mv.i21, ptr noundef %136, ptr noundef nonnull %call92.lcssa.i, i64 noundef %add.i23, i64 noundef %68, i64 noundef 0, i32 noundef 0)
  br label %if.end174.i

if.end174.i:                                      ; preds = %if.end171.i, %if.then144.i
  %dp.1.i116 = phi ptr [ %call173.i, %if.end171.i ], [ %call146.i, %if.then144.i ]
  %cmp175.not.i = icmp eq ptr %dp.1.i116, null
  br i1 %cmp175.not.i, label %lor.lhs.false.i117, label %for.end208.i

lor.lhs.false.i117:                               ; preds = %if.end174.i, %if.end193.i
  %endp.0459.i = phi ptr [ %call189.i, %if.end193.i ], [ %call92.lcssa.i, %if.end174.i ]
  %137 = load ptr, ptr %coldp142.i.i, align 8, !tbaa !63
  %cmp183.not.i = icmp ugt ptr %endp.0459.i, %137
  br i1 %cmp183.not.i, label %if.end186.i, label %if.end200.i

if.end186.i:                                      ; preds = %lor.lhs.false.i117
  %add.ptr188.i = getelementptr inbounds i8, ptr %endp.0459.i, i64 -1
  %call189.i = call fastcc ptr @lslow(ptr noundef nonnull %mv.i21, ptr noundef %137, ptr noundef nonnull %add.ptr188.i, i64 noundef %add.i23, i64 noundef %68)
...
if.end193.i:                                      ; preds = %if.end186.i
  %call195.i = call fastcc ptr @lbackref(ptr noundef nonnull %mv.i21, ptr noundef %.pre472.i, ptr noundef nonnull %call189.i, i64 noundef %add.i23, i64 noundef %68, i64 noundef 0, i32 noundef 0)
  %cmp180.not.i = icmp eq ptr %call195.i, null
  br i1 %cmp180.not.i, label %lor.lhs.false.i117, label %for.end208.i

if.end200.i:                                      ; preds = %if.end186.i, %lor.lhs.false.i117
  %138 = phi ptr [ %.pre472.i, %if.end186.i ], [ %137, %lor.lhs.false.i117 ]
  %endp.1.ph.i118 = phi ptr [ null, %if.end186.i ], [ %endp.0459.i, %lor.lhs.false.i117 ]
  %cmp202.i = icmp eq ptr %138, %stop.0.i38
  %add.ptr207.i = getelementptr inbounds i8, ptr %138, i64 1
  br i1 %cmp202.i, label %for.end208.i, label %for.cond76.i

for.end208.i:                                     ; preds = %if.end200.i, %if.end174.i, %if.end193.i
  %endp.2.i119 = phi ptr [ %call189.i, %if.end193.i ], [ %call92.lcssa.i, %if.end174.i ], [ %endp.1.ph.i118, %if.end200.i ]
  br i1 %cmp85.i, label %if.end250.i, label %if.end225.i

if.end225.i:                                      ; preds = %land.lhs.true102.i, %for.end208.i
  %endp.2428.i = phi ptr [ %endp.2.i119, %for.end208.i ], [ %call92.lcssa.i, %land.lhs.true102.i ]
  %139 = load ptr, ptr %coldp142.i.i, align 8, !tbaa !63
  %140 = load ptr, ptr %offp.i67, align 8, !tbaa !54
  %sub.ptr.lhs.cast214.i = ptrtoint ptr %139 to i64
  %sub.ptr.rhs.cast215.i = ptrtoint ptr %140 to i64
...
for.body232.lr.ph.i:                              ; preds = %if.end225.i
  %141 = load ptr, ptr %mv.i21, align 8, !tbaa !49
  %nsub234.i = getelementptr inbounds %struct.re_guts, ptr %141, i64 0, i32 17
  %142 = load ptr, ptr %pmatch37.i65, align 8
  %143 = add i64 %spec.select.i28, -1
  %xtraiter = and i64 %143, 1
  %144 = icmp eq i64 %spec.select.i28, 2
  br i1 %144, label %if.end250.i.loopexit.unr-lcssa, label %for.body232.lr.ph.i.new

for.body232.lr.ph.i.new:                          ; preds = %for.body232.lr.ph.i
  %unroll_iter = and i64 %143, -2
...
for.body232.i:                                    ; preds = %for.inc247.i.1, %for.body232.lr.ph.i.new
  ...
  %145 = load i64, ptr %nsub234.i, align 8, !tbaa !43
  %cmp235.not.i = icmp ugt i64 %i.1461.i, %145
...
if.then237.i:                                     ; preds = %for.body232.i
  %arrayidx240.i = getelementptr inbounds %struct.regmatch_t, ptr %142, i64 %i.1461.i
...
for.inc247.i:                                     ; preds = %if.else241.i, %if.then237.i
  ...
  %146 = load i64, ptr %nsub234.i, align 8, !tbaa !43
  %cmp235.not.i.1.not = icmp ult i64 %i.1461.i, %146
...
if.then237.i.1:                                   ; preds = %for.inc247.i
  %arrayidx240.i.1 = getelementptr inbounds %struct.regmatch_t, ptr %142, i64 %inc248.i
...
for.body232.i.epil:                               ; preds = %if.end250.i.loopexit.unr-lcssa
  %147 = load i64, ptr %nsub234.i, align 8, !tbaa !43
  %cmp235.not.i.epil = icmp ugt i64 %i.1461.i.unr, %147
...
if.then237.i.epil:                                ; preds = %for.body232.i.epil
  %arrayidx240.i.epil = getelementptr inbounds %struct.regmatch_t, ptr %142, i64 %i.1461.i.unr
...
if.end250.i:                                      ; preds = %land.lhs.true87.i, %if.end250.i.loopexit.unr-lcssa, %if.else241.i.epil, %if.then237.i.epil, %if.end225.i, %for.end208.i
  %148 = load ptr, ptr %pmatch37.i65, align 8, !tbaa !52
  %cmp252.not.i = icmp eq ptr %148, null
...
if.end256.i:                                      ; preds = %if.then254.i, %if.end250.i
  %149 = load ptr, ptr %lastpos.i66, align 8, !tbaa !53
  %cmp258.not.i = icmp eq ptr %149, null
...
cleanup.sink.split.i:                             ; preds = %if.end116.i, %if.then260.i, %if.end256.i, %if.then168.i, %if.then80.i
  ...
  %150 = load ptr, ptr %space.i, align 8, !tbaa !57
...
lmatcher.exit:                                    ; preds = %if.end7.i40, %for.end.i63, %if.end34.i71, %cleanup.sink.split.i
  %retval.0.i121 = phi i32 [ 16, %if.end7.i40 ], [ 1, %for.end.i63 ], [ 12, %if.end34.i71 ], [ %retval.0.ph.i, %cleanup.sink.split.i ]
  call void @llvm.lifetime.end.p0(i64 112, ptr nonnull %mv.i21) #14
  br label %cleanup

cleanup:                                          ; preds = %if.end, %entry, %lor.lhs.false, %lmatcher.exit, %smatcher.exit
  %retval.0 = phi i32 [ %retval.0.i121, %lmatcher.exit ], [ %retval.0.i, %smatcher.exit ], [ 2, %lor.lhs.false ], [ 2, %entry ], [ 2, %if.end ]
  ret i32 %retval.0
}
...
land.lhs.true54:                                  ; preds = %lor.lhs.false51
  %call55 = tail call ptr @__ctype_b_loc() #16
...
land.lhs.true62.land.lhs.true65_crit_edge:        ; preds = %land.lhs.true62
  %.pre221 = tail call ptr @__ctype_b_loc() #16
...
land.lhs.true113:                                 ; preds = %land.lhs.true109
  %call114 = tail call ptr @__ctype_b_loc() #16
...
land.lhs.true153:                                 ; preds = %land.lhs.true144, %land.lhs.true140
  %call154 = tail call ptr @__ctype_b_loc() #16
...
land.lhs.true169:                                 ; preds = %land.lhs.true165
  %call170 = tail call ptr @__ctype_b_loc() #16
...
land.lhs.true55:                                  ; preds = %lor.lhs.false52
  %call56 = tail call ptr @__ctype_b_loc() #16
...
land.lhs.true64.land.lhs.true67_crit_edge:        ; preds = %land.lhs.true64
  %.pre237 = tail call ptr @__ctype_b_loc() #16
...
if.end78.land.lhs.true81_crit_edge:               ; preds = %if.end78
  %.pre235 = tail call ptr @__ctype_b_loc() #16
