; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/jccoefct.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/jccoefct.c"
...
for.body33.us.preheader:                          ; preds = %for.body33.us.preheader.preheader, %for.inc38.loopexit.us
  %indvars.iv195 = phi i64 [ %indvars.iv.next196, %for.inc38.loopexit.us ], [ 0, %for.body33.us.preheader.preheader ]
  ...
  br i1 %15, label %for.inc38.loopexit.us.unr-lcssa, label %for.body33.us

for.body33.us:                                    ; preds = %for.body33.us.preheader, %for.body33.us
  %indvars.iv190 = phi i64 [ %indvars.iv.next191.3, %for.body33.us ], [ 0, %for.body33.us.preheader ]
...
for.inc38.loopexit.us.unr-lcssa:                  ; preds = %for.body33.us, %for.body33.us.preheader
  %indvars.iv190.unr = phi i64 [ 0, %for.body33.us.preheader ], [ %indvars.iv.next191.3, %for.body33.us ]
...
for.body33.us.epil:                               ; preds = %for.inc38.loopexit.us.unr-lcssa, %for.body33.us.epil
  %indvars.iv190.epil = phi i64 [ %indvars.iv.next191.epil, %for.body33.us.epil ], [ %indvars.iv190.unr, %for.inc38.loopexit.us.unr-lcssa ]
...
for.inc38.loopexit.us:                            ; preds = %for.body33.us.epil, %for.inc38.loopexit.us.unr-lcssa
  ...
  br i1 %exitcond200.not, label %for.end40, label %for.body33.us.preheader, !llvm.loop !67
...
for.body19:                                       ; preds = %for.body19.lr.ph, %for.body19
  ...
  tail call void %24(ptr noundef nonnull %cinfo, ptr noundef %compptr.0183, ptr noundef %25, ptr noundef %22, i32 noundef %26, i32 noundef 0, i32 noundef %13) #4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
...
for.end88:                                        ; preds = %for.inc86, %entry
  %call89 = tail call i32 @compress_output(ptr noundef nonnull %cinfo, ptr poison)
  ret i32 %call89
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %33, label %middle.block, label %vector.body, !llvm.loop !75
...
for.cond28.for.inc38_crit_edge.us:                ; preds = %for.body31.us, %middle.block
  ...
  br i1 %exitcond138.not, label %for.inc41, label %for.body23.us, !llvm.loop !79
...
for.inc41:                                        ; preds = %for.cond28.for.inc38_crit_edge.us, %for.body23.lr.ph, %for.body16
  ...
  br i1 %exitcond143.not, label %for.end43, label %for.body16, !llvm.loop !80
...
for.inc48:                                        ; preds = %for.end43
  ...
  br i1 %cmp11, label %for.cond13.preheader, label %for.end50.loopexit, !llvm.loop !81
...
for.end50:                                        ; preds = %for.end50.loopexit, %for.body9
  ...
  br i1 %cmp8, label %for.body9, label %for.end54.loopexit, !llvm.loop !82
