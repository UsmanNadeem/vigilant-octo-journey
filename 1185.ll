; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Benchmarks/McGill/chomp.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Benchmarks/McGill/chomp.c"
...
while.body.preheader:                             ; preds = %entry
  ...
  %4 = sub nsw i64 %2, %3
  %5 = shl nsw i64 %4, 2
  %uglygep = getelementptr i8, ptr %call, i64 %5
  %uglygep8 = getelementptr i8, ptr %data, i64 %5
  %6 = zext i32 %0 to i64
  %7 = shl nuw nsw i64 %6, 2
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 4 %uglygep, ptr align 4 %uglygep8, i64 %7, i1 false), !tbaa !5
  br label %while.end
...
vector.memcheck:                                  ; preds = %while.body.preheader
  ...
  %7 = shl nuw nsw i64 %6, 2
  %8 = sub nsw i64 %4, %7
  %uglygep = getelementptr i8, ptr %data1, i64 %8
  %uglygep17 = getelementptr i8, ptr %data1, i64 %3
  %uglygep18 = getelementptr i8, ptr %data2, i64 %8
  %uglygep19 = getelementptr i8, ptr %data2, i64 %3
  %bound0 = icmp ult ptr %uglygep, %uglygep19
  %bound1 = icmp ult ptr %uglygep18, %uglygep17
...
vector.body:                                      ; preds = %pred.store.continue39, %vector.ph
  ...
  %wide.load20 = load <4 x i32>, ptr %13, align 4, !tbaa !5, !alias.scope !11, !noalias !14
  %14 = getelementptr inbounds i32, ptr %data2, i64 %9
  %15 = getelementptr inbounds i32, ptr %14, i64 -3
  %wide.load22 = load <4 x i32>, ptr %15, align 4, !tbaa !5, !alias.scope !14
  %16 = getelementptr inbounds i32, ptr %14, i64 -4
  %17 = getelementptr inbounds i32, ptr %16, i64 -3
  %wide.load24 = load <4 x i32>, ptr %17, align 4, !tbaa !5, !alias.scope !14
  %18 = icmp sgt <4 x i32> %wide.load, %wide.load22
  %19 = icmp sgt <4 x i32> %wide.load20, %wide.load24
  %20 = extractelement <4 x i1> %18, i64 3
  br i1 %20, label %pred.store.if, label %pred.store.continue

pred.store.if:                                    ; preds = %vector.body
  %21 = add nsw i64 %offset.idx, -1
  %22 = getelementptr inbounds i32, ptr %data1, i64 %21
  %23 = extractelement <4 x i32> %wide.load22, i64 3
  store i32 %23, ptr %22, align 4, !tbaa !5, !alias.scope !11, !noalias !14
  br label %pred.store.continue

pred.store.continue:                              ; preds = %pred.store.if, %vector.body
  %24 = extractelement <4 x i1> %18, i64 2
  br i1 %24, label %pred.store.if26, label %pred.store.continue27

pred.store.if26:                                  ; preds = %pred.store.continue
  %25 = add i64 %offset.idx, -2
  %26 = getelementptr inbounds i32, ptr %data1, i64 %25
  %27 = extractelement <4 x i32> %wide.load22, i64 2
  store i32 %27, ptr %26, align 4, !tbaa !5, !alias.scope !11, !noalias !14
  br label %pred.store.continue27

pred.store.continue27:                            ; preds = %pred.store.if26, %pred.store.continue
  %28 = extractelement <4 x i1> %18, i64 1
  br i1 %28, label %pred.store.if28, label %pred.store.continue29

pred.store.if28:                                  ; preds = %pred.store.continue27
  %29 = add i64 %offset.idx, -3
  %30 = getelementptr inbounds i32, ptr %data1, i64 %29
  %31 = extractelement <4 x i32> %wide.load22, i64 1
  store i32 %31, ptr %30, align 4, !tbaa !5, !alias.scope !11, !noalias !14
  br label %pred.store.continue29

pred.store.continue29:                            ; preds = %pred.store.if28, %pred.store.continue27
  %32 = extractelement <4 x i1> %18, i64 0
  br i1 %32, label %pred.store.if30, label %pred.store.continue31

pred.store.if30:                                  ; preds = %pred.store.continue29
  %33 = add i64 %offset.idx, -4
  %34 = getelementptr inbounds i32, ptr %data1, i64 %33
  %35 = extractelement <4 x i32> %wide.load22, i64 0
  store i32 %35, ptr %34, align 4, !tbaa !5, !alias.scope !11, !noalias !14
  br label %pred.store.continue31

pred.store.continue31:                            ; preds = %pred.store.if30, %pred.store.continue29
  %36 = extractelement <4 x i1> %19, i64 3
  br i1 %36, label %pred.store.if32, label %pred.store.continue33

pred.store.if32:                                  ; preds = %pred.store.continue31
  %37 = add i64 %offset.idx, -5
  %38 = getelementptr inbounds i32, ptr %data1, i64 %37
  %39 = extractelement <4 x i32> %wide.load24, i64 3
  store i32 %39, ptr %38, align 4, !tbaa !5, !alias.scope !11, !noalias !14
  br label %pred.store.continue33

pred.store.continue33:                            ; preds = %pred.store.if32, %pred.store.continue31
  %40 = extractelement <4 x i1> %19, i64 2
  br i1 %40, label %pred.store.if34, label %pred.store.continue35

pred.store.if34:                                  ; preds = %pred.store.continue33
  %41 = add i64 %offset.idx, -6
  %42 = getelementptr inbounds i32, ptr %data1, i64 %41
  %43 = extractelement <4 x i32> %wide.load24, i64 2
  store i32 %43, ptr %42, align 4, !tbaa !5, !alias.scope !11, !noalias !14
  br label %pred.store.continue35

pred.store.continue35:                            ; preds = %pred.store.if34, %pred.store.continue33
  %44 = extractelement <4 x i1> %19, i64 1
  br i1 %44, label %pred.store.if36, label %pred.store.continue37

pred.store.if36:                                  ; preds = %pred.store.continue35
  %45 = add i64 %offset.idx, -7
  %46 = getelementptr inbounds i32, ptr %data1, i64 %45
  %47 = extractelement <4 x i32> %wide.load24, i64 1
  store i32 %47, ptr %46, align 4, !tbaa !5, !alias.scope !11, !noalias !14
  br label %pred.store.continue37

pred.store.continue37:                            ; preds = %pred.store.if36, %pred.store.continue35
  %48 = extractelement <4 x i1> %19, i64 0
  br i1 %48, label %pred.store.if38, label %pred.store.continue39

pred.store.if38:                                  ; preds = %pred.store.continue37
  %49 = add i64 %offset.idx, -8
  %50 = getelementptr inbounds i32, ptr %data1, i64 %49
  %51 = extractelement <4 x i32> %wide.load24, i64 0
...
while.body.preheader40:                           ; preds = %vector.memcheck, %while.body.preheader, %middle.block
  ...
  %53 = trunc i64 %indvars.iv.ph to i32
  %xtraiter = and i32 %53, 1
...
while.body:                                       ; preds = %while.body.prol.loopexit, %if.end.1
  ...
  %57 = load i32, ptr %arrayidx, align 4, !tbaa !5
  %arrayidx2 = getelementptr inbounds i32, ptr %data2, i64 %indvars.iv.next
  %58 = load i32, ptr %arrayidx2, align 4, !tbaa !5
  %cmp = icmp sgt i32 %57, %58
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %while.body
  store i32 %58, ptr %arrayidx, align 4, !tbaa !5
  br label %if.end
...
if.end:                                           ; preds = %if.then, %while.body
  ...
  %60 = load i32, ptr %arrayidx2.1, align 4, !tbaa !5
  %cmp.1 = icmp sgt i32 %59, %60
  br i1 %cmp.1, label %if.then.1, label %if.end.1

if.then.1:                                        ; preds = %if.end
  store i32 %60, ptr %arrayidx.1, align 4, !tbaa !5
  br label %if.end.1

if.end.1:                                         ; preds = %if.then.1, %if.end
  %61 = and i64 %indvars.iv.next.1, 4294967295
  %tobool.not.1 = icmp eq i64 %61, 0
...
if.then:                                          ; preds = %while.body
  ...
  %call.i = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %4)
...
if.end.i:                                         ; preds = %while.body.i
  ...
  %call.i.i = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %5)
...
if.end.i.i:                                       ; preds = %while.body.i.i
  ...
  %call.i.i.i = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %6)
...
show_data.exit:                                   ; preds = %while.body.i, %if.end.i, %while.body
  ...
  br i1 %cmp.not3.i, label %show_list.exit, label %while.body.i8

while.body.i8:                                    ; preds = %show_data.exit, %show_move.exit.i
  ...
  %call.i.i.i = tail call i32 @_IO_putc(i32 noundef 40, ptr noundef %9)
...
while.body.i.i.i:                                 ; preds = %while.body.i8, %if.end.i.i.i
  %indvars.iv.i.i.i = phi i64 [ %indvars.iv.next.i.i.i, %if.end.i.i.i ], [ 0, %while.body.i8 ]
...
if.end.i.i.i:                                     ; preds = %while.body.i.i.i
  ...
  %call.i.i.i.i = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %14)
...
show_move.exit.i:                                 ; preds = %if.end.i.i.i, %while.body.i.i.i, %while.body.i8
  ...
  br i1 %cmp.not.i9, label %show_list.exit, label %while.body.i8, !llvm.loop !34
...
entry:
  ...
  %cond13 = icmp eq ptr %current.012, null
  br i1 %cond13, label %cleanup, label %while.body.lr.ph
...
while.cond:                                       ; preds = %equal_data.exit
  %next = getelementptr inbounds %struct._list, ptr %current.014, i64 0, i32 1
...
while.body:                                       ; preds = %while.body.lr.ph, %while.cond
  %current.014 = phi ptr [ %current.012, %while.body.lr.ph ], [ %current.0, %while.cond ]
  %2 = load ptr, ptr %current.014, align 8, !tbaa !25
  br label %while.cond.i
...
entry:
  ...
  %cmp.not106 = icmp eq i32 %0, 0
  %1 = load i32, ptr @ncol, align 4
  %2 = icmp eq i32 %1, 0
  %or.cond128 = select i1 %cmp.not106, i1 true, i1 %2
  br i1 %or.cond128, label %for.end34.thread, label %for.cond1.preheader

for.cond1.preheader:                              ; preds = %entry, %for.inc32
  %3 = phi i32 [ %97, %for.inc32 ], [ %0, %entry ]
  %4 = phi i32 [ %98, %for.inc32 ], [ %1, %entry ]
  %current.0108 = phi ptr [ %current.1.lcssa, %for.inc32 ], [ %call, %entry ]
  %row.0107 = phi i32 [ %inc33, %for.inc32 ], [ 0, %entry ]
  %cmp2.not101 = icmp eq i32 %4, 0
  br i1 %cmp2.not101, label %for.inc32, label %for.body3.lr.ph

for.body3.lr.ph:                                  ; preds = %for.cond1.preheader
  %current.012.i = load ptr, ptr @wanted, align 8
  %cond13.i = icmp eq ptr %current.012.i, null
  br label %for.body3

for.body3:                                        ; preds = %for.body3.lr.ph, %if.end31
  %5 = phi i32 [ %4, %for.body3.lr.ph ], [ %96, %if.end31 ]
  %current.1104 = phi ptr [ %current.0108, %for.body3.lr.ph ], [ %current.2, %if.end31 ]
  %row.1103 = phi i32 [ %row.0107, %for.body3.lr.ph ], [ %row.3, %if.end31 ]
  %col.0102 = phi i32 [ 0, %for.body3.lr.ph ], [ %inc, %if.end31 ]
  %conv.i = sext i32 %5 to i64
  %mul.i = shl nsw i64 %conv.i, 2
  %call.i = tail call noalias ptr @malloc(i64 noundef %mul.i) #14
  %cmp.not18.i = icmp eq i32 %col.0102, 0
...
for.body.lr.ph.i:                                 ; preds = %for.body3
  ...
  %7 = zext i32 %col.0102 to i64
  %min.iters.check173 = icmp ult i32 %col.0102, 8
  br i1 %min.iters.check173, label %for.body.i.preheader, label %vector.ph174

vector.ph174:                                     ; preds = %for.body.lr.ph.i
  %n.vec176 = and i64 %7, 4294967288
  ...
  %broadcast.splatinsert183 = insertelement <4 x i32> poison, i32 %6, i64 0
...
vector.body179:                                   ; preds = %vector.body179, %vector.ph174
  %index180 = phi i64 [ 0, %vector.ph174 ], [ %index.next185, %vector.body179 ]
  %8 = getelementptr inbounds i32, ptr %call.i, i64 %index180
  store <4 x i32> %broadcast.splat182, ptr %8, align 4, !tbaa !5
  %9 = getelementptr inbounds i32, ptr %8, i64 4
  store <4 x i32> %broadcast.splat184, ptr %9, align 4, !tbaa !5
  %index.next185 = add nuw i64 %index180, 8
  %10 = icmp eq i64 %index.next185, %n.vec176
  br i1 %10, label %middle.block171, label %vector.body179, !llvm.loop !41

middle.block171:                                  ; preds = %vector.body179
  %cmp.n178 = icmp eq i64 %n.vec176, %7
  br i1 %cmp.n178, label %for.body5.preheader.i, label %for.body.i.preheader

for.body.i.preheader:                             ; preds = %for.body.lr.ph.i, %middle.block171
  %indvars.iv.i.ph = phi i64 [ 0, %for.body.lr.ph.i ], [ %n.vec176, %middle.block171 ]
  br label %for.body.i

for.body5.preheader.i:                            ; preds = %for.body.i, %middle.block171, %for.body3
  %.pre-phi = phi i64 [ 0, %for.body3 ], [ %7, %middle.block171 ], [ %7, %for.body.i ]
  %11 = zext i32 %5 to i64
  %12 = sub nsw i64 %11, %.pre-phi
  %min.iters.check158 = icmp ult i64 %12, 8
  br i1 %min.iters.check158, label %for.body5.i.preheader, label %vector.ph159

vector.ph159:                                     ; preds = %for.body5.preheader.i
  %n.vec161 = and i64 %12, -8
  %ind.end162 = add nsw i64 %.pre-phi, %n.vec161
  %broadcast.splatinsert = insertelement <4 x i32> poison, i32 %row.1103, i64 0
  %broadcast.splat = shufflevector <4 x i32> %broadcast.splatinsert, <4 x i32> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert168 = insertelement <4 x i32> poison, i32 %row.1103, i64 0
...
vector.body165:                                   ; preds = %vector.body165, %vector.ph159
  %index166 = phi i64 [ 0, %vector.ph159 ], [ %index.next170, %vector.body165 ]
  %offset.idx167 = add i64 %.pre-phi, %index166
  %13 = getelementptr inbounds i32, ptr %call.i, i64 %offset.idx167
  store <4 x i32> %broadcast.splat, ptr %13, align 4, !tbaa !5
  %14 = getelementptr inbounds i32, ptr %13, i64 4
  store <4 x i32> %broadcast.splat169, ptr %14, align 4, !tbaa !5
  %index.next170 = add nuw i64 %index166, 8
  %15 = icmp eq i64 %index.next170, %n.vec161
  br i1 %15, label %middle.block156, label %vector.body165, !llvm.loop !42

middle.block156:                                  ; preds = %vector.body165
  %cmp.n164 = icmp eq i64 %12, %n.vec161
  br i1 %cmp.n164, label %make_data.exit, label %for.body5.i.preheader

for.body5.i.preheader:                            ; preds = %for.body5.preheader.i, %middle.block156
  %indvars.iv23.i.ph = phi i64 [ %.pre-phi, %for.body5.preheader.i ], [ %ind.end162, %middle.block156 ]
...
for.body5.i:                                      ; preds = %for.body5.i.preheader, %for.body5.i
  ...
  store i32 %row.1103, ptr %arrayidx7.i, align 4, !tbaa !5
...
make_data.exit:                                   ; preds = %for.body5.i, %middle.block156
...
while.body.i.preheader:                           ; preds = %make_data.exit
  ...
  br i1 %min.iters.check, label %while.body.i.preheader188, label %vector.ph

vector.ph:                                        ; preds = %while.body.i.preheader
  %n.vec = and i64 %16, 4294967288
  %ind.end = sub nsw i64 %conv.i, %n.vec
  br label %vector.body

vector.body:                                      ; preds = %pred.store.continue155, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %pred.store.continue155 ]
  ...
  %22 = getelementptr inbounds i32, ptr %data, i64 %17
  %23 = getelementptr inbounds i32, ptr %22, i64 -3
  %wide.load138 = load <4 x i32>, ptr %23, align 4, !tbaa !5
  %24 = getelementptr inbounds i32, ptr %22, i64 -4
  %25 = getelementptr inbounds i32, ptr %24, i64 -3
  %wide.load140 = load <4 x i32>, ptr %25, align 4, !tbaa !5
  %26 = icmp sgt <4 x i32> %wide.load, %wide.load138
  %27 = icmp sgt <4 x i32> %wide.load136, %wide.load140
  %28 = extractelement <4 x i1> %26, i64 3
  br i1 %28, label %pred.store.if, label %pred.store.continue

pred.store.if:                                    ; preds = %vector.body
  %29 = add nsw i64 %offset.idx, -1
  %30 = getelementptr inbounds i32, ptr %call.i, i64 %29
  %31 = extractelement <4 x i32> %wide.load138, i64 3
  store i32 %31, ptr %30, align 4, !tbaa !5
  br label %pred.store.continue

pred.store.continue:                              ; preds = %pred.store.if, %vector.body
  %32 = extractelement <4 x i1> %26, i64 2
  br i1 %32, label %pred.store.if142, label %pred.store.continue143

pred.store.if142:                                 ; preds = %pred.store.continue
  %33 = add i64 %offset.idx, -2
  %34 = getelementptr inbounds i32, ptr %call.i, i64 %33
  %35 = extractelement <4 x i32> %wide.load138, i64 2
  store i32 %35, ptr %34, align 4, !tbaa !5
  br label %pred.store.continue143

pred.store.continue143:                           ; preds = %pred.store.if142, %pred.store.continue
  %36 = extractelement <4 x i1> %26, i64 1
  br i1 %36, label %pred.store.if144, label %pred.store.continue145

pred.store.if144:                                 ; preds = %pred.store.continue143
  %37 = add i64 %offset.idx, -3
  %38 = getelementptr inbounds i32, ptr %call.i, i64 %37
  %39 = extractelement <4 x i32> %wide.load138, i64 1
...
pred.store.continue145:                           ; preds = %pred.store.if144, %pred.store.continue143
  %40 = extractelement <4 x i1> %26, i64 0
  br i1 %40, label %pred.store.if146, label %pred.store.continue147

pred.store.if146:                                 ; preds = %pred.store.continue145
  %41 = add i64 %offset.idx, -4
  %42 = getelementptr inbounds i32, ptr %call.i, i64 %41
  %43 = extractelement <4 x i32> %wide.load138, i64 0
...
pred.store.continue147:                           ; preds = %pred.store.if146, %pred.store.continue145
  %44 = extractelement <4 x i1> %27, i64 3
  br i1 %44, label %pred.store.if148, label %pred.store.continue149

pred.store.if148:                                 ; preds = %pred.store.continue147
  %45 = add i64 %offset.idx, -5
  %46 = getelementptr inbounds i32, ptr %call.i, i64 %45
  %47 = extractelement <4 x i32> %wide.load140, i64 3
...
pred.store.continue149:                           ; preds = %pred.store.if148, %pred.store.continue147
  %48 = extractelement <4 x i1> %27, i64 2
  br i1 %48, label %pred.store.if150, label %pred.store.continue151

pred.store.if150:                                 ; preds = %pred.store.continue149
  %49 = add i64 %offset.idx, -6
  %50 = getelementptr inbounds i32, ptr %call.i, i64 %49
  %51 = extractelement <4 x i32> %wide.load140, i64 2
...
pred.store.continue151:                           ; preds = %pred.store.if150, %pred.store.continue149
  %52 = extractelement <4 x i1> %27, i64 1
  br i1 %52, label %pred.store.if152, label %pred.store.continue153

pred.store.if152:                                 ; preds = %pred.store.continue151
  %53 = add i64 %offset.idx, -7
  %54 = getelementptr inbounds i32, ptr %call.i, i64 %53
  %55 = extractelement <4 x i32> %wide.load140, i64 1
...
pred.store.continue153:                           ; preds = %pred.store.if152, %pred.store.continue151
  %56 = extractelement <4 x i1> %27, i64 0
  br i1 %56, label %pred.store.if154, label %pred.store.continue155

pred.store.if154:                                 ; preds = %pred.store.continue153
  %57 = add i64 %offset.idx, -8
  %58 = getelementptr inbounds i32, ptr %call.i, i64 %57
  %59 = extractelement <4 x i32> %wide.load140, i64 0
...
pred.store.continue155:                           ; preds = %pred.store.if154, %pred.store.continue153
  ...
  br i1 %60, label %middle.block, label %vector.body, !llvm.loop !45

middle.block:                                     ; preds = %pred.store.continue155
  %cmp.n = icmp eq i64 %n.vec, %16
  br i1 %cmp.n, label %while.cond.i.preheader, label %while.body.i.preheader188

while.body.i.preheader188:                        ; preds = %while.body.i.preheader, %middle.block
  %indvars.iv.i65.ph = phi i64 [ %conv.i, %while.body.i.preheader ], [ %ind.end, %middle.block ]
  br label %while.body.i

while.body.i:                                     ; preds = %while.body.i.preheader188, %if.end.i
  %indvars.iv.i65 = phi i64 [ %indvars.iv.next.i66, %if.end.i ], [ %indvars.iv.i65.ph, %while.body.i.preheader188 ]
  ...
  %61 = load i32, ptr %arrayidx.i67, align 4, !tbaa !5
  %arrayidx2.i = getelementptr inbounds i32, ptr %data, i64 %indvars.iv.next.i66
  %62 = load i32, ptr %arrayidx2.i, align 4, !tbaa !5
  %cmp.i = icmp sgt i32 %61, %62
  br i1 %cmp.i, label %if.then.i, label %if.end.i

if.then.i:                                        ; preds = %while.body.i
  store i32 %62, ptr %arrayidx.i67, align 4, !tbaa !5
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i, %while.body.i
  %63 = and i64 %indvars.iv.next.i66, 4294967295
...
while.cond.i:                                     ; preds = %while.cond.i.preheader, %land.rhs.i
  ...
  %64 = icmp eq i64 %indvars.iv.i68, 0
  br i1 %64, label %if.else, label %land.rhs.i
...
land.rhs.i:                                       ; preds = %while.cond.i
  ...
  %65 = load i32, ptr %arrayidx.i70, align 4, !tbaa !5
  %arrayidx2.i71 = getelementptr inbounds i32, ptr %data, i64 %indvars.iv.next.i69
  %66 = load i32, ptr %arrayidx2.i71, align 4, !tbaa !5
  %cmp.i72 = icmp eq i32 %65, %66
  br i1 %cmp.i72, label %while.cond.i, label %equal_data.exit, !llvm.loop !20

equal_data.exit:                                  ; preds = %land.rhs.i
  %67 = trunc i64 %indvars.iv.i68 to i32
...
if.then:                                          ; preds = %equal_data.exit
  ...
  %next7 = getelementptr inbounds %struct._list, ptr %current.1104, i64 0, i32 1
...
while.body.preheader.i76:                         ; preds = %if.then
  ...
  %73 = shl nsw i64 %72, 2
  %uglygep.i = getelementptr i8, ptr %call.i75, i64 %73
  %uglygep8.i = getelementptr i8, ptr %call.i, i64 %73
  %74 = shl nuw nsw i64 %11, 2
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 4 %uglygep.i, ptr align 4 %uglygep8.i, i64 %74, i1 false), !tbaa !5
...
if.then19:                                        ; preds = %if.end
  ...
  br i1 %cond13.i, label %if.end31, label %while.body.lr.ph.i
...
while.cond.i80:                                   ; preds = %equal_data.exit.i89
  %next.i79 = getelementptr inbounds %struct._list, ptr %current.014.i, i64 0, i32 1
...
while.body.i81:                                   ; preds = %while.cond.i80, %while.body.lr.ph.i
  %current.014.i = phi ptr [ %current.012.i, %while.body.lr.ph.i ], [ %current.0.i, %while.cond.i80 ]
  %89 = load ptr, ptr %current.014.i, align 8, !tbaa !25
  br label %while.cond.i.i83

while.cond.i.i83:                                 ; preds = %land.rhs.i.i88, %while.body.i81
  %indvars.iv.i.i82 = phi i64 [ %indvars.iv.next.i.i84, %land.rhs.i.i88 ], [ %88, %while.body.i81 ]
  %90 = icmp eq i64 %indvars.iv.i.i82, 0
  br i1 %90, label %if.then23, label %land.rhs.i.i88

land.rhs.i.i88:                                   ; preds = %while.cond.i.i83
  %indvars.iv.next.i.i84 = add nsw i64 %indvars.iv.i.i82, -1
  %arrayidx.i.i85 = getelementptr inbounds i32, ptr %89, i64 %indvars.iv.next.i.i84
  %91 = load i32, ptr %arrayidx.i.i85, align 4, !tbaa !5
  %arrayidx2.i.i86 = getelementptr inbounds i32, ptr %call.i, i64 %indvars.iv.next.i.i84
  %92 = load i32, ptr %arrayidx2.i.i86, align 4, !tbaa !5
  %cmp.i.i87 = icmp eq i32 %91, %92
  br i1 %cmp.i.i87, label %while.cond.i.i83, label %equal_data.exit.i89, !llvm.loop !20

equal_data.exit.i89:                              ; preds = %land.rhs.i.i88
  %93 = trunc i64 %indvars.iv.i.i82 to i32
  %94 = icmp sgt i32 %93, 0
  br i1 %94, label %while.cond.i80, label %if.then23
...
if.else:                                          ; preds = %while.cond.i, %equal_data.exit
  ...
  %row.2 = select i1 %cmp.not18.i, i32 %sub28, i32 %row.1103
  %sub30 = add nsw i32 %5, -1
  br label %if.end31

if.end31:                                         ; preds = %while.cond.i80, %if.then19, %if.end, %if.then23, %if.else
  %col.1 = phi i32 [ %sub30, %if.else ], [ %col.0102, %if.end ], [ %sub, %if.then23 ], [ %sub, %if.then19 ], [ %sub, %while.cond.i80 ]
  %row.3 = phi i32 [ %row.2, %if.else ], [ %row.1103, %if.end ], [ %sub20, %if.then23 ], [ %sub20, %if.then19 ], [ %sub20, %while.cond.i80 ]
  %current.2 = phi ptr [ %current.1104, %if.else ], [ %75, %if.end ], [ %75, %if.then23 ], [ %75, %if.then19 ], [ %75, %while.cond.i80 ]
...
for.inc32:                                        ; preds = %for.inc32.loopexit, %for.cond1.preheader
  ...
  %row.1.lcssa = phi i32 [ %row.0107, %for.cond1.preheader ], [ %row.3, %for.inc32.loopexit ]
  %current.1.lcssa = phi ptr [ %current.0108, %for.cond1.preheader ], [ %current.2, %for.inc32.loopexit ]
...
for.end34:                                        ; preds = %for.inc32
  %.pre117 = load ptr, ptr %next, align 8, !tbaa !22
  tail call void @free(ptr noundef %call) #15
  %cmp36.not = icmp eq ptr %.pre117, null
...
if.end39:                                         ; preds = %for.end34.thread, %if.then37, %for.end34
  %100 = phi ptr [ null, %for.end34.thread ], [ %.pre117, %if.then37 ], [ null, %for.end34 ]
  ret ptr %100
}
...
while.body.i.preheader:                           ; preds = %while.body.i.preheader.preheader, %if.end20
  %current.067 = phi ptr [ %current.1, %if.end20 ], [ %call, %while.body.i.preheader.preheader ]
  %temp.066 = phi ptr [ %temp.1, %if.end20 ], [ %call.i, %while.body.i.preheader.preheader ]
  br label %while.body.i

while.body.i:                                     ; preds = %while.body.i.preheader, %if.end.i
  %indvars.iv = phi i64 [ 0, %while.body.i.preheader ], [ %indvars.iv.next, %if.end.i ]
  %arrayidx.i = getelementptr inbounds i32, ptr %temp.066, i64 %indvars.iv
  %4 = load i32, ptr %arrayidx.i, align 4, !tbaa !5
  %5 = load i32, ptr @nrow, align 4, !tbaa !5
  %cmp1.i = icmp eq i32 %4, %5
  br i1 %cmp1.i, label %if.end.i, label %while.body
...
if.end.i:                                         ; preds = %while.body.i
  ...
  %7 = zext i32 %6 to i64
  %cmp.i.not = icmp eq i64 %indvars.iv.next, %7
...
while.body.i38:                                   ; preds = %while.body.i38, %while.body.preheader.i
  ...
  %arrayidx.i36 = getelementptr inbounds i32, ptr %temp.066, i64 %indvars.iv.i
...
if.then:                                          ; preds = %while.body, %valid_data.exit
  %call5 = tail call noalias dereferenceable_or_null(32) ptr @malloc(i64 noundef 32) #14
  %next = getelementptr inbounds %struct._play, ptr %current.067, i64 0, i32 3
...
while.body.preheader.i42:                         ; preds = %if.end
  ...
  %17 = shl nsw i64 %16, 2
  %uglygep.i = getelementptr i8, ptr %call.i41, i64 %17
  %uglygep8.i = getelementptr i8, ptr %temp.066, i64 %17
  %18 = zext i32 %8 to i64
  %19 = shl nuw nsw i64 %18, 2
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 4 %uglygep.i, ptr align 4 %uglygep8.i, i64 %19, i1 false), !tbaa !5
  br label %copy_data.exit
...
copy_data.exit:                                   ; preds = %if.end, %while.body.preheader.i42
  ...
  %call10 = call ptr @make_list(ptr noundef nonnull %temp.066, ptr noundef nonnull %val, ptr noundef nonnull %all.addr)
...
copy_data.exit.if.end20_crit_edge:                ; preds = %copy_data.exit
  %.pre72 = load i32, ptr @ncol, align 4, !tbaa !5
  br label %if.end20

if.then17:                                        ; preds = %copy_data.exit
  tail call void @free(ptr noundef nonnull %temp.066) #15
  %24 = load i32, ptr @nrow, align 4, !tbaa !5
  %25 = load i32, ptr @ncol, align 4, !tbaa !5
  %conv.i43 = sext i32 %25 to i64
  %mul.i44 = shl nsw i64 %conv.i43, 2
  %call.i45 = tail call noalias ptr @malloc(i64 noundef %mul.i44) #14
  %cmp.not18.i = icmp eq i32 %25, 0
...
vector.ph:                                        ; preds = %for.body.lr.ph.i
  ...
  %broadcast.splat = shufflevector <4 x i32> %broadcast.splatinsert, <4 x i32> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert83 = insertelement <4 x i32> poison, i32 %24, i64 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> %broadcast.splat84, ptr %28, align 4, !tbaa !5
  %index.next = add nuw i64 %index, 8
...
for.body.i:                                       ; preds = %for.body.i.preheader, %for.body.i
  ...
  store i32 %24, ptr %arrayidx.i49, align 4, !tbaa !5
...
if.end20:                                         ; preds = %for.body.i, %middle.block, %copy_data.exit.if.end20_crit_edge, %valid_data.exit
  %30 = phi i32 [ %.pre72, %copy_data.exit.if.end20_crit_edge ], [ 1, %valid_data.exit ], [ 1, %middle.block ], [ 1, %for.body.i ]
  %temp.1 = phi ptr [ %temp.066, %copy_data.exit.if.end20_crit_edge ], [ %temp.066, %valid_data.exit ], [ %call.i45, %middle.block ], [ %call.i45, %for.body.i ]
  %current.1 = phi ptr [ %22, %copy_data.exit.if.end20_crit_edge ], [ %current.067, %valid_data.exit ], [ %22, %middle.block ], [ %22, %for.body.i ]
...
for.cond1.preheader.lr.ph:                        ; preds = %entry
  ...
  %sub = add nsw i32 %0, -1
  br i1 %cmp2.not53, label %for.end20, label %for.cond1.preheader.preheader
...
for.body3:                                        ; preds = %for.body3.backedge, %for.cond1.preheader.preheader
  %current.156 = phi ptr [ %call, %for.cond1.preheader.preheader ], [ %current.2, %for.body3.backedge ]
  %row.155 = phi i32 [ 0, %for.cond1.preheader.preheader ], [ %row.155.be, %for.body3.backedge ]
  %col.054 = phi i32 [ 0, %for.cond1.preheader.preheader ], [ %col.054.be, %for.body3.backedge ]
  %call.i = tail call noalias ptr @malloc(i64 noundef %mul.i) #14
  %cmp.not18.i = icmp eq i32 %col.054, 0
  br i1 %cmp.not18.i, label %for.body5.preheader.i, label %for.body.lr.ph.i

for.body.lr.ph.i:                                 ; preds = %for.body3
  %10 = zext i32 %col.054 to i64
...
vector.ph104:                                     ; preds = %for.body.lr.ph.i
  %n.vec106 = and i64 %10, 4294967288
...
vector.body109:                                   ; preds = %vector.body109, %vector.ph104
  ...
  %11 = getelementptr inbounds i32, ptr %call.i, i64 %index110
  store <4 x i32> %broadcast.splat112, ptr %11, align 4, !tbaa !5
  %12 = getelementptr inbounds i32, ptr %11, i64 4
  store <4 x i32> %broadcast.splat114, ptr %12, align 4, !tbaa !5
  %index.next115 = add nuw i64 %index110, 8
  %13 = icmp eq i64 %index.next115, %n.vec106
  br i1 %13, label %middle.block101, label %vector.body109, !llvm.loop !53

middle.block101:                                  ; preds = %vector.body109
  %cmp.n108 = icmp eq i64 %n.vec106, %10
...
for.body5.preheader.i:                            ; preds = %for.body.i, %middle.block101, %for.body3
  %.pre-phi = phi i64 [ 0, %for.body3 ], [ %10, %middle.block101 ], [ %10, %for.body.i ]
  %14 = sub nsw i64 %2, %.pre-phi
  %min.iters.check88 = icmp ult i64 %14, 8
  br i1 %min.iters.check88, label %for.body5.i.preheader, label %vector.ph89

vector.ph89:                                      ; preds = %for.body5.preheader.i
  %n.vec91 = and i64 %14, -8
...
vector.body95:                                    ; preds = %vector.body95, %vector.ph89
  ...
  %15 = getelementptr inbounds i32, ptr %call.i, i64 %offset.idx97
  store <4 x i32> %broadcast.splat, ptr %15, align 4, !tbaa !5
  %16 = getelementptr inbounds i32, ptr %15, i64 4
  store <4 x i32> %broadcast.splat99, ptr %16, align 4, !tbaa !5
  %index.next100 = add nuw i64 %index96, 8
  %17 = icmp eq i64 %index.next100, %n.vec91
  br i1 %17, label %middle.block86, label %vector.body95, !llvm.loop !54

middle.block86:                                   ; preds = %vector.body95
  %cmp.n94 = icmp eq i64 %14, %n.vec91
...
vector.body:                                      ; preds = %while.body.i.preheader, %pred.store.continue85
  ...
  %23 = getelementptr inbounds i32, ptr %data, i64 %18
  ...
  %wide.load70 = load <4 x i32>, ptr %26, align 4, !tbaa !5
  %27 = icmp sgt <4 x i32> %wide.load, %wide.load68
  %28 = icmp sgt <4 x i32> %wide.load66, %wide.load70
  %29 = extractelement <4 x i1> %27, i64 3
  br i1 %29, label %pred.store.if, label %pred.store.continue

pred.store.if:                                    ; preds = %vector.body
  %30 = add nsw i64 %offset.idx, -1
  %31 = getelementptr inbounds i32, ptr %call.i, i64 %30
  %32 = extractelement <4 x i32> %wide.load68, i64 3
  store i32 %32, ptr %31, align 4, !tbaa !5
  br label %pred.store.continue

pred.store.continue:                              ; preds = %pred.store.if, %vector.body
  %33 = extractelement <4 x i1> %27, i64 2
  br i1 %33, label %pred.store.if72, label %pred.store.continue73

pred.store.if72:                                  ; preds = %pred.store.continue
  %34 = add i64 %offset.idx, -2
  %35 = getelementptr inbounds i32, ptr %call.i, i64 %34
  %36 = extractelement <4 x i32> %wide.load68, i64 2
...
pred.store.continue73:                            ; preds = %pred.store.if72, %pred.store.continue
  %37 = extractelement <4 x i1> %27, i64 1
  br i1 %37, label %pred.store.if74, label %pred.store.continue75

pred.store.if74:                                  ; preds = %pred.store.continue73
  %38 = add i64 %offset.idx, -3
  %39 = getelementptr inbounds i32, ptr %call.i, i64 %38
  %40 = extractelement <4 x i32> %wide.load68, i64 1
...
pred.store.continue79:                            ; preds = %pred.store.if78, %pred.store.continue77
  %49 = extractelement <4 x i1> %28, i64 2
  br i1 %49, label %pred.store.if80, label %pred.store.continue81

pred.store.if80:                                  ; preds = %pred.store.continue79
  %50 = add i64 %offset.idx, -6
  %51 = getelementptr inbounds i32, ptr %call.i, i64 %50
  %52 = extractelement <4 x i32> %wide.load70, i64 2
...
pred.store.continue81:                            ; preds = %pred.store.if80, %pred.store.continue79
  %53 = extractelement <4 x i1> %28, i64 1
  br i1 %53, label %pred.store.if82, label %pred.store.continue83

pred.store.if82:                                  ; preds = %pred.store.continue81
  %54 = add i64 %offset.idx, -7
  %55 = getelementptr inbounds i32, ptr %call.i, i64 %54
  %56 = extractelement <4 x i32> %wide.load70, i64 1
...
pred.store.continue83:                            ; preds = %pred.store.if82, %pred.store.continue81
  %57 = extractelement <4 x i1> %28, i64 0
  br i1 %57, label %pred.store.if84, label %pred.store.continue85

pred.store.if84:                                  ; preds = %pred.store.continue83
  %58 = add i64 %offset.idx, -8
  %59 = getelementptr inbounds i32, ptr %call.i, i64 %58
  %60 = extractelement <4 x i32> %wide.load70, i64 0
...
pred.store.continue85:                            ; preds = %pred.store.if84, %pred.store.continue83
  ...
  br i1 %61, label %middle.block, label %vector.body, !llvm.loop !57
...
while.body.i:                                     ; preds = %while.body.i.preheader116, %if.end.i
  ...
  %62 = load i32, ptr %arrayidx.i40, align 4, !tbaa !5
  %arrayidx2.i = getelementptr inbounds i32, ptr %data, i64 %indvars.iv.next.i39
  %63 = load i32, ptr %arrayidx2.i, align 4, !tbaa !5
  %cmp.i = icmp sgt i32 %62, %63
  br i1 %cmp.i, label %if.then.i, label %if.end.i

if.then.i:                                        ; preds = %while.body.i
  store i32 %63, ptr %arrayidx.i40, align 4, !tbaa !5
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i, %while.body.i
  %64 = and i64 %indvars.iv.next.i39, 4294967295
  %tobool.not.i = icmp eq i64 %64, 0
...
while.cond.i:                                     ; preds = %while.cond.i.preheader, %land.rhs.i
  ...
  %65 = icmp eq i64 %indvars.iv.i41, 0
  br i1 %65, label %if.else, label %land.rhs.i
...
land.rhs.i:                                       ; preds = %while.cond.i
  ...
  %66 = load i32, ptr %arrayidx.i43, align 4, !tbaa !5
  %arrayidx2.i44 = getelementptr inbounds i32, ptr %data, i64 %indvars.iv.next.i42
  %67 = load i32, ptr %arrayidx2.i44, align 4, !tbaa !5
  %cmp.i45 = icmp eq i32 %66, %67
  br i1 %cmp.i45, label %while.cond.i, label %equal_data.exit, !llvm.loop !20

equal_data.exit:                                  ; preds = %land.rhs.i
  %68 = trunc i64 %indvars.iv.i41 to i32
...
if.then:                                          ; preds = %equal_data.exit
  ...
  %uglygep.i = getelementptr i8, ptr %call.i48, i64 %7
  %uglygep8.i = getelementptr i8, ptr %call.i, i64 %7
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 4 %uglygep.i, ptr align 4 %uglygep8.i, i64 %8, i1 false), !tbaa !5
  store ptr %call.i48, ptr %call6, align 8, !tbaa !25
  %next12 = getelementptr inbounds %struct._list, ptr %call6, i64 0, i32 1
  store ptr null, ptr %next12, align 8, !tbaa !22
  %70 = load ptr, ptr %next7, align 8, !tbaa !22
  br label %if.end17
...
if.end17:                                         ; preds = %if.else, %if.then
  ...
  %current.2 = phi ptr [ %current.156, %if.else ], [ %70, %if.then ]
...
for.end20:                                        ; preds = %for.cond1.preheader.lr.ph, %for.end20.loopexit61, %entry
  %71 = phi ptr [ %.pre, %for.end20.loopexit61 ], [ null, %entry ], [ null, %for.cond1.preheader.lr.ph ]
  tail call void @free(ptr noundef nonnull %call) #15
  store ptr %71, ptr @wanted, align 8, !tbaa !30
  ret void
}
...
while.body.preheader.i:                           ; preds = %while.end
  ...
  %14 = shl nsw i64 %13, 2
  %uglygep.i = getelementptr i8, ptr %call.i, i64 %14
  %uglygep8.i = getelementptr i8, ptr %.pre, i64 %14
  %15 = zext i32 %0 to i64
  %16 = shl nuw nsw i64 %15, 2
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 4 %uglygep.i, ptr align 4 %uglygep8.i, i64 %16, i1 false), !tbaa !5
  br label %return
...
while.body.preheader.i.i:                         ; preds = %while.end.i
  ...
  %16 = shl nsw i64 %15, 2
  %uglygep.i.i = getelementptr i8, ptr %call.i.i, i64 %16
  %uglygep8.i.i = getelementptr i8, ptr %.pre.i, i64 %16
  %17 = zext i32 %2 to i64
  %18 = shl nuw nsw i64 %17, 2
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 4 %uglygep.i.i, ptr align 4 %uglygep8.i.i, i64 %18, i1 false), !tbaa !5
...
entry:
  ...
  %puts56 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.21)
  %puts57 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.22)
...
where.exit:                                       ; preds = %equal_data.exit.i, %while.cond.i.i
  ...
  br i1 %cmp.i, label %while.end, label %while.cond.i59

while.cond.i59:                                   ; preds = %where.exit, %get_value.exit.i
  %list.addr.0.i = phi ptr [ %16, %get_value.exit.i ], [ %15, %where.exit ]
  %next.i58 = getelementptr inbounds %struct._list, ptr %list.addr.0.i, i64 0, i32 1
  %16 = load ptr, ptr %next.i58, align 8, !tbaa !22
  %cmp1.not.i = icmp eq ptr %16, null
  %.pre.i = load ptr, ptr %list.addr.0.i, align 8, !tbaa !25
  br i1 %cmp1.not.i, label %while.end.i, label %while.cond.i.i60

while.cond.i.i60:                                 ; preds = %while.cond.i59, %while.body.i.i
  %search.0.in.i.i = phi ptr [ %next.i.i, %while.body.i.i ], [ @game_tree, %while.cond.i59 ]
  %search.0.i.i = load ptr, ptr %search.0.in.i.i, align 8, !tbaa !30
  %state.i.i = getelementptr inbounds %struct._play, ptr %search.0.i.i, i64 0, i32 1
  %17 = load ptr, ptr %state.i.i, align 8, !tbaa !29
  br label %while.cond.i.i.i

while.cond.i.i.i:                                 ; preds = %land.rhs.i.i.i, %while.cond.i.i60
  %indvars.iv.i.i.i = phi i64 [ %indvars.iv.next.i.i.i, %land.rhs.i.i.i ], [ %7, %while.cond.i.i60 ]
...
while.body.i.i:                                   ; preds = %equal_data.exit.i.i
  %next.i.i = getelementptr inbounds %struct._play, ptr %search.0.i.i, i64 0, i32 3
  br label %while.cond.i.i60, !llvm.loop !31

get_value.exit.i:                                 ; preds = %equal_data.exit.i.i, %while.cond.i.i.i
  %23 = load i32, ptr %search.0.i.i, align 8, !tbaa !32
  %tobool.not.i = icmp eq i32 %23, 0
  br i1 %tobool.not.i, label %while.end.i, label %while.cond.i59, !llvm.loop !60

while.end.i:                                      ; preds = %get_value.exit.i, %while.cond.i59
...
while.body.preheader.i.i:                         ; preds = %while.end.i
  ...
  %28 = shl nsw i64 %27, 2
  %uglygep.i.i = getelementptr i8, ptr %call.i.i, i64 %28
  %uglygep8.i.i = getelementptr i8, ptr %.pre.i, i64 %28
  %29 = zext i32 %6 to i64
  %30 = shl nuw nsw i64 %29, 2
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 4 %uglygep.i.i, ptr align 4 %uglygep8.i.i, i64 %30, i1 false), !tbaa !5
  br label %get_good_move.exit

get_good_move.exit:                               ; preds = %while.end.i, %while.body.preheader.i.i
  %cmp23.not = icmp eq ptr %call.i.i, null
  br i1 %cmp23.not, label %while.end, label %while.cond.i65

while.cond.i65:                                   ; preds = %get_good_move.exit, %while.cond.i65
  %indvars.iv.i61 = phi i64 [ %indvars.iv.next.i64, %while.cond.i65 ], [ 0, %get_good_move.exit ]
  %arrayidx.i62 = getelementptr inbounds i32, ptr %call.i.i, i64 %indvars.iv.i61
  %31 = load i32, ptr %arrayidx.i62, align 4, !tbaa !5
  %arrayidx2.i = getelementptr inbounds i32, ptr %current.081, i64 %indvars.iv.i61
  %32 = load i32, ptr %arrayidx2.i, align 4, !tbaa !5
  %cmp.i63 = icmp eq i32 %31, %32
  %indvars.iv.next.i64 = add nuw i64 %indvars.iv.i61, 1
  br i1 %cmp.i63, label %while.cond.i65, label %if.end, !llvm.loop !63

if.end:                                           ; preds = %while.cond.i65
  %33 = trunc i64 %indvars.iv.i61 to i32
...
; Function Attrs: nofree nounwind
declare noundef i32 @_IO_putc(i32 noundef, ptr nocapture noundef) local_unnamed_addr #8
