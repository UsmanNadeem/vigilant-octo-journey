; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/vprobes.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/vprobes.c"
...
define dso_local void @vprobes() local_unnamed_addr #0 {
entry:
  %ritePtr.0718 = load ptr, ptr @hFixedList, align 8, !tbaa !5
  %cmp.not719 = icmp eq ptr %ritePtr.0718, null
  br i1 %cmp.not719, label %for.end517, label %for.body

for.body:                                         ; preds = %entry, %for.inc515
  %ritePtr.0724 = phi ptr [ %ritePtr.0, %for.inc515 ], [ %ritePtr.0718, %entry ]
  %l2y.0723 = phi i32 [ %l2y.4, %for.inc515 ], [ undef, %entry ]
  %l2x1.0722 = phi i32 [ %l2x1.4, %for.inc515 ], [ undef, %entry ]
  %l1y.0721 = phi i32 [ %l1y.4, %for.inc515 ], [ undef, %entry ]
  %l1x2.0720 = phi i32 [ %l1x2.4, %for.inc515 ], [ undef, %entry ]
  %0 = load i32, ptr %ritePtr.0724, align 8, !tbaa !9
...
if.then15:                                        ; preds = %if.end
  %8 = load ptr, ptr @Hptrs, align 8, !tbaa !5
  %9 = load ptr, ptr @Hroot, align 8, !tbaa !5
  ...
  %left1ptr.0678 = load ptr, ptr %arrayidx17, align 8, !tbaa !5
  %cmp19.not679 = icmp eq ptr %left1ptr.0678, null
...
for.body20:                                       ; preds = %if.then15, %for.inc
  %left1ptr.0682 = phi ptr [ %left1ptr.0, %for.inc ], [ %left1ptr.0678, %if.then15 ]
  %l1y.1681 = phi i32 [ %l1y.2, %for.inc ], [ %l1y.0721, %if.then15 ]
  %l1x2.1680 = phi i32 [ %l1x2.2, %for.inc ], [ %l1x2.0720, %if.then15 ]
  %10 = load i32, ptr %left1ptr.0682, align 8, !tbaa !9
...
if.end27:                                         ; preds = %for.body20
  ...
  %13 = load i32, ptr %end36, align 4, !tbaa !16
  %cmp37.not = icmp sgt i32 %13, %4
  br i1 %cmp37.not, label %lor.lhs.false, label %for.inc

lor.lhs.false:                                    ; preds = %if.end27
  %start33 = getelementptr inbounds %struct.edgebox, ptr %.pre, i64 %idxprom22, i32 1
  %14 = load i32, ptr %start33, align 4, !tbaa !15
  %cmp38 = icmp sgt i32 %14, %4
  br i1 %cmp38, label %for.inc, label %if.end41

for.inc:                                          ; preds = %if.end27, %lor.lhs.false, %for.body20
  %l1x2.2 = phi i32 [ %l1x2.1680, %for.body20 ], [ %13, %if.end27 ], [ %13, %lor.lhs.false ]
  %l1y.2 = phi i32 [ %l1y.1681, %for.body20 ], [ %12, %if.end27 ], [ %12, %lor.lhs.false ]
  %next = getelementptr inbounds %struct.dlink1, ptr %left1ptr.0682, i64 0, i32 2
  %left1ptr.0 = load ptr, ptr %next, align 8, !tbaa !5
  %cmp19.not = icmp eq ptr %left1ptr.0, null
  br i1 %cmp19.not, label %if.end41, label %for.body20, !llvm.loop !18

if.end41:                                         ; preds = %lor.lhs.false, %for.inc, %if.then15, %if.end
  %15 = phi ptr [ %1, %if.end ], [ %.pre, %if.then15 ], [ %.pre, %for.inc ], [ %.pre, %lor.lhs.false ]
  %l1x2.3 = phi i32 [ %l1x2.0720, %if.end ], [ %l1x2.0720, %if.then15 ], [ %13, %lor.lhs.false ], [ %l1x2.2, %for.inc ]
  %left1ptr.1 = phi ptr [ null, %if.end ], [ null, %if.then15 ], [ %left1ptr.0682, %lor.lhs.false ], [ null, %for.inc ]
  %l1y.3 = phi i32 [ %l1y.0721, %if.end ], [ %l1y.0721, %if.then15 ], [ %12, %lor.lhs.false ], [ %l1y.2, %for.inc ]
...
if.then48:                                        ; preds = %if.end41
  ...
  %19 = load ptr, ptr @Hroot, align 8, !tbaa !5
  ...
  %left2ptr.0688 = load ptr, ptr %arrayidx51, align 8, !tbaa !5
  %cmp53.not689 = icmp eq ptr %left2ptr.0688, null
...
for.body54:                                       ; preds = %for.body54.lr.ph, %for.inc76
  %left2ptr.0692 = phi ptr [ %left2ptr.0688, %for.body54.lr.ph ], [ %left2ptr.0, %for.inc76 ]
  %l2y.1691 = phi i32 [ %l2y.0723, %for.body54.lr.ph ], [ %l2y.2, %for.inc76 ]
  %l2x1.1690 = phi i32 [ %l2x1.0722, %for.body54.lr.ph ], [ %l2x1.2, %for.inc76 ]
  %21 = load i32, ptr %left2ptr.0692, align 8, !tbaa !9
...
if.end61:                                         ; preds = %for.body54
  ...
  %24 = load i32, ptr %start67, align 4, !tbaa !15
  %end70 = getelementptr inbounds %struct.edgebox, ptr %20, i64 %idxprom56, i32 2
  %25 = load i32, ptr %end70, align 4, !tbaa !16
  %cmp71 = icmp sge i32 %25, %5
  %cmp73.not = icmp slt i32 %24, %5
  %or.cond = select i1 %cmp71, i1 %cmp73.not, i1 false
  br i1 %or.cond, label %if.end80, label %for.inc76

for.inc76:                                        ; preds = %if.end61, %for.body54
  %l2x1.2 = phi i32 [ %l2x1.1690, %for.body54 ], [ %24, %if.end61 ]
  %l2y.2 = phi i32 [ %l2y.1691, %for.body54 ], [ %23, %if.end61 ]
  %next77 = getelementptr inbounds %struct.dlink1, ptr %left2ptr.0692, i64 0, i32 2
  %left2ptr.0 = load ptr, ptr %next77, align 8, !tbaa !5
  %cmp53.not = icmp eq ptr %left2ptr.0, null
  br i1 %cmp53.not, label %if.end80, label %for.body54, !llvm.loop !21

if.end80:                                         ; preds = %for.inc76, %if.end61, %if.then48, %if.end41
  %left2ptr.1 = phi ptr [ null, %if.end41 ], [ null, %if.then48 ], [ null, %for.inc76 ], [ %left2ptr.0692, %if.end61 ]
  %l2x1.3 = phi i32 [ %l2x1.0722, %if.end41 ], [ %l2x1.0722, %if.then48 ], [ %l2x1.2, %for.inc76 ], [ %24, %if.end61 ]
  %l2y.3 = phi i32 [ %l2y.0723, %if.end41 ], [ %l2y.0723, %if.then48 ], [ %l2y.2, %for.inc76 ], [ %23, %if.end61 ]
  %cmp81.not = icmp ne ptr %left1ptr.1, null
  %cmp82 = icmp eq ptr %left1ptr.1, %left2ptr.1
  %or.cond672 = and i1 %cmp81.not, %cmp82
  br i1 %or.cond672, label %if.then83, label %if.end183

if.then83:                                        ; preds = %if.end80
  %26 = load ptr, ptr @Hptrs, align 8, !tbaa !5
  %27 = load ptr, ptr @Hroot, align 8, !tbaa !5
...
if.end96:                                         ; preds = %for.body89
  ...
  %cmp101.not = icmp slt i32 %30, %l2y.3
...
if.then120.critedge:                              ; preds = %if.end96, %for.inc117, %if.then83
  ...
  store i32 %l2y.3, ptr %end127, align 4, !tbaa !16
  ...
  store i32 %4, ptr %loc131, align 4, !tbaa !14
  %sub = sub nsw i32 %l2y.3, %3
  ...
  tail call void @tinsert(ptr noundef nonnull @vEdgeRoot, i32 noundef %4, i32 noundef %add145) #3
  ...
  %call147 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %51, ptr noundef nonnull @.str.1, i32 noundef %3, i32 noundef %l2y.3, i32 noundef %4, i32 noundef 1)
  ...
  store i32 %l2y.3, ptr %end156, align 4, !tbaa !16
  ...
  store i32 %5, ptr %loc160, align 4, !tbaa !14
  ...
  tail call void @tinsert(ptr noundef nonnull @vEdgeRoot, i32 noundef %5, i32 noundef %add178) #3
  ...
  %call180 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %71, ptr noundef nonnull @.str.1, i32 noundef %3, i32 noundef %l2y.3, i32 noundef %5, i32 noundef -1)
  br label %for.inc515

if.else181:                                       ; preds = %lor.lhs.false109
  tail call void @doubleDown(ptr noundef nonnull %ritePtr.0724)
  br label %for.inc515
...
land.lhs.true185:                                 ; preds = %if.end183
  ...
  %73 = load i32, ptr %left1ptr.1, align 8, !tbaa !9
...
if.then194:                                       ; preds = %land.lhs.true185
  %76 = load ptr, ptr @Hptrs, align 8, !tbaa !5
  %77 = load ptr, ptr @Hroot, align 8, !tbaa !5
  %call195 = tail call i32 @tprop(ptr noundef %77, i32 noundef %l1y.3) #3
...
if.end215:                                        ; preds = %for.cond199, %for.end211
  %ptr.1.in = phi ptr [ %prev, %for.end211 ], [ @hFixedEnd, %for.cond199 ]
...
if.end225:                                        ; preds = %for.body218
  ...
  %cmp232 = icmp slt i32 %84, %l1x2.3
  br i1 %cmp232, label %for.inc237, label %lor.lhs.false233
...
lor.lhs.false233:                                 ; preds = %if.end225
  ...
  %cmp234.not = icmp slt i32 %85, %l1x2.3
  br i1 %cmp234.not, label %for.end239, label %for.inc237
...
for.end239:                                       ; preds = %for.inc237, %lor.lhs.false233, %if.end215
  ...
  %cmp240 = icmp eq ptr %ritePtr.0724, %ptr.2.lcssa
  br i1 %cmp240, label %if.then241, label %if.end348

if.then241:                                       ; preds = %for.end239
  %86 = load ptr, ptr @Hptrs, align 8, !tbaa !5
  %87 = load ptr, ptr @Hroot, align 8, !tbaa !5
...
if.end254:                                        ; preds = %for.body247
  ...
  %cmp259.not = icmp slt i32 %90, %l1y.3
...
if.end261:                                        ; preds = %if.end254
  ...
  %cmp266.not = icmp slt i32 %91, %l1x2.3
...
if.then279.critedge:                              ; preds = %if.end254, %for.inc275, %if.then241
  ...
  store i32 %l1y.3, ptr %end288, align 4, !tbaa !16
  ...
  store i32 %4, ptr %loc292, align 4, !tbaa !14
  %sub293 = sub nsw i32 %l1y.3, %3
  ...
  tail call void @tinsert(ptr noundef nonnull @vEdgeRoot, i32 noundef %4, i32 noundef %add310) #3
  ...
  %call312 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %111, ptr noundef nonnull @.str.1, i32 noundef %3, i32 noundef %l1y.3, i32 noundef %4, i32 noundef 1)
  ...
  store i32 %l1y.3, ptr %end321, align 4, !tbaa !16
  ...
  store i32 %l1x2.3, ptr %loc325, align 4, !tbaa !14
  ...
  tail call void @tinsert(ptr noundef nonnull @vEdgeRoot, i32 noundef %l1x2.3, i32 noundef %add343) #3
  ...
  %call345 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %131, ptr noundef nonnull @.str.1, i32 noundef %3, i32 noundef %l1y.3, i32 noundef %l1x2.3, i32 noundef -1)
  br label %if.end348

if.end348:                                        ; preds = %lor.lhs.false267, %for.end239, %if.then279.critedge, %land.lhs.true185, %if.end183
  %cmp349.not = icmp eq ptr %left2ptr.1, null
...
land.lhs.true350:                                 ; preds = %if.end348
  ...
  %133 = load i32, ptr %left2ptr.1, align 8, !tbaa !9
...
if.then359:                                       ; preds = %land.lhs.true350
  %136 = load ptr, ptr @Hptrs, align 8, !tbaa !5
  %137 = load ptr, ptr @Hroot, align 8, !tbaa !5
  %call360 = tail call i32 @tprop(ptr noundef %137, i32 noundef %l2y.3) #3
...
if.end381:                                        ; preds = %for.cond364, %for.end376
  %ptr.4.in = phi ptr [ %prev380, %for.end376 ], [ @hFixedEnd, %for.cond364 ]
...
if.end391:                                        ; preds = %for.body384
  ...
  %cmp398.not = icmp sgt i32 %144, %l2x1.3
  br i1 %cmp398.not, label %lor.lhs.false399, label %for.inc403
...
lor.lhs.false399:                                 ; preds = %if.end391
  ...
  %cmp400 = icmp sgt i32 %145, %l2x1.3
  br i1 %cmp400, label %for.inc403, label %for.end405
...
for.end405:                                       ; preds = %for.inc403, %lor.lhs.false399, %if.end381
  ...
  %cmp406 = icmp eq ptr %ritePtr.0724, %ptr.5.lcssa
  br i1 %cmp406, label %if.then407, label %if.end514

if.then407:                                       ; preds = %for.end405
  %146 = load ptr, ptr @Hptrs, align 8, !tbaa !5
  %147 = load ptr, ptr @Hroot, align 8, !tbaa !5
...
if.end420:                                        ; preds = %for.body413
  ...
  %cmp425.not = icmp slt i32 %150, %l2y.3
...
lor.lhs.false433:                                 ; preds = %if.end427
  ...
  %cmp438.not = icmp sgt i32 %152, %l2x1.3
...
if.then445.critedge:                              ; preds = %if.end420, %for.inc441, %if.then407
  ...
  store i32 %l2y.3, ptr %end454, align 4, !tbaa !16
  ...
  store i32 %l2x1.3, ptr %loc458, align 4, !tbaa !14
  %sub459 = sub nsw i32 %l2y.3, %3
  ...
  tail call void @tinsert(ptr noundef nonnull @vEdgeRoot, i32 noundef %l2x1.3, i32 noundef %add476) #3
  ...
  %call478 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %171, ptr noundef nonnull @.str.1, i32 noundef %3, i32 noundef %l2y.3, i32 noundef %l2x1.3, i32 noundef 1)
  ...
  store i32 %l2y.3, ptr %end487, align 4, !tbaa !16
  ...
  store i32 %5, ptr %loc491, align 4, !tbaa !14
  ...
  tail call void @tinsert(ptr noundef nonnull @vEdgeRoot, i32 noundef %5, i32 noundef %add509) #3
  ...
  %call511 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %191, ptr noundef nonnull @.str.1, i32 noundef %3, i32 noundef %l2y.3, i32 noundef %5, i32 noundef -1)
  br label %if.end514
...
for.inc515:                                       ; preds = %if.then120.critedge, %if.else181, %for.body, %if.end514
  %l1x2.4 = phi i32 [ %l1x2.0720, %for.body ], [ %l1x2.3, %if.then120.critedge ], [ %l1x2.3, %if.else181 ], [ %l1x2.3, %if.end514 ]
  %l1y.4 = phi i32 [ %l1y.0721, %for.body ], [ %l1y.3, %if.then120.critedge ], [ %l1y.3, %if.else181 ], [ %l1y.3, %if.end514 ]
  %l2x1.4 = phi i32 [ %l2x1.0722, %for.body ], [ %l2x1.3, %if.then120.critedge ], [ %l2x1.3, %if.else181 ], [ %l2x1.3, %if.end514 ]
  %l2y.4 = phi i32 [ %l2y.0723, %for.body ], [ %l2y.3, %if.then120.critedge ], [ %l2y.3, %if.else181 ], [ %l2y.3, %if.end514 ]
  %next516 = getelementptr inbounds %struct.dlink1, ptr %ritePtr.0724, i64 0, i32 2
  %ritePtr.0 = load ptr, ptr %next516, align 8, !tbaa !5
  %cmp.not = icmp eq ptr %ritePtr.0, null
...
; Function Attrs: nounwind uwtable
define dso_local void @doubleDown(ptr noundef readonly %rptr) local_unnamed_addr #0 {
entry:
  %0 = load ptr, ptr @edgeList, align 8, !tbaa !5
  %1 = load i32, ptr %rptr, align 8, !tbaa !9
  ...
  %4 = load i32, ptr %start, align 4, !tbaa !15
  %5 = load ptr, ptr @Hptrs, align 8, !tbaa !5
  %6 = load ptr, ptr @Hroot, align 8, !tbaa !5
...
if.then40:                                        ; preds = %land.lhs.true33
  %17 = load ptr, ptr @Hptrs, align 8, !tbaa !5
  %18 = load ptr, ptr @Hroot, align 8, !tbaa !5
...
for.body46:                                       ; preds = %if.then40, %for.inc
  ...
  %cmp47 = icmp eq ptr %checkPtr.0180, %rptr
...
if.then77.critedge:                               ; preds = %for.inc, %if.end56, %if.then40
  ...
  store i32 %11, ptr %loc88, align 4, !tbaa !14
  ...
  tail call void @tinsert(ptr noundef nonnull @vEdgeRoot, i32 noundef %11, i32 noundef %add102) #3
  %40 = load ptr, ptr @fpdebug, align 8, !tbaa !5
  %41 = load i32, ptr @numProbes, align 4, !tbaa !23
  %call103 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %40, ptr noundef nonnull @.str.2, i32 noundef %41, i32 noundef %2, i32 noundef %10, i32 noundef %11, i32 noundef 1)
  ...
  store i32 %12, ptr %loc116, align 4, !tbaa !14
  ...
  tail call void @tinsert(ptr noundef nonnull @vEdgeRoot, i32 noundef %12, i32 noundef %add134) #3
  %59 = load ptr, ptr @fpdebug, align 8, !tbaa !5
  %60 = load i32, ptr @numProbes, align 4, !tbaa !23
  %call135 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %59, ptr noundef nonnull @.str.2, i32 noundef %60, i32 noundef %2, i32 noundef %10, i32 noundef %12, i32 noundef -1)
  %.pre = load ptr, ptr @edgeList, align 8, !tbaa !5
  br label %for.inc137
