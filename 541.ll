; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/img_chroma.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/img_chroma.c"
...
vector.memcheck305:                               ; preds = %for.body55.us.us.us.preheader
  %uglygep306 = getelementptr i8, ptr %35, i64 %22
  %uglygep307 = getelementptr i8, ptr %36, i64 2
  %uglygep308 = getelementptr i8, ptr %37, i64 2
  %bound0309 = icmp ult ptr %35, %uglygep307
  %bound1310 = icmp ult ptr %36, %uglygep306
  %found.conflict311 = and i1 %bound0309, %bound1310
  %bound0312 = icmp ult ptr %35, %uglygep308
  %bound1313 = icmp ult ptr %37, %uglygep306
...
vector.memcheck268:                               ; preds = %for.body70.us.us.us.preheader
  %uglygep269 = getelementptr i8, ptr %35, i64 %18
  %uglygep270 = getelementptr i8, ptr %35, i64 %20
  %uglygep271 = getelementptr i8, ptr %36, i64 %21
  %uglygep272 = getelementptr i8, ptr %37, i64 %21
  %bound0273 = icmp ult ptr %uglygep269, %uglygep271
  %bound1274 = icmp ult ptr %36, %uglygep270
  %found.conflict275 = and i1 %bound0273, %bound1274
  %bound0276 = icmp ult ptr %uglygep269, %uglygep272
  %bound1277 = icmp ult ptr %37, %uglygep270
...
vector.memcheck:                                  ; preds = %for.body103.lr.ph.us.us.us
  ...
  %uglygep = getelementptr i8, ptr %35, i64 %101
  %uglygep253 = getelementptr i8, ptr %35, i64 %12
  %uglygep254 = getelementptr i8, ptr %uglygep253, i64 %101
  %uglygep255 = getelementptr i8, ptr %36, i64 %14
  %uglygep256 = getelementptr i8, ptr %37, i64 %14
  %bound0 = icmp ult ptr %uglygep, %uglygep255
  %bound1 = icmp ult ptr %arrayidx105.us.us.us, %uglygep254
  %found.conflict = and i1 %bound0, %bound1
  %bound0257 = icmp ult ptr %uglygep, %uglygep256
  %bound1258 = icmp ult ptr %arrayidx109.us.us.us, %uglygep254
...
for.inc133.split.us.us:                           ; preds = %for.end128.split.us.us.us
  %wide.trip.count238.le.le = zext i32 %8 to i64
...
vector.memcheck411:                               ; preds = %for.body55.us.us.us.1.preheader
  %uglygep412 = getelementptr i8, ptr %140, i64 %127
  %uglygep413 = getelementptr i8, ptr %141, i64 2
  %uglygep414 = getelementptr i8, ptr %142, i64 2
  %bound0415 = icmp ult ptr %140, %uglygep413
  %bound1416 = icmp ult ptr %141, %uglygep412
  %found.conflict417 = and i1 %bound0415, %bound1416
  %bound0418 = icmp ult ptr %140, %uglygep414
  %bound1419 = icmp ult ptr %142, %uglygep412
...
vector.memcheck372:                               ; preds = %for.body70.us.us.us.preheader.1
  %uglygep374 = getelementptr i8, ptr %140, i64 %123
  %uglygep375 = getelementptr i8, ptr %140, i64 %125
  %uglygep376 = getelementptr i8, ptr %141, i64 %126
  %uglygep377 = getelementptr i8, ptr %142, i64 %126
  %bound0378 = icmp ult ptr %uglygep374, %uglygep376
  %bound1379 = icmp ult ptr %141, %uglygep375
  %found.conflict380 = and i1 %bound0378, %bound1379
  %bound0381 = icmp ult ptr %uglygep374, %uglygep377
  %bound1382 = icmp ult ptr %142, %uglygep375
...
vector.memcheck335:                               ; preds = %for.body103.lr.ph.us.us.us.1
  ...
  %uglygep336 = getelementptr i8, ptr %140, i64 %197
  %uglygep337 = getelementptr i8, ptr %140, i64 %117
  %uglygep338 = getelementptr i8, ptr %uglygep337, i64 %197
  %uglygep339 = getelementptr i8, ptr %141, i64 %119
  %uglygep340 = getelementptr i8, ptr %142, i64 %119
  %bound0341 = icmp ult ptr %uglygep336, %uglygep339
  %bound1342 = icmp ult ptr %arrayidx105.us.us.us.1, %uglygep338
  %found.conflict343 = and i1 %bound0341, %bound1342
  %bound0344 = icmp ult ptr %uglygep336, %uglygep340
  %bound1345 = icmp ult ptr %arrayidx109.us.us.us.1, %uglygep338
...
for.inc121.us.us.us.1:                            ; preds = %for.body103.us.us.us.1, %middle.block348, %for.cond99.preheader.us.us.us.1
  ...
  %exitcond239.1.not = icmp eq i64 %indvars.iv.next236.1, %wide.trip.count238.le.le
