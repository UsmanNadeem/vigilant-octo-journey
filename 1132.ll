; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/Tar/TarOut.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/Tar/TarOut.cpp"
...
if.end11:                                         ; preds = %_ZN8NArchive4NTarL16MakeOctalString8EPcj.exit138
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %tempString.i139) #13
...
_ZN8NArchive4NTarL16MakeOctalString8EPcj.exit161: ; preds = %cleanup.i159, %delete.notnull.i.i160
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %tempString.i139) #13
...
if.end15:                                         ; preds = %_ZN8NArchive4NTarL16MakeOctalString8EPcj.exit161
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %tempString.i162) #13
...
for.body13.preheader.i:                           ; preds = %if.end.i168
  ...
  call void @llvm.memset.p0.i64(ptr nonnull align 4 %add.ptr16, i8 32, i64 %29, i1 false), !tbaa !12
...
_ZN8NArchive4NTarL17MakeOctalString12EPcy.exit:   ; preds = %cleanup.i172, %delete.notnull.i.i173
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %tempString.i162) #13
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %tempString.i174) #13
...
for.body13.preheader.i203:                        ; preds = %if.end.i201
  ...
  call void @llvm.memset.p0.i64(ptr nonnull align 8 %add.ptr17, i8 32, i64 %37, i1 false), !tbaa !12
...
_ZN8NArchive4NTarL17MakeOctalString12EPcy.exit211: ; preds = %cleanup.i209, %delete.notnull.i.i210
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %tempString.i174) #13
...
call.i.i.noexc:                                   ; preds = %if.end.i.i
  %call.i.i74121 = ptrtoint ptr %call.i.i74 to i64
...
vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check122 = icmp ult i32 %6, 32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load123 = load <16 x i8>, ptr %11, align 1, !tbaa !12
  %12 = getelementptr inbounds i8, ptr %call.i.i74, i64 %index
  store <16 x i8> %wide.load, ptr %12, align 1, !tbaa !12
  %13 = getelementptr inbounds i8, ptr %12, i64 16
  store <16 x i8> %wide.load123, ptr %13, align 1, !tbaa !12
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec125 = and i64 %wide.trip.count.i.i, 4294967288
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index127 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next129, %vec.epilog.vector.body ]
  %15 = getelementptr inbounds i8, ptr %7, i64 %index127
  %wide.load128 = load <8 x i8>, ptr %15, align 1, !tbaa !12
  %16 = getelementptr inbounds i8, ptr %call.i.i74, i64 %index127
  store <8 x i8> %wide.load128, ptr %16, align 1, !tbaa !12
  %index.next129 = add nuw i64 %index127, 8
  %17 = icmp eq i64 %index.next129, %n.vec125
  br i1 %17, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !42

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n126 = icmp eq i64 %n.vec125, %wide.trip.count.i.i
  br i1 %cmp.n126, label %delete.notnull.i.i, label %for.body.i.i.preheader

for.body.i.i.preheader:                           ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv.i6.i.ph = phi i64 [ 0, %iter.check ], [ %n.vec, %vec.epilog.iter.check ], [ %n.vec125, %vec.epilog.middle.block ]
...
delete.notnull.i.i:                               ; preds = %for.body.i.i.prol.loopexit, %for.body.i.i, %middle.block, %vec.epilog.middle.block, %for.cond.cleanup.i.i
  call void @_ZdaPv(ptr noundef nonnull %7) #14
...
while.cond.i.i.preheader:                         ; preds = %if.end9.i.i, %_Z11MyStringLenIcEiPKT_.exit._ZN11CStringBaseIcE11SetCapacityEi.exit_crit_edge.i
  %dest.addr.0.i.i.ph = phi ptr [ %.pre.i, %_Z11MyStringLenIcEiPKT_.exit._ZN11CStringBaseIcE11SetCapacityEi.exit_crit_edge.i ], [ %call.i.i74, %if.end9.i.i ]
  br label %while.cond.i.i
...
cleanup.cont:                                     ; preds = %invoke.cont7
  ...
  %call2.i76 = invoke noundef i32 @_Z11WriteStreamP20ISequentialOutStreamPKvm(ptr noundef %32, ptr noundef %31, i64 noundef %conv)
...
cleanup.cont24:                                   ; preds = %invoke.cont17
  ...
  br i1 %cmp.i, label %cleanup.cont35, label %for.cond.cleanup.i

for.cond.cleanup.i:                               ; preds = %cleanup.cont24
  ...
  call void @llvm.memset.p0.i64(ptr nonnull align 16 %residualBytes.i, i8 0, i64 %34, i1 false), !tbaa !12
  %35 = load ptr, ptr %this, align 8, !tbaa !5
  %call2.i.i78 = invoke noundef i32 @_Z11WriteStreamP20ISequentialOutStreamPKvm(ptr noundef %35, ptr noundef nonnull %residualBytes.i, i64 noundef %34)
          to label %invoke.cont28 unwind label %lpad27

invoke.cont28:                                    ; preds = %for.cond.cleanup.i
...
lpad27:                                           ; preds = %for.cond.cleanup.i
...
invoke.cont40:                                    ; preds = %invoke.cont36
  ...
  %_length.i80 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp, i64 0, i32 1
  %38 = load i32, ptr %_length.i80, align 8, !tbaa !13
  %add.i.i81 = add nsw i32 %38, 1
  %39 = load i32, ptr %_capacity.i.i, align 4, !tbaa !40
  %cmp.i.i83 = icmp eq i32 %add.i.i81, %39
  br i1 %cmp.i.i83, label %if.end._ZN11CStringBaseIcE11SetCapacityEi.exit_crit_edge.i, label %if.end.i.i87

if.end._ZN11CStringBaseIcE11SetCapacityEi.exit_crit_edge.i: ; preds = %invoke.cont40
  %.pre.i84 = load ptr, ptr %modifiedItem, align 8, !tbaa !16
  br label %_ZN11CStringBaseIcE11SetCapacityEi.exit.i104

if.end.i.i87:                                     ; preds = %invoke.cont40
  %conv.i.i85 = sext i32 %add.i.i81 to i64
  %call.i.i112 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i85) #15
          to label %call.i.i.noexc111 unwind label %lpad42

call.i.i.noexc111:                                ; preds = %if.end.i.i87
  %call.i.i112131 = ptrtoint ptr %call.i.i112 to i64
  %cmp3.i.i86 = icmp sgt i32 %39, 0
  br i1 %cmp3.i.i86, label %for.cond.preheader.i.i89, label %if.end9.i.i103

for.cond.preheader.i.i89:                         ; preds = %call.i.i.noexc111
  %40 = load i32, ptr %_length.i.i, align 8, !tbaa !13
  %cmp522.i.i88 = icmp sgt i32 %40, 0
  %41 = load ptr, ptr %modifiedItem, align 8, !tbaa !16
  br i1 %cmp522.i.i88, label %iter.check136, label %for.cond.cleanup.i.i93

iter.check136:                                    ; preds = %for.cond.preheader.i.i89
  %42 = ptrtoint ptr %41 to i64
  %wide.trip.count.i.i90 = zext i32 %40 to i64
  %min.iters.check134 = icmp ult i32 %40, 8
  %43 = sub i64 %call.i.i112131, %42
  %diff.check132 = icmp ult i64 %43, 32
  %or.cond163 = select i1 %min.iters.check134, i1 true, i1 %diff.check132
  br i1 %or.cond163, label %for.body.i.i99.preheader, label %vector.main.loop.iter.check138

vector.main.loop.iter.check138:                   ; preds = %iter.check136
  %min.iters.check137 = icmp ult i32 %40, 32
  br i1 %min.iters.check137, label %vec.epilog.ph151, label %vector.ph139

vector.ph139:                                     ; preds = %vector.main.loop.iter.check138
  %n.vec141 = and i64 %wide.trip.count.i.i90, 4294967264
...
vector.body143:                                   ; preds = %vector.body143, %vector.ph139
  ...
  %44 = getelementptr inbounds i8, ptr %41, i64 %index144
  %wide.load145 = load <16 x i8>, ptr %44, align 1, !tbaa !12
  %45 = getelementptr inbounds i8, ptr %44, i64 16
  %wide.load146 = load <16 x i8>, ptr %45, align 1, !tbaa !12
  %46 = getelementptr inbounds i8, ptr %call.i.i112, i64 %index144
  store <16 x i8> %wide.load145, ptr %46, align 1, !tbaa !12
  %47 = getelementptr inbounds i8, ptr %46, i64 16
  store <16 x i8> %wide.load146, ptr %47, align 1, !tbaa !12
  %index.next147 = add nuw i64 %index144, 32
  %48 = icmp eq i64 %index.next147, %n.vec141
  br i1 %48, label %middle.block133, label %vector.body143, !llvm.loop !46

middle.block133:                                  ; preds = %vector.body143
  %cmp.n142 = icmp eq i64 %n.vec141, %wide.trip.count.i.i90
  br i1 %cmp.n142, label %delete.notnull.i.i100, label %vec.epilog.iter.check150

vec.epilog.iter.check150:                         ; preds = %middle.block133
  %n.vec.remaining152 = and i64 %wide.trip.count.i.i90, 24
  %min.epilog.iters.check153 = icmp eq i64 %n.vec.remaining152, 0
  br i1 %min.epilog.iters.check153, label %for.body.i.i99.preheader, label %vec.epilog.ph151

vec.epilog.ph151:                                 ; preds = %vector.main.loop.iter.check138, %vec.epilog.iter.check150
  %vec.epilog.resume.val154 = phi i64 [ %n.vec141, %vec.epilog.iter.check150 ], [ 0, %vector.main.loop.iter.check138 ]
  %n.vec156 = and i64 %wide.trip.count.i.i90, 4294967288
  br label %vec.epilog.vector.body159

vec.epilog.vector.body159:                        ; preds = %vec.epilog.vector.body159, %vec.epilog.ph151
  %index160 = phi i64 [ %vec.epilog.resume.val154, %vec.epilog.ph151 ], [ %index.next162, %vec.epilog.vector.body159 ]
  %49 = getelementptr inbounds i8, ptr %41, i64 %index160
  %wide.load161 = load <8 x i8>, ptr %49, align 1, !tbaa !12
  %50 = getelementptr inbounds i8, ptr %call.i.i112, i64 %index160
  store <8 x i8> %wide.load161, ptr %50, align 1, !tbaa !12
  %index.next162 = add nuw i64 %index160, 8
  %51 = icmp eq i64 %index.next162, %n.vec156
  br i1 %51, label %vec.epilog.middle.block148, label %vec.epilog.vector.body159, !llvm.loop !47

vec.epilog.middle.block148:                       ; preds = %vec.epilog.vector.body159
  %cmp.n158 = icmp eq i64 %n.vec156, %wide.trip.count.i.i90
  br i1 %cmp.n158, label %delete.notnull.i.i100, label %for.body.i.i99.preheader

for.body.i.i99.preheader:                         ; preds = %iter.check136, %vec.epilog.iter.check150, %vec.epilog.middle.block148
  %indvars.iv.i.i94.ph = phi i64 [ 0, %iter.check136 ], [ %n.vec141, %vec.epilog.iter.check150 ], [ %n.vec156, %vec.epilog.middle.block148 ]
  %52 = xor i64 %indvars.iv.i.i94.ph, -1
  %53 = add nsw i64 %52, %wide.trip.count.i.i90
  %xtraiter164 = and i64 %wide.trip.count.i.i90, 3
  %lcmp.mod165.not = icmp eq i64 %xtraiter164, 0
  br i1 %lcmp.mod165.not, label %for.body.i.i99.prol.loopexit, label %for.body.i.i99.prol
...
for.body.i.i99.prol:                              ; preds = %for.body.i.i99.preheader, %for.body.i.i99.prol
  ...
  %prol.iter166 = phi i64 [ %prol.iter166.next, %for.body.i.i99.prol ], [ 0, %for.body.i.i99.preheader ]
  %arrayidx.i.i95.prol = getelementptr inbounds i8, ptr %41, i64 %indvars.iv.i.i94.prol
  %54 = load i8, ptr %arrayidx.i.i95.prol, align 1, !tbaa !12
  %arrayidx7.i.i96.prol = getelementptr inbounds i8, ptr %call.i.i112, i64 %indvars.iv.i.i94.prol
  store i8 %54, ptr %arrayidx7.i.i96.prol, align 1, !tbaa !12
  %indvars.iv.next.i.i97.prol = add nuw nsw i64 %indvars.iv.i.i94.prol, 1
  %prol.iter166.next = add i64 %prol.iter166, 1
  %prol.iter166.cmp.not = icmp eq i64 %prol.iter166.next, %xtraiter164
  br i1 %prol.iter166.cmp.not, label %for.body.i.i99.prol.loopexit, label %for.body.i.i99.prol, !llvm.loop !48
...
for.body.i.i99.prol.loopexit:                     ; preds = %for.body.i.i99.prol, %for.body.i.i99.preheader
  ...
  br i1 %55, label %delete.notnull.i.i100, label %for.body.i.i99

for.cond.cleanup.i.i93:                           ; preds = %for.cond.preheader.i.i89
  %isnull.i.i92 = icmp eq ptr %41, null
...
for.body.i.i99:                                   ; preds = %for.body.i.i99.prol.loopexit, %for.body.i.i99
  ...
  %arrayidx.i.i95 = getelementptr inbounds i8, ptr %41, i64 %indvars.iv.i.i94
  %56 = load i8, ptr %arrayidx.i.i95, align 1, !tbaa !12
  %arrayidx7.i.i96 = getelementptr inbounds i8, ptr %call.i.i112, i64 %indvars.iv.i.i94
  store i8 %56, ptr %arrayidx7.i.i96, align 1, !tbaa !12
  %indvars.iv.next.i.i97 = add nuw nsw i64 %indvars.iv.i.i94, 1
  %arrayidx.i.i95.1 = getelementptr inbounds i8, ptr %41, i64 %indvars.iv.next.i.i97
  %57 = load i8, ptr %arrayidx.i.i95.1, align 1, !tbaa !12
  %arrayidx7.i.i96.1 = getelementptr inbounds i8, ptr %call.i.i112, i64 %indvars.iv.next.i.i97
  store i8 %57, ptr %arrayidx7.i.i96.1, align 1, !tbaa !12
  %indvars.iv.next.i.i97.1 = add nuw nsw i64 %indvars.iv.i.i94, 2
  %arrayidx.i.i95.2 = getelementptr inbounds i8, ptr %41, i64 %indvars.iv.next.i.i97.1
  %58 = load i8, ptr %arrayidx.i.i95.2, align 1, !tbaa !12
  %arrayidx7.i.i96.2 = getelementptr inbounds i8, ptr %call.i.i112, i64 %indvars.iv.next.i.i97.1
  store i8 %58, ptr %arrayidx7.i.i96.2, align 1, !tbaa !12
  %indvars.iv.next.i.i97.2 = add nuw nsw i64 %indvars.iv.i.i94, 3
  %arrayidx.i.i95.3 = getelementptr inbounds i8, ptr %41, i64 %indvars.iv.next.i.i97.2
  %59 = load i8, ptr %arrayidx.i.i95.3, align 1, !tbaa !12
  %arrayidx7.i.i96.3 = getelementptr inbounds i8, ptr %call.i.i112, i64 %indvars.iv.next.i.i97.2
  store i8 %59, ptr %arrayidx7.i.i96.3, align 1, !tbaa !12
  ...
  br i1 %exitcond.not.i.i98.3, label %delete.notnull.i.i100, label %for.body.i.i99, !llvm.loop !49

delete.notnull.i.i100:                            ; preds = %for.body.i.i99.prol.loopexit, %for.body.i.i99, %middle.block133, %vec.epilog.middle.block148, %for.cond.cleanup.i.i93
  call void @_ZdaPv(ptr noundef nonnull %41) #14
  br label %if.end9.i.i103

if.end9.i.i103:                                   ; preds = %delete.notnull.i.i100, %for.cond.cleanup.i.i93, %call.i.i.noexc111
  store ptr %call.i.i112, ptr %modifiedItem, align 8, !tbaa !16
  %60 = load i32, ptr %_length.i.i, align 8, !tbaa !13
  %idxprom13.i.i101 = sext i32 %60 to i64
  %arrayidx14.i.i102 = getelementptr inbounds i8, ptr %call.i.i112, i64 %idxprom13.i.i101
  store i8 0, ptr %arrayidx14.i.i102, align 1, !tbaa !12
  store i32 %add.i.i81, ptr %_capacity.i.i, align 4, !tbaa !40
  br label %_ZN11CStringBaseIcE11SetCapacityEi.exit.i104

_ZN11CStringBaseIcE11SetCapacityEi.exit.i104:     ; preds = %if.end9.i.i103, %if.end._ZN11CStringBaseIcE11SetCapacityEi.exit_crit_edge.i
  %61 = phi ptr [ %.pre.i84, %if.end._ZN11CStringBaseIcE11SetCapacityEi.exit_crit_edge.i ], [ %call.i.i112, %if.end9.i.i103 ]
  %62 = load ptr, ptr %ref.tmp, align 8, !tbaa !16
  br label %while.cond.i.i110

while.cond.i.i110:                                ; preds = %while.cond.i.i110, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i104
  %src.addr.0.i.i105 = phi ptr [ %62, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i104 ], [ %incdec.ptr.i.i107, %while.cond.i.i110 ]
  %dest.addr.0.i.i106 = phi ptr [ %61, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i104 ], [ %incdec.ptr1.i.i108, %while.cond.i.i110 ]
  %incdec.ptr.i.i107 = getelementptr inbounds i8, ptr %src.addr.0.i.i105, i64 1
  %63 = load i8, ptr %src.addr.0.i.i105, align 1, !tbaa !12
  %incdec.ptr1.i.i108 = getelementptr inbounds i8, ptr %dest.addr.0.i.i106, i64 1
  store i8 %63, ptr %dest.addr.0.i.i106, align 1, !tbaa !12
  %cmp.not.i.i109 = icmp eq i8 %63, 0
  br i1 %cmp.not.i.i109, label %invoke.cont43, label %while.cond.i.i110, !llvm.loop !23

invoke.cont43:                                    ; preds = %while.cond.i.i110
  %64 = load i32, ptr %_length.i80, align 8, !tbaa !13
...
lpad42:                                           ; preds = %if.end.i.i87
  %67 = landingpad { ptr, i32 }
          cleanup
  %68 = load ptr, ptr %ref.tmp, align 8, !tbaa !16
  %isnull.i113 = icmp eq ptr %68, null
  br i1 %isnull.i113, label %ehcleanup, label %delete.notnull.i114

delete.notnull.i114:                              ; preds = %lpad42
  call void @_ZdaPv(ptr noundef nonnull %68) #14
  br label %ehcleanup

ehcleanup:                                        ; preds = %delete.notnull.i114, %lpad42, %lpad39
  %.pn = phi { ptr, i32 } [ %66, %lpad39 ], [ %67, %lpad42 ], [ %67, %delete.notnull.i114 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp) #13
  br label %ehcleanup48
...
cleanup47:                                        ; preds = %_ZN11CStringBaseIcED2Ev.exit, %invoke.cont28, %invoke.cont17, %invoke.cont7
  ...
  %isnull.i.i116 = icmp eq ptr %69, null
  br i1 %isnull.i.i116, label %_ZN11CStringBaseIcED2Ev.exit.i, label %delete.notnull.i.i117

delete.notnull.i.i117:                            ; preds = %cleanup47
  call void @_ZdaPv(ptr noundef nonnull %69) #14
  br label %_ZN11CStringBaseIcED2Ev.exit.i

_ZN11CStringBaseIcED2Ev.exit.i:                   ; preds = %delete.notnull.i.i117, %cleanup47
...
ehcleanup48:                                      ; preds = %ehcleanup, %lpad27, %lpad14, %lpad6, %lpad
  %.pn71 = phi { ptr, i32 } [ %29, %lpad ], [ %.pn, %ehcleanup ], [ %36, %lpad27 ], [ %33, %lpad14 ], [ %30, %lpad6 ]
...
if.end9.i.i27:                                    ; preds = %_ZN11CStringBaseIcEC2ERKS0_.exit
  ...
  %call.i.i2636 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i25) #15
...
call.i.i26.noexc:                                 ; preds = %if.end9.i.i27
  ...
  store ptr %call.i.i2636, ptr %LinkName, align 8, !tbaa !16
  store i8 0, ptr %call.i.i2636, align 1, !tbaa !12
  store i32 %add.i.i22, ptr %_capacity.i24, align 4, !tbaa !40
...
while.cond.i.i34:                                 ; preds = %while.cond.i.i34, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i28
  ...
  %8 = load i8, ptr %src.addr.0.i.i29, align 1, !tbaa !12
  %incdec.ptr1.i.i32 = getelementptr inbounds i8, ptr %dest.addr.0.i.i30, i64 1
  store i8 %8, ptr %dest.addr.0.i.i30, align 1, !tbaa !12
  %cmp.not.i.i33 = icmp eq i8 %8, 0
  br i1 %cmp.not.i.i33, label %invoke.cont, label %while.cond.i.i34, !llvm.loop !23
...
if.end9.i.i44:                                    ; preds = %invoke.cont
  ...
  %call.i.i4353 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i42) #15
...
call.i.i43.noexc:                                 ; preds = %if.end9.i.i44
  ...
  store ptr %call.i.i4353, ptr %User, align 8, !tbaa !16
  store i8 0, ptr %call.i.i4353, align 1, !tbaa !12
  store i32 %add.i.i39, ptr %_capacity.i41, align 4, !tbaa !40
...
while.cond.i.i51:                                 ; preds = %while.cond.i.i51, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i45
  ...
  %12 = load i8, ptr %src.addr.0.i.i46, align 1, !tbaa !12
  %incdec.ptr1.i.i49 = getelementptr inbounds i8, ptr %dest.addr.0.i.i47, i64 1
  store i8 %12, ptr %dest.addr.0.i.i47, align 1, !tbaa !12
  %cmp.not.i.i50 = icmp eq i8 %12, 0
  br i1 %cmp.not.i.i50, label %invoke.cont7, label %while.cond.i.i51, !llvm.loop !23
...
if.end9.i.i61:                                    ; preds = %invoke.cont7
  ...
  %call.i.i6070 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i59) #15
...
call.i.i60.noexc:                                 ; preds = %if.end9.i.i61
  ...
  store ptr %call.i.i6070, ptr %Group, align 8, !tbaa !16
  store i8 0, ptr %call.i.i6070, align 1, !tbaa !12
  store i32 %add.i.i56, ptr %_capacity.i58, align 4, !tbaa !40
...
while.cond.i.i68:                                 ; preds = %while.cond.i.i68, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i62
  ...
  %16 = load i8, ptr %src.addr.0.i.i63, align 1, !tbaa !12
  %incdec.ptr1.i.i66 = getelementptr inbounds i8, ptr %dest.addr.0.i.i64, i64 1
  store i8 %16, ptr %dest.addr.0.i.i64, align 1, !tbaa !12
  %cmp.not.i.i67 = icmp eq i8 %16, 0
  br i1 %cmp.not.i.i67, label %invoke.cont10, label %while.cond.i.i68, !llvm.loop !23
...
entry:
  ...
  br i1 %cmp, label %cleanup, label %for.cond.cleanup

for.cond.cleanup:                                 ; preds = %entry
  call void @llvm.lifetime.start.p0(i64 512, ptr nonnull %residualBytes) #13
  %sub = sub nuw nsw i32 512, %conv
  %1 = zext i32 %sub to i64
  call void @llvm.memset.p0.i64(ptr nonnull align 16 %residualBytes, i8 0, i64 %1, i1 false), !tbaa !12
...
cleanup:                                          ; preds = %entry, %for.cond.cleanup
  %retval.0 = phi i32 [ %call2.i, %for.cond.cleanup ], [ 0, %entry ]
  ret i32 %retval.0
}
...
if.end.i.i28:                                     ; preds = %if.end.i22
  ...
  %call.i.i26 = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i25) #15
...
if.end.i.i66:                                     ; preds = %if.end.i60
  ...
  %call.i.i64 = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i63) #15
...
delete.notnull.i.i79:                             ; preds = %for.body.i.i78.prol.loopexit, %for.body.i.i78, %middle.block183, %vec.epilog.middle.block198, %for.cond.cleanup.i.i72
  tail call void @_ZdaPv(ptr noundef nonnull %61) #14
...
if.end.i.i104:                                    ; preds = %if.end.i98
  ...
  %call.i.i102 = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i101) #15
...
if.end8:                                          ; preds = %entry
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %agg.result, i8 0, i64 16, i1 false)
  %call.i.i32 = tail call noalias noundef nonnull dereferenceable(4) ptr @_Znam(i64 noundef 4) #15
