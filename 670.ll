; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_filetypes.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_filetypes.c"
...
if.then15:                                        ; preds = %if.then
  ...
  %descr = getelementptr inbounds [64 x %struct.cli_magic_s], ptr @cli_magic, i64 0, i64 %idxprom.le, i32 3
  %3 = load ptr, ptr %descr, align 8, !tbaa !12
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str, ptr noundef %3) #10
  %type = getelementptr inbounds [64 x %struct.cli_magic_s], ptr @cli_magic, i64 0, i64 %idxprom.le, i32 4
...
if.then15.i:                                      ; preds = %if.then.i
  ...
  %descr.i = getelementptr inbounds [64 x %struct.cli_magic_s], ptr @cli_magic, i64 0, i64 %idxprom.le.i, i32 3
  %3 = load ptr, ptr %descr.i, align 8, !tbaa !12
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str, ptr noundef %3) #10
  %type.i = getelementptr inbounds [64 x %struct.cli_magic_s], ptr @cli_magic, i64 0, i64 %idxprom.le.i, i32 4
