; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/lua/ltablib.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/lua/ltablib.c"
...
entry:
  tail call void @luaL_register(ptr noundef %L, ptr noundef nonnull @.str, ptr noundef nonnull @tab_funcs) #4
  ret i32 1
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8216, ptr nonnull %b) #4
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %lsep) #4
  %call = call ptr @luaL_optlstring(ptr noundef %L, i32 noundef 2, ptr noundef nonnull @.str.10, ptr noundef nonnull %lsep) #4
  call void @luaL_checktype(ptr noundef %L, i32 noundef 1, i32 noundef 5) #4
  %call1 = call i64 @luaL_optinteger(ptr noundef %L, i32 noundef 3, i64 noundef 1) #4
  %conv = trunc i64 %call1 to i32
  %call2 = call i32 @lua_type(ptr noundef %L, i32 noundef 4) #4
  %cmp = icmp slt i32 %call2, 1
  br i1 %cmp, label %cond.true, label %cond.false

cond.true:                                        ; preds = %entry
  %call4 = call i64 @lua_objlen(ptr noundef %L, i32 noundef 1) #4
  br label %cond.end

cond.false:                                       ; preds = %entry
  %call6 = call i64 @luaL_checkinteger(ptr noundef %L, i32 noundef 4) #4
  br label %cond.end
...
for.body:                                         ; preds = %cond.end, %addfield.exit
  ...
  call void @lua_rawgeti(ptr noundef %L, i32 noundef 1, i32 noundef %i.033) #4
  %call.i = call i32 @lua_isstring(ptr noundef %L, i32 noundef -1) #4
  %tobool.not.i = icmp eq i32 %call.i, 0
  br i1 %tobool.not.i, label %if.then.i, label %addfield.exit

if.then.i:                                        ; preds = %for.body
  %call1.i = call i32 @lua_type(ptr noundef %L, i32 noundef -1) #4
  %call2.i = call ptr @lua_typename(ptr noundef %L, i32 noundef %call1.i) #4
  %call3.i = call i32 (ptr, ptr, ...) @luaL_error(ptr noundef %L, ptr noundef nonnull @.str.11, ptr noundef %call2.i, i32 noundef %i.033) #4
...
addfield.exit:                                    ; preds = %for.body, %if.then.i
  ...
  call void @luaL_addlstring(ptr noundef nonnull %b, ptr noundef %call, i64 noundef %0) #4
  %inc = add i32 %i.033, 1
...
if.then:                                          ; preds = %addfield.exit, %for.end
  call void @lua_rawgeti(ptr noundef %L, i32 noundef 1, i32 noundef %cond) #4
  %call.i25 = call i32 @lua_isstring(ptr noundef %L, i32 noundef -1) #4
...
if.then.i30:                                      ; preds = %if.then
  %call1.i27 = call i32 @lua_type(ptr noundef %L, i32 noundef -1) #4
  %call2.i28 = call ptr @lua_typename(ptr noundef %L, i32 noundef %call1.i27) #4
  %call3.i29 = call i32 (ptr, ptr, ...) @luaL_error(ptr noundef %L, ptr noundef nonnull @.str.11, ptr noundef %call2.i28, i32 noundef %cond) #4
...
if.end:                                           ; preds = %addfield.exit31, %for.end
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %lsep) #4
  call void @llvm.lifetime.end.p0(i64 8216, ptr nonnull %b) #4
  ret i32 1
}
...
entry:
  ...
  %call11 = tail call i32 @lua_next(ptr noundef %L, i32 noundef 1) #4
...
while.body:                                       ; preds = %entry, %if.end
  ...
  tail call void @lua_pushvalue(ptr noundef %L, i32 noundef -3) #4
  tail call void @lua_call(ptr noundef %L, i32 noundef 2, i32 noundef 1) #4
  %call1 = tail call i32 @lua_type(ptr noundef %L, i32 noundef -1) #4
  %cmp = icmp eq i32 %call1, 0
  br i1 %cmp, label %if.end, label %return

if.end:                                           ; preds = %while.body
  tail call void @lua_settop(ptr noundef %L, i32 noundef -3) #4
  %call = tail call i32 @lua_next(ptr noundef %L, i32 noundef 1) #4
...
entry:
  tail call void @luaL_checktype(ptr noundef %L, i32 noundef 1, i32 noundef 5) #4
  %call = tail call i64 @lua_objlen(ptr noundef %L, i32 noundef 1) #4
...
for.body:                                         ; preds = %for.body.preheader, %if.end
  ...
  tail call void @lua_pushvalue(ptr noundef %L, i32 noundef 2) #4
  tail call void @lua_pushinteger(ptr noundef %L, i64 noundef %indvars.iv) #4
  %1 = trunc i64 %indvars.iv to i32
  tail call void @lua_rawgeti(ptr noundef %L, i32 noundef 1, i32 noundef %1) #4
  tail call void @lua_call(ptr noundef %L, i32 noundef 2, i32 noundef 1) #4
  %call3 = tail call i32 @lua_type(ptr noundef %L, i32 noundef -1) #4
...
entry:
  tail call void @luaL_checktype(ptr noundef %L, i32 noundef 1, i32 noundef 5) #4
  tail call void @lua_pushnil(ptr noundef %L) #4
  %call14 = tail call i32 @lua_next(ptr noundef %L, i32 noundef 1) #4
...
if.then:                                          ; preds = %while.body
  %call2 = tail call double @lua_tonumber(ptr noundef %L, i32 noundef -1) #4
...
while.end:                                        ; preds = %if.end5, %entry
  ...
  tail call void @lua_pushnumber(ptr noundef %L, double noundef %max.0.lcssa) #4
  ret i32 1
}
...
sw.bb2:                                           ; preds = %entry
  ...
  br i1 %cmp625.not, label %sw.epilog, label %for.body.preheader

for.body.preheader:                               ; preds = %sw.bb2
  %spec.select = tail call i32 @llvm.smax.i32(i32 %add, i32 %conv4)
  br label %for.body

for.body:                                         ; preds = %for.body.preheader, %for.body
  %i.026 = phi i32 [ %sub, %for.body ], [ %spec.select, %for.body.preheader ]
  %sub = add nsw i32 %i.026, -1
  tail call void @lua_rawgeti(ptr noundef %L, i32 noundef 1, i32 noundef %sub) #4
  tail call void @lua_rawseti(ptr noundef %L, i32 noundef 1, i32 noundef %i.026) #4
  %cmp6 = icmp sgt i32 %sub, %conv4
  br i1 %cmp6, label %for.body, label %sw.epilog, !llvm.loop !14

sw.default:                                       ; preds = %entry
  %call8 = tail call i32 (ptr, ptr, ...) @luaL_error(ptr noundef %L, ptr noundef nonnull @.str.12) #4
  br label %cleanup

sw.epilog:                                        ; preds = %for.body, %sw.bb2, %entry
  %pos.0 = phi i32 [ %add, %entry ], [ %conv4, %sw.bb2 ], [ %conv4, %for.body ]
  tail call void @lua_rawseti(ptr noundef %L, i32 noundef 1, i32 noundef %pos.0) #4
  br label %cleanup
...
entry:
  ...
  %sext = shl i64 %call, 32
  %conv1 = ashr exact i64 %sext, 32
  %call2 = tail call i64 @luaL_optinteger(ptr noundef %L, i32 noundef 2, i64 noundef %conv1) #4
...
if.end:                                           ; preds = %entry
  tail call void @lua_rawgeti(ptr noundef %L, i32 noundef 1, i32 noundef %conv3) #4
...
for.body:                                         ; preds = %if.end, %for.body
  ...
  tail call void @lua_rawgeti(ptr noundef %L, i32 noundef 1, i32 noundef %add) #4
  tail call void @lua_rawseti(ptr noundef %L, i32 noundef 1, i32 noundef %pos.027) #4
  %exitcond.not = icmp eq i32 %add, %conv
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !15

for.end:                                          ; preds = %for.body, %if.end
  tail call void @lua_pushnil(ptr noundef %L) #4
  tail call void @lua_rawseti(ptr noundef %L, i32 noundef 1, i32 noundef %conv) #4
  br label %cleanup
...
entry:
  tail call void @luaL_checktype(ptr noundef %L, i32 noundef 1, i32 noundef 5) #4
  %call = tail call i32 (ptr, ptr, ...) @luaL_error(ptr noundef %L, ptr noundef nonnull @.str.13) #4
...
entry:
  tail call void @luaL_checktype(ptr noundef %L, i32 noundef 1, i32 noundef 5) #4
  %call = tail call i64 @lua_objlen(ptr noundef %L, i32 noundef 1) #4
  tail call void @luaL_checkstack(ptr noundef %L, i32 noundef 40, ptr noundef nonnull @.str.10) #4
...
while.body:                                       ; preds = %entry, %if.then39
  ...
  tail call void @lua_rawgeti(ptr noundef %L, i32 noundef 1, i32 noundef %l.addr.0146) #4
  tail call void @lua_rawgeti(ptr noundef %L, i32 noundef 1, i32 noundef %u.addr.0147) #4
  %call = tail call fastcc i32 @sort_comp(ptr noundef %L, i32 noundef -1, i32 noundef -2)
  %tobool.not = icmp eq i32 %call, 0
  br i1 %tobool.not, label %if.else, label %if.then

if.then:                                          ; preds = %while.body
  tail call void @lua_rawseti(ptr noundef %L, i32 noundef 1, i32 noundef %l.addr.0146) #4
  tail call void @lua_rawseti(ptr noundef %L, i32 noundef 1, i32 noundef %u.addr.0147) #4
  br label %if.end
...
if.end3:                                          ; preds = %if.end
  ...
  %div = sdiv i32 %add, 2
  tail call void @lua_rawgeti(ptr noundef %L, i32 noundef 1, i32 noundef %div) #4
  tail call void @lua_rawgeti(ptr noundef %L, i32 noundef 1, i32 noundef %l.addr.0146) #4
...
if.then6:                                         ; preds = %if.end3
  tail call void @lua_rawseti(ptr noundef %L, i32 noundef 1, i32 noundef %div) #4
  tail call void @lua_rawseti(ptr noundef %L, i32 noundef 1, i32 noundef %l.addr.0146) #4
  br label %if.end13
...
if.end17:                                         ; preds = %if.end13
  ...
  tail call void @lua_rawgeti(ptr noundef %L, i32 noundef 1, i32 noundef %sub18) #4
  br label %for.cond
...
while.cond21:                                     ; preds = %if.end28, %for.cond
  ...
  tail call void @lua_rawgeti(ptr noundef %L, i32 noundef 1, i32 noundef %inc) #4
  %call.i = tail call i32 @lua_type(ptr noundef %L, i32 noundef 2) #4
...
if.then.i:                                        ; preds = %while.cond21
  ...
  tail call void @lua_call(ptr noundef %L, i32 noundef 2, i32 noundef 1) #4
  %call2.i = tail call i32 @lua_toboolean(ptr noundef %L, i32 noundef -1) #4
  tail call void @lua_settop(ptr noundef %L, i32 noundef -2) #4
  br label %sort_comp.exit

if.else.i:                                        ; preds = %while.cond21
  %call3.i = tail call i32 @lua_lessthan(ptr noundef %L, i32 noundef -1, i32 noundef -2) #4
  br label %sort_comp.exit
...
if.then26:                                        ; preds = %while.body24
  %call27 = tail call i32 (ptr, ptr, ...) @luaL_error(ptr noundef %L, ptr noundef nonnull @.str.14) #4
  br label %if.end28
...
while.cond29:                                     ; preds = %sort_comp.exit, %if.end36
  ...
  tail call void @lua_rawgeti(ptr noundef %L, i32 noundef 1, i32 noundef %dec) #4
  %call.i133 = tail call i32 @lua_type(ptr noundef %L, i32 noundef 2) #4
...
if.then.i136:                                     ; preds = %while.cond29
  ...
  tail call void @lua_pushvalue(ptr noundef %L, i32 noundef -3) #4
  tail call void @lua_call(ptr noundef %L, i32 noundef 2, i32 noundef 1) #4
  %call2.i135 = tail call i32 @lua_toboolean(ptr noundef %L, i32 noundef -1) #4
  tail call void @lua_settop(ptr noundef %L, i32 noundef -2) #4
  br label %sort_comp.exit140

if.else.i138:                                     ; preds = %while.cond29
  %call3.i137 = tail call i32 @lua_lessthan(ptr noundef %L, i32 noundef -3, i32 noundef -1) #4
  br label %sort_comp.exit140
...
if.then34:                                        ; preds = %while.body32
  %call35 = tail call i32 (ptr, ptr, ...) @luaL_error(ptr noundef %L, ptr noundef nonnull @.str.14) #4
  br label %if.end36
...
if.then39:                                        ; preds = %while.end37
  tail call void @lua_settop(ptr noundef %L, i32 noundef -4) #4
  tail call void @lua_rawgeti(ptr noundef %L, i32 noundef 1, i32 noundef %sub18) #4
  tail call void @lua_rawgeti(ptr noundef %L, i32 noundef 1, i32 noundef %inc) #4
  tail call void @lua_rawseti(ptr noundef %L, i32 noundef 1, i32 noundef %sub18) #4
  tail call void @lua_rawseti(ptr noundef %L, i32 noundef 1, i32 noundef %inc) #4
...
if.then:                                          ; preds = %entry
  ...
  tail call void @lua_pushvalue(ptr noundef %L, i32 noundef %sub1) #4
  tail call void @lua_call(ptr noundef %L, i32 noundef 2, i32 noundef 1) #4
  %call2 = tail call i32 @lua_toboolean(ptr noundef %L, i32 noundef -1) #4
  tail call void @lua_settop(ptr noundef %L, i32 noundef -2) #4
  br label %return

if.else:                                          ; preds = %entry
  %call3 = tail call i32 @lua_lessthan(ptr noundef %L, i32 noundef %a, i32 noundef %b) #4
  br label %return
