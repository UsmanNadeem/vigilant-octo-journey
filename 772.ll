; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pcfrac.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pcfrac.c"
...
land.end:                                         ; preds = %land.rhs, %for.end
  ...
  %call12 = tail call i32 @_IO_putc(i32 noundef %., ptr noundef %stream)
...
; Function Attrs: mustprogress nofree nounwind willreturn memory(write) uwtable
define dso_local double @cfracA(double noundef %n, i32 noundef %aborts) local_unnamed_addr #10 {
entry:
...
do.body32.preheader:                              ; preds = %if.end25
  ...
  %.pre117 = load i16, ptr getelementptr ([0 x i16], ptr @primes, i64 0, i64 1), align 2, !tbaa !14
  br label %do.body32
...
do.body32:                                        ; preds = %do.body32.preheader, %if.end56
  ...
  %primePtr.2 = phi ptr [ %incdec.ptr57, %if.end56 ], [ getelementptr ([0 x i16], ptr @primes, i64 0, i64 1), %do.body32.preheader ]
...
for.body40.us:                                    ; preds = %for.body.us, %for.inc.us
  ...
  br i1 %cmp43.not.us, label %for.inc.us, label %foundpm.us

foundpm.us:                                       ; preds = %for.body40.us
  %idxprom41.le.us = and i64 %indvars.iv, 4294967295
  %arrayidx42.le.us = getelementptr inbounds i32, ptr %pm, i64 %idxprom41.le.us
...
if.then50.us:                                     ; preds = %foundpm.us
  ...
  %call55.us = call i32 @_IO_putc(i32 noundef 10, ptr noundef %6)
...
if.end57.us:                                      ; preds = %if.then50.us, %foundpm.us
  store ptr %arrayidx42.le.us, ptr %arrayidx.us, align 8, !tbaa !30
  ...
  br i1 %cmp17.not.us, label %for.end71, label %for.body.us, !llvm.loop !36

for.inc.us:                                       ; preds = %for.body40.us
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.end71, label %for.body40.us, !llvm.loop !37
...
for.end71:                                        ; preds = %if.end57.us, %for.inc.us, %for.body
  %i.0156 = phi i32 [ 1, %for.body ], [ %i.0162.us, %for.inc.us ], [ %inc70.us, %if.end57.us ]
...
for.end:                                          ; preds = %for.body, %if.then25
  ...
  %call31 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %10)
...
if.end75:                                         ; preds = %if.then73, %if.end54
  ...
  %call81 = call i32 @pfactorQ(ptr noundef nonnull %t, ptr noundef %43, ptr noundef %phi.call, ptr noundef nonnull %arrayidx80, i32 noundef %4, ptr noundef %call22)
...
do.body50.backedge:                               ; preds = %do.cond, %if.end159
  br label %do.body50, !llvm.loop !42
...
if.end108:                                        ; preds = %if.then102
  ...
  %call107 = call i32 @_IO_putc(i32 noundef 46, ptr noundef %54)
...
if.end124:                                        ; preds = %if.end118
  ...
  %call123 = call i32 @_IO_putc(i32 noundef 35, ptr noundef %67)
...
if.end133:                                        ; preds = %if.else
  ...
  %call132 = call i32 @_IO_putc(i32 noundef 42, ptr noundef %73)
...
if.then150:                                       ; preds = %if.then145
  %idxprom142.le = zext i32 %dec141 to i64
  %arrayidx147.le = getelementptr inbounds ptr, ptr %call5, i64 %idxprom142.le
...
if.then157:                                       ; preds = %if.end154
  ...
  %call158 = call i32 @_IO_putc(i32 noundef 10, ptr noundef %84)
  br label %if.end159
...
do.cond165:                                       ; preds = %do.body140, %if.end163
  ...
  br i1 %cmp166.not, label %do.end168, label %do.body140, !llvm.loop !43
...
sw.bb:                                            ; preds = %do.end168
  ...
  %call171 = call i32 @_IO_putc(i32 noundef 47, ptr noundef %90)
  br label %do.cond181

sw.bb172:                                         ; preds = %do.end168
  %91 = load ptr, ptr @stderr, align 8, !tbaa !22
  %call173 = call i32 @_IO_putc(i32 noundef 10, ptr noundef %91)
  br label %do.cond181

sw.default:                                       ; preds = %do.end168
  %92 = load ptr, ptr @stderr, align 8, !tbaa !22
  %call174 = call i32 @_IO_putc(i32 noundef 10, ptr noundef %92)
  ...
  %call179 = call i32 @_IO_putc(i32 noundef 10, ptr noundef %104)
...
F2.outer.backedge:                                ; preds = %lor.rhs, %do.cond181
  br label %F2.outer, !llvm.loop !44
...
if.then199:                                       ; preds = %lor.lhs.false, %do.end189
  ...
  %call205 = call i32 @_IO_putc(i32 noundef 10, ptr noundef %124)
...
freeSoln.exit:                                    ; preds = %for.body218, %land.end32.i
  ...
  br i1 %cmp216.not, label %if.end224, label %for.body218, !llvm.loop !45
...
define dso_local i32 @pcfracInit(i32 noundef %m, i32 noundef %k, i32 noundef %aborts) local_unnamed_addr #14 {
entry:
