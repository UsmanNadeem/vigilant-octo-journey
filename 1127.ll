; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/7z/7zUpdate.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/7z/7zUpdate.cpp"
...
if.then3:                                         ; preds = %while.body
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %cur) #17
...
cleanup40.thread97:                               ; preds = %cleanup.cont
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %cur) #17
  br label %return
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %passwordIsDefined) #17
...
invoke.cont6:                                     ; preds = %entry
  ...
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %passwordIsDefined) #17
  br label %try.cont
...
entry:
  ...
  %cmp = icmp eq i64 %0, 0
  %spec.store.select = select i1 %cmp, i64 1, i64 %0
  %spec.store.select.fr = freeze i64 %spec.store.select
...
if.end7:                                          ; preds = %entry, %if.then3, %cond.end
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %fileIndexToUpdateIndexMap) #17
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %folderRefs) #17
...
for.body41:                                       ; preds = %for.body41.lr.ph, %cleanup108
  ...
  %indvars.iv3113 = phi i64 [ 0, %for.body41.lr.ph ], [ %indvars.iv.next3114, %cleanup108 ]
  ...
  %arrayidx.i1554 = getelementptr inbounds i32, ptr %21, i64 %indvars.iv3113
...
for.body50.lr.ph:                                 ; preds = %for.body41
  ...
  %arrayidx.i1557 = getelementptr inbounds i32, ptr %23, i64 %indvars.iv3113
...
invoke.cont90:                                    ; preds = %invoke.cont86
  ...
  %rep.sroa.0.4.insert.insert = or i64 %rep.sroa.0.4.insert.shift, %indvars.iv3113
...
if.then93:                                        ; preds = %invoke.cont90
  ...
  %arrayidx.i.i1580 = getelementptr inbounds i32, ptr %48, i64 %indvars.iv3113
  %49 = load i32, ptr %arrayidx.i.i1580, align 4, !tbaa !51
  %50 = load ptr, ptr %_items.i.i1567, align 8, !tbaa !36
  %arrayidx.i.i.i1582 = getelementptr inbounds ptr, ptr %50, i64 %indvars.iv3113
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi4247 = phi <2 x i64> [ zeroinitializer, %vector.ph ], [ %66, %vector.body ]
  ...
  %wide.load4248 = load <2 x i64>, ptr %64, align 8, !tbaa !109
  %65 = add <2 x i64> %wide.load, %vec.phi
  %66 = add <2 x i64> %wide.load4248, %vec.phi4247
...
if.end104:                                        ; preds = %for.body.i1589.prol.loopexit, %for.body.i1589, %middle.block, %if.then93, %if.else
  ...
  %.pre3181 = load i32, ptr %_size.i1551, align 4, !tbaa !33
  br label %cleanup108

cleanup108:                                       ; preds = %for.body41, %for.cond.cleanup, %if.end104
  %86 = phi i32 [ %.pre3181, %if.end104 ], [ %20, %for.cond.cleanup ], [ %20, %for.body41 ]
  ...
  %cmp40 = icmp slt i64 %indvars.iv.next3114, %87
...
if.end123:                                        ; preds = %for.end120, %if.end7
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %inSizeForReduce) #17
...
for.body130.lr.ph:                                ; preds = %if.end123
  ...
  %cmp139.not = icmp eq i64 %spec.store.select.fr, 1
...
for.body130.preheader:                            ; preds = %for.body130.lr.ph
  %xtraiter4519 = and i64 %wide.trip.count, 1
  %90 = icmp eq i32 %88, 1
  br i1 %90, label %for.end154.loopexit4515.unr-lcssa, label %for.body130.preheader.new
...
for.body130.us.preheader:                         ; preds = %for.body130.lr.ph
  %xtraiter4523 = and i64 %wide.trip.count, 1
  %91 = icmp eq i32 %88, 1
...
for.body130.us.preheader.new:                     ; preds = %for.body130.us.preheader
  %unroll_iter4528 = and i64 %wide.trip.count, 4294967294
  br label %for.body130.us

for.body130.us:                                   ; preds = %if.end150.us.1, %for.body130.us.preheader.new
  %indvars.iv3115.us = phi i64 [ 0, %for.body130.us.preheader.new ], [ %indvars.iv.next3116.us.1, %if.end150.us.1 ]
  ...
  %niter4529 = phi i64 [ 0, %for.body130.us.preheader.new ], [ %niter4529.next.1, %if.end150.us.1 ]
  %arrayidx.i.i1593.us = getelementptr inbounds ptr, ptr %89, i64 %indvars.iv3115.us
...
if.end150.us:                                     ; preds = %if.then146.us, %if.then136.us, %for.body130.us
  ...
  %indvars.iv.next3116.us = or i64 %indvars.iv3115.us, 1
  %arrayidx.i.i1593.us.1 = getelementptr inbounds ptr, ptr %89, i64 %indvars.iv.next3116.us
...
if.end150.us.1:                                   ; preds = %if.then146.us.1, %if.then136.us.1, %if.end150.us
  ...
  %indvars.iv.next3116.us.1 = add nuw nsw i64 %indvars.iv3115.us, 2
  %niter4529.next.1 = add i64 %niter4529, 2
  %niter4529.ncmp.1 = icmp eq i64 %niter4529.next.1, %unroll_iter4528
  br i1 %niter4529.ncmp.1, label %for.end154.loopexit.unr-lcssa, label %for.body130.us, !llvm.loop !118

for.body130:                                      ; preds = %if.end150.1, %for.body130.preheader.new
  %indvars.iv3115 = phi i64 [ 0, %for.body130.preheader.new ], [ %indvars.iv.next3116.1, %if.end150.1 ]
  ...
  %arrayidx.i.i1593 = getelementptr inbounds ptr, ptr %89, i64 %indvars.iv3115
...
if.end150:                                        ; preds = %if.then136, %for.body130
  ...
  %arrayidx.i.i1593.1 = getelementptr inbounds ptr, ptr %89, i64 %indvars.iv.next3116
...
if.end150.1:                                      ; preds = %if.then136.1, %if.end150
  ...
  %indvars.iv.next3116.1 = add nuw nsw i64 %indvars.iv3115, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %for.end154.loopexit4515.unr-lcssa, label %for.body130, !llvm.loop !118

for.end154.loopexit.unr-lcssa:                    ; preds = %if.end150.us.1, %for.body130.us.preheader
  %.lcssa4514.ph = phi i64 [ undef, %for.body130.us.preheader ], [ %100, %if.end150.us.1 ]
  %complexity.5.us.lcssa.ph = phi i64 [ undef, %for.body130.us.preheader ], [ %complexity.5.us.1, %if.end150.us.1 ]
  %indvars.iv3115.us.unr = phi i64 [ 0, %for.body130.us.preheader ], [ %indvars.iv.next3116.us.1, %if.end150.us.1 ]
  %complexity.42803.us.unr = phi i64 [ %complexity.3, %for.body130.us.preheader ], [ %complexity.5.us.1, %if.end150.us.1 ]
  %.unr4524 = phi i64 [ 0, %for.body130.us.preheader ], [ %100, %if.end150.us.1 ]
  %lcmp.mod4525.not = icmp eq i64 %xtraiter4523, 0
  br i1 %lcmp.mod4525.not, label %for.end154, label %for.body130.us.epil

for.body130.us.epil:                              ; preds = %for.end154.loopexit.unr-lcssa
  %arrayidx.i.i1593.us.epil = getelementptr inbounds ptr, ptr %89, i64 %indvars.iv3115.us.unr
...
if.then136.us.epil:                               ; preds = %for.body130.us.epil
  ...
  %cmp145.us.epil = icmp ugt i64 %112, %.unr4524
...
for.end154.loopexit4515.unr-lcssa:                ; preds = %if.end150.1, %for.body130.preheader
  %.lcssa4516.ph = phi i64 [ undef, %for.body130.preheader ], [ %109, %if.end150.1 ]
  %complexity.5.lcssa.ph = phi i64 [ undef, %for.body130.preheader ], [ %complexity.5.1, %if.end150.1 ]
  %indvars.iv3115.unr = phi i64 [ 0, %for.body130.preheader ], [ %indvars.iv.next3116.1, %if.end150.1 ]
  ...
  br i1 %lcmp.mod4520.not, label %for.end154, label %for.body130.epil

for.body130.epil:                                 ; preds = %for.end154.loopexit4515.unr-lcssa
  %arrayidx.i.i1593.epil = getelementptr inbounds ptr, ptr %89, i64 %indvars.iv3115.unr
...
for.end154:                                       ; preds = %for.end154.loopexit4515.unr-lcssa, %if.then136.epil, %for.body130.epil, %for.end154.loopexit.unr-lcssa, %if.then146.us.epil, %if.then136.us.epil, %for.body130.us.epil, %if.end123
  %116 = phi i64 [ 0, %if.end123 ], [ %.lcssa4514.ph, %for.end154.loopexit.unr-lcssa ], [ %112, %if.then146.us.epil ], [ %.unr4524, %if.then136.us.epil ], [ %.unr4524, %for.body130.us.epil ], [ %.lcssa4516.ph, %for.end154.loopexit4515.unr-lcssa ], [ %add142.epil, %if.then136.epil ], [ %.unr, %for.body130.epil ]
  %complexity.4.lcssa = phi i64 [ %complexity.3, %if.end123 ], [ %complexity.5.us.lcssa.ph, %for.end154.loopexit.unr-lcssa ], [ %add138.us.epil, %if.then146.us.epil ], [ %add138.us.epil, %if.then136.us.epil ], [ %complexity.42803.us.unr, %for.body130.us.epil ], [ %complexity.5.lcssa.ph, %for.end154.loopexit4515.unr-lcssa ], [ %add138.epil, %if.then136.epil ], [ %complexity.42803.unr, %for.body130.epil ]
...
cleanup.cont170:                                  ; preds = %invoke.cont163
  %call174 = invoke noalias noundef nonnull dereferenceable(72) ptr @_Znwm(i64 noundef 72) #18
...
invoke.cont181:                                   ; preds = %invoke.cont179
  call void @llvm.lifetime.start.p0(i64 536, ptr nonnull %threadDecoder) #17
...
lpad175:                                          ; preds = %invoke.cont173
  %126 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %call174) #19
  br label %ehcleanup1146
...
if.end199:                                        ; preds = %invoke.cont190, %invoke.cont183
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %groups) #17
...
for.body230:                                      ; preds = %for.body230.lr.ph, %cleanup259
  ...
  %indvars.iv3119 = phi i64 [ 0, %for.body230.lr.ph ], [ %indvars.iv.next3120, %cleanup259 ]
  %140 = load ptr, ptr %_items.i.i1602, align 8, !tbaa !36
  %arrayidx.i.i1604 = getelementptr inbounds ptr, ptr %140, i64 %indvars.iv3119
...
lor.lhs.false237:                                 ; preds = %for.body230
  ...
  %144 = load i8, ptr %IsAnti.i, align 2
...
_ZNK8NArchive3N7z11CUpdateItem9HasStreamEv.exit:  ; preds = %lor.lhs.false237
  ...
  %145 = load i64, ptr %Size.i, align 8, !tbaa !117
...
if.then.i:                                        ; preds = %if.then243
  ...
  %or.cond.i1609 = select i1 %tobool4.not.i, i1 %cmp.i1608, i1 false
  br i1 %or.cond.i1609, label %if.then5.i, label %invoke.cont254

if.then5.i:                                       ; preds = %if.then.i
  call void @llvm.lifetime.start.p0(i64 1088, ptr nonnull %file.i) #17
  store i32 -1, ptr %_fd.i.i.i, align 8, !tbaa !123
  store i64 0, ptr %138, align 8
  %call.i.i.i.i.i1618 = invoke noalias noundef nonnull dereferenceable(4) ptr @_Znam(i64 noundef 4) #18
...
if.then8.i:                                       ; preds = %invoke.cont6.i
  call void @llvm.lifetime.start.p0(i64 512, ptr nonnull %buffer.i) #17
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %processedSize.i) #17
...
lpad9.i:                                          ; preds = %if.then8.i
  %151 = landingpad { ptr, i32 }
          cleanup
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %processedSize.i) #17
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %buffer.i) #17
  br label %ehcleanup.i
...
cleanup22.i:                                      ; preds = %if.end17.i, %invoke.cont6.i
  call void @_ZN8NWindows5NFile3NIO9CFileBaseD2Ev(ptr noundef nonnull align 8 dereferenceable(1084) %file.i) #17
  call void @llvm.lifetime.end.p0(i64 1088, ptr nonnull %file.i) #17
...
_ZN13CRecordVectorIjE3AddEj.exit:                 ; preds = %invoke.cont254
  ...
  %159 = trunc i64 %indvars.iv3119 to i32
...
cleanup259:                                       ; preds = %lor.lhs.false237, %_ZN13CRecordVectorIjE3AddEj.exit, %for.body230, %_ZNK8NArchive3N7z11CUpdateItem9HasStreamEv.exit
  %161 = phi i32 [ %139, %lor.lhs.false237 ], [ %.pre3182, %_ZN13CRecordVectorIjE3AddEj.exit ], [ %139, %for.body230 ], [ %139, %_ZNK8NArchive3N7z11CUpdateItem9HasStreamEv.exit ]
  %indvars.iv.next3120 = add nuw nsw i64 %indvars.iv3119, 1
  %162 = sext i32 %161 to i64
  %cmp229 = icmp slt i64 %indvars.iv.next3120, %162
...
if.then269:                                       ; preds = %for.end265
  %call272 = invoke noalias noundef nonnull dereferenceable(32) ptr @_Znwm(i64 noundef 32) #18
...
invoke.cont271:                                   ; preds = %if.then269
  ...
  %call.i.i3.i1631 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #18
...
if.end.i.i:                                       ; preds = %if.end.i
  ...
  %call.i.i1640 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %174) #18
...
lpad273:                                          ; preds = %invoke.cont271
  %181 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %call272) #19
  br label %ehcleanup1132
...
cleanup.cont341:                                  ; preds = %invoke.cont334
  ...
  %cmp761 = icmp ugt i64 %spec.store.select.fr, 1
  ...
  %uglygep = getelementptr i8, ptr %call174, i64 64
  br label %invoke.cont348

invoke.cont348:                                   ; preds = %cleanup.cont341, %for.inc1038
  %indvars.iv3167 = phi i64 [ 0, %cleanup.cont341 ], [ %indvars.iv.next3168, %for.inc1038 ]
  %retval.92879 = phi i32 [ 0, %cleanup.cont341 ], [ %retval.31, %for.inc1038 ]
  %folderRefIndex.02878 = phi i32 [ 0, %cleanup.cont341 ], [ %folderRefIndex.12391, %for.inc1038 ]
  %195 = load ptr, ptr %_items.i.i1643, align 8, !tbaa !36
  %arrayidx.i.i1645 = getelementptr inbounds ptr, ptr %195, i64 %indvars.iv3167
  %196 = load ptr, ptr %arrayidx.i.i1645, align 8, !tbaa !37
  call void @llvm.lifetime.start.p0(i64 88, ptr nonnull %method350) #17
  ...
  %call.i.i5.i = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #18
          to label %invoke.cont352 unwind label %lpad2.i

lpad2.i:                                          ; preds = %invoke.cont348
  %197 = landingpad { ptr, i32 }
          cleanup
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %Binds.i) #17
  call void @_ZN13CObjectVectorIN8NArchive3N7z11CMethodFullEED2Ev(ptr noundef nonnull align 8 dereferenceable(32) %method350) #17
...
invoke.cont352:                                   ; preds = %invoke.cont348
  ...
  %and.i16523187 = and i64 %indvars.iv3167, 1
  %cmp.i1653.not = icmp eq i64 %and.i16523187, 0
...
if.then.i1654:                                    ; preds = %call.i.noexc1668
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %methodFull.i) #17
  ...
  %call.i143.i = invoke noalias noundef nonnull dereferenceable(48) ptr @_Znwm(i64 noundef 48) #18
...
lpad.i.i.i.i.i:                                   ; preds = %call.i.noexc.i
  %200 = landingpad { ptr, i32 }
          cleanup
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %Props.i.i.i.i) #17
  call void @_ZdlPv(ptr noundef nonnull %call.i143.i) #19
...
invoke.cont4.i:                                   ; preds = %invoke.cont.i.i
  ...
  store i32 1, ptr %NumOutStreams.i.i, align 4, !tbaa !151
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %prop.i) #17
...
invoke.cont6.i1657:                               ; preds = %invoke.cont4.i
  %call.i149.i = invoke noalias noundef nonnull dereferenceable(24) ptr @_Znwm(i64 noundef 24) #18
...
lpad.i.i:                                         ; preds = %call.i.noexc148.i
  %204 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %call.i149.i) #19
...
invoke.cont12.i:                                  ; preds = %invoke.cont8.i
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %prop.i) #17
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %prop10.i) #17
...
invoke.cont16.i:                                  ; preds = %invoke.cont12.i
  %call.i164.i = invoke noalias noundef nonnull dereferenceable(24) ptr @_Znwm(i64 noundef 24) #18
...
lpad.i162.i:                                      ; preds = %call.i.noexc163.i
  %210 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %call.i164.i) #19
...
invoke.cont25.i:                                  ; preds = %invoke.cont19.i
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %prop10.i) #17
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %prop23.i) #17
...
invoke.cont29.i:                                  ; preds = %invoke.cont25.i
  %call.i183.i = invoke noalias noundef nonnull dereferenceable(24) ptr @_Znwm(i64 noundef 24) #18
...
lpad.i181.i:                                      ; preds = %call.i.noexc182.i
  %216 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %call.i183.i) #19
...
invoke.cont38.i:                                  ; preds = %invoke.cont32.i
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %prop23.i) #17
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %prop36.i) #17
...
invoke.cont42.i:                                  ; preds = %invoke.cont38.i
  %call.i202.i = invoke noalias noundef nonnull dereferenceable(24) ptr @_Znwm(i64 noundef 24) #18
...
lpad.i200.i:                                      ; preds = %call.i.noexc201.i
  %222 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %call.i202.i) #19
...
invoke.cont51.i:                                  ; preds = %invoke.cont45.i
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %prop36.i) #17
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %prop49.i) #17
...
invoke.cont55.i:                                  ; preds = %invoke.cont51.i
  %call.i221.i = invoke noalias noundef nonnull dereferenceable(24) ptr @_Znwm(i64 noundef 24) #18
...
lpad.i219.i:                                      ; preds = %call.i.noexc220.i
  %228 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %call.i221.i) #19
...
_ZN5CPropD2Ev.exit227.i:                          ; preds = %invoke.cont58.i
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %prop49.i) #17
  %call.i243.i = invoke noalias noundef nonnull dereferenceable(48) ptr @_Znwm(i64 noundef 48) #18
...
lpad.i.i.i.i233.i:                                ; preds = %call.i.noexc242.i
  %234 = landingpad { ptr, i32 }
          cleanup
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %Props.i.i.i228.i) #17
  call void @_ZdlPv(ptr noundef nonnull %call.i243.i) #19
  br label %ehcleanup84.i
...
invoke.cont63.i:                                  ; preds = %invoke.cont.i241.i
  ...
  %call.i261.i = invoke noalias noundef nonnull dereferenceable(48) ptr @_Znwm(i64 noundef 48) #18
...
lpad.i.i.i.i251.i:                                ; preds = %call.i.noexc260.i
  %239 = landingpad { ptr, i32 }
          cleanup
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %Props.i.i.i246.i) #17
  call void @_ZdlPv(ptr noundef nonnull %call.i261.i) #19
  br label %ehcleanup84.i
...
_ZN7CMethodD2Ev.exit.i:                           ; preds = %invoke.cont81.i
  ...
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %methodFull.i) #17
  br label %if.end364
...
ehcleanup84.i:                                    ; preds = %lpad68.i, %ehcleanup61.i, %ehcleanup48.i, %ehcleanup35.i, %ehcleanup22.i, %ehcleanup.i1665, %lpad.i1664, %lpad.i.i.i.i251.i, %lpad.i.i.i.i233.i, %lpad.i.i.i.i.i
  ...
  call void @_ZN7CMethodD2Ev(ptr noundef nonnull align 8 dereferenceable(48) %methodFull.i) #17
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %methodFull.i) #17
  br label %ehcleanup1031

if.else.i:                                        ; preds = %call.i.noexc1668
  call void @llvm.lifetime.start.p0(i64 48, ptr nonnull %methodFull86.i) #17
  ...
  %call.i316.i = invoke noalias noundef nonnull dereferenceable(48) ptr @_Znwm(i64 noundef 48) #18
...
lpad.i.i.i.i310.i:                                ; preds = %call.i.noexc315.i
  %271 = landingpad { ptr, i32 }
          cleanup
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %Props.i.i.i305.i) #17
  call void @_ZdlPv(ptr noundef nonnull %call.i316.i) #19
...
_ZN7CMethodD2Ev.exit328.i:                        ; preds = %invoke.cont99.i
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %Props.i.i300.i) #17
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %methodFull86.i) #17
  br label %if.end364
...
ehcleanup102.i:                                   ; preds = %lpad98.i, %lpad87.i, %lpad.i.i.i.i310.i
  ...
  call void @_ZN7CMethodD2Ev(ptr noundef nonnull align 8 dereferenceable(48) %methodFull86.i) #17
  call void @llvm.lifetime.end.p0(i64 48, ptr nonnull %methodFull86.i) #17
  br label %ehcleanup1031
...
if.end364:                                        ; preds = %_ZN7CMethodD2Ev.exit328.i, %_ZN7CMethodD2Ev.exit.i, %if.else360
  %cmp.i1672.not = icmp ult i64 %indvars.iv3167, 2
...
if.end.i.i1682:                                   ; preds = %if.end.i1679
  ...
  %call.i.i1697 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %288) #18
...
if.end384:                                        ; preds = %if.then367, %if.end377, %if.else380
  call void @llvm.lifetime.start.p0(i64 440, ptr nonnull %encoder) #17
...
for.cond387.preheader:                            ; preds = %if.end384
  ...
  %cmp3912819 = icmp slt i32 %folderRefIndex.02878, %295
  br i1 %cmp3912819, label %for.body392.preheader, label %for.end749

for.body392.preheader:                            ; preds = %for.cond387.preheader
  %296 = sext i32 %folderRefIndex.02878 to i64
  br label %for.body392

for.body392:                                      ; preds = %for.body392.preheader, %for.inc747
  %indvars.iv3130 = phi i64 [ %296, %for.body392.preheader ], [ %indvars.iv.next3131, %for.inc747 ]
  %retval.102821 = phi i32 [ %retval.92879, %for.body392.preheader ], [ %retval.19, %for.inc747 ]
  %297 = load ptr, ptr %_items.i1701, align 8, !tbaa !36
  %Group397 = getelementptr inbounds %"struct.NArchive::N7z::CFolderRepack", ptr %297, i64 %indvars.iv3130, i32 1
  %298 = load i32, ptr %Group397, align 4, !tbaa !161
  %299 = zext i32 %298 to i64
  %cmp398.not = icmp eq i64 %indvars.iv3167, %299
...
if.end400:                                        ; preds = %for.body392
  %arrayidx.i1703 = getelementptr inbounds %"struct.NArchive::N7z::CFolderRepack", ptr %297, i64 %indvars.iv3130
  %301 = load i32, ptr %arrayidx.i1703, align 4, !tbaa !163
  %NumCopyFiles402 = getelementptr inbounds %"struct.NArchive::N7z::CFolderRepack", ptr %297, i64 %indvars.iv3130, i32 2
...
for.body.lr.ph.i1716:                             ; preds = %if.then408
  ...
  %min.iters.check4271 = icmp ult i32 %309, 10
  br i1 %min.iters.check4271, label %for.body.i1726.preheader, label %vector.scevcheck4268

vector.scevcheck4268:                             ; preds = %for.body.lr.ph.i1716
  ...
  %316 = or i1 %314, %315
  br i1 %316, label %for.body.i1726.preheader, label %vector.ph4272

vector.ph4272:                                    ; preds = %vector.scevcheck4268
  %n.vec4274 = and i64 %wide.trip.count.i1715, 4294967292
  br label %vector.body4277

vector.body4277:                                  ; preds = %vector.body4277, %vector.ph4272
  %offset.idx4281 = phi i64 [ 0, %vector.ph4272 ], [ %index.next4284, %vector.body4277 ]
  %vec.phi4279 = phi <2 x i64> [ zeroinitializer, %vector.ph4272 ], [ %322, %vector.body4277 ]
  %vec.phi4280 = phi <2 x i64> [ zeroinitializer, %vector.ph4272 ], [ %323, %vector.body4277 ]
  %317 = trunc i64 %offset.idx4281 to i32
  %318 = add i32 %306, %317
  %319 = sext i32 %318 to i64
  %320 = getelementptr inbounds i64, ptr %310, i64 %319
  %wide.load4282 = load <2 x i64>, ptr %320, align 8, !tbaa !109
  %321 = getelementptr inbounds i64, ptr %320, i64 2
  %wide.load4283 = load <2 x i64>, ptr %321, align 8, !tbaa !109
  %322 = add <2 x i64> %wide.load4282, %vec.phi4279
  %323 = add <2 x i64> %wide.load4283, %vec.phi4280
  %index.next4284 = add nuw i64 %offset.idx4281, 4
  %324 = icmp eq i64 %index.next4284, %n.vec4274
  br i1 %324, label %middle.block4269, label %vector.body4277, !llvm.loop !165

middle.block4269:                                 ; preds = %vector.body4277
  %bin.rdx4285 = add <2 x i64> %323, %322
  %325 = call i64 @llvm.vector.reduce.add.v2i64(<2 x i64> %bin.rdx4285)
  %cmp.n4276 = icmp eq i64 %n.vec4274, %wide.trip.count.i1715
  br i1 %cmp.n4276, label %invoke.cont416, label %for.body.i1726.preheader

for.body.i1726.preheader:                         ; preds = %vector.scevcheck4268, %for.body.lr.ph.i1716, %middle.block4269
  %indvars.iv.i1718.ph = phi i64 [ 0, %vector.scevcheck4268 ], [ 0, %for.body.lr.ph.i1716 ], [ %n.vec4274, %middle.block4269 ]
  %size.014.i1719.ph = phi i64 [ 0, %vector.scevcheck4268 ], [ 0, %for.body.lr.ph.i1716 ], [ %325, %middle.block4269 ]
  %326 = xor i64 %indvars.iv.i1718.ph, -1
  %327 = add nsw i64 %326, %wide.trip.count.i1715
  %xtraiter4533 = and i64 %wide.trip.count.i1715, 3
  %lcmp.mod4534.not = icmp eq i64 %xtraiter4533, 0
  br i1 %lcmp.mod4534.not, label %for.body.i1726.prol.loopexit, label %for.body.i1726.prol
...
for.body.i1726.prol:                              ; preds = %for.body.i1726.preheader, %for.body.i1726.prol
  ...
  %prol.iter4535 = phi i64 [ %prol.iter4535.next, %for.body.i1726.prol ], [ 0, %for.body.i1726.preheader ]
  ...
  %prol.iter4535.next = add i64 %prol.iter4535, 1
  %prol.iter4535.cmp.not = icmp eq i64 %prol.iter4535.next, %xtraiter4533
  br i1 %prol.iter4535.cmp.not, label %for.body.i1726.prol.loopexit, label %for.body.i1726.prol, !llvm.loop !166
...
invoke.cont416:                                   ; preds = %for.body.i1726.prol.loopexit, %for.body.i1726, %middle.block4269, %if.then408
  %size.0.lcssa.i1717 = phi i64 [ 0, %if.then408 ], [ %325, %middle.block4269 ], [ %add5.i1723.lcssa.unr, %for.body.i1726.prol.loopexit ], [ %add5.i1723.3, %for.body.i1726 ]
...
for.cond.cleanup443:                              ; preds = %for.inc451, %cleanup.cont427
  %call.i1745 = invoke noalias noundef nonnull dereferenceable(136) ptr @_Znwm(i64 noundef 136) #18
...
lpad.i1743:                                       ; preds = %call.i.noexc1744
  %354 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %call.i1745) #19
  br label %ehcleanup1027
...
for.body444:                                      ; preds = %cleanup.cont427, %for.inc451
  %indvars.iv3127 = phi i64 [ %indvars.iv.next3128, %for.inc451 ], [ 0, %cleanup.cont427 ]
  %357 = trunc i64 %indvars.iv3127 to i32
...
for.inc451:                                       ; preds = %for.body444
  ...
  %cmp442 = icmp slt i64 %indvars.iv.next3128, %363
...
invoke.cont467:                                   ; preds = %if.end400
  call void @llvm.lifetime.start.p0(i64 184, ptr nonnull %sb) #17
...
cleanup.cont477:                                  ; preds = %invoke.cont470
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %sbOutStream) #17
  store ptr null, ptr %sbOutStream, align 8, !tbaa !30
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %sbInStream) #17
...
invoke.cont488:                                   ; preds = %cleanup.cont477
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %extractStatuses) #17
...
for.cond.cleanup504.loopexit:                     ; preds = %invoke.cont529
  %.pre3183 = load ptr, ptr %_items.i1760, align 8, !tbaa !36
  %arrayidx.i1765.phi.trans.insert = getelementptr inbounds i32, ptr %.pre3183, i64 %idxprom.i1705
  %.pre3184 = load i32, ptr %arrayidx.i1765.phi.trans.insert, align 4, !tbaa !51
  br label %for.cond.cleanup504

for.cond.cleanup504:                              ; preds = %for.cond.cleanup504.loopexit, %invoke.cont488
  %371 = phi i32 [ %.pre3184, %for.cond.cleanup504.loopexit ], [ %370, %invoke.cont488 ]
...
invoke.cont575:                                   ; preds = %invoke.cont560
  ...
  call void @llvm.lifetime.start.p0(i64 136, ptr nonnull %newFolder) #17
...
for.body609.lr.ph:                                ; preds = %for.cond604.preheader
  ...
  %wide.trip.count3125 = sext i32 %409 to i64
  %412 = sub nsw i64 %wide.trip.count3125, %411
  %min.iters.check4295 = icmp ult i64 %412, 14
  br i1 %min.iters.check4295, label %for.body609.preheader, label %vector.memcheck4287

vector.memcheck4287:                              ; preds = %for.body609.lr.ph
  %413 = shl nsw i64 %411, 3
  %uglygep4288 = getelementptr i8, ptr %410, i64 %413
  %414 = shl nsw i64 %wide.trip.count3125, 3
  %uglygep4289 = getelementptr i8, ptr %410, i64 %414
  %bound04290 = icmp ult ptr %OutSize, %uglygep4289
  %bound14291 = icmp ult ptr %uglygep4288, %uglygep
  %found.conflict4292 = and i1 %bound04290, %bound14291
  br i1 %found.conflict4292, label %for.body609.preheader, label %vector.ph4296

vector.ph4296:                                    ; preds = %vector.memcheck4287
  %n.vec4298 = and i64 %412, -4
  %ind.end4299 = add nsw i64 %n.vec4298, %411
  %415 = insertelement <2 x i64> <i64 poison, i64 0>, i64 %OutSize.promoted, i64 0
  br label %vector.body4302

vector.body4302:                                  ; preds = %vector.body4302, %vector.ph4296
  %index4303 = phi i64 [ 0, %vector.ph4296 ], [ %index.next4309, %vector.body4302 ]
  %vec.phi4304 = phi <2 x i64> [ %415, %vector.ph4296 ], [ %418, %vector.body4302 ]
  %vec.phi4305 = phi <2 x i64> [ zeroinitializer, %vector.ph4296 ], [ %419, %vector.body4302 ]
  %offset.idx4306 = add i64 %index4303, %411
  %416 = getelementptr inbounds i64, ptr %410, i64 %offset.idx4306
  %wide.load4307 = load <2 x i64>, ptr %416, align 8, !tbaa !109, !alias.scope !186
  %417 = getelementptr inbounds i64, ptr %416, i64 2
  %wide.load4308 = load <2 x i64>, ptr %417, align 8, !tbaa !109, !alias.scope !186
  %418 = add <2 x i64> %wide.load4307, %vec.phi4304
  %419 = add <2 x i64> %wide.load4308, %vec.phi4305
  %index.next4309 = add nuw i64 %index4303, 4
  %420 = icmp eq i64 %index.next4309, %n.vec4298
  br i1 %420, label %middle.block4293, label %vector.body4302, !llvm.loop !189

middle.block4293:                                 ; preds = %vector.body4302
  %bin.rdx4310 = add <2 x i64> %419, %418
  %421 = call i64 @llvm.vector.reduce.add.v2i64(<2 x i64> %bin.rdx4310)
  store i64 %421, ptr %OutSize, align 8, !tbaa !185
  %cmp.n4301 = icmp eq i64 %412, %n.vec4298
  br i1 %cmp.n4301, label %for.end616, label %for.body609.preheader

for.body609.preheader:                            ; preds = %vector.memcheck4287, %for.body609.lr.ph, %middle.block4293
  %indvars.iv3122.ph = phi i64 [ %411, %vector.memcheck4287 ], [ %411, %for.body609.lr.ph ], [ %ind.end4299, %middle.block4293 ]
  %add6132813.ph = phi i64 [ %OutSize.promoted, %vector.memcheck4287 ], [ %OutSize.promoted, %for.body609.lr.ph ], [ %421, %middle.block4293 ]
  %422 = sub nsw i64 %wide.trip.count3125, %indvars.iv3122.ph
  %423 = xor i64 %indvars.iv3122.ph, -1
  %424 = add nsw i64 %423, %wide.trip.count3125
  %xtraiter4530 = and i64 %422, 3
  %lcmp.mod4531.not = icmp eq i64 %xtraiter4530, 0
  br i1 %lcmp.mod4531.not, label %for.body609.prol.loopexit, label %for.body609.prol

for.body609.prol:                                 ; preds = %for.body609.preheader, %for.body609.prol
  %indvars.iv3122.prol = phi i64 [ %indvars.iv.next3123.prol, %for.body609.prol ], [ %indvars.iv3122.ph, %for.body609.preheader ]
  %add6132813.prol = phi i64 [ %add613.prol, %for.body609.prol ], [ %add6132813.ph, %for.body609.preheader ]
  %prol.iter4532 = phi i64 [ %prol.iter4532.next, %for.body609.prol ], [ 0, %for.body609.preheader ]
  %arrayidx.i1833.prol = getelementptr inbounds i64, ptr %410, i64 %indvars.iv3122.prol
  ...
  %indvars.iv.next3123.prol = add nsw i64 %indvars.iv3122.prol, 1
  %prol.iter4532.next = add i64 %prol.iter4532, 1
  %prol.iter4532.cmp.not = icmp eq i64 %prol.iter4532.next, %xtraiter4530
  br i1 %prol.iter4532.cmp.not, label %for.body609.prol.loopexit, label %for.body609.prol, !llvm.loop !190

for.body609.prol.loopexit:                        ; preds = %for.body609.prol, %for.body609.preheader
  %indvars.iv3122.unr = phi i64 [ %indvars.iv3122.ph, %for.body609.preheader ], [ %indvars.iv.next3123.prol, %for.body609.prol ]
...
for.body609:                                      ; preds = %for.body609.prol.loopexit, %for.body609
  %indvars.iv3122 = phi i64 [ %indvars.iv.next3123.3, %for.body609 ], [ %indvars.iv3122.unr, %for.body609.prol.loopexit ]
  %add6132813 = phi i64 [ %add613.3, %for.body609 ], [ %add6132813.unr, %for.body609.prol.loopexit ]
  %arrayidx.i1833 = getelementptr inbounds i64, ptr %410, i64 %indvars.iv3122
  ...
  %indvars.iv.next3123 = add nsw i64 %indvars.iv3122, 1
  %arrayidx.i1833.1 = getelementptr inbounds i64, ptr %410, i64 %indvars.iv.next3123
  ...
  %indvars.iv.next3123.1 = add nsw i64 %indvars.iv3122, 2
  %arrayidx.i1833.2 = getelementptr inbounds i64, ptr %410, i64 %indvars.iv.next3123.1
  ...
  %indvars.iv.next3123.2 = add nsw i64 %indvars.iv3122, 3
  %arrayidx.i1833.3 = getelementptr inbounds i64, ptr %410, i64 %indvars.iv.next3123.2
  ...
  %indvars.iv.next3123.3 = add nsw i64 %indvars.iv3122, 4
  %exitcond3126.not.3 = icmp eq i64 %indvars.iv.next3123.3, %wide.trip.count3125
  br i1 %exitcond3126.not.3, label %for.end616, label %for.body609, !llvm.loop !191

for.end616:                                       ; preds = %for.body609.prol.loopexit, %for.body609, %middle.block4293, %for.cond604.preheader
...
for.end.i:                                        ; preds = %for.cond.i1840, %for.cond.us.i
  ...
  invoke void @__cxa_throw(ptr nonnull %exception.i, ptr nonnull @_ZTIi, ptr null) #21
...
invoke.cont617:                                   ; preds = %cleanup.i, %for.end616
  ...
  %call.i1852 = invoke noalias noundef nonnull dereferenceable(136) ptr @_Znwm(i64 noundef 136) #18
...
lpad.i1850:                                       ; preds = %call.i.noexc1851
  %439 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %call.i1852) #19
  br label %ehcleanup624
...
cleanup623:                                       ; preds = %_ZN13CObjectVectorIN8NArchive3N7z7CFolderEE3AddERKS2_.exit1855, %invoke.cont596, %invoke.cont586
  ...
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %UnpackSizes.i) #17
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %PackStreams.i) #17
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %BindPairs.i) #17
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN8NArchive3N7z10CCoderInfoEE, i64 0, inrange i32 0, i64 2), ptr %newFolder, align 8, !tbaa !28
...
_ZN8NArchive3N7z7CFolderD2Ev.exit:                ; preds = %cleanup623
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %newFolder) #17
  call void @llvm.lifetime.end.p0(i64 136, ptr nonnull %newFolder) #17
  br label %cleanup629
...
cleanup629:                                       ; preds = %invoke.cont544, %_ZN8NArchive3N7z7CFolderD2Ev.exit
  ...
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %extractStatuses) #17
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %extractStatuses) #17
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit:    ; preds = %cleanup629, %if.then.i1862
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %sbInStream) #17
...
_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit:   ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit, %if.then.i1869
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %sbOutStream) #17
  br label %cleanup645
...
if.then.i.i1875:                                  ; preds = %delete.notnull.i
  %call.i.i = call i32 @pthread_mutex_destroy(ptr noundef nonnull %452) #17
  %_cond.i.i = getelementptr inbounds %"class.NWindows::NSynchronization::CSynchro", ptr %452, i64 0, i32 1
  %call2.i.i = call i32 @pthread_cond_destroy(ptr noundef nonnull %_cond.i.i) #17
...
_ZN13CStreamBinderD2Ev.exit:                      ; preds = %if.end.i1879
  call void @llvm.lifetime.end.p0(i64 184, ptr nonnull %sb) #17
...
ehcleanup624:                                     ; preds = %lpad595.loopexit, %lpad595.loopexit.split-lp, %lpad.i1850, %lpad577
  ...
  call void @_ZN8NArchive3N7z7CFolderD2Ev(ptr noundef nonnull align 8 dereferenceable(133) %newFolder) #17
  call void @llvm.lifetime.end.p0(i64 136, ptr nonnull %newFolder) #17
  br label %ehcleanup630
...
ehcleanup646:                                     ; preds = %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit1896, %lpad469
  ...
  call void @_ZN13CStreamBinderD2Ev(ptr noundef nonnull align 8 dereferenceable(184) %sb) #17
  call void @llvm.lifetime.end.p0(i64 184, ptr nonnull %sb) #17
  br label %ehcleanup1027
...
for.body670:                                      ; preds = %for.body670.preheader, %_ZN8NArchive3N7z9CFileItemD2Ev.exit1946
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %file671) #17
  store i64 17179869184, ptr %_length.i.i.i, align 8
  %call.i.i.i19121914 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #18
...
invoke.cont673:                                   ; preds = %for.body670
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %file2) #17
...
if.then695:                                       ; preds = %if.end693
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %uf) #17
  store i64 17179869184, ptr %_length.i.i1931, align 8
  %call.i.i.i19231928 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #18
...
if.end.i.i.i:                                     ; preds = %invoke.cont699
  ...
  %call.i.i.i19341936 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %491) #18
...
_ZN8NArchive3N7z9CFileItemD2Ev.exit:              ; preds = %invoke.cont710, %delete.notnull.i.i1938
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %uf) #17
  br label %if.end714
...
delete.notnull.i.i1941:                           ; preds = %lpad698
  call void @_ZdaPv(ptr noundef nonnull %500) #19
  br label %ehcleanup713
...
cleanup726:                                       ; preds = %if.end714, %if.then685, %if.then678, %invoke.cont675
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %file2) #17
...
_ZN8NArchive3N7z9CFileItemD2Ev.exit1946:          ; preds = %cleanup726, %delete.notnull.i.i1945
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %file671) #17
...
delete.notnull.i.i1949:                           ; preds = %ehcleanup727
  call void @_ZdaPv(ptr noundef nonnull %502) #19
  br label %ehcleanup733
...
for.inc747:                                       ; preds = %_ZN8NArchive3N7z9CFileItemD2Ev.exit1946, %invoke.cont654
  %indvars.iv.next3131 = add nsw i64 %indvars.iv3130, 1
  %503 = load i32, ptr %_size.i1595, align 4, !tbaa !33
  %504 = sext i32 %503 to i64
  %cmp391 = icmp slt i64 %indvars.iv.next3131, %504
  br i1 %cmp391, label %for.body392, label %for.end749.loopexit, !llvm.loop !202

for.end749.loopexit:                              ; preds = %for.inc747, %for.body392
  %indvars.iv.next3131.lcssa.sink = phi i64 [ %indvars.iv3130, %for.body392 ], [ %indvars.iv.next3131, %for.inc747 ]
  %retval.10.lcssa.ph = phi i32 [ %retval.102821, %for.body392 ], [ %retval.19, %for.inc747 ]
  %indvars.le = trunc i64 %indvars.iv.next3131.lcssa.sink to i32
  br label %for.end749

for.end749:                                       ; preds = %for.end749.loopexit, %for.cond387.preheader
  %folderRefIndex.1.lcssa = phi i32 [ %folderRefIndex.02878, %for.cond387.preheader ], [ %indvars.le, %for.end749.loopexit ]
  %retval.10.lcssa = phi i32 [ %retval.92879, %for.cond387.preheader ], [ %retval.10.lcssa.ph, %for.end749.loopexit ]
...
if.end756:                                        ; preds = %for.end749
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %refItems) #17
...
invoke.cont760:                                   ; preds = %if.end756
  call void @llvm.lifetime.start.p0(i64 1, ptr nonnull %sortByType) #17
...
invoke.cont760.for.end782_crit_edge:              ; preds = %invoke.cont760
  %.pre3185 = load i32, ptr %_size.i1965, align 4, !tbaa !33
  br label %for.end782

for.body765.lr.ph:                                ; preds = %invoke.cont760
  %_items.i1954 = getelementptr inbounds %class.CBaseRecordVector, ptr %196, i64 0, i32 3
  %wide.trip.count3137 = zext i32 %505 to i64
  br label %for.body765

for.body765:                                      ; preds = %for.body765.lr.ph, %for.inc780
  %indvars.iv3133 = phi i64 [ 0, %for.body765.lr.ph ], [ %indvars.iv.next3134, %for.inc780 ]
  %506 = load ptr, ptr %_items.i1954, align 8, !tbaa !36
  %arrayidx.i1956 = getelementptr inbounds i32, ptr %506, i64 %indvars.iv3133
...
for.inc780:                                       ; preds = %invoke.cont777
  ...
  %exitcond3138.not = icmp eq i64 %indvars.iv.next3134, %wide.trip.count3137
  br i1 %exitcond3138.not, label %for.end782, label %for.body765, !llvm.loop !204
...
for.end782:                                       ; preds = %for.inc780, %invoke.cont760.for.end782_crit_edge
  %514 = phi i32 [ %.pre3185, %invoke.cont760.for.end782_crit_edge ], [ %inc.i1968, %for.inc780 ]
...
do.body.i:                                        ; preds = %_ZN13CRecordVectorIN8NArchive3N7z8CRefItemEE11SortRefDownEPS2_iiPFiPKS2_S6_PvES7_.exit.i, %if.end.i1973
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %temp.i.i) #17
...
_ZN13CRecordVectorIN8NArchive3N7z8CRefItemEE11SortRefDownEPS2_iiPFiPKS2_S6_PvES7_.exit.i: ; preds = %cleanup.i.i, %call10.i.i.noexc, %do.body.i
  ...
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %temp.i.i) #17
...
if.end.i33.i.preheader:                           ; preds = %do.body3.i
  %IsDir.i3406 = getelementptr inbounds %"struct.NArchive::N7z::CUpdateItem", ptr %temp.i.sroa.0.0.copyload, i64 0, i32 11
  %IsAnti.i3412 = getelementptr inbounds %"struct.NArchive::N7z::CUpdateItem", ptr %temp.i.sroa.0.0.copyload, i64 0, i32 10
  %Name.i3413 = getelementptr inbounds %"struct.NArchive::N7z::CUpdateItem", ptr %temp.i.sroa.0.0.copyload, i64 0, i32 6
  ...
  %Size.i3417 = getelementptr inbounds %"struct.NArchive::N7z::CUpdateItem", ptr %temp.i.sroa.0.0.copyload, i64 0, i32 5
...
if.end7.i47.i:                                    ; preds = %call.i37.i.noexc, %if.end.i33.i
  ...
  %523 = load i8, ptr %IsDir.i3406, align 1, !tbaa !121, !range !42, !noundef !43
  %tobool.not.i3407 = icmp eq i8 %523, 0
  ...
  %cmp.not.i3408 = icmp eq i8 %523, %524
  br i1 %cmp.not.i3408, label %if.end.i3411, label %if.then.i3410

if.then.i3410:                                    ; preds = %if.end7.i47.i
  br i1 %tobool.not.i3407, label %cleanup.i54.i, label %if.end7.for.end.loopexit_crit_edge.i49.i

if.end.i3411:                                     ; preds = %if.end7.i47.i
  br i1 %tobool.not.i3407, label %if.end24.i, label %if.then9.i

if.then9.i:                                       ; preds = %if.end.i3411
  %525 = load i8, ptr %IsAnti.i3412, align 2, !tbaa !208, !range !42, !noundef !43
...
if.end20.i:                                       ; preds = %if.then9.i
  %527 = load ptr, ptr %Name.i3413, align 8, !tbaa !81
  ...
  %call23.i3418 = invoke noundef i32 @_Z21MyStringCompareNoCasePKwS0_(ptr noundef %527, ptr noundef %528)
          to label %call23.i.noexc unwind label %lpad768.loopexit

call23.i.noexc:                                   ; preds = %if.end20.i
  %sub.i = sub nsw i32 0, %call23.i3418
  br label %call10.i45.i.noexc

if.end24.i:                                       ; preds = %if.end.i3411
  br i1 %cmp761, label %if.then27.i, label %if.end102.i

if.then27.i:                                      ; preds = %if.end24.i
  %ExtensionIndex28.i = getelementptr inbounds %"struct.NArchive::N7z::CRefItem", ptr %add.ptr9.i44.i, i64 0, i32 4
  %529 = load i32, ptr %ExtensionIndex28.i, align 4, !tbaa !209
  %cmp.i.i3414 = icmp slt i32 %temp.i.sroa.10.0.copyload, %529
  %cmp1.i.i3415 = icmp ne i32 %temp.i.sroa.10.0.copyload, %529
  %cond.i.i = zext i1 %cmp1.i.i3415 to i32
  %cond2.i.i = select i1 %cmp.i.i3414, i32 -1, i32 %cond.i.i
...
cleanup.cont.i:                                   ; preds = %if.then27.i
  %530 = load ptr, ptr %Name.i3413, align 8, !tbaa !81
  %add.ptr.i3416 = getelementptr inbounds i32, ptr %530, i64 %idx.ext.i
  ...
  %ExtensionPos38.i = getelementptr inbounds %"struct.NArchive::N7z::CRefItem", ptr %add.ptr9.i44.i, i64 0, i32 2
...
cleanup.cont47.i:                                 ; preds = %call41.i.noexc
  ...
  %call58.i3420 = invoke noundef i32 @_Z21MyStringCompareNoCasePKwS0_(ptr noundef %add.ptr52.i, ptr noundef %add.ptr57.i)
          to label %call58.i.noexc unwind label %lpad768.loopexit

call58.i.noexc:                                   ; preds = %cleanup.cont47.i
  %cmp59.not.i = icmp eq i32 %call58.i3420, 0
...
cleanup.cont64.i:                                 ; preds = %call58.i.noexc
  ...
  %537 = load i8, ptr %MTimeDefined66.i, align 1, !tbaa !212, !range !42
...
if.end92.i:                                       ; preds = %if.then82.i, %land.lhs.true.i
  %540 = load i64, ptr %Size.i3417, align 8, !tbaa !117
...
if.end102.i:                                      ; preds = %if.end92.i, %if.end24.i
  %542 = load ptr, ptr %Name.i3413, align 8, !tbaa !81
  ...
  %call107.i3421 = invoke noundef i32 @_Z21MyStringCompareNoCasePKwS0_(ptr noundef %542, ptr noundef %543)
...
call10.i45.i.noexc:                               ; preds = %if.end92.i, %if.then82.i, %call58.i.noexc, %call41.i.noexc, %if.then27.i, %call23.i.noexc, %if.end102.i
  %retval.7.i = phi i32 [ %sub.i, %call23.i.noexc ], [ %cond2.i164.i, %if.end92.i ], [ %cond2.i160.i, %if.then82.i ], [ %call58.i3420, %call58.i.noexc ], [ %call41.i3419, %call41.i.noexc ], [ %cond2.i.i, %if.then27.i ], [ %call107.i3421, %if.end102.i ]
...
if.end7.for.end.loopexit_crit_edge.i49.i:         ; preds = %land.lhs.true.i, %if.then16.i, %if.then.i3410, %call10.i45.i.noexc
...
cleanup.i54.i:                                    ; preds = %if.then16.i, %if.then.i3410, %land.lhs.true72.i, %call10.i45.i.noexc
...
invoke.cont783:                                   ; preds = %do.body3.i, %for.end782
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %indices) #17
...
for.body790.preheader:                            ; preds = %for.cond788.preheader
  %wide.trip.count3143 = zext i32 %505 to i64
  br label %for.body790

for.body790:                                      ; preds = %for.body790.preheader, %invoke.cont795
  %indvars.iv3139 = phi i64 [ 0, %for.body790.preheader ], [ %indvars.iv.next3140, %invoke.cont795 ]
  %545 = load ptr, ptr %_items.i1964, align 8, !tbaa !36
  %Index = getelementptr inbounds %"struct.NArchive::N7z::CRefItem", ptr %545, i64 %indvars.iv3139, i32 1
...
invoke.cont795:                                   ; preds = %for.body790
  ...
  %exitcond3144.not = icmp eq i64 %indvars.iv.next3140, %wide.trip.count3143
  br i1 %exitcond3144.not, label %for.body803, label %for.body790, !llvm.loop !216
...
for.body803:                                      ; preds = %invoke.cont795, %for.cond801
  %retval.232862 = phi i32 [ %retval.28, %for.cond801 ], [ %retval.10.lcssa, %invoke.cont795 ]
  %i124.52861 = phi i32 [ %i124.7, %for.cond801 ], [ 0, %invoke.cont795 ]
  %call.i.i20002002 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #18
...
_ZN11CStringBaseIwEC2Ev.exit:                     ; preds = %for.body803
  ...
  %cmp8082831 = icmp slt i32 %i124.52861, %505
  br i1 %cmp8082831, label %for.body811.preheader, label %for.end853.thread

for.body811.preheader:                            ; preds = %_ZN11CStringBaseIwEC2Ev.exit
  %552 = sext i32 %i124.52861 to i64
  br label %for.body811

for.body811:                                      ; preds = %for.body811.preheader, %for.inc851
  %indvars.iv3147 = phi i64 [ 0, %for.body811.preheader ], [ %indvars.iv.next3148, %for.inc851 ]
  %indvars.iv3145 = phi i64 [ %552, %for.body811.preheader ], [ %indvars.iv.next3146, %for.inc851 ]
  %totalSize.02836 = phi i64 [ 0, %for.body811.preheader ], [ %add820, %for.inc851 ]
  %prevExtension.sroa.0.22835 = phi ptr [ %call.i.i20002002, %for.body811.preheader ], [ %prevExtension.sroa.0.72296, %for.inc851 ]
  %prevExtension.sroa.13.22834 = phi i32 [ 4, %for.body811.preheader ], [ %prevExtension.sroa.13.72295, %for.inc851 ]
  %553 = load ptr, ptr %_items.i1993, align 8, !tbaa !36
  %arrayidx.i2005 = getelementptr inbounds i32, ptr %553, i64 %indvars.iv3145
  ...
  %add820 = add i64 %557, %totalSize.02836
  %558 = load i64, ptr %NumSolidBytes, align 8, !tbaa !218
  %cmp821 = icmp ugt i64 %add820, %558
  br i1 %cmp821, label %for.end853, label %if.end823
...
if.then825:                                       ; preds = %if.end823
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ext) #17
...
invoke.cont827:                                   ; preds = %_ZNK8NArchive3N7z11CUpdateItem15GetExtensionPosEv.exit.i
  %cmp828 = icmp eq i64 %indvars.iv3147, 0
  br i1 %cmp828, label %if.then829, label %if.else833

if.then829:                                       ; preds = %invoke.cont827
  store i32 0, ptr %prevExtension.sroa.0.22835, align 4, !tbaa !11
  %566 = load i32, ptr %_length.i2018, align 8, !tbaa !5
  %add.i.i2019 = add nsw i32 %566, 1
  %cmp.i.i2021 = icmp eq i32 %add.i.i2019, %prevExtension.sroa.13.22834
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i2032:    ; preds = %if.end9.i.i2031, %if.then829
  %prevExtension.sroa.13.3 = phi i32 [ %prevExtension.sroa.13.22834, %if.then829 ], [ %add.i.i2019, %if.end9.i.i2031 ]
  %prevExtension.sroa.0.3 = phi ptr [ %prevExtension.sroa.0.22835, %if.then829 ], [ %call.i.i20242040, %if.end9.i.i2031 ]
...
delete.notnull.i2042:                             ; preds = %lpad830
  call void @_ZdaPv(ptr noundef nonnull %574) #19
  br label %ehcleanup845

if.else833:                                       ; preds = %invoke.cont827
  %575 = load ptr, ptr %ext, align 8, !tbaa !81
  %call.i20432044 = invoke noundef i32 @_Z21MyStringCompareNoCasePKwS0_(ptr noundef %575, ptr noundef %prevExtension.sroa.0.22835)
...
if.end839:                                        ; preds = %while.cond.i.i2038, %invoke.cont834
  %prevExtension.sroa.13.4 = phi i32 [ %prevExtension.sroa.13.22834, %invoke.cont834 ], [ %prevExtension.sroa.13.3, %while.cond.i.i2038 ]
  %prevExtension.sroa.0.4 = phi ptr [ %prevExtension.sroa.0.22835, %invoke.cont834 ], [ %prevExtension.sroa.0.3, %while.cond.i.i2038 ]
  br label %cleanup840

cleanup840:                                       ; preds = %invoke.cont834, %if.end839
  %prevExtension.sroa.13.5 = phi i32 [ %prevExtension.sroa.13.4, %if.end839 ], [ %prevExtension.sroa.13.22834, %invoke.cont834 ]
  %prevExtension.sroa.0.5 = phi ptr [ %prevExtension.sroa.0.4, %if.end839 ], [ %prevExtension.sroa.0.22835, %invoke.cont834 ]
...
delete.notnull.i2046:                             ; preds = %cleanup840
  call void @_ZdaPv(ptr noundef nonnull %576) #19
  br label %_ZN11CStringBaseIwED2Ev.exit2047

_ZN11CStringBaseIwED2Ev.exit2047:                 ; preds = %cleanup840, %delete.notnull.i2046
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ext) #17
  br i1 %cond1178, label %for.inc851, label %for.end853
...
for.inc851:                                       ; preds = %_ZN11CStringBaseIwED2Ev.exit2047, %if.end823
  %prevExtension.sroa.0.72296 = phi ptr [ %prevExtension.sroa.0.22835, %if.end823 ], [ %prevExtension.sroa.0.5, %_ZN11CStringBaseIwED2Ev.exit2047 ]
  %prevExtension.sroa.13.72295 = phi i32 [ %prevExtension.sroa.13.22834, %if.end823 ], [ %prevExtension.sroa.13.5, %_ZN11CStringBaseIwED2Ev.exit2047 ]
  %indvars.iv.next3148 = add nuw nsw i64 %indvars.iv3147, 1
  %577 = add nsw i64 %indvars.iv.next3148, %552
  %indvars.iv.next3146 = add nsw i64 %indvars.iv3145, 1
  %cmp808 = icmp slt i64 %577, %wide.trip.count3143
  %conv809 = and i64 %indvars.iv.next3148, 4294967295
  %cmp810 = icmp ugt i64 %spec.store.select.fr, %conv809
  %578 = and i1 %cmp808, %cmp810
  br i1 %578, label %for.body811, label %for.end853, !llvm.loop !223

for.end853:                                       ; preds = %for.inc851, %for.body811, %_ZN11CStringBaseIwED2Ev.exit2047
  %numSubFiles.0.lcssa.ph.in = phi i64 [ %indvars.iv.next3148, %for.inc851 ], [ %indvars.iv3147, %for.body811 ], [ %indvars.iv3147, %_ZN11CStringBaseIwED2Ev.exit2047 ]
  %prevExtension.sroa.0.8.ph = phi ptr [ %prevExtension.sroa.0.72296, %for.inc851 ], [ %prevExtension.sroa.0.22835, %for.body811 ], [ %prevExtension.sroa.0.5, %_ZN11CStringBaseIwED2Ev.exit2047 ]
  %numSubFiles.0.lcssa.ph.in.fr = freeze i64 %numSubFiles.0.lcssa.ph.in
  %numSubFiles.0.lcssa.ph = trunc i64 %numSubFiles.0.lcssa.ph.in.fr to i32
  %cmp854 = icmp eq i32 %numSubFiles.0.lcssa.ph, 0
  br i1 %cmp854, label %for.end853.thread, label %579

for.end853.thread:                                ; preds = %_ZN11CStringBaseIwEC2Ev.exit, %for.end853
  %prevExtension.sroa.0.83196 = phi ptr [ %prevExtension.sroa.0.8.ph, %for.end853 ], [ %call.i.i20002002, %_ZN11CStringBaseIwEC2Ev.exit ]
  br label %579

579:                                              ; preds = %for.end853, %for.end853.thread
  %prevExtension.sroa.0.83195 = phi ptr [ %prevExtension.sroa.0.83196, %for.end853.thread ], [ %prevExtension.sroa.0.8.ph, %for.end853 ]
  %580 = phi i32 [ 1, %for.end853.thread ], [ %numSubFiles.0.lcssa.ph, %for.end853 ]
  %call859 = invoke noalias noundef nonnull dereferenceable(184) ptr @_Znwm(i64 noundef 184) #18
          to label %invoke.cont858 unwind label %lpad857

invoke.cont858:                                   ; preds = %579
...
invoke.cont861:                                   ; preds = %invoke.cont858
  ...
  %581 = load ptr, ptr %vfn.i2049, align 8
  %call.i20502053 = invoke noundef i32 %581(ptr noundef nonnull align 8 dereferenceable(8) %call859)
          to label %invoke.cont864 unwind label %lpad863

invoke.cont864:                                   ; preds = %invoke.cont861
  %582 = load ptr, ptr %_items.i1993, align 8, !tbaa !36
  %idxprom.i2055 = sext i32 %i124.52861 to i64
  %arrayidx.i2056 = getelementptr inbounds i32, ptr %582, i64 %idxprom.i2055
  invoke void @_ZN8NArchive3N7z15CFolderInStream4InitEP22IArchiveUpdateCallbackPKjj(ptr noundef nonnull align 8 dereferenceable(184) %call859, ptr noundef nonnull %updateCallback, ptr noundef nonnull %arrayidx.i2056, i32 noundef %580)
          to label %invoke.cont870 unwind label %lpad865

invoke.cont870:                                   ; preds = %invoke.cont864
  call void @llvm.lifetime.start.p0(i64 136, ptr nonnull %folderItem) #17
...
invoke.cont886:                                   ; preds = %invoke.cont870
  ...
  %retval.23.call887 = select i1 %cmp888.not, i32 %retval.232862, i32 %call887
  br i1 %cmp888.not, label %for.cond895.preheader, label %cleanup991

for.cond895.preheader:                            ; preds = %invoke.cont886
  %585 = load i32, ptr %_size.i1823, align 4, !tbaa !33
  %cmp8992851 = icmp slt i32 %583, %585
  br i1 %cmp8992851, label %for.body900.lr.ph, label %for.end908

for.body900.lr.ph:                                ; preds = %for.cond895.preheader
  %586 = load ptr, ptr %_items.i1831, align 8, !tbaa !36
  %OutSize904.promoted = load i64, ptr %OutSize, align 8, !tbaa !185
  %587 = sext i32 %583 to i64
  %wide.trip.count3158 = sext i32 %585 to i64
  %588 = sub nsw i64 %wide.trip.count3158, %587
  %min.iters.check4253 = icmp ult i64 %588, 14
  br i1 %min.iters.check4253, label %for.body900.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %for.body900.lr.ph
  %589 = shl nsw i64 %587, 3
  %uglygep4249 = getelementptr i8, ptr %586, i64 %589
  %590 = shl nsw i64 %wide.trip.count3158, 3
  %uglygep4250 = getelementptr i8, ptr %586, i64 %590
  %bound0 = icmp ult ptr %OutSize, %uglygep4250
  %bound1 = icmp ult ptr %uglygep4249, %uglygep
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %for.body900.preheader, label %vector.ph4254

vector.ph4254:                                    ; preds = %vector.memcheck
  %n.vec4256 = and i64 %588, -4
  %ind.end = add nsw i64 %n.vec4256, %587
  %591 = insertelement <2 x i64> <i64 poison, i64 0>, i64 %OutSize904.promoted, i64 0
  br label %vector.body4259

vector.body4259:                                  ; preds = %vector.body4259, %vector.ph4254
  %index = phi i64 [ 0, %vector.ph4254 ], [ %index.next4265, %vector.body4259 ]
  %vec.phi4260 = phi <2 x i64> [ %591, %vector.ph4254 ], [ %594, %vector.body4259 ]
  %vec.phi4261 = phi <2 x i64> [ zeroinitializer, %vector.ph4254 ], [ %595, %vector.body4259 ]
  %offset.idx4262 = add i64 %index, %587
  %592 = getelementptr inbounds i64, ptr %586, i64 %offset.idx4262
  %wide.load4263 = load <2 x i64>, ptr %592, align 8, !tbaa !109, !alias.scope !224
  %593 = getelementptr inbounds i64, ptr %592, i64 2
  %wide.load4264 = load <2 x i64>, ptr %593, align 8, !tbaa !109, !alias.scope !224
  %594 = add <2 x i64> %wide.load4263, %vec.phi4260
  %595 = add <2 x i64> %wide.load4264, %vec.phi4261
  %index.next4265 = add nuw i64 %index, 4
  %596 = icmp eq i64 %index.next4265, %n.vec4256
  br i1 %596, label %middle.block4251, label %vector.body4259, !llvm.loop !227

middle.block4251:                                 ; preds = %vector.body4259
  %bin.rdx4266 = add <2 x i64> %595, %594
  %597 = call i64 @llvm.vector.reduce.add.v2i64(<2 x i64> %bin.rdx4266)
  store i64 %597, ptr %OutSize, align 8, !tbaa !185
  %cmp.n4258 = icmp eq i64 %588, %n.vec4256
  br i1 %cmp.n4258, label %for.end908, label %for.body900.preheader

for.body900.preheader:                            ; preds = %vector.memcheck, %for.body900.lr.ph, %middle.block4251
  %indvars.iv3154.ph = phi i64 [ %587, %vector.memcheck ], [ %587, %for.body900.lr.ph ], [ %ind.end, %middle.block4251 ]
  %add9052853.ph = phi i64 [ %OutSize904.promoted, %vector.memcheck ], [ %OutSize904.promoted, %for.body900.lr.ph ], [ %597, %middle.block4251 ]
  %598 = sub nsw i64 %wide.trip.count3158, %indvars.iv3154.ph
  %599 = xor i64 %indvars.iv3154.ph, -1
  %600 = add nsw i64 %599, %wide.trip.count3158
  %xtraiter4536 = and i64 %598, 3
  %lcmp.mod4537.not = icmp eq i64 %xtraiter4536, 0
  br i1 %lcmp.mod4537.not, label %for.body900.prol.loopexit, label %for.body900.prol

for.body900.prol:                                 ; preds = %for.body900.preheader, %for.body900.prol
  %indvars.iv3154.prol = phi i64 [ %indvars.iv.next3155.prol, %for.body900.prol ], [ %indvars.iv3154.ph, %for.body900.preheader ]
  %add9052853.prol = phi i64 [ %add905.prol, %for.body900.prol ], [ %add9052853.ph, %for.body900.preheader ]
  %prol.iter4538 = phi i64 [ %prol.iter4538.next, %for.body900.prol ], [ 0, %for.body900.preheader ]
  %arrayidx.i2073.prol = getelementptr inbounds i64, ptr %586, i64 %indvars.iv3154.prol
  %601 = load i64, ptr %arrayidx.i2073.prol, align 8, !tbaa !109
  %add905.prol = add i64 %601, %add9052853.prol
  store i64 %add905.prol, ptr %OutSize, align 8, !tbaa !185
  %indvars.iv.next3155.prol = add nsw i64 %indvars.iv3154.prol, 1
  %prol.iter4538.next = add i64 %prol.iter4538, 1
  %prol.iter4538.cmp.not = icmp eq i64 %prol.iter4538.next, %xtraiter4536
  br i1 %prol.iter4538.cmp.not, label %for.body900.prol.loopexit, label %for.body900.prol, !llvm.loop !228

for.body900.prol.loopexit:                        ; preds = %for.body900.prol, %for.body900.preheader
  %indvars.iv3154.unr = phi i64 [ %indvars.iv3154.ph, %for.body900.preheader ], [ %indvars.iv.next3155.prol, %for.body900.prol ]
  %add9052853.unr = phi i64 [ %add9052853.ph, %for.body900.preheader ], [ %add905.prol, %for.body900.prol ]
...
lpad860:                                          ; preds = %invoke.cont858
  %604 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %call859) #19
  br label %ehcleanup1004
...
for.body900:                                      ; preds = %for.body900.prol.loopexit, %for.body900
  %indvars.iv3154 = phi i64 [ %indvars.iv.next3155.3, %for.body900 ], [ %indvars.iv3154.unr, %for.body900.prol.loopexit ]
  %add9052853 = phi i64 [ %add905.3, %for.body900 ], [ %add9052853.unr, %for.body900.prol.loopexit ]
  %arrayidx.i2073 = getelementptr inbounds i64, ptr %586, i64 %indvars.iv3154
  %608 = load i64, ptr %arrayidx.i2073, align 8, !tbaa !109
  %add905 = add i64 %608, %add9052853
  store i64 %add905, ptr %OutSize, align 8, !tbaa !185
  %indvars.iv.next3155 = add nsw i64 %indvars.iv3154, 1
  %arrayidx.i2073.1 = getelementptr inbounds i64, ptr %586, i64 %indvars.iv.next3155
  %609 = load i64, ptr %arrayidx.i2073.1, align 8, !tbaa !109
  %add905.1 = add i64 %609, %add905
  store i64 %add905.1, ptr %OutSize, align 8, !tbaa !185
  %indvars.iv.next3155.1 = add nsw i64 %indvars.iv3154, 2
  %arrayidx.i2073.2 = getelementptr inbounds i64, ptr %586, i64 %indvars.iv.next3155.1
  %610 = load i64, ptr %arrayidx.i2073.2, align 8, !tbaa !109
  %add905.2 = add i64 %610, %add905.1
  store i64 %add905.2, ptr %OutSize, align 8, !tbaa !185
  %indvars.iv.next3155.2 = add nsw i64 %indvars.iv3154, 3
  %arrayidx.i2073.3 = getelementptr inbounds i64, ptr %586, i64 %indvars.iv.next3155.2
  %611 = load i64, ptr %arrayidx.i2073.3, align 8, !tbaa !109
  %add905.3 = add i64 %611, %add905.2
  store i64 %add905.3, ptr %OutSize, align 8, !tbaa !185
  %indvars.iv.next3155.3 = add nsw i64 %indvars.iv3154, 4
  %exitcond3159.not.3 = icmp eq i64 %indvars.iv.next3155.3, %wide.trip.count3158
  br i1 %exitcond3159.not.3, label %for.end908, label %for.body900, !llvm.loop !229

for.end908:                                       ; preds = %for.body900.prol.loopexit, %for.body900, %middle.block4251, %for.cond895.preheader
  %612 = load i32, ptr %_size.i.i2074, align 4, !tbaa !33
  %cmp.i.i2075 = icmp eq i32 %612, 0
  br i1 %cmp.i.i2075, label %invoke.cont909, label %for.cond.preheader.i2081

for.cond.preheader.i2081:                         ; preds = %for.end908
  %613 = load i32, ptr %_size.i.i.i2076, align 4
  %.fr.i2077 = freeze i32 %613
  %cmp.not8.i.i2078 = icmp sgt i32 %.fr.i2077, 0
  %614 = load ptr, ptr %_items.i.i.i2079, align 8
...
for.cond.us.i2085:                                ; preds = %for.cond.preheader.i2081, %_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit.us.i2094
  %i.0.in.us.i2082 = phi i32 [ %i.0.us.i2083, %_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit.us.i2094 ], [ %612, %for.cond.preheader.i2081 ]
...
for.body.i.us.i2089:                              ; preds = %for.cond.us.i2085, %for.inc.i.us.i2092
  ...
  %OutIndex.i.us.i2087 = getelementptr inbounds %"struct.NArchive::N7z::CBindPair", ptr %614, i64 %indvars.iv.i.us.i2086, i32 1
  %615 = load i32, ptr %OutIndex.i.us.i2087, align 4, !tbaa !192
  %cmp4.i.us.i2088 = icmp eq i32 %615, %i.0.us.i2083
...
_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit.us.i2094: ; preds = %for.body.i.us.i2089
  %616 = and i64 %indvars.iv.i.us.i2086, 2147483648
  %cmp5.not.us.i2093 = icmp eq i64 %616, 0
...
for.cond.i2097:                                   ; preds = %for.cond.preheader.i2081
  %i.0.i2095 = add nsw i32 %612, -1
  %cmp.i2096 = icmp sgt i32 %612, 0
...
cleanup.i2102:                                    ; preds = %_ZNK8NArchive3N7z7CFolder24FindBindPairForOutStreamEj.exit.us.i2094, %for.inc.i.us.i2092, %for.cond.i2097
  ...
  %617 = load ptr, ptr %_items.i.i2099, align 8, !tbaa !36
  %idxprom.i.i2100 = sext i32 %i.024.i2098 to i64
  %arrayidx.i.i2101 = getelementptr inbounds i64, ptr %617, i64 %idxprom.i.i2100
  %618 = load i64, ptr %arrayidx.i.i2101, align 8, !tbaa !109
  br label %invoke.cont909

for.end.i2104:                                    ; preds = %for.cond.i2097, %for.cond.us.i2085
  %exception.i2103 = call ptr @__cxa_allocate_exception(i64 4) #17
  store i32 1, ptr %exception.i2103, align 16, !tbaa !51
  invoke void @__cxa_throw(ptr nonnull %exception.i2103, ptr nonnull @_ZTIi, ptr null) #21
...
invoke.cont909:                                   ; preds = %cleanup.i2102, %for.end908
  %retval.1.i2105 = phi i64 [ %618, %cleanup.i2102 ], [ 0, %for.end908 ]
  %619 = load i64, ptr %InSize, align 8, !tbaa !196
  %add912 = add i64 %619, %retval.1.i2105
  store i64 %add912, ptr %InSize, align 8, !tbaa !196
  %call.i21082116 = invoke noalias noundef nonnull dereferenceable(136) ptr @_Znwm(i64 noundef 136) #18
...
invoke.cont.i2114:                                ; preds = %call.i2108.noexc
  invoke void @_ZN17CBaseRecordVector18ReserveOnePositionEv(ptr noundef nonnull align 8 dereferenceable(32) %Folders620)
          to label %for.body920.lr.ph unwind label %lpad873.loopexit

lpad.i2115:                                       ; preds = %call.i2108.noexc
  %620 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPv(ptr noundef nonnull %call.i21082116) #19
  br label %ehcleanup992

for.body920.lr.ph:                                ; preds = %invoke.cont.i2114
  %621 = load ptr, ptr %_items.i.i1844, align 8, !tbaa !36
  %622 = load i32, ptr %_size.i.i1845, align 4, !tbaa !33
  %idxprom.i.i2111 = sext i32 %622 to i64
  %arrayidx.i.i2112 = getelementptr inbounds ptr, ptr %621, i64 %idxprom.i.i2111
  store ptr %call.i21082116, ptr %arrayidx.i.i2112, align 8, !tbaa !37
  %inc.i.i2113 = add nsw i32 %622, 1
  ...
  %wide.trip.count3165 = zext i32 %580 to i64
  br label %for.body920

for.body920:                                      ; preds = %for.body920.lr.ph, %for.inc978
  %indvars.iv3160 = phi i64 [ 0, %for.body920.lr.ph ], [ %indvars.iv.next3161, %for.inc978 ]
  %retval.252857 = phi i32 [ %retval.23.call887, %for.body920.lr.ph ], [ %retval.26, %for.inc978 ]
  %numUnpackStreams916.02855 = phi i32 [ 0, %for.body920.lr.ph ], [ %numUnpackStreams916.2, %for.inc978 ]
  %623 = add nsw i64 %indvars.iv3160, %idxprom.i2055
  %624 = load ptr, ptr %_items.i1993, align 8, !tbaa !36
  %arrayidx.i2122 = getelementptr inbounds i32, ptr %624, i64 %623
  %625 = load i32, ptr %arrayidx.i2122, align 4, !tbaa !51
  %626 = load ptr, ptr %_items.i.i1778, align 8, !tbaa !36
  %idxprom.i.i2124 = sext i32 %625 to i64
  %arrayidx.i.i2125 = getelementptr inbounds ptr, ptr %626, i64 %idxprom.i.i2124
  %627 = load ptr, ptr %arrayidx.i.i2125, align 8, !tbaa !37
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %file928) #17
  store i64 17179869184, ptr %194, align 8
  %call.i.i.i21282133 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #18
...
invoke.cont930:                                   ; preds = %for.body920
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %file2931) #17
  %NewProps932 = getelementptr inbounds %"struct.NArchive::N7z::CUpdateItem", ptr %627, i64 0, i32 9
  %628 = load i8, ptr %NewProps932, align 1, !tbaa !199, !range !42, !noundef !43
...
lpad935:                                          ; preds = %if.end950, %if.else937, %if.then934
  %630 = landingpad { ptr, i32 }
          cleanup
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %file2931) #17
  %631 = load ptr, ptr %Name.i2126, align 8, !tbaa !81
  %isnull.i.i2136 = icmp eq ptr %631, null
  br i1 %isnull.i.i2136, label %ehcleanup973, label %delete.notnull.i.i2137

delete.notnull.i.i2137:                           ; preds = %lpad935
  call void @_ZdaPv(ptr noundef nonnull %631) #19
  br label %ehcleanup973

if.else937:                                       ; preds = %invoke.cont930
  %632 = load i32, ptr %627, align 8, !tbaa !96
...
if.end940:                                        ; preds = %if.else937, %if.then934
  ...
  %634 = load i8, ptr %IsDir.i2130, align 1
...
if.end945:                                        ; preds = %if.end940
  %635 = load ptr, ptr %_items.i2139, align 8, !tbaa !36
  %arrayidx.i2141 = getelementptr inbounds i8, ptr %635, i64 %indvars.iv3160
  %636 = load i8, ptr %arrayidx.i2141, align 1, !tbaa !41, !range !42, !noundef !43
  %tobool948.not = icmp eq i8 %636, 0
  br i1 %tobool948.not, label %cleanup968, label %if.end950

if.end950:                                        ; preds = %if.end945
  %637 = load ptr, ptr %_items.i2142, align 8, !tbaa !36
  %arrayidx.i2144 = getelementptr inbounds i32, ptr %637, i64 %indvars.iv3160
  %638 = load i32, ptr %arrayidx.i2144, align 4, !tbaa !51
  store i32 %638, ptr %Crc953, align 4, !tbaa !50
  %639 = load ptr, ptr %_items.i2145, align 8, !tbaa !36
  %arrayidx.i2147 = getelementptr inbounds i64, ptr %639, i64 %indvars.iv3160
  %640 = load i64, ptr %arrayidx.i2147, align 8, !tbaa !109
  store i64 %640, ptr %file928, align 8, !tbaa !38
  %cmp958.not = icmp ne i64 %640, 0
  %spec.select3402 = zext i1 %cmp958.not to i8
  %inc962 = zext i1 %cmp958.not to i32
  %spec.select3403 = add i32 %numUnpackStreams916.02855, %inc962
  store i8 %spec.select3402, ptr %CrcDefined.i2131, align 2
  store i8 %spec.select3402, ptr %HasStream.i2129, align 8
...
cleanup968:                                       ; preds = %if.end950, %if.end945, %if.end940
  %numUnpackStreams916.2 = phi i32 [ %numUnpackStreams916.02855, %if.end940 ], [ %numUnpackStreams916.02855, %if.end945 ], [ %spec.select3403, %if.end950 ]
  %cleanup.dest.slot.23 = phi i32 [ 1, %if.end940 ], [ 57, %if.end945 ], [ 0, %if.end950 ]
  %retval.26 = phi i32 [ -2147467259, %if.end940 ], [ %retval.252857, %if.end945 ], [ %retval.252857, %if.end950 ]
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %file2931) #17
  %641 = load ptr, ptr %Name.i2126, align 8, !tbaa !81
  %isnull.i.i2149 = icmp eq ptr %641, null
...
_ZN8NArchive3N7z9CFileItemD2Ev.exit2151:          ; preds = %cleanup968, %delete.notnull.i.i2150
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %file928) #17
...
for.inc978:                                       ; preds = %_ZN8NArchive3N7z9CFileItemD2Ev.exit2151, %_ZN8NArchive3N7z9CFileItemD2Ev.exit2151
  %indvars.iv.next3161 = add nuw nsw i64 %indvars.iv3160, 1
  %exitcond3166.not = icmp eq i64 %indvars.iv.next3161, %wide.trip.count3165
  br i1 %exitcond3166.not, label %for.end983, label %for.body920, !llvm.loop !232

ehcleanup973:                                     ; preds = %delete.notnull.i.i2137, %lpad935, %lpad929
  %.pn1481 = phi { ptr, i32 } [ %629, %lpad929 ], [ %630, %lpad935 ], [ %630, %delete.notnull.i.i2137 ]
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %file928) #17
  br label %ehcleanup992
...
invoke.cont986:                                   ; preds = %for.end983
  %642 = load ptr, ptr %_items.i1897, align 8, !tbaa !36
  %643 = load i32, ptr %_size.i1898, align 4, !tbaa !33
  %idxprom.i2154 = sext i32 %643 to i64
  %arrayidx.i2155 = getelementptr inbounds i32, ptr %642, i64 %idxprom.i2154
  store i32 %numUnpackStreams916.2, ptr %arrayidx.i2155, align 4, !tbaa !51
  %644 = load i32, ptr %_size.i1898, align 4, !tbaa !33
  %inc.i2156 = add nsw i32 %644, 1
  store i32 %inc.i2156, ptr %_size.i1898, align 4, !tbaa !33
  %add988 = add nsw i32 %580, %i124.52861
  br label %cleanup991

cleanup991:                                       ; preds = %_ZN8NArchive3N7z9CFileItemD2Ev.exit2151, %invoke.cont986, %invoke.cont886
  %i124.7 = phi i32 [ %i124.52861, %invoke.cont886 ], [ %add988, %invoke.cont986 ], [ %i124.52861, %_ZN8NArchive3N7z9CFileItemD2Ev.exit2151 ]
  ...
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %UnpackSizes.i2065) #17
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %PackStreams.i2062) #17
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %BindPairs.i2059) #17
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN8NArchive3N7z10CCoderInfoEE, i64 0, inrange i32 0, i64 2), ptr %folderItem, align 8, !tbaa !28
...
if.then.i2168:                                    ; preds = %cleanup991
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %folderItem) #17
  call void @llvm.lifetime.end.p0(i64 136, ptr nonnull %folderItem) #17
  %vtable.i2165 = load ptr, ptr %call859, align 8, !tbaa !28
  %vfn.i2166 = getelementptr inbounds ptr, ptr %vtable.i2165, i64 2
  %647 = load ptr, ptr %vfn.i2166, align 8
  %call.i2167 = invoke noundef i32 %647(ptr noundef nonnull align 8 dereferenceable(8) %call859)
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit2171: ; preds = %if.then.i2168
  %isnull.i2172 = icmp eq ptr %prevExtension.sroa.0.83195, null
...
delete.notnull.i2173:                             ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit2171
  call void @_ZdaPv(ptr noundef nonnull %prevExtension.sroa.0.83195) #19
...
ehcleanup992:                                     ; preds = %lpad873.loopexit, %lpad873.loopexit.split-lp, %lpad.i2115, %ehcleanup973, %lpad985, %lpad877
  %.pn1482.pn = phi { ptr, i32 } [ %607, %lpad877 ], [ %650, %lpad985 ], [ %.pn1481, %ehcleanup973 ], [ %620, %lpad.i2115 ], [ %lpad.loopexit2321, %lpad873.loopexit ], [ %lpad.loopexit.split-lp, %lpad873.loopexit.split-lp ]
  call void @_ZN8NArchive3N7z7CFolderD2Ev(ptr noundef nonnull align 8 dereferenceable(133) %folderItem) #17
  call void @llvm.lifetime.end.p0(i64 136, ptr nonnull %folderItem) #17
  br label %if.then.i2179

if.then.i2179:                                    ; preds = %lpad865, %ehcleanup992
  %.pn1482.pn.pn.pn = phi { ptr, i32 } [ %.pn1482.pn, %ehcleanup992 ], [ %606, %lpad865 ]
  %vtable.i2176 = load ptr, ptr %call859, align 8, !tbaa !28
  %vfn.i2177 = getelementptr inbounds ptr, ptr %vtable.i2176, i64 2
  %651 = load ptr, ptr %vfn.i2177, align 8
  %call.i2178 = invoke noundef i32 %651(ptr noundef nonnull align 8 dereferenceable(8) %call859)
...
ehcleanup1004:                                    ; preds = %lpad863, %if.then.i2179, %lpad857, %lpad860, %ehcleanup845
  %prevExtension.sroa.0.9 = phi ptr [ %prevExtension.sroa.0.83195, %lpad860 ], [ %prevExtension.sroa.0.83195, %lpad857 ], [ %prevExtension.sroa.0.22835, %ehcleanup845 ], [ %prevExtension.sroa.0.83195, %if.then.i2179 ], [ %prevExtension.sroa.0.83195, %lpad863 ]
  %.pn1482.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %604, %lpad860 ], [ %603, %lpad857 ], [ %.pn1490, %ehcleanup845 ], [ %.pn1482.pn.pn.pn, %if.then.i2179 ], [ %605, %lpad863 ]
...
delete.notnull.i2184:                             ; preds = %ehcleanup1004
  call void @_ZdaPv(ptr noundef nonnull %prevExtension.sroa.0.9) #19
  br label %ehcleanup1015
...
cleanup1014:                                      ; preds = %_ZN11CStringBaseIwED2Ev.exit2174, %for.cond801, %for.cond788.preheader
  ...
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %indices) #17
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %indices) #17
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %sortByType) #17
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %refItems) #17
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %refItems) #17
...
cleanup1026.loopexit:                             ; preds = %_ZN13CStreamBinderD2Ev.exit, %invoke.cont420
  ...
  %654 = trunc i64 %indvars.iv3130 to i32
  br label %cleanup1026

cleanup1026:                                      ; preds = %cleanup1026.loopexit, %cleanup1014, %for.end749
  %folderRefIndex.12391 = phi i32 [ %folderRefIndex.1.lcssa, %for.end749 ], [ %folderRefIndex.1.lcssa, %cleanup1014 ], [ %654, %cleanup1026.loopexit ]
  ...
  call void @_ZN8NArchive3N7z8CEncoderD1Ev(ptr noundef nonnull align 8 dereferenceable(433) %encoder) #17
  call void @llvm.lifetime.end.p0(i64 440, ptr nonnull %encoder) #17
  %655 = load ptr, ptr %Password.i1649, align 8, !tbaa !81
  %isnull.i.i2187 = icmp eq ptr %655, null
...
_ZN8NArchive3N7z22CCompressionMethodModeD2Ev.exit: ; preds = %_ZN11CStringBaseIwED2Ev.exit.i
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %method350) #17
  call void @llvm.lifetime.end.p0(i64 88, ptr nonnull %method350) #17
...
for.inc1038:                                      ; preds = %_ZN8NArchive3N7z22CCompressionMethodModeD2Ev.exit, %_ZN8NArchive3N7z22CCompressionMethodModeD2Ev.exit
  ...
  %exitcond3171.not = icmp eq i64 %indvars.iv.next3168, 4
  br i1 %exitcond3171.not, label %for.end1043, label %invoke.cont348, !llvm.loop !233
...
ehcleanup1031:                                    ; preds = %lpad353, %ehcleanup102.i, %ehcleanup84.i, %ehcleanup1029
  ...
  call void @_ZN8NArchive3N7z22CCompressionMethodModeD2Ev(ptr noundef nonnull align 8 dereferenceable(88) %method350) #17
  br label %ehcleanup1033
...
for.end1043:                                      ; preds = %for.inc1038
  %658 = load i32, ptr %_size.i1595, align 4, !tbaa !33
  %cmp1047.not = icmp eq i32 %folderRefIndex.12391, %658
...
if.end1049:                                       ; preds = %for.end1043
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %emptyRefs) #17
  ...
  %660 = load i32, ptr %_size.i1590, align 4, !tbaa !33
  %cmp10562880 = icmp sgt i32 %660, 0
  br i1 %cmp10562880, label %for.body1057.lr.ph, label %for.end1090
...
for.body1057:                                     ; preds = %for.body1057.lr.ph, %cleanup1084
  ...
  %indvars.iv3172 = phi i64 [ 0, %for.body1057.lr.ph ], [ %indvars.iv.next3173, %cleanup1084 ]
  %662 = load ptr, ptr %_items.i.i1778, align 8, !tbaa !36
  %arrayidx.i.i2197 = getelementptr inbounds ptr, ptr %662, i64 %indvars.iv3172
  %663 = load ptr, ptr %arrayidx.i.i2197, align 8, !tbaa !37
  %NewData1062 = getelementptr inbounds %"struct.NArchive::N7z::CUpdateItem", ptr %663, i64 0, i32 8
  %664 = load i8, ptr %NewData1062, align 4, !tbaa !100, !range !42, !noundef !43
  %tobool1063.not = icmp eq i8 %664, 0
  br i1 %tobool1063.not, label %if.else1069, label %if.then1064

if.then1064:                                      ; preds = %for.body1057
  %IsDir.i2198 = getelementptr inbounds %"struct.NArchive::N7z::CUpdateItem", ptr %663, i64 0, i32 11
  %665 = load i8, ptr %IsDir.i2198, align 1, !tbaa !121, !range !42, !noundef !43
  %tobool.not.i2199 = icmp eq i8 %665, 0
  %IsAnti.i2200 = getelementptr inbounds %"struct.NArchive::N7z::CUpdateItem", ptr %663, i64 0, i32 10
  %666 = load i8, ptr %IsAnti.i2200, align 2
  %tobool2.not.i2201 = icmp eq i8 %666, 0
...
_ZNK8NArchive3N7z11CUpdateItem9HasStreamEv.exit2206: ; preds = %if.then1064
  %Size.i2203 = getelementptr inbounds %"struct.NArchive::N7z::CUpdateItem", ptr %663, i64 0, i32 5
  %667 = load i64, ptr %Size.i2203, align 8, !tbaa !117
  %cmp.i2204.not = icmp eq i64 %667, 0
...
if.else1069:                                      ; preds = %for.body1057
  %670 = load i32, ptr %663, align 8, !tbaa !96
...
land.lhs.true1072:                                ; preds = %if.else1069
  %671 = load ptr, ptr %_items.i.i1772, align 8, !tbaa !36
  %idxprom.i.i2208 = sext i32 %670 to i64
  %arrayidx.i.i2209 = getelementptr inbounds ptr, ptr %671, i64 %idxprom.i.i2208
  %672 = load ptr, ptr %arrayidx.i.i2209, align 8, !tbaa !37
  %HasStream1077 = getelementptr inbounds %"struct.NArchive::N7z::CFileItem", ptr %672, i64 0, i32 4
  %673 = load i8, ptr %HasStream1077, align 8, !tbaa !99, !range !42, !noundef !43
...
_ZN13CRecordVectorIiE3AddEi.exit2216:             ; preds = %if.end1081
  %674 = load ptr, ptr %_items.i2210, align 8, !tbaa !36
  %675 = load i32, ptr %_size.i2211, align 4, !tbaa !33
  %idxprom.i2212 = sext i32 %675 to i64
  %arrayidx.i2213 = getelementptr inbounds i32, ptr %674, i64 %idxprom.i2212
  %676 = trunc i64 %indvars.iv3172 to i32
  store i32 %676, ptr %arrayidx.i2213, align 4, !tbaa !51
  %677 = load i32, ptr %_size.i2211, align 4, !tbaa !33
  %inc.i2214 = add nsw i32 %677, 1
  store i32 %inc.i2214, ptr %_size.i2211, align 4, !tbaa !33
  %.pre3186 = load i32, ptr %_size.i1590, align 4, !tbaa !33
...
cleanup1084:                                      ; preds = %_ZN13CRecordVectorIiE3AddEi.exit2216, %land.lhs.true1072, %_ZNK8NArchive3N7z11CUpdateItem9HasStreamEv.exit2206
  %678 = phi i32 [ %.pre3186, %_ZN13CRecordVectorIiE3AddEi.exit2216 ], [ %661, %land.lhs.true1072 ], [ %661, %_ZNK8NArchive3N7z11CUpdateItem9HasStreamEv.exit2206 ]
  %indvars.iv.next3173 = add nuw nsw i64 %indvars.iv3172, 1
  %679 = sext i32 %678 to i64
  %cmp1056 = icmp slt i64 %indvars.iv.next3173, %679
...
for.cond1092.preheader:                           ; preds = %for.end1090
  ...
  %680 = load i32, ptr %_size.i2217, align 4, !tbaa !33
  %cmp10952882 = icmp sgt i32 %680, 0
  br i1 %cmp10952882, label %for.body1096.lr.ph, label %for.end1123
...
for.body1096:                                     ; preds = %for.body1096.lr.ph, %_ZN8NArchive3N7z9CFileItemD2Ev.exit2242
  %indvars.iv3176 = phi i64 [ 0, %for.body1096.lr.ph ], [ %indvars.iv.next3177, %_ZN8NArchive3N7z9CFileItemD2Ev.exit2242 ]
  %682 = load ptr, ptr %_items.i2218, align 8, !tbaa !36
  %arrayidx.i2220 = getelementptr inbounds i32, ptr %682, i64 %indvars.iv3176
  %683 = load i32, ptr %arrayidx.i2220, align 4, !tbaa !51
  %684 = load ptr, ptr %_items.i.i1778, align 8, !tbaa !36
  %idxprom.i.i2222 = sext i32 %683 to i64
  %arrayidx.i.i2223 = getelementptr inbounds ptr, ptr %684, i64 %idxprom.i.i2222
  %685 = load ptr, ptr %arrayidx.i.i2223, align 8, !tbaa !37
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %file1103) #17
  store i64 17179869184, ptr %681, align 8
  %call.i.i.i22262231 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #18
...
invoke.cont1105:                                  ; preds = %for.body1096
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %file21106) #17
  %NewProps1107 = getelementptr inbounds %"struct.NArchive::N7z::CUpdateItem", ptr %685, i64 0, i32 9
  %686 = load i8, ptr %NewProps1107, align 1, !tbaa !199, !range !42, !noundef !43
...
lpad1110:                                         ; preds = %if.end1115, %if.else1112, %if.then1109
  %688 = landingpad { ptr, i32 }
          cleanup
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %file21106) #17
  %689 = load ptr, ptr %Name.i2224, align 8, !tbaa !81
  %isnull.i.i2234 = icmp eq ptr %689, null
...
if.else1112:                                      ; preds = %invoke.cont1105
  %690 = load i32, ptr %685, align 8, !tbaa !96
...
invoke.cont1116:                                  ; preds = %if.end1115
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %file21106) #17
  %691 = load ptr, ptr %Name.i2224, align 8, !tbaa !81
  %isnull.i.i2239 = icmp eq ptr %691, null
...
delete.notnull.i.i2240:                           ; preds = %invoke.cont1116
  call void @_ZdaPv(ptr noundef nonnull %691) #19
...
_ZN8NArchive3N7z9CFileItemD2Ev.exit2242:          ; preds = %invoke.cont1116, %delete.notnull.i.i2240
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %file1103) #17
  %indvars.iv.next3177 = add nuw nsw i64 %indvars.iv3176, 1
  %692 = load i32, ptr %_size.i2217, align 4, !tbaa !33
  %693 = sext i32 %692 to i64
  %cmp1095 = icmp slt i64 %indvars.iv.next3177, %693
...
ehcleanup1119:                                    ; preds = %delete.notnull.i.i2235, %lpad1110, %lpad1104
  %.pn = phi { ptr, i32 } [ %687, %lpad1104 ], [ %688, %lpad1110 ], [ %688, %delete.notnull.i.i2235 ]
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %file1103) #17
  br label %ehcleanup1124

for.end1123:                                      ; preds = %_ZN8NArchive3N7z9CFileItemD2Ev.exit2242, %for.cond1092.preheader
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %emptyRefs) #17
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %emptyRefs) #17
...
ehcleanup1124:                                    ; preds = %ehcleanup1119, %lpad1059, %lpad1053
  %.pn1478 = phi { ptr, i32 } [ %669, %lpad1059 ], [ %.pn, %ehcleanup1119 ], [ %668, %lpad1053 ]
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %emptyRefs) #17
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %emptyRefs) #17
  br label %ehcleanup1132
...
_ZN13CObjectVectorIN8NArchive3N7z11CSolidGroupEED2Ev.exit: ; preds = %cleanup1129
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %groups) #17
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %groups) #17
...
ehcleanup1132:                                    ; preds = %lpad244, %ehcleanup.i, %lpad270, %lpad273, %_ZN10CMyComBSTRD2Ev.exit1642, %lpad322, %lpad333, %ehcleanup1033, %ehcleanup1124, %lpad1044, %lpad207
  %.pn1526.pn = phi { ptr, i32 } [ %134, %lpad207 ], [ %193, %lpad333 ], [ %192, %lpad322 ], [ %180, %lpad270 ], [ %.pn1523, %_ZN10CMyComBSTRD2Ev.exit1642 ], [ %181, %lpad273 ], [ %.pn1478, %ehcleanup1124 ], [ %659, %lpad1044 ], [ %.pn1492.pn.pn.pn.pn.pn, %ehcleanup1033 ], [ %153, %lpad244 ], [ %.pn.i, %ehcleanup.i ]
  call void @_ZN13CObjectVectorIN8NArchive3N7z11CSolidGroupEED2Ev(ptr noundef nonnull align 8 dereferenceable(32) %groups) #17
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %groups) #17
  br label %ehcleanup1136
...
cleanup1135:                                      ; preds = %invoke.cont190, %_ZN13CObjectVectorIN8NArchive3N7z11CSolidGroupEED2Ev.exit
  ...
  call void @_ZN8NArchive3N7z8CDecoderD2Ev(ptr noundef nonnull align 8 dereferenceable(232) %Decoder.i) #17
  %GetTextPassword.i = getelementptr inbounds %"class.NArchive::N7z::CThreadDecoder", ptr %threadDecoder, i64 0, i32 8
  %698 = load ptr, ptr %GetTextPassword.i, align 8, !tbaa !76
  %tobool.not.i.i2248 = icmp eq ptr %698, null
...
if.then.i.i2252:                                  ; preds = %cleanup1135
  %vtable.i.i2249 = load ptr, ptr %698, align 8, !tbaa !28
  %vfn.i.i2250 = getelementptr inbounds ptr, ptr %vtable.i.i2249, i64 2
  %699 = load ptr, ptr %vfn.i.i2250, align 8
  %call.i.i2251 = invoke noundef i32 %699(ptr noundef nonnull align 8 dereferenceable(8) %698)
...
_ZN9CMyComPtrI22ICryptoGetTextPasswordED2Ev.exit.i: ; preds = %if.then.i.i2252, %cleanup1135
  ...
  %702 = load ptr, ptr %Fos.i, align 8, !tbaa !30
  %tobool.not.i2.i = icmp eq ptr %702, null
...
if.then.i6.i:                                     ; preds = %_ZN9CMyComPtrI22ICryptoGetTextPasswordED2Ev.exit.i
  %vtable.i3.i = load ptr, ptr %702, align 8, !tbaa !28
  %vfn.i4.i = getelementptr inbounds ptr, ptr %vtable.i3.i, i64 2
  %703 = load ptr, ptr %vfn.i4.i, align 8
  %call.i5.i = invoke noundef i32 %703(ptr noundef nonnull align 8 dereferenceable(8) %702)
...
_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit.i: ; preds = %if.then.i6.i, %_ZN9CMyComPtrI22ICryptoGetTextPasswordED2Ev.exit.i
  ...
  %706 = load ptr, ptr %InStream.i, align 8, !tbaa !53
  %tobool.not.i8.i = icmp eq ptr %706, null
...
if.then.i12.i:                                    ; preds = %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit.i
  %vtable.i9.i = load ptr, ptr %706, align 8, !tbaa !28
  %vfn.i10.i = getelementptr inbounds ptr, ptr %vtable.i9.i, i64 2
  %707 = load ptr, ptr %vfn.i10.i, align 8
  %call.i11.i = invoke noundef i32 %707(ptr noundef nonnull align 8 dereferenceable(8) %706)
...
if.then.i2258:                                    ; preds = %if.then.i12.i, %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit.i
  call void @_ZN11CVirtThreadD2Ev(ptr noundef nonnull align 8 dereferenceable(233) %threadDecoder) #17
  call void @llvm.lifetime.end.p0(i64 536, ptr nonnull %threadDecoder) #17
  %vtable.i2255 = load ptr, ptr %call174, align 8, !tbaa !28
  %vfn.i2256 = getelementptr inbounds ptr, ptr %vtable.i2255, i64 2
  %710 = load ptr, ptr %vfn.i2256, align 8
  %call.i2257 = invoke noundef i32 %710(ptr noundef nonnull align 8 dereferenceable(8) %call174)
...
ehcleanup1136:                                    ; preds = %ehcleanup1132, %lpad189
  ...
  call void @_ZN8NArchive3N7z14CThreadDecoderD2Ev(ptr noundef nonnull align 8 dereferenceable(536) %threadDecoder) #17
  br label %ehcleanup1138
...
if.then.i2265:                                    ; preds = %lpad180, %ehcleanup1138
  ...
  %713 = load ptr, ptr %vfn.i2263, align 8
  %call.i2264 = invoke noundef i32 %713(ptr noundef nonnull align 8 dereferenceable(8) %call174)
...
cleanup1145:                                      ; preds = %if.then.i2258, %invoke.cont163
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %inSizeForReduce) #17
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %folderRefs) #17
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %folderRefs) #17
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %fileIndexToUpdateIndexMap) #17
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %fileIndexToUpdateIndexMap) #17
...
do.body:                                          ; preds = %_ZN13CRecordVectorIN8NArchive3N7z13CFolderRepackEE11SortRefDownEPS2_iiPFiPKS2_S6_PvES7_.exit, %if.end
  ...
  call void @llvm.lifetime.start.p0(i64 12, ptr nonnull %temp.i) #17
...
_ZN13CRecordVectorIN8NArchive3N7z13CFolderRepackEE11SortRefDownEPS2_iiPFiPKS2_S6_PvES7_.exit: ; preds = %cleanup.i, %if.end7.i, %do.body
  ...
  call void @llvm.lifetime.end.p0(i64 12, ptr nonnull %temp.i) #17
...
do.body3:                                         ; preds = %do.body3.preheader, %_ZN13CRecordVectorIN8NArchive3N7z13CFolderRepackEE11SortRefDownEPS2_iiPFiPKS2_S6_PvES7_.exit57
  ...
  call void @llvm.lifetime.start.p0(i64 12, ptr nonnull %temp.i27) #17
...
_ZN13CRecordVectorIN8NArchive3N7z13CFolderRepackEE11SortRefDownEPS2_iiPFiPKS2_S6_PvES7_.exit57.thread: ; preds = %do.body3
  call void @llvm.lifetime.end.p0(i64 12, ptr nonnull %temp.i27) #17
...
ehcleanup:                                        ; preds = %lpad10, %lpad8
  ...
  tail call void @_ZN8NArchive3N7z8CDecoderD2Ev(ptr noundef nonnull align 8 dereferenceable(232) %Decoder) #17
  br label %ehcleanup16
...
lpad.i.i:                                         ; preds = %lpad.loopexit.split-lp.i.i, %lpad.loopexit.i.i
  ...
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %call) #17
  tail call void @_ZdlPv(ptr noundef nonnull %call) #19
...
if.end.i.i:                                       ; preds = %if.end.i
  ...
  %call.i.i = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %13) #18
...
entry:
  ...
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %UnpackSizes) #17
  %PackStreams = getelementptr inbounds %"struct.NArchive::N7z::CFolder", ptr %this, i64 0, i32 2
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %PackStreams) #17
...
if.then.i:                                        ; preds = %delete.notnull
  %call.i = tail call i32 @pthread_mutex_destroy(ptr noundef nonnull %0) #17
  %_cond.i = getelementptr inbounds %"class.NWindows::NSynchronization::CSynchro", ptr %0, i64 0, i32 1
  %call2.i = tail call i32 @pthread_cond_destroy(ptr noundef nonnull %_cond.i) #17
...
if.end.i.i:                                       ; preds = %if.end.i
  ...
  %call.i.i46 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %5) #18
...
if.else:                                          ; preds = %_ZNK11CStringBaseIwE11ReverseFindEw.exit
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %us) #17
...
invoke.cont18:                                    ; preds = %if.then17
  %call.i.i75 = invoke noalias noundef nonnull dereferenceable(4) ptr @_Znam(i64 noundef 4) #18
...
for.body.preheader:                               ; preds = %_ZN11CStringBaseIcEC2Ev.exit
  ...
  %cmp28186 = icmp sgt i32 %9, 127
  br i1 %cmp28186, label %for.end, label %if.end
...
for.body:                                         ; preds = %for.inc
  ...
  br i1 %cmp28, label %for.end.loopexit.loopexit, label %if.end, !llvm.loop !268
...
delete.notnull.i:                                 ; preds = %if.end.i.i.i
  %14 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdaPv(ptr noundef nonnull %s.sroa.0.0130191) #19
  br label %ehcleanup46

if.end:                                           ; preds = %for.body.preheader, %for.body
  %15 = phi i32 [ %11, %for.body ], [ %9, %for.body.preheader ]
  %s.sroa.0.0130191 = phi ptr [ %s.sroa.0.1, %for.body ], [ %call.i.i75, %for.body.preheader ]
  %s.sroa.16.0132190 = phi i32 [ %s.sroa.16.1, %for.body ], [ 4, %for.body.preheader ]
  %indvars.iv187 = phi i64 [ %indvars.iv.next, %for.body ], [ 0, %for.body.preheader ]
  %s.sroa.0.0130191198 = ptrtoint ptr %s.sroa.0.0130191 to i64
  %indvars151 = trunc i64 %indvars.iv187 to i32
  %conv = trunc i32 %15 to i8
  %16 = xor i32 %indvars151, -1
  %sub2.i.i = add i32 %s.sroa.16.0132190, %16
  %cmp.not.i.i = icmp slt i32 %sub2.i.i, 1
  br i1 %cmp.not.i.i, label %if.end.i.i78, label %for.inc

if.end.i.i78:                                     ; preds = %if.end
  %cmp4.i.i77 = icmp sgt i32 %s.sroa.16.0132190, 64
  %div24.i.i = lshr i32 %s.sroa.16.0132190, 1
  %cmp8.i.i = icmp sgt i32 %s.sroa.16.0132190, 8
  ...
  %add18.i.i = add i32 %s.sroa.16.0132190, 1
  %add.i.i.i = add i32 %add18.i.i, %delta.1.i.i
  %cmp.i.i.i = icmp eq i32 %add.i.i.i, %s.sroa.16.0132190
  br i1 %cmp.i.i.i, label %for.inc, label %if.end.i.i.i

if.end.i.i.i:                                     ; preds = %if.end.i.i78
  %conv.i.i.i = sext i32 %add.i.i.i to i64
  %call.i.i.i79 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %conv.i.i.i) #18
          to label %call.i.i.i.noexc unwind label %delete.notnull.i

call.i.i.i.noexc:                                 ; preds = %if.end.i.i.i
  %call.i.i.i79197 = ptrtoint ptr %call.i.i.i79 to i64
  %cmp3.i.i.i = icmp sgt i32 %s.sroa.16.0132190, 0
  br i1 %cmp3.i.i.i, label %for.cond.preheader.i.i.i, label %if.end9.i.i.i

for.cond.preheader.i.i.i:                         ; preds = %call.i.i.i.noexc
  %cmp522.i.i.i.not = icmp eq i64 %indvars.iv187, 0
  br i1 %cmp522.i.i.i.not, label %delete.notnull.i.i.i, label %iter.check

iter.check:                                       ; preds = %for.cond.preheader.i.i.i
  %min.iters.check = icmp ult i64 %indvars.iv187, 8
  %17 = sub i64 %call.i.i.i79197, %s.sroa.0.0130191198
  %diff.check = icmp ult i64 %17, 32
  %or.cond208 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond208, label %for.body.i.i.i.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check199 = icmp ult i64 %indvars.iv187, 32
  br i1 %min.iters.check199, label %vec.epilog.ph, label %vector.ph

vector.ph:                                        ; preds = %vector.main.loop.iter.check
  %n.vec = and i64 %indvars.iv187, 9223372036854775776
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index200 = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %18 = getelementptr inbounds i8, ptr %s.sroa.0.0130191, i64 %index200
  %wide.load = load <16 x i8>, ptr %18, align 1, !tbaa !15
  %19 = getelementptr inbounds i8, ptr %18, i64 16
  %wide.load201 = load <16 x i8>, ptr %19, align 1, !tbaa !15
  %20 = getelementptr inbounds i8, ptr %call.i.i.i79, i64 %index200
  store <16 x i8> %wide.load, ptr %20, align 1, !tbaa !15
  %21 = getelementptr inbounds i8, ptr %20, i64 16
  store <16 x i8> %wide.load201, ptr %21, align 1, !tbaa !15
  %index.next = add nuw i64 %index200, 32
  %22 = icmp eq i64 %index.next, %n.vec
  br i1 %22, label %middle.block, label %vector.body, !llvm.loop !269

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %indvars.iv187, %n.vec
  br i1 %cmp.n, label %delete.notnull.i.i.i, label %vec.epilog.iter.check

vec.epilog.iter.check:                            ; preds = %middle.block
  %n.vec.remaining = and i64 %indvars.iv187, 24
  %min.epilog.iters.check = icmp eq i64 %n.vec.remaining, 0
  br i1 %min.epilog.iters.check, label %for.body.i.i.i.preheader, label %vec.epilog.ph

vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec203 = and i64 %indvars.iv187, 9223372036854775800
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index205 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next207, %vec.epilog.vector.body ]
  %23 = getelementptr inbounds i8, ptr %s.sroa.0.0130191, i64 %index205
  %wide.load206 = load <8 x i8>, ptr %23, align 1, !tbaa !15
  %24 = getelementptr inbounds i8, ptr %call.i.i.i79, i64 %index205
  store <8 x i8> %wide.load206, ptr %24, align 1, !tbaa !15
  %index.next207 = add nuw i64 %index205, 8
  %25 = icmp eq i64 %index.next207, %n.vec203
  br i1 %25, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !270

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n204 = icmp eq i64 %indvars.iv187, %n.vec203
  br i1 %cmp.n204, label %delete.notnull.i.i.i, label %for.body.i.i.i.preheader

for.body.i.i.i.preheader:                         ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv.i.i.i.ph = phi i64 [ 0, %iter.check ], [ %n.vec, %vec.epilog.iter.check ], [ %n.vec203, %vec.epilog.middle.block ]
  %26 = xor i64 %indvars.iv.i.i.i.ph, -1
  %27 = add nsw i64 %indvars.iv187, %26
  %xtraiter = and i64 %indvars.iv187, 3
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
...
for.body.i.i.i.prol:                              ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i.prol
  ...
  %arrayidx.i.i.i.prol = getelementptr inbounds i8, ptr %s.sroa.0.0130191, i64 %indvars.iv.i.i.i.prol
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i
  ...
  %arrayidx.i.i.i = getelementptr inbounds i8, ptr %s.sroa.0.0130191, i64 %indvars.iv.i.i.i
  ...
  %arrayidx.i.i.i.1 = getelementptr inbounds i8, ptr %s.sroa.0.0130191, i64 %indvars.iv.next.i.i.i
  ...
  %arrayidx.i.i.i.2 = getelementptr inbounds i8, ptr %s.sroa.0.0130191, i64 %indvars.iv.next.i.i.i.1
  ...
  %arrayidx.i.i.i.3 = getelementptr inbounds i8, ptr %s.sroa.0.0130191, i64 %indvars.iv.next.i.i.i.2
  ...
  %exitcond.not.i.i.i.3 = icmp eq i64 %indvars.iv.next.i.i.i.3, %indvars.iv187
...
if.end9.i.i.i:                                    ; preds = %delete.notnull.i.i.i, %call.i.i.i.noexc
  %arrayidx14.i.i.i = getelementptr inbounds i8, ptr %call.i.i.i79, i64 %indvars.iv187
  store i8 0, ptr %arrayidx14.i.i.i, align 1, !tbaa !15
  br label %for.inc

for.inc:                                          ; preds = %if.end9.i.i.i, %if.end.i.i78, %if.end
  %s.sroa.0.1 = phi ptr [ %s.sroa.0.0130191, %if.end.i.i78 ], [ %call.i.i.i79, %if.end9.i.i.i ], [ %s.sroa.0.0130191, %if.end ]
  %s.sroa.16.1 = phi i32 [ %s.sroa.16.0132190, %if.end.i.i78 ], [ %add.i.i.i, %if.end9.i.i.i ], [ %s.sroa.16.0132190, %if.end ]
  %arrayidx.i = getelementptr inbounds i8, ptr %s.sroa.0.1, i64 %indvars.iv187
  ...
  br i1 %cmp24, label %for.body, label %for.end.loopexit.loopexit, !llvm.loop !268

for.end.loopexit.loopexit:                        ; preds = %for.inc, %for.body
  %36 = trunc i64 %indvars.iv.next to i32
  br label %for.end

for.end:                                          ; preds = %for.body.preheader, %for.end.loopexit.loopexit, %_ZN11CStringBaseIcEC2Ev.exit
  %37 = phi i32 [ %7, %_ZN11CStringBaseIcEC2Ev.exit ], [ %7, %for.body.preheader ], [ %34, %for.end.loopexit.loopexit ]
  %s.sroa.0.0.lcssa = phi ptr [ %call.i.i75, %_ZN11CStringBaseIcEC2Ev.exit ], [ %call.i.i75, %for.body.preheader ], [ %s.sroa.0.1, %for.end.loopexit.loopexit ]
  %i.0.lcssa = phi i32 [ 0, %_ZN11CStringBaseIcEC2Ev.exit ], [ 0, %for.body.preheader ], [ %36, %for.end.loopexit.loopexit ]
  %cmp34 = icmp eq i32 %i.0.lcssa, %37
...
for.cond.i82:                                     ; preds = %for.cond.i82.outer, %for.cond.i82
  ...
  %38 = load i8, ptr %p.0.i81, align 1, !tbaa !15
  switch i8 %38, label %for.cond5.preheader.i [
    i8 0, label %if.end42
    i8 32, label %for.cond.i82
  ], !llvm.loop !16

for.cond5.preheader.i:                            ; preds = %for.cond.i82
  %39 = load i8, ptr %s.sroa.0.0.lcssa, align 1, !tbaa !15
  %40 = and i8 %38, -33
  %41 = or i8 %39, %40
  %or.cond5178.i = icmp eq i8 %41, 0
...
if.end13.i:                                       ; preds = %for.cond5.preheader.i, %cleanup.i
  ...
  %42 = phi i8 [ %44, %cleanup.i ], [ %39, %for.cond5.preheader.i ]
  %c.080.i = phi i8 [ %43, %cleanup.i ], [ %38, %for.cond5.preheader.i ]
  %p.179.i = phi ptr [ %incdec.ptr19.i, %cleanup.i ], [ %incdec.ptr.i, %for.cond5.preheader.i ]
  %cmp16.not.i = icmp eq i8 %c.080.i, %42
...
cleanup.i:                                        ; preds = %if.end13.i
  ...
  %43 = load i8, ptr %p.179.i, align 1, !tbaa !15
  %indvars.iv.next.i = add nuw i64 %indvars.iv.i, 1
  %arrayidx.i83 = getelementptr inbounds i8, ptr %s.sroa.0.0.lcssa, i64 %indvars.iv.i
  %44 = load i8, ptr %arrayidx.i83, align 1, !tbaa !15
  %cmp7.i = icmp eq i8 %44, 0
  %45 = and i8 %43, -33
  %or.cond.i = icmp eq i8 %45, 0
...
for.cond21.i:                                     ; preds = %if.end29.i, %for.end.i
  ...
  %c.2.i = phi i8 [ %c.080.i, %for.end.i ], [ %46, %if.end29.i ]
...
if.end29.i:                                       ; preds = %for.cond21.i
  ...
  %46 = load i8, ptr %p.3.i, align 1, !tbaa !15
...
delete.notnull.i85:                               ; preds = %delete.notnull.i85.sink.split, %if.end42
  call void @_ZdaPv(ptr noundef nonnull %s.sroa.0.0.lcssa) #19
  br label %if.end45

if.end45:                                         ; preds = %delete.notnull.i85, %if.end42, %if.else
  %47 = load ptr, ptr %us, align 8, !tbaa !81
  %isnull.i87 = icmp eq ptr %47, null
...
_ZN11CStringBaseIwED2Ev.exit:                     ; preds = %if.end45, %delete.notnull.i88
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %us) #17
  br label %if.end51

ehcleanup46:                                      ; preds = %lpad19, %delete.notnull.i, %lpad
  %.pn.pn = phi { ptr, i32 } [ %12, %lpad ], [ %13, %lpad19 ], [ %14, %delete.notnull.i ]
  %48 = load ptr, ptr %us, align 8, !tbaa !81
  %isnull.i89 = icmp eq ptr %48, null
...
cleanup.cont64:                                   ; preds = %cleanup.cont47
  ...
  %20 = load i8, ptr %MTimeDefined66, align 1, !tbaa !212, !range !42
...
do.body:                                          ; preds = %_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit, %if.end
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %temp.i) #17
...
_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit: ; preds = %do.body, %for.end.loopexit.i
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %temp.i) #17
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
...
do.body3.preheader:                               ; preds = %_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %temp.i27) #17
...
_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit60.thread: ; preds = %_ZN13CRecordVectorIiE11SortRefDownEPiiiPFiPKiS3_PvES4_.exit60, %do.body3.preheader
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %temp.i27) #17
  br label %cleanup
...
if.end:                                           ; preds = %entry
  ...
  %7 = load i8, ptr %IsAnti26, align 2, !tbaa !208, !range !42
  %IsAnti29 = getelementptr inbounds %"struct.NArchive::N7z::CUpdateItem", ptr %4, i64 0, i32 10
  %8 = load i8, ptr %IsAnti29, align 2, !tbaa !208, !range !42
...
delete.notnull:                                   ; preds = %entry
  ...
  %vfn = getelementptr inbounds ptr, ptr %vtable, i64 4
  %1 = load ptr, ptr %vfn, align 8
  tail call void %1(ptr noundef nonnull align 8 dereferenceable(32) %this) #17
  br label %return
...
entry:
  ...
  %_outStream = getelementptr inbounds %"class.NArchive::N7z::CFolderOutStream2", ptr %this, i64 0, i32 6
  store ptr null, ptr %_outStream, align 8, !tbaa !30
  %call = invoke noalias noundef nonnull dereferenceable(40) ptr @_Znwm(i64 noundef 40) #18
...
_ZN13CObjectVectorI9CMyComPtrI8IUnknownEED2Ev.exit: ; preds = %entry
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %_decoders) #17
...
_ZN9CMyComPtrI15ICompressCoder2ED2Ev.exit:        ; preds = %_ZN13CObjectVectorI9CMyComPtrI8IUnknownEED2Ev.exit, %if.then.i
  ...
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %CoderMethodIDs.i) #17
  ...
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %_bindInfoExPrev) #17
  ret void
}
...
for.body.i:                                       ; preds = %_ZN13CObjectVectorI5CPropE3AddERKS0_.exit.i, %for.body.lr.ph.i
  ...
  %call.i.i = tail call noalias noundef nonnull dereferenceable(24) ptr @_Znwm(i64 noundef 24) #18
...
delete.notnull:                                   ; preds = %for.body
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %5) #17
  tail call void @_ZdlPv(ptr noundef nonnull %5) #19
  br label %for.inc
...
ehcleanup11:                                      ; preds = %lpad.loopexit.i, %lpad.loopexit.split-lp.i, %ehcleanup
  ...
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %BindPairs) #17
  tail call void @_ZN13CObjectVectorIN8NArchive3N7z10CCoderInfoEED2Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) #17
  br label %common.resume
}
