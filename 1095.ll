; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/Common/ListFileUtils.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/Common/ListFileUtils.cpp"
...
if.then40:                                        ; preds = %if.end37
  ...
  %or.cond = select i1 %cmp44, i1 %cmp3.i, i1 false
  br i1 %or.cond, label %if.then4.i, label %if.end49

if.then4.i:                                       ; preds = %if.then40
  %spec.select.i = call i32 @llvm.smin.i32(i32 %31, i32 1)
  %idx.ext3.i.i = zext i32 %spec.select.i to i64
  %add.ptr4.i.i = getelementptr inbounds i32, ptr %32, i64 %idx.ext3.i.i
  ...
  %sub7.i = sub nsw i32 %34, %spec.select.i
...
if.then4.i.i.i28:                                 ; preds = %while.end.i.i24
  ...
  %add.i.i.i.i = sub i32 %sub.i.i.i.i, %spec.select.i.i.i
...
; Function Attrs: uwtable
define internal fastcc void @_ZL11RemoveQuoteR11CStringBaseIwE(ptr noundef nonnull align 8 dereferenceable(16) %s) unnamed_addr #0 personality ptr @__gxx_personality_v0 {
entry:
  %_length.i = getelementptr inbounds %class.CStringBase.0, ptr %s, i64 0, i32 1
  %0 = load i32, ptr %_length.i, align 8, !tbaa !28
