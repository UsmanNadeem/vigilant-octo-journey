; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/jcmarker.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/jcmarker.c"
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %call = tail call fastcc i32 @emit_dqt(ptr noundef nonnull %cinfo, i32 noundef %2)
  %add = add nsw i32 %call, %prec.066
...
for.end:                                          ; preds = %for.body, %entry
  ...
  %4 = load i32, ptr %arith_code, align 4, !tbaa !47
...
lor.lhs.false:                                    ; preds = %for.end
  ...
  %5 = load i32, ptr %progressive_mode, align 4, !tbaa !48
...
lor.lhs.false2:                                   ; preds = %lor.lhs.false
  ...
  %6 = load i32, ptr %data_precision, align 8, !tbaa !49
...
for.body8:                                        ; preds = %for.inc13.1, %for.body8.preheader.new
  ...
  %9 = load i32, ptr %dc_tbl_no, align 4, !tbaa !50
...
lor.lhs.false10:                                  ; preds = %for.body8
  ...
  %10 = load i32, ptr %ac_tbl_no, align 8, !tbaa !51
...
for.inc13:                                        ; preds = %lor.lhs.false10, %if.then12
  ...
  %11 = load i32, ptr %dc_tbl_no.1, align 4, !tbaa !50
...
lor.lhs.false10.1:                                ; preds = %for.inc13
  ...
  %12 = load i32, ptr %ac_tbl_no.1, align 8, !tbaa !51
...
for.inc13.1:                                      ; preds = %if.then12.1, %lor.lhs.false10.1
  ...
  br i1 %niter.ncmp.1, label %for.end16.loopexit.unr-lcssa, label %for.body8, !llvm.loop !52
...
for.body8.epil:                                   ; preds = %for.end16.loopexit.unr-lcssa
  ...
  %13 = load i32, ptr %dc_tbl_no.epil, align 4, !tbaa !50
...
lor.lhs.false10.epil:                             ; preds = %for.body8.epil
  ...
  %14 = load i32, ptr %ac_tbl_no.epil, align 8, !tbaa !51
...
if.end22:                                         ; preds = %for.end16
  ...
  %16 = load ptr, ptr %emit_message, align 8, !tbaa !53
  tail call void %16(ptr noundef nonnull %cinfo, i32 noundef 0) #2
  %.pr.pre = load i32, ptr %arith_code, align 4, !tbaa !47
...
entry:
  %arith_code = getelementptr inbounds %struct.jpeg_compress_struct, ptr %cinfo, i64 0, i32 24
  %0 = load i32, ptr %arith_code, align 4, !tbaa !47
...
for.cond.preheader:                               ; preds = %entry
  ...
  %1 = load i32, ptr %comps_in_scan, align 4, !tbaa !54
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %2 = load ptr, ptr %arrayidx, align 8, !tbaa !55
  %3 = load i32, ptr %progressive_mode, align 4, !tbaa !48
  %tobool1.not = icmp eq i32 %3, 0
  br i1 %tobool1.not, label %if.else9, label %if.then2

if.then2:                                         ; preds = %for.body
  %4 = load i32, ptr %Ss, align 4, !tbaa !56
  %cmp3 = icmp eq i32 %4, 0
  br i1 %cmp3, label %if.then4, label %if.else7

if.then4:                                         ; preds = %if.then2
  %5 = load i32, ptr %Ah, align 4, !tbaa !57
...
if.then6:                                         ; preds = %if.then4
  ...
  %6 = load i32, ptr %dc_tbl_no, align 4, !tbaa !50
...
if.else7:                                         ; preds = %if.then2
  ...
  %7 = load i32, ptr %ac_tbl_no, align 8, !tbaa !51
...
if.else9:                                         ; preds = %for.body
  ...
  %8 = load i32, ptr %dc_tbl_no10, align 4, !tbaa !50
  ...
  %9 = load i32, ptr %ac_tbl_no11, align 8, !tbaa !51
...
for.inc:                                          ; preds = %if.else9, %if.then4, %if.then6, %if.else7
  ...
  %10 = load i32, ptr %comps_in_scan, align 4, !tbaa !54
  %11 = sext i32 %10 to i64
  %cmp = icmp slt i64 %indvars.iv.next, %11
  br i1 %cmp, label %for.body, label %if.end13, !llvm.loop !58
...
if.end13:                                         ; preds = %for.inc, %for.cond.preheader, %entry
  ...
  %12 = load i32, ptr %restart_interval, align 8, !tbaa !59
...
emit_2bytes.exit.i:                               ; preds = %if.then3.i15.i.i, %if.then.i13.i.i, %emit_byte.exit.i15.i
  %37 = load i32, ptr %restart_interval, align 8, !tbaa !59
  %38 = lshr i32 %37, 8
...
emit_marker.exit.i58:                             ; preds = %if.then3.i12.i.i56, %if.then.i10.i.i54, %emit_byte.exit.i.i50
  ...
  %63 = load i32, ptr %comps_in_scan.i, align 4, !tbaa !54
...
emit_2bytes.exit.i70:                             ; preds = %if.then3.i15.i.i69, %if.then.i13.i.i67, %emit_byte.exit.i51.i
  %77 = load i32, ptr %comps_in_scan.i, align 4, !tbaa !54
...
emit_byte.exit.i:                                 ; preds = %if.then3.i.i, %if.then.i.i, %emit_2bytes.exit.i70
  %84 = load i32, ptr %comps_in_scan.i, align 4, !tbaa !54
...
for.body.i:                                       ; preds = %emit_byte.exit77.i, %for.body.lr.ph.i
  ...
  %85 = load ptr, ptr %arrayidx.i, align 8, !tbaa !55
...
emit_byte.exit77.i:                               ; preds = %if.then3.i76.i, %if.then.i74.i, %if.end11.i
  ...
  %105 = load i32, ptr %comps_in_scan.i, align 4, !tbaa !54
  %106 = sext i32 %105 to i64
  %cmp.i = icmp slt i64 %indvars.iv.next.i, %106
  br i1 %cmp.i, label %for.body.i, label %for.end.i, !llvm.loop !61
...
for.end.i:                                        ; preds = %emit_byte.exit77.i, %emit_byte.exit.i
  ...
  %107 = load i32, ptr %Ss13.i, align 4, !tbaa !56
...
emit_byte.exit90.i:                               ; preds = %if.then3.i89.i, %if.then.i87.i, %for.end.i
  ...
  %114 = load i32, ptr %Se.i, align 8, !tbaa !62
...
emit_marker.exit:                                 ; preds = %emit_byte.exit.i, %if.then.i10.i, %if.then3.i12.i
  ...
  %12 = load ptr, ptr %arrayidx, align 8, !tbaa !55
  %cmp1.not = icmp eq ptr %12, null
  br i1 %cmp1.not, label %for.inc, label %if.then

if.then:                                          ; preds = %emit_marker.exit
  %call = tail call fastcc i32 @emit_dqt(ptr noundef nonnull %cinfo, i32 noundef 0)
  br label %for.inc
...
for.body5.preheader:                              ; preds = %for.inc.3
  ...
  %17 = load ptr, ptr %arrayidx7, align 8, !tbaa !55
...
if.end10:                                         ; preds = %if.then9, %for.body5.preheader
  ...
  %18 = load ptr, ptr %arrayidx12, align 8, !tbaa !55
...
for.inc16:                                        ; preds = %if.end10, %if.then14
  ...
  %19 = load ptr, ptr %arrayidx7.1, align 8, !tbaa !55
...
if.end10.1:                                       ; preds = %if.then9.1, %for.inc16
  ...
  %20 = load ptr, ptr %arrayidx12.1, align 8, !tbaa !55
...
for.inc16.1:                                      ; preds = %if.then14.1, %if.end10.1
  ...
  %21 = load ptr, ptr %arrayidx7.2, align 8, !tbaa !55
...
if.end10.2:                                       ; preds = %if.then9.2, %for.inc16.1
  ...
  %22 = load ptr, ptr %arrayidx12.2, align 8, !tbaa !55
...
for.inc16.2:                                      ; preds = %if.then14.2, %if.end10.2
  ...
  %23 = load ptr, ptr %arrayidx7.3, align 8, !tbaa !55
...
if.end10.3:                                       ; preds = %if.then9.3, %for.inc16.2
  ...
  %24 = load ptr, ptr %arrayidx12.3, align 8, !tbaa !55
...
entry:
  ...
  %0 = load ptr, ptr %arrayidx, align 8, !tbaa !55
...
if.end:                                           ; preds = %if.then, %entry
  %4 = load <64 x i16>, ptr %0, align 2, !tbaa !64
  ...
  %132 = load i32, ptr %sent_table, align 4, !tbaa !65
...
emit_byte.exit92.us:                              ; preds = %if.then3.i91.us, %if.then.i89.us, %for.body16.us
  ...
  br i1 %exitcond102.not, label %for.end28, label %for.body16.us, !llvm.loop !68
...
emit_byte.exit92:                                 ; preds = %if.end25, %if.then.i89, %if.then3.i91
  ...
  br i1 %exitcond.not, label %for.end28, label %for.body16, !llvm.loop !68

for.end28:                                        ; preds = %emit_byte.exit92.us, %emit_byte.exit92
  store i32 1, ptr %sent_table, align 4, !tbaa !65
  br label %if.end30
...
emit_2bytes.exit:                                 ; preds = %emit_byte.exit.i54, %if.then.i13.i, %if.then3.i15.i
  ...
  %26 = load i32, ptr %image_height, align 4, !tbaa !69
...
lor.lhs.false:                                    ; preds = %emit_2bytes.exit
  ...
  %27 = load i32, ptr %image_width, align 8, !tbaa !70
...
if.end:                                           ; preds = %if.then, %lor.lhs.false
  %data_precision = getelementptr inbounds %struct.jpeg_compress_struct, ptr %cinfo, i64 0, i32 11
  %31 = load i32, ptr %data_precision, align 8, !tbaa !49
...
emit_byte.exit:                                   ; preds = %if.end, %if.then.i, %if.then3.i
  %38 = load i32, ptr %image_height, align 4, !tbaa !69
  %39 = lshr i32 %38, 8
...
emit_2bytes.exit79:                               ; preds = %emit_byte.exit.i72, %if.then.i13.i76, %if.then3.i15.i78
  ...
  %52 = load i32, ptr %image_width10, align 8, !tbaa !70
  %53 = lshr i32 %52, 8
...
for.body:                                         ; preds = %for.body.preheader, %emit_byte.exit156
  ...
  %75 = load i32, ptr %compptr.0159, align 8, !tbaa !60
...
emit_byte.exit156:                                ; preds = %emit_byte.exit143, %if.then.i153, %if.then3.i155
  ...
  br i1 %cmp13, label %for.body, label %for.end, !llvm.loop !73
...
entry:
  ...
  %htbl.0 = load ptr, ptr %htbl.0.in, align 8, !tbaa !55
...
if.end7:                                          ; preds = %if.then3, %entry
  ...
  %3 = load i32, ptr %sent_table, align 4, !tbaa !74
...
emit_byte.exit92:                                 ; preds = %for.body20, %if.then.i89, %if.then3.i91
  ...
  br i1 %exitcond.not, label %for.cond28.preheader, label %for.body20, !llvm.loop !76
...
emit_byte.exit104:                                ; preds = %for.body31, %if.then.i101, %if.then3.i103
  ...
  br i1 %cmp29, label %for.body31, label %for.end37, !llvm.loop !77

for.end37:                                        ; preds = %emit_byte.exit104, %for.cond28.preheader
  store i32 1, ptr %sent_table, align 4, !tbaa !74
  br label %if.end39
...
!73 = distinct !{!73, !35}
!74 = !{!75, !10, i64 276}
!75 = !{!"", !8, i64 0, !8, i64 17, !10, i64 276}
!76 = distinct !{!76, !35}
!77 = distinct !{!77, !35}
