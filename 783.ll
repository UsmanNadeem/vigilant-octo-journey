; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/NPB-serial/is/is.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/NPB-serial/is/is.c"
...
if.then:                                          ; preds = %entry
  ...
  %cmp4.not = icmp eq i32 %n2, 0
  %narrow = select i1 %cmp4.not, i32 1, i32 %n2
