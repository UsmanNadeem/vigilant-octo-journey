; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/d/util.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/d/util.c"
...
cond.true:                                        ; preds = %entry
  %call = tail call noalias dereferenceable_or_null(1) ptr @calloc(i64 noundef 1, i64 noundef 1) #23
  br label %cleanup
...
if.else:                                          ; preds = %if.end
  %call11 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #25
  %add.i27 = shl i64 %call11, 32
  %sext.i28 = add i64 %add.i27, 4294967296
  %conv1.i29 = ashr exact i64 %sext.i28, 32
  %call.i30 = tail call noalias ptr @malloc(i64 noundef %conv1.i29) #24
  %conv2.i31 = ashr exact i64 %add.i27, 32
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %call.i30, ptr nonnull align 1 %s, i64 %conv2.i31, i1 false)
  %arrayidx.i32 = getelementptr inbounds i8, ptr %call.i30, i64 %conv2.i31
  store i8 0, ptr %arrayidx.i32, align 1, !tbaa !5
  br label %cleanup

cleanup:                                          ; preds = %if.else, %while.end, %cond.true
  %retval.0 = phi ptr [ %call.i, %while.end ], [ %call.i30, %if.else ], [ %call, %cond.true ]
  ret ptr %retval.0
}
...
define dso_local i32 @buf_read(ptr nocapture noundef readonly %pathname, ptr nocapture noundef %buf, ptr nocapture noundef %len) local_unnamed_addr #8 {
entry:
  %sb = alloca %struct.stat, align 8
  call void @llvm.lifetime.start.p0(i64 144, ptr nonnull %sb) #26
  store ptr null, ptr %buf, align 8, !tbaa !11
  store i32 0, ptr %len, align 4, !tbaa !13
  %call = tail call i32 (ptr, i32, ...) @open(ptr noundef %pathname, i32 noundef 0) #26
  %cmp = icmp slt i32 %call, 1
  br i1 %cmp, label %cleanup, label %if.end

if.end:                                           ; preds = %entry
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(144) %sb, i8 0, i64 144, i1 false)
  %call.i = call i32 @__fxstat(i32 noundef 1, i32 noundef %call, ptr noundef nonnull %sb) #26
  ...
  %call3 = call noalias ptr @malloc(i64 noundef %conv2) #24
  ...
  %call8 = call i64 @read(i32 noundef %call, ptr noundef %call3, i64 noundef %idxprom) #26
  %call9 = call i32 @close(i32 noundef %call) #26
  %1 = load i32, ptr %len, align 4, !tbaa !13
  br label %cleanup

cleanup:                                          ; preds = %entry, %if.end
  %retval.0 = phi i32 [ %1, %if.end ], [ -1, %entry ]
  call void @llvm.lifetime.end.p0(i64 144, ptr nonnull %sb) #26
  ret i32 %retval.0
}
...
; Function Attrs: nounwind uwtable
define dso_local ptr @sbuf_read(ptr nocapture noundef readonly %pathname) local_unnamed_addr #8 {
entry:
  %sb.i = alloca %struct.stat, align 8
  call void @llvm.lifetime.start.p0(i64 144, ptr nonnull %sb.i) #26
  %call.i = tail call i32 (ptr, i32, ...) @open(ptr noundef %pathname, i32 noundef 0) #26
  %cmp.i = icmp slt i32 %call.i, 1
  br i1 %cmp.i, label %buf_read.exit.thread, label %buf_read.exit

buf_read.exit.thread:                             ; preds = %entry
  call void @llvm.lifetime.end.p0(i64 144, ptr nonnull %sb.i) #26
  br label %2
...
buf_read.exit:                                    ; preds = %entry
  ...
  %call.i.i = call i32 @__fxstat(i32 noundef 1, i32 noundef %call.i, ptr noundef nonnull %sb.i) #26
  ...
  %call3.i = call noalias ptr @malloc(i64 noundef %conv2.i) #24
  ...
  %call8.i = call i64 @read(i32 noundef %call.i, ptr noundef %call3.i, i64 noundef %idxprom.i) #26
  %call9.i = call i32 @close(i32 noundef %call.i) #26
  call void @llvm.lifetime.end.p0(i64 144, ptr nonnull %sb.i) #26
...
define dso_local void @d_fail(ptr noundef %str, ...) local_unnamed_addr #12 {
entry:
  %nstr = alloca [256 x i8], align 16
  %ap = alloca [1 x %struct.__va_list_tag], align 16
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %nstr) #26
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %ap) #26
  call void @llvm.va_start(ptr nonnull %ap)
  %call = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %nstr, i64 noundef 255, ptr noundef nonnull @.str.1, ptr noundef %str) #26
  %0 = load ptr, ptr @stderr, align 8, !tbaa !11
  %call4 = call i32 @vfprintf(ptr noundef %0, ptr noundef nonnull %nstr, ptr noundef nonnull %ap) #27
...
if.then24:                                        ; preds = %while.end
  ...
  %call28 = tail call ptr @realloc(ptr noundef %1, i64 noundef %mul27) #29
...
if.else:                                          ; preds = %entry
  %call14 = tail call ptr @realloc(ptr noundef %1, i64 noundef %mul4) #29
...
if.then:                                          ; preds = %tailrecurse
  ...
  %cmp93.not = icmp ugt i32 %1, %conv2
...
if.then9.split.loop.exit147:                      ; preds = %for.inc.3
  %idxprom.4.le = zext i32 %rem20.3 to i64
  br label %if.then9

if.then9.split.loop.exit150:                      ; preds = %for.inc.2
  %idxprom.3.le = zext i32 %rem20.2 to i64
  br label %if.then9

if.then9.split.loop.exit153:                      ; preds = %for.inc.1
  %idxprom.2.le = zext i32 %rem20.1 to i64
  br label %if.then9

if.then9.split.loop.exit156:                      ; preds = %for.inc
  %idxprom.1.le = zext i32 %rem20 to i64
  br label %if.then9

if.then9:                                         ; preds = %for.body.lr.ph, %if.then9.split.loop.exit156, %if.then9.split.loop.exit153, %if.then9.split.loop.exit150, %if.then9.split.loop.exit147
  %idxprom.le.pre-phi = phi i64 [ %idxprom.4.le, %if.then9.split.loop.exit147 ], [ %idxprom.3.le, %if.then9.split.loop.exit150 ], [ %idxprom.2.le, %if.then9.split.loop.exit153 ], [ %idxprom.1.le, %if.then9.split.loop.exit156 ], [ %idxprom, %for.body.lr.ph ]
  %arrayidx.le = getelementptr inbounds ptr, ptr %2, i64 %idxprom.le.pre-phi
...
for.inc:                                          ; preds = %if.else
  ...
  %rem20 = urem i32 %add, %1
  %idxprom.1 = zext i32 %rem20 to i64
  %arrayidx.1 = getelementptr inbounds ptr, ptr %2, i64 %idxprom.1
  %4 = load ptr, ptr %arrayidx.1, align 8, !tbaa !11
  %tobool8.not.1 = icmp eq ptr %4, null
  br i1 %tobool8.not.1, label %if.then9.split.loop.exit156, label %if.else.1

if.else.1:                                        ; preds = %for.inc
  %cmp16.1 = icmp eq ptr %4, %t
  br i1 %cmp16.1, label %cleanup53, label %for.inc.1

for.inc.1:                                        ; preds = %if.else.1
  %add.1 = add nuw i32 %rem20, 1
  %rem20.1 = urem i32 %add.1, %1
  %idxprom.2 = zext i32 %rem20.1 to i64
  %arrayidx.2 = getelementptr inbounds ptr, ptr %2, i64 %idxprom.2
  %5 = load ptr, ptr %arrayidx.2, align 8, !tbaa !11
  %tobool8.not.2 = icmp eq ptr %5, null
  br i1 %tobool8.not.2, label %if.then9.split.loop.exit153, label %if.else.2

if.else.2:                                        ; preds = %for.inc.1
  %cmp16.2 = icmp eq ptr %5, %t
  br i1 %cmp16.2, label %cleanup53, label %for.inc.2

for.inc.2:                                        ; preds = %if.else.2
  %add.2 = add nuw i32 %rem20.1, 1
  %rem20.2 = urem i32 %add.2, %1
  %idxprom.3 = zext i32 %rem20.2 to i64
  %arrayidx.3 = getelementptr inbounds ptr, ptr %2, i64 %idxprom.3
  %6 = load ptr, ptr %arrayidx.3, align 8, !tbaa !11
  %tobool8.not.3 = icmp eq ptr %6, null
  br i1 %tobool8.not.3, label %if.then9.split.loop.exit150, label %if.else.3

if.else.3:                                        ; preds = %for.inc.2
  %cmp16.3 = icmp eq ptr %6, %t
  br i1 %cmp16.3, label %cleanup53, label %for.inc.3

for.inc.3:                                        ; preds = %if.else.3
  %add.3 = add nuw i32 %rem20.2, 1
  %rem20.3 = urem i32 %add.3, %1
  %idxprom.4 = zext i32 %rem20.3 to i64
  %arrayidx.4 = getelementptr inbounds ptr, ptr %2, i64 %idxprom.4
  %7 = load ptr, ptr %arrayidx.4, align 8, !tbaa !11
  %tobool8.not.4 = icmp eq ptr %7, null
  br i1 %tobool8.not.4, label %if.then9.split.loop.exit147, label %if.else.4

if.else.4:                                        ; preds = %for.inc.3
  %cmp16.4 = icmp eq ptr %7, %t
  br i1 %cmp16.4, label %cleanup53, label %if.else26

if.else26:                                        ; preds = %if.then, %if.else.4
  %8 = load i32, ptr %i31, align 4, !tbaa !28
  %add32 = add i32 %8, 1
  br label %if.end34
...
if.end34:                                         ; preds = %tailrecurse, %if.else26
  ...
  %9 = load i32, ptr %arrayidx37, align 4, !tbaa !13
  store i32 %9, ptr %av, align 8, !tbaa !19
  %conv40 = zext i32 %9 to i64
...
for.body.i:                                       ; preds = %for.body.i.preheader, %for.inc.i
  ...
  %10 = load ptr, ptr %arrayidx.i, align 8, !tbaa !11
  %tobool.not.i = icmp eq ptr %10, null
  br i1 %tobool.not.i, label %for.inc.i, label %if.then.i

if.then.i:                                        ; preds = %for.body.i
  %call.i = tail call i32 @set_add(ptr noundef nonnull %av, ptr noundef nonnull %10)
  br label %for.inc.i
...
set_union.exit:                                   ; preds = %for.inc.i, %for.cond.i.preheader
  tail call void @free(ptr noundef nonnull %vv.sroa.488.0) #26
...
tailrecurse:                                      ; preds = %tailrecurse.backedge, %entry
  ...
  %call = tail call i32 %0(ptr noundef %t, ptr noundef nonnull %fns) #26
  %1 = load i32, ptr %av, align 8, !tbaa !19
  %tobool.not = icmp eq i32 %1, 0
  br i1 %tobool.not, label %if.end34, label %for.body.preheader

for.body.preheader:                               ; preds = %tailrecurse
  %i.0104 = urem i32 %call, %1
  br label %for.body

for.body:                                         ; preds = %for.body.preheader, %for.inc
  %i.0108 = phi i32 [ %i.0, %for.inc ], [ %i.0104, %for.body.preheader ]
  %j.0107 = phi i32 [ %inc, %for.inc ], [ 0, %for.body.preheader ]
  %2 = load ptr, ptr %v4, align 8, !tbaa !21
  %idxprom = zext i32 %i.0108 to i64
  %arrayidx = getelementptr inbounds ptr, ptr %2, i64 %idxprom
  %3 = load ptr, ptr %arrayidx, align 8, !tbaa !11
...
if.then6:                                         ; preds = %for.body
  %idxprom.le = zext i32 %i.0108 to i64
  %arrayidx.le = getelementptr inbounds ptr, ptr %2, i64 %idxprom.le
  store ptr %t, ptr %arrayidx.le, align 8, !tbaa !11
  br label %cleanup52

if.else:                                          ; preds = %for.body
  %4 = load ptr, ptr %cmp_fn, align 8, !tbaa !32
  %call13 = tail call i32 %4(ptr noundef nonnull %3, ptr noundef %t, ptr noundef nonnull %fns) #26
  %tobool14.not = icmp eq i32 %call13, 0
  br i1 %tobool14.not, label %if.then15, label %for.inc

if.then15:                                        ; preds = %if.else
  %idxprom.le140 = zext i32 %i.0108 to i64
  %5 = load ptr, ptr %v4, align 8, !tbaa !21
  %arrayidx18 = getelementptr inbounds ptr, ptr %5, i64 %idxprom.le140
...
for.inc:                                          ; preds = %if.else
  ...
  %i.0 = urem i32 %add, %1
  %7 = load i32, ptr %av, align 8, !tbaa !19
  %cmp = icmp uge i32 %i.0, %7
  %cmp3 = icmp ugt i32 %j.0107, 3
  %.not = select i1 %cmp, i1 true, i1 %cmp3
  br i1 %.not, label %if.else26, label %for.body, !llvm.loop !33

if.else26:                                        ; preds = %for.inc
  %8 = load ptr, ptr %v4, align 8, !tbaa !21
  %9 = load i32, ptr %i31, align 4, !tbaa !28
  %add32 = add i32 %9, 1
  br label %if.end34

if.end34:                                         ; preds = %tailrecurse, %if.else26
  %storemerge = phi i32 [ %add32, %if.else26 ], [ 2, %tailrecurse ]
  %vv.sroa.495.0 = phi ptr [ %8, %if.else26 ], [ null, %tailrecurse ]
  %vv.sroa.0.0 = phi i32 [ %7, %if.else26 ], [ undef, %tailrecurse ]
  store i32 %storemerge, ptr %i31, align 4, !tbaa !28
  %idxprom36 = zext i32 %storemerge to i64
  %arrayidx37 = getelementptr inbounds [29 x i32], ptr @prime2, i64 0, i64 %idxprom36
  %10 = load i32, ptr %arrayidx37, align 4, !tbaa !13
  store i32 %10, ptr %av, align 8, !tbaa !19
...
for.cond.i.preheader:                             ; preds = %if.end34
  %cmp.i109.not = icmp eq i32 %vv.sroa.0.0, 0
  br i1 %cmp.i109.not, label %set_union_fn.exit, label %for.body.i.preheader
...
if.then.i:                                        ; preds = %for.body.i
  %call.i = tail call ptr @set_add_fn(ptr noundef nonnull %av, ptr noundef nonnull %11, ptr noundef nonnull %fns)
  br label %for.inc.i
...
set_union_fn.exit:                                ; preds = %for.inc.i, %for.cond.i.preheader
  tail call void @free(ptr noundef nonnull %vv.sroa.495.0) #26
  br label %tailrecurse.backedge
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %vv) #26
...
if.then24.i:                                      ; preds = %while.end.i
  ...
  %call28.i = call ptr @realloc(ptr noundef %7, i64 noundef %mul27.i) #29
...
for.end:                                          ; preds = %for.end.loopexit, %if.end
  ...
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %vv) #26
  ret void
}
...
while.end:                                        ; preds = %while.cond
  ...
  %mul = add i64 %sub.ptr.sub, %sub.ptr.lhs.cast
...
sw.default:                                       ; preds = %for.body
  %call24 = tail call ptr @__ctype_b_loc() #30
...
entry:
  tail call void @free(ptr noundef %x) #26
  ret void
}

; Function Attrs: nounwind
declare i32 @__fxstat(i32 noundef, i32 noundef, ptr noundef) local_unnamed_addr #22
...
attributes #22 = { nounwind "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
