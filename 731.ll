; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_setup.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/smg_setup.c"
...
define dso_local i32 @hypre_SMGSetup(ptr noundef %smg_vdata, ptr noundef %A, ptr noundef %b, ptr noundef %x) local_unnamed_addr #0 {
if.end68.peel:
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %21 = or i64 %19, 1
  %22 = or i64 %20, 5
  %23 = getelementptr inbounds [6 x i32], ptr %x_num_ghost, i64 0, i64 %21
  %24 = getelementptr inbounds [6 x i32], ptr %x_num_ghost, i64 0, i64 %22
  %25 = getelementptr inbounds i32, ptr %23, i64 -1
  %26 = getelementptr inbounds i32, ptr %24, i64 -1
  store <4 x i32> <i32 1, i32 1, i32 1, i32 1>, ptr %25, align 16, !tbaa !22
  store <4 x i32> <i32 1, i32 1, i32 1, i32 1>, ptr %26, align 16, !tbaa !22
  %index.next = add nuw i64 %index, 4
  %27 = icmp eq i64 %index.next, %n.vec
  br i1 %27, label %middle.block, label %vector.body, !llvm.loop !30
...
for.body:                                         ; preds = %for.body.preheader1310, %for.body
  ...
  %28 = shl nuw nsw i64 %indvars.iv1263, 1
  %arrayidx164 = getelementptr inbounds [6 x i32], ptr %x_num_ghost, i64 0, i64 %28
  store <2 x i32> <i32 1, i32 1>, ptr %arrayidx164, align 8, !tbaa !22
...
for.end171:                                       ; preds = %for.body, %middle.block, %for.end
  %29 = load ptr, ptr %call31, align 8, !tbaa !24
  %call173 = call ptr @hypre_StructVectorCreate(i32 noundef %0, ptr noundef %29) #5
  ...
  %30 = load ptr, ptr %call148, align 8, !tbaa !24
  %call179 = call i32 @hypre_StructVectorInitializeShell(ptr noundef %30) #5
  %31 = load ptr, ptr %call148, align 8, !tbaa !24
  %data_size181 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %31, i64 0, i32 5
  %32 = load i32, ptr %data_size181, align 4, !tbaa !35
  %33 = load ptr, ptr %call31, align 8, !tbaa !24
  %call184 = call ptr @hypre_StructVectorCreate(i32 noundef %0, ptr noundef %33) #5
  ...
  %34 = load ptr, ptr %call152, align 8, !tbaa !24
  %call191 = call i32 @hypre_StructVectorInitializeShell(ptr noundef %34) #5
  %35 = load ptr, ptr %call152, align 8, !tbaa !24
  %data_size193 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %35, i64 0, i32 5
  %36 = load i32, ptr %data_size193, align 4, !tbaa !35
  %add194 = add nsw i32 %36, %32
...
for.body199:                                      ; preds = %for.body199.lr.ph, %for.body199
  ...
  %37 = load ptr, ptr %arrayidx201, align 8, !tbaa !24
  ...
  %38 = load ptr, ptr %arrayidx204, align 8, !tbaa !24
  %call205 = call ptr @hypre_SMGCreateInterpOp(ptr noundef %37, ptr noundef %38, i32 noundef %sub) #5
  ...
  %39 = load ptr, ptr %arrayidx207, align 8, !tbaa !24
  %data_size213 = getelementptr inbounds %struct.hypre_StructMatrix_struct, ptr %39, i64 0, i32 8
  %40 = load i32, ptr %data_size213, align 4, !tbaa !37
  %add214 = add nsw i32 %40, %data_size.01253
  %41 = getelementptr inbounds ptr, ptr %call136, i64 %indvars.iv1268
  store ptr %39, ptr %41, align 8
  %42 = load ptr, ptr %arrayidx201, align 8, !tbaa !24
  %43 = load ptr, ptr %arrayidx207, align 8, !tbaa !24
  %arrayidx234 = getelementptr inbounds ptr, ptr %call31, i64 %indvars.iv.next1269
  %44 = load ptr, ptr %arrayidx234, align 8, !tbaa !24
  %call235 = call ptr @hypre_SMGCreateRAPOp(ptr noundef nonnull %39, ptr noundef %42, ptr noundef %43, ptr noundef %44) #5
  ...
  %45 = load ptr, ptr %arrayidx238, align 8, !tbaa !24
  %data_size246 = getelementptr inbounds %struct.hypre_StructMatrix_struct, ptr %45, i64 0, i32 8
  %46 = load i32, ptr %data_size246, align 4, !tbaa !37
  %add247 = add nsw i32 %add214, %46
  %47 = load ptr, ptr %arrayidx234, align 8, !tbaa !24
  %call251 = call ptr @hypre_StructVectorCreate(i32 noundef %0, ptr noundef %47) #5
  ...
  %48 = load ptr, ptr %arrayidx254, align 8, !tbaa !24
  %call263 = call i32 @hypre_StructVectorInitializeShell(ptr noundef %48) #5
  %49 = load ptr, ptr %arrayidx254, align 8, !tbaa !24
  %data_size267 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %49, i64 0, i32 5
  %50 = load i32, ptr %data_size267, align 4, !tbaa !35
  %add268 = add nsw i32 %add247, %50
  %51 = load ptr, ptr %arrayidx234, align 8, !tbaa !24
  %call272 = call ptr @hypre_StructVectorCreate(i32 noundef %0, ptr noundef %51) #5
  ...
  %52 = load ptr, ptr %arrayidx275, align 8, !tbaa !24
  %call284 = call i32 @hypre_StructVectorInitializeShell(ptr noundef %52) #5
  %53 = load ptr, ptr %arrayidx275, align 8, !tbaa !24
  %data_size288 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %53, i64 0, i32 5
  %54 = load i32, ptr %data_size288, align 4, !tbaa !35
  %add289 = add nsw i32 %add268, %54
  %55 = load ptr, ptr %arrayidx234, align 8, !tbaa !24
  %call293 = call ptr @hypre_StructVectorCreate(i32 noundef %0, ptr noundef %55) #5
  ...
  %56 = load ptr, ptr %arrayidx296, align 8, !tbaa !24
  %call306 = call i32 @hypre_StructVectorInitializeShell(ptr noundef %56) #5
  %57 = load ptr, ptr %arrayidx234, align 8, !tbaa !24
  %call310 = call ptr @hypre_StructVectorCreate(i32 noundef %0, ptr noundef %57) #5
  ...
  %58 = load ptr, ptr %arrayidx313, align 8, !tbaa !24
  %call323 = call i32 @hypre_StructVectorInitializeShell(ptr noundef %58) #5
...
for.end326:                                       ; preds = %for.body199, %for.end171
  ...
  %59 = load ptr, ptr %call148, align 8, !tbaa !24
  %call330 = call i32 @hypre_StructVectorInitializeData(ptr noundef %59, ptr noundef %call327) #5
  %60 = load ptr, ptr %call148, align 8, !tbaa !24
  %call332 = call i32 @hypre_StructVectorAssemble(ptr noundef %60) #5
  %61 = load ptr, ptr %call148, align 8, !tbaa !24
  %data_size334 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %61, i64 0, i32 5
  %62 = load i32, ptr %data_size334, align 4, !tbaa !35
  %idx.ext = sext i32 %62 to i64
  %add.ptr = getelementptr inbounds double, ptr %call327, i64 %idx.ext
  %63 = load ptr, ptr %call152, align 8, !tbaa !24
  %call336 = call i32 @hypre_StructVectorInitializeData(ptr noundef %63, ptr noundef %add.ptr) #5
  %64 = load ptr, ptr %call152, align 8, !tbaa !24
  %call338 = call i32 @hypre_StructVectorAssemble(ptr noundef %64) #5
  br i1 %cmp1971252.not, label %for.end416, label %for.body347.preheader

for.body347.preheader:                            ; preds = %for.end326
  %65 = load ptr, ptr %call152, align 8, !tbaa !24
  %data_size340 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %65, i64 0, i32 5
  %66 = load i32, ptr %data_size340, align 4, !tbaa !35
  %idx.ext341 = sext i32 %66 to i64
...
for.body347:                                      ; preds = %for.body347.preheader, %for.body347
  ...
  %67 = load ptr, ptr %arrayidx349, align 8, !tbaa !24
  %call350 = call i32 @hypre_StructMatrixInitializeData(ptr noundef %67, ptr noundef %data.01256) #5
  %68 = load ptr, ptr %arrayidx349, align 8, !tbaa !24
  %data_size353 = getelementptr inbounds %struct.hypre_StructMatrix_struct, ptr %68, i64 0, i32 8
  %69 = load i32, ptr %data_size353, align 4, !tbaa !37
  %idx.ext354 = sext i32 %69 to i64
  ...
  %70 = load ptr, ptr %arrayidx358, align 8, !tbaa !24
  %call359 = call i32 @hypre_StructMatrixInitializeData(ptr noundef %70, ptr noundef %add.ptr355) #5
  %71 = load ptr, ptr %arrayidx358, align 8, !tbaa !24
  %data_size363 = getelementptr inbounds %struct.hypre_StructMatrix_struct, ptr %71, i64 0, i32 8
  %72 = load i32, ptr %data_size363, align 4, !tbaa !37
  %idx.ext364 = sext i32 %72 to i64
  ...
  %73 = load ptr, ptr %arrayidx368, align 8, !tbaa !24
  %call369 = call i32 @hypre_StructVectorInitializeData(ptr noundef %73, ptr noundef %add.ptr365) #5
  %74 = load ptr, ptr %arrayidx368, align 8, !tbaa !24
  %call373 = call i32 @hypre_StructVectorAssemble(ptr noundef %74) #5
  %75 = load ptr, ptr %arrayidx368, align 8, !tbaa !24
  %data_size377 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %75, i64 0, i32 5
  %76 = load i32, ptr %data_size377, align 4, !tbaa !35
  %idx.ext378 = sext i32 %76 to i64
  ...
  %77 = load ptr, ptr %arrayidx382, align 8, !tbaa !24
  %call383 = call i32 @hypre_StructVectorInitializeData(ptr noundef %77, ptr noundef %add.ptr379) #5
  %78 = load ptr, ptr %arrayidx382, align 8, !tbaa !24
  %call387 = call i32 @hypre_StructVectorAssemble(ptr noundef %78) #5
  %79 = load ptr, ptr %arrayidx382, align 8, !tbaa !24
  %data_size391 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %79, i64 0, i32 5
  %80 = load i32, ptr %data_size391, align 4, !tbaa !35
  %idx.ext392 = sext i32 %80 to i64
  ...
  %82 = load ptr, ptr %call148, align 8, !tbaa !24
  %data398 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %82, i64 0, i32 3
  %83 = load ptr, ptr %data398, align 8, !tbaa !40
  %call399 = call i32 @hypre_StructVectorInitializeData(ptr noundef %81, ptr noundef %83) #5
  %84 = load ptr, ptr %arrayidx396, align 8, !tbaa !24
  %call403 = call i32 @hypre_StructVectorAssemble(ptr noundef %84) #5
  %arrayidx406 = getelementptr inbounds ptr, ptr %call152, i64 %indvars.iv.next1274
  %85 = load ptr, ptr %arrayidx406, align 8, !tbaa !24
  %86 = load ptr, ptr %call152, align 8, !tbaa !24
  %data408 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %86, i64 0, i32 3
  %87 = load ptr, ptr %data408, align 8, !tbaa !40
  %call409 = call i32 @hypre_StructVectorInitializeData(ptr noundef %85, ptr noundef %87) #5
  %88 = load ptr, ptr %arrayidx406, align 8, !tbaa !24
  %call413 = call i32 @hypre_StructVectorAssemble(ptr noundef %88) #5
...
for.end416:                                       ; preds = %for.body347, %for.end326
  ...
  %89 = load ptr, ptr %call140, align 8, !tbaa !24
  %data443 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %89, i64 0, i32 3
  %90 = load ptr, ptr %data443, align 8, !tbaa !40
  %data_alloced = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %89, i64 0, i32 4
  %91 = load i32, ptr %data_alloced, align 8, !tbaa !51
  %92 = load ptr, ptr %call144, align 8, !tbaa !24
  %data446 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %92, i64 0, i32 3
  %93 = load ptr, ptr %data446, align 8, !tbaa !40
  %data_alloced448 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %92, i64 0, i32 4
  %94 = load i32, ptr %data_alloced448, align 8, !tbaa !51
  %95 = load ptr, ptr %call148, align 8, !tbaa !24
  %data451 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %95, i64 0, i32 3
  %96 = load ptr, ptr %data451, align 8, !tbaa !40
  %call452 = call i32 @hypre_StructVectorInitializeData(ptr noundef %89, ptr noundef %96) #5
  %97 = load ptr, ptr %call144, align 8, !tbaa !24
  %98 = load ptr, ptr %call152, align 8, !tbaa !24
  %data455 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %98, i64 0, i32 3
  %99 = load ptr, ptr %data455, align 8, !tbaa !40
  %call456 = call i32 @hypre_StructVectorInitializeData(ptr noundef %97, ptr noundef %99) #5
  %100 = load ptr, ptr %call140, align 8, !tbaa !24
  %call458 = call i32 @hypre_StructVectorAssemble(ptr noundef %100) #5
  %101 = load ptr, ptr %call144, align 8, !tbaa !24
  %call460 = call i32 @hypre_StructVectorAssemble(ptr noundef %101) #5
...
if.else534:                                       ; preds = %for.body465
  %102 = load i32, ptr %base_index2, align 4, !tbaa !22
  store i32 %102, ptr %bindex, align 8, !tbaa !22
  %103 = load i32, ptr %arrayidx47, align 4, !tbaa !22
  store i32 %103, ptr %arrayidx470, align 4, !tbaa !22
  %104 = load i32, ptr %arrayidx49, align 4, !tbaa !22
  store i32 %104, ptr %arrayidx471, align 8, !tbaa !22
  %105 = load i32, ptr %base_stride3, align 4, !tbaa !22
  store i32 %105, ptr %bstride, align 8, !tbaa !22
  %106 = load i32, ptr %arrayidx64, align 4, !tbaa !22
  store i32 %106, ptr %arrayidx484, align 4, !tbaa !22
  %107 = load i32, ptr %arrayidx66, align 4, !tbaa !22
  br label %if.end541

if.end541:                                        ; preds = %if.else534, %if.then530
  %storemerge1296 = phi i32 [ 0, %if.then530 ], [ %102, %if.else534 ]
  %storemerge1295 = phi i32 [ 0, %if.then530 ], [ %103, %if.else534 ]
  %storemerge1294 = phi i32 [ 0, %if.then530 ], [ %104, %if.else534 ]
  %storemerge1292 = phi i32 [ 1, %if.then530 ], [ %105, %if.else534 ]
  %storemerge1291 = phi i32 [ 1, %if.then530 ], [ %106, %if.else534 ]
  %storemerge = phi i32 [ 1, %if.then530 ], [ %107, %if.else534 ]
  ...
  %108 = load i32, ptr %arrayidx70, align 4, !tbaa !22
  %mul544 = shl nsw i32 %108, 1
  ...
  %110 = load i32, ptr %memory_use, align 4, !tbaa !52
  %call555 = call i32 @hypre_SMGRelaxSetMemoryUse(ptr noundef %109, i32 noundef %110) #5
  %111 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %call558 = call i32 @hypre_SMGRelaxSetTol(ptr noundef %111, double noundef 0.000000e+00) #5
  %112 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %call561 = call i32 @hypre_SMGRelaxSetNumSpaces(ptr noundef %112, i32 noundef 2) #5
  %113 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %114 = load i32, ptr %arrayidx531244.le, align 4, !tbaa !22
  %115 = load i32, ptr %arrayidx70, align 4, !tbaa !22
  %call568 = call i32 @hypre_SMGRelaxSetSpace(ptr noundef %113, i32 noundef 0, i32 noundef %114, i32 noundef %115) #5
  %116 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %117 = load i32, ptr %arrayidx526, align 4, !tbaa !22
  %118 = load i32, ptr %arrayidx70, align 4, !tbaa !22
  %call575 = call i32 @hypre_SMGRelaxSetSpace(ptr noundef %116, i32 noundef 1, i32 noundef %117, i32 noundef %118) #5
  %119 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %arrayidx579 = getelementptr inbounds ptr, ptr %call148, i64 %indvars.iv1278
  %120 = load ptr, ptr %arrayidx579, align 8, !tbaa !24
  %call580 = call i32 @hypre_SMGRelaxSetTempVec(ptr noundef %119, ptr noundef %120) #5
  %121 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %call583 = call i32 @hypre_SMGRelaxSetNumPreRelax(ptr noundef %121, i32 noundef %1) #5
  %122 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %call586 = call i32 @hypre_SMGRelaxSetNumPostRelax(ptr noundef %122, i32 noundef %2) #5
  %123 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %arrayidx590 = getelementptr inbounds ptr, ptr %call126, i64 %indvars.iv1278
  %124 = load ptr, ptr %arrayidx590, align 8, !tbaa !24
  %arrayidx592 = getelementptr inbounds ptr, ptr %call140, i64 %indvars.iv1278
  %125 = load ptr, ptr %arrayidx592, align 8, !tbaa !24
  %arrayidx594 = getelementptr inbounds ptr, ptr %call144, i64 %indvars.iv1278
  %126 = load ptr, ptr %arrayidx594, align 8, !tbaa !24
  %call595 = call i32 @hypre_SMGRelaxSetup(ptr noundef %123, ptr noundef %124, ptr noundef %125, ptr noundef %126) #5
  %127 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %128 = load ptr, ptr %arrayidx590, align 8, !tbaa !24
  %129 = load ptr, ptr %arrayidx592, align 8, !tbaa !24
  %130 = load ptr, ptr %arrayidx594, align 8, !tbaa !24
  %arrayidx605 = getelementptr inbounds ptr, ptr %call131, i64 %indvars.iv1278
  %131 = load ptr, ptr %arrayidx605, align 8, !tbaa !24
  %call609 = call i32 @hypre_SMGSetupInterpOp(ptr noundef %127, ptr noundef %128, ptr noundef %129, ptr noundef %130, ptr noundef %131, i32 noundef %sub, ptr noundef nonnull %cindex, ptr noundef nonnull %findex, ptr noundef nonnull %stride) #5
  %132 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %call612 = call i32 @hypre_SMGRelaxSetNumPreSpaces(ptr noundef %132, i32 noundef 0) #5
  %133 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %call615 = call i32 @hypre_SMGRelaxSetNumRegSpaces(ptr noundef %133, i32 noundef 2) #5
  %134 = load ptr, ptr %arrayidx547, align 8, !tbaa !24
  %135 = load ptr, ptr %arrayidx590, align 8, !tbaa !24
  %136 = load ptr, ptr %arrayidx592, align 8, !tbaa !24
  %137 = load ptr, ptr %arrayidx594, align 8, !tbaa !24
  %call624 = call i32 @hypre_SMGRelaxSetup(ptr noundef %134, ptr noundef %135, ptr noundef %136, ptr noundef %137) #5
  ...
  %138 = load ptr, ptr %arrayidx627, align 8, !tbaa !24
  %139 = load ptr, ptr %arrayidx590, align 8, !tbaa !24
  %140 = load ptr, ptr %arrayidx594, align 8, !tbaa !24
  %141 = load ptr, ptr %arrayidx592, align 8, !tbaa !24
  %arrayidx642 = getelementptr inbounds ptr, ptr %call152, i64 %indvars.iv1278
  %142 = load ptr, ptr %arrayidx642, align 8, !tbaa !24
  %call643 = call i32 @hypre_SMGResidualSetup(ptr noundef %138, ptr noundef %139, ptr noundef %140, ptr noundef %141, ptr noundef %142) #5
  ...
  %143 = load ptr, ptr %arrayidx605, align 8, !tbaa !24
  ...
  %144 = load ptr, ptr %arrayidx653, align 8, !tbaa !24
  %145 = load ptr, ptr %arrayidx642, align 8, !tbaa !24
  %call659 = call i32 @hypre_SemiInterpSetup(ptr noundef %call644, ptr noundef %143, i32 noundef 1, ptr noundef %144, ptr noundef %145, ptr noundef nonnull %cindex, ptr noundef nonnull %findex, ptr noundef nonnull %stride) #5
  ...
  %147 = load ptr, ptr %arrayidx642, align 8, !tbaa !24
  %arrayidx671 = getelementptr inbounds ptr, ptr %call140, i64 %indvars.iv.next1279
  %148 = load ptr, ptr %arrayidx671, align 8, !tbaa !24
  %call675 = call i32 @hypre_SemiRestrictSetup(ptr noundef %call660, ptr noundef %146, i32 noundef 0, ptr noundef %147, ptr noundef %148, ptr noundef nonnull %cindex, ptr noundef nonnull %findex, ptr noundef nonnull %stride) #5
  %149 = load ptr, ptr %arrayidx666, align 8, !tbaa !24
  %150 = load ptr, ptr %arrayidx590, align 8, !tbaa !24
  %151 = load ptr, ptr %arrayidx605, align 8, !tbaa !24
  %arrayidx684 = getelementptr inbounds ptr, ptr %call126, i64 %indvars.iv.next1279
  %152 = load ptr, ptr %arrayidx684, align 8, !tbaa !24
  %call687 = call i32 @hypre_SMGSetupRAPOp(ptr noundef %149, ptr noundef %150, ptr noundef %151, ptr noundef %152, ptr noundef nonnull %cindex, ptr noundef nonnull %stride) #5
...
if.else711:                                       ; preds = %for.end416
  %153 = load <2 x i32>, ptr %base_index2, align 4, !tbaa !22
  %154 = load i32, ptr %arrayidx49, align 4, !tbaa !22
  %155 = load <2 x i32>, ptr %base_stride3, align 4, !tbaa !22
  %156 = load i32, ptr %arrayidx66, align 4, !tbaa !22
  br label %if.end718

if.end718:                                        ; preds = %if.end541, %if.else711
  %l.3.lcssa1303 = phi i64 [ 0, %if.else711 ], [ %l.0.lcssa.wide, %if.end541 ]
  %.sink1285 = phi i32 [ %154, %if.else711 ], [ 0, %if.end541 ]
  %.sink = phi i32 [ %156, %if.else711 ], [ 1, %if.end541 ]
  %157 = phi <2 x i32> [ %153, %if.else711 ], [ zeroinitializer, %if.end541 ]
  %158 = phi <2 x i32> [ %155, %if.else711 ], [ <i32 1, i32 1>, %if.end541 ]
  store <2 x i32> %157, ptr %bindex, align 8
  %159 = getelementptr inbounds [3 x i32], ptr %bindex, i64 0, i64 2
  store i32 %.sink1285, ptr %159, align 8
  store <2 x i32> %158, ptr %bstride, align 8
  %160 = getelementptr inbounds [3 x i32], ptr %bstride, i64 0, i64 2
  ...
  %161 = load ptr, ptr %arrayidx721, align 8, !tbaa !24
  %call729 = call i32 @hypre_SMGRelaxSetTol(ptr noundef %161, double noundef 0.000000e+00) #5
  %162 = load ptr, ptr %arrayidx721, align 8, !tbaa !24
  %call732 = call i32 @hypre_SMGRelaxSetMaxIter(ptr noundef %162, i32 noundef 1) #5
  %163 = load ptr, ptr %arrayidx721, align 8, !tbaa !24
  %arrayidx736 = getelementptr inbounds ptr, ptr %call148, i64 %idxprom720
  %164 = load ptr, ptr %arrayidx736, align 8, !tbaa !24
  %call737 = call i32 @hypre_SMGRelaxSetTempVec(ptr noundef %163, ptr noundef %164) #5
  %165 = load ptr, ptr %arrayidx721, align 8, !tbaa !24
  %call740 = call i32 @hypre_SMGRelaxSetNumPreRelax(ptr noundef %165, i32 noundef %1) #5
  %166 = load ptr, ptr %arrayidx721, align 8, !tbaa !24
  %call743 = call i32 @hypre_SMGRelaxSetNumPostRelax(ptr noundef %166, i32 noundef %2) #5
  %167 = load ptr, ptr %arrayidx721, align 8, !tbaa !24
  %arrayidx747 = getelementptr inbounds ptr, ptr %call126, i64 %idxprom720
  %168 = load ptr, ptr %arrayidx747, align 8, !tbaa !24
  %arrayidx749 = getelementptr inbounds ptr, ptr %call140, i64 %idxprom720
  %169 = load ptr, ptr %arrayidx749, align 8, !tbaa !24
  %arrayidx751 = getelementptr inbounds ptr, ptr %call144, i64 %idxprom720
  %170 = load ptr, ptr %arrayidx751, align 8, !tbaa !24
  %call752 = call i32 @hypre_SMGRelaxSetup(ptr noundef %167, ptr noundef %168, ptr noundef %169, ptr noundef %170) #5
...
if.then755:                                       ; preds = %if.end718
  ...
  %171 = load ptr, ptr %arrayidx758, align 8, !tbaa !24
  %172 = load ptr, ptr %arrayidx747, align 8, !tbaa !24
  %173 = load ptr, ptr %arrayidx751, align 8, !tbaa !24
  %174 = load ptr, ptr %arrayidx749, align 8, !tbaa !24
  %arrayidx773 = getelementptr inbounds ptr, ptr %call152, i64 %idxprom720
  %175 = load ptr, ptr %arrayidx773, align 8, !tbaa !24
  %call774 = call i32 @hypre_SMGResidualSetup(ptr noundef %171, ptr noundef %172, ptr noundef %173, ptr noundef %174, ptr noundef %175) #5
  br label %if.end775

if.end775:                                        ; preds = %if.then755, %if.end718
  %176 = load ptr, ptr %call140, align 8, !tbaa !24
  %call777 = call i32 @hypre_StructVectorInitializeData(ptr noundef %176, ptr noundef %90) #5
  %177 = load ptr, ptr %call140, align 8, !tbaa !24
  %data_alloced779 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %177, i64 0, i32 4
  store i32 %91, ptr %data_alloced779, align 8, !tbaa !51
  %178 = load ptr, ptr %call144, align 8, !tbaa !24
  %call781 = call i32 @hypre_StructVectorInitializeData(ptr noundef %178, ptr noundef %93) #5
  %179 = load ptr, ptr %call144, align 8, !tbaa !24
  %data_alloced783 = getelementptr inbounds %struct.hypre_StructVector_struct, ptr %179, i64 0, i32 4
  store i32 %94, ptr %data_alloced783, align 8, !tbaa !51
  %180 = load ptr, ptr %call140, align 8, !tbaa !24
  %call785 = call i32 @hypre_StructVectorAssemble(ptr noundef %180) #5
  %181 = load ptr, ptr %call144, align 8, !tbaa !24
  %call787 = call i32 @hypre_StructVectorAssemble(ptr noundef %181) #5
  ...
  %182 = load i32, ptr %logging, align 8, !tbaa !58
  %cmp792 = icmp sgt i32 %182, 0
...
if.then794:                                       ; preds = %if.end775
  ...
  %183 = load i32, ptr %max_iter795, align 8, !tbaa !59
  %mul797 = shl i32 %183, 3
