; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/rules-red.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/rules-red.c"
...
@.str.16 = private unnamed_addr constant [95 x i8] c"/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/rules-red.c\00", align 1
...
entry:
  ...
  %call5.i = call fastcc i32 @red_SimpleStaticReductions(ptr noundef nonnull %Clause.addr, ptr noundef %Search.val.i, ptr noundef %Search.val190.i, ptr noundef nonnull %Redundant)
...
land.lhs.true.i:                                  ; preds = %if.end.i
  ...
  %call11.i = call fastcc i32 @red_AssignmentEquationDeletion(ptr noundef %3, ptr noundef nonnull %Search.val.i, ptr noundef %Search.val190.i, ptr noundef nonnull %Copy.i, i32 noundef %Search.val193.i, i32 noundef %conv.i)
...
land.lhs.true36.i:                                ; preds = %lor.lhs.false.i
  ...
  %call38.i = call fastcc i32 @red_ContextualRewriting(ptr noundef nonnull %Search, ptr noundef %18, i32 noundef %Mode, i32 noundef %Search.val197.i, ptr noundef nonnull %Copy.i)
...
red_ExchangeClauses.exit210.i:                    ; preds = %if.then.i209.i, %if.then40.i
  %call41.i = call fastcc i32 @red_SimpleStaticReductions(ptr noundef nonnull %Clause.addr, ptr noundef nonnull %Search.val.i, ptr noundef %Search.val190.i, ptr noundef nonnull %Redundant)
...
if.then64.i:                                      ; preds = %land.lhs.true61.i
  ...
  %call68.i = call fastcc i32 @red_SortSimplification(ptr noundef %Search.val199.i, ptr noundef %31, i32 noundef %Search.val196.i, i32 noundef %33, ptr noundef nonnull %Search.val.i, ptr noundef %Search.val190.i, ptr noundef nonnull %Copy.i)
...
red_StaticReductions.exit:                        ; preds = %land.lhs.true96.i
  ...
  %call101.i = tail call i32 @red_ClauseDeletion(ptr noundef %Search.val200.i, ptr noundef %63, ptr noundef nonnull %Search.val.i, ptr noundef %Search.val190.i)
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %Copy.i) #11
...
for.inc.i:                                        ; preds = %if.else12.i, %if.then11.i, %if.then.i
  ...
  br i1 %cmp.i.not.i, label %while.body.i, label %for.body.i, !llvm.loop !5
...
while.body.i:                                     ; preds = %for.inc.i, %while.body.i
  ...
  br i1 %cmp.i.not.i29, label %list_Delete.exit, label %while.body.i, !llvm.loop !7
...
for.inc.i50:                                      ; preds = %if.else12.i47, %if.then11.i46, %if.then.i41
  ...
  br i1 %cmp.i.not.i49, label %while.body.i59, label %for.body.i40, !llvm.loop !5
...
while.body.i59:                                   ; preds = %for.inc.i50, %while.body.i59
  ...
  br i1 %cmp.i.not.i58, label %if.end17, label %while.body.i59, !llvm.loop !7
...
entry:
  ...
  %call1 = call fastcc i32 @red_SelectedStaticReductions(ptr noundef %Search, ptr noundef nonnull %Clause.addr, ptr noundef nonnull %RedClause, ptr noundef nonnull %Redundant, i32 noundef %Mode)
...
while.body.i:                                     ; preds = %for.inc.i, %while.body.i
  ...
  br i1 %cmp.i.not.i27, label %list_Delete.exit, label %while.body.i, !llvm.loop !7
...
for.inc.i48:                                      ; preds = %if.else12.i45, %if.then11.i44, %if.then.i39
  ...
  br i1 %cmp.i.not.i47, label %while.body.i57, label %for.body.i38, !llvm.loop !5
...
while.body.i57:                                   ; preds = %for.inc.i48, %while.body.i57
  ...
  br i1 %cmp.i.not.i56, label %if.end17, label %while.body.i57, !llvm.loop !7
...
if.end8:                                          ; preds = %if.then6, %if.end
  ...
  %call9 = tail call fastcc i32 @red_SimpleStaticReductions(ptr noundef %Clause, ptr noundef %Search.val, ptr noundef %Search.val364, ptr noundef %Result)
...
land.lhs.true:                                    ; preds = %if.end12
  ...
  %call17 = call fastcc i32 @red_AssignmentEquationDeletion(ptr noundef %7, ptr noundef nonnull %Search.val, ptr noundef %Search.val364, ptr noundef nonnull %Copy, i32 noundef %Search.val367, i32 noundef %conv)
...
land.lhs.true61:                                  ; preds = %lor.lhs.false
  ...
  %call63 = call fastcc i32 @red_ContextualRewriting(ptr noundef %Search, ptr noundef %30, i32 noundef 2, i32 noundef %Search.val375, ptr noundef nonnull %Copy)
...
red_ExchangeClauses.exit399:                      ; preds = %if.then65, %if.then.i398
  %call66 = tail call fastcc i32 @red_SimpleStaticReductions(ptr noundef nonnull %Clause, ptr noundef %Search.val, ptr noundef %Search.val364, ptr noundef %Result)
...
land.lhs.true107:                                 ; preds = %lor.lhs.false105
  ...
  %call109 = call fastcc i32 @red_ContextualRewriting(ptr noundef %Search, ptr noundef %50, i32 noundef 1, i32 noundef %Search.val373, ptr noundef nonnull %Copy)
...
red_ExchangeClauses.exit438:                      ; preds = %if.then111, %if.then.i437
  %call112 = tail call fastcc i32 @red_SimpleStaticReductions(ptr noundef nonnull %Clause, ptr noundef %Search.val, ptr noundef %Search.val364, ptr noundef %Result)
...
if.end138:                                        ; preds = %if.end81, %if.end119, %red_ForwardSubsumption.exit472, %land.lhs.true107, %lor.lhs.false105, %if.end92
  ...
  br i1 %tobool51.not, label %while.end, label %while.body, !llvm.loop !8
...
if.then141:                                       ; preds = %while.end
  ...
  %call145 = call fastcc i32 @red_SortSimplification(ptr noundef %Search.val377, ptr noundef %71, i32 noundef %Search.val372, i32 noundef %73, ptr noundef nonnull %Search.val, ptr noundef %Search.val364, ptr noundef nonnull %Copy)
...
if.end162:                                        ; preds = %red_ExchangeClauses.exit498, %land.lhs.true.i502, %land.lhs.true1.i505, %clause_IsEmptyClause.exit511
  %.pr604652 = phi ptr [ %85, %clause_IsEmptyClause.exit511 ], [ null, %red_ExchangeClauses.exit498 ], [ %85, %land.lhs.true.i502 ], [ %85, %land.lhs.true1.i505 ]
...
if.end167:                                        ; preds = %if.end162
  %89 = getelementptr i8, ptr %Search, i64 132
  %Search.val370 = load i32, ptr %89, align 4
  call fastcc void @red_MatchingReplacementResolution(ptr noundef %.pr604652, ptr noundef nonnull %UsIndex.0, ptr noundef nonnull %Search.val, ptr noundef %Search.val364, ptr noundef nonnull %Copy, i32 noundef %Search.val370)
  %.pre = load ptr, ptr %Copy, align 8
  %tobool.not.i512 = icmp eq ptr %.pre, null
  %.pr604.pre = load ptr, ptr %Clause, align 8
...
red_ExchangeClauses.exit516.thread:               ; preds = %if.end167
  ...
  store ptr %.pr604.pre, ptr %car.i.i514, align 8
  store ptr %90, ptr %call.i.i513, align 8
  store ptr %call.i.i513, ptr %Result, align 8
  store ptr %.pre, ptr %Clause, align 8
  store ptr null, ptr %Copy, align 8
  br label %land.lhs.true.i520

red_ExchangeClauses.exit516:                      ; preds = %if.end167, %if.end162
  %.pr604 = phi ptr [ %.pr604652, %if.end162 ], [ %.pr604.pre, %if.end167 ]
...
land.lhs.true.i520:                               ; preds = %red_ExchangeClauses.exit516.thread, %red_ExchangeClauses.exit516
  %91 = phi ptr [ %.pre, %red_ExchangeClauses.exit516.thread ], [ %.pr604, %red_ExchangeClauses.exit516 ]
  %92 = getelementptr i8, ptr %91, i64 68
  %C.val.i518 = load i32, ptr %92, align 4
...
land.lhs.true1.i523:                              ; preds = %land.lhs.true.i520
  ...
  %C.val9.i521 = load i32, ptr %93, align 8
...
clause_IsEmptyClause.exit529:                     ; preds = %land.lhs.true1.i523
  %94 = getelementptr i8, ptr %91, i64 64
  %C.val10.i524 = load i32, ptr %94, align 8
...
if.end172:                                        ; preds = %red_ExchangeClauses.exit516, %land.lhs.true.i520, %land.lhs.true1.i523, %clause_IsEmptyClause.exit529, %if.end150
  ...
  %95 = load i32, ptr %arrayidx.i530, align 4
  %tobool174.not = icmp eq i32 %95, 0
...
if.then177:                                       ; preds = %if.then175
  %96 = load ptr, ptr %Clause, align 8
  %97 = getelementptr i8, ptr %Search, i64 132
  %Search.val369 = load i32, ptr %97, align 4
  call fastcc void @red_UnitConflict(ptr noundef %96, ptr noundef nonnull %WoIndex.0, ptr noundef nonnull %Search.val, ptr noundef %Search.val364, ptr noundef nonnull %Copy, i32 noundef %Search.val369)
  br label %if.end180

if.end180:                                        ; preds = %if.then177, %if.then175
  %98 = load ptr, ptr %Copy, align 8
  %tobool.not.i531 = icmp eq ptr %98, null
...
red_ExchangeClauses.exit535.thread:               ; preds = %if.end180
  ...
  store ptr %99, ptr %call.i.i532, align 8
  store ptr %call.i.i532, ptr %Result, align 8
  store ptr %98, ptr %Clause, align 8
  store ptr null, ptr %Copy, align 8
...
land.lhs.true.i539:                               ; preds = %red_ExchangeClauses.exit535.thread, %red_ExchangeClauses.exit535
  %100 = phi ptr [ %98, %red_ExchangeClauses.exit535.thread ], [ %.pr608, %red_ExchangeClauses.exit535 ]
  %101 = getelementptr i8, ptr %100, i64 68
  %C.val.i537 = load i32, ptr %101, align 4
...
land.lhs.true1.i542:                              ; preds = %land.lhs.true.i539
  ...
  %C.val9.i540 = load i32, ptr %102, align 8
...
clause_IsEmptyClause.exit548:                     ; preds = %land.lhs.true1.i542
  %103 = getelementptr i8, ptr %100, i64 64
  %C.val10.i543 = load i32, ptr %103, align 8
...
if.end184:                                        ; preds = %red_ExchangeClauses.exit535, %land.lhs.true.i539, %land.lhs.true1.i542, %clause_IsEmptyClause.exit548
  %.pr613654 = phi ptr [ %100, %clause_IsEmptyClause.exit548 ], [ null, %red_ExchangeClauses.exit535 ], [ %100, %land.lhs.true.i539 ], [ %100, %land.lhs.true1.i542 ]
...
if.end189:                                        ; preds = %if.end184
  %104 = getelementptr i8, ptr %Search, i64 132
  %Search.val368 = load i32, ptr %104, align 4
  call fastcc void @red_UnitConflict(ptr noundef %.pr613654, ptr noundef nonnull %UsIndex.0, ptr noundef nonnull %Search.val, ptr noundef %Search.val364, ptr noundef nonnull %Copy, i32 noundef %Search.val368)
  %.pre631 = load ptr, ptr %Copy, align 8
  %tobool.not.i549 = icmp eq ptr %.pre631, null
  %.pr613.pre = load ptr, ptr %Clause, align 8
...
red_ExchangeClauses.exit553.thread:               ; preds = %if.end189
  ...
  store ptr %.pr613.pre, ptr %car.i.i551, align 8
  store ptr %105, ptr %call.i.i550, align 8
  store ptr %call.i.i550, ptr %Result, align 8
  store ptr %.pre631, ptr %Clause, align 8
  br label %land.lhs.true.i557

red_ExchangeClauses.exit553:                      ; preds = %if.end189, %if.end184
  %.pr613 = phi ptr [ %.pr613654, %if.end184 ], [ %.pr613.pre, %if.end189 ]
...
land.lhs.true.i557:                               ; preds = %red_ExchangeClauses.exit553.thread, %red_ExchangeClauses.exit553
  %106 = phi ptr [ %.pre631, %red_ExchangeClauses.exit553.thread ], [ %.pr613, %red_ExchangeClauses.exit553 ]
  %107 = getelementptr i8, ptr %106, i64 68
  %C.val.i555 = load i32, ptr %107, align 4
...
land.lhs.true1.i560:                              ; preds = %land.lhs.true.i557
  %108 = getelementptr i8, ptr %106, i64 72
  %C.val9.i558 = load i32, ptr %108, align 8
...
clause_IsEmptyClause.exit566:                     ; preds = %land.lhs.true1.i560
  ...
  %C.val10.i561 = load i32, ptr %109, align 8
...
if.end194:                                        ; preds = %red_ExchangeClauses.exit553, %land.lhs.true.i557, %land.lhs.true1.i560, %clause_IsEmptyClause.exit566, %if.end172
  ...
  %110 = load i32, ptr %arrayidx.i567, align 4
  %tobool196.not = icmp eq i32 %110, 0
  br i1 %tobool196.not, label %cleanup, label %if.then197

if.then197:                                       ; preds = %if.end194
  %111 = getelementptr i8, ptr %Search, i64 64
  %Search.val378 = load ptr, ptr %111, align 8
  %112 = load ptr, ptr %Clause, align 8
  %call199 = tail call i32 @red_ClauseDeletion(ptr noundef %Search.val378, ptr noundef %112, ptr noundef nonnull %Search.val, ptr noundef %Search.val364)
  br label %cleanup
...
cleanup:                                          ; preds = %red_ForwardSubsumption.exit472, %if.end127, %clause_IsEmptyClause.exit451, %red_ExchangeClauses.exit438, %red_ForwardSubsumption.exit433, %red_ForwardSubsumption.exit423, %clause_IsEmptyClause.exit412, %red_ExchangeClauses.exit399, %red_ForwardSubsumption.exit472.thread, %if.end127.thread593, %red_ForwardSubsumption.exit433.thread, %red_ForwardSubsumption.exit423.thread, %red_ForwardSubsumption.exit392.thread, %red_ForwardSubsumption.exit.thread, %if.end194, %if.then197, %clause_IsEmptyClause.exit566, %clause_IsEmptyClause.exit548, %clause_IsEmptyClause.exit529, %clause_IsEmptyClause.exit511, %clause_IsEmptyClause.exit492, %red_ForwardSubsumption.exit392, %red_ForwardSubsumption.exit, %clause_IsEmptyClause.exit, %if.end8
  %retval.0 = phi i32 [ 1, %if.end8 ], [ 0, %clause_IsEmptyClause.exit ], [ 1, %red_ForwardSubsumption.exit ], [ 1, %red_ForwardSubsumption.exit392 ], [ 0, %clause_IsEmptyClause.exit492 ], [ 0, %clause_IsEmptyClause.exit511 ], [ 0, %clause_IsEmptyClause.exit529 ], [ 0, %clause_IsEmptyClause.exit548 ], [ 0, %clause_IsEmptyClause.exit566 ], [ %call199, %if.then197 ], [ 0, %if.end194 ], [ 1, %red_ForwardSubsumption.exit.thread ], [ 1, %red_ForwardSubsumption.exit392.thread ], [ 1, %red_ForwardSubsumption.exit423.thread ], [ 1, %red_ForwardSubsumption.exit433.thread ], [ 1, %if.end127.thread593 ], [ 1, %red_ForwardSubsumption.exit472.thread ], [ 1, %red_ExchangeClauses.exit399 ], [ 0, %clause_IsEmptyClause.exit412 ], [ 1, %red_ForwardSubsumption.exit423 ], [ 1, %red_ForwardSubsumption.exit433 ], [ 1, %red_ExchangeClauses.exit438 ], [ 0, %clause_IsEmptyClause.exit451 ], [ 1, %if.end127 ], [ 1, %red_ForwardSubsumption.exit472 ]
...
while.body.i:                                     ; preds = %while.body.i.preheader, %while.body.i
  ...
  br i1 %cmp.i.not.i134, label %if.end17, label %while.body.i, !llvm.loop !7
...
while.body.i155:                                  ; preds = %while.body.i155.preheader, %while.body.i155
  ...
  br i1 %cmp.i.not.i154, label %if.end35, label %while.body.i155, !llvm.loop !7
...
while.body.i177:                                  ; preds = %while.body.i177.preheader, %while.body.i177
  ...
  br i1 %cmp.i.not.i176, label %if.end53, label %while.body.i177, !llvm.loop !7
...
while.body.i199:                                  ; preds = %while.body.i199.preheader, %while.body.i199
  ...
  br i1 %cmp.i.not.i198, label %if.end69, label %while.body.i199, !llvm.loop !7
...
entry:
  %cmp.not.i = icmp ne ptr %RedCl, null
  %.phi.trans.insert = getelementptr i8, ptr %RedCl, i64 68
  %RedCl.val228.pre = load i32, ptr %.phi.trans.insert, align 4
  %cmp.i.not.i = icmp eq i32 %RedCl.val228.pre, 0
  %or.cond33 = select i1 %cmp.not.i, i1 %cmp.i.not.i, i1 false
  br i1 %or.cond33, label %land.lhs.true1.i, label %if.end

land.lhs.true1.i:                                 ; preds = %entry
  %0 = getelementptr i8, ptr %RedCl, i64 72
  %C.val9.i = load i32, ptr %0, align 8
  %cmp.i11.not.i = icmp eq i32 %C.val9.i, 0
  br i1 %cmp.i11.not.i, label %clause_IsEmptyClause.exit, label %if.end

clause_IsEmptyClause.exit:                        ; preds = %land.lhs.true1.i
  %1 = getelementptr i8, ptr %RedCl, i64 64
  %C.val10.i = load i32, ptr %1, align 8
  %cmp.i13.i.not = icmp eq i32 %C.val10.i, 0
  br i1 %cmp.i13.i.not, label %cleanup, label %if.end

if.end:                                           ; preds = %entry, %land.lhs.true1.i, %clause_IsEmptyClause.exit
  %RedCl.val228 = phi i32 [ 0, %land.lhs.true1.i ], [ 0, %clause_IsEmptyClause.exit ], [ %RedCl.val228.pre, %entry ]
  %2 = getelementptr i8, ptr %RedCl, i64 64
  %RedCl.val240 = load i32, ptr %2, align 8
  %sub.i = add i32 %RedCl.val240, -1
  %sub.i243 = add i32 %sub.i, %RedCl.val228
  %add.i = add i32 %RedCl.val228, %RedCl.val240
  %3 = getelementptr i8, ptr %RedCl, i64 72
...
for.body.lr.ph:                                   ; preds = %if.end
  %4 = add i32 %add.i, %Clause.val7.i.i
...
for.body:                                         ; preds = %for.body, %for.body.lr.ph.new
  ...
  %14 = load ptr, ptr %arrayidx.i247.1, align 8
  %15 = getelementptr i8, ptr %14, i64 4
  %call11.val.1 = load i32, ptr %15, align 4
  %cmp13.1 = icmp ugt i32 %call9.val.1, %call11.val.1
  %16 = trunc i64 %indvars.iv.next to i32
  %spec.select.1 = select i1 %cmp13.1, i32 %16, i32 %spec.select
...
for.body.epil:                                    ; preds = %for.end.loopexit.unr-lcssa
  ...
  %17 = load ptr, ptr %arrayidx.i.epil, align 8
  %18 = getelementptr i8, ptr %17, i64 4
  %call9.val.epil = load i32, ptr %18, align 4
  ...
  %19 = load ptr, ptr %arrayidx.i247.epil, align 8
  %20 = getelementptr i8, ptr %19, i64 4
  %call11.val.epil = load i32, ptr %20, align 4
  %cmp13.epil = icmp ugt i32 %call9.val.epil, %call11.val.epil
  %21 = trunc i64 %indvars.iv.unr to i32
  %spec.select.epil = select i1 %cmp13.epil, i32 %21, i32 %i.08.unr
  br label %for.end
...
for.end:                                          ; preds = %for.body.epil, %for.end.loopexit.unr-lcssa, %if.end
  ...
  %22 = getelementptr i8, ptr %RedCl, i64 56
...
clause_GetLiteralAtom.exit:                       ; preds = %for.end, %if.then.i.i
  ...
  %call19 = tail call ptr @st_ExistInstance(ptr noundef %28, ptr noundef %ShIndex.val241, ptr noundef %retval.0.i.i) #11
...
for.body25:                                       ; preds = %while.body, %for.inc54
  ...
  %29 = getelementptr i8, ptr %Scan.011, i64 8
  %Scan.0.val = load ptr, ptr %29, align 8
  %30 = getelementptr i8, ptr %Scan.0.val, i64 16
  %call26.val = load ptr, ptr %30, align 8
  %31 = getelementptr i8, ptr %call26.val, i64 56
  %call.val.i248 = load ptr, ptr %31, align 8
...
while.cond.i:                                     ; preds = %while.cond.i, %for.body25
  ...
  %32 = load ptr, ptr %arrayidx.i.i249, align 8
  %cmp.not.i250 = icmp eq ptr %32, %Scan.0.val
  %indvars.iv.next.i = add nuw i64 %indvars.iv.i, 1
  br i1 %cmp.not.i250, label %clause_LiteralGetIndex.exit, label %while.cond.i, !llvm.loop !11
...
while.cond.i.i:                                   ; preds = %land.lhs.true, %while.cond.i.i
  ...
  %cmp.not.i.i = icmp eq ptr %34, %Scan.0.val
  %indvars.iv.next.i.i = add nuw i64 %indvars.iv.i.i, 1
  br i1 %cmp.not.i.i, label %clause_LiteralIsFromConstraint.exit, label %while.cond.i.i, !llvm.loop !11

clause_LiteralIsFromConstraint.exit:              ; preds = %while.cond.i.i
  %35 = trunc i64 %indvars.iv.i.i to i32
  %36 = getelementptr i8, ptr %call26.val, i64 64
  %call1.val.i = load i32, ptr %36, align 8
  %cmp.not.not.i = icmp sle i32 %call1.val.i, %35
  %cmp4.i = icmp slt i32 %35, 0
...
while.cond.i.i258:                                ; preds = %lor.lhs.false, %while.cond.i.i258
  ...
  %37 = load ptr, ptr %arrayidx.i.i.i255, align 8
  %cmp.not.i.i256 = icmp eq ptr %37, %Scan.0.val
  %indvars.iv.next.i.i257 = add nuw i64 %indvars.iv.i.i254, 1
  br i1 %cmp.not.i.i256, label %clause_LiteralIsFromAntecedent.exit, label %while.cond.i.i258, !llvm.loop !11

clause_LiteralIsFromAntecedent.exit:              ; preds = %while.cond.i.i258
  %38 = trunc i64 %indvars.iv.i.i254 to i32
  %39 = getelementptr i8, ptr %call26.val, i64 64
  %call1.val.i259 = load i32, ptr %39, align 8
  %40 = getelementptr i8, ptr %call26.val, i64 68
  %call1.val8.i = load i32, ptr %40, align 4
  %add.i.i.i = add i32 %call1.val.i259, -1
  %sub.i.i = add i32 %add.i.i.i, %call1.val8.i
  %cmp.not.i260 = icmp slt i32 %sub.i.i, %38
  %cmp4.i261 = icmp sgt i32 %call1.val.i259, %38
  %narrow.i262.not = select i1 %cmp.not.i260, i1 true, i1 %cmp4.i261
...
while.cond.i.i270:                                ; preds = %lor.lhs.false40, %while.cond.i.i270
  ...
  %41 = load ptr, ptr %arrayidx.i.i.i267, align 8
  %cmp.not.i.i268 = icmp eq ptr %41, %Scan.0.val
  %indvars.iv.next.i.i269 = add nuw i64 %indvars.iv.i.i266, 1
  br i1 %cmp.not.i.i268, label %clause_LiteralIsFromSuccedent.exit, label %while.cond.i.i270, !llvm.loop !11

clause_LiteralIsFromSuccedent.exit:               ; preds = %while.cond.i.i270
  %42 = trunc i64 %indvars.iv.i.i266 to i32
  %43 = getelementptr i8, ptr %call26.val, i64 64
  %Clause.val6.i.i.i = load i32, ptr %43, align 8
  %44 = getelementptr i8, ptr %call26.val, i64 68
  %Clause.val.i.i.i = load i32, ptr %44, align 4
  %45 = getelementptr i8, ptr %call26.val, i64 72
  %Clause.val7.i.i.i = load i32, ptr %45, align 8
  ...
  %cmp.not.i273 = icmp slt i32 %sub.i.i272, %42
  %cmp4.i274 = icmp sgt i32 %add.i.i.i271, %42
  %narrow.i275.not = select i1 %cmp.not.i273, i1 true, i1 %cmp4.i274
...
while.body.i:                                     ; preds = %land.lhs.true45, %if.end.i
  ...
  %46 = getelementptr i8, ptr %List.addr.07.i, i64 8
  %List.addr.0.val.i = load ptr, ptr %46, align 8
...
if.end.i:                                         ; preds = %while.body.i
  ...
  br i1 %cmp.i.not.i278, label %land.lhs.true48, label %while.body.i, !llvm.loop !12

land.lhs.true48:                                  ; preds = %if.end.i, %land.lhs.true45
  %call49 = tail call i32 @subs_SubsumesBasic(ptr noundef %RedCl, ptr noundef %call26.val, i32 noundef %i.0.lcssa, i32 noundef %33) #11
...
for.inc54:                                        ; preds = %while.body.i, %clause_LiteralGetIndex.exit, %lor.lhs.false40, %clause_LiteralIsFromSuccedent.exit, %land.lhs.true48, %if.then51
  ...
  br i1 %cmp.i.not, label %for.end56, label %for.body25, !llvm.loop !13
...
if.then64:                                        ; preds = %land.lhs.true60
  ...
  %call16.val242 = load ptr, ptr %50, align 8
  ...
  %call71 = tail call ptr @st_ExistInstance(ptr noundef %51, ptr noundef %ShIndex.val, ptr noundef %call68) #11
...
while.body74.lr.ph:                               ; preds = %if.then64
  ...
  %or.cond225 = select i1 %cmp93.not, i1 true, i1 %cmp95.not
...
for.body80:                                       ; preds = %while.body74, %for.inc113
  ...
  %52 = getelementptr i8, ptr %Scan.119, i64 8
  %Scan.1.val233 = load ptr, ptr %52, align 8
  %53 = getelementptr i8, ptr %Scan.1.val233, i64 16
  %call82.val = load ptr, ptr %53, align 8
  %54 = getelementptr i8, ptr %call82.val, i64 56
  %call.val.i286 = load ptr, ptr %54, align 8
...
while.cond.i291:                                  ; preds = %while.cond.i291, %for.body80
  ...
  %55 = load ptr, ptr %arrayidx.i.i288, align 8
  %cmp.not.i289 = icmp eq ptr %55, %Scan.1.val233
  %indvars.iv.next.i290 = add nuw i64 %indvars.iv.i287, 1
  br i1 %cmp.not.i289, label %clause_LiteralGetIndex.exit292, label %while.cond.i291, !llvm.loop !11

clause_LiteralGetIndex.exit292:                   ; preds = %while.cond.i291
  %56 = trunc i64 %indvars.iv.i287 to i32
...
while.cond.i.i299:                                ; preds = %land.lhs.true87, %while.cond.i.i299
  ...
  %57 = load ptr, ptr %arrayidx.i.i.i296, align 8
  %cmp.not.i.i297 = icmp eq ptr %57, %Scan.1.val233
  %indvars.iv.next.i.i298 = add nuw i64 %indvars.iv.i.i295, 1
  br i1 %cmp.not.i.i297, label %clause_LiteralIsFromConstraint.exit305, label %while.cond.i.i299, !llvm.loop !11

clause_LiteralIsFromConstraint.exit305:           ; preds = %while.cond.i.i299
  %58 = trunc i64 %indvars.iv.i.i295 to i32
  %59 = getelementptr i8, ptr %call82.val, i64 64
  %call1.val.i300 = load i32, ptr %59, align 8
  %cmp.not.not.i301 = icmp sle i32 %call1.val.i300, %58
  %cmp4.i302 = icmp slt i32 %58, 0
...
while.cond.i.i312:                                ; preds = %lor.lhs.false92, %while.cond.i.i312
  ...
  %60 = load ptr, ptr %arrayidx.i.i.i309, align 8
  %cmp.not.i.i310 = icmp eq ptr %60, %Scan.1.val233
  %indvars.iv.next.i.i311 = add nuw i64 %indvars.iv.i.i308, 1
  br i1 %cmp.not.i.i310, label %clause_LiteralIsFromAntecedent.exit321, label %while.cond.i.i312, !llvm.loop !11

clause_LiteralIsFromAntecedent.exit321:           ; preds = %while.cond.i.i312
  %61 = trunc i64 %indvars.iv.i.i308 to i32
  %62 = getelementptr i8, ptr %call82.val, i64 64
  %call1.val.i313 = load i32, ptr %62, align 8
  %63 = getelementptr i8, ptr %call82.val, i64 68
  %call1.val8.i314 = load i32, ptr %63, align 4
  %add.i.i.i315 = add i32 %call1.val.i313, -1
  %sub.i.i316 = add i32 %add.i.i.i315, %call1.val8.i314
  %cmp.not.i317 = icmp slt i32 %sub.i.i316, %61
  %cmp4.i318 = icmp sgt i32 %call1.val.i313, %61
  %narrow.i319.not = select i1 %cmp.not.i317, i1 true, i1 %cmp4.i318
...
while.cond.i.i328:                                ; preds = %lor.lhs.false99, %while.cond.i.i328
  ...
  %64 = load ptr, ptr %arrayidx.i.i.i325, align 8
  %cmp.not.i.i326 = icmp eq ptr %64, %Scan.1.val233
  %indvars.iv.next.i.i327 = add nuw i64 %indvars.iv.i.i324, 1
  br i1 %cmp.not.i.i326, label %clause_LiteralIsFromSuccedent.exit339, label %while.cond.i.i328, !llvm.loop !11

clause_LiteralIsFromSuccedent.exit339:            ; preds = %while.cond.i.i328
  %65 = trunc i64 %indvars.iv.i.i324 to i32
  %66 = getelementptr i8, ptr %call82.val, i64 64
  %Clause.val6.i.i.i329 = load i32, ptr %66, align 8
  %67 = getelementptr i8, ptr %call82.val, i64 68
  %Clause.val.i.i.i330 = load i32, ptr %67, align 4
  %68 = getelementptr i8, ptr %call82.val, i64 72
  %Clause.val7.i.i.i331 = load i32, ptr %68, align 8
  ...
  %cmp.not.i335 = icmp slt i32 %sub.i.i334, %65
  %cmp4.i336 = icmp sgt i32 %add.i.i.i332, %65
  %narrow.i337.not = select i1 %cmp.not.i335, i1 true, i1 %cmp4.i336
...
while.body.i344:                                  ; preds = %land.lhs.true104, %if.end.i347
  ...
  %69 = getelementptr i8, ptr %List.addr.07.i341, i64 8
  %List.addr.0.val.i342 = load ptr, ptr %69, align 8
...
if.end.i347:                                      ; preds = %while.body.i344
  ...
  br i1 %cmp.i.not.i346, label %land.lhs.true107, label %while.body.i344, !llvm.loop !12

land.lhs.true107:                                 ; preds = %if.end.i347, %land.lhs.true104
  %call108 = tail call i32 @subs_SubsumesBasic(ptr noundef %RedCl, ptr noundef %call82.val, i32 noundef %i.0.lcssa, i32 noundef %56) #11
...
for.inc113:                                       ; preds = %while.body.i344, %clause_LiteralGetIndex.exit292, %lor.lhs.false99, %clause_LiteralIsFromSuccedent.exit339, %land.lhs.true107, %if.then110
  ...
  br i1 %cmp.i283.not, label %for.end115, label %for.body80, !llvm.loop !15
...
for.end115:                                       ; preds = %for.inc113, %while.body74
  ...
  br i1 %tobool73.not, label %while.end117, label %while.body74, !llvm.loop !16
...
while.end117:                                     ; preds = %for.end115, %if.then64
  ...
  %70 = getelementptr i8, ptr %call68, i64 16
  %call68.val = load ptr, ptr %70, align 8
...
while.body.i353:                                  ; preds = %while.end117, %while.body.i353
  ...
  br i1 %cmp.i.not.i352, label %list_Delete.exit, label %while.body.i353, !llvm.loop !7
...
list_Delete.exit:                                 ; preds = %while.body.i353, %while.end117
  ...
  %total_size.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %76, i64 0, i32 4
  %77 = load i32, ptr %total_size.i.i, align 8
  %conv26.i.i = sext i32 %77 to i64
  %78 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i = add i64 %78, %conv26.i.i
  store i64 %add27.i.i, ptr @memory_FREEDBYTES, align 8
  %79 = load ptr, ptr %76, align 8
  store ptr %79, ptr %call68, align 8
  %80 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 32), align 8
  store ptr %call68, ptr %80, align 8
  br label %if.end119
...
if.end119:                                        ; preds = %list_Delete.exit, %land.lhs.true60, %while.end
  ...
  %81 = load i32, ptr %arrayidx.i354, align 4
  %tobool121.not = icmp eq i32 %81, 0
...
for.body127:                                      ; preds = %if.end119, %for.body127
  ...
  %82 = getelementptr i8, ptr %Scan.227, i64 8
  %Scan.2.val = load ptr, ptr %82, align 8
  %83 = load ptr, ptr @stdout, align 8
  %84 = tail call i64 @fwrite(ptr nonnull @.str.40, i64 15, i64 1, ptr %83)
  ...
  br i1 %cmp.i355.not, label %cleanup, label %for.body127, !llvm.loop !17
...
clause_LiteralAtom.exit259:                       ; preds = %clause_LiteralAtom.exit, %if.then.i257
  ...
  %ShIndex.val418 = load ptr, ptr %ShIndex, align 8
  %call13 = tail call ptr @st_ExistInstance(ptr noundef %11, ptr noundef %ShIndex.val418, ptr noundef %retval.0.i258) #11
...
lor.rhs.i:                                        ; preds = %for.body
  ...
  %or.cond377 = or i1 %cmp.i11.not.i, %cmp.i.not.i262
...
for.inc:                                          ; preds = %land.lhs.true.i, %lor.rhs.i, %if.then23
  ...
  br i1 %cmp.i260.not, label %for.end, label %for.body, !llvm.loop !19
...
for.end:                                          ; preds = %for.inc, %while.body
  ...
  br i1 %tobool16.not, label %while.cond28.preheader, label %while.body, !llvm.loop !20
...
for.inc57:                                        ; preds = %for.body50, %if.then54
  ...
  br i1 %cmp.i268.not, label %for.end59.loopexit, label %for.body50, !llvm.loop !21
...
while.cond.i:                                     ; preds = %while.cond.i, %for.body66
  ...
  %indvars.iv.next.i = add nuw i64 %indvars.iv.i, 1
  br i1 %cmp.not.i, label %clause_LiteralGetIndex.exit, label %while.cond.i, !llvm.loop !11
...
clause_LiteralGetIndex.exit:                      ; preds = %while.cond.i
  ...
  br i1 %cmp.i271.not, label %for.end71, label %for.body66, !llvm.loop !22
...
while.body.i:                                     ; preds = %if.else79, %while.body.i
  ...
  br i1 %cmp.i.not.i278, label %if.end80, label %while.body.i, !llvm.loop !7
...
if.end84:                                         ; preds = %if.then83, %if.end80
  ...
  br i1 %cmp.i263.not, label %cleanup, label %while.body32, !llvm.loop !23
...
while.cond.i.i:                                   ; preds = %while.cond.i.i, %if.then105
  ...
  %indvars.iv.next.i.i = add nuw i64 %indvars.iv.i.i, 1
  br i1 %cmp.not.i.i, label %clause_LiteralGetIndex.exit.i, label %while.cond.i.i, !llvm.loop !11
...
while.cond.i40.i:                                 ; preds = %while.cond.i40.i, %land.lhs.true13.i
  ...
  br i1 %cmp.not.i38.i, label %clause_LiteralGetIndex.exit41.i, label %while.cond.i40.i, !llvm.loop !11
...
for.inc.i:                                        ; preds = %if.then.i302, %clause_LiteralGetIndex.exit41.i, %lor.rhs.i.i, %land.lhs.true.i.i, %for.body.i
  ...
  br i1 %cmp.i.not.i303, label %for.end.i, label %for.body.i, !llvm.loop !24
...
for.end.i:                                        ; preds = %for.inc.i, %while.body.i297
  ...
  br i1 %tobool.not.i304, label %red_GetBackMRResLits.exit, label %while.body.i297, !llvm.loop !25
...
while.cond.i313:                                  ; preds = %while.cond.i313, %for.body111
  ...
  br i1 %cmp.not.i311, label %clause_LiteralGetIndex.exit314, label %while.cond.i313, !llvm.loop !11
...
if.end.i:                                         ; preds = %while.body.i316
  ...
  br i1 %cmp.i.not.i317, label %if.else123, label %while.body.i316, !llvm.loop !12
...
for.body11.preheader.i.i.i:                       ; preds = %for.cond8.preheader.i.i.i
  ...
  %uglygep.i.i.i = getelementptr i8, ptr %call.i.i.i, i64 %85
  %86 = xor i32 %.lcssa.i.i.i, -1
  %87 = add i32 %82, %86
  %88 = zext i32 %87 to i64
  %89 = shl nuw nsw i64 %88, 3
  %90 = add nuw nsw i64 %89, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %uglygep.i.i.i, i8 0, i64 %90, i1 false)
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i
  ...
  br i1 %cmp3.i.i.i, label %for.body.i.i.i, label %for.cond8.preheader.i.i.i, !llvm.loop !26
...
if.then.i.i.i.i:                                  ; preds = %if.then20.i.i.i
  ...
  %add.ptr.i.i.i.i413 = getelementptr i8, ptr %95, i64 -16
  %add.ptr1.i.i.i.i = getelementptr i8, ptr %add.ptr.i.i.i.i413, i64 %idx.neg.i.i.i.i
  %98 = load ptr, ptr %add.ptr1.i.i.i.i, align 8
  %cmp2.not.i.i.i.i = icmp eq ptr %98, null
  %next6.i.i.i.i = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %add.ptr1.i.i.i.i, i64 0, i32 1
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  br i1 %cmp4.i.i, label %for.body.i.i, label %clause_UpdateSplitDataFromPartner.exit, !llvm.loop !27
...
for.body.i347:                                    ; preds = %if.then127, %for.body.i347
  ...
  br i1 %cmp.i.not.i346, label %for.end.i349, label %for.body.i347, !llvm.loop !28
...
while.body.i.i:                                   ; preds = %for.end.i349, %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i353, label %list_Delete.exit.i, label %while.body.i.i, !llvm.loop !7
...
while.body.i28.i:                                 ; preds = %list_Delete.exit.i, %while.body.i28.i
  ...
  br i1 %cmp.i.not.i27.i, label %for.cond.i.i.preheader, label %while.body.i28.i, !llvm.loop !7
...
for.cond.i37.i:                                   ; preds = %for.end.i.i, %for.cond.i37.i
  ...
  br i1 %cmp.i20.not.i36.i, label %red_DocumentMatchingReplacementResolution.exit, label %for.cond.i37.i, !llvm.loop !9
...
if.end141:                                        ; preds = %if.then137, %if.end134
  ...
  br i1 %cmp.i305.not, label %for.end145, label %for.body111, !llvm.loop !29
...
while.body.i367:                                  ; preds = %for.end145, %while.body.i367
  ...
  br i1 %cmp.i.not.i366, label %for.inc147, label %while.body.i367, !llvm.loop !7
...
for.inc147:                                       ; preds = %while.body.i367, %clause_LiteralAtom.exit.i, %red_GetBackMRResLits.exit, %for.end145, %clause_LiteralAtom.exit294
  ...
  br i1 %exitcond.not, label %cleanup, label %for.body100, !llvm.loop !30
...
if.end.i.i:                                       ; preds = %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %land.lhs.true25.i, label %while.body.i.i, !llvm.loop !12
...
while.body.i.i.i.i:                               ; preds = %if.then.i66.i, %while.body.i.i.i.i
  ...
  br i1 %cmp.i.not.i.i.i.i, label %list_Delete.exit.i.i.i, label %while.body.i.i.i.i, !llvm.loop !7
...
while.body.i24.i.i.i:                             ; preds = %list_Delete.exit.i.i.i, %while.body.i24.i.i.i
  ...
  br i1 %cmp.i.not.i23.i.i.i, label %red_DocumentRewriting.exit.i.i, label %while.body.i24.i.i.i, !llvm.loop !7
...
for.body11.preheader.i.i.i:                       ; preds = %for.cond8.preheader.i.i.i
  ...
  %uglygep.i.i.i = getelementptr i8, ptr %call.i.i.i, i64 %63
  %64 = xor i32 %.lcssa.i.i.i, -1
  %65 = add i32 %60, %64
  %66 = zext i32 %65 to i64
  %67 = shl nuw nsw i64 %66, 3
  %68 = add nuw nsw i64 %67, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %uglygep.i.i.i, i8 0, i64 %68, i1 false)
  br label %for.end16.i.i.i
...
if.then.i.i.i.i:                                  ; preds = %if.then20.i.i.i
  ...
  %idx.neg.i.i.i.i = sub nsw i64 0, %idx.ext.i.i.i.i
  %add.ptr.i.i.i.i42 = getelementptr i8, ptr %73, i64 -16
  %add.ptr1.i.i.i.i = getelementptr i8, ptr %add.ptr.i.i.i.i42, i64 %idx.neg.i.i.i.i
...
if.end.i:                                         ; preds = %while.body.i.i, %red_ApplyRewriting.exit.i, %land.lhs.true25.i, %land.lhs.true19.i, %clause_LiteralGetIndex.exit.i
  ...
  br i1 %cmp.i60.not.i, label %if.end33.i, label %for.body.i, !llvm.loop !31
...
if.end33.i:                                       ; preds = %if.end.i, %if.then.i, %symbol_IsPredicate.exit.i, %while.body.i
  ...
  br i1 %tobool.not.i, label %red_LiteralRewriting.exit, label %while.body.i, !llvm.loop !32
...
for.inc.i:                                        ; preds = %if.else.i, %land.lhs.true.i, %lor.lhs.false.i, %for.body.i
  ...
  br i1 %exitcond.not.i, label %if.then.loopexit, label %for.body.i, !llvm.loop !34
...
while.cond.i.i45:                                 ; preds = %while.cond.i.i45, %for.body25.i
  ...
  br i1 %cmp.not.i.i43, label %clause_LiteralGetIndex.exit.i46, label %while.cond.i.i45, !llvm.loop !11
...
if.end.i.i:                                       ; preds = %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i47, label %land.lhs.true37.i, label %while.body.i.i, !llvm.loop !12

land.lhs.true37.i:                                ; preds = %if.end.i.i, %land.lhs.true34.i
  %call38.i = call fastcc i32 @red_CRwTautologyCheck(ptr noundef %Search, ptr noundef nonnull %L.val.i.i39, i32 noundef %45, ptr noundef nonnull %Inst.0.val.i, ptr noundef nonnull %RuleClause, i32 noundef %39, i32 noundef %Mode, ptr noundef nonnull %HelpClause.i)
  %tobool39.not.i = icmp eq i32 %call38.i, 0
...
while.body.i153.i:                                ; preds = %while.body.i153.i.prol.loopexit, %while.body.i153.i
  ...
  br i1 %cmp.i152.i.1, label %while.body.i153.i, label %while.end.i.i, !llvm.loop !35
...
while.body.i.i.i:                                 ; preds = %if.end67.i, %while.body.i.i.i
  ...
  br i1 %cmp.i.not.i.i162.i, label %list_Delete.exit.i.i, label %while.body.i.i.i, !llvm.loop !7
...
while.body.i23.i.i:                               ; preds = %list_Delete.exit.i.i, %while.body.i23.i.i
  ...
  br i1 %cmp.i.not.i22.i.i, label %red_DocumentContextualRewriting.exit.i, label %while.body.i23.i.i, !llvm.loop !7
...
for.body11.preheader.i.i.i90:                     ; preds = %for.cond8.preheader.i.i.i88
  ...
  %uglygep.i.i.i89 = getelementptr i8, ptr %call.i.i.i81, i64 %105
  %106 = xor i32 %.lcssa.i.i.i86, -1
  %107 = add i32 %102, %106
  %108 = zext i32 %107 to i64
  %109 = shl nuw nsw i64 %108, 3
  %110 = add nuw nsw i64 %109, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %uglygep.i.i.i89, i8 0, i64 %110, i1 false)
...
for.body.i.i.i96:                                 ; preds = %for.body.i.i.i96, %for.body.lr.ph.i.i.i85
  ...
  br i1 %cmp3.i.i.i95, label %for.body.i.i.i96, label %for.cond8.preheader.i.i.i88, !llvm.loop !26
...
if.then.i.i.i.i117:                               ; preds = %if.then20.i.i.i102
  ...
  %add.ptr.i.i.i.i110167 = getelementptr i8, ptr %115, i64 -16
  %add.ptr1.i.i.i.i111 = getelementptr i8, ptr %add.ptr.i.i.i.i110167, i64 %idx.neg.i.i.i.i109
  %118 = load ptr, ptr %add.ptr1.i.i.i.i111, align 8
  %cmp2.not.i.i.i.i112 = icmp eq ptr %118, null
  %next6.i.i.i.i113 = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %add.ptr1.i.i.i.i111, i64 0, i32 1
...
for.body.i.i148:                                  ; preds = %for.body.i.i148, %for.body.lr.ph.i.i141
  ...
  br i1 %cmp4.i.i147, label %for.body.i.i148, label %clause_UpdateSplitDataFromPartner.exit149, !llvm.loop !27
...
for.body11.preheader.i.i.i:                       ; preds = %for.cond8.preheader.i.i.i
  ...
  %uglygep.i.i.i = getelementptr i8, ptr %call.i.i.i, i64 %146
  %147 = xor i32 %.lcssa.i.i.i, -1
  %148 = add i32 %143, %147
  %149 = zext i32 %148 to i64
  %150 = shl nuw nsw i64 %149, 3
  %151 = add nuw nsw i64 %150, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %uglygep.i.i.i, i8 0, i64 %151, i1 false)
  br label %for.end16.i.i.i
...
if.then.i.i.i.i:                                  ; preds = %if.then20.i.i.i
  ...
  %idx.neg.i.i.i.i = sub nsw i64 0, %idx.ext.i.i.i.i
  %add.ptr.i.i.i.i166 = getelementptr i8, ptr %156, i64 -16
  %add.ptr1.i.i.i.i = getelementptr i8, ptr %add.ptr.i.i.i.i166, i64 %idx.neg.i.i.i.i
...
if.end80.i:                                       ; preds = %while.body.i.i, %if.end78.i, %land.lhs.true37.i, %land.lhs.true31.i, %clause_LiteralGetIndex.exit.i46
  ...
  br i1 %cmp.i143.not.i, label %for.inc83.i, label %for.body25.i, !llvm.loop !36
...
for.inc83.i:                                      ; preds = %if.end80.i, %if.then19.i, %symbol_IsPredicate.exit.i, %for.body.i37
  ...
  br i1 %cmp.i.not.i51, label %for.end, label %for.body.i37, !llvm.loop !37
...
if.end28:                                         ; preds = %if.then26, %if.then23
  ...
  %or.cond110 = select i1 %cmp29, i1 true, i1 %cmp30
...
for.body:                                         ; preds = %if.else, %for.body
  ...
  br i1 %cmp.i125.not, label %if.end64, label %for.body, !llvm.loop !39
...
if.end69:                                         ; preds = %if.then31, %if.end28, %if.end34, %if.then51, %if.end64, %if.end41
  ...
  br i1 %cmp.i.not, label %while.end.loopexit, label %while.body, !llvm.loop !40
...
while.body.i:                                     ; preds = %for.end, %while.body.i
  ...
  br i1 %cmp.i.not.i192, label %list_Delete.exit, label %while.body.i, !llvm.loop !7
...
for.body67:                                       ; preds = %for.cond60.preheader, %if.end84
  ...
  %call1.i = call fastcc i32 @red_SortSimplification(ptr noundef nonnull %Theory, ptr noundef %Scan.1.val, i32 noundef -1, i32 noundef 0, ptr noundef nonnull %Flags, ptr noundef %Precedence, ptr noundef nonnull %Copy.i)
...
for.inc.i.i.i:                                    ; preds = %land.lhs.true.i.i.i, %for.body8.i.i.i
  ...
  br i1 %cmp.i.not.i.i.i, label %for.end.i.i.i, label %for.body8.i.i.i, !llvm.loop !42
...
for.end.i.i.i:                                    ; preds = %for.inc.i.i.i, %while.body.i.i.i
  ...
  br i1 %tobool.not.i.i.i, label %for.inc20.i.i.i, label %while.body.i.i.i, !llvm.loop !43

for.inc20.i.i.i:                                  ; preds = %for.end.i.i.i, %clause_GetLiteralAtom.exit.i.i.i
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1
  %exitcond.not.i.i.i = icmp eq i64 %indvars.iv.next.i.i.i, %wide.trip.count.i.i.i
  br i1 %exitcond.not.i.i.i, label %if.else.i216, label %for.body.i.i.i, !llvm.loop !44
...
while.cond.i.i.i:                                 ; preds = %while.cond.i.i.i, %land.lhs.true.i34.i
  ...
  br i1 %cmp.not.i81.i.i, label %clause_LiteralGetIndex.exit.i.i, label %while.cond.i.i.i, !llvm.loop !11
...
if.end.i.i.i:                                     ; preds = %while.body.i.i37.i
  ...
  br i1 %cmp.i.not.i83.i.i, label %if.then20.i.i, label %while.body.i.i37.i, !llvm.loop !12
...
for.inc.i.i:                                      ; preds = %while.body.i.i37.i, %if.then20.i.i, %clause_LiteralGetIndex.exit.i.i, %for.body.i.i
  ...
  br i1 %cmp.i.not.i38.i, label %for.end.i.i, label %for.body.i.i, !llvm.loop !45
...
for.end.i.i:                                      ; preds = %for.inc.i.i, %while.body.i.i
  ...
  br i1 %tobool6.not.i.i, label %for.cond24.preheader.i.i, label %while.body.i.i, !llvm.loop !46
...
if.end39.i.i:                                     ; preds = %if.then35.i.i, %land.lhs.true32.i.i, %for.body28.i.i
  ...
  br i1 %cmp.i84.not.i.i, label %while.body.i90.i.i, label %for.body28.i.i, !llvm.loop !47
...
while.body.i90.i.i:                               ; preds = %if.end39.i.i, %while.body.i90.i.i
  ...
  br i1 %cmp.i.not.i89.i.i, label %red_CDBackSubsumption.exit.i, label %while.body.i90.i.i, !llvm.loop !7
...
if.then76:                                        ; preds = %if.else72
  ...
  %call.i221 = call i32 @_IO_putc(i32 noundef 10, ptr noundef %81)
  call void @clause_Print(ptr noundef %Scan.1.val) #11
  br label %if.end78
...
if.end84:                                         ; preds = %if.end78, %land.lhs.true.i, %land.lhs.true1.i, %clause_IsEmptyClause.exit, %if.then81, %if.then71
  ...
  br i1 %or.cond262, label %for.body67, label %for.end87, !llvm.loop !48
...
while.body.i236:                                  ; preds = %for.end87, %while.body.i236
  ...
  br i1 %cmp.i.not.i235, label %if.end101thread-pre-split, label %while.body.i236, !llvm.loop !7
...
if.end101:                                        ; preds = %if.end101thread-pre-split, %for.cond60.preheader
  ...
  br i1 %or.cond, label %while.body, label %while.end, !llvm.loop !49
...
for.body:                                         ; preds = %list_Nconc.exit, %for.body
  ...
  br i1 %cmp.i77.not, label %for.end, label %for.body, !llvm.loop !50
...
for.cond.i85:                                     ; preds = %for.end, %for.cond.i85
  ...
  br i1 %cmp.i20.not.i84, label %for.end.i86, label %for.cond.i85, !llvm.loop !9
...
if.end35:                                         ; preds = %for.end, %for.end.thread, %for.end.i86, %if.then13, %while.body
  ...
  br i1 %or.cond.not, label %for.cond36.preheader, label %while.body, !llvm.loop !51
...
for.body40:                                       ; preds = %for.cond36.preheader, %for.body40
  ...
  br i1 %cmp.i89.not, label %for.end44, label %for.body40, !llvm.loop !52
...
while.body.i:                                     ; preds = %for.end44, %while.body.i
  ...
  br i1 %cmp.i.not.i94, label %list_Delete.exit, label %while.body.i, !llvm.loop !7
...
for.inc.i:                                        ; preds = %if.then.i, %clause_LiteralAtom.exit.i
  ...
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %for.end.loopexit.i, label %for.body.i, !llvm.loop !53
...
for.inc21.i:                                      ; preds = %if.then17.i, %clause_LiteralAtom.exit58.i
  ...
  br i1 %exitcond75.not.i, label %for.end23.i, label %for.body12.i, !llvm.loop !54
...
while.body.i.i:                                   ; preds = %for.end23.i, %while.body.i.i
  ...
  br i1 %cmp.i.not.i63.i, label %red_SpecialInputReductions.exit, label %while.body.i.i, !llvm.loop !7
...
if.end27:                                         ; preds = %if.then20, %if.else, %red_SpecialInputReductions.exit
  ...
  br i1 %or.cond.not, label %while.end, label %land.rhs, !llvm.loop !55
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  br i1 %cmp.i59.not, label %for.end, label %for.body, !llvm.loop !56
...
while.body.i:                                     ; preds = %for.end, %while.body.i
  ...
  br i1 %cmp.i.not.i64, label %list_Delete.exit, label %while.body.i, !llvm.loop !7
...
if.end:                                           ; preds = %for.end.i, %if.end.i, %if.then, %while.body
  ...
  br i1 %or.cond, label %land.rhs, label %while.end, !llvm.loop !57
...
while.body.i:                                     ; preds = %while.end, %while.body.i
  ...
  br i1 %cmp.i.not.i116, label %list_Delete.exit, label %while.body.i, !llvm.loop !7
...
for.cond.i134:                                    ; preds = %if.end.i130, %for.cond.i134
  ...
  br i1 %cmp.i20.not.i133, label %for.end.i135, label %for.cond.i134, !llvm.loop !9
...
if.end59:                                         ; preds = %for.end.i135, %if.end.i130, %if.then53, %land.lhs.true50, %while.body46
  ...
  br i1 %or.cond65, label %land.rhs34, label %while.end61, !llvm.loop !58
...
while.body.i147:                                  ; preds = %while.end61, %while.body.i147
  ...
  br i1 %cmp.i.not.i146, label %if.end64, label %while.body.i147, !llvm.loop !7
...
for.cond.loopexit:                                ; preds = %for.inc, %for.body
  ...
  br i1 %cmp.i.not, label %for.end29, label %for.body, !llvm.loop !59
...
land.lhs.true18:                                  ; preds = %land.lhs.true
  ...
  %call20 = tail call i32 @red_ClauseDeletion(ptr noundef %Search.val53, ptr noundef %Scan2.0.val, ptr noundef %Search.val, ptr noundef %Search.val47)
...
for.inc:                                          ; preds = %for.body10, %land.lhs.true, %land.lhs.true18
  ...
  br i1 %cmp.i55.not, label %for.cond.loopexit, label %for.body10, !llvm.loop !60
...
while.body.lr.ph:                                 ; preds = %clause_GetLiteralAtom.exit
  ...
  %or.cond = select i1 %cmp27.not, i1 true, i1 %cmp29.not
...
if.end44.us:                                      ; preds = %for.inc.us.us, %for.inc.us.us.us, %for.body15.lr.ph.split.us.us.split.us, %if.then.us, %while.body.us
  ...
  br i1 %tobool.not.us, label %while.end, label %while.body.us, !llvm.loop !61
...
while.cond.i.i.us.us.us:                          ; preds = %land.lhs.true.us.us.us, %while.cond.i.i.us.us.us
  ...
  br i1 %cmp.not.i.i.us.us.us, label %clause_LiteralIsFromConstraint.exit.us.us.us, label %while.cond.i.i.us.us.us, !llvm.loop !11
...
for.inc.us.us.us:                                 ; preds = %clause_LiteralIsFromConstraint.exit.us.us.us, %land.lhs.true38.us.us.us, %land.lhs.true.us.us.us, %for.body15.us.us.us
  ...
  br i1 %cmp.i.not.us.us.us, label %if.end44.us, label %for.body15.us.us.us, !llvm.loop !62
...
while.cond.i.i.us.us:                             ; preds = %land.lhs.true22.us.us, %while.cond.i.i.us.us
  ...
  br i1 %cmp.not.i.i.us.us, label %clause_LiteralIsFromConstraint.exit.us.us, label %while.cond.i.i.us.us, !llvm.loop !11
...
while.cond.i.i206.us.us:                          ; preds = %while.cond.i.i206.us.us.preheader, %while.cond.i.i206.us.us
  ...
  br i1 %cmp.not.i.i204.us.us, label %clause_LiteralIsFromAntecedent.exit.us.us, label %while.cond.i.i206.us.us, !llvm.loop !11
...
clause_LiteralIsFromAntecedent.exit.us.us:        ; preds = %while.cond.i.i206.us.us
  ...
  %narrow.i209.not.us.us = select i1 %cmp.not.i.us.us, i1 true, i1 %cmp4.i208.us.us
...
for.inc.us.us:                                    ; preds = %clause_LiteralIsFromAntecedent.exit.us.us, %land.lhs.true38.us.us, %land.lhs.true.us.us, %for.body15.us.us
  ...
  br i1 %cmp.i.not.us.us, label %if.end44.us, label %for.body15.us.us, !llvm.loop !62
...
while.cond.i.i206:                                ; preds = %lor.lhs.false, %while.cond.i.i206
  ...
  br i1 %cmp.not.i.i204, label %clause_LiteralIsFromAntecedent.exit, label %while.cond.i.i206, !llvm.loop !11
...
clause_LiteralIsFromAntecedent.exit:              ; preds = %while.cond.i.i206
  ...
  %narrow.i209.not = select i1 %cmp.not.i, i1 true, i1 %cmp4.i208
...
while.cond.i.i217:                                ; preds = %while.cond.i.i217.preheader, %while.cond.i.i217
  ...
  br i1 %cmp.not.i.i215, label %clause_LiteralIsFromSuccedent.exit, label %while.cond.i.i217, !llvm.loop !11
...
clause_LiteralIsFromSuccedent.exit:               ; preds = %while.cond.i.i217
  ...
  %narrow.i222.not = select i1 %cmp.not.i220, i1 true, i1 %cmp4.i221
...
for.inc:                                          ; preds = %for.body15, %land.lhs.true, %clause_LiteralIsFromSuccedent.exit, %land.lhs.true38
  ...
  br i1 %cmp.i.not, label %if.end44, label %for.body15, !llvm.loop !62
...
while.body62.lr.ph:                               ; preds = %if.then52
  ...
  %or.cond184 = select i1 %cmp85.not, i1 true, i1 %cmp87.not
...
while.cond.i.i236.us:                             ; preds = %land.lhs.true79.us, %while.cond.i.i236.us
  ...
  br i1 %cmp.not.i.i234.us, label %clause_LiteralIsFromConstraint.exit242.us, label %while.cond.i.i236.us, !llvm.loop !11
...
while.cond.i.i249.us:                             ; preds = %lor.lhs.false84.us, %while.cond.i.i249.us
  ...
  br i1 %cmp.not.i.i247.us, label %clause_LiteralIsFromAntecedent.exit258.us, label %while.cond.i.i249.us, !llvm.loop !11
...
clause_LiteralIsFromAntecedent.exit258.us:        ; preds = %while.cond.i.i249.us
  ...
  %narrow.i256.not.us = select i1 %cmp.not.i254.us, i1 true, i1 %cmp4.i255.us
...
for.inc103.us:                                    ; preds = %lor.lhs.false84.us, %clause_LiteralIsFromAntecedent.exit258.us, %land.lhs.true96.us, %land.lhs.true75.us, %for.body71.us
  ...
  br i1 %cmp.i228.not.us, label %if.end106, label %for.body71.us, !llvm.loop !63
...
while.cond.i.i236:                                ; preds = %land.lhs.true79, %while.cond.i.i236
  ...
  br i1 %cmp.not.i.i234, label %clause_LiteralIsFromConstraint.exit242, label %while.cond.i.i236, !llvm.loop !11
...
while.cond.i.i249:                                ; preds = %lor.lhs.false84, %while.cond.i.i249
  ...
  br i1 %cmp.not.i.i247, label %clause_LiteralIsFromAntecedent.exit258, label %while.cond.i.i249, !llvm.loop !11
...
clause_LiteralIsFromAntecedent.exit258:           ; preds = %while.cond.i.i249
  ...
  %narrow.i256.not = select i1 %cmp.not.i254, i1 true, i1 %cmp4.i255
...
while.cond.i.i265:                                ; preds = %while.cond.i.i265.preheader, %while.cond.i.i265
  ...
  br i1 %cmp.not.i.i263, label %clause_LiteralIsFromSuccedent.exit276, label %while.cond.i.i265, !llvm.loop !11
...
clause_LiteralIsFromSuccedent.exit276:            ; preds = %while.cond.i.i265
  ...
  %narrow.i274.not = select i1 %cmp.not.i272, i1 true, i1 %cmp4.i273
...
for.inc103:                                       ; preds = %for.body71, %land.lhs.true75, %clause_LiteralIsFromSuccedent.exit276, %land.lhs.true96
  ...
  br i1 %cmp.i228.not, label %if.end106, label %for.body71, !llvm.loop !63
...
if.end106:                                        ; preds = %for.inc103, %for.inc103.us, %if.then65, %while.body62
  ...
  br i1 %tobool61.not, label %while.end108, label %while.body62, !llvm.loop !64
...
while.body.i284:                                  ; preds = %while.end108, %while.body.i284
  ...
  br i1 %cmp.i.not.i283, label %list_Delete.exit285, label %while.body.i284, !llvm.loop !7
...
for.body.lr.ph.i:                                 ; preds = %land.lhs.true
  ...
  br i1 %cmp178.i, label %for.body.preheader.i, label %for.body.us.preheader.i
...
for.body.us.i:                                    ; preds = %if.end.us.i, %for.body.us.preheader.i
  %12 = phi i32 [ %.pre25.i, %for.body.us.preheader.i ], [ %22, %if.end.us.i ]
  %indvars.iv.i = phi i64 [ %7, %for.body.us.preheader.i ], [ %indvars.iv.next.i, %if.end.us.i ]
  %Clause.val82.us.i = load ptr, ptr %6, align 8
  %arrayidx.i.us.i = getelementptr inbounds ptr, ptr %Clause.val82.us.i, i64 %indvars.iv.i
  ...
  %cmp.i.not.i.us.i = icmp eq i32 %12, %L.val7.val.i.us.i
...
clause_LiteralAtom.exit.us.i:                     ; preds = %if.then.i.us.i, %for.body.us.i
  ...
  br i1 %cmp.i.not.us.i, label %land.lhs.true.us.i, label %if.end.us.i
...
if.end.us.i:                                      ; preds = %land.lhs.true10.us.i, %land.lhs.true.us.i, %clause_LiteralAtom.exit.us.i
  ...
  br i1 %23, label %for.body.us.i, label %for.end31.i, !llvm.loop !66

for.body.i:                                       ; preds = %for.inc29.i, %for.body.preheader.i
  %indvars.iv22.i = phi i64 [ %10, %for.body.preheader.i ], [ %indvars.iv.next23.i, %for.inc29.i ]
  %Clause.val82.i = load ptr, ptr %6, align 8
  %arrayidx.i.i = getelementptr inbounds ptr, ptr %Clause.val82.i, i64 %indvars.iv22.i
...
clause_LiteralAtom.exit.i:                        ; preds = %if.then.i.i, %for.body.i
  ...
  %cmp.i.not.i = icmp eq i32 %29, %call4.val83.i
  br i1 %cmp.i.not.i, label %land.lhs.true.i, label %for.body22.i.preheader
...
if.end.i:                                         ; preds = %land.lhs.true.i
  ...
  %33 = getelementptr i8, ptr %call4.val84.val.i, i64 8
  %call4.val84.val.val.i = load ptr, ptr %33, align 8
...
for.body22.i:                                     ; preds = %for.body22.i.preheader, %clause_LiteralAtom.exit96.i
  %indvars.iv19.i = phi i64 [ %indvars.iv.next20.i, %clause_LiteralAtom.exit96.i ], [ 0, %for.body22.i.preheader ]
  %Clause.val80.i = load ptr, ptr %6, align 8
  %arrayidx.i89.i = getelementptr inbounds ptr, ptr %Clause.val80.i, i64 %indvars.iv19.i
  %34 = load ptr, ptr %arrayidx.i89.i, align 8
  %35 = getelementptr i8, ptr %34, i64 24
  %call23.val.i = load ptr, ptr %35, align 8
  %L.val7.val.i90.i = load i32, ptr %call23.val.i, align 8
  %36 = load i32, ptr @fol_NOT, align 4
  %cmp.i.not.i91.i = icmp eq i32 %36, %L.val7.val.i90.i
  br i1 %cmp.i.not.i91.i, label %if.then.i94.i, label %clause_LiteralAtom.exit96.i

if.then.i94.i:                                    ; preds = %for.body22.i
  %37 = getelementptr i8, ptr %call23.val.i, i64 16
  %call1.val.i92.i = load ptr, ptr %37, align 8
  %38 = getelementptr i8, ptr %call1.val.i92.i, i64 8
  %call1.val.val.i93.i = load ptr, ptr %38, align 8
  br label %clause_LiteralAtom.exit96.i

clause_LiteralAtom.exit96.i:                      ; preds = %if.then.i94.i, %for.body22.i
  %retval.0.i95.i = phi ptr [ %call1.val.val.i93.i, %if.then.i94.i ], [ %call23.val.i, %for.body22.i ]
  %call25.i = tail call i32 @term_Equal(ptr noundef nonnull %retval.0.i.i, ptr noundef %retval.0.i95.i) #11
  %tobool26.not.i = icmp eq i32 %call25.i, 0
  %indvars.iv.next20.i = add nuw nsw i64 %indvars.iv19.i, 1
  %cmp17.i = icmp ult i64 %indvars.iv19.i, %9
  %39 = select i1 %cmp17.i, i1 %tobool26.not.i, i1 false
  br i1 %39, label %for.body22.i, label %for.inc29.i, !llvm.loop !67

for.inc29.i:                                      ; preds = %clause_LiteralAtom.exit96.i
  %indvars.iv.next23.i = add nsw i64 %indvars.iv22.i, 1
  %cmp.i = icmp slt i64 %indvars.iv.next23.i, %11
  %40 = select i1 %cmp.i, i1 %tobool26.not.i, i1 false
  br i1 %40, label %for.body.i, label %for.end31.i, !llvm.loop !66
...
for.inc:                                          ; preds = %clause_LiteralIsEquality.exit.thread, %clause_LiteralIsEquality.exit, %if.then23, %land.lhs.true19, %lor.lhs.false
  ...
  br i1 %cmp.not, label %if.end69, label %for.body, !llvm.loop !68
...
for.inc65:                                        ; preds = %clause_LiteralIsEquality.exit195.thread, %clause_LiteralIsEquality.exit195, %if.then60, %land.lhs.true55, %lor.lhs.false52
  ...
  br i1 %cmp34.not, label %if.end69, label %for.body36, !llvm.loop !69
...
while.body.i.i:                                   ; preds = %if.then81, %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i224, label %list_Delete.exit.i, label %while.body.i.i, !llvm.loop !7
...
while.body.i24.i:                                 ; preds = %list_Delete.exit.i, %while.body.i24.i
  ...
  br i1 %cmp.i.not.i23.i, label %list_Delete.exit25.i, label %while.body.i24.i, !llvm.loop !7
...
while.cond.loopexit.i:                            ; preds = %if.end144.i
  %tobool14.not.i = icmp eq i32 %Rewritten.2.lcssa463.i, 0
  br i1 %tobool14.not.i, label %while.end146.i, label %while.body.i, !llvm.loop !70

while.body.i:                                     ; preds = %while.cond.loopexit.i, %if.end13.i
  %RedAtom.0377.i = phi ptr [ %retval.0.i.i.i, %if.end13.i ], [ %RedAtom.2.lcssa464.i, %while.cond.loopexit.i ]
  %Copy.0376.i = phi ptr [ %RedClause, %if.end13.i ], [ %Copy.2.lcssa462.i, %while.cond.loopexit.i ]
  %Result.0375.i = phi i32 [ 0, %if.end13.i ], [ %Result.2.lcssa461.i, %while.cond.loopexit.i ]
  %Renamed.0374.i = phi i32 [ 0, %if.end13.i ], [ %Renamed.2.lcssa460.i, %while.cond.loopexit.i ]
...
while.body20.i:                                   ; preds = %while.body.i, %if.end144.i
  ...
  %RedAtom.1368.i = phi ptr [ %RedAtom.2.lcssa464.i, %if.end144.i ], [ %RedAtom.0377.i, %while.body.i ]
  %Rewritten.1367.i = phi i32 [ %Rewritten.2.lcssa463.i, %if.end144.i ], [ 0, %while.body.i ]
  %Copy.1366.i = phi ptr [ %Copy.2.lcssa462.i, %if.end144.i ], [ %Copy.0376.i, %while.body.i ]
  %Result.1365.i = phi i32 [ %Result.2.lcssa461.i, %if.end144.i ], [ %Result.0375.i, %while.body.i ]
  %Renamed.1364.i = phi i32 [ %Renamed.2.lcssa460.i, %if.end144.i ], [ %Renamed.0374.i, %while.body.i ]
...
while.body29.i:                                   ; preds = %while.body20.i, %if.then139.i
  ...
  %Renamed.2352.i = phi i32 [ %Renamed.3.lcssa424.i, %if.then139.i ], [ %Renamed.1364.i, %while.body20.i ]
...
if.then96.i:                                      ; preds = %if.end94.thread.i, %if.end94.i
  ...
  %Copy.5317.i = phi ptr [ %Copy.1366.i, %if.end94.thread.i ], [ %Copy.5.i, %if.end94.i ]
...
while.body.i.i.i:                                 ; preds = %if.then107.i, %while.body.i.i.i
  ...
  br i1 %cmp.i.not.i.i286.i, label %list_Delete.exit.i.i, label %while.body.i.i.i, !llvm.loop !7
...
while.body.i24.i.i:                               ; preds = %list_Delete.exit.i.i, %while.body.i24.i.i
  ...
  br i1 %cmp.i.not.i23.i.i, label %red_DocumentRewriting.exit.i, label %while.body.i24.i.i, !llvm.loop !7
...
if.end114.i:                                      ; preds = %if.else110.i, %red_DocumentRewriting.exit.i, %if.end103.thread.i, %if.end103.i, %if.end94.thread.i
  ...
  %Copy.5315.i = phi ptr [ %Copy.5.i, %if.end103.thread.i ], [ %Copy.5317.i, %red_DocumentRewriting.exit.i ], [ %Copy.5.i, %if.else110.i ], [ %Copy.5317.i, %if.end103.i ], [ %Copy.1366.i, %if.end94.thread.i ]
...
for.body11.preheader.i.i.i.i:                     ; preds = %for.cond8.preheader.i.i.i.i
  ...
  %uglygep.i.i.i.i = getelementptr i8, ptr %call.i.i.i295.i, i64 %94
  %95 = xor i32 %.lcssa.i.i.i.i, -1
  %96 = add i32 %91, %95
  %97 = zext i32 %96 to i64
  %98 = shl nuw nsw i64 %97, 3
  %99 = add nuw nsw i64 %98, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %uglygep.i.i.i.i, i8 0, i64 %99, i1 false)
...
for.body.i.i.i.i:                                 ; preds = %for.body.i.i.i.i, %for.body.lr.ph.i.i.i.i
  ...
  br i1 %cmp3.i.i.i.i, label %for.body.i.i.i.i, label %for.cond8.preheader.i.i.i.i, !llvm.loop !26
...
if.then.i.i.i.i.i:                                ; preds = %if.then20.i.i.i.i
  ...
  %add.ptr.i.i.i.i380.i = getelementptr i8, ptr %104, i64 -16
  %add.ptr1.i.i.i.i.i = getelementptr i8, ptr %add.ptr.i.i.i.i380.i, i64 %idx.neg.i.i.i.i.i
  %107 = load ptr, ptr %add.ptr1.i.i.i.i.i, align 8
  %cmp2.not.i.i.i.i.i = icmp eq ptr %107, null
  %next6.i.i.i.i.i = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %add.ptr1.i.i.i.i.i, i64 0, i32 1
...
if.end23.i.i.i.i.i:                               ; preds = %if.then18.i.i.i.i.i, %if.end13.i.i.i.i.i
  tail call void @free(ptr noundef nonnull %add.ptr.i.i.i.i380.i) #11
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i
  ...
  br i1 %cmp4.i.i.i, label %for.body.i.i.i, label %clause_UpdateSplitDataFromPartner.exit.i, !llvm.loop !27
...
for.inc.i:                                        ; preds = %if.end79.i, %land.lhs.true.i, %for.body55.i
  ...
  br i1 %cmp.i273.not.i, label %for.inc135.i, label %for.body55.i, !llvm.loop !71
...
for.inc135.i:                                     ; preds = %for.inc.i, %if.end46.i, %for.body.i
  ...
  br i1 %cmp.i269.not.i, label %if.then139.i, label %for.body.i, !llvm.loop !72

if.then139.i:                                     ; preds = %for.inc135.i, %while.body29.i
  %Renamed.3.lcssa424.i = phi i32 [ %Renamed.2352.i, %while.body29.i ], [ %Renamed.7.i, %for.inc135.i ]
  %call140.i = tail call ptr @st_NextCandidate() #11
  %tobool26.not.i = icmp eq ptr %call140.i, null
  br i1 %tobool26.not.i, label %while.end.i.thread, label %while.body29.i, !llvm.loop !73
...
if.then143.i:                                     ; preds = %while.end.i.thread, %while.end.i
  %Renamed.2.lcssa.i301 = phi i32 [ %Renamed.3.lcssa424.i, %while.end.i.thread ], [ %Renamed.1364.i, %while.end.i ]
...
if.end144.i:                                      ; preds = %if.then143.i, %while.end.i, %while.end.thread.i
  %RedAtom.2.lcssa464.i = phi ptr [ %RedAtom.5319.i, %while.end.thread.i ], [ %RedAtom.1368.i, %if.then143.i ], [ %RedAtom.1368.i, %while.end.i ]
  %Rewritten.2.lcssa463.i = phi i32 [ 1, %while.end.thread.i ], [ 0, %if.then143.i ], [ %Rewritten.1367.i, %while.end.i ]
  %Copy.2.lcssa462.i = phi ptr [ %Copy.5315.i, %while.end.thread.i ], [ %Copy.1366.i, %if.then143.i ], [ %Copy.1366.i, %while.end.i ]
  %Result.2.lcssa461.i = phi i32 [ 1, %while.end.thread.i ], [ %Result.1365.i, %if.then143.i ], [ %Result.1365.i, %while.end.i ]
  %Renamed.2.lcssa460.i = phi i32 [ %Renamed.5.i, %while.end.thread.i ], [ %Renamed.2.lcssa.i301, %if.then143.i ], [ %Renamed.1364.i, %while.end.i ]
  %129 = load i32, ptr @stack_POINTER, align 4
  %cmp.i266.not.i = icmp eq i32 %129, %.pre.i
  br i1 %cmp.i266.not.i, label %while.cond.loopexit.i, label %while.body20.i, !llvm.loop !74

while.end146.i:                                   ; preds = %while.body.i, %while.cond.loopexit.i
  %Copy.1.lcssa389.i = phi ptr [ %Copy.2.lcssa462.i, %while.cond.loopexit.i ], [ %Copy.0376.i, %while.body.i ]
  %Result.1.lcssa388.i = phi i32 [ %Result.2.lcssa461.i, %while.cond.loopexit.i ], [ %Result.0375.i, %while.body.i ]
  %Renamed.1.lcssa387.i = phi i32 [ %Renamed.2.lcssa460.i, %while.cond.loopexit.i ], [ %Renamed.0374.i, %while.body.i ]
  %tobool147.not.i = icmp eq i32 %Result.1.lcssa388.i, 0
  br i1 %tobool147.not.i, label %if.else160.i, label %if.then148.i

if.then148.i:                                     ; preds = %while.end146.i
  tail call void @clause_OrientEqualities(ptr noundef %Copy.1.lcssa389.i, ptr noundef %Flags, ptr noundef %Precedence) #11
  tail call void @clause_Normalize(ptr noundef %Copy.1.lcssa389.i) #11
  tail call void @clause_SetMaxLitFlags(ptr noundef %Copy.1.lcssa389.i, ptr noundef %Flags, ptr noundef %Precedence) #11
  %call.i.i.i301.i = tail call i32 @clause_ComputeWeight(ptr noundef %Copy.1.lcssa389.i, ptr noundef %Flags) #11
  %weight.i.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.1.lcssa389.i, i64 0, i32 1
  store i32 %call.i.i.i301.i, ptr %weight.i.i.i.i, align 4
  tail call void @clause_UpdateMaxVar(ptr noundef %Copy.1.lcssa389.i) #11
  %cmp149.not.i = icmp eq ptr %Copy.1.lcssa389.i, %RedClause
...
if.then154.i:                                     ; preds = %if.end151.i
  ...
  tail call void @clause_Print(ptr noundef nonnull %Copy.1.lcssa389.i) #11
...
if.then158.i:                                     ; preds = %if.end156.i
  store ptr %Copy.1.lcssa389.i, ptr %Changed, align 8
  br label %cleanup

if.else160.i:                                     ; preds = %while.end146.i
  %tobool161.not.i = icmp eq i32 %Renamed.1.lcssa387.i, 0
...
if.then162.i:                                     ; preds = %if.else160.i
  ...
  tail call void @clause_Normalize(ptr noundef %Copy.1.lcssa389.i) #11
  tail call void @clause_SetMaxLitFlags(ptr noundef %Copy.1.lcssa389.i, ptr noundef %Flags, ptr noundef %Precedence) #11
  %call.i.i.i305.i = tail call i32 @clause_ComputeWeight(ptr noundef %Copy.1.lcssa389.i, ptr noundef %Flags) #11
  %weight.i.i.i306.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.1.lcssa389.i, i64 0, i32 1
...
clause_GetLiteralAtom.exit239:                    ; preds = %while.body, %if.then.i.i237
  ...
  br i1 %cmp.i240.not368, label %for.inc116, label %while.body16, !llvm.loop !75

while.body16:                                     ; preds = %clause_GetLiteralAtom.exit239, %while.end
  %151 = phi i32 [ %253, %while.end ], [ %150, %clause_GetLiteralAtom.exit239 ]
...
lor.lhs.false:                                    ; preds = %land.lhs.true66
  %170 = getelementptr i8, ptr %call53.val220, i64 12
  %call54.val222 = load i32, ptr %170, align 4
...
if.then72:                                        ; preds = %lor.lhs.false, %land.lhs.true66
  ...
  %171 = getelementptr i8, ptr %call73, i64 56
  %call73.val = load ptr, ptr %171, align 8
  %arrayidx.i.i255 = getelementptr inbounds ptr, ptr %call73.val, i64 %indvars.iv
  %172 = load ptr, ptr %arrayidx.i.i255, align 8
  %173 = getelementptr i8, ptr %172, i64 24
  %call.val.i256 = load ptr, ptr %173, align 8
  %L.val7.val.i.i257 = load i32, ptr %call.val.i256, align 8
  %174 = load i32, ptr @fol_NOT, align 4
  %cmp.i.not.i.i258 = icmp eq i32 %174, %L.val7.val.i.i257
  br i1 %cmp.i.not.i.i258, label %if.then.i.i261, label %if.end75

if.then.i.i261:                                   ; preds = %if.then72
  %175 = getelementptr i8, ptr %call.val.i256, i64 16
  %call1.val.i.i259 = load ptr, ptr %175, align 8
  %176 = getelementptr i8, ptr %call1.val.i.i259, i64 8
  %call1.val.val.i.i260 = load ptr, ptr %176, align 8
  br label %if.end75
...
if.then77:                                        ; preds = %if.end75.thread, %if.end75
  ...
  %Copy.6323 = phi ptr [ %Copy.2370, %if.end75.thread ], [ %Copy.6, %if.end75 ]
  %177 = load i32, ptr %arrayidx.i264, align 4
  %tobool79.not = icmp eq i32 %177, 0
  br i1 %tobool79.not, label %if.end84, label %if.then80

if.then80:                                        ; preds = %if.then77
  %178 = load ptr, ptr @stdout, align 8
  %179 = tail call i64 @fwrite(ptr nonnull @.str.27, i64 13, i64 1, ptr %178)
  tail call void @clause_Print(ptr noundef %Copy.6323) #11
  %180 = load ptr, ptr @stdout, align 8
  %181 = tail call i64 @fwrite(ptr nonnull @.str.28, i64 6, i64 1, ptr %180)
  br label %if.end84
...
if.then88:                                        ; preds = %if.end84
  %182 = getelementptr i8, ptr %Copy.6323, i64 32
  %Clause.val.i265 = load ptr, ptr %182, align 8
...
while.body.i.i:                                   ; preds = %if.then88, %while.body.i.i
  ...
  %total_size.i.i.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %183, i64 0, i32 4
  %184 = load i32, ptr %total_size.i.i.i.i, align 8
  %conv26.i.i.i.i = sext i32 %184 to i64
  %185 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i = add i64 %185, %conv26.i.i.i.i
  store i64 %add27.i.i.i.i, ptr @memory_FREEDBYTES, align 8
  %186 = load ptr, ptr %183, align 8
  store ptr %186, ptr %Current.06.i.i, align 8
  %187 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i, ptr %187, align 8
  %cmp.i.not.i.i266 = icmp eq ptr %Current.0.val.i.i, null
  br i1 %cmp.i.not.i.i266, label %list_Delete.exit.i, label %while.body.i.i, !llvm.loop !7

list_Delete.exit.i:                               ; preds = %while.body.i.i, %if.then88
  %188 = getelementptr i8, ptr %Copy.6323, i64 40
  %Clause.val15.i = load ptr, ptr %188, align 8
  %cmp.i.not5.i17.i = icmp eq ptr %Clause.val15.i, null
...
while.body.i24.i:                                 ; preds = %list_Delete.exit.i, %while.body.i24.i
  ...
  %total_size.i.i.i20.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %189, i64 0, i32 4
  %190 = load i32, ptr %total_size.i.i.i20.i, align 8
  %conv26.i.i.i21.i = sext i32 %190 to i64
  %191 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i22.i = add i64 %191, %conv26.i.i.i21.i
  store i64 %add27.i.i.i22.i, ptr @memory_FREEDBYTES, align 8
  %192 = load ptr, ptr %189, align 8
  store ptr %192, ptr %Current.06.i18.i, align 8
  %193 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i18.i, ptr %193, align 8
  %cmp.i.not.i23.i = icmp eq ptr %Current.0.val.i19.i, null
  br i1 %cmp.i.not.i23.i, label %red_DocumentRewriting.exit, label %while.body.i24.i, !llvm.loop !7
...
red_DocumentRewriting.exit:                       ; preds = %while.body.i24.i, %list_Delete.exit.i
  ...
  %194 = inttoptr i64 %conv.i267 to ptr
  %call.i.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i, i64 0, i32 1
  store ptr %194, ptr %car.i.i.i, align 8
  store ptr null, ptr %call.i.i.i, align 8
  store ptr %call.i.i.i, ptr %182, align 8
  ...
  store ptr %call.i.i26.i, ptr %188, align 8
  %195 = load i32, ptr @clause_CLAUSECOUNTER, align 4
  %inc.i.i.i = add nsw i32 %195, 1
  store i32 %inc.i.i.i, ptr @clause_CLAUSECOUNTER, align 4
  store i32 %195, ptr %Copy.6323, align 8
  ...
  %196 = inttoptr i64 %conv.i.i268 to ptr
  %197 = load ptr, ptr %182, align 8
  %call.i.i29.i = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i30.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i29.i, i64 0, i32 1
  store ptr %196, ptr %car.i.i30.i, align 8
  store ptr %197, ptr %call.i.i29.i, align 8
  store ptr %call.i.i29.i, ptr %182, align 8
  %sext332 = shl i64 %indvars.iv.i, 32
  %conv.i31.i = ashr exact i64 %sext332, 32
  %198 = inttoptr i64 %conv.i31.i to ptr
  ...
  store ptr %198, ptr %car.i.i34.i, align 8
  store ptr %199, ptr %call.i.i33.i, align 8
  store ptr %call.i.i33.i, ptr %188, align 8
  br label %if.end90

if.else:                                          ; preds = %if.end84.thread
  %200 = getelementptr i8, ptr %Copy.6, i64 32
  %Clause.val.i269 = load ptr, ptr %200, align 8
  %call.val.i270 = load ptr, ptr %Clause.val.i269, align 8
  %201 = getelementptr i8, ptr %call.val.i270, i64 8
  %call1.val.i271 = load ptr, ptr %201, align 8
  %202 = ptrtoint ptr %call1.val.i271 to i64
  %sext.i = shl i64 %202, 32
  %conv.i.i272 = ashr exact i64 %sext.i, 32
  %203 = inttoptr i64 %conv.i.i272 to ptr
  ...
  store ptr %204, ptr %call.i.i9.i, align 8
  ...
  %205 = inttoptr i64 %conv.i11.i to ptr
  ...
  store ptr %205, ptr %car.i.i14.i, align 8
  store ptr %206, ptr %call.i.i13.i, align 8
  store ptr %call.i.i13.i, ptr %200, align 8
  %sext = shl i64 %indvars.iv.i, 32
  %conv.i15.i = ashr exact i64 %sext, 32
  %207 = inttoptr i64 %conv.i15.i to ptr
  %208 = load ptr, ptr %parentLits.i.i, align 8
  ...
  store ptr %207, ptr %car.i.i18.i, align 8
  store ptr %208, ptr %call.i.i17.i, align 8
...
if.end90:                                         ; preds = %if.end75.thread, %if.end84.thread, %red_DocumentRewriting.exit, %if.else, %if.end84
  ...
  %Copy.6321 = phi ptr [ %Copy.6, %if.end84.thread ], [ %Copy.6323, %red_DocumentRewriting.exit ], [ %Copy.6, %if.else ], [ %Copy.6323, %if.end84 ], [ %Copy.2370, %if.end75.thread ]
  ...
  %210 = getelementptr i8, ptr %call38.val219.val, i64 8
  %call38.val219.val.val = load ptr, ptr %210, align 8
  %call93 = tail call ptr @term_Copy(ptr noundef %call38.val219.val.val) #11
  %call94 = tail call ptr @cont_ApplyBindingsModuloMatching(ptr noundef %209, ptr noundef %call93, i32 noundef 1) #11
  %call95 = tail call i32 @term_ReplaceSubtermBy(ptr noundef %RedAtom.4325, ptr noundef %152, ptr noundef %call94) #11
  %211 = getelementptr i8, ptr %call53.val220, i64 48
  %Partner.val20.i = load i32, ptr %211, align 8
  %212 = and i32 %Partner.val20.i, 8
  %tobool.not.i = icmp eq i32 %212, 0
...
if.then.i:                                        ; preds = %if.end90
  ...
  %213 = load i32, ptr %flags.i.i, align 8
  %or.i.i = or i32 %213, 8
  store i32 %or.i.i, ptr %flags.i.i, align 8
  br label %if.end.i277

if.end.i277:                                      ; preds = %if.then.i, %if.end90
  %214 = getelementptr i8, ptr %call53.val220, i64 12
  %Partner.val19.i = load i32, ptr %214, align 4
...
if.end3.i:                                        ; preds = %if.end.i277
  %215 = getelementptr i8, ptr %Copy.6321, i64 12
  %Result.val17.i = load i32, ptr %215, align 4
  %spec.select.i = tail call i32 @llvm.umax.i32(i32 %Partner.val19.i, i32 %Result.val17.i)
  store i32 %spec.select.i, ptr %215, align 4
  %splitfield_length.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6321, i64 0, i32 5
  %216 = load i32, ptr %splitfield_length.i.i, align 8
  %splitfield_length1.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call53.val220, i64 0, i32 5
  %217 = load i32, ptr %splitfield_length1.i.i, align 8
  %cmp.i21.i = icmp ult i32 %216, %217
  br i1 %cmp.i21.i, label %if.then.i.i.i279, label %if.end.i.i291

if.then.i.i.i279:                                 ; preds = %if.end3.i
  %mul.i.i.i = shl i32 %217, 3
  %call.i.i.i278 = tail call ptr @memory_Malloc(i32 noundef %mul.i.i.i) #11
  %218 = load i32, ptr %splitfield_length.i.i, align 8
  %cmp349.not.i.i.i = icmp eq i32 %218, 0
...
for.cond8.preheader.i.i.i:                        ; preds = %for.body.i.i.i285, %if.then.i.i.i279
  %.lcssa.i.i.i = phi i32 [ 0, %if.then.i.i.i279 ], [ %228, %for.body.i.i.i285 ]
  %cmp951.i.i.i = icmp ult i32 %.lcssa.i.i.i, %217
  br i1 %cmp951.i.i.i, label %for.body11.preheader.i.i.i, label %for.end16.i.i.i

for.body11.preheader.i.i.i:                       ; preds = %for.cond8.preheader.i.i.i
  %219 = zext i32 %.lcssa.i.i.i to i64
  %220 = shl nuw nsw i64 %219, 3
  %uglygep.i.i.i = getelementptr i8, ptr %call.i.i.i278, i64 %220
  %221 = xor i32 %.lcssa.i.i.i, -1
  %222 = add i32 %217, %221
  %223 = zext i32 %222 to i64
  %224 = shl nuw nsw i64 %223, 3
  %225 = add nuw nsw i64 %224, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %uglygep.i.i.i, i8 0, i64 %225, i1 false)
  br label %for.end16.i.i.i
...
for.body.i.i.i285:                                ; preds = %for.body.i.i.i285, %for.body.lr.ph.i.i.i281
  ...
  %226 = load ptr, ptr %splitfield.i.i.i280, align 8
  %arrayidx.i.i.i283 = getelementptr inbounds i64, ptr %226, i64 %indvars.iv.i.i.i282
  %227 = load i64, ptr %arrayidx.i.i.i283, align 8
  %arrayidx6.i.i.i = getelementptr inbounds i64, ptr %call.i.i.i278, i64 %indvars.iv.i.i.i282
  store i64 %227, ptr %arrayidx6.i.i.i, align 8
  %indvars.iv.next.i.i.i284 = add nuw nsw i64 %indvars.iv.i.i.i282, 1
  %228 = load i32, ptr %splitfield_length.i.i, align 8
  %229 = zext i32 %228 to i64
  %cmp3.i.i.i = icmp ult i64 %indvars.iv.next.i.i.i284, %229
  br i1 %cmp3.i.i.i, label %for.body.i.i.i285, label %for.cond8.preheader.i.i.i, !llvm.loop !26

for.end16.i.i.i:                                  ; preds = %for.body11.preheader.i.i.i, %for.cond8.preheader.i.i.i
  %splitfield17.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6321, i64 0, i32 4
  %230 = load ptr, ptr %splitfield17.i.i.i, align 8
  %cmp18.not.i.i.i = icmp eq ptr %230, null
  br i1 %cmp18.not.i.i.i, label %clause_ExpandSplitField.exit.i.i, label %if.then20.i.i.i

if.then20.i.i.i:                                  ; preds = %for.end16.i.i.i
  %231 = load i32, ptr %splitfield_length.i.i, align 8
  %mul24.i.i.i = shl i32 %231, 3
  %cmp.i.i.i.i.i = icmp ult i32 %mul24.i.i.i, 1024
...
if.then.i.i.i.i286:                               ; preds = %if.then20.i.i.i
  ...
  %add7.i.i.i.i.i.i = select i1 %tobool3.not.i.i.i.i.i.i, i32 0, i32 %sub6.i.i.i.i.i.i
  %RealSize.1.i.i.i.i.i.i = add i32 %add7.i.i.i.i.i.i, %mul24.i.i.i
  %232 = load i32, ptr @memory_OFFSET, align 4
  %idx.ext.i.i.i.i = zext i32 %232 to i64
  %idx.neg.i.i.i.i = sub nsw i64 0, %idx.ext.i.i.i.i
  %add.ptr.i.i.i.i389 = getelementptr i8, ptr %230, i64 -16
  %add.ptr1.i.i.i.i = getelementptr i8, ptr %add.ptr.i.i.i.i389, i64 %idx.neg.i.i.i.i
  %233 = load ptr, ptr %add.ptr1.i.i.i.i, align 8
  %cmp2.not.i.i.i.i = icmp eq ptr %233, null
  %next6.i.i.i.i = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %add.ptr1.i.i.i.i, i64 0, i32 1
  %234 = load ptr, ptr %next6.i.i.i.i, align 8
  %next5.i.i.i.i = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %233, i64 0, i32 1
  %memory_BIGBLOCKS.sink.i.i.i.i = select i1 %cmp2.not.i.i.i.i, ptr @memory_BIGBLOCKS, ptr %next5.i.i.i.i
  store ptr %234, ptr %memory_BIGBLOCKS.sink.i.i.i.i, align 8
  %235 = load ptr, ptr %next6.i.i.i.i, align 8
  %cmp8.not.i.i.i.i = icmp eq ptr %235, null
  br i1 %cmp8.not.i.i.i.i, label %if.end13.i.i.i.i, label %if.then9.i.i.i.i

if.then9.i.i.i.i:                                 ; preds = %if.then.i.i.i.i286
  %236 = load ptr, ptr %add.ptr1.i.i.i.i, align 8
  store ptr %236, ptr %235, align 8
  br label %if.end13.i.i.i.i

if.end13.i.i.i.i:                                 ; preds = %if.then9.i.i.i.i, %if.then.i.i.i.i286
  %237 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i.i.i = add i32 %RealSize.1.i.i.i.i.i.i, %237
  %conv.i.i.i.i = zext i32 %add.i.i.i.i to i64
  %add14.i.i.i.i = add nuw nsw i64 %conv.i.i.i.i, 16
  %238 = load i64, ptr @memory_FREEDBYTES, align 8
  %add15.i.i.i.i = add i64 %add14.i.i.i.i, %238
  store i64 %add15.i.i.i.i, ptr @memory_FREEDBYTES, align 8
  %239 = load i64, ptr @memory_MAXMEM, align 8
  %cmp16.i.i.i.i = icmp sgt i64 %239, -1
  br i1 %cmp16.i.i.i.i, label %if.then18.i.i.i.i, label %if.end23.i.i.i.i

if.then18.i.i.i.i:                                ; preds = %if.end13.i.i.i.i
  %add22.i.i.i.i = add nuw i64 %239, %add14.i.i.i.i
  store i64 %add22.i.i.i.i, ptr @memory_MAXMEM, align 8
  br label %if.end23.i.i.i.i

if.end23.i.i.i.i:                                 ; preds = %if.then18.i.i.i.i, %if.end13.i.i.i.i
  %add.ptr24.i.i.i.i = getelementptr inbounds i8, ptr %230, i64 -16
  tail call void @free(ptr noundef nonnull %add.ptr24.i.i.i.i) #11
  br label %clause_ExpandSplitField.exit.i.i
...
if.else25.i.i.i.i:                                ; preds = %if.then20.i.i.i
  ...
  %240 = load ptr, ptr %arrayidx.i.i.i.i287, align 8
  %total_size.i.i.i.i288 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %240, i64 0, i32 4
  %241 = load i32, ptr %total_size.i.i.i.i288, align 8
  %conv26.i.i.i.i289 = sext i32 %241 to i64
  %242 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i290 = add i64 %242, %conv26.i.i.i.i289
  store i64 %add27.i.i.i.i290, ptr @memory_FREEDBYTES, align 8
  %243 = load ptr, ptr %240, align 8
  store ptr %243, ptr %230, align 8
  %244 = load ptr, ptr %arrayidx.i.i.i.i287, align 8
  store ptr %230, ptr %244, align 8
  br label %clause_ExpandSplitField.exit.i.i

clause_ExpandSplitField.exit.i.i:                 ; preds = %if.else25.i.i.i.i, %if.end23.i.i.i.i, %for.end16.i.i.i
  store ptr %call.i.i.i278, ptr %splitfield17.i.i.i, align 8
  store i32 %217, ptr %splitfield_length.i.i, align 8
  %.pre.i.i = load i32, ptr %splitfield_length1.i.i, align 8
  br label %if.end.i.i291

if.end.i.i291:                                    ; preds = %clause_ExpandSplitField.exit.i.i, %if.end3.i
  %245 = phi i32 [ %.pre.i.i, %clause_ExpandSplitField.exit.i.i ], [ %217, %if.end3.i ]
  %cmp421.not.i.i = icmp eq i32 %245, 0
  br i1 %cmp421.not.i.i, label %clause_UpdateSplitDataFromPartner.exit, label %for.body.lr.ph.i.i
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  %246 = load ptr, ptr %splitfield.i.i, align 8
  %arrayidx.i.i292 = getelementptr inbounds i64, ptr %246, i64 %indvars.iv.i.i
  %247 = load i64, ptr %arrayidx.i.i292, align 8
  %248 = load ptr, ptr %splitfield5.i.i, align 8
  %arrayidx7.i.i = getelementptr inbounds i64, ptr %248, i64 %indvars.iv.i.i
  %249 = load i64, ptr %arrayidx7.i.i, align 8
  %or.i22.i = or i64 %249, %247
  store i64 %or.i22.i, ptr %arrayidx.i.i292, align 8
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1
  %250 = load i32, ptr %splitfield_length1.i.i, align 8
  %251 = zext i32 %250 to i64
  %cmp4.i.i = icmp ult i64 %indvars.iv.next.i.i, %251
  br i1 %cmp4.i.i, label %for.body.i.i, label %clause_UpdateSplitDataFromPartner.exit, !llvm.loop !27
...
clause_UpdateSplitDataFromPartner.exit:           ; preds = %for.body.i.i, %if.end.i277, %if.end.i.i291
  ...
  %252 = load i32, ptr %arrayidx.i264, align 4
  %tobool97.not = icmp eq i32 %252, 0
...
if.then98:                                        ; preds = %clause_UpdateSplitDataFromPartner.exit
  ...
  %call100 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.29, i32 noundef %call54.val, i32 noundef %169)
...
for.inc:                                          ; preds = %clause_LiteralGetIndex.exit, %land.lhs.true58, %land.lhs.true61
  ...
  br i1 %cmp.i247.not, label %for.inc105, label %for.body52, !llvm.loop !76
...
for.inc105:                                       ; preds = %for.inc, %if.then43, %for.body37, %land.lhs.true
  ...
  br i1 %cmp.i243.not, label %if.end112, label %for.body37, !llvm.loop !77
...
if.end112:                                        ; preds = %for.inc105, %if.then28, %while.body25
  ...
  br i1 %tobool22.not, label %while.end, label %while.body25, !llvm.loop !78
...
while.end:                                        ; preds = %if.end112, %if.end112.thread, %while.body16
  ...
  tail call void @st_CancelExistRetrieval() #11
  %253 = load i32, ptr @stack_POINTER, align 4
  %cmp.i240.not = icmp eq i32 %253, %148
  br i1 %cmp.i240.not, label %while.cond, label %while.body16, !llvm.loop !79
...
for.inc116:                                       ; preds = %while.cond, %clause_GetLiteralAtom.exit239, %clause_GetLiteralAtom.exit
  ...
  br i1 %exitcond.not, label %for.end117, label %for.body, !llvm.loop !80
...
if.then119:                                       ; preds = %for.end117
  ...
  %254 = load i32, ptr %arrayidx.i295, align 4
  %tobool121.not = icmp eq i32 %254, 0
  br i1 %tobool121.not, label %if.end124, label %if.then122

if.then122:                                       ; preds = %if.then119
  %255 = load ptr, ptr @stdout, align 8
  %256 = tail call i64 @fwrite(ptr nonnull @.str.30, i64 2, i64 1, ptr %255)
...
cleanup:                                          ; preds = %for.cond.preheader, %if.then162.i, %if.else160.i, %if.then158.i, %if.end156.i, %lor.lhs.false.i, %clause_GetLiteralAtom.exit.i, %for.end117, %if.then126, %if.end124
  %retval.0 = phi i32 [ %Result.9, %if.end124 ], [ %Result.9, %if.then126 ], [ 0, %for.end117 ], [ 0, %lor.lhs.false.i ], [ 0, %clause_GetLiteralAtom.exit.i ], [ 0, %if.else160.i ], [ 0, %if.then162.i ], [ %Result.1.lcssa388.i, %if.end156.i ], [ %Result.1.lcssa388.i, %if.then158.i ], [ 0, %for.cond.preheader ]
  ret i32 %retval.0
}
...
while.cond.loopexit:                              ; preds = %list_Delete.exit
  ...
  br i1 %tobool13.not, label %for.inc147, label %while.body, !llvm.loop !81
...
while.body20:                                     ; preds = %clause_GetLiteralAtom.exit272, %list_Delete.exit
  %30 = phi i32 [ %235, %list_Delete.exit ], [ %29, %clause_GetLiteralAtom.exit272 ]
...
for.inc.i:                                        ; preds = %if.else.i, %land.lhs.true.i, %lor.lhs.false.i, %for.body.i
  ...
  br i1 %exitcond.not.i, label %land.lhs.true73, label %for.body.i, !llvm.loop !34

land.lhs.true73:                                  ; preds = %for.inc.i, %clause_LiteralGetIndex.exit.i
  %call74 = call fastcc i32 @red_CRwTautologyCheck(ptr noundef %Search, ptr noundef %Copy.4476, i32 noundef %20, ptr noundef %31, ptr noundef %call59.val255, i32 noundef %44, i32 noundef %Mode, ptr noundef nonnull %HelpClause)
...
lor.lhs.false:                                    ; preds = %land.lhs.true78
  %68 = getelementptr i8, ptr %call59.val255, i64 12
  %call60.val259 = load i32, ptr %68, align 4
...
if.then89:                                        ; preds = %lor.lhs.false84, %lor.lhs.false, %land.lhs.true78
  ...
  %71 = getelementptr i8, ptr %call90, i64 56
  %call90.val = load ptr, ptr %71, align 8
  %arrayidx.i.i303 = getelementptr inbounds ptr, ptr %call90.val, i64 %indvars.iv
  %72 = load ptr, ptr %arrayidx.i.i303, align 8
  %73 = getelementptr i8, ptr %72, i64 24
  %call.val.i304 = load ptr, ptr %73, align 8
  %L.val7.val.i.i305 = load i32, ptr %call.val.i304, align 8
  %74 = load i32, ptr @fol_NOT, align 4
  %cmp.i.not.i.i306 = icmp eq i32 %74, %L.val7.val.i.i305
  br i1 %cmp.i.not.i.i306, label %if.then.i.i309, label %if.end92

if.then.i.i309:                                   ; preds = %if.then89
  %75 = getelementptr i8, ptr %call.val.i304, i64 16
  %call1.val.i.i307 = load ptr, ptr %75, align 8
  %76 = getelementptr i8, ptr %call1.val.i.i307, i64 8
  %call1.val.val.i.i308 = load ptr, ptr %76, align 8
  br label %if.end92

if.end92:                                         ; preds = %if.then.i.i309, %if.then89, %lor.lhs.false84, %if.then76
  %Copy.6 = phi ptr [ %Copy.4476, %lor.lhs.false84 ], [ %Copy.4476, %if.then76 ], [ %call90, %if.then89 ], [ %call90, %if.then.i.i309 ]
...
land.lhs.true94:                                  ; preds = %if.end92
  %77 = load i32, ptr %arrayidx.i313, align 4
...
if.then97:                                        ; preds = %land.lhs.true94
  ...
  %79 = tail call i64 @fwrite(ptr nonnull @.str.31, i64 17, i64 1, ptr %78)
  tail call void @clause_Print(ptr noundef %Copy.6) #11
  %80 = load ptr, ptr @stdout, align 8
  %81 = tail call i64 @fwrite(ptr nonnull @.str.28, i64 6, i64 1, ptr %80)
  br label %if.end100
...
if.then102:                                       ; preds = %if.end100
  %82 = load ptr, ptr %HelpClause, align 8
  %cmp104.not = icmp eq ptr %82, null
...
list_Nconc.exit.i.thread:                         ; preds = %if.end112.thread
  %85 = getelementptr i8, ptr %Copy.6, i64 32
  %Clause.val15.i317449 = load ptr, ptr %85, align 8
  %call.val.i318450 = load ptr, ptr %Clause.val15.i317449, align 8
  %86 = getelementptr i8, ptr %call.val.i318450, i64 8
  %call.val.val.i319451 = load ptr, ptr %86, align 8
  %87 = getelementptr i8, ptr %Copy.6, i64 40
  %Clause.val16.i458 = load ptr, ptr %87, align 8
...
if.then114:                                       ; preds = %if.end112.thread, %if.end112
  ...
  %88 = getelementptr i8, ptr %Copy.6, i64 32
  %Clause.val.i314 = load ptr, ptr %88, align 8
...
while.body.i.i:                                   ; preds = %if.then114, %while.body.i.i
  ...
  %total_size.i.i.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %89, i64 0, i32 4
  %90 = load i32, ptr %total_size.i.i.i.i, align 8
  %conv26.i.i.i.i = sext i32 %90 to i64
  %91 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i = add i64 %91, %conv26.i.i.i.i
  store i64 %add27.i.i.i.i, ptr @memory_FREEDBYTES, align 8
  %92 = load ptr, ptr %89, align 8
  store ptr %92, ptr %Current.06.i.i, align 8
  %93 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i.i, ptr %93, align 8
  %cmp.i.not.i.i315 = icmp eq ptr %Current.0.val.i.i, null
  br i1 %cmp.i.not.i.i315, label %list_Delete.exit.i, label %while.body.i.i, !llvm.loop !7

list_Delete.exit.i:                               ; preds = %while.body.i.i, %if.then114
  %94 = getelementptr i8, ptr %Copy.6, i64 40
  %Clause.val14.i = load ptr, ptr %94, align 8
...
while.body.i23.i:                                 ; preds = %list_Delete.exit.i, %while.body.i23.i
  ...
  %total_size.i.i.i19.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %95, i64 0, i32 4
  %96 = load i32, ptr %total_size.i.i.i19.i, align 8
  %conv26.i.i.i20.i = sext i32 %96 to i64
  %97 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i21.i = add i64 %97, %conv26.i.i.i20.i
  store i64 %add27.i.i.i21.i, ptr @memory_FREEDBYTES, align 8
  %98 = load ptr, ptr %95, align 8
  store ptr %98, ptr %Current.06.i17.i, align 8
  %99 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i17.i, ptr %99, align 8
  %cmp.i.not.i22.i = icmp eq ptr %Current.0.val.i18.i, null
  br i1 %cmp.i.not.i22.i, label %red_DocumentContextualRewriting.exit, label %while.body.i23.i, !llvm.loop !7

red_DocumentContextualRewriting.exit:             ; preds = %while.body.i23.i, %list_Delete.exit.i
  store ptr %PClauses.0443, ptr %88, align 8
  store ptr %PLits.0445, ptr %94, align 8
  %Clause.val15.i = load i32, ptr %Copy.6, align 8
  %conv.i.i316 = sext i32 %Clause.val15.i to i64
  %100 = inttoptr i64 %conv.i.i316 to ptr
  %call.i.i.i = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i.i, i64 0, i32 1
  store ptr %100, ptr %car.i.i.i, align 8
  store ptr %PClauses.0443, ptr %call.i.i.i, align 8
  store ptr %call.i.i.i, ptr %88, align 8
  ...
  store ptr %101, ptr %call.i.i28.i, align 8
  store ptr %call.i.i28.i, ptr %94, align 8
  %RuleClause.val.i = load i32, ptr %call59.val255, align 8
  %conv.i30.i = sext i32 %RuleClause.val.i to i64
  %102 = inttoptr i64 %conv.i30.i to ptr
  %103 = load ptr, ptr %88, align 8
  %call.i.i32.i = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.i33.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.i32.i, i64 0, i32 1
  store ptr %102, ptr %car.i.i33.i, align 8
  store ptr %103, ptr %call.i.i32.i, align 8
  store ptr %call.i.i32.i, ptr %88, align 8
  %sext461 = shl i64 %indvars.iv.i, 32
  %conv.i34.i = ashr exact i64 %sext461, 32
  %104 = inttoptr i64 %conv.i34.i to ptr
  ...
  store ptr %104, ptr %car.i.i37.i, align 8
  store ptr %105, ptr %call.i.i36.i, align 8
  store ptr %call.i.i36.i, ptr %94, align 8
  %106 = load i32, ptr @clause_CLAUSECOUNTER, align 4
  %inc.i.i.i = add nsw i32 %106, 1
  store i32 %inc.i.i.i, ptr @clause_CLAUSECOUNTER, align 4
  store i32 %106, ptr %Copy.6, align 8
...
if.else115:                                       ; preds = %if.end112
  %107 = getelementptr i8, ptr %Copy.6, i64 32
  %Clause.val15.i317 = load ptr, ptr %107, align 8
  %call.val.i318 = load ptr, ptr %Clause.val15.i317, align 8
  %108 = getelementptr i8, ptr %call.val.i318, i64 8
  %call.val.val.i319 = load ptr, ptr %108, align 8
...
list_Nconc.exit.i:                                ; preds = %for.end.i.i, %if.else115
  ...
  store ptr %retval.0.i.i321, ptr %107, align 8
  %109 = getelementptr i8, ptr %Copy.6, i64 40
  %Clause.val16.i = load ptr, ptr %109, align 8
...
for.cond.i23.i:                                   ; preds = %if.end.i19.i, %for.cond.i23.i
  ...
  br i1 %cmp.i20.not.i22.i, label %for.end.i24.i, label %for.cond.i23.i, !llvm.loop !9
...
red_DocumentFurtherCRw.exit:                      ; preds = %list_Nconc.exit.i.thread, %list_Nconc.exit.i, %if.end.i19.i, %for.end.i24.i
  %110 = phi ptr [ %109, %for.end.i24.i ], [ %109, %list_Nconc.exit.i ], [ %109, %if.end.i19.i ], [ %87, %list_Nconc.exit.i.thread ]
  %111 = phi ptr [ %107, %for.end.i24.i ], [ %107, %list_Nconc.exit.i ], [ %107, %if.end.i19.i ], [ %85, %list_Nconc.exit.i.thread ]
  ...
  %112 = phi ptr [ %.pre.i, %for.end.i24.i ], [ %retval.0.i.i321, %list_Nconc.exit.i ], [ %retval.0.i.i321, %if.end.i19.i ], [ %Clause.val15.i317449, %list_Nconc.exit.i.thread ]
  ...
  %113 = ptrtoint ptr %call.val.val.i319454460 to i64
  store ptr %retval.0.i25.i, ptr %110, align 8
  %sext.i = shl i64 %113, 32
  %conv.i.i322 = ashr exact i64 %sext.i, 32
  %114 = inttoptr i64 %conv.i.i322 to ptr
  ...
  store ptr %114, ptr %car.i.i.i324, align 8
  store ptr %112, ptr %call.i.i.i323, align 8
  store ptr %call.i.i.i323, ptr %111, align 8
  ...
  store ptr %115, ptr %call.i.i30.i, align 8
  store ptr %call.i.i30.i, ptr %110, align 8
  %RuleClause.val.i325 = load i32, ptr %call59.val255, align 8
  %conv.i32.i = sext i32 %RuleClause.val.i325 to i64
  %116 = inttoptr i64 %conv.i32.i to ptr
  ...
  store ptr %116, ptr %car.i.i35.i, align 8
  store ptr %117, ptr %call.i.i34.i, align 8
  store ptr %call.i.i34.i, ptr %111, align 8
  %sext = shl i64 %indvars.iv.i, 32
  %conv.i36.i = ashr exact i64 %sext, 32
  %118 = inttoptr i64 %conv.i36.i to ptr
  ...
  store ptr %118, ptr %car.i.i39.i, align 8
  store ptr %119, ptr %call.i.i38.i, align 8
  store ptr %call.i.i38.i, ptr %110, align 8
  br label %if.end117
...
if.end117:                                        ; preds = %red_DocumentContextualRewriting.exit, %red_DocumentFurtherCRw.exit, %if.end100
  ...
  %idxprom.i.i326 = sext i32 %121 to i64
  %arrayidx.i.i327 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i326
  store i32 %120, ptr %arrayidx.i.i327, align 4
  store i32 0, ptr @cont_BINDINGS, align 4
  %122 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  %call119 = tail call i32 @unify_MatchBindings(ptr noundef %122, ptr noundef nonnull %Gen.0.val, ptr noundef %31) #11
  ...
  %124 = getelementptr i8, ptr %call44.val253.val, i64 8
  %call44.val253.val.val = load ptr, ptr %124, align 8
  %call122 = tail call ptr @term_Copy(ptr noundef %call44.val253.val.val) #11
  %call123 = tail call ptr @cont_ApplyBindingsModuloMatching(ptr noundef %123, ptr noundef %call122, i32 noundef 1) #11
...
while.body.i.prol:                                ; preds = %while.body.i.preheader
  ...
  %call.val.i.i.i.prol = load ptr, ptr %126, align 8
  store ptr %call.val.i.i.i.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i.prol = getelementptr inbounds %struct.binding, ptr %125, i64 0, i32 1
  ...
  %link.i.i.i.i.prol = getelementptr inbounds %struct.binding, ptr %127, i64 0, i32 4
...
while.body.i.prol.loopexit:                       ; preds = %while.body.i.prol, %while.body.i.preheader
  ...
  %128 = icmp eq i32 %.pr.i, 1
  br i1 %128, label %while.end.i, label %while.body.i

while.body.i:                                     ; preds = %while.body.i.prol.loopexit, %while.body.i
  %129 = phi i32 [ %dec.i.i.i.1, %while.body.i ], [ %.unr, %while.body.i.prol.loopexit ]
  %130 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %130, ptr @cont_CURRENTBINDING, align 8
  %131 = getelementptr i8, ptr %130, i64 24
  %call.val.i.i.i = load ptr, ptr %131, align 8
  store ptr %call.val.i.i.i, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i = getelementptr inbounds %struct.binding, ptr %130, i64 0, i32 1
  ...
  %link.i.i.i.i = getelementptr inbounds %struct.binding, ptr %132, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i, align 8
  %dec.i.i.i = add nsw i32 %129, -1
  ...
  %call.val.i.i.i.1 = load ptr, ptr %134, align 8
  store ptr %call.val.i.i.i.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i.1 = getelementptr inbounds %struct.binding, ptr %133, i64 0, i32 1
...
if.then.i332:                                     ; preds = %while.end.i
  ...
  %137 = load i32, ptr %arrayidx.i.i331, align 4
...
cont_BackTrack.exit:                              ; preds = %while.end.i, %if.then.i332
  ...
  %138 = getelementptr i8, ptr %call59.val255, i64 48
  %Partner.val20.i = load i32, ptr %138, align 8
  %139 = and i32 %Partner.val20.i, 8
  %tobool.not.i = icmp eq i32 %139, 0
...
if.then.i333:                                     ; preds = %cont_BackTrack.exit
  ...
  %140 = load i32, ptr %flags.i.i, align 8
  %or.i.i = or i32 %140, 8
  store i32 %or.i.i, ptr %flags.i.i, align 8
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i333, %cont_BackTrack.exit
  %141 = getelementptr i8, ptr %call59.val255, i64 12
  %Partner.val19.i = load i32, ptr %141, align 4
  %cmp.i334 = icmp eq i32 %Partner.val19.i, 0
  br i1 %cmp.i334, label %clause_UpdateSplitDataFromPartner.exit, label %if.end3.i

if.end3.i:                                        ; preds = %if.end.i
  %142 = getelementptr i8, ptr %Copy.6, i64 12
  %Result.val17.i = load i32, ptr %142, align 4
  %spec.select.i = tail call i32 @llvm.umax.i32(i32 %Partner.val19.i, i32 %Result.val17.i)
  store i32 %spec.select.i, ptr %142, align 4
  %splitfield_length.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6, i64 0, i32 5
  %143 = load i32, ptr %splitfield_length.i.i, align 8
  %splitfield_length1.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %call59.val255, i64 0, i32 5
  %144 = load i32, ptr %splitfield_length1.i.i, align 8
  %cmp.i21.i = icmp ult i32 %143, %144
  br i1 %cmp.i21.i, label %if.then.i.i.i, label %if.end.i.i

if.then.i.i.i:                                    ; preds = %if.end3.i
  %mul.i.i.i = shl i32 %144, 3
  %call.i.i.i335 = tail call ptr @memory_Malloc(i32 noundef %mul.i.i.i) #11
  %145 = load i32, ptr %splitfield_length.i.i, align 8
  %cmp349.not.i.i.i = icmp eq i32 %145, 0
  br i1 %cmp349.not.i.i.i, label %for.cond8.preheader.i.i.i, label %for.body.lr.ph.i.i.i
...
for.cond8.preheader.i.i.i:                        ; preds = %for.body.i.i.i, %if.then.i.i.i
  %.lcssa.i.i.i = phi i32 [ 0, %if.then.i.i.i ], [ %155, %for.body.i.i.i ]
  %cmp951.i.i.i = icmp ult i32 %.lcssa.i.i.i, %144
  br i1 %cmp951.i.i.i, label %for.body11.preheader.i.i.i, label %for.end16.i.i.i

for.body11.preheader.i.i.i:                       ; preds = %for.cond8.preheader.i.i.i
  %146 = zext i32 %.lcssa.i.i.i to i64
  %147 = shl nuw nsw i64 %146, 3
  %uglygep.i.i.i = getelementptr i8, ptr %call.i.i.i335, i64 %147
  %148 = xor i32 %.lcssa.i.i.i, -1
  %149 = add i32 %144, %148
  %150 = zext i32 %149 to i64
  %151 = shl nuw nsw i64 %150, 3
  %152 = add nuw nsw i64 %151, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %uglygep.i.i.i, i8 0, i64 %152, i1 false)
  br label %for.end16.i.i.i

for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i
  %indvars.iv.i.i.i = phi i64 [ 0, %for.body.lr.ph.i.i.i ], [ %indvars.iv.next.i.i.i, %for.body.i.i.i ]
  %153 = load ptr, ptr %splitfield.i.i.i, align 8
  %arrayidx.i.i.i336 = getelementptr inbounds i64, ptr %153, i64 %indvars.iv.i.i.i
  %154 = load i64, ptr %arrayidx.i.i.i336, align 8
  %arrayidx6.i.i.i = getelementptr inbounds i64, ptr %call.i.i.i335, i64 %indvars.iv.i.i.i
  store i64 %154, ptr %arrayidx6.i.i.i, align 8
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1
  %155 = load i32, ptr %splitfield_length.i.i, align 8
  %156 = zext i32 %155 to i64
  %cmp3.i.i.i = icmp ult i64 %indvars.iv.next.i.i.i, %156
  br i1 %cmp3.i.i.i, label %for.body.i.i.i, label %for.cond8.preheader.i.i.i, !llvm.loop !26

for.end16.i.i.i:                                  ; preds = %for.body11.preheader.i.i.i, %for.cond8.preheader.i.i.i
  %splitfield17.i.i.i = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6, i64 0, i32 4
  %157 = load ptr, ptr %splitfield17.i.i.i, align 8
  %cmp18.not.i.i.i = icmp eq ptr %157, null
  br i1 %cmp18.not.i.i.i, label %clause_ExpandSplitField.exit.i.i, label %if.then20.i.i.i

if.then20.i.i.i:                                  ; preds = %for.end16.i.i.i
  %158 = load i32, ptr %splitfield_length.i.i, align 8
  %mul24.i.i.i = shl i32 %158, 3
  %cmp.i.i.i.i.i = icmp ult i32 %mul24.i.i.i, 1024
  br i1 %cmp.i.i.i.i.i, label %if.else25.i.i.i.i, label %if.then.i.i.i.i
...
if.then.i.i.i.i:                                  ; preds = %if.then20.i.i.i
  ...
  %add7.i.i.i.i.i.i = select i1 %tobool3.not.i.i.i.i.i.i, i32 0, i32 %sub6.i.i.i.i.i.i
  %RealSize.1.i.i.i.i.i.i = add i32 %add7.i.i.i.i.i.i, %mul24.i.i.i
  %159 = load i32, ptr @memory_OFFSET, align 4
  %idx.ext.i.i.i.i = zext i32 %159 to i64
  %idx.neg.i.i.i.i = sub nsw i64 0, %idx.ext.i.i.i.i
  %add.ptr.i.i.i.i516 = getelementptr i8, ptr %157, i64 -16
  %add.ptr1.i.i.i.i = getelementptr i8, ptr %add.ptr.i.i.i.i516, i64 %idx.neg.i.i.i.i
  %160 = load ptr, ptr %add.ptr1.i.i.i.i, align 8
  %cmp2.not.i.i.i.i = icmp eq ptr %160, null
  %next6.i.i.i.i = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %add.ptr1.i.i.i.i, i64 0, i32 1
  %161 = load ptr, ptr %next6.i.i.i.i, align 8
  %next5.i.i.i.i = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %160, i64 0, i32 1
  %memory_BIGBLOCKS.sink.i.i.i.i = select i1 %cmp2.not.i.i.i.i, ptr @memory_BIGBLOCKS, ptr %next5.i.i.i.i
  store ptr %161, ptr %memory_BIGBLOCKS.sink.i.i.i.i, align 8
  %162 = load ptr, ptr %next6.i.i.i.i, align 8
  %cmp8.not.i.i.i.i = icmp eq ptr %162, null
  br i1 %cmp8.not.i.i.i.i, label %if.end13.i.i.i.i, label %if.then9.i.i.i.i

if.then9.i.i.i.i:                                 ; preds = %if.then.i.i.i.i
  %163 = load ptr, ptr %add.ptr1.i.i.i.i, align 8
  store ptr %163, ptr %162, align 8
  br label %if.end13.i.i.i.i

if.end13.i.i.i.i:                                 ; preds = %if.then9.i.i.i.i, %if.then.i.i.i.i
  %164 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i.i.i = add i32 %RealSize.1.i.i.i.i.i.i, %164
  %conv.i.i.i.i = zext i32 %add.i.i.i.i to i64
  %add14.i.i.i.i = add nuw nsw i64 %conv.i.i.i.i, 16
  %165 = load i64, ptr @memory_FREEDBYTES, align 8
  %add15.i.i.i.i = add i64 %add14.i.i.i.i, %165
  store i64 %add15.i.i.i.i, ptr @memory_FREEDBYTES, align 8
  %166 = load i64, ptr @memory_MAXMEM, align 8
  %cmp16.i.i.i.i = icmp sgt i64 %166, -1
  br i1 %cmp16.i.i.i.i, label %if.then18.i.i.i.i, label %if.end23.i.i.i.i

if.then18.i.i.i.i:                                ; preds = %if.end13.i.i.i.i
  %add22.i.i.i.i = add nuw i64 %166, %add14.i.i.i.i
  store i64 %add22.i.i.i.i, ptr @memory_MAXMEM, align 8
  br label %if.end23.i.i.i.i

if.end23.i.i.i.i:                                 ; preds = %if.then18.i.i.i.i, %if.end13.i.i.i.i
  %add.ptr24.i.i.i.i = getelementptr inbounds i8, ptr %157, i64 -16
  tail call void @free(ptr noundef nonnull %add.ptr24.i.i.i.i) #11
  br label %clause_ExpandSplitField.exit.i.i
...
if.else25.i.i.i.i:                                ; preds = %if.then20.i.i.i
  ...
  %total_size.i.i.i.i337 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %167, i64 0, i32 4
  %168 = load i32, ptr %total_size.i.i.i.i337, align 8
  %conv26.i.i.i.i338 = sext i32 %168 to i64
  %169 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i339 = add i64 %169, %conv26.i.i.i.i338
  store i64 %add27.i.i.i.i339, ptr @memory_FREEDBYTES, align 8
  %170 = load ptr, ptr %167, align 8
  store ptr %170, ptr %157, align 8
  %171 = load ptr, ptr %arrayidx.i.i.i.i, align 8
  store ptr %157, ptr %171, align 8
  br label %clause_ExpandSplitField.exit.i.i

clause_ExpandSplitField.exit.i.i:                 ; preds = %if.else25.i.i.i.i, %if.end23.i.i.i.i, %for.end16.i.i.i
  store ptr %call.i.i.i335, ptr %splitfield17.i.i.i, align 8
  store i32 %144, ptr %splitfield_length.i.i, align 8
  %.pre.i.i = load i32, ptr %splitfield_length1.i.i, align 8
  br label %if.end.i.i

if.end.i.i:                                       ; preds = %clause_ExpandSplitField.exit.i.i, %if.end3.i
  %172 = phi i32 [ %.pre.i.i, %clause_ExpandSplitField.exit.i.i ], [ %144, %if.end3.i ]
  %cmp421.not.i.i = icmp eq i32 %172, 0
  br i1 %cmp421.not.i.i, label %clause_UpdateSplitDataFromPartner.exit, label %for.body.lr.ph.i.i
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  %173 = load ptr, ptr %splitfield.i.i, align 8
  %arrayidx.i.i341 = getelementptr inbounds i64, ptr %173, i64 %indvars.iv.i.i340
  %174 = load i64, ptr %arrayidx.i.i341, align 8
  %175 = load ptr, ptr %splitfield5.i.i, align 8
  %arrayidx7.i.i = getelementptr inbounds i64, ptr %175, i64 %indvars.iv.i.i340
  %176 = load i64, ptr %arrayidx7.i.i, align 8
  %or.i22.i = or i64 %176, %174
  store i64 %or.i22.i, ptr %arrayidx.i.i341, align 8
  %indvars.iv.next.i.i342 = add nuw nsw i64 %indvars.iv.i.i340, 1
  %177 = load i32, ptr %splitfield_length1.i.i, align 8
  %178 = zext i32 %177 to i64
  %cmp4.i.i = icmp ult i64 %indvars.iv.next.i.i342, %178
  br i1 %cmp4.i.i, label %for.body.i.i, label %clause_UpdateSplitDataFromPartner.exit, !llvm.loop !27

clause_UpdateSplitDataFromPartner.exit:           ; preds = %for.body.i.i, %if.end.i, %if.end.i.i
  %179 = load ptr, ptr %HelpClause, align 8
  %cmp126.not = icmp eq ptr %179, null
  br i1 %cmp126.not, label %if.end128, label %if.then127

if.then127:                                       ; preds = %clause_UpdateSplitDataFromPartner.exit
  %180 = getelementptr i8, ptr %179, i64 48
  %Partner.val20.i343 = load i32, ptr %180, align 8
  %181 = and i32 %Partner.val20.i343, 8
  %tobool.not.i344 = icmp eq i32 %181, 0
...
if.then.i347:                                     ; preds = %if.then127
  ...
  %182 = load i32, ptr %flags.i.i345, align 8
  %or.i.i346 = or i32 %182, 8
  store i32 %or.i.i346, ptr %flags.i.i345, align 8
  br label %if.end.i350

if.end.i350:                                      ; preds = %if.then.i347, %if.then127
  %183 = getelementptr i8, ptr %179, i64 12
  %Partner.val19.i348 = load i32, ptr %183, align 4
...
if.end3.i356:                                     ; preds = %if.end.i350
  %184 = getelementptr i8, ptr %Copy.6, i64 12
  %Result.val17.i351 = load i32, ptr %184, align 4
  %spec.select.i352 = tail call i32 @llvm.umax.i32(i32 %Partner.val19.i348, i32 %Result.val17.i351)
  store i32 %spec.select.i352, ptr %184, align 4
  %splitfield_length.i.i353 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Copy.6, i64 0, i32 5
  %185 = load i32, ptr %splitfield_length.i.i353, align 8
  %splitfield_length1.i.i354 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %179, i64 0, i32 5
  %186 = load i32, ptr %splitfield_length1.i.i354, align 8
  %cmp.i21.i355 = icmp ult i32 %185, %186
  br i1 %cmp.i21.i355, label %if.then.i.i.i360, label %if.end.i.i415

if.then.i.i.i360:                                 ; preds = %if.end3.i356
  %mul.i.i.i357 = shl i32 %186, 3
  %call.i.i.i358 = tail call ptr @memory_Malloc(i32 noundef %mul.i.i.i357) #11
  %187 = load i32, ptr %splitfield_length.i.i353, align 8
  %cmp349.not.i.i.i359 = icmp eq i32 %187, 0
...
for.cond8.preheader.i.i.i365:                     ; preds = %for.body.i.i.i373, %if.then.i.i.i360
  %.lcssa.i.i.i363 = phi i32 [ 0, %if.then.i.i.i360 ], [ %197, %for.body.i.i.i373 ]
  %cmp951.i.i.i364 = icmp ult i32 %.lcssa.i.i.i363, %186
...
for.body11.preheader.i.i.i367:                    ; preds = %for.cond8.preheader.i.i.i365
  %188 = zext i32 %.lcssa.i.i.i363 to i64
  %189 = shl nuw nsw i64 %188, 3
  %uglygep.i.i.i366 = getelementptr i8, ptr %call.i.i.i358, i64 %189
  %190 = xor i32 %.lcssa.i.i.i363, -1
  %191 = add i32 %186, %190
  %192 = zext i32 %191 to i64
  %193 = shl nuw nsw i64 %192, 3
  %194 = add nuw nsw i64 %193, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %uglygep.i.i.i366, i8 0, i64 %194, i1 false)
...
for.body.i.i.i373:                                ; preds = %for.body.i.i.i373, %for.body.lr.ph.i.i.i362
  ...
  %195 = load ptr, ptr %splitfield.i.i.i361, align 8
  %arrayidx.i.i.i369 = getelementptr inbounds i64, ptr %195, i64 %indvars.iv.i.i.i368
  %196 = load i64, ptr %arrayidx.i.i.i369, align 8
  %arrayidx6.i.i.i370 = getelementptr inbounds i64, ptr %call.i.i.i358, i64 %indvars.iv.i.i.i368
  store i64 %196, ptr %arrayidx6.i.i.i370, align 8
  %indvars.iv.next.i.i.i371 = add nuw nsw i64 %indvars.iv.i.i.i368, 1
  %197 = load i32, ptr %splitfield_length.i.i353, align 8
  %198 = zext i32 %197 to i64
  %cmp3.i.i.i372 = icmp ult i64 %indvars.iv.next.i.i.i371, %198
  br i1 %cmp3.i.i.i372, label %for.body.i.i.i373, label %for.cond8.preheader.i.i.i365, !llvm.loop !26
...
for.end16.i.i.i376:                               ; preds = %for.body11.preheader.i.i.i367, %for.cond8.preheader.i.i.i365
  ...
  %199 = load ptr, ptr %splitfield17.i.i.i374, align 8
  %cmp18.not.i.i.i375 = icmp eq ptr %199, null
...
if.then20.i.i.i379:                               ; preds = %for.end16.i.i.i376
  %200 = load i32, ptr %splitfield_length.i.i353, align 8
  %mul24.i.i.i377 = shl i32 %200, 3
...
if.then.i.i.i.i394:                               ; preds = %if.then20.i.i.i379
  ...
  %201 = load i32, ptr @memory_OFFSET, align 4
  %idx.ext.i.i.i.i385 = zext i32 %201 to i64
  %idx.neg.i.i.i.i386 = sub nsw i64 0, %idx.ext.i.i.i.i385
  %add.ptr.i.i.i.i387515 = getelementptr i8, ptr %199, i64 -16
  %add.ptr1.i.i.i.i388 = getelementptr i8, ptr %add.ptr.i.i.i.i387515, i64 %idx.neg.i.i.i.i386
  %202 = load ptr, ptr %add.ptr1.i.i.i.i388, align 8
  %cmp2.not.i.i.i.i389 = icmp eq ptr %202, null
  %next6.i.i.i.i390 = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %add.ptr1.i.i.i.i388, i64 0, i32 1
  %203 = load ptr, ptr %next6.i.i.i.i390, align 8
  %next5.i.i.i.i391 = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %202, i64 0, i32 1
  %memory_BIGBLOCKS.sink.i.i.i.i392 = select i1 %cmp2.not.i.i.i.i389, ptr @memory_BIGBLOCKS, ptr %next5.i.i.i.i391
  store ptr %203, ptr %memory_BIGBLOCKS.sink.i.i.i.i392, align 8
  %204 = load ptr, ptr %next6.i.i.i.i390, align 8
  %cmp8.not.i.i.i.i393 = icmp eq ptr %204, null
...
if.then9.i.i.i.i395:                              ; preds = %if.then.i.i.i.i394
  %205 = load ptr, ptr %add.ptr1.i.i.i.i388, align 8
  store ptr %205, ptr %204, align 8
  br label %if.end13.i.i.i.i401

if.end13.i.i.i.i401:                              ; preds = %if.then9.i.i.i.i395, %if.then.i.i.i.i394
  %206 = load i32, ptr @memory_MARKSIZE, align 4
  %add.i.i.i.i396 = add i32 %RealSize.1.i.i.i.i.i.i384, %206
...
if.then18.i.i.i.i403:                             ; preds = %if.end13.i.i.i.i401
  %add22.i.i.i.i402 = add nuw i64 %208, %add14.i.i.i.i398
...
if.end23.i.i.i.i405:                              ; preds = %if.then18.i.i.i.i403, %if.end13.i.i.i.i401
  %add.ptr24.i.i.i.i404 = getelementptr inbounds i8, ptr %199, i64 -16
...
if.else25.i.i.i.i411:                             ; preds = %if.then20.i.i.i379
  ...
  %209 = load ptr, ptr %arrayidx.i.i.i.i407, align 8
  %total_size.i.i.i.i408 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %209, i64 0, i32 4
  %210 = load i32, ptr %total_size.i.i.i.i408, align 8
  %conv26.i.i.i.i409 = sext i32 %210 to i64
  %211 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i410 = add i64 %211, %conv26.i.i.i.i409
  store i64 %add27.i.i.i.i410, ptr @memory_FREEDBYTES, align 8
  %212 = load ptr, ptr %209, align 8
  store ptr %212, ptr %199, align 8
  %213 = load ptr, ptr %arrayidx.i.i.i.i407, align 8
...
clause_ExpandSplitField.exit.i.i413:              ; preds = %if.else25.i.i.i.i411, %if.end23.i.i.i.i405, %for.end16.i.i.i376
  ...
  store i32 %186, ptr %splitfield_length.i.i353, align 8
...
if.end.i.i415:                                    ; preds = %clause_ExpandSplitField.exit.i.i413, %if.end3.i356
  %214 = phi i32 [ %.pre.i.i412, %clause_ExpandSplitField.exit.i.i413 ], [ %186, %if.end3.i356 ]
  %cmp421.not.i.i414 = icmp eq i32 %214, 0
...
for.body.lr.ph.i.i418:                            ; preds = %if.end.i.i415
  ...
  %splitfield5.i.i417 = getelementptr inbounds %struct.CLAUSE_HELP, ptr %179, i64 0, i32 4
...
for.body.i.i425:                                  ; preds = %for.body.i.i425, %for.body.lr.ph.i.i418
  ...
  %215 = load ptr, ptr %splitfield.i.i416, align 8
  %arrayidx.i.i420 = getelementptr inbounds i64, ptr %215, i64 %indvars.iv.i.i419
  %216 = load i64, ptr %arrayidx.i.i420, align 8
  %217 = load ptr, ptr %splitfield5.i.i417, align 8
  %arrayidx7.i.i421 = getelementptr inbounds i64, ptr %217, i64 %indvars.iv.i.i419
  %218 = load i64, ptr %arrayidx7.i.i421, align 8
  %or.i22.i422 = or i64 %218, %216
  store i64 %or.i22.i422, ptr %arrayidx.i.i420, align 8
  %indvars.iv.next.i.i423 = add nuw nsw i64 %indvars.iv.i.i419, 1
  %219 = load i32, ptr %splitfield_length1.i.i354, align 8
  %220 = zext i32 %219 to i64
  %cmp4.i.i424 = icmp ult i64 %indvars.iv.next.i.i423, %220
  br i1 %cmp4.i.i424, label %for.body.i.i425, label %clause_UpdateSplitDataFromPartner.exit426, !llvm.loop !27

clause_UpdateSplitDataFromPartner.exit426:        ; preds = %for.body.i.i425, %if.end.i350, %if.end.i.i415
  %221 = load ptr, ptr %HelpClause, align 8
  tail call void @clause_Delete(ptr noundef %221) #11
  br label %if.end128
...
if.end128:                                        ; preds = %clause_UpdateSplitDataFromPartner.exit426, %clause_UpdateSplitDataFromPartner.exit
  ...
  %222 = load i32, ptr %arrayidx.i313, align 4
  %tobool130.not = icmp eq i32 %222, 0
  br i1 %tobool130.not, label %for.inc.thread, label %if.then131

if.then131:                                       ; preds = %if.end128
  %call60.val = load i32, ptr %call59.val255, align 8
  %call133 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.29, i32 noundef %call60.val, i32 noundef %67)
...
for.inc:                                          ; preds = %land.lhs.true.i, %if.then9.i, %if.else.i, %clause_LiteralGetIndex.exit, %land.lhs.true64, %land.lhs.true67, %land.lhs.true73
  ...
  br i1 %cmp.i282.not, label %for.end, label %for.body58, !llvm.loop !82
...
for.inc138:                                       ; preds = %for.body43, %land.lhs.true, %for.end
  ...
  %223 = and i1 %cmp.i278, %tobool40.not
  br i1 %223, label %for.body43, label %for.inc142, !llvm.loop !83
...
for.inc142:                                       ; preds = %for.inc138, %if.then34, %for.body30
  ...
  %total_size.i.i.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %224, i64 0, i32 4
  %225 = load i32, ptr %total_size.i.i.i, align 8
  %conv26.i.i.i = sext i32 %225 to i64
  %226 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i = add i64 %226, %conv26.i.i.i
  store i64 %add27.i.i.i, ptr @memory_FREEDBYTES, align 8
  %227 = load ptr, ptr %224, align 8
  store ptr %227, ptr %Gen.0487, align 8
  %228 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Gen.0487, ptr %228, align 8
  %cmp.i276 = icmp ne ptr %L.val.i428, null
  %tobool28.not = icmp eq i32 %Rewritten.7, 0
  %229 = and i1 %cmp.i276, %tobool28.not
  br i1 %229, label %for.body30, label %for.end144, !llvm.loop !84
...
while.body.i433:                                  ; preds = %for.end144, %while.body.i433
  ...
  %total_size.i.i.i429 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %230, i64 0, i32 4
  %231 = load i32, ptr %total_size.i.i.i429, align 8
  %conv26.i.i.i430 = sext i32 %231 to i64
  %232 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i431 = add i64 %232, %conv26.i.i.i430
  store i64 %add27.i.i.i431, ptr @memory_FREEDBYTES, align 8
  %233 = load ptr, ptr %230, align 8
  store ptr %233, ptr %Current.06.i, align 8
  %234 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i, ptr %234, align 8
  %cmp.i.not.i432 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i432, label %list_Delete.exit, label %while.body.i433, !llvm.loop !7

list_Delete.exit:                                 ; preds = %while.body.i433, %for.end144
  %235 = load i32, ptr @stack_POINTER, align 4
  %cmp.i273.not = icmp eq i32 %235, %27
  br i1 %cmp.i273.not, label %while.cond.loopexit, label %while.body20, !llvm.loop !85
...
for.inc147:                                       ; preds = %while.cond.loopexit, %clause_GetLiteralAtom.exit272, %clause_GetLiteralAtom.exit
  ...
  br i1 %exitcond.not, label %for.end148, label %for.body, !llvm.loop !86
...
if.then150:                                       ; preds = %for.end148
  ...
  %236 = load i32, ptr %arrayidx.i436, align 4
  %tobool152.not = icmp eq i32 %236, 0
  br i1 %tobool152.not, label %if.end155, label %if.then153

if.then153:                                       ; preds = %if.then150
  %237 = load ptr, ptr @stdout, align 8
  %238 = tail call i64 @fwrite(ptr nonnull @.str.30, i64 2, i64 1, ptr %237)
  tail call void @clause_Print(ptr noundef nonnull %Copy.10) #11
  br label %if.end155
...
if.end159:                                        ; preds = %entry, %if.end155, %if.then157, %for.end148
  %Result.0.lcssa537 = phi i32 [ %Result.9, %if.end155 ], [ %Result.9, %if.then157 ], [ 0, %for.end148 ], [ 0, %entry ]
  ret i32 %Result.0.lcssa537
}
...
lor.lhs.false:                                    ; preds = %land.lhs.true31
  ...
  %cmp.i152 = icmp ule i32 %call33.val, %Clause.val145
  %cmp1.i = icmp ule i32 %call33.val, %Level
  %.not = and i1 %cmp.i152, %cmp1.i
  br i1 %.not, label %if.end39, label %if.then37
...
if.end39:                                         ; preds = %if.then37, %lor.lhs.false, %for.body
  %Copy.2 = phi ptr [ %call38, %if.then37 ], [ %Copy.1187, %lor.lhs.false ], [ %Copy.1187, %for.body ]
...
for.body11.preheader.i.i.i:                       ; preds = %for.cond8.preheader.i.i.i
  ...
  %uglygep.i.i.i = getelementptr i8, ptr %call.i.i.i, i64 %31
  %32 = xor i32 %.lcssa.i.i.i, -1
  %33 = add i32 %28, %32
  %34 = zext i32 %33 to i64
  %35 = shl nuw nsw i64 %34, 3
  %36 = add nuw nsw i64 %35, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %uglygep.i.i.i, i8 0, i64 %36, i1 false)
  br label %for.end16.i.i.i
...
if.then.i.i.i.i:                                  ; preds = %if.then20.i.i.i
  ...
  %idx.neg.i.i.i.i = sub nsw i64 0, %idx.ext.i.i.i.i
  %add.ptr.i.i.i.i210 = getelementptr i8, ptr %41, i64 -16
  %add.ptr1.i.i.i.i = getelementptr i8, ptr %add.ptr.i.i.i.i210, i64 %idx.neg.i.i.i.i
...
for.cond.i163:                                    ; preds = %if.end.i159, %for.cond.i163
  ...
  br i1 %cmp.i20.not.i162, label %for.end.i164, label %for.cond.i163, !llvm.loop !9
...
while.body.i:                                     ; preds = %if.else, %while.body.i
  ...
  br i1 %cmp.i.not.i167, label %list_Delete.exit, label %while.body.i, !llvm.loop !7
...
if.end55:                                         ; preds = %list_Delete.exit, %list_Nconc.exit166
  ...
  br i1 %cmp5.not, label %while.end, label %while.body, !llvm.loop !88
...
while.body.i54.i:                                 ; preds = %list_Delete.exit.i, %while.body.i54.i
  ...
  br i1 %cmp.i.not.i53.i, label %list_Delete.exit55.i, label %while.body.i54.i, !llvm.loop !7
...
for.body.i:                                       ; preds = %list_Delete.exit55.i, %for.body.i
  ...
  br i1 %cmp.i.not.i172, label %for.cond8.preheader.i, label %for.body.i, !llvm.loop !89
...
for.body12.i:                                     ; preds = %for.body12.i, %for.body12.preheader.i
  ...
  br i1 %cmp.i56.not.i, label %for.end22.i, label %for.body12.i, !llvm.loop !90
...
for.cond.i68.i:                                   ; preds = %list_Nconc.exit.i, %for.cond.i68.i
  ...
  br i1 %cmp.i20.not.i67.i, label %for.end.i69.i, label %for.cond.i68.i, !llvm.loop !9
...
while.body.i180:                                  ; preds = %if.else61, %while.body.i180
  ...
  br i1 %cmp.i.not.i179, label %if.end62, label %while.body.i180, !llvm.loop !7
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end45
  ...
  %4 = getelementptr i8, ptr %Copy.0215, i64 56
  %Copy.0.val = load ptr, ptr %4, align 8
  %idxprom.i = sext i32 %i.0216 to i64
  %arrayidx.i166 = getelementptr inbounds ptr, ptr %Copy.0.val, i64 %idxprom.i
  %5 = load ptr, ptr %arrayidx.i166, align 8
  %6 = getelementptr i8, ptr %5, i64 24
  %call6.val = load ptr, ptr %6, align 8
  %L.val7.val.i = load i32, ptr %call6.val, align 8
  %7 = load i32, ptr @fol_NOT, align 4
...
clause_LiteralAtom.exit:                          ; preds = %while.body
  %8 = getelementptr i8, ptr %call6.val, i64 16
  ...
  %cmp.i.not = icmp eq i32 %10, %call7.val.pre
  %or.cond = and i1 %cmp.i.not, %cmp.i.not.i
...
if.then:                                          ; preds = %while.body, %clause_LiteralAtom.exit
  ...
  %ActLit.val46.i = load ptr, ptr %11, align 8
  %12 = getelementptr i8, ptr %ActLit.val46.i, i64 56
...
if.then.i.i:                                      ; preds = %clause_LiteralGetIndex.exit.i
  %16 = getelementptr i8, ptr %call6.val, i64 16
  %call1.val.i.i = load ptr, ptr %16, align 8
  %17 = getelementptr i8, ptr %call1.val.i.i, i64 8
  %call1.val.val.i.i = load ptr, ptr %17, align 8
  br label %clause_LiteralAtom.exit.i
...
clause_LiteralAtom.exit.i:                        ; preds = %if.then.i.i, %clause_LiteralGetIndex.exit.i
  ...
  %call5.i = tail call ptr @st_ExistGen(ptr noundef %15, ptr noundef %ShIndex.val.i, ptr noundef %retval.0.i.i) #11
...
while.body12.i:                                   ; preds = %if.end24.i, %while.body12.preheader.i
  %18 = phi i32 [ %28, %if.end24.i ], [ %.pre67.i, %while.body12.preheader.i ]
  %LitScan.063.i = phi ptr [ %LitScan.0.val44.i, %if.end24.i ], [ %call8.i, %while.body12.preheader.i ]
  %19 = getelementptr i8, ptr %LitScan.063.i, i64 8
  %LitScan.0.val.i = load ptr, ptr %19, align 8
  %ActLit.val47.i = load ptr, ptr %6, align 8
  %ActLit.val47.val.i = load i32, ptr %ActLit.val47.i, align 8
  %cmp.i.not.i48.i = icmp eq i32 %18, %ActLit.val47.val.i
  %20 = getelementptr i8, ptr %LitScan.0.val.i, i64 24
  %L2.val10.i.i = load ptr, ptr %20, align 8
  %L2.val10.val.i.i = load i32, ptr %L2.val10.i.i, align 8
  br i1 %cmp.i.not.i48.i, label %land.lhs.true.i.i, label %lor.rhs.i.i

land.lhs.true.i.i:                                ; preds = %while.body12.i
  %cmp.i.i.not.i.i = icmp eq i32 %L2.val10.val.i.i, %18
  br i1 %cmp.i.i.not.i.i, label %if.end24.i, label %if.then16.i

lor.rhs.i.i:                                      ; preds = %while.body12.i
  %cmp.i11.not.i.i.not = icmp eq i32 %18, %L2.val10.val.i.i
  br i1 %cmp.i11.not.i.i.not, label %if.then16.i, label %if.end24.i

if.then16.i:                                      ; preds = %lor.rhs.i.i, %land.lhs.true.i.i
  %21 = getelementptr i8, ptr %LitScan.0.val.i, i64 16
  %call13.val45.i = load ptr, ptr %21, align 8
  %22 = getelementptr i8, ptr %call13.val45.i, i64 64
  %Clause.val6.i.i = load i32, ptr %22, align 8
  %23 = getelementptr i8, ptr %call13.val45.i, i64 68
  %Clause.val.i.i = load i32, ptr %23, align 4
  %add.i.i = add nsw i32 %Clause.val.i.i, %Clause.val6.i.i
  %24 = getelementptr i8, ptr %call13.val45.i, i64 72
  %Clause.val7.i.i = load i32, ptr %24, align 8
  %add3.i.i = add nsw i32 %add.i.i, %Clause.val7.i.i
...
lor.lhs.false.i:                                  ; preds = %if.then16.i
  %25 = getelementptr i8, ptr %call13.val45.i, i64 56
  %call.val.i50.i = load ptr, ptr %25, align 8
...
while.cond.i55.i:                                 ; preds = %while.cond.i55.i, %lor.lhs.false.i
  ...
  %26 = load ptr, ptr %arrayidx.i.i52.i, align 8
  %cmp.not.i53.i = icmp eq ptr %26, %LitScan.0.val.i
  %indvars.iv.next.i54.i = add nuw i64 %indvars.iv.i51.i, 1
  br i1 %cmp.not.i53.i, label %clause_LiteralGetIndex.exit56.i, label %while.cond.i55.i, !llvm.loop !11

clause_LiteralGetIndex.exit56.i:                  ; preds = %while.cond.i55.i
  %27 = trunc i64 %indvars.iv.i51.i to i32
  %call21.i = tail call i32 @subs_SubsumesBasic(ptr noundef %call13.val45.i, ptr noundef %ActLit.val46.i, i32 noundef %27, i32 noundef %14) #11
...
if.end24.i:                                       ; preds = %clause_LiteralGetIndex.exit56.i, %lor.rhs.i.i, %land.lhs.true.i.i
  %28 = phi i32 [ %18, %lor.rhs.i.i ], [ %.pre.i, %clause_LiteralGetIndex.exit56.i ], [ %18, %land.lhs.true.i.i ]
  %LitScan.0.val44.i = load ptr, ptr %LitScan.063.i, align 8
  %cmp.i.not.i169 = icmp eq ptr %LitScan.0.val44.i, null
  br i1 %cmp.i.not.i169, label %if.end26.i, label %while.body12.i, !llvm.loop !91
...
if.end26.i:                                       ; preds = %if.end24.i, %if.then.i167, %while.body.i
  ...
  br i1 %tobool.not.i, label %if.else, label %while.body.i, !llvm.loop !92
...
while.cond.i:                                     ; preds = %while.cond.i, %if.end
  ...
  %cmp.not.i = icmp eq ptr %35, %LitScan.0.val.i
  %indvars.iv.next.i = add nuw i64 %indvars.iv.i, 1
  br i1 %cmp.not.i, label %clause_LiteralGetIndex.exit, label %while.cond.i, !llvm.loop !11
...
clause_LiteralGetIndex.exit:                      ; preds = %while.cond.i
  ...
  store ptr %37, ptr %car.i179, align 8
...
lor.lhs.false33:                                  ; preds = %land.lhs.true31
  %38 = getelementptr i8, ptr %call11.val, i64 12
  %call21.val164 = load i32, ptr %38, align 4
  %39 = getelementptr i8, ptr %Copy.0215, i64 12
  %Copy.0.val163 = load i32, ptr %39, align 4
...
if.end40:                                         ; preds = %if.then38, %lor.lhs.false33, %clause_LiteralGetIndex.exit
  %Copy.1 = phi ptr [ %call39, %if.then38 ], [ %Copy.0215, %lor.lhs.false33 ], [ %Copy.0215, %clause_LiteralGetIndex.exit ]
...
for.body:                                         ; preds = %if.then56, %for.body
  ...
  br i1 %cmp.i184.not, label %for.end, label %for.body, !llvm.loop !94
...
for.body76:                                       ; preds = %for.body76.preheader, %for.body76
  ...
  br i1 %cmp.i187.not, label %for.end83, label %for.body76, !llvm.loop !95
...
while.body.i190:                                  ; preds = %while.body.i190.preheader, %while.body.i190
  ...
  br i1 %cmp.i.not.i189, label %list_Delete.exit, label %while.body.i190, !llvm.loop !7
...
while.body.i198:                                  ; preds = %list_Delete.exit, %while.body.i198
  ...
  br i1 %cmp.i.not.i197, label %list_Delete.exit199, label %while.body.i198, !llvm.loop !7
...
while.body.i207:                                  ; preds = %list_Delete.exit199, %while.body.i207
  ...
  br i1 %cmp.i.not.i206, label %if.end86, label %while.body.i207, !llvm.loop !7
...
lor.rhs.i:                                        ; preds = %while.body17
  ...
  %or.cond = or i1 %cmp.i11.not.i, %cmp.i.not.i191
...
if.end:                                           ; preds = %land.lhs.true.i, %land.lhs.true, %lor.rhs.i
  ...
  br i1 %cmp.i.not, label %if.end31, label %while.body17, !llvm.loop !96
...
if.end31:                                         ; preds = %if.end, %if.then12, %while.body
  ...
  br i1 %tobool.not, label %land.lhs.true34, label %while.body, !llvm.loop !97
...
lor.rhs.i224:                                     ; preds = %while.body62
  ...
  %or.cond281 = or i1 %cmp.i11.not.i223, %cmp.i.not.i217
...
if.end74:                                         ; preds = %land.lhs.true.i221, %land.lhs.true66, %lor.rhs.i224
  ...
  br i1 %cmp.i215.not, label %if.end80, label %while.body62, !llvm.loop !98
...
if.end80:                                         ; preds = %if.end74, %if.then56, %while.body53
  ...
  br i1 %tobool51.not, label %while.end81, label %while.body53, !llvm.loop !99
...
while.body.i:                                     ; preds = %while.end81, %while.body.i
  ...
  br i1 %cmp.i.not.i235, label %if.end83, label %while.body.i, !llvm.loop !7
...
while.body.i22.i:                                 ; preds = %list_Delete.exit.i, %while.body.i22.i
  ...
  br i1 %cmp.i.not.i21.i, label %if.end.i27.i, label %while.body.i22.i, !llvm.loop !7
...
for.cond.i31.i:                                   ; preds = %if.end.i27.i, %for.cond.i31.i
  ...
  br i1 %cmp.i20.not.i30.i, label %red_DocumentUnitConflict.exit, label %for.cond.i31.i, !llvm.loop !9
...
for.inc:                                          ; preds = %lor.lhs.false, %land.lhs.true25, %land.lhs.true28, %land.lhs.true33
  ...
  br i1 %cmp16.not.not, label %for.body18, label %for.inc42, !llvm.loop !100
...
for.inc42:                                        ; preds = %for.inc, %for.inc42.sink.split, %if.else
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.end44.loopexit, label %for.body, !llvm.loop !101
...
for.cond47.loopexit:                              ; preds = %for.inc82, %for.inc82.thread, %clause_LiteralAtom.exit284.for.cond47.loopexit_crit_edge
  ...
  br i1 %exitcond374.not, label %for.end87.loopexit, label %for.body50, !llvm.loop !102
...
for.inc82:                                        ; preds = %lor.lhs.false62, %land.lhs.true65, %land.lhs.true68, %land.lhs.true73
  ...
  br i1 %cmp55.not.not, label %for.body57, label %for.cond47.loopexit, !llvm.loop !103
...
for.end87:                                        ; preds = %for.end87.loopexit, %for.end44
  ...
  %or.cond = select i1 %cmp89, i1 %cmp93, i1 false
...
if.end.i:                                         ; preds = %while.body.i
  ...
  br i1 %cmp.i.not.i302, label %land.lhs.true100, label %while.body.i, !llvm.loop !12
...
while.body.i329:                                  ; preds = %while.body.i329.prol.loopexit, %while.body.i329
  ...
  store i32 %dec.i.i.i.1, ptr @cont_BINDINGS, align 4
  %cmp.i328.1 = icmp ugt i32 %dec.i.i.i, 1
  br i1 %cmp.i328.1, label %while.body.i329, label %while.end.i, !llvm.loop !35
...
while.body.i.i:                                   ; preds = %if.then134, %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i339, label %list_Delete.exit.i, label %while.body.i.i, !llvm.loop !7
...
while.body.i21.i:                                 ; preds = %list_Delete.exit.i, %while.body.i21.i
  ...
  br i1 %cmp.i.not.i20.i, label %red_DocumentObviousReductions.exit, label %while.body.i21.i, !llvm.loop !7
...
while.body.i343:                                  ; preds = %while.body.i343.preheader, %while.body.i343
  ...
  br i1 %cmp.i.not.i342, label %list_Delete.exit, label %while.body.i343, !llvm.loop !7
...
while.body.i21.i:                                 ; preds = %list_Delete.exit.i, %while.body.i21.i
  ...
  %cmp.i.not.i20.i = icmp eq ptr %Current.0.val.i16.i, null
  br i1 %cmp.i.not.i20.i, label %red_DocumentCondensing.exit, label %while.body.i21.i, !llvm.loop !7
...
for.body11.preheader.i.i:                         ; preds = %for.cond8.preheader.i.i
  ...
  %uglygep.i.i = getelementptr i8, ptr %call.i.i, i64 %9
  %10 = xor i32 %.lcssa.i.i, -1
  %11 = add i32 %6, %10
  %12 = zext i32 %11 to i64
  %13 = shl nuw nsw i64 %12, 3
  %14 = add nuw nsw i64 %13, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %uglygep.i.i, i8 0, i64 %14, i1 false)
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  br i1 %cmp3.i.i, label %for.body.i.i, label %for.cond8.preheader.i.i, !llvm.loop !26
...
if.then.i.i.i:                                    ; preds = %if.then20.i.i
  ...
  %next6.i.i.i = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %add.ptr1.i.i.i, i64 0, i32 1
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  br i1 %cmp4.i, label %for.body.i, label %return, !llvm.loop !27
...
while.body.i163:                                  ; preds = %list_Delete.exit, %while.body.i163
  ...
  br i1 %cmp.i.not.i162, label %list_Delete.exit164, label %while.body.i163, !llvm.loop !7
...
while.body.i191:                                  ; preds = %while.body.i191.prol.loopexit, %while.body.i191
  ...
  br i1 %cmp.i.1, label %while.body.i191, label %while.end.i, !llvm.loop !35
...
while.body.i212:                                  ; preds = %while.body.i212.prol.loopexit, %while.body.i212
  ...
  br i1 %cmp.i211.1, label %while.body.i212, label %while.end.i214, !llvm.loop !35
...
for.body.i:                                       ; preds = %cont_BackTrack.exit219, %for.body.i
  ...
  br i1 %exitcond.not.i.5, label %flag_TransferAllFlags.exit, label %for.body.i, !llvm.loop !105
...
while.body.i323:                                  ; preds = %if.then.i228, %while.body.i323
  ...
  br i1 %cmp.i.not.i322, label %list_Delete.exit325, label %while.body.i323, !llvm.loop !7
...
list_Delete.exit325:                              ; preds = %while.body.i323
  ...
  %call14.i = call fastcc i32 @red_SortSimplification(ptr noundef %Search.val106.i, ptr noundef nonnull %call11.i, i32 noundef -1, i32 noundef %141, ptr noundef %Search.val.i, ptr noundef %Search.val101.i, ptr noundef nonnull %NewClause.i)
...
for.body29.i:                                     ; preds = %if.then17.i, %for.body29.i
  ...
  br i1 %cmp.i62.not.i, label %for.end32.i, label %for.body29.i, !llvm.loop !107
...
while.body.i.i314:                                ; preds = %for.end32.i, %while.body.i.i314
  ...
  br i1 %cmp.i.not.i65.i, label %if.end.i.thread, label %while.body.i.i314, !llvm.loop !7
...
while.body.i296:                                  ; preds = %if.end38.i, %while.body.i296
  ...
  br i1 %cmp.i.not.i295, label %list_Delete.exit298, label %while.body.i296, !llvm.loop !7
...
while.body.i286:                                  ; preds = %list_Delete.exit298, %while.body.i286
  ...
  br i1 %cmp.i.not.i285, label %list_Delete.exit288, label %while.body.i286, !llvm.loop !7
...
for.inc.i:                                        ; preds = %if.else46.i, %lor.lhs.false.i273, %land.lhs.true.i272, %for.body24.i
  ...
  br i1 %218, label %for.body24.i, label %for.end.loopexit.i, !llvm.loop !108
...
while.body.i.i:                                   ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i
  ...
  br i1 %cmp.i144.i.1, label %while.body.i.i, label %while.end.i.i, !llvm.loop !35
...
for.inc61.i:                                      ; preds = %cont_BackTrack.exit.i, %land.lhs.true11.i.i, %lor.lhs.false.i.i, %land.lhs.true.i.i, %clause_LiteralAtom.exit.i.i
  ...
  br i1 %exitcond.not.i278, label %for.end63.i, label %for.body.i260, !llvm.loop !109
...
for.inc61.i.thread:                               ; preds = %cont_BackTrack.exit.i
  ...
  br i1 %exitcond.not.i278341, label %if.then65.i.thread, label %for.body.i260.outer, !llvm.loop !109
...
while.body.i150.i:                                ; preds = %while.body.i150.i.preheader, %while.body.i150.i
  ...
  br i1 %cmp.i.not.i149.i, label %list_Delete.exit.i.loopexit, label %while.body.i150.i, !llvm.loop !7
...
red_PropagateDefinitions.exit:                    ; preds = %list_Delete.exit288, %for.end63.i, %list_Delete.exit.i
  ...
  %call47.i = call fastcc i32 @red_SelectedStaticReductions(ptr noundef %Search, ptr noundef nonnull %aux.i, ptr noundef nonnull %NewClause.i, ptr noundef nonnull %RedundantList.i, i32 noundef %Mode)
...
for.cond.i.i:                                     ; preds = %if.end.i.i, %for.cond.i.i
  ...
  br i1 %cmp.i22.not.i.i, label %for.end.i.i, label %for.cond.i.i, !llvm.loop !110
...
list_Append.exit.i:                               ; preds = %for.end.i.i, %if.end.i.i, %for.body.i398
  ...
  br i1 %cmp.i.not.i400, label %for.end.i401, label %for.body.i398, !llvm.loop !111
...
for.body15.i:                                     ; preds = %if.end.i406, %for.body15.i
  ...
  br i1 %cmp.i59.not.i, label %for.end22.i, label %for.body15.i, !llvm.loop !112
...
for.body29.i414:                                  ; preds = %for.end22.i, %for.body29.i414
  ...
  br i1 %cmp.i62.not.i413, label %for.end32.i417, label %for.body29.i414, !llvm.loop !107
...
while.body.i.i424:                                ; preds = %for.end32.i417, %while.body.i.i424
  ...
  br i1 %cmp.i.not.i65.i423, label %red_CRwCalculateAdditionalParents.exit, label %while.body.i.i424, !llvm.loop !7
...
for.cond.i240:                                    ; preds = %if.end.i236, %for.cond.i240
  ...
  br i1 %cmp.i20.not.i239, label %for.end.i241, label %for.cond.i240, !llvm.loop !9
...
for.inc66:                                        ; preds = %for.body46, %if.end63
  ...
  br i1 %exitcond.not433, label %for.end68, label %for.body46, !llvm.loop !113
...
for.body.i252:                                    ; preds = %for.end68, %for.body.i252
  ...
  br i1 %exitcond.not.i251.5, label %flag_TransferAllFlags.exit254, label %for.body.i252, !llvm.loop !114
...
while.body.i28:                                   ; preds = %list_Delete.exit, %while.body.i28
  ...
  br i1 %cmp.i.not.i27, label %list_Delete.exit29, label %while.body.i28, !llvm.loop !7
...
for.cond.i37:                                     ; preds = %if.end.i33, %for.cond.i37
  ...
  br i1 %cmp.i20.not.i36, label %for.end.i38, label %for.cond.i37, !llvm.loop !9
