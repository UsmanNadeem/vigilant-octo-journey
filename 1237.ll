; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20041112-1.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20041112-1.c"
...
entry:
  ...
  %.op = add nsw i32 %0, 1
  %storemerge = select i1 %cmp.i, i32 %.op, i32 select (i1 icmp eq (ptr inttoptr (i64 -1 to ptr), ptr @global), i32 2, i32 1)
