; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher-bm.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_matcher-bm.c"
...
if.then27:                                        ; preds = %if.then25
  %idxprom.le = zext i32 %conv3200 to i64
  %arrayidx.le = getelementptr inbounds i8, ptr %0, i64 %idxprom.le
...
if.end90:                                         ; preds = %lor.lhs.false74, %if.end52
  ...
  %17 = select i1 %cmp111271, i1 %cmp113272, i1 false
