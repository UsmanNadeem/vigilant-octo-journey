; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/Zip/ZipIn.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/Zip/ZipIn.cpp"
...
cleanup61.thread:                                 ; preds = %if.then.i129, %_ZN8NArchive4NZipL20TestMarkerCandidate2EPKhRj.exit, %_ZN8NArchive4NZipL20TestMarkerCandidate2EPKhRj.exit.us, %if.then.i129.us
  %.us-phi165.in = phi i64 [ %indvars.iv190, %if.then.i129.us ], [ %indvars.iv190, %_ZN8NArchive4NZipL20TestMarkerCandidate2EPKhRj.exit.us ], [ %indvars.iv, %_ZN8NArchive4NZipL20TestMarkerCandidate2EPKhRj.exit ], [ %indvars.iv, %if.then.i129 ]
  %.us-phi166 = phi i64 [ %curTestPos.0.us, %if.then.i129.us ], [ %curTestPos.0.us, %_ZN8NArchive4NZipL20TestMarkerCandidate2EPKhRj.exit.us ], [ %curTestPos.0170, %_ZN8NArchive4NZipL20TestMarkerCandidate2EPKhRj.exit ], [ %curTestPos.0170, %if.then.i129 ]
  %idxprom.le = and i64 %.us-phi165.in, 4294967295
  %add56 = add i64 %.us-phi166, %idxprom.le
...
define linkonce_odr dso_local void @_ZN8NArchive4NZip5CItemD2Ev(ptr noundef nonnull align 8 dereferenceable(179) %this) unnamed_addr #7 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
...
if.then20:                                        ; preds = %for.body
  %indvars142.le = trunc i64 %indvars.iv to i32
  ...
  %sub30.neg = sub i32 16, %add
  %sub32 = add i32 %sub30.neg, %indvars142.le
...
; Function Attrs: uwtable
define dso_local noundef i32 @_ZN8NArchive4NZip10CInArchive6FindCdERNS0_7CCdInfoE(ptr noundef nonnull align 8 dereferenceable(138) %this, ptr nocapture noundef nonnull align 8 dereferenceable(16) %cdInfo) local_unnamed_addr #2 align 2 personality ptr @__gxx_personality_v0 {
entry:
...
if.end.i:                                         ; preds = %entry
  ...
  %2 = load i64, ptr %endPosition, align 8, !tbaa !34
...
if.then45:                                        ; preds = %if.then40
  %add.ptr46 = getelementptr inbounds i8, ptr %add.ptr43, i64 8
...
if.then73:                                        ; preds = %if.end68
  %idx.ext.le = and i64 %indvars.iv, 4294967295
  ...
  %add85 = add i64 %sub83, %idx.ext.le
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc198
  ...
  %or.cond = select i1 %tobool.not, i1 %cmp43, i1 false
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local void @_ZN8NArchive4NZip11CExtraBlockD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) unnamed_addr #7 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local void @_ZN8NArchive4NZip10CLocalItemD2Ev(ptr noundef nonnull align 8 dereferenceable(80) %this) unnamed_addr #7 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN13CObjectVectorIN8NArchive4NZip14CExtraSubBlockEED2Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) unnamed_addr #5 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN8NArchive4NZip14CExtraSubBlockEE, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !20
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %this)
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN13CObjectVectorIN8NArchive4NZip14CExtraSubBlockEED0Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) unnamed_addr #5 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN8NArchive4NZip14CExtraSubBlockEE, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !20
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %this)
          to label %_ZN13CObjectVectorIN8NArchive4NZip14CExtraSubBlockEED2Ev.exit unwind label %terminate.lpad.i
