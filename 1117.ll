; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/SplitHandler.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/SplitHandler.cpp"
...
if.end23:                                         ; preds = %for.body
  ...
  %or.cond172 = select i1 %or.cond, i1 %cmp26, i1 false
...
for.body.lr.ph.i.i.i:                             ; preds = %for.cond.preheader.i.i.i
  ...
  %or.cond932 = select i1 %min.iters.check, i1 true, i1 %diff.check
