; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_mspack.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_mspack.c"
...
if.end:                                           ; preds = %entry
  %call = tail call ptr @cli_malloc(i64 noundef 35760) #12
  %tobool1.not = icmp eq ptr %call, null
  br i1 %tobool1.not, label %cleanup, label %if.end3

if.end3:                                          ; preds = %if.end
  %conv = sext i32 %and to i64
  %call4 = tail call ptr @cli_malloc(i64 noundef %conv) #12
...
if.then:                                          ; preds = %entry
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.19, i32 noundef %data_flushed, i32 noundef %add) #12
  br label %return
...
land.lhs.true:                                    ; preds = %if.then13
  ...
  %call = tail call i32 @cli_writen(i32 noundef %4, ptr noundef %2, i32 noundef %i.0) #12
...
cond.true.i:                                      ; preds = %if.then45
  ...
  %call.i = tail call i32 %10(ptr noundef %13, ptr noundef %11, i32 noundef %12) #12
  br label %cond.end.i

cond.false.i:                                     ; preds = %if.then45
  %14 = load i32, ptr %zip, align 8, !tbaa !11
  %call5.i = tail call i32 @cli_readn(i32 noundef %14, ptr noundef %11, i32 noundef %12) #12
  br label %cond.end.i
...
do.end56:                                         ; preds = %if.end53, %do.body36
  ...
  %or.cond155 = select i1 %cmp65, i1 %cmp68, i1 false
...
if.then87:                                        ; preds = %do.end77
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str, i32 noundef %call85) #12
...
if.then89:                                        ; preds = %if.then87
  ...
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.1, i32 noundef %sub91) #12
...
for.body.preheader:                               ; preds = %if.then89
  ...
  %uglygep278 = getelementptr i8, ptr %window102, i64 %22
  %23 = sub i32 32767, %21
  %24 = zext i32 %23 to i64
  %25 = add nuw nsw i64 %24, 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %uglygep278, i8 0, i64 %25, i1 false), !tbaa !28
  br label %for.end
...
land.lhs.true123:                                 ; preds = %if.end101
  ...
  %call126 = tail call i32 @cli_writen(i32 noundef %28, ptr noundef nonnull %window102, i32 noundef %cond119) #12
...
if.then146:                                       ; preds = %while.cond.preheader, %while.end144
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.2) #12
  br label %cleanup.sink.split
...
entry:
  %zip1702 = ptrtoint ptr %zip to i64
  ...
  %uglygep1522 = getelementptr i8, ptr %zip, i64 236
  %uglygep1524 = getelementptr i8, ptr %zip, i64 348
  %uglygep1526 = getelementptr i8, ptr %zip, i64 372
  %arrayidx.3 = getelementptr inbounds [4 x i8], ptr %lens_buf, i64 0, i64 3
  %4 = add i64 %zip1702, 2972
  %5 = add i64 %zip1702, 2972
  br label %do.body5
...
do.body5:                                         ; preds = %do.cond599, %entry
  ...
  %cmp1338 = icmp slt i32 %bits_left.0, 1
  br i1 %cmp1338, label %while.body, label %do.end14

while.body:                                       ; preds = %do.body5, %if.end12
  %i_end.11342 = phi ptr [ %i_end.2, %if.end12 ], [ %i_end.0, %do.body5 ]
  %i_ptr.11341 = phi ptr [ %incdec.ptr, %if.end12 ], [ %i_ptr.0, %do.body5 ]
  %bits_left.11340 = phi i32 [ %add, %if.end12 ], [ %bits_left.0, %do.body5 ]
  %bit_buffer.11339 = phi i32 [ %or, %if.end12 ], [ %bit_buffer.0, %do.body5 ]
  %cmp8.not = icmp ult ptr %i_ptr.11341, %i_end.11342
...
cond.true.i:                                      ; preds = %if.then
  ...
  %call.i = tail call i32 %6(ptr noundef %9, ptr noundef %7, i32 noundef %8) #12
  br label %cond.end.i

cond.false.i:                                     ; preds = %if.then
  %10 = load i32, ptr %zip, align 8, !tbaa !11
  %call5.i = tail call i32 @cli_readn(i32 noundef %10, ptr noundef %7, i32 noundef %8) #12
  br label %cond.end.i
...
if.end12:                                         ; preds = %if.end, %while.body
  %i_ptr.2 = phi ptr [ %13, %if.end ], [ %i_ptr.11341, %while.body ]
  %i_end.2 = phi ptr [ %arrayidx18.i, %if.end ], [ %i_end.11342, %while.body ]
  %incdec.ptr = getelementptr inbounds i8, ptr %i_ptr.2, i64 1
  %14 = load i8, ptr %i_ptr.2, align 1, !tbaa !28
  %conv = zext i8 %14 to i32
  %shl = shl nuw nsw i32 %conv, %bits_left.11340
  %or = or i32 %shl, %bit_buffer.11339
  %add = add nsw i32 %bits_left.11340, 8
  %cmp = icmp slt i32 %bits_left.11340, -7
...
do.end14:                                         ; preds = %if.end12, %do.body5
  ...
  %cmp201346 = icmp ult i32 %bits_left.1.lcssa, 3
  br i1 %cmp201346, label %while.body22, label %do.end41

while.body22:                                     ; preds = %do.end14, %if.end33
  %i_end.31350 = phi ptr [ %i_end.4, %if.end33 ], [ %i_end.1.lcssa, %do.end14 ]
  %i_ptr.31349 = phi ptr [ %incdec.ptr34, %if.end33 ], [ %i_ptr.1.lcssa, %do.end14 ]
  %bits_left.21348 = phi i32 [ %add38, %if.end33 ], [ %sub, %do.end14 ]
  %bit_buffer.21347 = phi i32 [ %or37, %if.end33 ], [ %shr, %do.end14 ]
  %cmp23.not = icmp ult ptr %i_ptr.31349, %i_end.31350
...
cond.true.i913:                                   ; preds = %if.then25
  ...
  %call.i912 = tail call i32 %15(ptr noundef %18, ptr noundef %16, i32 noundef %17) #12
  br label %cond.end.i920

cond.false.i917:                                  ; preds = %if.then25
  %19 = load i32, ptr %zip, align 8, !tbaa !11
  %call5.i916 = tail call i32 @cli_readn(i32 noundef %19, ptr noundef %16, i32 noundef %17) #12
  br label %cond.end.i920
...
if.end33:                                         ; preds = %if.end30, %while.body22
  %i_ptr.4 = phi ptr [ %22, %if.end30 ], [ %i_ptr.31349, %while.body22 ]
  %i_end.4 = phi ptr [ %arrayidx18.i936, %if.end30 ], [ %i_end.31350, %while.body22 ]
  %incdec.ptr34 = getelementptr inbounds i8, ptr %i_ptr.4, i64 1
  %23 = load i8, ptr %i_ptr.4, align 1, !tbaa !28
  %conv35 = zext i8 %23 to i32
  %shl36 = shl nuw nsw i32 %conv35, %bits_left.21348
  %or37 = or i32 %shl36, %bit_buffer.21347
  %add38 = add nuw nsw i32 %bits_left.21348, 8
  %cmp20 = icmp slt i32 %bits_left.21348, -6
...
if.then49:                                        ; preds = %do.end41
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %lens_buf) #12
  %and50 = and i32 %sub44, 7
  %shr51 = lshr i32 %shr43, %and50
  %sub52 = and i32 %sub44, -8
  %cmp53.not1365 = icmp eq i32 %sub52, 0
  br i1 %cmp53.not1365, label %while.body70.preheader, label %for.body.preheader
...
while.body70:                                     ; preds = %while.body70.preheader, %if.end81
  ...
  %i_end.51375 = phi ptr [ %i_end.3.lcssa, %while.body70.preheader ], [ %i_end.6, %if.end81 ]
  %i_ptr.51374 = phi ptr [ %i_ptr.3.lcssa, %while.body70.preheader ], [ %incdec.ptr82, %if.end81 ]
  %cmp71.not = icmp ult ptr %i_ptr.51374, %i_end.51375
...
cond.true.i947:                                   ; preds = %if.then73
  ...
  %call.i946 = tail call i32 %24(ptr noundef %27, ptr noundef %25, i32 noundef %26) #12
  br label %cond.end.i954

cond.false.i951:                                  ; preds = %if.then73
  %28 = load i32, ptr %zip, align 8, !tbaa !11
  %call5.i950 = tail call i32 @cli_readn(i32 noundef %28, ptr noundef %25, i32 noundef %26) #12
  br label %cond.end.i954
...
if.end81:                                         ; preds = %if.end78, %while.body70
  %i_ptr.6 = phi ptr [ %31, %if.end78 ], [ %i_ptr.51374, %while.body70 ]
  %i_end.6 = phi ptr [ %arrayidx18.i970, %if.end78 ], [ %i_end.51375, %while.body70 ]
...
while.end86:                                      ; preds = %for.body.3, %while.end86.loopexit
  %bit_buffer.3.lcssa1538 = phi i32 [ %bit_buffer.3.lcssa.ph, %while.end86.loopexit ], [ 0, %for.body.3 ]
...
while.cond104.preheader:                          ; preds = %while.end86
  %cmp105.not1378 = icmp eq i32 %or92, 0
  br i1 %cmp105.not1378, label %cleanup, label %while.body107

while.body107:                                    ; preds = %while.cond104.preheader, %if.end151
  %i_end.71381 = phi ptr [ %i_end.8, %if.end151 ], [ %i_end.5.lcssa, %while.cond104.preheader ]
  %i_ptr.71380 = phi ptr [ %add.ptr, %if.end151 ], [ %i_ptr.5.lcssa, %while.cond104.preheader ]
  %length.01379 = phi i32 [ %sub141, %if.end151 ], [ %or92, %while.cond104.preheader ]
  %cmp108.not = icmp ult ptr %i_ptr.71380, %i_end.71381
...
cond.true.i981:                                   ; preds = %if.then110
  ...
  %call.i980 = tail call i32 %37(ptr noundef %40, ptr noundef %38, i32 noundef %39) #12
  br label %cond.end.i988

cond.false.i985:                                  ; preds = %if.then110
  %41 = load i32, ptr %zip, align 8, !tbaa !11
  %call5.i984 = tail call i32 @cli_readn(i32 noundef %41, ptr noundef %38, i32 noundef %39) #12
  br label %cond.end.i988
...
if.end118:                                        ; preds = %if.end115, %while.body107
  %i_ptr.8 = phi ptr [ %44, %if.end115 ], [ %i_ptr.71380, %while.body107 ]
  %i_end.8 = phi ptr [ %arrayidx18.i1004, %if.end115 ], [ %i_end.71381, %while.body107 ]
  ...
  %spec.select = tail call i32 @llvm.umin.i32(i32 %length.01379, i32 %conv119)
  ...
  %sub141 = sub i32 %length.01379, %this_run.1
...
if.then145:                                       ; preds = %if.end118
  ...
  %call146 = tail call i32 %47(ptr noundef nonnull %zip, i32 noundef 32768) #12
...
cleanup.thread:                                   ; preds = %while.end86, %for.body.3, %if.then145, %cleanup.thread.sink.split
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %lens_buf) #12
  br label %cleanup619
...
for.cond197.preheader:                            ; preds = %do.end41
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(112) %uglygep1522, i8 9, i64 112, i1 false), !tbaa !28
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(24) %uglygep1524, i8 7, i64 24, i1 false), !tbaa !28
  store i64 578721382704613384, ptr %uglygep1526, align 1
...
do.body207:                                       ; preds = %do.end41
  ...
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %bl_table.i) #12
  call void @llvm.lifetime.start.p0(i64 19, ptr nonnull %bl_len.i) #12
  call void @llvm.lifetime.start.p0(i64 320, ptr nonnull %lens.i) #12
...
cond.true.i.i:                                    ; preds = %if.then.i1009
  ...
  %call.i.i = tail call i32 %48(ptr noundef %51, ptr noundef %49, i32 noundef %50) #12
  br label %cond.end.i.i

cond.false.i.i:                                   ; preds = %if.then.i1009
  %52 = load i32, ptr %zip, align 8, !tbaa !11
  %call5.i.i = tail call i32 @cli_readn(i32 noundef %52, ptr noundef %49, i32 noundef %50) #12
  br label %cond.end.i.i
...
cond.true.i509.i:                                 ; preds = %if.then25.i
  ...
  %call.i508.i = tail call i32 %57(ptr noundef %60, ptr noundef %58, i32 noundef %59) #12
  br label %cond.end.i516.i

cond.false.i513.i:                                ; preds = %if.then25.i
  %61 = load i32, ptr %zip, align 8, !tbaa !11
  %call5.i512.i = tail call i32 @cli_readn(i32 noundef %61, ptr noundef %58, i32 noundef %59) #12
  br label %cond.end.i516.i
...
cond.true.i543.i:                                 ; preds = %if.then56.i
  ...
  %call.i542.i = tail call i32 %66(ptr noundef %69, ptr noundef %67, i32 noundef %68) #12
  br label %cond.end.i550.i

cond.false.i547.i:                                ; preds = %if.then56.i
  %70 = load i32, ptr %zip, align 8, !tbaa !11
  %call5.i546.i = tail call i32 @cli_readn(i32 noundef %70, ptr noundef %67, i32 noundef %68) #12
  br label %cond.end.i550.i
...
cond.true.i577.i:                                 ; preds = %if.then97.i
  ...
  %call.i576.i = tail call i32 %81(ptr noundef %84, ptr noundef %82, i32 noundef %83) #12
  br label %cond.end.i584.i

cond.false.i581.i:                                ; preds = %if.then97.i
  %85 = load i32, ptr %zip, align 8, !tbaa !11
  %call5.i580.i = tail call i32 @cli_readn(i32 noundef %85, ptr noundef %82, i32 noundef %83) #12
  br label %cond.end.i584.i
...
while.end131.i:                                   ; preds = %while.body125.i.prol.loopexit, %while.body125.i, %while.cond122.preheader.i
  %call134.i = call fastcc i32 @mszip_make_decode_table(i32 noundef 19, i32 noundef 7, ptr noundef nonnull %bl_len.i, ptr noundef nonnull %bl_table.i)
...
while.cond144.preheader.i:                        ; preds = %for.inc296.i, %for.cond138.preheader.i
  ...
  %last_code.0962.i = phi i8 [ 0, %for.cond138.preheader.i ], [ %last_code.1.i, %for.inc296.i ]
...
cond.true.i611.i:                                 ; preds = %if.then150.i
  ...
  %call.i610.i = tail call i32 %96(ptr noundef %99, ptr noundef %97, i32 noundef %98) #12
  br label %cond.end.i618.i

cond.false.i615.i:                                ; preds = %if.then150.i
  %100 = load i32, ptr %zip, align 8, !tbaa !11
  %call5.i614.i = tail call i32 @cli_readn(i32 noundef %100, ptr noundef %97, i32 noundef %98) #12
  br label %cond.end.i618.i
...
if.end158.i:                                      ; preds = %if.end155.i, %while.body147.i
  ...
  br i1 %cmp145.i, label %while.body147.i, label %do.end166.i, !llvm.loop !47
...
do.end166.i:                                      ; preds = %if.end158.i, %while.cond144.preheader.i
  ...
  %105 = load i16, ptr %arrayidx169.i, align 2, !tbaa !48
...
cond.true.i645.i:                                 ; preds = %if.then193.i
  ...
  %call.i644.i = tail call i32 %107(ptr noundef %110, ptr noundef %108, i32 noundef %109) #12
  br label %cond.end.i652.i

cond.false.i649.i:                                ; preds = %if.then193.i
  %111 = load i32, ptr %zip, align 8, !tbaa !11
  %call5.i648.i = tail call i32 @cli_readn(i32 noundef %111, ptr noundef %108, i32 noundef %109) #12
  br label %cond.end.i652.i
...
if.end201.i:                                      ; preds = %if.end198.i, %while.body190.i
  ...
  br i1 %cmp188.i, label %while.body190.i, label %do.end209.i, !llvm.loop !50
...
cond.true.i679.i:                                 ; preds = %if.then225.i
  ...
  %call.i678.i = tail call i32 %116(ptr noundef %119, ptr noundef %117, i32 noundef %118) #12
  br label %cond.end.i686.i

cond.false.i683.i:                                ; preds = %if.then225.i
  %120 = load i32, ptr %zip, align 8, !tbaa !11
  %call5.i682.i = tail call i32 @cli_readn(i32 noundef %120, ptr noundef %117, i32 noundef %118) #12
  br label %cond.end.i686.i
...
if.end233.i:                                      ; preds = %if.end230.i, %while.body222.i
  ...
  br i1 %cmp220.i, label %while.body222.i, label %do.end241.i, !llvm.loop !51
...
cond.true.i713.i:                                 ; preds = %if.then257.i
  ...
  %call.i712.i = tail call i32 %125(ptr noundef %128, ptr noundef %126, i32 noundef %127) #12
  br label %cond.end.i720.i

cond.false.i717.i:                                ; preds = %if.then257.i
  %129 = load i32, ptr %zip, align 8, !tbaa !11
  %call5.i716.i = tail call i32 @cli_readn(i32 noundef %129, ptr noundef %126, i32 noundef %127) #12
  br label %cond.end.i720.i
...
if.end265.i:                                      ; preds = %if.end262.i, %while.body254.i
  ...
  br i1 %cmp252.i, label %while.body254.i, label %do.end273.i, !llvm.loop !52
...
sw.default.i:                                     ; preds = %if.else.i1012
  %conv170.le.i = zext i16 %105 to i32
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.23, i32 noundef %conv170.le.i) #12
  br label %mszip_read_lens.exit.thread
...
sw.epilog.i:                                      ; preds = %do.end273.i, %do.end241.i, %do.end209.i
  ...
  %code.0.i = phi i8 [ 0, %do.end273.i ], [ 0, %do.end241.i ], [ %last_code.0962.i, %do.end209.i ]
  ...
  br i1 %cmp282.i, label %mszip_read_lens.exit.thread, label %while.body288.i.preheader

while.body288.i.preheader:                        ; preds = %sw.epilog.i
  %min.iters.check1729 = icmp ult i32 %run.0.i, 32
  br i1 %min.iters.check1729, label %while.body288.i.preheader1745, label %vector.scevcheck

vector.scevcheck:                                 ; preds = %while.body288.i.preheader
  %134 = add nsw i32 %run.0.i, -1
  %135 = xor i32 %i.2963.i, -1
  %136 = icmp ugt i32 %134, %135
  br i1 %136, label %while.body288.i.preheader1745, label %vector.ph1730

vector.ph1730:                                    ; preds = %vector.scevcheck
  %n.vec1732 = and i32 %run.0.i, -32
  %ind.end1733 = and i32 %run.0.i, 31
  %ind.end1735 = add i32 %i.2963.i, %n.vec1732
  %broadcast.splatinsert = insertelement <16 x i8> poison, i8 %code.0.i, i64 0
  %broadcast.splat = shufflevector <16 x i8> %broadcast.splatinsert, <16 x i8> poison, <16 x i32> zeroinitializer
  %broadcast.splatinsert1740 = insertelement <16 x i8> poison, i8 %code.0.i, i64 0
  %broadcast.splat1741 = shufflevector <16 x i8> %broadcast.splatinsert1740, <16 x i8> poison, <16 x i32> zeroinitializer
  ...
  store <16 x i8> %broadcast.splat1741, ptr %139, align 1, !tbaa !28
  %140 = icmp eq i32 %n.vec1732, 32
  br i1 %140, label %middle.block1728, label %vector.body1738.1, !llvm.loop !53

vector.body1738.1:                                ; preds = %vector.ph1730
  ...
  store <16 x i8> %broadcast.splat1741, ptr %143, align 1, !tbaa !28
  %144 = icmp eq i32 %n.vec1732, 64
  br i1 %144, label %middle.block1728, label %vector.body1738.2, !llvm.loop !53

vector.body1738.2:                                ; preds = %vector.body1738.1
  ...
  store <16 x i8> %broadcast.splat1741, ptr %147, align 1, !tbaa !28
  %148 = icmp eq i32 %n.vec1732, 96
  br i1 %148, label %middle.block1728, label %vector.body1738.3, !llvm.loop !53

vector.body1738.3:                                ; preds = %vector.body1738.2
  ...
  store <16 x i8> %broadcast.splat1741, ptr %151, align 1, !tbaa !28
  br label %middle.block1728

middle.block1728:                                 ; preds = %vector.body1738.3, %vector.body1738.2, %vector.body1738.1, %vector.ph1730
  %cmp.n1737 = icmp eq i32 %run.0.i, %n.vec1732
  br i1 %cmp.n1737, label %for.inc296.i, label %while.body288.i.preheader1745

while.body288.i.preheader1745:                    ; preds = %vector.scevcheck, %while.body288.i.preheader, %middle.block1728
  %run.1957.i.ph = phi i32 [ %run.0.i, %vector.scevcheck ], [ %run.0.i, %while.body288.i.preheader ], [ %ind.end1733, %middle.block1728 ]
  %i.3956.i.ph = phi i32 [ %i.2963.i, %vector.scevcheck ], [ %i.2963.i, %while.body288.i.preheader ], [ %ind.end1735, %middle.block1728 ]
  %152 = add nsw i32 %run.1957.i.ph, -1
  %xtraiter1856 = and i32 %run.1957.i.ph, 3
  %lcmp.mod1857.not = icmp eq i32 %xtraiter1856, 0
  br i1 %lcmp.mod1857.not, label %while.body288.i.prol.loopexit, label %while.body288.i.prol

while.body288.i.prol:                             ; preds = %while.body288.i.preheader1745, %while.body288.i.prol
  %run.1957.i.prol = phi i32 [ %dec.i.prol, %while.body288.i.prol ], [ %run.1957.i.ph, %while.body288.i.preheader1745 ]
  %i.3956.i.prol = phi i32 [ %inc290.i.prol, %while.body288.i.prol ], [ %i.3956.i.ph, %while.body288.i.preheader1745 ]
  %prol.iter1858 = phi i32 [ %prol.iter1858.next, %while.body288.i.prol ], [ 0, %while.body288.i.preheader1745 ]
  ...
  store i8 %code.0.i, ptr %arrayidx292.i.prol, align 1, !tbaa !28
  %prol.iter1858.next = add i32 %prol.iter1858, 1
  %prol.iter1858.cmp.not = icmp eq i32 %prol.iter1858.next, %xtraiter1856
  br i1 %prol.iter1858.cmp.not, label %while.body288.i.prol.loopexit, label %while.body288.i.prol, !llvm.loop !56

while.body288.i.prol.loopexit:                    ; preds = %while.body288.i.prol, %while.body288.i.preheader1745
  %inc290.i.lcssa.unr = phi i32 [ undef, %while.body288.i.preheader1745 ], [ %inc290.i.prol, %while.body288.i.prol ]
  %run.1957.i.unr = phi i32 [ %run.1957.i.ph, %while.body288.i.preheader1745 ], [ %dec.i.prol, %while.body288.i.prol ]
  %i.3956.i.unr = phi i32 [ %i.3956.i.ph, %while.body288.i.preheader1745 ], [ %inc290.i.prol, %while.body288.i.prol ]
...
while.body288.i:                                  ; preds = %while.body288.i.prol.loopexit, %while.body288.i
  ...
  store i8 %code.0.i, ptr %arrayidx292.i, align 1, !tbaa !28
  ...
  store i8 %code.0.i, ptr %arrayidx292.i.1, align 1, !tbaa !28
  ...
  store i8 %code.0.i, ptr %arrayidx292.i.2, align 1, !tbaa !28
  ...
  store i8 %code.0.i, ptr %arrayidx292.i.3, align 1, !tbaa !28
  %tobool287.not.i.3 = icmp eq i32 %dec.i.3, 0
  br i1 %tobool287.not.i.3, label %for.inc296.i, label %while.body288.i, !llvm.loop !57

for.inc296.i:                                     ; preds = %while.body288.i.prol.loopexit, %while.body288.i, %middle.block1728, %if.then181.i
  %inc297.pre-phi.i = phi i32 [ %.pre.i, %if.then181.i ], [ %ind.end1735, %middle.block1728 ], [ %inc290.i.lcssa.unr, %while.body288.i.prol.loopexit ], [ %inc290.i.3, %while.body288.i ]
  %bit_buffer.11.i = phi i32 [ %shr174.i, %if.then181.i ], [ %bit_buffer.10.i, %middle.block1728 ], [ %bit_buffer.10.i, %while.body288.i ], [ %bit_buffer.10.i, %while.body288.i.prol.loopexit ]
  %bits_left.11.i = phi i32 [ %sub178.i, %if.then181.i ], [ %bits_left.10.i, %middle.block1728 ], [ %bits_left.10.i, %while.body288.i ], [ %bits_left.10.i, %while.body288.i.prol.loopexit ]
  %i_ptr.19.i = phi ptr [ %i_ptr.10.lcssa.i, %if.then181.i ], [ %i_ptr.18.i, %middle.block1728 ], [ %i_ptr.18.i, %while.body288.i ], [ %i_ptr.18.i, %while.body288.i.prol.loopexit ]
  %i_end.19.i = phi ptr [ %i_end.10.lcssa.i, %if.then181.i ], [ %i_end.18.i, %middle.block1728 ], [ %i_end.18.i, %while.body288.i ], [ %i_end.18.i, %while.body288.i.prol.loopexit ]
  %last_code.1.i = phi i8 [ %conv170.i, %if.then181.i ], [ %last_code.0962.i, %middle.block1728 ], [ %last_code.0962.i, %while.body288.i ], [ %last_code.0962.i, %while.body288.i.prol.loopexit ]
  %cmp140.i = icmp ult i32 %inc297.pre-phi.i, %add139.i
  br i1 %cmp140.i, label %while.cond144.preheader.i, label %for.end298.i, !llvm.loop !58
...
while.body305.preheader.i:                        ; preds = %for.end298.i
  ...
  %uglygep.i = getelementptr i8, ptr %zip, i64 %154
  %155 = sub nsw i32 30, %and.i
  %156 = zext i32 %155 to i64
  %157 = add nuw nsw i64 %156, 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %uglygep.i, i8 0, i64 %157, i1 false), !tbaa !28
...
while.body318.preheader.i:                        ; preds = %while.end310.i
  ...
  %uglygep988.i = getelementptr i8, ptr %zip, i64 %158
  %159 = sub nsw i32 30, %and42.i
  %160 = zext i32 %159 to i64
  %161 = add nuw nsw i64 %160, 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %uglygep988.i, i8 0, i64 %161, i1 false), !tbaa !28
  br label %do.body218
...
mszip_read_lens.exit.thread:                      ; preds = %while.end131.i, %sw.epilog.i, %sw.default.i, %if.then.i.i, %if.then9.i.i, %if.then.i518.i, %if.then9.i525.i, %if.then.i552.i, %if.then9.i559.i, %if.then.i586.i, %if.then9.i593.i, %if.then.i620.i, %if.then9.i627.i, %if.then.i654.i, %if.then9.i661.i, %if.then.i688.i, %if.then9.i695.i, %if.then.i722.i, %if.then9.i729.i
  ...
  call void @llvm.lifetime.end.p0(i64 320, ptr nonnull %lens.i) #12
  call void @llvm.lifetime.end.p0(i64 19, ptr nonnull %bl_len.i) #12
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %bl_table.i) #12
  br label %cleanup619
...
if.end225:                                        ; preds = %for.cond197.preheader, %do.body218
  ...
  %call229 = tail call fastcc i32 @mszip_make_decode_table(i32 noundef 288, i32 noundef 9, ptr noundef nonnull %LITERAL_len.i, ptr noundef nonnull %LITERAL_table)
  %tobool230.not = icmp eq i32 %call229, 0
  br i1 %tobool230.not, label %if.end232, label %cleanup619

if.end232:                                        ; preds = %if.end225
  %call236 = tail call fastcc i32 @mszip_make_decode_table(i32 noundef 32, i32 noundef 6, ptr noundef nonnull %DISTANCE_len.i, ptr noundef nonnull %DISTANCE_table)
...
while.cond241:                                    ; preds = %while.cond241.outer, %while.cond513.preheader
  ...
  %cmp2461384 = icmp slt i32 %bits_left.5, 16
  br i1 %cmp2461384, label %while.body248, label %do.end267

while.body248:                                    ; preds = %while.cond241, %if.end259
  %i_end.121388 = phi ptr [ %i_end.13, %if.end259 ], [ %i_end.11, %while.cond241 ]
  %i_ptr.121387 = phi ptr [ %incdec.ptr260, %if.end259 ], [ %i_ptr.11, %while.cond241 ]
  %bits_left.61386 = phi i32 [ %add264, %if.end259 ], [ %bits_left.5, %while.cond241 ]
  %bit_buffer.61385 = phi i32 [ %or263, %if.end259 ], [ %bit_buffer.5, %while.cond241 ]
  %cmp249.not = icmp ult ptr %i_ptr.121387, %i_end.121388
...
cond.true.i1020:                                  ; preds = %if.then251
  ...
  %call.i1019 = tail call i32 %163(ptr noundef %166, ptr noundef %164, i32 noundef %165) #12
  br label %cond.end.i1027

cond.false.i1024:                                 ; preds = %if.then251
  %167 = load i32, ptr %zip, align 8, !tbaa !11
  %call5.i1023 = tail call i32 @cli_readn(i32 noundef %167, ptr noundef %164, i32 noundef %165) #12
  br label %cond.end.i1027
...
if.end259:                                        ; preds = %if.end256, %while.body248
  %i_ptr.13 = phi ptr [ %170, %if.end256 ], [ %i_ptr.121387, %while.body248 ]
  %i_end.13 = phi ptr [ %arrayidx18.i1043, %if.end256 ], [ %i_end.121388, %while.body248 ]
  ...
  %shl262 = shl nuw nsw i32 %conv261, %bits_left.61386
  %or263 = or i32 %shl262, %bit_buffer.61385
  %add264 = add nsw i32 %bits_left.61386, 8
  %cmp246 = icmp slt i32 %bits_left.61386, 8
  br i1 %cmp246, label %while.body248, label %do.end267, !llvm.loop !59
...
do.end267:                                        ; preds = %if.end259, %while.cond241
  ...
  %172 = load i16, ptr %arrayidx271, align 2, !tbaa !48
...
if.end292:                                        ; preds = %do.body276.preheader
  ...
  %174 = load i16, ptr %arrayidx295, align 2, !tbaa !48
  %cmp298 = icmp ugt i16 %174, 287
  br i1 %cmp298, label %do.body276.1, label %if.end301, !llvm.loop !60
...
if.end292.1:                                      ; preds = %do.body276.1
  ...
  %176 = load i16, ptr %arrayidx295.1, align 2, !tbaa !48
  %cmp298.1 = icmp ugt i16 %176, 287
  br i1 %cmp298.1, label %do.body276.2, label %if.end301, !llvm.loop !60
...
if.end292.2:                                      ; preds = %do.body276.2
  ...
  %178 = load i16, ptr %arrayidx295.2, align 2, !tbaa !48
  %cmp298.2 = icmp ugt i16 %178, 287
  br i1 %cmp298.2, label %do.body276.3, label %if.end301, !llvm.loop !60
...
if.end292.3:                                      ; preds = %do.body276.3
  ...
  %180 = load i16, ptr %arrayidx295.3, align 2, !tbaa !48
  %cmp298.3 = icmp ugt i16 %180, 287
  br i1 %cmp298.3, label %do.body276.4, label %if.end301, !llvm.loop !60
...
if.end292.4:                                      ; preds = %do.body276.4
  ...
  %182 = load i16, ptr %arrayidx295.4, align 2, !tbaa !48
  %cmp298.4 = icmp ugt i16 %182, 287
  br i1 %cmp298.4, label %do.body276.5, label %if.end301, !llvm.loop !60
...
if.end292.5:                                      ; preds = %do.body276.5
  ...
  %184 = load i16, ptr %arrayidx295.5, align 2, !tbaa !48
  %cmp298.5 = icmp ugt i16 %184, 287
  br i1 %cmp298.5, label %do.body276.6, label %if.end301, !llvm.loop !60
...
if.end292.6:                                      ; preds = %do.body276.6
  ...
  %186 = load i16, ptr %arrayidx295.6, align 2, !tbaa !48
  %cmp298.6 = icmp ugt i16 %186, 287
  br i1 %cmp298.6, label %do.body276.7, label %if.end301, !llvm.loop !60
...
if.end292.7:                                      ; preds = %do.body276.7
  ...
  %188 = load i16, ptr %arrayidx295.7, align 2, !tbaa !48
  %cmp298.7 = icmp ugt i16 %188, 287
  br i1 %cmp298.7, label %do.body276.8, label %if.end301, !llvm.loop !60
...
if.end292.8:                                      ; preds = %do.body276.8
  ...
  %190 = load i16, ptr %arrayidx295.8, align 2, !tbaa !48
  %cmp298.8 = icmp ugt i16 %190, 287
  br i1 %cmp298.8, label %if.then280, label %if.end301, !llvm.loop !60
...
if.then321:                                       ; preds = %if.then313
  ...
  %call323 = tail call i32 %192(ptr noundef nonnull %zip, i32 noundef 32768) #12
...
while.cond340.preheader:                          ; preds = %if.else332
  ...
  %cmp3441394 = icmp slt i32 %sub308, %conv343
  br i1 %cmp3441394, label %while.body346, label %do.end365

while.body346:                                    ; preds = %while.cond340.preheader, %if.end357
  %i_end.141398 = phi ptr [ %i_end.15, %if.end357 ], [ %i_end.12.lcssa, %while.cond340.preheader ]
  %i_ptr.141397 = phi ptr [ %incdec.ptr358, %if.end357 ], [ %i_ptr.12.lcssa, %while.cond340.preheader ]
  %bits_left.71396 = phi i32 [ %add362, %if.end357 ], [ %sub308, %while.cond340.preheader ]
  %bit_buffer.71395 = phi i32 [ %or361, %if.end357 ], [ %shr307, %while.cond340.preheader ]
  %cmp347.not = icmp ult ptr %i_ptr.141397, %i_end.141398
...
cond.true.i1054:                                  ; preds = %if.then349
  ...
  %call.i1053 = tail call i32 %194(ptr noundef %197, ptr noundef %195, i32 noundef %196) #12
  br label %cond.end.i1061

cond.false.i1058:                                 ; preds = %if.then349
  %198 = load i32, ptr %zip, align 8, !tbaa !11
  %call5.i1057 = tail call i32 @cli_readn(i32 noundef %198, ptr noundef %195, i32 noundef %196) #12
  br label %cond.end.i1061
...
if.end357:                                        ; preds = %if.end354, %while.body346
  %i_ptr.15 = phi ptr [ %201, %if.end354 ], [ %i_ptr.141397, %while.body346 ]
  %i_end.15 = phi ptr [ %arrayidx18.i1077, %if.end354 ], [ %i_end.141398, %while.body346 ]
  ...
  %shl360 = shl i32 %conv359, %bits_left.71396
  %or361 = or i32 %shl360, %bit_buffer.71395
  %add362 = add nsw i32 %bits_left.71396, 8
  %cmp344 = icmp slt i32 %add362, %conv343
  br i1 %cmp344, label %while.body346, label %do.end365, !llvm.loop !61
...
do.end365:                                        ; preds = %if.end357, %while.cond340.preheader
  ...
  %203 = load i16, ptr %arrayidx369, align 2, !tbaa !48
  ...
  %204 = load i16, ptr %arrayidx383, align 2, !tbaa !48
  %conv384 = zext i16 %204 to i32
  %add385 = add nuw nsw i32 %and371, %conv384
  %cmp3891405 = icmp slt i32 %sub379, 16
  br i1 %cmp3891405, label %while.body391, label %do.end410

while.body391:                                    ; preds = %do.end365, %if.end402
  %i_end.161409 = phi ptr [ %i_end.17, %if.end402 ], [ %i_end.14.lcssa, %do.end365 ]
  %i_ptr.161408 = phi ptr [ %incdec.ptr403, %if.end402 ], [ %i_ptr.14.lcssa, %do.end365 ]
  %bits_left.81407 = phi i32 [ %add407, %if.end402 ], [ %sub379, %do.end365 ]
  %bit_buffer.81406 = phi i32 [ %or406, %if.end402 ], [ %shr375, %do.end365 ]
  %cmp392.not = icmp ult ptr %i_ptr.161408, %i_end.161409
...
cond.true.i1088:                                  ; preds = %if.then394
  ...
  %call.i1087 = tail call i32 %205(ptr noundef %208, ptr noundef %206, i32 noundef %207) #12
  br label %cond.end.i1095

cond.false.i1092:                                 ; preds = %if.then394
  %209 = load i32, ptr %zip, align 8, !tbaa !11
  %call5.i1091 = tail call i32 @cli_readn(i32 noundef %209, ptr noundef %206, i32 noundef %207) #12
  br label %cond.end.i1095
...
if.end402:                                        ; preds = %if.end399, %while.body391
  %i_ptr.17 = phi ptr [ %212, %if.end399 ], [ %i_ptr.161408, %while.body391 ]
  %i_end.17 = phi ptr [ %arrayidx18.i1111, %if.end399 ], [ %i_end.161409, %while.body391 ]
  ...
  %shl405 = shl nuw nsw i32 %conv404, %bits_left.81407
  %or406 = or i32 %shl405, %bit_buffer.81406
  %add407 = add nsw i32 %bits_left.81407, 8
  %cmp389 = icmp slt i32 %bits_left.81407, 8
  br i1 %cmp389, label %while.body391, label %do.end410, !llvm.loop !62
...
do.end410:                                        ; preds = %if.end402, %do.end365
  ...
  %214 = load i16, ptr %arrayidx414, align 2, !tbaa !48
...
if.end435:                                        ; preds = %do.body419.preheader
  ...
  %217 = load i16, ptr %arrayidx438, align 2, !tbaa !48
  %cmp441 = icmp ugt i16 %217, 31
  br i1 %cmp441, label %do.body419.1, label %if.end444, !llvm.loop !63
...
if.end435.1:                                      ; preds = %do.body419.1
  ...
  %220 = load i16, ptr %arrayidx438.1, align 2, !tbaa !48
  %cmp441.1 = icmp ugt i16 %220, 31
  br i1 %cmp441.1, label %do.body419.2, label %if.end444, !llvm.loop !63
...
if.end435.2:                                      ; preds = %do.body419.2
  ...
  %223 = load i16, ptr %arrayidx438.2, align 2, !tbaa !48
  %cmp441.2 = icmp ugt i16 %223, 31
  br i1 %cmp441.2, label %do.body419.3, label %if.end444, !llvm.loop !63
...
if.end435.3:                                      ; preds = %do.body419.3
  ...
  %226 = load i16, ptr %arrayidx438.3, align 2, !tbaa !48
  %cmp441.3 = icmp ugt i16 %226, 31
  br i1 %cmp441.3, label %do.body419.4, label %if.end444, !llvm.loop !63
...
if.end435.4:                                      ; preds = %do.body419.4
  ...
  %229 = load i16, ptr %arrayidx438.4, align 2, !tbaa !48
  %cmp441.4 = icmp ugt i16 %229, 31
  br i1 %cmp441.4, label %do.body419.5, label %if.end444, !llvm.loop !63
...
if.end435.5:                                      ; preds = %do.body419.5
  ...
  %232 = load i16, ptr %arrayidx438.5, align 2, !tbaa !48
  %cmp441.5 = icmp ugt i16 %232, 31
  br i1 %cmp441.5, label %do.body419.6, label %if.end444, !llvm.loop !63
...
if.end435.6:                                      ; preds = %do.body419.6
  ...
  %235 = load i16, ptr %arrayidx438.6, align 2, !tbaa !48
  %cmp441.6 = icmp ugt i16 %235, 31
  br i1 %cmp441.6, label %do.body419.7, label %if.end444, !llvm.loop !63
...
if.end435.7:                                      ; preds = %do.body419.7
  ...
  %238 = load i16, ptr %arrayidx438.7, align 2, !tbaa !48
  %cmp441.7 = icmp ugt i16 %238, 31
  br i1 %cmp441.7, label %do.body419.8, label %if.end444, !llvm.loop !63
...
if.end435.8:                                      ; preds = %do.body419.8
  ...
  %241 = load i16, ptr %arrayidx438.8, align 2, !tbaa !48
  %cmp441.8 = icmp ugt i16 %241, 31
  br i1 %cmp441.8, label %do.body419.9, label %if.end444, !llvm.loop !63
...
if.end435.9:                                      ; preds = %do.body419.9
  ...
  %244 = load i16, ptr %arrayidx438.9, align 2, !tbaa !48
  %cmp441.9 = icmp ugt i16 %244, 31
  br i1 %cmp441.9, label %do.body419.10, label %if.end444, !llvm.loop !63
...
if.end435.10:                                     ; preds = %do.body419.10
  ...
  %247 = load i16, ptr %arrayidx438.10, align 2, !tbaa !48
  %cmp441.10 = icmp ugt i16 %247, 31
  br i1 %cmp441.10, label %do.body419.11, label %if.end444, !llvm.loop !63
...
if.end435.11:                                     ; preds = %do.body419.11
  ...
  %250 = load i16, ptr %arrayidx438.11, align 2, !tbaa !48
  %cmp441.11 = icmp ugt i16 %250, 31
  br i1 %cmp441.11, label %if.then423, label %if.end444, !llvm.loop !63
...
while.cond460.preheader:                          ; preds = %if.end444
  ...
  %cmp4641415 = icmp slt i32 %sub451, %conv463
  br i1 %cmp4641415, label %while.body466, label %do.end485

while.body466:                                    ; preds = %while.cond460.preheader, %if.end477
  %i_end.181419 = phi ptr [ %i_end.19, %if.end477 ], [ %i_end.16.lcssa, %while.cond460.preheader ]
  %i_ptr.181418 = phi ptr [ %incdec.ptr478, %if.end477 ], [ %i_ptr.16.lcssa, %while.cond460.preheader ]
  %bits_left.91417 = phi i32 [ %add482, %if.end477 ], [ %sub451, %while.cond460.preheader ]
  %bit_buffer.91416 = phi i32 [ %or481, %if.end477 ], [ %shr450, %while.cond460.preheader ]
  %cmp467.not = icmp ult ptr %i_ptr.181418, %i_end.181419
...
cond.true.i1122:                                  ; preds = %if.then469
  ...
  %call.i1121 = tail call i32 %253(ptr noundef %256, ptr noundef %254, i32 noundef %255) #12
  br label %cond.end.i1129

cond.false.i1126:                                 ; preds = %if.then469
  %257 = load i32, ptr %zip, align 8, !tbaa !11
  %call5.i1125 = tail call i32 @cli_readn(i32 noundef %257, ptr noundef %254, i32 noundef %255) #12
  br label %cond.end.i1129
...
if.end477:                                        ; preds = %if.end474, %while.body466
  %i_ptr.19 = phi ptr [ %260, %if.end474 ], [ %i_ptr.181418, %while.body466 ]
  %i_end.19 = phi ptr [ %arrayidx18.i1145, %if.end474 ], [ %i_end.181419, %while.body466 ]
  ...
  %shl480 = shl i32 %conv479, %bits_left.91417
  %or481 = or i32 %shl480, %bit_buffer.91416
  %add482 = add nsw i32 %bits_left.91417, 8
  %cmp464 = icmp slt i32 %add482, %conv463
  br i1 %cmp464, label %while.body466, label %do.end485, !llvm.loop !64
...
do.body536.preheader:                             ; preds = %do.end485
  %idxprom488.le1993 = zext i8 %252 to i64
  %arrayidx489.le = getelementptr inbounds [17 x i16], ptr @mszip_bit_mask_tab, i64 0, i64 %idxprom488.le1993
  %262 = load i16, ptr %arrayidx489.le, align 2, !tbaa !48
  %conv490.le = zext i16 %262 to i32
  %and491.le1983 = and i32 %bit_buffer.9.lcssa, %conv490.le
  %arrayidx503.le1981 = getelementptr inbounds [30 x i16], ptr @mszip_dist_offsets, i64 0, i64 %idxprom447
  %263 = load i16, ptr %arrayidx503.le1981, align 2, !tbaa !48
  %conv504.le1978 = zext i16 %263 to i32
  %add505.le = add nuw nsw i32 %and491.le1983, %conv504.le1978
  %cmp506.le1972 = icmp ult i32 %window_posn158.0.ph, %add505.le
  %cond.le = select i1 %cmp506.le1972, i32 32768, i32 0
  %add508.le = sub i32 %window_posn158.0.ph, %add505.le
  %sub509.le1964 = add i32 %add508.le, %cond.le
  br label %do.body536

while.cond513.preheader:                          ; preds = %do.end485
  %tobool514.not1431 = icmp eq i32 %add385, 0
  br i1 %tobool514.not1431, label %while.cond241, label %while.body515.preheader

while.body515.preheader:                          ; preds = %while.cond513.preheader
  %idxprom488.le = zext i8 %252 to i64
  %arrayidx489.le1990 = getelementptr inbounds [17 x i16], ptr @mszip_bit_mask_tab, i64 0, i64 %idxprom488.le
  %264 = load i16, ptr %arrayidx489.le1990, align 2, !tbaa !48
  %conv490.le1987 = zext i16 %264 to i32
  %and491.le = and i32 %bit_buffer.9.lcssa, %conv490.le1987
  %arrayidx503.le = getelementptr inbounds [30 x i16], ptr @mszip_dist_offsets, i64 0, i64 %idxprom447
  %265 = load i16, ptr %arrayidx503.le, align 2, !tbaa !48
  %conv504.le = zext i16 %265 to i32
  %add505.le1974 = add nuw nsw i32 %and491.le, %conv504.le
  %cmp506.le = icmp ult i32 %window_posn158.0.ph, %add505.le1974
  %cond.le1969 = select i1 %cmp506.le, i32 32768, i32 0
  %add508.le1967 = sub i32 %window_posn158.0.ph, %add505.le1974
  %sub509.le = add i32 %add508.le1967, %cond.le1969
  br label %while.body515

while.body515:                                    ; preds = %while.body515.preheader, %if.end533
  %dec1434.in = phi i32 [ %dec1434, %if.end533 ], [ %add385, %while.body515.preheader ]
  %match_posn.01433 = phi i32 [ %and524, %if.end533 ], [ %sub509.le, %while.body515.preheader ]
  %window_posn158.11432 = phi i32 [ %window_posn158.2, %if.end533 ], [ %window_posn158.0.ph, %while.body515.preheader ]
  %dec1434 = add nsw i32 %dec1434.in, -1
  %inc517 = add i32 %match_posn.01433, 1
  %idxprom518 = zext i32 %match_posn.01433 to i64
  ...
  %inc521 = add i32 %window_posn158.11432, 1
  %idxprom522 = zext i32 %window_posn158.11432 to i64
...
if.then527:                                       ; preds = %while.body515
  ...
  %call529 = tail call i32 %267(ptr noundef nonnull %zip, i32 noundef 32768) #12
...
if.end533:                                        ; preds = %if.then527, %while.body515
  ...
  %tobool514.not = icmp eq i32 %dec1434, 0
  br i1 %tobool514.not, label %while.cond241.outer.backedge, label %while.body515, !llvm.loop !65
...
do.body536:                                       ; preds = %do.body536.preheader, %if.end573
  ...
  %match_posn.1 = phi i32 [ %spec.store.select, %if.end573 ], [ %sub509.le1964, %do.body536.preheader ]
  ...
  %tobool560.not1426 = icmp eq i32 %this_run.3, 0
  br i1 %tobool560.not1426, label %while.end564, label %iter.check
...
vector.main.loop.iter.check:                      ; preds = %vector.memcheck
  %min.iters.check1703 = icmp ult i32 %this_run.3, 32
  br i1 %min.iters.check1703, label %vec.epilog.ph, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep1705 = getelementptr i8, ptr %arrayidx555, i64 %index
  %wide.load = load <16 x i8>, ptr %next.gep1705, align 1, !tbaa !28
  %272 = getelementptr i8, ptr %next.gep1705, i64 16
  %wide.load1707 = load <16 x i8>, ptr %272, align 1, !tbaa !28
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !28
  %273 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load1707, ptr %273, align 1, !tbaa !28
  %index.next = add nuw i64 %index, 32
  %274 = icmp eq i64 %index.next, %n.vec
  br i1 %274, label %middle.block, label %vector.body, !llvm.loop !66
...
vec.epilog.iter.check:                            ; preds = %middle.block
  %.cast1719 = trunc i64 %n.vec to i32
  %ind.end1720 = sub i32 %this_run.3, %.cast1719
  %ind.end1716 = getelementptr i8, ptr %arrayidx555, i64 %n.vec
  %ind.end1713 = getelementptr i8, ptr %arrayidx551, i64 %n.vec
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec1711 = and i64 %268, 4294967288
  %ind.end1712 = getelementptr i8, ptr %arrayidx551, i64 %n.vec1711
  %ind.end1715 = getelementptr i8, ptr %arrayidx555, i64 %n.vec1711
  %.cast = trunc i64 %n.vec1711 to i32
  %ind.end1718 = sub i32 %this_run.3, %.cast
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index1723 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next1727, %vec.epilog.vector.body ]
  %next.gep1724 = getelementptr i8, ptr %arrayidx551, i64 %index1723
  %next.gep1725 = getelementptr i8, ptr %arrayidx555, i64 %index1723
  %wide.load1726 = load <8 x i8>, ptr %next.gep1725, align 1, !tbaa !28
  store <8 x i8> %wide.load1726, ptr %next.gep1724, align 1, !tbaa !28
  %index.next1727 = add nuw i64 %index1723, 8
  %275 = icmp eq i64 %index.next1727, %n.vec1711
  br i1 %275, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !67

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n1722 = icmp eq i64 %n.vec1711, %268
  br i1 %cmp.n1722, label %while.end564, label %while.body561.preheader

while.body561.preheader:                          ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %rundest.01429.ph = phi ptr [ %arrayidx551, %iter.check ], [ %arrayidx551, %vector.memcheck ], [ %ind.end1713, %vec.epilog.iter.check ], [ %ind.end1712, %vec.epilog.middle.block ]
  %runsrc.01428.ph = phi ptr [ %arrayidx555, %iter.check ], [ %arrayidx555, %vector.memcheck ], [ %ind.end1716, %vec.epilog.iter.check ], [ %ind.end1715, %vec.epilog.middle.block ]
  %this_run.41427.ph = phi i32 [ %this_run.3, %iter.check ], [ %this_run.3, %vector.memcheck ], [ %ind.end1720, %vec.epilog.iter.check ], [ %ind.end1718, %vec.epilog.middle.block ]
  %276 = add i32 %this_run.41427.ph, -1
  %xtraiter1859 = and i32 %this_run.41427.ph, 7
  %lcmp.mod1860.not = icmp eq i32 %xtraiter1859, 0
  br i1 %lcmp.mod1860.not, label %while.body561.prol.loopexit, label %while.body561.prol

while.body561.prol:                               ; preds = %while.body561.preheader, %while.body561.prol
  %rundest.01429.prol = phi ptr [ %incdec.ptr563.prol, %while.body561.prol ], [ %rundest.01429.ph, %while.body561.preheader ]
  %runsrc.01428.prol = phi ptr [ %incdec.ptr562.prol, %while.body561.prol ], [ %runsrc.01428.ph, %while.body561.preheader ]
  %this_run.41427.prol = phi i32 [ %dec559.prol, %while.body561.prol ], [ %this_run.41427.ph, %while.body561.preheader ]
  %prol.iter1861 = phi i32 [ %prol.iter1861.next, %while.body561.prol ], [ 0, %while.body561.preheader ]
  %dec559.prol = add i32 %this_run.41427.prol, -1
  %incdec.ptr562.prol = getelementptr inbounds i8, ptr %runsrc.01428.prol, i64 1
  %277 = load i8, ptr %runsrc.01428.prol, align 1, !tbaa !28
  %incdec.ptr563.prol = getelementptr inbounds i8, ptr %rundest.01429.prol, i64 1
  store i8 %277, ptr %rundest.01429.prol, align 1, !tbaa !28
  %prol.iter1861.next = add i32 %prol.iter1861, 1
  %prol.iter1861.cmp.not = icmp eq i32 %prol.iter1861.next, %xtraiter1859
  br i1 %prol.iter1861.cmp.not, label %while.body561.prol.loopexit, label %while.body561.prol, !llvm.loop !68

while.body561.prol.loopexit:                      ; preds = %while.body561.prol, %while.body561.preheader
  %rundest.01429.unr = phi ptr [ %rundest.01429.ph, %while.body561.preheader ], [ %incdec.ptr563.prol, %while.body561.prol ]
  %runsrc.01428.unr = phi ptr [ %runsrc.01428.ph, %while.body561.preheader ], [ %incdec.ptr562.prol, %while.body561.prol ]
  %this_run.41427.unr = phi i32 [ %this_run.41427.ph, %while.body561.preheader ], [ %dec559.prol, %while.body561.prol ]
...
while.body561:                                    ; preds = %while.body561.prol.loopexit, %while.body561
  %rundest.01429 = phi ptr [ %incdec.ptr563.7, %while.body561 ], [ %rundest.01429.unr, %while.body561.prol.loopexit ]
  %runsrc.01428 = phi ptr [ %incdec.ptr562.7, %while.body561 ], [ %runsrc.01428.unr, %while.body561.prol.loopexit ]
  %this_run.41427 = phi i32 [ %dec559.7, %while.body561 ], [ %this_run.41427.unr, %while.body561.prol.loopexit ]
  %incdec.ptr562 = getelementptr inbounds i8, ptr %runsrc.01428, i64 1
  %279 = load i8, ptr %runsrc.01428, align 1, !tbaa !28
  %incdec.ptr563 = getelementptr inbounds i8, ptr %rundest.01429, i64 1
  store i8 %279, ptr %rundest.01429, align 1, !tbaa !28
  %incdec.ptr562.1 = getelementptr inbounds i8, ptr %runsrc.01428, i64 2
  %280 = load i8, ptr %incdec.ptr562, align 1, !tbaa !28
  %incdec.ptr563.1 = getelementptr inbounds i8, ptr %rundest.01429, i64 2
  store i8 %280, ptr %incdec.ptr563, align 1, !tbaa !28
  %incdec.ptr562.2 = getelementptr inbounds i8, ptr %runsrc.01428, i64 3
  %281 = load i8, ptr %incdec.ptr562.1, align 1, !tbaa !28
  %incdec.ptr563.2 = getelementptr inbounds i8, ptr %rundest.01429, i64 3
  store i8 %281, ptr %incdec.ptr563.1, align 1, !tbaa !28
  %incdec.ptr562.3 = getelementptr inbounds i8, ptr %runsrc.01428, i64 4
  %282 = load i8, ptr %incdec.ptr562.2, align 1, !tbaa !28
  %incdec.ptr563.3 = getelementptr inbounds i8, ptr %rundest.01429, i64 4
  store i8 %282, ptr %incdec.ptr563.2, align 1, !tbaa !28
  %incdec.ptr562.4 = getelementptr inbounds i8, ptr %runsrc.01428, i64 5
  %283 = load i8, ptr %incdec.ptr562.3, align 1, !tbaa !28
  %incdec.ptr563.4 = getelementptr inbounds i8, ptr %rundest.01429, i64 5
  store i8 %283, ptr %incdec.ptr563.3, align 1, !tbaa !28
  %incdec.ptr562.5 = getelementptr inbounds i8, ptr %runsrc.01428, i64 6
  %284 = load i8, ptr %incdec.ptr562.4, align 1, !tbaa !28
  %incdec.ptr563.5 = getelementptr inbounds i8, ptr %rundest.01429, i64 6
  store i8 %284, ptr %incdec.ptr563.4, align 1, !tbaa !28
  %incdec.ptr562.6 = getelementptr inbounds i8, ptr %runsrc.01428, i64 7
  %285 = load i8, ptr %incdec.ptr562.5, align 1, !tbaa !28
  %incdec.ptr563.6 = getelementptr inbounds i8, ptr %rundest.01429, i64 7
  store i8 %285, ptr %incdec.ptr563.5, align 1, !tbaa !28
  %dec559.7 = add i32 %this_run.41427, -8
  %incdec.ptr562.7 = getelementptr inbounds i8, ptr %runsrc.01428, i64 8
  %286 = load i8, ptr %incdec.ptr562.6, align 1, !tbaa !28
  %incdec.ptr563.7 = getelementptr inbounds i8, ptr %rundest.01429, i64 8
  store i8 %286, ptr %incdec.ptr563.6, align 1, !tbaa !28
  %tobool560.not.7 = icmp eq i32 %dec559.7, 0
  br i1 %tobool560.not.7, label %while.end564, label %while.body561, !llvm.loop !69
...
if.then567:                                       ; preds = %while.end564
  ...
  %call569 = tail call i32 %287(ptr noundef %zip, i32 noundef 32768) #12
...
if.end573:                                        ; preds = %if.then567, %while.end564
  ...
  br i1 %cmp579.not, label %while.cond241.outer.backedge, label %do.body536, !llvm.loop !70
...
do.cond599:                                       ; preds = %cleanup591, %cleanup
  %bit_buffer.12 = phi i32 [ %bit_buffer.3.lcssa1538, %cleanup ], [ %shr307, %cleanup591 ]
  ...
  br i1 %tobool600.not, label %do.body5, label %do.end601, !llvm.loop !71
...
if.then604:                                       ; preds = %do.end601
  ...
  %call607 = tail call i32 %289(ptr noundef nonnull %zip, i32 noundef %288) #12
...
if.then:                                          ; preds = %entry
  ...
  tail call void @free(ptr noundef nonnull %zip) #12
  br label %if.end
...
if.end3:                                          ; preds = %if.end
  %call = tail call ptr @cli_calloc(i64 noundef 1, i64 noundef 54896) #12
...
if.end16:                                         ; preds = %if.then10, %for.body
  ...
  br i1 %cmp7, label %for.body, label %for.body27, !llvm.loop !72
...
for.body27:                                       ; preds = %if.end16, %for.body27
  ...
  store i32 %j.2141, ptr %arrayidx29, align 4, !tbaa !73
  ...
  store i32 %add35, ptr %arrayidx29.1, align 4, !tbaa !73
  ...
  br i1 %exitcond.not.2, label %for.end38, label %for.body27, !llvm.loop !74

for.end38:                                        ; preds = %for.body27
  %conv39 = zext i32 %shl to i64
  %call40 = tail call ptr @cli_calloc(i64 noundef 1, i64 noundef %conv39) #12
  %window = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 5
  store ptr %call40, ptr %window, align 8, !tbaa !75
...
if.end51:                                         ; preds = %if.end44
  ...
  store ptr %e8_buf, ptr %o_end, align 8, !tbaa !100
  %o_ptr = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 27
  store ptr %e8_buf, ptr %o_ptr, align 8, !tbaa !101
  %bits_left = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 30
  store i32 0, ptr %bits_left, align 4, !tbaa !102
  %bit_buffer = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 29
  store i32 0, ptr %bit_buffer, align 8, !tbaa !103
  %R0.i = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 11
  store i32 1, ptr %R0.i, align 4, !tbaa !104
  %R1.i = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 12
  store i32 1, ptr %R1.i, align 8, !tbaa !105
  %R2.i = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 13
  store i32 1, ptr %R2.i, align 4, !tbaa !106
  %header_read.i = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 20
  store i8 0, ptr %header_read.i, align 2, !tbaa !107
  %block_remaining.i = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 15
  store i32 0, ptr %block_remaining.i, align 4, !tbaa !108
  %block_type.i = getelementptr inbounds %struct.lzx_stream, ptr %call, i64 0, i32 19
  store i8 0, ptr %block_type.i, align 1, !tbaa !109
  %uglygep.i = getelementptr i8, ptr %call, i64 240
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(656) %uglygep.i, i8 0, i64 656, i1 false), !tbaa !28
  %uglygep24.i = getelementptr i8, ptr %call, i64 960
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(250) %uglygep24.i, i8 0, i64 250, i1 false), !tbaa !28
  br label %cleanup
...
if.then:                                          ; preds = %entry
  ...
  store i64 %out_bytes, ptr %length, align 8, !tbaa !83
  br label %if.end
...
if.end:                                           ; preds = %entry
  ...
  %0 = load i32, ptr %error, align 8, !tbaa !97
...
if.end4:                                          ; preds = %if.end
  ...
  %1 = load ptr, ptr %o_end, align 8, !tbaa !100
  %o_ptr = getelementptr inbounds %struct.lzx_stream, ptr %lzx, i64 0, i32 27
  %2 = load ptr, ptr %o_ptr, align 8, !tbaa !101
  %sub.ptr.lhs.cast = ptrtoint ptr %1 to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %2 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %sext = shl i64 %sub.ptr.sub, 32
...
if.then12:                                        ; preds = %if.end4
  ...
  %3 = load i8, ptr %wflag, align 8, !tbaa !81
...
if.end20:                                         ; preds = %land.lhs.true.if.end20_crit_edge, %if.then12
  ...
  %add.ptr = getelementptr inbounds i8, ptr %5, i64 %idx.ext
  store ptr %add.ptr, ptr %o_ptr, align 8, !tbaa !101
  %offset = getelementptr inbounds %struct.lzx_stream, ptr %lzx, i64 0, i32 3
  %6 = load i64, ptr %offset, align 8, !tbaa !82
  %add = add nsw i64 %6, %idx.ext
  store i64 %add, ptr %offset, align 8, !tbaa !82
  %sub = sub nsw i64 %out_bytes, %idx.ext
  br label %if.end24
...
do.body:                                          ; preds = %if.end24
  ...
  %7 = load ptr, ptr %window33, align 8, !tbaa !75
  ...
  %9 = load i64, ptr %offset38, align 8, !tbaa !82
  ...
  %10 = load i32, ptr %frame, align 4, !tbaa !90
  %cmp424690 = icmp ult i32 %10, %add41
  br i1 %cmp424690, label %while.body.lr.ph, label %if.then1646

while.body.lr.ph:                                 ; preds = %do.body
  %11 = load i32, ptr %R237, align 4, !tbaa !106
  %12 = load i32, ptr %R136, align 8, !tbaa !105
  %13 = load i32, ptr %R035, align 4, !tbaa !104
  %14 = load i32, ptr %window_posn34, align 4, !tbaa !88
  %15 = load i32, ptr %bits_left32, align 4, !tbaa !102
  %16 = load i32, ptr %bit_buffer31, align 8, !tbaa !103
  %17 = load ptr, ptr %i_end30, align 8, !tbaa !98
  %18 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  ...
  %uglygep.i = getelementptr i8, ptr %lzx, i64 240
  %uglygep24.i = getelementptr i8, ptr %lzx, i64 960
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end1643
  ...
  %20 = load i32, ptr %reset_interval, align 8, !tbaa !91
...
if.then50:                                        ; preds = %land.lhs.true45
  %21 = load i32, ptr %block_remaining, align 4, !tbaa !108
  %tobool51.not = icmp eq i32 %21, 0
  br i1 %tobool51.not, label %if.end56.thread, label %if.then52

if.then52:                                        ; preds = %if.then50
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.3, i32 noundef %21) #12
  store i32 -124, ptr %error, align 8, !tbaa !97
  br label %cleanup

if.end56.thread:                                  ; preds = %if.then50
  store i32 1, ptr %R035, align 4, !tbaa !104
  store i32 1, ptr %R136, align 8, !tbaa !105
  store i32 1, ptr %R237, align 4, !tbaa !106
  store i8 0, ptr %header_read.i, align 2, !tbaa !107
  store i32 0, ptr %block_remaining, align 4, !tbaa !108
  store i8 0, ptr %block_type.i, align 1, !tbaa !109
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(656) %uglygep.i, i8 0, i64 656, i1 false), !tbaa !28
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(250) %uglygep24.i, i8 0, i64 250, i1 false), !tbaa !28
...
if.end56:                                         ; preds = %land.lhs.true45, %while.body
  %.pr = load i8, ptr %header_read.i, align 2, !tbaa !107
...
if.then67:                                        ; preds = %while.body63
  %22 = load ptr, ptr %read.i, align 8, !tbaa !85
  %tobool.not.i = icmp eq ptr %22, null
  %23 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  %24 = load i32, ptr %inbuf_size.i, align 8, !tbaa !86
  br i1 %tobool.not.i, label %cond.false.i, label %cond.true.i

cond.true.i:                                      ; preds = %if.then67
  %25 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i = tail call i32 %22(ptr noundef %25, ptr noundef %23, i32 noundef %24) #12
  br label %cond.end.i

cond.false.i:                                     ; preds = %if.then67
  %26 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i = tail call i32 @cli_readn(i32 noundef %26, ptr noundef %23, i32 noundef %24) #12
  br label %cond.end.i
...
if.then7.i:                                       ; preds = %if.end.i
  %27 = load i8, ptr %input_end.i, align 4, !tbaa !96
...
if.end72:                                         ; preds = %if.else.i, %if.end.i
  ...
  %30 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  store ptr %30, ptr %i_ptr29, align 8, !tbaa !99
  %idxprom.i = zext i32 %bread.0.i to i64
  %arrayidx21.i = getelementptr inbounds i8, ptr %30, i64 %idxprom.i
  store ptr %arrayidx21.i, ptr %i_end30, align 8, !tbaa !98
  br label %if.end75
...
if.end75:                                         ; preds = %if.end72, %while.body63
  ...
  br i1 %cmp61, label %while.body63, label %while.end, !llvm.loop !110
...
if.then99:                                        ; preds = %while.body95
  %33 = load ptr, ptr %read.i, align 8, !tbaa !85
  %tobool.not.i2532 = icmp eq ptr %33, null
  %34 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  %35 = load i32, ptr %inbuf_size.i, align 8, !tbaa !86
  br i1 %tobool.not.i2532, label %cond.false.i2541, label %cond.true.i2537

cond.true.i2537:                                  ; preds = %if.then99
  %36 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i2536 = tail call i32 %33(ptr noundef %36, ptr noundef %34, i32 noundef %35) #12
  br label %cond.end.i2544

cond.false.i2541:                                 ; preds = %if.then99
  %37 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i2540 = tail call i32 @cli_readn(i32 noundef %37, ptr noundef %34, i32 noundef %35) #12
  br label %cond.end.i2544
...
if.then7.i2551:                                   ; preds = %if.end.i2548
  %38 = load i8, ptr %input_end.i, align 4, !tbaa !96
...
if.end104:                                        ; preds = %if.else.i2556, %if.end.i2548
  ...
  %41 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  store ptr %41, ptr %i_ptr29, align 8, !tbaa !99
  %idxprom.i2560 = zext i32 %bread.0.i2557 to i64
  %arrayidx21.i2561 = getelementptr inbounds i8, ptr %41, i64 %idxprom.i2560
  store ptr %arrayidx21.i2561, ptr %i_end30, align 8, !tbaa !98
  br label %if.end107
...
if.end107:                                        ; preds = %if.end104, %while.body95
  ...
  br i1 %cmp93, label %while.body95, label %while.end121, !llvm.loop !111
...
if.then135:                                       ; preds = %while.body131
  %44 = load ptr, ptr %read.i, align 8, !tbaa !85
  %tobool.not.i2567 = icmp eq ptr %44, null
  %45 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  %46 = load i32, ptr %inbuf_size.i, align 8, !tbaa !86
  br i1 %tobool.not.i2567, label %cond.false.i2576, label %cond.true.i2572

cond.true.i2572:                                  ; preds = %if.then135
  %47 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i2571 = tail call i32 %44(ptr noundef %47, ptr noundef %45, i32 noundef %46) #12
  br label %cond.end.i2579

cond.false.i2576:                                 ; preds = %if.then135
  %48 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i2575 = tail call i32 @cli_readn(i32 noundef %48, ptr noundef %45, i32 noundef %46) #12
  br label %cond.end.i2579
...
if.then7.i2586:                                   ; preds = %if.end.i2583
  %49 = load i8, ptr %input_end.i, align 4, !tbaa !96
...
if.end140:                                        ; preds = %if.else.i2591, %if.end.i2583
  ...
  %52 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  store ptr %52, ptr %i_ptr29, align 8, !tbaa !99
  %idxprom.i2595 = zext i32 %bread.0.i2592 to i64
  %arrayidx21.i2596 = getelementptr inbounds i8, ptr %52, i64 %idxprom.i2595
  store ptr %arrayidx21.i2596, ptr %i_end30, align 8, !tbaa !98
  br label %if.end143
...
if.end143:                                        ; preds = %if.end140, %while.body131
  ...
  br i1 %cmp129, label %while.body131, label %while.end157, !llvm.loop !112
...
if.end163:                                        ; preds = %while.end157, %while.end
  ...
  store i32 %or165, ptr %intel_filesize, align 8, !tbaa !92
  store i8 1, ptr %header_read.i, align 2, !tbaa !107
  br label %if.end167
...
if.end181:                                        ; preds = %land.lhs.true169, %if.end167
  ...
  %58 = load i32, ptr %frame_posn, align 8, !tbaa !89
...
if.then200:                                       ; preds = %if.then197
  %call201 = tail call fastcc i32 @lzx_read_input(ptr noundef nonnull %lzx)
  %tobool202.not = icmp eq i32 %call201, 0
  br i1 %tobool202.not, label %if.end205, label %if.then203

if.then203:                                       ; preds = %if.then200
  %62 = load i32, ptr %error, align 8, !tbaa !97
  br label %cleanup

if.end205:                                        ; preds = %if.then200
  %63 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %64 = load ptr, ptr %i_end30, align 8, !tbaa !98
  br label %if.end208
...
if.then218:                                       ; preds = %while.body214
  %65 = load ptr, ptr %read.i, align 8, !tbaa !85
  %tobool.not.i2602 = icmp eq ptr %65, null
  %66 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  %67 = load i32, ptr %inbuf_size.i, align 8, !tbaa !86
  br i1 %tobool.not.i2602, label %cond.false.i2611, label %cond.true.i2607

cond.true.i2607:                                  ; preds = %if.then218
  %68 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i2606 = tail call i32 %65(ptr noundef %68, ptr noundef %66, i32 noundef %67) #12
  br label %cond.end.i2614

cond.false.i2611:                                 ; preds = %if.then218
  %69 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i2610 = tail call i32 @cli_readn(i32 noundef %69, ptr noundef %66, i32 noundef %67) #12
  br label %cond.end.i2614
...
if.then7.i2621:                                   ; preds = %if.end.i2618
  %70 = load i8, ptr %input_end.i, align 4, !tbaa !96
...
if.end223:                                        ; preds = %if.else.i2626, %if.end.i2618
  ...
  %73 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  store ptr %73, ptr %i_ptr29, align 8, !tbaa !99
  %idxprom.i2630 = zext i32 %bread.0.i2627 to i64
  %arrayidx21.i2631 = getelementptr inbounds i8, ptr %73, i64 %idxprom.i2630
  store ptr %arrayidx21.i2631, ptr %i_end30, align 8, !tbaa !98
  br label %if.end226
...
while.end240:                                     ; preds = %if.end226, %do.body210
  ...
  store i8 %conv242, ptr %block_type.i, align 1, !tbaa !109
...
if.then256:                                       ; preds = %while.body252
  %76 = load ptr, ptr %read.i, align 8, !tbaa !85
  %tobool.not.i2637 = icmp eq ptr %76, null
  %77 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  %78 = load i32, ptr %inbuf_size.i, align 8, !tbaa !86
  br i1 %tobool.not.i2637, label %cond.false.i2646, label %cond.true.i2642

cond.true.i2642:                                  ; preds = %if.then256
  %79 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i2641 = tail call i32 %76(ptr noundef %79, ptr noundef %77, i32 noundef %78) #12
  br label %cond.end.i2649

cond.false.i2646:                                 ; preds = %if.then256
  %80 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i2645 = tail call i32 @cli_readn(i32 noundef %80, ptr noundef %77, i32 noundef %78) #12
  br label %cond.end.i2649
...
if.then7.i2656:                                   ; preds = %if.end.i2653
  %81 = load i8, ptr %input_end.i, align 4, !tbaa !96
...
if.end261:                                        ; preds = %if.else.i2661, %if.end.i2653
  ...
  %84 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  store ptr %84, ptr %i_ptr29, align 8, !tbaa !99
  %idxprom.i2665 = zext i32 %bread.0.i2662 to i64
  %arrayidx21.i2666 = getelementptr inbounds i8, ptr %84, i64 %idxprom.i2665
  store ptr %arrayidx21.i2666, ptr %i_end30, align 8, !tbaa !98
  br label %if.end264
...
if.then292:                                       ; preds = %while.body288
  %87 = load ptr, ptr %read.i, align 8, !tbaa !85
  %tobool.not.i2672 = icmp eq ptr %87, null
  %88 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  %89 = load i32, ptr %inbuf_size.i, align 8, !tbaa !86
  br i1 %tobool.not.i2672, label %cond.false.i2681, label %cond.true.i2677

cond.true.i2677:                                  ; preds = %if.then292
  %90 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i2676 = tail call i32 %87(ptr noundef %90, ptr noundef %88, i32 noundef %89) #12
  br label %cond.end.i2684

cond.false.i2681:                                 ; preds = %if.then292
  %91 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i2680 = tail call i32 @cli_readn(i32 noundef %91, ptr noundef %88, i32 noundef %89) #12
  br label %cond.end.i2684
...
if.then7.i2691:                                   ; preds = %if.end.i2688
  %92 = load i8, ptr %input_end.i, align 4, !tbaa !96
...
if.end297:                                        ; preds = %if.else.i2696, %if.end.i2688
  ...
  %95 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  store ptr %95, ptr %i_ptr29, align 8, !tbaa !99
  %idxprom.i2700 = zext i32 %bread.0.i2697 to i64
  %arrayidx21.i2701 = getelementptr inbounds i8, ptr %95, i64 %idxprom.i2700
  store ptr %arrayidx21.i2701, ptr %i_end30, align 8, !tbaa !98
  br label %if.end300
...
while.end314:                                     ; preds = %if.end300, %while.end278
  ...
  store i32 %or321, ptr %block_length, align 8, !tbaa !113
  store i32 %or321, ptr %block_remaining, align 4, !tbaa !108
  %99 = load i8, ptr %block_type.i, align 1, !tbaa !109
...
if.then336:                                       ; preds = %while.body332
  %100 = load ptr, ptr %read.i, align 8, !tbaa !85
  %tobool.not.i2707 = icmp eq ptr %100, null
  %101 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  %102 = load i32, ptr %inbuf_size.i, align 8, !tbaa !86
  br i1 %tobool.not.i2707, label %cond.false.i2716, label %cond.true.i2712

cond.true.i2712:                                  ; preds = %if.then336
  %103 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i2711 = tail call i32 %100(ptr noundef %103, ptr noundef %101, i32 noundef %102) #12
  br label %cond.end.i2719

cond.false.i2716:                                 ; preds = %if.then336
  %104 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i2715 = tail call i32 @cli_readn(i32 noundef %104, ptr noundef %101, i32 noundef %102) #12
  br label %cond.end.i2719
...
if.then7.i2726:                                   ; preds = %if.end.i2723
  %105 = load i8, ptr %input_end.i, align 4, !tbaa !96
...
if.end341:                                        ; preds = %if.else.i2731, %if.end.i2723
  ...
  %108 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  store ptr %108, ptr %i_ptr29, align 8, !tbaa !99
  %idxprom.i2735 = zext i32 %bread.0.i2732 to i64
  %arrayidx21.i2736 = getelementptr inbounds i8, ptr %108, i64 %idxprom.i2735
  store ptr %arrayidx21.i2736, ptr %i_end30, align 8, !tbaa !98
  br label %if.end344
...
for.end:                                          ; preds = %while.end358
  %call369 = tail call fastcc i32 @lzx_make_decode_table(i32 noundef 8, i32 noundef 7, ptr noundef nonnull %ALIGNED_len366, ptr noundef nonnull %ALIGNED_table)
  %tobool370.not = icmp eq i32 %call369, 0
  br i1 %tobool370.not, label %do.body376, label %if.then371

if.then371:                                       ; preds = %for.end
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.5) #12
  store i32 -124, ptr %error, align 8, !tbaa !97
  br label %cleanup
...
do.body376:                                       ; preds = %for.end, %while.end314
  ...
  store ptr %i_ptr.21, ptr %i_ptr29, align 8, !tbaa !99
  store ptr %i_end.21, ptr %i_end30, align 8, !tbaa !98
  store i32 %bit_buffer.12, ptr %bit_buffer31, align 8, !tbaa !103
  store i32 %bits_left.12, ptr %bits_left32, align 4, !tbaa !102
  %call384 = tail call fastcc i32 @lzx_read_lens(ptr noundef nonnull %lzx, ptr noundef nonnull %uglygep.i, i32 noundef 0, i32 noundef 256)
  %tobool385.not = icmp eq i32 %call384, 0
  br i1 %tobool385.not, label %do.body389, label %if.then386

if.then386:                                       ; preds = %do.body376
  %111 = load i32, ptr %error, align 8, !tbaa !97
  br label %cleanup

do.body389:                                       ; preds = %do.body376
  %112 = load i8, ptr %posn_slots, align 1, !tbaa !94
  %conv408 = zext i8 %112 to i32
  %shl409 = shl nuw nsw i32 %conv408, 3
  %add410 = add nuw nsw i32 %shl409, 256
  %call411 = tail call fastcc i32 @lzx_read_lens(ptr noundef nonnull %lzx, ptr noundef nonnull %uglygep.i, i32 noundef 256, i32 noundef %add410)
  %tobool412.not = icmp eq i32 %call411, 0
  br i1 %tobool412.not, label %do.body416, label %if.then413

if.then413:                                       ; preds = %do.body389
  %113 = load i32, ptr %error, align 8, !tbaa !97
  br label %cleanup
...
do.body416:                                       ; preds = %do.body389
  ...
  %call428 = tail call fastcc i32 @lzx_make_decode_table(i32 noundef 656, i32 noundef 12, ptr noundef nonnull %uglygep.i, ptr noundef nonnull %MAINTREE_table)
  %tobool429.not = icmp eq i32 %call428, 0
  br i1 %tobool429.not, label %if.end432, label %if.then430

if.then430:                                       ; preds = %do.body416
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.6) #12
  store i32 -124, ptr %error, align 8, !tbaa !97
  br label %cleanup
...
if.then438:                                       ; preds = %if.end432
  store i8 1, ptr %intel_started472, align 8, !tbaa !95
  br label %do.body441
...
do.body441:                                       ; preds = %if.then438, %if.end432
  ...
  %call449 = tail call fastcc i32 @lzx_read_lens(ptr noundef nonnull %lzx, ptr noundef nonnull %uglygep24.i, i32 noundef 0, i32 noundef 249)
  %tobool450.not = icmp eq i32 %call449, 0
  br i1 %tobool450.not, label %do.body454, label %if.then451

if.then451:                                       ; preds = %do.body441
  %117 = load i32, ptr %error, align 8, !tbaa !97
  br label %cleanup

do.body454:                                       ; preds = %do.body441
  %118 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %119 = load ptr, ptr %i_end30, align 8, !tbaa !98
  %120 = load i32, ptr %bit_buffer31, align 8, !tbaa !103
  %121 = load i32, ptr %bits_left32, align 4, !tbaa !102
  %call466 = tail call fastcc i32 @lzx_make_decode_table(i32 noundef 250, i32 noundef 12, ptr noundef nonnull %uglygep24.i, ptr noundef nonnull %LENGTH_table)
  %tobool467.not = icmp eq i32 %call466, 0
  br i1 %tobool467.not, label %if.end574, label %if.then468

if.then468:                                       ; preds = %do.body454
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.7) #12
  store i32 -124, ptr %error, align 8, !tbaa !97
  br label %cleanup
...
if.then480:                                       ; preds = %while.body476
  %122 = load ptr, ptr %read.i, align 8, !tbaa !85
  %tobool.not.i2742 = icmp eq ptr %122, null
  %123 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  %124 = load i32, ptr %inbuf_size.i, align 8, !tbaa !86
  br i1 %tobool.not.i2742, label %cond.false.i2751, label %cond.true.i2747

cond.true.i2747:                                  ; preds = %if.then480
  %125 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i2746 = tail call i32 %122(ptr noundef %125, ptr noundef %123, i32 noundef %124) #12
  br label %cond.end.i2754

cond.false.i2751:                                 ; preds = %if.then480
  %126 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i2750 = tail call i32 @cli_readn(i32 noundef %126, ptr noundef %123, i32 noundef %124) #12
  br label %cond.end.i2754
...
if.then7.i2761:                                   ; preds = %if.end.i2758
  %127 = load i8, ptr %input_end.i, align 4, !tbaa !96
...
if.end485:                                        ; preds = %if.else.i2766, %if.end.i2758
  ...
  %130 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  store ptr %130, ptr %i_ptr29, align 8, !tbaa !99
  %idxprom.i2770 = zext i32 %bread.0.i2767 to i64
  %arrayidx21.i2771 = getelementptr inbounds i8, ptr %130, i64 %idxprom.i2770
  store ptr %arrayidx21.i2771, ptr %i_end30, align 8, !tbaa !98
  br label %if.end488
...
if.then515:                                       ; preds = %while.end502
  %call516 = tail call fastcc i32 @lzx_read_input(ptr noundef %lzx)
...
if.then518:                                       ; preds = %if.then515.11, %if.then515.10, %if.then515.9, %if.then515.8, %if.then515.7, %if.then515.6, %if.then515.5, %if.then515.4, %if.then515.3, %if.then515.2, %if.then515.1, %if.then515
  %131 = load i32, ptr %error, align 8, !tbaa !97
  br label %cleanup

if.end520:                                        ; preds = %if.then515
  %132 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %133 = load ptr, ptr %i_end30, align 8, !tbaa !98
  br label %if.end523
...
if.then515.1:                                     ; preds = %if.end523
  %call516.1 = tail call fastcc i32 @lzx_read_input(ptr noundef %lzx)
...
if.end520.1:                                      ; preds = %if.then515.1
  %135 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %136 = load ptr, ptr %i_end30, align 8, !tbaa !98
...
if.then515.2:                                     ; preds = %if.end523.1
  %call516.2 = tail call fastcc i32 @lzx_read_input(ptr noundef %lzx)
...
if.end520.2:                                      ; preds = %if.then515.2
  %138 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %139 = load ptr, ptr %i_end30, align 8, !tbaa !98
...
if.then515.3:                                     ; preds = %if.end523.2
  %call516.3 = tail call fastcc i32 @lzx_read_input(ptr noundef %lzx)
...
if.end520.3:                                      ; preds = %if.then515.3
  %141 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %142 = load ptr, ptr %i_end30, align 8, !tbaa !98
...
if.then515.4:                                     ; preds = %if.end523.3
  %call516.4 = tail call fastcc i32 @lzx_read_input(ptr noundef %lzx)
...
if.end520.4:                                      ; preds = %if.then515.4
  %144 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %145 = load ptr, ptr %i_end30, align 8, !tbaa !98
...
if.then515.5:                                     ; preds = %if.end523.4
  %call516.5 = tail call fastcc i32 @lzx_read_input(ptr noundef %lzx)
...
if.end520.5:                                      ; preds = %if.then515.5
  %147 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %148 = load ptr, ptr %i_end30, align 8, !tbaa !98
...
if.then515.6:                                     ; preds = %if.end523.5
  %call516.6 = tail call fastcc i32 @lzx_read_input(ptr noundef %lzx)
...
if.end520.6:                                      ; preds = %if.then515.6
  %150 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %151 = load ptr, ptr %i_end30, align 8, !tbaa !98
...
if.then515.7:                                     ; preds = %if.end523.6
  %call516.7 = tail call fastcc i32 @lzx_read_input(ptr noundef %lzx)
...
if.end520.7:                                      ; preds = %if.then515.7
  %153 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %154 = load ptr, ptr %i_end30, align 8, !tbaa !98
...
if.then515.8:                                     ; preds = %if.end523.7
  %call516.8 = tail call fastcc i32 @lzx_read_input(ptr noundef %lzx)
...
if.end520.8:                                      ; preds = %if.then515.8
  %156 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %157 = load ptr, ptr %i_end30, align 8, !tbaa !98
...
if.then515.9:                                     ; preds = %if.end523.8
  %call516.9 = tail call fastcc i32 @lzx_read_input(ptr noundef %lzx)
...
if.end520.9:                                      ; preds = %if.then515.9
  %159 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %160 = load ptr, ptr %i_end30, align 8, !tbaa !98
...
if.then515.10:                                    ; preds = %if.end523.9
  %call516.10 = tail call fastcc i32 @lzx_read_input(ptr noundef %lzx)
...
if.end520.10:                                     ; preds = %if.then515.10
  %162 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %163 = load ptr, ptr %i_end30, align 8, !tbaa !98
...
if.then515.11:                                    ; preds = %if.end523.10
  %call516.11 = tail call fastcc i32 @lzx_read_input(ptr noundef %lzx)
...
if.end520.11:                                     ; preds = %if.then515.11
  %165 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %166 = load ptr, ptr %i_end30, align 8, !tbaa !98
...
sw.default:                                       ; preds = %while.end314
  ...
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.8, i32 noundef %conv325) #12
  store i32 -124, ptr %error, align 8, !tbaa !97
  br label %cleanup
...
if.end574:                                        ; preds = %if.end523.11, %do.body454, %while.body187
  ...
  %168 = load i32, ptr %block_remaining, align 4, !tbaa !108
  ...
  store i32 %sub582, ptr %block_remaining, align 4, !tbaa !108
  %169 = load i8, ptr %block_type.i, align 1, !tbaa !109
...
if.then598:                                       ; preds = %while.body594
  %170 = load ptr, ptr %read.i, align 8, !tbaa !85
  %tobool.not.i2777 = icmp eq ptr %170, null
  %171 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  %172 = load i32, ptr %inbuf_size.i, align 8, !tbaa !86
  br i1 %tobool.not.i2777, label %cond.false.i2786, label %cond.true.i2782

cond.true.i2782:                                  ; preds = %if.then598
  %173 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i2781 = tail call i32 %170(ptr noundef %173, ptr noundef %171, i32 noundef %172) #12
  br label %cond.end.i2789

cond.false.i2786:                                 ; preds = %if.then598
  %174 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i2785 = tail call i32 @cli_readn(i32 noundef %174, ptr noundef %171, i32 noundef %172) #12
  br label %cond.end.i2789
...
if.then7.i2796:                                   ; preds = %if.end.i2793
  %175 = load i8, ptr %input_end.i, align 4, !tbaa !96
...
if.end603:                                        ; preds = %if.else.i2801, %if.end.i2793
  ...
  %178 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  store ptr %178, ptr %i_ptr29, align 8, !tbaa !99
  %idxprom.i2805 = zext i32 %bread.0.i2802 to i64
  %arrayidx21.i2806 = getelementptr inbounds i8, ptr %178, i64 %idxprom.i2805
  store ptr %arrayidx21.i2806, ptr %i_end30, align 8, !tbaa !98
  br label %if.end606
...
while.end620:                                     ; preds = %if.end606, %while.cond591.preheader
  ...
  %181 = load i16, ptr %arrayidx624, align 2, !tbaa !48
...
if.then647:                                       ; preds = %do.body629.19, %do.body629.18, %do.body629.17, %do.body629.16, %do.body629.15, %do.body629.14, %do.body629.13, %do.body629.12, %do.body629.11, %do.body629.10, %do.body629.9, %do.body629.8, %do.body629.7, %do.body629.6, %do.body629.5, %do.body629.4, %do.body629.3, %do.body629.2, %do.body629.1, %do.body629.preheader
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.10) #12
  store i32 -124, ptr %error, align 8, !tbaa !97
  br label %cleanup
...
if.end649:                                        ; preds = %do.body629.preheader
  ...
  %185 = load i16, ptr %arrayidx652, align 2, !tbaa !48
...
if.end649.1:                                      ; preds = %do.body629.1
  ...
  %189 = load i16, ptr %arrayidx652.1, align 2, !tbaa !48
...
if.end649.2:                                      ; preds = %do.body629.2
  ...
  %193 = load i16, ptr %arrayidx652.2, align 2, !tbaa !48
...
if.end649.3:                                      ; preds = %do.body629.3
  ...
  %197 = load i16, ptr %arrayidx652.3, align 2, !tbaa !48
...
if.end649.4:                                      ; preds = %do.body629.4
  ...
  %200 = load i16, ptr %arrayidx652.4, align 2, !tbaa !48
...
if.end649.5:                                      ; preds = %do.body629.5
  ...
  %205 = load i16, ptr %arrayidx652.5, align 2, !tbaa !48
...
if.end649.6:                                      ; preds = %do.body629.6
  ...
  %210 = load i16, ptr %arrayidx652.6, align 2, !tbaa !48
...
if.end649.7:                                      ; preds = %do.body629.7
  ...
  %215 = load i16, ptr %arrayidx652.7, align 2, !tbaa !48
...
if.end649.8:                                      ; preds = %do.body629.8
  ...
  %220 = load i16, ptr %arrayidx652.8, align 2, !tbaa !48
...
if.end649.9:                                      ; preds = %do.body629.9
  ...
  %225 = load i16, ptr %arrayidx652.9, align 2, !tbaa !48
...
if.end649.10:                                     ; preds = %do.body629.10
  ...
  %230 = load i16, ptr %arrayidx652.10, align 2, !tbaa !48
...
if.end649.11:                                     ; preds = %do.body629.11
  ...
  %235 = load i16, ptr %arrayidx652.11, align 2, !tbaa !48
...
if.end649.12:                                     ; preds = %do.body629.12
  ...
  %240 = load i16, ptr %arrayidx652.12, align 2, !tbaa !48
...
if.end649.13:                                     ; preds = %do.body629.13
  ...
  %245 = load i16, ptr %arrayidx652.13, align 2, !tbaa !48
...
if.end649.14:                                     ; preds = %do.body629.14
  ...
  %250 = load i16, ptr %arrayidx652.14, align 2, !tbaa !48
...
if.end649.15:                                     ; preds = %do.body629.15
  ...
  %255 = load i16, ptr %arrayidx652.15, align 2, !tbaa !48
...
if.end649.16:                                     ; preds = %do.body629.16
  ...
  %260 = load i16, ptr %arrayidx652.16, align 2, !tbaa !48
...
if.end649.17:                                     ; preds = %do.body629.17
  ...
  %265 = load i16, ptr %arrayidx652.17, align 2, !tbaa !48
...
if.end649.18:                                     ; preds = %do.body629.18
  ...
  %270 = load i16, ptr %arrayidx652.18, align 2, !tbaa !48
...
if.end649.19:                                     ; preds = %do.body629.19
  ...
  %274 = load i16, ptr %arrayidx652.19, align 2, !tbaa !48
...
if.then688:                                       ; preds = %while.body684
  %276 = load ptr, ptr %read.i, align 8, !tbaa !85
  %tobool.not.i2812 = icmp eq ptr %276, null
  %277 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  %278 = load i32, ptr %inbuf_size.i, align 8, !tbaa !86
  br i1 %tobool.not.i2812, label %cond.false.i2821, label %cond.true.i2817

cond.true.i2817:                                  ; preds = %if.then688
  %279 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i2816 = tail call i32 %276(ptr noundef %279, ptr noundef %277, i32 noundef %278) #12
  br label %cond.end.i2824

cond.false.i2821:                                 ; preds = %if.then688
  %280 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i2820 = tail call i32 @cli_readn(i32 noundef %280, ptr noundef %277, i32 noundef %278) #12
  br label %cond.end.i2824
...
if.then7.i2831:                                   ; preds = %if.end.i2828
  %281 = load i8, ptr %input_end.i, align 4, !tbaa !96
...
if.end693:                                        ; preds = %if.else.i2836, %if.end.i2828
  ...
  %284 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  store ptr %284, ptr %i_ptr29, align 8, !tbaa !99
  %idxprom.i2840 = zext i32 %bread.0.i2837 to i64
  %arrayidx21.i2841 = getelementptr inbounds i8, ptr %284, i64 %idxprom.i2840
  store ptr %arrayidx21.i2841, ptr %i_end30, align 8, !tbaa !98
  br label %if.end696
...
while.end710:                                     ; preds = %if.end696, %while.cond681.preheader
  ...
  %287 = load i16, ptr %arrayidx714, align 2, !tbaa !48
...
if.end740:                                        ; preds = %do.body719.preheader
  ...
  %291 = load i16, ptr %arrayidx743, align 2, !tbaa !48
...
if.end740.1:                                      ; preds = %do.body719.1
  ...
  %295 = load i16, ptr %arrayidx743.1, align 2, !tbaa !48
...
if.end740.2:                                      ; preds = %do.body719.2
  ...
  %299 = load i16, ptr %arrayidx743.2, align 2, !tbaa !48
...
if.end740.3:                                      ; preds = %do.body719.3
  ...
  %303 = load i16, ptr %arrayidx743.3, align 2, !tbaa !48
...
if.end740.4:                                      ; preds = %do.body719.4
  ...
  %306 = load i16, ptr %arrayidx743.4, align 2, !tbaa !48
...
if.end740.5:                                      ; preds = %do.body719.5
  ...
  %311 = load i16, ptr %arrayidx743.5, align 2, !tbaa !48
...
if.end740.6:                                      ; preds = %do.body719.6
  ...
  %316 = load i16, ptr %arrayidx743.6, align 2, !tbaa !48
...
if.end740.7:                                      ; preds = %do.body719.7
  ...
  %321 = load i16, ptr %arrayidx743.7, align 2, !tbaa !48
...
if.end740.8:                                      ; preds = %do.body719.8
  ...
  %326 = load i16, ptr %arrayidx743.8, align 2, !tbaa !48
...
if.end740.9:                                      ; preds = %do.body719.9
  ...
  %331 = load i16, ptr %arrayidx743.9, align 2, !tbaa !48
...
if.end740.10:                                     ; preds = %do.body719.10
  ...
  %336 = load i16, ptr %arrayidx743.10, align 2, !tbaa !48
...
if.end740.11:                                     ; preds = %do.body719.11
  ...
  %341 = load i16, ptr %arrayidx743.11, align 2, !tbaa !48
...
if.end740.12:                                     ; preds = %do.body719.12
  ...
  %346 = load i16, ptr %arrayidx743.12, align 2, !tbaa !48
...
if.end740.13:                                     ; preds = %do.body719.13
  ...
  %351 = load i16, ptr %arrayidx743.13, align 2, !tbaa !48
...
if.end740.14:                                     ; preds = %do.body719.14
  ...
  %356 = load i16, ptr %arrayidx743.14, align 2, !tbaa !48
...
if.end740.15:                                     ; preds = %do.body719.15
  ...
  %361 = load i16, ptr %arrayidx743.15, align 2, !tbaa !48
...
if.end740.16:                                     ; preds = %do.body719.16
  ...
  %366 = load i16, ptr %arrayidx743.16, align 2, !tbaa !48
...
if.end740.17:                                     ; preds = %do.body719.17
  ...
  %371 = load i16, ptr %arrayidx743.17, align 2, !tbaa !48
...
if.end740.18:                                     ; preds = %do.body719.18
  ...
  %376 = load i16, ptr %arrayidx743.18, align 2, !tbaa !48
...
if.end740.19:                                     ; preds = %do.body719.19
  ...
  %380 = load i16, ptr %arrayidx743.19, align 2, !tbaa !48
...
if.then779:                                       ; preds = %while.body775
  %call780 = tail call fastcc i32 @lzx_read_input(ptr noundef %lzx)
  %tobool781.not = icmp eq i32 %call780, 0
  br i1 %tobool781.not, label %if.end784, label %if.then782

if.then782:                                       ; preds = %if.then779
  %383 = load i32, ptr %error, align 8, !tbaa !97
  br label %cleanup

if.end784:                                        ; preds = %if.then779
  %384 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %385 = load ptr, ptr %i_end30, align 8, !tbaa !98
  br label %if.end787
...
sw.epilog814:                                     ; preds = %if.end760, %while.end801, %sw.bb766, %sw.bb765, %sw.bb764
  ...
  %389 = load i32, ptr %window_size1326, align 8, !tbaa !87
...
if.then830:                                       ; preds = %if.then825
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.12) #12
  store i32 -124, ptr %error, align 8, !tbaa !97
  br label %cleanup
...
vector.body5120:                                  ; preds = %vector.body5120, %vector.ph5109
  ...
  br i1 %399, label %middle.block5107, label %vector.body5120, !llvm.loop !126
...
vector.ph5138:                                    ; preds = %vector.main.loop.iter.check5137
  ...
  br i1 %411, label %middle.block5131, label %vector.body5142.1, !llvm.loop !131
...
vec.epilog.vector.body5176:                       ; preds = %vec.epilog.vector.body5176, %vec.epilog.ph5158
  ...
  br i1 %432, label %vec.epilog.middle.block5155, label %vec.epilog.vector.body5176, !llvm.loop !132
...
if.then887:                                       ; preds = %while.body883
  %434 = load ptr, ptr %read.i, align 8, !tbaa !85
  %tobool.not.i2847 = icmp eq ptr %434, null
  %435 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  %436 = load i32, ptr %inbuf_size.i, align 8, !tbaa !86
  br i1 %tobool.not.i2847, label %cond.false.i2856, label %cond.true.i2852

cond.true.i2852:                                  ; preds = %if.then887
  %437 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i2851 = tail call i32 %434(ptr noundef %437, ptr noundef %435, i32 noundef %436) #12
  br label %cond.end.i2859

cond.false.i2856:                                 ; preds = %if.then887
  %438 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i2855 = tail call i32 @cli_readn(i32 noundef %438, ptr noundef %435, i32 noundef %436) #12
  br label %cond.end.i2859
...
if.then7.i2866:                                   ; preds = %if.end.i2863
  %439 = load i8, ptr %input_end.i, align 4, !tbaa !96
...
if.end892:                                        ; preds = %if.else.i2871, %if.end.i2863
  ...
  %442 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  store ptr %442, ptr %i_ptr29, align 8, !tbaa !99
  %idxprom.i2875 = zext i32 %bread.0.i2872 to i64
  %arrayidx21.i2876 = getelementptr inbounds i8, ptr %442, i64 %idxprom.i2875
  store ptr %arrayidx21.i2876, ptr %i_end30, align 8, !tbaa !98
  br label %if.end895
...
while.end909:                                     ; preds = %if.end895, %while.cond880.preheader
  ...
  %445 = load i16, ptr %arrayidx913, align 2, !tbaa !48
...
if.end939:                                        ; preds = %do.body918.preheader
  ...
  %449 = load i16, ptr %arrayidx942, align 2, !tbaa !48
...
if.end939.1:                                      ; preds = %do.body918.1
  ...
  %453 = load i16, ptr %arrayidx942.1, align 2, !tbaa !48
...
if.end939.2:                                      ; preds = %do.body918.2
  ...
  %457 = load i16, ptr %arrayidx942.2, align 2, !tbaa !48
...
if.end939.3:                                      ; preds = %do.body918.3
  ...
  %461 = load i16, ptr %arrayidx942.3, align 2, !tbaa !48
...
if.end939.4:                                      ; preds = %do.body918.4
  ...
  %464 = load i16, ptr %arrayidx942.4, align 2, !tbaa !48
...
if.end939.5:                                      ; preds = %do.body918.5
  ...
  %469 = load i16, ptr %arrayidx942.5, align 2, !tbaa !48
...
if.end939.6:                                      ; preds = %do.body918.6
  ...
  %474 = load i16, ptr %arrayidx942.6, align 2, !tbaa !48
...
if.end939.7:                                      ; preds = %do.body918.7
  ...
  %479 = load i16, ptr %arrayidx942.7, align 2, !tbaa !48
...
if.end939.8:                                      ; preds = %do.body918.8
  ...
  %484 = load i16, ptr %arrayidx942.8, align 2, !tbaa !48
...
if.end939.9:                                      ; preds = %do.body918.9
  ...
  %489 = load i16, ptr %arrayidx942.9, align 2, !tbaa !48
...
if.end939.10:                                     ; preds = %do.body918.10
  ...
  %494 = load i16, ptr %arrayidx942.10, align 2, !tbaa !48
...
if.end939.11:                                     ; preds = %do.body918.11
  ...
  %499 = load i16, ptr %arrayidx942.11, align 2, !tbaa !48
...
if.end939.12:                                     ; preds = %do.body918.12
  ...
  %504 = load i16, ptr %arrayidx942.12, align 2, !tbaa !48
...
if.end939.13:                                     ; preds = %do.body918.13
  ...
  %509 = load i16, ptr %arrayidx942.13, align 2, !tbaa !48
...
if.end939.14:                                     ; preds = %do.body918.14
  ...
  %514 = load i16, ptr %arrayidx942.14, align 2, !tbaa !48
...
if.end939.15:                                     ; preds = %do.body918.15
  ...
  %519 = load i16, ptr %arrayidx942.15, align 2, !tbaa !48
...
if.end939.16:                                     ; preds = %do.body918.16
  ...
  %524 = load i16, ptr %arrayidx942.16, align 2, !tbaa !48
...
if.end939.17:                                     ; preds = %do.body918.17
  ...
  %529 = load i16, ptr %arrayidx942.17, align 2, !tbaa !48
...
if.end939.18:                                     ; preds = %do.body918.18
  ...
  %534 = load i16, ptr %arrayidx942.18, align 2, !tbaa !48
...
if.end939.19:                                     ; preds = %do.body918.19
  ...
  %538 = load i16, ptr %arrayidx942.19, align 2, !tbaa !48
...
if.then980:                                       ; preds = %while.body976
  %540 = load ptr, ptr %read.i, align 8, !tbaa !85
  %tobool.not.i2882 = icmp eq ptr %540, null
  %541 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  %542 = load i32, ptr %inbuf_size.i, align 8, !tbaa !86
  br i1 %tobool.not.i2882, label %cond.false.i2891, label %cond.true.i2887

cond.true.i2887:                                  ; preds = %if.then980
  %543 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i2886 = tail call i32 %540(ptr noundef %543, ptr noundef %541, i32 noundef %542) #12
  br label %cond.end.i2894

cond.false.i2891:                                 ; preds = %if.then980
  %544 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i2890 = tail call i32 @cli_readn(i32 noundef %544, ptr noundef %541, i32 noundef %542) #12
  br label %cond.end.i2894
...
if.then7.i2901:                                   ; preds = %if.end.i2898
  %545 = load i8, ptr %input_end.i, align 4, !tbaa !96
...
if.end985:                                        ; preds = %if.else.i2906, %if.end.i2898
  ...
  %548 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  store ptr %548, ptr %i_ptr29, align 8, !tbaa !99
  %idxprom.i2910 = zext i32 %bread.0.i2907 to i64
  %arrayidx21.i2911 = getelementptr inbounds i8, ptr %548, i64 %idxprom.i2910
  store ptr %arrayidx21.i2911, ptr %i_end30, align 8, !tbaa !98
  br label %if.end988
...
while.end1002:                                    ; preds = %if.end988, %while.cond973.preheader
  ...
  %551 = load i16, ptr %arrayidx1006, align 2, !tbaa !48
...
if.end1032:                                       ; preds = %do.body1011.preheader
  ...
  %555 = load i16, ptr %arrayidx1035, align 2, !tbaa !48
...
if.end1032.1:                                     ; preds = %do.body1011.1
  ...
  %559 = load i16, ptr %arrayidx1035.1, align 2, !tbaa !48
...
if.end1032.2:                                     ; preds = %do.body1011.2
  ...
  %563 = load i16, ptr %arrayidx1035.2, align 2, !tbaa !48
...
if.end1032.3:                                     ; preds = %do.body1011.3
  ...
  %567 = load i16, ptr %arrayidx1035.3, align 2, !tbaa !48
...
if.end1032.4:                                     ; preds = %do.body1011.4
  ...
  %570 = load i16, ptr %arrayidx1035.4, align 2, !tbaa !48
...
if.end1032.5:                                     ; preds = %do.body1011.5
  ...
  %575 = load i16, ptr %arrayidx1035.5, align 2, !tbaa !48
...
if.end1032.6:                                     ; preds = %do.body1011.6
  ...
  %580 = load i16, ptr %arrayidx1035.6, align 2, !tbaa !48
...
if.end1032.7:                                     ; preds = %do.body1011.7
  ...
  %585 = load i16, ptr %arrayidx1035.7, align 2, !tbaa !48
...
if.end1032.8:                                     ; preds = %do.body1011.8
  ...
  %590 = load i16, ptr %arrayidx1035.8, align 2, !tbaa !48
...
if.end1032.9:                                     ; preds = %do.body1011.9
  ...
  %595 = load i16, ptr %arrayidx1035.9, align 2, !tbaa !48
...
if.end1032.10:                                    ; preds = %do.body1011.10
  ...
  %600 = load i16, ptr %arrayidx1035.10, align 2, !tbaa !48
...
if.end1032.11:                                    ; preds = %do.body1011.11
  ...
  %605 = load i16, ptr %arrayidx1035.11, align 2, !tbaa !48
...
if.end1032.12:                                    ; preds = %do.body1011.12
  ...
  %610 = load i16, ptr %arrayidx1035.12, align 2, !tbaa !48
...
if.end1032.13:                                    ; preds = %do.body1011.13
  ...
  %615 = load i16, ptr %arrayidx1035.13, align 2, !tbaa !48
...
if.end1032.14:                                    ; preds = %do.body1011.14
  ...
  %620 = load i16, ptr %arrayidx1035.14, align 2, !tbaa !48
...
if.end1032.15:                                    ; preds = %do.body1011.15
  ...
  %625 = load i16, ptr %arrayidx1035.15, align 2, !tbaa !48
...
if.end1032.16:                                    ; preds = %do.body1011.16
  ...
  %630 = load i16, ptr %arrayidx1035.16, align 2, !tbaa !48
...
if.end1032.17:                                    ; preds = %do.body1011.17
  ...
  %635 = load i16, ptr %arrayidx1035.17, align 2, !tbaa !48
...
if.end1032.18:                                    ; preds = %do.body1011.18
  ...
  %640 = load i16, ptr %arrayidx1035.18, align 2, !tbaa !48
...
if.end1032.19:                                    ; preds = %do.body1011.19
  ...
  %644 = load i16, ptr %arrayidx1035.19, align 2, !tbaa !48
...
if.then1079:                                      ; preds = %while.body1075
  %call1080 = tail call fastcc i32 @lzx_read_input(ptr noundef %lzx)
...
if.then1082:                                      ; preds = %if.then1079
  %648 = load i32, ptr %error, align 8, !tbaa !97
  br label %cleanup

if.end1084:                                       ; preds = %if.then1079
  %649 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %650 = load ptr, ptr %i_end30, align 8, !tbaa !98
  br label %if.end1087
...
if.then1120:                                      ; preds = %while.body1116
  %call1121 = tail call fastcc i32 @lzx_read_input(ptr noundef %lzx)
...
if.then1123:                                      ; preds = %if.then1120
  %653 = load i32, ptr %error, align 8, !tbaa !97
  br label %cleanup

if.end1125:                                       ; preds = %if.then1120
  %654 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %655 = load ptr, ptr %i_end30, align 8, !tbaa !98
  br label %if.end1128
...
while.end1142:                                    ; preds = %if.end1128, %while.end1101
  ...
  %658 = load i16, ptr %arrayidx1146, align 2, !tbaa !48
...
if.end1172:                                       ; preds = %do.body1151
  ...
  %661 = load i16, ptr %arrayidx1175, align 2, !tbaa !48
...
if.end1172.1:                                     ; preds = %if.end1157.1
  ...
  %664 = load i16, ptr %arrayidx1175.1, align 2, !tbaa !48
  %cmp1178.1 = icmp ugt i16 %664, 7
  br i1 %cmp1178.1, label %do.body1151, label %if.end1181, !llvm.loop !141
...
if.then1204:                                      ; preds = %while.body1200
  %call1205 = tail call fastcc i32 @lzx_read_input(ptr noundef %lzx)
...
if.then1207:                                      ; preds = %if.then1204
  %666 = load i32, ptr %error, align 8, !tbaa !97
  br label %cleanup

if.end1209:                                       ; preds = %if.then1204
  %667 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %668 = load ptr, ptr %i_end30, align 8, !tbaa !98
  br label %if.end1212
...
while.end1226:                                    ; preds = %if.end1212, %while.cond1197.preheader
  ...
  %671 = load i16, ptr %arrayidx1230, align 2, !tbaa !48
...
if.end1256:                                       ; preds = %do.body1235
  ...
  %674 = load i16, ptr %arrayidx1259, align 2, !tbaa !48
...
if.end1256.1:                                     ; preds = %if.end1241.1
  ...
  %677 = load i16, ptr %arrayidx1259.1, align 2, !tbaa !48
  %cmp1262.1 = icmp ugt i16 %677, 7
  br i1 %cmp1262.1, label %do.body1235, label %if.end1265, !llvm.loop !143
...
if.then1288:                                      ; preds = %while.body1284
  %call1289 = tail call fastcc i32 @lzx_read_input(ptr noundef %lzx)
...
if.then1291:                                      ; preds = %if.then1288
  %679 = load i32, ptr %error, align 8, !tbaa !97
  br label %cleanup

if.end1293:                                       ; preds = %if.then1288
  %680 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %681 = load ptr, ptr %i_end30, align 8, !tbaa !98
  br label %if.end1296
...
sw.epilog1324:                                    ; preds = %if.end1181, %while.end1310, %if.end1265, %if.else1192, %if.end1052, %sw.bb1057, %sw.bb1056
  ...
  %684 = load i32, ptr %window_size1326, align 8, !tbaa !87
...
vector.body5253:                                  ; preds = %vector.body5253, %vector.ph5242
  ...
  br i1 %694, label %middle.block5239, label %vector.body5253, !llvm.loop !145
...
vector.body5197:                                  ; preds = %vector.body5197, %vector.ph5193
  ...
  br i1 %700, label %middle.block5186, label %vector.body5197, !llvm.loop !147
...
vec.epilog.vector.body5231:                       ; preds = %vec.epilog.vector.body5231, %vec.epilog.ph5213
  ...
  br i1 %701, label %vec.epilog.middle.block5210, label %vec.epilog.vector.body5231, !llvm.loop !148
...
vector.ph5271:                                    ; preds = %vector.main.loop.iter.check5270
  ...
  br i1 %706, label %middle.block5264, label %vector.body5275.1, !llvm.loop !150
...
vec.epilog.vector.body5309:                       ; preds = %vec.epilog.vector.body5309, %vec.epilog.ph5291
  ...
  br i1 %727, label %vec.epilog.middle.block5288, label %vec.epilog.vector.body5309, !llvm.loop !151
...
if.else1410:                                      ; preds = %while.body1393
  %729 = load ptr, ptr %read.i, align 8, !tbaa !85
  %tobool.not.i2917 = icmp eq ptr %729, null
  %730 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  %731 = load i32, ptr %inbuf_size.i, align 8, !tbaa !86
  br i1 %tobool.not.i2917, label %cond.false.i2926, label %cond.true.i2922

cond.true.i2922:                                  ; preds = %if.else1410
  %732 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i2921 = tail call i32 %729(ptr noundef %732, ptr noundef %730, i32 noundef %731) #12
  br label %cond.end.i2929

cond.false.i2926:                                 ; preds = %if.else1410
  %733 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i2925 = tail call i32 @cli_readn(i32 noundef %733, ptr noundef %730, i32 noundef %731) #12
  br label %cond.end.i2929
...
if.then7.i2936:                                   ; preds = %if.end.i2933
  %734 = load i8, ptr %input_end.i, align 4, !tbaa !96
...
if.end1415:                                       ; preds = %if.else.i2941, %if.end.i2933
  ...
  %737 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  store ptr %737, ptr %i_ptr29, align 8, !tbaa !99
  %idxprom.i2945 = zext i32 %bread.0.i2942 to i64
  %arrayidx21.i2946 = getelementptr inbounds i8, ptr %737, i64 %idxprom.i2945
  store ptr %arrayidx21.i2946, ptr %i_end30, align 8, !tbaa !98
  br label %if.end1418
...
if.then1425:                                      ; preds = %sw.epilog1422
  ...
  %738 = load i32, ptr %block_remaining, align 4, !tbaa !108
  %cmp1428 = icmp ult i32 %738, %sub1426
  br i1 %cmp1428, label %if.then1430, label %if.end1434

if.then1430:                                      ; preds = %if.then1425
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.13, i32 noundef %sub1426, i32 noundef %738) #12
  store i32 -124, ptr %error, align 8, !tbaa !97
  br label %cleanup

if.end1434:                                       ; preds = %if.then1425
  %sub1437 = add i32 %738, %this_run.7
  store i32 %sub1437, ptr %block_remaining, align 4, !tbaa !108
  br label %if.end1438
...
while.end1439.loopexit:                           ; preds = %if.end1438
  %.pre4827 = load i32, ptr %frame_posn, align 8, !tbaa !89
...
if.then1444:                                      ; preds = %while.end1439
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.14, i32 noundef %sub1441, i32 noundef %frame_size.0) #12
  store i32 -124, ptr %error, align 8, !tbaa !97
  br label %cleanup
...
if.then1459:                                      ; preds = %while.body1455
  %call1460 = tail call fastcc i32 @lzx_read_input(ptr noundef %lzx)
...
if.then1462:                                      ; preds = %if.then1459
  %741 = load i32, ptr %error, align 8, !tbaa !97
  br label %cleanup

if.end1464:                                       ; preds = %if.then1459
  %742 = load ptr, ptr %i_ptr29, align 8, !tbaa !99
  %743 = load ptr, ptr %i_end30, align 8, !tbaa !98
  br label %if.end1467
...
if.end1482:                                       ; preds = %if.end1467, %if.end1448
  ...
  %746 = load ptr, ptr %o_ptr, align 8, !tbaa !101
  %747 = load ptr, ptr %o_end, align 8, !tbaa !100
...
if.then1495:                                      ; preds = %if.end1482
  ...
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.15, i64 noundef %sub.ptr.sub1500, i32 noundef %frame_size.0) #12
  store i32 -124, ptr %error, align 8, !tbaa !97
  br label %cleanup

if.end1502:                                       ; preds = %if.end1482
  %748 = load i8, ptr %intel_started472, align 8, !tbaa !95
  %tobool1505.not = icmp eq i8 %748, 0
  %.pre4829 = load i32, ptr %intel_filesize, align 8, !tbaa !92
...
if.then1516:                                      ; preds = %land.lhs.true1509
  ...
  %754 = load i32, ptr %intel_curpos, align 4, !tbaa !93
  store ptr %e8_buf, ptr %o_ptr, align 8, !tbaa !101
  %755 = load ptr, ptr %window33, align 8, !tbaa !75
  %756 = load i32, ptr %frame_posn, align 8, !tbaa !89
...
if.end1539:                                       ; preds = %while.body1532
  ...
  %or.cond2530 = select i1 %cmp1555.not, i1 %cmp1558, i1 false
...
while.end1580.loopexit:                           ; preds = %while.cond1529.backedge
  %.pre4828 = load i32, ptr %intel_curpos, align 4, !tbaa !93
  %.pre4830.pre = load ptr, ptr %o_ptr, align 8, !tbaa !101
...
while.end1580:                                    ; preds = %while.end1580.loopexit, %if.then1516
  ...
  store i32 %add1582, ptr %intel_curpos, align 4, !tbaa !93
  br label %if.end1595

if.else1583:                                      ; preds = %if.end1502
  %766 = load ptr, ptr %window33, align 8, !tbaa !75
  %767 = load i32, ptr %frame_posn, align 8, !tbaa !89
  %idxprom1586 = zext i32 %767 to i64
  %arrayidx1587 = getelementptr inbounds i8, ptr %766, i64 %idxprom1586
  store ptr %arrayidx1587, ptr %o_ptr, align 8, !tbaa !101
...
if.then1591:                                      ; preds = %if.else1583.thread4837, %if.else1583
  ...
  %768 = load i32, ptr %intel_curpos, align 4, !tbaa !93
  %add1593 = add i32 %768, %frame_size.0
  store i32 %add1593, ptr %intel_curpos, align 4, !tbaa !93
  br label %if.end1595
...
if.end1595:                                       ; preds = %if.else1583.thread, %if.else1583, %if.then1591, %while.end1580
  ...
  store ptr %arrayidx1598, ptr %o_end, align 8, !tbaa !100
  ...
  %770 = load i8, ptr %wflag1608, align 8, !tbaa !81
...
land.lhs.true1611:                                ; preds = %if.end1595
  %771 = load i32, ptr %ofd1612, align 4, !tbaa !80
  %call1614 = tail call i32 @cli_writen(i32 noundef %771, ptr noundef %769, i32 noundef %cond1607) #12
...
land.lhs.true1611.if.end1619_crit_edge:           ; preds = %land.lhs.true1611
  %.pre4831 = load ptr, ptr %o_ptr, align 8, !tbaa !101
  br label %if.end1619
...
if.end1619:                                       ; preds = %land.lhs.true1611.if.end1619_crit_edge, %if.end1595
  ...
  store ptr %add.ptr1622, ptr %o_ptr, align 8, !tbaa !101
  %773 = load i64, ptr %offset38, align 8, !tbaa !82
  %add1625 = add nsw i64 %773, %idx.ext1621
  store i64 %add1625, ptr %offset38, align 8, !tbaa !82
  %sub1627 = sub nsw i64 %out_bytes.addr.14699, %idx.ext1621
  %774 = load i32, ptr %frame_posn, align 8, !tbaa !89
  %add1629 = add i32 %774, %frame_size.0
  store i32 %add1629, ptr %frame_posn, align 8, !tbaa !89
  %775 = load i32, ptr %frame, align 4, !tbaa !90
  %inc1631 = add i32 %775, 1
  store i32 %inc1631, ptr %frame, align 4, !tbaa !90
  %776 = load i32, ptr %window_size1326, align 8, !tbaa !87
...
do.body1649:                                      ; preds = %while.end1644
  store ptr %i_ptr.60, ptr %i_ptr29, align 8, !tbaa !99
  store ptr %i_end.59, ptr %i_end30, align 8, !tbaa !98
  store i32 %shl1487, ptr %bit_buffer31, align 8, !tbaa !103
  store i32 %sub1489, ptr %bits_left32, align 4, !tbaa !102
  store i32 %spec.store.select, ptr %window_posn34, align 4, !tbaa !88
  store i32 %R0.1.lcssa, ptr %R035, align 4, !tbaa !104
  store i32 %R1.1.lcssa, ptr %R136, align 8, !tbaa !105
  store i32 %R2.1.lcssa, ptr %R237, align 4, !tbaa !106
  br label %cleanup
...
entry:
  ...
  %0 = load ptr, ptr %read, align 8, !tbaa !85
  %tobool.not = icmp eq ptr %0, null
  br i1 %tobool.not, label %cond.false, label %cond.true

cond.true:                                        ; preds = %entry
  %file = getelementptr inbounds %struct.lzx_stream, ptr %lzx, i64 0, i32 43
  %1 = load ptr, ptr %file, align 8, !tbaa !84
  %inbuf = getelementptr inbounds %struct.lzx_stream, ptr %lzx, i64 0, i32 24
  %2 = load ptr, ptr %inbuf, align 8, !tbaa !78
  %inbuf_size = getelementptr inbounds %struct.lzx_stream, ptr %lzx, i64 0, i32 31
  %3 = load i32, ptr %inbuf_size, align 8, !tbaa !86
  %call = tail call i32 %0(ptr noundef %1, ptr noundef %2, i32 noundef %3) #12
  br label %cond.end

cond.false:                                       ; preds = %entry
  %4 = load i32, ptr %lzx, align 8, !tbaa !79
  %inbuf2 = getelementptr inbounds %struct.lzx_stream, ptr %lzx, i64 0, i32 24
  %5 = load ptr, ptr %inbuf2, align 8, !tbaa !78
  %inbuf_size4 = getelementptr inbounds %struct.lzx_stream, ptr %lzx, i64 0, i32 31
  %6 = load i32, ptr %inbuf_size4, align 8, !tbaa !86
  %call5 = tail call i32 @cli_readn(i32 noundef %4, ptr noundef %5, i32 noundef %6) #12
  br label %cond.end
...
if.then7:                                         ; preds = %if.end
  ...
  %7 = load i8, ptr %input_end, align 4, !tbaa !96
...
if.end17:                                         ; preds = %if.else, %if.end
  ...
  store ptr %arrayidx21, ptr %i_end, align 8, !tbaa !98
  br label %cleanup
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <8 x i16> %broadcast.splat, ptr %5, align 2, !tbaa !48
  %6 = getelementptr inbounds i16, ptr %5, i64 8
  store <8 x i16> %broadcast.splat324, ptr %6, align 2, !tbaa !48
...
for.body18.us.prol:                               ; preds = %for.body18.us.preheader348, %for.body18.us.prol
  ...
  store i16 %sym.0211.us223, ptr %arrayidx20.us.prol, align 2, !tbaa !48
...
for.body18.us:                                    ; preds = %for.body18.us.prol.loopexit, %for.body18.us
  ...
  store i16 %sym.0211.us223, ptr %arrayidx20.us, align 2, !tbaa !48
  ...
  store i16 %sym.0211.us223, ptr %arrayidx20.us.1, align 2, !tbaa !48
  ...
  store i16 %sym.0211.us223, ptr %arrayidx20.us.2, align 2, !tbaa !48
  ...
  store i16 %sym.0211.us223, ptr %arrayidx20.us.3, align 2, !tbaa !48
...
vector.body337:                                   ; preds = %vector.body337, %vector.ph331
  ...
  store <8 x i16> <i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1>, ptr %28, align 2, !tbaa !48
  %29 = getelementptr inbounds i16, ptr %28, i64 8
  store <8 x i16> <i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1, i16 -1>, ptr %29, align 2, !tbaa !48
  %index.next341 = add nuw i32 %index338, 16
  %30 = icmp eq i32 %index.next341, %n.vec333
  br i1 %30, label %middle.block328, label %vector.body337, !llvm.loop !163
...
for.body36:                                       ; preds = %for.body36.preheader347, %for.body36
  ...
  store i16 -1, ptr %arrayidx38, align 2, !tbaa !48
...
if.end63.us270:                                   ; preds = %for.body55.us264
  ...
  store i16 %sym.2249.us266, ptr %arrayidx101.us273, align 2, !tbaa !48
...
for.body69.us.us:                                 ; preds = %if.end87.us.us, %if.end63.us.us
  ...
  %39 = load i16, ptr %arrayidx71.us.us, align 2, !tbaa !48
...
if.then75.us.us:                                  ; preds = %for.body69.us.us
  ...
  store <2 x i16> <i16 -1, i16 -1>, ptr %arrayidx78.us.us, align 2, !tbaa !48
  %inc83.us.us = add i32 %next_symbol.2246.us.us, 1
  %conv84.us.us = trunc i32 %next_symbol.2246.us.us to i16
  store i16 %conv84.us.us, ptr %arrayidx71.us.us, align 2, !tbaa !48
...
for.cond65.for.end99_crit_edge.us.us:             ; preds = %if.end87.us.us
  ...
  store i16 %sym.2249.us.us, ptr %arrayidx101.us.us, align 2, !tbaa !48
...
if.then:                                          ; preds = %while.body
  %4 = load ptr, ptr %read.i, align 8, !tbaa !85
  %tobool.not.i = icmp eq ptr %4, null
  %5 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  %6 = load i32, ptr %inbuf_size.i, align 8, !tbaa !86
  br i1 %tobool.not.i, label %cond.false.i, label %cond.true.i

cond.true.i:                                      ; preds = %if.then
  %7 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i = tail call i32 %4(ptr noundef %7, ptr noundef %5, i32 noundef %6) #12
  br label %cond.end.i

cond.false.i:                                     ; preds = %if.then
  %8 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i = tail call i32 @cli_readn(i32 noundef %8, ptr noundef %5, i32 noundef %6) #12
  br label %cond.end.i
...
if.then.i:                                        ; preds = %cond.end.i
  ...
  store i32 -123, ptr %error.i, align 8, !tbaa !97
  br label %cleanup
...
if.then7.i:                                       ; preds = %if.end.i
  %9 = load i8, ptr %input_end.i, align 4, !tbaa !96
...
if.then9.i:                                       ; preds = %if.then7.i
  ...
  store i32 -123, ptr %error10.i, align 8, !tbaa !97
  br label %cleanup

if.else.i:                                        ; preds = %if.then7.i
  %10 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  %arrayidx12.i = getelementptr inbounds i8, ptr %10, i64 1
  store i8 0, ptr %arrayidx12.i, align 1, !tbaa !28
  %11 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
...
if.end:                                           ; preds = %if.else.i, %if.end.i
  %bread.0.i = phi i32 [ 2, %if.else.i ], [ %cond.i, %if.end.i ]
  %12 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  store ptr %12, ptr %i_ptr1, align 8, !tbaa !99
  %idxprom.i = zext i32 %bread.0.i to i64
  %arrayidx21.i = getelementptr inbounds i8, ptr %12, i64 %idxprom.i
  store ptr %arrayidx21.i, ptr %i_end2, align 8, !tbaa !98
  br label %if.end11
...
for.end:                                          ; preds = %while.end
  ...
  %call27 = tail call fastcc i32 @lzx_make_decode_table(i32 noundef 20, i32 noundef 6, ptr noundef nonnull %PRETREE_len24, ptr noundef nonnull %PRETREE_table)
...
if.then29:                                        ; preds = %for.end
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.4, ptr noundef nonnull @.str.25) #12
  %error30 = getelementptr inbounds %struct.lzx_stream, ptr %lzx, i64 0, i32 23
  store i32 -124, ptr %error30, align 8, !tbaa !97
  br label %cleanup
...
if.then44:                                        ; preds = %while.body40
  %15 = load ptr, ptr %read.i, align 8, !tbaa !85
  %tobool.not.i554 = icmp eq ptr %15, null
  %16 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  %17 = load i32, ptr %inbuf_size.i, align 8, !tbaa !86
  br i1 %tobool.not.i554, label %cond.false.i563, label %cond.true.i559

cond.true.i559:                                   ; preds = %if.then44
  %18 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i558 = tail call i32 %15(ptr noundef %18, ptr noundef %16, i32 noundef %17) #12
  br label %cond.end.i566

cond.false.i563:                                  ; preds = %if.then44
  %19 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i562 = tail call i32 @cli_readn(i32 noundef %19, ptr noundef %16, i32 noundef %17) #12
  br label %cond.end.i566
...
if.then.i568:                                     ; preds = %cond.end.i566
  ...
  store i32 -123, ptr %error.i567, align 8, !tbaa !97
  br label %cleanup
...
if.then7.i573:                                    ; preds = %if.end.i570
  %20 = load i8, ptr %input_end.i, align 4, !tbaa !96
...
while.end66:                                      ; preds = %if.end52, %while.cond37.preheader
  ...
  %26 = load i16, ptr %arrayidx70, align 2, !tbaa !48
...
if.then79:                                        ; preds = %do.body75
  ...
  store i32 -124, ptr %error80, align 8, !tbaa !97
  br label %cleanup
...
if.then92:                                        ; preds = %do.body75.1, %if.end81
  ...
  store i32 -124, ptr %error93, align 8, !tbaa !97
  br label %cleanup
...
if.end94:                                         ; preds = %if.end81
  ...
  %29 = load i16, ptr %arrayidx97, align 2, !tbaa !48
...
if.end94.1:                                       ; preds = %do.body75.1
  ...
  %32 = load i16, ptr %arrayidx97.1, align 2, !tbaa !48
  %cmp100.1 = icmp ugt i16 %32, 19
  br i1 %cmp100.1, label %do.body75, label %if.end103, !llvm.loop !172
...
if.then124:                                       ; preds = %while.body120
  %34 = load ptr, ptr %read.i, align 8, !tbaa !85
  %tobool.not.i589 = icmp eq ptr %34, null
  %35 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  %36 = load i32, ptr %inbuf_size.i, align 8, !tbaa !86
  br i1 %tobool.not.i589, label %cond.false.i598, label %cond.true.i594

cond.true.i594:                                   ; preds = %if.then124
  %37 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i593 = tail call i32 %34(ptr noundef %37, ptr noundef %35, i32 noundef %36) #12
  br label %cond.end.i601

cond.false.i598:                                  ; preds = %if.then124
  %38 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i597 = tail call i32 @cli_readn(i32 noundef %38, ptr noundef %35, i32 noundef %36) #12
  br label %cond.end.i601
...
if.then.i603:                                     ; preds = %cond.end.i601
  ...
  store i32 -123, ptr %error.i602, align 8, !tbaa !97
  br label %cleanup
...
if.then7.i608:                                    ; preds = %if.end.i605
  %39 = load i8, ptr %input_end.i, align 4, !tbaa !96
...
if.then9.i610:                                    ; preds = %if.then7.i608
  ...
  store i32 -123, ptr %error10.i609, align 8, !tbaa !97
  br label %cleanup
...
if.end129:                                        ; preds = %if.else.i613, %if.end.i605
  ...
  %42 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  store ptr %42, ptr %i_ptr1, align 8, !tbaa !99
  %idxprom.i617 = zext i32 %bread.0.i614 to i64
  %arrayidx21.i618 = getelementptr inbounds i8, ptr %42, i64 %idxprom.i617
  store ptr %arrayidx21.i618, ptr %i_end2, align 8, !tbaa !98
  br label %if.end132
...
while.body155.prol:                               ; preds = %while.body155.preheader, %while.body155.prol
  ...
  br i1 %prol.iter958.cmp.not, label %while.body155.prol.loopexit, label %while.body155.prol, !llvm.loop !174
...
if.then171:                                       ; preds = %while.body167
  %52 = load ptr, ptr %read.i, align 8, !tbaa !85
  %tobool.not.i624 = icmp eq ptr %52, null
  %53 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  %54 = load i32, ptr %inbuf_size.i, align 8, !tbaa !86
  br i1 %tobool.not.i624, label %cond.false.i633, label %cond.true.i629

cond.true.i629:                                   ; preds = %if.then171
  %55 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i628 = tail call i32 %52(ptr noundef %55, ptr noundef %53, i32 noundef %54) #12
  br label %cond.end.i636

cond.false.i633:                                  ; preds = %if.then171
  %56 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i632 = tail call i32 @cli_readn(i32 noundef %56, ptr noundef %53, i32 noundef %54) #12
  br label %cond.end.i636
...
if.then.i638:                                     ; preds = %cond.end.i636
  ...
  store i32 -123, ptr %error.i637, align 8, !tbaa !97
  br label %cleanup
...
if.then7.i643:                                    ; preds = %if.end.i640
  %57 = load i8, ptr %input_end.i, align 4, !tbaa !96
...
if.end176:                                        ; preds = %if.else.i648, %if.end.i640
  ...
  %60 = load ptr, ptr %inbuf.i, align 8, !tbaa !78
  store ptr %60, ptr %i_ptr1, align 8, !tbaa !99
  %idxprom.i652 = zext i32 %bread.0.i649 to i64
  %arrayidx21.i653 = getelementptr inbounds i8, ptr %60, i64 %idxprom.i652
  store ptr %arrayidx21.i653, ptr %i_end2, align 8, !tbaa !98
  br label %if.end179
...
vector.ph941:                                     ; preds = %while.end193
  ...
  br i1 %68, label %middle.block938, label %vector.body949.1, !llvm.loop !177
...
vector.body949.1:                                 ; preds = %vector.ph941
  ...
  br i1 %71, label %middle.block938, label %vector.body949.2, !llvm.loop !177
...
cond.true.i664:                                   ; preds = %if.then220
  %79 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i663 = tail call i32 %76(ptr noundef %79, ptr noundef %77, i32 noundef %78) #12
  br label %cond.end.i671

cond.false.i668:                                  ; preds = %if.then220
  %80 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i667 = tail call i32 @cli_readn(i32 noundef %80, ptr noundef %77, i32 noundef %78) #12
  br label %cond.end.i671
...
if.then.i673:                                     ; preds = %cond.end.i671
  ...
  store i32 -123, ptr %error.i672, align 8, !tbaa !97
  br label %cleanup
...
if.then9.i680:                                    ; preds = %if.then7.i678
  ...
  store i32 -123, ptr %error10.i679, align 8, !tbaa !97
  br label %cleanup
...
cond.true.i699:                                   ; preds = %if.then257
  %90 = load ptr, ptr %file.i, align 8, !tbaa !84
  %call.i698 = tail call i32 %87(ptr noundef %90, ptr noundef %88, i32 noundef %89) #12
  br label %cond.end.i706

cond.false.i703:                                  ; preds = %if.then257
  %91 = load i32, ptr %lzx, align 8, !tbaa !79
  %call5.i702 = tail call i32 @cli_readn(i32 noundef %91, ptr noundef %88, i32 noundef %89) #12
  br label %cond.end.i706
...
if.then.i708:                                     ; preds = %cond.end.i706
  ...
  store i32 -123, ptr %error.i707, align 8, !tbaa !97
  br label %cleanup
...
if.then9.i715:                                    ; preds = %if.then7.i713
  ...
  store i32 -123, ptr %error10.i714, align 8, !tbaa !97
  br label %cleanup
...
while.end279:                                     ; preds = %if.end265, %while.end242
  ...
  %98 = load i16, ptr %arrayidx283, align 2, !tbaa !48
...
if.then292:                                       ; preds = %do.body288
  ...
  store i32 -124, ptr %error293, align 8, !tbaa !97
  br label %cleanup
...
if.then307:                                       ; preds = %do.body288.1, %if.end294
  ...
  store i32 -124, ptr %error308, align 8, !tbaa !97
  br label %cleanup
...
if.end309:                                        ; preds = %if.end294
  ...
  %101 = load i16, ptr %arrayidx312, align 2, !tbaa !48
...
if.end309.1:                                      ; preds = %do.body288.1
  ...
  %104 = load i16, ptr %arrayidx312.1, align 2, !tbaa !48
  %cmp315.1 = icmp ugt i16 %104, 19
  br i1 %cmp315.1, label %do.body288, label %if.end318, !llvm.loop !182
...
do.body364:                                       ; preds = %if.end362, %for.cond32.preheader
  ...
  store ptr %i_ptr.3.lcssa, ptr %i_ptr1, align 8, !tbaa !99
  store ptr %i_end.3.lcssa, ptr %i_end2, align 8, !tbaa !98
  store i32 %bit_buffer.2.lcssa, ptr %bit_buffer3, align 8, !tbaa !103
  store i32 %bits_left.2.lcssa, ptr %bits_left4, align 4, !tbaa !102
  br label %cleanup
...
if.then:                                          ; preds = %entry
  %inbuf = getelementptr inbounds %struct.lzx_stream, ptr %lzx, i64 0, i32 24
  %0 = load ptr, ptr %inbuf, align 8, !tbaa !78
  tail call void @free(ptr noundef %0) #12
  %window = getelementptr inbounds %struct.lzx_stream, ptr %lzx, i64 0, i32 5
  %1 = load ptr, ptr %window, align 8, !tbaa !75
  tail call void @free(ptr noundef %1) #12
  tail call void @free(ptr noundef nonnull %lzx) #12
  br label %if.end
...
if.end4:                                          ; preds = %if.end
  %call = tail call ptr @cli_malloc(i64 noundef 2136) #12
...
for.body:                                         ; preds = %if.end4, %for.body
  ...
  store i32 %offset.0277, ptr %arrayidx, align 4, !tbaa !73
  ...
  store i32 %add16, ptr %arrayidx.1, align 4, !tbaa !73
  ...
  br i1 %exitcond.not.1, label %for.body20.preheader, label %for.body, !llvm.loop !185
...
for.body20.preheader:                             ; preds = %for.body
  ...
  %call49 = tail call ptr @cli_malloc(i64 noundef %conv48) #12
  %window = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 3
  store ptr %call49, ptr %window, align 8, !tbaa !186
...
if.end60:                                         ; preds = %if.end53
  ...
  store i32 4, ptr %model0, align 8, !tbaa !205
  %entries.i = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 24, i32 1
  store i32 64, ptr %entries.i, align 4, !tbaa !206
  %syms1.i = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 24, i32 2
  store ptr %m0sym, ptr %syms1.i, align 8, !tbaa !207
  store <8 x i16> <i16 0, i16 64, i16 1, i16 63, i16 2, i16 62, i16 3, i16 61>, ptr %m0sym, align 2, !tbaa !48
  %5 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 4
  store <8 x i16> <i16 4, i16 60, i16 5, i16 59, i16 6, i16 58, i16 7, i16 57>, ptr %5, align 2, !tbaa !48
  %6 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 8
  store <8 x i16> <i16 8, i16 56, i16 9, i16 55, i16 10, i16 54, i16 11, i16 53>, ptr %6, align 2, !tbaa !48
  %7 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 12
  store <8 x i16> <i16 12, i16 52, i16 13, i16 51, i16 14, i16 50, i16 15, i16 49>, ptr %7, align 2, !tbaa !48
  %8 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 16
  store <8 x i16> <i16 16, i16 48, i16 17, i16 47, i16 18, i16 46, i16 19, i16 45>, ptr %8, align 2, !tbaa !48
  %9 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 20
  store <8 x i16> <i16 20, i16 44, i16 21, i16 43, i16 22, i16 42, i16 23, i16 41>, ptr %9, align 2, !tbaa !48
  %10 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 24
  store <8 x i16> <i16 24, i16 40, i16 25, i16 39, i16 26, i16 38, i16 27, i16 37>, ptr %10, align 2, !tbaa !48
  %11 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 28
  store <8 x i16> <i16 28, i16 36, i16 29, i16 35, i16 30, i16 34, i16 31, i16 33>, ptr %11, align 2, !tbaa !48
  %12 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 32
  store <8 x i16> <i16 32, i16 32, i16 33, i16 31, i16 34, i16 30, i16 35, i16 29>, ptr %12, align 2, !tbaa !48
  %13 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 36
  store <8 x i16> <i16 36, i16 28, i16 37, i16 27, i16 38, i16 26, i16 39, i16 25>, ptr %13, align 2, !tbaa !48
  %14 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 40
  store <8 x i16> <i16 40, i16 24, i16 41, i16 23, i16 42, i16 22, i16 43, i16 21>, ptr %14, align 2, !tbaa !48
  %15 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 44
  store <8 x i16> <i16 44, i16 20, i16 45, i16 19, i16 46, i16 18, i16 47, i16 17>, ptr %15, align 2, !tbaa !48
  %16 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 48
  store <8 x i16> <i16 48, i16 16, i16 49, i16 15, i16 50, i16 14, i16 51, i16 13>, ptr %16, align 2, !tbaa !48
  %17 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 52
  store <8 x i16> <i16 52, i16 12, i16 53, i16 11, i16 54, i16 10, i16 55, i16 9>, ptr %17, align 2, !tbaa !48
  %18 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 56
  store <8 x i16> <i16 56, i16 8, i16 57, i16 7, i16 58, i16 6, i16 59, i16 5>, ptr %18, align 2, !tbaa !48
  %19 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 60
  store <8 x i16> <i16 60, i16 4, i16 61, i16 3, i16 62, i16 2, i16 63, i16 1>, ptr %19, align 2, !tbaa !48
  %arrayidx.i = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 64
  store i16 64, ptr %arrayidx.i, align 2, !tbaa !208
  %cumfreq.i = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 33, i64 64, i32 1
  store i16 0, ptr %cumfreq.i, align 2, !tbaa !210
  ...
  store i32 4, ptr %model1, align 8, !tbaa !205
  %entries.i174 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 25, i32 1
  store i32 64, ptr %entries.i174, align 4, !tbaa !206
  %syms1.i175 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 25, i32 2
  store ptr %m1sym, ptr %syms1.i175, align 8, !tbaa !207
  store <8 x i16> <i16 64, i16 64, i16 65, i16 63, i16 66, i16 62, i16 67, i16 61>, ptr %m1sym, align 2, !tbaa !48
  %20 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 4
  store <8 x i16> <i16 68, i16 60, i16 69, i16 59, i16 70, i16 58, i16 71, i16 57>, ptr %20, align 2, !tbaa !48
  %21 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 8
  store <8 x i16> <i16 72, i16 56, i16 73, i16 55, i16 74, i16 54, i16 75, i16 53>, ptr %21, align 2, !tbaa !48
  %22 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 12
  store <8 x i16> <i16 76, i16 52, i16 77, i16 51, i16 78, i16 50, i16 79, i16 49>, ptr %22, align 2, !tbaa !48
  %23 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 16
  store <8 x i16> <i16 80, i16 48, i16 81, i16 47, i16 82, i16 46, i16 83, i16 45>, ptr %23, align 2, !tbaa !48
  %24 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 20
  store <8 x i16> <i16 84, i16 44, i16 85, i16 43, i16 86, i16 42, i16 87, i16 41>, ptr %24, align 2, !tbaa !48
  %25 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 24
  store <8 x i16> <i16 88, i16 40, i16 89, i16 39, i16 90, i16 38, i16 91, i16 37>, ptr %25, align 2, !tbaa !48
  %26 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 28
  store <8 x i16> <i16 92, i16 36, i16 93, i16 35, i16 94, i16 34, i16 95, i16 33>, ptr %26, align 2, !tbaa !48
  %27 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 32
  store <8 x i16> <i16 96, i16 32, i16 97, i16 31, i16 98, i16 30, i16 99, i16 29>, ptr %27, align 2, !tbaa !48
  %28 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 36
  store <8 x i16> <i16 100, i16 28, i16 101, i16 27, i16 102, i16 26, i16 103, i16 25>, ptr %28, align 2, !tbaa !48
  %29 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 40
  store <8 x i16> <i16 104, i16 24, i16 105, i16 23, i16 106, i16 22, i16 107, i16 21>, ptr %29, align 2, !tbaa !48
  %30 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 44
  store <8 x i16> <i16 108, i16 20, i16 109, i16 19, i16 110, i16 18, i16 111, i16 17>, ptr %30, align 2, !tbaa !48
  %31 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 48
  store <8 x i16> <i16 112, i16 16, i16 113, i16 15, i16 114, i16 14, i16 115, i16 13>, ptr %31, align 2, !tbaa !48
  %32 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 52
  store <8 x i16> <i16 116, i16 12, i16 117, i16 11, i16 118, i16 10, i16 119, i16 9>, ptr %32, align 2, !tbaa !48
  %33 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 56
  store <8 x i16> <i16 120, i16 8, i16 121, i16 7, i16 122, i16 6, i16 123, i16 5>, ptr %33, align 2, !tbaa !48
  %34 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 60
  store <8 x i16> <i16 124, i16 4, i16 125, i16 3, i16 126, i16 2, i16 127, i16 1>, ptr %34, align 2, !tbaa !48
  %arrayidx.i178 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 64
  store i16 128, ptr %arrayidx.i178, align 2, !tbaa !208
  %cumfreq.i181 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 34, i64 64, i32 1
  store i16 0, ptr %cumfreq.i181, align 2, !tbaa !210
  ...
  store i32 4, ptr %model2, align 8, !tbaa !205
  %entries.i186 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 26, i32 1
  store i32 64, ptr %entries.i186, align 4, !tbaa !206
  %syms1.i187 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 26, i32 2
  store ptr %m2sym, ptr %syms1.i187, align 8, !tbaa !207
  store <8 x i16> <i16 128, i16 64, i16 129, i16 63, i16 130, i16 62, i16 131, i16 61>, ptr %m2sym, align 2, !tbaa !48
  %35 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 4
  store <8 x i16> <i16 132, i16 60, i16 133, i16 59, i16 134, i16 58, i16 135, i16 57>, ptr %35, align 2, !tbaa !48
  %36 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 8
  store <8 x i16> <i16 136, i16 56, i16 137, i16 55, i16 138, i16 54, i16 139, i16 53>, ptr %36, align 2, !tbaa !48
  %37 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 12
  store <8 x i16> <i16 140, i16 52, i16 141, i16 51, i16 142, i16 50, i16 143, i16 49>, ptr %37, align 2, !tbaa !48
  %38 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 16
  store <8 x i16> <i16 144, i16 48, i16 145, i16 47, i16 146, i16 46, i16 147, i16 45>, ptr %38, align 2, !tbaa !48
  %39 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 20
  store <8 x i16> <i16 148, i16 44, i16 149, i16 43, i16 150, i16 42, i16 151, i16 41>, ptr %39, align 2, !tbaa !48
  %40 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 24
  store <8 x i16> <i16 152, i16 40, i16 153, i16 39, i16 154, i16 38, i16 155, i16 37>, ptr %40, align 2, !tbaa !48
  %41 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 28
  store <8 x i16> <i16 156, i16 36, i16 157, i16 35, i16 158, i16 34, i16 159, i16 33>, ptr %41, align 2, !tbaa !48
  %42 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 32
  store <8 x i16> <i16 160, i16 32, i16 161, i16 31, i16 162, i16 30, i16 163, i16 29>, ptr %42, align 2, !tbaa !48
  %43 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 36
  store <8 x i16> <i16 164, i16 28, i16 165, i16 27, i16 166, i16 26, i16 167, i16 25>, ptr %43, align 2, !tbaa !48
  %44 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 40
  store <8 x i16> <i16 168, i16 24, i16 169, i16 23, i16 170, i16 22, i16 171, i16 21>, ptr %44, align 2, !tbaa !48
  %45 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 44
  store <8 x i16> <i16 172, i16 20, i16 173, i16 19, i16 174, i16 18, i16 175, i16 17>, ptr %45, align 2, !tbaa !48
  %46 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 48
  store <8 x i16> <i16 176, i16 16, i16 177, i16 15, i16 178, i16 14, i16 179, i16 13>, ptr %46, align 2, !tbaa !48
  %47 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 52
  store <8 x i16> <i16 180, i16 12, i16 181, i16 11, i16 182, i16 10, i16 183, i16 9>, ptr %47, align 2, !tbaa !48
  %48 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 56
  store <8 x i16> <i16 184, i16 8, i16 185, i16 7, i16 186, i16 6, i16 187, i16 5>, ptr %48, align 2, !tbaa !48
  %49 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 60
  store <8 x i16> <i16 188, i16 4, i16 189, i16 3, i16 190, i16 2, i16 191, i16 1>, ptr %49, align 2, !tbaa !48
  %arrayidx.i191 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 64
  store i16 192, ptr %arrayidx.i191, align 2, !tbaa !208
  %cumfreq.i194 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 35, i64 64, i32 1
  store i16 0, ptr %cumfreq.i194, align 2, !tbaa !210
  ...
  store i32 4, ptr %model3, align 8, !tbaa !205
  %entries.i199 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 27, i32 1
  store i32 64, ptr %entries.i199, align 4, !tbaa !206
  %syms1.i200 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 27, i32 2
  store ptr %m3sym, ptr %syms1.i200, align 8, !tbaa !207
  store <8 x i16> <i16 192, i16 64, i16 193, i16 63, i16 194, i16 62, i16 195, i16 61>, ptr %m3sym, align 2, !tbaa !48
  %50 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 4
  store <8 x i16> <i16 196, i16 60, i16 197, i16 59, i16 198, i16 58, i16 199, i16 57>, ptr %50, align 2, !tbaa !48
  %51 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 8
  store <8 x i16> <i16 200, i16 56, i16 201, i16 55, i16 202, i16 54, i16 203, i16 53>, ptr %51, align 2, !tbaa !48
  %52 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 12
  store <8 x i16> <i16 204, i16 52, i16 205, i16 51, i16 206, i16 50, i16 207, i16 49>, ptr %52, align 2, !tbaa !48
  %53 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 16
  store <8 x i16> <i16 208, i16 48, i16 209, i16 47, i16 210, i16 46, i16 211, i16 45>, ptr %53, align 2, !tbaa !48
  %54 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 20
  store <8 x i16> <i16 212, i16 44, i16 213, i16 43, i16 214, i16 42, i16 215, i16 41>, ptr %54, align 2, !tbaa !48
  %55 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 24
  store <8 x i16> <i16 216, i16 40, i16 217, i16 39, i16 218, i16 38, i16 219, i16 37>, ptr %55, align 2, !tbaa !48
  %56 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 28
  store <8 x i16> <i16 220, i16 36, i16 221, i16 35, i16 222, i16 34, i16 223, i16 33>, ptr %56, align 2, !tbaa !48
  %57 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 32
  store <8 x i16> <i16 224, i16 32, i16 225, i16 31, i16 226, i16 30, i16 227, i16 29>, ptr %57, align 2, !tbaa !48
  %58 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 36
  store <8 x i16> <i16 228, i16 28, i16 229, i16 27, i16 230, i16 26, i16 231, i16 25>, ptr %58, align 2, !tbaa !48
  %59 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 40
  store <8 x i16> <i16 232, i16 24, i16 233, i16 23, i16 234, i16 22, i16 235, i16 21>, ptr %59, align 2, !tbaa !48
  %60 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 44
  store <8 x i16> <i16 236, i16 20, i16 237, i16 19, i16 238, i16 18, i16 239, i16 17>, ptr %60, align 2, !tbaa !48
  %61 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 48
  store <8 x i16> <i16 240, i16 16, i16 241, i16 15, i16 242, i16 14, i16 243, i16 13>, ptr %61, align 2, !tbaa !48
  %62 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 52
  store <8 x i16> <i16 244, i16 12, i16 245, i16 11, i16 246, i16 10, i16 247, i16 9>, ptr %62, align 2, !tbaa !48
  %63 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 56
  store <8 x i16> <i16 248, i16 8, i16 249, i16 7, i16 250, i16 6, i16 251, i16 5>, ptr %63, align 2, !tbaa !48
  %64 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 60
  store <8 x i16> <i16 252, i16 4, i16 253, i16 3, i16 254, i16 2, i16 255, i16 1>, ptr %64, align 2, !tbaa !48
  %arrayidx.i204 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 64
  store i16 256, ptr %arrayidx.i204, align 2, !tbaa !208
  %cumfreq.i207 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 36, i64 64, i32 1
  store i16 0, ptr %cumfreq.i207, align 2, !tbaa !210
  ...
  store i32 4, ptr %model4, align 8, !tbaa !205
  %entries.i212 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 28, i32 1
  store i32 24, ptr %entries.i212, align 4, !tbaa !206
  %syms1.i213 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 28, i32 2
  store ptr %m4sym, ptr %syms1.i213, align 8, !tbaa !207
  store <8 x i16> <i16 0, i16 24, i16 1, i16 23, i16 2, i16 22, i16 3, i16 21>, ptr %m4sym, align 2, !tbaa !48
  %arrayidx.i216.4 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 37, i64 4
  store <8 x i16> <i16 4, i16 20, i16 5, i16 19, i16 6, i16 18, i16 7, i16 17>, ptr %arrayidx.i216.4, align 2, !tbaa !48
  %arrayidx.i216.8 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 37, i64 8
  store <8 x i16> <i16 8, i16 16, i16 9, i16 15, i16 10, i16 14, i16 11, i16 13>, ptr %arrayidx.i216.8, align 2, !tbaa !48
  %arrayidx.i216.12 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 37, i64 12
  store <8 x i16> <i16 12, i16 12, i16 13, i16 11, i16 14, i16 10, i16 15, i16 9>, ptr %arrayidx.i216.12, align 2, !tbaa !48
  %arrayidx.i216.16 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 37, i64 16
  store <8 x i16> <i16 16, i16 8, i16 17, i16 7, i16 18, i16 6, i16 19, i16 5>, ptr %arrayidx.i216.16, align 2, !tbaa !48
  %arrayidx.i216.20 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 37, i64 20
  store <8 x i16> <i16 20, i16 4, i16 21, i16 3, i16 22, i16 2, i16 23, i16 1>, ptr %arrayidx.i216.20, align 2, !tbaa !48
  %arrayidx.i216.24 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 37, i64 24
  store i16 24, ptr %arrayidx.i216.24, align 2, !tbaa !208
  %cumfreq.i219.24 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 37, i64 24, i32 1
  store i16 0, ptr %cumfreq.i219.24, align 2, !tbaa !210
...
vector.body324:                                   ; preds = %vector.body324, %vector.ph321
  ...
  store <8 x i16> %interleaved.vec330, ptr %68, align 2, !tbaa !48
  ...
  br i1 %69, label %for.body.i234.preheader, label %vector.body324, !llvm.loop !211
...
for.body.i234:                                    ; preds = %for.body.i234.preheader, %for.body.i234
  ...
  store i16 %conv.i227, ptr %arrayidx.i228, align 2, !tbaa !208
  ...
  store i16 %conv2.i230, ptr %cumfreq.i231, align 2, !tbaa !210
  ...
  br i1 %exitcond.not.i233, label %qtm_init_model.exit235, label %for.body.i234, !llvm.loop !212
...
vector.body340:                                   ; preds = %vector.body340, %vector.ph335
  ...
  br i1 %79, label %for.body.i249.preheader, label %vector.body340, !llvm.loop !213
...
for.body.i249:                                    ; preds = %for.body.i249.preheader, %for.body.i249
  ...
  store i16 %conv.i242, ptr %arrayidx.i243, align 2, !tbaa !208
  ...
  store i16 %conv2.i245, ptr %cumfreq.i246, align 2, !tbaa !210
  ...
  br i1 %exitcond.not.i248, label %qtm_init_model.exit250, label %for.body.i249, !llvm.loop !214
...
qtm_init_model.exit250:                           ; preds = %for.body.i249, %qtm_init_model.exit235
  ...
  store i32 4, ptr %model6len, align 8, !tbaa !205
  %entries.i251 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 31, i32 1
  store i32 27, ptr %entries.i251, align 4, !tbaa !206
  %syms1.i252 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 31, i32 2
  store ptr %m6lsym, ptr %syms1.i252, align 8, !tbaa !207
  store <8 x i16> <i16 0, i16 27, i16 1, i16 26, i16 2, i16 25, i16 3, i16 24>, ptr %m6lsym, align 2, !tbaa !48
  %arrayidx.i256.4 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 40, i64 4
  store <8 x i16> <i16 4, i16 23, i16 5, i16 22, i16 6, i16 21, i16 7, i16 20>, ptr %arrayidx.i256.4, align 2, !tbaa !48
  %arrayidx.i256.8 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 40, i64 8
  store <8 x i16> <i16 8, i16 19, i16 9, i16 18, i16 10, i16 17, i16 11, i16 16>, ptr %arrayidx.i256.8, align 2, !tbaa !48
  %arrayidx.i256.12 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 40, i64 12
  store <8 x i16> <i16 12, i16 15, i16 13, i16 14, i16 14, i16 13, i16 15, i16 12>, ptr %arrayidx.i256.12, align 2, !tbaa !48
  %arrayidx.i256.16 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 40, i64 16
  store <8 x i16> <i16 16, i16 11, i16 17, i16 10, i16 18, i16 9, i16 19, i16 8>, ptr %arrayidx.i256.16, align 2, !tbaa !48
  %arrayidx.i256.20 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 40, i64 20
  store <8 x i16> <i16 20, i16 7, i16 21, i16 6, i16 22, i16 5, i16 23, i16 4>, ptr %arrayidx.i256.20, align 2, !tbaa !48
  %arrayidx.i256.24 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 40, i64 24
  store <8 x i16> <i16 24, i16 3, i16 25, i16 2, i16 26, i16 1, i16 27, i16 0>, ptr %arrayidx.i256.24, align 2, !tbaa !48
  ...
  store i32 4, ptr %model7, align 8, !tbaa !205
  %entries.i264 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 32, i32 1
  store i32 7, ptr %entries.i264, align 4, !tbaa !206
  %syms1.i265 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 32, i32 2
  store ptr %m7sym, ptr %syms1.i265, align 8, !tbaa !207
  store <8 x i16> <i16 0, i16 7, i16 1, i16 6, i16 2, i16 5, i16 3, i16 4>, ptr %m7sym, align 2, !tbaa !48
  %arrayidx.i269.4 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 41, i64 4
  store <8 x i16> <i16 4, i16 3, i16 5, i16 2, i16 6, i16 1, i16 7, i16 0>, ptr %arrayidx.i269.4, align 2, !tbaa !48
  %file89 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 42
  store ptr %file, ptr %file89, align 8, !tbaa !215
  %read90 = getelementptr inbounds %struct.qtm_stream, ptr %call, i64 0, i32 43
  store ptr %read, ptr %read90, align 8, !tbaa !216
  br label %cleanup
...
if.then12:                                        ; preds = %if.end4
  ...
  %3 = load i8, ptr %wflag, align 8, !tbaa !192
  %tobool14.not = icmp eq i8 %3, 0
  br i1 %tobool14.not, label %if.end20, label %land.lhs.true

land.lhs.true:                                    ; preds = %if.then12
  %ofd = getelementptr inbounds %struct.qtm_stream, ptr %qtm, i64 0, i32 1
  %4 = load i32, ptr %ofd, align 4, !tbaa !191
  %call = tail call i32 @cli_writen(i32 noundef %4, ptr noundef %2, i32 noundef %i.0) #12
  %cmp16.not = icmp eq i32 %call, %i.0
  br i1 %cmp16.not, label %land.lhs.true.if.end20_crit_edge, label %if.then18

land.lhs.true.if.end20_crit_edge:                 ; preds = %land.lhs.true
  %.pre = load ptr, ptr %o_ptr, align 8, !tbaa !202
  br label %if.end20

if.then18:                                        ; preds = %land.lhs.true
  store i32 -123, ptr %error, align 4, !tbaa !198
...
if.end20:                                         ; preds = %land.lhs.true.if.end20_crit_edge, %if.then12
  ...
  %add.ptr = getelementptr inbounds i8, ptr %5, i64 %idx.ext
  store ptr %add.ptr, ptr %o_ptr, align 8, !tbaa !202
  %sub = sub nsw i64 %out_bytes, %idx.ext
  br label %if.end23
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end1752
  ...
  %21 = load i8, ptr %header_read, align 2, !tbaa !197
...
if.then58:                                        ; preds = %if.then55
  %22 = load ptr, ptr %read1.i, align 8, !tbaa !216
  %tobool.not.i = icmp eq ptr %22, null
  %23 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  %24 = load i32, ptr %inbuf_size.i, align 4, !tbaa !193
  br i1 %tobool.not.i, label %cond.false.i, label %cond.true.i

cond.true.i:                                      ; preds = %if.then58
  %25 = load ptr, ptr %file.i, align 8, !tbaa !215
  %call.i = tail call i32 %22(ptr noundef %25, ptr noundef %23, i32 noundef %24) #12
  br label %cond.end.i

cond.false.i:                                     ; preds = %if.then58
  %26 = load i32, ptr %qtm, align 8, !tbaa !190
  %call6.i = tail call i32 @cli_readn(i32 noundef %26, ptr noundef %23, i32 noundef %24) #12
  br label %cond.end.i
...
if.end63:                                         ; preds = %cond.end.i
  %27 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  store ptr %27, ptr %i_ptr28, align 8, !tbaa !200
  %idxprom.i = zext i32 %cond.i to i64
  %arrayidx10.i = getelementptr inbounds i8, ptr %27, i64 %idxprom.i
  store ptr %arrayidx10.i, ptr %i_end29, align 8, !tbaa !199
  br label %if.end66
...
if.end66:                                         ; preds = %if.end63, %if.then55
  ...
  %.pre3363 = zext i8 %add to i32
  br label %do.end79

do.end79:                                         ; preds = %if.end66, %do.body51
  %conv80.pre-phi = phi i32 [ %.pre3363, %if.end66 ], [ %conv52, %do.body51 ]
  ...
  br i1 %cmp49.not, label %do.end106, label %do.body51, !llvm.loop !220

do.end106:                                        ; preds = %do.end79
  %conv94.le = trunc i32 %or93 to i16
  store i8 1, ptr %header_read, align 2, !tbaa !197
  %.pre3359 = load ptr, ptr %o_end, align 8, !tbaa !201
  %.pre3360 = load ptr, ptr %o_ptr, align 8, !tbaa !202
  br label %if.end108

if.end108:                                        ; preds = %do.end106, %while.body
  %31 = phi ptr [ %19, %while.body ], [ %.pre3360, %do.end106 ]
  %32 = phi ptr [ %20, %while.body ], [ %.pre3359, %do.end106 ]
  ...
  %C.2 = phi i16 [ %C.03246, %while.body ], [ %conv94.le, %do.end106 ]
...
for.body146:                                      ; preds = %for.body146.lr.ph, %for.inc157
  ...
  %38 = load i16, ptr %cumfreq150, align 2, !tbaa !210
...
for.inc157:                                       ; preds = %for.body146
  ...
  br i1 %exitcond.not, label %for.end158, label %for.body146, !llvm.loop !223
...
for.end158:                                       ; preds = %for.inc157, %for.end158.loopexit.split.loop.exit, %do.body128
  ...
  %43 = load i16, ptr %cumfreq193, align 2, !tbaa !210
...
do.body200:                                       ; preds = %do.body200, %for.end158
  %indvars.iv3316 = phi i64 [ %indvars.iv.next3317, %do.body200 ], [ %45, %for.end158 ]
  %indvars.iv.next3317 = add nsw i64 %indvars.iv3316, -1
  %cumfreq205 = getelementptr inbounds %struct.qtm_modelsym, ptr %34, i64 %indvars.iv.next3317, i32 1
  %46 = load i16, ptr %cumfreq205, align 2, !tbaa !210
  %add207 = add i16 %46, 8
  store i16 %add207, ptr %cumfreq205, align 2, !tbaa !210
  %cmp210 = icmp sgt i64 %indvars.iv3316, 1
  br i1 %cmp210, label %do.body200, label %do.end212, !llvm.loop !224

do.end212:                                        ; preds = %do.body200
  %47 = trunc i32 %div184 to i16
  %conv187 = add i16 %42, %47
  %conv199 = add i16 %L.23217, %44
  %48 = load i16, ptr %cumfreq, align 2, !tbaa !210
...
if.then231:                                       ; preds = %while.cond223
  ...
  %or.cond2473 = select i1 %tobool234.not, i1 %tobool238.not, i1 false
...
if.then264:                                       ; preds = %if.then261
  %51 = load ptr, ptr %read1.i, align 8, !tbaa !216
  %tobool.not.i2480 = icmp eq ptr %51, null
  %52 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  %53 = load i32, ptr %inbuf_size.i, align 4, !tbaa !193
  br i1 %tobool.not.i2480, label %cond.false.i2489, label %cond.true.i2485

cond.true.i2485:                                  ; preds = %if.then264
  %54 = load ptr, ptr %file.i, align 8, !tbaa !215
  %call.i2484 = tail call i32 %51(ptr noundef %54, ptr noundef %52, i32 noundef %53) #12
  br label %cond.end.i2492

cond.false.i2489:                                 ; preds = %if.then264
  %55 = load i32, ptr %qtm, align 8, !tbaa !190
  %call6.i2488 = tail call i32 @cli_readn(i32 noundef %55, ptr noundef %52, i32 noundef %53) #12
  br label %cond.end.i2492
...
if.end269:                                        ; preds = %cond.end.i2492
  %56 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  store ptr %56, ptr %i_ptr28, align 8, !tbaa !200
  %idxprom.i2497 = zext i32 %cond.i2490 to i64
  %arrayidx10.i2498 = getelementptr inbounds i8, ptr %56, i64 %idxprom.i2497
  store ptr %arrayidx10.i2498, ptr %i_end29, align 8, !tbaa !199
  br label %if.end272
...
for.body346.lr.ph:                                ; preds = %cond.end321
  ...
  %wide.trip.count3354 = zext i32 %61 to i64
  br label %for.body346

for.body346:                                      ; preds = %for.body346.lr.ph, %for.inc357
  %indvars.iv3351 = phi i64 [ 1, %for.body346.lr.ph ], [ %indvars.iv.next3352, %for.inc357 ]
  %cumfreq350 = getelementptr inbounds %struct.qtm_modelsym, ptr %59, i64 %indvars.iv3351, i32 1
  %63 = load i16, ptr %cumfreq350, align 2, !tbaa !210
...
for.inc357:                                       ; preds = %for.body346
  ...
  %exitcond3355.not = icmp eq i64 %indvars.iv.next3352, %wide.trip.count3354
  br i1 %exitcond3355.not, label %for.end359, label %for.body346, !llvm.loop !225

for.end359.loopexit.split.loop.exit:              ; preds = %for.body346
  %64 = trunc i64 %indvars.iv3351 to i32
  br label %for.end359
...
for.end359:                                       ; preds = %for.inc357, %for.end359.loopexit.split.loop.exit, %cond.end321
  ...
  %68 = load i16, ptr %cumfreq390, align 2, !tbaa !210
...
do.body397:                                       ; preds = %do.body397, %for.end359
  %indvars.iv3356 = phi i64 [ %indvars.iv.next3357, %do.body397 ], [ %70, %for.end359 ]
  %indvars.iv.next3357 = add nsw i64 %indvars.iv3356, -1
  %cumfreq402 = getelementptr inbounds %struct.qtm_modelsym, ptr %59, i64 %indvars.iv.next3357, i32 1
  %71 = load i16, ptr %cumfreq402, align 2, !tbaa !210
  %add404 = add i16 %71, 8
  store i16 %add404, ptr %cumfreq402, align 2, !tbaa !210
  %cmp407 = icmp sgt i64 %indvars.iv3356, 1
  br i1 %cmp407, label %do.body397, label %do.end409, !llvm.loop !226

do.end409:                                        ; preds = %do.body397
  %72 = trunc i32 %div382 to i16
  %conv385 = add i16 %67, %72
  %conv396 = add i16 %L.3, %69
  %73 = load i16, ptr %cumfreq335, align 2, !tbaa !210
...
if.then426:                                       ; preds = %while.cond418
  ...
  %or.cond2474 = select i1 %tobool429.not, i1 %tobool433.not, i1 false
...
if.then461:                                       ; preds = %if.then458
  %76 = load ptr, ptr %read1.i, align 8, !tbaa !216
  %tobool.not.i2504 = icmp eq ptr %76, null
  %77 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  %78 = load i32, ptr %inbuf_size.i, align 4, !tbaa !193
  br i1 %tobool.not.i2504, label %cond.false.i2513, label %cond.true.i2509

cond.true.i2509:                                  ; preds = %if.then461
  %79 = load ptr, ptr %file.i, align 8, !tbaa !215
  %call.i2508 = tail call i32 %76(ptr noundef %79, ptr noundef %77, i32 noundef %78) #12
  br label %cond.end.i2516

cond.false.i2513:                                 ; preds = %if.then461
  %80 = load i32, ptr %qtm, align 8, !tbaa !190
  %call6.i2512 = tail call i32 @cli_readn(i32 noundef %80, ptr noundef %77, i32 noundef %78) #12
  br label %cond.end.i2516
...
if.end466:                                        ; preds = %cond.end.i2516
  %81 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  store ptr %81, ptr %i_ptr28, align 8, !tbaa !200
  %idxprom.i2521 = zext i32 %cond.i2514 to i64
  %arrayidx10.i2522 = getelementptr inbounds i8, ptr %81, i64 %idxprom.i2521
  store ptr %arrayidx10.i2522, ptr %i_end29, align 8, !tbaa !199
  br label %if.end469
...
for.body529.lr.ph:                                ; preds = %do.body505
  ...
  %wide.trip.count3346 = zext i32 %86 to i64
  br label %for.body529

for.body529:                                      ; preds = %for.body529.lr.ph, %for.inc541
  %indvars.iv3343 = phi i64 [ 1, %for.body529.lr.ph ], [ %indvars.iv.next3344, %for.inc541 ]
  %cumfreq534 = getelementptr inbounds %struct.qtm_modelsym, ptr %84, i64 %indvars.iv3343, i32 1
  %88 = load i16, ptr %cumfreq534, align 2, !tbaa !210
...
for.inc541:                                       ; preds = %for.body529
  ...
  %exitcond3347.not = icmp eq i64 %indvars.iv.next3344, %wide.trip.count3346
  br i1 %exitcond3347.not, label %for.end543, label %for.body529, !llvm.loop !229

for.end543.loopexit.split.loop.exit:              ; preds = %for.body529
  %89 = trunc i64 %indvars.iv3343 to i32
  br label %for.end543
...
for.end543:                                       ; preds = %for.inc541, %for.end543.loopexit.split.loop.exit, %do.body505
  ...
  %93 = load i16, ptr %cumfreq578, align 2, !tbaa !210
...
do.body585:                                       ; preds = %do.body585, %for.end543
  %indvars.iv3348 = phi i64 [ %indvars.iv.next3349, %do.body585 ], [ %95, %for.end543 ]
  %indvars.iv.next3349 = add nsw i64 %indvars.iv3348, -1
  %cumfreq591 = getelementptr inbounds %struct.qtm_modelsym, ptr %84, i64 %indvars.iv.next3349, i32 1
  %96 = load i16, ptr %cumfreq591, align 2, !tbaa !210
  %add593 = add i16 %96, 8
  store i16 %add593, ptr %cumfreq591, align 2, !tbaa !210
  %cmp596 = icmp sgt i64 %indvars.iv3348, 1
  br i1 %cmp596, label %do.body585, label %do.end598, !llvm.loop !230

do.end598:                                        ; preds = %do.body585
  %97 = trunc i32 %div569 to i16
  %conv572 = add i16 %92, %97
  %conv584 = add i16 %L.3, %94
  %98 = load i16, ptr %cumfreq517, align 2, !tbaa !210
...
if.then617:                                       ; preds = %while.cond609
  ...
  %or.cond2475 = select i1 %tobool620.not, i1 %tobool624.not, i1 false
...
if.then652:                                       ; preds = %if.then649
  %101 = load ptr, ptr %read1.i, align 8, !tbaa !216
  %tobool.not.i2528 = icmp eq ptr %101, null
  %102 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  %103 = load i32, ptr %inbuf_size.i, align 4, !tbaa !193
  br i1 %tobool.not.i2528, label %cond.false.i2537, label %cond.true.i2533

cond.true.i2533:                                  ; preds = %if.then652
  %104 = load ptr, ptr %file.i, align 8, !tbaa !215
  %call.i2532 = tail call i32 %101(ptr noundef %104, ptr noundef %102, i32 noundef %103) #12
  br label %cond.end.i2540

cond.false.i2537:                                 ; preds = %if.then652
  %105 = load i32, ptr %qtm, align 8, !tbaa !190
  %call6.i2536 = tail call i32 @cli_readn(i32 noundef %105, ptr noundef %102, i32 noundef %103) #12
  br label %cond.end.i2540
...
if.end657:                                        ; preds = %cond.end.i2540
  %106 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  store ptr %106, ptr %i_ptr28, align 8, !tbaa !200
  %idxprom.i2545 = zext i32 %cond.i2538 to i64
  %arrayidx10.i2546 = getelementptr inbounds i8, ptr %106, i64 %idxprom.i2545
  store ptr %arrayidx10.i2546, ptr %i_end29, align 8, !tbaa !199
  br label %if.end660
...
if.then706:                                       ; preds = %if.then703
  %110 = load ptr, ptr %read1.i, align 8, !tbaa !216
  %tobool.not.i2552 = icmp eq ptr %110, null
  %111 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  %112 = load i32, ptr %inbuf_size.i, align 4, !tbaa !193
  br i1 %tobool.not.i2552, label %cond.false.i2561, label %cond.true.i2557

cond.true.i2557:                                  ; preds = %if.then706
  %113 = load ptr, ptr %file.i, align 8, !tbaa !215
  %call.i2556 = tail call i32 %110(ptr noundef %113, ptr noundef %111, i32 noundef %112) #12
  br label %cond.end.i2564

cond.false.i2561:                                 ; preds = %if.then706
  %114 = load i32, ptr %qtm, align 8, !tbaa !190
  %call6.i2560 = tail call i32 @cli_readn(i32 noundef %114, ptr noundef %111, i32 noundef %112) #12
  br label %cond.end.i2564
...
if.end711:                                        ; preds = %cond.end.i2564
  %115 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  store ptr %115, ptr %i_ptr28, align 8, !tbaa !200
  %idxprom.i2569 = zext i32 %cond.i2562 to i64
  %arrayidx10.i2570 = getelementptr inbounds i8, ptr %115, i64 %idxprom.i2569
  store ptr %arrayidx10.i2570, ptr %i_end29, align 8, !tbaa !199
  br label %if.end714
...
for.body794.lr.ph:                                ; preds = %do.body770
  ...
  %wide.trip.count3338 = zext i32 %121 to i64
  br label %for.body794

for.body794:                                      ; preds = %for.body794.lr.ph, %for.inc806
  %indvars.iv3335 = phi i64 [ 1, %for.body794.lr.ph ], [ %indvars.iv.next3336, %for.inc806 ]
  %cumfreq799 = getelementptr inbounds %struct.qtm_modelsym, ptr %119, i64 %indvars.iv3335, i32 1
  %123 = load i16, ptr %cumfreq799, align 2, !tbaa !210
...
for.inc806:                                       ; preds = %for.body794
  ...
  %exitcond3339.not = icmp eq i64 %indvars.iv.next3336, %wide.trip.count3338
  br i1 %exitcond3339.not, label %for.end808, label %for.body794, !llvm.loop !234

for.end808.loopexit.split.loop.exit:              ; preds = %for.body794
  %124 = trunc i64 %indvars.iv3335 to i32
  br label %for.end808
...
for.end808:                                       ; preds = %for.inc806, %for.end808.loopexit.split.loop.exit, %do.body770
  ...
  %128 = load i16, ptr %cumfreq843, align 2, !tbaa !210
...
do.body850:                                       ; preds = %do.body850, %for.end808
  %indvars.iv3340 = phi i64 [ %indvars.iv.next3341, %do.body850 ], [ %130, %for.end808 ]
  %indvars.iv.next3341 = add nsw i64 %indvars.iv3340, -1
  %cumfreq856 = getelementptr inbounds %struct.qtm_modelsym, ptr %119, i64 %indvars.iv.next3341, i32 1
  %131 = load i16, ptr %cumfreq856, align 2, !tbaa !210
  %add858 = add i16 %131, 8
  store i16 %add858, ptr %cumfreq856, align 2, !tbaa !210
  %cmp861 = icmp sgt i64 %indvars.iv3340, 1
  br i1 %cmp861, label %do.body850, label %do.end863, !llvm.loop !235

do.end863:                                        ; preds = %do.body850
  %132 = trunc i32 %div834 to i16
  %conv837 = add i16 %127, %132
  %conv849 = add i16 %L.3, %129
  %133 = load i16, ptr %cumfreq782, align 2, !tbaa !210
...
if.then882:                                       ; preds = %while.cond874
  ...
  %or.cond2476 = select i1 %tobool885.not, i1 %tobool889.not, i1 false
...
if.then917:                                       ; preds = %if.then914
  %136 = load ptr, ptr %read1.i, align 8, !tbaa !216
  %tobool.not.i2576 = icmp eq ptr %136, null
  %137 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  %138 = load i32, ptr %inbuf_size.i, align 4, !tbaa !193
  br i1 %tobool.not.i2576, label %cond.false.i2585, label %cond.true.i2581

cond.true.i2581:                                  ; preds = %if.then917
  %139 = load ptr, ptr %file.i, align 8, !tbaa !215
  %call.i2580 = tail call i32 %136(ptr noundef %139, ptr noundef %137, i32 noundef %138) #12
  br label %cond.end.i2588

cond.false.i2585:                                 ; preds = %if.then917
  %140 = load i32, ptr %qtm, align 8, !tbaa !190
  %call6.i2584 = tail call i32 @cli_readn(i32 noundef %140, ptr noundef %137, i32 noundef %138) #12
  br label %cond.end.i2588
...
if.end922:                                        ; preds = %cond.end.i2588
  %141 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  store ptr %141, ptr %i_ptr28, align 8, !tbaa !200
  %idxprom.i2593 = zext i32 %cond.i2586 to i64
  %arrayidx10.i2594 = getelementptr inbounds i8, ptr %141, i64 %idxprom.i2593
  store ptr %arrayidx10.i2594, ptr %i_end29, align 8, !tbaa !199
  br label %if.end925
...
if.then972:                                       ; preds = %if.then969
  %145 = load ptr, ptr %read1.i, align 8, !tbaa !216
  %tobool.not.i2600 = icmp eq ptr %145, null
  %146 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  %147 = load i32, ptr %inbuf_size.i, align 4, !tbaa !193
  br i1 %tobool.not.i2600, label %cond.false.i2609, label %cond.true.i2605

cond.true.i2605:                                  ; preds = %if.then972
  %148 = load ptr, ptr %file.i, align 8, !tbaa !215
  %call.i2604 = tail call i32 %145(ptr noundef %148, ptr noundef %146, i32 noundef %147) #12
  br label %cond.end.i2612

cond.false.i2609:                                 ; preds = %if.then972
  %149 = load i32, ptr %qtm, align 8, !tbaa !190
  %call6.i2608 = tail call i32 @cli_readn(i32 noundef %149, ptr noundef %146, i32 noundef %147) #12
  br label %cond.end.i2612
...
if.end977:                                        ; preds = %cond.end.i2612
  %150 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  store ptr %150, ptr %i_ptr28, align 8, !tbaa !200
  %idxprom.i2617 = zext i32 %cond.i2610 to i64
  %arrayidx10.i2618 = getelementptr inbounds i8, ptr %150, i64 %idxprom.i2617
  store ptr %arrayidx10.i2618, ptr %i_end29, align 8, !tbaa !199
  br label %if.end980
...
do.end998:                                        ; preds = %if.end980, %do.body965
  ...
  br i1 %cmp962.not, label %sw.epilog, label %do.body965, !llvm.loop !236

do.body1037:                                      ; preds = %if.else504
  %sub1040 = sub nsw i32 %conv227, %conv225
  %154 = load ptr, ptr %syms1047, align 8, !tbaa !237
  %cumfreq1049 = getelementptr inbounds %struct.qtm_modelsym, ptr %154, i64 0, i32 1
  %155 = load i16, ptr %cumfreq1049, align 2, !tbaa !210
  %conv1050 = zext i16 %155 to i32
  %156 = load i32, ptr %entries1058, align 4, !tbaa !238
...
for.body1061.lr.ph:                               ; preds = %do.body1037
  %sub1045 = sub nsw i32 1, %conv225
  %conv1043 = zext i16 %C.4 to i32
  %add1046 = add nsw i32 %sub1045, %conv1043
  ...
  %wide.trip.count3322 = zext i32 %156 to i64
  br label %for.body1061

for.body1061:                                     ; preds = %for.body1061.lr.ph, %for.inc1073
  %indvars.iv3319 = phi i64 [ 1, %for.body1061.lr.ph ], [ %indvars.iv.next3320, %for.inc1073 ]
  %cumfreq1066 = getelementptr inbounds %struct.qtm_modelsym, ptr %154, i64 %indvars.iv3319, i32 1
  %158 = load i16, ptr %cumfreq1066, align 2, !tbaa !210
...
for.inc1073:                                      ; preds = %for.body1061
  ...
  br i1 %exitcond3323.not, label %for.end1075, label %for.body1061, !llvm.loop !239

for.end1075.loopexit.split.loop.exit:             ; preds = %for.body1061
  %159 = trunc i64 %indvars.iv3319 to i32
...
for.end1075:                                      ; preds = %for.inc1073, %for.end1075.loopexit.split.loop.exit, %do.body1037
  ...
  %163 = load i16, ptr %cumfreq1110, align 2, !tbaa !210
...
do.body1117:                                      ; preds = %do.body1117, %for.end1075
  %indvars.iv3324 = phi i64 [ %indvars.iv.next3325, %do.body1117 ], [ %165, %for.end1075 ]
  %indvars.iv.next3325 = add nsw i64 %indvars.iv3324, -1
  %cumfreq1123 = getelementptr inbounds %struct.qtm_modelsym, ptr %154, i64 %indvars.iv.next3325, i32 1
  %166 = load i16, ptr %cumfreq1123, align 2, !tbaa !210
  %add1125 = add i16 %166, 8
  store i16 %add1125, ptr %cumfreq1123, align 2, !tbaa !210
  %cmp1128 = icmp sgt i64 %indvars.iv3324, 1
  br i1 %cmp1128, label %do.body1117, label %do.end1130, !llvm.loop !240

do.end1130:                                       ; preds = %do.body1117
  %167 = trunc i32 %div1101 to i16
  %conv1104 = add i16 %162, %167
  %conv1116 = add i16 %L.3, %164
  %168 = load i16, ptr %cumfreq1049, align 2, !tbaa !210
...
if.then1149:                                      ; preds = %while.cond1141
  ...
  %or.cond2477 = select i1 %tobool1152.not, i1 %tobool1156.not, i1 false
...
if.then1184:                                      ; preds = %if.then1181
  %171 = load ptr, ptr %read1.i, align 8, !tbaa !216
  %tobool.not.i2624 = icmp eq ptr %171, null
  %172 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  %173 = load i32, ptr %inbuf_size.i, align 4, !tbaa !193
  br i1 %tobool.not.i2624, label %cond.false.i2633, label %cond.true.i2629

cond.true.i2629:                                  ; preds = %if.then1184
  %174 = load ptr, ptr %file.i, align 8, !tbaa !215
  %call.i2628 = tail call i32 %171(ptr noundef %174, ptr noundef %172, i32 noundef %173) #12
  br label %cond.end.i2636

cond.false.i2633:                                 ; preds = %if.then1184
  %175 = load i32, ptr %qtm, align 8, !tbaa !190
  %call6.i2632 = tail call i32 @cli_readn(i32 noundef %175, ptr noundef %172, i32 noundef %173) #12
  br label %cond.end.i2636
...
if.end1189:                                       ; preds = %cond.end.i2636
  %176 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  store ptr %176, ptr %i_ptr28, align 8, !tbaa !200
  %idxprom.i2641 = zext i32 %cond.i2634 to i64
  %arrayidx10.i2642 = getelementptr inbounds i8, ptr %176, i64 %idxprom.i2641
  store ptr %arrayidx10.i2642, ptr %i_end29, align 8, !tbaa !199
  br label %if.end1192
...
if.then1238:                                      ; preds = %if.then1235
  %180 = load ptr, ptr %read1.i, align 8, !tbaa !216
  %tobool.not.i2648 = icmp eq ptr %180, null
  %181 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  %182 = load i32, ptr %inbuf_size.i, align 4, !tbaa !193
  br i1 %tobool.not.i2648, label %cond.false.i2657, label %cond.true.i2653

cond.true.i2653:                                  ; preds = %if.then1238
  %183 = load ptr, ptr %file.i, align 8, !tbaa !215
  %call.i2652 = tail call i32 %180(ptr noundef %183, ptr noundef %181, i32 noundef %182) #12
  br label %cond.end.i2660

cond.false.i2657:                                 ; preds = %if.then1238
  %184 = load i32, ptr %qtm, align 8, !tbaa !190
  %call6.i2656 = tail call i32 @cli_readn(i32 noundef %184, ptr noundef %181, i32 noundef %182) #12
  br label %cond.end.i2660
...
if.end1243:                                       ; preds = %cond.end.i2660
  %185 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  store ptr %185, ptr %i_ptr28, align 8, !tbaa !200
  %idxprom.i2665 = zext i32 %cond.i2658 to i64
  %arrayidx10.i2666 = getelementptr inbounds i8, ptr %185, i64 %idxprom.i2665
  store ptr %arrayidx10.i2666, ptr %i_end29, align 8, !tbaa !199
  br label %if.end1246
...
do.end1264:                                       ; preds = %if.end1246, %do.body1231
  ...
  br i1 %cmp1228.not, label %do.end1296, label %do.body1231, !llvm.loop !241
...
do.end1296:                                       ; preds = %do.end1264, %do.body1223
  ...
  %190 = load ptr, ptr %syms1312, align 8, !tbaa !242
  %cumfreq1314 = getelementptr inbounds %struct.qtm_modelsym, ptr %190, i64 0, i32 1
  %191 = load i16, ptr %cumfreq1314, align 2, !tbaa !210
  %conv1315 = zext i16 %191 to i32
  %192 = load i32, ptr %entries1323, align 4, !tbaa !243
...
for.body1326.lr.ph:                               ; preds = %do.end1296
  %sub1310 = sub nsw i32 1, %conv1143
  %conv1308 = zext i16 %C.13 to i32
  %add1311 = add nsw i32 %sub1310, %conv1308
  ...
  %wide.trip.count3330 = zext i32 %192 to i64
  br label %for.body1326

for.body1326:                                     ; preds = %for.body1326.lr.ph, %for.inc1338
  %indvars.iv3327 = phi i64 [ 1, %for.body1326.lr.ph ], [ %indvars.iv.next3328, %for.inc1338 ]
  %cumfreq1331 = getelementptr inbounds %struct.qtm_modelsym, ptr %190, i64 %indvars.iv3327, i32 1
  %194 = load i16, ptr %cumfreq1331, align 2, !tbaa !210
...
for.inc1338:                                      ; preds = %for.body1326
  ...
  %exitcond3331.not = icmp eq i64 %indvars.iv.next3328, %wide.trip.count3330
  br i1 %exitcond3331.not, label %for.end1340, label %for.body1326, !llvm.loop !244

for.end1340.loopexit.split.loop.exit:             ; preds = %for.body1326
  %195 = trunc i64 %indvars.iv3327 to i32
...
for.end1340:                                      ; preds = %for.inc1338, %for.end1340.loopexit.split.loop.exit, %do.end1296
  ...
  %199 = load i16, ptr %cumfreq1375, align 2, !tbaa !210
...
do.body1382:                                      ; preds = %do.body1382, %for.end1340
  %indvars.iv3332 = phi i64 [ %indvars.iv.next3333, %do.body1382 ], [ %201, %for.end1340 ]
  %indvars.iv.next3333 = add nsw i64 %indvars.iv3332, -1
  %cumfreq1388 = getelementptr inbounds %struct.qtm_modelsym, ptr %190, i64 %indvars.iv.next3333, i32 1
  %202 = load i16, ptr %cumfreq1388, align 2, !tbaa !210
  %add1390 = add i16 %202, 8
  store i16 %add1390, ptr %cumfreq1388, align 2, !tbaa !210
  %cmp1393 = icmp sgt i64 %indvars.iv3332, 1
  br i1 %cmp1393, label %do.body1382, label %do.end1395, !llvm.loop !245

do.end1395:                                       ; preds = %do.body1382
  %203 = trunc i32 %div1366 to i16
  %conv1369 = add i16 %198, %203
  %conv1381 = add i16 %L.12, %200
  %204 = load i16, ptr %cumfreq1314, align 2, !tbaa !210
...
if.then1414:                                      ; preds = %while.cond1406
  ...
  %or.cond2478 = select i1 %tobool1417.not, i1 %tobool1421.not, i1 false
...
if.then1449:                                      ; preds = %if.then1446
  %207 = load ptr, ptr %read1.i, align 8, !tbaa !216
  %tobool.not.i2672 = icmp eq ptr %207, null
  %208 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  %209 = load i32, ptr %inbuf_size.i, align 4, !tbaa !193
  br i1 %tobool.not.i2672, label %cond.false.i2681, label %cond.true.i2677

cond.true.i2677:                                  ; preds = %if.then1449
  %210 = load ptr, ptr %file.i, align 8, !tbaa !215
  %call.i2676 = tail call i32 %207(ptr noundef %210, ptr noundef %208, i32 noundef %209) #12
  br label %cond.end.i2684

cond.false.i2681:                                 ; preds = %if.then1449
  %211 = load i32, ptr %qtm, align 8, !tbaa !190
  %call6.i2680 = tail call i32 @cli_readn(i32 noundef %211, ptr noundef %208, i32 noundef %209) #12
  br label %cond.end.i2684
...
if.end1454:                                       ; preds = %cond.end.i2684
  %212 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  store ptr %212, ptr %i_ptr28, align 8, !tbaa !200
  %idxprom.i2689 = zext i32 %cond.i2682 to i64
  %arrayidx10.i2690 = getelementptr inbounds i8, ptr %212, i64 %idxprom.i2689
  store ptr %arrayidx10.i2690, ptr %i_end29, align 8, !tbaa !199
  br label %if.end1457
...
if.then1504:                                      ; preds = %if.then1501
  %216 = load ptr, ptr %read1.i, align 8, !tbaa !216
  %tobool.not.i2696 = icmp eq ptr %216, null
  %217 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  %218 = load i32, ptr %inbuf_size.i, align 4, !tbaa !193
  br i1 %tobool.not.i2696, label %cond.false.i2705, label %cond.true.i2701

cond.true.i2701:                                  ; preds = %if.then1504
  %219 = load ptr, ptr %file.i, align 8, !tbaa !215
  %call.i2700 = tail call i32 %216(ptr noundef %219, ptr noundef %217, i32 noundef %218) #12
  br label %cond.end.i2708

cond.false.i2705:                                 ; preds = %if.then1504
  %220 = load i32, ptr %qtm, align 8, !tbaa !190
  %call6.i2704 = tail call i32 @cli_readn(i32 noundef %220, ptr noundef %217, i32 noundef %218) #12
  br label %cond.end.i2708
...
if.end1509:                                       ; preds = %cond.end.i2708
  %221 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  store ptr %221, ptr %i_ptr28, align 8, !tbaa !200
  %idxprom.i2713 = zext i32 %cond.i2706 to i64
  %arrayidx10.i2714 = getelementptr inbounds i8, ptr %221, i64 %idxprom.i2713
  store ptr %arrayidx10.i2714, ptr %i_end29, align 8, !tbaa !199
  br label %if.end1512
...
do.end1530:                                       ; preds = %if.end1512, %do.body1497
  ...
  br i1 %cmp1494.not, label %sw.epilog, label %do.body1497, !llvm.loop !246

sw.default:                                       ; preds = %if.else504
  store i32 -124, ptr %error, align 4, !tbaa !198
  br label %cleanup1785
...
if.then1573:                                      ; preds = %sw.epilog
  ...
  %226 = load i32, ptr %window_size, align 8, !tbaa !194
...
while.body1592.preheader:                         ; preds = %if.then1586
  ...
  %min.iters.check3525 = icmp ult i32 %228, 31
  br i1 %min.iters.check3525, label %while.body1592.preheader3601, label %vector.memcheck3522

vector.memcheck3522:                              ; preds = %while.body1592.preheader
  %231 = add i64 %12, %idxprom1569
  %232 = add i64 %12, %idxprom1582
  %233 = sub i64 %231, %232
  %diff.check3523 = icmp ult i64 %233, 32
  br i1 %diff.check3523, label %while.body1592.preheader3601, label %vector.ph3526

vector.ph3526:                                    ; preds = %vector.memcheck3522
  %n.vec3528 = and i64 %230, -32
  %.cast3529 = trunc i64 %n.vec3528 to i32
  %ind.end3530 = sub i32 %sub1574, %.cast3529
  %ind.end3532 = getelementptr i8, ptr %arrayidx1570, i64 %n.vec3528
  %ind.end3534 = getelementptr i8, ptr %arrayidx1583, i64 %n.vec3528
  br label %vector.body3537

vector.body3537:                                  ; preds = %vector.body3537, %vector.ph3526
  %index3538 = phi i64 [ 0, %vector.ph3526 ], [ %index.next3545, %vector.body3537 ]
  %next.gep3539 = getelementptr i8, ptr %arrayidx1570, i64 %index3538
  %next.gep3541 = getelementptr i8, ptr %arrayidx1583, i64 %index3538
  %wide.load3543 = load <16 x i8>, ptr %next.gep3541, align 1, !tbaa !28
  %234 = getelementptr i8, ptr %next.gep3541, i64 16
  %wide.load3544 = load <16 x i8>, ptr %234, align 1, !tbaa !28
  store <16 x i8> %wide.load3543, ptr %next.gep3539, align 1, !tbaa !28
  %235 = getelementptr i8, ptr %next.gep3539, i64 16
  store <16 x i8> %wide.load3544, ptr %235, align 1, !tbaa !28
  %index.next3545 = add nuw i64 %index3538, 32
  %236 = icmp eq i64 %index.next3545, %n.vec3528
  br i1 %236, label %middle.block3524, label %vector.body3537, !llvm.loop !247

middle.block3524:                                 ; preds = %vector.body3537
  %cmp.n3536 = icmp eq i64 %230, %n.vec3528
  br i1 %cmp.n3536, label %if.end1595, label %while.body1592.preheader3601

while.body1592.preheader3601:                     ; preds = %vector.memcheck3522, %while.body1592.preheader, %middle.block3524
  %j.03202.ph = phi i32 [ %sub1574, %vector.memcheck3522 ], [ %sub1574, %while.body1592.preheader ], [ %ind.end3530, %middle.block3524 ]
  %rundest.03201.ph = phi ptr [ %arrayidx1570, %vector.memcheck3522 ], [ %arrayidx1570, %while.body1592.preheader ], [ %ind.end3532, %middle.block3524 ]
  %runsrc.03200.ph = phi ptr [ %arrayidx1583, %vector.memcheck3522 ], [ %arrayidx1583, %while.body1592.preheader ], [ %ind.end3534, %middle.block3524 ]
  br label %while.body1592

while.body1592:                                   ; preds = %while.body1592.preheader3601, %while.body1592
  %j.03202 = phi i32 [ %dec1589, %while.body1592 ], [ %j.03202.ph, %while.body1592.preheader3601 ]
  %rundest.03201 = phi ptr [ %incdec.ptr1593, %while.body1592 ], [ %rundest.03201.ph, %while.body1592.preheader3601 ]
  %runsrc.03200 = phi ptr [ %incdec.ptr, %while.body1592 ], [ %runsrc.03200.ph, %while.body1592.preheader3601 ]
  ...
  br i1 %cmp1590, label %while.body1592, label %if.end1595, !llvm.loop !248

if.end1595:                                       ; preds = %while.body1592, %middle.block3524, %if.then1586, %if.end1579
  %runsrc.1 = phi ptr [ %arrayidx1583, %if.end1579 ], [ %11, %if.then1586 ], [ %11, %middle.block3524 ], [ %11, %while.body1592 ]
  %rundest.1 = phi ptr [ %arrayidx1570, %if.end1579 ], [ %arrayidx1570, %if.then1586 ], [ %ind.end3532, %middle.block3524 ], [ %incdec.ptr1593, %while.body1592 ]
  %i.13 = phi i32 [ %match_length.0, %if.end1579 ], [ %sub1587, %if.then1586 ], [ %sub1587, %middle.block3524 ], [ %sub1587, %while.body1592 ]
  %cmp15983204 = icmp sgt i32 %i.13, 0
  br i1 %cmp15983204, label %iter.check, label %if.end1617

iter.check:                                       ; preds = %if.end1595
  %runsrc.13496 = ptrtoint ptr %runsrc.1 to i64
  %rundest.13495 = ptrtoint ptr %rundest.1 to i64
  %238 = zext i32 %i.13 to i64
  %min.iters.check = icmp ult i32 %i.13, 8
  %239 = sub i64 %rundest.13495, %runsrc.13496
  %diff.check = icmp ult i64 %239, 32
  %or.cond3599 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond3599, label %while.body1600.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check3497 = icmp ult i32 %i.13, 32
  br i1 %min.iters.check3497, label %vec.epilog.ph, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep3499 = getelementptr i8, ptr %runsrc.1, i64 %index
  %wide.load = load <16 x i8>, ptr %next.gep3499, align 1, !tbaa !28
  %240 = getelementptr i8, ptr %next.gep3499, i64 16
  %wide.load3501 = load <16 x i8>, ptr %240, align 1, !tbaa !28
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !28
  %241 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load3501, ptr %241, align 1, !tbaa !28
  %index.next = add nuw i64 %index, 32
  %242 = icmp eq i64 %index.next, %n.vec
  br i1 %242, label %middle.block, label %vector.body, !llvm.loop !249
...
vec.epilog.iter.check:                            ; preds = %middle.block
  %ind.end3514 = getelementptr i8, ptr %runsrc.1, i64 %n.vec
  %ind.end3511 = getelementptr i8, ptr %rundest.1, i64 %n.vec
  %.cast3507 = trunc i64 %n.vec to i32
  %ind.end3508 = sub i32 %i.13, %.cast3507
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec3505 = and i64 %238, 4294967288
  %.cast = trunc i64 %n.vec3505 to i32
  %ind.end3506 = sub i32 %i.13, %.cast
  %ind.end3510 = getelementptr i8, ptr %rundest.1, i64 %n.vec3505
  %ind.end3513 = getelementptr i8, ptr %runsrc.1, i64 %n.vec3505
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index3517 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next3521, %vec.epilog.vector.body ]
  %next.gep3518 = getelementptr i8, ptr %rundest.1, i64 %index3517
  %next.gep3519 = getelementptr i8, ptr %runsrc.1, i64 %index3517
  %wide.load3520 = load <8 x i8>, ptr %next.gep3519, align 1, !tbaa !28
  store <8 x i8> %wide.load3520, ptr %next.gep3518, align 1, !tbaa !28
  %index.next3521 = add nuw i64 %index3517, 8
  %243 = icmp eq i64 %index.next3521, %n.vec3505
  br i1 %243, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !250

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n3516 = icmp eq i64 %n.vec3505, %238
  br i1 %cmp.n3516, label %if.end1617, label %while.body1600.preheader

while.body1600.preheader:                         ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %i.143207.ph = phi i32 [ %i.13, %iter.check ], [ %ind.end3508, %vec.epilog.iter.check ], [ %ind.end3506, %vec.epilog.middle.block ]
  %rundest.23206.ph = phi ptr [ %rundest.1, %iter.check ], [ %ind.end3511, %vec.epilog.iter.check ], [ %ind.end3510, %vec.epilog.middle.block ]
  %runsrc.23205.ph = phi ptr [ %runsrc.1, %iter.check ], [ %ind.end3514, %vec.epilog.iter.check ], [ %ind.end3513, %vec.epilog.middle.block ]
...
while.body1600:                                   ; preds = %while.body1600.preheader, %while.body1600
  ...
  br i1 %cmp1598, label %while.body1600, label %if.end1617, !llvm.loop !251

if.else1604:                                      ; preds = %sw.epilog
  %cmp16093195 = icmp sgt i32 %match_length.0, 0
  br i1 %cmp16093195, label %iter.check3552, label %if.end1617

iter.check3552:                                   ; preds = %if.else1604
  ...
  %min.iters.check3550 = icmp ult i32 %match_length.0, 8
  %diff.check3547 = icmp ult i32 %match_offset.0, 32
  %or.cond3600 = select i1 %min.iters.check3550, i1 true, i1 %diff.check3547
  br i1 %or.cond3600, label %while.body1611.preheader, label %vector.main.loop.iter.check3554

vector.main.loop.iter.check3554:                  ; preds = %iter.check3552
  %min.iters.check3553 = icmp ult i32 %match_length.0, 32
  br i1 %min.iters.check3553, label %vec.epilog.ph3575, label %vector.ph3555

vector.ph3555:                                    ; preds = %vector.main.loop.iter.check3554
  %n.vec3557 = and i64 %245, 4294967264
  br label %vector.body3559

vector.body3559:                                  ; preds = %vector.body3559, %vector.ph3555
  %index3560 = phi i64 [ 0, %vector.ph3555 ], [ %index.next3567, %vector.body3559 ]
  %next.gep3561 = getelementptr i8, ptr %arrayidx1570, i64 %index3560
  %next.gep3563 = getelementptr i8, ptr %add.ptr1606, i64 %index3560
  %wide.load3565 = load <16 x i8>, ptr %next.gep3563, align 1, !tbaa !28
  %246 = getelementptr i8, ptr %next.gep3563, i64 16
  %wide.load3566 = load <16 x i8>, ptr %246, align 1, !tbaa !28
  store <16 x i8> %wide.load3565, ptr %next.gep3561, align 1, !tbaa !28
  %247 = getelementptr i8, ptr %next.gep3561, i64 16
  store <16 x i8> %wide.load3566, ptr %247, align 1, !tbaa !28
  %index.next3567 = add nuw i64 %index3560, 32
  %248 = icmp eq i64 %index.next3567, %n.vec3557
  br i1 %248, label %middle.block3548, label %vector.body3559, !llvm.loop !252

middle.block3548:                                 ; preds = %vector.body3559
  %cmp.n3558 = icmp eq i64 %n.vec3557, %245
  br i1 %cmp.n3558, label %if.end1617, label %vec.epilog.iter.check3574

vec.epilog.iter.check3574:                        ; preds = %middle.block3548
  %ind.end3590 = getelementptr i8, ptr %add.ptr1606, i64 %n.vec3557
  %ind.end3587 = getelementptr i8, ptr %arrayidx1570, i64 %n.vec3557
  %.cast3583 = trunc i64 %n.vec3557 to i32
  %ind.end3584 = sub i32 %match_length.0, %.cast3583
  %n.vec.remaining3576 = and i64 %245, 24
  %min.epilog.iters.check3577 = icmp eq i64 %n.vec.remaining3576, 0
  br i1 %min.epilog.iters.check3577, label %while.body1611.preheader, label %vec.epilog.ph3575

vec.epilog.ph3575:                                ; preds = %vector.main.loop.iter.check3554, %vec.epilog.iter.check3574
  %vec.epilog.resume.val3578 = phi i64 [ %n.vec3557, %vec.epilog.iter.check3574 ], [ 0, %vector.main.loop.iter.check3554 ]
  %n.vec3580 = and i64 %245, 4294967288
  %.cast3581 = trunc i64 %n.vec3580 to i32
  %ind.end3582 = sub i32 %match_length.0, %.cast3581
  %ind.end3586 = getelementptr i8, ptr %arrayidx1570, i64 %n.vec3580
  %ind.end3589 = getelementptr i8, ptr %add.ptr1606, i64 %n.vec3580
  br label %vec.epilog.vector.body3593

vec.epilog.vector.body3593:                       ; preds = %vec.epilog.vector.body3593, %vec.epilog.ph3575
  %index3594 = phi i64 [ %vec.epilog.resume.val3578, %vec.epilog.ph3575 ], [ %index.next3598, %vec.epilog.vector.body3593 ]
  %next.gep3595 = getelementptr i8, ptr %arrayidx1570, i64 %index3594
  %next.gep3596 = getelementptr i8, ptr %add.ptr1606, i64 %index3594
  %wide.load3597 = load <8 x i8>, ptr %next.gep3596, align 1, !tbaa !28
  store <8 x i8> %wide.load3597, ptr %next.gep3595, align 1, !tbaa !28
  %index.next3598 = add nuw i64 %index3594, 8
  %249 = icmp eq i64 %index.next3598, %n.vec3580
  br i1 %249, label %vec.epilog.middle.block3572, label %vec.epilog.vector.body3593, !llvm.loop !253

vec.epilog.middle.block3572:                      ; preds = %vec.epilog.vector.body3593
  %cmp.n3592 = icmp eq i64 %n.vec3580, %245
  br i1 %cmp.n3592, label %if.end1617, label %while.body1611.preheader

while.body1611.preheader:                         ; preds = %iter.check3552, %vec.epilog.iter.check3574, %vec.epilog.middle.block3572
  %i.153198.ph = phi i32 [ %match_length.0, %iter.check3552 ], [ %ind.end3584, %vec.epilog.iter.check3574 ], [ %ind.end3582, %vec.epilog.middle.block3572 ]
  %rundest.33197.ph = phi ptr [ %arrayidx1570, %iter.check3552 ], [ %ind.end3587, %vec.epilog.iter.check3574 ], [ %ind.end3586, %vec.epilog.middle.block3572 ]
  %runsrc.33196.ph = phi ptr [ %add.ptr1606, %iter.check3552 ], [ %ind.end3590, %vec.epilog.iter.check3574 ], [ %ind.end3589, %vec.epilog.middle.block3572 ]
...
while.body1611:                                   ; preds = %while.body1611.preheader, %while.body1611
  ...
  br i1 %cmp1609, label %while.body1611, label %if.end1617, !llvm.loop !254

if.end1617:                                       ; preds = %while.body1611, %while.body1600, %middle.block3548, %vec.epilog.middle.block3572, %middle.block, %vec.epilog.middle.block, %if.else1604, %if.end1595, %cleanup.thread
  %match_length.0.pn = phi i32 [ 1, %cleanup.thread ], [ %match_length.0, %if.end1595 ], [ %match_length.0, %if.else1604 ], [ %match_length.0, %vec.epilog.middle.block ], [ %match_length.0, %middle.block ], [ %match_length.0, %vec.epilog.middle.block3572 ], [ %match_length.0, %middle.block3548 ], [ %match_length.0, %while.body1600 ], [ %match_length.0, %while.body1611 ]
  %i_ptr.37 = phi ptr [ %i_ptr.9, %cleanup.thread ], [ %i_ptr.36, %if.end1595 ], [ %i_ptr.36, %if.else1604 ], [ %i_ptr.36, %vec.epilog.middle.block ], [ %i_ptr.36, %middle.block ], [ %i_ptr.36, %vec.epilog.middle.block3572 ], [ %i_ptr.36, %middle.block3548 ], [ %i_ptr.36, %while.body1600 ], [ %i_ptr.36, %while.body1611 ]
  %i_end.37 = phi ptr [ %i_end.9, %cleanup.thread ], [ %i_end.36, %if.end1595 ], [ %i_end.36, %if.else1604 ], [ %i_end.36, %vec.epilog.middle.block ], [ %i_end.36, %middle.block ], [ %i_end.36, %vec.epilog.middle.block3572 ], [ %i_end.36, %middle.block3548 ], [ %i_end.36, %while.body1600 ], [ %i_end.36, %while.body1611 ]
  %H.17 = phi i16 [ %H.5, %cleanup.thread ], [ %H.16, %if.end1595 ], [ %H.16, %if.else1604 ], [ %H.16, %vec.epilog.middle.block ], [ %H.16, %middle.block ], [ %H.16, %vec.epilog.middle.block3572 ], [ %H.16, %middle.block3548 ], [ %H.16, %while.body1600 ], [ %H.16, %while.body1611 ]
  %L.17 = phi i16 [ %L.5, %cleanup.thread ], [ %L.16, %if.end1595 ], [ %L.16, %if.else1604 ], [ %L.16, %vec.epilog.middle.block ], [ %L.16, %middle.block ], [ %L.16, %vec.epilog.middle.block3572 ], [ %L.16, %middle.block3548 ], [ %L.16, %while.body1600 ], [ %L.16, %while.body1611 ]
  %C.18 = phi i16 [ %C.6, %cleanup.thread ], [ %C.17, %if.end1595 ], [ %C.17, %if.else1604 ], [ %C.17, %vec.epilog.middle.block ], [ %C.17, %middle.block ], [ %C.17, %vec.epilog.middle.block3572 ], [ %C.17, %middle.block3548 ], [ %C.17, %while.body1600 ], [ %C.17, %while.body1611 ]
  %bit_buffer.26 = phi i32 [ %bit_buffer.7, %cleanup.thread ], [ %bit_buffer.25, %if.end1595 ], [ %bit_buffer.25, %if.else1604 ], [ %bit_buffer.25, %vec.epilog.middle.block ], [ %bit_buffer.25, %middle.block ], [ %bit_buffer.25, %vec.epilog.middle.block3572 ], [ %bit_buffer.25, %middle.block3548 ], [ %bit_buffer.25, %while.body1600 ], [ %bit_buffer.25, %while.body1611 ]
  %bits_left.26 = phi i8 [ %bits_left.7, %cleanup.thread ], [ %bits_left.25, %if.end1595 ], [ %bits_left.25, %if.else1604 ], [ %bits_left.25, %vec.epilog.middle.block ], [ %bits_left.25, %middle.block ], [ %bits_left.25, %vec.epilog.middle.block3572 ], [ %bits_left.25, %middle.block3548 ], [ %bits_left.25, %while.body1600 ], [ %bits_left.25, %while.body1611 ]
  %window_posn.3 = add i32 %match_length.0.pn, %window_posn.13213
  %cmp125 = icmp ult i32 %window_posn.3, %spec.select2472
  br i1 %cmp125, label %do.body128, label %while.end1618, !llvm.loop !255
...
while.end1618:                                    ; preds = %if.end1617, %if.end108
  ...
  store ptr %arrayidx1620, ptr %o_end, align 8, !tbaa !201
...
if.then1659:                                      ; preds = %if.then1656
  %252 = load ptr, ptr %read1.i, align 8, !tbaa !216
  %tobool.not.i2720 = icmp eq ptr %252, null
  %253 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  %254 = load i32, ptr %inbuf_size.i, align 4, !tbaa !193
  br i1 %tobool.not.i2720, label %cond.false.i2729, label %cond.true.i2725

cond.true.i2725:                                  ; preds = %if.then1659
  %255 = load ptr, ptr %file.i, align 8, !tbaa !215
  %call.i2724 = tail call i32 %252(ptr noundef %255, ptr noundef %253, i32 noundef %254) #12
  br label %cond.end.i2732

cond.false.i2729:                                 ; preds = %if.then1659
  %256 = load i32, ptr %qtm, align 8, !tbaa !190
  %call6.i2728 = tail call i32 @cli_readn(i32 noundef %256, ptr noundef %253, i32 noundef %254) #12
  br label %cond.end.i2732
...
if.end1664:                                       ; preds = %cond.end.i2732
  %257 = load ptr, ptr %inbuf.i, align 8, !tbaa !189
  store ptr %257, ptr %i_ptr28, align 8, !tbaa !200
  %idxprom.i2737 = zext i32 %cond.i2730 to i64
  %arrayidx10.i2738 = getelementptr inbounds i8, ptr %257, i64 %idxprom.i2737
  store ptr %arrayidx10.i2738, ptr %i_end29, align 8, !tbaa !199
  br label %if.end1667
...
if.end1667:                                       ; preds = %if.end1664, %if.then1656
  ...
  %.pre3364 = zext i8 %add1680 to i32
  br label %do.end1685

do.end1685:                                       ; preds = %if.end1667, %do.body1652
  %conv1686.pre-phi = phi i32 [ %.pre3364, %if.end1667 ], [ %conv1653, %do.body1652 ]
...
do.body1652.backedge:                             ; preds = %do.end1685, %do.cond1718
  ...
  br label %do.body1652, !llvm.loop !256
...
do.end1721:                                       ; preds = %do.cond1718
  store i8 0, ptr %header_read, align 2, !tbaa !197
  %261 = load i32, ptr %window_size, align 8, !tbaa !194
  %cmp1724 = icmp eq i32 %window_posn.1.lcssa, %261
  %262 = load ptr, ptr %o_end, align 8, !tbaa !201
  br i1 %cmp1724, label %if.then1726, label %if.end1752

if.then1726:                                      ; preds = %do.end1721
  %263 = load ptr, ptr %o_ptr, align 8, !tbaa !202
  ...
  %264 = load i8, ptr %wflag1733, align 8, !tbaa !192
...
land.lhs.true1736:                                ; preds = %if.then1726
  ...
  %265 = load i32, ptr %ofd1737, align 4, !tbaa !191
  %call1739 = tail call i32 @cli_writen(i32 noundef %265, ptr noundef %263, i32 noundef %conv1732) #12
...
if.end1744:                                       ; preds = %land.lhs.true1736, %if.then1726
  ...
  store ptr %11, ptr %o_ptr, align 8, !tbaa !202
  store ptr %11, ptr %o_end, align 8, !tbaa !201
  br label %if.end1752
...
if.end1752:                                       ; preds = %do.end1721, %if.end1744, %while.end1618
  ...
  %267 = load ptr, ptr %o_ptr, align 8, !tbaa !202
  ...
  br i1 %cmp43, label %while.body, label %while.end1753, !llvm.loop !257
...
if.then1755:                                      ; preds = %while.end1753
  ...
  %268 = load i8, ptr %wflag1757, align 8, !tbaa !192
...
land.lhs.true1760:                                ; preds = %if.then1755
  ...
  %269 = load i32, ptr %ofd1761, align 4, !tbaa !191
  %call1763 = tail call i32 @cli_writen(i32 noundef %269, ptr noundef %.lcssa, i32 noundef %conv1756) #12
...
land.lhs.true1760.if.end1768_crit_edge:           ; preds = %land.lhs.true1760
  %.pre3362 = load ptr, ptr %o_ptr, align 8, !tbaa !202
  br label %if.end1768
...
if.end1768:                                       ; preds = %land.lhs.true1760.if.end1768_crit_edge, %if.then1755
  %270 = phi ptr [ %.pre3362, %land.lhs.true1760.if.end1768_crit_edge ], [ %.lcssa, %if.then1755 ]
  ...
  store ptr %add.ptr1771, ptr %o_ptr, align 8, !tbaa !202
  br label %do.body1773

do.body1773:                                      ; preds = %while.end1753, %if.end1768
  store ptr %i_ptr.0.lcssa, ptr %i_ptr28, align 8, !tbaa !200
  store ptr %i_end.0.lcssa, ptr %i_end29, align 8, !tbaa !199
  store i32 %bit_buffer.0.lcssa, ptr %bit_buffer30, align 8, !tbaa !204
  store i8 %bits_left.0.lcssa, ptr %bits_left31, align 8, !tbaa !203
  store i32 %window_posn.0.lcssa, ptr %window_posn33, align 4, !tbaa !195
  store i32 %frame_start.0.lcssa, ptr %frame_start34, align 8, !tbaa !196
  store i16 %H.0.lcssa, ptr %H35, align 4, !tbaa !217
  store i16 %L.0.lcssa, ptr %L36, align 2, !tbaa !218
  store i16 %C.0.lcssa, ptr %C37, align 8, !tbaa !219
  br label %cleanup1785
...
entry:
  %0 = load i32, ptr %model, align 8, !tbaa !205
  %dec = add nsw i32 %0, -1
  store i32 %dec, ptr %model, align 8, !tbaa !205
  %tobool.not = icmp eq i32 %dec, 0
  br i1 %tobool.not, label %if.else, label %if.then

if.then:                                          ; preds = %entry
  %entries = getelementptr inbounds %struct.qtm_model, ptr %model, i64 0, i32 1
  %1 = load i32, ptr %entries, align 4, !tbaa !206
...
for.body.lr.ph:                                   ; preds = %if.then
  ...
  %2 = load ptr, ptr %syms, align 8, !tbaa !207
  %3 = zext i32 %1 to i64
...
for.body.prol:                                    ; preds = %for.body.lr.ph
  ...
  %4 = load i16, ptr %cumfreq.prol, align 2, !tbaa !210
  %5 = lshr i16 %4, 1
  store i16 %5, ptr %cumfreq.prol, align 2, !tbaa !210
  %cumfreq10.prol = getelementptr inbounds %struct.qtm_modelsym, ptr %2, i64 %3, i32 1
  %6 = load i16, ptr %cumfreq10.prol, align 2, !tbaa !210
...
if.then14.prol:                                   ; preds = %for.body.prol
  ...
  store i16 %add21.prol, ptr %cumfreq.prol, align 2, !tbaa !210
...
for.body:                                         ; preds = %for.body.prol.loopexit, %for.inc.1
  ...
  %8 = load i16, ptr %cumfreq, align 2, !tbaa !210
  %9 = lshr i16 %8, 1
  store i16 %9, ptr %cumfreq, align 2, !tbaa !210
  %cumfreq10 = getelementptr inbounds %struct.qtm_modelsym, ptr %2, i64 %indvars.iv, i32 1
  %10 = load i16, ptr %cumfreq10, align 2, !tbaa !210
  %cmp12.not = icmp ugt i16 %9, %10
  br i1 %cmp12.not, label %for.inc, label %if.then14

if.then14:                                        ; preds = %for.body
  %add21 = add i16 %10, 1
  store i16 %add21, ptr %cumfreq, align 2, !tbaa !210
  br label %for.inc
...
for.inc:                                          ; preds = %for.body, %if.then14
  ...
  %11 = load i16, ptr %cumfreq.1, align 2, !tbaa !210
  %12 = lshr i16 %11, 1
  store i16 %12, ptr %cumfreq.1, align 2, !tbaa !210
  %cumfreq10.1 = getelementptr inbounds %struct.qtm_modelsym, ptr %2, i64 %indvars.iv.next, i32 1
  %13 = load i16, ptr %cumfreq10.1, align 2, !tbaa !210
...
if.then14.1:                                      ; preds = %for.inc
  ...
  store i16 %add21.1, ptr %cumfreq.1, align 2, !tbaa !210
  br label %for.inc.1

for.inc.1:                                        ; preds = %if.then14.1, %for.inc
  %cmp.1 = icmp ugt i64 %indvars.iv.next, 1
  br i1 %cmp.1, label %for.body, label %if.end127, !llvm.loop !258

if.else:                                          ; preds = %entry
  store i32 50, ptr %model, align 8, !tbaa !205
  %entries30 = getelementptr inbounds %struct.qtm_model, ptr %model, i64 0, i32 1
  %14 = load i32, ptr %entries30, align 4, !tbaa !206
...
for.body33.lr.ph:                                 ; preds = %if.else
  ...
  %15 = load ptr, ptr %syms34, align 8, !tbaa !207
  %wide.trip.count = zext i32 %14 to i64
  %cumfreq43.phi.trans.insert = getelementptr inbounds %struct.qtm_modelsym, ptr %15, i64 0, i32 1
  %.pre = load i16, ptr %cumfreq43.phi.trans.insert, align 2, !tbaa !210
...
for.body33.epil:                                  ; preds = %for.cond61.preheader.unr-lcssa
  ...
  %17 = load i16, ptr %cumfreq38.epil, align 2, !tbaa !210
  %cumfreq43.epil = getelementptr inbounds %struct.qtm_modelsym, ptr %15, i64 %indvars.iv194.unr, i32 1
  %sub45.epil = sub i16 1, %17
  %inc.epil = add i16 %sub45.epil, %.unr
  %18 = lshr i16 %inc.epil, 1
  store i16 %18, ptr %cumfreq43.epil, align 2, !tbaa !210
...
for.body33:                                       ; preds = %for.body33, %for.body33.lr.ph.new
  ...
  %20 = load i16, ptr %cumfreq38, align 2, !tbaa !210
  %cumfreq43 = getelementptr inbounds %struct.qtm_modelsym, ptr %15, i64 %indvars.iv194, i32 1
  %sub45 = sub i16 1, %20
  %inc = add i16 %sub45, %19
  %21 = lshr i16 %inc, 1
  store i16 %21, ptr %cumfreq43, align 2, !tbaa !210
  ...
  %22 = load i16, ptr %cumfreq38.1, align 2, !tbaa !210
  %cumfreq43.1 = getelementptr inbounds %struct.qtm_modelsym, ptr %15, i64 %indvars.iv.next195, i32 1
  %sub45.1 = sub i16 1, %22
  %inc.1 = add i16 %sub45.1, %20
  %23 = lshr i16 %inc.1, 1
  store i16 %23, ptr %cumfreq43.1, align 2, !tbaa !210
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %for.cond61.preheader.unr-lcssa, label %for.body33, !llvm.loop !259
...
for.cond61.loopexit:                              ; preds = %for.inc99, %for.body66
  ...
  br i1 %cmp64, label %for.body66, label %for.cond107.preheader, !llvm.loop !260
...
for.body110.lr.ph:                                ; preds = %for.cond107.preheader
  ...
  %26 = load ptr, ptr %syms111, align 8, !tbaa !207
...
for.body110.prol:                                 ; preds = %for.body110.lr.ph
  ...
  %30 = load i16, ptr %cumfreq115.prol, align 2, !tbaa !210
  %cumfreq120.prol = getelementptr inbounds %struct.qtm_modelsym, ptr %26, i64 %27, i32 1
  %31 = load i16, ptr %cumfreq120.prol, align 2, !tbaa !210
  %add122.prol = add i16 %31, %30
  store i16 %add122.prol, ptr %cumfreq120.prol, align 2, !tbaa !210
...
for.inc99:                                        ; preds = %for.body72, %if.then85
  ...
  br i1 %cmp70, label %for.body72, label %for.cond61.loopexit, !llvm.loop !261
...
for.body110:                                      ; preds = %for.body110.prol.loopexit, %for.body110
  ...
  %47 = load i16, ptr %cumfreq115, align 2, !tbaa !210
  %cumfreq120 = getelementptr inbounds %struct.qtm_modelsym, ptr %26, i64 %indvars.iv208, i32 1
  %48 = load i16, ptr %cumfreq120, align 2, !tbaa !210
  %add122 = add i16 %48, %47
  store i16 %add122, ptr %cumfreq120, align 2, !tbaa !210
  ...
  %49 = load i16, ptr %cumfreq120.1, align 2, !tbaa !210
  %add122.1 = add i16 %49, %add122
  store i16 %add122.1, ptr %cumfreq120.1, align 2, !tbaa !210
  %indvars.iv.next209.1 = add nsw i64 %indvars.iv208, -2
  %cmp108.not.1 = icmp eq i64 %indvars.iv.next209, 0
  br i1 %cmp108.not.1, label %if.end127, label %for.body110, !llvm.loop !262
...
if.then:                                          ; preds = %entry
  ...
  %0 = load ptr, ptr %window, align 8, !tbaa !186
  tail call void @free(ptr noundef %0) #12
  %inbuf = getelementptr inbounds %struct.qtm_stream, ptr %qtm, i64 0, i32 12
  %1 = load ptr, ptr %inbuf, align 8, !tbaa !189
  tail call void @free(ptr noundef %1) #12
  tail call void @free(ptr noundef nonnull %qtm) #12
  br label %if.end
...
define internal fastcc i32 @mszip_make_decode_table(i32 noundef %nsyms, i32 noundef %nbits, ptr nocapture noundef readonly %length, ptr nocapture noundef %table) unnamed_addr #9 {
entry:
  %shl = shl nuw nsw i32 1, %nbits
  %shr = lshr i32 %shl, 1
...
do.body.us:                                       ; preds = %if.end.us, %do.body.us
  ...
  br i1 %niter.ncmp.3, label %do.end.us.unr-lcssa, label %do.body.us, !llvm.loop !263
...
do.body.us.epil:                                  ; preds = %do.end.us.unr-lcssa, %do.body.us.epil
  ...
  br i1 %epil.iter.cmp.not, label %do.end.us, label %do.body.us.epil, !llvm.loop !264
...
do.body24.us.prol:                                ; preds = %do.body24.us.preheader, %do.body24.us.prol
  ...
  store i16 %sym.0250.us, ptr %arrayidx26.us.prol, align 2, !tbaa !48
  ...
  br i1 %prol.iter.cmp.not, label %do.body24.us.prol.loopexit, label %do.body24.us.prol, !llvm.loop !265
...
do.body24.us:                                     ; preds = %do.body24.us.prol.loopexit, %do.body24.us
  ...
  store i16 %sym.0250.us, ptr %arrayidx26.us, align 2, !tbaa !48
  ...
  store i16 %sym.0250.us, ptr %arrayidx26.us.1, align 2, !tbaa !48
  ...
  store i16 %sym.0250.us, ptr %arrayidx26.us.2, align 2, !tbaa !48
  ...
  store i16 %sym.0250.us, ptr %arrayidx26.us.3, align 2, !tbaa !48
  %add28.us.3 = add i32 %add28.us.2, %conv27.us
  %dec30.us.3 = add i32 %fill.1.us, -4
  %tobool31.not.us.3 = icmp eq i32 %dec30.us.3, 0
  br i1 %tobool31.not.us.3, label %for.inc.us, label %do.body24.us, !llvm.loop !266
...
for.inc.us:                                       ; preds = %do.body24.us.prol.loopexit, %do.body24.us, %for.body6.us
  ...
  br i1 %cmp4.us, label %for.body6.us, label %for.cond2.for.end_crit_edge.us, !llvm.loop !267
...
for.cond2.for.end_crit_edge.us:                   ; preds = %for.inc.us
  ...
  %cmp.not.us = icmp ugt i32 %conv.us, %nbits
  br i1 %cmp.not.us, label %for.end36, label %for.cond2.preheader.us, !llvm.loop !268
...
do.body48:                                        ; preds = %do.body48.preheader, %do.body48
  ...
  br i1 %niter352.ncmp.3, label %do.end56.unr-lcssa, label %do.body48, !llvm.loop !269
...
do.body48.epil:                                   ; preds = %do.end56.unr-lcssa, %do.body48.epil
  ...
  br i1 %epil.iter348.cmp.not, label %do.end56, label %do.body48.epil, !llvm.loop !270
...
do.end56:                                         ; preds = %do.body48.epil, %do.end56.unr-lcssa
  ...
  store i16 -1, ptr %arrayidx58, align 2, !tbaa !48
  %inc60 = add nuw nsw i32 %conv43261, 1
  %conv43 = and i32 %inc60, 65535
  %cmp44 = icmp ugt i32 %shl, %conv43
  br i1 %cmp44, label %do.body48.preheader, label %for.end61, !llvm.loop !271
...
do.body90.us293:                                  ; preds = %if.end88.us291, %do.body90.us293
  ...
  br i1 %niter364.ncmp.3, label %for.cond99.preheader.us308.unr-lcssa, label %do.body90.us293, !llvm.loop !272
...
for.inc142.us303:                                 ; preds = %for.cond99.preheader.us308, %for.body80.us285
  ...
  br i1 %cmp78.us307, label %for.body80.us285, label %for.cond76.for.end144_crit_edge.us, !llvm.loop !273
...
do.body90.us293.epil:                             ; preds = %for.cond99.preheader.us308.unr-lcssa, %do.body90.us293.epil
  ...
  br i1 %epil.iter360.cmp.not, label %for.cond99.preheader.us308, label %do.body90.us293.epil, !llvm.loop !274
...
for.cond99.preheader.us308:                       ; preds = %do.body90.us293.epil, %for.cond99.preheader.us308.unr-lcssa
  ...
  store i16 %sym.2268.us287, ptr %arrayidx136.us311, align 2, !tbaa !48
...
for.cond76.for.end144_crit_edge.us:               ; preds = %for.inc142.us.us, %for.inc142.us303
  ...
  br i1 %exitcond329.not, label %for.end148, label %for.cond76.preheader.us, !llvm.loop !275
...
do.body90.us.us:                                  ; preds = %if.end88.us.us, %do.body90.us.us
  ...
  br i1 %niter358.ncmp.3, label %for.body104.us.us.preheader.unr-lcssa, label %do.body90.us.us, !llvm.loop !272
...
do.body90.us.us.epil:                             ; preds = %for.body104.us.us.preheader.unr-lcssa, %do.body90.us.us.epil
  ...
  br i1 %epil.iter354.cmp.not, label %for.body104.us.us.preheader, label %do.body90.us.us.epil, !llvm.loop !276
...
for.inc142.us.us:                                 ; preds = %for.cond99.for.end134_crit_edge.us.us, %for.body80.us.us
  ...
  br i1 %cmp78.us.us, label %for.body80.us.us, label %for.cond76.for.end144_crit_edge.us, !llvm.loop !273
...
for.body104.us.us:                                ; preds = %for.body104.us.us.preheader, %if.end123.us.us
  ...
  %26 = load i16, ptr %arrayidx106.us.us, align 2, !tbaa !48
...
if.then110.us.us:                                 ; preds = %for.body104.us.us
  ...
  store <2 x i16> <i16 -1, i16 -1>, ptr %arrayidx114.us.us, align 2, !tbaa !48
  %inc120.us.us = add i16 %next_sym.2265.us.us, 1
  store i16 %next_sym.2265.us.us, ptr %arrayidx106.us.us, align 2, !tbaa !48
  br label %if.end123.us.us
...
if.end123.us.us:                                  ; preds = %for.body104.us.us.if.end123.us.us_crit_edge, %if.then110.us.us
  ...
  br i1 %exitcond.not, label %for.cond99.for.end134_crit_edge.us.us, label %for.body104.us.us, !llvm.loop !277
...
for.cond99.for.end134_crit_edge.us.us:            ; preds = %if.end123.us.us
  ...
  store i16 %sym.2268.us.us, ptr %arrayidx136.us.us, align 2, !tbaa !48
...
!64 = distinct !{!64, !30}
!65 = distinct !{!65, !30}
!66 = distinct !{!66, !30, !54, !55}
!67 = distinct !{!67, !30, !54, !55}
!68 = distinct !{!68, !43}
!69 = distinct !{!69, !30, !54}
!70 = distinct !{!70, !30}
!71 = distinct !{!71, !30}
!72 = distinct !{!72, !30}
!73 = !{!7, !7, i64 0}
...
!124 = distinct !{!124, !30}
!125 = distinct !{!125, !30}
!126 = distinct !{!126, !30, !54, !55}
!127 = distinct !{!127, !30, !54}
!128 = distinct !{!128, !30, !54, !55}
!129 = distinct !{!129, !30, !54, !55}
!130 = distinct !{!130, !30, !54}
!131 = distinct !{!131, !30, !54, !55}
!132 = distinct !{!132, !30, !54, !55}
!133 = distinct !{!133, !30, !54}
!134 = distinct !{!134, !30}
!135 = distinct !{!135, !30}
!136 = distinct !{!136, !30}
!137 = distinct !{!137, !30}
...
!143 = distinct !{!143, !30}
!144 = distinct !{!144, !30}
!145 = distinct !{!145, !30, !54, !55}
!146 = distinct !{!146, !30, !54}
!147 = distinct !{!147, !30, !54, !55}
!148 = distinct !{!148, !30, !54, !55}
!149 = distinct !{!149, !30, !54}
!150 = distinct !{!150, !30, !54, !55}
!151 = distinct !{!151, !30, !54, !55}
!152 = distinct !{!152, !30, !54}
!153 = distinct !{!153, !30}
!154 = distinct !{!154, !30}
!155 = distinct !{!155, !30}
!156 = distinct !{!156, !30}
!157 = distinct !{!157, !30}
!158 = distinct !{!158, !30, !54, !55}
!159 = distinct !{!159, !43}
!160 = distinct !{!160, !30, !54}
!161 = distinct !{!161, !30}
!162 = distinct !{!162, !30}
!163 = distinct !{!163, !30, !54, !55}
!164 = distinct !{!164, !30, !54}
!165 = distinct !{!165, !30}
!166 = distinct !{!166, !30}
!167 = distinct !{!167, !30}
!168 = distinct !{!168, !30}
...
!173 = distinct !{!173, !30}
!174 = distinct !{!174, !43}
!175 = distinct !{!175, !30, !54}
!176 = distinct !{!176, !30}
!177 = distinct !{!177, !30, !54, !55}
!178 = distinct !{!178, !43}
!179 = distinct !{!179, !30, !54}
!180 = distinct !{!180, !30}
!181 = distinct !{!181, !30}
!182 = distinct !{!182, !30}
!183 = distinct !{!183, !30}
...
!185 = distinct !{!185, !30}
!186 = !{!187, !10, i64 16}
!187 = !{!"qtm_stream", !7, i64 0, !7, i64 4, !8, i64 8, !10, i64 16, !7, i64 24, !7, i64 28, !7, i64 32, !49, i64 36, !49, i64 38, !49, i64 40, !8, i64 42, !7, i64 44, !10, i64 48, !10, i64 56, !10, i64 64, !10, i64 72, !10, i64 80, !7, i64 88, !7, i64 92, !8, i64 96, !8, i64 100, !8, i64 268, !8, i64 310, !8, i64 337, !188, i64 368, !188, i64 384, !188, i64 400, !188, i64 416, !188, i64 432, !188, i64 448, !188, i64 464, !188, i64 480, !188, i64 496, !8, i64 512, !8, i64 772, !8, i64 1032, !8, i64 1292, !8, i64 1552, !8, i64 1652, !8, i64 1800, !8, i64 1972, !8, i64 2084, !10, i64 2120, !10, i64 2128}
!188 = !{!"qtm_model", !7, i64 0, !7, i64 4, !10, i64 8}
!189 = !{!187, !10, i64 48}
!190 = !{!187, !7, i64 0}
!191 = !{!187, !7, i64 4}
!192 = !{!187, !8, i64 8}
...
!207 = !{!188, !10, i64 8}
!208 = !{!209, !49, i64 0}
!209 = !{!"qtm_modelsym", !49, i64 0, !49, i64 2}
!210 = !{!209, !49, i64 2}
!211 = distinct !{!211, !30, !54, !55}
!212 = distinct !{!212, !30, !55, !54}
!213 = distinct !{!213, !30, !54, !55}
!214 = distinct !{!214, !30, !55, !54}
!215 = !{!187, !10, i64 2120}
!216 = !{!187, !10, i64 2128}
!217 = !{!187, !49, i64 36}
!218 = !{!187, !49, i64 38}
...
!245 = distinct !{!245, !30}
!246 = distinct !{!246, !30}
!247 = distinct !{!247, !30, !54, !55}
!248 = distinct !{!248, !30, !54}
!249 = distinct !{!249, !30, !54, !55}
!250 = distinct !{!250, !30, !54, !55}
!251 = distinct !{!251, !30, !54}
!252 = distinct !{!252, !30, !54, !55}
!253 = distinct !{!253, !30, !54, !55}
!254 = distinct !{!254, !30, !54}
!255 = distinct !{!255, !30}
!256 = distinct !{!256, !30}
!257 = distinct !{!257, !30}
!258 = distinct !{!258, !30}
