...
if.then.i135:                                     ; preds = %if.then45
  ...
  %.pre = load ptr, ptr %__parent_.i103.le188, align 8, !tbaa !34
...
_ZNSt3__119__tree_right_rotateB7v170000IPNS_16__tree_node_baseIPvEEEEvT_.exit141: ; preds = %if.then45, %if.then.i135
  ...
  store ptr %22, ptr %__parent_.i.le, align 8, !tbaa !34
  %23 = load ptr, ptr %__parent_.i103.le188, align 8, !tbaa !34
  ...
  store ptr %__x.addr.0169, ptr %__parent_.i103.le188, align 8, !tbaa !34
  %.pre174 = load ptr, ptr %__parent_.i.le, align 8, !tbaa !34
  br label %if.end47
