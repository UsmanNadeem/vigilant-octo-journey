; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c"
...
@.str.1 = private unnamed_addr constant [96 x i8] c"/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/rules-sort.c\00", align 1
...
clause_GetLiteralAtom.exit:                       ; preds = %while.body, %if.then.i.i
  ...
  %9 = select i1 %cmp, i1 %cmp.i.i, i1 false
...
if.end19:                                         ; preds = %if.end19.loopexit, %clause_GetLiteralAtom.exit
  ...
  %19 = select i1 %cmp, i1 %tobool.not, i1 false
...
; Function Attrs: nounwind uwtable
define internal fastcc ptr @inf_GetForwardPartnerLits(ptr %Literal.24.val, ptr noundef %Index) unnamed_addr #0 {
entry:
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %call.i180 = tail call i32 @_IO_putc(i32 noundef 32, ptr noundef %7)
...
for.body12:                                       ; preds = %for.end, %for.body12
  ...
  %call.i183 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %10)
...
for.end20:                                        ; preds = %for.body12, %for.end
  ...
  %call.i184 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %15)
