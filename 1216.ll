; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/PR10189.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/PR10189.c"
...
func_13.exit:                                     ; preds = %entry, %for.inc.preheader.i
  ...
  %conv7.i = trunc i32 %9 to i16
  %cmp1224.i = icmp sgt i16 %conv7.i, 0
...
define dso_local signext i8 @func_13(i32 noundef %p_, i16 noundef zeroext %p_15, i16 noundef signext %p_1) local_unnamed_addr #2 {
entry:
  %0 = load i16, ptr @g_8, align 2, !tbaa !5
...
define dso_local signext i8 @func_21(i8 noundef zeroext %p_, i32 noundef %p_2, ptr nocapture noundef readnone %p_24) local_unnamed_addr #3 {
entry:
...
func_1.exit:                                      ; preds = %entry, %for.inc.preheader.i.i
  ...
  %conv7.i.i = trunc i32 %9 to i16
  %cmp1224.i.i = icmp sgt i16 %conv7.i.i, 0
...
attributes #2 = { nofree norecurse nounwind memory(readwrite, argmem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
