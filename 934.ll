; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Bullet/btDbvtBroadphase.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Bullet/btDbvtBroadphase.cpp"
...
for.body10.lr.ph.i119:                            ; preds = %if.then3.i.i.i116, %if.then5.i97
  ...
  %60 = shl nsw i64 %59, 3
  %uglygep = getelementptr i8, ptr %stack.sroa.21159.3, i64 %60
  %61 = sub nsw i64 %wide.trip.count.i, %59
  %62 = shl nsw i64 %61, 3
  tail call void @llvm.memset.p0.i64(ptr align 8 %uglygep, i8 0, i64 %62, i1 false), !tbaa !25
...
_ZNK20btAlignedObjectArrayIN6btDbvt6sStkNNEE4copyEiiPS1_.exit.i.i199: ; preds = %for.body.i.i.i193.epil, %_ZNK20btAlignedObjectArrayIN6btDbvt6sStkNNEE4copyEiiPS1_.exit.i.i199.loopexit.unr-lcssa, %if.then.i.i181, %_ZN20btAlignedObjectArrayIN6btDbvt6sStkNNEE8allocateEi.exit.i.i
  ...
  %17 = load i8, ptr %m_ownsMemory.i.i.i196, align 8
...
if.end54:                                         ; preds = %do.end, %if.end
  ...
  %m_deferedcollide = getelementptr inbounds %struct.btDbvtBroadphase, ptr %this, i64 0, i32 18
  %17 = load i8, ptr %m_deferedcollide, align 1, !tbaa !8, !range !26
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end27
  ...
  %8 = load ptr, ptr %arrayidx.i, align 8, !tbaa !87
...
if.then:                                          ; preds = %entry
  ...
  %m_updates_call = getelementptr inbounds %struct.btDbvtBroadphase, ptr %this, i64 0, i32 11
  %uglygep = getelementptr i8, ptr %this, i64 136
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %uglygep, i8 0, i64 24, i1 false), !tbaa !25
...
attributes #12 = { mustprogress nofree nosync nounwind willreturn uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
