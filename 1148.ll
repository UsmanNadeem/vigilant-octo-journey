; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Crypto/WzAes.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Crypto/WzAes.cpp"
...
for.body.preheader:                               ; preds = %entry
  %uglygep = getelementptr i8, ptr %this, i64 28
  %1 = shl i32 %0, 2
  %2 = and i32 %1, 12
  %narrow = add nuw nsw i32 %2, 4
  %3 = zext i32 %narrow to i64
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %uglygep, ptr noundef nonnull align 16 dereferenceable(1) %temp, i64 %3, i1 false), !tbaa !15
  %uglygep35 = getelementptr i8, ptr %this, i64 280
  %uglygep36 = getelementptr i8, ptr %temp, i64 %3
  %4 = load i16, ptr %uglygep36, align 4, !tbaa !15
  store i16 %4, ptr %uglygep35, align 8, !tbaa !15
  br label %cleanup19
...
vector.memcheck:                                  ; preds = %vector.scevcheck
  ...
  %uglygep = getelementptr i8, ptr %data, i64 %15
  %16 = shl nuw nsw i64 %idx.ext, 2
  %17 = zext i32 %1 to i64
  %18 = add nuw nsw i64 %16, %17
  %19 = add nuw nsw i64 %18, 8
  %uglygep74 = getelementptr i8, ptr %p, i64 %19
  %20 = add nuw nsw i64 %umin73, %16
  %21 = add nuw nsw i64 %20, %17
  %22 = add nuw nsw i64 %21, 9
  %uglygep75 = getelementptr i8, ptr %p, i64 %22
  %bound0 = icmp ugt ptr %uglygep75, %data
  %bound1 = icmp ult ptr %uglygep74, %uglygep
...
do.body:                                          ; preds = %do.body.preheader87, %do.body
  ...
  %32 = select i1 %cmp6, i1 %cmp7, i1 false
...
vector.memcheck:                                  ; preds = %vector.scevcheck
  ...
  %uglygep7 = getelementptr i8, ptr %this, i64 %19
  %20 = add nuw nsw i64 %umin6, %16
  %21 = add nuw nsw i64 %20, %17
  %22 = add nuw nsw i64 %21, 293
  %uglygep8 = getelementptr i8, ptr %this, i64 %22
  %bound0 = icmp ugt ptr %uglygep8, %data
  %bound1 = icmp ult ptr %uglygep7, %uglygep
  %found.conflict = and i1 %bound0, %bound1
...
do.body.i:                                        ; preds = %do.body.i.preheader20, %do.body.i
  ...
  %32 = select i1 %cmp6.i, i1 %cmp7.i, i1 false
