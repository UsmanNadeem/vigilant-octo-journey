; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_bzlib.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_bzlib.c"
...
if.end18:                                         ; preds = %if.then16, %if.end14
  ...
  %call20 = tail call ptr %1(ptr noundef %3, i32 noundef 64144, i32 noundef 1) #8
...
if.then:                                          ; preds = %entry
  tail call void @free(ptr noundef nonnull %addr) #8
  br label %if.end
...
entry:
  ...
  %pos.i384 = ptrtoint ptr %pos.i to i64
  %cmp = icmp eq ptr %strm, null
...
while.cond.preheader:                             ; preds = %if.end3
  ...
  %uglygep.i = getelementptr i8, ptr %0, i64 3196
  %nInUse.i.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 27
  %uglygep3283.i = getelementptr i8, ptr %0, i64 68
  ...
  %uglygep = getelementptr i8, ptr %0, i64 3724
  %uglygep309 = getelementptr i8, ptr %0, i64 3724
  %3 = add i64 %1, 3724
  %4 = add i64 %1, 3724
...
while.cond.outer:                                 ; preds = %cleanup, %while.cond.preheader
  %.ph528 = phi i32 [ 2, %cleanup ], [ %.pre, %while.cond.preheader ]
  %cmp29 = icmp sgt i32 %.ph528, 9
  br label %while.cond

while.cond:                                       ; preds = %while.cond.outer, %if.end27
  switch i32 %.ph528, label %if.end27 [
...
if.end.i.outer:                                   ; preds = %if.end.lr.ph.lr.ph.i, %if.end20.i
  %.ph524 = phi ptr [ %277, %if.end.lr.ph.lr.ph.i ], [ %283, %if.end20.i ]
  %.ph525 = phi i32 [ %.pre.pre.i, %if.end.lr.ph.lr.ph.i ], [ %dec.i, %if.end20.i ]
  %avail_out336.i = getelementptr inbounds %struct.nsis_bzstream, ptr %.ph524, i64 0, i32 5
  br label %if.end.i

if.end.i:                                         ; preds = %if.end.i.outer, %while.cond.backedge.i
  %279 = phi i32 [ %.pre342.i, %while.cond.backedge.i ], [ %.ph525, %if.end.i.outer ]
  %cmp3.i = icmp eq i32 %279, 0
  br i1 %cmp3.i, label %while.end.i, label %if.end5.i

if.end5.i:                                        ; preds = %if.end.i
  %280 = load i8, ptr %state_out_ch.i, align 4, !tbaa !29
  %next_out.i = getelementptr inbounds %struct.nsis_bzstream, ptr %.ph524, i64 0, i32 4
...
while.cond.backedge.i:                            ; preds = %indexIntoF.exit334.i, %if.then141.i, %indexIntoF.exit308.i, %if.then99.i, %indexIntoF.exit295.i, %if.then57.i, %indexIntoF.exit.i
  %.pre342.i = phi i32 [ 1, %if.then57.i ], [ 2, %if.then99.i ], [ 3, %if.then141.i ], [ %add172.i, %indexIntoF.exit334.i ], [ 1, %indexIntoF.exit.i ], [ 2, %indexIntoF.exit295.i ], [ 3, %indexIntoF.exit308.i ]
...
if.end.i69.preheader:                             ; preds = %while.cond2.preheader.i
  ...
  %umin = call i32 @llvm.umin.i32(i32 %321, i32 %322)
  %min.iters.check465 = icmp ult i32 %umin, 32
  br i1 %min.iters.check465, label %if.end.i69.preheader483, label %vector.ph466

vector.ph466:                                     ; preds = %if.end.i69.preheader
  %323 = zext i32 %umin to i64
  %324 = add nuw nsw i64 %323, 1
  %n.mod.vf467 = and i64 %324, 31
  %325 = icmp eq i64 %n.mod.vf467, 0
  %326 = select i1 %325, i64 32, i64 %n.mod.vf467
  %n.vec468 = sub nsw i64 %324, %326
  %.cast = trunc i64 %n.vec468 to i32
  %ind.end469 = sub i32 %cs_avail_out.0.i.fr, %.cast
  %ind.end471 = getelementptr i8, ptr %cs_next_out.0.i, i64 %n.vec468
  %.cast473 = trunc i64 %n.vec468 to i32
  %ind.end474 = sub i32 %c_state_out_len.0.i, %.cast473
  %broadcast.splatinsert = insertelement <16 x i8> poison, i8 %c_state_out_ch.0.i, i64 0
  %broadcast.splat = shufflevector <16 x i8> %broadcast.splatinsert, <16 x i8> poison, <16 x i32> zeroinitializer
  %broadcast.splatinsert479 = insertelement <16 x i8> poison, i8 %c_state_out_ch.0.i, i64 0
  %broadcast.splat480 = shufflevector <16 x i8> %broadcast.splatinsert479, <16 x i8> poison, <16 x i32> zeroinitializer
  br label %vector.body476

vector.body476:                                   ; preds = %vector.body476, %vector.ph466
  %index477 = phi i64 [ 0, %vector.ph466 ], [ %index.next481, %vector.body476 ]
  %next.gep = getelementptr i8, ptr %cs_next_out.0.i, i64 %index477
  store <16 x i8> %broadcast.splat, ptr %next.gep, align 1, !tbaa !31
  %327 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %broadcast.splat480, ptr %327, align 1, !tbaa !31
  %index.next481 = add nuw i64 %index477, 32
  %328 = icmp eq i64 %index.next481, %n.vec468
  br i1 %328, label %if.end.i69.preheader483, label %vector.body476, !llvm.loop !45

if.end.i69.preheader483:                          ; preds = %vector.body476, %if.end.i69.preheader
  %cs_avail_out.1250.i.ph = phi i32 [ %cs_avail_out.0.i.fr, %if.end.i69.preheader ], [ %ind.end469, %vector.body476 ]
  %cs_next_out.1249.i.ph = phi ptr [ %cs_next_out.0.i, %if.end.i69.preheader ], [ %ind.end471, %vector.body476 ]
  %c_state_out_len.1248.i.ph = phi i32 [ %c_state_out_len.0.i, %if.end.i69.preheader ], [ %ind.end474, %vector.body476 ]
  br label %if.end.i69

if.end.i69:                                       ; preds = %if.end.i69.preheader483, %if.end8.i
  %cs_avail_out.1250.i = phi i32 [ %dec9.i, %if.end8.i ], [ %cs_avail_out.1250.i.ph, %if.end.i69.preheader483 ]
  %cs_next_out.1249.i = phi ptr [ %incdec.ptr.i71, %if.end8.i ], [ %cs_next_out.1249.i.ph, %if.end.i69.preheader483 ]
  %c_state_out_len.1248.i = phi i32 [ %dec.i70, %if.end8.i ], [ %c_state_out_len.1248.i.ph, %if.end.i69.preheader483 ]
...
if.end.i88:                                       ; preds = %if.then30.if.end.i88_crit_edge, %if.then30.thread
  ...
  %346 = phi i32 [ 14, %if.then30.thread ], [ %.ph528, %if.then30.if.end.i88_crit_edge ]
...
if.then27.i:                                      ; preds = %if.end.thread.i
  %call.i = tail call ptr %344(ptr noundef %345, i32 noundef 1800000, i32 noundef 1) #8
  ...
  %call38.i = tail call ptr %347(ptr noundef %348, i32 noundef %shr.i90, i32 noundef 1) #8
...
if.else.i:                                        ; preds = %if.end.thread.i
  %call54.i = tail call ptr %344(ptr noundef %345, i32 noundef 3600000, i32 noundef 1) #8
...
for.body357.preheader.i:                          ; preds = %for.cond.i
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(256) %uglygep.i, i8 0, i64 256, i1 false), !tbaa !31
...
for.cond564.i:                                    ; preds = %while.end632.i, %if.then516.i
  ...
  %695 = phi i32 [ %.ph486, %while.end632.i ], [ %669, %if.then516.i ]
  %696 = phi i32 [ %.ph487, %while.end632.i ], [ %670, %if.then516.i ]
  %697 = phi i32 [ %.ph488, %while.end632.i ], [ %671, %if.then516.i ]
  %698 = phi i32 [ %.ph489, %while.end632.i ], [ %672, %if.then516.i ]
  %699 = phi i32 [ %.ph490, %while.end632.i ], [ %673, %if.then516.i ]
  %700 = phi i32 [ %.ph491, %while.end632.i ], [ %674, %if.then516.i ]
  %701 = phi i32 [ %.ph492, %while.end632.i ], [ %675, %if.then516.i ]
  %702 = phi i32 [ %.ph493, %while.end632.i ], [ %676, %if.then516.i ]
  %703 = phi i32 [ %.ph494, %while.end632.i ], [ %677, %if.then516.i ]
  %704 = phi i32 [ %.ph495, %while.end632.i ], [ %678, %if.then516.i ]
  %705 = phi i32 [ %.ph496, %while.end632.i ], [ %679, %if.then516.i ]
  %706 = phi i32 [ %.ph497, %while.end632.i ], [ %680, %if.then516.i ]
  %707 = phi i32 [ %.ph498, %while.end632.i ], [ %681, %if.then516.i ]
  %708 = phi i32 [ %.ph499, %while.end632.i ], [ %682, %if.then516.i ]
  %709 = phi i32 [ %.ph500, %while.end632.i ], [ %683, %if.then516.i ]
  %710 = phi ptr [ %.ph501, %while.end632.i ], [ %684, %if.then516.i ]
  %711 = phi ptr [ %.ph502, %while.end632.i ], [ %685, %if.then516.i ]
  %712 = phi ptr [ %.ph503, %while.end632.i ], [ %686, %if.then516.i ]
...
sw.bb570.i.preheader:                             ; preds = %if.end.i88, %for.cond564.i
  ...
  %.ph486 = phi i32 [ %695, %for.cond564.i ], [ %.pre3399.i, %if.end.i88 ]
  %.ph487 = phi i32 [ %696, %for.cond564.i ], [ %.pre3400.i, %if.end.i88 ]
  %.ph488 = phi i32 [ %697, %for.cond564.i ], [ %.pre3401.i, %if.end.i88 ]
  %.ph489 = phi i32 [ %698, %for.cond564.i ], [ %.pre3402.i, %if.end.i88 ]
  %.ph490 = phi i32 [ %699, %for.cond564.i ], [ %.pre3403.i, %if.end.i88 ]
  %.ph491 = phi i32 [ %700, %for.cond564.i ], [ %.pre3404.i, %if.end.i88 ]
  %.ph492 = phi i32 [ %701, %for.cond564.i ], [ %.pre3405.i, %if.end.i88 ]
  %.ph493 = phi i32 [ %702, %for.cond564.i ], [ %.pre3406.i, %if.end.i88 ]
  %.ph494 = phi i32 [ %703, %for.cond564.i ], [ %.pre3407.i, %if.end.i88 ]
  %.ph495 = phi i32 [ %704, %for.cond564.i ], [ %.pre3408.i, %if.end.i88 ]
  %.ph496 = phi i32 [ %705, %for.cond564.i ], [ %.pre3409.i, %if.end.i88 ]
  %.ph497 = phi i32 [ %706, %for.cond564.i ], [ %.pre3410.i, %if.end.i88 ]
  %.ph498 = phi i32 [ %707, %for.cond564.i ], [ %.pre3411.i, %if.end.i88 ]
  %.ph499 = phi i32 [ %708, %for.cond564.i ], [ %.pre3412.i, %if.end.i88 ]
  %.ph500 = phi i32 [ %709, %for.cond564.i ], [ %.pre3413.i, %if.end.i88 ]
  %.ph501 = phi ptr [ %710, %for.cond564.i ], [ %.pre3414.i, %if.end.i88 ]
  %.ph502 = phi ptr [ %711, %for.cond564.i ], [ %.pre3415.i, %if.end.i88 ]
  %.ph503 = phi ptr [ %712, %for.cond564.i ], [ %.pre3416.i, %if.end.i88 ]
...
sw.bb570.i:                                       ; preds = %sw.bb570.i.preheader, %if.end626.i
  %bsLive574.promoted.i591 = phi i32 [ %sub581.i, %if.end626.i ], [ %bsLive1264.phi.trans.insert.i.promoted, %sw.bb570.i.preheader ]
  %j.8.i = phi i32 [ %inc627.i, %if.end626.i ], [ %j.8.i.ph, %sw.bb570.i.preheader ]
  store i32 32, ptr %state8, align 8, !tbaa !16
  %cmp5753220.i = icmp sgt i32 %bsLive574.promoted.i591, 0
...
if.then577.i:                                     ; preds = %if.end620.i, %sw.bb570.if.then577_crit_edge.i
  ...
  %.lcssa3020.i = phi i32 [ %bsLive574.promoted.i591, %sw.bb570.if.then577_crit_edge.i ], [ %add602.i, %if.end620.i ]
...
if.end587.i:                                      ; preds = %if.end620.i, %if.end587.lr.ph.i
  ...
  %add60232193221.i = phi i32 [ %bsLive574.promoted.i591, %if.end587.lr.ph.i ], [ %add602.i, %if.end620.i ]
...
for.end638.i:                                     ; preds = %for.cond564.i
  call void @llvm.lifetime.start.p0(i64 6, ptr nonnull %pos.i) #8
  %cmp6423111.i = icmp sgt i32 %nGroups.1.i, 0
  br i1 %cmp6423111.i, label %iter.check429, label %for.cond650.preheader.i

iter.check429:                                    ; preds = %for.end638.i
  %min.iters.check427 = icmp ult i32 %nGroups.1.i, 8
  br i1 %min.iters.check427, label %for.body644.i.preheader, label %vector.scevcheck424

vector.scevcheck424:                              ; preds = %iter.check429
  %722 = add i32 %nGroups.1.i, -1
  %723 = and i32 %722, 255
  %724 = icmp eq i32 %723, 255
  %725 = icmp ugt i32 %722, 255
  %726 = or i1 %724, %725
  br i1 %726, label %for.body644.i.preheader, label %vector.main.loop.iter.check431

vector.main.loop.iter.check431:                   ; preds = %vector.scevcheck424
  %min.iters.check430 = icmp ult i32 %nGroups.1.i, 32
  br i1 %min.iters.check430, label %vec.epilog.ph446, label %vector.ph432

vector.ph432:                                     ; preds = %vector.main.loop.iter.check431
  %n.vec434 = and i32 %nGroups.1.i, -32
  %ind.end441 = trunc i32 %n.vec434 to i8
  ...
  %727 = icmp eq i32 %n.vec434, 32
  br i1 %727, label %middle.block425, label %vector.body436.1, !llvm.loop !82

vector.body436.1:                                 ; preds = %vector.ph432
  ...
  %728 = icmp eq i32 %n.vec434, 64
  br i1 %728, label %middle.block425, label %vector.body436.2, !llvm.loop !82

vector.body436.2:                                 ; preds = %vector.body436.1
  ...
  %729 = icmp eq i32 %n.vec434, 96
  br i1 %729, label %middle.block425, label %vector.body436.3, !llvm.loop !82

vector.body436.3:                                 ; preds = %vector.body436.2
  ...
  %730 = icmp eq i32 %n.vec434, 128
  br i1 %730, label %middle.block425, label %vector.body436.4, !llvm.loop !82

vector.body436.4:                                 ; preds = %vector.body436.3
  ...
  %731 = icmp eq i32 %n.vec434, 160
  br i1 %731, label %middle.block425, label %vector.body436.5, !llvm.loop !82

vector.body436.5:                                 ; preds = %vector.body436.4
  ...
  %732 = icmp eq i32 %n.vec434, 192
  br i1 %732, label %middle.block425, label %vector.body436.6, !llvm.loop !82

vector.body436.6:                                 ; preds = %vector.body436.5
  ...
  %733 = icmp eq i32 %n.vec434, 224
  br i1 %733, label %middle.block425, label %vector.body436.7, !llvm.loop !82

vector.body436.7:                                 ; preds = %vector.body436.6
  ...
  br label %middle.block425

middle.block425:                                  ; preds = %vector.body436.7, %vector.body436.6, %vector.body436.5, %vector.body436.4, %vector.body436.3, %vector.body436.2, %vector.body436.1, %vector.ph432
  %cmp.n435 = icmp eq i32 %nGroups.1.i, %n.vec434
  br i1 %cmp.n435, label %for.cond650.preheader.i, label %vec.epilog.iter.check445

vec.epilog.iter.check445:                         ; preds = %middle.block425
  %ind.end453 = trunc i32 %n.vec434 to i8
  %n.vec.remaining447 = and i32 %nGroups.1.i, 24
  %min.epilog.iters.check448 = icmp eq i32 %n.vec.remaining447, 0
  br i1 %min.epilog.iters.check448, label %for.body644.i.preheader, label %vec.epilog.ph446

vec.epilog.ph446:                                 ; preds = %vector.main.loop.iter.check431, %vec.epilog.iter.check445
  %bc.resume.val442 = phi i8 [ %ind.end441, %vec.epilog.iter.check445 ], [ 0, %vector.main.loop.iter.check431 ]
  %vec.epilog.resume.val449 = phi i32 [ %n.vec434, %vec.epilog.iter.check445 ], [ 0, %vector.main.loop.iter.check431 ]
  %n.vec451 = and i32 %nGroups.1.i, -8
  %ind.end452 = trunc i32 %n.vec451 to i8
  %.splatinsert = insertelement <8 x i8> poison, i8 %bc.resume.val442, i64 0
...
vec.epilog.vector.body456:                        ; preds = %vec.epilog.vector.body456, %vec.epilog.ph446
  %index457 = phi i32 [ %vec.epilog.resume.val449, %vec.epilog.ph446 ], [ %index.next462, %vec.epilog.vector.body456 ]
  %vec.ind458 = phi <8 x i8> [ %induction, %vec.epilog.ph446 ], [ %vec.ind.next460, %vec.epilog.vector.body456 ]
  %734 = and i32 %index457, 248
  %735 = zext i32 %734 to i64
  %736 = getelementptr inbounds [6 x i8], ptr %pos.i, i64 0, i64 %735
  store <8 x i8> %vec.ind458, ptr %736, align 8, !tbaa !31
  %index.next462 = add nuw i32 %index457, 8
  %vec.ind.next460 = add <8 x i8> %vec.ind458, <i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8, i8 8>
  %737 = icmp eq i32 %index.next462, %n.vec451
  br i1 %737, label %vec.epilog.middle.block443, label %vec.epilog.vector.body456, !llvm.loop !83

vec.epilog.middle.block443:                       ; preds = %vec.epilog.vector.body456
  %cmp.n455 = icmp eq i32 %nGroups.1.i, %n.vec451
  br i1 %cmp.n455, label %for.cond650.preheader.i, label %for.body644.i.preheader

for.body644.i.preheader:                          ; preds = %vector.scevcheck424, %iter.check429, %vec.epilog.iter.check445, %vec.epilog.middle.block443
  %v639.03112.i.ph = phi i8 [ 0, %iter.check429 ], [ 0, %vector.scevcheck424 ], [ %ind.end453, %vec.epilog.iter.check445 ], [ %ind.end452, %vec.epilog.middle.block443 ]
  br label %for.body644.i

for.cond650.preheader.i:                          ; preds = %for.body644.i, %middle.block425, %vec.epilog.middle.block443, %for.end638.i
...
for.body653.i:                                    ; preds = %while.end671.i, %for.body653.preheader.i
  ...
  br i1 %cmp661.not3113.i, label %while.end671.i, label %iter.check390

iter.check390:                                    ; preds = %for.body653.i
  %740 = zext i8 %738 to i64
  %min.iters.check388 = icmp ult i8 %738, 8
  br i1 %min.iters.check388, label %while.body663.i.preheader, label %vector.scevcheck371

vector.scevcheck371:                              ; preds = %iter.check390
  %741 = add i8 %738, -1
  %742 = zext i8 %738 to i32
  %743 = add nsw i32 %742, -1
  %744 = zext i8 %741 to i32
  %745 = icmp ult i32 %743, %744
  %uglygep375 = getelementptr i8, ptr %pos.i, i64 %idxprom657.i
  %746 = zext i8 %741 to i64
  %747 = sub nsw i64 0, %746
  %748 = getelementptr i8, ptr %uglygep375, i64 %747
  %749 = icmp ugt ptr %748, %uglygep375
  %750 = zext i32 %743 to i64
  %uglygep379 = getelementptr i8, ptr %pos.i, i64 %750
  %751 = zext i8 %741 to i64
  %752 = sub nsw i64 0, %751
  %753 = getelementptr i8, ptr %uglygep379, i64 %752
  %754 = icmp ugt ptr %753, %uglygep379
  %755 = or i1 %745, %749
  %756 = or i1 %755, %754
  br i1 %756, label %while.body663.i.preheader, label %vector.memcheck383

vector.memcheck383:                               ; preds = %vector.scevcheck371
  %757 = zext i8 %738 to i64
  %758 = add nuw nsw i64 %757, 4294967295
  %759 = and i64 %758, 4294967295
  %760 = add i64 %759, %pos.i384
  %761 = add i64 %pos.i384, %idxprom657.i
  %762 = sub i64 %760, %761
  %diff.check385 = icmp ult i64 %762, 16
  br i1 %diff.check385, label %while.body663.i.preheader, label %vector.main.loop.iter.check392

vector.main.loop.iter.check392:                   ; preds = %vector.memcheck383
  %min.iters.check391 = icmp ult i8 %738, 16
  br i1 %min.iters.check391, label %vec.epilog.ph407, label %vector.ph393

vector.ph393:                                     ; preds = %vector.main.loop.iter.check392
  %n.vec395 = and i64 %740, 240
  br label %vector.body397

vector.body397:                                   ; preds = %vector.body397, %vector.ph393
  %index398 = phi i64 [ 0, %vector.ph393 ], [ %index.next403, %vector.body397 ]
  %offset.idx399 = sub i64 %idxprom657.i, %index398
  %763 = add nuw nsw i64 %offset.idx399, 4294967295
  %764 = and i64 %763, 4294967295
  %765 = getelementptr inbounds [6 x i8], ptr %pos.i, i64 0, i64 %764
  %766 = getelementptr inbounds i8, ptr %765, i64 -15
  %wide.load400 = load <16 x i8>, ptr %766, align 1, !tbaa !31
  %767 = getelementptr inbounds [6 x i8], ptr %pos.i, i64 0, i64 %offset.idx399
  %768 = getelementptr inbounds i8, ptr %767, i64 -15
  store <16 x i8> %wide.load400, ptr %768, align 1, !tbaa !31
  %index.next403 = add nuw i64 %index398, 16
  %769 = icmp eq i64 %index.next403, %n.vec395
  br i1 %769, label %middle.block386, label %vector.body397, !llvm.loop !85

middle.block386:                                  ; preds = %vector.body397
  %cmp.n396 = icmp eq i64 %n.vec395, %740
  br i1 %cmp.n396, label %while.end671.i, label %vec.epilog.iter.check406

vec.epilog.iter.check406:                         ; preds = %middle.block386
  %ind.end414 = sub nsw i64 %idxprom657.i, %n.vec395
  %n.vec.remaining408 = and i64 %740, 8
  %min.epilog.iters.check409.not.not = icmp eq i64 %n.vec.remaining408, 0
  br i1 %min.epilog.iters.check409.not.not, label %while.body663.i.preheader, label %vec.epilog.ph407

vec.epilog.ph407:                                 ; preds = %vector.main.loop.iter.check392, %vec.epilog.iter.check406
  %vec.epilog.resume.val410 = phi i64 [ %n.vec395, %vec.epilog.iter.check406 ], [ 0, %vector.main.loop.iter.check392 ]
  %n.vec412 = and i64 %740, 248
  %ind.end413 = sub nsw i64 %idxprom657.i, %n.vec412
  br label %vec.epilog.vector.body417

vec.epilog.vector.body417:                        ; preds = %vec.epilog.vector.body417, %vec.epilog.ph407
  %index418 = phi i64 [ %vec.epilog.resume.val410, %vec.epilog.ph407 ], [ %index.next423, %vec.epilog.vector.body417 ]
  %offset.idx419 = sub i64 %idxprom657.i, %index418
  %770 = add nuw nsw i64 %offset.idx419, 4294967295
  %771 = and i64 %770, 4294967295
  %772 = getelementptr inbounds [6 x i8], ptr %pos.i, i64 0, i64 %771
  %773 = getelementptr inbounds i8, ptr %772, i64 -7
  %wide.load420 = load <8 x i8>, ptr %773, align 1, !tbaa !31
  %774 = getelementptr inbounds [6 x i8], ptr %pos.i, i64 0, i64 %offset.idx419
  %775 = getelementptr inbounds i8, ptr %774, i64 -7
  store <8 x i8> %wide.load420, ptr %775, align 1, !tbaa !31
  %index.next423 = add nuw i64 %index418, 8
  %776 = icmp eq i64 %index.next423, %n.vec412
  br i1 %776, label %vec.epilog.middle.block404, label %vec.epilog.vector.body417, !llvm.loop !86

vec.epilog.middle.block404:                       ; preds = %vec.epilog.vector.body417
  %cmp.n416 = icmp eq i64 %n.vec412, %740
  br i1 %cmp.n416, label %while.end671.i, label %while.body663.i.preheader

while.body663.i.preheader:                        ; preds = %vector.memcheck383, %vector.scevcheck371, %iter.check390, %vec.epilog.iter.check406, %vec.epilog.middle.block404
  %indvars.iv.i.ph = phi i64 [ %idxprom657.i, %iter.check390 ], [ %idxprom657.i, %vector.memcheck383 ], [ %idxprom657.i, %vector.scevcheck371 ], [ %ind.end414, %vec.epilog.iter.check406 ], [ %ind.end413, %vec.epilog.middle.block404 ]
  %777 = trunc i64 %indvars.iv.i.ph to i8
  %xtraiter = and i8 %777, 1
...
while.body663.i.prol:                             ; preds = %while.body663.i.preheader
  ...
  %778 = load i8, ptr %arrayidx667.i.prol, align 1, !tbaa !31
  %arrayidx669.i.prol = getelementptr inbounds [6 x i8], ptr %pos.i, i64 0, i64 %indvars.iv.i.ph
  store i8 %778, ptr %arrayidx669.i.prol, align 1, !tbaa !31
...
while.body663.i.prol.loopexit:                    ; preds = %while.body663.i.prol, %while.body663.i.preheader
  ...
  %779 = icmp eq i8 %777, 1
  br i1 %779, label %while.end671.i, label %while.body663.i
...
while.body663.i:                                  ; preds = %while.body663.i.prol.loopexit, %while.body663.i
  ...
  %780 = load i8, ptr %arrayidx667.i, align 1, !tbaa !31
  %arrayidx669.i = getelementptr inbounds [6 x i8], ptr %pos.i, i64 0, i64 %indvars.iv.i
  store i8 %780, ptr %arrayidx669.i, align 1, !tbaa !31
  ...
  %781 = load i8, ptr %arrayidx667.i.1, align 1, !tbaa !31
  %arrayidx669.i.1 = getelementptr inbounds [6 x i8], ptr %pos.i, i64 0, i64 %indvars.iv.next.i
  store i8 %781, ptr %arrayidx669.i.1, align 1, !tbaa !31
  %indvars.iv.next.i.1 = add nsw i64 %indvars.iv.i, -2
  %782 = and i64 %indvars.iv.next.i.1, 255
  %cmp661.not.i.1 = icmp eq i64 %782, 0
  br i1 %cmp661.not.i.1, label %while.end671.i, label %while.body663.i, !llvm.loop !87

while.end671.i:                                   ; preds = %while.body663.i.prol.loopexit, %while.body663.i, %middle.block386, %vec.epilog.middle.block404, %for.body653.i
...
for.end677.i:                                     ; preds = %while.end671.i, %for.cond650.preheader.i
  ...
  call void @llvm.lifetime.end.p0(i64 6, ptr nonnull %pos.i) #8
  br label %for.cond678.i

for.cond678.i:                                    ; preds = %for.inc872.i, %for.end677.i
  %783 = phi i32 [ %827, %for.inc872.i ], [ %695, %for.end677.i ]
  %784 = phi i32 [ %828, %for.inc872.i ], [ %696, %for.end677.i ]
  %785 = phi i32 [ %829, %for.inc872.i ], [ %697, %for.end677.i ]
  %786 = phi i32 [ %830, %for.inc872.i ], [ %698, %for.end677.i ]
  %787 = phi i32 [ %831, %for.inc872.i ], [ %699, %for.end677.i ]
  %788 = phi i32 [ %832, %for.inc872.i ], [ %700, %for.end677.i ]
  %789 = phi i32 [ %833, %for.inc872.i ], [ %701, %for.end677.i ]
  %790 = phi i32 [ %834, %for.inc872.i ], [ %702, %for.end677.i ]
  %791 = phi i32 [ %835, %for.inc872.i ], [ %704, %for.end677.i ]
  %792 = phi i32 [ %836, %for.inc872.i ], [ %705, %for.end677.i ]
  %793 = phi i32 [ %837, %for.inc872.i ], [ %706, %for.end677.i ]
  %794 = phi i32 [ %838, %for.inc872.i ], [ %707, %for.end677.i ]
  %795 = phi i32 [ %839, %for.inc872.i ], [ %708, %for.end677.i ]
  %796 = phi i32 [ %840, %for.inc872.i ], [ %709, %for.end677.i ]
  %797 = phi ptr [ %841, %for.inc872.i ], [ %710, %for.end677.i ]
  %798 = phi ptr [ %842, %for.inc872.i ], [ %711, %for.end677.i ]
  %799 = phi ptr [ %843, %for.inc872.i ], [ %712, %for.end677.i ]
...
for.cond879.preheader.lr.ph.i:                    ; preds = %for.cond875.preheader.i
  ...
  %800 = add nsw i64 %wide.trip.count.i.i, -1
  %min.iters.check354 = icmp ult i32 %alphaSize.5.i, 8
  %n.vec357 = and i64 %wide.trip.count.i.i, 4294967288
  %cmp.n359 = icmp eq i64 %n.vec357, %wide.trip.count.i.i
  %xtraiter552 = and i64 %wide.trip.count.i.i, 1
  %801 = icmp eq i64 %800, 0
  %unroll_iter = and i64 %wide.trip.count.i.i, 4294967294
  %lcmp.mod553.not = icmp eq i64 %xtraiter552, 0
  %xtraiter555 = and i64 %wide.trip.count.i.i, 1
  %802 = icmp eq i64 %800, 0
  %unroll_iter557 = and i64 %wide.trip.count.i.i, 4294967294
  %lcmp.mod556.not = icmp eq i64 %xtraiter555, 0
  br label %for.cond879.preheader.i

sw.bb682.i:                                       ; preds = %for.cond678.i, %if.end.i88
  %803 = phi i32 [ %783, %for.cond678.i ], [ %.pre3399.i, %if.end.i88 ]
  %804 = phi i32 [ %784, %for.cond678.i ], [ %.pre3400.i, %if.end.i88 ]
  %805 = phi i32 [ %785, %for.cond678.i ], [ %.pre3401.i, %if.end.i88 ]
  %806 = phi i32 [ %786, %for.cond678.i ], [ %.pre3402.i, %if.end.i88 ]
  %807 = phi i32 [ %787, %for.cond678.i ], [ %.pre3403.i, %if.end.i88 ]
  %808 = phi i32 [ %788, %for.cond678.i ], [ %.pre3404.i, %if.end.i88 ]
  %809 = phi i32 [ %789, %for.cond678.i ], [ %.pre3405.i, %if.end.i88 ]
  %810 = phi i32 [ %790, %for.cond678.i ], [ %.pre3406.i, %if.end.i88 ]
  %811 = phi i32 [ %791, %for.cond678.i ], [ %.pre3408.i, %if.end.i88 ]
  %812 = phi i32 [ %792, %for.cond678.i ], [ %.pre3409.i, %if.end.i88 ]
  %813 = phi i32 [ %793, %for.cond678.i ], [ %.pre3410.i, %if.end.i88 ]
  %814 = phi i32 [ %794, %for.cond678.i ], [ %.pre3411.i, %if.end.i88 ]
  %815 = phi i32 [ %795, %for.cond678.i ], [ %.pre3412.i, %if.end.i88 ]
  %816 = phi i32 [ %796, %for.cond678.i ], [ %.pre3413.i, %if.end.i88 ]
  %817 = phi ptr [ %797, %for.cond678.i ], [ %.pre3414.i, %if.end.i88 ]
  %818 = phi ptr [ %798, %for.cond678.i ], [ %.pre3415.i, %if.end.i88 ]
  %819 = phi ptr [ %799, %for.cond678.i ], [ %.pre3416.i, %if.end.i88 ]
...
if.end698.lr.ph.i:                                ; preds = %sw.bb682.i
  %820 = load ptr, ptr %0, align 8, !tbaa !13
  %avail_in700.i = getelementptr inbounds %struct.nsis_bzstream, ptr %820, i64 0, i32 1
  %total_in_lo32721.i = getelementptr inbounds %struct.nsis_bzstream, ptr %820, i64 0, i32 2
  %total_in_hi32729.i = getelementptr inbounds %struct.nsis_bzstream, ptr %820, i64 0, i32 3
...
if.then689.i:                                     ; preds = %if.end731.i, %sw.bb682.if.then689_crit_edge.i
  %821 = phi i32 [ %.pre3444.i, %sw.bb682.if.then689_crit_edge.i ], [ %or710.i, %if.end731.i ]
  ...
  %shr694.i = lshr i32 %821, %sub693.i
...
if.end704.i:                                      ; preds = %if.end698.i
  %822 = load i32, ptr %bsBuff77.i, align 8, !tbaa !18
  %shl706.i = shl i32 %822, 8
  %823 = load ptr, ptr %820, align 8, !tbaa !74
  %824 = load i8, ptr %823, align 1, !tbaa !31
  %conv709.i = zext i8 %824 to i32
  ...
  %incdec.ptr716.i = getelementptr inbounds i8, ptr %823, i64 1
  store ptr %incdec.ptr716.i, ptr %820, align 8, !tbaa !74
  %dec719.i = add i32 %dec7193206.i, -1
  store i32 %dec719.i, ptr %avail_in700.i, align 8, !tbaa !73
  %825 = load i32, ptr %total_in_lo32721.i, align 4, !tbaa !20
  %inc722.i = add i32 %825, 1
...
if.then727.i:                                     ; preds = %if.end704.i
  %826 = load i32, ptr %total_in_hi32729.i, align 8, !tbaa !21
  %inc730.i = add i32 %826, 1
...
for.cond733.i:                                    ; preds = %while.end863.i, %if.then689.i
  ...
  %832 = phi i32 [ %867, %while.end863.i ], [ %808, %if.then689.i ]
  %833 = phi i32 [ %868, %while.end863.i ], [ %809, %if.then689.i ]
  %834 = phi i32 [ %869, %while.end863.i ], [ %810, %if.then689.i ]
  %835 = phi i32 [ %870, %while.end863.i ], [ %811, %if.then689.i ]
  %836 = phi i32 [ %871, %while.end863.i ], [ %812, %if.then689.i ]
  %837 = phi i32 [ %872, %while.end863.i ], [ %813, %if.then689.i ]
  %838 = phi i32 [ %873, %while.end863.i ], [ %814, %if.then689.i ]
  %839 = phi i32 [ %874, %while.end863.i ], [ %815, %if.then689.i ]
  %840 = phi i32 [ %875, %while.end863.i ], [ %816, %if.then689.i ]
  %841 = phi ptr [ %876, %while.end863.i ], [ %817, %if.then689.i ]
  %842 = phi ptr [ %877, %while.end863.i ], [ %818, %if.then689.i ]
  %843 = phi ptr [ %878, %while.end863.i ], [ %819, %if.then689.i ]
...
while.cond737.i:                                  ; preds = %if.then810.i, %for.cond733.i
  ...
  %849 = phi i32 [ %893, %if.then810.i ], [ %832, %for.cond733.i ]
  %850 = phi i32 [ %894, %if.then810.i ], [ %833, %for.cond733.i ]
  %851 = phi i32 [ %895, %if.then810.i ], [ %834, %for.cond733.i ]
  %852 = phi i32 [ %896, %if.then810.i ], [ %835, %for.cond733.i ]
  %853 = phi i32 [ %897, %if.then810.i ], [ %836, %for.cond733.i ]
  %854 = phi i32 [ %898, %if.then810.i ], [ %837, %for.cond733.i ]
  %855 = phi i32 [ %899, %if.then810.i ], [ %838, %for.cond733.i ]
  %856 = phi i32 [ %900, %if.then810.i ], [ %839, %for.cond733.i ]
  %857 = phi i32 [ %901, %if.then810.i ], [ %840, %for.cond733.i ]
  %858 = phi ptr [ %902, %if.then810.i ], [ %841, %for.cond733.i ]
  %859 = phi ptr [ %903, %if.then810.i ], [ %842, %for.cond733.i ]
  %860 = phi ptr [ %904, %if.then810.i ], [ %843, %for.cond733.i ]
  ...
  %861 = add i32 %curr.3.i, -21
  %or.cond2101.i = icmp ult i32 %861, -20
  br i1 %or.cond2101.i, label %BZ2_decompress.exit, label %sw.bb746.i

sw.bb746.i:                                       ; preds = %while.cond737.i, %if.end.i88
  %862 = phi i32 [ %844, %while.cond737.i ], [ %.pre3399.i, %if.end.i88 ]
  %863 = phi i32 [ %845, %while.cond737.i ], [ %.pre3400.i, %if.end.i88 ]
  %864 = phi i32 [ %846, %while.cond737.i ], [ %.pre3401.i, %if.end.i88 ]
  %865 = phi i32 [ %847, %while.cond737.i ], [ %.pre3402.i, %if.end.i88 ]
  %866 = phi i32 [ %848, %while.cond737.i ], [ %.pre3403.i, %if.end.i88 ]
  %867 = phi i32 [ %849, %while.cond737.i ], [ %.pre3404.i, %if.end.i88 ]
  %868 = phi i32 [ %850, %while.cond737.i ], [ %.pre3405.i, %if.end.i88 ]
  %869 = phi i32 [ %851, %while.cond737.i ], [ %.pre3406.i, %if.end.i88 ]
  %870 = phi i32 [ %852, %while.cond737.i ], [ %.pre3408.i, %if.end.i88 ]
  %871 = phi i32 [ %853, %while.cond737.i ], [ %.pre3409.i, %if.end.i88 ]
  %872 = phi i32 [ %854, %while.cond737.i ], [ %.pre3410.i, %if.end.i88 ]
  %873 = phi i32 [ %855, %while.cond737.i ], [ %.pre3411.i, %if.end.i88 ]
  %874 = phi i32 [ %856, %while.cond737.i ], [ %.pre3412.i, %if.end.i88 ]
  %875 = phi i32 [ %857, %while.cond737.i ], [ %.pre3413.i, %if.end.i88 ]
  %876 = phi ptr [ %858, %while.cond737.i ], [ %.pre3414.i, %if.end.i88 ]
  %877 = phi ptr [ %859, %while.cond737.i ], [ %.pre3415.i, %if.end.i88 ]
  %878 = phi ptr [ %860, %while.cond737.i ], [ %.pre3416.i, %if.end.i88 ]
...
if.end763.lr.ph.i:                                ; preds = %sw.bb746.i
  ...
  %avail_in765.i = getelementptr inbounds %struct.nsis_bzstream, ptr %879, i64 0, i32 1
  %total_in_lo32786.i = getelementptr inbounds %struct.nsis_bzstream, ptr %879, i64 0, i32 2
  %total_in_hi32794.i = getelementptr inbounds %struct.nsis_bzstream, ptr %879, i64 0, i32 3
...
if.then753.i:                                     ; preds = %if.end796.i, %sw.bb746.if.then753_crit_edge.i
  %880 = phi i32 [ %.pre3445.i, %sw.bb746.if.then753_crit_edge.i ], [ %or775.i, %if.end796.i ]
  ...
  %881 = shl nuw i32 1, %sub757.i
  %882 = and i32 %881, %880
  %cmp799.i = icmp eq i32 %882, 0
...
if.end769.i:                                      ; preds = %if.end763.i
  %883 = load i32, ptr %bsBuff77.i, align 8, !tbaa !18
  %shl771.i = shl i32 %883, 8
  %884 = load ptr, ptr %879, align 8, !tbaa !74
  %885 = load i8, ptr %884, align 1, !tbaa !31
  %conv774.i = zext i8 %885 to i32
  ...
  %incdec.ptr781.i = getelementptr inbounds i8, ptr %884, i64 1
  store ptr %incdec.ptr781.i, ptr %879, align 8, !tbaa !74
  %dec784.i = add i32 %dec7843212.i, -1
  store i32 %dec784.i, ptr %avail_in765.i, align 8, !tbaa !73
  %886 = load i32, ptr %total_in_lo32786.i, align 4, !tbaa !20
  %inc787.i = add i32 %886, 1
...
if.then792.i:                                     ; preds = %if.end769.i
  %887 = load i32, ptr %total_in_hi32794.i, align 8, !tbaa !21
  %inc795.i = add i32 %887, 1
...
sw.bb803.i:                                       ; preds = %if.then753.i, %if.end.sw.bb803_crit_edge.i
  %888 = phi i32 [ %.pre3399.i, %if.end.sw.bb803_crit_edge.i ], [ %862, %if.then753.i ]
  %889 = phi i32 [ %.pre3400.i, %if.end.sw.bb803_crit_edge.i ], [ %863, %if.then753.i ]
  %890 = phi i32 [ %.pre3401.i, %if.end.sw.bb803_crit_edge.i ], [ %864, %if.then753.i ]
  %891 = phi i32 [ %.pre3402.i, %if.end.sw.bb803_crit_edge.i ], [ %865, %if.then753.i ]
  %892 = phi i32 [ %.pre3403.i, %if.end.sw.bb803_crit_edge.i ], [ %866, %if.then753.i ]
  %893 = phi i32 [ %.pre3404.i, %if.end.sw.bb803_crit_edge.i ], [ %867, %if.then753.i ]
  %894 = phi i32 [ %.pre3405.i, %if.end.sw.bb803_crit_edge.i ], [ %868, %if.then753.i ]
  %895 = phi i32 [ %.pre3406.i, %if.end.sw.bb803_crit_edge.i ], [ %869, %if.then753.i ]
  %896 = phi i32 [ %.pre3408.i, %if.end.sw.bb803_crit_edge.i ], [ %870, %if.then753.i ]
  %897 = phi i32 [ %.pre3409.i, %if.end.sw.bb803_crit_edge.i ], [ %871, %if.then753.i ]
  %898 = phi i32 [ %.pre3410.i, %if.end.sw.bb803_crit_edge.i ], [ %872, %if.then753.i ]
  %899 = phi i32 [ %.pre3411.i, %if.end.sw.bb803_crit_edge.i ], [ %873, %if.then753.i ]
  %900 = phi i32 [ %.pre3412.i, %if.end.sw.bb803_crit_edge.i ], [ %874, %if.then753.i ]
  %901 = phi i32 [ %.pre3413.i, %if.end.sw.bb803_crit_edge.i ], [ %875, %if.then753.i ]
  %902 = phi ptr [ %.pre3414.i, %if.end.sw.bb803_crit_edge.i ], [ %876, %if.then753.i ]
  %903 = phi ptr [ %.pre3415.i, %if.end.sw.bb803_crit_edge.i ], [ %877, %if.then753.i ]
  %904 = phi ptr [ %.pre3416.i, %if.end.sw.bb803_crit_edge.i ], [ %878, %if.then753.i ]
...
if.end820.lr.ph.i:                                ; preds = %sw.bb803.i
  %905 = load ptr, ptr %0, align 8, !tbaa !13
  %avail_in822.i = getelementptr inbounds %struct.nsis_bzstream, ptr %905, i64 0, i32 1
  %total_in_lo32843.i = getelementptr inbounds %struct.nsis_bzstream, ptr %905, i64 0, i32 2
  %total_in_hi32851.i = getelementptr inbounds %struct.nsis_bzstream, ptr %905, i64 0, i32 3
...
if.then810.i:                                     ; preds = %if.end853.i, %sw.bb803.if.then810_crit_edge.i
  %906 = phi i32 [ %.pre3447.i, %sw.bb803.if.then810_crit_edge.i ], [ %or832.i, %if.end853.i ]
  ...
  %907 = shl nuw i32 1, %sub814.i
  %908 = and i32 %907, %906
  %cmp856.i = icmp eq i32 %908, 0
...
if.end826.i:                                      ; preds = %if.end820.i
  %909 = load i32, ptr %bsBuff77.i, align 8, !tbaa !18
  %shl828.i = shl i32 %909, 8
  %910 = load ptr, ptr %905, align 8, !tbaa !74
  %911 = load i8, ptr %910, align 1, !tbaa !31
  %conv831.i = zext i8 %911 to i32
  ...
  %incdec.ptr838.i = getelementptr inbounds i8, ptr %910, i64 1
  store ptr %incdec.ptr838.i, ptr %905, align 8, !tbaa !74
  %dec841.i = add i32 %dec8413218.i, -1
  store i32 %dec841.i, ptr %avail_in822.i, align 8, !tbaa !73
  %912 = load i32, ptr %total_in_lo32843.i, align 4, !tbaa !20
  %inc844.i = add i32 %912, 1
...
if.then849.i:                                     ; preds = %if.end826.i
  %913 = load i32, ptr %total_in_hi32851.i, align 8, !tbaa !21
  %inc852.i = add i32 %913, 1
...
for.body882.i.preheader:                          ; preds = %for.cond879.preheader.i
  br i1 %min.iters.check354, label %for.body882.i.preheader482, label %vector.body360

vector.body360:                                   ; preds = %for.body882.i.preheader, %vector.body360
  %index361 = phi i64 [ %index.next367, %vector.body360 ], [ 0, %for.body882.i.preheader ]
  %vec.phi = phi <4 x i32> [ %920, %vector.body360 ], [ <i32 32, i32 32, i32 32, i32 32>, %for.body882.i.preheader ]
  %vec.phi362 = phi <4 x i32> [ %921, %vector.body360 ], [ <i32 32, i32 32, i32 32, i32 32>, %for.body882.i.preheader ]
  %vec.phi363 = phi <4 x i32> [ %918, %vector.body360 ], [ zeroinitializer, %for.body882.i.preheader ]
  %vec.phi364 = phi <4 x i32> [ %919, %vector.body360 ], [ zeroinitializer, %for.body882.i.preheader ]
  %914 = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 35, i64 %indvars.iv3277.i, i64 %index361
  %wide.load365 = load <4 x i8>, ptr %914, align 1, !tbaa !31
  %915 = getelementptr inbounds i8, ptr %914, i64 4
  %wide.load366 = load <4 x i8>, ptr %915, align 1, !tbaa !31
  %916 = zext <4 x i8> %wide.load365 to <4 x i32>
  %917 = zext <4 x i8> %wide.load366 to <4 x i32>
  %918 = call <4 x i32> @llvm.smax.v4i32(<4 x i32> %vec.phi363, <4 x i32> %916)
  %919 = call <4 x i32> @llvm.smax.v4i32(<4 x i32> %vec.phi364, <4 x i32> %917)
  %920 = call <4 x i32> @llvm.smin.v4i32(<4 x i32> %vec.phi, <4 x i32> %916)
  %921 = call <4 x i32> @llvm.smin.v4i32(<4 x i32> %vec.phi362, <4 x i32> %917)
  %index.next367 = add nuw i64 %index361, 8
  %922 = icmp eq i64 %index.next367, %n.vec357
  br i1 %922, label %middle.block352, label %vector.body360, !llvm.loop !91

middle.block352:                                  ; preds = %vector.body360
  %rdx.minmax.select369 = call <4 x i32> @llvm.umax.v4i32(<4 x i32> %918, <4 x i32> %919)
  %923 = call i32 @llvm.vector.reduce.smax.v4i32(<4 x i32> %rdx.minmax.select369)
  %rdx.minmax.select = call <4 x i32> @llvm.smin.v4i32(<4 x i32> %920, <4 x i32> %921)
  %924 = call i32 @llvm.vector.reduce.smin.v4i32(<4 x i32> %rdx.minmax.select)
  br i1 %cmp.n359, label %for.cond1.preheader.us.i.i.preheader, label %for.body882.i.preheader482

for.body882.i.preheader482:                       ; preds = %for.body882.i.preheader, %middle.block352
  %indvars.iv3271.i.ph = phi i64 [ 0, %for.body882.i.preheader ], [ %n.vec357, %middle.block352 ]
  %minLen.03121.i.ph = phi i32 [ 32, %for.body882.i.preheader ], [ %924, %middle.block352 ]
  %maxLen.03120.i.ph = phi i32 [ 0, %for.body882.i.preheader ], [ %923, %middle.block352 ]
...
for.body882.i:                                    ; preds = %for.body882.i.preheader482, %for.body882.i
  %indvars.iv3271.i = phi i64 [ %indvars.iv.next3272.i, %for.body882.i ], [ %indvars.iv3271.i.ph, %for.body882.i.preheader482 ]
  %minLen.03121.i = phi i32 [ %minLen.1.i, %for.body882.i ], [ %minLen.03121.i.ph, %for.body882.i.preheader482 ]
  %maxLen.03120.i = phi i32 [ %spec.select.i, %for.body882.i ], [ %maxLen.03120.i.ph, %for.body882.i.preheader482 ]
  %arrayidx887.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 35, i64 %indvars.iv3277.i, i64 %indvars.iv3271.i
  %925 = load i8, ptr %arrayidx887.i, align 1, !tbaa !31
  %conv888.i = zext i8 %925 to i32
...
for.cond1.preheader.us.i.i.preheader:             ; preds = %for.body882.i, %middle.block352
  %spec.select.i.lcssa = phi i32 [ %923, %middle.block352 ], [ %spec.select.i, %for.body882.i ]
  %minLen.1.i.lcssa = phi i32 [ %924, %middle.block352 ], [ %minLen.1.i, %for.body882.i ]
...
for.cond1.preheader.us.i.i:                       ; preds = %for.cond1.preheader.us.i.i.preheader, %for.cond1.for.inc9_crit_edge.us.i.i
  ...
  br i1 %801, label %for.cond1.for.inc9_crit_edge.us.i.i.unr-lcssa, label %for.body3.us.i.i
...
for.body3.us.i.i:                                 ; preds = %for.cond1.preheader.us.i.i, %for.inc.us.i.i.1
  ...
  %926 = load i8, ptr %arrayidx.us.i.i, align 1, !tbaa !31
  %conv.us.i.i = zext i8 %926 to i32
...
if.then.us.i.i:                                   ; preds = %for.body3.us.i.i
  ...
  %927 = trunc i64 %indvars.iv.i2989.i to i32
  store i32 %927, ptr %arrayidx7.us.i.i, align 4, !tbaa !36
...
for.inc.us.i.i:                                   ; preds = %if.then.us.i.i, %for.body3.us.i.i
  ...
  %928 = load i8, ptr %arrayidx.us.i.i.1, align 1, !tbaa !31
  %conv.us.i.i.1 = zext i8 %928 to i32
...
if.then.us.i.i.1:                                 ; preds = %for.inc.us.i.i
  ...
  %929 = trunc i64 %indvars.iv.next.i2990.i to i32
  store i32 %929, ptr %arrayidx7.us.i.i.1, align 4, !tbaa !36
...
for.cond1.for.inc9_crit_edge.us.i.i.unr-lcssa:    ; preds = %for.inc.us.i.i.1, %for.cond1.preheader.us.i.i
  ...
  br i1 %lcmp.mod553.not, label %for.cond1.for.inc9_crit_edge.us.i.i, label %for.body3.us.i.i.epil
...
for.body3.us.i.i.epil:                            ; preds = %for.cond1.for.inc9_crit_edge.us.i.i.unr-lcssa
  ...
  %930 = load i8, ptr %arrayidx.us.i.i.epil, align 1, !tbaa !31
  %conv.us.i.i.epil = zext i8 %930 to i32
...
if.then.us.i.i.epil:                              ; preds = %for.body3.us.i.i.epil
  ...
  %931 = trunc i64 %indvars.iv.i2989.i.unr to i32
  store i32 %931, ptr %arrayidx7.us.i.i.epil, align 4, !tbaa !36
...
for.body24.i.i.preheader:                         ; preds = %for.cond1.for.inc9_crit_edge.us.i.i
  ...
  br i1 %802, label %for.cond34.preheader.loopexit.i.i.unr-lcssa, label %for.body24.i.i
...
for.cond34.preheader.loopexit.i.i.unr-lcssa:      ; preds = %for.body24.i.i, %for.body24.i.i.preheader
  ...
  br i1 %lcmp.mod556.not, label %for.cond34.preheader.loopexit.i.i, label %for.body24.i.i.epil
...
for.body24.i.i.epil:                              ; preds = %for.cond34.preheader.loopexit.i.i.unr-lcssa
  ...
  %932 = load i8, ptr %arrayidx26.i.i.epil, align 1, !tbaa !31
  %conv27.i.i.epil = zext i8 %932 to i64
  ...
  %933 = load i32, ptr %arrayidx29.i.i.epil, align 4, !tbaa !36
  %inc30.i.i.epil = add nsw i32 %933, 1
...
for.cond34.preheader.i.i:                         ; preds = %for.cond34.preheader.loopexit.i.i, %for.cond12.preheader.i.thread.i
  ...
  %934 = phi i32 [ %.pre200.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %935 = phi i32 [ %.pre199.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %936 = phi i32 [ %.pre198.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %937 = phi i32 [ %.pre197.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %938 = phi i32 [ %.pre196.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %939 = phi i32 [ %.pre195.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %940 = phi i32 [ %.pre194.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %941 = phi i32 [ %.pre193.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %942 = phi i32 [ %.pre192.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %943 = phi i32 [ %.pre191.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %944 = phi i32 [ %.pre190.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %945 = phi i32 [ %.pre189.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %946 = phi i32 [ %.pre188.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %947 = phi i32 [ %.pre187.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %948 = phi i32 [ %.pre186.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %949 = phi i32 [ %.pre185.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %950 = phi i32 [ %.pre184.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %951 = phi i32 [ %.pre183.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %952 = phi i32 [ %.pre182.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %953 = phi i32 [ %.pre181.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %954 = phi i32 [ %.pre180.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  %955 = phi i32 [ %.pre.i.i, %for.cond34.preheader.loopexit.i.i ], [ 0, %for.cond12.preheader.i.thread.i ]
  ...
  %add42.2.i.i = add nsw i32 %add42.1.i.i, %953
  ...
  %add42.3.i.i = add nsw i32 %add42.2.i.i, %952
  ...
  %add42.4.i.i = add nsw i32 %add42.3.i.i, %951
  ...
  %add42.5.i.i = add nsw i32 %add42.4.i.i, %950
  ...
  %add42.6.i.i = add nsw i32 %add42.5.i.i, %949
  ...
  %add42.7.i.i = add nsw i32 %add42.6.i.i, %948
  ...
  %add42.8.i.i = add nsw i32 %add42.7.i.i, %947
  ...
  %add42.9.i.i = add nsw i32 %add42.8.i.i, %946
  ...
  %add42.10.i.i = add nsw i32 %add42.9.i.i, %945
  ...
  %add42.11.i.i = add nsw i32 %add42.10.i.i, %944
  ...
  %add42.12.i.i = add nsw i32 %add42.11.i.i, %943
  ...
  %add42.13.i.i = add nsw i32 %add42.12.i.i, %942
  ...
  %add42.14.i.i = add nsw i32 %add42.13.i.i, %941
  ...
  %add42.15.i.i = add nsw i32 %add42.14.i.i, %940
  ...
  %add42.16.i.i = add nsw i32 %add42.15.i.i, %939
  ...
  %add42.17.i.i = add nsw i32 %add42.16.i.i, %938
  ...
  %add42.18.i.i = add nsw i32 %add42.17.i.i, %937
  ...
  %add42.19.i.i = add nsw i32 %add42.18.i.i, %936
  ...
  %add42.20.i.i = add nsw i32 %add42.19.i.i, %935
  ...
  %add42.21.i.i = add nsw i32 %add42.20.i.i, %934
...
for.body24.i.i:                                   ; preds = %for.body24.i.i.preheader, %for.body24.i.i
  ...
  %niter558 = phi i64 [ %niter558.next.1, %for.body24.i.i ], [ 0, %for.body24.i.i.preheader ]
  %arrayidx26.i.i = getelementptr inbounds i8, ptr %arrayidx929.i, i64 %indvars.iv158.i.i
  %956 = load i8, ptr %arrayidx26.i.i, align 1, !tbaa !31
  %conv27.i.i = zext i8 %956 to i64
  %add.i.i101 = add nuw nsw i64 %conv27.i.i, 1
  %arrayidx29.i.i = getelementptr inbounds i32, ptr %arrayidx922.i, i64 %add.i.i101
  %957 = load i32, ptr %arrayidx29.i.i, align 4, !tbaa !36
  %inc30.i.i = add nsw i32 %957, 1
  ...
  %958 = load i8, ptr %arrayidx26.i.i.1, align 1, !tbaa !31
  %conv27.i.i.1 = zext i8 %958 to i64
  ...
  %959 = load i32, ptr %arrayidx29.i.i.1, align 4, !tbaa !36
  %inc30.i.i.1 = add nsw i32 %959, 1
  store i32 %inc30.i.i.1, ptr %arrayidx29.i.i.1, align 4, !tbaa !36
  %indvars.iv.next159.i.i.1 = add nuw nsw i64 %indvars.iv158.i.i, 2
  %niter558.next.1 = add i64 %niter558, 2
  %niter558.ncmp.1 = icmp eq i64 %niter558.next.1, %unroll_iter557
  br i1 %niter558.ncmp.1, label %for.cond34.preheader.loopexit.i.i.unr-lcssa, label %for.body24.i.i, !llvm.loop !95

for.body58.preheader.i.i:                         ; preds = %for.cond34.preheader.i.i
  %960 = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 37, i64 %indvars.iv3277.i
  %961 = zext i32 %minLen.0.lcssa4301.i to i64
  %arrayidx63.i.phi.trans.insert.i = getelementptr inbounds i32, ptr %960, i64 %961
  %.pre3427.i = load i32, ptr %arrayidx63.i.phi.trans.insert.i, align 4, !tbaa !36
  %962 = add i32 %maxLen.0.lcssa4299.i, 1
  %963 = sub i32 %962, %minLen.0.lcssa4301.i
  %xtraiter559 = and i32 %963, 1
  %964 = icmp eq i32 %maxLen.0.lcssa4299.i, %minLen.0.lcssa4301.i
  br i1 %964, label %for.cond73.preheader.i.i.loopexit.unr-lcssa, label %for.body58.preheader.i.i.new

for.body58.preheader.i.i.new:                     ; preds = %for.body58.preheader.i.i
  %unroll_iter561 = and i32 %963, -2
  br label %for.body58.i.i

for.cond73.preheader.i.i.loopexit.unr-lcssa:      ; preds = %for.body58.i.i, %for.body58.preheader.i.i
  %.unr = phi i32 [ %.pre3427.i, %for.body58.preheader.i.i ], [ %978, %for.body58.i.i ]
  %indvars.iv171.i.i.unr = phi i64 [ %961, %for.body58.preheader.i.i ], [ %indvars.iv.next172.i.i.1, %for.body58.i.i ]
  %vec.0149.i.i.unr = phi i32 [ 0, %for.body58.preheader.i.i ], [ %shl.i.i.1, %for.body58.i.i ]
  %lcmp.mod560.not = icmp eq i32 %xtraiter559, 0
  br i1 %lcmp.mod560.not, label %for.cond73.preheader.i.i, label %for.body58.i.i.epil
...
for.body58.i.i.epil:                              ; preds = %for.cond73.preheader.i.i.loopexit.unr-lcssa
  ...
  %arrayidx61.i.i.epil = getelementptr inbounds i32, ptr %960, i64 %indvars.iv.next172.i.i.epil
  %965 = load i32, ptr %arrayidx61.i.i.epil, align 4, !tbaa !36
  %sub64.i.i.epil = sub nsw i32 %965, %.unr
...
for.body76.preheader.i.i:                         ; preds = %for.cond73.preheader.i.i
  %966 = zext i32 %minLen.0.lcssa4301.i to i64
  %wide.trip.count178.i.i = zext i32 %maxLen.0.lcssa4299.i to i64
  %967 = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 37, i64 %indvars.iv3277.i
  %968 = sub nsw i64 %wide.trip.count178.i.i, %966
  %min.iters.check339 = icmp ult i64 %968, 4
  br i1 %min.iters.check339, label %for.body76.i.i.preheader, label %vector.ph340

vector.ph340:                                     ; preds = %for.body76.preheader.i.i
  %n.vec342 = and i64 %968, -4
  %ind.end343 = add nsw i64 %n.vec342, %966
  br label %vector.body346

vector.body346:                                   ; preds = %vector.body346, %vector.ph340
  %index347 = phi i64 [ 0, %vector.ph340 ], [ %index.next351, %vector.body346 ]
  %offset.idx348 = add i64 %index347, %966
  %969 = add nuw nsw i64 %offset.idx348, 1
  %970 = getelementptr inbounds i32, ptr %arrayidx9194303.i, i64 %offset.idx348
  %wide.load349 = load <4 x i32>, ptr %970, align 4, !tbaa !36
  %971 = shl <4 x i32> %wide.load349, <i32 1, i32 1, i32 1, i32 1>
  %972 = add <4 x i32> %971, <i32 2, i32 2, i32 2, i32 2>
  %973 = getelementptr inbounds i32, ptr %967, i64 %969
  %wide.load350 = load <4 x i32>, ptr %973, align 4, !tbaa !36
  %974 = sub <4 x i32> %972, %wide.load350
  store <4 x i32> %974, ptr %973, align 4, !tbaa !36
  %index.next351 = add nuw i64 %index347, 4
  %975 = icmp eq i64 %index.next351, %n.vec342
  br i1 %975, label %middle.block337, label %vector.body346, !llvm.loop !96

middle.block337:                                  ; preds = %vector.body346
  %cmp.n345 = icmp eq i64 %968, %n.vec342
  br i1 %cmp.n345, label %CreateDecodeTables.exit.i, label %for.body76.i.i.preheader

for.body76.i.i.preheader:                         ; preds = %for.body76.preheader.i.i, %middle.block337
  %indvars.iv175.i.i.ph = phi i64 [ %966, %for.body76.preheader.i.i ], [ %ind.end343, %middle.block337 ]
  br label %for.body76.i.i

for.body58.i.i:                                   ; preds = %for.body58.i.i, %for.body58.preheader.i.i.new
  %976 = phi i32 [ %.pre3427.i, %for.body58.preheader.i.i.new ], [ %978, %for.body58.i.i ]
  %indvars.iv171.i.i = phi i64 [ %961, %for.body58.preheader.i.i.new ], [ %indvars.iv.next172.i.i.1, %for.body58.i.i ]
  %vec.0149.i.i = phi i32 [ 0, %for.body58.preheader.i.i.new ], [ %shl.i.i.1, %for.body58.i.i ]
  %niter562 = phi i32 [ 0, %for.body58.preheader.i.i.new ], [ %niter562.next.1, %for.body58.i.i ]
  %indvars.iv.next172.i.i = add nuw nsw i64 %indvars.iv171.i.i, 1
  %arrayidx61.i.i = getelementptr inbounds i32, ptr %960, i64 %indvars.iv.next172.i.i
  %977 = load i32, ptr %arrayidx61.i.i, align 4, !tbaa !36
  %sub64.i.i = sub nsw i32 %977, %976
  ...
  %arrayidx61.i.i.1 = getelementptr inbounds i32, ptr %960, i64 %indvars.iv.next172.i.i.1
  %978 = load i32, ptr %arrayidx61.i.i.1, align 4, !tbaa !36
  %sub64.i.i.1 = sub nsw i32 %978, %977
  ...
  %niter562.next.1 = add i32 %niter562, 2
  %niter562.ncmp.1 = icmp eq i32 %niter562.next.1, %unroll_iter561
  br i1 %niter562.ncmp.1, label %for.cond73.preheader.i.i.loopexit.unr-lcssa, label %for.body58.i.i, !llvm.loop !97
...
for.body76.i.i:                                   ; preds = %for.body76.i.i.preheader, %for.body76.i.i
  ...
  %979 = load i32, ptr %arrayidx79.i.i, align 4, !tbaa !36
  %add80.i.i = shl i32 %979, 1
  %shl81.i.i = add i32 %add80.i.i, 2
  %arrayidx83.i.i = getelementptr inbounds i32, ptr %967, i64 %indvars.iv.next176.i.i
  %980 = load i32, ptr %arrayidx83.i.i, align 4, !tbaa !36
  %sub84.i.i = sub i32 %shl81.i.i, %980
...
CreateDecodeTables.exit.i:                        ; preds = %for.body76.i.i, %middle.block337, %for.cond73.preheader.i.i
...
for.end935.i:                                     ; preds = %CreateDecodeTables.exit.i, %for.cond875.preheader.i
  ...
  %981 = load i32, ptr %nInUse.i.i, align 8, !tbaa !79
  %982 = load i32, ptr %blockSize100k.i, align 8, !tbaa !49
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1024) %uglygep3283.i, i8 0, i64 1024, i1 false), !tbaa !36
...
for.cond953.preheader.i:                          ; preds = %for.cond953.preheader.i, %for.end935.i
  ...
  %983 = insertelement <4 x i8> poison, i8 %mul957.i, i64 0
  %984 = shufflevector <4 x i8> %983, <4 x i8> poison, <4 x i32> zeroinitializer
  %985 = or <4 x i8> %984, <i8 9, i8 10, i8 11, i8 12>
  store <4 x i8> %985, ptr %arrayidx961.6.i, align 1, !tbaa !31
  ...
  %986 = insertelement <8 x i8> poison, i8 %mul957.i, i64 0
  %987 = shufflevector <8 x i8> %986, <8 x i8> poison, <8 x i32> zeroinitializer
  %988 = or <8 x i8> %987, <i8 1, i8 2, i8 3, i8 4, i8 5, i8 6, i8 7, i8 8>
  store <8 x i8> %988, ptr %arrayidx961.14.i, align 1, !tbaa !31
  ...
  %989 = trunc i64 %indvars.iv.next3290.14.i to i32
  ...
  store i32 %989, ptr %arrayidx968.i, align 4, !tbaa !36
...
if.then974.i:                                     ; preds = %for.cond953.preheader.i
  %mul939.i = mul nsw i32 %982, 100000
  %add937.i = add nsw i32 %981, 1
...
if.end999.i:                                      ; preds = %if.then974.i
  %990 = load i8, ptr %selector980.i, align 1, !tbaa !31
  %idxprom985.i = zext i8 %990 to i64
  ...
  %991 = load i32, ptr %arrayidx986.i, align 4, !tbaa !36
  %conv983.i = zext i8 %990 to i32
  br label %sw.bb1001.i

sw.bb1001.i:                                      ; preds = %if.end999.i, %if.end.i88
  %992 = phi i32 [ %.pre3402.i, %if.end.i88 ], [ %786, %if.end999.i ]
  %993 = phi i32 [ %.pre3405.i, %if.end.i88 ], [ %789, %if.end999.i ]
  %994 = phi i32 [ %.pre3406.i, %if.end.i88 ], [ %790, %if.end999.i ]
  %995 = phi i32 [ %.pre3408.i, %if.end.i88 ], [ %791, %if.end999.i ]
  %996 = phi i32 [ %.pre3410.i, %if.end.i88 ], [ %793, %if.end999.i ]
  %997 = phi i32 [ %.pre3411.i, %if.end.i88 ], [ %794, %if.end999.i ]
  %gSel.1.i = phi i32 [ %.pre3412.i, %if.end.i88 ], [ %conv983.i, %if.end999.i ]
  %gMinlen.1.i = phi i32 [ %.pre3413.i, %if.end.i88 ], [ %991, %if.end999.i ]
  ...
  %zn.0.i = phi i32 [ %.pre3409.i, %if.end.i88 ], [ %991, %if.end999.i ]
...
if.end1019.lr.ph.i:                               ; preds = %sw.bb1001.i
  %998 = load ptr, ptr %0, align 8, !tbaa !13
  %avail_in1021.i = getelementptr inbounds %struct.nsis_bzstream, ptr %998, i64 0, i32 1
  %total_in_lo321042.i = getelementptr inbounds %struct.nsis_bzstream, ptr %998, i64 0, i32 2
  %total_in_hi321050.i = getelementptr inbounds %struct.nsis_bzstream, ptr %998, i64 0, i32 3
...
if.then1008.i:                                    ; preds = %if.end1052.i, %sw.bb1001.if.then1008_crit_edge.i
  %999 = phi i32 [ %.pre3428.i, %sw.bb1001.if.then1008_crit_edge.i ], [ %or1031.i, %if.end1052.i ]
  ...
  %shr1013.i = lshr i32 %999, %sub1012.i
...
if.end1025.i:                                     ; preds = %if.end1019.i
  %1000 = load i32, ptr %bsBuff77.i, align 8, !tbaa !18
  %shl1027.i = shl i32 %1000, 8
  %1001 = load ptr, ptr %998, align 8, !tbaa !74
  %1002 = load i8, ptr %1001, align 1, !tbaa !31
  %conv1030.i = zext i8 %1002 to i32
  ...
  %incdec.ptr1037.i = getelementptr inbounds i8, ptr %1001, i64 1
  store ptr %incdec.ptr1037.i, ptr %998, align 8, !tbaa !74
  %dec1040.i = add i32 %dec10403137.i, -1
  store i32 %dec1040.i, ptr %avail_in1021.i, align 8, !tbaa !73
  %1003 = load i32, ptr %total_in_lo321042.i, align 4, !tbaa !20
  %inc1043.i = add i32 %1003, 1
...
if.then1048.i:                                    ; preds = %if.end1025.i
  %1004 = load i32, ptr %total_in_hi321050.i, align 8, !tbaa !21
  %inc1051.i = add i32 %1004, 1
...
while.cond1054.i:                                 ; preds = %if.then1074.i, %if.then1008.i
  %1005 = phi i32 [ %1010, %if.then1074.i ], [ %992, %if.then1008.i ]
  %1006 = phi i32 [ %1011, %if.then1074.i ], [ %993, %if.then1008.i ]
  %1007 = phi i32 [ %1012, %if.then1074.i ], [ %994, %if.then1008.i ]
  %1008 = phi i32 [ %1013, %if.then1074.i ], [ %995, %if.then1008.i ]
  %bsLive1071.promoted3442.i = phi i32 [ %sub1078.i, %if.then1074.i ], [ %sub1012.i, %if.then1008.i ]
  %zj.0.i = phi i32 [ %and1080.i, %if.then1074.i ], [ %997, %if.then1008.i ]
...
if.end1059.i:                                     ; preds = %while.cond1054.i
  ...
  %1009 = load i32, ptr %arrayidx1061.i, align 4, !tbaa !36
  %cmp1062.not.i = icmp sgt i32 %zvec.0.i, %1009
...
sw.bb1067.i:                                      ; preds = %if.end1065.i, %if.end.sw.bb1067_crit_edge.i
  %1010 = phi i32 [ %.pre3402.i, %if.end.sw.bb1067_crit_edge.i ], [ %1005, %if.end1065.i ]
  %1011 = phi i32 [ %.pre3405.i, %if.end.sw.bb1067_crit_edge.i ], [ %1006, %if.end1065.i ]
  %1012 = phi i32 [ %.pre3406.i, %if.end.sw.bb1067_crit_edge.i ], [ %1007, %if.end1065.i ]
  %1013 = phi i32 [ %.pre3408.i, %if.end.sw.bb1067_crit_edge.i ], [ %1008, %if.end1065.i ]
...
if.end1083.lr.ph.i:                               ; preds = %sw.bb1067.i
  %1014 = load ptr, ptr %0, align 8, !tbaa !13
  %avail_in1085.i = getelementptr inbounds %struct.nsis_bzstream, ptr %1014, i64 0, i32 1
  %total_in_lo321106.i = getelementptr inbounds %struct.nsis_bzstream, ptr %1014, i64 0, i32 2
  %total_in_hi321114.i = getelementptr inbounds %struct.nsis_bzstream, ptr %1014, i64 0, i32 3
...
if.then1074.i:                                    ; preds = %if.end1116.i, %sw.bb1067.if.then1074_crit_edge.i
  %1015 = phi i32 [ %.pre3443.i, %sw.bb1067.if.then1074_crit_edge.i ], [ %or1095.i, %if.end1116.i ]
  ...
  %shr1079.i = lshr i32 %1015, %sub1078.i
...
if.end1089.i:                                     ; preds = %if.end1083.i
  %1016 = load i32, ptr %bsBuff77.i, align 8, !tbaa !18
  %shl1091.i = shl i32 %1016, 8
  %1017 = load ptr, ptr %1014, align 8, !tbaa !74
  %1018 = load i8, ptr %1017, align 1, !tbaa !31
  %conv1094.i = zext i8 %1018 to i32
  ...
  %incdec.ptr1101.i = getelementptr inbounds i8, ptr %1017, i64 1
  store ptr %incdec.ptr1101.i, ptr %1014, align 8, !tbaa !74
  %dec1104.i = add i32 %dec11043200.i, -1
  store i32 %dec1104.i, ptr %avail_in1085.i, align 8, !tbaa !73
  %1019 = load i32, ptr %total_in_lo321106.i, align 4, !tbaa !20
  %inc1107.i = add i32 %1019, 1
...
if.then1112.i:                                    ; preds = %if.end1089.i
  %1020 = load i32, ptr %total_in_hi321114.i, align 8, !tbaa !21
  %inc1115.i = add i32 %1020, 1
...
while.end1120.i:                                  ; preds = %if.end1059.i
  ...
  %1021 = load i32, ptr %arrayidx1122.i, align 4, !tbaa !36
  %sub1123.i = sub nsw i32 %zvec.0.i, %1021
...
if.end1133.i:                                     ; preds = %while.end1120.i
  ...
  %1022 = load i32, ptr %arrayidx1138.i, align 4, !tbaa !36
...
while.cond1139.i:                                 ; preds = %while.cond1351.preheader.i, %while.cond1367.preheader.i, %if.end1382.loopexit.i, %if.end1382.loopexit3247.i, %if.end1742.i, %if.end1133.i
  %1023 = phi i32 [ %1195, %if.end1742.i ], [ %1008, %if.end1133.i ], [ %1035, %if.end1382.loopexit3247.i ], [ %1035, %if.end1382.loopexit.i ], [ %1035, %while.cond1367.preheader.i ], [ %1035, %while.cond1351.preheader.i ]
  ...
  %N.0.i = phi i32 [ %N.6.i, %if.end1742.i ], [ %1007, %if.end1133.i ], [ %N.3.i, %if.end1382.loopexit3247.i ], [ %N.3.i, %if.end1382.loopexit.i ], [ %N.3.i, %while.cond1367.preheader.i ], [ %N.3.i, %while.cond1351.preheader.i ]
  %es.0.i = phi i32 [ %es.10.i, %if.end1742.i ], [ %1006, %if.end1133.i ], [ %dec1364.i, %if.end1382.loopexit3247.i ], [ %dec1380.i, %if.end1382.loopexit.i ], [ %inc1336.i, %while.cond1367.preheader.i ], [ %inc1336.i, %while.cond1351.preheader.i ]
  %nblock.3.i = phi i32 [ %nblock.12.i, %if.end1742.i ], [ %nblock.1.i, %if.end1133.i ], [ %1058, %if.end1382.loopexit3247.i ], [ %1057, %if.end1382.loopexit.i ], [ %nblock.6.i, %while.cond1367.preheader.i ], [ %nblock.6.i, %while.cond1351.preheader.i ]
  ...
  %nextSym.0.i = phi i32 [ %1206, %if.end1742.i ], [ %1022, %if.end1133.i ], [ %1046, %if.end1382.loopexit3247.i ], [ %1046, %if.end1382.loopexit.i ], [ %1046, %while.cond1367.preheader.i ], [ %1046, %while.cond1351.preheader.i ]
...
do.body.i:                                        ; preds = %if.end1326.i, %if.end1144.i
  %1024 = phi i32 [ %1035, %if.end1326.i ], [ %1023, %if.end1144.i ]
  ...
  %nextSym.1.i = phi i32 [ %1046, %if.end1326.i ], [ %nextSym.0.i, %if.end1144.i ]
  ...
  %switch.not.i = icmp eq i32 %nextSym.1.i, 1
  %mul1160.i = shl nsw i32 %N.1.i, 1
  %es.2.v.i = select i1 %switch.not.i, i32 %mul1160.i, i32 %N.1.i
...
if.end1172.i:                                     ; preds = %if.then1167.i
  ...
  %1025 = load i8, ptr %arrayidx1175.i, align 1, !tbaa !31
  %conv1176.i = zext i8 %1025 to i32
  %idxprom1178.i = zext i8 %1025 to i64
  %arrayidx1179.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 39, i64 %idxprom1178.i
  %1026 = load i32, ptr %arrayidx1179.i, align 4, !tbaa !36
...
if.end1192.i:                                     ; preds = %if.end1172.i, %do.body.i
  ...
  %gMinlen.6.i = phi i32 [ %1026, %if.end1172.i ], [ %gMinlen.5.i, %do.body.i ]
...
sw.bb1194.i:                                      ; preds = %if.end1192.i, %if.end.i88
  %1027 = phi i32 [ %1024, %if.end1192.i ], [ %.pre3408.i, %if.end.i88 ]
...
if.end1212.lr.ph.i:                               ; preds = %sw.bb1194.i
  %1028 = load ptr, ptr %0, align 8, !tbaa !13
  %avail_in1214.i = getelementptr inbounds %struct.nsis_bzstream, ptr %1028, i64 0, i32 1
  %total_in_lo321235.i = getelementptr inbounds %struct.nsis_bzstream, ptr %1028, i64 0, i32 2
  %total_in_hi321243.i = getelementptr inbounds %struct.nsis_bzstream, ptr %1028, i64 0, i32 3
...
if.then1201.i:                                    ; preds = %if.end1245.i, %sw.bb1194.if.then1201_crit_edge.i
  %1029 = phi i32 [ %.pre3433.i, %sw.bb1194.if.then1201_crit_edge.i ], [ %or1224.i, %if.end1245.i ]
  ...
  %shr1206.i = lshr i32 %1029, %sub1205.i
...
if.end1218.i:                                     ; preds = %if.end1212.i
  %1030 = load i32, ptr %bsBuff77.i, align 8, !tbaa !18
  %shl1220.i = shl i32 %1030, 8
  %1031 = load ptr, ptr %1028, align 8, !tbaa !74
  %1032 = load i8, ptr %1031, align 1, !tbaa !31
  %conv1223.i = zext i8 %1032 to i32
  ...
  %incdec.ptr1230.i = getelementptr inbounds i8, ptr %1031, i64 1
  store ptr %incdec.ptr1230.i, ptr %1028, align 8, !tbaa !74
  %dec1233.i = add i32 %dec12333169.i, -1
  store i32 %dec1233.i, ptr %avail_in1214.i, align 8, !tbaa !73
  %1033 = load i32, ptr %total_in_lo321235.i, align 4, !tbaa !20
  %inc1236.i = add i32 %1033, 1
...
if.then1241.i:                                    ; preds = %if.end1218.i
  %1034 = load i32, ptr %total_in_hi321243.i, align 8, !tbaa !21
  %inc1244.i = add i32 %1034, 1
...
while.cond1247.i:                                 ; preds = %if.then1267.i, %if.then1201.i
  %1035 = phi i32 [ %1027, %if.then1201.i ], [ %1037, %if.then1267.i ]
...
if.end1252.i:                                     ; preds = %while.cond1247.i
  ...
  %1036 = load i32, ptr %arrayidx1254.i, align 4, !tbaa !36
  %cmp1255.not.i = icmp sgt i32 %zvec.5.i, %1036
...
sw.bb1260.i:                                      ; preds = %if.end1258.i, %if.end.sw.bb1260_crit_edge.i
  %1037 = phi i32 [ %1035, %if.end1258.i ], [ %.pre3408.i, %if.end.sw.bb1260_crit_edge.i ]
...
if.end1276.lr.ph.i:                               ; preds = %sw.bb1260.i
  ...
  %avail_in1278.i = getelementptr inbounds %struct.nsis_bzstream, ptr %1038, i64 0, i32 1
  %total_in_lo321299.i = getelementptr inbounds %struct.nsis_bzstream, ptr %1038, i64 0, i32 2
  %total_in_hi321307.i = getelementptr inbounds %struct.nsis_bzstream, ptr %1038, i64 0, i32 3
...
if.then1267.i:                                    ; preds = %if.end1309.i, %sw.bb1260.if.then1267_crit_edge.i
  %1039 = phi i32 [ %.pre3436.i, %sw.bb1260.if.then1267_crit_edge.i ], [ %or1288.i, %if.end1309.i ]
  ...
  %shr1272.i = lshr i32 %1039, %sub1271.i
...
if.end1282.i:                                     ; preds = %if.end1276.i
  %1040 = load i32, ptr %bsBuff77.i, align 8, !tbaa !18
  %shl1284.i = shl i32 %1040, 8
  %1041 = load ptr, ptr %1038, align 8, !tbaa !74
  %1042 = load i8, ptr %1041, align 1, !tbaa !31
  %conv1287.i = zext i8 %1042 to i32
  ...
  %incdec.ptr1294.i = getelementptr inbounds i8, ptr %1041, i64 1
  store ptr %incdec.ptr1294.i, ptr %1038, align 8, !tbaa !74
  %dec1297.i = add i32 %dec12973185.i, -1
  store i32 %dec1297.i, ptr %avail_in1278.i, align 8, !tbaa !73
  %1043 = load i32, ptr %total_in_lo321299.i, align 4, !tbaa !20
  %inc1300.i = add i32 %1043, 1
...
if.then1305.i:                                    ; preds = %if.end1282.i
  %1044 = load i32, ptr %total_in_hi321307.i, align 8, !tbaa !21
  %inc1308.i = add i32 %1044, 1
...
while.end1313.i:                                  ; preds = %if.end1252.i
  ...
  %1045 = load i32, ptr %arrayidx1315.i, align 4, !tbaa !36
  %sub1316.i = sub nsw i32 %zvec.5.i, %1045
...
if.end1326.i:                                     ; preds = %while.end1313.i
  ...
  %1046 = load i32, ptr %arrayidx1331.i, align 4, !tbaa !36
  %1047 = icmp ult i32 %1046, 2
  br i1 %1047, label %do.body.i, label %do.end.i, !llvm.loop !101

do.end.i:                                         ; preds = %if.end1326.i
  %inc1336.i = add nsw i32 %es.4.i, 1
  %1048 = load i32, ptr %mtfbase1458.i, align 4, !tbaa !36
  %idxprom1340.i = sext i32 %1048 to i64
  %arrayidx1341.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 31, i64 %idxprom1340.i
  %1049 = load i8, ptr %arrayidx1341.i, align 1, !tbaa !31
  %idxprom1342.i = zext i8 %1049 to i64
  %arrayidx1343.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 30, i64 %idxprom1342.i
  %1050 = load i8, ptr %arrayidx1343.i, align 1, !tbaa !31
  %idxprom1345.i = zext i8 %1050 to i64
  %arrayidx1346.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 16, i64 %idxprom1345.i
  %1051 = load i32, ptr %arrayidx1346.i, align 4, !tbaa !36
  %add1347.i = add nsw i32 %1051, %inc1336.i
  store i32 %add1347.i, ptr %arrayidx1346.i, align 4, !tbaa !36
  %1052 = load i8, ptr %smallDecompress, align 4, !tbaa !24
  %tobool1349.not.i = icmp eq i8 %1052, 0
...
while.body1354.lr.ph.i:                           ; preds = %while.cond1351.preheader.i
  %conv1359.i = zext i8 %1050 to i16
  %1053 = sext i32 %nblock.6.i to i64
...
while.body1370.lr.ph.i:                           ; preds = %while.cond1367.preheader.i
  %conv1375.i = zext i8 %1050 to i32
  %1054 = sext i32 %nblock.6.i to i64
...
while.body1354.i:                                 ; preds = %if.end1358.i, %while.body1354.lr.ph.i
  %indvars.iv3343.i = phi i64 [ %1053, %while.body1354.lr.ph.i ], [ %indvars.iv.next3344.i, %if.end1358.i ]
...
if.end1358.i:                                     ; preds = %while.body1354.i
  %1055 = load ptr, ptr %ll16.i, align 8, !tbaa !39
  %arrayidx1362.i = getelementptr inbounds i16, ptr %1055, i64 %indvars.iv3343.i
...
while.body1370.i:                                 ; preds = %if.end1374.i, %while.body1370.lr.ph.i
  %indvars.iv3349.i = phi i64 [ %1054, %while.body1370.lr.ph.i ], [ %indvars.iv.next3350.i, %if.end1374.i ]
...
if.end1374.i:                                     ; preds = %while.body1370.i
  %1056 = load ptr, ptr %tt.i, align 8, !tbaa !44
  %arrayidx1378.i = getelementptr inbounds i32, ptr %1056, i64 %indvars.iv3349.i
...
if.end1382.loopexit.i:                            ; preds = %if.end1374.i
  %1057 = trunc i64 %indvars.iv.next3350.i to i32
  br label %while.cond1139.i

if.end1382.loopexit3247.i:                        ; preds = %if.end1358.i
  %1058 = trunc i64 %indvars.iv.next3344.i to i32
  br label %while.cond1139.i
...
if.then1394.i:                                    ; preds = %if.end1387.i
  %1059 = load i32, ptr %mtfbase1458.i, align 4, !tbaa !36
  %add1398.i = add i32 %1059, %sub1391.i
  ...
  %1060 = load i8, ptr %arrayidx1400.i, align 1, !tbaa !31
...
while.body1404.preheader.i:                       ; preds = %if.then1394.i
  %1061 = zext i32 %sub1391.i to i64
  br label %while.body1404.i

while.cond1439.preheader.i:                       ; preds = %while.body1404.i
  %1062 = trunc i64 %indvars.iv.next3336.i to i32
  %cmp1440.not3150.i = icmp eq i32 %1062, 0
  br i1 %cmp1440.not3150.i, label %while.end1453.i, label %iter.check

iter.check:                                       ; preds = %while.cond1439.preheader.i, %if.then1394.i
  %nn.0.lcssa4318.i = phi i32 [ %1062, %while.cond1439.preheader.i ], [ %sub1391.i, %if.then1394.i ]
  %1063 = zext i32 %nn.0.lcssa4318.i to i64
  %1064 = add i32 %nn.0.lcssa4318.i, -1
  %1065 = zext i32 %1064 to i64
  %1066 = add nuw nsw i64 %1065, 1
  %min.iters.check = icmp ult i32 %1064, 7
  br i1 %min.iters.check, label %while.body1442.i.preheader, label %vector.scevcheck

vector.scevcheck:                                 ; preds = %iter.check
  %1067 = add i32 %nn.0.lcssa4318.i, -1
  %1068 = add i32 %nn.0.lcssa4318.i, %1059
  %1069 = icmp ugt i32 %1067, %1068
  %1070 = add i32 %nn.0.lcssa4318.i, -1
  %1071 = add i32 %1070, %1059
  %1072 = icmp ugt i32 %1059, %1071
  %1073 = zext i32 %1068 to i64
  %uglygep305 = getelementptr i8, ptr %uglygep, i64 %1073
  %1074 = zext i32 %1067 to i64
  %1075 = sub nsw i64 0, %1074
  %1076 = getelementptr i8, ptr %uglygep305, i64 %1075
  %1077 = icmp ugt ptr %1076, %uglygep305
  %1078 = zext i32 %1071 to i64
  %uglygep310 = getelementptr i8, ptr %uglygep309, i64 %1078
  %1079 = zext i32 %1067 to i64
  %1080 = sub nsw i64 0, %1079
  %1081 = getelementptr i8, ptr %uglygep310, i64 %1080
  %1082 = icmp ugt ptr %1081, %uglygep310
  %1083 = or i1 %1069, %1072
  %1084 = or i1 %1083, %1077
  %1085 = or i1 %1084, %1082
  br i1 %1085, label %while.body1442.i.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %vector.scevcheck
  %1086 = add i32 %nn.0.lcssa4318.i, -1
  %1087 = add i32 %1086, %1059
  %1088 = zext i32 %1087 to i64
  %1089 = add i64 %3, %1088
  %1090 = add i32 %nn.0.lcssa4318.i, %1059
  %1091 = zext i32 %1090 to i64
  %1092 = add i64 %4, %1091
  %1093 = sub i64 %1089, %1092
  %diff.check = icmp ult i64 %1093, 16
  br i1 %diff.check, label %while.body1442.i.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %vector.memcheck
  %min.iters.check317 = icmp ult i32 %1064, 15
  br i1 %min.iters.check317, label %vec.epilog.ph, label %vector.ph318

vector.ph318:                                     ; preds = %vector.main.loop.iter.check
  %n.vec = and i64 %1066, -16
  br label %vector.body320

vector.body320:                                   ; preds = %vector.body320, %vector.ph318
  %index321 = phi i64 [ 0, %vector.ph318 ], [ %index.next325, %vector.body320 ]
  %1094 = trunc i64 %index321 to i32
  %1095 = sub i32 %nn.0.lcssa4318.i, %1094
  %1096 = add i32 %1059, %1095
  %1097 = add i32 %1096, -1
  %1098 = zext i32 %1097 to i64
  %1099 = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 31, i64 %1098
  %1100 = getelementptr inbounds i8, ptr %1099, i64 -15
  %wide.load323 = load <16 x i8>, ptr %1100, align 1, !tbaa !31
  %1101 = zext i32 %1096 to i64
  %1102 = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 31, i64 %1101
  %1103 = getelementptr inbounds i8, ptr %1102, i64 -15
  store <16 x i8> %wide.load323, ptr %1103, align 1, !tbaa !31
  %index.next325 = add nuw i64 %index321, 16
  %1104 = icmp eq i64 %index.next325, %n.vec
  br i1 %1104, label %middle.block314, label %vector.body320, !llvm.loop !104

middle.block314:                                  ; preds = %vector.body320
  %cmp.n319 = icmp eq i64 %1066, %n.vec
  br i1 %cmp.n319, label %while.end1453.i, label %vec.epilog.iter.check

vec.epilog.iter.check:                            ; preds = %middle.block314
  %ind.end328 = sub nsw i64 %1063, %n.vec
  %n.vec.remaining = and i64 %1066, 8
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec327 = and i64 %1066, -8
  %ind.end = sub nsw i64 %1063, %n.vec327
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index331 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next336, %vec.epilog.vector.body ]
  %1105 = trunc i64 %index331 to i32
  %1106 = sub i32 %nn.0.lcssa4318.i, %1105
  %1107 = add i32 %1059, %1106
  %1108 = add i32 %1107, -1
  %1109 = zext i32 %1108 to i64
  %1110 = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 31, i64 %1109
  %1111 = getelementptr inbounds i8, ptr %1110, i64 -7
  %wide.load333 = load <8 x i8>, ptr %1111, align 1, !tbaa !31
  %1112 = zext i32 %1107 to i64
  %1113 = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 31, i64 %1112
  %1114 = getelementptr inbounds i8, ptr %1113, i64 -7
  store <8 x i8> %wide.load333, ptr %1114, align 1, !tbaa !31
  %index.next336 = add nuw i64 %index331, 8
  %1115 = icmp eq i64 %index.next336, %n.vec327
  br i1 %1115, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !105

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n330 = icmp eq i64 %1066, %n.vec327
  br i1 %cmp.n330, label %while.end1453.i, label %while.body1442.i.preheader
...
while.body1442.i.preheader:                       ; preds = %vector.memcheck, %vector.scevcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv3339.i.ph = phi i64 [ %1063, %iter.check ], [ %1063, %vector.memcheck ], [ %1063, %vector.scevcheck ], [ %ind.end328, %vec.epilog.iter.check ], [ %ind.end, %vec.epilog.middle.block ]
  %1116 = trunc i64 %indvars.iv3339.i.ph to i32
  %xtraiter563 = and i32 %1116, 1
  %lcmp.mod564.not = icmp eq i32 %xtraiter563, 0
  br i1 %lcmp.mod564.not, label %while.body1442.i.prol.loopexit, label %while.body1442.i.prol

while.body1442.i.prol:                            ; preds = %while.body1442.i.preheader
  %1117 = trunc i64 %indvars.iv3339.i.ph to i32
  %add1444.i.prol = add i32 %1059, %1117
  ...
  %1118 = load i8, ptr %arrayidx1447.i.prol, align 1, !tbaa !31
  ...
  store i8 %1118, ptr %arrayidx1451.i.prol, align 1, !tbaa !31
...
while.body1442.i.prol.loopexit:                   ; preds = %while.body1442.i.prol, %while.body1442.i.preheader
  ...
  br i1 %1119, label %while.end1453.i, label %while.body1442.i

while.body1404.i:                                 ; preds = %while.body1404.i, %while.body1404.preheader.i
  %indvars.iv3335.i = phi i64 [ %1061, %while.body1404.preheader.i ], [ %indvars.iv.next3336.i, %while.body1404.i ]
  %1120 = trunc i64 %indvars.iv3335.i to i32
  %add1405.i = add i32 %1059, %1120
  ...
  %1121 = load i8, ptr %arrayidx1409.i, align 1, !tbaa !31
  ...
  store i8 %1121, ptr %arrayidx1412.i, align 1, !tbaa !31
  ...
  %1122 = load i8, ptr %arrayidx1416.i, align 1, !tbaa !31
  store i8 %1122, ptr %arrayidx1409.i, align 1, !tbaa !31
  ...
  %1123 = load i8, ptr %arrayidx1424.i, align 1, !tbaa !31
  store i8 %1123, ptr %arrayidx1416.i, align 1, !tbaa !31
  ...
  %1124 = load i8, ptr %arrayidx1432.i, align 1, !tbaa !31
  store i8 %1124, ptr %arrayidx1424.i, align 1, !tbaa !31
  %indvars.iv.next3336.i = add i64 %indvars.iv3335.i, -4
  %1125 = and i64 %indvars.iv.next3336.i, 4294967292
  %cmp1402.not.i = icmp eq i64 %1125, 0
  br i1 %cmp1402.not.i, label %while.cond1439.preheader.i, label %while.body1404.i, !llvm.loop !106
...
while.body1442.i:                                 ; preds = %while.body1442.i.prol.loopexit, %while.body1442.i
  ...
  %1126 = trunc i64 %indvars.iv3339.i to i32
  %add1444.i = add i32 %1059, %1126
  ...
  %1127 = load i8, ptr %arrayidx1447.i, align 1, !tbaa !31
  ...
  store i8 %1127, ptr %arrayidx1451.i, align 1, !tbaa !31
  %1128 = trunc i64 %indvars.iv3339.i to i32
  %1129 = add i32 %1128, -1
  %add1444.i.1 = add i32 %1059, %1129
  ...
  %1130 = load i8, ptr %arrayidx1447.i.1, align 1, !tbaa !31
  ...
  store i8 %1130, ptr %arrayidx1451.i.1, align 1, !tbaa !31
  %indvars.iv.next3340.i.1 = add nsw i64 %indvars.iv3339.i, -2
  %1131 = and i64 %indvars.iv.next3340.i.1, 4294967295
  %cmp1440.not.i.1 = icmp eq i64 %1131, 0
  br i1 %cmp1440.not.i.1, label %while.end1453.i, label %while.body1442.i, !llvm.loop !107

while.end1453.i:                                  ; preds = %while.body1442.i.prol.loopexit, %while.body1442.i, %middle.block314, %vec.epilog.middle.block, %while.cond1439.preheader.i
  %idxprom1455.i = sext i32 %1059 to i64
  %arrayidx1456.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 31, i64 %idxprom1455.i
  store i8 %1060, ptr %arrayidx1456.i, align 1, !tbaa !31
...
if.else1457.i:                                    ; preds = %if.end1387.i
  ...
  %1132 = load i32, ptr %arrayidx1460.i, align 4, !tbaa !36
  %add1461.i = add nsw i32 %1132, %rem.i
  ...
  %1133 = load i8, ptr %arrayidx1464.i, align 1, !tbaa !31
...
while.body1471.preheader.i:                       ; preds = %if.else1457.i
  ...
  %1135 = add i32 %nextSym.0.i, 15
  %1136 = and i32 %1135, 15
  %1137 = zext i32 %1136 to i64
  %1138 = add nsw i64 %1134, %1137
  br label %while.body1471.i

while.body1471.i:                                 ; preds = %while.body1471.i, %while.body1471.preheader.i
  %indvars.iv3317.i = phi i64 [ %1138, %while.body1471.preheader.i ], [ %indvars.iv.next3318.i, %while.body1471.i ]
  ...
  %1139 = load i8, ptr %arrayidx1475.i, align 1, !tbaa !31
  %arrayidx1478.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 31, i64 %indvars.iv3317.i
  store i8 %1139, ptr %arrayidx1478.i, align 1, !tbaa !31
  %1140 = load i32, ptr %arrayidx1460.i, align 4, !tbaa !36
  %1141 = sext i32 %1140 to i64
  %cmp1469.i = icmp sgt i64 %indvars.iv.next3318.i, %1141
...
while.body1488.preheader.i:                       ; preds = %while.body1471.i, %if.else1457.i
  %.lcssa3053.i = phi i32 [ %1132, %if.else1457.i ], [ %1140, %while.body1471.i ]
...
while.body1488.i:                                 ; preds = %while.body1488.i, %while.body1488.preheader.i
  ...
  %1142 = load i32, ptr %arrayidx1491.i, align 4, !tbaa !36
  %dec1492.i = add nsw i32 %1142, -1
  ...
  %1143 = load i32, ptr %arrayidx1497.i, align 4, !tbaa !36
  %sub1499.i = add nsw i32 %1143, 15
  ...
  %1144 = load i8, ptr %arrayidx1501.i, align 1, !tbaa !31
  ...
  store i8 %1144, ptr %arrayidx1507.i, align 1, !tbaa !31
...
while.end1509.i:                                  ; preds = %while.body1488.i
  %1145 = load i32, ptr %mtfbase1458.i, align 4, !tbaa !36
  %dec1512.i = add nsw i32 %1145, -1
  ...
  store i8 %1133, ptr %arrayidx1517.i, align 1, !tbaa !31
  %1146 = load i32, ptr %mtfbase1458.i, align 4, !tbaa !36
  %cmp1520.i = icmp eq i32 %1146, 0
...
for.cond1527.preheader.i:                         ; preds = %while.end1509.i, %for.cond1527.preheader.i
  ...
  %1160 = load i8, ptr %arrayidx1537.6.i, align 1, !tbaa !31
  %arrayidx1540.6.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 31, i64 %indvars.iv.next3324.5.i
  store i8 %1160, ptr %arrayidx1540.6.i, align 1, !tbaa !31
  %indvars.iv.next3324.6.i = add nsw i64 %indvars.iv3327.i, -7
  %1161 = load i32, ptr %arrayidx1534.i, align 4, !tbaa !36
  %add1535.7.i = add nsw i32 %1161, 8
  ...
  %1162 = load i8, ptr %arrayidx1537.7.i, align 1, !tbaa !31
  %arrayidx1540.7.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 31, i64 %indvars.iv.next3324.6.i
  store i8 %1162, ptr %arrayidx1540.7.i, align 1, !tbaa !31
  %indvars.iv.next3324.7.i = add nsw i64 %indvars.iv3327.i, -8
  %1163 = load i32, ptr %arrayidx1534.i, align 4, !tbaa !36
  %add1535.8.i = add nsw i32 %1163, 7
  ...
  %1164 = load i8, ptr %arrayidx1537.8.i, align 1, !tbaa !31
  %arrayidx1540.8.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 31, i64 %indvars.iv.next3324.7.i
  store i8 %1164, ptr %arrayidx1540.8.i, align 1, !tbaa !31
  %indvars.iv.next3324.8.i = add nsw i64 %indvars.iv3327.i, -9
  %1165 = load i32, ptr %arrayidx1534.i, align 4, !tbaa !36
  %add1535.9.i = add nsw i32 %1165, 6
  ...
  %1166 = load i8, ptr %arrayidx1537.9.i, align 1, !tbaa !31
  %arrayidx1540.9.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 31, i64 %indvars.iv.next3324.8.i
  store i8 %1166, ptr %arrayidx1540.9.i, align 1, !tbaa !31
  %indvars.iv.next3324.9.i = add nsw i64 %indvars.iv3327.i, -10
  %1167 = load i32, ptr %arrayidx1534.i, align 4, !tbaa !36
  %add1535.10.i = add nsw i32 %1167, 5
  ...
  %1168 = load i8, ptr %arrayidx1537.10.i, align 1, !tbaa !31
  %arrayidx1540.10.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 31, i64 %indvars.iv.next3324.9.i
  store i8 %1168, ptr %arrayidx1540.10.i, align 1, !tbaa !31
  %indvars.iv.next3324.10.i = add nsw i64 %indvars.iv3327.i, -11
  %1169 = load i32, ptr %arrayidx1534.i, align 4, !tbaa !36
  %add1535.11.i = add nsw i32 %1169, 4
  ...
  %1170 = load i8, ptr %arrayidx1537.11.i, align 1, !tbaa !31
  %arrayidx1540.11.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 31, i64 %indvars.iv.next3324.10.i
  store i8 %1170, ptr %arrayidx1540.11.i, align 1, !tbaa !31
  %indvars.iv.next3324.11.i = add nsw i64 %indvars.iv3327.i, -12
  %1171 = load i32, ptr %arrayidx1534.i, align 4, !tbaa !36
  %add1535.12.i = add nsw i32 %1171, 3
  ...
  %1172 = load i8, ptr %arrayidx1537.12.i, align 1, !tbaa !31
  %arrayidx1540.12.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 31, i64 %indvars.iv.next3324.11.i
  store i8 %1172, ptr %arrayidx1540.12.i, align 1, !tbaa !31
  %indvars.iv.next3324.12.i = add nsw i64 %indvars.iv3327.i, -13
  %1173 = load i32, ptr %arrayidx1534.i, align 4, !tbaa !36
  %add1535.13.i = add nsw i32 %1173, 2
  ...
  %1174 = load i8, ptr %arrayidx1537.13.i, align 1, !tbaa !31
  %arrayidx1540.13.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 31, i64 %indvars.iv.next3324.12.i
  store i8 %1174, ptr %arrayidx1540.13.i, align 1, !tbaa !31
  %indvars.iv.next3324.13.i = add nsw i64 %indvars.iv3327.i, -14
  %1175 = load i32, ptr %arrayidx1534.i, align 4, !tbaa !36
  %add1535.14.i = add nsw i32 %1175, 1
...
if.end1553.i:                                     ; preds = %for.cond1527.preheader.i, %while.end1509.i, %while.end1453.i
  %uc.0.i = phi i8 [ %1060, %while.end1453.i ], [ %1133, %while.end1509.i ], [ %1133, %for.cond1527.preheader.i ]
  ...
  %1180 = load i8, ptr %arrayidx1557.i, align 1, !tbaa !31
  %idxprom1558.i = zext i8 %1180 to i64
  %arrayidx1559.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 16, i64 %idxprom1558.i
  %1181 = load i32, ptr %arrayidx1559.i, align 4, !tbaa !36
  %inc1560.i = add nsw i32 %1181, 1
  store i32 %inc1560.i, ptr %arrayidx1559.i, align 4, !tbaa !36
  %1182 = load i8, ptr %smallDecompress, align 4, !tbaa !24
  %tobool1562.not.i = icmp eq i8 %1182, 0
...
if.then1563.i:                                    ; preds = %if.end1553.i
  %conv1567.i = zext i8 %1180 to i16
  %1183 = load ptr, ptr %ll16.i, align 8, !tbaa !39
  %arrayidx1570.i = getelementptr inbounds i16, ptr %1183, i64 %idxprom1577.i
  store i16 %conv1567.i, ptr %arrayidx1570.i, align 2, !tbaa !40
  br label %if.end1579.i

if.else1571.i:                                    ; preds = %if.end1553.i
  %conv1575.i = zext i8 %1180 to i32
  %1184 = load ptr, ptr %tt.i, align 8, !tbaa !44
  %arrayidx1578.i = getelementptr inbounds i32, ptr %1184, i64 %idxprom1577.i
...
if.end1588.i:                                     ; preds = %if.then1583.i
  ...
  %1185 = load i8, ptr %arrayidx1591.i, align 1, !tbaa !31
  %conv1592.i = zext i8 %1185 to i32
  %idxprom1594.i = zext i8 %1185 to i64
  %arrayidx1595.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 39, i64 %idxprom1594.i
  %1186 = load i32, ptr %arrayidx1595.i, align 4, !tbaa !36
...
if.end1608.i:                                     ; preds = %if.end1588.i, %if.end1579.i
  ...
  %gMinlen.10.i = phi i32 [ %1186, %if.end1588.i ], [ %gMinlen.4.i, %if.end1579.i ]
...
sw.bb1610.i:                                      ; preds = %if.end1608.i, %if.end.i88
  %1187 = phi i32 [ %1023, %if.end1608.i ], [ %.pre3408.i, %if.end.i88 ]
...
if.end1628.lr.ph.i:                               ; preds = %sw.bb1610.i
  %1188 = load ptr, ptr %0, align 8, !tbaa !13
  %avail_in1630.i = getelementptr inbounds %struct.nsis_bzstream, ptr %1188, i64 0, i32 1
  %total_in_lo321651.i = getelementptr inbounds %struct.nsis_bzstream, ptr %1188, i64 0, i32 2
  %total_in_hi321659.i = getelementptr inbounds %struct.nsis_bzstream, ptr %1188, i64 0, i32 3
...
if.then1617.i:                                    ; preds = %if.end1661.i, %sw.bb1610.if.then1617_crit_edge.i
  %1189 = phi i32 [ %.pre3429.i, %sw.bb1610.if.then1617_crit_edge.i ], [ %or1640.i, %if.end1661.i ]
  ...
  %shr1622.i = lshr i32 %1189, %sub1621.i
...
if.end1634.i:                                     ; preds = %if.end1628.i
  %1190 = load i32, ptr %bsBuff77.i, align 8, !tbaa !18
  %shl1636.i = shl i32 %1190, 8
  %1191 = load ptr, ptr %1188, align 8, !tbaa !74
  %1192 = load i8, ptr %1191, align 1, !tbaa !31
  %conv1639.i = zext i8 %1192 to i32
  ...
  %incdec.ptr1646.i = getelementptr inbounds i8, ptr %1191, i64 1
  store ptr %incdec.ptr1646.i, ptr %1188, align 8, !tbaa !74
  %dec1649.i = add i32 %dec16493157.i, -1
  store i32 %dec1649.i, ptr %avail_in1630.i, align 8, !tbaa !73
  %1193 = load i32, ptr %total_in_lo321651.i, align 4, !tbaa !20
  %inc1652.i = add i32 %1193, 1
...
if.then1657.i:                                    ; preds = %if.end1634.i
  %1194 = load i32, ptr %total_in_hi321659.i, align 8, !tbaa !21
  %inc1660.i = add i32 %1194, 1
...
while.cond1663.i:                                 ; preds = %if.then1683.i, %if.then1617.i
  %1195 = phi i32 [ %1197, %if.then1683.i ], [ %1187, %if.then1617.i ]
...
if.end1668.i:                                     ; preds = %while.cond1663.i
  ...
  %1196 = load i32, ptr %arrayidx1670.i, align 4, !tbaa !36
  %cmp1671.not.i = icmp sgt i32 %zvec.8.i, %1196
...
sw.bb1676.i:                                      ; preds = %if.end1674.i, %if.end.sw.bb1676_crit_edge.i
  %1197 = phi i32 [ %.pre3408.i, %if.end.sw.bb1676_crit_edge.i ], [ %1195, %if.end1674.i ]
...
if.end1692.lr.ph.i:                               ; preds = %sw.bb1676.i
  %1198 = load ptr, ptr %0, align 8, !tbaa !13
  %avail_in1694.i = getelementptr inbounds %struct.nsis_bzstream, ptr %1198, i64 0, i32 1
  %total_in_lo321715.i = getelementptr inbounds %struct.nsis_bzstream, ptr %1198, i64 0, i32 2
  %total_in_hi321723.i = getelementptr inbounds %struct.nsis_bzstream, ptr %1198, i64 0, i32 3
...
if.then1683.i:                                    ; preds = %if.end1725.i, %sw.bb1676.if.then1683_crit_edge.i
  %1199 = phi i32 [ %.pre3432.i, %sw.bb1676.if.then1683_crit_edge.i ], [ %or1704.i, %if.end1725.i ]
  ...
  %shr1688.i = lshr i32 %1199, %sub1687.i
...
if.end1698.i:                                     ; preds = %if.end1692.i
  %1200 = load i32, ptr %bsBuff77.i, align 8, !tbaa !18
  %shl1700.i = shl i32 %1200, 8
  %1201 = load ptr, ptr %1198, align 8, !tbaa !74
  %1202 = load i8, ptr %1201, align 1, !tbaa !31
  %conv1703.i = zext i8 %1202 to i32
  ...
  %incdec.ptr1710.i = getelementptr inbounds i8, ptr %1201, i64 1
  store ptr %incdec.ptr1710.i, ptr %1198, align 8, !tbaa !74
  %dec1713.i = add i32 %dec17133163.i, -1
  store i32 %dec1713.i, ptr %avail_in1694.i, align 8, !tbaa !73
  %1203 = load i32, ptr %total_in_lo321715.i, align 4, !tbaa !20
  %inc1716.i = add i32 %1203, 1
...
if.then1721.i:                                    ; preds = %if.end1698.i
  %1204 = load i32, ptr %total_in_hi321723.i, align 8, !tbaa !21
  %inc1724.i = add i32 %1204, 1
...
while.end1729.i:                                  ; preds = %if.end1668.i
  ...
  %1205 = load i32, ptr %arrayidx1731.i, align 4, !tbaa !36
  %sub1732.i = sub nsw i32 %zvec.8.i, %1205
...
if.end1742.i:                                     ; preds = %while.end1729.i
  ...
  %1206 = load i32, ptr %arrayidx1747.i, align 4, !tbaa !36
  br label %while.cond1139.i

while.end1748.i:                                  ; preds = %while.cond1139.i
  %1207 = load i32, ptr %origPtr.i, align 8, !tbaa !75
  %cmp1750.i = icmp sgt i32 %1207, -1
  %cmp1754.not.i = icmp slt i32 %1207, %nblock.3.i
...
if.end1757.i:                                     ; preds = %while.end1748.i
  ...
  %wide.load299 = load <4 x i32>, ptr %20, align 4, !tbaa !36
  %wide.load300 = load <4 x i32>, ptr %21, align 4, !tbaa !36
  store <4 x i32> %wide.load299, ptr %22, align 4, !tbaa !36
  store <4 x i32> %wide.load300, ptr %23, align 4, !tbaa !36
  %wide.load299.1 = load <4 x i32>, ptr %24, align 4, !tbaa !36
  %wide.load300.1 = load <4 x i32>, ptr %25, align 4, !tbaa !36
  store <4 x i32> %wide.load299.1, ptr %26, align 4, !tbaa !36
  store <4 x i32> %wide.load300.1, ptr %27, align 4, !tbaa !36
  %wide.load299.2 = load <4 x i32>, ptr %28, align 4, !tbaa !36
  %wide.load300.2 = load <4 x i32>, ptr %29, align 4, !tbaa !36
  store <4 x i32> %wide.load299.2, ptr %30, align 4, !tbaa !36
  store <4 x i32> %wide.load300.2, ptr %31, align 4, !tbaa !36
  %wide.load299.3 = load <4 x i32>, ptr %32, align 4, !tbaa !36
  %wide.load300.3 = load <4 x i32>, ptr %33, align 4, !tbaa !36
  store <4 x i32> %wide.load299.3, ptr %34, align 4, !tbaa !36
  store <4 x i32> %wide.load300.3, ptr %35, align 4, !tbaa !36
  %wide.load299.4 = load <4 x i32>, ptr %36, align 4, !tbaa !36
  %wide.load300.4 = load <4 x i32>, ptr %37, align 4, !tbaa !36
  store <4 x i32> %wide.load299.4, ptr %38, align 4, !tbaa !36
  store <4 x i32> %wide.load300.4, ptr %39, align 4, !tbaa !36
  %wide.load299.5 = load <4 x i32>, ptr %40, align 4, !tbaa !36
  %wide.load300.5 = load <4 x i32>, ptr %41, align 4, !tbaa !36
  store <4 x i32> %wide.load299.5, ptr %42, align 4, !tbaa !36
  store <4 x i32> %wide.load300.5, ptr %43, align 4, !tbaa !36
  %wide.load299.6 = load <4 x i32>, ptr %44, align 4, !tbaa !36
  %wide.load300.6 = load <4 x i32>, ptr %45, align 4, !tbaa !36
  store <4 x i32> %wide.load299.6, ptr %46, align 4, !tbaa !36
  store <4 x i32> %wide.load300.6, ptr %47, align 4, !tbaa !36
  %wide.load299.7 = load <4 x i32>, ptr %48, align 4, !tbaa !36
  %wide.load300.7 = load <4 x i32>, ptr %49, align 4, !tbaa !36
  store <4 x i32> %wide.load299.7, ptr %50, align 4, !tbaa !36
  store <4 x i32> %wide.load300.7, ptr %51, align 4, !tbaa !36
  %wide.load299.8 = load <4 x i32>, ptr %52, align 4, !tbaa !36
  %wide.load300.8 = load <4 x i32>, ptr %53, align 4, !tbaa !36
  store <4 x i32> %wide.load299.8, ptr %54, align 4, !tbaa !36
  store <4 x i32> %wide.load300.8, ptr %55, align 4, !tbaa !36
  %wide.load299.9 = load <4 x i32>, ptr %56, align 4, !tbaa !36
  %wide.load300.9 = load <4 x i32>, ptr %57, align 4, !tbaa !36
  store <4 x i32> %wide.load299.9, ptr %58, align 4, !tbaa !36
  store <4 x i32> %wide.load300.9, ptr %59, align 4, !tbaa !36
  %wide.load299.10 = load <4 x i32>, ptr %60, align 4, !tbaa !36
  %wide.load300.10 = load <4 x i32>, ptr %61, align 4, !tbaa !36
  store <4 x i32> %wide.load299.10, ptr %62, align 4, !tbaa !36
  store <4 x i32> %wide.load300.10, ptr %63, align 4, !tbaa !36
  %wide.load299.11 = load <4 x i32>, ptr %64, align 4, !tbaa !36
  %wide.load300.11 = load <4 x i32>, ptr %65, align 4, !tbaa !36
  store <4 x i32> %wide.load299.11, ptr %66, align 4, !tbaa !36
  store <4 x i32> %wide.load300.11, ptr %67, align 4, !tbaa !36
  %wide.load299.12 = load <4 x i32>, ptr %68, align 4, !tbaa !36
  %wide.load300.12 = load <4 x i32>, ptr %69, align 4, !tbaa !36
  store <4 x i32> %wide.load299.12, ptr %70, align 4, !tbaa !36
  store <4 x i32> %wide.load300.12, ptr %71, align 4, !tbaa !36
  %wide.load299.13 = load <4 x i32>, ptr %72, align 4, !tbaa !36
  %wide.load300.13 = load <4 x i32>, ptr %73, align 4, !tbaa !36
  store <4 x i32> %wide.load299.13, ptr %74, align 4, !tbaa !36
  store <4 x i32> %wide.load300.13, ptr %75, align 4, !tbaa !36
  %wide.load299.14 = load <4 x i32>, ptr %76, align 4, !tbaa !36
  %wide.load300.14 = load <4 x i32>, ptr %77, align 4, !tbaa !36
  store <4 x i32> %wide.load299.14, ptr %78, align 4, !tbaa !36
  store <4 x i32> %wide.load300.14, ptr %79, align 4, !tbaa !36
  %wide.load299.15 = load <4 x i32>, ptr %80, align 4, !tbaa !36
  %wide.load300.15 = load <4 x i32>, ptr %81, align 4, !tbaa !36
  store <4 x i32> %wide.load299.15, ptr %82, align 4, !tbaa !36
  store <4 x i32> %wide.load300.15, ptr %83, align 4, !tbaa !36
  %wide.load299.16 = load <4 x i32>, ptr %84, align 4, !tbaa !36
  %wide.load300.16 = load <4 x i32>, ptr %85, align 4, !tbaa !36
  store <4 x i32> %wide.load299.16, ptr %86, align 4, !tbaa !36
  store <4 x i32> %wide.load300.16, ptr %87, align 4, !tbaa !36
  %wide.load299.17 = load <4 x i32>, ptr %88, align 4, !tbaa !36
  %wide.load300.17 = load <4 x i32>, ptr %89, align 4, !tbaa !36
  store <4 x i32> %wide.load299.17, ptr %90, align 4, !tbaa !36
  store <4 x i32> %wide.load300.17, ptr %91, align 4, !tbaa !36
  %wide.load299.18 = load <4 x i32>, ptr %92, align 4, !tbaa !36
  %wide.load300.18 = load <4 x i32>, ptr %93, align 4, !tbaa !36
  store <4 x i32> %wide.load299.18, ptr %94, align 4, !tbaa !36
  store <4 x i32> %wide.load300.18, ptr %95, align 4, !tbaa !36
  %wide.load299.19 = load <4 x i32>, ptr %96, align 4, !tbaa !36
  %wide.load300.19 = load <4 x i32>, ptr %97, align 4, !tbaa !36
  store <4 x i32> %wide.load299.19, ptr %98, align 4, !tbaa !36
  store <4 x i32> %wide.load300.19, ptr %99, align 4, !tbaa !36
  %wide.load299.20 = load <4 x i32>, ptr %100, align 4, !tbaa !36
  %wide.load300.20 = load <4 x i32>, ptr %101, align 4, !tbaa !36
  store <4 x i32> %wide.load299.20, ptr %102, align 4, !tbaa !36
  store <4 x i32> %wide.load300.20, ptr %103, align 4, !tbaa !36
  %wide.load299.21 = load <4 x i32>, ptr %104, align 4, !tbaa !36
  %wide.load300.21 = load <4 x i32>, ptr %105, align 4, !tbaa !36
  store <4 x i32> %wide.load299.21, ptr %106, align 4, !tbaa !36
  store <4 x i32> %wide.load300.21, ptr %107, align 4, !tbaa !36
  %wide.load299.22 = load <4 x i32>, ptr %108, align 4, !tbaa !36
  %wide.load300.22 = load <4 x i32>, ptr %109, align 4, !tbaa !36
  store <4 x i32> %wide.load299.22, ptr %110, align 4, !tbaa !36
  store <4 x i32> %wide.load300.22, ptr %111, align 4, !tbaa !36
  %wide.load299.23 = load <4 x i32>, ptr %112, align 4, !tbaa !36
  %wide.load300.23 = load <4 x i32>, ptr %113, align 4, !tbaa !36
  store <4 x i32> %wide.load299.23, ptr %114, align 4, !tbaa !36
  store <4 x i32> %wide.load300.23, ptr %115, align 4, !tbaa !36
  %wide.load299.24 = load <4 x i32>, ptr %116, align 4, !tbaa !36
  %wide.load300.24 = load <4 x i32>, ptr %117, align 4, !tbaa !36
  store <4 x i32> %wide.load299.24, ptr %118, align 4, !tbaa !36
  store <4 x i32> %wide.load300.24, ptr %119, align 4, !tbaa !36
  %wide.load299.25 = load <4 x i32>, ptr %120, align 4, !tbaa !36
  %wide.load300.25 = load <4 x i32>, ptr %121, align 4, !tbaa !36
  store <4 x i32> %wide.load299.25, ptr %122, align 4, !tbaa !36
  store <4 x i32> %wide.load300.25, ptr %123, align 4, !tbaa !36
  %wide.load299.26 = load <4 x i32>, ptr %124, align 4, !tbaa !36
  %wide.load300.26 = load <4 x i32>, ptr %125, align 4, !tbaa !36
  store <4 x i32> %wide.load299.26, ptr %126, align 4, !tbaa !36
  store <4 x i32> %wide.load300.26, ptr %127, align 4, !tbaa !36
  %wide.load299.27 = load <4 x i32>, ptr %128, align 4, !tbaa !36
  %wide.load300.27 = load <4 x i32>, ptr %129, align 4, !tbaa !36
  store <4 x i32> %wide.load299.27, ptr %130, align 4, !tbaa !36
  store <4 x i32> %wide.load300.27, ptr %131, align 4, !tbaa !36
  %wide.load299.28 = load <4 x i32>, ptr %132, align 4, !tbaa !36
  %wide.load300.28 = load <4 x i32>, ptr %133, align 4, !tbaa !36
  store <4 x i32> %wide.load299.28, ptr %134, align 4, !tbaa !36
  store <4 x i32> %wide.load300.28, ptr %135, align 4, !tbaa !36
  %wide.load299.29 = load <4 x i32>, ptr %136, align 4, !tbaa !36
  %wide.load300.29 = load <4 x i32>, ptr %137, align 4, !tbaa !36
  store <4 x i32> %wide.load299.29, ptr %138, align 4, !tbaa !36
  store <4 x i32> %wide.load300.29, ptr %139, align 4, !tbaa !36
  %wide.load299.30 = load <4 x i32>, ptr %140, align 4, !tbaa !36
  %wide.load300.30 = load <4 x i32>, ptr %141, align 4, !tbaa !36
  store <4 x i32> %wide.load299.30, ptr %142, align 4, !tbaa !36
  store <4 x i32> %wide.load300.30, ptr %143, align 4, !tbaa !36
  %wide.load299.31 = load <4 x i32>, ptr %144, align 4, !tbaa !36
  %wide.load300.31 = load <4 x i32>, ptr %145, align 4, !tbaa !36
  store <4 x i32> %wide.load299.31, ptr %146, align 4, !tbaa !36
  store <4 x i32> %wide.load300.31, ptr %147, align 4, !tbaa !36
  br label %for.body1776.i

for.body1776.i:                                   ; preds = %for.body1776.i, %if.end1757.i
  %1208 = phi i32 [ 0, %if.end1757.i ], [ %add1784.i.3, %for.body1776.i ]
  ...
  %1209 = load i32, ptr %arrayidx1783.i, align 4, !tbaa !36
  %add1784.i = add nsw i32 %1209, %1208
  ...
  %1210 = load i32, ptr %arrayidx1783.i.1, align 4, !tbaa !36
  %add1784.i.1 = add nsw i32 %1210, %add1784.i
  ...
  %1211 = load i32, ptr %arrayidx1783.i.2, align 4, !tbaa !36
  %add1784.i.2 = add nsw i32 %1211, %add1784.i.1
  ...
  %1212 = load i32, ptr %arrayidx1783.i.3, align 4, !tbaa !36
  %add1784.i.3 = add nsw i32 %1212, %add1784.i.2
...
for.body1791.i:                                   ; preds = %for.body1776.i, %for.inc1805.i.3
  ...
  %1213 = load i32, ptr %arrayidx1794.i, align 4, !tbaa !36
  %cmp1795.i = icmp slt i32 %1213, 0
  %cmp1801.i = icmp sgt i32 %1213, %nblock.3.i
...
for.body1791.i.1:                                 ; preds = %for.inc1805.i
  ...
  %1214 = load i32, ptr %arrayidx1794.i.1, align 4, !tbaa !36
  %cmp1795.i.1 = icmp slt i32 %1214, 0
  %cmp1801.i.1 = icmp sgt i32 %1214, %nblock.3.i
...
for.inc1805.i.1:                                  ; preds = %for.body1791.i.1
  ...
  %1215 = load i32, ptr %arrayidx1794.i.2, align 4, !tbaa !36
  %cmp1795.i.2 = icmp slt i32 %1215, 0
  %cmp1801.i.2 = icmp sgt i32 %1215, %nblock.3.i
...
for.inc1805.i.2:                                  ; preds = %for.inc1805.i.1
  ...
  %1216 = load i32, ptr %arrayidx1794.i.3, align 4, !tbaa !36
  %cmp1795.i.3 = icmp slt i32 %1216, 0
  %cmp1801.i.3 = icmp sgt i32 %1216, %nblock.3.i
...
for.end1807.i:                                    ; preds = %for.inc1805.i
  ...
  %1217 = load i8, ptr %smallDecompress, align 4, !tbaa !24
  %tobool1817.not.i = icmp eq i8 %1217, 0
...
vector.body:                                      ; preds = %for.end1807.i
  ...
  %wide.load291 = load <4 x i32>, ptr %149, align 4, !tbaa !36
  store <4 x i32> %wide.load, ptr %150, align 4, !tbaa !36
  store <4 x i32> %wide.load291, ptr %151, align 4, !tbaa !36
  %wide.load.1 = load <4 x i32>, ptr %152, align 4, !tbaa !36
  %wide.load291.1 = load <4 x i32>, ptr %153, align 4, !tbaa !36
  store <4 x i32> %wide.load.1, ptr %154, align 4, !tbaa !36
  store <4 x i32> %wide.load291.1, ptr %155, align 4, !tbaa !36
  %wide.load.2 = load <4 x i32>, ptr %156, align 4, !tbaa !36
  %wide.load291.2 = load <4 x i32>, ptr %157, align 4, !tbaa !36
  store <4 x i32> %wide.load.2, ptr %158, align 4, !tbaa !36
  store <4 x i32> %wide.load291.2, ptr %159, align 4, !tbaa !36
  %wide.load.3 = load <4 x i32>, ptr %160, align 4, !tbaa !36
  %wide.load291.3 = load <4 x i32>, ptr %161, align 4, !tbaa !36
  store <4 x i32> %wide.load.3, ptr %162, align 4, !tbaa !36
  store <4 x i32> %wide.load291.3, ptr %163, align 4, !tbaa !36
  %wide.load.4 = load <4 x i32>, ptr %164, align 4, !tbaa !36
  %wide.load291.4 = load <4 x i32>, ptr %165, align 4, !tbaa !36
  store <4 x i32> %wide.load.4, ptr %166, align 4, !tbaa !36
  store <4 x i32> %wide.load291.4, ptr %167, align 4, !tbaa !36
  %wide.load.5 = load <4 x i32>, ptr %168, align 4, !tbaa !36
  %wide.load291.5 = load <4 x i32>, ptr %169, align 4, !tbaa !36
  store <4 x i32> %wide.load.5, ptr %170, align 4, !tbaa !36
  store <4 x i32> %wide.load291.5, ptr %171, align 4, !tbaa !36
  %wide.load.6 = load <4 x i32>, ptr %172, align 4, !tbaa !36
  %wide.load291.6 = load <4 x i32>, ptr %173, align 4, !tbaa !36
  store <4 x i32> %wide.load.6, ptr %174, align 4, !tbaa !36
  store <4 x i32> %wide.load291.6, ptr %175, align 4, !tbaa !36
  %wide.load.7 = load <4 x i32>, ptr %176, align 4, !tbaa !36
  %wide.load291.7 = load <4 x i32>, ptr %177, align 4, !tbaa !36
  store <4 x i32> %wide.load.7, ptr %178, align 4, !tbaa !36
  store <4 x i32> %wide.load291.7, ptr %179, align 4, !tbaa !36
  %wide.load.8 = load <4 x i32>, ptr %180, align 4, !tbaa !36
  %wide.load291.8 = load <4 x i32>, ptr %181, align 4, !tbaa !36
  store <4 x i32> %wide.load.8, ptr %182, align 4, !tbaa !36
  store <4 x i32> %wide.load291.8, ptr %183, align 4, !tbaa !36
  %wide.load.9 = load <4 x i32>, ptr %184, align 4, !tbaa !36
  %wide.load291.9 = load <4 x i32>, ptr %185, align 4, !tbaa !36
  store <4 x i32> %wide.load.9, ptr %186, align 4, !tbaa !36
  store <4 x i32> %wide.load291.9, ptr %187, align 4, !tbaa !36
  %wide.load.10 = load <4 x i32>, ptr %188, align 4, !tbaa !36
  %wide.load291.10 = load <4 x i32>, ptr %189, align 4, !tbaa !36
  store <4 x i32> %wide.load.10, ptr %190, align 4, !tbaa !36
  store <4 x i32> %wide.load291.10, ptr %191, align 4, !tbaa !36
  %wide.load.11 = load <4 x i32>, ptr %192, align 4, !tbaa !36
  %wide.load291.11 = load <4 x i32>, ptr %193, align 4, !tbaa !36
  store <4 x i32> %wide.load.11, ptr %194, align 4, !tbaa !36
  store <4 x i32> %wide.load291.11, ptr %195, align 4, !tbaa !36
  %wide.load.12 = load <4 x i32>, ptr %196, align 4, !tbaa !36
  %wide.load291.12 = load <4 x i32>, ptr %197, align 4, !tbaa !36
  store <4 x i32> %wide.load.12, ptr %198, align 4, !tbaa !36
  store <4 x i32> %wide.load291.12, ptr %199, align 4, !tbaa !36
  %wide.load.13 = load <4 x i32>, ptr %200, align 4, !tbaa !36
  %wide.load291.13 = load <4 x i32>, ptr %201, align 4, !tbaa !36
  store <4 x i32> %wide.load.13, ptr %202, align 4, !tbaa !36
  store <4 x i32> %wide.load291.13, ptr %203, align 4, !tbaa !36
  %wide.load.14 = load <4 x i32>, ptr %204, align 4, !tbaa !36
  %wide.load291.14 = load <4 x i32>, ptr %205, align 4, !tbaa !36
  store <4 x i32> %wide.load.14, ptr %206, align 4, !tbaa !36
  store <4 x i32> %wide.load291.14, ptr %207, align 4, !tbaa !36
  %wide.load.15 = load <4 x i32>, ptr %208, align 4, !tbaa !36
  %wide.load291.15 = load <4 x i32>, ptr %209, align 4, !tbaa !36
  store <4 x i32> %wide.load.15, ptr %210, align 4, !tbaa !36
  store <4 x i32> %wide.load291.15, ptr %211, align 4, !tbaa !36
  %wide.load.16 = load <4 x i32>, ptr %212, align 4, !tbaa !36
  %wide.load291.16 = load <4 x i32>, ptr %213, align 4, !tbaa !36
  store <4 x i32> %wide.load.16, ptr %214, align 4, !tbaa !36
  store <4 x i32> %wide.load291.16, ptr %215, align 4, !tbaa !36
  %wide.load.17 = load <4 x i32>, ptr %216, align 4, !tbaa !36
  %wide.load291.17 = load <4 x i32>, ptr %217, align 4, !tbaa !36
  store <4 x i32> %wide.load.17, ptr %218, align 4, !tbaa !36
  store <4 x i32> %wide.load291.17, ptr %219, align 4, !tbaa !36
  %wide.load.18 = load <4 x i32>, ptr %220, align 4, !tbaa !36
  %wide.load291.18 = load <4 x i32>, ptr %221, align 4, !tbaa !36
  store <4 x i32> %wide.load.18, ptr %222, align 4, !tbaa !36
  store <4 x i32> %wide.load291.18, ptr %223, align 4, !tbaa !36
  %wide.load.19 = load <4 x i32>, ptr %224, align 4, !tbaa !36
  %wide.load291.19 = load <4 x i32>, ptr %225, align 4, !tbaa !36
  store <4 x i32> %wide.load.19, ptr %226, align 4, !tbaa !36
  store <4 x i32> %wide.load291.19, ptr %227, align 4, !tbaa !36
  %wide.load.20 = load <4 x i32>, ptr %228, align 4, !tbaa !36
  %wide.load291.20 = load <4 x i32>, ptr %229, align 4, !tbaa !36
  store <4 x i32> %wide.load.20, ptr %230, align 4, !tbaa !36
  store <4 x i32> %wide.load291.20, ptr %231, align 4, !tbaa !36
  %wide.load.21 = load <4 x i32>, ptr %232, align 4, !tbaa !36
  %wide.load291.21 = load <4 x i32>, ptr %233, align 4, !tbaa !36
  store <4 x i32> %wide.load.21, ptr %234, align 4, !tbaa !36
  store <4 x i32> %wide.load291.21, ptr %235, align 4, !tbaa !36
  %wide.load.22 = load <4 x i32>, ptr %236, align 4, !tbaa !36
  %wide.load291.22 = load <4 x i32>, ptr %237, align 4, !tbaa !36
  store <4 x i32> %wide.load.22, ptr %238, align 4, !tbaa !36
  store <4 x i32> %wide.load291.22, ptr %239, align 4, !tbaa !36
  %wide.load.23 = load <4 x i32>, ptr %240, align 4, !tbaa !36
  %wide.load291.23 = load <4 x i32>, ptr %241, align 4, !tbaa !36
  store <4 x i32> %wide.load.23, ptr %242, align 4, !tbaa !36
  store <4 x i32> %wide.load291.23, ptr %243, align 4, !tbaa !36
  %wide.load.24 = load <4 x i32>, ptr %244, align 4, !tbaa !36
  %wide.load291.24 = load <4 x i32>, ptr %245, align 4, !tbaa !36
  store <4 x i32> %wide.load.24, ptr %246, align 4, !tbaa !36
  store <4 x i32> %wide.load291.24, ptr %247, align 4, !tbaa !36
  %wide.load.25 = load <4 x i32>, ptr %248, align 4, !tbaa !36
  %wide.load291.25 = load <4 x i32>, ptr %249, align 4, !tbaa !36
  store <4 x i32> %wide.load.25, ptr %250, align 4, !tbaa !36
  store <4 x i32> %wide.load291.25, ptr %251, align 4, !tbaa !36
  %wide.load.26 = load <4 x i32>, ptr %252, align 4, !tbaa !36
  %wide.load291.26 = load <4 x i32>, ptr %253, align 4, !tbaa !36
  store <4 x i32> %wide.load.26, ptr %254, align 4, !tbaa !36
  store <4 x i32> %wide.load291.26, ptr %255, align 4, !tbaa !36
  %wide.load.27 = load <4 x i32>, ptr %256, align 4, !tbaa !36
  %wide.load291.27 = load <4 x i32>, ptr %257, align 4, !tbaa !36
  store <4 x i32> %wide.load.27, ptr %258, align 4, !tbaa !36
  store <4 x i32> %wide.load291.27, ptr %259, align 4, !tbaa !36
  %wide.load.28 = load <4 x i32>, ptr %260, align 4, !tbaa !36
  %wide.load291.28 = load <4 x i32>, ptr %261, align 4, !tbaa !36
  store <4 x i32> %wide.load.28, ptr %262, align 4, !tbaa !36
  store <4 x i32> %wide.load291.28, ptr %263, align 4, !tbaa !36
  %wide.load.29 = load <4 x i32>, ptr %264, align 4, !tbaa !36
  %wide.load291.29 = load <4 x i32>, ptr %265, align 4, !tbaa !36
  store <4 x i32> %wide.load.29, ptr %266, align 4, !tbaa !36
  store <4 x i32> %wide.load291.29, ptr %267, align 4, !tbaa !36
  %wide.load.30 = load <4 x i32>, ptr %268, align 4, !tbaa !36
  %wide.load291.30 = load <4 x i32>, ptr %269, align 4, !tbaa !36
  store <4 x i32> %wide.load.30, ptr %270, align 4, !tbaa !36
  store <4 x i32> %wide.load291.30, ptr %271, align 4, !tbaa !36
  %wide.load.31 = load <4 x i32>, ptr %272, align 4, !tbaa !36
  %wide.load291.31 = load <4 x i32>, ptr %273, align 4, !tbaa !36
  store <4 x i32> %wide.load.31, ptr %274, align 4, !tbaa !36
  store <4 x i32> %wide.load291.31, ptr %275, align 4, !tbaa !36
  %1218 = load i32, ptr %arrayidx1825.i, align 4, !tbaa !36
  store i32 %1218, ptr %arrayidx1827.i, align 4, !tbaa !36
  %wide.trip.count3386.i = zext i32 %nblock.3.i to i64
  br label %for.body1834.i

for.cond1995.preheader.i:                         ; preds = %for.end1807.i
  %1219 = load ptr, ptr %tt.i, align 8, !tbaa !44
  %wide.trip.count3392.i = zext i32 %nblock.3.i to i64
  %xtraiter565 = and i64 %wide.trip.count3392.i, 1
  %1220 = icmp eq i32 %nblock.3.i, 1
  br i1 %1220, label %for.end2018.loopexit.i.unr-lcssa, label %for.cond1995.preheader.i.new

for.cond1995.preheader.i.new:                     ; preds = %for.cond1995.preheader.i
  %unroll_iter567 = and i64 %wide.trip.count3392.i, 4294967294
...
for.body1834.i:                                   ; preds = %if.end1885.i, %vector.body
  ...
  %arrayidx1837.i = getelementptr inbounds i16, ptr %1221, i64 %indvars.iv3382.i
  %1222 = load i16, ptr %arrayidx1837.i, align 2, !tbaa !40
  %1223 = and i16 %1222, 255
  %idxprom1840.i = zext i16 %1223 to i64
  %arrayidx1841.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 19, i64 %idxprom1840.i
  %1224 = load i32, ptr %arrayidx1841.i, align 4, !tbaa !36
  %conv1843.i = trunc i32 %1224 to i16
  ...
  %1225 = load ptr, ptr %ll4.i, align 8, !tbaa !42
  %shr1852.i = lshr i64 %indvars.iv3382.i, 1
  %idxprom1853.i = and i64 %shr1852.i, 2147483647
  %arrayidx1854.i = getelementptr inbounds i8, ptr %1225, i64 %idxprom1853.i
  %1226 = load i8, ptr %arrayidx1854.i, align 1, !tbaa !31
...
if.then1850.i:                                    ; preds = %for.body1834.i
  ...
  %conv1862.i = or i8 %1227, %1229
  br label %if.end1885.i

if.else1867.i:                                    ; preds = %for.body1834.i
  %1230 = and i8 %1226, 15
  %1231 = lshr i32 %1224, 12
  %1232 = trunc i32 %1231 to i8
  %1233 = and i8 %1232, -16
  %conv1880.i = or i8 %1230, %1233
  br label %if.end1885.i
...
if.end1885.i:                                     ; preds = %if.else1867.i, %if.then1850.i
  ...
  %1234 = load i32, ptr %arrayidx1841.i, align 4, !tbaa !36
  %inc1889.i = add nsw i32 %1234, 1
...
for.end1892.loopexit.i:                           ; preds = %if.end1885.i
  ...
  %arrayidx1896.i = getelementptr inbounds i16, ptr %1235, i64 %idxprom1895.i
  %1236 = load i16, ptr %arrayidx1896.i, align 2, !tbaa !40
  %conv1897.i = zext i16 %1236 to i32
  %1237 = load ptr, ptr %ll4.i, align 8, !tbaa !42
  %shr1899.i = ashr i32 %.pre3438.i, 1
  %idxprom1900.i = sext i32 %shr1899.i to i64
  %arrayidx1901.i = getelementptr inbounds i8, ptr %1237, i64 %idxprom1900.i
  %1238 = load i8, ptr %arrayidx1901.i, align 1, !tbaa !31
  %conv1902.i = zext i8 %1238 to i32
...
do.body1909.i:                                    ; preds = %if.end1963.i, %for.end1892.loopexit.i
  ...
  %1239 = load ptr, ptr %ll16.i, align 8, !tbaa !39
  %idxprom1912.i = zext i32 %j.26.i to i64
  %arrayidx1913.i = getelementptr inbounds i16, ptr %1239, i64 %idxprom1912.i
  %1240 = load i16, ptr %arrayidx1913.i, align 2, !tbaa !40
  %conv1914.i = zext i16 %1240 to i32
  %1241 = load ptr, ptr %ll4.i, align 8, !tbaa !42
  %shr1916.i = lshr i32 %j.26.i, 1
  %idxprom1917.i = zext i32 %shr1916.i to i64
  %arrayidx1918.i = getelementptr inbounds i8, ptr %1241, i64 %idxprom1917.i
  %1242 = load i8, ptr %arrayidx1918.i, align 1, !tbaa !31
  %conv1919.i = zext i8 %1242 to i32
...
if.end1963.i:                                     ; preds = %if.else1948.i, %if.then1934.i
  ...
  %1251 = load i32, ptr %origPtr.i, align 8, !tbaa !75
  %cmp1966.not.i = icmp eq i32 %j.26.i, %1251
  br i1 %cmp1966.not.i, label %do.end1968.i, label %do.body1909.i, !llvm.loop !114

do.end1968.i:                                     ; preds = %if.end1963.i
  %idxprom1912.i.le = zext i32 %j.26.i to i64
  %idxprom1917.i.le = zext i32 %shr1916.i to i64
...
do.body.i.i116:                                   ; preds = %do.body.i.i116, %do.end1968.i
  ...
  %1252 = load i32, ptr %arrayidx.i2993.i, align 4, !tbaa !36
  %cmp.not.i.i111 = icmp sgt i32 %1252, %j.26.i
...
indexIntoF.exit.i118:                             ; preds = %do.body.i.i116
  ...
  %1253 = load ptr, ptr %ll16.i, align 8, !tbaa !39
  %arrayidx1976.i = getelementptr inbounds i16, ptr %1253, i64 %idxprom1912.i.le
  %1254 = load i16, ptr %arrayidx1976.i, align 2, !tbaa !40
  %conv1977.i = zext i16 %1254 to i32
  %1255 = load ptr, ptr %ll4.i, align 8, !tbaa !42
  %arrayidx1982.i = getelementptr inbounds i8, ptr %1255, i64 %idxprom1917.i.le
  %1256 = load i8, ptr %arrayidx1982.i, align 1, !tbaa !31
  %conv1983.i = zext i8 %1256 to i32
...
for.body1998.i:                                   ; preds = %for.body1998.i, %for.cond1995.preheader.i.new
  ...
  %niter568 = phi i64 [ 0, %for.cond1995.preheader.i.new ], [ %niter568.next.1, %for.body1998.i ]
  %arrayidx2001.i = getelementptr inbounds i32, ptr %1219, i64 %indvars.iv3388.i
  %1257 = load i32, ptr %arrayidx2001.i, align 4, !tbaa !36
  %1258 = trunc i64 %indvars.iv3388.i to i32
  %shl2004.i = shl i32 %1258, 8
  %1259 = and i32 %1257, 255
  %idxprom2007.i = zext i32 %1259 to i64
  %arrayidx2008.i = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 18, i64 %idxprom2007.i
  %1260 = load i32, ptr %arrayidx2008.i, align 4, !tbaa !36
  %idxprom2009.i = sext i32 %1260 to i64
  %arrayidx2010.i = getelementptr inbounds i32, ptr %1219, i64 %idxprom2009.i
  %1261 = load i32, ptr %arrayidx2010.i, align 4, !tbaa !36
  %or2011.i = or i32 %1261, %shl2004.i
  store i32 %or2011.i, ptr %arrayidx2010.i, align 4, !tbaa !36
  %1262 = load i32, ptr %arrayidx2008.i, align 4, !tbaa !36
  %inc2015.i = add nsw i32 %1262, 1
  store i32 %inc2015.i, ptr %arrayidx2008.i, align 4, !tbaa !36
  %indvars.iv.next3389.i = or i64 %indvars.iv3388.i, 1
  %arrayidx2001.i.1 = getelementptr inbounds i32, ptr %1219, i64 %indvars.iv.next3389.i
  %1263 = load i32, ptr %arrayidx2001.i.1, align 4, !tbaa !36
  %1264 = trunc i64 %indvars.iv.next3389.i to i32
  %shl2004.i.1 = shl i32 %1264, 8
  %1265 = and i32 %1263, 255
  %idxprom2007.i.1 = zext i32 %1265 to i64
  %arrayidx2008.i.1 = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 18, i64 %idxprom2007.i.1
  %1266 = load i32, ptr %arrayidx2008.i.1, align 4, !tbaa !36
  %idxprom2009.i.1 = sext i32 %1266 to i64
  %arrayidx2010.i.1 = getelementptr inbounds i32, ptr %1219, i64 %idxprom2009.i.1
  %1267 = load i32, ptr %arrayidx2010.i.1, align 4, !tbaa !36
  %or2011.i.1 = or i32 %1267, %shl2004.i.1
  store i32 %or2011.i.1, ptr %arrayidx2010.i.1, align 4, !tbaa !36
  %1268 = load i32, ptr %arrayidx2008.i.1, align 4, !tbaa !36
  %inc2015.i.1 = add nsw i32 %1268, 1
  ...
  br i1 %niter568.ncmp.1, label %for.end2018.loopexit.i.unr-lcssa, label %for.body1998.i, !llvm.loop !115
...
for.end2018.loopexit.i.unr-lcssa:                 ; preds = %for.body1998.i, %for.cond1995.preheader.i
  ...
  br i1 %lcmp.mod566.not, label %for.end2018.loopexit.i, label %for.body1998.i.epil

for.body1998.i.epil:                              ; preds = %for.end2018.loopexit.i.unr-lcssa
  %arrayidx2001.i.epil = getelementptr inbounds i32, ptr %1219, i64 %indvars.iv3388.i.unr
  %1269 = load i32, ptr %arrayidx2001.i.epil, align 4, !tbaa !36
  %1270 = trunc i64 %indvars.iv3388.i.unr to i32
  %shl2004.i.epil = shl i32 %1270, 8
  %1271 = and i32 %1269, 255
  %idxprom2007.i.epil = zext i32 %1271 to i64
  %arrayidx2008.i.epil = getelementptr inbounds %struct.DState, ptr %0, i64 0, i32 18, i64 %idxprom2007.i.epil
  %1272 = load i32, ptr %arrayidx2008.i.epil, align 4, !tbaa !36
  %idxprom2009.i.epil = sext i32 %1272 to i64
  %arrayidx2010.i.epil = getelementptr inbounds i32, ptr %1219, i64 %idxprom2009.i.epil
  %1273 = load i32, ptr %arrayidx2010.i.epil, align 4, !tbaa !36
  %or2011.i.epil = or i32 %1273, %shl2004.i.epil
  store i32 %or2011.i.epil, ptr %arrayidx2010.i.epil, align 4, !tbaa !36
  %1274 = load i32, ptr %arrayidx2008.i.epil, align 4, !tbaa !36
  %inc2015.i.epil = add nsw i32 %1274, 1
...
for.end2018.loopexit.i:                           ; preds = %for.end2018.loopexit.i.unr-lcssa, %for.body1998.i.epil
  ...
  %arrayidx2022.i = getelementptr inbounds i32, ptr %1219, i64 %idxprom2021.i
  %1275 = load i32, ptr %arrayidx2022.i, align 4, !tbaa !36
  %shr2023.i = lshr i32 %1275, 8
  store i32 %shr2023.i, ptr %tPos.i, align 4, !tbaa !35
  store i32 0, ptr %nblock_used.i, align 4, !tbaa !32
  %1276 = load i32, ptr %blockSize100k.i, align 8, !tbaa !49
  %mul2028.i = mul nsw i32 %1276, 100000
...
if.end2032.i:                                     ; preds = %for.end2018.loopexit.i
  ...
  %arrayidx2036.i = getelementptr inbounds i32, ptr %1219, i64 %idxprom2035.i
  %1277 = load i32, ptr %arrayidx2036.i, align 4, !tbaa !36
  %conv2041.i = and i32 %1277, 255
  store i32 %conv2041.i, ptr %k0.i, align 8, !tbaa !34
  %shr2044.i = lshr i32 %1277, 8
...
save_state_and_return.loopexit3243.i:             ; preds = %for.inc1805.i.2, %for.inc1805.i.1, %for.body1791.i.1, %for.body1791.i
  ...
  %1278 = trunc i64 %indvars.iv3370.i.lcssa to i32
  br label %BZ2_decompress.exit
...
BZ2_decompress.exit:                              ; preds = %if.end71.i, %if.end123.i, %if.end180.i, %if.end237.i, %if.end467.i, %if.end525.i, %if.end1019.i, %if.end1628.i, %if.end1692.i, %if.end1212.i, %while.body1354.i, %while.body1370.i, %if.end1276.i, %if.end1083.i, %if.end698.i, %if.end763.i, %if.end820.i, %if.end626.i, %if.end393.i, %if.end309.i, %if.end587.i, %if.end.i88, %if.then27.i, %if.else.i, %if.then65.i, %if.then227.i, %if.end281.i, %makeMaps_d.exit.i, %if.then458.i, %if.then458.i, %if.then458.i, %if.then516.i, %while.cond737.i, %if.then974.i, %while.cond1054.i, %while.end1120.i, %if.then1167.i, %while.cond1247.i, %while.end1313.i, %if.else1383.i, %if.then1583.i, %while.cond1663.i, %while.end1729.i, %while.end1748.i, %indexIntoF.exit.i118, %if.end2032.i, %endhdr_2.i, %save_state_and_return.loopexit3243.i
  %1279 = phi i32 [ %366, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %366, %if.then65.i ], [ %461, %if.then227.i ], [ %461, %if.end281.i ], [ %547, %makeMaps_d.exit.i ], [ %651, %if.then458.i ], [ %651, %if.then458.i ], [ %651, %if.then458.i ], [ %678, %if.then516.i ], [ %852, %while.cond737.i ], [ %791, %if.then974.i ], [ %1008, %while.cond1054.i ], [ %1008, %while.end1120.i ], [ %1024, %if.then1167.i ], [ %1035, %while.cond1247.i ], [ %1035, %while.end1313.i ], [ %1023, %if.else1383.i ], [ %1023, %if.then1583.i ], [ %1195, %while.cond1663.i ], [ %1195, %while.end1729.i ], [ %1023, %while.end1748.i ], [ %1023, %if.end2032.i ], [ %1023, %indexIntoF.exit.i118 ], [ %.pre3408.i, %if.end.i88 ], [ %1023, %save_state_and_return.loopexit3243.i ], [ %.ph495, %if.end587.i ], [ %516, %if.end309.i ], [ %592, %if.end393.i ], [ %.ph495, %if.end626.i ], [ %896, %if.end820.i ], [ %870, %if.end763.i ], [ %811, %if.end698.i ], [ %1013, %if.end1083.i ], [ %1037, %if.end1276.i ], [ %1035, %while.body1370.i ], [ %1035, %while.body1354.i ], [ %1027, %if.end1212.i ], [ %1197, %if.end1692.i ], [ %1187, %if.end1628.i ], [ %995, %if.end1019.i ], [ %678, %if.end525.i ], [ %651, %if.end467.i ], [ %461, %if.end237.i ], [ %429, %if.end180.i ], [ %397, %if.end123.i ], [ %366, %if.end71.i ]
  %zj.10.i = phi i32 [ %369, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %369, %if.then65.i ], [ %464, %if.then227.i ], [ %464, %if.end281.i ], [ %550, %makeMaps_d.exit.i ], [ %654, %if.then458.i ], [ %654, %if.then458.i ], [ %654, %if.then458.i ], [ %681, %if.then516.i ], [ %855, %while.cond737.i ], [ %794, %if.then974.i ], [ %zj.0.i, %while.cond1054.i ], [ %zj.0.i, %while.end1120.i ], [ %zj.3.i, %if.then1167.i ], [ %zj.5.i, %while.cond1247.i ], [ %zj.5.i, %while.end1313.i ], [ %zj.2.i, %if.else1383.i ], [ %zj.2.i, %if.then1583.i ], [ %zj.8.i, %while.cond1663.i ], [ %zj.8.i, %while.end1729.i ], [ %zj.2.i, %while.end1748.i ], [ %zj.2.i, %if.end2032.i ], [ %zj.2.i, %indexIntoF.exit.i118 ], [ %.pre3411.i, %if.end.i88 ], [ %zj.2.i, %save_state_and_return.loopexit3243.i ], [ %.ph498, %if.end587.i ], [ %519, %if.end309.i ], [ %595, %if.end393.i ], [ %.ph498, %if.end626.i ], [ %899, %if.end820.i ], [ %873, %if.end763.i ], [ %814, %if.end698.i ], [ %zj.1.i, %if.end1083.i ], [ %zj.6.i, %if.end1276.i ], [ %zj.5.i, %while.body1370.i ], [ %zj.5.i, %while.body1354.i ], [ %zj.4.i, %if.end1212.i ], [ %zj.9.i, %if.end1692.i ], [ %zj.7.i, %if.end1628.i ], [ %997, %if.end1019.i ], [ %681, %if.end525.i ], [ %654, %if.end467.i ], [ %464, %if.end237.i ], [ %432, %if.end180.i ], [ %400, %if.end123.i ], [ %369, %if.end71.i ]
  %gSel.14.i = phi i32 [ %370, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %370, %if.then65.i ], [ %465, %if.then227.i ], [ %465, %if.end281.i ], [ %551, %makeMaps_d.exit.i ], [ %655, %if.then458.i ], [ %655, %if.then458.i ], [ %655, %if.then458.i ], [ %682, %if.then516.i ], [ %856, %while.cond737.i ], [ %795, %if.then974.i ], [ %gSel.2.i, %while.cond1054.i ], [ %gSel.2.i, %while.end1120.i ], [ %gSel.5.i, %if.then1167.i ], [ %gSel.8.i, %while.cond1247.i ], [ %gSel.8.i, %while.end1313.i ], [ %gSel.4.i, %if.else1383.i ], [ %gSel.4.i, %if.then1583.i ], [ %gSel.12.i, %while.cond1663.i ], [ %gSel.12.i, %while.end1729.i ], [ %gSel.4.i, %while.end1748.i ], [ %gSel.4.i, %if.end2032.i ], [ %gSel.4.i, %indexIntoF.exit.i118 ], [ %.pre3412.i, %if.end.i88 ], [ %gSel.4.i, %save_state_and_return.loopexit3243.i ], [ %.ph499, %if.end587.i ], [ %520, %if.end309.i ], [ %596, %if.end393.i ], [ %.ph499, %if.end626.i ], [ %900, %if.end820.i ], [ %874, %if.end763.i ], [ %815, %if.end698.i ], [ %gSel.3.i, %if.end1083.i ], [ %gSel.9.i, %if.end1276.i ], [ %gSel.8.i, %while.body1370.i ], [ %gSel.8.i, %while.body1354.i ], [ %gSel.7.i, %if.end1212.i ], [ %gSel.13.i, %if.end1692.i ], [ %gSel.11.i, %if.end1628.i ], [ %gSel.1.i, %if.end1019.i ], [ %682, %if.end525.i ], [ %655, %if.end467.i ], [ %465, %if.end237.i ], [ %433, %if.end180.i ], [ %401, %if.end123.i ], [ %370, %if.end71.i ]
  %gMinlen.14.i = phi i32 [ %371, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %371, %if.then65.i ], [ %466, %if.then227.i ], [ %466, %if.end281.i ], [ %552, %makeMaps_d.exit.i ], [ %656, %if.then458.i ], [ %656, %if.then458.i ], [ %656, %if.then458.i ], [ %683, %if.then516.i ], [ %857, %while.cond737.i ], [ %796, %if.then974.i ], [ %gMinlen.2.i, %while.cond1054.i ], [ %gMinlen.2.i, %while.end1120.i ], [ %gMinlen.5.i, %if.then1167.i ], [ %gMinlen.8.i, %while.cond1247.i ], [ %gMinlen.8.i, %while.end1313.i ], [ %gMinlen.4.i, %if.else1383.i ], [ %gMinlen.4.i, %if.then1583.i ], [ %gMinlen.12.i, %while.cond1663.i ], [ %gMinlen.12.i, %while.end1729.i ], [ %gMinlen.4.i, %while.end1748.i ], [ %gMinlen.4.i, %if.end2032.i ], [ %gMinlen.4.i, %indexIntoF.exit.i118 ], [ %.pre3413.i, %if.end.i88 ], [ %gMinlen.4.i, %save_state_and_return.loopexit3243.i ], [ %.ph500, %if.end587.i ], [ %521, %if.end309.i ], [ %597, %if.end393.i ], [ %.ph500, %if.end626.i ], [ %901, %if.end820.i ], [ %875, %if.end763.i ], [ %816, %if.end698.i ], [ %gMinlen.3.i, %if.end1083.i ], [ %gMinlen.9.i, %if.end1276.i ], [ %gMinlen.8.i, %while.body1370.i ], [ %gMinlen.8.i, %while.body1354.i ], [ %gMinlen.7.i, %if.end1212.i ], [ %gMinlen.13.i, %if.end1692.i ], [ %gMinlen.11.i, %if.end1628.i ], [ %gMinlen.1.i, %if.end1019.i ], [ %683, %if.end525.i ], [ %656, %if.end467.i ], [ %466, %if.end237.i ], [ %434, %if.end180.i ], [ %402, %if.end123.i ], [ %371, %if.end71.i ]
  %gLimit.14.i = phi ptr [ %372, %endhdr_2.i ], [ null, %if.then27.i ], [ null, %if.else.i ], [ %372, %if.then65.i ], [ %467, %if.then227.i ], [ %467, %if.end281.i ], [ %553, %makeMaps_d.exit.i ], [ %657, %if.then458.i ], [ %657, %if.then458.i ], [ %657, %if.then458.i ], [ %684, %if.then516.i ], [ %858, %while.cond737.i ], [ %797, %if.then974.i ], [ %gLimit.2.i, %while.cond1054.i ], [ %gLimit.2.i, %while.end1120.i ], [ %gLimit.5.i, %if.then1167.i ], [ %gLimit.8.i, %while.cond1247.i ], [ %gLimit.8.i, %while.end1313.i ], [ %gLimit.4.i, %if.else1383.i ], [ %gLimit.4.i, %if.then1583.i ], [ %gLimit.12.i, %while.cond1663.i ], [ %gLimit.12.i, %while.end1729.i ], [ %gLimit.4.i, %while.end1748.i ], [ %gLimit.4.i, %if.end2032.i ], [ %gLimit.4.i, %indexIntoF.exit.i118 ], [ %.pre3414.i, %if.end.i88 ], [ %gLimit.4.i, %save_state_and_return.loopexit3243.i ], [ %.ph501, %if.end587.i ], [ %522, %if.end309.i ], [ %598, %if.end393.i ], [ %.ph501, %if.end626.i ], [ %902, %if.end820.i ], [ %876, %if.end763.i ], [ %817, %if.end698.i ], [ %gLimit.3.i, %if.end1083.i ], [ %gLimit.9.i, %if.end1276.i ], [ %gLimit.8.i, %while.body1370.i ], [ %gLimit.8.i, %while.body1354.i ], [ %gLimit.7.i, %if.end1212.i ], [ %gLimit.13.i, %if.end1692.i ], [ %gLimit.11.i, %if.end1628.i ], [ %gLimit.1.i, %if.end1019.i ], [ %684, %if.end525.i ], [ %657, %if.end467.i ], [ %467, %if.end237.i ], [ %435, %if.end180.i ], [ %403, %if.end123.i ], [ %372, %if.end71.i ]
  %gBase.14.i = phi ptr [ %373, %endhdr_2.i ], [ null, %if.then27.i ], [ null, %if.else.i ], [ %373, %if.then65.i ], [ %468, %if.then227.i ], [ %468, %if.end281.i ], [ %554, %makeMaps_d.exit.i ], [ %658, %if.then458.i ], [ %658, %if.then458.i ], [ %658, %if.then458.i ], [ %685, %if.then516.i ], [ %859, %while.cond737.i ], [ %798, %if.then974.i ], [ %gBase.2.i, %while.cond1054.i ], [ %gBase.2.i, %while.end1120.i ], [ %gBase.5.i, %if.then1167.i ], [ %gBase.8.i, %while.cond1247.i ], [ %gBase.8.i, %while.end1313.i ], [ %gBase.4.i, %if.else1383.i ], [ %gBase.4.i, %if.then1583.i ], [ %gBase.12.i, %while.cond1663.i ], [ %gBase.12.i, %while.end1729.i ], [ %gBase.4.i, %while.end1748.i ], [ %gBase.4.i, %if.end2032.i ], [ %gBase.4.i, %indexIntoF.exit.i118 ], [ %.pre3415.i, %if.end.i88 ], [ %gBase.4.i, %save_state_and_return.loopexit3243.i ], [ %.ph502, %if.end587.i ], [ %523, %if.end309.i ], [ %599, %if.end393.i ], [ %.ph502, %if.end626.i ], [ %903, %if.end820.i ], [ %877, %if.end763.i ], [ %818, %if.end698.i ], [ %gBase.3.i, %if.end1083.i ], [ %gBase.9.i, %if.end1276.i ], [ %gBase.8.i, %while.body1370.i ], [ %gBase.8.i, %while.body1354.i ], [ %gBase.7.i, %if.end1212.i ], [ %gBase.13.i, %if.end1692.i ], [ %gBase.11.i, %if.end1628.i ], [ %gBase.1.i, %if.end1019.i ], [ %685, %if.end525.i ], [ %658, %if.end467.i ], [ %468, %if.end237.i ], [ %436, %if.end180.i ], [ %404, %if.end123.i ], [ %373, %if.end71.i ]
  %gPerm.14.i = phi ptr [ %374, %endhdr_2.i ], [ null, %if.then27.i ], [ null, %if.else.i ], [ %374, %if.then65.i ], [ %469, %if.then227.i ], [ %469, %if.end281.i ], [ %555, %makeMaps_d.exit.i ], [ %659, %if.then458.i ], [ %659, %if.then458.i ], [ %659, %if.then458.i ], [ %686, %if.then516.i ], [ %860, %while.cond737.i ], [ %799, %if.then974.i ], [ %gPerm.2.i, %while.cond1054.i ], [ %gPerm.2.i, %while.end1120.i ], [ %gPerm.5.i, %if.then1167.i ], [ %gPerm.8.i, %while.cond1247.i ], [ %gPerm.8.i, %while.end1313.i ], [ %gPerm.4.i, %if.else1383.i ], [ %gPerm.4.i, %if.then1583.i ], [ %gPerm.12.i, %while.cond1663.i ], [ %gPerm.12.i, %while.end1729.i ], [ %gPerm.4.i, %while.end1748.i ], [ %gPerm.4.i, %if.end2032.i ], [ %gPerm.4.i, %indexIntoF.exit.i118 ], [ %.pre3416.i, %if.end.i88 ], [ %gPerm.4.i, %save_state_and_return.loopexit3243.i ], [ %.ph503, %if.end587.i ], [ %524, %if.end309.i ], [ %600, %if.end393.i ], [ %.ph503, %if.end626.i ], [ %904, %if.end820.i ], [ %878, %if.end763.i ], [ %819, %if.end698.i ], [ %gPerm.3.i, %if.end1083.i ], [ %gPerm.9.i, %if.end1276.i ], [ %gPerm.8.i, %while.body1370.i ], [ %gPerm.8.i, %while.body1354.i ], [ %gPerm.7.i, %if.end1212.i ], [ %gPerm.13.i, %if.end1692.i ], [ %gPerm.11.i, %if.end1628.i ], [ %gPerm.1.i, %if.end1019.i ], [ %686, %if.end525.i ], [ %659, %if.end467.i ], [ %469, %if.end237.i ], [ %437, %if.end180.i ], [ %405, %if.end123.i ], [ %374, %if.end71.i ]
  %zvec.10.i = phi i32 [ %368, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %368, %if.then65.i ], [ %463, %if.then227.i ], [ %463, %if.end281.i ], [ %549, %makeMaps_d.exit.i ], [ %653, %if.then458.i ], [ %653, %if.then458.i ], [ %653, %if.then458.i ], [ %680, %if.then516.i ], [ %854, %while.cond737.i ], [ %793, %if.then974.i ], [ %zvec.0.i, %while.cond1054.i ], [ %zvec.0.i, %while.end1120.i ], [ %zvec.3.i, %if.then1167.i ], [ %zvec.5.i, %while.cond1247.i ], [ %zvec.5.i, %while.end1313.i ], [ %zvec.2.i, %if.else1383.i ], [ %zvec.2.i, %if.then1583.i ], [ %zvec.8.i, %while.cond1663.i ], [ %zvec.8.i, %while.end1729.i ], [ %zvec.2.i, %while.end1748.i ], [ %zvec.2.i, %if.end2032.i ], [ %zvec.2.i, %indexIntoF.exit.i118 ], [ %.pre3410.i, %if.end.i88 ], [ %zvec.2.i, %save_state_and_return.loopexit3243.i ], [ %.ph497, %if.end587.i ], [ %518, %if.end309.i ], [ %594, %if.end393.i ], [ %.ph497, %if.end626.i ], [ %898, %if.end820.i ], [ %872, %if.end763.i ], [ %813, %if.end698.i ], [ %zvec.1.i, %if.end1083.i ], [ %zvec.6.i, %if.end1276.i ], [ %zvec.5.i, %while.body1370.i ], [ %zvec.5.i, %while.body1354.i ], [ %zvec.4.i, %if.end1212.i ], [ %zvec.9.i, %if.end1692.i ], [ %zvec.7.i, %if.end1628.i ], [ %996, %if.end1019.i ], [ %680, %if.end525.i ], [ %653, %if.end467.i ], [ %463, %if.end237.i ], [ %431, %if.end180.i ], [ %399, %if.end123.i ], [ %368, %if.end71.i ]
  %zn.11.i = phi i32 [ %367, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %367, %if.then65.i ], [ %462, %if.then227.i ], [ %462, %if.end281.i ], [ %548, %makeMaps_d.exit.i ], [ %652, %if.then458.i ], [ %652, %if.then458.i ], [ %652, %if.then458.i ], [ %679, %if.then516.i ], [ %853, %while.cond737.i ], [ %792, %if.then974.i ], [ %zn.1.i, %while.cond1054.i ], [ %zn.1.i, %while.end1120.i ], [ %zn.4.i, %if.then1167.i ], [ %zn.6.i, %while.cond1247.i ], [ %zn.6.i, %while.end1313.i ], [ %zn.3.i, %if.else1383.i ], [ %zn.3.i, %if.then1583.i ], [ %zn.9.i, %while.cond1663.i ], [ %zn.9.i, %while.end1729.i ], [ %zn.3.i, %while.end1748.i ], [ %zn.3.i, %if.end2032.i ], [ %zn.3.i, %indexIntoF.exit.i118 ], [ %.pre3409.i, %if.end.i88 ], [ %zn.3.i, %save_state_and_return.loopexit3243.i ], [ %.ph496, %if.end587.i ], [ %517, %if.end309.i ], [ %593, %if.end393.i ], [ %.ph496, %if.end626.i ], [ %897, %if.end820.i ], [ %871, %if.end763.i ], [ %812, %if.end698.i ], [ %zn.2.i, %if.end1083.i ], [ %zn.7.i, %if.end1276.i ], [ %zn.6.i, %while.body1370.i ], [ %zn.6.i, %while.body1354.i ], [ %zn.5.i, %if.end1212.i ], [ %zn.10.i, %if.end1692.i ], [ %zn.8.i, %if.end1628.i ], [ %zn.0.i, %if.end1019.i ], [ %679, %if.end525.i ], [ %652, %if.end467.i ], [ %462, %if.end237.i ], [ %430, %if.end180.i ], [ %398, %if.end123.i ], [ %367, %if.end71.i ]
  %curr.18.i = phi i32 [ %365, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %365, %if.then65.i ], [ %460, %if.then227.i ], [ %460, %if.end281.i ], [ %546, %makeMaps_d.exit.i ], [ %650, %if.then458.i ], [ %650, %if.then458.i ], [ %650, %if.then458.i ], [ %677, %if.then516.i ], [ %curr.3.i, %while.cond737.i ], [ %curr.0.i, %if.then974.i ], [ %curr.8.i, %while.cond1054.i ], [ %curr.8.i, %while.end1120.i ], [ %curr.11.i, %if.then1167.i ], [ %curr.13.i, %while.cond1247.i ], [ %curr.13.i, %while.end1313.i ], [ %curr.10.i, %if.else1383.i ], [ %curr.10.i, %if.then1583.i ], [ %curr.16.i, %while.cond1663.i ], [ %curr.16.i, %while.end1729.i ], [ %curr.10.i, %while.end1748.i ], [ %curr.10.i, %if.end2032.i ], [ %curr.10.i, %indexIntoF.exit.i118 ], [ %.pre3407.i, %if.end.i88 ], [ %curr.10.i, %save_state_and_return.loopexit3243.i ], [ %.ph494, %if.end587.i ], [ %515, %if.end309.i ], [ %591, %if.end393.i ], [ %.ph494, %if.end626.i ], [ %curr.5.i, %if.end820.i ], [ %curr.4.i, %if.end763.i ], [ %curr.1.i, %if.end698.i ], [ %curr.9.i, %if.end1083.i ], [ %curr.14.i, %if.end1276.i ], [ %curr.13.i, %while.body1370.i ], [ %curr.13.i, %while.body1354.i ], [ %curr.12.i, %if.end1212.i ], [ %curr.17.i, %if.end1692.i ], [ %curr.15.i, %if.end1628.i ], [ %curr.7.i, %if.end1019.i ], [ %677, %if.end525.i ], [ %650, %if.end467.i ], [ %460, %if.end237.i ], [ %428, %if.end180.i ], [ %396, %if.end123.i ], [ %365, %if.end71.i ]
  %N.8.i = phi i32 [ %364, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %364, %if.then65.i ], [ %459, %if.then227.i ], [ %459, %if.end281.i ], [ %545, %makeMaps_d.exit.i ], [ %649, %if.then458.i ], [ %649, %if.then458.i ], [ %649, %if.then458.i ], [ %676, %if.then516.i ], [ %851, %while.cond737.i ], [ %790, %if.then974.i ], [ %1007, %while.cond1054.i ], [ %1007, %while.end1120.i ], [ %mul1160.i, %if.then1167.i ], [ %N.3.i, %while.cond1247.i ], [ %N.3.i, %while.end1313.i ], [ %N.0.i, %if.else1383.i ], [ %N.0.i, %if.then1583.i ], [ %N.6.i, %while.cond1663.i ], [ %N.6.i, %while.end1729.i ], [ %N.0.i, %while.end1748.i ], [ %N.0.i, %if.end2032.i ], [ %N.0.i, %indexIntoF.exit.i118 ], [ %.pre3406.i, %if.end.i88 ], [ %N.0.i, %save_state_and_return.loopexit3243.i ], [ %.ph493, %if.end587.i ], [ %514, %if.end309.i ], [ %590, %if.end393.i ], [ %.ph493, %if.end626.i ], [ %895, %if.end820.i ], [ %869, %if.end763.i ], [ %810, %if.end698.i ], [ %1012, %if.end1083.i ], [ %N.4.i, %if.end1276.i ], [ %N.3.i, %while.body1370.i ], [ %N.3.i, %while.body1354.i ], [ %N.2.i, %if.end1212.i ], [ %N.7.i, %if.end1692.i ], [ %N.5.i, %if.end1628.i ], [ %994, %if.end1019.i ], [ %676, %if.end525.i ], [ %649, %if.end467.i ], [ %459, %if.end237.i ], [ %427, %if.end180.i ], [ %395, %if.end123.i ], [ %364, %if.end71.i ]
  %es.12.i = phi i32 [ %363, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %363, %if.then65.i ], [ %458, %if.then227.i ], [ %458, %if.end281.i ], [ %544, %makeMaps_d.exit.i ], [ %648, %if.then458.i ], [ %648, %if.then458.i ], [ %648, %if.then458.i ], [ %675, %if.then516.i ], [ %850, %while.cond737.i ], [ %789, %if.then974.i ], [ %1006, %while.cond1054.i ], [ %1006, %while.end1120.i ], [ %es.2.i, %if.then1167.i ], [ %es.4.i, %while.cond1247.i ], [ %es.4.i, %while.end1313.i ], [ %es.0.i, %if.else1383.i ], [ %es.0.i, %if.then1583.i ], [ %es.10.i, %while.cond1663.i ], [ %es.10.i, %while.end1729.i ], [ %es.0.i, %while.end1748.i ], [ %es.0.i, %if.end2032.i ], [ %es.0.i, %indexIntoF.exit.i118 ], [ %.pre3405.i, %if.end.i88 ], [ %es.0.i, %save_state_and_return.loopexit3243.i ], [ %.ph492, %if.end587.i ], [ %513, %if.end309.i ], [ %589, %if.end393.i ], [ %.ph492, %if.end626.i ], [ %894, %if.end820.i ], [ %868, %if.end763.i ], [ %809, %if.end698.i ], [ %1011, %if.end1083.i ], [ %es.5.i, %if.end1276.i ], [ %es.73176.i, %while.body1370.i ], [ %es.63171.i, %while.body1354.i ], [ %es.3.i, %if.end1212.i ], [ %es.11.i, %if.end1692.i ], [ %es.9.i, %if.end1628.i ], [ %993, %if.end1019.i ], [ %675, %if.end525.i ], [ %648, %if.end467.i ], [ %458, %if.end237.i ], [ %426, %if.end180.i ], [ %394, %if.end123.i ], [ %363, %if.end71.i ]
  %nblock.14.i = phi i32 [ %362, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %362, %if.then65.i ], [ %457, %if.then227.i ], [ %457, %if.end281.i ], [ %543, %makeMaps_d.exit.i ], [ %647, %if.then458.i ], [ %647, %if.then458.i ], [ %647, %if.then458.i ], [ %674, %if.then516.i ], [ %849, %while.cond737.i ], [ 0, %if.then974.i ], [ %nblock.1.i, %while.cond1054.i ], [ %nblock.1.i, %while.end1120.i ], [ %nblock.4.i, %if.then1167.i ], [ %nblock.6.i, %while.cond1247.i ], [ %nblock.6.i, %while.end1313.i ], [ %nblock.3.i, %if.else1383.i ], [ %inc1580.i, %if.then1583.i ], [ %nblock.12.i, %while.cond1663.i ], [ %nblock.12.i, %while.end1729.i ], [ %nblock.3.i, %while.end1748.i ], [ %nblock.3.i, %if.end2032.i ], [ %nblock.3.i, %indexIntoF.exit.i118 ], [ %.pre3404.i, %if.end.i88 ], [ %nblock.3.i, %save_state_and_return.loopexit3243.i ], [ %.ph491, %if.end587.i ], [ %512, %if.end309.i ], [ %588, %if.end393.i ], [ %.ph491, %if.end626.i ], [ %893, %if.end820.i ], [ %867, %if.end763.i ], [ %808, %if.end698.i ], [ %nblock.2.i, %if.end1083.i ], [ %nblock.7.i, %if.end1276.i ], [ %smax3353.i, %while.body1370.i ], [ %smax.i, %while.body1354.i ], [ %nblock.5.i, %if.end1212.i ], [ %nblock.13.i, %if.end1692.i ], [ %nblock.11.i, %if.end1628.i ], [ %nblock.0.i, %if.end1019.i ], [ %674, %if.end525.i ], [ %647, %if.end467.i ], [ %457, %if.end237.i ], [ %425, %if.end180.i ], [ %393, %if.end123.i ], [ %362, %if.end71.i ]
  %nblockMAX.11.i = phi i32 [ %361, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %361, %if.then65.i ], [ %456, %if.then227.i ], [ %456, %if.end281.i ], [ %542, %makeMaps_d.exit.i ], [ %646, %if.then458.i ], [ %646, %if.then458.i ], [ %646, %if.then458.i ], [ %673, %if.then516.i ], [ %848, %while.cond737.i ], [ %mul939.i, %if.then974.i ], [ %nblockMAX.1.i, %while.cond1054.i ], [ %nblockMAX.1.i, %while.end1120.i ], [ %nblockMAX.4.i, %if.then1167.i ], [ %nblockMAX.6.i, %while.cond1247.i ], [ %nblockMAX.6.i, %while.end1313.i ], [ %nblockMAX.3.i, %if.else1383.i ], [ %nblockMAX.3.i, %if.then1583.i ], [ %nblockMAX.9.i, %while.cond1663.i ], [ %nblockMAX.9.i, %while.end1729.i ], [ %nblockMAX.3.i, %while.end1748.i ], [ %nblockMAX.3.i, %if.end2032.i ], [ %nblockMAX.3.i, %indexIntoF.exit.i118 ], [ %.pre3403.i, %if.end.i88 ], [ %nblockMAX.3.i, %save_state_and_return.loopexit3243.i ], [ %.ph490, %if.end587.i ], [ %511, %if.end309.i ], [ %587, %if.end393.i ], [ %.ph490, %if.end626.i ], [ %892, %if.end820.i ], [ %866, %if.end763.i ], [ %807, %if.end698.i ], [ %nblockMAX.2.i, %if.end1083.i ], [ %nblockMAX.7.i, %if.end1276.i ], [ %nblockMAX.6.i, %while.body1370.i ], [ %nblockMAX.6.i, %while.body1354.i ], [ %nblockMAX.5.i, %if.end1212.i ], [ %nblockMAX.10.i, %if.end1692.i ], [ %nblockMAX.8.i, %if.end1628.i ], [ %nblockMAX.0.i, %if.end1019.i ], [ %673, %if.end525.i ], [ %646, %if.end467.i ], [ %456, %if.end237.i ], [ %424, %if.end180.i ], [ %392, %if.end123.i ], [ %361, %if.end71.i ]
  %nextSym.8.i = phi i32 [ %360, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %360, %if.then65.i ], [ %455, %if.then227.i ], [ %455, %if.end281.i ], [ %541, %makeMaps_d.exit.i ], [ %645, %if.then458.i ], [ %645, %if.then458.i ], [ %645, %if.then458.i ], [ %672, %if.then516.i ], [ %847, %while.cond737.i ], [ %786, %if.then974.i ], [ %1005, %while.cond1054.i ], [ %1005, %while.end1120.i ], [ %nextSym.1.i, %if.then1167.i ], [ %nextSym.3.i, %while.cond1247.i ], [ %nextSym.3.i, %while.end1313.i ], [ %nextSym.0.i, %if.else1383.i ], [ %nextSym.0.i, %if.then1583.i ], [ %nextSym.6.i, %while.cond1663.i ], [ %nextSym.6.i, %while.end1729.i ], [ %nextSym.0.i, %while.end1748.i ], [ %nextSym.0.i, %if.end2032.i ], [ %nextSym.0.i, %indexIntoF.exit.i118 ], [ %.pre3402.i, %if.end.i88 ], [ %nextSym.0.i, %save_state_and_return.loopexit3243.i ], [ %.ph489, %if.end587.i ], [ %510, %if.end309.i ], [ %586, %if.end393.i ], [ %.ph489, %if.end626.i ], [ %891, %if.end820.i ], [ %865, %if.end763.i ], [ %806, %if.end698.i ], [ %1010, %if.end1083.i ], [ %nextSym.4.i, %if.end1276.i ], [ %1046, %while.body1370.i ], [ %1046, %while.body1354.i ], [ %nextSym.2.i, %if.end1212.i ], [ %nextSym.7.i, %if.end1692.i ], [ %nextSym.5.i, %if.end1628.i ], [ %992, %if.end1019.i ], [ %672, %if.end525.i ], [ %645, %if.end467.i ], [ %455, %if.end237.i ], [ %423, %if.end180.i ], [ %391, %if.end123.i ], [ %360, %if.end71.i ]
  %groupPos.14.i = phi i32 [ %359, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %359, %if.then65.i ], [ %454, %if.then227.i ], [ %454, %if.end281.i ], [ %540, %makeMaps_d.exit.i ], [ %644, %if.then458.i ], [ %644, %if.then458.i ], [ %644, %if.then458.i ], [ %671, %if.then516.i ], [ %846, %while.cond737.i ], [ 0, %if.then974.i ], [ %groupPos.2.i, %while.cond1054.i ], [ %groupPos.2.i, %while.end1120.i ], [ 0, %if.then1167.i ], [ %groupPos.8.i, %while.cond1247.i ], [ %groupPos.8.i, %while.end1313.i ], [ %groupPos.4.i, %if.else1383.i ], [ 0, %if.then1583.i ], [ %groupPos.12.i, %while.cond1663.i ], [ %groupPos.12.i, %while.end1729.i ], [ %groupPos.4.i, %while.end1748.i ], [ %groupPos.4.i, %if.end2032.i ], [ %groupPos.4.i, %indexIntoF.exit.i118 ], [ %.pre3401.i, %if.end.i88 ], [ %groupPos.4.i, %save_state_and_return.loopexit3243.i ], [ %.ph488, %if.end587.i ], [ %509, %if.end309.i ], [ %585, %if.end393.i ], [ %.ph488, %if.end626.i ], [ %890, %if.end820.i ], [ %864, %if.end763.i ], [ %805, %if.end698.i ], [ %groupPos.3.i, %if.end1083.i ], [ %groupPos.9.i, %if.end1276.i ], [ %groupPos.8.i, %while.body1370.i ], [ %groupPos.8.i, %while.body1354.i ], [ %groupPos.7.i, %if.end1212.i ], [ %groupPos.13.i, %if.end1692.i ], [ %groupPos.11.i, %if.end1628.i ], [ %groupPos.1.i, %if.end1019.i ], [ %671, %if.end525.i ], [ %644, %if.end467.i ], [ %454, %if.end237.i ], [ %422, %if.end180.i ], [ %390, %if.end123.i ], [ %359, %if.end71.i ]
  %groupNo.14.i = phi i32 [ %358, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %358, %if.then65.i ], [ %453, %if.then227.i ], [ %453, %if.end281.i ], [ %539, %makeMaps_d.exit.i ], [ %643, %if.then458.i ], [ %643, %if.then458.i ], [ %643, %if.then458.i ], [ %670, %if.then516.i ], [ %845, %while.cond737.i ], [ 0, %if.then974.i ], [ %groupNo.2.i, %while.cond1054.i ], [ %groupNo.2.i, %while.end1120.i ], [ %inc1168.i, %if.then1167.i ], [ %groupNo.8.i, %while.cond1247.i ], [ %groupNo.8.i, %while.end1313.i ], [ %groupNo.4.i, %if.else1383.i ], [ %inc1584.i, %if.then1583.i ], [ %groupNo.12.i, %while.cond1663.i ], [ %groupNo.12.i, %while.end1729.i ], [ %groupNo.4.i, %while.end1748.i ], [ %groupNo.4.i, %if.end2032.i ], [ %groupNo.4.i, %indexIntoF.exit.i118 ], [ %.pre3400.i, %if.end.i88 ], [ %groupNo.4.i, %save_state_and_return.loopexit3243.i ], [ %.ph487, %if.end587.i ], [ %508, %if.end309.i ], [ %584, %if.end393.i ], [ %.ph487, %if.end626.i ], [ %889, %if.end820.i ], [ %863, %if.end763.i ], [ %804, %if.end698.i ], [ %groupNo.3.i, %if.end1083.i ], [ %groupNo.9.i, %if.end1276.i ], [ %groupNo.8.i, %while.body1370.i ], [ %groupNo.8.i, %while.body1354.i ], [ %groupNo.7.i, %if.end1212.i ], [ %groupNo.13.i, %if.end1692.i ], [ %groupNo.11.i, %if.end1628.i ], [ %groupNo.1.i, %if.end1019.i ], [ %670, %if.end525.i ], [ %643, %if.end467.i ], [ %453, %if.end237.i ], [ %421, %if.end180.i ], [ %389, %if.end123.i ], [ %358, %if.end71.i ]
  %EOB.11.i = phi i32 [ %357, %endhdr_2.i ], [ 0, %if.then27.i ], [ 0, %if.else.i ], [ %357, %if.then65.i ], [ %452, %if.then227.i ], [ %452, %if.end281.i ], [ %538, %makeMaps_d.exit.i ], [ %642, %if.then458.i ], [ %642, %if.then458.i ], [ %642, %if.then458.i ], [ %669, %if.then516.i ], [ %844, %while.cond737.i ], [ %add937.i, %if.then974.i ], [ %EOB.1.i, %while.cond1054.i ], [ %EOB.1.i, %while.end1120.i ], [ %EOB.4.i, %if.then1167.i ], [ %EOB.6.i, %while.cond1247.i ], [ %EOB.6.i, %while.end1313.i ], [ %EOB.3.i, %if.else1383.i ], [ %EOB.3.i, %if.then1583.i ], [ %EOB.9.i, %while.cond1663.i ], [ %EOB.9.i, %while.end1729.i ], [ %nextSym.0.i, %while.end1748.i ], [ %nextSym.0.i, %if.end2032.i ], [ %nextSym.0.i, %indexIntoF.exit.i118 ], [ %.pre3399.i, %if.end.i88 ], [ %nextSym.0.i, %save_state_and_return.loopexit3243.i ], [ %.ph486, %if.end587.i ], [ %507, %if.end309.i ], [ %583, %if.end393.i ], [ %.ph486, %if.end626.i ], [ %888, %if.end820.i ], [ %862, %if.end763.i ], [ %803, %if.end698.i ], [ %EOB.2.i, %if.end1083.i ], [ %EOB.7.i, %if.end1276.i ], [ %EOB.6.i, %while.body1370.i ], [ %EOB.6.i, %while.body1354.i ], [ %EOB.5.i, %if.end1212.i ], [ %EOB.10.i, %if.end1692.i ], [ %EOB.8.i, %if.end1628.i ], [ %EOB.0.i, %if.end1019.i ], [ %669, %if.end525.i ], [ %642, %if.end467.i ], [ %452, %if.end237.i ], [ %420, %if.end180.i ], [ %388, %if.end123.i ], [ %357, %if.end71.i ]
  ...
  store i32 %1279, ptr %save_zt17.phi.trans.insert.i, align 8, !tbaa !64
...
cleanup:                                          ; preds = %for.end2018.loopexit.i, %BZ2_decompress.exit
  ...
  %1280 = load i32, ptr %state8, align 8, !tbaa !16
  %cmp36.not = icmp eq i32 %1280, 2
...
if.then9:                                         ; preds = %if.end7
  ...
  tail call void %3(ptr noundef %4, ptr noundef nonnull %2) #8
  br label %if.end11
...
if.then13:                                        ; preds = %if.end11
  ...
  tail call void %6(ptr noundef %7, ptr noundef nonnull %5) #8
  br label %if.end17
...
if.then19:                                        ; preds = %if.end17
  ...
  tail call void %9(ptr noundef %10, ptr noundef nonnull %8) #8
  br label %if.end23
...
if.end23:                                         ; preds = %if.then19, %if.end17
  ...
  tail call void %11(ptr noundef %12, ptr noundef %13) #8
