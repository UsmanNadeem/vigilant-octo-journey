; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/compiler/parser.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/compiler/parser.c"
...
while.cond:                                       ; preds = %match.exit338, %entry
  %0 = load i32, ptr @lookahead, align 4, !tbaa !5
  switch i32 %0, label %if.else.i315 [
    i32 259, label %if.then
    i32 2002, label %if.then.i
    i32 2003, label %if.then.i310
  ]
...
if.then:                                          ; preds = %while.cond
  ...
  br i1 %tobool.not, label %cond.end107, label %cleanup

cond.end107:                                      ; preds = %if.then
  %bcmp307 = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(5) @.str.7, ptr noundef nonnull dereferenceable(5) @lexbuf, i64 5)
  %cmp109 = icmp eq i32 %bcmp307, 0
  br i1 %cmp109, label %if.then111, label %cleanup.sink.split
...
match.exit:                                       ; preds = %if.then.i, %if.then2.i
  ...
  %8 = load i32, ptr @ErrorFlag, align 4, !tbaa !5
  %tobool119.not = icmp eq i32 %8, 0
  br i1 %tobool119.not, label %if.end127, label %cleanup

if.then.i310:                                     ; preds = %while.cond
  ...
  %cmp1.not.i309 = icmp eq i32 %11, 260
  br i1 %cmp1.not.i309, label %match.exit321, label %if.then2.i312

if.then2.i312:                                    ; preds = %if.then.i310
  %call.i311 = tail call i32 @lexan() #7
  store i32 %call.i311, ptr @NextLookahead, align 4, !tbaa !5
  br label %match.exit321

if.else.i315:                                     ; preds = %while.cond
  %.off.i313 = add i32 %0, -2007
  %switch.i314 = icmp ult i32 %.off.i313, 2
  br i1 %switch.i314, label %sw.bb.i316, label %sw.epilog.i318

sw.bb.i316:                                       ; preds = %if.else.i315
  tail call void @error(ptr noundef nonnull @.str) #7
  br label %sw.epilog.i318

sw.epilog.i318:                                   ; preds = %sw.bb.i316, %if.else.i315
  %14 = load i32, ptr @ErrorFlag, align 4, !tbaa !5
  %tobool.not.i317 = icmp eq i32 %14, 0
  br i1 %tobool.not.i317, label %if.end4.i319, label %cleanup

if.end4.i319:                                     ; preds = %sw.epilog.i318
  %15 = load i32, ptr @lookahead, align 4, !tbaa !5
  %call6.i320 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %15)
  tail call void @error(ptr noundef nonnull @.str.3) #7
  br label %match.exit321

match.exit321:                                    ; preds = %if.then.i310, %if.then2.i312, %if.end4.i319
  %.pr = load i32, ptr @ErrorFlag, align 4, !tbaa !5
  %tobool123.not = icmp eq i32 %.pr, 0
  br i1 %tobool123.not, label %match.exit321.if.end127_crit_edge, label %cleanup

match.exit321.if.end127_crit_edge:                ; preds = %match.exit321
  %.pre = load i32, ptr @NextLookahead, align 4, !tbaa !5
  br label %if.end127

if.end127:                                        ; preds = %match.exit321.if.end127_crit_edge, %match.exit
  %16 = phi i32 [ %.pre, %match.exit321.if.end127_crit_edge ], [ %7, %match.exit ]
  %cmp128 = icmp eq i32 %16, 40
  br i1 %cmp128, label %if.then130, label %if.else270

if.then130:                                       ; preds = %if.end127
  tail call void @emit(i32 noundef 2026, i32 noundef 0, float noundef 0.000000e+00) #7
  store i32 4, ptr @LabelCounter, align 4, !tbaa !5
  %call131 = tail call i32 @GlobalInsert(ptr noundef nonnull @.str.7, i32 noundef 259, i32 noundef 2002, i32 noundef 0, i32 noundef 1, i32 noundef 1) #7
  %17 = load i32, ptr @ErrorFlag, align 4, !tbaa !5
  %tobool132.not = icmp eq i32 %17, 0
  br i1 %tobool132.not, label %cond.end261, label %cleanup

cond.end261:                                      ; preds = %if.then130
  %bcmp = tail call i32 @bcmp(ptr noundef nonnull dereferenceable(5) @.str.7, ptr noundef nonnull dereferenceable(5) @lexbuf, i64 5)
  %cmp263 = icmp eq i32 %bcmp, 0
  br i1 %cmp263, label %if.then265, label %if.end266

if.then265:                                       ; preds = %cond.end261
  store i32 %call131, ptr @GlobalIndex, align 4, !tbaa !5
  br label %if.end266

if.end266:                                        ; preds = %if.then265, %cond.end261
  %18 = load i32, ptr @PreviousLookahead, align 4, !tbaa !5
  br label %cleanup.sink.split

if.else270:                                       ; preds = %if.end127
  %19 = load i32, ptr @PreviousLookahead, align 4, !tbaa !5
  tail call void @GlobalScopeAndInsert(i32 noundef %19)
  %20 = load i32, ptr @ErrorFlag, align 4, !tbaa !5
  %tobool271.not = icmp eq i32 %20, 0
  br i1 %tobool271.not, label %if.end273, label %cleanup

if.end273:                                        ; preds = %if.else270
  %.old.i = load i32, ptr @lookahead, align 4, !tbaa !5
  %cmp.old.i = icmp eq i32 %.old.i, 44
  br i1 %cmp.old.i, label %if.then.i.i, label %if.end276

if.then.i.i:                                      ; preds = %if.end273, %if.then3.i
...
match.exit.i:                                     ; preds = %if.then.i.i
  ...
  %.pre349 = load i32, ptr @ErrorFlag, align 4, !tbaa !5
  %tobool.not.i322 = icmp eq i32 %.pre349, 0
  br i1 %tobool.not.i322, label %if.end.i, label %cleanup

if.end.i:                                         ; preds = %if.then.i.i, %match.exit.i
  %26 = load i32, ptr @lookahead, align 4, !tbaa !5
  switch i32 %26, label %if.else.i324 [
...
if.then3.i:                                       ; preds = %if.end.i, %if.end.i
  ...
  %cmp.i323 = icmp eq i32 %28, 44
  %or.cond8.i = select i1 %tobool4.i, i1 %cmp.i323, i1 false
  br i1 %or.cond8.i, label %if.then.i.i, label %GlobalVarList.exit, !llvm.loop !19

if.else.i324:                                     ; preds = %if.end.i
  tail call void @error(ptr noundef nonnull @.str.12) #7
  %.pr340 = load i32, ptr @ErrorFlag, align 4, !tbaa !5
  br label %GlobalVarList.exit

GlobalVarList.exit:                               ; preds = %if.then3.i, %if.else.i324
  %29 = phi i32 [ %.pr340, %if.else.i324 ], [ %27, %if.then3.i ]
  %tobool274.not = icmp eq i32 %29, 0
  br i1 %tobool274.not, label %if.end276thread-pre-split, label %cleanup

if.end276thread-pre-split:                        ; preds = %GlobalVarList.exit
  %.pr344 = load i32, ptr @lookahead, align 4, !tbaa !5
  br label %if.end276

if.end276:                                        ; preds = %if.end273, %if.end276thread-pre-split
  %30 = phi i32 [ %.pr344, %if.end276thread-pre-split ], [ %.old.i, %if.end273 ]
  %cmp.i325 = icmp eq i32 %30, 59
  br i1 %cmp.i325, label %if.then.i327, label %if.else.i332

if.then.i327:                                     ; preds = %if.end276
  ...
  %cmp1.not.i326 = icmp eq i32 %33, 260
  br i1 %cmp1.not.i326, label %match.exit338, label %if.then2.i329

if.then2.i329:                                    ; preds = %if.then.i327
  %call.i328 = tail call i32 @lexan() #7
  store i32 %call.i328, ptr @NextLookahead, align 4, !tbaa !5
  br label %match.exit338

if.else.i332:                                     ; preds = %if.end276
  %.off.i330 = add i32 %30, -2007
  %switch.i331 = icmp ult i32 %.off.i330, 2
  br i1 %switch.i331, label %sw.epilog.i335, label %if.end4.i336

sw.epilog.i335:                                   ; preds = %if.else.i332
  tail call void @error(ptr noundef nonnull @.str) #7
  %.pre350 = load i32, ptr @ErrorFlag, align 4, !tbaa !5
  %tobool.not.i334 = icmp eq i32 %.pre350, 0
  br i1 %tobool.not.i334, label %if.end4.i336, label %cleanup

if.end4.i336:                                     ; preds = %if.else.i332, %sw.epilog.i335
  %36 = load i32, ptr @lookahead, align 4, !tbaa !5
  %call6.i337 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %36)
  tail call void @error(ptr noundef nonnull @.str.3) #7
  br label %match.exit338

match.exit338:                                    ; preds = %if.then.i327, %if.then2.i329, %if.end4.i336
  %.pr345 = load i32, ptr @ErrorFlag, align 4, !tbaa !5
  %tobool277.not = icmp eq i32 %.pr345, 0
  br i1 %tobool277.not, label %while.cond, label %cleanup

cleanup.sink.split:                               ; preds = %cond.end107, %if.then111, %if.end266
  %.sink = phi i32 [ %18, %if.end266 ], [ 2002, %if.then111 ], [ 2002, %cond.end107 ]
  tail call void @FunctionDef(i32 noundef %.sink)
  br label %cleanup

cleanup:                                          ; preds = %sw.epilog.i335, %sw.epilog.i318, %match.exit338, %GlobalVarList.exit, %if.else270, %match.exit321, %match.exit, %match.exit.i, %cleanup.sink.split, %if.then130, %if.then
  ret void
}
...
if.end39:                                         ; preds = %if.then38, %match.exit
  ...
  %cmp.i260 = icmp eq i32 %20, 40
  br i1 %cmp.i260, label %if.then.i262, label %if.else.i267

if.then.i262:                                     ; preds = %if.end39
  store i32 40, ptr @PreviousLookahead, align 4, !tbaa !5
  %21 = load i32, ptr @tokenval, align 4, !tbaa !5
  store i32 %21, ptr @PreviousTokenval, align 4, !tbaa !5
  %22 = load float, ptr @ftokenval, align 4, !tbaa !11
  ...
  %25 = load float, ptr @NextFtokenval, align 4, !tbaa !11
  store float %25, ptr @ftokenval, align 4, !tbaa !11
  %cmp1.not.i261 = icmp eq i32 %23, 260
  br i1 %cmp1.not.i261, label %match.exit273, label %if.then2.i264
...
if.else.i267:                                     ; preds = %if.end39
  %.off.i265 = add i32 %20, -2007
  %switch.i266 = icmp ult i32 %.off.i265, 2
  br i1 %switch.i266, label %sw.epilog.i270, label %if.end4.i271

sw.epilog.i270:                                   ; preds = %if.else.i267
  tail call void @error(ptr noundef nonnull @.str) #7
  %.pre308 = load i32, ptr @ErrorFlag, align 4, !tbaa !5
  %tobool.not.i269 = icmp eq i32 %.pre308, 0
  br i1 %tobool.not.i269, label %if.end4.i271, label %if.then41

if.end4.i271:                                     ; preds = %if.else.i267, %sw.epilog.i270
  %26 = load i32, ptr @lookahead, align 4, !tbaa !5
  %call6.i272 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %26)
  tail call void @error(ptr noundef nonnull @.str.3) #7
  br label %match.exit273

match.exit273:                                    ; preds = %if.then.i262, %if.then2.i264, %if.end4.i271
  %.pr302 = load i32, ptr @ErrorFlag, align 4, !tbaa !5
  %tobool40.not = icmp eq i32 %.pr302, 0
  br i1 %tobool40.not, label %cond.end212, label %if.then41

if.then41:                                        ; preds = %sw.epilog.i270, %match.exit273
  store i32 0, ptr @ErrorFlag, align 4, !tbaa !5
  br label %cond.end212

cond.end212:                                      ; preds = %match.exit273, %if.then41
  %27 = load i32, ptr @FuncNameIndex, align 4, !tbaa !5
  %idxprom204 = sext i32 %27 to i64
  %arrayidx205 = getelementptr inbounds [100 x %struct.entry], ptr @GlobalTable, i64 0, i64 %idxprom204
  %28 = load ptr, ptr %arrayidx205, align 16, !tbaa !20
  %call207 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %28, ptr noundef nonnull dereferenceable(5) @.str.7) #7
  %cmp214 = icmp eq i32 %call207, 0
  br i1 %cmp214, label %if.then216, label %if.else225

if.then216:                                       ; preds = %cond.end212
  %29 = load i32, ptr @lookahead, align 4, !tbaa !5
  %cmp217 = icmp eq i32 %29, 41
  br i1 %cmp217, label %if.then.i276, label %if.else223

if.then.i276:                                     ; preds = %if.then216
  ...
  store float %34, ptr @ftokenval, align 4, !tbaa !11
  %cmp1.not.i275 = icmp eq i32 %32, 260
  br i1 %cmp1.not.i275, label %while.cond.i.preheader, label %match.exit286

match.exit286:                                    ; preds = %if.then.i276
  %call.i277 = tail call i32 @lexan() #7
  store i32 %call.i277, ptr @NextLookahead, align 4, !tbaa !5
  %.pre310 = load i32, ptr @ErrorFlag, align 4, !tbaa !5
  %35 = icmp eq i32 %.pre310, 0
...
if.end228:                                        ; preds = %if.then227, %if.else225
  %37 = load i32, ptr @lookahead, align 4, !tbaa !5
  %cmp.i287 = icmp eq i32 %37, 41
  br i1 %cmp.i287, label %if.then.i289, label %if.else.i294

if.then.i289:                                     ; preds = %if.end228
  store i32 41, ptr @PreviousLookahead, align 4, !tbaa !5
  ...
  %cmp1.not.i288 = icmp eq i32 %40, 260
  br i1 %cmp1.not.i288, label %match.exit299, label %if.then2.i291

if.then2.i291:                                    ; preds = %if.then.i289
  %call.i290 = tail call i32 @lexan() #7
  store i32 %call.i290, ptr @NextLookahead, align 4, !tbaa !5
  br label %match.exit299

if.else.i294:                                     ; preds = %if.end228
  %.off.i292 = add i32 %37, -2007
  %switch.i293 = icmp ult i32 %.off.i292, 2
  br i1 %switch.i293, label %sw.epilog.i297, label %if.end4.i298

sw.epilog.i297:                                   ; preds = %if.else.i294
  tail call void @error(ptr noundef nonnull @.str) #7
  %.pre309 = load i32, ptr @ErrorFlag, align 4, !tbaa !5
  %43 = icmp eq i32 %.pre309, 0
  br i1 %43, label %if.end4.i298, label %if.then230

if.end4.i298:                                     ; preds = %if.else.i294, %sw.epilog.i297
  tail call void @error(ptr noundef nonnull @.str.1) #7
  br label %match.exit299

match.exit299:                                    ; preds = %if.then.i289, %if.then2.i291, %if.end4.i298
  %.pr304 = load i32, ptr @ErrorFlag, align 4, !tbaa !5
  %tobool229.not = icmp eq i32 %.pr304, 0
  br i1 %tobool229.not, label %while.cond.i.preheader, label %if.then230

if.then230:                                       ; preds = %sw.epilog.i297, %match.exit299
  store i32 0, ptr @ErrorFlag, align 4, !tbaa !5
  br label %while.cond.i.preheader

while.cond.i.preheader:                           ; preds = %if.then.i276, %match.exit299, %if.then230, %match.exit286
  br label %while.cond.i

while.cond.i:                                     ; preds = %while.cond.i.preheader, %if.end.i
  %44 = load i32, ptr @lookahead, align 4, !tbaa !5
  %45 = and i32 %44, -2
...
while.body.i:                                     ; preds = %while.cond.i
  ...
  %47 = load i32, ptr @ErrorFlag, align 4, !tbaa !5
  %tobool.not.i300 = icmp eq i32 %47, 0
  br i1 %tobool.not.i300, label %if.end.i, label %if.then234
...
if.end.i:                                         ; preds = %while.body.i
  ...
  br i1 %tobool2.not.i, label %while.cond.i, label %if.then234, !llvm.loop !21

DecList.exit:                                     ; preds = %while.cond.i
  tail call void @ParamInt() #7
  %.pr306 = load i32, ptr @ErrorFlag, align 4, !tbaa !5
  %tobool233.not = icmp eq i32 %.pr306, 0
  br i1 %tobool233.not, label %if.end235, label %if.then234

if.then234:                                       ; preds = %if.end.i, %while.body.i, %DecList.exit
  store i32 0, ptr @ErrorFlag, align 4, !tbaa !5
  br label %if.end235

if.end235:                                        ; preds = %if.then234, %DecList.exit
  %50 = load i32, ptr @FuncNameIndex, align 4, !tbaa !5
  ...
  %tobool236.not = icmp eq i32 %51, 0
  br i1 %tobool236.not, label %if.end238, label %return

if.end238:                                        ; preds = %if.end235
  %52 = load i32, ptr @FuncNameIndex, align 4, !tbaa !5
  %idxprom239 = sext i32 %52 to i64
  %type241 = getelementptr inbounds [100 x %struct.entry], ptr @GlobalTable, i64 0, i64 %idxprom239, i32 2
  %53 = load i32, ptr %type241, align 4, !tbaa !17
  %cmp242 = icmp eq i32 %53, 2002
...
return:                                           ; preds = %if.end235, %match.exit286, %if.end246, %if.else223, %if.then11, %if.then5, %if.then1, %if.then
  ret void
}
...
do.cond:                                          ; preds = %do.body, %if.then2
  %9 = load i32, ptr @lookahead, align 4, !tbaa !5
...
do.cond:                                          ; preds = %match.exit158
  %63 = load i32, ptr @lookahead, align 4, !tbaa !5
