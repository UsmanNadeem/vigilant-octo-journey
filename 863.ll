; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/anagram/anagram.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/anagram/anagram.c"
...
define dso_local void @ReadDict(ptr noundef %pchFile) local_unnamed_addr #3 {
entry:
  %statBuf = alloca %struct.stat, align 8
  call void @llvm.lifetime.start.p0(i64 144, ptr nonnull %statBuf) #17
  %call.i = call i32 @__xstat(i32 noundef 1, ptr noundef nonnull %pchFile, ptr noundef nonnull %statBuf) #17
  %tobool.not = icmp eq i32 %call.i, 0
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %0 = load ptr, ptr @stderr, align 8, !tbaa !5
  %call.i54 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str, i32 noundef 0) #15
...
if.end:                                           ; preds = %entry
  ...
  %add = add i64 %1, 52000
  %call1 = call noalias ptr @malloc(i64 noundef %add) #18
...
if.then2:                                         ; preds = %if.end
  ...
  %call.i55 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %2, ptr noundef nonnull @.str.1, i32 noundef 0) #15
  call void @exit(i32 noundef 1) #16
  unreachable

if.end3:                                          ; preds = %if.end
  %call4 = call ptr @fopen(ptr noundef nonnull %pchFile, ptr noundef nonnull @.str.2)
  %cmp5 = icmp eq ptr %call4, null
  br i1 %cmp5, label %if.then6, label %while.cond.preheader

while.cond.preheader:                             ; preds = %if.end3
  %call861 = call i32 @feof(ptr noundef nonnull %call4) #17
  %tobool9.not62 = icmp eq i32 %call861, 0
  br i1 %tobool9.not62, label %while.body, label %while.end25

if.then6:                                         ; preds = %if.end3
  %3 = load ptr, ptr @stderr, align 8, !tbaa !5
  %call.i57 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %3, ptr noundef nonnull @.str.3, i32 noundef 0) #15
  call void @exit(i32 noundef 1) #16
  unreachable

while.body:                                       ; preds = %while.cond.preheader, %while.end
  %cWords.064 = phi i32 [ %inc24, %while.end ], [ 0, %while.cond.preheader ]
  %pchBase.063 = phi ptr [ %incdec.ptr20, %while.end ], [ %call1, %while.cond.preheader ]
  %add.ptr = getelementptr inbounds i8, ptr %pchBase.063, i64 2
...
while.cond10:                                     ; preds = %while.body14, %while.body
  ...
  %call11 = call i32 @fgetc(ptr noundef nonnull %call4)
...
while.end:                                        ; preds = %while.cond10, %while.cond10
  ...
  %sub.ptr.rhs.cast = ptrtoint ptr %pchBase.063 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %conv21 = trunc i64 %sub.ptr.sub to i8
  store i8 %conv21, ptr %pchBase.063, align 1, !tbaa !16
  %arrayidx23 = getelementptr inbounds i8, ptr %pchBase.063, i64 1
  store i8 %cLetters.0, ptr %arrayidx23, align 1, !tbaa !16
  %inc24 = add i32 %cWords.064, 1
  %call8 = call i32 @feof(ptr noundef nonnull %call4) #17
...
while.end25:                                      ; preds = %while.end, %while.cond.preheader
  ...
  %call26 = call i32 @fclose(ptr noundef nonnull %call4)
  store i8 0, ptr %pchBase.0.lcssa, align 1, !tbaa !16
  %8 = load ptr, ptr @stderr, align 8, !tbaa !5
  %call28 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %8, ptr noundef nonnull @.str.4, i32 noundef %cWords.0.lcssa) #15
  %cmp29 = icmp ugt i32 %cWords.0.lcssa, 25999
  br i1 %cmp29, label %if.then31, label %if.end32

if.then31:                                        ; preds = %while.end25
  %9 = load ptr, ptr @stderr, align 8, !tbaa !5
  %call.i59 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %9, ptr noundef nonnull @.str.5, i32 noundef 0) #15
  call void @exit(i32 noundef 1) #16
  unreachable
...
if.end32:                                         ; preds = %while.end25
  ...
  %call36 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %10, ptr noundef nonnull @.str.6, i64 noundef %sub) #15
...
for.inc:                                          ; preds = %for.inc.preheader, %for.inc
  %qNeed.0132 = phi i64 [ %shl, %for.inc ], [ 1, %for.inc.preheader ]
  %cbtNeed.0131 = phi i32 [ %inc37, %for.inc ], [ 1, %for.inc.preheader ]
  %inc37 = add i32 %cbtNeed.0131, 1
  %shl = shl nuw nsw i64 %qNeed.0132, 1
  %cmp34.not = icmp ugt i64 %shl, %conv33
  br i1 %cmp34.not, label %for.end, label %for.inc, !llvm.loop !24
...
; Function Attrs: nounwind uwtable
define dso_local i32 @main(i32 noundef %cpchArgc, ptr nocapture noundef readonly %ppchArgv) local_unnamed_addr #3 {
entry:
