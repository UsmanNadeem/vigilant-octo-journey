; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/McCat/15-trie/trie.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/McCat/15-trie/trie.c"
...
; Function Attrs: nounwind uwtable
define dso_local void @insertW(ptr noundef %tr, ptr noundef %w) local_unnamed_addr #0 {
entry:
  br label %tailrecurse.outer

tailrecurse.outer:                                ; preds = %if.else14, %entry
  %tr.tr.ph = phi ptr [ %3, %if.else14 ], [ %tr, %entry ]
  %w.tr.ph = phi ptr [ %add.ptr, %if.else14 ], [ %w, %entry ]
...
if.end:                                           ; preds = %entry
  ...
  %call3 = tail call ptr @fopen(ptr noundef %2, ptr noundef nonnull @.str.2)
