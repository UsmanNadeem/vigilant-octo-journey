; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/UI/Console/List.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/UI/Console/List.cpp"
...
if.end46:                                         ; preds = %invoke.cont42, %if.end36
  ...
  %23 = load i16, ptr %prop, align 8, !tbaa !47
...
entry:
  ...
  %_size.i = getelementptr inbounds %class.CBaseRecordVector, ptr %this, i64 0, i32 2
  %0 = load i32, ptr %_size.i, align 4, !tbaa !28
  %cmp487 = icmp sgt i32 %0, 0
  br i1 %cmp487, label %for.body.lr.ph, label %for.cond.cleanup
...
if.end9.i.i.i:                                    ; preds = %delete.notnull.i.i.i, %for.cond.cleanup.i.i.i, %call.i.i.i.noexc
  %sext473 = shl i64 %indvars.iv.i.i, 32
  %idxprom13.i.i.i = ashr exact i64 %sext473, 32
...
_ZN11CStringBaseIwE10GrowLengthEi.exit.i:         ; preds = %if.end9.i.i.i, %if.end.i.i
  ...
  %temp.sroa.0.2564 = ptrtoint ptr %temp.sroa.0.2 to i64
  ...
  %19 = sub i32 -2, %10
  %sub2.i.i95 = add i32 %temp.sroa.46.2, %19
...
if.end.i.i110:                                    ; preds = %_ZN11CStringBaseIwE10GrowLengthEi.exit.i
  ...
  %sub15.i.i105 = sub nsw i32 5, %sub2.i.i95
...
if.end.i.i.i113:                                  ; preds = %if.end.i.i110
  ...
  %20 = icmp slt i32 %add18.i.i107, -1
  %21 = shl nuw nsw i64 %conv.i.i.i111, 2
  %22 = select i1 %20, i64 -1, i64 %21
  %call.i.i.i142 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %22) #14
...
call.i.i.i.noexc141:                              ; preds = %if.end.i.i.i113
  %call.i.i.i142563 = ptrtoint ptr %call.i.i.i142 to i64
...
for.body.lr.ph.i.i.i117:                          ; preds = %for.cond.preheader.i.i.i115
  ...
  %min.iters.check568 = icmp ult i32 %add.i.i, 8
  %23 = sub i64 %call.i.i.i142563, %temp.sroa.0.2564
  %diff.check565 = icmp ult i64 %23, 32
  %or.cond = or i1 %min.iters.check568, %diff.check565
  br i1 %or.cond, label %for.body.i.i.i125.preheader, label %vector.ph569

vector.ph569:                                     ; preds = %for.body.lr.ph.i.i.i117
  %n.vec571 = and i64 %wide.trip.count.i.i.i116, 4294967288
  br label %vector.body574

vector.body574:                                   ; preds = %vector.body574, %vector.ph569
  %index575 = phi i64 [ 0, %vector.ph569 ], [ %index.next578, %vector.body574 ]
  %24 = getelementptr inbounds i32, ptr %temp.sroa.0.2, i64 %index575
  %wide.load576 = load <4 x i32>, ptr %24, align 4, !tbaa !13
  %25 = getelementptr inbounds i32, ptr %24, i64 4
  %wide.load577 = load <4 x i32>, ptr %25, align 4, !tbaa !13
  %26 = getelementptr inbounds i32, ptr %call.i.i.i142, i64 %index575
  store <4 x i32> %wide.load576, ptr %26, align 4, !tbaa !13
  %27 = getelementptr inbounds i32, ptr %26, i64 4
  store <4 x i32> %wide.load577, ptr %27, align 4, !tbaa !13
  %index.next578 = add nuw i64 %index575, 8
  %28 = icmp eq i64 %index.next578, %n.vec571
  br i1 %28, label %middle.block566, label %vector.body574, !llvm.loop !62

middle.block566:                                  ; preds = %vector.body574
  %cmp.n573 = icmp eq i64 %n.vec571, %wide.trip.count.i.i.i116
  br i1 %cmp.n573, label %delete.notnull.i.i.i127, label %for.body.i.i.i125.preheader

for.body.i.i.i125.preheader:                      ; preds = %for.body.lr.ph.i.i.i117, %middle.block566
  %indvars.iv.i.i.i120.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i117 ], [ %n.vec571, %middle.block566 ]
  %29 = xor i64 %indvars.iv.i.i.i120.ph, -1
  %30 = add nsw i64 %29, %wide.trip.count.i.i.i116
...
for.body.i.i.i125.prol:                           ; preds = %for.body.i.i.i125.preheader, %for.body.i.i.i125.prol
  ...
  %31 = load i32, ptr %arrayidx.i.i.i121.prol, align 4, !tbaa !13
  %arrayidx7.i.i.i122.prol = getelementptr inbounds i32, ptr %call.i.i.i142, i64 %indvars.iv.i.i.i120.prol
  store i32 %31, ptr %arrayidx7.i.i.i122.prol, align 4, !tbaa !13
...
for.body.i.i.i125.prol.loopexit:                  ; preds = %for.body.i.i.i125.prol, %for.body.i.i.i125.preheader
  ...
  br i1 %32, label %delete.notnull.i.i.i127, label %for.body.i.i.i125
...
for.body.i.i.i125:                                ; preds = %for.body.i.i.i125.prol.loopexit, %for.body.i.i.i125
  ...
  %33 = load i32, ptr %arrayidx.i.i.i121, align 4, !tbaa !13
  %arrayidx7.i.i.i122 = getelementptr inbounds i32, ptr %call.i.i.i142, i64 %indvars.iv.i.i.i120
  store i32 %33, ptr %arrayidx7.i.i.i122, align 4, !tbaa !13
  ...
  %34 = load i32, ptr %arrayidx.i.i.i121.1, align 4, !tbaa !13
  %arrayidx7.i.i.i122.1 = getelementptr inbounds i32, ptr %call.i.i.i142, i64 %indvars.iv.next.i.i.i123
  store i32 %34, ptr %arrayidx7.i.i.i122.1, align 4, !tbaa !13
  ...
  %35 = load i32, ptr %arrayidx.i.i.i121.2, align 4, !tbaa !13
  %arrayidx7.i.i.i122.2 = getelementptr inbounds i32, ptr %call.i.i.i142, i64 %indvars.iv.next.i.i.i123.1
  store i32 %35, ptr %arrayidx7.i.i.i122.2, align 4, !tbaa !13
  ...
  %36 = load i32, ptr %arrayidx.i.i.i121.3, align 4, !tbaa !13
  %arrayidx7.i.i.i122.3 = getelementptr inbounds i32, ptr %call.i.i.i142, i64 %indvars.iv.next.i.i.i123.2
  store i32 %36, ptr %arrayidx7.i.i.i122.3, align 4, !tbaa !13
...
delete.notnull.i.i.i127:                          ; preds = %for.body.i.i.i125.prol.loopexit, %for.body.i.i.i125, %middle.block566, %for.cond.preheader.i.i.i115
...
_ZN11CStringBaseIwE10GrowLengthEi.exit.i133:      ; preds = %if.end9.i.i.i130, %if.end.i.i110, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i
  ...
  %temp.sroa.0.3547 = ptrtoint ptr %temp.sroa.0.3 to i64
  %idx.ext.i131 = sext i32 %add.i.i to i64
  %add.ptr.i132 = getelementptr i32, ptr %temp.sroa.0.3, i64 %idx.ext.i131
  %incdec.ptr1.i.i137 = getelementptr inbounds i32, ptr %add.ptr.i132, i64 1
  %incdec.ptr1.i.i137.1 = getelementptr inbounds i32, ptr %incdec.ptr1.i.i137, i64 1
  %incdec.ptr1.i.i137.2 = getelementptr inbounds i32, ptr %incdec.ptr1.i.i137.1, i64 1
  %incdec.ptr1.i.i137.3 = getelementptr inbounds i32, ptr %incdec.ptr1.i.i137.2, i64 1
  store <4 x i32> <i32 102, i32 105, i32 108, i32 101>, ptr %add.ptr.i132, align 4, !tbaa !13
  %incdec.ptr1.i.i137.4 = getelementptr inbounds i32, ptr %incdec.ptr1.i.i137.3, i64 1
  ...
  %37 = sub i32 -7, %10
  %sub2.i.i151 = add i32 %temp.sroa.46.3, %37
...
if.end.i.i166:                                    ; preds = %_ZN11CStringBaseIwE10GrowLengthEi.exit.i133
  ...
  %sub15.i.i161 = sub nsw i32 2, %sub2.i.i151
...
if.end.i.i.i169:                                  ; preds = %if.end.i.i166
  ...
  %38 = icmp slt i32 %add18.i.i163, -1
  %39 = shl nuw nsw i64 %conv.i.i.i167, 2
  %40 = select i1 %38, i64 -1, i64 %39
  %call.i.i.i198 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %40) #14
...
call.i.i.i.noexc197:                              ; preds = %if.end.i.i.i169
  %call.i.i.i198546 = ptrtoint ptr %call.i.i.i198 to i64
...
for.body.lr.ph.i.i.i173:                          ; preds = %for.cond.preheader.i.i.i171
  ...
  %min.iters.check551 = icmp ult i32 %add.i140, 8
  %41 = sub i64 %call.i.i.i198546, %temp.sroa.0.3547
  %diff.check548 = icmp ult i64 %41, 32
  %or.cond579 = or i1 %min.iters.check551, %diff.check548
  br i1 %or.cond579, label %for.body.i.i.i181.preheader, label %vector.ph552

vector.ph552:                                     ; preds = %for.body.lr.ph.i.i.i173
  %n.vec554 = and i64 %wide.trip.count.i.i.i172, 4294967288
  br label %vector.body557

vector.body557:                                   ; preds = %vector.body557, %vector.ph552
  %index558 = phi i64 [ 0, %vector.ph552 ], [ %index.next561, %vector.body557 ]
  %42 = getelementptr inbounds i32, ptr %temp.sroa.0.3, i64 %index558
  %wide.load559 = load <4 x i32>, ptr %42, align 4, !tbaa !13
  %43 = getelementptr inbounds i32, ptr %42, i64 4
  %wide.load560 = load <4 x i32>, ptr %43, align 4, !tbaa !13
  %44 = getelementptr inbounds i32, ptr %call.i.i.i198, i64 %index558
  store <4 x i32> %wide.load559, ptr %44, align 4, !tbaa !13
  %45 = getelementptr inbounds i32, ptr %44, i64 4
  store <4 x i32> %wide.load560, ptr %45, align 4, !tbaa !13
  %index.next561 = add nuw i64 %index558, 8
  %46 = icmp eq i64 %index.next561, %n.vec554
  br i1 %46, label %middle.block549, label %vector.body557, !llvm.loop !68

middle.block549:                                  ; preds = %vector.body557
  %cmp.n556 = icmp eq i64 %n.vec554, %wide.trip.count.i.i.i172
  br i1 %cmp.n556, label %delete.notnull.i.i.i183, label %for.body.i.i.i181.preheader

for.body.i.i.i181.preheader:                      ; preds = %for.body.lr.ph.i.i.i173, %middle.block549
  %indvars.iv.i.i.i176.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i173 ], [ %n.vec554, %middle.block549 ]
  %47 = xor i64 %indvars.iv.i.i.i176.ph, -1
  %48 = add nsw i64 %47, %wide.trip.count.i.i.i172
  %xtraiter587 = and i64 %wide.trip.count.i.i.i172, 3
  %lcmp.mod588.not = icmp eq i64 %xtraiter587, 0
  br i1 %lcmp.mod588.not, label %for.body.i.i.i181.prol.loopexit, label %for.body.i.i.i181.prol
...
for.body.i.i.i181.prol:                           ; preds = %for.body.i.i.i181.preheader, %for.body.i.i.i181.prol
  ...
  %prol.iter589 = phi i64 [ %prol.iter589.next, %for.body.i.i.i181.prol ], [ 0, %for.body.i.i.i181.preheader ]
  %arrayidx.i.i.i177.prol = getelementptr inbounds i32, ptr %temp.sroa.0.3, i64 %indvars.iv.i.i.i176.prol
  %49 = load i32, ptr %arrayidx.i.i.i177.prol, align 4, !tbaa !13
  %arrayidx7.i.i.i178.prol = getelementptr inbounds i32, ptr %call.i.i.i198, i64 %indvars.iv.i.i.i176.prol
  store i32 %49, ptr %arrayidx7.i.i.i178.prol, align 4, !tbaa !13
  %indvars.iv.next.i.i.i179.prol = add nuw nsw i64 %indvars.iv.i.i.i176.prol, 1
  %prol.iter589.next = add i64 %prol.iter589, 1
  %prol.iter589.cmp.not = icmp eq i64 %prol.iter589.next, %xtraiter587
  br i1 %prol.iter589.cmp.not, label %for.body.i.i.i181.prol.loopexit, label %for.body.i.i.i181.prol, !llvm.loop !69
...
for.body.i.i.i181.prol.loopexit:                  ; preds = %for.body.i.i.i181.prol, %for.body.i.i.i181.preheader
  ...
  br i1 %50, label %delete.notnull.i.i.i183, label %for.body.i.i.i181
...
for.body.i.i.i181:                                ; preds = %for.body.i.i.i181.prol.loopexit, %for.body.i.i.i181
  ...
  %51 = load i32, ptr %arrayidx.i.i.i177, align 4, !tbaa !13
  %arrayidx7.i.i.i178 = getelementptr inbounds i32, ptr %call.i.i.i198, i64 %indvars.iv.i.i.i176
  store i32 %51, ptr %arrayidx7.i.i.i178, align 4, !tbaa !13
  ...
  %52 = load i32, ptr %arrayidx.i.i.i177.1, align 4, !tbaa !13
  %arrayidx7.i.i.i178.1 = getelementptr inbounds i32, ptr %call.i.i.i198, i64 %indvars.iv.next.i.i.i179
  store i32 %52, ptr %arrayidx7.i.i.i178.1, align 4, !tbaa !13
  ...
  %53 = load i32, ptr %arrayidx.i.i.i177.2, align 4, !tbaa !13
  %arrayidx7.i.i.i178.2 = getelementptr inbounds i32, ptr %call.i.i.i198, i64 %indvars.iv.next.i.i.i179.1
  store i32 %53, ptr %arrayidx7.i.i.i178.2, align 4, !tbaa !13
  ...
  %54 = load i32, ptr %arrayidx.i.i.i177.3, align 4, !tbaa !13
  %arrayidx7.i.i.i178.3 = getelementptr inbounds i32, ptr %call.i.i.i198, i64 %indvars.iv.next.i.i.i179.2
  store i32 %54, ptr %arrayidx7.i.i.i178.3, align 4, !tbaa !13
...
delete.notnull.i.i.i183:                          ; preds = %for.body.i.i.i181.prol.loopexit, %for.body.i.i.i181, %middle.block549, %for.cond.preheader.i.i.i171
...
_ZN11CStringBaseIwE10GrowLengthEi.exit.i189:      ; preds = %if.end9.i.i.i186, %if.end.i.i166, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i133
  ...
  %temp.sroa.0.4530 = ptrtoint ptr %temp.sroa.0.4 to i64
  ...
  %incdec.ptr1.i.i193.1 = getelementptr inbounds i32, ptr %incdec.ptr1.i.i193, i64 1
...
for.cond.i.i204:                                  ; preds = %_ZN11CStringBaseIwE10GrowLengthEi.exit.i189, %for.cond.i.i204
  ...
  %55 = load i32, ptr %arrayidx.i.i201, align 4, !tbaa !13
  %cmp.not.i.i202 = icmp eq i32 %55, 0
...
_Z11MyStringLenIwEiPKT_.exit.i209:                ; preds = %for.cond.i.i204
  %56 = trunc i64 %indvars.iv.i.i200 to i32
  %57 = sub i32 -9, %10
  %sub2.i.i207 = add i32 %temp.sroa.46.4, %57
  %cmp.not.i6.i208 = icmp slt i32 %sub2.i.i207, %56
...
if.end.i.i222:                                    ; preds = %_Z11MyStringLenIwEiPKT_.exit.i209
  ...
  %cmp13.i.i216 = icmp slt i32 %add.i.i215, %56
  %sub15.i.i217 = sub nsw i32 %56, %sub2.i.i207
...
if.end.i.i.i225:                                  ; preds = %if.end.i.i222
  ...
  %58 = icmp slt i32 %add18.i.i219, -1
  %59 = shl nuw nsw i64 %conv.i.i.i223, 2
  %60 = select i1 %58, i64 -1, i64 %59
  %call.i.i.i254 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %60) #14
...
call.i.i.i.noexc253:                              ; preds = %if.end.i.i.i225
  %call.i.i.i254529 = ptrtoint ptr %call.i.i.i254 to i64
...
for.body.lr.ph.i.i.i229:                          ; preds = %for.cond.preheader.i.i.i227
  ...
  %min.iters.check534 = icmp ugt i32 %10, -9
  %61 = sub i64 %call.i.i.i254529, %temp.sroa.0.4530
  %diff.check531 = icmp ult i64 %61, 32
  %or.cond580 = or i1 %min.iters.check534, %diff.check531
  br i1 %or.cond580, label %for.body.i.i.i237.preheader, label %vector.ph535

vector.ph535:                                     ; preds = %for.body.lr.ph.i.i.i229
  %n.vec537 = and i64 %wide.trip.count.i.i.i228, 4294967288
  br label %vector.body540

vector.body540:                                   ; preds = %vector.body540, %vector.ph535
  %index541 = phi i64 [ 0, %vector.ph535 ], [ %index.next544, %vector.body540 ]
  %62 = getelementptr inbounds i32, ptr %temp.sroa.0.4, i64 %index541
  %wide.load542 = load <4 x i32>, ptr %62, align 4, !tbaa !13
  %63 = getelementptr inbounds i32, ptr %62, i64 4
  %wide.load543 = load <4 x i32>, ptr %63, align 4, !tbaa !13
  %64 = getelementptr inbounds i32, ptr %call.i.i.i254, i64 %index541
  store <4 x i32> %wide.load542, ptr %64, align 4, !tbaa !13
  %65 = getelementptr inbounds i32, ptr %64, i64 4
  store <4 x i32> %wide.load543, ptr %65, align 4, !tbaa !13
  %index.next544 = add nuw i64 %index541, 8
  %66 = icmp eq i64 %index.next544, %n.vec537
  br i1 %66, label %middle.block532, label %vector.body540, !llvm.loop !71

middle.block532:                                  ; preds = %vector.body540
  %cmp.n539 = icmp eq i64 %n.vec537, %wide.trip.count.i.i.i228
  br i1 %cmp.n539, label %delete.notnull.i.i.i239, label %for.body.i.i.i237.preheader

for.body.i.i.i237.preheader:                      ; preds = %for.body.lr.ph.i.i.i229, %middle.block532
  %indvars.iv.i.i.i232.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i229 ], [ %n.vec537, %middle.block532 ]
  %67 = xor i64 %indvars.iv.i.i.i232.ph, -1
  %68 = add nsw i64 %67, %wide.trip.count.i.i.i228
  %xtraiter590 = and i64 %wide.trip.count.i.i.i228, 3
  %lcmp.mod591.not = icmp eq i64 %xtraiter590, 0
  br i1 %lcmp.mod591.not, label %for.body.i.i.i237.prol.loopexit, label %for.body.i.i.i237.prol
...
for.body.i.i.i237.prol:                           ; preds = %for.body.i.i.i237.preheader, %for.body.i.i.i237.prol
  ...
  %prol.iter592 = phi i64 [ %prol.iter592.next, %for.body.i.i.i237.prol ], [ 0, %for.body.i.i.i237.preheader ]
  %arrayidx.i.i.i233.prol = getelementptr inbounds i32, ptr %temp.sroa.0.4, i64 %indvars.iv.i.i.i232.prol
  %69 = load i32, ptr %arrayidx.i.i.i233.prol, align 4, !tbaa !13
  %arrayidx7.i.i.i234.prol = getelementptr inbounds i32, ptr %call.i.i.i254, i64 %indvars.iv.i.i.i232.prol
  store i32 %69, ptr %arrayidx7.i.i.i234.prol, align 4, !tbaa !13
  %indvars.iv.next.i.i.i235.prol = add nuw nsw i64 %indvars.iv.i.i.i232.prol, 1
  %prol.iter592.next = add i64 %prol.iter592, 1
  %prol.iter592.cmp.not = icmp eq i64 %prol.iter592.next, %xtraiter590
  br i1 %prol.iter592.cmp.not, label %for.body.i.i.i237.prol.loopexit, label %for.body.i.i.i237.prol, !llvm.loop !72
...
for.body.i.i.i237.prol.loopexit:                  ; preds = %for.body.i.i.i237.prol, %for.body.i.i.i237.preheader
  ...
  br i1 %70, label %delete.notnull.i.i.i239, label %for.body.i.i.i237
...
for.body.i.i.i237:                                ; preds = %for.body.i.i.i237.prol.loopexit, %for.body.i.i.i237
  ...
  %72 = load i32, ptr %arrayidx.i.i.i233.1, align 4, !tbaa !13
  %arrayidx7.i.i.i234.1 = getelementptr inbounds i32, ptr %call.i.i.i254, i64 %indvars.iv.next.i.i.i235
  store i32 %72, ptr %arrayidx7.i.i.i234.1, align 4, !tbaa !13
  ...
  %73 = load i32, ptr %arrayidx.i.i.i233.2, align 4, !tbaa !13
  %arrayidx7.i.i.i234.2 = getelementptr inbounds i32, ptr %call.i.i.i254, i64 %indvars.iv.next.i.i.i235.1
  store i32 %73, ptr %arrayidx7.i.i.i234.2, align 4, !tbaa !13
  ...
  %74 = load i32, ptr %arrayidx.i.i.i233.3, align 4, !tbaa !13
  %arrayidx7.i.i.i234.3 = getelementptr inbounds i32, ptr %call.i.i.i254, i64 %indvars.iv.next.i.i.i235.2
  store i32 %74, ptr %arrayidx7.i.i.i234.3, align 4, !tbaa !13
...
delete.notnull.i.i.i239:                          ; preds = %for.body.i.i.i237.prol.loopexit, %for.body.i.i.i237, %middle.block532, %for.cond.cleanup.i.i.i231
...
_ZN11CStringBaseIwE10GrowLengthEi.exit.i245:      ; preds = %if.end9.i.i.i242, %if.end.i.i222, %_Z11MyStringLenIwEiPKT_.exit.i209
  ...
  %temp.sroa.0.5513 = ptrtoint ptr %temp.sroa.0.5 to i64
...
while.cond.i.i251:                                ; preds = %while.cond.i.i251, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i245
  ...
  %75 = load i32, ptr %src.addr.0.i.i246, align 4, !tbaa !13
  %incdec.ptr1.i.i249 = getelementptr inbounds i32, ptr %dest.addr.0.i.i247, i64 1
  store i32 %75, ptr %dest.addr.0.i.i247, align 4, !tbaa !13
  %cmp.not.i7.i250 = icmp eq i32 %75, 0
  br i1 %cmp.not.i7.i250, label %invoke.cont30, label %while.cond.i.i251, !llvm.loop !17

invoke.cont30:                                    ; preds = %while.cond.i.i251
  %add.i252 = add nsw i32 %add.i196, %56
  %76 = xor i32 %add.i252, -1
  %sub2.i.i263 = add i32 %temp.sroa.46.5, %76
...
if.end.i.i.i281:                                  ; preds = %if.end.i.i278
  ...
  %77 = icmp slt i32 %add18.i.i275, -1
  %78 = shl nuw nsw i64 %conv.i.i.i279, 2
  %79 = select i1 %77, i64 -1, i64 %78
  %call.i.i.i310 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %79) #14
...
call.i.i.i.noexc309:                              ; preds = %if.end.i.i.i281
  %call.i.i.i310512 = ptrtoint ptr %call.i.i.i310 to i64
...
for.body.lr.ph.i.i.i285:                          ; preds = %for.cond.preheader.i.i.i283
  ...
  %min.iters.check517 = icmp ult i32 %add.i252, 8
  %80 = sub i64 %call.i.i.i310512, %temp.sroa.0.5513
  %diff.check514 = icmp ult i64 %80, 32
  %or.cond581 = select i1 %min.iters.check517, i1 true, i1 %diff.check514
  br i1 %or.cond581, label %for.body.i.i.i293.preheader, label %vector.ph518

vector.ph518:                                     ; preds = %for.body.lr.ph.i.i.i285
  %n.vec520 = and i64 %wide.trip.count.i.i.i284, 4294967288
...
vector.body523:                                   ; preds = %vector.body523, %vector.ph518
  ...
  %81 = getelementptr inbounds i32, ptr %temp.sroa.0.5, i64 %index524
  %wide.load525 = load <4 x i32>, ptr %81, align 4, !tbaa !13
  %82 = getelementptr inbounds i32, ptr %81, i64 4
  %wide.load526 = load <4 x i32>, ptr %82, align 4, !tbaa !13
  %83 = getelementptr inbounds i32, ptr %call.i.i.i310, i64 %index524
  store <4 x i32> %wide.load525, ptr %83, align 4, !tbaa !13
  %84 = getelementptr inbounds i32, ptr %83, i64 4
  store <4 x i32> %wide.load526, ptr %84, align 4, !tbaa !13
  %index.next527 = add nuw i64 %index524, 8
  %85 = icmp eq i64 %index.next527, %n.vec520
  br i1 %85, label %middle.block515, label %vector.body523, !llvm.loop !74

middle.block515:                                  ; preds = %vector.body523
  %cmp.n522 = icmp eq i64 %n.vec520, %wide.trip.count.i.i.i284
  br i1 %cmp.n522, label %delete.notnull.i.i.i295, label %for.body.i.i.i293.preheader

for.body.i.i.i293.preheader:                      ; preds = %for.body.lr.ph.i.i.i285, %middle.block515
  %indvars.iv.i.i.i288.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i285 ], [ %n.vec520, %middle.block515 ]
  %86 = xor i64 %indvars.iv.i.i.i288.ph, -1
  %87 = add nsw i64 %86, %wide.trip.count.i.i.i284
  %xtraiter593 = and i64 %wide.trip.count.i.i.i284, 3
  %lcmp.mod594.not = icmp eq i64 %xtraiter593, 0
  br i1 %lcmp.mod594.not, label %for.body.i.i.i293.prol.loopexit, label %for.body.i.i.i293.prol
...
for.body.i.i.i293.prol:                           ; preds = %for.body.i.i.i293.preheader, %for.body.i.i.i293.prol
  ...
  %prol.iter595 = phi i64 [ %prol.iter595.next, %for.body.i.i.i293.prol ], [ 0, %for.body.i.i.i293.preheader ]
  %arrayidx.i.i.i289.prol = getelementptr inbounds i32, ptr %temp.sroa.0.5, i64 %indvars.iv.i.i.i288.prol
  %88 = load i32, ptr %arrayidx.i.i.i289.prol, align 4, !tbaa !13
  %arrayidx7.i.i.i290.prol = getelementptr inbounds i32, ptr %call.i.i.i310, i64 %indvars.iv.i.i.i288.prol
  store i32 %88, ptr %arrayidx7.i.i.i290.prol, align 4, !tbaa !13
  ...
  br i1 %prol.iter595.cmp.not, label %for.body.i.i.i293.prol.loopexit, label %for.body.i.i.i293.prol, !llvm.loop !75
...
for.body.i.i.i293.prol.loopexit:                  ; preds = %for.body.i.i.i293.prol, %for.body.i.i.i293.preheader
  ...
  br i1 %89, label %delete.notnull.i.i.i295, label %for.body.i.i.i293
...
for.body.i.i.i293:                                ; preds = %for.body.i.i.i293.prol.loopexit, %for.body.i.i.i293
  ...
  %90 = load i32, ptr %arrayidx.i.i.i289, align 4, !tbaa !13
  %arrayidx7.i.i.i290 = getelementptr inbounds i32, ptr %call.i.i.i310, i64 %indvars.iv.i.i.i288
  store i32 %90, ptr %arrayidx7.i.i.i290, align 4, !tbaa !13
  ...
  %91 = load i32, ptr %arrayidx.i.i.i289.1, align 4, !tbaa !13
  %arrayidx7.i.i.i290.1 = getelementptr inbounds i32, ptr %call.i.i.i310, i64 %indvars.iv.next.i.i.i291
  store i32 %91, ptr %arrayidx7.i.i.i290.1, align 4, !tbaa !13
  ...
  %92 = load i32, ptr %arrayidx.i.i.i289.2, align 4, !tbaa !13
  %arrayidx7.i.i.i290.2 = getelementptr inbounds i32, ptr %call.i.i.i310, i64 %indvars.iv.next.i.i.i291.1
  store i32 %92, ptr %arrayidx7.i.i.i290.2, align 4, !tbaa !13
  ...
  %93 = load i32, ptr %arrayidx.i.i.i289.3, align 4, !tbaa !13
  %arrayidx7.i.i.i290.3 = getelementptr inbounds i32, ptr %call.i.i.i310, i64 %indvars.iv.next.i.i.i291.2
  store i32 %93, ptr %arrayidx7.i.i.i290.3, align 4, !tbaa !13
...
delete.notnull.i.i.i295:                          ; preds = %for.body.i.i.i293.prol.loopexit, %for.body.i.i.i293, %middle.block515, %for.cond.cleanup.i.i.i287
...
_ZN11CStringBaseIwE10GrowLengthEi.exit.i301:      ; preds = %if.end9.i.i.i298, %if.end.i.i278, %invoke.cont30
  ...
  %temp.sroa.0.6509 = ptrtoint ptr %temp.sroa.0.6 to i64
  ...
  %94 = sub i32 -2, %add.i252
  %sub2.i.i319 = add i32 %temp.sroa.46.6, %94
...
if.end.i.i334:                                    ; preds = %_ZN11CStringBaseIwE10GrowLengthEi.exit.i301
  ...
  %sub15.i.i329 = sub nsw i32 7, %sub2.i.i319
...
if.end.i.i.i337:                                  ; preds = %if.end.i.i334
  ...
  %95 = icmp slt i32 %add18.i.i331, -1
  %96 = shl nuw nsw i64 %conv.i.i.i335, 2
  %97 = select i1 %95, i64 -1, i64 %96
  %call.i.i.i366 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %97) #14
...
call.i.i.i.noexc365:                              ; preds = %if.end.i.i.i337
  %call.i.i.i366508 = ptrtoint ptr %call.i.i.i366 to i64
...
for.body.lr.ph.i.i.i341:                          ; preds = %for.cond.preheader.i.i.i339
  ...
  %98 = sub i64 %call.i.i.i366508, %temp.sroa.0.6509
  %diff.check = icmp ult i64 %98, 32
  %or.cond582 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond582, label %for.body.i.i.i349.preheader, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %99 = getelementptr inbounds i32, ptr %temp.sroa.0.6, i64 %index
  %wide.load = load <4 x i32>, ptr %99, align 4, !tbaa !13
  %100 = getelementptr inbounds i32, ptr %99, i64 4
  %wide.load510 = load <4 x i32>, ptr %100, align 4, !tbaa !13
  %101 = getelementptr inbounds i32, ptr %call.i.i.i366, i64 %index
  store <4 x i32> %wide.load, ptr %101, align 4, !tbaa !13
  %102 = getelementptr inbounds i32, ptr %101, i64 4
  store <4 x i32> %wide.load510, ptr %102, align 4, !tbaa !13
  %index.next = add nuw i64 %index, 8
  %103 = icmp eq i64 %index.next, %n.vec
  br i1 %103, label %middle.block, label %vector.body, !llvm.loop !77
...
for.body.i.i.i349.preheader:                      ; preds = %for.body.lr.ph.i.i.i341, %middle.block
  ...
  %104 = xor i64 %indvars.iv.i.i.i344.ph, -1
  %105 = add nsw i64 %104, %wide.trip.count.i.i.i340
  %xtraiter596 = and i64 %wide.trip.count.i.i.i340, 3
  %lcmp.mod597.not = icmp eq i64 %xtraiter596, 0
  br i1 %lcmp.mod597.not, label %for.body.i.i.i349.prol.loopexit, label %for.body.i.i.i349.prol
...
for.body.i.i.i349.prol:                           ; preds = %for.body.i.i.i349.preheader, %for.body.i.i.i349.prol
  ...
  %prol.iter598 = phi i64 [ %prol.iter598.next, %for.body.i.i.i349.prol ], [ 0, %for.body.i.i.i349.preheader ]
  %arrayidx.i.i.i345.prol = getelementptr inbounds i32, ptr %temp.sroa.0.6, i64 %indvars.iv.i.i.i344.prol
  %106 = load i32, ptr %arrayidx.i.i.i345.prol, align 4, !tbaa !13
  %arrayidx7.i.i.i346.prol = getelementptr inbounds i32, ptr %call.i.i.i366, i64 %indvars.iv.i.i.i344.prol
  store i32 %106, ptr %arrayidx7.i.i.i346.prol, align 4, !tbaa !13
  ...
  br i1 %prol.iter598.cmp.not, label %for.body.i.i.i349.prol.loopexit, label %for.body.i.i.i349.prol, !llvm.loop !78
...
for.body.i.i.i349.prol.loopexit:                  ; preds = %for.body.i.i.i349.prol, %for.body.i.i.i349.preheader
  ...
  br i1 %107, label %delete.notnull.i.i.i351, label %for.body.i.i.i349
...
for.body.i.i.i349:                                ; preds = %for.body.i.i.i349.prol.loopexit, %for.body.i.i.i349
  ...
  %108 = load i32, ptr %arrayidx.i.i.i345, align 4, !tbaa !13
  %arrayidx7.i.i.i346 = getelementptr inbounds i32, ptr %call.i.i.i366, i64 %indvars.iv.i.i.i344
  store i32 %108, ptr %arrayidx7.i.i.i346, align 4, !tbaa !13
  ...
  %109 = load i32, ptr %arrayidx.i.i.i345.1, align 4, !tbaa !13
  %arrayidx7.i.i.i346.1 = getelementptr inbounds i32, ptr %call.i.i.i366, i64 %indvars.iv.next.i.i.i347
  store i32 %109, ptr %arrayidx7.i.i.i346.1, align 4, !tbaa !13
  ...
  %110 = load i32, ptr %arrayidx.i.i.i345.2, align 4, !tbaa !13
  %arrayidx7.i.i.i346.2 = getelementptr inbounds i32, ptr %call.i.i.i366, i64 %indvars.iv.next.i.i.i347.1
  store i32 %110, ptr %arrayidx7.i.i.i346.2, align 4, !tbaa !13
  ...
  %111 = load i32, ptr %arrayidx.i.i.i345.3, align 4, !tbaa !13
  %arrayidx7.i.i.i346.3 = getelementptr inbounds i32, ptr %call.i.i.i366, i64 %indvars.iv.next.i.i.i347.2
  store i32 %111, ptr %arrayidx7.i.i.i346.3, align 4, !tbaa !13
...
_ZN11CStringBaseIwE10GrowLengthEi.exit.i357:      ; preds = %if.end9.i.i.i354, %if.end.i.i334, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i301
  ...
  %incdec.ptr1.i.i361 = getelementptr inbounds i32, ptr %add.ptr.i356, i64 1
  %incdec.ptr1.i.i361.1 = getelementptr inbounds i32, ptr %incdec.ptr1.i.i361, i64 1
  %incdec.ptr1.i.i361.2 = getelementptr inbounds i32, ptr %incdec.ptr1.i.i361.1, i64 1
  %incdec.ptr1.i.i361.3 = getelementptr inbounds i32, ptr %incdec.ptr1.i.i361.2, i64 1
  store <4 x i32> <i32 102, i32 111, i32 108, i32 100>, ptr %add.ptr.i356, align 4, !tbaa !13
  %incdec.ptr1.i.i361.4 = getelementptr inbounds i32, ptr %incdec.ptr1.i.i361.3, i64 1
  store i32 101, ptr %incdec.ptr1.i.i361.3, align 4, !tbaa !13
  %incdec.ptr1.i.i361.5 = getelementptr inbounds i32, ptr %incdec.ptr1.i.i361.4, i64 1
  store i32 114, ptr %incdec.ptr1.i.i361.4, align 4, !tbaa !13
  %incdec.ptr1.i.i361.6 = getelementptr inbounds i32, ptr %incdec.ptr1.i.i361.5, i64 1
  store i32 115, ptr %incdec.ptr1.i.i361.5, align 4, !tbaa !13
  store i32 0, ptr %incdec.ptr1.i.i361.6, align 4, !tbaa !13
  %TextAdjustment36 = getelementptr inbounds %struct.CFieldInfo, ptr %2, i64 0, i32 3
  %112 = load i32, ptr %TextAdjustment36, align 4, !tbaa !59
  %sub.i = sub i32 -8, %add.i252
  switch i32 %112, label %_ZL11PrintSpacesi.exit.i [
    i32 2, label %sw.epilog.i
    i32 1, label %sw.bb1.i
  ]
...
lpad20:                                           ; preds = %lpad20.loopexit.split-lp.loopexit, %lpad20.loopexit.split-lp.loopexit.split-lp, %lpad20.loopexit
  ...
  %lpad.phi478 = phi { ptr, i32 } [ %lpad.loopexit477, %lpad20.loopexit ], [ %lpad.loopexit479, %lpad20.loopexit.split-lp.loopexit ], [ %lpad.loopexit.split-lp480, %lpad20.loopexit.split-lp.loopexit.split-lp ]
...
ehcleanup38:                                      ; preds = %lpad18, %lpad20, %delete.notnull.i374, %lpad15
  %.pn68.pn = phi { ptr, i32 } [ %113, %lpad15 ], [ %114, %lpad18 ], [ %lpad.phi478, %lpad20 ], [ %lpad.phi478, %delete.notnull.i374 ]
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %textString) #16
  br label %ehcleanup50

if.else39:                                        ; preds = %_ZL11PrintSpacesi.exit
  %TextAdjustment40 = getelementptr inbounds %struct.CFieldInfo, ptr %2, i64 0, i32 3
  %115 = load i32, ptr %TextAdjustment40, align 4, !tbaa !59
  %Width41 = getelementptr inbounds %struct.CFieldInfo, ptr %2, i64 0, i32 5
  %116 = load i32, ptr %Width41, align 4, !tbaa !43
  %call.i.i396 = invoke noalias noundef nonnull dereferenceable(4) ptr @_Znam(i64 noundef 4) #14
          to label %call.i.i.noexc395 unwind label %lpad42

call.i.i.noexc395:                                ; preds = %if.else39
  store i32 0, ptr %call.i.i396, align 4, !tbaa !13
  switch i32 %115, label %_ZL11PrintSpacesi.exit.i412 [
    i32 2, label %sw.epilog.i404
    i32 1, label %sw.bb1.i401
  ]

sw.bb1.i401:                                      ; preds = %call.i.i.noexc395
  %div.i400 = sdiv i32 %116, 2
  br label %sw.epilog.i404

sw.epilog.i404:                                   ; preds = %sw.bb1.i401, %call.i.i.noexc395
  %numLeftSpaces.0.i402 = phi i32 [ %div.i400, %sw.bb1.i401 ], [ %116, %call.i.i.noexc395 ]
  %cmp2.i.i403 = icmp sgt i32 %numLeftSpaces.0.i402, 0
  br i1 %cmp2.i.i403, label %for.body.i.i408, label %_ZL11PrintSpacesi.exit.i412

for.body.i.i408:                                  ; preds = %sw.epilog.i404, %call.i.i.noexc417
  %i.03.i.i405 = phi i32 [ %inc.i.i406, %call.i.i.noexc417 ], [ 0, %sw.epilog.i404 ]
  %call.i.i418 = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN13CStdOutStreamlsEc(ptr noundef nonnull align 8 dereferenceable(16) @g_StdOut, i8 noundef signext 32)
          to label %call.i.i.noexc417 unwind label %lpad44.loopexit.split-lp.loopexit

call.i.i.noexc417:                                ; preds = %for.body.i.i408
  %inc.i.i406 = add nuw nsw i32 %i.03.i.i405, 1
  %exitcond.not.i.i407 = icmp eq i32 %inc.i.i406, %numLeftSpaces.0.i402
  br i1 %exitcond.not.i.i407, label %_ZL11PrintSpacesi.exit.i412, label %for.body.i.i408, !llvm.loop !40

_ZL11PrintSpacesi.exit.i412:                      ; preds = %call.i.i.noexc417, %sw.epilog.i404, %call.i.i.noexc395
  %numLeftSpaces.019.i409 = phi i32 [ %numLeftSpaces.0.i402, %sw.epilog.i404 ], [ 0, %call.i.i.noexc395 ], [ %numLeftSpaces.0.i402, %call.i.i.noexc417 ]
  %call4.i420 = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN13CStdOutStreamlsEPKw(ptr noundef nonnull align 8 dereferenceable(16) @g_StdOut, ptr noundef nonnull %call.i.i396)
          to label %call4.i.noexc419 unwind label %lpad44.loopexit.split-lp.loopexit.split-lp

call4.i.noexc419:                                 ; preds = %_ZL11PrintSpacesi.exit.i412
  %sub5.i410 = sub nsw i32 %116, %numLeftSpaces.019.i409
  %cmp2.i10.i411 = icmp sgt i32 %sub5.i410, 0
  br i1 %cmp2.i10.i411, label %for.body.i15.i416, label %delete.notnull.i425

for.body.i15.i416:                                ; preds = %call4.i.noexc419, %call.i12.i.noexc421
  %i.03.i11.i413 = phi i32 [ %inc.i13.i414, %call.i12.i.noexc421 ], [ 0, %call4.i.noexc419 ]
  %call.i12.i422 = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN13CStdOutStreamlsEc(ptr noundef nonnull align 8 dereferenceable(16) @g_StdOut, i8 noundef signext 32)
          to label %call.i12.i.noexc421 unwind label %lpad44.loopexit

call.i12.i.noexc421:                              ; preds = %for.body.i15.i416
  %inc.i13.i414 = add nuw nsw i32 %i.03.i11.i413, 1
  %exitcond.not.i14.i415 = icmp eq i32 %inc.i13.i414, %sub5.i410
  br i1 %exitcond.not.i14.i415, label %delete.notnull.i425, label %for.body.i15.i416, !llvm.loop !40

delete.notnull.i425:                              ; preds = %call.i12.i.noexc421, %call4.i.noexc419
  call void @_ZdaPv(ptr noundef nonnull %call.i.i396) #15
  br label %if.end49
...
lpad44.loopexit:                                  ; preds = %for.body.i15.i416
  %lpad.loopexit = landingpad { ptr, i32 }
          cleanup
  br label %delete.notnull.i428

lpad44.loopexit.split-lp.loopexit:                ; preds = %for.body.i.i408
  %lpad.loopexit474 = landingpad { ptr, i32 }
          cleanup
  br label %delete.notnull.i428

lpad44.loopexit.split-lp.loopexit.split-lp:       ; preds = %_ZL11PrintSpacesi.exit.i412
  %lpad.loopexit.split-lp475 = landingpad { ptr, i32 }
          cleanup
  br label %delete.notnull.i428

delete.notnull.i428:                              ; preds = %lpad44.loopexit, %lpad44.loopexit.split-lp.loopexit.split-lp, %lpad44.loopexit.split-lp.loopexit
  %lpad.phi = phi { ptr, i32 } [ %lpad.loopexit, %lpad44.loopexit ], [ %lpad.loopexit474, %lpad44.loopexit.split-lp.loopexit ], [ %lpad.loopexit.split-lp475, %lpad44.loopexit.split-lp.loopexit.split-lp ]
  call void @_ZdaPv(ptr noundef nonnull %call.i.i396) #15
  br label %ehcleanup50

if.end49:                                         ; preds = %if.then7.invoke, %delete.notnull.i425, %_ZN11CStringBaseIwED2Ev.exit
...
_ZN8NWindows4NCOM12CPropVariantD2Ev.exit:         ; preds = %if.end49
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %prop) #16
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %120 = load i32, ptr %_size.i, align 4, !tbaa !28
  %121 = sext i32 %120 to i64
  %cmp = icmp slt i64 %indvars.iv.next, %121
  br i1 %cmp, label %for.body, label %for.cond.cleanup, !llvm.loop !80

ehcleanup50:                                      ; preds = %lpad42, %delete.notnull.i428, %ehcleanup38, %lpad
  %.pn69 = phi { ptr, i32 } [ %5, %lpad ], [ %.pn68.pn, %ehcleanup38 ], [ %117, %lpad42 ], [ %lpad.phi, %delete.notnull.i428 ]
  %call.i431 = invoke noundef i32 @_ZN8NWindows4NCOM12CPropVariant5ClearEv(ptr noundef nonnull align 8 dereferenceable(16) %prop)
          to label %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit433 unwind label %terminate.lpad.i432

terminate.lpad.i432:                              ; preds = %ehcleanup50
...
_ZN8NWindows4NCOM12CPropVariantD2Ev.exit433:      ; preds = %ehcleanup50
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %prop) #16
  resume { ptr, i32 } %.pn69
}
...
invoke.cont107:                                   ; preds = %call.i.i.i.noexc842
  ...
  %or.cond811 = select i1 %cmp109, i1 %cmp110, i1 false
