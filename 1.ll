; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/tools/fpcmp.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/tools/fpcmp.c"
...
entry:
  %call = tail call ptr @fopen(ptr noundef %path, ptr noundef nonnull @.str)
...
land.rhs.lr.ph.i:                                 ; preds = %if.then7
  ...
  %uglygep.i = getelementptr i8, ptr %F1P.0307, i64 %2
...
while.body.peel.i:                                ; preds = %land.rhs.lr.ph.i
  ...
  %exitcond.peel.not.i = icmp eq ptr %incdec.ptr.peel.i, %uglygep.i
...
skip_whitespace.exit:                             ; preds = %land.rhs.i, %while.body.i, %if.then7.thread, %land.rhs.lr.ph.i, %while.body.peel.i
  ...
  %F1P.2 = phi ptr [ %F1P.0307, %land.rhs.lr.ph.i ], [ %uglygep.i, %while.body.peel.i ], [ %F1P.0.lcssa, %if.then7.thread ], [ %F1P.1, %land.rhs.i ], [ %uglygep.i, %while.body.i ]
...
land.rhs.lr.ph.i159:                              ; preds = %skip_whitespace.exit
  ...
  %uglygep.i155 = getelementptr i8, ptr %F2P.0301, i64 %10
...
while.body.peel.i162:                             ; preds = %land.rhs.lr.ph.i159
  ...
  %exitcond.peel.not.i161 = icmp eq ptr %incdec.ptr.peel.i160, %uglygep.i155
...
while.body.i169:                                  ; preds = %land.rhs.i166
  ...
  %exitcond.not.i168 = icmp eq ptr %incdec.ptr.i167, %uglygep.i155
...
land.rhs.lr.ph.i181:                              ; preds = %if.end23
  ...
  %uglygep.i177 = getelementptr i8, ptr %F1P.0307, i64 %21
...
while.body.peel.i184:                             ; preds = %land.rhs.lr.ph.i181
  ...
  %exitcond.peel.not.i183 = icmp eq ptr %incdec.ptr.peel.i182, %uglygep.i177
...
while.body.i191:                                  ; preds = %land.rhs.i188
  ...
  %exitcond.not.i190 = icmp eq ptr %incdec.ptr.i189, %uglygep.i177
...
land.rhs.lr.ph.i203:                              ; preds = %while.body.i191, %land.rhs.i188, %while.body.peel.i184, %land.rhs.lr.ph.i181
  %F1P.4 = phi ptr [ %F1P.0307, %land.rhs.lr.ph.i181 ], [ %uglygep.i177, %while.body.peel.i184 ], [ %uglygep.i177, %while.body.i191 ], [ %F1P.3, %land.rhs.i188 ]
  ...
  %uglygep.i199 = getelementptr i8, ptr %F2P.0308, i64 %28
...
while.body.peel.i206:                             ; preds = %land.rhs.lr.ph.i203
  ...
  %exitcond.peel.not.i205 = icmp eq ptr %incdec.ptr.peel.i204, %uglygep.i199
...
while.body.i213:                                  ; preds = %land.rhs.i210
  ...
  %exitcond.not.i212 = icmp eq ptr %incdec.ptr.i211, %uglygep.i199
...
skip_whitespace.exit215:                          ; preds = %land.rhs.i210, %while.body.i213, %land.rhs.lr.ph.i203, %while.body.peel.i206
  %F2P.4 = phi ptr [ %F2P.0308, %land.rhs.lr.ph.i203 ], [ %uglygep.i199, %while.body.peel.i206 ], [ %uglygep.i199, %while.body.i213 ], [ %F2P.3, %land.rhs.i210 ]
...
land.rhs.lr.ph.i225:                              ; preds = %if.else
  ...
  %uglygep.i221 = getelementptr i8, ptr %F1P.0307, i64 %34
...
while.body.peel.i228:                             ; preds = %land.rhs.lr.ph.i225
  ...
  %exitcond.peel.not.i227 = icmp eq ptr %incdec.ptr.peel.i226, %uglygep.i221
...
while.body.i235:                                  ; preds = %land.rhs.i232
  ...
  %exitcond.not.i234 = icmp eq ptr %incdec.ptr.i233, %uglygep.i221
...
land.rhs.lr.ph.i247:                              ; preds = %while.body.i235, %land.rhs.i232, %while.body.peel.i228, %land.rhs.lr.ph.i225
  %F1NumStart.1 = phi ptr [ %F1P.0307, %land.rhs.lr.ph.i225 ], [ %uglygep.i221, %while.body.peel.i228 ], [ %uglygep.i221, %while.body.i235 ], [ %F1NumStart.0, %land.rhs.i232 ]
  %FP.promoted8.i240 = ptrtoint ptr %F2P.0308 to i64
  %41 = sub i64 %FEnd7.i197, %FP.promoted8.i240
  %uglygep.i243 = getelementptr i8, ptr %F2P.0308, i64 %41
...
while.body.peel.i250:                             ; preds = %land.rhs.lr.ph.i247
  ...
  %exitcond.peel.not.i249 = icmp eq ptr %incdec.ptr.peel.i248, %uglygep.i243
...
while.body.i257:                                  ; preds = %land.rhs.i254
  ...
  %exitcond.not.i256 = icmp eq ptr %incdec.ptr.i255, %uglygep.i243
...
if.end36:                                         ; preds = %while.body.i257, %land.rhs.i254, %while.body.peel.i250, %land.rhs.lr.ph.i247, %skip_whitespace.exit215
  ...
  %F2NumStart.2 = phi ptr [ %F2P.0308, %skip_whitespace.exit215 ], [ %F2P.0308, %land.rhs.lr.ph.i247 ], [ %uglygep.i243, %while.body.peel.i250 ], [ %uglygep.i243, %while.body.i257 ], [ %F2NumStart.0, %land.rhs.i254 ]
...
if.end25.i:                                       ; preds = %if.then12.i, %if.end.i
  ...
  %55 = load ptr, ptr %F2NumEnd.i, align 8, !tbaa !5
...
while.end:                                        ; preds = %if.then59, %if.then38, %land.lhs.true44, %while.body.i169, %land.rhs.i166, %while.body.peel.i162, %land.rhs.lr.ph.i159, %skip_whitespace.exit, %if.then7.thread, %if.then7
  ...
  %F2P.8 = phi ptr [ %F2P.0308, %if.then7 ], [ %F2P.0.lcssa, %if.then7.thread ], [ %F2P.0301, %skip_whitespace.exit ], [ %F2P.0301, %land.rhs.lr.ph.i159 ], [ %uglygep.i155, %while.body.peel.i162 ], [ %uglygep.i155, %while.body.i169 ], [ %F2P.1, %land.rhs.i166 ], [ %F2P.6, %land.lhs.true44 ], [ %F2P.6, %if.then38 ], [ %F2P.5, %if.then59 ]
...
define internal fastcc ptr @AdvanceNumber(ptr noundef readonly %StartPos, ptr noundef readnone %End) unnamed_addr #6 {
entry:
...
land.rhs.preheader:                               ; preds = %if.end
  ...
  %uglygep = getelementptr i8, ptr %Pos.0, i64 %1
...
while.body:                                       ; preds = %land.rhs.preheader, %land.rhs
  ...
  %exitcond.not = icmp eq ptr %incdec.ptr4, %uglygep
...
cleanup:                                          ; preds = %while.body18, %land.rhs14
  %Pos.2.lcssa = phi ptr [ %EndOfNumber.1110, %land.rhs14 ], [ %uglygep, %while.body18 ]
  br i1 %switch.i91.peel, label %cleanup54, label %if.end24

if.end24:                                         ; preds = %while.body, %while.body18.peel, %cleanup, %land.lhs.true6
  %Pos.3 = phi ptr [ %Pos.2.lcssa, %cleanup ], [ %Pos.1105.lcssa, %land.lhs.true6 ], [ %uglygep, %while.body18.peel ], [ %uglygep, %while.body ]
  %EndOfNumber.2 = phi ptr [ %Pos.2.lcssa, %cleanup ], [ %EndOfNumber.0106.lcssa, %land.lhs.true6 ], [ %uglygep, %while.body18.peel ], [ %uglygep, %while.body ]
...
land.rhs46.preheader:                             ; preds = %if.end42
  ...
  %uglygep131 = getelementptr i8, ptr %Pos.4, i64 %13
...
while.cond43:                                     ; preds = %land.rhs46.preheader, %land.rhs46
  ...
  %exitcond132.not = icmp eq ptr %incdec.ptr51, %uglygep131
...
cleanup54:                                        ; preds = %while.cond43, %land.rhs46, %land.rhs46.preheader, %land.rhs14.preheader, %if.then9, %if.end, %if.end42, %if.end27, %land.lhs.true30, %if.end24, %cleanup
  %retval.1 = phi ptr [ %Pos.2.lcssa, %cleanup ], [ null, %if.end24 ], [ %EndOfNumber.2, %land.lhs.true30 ], [ %EndOfNumber.2, %if.end27 ], [ %EndOfNumber.2, %if.end42 ], [ null, %if.end ], [ %EndOfNumber.0106.lcssa, %if.then9 ], [ %EndOfNumber.0106.lcssa, %land.rhs14.preheader ], [ %EndOfNumber.2, %land.rhs46.preheader ], [ %incdec.ptr51, %land.rhs46 ], [ %uglygep131, %while.cond43 ]
  ret ptr %retval.1
}
