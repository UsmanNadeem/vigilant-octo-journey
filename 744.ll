; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/contain.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/contain.c"
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> %wide.load42, ptr %40, align 4, !tbaa !13
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load42 = load <4 x i32>, ptr %37, align 4, !tbaa !13
  ...
  store <4 x i32> %wide.load42, ptr %41, align 4, !tbaa !13
  %index.next = add nuw i64 %index, 8
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %39 = getelementptr inbounds i32, ptr %37, i64 -4
  %40 = getelementptr inbounds i32, ptr %39, i64 -3
  %wide.load50 = load <4 x i32>, ptr %40, align 4, !tbaa !13
  ...
  store <4 x i32> %wide.load50, ptr %44, align 4, !tbaa !13
  %index.next = add nuw i64 %index, 8
...
; Function Attrs: nounwind uwtable
define dso_local ptr @sf_unlist(ptr noundef %A1, i32 noundef %totcnt, i32 noundef %size) local_unnamed_addr #0 {
entry:
...
; Function Attrs: nounwind uwtable
define dso_local ptr @sf_ind_unlist(ptr noundef %A1, i32 noundef %totcnt, i32 noundef %size, ptr nocapture noundef %row_indices, ptr noundef %pfirst) local_unnamed_addr #0 {
entry:
  %call = tail call ptr (i32, i32, ...) @sf_new(i32 noundef %totcnt, i32 noundef %size) #10
  %count = getelementptr inbounds %struct.set_family, ptr %call, i64 0, i32 3
  store i32 %totcnt, ptr %count, align 4, !tbaa !5
...
; Function Attrs: nounwind uwtable
define dso_local ptr @sf_merge(ptr noundef %A1, ptr noundef %B1, ptr noundef %E1, i32 noundef %totcnt, i32 noundef %size) local_unnamed_addr #0 {
for.body5.lr.ph:
  %call = tail call ptr (i32, i32, ...) @sf_new(i32 noundef %totcnt, i32 noundef %size) #10
  %count = getelementptr inbounds %struct.set_family, ptr %call, i64 0, i32 3
  store i32 %totcnt, ptr %count, align 4, !tbaa !5
