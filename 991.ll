...
for.body.preheader:                               ; preds = %if.end295
  %9 = zext i1 %start_with_pm.1 to i64
  %wide.trip.count = and i64 %cond.i680, 4294967295
  br label %for.body
...
for.body:                                         ; preds = %for.body.preheader, %for.cond
  %indvars.iv = phi i64 [ %9, %for.body.preheader ], [ %indvars.iv.next, %for.cond ]
  %add.ptr.i687 = getelementptr inbounds i8, ptr %cond.i.i631, i64 %indvars.iv
  %10 = load i8, ptr %add.ptr.i687, align 1, !tbaa !22
  %conv306 = sext i8 %10 to i32
...
for.cond316.preheader:                            ; preds = %for.body
  ...
  br i1 %cmp320.not902, label %for.body322, label %if.end379

if.then312:                                       ; preds = %for.cond, %if.end295
  store i32 2, ptr %type, align 8, !tbaa !30
  br label %cleanup516

for.body322:                                      ; preds = %for.cond316.preheader, %for.inc372
  %indvars.iv910 = phi i64 [ %indvars.iv.next911, %for.inc372 ], [ 0, %for.cond316.preheader ]
  %add.ptr.i701 = getelementptr inbounds i8, ptr %cond.i.i631, i64 %indvars.iv910
  %11 = load i8, ptr %add.ptr.i701, align 1, !tbaa !22
  %.fr = freeze i8 %11
...
for.inc372:                                       ; preds = %switch.early.test895, %switch.early.test895, %switch.early.test895, %switch.early.test895, %switch.early.test895, %switch.early.test895, %switch.early.test895, %for.body322
  ...
  %exitcond914.not = icmp eq i64 %indvars.iv.next911, %wide.trip.count
  br i1 %exitcond914.not, label %if.end379, label %for.body322, !llvm.loop !37
...
if.end379:                                        ; preds = %for.inc372, %for.cond316.preheader
  ...
  %12 = load i8, ptr %cond.i.i631, align 1, !tbaa !22
  switch i8 %12, label %for.cond414.preheader [
...
for.cond414.preheader:                            ; preds = %if.end379
  br i1 %cmp320.not902, label %for.body420, label %if.end490.thread
...
if.then400:                                       ; preds = %if.end379, %if.end379, %if.end379, %if.end379
  ...
  %13 = load i64, ptr %__size_.i.i, align 8
  %bf.lshr.i.i779 = lshr i8 %bf.load.i.i775, 1
  %conv.i.i780 = zext i8 %bf.lshr.i.i779 to i64
  %cond.i781 = select i1 %tobool.i.not.i777, i64 %conv.i.i780, i64 %13
...
if.then.i:                                        ; preds = %if.then400
  ...
  %14 = load ptr, ptr %__data_.i.i, align 8, !tbaa !22
...
for.body420:                                      ; preds = %for.cond414.preheader, %for.inc446
  %indvars.iv915 = phi i64 [ %indvars.iv.next916, %for.inc446 ], [ 0, %for.cond414.preheader ]
  %add.ptr.i799 = getelementptr inbounds i8, ptr %cond.i.i631, i64 %indvars.iv915
  %15 = load i8, ptr %add.ptr.i799, align 1, !tbaa !22
  switch i8 %15, label %for.inc446 [
...
for.inc446:                                       ; preds = %for.body420
  ...
  %exitcond919.not = icmp eq i64 %indvars.iv.next916, %wide.trip.count
  br i1 %exitcond919.not, label %if.end490.thread, label %for.body420, !llvm.loop !38

cleanup448:                                       ; preds = %for.body420, %for.body420, %for.body420, %for.body420
  %16 = trunc i64 %indvars.iv915 to i32
  %sext924 = shl i64 %cond.i680, 32
  %17 = ashr exact i64 %sext924, 32
  br label %for.cond453

for.cond453:                                      ; preds = %cleanup448, %for.body459
  %indvars.iv921 = phi i64 [ %indvars.iv915, %cleanup448 ], [ %indvars.iv.next922, %for.body459 ]
  %indvars.iv.next922 = add nuw nsw i64 %indvars.iv921, 1
  %cmp457.not = icmp slt i64 %indvars.iv.next922, %17
  br i1 %cmp457.not, label %for.body459, label %if.end490.thread

for.body459:                                      ; preds = %for.cond453
  %add.ptr.i834 = getelementptr inbounds i8, ptr %cond.i.i631, i64 %indvars.iv.next922
  %18 = load i8, ptr %add.ptr.i834, align 1, !tbaa !22
  switch i8 %18, label %for.cond453 [
...
if.end490.thread:                                 ; preds = %for.inc446, %for.cond453, %for.cond414.preheader
  %19 = phi i32 [ %conv301, %for.cond414.preheader ], [ %16, %for.cond453 ], [ %conv301, %for.inc446 ]
  %ic2.0 = add nsw i32 %19, -1
...
if.then.i867:                                     ; preds = %if.end490.thread
  ...
  %20 = load ptr, ptr %__data_.i.i866, align 8, !tbaa !22
...
return:                                           ; preds = %entry, %if.end
  ...
  tail call void @_ZN2PP4WordC2ERKS0_(ptr noundef nonnull align 8 dereferenceable(104) %agg.result, ptr noundef nonnull align 8 dereferenceable(104) %this.sink)
  ret void
}
...
common.resume:                                    ; preds = %lpad.i.i486, %lpad.i.i472, %lpad.i.i458, %lpad.i.i444, %lpad.i.i430, %lpad.i.i416, %lpad.i.i402, %lpad.i.i388, %lpad.i.i374, %lpad.i.i360, %lpad.i.i346, %lpad.i.i332, %lpad.i.i318, %lpad.i.i304, %lpad.i.i
  %common.resume.op = phi { ptr, i32 } [ %4, %lpad.i.i ], [ %7, %lpad.i.i304 ], [ %16, %lpad.i.i318 ], [ %20, %lpad.i.i332 ], [ %22, %lpad.i.i346 ], [ %26, %lpad.i.i360 ], [ %28, %lpad.i.i374 ], [ %37, %lpad.i.i388 ], [ %40, %lpad.i.i402 ], [ %49, %lpad.i.i416 ], [ %53, %lpad.i.i430 ], [ %55, %lpad.i.i444 ], [ %57, %lpad.i.i458 ], [ %61, %lpad.i.i472 ], [ %63, %lpad.i.i486 ]
  resume { ptr, i32 } %common.resume.op
...
for.body.preheader:                               ; preds = %if.end29
  %32 = zext i1 %start_with_pm.1 to i64
  %wide.trip.count = and i64 %cond.i, 4294967295
  br label %for.body

for.body:                                         ; preds = %for.body.preheader, %for.inc
  %indvars.iv = phi i64 [ %32, %for.body.preheader ], [ %indvars.iv.next, %for.inc ]
  ...
  %33 = load i8, ptr %add.ptr.i200, align 1, !tbaa !22
  %conv51 = sext i8 %33 to i32
  %isdigittmp = add nsw i32 %conv51, -48
  %isdigit = icmp ult i32 %isdigittmp, 10
  %cmp66 = icmp eq i8 %33, 46
...
if.end68:                                         ; preds = %if.end61
  %34 = and i8 %dot_found.0493, 1
  %tobool69.not = icmp eq i8 %34, 0
  %cmp75.not = icmp eq i8 %33, 48
...
if.then79:                                        ; preds = %if.end68, %land.lhs.true54
  ...
  %35 = load ptr, ptr %lines80, align 8, !tbaa !31
  %cmp81.not = icmp eq ptr %35, null
...
invoke.cont.i.i387:                               ; preds = %if.then82
  ...
  %36 = load ptr, ptr %vfn.i.i.i385, align 8
  %call.i6.i.i386 = invoke noundef signext i8 %36(ptr noundef nonnull align 8 dereferenceable(25) %call.i5.i.i383, i8 noundef signext 10)
...
_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit391: ; preds = %invoke.cont.i.i387
  ...
  %38 = load i32, ptr %file_line_number87, align 4, !tbaa !33
  %call88 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSt3__113basic_ostreamIcNS_11char_traitsIcEEElsEi(ptr noundef nonnull align 8 dereferenceable(8) %call1.i224, i32 noundef %38)
...
invoke.cont.i.i401:                               ; preds = %_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit391
  ...
  %39 = load ptr, ptr %vfn.i.i.i399, align 8
  %call.i6.i.i400 = invoke noundef signext i8 %39(ptr noundef nonnull align 8 dereferenceable(25) %call.i5.i.i397, i8 noundef signext 10)
...
_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit405: ; preds = %invoke.cont.i.i401
  ...
  %41 = load ptr, ptr %lines80, align 8, !tbaa !31
  %line_number94 = getelementptr inbounds %"class.PP::Word", ptr %this, i64 0, i32 7
  %42 = load i32, ptr %line_number94, align 8, !tbaa !32
  %sub95 = add nsw i32 %42, -1
  %conv96 = sext i32 %sub95 to i64
  %__start_.i230 = getelementptr inbounds %"class.std::__1::deque", ptr %41, i64 0, i32 1
  %43 = load i64, ptr %__start_.i230, align 8, !tbaa !62
  %add.i231 = add i64 %43, %conv96
  %__begin_.i.i232 = getelementptr inbounds %"struct.std::__1::__split_buffer", ptr %41, i64 0, i32 1
  %44 = load ptr, ptr %__begin_.i.i232, align 8, !tbaa !69
  %div.i233 = udiv i64 %add.i231, 170
  %add.ptr.i234 = getelementptr inbounds ptr, ptr %44, i64 %div.i233
  %45 = load ptr, ptr %add.ptr.i234, align 8, !tbaa !29
  %rem.i235 = urem i64 %add.i231, 170
  %add.ptr2.i236 = getelementptr inbounds %"class.std::__1::basic_string", ptr %45, i64 %rem.i235
...
invoke.cont.i.i415:                               ; preds = %_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit405
  ...
  %48 = load ptr, ptr %vfn.i.i.i413, align 8
  %call.i6.i.i414 = invoke noundef signext i8 %48(ptr noundef nonnull align 8 dereferenceable(25) %call.i5.i.i411, i8 noundef signext 10)
...
invoke.cont.i.i429:                               ; preds = %_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit419
  ...
  %52 = load ptr, ptr %vfn.i.i.i427, align 8
  %call.i6.i.i428 = invoke noundef signext i8 %52(ptr noundef nonnull align 8 dereferenceable(25) %call.i5.i.i425, i8 noundef signext 10)
...
invoke.cont.i.i443:                               ; preds = %if.end105
  ...
  %54 = load ptr, ptr %vfn.i.i.i441, align 8
  %call.i6.i.i442 = invoke noundef signext i8 %54(ptr noundef nonnull align 8 dereferenceable(25) %call.i5.i.i439, i8 noundef signext 10)
...
invoke.cont.i.i457:                               ; preds = %_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit447
  ...
  %56 = load ptr, ptr %vfn.i.i.i455, align 8
  %call.i6.i.i456 = invoke noundef signext i8 %56(ptr noundef nonnull align 8 dereferenceable(25) %call.i5.i.i453, i8 noundef signext 10)
...
_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit461: ; preds = %invoke.cont.i.i457
  ...
  %58 = load ptr, ptr %__data_.i.i.i, align 8
  %cond.i.i.i276 = select i1 %tobool.i.not.i.i.i273, ptr %__data_.i4.i.i, ptr %58
  %59 = load i64, ptr %__size_.i.i, align 8
  %bf.lshr.i.i.i278 = lshr i8 %bf.load.i.i.i.i271, 1
  %conv.i.i.i279 = zext i8 %bf.lshr.i.i.i278 to i64
  %cond.i.i280 = select i1 %tobool.i.not.i.i.i273, i64 %conv.i.i.i279, i64 %59
...
invoke.cont.i.i471:                               ; preds = %_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit461
  ...
  %60 = load ptr, ptr %vfn.i.i.i469, align 8
  %call.i6.i.i470 = invoke noundef signext i8 %60(ptr noundef nonnull align 8 dereferenceable(25) %call.i5.i.i467, i8 noundef signext 10)
...
invoke.cont.i.i485:                               ; preds = %_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit475
  ...
  %62 = load ptr, ptr %vfn.i.i.i483, align 8
  %call.i6.i.i484 = invoke noundef signext i8 %62(ptr noundef nonnull align 8 dereferenceable(25) %call.i5.i.i481, i8 noundef signext 10)
...
if.end118:                                        ; preds = %for.inc, %if.end29
  ...
  %negate = getelementptr inbounds %"class.PP::Word", ptr %this, i64 0, i32 3
  %64 = load i8, ptr %negate, align 1, !tbaa !17, !range !18, !noundef !19
  %tobool122.not = icmp eq i8 %64, 0
  %mul = sub nsw i32 0, %conv.i
...
common.resume:                                    ; preds = %lpad, %lpad.i.i480, %lpad.i.i466, %lpad.i.i452, %lpad.i.i438, %lpad.i.i424, %lpad.i.i410, %lpad.i.i396, %lpad.i.i382, %lpad.i.i368, %lpad.i.i354, %lpad.i.i340, %lpad.i.i326, %lpad.i.i312, %lpad.i.i298, %lpad.i.i
  %common.resume.op = phi { ptr, i32 } [ %4, %lpad.i.i ], [ %7, %lpad.i.i298 ], [ %16, %lpad.i.i312 ], [ %20, %lpad.i.i326 ], [ %22, %lpad.i.i340 ], [ %26, %lpad.i.i354 ], [ %28, %lpad.i.i368 ], [ %37, %lpad.i.i382 ], [ %40, %lpad.i.i396 ], [ %49, %lpad.i.i410 ], [ %53, %lpad.i.i424 ], [ %55, %lpad.i.i438 ], [ %57, %lpad.i.i452 ], [ %61, %lpad.i.i466 ], [ %63, %lpad.i.i480 ], [ %66, %lpad ]
  resume { ptr, i32 } %common.resume.op
...
for.body:                                         ; preds = %for.body.preheader, %for.inc
  ...
  %33 = load i8, ptr %add.ptr.i201, align 1, !tbaa !22
  %conv51 = sext i8 %33 to i32
  %isdigittmp = add nsw i32 %conv51, -48
  %isdigit = icmp ult i32 %isdigittmp, 10
  %cmp66 = icmp eq i8 %33, 46
...
invoke.cont.i.i381:                               ; preds = %if.then82
  ...
  %36 = load ptr, ptr %vfn.i.i.i379, align 8
  %call.i6.i.i380 = invoke noundef signext i8 %36(ptr noundef nonnull align 8 dereferenceable(25) %call.i5.i.i377, i8 noundef signext 10)
...
_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit385: ; preds = %invoke.cont.i.i381
  ...
  %file_line_number87 = getelementptr inbounds %"class.PP::Word", ptr %this, i64 0, i32 8
  %38 = load i32, ptr %file_line_number87, align 4, !tbaa !33
  %call88 = call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSt3__113basic_ostreamIcNS_11char_traitsIcEEElsEi(ptr noundef nonnull align 8 dereferenceable(8) %call1.i225, i32 noundef %38)
...
invoke.cont.i.i395:                               ; preds = %_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit385
  ...
  %39 = load ptr, ptr %vfn.i.i.i393, align 8
  %call.i6.i.i394 = invoke noundef signext i8 %39(ptr noundef nonnull align 8 dereferenceable(25) %call.i5.i.i391, i8 noundef signext 10)
...
_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit399: ; preds = %invoke.cont.i.i395
  ...
  %sub95 = add nsw i32 %42, -1
  %conv96 = sext i32 %sub95 to i64
  %__start_.i231 = getelementptr inbounds %"class.std::__1::deque", ptr %41, i64 0, i32 1
  %43 = load i64, ptr %__start_.i231, align 8, !tbaa !62
  %add.i232 = add i64 %43, %conv96
  %__begin_.i.i233 = getelementptr inbounds %"struct.std::__1::__split_buffer", ptr %41, i64 0, i32 1
  %44 = load ptr, ptr %__begin_.i.i233, align 8, !tbaa !69
  %div.i234 = udiv i64 %add.i232, 170
  %add.ptr.i235 = getelementptr inbounds ptr, ptr %44, i64 %div.i234
  %45 = load ptr, ptr %add.ptr.i235, align 8, !tbaa !29
  %rem.i236 = urem i64 %add.i232, 170
  %add.ptr2.i237 = getelementptr inbounds %"class.std::__1::basic_string", ptr %45, i64 %rem.i236
...
invoke.cont.i.i409:                               ; preds = %_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit399
  ...
  %48 = load ptr, ptr %vfn.i.i.i407, align 8
  %call.i6.i.i408 = invoke noundef signext i8 %48(ptr noundef nonnull align 8 dereferenceable(25) %call.i5.i.i405, i8 noundef signext 10)
...
invoke.cont.i.i423:                               ; preds = %_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit413
  ...
  %52 = load ptr, ptr %vfn.i.i.i421, align 8
  %call.i6.i.i422 = invoke noundef signext i8 %52(ptr noundef nonnull align 8 dereferenceable(25) %call.i5.i.i419, i8 noundef signext 10)
...
invoke.cont.i.i437:                               ; preds = %if.end105
  ...
  %54 = load ptr, ptr %vfn.i.i.i435, align 8
  %call.i6.i.i436 = invoke noundef signext i8 %54(ptr noundef nonnull align 8 dereferenceable(25) %call.i5.i.i433, i8 noundef signext 10)
...
invoke.cont.i.i451:                               ; preds = %_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit441
  %vtable.i.i.i448 = load ptr, ptr %call.i5.i.i447, align 8, !tbaa !20
  %vfn.i.i.i449 = getelementptr inbounds ptr, ptr %vtable.i.i.i448, i64 7
  %56 = load ptr, ptr %vfn.i.i.i449, align 8
  %call.i6.i.i450 = invoke noundef signext i8 %56(ptr noundef nonnull align 8 dereferenceable(25) %call.i5.i.i447, i8 noundef signext 10)
...
_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit455: ; preds = %invoke.cont.i.i451
  ...
  %58 = load ptr, ptr %__data_.i.i.i, align 8
  %cond.i.i.i277 = select i1 %tobool.i.not.i.i.i274, ptr %__data_.i4.i.i, ptr %58
  %59 = load i64, ptr %__size_.i.i, align 8
  %bf.lshr.i.i.i279 = lshr i8 %bf.load.i.i.i.i272, 1
  %conv.i.i.i280 = zext i8 %bf.lshr.i.i.i279 to i64
  %cond.i.i281 = select i1 %tobool.i.not.i.i.i274, i64 %conv.i.i.i280, i64 %59
...
invoke.cont.i.i465:                               ; preds = %_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit455
  ...
  %60 = load ptr, ptr %vfn.i.i.i463, align 8
  %call.i6.i.i464 = invoke noundef signext i8 %60(ptr noundef nonnull align 8 dereferenceable(25) %call.i5.i.i461, i8 noundef signext 10)
...
invoke.cont.i.i479:                               ; preds = %_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit469
  ...
  %62 = load ptr, ptr %vfn.i.i.i477, align 8
  %call.i6.i.i478 = invoke noundef signext i8 %62(ptr noundef nonnull align 8 dereferenceable(25) %call.i5.i.i475, i8 noundef signext 10)
...
invoke.cont:                                      ; preds = %if.end118
  ...
  %.pre = load i64, ptr %iret, align 8, !tbaa !23
  %mul = sub nsw i64 0, %.pre
  %65 = select i1 %tobool121.not, i64 %.pre, i64 %mul
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %iret) #26
...
if.then.i.i.i.i:                                  ; preds = %invoke.cont
  ...
  %67 = load ptr, ptr %__data_.i.i.i.i.i, align 8, !tbaa !22
  call void @_ZdlPv(ptr noundef %67) #27
  br label %_ZNSt3__118basic_stringstreamIcNS_11char_traitsIcEENS_9allocatorIcEEED1Ev.exit
...
return:                                           ; preds = %_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit483, %_ZNSt3__118basic_stringstreamIcNS_11char_traitsIcEENS_9allocatorIcEEED1Ev.exit, %_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit371
  %retval.1 = phi i64 [ 0, %_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit371 ], [ %65, %_ZNSt3__118basic_stringstreamIcNS_11char_traitsIcEENS_9allocatorIcEEED1Ev.exit ], [ 0, %_ZNSt3__14endlB7v170000IcNS_11char_traitsIcEEEERNS_13basic_ostreamIT_T0_EES7_.exit483 ]
  ret i64 %retval.1
}
