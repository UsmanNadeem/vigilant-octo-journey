; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr68506.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr68506.c"
...
for.end.split.us.i:                               ; preds = %for.body.i
  ...
  %cmp46.us.i = icmp eq i32 %3, 0
  br i1 %cmp46.us.i, label %for.inc53.split.us.i, label %for.cond35.us.i

for.cond35.us.i:                                  ; preds = %for.end.split.us.i, %for.cond35.us.i
  br label %for.cond35.us.i

for.inc53.split.us.i:                             ; preds = %for.end.split.us.i
  %4 = load i32, ptr @i, align 4, !tbaa !5
  %5 = trunc i32 %4 to i8
  %conv41.us.i = or i8 %5, 7
...
for.inc53.i:                                      ; preds = %for.inc53.loopexit.i, %for.inc53.split.us.i
  %11 = phi i32 [ %0, %for.inc53.split.us.i ], [ %.pre61.i, %for.inc53.loopexit.i ]
  %.us-phi.i = phi i8 [ %conv41.us.i, %for.inc53.split.us.i ], [ %conv41.i, %for.inc53.loopexit.i ]
