...
if.then.i135:                                     ; preds = %if.then45
  ...
  %.pre = load ptr, ptr %__parent_.i103.le187, align 8, !tbaa !28
...
_ZNSt3__119__tree_right_rotateB7v170000IPNS_16__tree_node_baseIPvEEEEvT_.exit141: ; preds = %if.then45, %if.then.i135
  ...
  store ptr %22, ptr %__parent_7.i137, align 8, !tbaa !28
  %23 = load ptr, ptr %__parent_.i103.le187, align 8, !tbaa !28
  ...
  store ptr %20, ptr %__parent_.i103.le187, align 8, !tbaa !28
  %.pre174 = load ptr, ptr %__parent_7.i137, align 8, !tbaa !28
  br label %if.end47
