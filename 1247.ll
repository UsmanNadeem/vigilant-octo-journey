; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr44575.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr44575.c"
...
land.lhs.true.1:                                  ; preds = %vaarg.in_reg.1, %vaarg.in_mem.1
  %arg.sroa.3.1.ph.1 = phi float [ %vaarg.addr.sroa.phi.sroa.speculate.load.vaarg.in_mem.1, %vaarg.in_mem.1 ], [ %5, %vaarg.in_reg.1 ]
...
land.lhs.true:                                    ; preds = %vaarg.in_mem, %vaarg.in_reg
  ...
  %12 = phi i32 [ %fp_offset_p.promoted, %vaarg.in_mem ], [ %11, %vaarg.in_reg ]
  %arg.sroa.3.1.ph = phi float [ %vaarg.addr.sroa.phi.sroa.speculate.load.vaarg.in_mem, %vaarg.in_mem ], [ %10, %vaarg.in_reg ]
