; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/Bz2Handler.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/Bz2Handler.cpp"
...
if.then:                                          ; preds = %entry
  %_packSize = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 8
  %2 = load i64, ptr %_packSize, align 8, !tbaa !19
...
invoke.cont:                                      ; preds = %entry
  ...
  %vtable3 = load ptr, ptr %stream, align 8, !tbaa !31
...
cleanup.cont17:                                   ; preds = %invoke.cont10
  %7 = load i8, ptr %buf, align 1, !tbaa !33
...
if.end27:                                         ; preds = %cleanup.cont17
  ...
  %vtable29 = load ptr, ptr %stream, align 8, !tbaa !31
...
if.then.i:                                        ; preds = %invoke.cont32
  %12 = load i64, ptr %endPosition, align 8, !tbaa !34
  %13 = load i64, ptr %_startPosition, align 8, !tbaa !35
  %sub = sub i64 %12, %13
  %_packSize = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 8
  store i64 %sub, ptr %_packSize, align 8, !tbaa !19
  %_packSizeDefined = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 10
  store i8 1, ptr %_packSizeDefined, align 8, !tbaa !36
  %_stream = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 6
  %vtable.i = load ptr, ptr %stream, align 8, !tbaa !31
...
if.end.i:                                         ; preds = %if.then.i
  %15 = load ptr, ptr %_stream, align 8, !tbaa !37
  %tobool.not.i = icmp eq ptr %15, null
  br i1 %tobool.not.i, label %if.then.i87, label %if.then2.i

if.then2.i:                                       ; preds = %if.end.i
  %vtable4.i = load ptr, ptr %15, align 8, !tbaa !31
...
if.then.i87:                                      ; preds = %if.then2.i, %if.end.i
  store ptr %stream, ptr %_stream, align 8, !tbaa !37
  %_seqStream = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 7
  %vtable.i85 = load ptr, ptr %stream, align 8, !tbaa !31
...
20:                                               ; preds = %if.end.i89, %if.then2.i92
  store ptr %stream, ptr %_seqStream, align 8, !tbaa !38
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %endPosition) #17
  call void @llvm.lifetime.end.p0(i64 3, ptr nonnull %buf) #17
  br label %return
...
if.then.i.i:                                      ; preds = %entry
  %vtable.i.i = load ptr, ptr %stream, align 8, !tbaa !31
...
_ZN8NArchive4NBz28CHandler7OpenSeqEP19ISequentialInStream.exit: ; preds = %if.end.i.i, %if.then2.i.i
  store ptr %stream, ptr %_seqStream.i, align 8, !tbaa !38
  ret i32 0
}
...
entry:
  %_packSizeDefined = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 10
  store i8 0, ptr %_packSizeDefined, align 8, !tbaa !36
  %_seqStream = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 7
  %0 = load ptr, ptr %_seqStream, align 8, !tbaa !38
...
if.then.i:                                        ; preds = %entry
  ...
  store ptr null, ptr %_seqStream, align 8, !tbaa !38
...
_ZN9CMyComPtrI19ISequentialInStreamE7ReleaseEv.exit: ; preds = %entry, %if.then.i
  %_stream = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 6
  %2 = load ptr, ptr %_stream, align 8, !tbaa !37
...
if.then.i6:                                       ; preds = %_ZN9CMyComPtrI19ISequentialInStreamE7ReleaseEv.exit
  %vtable.i3 = load ptr, ptr %2, align 8, !tbaa !31
  ...
  store ptr null, ptr %_stream, align 8, !tbaa !37
...
if.end6:                                          ; preds = %entry, %lor.lhs.false
  %_stream = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 6
  %1 = load ptr, ptr %_stream, align 8, !tbaa !37
...
if.then7:                                         ; preds = %if.end6
  %_packSize = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 8
  %2 = load i64, ptr %_packSize, align 8, !tbaa !19
  %vtable = load ptr, ptr %extractCallback, align 8, !tbaa !31
...
if.end10:                                         ; preds = %if.then7, %if.end6
  ...
  store i64 0, ptr %currentTotalPacked, align 8, !tbaa !34
  %vtable11 = load ptr, ptr %extractCallback, align 8, !tbaa !31
...
cleanup.cont:                                     ; preds = %invoke.cont14
  ...
  store ptr null, ptr %realOutStream, align 8, !tbaa !39
  %tobool21.not = icmp ne i32 %testMode, 0
  %cond = zext i1 %tobool21.not to i32
  %vtable26 = load ptr, ptr %extractCallback, align 8, !tbaa !31
...
if.end42:                                         ; preds = %cleanup.cont35
  %vtable43 = load ptr, ptr %extractCallback, align 8, !tbaa !31
...
invoke.cont51:                                    ; preds = %invoke.cont48
  %vtable.i = load ptr, ptr %call49, align 8, !tbaa !31
  %vfn.i = getelementptr inbounds ptr, ptr %vtable.i, i64 1
...
invoke.cont53:                                    ; preds = %invoke.cont51
  %13 = load ptr, ptr %_stream, align 8, !tbaa !37
  %tobool58.not = icmp eq ptr %13, null
  br i1 %tobool58.not, label %if.end75, label %if.then59

if.then59:                                        ; preds = %invoke.cont53
  %_startPosition = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 9
  %14 = load i64, ptr %_startPosition, align 8, !tbaa !35
  %vtable65 = load ptr, ptr %13, align 8, !tbaa !31
...
if.end75:                                         ; preds = %invoke.cont67, %invoke.cont53
  %_seqStream = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 7
  %21 = load ptr, ptr %_seqStream, align 8, !tbaa !38
  %vtable78 = load ptr, ptr %call49, align 8, !tbaa !31
...
invoke.cont80:                                    ; preds = %if.end75
  ...
  %23 = load i32, ptr %_numThreads, align 8, !tbaa !41
  %vtable83 = load ptr, ptr %call49, align 8, !tbaa !31
...
invoke.cont98:                                    ; preds = %cleanup.cont93
  ...
  store ptr getelementptr inbounds ({ [8 x ptr] }, ptr @_ZTV15CDummyOutStream, i64 0, inrange i32 0, i64 2), ptr %call96, align 8, !tbaa !31
  %_stream.i = getelementptr inbounds %class.CDummyOutStream, ptr %call96, i64 0, i32 2
  store ptr null, ptr %_stream.i, align 8, !tbaa !39
...
invoke.cont100:                                   ; preds = %invoke.cont98
  %28 = load ptr, ptr %realOutStream, align 8, !tbaa !39
  %cmp.not.i.i = icmp eq ptr %28, null
  br i1 %cmp.not.i.i, label %if.end.i.i, label %if.then.i.i

if.then.i.i:                                      ; preds = %invoke.cont100
  %vtable.i.i = load ptr, ptr %28, align 8, !tbaa !31
  %vfn.i.i = getelementptr inbounds ptr, ptr %vtable.i.i, i64 1
...
if.end.i.i:                                       ; preds = %if.then.i.i, %invoke.cont100
  %30 = load ptr, ptr %_stream.i, align 8, !tbaa !39
  %tobool.not.i.i = icmp eq ptr %30, null
  br i1 %tobool.not.i.i, label %invoke.cont104, label %if.then2.i.i

if.then2.i.i:                                     ; preds = %if.end.i.i
  %vtable4.i.i = load ptr, ptr %30, align 8, !tbaa !31
  %vfn5.i.i = getelementptr inbounds ptr, ptr %vtable4.i.i, i64 2
...
invoke.cont104:                                   ; preds = %if.end.i.i, %if.then2.i.i
  store ptr %28, ptr %_stream.i, align 8, !tbaa !39
  %_size.i = getelementptr inbounds %class.CDummyOutStream, ptr %call96, i64 0, i32 3
  store i64 0, ptr %_size.i, align 8, !tbaa !43
  %32 = load ptr, ptr %realOutStream, align 8, !tbaa !39
  %tobool.not.i = icmp eq ptr %32, null
  br i1 %tobool.not.i, label %invoke.cont106, label %if.then.i

if.then.i:                                        ; preds = %invoke.cont104
  %vtable.i267 = load ptr, ptr %32, align 8, !tbaa !31
...
invoke.cont111:                                   ; preds = %invoke.cont108
  %vtable.i270 = load ptr, ptr %call109, align 8, !tbaa !31
...
for.cond.preheader:                               ; preds = %invoke.cont113
  ...
  %_packSizeDefined = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 10
  %35 = load i64, ptr %currentTotalPacked, align 8, !tbaa !34
  store i64 %35, ptr %InSize, align 8, !tbaa !46
  %36 = load i64, ptr %_size.i, align 8, !tbaa !43
  store i64 %36, ptr %OutSize, align 8, !tbaa !51
...
if.end138.peel:                                   ; preds = %invoke.cont134.peel
  %37 = load i8, ptr %isBz2, align 1, !tbaa !52, !range !53, !noundef !54
...
cleanup148.peel:                                  ; preds = %if.end138.peel
  ...
  store i64 %sub2.i.i.peel, ptr %currentTotalPacked, align 8, !tbaa !34
  store i64 %sub2.i.i.peel, ptr %_packSize147, align 8, !tbaa !19
  store i8 1, ptr %_packSizeDefined, align 8, !tbaa !36
...
for.cond:                                         ; preds = %cleanup148.peel, %cleanup148
  ...
  store i64 %43, ptr %InSize, align 8, !tbaa !46
  %44 = load i64, ptr %_size.i, align 8, !tbaa !43
  store i64 %44, ptr %OutSize, align 8, !tbaa !51
...
if.end138:                                        ; preds = %invoke.cont134
  %53 = load i8, ptr %isBz2, align 1, !tbaa !52, !range !53, !noundef !54
...
cleanup148:                                       ; preds = %if.end138
  ...
  store i64 %sub2.i.i, ptr %currentTotalPacked, align 8, !tbaa !34
  store i64 %sub2.i.i, ptr %_packSize147, align 8, !tbaa !19
  store i8 1, ptr %_packSizeDefined, align 8, !tbaa !36
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %isBz2) #17
...
for.end:                                          ; preds = %if.end138, %invoke.cont134, %if.end138.peel, %invoke.cont134.peel
  ...
  call void @llvm.lifetime.end.p0(i64 1, ptr nonnull %isBz2) #17
  %vtable151 = load ptr, ptr %call49, align 8, !tbaa !31
...
if.then.i279:                                     ; preds = %for.end
  %vtable.i277 = load ptr, ptr %call96, align 8, !tbaa !31
...
if.end162:                                        ; preds = %invoke.cont155, %if.then159
  ...
  %vtable163 = load ptr, ptr %extractCallback, align 8, !tbaa !31
...
if.then.i286:                                     ; preds = %invoke.cont121, %invoke.cont121.peel, %if.end162, %invoke.cont155
  ...
  %vtable.i284 = load ptr, ptr %call109, align 8, !tbaa !31
...
if.then.i291:                                     ; preds = %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit
  %vtable.i288 = load ptr, ptr %outStream.sroa.0.1, align 8, !tbaa !31
...
if.then.i297:                                     ; preds = %lpad120.loopexit, %lpad120.loopexit.split-lp, %lpad114, %lpad165, %lpad129, %lpad116
  ...
  %vtable.i294 = load ptr, ptr %call109, align 8, !tbaa !31
...
if.then.i304:                                     ; preds = %lpad112, %lpad101, %lpad107, %lpad110, %ehcleanup179
  ...
  %vtable.i301 = load ptr, ptr %outStream.sroa.0.4348, align 8, !tbaa !31
...
if.then.i311:                                     ; preds = %invoke.cont86, %invoke.cont67, %_ZN9CMyComPtrI21ICompressProgressInfoED2Ev.exit, %if.then.i291
  ...
  %vtable.i308 = load ptr, ptr %call49, align 8, !tbaa !31
...
if.then.i317:                                     ; preds = %lpad55, %lpad62, %lpad85, %lpad94, %if.then.i304, %ehcleanup179, %lpad99
  ...
  %vtable.i314 = load ptr, ptr %call49, align 8, !tbaa !31
...
cleanup190:                                       ; preds = %if.then.i311, %invoke.cont28
  ...
  %.pr = load ptr, ptr %realOutStream, align 8, !tbaa !39
...
if.then.i324:                                     ; preds = %cleanup190
  %vtable.i321 = load ptr, ptr %.pr, align 8, !tbaa !31
...
ehcleanup191:                                     ; preds = %lpad52, %if.then.i317, %lpad47, %lpad50, %lpad38, %lpad23
  ...
  %84 = load ptr, ptr %realOutStream, align 8, !tbaa !39
...
if.then.i331:                                     ; preds = %ehcleanup191
  %vtable.i328 = load ptr, ptr %84, align 8, !tbaa !31
...
if.then8:                                         ; preds = %cleanup.cont
  ...
  %wReserved1.i = getelementptr inbounds %struct.tagPROPVARIANT, ptr %prop, i64 0, i32 1
  store i16 0, ptr %wReserved1.i, align 2, !tbaa !18
  %vtable10 = load ptr, ptr %updateCallback, align 8, !tbaa !31
...
if.then37:                                        ; preds = %if.end35
  ...
  %vtable40 = load ptr, ptr %updateCallback, align 8, !tbaa !31
...
if.end78:                                         ; preds = %if.then68, %if.end66
  ...
  %_numThreads = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 15
  %25 = load i32, ptr %_numThreads, align 8, !tbaa !41
  %vtable.i = load ptr, ptr %updateCallback, align 8, !tbaa !31
...
cleanup.cont.i:                                   ; preds = %if.end78
  ...
  store i64 0, ptr %complexity.i, align 8, !tbaa !34
  %vtable2.i = load ptr, ptr %updateCallback, align 8, !tbaa !31
...
cleanup.cont10.i:                                 ; preds = %cleanup.cont.i
  ...
  store ptr null, ptr %fileInStream.i, align 8, !tbaa !38
  %vtable13.i = load ptr, ptr %updateCallback, align 8, !tbaa !31
...
invoke.cont27.i:                                  ; preds = %invoke.cont24.i
  %vtable.i.i = load ptr, ptr %call25.i, align 8, !tbaa !31
  %vfn.i.i = getelementptr inbounds ptr, ptr %vtable.i.i, i64 1
...
invoke.cont36.i:                                  ; preds = %invoke.cont33.i
  %vtable.i145.i = load ptr, ptr %call34.i, align 8, !tbaa !31
...
invoke.cont38.i:                                  ; preds = %invoke.cont36.i
  ...
  store i32 %dicSize.0, ptr %32, align 8, !tbaa !33
  ...
  store i32 %numPasses.0, ptr %33, align 8, !tbaa !33
  ...
  store i32 %25, ptr %34, align 8, !tbaa !33
  ...
  %vtable47.i = load ptr, ptr %call34.i, align 8, !tbaa !31
...
cleanup.cont73.i:                                 ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit.2.i
  %46 = load ptr, ptr %fileInStream.i, align 8, !tbaa !38
  %vtable82.i = load ptr, ptr %call34.i, align 8, !tbaa !31
...
cleanup.cont91.i:                                 ; preds = %invoke.cont84.i
  %vtable93.i = load ptr, ptr %updateCallback, align 8, !tbaa !31
...
if.then.i.i:                                      ; preds = %cleanup.cont91.i, %invoke.cont84.i, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit.2.i
  ...
  %vtable.i153.i = load ptr, ptr %call34.i, align 8, !tbaa !31
...
if.then.i161.i:                                   ; preds = %if.then.i.i
  %vtable.i158.i = load ptr, ptr %call25.i, align 8, !tbaa !31
...
if.then.i167.i:                                   ; preds = %lpad95.i, %lpad75.i, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit152.2.i
  ...
  %vtable.i164.i = load ptr, ptr %call34.i, align 8, !tbaa !31
...
if.then.i174.i:                                   ; preds = %if.then.i167.i, %lpad37.i, %lpad35.i, %lpad32.i, %lpad30.i
  ...
  %vtable.i171.i = load ptr, ptr %call25.i, align 8, !tbaa !31
...
cleanup110.i:                                     ; preds = %if.then.i161.i, %invoke.cont15.i
  ...
  %65 = load ptr, ptr %fileInStream.i, align 8, !tbaa !38
...
if.then.i181.i:                                   ; preds = %cleanup110.i
  %vtable.i178.i = load ptr, ptr %65, align 8, !tbaa !31
...
ehcleanup111.i:                                   ; preds = %if.then.i174.i, %lpad28.i, %lpad26.i, %lpad23.i, %lpad.i
  ...
  %69 = load ptr, ptr %fileInStream.i, align 8, !tbaa !38
...
if.then.i187.i:                                   ; preds = %ehcleanup111.i
  %vtable.i184.i = load ptr, ptr %69, align 8, !tbaa !31
...
if.end86:                                         ; preds = %if.end83
  %_stream = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 6
  %74 = load ptr, ptr %_stream, align 8, !tbaa !37
  %tobool88.not = icmp eq ptr %74, null
  br i1 %tobool88.not, label %if.end102, label %if.then89

if.then89:                                        ; preds = %if.end86
  %_startPosition = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 9
  %75 = load i64, ptr %_startPosition, align 8, !tbaa !35
  %vtable93 = load ptr, ptr %74, align 8, !tbaa !31
...
if.then89.if.end102_crit_edge:                    ; preds = %if.then89
  %.pre = load ptr, ptr %_stream, align 8, !tbaa !37
  br label %if.end102
...
entry:
  ...
  store i32 %call.i, ptr %_numThreads.i, align 8, !tbaa !41
  %call = tail call noundef i32 @_ZN8NWindows7NSystem21GetNumberOfProcessorsEv()
  store i32 %call, ptr %_numThreads.i, align 8, !tbaa !41
...
invoke.cont:                                      ; preds = %_ZN11CStringBaseIwEC2EPKw.exit
  %8 = load i32, ptr %_length.i, align 8, !tbaa !75
...
if.then59:                                        ; preds = %_ZN11CStringBaseIwED2Ev.exit189
  ...
  %86 = load i32, ptr %_length.i, align 8, !tbaa !75, !noalias !91
...
call.i.i32.i.noexc292:                            ; preds = %if.then59
  store ptr %call.i.i32.i293, ptr %ref.tmp61, align 8, !tbaa !71, !alias.scope !94
  store i32 0, ptr %call.i.i32.i293, align 4, !tbaa !68, !noalias !94
  store i32 4, ptr %_capacity.i31.i271, align 4, !tbaa !73, !alias.scope !94
...
if.end.i.i276:                                    ; preds = %call.i.i32.i.noexc292
  ...
  %call.i36.i275 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %89) #20
          to label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i278 unwind label %_ZN11CStringBaseIwED2Ev.exit.i284, !noalias !94

_ZN11CStringBaseIwE11SetCapacityEi.exit.i278:     ; preds = %if.end.i.i276
  call void @_ZdaPv(ptr noundef nonnull %call.i.i32.i293) #21, !noalias !94
  store ptr %call.i36.i275, ptr %ref.tmp61, align 8, !tbaa !71, !alias.scope !94
  store i32 0, ptr %call.i36.i275, align 4, !tbaa !68, !noalias !94
  store i32 %add.i.i272, ptr %_capacity.i31.i271, align 4, !tbaa !73, !alias.scope !94
...
for.body.lr.ph.i281:                              ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i278, %call.i.i32.i.noexc292
  ...
  %91 = load ptr, ptr %name, align 8, !tbaa !71, !noalias !94
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %98, align 4, !tbaa !68, !noalias !94
  %99 = getelementptr inbounds i32, ptr %98, i64 4
  %wide.load355 = load <4 x i32>, ptr %99, align 4, !tbaa !68, !noalias !94
  %100 = getelementptr inbounds i32, ptr %90, i64 %index
  store <4 x i32> %wide.load, ptr %100, align 4, !tbaa !68, !noalias !94
  %101 = getelementptr inbounds i32, ptr %100, i64 4
  store <4 x i32> %wide.load355, ptr %101, align 4, !tbaa !68, !noalias !94
  %index.next = add nuw i64 %index, 8
  %102 = icmp eq i64 %index.next, %n.vec
  br i1 %102, label %middle.block, label %vector.body, !llvm.loop !97
...
for.body.i290.prol:                               ; preds = %for.body.i290.preheader, %for.body.i290.prol
  ...
  %106 = load i32, ptr %arrayidx.i286.prol, align 4, !tbaa !68, !noalias !94
  %arrayidx13.i287.prol = getelementptr inbounds i32, ptr %90, i64 %indvars.iv.i285.prol
  store i32 %106, ptr %arrayidx13.i287.prol, align 4, !tbaa !68, !noalias !94
  ...
  br i1 %prol.iter413.cmp.not, label %for.body.i290.prol.loopexit, label %for.body.i290.prol, !llvm.loop !98
...
for.body.i290:                                    ; preds = %for.body.i290.prol.loopexit, %for.body.i290
  ...
  %110 = load i32, ptr %arrayidx.i286, align 4, !tbaa !68, !noalias !94
  %arrayidx13.i287 = getelementptr inbounds i32, ptr %90, i64 %indvars.iv.i285
  store i32 %110, ptr %arrayidx13.i287, align 4, !tbaa !68, !noalias !94
  ...
  %112 = load i32, ptr %arrayidx.i286.1, align 4, !tbaa !68, !noalias !94
  %arrayidx13.i287.1 = getelementptr inbounds i32, ptr %90, i64 %indvars.iv.next.i288
  store i32 %112, ptr %arrayidx13.i287.1, align 4, !tbaa !68, !noalias !94
  ...
  %114 = load i32, ptr %arrayidx.i286.2, align 4, !tbaa !68, !noalias !94
  %arrayidx13.i287.2 = getelementptr inbounds i32, ptr %90, i64 %indvars.iv.next.i288.1
  store i32 %114, ptr %arrayidx13.i287.2, align 4, !tbaa !68, !noalias !94
  ...
  %116 = load i32, ptr %arrayidx.i286.3, align 4, !tbaa !68, !noalias !94
  %arrayidx13.i287.3 = getelementptr inbounds i32, ptr %90, i64 %indvars.iv.next.i288.2
  store i32 %116, ptr %arrayidx13.i287.3, align 4, !tbaa !68, !noalias !94
  %indvars.iv.next.i288.3 = add nuw nsw i64 %indvars.iv.i285, 4
  %exitcond343.not.3 = icmp eq i64 %indvars.iv.next.i288.3, %92
  br i1 %exitcond343.not.3, label %invoke.cont63, label %for.body.i290, !llvm.loop !99
...
invoke.cont63:                                    ; preds = %for.body.i290.prol.loopexit, %for.body.i290, %middle.block, %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i280
  ...
  store i32 0, ptr %arrayidx16.i283, align 4, !tbaa !68, !noalias !94
  store i32 %sub.i191, ptr %_length17.i291, align 8, !tbaa !75, !alias.scope !94
...
if.then89:                                        ; preds = %_ZN11CStringBaseIwED2Ev.exit209
  ...
  %128 = load i32, ptr %_length.i, align 8, !tbaa !75, !noalias !100
...
call.i.i32.i.noexc322:                            ; preds = %if.then89
  store ptr %call.i.i32.i323, ptr %ref.tmp91, align 8, !tbaa !71, !alias.scope !103
  store i32 0, ptr %call.i.i32.i323, align 4, !tbaa !68, !noalias !103
  store i32 4, ptr %_capacity.i31.i301, align 4, !tbaa !73, !alias.scope !103
...
if.end.i.i306:                                    ; preds = %call.i.i32.i.noexc322
  ...
  %call.i36.i305 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %131) #20
          to label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i308 unwind label %_ZN11CStringBaseIwED2Ev.exit.i314, !noalias !103

_ZN11CStringBaseIwE11SetCapacityEi.exit.i308:     ; preds = %if.end.i.i306
  call void @_ZdaPv(ptr noundef nonnull %call.i.i32.i323) #21, !noalias !103
  store ptr %call.i36.i305, ptr %ref.tmp91, align 8, !tbaa !71, !alias.scope !103
  store i32 0, ptr %call.i36.i305, align 4, !tbaa !68, !noalias !103
  store i32 %add.i.i302, ptr %_capacity.i31.i301, align 4, !tbaa !73, !alias.scope !103
...
for.body.lr.ph.i311:                              ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i308, %call.i.i32.i.noexc322
  ...
  %133 = load ptr, ptr %name, align 8, !tbaa !71, !noalias !103
...
vector.body366:                                   ; preds = %vector.body366, %vector.ph361
  ...
  %wide.load368 = load <4 x i32>, ptr %140, align 4, !tbaa !68, !noalias !103
  %141 = getelementptr inbounds i32, ptr %140, i64 4
  %wide.load369 = load <4 x i32>, ptr %141, align 4, !tbaa !68, !noalias !103
  %142 = getelementptr inbounds i32, ptr %132, i64 %index367
  store <4 x i32> %wide.load368, ptr %142, align 4, !tbaa !68, !noalias !103
  %143 = getelementptr inbounds i32, ptr %142, i64 4
  store <4 x i32> %wide.load369, ptr %143, align 4, !tbaa !68, !noalias !103
  %index.next370 = add nuw i64 %index367, 8
  %144 = icmp eq i64 %index.next370, %n.vec363
  br i1 %144, label %middle.block358, label %vector.body366, !llvm.loop !106
...
for.body.i320.prol:                               ; preds = %for.body.i320.preheader, %for.body.i320.prol
  ...
  %148 = load i32, ptr %arrayidx.i316.prol, align 4, !tbaa !68, !noalias !103
  %arrayidx13.i317.prol = getelementptr inbounds i32, ptr %132, i64 %indvars.iv.i315.prol
  store i32 %148, ptr %arrayidx13.i317.prol, align 4, !tbaa !68, !noalias !103
  ...
  br i1 %prol.iter410.cmp.not, label %for.body.i320.prol.loopexit, label %for.body.i320.prol, !llvm.loop !107
...
for.body.i320:                                    ; preds = %for.body.i320.prol.loopexit, %for.body.i320
  ...
  %152 = load i32, ptr %arrayidx.i316, align 4, !tbaa !68, !noalias !103
  %arrayidx13.i317 = getelementptr inbounds i32, ptr %132, i64 %indvars.iv.i315
  store i32 %152, ptr %arrayidx13.i317, align 4, !tbaa !68, !noalias !103
  ...
  %154 = load i32, ptr %arrayidx.i316.1, align 4, !tbaa !68, !noalias !103
  %arrayidx13.i317.1 = getelementptr inbounds i32, ptr %132, i64 %indvars.iv.next.i318
  store i32 %154, ptr %arrayidx13.i317.1, align 4, !tbaa !68, !noalias !103
  ...
  %156 = load i32, ptr %arrayidx.i316.2, align 4, !tbaa !68, !noalias !103
  %arrayidx13.i317.2 = getelementptr inbounds i32, ptr %132, i64 %indvars.iv.next.i318.1
  store i32 %156, ptr %arrayidx13.i317.2, align 4, !tbaa !68, !noalias !103
  ...
  %158 = load i32, ptr %arrayidx.i316.3, align 4, !tbaa !68, !noalias !103
  %arrayidx13.i317.3 = getelementptr inbounds i32, ptr %132, i64 %indvars.iv.next.i318.2
  store i32 %158, ptr %arrayidx13.i317.3, align 4, !tbaa !68, !noalias !103
  %indvars.iv.next.i318.3 = add nuw nsw i64 %indvars.iv.i315, 4
  %exitcond341.not.3 = icmp eq i64 %indvars.iv.next.i318.3, %134
  br i1 %exitcond341.not.3, label %invoke.cont93, label %for.body.i320, !llvm.loop !108
...
invoke.cont93:                                    ; preds = %for.body.i320.prol.loopexit, %for.body.i320, %middle.block358, %_ZN11CStringBaseIwE11SetCapacityEi.exit.for.cond.cleanup_crit_edge.i310
  ...
  store i32 0, ptr %arrayidx16.i313, align 4, !tbaa !68, !noalias !103
  store i32 %sub.i211, ptr %_length17.i321, align 8, !tbaa !75, !alias.scope !103
...
if.end:                                           ; preds = %for.cond.13.i, %for.cond.12.i, %for.cond.11.i, %for.cond.10.i, %for.cond.9.i, %for.cond.8.i, %for.cond.7.i, %for.cond.6.i, %for.cond.5.i, %for.cond.4.i, %for.cond.3.i, %for.cond.2.i, %for.cond.1.i, %for.cond.i, %entry, %_ZeqRK4GUIDS1_.exit
  %32 = load i8, ptr @IID_IInArchive, align 4, !tbaa !33
...
for.cond.i44:                                     ; preds = %if.end
  ...
  %33 = load i8, ptr %arrayidx.1.i42, align 1, !tbaa !33
  %34 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IInArchive, i64 1), align 1, !tbaa !33
...
for.cond.1.i47:                                   ; preds = %for.cond.i44
  ...
  %35 = load i8, ptr %arrayidx.2.i45, align 2, !tbaa !33
  %36 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IInArchive, i64 2), align 2, !tbaa !33
...
for.cond.2.i50:                                   ; preds = %for.cond.1.i47
  ...
  %37 = load i8, ptr %arrayidx.3.i48, align 1, !tbaa !33
  %38 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IInArchive, i64 3), align 1, !tbaa !33
...
for.cond.3.i53:                                   ; preds = %for.cond.2.i50
  ...
  %39 = load i8, ptr %arrayidx.4.i51, align 4, !tbaa !33
  %40 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IInArchive, i64 0, i32 1), align 4, !tbaa !33
...
for.cond.4.i56:                                   ; preds = %for.cond.3.i53
  ...
  %41 = load i8, ptr %arrayidx.5.i54, align 1, !tbaa !33
  %42 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IInArchive, i64 5), align 1, !tbaa !33
...
for.cond.5.i59:                                   ; preds = %for.cond.4.i56
  ...
  %43 = load i8, ptr %arrayidx.6.i57, align 2, !tbaa !33
  %44 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IInArchive, i64 0, i32 2), align 2, !tbaa !33
...
for.cond.6.i62:                                   ; preds = %for.cond.5.i59
  ...
  %45 = load i8, ptr %arrayidx.7.i60, align 1, !tbaa !33
  %46 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IInArchive, i64 7), align 1, !tbaa !33
...
for.cond.7.i65:                                   ; preds = %for.cond.6.i62
  ...
  %47 = load i8, ptr %arrayidx.8.i63, align 4, !tbaa !33
  %48 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IInArchive, i64 0, i32 3, i64 0), align 4, !tbaa !33
...
for.cond.8.i68:                                   ; preds = %for.cond.7.i65
  ...
  %49 = load i8, ptr %arrayidx.9.i66, align 1, !tbaa !33
  %50 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IInArchive, i64 0, i32 3, i64 1), align 1, !tbaa !33
...
for.cond.9.i71:                                   ; preds = %for.cond.8.i68
  ...
  %51 = load i8, ptr %arrayidx.10.i69, align 2, !tbaa !33
  %52 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IInArchive, i64 0, i32 3, i64 2), align 2, !tbaa !33
...
for.cond.10.i74:                                  ; preds = %for.cond.9.i71
  ...
  %53 = load i8, ptr %arrayidx.11.i72, align 1, !tbaa !33
  %54 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IInArchive, i64 0, i32 3, i64 3), align 1, !tbaa !33
...
for.cond.11.i77:                                  ; preds = %for.cond.10.i74
  ...
  %55 = load i8, ptr %arrayidx.12.i75, align 4, !tbaa !33
  %56 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IInArchive, i64 0, i32 3, i64 4), align 4, !tbaa !33
...
for.cond.12.i80:                                  ; preds = %for.cond.11.i77
  ...
  %57 = load i8, ptr %arrayidx.13.i78, align 1, !tbaa !33
  %58 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IInArchive, i64 0, i32 3, i64 5), align 1, !tbaa !33
...
for.cond.13.i83:                                  ; preds = %for.cond.12.i80
  ...
  %59 = load i8, ptr %arrayidx.14.i81, align 2, !tbaa !33
  %60 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IInArchive, i64 0, i32 3, i64 6), align 2, !tbaa !33
...
_ZeqRK4GUIDS1_.exit89:                            ; preds = %for.cond.13.i83
  ...
  %61 = load i8, ptr %arrayidx.15.i84, align 1, !tbaa !33
  %62 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IInArchive, i64 0, i32 3, i64 7), align 1, !tbaa !33
...
if.end9:                                          ; preds = %for.cond.13.i83, %for.cond.12.i80, %for.cond.11.i77, %for.cond.10.i74, %for.cond.9.i71, %for.cond.8.i68, %for.cond.7.i65, %for.cond.6.i62, %for.cond.5.i59, %for.cond.4.i56, %for.cond.3.i53, %for.cond.2.i50, %for.cond.1.i47, %for.cond.i44, %if.end, %_ZeqRK4GUIDS1_.exit89
  %63 = load i8, ptr @IID_IArchiveOpenSeq, align 4, !tbaa !33
...
for.cond.i93:                                     ; preds = %if.end9
  ...
  %64 = load i8, ptr %arrayidx.1.i91, align 1, !tbaa !33
  %65 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IArchiveOpenSeq, i64 1), align 1, !tbaa !33
...
for.cond.1.i96:                                   ; preds = %for.cond.i93
  ...
  %66 = load i8, ptr %arrayidx.2.i94, align 2, !tbaa !33
  %67 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IArchiveOpenSeq, i64 2), align 2, !tbaa !33
...
for.cond.2.i99:                                   ; preds = %for.cond.1.i96
  ...
  %68 = load i8, ptr %arrayidx.3.i97, align 1, !tbaa !33
  %69 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IArchiveOpenSeq, i64 3), align 1, !tbaa !33
...
for.cond.3.i102:                                  ; preds = %for.cond.2.i99
  ...
  %70 = load i8, ptr %arrayidx.4.i100, align 4, !tbaa !33
  %71 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IArchiveOpenSeq, i64 0, i32 1), align 4, !tbaa !33
...
for.cond.4.i105:                                  ; preds = %for.cond.3.i102
  ...
  %72 = load i8, ptr %arrayidx.5.i103, align 1, !tbaa !33
  %73 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IArchiveOpenSeq, i64 5), align 1, !tbaa !33
...
for.cond.5.i108:                                  ; preds = %for.cond.4.i105
  ...
  %74 = load i8, ptr %arrayidx.6.i106, align 2, !tbaa !33
  %75 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IArchiveOpenSeq, i64 0, i32 2), align 2, !tbaa !33
...
for.cond.6.i111:                                  ; preds = %for.cond.5.i108
  ...
  %76 = load i8, ptr %arrayidx.7.i109, align 1, !tbaa !33
  %77 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IArchiveOpenSeq, i64 7), align 1, !tbaa !33
...
for.cond.7.i114:                                  ; preds = %for.cond.6.i111
  ...
  %78 = load i8, ptr %arrayidx.8.i112, align 4, !tbaa !33
  %79 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IArchiveOpenSeq, i64 0, i32 3, i64 0), align 4, !tbaa !33
...
for.cond.8.i117:                                  ; preds = %for.cond.7.i114
  ...
  %80 = load i8, ptr %arrayidx.9.i115, align 1, !tbaa !33
  %81 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IArchiveOpenSeq, i64 0, i32 3, i64 1), align 1, !tbaa !33
...
for.cond.9.i120:                                  ; preds = %for.cond.8.i117
  ...
  %82 = load i8, ptr %arrayidx.10.i118, align 2, !tbaa !33
  %83 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IArchiveOpenSeq, i64 0, i32 3, i64 2), align 2, !tbaa !33
...
for.cond.10.i123:                                 ; preds = %for.cond.9.i120
  ...
  %84 = load i8, ptr %arrayidx.11.i121, align 1, !tbaa !33
  %85 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IArchiveOpenSeq, i64 0, i32 3, i64 3), align 1, !tbaa !33
...
for.cond.11.i126:                                 ; preds = %for.cond.10.i123
  ...
  %86 = load i8, ptr %arrayidx.12.i124, align 4, !tbaa !33
  %87 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IArchiveOpenSeq, i64 0, i32 3, i64 4), align 4, !tbaa !33
...
for.cond.12.i129:                                 ; preds = %for.cond.11.i126
  ...
  %88 = load i8, ptr %arrayidx.13.i127, align 1, !tbaa !33
  %89 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IArchiveOpenSeq, i64 0, i32 3, i64 5), align 1, !tbaa !33
...
for.cond.13.i132:                                 ; preds = %for.cond.12.i129
  ...
  %90 = load i8, ptr %arrayidx.14.i130, align 2, !tbaa !33
  %91 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IArchiveOpenSeq, i64 0, i32 3, i64 6), align 2, !tbaa !33
...
_ZeqRK4GUIDS1_.exit138:                           ; preds = %for.cond.13.i132
  ...
  %92 = load i8, ptr %arrayidx.15.i133, align 1, !tbaa !33
  %93 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IArchiveOpenSeq, i64 0, i32 3, i64 7), align 1, !tbaa !33
...
if.end16:                                         ; preds = %for.cond.13.i132, %for.cond.12.i129, %for.cond.11.i126, %for.cond.10.i123, %for.cond.9.i120, %for.cond.8.i117, %for.cond.7.i114, %for.cond.6.i111, %for.cond.5.i108, %for.cond.4.i105, %for.cond.3.i102, %for.cond.2.i99, %for.cond.1.i96, %for.cond.i93, %if.end9, %_ZeqRK4GUIDS1_.exit138
  %94 = load i8, ptr @IID_IOutArchive, align 4, !tbaa !33
...
for.cond.i142:                                    ; preds = %if.end16
  ...
  %95 = load i8, ptr %arrayidx.1.i140, align 1, !tbaa !33
  %96 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IOutArchive, i64 1), align 1, !tbaa !33
...
for.cond.1.i145:                                  ; preds = %for.cond.i142
  ...
  %97 = load i8, ptr %arrayidx.2.i143, align 2, !tbaa !33
  %98 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IOutArchive, i64 2), align 2, !tbaa !33
...
for.cond.2.i148:                                  ; preds = %for.cond.1.i145
  ...
  %99 = load i8, ptr %arrayidx.3.i146, align 1, !tbaa !33
  %100 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IOutArchive, i64 3), align 1, !tbaa !33
...
for.cond.3.i151:                                  ; preds = %for.cond.2.i148
  ...
  %101 = load i8, ptr %arrayidx.4.i149, align 4, !tbaa !33
  %102 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IOutArchive, i64 0, i32 1), align 4, !tbaa !33
...
for.cond.4.i154:                                  ; preds = %for.cond.3.i151
  ...
  %103 = load i8, ptr %arrayidx.5.i152, align 1, !tbaa !33
  %104 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IOutArchive, i64 5), align 1, !tbaa !33
...
for.cond.5.i157:                                  ; preds = %for.cond.4.i154
  ...
  %105 = load i8, ptr %arrayidx.6.i155, align 2, !tbaa !33
  %106 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IOutArchive, i64 0, i32 2), align 2, !tbaa !33
...
for.cond.6.i160:                                  ; preds = %for.cond.5.i157
  ...
  %107 = load i8, ptr %arrayidx.7.i158, align 1, !tbaa !33
  %108 = load i8, ptr getelementptr inbounds (i8, ptr @IID_IOutArchive, i64 7), align 1, !tbaa !33
...
for.cond.7.i163:                                  ; preds = %for.cond.6.i160
  ...
  %109 = load i8, ptr %arrayidx.8.i161, align 4, !tbaa !33
  %110 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IOutArchive, i64 0, i32 3, i64 0), align 4, !tbaa !33
...
for.cond.8.i166:                                  ; preds = %for.cond.7.i163
  ...
  %111 = load i8, ptr %arrayidx.9.i164, align 1, !tbaa !33
  %112 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IOutArchive, i64 0, i32 3, i64 1), align 1, !tbaa !33
...
for.cond.9.i169:                                  ; preds = %for.cond.8.i166
  ...
  %113 = load i8, ptr %arrayidx.10.i167, align 2, !tbaa !33
  %114 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IOutArchive, i64 0, i32 3, i64 2), align 2, !tbaa !33
...
for.cond.10.i172:                                 ; preds = %for.cond.9.i169
  ...
  %115 = load i8, ptr %arrayidx.11.i170, align 1, !tbaa !33
  %116 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IOutArchive, i64 0, i32 3, i64 3), align 1, !tbaa !33
...
for.cond.11.i175:                                 ; preds = %for.cond.10.i172
  ...
  %117 = load i8, ptr %arrayidx.12.i173, align 4, !tbaa !33
  %118 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IOutArchive, i64 0, i32 3, i64 4), align 4, !tbaa !33
...
for.cond.12.i178:                                 ; preds = %for.cond.11.i175
  ...
  %119 = load i8, ptr %arrayidx.13.i176, align 1, !tbaa !33
  %120 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IOutArchive, i64 0, i32 3, i64 5), align 1, !tbaa !33
...
for.cond.13.i181:                                 ; preds = %for.cond.12.i178
  ...
  %121 = load i8, ptr %arrayidx.14.i179, align 2, !tbaa !33
  %122 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IOutArchive, i64 0, i32 3, i64 6), align 2, !tbaa !33
...
_ZeqRK4GUIDS1_.exit187:                           ; preds = %for.cond.13.i181
  ...
  %123 = load i8, ptr %arrayidx.15.i182, align 1, !tbaa !33
  %124 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_IOutArchive, i64 0, i32 3, i64 7), align 1, !tbaa !33
...
if.end24:                                         ; preds = %for.cond.13.i181, %for.cond.12.i178, %for.cond.11.i175, %for.cond.10.i172, %for.cond.9.i169, %for.cond.8.i166, %for.cond.7.i163, %for.cond.6.i160, %for.cond.5.i157, %for.cond.4.i154, %for.cond.3.i151, %for.cond.2.i148, %for.cond.1.i145, %for.cond.i142, %if.end16, %_ZeqRK4GUIDS1_.exit187
  %125 = load i8, ptr @IID_ISetProperties, align 4, !tbaa !33
...
for.cond.i191:                                    ; preds = %if.end24
  ...
  %126 = load i8, ptr %arrayidx.1.i189, align 1, !tbaa !33
  %127 = load i8, ptr getelementptr inbounds (i8, ptr @IID_ISetProperties, i64 1), align 1, !tbaa !33
...
for.cond.1.i194:                                  ; preds = %for.cond.i191
  ...
  %128 = load i8, ptr %arrayidx.2.i192, align 2, !tbaa !33
  %129 = load i8, ptr getelementptr inbounds (i8, ptr @IID_ISetProperties, i64 2), align 2, !tbaa !33
...
for.cond.2.i197:                                  ; preds = %for.cond.1.i194
  ...
  %130 = load i8, ptr %arrayidx.3.i195, align 1, !tbaa !33
  %131 = load i8, ptr getelementptr inbounds (i8, ptr @IID_ISetProperties, i64 3), align 1, !tbaa !33
...
for.cond.3.i200:                                  ; preds = %for.cond.2.i197
  ...
  %132 = load i8, ptr %arrayidx.4.i198, align 4, !tbaa !33
  %133 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ISetProperties, i64 0, i32 1), align 4, !tbaa !33
...
for.cond.4.i203:                                  ; preds = %for.cond.3.i200
  ...
  %134 = load i8, ptr %arrayidx.5.i201, align 1, !tbaa !33
  %135 = load i8, ptr getelementptr inbounds (i8, ptr @IID_ISetProperties, i64 5), align 1, !tbaa !33
...
for.cond.5.i206:                                  ; preds = %for.cond.4.i203
  ...
  %136 = load i8, ptr %arrayidx.6.i204, align 2, !tbaa !33
  %137 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ISetProperties, i64 0, i32 2), align 2, !tbaa !33
...
for.cond.6.i209:                                  ; preds = %for.cond.5.i206
  ...
  %138 = load i8, ptr %arrayidx.7.i207, align 1, !tbaa !33
  %139 = load i8, ptr getelementptr inbounds (i8, ptr @IID_ISetProperties, i64 7), align 1, !tbaa !33
...
for.cond.7.i212:                                  ; preds = %for.cond.6.i209
  ...
  %140 = load i8, ptr %arrayidx.8.i210, align 4, !tbaa !33
  %141 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ISetProperties, i64 0, i32 3, i64 0), align 4, !tbaa !33
...
for.cond.8.i215:                                  ; preds = %for.cond.7.i212
  ...
  %142 = load i8, ptr %arrayidx.9.i213, align 1, !tbaa !33
  %143 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ISetProperties, i64 0, i32 3, i64 1), align 1, !tbaa !33
...
for.cond.9.i218:                                  ; preds = %for.cond.8.i215
  ...
  %144 = load i8, ptr %arrayidx.10.i216, align 2, !tbaa !33
  %145 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ISetProperties, i64 0, i32 3, i64 2), align 2, !tbaa !33
...
for.cond.10.i221:                                 ; preds = %for.cond.9.i218
  ...
  %146 = load i8, ptr %arrayidx.11.i219, align 1, !tbaa !33
  %147 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ISetProperties, i64 0, i32 3, i64 3), align 1, !tbaa !33
...
for.cond.11.i224:                                 ; preds = %for.cond.10.i221
  ...
  %148 = load i8, ptr %arrayidx.12.i222, align 4, !tbaa !33
  %149 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ISetProperties, i64 0, i32 3, i64 4), align 4, !tbaa !33
...
for.cond.12.i227:                                 ; preds = %for.cond.11.i224
  ...
  %150 = load i8, ptr %arrayidx.13.i225, align 1, !tbaa !33
  %151 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ISetProperties, i64 0, i32 3, i64 5), align 1, !tbaa !33
...
for.cond.13.i230:                                 ; preds = %for.cond.12.i227
  ...
  %152 = load i8, ptr %arrayidx.14.i228, align 2, !tbaa !33
  %153 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ISetProperties, i64 0, i32 3, i64 6), align 2, !tbaa !33
...
_ZeqRK4GUIDS1_.exit236:                           ; preds = %for.cond.13.i230
  ...
  %154 = load i8, ptr %arrayidx.15.i231, align 1, !tbaa !33
  %155 = load i8, ptr getelementptr inbounds (%struct.GUID, ptr @IID_ISetProperties, i64 0, i32 3, i64 7), align 1, !tbaa !33
...
return.sink.split:                                ; preds = %_ZeqRK4GUIDS1_.exit89, %_ZeqRK4GUIDS1_.exit, %if.then12, %if.then19, %if.then27
  ...
  %vtable29 = load ptr, ptr %this, align 8, !tbaa !31
...
entry:
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !31
  %add.ptr = getelementptr inbounds i8, ptr %this, i64 8
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 1, i64 2), ptr %add.ptr, align 8, !tbaa !31
  %add.ptr2 = getelementptr inbounds i8, ptr %this, i64 16
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 2, i64 2), ptr %add.ptr2, align 8, !tbaa !31
  %add.ptr3 = getelementptr inbounds i8, ptr %this, i64 24
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 3, i64 2), ptr %add.ptr3, align 8, !tbaa !31
  %_seqStream = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 7
  %0 = load ptr, ptr %_seqStream, align 8, !tbaa !38
  %tobool.not.i = icmp eq ptr %0, null
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit:    ; preds = %entry, %if.then.i
  %_stream = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 6
  %4 = load ptr, ptr %_stream, align 8, !tbaa !37
...
if.then.i8:                                       ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit
  %vtable.i5 = load ptr, ptr %4, align 8, !tbaa !31
...
entry:
  ...
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 1, i64 2), ptr %add.ptr.i, align 8, !tbaa !31
  %add.ptr2.i = getelementptr inbounds i8, ptr %this, i64 16
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 2, i64 2), ptr %add.ptr2.i, align 8, !tbaa !31
  %add.ptr3.i = getelementptr inbounds i8, ptr %this, i64 24
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 3, i64 2), ptr %add.ptr3.i, align 8, !tbaa !31
  %_seqStream.i = getelementptr inbounds %"class.NArchive::NBz2::CHandler", ptr %this, i64 0, i32 7
  %0 = load ptr, ptr %_seqStream.i, align 8, !tbaa !38
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i:  ; preds = %if.then.i.i, %entry
  ...
  %4 = load ptr, ptr %_stream.i, align 8, !tbaa !37
...
if.then.i8.i:                                     ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i
  %vtable.i5.i = load ptr, ptr %4, align 8, !tbaa !31
...
entry:
  ...
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 1, i64 2), ptr %this, align 8, !tbaa !31
  %add.ptr2.i = getelementptr inbounds i8, ptr %this, i64 8
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 2, i64 2), ptr %add.ptr2.i, align 8, !tbaa !31
  %add.ptr3.i = getelementptr inbounds i8, ptr %this, i64 16
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 3, i64 2), ptr %add.ptr3.i, align 8, !tbaa !31
  %_seqStream.i = getelementptr inbounds i8, ptr %this, i64 40
  %1 = load ptr, ptr %_seqStream.i, align 8, !tbaa !38
  %tobool.not.i.i = icmp eq ptr %1, null
  br i1 %tobool.not.i.i, label %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i, label %if.then.i.i

if.then.i.i:                                      ; preds = %entry
  %vtable.i.i = load ptr, ptr %1, align 8, !tbaa !31
  %vfn.i.i = getelementptr inbounds ptr, ptr %vtable.i.i, i64 2
  %2 = load ptr, ptr %vfn.i.i, align 8
...
if.then.i8.i:                                     ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i
  %vtable.i5.i = load ptr, ptr %5, align 8, !tbaa !31
  %vfn.i6.i = getelementptr inbounds ptr, ptr %vtable.i5.i, i64 2
...
entry:
  ...
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 2, i64 2), ptr %add.ptr2.i.i, align 8, !tbaa !31
  %add.ptr3.i.i = getelementptr inbounds i8, ptr %this, i64 16
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 3, i64 2), ptr %add.ptr3.i.i, align 8, !tbaa !31
  %_seqStream.i.i = getelementptr inbounds i8, ptr %this, i64 40
  %1 = load ptr, ptr %_seqStream.i.i, align 8, !tbaa !38
  %tobool.not.i.i.i = icmp eq ptr %1, null
  br i1 %tobool.not.i.i.i, label %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i.i, label %if.then.i.i.i

if.then.i.i.i:                                    ; preds = %entry
  %vtable.i.i.i = load ptr, ptr %1, align 8, !tbaa !31
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i.i: ; preds = %if.then.i.i.i, %entry
  ...
  %5 = load ptr, ptr %_stream.i.i, align 8, !tbaa !37
...
if.then.i8.i.i:                                   ; preds = %_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i.i
  %vtable.i5.i.i = load ptr, ptr %5, align 8, !tbaa !31
...
entry:
  ...
  %add.ptr.i = getelementptr inbounds i8, ptr %this, i64 -8
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 1, i64 2), ptr %add.ptr.i, align 8, !tbaa !31
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 2, i64 2), ptr %this, align 8, !tbaa !31
...
entry:
  ...
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 1, i64 2), ptr %add.ptr.i.i, align 8, !tbaa !31
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 2, i64 2), ptr %this, align 8, !tbaa !31
...
entry:
  ...
  %add.ptr2.i = getelementptr inbounds i8, ptr %this, i64 -8
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 2, i64 2), ptr %add.ptr2.i, align 8, !tbaa !31
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 3, i64 2), ptr %this, align 8, !tbaa !31
...
; Function Attrs: uwtable
define internal noundef ptr @_ZN8NArchive4NBz2L9CreateArcEv() #4 personality ptr @__gxx_personality_v0 {
entry:
  ...
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 0, i64 2), ptr %call, align 8, !tbaa !31
  ...
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 2, i64 2), ptr %1, align 8, !tbaa !31
  store ptr getelementptr inbounds ({ [21 x ptr], [8 x ptr], [9 x ptr], [8 x ptr] }, ptr @_ZTVN8NArchive4NBz28CHandlerE, i64 0, inrange i32 3, i64 2), ptr %2, align 8, !tbaa !31
...
invoke.cont:                                      ; preds = %entry
  ...
  store i32 %call.i13.i, ptr %_numThreads.i.i, align 8, !tbaa !41
  ret ptr %call
...
; Function Attrs: uwtable
define internal noundef ptr @_ZN8NArchive4NBz2L12CreateArcOutEv() #4 personality ptr @__gxx_personality_v0 {
entry:
  %call = tail call noalias noundef nonnull dereferenceable(96) ptr @_Znwm(i64 noundef 96) #20
  %0 = getelementptr inbounds i8, ptr %call, i64 8
  %1 = getelementptr inbounds i8, ptr %call, i64 16
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %24, label %middle.block, label %vector.body, !llvm.loop !109
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  br i1 %cmp9, label %for.body, label %for.cond.cleanup, !llvm.loop !110
...
!91 = !{!92}
!92 = distinct !{!92, !93, !"_ZNK11CStringBaseIwE3MidEi: %agg.result"}
!93 = distinct !{!93, !"_ZNK11CStringBaseIwE3MidEi"}
!94 = !{!95}
!95 = distinct !{!95, !96, !"_ZNK11CStringBaseIwE3MidEii: %agg.result"}
!96 = distinct !{!96, !"_ZNK11CStringBaseIwE3MidEii"}
!97 = distinct !{!97, !67, !80, !81}
!98 = distinct !{!98, !83}
!99 = distinct !{!99, !67, !80}
!100 = !{!101}
!101 = distinct !{!101, !102, !"_ZNK11CStringBaseIwE3MidEi: %agg.result"}
!102 = distinct !{!102, !"_ZNK11CStringBaseIwE3MidEi"}
!103 = !{!104}
!104 = distinct !{!104, !105, !"_ZNK11CStringBaseIwE3MidEii: %agg.result"}
