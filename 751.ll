; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/setc.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/setc.c"
...
cleanup.cont:                                     ; preds = %for.cond, %for.cond.preheader, %entry
  ...
  %cmp24.not90.not = icmp slt i32 %6, %7
  br i1 %cmp24.not90.not, label %for.body25.lr.ph, label %cleanup52
...
for.body25:                                       ; preds = %for.body25.lr.ph, %for.inc49
  ...
  %cmp24.not92 = phi i1 [ false, %for.body25.lr.ph ], [ %cmp24.not, %for.inc49 ]
...
for.inc49:                                        ; preds = %for.body34
  ...
  %cmp24.not = icmp sge i64 %indvars.iv.next102, %12
  %lftr.wideiv103 = trunc i64 %indvars.iv.next102 to i32
  %exitcond104 = icmp eq i32 %7, %lftr.wideiv103
  br i1 %exitcond104, label %cleanup52, label %for.body25

cleanup52:                                        ; preds = %for.inc49, %for.body25, %for.cond32, %cleanup.cont
  %cmp24.not84 = phi i1 [ true, %cleanup.cont ], [ %cmp24.not92, %for.cond32 ], [ %cmp24.not92, %for.body25 ], [ %cmp24.not, %for.inc49 ]
  %spec.select = zext i1 %cmp24.not84 to i32
  br label %return
...
if.end24:                                         ; preds = %if.then4, %if.then
  ...
  %cmp25143 = icmp sgt i32 %0, 1
  br i1 %cmp25143, label %for.body.preheader, label %cleanup.cont
...
for.body:                                         ; preds = %for.body.preheader, %for.inc
  ...
  %dist.1145 = phi i32 [ %dist.0, %for.body.preheader ], [ %dist.3, %for.inc ]
...
for.inc:                                          ; preds = %for.body, %lor.lhs.false
  %dist.3 = phi i32 [ %add56, %lor.lhs.false ], [ %dist.1145, %for.body ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %cleanup.cont, label %for.body
...
cleanup.cont:                                     ; preds = %for.inc, %if.end24, %entry
  ...
  %cmp67.not148 = icmp slt i32 %14, %15
  br i1 %cmp67.not148, label %for.body68.lr.ph, label %cleanup105
...
for.body68:                                       ; preds = %for.body68.lr.ph, %for.inc96
  %indvars.iv159 = phi i64 [ %19, %for.body68.lr.ph ], [ %indvars.iv.next160, %for.inc96 ]
  %dist.6150 = phi i32 [ %dist.5, %for.body68.lr.ph ], [ %dist.7, %for.inc96 ]
  %arrayidx70 = getelementptr inbounds ptr, ptr %16, i64 %indvars.iv159
  %20 = load ptr, ptr %arrayidx70, align 8, !tbaa !19
  %arrayidx72 = getelementptr inbounds i32, ptr %17, i64 %indvars.iv159
  %21 = load i32, ptr %arrayidx72, align 4, !tbaa !5
  %arrayidx74 = getelementptr inbounds i32, ptr %18, i64 %indvars.iv159
  %22 = load i32, ptr %arrayidx74, align 4, !tbaa !5
  %cmp76.not146 = icmp sgt i32 %22, %21
  br i1 %cmp76.not146, label %for.end91, label %for.body77.preheader
...
for.cond75:                                       ; preds = %for.body77
  ...
  %exitcond158.not = icmp eq i32 %24, %lftr.wideiv
  br i1 %exitcond158.not, label %for.end91, label %for.body77

for.body77:                                       ; preds = %for.body77.preheader, %for.cond75
  %indvars.iv155 = phi i64 [ %23, %for.body77.preheader ], [ %indvars.iv.next156, %for.cond75 ]
  %arrayidx79 = getelementptr inbounds i32, ptr %a, i64 %indvars.iv155
  %25 = load i32, ptr %arrayidx79, align 4, !tbaa !5
  %arrayidx81 = getelementptr inbounds i32, ptr %b, i64 %indvars.iv155
  %26 = load i32, ptr %arrayidx81, align 4, !tbaa !5
  %and82 = and i32 %26, %25
  %arrayidx84 = getelementptr inbounds i32, ptr %20, i64 %indvars.iv155
  %27 = load i32, ptr %arrayidx84, align 4, !tbaa !5
  %and85 = and i32 %and82, %27
  %tobool86.not = icmp eq i32 %and85, 0
  br i1 %tobool86.not, label %for.cond75, label %for.inc96

for.end91:                                        ; preds = %for.cond75, %for.body68
  %inc92 = add nsw i32 %dist.6150, 1
  %cmp93 = icmp sgt i32 %dist.6150, 0
  br i1 %cmp93, label %cleanup105, label %for.inc96

for.inc96:                                        ; preds = %for.body77, %for.end91
  %dist.7 = phi i32 [ %inc92, %for.end91 ], [ %dist.6150, %for.body77 ]
  %indvars.iv.next160 = add nsw i64 %indvars.iv159, 1
  %lftr.wideiv162 = trunc i64 %indvars.iv.next160 to i32
  %exitcond163.not = icmp eq i32 %15, %lftr.wideiv162
  br i1 %exitcond163.not, label %cleanup105, label %for.body68

cleanup105:                                       ; preds = %if.then36, %lor.lhs.false, %for.inc96, %for.end91, %cleanup.cont, %if.then4
  %retval.2 = phi i32 [ 2, %if.then4 ], [ %dist.5, %cleanup.cont ], [ %dist.7, %for.inc96 ], [ 2, %for.end91 ], [ 2, %lor.lhs.false ], [ 2, %if.then36 ]
  ret i32 %retval.2
}
...
for.body38.lr.ph:                                 ; preds = %if.end33
  ...
  %uglygep149 = getelementptr i8, ptr %xlower, i64 4
  %uglygep152 = getelementptr i8, ptr %a, i64 4
  br label %for.body38
...
vector.memcheck:                                  ; preds = %for.body66.preheader
  %25 = shl nsw i64 %18, 2
  %uglygep = getelementptr i8, ptr %xlower, i64 %25
  %26 = sub i32 %16, %17
  %27 = zext i32 %26 to i64
  %28 = add nsw i64 %18, %27
  %29 = shl nsw i64 %28, 2
  %uglygep150 = getelementptr i8, ptr %uglygep149, i64 %29
  %uglygep151 = getelementptr i8, ptr %a, i64 %25
  %uglygep153 = getelementptr i8, ptr %uglygep152, i64 %29
  %uglygep154 = getelementptr i8, ptr %15, i64 %25
  %uglygep155 = getelementptr i8, ptr %15, i64 4
  %uglygep156 = getelementptr i8, ptr %uglygep155, i64 %29
  %bound0 = icmp ult ptr %uglygep, %uglygep153
  %bound1 = icmp ult ptr %uglygep151, %uglygep150
  %found.conflict = and i1 %bound0, %bound1
  %bound0157 = icmp ult ptr %uglygep, %uglygep156
  %bound1158 = icmp ult ptr %uglygep154, %uglygep150
...
; Function Attrs: nofree norecurse nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none) uwtable
define dso_local void @consensus(ptr nocapture noundef %r, ptr nocapture noundef readonly %a, ptr nocapture noundef readonly %b) local_unnamed_addr #1 {
entry:
  %0 = load i32, ptr @cube, align 8, !tbaa !32
  ...
  %1 = shl nuw nsw i32 %cond, 2
  %2 = zext i32 %1 to i64
  %3 = add nsw i32 %cond, -1
  %4 = zext i32 %3 to i64
  %5 = shl nuw nsw i64 %4, 2
  %6 = sub nsw i64 %2, %5
  %uglygep = getelementptr i8, ptr %r, i64 %6
  %7 = add nuw nsw i64 %5, 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %uglygep, i8 0, i64 %7, i1 false), !tbaa !5
...
vector.memcheck:                                  ; preds = %for.body.preheader
  %uglygep189 = getelementptr i8, ptr %r, i64 4
  %15 = shl nuw nsw i64 %wide.trip.count, 2
  %uglygep190 = getelementptr i8, ptr %r, i64 %15
  %uglygep191 = getelementptr i8, ptr %a, i64 4
  %uglygep192 = getelementptr i8, ptr %a, i64 %15
  %uglygep193 = getelementptr i8, ptr %b, i64 4
  %uglygep194 = getelementptr i8, ptr %b, i64 %15
  %bound0 = icmp ult ptr %uglygep189, %uglygep192
  %bound1 = icmp ult ptr %uglygep191, %uglygep190
  %found.conflict = and i1 %bound0, %bound1
  %bound0195 = icmp ult ptr %uglygep189, %uglygep194
  %bound1196 = icmp ult ptr %uglygep193, %uglygep190
...
vector.body:                                      ; preds = %pred.store.continue206, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %16, align 4, !tbaa !5, !alias.scope !33
  %17 = getelementptr i32, ptr %b, i64 %offset.idx
  %wide.load198 = load <4 x i32>, ptr %17, align 4, !tbaa !5, !alias.scope !36
  %18 = and <4 x i32> %wide.load198, %wide.load
  %19 = getelementptr inbounds i32, ptr %r, i64 %offset.idx
  store <4 x i32> %18, ptr %19, align 4, !tbaa !5, !alias.scope !38, !noalias !40
  ...
  %wide.load199 = load <4 x i32>, ptr %16, align 4, !tbaa !5, !alias.scope !33
  %wide.load200 = load <4 x i32>, ptr %17, align 4, !tbaa !5, !alias.scope !36
...
pred.store.if:                                    ; preds = %vector.body
  ...
  store i32 %31, ptr %30, align 4, !tbaa !5, !alias.scope !38, !noalias !40
...
pred.store.if201:                                 ; preds = %pred.store.continue
  ...
  store i32 %35, ptr %34, align 4, !tbaa !5, !alias.scope !38, !noalias !40
...
pred.store.if203:                                 ; preds = %pred.store.continue202
  ...
  store i32 %39, ptr %38, align 4, !tbaa !5, !alias.scope !38, !noalias !40
...
pred.store.if205:                                 ; preds = %pred.store.continue204
  ...
  store i32 %43, ptr %42, align 4, !tbaa !5, !alias.scope !38, !noalias !40
...
pred.store.continue206:                           ; preds = %pred.store.if205, %pred.store.continue204
  ...
  br i1 %44, label %middle.block, label %vector.body, !llvm.loop !41
...
for.inc:                                          ; preds = %for.body, %if.then35
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %if.end48, label %for.body, !llvm.loop !42
...
for.body54.lr.ph:                                 ; preds = %if.end48
  ...
  %uglygep209 = getelementptr i8, ptr %r, i64 4
  %uglygep215 = getelementptr i8, ptr %a, i64 4
  %uglygep218 = getelementptr i8, ptr %b, i64 4
  br label %for.body54
...
vector.memcheck207:                               ; preds = %for.body87.preheader
  %80 = shl nsw i64 %75, 2
  %uglygep208 = getelementptr i8, ptr %r, i64 %80
  %81 = sub i32 %56, %74
  %82 = zext i32 %81 to i64
  %83 = add nsw i64 %75, %82
  %84 = shl nsw i64 %83, 2
  %uglygep210 = getelementptr i8, ptr %uglygep209, i64 %84
  %uglygep211 = getelementptr i8, ptr %55, i64 %80
  %uglygep212 = getelementptr i8, ptr %55, i64 4
  %uglygep213 = getelementptr i8, ptr %uglygep212, i64 %84
  %uglygep214 = getelementptr i8, ptr %a, i64 %80
  %uglygep216 = getelementptr i8, ptr %uglygep215, i64 %84
  %uglygep217 = getelementptr i8, ptr %b, i64 %80
  %uglygep219 = getelementptr i8, ptr %uglygep218, i64 %84
  %bound0220 = icmp ult ptr %uglygep208, %uglygep213
  %bound1221 = icmp ult ptr %uglygep211, %uglygep210
  %found.conflict222 = and i1 %bound0220, %bound1221
  %bound0223 = icmp ult ptr %uglygep208, %uglygep216
  %bound1224 = icmp ult ptr %uglygep214, %uglygep210
  %found.conflict225 = and i1 %bound0223, %bound1224
  %conflict.rdx226 = or i1 %found.conflict222, %found.conflict225
  %bound0227 = icmp ult ptr %uglygep208, %uglygep219
  %bound1228 = icmp ult ptr %uglygep217, %uglygep210
...
vector.body240:                                   ; preds = %vector.body240, %vector.ph234
  ...
  %wide.load243 = load <4 x i32>, ptr %85, align 4, !tbaa !5, !alias.scope !43
  %86 = getelementptr inbounds i32, ptr %85, i64 4
  %wide.load244 = load <4 x i32>, ptr %86, align 4, !tbaa !5, !alias.scope !43
  %87 = getelementptr inbounds i32, ptr %a, i64 %offset.idx242
  %wide.load245 = load <4 x i32>, ptr %87, align 4, !tbaa !5, !alias.scope !46
  %88 = getelementptr inbounds i32, ptr %87, i64 4
  %wide.load246 = load <4 x i32>, ptr %88, align 4, !tbaa !5, !alias.scope !46
  %89 = getelementptr inbounds i32, ptr %b, i64 %offset.idx242
  %wide.load247 = load <4 x i32>, ptr %89, align 4, !tbaa !5, !alias.scope !48
  %90 = getelementptr inbounds i32, ptr %89, i64 4
  %wide.load248 = load <4 x i32>, ptr %90, align 4, !tbaa !5, !alias.scope !48
  ...
  %wide.load249 = load <4 x i32>, ptr %95, align 4, !tbaa !5, !alias.scope !50, !noalias !52
  %96 = getelementptr inbounds i32, ptr %95, i64 4
  %wide.load250 = load <4 x i32>, ptr %96, align 4, !tbaa !5, !alias.scope !50, !noalias !52
  %97 = or <4 x i32> %93, %wide.load249
  %98 = or <4 x i32> %94, %wide.load250
  store <4 x i32> %97, ptr %95, align 4, !tbaa !5, !alias.scope !50, !noalias !52
  store <4 x i32> %98, ptr %96, align 4, !tbaa !5, !alias.scope !50, !noalias !52
  %index.next251 = add nuw i64 %index241, 8
  %99 = icmp eq i64 %index.next251, %n.vec236
  br i1 %99, label %middle.block231, label %vector.body240, !llvm.loop !53
...
for.body87:                                       ; preds = %for.body87.prol.loopexit, %for.body87
  ...
  br i1 %exitcond183.not.1, label %for.inc103, label %for.body87, !llvm.loop !54
...
define dso_local i32 @cactive(ptr nocapture noundef readonly %a) local_unnamed_addr #2 {
entry:
  %0 = load i32, ptr getelementptr inbounds (%struct.cube_struct, ptr @cube, i64 0, i32 15), align 4, !tbaa !12
  %cmp.not = icmp eq i32 %0, -1
  br i1 %cmp.not, label %cleanup.cont, label %if.then
...
if.end:                                           ; preds = %if.then2
  %sub = shl i32 %0, 4
  %mul = add i32 %sub, -16
  %call = tail call i32 (i32, ...) @bit_index(i32 noundef %and1) #6
  %div = sdiv i32 %call, 2
...
if.end23:                                         ; preds = %if.end, %if.then
  ...
  %cmp24144 = icmp sgt i32 %0, 1
  br i1 %cmp24144, label %for.body.preheader, label %cleanup.cont
...
for.body:                                         ; preds = %for.body.preheader, %for.inc
  %indvars.iv = phi i64 [ 1, %for.body.preheader ], [ %indvars.iv.next, %for.inc ]
  %active.1147 = phi i32 [ %active.0, %for.body.preheader ], [ %active.2, %for.inc ]
  %dist.1146 = phi i32 [ %dist.0, %for.body.preheader ], [ %dist.2, %for.inc ]
...
if.end54:                                         ; preds = %if.then32
  ...
  %call57 = tail call i32 (i32, ...) @bit_index(i32 noundef %and30) #6
  %div58 = sdiv i32 %call57, 2
  %add59 = add nsw i32 %mul56, %div58
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.end54
  %dist.2 = phi i32 [ %add51, %if.end54 ], [ %dist.1146, %for.body ]
  %active.2 = phi i32 [ %add59, %if.end54 ], [ %active.1147, %for.body ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %cleanup.cont, label %for.body
...
cleanup.cont:                                     ; preds = %for.inc, %if.end23, %entry
  ...
  %cmp67.not151 = icmp slt i32 %13, %14
  br i1 %cmp67.not151, label %for.body68.lr.ph, label %cleanup103
...
for.body68:                                       ; preds = %for.body68.lr.ph, %for.inc94
  %indvars.iv164 = phi i64 [ %18, %for.body68.lr.ph ], [ %indvars.iv.next165, %for.inc94 ]
  %active.5155 = phi i32 [ %active.4.ph, %for.body68.lr.ph ], [ %active.6, %for.inc94 ]
  %dist.5152 = phi i32 [ %dist.4.ph, %for.body68.lr.ph ], [ %dist.6, %for.inc94 ]
  %arrayidx70 = getelementptr inbounds ptr, ptr %15, i64 %indvars.iv164
  %19 = load ptr, ptr %arrayidx70, align 8, !tbaa !19
  %arrayidx72 = getelementptr inbounds i32, ptr %16, i64 %indvars.iv164
  %20 = load i32, ptr %arrayidx72, align 4, !tbaa !5
  %arrayidx74 = getelementptr inbounds i32, ptr %17, i64 %indvars.iv164
  %21 = load i32, ptr %arrayidx74, align 4, !tbaa !5
  %cmp76.not149 = icmp sgt i32 %21, %20
  br i1 %cmp76.not149, label %for.inc94, label %for.body77.preheader
...
for.cond75:                                       ; preds = %for.body77
  ...
  %exitcond163.not = icmp eq i32 %23, %lftr.wideiv
  br i1 %exitcond163.not, label %for.inc94, label %for.body77

for.body77:                                       ; preds = %for.body77.preheader, %for.cond75
  %indvars.iv160 = phi i64 [ %22, %for.body77.preheader ], [ %indvars.iv.next161, %for.cond75 ]
  %arrayidx79 = getelementptr inbounds i32, ptr %19, i64 %indvars.iv160
  %24 = load i32, ptr %arrayidx79, align 4, !tbaa !5
  %arrayidx81 = getelementptr inbounds i32, ptr %a, i64 %indvars.iv160
  %25 = load i32, ptr %arrayidx81, align 4, !tbaa !5
  %not82 = xor i32 %25, -1
  %and83 = and i32 %24, %not82
  %tobool84.not = icmp eq i32 %and83, 0
  br i1 %tobool84.not, label %for.cond75, label %if.then85

if.then85:                                        ; preds = %for.body77
  %cmp87 = icmp sgt i32 %dist.5152, 0
  br i1 %cmp87, label %cleanup103, label %if.end89

if.end89:                                         ; preds = %if.then85
  %inc86 = add nsw i32 %dist.5152, 1
  %26 = trunc i64 %indvars.iv164 to i32
  br label %for.inc94

for.inc94:                                        ; preds = %for.cond75, %for.body68, %if.end89
  %dist.6 = phi i32 [ %inc86, %if.end89 ], [ %dist.5152, %for.body68 ], [ %dist.5152, %for.cond75 ]
  %active.6 = phi i32 [ %26, %if.end89 ], [ %active.5155, %for.body68 ], [ %active.5155, %for.cond75 ]
  ...
  br i1 %exitcond168.not, label %cleanup103, label %for.body68

cleanup103:                                       ; preds = %if.then32, %for.inc94, %if.then85, %cleanup.cont, %if.then2
  %retval.2 = phi i32 [ -1, %if.then2 ], [ %active.4.ph, %cleanup.cont ], [ %active.6, %for.inc94 ], [ -1, %if.then85 ], [ -1, %if.then32 ]
  ret i32 %retval.2
}
...
cleanup.cont:                                     ; preds = %for.cond, %for.cond.preheader, %entry
  %8 = load i32, ptr getelementptr inbounds (%struct.cube_struct, ptr @cube, i64 0, i32 2), align 8, !tbaa !14
  %9 = load i32, ptr getelementptr inbounds (%struct.cube_struct, ptr @cube, i64 0, i32 1), align 4, !tbaa !15
  %cmp43.not155 = icmp slt i32 %8, %9
  br i1 %cmp43.not155, label %for.body44.lr.ph, label %cleanup94
...
for.body44:                                       ; preds = %for.body44.lr.ph, %for.inc91
  ...
  %cmp43.not157 = phi i1 [ true, %for.body44.lr.ph ], [ %cmp43.not, %for.inc91 ]
...
for.inc91:                                        ; preds = %for.cond51, %for.cond68, %for.body44
  ...
  %cmp43.not = icmp slt i64 %indvars.iv.next172, %14
...
cleanup94:                                        ; preds = %for.inc91, %for.body70, %cleanup.cont
  %cmp43.not148 = phi i1 [ false, %cleanup.cont ], [ %cmp43.not157, %for.body70 ], [ %cmp43.not, %for.inc91 ]
  %spec.select = zext i1 %cmp43.not148 to i32
  br label %return
...
entry:
  %0 = load ptr, ptr %a, align 8, !tbaa !19
  %1 = load ptr, ptr %b, align 8, !tbaa !19
  %2 = load ptr, ptr getelementptr inbounds (%struct.cube_struct, ptr @cube, i64 0, i32 11), align 8, !tbaa !55
...
define dso_local i32 @desc1(ptr noundef readonly %a, ptr noundef readonly %b) local_unnamed_addr #4 {
entry:
