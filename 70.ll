...
if.then9.split.loop.exit150:                      ; preds = %for.inc.2
  %rem20.2.fr.le = freeze i32 %rem20.2
  %idxprom.3.le = zext i32 %rem20.2.fr.le to i64
  br label %if.then9
...
if.then9.split.loop.exit156:                      ; preds = %for.inc
  %rem20.fr.le = freeze i32 %rem20
  %idxprom.1.le = zext i32 %rem20.fr.le to i64
  br label %if.then9
...
for.inc:                                          ; preds = %if.else
  ...
  %rem20.fr = freeze i32 %rem20
  %idxprom.1 = zext i32 %rem20.fr to i64
...
if.then.i:                                        ; preds = %for.body.i
  %call.i = tail call i32 @set_add(ptr noundef nonnull %av, ptr noundef nonnull %12)
  br label %for.inc.i
...
for.body:                                         ; preds = %for.body.preheader, %for.inc
  ...
  %i.0108.fr = freeze i32 %i.0108
  %2 = load ptr, ptr %v4, align 8, !tbaa !21
  %idxprom = zext i32 %i.0108.fr to i64
  %arrayidx = getelementptr inbounds ptr, ptr %2, i64 %idxprom
  %3 = load ptr, ptr %arrayidx, align 8, !tbaa !11
...
if.then6:                                         ; preds = %for.body
  %i.0108.fr.le163 = freeze i32 %i.0108
  %idxprom.le = zext i32 %i.0108.fr.le163 to i64
...
if.then15:                                        ; preds = %if.else
  %i.0108.fr.le = freeze i32 %i.0108
  %idxprom.le144 = zext i32 %i.0108.fr.le to i64
  %5 = load ptr, ptr %v4, align 8, !tbaa !21
  %arrayidx18 = getelementptr inbounds ptr, ptr %5, i64 %idxprom.le144
  %6 = load ptr, ptr %arrayidx18, align 8, !tbaa !11
  br label %cleanup52

for.inc:                                          ; preds = %if.else
  %add = add i32 %i.0108.fr, 1
