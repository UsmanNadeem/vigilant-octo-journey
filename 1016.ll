; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/CoMD/linkCells.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/CoMD/linkCells.c"
...
entry:
  ...
  %12 = insertelement <2 x double> poison, double %conv19.2, i64 0
  %13 = shufflevector <2 x double> %12, <2 x double> %7, <2 x i32> <i32 0, i32 2>
  ...
  %call.i112 = tail call noalias ptr @malloc(i64 noundef %mul57) #16
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %localMax) #17
...
vector.memcheck:                                  ; preds = %for.body.lr.ph
  %uglygep = getelementptr inbounds i8, ptr %localMax, i64 4
  %2 = shl nuw nsw i64 %wide.trip.count, 2
  %uglygep19 = getelementptr i8, ptr %1, i64 %2
  %bound0 = icmp ult ptr %localMax, %uglygep19
...
middle.block:                                     ; preds = %vector.body
  %rdx.minmax.select = call <4 x i32> @llvm.smax.v4i32(<4 x i32> %5, <4 x i32> %6)
  %8 = call i32 @llvm.vector.reduce.smax.v4i32(<4 x i32> %rdx.minmax.select)
...
for.cond.cleanup:                                 ; preds = %for.body.prol.loopexit, %for.body, %middle.block, %entry
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %globalMax) #17
  tail call void @profileStart(i32 noundef 10) #17
  call void @maxIntParallel(ptr noundef nonnull %localMax, ptr noundef nonnull %globalMax, i32 noundef 1) #17
  call void @profileStop(i32 noundef 10) #17
  %13 = load i32, ptr %globalMax, align 4, !tbaa !9
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %globalMax) #17
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %localMax) #17
  ret i32 %13
