; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/obsequi/move_sort.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/obsequi/move_sort.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct.Move = type { i32, i32, i32 }

@.str = private unnamed_addr constant [97 x i8] c"/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/obsequi/move_sort.c\00", align 1
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 393216, ptr nonnull %bucket) #6
  call void @llvm.lifetime.start.p0(i64 512, ptr nonnull %buck_val) #6
  call void @llvm.lifetime.start.p0(i64 512, ptr nonnull %buck_size) #6
  %cmp105 = icmp slt i32 %start, %num_moves
  br i1 %cmp105, label %for.cond1.preheader.preheader, label %while.cond.preheader.thread
...
for.cond1.preheader:                              ; preds = %for.cond1.preheader.preheader, %for.inc35
  ...
  %num_buckets.0106 = phi i32 [ 0, %for.cond1.preheader.preheader ], [ %num_buckets.1, %for.inc35 ]
  %cmp2103 = icmp sgt i32 %num_buckets.0106, 0
  br i1 %cmp2103, label %for.body3.lr.ph, label %for.end

for.body3.lr.ph:                                  ; preds = %for.cond1.preheader
  %info = getelementptr inbounds %struct.Move, ptr %movelist, i64 %indvars.iv120, i32 2
  %1 = load i32, ptr %info, align 4, !tbaa !5
  %wide.trip.count = zext i32 %num_buckets.0106 to i64
  br label %for.body3

while.cond.preheader:                             ; preds = %for.inc35
  %cmp38.not115 = icmp eq i32 %start, %num_moves
  br i1 %cmp38.not115, label %while.end, label %while.body.lr.ph

while.cond.preheader.thread:                      ; preds = %entry
  %cmp38.not115153 = icmp eq i32 %start, %num_moves
  br i1 %cmp38.not115153, label %while.end, label %while.body.lr.ph.split

while.body.lr.ph:                                 ; preds = %while.cond.preheader
  %cmp41110 = icmp sgt i32 %num_buckets.1, 1
  br i1 %cmp41110, label %while.body.us.preheader, label %while.body.lr.ph.split
...
while.body.us:                                    ; preds = %while.body.us.preheader, %do.end.us
  %count.0116.us = phi i32 [ %6, %do.end.us ], [ %start, %while.body.us.preheader ]
...
for.body42.us:                                    ; preds = %while.body.us, %for.body42.us
  ...
  %index.0113.us = phi i32 [ %spec.select99.us.3, %for.body42.us ], [ 0, %while.body.us ]
  %best.0112.us = phi i32 [ %spec.select.us.3, %for.body42.us ], [ %5, %while.body.us ]
  ...
  %cmp45.us = icmp sgt i32 %7, %best.0112.us
  %spec.select.us = tail call i32 @llvm.smax.i32(i32 %7, i32 %best.0112.us)
  %8 = trunc i64 %indvars.iv134 to i32
  %spec.select99.us = select i1 %cmp45.us, i32 %8, i32 %index.0113.us
...
for.cond40.do.body.preheader_crit_edge.us.unr-lcssa: ; preds = %for.body42.us, %while.body.us
  ...
  %index.0113.us.unr = phi i32 [ 0, %while.body.us ], [ %spec.select99.us.3, %for.body42.us ]
  %best.0112.us.unr = phi i32 [ %5, %while.body.us ], [ %spec.select.us.3, %for.body42.us ]
...
for.body42.us.epil:                               ; preds = %for.cond40.do.body.preheader_crit_edge.us.unr-lcssa, %for.body42.us.epil
  ...
  %index.0113.us.epil = phi i32 [ %spec.select99.us.epil, %for.body42.us.epil ], [ %index.0113.us.unr, %for.cond40.do.body.preheader_crit_edge.us.unr-lcssa ]
  %best.0112.us.epil = phi i32 [ %spec.select.us.epil, %for.body42.us.epil ], [ %best.0112.us.unr, %for.cond40.do.body.preheader_crit_edge.us.unr-lcssa ]
  ...
  %cmp45.us.epil = icmp sgt i32 %15, %best.0112.us.epil
  %spec.select.us.epil = tail call i32 @llvm.smax.i32(i32 %15, i32 %best.0112.us.epil)
  %16 = trunc i64 %indvars.iv134.epil to i32
  %spec.select99.us.epil = select i1 %cmp45.us.epil, i32 %16, i32 %index.0113.us.epil
...
for.cond40.do.body.preheader_crit_edge.us:        ; preds = %for.body42.us.epil, %for.cond40.do.body.preheader_crit_edge.us.unr-lcssa
  ...
  %18 = sext i32 %count.0116.us to i64
  %19 = mul nsw i64 %18, 12
  %uglygep139 = getelementptr i8, ptr %movelist, i64 %19
  %20 = mul nsw i64 %idxprom56.us, 3072
  %uglygep140 = getelementptr i8, ptr %bucket, i64 %20
  %smax141 = tail call i32 @llvm.smax.i32(i32 %17, i32 1)
  %21 = zext i32 %smax141 to i64
  %22 = mul nuw nsw i64 %21, 12
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %uglygep139, ptr align 16 %uglygep140, i64 %22, i1 false)
...
if.then:                                          ; preds = %for.body3
  ...
  %idxprom4.le = and i64 %indvars.iv, 4294967295
  %arrayidx = getelementptr inbounds %struct.Move, ptr %movelist, i64 %indvars.iv120
  %arrayidx10 = getelementptr inbounds [128 x i32], ptr %buck_size, i64 0, i64 %idxprom4.le
  %33 = load i32, ptr %arrayidx10, align 4, !tbaa !10
  %inc = add nsw i32 %33, 1
  store i32 %inc, ptr %arrayidx10, align 4, !tbaa !10
  %idxprom11 = sext i32 %33 to i64
  %arrayidx12 = getelementptr inbounds [128 x [256 x %struct.Move]], ptr %bucket, i64 0, i64 %idxprom4.le, i64 %idxprom11
...
for.end:                                          ; preds = %for.cond1.preheader, %if.then
  ...
  %cmp16 = icmp eq i32 %j.0101, %num_buckets.0106
  br i1 %cmp16, label %if.then17, label %for.inc35

if.then17:                                        ; preds = %for.inc, %for.end
  %cmp18 = icmp eq i32 %num_buckets.0106, 128
  br i1 %cmp18, label %if.then19, label %if.end20

if.then19:                                        ; preds = %if.then17
  tail call void (ptr, i32, i32, ptr, ...) @_fatal_error_aux(ptr noundef nonnull @.str, i32 noundef 34, i32 noundef 1, ptr noundef nonnull @.str.1) #6
  br label %if.end20

if.end20:                                         ; preds = %if.then19, %if.then17
  %idxprom21 = zext i32 %num_buckets.0106 to i64
  ...
  %inc33 = add nsw i32 %num_buckets.0106, 1
  br label %for.inc35

for.inc35:                                        ; preds = %for.end, %if.end20
  %num_buckets.1 = phi i32 [ %inc33, %if.end20 ], [ %num_buckets.0106, %for.end ]
...
while.body:                                       ; preds = %while.body.lr.ph.split, %do.end
  %count.0116 = phi i32 [ %start, %while.body.lr.ph.split ], [ %42, %do.end ]
  %35 = sext i32 %count.0116 to i64
  %36 = mul nsw i64 %35, 12
  %uglygep = getelementptr i8, ptr %movelist, i64 %36
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %uglygep, ptr nonnull align 16 %bucket, i64 %30, i1 false)
...
while.end:                                        ; preds = %do.end, %do.end.us, %while.cond.preheader.thread, %while.cond.preheader
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %buck_size) #6
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %buck_val) #6
  call void @llvm.lifetime.end.p0(i64 393216, ptr nonnull %bucket) #6
  ret void
}
