; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/viterbi/dec_viterbi_F.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/viterbi/dec_viterbi_F.c"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 18304, ptr nonnull %history) #10
  call void @llvm.lifetime.start.p0(i64 18432, ptr nonnull %history_new) #10
...
bitvector_init.exit:                              ; preds = %if.end3, %if.then.i
  ...
  %call7 = tail call noalias ptr @malloc(i64 noundef %mul) #11
  %call10 = tail call noalias ptr @malloc(i64 noundef %mul) #11
...
for.body93:                                       ; preds = %for.body93.preheader, %for.inc207
  ...
  %55 = add i64 %30, %54
  %uglygep465 = getelementptr i8, ptr %history_new, i64 %55
  %56 = mul i64 %i.2444, 286
  %57 = add i64 %56, 143
  %uglygep466 = getelementptr i8, ptr %history, i64 %57
  %uglygep464 = getelementptr i8, ptr %history, i64 %56
  %58 = or i64 %54, 1
  %uglygep461 = getelementptr i8, ptr %history_new, i64 %58
  %mul94 = shl nuw i64 %i.2444, 1
  %arrayidx95 = getelementptr inbounds double, ptr %call7, i64 %mul94
  %59 = load <2 x double>, ptr %arrayidx95, align 8, !tbaa !15
  %60 = extractelement <2 x double> %59, i64 0
  %61 = extractelement <2 x double> %59, i64 1
  %cmp99 = fcmp ugt double %60, %61
...
if.then101:                                       ; preds = %for.body93
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(143) %uglygep461, ptr noundef nonnull align 2 dereferenceable(143) %uglygep464, i64 143, i1 false), !tbaa !12
  br label %if.end140

if.else:                                          ; preds = %for.body93
  store double %61, ptr %arrayidx123, align 8, !tbaa !15
  store i8 1, ptr %arrayidx124, align 16, !tbaa !12
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(143) %uglygep461, ptr noundef nonnull align 1 dereferenceable(143) %uglygep466, i64 143, i1 false), !tbaa !12
  br label %if.end140

if.end140:                                        ; preds = %if.then101, %if.else
  %arrayidx142 = getelementptr inbounds double, ptr %call10, i64 %mul94
  %62 = load <2 x double>, ptr %arrayidx142, align 8, !tbaa !15
  %63 = extractelement <2 x double> %62, i64 0
  %64 = extractelement <2 x double> %62, i64 1
  %cmp146 = fcmp ugt double %63, %64
...
if.then148:                                       ; preds = %if.end140
  store double %63, ptr %arrayidx183, align 8, !tbaa !15
  store i8 0, ptr %arrayidx187, align 16, !tbaa !12
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(143) %uglygep465, ptr noundef nonnull align 2 dereferenceable(143) %uglygep464, i64 143, i1 false), !tbaa !12
  br label %for.inc207

if.else176:                                       ; preds = %if.end140
  store double %64, ptr %arrayidx183, align 8, !tbaa !15
  store i8 1, ptr %arrayidx187, align 16, !tbaa !12
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(143) %uglygep465, ptr noundef nonnull align 1 dereferenceable(143) %uglygep466, i64 143, i1 false), !tbaa !12
  br label %for.inc207
...
for.body214:                                      ; preds = %for.body214.preheader474, %for.body214
  ...
  %65 = load i8, ptr %arrayidx216, align 1, !tbaa !12
  %cmp218 = icmp eq i8 %65, 0
...
for.end224:                                       ; preds = %for.body214, %middle.block, %for.cond210.preheader
  ...
  %arrayidx236 = getelementptr inbounds i8, ptr %66, i64 %bv.0454
  %. = zext i1 %cmp227.not to i8
  store i8 %., ptr %arrayidx236, align 1, !tbaa !12
  %bv.1 = add i64 %bv.0454, 1
  %67 = load i64, ptr %Nways, align 8, !tbaa !13
  %cmp240451.not = icmp eq i64 %67, 0
...
for.cond243.preheader.preheader:                  ; preds = %for.end224
  %xtraiter = and i64 %67, 1
  %68 = icmp eq i64 %67, 1
  br i1 %68, label %for.end256.loopexit.unr-lcssa, label %for.cond243.preheader.preheader.new

for.cond243.preheader.preheader.new:              ; preds = %for.cond243.preheader.preheader
  %unroll_iter = and i64 %67, -2
...
for.cond243.preheader:                            ; preds = %for.cond243.preheader, %for.cond243.preheader.preheader.new
  ...
  %69 = mul i64 %i.4452, 143
  %uglygep469 = getelementptr i8, ptr %history, i64 %69
  %70 = mul i64 %i.4452, 144
  %uglygep470 = getelementptr i8, ptr %history_new, i64 %70
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 2 dereferenceable(143) %uglygep469, ptr noundef nonnull align 16 dereferenceable(143) %uglygep470, i64 143, i1 false), !tbaa !12
  %inc255 = or i64 %i.4452, 1
  %71 = mul i64 %inc255, 143
  %uglygep469.1 = getelementptr i8, ptr %history, i64 %71
  %72 = mul i64 %inc255, 144
  %uglygep470.1 = getelementptr i8, ptr %history_new, i64 %72
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(143) %uglygep469.1, ptr noundef nonnull align 16 dereferenceable(143) %uglygep470.1, i64 143, i1 false), !tbaa !12
...
for.cond243.preheader.epil:                       ; preds = %for.end256.loopexit.unr-lcssa
  %73 = mul i64 %i.4452.unr, 143
  %uglygep469.epil = getelementptr i8, ptr %history, i64 %73
  %74 = mul i64 %i.4452.unr, 144
  %uglygep470.epil = getelementptr i8, ptr %history_new, i64 %74
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(143) %uglygep469.epil, ptr noundef nonnull align 16 dereferenceable(143) %uglygep470.epil, i64 143, i1 false), !tbaa !12
  br label %for.end256

for.end256:                                       ; preds = %for.cond243.preheader.epil, %for.end256.loopexit.unr-lcssa, %for.end224
  %inc257 = add i64 %i_punct.0455, 1
  %75 = load i64, ptr %n_in, align 8, !tbaa !26
  %cmp258 = icmp eq i64 %inc257, %75
  %spec.store.select = select i1 %cmp258, i64 0, i64 %inc257
  %76 = load i64, ptr %bit_stream, align 8, !tbaa !5
  %cmp15 = icmp ult i64 %i_in.2, %76
...
while.end:                                        ; preds = %while.end.loopexit, %bitvector_init.exit
  %77 = phi ptr [ %call.sink.i, %bitvector_init.exit ], [ %.pre472, %while.end.loopexit ]
  %bv.0.lcssa = phi i64 [ 0, %bitvector_init.exit ], [ %bv.1, %while.end.loopexit ]
  %call264 = tail call ptr @realloc(ptr noundef %77, i64 noundef %bv.0.lcssa) #12
  store ptr %call264, ptr %5, align 8, !tbaa !11
  store i64 %bv.0.lcssa, ptr %bit_stream, align 8, !tbaa !5
  %78 = load ptr, ptr %data11, align 8, !tbaa !11
  %79 = load i64, ptr %Metr_mem, align 8, !tbaa !5
  %mul269 = shl i64 %79, 3
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 8 %78, ptr align 8 %call, i64 %mul269, i1 false)
  ...
  tail call void @free(ptr noundef %call7) #10
  tail call void @free(ptr noundef %call10) #10
  call void @llvm.lifetime.end.p0(i64 18432, ptr nonnull %history_new) #10
  call void @llvm.lifetime.end.p0(i64 18304, ptr nonnull %history) #10
  ret void
}
