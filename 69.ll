; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/d/symtab.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/d/symtab.c"
...
define dso_local ptr @enter_D_Scope(ptr noundef %current, ptr noundef %scope) local_unnamed_addr #3 {
entry:
  %calloc = tail call dereferenceable_or_null(72) ptr @calloc(i64 1, i64 72)
...
define dso_local void @free_D_Scope(ptr nocapture noundef %st, i32 noundef %force) local_unnamed_addr #4 {
entry:
...
for.end26:                                        ; preds = %for.body20, %if.end17
  tail call void @free(ptr noundef nonnull %st) #16
  br label %cleanup
...
define dso_local void @free_D_Sym(ptr nocapture noundef %s) local_unnamed_addr #5 {
entry:
  tail call void @free(ptr noundef %s) #16
  ret void
}
...
; Function Attrs: nounwind uwtable
define dso_local ptr @commit_D_Scope(ptr noundef %st) local_unnamed_addr #4 {
entry:
...
; Function Attrs: nounwind uwtable
define internal fastcc void @commit_ll(ptr nocapture noundef %st, ptr nocapture noundef %sh) unnamed_addr #4 {
entry:
...
; Function Attrs: nounwind uwtable
define dso_local ptr @new_D_Sym(ptr nocapture noundef %st, ptr noundef %name, ptr noundef %end, i32 noundef %sizeof_D_Sym) local_unnamed_addr #4 {
entry:
  ...
  %call5 = tail call i32 @strhashl(ptr noundef %name, i32 noundef %conv) #16
...
declare i32 @strhashl(ptr noundef, i32 noundef) local_unnamed_addr #7

; Function Attrs: nounwind uwtable
define internal fastcc void @symhash_add(ptr nocapture noundef %sh, ptr noundef %s) unnamed_addr #4 {
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 40, ptr nonnull %tv) #16
...
if.end83:                                         ; preds = %if.then62, %if.else72
  call void @vec_add_internal(ptr noundef nonnull %tv, ptr noundef nonnull %11) #16
  br label %do.end85
...
if.end109:                                        ; preds = %while.end107, %entry
  call void @llvm.lifetime.end.p0(i64 40, ptr nonnull %tv) #16
  ret void
}

; Function Attrs: nofree norecurse nosync nounwind memory(read, inaccessiblemem: none) uwtable
define dso_local ptr @current_D_Sym(ptr noundef readonly %st, ptr noundef readonly %sym) local_unnamed_addr #8 {
entry:
...
define dso_local ptr @find_sym_internal(ptr noundef readonly %top, ptr noundef readonly %cur, ptr nocapture noundef readonly %name, i32 noundef %len, i32 noundef %h) local_unnamed_addr #9 {
entry:
  %conv194 = sext i32 %len to i64
  br label %tailrecurse

tailrecurse:                                      ; preds = %if.then200, %entry
  %cur.tr = phi ptr [ %cur, %entry ], [ %6, %if.then200 ]
...
if.end7:                                          ; preds = %if.else, %if.then2
  ...
  %ll.1233 = load ptr, ptr %ll.0.in, align 8, !tbaa !24
  %tobool8.not234 = icmp eq ptr %ll.1233, null
  br i1 %tobool8.not234, label %if.then200, label %while.body

while.body:                                       ; preds = %if.end7, %if.end198
  %ll.1235 = phi ptr [ %ll.1, %if.end198 ], [ %ll.1233, %if.end7 ]
  %hash9 = getelementptr inbounds %struct.D_Sym, ptr %ll.1235, i64 0, i32 2
  %3 = load i32, ptr %hash9, align 4, !tbaa !41
  %cmp = icmp eq i32 %3, %h
  br i1 %cmp, label %land.lhs.true, label %if.end198

land.lhs.true:                                    ; preds = %while.body
  %len10 = getelementptr inbounds %struct.D_Sym, ptr %ll.1235, i64 0, i32 1
  %4 = load i32, ptr %len10, align 8, !tbaa !40
  %cmp11 = icmp eq i32 %4, %len
  br i1 %cmp11, label %land.lhs.true12, label %if.end198

land.lhs.true12:                                  ; preds = %land.lhs.true
  %5 = load ptr, ptr %ll.1235, align 8, !tbaa !39
  %call195 = tail call i32 @strncmp(ptr noundef %5, ptr noundef %name, i64 noundef %conv194) #17
  %tobool196.not = icmp eq i32 %call195, 0
  br i1 %tobool196.not, label %if.end206, label %if.end198

if.end198:                                        ; preds = %land.lhs.true12, %land.lhs.true, %while.body
  %next = getelementptr inbounds %struct.D_Sym, ptr %ll.1235, i64 0, i32 4
  %ll.1 = load ptr, ptr %next, align 8, !tbaa !24
  %tobool8.not = icmp eq ptr %ll.1, null
  br i1 %tobool8.not, label %if.then200, label %while.body, !llvm.loop !48

if.then200:                                       ; preds = %if.end198, %if.end7
  %search = getelementptr inbounds %struct.D_Scope, ptr %cur.tr, i64 0, i32 4
  %6 = load ptr, ptr %search, align 8, !tbaa !5
  %tobool201.not = icmp eq ptr %6, null
  br i1 %tobool201.not, label %cleanup, label %tailrecurse

if.end206:                                        ; preds = %land.lhs.true12
  %update_of.i = getelementptr inbounds %struct.D_Sym, ptr %ll.1235, i64 0, i32 3
  %7 = load ptr, ptr %update_of.i, align 8, !tbaa !33
  %tobool.not.i = icmp eq ptr %7, null
  %spec.select.i = select i1 %tobool.not.i, ptr %ll.1235, ptr %7
  %tobool2.not25.i = icmp eq ptr %top, null
  br i1 %tobool2.not25.i, label %cleanup, label %for.body.i

for.body.i:                                       ; preds = %if.end206, %for.inc9.i
  %sc.026.i = phi ptr [ %9, %for.inc9.i ], [ %top, %if.end206 ]
...
cleanup:                                          ; preds = %if.then200, %tailrecurse, %for.inc9.i, %for.body5.i, %if.end206
  %retval.0 = phi ptr [ %spec.select.i, %if.end206 ], [ %uu.024.i, %for.body5.i ], [ %spec.select.i, %for.inc9.i ], [ null, %tailrecurse ], [ null, %if.then200 ]
  ret ptr %retval.0
}
...
; Function Attrs: nounwind uwtable
define dso_local ptr @find_D_Sym(ptr noundef readonly %st, ptr noundef %name, ptr noundef %end) local_unnamed_addr #4 {
entry:
  %sub.ptr.lhs.cast = ptrtoint ptr %end to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %name to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %conv = trunc i64 %sub.ptr.sub to i32
  %call = tail call i32 @strhashl(ptr noundef %name, i32 noundef %conv) #16
  %sext = shl i64 %sub.ptr.sub, 32
  %conv194.i = ashr exact i64 %sext, 32
  br label %tailrecurse.i

tailrecurse.i:                                    ; preds = %if.then200.i, %entry
  %cur.tr.i = phi ptr [ %st, %entry ], [ %6, %if.then200.i ]
...
if.end7.i:                                        ; preds = %if.else.i, %if.then2.i
  ...
  %ll.1233.i = load ptr, ptr %ll.0.in.i, align 8, !tbaa !24
  %tobool8.not234.i = icmp eq ptr %ll.1233.i, null
  br i1 %tobool8.not234.i, label %if.then200.i, label %while.body.i

while.body.i:                                     ; preds = %if.end7.i, %if.end198.i
  %ll.1235.i = phi ptr [ %ll.1.i, %if.end198.i ], [ %ll.1233.i, %if.end7.i ]
  %hash9.i = getelementptr inbounds %struct.D_Sym, ptr %ll.1235.i, i64 0, i32 2
  %3 = load i32, ptr %hash9.i, align 4, !tbaa !41
  %cmp.i = icmp eq i32 %3, %call
  br i1 %cmp.i, label %land.lhs.true.i, label %if.end198.i

land.lhs.true.i:                                  ; preds = %while.body.i
  %len10.i = getelementptr inbounds %struct.D_Sym, ptr %ll.1235.i, i64 0, i32 1
  %4 = load i32, ptr %len10.i, align 8, !tbaa !40
  %cmp11.i = icmp eq i32 %4, %conv
  br i1 %cmp11.i, label %land.lhs.true12.i, label %if.end198.i

land.lhs.true12.i:                                ; preds = %land.lhs.true.i
  %5 = load ptr, ptr %ll.1235.i, align 8, !tbaa !39
  %call195.i = tail call i32 @strncmp(ptr noundef %5, ptr noundef %name, i64 noundef %conv194.i) #17
  %tobool196.not.i = icmp eq i32 %call195.i, 0
  br i1 %tobool196.not.i, label %if.end206.i, label %if.end198.i

if.end198.i:                                      ; preds = %land.lhs.true12.i, %land.lhs.true.i, %while.body.i
  %next.i = getelementptr inbounds %struct.D_Sym, ptr %ll.1235.i, i64 0, i32 4
  %ll.1.i = load ptr, ptr %next.i, align 8, !tbaa !24
  %tobool8.not.i = icmp eq ptr %ll.1.i, null
  br i1 %tobool8.not.i, label %if.then200.i, label %while.body.i, !llvm.loop !48

if.then200.i:                                     ; preds = %if.end198.i, %if.end7.i
  %search.i = getelementptr inbounds %struct.D_Scope, ptr %cur.tr.i, i64 0, i32 4
  %6 = load ptr, ptr %search.i, align 8, !tbaa !5
  %tobool201.not.i = icmp eq ptr %6, null
  br i1 %tobool201.not.i, label %find_sym_internal.exit, label %tailrecurse.i

if.end206.i:                                      ; preds = %land.lhs.true12.i
  %update_of.i.i = getelementptr inbounds %struct.D_Sym, ptr %ll.1235.i, i64 0, i32 3
  %7 = load ptr, ptr %update_of.i.i, align 8, !tbaa !33
  %tobool.not.i.i = icmp eq ptr %7, null
  %spec.select.i.i = select i1 %tobool.not.i.i, ptr %ll.1235.i, ptr %7
  %tobool2.not25.i.i = icmp eq ptr %st, null
  br i1 %tobool2.not25.i.i, label %find_sym_internal.exit, label %for.body.i.i

for.body.i.i:                                     ; preds = %if.end206.i, %for.inc9.i.i
  %sc.026.i.i = phi ptr [ %9, %for.inc9.i.i ], [ %st, %if.end206.i ]
  %updates.i.i = getelementptr inbounds %struct.D_Scope, ptr %sc.026.i.i, i64 0, i32 3
  %uu.022.i.i = load ptr, ptr %updates.i.i, align 8, !tbaa !24
  %tobool4.not23.i.i = icmp eq ptr %uu.022.i.i, null
  br i1 %tobool4.not23.i.i, label %for.inc9.i.i, label %for.body5.i.i
...
find_sym_internal.exit:                           ; preds = %tailrecurse.i, %if.then200.i, %for.inc9.i.i, %for.body5.i.i, %if.end206.i
  %retval.0.i = phi ptr [ %spec.select.i.i, %if.end206.i ], [ %uu.024.i.i, %for.body5.i.i ], [ %spec.select.i.i, %for.inc9.i.i ], [ null, %if.then200.i ], [ null, %tailrecurse.i ]
  ret ptr %retval.0.i
}

; Function Attrs: nounwind uwtable
define dso_local ptr @find_D_Sym_in_Scope(ptr noundef readonly %st, ptr noundef %name, ptr noundef %end) local_unnamed_addr #4 {
entry:
  %sub.ptr.lhs.cast = ptrtoint ptr %end to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %name to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  ...
  %call = tail call i32 @strhashl(ptr noundef %name, i32 noundef %conv) #16
  %sext = shl i64 %sub.ptr.sub, 32
  %conv196 = ashr exact i64 %sext, 32
  br label %for.cond

for.cond:                                         ; preds = %lor.lhs.false202, %entry
  %st.addr.0 = phi ptr [ %st, %entry ], [ %6, %lor.lhs.false202 ]
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %ll.1234 = load ptr, ptr %ll.0.in, align 8, !tbaa !24
  %tobool6.not235 = icmp eq ptr %ll.1234, null
  br i1 %tobool6.not235, label %while.end, label %while.body

while.body:                                       ; preds = %if.end, %if.end200
  %ll.1236 = phi ptr [ %ll.1, %if.end200 ], [ %ll.1234, %if.end ]
  %hash7 = getelementptr inbounds %struct.D_Sym, ptr %ll.1236, i64 0, i32 2
  %3 = load i32, ptr %hash7, align 4, !tbaa !41
  %cmp = icmp eq i32 %3, %call
  br i1 %cmp, label %land.lhs.true, label %if.end200

land.lhs.true:                                    ; preds = %while.body
  %len9 = getelementptr inbounds %struct.D_Sym, ptr %ll.1236, i64 0, i32 1
  %4 = load i32, ptr %len9, align 8, !tbaa !40
  %cmp10 = icmp eq i32 %4, %conv
  br i1 %cmp10, label %land.lhs.true12, label %if.end200

land.lhs.true12:                                  ; preds = %land.lhs.true
  %5 = load ptr, ptr %ll.1236, align 8, !tbaa !39
  %call197 = tail call i32 @strncmp(ptr noundef %5, ptr noundef %name, i64 noundef %conv196) #17
  %tobool198.not = icmp eq i32 %call197, 0
  br i1 %tobool198.not, label %cleanup, label %if.end200

if.end200:                                        ; preds = %land.lhs.true12, %land.lhs.true, %while.body
  %next = getelementptr inbounds %struct.D_Sym, ptr %ll.1236, i64 0, i32 4
  %ll.1 = load ptr, ptr %next, align 8, !tbaa !24
  %tobool6.not = icmp eq ptr %ll.1, null
  br i1 %tobool6.not, label %while.end, label %while.body, !llvm.loop !49

while.end:                                        ; preds = %if.end200, %if.end
  %search = getelementptr inbounds %struct.D_Scope, ptr %st.addr.0, i64 0, i32 4
  %6 = load ptr, ptr %search, align 8, !tbaa !5
  %tobool201.not = icmp eq ptr %6, null
  br i1 %tobool201.not, label %cleanup, label %lor.lhs.false202

lor.lhs.false202:                                 ; preds = %while.end
  %up = getelementptr inbounds %struct.D_Scope, ptr %6, i64 0, i32 5
  %7 = load ptr, ptr %up, align 8, !tbaa !11
  %up204 = getelementptr inbounds %struct.D_Scope, ptr %st.addr.0, i64 0, i32 5
  %8 = load ptr, ptr %up204, align 8, !tbaa !11
  %cmp205.not = icmp eq ptr %7, %8
  br i1 %cmp205.not, label %for.cond, label %cleanup, !llvm.loop !50

cleanup:                                          ; preds = %for.cond, %lor.lhs.false202, %while.end, %land.lhs.true12
  %retval.0 = phi ptr [ %ll.1236, %land.lhs.true12 ], [ null, %while.end ], [ null, %lor.lhs.false202 ], [ null, %for.cond ]
  ret ptr %retval.0
}

; Function Attrs: nofree nounwind uwtable
define dso_local ptr @update_D_Sym(ptr noundef %st, ptr noundef %sym, i32 noundef %sizeof_D_Sym) local_unnamed_addr #11 {
entry:
...
current_D_Sym.exit:                               ; preds = %for.inc9.i, %for.body5.i, %entry
  ...
  %call1 = tail call noalias ptr @malloc(i64 noundef %conv) #18
...
; Function Attrs: nounwind uwtable
define dso_local void @print_sym(ptr nocapture noundef readonly %s) local_unnamed_addr #4 {
entry:
  %len = getelementptr inbounds %struct.D_Sym, ptr %s, i64 0, i32 1
  %0 = load i32, ptr %len, align 8, !tbaa !40
  %add = add nsw i32 %0, 1
  %conv = sext i32 %add to i64
  %call = tail call noalias ptr @malloc(i64 noundef %conv) #18
...
; Function Attrs: nounwind uwtable
define dso_local void @print_scope(ptr noundef %st) local_unnamed_addr #4 {
entry:
  br label %tailrecurse
...
if.then17:                                        ; preds = %for.body
  ...
  %call.i = tail call noalias ptr @malloc(i64 noundef %conv.i) #18
...
while.body:                                       ; preds = %while.cond.preheader, %while.body
  ...
  %call.i55 = tail call noalias ptr @malloc(i64 noundef %conv.i54) #18
  ...
  tail call void @free(ptr noundef %call.i55) #16
...
attributes #3 = { mustprogress nofree nounwind willreturn memory(write, argmem: readwrite, inaccessiblemem: readwrite) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #9 = { nofree nounwind memory(read, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
