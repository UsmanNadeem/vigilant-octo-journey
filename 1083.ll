; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/hash.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/hash.c"
...
entry:
  %uglygep = getelementptr i8, ptr %s, i64 4
...
for.end:                                          ; preds = %for.body.2
  ...
  %.pre = load i8, ptr %uglygep, align 1, !tbaa !5
...
while.body:                                       ; preds = %for.end, %while.body
  ...
  %s.addr.125 = phi ptr [ %incdec.ptr8, %while.body ], [ %uglygep, %for.end ]
