; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gspath.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gspath.c"
...
while.body.preheader:                             ; preds = %while.cond.preheader
  ...
  %13 = shufflevector <2 x double> %6, <2 x double> poison, <2 x i32> <i32 1, i32 undef>
...
while.body68.preheader:                           ; preds = %while.cond64.preheader
  ...
  %23 = insertelement <2 x double> poison, double %conv71.peel, i64 0
  %24 = shufflevector <2 x double> %23, <2 x double> %6, <2 x i32> <i32 0, i32 2>
...
if.end3:                                          ; preds = %gs_currentpoint.exit
  ...
  %shift = shufflevector <2 x double> %18, <2 x double> poison, <2 x i32> <i32 1, i32 undef>
...
if.end35:                                         ; preds = %if.then31, %if.then27
  ...
  %32 = insertelement <2 x double> poison, double %ax1, i64 0
  %33 = insertelement <2 x double> %32, double %ay1, i64 1
  %34 = fptrunc <2 x double> %33 to <2 x float>
  %35 = shufflevector <2 x float> %34, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %pt) #6
  br label %if.end60
...
if.else:                                          ; preds = %if.end3
  ...
  %36 = call double @llvm.fabs.f64(double %div)
  %37 = call <2 x double> @llvm.sqrt.v2f64(<2 x double> %18)
  %38 = fpext <4 x float> %13 to <4 x double>
  %39 = insertelement <2 x double> poison, double %36, i64 0
  %40 = shufflevector <2 x double> %39, <2 x double> poison, <2 x i32> zeroinitializer
  %41 = fdiv <2 x double> %40, %37
  %42 = shufflevector <2 x double> %41, <2 x double> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 1>
  %43 = call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %38, <4 x double> %42, <4 x double> %11)
  %44 = fptrunc <4 x double> %43 to <4 x float>
  %45 = extractelement <4 x float> %44, i64 0
  %conv55 = fpext float %45 to double
  %46 = extractelement <4 x float> %44, i64 1
  %conv56 = fpext float %46 to double
  %47 = extractelement <4 x float> %44, i64 2
  %conv57 = fpext float %47 to double
  %48 = extractelement <4 x float> %44, i64 3
...
if.end60:                                         ; preds = %if.else, %if.end35
  ...
  %49 = phi <4 x float> [ %35, %if.end35 ], [ %44, %if.else ]
  %cmp61.not = icmp eq ptr %retxy, null
  br i1 %cmp61.not, label %cleanup, label %if.then63

if.then63:                                        ; preds = %if.end60
  store <4 x float> %49, ptr %retxy, align 4, !tbaa !26
  br label %cleanup
