; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Benchmarks/Dhrystone/dry.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Benchmarks/Dhrystone/dry.c"
...
entry:
  %call = tail call i64 @clock() #14
  %call1 = tail call i64 @clock() #14
  %call2 = tail call noalias dereferenceable_or_null(56) ptr @malloc(i64 noundef 56) #15
  store ptr %call2, ptr @PtrGlbNext, align 8, !tbaa !5
  %call3 = tail call noalias dereferenceable_or_null(56) ptr @malloc(i64 noundef 56) #15
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(31) %StringComp, ptr noundef nonnull align 1 dereferenceable(31) @.str, i64 31, i1 false) #14
  store i32 10, ptr getelementptr inbounds ([51 x [51 x i32]], ptr @Array2Glob, i64 0, i64 8, i64 7), align 4, !tbaa !15
  %call7 = tail call i64 @clock() #14
  br label %for.body10
...
define dso_local i32 @Proc8(ptr nocapture noundef %Array1Par, ptr nocapture noundef %Array2Par, i32 noundef %IntParI1, i32 noundef %IntParI2) local_unnamed_addr #9 {
entry:
...
define dso_local i32 @Func1(i32 noundef %0, i32 noundef %1) local_unnamed_addr #10 {
entry:
...
define dso_local i32 @Func2(ptr nocapture noundef readonly %StrParI1, ptr nocapture noundef readonly %StrParI2) local_unnamed_addr #11 {
entry:
...
if.else:                                          ; preds = %entry
  %call160 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %StrParI1, ptr noundef nonnull dereferenceable(1) %StrParI2) #14
  %cmp167 = icmp sgt i32 %call160, 0
  %. = zext i1 %cmp167 to i32
  ret i32 %.
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local i32 @Func3(i32 noundef %EnumParIn) local_unnamed_addr #10 {
entry:
...
attributes #11 = { nofree nounwind memory(argmem: read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
