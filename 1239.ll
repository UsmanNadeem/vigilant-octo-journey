; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20011126-2.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20011126-2.c"
...
while.body.i.outer:                               ; preds = %while.body14.i.preheader, %entry
  %in.addr.0.i.ph = phi ptr [ %uglygep10, %while.body14.i.preheader ], [ @.str, %entry ]
  %out.addr.0.i.ph = phi ptr [ %uglygep13, %while.body14.i.preheader ], [ %out, %entry ]
...
while.body14.i.preheader:                         ; preds = %while.cond11.preheader.i
  %in.addr.0.i5.le = ptrtoint ptr %in.addr.0.i.ph to i64
  %2 = sub i64 1, %in.addr.0.i5.le
  %3 = add i64 %indvar, %in.addr.0.i5.le
  %umax = tail call i64 @llvm.umax.i64(i64 %in.addr.0.i5.le, i64 %3)
  %4 = add i64 %2, %umax
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %out.addr.0.i.ph, ptr nonnull align 1 %in.addr.0.i.ph, i64 %4, i1 false), !tbaa !5
  %5 = sub i64 0, %in.addr.0.i5.le
  %umax9 = tail call i64 @llvm.umax.i64(i64 %in.addr.0.i5.le, i64 %indvars.iv)
  %uglygep11 = getelementptr i8, ptr %out.addr.0.i.ph, i64 1
  %uglygep12 = getelementptr i8, ptr %uglygep11, i64 %5
  %uglygep = getelementptr i8, ptr %in.addr.0.i.ph, i64 1
  %uglygep7 = getelementptr i8, ptr %uglygep, i64 %5
  %uglygep10 = getelementptr i8, ptr %uglygep7, i64 %umax9
  %uglygep13 = getelementptr i8, ptr %uglygep12, i64 %umax9
  br label %while.body.i.outer
