; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_infblock.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_infblock.c"
...
for.cond.sw.bb789_crit_edge:                      ; preds = %for.cond
  %.pre3414 = load i32, ptr %need955, align 8, !tbaa !20
  br label %sw.bb789

for.cond.sw.bb782_crit_edge:                      ; preds = %for.cond
  %.pre3412 = load i8, ptr %lbits761, align 8, !tbaa !21
  %.pre3413 = load ptr, ptr %ltree768, align 8, !tbaa !23
  br label %sw.bb782
...
for.cond.sw.bb960_crit_edge:                      ; preds = %for.cond
  %.pre3408 = load i32, ptr %need955, align 8, !tbaa !20
  br label %sw.bb960

for.cond.sw.bb1113_crit_edge:                     ; preds = %for.cond
  %.pre3406 = load i32, ptr %dist1103, align 4, !tbaa !20
  br label %sw.bb1113
...
for.body:                                         ; preds = %if.end69.1, %if.then53
  %indvars.iv3399 = phi i64 [ 0, %if.then53 ], [ %indvars.iv.next3400.1, %if.end69.1 ]
  %cmp57 = icmp ugt i64 %indvars.iv3399, 143
  br i1 %cmp57, label %if.then59, label %if.end69

if.then59:                                        ; preds = %for.body
  %cmp60 = icmp ult i64 %indvars.iv3399, 256
  br i1 %cmp60, label %if.end69, label %if.else

if.else:                                          ; preds = %if.then59
  %cmp63 = icmp ult i64 %indvars.iv3399, 280
...
if.end69:                                         ; preds = %if.else, %if.then59, %for.body
  ...
  %arrayidx = getelementptr inbounds [288 x i32], ptr @nsis_inflate.lc, i64 0, i64 %indvars.iv3399
  store i32 %v.0, ptr %arrayidx, align 8, !tbaa !29
  %indvars.iv.next3400 = or i64 %indvars.iv3399, 1
  %cmp57.1 = icmp ugt i64 %indvars.iv3399, 142
  br i1 %cmp57.1, label %if.then59.1, label %if.end69.1

if.then59.1:                                      ; preds = %if.end69
  %cmp60.1 = icmp ult i64 %indvars.iv.next3400, 256
  br i1 %cmp60.1, label %if.end69.1, label %if.else.1

if.else.1:                                        ; preds = %if.then59.1
  %cmp63.1 = icmp ult i64 %indvars.iv.next3400, 280
...
if.end69.1:                                       ; preds = %if.else.1, %if.then59.1, %if.end69
  ...
  %arrayidx.1 = getelementptr inbounds [288 x i32], ptr @nsis_inflate.lc, i64 0, i64 %indvars.iv.next3400
  store i32 %v.0.1, ptr %arrayidx.1, align 4, !tbaa !29
  %indvars.iv.next3400.1 = add nuw nsw i64 %indvars.iv3399, 2
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next3400.1, 288
...
if.then106:                                       ; preds = %while.body103.1, %if.then106.split.loop.exit4163
  ...
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
  %35 = load ptr, ptr %read, align 8, !tbaa !17
  %cmp.not.peel.i2241 = icmp ugt ptr %35, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2241, label %cond.false.peel.i2242, label %cond.end.peel.i2254

cond.false.peel.i2242:                            ; preds = %if.then106
  %36 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  br label %cond.end.peel.i2254

cond.end.peel.i2254:                              ; preds = %cond.false.peel.i2242, %if.then106
  %cond.peel.i2243 = phi ptr [ %36, %cond.false.peel.i2242 ], [ %_state.sroa.3231780.0, %if.then106 ]
  %sub.ptr.lhs.cast.peel.i2244 = ptrtoint ptr %cond.peel.i2243 to i64
  %sub.ptr.rhs.cast.peel.i2245 = ptrtoint ptr %35 to i64
  ...
  %37 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..peel.i2248 = tail call i32 @llvm.umin.i32(i32 %37, i32 %conv.peel.i2247)
  %sub.peel.i2249 = sub i32 %37, %conv..peel.i2248
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %38, ptr align 1 %35, i64 %conv10.peel.i2250, i1 false)
  %39 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.peel.i2251 = getelementptr inbounds i8, ptr %39, i64 %conv10.peel.i2250
  store ptr %add.ptr.peel.i2251, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr13.peel.i2252 = getelementptr inbounds i8, ptr %35, i64 %conv10.peel.i2250
  %40 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.peel.i2253 = icmp eq ptr %add.ptr13.peel.i2252, %40
...
again.i2271:                                      ; preds = %again.i2271.preheader, %if.then.i2273
  ...
  %45 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..i2265 = tail call i32 @llvm.umin.i32(i32 %45, i32 %conv.i2264)
  %sub.i2266 = sub i32 %45, %conv..i2265
  store i32 %sub.i2266, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv10.i2267 = zext i32 %conv..i2265 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %42, ptr nonnull align 1 %window.i2885, i64 %conv10.i2267, i1 false)
  %46 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.i2268 = getelementptr inbounds i8, ptr %46, i64 %conv10.i2267
  ...
  %47 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.i2270 = icmp eq ptr %add.ptr13.i2269, %47
...
if.end117:                                        ; preds = %while.body103.preheader
  ...
  %49 = load i8, ptr %_state.sroa.2191703.0, align 1, !tbaa !20
  %conv122 = zext i8 %49 to i64
  %shl125 = shl nuw nsw i64 %conv122, %11
  %or127 = or i64 %shl125, %_state.sroa.561588.0
  %indvars.iv.next3397 = add nuw nsw i64 %11, 8
...
if.end117.1:                                      ; preds = %while.body103.1
  ...
  %50 = load i8, ptr %incdec.ptr121, align 1, !tbaa !20
  %conv122.1 = zext i8 %50 to i64
  %shl125.1 = shl nuw nsw i64 %conv122.1, %indvars.iv.next3397
...
cond.false140:                                    ; preds = %while.end130
  %51 = load i32, ptr %last1482, align 8, !tbaa !28
  br label %cond.end142

cond.end142:                                      ; preds = %while.end130, %cond.false140
  %cond143 = phi i32 [ %51, %cond.false140 ], [ 10, %while.end130 ]
...
if.then149:                                       ; preds = %sw.bb145
  ...
  store ptr %_state.sroa.2191703.0, ptr %z, align 8, !tbaa !5
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
  %52 = load ptr, ptr %read, align 8, !tbaa !17
  %cmp.not.peel.i2284 = icmp ugt ptr %52, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2284, label %cond.false.peel.i2285, label %cond.end.peel.i2297

cond.false.peel.i2285:                            ; preds = %if.then149
  %53 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  br label %cond.end.peel.i2297

cond.end.peel.i2297:                              ; preds = %cond.false.peel.i2285, %if.then149
  %cond.peel.i2286 = phi ptr [ %53, %cond.false.peel.i2285 ], [ %_state.sroa.3231780.0, %if.then149 ]
  %sub.ptr.lhs.cast.peel.i2287 = ptrtoint ptr %cond.peel.i2286 to i64
  %sub.ptr.rhs.cast.peel.i2288 = ptrtoint ptr %52 to i64
  ...
  %54 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..peel.i2291 = tail call i32 @llvm.umin.i32(i32 %54, i32 %conv.peel.i2290)
  %sub.peel.i2292 = sub i32 %54, %conv..peel.i2291
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %55, ptr align 1 %52, i64 %conv10.peel.i2293, i1 false)
  %56 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.peel.i2294 = getelementptr inbounds i8, ptr %56, i64 %conv10.peel.i2293
  store ptr %add.ptr.peel.i2294, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr13.peel.i2295 = getelementptr inbounds i8, ptr %52, i64 %conv10.peel.i2293
  %57 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.peel.i2296 = icmp eq ptr %add.ptr13.peel.i2295, %57
...
again.i2314:                                      ; preds = %again.i2314.preheader, %if.then.i2316
  ...
  %62 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..i2308 = tail call i32 @llvm.umin.i32(i32 %62, i32 %conv.i2307)
  %sub.i2309 = sub i32 %62, %conv..i2308
  store i32 %sub.i2309, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv10.i2310 = zext i32 %conv..i2308 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %59, ptr nonnull align 1 %window.i2885, i64 %conv10.i2310, i1 false)
  %63 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.i2311 = getelementptr inbounds i8, ptr %63, i64 %conv10.i2310
  ...
  %64 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.i2313 = icmp eq ptr %add.ptr13.i2312, %64
...
if.then164:                                       ; preds = %if.end160
  %66 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp167 = icmp eq ptr %_state.sroa.3231780.0, %66
  br i1 %cmp167, label %land.lhs.true, label %if.then201

land.lhs.true:                                    ; preds = %if.then164
  %67 = load ptr, ptr %read, align 8, !tbaa !17
  %cmp170.not = icmp eq ptr %67, %window.i2885
...
if.then201:                                       ; preds = %if.then164, %land.lhs.true, %if.end197
  ...
  %68 = load ptr, ptr %write, align 8, !tbaa !16
  %69 = load ptr, ptr %read, align 8, !tbaa !17
  %cmp208 = icmp ult ptr %68, %69
  br i1 %cmp208, label %cond.true210, label %cond.false217

cond.true210:                                     ; preds = %if.then201
  %sub.ptr.lhs.cast213 = ptrtoint ptr %69 to i64
  %sub.ptr.rhs.cast214 = ptrtoint ptr %68 to i64
  %70 = xor i64 %sub.ptr.rhs.cast214, -1
  %sub216 = add i64 %sub.ptr.lhs.cast213, %70
  %.pre3415 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %.pre3417 = ptrtoint ptr %.pre3415 to i64
  br label %cond.end223

cond.false217:                                    ; preds = %if.then201
  %71 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %sub.ptr.lhs.cast220 = ptrtoint ptr %71 to i64
  %sub.ptr.rhs.cast221 = ptrtoint ptr %68 to i64
  %sub.ptr.sub222 = sub i64 %sub.ptr.lhs.cast220, %sub.ptr.rhs.cast221
  %.pre3416 = ptrtoint ptr %69 to i64
  br label %cond.end223

cond.end223:                                      ; preds = %cond.false217, %cond.true210
  %sub.ptr.lhs.cast255.pre-phi = phi i64 [ %sub.ptr.lhs.cast220, %cond.false217 ], [ %.pre3417, %cond.true210 ]
  %sub.ptr.lhs.cast248.pre-phi = phi i64 [ %.pre3416, %cond.false217 ], [ %sub.ptr.lhs.cast213, %cond.true210 ]
  %72 = phi ptr [ %71, %cond.false217 ], [ %.pre3415, %cond.true210 ]
  %cond224 = phi i64 [ %sub.ptr.sub222, %cond.false217 ], [ %sub216, %cond.true210 ]
  %cmp229 = icmp ne ptr %68, %72
  %cmp235.not = icmp eq ptr %69, %window.i2885
  %or.cond3255 = select i1 %cmp229, i1 true, i1 %cmp235.not
  %cmp243 = icmp ult ptr %window.i2885, %69
  ...
  %_state.sroa.3231780.2 = select i1 %or.cond3255, ptr %68, ptr %window.i2885
  %_state.sroa.407.2.in = select i1 %or.cond3255, i64 %cond224, i64 %cond259
...
if.end279:                                        ; preds = %if.end197, %cond.end223, %if.end160
  ...
  %.cond289 = tail call i32 @llvm.umin.i32(i32 %73, i32 %cond289)
  ...
  %74 = load i32, ptr %sub, align 8, !tbaa !20
  %sub317 = sub i32 %74, %.cond289
  store i32 %sub317, ptr %sub, align 8, !tbaa !20
  %tobool318.not = icmp eq i32 %74, %.cond289
...
if.then319:                                       ; preds = %if.end279
  %75 = load i32, ptr %last1482, align 8, !tbaa !28
...
if.then331:                                       ; preds = %while.body328.1, %if.then331.split.loop.exit4158
  ...
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
  %78 = load ptr, ptr %read, align 8, !tbaa !17
  %cmp.not.peel.i2327 = icmp ugt ptr %78, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2327, label %cond.false.peel.i2328, label %cond.end.peel.i2340

cond.false.peel.i2328:                            ; preds = %if.then331
  %79 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  br label %cond.end.peel.i2340

cond.end.peel.i2340:                              ; preds = %cond.false.peel.i2328, %if.then331
  %cond.peel.i2329 = phi ptr [ %79, %cond.false.peel.i2328 ], [ %_state.sroa.3231780.0, %if.then331 ]
  %sub.ptr.lhs.cast.peel.i2330 = ptrtoint ptr %cond.peel.i2329 to i64
  %sub.ptr.rhs.cast.peel.i2331 = ptrtoint ptr %78 to i64
  ...
  %80 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..peel.i2334 = tail call i32 @llvm.umin.i32(i32 %80, i32 %conv.peel.i2333)
  %sub.peel.i2335 = sub i32 %80, %conv..peel.i2334
  store i32 %sub.peel.i2335, ptr %avail_out.i2882, align 8, !tbaa !24
  %81 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %conv10.peel.i2336 = zext i32 %conv..peel.i2334 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %81, ptr align 1 %78, i64 %conv10.peel.i2336, i1 false)
  %82 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.peel.i2337 = getelementptr inbounds i8, ptr %82, i64 %conv10.peel.i2336
  store ptr %add.ptr.peel.i2337, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr13.peel.i2338 = getelementptr inbounds i8, ptr %78, i64 %conv10.peel.i2336
  %83 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.peel.i2339 = icmp eq ptr %add.ptr13.peel.i2338, %83
...
again.i2357:                                      ; preds = %again.i2357.preheader, %if.then.i2359
  ...
  %88 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..i2351 = tail call i32 @llvm.umin.i32(i32 %88, i32 %conv.i2350)
  %sub.i2352 = sub i32 %88, %conv..i2351
  store i32 %sub.i2352, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv10.i2353 = zext i32 %conv..i2351 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %85, ptr nonnull align 1 %window.i2885, i64 %conv10.i2353, i1 false)
  %89 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.i2354 = getelementptr inbounds i8, ptr %89, i64 %conv10.i2353
  ...
  %90 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.i2356 = icmp eq ptr %add.ptr13.i2355, %90
...
if.end342:                                        ; preds = %while.body328.preheader
  ...
  %92 = load i8, ptr %_state.sroa.2191703.0, align 1, !tbaa !20
  %conv347 = zext i8 %92 to i64
...
if.end342.1:                                      ; preds = %while.body328.1
  ...
  %93 = load i8, ptr %incdec.ptr346, align 1, !tbaa !20
  %conv347.1 = zext i8 %93 to i64
...
while.end355.loopexit:                            ; preds = %if.end342.1, %if.end342
  ...
  %94 = trunc i64 %indvars.iv.next.lcssa to i32
...
while.end355:                                     ; preds = %while.end355.loopexit, %while.cond324.preheader
  ...
  %_state.sroa.130.3.lcssa = phi i32 [ %_state.sroa.130.0, %while.cond324.preheader ], [ %94, %while.end355.loopexit ]
  ...
  %95 = and i32 %conv357, 960
  %cmp368 = icmp eq i32 %95, 960
...
sw.bb389:                                         ; preds = %for.cond
  %.pre3409 = load i32, ptr %index, align 4, !tbaa !20
  %.pre3410 = load i32, ptr %sub, align 8, !tbaa !20
  %shr3953182 = lshr i32 %.pre3410, 10
  %add3963183 = add nuw nsw i32 %shr3953182, 4
  %cmp3973184 = icmp ult i32 %.pre3409, %add3963183
...
while.cond449.preheader:                          ; preds = %while.end431, %sw.bb389
  ...
  %.lcssa2983 = phi i32 [ %.pre3409, %sw.bb389 ], [ %113, %while.end431 ]
...
if.then407:                                       ; preds = %while.body404
  ...
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
  %97 = load ptr, ptr %read, align 8, !tbaa !17
  %cmp.not.peel.i2370 = icmp ugt ptr %97, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2370, label %cond.false.peel.i2371, label %cond.end.peel.i2383

cond.false.peel.i2371:                            ; preds = %if.then407
  %98 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  br label %cond.end.peel.i2383

cond.end.peel.i2383:                              ; preds = %cond.false.peel.i2371, %if.then407
  %cond.peel.i2372 = phi ptr [ %98, %cond.false.peel.i2371 ], [ %_state.sroa.3231780.0, %if.then407 ]
  %sub.ptr.lhs.cast.peel.i2373 = ptrtoint ptr %cond.peel.i2372 to i64
  %sub.ptr.rhs.cast.peel.i2374 = ptrtoint ptr %97 to i64
  ...
  %99 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..peel.i2377 = tail call i32 @llvm.umin.i32(i32 %99, i32 %conv.peel.i2376)
  %sub.peel.i2378 = sub i32 %99, %conv..peel.i2377
  store i32 %sub.peel.i2378, ptr %avail_out.i2882, align 8, !tbaa !24
  %100 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %conv10.peel.i2379 = zext i32 %conv..peel.i2377 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %100, ptr align 1 %97, i64 %conv10.peel.i2379, i1 false)
  %101 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.peel.i2380 = getelementptr inbounds i8, ptr %101, i64 %conv10.peel.i2379
  store ptr %add.ptr.peel.i2380, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr13.peel.i2381 = getelementptr inbounds i8, ptr %97, i64 %conv10.peel.i2379
  %102 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.peel.i2382 = icmp eq ptr %add.ptr13.peel.i2381, %102
...
again.i2400:                                      ; preds = %again.i2400.preheader, %if.then.i2402
  ...
  %107 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..i2394 = tail call i32 @llvm.umin.i32(i32 %107, i32 %conv.i2393)
  %sub.i2395 = sub i32 %107, %conv..i2394
  store i32 %sub.i2395, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv10.i2396 = zext i32 %conv..i2394 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %104, ptr nonnull align 1 %window.i2885, i64 %conv10.i2396, i1 false)
  %108 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.i2397 = getelementptr inbounds i8, ptr %108, i64 %conv10.i2396
  ...
  %109 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.i2399 = icmp eq ptr %add.ptr13.i2398, %109
...
if.end418:                                        ; preds = %while.body404
  ...
  %111 = load i8, ptr %_state.sroa.2191703.63186, align 1, !tbaa !20
  %conv423 = zext i8 %111 to i64
...
while.end431:                                     ; preds = %if.end418, %while.cond400.preheader
  ...
  %inc438 = add nuw i32 %96, 1
  store i32 %inc438, ptr %index, align 4, !tbaa !20
  %idxprom439 = zext i32 %96 to i64
  %arrayidx440 = getelementptr inbounds [19 x i8], ptr @border, i64 0, i64 %idxprom439
  %112 = load i8, ptr %arrayidx440, align 1, !tbaa !20
  %idxprom442 = sext i8 %112 to i64
  ...
  %113 = load i32, ptr %index, align 4, !tbaa !20
  %114 = load i32, ptr %sub, align 8, !tbaa !20
  %shr395 = lshr i32 %114, 10
  %add396 = add nuw nsw i32 %shr395, 4
  %cmp397 = icmp ult i32 %113, %add396
...
while.body454:                                    ; preds = %while.cond449.preheader, %while.body454
  %115 = phi i32 [ %.pr, %while.body454 ], [ %.lcssa2983, %while.cond449.preheader ]
  %inc459 = add nuw nsw i32 %115, 1
  store i32 %inc459, ptr %index, align 4, !tbaa !20
  %idxprom460 = zext i32 %115 to i64
  %arrayidx461 = getelementptr inbounds [19 x i8], ptr @border, i64 0, i64 %idxprom460
  %116 = load i8, ptr %arrayidx461, align 1, !tbaa !20
  %idxprom463 = sext i8 %116 to i64
...
lor.lhs.false479:                                 ; preds = %while.end465
  %117 = load i32, ptr %bb, align 8, !tbaa !20
  %tobool482.not = icmp eq i32 %117, 0
...
sw.bb491:                                         ; preds = %for.cond.sw.bb491_crit_edge, %cleanup.cont
  ...
  %118 = load i32, ptr %sub, align 8, !tbaa !20
  %and499 = and i32 %118, 31
  %add500 = add nuw nsw i32 %and499, 258
  %shr502 = lshr i32 %118, 5
...
while.body507:                                    ; preds = %sw.bb491, %cleanup690
  ...
  %119 = phi i32 [ %190, %cleanup690 ], [ %index497.promoted, %sw.bb491 ]
  %120 = load i32, ptr %bb, align 8, !tbaa !20
  %cmp5143196 = icmp ult i32 %_state.sroa.130.83218, %120
...
if.then519:                                       ; preds = %while.body516
  %121 = shl i32 %_state.sroa.265.93216, 3
  %122 = add i32 %_state.sroa.130.83218, %121
  %123 = zext i32 %_state.sroa.265.93216 to i64
  %uglygep3390.le = getelementptr i8, ptr %_state.sroa.2191703.93217, i64 %123
  store i64 %_state.sroa.561588.93200, ptr %bitb, align 8, !tbaa !14
  store i32 %122, ptr %bitk, align 4, !tbaa !15
  store i32 0, ptr %avail_in, align 8, !tbaa !13
  store ptr %uglygep3390.le, ptr %z, align 8, !tbaa !5
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
  %124 = load ptr, ptr %read, align 8, !tbaa !17
  %cmp.not.peel.i2413 = icmp ugt ptr %124, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2413, label %cond.false.peel.i2414, label %cond.end.peel.i2426

cond.false.peel.i2414:                            ; preds = %if.then519
  %125 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  br label %cond.end.peel.i2426

cond.end.peel.i2426:                              ; preds = %cond.false.peel.i2414, %if.then519
  %cond.peel.i2415 = phi ptr [ %125, %cond.false.peel.i2414 ], [ %_state.sroa.3231780.0, %if.then519 ]
  %sub.ptr.lhs.cast.peel.i2416 = ptrtoint ptr %cond.peel.i2415 to i64
  %sub.ptr.rhs.cast.peel.i2417 = ptrtoint ptr %124 to i64
  ...
  %126 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..peel.i2420 = tail call i32 @llvm.umin.i32(i32 %126, i32 %conv.peel.i2419)
  %sub.peel.i2421 = sub i32 %126, %conv..peel.i2420
  store i32 %sub.peel.i2421, ptr %avail_out.i2882, align 8, !tbaa !24
  %127 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %conv10.peel.i2422 = zext i32 %conv..peel.i2420 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %127, ptr align 1 %124, i64 %conv10.peel.i2422, i1 false)
  %128 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.peel.i2423 = getelementptr inbounds i8, ptr %128, i64 %conv10.peel.i2422
  store ptr %add.ptr.peel.i2423, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr13.peel.i2424 = getelementptr inbounds i8, ptr %124, i64 %conv10.peel.i2422
  %129 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.peel.i2425 = icmp eq ptr %add.ptr13.peel.i2424, %129
...
again.i2443:                                      ; preds = %again.i2443.preheader, %if.then.i2445
  ...
  %134 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..i2437 = tail call i32 @llvm.umin.i32(i32 %134, i32 %conv.i2436)
  %sub.i2438 = sub i32 %134, %conv..i2437
  store i32 %sub.i2438, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv10.i2439 = zext i32 %conv..i2437 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %131, ptr nonnull align 1 %window.i2885, i64 %conv10.i2439, i1 false)
  %135 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.i2440 = getelementptr inbounds i8, ptr %135, i64 %conv10.i2439
  ...
  %136 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.i2442 = icmp eq ptr %add.ptr13.i2441, %136
...
if.end530:                                        ; preds = %while.body516
  ...
  %138 = load i8, ptr %_state.sroa.2191703.103198, align 1, !tbaa !20
  %conv535 = zext i8 %138 to i64
  ...
  %cmp514 = icmp ult i32 %add542, %120
...
while.end543:                                     ; preds = %if.end530, %while.body507
  ...
  %139 = load ptr, ptr %tb, align 8, !tbaa !20
  %idxprom549 = zext i32 %120 to i64
  %arrayidx550 = getelementptr inbounds [17 x i16], ptr @inflate_mask, i64 0, i64 %idxprom549
  %140 = load i16, ptr %arrayidx550, align 2, !tbaa !38
  %conv551 = zext i16 %140 to i64
  %and552 = and i64 %_state.sroa.561588.9.lcssa, %conv551
  %Bits = getelementptr inbounds %struct.inflate_huft_s, ptr %139, i64 %and552, i32 0, i32 0, i32 1
  %141 = load i8, ptr %Bits, align 1, !tbaa !20
  %conv555 = zext i8 %141 to i32
  %base = getelementptr inbounds %struct.inflate_huft_s, ptr %139, i64 %and552, i32 1
  %142 = load i16, ptr %base, align 2, !tbaa !40
  %conv557 = zext i16 %142 to i32
  %cmp558 = icmp ult i16 %142, 16
  br i1 %cmp558, label %if.then560, label %if.else575

if.then560:                                       ; preds = %while.end543
  %sh_prom563 = zext i8 %141 to i64
  %shr564 = lshr i64 %_state.sroa.561588.9.lcssa, %sh_prom563
  %sub567 = sub i32 %_state.sroa.130.9.lcssa, %conv555
  %inc572 = add i32 %119, 1
  store i32 %inc572, ptr %index, align 4, !tbaa !20
  %idxprom573 = zext i32 %119 to i64
...
while.body588.preheader:                          ; preds = %if.else575
  %143 = zext i32 %_state.sroa.130.9.lcssa to i64
  %144 = zext i32 %add585 to i64
  br label %while.body588

while.body588:                                    ; preds = %while.body588.preheader, %if.end602
  %indvars.iv3391 = phi i64 [ %143, %while.body588.preheader ], [ %indvars.iv.next3392, %if.end602 ]
...
if.then591:                                       ; preds = %while.body588
  %145 = zext i32 %_state.sroa.265.10.lcssa to i64
  %146 = shl i32 %_state.sroa.265.10.lcssa, 3
  %147 = add i32 %146, %_state.sroa.130.9.lcssa
  %uglygep3393.le = getelementptr i8, ptr %_state.sroa.2191703.10.lcssa, i64 %145
  store i64 %_state.sroa.561588.103209, ptr %bitb, align 8, !tbaa !14
  store i32 %147, ptr %bitk, align 4, !tbaa !15
  store i32 0, ptr %avail_in, align 8, !tbaa !13
  store ptr %uglygep3393.le, ptr %z, align 8, !tbaa !5
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
  %148 = load ptr, ptr %read, align 8, !tbaa !17
  %cmp.not.peel.i2456 = icmp ugt ptr %148, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2456, label %cond.false.peel.i2457, label %cond.end.peel.i2469

cond.false.peel.i2457:                            ; preds = %if.then591
  %149 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  br label %cond.end.peel.i2469

cond.end.peel.i2469:                              ; preds = %cond.false.peel.i2457, %if.then591
  %cond.peel.i2458 = phi ptr [ %149, %cond.false.peel.i2457 ], [ %_state.sroa.3231780.0, %if.then591 ]
  %sub.ptr.lhs.cast.peel.i2459 = ptrtoint ptr %cond.peel.i2458 to i64
  %sub.ptr.rhs.cast.peel.i2460 = ptrtoint ptr %148 to i64
  ...
  %150 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..peel.i2463 = tail call i32 @llvm.umin.i32(i32 %150, i32 %conv.peel.i2462)
  %sub.peel.i2464 = sub i32 %150, %conv..peel.i2463
  store i32 %sub.peel.i2464, ptr %avail_out.i2882, align 8, !tbaa !24
  %151 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %conv10.peel.i2465 = zext i32 %conv..peel.i2463 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %151, ptr align 1 %148, i64 %conv10.peel.i2465, i1 false)
  %152 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.peel.i2466 = getelementptr inbounds i8, ptr %152, i64 %conv10.peel.i2465
  store ptr %add.ptr.peel.i2466, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr13.peel.i2467 = getelementptr inbounds i8, ptr %148, i64 %conv10.peel.i2465
  %153 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.peel.i2468 = icmp eq ptr %add.ptr13.peel.i2467, %153
...
again.i2486:                                      ; preds = %again.i2486.preheader, %if.then.i2488
  ...
  %158 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..i2480 = tail call i32 @llvm.umin.i32(i32 %158, i32 %conv.i2479)
  %sub.i2481 = sub i32 %158, %conv..i2480
  store i32 %sub.i2481, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv10.i2482 = zext i32 %conv..i2480 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %155, ptr nonnull align 1 %window.i2885, i64 %conv10.i2482, i1 false)
  %159 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.i2483 = getelementptr inbounds i8, ptr %159, i64 %conv10.i2482
  ...
  %160 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.i2485 = icmp eq ptr %add.ptr13.i2484, %160
...
if.end602:                                        ; preds = %while.body588
  ...
  %162 = load i8, ptr %_state.sroa.2191703.113207, align 1, !tbaa !20
  %conv607 = zext i8 %162 to i64
  %shl610 = shl i64 %conv607, %indvars.iv3391
  %or612 = or i64 %shl610, %_state.sroa.561588.103209
  %indvars.iv.next3392 = add nuw nsw i64 %indvars.iv3391, 8
  %cmp586 = icmp ult i64 %indvars.iv.next3392, %144
  br i1 %cmp586, label %while.body588, label %while.end615.loopexit, !llvm.loop !42

while.end615.loopexit:                            ; preds = %if.end602
  %163 = trunc i64 %indvars.iv.next3392 to i32
...
while.end615:                                     ; preds = %while.end615.loopexit, %if.else575
  ...
  %_state.sroa.130.10.lcssa = phi i32 [ %_state.sroa.130.9.lcssa, %if.else575 ], [ %163, %while.end615.loopexit ]
  %_state.sroa.561588.10.lcssa = phi i64 [ %_state.sroa.561588.9.lcssa, %if.else575 ], [ %or612, %while.end615.loopexit ]
  %sh_prom618 = zext i8 %141 to i64
  ...
  %164 = load i16, ptr %arrayidx626, align 2, !tbaa !38
  %conv627 = zext i16 %164 to i32
...
if.then656:                                       ; preds = %lor.lhs.false650, %while.end615
  ...
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
  %165 = load ptr, ptr %read, align 8, !tbaa !17
  %cmp.not.peel.i2499 = icmp ugt ptr %165, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2499, label %cond.false.peel.i2500, label %cond.end.peel.i2512

cond.false.peel.i2500:                            ; preds = %if.then656
  %166 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  br label %cond.end.peel.i2512

cond.end.peel.i2512:                              ; preds = %cond.false.peel.i2500, %if.then656
  %cond.peel.i2501 = phi ptr [ %166, %cond.false.peel.i2500 ], [ %_state.sroa.3231780.0, %if.then656 ]
  %sub.ptr.lhs.cast.peel.i2502 = ptrtoint ptr %cond.peel.i2501 to i64
  %sub.ptr.rhs.cast.peel.i2503 = ptrtoint ptr %165 to i64
  ...
  %167 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..peel.i2506 = tail call i32 @llvm.umin.i32(i32 %167, i32 %conv.peel.i2505)
  %sub.peel.i2507 = sub i32 %167, %conv..peel.i2506
  store i32 %sub.peel.i2507, ptr %avail_out.i2882, align 8, !tbaa !24
  %168 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %conv10.peel.i2508 = zext i32 %conv..peel.i2506 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %168, ptr align 1 %165, i64 %conv10.peel.i2508, i1 false)
  %169 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.peel.i2509 = getelementptr inbounds i8, ptr %169, i64 %conv10.peel.i2508
  store ptr %add.ptr.peel.i2509, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr13.peel.i2510 = getelementptr inbounds i8, ptr %165, i64 %conv10.peel.i2508
  %170 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.peel.i2511 = icmp eq ptr %add.ptr13.peel.i2510, %170
...
again.i2529:                                      ; preds = %again.i2529.preheader, %if.then.i2531
  ...
  %175 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..i2523 = tail call i32 @llvm.umin.i32(i32 %175, i32 %conv.i2522)
  %sub.i2524 = sub i32 %175, %conv..i2523
  store i32 %sub.i2524, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv10.i2525 = zext i32 %conv..i2523 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %172, ptr nonnull align 1 %window.i2885, i64 %conv10.i2525, i1 false)
  %176 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.i2526 = getelementptr inbounds i8, ptr %176, i64 %conv10.i2525
  ...
  %177 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.i2528 = icmp eq ptr %add.ptr13.i2527, %177
...
cond.true671:                                     ; preds = %if.end668
  ...
  %179 = load i32, ptr %arrayidx676, align 4, !tbaa !20
  br label %cond.end678

cond.end678:                                      ; preds = %if.end668, %cond.true671
  %cond679 = phi i32 [ %179, %cond.true671 ], [ 0, %if.end668 ]
...
vector.scevcheck:                                 ; preds = %cond.end678
  %180 = add nsw i32 %j.0, -1
  %181 = add nuw nsw i32 %180, %and628
  %182 = xor i32 %119, -1
  %183 = icmp ugt i32 %181, %182
  br i1 %183, label %do.body.preheader, label %vector.ph

vector.ph:                                        ; preds = %vector.scevcheck
  %n.vec = and i32 %add629, -8
  %ind.end = add i32 %119, %n.vec
  %ind.end3723 = and i32 %add629, 7
  %broadcast.splatinsert = insertelement <4 x i32> poison, i32 %cond679, i64 0
  %broadcast.splat = shufflevector <4 x i32> %broadcast.splatinsert, <4 x i32> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert3726 = insertelement <4 x i32> poison, i32 %cond679, i64 0
  %broadcast.splat3727 = shufflevector <4 x i32> %broadcast.splatinsert3726, <4 x i32> poison, <4 x i32> zeroinitializer
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index3725 = phi i32 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %offset.idx = add i32 %119, %index3725
  %184 = zext i32 %offset.idx to i64
  %185 = getelementptr inbounds %struct.nsis_z_stream_s, ptr %z, i64 0, i32 5, i32 1, i32 0, i32 2, i64 %184
  store <4 x i32> %broadcast.splat, ptr %185, align 4, !tbaa !20
  %186 = getelementptr inbounds i32, ptr %185, i64 4
  store <4 x i32> %broadcast.splat3727, ptr %186, align 4, !tbaa !20
  %index.next = add nuw i32 %index3725, 8
  %187 = icmp eq i32 %index.next, %n.vec
  br i1 %187, label %middle.block, label %vector.body, !llvm.loop !43
...
do.body.preheader:                                ; preds = %vector.scevcheck, %cond.end678, %middle.block
  %i.1.ph = phi i32 [ %119, %vector.scevcheck ], [ %119, %cond.end678 ], [ %ind.end, %middle.block ]
  %j.1.ph = phi i32 [ %add629, %vector.scevcheck ], [ %add629, %cond.end678 ], [ %ind.end3723, %middle.block ]
  %188 = add nsw i32 %j.1.ph, -1
...
do.body.prol.loopexit:                            ; preds = %do.body.prol, %do.body.preheader
  ...
  br i1 %189, label %do.end, label %do.body
...
cleanup690:                                       ; preds = %if.then560, %do.end
  %190 = phi i32 [ %inc572, %if.then560 ], [ %inc682.lcssa, %do.end ]
  ...
  %cmp505 = icmp ult i32 %190, %add504
...
while.end696:                                     ; preds = %cleanup690, %sw.bb491
  ...
  %191 = load i32, ptr %bl, align 4, !tbaa !29
  %cmp717 = icmp ne i32 %191, 0
...
lor.lhs.false739:                                 ; preds = %if.end735
  %192 = load i32, ptr %bd, align 4, !tbaa !29
  %cmp740 = icmp eq i32 %192, 0
  %cmp743 = icmp ne i32 %and499, 0
  %or.cond1517 = select i1 %cmp740, i1 %cmp743, i1 false
...
if.then745:                                       ; preds = %while.end696, %lor.lhs.false739, %if.end735
  ...
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
  %193 = load ptr, ptr %read, align 8, !tbaa !17
  %cmp.not.peel.i2542 = icmp ugt ptr %193, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2542, label %cond.false.peel.i2543, label %cond.end.peel.i2555

cond.false.peel.i2543:                            ; preds = %if.then745
  %194 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  br label %cond.end.peel.i2555

cond.end.peel.i2555:                              ; preds = %cond.false.peel.i2543, %if.then745
  %cond.peel.i2544 = phi ptr [ %194, %cond.false.peel.i2543 ], [ %_state.sroa.3231780.0, %if.then745 ]
  %sub.ptr.lhs.cast.peel.i2545 = ptrtoint ptr %cond.peel.i2544 to i64
  %sub.ptr.rhs.cast.peel.i2546 = ptrtoint ptr %193 to i64
  ...
  %195 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..peel.i2549 = tail call i32 @llvm.umin.i32(i32 %195, i32 %conv.peel.i2548)
  %sub.peel.i2550 = sub i32 %195, %conv..peel.i2549
  store i32 %sub.peel.i2550, ptr %avail_out.i2882, align 8, !tbaa !24
  %196 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %conv10.peel.i2551 = zext i32 %conv..peel.i2549 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %196, ptr align 1 %193, i64 %conv10.peel.i2551, i1 false)
  %197 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.peel.i2552 = getelementptr inbounds i8, ptr %197, i64 %conv10.peel.i2551
  store ptr %add.ptr.peel.i2552, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr13.peel.i2553 = getelementptr inbounds i8, ptr %193, i64 %conv10.peel.i2551
  %198 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.peel.i2554 = icmp eq ptr %add.ptr13.peel.i2553, %198
...
again.i2572:                                      ; preds = %again.i2572.preheader, %if.then.i2574
  ...
  %203 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..i2566 = tail call i32 @llvm.umin.i32(i32 %203, i32 %conv.i2565)
  %sub.i2567 = sub i32 %203, %conv..i2566
  store i32 %sub.i2567, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv10.i2568 = zext i32 %conv..i2566 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %200, ptr nonnull align 1 %window.i2885, i64 %conv10.i2568, i1 false)
  %204 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.i2569 = getelementptr inbounds i8, ptr %204, i64 %conv10.i2568
  ...
  %205 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.i2571 = icmp eq ptr %add.ptr13.i2570, %205
...
cleanup.cont780:                                  ; preds = %lor.lhs.false739
  %conv758 = trunc i32 %191 to i8
  store i8 %conv758, ptr %lbits761, align 8, !tbaa !20
  %conv762 = trunc i32 %192 to i8
  store i8 %conv762, ptr %dbits952, align 1, !tbaa !20
  %207 = load ptr, ptr %tl, align 8, !tbaa !32
  store ptr %207, ptr %ltree768, align 8, !tbaa !20
  %208 = load ptr, ptr %td, align 8, !tbaa !32
  store ptr %208, ptr %dtree956, align 8, !tbaa !20
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %td) #5
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %tl) #5
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %bd) #5
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %bl) #5
...
sw.bb782:                                         ; preds = %for.cond.sw.bb782_crit_edge, %cleanup.cont780
  %209 = phi ptr [ %.pre3413, %for.cond.sw.bb782_crit_edge ], [ %207, %cleanup.cont780 ]
  %210 = phi i8 [ %.pre3412, %for.cond.sw.bb782_crit_edge ], [ %conv758, %cleanup.cont780 ]
...
sw.bb789:                                         ; preds = %for.cond.sw.bb789_crit_edge, %sw.bb782
  ...
  %cmp7963226 = icmp ult i32 %_state.sroa.130.14, %211
...
if.then801:                                       ; preds = %while.body798
  %212 = shl i32 %_state.sroa.265.15, 3
  %213 = add i32 %_state.sroa.130.14, %212
  %214 = zext i32 %_state.sroa.265.15 to i64
  %uglygep3395.le = getelementptr i8, ptr %_state.sroa.2191703.15, i64 %214
  store i64 %_state.sroa.561588.153230, ptr %bitb, align 8, !tbaa !14
  store i32 %213, ptr %bitk, align 4, !tbaa !15
  store i32 0, ptr %avail_in, align 8, !tbaa !13
  store ptr %uglygep3395.le, ptr %z, align 8, !tbaa !5
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
  %215 = load ptr, ptr %read, align 8, !tbaa !17
  %cmp.not.peel.i2585 = icmp ugt ptr %215, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2585, label %cond.false.peel.i2586, label %cond.end.peel.i2598

cond.false.peel.i2586:                            ; preds = %if.then801
  %216 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  br label %cond.end.peel.i2598

cond.end.peel.i2598:                              ; preds = %cond.false.peel.i2586, %if.then801
  %cond.peel.i2587 = phi ptr [ %216, %cond.false.peel.i2586 ], [ %_state.sroa.3231780.0, %if.then801 ]
  %sub.ptr.lhs.cast.peel.i2588 = ptrtoint ptr %cond.peel.i2587 to i64
  %sub.ptr.rhs.cast.peel.i2589 = ptrtoint ptr %215 to i64
  ...
  %217 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..peel.i2592 = tail call i32 @llvm.umin.i32(i32 %217, i32 %conv.peel.i2591)
  %sub.peel.i2593 = sub i32 %217, %conv..peel.i2592
  store i32 %sub.peel.i2593, ptr %avail_out.i2882, align 8, !tbaa !24
  %218 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %conv10.peel.i2594 = zext i32 %conv..peel.i2592 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %218, ptr align 1 %215, i64 %conv10.peel.i2594, i1 false)
  %219 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.peel.i2595 = getelementptr inbounds i8, ptr %219, i64 %conv10.peel.i2594
  store ptr %add.ptr.peel.i2595, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr13.peel.i2596 = getelementptr inbounds i8, ptr %215, i64 %conv10.peel.i2594
  %220 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.peel.i2597 = icmp eq ptr %add.ptr13.peel.i2596, %220
...
again.i2615:                                      ; preds = %again.i2615.preheader, %if.then.i2617
  ...
  %225 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..i2609 = tail call i32 @llvm.umin.i32(i32 %225, i32 %conv.i2608)
  %sub.i2610 = sub i32 %225, %conv..i2609
  store i32 %sub.i2610, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv10.i2611 = zext i32 %conv..i2609 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %222, ptr nonnull align 1 %window.i2885, i64 %conv10.i2611, i1 false)
  %226 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.i2612 = getelementptr inbounds i8, ptr %226, i64 %conv10.i2611
  ...
  %227 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.i2614 = icmp eq ptr %add.ptr13.i2613, %227
...
if.end812:                                        ; preds = %while.body798
  ...
  %229 = load i8, ptr %_state.sroa.2191703.163228, align 1, !tbaa !20
  %conv817 = zext i8 %229 to i64
  ...
  %cmp796 = icmp ult i32 %add824, %211
...
while.end825:                                     ; preds = %if.end812, %sw.bb789
  ...
  %230 = load ptr, ptr %sub1416, align 8, !tbaa !20
  %idxprom831 = zext i32 %211 to i64
  %arrayidx832 = getelementptr inbounds [17 x i16], ptr @inflate_mask, i64 0, i64 %idxprom831
  %231 = load i16, ptr %arrayidx832, align 2, !tbaa !38
  %conv833 = zext i16 %231 to i64
  %and834 = and i64 %_state.sroa.561588.15.lcssa, %conv833
  %add.ptr836 = getelementptr inbounds %struct.inflate_huft_s, ptr %230, i64 %and834
  %Bits840 = getelementptr inbounds %struct.anon.1, ptr %add.ptr836, i64 0, i32 1
  %232 = load i8, ptr %Bits840, align 1, !tbaa !20
  %conv841 = zext i8 %232 to i32
  %sh_prom843 = zext i8 %232 to i64
  %shr844 = lshr i64 %_state.sroa.561588.15.lcssa, %sh_prom843
  %sub850 = sub i32 %_state.sroa.130.15.lcssa, %conv841
  %233 = load i8, ptr %add.ptr836, align 2, !tbaa !20
  %conv853 = zext i8 %233 to i32
  %cmp855 = icmp eq i8 %233, 0
  br i1 %cmp855, label %if.then857, label %if.end863

if.then857:                                       ; preds = %while.end825
  %base859 = getelementptr inbounds %struct.inflate_huft_s, ptr %230, i64 %and834, i32 1
  %234 = load i16, ptr %base859, align 2, !tbaa !40
  %conv860 = zext i16 %234 to i32
...
if.then867:                                       ; preds = %if.end863
  ...
  %base872 = getelementptr inbounds %struct.inflate_huft_s, ptr %230, i64 %and834, i32 1
  %235 = load i16, ptr %base872, align 2, !tbaa !40
  %conv873 = zext i16 %235 to i32
...
if.then880:                                       ; preds = %if.end875
  ...
  %base886 = getelementptr inbounds %struct.inflate_huft_s, ptr %230, i64 %and834, i32 1
  %236 = load i16, ptr %base886, align 2, !tbaa !40
  %idx.ext888 = zext i16 %236 to i64
...
sw.bb899:                                         ; preds = %for.cond
  %237 = load i32, ptr %sub1416, align 8, !tbaa !20
  %cmp9063146 = icmp ult i32 %_state.sroa.130.0, %237
...
if.then911:                                       ; preds = %while.body908
  %238 = shl i32 %_state.sroa.265.0, 3
  %239 = add i32 %_state.sroa.130.0, %238
  %240 = zext i32 %_state.sroa.265.0 to i64
  %uglygep3387.le = getelementptr i8, ptr %_state.sroa.2191703.0, i64 %240
  store i64 %_state.sroa.561588.163150, ptr %bitb, align 8, !tbaa !14
  store i32 %239, ptr %bitk, align 4, !tbaa !15
  store i32 0, ptr %avail_in, align 8, !tbaa !13
  store ptr %uglygep3387.le, ptr %z, align 8, !tbaa !5
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
  %241 = load ptr, ptr %read, align 8, !tbaa !17
  %cmp.not.peel.i2628 = icmp ugt ptr %241, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2628, label %cond.false.peel.i2629, label %cond.end.peel.i2641

cond.false.peel.i2629:                            ; preds = %if.then911
  %242 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  br label %cond.end.peel.i2641

cond.end.peel.i2641:                              ; preds = %cond.false.peel.i2629, %if.then911
  %cond.peel.i2630 = phi ptr [ %242, %cond.false.peel.i2629 ], [ %_state.sroa.3231780.0, %if.then911 ]
  %sub.ptr.lhs.cast.peel.i2631 = ptrtoint ptr %cond.peel.i2630 to i64
  %sub.ptr.rhs.cast.peel.i2632 = ptrtoint ptr %241 to i64
  ...
  %243 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..peel.i2635 = tail call i32 @llvm.umin.i32(i32 %243, i32 %conv.peel.i2634)
  %sub.peel.i2636 = sub i32 %243, %conv..peel.i2635
  store i32 %sub.peel.i2636, ptr %avail_out.i2882, align 8, !tbaa !24
  %244 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %conv10.peel.i2637 = zext i32 %conv..peel.i2635 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %244, ptr align 1 %241, i64 %conv10.peel.i2637, i1 false)
  %245 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.peel.i2638 = getelementptr inbounds i8, ptr %245, i64 %conv10.peel.i2637
  store ptr %add.ptr.peel.i2638, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr13.peel.i2639 = getelementptr inbounds i8, ptr %241, i64 %conv10.peel.i2637
  %246 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.peel.i2640 = icmp eq ptr %add.ptr13.peel.i2639, %246
...
again.i2658:                                      ; preds = %again.i2658.preheader, %if.then.i2660
  ...
  %251 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..i2652 = tail call i32 @llvm.umin.i32(i32 %251, i32 %conv.i2651)
  %sub.i2653 = sub i32 %251, %conv..i2652
  store i32 %sub.i2653, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv10.i2654 = zext i32 %conv..i2652 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %248, ptr nonnull align 1 %window.i2885, i64 %conv10.i2654, i1 false)
  %252 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.i2655 = getelementptr inbounds i8, ptr %252, i64 %conv10.i2654
  ...
  %253 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.i2657 = icmp eq ptr %add.ptr13.i2656, %253
...
if.end922:                                        ; preds = %while.body908
  ...
  %255 = load i8, ptr %_state.sroa.2191703.173148, align 1, !tbaa !20
  %conv927 = zext i8 %255 to i64
  ...
  %cmp906 = icmp ult i32 %add934, %237
...
while.end935:                                     ; preds = %if.end922, %sw.bb899
  ...
  %idxprom939 = zext i32 %237 to i64
  %arrayidx940 = getelementptr inbounds [17 x i16], ptr @inflate_mask, i64 0, i64 %idxprom939
  %256 = load i16, ptr %arrayidx940, align 2, !tbaa !38
  %conv941 = zext i16 %256 to i32
  %and942 = and i32 %conv941, %conv937
  %257 = load i32, ptr %sub, align 8, !tbaa !51
  %add944 = add i32 %and942, %257
  store i32 %add944, ptr %sub, align 8, !tbaa !51
  %shr948 = lshr i64 %_state.sroa.561588.16.lcssa, %idxprom939
  %sub951 = sub i32 %_state.sroa.130.16.lcssa, %237
  %258 = load i8, ptr %dbits952, align 1, !tbaa !53
  %conv953 = zext i8 %258 to i32
  store i32 %conv953, ptr %need955, align 8, !tbaa !20
  %259 = load ptr, ptr %dtree956, align 8, !tbaa !54
  store ptr %259, ptr %sub1416, align 8, !tbaa !20
  store i32 3, ptr %blocks, align 8, !tbaa !19
  br label %sw.bb960

sw.bb960:                                         ; preds = %for.cond.sw.bb960_crit_edge, %while.end935
  %260 = phi i32 [ %.pre3408, %for.cond.sw.bb960_crit_edge ], [ %conv953, %while.end935 ]
  ...
  %cmp9673155 = icmp ult i32 %_state.sroa.130.17, %260
...
if.then972:                                       ; preds = %while.body969
  %261 = shl i32 %_state.sroa.265.18, 3
  %262 = add i32 %_state.sroa.130.17, %261
  %263 = zext i32 %_state.sroa.265.18 to i64
  %uglygep3388.le = getelementptr i8, ptr %_state.sroa.2191703.18, i64 %263
  store i64 %_state.sroa.561588.183159, ptr %bitb, align 8, !tbaa !14
  store i32 %262, ptr %bitk, align 4, !tbaa !15
  store i32 0, ptr %avail_in, align 8, !tbaa !13
  store ptr %uglygep3388.le, ptr %z, align 8, !tbaa !5
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
  %264 = load ptr, ptr %read, align 8, !tbaa !17
  %cmp.not.peel.i2671 = icmp ugt ptr %264, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2671, label %cond.false.peel.i2672, label %cond.end.peel.i2684

cond.false.peel.i2672:                            ; preds = %if.then972
  %265 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  br label %cond.end.peel.i2684

cond.end.peel.i2684:                              ; preds = %cond.false.peel.i2672, %if.then972
  %cond.peel.i2673 = phi ptr [ %265, %cond.false.peel.i2672 ], [ %_state.sroa.3231780.0, %if.then972 ]
  %sub.ptr.lhs.cast.peel.i2674 = ptrtoint ptr %cond.peel.i2673 to i64
  %sub.ptr.rhs.cast.peel.i2675 = ptrtoint ptr %264 to i64
  ...
  %266 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..peel.i2678 = tail call i32 @llvm.umin.i32(i32 %266, i32 %conv.peel.i2677)
  %sub.peel.i2679 = sub i32 %266, %conv..peel.i2678
  store i32 %sub.peel.i2679, ptr %avail_out.i2882, align 8, !tbaa !24
  %267 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %conv10.peel.i2680 = zext i32 %conv..peel.i2678 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %267, ptr align 1 %264, i64 %conv10.peel.i2680, i1 false)
  %268 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.peel.i2681 = getelementptr inbounds i8, ptr %268, i64 %conv10.peel.i2680
  store ptr %add.ptr.peel.i2681, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr13.peel.i2682 = getelementptr inbounds i8, ptr %264, i64 %conv10.peel.i2680
  %269 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.peel.i2683 = icmp eq ptr %add.ptr13.peel.i2682, %269
...
again.i2701:                                      ; preds = %again.i2701.preheader, %if.then.i2703
  ...
  %274 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..i2695 = tail call i32 @llvm.umin.i32(i32 %274, i32 %conv.i2694)
  %sub.i2696 = sub i32 %274, %conv..i2695
  store i32 %sub.i2696, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv10.i2697 = zext i32 %conv..i2695 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %271, ptr nonnull align 1 %window.i2885, i64 %conv10.i2697, i1 false)
  %275 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.i2698 = getelementptr inbounds i8, ptr %275, i64 %conv10.i2697
  ...
  %276 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.i2700 = icmp eq ptr %add.ptr13.i2699, %276
...
if.end983:                                        ; preds = %while.body969
  ...
  %278 = load i8, ptr %_state.sroa.2191703.193157, align 1, !tbaa !20
  %conv988 = zext i8 %278 to i64
  ...
  %cmp967 = icmp ult i32 %add995, %260
...
while.end996:                                     ; preds = %if.end983, %sw.bb960
  ...
  %279 = load ptr, ptr %sub1416, align 8, !tbaa !20
  %idxprom1002 = zext i32 %260 to i64
  %arrayidx1003 = getelementptr inbounds [17 x i16], ptr @inflate_mask, i64 0, i64 %idxprom1002
  %280 = load i16, ptr %arrayidx1003, align 2, !tbaa !38
  %conv1004 = zext i16 %280 to i64
  %and1005 = and i64 %_state.sroa.561588.18.lcssa, %conv1004
  %add.ptr1007 = getelementptr inbounds %struct.inflate_huft_s, ptr %279, i64 %and1005
  %Bits1011 = getelementptr inbounds %struct.anon.1, ptr %add.ptr1007, i64 0, i32 1
  %281 = load i8, ptr %Bits1011, align 1, !tbaa !20
  %conv1012 = zext i8 %281 to i32
  %sh_prom1014 = zext i8 %281 to i64
  %shr1015 = lshr i64 %_state.sroa.561588.18.lcssa, %sh_prom1014
  %sub1021 = sub i32 %_state.sroa.130.18.lcssa, %conv1012
  %282 = load i8, ptr %add.ptr1007, align 2, !tbaa !20
  %conv1025 = zext i8 %282 to i32
...
if.then1030:                                      ; preds = %while.end996
  ...
  %base1036 = getelementptr inbounds %struct.inflate_huft_s, ptr %279, i64 %and1005, i32 1
  %283 = load i16, ptr %base1036, align 2, !tbaa !40
  %conv1037 = zext i16 %283 to i32
...
if.then1045:                                      ; preds = %if.end1040
  ...
  %base1051 = getelementptr inbounds %struct.inflate_huft_s, ptr %279, i64 %and1005, i32 1
  %284 = load i16, ptr %base1051, align 2, !tbaa !40
  %idx.ext1053 = zext i16 %284 to i64
...
sw.bb1058:                                        ; preds = %for.cond
  %285 = load i32, ptr %sub1416, align 8, !tbaa !20
  %cmp10653132 = icmp ult i32 %_state.sroa.130.0, %285
...
if.then1070:                                      ; preds = %while.body1067
  %286 = shl i32 %_state.sroa.265.0, 3
  %287 = add i32 %_state.sroa.130.0, %286
  %288 = zext i32 %_state.sroa.265.0 to i64
  %uglygep.le = getelementptr i8, ptr %_state.sroa.2191703.0, i64 %288
  store i64 %_state.sroa.561588.193136, ptr %bitb, align 8, !tbaa !14
  store i32 %287, ptr %bitk, align 4, !tbaa !15
  store i32 0, ptr %avail_in, align 8, !tbaa !13
  store ptr %uglygep.le, ptr %z, align 8, !tbaa !5
  store ptr %_state.sroa.3231780.0, ptr %write, align 8, !tbaa !16
  %289 = load ptr, ptr %read, align 8, !tbaa !17
  %cmp.not.peel.i2714 = icmp ugt ptr %289, %_state.sroa.3231780.0
  br i1 %cmp.not.peel.i2714, label %cond.false.peel.i2715, label %cond.end.peel.i2727

cond.false.peel.i2715:                            ; preds = %if.then1070
  %290 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  br label %cond.end.peel.i2727

cond.end.peel.i2727:                              ; preds = %cond.false.peel.i2715, %if.then1070
  %cond.peel.i2716 = phi ptr [ %290, %cond.false.peel.i2715 ], [ %_state.sroa.3231780.0, %if.then1070 ]
  %sub.ptr.lhs.cast.peel.i2717 = ptrtoint ptr %cond.peel.i2716 to i64
  %sub.ptr.rhs.cast.peel.i2718 = ptrtoint ptr %289 to i64
  ...
  %291 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..peel.i2721 = tail call i32 @llvm.umin.i32(i32 %291, i32 %conv.peel.i2720)
  %sub.peel.i2722 = sub i32 %291, %conv..peel.i2721
  store i32 %sub.peel.i2722, ptr %avail_out.i2882, align 8, !tbaa !24
  %292 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %conv10.peel.i2723 = zext i32 %conv..peel.i2721 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %292, ptr align 1 %289, i64 %conv10.peel.i2723, i1 false)
  %293 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.peel.i2724 = getelementptr inbounds i8, ptr %293, i64 %conv10.peel.i2723
  store ptr %add.ptr.peel.i2724, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr13.peel.i2725 = getelementptr inbounds i8, ptr %289, i64 %conv10.peel.i2723
  %294 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.peel.i2726 = icmp eq ptr %add.ptr13.peel.i2725, %294
...
again.i2744:                                      ; preds = %again.i2744.preheader, %if.then.i2746
  ...
  %299 = load i32, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv..i2738 = tail call i32 @llvm.umin.i32(i32 %299, i32 %conv.i2737)
  %sub.i2739 = sub i32 %299, %conv..i2738
  store i32 %sub.i2739, ptr %avail_out.i2882, align 8, !tbaa !24
  %conv10.i2740 = zext i32 %conv..i2738 to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %296, ptr nonnull align 1 %window.i2885, i64 %conv10.i2740, i1 false)
  %300 = load ptr, ptr %next_out.i2883, align 8, !tbaa !25
  %add.ptr.i2741 = getelementptr inbounds i8, ptr %300, i64 %conv10.i2740
  ...
  %301 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  %cmp15.i2743 = icmp eq ptr %add.ptr13.i2742, %301
...
if.end1081:                                       ; preds = %while.body1067
  ...
  %303 = load i8, ptr %_state.sroa.2191703.203134, align 1, !tbaa !20
  %conv1086 = zext i8 %303 to i64
  ...
  %cmp1065 = icmp ult i32 %add1093, %285
...
sw.bb1113:                                        ; preds = %for.cond.sw.bb1113_crit_edge, %while.end1094
  ...
  %cmp1123 = icmp ugt i32 %306, %conv1120
  br i1 %cmp1123, label %cond.true1125, label %cond.end1145

cond.true1125:                                    ; preds = %sw.bb1113
  %307 = load ptr, ptr %end14.i2884, align 8, !tbaa !18
  br label %cond.end1145

cond.end1145:                                     ; preds = %sw.bb1113, %cond.true1125
  %.sink = phi i64 [ %sub.ptr.sub1119, %cond.true1125 ], [ 0, %sw.bb1113 ]
  %_state.sroa.3231780.0.sink = phi ptr [ %307, %cond.true1125 ], [ %_state.sroa.3231780.0, %sw.bb1113 ]
  %.pr2946 = load i32, ptr %sub, align 8, !tbaa !51
...
while.body1151.preheader:                         ; preds = %cond.end1145
  %idx.ext1142 = zext i32 %306 to i64
...
if.then.peel.i2772:                               ; preds = %if.then1195
  ...
  %cmp19.peel.i2771 = icmp eq ptr %314, %add.ptr13.peel.i2768
...
again.i2787.preheader:                            ; preds = %if.then.peel.i2772, %again.i2787.sink.split
  ...
  %.ph3833 = phi ptr [ %window.i2885, %again.i2787.sink.split ], [ %314, %if.then.peel.i2772 ]
  br label %again.i2787

again.i2787:                                      ; preds = %again.i2787.preheader, %if.then.i2789
  %315 = phi ptr [ %add.ptr.i2784, %if.then.i2789 ], [ %.ph3831, %again.i2787.preheader ]
  %316 = phi ptr [ %add.ptr13.i2785, %if.then.i2789 ], [ %.ph3832, %again.i2787.preheader ]
  %317 = phi ptr [ %321, %if.then.i2789 ], [ %.ph3833, %again.i2787.preheader ]
...
if.then.i2789:                                    ; preds = %again.i2787
  ...
  %cmp19.i2788 = icmp eq ptr %321, %add.ptr13.i2785
...
if.then.peel.i2815:                               ; preds = %if.then1260
  ...
  %cmp19.peel.i2814 = icmp eq ptr %329, %add.ptr13.peel.i2811
...
again.i2830.preheader:                            ; preds = %if.then.peel.i2815, %again.i2830.sink.split
  ...
  %.ph3828 = phi ptr [ %window.i2885, %again.i2830.sink.split ], [ %329, %if.then.peel.i2815 ]
  br label %again.i2830

again.i2830:                                      ; preds = %again.i2830.preheader, %if.then.i2832
  %330 = phi ptr [ %add.ptr.i2827, %if.then.i2832 ], [ %.ph3826, %again.i2830.preheader ]
  %331 = phi ptr [ %add.ptr13.i2828, %if.then.i2832 ], [ %.ph3827, %again.i2830.preheader ]
  %332 = phi ptr [ %336, %if.then.i2832 ], [ %.ph3828, %again.i2830.preheader ]
...
if.then.i2832:                                    ; preds = %again.i2830
  ...
  %cmp19.i2831 = icmp eq ptr %336, %add.ptr13.i2828
...
again.i2873.preheader:                            ; preds = %if.then.peel.i2858, %again.i2873.sink.split
  ...
  %.ph3837 = phi ptr [ %window.i2885, %again.i2873.sink.split ], [ %346, %if.then.peel.i2858 ]
  br label %again.i2873

again.i2873:                                      ; preds = %again.i2873.preheader, %if.then.i2875
  %347 = phi ptr [ %add.ptr.i2870, %if.then.i2875 ], [ %.ph3835, %again.i2873.preheader ]
  %348 = phi ptr [ %add.ptr13.i2871, %if.then.i2875 ], [ %.ph3836, %again.i2873.preheader ]
  %349 = phi ptr [ %353, %if.then.i2875 ], [ %.ph3837, %again.i2873.preheader ]
...
again.i2916.preheader:                            ; preds = %if.then.peel.i2901, %again.i2916.sink.split
  ...
  %.ph3840 = phi ptr [ %window.i2885, %again.i2916.sink.split ], [ %364, %if.then.peel.i2901 ]
  br label %again.i2916

again.i2916:                                      ; preds = %again.i2916.preheader, %if.then.i2918
  %365 = phi ptr [ %add.ptr.i2913, %if.then.i2918 ], [ %.ph3838, %again.i2916.preheader ]
  %366 = phi ptr [ %add.ptr13.i2914, %if.then.i2918 ], [ %.ph3839, %again.i2916.preheader ]
  %367 = phi ptr [ %371, %if.then.i2918 ], [ %.ph3840, %again.i2916.preheader ]
...
while.body56.preheader:                           ; preds = %if.end46
  ...
  %xtraiter548 = and i32 %dec54403, 3
...
do.body61.preheader.loopexit.unr-lcssa:           ; preds = %while.body56, %while.body56.preheader
  ...
  br i1 %lcmp.mod549.not, label %do.body61.preheader, label %while.body56.epil
...
while.body56.epil:                                ; preds = %do.body61.preheader.loopexit.unr-lcssa, %while.body56.epil
  ...
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter548
...
do.body61:                                        ; preds = %do.cond71.1, %do.body61.preheader.new
  ...
  %niter554 = phi i32 [ 0, %do.body61.preheader.new ], [ %niter554.next.1, %do.cond71.1 ]
...
do.cond71.1:                                      ; preds = %if.then64.1, %do.cond71
  ...
  %niter554.next.1 = add i32 %niter554, 2
  %niter554.ncmp.1 = icmp eq i32 %niter554.next.1, %unroll_iter553
  br i1 %niter554.ncmp.1, label %do.end74.unr-lcssa, label %do.body61, !llvm.loop !63
...
do.end74.unr-lcssa:                               ; preds = %do.cond71.1, %do.body61.preheader
  ...
  %lcmp.mod552.not = icmp eq i32 %xtraiter550, 0
  br i1 %lcmp.mod552.not, label %do.end74, label %do.body61.epil
...
for.body82:                                       ; preds = %for.body82.lr.ph, %for.inc224
  ...
  %tobool87.not527 = icmp eq i32 %63, 0
  br i1 %tobool87.not527, label %for.inc224, label %while.cond89.preheader

while.cond89.preheader:                           ; preds = %for.body82, %cleanup
  %z.1535 = phi i32 [ %z.2.lcssa, %cleanup ], [ %z.0456, %for.body82 ]
  %w.1534 = phi i32 [ %w.4, %cleanup ], [ %w.0455, %for.body82 ]
  %r.sroa.10.1533 = phi i16 [ %r.sroa.10.4, %cleanup ], [ %r.sroa.10.0454, %for.body82 ]
  %q.1532 = phi ptr [ %q.2.lcssa, %cleanup ], [ %q.0453, %for.body82 ]
  %p.5531 = phi ptr [ %p.6, %cleanup ], [ %p.4452, %for.body82 ]
  %i.5530 = phi i32 [ %xor210, %cleanup ], [ %i.4450, %for.body82 ]
  %h.1529 = phi i32 [ %h.4, %cleanup ], [ %h.0449, %for.body82 ]
  %a.0528 = phi i32 [ %dec86536, %cleanup ], [ %63, %for.body82 ]
  %dec86536 = add i32 %a.0528, -1
  %add90416 = add nsw i32 %w.1534, %spec.select377
...
while.body92:                                     ; preds = %while.body92.preheader, %if.end147
  ...
  %w.2421 = phi i32 [ %w.1534, %while.body92.preheader ], [ %add90422, %if.end147 ]
  %r.sroa.10.2420 = phi i16 [ %r.sroa.10.1533, %while.body92.preheader ], [ %r.sroa.10.3, %if.end147 ]
  ...
  %cmp99 = icmp ugt i32 %shl97, %a.0528
...
if.end122:                                        ; preds = %if.end117
  ...
  %72 = and i64 %indvars.iv.next481, 4294967295
  %tobool128.not = icmp eq i64 %72, 0
...
if.then129:                                       ; preds = %if.end122
  ...
  store i32 %i.5530, ptr %arrayidx131, align 4, !tbaa !29
  %conv132 = trunc i32 %j.4 to i8
  %shr = lshr i32 %i.5530, %w.2421
...
if.end147:                                        ; preds = %if.else, %if.then129
  ...
  br i1 %cmp91.not, label %while.body92, label %while.end148.loopexit, !llvm.loop !68

while.end148.loopexit:                            ; preds = %if.end147
  %77 = trunc i64 %indvars.iv.next481 to i32
  br label %while.end148

while.end148:                                     ; preds = %while.end148.loopexit, %while.cond89.preheader.while.end148_crit_edge
  %sub149.pre-phi = phi i32 [ %.pre491, %while.cond89.preheader.while.end148_crit_edge ], [ %sub96, %while.end148.loopexit ]
  %h.2.lcssa = phi i32 [ %h.1529, %while.cond89.preheader.while.end148_crit_edge ], [ %77, %while.end148.loopexit ]
  %q.2.lcssa = phi ptr [ %q.1532, %while.cond89.preheader.while.end148_crit_edge ], [ %add.ptr124, %while.end148.loopexit ]
  %r.sroa.10.2.lcssa = phi i16 [ %r.sroa.10.1533, %while.cond89.preheader.while.end148_crit_edge ], [ %r.sroa.10.3, %while.end148.loopexit ]
  %w.2.lcssa = phi i32 [ %w.1534, %while.cond89.preheader.while.end148_crit_edge ], [ %add90422, %while.end148.loopexit ]
  %z.2.lcssa = phi i32 [ %z.1535, %while.cond89.preheader.while.end148_crit_edge ], [ %shl118, %while.end148.loopexit ]
  %conv150 = trunc i32 %sub149.pre-phi to i8
  %cmp155.not = icmp ult ptr %p.5531, %add.ptr154
  br i1 %cmp155.not, label %if.else160, label %if.end189

if.else160:                                       ; preds = %while.end148
  %78 = load i32, ptr %p.5531, align 4, !tbaa !29
  %cmp161 = icmp ult i32 %78, %s
  br i1 %cmp161, label %if.then163, label %if.else173

if.then163:                                       ; preds = %if.else160
  %cmp164 = icmp ult i32 %78, 256
  %conv167 = select i1 %cmp164, i8 0, i8 96
  %incdec.ptr170 = getelementptr inbounds i32, ptr %p.5531, i64 1
  %conv171 = trunc i32 %78 to i16
  br label %if.end189
...
if.else173:                                       ; preds = %if.else160
  ...
  %79 = load i16, ptr %arrayidx176, align 2, !tbaa !38
  %conv177 = trunc i16 %79 to i8
  %add179 = add i8 %conv177, 80
  %incdec.ptr183 = getelementptr inbounds i32, ptr %p.5531, i64 1
  %arrayidx186 = getelementptr inbounds i16, ptr %d, i64 %idxprom175
  %80 = load i16, ptr %arrayidx186, align 2, !tbaa !38
  br label %if.end189

if.end189:                                        ; preds = %while.end148, %if.then163, %if.else173
  %p.6 = phi ptr [ %incdec.ptr170, %if.then163 ], [ %incdec.ptr183, %if.else173 ], [ %p.5531, %while.end148 ]
  %r.sroa.10.4 = phi i16 [ %conv171, %if.then163 ], [ %80, %if.else173 ], [ %r.sroa.10.2.lcssa, %while.end148 ]
  %r.sroa.0.0 = phi i8 [ %conv167, %if.then163 ], [ %add179, %if.else173 ], [ -64, %while.end148 ]
  %shl191 = shl nuw i32 1, %sub149.pre-phi
  %shr192 = lshr i32 %i.5530, %w.2.lcssa
...
for.body206:                                      ; preds = %for.end201, %for.body206
  ...
  %i.6434 = phi i32 [ %xor, %for.body206 ], [ %i.5530, %for.end201 ]
...
for.end209:                                       ; preds = %for.body206, %for.end201
  %i.6.lcssa = phi i32 [ %i.5530, %for.end201 ], [ %xor, %for.body206 ]
  ...
  %81 = load i32, ptr %arrayidx216442, align 4, !tbaa !29
  %cmp217.not443 = icmp eq i32 %and214440, %81
...
for.end226:                                       ; preds = %for.inc224, %do.end74
  ...
  %84 = and i1 %cmp227, %cmp230
  %cond233 = select i1 %84, i32 -5, i32 0
  br label %cleanup234
