; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/ASCI_Purple/SMG2000/communication.c"
...
while.end:                                        ; preds = %if.end
  %tobool.not = icmp eq i32 %dim.1, 0
  %spec.store.select = select i1 %tobool.not, i32 1, i32 %dim.1
...
for.body5.preheader:                              ; preds = %for.inc45, %for.cond3.preheader.preheader
  %indvars.iv246 = phi i64 [ %2, %for.cond3.preheader.preheader ], [ %indvars.iv.next247, %for.inc45 ]
  br label %for.body5
...
for.inc:                                          ; preds = %if.else, %if.else20, %if.then24, %if.then33
  %exitcond.not = icmp eq i64 %indvars.iv.next, %indvars.iv246
  br i1 %exitcond.not, label %for.inc45, label %for.body5, !llvm.loop !72

for.inc45:                                        ; preds = %for.inc
  %indvars.iv.next247 = add nsw i64 %indvars.iv246, -1
  %cmp = icmp sgt i64 %indvars.iv246, 1
  br i1 %cmp, label %for.body5.preheader, label %for.cond47.preheader, !llvm.loop !73

for.cond47.loopexit:                              ; preds = %for.inc136, %for.end77
...
for.body84.preheader:                             ; preds = %for.inc136, %for.cond82.preheader.preheader
  %indvars.iv255 = phi i64 [ %18, %for.cond82.preheader.preheader ], [ %indvars.iv.next256, %for.inc136 ]
  br label %for.body84

for.body84:                                       ; preds = %for.body84.preheader, %for.inc133
  %indvars.iv252 = phi i64 [ %idxprom51, %for.body84.preheader ], [ %indvars.iv.next253, %for.inc133 ]
...
for.inc133:                                       ; preds = %if.else97, %if.else106, %if.then110, %if.then121
  ...
  br i1 %cmp83, label %for.body84, label %for.inc136, !llvm.loop !76

for.inc136:                                       ; preds = %for.inc133
  %indvars.iv.next256 = add nsw i64 %indvars.iv255, -1
  %cmp80 = icmp sgt i64 %indvars.iv.next256, %idxprom51
  br i1 %cmp80, label %for.body84.preheader, label %for.cond47.loopexit, !llvm.loop !77
