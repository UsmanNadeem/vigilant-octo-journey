...
common.ret106:                                    ; preds = %if.end20, %cnf_RplacVar.exit, %if.then12, %for.body, %if.then
  %common.ret106.op = phi ptr [ %TargetTerm, %if.then ], [ %Formula, %cnf_RplacVar.exit ], [ %TargetTerm, %if.end20 ], [ %TargetTerm, %if.then12 ], [ %TargetTerm, %for.body ]
  ret ptr %common.ret106.op
...
if.end:                                           ; preds = %entry
  ...
  %op.rdx97 = select i1 %op.rdx, i1 true, i1 %cmp.i.not.i72
  %op.rdx98 = select i1 %op.rdx97, i1 true, i1 %cmp.i31.not.i
  %op.rdx99 = select i1 %op.rdx98, i1 true, i1 %cmp.i33.not.i
  %op.rdx100 = select i1 %op.rdx99, i1 true, i1 %cmp.i35.not.i
  %op.rdx101 = select i1 %op.rdx100, i1 true, i1 %cmp.i37.i
  br i1 %op.rdx101, label %if.then12, label %if.end20

if.then12:                                        ; preds = %if.end
  %12 = getelementptr i8, ptr %TargetTerm, i64 16
  %scan.084 = load ptr, ptr %12, align 8
  %cmp.i75.not85 = icmp eq ptr %scan.084, null
  br i1 %cmp.i75.not85, label %common.ret106, label %for.body
...
for.body:                                         ; preds = %if.then12, %for.body
  ...
  br i1 %cmp.i75.not, label %common.ret106, label %for.body, !llvm.loop !27
...
if.end20:                                         ; preds = %if.end
  ...
  br i1 %or.cond, label %if.then26, label %common.ret106
...
while.body.us.i:                                  ; preds = %if.then26, %if.end36.us.i
  %17 = phi i32 [ %26, %if.end36.us.i ], [ %inc.i.i, %if.then26 ]
...
if.end36.us.i:                                    ; preds = %for.inc.us.i, %if.end36.us.i.loopexit, %for.inc.us.thread.i, %if.else.us.i
  %26 = phi i32 [ %dec.i.us.i, %if.else.us.i ], [ %.pre.i.pre, %for.inc.us.thread.i ], [ %25, %if.end36.us.i.loopexit ], [ %dec.i.us.i, %for.inc.us.i ]
  %cmp.not.us.i = icmp eq i32 %16, %26
...
while.body.i:                                     ; preds = %if.then26, %if.end36.i
  %27 = phi i32 [ %vec_MAX.promoted80.i, %if.end36.i ], [ %inc.i.i, %if.then26 ]
  ...
  %28 = load ptr, ptr %arrayidx.i58.i, align 8
  %call2.val50.i = load i32, ptr %28, align 8
  %cmp.i.i = icmp slt i32 %call2.val50.i, 1
  br i1 %cmp.i.i, label %if.else.i, label %if.end36.i

if.else.i:                                        ; preds = %while.body.i
  %29 = getelementptr i8, ptr %28, i64 16
  %call2.val52.i = load ptr, ptr %29, align 8
...
for.body30.i:                                     ; preds = %for.body30.i, %for.body30.preheader.i
  %indvars.iv84.i = phi i64 [ %31, %for.body30.preheader.i ], [ %indvars.iv.next85.i, %for.body30.i ]
  %scan.177.i = phi ptr [ %call2.val52.i, %for.body30.preheader.i ], [ %scan.1.val54.i, %for.body30.i ]
  %32 = getelementptr i8, ptr %scan.177.i, i64 8
  %scan.1.val.i = load ptr, ptr %32, align 8
  %indvars.iv.next85.i = add i64 %indvars.iv84.i, 1
  %33 = trunc i64 %indvars.iv.next85.i to i32
  store i32 %33, ptr @vec_MAX, align 4
...
if.end36.i:                                       ; preds = %if.end36.i.loopexit, %if.else.i, %while.body.i
  %vec_MAX.promoted80.i = phi i32 [ %dec.i.i, %if.else.i ], [ %dec.i.i, %while.body.i ], [ %34, %if.end36.i.loopexit ]
