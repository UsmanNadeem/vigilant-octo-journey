; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/util.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/util.c"
...
entry:
  ...
  %cmp137 = icmp eq i32 %bcmp, 0
  br i1 %cmp137, label %cleanup, label %cond.end299

cond.end299:                                      ; preds = %entry
  %bcmp329 = call i32 @bcmp(ptr noundef nonnull dereferenceable(5) %s, ptr noundef nonnull dereferenceable(5) @.str.9, i64 5)
  %cmp301 = icmp eq i32 %bcmp329, 0
  %. = select i1 %cmp301, i32 2, i32 0
  br label %cleanup

cleanup:                                          ; preds = %cond.end299, %entry
  %retval.0 = phi i32 [ 1, %entry ], [ %., %cond.end299 ]
