; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C++/simul/simulate.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C++/simul/simulate.cpp"
...
define dso_local void @_ZN17screen_controller4moveEii(ptr nocapture noundef nonnull align 4 dereferenceable(8) %this, i32 noundef %row, i32 noundef %col) local_unnamed_addr #3 align 2 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local void @_ZN17screen_controller10lower_leftEv(ptr nocapture noundef nonnull readonly align 4 dereferenceable(8) %this) local_unnamed_addr #3 align 2 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local void @_ZN17screen_controller11upper_rightEv(ptr nocapture noundef nonnull readonly align 4 dereferenceable(8) %this) local_unnamed_addr #3 align 2 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local void @_ZN17screen_controller11lower_rightEv(ptr nocapture noundef nonnull readonly align 4 dereferenceable(8) %this) local_unnamed_addr #3 align 2 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local void @_ZN17screen_controller13draw_verticalEiiic(ptr nocapture noundef nonnull align 4 dereferenceable(8) %this, i32 noundef %row, i32 noundef %col, i32 noundef %length, i8 noundef signext %l_char) local_unnamed_addr #3 align 2 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local void @_ZN17screen_controller15draw_horizontalEiiic(ptr nocapture noundef nonnull align 4 dereferenceable(8) %this, i32 noundef %row, i32 noundef %col, i32 noundef %length, i8 noundef signext %l_char) local_unnamed_addr #3 align 2 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local void @_ZN17screen_controller6centerEiPc(ptr nocapture noundef nonnull readonly align 4 dereferenceable(8) %this, i32 noundef %row, ptr nocapture noundef readonly %text) local_unnamed_addr #3 align 2 {
entry:
  ret void
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define dso_local void @_ZN17screen_controller7drawboxEiiiiii(ptr nocapture noundef nonnull readonly align 4 dereferenceable(8) %this, i32 noundef %hor, i32 noundef %ver, i32 noundef %ul, i32 noundef %ur, i32 noundef %ll, i32 noundef %lr) local_unnamed_addr #3 align 2 {
entry:
  ret void
}

; Function Attrs: nofree norecurse nosync nounwind memory(write, argmem: none, inaccessiblemem: none) uwtable
define dso_local void @_ZN9init_gridC2Ev(ptr nocapture nonnull readnone align 1 %this) unnamed_addr #4 align 2 {
entry:
...
define dso_local void @_ZN15simulation_unit4moveEii(ptr noundef nonnull align 8 dereferenceable(16) %this, i32 noundef %x_steps, i32 noundef %y_steps) local_unnamed_addr #5 align 2 {
entry:
...
define linkonce_odr dso_local void @_ZN10pop_around7displayEv(ptr noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #9 comdat align 2 {
entry:
  ret void
}

; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local void @_ZN10pop_around5eraseEv(ptr noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #9 comdat align 2 {
entry:
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN15simulation_unitD2Ev(ptr noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #10 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN10pop_aroundD0Ev(ptr noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #10 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZN10pop_around5cycleEv(ptr noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #5 comdat align 2 {
entry:
  %x = getelementptr inbounds %class.simulation_unit, ptr %this, i64 0, i32 1
  %0 = load i32, ptr %x, align 8, !tbaa !13
  %cmp = icmp eq i32 %0, 0
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local void @_ZN15simulation_unit7displayEv(ptr noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #9 comdat align 2 {
entry:
  ret void
}

; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local void @_ZN15simulation_unit5eraseEv(ptr noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #9 comdat align 2 {
entry:
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN15simulation_unitD0Ev(ptr noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #10 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
  tail call void @_ZdlPv(ptr noundef nonnull %this) #13
  ret void
}
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local void @_ZN15simulation_unit5cycleEv(ptr noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #9 comdat align 2 {
entry:
  ret void
}
...
attributes #4 = { nofree norecurse nosync nounwind memory(write, argmem: none, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
