; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/hbd/class.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/hbd/class.cpp"
...
sw.bb15:                                          ; preds = %for.end
  ...
  %call24 = tail call ptr @fopen(ptr noundef nonnull %call18, ptr noundef nonnull @.str.3)
...
if.end:                                           ; preds = %sw.bb15
  ...
  %call31 = tail call ptr @fopen(ptr noundef %13, ptr noundef nonnull @.str.5)
...
sw.bb69:                                          ; preds = %for.end68
  ...
  %call71 = tail call ptr @fopen(ptr noundef %27, ptr noundef nonnull @.str.5)
...
sw.bb78:                                          ; preds = %sw.bb69.sw.bb78_crit_edge, %for.end68
  ...
  %call80 = tail call ptr @fopen(ptr noundef %28, ptr noundef nonnull @.str.3)
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %tobool26.not1495 = icmp eq i16 %or.i1138, 0
  br i1 %tobool26.not1495, label %for.end, label %for.body

for.body:                                         ; preds = %if.end, %for.body
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body ], [ 0, %if.end ]
  %i.01497 = phi i16 [ %dec, %for.body ], [ %or.i1138, %if.end ]
  %dec = add i16 %i.01497, -1
...
for.end:                                          ; preds = %for.body, %if.end
  ...
  %tobool45.not1504 = icmp eq i16 %or.i1152, 0
  br i1 %tobool45.not1504, label %for.end109, label %invoke.cont.lr.ph
...
for.cond43.loopexit:                              ; preds = %if.end107, %invoke.cont
  %tobool45.not = icmp eq i16 %dec441506, 0
...
invoke.cont:                                      ; preds = %invoke.cont.lr.ph, %for.cond43.loopexit
  %indvars.iv1601 = phi i64 [ 0, %invoke.cont.lr.ph ], [ %indvars.iv.next1602, %for.cond43.loopexit ]
  %dec441506.in = phi i16 [ %or.i1152, %invoke.cont.lr.ph ], [ %dec441506, %for.cond43.loopexit ]
  %dec441506 = add i16 %dec441506.in, -1
  ...
  %arrayidx51 = getelementptr inbounds ptr, ptr %15, i64 %indvars.iv1601
  ...
  %tobool75.not1501 = icmp eq i32 %conv72, 0
  br i1 %tobool75.not1501, label %for.cond43.loopexit, label %for.body76.lr.ph
...
for.body76:                                       ; preds = %for.body76.lr.ph, %if.end107
  %dec741502.in = phi i32 [ %conv72, %for.body76.lr.ph ], [ %dec741502, %if.end107 ]
  %dec741502 = add nsw i32 %dec741502.in, -1
...
if.else96:                                        ; preds = %for.body76
  ...
  %tobool100.not1498 = icmp eq i64 %or.i1206, 0
  br i1 %tobool100.not1498, label %if.end107, label %for.body102

for.body102:                                      ; preds = %if.else96, %for.body102
  %m.01499 = phi i64 [ %dec99, %for.body102 ], [ %or.i1206, %if.else96 ]
  %dec99 = add nsw i64 %m.01499, -1
...
if.end107:                                        ; preds = %for.body102, %if.else96, %if.else
  %tobool75.not = icmp eq i32 %dec741502, 0
...
for.end109:                                       ; preds = %for.cond43.loopexit, %for.end
  ...
  %call.i1227 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %50, i32 noundef 47) #18
  %cmp136.not = icmp eq ptr %call.i1227, null
  br i1 %cmp136.not, label %if.else178, label %while.body

while.body:                                       ; preds = %for.end109, %while.body
  %tmpstr1.01508 = phi ptr [ %call.i1228, %while.body ], [ %call.i1227, %for.end109 ]
  %add.ptr = getelementptr inbounds i8, ptr %tmpstr1.01508, i64 1
  %call.i1228 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %add.ptr, i32 noundef 47) #18
  %tobool139.not = icmp eq ptr %call.i1228, null
...
while.cond.while.end_crit_edge:                   ; preds = %while.body
  ...
  %sub.ptr.lhs.cast.le = ptrtoint ptr %tmpstr1.01508 to i64
  %sub.ptr.sub.le = sub i64 %sub.ptr.lhs.cast.le, %sub.ptr.rhs.cast
  %add142 = shl i64 %sub.ptr.sub.le, 32
  %sext1595 = add i64 %add142, 4294967296
  %conv143 = ashr exact i64 %sext1595, 32
  ...
  %call.i12321509 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %53, i32 noundef 47) #18
  %cmp175.not1510 = icmp eq ptr %call.i12321509, null
  br i1 %cmp175.not1510, label %if.end189, label %while.body176

while.body176:                                    ; preds = %while.cond.while.end_crit_edge, %while.body176
  %call.i12321511 = phi ptr [ %call.i1232, %while.body176 ], [ %call.i12321509, %while.cond.while.end_crit_edge ]
  %incdec.ptr = getelementptr inbounds i8, ptr %call.i12321511, i64 1
  store i8 46, ptr %call.i12321511, align 1, !tbaa !21
  %call.i1232 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %incdec.ptr, i32 noundef 47) #18
  %cmp175.not = icmp eq ptr %call.i1232, null
...
if.end189:                                        ; preds = %while.body176, %while.cond.while.end_crit_edge, %if.else178
  ...
  %dec1941538 = add i16 %54, -1
  %cmp1961539 = icmp sgt i16 %dec1941538, -1
  br i1 %cmp1961539, label %for.body198.lr.ph, label %for.cond.cleanup197
...
for.cond.cleanup197:                              ; preds = %if.end374, %if.end189
  ...
  %tobool380.not1584 = icmp eq i16 %55, 0
  br i1 %tobool380.not1584, label %for.end840, label %invoke.cont384.lr.ph
...
for.body198:                                      ; preds = %for.body198.lr.ph, %if.end374
  %dec1941541 = phi i16 [ %dec1941538, %for.body198.lr.ph ], [ %dec194, %if.end374 ]
  %numimports.01540 = phi i16 [ 0, %for.body198.lr.ph ], [ %numimports.7, %if.end374 ]
  %56 = load ptr, ptr %constant_pool.i1225, align 8, !tbaa !42
  %idxprom.i1234 = zext i16 %dec1941541 to i64
  %arrayidx.i1235 = getelementptr inbounds %struct.cp_info, ptr %56, i64 %idxprom.i1234
  %tmpcpi.sroa.0.0.copyload = load i8, ptr %arrayidx.i1235, align 8, !tbaa.struct !56
...
if.then203:                                       ; preds = %for.body198
  %57 = getelementptr inbounds %struct.cp_info, ptr %56, i64 %idxprom.i1234, i32 1
...
while.cond211.preheader:                          ; preds = %if.then203
  %call.i12391531 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %60, i32 noundef 47) #18
  %cmp213.not1532 = icmp eq ptr %call.i12391531, null
  br i1 %cmp213.not1532, label %if.end217, label %while.body214
...
while.body214:                                    ; preds = %while.cond211.preheader, %while.body214
  %call.i12391533 = phi ptr [ %call.i1239, %while.body214 ], [ %call.i12391531, %while.cond211.preheader ]
  %incdec.ptr215 = getelementptr inbounds i8, ptr %call.i12391533, i64 1
  store i8 46, ptr %call.i12391533, align 1, !tbaa !21
  %call.i1239 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %incdec.ptr215, i32 noundef 47) #18
  %cmp213.not = icmp eq ptr %call.i1239, null
...
if.end229:                                        ; preds = %if.then225, %land.lhs.true220, %if.end217
  ...
  %cmp233.not = icmp eq i16 %numimports.01540, %63
  br i1 %cmp233.not, label %if.end374, label %land.lhs.true234

land.lhs.true234:                                 ; preds = %if.end229
  %call.i1240 = tail call ptr @strrchr(ptr noundef nonnull dereferenceable(1) %tmpstr.2, i32 noundef 46) #18
  %cmp236.not = icmp eq ptr %call.i1240, null
...
if.then237:                                       ; preds = %land.lhs.true234
  ...
  %inc239 = add i16 %numimports.01540, 1
  %idxprom240 = zext i16 %numimports.01540 to i64
  %arrayidx241 = getelementptr inbounds ptr, ptr %64, i64 %idxprom240
  store ptr %tmpstr.2, ptr %arrayidx241, align 8, !tbaa !17
  %cmp2441534 = icmp ugt i16 %inc239, 1
  br i1 %cmp2441534, label %for.body246.lr.ph, label %cleanup
...
for.cond243:                                      ; preds = %for.body246
  ...
  %cmp244 = icmp sgt i64 %indvars.iv1607, 0
  br i1 %cmp244, label %for.body246, label %cleanup, !llvm.loop !64

for.body246:                                      ; preds = %for.body246.lr.ph, %for.cond243
  %indvars.iv1607 = phi i64 [ %66, %for.body246.lr.ph ], [ %indvars.iv.next1608, %for.cond243 ]
  %arrayidx249 = getelementptr inbounds ptr, ptr %65, i64 %indvars.iv1607
...
cleanup:                                          ; preds = %for.cond243, %for.body246, %if.then237
  %numimports.1 = phi i16 [ %inc239, %if.then237 ], [ %numimports.01540, %for.body246 ], [ %inc239, %for.cond243 ]
  %add.ptr257 = getelementptr inbounds i8, ptr %call.i1240, i64 1
  store ptr %add.ptr257, ptr %59, align 8, !tbaa !17
  br label %if.end374

if.then263:                                       ; preds = %for.body198
  %tmpcpi.sroa.51038.0.call200.sroa_idx = getelementptr inbounds i8, ptr %arrayidx.i1235, i64 8
  ...
  %idxprom.i1242 = zext i16 %68 to i64
  %69 = getelementptr inbounds %struct.cp_info, ptr %56, i64 %idxprom.i1242, i32 1
...
if.end269:                                        ; preds = %if.then268, %if.then263
  ...
  %cmp274.not1524 = icmp eq i8 %71, 0
  br i1 %cmp274.not1524, label %if.end374, label %while.body275

while.body275:                                    ; preds = %if.end269, %if.end371
  %deststr.2.pn = phi ptr [ %deststr.2, %if.end371 ], [ %70, %if.end269 ]
  %numimports.31527 = phi i16 [ %numimports.6, %if.end371 ], [ %numimports.01540, %if.end269 ]
  %srcstr.01525 = phi ptr [ %srcstr.5, %if.end371 ], [ %call266, %if.end269 ]
  %incdec.ptr2711528 = getelementptr inbounds i8, ptr %srcstr.01525, i64 1
  %incdec.ptr2721529 = getelementptr inbounds i8, ptr %deststr.2.pn, i64 1
  %72 = load i8, ptr %srcstr.01525, align 1, !tbaa !21
  %cmp278 = icmp eq i8 %72, 76
  br i1 %cmp278, label %if.then279, label %if.end371

if.then279:                                       ; preds = %while.body275
  %call.i1244 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %incdec.ptr2711528, i32 noundef 59) #18
  %tobool281.not = icmp eq ptr %call.i1244, null
...
if.end283:                                        ; preds = %if.then282, %if.then279
  %call284 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %incdec.ptr2711528, ptr noundef nonnull dereferenceable(11) @.str.10, i64 noundef 10) #14
...
while.cond289.preheader:                          ; preds = %if.end283
  %call.i12451512 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %incdec.ptr2711528, i32 noundef 47) #18
  %cmp2911513 = icmp ne ptr %call.i12451512, null
  %cmp2921514 = icmp ult ptr %call.i12451512, %call.i1244
  %73 = and i1 %cmp2911513, %cmp2921514
  br i1 %73, label %while.body293, label %if.end296

if.then286:                                       ; preds = %if.end283
  %add.ptr287 = getelementptr inbounds i8, ptr %srcstr.01525, i64 11
  br label %if.end296

while.body293:                                    ; preds = %while.cond289.preheader, %while.body293
  %call.i12451515 = phi ptr [ %call.i1245, %while.body293 ], [ %call.i12451512, %while.cond289.preheader ]
  %incdec.ptr294 = getelementptr inbounds i8, ptr %call.i12451515, i64 1
  store i8 46, ptr %call.i12451515, align 1, !tbaa !21
  %call.i1245 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %incdec.ptr294, i32 noundef 47) #18
  %cmp291 = icmp ne ptr %call.i1245, null
  %cmp292 = icmp ult ptr %call.i1245, %call.i1244
...
if.end296:                                        ; preds = %while.body293, %while.cond289.preheader, %if.then286
  %srcstr.1 = phi ptr [ %add.ptr287, %if.then286 ], [ %incdec.ptr2711528, %while.cond289.preheader ], [ %incdec.ptr2711528, %while.body293 ]
...
land.lhs.true299:                                 ; preds = %if.end296
  ...
  %narrow1597 = select i1 %tobool303.not, i32 %add305, i32 0
  %spec.select.idx = sext i32 %narrow1597 to i64
...
if.end308:                                        ; preds = %land.lhs.true299, %if.end296
  ...
  %cmp312.not = icmp eq i16 %numimports.31527, %76
  br i1 %cmp312.not, label %if.end363, label %land.lhs.true313

land.lhs.true313:                                 ; preds = %if.end308
  %call.i1246 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %srcstr.2, i32 noundef 46) #18
  %cmp315.not = icmp ne ptr %call.i1246, null
  %cmp317 = icmp ult ptr %call.i1246, %call.i1244
...
while.body324:                                    ; preds = %land.lhs.true313, %while.body324
  %tmpstr4.01518 = phi ptr [ %call.i1247, %while.body324 ], [ %call.i1246, %land.lhs.true313 ]
  %add.ptr325 = getelementptr inbounds i8, ptr %tmpstr4.01518, i64 1
  %call.i1247 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %add.ptr325, i32 noundef 46) #18
  %cmp320 = icmp ne ptr %call.i1247, null
  %cmp322 = icmp ult ptr %call.i1247, %call.i1244
  %77 = and i1 %cmp320, %cmp322
  br i1 %77, label %while.body324, label %while.end327, !llvm.loop !69

while.end327:                                     ; preds = %while.body324
  %sub.ptr.lhs.cast329 = ptrtoint ptr %call.i1244 to i64
  ...
  %inc337 = add i16 %numimports.31527, 1
  %idxprom338 = zext i16 %numimports.31527 to i64
  ...
  %cmp3501520 = icmp ugt i16 %inc337, 1
  br i1 %cmp3501520, label %for.body351.lr.ph, label %if.end363

for.body351.lr.ph:                                ; preds = %while.end327
...
for.cond349:                                      ; preds = %for.body351
  ...
  %cmp350 = icmp sgt i64 %indvars.iv1604, 0
  br i1 %cmp350, label %for.body351, label %if.end363, !llvm.loop !70

for.body351:                                      ; preds = %for.body351.lr.ph, %for.cond349
  %indvars.iv1604 = phi i64 [ %80, %for.body351.lr.ph ], [ %indvars.iv.next1605, %for.cond349 ]
  %arrayidx354 = getelementptr inbounds ptr, ptr %79, i64 %indvars.iv1604
...
if.end363:                                        ; preds = %for.cond349, %while.end327, %delete.notnull, %land.lhs.true313, %if.end308
  %srcstr.3 = phi ptr [ %srcstr.2, %land.lhs.true313 ], [ %srcstr.2, %if.end308 ], [ %add.ptr325, %delete.notnull ], [ %add.ptr325, %while.end327 ], [ %add.ptr325, %for.cond349 ]
  %numimports.5 = phi i16 [ %numimports.31527, %land.lhs.true313 ], [ %numimports.31527, %if.end308 ], [ %numimports.31527, %delete.notnull ], [ %inc337, %while.end327 ], [ %inc337, %for.cond349 ]
  br label %while.cond364

while.cond364:                                    ; preds = %while.cond364, %if.end363
  %deststr.1 = phi ptr [ %incdec.ptr2721529, %if.end363 ], [ %incdec.ptr366, %while.cond364 ]
...
if.end371:                                        ; preds = %while.cond364, %while.body275
  %deststr.2 = phi ptr [ %incdec.ptr2721529, %while.body275 ], [ %incdec.ptr366, %while.cond364 ]
  %srcstr.5 = phi ptr [ %incdec.ptr2711528, %while.body275 ], [ %incdec.ptr365, %while.cond364 ]
  %numimports.6 = phi i16 [ %numimports.31527, %while.body275 ], [ %numimports.5, %while.cond364 ]
...
if.end374:                                        ; preds = %if.end371, %if.end269, %for.body198, %if.end229, %land.lhs.true234, %cleanup
  %numimports.7 = phi i16 [ %numimports.1, %cleanup ], [ %numimports.01540, %land.lhs.true234 ], [ %numimports.01540, %if.end229 ], [ %numimports.01540, %for.body198 ], [ %numimports.01540, %if.end269 ], [ %numimports.6, %if.end371 ]
  %dec194 = add i16 %dec1941541, -1
  %cmp196 = icmp sgt i16 %dec194, -1
  br i1 %cmp196, label %for.body198, label %for.cond.cleanup197, !llvm.loop !73

for.cond378.loopexit:                             ; preds = %if.end837, %while.end520
  %tobool380.not = icmp eq i16 %dec3791587, 0
...
invoke.cont384:                                   ; preds = %invoke.cont384.lr.ph, %for.cond378.loopexit
  %indvars.iv1624 = phi i64 [ 0, %invoke.cont384.lr.ph ], [ %indvars.iv.next1625, %for.cond378.loopexit ]
  %dec3791587.in = phi i16 [ %55, %invoke.cont384.lr.ph ], [ %dec3791587, %for.cond378.loopexit ]
  %numimports.81586 = phi i16 [ %numimports.0.lcssa, %invoke.cont384.lr.ph ], [ %numimports.9.lcssa, %for.cond378.loopexit ]
  %dec3791587 = add i16 %dec3791587.in, -1
  ...
  %arrayidx388 = getelementptr inbounds ptr, ptr %84, i64 %indvars.iv1624
  store ptr %call382, ptr %arrayidx388, align 8, !tbaa !17
  %85 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i.i1248 = tail call i32 @getc(ptr noundef %85)
  %conv.i.i1249 = trunc i32 %call.i.i1248 to i16
  %call.i8.i1250 = tail call i32 @getc(ptr noundef %85)
  %conv.i9.i1251 = trunc i32 %call.i8.i1250 to i16
  %conv3.i1252 = shl i16 %conv.i.i1249, 8
  %conv4.i1253 = and i16 %conv.i9.i1251, 255
  %or.i1254 = or i16 %conv4.i1253, %conv3.i1252
  store i16 %or.i1254, ptr %call382, align 2, !tbaa !5
  %86 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i.i1255 = tail call i32 @getc(ptr noundef %86)
  %conv.i.i1256 = zext i32 %call.i.i1255 to i64
  %call.i8.i1257 = tail call i32 @getc(ptr noundef %86)
  %conv3.i1259 = shl nuw nsw i64 %conv.i.i1256, 8
  %87 = and i32 %call.i8.i1257, 255
  %conv4.i1260 = zext i32 %87 to i64
  %88 = load ptr, ptr %constant_pool.i1225, align 8, !tbaa !42
  %conv3.i1259.masked = and i64 %conv3.i1259, 65280
  %idxprom.i1263 = or i64 %conv3.i1259.masked, %conv4.i1260
  %89 = getelementptr inbounds %struct.cp_info, ptr %88, i64 %idxprom.i1263, i32 1
  ...
  %call.i.i1265 = tail call i32 @getc(ptr noundef %91)
  %conv.i.i1266 = zext i32 %call.i.i1265 to i64
  %call.i8.i1267 = tail call i32 @getc(ptr noundef %91)
  %conv3.i1269 = shl nuw nsw i64 %conv.i.i1266, 8
  %92 = and i32 %call.i8.i1267, 255
  %conv4.i1270 = zext i32 %92 to i64
  %93 = load ptr, ptr %constant_pool.i1225, align 8, !tbaa !42
  %conv3.i1269.masked = and i64 %conv3.i1269, 65280
  %idxprom.i1273 = or i64 %conv3.i1269.masked, %conv4.i1270
  %94 = getelementptr inbounds %struct.cp_info, ptr %93, i64 %idxprom.i1273, i32 1
...
if.end414:                                        ; preds = %if.then413, %invoke.cont384
  ...
  %cmp423.not1556 = icmp eq i8 %96, 0
  br i1 %cmp423.not1556, label %while.end520, label %while.body424

while.body424:                                    ; preds = %if.end414, %if.end519
  %incdec.ptr4211561.pn = phi ptr [ %incdec.ptr4211561, %if.end519 ], [ %95, %if.end414 ]
  %numimports.91559 = phi i16 [ %numimports.11, %if.end519 ], [ %numimports.81586, %if.end414 ]
  %srcstr415.01557 = phi ptr [ %srcstr415.3, %if.end519 ], [ %call411, %if.end414 ]
  %incdec.ptr4201560 = getelementptr inbounds i8, ptr %srcstr415.01557, i64 1
  %incdec.ptr4211561 = getelementptr inbounds i8, ptr %incdec.ptr4211561.pn, i64 1
  %97 = load i8, ptr %srcstr415.01557, align 1, !tbaa !21
  %cmp427 = icmp eq i8 %97, 76
  br i1 %cmp427, label %if.then428, label %if.end519

if.then428:                                       ; preds = %while.body424
  %call.i1275 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %incdec.ptr4201560, i32 noundef 59) #18
  %tobool430.not = icmp eq ptr %call.i1275, null
...
if.end432:                                        ; preds = %if.then431, %if.then428
  %call433 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %incdec.ptr4201560, ptr noundef nonnull dereferenceable(11) @.str.10, i64 noundef 10) #14
...
while.cond438.preheader:                          ; preds = %if.end432
  %call.i12761543 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %incdec.ptr4201560, i32 noundef 47) #18
  %cmp4401544 = icmp ne ptr %call.i12761543, null
  %cmp4421545 = icmp ult ptr %call.i12761543, %call.i1275
  %98 = and i1 %cmp4401544, %cmp4421545
  br i1 %98, label %while.body444, label %if.end447

if.then435:                                       ; preds = %if.end432
  %add.ptr436 = getelementptr inbounds i8, ptr %srcstr415.01557, i64 11
  br label %if.end447

while.body444:                                    ; preds = %while.cond438.preheader, %while.body444
  %call.i12761546 = phi ptr [ %call.i1276, %while.body444 ], [ %call.i12761543, %while.cond438.preheader ]
  %incdec.ptr445 = getelementptr inbounds i8, ptr %call.i12761546, i64 1
  store i8 46, ptr %call.i12761546, align 1, !tbaa !21
  %call.i1276 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %incdec.ptr445, i32 noundef 47) #18
  %cmp440 = icmp ne ptr %call.i1276, null
  %cmp442 = icmp ult ptr %call.i1276, %call.i1275
...
if.end447:                                        ; preds = %while.body444, %while.cond438.preheader, %if.then435
  %srcstr415.1 = phi ptr [ %add.ptr436, %if.then435 ], [ %incdec.ptr4201560, %while.cond438.preheader ], [ %incdec.ptr4201560, %while.body444 ]
...
land.lhs.true450:                                 ; preds = %if.end447
  ...
  %spec.select1594.idx = sext i32 %narrow to i64
  %spec.select1594 = getelementptr i8, ptr %srcstr415.1, i64 %spec.select1594.idx
  br label %if.end459

if.end459:                                        ; preds = %land.lhs.true450, %if.end447
  %srcstr415.2 = phi ptr [ %srcstr415.1, %if.end447 ], [ %spec.select1594, %land.lhs.true450 ]
  %101 = load i16, ptr %imports_count, align 8, !tbaa !30
  %cmp463.not = icmp eq i16 %numimports.91559, %101
  br i1 %cmp463.not, label %if.end519, label %land.lhs.true464

land.lhs.true464:                                 ; preds = %if.end459
  %call.i1277 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %srcstr415.2, i32 noundef 46) #18
  %cmp466.not = icmp ne ptr %call.i1277, null
  %cmp468 = icmp ult ptr %call.i1277, %call.i1275
...
while.body475:                                    ; preds = %land.lhs.true464, %while.body475
  %tmpstr4418.01550 = phi ptr [ %call.i1278, %while.body475 ], [ %call.i1277, %land.lhs.true464 ]
  %add.ptr476 = getelementptr inbounds i8, ptr %tmpstr4418.01550, i64 1
  %call.i1278 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %add.ptr476, i32 noundef 46) #18
  %cmp471 = icmp ne ptr %call.i1278, null
  %cmp473 = icmp ult ptr %call.i1278, %call.i1275
  %102 = and i1 %cmp471, %cmp473
  br i1 %102, label %while.body475, label %while.end478, !llvm.loop !80

while.end478:                                     ; preds = %while.body475
  %sub.ptr.lhs.cast480 = ptrtoint ptr %call.i1275 to i64
  ...
  %inc489 = add i16 %numimports.91559, 1
  %idxprom490 = zext i16 %numimports.91559 to i64
  ...
  %cmp5021552 = icmp ugt i16 %inc489, 1
  br i1 %cmp5021552, label %for.body503.lr.ph, label %if.end519

for.body503.lr.ph:                                ; preds = %while.end478
...
for.cond501:                                      ; preds = %for.body503
  ...
  %cmp502 = icmp sgt i64 %indvars.iv1610, 0
  br i1 %cmp502, label %for.body503, label %if.end519, !llvm.loop !81

for.body503:                                      ; preds = %for.body503.lr.ph, %for.cond501
  %indvars.iv1610 = phi i64 [ %105, %for.body503.lr.ph ], [ %indvars.iv.next1611, %for.cond501 ]
  %arrayidx506 = getelementptr inbounds ptr, ptr %104, i64 %indvars.iv1610
...
if.end519:                                        ; preds = %for.cond501, %while.end478, %delete.notnull512, %if.end459, %land.lhs.true464, %while.body424
  %srcstr415.3 = phi ptr [ %srcstr415.2, %land.lhs.true464 ], [ %srcstr415.2, %if.end459 ], [ %incdec.ptr4201560, %while.body424 ], [ %add.ptr476, %delete.notnull512 ], [ %add.ptr476, %while.end478 ], [ %add.ptr476, %for.cond501 ]
  %numimports.11 = phi i16 [ %numimports.91559, %land.lhs.true464 ], [ %numimports.91559, %if.end459 ], [ %numimports.91559, %while.body424 ], [ %numimports.91559, %delete.notnull512 ], [ %inc489, %while.end478 ], [ %inc489, %for.cond501 ]
  %107 = load i8, ptr %srcstr415.3, align 1, !tbaa !21
  store i8 %107, ptr %incdec.ptr4211561, align 1, !tbaa !21
...
while.end520:                                     ; preds = %if.end519, %if.end414
  %numimports.9.lcssa = phi i16 [ %numimports.81586, %if.end414 ], [ %numimports.11, %if.end519 ]
  ...
  %call.i.i1279 = tail call i32 @getc(ptr noundef %108)
  %call.i8.i1281 = tail call i32 @getc(ptr noundef %108)
  %conv3.i1283 = shl i32 %call.i.i1279, 8
  %conv4.i1284 = and i32 %call.i8.i1281, 255
  %conv3.i1283.masked = and i32 %conv3.i1283, 65280
  %conv525 = or i32 %conv4.i1284, %conv3.i1283.masked
  %tobool528.not1581 = icmp eq i32 %conv525, 0
  br i1 %tobool528.not1581, label %for.cond378.loopexit, label %for.body530.lr.ph
...
for.body530:                                      ; preds = %for.body530.lr.ph, %if.end837
  %dec5271582.in = phi i32 [ %conv525, %for.body530.lr.ph ], [ %dec5271582, %if.end837 ]
  %dec5271582 = add nsw i32 %dec5271582.in, -1
  %109 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i.i1286 = tail call i32 @getc(ptr noundef %109)
  %conv.i.i1287 = zext i32 %call.i.i1286 to i64
  %call.i8.i1288 = tail call i32 @getc(ptr noundef %109)
  %conv3.i1290 = shl nuw nsw i64 %conv.i.i1287, 8
  %110 = and i32 %call.i8.i1288, 255
  %conv4.i1291 = zext i32 %110 to i64
  %111 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i.i.i1293 = tail call i32 @getc(ptr noundef %111)
  %conv.i.i.i1294 = zext i32 %call.i.i.i1293 to i64
  %call.i8.i.i1295 = tail call i32 @getc(ptr noundef %111)
  %conv3.i.i1296 = shl nuw nsw i64 %conv.i.i.i1294, 8
  %112 = and i32 %call.i8.i.i1295, 255
  %conv4.i.i1297 = zext i32 %112 to i64
  %conv3.i.masked.i1298 = and i64 %conv3.i.i1296, 65280
  %conv.i1299 = or i64 %conv3.i.masked.i1298, %conv4.i.i1297
  %call.i.i5.i1300 = tail call i32 @getc(ptr noundef %111)
  %conv.i.i6.i1301 = zext i32 %call.i.i5.i1300 to i64
  %call.i8.i7.i1302 = tail call i32 @getc(ptr noundef %111)
  %conv3.i9.i1303 = shl nuw nsw i64 %conv.i.i6.i1301, 8
  %113 = and i32 %call.i8.i7.i1302, 255
  %conv4.i10.i1304 = zext i32 %113 to i64
  %conv3.i9.masked.i1305 = and i64 %conv3.i9.i1303, 65280
  %conv2.i1306 = or i64 %conv3.i9.masked.i1305, %conv4.i10.i1304
  %shl.i1307 = shl nuw nsw i64 %conv.i1299, 16
  %or.i1308 = or i64 %conv2.i1306, %shl.i1307
  %114 = load ptr, ptr %constant_pool.i1225, align 8, !tbaa !42
  %conv3.i1290.masked = and i64 %conv3.i1290, 65280
  %idxprom.i1310 = or i64 %conv3.i1290.masked, %conv4.i1291
  %115 = getelementptr inbounds %struct.cp_info, ptr %114, i64 %idxprom.i1310, i32 1
...
if.then544:                                       ; preds = %for.body530
  ...
  %call.i.i1312 = tail call i32 @getc(ptr noundef %117)
  %call.i8.i1314 = tail call i32 @getc(ptr noundef %117)
  %conv.i9.i1315 = trunc i32 %call.i8.i1314 to i8
  store i8 %conv.i9.i1315, ptr %max_stack, align 8, !tbaa !86
  %118 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i.i1319 = tail call i32 @getc(ptr noundef %118)
  %call.i8.i1321 = tail call i32 @getc(ptr noundef %118)
  %conv.i9.i1322 = trunc i32 %call.i8.i1321 to i8
  store i8 %conv.i9.i1322, ptr %max_locals, align 1, !tbaa !87
  %119 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i.i.i1326 = tail call i32 @getc(ptr noundef %119)
  %conv.i.i.i1327 = zext i32 %call.i.i.i1326 to i64
  %call.i8.i.i1328 = tail call i32 @getc(ptr noundef %119)
  %conv3.i.i1329 = shl nuw nsw i64 %conv.i.i.i1327, 8
  %120 = and i32 %call.i8.i.i1328, 255
  %conv4.i.i1330 = zext i32 %120 to i64
  %conv3.i.masked.i1331 = and i64 %conv3.i.i1329, 65280
  %conv.i1332 = or i64 %conv3.i.masked.i1331, %conv4.i.i1330
  %call.i.i5.i1333 = tail call i32 @getc(ptr noundef %119)
  %conv.i.i6.i1334 = zext i32 %call.i.i5.i1333 to i64
  %call.i8.i7.i1335 = tail call i32 @getc(ptr noundef %119)
  %conv3.i9.i1336 = shl nuw nsw i64 %conv.i.i6.i1334, 8
  %121 = and i32 %call.i8.i7.i1335, 255
  %conv4.i10.i1337 = zext i32 %121 to i64
  %conv3.i9.masked.i1338 = and i64 %conv3.i9.i1336, 65280
  %conv2.i1339 = or i64 %conv3.i9.masked.i1338, %conv4.i10.i1337
  %shl.i1340 = shl nuw nsw i64 %conv.i1332, 16
  %or.i1341 = or i64 %conv2.i1339, %shl.i1340
  %conv556 = trunc i64 %or.i1341 to i32
  store i32 %conv556, ptr %code_length, align 4, !tbaa !88
  %call558 = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %or.i1341) #17
  ...
  %call569 = tail call i64 @fread(ptr noundef nonnull %call558, i64 noundef %or.i1341, i64 noundef 1, ptr noundef %123)
  %124 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i.i1342 = tail call i32 @getc(ptr noundef %124)
  %conv.i.i1343 = trunc i32 %call.i.i1342 to i16
  %call.i8.i1344 = tail call i32 @getc(ptr noundef %124)
  %conv.i9.i1345 = trunc i32 %call.i8.i1344 to i16
  %conv3.i1346 = shl i16 %conv.i.i1343, 8
  %conv4.i1347 = and i16 %conv.i9.i1345, 255
  %or.i1348 = or i16 %conv4.i1347, %conv3.i1346
  store i16 %or.i1348, ptr %exception_table_length, align 8, !tbaa !90
  %conv573 = zext i16 %or.i1348 to i64
  ...
  %tobool585.not1568 = icmp eq i16 %or.i1348, 0
  br i1 %tobool585.not1568, label %for.cond.cleanup586, label %for.body587

for.cond.cleanup586:                              ; preds = %for.body587, %if.then544
  %126 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i.i1349 = tail call i32 @getc(ptr noundef %126)
  %call.i8.i1351 = tail call i32 @getc(ptr noundef %126)
  %conv3.i1353 = shl i32 %call.i.i1349, 8
  %conv4.i1354 = and i32 %call.i8.i1351, 255
  %conv3.i1353.masked = and i32 %conv3.i1353, 65280
  %conv623 = or i32 %conv4.i1354, %conv3.i1353.masked
  %tobool626.not1578 = icmp eq i32 %conv623, 0
  br i1 %tobool626.not1578, label %if.end837, label %for.body628

for.body587:                                      ; preds = %if.then544, %for.body587
  %127 = phi ptr [ %136, %for.body587 ], [ %call574, %if.then544 ]
  %indvars.iv1613 = phi i64 [ %indvars.iv.next1614, %for.body587 ], [ 0, %if.then544 ]
  %m581.01570 = phi i16 [ %dec584, %for.body587 ], [ %or.i1348, %if.then544 ]
  %dec584 = add i16 %m581.01570, -1
  %arrayidx590 = getelementptr inbounds %struct.Block, ptr %127, i64 %indvars.iv1613
  store i32 0, ptr %arrayidx590, align 8, !tbaa !92
  %128 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i.i1356 = tail call i32 @getc(ptr noundef %128)
  %conv.i.i1357 = trunc i32 %call.i.i1356 to i16
  %call.i8.i1358 = tail call i32 @getc(ptr noundef %128)
  %conv.i9.i1359 = trunc i32 %call.i8.i1358 to i16
  %conv3.i1360 = shl i16 %conv.i.i1357, 8
  %conv4.i1361 = and i16 %conv.i9.i1359, 255
  %or.i1362 = or i16 %conv4.i1361, %conv3.i1360
  %129 = load ptr, ptr %exception_table, align 8, !tbaa !91
  %start_pc = getelementptr inbounds %struct.Block, ptr %129, i64 %indvars.iv1613, i32 1
  store i16 %or.i1362, ptr %start_pc, align 4, !tbaa !95
  %130 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i.i1363 = tail call i32 @getc(ptr noundef %130)
  %conv.i.i1364 = trunc i32 %call.i.i1363 to i16
  %call.i8.i1365 = tail call i32 @getc(ptr noundef %130)
  %conv.i9.i1366 = trunc i32 %call.i8.i1365 to i16
  %conv3.i1367 = shl i16 %conv.i.i1364, 8
  %conv4.i1368 = and i16 %conv.i9.i1366, 255
  %or.i1369 = or i16 %conv4.i1368, %conv3.i1367
  %131 = load ptr, ptr %exception_table, align 8, !tbaa !91
  %end_pc = getelementptr inbounds %struct.Block, ptr %131, i64 %indvars.iv1613, i32 2
  store i16 %or.i1369, ptr %end_pc, align 2, !tbaa !96
  %132 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i.i1370 = tail call i32 @getc(ptr noundef %132)
  %conv.i.i1371 = trunc i32 %call.i.i1370 to i16
  %call.i8.i1372 = tail call i32 @getc(ptr noundef %132)
  %conv.i9.i1373 = trunc i32 %call.i8.i1372 to i16
  %conv3.i1374 = shl i16 %conv.i.i1371, 8
  %conv4.i1375 = and i16 %conv.i9.i1373, 255
  %or.i1376 = or i16 %conv4.i1375, %conv3.i1374
  %133 = load ptr, ptr %exception_table, align 8, !tbaa !91
  %134 = getelementptr inbounds %struct.Block, ptr %133, i64 %indvars.iv1613, i32 3
  store i16 %or.i1376, ptr %134, align 8, !tbaa !21
  %135 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i.i1377 = tail call i32 @getc(ptr noundef %135)
  %conv.i.i1378 = trunc i32 %call.i.i1377 to i16
  %call.i8.i1379 = tail call i32 @getc(ptr noundef %135)
  %conv.i9.i1380 = trunc i32 %call.i8.i1379 to i16
  %conv3.i1381 = shl i16 %conv.i.i1378, 8
  %conv4.i1382 = and i16 %conv.i9.i1380, 255
  %or.i1383 = or i16 %conv4.i1382, %conv3.i1381
  %136 = load ptr, ptr %exception_table, align 8, !tbaa !91
  %indvars.iv.next1614 = add nuw nsw i64 %indvars.iv1613, 1
  %catch_type = getelementptr inbounds %struct.Block, ptr %136, i64 %indvars.iv1613, i32 4
  store i16 %or.i1383, ptr %catch_type, align 4, !tbaa !97
...
for.body628:                                      ; preds = %for.cond.cleanup586, %if.end783
  %dec6251579.in = phi i32 [ %dec6251579, %if.end783 ], [ %conv623, %for.cond.cleanup586 ]
  %dec6251579 = add nsw i32 %dec6251579.in, -1
  %137 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i.i1384 = tail call i32 @getc(ptr noundef %137)
  %conv.i.i1385 = zext i32 %call.i.i1384 to i64
  %call.i8.i1386 = tail call i32 @getc(ptr noundef %137)
  %conv3.i1388 = shl nuw nsw i64 %conv.i.i1385, 8
  %138 = and i32 %call.i8.i1386, 255
  %conv4.i1389 = zext i32 %138 to i64
  %139 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i.i.i1391 = tail call i32 @getc(ptr noundef %139)
  %conv.i.i.i1392 = zext i32 %call.i.i.i1391 to i64
  %call.i8.i.i1393 = tail call i32 @getc(ptr noundef %139)
  %conv3.i.i1394 = shl nuw nsw i64 %conv.i.i.i1392, 8
  %140 = and i32 %call.i8.i.i1393, 255
  %conv4.i.i1395 = zext i32 %140 to i64
  %conv3.i.masked.i1396 = and i64 %conv3.i.i1394, 65280
  %conv.i1397 = or i64 %conv3.i.masked.i1396, %conv4.i.i1395
  %call.i.i5.i1398 = tail call i32 @getc(ptr noundef %139)
  %conv.i.i6.i1399 = zext i32 %call.i.i5.i1398 to i64
  %call.i8.i7.i1400 = tail call i32 @getc(ptr noundef %139)
  %conv3.i9.i1401 = shl nuw nsw i64 %conv.i.i6.i1399, 8
  %141 = and i32 %call.i8.i7.i1400, 255
  %conv4.i10.i1402 = zext i32 %141 to i64
  %conv3.i9.masked.i1403 = and i64 %conv3.i9.i1401, 65280
  %conv2.i1404 = or i64 %conv3.i9.masked.i1403, %conv4.i10.i1402
  %shl.i1405 = shl nuw nsw i64 %conv.i1397, 16
  %or.i1406 = or i64 %conv2.i1404, %shl.i1405
  %142 = load ptr, ptr %constant_pool.i1225, align 8, !tbaa !42
  %conv3.i1388.masked = and i64 %conv3.i1388, 65280
  %idxprom.i1408 = or i64 %conv3.i1388.masked, %conv4.i1389
  %143 = getelementptr inbounds %struct.cp_info, ptr %142, i64 %idxprom.i1408, i32 1
...
if.then639:                                       ; preds = %for.body628
  ...
  %call.i.i1410 = tail call i32 @getc(ptr noundef %145)
  %conv.i.i1411 = trunc i32 %call.i.i1410 to i16
  %call.i8.i1412 = tail call i32 @getc(ptr noundef %145)
  %conv.i9.i1413 = trunc i32 %call.i8.i1412 to i16
  %conv3.i1414 = shl i16 %conv.i.i1411, 8
  %conv4.i1415 = and i16 %conv.i9.i1413, 255
  %or.i1416 = or i16 %conv4.i1415, %conv3.i1414
  store i16 %or.i1416, ptr %line_number_table_length, align 8, !tbaa !85
  %conv644 = zext i16 %or.i1416 to i64
  ...
  %conv650 = zext i16 %or.i1416 to i32
...
if.then663:                                       ; preds = %if.else660
  ...
  %call.i.i1417 = tail call i32 @getc(ptr noundef %149)
  %conv.i.i1418 = trunc i32 %call.i.i1417 to i16
  %call.i8.i1419 = tail call i32 @getc(ptr noundef %149)
  %conv.i9.i1420 = trunc i32 %call.i8.i1419 to i16
  %conv3.i1421 = shl i16 %conv.i.i1418, 8
  %conv4.i1422 = and i16 %conv.i9.i1420, 255
  %or.i1423 = or i16 %conv4.i1422, %conv3.i1421
  store i16 %or.i1423, ptr %local_variable_table_length, align 8, !tbaa !84
  %conv668 = zext i16 %or.i1423 to i64
  ...
  %conv674 = zext i16 %or.i1423 to i32
  ...
  %tobool696.not1573 = icmp eq i16 %153, 0
  br i1 %tobool696.not1573, label %for.end724, label %for.body697

for.body697:                                      ; preds = %if.then663, %for.body697
  %indvars.iv1616 = phi i64 [ %indvars.iv.next1617, %for.body697 ], [ %conv685, %if.then663 ]
  %indvars.iv.next1617 = add nsw i64 %indvars.iv1616, -1
  %155 = load ptr, ptr %local_variable_table, align 8, !tbaa !100
  %name_index = getelementptr inbounds %struct.LocalVariableTableEntry, ptr %155, i64 %indvars.iv.next1617, i32 2
  %156 = load i16, ptr %name_index, align 2, !tbaa !102
  %157 = load ptr, ptr %constant_pool.i1225, align 8, !tbaa !42
  %idxprom.i1425 = zext i16 %156 to i64
  %158 = getelementptr inbounds %struct.cp_info, ptr %157, i64 %idxprom.i1425, i32 1
  ...
  %slot = getelementptr inbounds %struct.LocalVariableTableEntry, ptr %155, i64 %indvars.iv.next1617, i32 4
  ...
  %slot720 = getelementptr inbounds %struct.LocalVariableTableEntry, ptr %163, i64 %indvars.iv.next1617, i32 4
  ...
  %166 = icmp eq i64 %indvars.iv.next1617, 0
  br i1 %166, label %for.end724.loopexit, label %for.body697, !llvm.loop !105

for.end724.loopexit:                              ; preds = %for.body697
  %.pre1627 = load i16, ptr %local_variable_table_length, align 8, !tbaa !84
  br label %for.end724

for.end724:                                       ; preds = %for.end724.loopexit, %if.then663
  %167 = phi i16 [ %.pre1627, %for.end724.loopexit ], [ 0, %if.then663 ]
  ...
  %tobool737.not1575 = icmp eq i16 %167, 0
  br i1 %tobool737.not1575, label %if.end783, label %for.body738

for.body738:                                      ; preds = %for.end724, %for.body738
  %indvars.iv1620 = phi i64 [ %indvars.iv.next1621, %for.body738 ], [ %conv726, %for.end724 ]
  %indvars.iv.next1621 = add nsw i64 %indvars.iv1620, -1
  %169 = load ptr, ptr %local_variable_table, align 8, !tbaa !100
  %signature_index744 = getelementptr inbounds %struct.LocalVariableTableEntry, ptr %169, i64 %indvars.iv.next1621, i32 3
  %170 = load i16, ptr %signature_index744, align 2, !tbaa !107
  %171 = load ptr, ptr %constant_pool.i1225, align 8, !tbaa !42
  %idxprom.i1428 = zext i16 %170 to i64
  %172 = getelementptr inbounds %struct.cp_info, ptr %171, i64 %idxprom.i1428, i32 1
  ...
  %slot753 = getelementptr inbounds %struct.LocalVariableTableEntry, ptr %169, i64 %indvars.iv.next1621, i32 4
  ...
  %slot763 = getelementptr inbounds %struct.LocalVariableTableEntry, ptr %177, i64 %indvars.iv.next1621, i32 4
  ...
  %180 = icmp eq i64 %indvars.iv.next1621, 0
...
if.else768:                                       ; preds = %if.else660
  ...
  %call769 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %181, ptr noundef nonnull @.str.14, ptr noundef %144, i64 noundef %or.i1406) #16
  %conv771 = trunc i64 %or.i1406 to i32
  %tobool774.not1571 = icmp eq i32 %conv771, 0
  br i1 %tobool774.not1571, label %if.end783, label %for.body776

for.body776:                                      ; preds = %if.else768, %for.body776
  %m770.01572 = phi i32 [ %dec773, %for.body776 ], [ %conv771, %if.else768 ]
  %dec773 = add nsw i32 %m770.01572, -1
  %182 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i1430 = tail call i32 @getc(ptr noundef %182)
...
if.end783:                                        ; preds = %for.body776, %for.body738, %if.else768, %for.end724, %if.then639
  %tobool626.not = icmp eq i32 %dec6251579, 0
...
if.then789:                                       ; preds = %if.else786
  ...
  %call.i.i1432 = tail call i32 @getc(ptr noundef %183)
  %conv.i.i1433 = trunc i32 %call.i.i1432 to i16
  %call.i8.i1434 = tail call i32 @getc(ptr noundef %183)
  %conv.i9.i1435 = trunc i32 %call.i8.i1434 to i16
  %conv3.i1436 = shl i16 %conv.i.i1433, 8
  %conv4.i1437 = and i16 %conv.i9.i1435, 255
  %or.i1438 = or i16 %conv4.i1437, %conv3.i1436
  %conv793 = zext i16 %or.i1438 to i32
  store i32 %conv793, ptr %num_throws, align 4, !tbaa !83
  %conv795 = zext i16 %or.i1438 to i64
  ...
  %tobool804.not1565 = icmp eq i16 %or.i1438, 0
  br i1 %tobool804.not1565, label %if.end837, label %for.body806

for.body806:                                      ; preds = %if.then789, %for.body806
  %m800.01567 = phi i32 [ %dec803, %for.body806 ], [ %conv793, %if.then789 ]
  %tmpintptr.01566 = phi ptr [ %incdec.ptr811, %for.body806 ], [ %call796, %if.then789 ]
  %dec803 = add nsw i32 %m800.01567, -1
  %185 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i.i1439 = tail call i32 @getc(ptr noundef %185)
  %call.i8.i1441 = tail call i32 @getc(ptr noundef %185)
  %conv3.i1443 = shl i32 %call.i.i1439, 8
  %conv4.i1444 = and i32 %call.i8.i1441, 255
  %conv3.i1443.masked = and i32 %conv3.i1443, 65280
  %conv810 = or i32 %conv4.i1444, %conv3.i1443.masked
  %incdec.ptr811 = getelementptr inbounds i32, ptr %tmpintptr.01566, i64 1
  store i32 %conv810, ptr %tmpintptr.01566, align 4, !tbaa !22
...
if.else814:                                       ; preds = %if.else786
  ...
  %call815 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %186, ptr noundef nonnull @.str.16, ptr noundef %116, i64 noundef %or.i1308) #16
  %cmp820.not1563 = icmp eq i64 %or.i1308, 0
  br i1 %cmp820.not1563, label %for.cond.cleanup821, label %for.body822
...
for.body822:                                      ; preds = %if.else814, %for.body822
  %m816.01564 = phi i32 [ %inc818, %for.body822 ], [ 0, %if.else814 ]
  %inc818 = add i32 %m816.01564, 1
  %187 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i1446 = tail call i32 @getc(ptr noundef %187)
  %conv826 = and i32 %call.i1446, 255
  ...
  %cmp820.not = icmp eq i64 %or.i1308, %conv819
...
if.end837:                                        ; preds = %for.body806, %if.end783, %if.then789, %for.cond.cleanup586, %for.cond.cleanup821
  %tobool528.not = icmp eq i32 %dec5271582, 0
...
for.end840:                                       ; preds = %for.cond378.loopexit, %for.cond.cleanup197
  ...
  %call.i.i1448 = tail call i32 @getc(ptr noundef %188)
  %conv.i.i1449 = trunc i32 %call.i.i1448 to i16
  %call.i8.i1450 = tail call i32 @getc(ptr noundef %188)
  %conv.i9.i1451 = trunc i32 %call.i8.i1450 to i16
  %conv3.i1452 = shl i16 %conv.i.i1449, 8
  %conv4.i1453 = and i16 %conv.i9.i1451, 255
  %or.i1454 = or i16 %conv4.i1453, %conv3.i1452
  %tobool847.not1592 = icmp eq i16 %or.i1454, 0
  br i1 %tobool847.not1592, label %for.end895, label %for.body848.lr.ph
...
for.body848:                                      ; preds = %for.body848.lr.ph, %if.end894
  %dec8461593.in = phi i16 [ %or.i1454, %for.body848.lr.ph ], [ %dec8461593, %if.end894 ]
  %dec8461593 = add i16 %dec8461593.in, -1
  %189 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i.i1455 = tail call i32 @getc(ptr noundef %189)
  %conv.i.i1456 = zext i32 %call.i.i1455 to i64
  %call.i8.i1457 = tail call i32 @getc(ptr noundef %189)
  %conv3.i1459 = shl nuw nsw i64 %conv.i.i1456, 8
  %190 = and i32 %call.i8.i1457, 255
  %conv4.i1460 = zext i32 %190 to i64
  %191 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i.i.i1462 = tail call i32 @getc(ptr noundef %191)
  %conv.i.i.i1463 = zext i32 %call.i.i.i1462 to i64
  %call.i8.i.i1464 = tail call i32 @getc(ptr noundef %191)
  %conv3.i.i1465 = shl nuw nsw i64 %conv.i.i.i1463, 8
  %192 = and i32 %call.i8.i.i1464, 255
  %conv4.i.i1466 = zext i32 %192 to i64
  %conv3.i.masked.i1467 = and i64 %conv3.i.i1465, 65280
  %conv.i1468 = or i64 %conv3.i.masked.i1467, %conv4.i.i1466
  %call.i.i5.i1469 = tail call i32 @getc(ptr noundef %191)
  %conv.i.i6.i1470 = zext i32 %call.i.i5.i1469 to i64
  %call.i8.i7.i1471 = tail call i32 @getc(ptr noundef %191)
  %conv3.i9.i1472 = shl nuw nsw i64 %conv.i.i6.i1470, 8
  %193 = and i32 %call.i8.i7.i1471, 255
  %conv4.i10.i1473 = zext i32 %193 to i64
  %conv3.i9.masked.i1474 = and i64 %conv3.i9.i1472, 65280
  %conv2.i1475 = or i64 %conv3.i9.masked.i1474, %conv4.i10.i1473
  %shl.i1476 = shl nuw nsw i64 %conv.i1468, 16
  %or.i1477 = or i64 %conv2.i1475, %shl.i1476
  %194 = load ptr, ptr %constant_pool.i1225, align 8, !tbaa !42
  %conv3.i1459.masked = and i64 %conv3.i1459, 65280
  %idxprom.i1479 = or i64 %conv3.i1459.masked, %conv4.i1460
  %195 = getelementptr inbounds %struct.cp_info, ptr %194, i64 %idxprom.i1479, i32 1
...
if.then862:                                       ; preds = %for.body848
  %cmp863.not = icmp eq i64 %or.i1477, 2
...
if.else866:                                       ; preds = %if.then862
  ...
  %call.i.i1481 = tail call i32 @getc(ptr noundef %199)
  %conv.i.i1482 = zext i32 %call.i.i1481 to i64
  %call.i8.i1483 = tail call i32 @getc(ptr noundef %199)
  %conv3.i1485 = shl nuw nsw i64 %conv.i.i1482, 8
  %200 = and i32 %call.i8.i1483, 255
  %conv4.i1486 = zext i32 %200 to i64
  %201 = load ptr, ptr %constant_pool.i1225, align 8, !tbaa !42
  %conv3.i1485.masked = and i64 %conv3.i1485, 65280
  %idxprom.i1489 = or i64 %conv3.i1485.masked, %conv4.i1486
  %202 = getelementptr inbounds %struct.cp_info, ptr %201, i64 %idxprom.i1489, i32 1
...
if.else882:                                       ; preds = %for.body848
  ...
  %call883 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %204, ptr noundef nonnull @.str.21, ptr noundef %196, i64 noundef %or.i1477) #16
  %tobool886.not1589 = icmp eq i64 %or.i1477, 0
  br i1 %tobool886.not1589, label %if.end894, label %for.body888

for.body888:                                      ; preds = %if.else882, %for.body888
  %k.01590 = phi i64 [ %dec885, %for.body888 ], [ %or.i1477, %if.else882 ]
  %dec885 = add nsw i64 %k.01590, -1
  %205 = load ptr, ptr %this, align 8, !tbaa !19
  %call.i1491 = tail call i32 @getc(ptr noundef %205)
...
if.end894:                                        ; preds = %for.body888, %if.else882, %if.else866
  %tobool847.not = icmp eq i16 %dec8461593, 0
