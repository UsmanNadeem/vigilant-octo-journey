; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/Common/Wildcard.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/Common/Wildcard.cpp"
...
for.body:                                         ; preds = %for.cond
  ...
  br i1 %cmp.i, label %for.end.split.loop.exit, label %for.cond, !llvm.loop !33
...
for.end:                                          ; preds = %for.cond, %for.end.split.loop.exit
  %i.0.in.lcssa = phi i32 [ %6, %for.end.split.loop.exit ], [ %smin, %for.cond ]
...
if.end.i.i:                                       ; preds = %if.end.i
  ...
  %call.i.i20 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %12) #19
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i:        ; preds = %if.end9.i.i, %if.end.i
  %14 = phi ptr [ %7, %if.end.i ], [ %call.i.i20, %if.end9.i.i ]
  %15 = load ptr, ptr %ref.tmp, align 8, !tbaa !5
  br label %while.cond.i.i

while.cond.i.i:                                   ; preds = %while.cond.i.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i
  %src.addr.0.i.i = phi ptr [ %15, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i ], [ %incdec.ptr.i.i, %while.cond.i.i ]
  %dest.addr.0.i.i = phi ptr [ %14, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i ], [ %incdec.ptr1.i.i, %while.cond.i.i ]
  %incdec.ptr.i.i = getelementptr inbounds i32, ptr %src.addr.0.i.i, i64 1
  %16 = load i32, ptr %src.addr.0.i.i, align 4, !tbaa !15
  %incdec.ptr1.i.i = getelementptr inbounds i32, ptr %dest.addr.0.i.i, i64 1
  store i32 %16, ptr %dest.addr.0.i.i, align 4, !tbaa !15
...
_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i:            ; preds = %while.cond.i.i
  %17 = load i32, ptr %_length.i19, align 8, !tbaa !17
  store i32 %17, ptr %_length.i.i, align 8, !tbaa !17
  br label %invoke.cont

invoke.cont:                                      ; preds = %for.end.invoke.cont_crit_edge, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i
  %18 = phi ptr [ %.pre, %for.end.invoke.cont_crit_edge ], [ %15, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i ]
...
_ZN11CStringBaseIwED2Ev.exit:                     ; preds = %invoke.cont, %delete.notnull.i
  ...
  %19 = load i32, ptr %_length.i, align 8, !tbaa !17, !noalias !34
  %sub.i = sub nsw i32 %19, %i.0.in.lcssa
...
if.end.i28:                                       ; preds = %_ZN11CStringBaseIwED2Ev.exit
  ...
  %21 = load i32, ptr %_length.i24, align 8, !tbaa !17
  %add.i.i25 = add nsw i32 %21, 1
  %_capacity.i.i26 = getelementptr inbounds %class.CStringBase, ptr %name, i64 0, i32 2
  %22 = load i32, ptr %_capacity.i.i26, align 4, !tbaa !18
  %cmp.i.i27 = icmp eq i32 %add.i.i25, %22
...
if.end.i.i31:                                     ; preds = %if.end.i28
  ...
  %24 = shl nuw nsw i64 %conv.i.i29, 2
  %25 = select i1 %23, i64 -1, i64 %24
  %call.i.i46 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %25) #19
          to label %call.i.i.noexc45 unwind label %lpad6

call.i.i.noexc45:                                 ; preds = %if.end.i.i31
  %cmp3.i.i30 = icmp sgt i32 %22, 0
...
delete.notnull.i.i33:                             ; preds = %call.i.i.noexc45
  ...
  %26 = sext i32 %.pre.i32 to i64
  br label %if.end9.i.i36

if.end9.i.i36:                                    ; preds = %delete.notnull.i.i33, %call.i.i.noexc45
  %idxprom13.i.i34 = phi i64 [ %26, %delete.notnull.i.i33 ], [ 0, %call.i.i.noexc45 ]
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i37:      ; preds = %if.end9.i.i36, %if.end.i28
  %27 = phi ptr [ %20, %if.end.i28 ], [ %call.i.i46, %if.end9.i.i36 ]
  %28 = load ptr, ptr %ref.tmp4, align 8, !tbaa !5
  br label %while.cond.i.i43

while.cond.i.i43:                                 ; preds = %while.cond.i.i43, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i37
  %src.addr.0.i.i38 = phi ptr [ %28, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i37 ], [ %incdec.ptr.i.i40, %while.cond.i.i43 ]
  %dest.addr.0.i.i39 = phi ptr [ %27, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i37 ], [ %incdec.ptr1.i.i41, %while.cond.i.i43 ]
  %incdec.ptr.i.i40 = getelementptr inbounds i32, ptr %src.addr.0.i.i38, i64 1
  %29 = load i32, ptr %src.addr.0.i.i38, align 4, !tbaa !15
  %incdec.ptr1.i.i41 = getelementptr inbounds i32, ptr %dest.addr.0.i.i39, i64 1
  store i32 %29, ptr %dest.addr.0.i.i39, align 4, !tbaa !15
  %cmp.not.i.i42 = icmp eq i32 %29, 0
...
_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i44:          ; preds = %while.cond.i.i43
  %30 = load i32, ptr %_length.i24, align 8, !tbaa !17
  store i32 %30, ptr %_length.i.i23, align 8, !tbaa !17
  br label %invoke.cont7

invoke.cont7:                                     ; preds = %_ZN11CStringBaseIwED2Ev.exit.invoke.cont7_crit_edge, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i44
  %31 = phi ptr [ %.pre59, %_ZN11CStringBaseIwED2Ev.exit.invoke.cont7_crit_edge ], [ %28, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i44 ]
  %isnull.i48 = icmp eq ptr %31, null
...
lpad:                                             ; preds = %if.end.i.i
  ...
  %isnull.i51 = icmp eq ptr %33, null
...
lpad6:                                            ; preds = %if.end.i.i31
  %34 = landingpad { ptr, i32 }
          cleanup
  %35 = load ptr, ptr %ref.tmp4, align 8, !tbaa !5
  %isnull.i54 = icmp eq ptr %35, null
...
ehcleanup:                                        ; preds = %_ZN11CStringBaseIwED2Ev.exit56, %_ZN11CStringBaseIwED2Ev.exit53
  %.pn = phi { ptr, i32 } [ %34, %_ZN11CStringBaseIwED2Ev.exit56 ], [ %32, %_ZN11CStringBaseIwED2Ev.exit53 ]
  resume { ptr, i32 } %.pn
}
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = load i32, ptr %arrayidx, align 4, !tbaa !15
  %cmp.i = icmp eq i32 %5, 47
  br i1 %cmp.i, label %for.end.split.loop.exit, label %for.cond, !llvm.loop !37
...
for.body:                                         ; preds = %for.cond
  ...
  %5 = load i32, ptr %arrayidx, align 4, !tbaa !15
  %cmp.i = icmp eq i32 %5, 47
  br i1 %cmp.i, label %for.end.split.loop.exit, label %for.cond, !llvm.loop !38
...
if.end5.if.end28_crit_edge:                       ; preds = %if.end5
  ...
  %.pre115 = load i8, ptr %ForFile34.phi.trans.insert, align 1
  br label %if.end28
...
land.lhs.true10:                                  ; preds = %if.then7
  ...
  %or.cond = select i1 %tobool11.not82, i1 %cmp13, i1 false
...
if.end15:                                         ; preds = %land.lhs.true10, %if.then7
  ...
  %4 = load i8, ptr %ForFile, align 1, !tbaa !45, !range !13, !noundef !14
  %tobool16.not83 = icmp eq i8 %4, 0
  %cmp18 = icmp eq i32 %1, %2
  %or.cond66 = select i1 %tobool16.not83, i1 %cmp18, i1 false
...
if.end20:                                         ; preds = %if.end15
  ...
  %5 = load i8, ptr %Recursive24, align 8
...
if.end28:                                         ; preds = %if.end5.if.end28_crit_edge, %if.end20
  ...
  %narrow = select i1 %isFile, i1 %tobool35.not, i1 false
...
for.cond:                                         ; preds = %for.end
  ...
  br i1 %exitcond114.not, label %return, label %for.cond41.preheader, !llvm.loop !46
...
for.inc:                                          ; preds = %for.body45
  ...
  br i1 %cmp44, label %for.body45, label %for.end.loopexit, !llvm.loop !48
...
for.inc:                                          ; preds = %_Z16CompareFileNamesRK11CStringBaseIwES2_.exit
  ...
  br i1 %cmp.not, label %for.body, label %cleanup, !llvm.loop !49
...
entry:
  ...
  store i64 8, ptr %_itemSize.i.i.i.i.i, align 8, !tbaa !50
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorI11CStringBaseIwEE, i64 0, inrange i32 0, i64 2), ptr %call.i, align 8, !tbaa !51
...
for.inc.i:                                        ; preds = %_Z16CompareFileNamesRK11CStringBaseIwES2_.exit.i
  ...
  br i1 %cmp.not.i, label %for.body.i, label %if.then10, !llvm.loop !49
...
if.then10:                                        ; preds = %for.inc.i, %if.end7, %_ZNK9NWildcard11CCensorNode11FindSubNodeERK11CStringBaseIwE.exit
  ...
  store ptr %this, ptr %ref.tmp, align 8, !tbaa !53
...
_ZN9NWildcard11CCensorNodeC2ERK11CStringBaseIwEPS0_.exit: ; preds = %while.cond.i.i.i
  ...
  store i64 8, ptr %_itemSize.i.i.i.i, align 8, !tbaa !50
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard11CCensorNodeEE, i64 0, inrange i32 0, i64 2), ptr %SubNodes.i, align 8, !tbaa !51
  ...
  store i64 8, ptr %_itemSize.i.i.i11.i, align 8, !tbaa !50
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard5CItemEE, i64 0, inrange i32 0, i64 2), ptr %IncludeItems.i, align 8, !tbaa !51
  ...
  store i64 8, ptr %_itemSize.i.i.i13.i, align 8, !tbaa !50
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard5CItemEE, i64 0, inrange i32 0, i64 2), ptr %ExcludeItems.i, align 8, !tbaa !51
...
entry:
  ...
  %0 = load ptr, ptr %item, align 8, !tbaa !53
  store ptr %0, ptr %call, align 8, !tbaa !53
...
.noexc:                                           ; preds = %while.cond.i.i
  ...
  store i64 8, ptr %_itemSize.i.i.i16, align 8, !tbaa !50
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard11CCensorNodeEE, i64 0, inrange i32 0, i64 2), ptr %SubNodes.i, align 8, !tbaa !51
...
call4.i.noexc:                                    ; preds = %for.body.i
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %invoke.cont.i, label %for.body.i, !llvm.loop !57
...
invoke.cont.i:                                    ; preds = %call4.i.noexc, %for.cond.i.preheader
  ...
  store i64 8, ptr %_itemSize.i.i.i8, align 8, !tbaa !50
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard5CItemEE, i64 0, inrange i32 0, i64 2), ptr %IncludeItems.i, align 8, !tbaa !51
...
invoke.cont7.i:                                   ; preds = %.noexc.i10
  ...
  store i64 8, ptr %_itemSize.i.i.i, align 8, !tbaa !50
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard5CItemEE, i64 0, inrange i32 0, i64 2), ptr %ExcludeItems.i, align 8, !tbaa !51
...
entry:
  %ExcludeItems = getelementptr inbounds %"class.NWildcard::CCensorNode", ptr %this, i64 0, i32 4
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard5CItemEE, i64 0, inrange i32 0, i64 2), ptr %ExcludeItems, align 8, !tbaa !51
...
_ZN13CObjectVectorIN9NWildcard5CItemEED2Ev.exit:  ; preds = %entry
  ...
  %IncludeItems = getelementptr inbounds %"class.NWildcard::CCensorNode", ptr %this, i64 0, i32 3
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard5CItemEE, i64 0, inrange i32 0, i64 2), ptr %IncludeItems, align 8, !tbaa !51
...
_ZN13CObjectVectorIN9NWildcard5CItemEED2Ev.exit3: ; preds = %_ZN13CObjectVectorIN9NWildcard5CItemEED2Ev.exit
  ...
  %SubNodes = getelementptr inbounds %"class.NWildcard::CCensorNode", ptr %this, i64 0, i32 2
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard11CCensorNodeEE, i64 0, inrange i32 0, i64 2), ptr %SubNodes, align 8, !tbaa !51
...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %_capacity.i.i.i.i, i8 0, i64 16, i1 false)
  store i64 8, ptr %_itemSize.i.i.i.i, align 8, !tbaa !50
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorI11CStringBaseIwEE, i64 0, inrange i32 0, i64 2), ptr %item, align 8, !tbaa !51
...
invoke.cont:                                      ; preds = %entry
  ...
  store i8 %frombool2, ptr %ForFile, align 1, !tbaa !45
...
entry:
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorI11CStringBaseIwEE, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !51
...
for.inc.i:                                        ; preds = %_Z16CompareFileNamesRK11CStringBaseIwES2_.exit.i
  ...
  br i1 %cmp.not.i59, label %for.body.i57, label %if.end21, !llvm.loop !49
...
if.then12:                                        ; preds = %_ZNK9NWildcard11CCensorNode11FindSubNodeERK11CStringBaseIwE.exit
  ...
  store i64 8, ptr %_itemSize.i.i.i, align 8, !tbaa !50
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorI11CStringBaseIwEE, i64 0, inrange i32 0, i64 2), ptr %pathParts2, align 8, !tbaa !51
...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %_capacity.i.i.i, i8 0, i64 16, i1 false)
  store i64 8, ptr %_itemSize.i.i.i, align 8, !tbaa !50
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorI11CStringBaseIwEE, i64 0, inrange i32 0, i64 2), ptr %pathParts, align 8, !tbaa !51
...
entry:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %_capacity.i.i.i.i, i8 0, i64 16, i1 false)
  store i64 8, ptr %_itemSize.i.i.i.i, align 8, !tbaa !50
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorI11CStringBaseIwEE, i64 0, inrange i32 0, i64 2), ptr %pathParts.i, align 8, !tbaa !51
...
if.end:                                           ; preds = %for.cond.i, %tailrecurse
  %5 = load ptr, ptr %this.tr, align 8, !tbaa !53
...
_ZN13CObjectVectorI11CStringBaseIwEE6InsertEiRKS1_.exit: ; preds = %while.cond.i.i.i
  ...
  %15 = load ptr, ptr %this.tr, align 8, !tbaa !53
  br label %tailrecurse
...
if.end14:                                         ; preds = %_ZN11CStringBaseIwE6DeleteEii.exit, %_ZN11CStringBaseIwEC2ERKS0_.exit
  ...
  store i64 8, ptr %_itemSize.i.i.i.i.i, align 8, !tbaa !50
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorI11CStringBaseIwEE, i64 0, inrange i32 0, i64 2), ptr %item.i, align 8, !tbaa !51
...
invoke.cont.i:                                    ; preds = %if.end14
  ...
  store i8 %frombool2.i, ptr %ForFile.i, align 1, !tbaa !45
...
for.inc.i:                                        ; preds = %_Z16CompareFileNamesRK11CStringBaseIwES2_.exit.i
  ...
  br i1 %cmp.not.i, label %for.body.i, label %if.then, !llvm.loop !49
...
for.body.lr.ph.i.i.i:                             ; preds = %for.cond.preheader.i.i.i
  ...
  %or.cond = select i1 %min.iters.check308, i1 true, i1 %diff.check305
...
invoke.cont88:                                    ; preds = %_ZN11CStringBaseIwEC2ERKS0_.exit.i
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %_capacity.i.i.i.i.i, i8 0, i64 16, i1 false)
  store i64 8, ptr %_itemSize.i.i.i.i.i, align 8, !tbaa !50
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard11CCensorNodeEE, i64 0, inrange i32 0, i64 2), ptr %SubNodes.i.i, align 8, !tbaa !51
  ...
  store i64 8, ptr %_itemSize.i.i.i11.i.i, align 8, !tbaa !50
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard5CItemEE, i64 0, inrange i32 0, i64 2), ptr %IncludeItems.i.i, align 8, !tbaa !51
  ...
  store i64 8, ptr %_itemSize.i.i.i13.i.i, align 8, !tbaa !50
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard5CItemEE, i64 0, inrange i32 0, i64 2), ptr %ExcludeItems.i.i, align 8, !tbaa !51
...
invoke.cont98:                                    ; preds = %.noexc
  ...
  store i8 %frombool101, ptr %ForFile, align 1, !tbaa !45
  %Recursive = getelementptr inbounds %"struct.NWildcard::CItem", ptr %item, i64 0, i32 1
  store i8 %frombool1, ptr %Recursive, align 8, !tbaa !41
...
entry:
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard5CItemEE, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !51
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %this)
          to label %invoke.cont unwind label %terminate.lpad
...
entry:
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard11CCensorNodeEE, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !51
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %this)
          to label %invoke.cont unwind label %terminate.lpad
...
call4.i.noexc.i:                                  ; preds = %for.body.i.i
  %indvars.iv.next.i.i = add nuw nsw i64 %indvars.iv.i.i, 1
  %exitcond.not.i.i = icmp eq i64 %indvars.iv.next.i.i, %wide.trip.count.i.i
  br i1 %exitcond.not.i.i, label %invoke.cont, label %for.body.i.i, !llvm.loop !57
...
invoke.cont:                                      ; preds = %call4.i.noexc.i, %.noexc4.i
  ...
  store i64 8, ptr %_itemSize.i.i.i21, align 8, !tbaa !50
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard5CItemEE, i64 0, inrange i32 0, i64 2), ptr %IncludeItems, align 8, !tbaa !51
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %IncludeItems)
...
invoke.cont7:                                     ; preds = %.noexc.i22
  ...
  store i64 8, ptr %_itemSize.i.i.i26, align 8, !tbaa !50
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN9NWildcard5CItemEE, i64 0, inrange i32 0, i64 2), ptr %ExcludeItems, align 8, !tbaa !51
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %ExcludeItems)
