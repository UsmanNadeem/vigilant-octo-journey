; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/UI/Common/UpdateCallback.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/UI/Common/UpdateCallback.cpp"
...
if.then17:                                        ; preds = %if.end15
  ...
  %9 = load i32, ptr %ArcIndex.i, align 4, !tbaa !44
...
if.then20:                                        ; preds = %if.then17
  ...
  %10 = load ptr, ptr %ArcItems, align 8, !tbaa !45
...
if.end19:                                         ; preds = %if.then11, %if.then11, %if.end
  ...
  %4 = load i32, ptr %DirIndex.i, align 4, !tbaa !51
  %cmp.i.not = icmp eq i32 %4, -1
  br i1 %cmp.i.not, label %if.else, label %if.then22

if.then22:                                        ; preds = %if.end19
  %DirItems = getelementptr inbounds %class.CArchiveUpdateCallback, ptr %this, i64 0, i32 11
  %5 = load ptr, ptr %DirItems, align 8, !tbaa !52
...
sw.bb36:                                          ; preds = %if.then22
  ...
  %14 = load i32, ptr %Attrib.i, align 8, !tbaa !53
  %and.i = and i32 %14, 16
...
sw.bb44:                                          ; preds = %if.then22
  ...
  %16 = load i32, ptr %Attrib, align 8, !tbaa !53
...
if.then59:                                        ; preds = %if.else
  ...
  %19 = load i32, ptr %NewNameIndex, align 4, !tbaa !58
...
if.then61:                                        ; preds = %if.then59
  ...
  %20 = load ptr, ptr %NewNames, align 8, !tbaa !59
...
if.end72:                                         ; preds = %if.then59, %if.else
  ...
  %24 = load i32, ptr %ArcIndex.i, align 4, !tbaa !44
...
cleanup.cont19:                                   ; preds = %invoke.cont12
  %IsAnti = getelementptr inbounds %struct.CUpdatePair2, ptr %1, i64 %idxprom.i, i32 2
  %10 = load i8, ptr %IsAnti, align 2, !tbaa !50, !range !40, !noundef !41
...
invoke.cont23:                                    ; preds = %cleanup.cont19
  ...
  %ArcItems = getelementptr inbounds %class.CArchiveUpdateCallback, ptr %this, i64 0, i32 12
  %12 = load ptr, ptr %ArcItems, align 8, !tbaa !45
  %ArcIndex = getelementptr inbounds %struct.CUpdatePair2, ptr %1, i64 %idxprom.i, i32 4
  %13 = load i32, ptr %ArcIndex, align 4, !tbaa !44
...
if.end31:                                         ; preds = %cleanup.cont19
  %DirItems = getelementptr inbounds %class.CArchiveUpdateCallback, ptr %this, i64 0, i32 11
  %18 = load ptr, ptr %DirItems, align 8, !tbaa !52
  %DirIndex = getelementptr inbounds %struct.CUpdatePair2, ptr %1, i64 %idxprom.i, i32 3
  %19 = load i32, ptr %DirIndex, align 4, !tbaa !51
...
cleanup.cont53:                                   ; preds = %_ZN11CStringBaseIwED2Ev.exit
  ...
  %29 = load i32, ptr %Attrib.i, align 8, !tbaa !53
  %and.i = and i32 %29, 16
...
invoke.cont84:                                    ; preds = %invoke.cont80
  ...
  %36 = load ptr, ptr %DirItems, align 8, !tbaa !52
  %37 = load i32, ptr %DirIndex, align 4, !tbaa !51
...
invoke.cont20:                                    ; preds = %if.end.i.i134.invoke.cont20_crit_edge, %if.end9.i.i.i136
  ...
  %29 = sub i32 -2, %19
  %sub2.i.i142 = add i32 %fileName.sroa.27.1, %29
...
if.end.i.i.i159:                                  ; preds = %if.end.i.i156
  ...
  %30 = icmp slt i32 %add18.i.i153, -1
  %31 = shl nuw nsw i64 %conv.i.i.i157, 2
  %32 = select i1 %30, i64 -1, i64 %31
  %call.i.i.i183 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %32) #16
...
for.body.lr.ph.i.i.i163:                          ; preds = %for.cond.preheader.i.i.i161
  ...
  %33 = sub i64 %call.i.i.i183422, %fileName.sroa.0.1423
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %34 = getelementptr inbounds i32, ptr %fileName.sroa.0.1, i64 %index424
  %wide.load = load <4 x i32>, ptr %34, align 4, !tbaa !18
  %35 = getelementptr inbounds i32, ptr %34, i64 4
  %wide.load425 = load <4 x i32>, ptr %35, align 4, !tbaa !18
  %36 = getelementptr inbounds i32, ptr %call.i.i.i183, i64 %index424
  store <4 x i32> %wide.load, ptr %36, align 4, !tbaa !18
  %37 = getelementptr inbounds i32, ptr %36, i64 4
  store <4 x i32> %wide.load425, ptr %37, align 4, !tbaa !18
  %index.next = add nuw i64 %index424, 8
  %38 = icmp eq i64 %index.next, %n.vec
  br i1 %38, label %middle.block, label %vector.body, !llvm.loop !83
...
for.body.i.i.i171.preheader:                      ; preds = %for.body.lr.ph.i.i.i163, %middle.block
  ...
  %39 = xor i64 %indvars.iv.i.i.i166.ph, -1
  %40 = add nsw i64 %39, %wide.trip.count.i.i.i162
...
for.body.i.i.i171.prol:                           ; preds = %for.body.i.i.i171.preheader, %for.body.i.i.i171.prol
  ...
  %41 = load i32, ptr %arrayidx.i.i.i167.prol, align 4, !tbaa !18
  %arrayidx7.i.i.i168.prol = getelementptr inbounds i32, ptr %call.i.i.i183, i64 %indvars.iv.i.i.i166.prol
  store i32 %41, ptr %arrayidx7.i.i.i168.prol, align 4, !tbaa !18
...
for.body.i.i.i171.prol.loopexit:                  ; preds = %for.body.i.i.i171.prol, %for.body.i.i.i171.preheader
  ...
  br i1 %42, label %delete.notnull.i.i.i173, label %for.body.i.i.i171
...
for.body.i.i.i171:                                ; preds = %for.body.i.i.i171.prol.loopexit, %for.body.i.i.i171
  ...
  %43 = load i32, ptr %arrayidx.i.i.i167, align 4, !tbaa !18
  %arrayidx7.i.i.i168 = getelementptr inbounds i32, ptr %call.i.i.i183, i64 %indvars.iv.i.i.i166
  store i32 %43, ptr %arrayidx7.i.i.i168, align 4, !tbaa !18
  ...
  %44 = load i32, ptr %arrayidx.i.i.i167.1, align 4, !tbaa !18
  %arrayidx7.i.i.i168.1 = getelementptr inbounds i32, ptr %call.i.i.i183, i64 %indvars.iv.next.i.i.i169
  store i32 %44, ptr %arrayidx7.i.i.i168.1, align 4, !tbaa !18
  ...
  %45 = load i32, ptr %arrayidx.i.i.i167.2, align 4, !tbaa !18
  %arrayidx7.i.i.i168.2 = getelementptr inbounds i32, ptr %call.i.i.i183, i64 %indvars.iv.next.i.i.i169.1
  store i32 %45, ptr %arrayidx7.i.i.i168.2, align 4, !tbaa !18
  ...
  %46 = load i32, ptr %arrayidx.i.i.i167.3, align 4, !tbaa !18
  %arrayidx7.i.i.i168.3 = getelementptr inbounds i32, ptr %call.i.i.i183, i64 %indvars.iv.next.i.i.i169.2
  store i32 %46, ptr %arrayidx7.i.i.i168.3, align 4, !tbaa !18
...
while.cond.i.i181:                                ; preds = %while.cond.i.i181, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i
  ...
  %47 = load i32, ptr %src.addr.0.i.i177, align 4, !tbaa !18
  %incdec.ptr1.i.i180 = getelementptr inbounds i32, ptr %dest.addr.0.i.i178, i64 1
  store i32 %47, ptr %dest.addr.0.i.i178, align 4, !tbaa !18
  %cmp.not.i8.i = icmp eq i32 %47, 0
...
invoke.cont22:                                    ; preds = %while.cond.i.i181
  ...
  %48 = load i32, ptr %_length.i184, align 8, !tbaa !82
  %49 = xor i32 %add.i, -1
  %sub2.i.i187 = add i32 %fileName.sroa.27.2, %49
  %cmp.not.i.i188 = icmp sgt i32 %48, %sub2.i.i187
...
if.end.i.i201:                                    ; preds = %invoke.cont22
  ...
  %cmp13.i.i195 = icmp slt i32 %add.i.i194, %48
  %sub15.i.i196 = sub nsw i32 %48, %sub2.i.i187
...
if.end.i.i.i204:                                  ; preds = %if.end.i.i201
  ...
  %50 = icmp slt i32 %add18.i.i198, -1
  %51 = shl nuw nsw i64 %conv.i.i.i202, 2
  %52 = select i1 %50, i64 -1, i64 %51
  %call.i.i.i233 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %52) #16
...
for.body.lr.ph.i.i.i208:                          ; preds = %for.cond.preheader.i.i.i206
  ...
  %53 = sub i64 %call.i.i.i233427, %fileName.sroa.0.2428
  %diff.check429 = icmp ult i64 %53, 32
...
vector.body438:                                   ; preds = %vector.body438, %vector.ph433
  ...
  %54 = getelementptr inbounds i32, ptr %fileName.sroa.0.2, i64 %index439
  %wide.load440 = load <4 x i32>, ptr %54, align 4, !tbaa !18
  %55 = getelementptr inbounds i32, ptr %54, i64 4
  %wide.load441 = load <4 x i32>, ptr %55, align 4, !tbaa !18
  %56 = getelementptr inbounds i32, ptr %call.i.i.i233, i64 %index439
  store <4 x i32> %wide.load440, ptr %56, align 4, !tbaa !18
  %57 = getelementptr inbounds i32, ptr %56, i64 4
  store <4 x i32> %wide.load441, ptr %57, align 4, !tbaa !18
  %index.next442 = add nuw i64 %index439, 8
  %58 = icmp eq i64 %index.next442, %n.vec435
  br i1 %58, label %middle.block430, label %vector.body438, !llvm.loop !89
...
for.body.i.i.i216.preheader:                      ; preds = %for.body.lr.ph.i.i.i208, %middle.block430
  ...
  %59 = xor i64 %indvars.iv.i.i.i211.ph, -1
  %60 = add nsw i64 %59, %wide.trip.count.i.i.i207
...
for.body.i.i.i216.prol:                           ; preds = %for.body.i.i.i216.preheader, %for.body.i.i.i216.prol
  ...
  %61 = load i32, ptr %arrayidx.i.i.i212.prol, align 4, !tbaa !18
  %arrayidx7.i.i.i213.prol = getelementptr inbounds i32, ptr %call.i.i.i233, i64 %indvars.iv.i.i.i211.prol
  store i32 %61, ptr %arrayidx7.i.i.i213.prol, align 4, !tbaa !18
...
for.body.i.i.i216.prol.loopexit:                  ; preds = %for.body.i.i.i216.prol, %for.body.i.i.i216.preheader
  ...
  br i1 %62, label %delete.notnull.i.i.i218, label %for.body.i.i.i216
...
for.body.i.i.i216:                                ; preds = %for.body.i.i.i216.prol.loopexit, %for.body.i.i.i216
  ...
  %63 = load i32, ptr %arrayidx.i.i.i212, align 4, !tbaa !18
  %arrayidx7.i.i.i213 = getelementptr inbounds i32, ptr %call.i.i.i233, i64 %indvars.iv.i.i.i211
  store i32 %63, ptr %arrayidx7.i.i.i213, align 4, !tbaa !18
  ...
  %64 = load i32, ptr %arrayidx.i.i.i212.1, align 4, !tbaa !18
  %arrayidx7.i.i.i213.1 = getelementptr inbounds i32, ptr %call.i.i.i233, i64 %indvars.iv.next.i.i.i214
  store i32 %64, ptr %arrayidx7.i.i.i213.1, align 4, !tbaa !18
  ...
  %65 = load i32, ptr %arrayidx.i.i.i212.2, align 4, !tbaa !18
  %arrayidx7.i.i.i213.2 = getelementptr inbounds i32, ptr %call.i.i.i233, i64 %indvars.iv.next.i.i.i214.1
  store i32 %65, ptr %arrayidx7.i.i.i213.2, align 4, !tbaa !18
  ...
  %66 = load i32, ptr %arrayidx.i.i.i212.3, align 4, !tbaa !18
  %arrayidx7.i.i.i213.3 = getelementptr inbounds i32, ptr %call.i.i.i233, i64 %indvars.iv.next.i.i.i214.2
  store i32 %66, ptr %arrayidx7.i.i.i213.3, align 4, !tbaa !18
...
_ZN11CStringBaseIwE10GrowLengthEi.exit.i224:      ; preds = %if.end9.i.i.i221, %if.end.i.i201, %invoke.cont22
  ...
  %67 = load ptr, ptr %VolExt, align 8, !tbaa !16
  br label %while.cond.i.i230

while.cond.i.i230:                                ; preds = %while.cond.i.i230, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i224
  %src.addr.0.i.i225 = phi ptr [ %67, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i224 ], [ %incdec.ptr.i.i227, %while.cond.i.i230 ]
  ...
  %68 = load i32, ptr %src.addr.0.i.i225, align 4, !tbaa !18
  %incdec.ptr1.i.i228 = getelementptr inbounds i32, ptr %dest.addr.0.i.i226, i64 1
  store i32 %68, ptr %dest.addr.0.i.i226, align 4, !tbaa !18
  %cmp.not.i8.i229 = icmp eq i32 %68, 0
...
invoke.cont27:                                    ; preds = %invoke.cont24
  %69 = getelementptr inbounds i8, ptr %call28, i64 8
...
invoke.cont30:                                    ; preds = %invoke.cont27
  ...
  %70 = load ptr, ptr getelementptr inbounds ({ [10 x ptr] }, ptr @_ZTV14COutFileStream, i64 0, inrange i32 0, i64 3), align 8
  %call.i236237 = invoke noundef i32 %70(ptr noundef nonnull align 8 dereferenceable(8) %call28)
...
if.then.i:                                        ; preds = %invoke.cont33
  ...
  %77 = load ptr, ptr %vfn.i243, align 8
  %call.i244 = invoke noundef i32 %77(ptr noundef nonnull align 8 dereferenceable(8) %call28)
...
if.then.i249:                                     ; preds = %invoke.cont37
  ...
  %80 = load i32, ptr %call.i241, align 4, !tbaa !42
  %vtable.i246 = load ptr, ptr %call28, align 8, !tbaa !10
  %vfn.i247 = getelementptr inbounds ptr, ptr %vtable.i246, i64 2
  %81 = load ptr, ptr %vfn.i247, align 8
  %call.i248 = invoke noundef i32 %81(ptr noundef nonnull align 8 dereferenceable(8) %call28)
...
_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit251: ; preds = %cleanup.thread, %if.then.i249
  %retval.0362 = phi i32 [ 0, %cleanup.thread ], [ %80, %if.then.i249 ]
...
ehcleanup49:                                      ; preds = %lpad32, %if.then.i, %lpad26, %lpad29, %lpad19
  ...
  %.pn.pn.pn = phi { ptr, i32 } [ %74, %lpad29 ], [ %73, %lpad26 ], [ %72, %lpad19 ], [ %76, %if.then.i ], [ %75, %lpad32 ]
...
ehcleanup53:                                      ; preds = %lpad17, %ehcleanup49, %delete.notnull.i259, %lpad8, %_ZN11CStringBaseIwED2Ev.exit112
  ...
  %.pn73.pn.pn = phi { ptr, i32 } [ %.pn73, %_ZN11CStringBaseIwED2Ev.exit112 ], [ %16, %lpad8 ], [ %71, %lpad17 ], [ %.pn.pn.pn, %ehcleanup49 ], [ %.pn.pn.pn, %delete.notnull.i259 ]
...
ehcleanup57:                                      ; preds = %lpad3, %ehcleanup53, %delete.notnull.i262, %lpad
  ...
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %temp) #18
  %84 = call i32 @llvm.eh.typeid.for(ptr nonnull @_ZTIPKc) #18
  %matches = icmp eq i32 %ehselector.slot.8, %84
  %85 = call ptr @__cxa_begin_catch(ptr %exn.slot.8) #18
  br i1 %matches, label %catch59, label %catch

catch59:                                          ; preds = %ehcleanup57
  %exception = call ptr @__cxa_allocate_exception(i64 8) #18
  store ptr %85, ptr %exception, align 16, !tbaa !35
  invoke void @__cxa_throw(ptr nonnull %exception, ptr nonnull @_ZTIPKc, ptr null) #19
...
entry:
  ...
  %Archive = getelementptr inbounds %class.CArchiveUpdateCallback, ptr %this, i64 0, i32 15
  %0 = load ptr, ptr %Archive, align 8, !tbaa !60
...
entry:
  ...
  %0 = load ptr, ptr %Archive.i, align 8, !tbaa !60
...
entry:
  ...
  %1 = load ptr, ptr %Archive.i, align 8, !tbaa !60
...
entry:
  ...
  %1 = load ptr, ptr %Archive.i.i, align 8, !tbaa !60
