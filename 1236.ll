; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr62151.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr62151.c"
...
for.cond.us.us.i:                                 ; preds = %entry.split.us.i
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %j.i) #3
...
if.end:                                           ; preds = %for.inc.us.us.preheader.i, %for.cond.us.us.i
  ...
  store i32 -1, ptr @g, align 4, !tbaa !9
  store i32 %2, ptr @e, align 4, !tbaa !9
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %j.i) #3
  ret i32 0
}
