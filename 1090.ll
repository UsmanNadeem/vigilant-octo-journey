; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/xgets.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/xgets.c"
...
for.cond.outer.split:                             ; preds = %for.cond.outer
  ...
  %call8.us243 = tail call i32 @_IO_getc(ptr noundef %4)
  %cmp9.not.us244 = icmp eq i32 %call8.us243, -1
...
if.else.us:                                       ; preds = %if.then20.us
  ...
  %call8.us = tail call i32 @_IO_getc(ptr noundef %8)
...
for.cond.outer.split.split:                       ; preds = %for.cond.outer.split
  br i1 %cmp9.not.us244, label %if.then20, label %if.then11

if.then11:                                        ; preds = %if.else.us, %for.cond.outer.split.split, %for.cond.outer.split.split.us
  %.us-phi = phi i32 [ %call8.us243, %for.cond.outer.split.split.us ], [ %call8.us243, %for.cond.outer.split.split ], [ %call8.us, %if.else.us ]
...
land.lhs.true38:                                  ; preds = %if.end35
  %12 = load i32, ptr @xgets.Include_Len, align 4, !tbaa !5
  %13 = load ptr, ptr @xgets.Include_File, align 8, !tbaa !9
  %conv201 = zext i32 %12 to i64
  %call202 = tail call i32 @strncmp(ptr noundef %str, ptr noundef %13, i64 noundef %conv201) #5
  %cmp205 = icmp eq i32 %call202, 0
  br i1 %cmp205, label %if.then207, label %cleanup

if.then207:                                       ; preds = %land.lhs.true38
  %idx.ext = sext i32 %12 to i64
  %add.ptr208 = getelementptr inbounds i8, ptr %str, i64 %idx.ext
  %14 = load ptr, ptr @xgets.current_F, align 8, !tbaa !9
  %sub.ptr.lhs.cast209 = ptrtoint ptr %14 to i64
  %sub.ptr.sub210 = sub i64 %sub.ptr.lhs.cast209, ptrtoint (ptr @xgets.F to i64)
  %cmp211 = icmp slt i64 %sub.ptr.sub210, 40
  br i1 %cmp211, label %land.lhs.true213, label %for.cond.outer.backedge

for.cond.outer.backedge:                          ; preds = %if.then207, %land.lhs.true213, %if.then219, %if.then217, %if.then11
  %s.0.ph.be = phi ptr [ %incdec.ptr, %if.then11 ], [ %str, %if.then217 ], [ %str, %if.then219 ], [ %str, %land.lhs.true213 ], [ %str, %if.then207 ]
  br label %for.cond.outer

land.lhs.true213:                                 ; preds = %if.then207
  %char0 = load i8, ptr %add.ptr208, align 1
  %cmp215.not = icmp eq i8 %char0, 0
  br i1 %cmp215.not, label %for.cond.outer.backedge, label %if.then217

if.then217:                                       ; preds = %land.lhs.true213
  %call218 = tail call ptr @fopen(ptr noundef nonnull %add.ptr208, ptr noundef nonnull @.str.2)
  %tobool.not = icmp eq ptr %call218, null
  br i1 %tobool.not, label %for.cond.outer.backedge, label %if.then219

if.then219:                                       ; preds = %if.then217
  %15 = load ptr, ptr @xgets.current_F, align 8, !tbaa !9
  %incdec.ptr220 = getelementptr inbounds ptr, ptr %15, i64 1
  store ptr %incdec.ptr220, ptr @xgets.current_F, align 8, !tbaa !9
  store ptr %call218, ptr %incdec.ptr220, align 8, !tbaa !9
