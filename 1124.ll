; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/7z/7zHandler.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/7z/7zHandler.cpp"
...
define linkonce_odr dso_local void @_ZN8NArchive3N7z18CArchiveDatabaseExD2Ev(ptr noundef nonnull align 8 dereferenceable(696) %this) unnamed_addr #2 comdat align 2 {
entry:
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local void @_ZN8NArchive11COutHandlerD2Ev(ptr noundef nonnull align 8 dereferenceable(100) %this) unnamed_addr #2 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
...
define dso_local noundef i32 @_ZN8NArchive3N7z8CHandler16GetNumberOfItemsEPj(ptr nocapture noundef nonnull readonly align 8 dereferenceable(912) %this, ptr nocapture noundef writeonly %numItems) unnamed_addr #3 align 2 {
entry:
...
delete.notnull.i.i.i:                             ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i, %middle.block311, %for.cond.cleanup.i.i.i
  call void @_ZdaPv(ptr noundef nonnull %resString.sroa.0.0268) #24
...
if.end.i.i.i183:                                  ; preds = %if.end.i.i180
  ...
  %call.i.i.i208 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %60) #23
...
delete.notnull.i219:                              ; preds = %ehcleanup66.thread, %ehcleanup66
  ...
  call void @_ZdaPv(ptr noundef nonnull %resString.sroa.0.7246) #24
  br label %ehcleanup105
...
define dso_local noundef i32 @_ZN8NArchive3N7z8CHandler28GetNumberOfArchivePropertiesEPj(ptr nocapture nonnull readnone align 8 %this, ptr nocapture noundef writeonly %numProperties) unnamed_addr #7 align 2 {
entry:
...
define dso_local noundef i32 @_ZN8NArchive3N7z8CHandler22GetArchivePropertyInfoEjPPwPjPt(ptr nocapture nonnull readnone align 8 %this, i32 noundef %index, ptr nocapture noundef writeonly %name, ptr nocapture noundef writeonly %propID, ptr nocapture noundef writeonly %varType) unnamed_addr #8 align 2 {
entry:
...
define dso_local noundef zeroext i1 @_ZNK8NArchive3N7z8CHandler11IsEncryptedEj(ptr nocapture noundef nonnull readonly align 8 dereferenceable(912) %this, i32 noundef %index2) local_unnamed_addr #9 align 2 {
entry:
...
for.body.lr.ph.i:                                 ; preds = %if.then31
  ...
  %min.iters.check1894 = icmp ult i32 %18, 10
  br i1 %min.iters.check1894, label %for.body.i.preheader, label %vector.scevcheck
...
vector.scevcheck:                                 ; preds = %for.body.lr.ph.i
  ...
  %25 = or i1 %23, %24
  br i1 %25, label %for.body.i.preheader, label %vector.ph1895

vector.ph1895:                                    ; preds = %vector.scevcheck
  %n.vec1897 = and i64 %wide.trip.count.i, 4294967292
  br label %vector.body1900

vector.body1900:                                  ; preds = %vector.body1900, %vector.ph1895
  %offset.idx = phi i64 [ 0, %vector.ph1895 ], [ %index.next1905, %vector.body1900 ]
  %vec.phi = phi <2 x i64> [ zeroinitializer, %vector.ph1895 ], [ %31, %vector.body1900 ]
  %vec.phi1902 = phi <2 x i64> [ zeroinitializer, %vector.ph1895 ], [ %32, %vector.body1900 ]
  %26 = trunc i64 %offset.idx to i32
  %27 = add i32 %15, %26
  %28 = sext i32 %27 to i64
  %29 = getelementptr inbounds i64, ptr %19, i64 %28
  %wide.load1903 = load <2 x i64>, ptr %29, align 8, !tbaa !53
  %30 = getelementptr inbounds i64, ptr %29, i64 2
  %wide.load1904 = load <2 x i64>, ptr %30, align 8, !tbaa !53
  %31 = add <2 x i64> %wide.load1903, %vec.phi
  %32 = add <2 x i64> %wide.load1904, %vec.phi1902
  %index.next1905 = add nuw i64 %offset.idx, 4
  %33 = icmp eq i64 %index.next1905, %n.vec1897
  br i1 %33, label %middle.block1892, label %vector.body1900, !llvm.loop !90

middle.block1892:                                 ; preds = %vector.body1900
  %bin.rdx = add <2 x i64> %32, %31
  %34 = tail call i64 @llvm.vector.reduce.add.v2i64(<2 x i64> %bin.rdx)
  %cmp.n1899 = icmp eq i64 %n.vec1897, %wide.trip.count.i
  br i1 %cmp.n1899, label %if.else.invoke, label %for.body.i.preheader

for.body.i.preheader:                             ; preds = %vector.scevcheck, %for.body.lr.ph.i, %middle.block1892
  %indvars.iv.i.ph = phi i64 [ 0, %vector.scevcheck ], [ 0, %for.body.lr.ph.i ], [ %n.vec1897, %middle.block1892 ]
  %size.014.i.ph = phi i64 [ 0, %vector.scevcheck ], [ 0, %for.body.lr.ph.i ], [ %34, %middle.block1892 ]
  %35 = xor i64 %indvars.iv.i.ph, -1
  %36 = add nsw i64 %35, %wide.trip.count.i
  %xtraiter1992 = and i64 %wide.trip.count.i, 3
  %lcmp.mod1993.not = icmp eq i64 %xtraiter1992, 0
  br i1 %lcmp.mod1993.not, label %for.body.i.prol.loopexit, label %for.body.i.prol

for.body.i.prol:                                  ; preds = %for.body.i.preheader, %for.body.i.prol
  %indvars.iv.i.prol = phi i64 [ %indvars.iv.next.i.prol, %for.body.i.prol ], [ %indvars.iv.i.ph, %for.body.i.preheader ]
  %size.014.i.prol = phi i64 [ %add5.i.prol, %for.body.i.prol ], [ %size.014.i.ph, %for.body.i.preheader ]
  %prol.iter1994 = phi i64 [ %prol.iter1994.next, %for.body.i.prol ], [ 0, %for.body.i.preheader ]
  ...
  br i1 %prol.iter1994.cmp.not, label %for.body.i.prol.loopexit, label %for.body.i.prol, !llvm.loop !91
...
if.else.invoke:                                   ; preds = %for.body.i.prol.loopexit, %for.body.i, %middle.block1892, %if.then31, %sw.bb21
  %52 = phi i64 [ 0, %sw.bb21 ], [ 0, %if.then31 ], [ %34, %middle.block1892 ], [ %add5.i.lcssa.unr, %for.body.i.prol.loopexit ], [ %add5.i.3, %for.body.i ]
...
_ZNK8NArchive3N7z16CArchiveDatabase10IsItemAntiEi.exit.invoke.sink.split: ; preds = %sw.bb15, %land.rhs.i
  ...
  %92 = load i8, ptr %arrayidx.i.i572.sink, align 1, !tbaa !93, !range !94
...
invoke.cont98:                                    ; preds = %invoke.cont95
  ...
  %cmp1021582 = icmp sgt i32 %100, 0
  br i1 %cmp1021582, label %invoke.cont105.lr.ph, label %for.cond.cleanup
...
for.cond.cleanup.loopexit:                        ; preds = %_ZN11CStringBaseIwED2Ev.exit1323
  %.pre1644 = load ptr, ptr %methodsString, align 8, !tbaa !55
  br label %for.cond.cleanup

for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %invoke.cont98
  %103 = phi ptr [ %.pre1644, %for.cond.cleanup.loopexit ], [ %call.i.i579, %invoke.cont98 ]
...
call.i.i.i.noexc:                                 ; preds = %if.end.i.i.i
  %call.i.i.i5891877 = ptrtoint ptr %call.i.i.i589 to i64
...
for.body.lr.ph.i.i.i:                             ; preds = %for.cond.preheader.i.i.i
  ...
  %min.iters.check1881 = icmp ult i32 %107, 8
  %115 = sub i64 %call.i.i.i5891877, %114
  %diff.check1878 = icmp ult i64 %115, 32
  %or.cond1906 = select i1 %min.iters.check1881, i1 true, i1 %diff.check1878
  br i1 %or.cond1906, label %for.body.i.i.i.preheader, label %vector.ph1882

vector.ph1882:                                    ; preds = %for.body.lr.ph.i.i.i
  %n.vec1884 = and i64 %wide.trip.count.i.i.i, 4294967288
  br label %vector.body1887

vector.body1887:                                  ; preds = %vector.body1887, %vector.ph1882
  %index1888 = phi i64 [ 0, %vector.ph1882 ], [ %index.next1891, %vector.body1887 ]
  %116 = getelementptr inbounds i32, ptr %113, i64 %index1888
  %wide.load1889 = load <4 x i32>, ptr %116, align 4, !tbaa !47
  %117 = getelementptr inbounds i32, ptr %116, i64 4
  %wide.load1890 = load <4 x i32>, ptr %117, align 4, !tbaa !47
  %118 = getelementptr inbounds i32, ptr %call.i.i.i589, i64 %index1888
  store <4 x i32> %wide.load1889, ptr %118, align 4, !tbaa !47
  %119 = getelementptr inbounds i32, ptr %118, i64 4
  store <4 x i32> %wide.load1890, ptr %119, align 4, !tbaa !47
  %index.next1891 = add nuw i64 %index1888, 8
  %120 = icmp eq i64 %index.next1891, %n.vec1884
  br i1 %120, label %middle.block1879, label %vector.body1887, !llvm.loop !101

middle.block1879:                                 ; preds = %vector.body1887
  %cmp.n1886 = icmp eq i64 %n.vec1884, %wide.trip.count.i.i.i
  br i1 %cmp.n1886, label %delete.notnull.i.i.i, label %for.body.i.i.i.preheader

for.body.i.i.i.preheader:                         ; preds = %for.body.lr.ph.i.i.i, %middle.block1879
  %indvars.iv.i.i.i.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i ], [ %n.vec1884, %middle.block1879 ]
...
delete.notnull.i.i.i:                             ; preds = %for.body.i.i.i.prol.loopexit, %for.body.i.i.i, %middle.block1879, %for.cond.cleanup.i.i.i
...
_ZN11CStringBaseIwEpLEw.exit:                     ; preds = %if.then109, %if.end.i.i, %if.end9.i.i.i
  ...
  store <2 x i32> <i32 32, i32 0>, ptr %arrayidx.i588, align 4, !tbaa !47
  br label %if.end112
...
if.end.i.i.i616:                                  ; preds = %if.end.i.i613
  ...
  %call.i.i.i636 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %141) #23
          to label %call.i.i.i.noexc635 unwind label %lpad126

call.i.i.i.noexc635:                              ; preds = %if.end.i.i.i616
  %call.i.i.i6361861 = ptrtoint ptr %call.i.i.i636 to i64
...
for.body.lr.ph.i.i.i620:                          ; preds = %for.cond.preheader.i.i.i618
  ...
  %min.iters.check1865 = icmp ult i32 %137, 8
  %144 = sub i64 %call.i.i.i6361861, %143
  %diff.check1862 = icmp ult i64 %144, 32
  %or.cond1907 = select i1 %min.iters.check1865, i1 true, i1 %diff.check1862
  br i1 %or.cond1907, label %for.body.i.i.i628.preheader, label %vector.ph1866

vector.ph1866:                                    ; preds = %for.body.lr.ph.i.i.i620
  %n.vec1868 = and i64 %wide.trip.count.i.i.i619, 4294967288
...
vector.body1871:                                  ; preds = %vector.body1871, %vector.ph1866
  ...
  %145 = getelementptr inbounds i32, ptr %142, i64 %index1872
  %wide.load1873 = load <4 x i32>, ptr %145, align 4, !tbaa !47
  %146 = getelementptr inbounds i32, ptr %145, i64 4
  %wide.load1874 = load <4 x i32>, ptr %146, align 4, !tbaa !47
  %147 = getelementptr inbounds i32, ptr %call.i.i.i636, i64 %index1872
  store <4 x i32> %wide.load1873, ptr %147, align 4, !tbaa !47
  %148 = getelementptr inbounds i32, ptr %147, i64 4
  store <4 x i32> %wide.load1874, ptr %148, align 4, !tbaa !47
  %index.next1875 = add nuw i64 %index1872, 8
  %149 = icmp eq i64 %index.next1875, %n.vec1868
  br i1 %149, label %middle.block1863, label %vector.body1871, !llvm.loop !104

middle.block1863:                                 ; preds = %vector.body1871
  %cmp.n1870 = icmp eq i64 %n.vec1868, %wide.trip.count.i.i.i619
  br i1 %cmp.n1870, label %delete.notnull.i.i.i630, label %for.body.i.i.i628.preheader

for.body.i.i.i628.preheader:                      ; preds = %for.body.lr.ph.i.i.i620, %middle.block1863
  %indvars.iv.i.i.i623.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i620 ], [ %n.vec1868, %middle.block1863 ]
  %150 = xor i64 %indvars.iv.i.i.i623.ph, -1
  %151 = add nsw i64 %150, %wide.trip.count.i.i.i619
  %xtraiter1965 = and i64 %wide.trip.count.i.i.i619, 3
  %lcmp.mod1966.not = icmp eq i64 %xtraiter1965, 0
  br i1 %lcmp.mod1966.not, label %for.body.i.i.i628.prol.loopexit, label %for.body.i.i.i628.prol
...
for.body.i.i.i628.prol:                           ; preds = %for.body.i.i.i628.preheader, %for.body.i.i.i628.prol
  ...
  %prol.iter1967 = phi i64 [ %prol.iter1967.next, %for.body.i.i.i628.prol ], [ 0, %for.body.i.i.i628.preheader ]
  ...
  %prol.iter1967.next = add i64 %prol.iter1967, 1
  %prol.iter1967.cmp.not = icmp eq i64 %prol.iter1967.next, %xtraiter1965
  br i1 %prol.iter1967.cmp.not, label %for.body.i.i.i628.prol.loopexit, label %for.body.i.i.i628.prol, !llvm.loop !105
...
delete.notnull.i.i.i630:                          ; preds = %for.body.i.i.i628.prol.loopexit, %for.body.i.i.i628, %middle.block1863, %for.cond.cleanup.i.i.i622
...
if.end.i.i.i663:                                  ; preds = %if.end.i.i660
  ...
  %call.i.i.i692 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %176) #23
          to label %call.i.i.i.noexc691 unwind label %lpad117

call.i.i.i.noexc691:                              ; preds = %if.end.i.i.i663
  %call.i.i.i6921845 = ptrtoint ptr %call.i.i.i692 to i64
...
for.body.lr.ph.i.i.i667:                          ; preds = %for.cond.preheader.i.i.i665
  ...
  %min.iters.check1849 = icmp ult i32 %172, 8
  %179 = sub i64 %call.i.i.i6921845, %178
  %diff.check1846 = icmp ult i64 %179, 32
  %or.cond1908 = select i1 %min.iters.check1849, i1 true, i1 %diff.check1846
  br i1 %or.cond1908, label %for.body.i.i.i675.preheader, label %vector.ph1850

vector.ph1850:                                    ; preds = %for.body.lr.ph.i.i.i667
  %n.vec1852 = and i64 %wide.trip.count.i.i.i666, 4294967288
  br label %vector.body1855

vector.body1855:                                  ; preds = %vector.body1855, %vector.ph1850
  %index1856 = phi i64 [ 0, %vector.ph1850 ], [ %index.next1859, %vector.body1855 ]
  %180 = getelementptr inbounds i32, ptr %177, i64 %index1856
  %wide.load1857 = load <4 x i32>, ptr %180, align 4, !tbaa !47
  %181 = getelementptr inbounds i32, ptr %180, i64 4
  %wide.load1858 = load <4 x i32>, ptr %181, align 4, !tbaa !47
  %182 = getelementptr inbounds i32, ptr %call.i.i.i692, i64 %index1856
  store <4 x i32> %wide.load1857, ptr %182, align 4, !tbaa !47
  %183 = getelementptr inbounds i32, ptr %182, i64 4
  store <4 x i32> %wide.load1858, ptr %183, align 4, !tbaa !47
  %index.next1859 = add nuw i64 %index1856, 8
  %184 = icmp eq i64 %index.next1859, %n.vec1852
  br i1 %184, label %middle.block1847, label %vector.body1855, !llvm.loop !107

middle.block1847:                                 ; preds = %vector.body1855
  %cmp.n1854 = icmp eq i64 %n.vec1852, %wide.trip.count.i.i.i666
  br i1 %cmp.n1854, label %delete.notnull.i.i.i677, label %for.body.i.i.i675.preheader

for.body.i.i.i675.preheader:                      ; preds = %for.body.lr.ph.i.i.i667, %middle.block1847
  %indvars.iv.i.i.i670.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i667 ], [ %n.vec1852, %middle.block1847 ]
  %185 = xor i64 %indvars.iv.i.i.i670.ph, -1
  %186 = add nsw i64 %185, %wide.trip.count.i.i.i666
  %xtraiter1968 = and i64 %wide.trip.count.i.i.i666, 3
  %lcmp.mod1969.not = icmp eq i64 %xtraiter1968, 0
  br i1 %lcmp.mod1969.not, label %for.body.i.i.i675.prol.loopexit, label %for.body.i.i.i675.prol
...
for.body.i.i.i675.prol:                           ; preds = %for.body.i.i.i675.preheader, %for.body.i.i.i675.prol
  ...
  %prol.iter1970 = phi i64 [ %prol.iter1970.next, %for.body.i.i.i675.prol ], [ 0, %for.body.i.i.i675.preheader ]
  ...
  %prol.iter1970.next = add i64 %prol.iter1970, 1
  %prol.iter1970.cmp.not = icmp eq i64 %prol.iter1970.next, %xtraiter1968
  br i1 %prol.iter1970.cmp.not, label %for.body.i.i.i675.prol.loopexit, label %for.body.i.i.i675.prol, !llvm.loop !108
...
delete.notnull.i.i.i677:                          ; preds = %for.body.i.i.i675.prol.loopexit, %for.body.i.i.i675, %middle.block1847, %for.cond.cleanup.i.i.i669
...
if.end9.i.i.i704:                                 ; preds = %_Z11MyStringLenIwEiPKT_.exit.i.i
  ...
  %call.i.i.i707 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %207) #23
...
if.end.i.i713:                                    ; preds = %invoke.cont145
  ...
  %call.i.i720 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %211) #23
...
if.end.i.i736:                                    ; preds = %invoke.cont166
  ...
  %call.i.i750 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %221) #23
...
if.end.i.i767:                                    ; preds = %invoke.cont193
  ...
  %call.i.i781 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %234) #23
...
if.end.i.i795:                                    ; preds = %land.lhs.true204
  ...
  store i32 0, ptr %call.i.i594, align 4, !tbaa !47
  %call.i.i803 = invoke noalias noundef nonnull dereferenceable(8) ptr @_Znam(i64 noundef 8) #23
...
invoke.cont214:                                   ; preds = %if.end.i.i795
  ...
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %buffer.i804) #21, !noalias !117
...
if.end9.i.i.i816:                                 ; preds = %_Z11MyStringLenIwEiPKT_.exit.i.i813
  ...
  %call.i.i.i827 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %248) #23
...
invoke.cont219:                                   ; preds = %while.cond.i.i.i823
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %buffer.i804) #21, !noalias !117
...
if.end.i.i846:                                    ; preds = %invoke.cont219
  ...
  %call.i.i.i878 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %250) #23
...
for.body.i.i.i861.preheader:                      ; preds = %if.end.i.i846
  ...
  call void @_ZdaPv(ptr noundef nonnull %call.i.i803) #24
...
_ZN11CStringBaseIwED2Ev.exit882:                  ; preds = %invoke.cont221, %delete.notnull.i881
  %253 = sub i32 -2, %245
  %sub2.i.i889 = add i32 %propsString.sroa.54.5, %253
...
if.end.i.i902:                                    ; preds = %_ZN11CStringBaseIwED2Ev.exit882
  ...
  %sub15.i.i897 = sub nsw i32 4, %sub2.i.i889
...
if.end.i.i.i905:                                  ; preds = %if.end.i.i902
  ...
  %254 = icmp slt i32 %add18.i.i899, -1
  %255 = shl nuw nsw i64 %conv.i.i.i903, 2
  %256 = select i1 %254, i64 -1, i64 %255
  %call.i.i.i933 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %256) #23
...
for.body.lr.ph.i.i.i909:                          ; preds = %for.cond.preheader.i.i.i907
  ...
  %257 = shl nuw nsw i64 %wide.trip.count.i.i.i908, 2
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %call.i.i.i933, ptr nonnull align 4 %propsString.sroa.0.6, i64 %257, i1 false), !tbaa !47
...
_ZN11CStringBaseIwE10GrowLengthEi.exit.i925:      ; preds = %delete.notnull.i.i.i919, %if.end.i.i902, %_ZN11CStringBaseIwED2Ev.exit882
  ...
  %propsString.sroa.0.71829 = ptrtoint ptr %propsString.sroa.0.7 to i64
  %idx.ext.i923 = sext i32 %add.i.i.i811 to i64
  %add.ptr.i924 = getelementptr i32, ptr %propsString.sroa.0.7, i64 %idx.ext.i923
  %incdec.ptr1.i.i929 = getelementptr inbounds i32, ptr %add.ptr.i924, i64 1
  %incdec.ptr1.i.i929.1 = getelementptr inbounds i32, ptr %incdec.ptr1.i.i929, i64 1
  %incdec.ptr1.i.i929.2 = getelementptr inbounds i32, ptr %incdec.ptr1.i.i929.1, i64 1
  %incdec.ptr1.i.i929.3 = getelementptr inbounds i32, ptr %incdec.ptr1.i.i929.2, i64 1
  ...
  %258 = load ptr, ptr %_items.i790, align 8, !tbaa !111
  %add.ptr232 = getelementptr inbounds i8, ptr %258, i64 1
  %259 = load i32, ptr %add.ptr232, align 4, !tbaa !42
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp233) #21
  invoke fastcc void @_ZN8NArchive3N7zL21GetStringForSizeValueEj(ptr noalias nonnull align 8 %ref.tmp233, i32 noundef %259)
          to label %invoke.cont235 unwind label %lpad234

invoke.cont235:                                   ; preds = %_ZN11CStringBaseIwE10GrowLengthEi.exit.i925
  %260 = load i32, ptr %_length.i935, align 8, !tbaa !58
  %261 = sub i32 -6, %245
  %sub2.i.i938 = add i32 %propsString.sroa.54.6, %261
  %cmp.not.i.i939 = icmp sgt i32 %260, %sub2.i.i938
...
if.end.i.i952:                                    ; preds = %invoke.cont235
  ...
  %cmp13.i.i946 = icmp slt i32 %add.i.i945, %260
  %sub15.i.i947 = sub nsw i32 %260, %sub2.i.i938
...
if.end.i.i.i955:                                  ; preds = %if.end.i.i952
  ...
  %262 = icmp slt i32 %add18.i.i949, -1
  %263 = shl nuw nsw i64 %conv.i.i.i953, 2
  %264 = select i1 %262, i64 -1, i64 %263
  %call.i.i.i984 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %264) #23
          to label %call.i.i.i.noexc983 unwind label %lpad236

call.i.i.i.noexc983:                              ; preds = %if.end.i.i.i955
  %call.i.i.i9841828 = ptrtoint ptr %call.i.i.i984 to i64
...
for.body.lr.ph.i.i.i959:                          ; preds = %for.cond.preheader.i.i.i957
  ...
  %min.iters.check1833 = icmp ult i32 %add.i931, 8
  %265 = sub i64 %call.i.i.i9841828, %propsString.sroa.0.71829
  %diff.check1830 = icmp ult i64 %265, 32
  %or.cond1909 = or i1 %min.iters.check1833, %diff.check1830
  br i1 %or.cond1909, label %for.body.i.i.i967.preheader, label %vector.ph1834

vector.ph1834:                                    ; preds = %for.body.lr.ph.i.i.i959
  %n.vec1836 = and i64 %wide.trip.count.i.i.i958, 4294967288
  br label %vector.body1839

vector.body1839:                                  ; preds = %vector.body1839, %vector.ph1834
  %index1840 = phi i64 [ 0, %vector.ph1834 ], [ %index.next1843, %vector.body1839 ]
  %266 = getelementptr inbounds i32, ptr %propsString.sroa.0.7, i64 %index1840
  %wide.load1841 = load <4 x i32>, ptr %266, align 4, !tbaa !47
  %267 = getelementptr inbounds i32, ptr %266, i64 4
  %wide.load1842 = load <4 x i32>, ptr %267, align 4, !tbaa !47
  %268 = getelementptr inbounds i32, ptr %call.i.i.i984, i64 %index1840
  store <4 x i32> %wide.load1841, ptr %268, align 4, !tbaa !47
  %269 = getelementptr inbounds i32, ptr %268, i64 4
  store <4 x i32> %wide.load1842, ptr %269, align 4, !tbaa !47
  %index.next1843 = add nuw i64 %index1840, 8
  %270 = icmp eq i64 %index.next1843, %n.vec1836
  br i1 %270, label %middle.block1831, label %vector.body1839, !llvm.loop !120

middle.block1831:                                 ; preds = %vector.body1839
  %cmp.n1838 = icmp eq i64 %n.vec1836, %wide.trip.count.i.i.i958
  br i1 %cmp.n1838, label %delete.notnull.i.i.i969, label %for.body.i.i.i967.preheader

for.body.i.i.i967.preheader:                      ; preds = %for.body.lr.ph.i.i.i959, %middle.block1831
  %indvars.iv.i.i.i962.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i959 ], [ %n.vec1836, %middle.block1831 ]
  %271 = xor i64 %indvars.iv.i.i.i962.ph, -1
  %272 = add nsw i64 %271, %wide.trip.count.i.i.i958
  %xtraiter1971 = and i64 %wide.trip.count.i.i.i958, 3
  %lcmp.mod1972.not = icmp eq i64 %xtraiter1971, 0
  br i1 %lcmp.mod1972.not, label %for.body.i.i.i967.prol.loopexit, label %for.body.i.i.i967.prol
...
for.body.i.i.i967.prol:                           ; preds = %for.body.i.i.i967.preheader, %for.body.i.i.i967.prol
  ...
  %prol.iter1973 = phi i64 [ %prol.iter1973.next, %for.body.i.i.i967.prol ], [ 0, %for.body.i.i.i967.preheader ]
  %arrayidx.i.i.i963.prol = getelementptr inbounds i32, ptr %propsString.sroa.0.7, i64 %indvars.iv.i.i.i962.prol
  %273 = load i32, ptr %arrayidx.i.i.i963.prol, align 4, !tbaa !47
  %arrayidx7.i.i.i964.prol = getelementptr inbounds i32, ptr %call.i.i.i984, i64 %indvars.iv.i.i.i962.prol
  store i32 %273, ptr %arrayidx7.i.i.i964.prol, align 4, !tbaa !47
  %indvars.iv.next.i.i.i965.prol = add nuw nsw i64 %indvars.iv.i.i.i962.prol, 1
  %prol.iter1973.next = add i64 %prol.iter1973, 1
  %prol.iter1973.cmp.not = icmp eq i64 %prol.iter1973.next, %xtraiter1971
  br i1 %prol.iter1973.cmp.not, label %for.body.i.i.i967.prol.loopexit, label %for.body.i.i.i967.prol, !llvm.loop !121
...
for.body.i.i.i967.prol.loopexit:                  ; preds = %for.body.i.i.i967.prol, %for.body.i.i.i967.preheader
  ...
  br i1 %274, label %delete.notnull.i.i.i969, label %for.body.i.i.i967
...
for.body.i.i.i967:                                ; preds = %for.body.i.i.i967.prol.loopexit, %for.body.i.i.i967
  ...
  %275 = load i32, ptr %arrayidx.i.i.i963, align 4, !tbaa !47
  %arrayidx7.i.i.i964 = getelementptr inbounds i32, ptr %call.i.i.i984, i64 %indvars.iv.i.i.i962
  store i32 %275, ptr %arrayidx7.i.i.i964, align 4, !tbaa !47
  ...
  %276 = load i32, ptr %arrayidx.i.i.i963.1, align 4, !tbaa !47
  %arrayidx7.i.i.i964.1 = getelementptr inbounds i32, ptr %call.i.i.i984, i64 %indvars.iv.next.i.i.i965
  store i32 %276, ptr %arrayidx7.i.i.i964.1, align 4, !tbaa !47
  ...
  %277 = load i32, ptr %arrayidx.i.i.i963.2, align 4, !tbaa !47
  %arrayidx7.i.i.i964.2 = getelementptr inbounds i32, ptr %call.i.i.i984, i64 %indvars.iv.next.i.i.i965.1
  store i32 %277, ptr %arrayidx7.i.i.i964.2, align 4, !tbaa !47
  ...
  %278 = load i32, ptr %arrayidx.i.i.i963.3, align 4, !tbaa !47
  %arrayidx7.i.i.i964.3 = getelementptr inbounds i32, ptr %call.i.i.i984, i64 %indvars.iv.next.i.i.i965.2
  store i32 %278, ptr %arrayidx7.i.i.i964.3, align 4, !tbaa !47
...
delete.notnull.i.i.i969:                          ; preds = %for.body.i.i.i967.prol.loopexit, %for.body.i.i.i967, %middle.block1831, %for.cond.preheader.i.i.i957
...
while.cond.i.i981:                                ; preds = %while.cond.i.i981, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i975
  %src.addr.0.i.i976 = phi ptr [ %279, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i975 ], [ %incdec.ptr.i.i978, %while.cond.i.i981 ]
  ...
  %280 = load i32, ptr %src.addr.0.i.i976, align 4, !tbaa !47
  %incdec.ptr1.i.i979 = getelementptr inbounds i32, ptr %dest.addr.0.i.i977, i64 1
  store i32 %280, ptr %dest.addr.0.i.i977, align 4, !tbaa !47
  %cmp.not.i8.i980 = icmp eq i32 %280, 0
  br i1 %cmp.not.i8.i980, label %invoke.cont237, label %while.cond.i.i981, !llvm.loop !59

invoke.cont237:                                   ; preds = %while.cond.i.i981
  %281 = load i32, ptr %_length.i935, align 8, !tbaa !58
  %add.i982 = add nsw i32 %281, %add.i931
  %isnull.i986 = icmp eq ptr %279, null
...
lpad236:                                          ; preds = %if.end.i.i.i955
  ...
  %287 = load ptr, ptr %ref.tmp233, align 8, !tbaa !55
  %isnull.i992 = icmp eq ptr %287, null
...
ehcleanup240:                                     ; preds = %delete.notnull.i993, %lpad236, %lpad234
  %.pn482 = phi { ptr, i32 } [ %285, %lpad234 ], [ %286, %lpad236 ], [ %286, %delete.notnull.i993 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp233) #21
  br label %delete.notnull.i1325
...
land.lhs.true246:                                 ; preds = %invoke.cont132
  ...
  %288 = load i64, ptr %_capacity.i995, align 8, !tbaa !110
  %cmp250.not = icmp eq i64 %288, 0
...
if.then251:                                       ; preds = %land.lhs.true246
  ...
  %289 = load ptr, ptr %_items.i996, align 8, !tbaa !111
  %290 = load i8, ptr %289, align 1, !tbaa !112
  %291 = and i8 %290, 63
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %buffer.i997) #21, !noalias !123
  %conv.i998 = zext i8 %291 to i64
...
for.cond.i.i.i1003:                               ; preds = %if.then251, %for.cond.i.i.i1003
  ...
  %292 = load i32, ptr %arrayidx.i.i.i1000, align 4, !tbaa !47, !noalias !123
  %cmp.not.i.i.i1001 = icmp eq i32 %292, 0
...
_Z11MyStringLenIwEiPKT_.exit.i.i1006:             ; preds = %for.cond.i.i.i1003
  %293 = trunc i64 %indvars.iv.i.i.i999 to i32
  %add.i.i.i1004 = add nsw i32 %293, 1
...
if.end9.i.i.i1009:                                ; preds = %_Z11MyStringLenIwEiPKT_.exit.i.i1006
  ...
  %295 = shl nuw nsw i64 %conv.i.i.i1008, 2
  %296 = select i1 %294, i64 -1, i64 %295
  %call.i.i.i1020 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %296) #23
...
while.cond.i.i.i1016:                             ; preds = %while.cond.i.i.i1016, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i.i1010
  ...
  %297 = load i32, ptr %src.addr.0.i.i.i1011, align 4, !tbaa !47, !noalias !123
  %incdec.ptr1.i.i.i1014 = getelementptr inbounds i32, ptr %dest.addr.0.i.i.i1012, i64 1
  store i32 %297, ptr %dest.addr.0.i.i.i1012, align 4, !tbaa !47, !noalias !123
  %cmp.not.i10.i.i1015 = icmp eq i32 %297, 0
...
invoke.cont260:                                   ; preds = %while.cond.i.i.i1016
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %buffer.i997) #21, !noalias !123
  store i32 0, ptr %call.i.i594, align 4, !tbaa !47
...
if.end.i.i1029:                                   ; preds = %invoke.cont260
  ...
  %298 = icmp slt i32 %293, -1
  %299 = shl nuw nsw i64 %conv.i.i1027, 2
  %300 = select i1 %298, i64 -1, i64 %299
  %call.i.i1043 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %300) #23
...
while.cond.i.i1041:                               ; preds = %while.cond.i.i1041, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1035
  ...
  %301 = load i32, ptr %src.addr.0.i.i1036, align 4, !tbaa !47
  %incdec.ptr1.i.i1039 = getelementptr inbounds i32, ptr %dest.addr.0.i.i1037, i64 1
  store i32 %301, ptr %dest.addr.0.i.i1037, align 4, !tbaa !47
  %cmp.not.i.i1040 = icmp eq i32 %301, 0
...
if.end274:                                        ; preds = %delete.notnull.i1046, %invoke.cont262, %delete.notnull.i722, %invoke.cont147, %_ZN11CStringBaseIwED2Ev.exit785, %_ZN11CStringBaseIwED2Ev.exit988, %_ZN11CStringBaseIwED2Ev.exit754
  ...
  %propsString.sroa.27.1 = phi i32 [ %224, %_ZN11CStringBaseIwED2Ev.exit754 ], [ %237, %_ZN11CStringBaseIwED2Ev.exit785 ], [ %add.i982, %_ZN11CStringBaseIwED2Ev.exit988 ], [ %204, %invoke.cont147 ], [ %204, %delete.notnull.i722 ], [ %293, %invoke.cont262 ], [ %293, %delete.notnull.i1046 ]
  %cmp.i1052 = icmp eq i32 %propsString.sroa.27.1, 0
  br i1 %cmp.i1052, label %if.else282, label %if.then277

if.then277:                                       ; preds = %if.end274
  %304 = load i32, ptr %_capacity.i, align 4, !tbaa !57
  %305 = load i32, ptr %_length.i583, align 8, !tbaa !58
  %306 = xor i32 %305, -1
  %sub2.i.i1055 = add i32 %304, %306
...
if.end.i.i1069:                                   ; preds = %if.then277
  %cmp4.i.i1057 = icmp sgt i32 %304, 64
  %div24.i.i1058 = lshr i32 %304, 1
  %cmp8.i.i1059 = icmp sgt i32 %304, 8
  ...
  %add18.i.i1066 = add nsw i32 %delta.1.i.i1065, %304
  %add.i.i.i1067 = add nsw i32 %add18.i.i1066, 1
  %cmp.i.i.i1068 = icmp eq i32 %add.i.i.i1067, %304
...
if.end.i.i.i1072:                                 ; preds = %if.end.i.i1069
  ...
  %307 = icmp slt i32 %add18.i.i1066, -1
  %308 = shl nuw nsw i64 %conv.i.i.i1070, 2
  %309 = select i1 %307, i64 -1, i64 %308
  %call.i.i.i1097 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %309) #23
          to label %call.i.i.i.noexc1096 unwind label %lpad117

call.i.i.i.noexc1096:                             ; preds = %if.end.i.i.i1072
  %call.i.i.i10971812 = ptrtoint ptr %call.i.i.i1097 to i64
  %cmp3.i.i.i1071 = icmp sgt i32 %304, 0
...
for.cond.preheader.i.i.i1074:                     ; preds = %call.i.i.i.noexc1096
  %cmp522.i.i.i1073 = icmp sgt i32 %305, 0
  %310 = load ptr, ptr %methodsString, align 8, !tbaa !55
...
for.body.lr.ph.i.i.i1076:                         ; preds = %for.cond.preheader.i.i.i1074
  ...
  %wide.trip.count.i.i.i1075 = zext i32 %305 to i64
  %min.iters.check1816 = icmp ult i32 %305, 8
  %312 = sub i64 %call.i.i.i10971812, %311
  %diff.check1813 = icmp ult i64 %312, 32
  %or.cond1910 = select i1 %min.iters.check1816, i1 true, i1 %diff.check1813
  br i1 %or.cond1910, label %for.body.i.i.i1084.preheader, label %vector.ph1817

vector.ph1817:                                    ; preds = %for.body.lr.ph.i.i.i1076
  %n.vec1819 = and i64 %wide.trip.count.i.i.i1075, 4294967288
  br label %vector.body1822

vector.body1822:                                  ; preds = %vector.body1822, %vector.ph1817
  %index1823 = phi i64 [ 0, %vector.ph1817 ], [ %index.next1826, %vector.body1822 ]
  %313 = getelementptr inbounds i32, ptr %310, i64 %index1823
  %wide.load1824 = load <4 x i32>, ptr %313, align 4, !tbaa !47
  %314 = getelementptr inbounds i32, ptr %313, i64 4
  %wide.load1825 = load <4 x i32>, ptr %314, align 4, !tbaa !47
  %315 = getelementptr inbounds i32, ptr %call.i.i.i1097, i64 %index1823
  store <4 x i32> %wide.load1824, ptr %315, align 4, !tbaa !47
  %316 = getelementptr inbounds i32, ptr %315, i64 4
  store <4 x i32> %wide.load1825, ptr %316, align 4, !tbaa !47
  %index.next1826 = add nuw i64 %index1823, 8
  %317 = icmp eq i64 %index.next1826, %n.vec1819
  br i1 %317, label %middle.block1814, label %vector.body1822, !llvm.loop !126

middle.block1814:                                 ; preds = %vector.body1822
  %cmp.n1821 = icmp eq i64 %n.vec1819, %wide.trip.count.i.i.i1075
  br i1 %cmp.n1821, label %delete.notnull.i.i.i1086, label %for.body.i.i.i1084.preheader

for.body.i.i.i1084.preheader:                     ; preds = %for.body.lr.ph.i.i.i1076, %middle.block1814
  %indvars.iv.i.i.i1079.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i1076 ], [ %n.vec1819, %middle.block1814 ]
  %318 = xor i64 %indvars.iv.i.i.i1079.ph, -1
  %319 = add nsw i64 %318, %wide.trip.count.i.i.i1075
  %xtraiter1974 = and i64 %wide.trip.count.i.i.i1075, 3
  %lcmp.mod1975.not = icmp eq i64 %xtraiter1974, 0
  br i1 %lcmp.mod1975.not, label %for.body.i.i.i1084.prol.loopexit, label %for.body.i.i.i1084.prol
...
for.body.i.i.i1084.prol:                          ; preds = %for.body.i.i.i1084.preheader, %for.body.i.i.i1084.prol
  ...
  %prol.iter1976 = phi i64 [ %prol.iter1976.next, %for.body.i.i.i1084.prol ], [ 0, %for.body.i.i.i1084.preheader ]
  %arrayidx.i.i.i1080.prol = getelementptr inbounds i32, ptr %310, i64 %indvars.iv.i.i.i1079.prol
  %320 = load i32, ptr %arrayidx.i.i.i1080.prol, align 4, !tbaa !47
  %arrayidx7.i.i.i1081.prol = getelementptr inbounds i32, ptr %call.i.i.i1097, i64 %indvars.iv.i.i.i1079.prol
  store i32 %320, ptr %arrayidx7.i.i.i1081.prol, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1082.prol = add nuw nsw i64 %indvars.iv.i.i.i1079.prol, 1
  %prol.iter1976.next = add i64 %prol.iter1976, 1
  %prol.iter1976.cmp.not = icmp eq i64 %prol.iter1976.next, %xtraiter1974
  br i1 %prol.iter1976.cmp.not, label %for.body.i.i.i1084.prol.loopexit, label %for.body.i.i.i1084.prol, !llvm.loop !127
...
for.body.i.i.i1084.prol.loopexit:                 ; preds = %for.body.i.i.i1084.prol, %for.body.i.i.i1084.preheader
  ...
  br i1 %321, label %delete.notnull.i.i.i1086, label %for.body.i.i.i1084

for.cond.cleanup.i.i.i1078:                       ; preds = %for.cond.preheader.i.i.i1074
  %isnull.i.i.i1077 = icmp eq ptr %310, null
...
for.body.i.i.i1084:                               ; preds = %for.body.i.i.i1084.prol.loopexit, %for.body.i.i.i1084
  ...
  %arrayidx.i.i.i1080 = getelementptr inbounds i32, ptr %310, i64 %indvars.iv.i.i.i1079
  %322 = load i32, ptr %arrayidx.i.i.i1080, align 4, !tbaa !47
  %arrayidx7.i.i.i1081 = getelementptr inbounds i32, ptr %call.i.i.i1097, i64 %indvars.iv.i.i.i1079
  store i32 %322, ptr %arrayidx7.i.i.i1081, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1082 = add nuw nsw i64 %indvars.iv.i.i.i1079, 1
  %arrayidx.i.i.i1080.1 = getelementptr inbounds i32, ptr %310, i64 %indvars.iv.next.i.i.i1082
  %323 = load i32, ptr %arrayidx.i.i.i1080.1, align 4, !tbaa !47
  %arrayidx7.i.i.i1081.1 = getelementptr inbounds i32, ptr %call.i.i.i1097, i64 %indvars.iv.next.i.i.i1082
  store i32 %323, ptr %arrayidx7.i.i.i1081.1, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1082.1 = add nuw nsw i64 %indvars.iv.i.i.i1079, 2
  %arrayidx.i.i.i1080.2 = getelementptr inbounds i32, ptr %310, i64 %indvars.iv.next.i.i.i1082.1
  %324 = load i32, ptr %arrayidx.i.i.i1080.2, align 4, !tbaa !47
  %arrayidx7.i.i.i1081.2 = getelementptr inbounds i32, ptr %call.i.i.i1097, i64 %indvars.iv.next.i.i.i1082.1
  store i32 %324, ptr %arrayidx7.i.i.i1081.2, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1082.2 = add nuw nsw i64 %indvars.iv.i.i.i1079, 3
  %arrayidx.i.i.i1080.3 = getelementptr inbounds i32, ptr %310, i64 %indvars.iv.next.i.i.i1082.2
  %325 = load i32, ptr %arrayidx.i.i.i1080.3, align 4, !tbaa !47
  %arrayidx7.i.i.i1081.3 = getelementptr inbounds i32, ptr %call.i.i.i1097, i64 %indvars.iv.next.i.i.i1082.2
  store i32 %325, ptr %arrayidx7.i.i.i1081.3, align 4, !tbaa !47
...
delete.notnull.i.i.i1086:                         ; preds = %for.body.i.i.i1084.prol.loopexit, %for.body.i.i.i1084, %middle.block1814, %for.cond.cleanup.i.i.i1078
...
if.end9.i.i.i1089:                                ; preds = %delete.notnull.i.i.i1086, %for.cond.cleanup.i.i.i1078, %call.i.i.i.noexc1096
  %326 = phi i32 [ %.pre.i.i1085, %delete.notnull.i.i.i1086 ], [ %305, %for.cond.cleanup.i.i.i1078 ], [ %305, %call.i.i.i.noexc1096 ]
  store ptr %call.i.i.i1097, ptr %methodsString, align 8, !tbaa !55
  %idxprom13.i.i.i1087 = sext i32 %326 to i64
...
invoke.cont278:                                   ; preds = %if.end9.i.i.i1089, %if.end.i.i1069, %if.then277
  %327 = phi i32 [ %304, %if.then277 ], [ %304, %if.end.i.i1069 ], [ %add.i.i.i1067, %if.end9.i.i.i1089 ]
  %328 = phi i32 [ %305, %if.then277 ], [ %305, %if.end.i.i1069 ], [ %326, %if.end9.i.i.i1089 ]
  %329 = load ptr, ptr %methodsString, align 8, !tbaa !55
  %330 = ptrtoint ptr %329 to i64
  %idxprom.i1090 = sext i32 %328 to i64
  %arrayidx.i1091 = getelementptr inbounds i32, ptr %329, i64 %idxprom.i1090
  %inc.i1092 = add nsw i32 %328, 1
  store i32 %inc.i1092, ptr %_length.i583, align 8, !tbaa !58
  %idxprom4.i1093 = sext i32 %inc.i1092 to i64
  store <2 x i32> <i32 58, i32 0>, ptr %arrayidx.i1091, align 4, !tbaa !47
  %331 = sub i32 -2, %328
  %sub2.i.i1102 = add i32 %327, %331
...
if.end.i.i1116:                                   ; preds = %invoke.cont278
  %cmp4.i.i1104 = icmp sgt i32 %327, 64
  %div24.i.i1105 = lshr i32 %327, 1
  %cmp8.i.i1106 = icmp sgt i32 %327, 8
  ...
  %add18.i.i1113 = add nsw i32 %delta.1.i.i1112, %327
  %add.i.i.i1114 = add nsw i32 %add18.i.i1113, 1
  %cmp.i.i.i1115 = icmp eq i32 %add.i.i.i1114, %327
...
if.end.i.i.i1119:                                 ; preds = %if.end.i.i1116
  ...
  %332 = icmp slt i32 %add18.i.i1113, -1
  %333 = shl nuw nsw i64 %conv.i.i.i1117, 2
  %334 = select i1 %332, i64 -1, i64 %333
  %call.i.i.i1148 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %334) #23
          to label %call.i.i.i.noexc1147 unwind label %lpad117

call.i.i.i.noexc1147:                             ; preds = %if.end.i.i.i1119
  %call.i.i.i11481796 = ptrtoint ptr %call.i.i.i1148 to i64
  %cmp3.i.i.i1118 = icmp sgt i32 %327, 0
...
for.cond.preheader.i.i.i1121:                     ; preds = %call.i.i.i.noexc1147
  %cmp522.i.i.i1120 = icmp sgt i32 %328, -1
...
for.body.lr.ph.i.i.i1123:                         ; preds = %for.cond.preheader.i.i.i1121
  ...
  %min.iters.check1800 = icmp ult i32 %inc.i1092, 8
  %335 = sub i64 %call.i.i.i11481796, %330
  %diff.check1797 = icmp ult i64 %335, 32
  %or.cond1911 = select i1 %min.iters.check1800, i1 true, i1 %diff.check1797
  br i1 %or.cond1911, label %for.body.i.i.i1131.preheader, label %vector.ph1801

vector.ph1801:                                    ; preds = %for.body.lr.ph.i.i.i1123
  %n.vec1803 = and i64 %wide.trip.count.i.i.i1122, 4294967288
  br label %vector.body1806

vector.body1806:                                  ; preds = %vector.body1806, %vector.ph1801
  %index1807 = phi i64 [ 0, %vector.ph1801 ], [ %index.next1810, %vector.body1806 ]
  %336 = getelementptr inbounds i32, ptr %329, i64 %index1807
  %wide.load1808 = load <4 x i32>, ptr %336, align 4, !tbaa !47
  %337 = getelementptr inbounds i32, ptr %336, i64 4
  %wide.load1809 = load <4 x i32>, ptr %337, align 4, !tbaa !47
  %338 = getelementptr inbounds i32, ptr %call.i.i.i1148, i64 %index1807
  store <4 x i32> %wide.load1808, ptr %338, align 4, !tbaa !47
  %339 = getelementptr inbounds i32, ptr %338, i64 4
  store <4 x i32> %wide.load1809, ptr %339, align 4, !tbaa !47
  %index.next1810 = add nuw i64 %index1807, 8
  %340 = icmp eq i64 %index.next1810, %n.vec1803
  br i1 %340, label %middle.block1798, label %vector.body1806, !llvm.loop !129

middle.block1798:                                 ; preds = %vector.body1806
  %cmp.n1805 = icmp eq i64 %n.vec1803, %wide.trip.count.i.i.i1122
  br i1 %cmp.n1805, label %delete.notnull.i.i.i1133, label %for.body.i.i.i1131.preheader

for.body.i.i.i1131.preheader:                     ; preds = %for.body.lr.ph.i.i.i1123, %middle.block1798
  %indvars.iv.i.i.i1126.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i1123 ], [ %n.vec1803, %middle.block1798 ]
  %341 = xor i64 %indvars.iv.i.i.i1126.ph, -1
  %342 = add nsw i64 %341, %wide.trip.count.i.i.i1122
  %xtraiter1977 = and i64 %wide.trip.count.i.i.i1122, 3
  %lcmp.mod1978.not = icmp eq i64 %xtraiter1977, 0
  br i1 %lcmp.mod1978.not, label %for.body.i.i.i1131.prol.loopexit, label %for.body.i.i.i1131.prol
...
for.body.i.i.i1131.prol:                          ; preds = %for.body.i.i.i1131.preheader, %for.body.i.i.i1131.prol
  ...
  %prol.iter1979 = phi i64 [ %prol.iter1979.next, %for.body.i.i.i1131.prol ], [ 0, %for.body.i.i.i1131.preheader ]
  %arrayidx.i.i.i1127.prol = getelementptr inbounds i32, ptr %329, i64 %indvars.iv.i.i.i1126.prol
  %343 = load i32, ptr %arrayidx.i.i.i1127.prol, align 4, !tbaa !47
  %arrayidx7.i.i.i1128.prol = getelementptr inbounds i32, ptr %call.i.i.i1148, i64 %indvars.iv.i.i.i1126.prol
  store i32 %343, ptr %arrayidx7.i.i.i1128.prol, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1129.prol = add nuw nsw i64 %indvars.iv.i.i.i1126.prol, 1
  %prol.iter1979.next = add i64 %prol.iter1979, 1
  %prol.iter1979.cmp.not = icmp eq i64 %prol.iter1979.next, %xtraiter1977
  br i1 %prol.iter1979.cmp.not, label %for.body.i.i.i1131.prol.loopexit, label %for.body.i.i.i1131.prol, !llvm.loop !130
...
for.body.i.i.i1131.prol.loopexit:                 ; preds = %for.body.i.i.i1131.prol, %for.body.i.i.i1131.preheader
  ...
  br i1 %344, label %delete.notnull.i.i.i1133, label %for.body.i.i.i1131
...
for.body.i.i.i1131:                               ; preds = %for.body.i.i.i1131.prol.loopexit, %for.body.i.i.i1131
  ...
  %arrayidx.i.i.i1127 = getelementptr inbounds i32, ptr %329, i64 %indvars.iv.i.i.i1126
  %345 = load i32, ptr %arrayidx.i.i.i1127, align 4, !tbaa !47
  %arrayidx7.i.i.i1128 = getelementptr inbounds i32, ptr %call.i.i.i1148, i64 %indvars.iv.i.i.i1126
  store i32 %345, ptr %arrayidx7.i.i.i1128, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1129 = add nuw nsw i64 %indvars.iv.i.i.i1126, 1
  %arrayidx.i.i.i1127.1 = getelementptr inbounds i32, ptr %329, i64 %indvars.iv.next.i.i.i1129
  %346 = load i32, ptr %arrayidx.i.i.i1127.1, align 4, !tbaa !47
  %arrayidx7.i.i.i1128.1 = getelementptr inbounds i32, ptr %call.i.i.i1148, i64 %indvars.iv.next.i.i.i1129
  store i32 %346, ptr %arrayidx7.i.i.i1128.1, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1129.1 = add nuw nsw i64 %indvars.iv.i.i.i1126, 2
  %arrayidx.i.i.i1127.2 = getelementptr inbounds i32, ptr %329, i64 %indvars.iv.next.i.i.i1129.1
  %347 = load i32, ptr %arrayidx.i.i.i1127.2, align 4, !tbaa !47
  %arrayidx7.i.i.i1128.2 = getelementptr inbounds i32, ptr %call.i.i.i1148, i64 %indvars.iv.next.i.i.i1129.1
  store i32 %347, ptr %arrayidx7.i.i.i1128.2, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1129.2 = add nuw nsw i64 %indvars.iv.i.i.i1126, 3
  %arrayidx.i.i.i1127.3 = getelementptr inbounds i32, ptr %329, i64 %indvars.iv.next.i.i.i1129.2
  %348 = load i32, ptr %arrayidx.i.i.i1127.3, align 4, !tbaa !47
  %arrayidx7.i.i.i1128.3 = getelementptr inbounds i32, ptr %call.i.i.i1148, i64 %indvars.iv.next.i.i.i1129.2
  store i32 %348, ptr %arrayidx7.i.i.i1128.3, align 4, !tbaa !47
...
delete.notnull.i.i.i1133:                         ; preds = %for.body.i.i.i1131.prol.loopexit, %for.body.i.i.i1131, %middle.block1798, %for.cond.preheader.i.i.i1121
  call void @_ZdaPv(ptr noundef nonnull %329) #24
  %.pre.i.i1132 = load i32, ptr %_length.i583, align 8, !tbaa !58
  %.pre1647 = sext i32 %.pre.i.i1132 to i64
  br label %if.end9.i.i.i1136

if.end9.i.i.i1136:                                ; preds = %delete.notnull.i.i.i1133, %call.i.i.i.noexc1147
  %idxprom13.i.i.i1134.pre-phi = phi i64 [ %.pre1647, %delete.notnull.i.i.i1133 ], [ %idxprom4.i1093, %call.i.i.i.noexc1147 ]
  %349 = phi i32 [ %.pre.i.i1132, %delete.notnull.i.i.i1133 ], [ %inc.i1092, %call.i.i.i.noexc1147 ]
...
_ZN11CStringBaseIwE10GrowLengthEi.exit.i1139:     ; preds = %if.end9.i.i.i1136, %if.end.i.i1116, %invoke.cont278
  ...
  %350 = phi ptr [ %call.i.i.i1148, %if.end9.i.i.i1136 ], [ %329, %if.end.i.i1116 ], [ %329, %invoke.cont278 ]
  %351 = phi i32 [ %349, %if.end9.i.i.i1136 ], [ %inc.i1092, %if.end.i.i1116 ], [ %inc.i1092, %invoke.cont278 ]
  %add.ptr.i1138 = getelementptr inbounds i32, ptr %350, i64 %idx.ext.i1137.pre-phi
...
while.cond.i.i1145:                               ; preds = %while.cond.i.i1145, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i1139
  ...
  %352 = load i32, ptr %src.addr.0.i.i1140, align 4, !tbaa !47
  %incdec.ptr1.i.i1143 = getelementptr inbounds i32, ptr %dest.addr.0.i.i1141, i64 1
  store i32 %352, ptr %dest.addr.0.i.i1141, align 4, !tbaa !47
  %cmp.not.i8.i1144 = icmp eq i32 %352, 0
...
if.end319.thread:                                 ; preds = %while.cond.i.i1145
  %add.i1146 = add nsw i32 %351, %propsString.sroa.27.1
...
if.else282:                                       ; preds = %invoke.cont132, %land.lhs.true, %land.lhs.true154, %land.lhs.true176, %land.lhs.true204, %_ZN11CStringBaseIwED2Ev.exit639, %land.lhs.true246, %if.end274
  ...
  %353 = load i64, ptr %_capacity.i1150, align 8, !tbaa !110
  %cmp286.not = icmp eq i64 %353, 0
  br i1 %cmp286.not, label %if.end319, label %for.cond.i.i1155.preheader

for.cond.i.i1155.preheader:                       ; preds = %if.else282
  %354 = load i32, ptr %_capacity.i, align 4, !tbaa !57
  %355 = load i32, ptr %_length.i583, align 8, !tbaa !58
  %356 = xor i32 %355, -1
  %sub2.i.i1158 = add i32 %354, %356
...
if.end.i.i1173:                                   ; preds = %for.cond.i.i1155.preheader
  %cmp4.i.i1161 = icmp sgt i32 %354, 64
  %div24.i.i1162 = lshr i32 %354, 1
  %cmp8.i.i1163 = icmp sgt i32 %354, 8
  ...
  %add18.i.i1170 = add nsw i32 %delta.1.i.i1169, %354
  %add.i.i.i1171 = add nsw i32 %add18.i.i1170, 1
  %cmp.i.i.i1172 = icmp eq i32 %add.i.i.i1171, %354
...
if.end.i.i.i1176:                                 ; preds = %if.end.i.i1173
  ...
  %357 = icmp slt i32 %add18.i.i1170, -1
  %358 = shl nuw nsw i64 %conv.i.i.i1174, 2
  %359 = select i1 %357, i64 -1, i64 %358
  %call.i.i.i1205 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %359) #23
          to label %call.i.i.i.noexc1204 unwind label %lpad117

call.i.i.i.noexc1204:                             ; preds = %if.end.i.i.i1176
  %call.i.i.i12051780 = ptrtoint ptr %call.i.i.i1205 to i64
  %cmp3.i.i.i1175 = icmp sgt i32 %354, 0
...
for.cond.preheader.i.i.i1178:                     ; preds = %call.i.i.i.noexc1204
  %cmp522.i.i.i1177 = icmp sgt i32 %355, 0
  %360 = load ptr, ptr %methodsString, align 8, !tbaa !55
...
for.body.lr.ph.i.i.i1180:                         ; preds = %for.cond.preheader.i.i.i1178
  ...
  %wide.trip.count.i.i.i1179 = zext i32 %355 to i64
  %min.iters.check1784 = icmp ult i32 %355, 8
  %362 = sub i64 %call.i.i.i12051780, %361
  %diff.check1781 = icmp ult i64 %362, 32
  %or.cond1912 = select i1 %min.iters.check1784, i1 true, i1 %diff.check1781
  br i1 %or.cond1912, label %for.body.i.i.i1188.preheader, label %vector.ph1785

vector.ph1785:                                    ; preds = %for.body.lr.ph.i.i.i1180
  %n.vec1787 = and i64 %wide.trip.count.i.i.i1179, 4294967288
  br label %vector.body1790

vector.body1790:                                  ; preds = %vector.body1790, %vector.ph1785
  %index1791 = phi i64 [ 0, %vector.ph1785 ], [ %index.next1794, %vector.body1790 ]
  %363 = getelementptr inbounds i32, ptr %360, i64 %index1791
  %wide.load1792 = load <4 x i32>, ptr %363, align 4, !tbaa !47
  %364 = getelementptr inbounds i32, ptr %363, i64 4
  %wide.load1793 = load <4 x i32>, ptr %364, align 4, !tbaa !47
  %365 = getelementptr inbounds i32, ptr %call.i.i.i1205, i64 %index1791
  store <4 x i32> %wide.load1792, ptr %365, align 4, !tbaa !47
  %366 = getelementptr inbounds i32, ptr %365, i64 4
  store <4 x i32> %wide.load1793, ptr %366, align 4, !tbaa !47
  %index.next1794 = add nuw i64 %index1791, 8
  %367 = icmp eq i64 %index.next1794, %n.vec1787
  br i1 %367, label %middle.block1782, label %vector.body1790, !llvm.loop !132

middle.block1782:                                 ; preds = %vector.body1790
  %cmp.n1789 = icmp eq i64 %n.vec1787, %wide.trip.count.i.i.i1179
  br i1 %cmp.n1789, label %delete.notnull.i.i.i1190, label %for.body.i.i.i1188.preheader

for.body.i.i.i1188.preheader:                     ; preds = %for.body.lr.ph.i.i.i1180, %middle.block1782
  %indvars.iv.i.i.i1183.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i1180 ], [ %n.vec1787, %middle.block1782 ]
  %368 = xor i64 %indvars.iv.i.i.i1183.ph, -1
  %369 = add nsw i64 %368, %wide.trip.count.i.i.i1179
  %xtraiter1980 = and i64 %wide.trip.count.i.i.i1179, 3
  %lcmp.mod1981.not = icmp eq i64 %xtraiter1980, 0
  br i1 %lcmp.mod1981.not, label %for.body.i.i.i1188.prol.loopexit, label %for.body.i.i.i1188.prol
...
for.body.i.i.i1188.prol:                          ; preds = %for.body.i.i.i1188.preheader, %for.body.i.i.i1188.prol
  ...
  %prol.iter1982 = phi i64 [ %prol.iter1982.next, %for.body.i.i.i1188.prol ], [ 0, %for.body.i.i.i1188.preheader ]
  %arrayidx.i.i.i1184.prol = getelementptr inbounds i32, ptr %360, i64 %indvars.iv.i.i.i1183.prol
  %370 = load i32, ptr %arrayidx.i.i.i1184.prol, align 4, !tbaa !47
  %arrayidx7.i.i.i1185.prol = getelementptr inbounds i32, ptr %call.i.i.i1205, i64 %indvars.iv.i.i.i1183.prol
  store i32 %370, ptr %arrayidx7.i.i.i1185.prol, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1186.prol = add nuw nsw i64 %indvars.iv.i.i.i1183.prol, 1
  %prol.iter1982.next = add i64 %prol.iter1982, 1
  %prol.iter1982.cmp.not = icmp eq i64 %prol.iter1982.next, %xtraiter1980
  br i1 %prol.iter1982.cmp.not, label %for.body.i.i.i1188.prol.loopexit, label %for.body.i.i.i1188.prol, !llvm.loop !133
...
for.body.i.i.i1188.prol.loopexit:                 ; preds = %for.body.i.i.i1188.prol, %for.body.i.i.i1188.preheader
  ...
  br i1 %371, label %delete.notnull.i.i.i1190, label %for.body.i.i.i1188

for.cond.cleanup.i.i.i1182:                       ; preds = %for.cond.preheader.i.i.i1178
  %isnull.i.i.i1181 = icmp eq ptr %360, null
...
for.body.i.i.i1188:                               ; preds = %for.body.i.i.i1188.prol.loopexit, %for.body.i.i.i1188
  ...
  %arrayidx.i.i.i1184 = getelementptr inbounds i32, ptr %360, i64 %indvars.iv.i.i.i1183
  %372 = load i32, ptr %arrayidx.i.i.i1184, align 4, !tbaa !47
  %arrayidx7.i.i.i1185 = getelementptr inbounds i32, ptr %call.i.i.i1205, i64 %indvars.iv.i.i.i1183
  store i32 %372, ptr %arrayidx7.i.i.i1185, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1186 = add nuw nsw i64 %indvars.iv.i.i.i1183, 1
  %arrayidx.i.i.i1184.1 = getelementptr inbounds i32, ptr %360, i64 %indvars.iv.next.i.i.i1186
  %373 = load i32, ptr %arrayidx.i.i.i1184.1, align 4, !tbaa !47
  %arrayidx7.i.i.i1185.1 = getelementptr inbounds i32, ptr %call.i.i.i1205, i64 %indvars.iv.next.i.i.i1186
  store i32 %373, ptr %arrayidx7.i.i.i1185.1, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1186.1 = add nuw nsw i64 %indvars.iv.i.i.i1183, 2
  %arrayidx.i.i.i1184.2 = getelementptr inbounds i32, ptr %360, i64 %indvars.iv.next.i.i.i1186.1
  %374 = load i32, ptr %arrayidx.i.i.i1184.2, align 4, !tbaa !47
  %arrayidx7.i.i.i1185.2 = getelementptr inbounds i32, ptr %call.i.i.i1205, i64 %indvars.iv.next.i.i.i1186.1
  store i32 %374, ptr %arrayidx7.i.i.i1185.2, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1186.2 = add nuw nsw i64 %indvars.iv.i.i.i1183, 3
  %arrayidx.i.i.i1184.3 = getelementptr inbounds i32, ptr %360, i64 %indvars.iv.next.i.i.i1186.2
  %375 = load i32, ptr %arrayidx.i.i.i1184.3, align 4, !tbaa !47
  %arrayidx7.i.i.i1185.3 = getelementptr inbounds i32, ptr %call.i.i.i1205, i64 %indvars.iv.next.i.i.i1186.2
  store i32 %375, ptr %arrayidx7.i.i.i1185.3, align 4, !tbaa !47
...
delete.notnull.i.i.i1190:                         ; preds = %for.body.i.i.i1188.prol.loopexit, %for.body.i.i.i1188, %middle.block1782, %for.cond.cleanup.i.i.i1182
...
if.end9.i.i.i1193:                                ; preds = %delete.notnull.i.i.i1190, %for.cond.cleanup.i.i.i1182, %call.i.i.i.noexc1204
  %376 = phi i32 [ %.pre.i.i1189, %delete.notnull.i.i.i1190 ], [ %355, %for.cond.cleanup.i.i.i1182 ], [ %355, %call.i.i.i.noexc1204 ]
  store ptr %call.i.i.i1205, ptr %methodsString, align 8, !tbaa !55
  %idxprom13.i.i.i1191 = sext i32 %376 to i64
...
_ZN11CStringBaseIwE10GrowLengthEi.exit.i1196:     ; preds = %if.end9.i.i.i1193, %if.end.i.i1173, %for.cond.i.i1155.preheader
  %.pre16431646 = phi i32 [ %354, %for.cond.i.i1155.preheader ], [ %354, %if.end.i.i1173 ], [ %add.i.i.i1171, %if.end9.i.i.i1193 ]
  %377 = phi i64 [ %353, %for.cond.i.i1155.preheader ], [ %353, %if.end.i.i1173 ], [ %.pre, %if.end9.i.i.i1193 ]
  %378 = phi i32 [ %355, %for.cond.i.i1155.preheader ], [ %355, %if.end.i.i1173 ], [ %376, %if.end9.i.i.i1193 ]
  %379 = load ptr, ptr %methodsString, align 8, !tbaa !55
  %idx.ext.i1194 = sext i32 %378 to i64
  %add.ptr.i1195 = getelementptr i32, ptr %379, i64 %idx.ext.i1194
  %incdec.ptr1.i.i1200 = getelementptr inbounds i32, ptr %add.ptr.i1195, i64 1
  store i32 58, ptr %add.ptr.i1195, align 4, !tbaa !47
  %incdec.ptr1.i.i1200.1 = getelementptr inbounds i32, ptr %incdec.ptr1.i.i1200, i64 1
  store i32 91, ptr %incdec.ptr1.i.i1200, align 4, !tbaa !47
  store i32 0, ptr %incdec.ptr1.i.i1200.1, align 4, !tbaa !47
  %add.i1203 = add nsw i32 %378, 2
  store i32 %add.i1203, ptr %_length.i583, align 8, !tbaa !58
  %cmp2951579.not = icmp eq i64 %377, 0
  br i1 %cmp2951579.not, label %cleanup, label %for.body297.lr.ph
...
for.body297:                                      ; preds = %for.body297.lr.ph, %for.inc
  %380 = phi i64 [ %377, %for.body297.lr.ph ], [ %435, %for.inc ]
  %bi.01580 = phi i64 [ 0, %for.body297.lr.ph ], [ %add300, %for.inc ]
  %cmp298 = icmp ugt i64 %bi.01580, 5
  %add300 = add nuw i64 %bi.01580, 1
  %cmp304 = icmp ult i64 %add300, %380
...
for.cond.i.i1213.preheader:                       ; preds = %for.body297
  %381 = load i32, ptr %_capacity.i, align 4, !tbaa !57
  %382 = load i32, ptr %_length.i583, align 8, !tbaa !58
  %383 = xor i32 %382, -1
  %sub2.i.i1216 = add i32 %381, %383
...
if.end.i.i1231:                                   ; preds = %for.cond.i.i1213.preheader
  %cmp4.i.i1219 = icmp sgt i32 %381, 64
  %div24.i.i1220 = lshr i32 %381, 1
  %cmp8.i.i1221 = icmp sgt i32 %381, 8
  ...
  %add18.i.i1228 = add nsw i32 %delta.1.i.i1227, %381
  %add.i.i.i1229 = add nsw i32 %add18.i.i1228, 1
  %cmp.i.i.i1230 = icmp eq i32 %add.i.i.i1229, %381
...
if.end.i.i.i1234:                                 ; preds = %if.end.i.i1231
  ...
  %384 = icmp slt i32 %add18.i.i1228, -1
  %385 = shl nuw nsw i64 %conv.i.i.i1232, 2
  %386 = select i1 %384, i64 -1, i64 %385
  %call.i.i.i1263 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %386) #23
          to label %call.i.i.i.noexc1262 unwind label %lpad292.loopexit.split-lp

call.i.i.i.noexc1262:                             ; preds = %if.end.i.i.i1234
  %call.i.i.i12631748 = ptrtoint ptr %call.i.i.i1263 to i64
  %cmp3.i.i.i1233 = icmp sgt i32 %381, 0
...
for.cond.preheader.i.i.i1236:                     ; preds = %call.i.i.i.noexc1262
  %cmp522.i.i.i1235 = icmp sgt i32 %382, 0
  %387 = load ptr, ptr %methodsString, align 8, !tbaa !55
...
for.body.lr.ph.i.i.i1238:                         ; preds = %for.cond.preheader.i.i.i1236
  ...
  %wide.trip.count.i.i.i1237 = zext i32 %382 to i64
  %min.iters.check1752 = icmp ult i32 %382, 8
  %389 = sub i64 %call.i.i.i12631748, %388
  %diff.check1749 = icmp ult i64 %389, 32
  %or.cond1913 = select i1 %min.iters.check1752, i1 true, i1 %diff.check1749
  br i1 %or.cond1913, label %for.body.i.i.i1246.preheader, label %vector.ph1753

vector.ph1753:                                    ; preds = %for.body.lr.ph.i.i.i1238
  %n.vec1755 = and i64 %wide.trip.count.i.i.i1237, 4294967288
  br label %vector.body1758

vector.body1758:                                  ; preds = %vector.body1758, %vector.ph1753
  %index1759 = phi i64 [ 0, %vector.ph1753 ], [ %index.next1762, %vector.body1758 ]
  %390 = getelementptr inbounds i32, ptr %387, i64 %index1759
  %wide.load1760 = load <4 x i32>, ptr %390, align 4, !tbaa !47
  %391 = getelementptr inbounds i32, ptr %390, i64 4
  %wide.load1761 = load <4 x i32>, ptr %391, align 4, !tbaa !47
  %392 = getelementptr inbounds i32, ptr %call.i.i.i1263, i64 %index1759
  store <4 x i32> %wide.load1760, ptr %392, align 4, !tbaa !47
  %393 = getelementptr inbounds i32, ptr %392, i64 4
  store <4 x i32> %wide.load1761, ptr %393, align 4, !tbaa !47
  %index.next1762 = add nuw i64 %index1759, 8
  %394 = icmp eq i64 %index.next1762, %n.vec1755
  br i1 %394, label %middle.block1750, label %vector.body1758, !llvm.loop !135

middle.block1750:                                 ; preds = %vector.body1758
  %cmp.n1757 = icmp eq i64 %n.vec1755, %wide.trip.count.i.i.i1237
  br i1 %cmp.n1757, label %delete.notnull.i.i.i1248, label %for.body.i.i.i1246.preheader

for.body.i.i.i1246.preheader:                     ; preds = %for.body.lr.ph.i.i.i1238, %middle.block1750
  %indvars.iv.i.i.i1241.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i1238 ], [ %n.vec1755, %middle.block1750 ]
  %395 = xor i64 %indvars.iv.i.i.i1241.ph, -1
  %396 = add nsw i64 %395, %wide.trip.count.i.i.i1237
  %xtraiter1986 = and i64 %wide.trip.count.i.i.i1237, 3
  %lcmp.mod1987.not = icmp eq i64 %xtraiter1986, 0
  br i1 %lcmp.mod1987.not, label %for.body.i.i.i1246.prol.loopexit, label %for.body.i.i.i1246.prol
...
for.body.i.i.i1246.prol:                          ; preds = %for.body.i.i.i1246.preheader, %for.body.i.i.i1246.prol
  ...
  %prol.iter1988 = phi i64 [ %prol.iter1988.next, %for.body.i.i.i1246.prol ], [ 0, %for.body.i.i.i1246.preheader ]
  %arrayidx.i.i.i1242.prol = getelementptr inbounds i32, ptr %387, i64 %indvars.iv.i.i.i1241.prol
  %397 = load i32, ptr %arrayidx.i.i.i1242.prol, align 4, !tbaa !47
  %arrayidx7.i.i.i1243.prol = getelementptr inbounds i32, ptr %call.i.i.i1263, i64 %indvars.iv.i.i.i1241.prol
  store i32 %397, ptr %arrayidx7.i.i.i1243.prol, align 4, !tbaa !47
  ...
  br i1 %prol.iter1988.cmp.not, label %for.body.i.i.i1246.prol.loopexit, label %for.body.i.i.i1246.prol, !llvm.loop !136
...
for.body.i.i.i1246.prol.loopexit:                 ; preds = %for.body.i.i.i1246.prol, %for.body.i.i.i1246.preheader
  ...
  br i1 %398, label %delete.notnull.i.i.i1248, label %for.body.i.i.i1246

for.cond.cleanup.i.i.i1240:                       ; preds = %for.cond.preheader.i.i.i1236
  %isnull.i.i.i1239 = icmp eq ptr %387, null
...
for.body.i.i.i1246:                               ; preds = %for.body.i.i.i1246.prol.loopexit, %for.body.i.i.i1246
  ...
  %arrayidx.i.i.i1242 = getelementptr inbounds i32, ptr %387, i64 %indvars.iv.i.i.i1241
  %399 = load i32, ptr %arrayidx.i.i.i1242, align 4, !tbaa !47
  %arrayidx7.i.i.i1243 = getelementptr inbounds i32, ptr %call.i.i.i1263, i64 %indvars.iv.i.i.i1241
  store i32 %399, ptr %arrayidx7.i.i.i1243, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1244 = add nuw nsw i64 %indvars.iv.i.i.i1241, 1
  %arrayidx.i.i.i1242.1 = getelementptr inbounds i32, ptr %387, i64 %indvars.iv.next.i.i.i1244
  %400 = load i32, ptr %arrayidx.i.i.i1242.1, align 4, !tbaa !47
  %arrayidx7.i.i.i1243.1 = getelementptr inbounds i32, ptr %call.i.i.i1263, i64 %indvars.iv.next.i.i.i1244
  store i32 %400, ptr %arrayidx7.i.i.i1243.1, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1244.1 = add nuw nsw i64 %indvars.iv.i.i.i1241, 2
  %arrayidx.i.i.i1242.2 = getelementptr inbounds i32, ptr %387, i64 %indvars.iv.next.i.i.i1244.1
  %401 = load i32, ptr %arrayidx.i.i.i1242.2, align 4, !tbaa !47
  %arrayidx7.i.i.i1243.2 = getelementptr inbounds i32, ptr %call.i.i.i1263, i64 %indvars.iv.next.i.i.i1244.1
  store i32 %401, ptr %arrayidx7.i.i.i1243.2, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1244.2 = add nuw nsw i64 %indvars.iv.i.i.i1241, 3
  %arrayidx.i.i.i1242.3 = getelementptr inbounds i32, ptr %387, i64 %indvars.iv.next.i.i.i1244.2
  %402 = load i32, ptr %arrayidx.i.i.i1242.3, align 4, !tbaa !47
  %arrayidx7.i.i.i1243.3 = getelementptr inbounds i32, ptr %call.i.i.i1263, i64 %indvars.iv.next.i.i.i1244.2
  store i32 %402, ptr %arrayidx7.i.i.i1243.3, align 4, !tbaa !47
...
delete.notnull.i.i.i1248:                         ; preds = %for.body.i.i.i1246.prol.loopexit, %for.body.i.i.i1246, %middle.block1750, %for.cond.cleanup.i.i.i1240
...
if.end9.i.i.i1251:                                ; preds = %delete.notnull.i.i.i1248, %for.cond.cleanup.i.i.i1240, %call.i.i.i.noexc1262
  %403 = phi i32 [ %.pre.i.i1247, %delete.notnull.i.i.i1248 ], [ %382, %for.cond.cleanup.i.i.i1240 ], [ %382, %call.i.i.i.noexc1262 ]
  store ptr %call.i.i.i1263, ptr %methodsString, align 8, !tbaa !55
  %idxprom13.i.i.i1249 = sext i32 %403 to i64
...
_ZN11CStringBaseIwE10GrowLengthEi.exit.i1254:     ; preds = %if.end9.i.i.i1251, %if.end.i.i1231, %for.cond.i.i1213.preheader
  %404 = phi i32 [ %381, %for.cond.i.i1213.preheader ], [ %381, %if.end.i.i1231 ], [ %add.i.i.i1229, %if.end9.i.i.i1251 ]
  %405 = phi i32 [ %382, %for.cond.i.i1213.preheader ], [ %382, %if.end.i.i1231 ], [ %403, %if.end9.i.i.i1251 ]
  %406 = load ptr, ptr %methodsString, align 8, !tbaa !55
  %idx.ext.i1252 = sext i32 %405 to i64
  %add.ptr.i1253 = getelementptr i32, ptr %406, i64 %idx.ext.i1252
  %incdec.ptr1.i.i1258 = getelementptr inbounds i32, ptr %add.ptr.i1253, i64 1
  store i32 46, ptr %add.ptr.i1253, align 4, !tbaa !47
  %incdec.ptr1.i.i1258.1 = getelementptr inbounds i32, ptr %incdec.ptr1.i.i1258, i64 1
  store i32 46, ptr %incdec.ptr1.i.i1258, align 4, !tbaa !47
  store i32 0, ptr %incdec.ptr1.i.i1258.1, align 4, !tbaa !47
  %add.i1261 = add nsw i32 %405, 2
  store i32 %add.i1261, ptr %_length.i583, align 8, !tbaa !58
  br label %cleanup

if.else308:                                       ; preds = %for.body297
  %407 = load ptr, ptr %_items.i1265, align 8, !tbaa !111
  %arrayidx312 = getelementptr inbounds i8, ptr %407, i64 %bi.01580
  %408 = load i8, ptr %arrayidx312, align 1, !tbaa !112
  %shr.i1266 = lshr i8 %408, 4
  %conv.i.i1267 = zext i8 %shr.i1266 to i32
  %cmp.i.i1268 = icmp ult i8 %408, -96
  %cond.v.i.i = select i1 %cmp.i.i1268, i32 48, i32 55
  %cond.i.i = add nuw nsw i32 %cond.v.i.i, %conv.i.i1267
  %409 = load i32, ptr %_capacity.i, align 4, !tbaa !57
  %410 = load i32, ptr %_length.i583, align 8, !tbaa !58
  %411 = xor i32 %410, -1
  %sub2.i.i1358 = add i32 %409, %411
...
if.end.i.i1372:                                   ; preds = %if.else308
  %cmp4.i.i1360 = icmp sgt i32 %409, 64
  %div24.i.i1361 = lshr i32 %409, 1
  %cmp8.i.i1362 = icmp sgt i32 %409, 8
  ...
  %add18.i.i1369 = add nsw i32 %delta.1.i.i1368, %409
  %add.i.i.i1370 = add nsw i32 %add18.i.i1369, 1
  %cmp.i.i.i1371 = icmp eq i32 %add.i.i.i1370, %409
...
if.end.i.i.i1375:                                 ; preds = %if.end.i.i1372
  ...
  %412 = icmp slt i32 %add18.i.i1369, -1
  %413 = shl nuw nsw i64 %conv.i.i.i1373, 2
  %414 = select i1 %412, i64 -1, i64 %413
  %call.i.i.i1400 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %414) #23
          to label %call.i.i.i.noexc1399 unwind label %lpad292.loopexit

call.i.i.i.noexc1399:                             ; preds = %if.end.i.i.i1375
  %call.i.i.i14001764 = ptrtoint ptr %call.i.i.i1400 to i64
  %cmp3.i.i.i1374 = icmp sgt i32 %409, 0
...
for.cond.preheader.i.i.i1377:                     ; preds = %call.i.i.i.noexc1399
  %cmp522.i.i.i1376 = icmp sgt i32 %410, 0
  %415 = load ptr, ptr %methodsString, align 8, !tbaa !55
...
for.body.lr.ph.i.i.i1379:                         ; preds = %for.cond.preheader.i.i.i1377
  ...
  %wide.trip.count.i.i.i1378 = zext i32 %410 to i64
  %min.iters.check1768 = icmp ult i32 %410, 8
  %417 = sub i64 %call.i.i.i14001764, %416
  %diff.check1765 = icmp ult i64 %417, 32
  %or.cond1914 = select i1 %min.iters.check1768, i1 true, i1 %diff.check1765
  br i1 %or.cond1914, label %for.body.i.i.i1387.preheader, label %vector.ph1769

vector.ph1769:                                    ; preds = %for.body.lr.ph.i.i.i1379
  %n.vec1771 = and i64 %wide.trip.count.i.i.i1378, 4294967288
  br label %vector.body1774

vector.body1774:                                  ; preds = %vector.body1774, %vector.ph1769
  %index1775 = phi i64 [ 0, %vector.ph1769 ], [ %index.next1778, %vector.body1774 ]
  %418 = getelementptr inbounds i32, ptr %415, i64 %index1775
  %wide.load1776 = load <4 x i32>, ptr %418, align 4, !tbaa !47
  %419 = getelementptr inbounds i32, ptr %418, i64 4
  %wide.load1777 = load <4 x i32>, ptr %419, align 4, !tbaa !47
  %420 = getelementptr inbounds i32, ptr %call.i.i.i1400, i64 %index1775
  store <4 x i32> %wide.load1776, ptr %420, align 4, !tbaa !47
  %421 = getelementptr inbounds i32, ptr %420, i64 4
  store <4 x i32> %wide.load1777, ptr %421, align 4, !tbaa !47
  %index.next1778 = add nuw i64 %index1775, 8
  %422 = icmp eq i64 %index.next1778, %n.vec1771
  br i1 %422, label %middle.block1766, label %vector.body1774, !llvm.loop !138

middle.block1766:                                 ; preds = %vector.body1774
  %cmp.n1773 = icmp eq i64 %n.vec1771, %wide.trip.count.i.i.i1378
  br i1 %cmp.n1773, label %delete.notnull.i.i.i1389, label %for.body.i.i.i1387.preheader

for.body.i.i.i1387.preheader:                     ; preds = %for.body.lr.ph.i.i.i1379, %middle.block1766
  %indvars.iv.i.i.i1382.ph = phi i64 [ 0, %for.body.lr.ph.i.i.i1379 ], [ %n.vec1771, %middle.block1766 ]
  %423 = xor i64 %indvars.iv.i.i.i1382.ph, -1
  %424 = add nsw i64 %423, %wide.trip.count.i.i.i1378
  %xtraiter1983 = and i64 %wide.trip.count.i.i.i1378, 3
  %lcmp.mod1984.not = icmp eq i64 %xtraiter1983, 0
  br i1 %lcmp.mod1984.not, label %for.body.i.i.i1387.prol.loopexit, label %for.body.i.i.i1387.prol
...
for.body.i.i.i1387.prol:                          ; preds = %for.body.i.i.i1387.preheader, %for.body.i.i.i1387.prol
  ...
  %prol.iter1985 = phi i64 [ %prol.iter1985.next, %for.body.i.i.i1387.prol ], [ 0, %for.body.i.i.i1387.preheader ]
  %arrayidx.i.i.i1383.prol = getelementptr inbounds i32, ptr %415, i64 %indvars.iv.i.i.i1382.prol
  %425 = load i32, ptr %arrayidx.i.i.i1383.prol, align 4, !tbaa !47
  %arrayidx7.i.i.i1384.prol = getelementptr inbounds i32, ptr %call.i.i.i1400, i64 %indvars.iv.i.i.i1382.prol
  store i32 %425, ptr %arrayidx7.i.i.i1384.prol, align 4, !tbaa !47
  ...
  br i1 %prol.iter1985.cmp.not, label %for.body.i.i.i1387.prol.loopexit, label %for.body.i.i.i1387.prol, !llvm.loop !139
...
for.body.i.i.i1387.prol.loopexit:                 ; preds = %for.body.i.i.i1387.prol, %for.body.i.i.i1387.preheader
  ...
  br i1 %426, label %delete.notnull.i.i.i1389, label %for.body.i.i.i1387

for.cond.cleanup.i.i.i1381:                       ; preds = %for.cond.preheader.i.i.i1377
  %isnull.i.i.i1380 = icmp eq ptr %415, null
...
for.body.i.i.i1387:                               ; preds = %for.body.i.i.i1387.prol.loopexit, %for.body.i.i.i1387
  ...
  %arrayidx.i.i.i1383 = getelementptr inbounds i32, ptr %415, i64 %indvars.iv.i.i.i1382
  %427 = load i32, ptr %arrayidx.i.i.i1383, align 4, !tbaa !47
  %arrayidx7.i.i.i1384 = getelementptr inbounds i32, ptr %call.i.i.i1400, i64 %indvars.iv.i.i.i1382
  store i32 %427, ptr %arrayidx7.i.i.i1384, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1385 = add nuw nsw i64 %indvars.iv.i.i.i1382, 1
  %arrayidx.i.i.i1383.1 = getelementptr inbounds i32, ptr %415, i64 %indvars.iv.next.i.i.i1385
  %428 = load i32, ptr %arrayidx.i.i.i1383.1, align 4, !tbaa !47
  %arrayidx7.i.i.i1384.1 = getelementptr inbounds i32, ptr %call.i.i.i1400, i64 %indvars.iv.next.i.i.i1385
  store i32 %428, ptr %arrayidx7.i.i.i1384.1, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1385.1 = add nuw nsw i64 %indvars.iv.i.i.i1382, 2
  %arrayidx.i.i.i1383.2 = getelementptr inbounds i32, ptr %415, i64 %indvars.iv.next.i.i.i1385.1
  %429 = load i32, ptr %arrayidx.i.i.i1383.2, align 4, !tbaa !47
  %arrayidx7.i.i.i1384.2 = getelementptr inbounds i32, ptr %call.i.i.i1400, i64 %indvars.iv.next.i.i.i1385.1
  store i32 %429, ptr %arrayidx7.i.i.i1384.2, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1385.2 = add nuw nsw i64 %indvars.iv.i.i.i1382, 3
  %arrayidx.i.i.i1383.3 = getelementptr inbounds i32, ptr %415, i64 %indvars.iv.next.i.i.i1385.2
  %430 = load i32, ptr %arrayidx.i.i.i1383.3, align 4, !tbaa !47
  %arrayidx7.i.i.i1384.3 = getelementptr inbounds i32, ptr %call.i.i.i1400, i64 %indvars.iv.next.i.i.i1385.2
  store i32 %430, ptr %arrayidx7.i.i.i1384.3, align 4, !tbaa !47
...
delete.notnull.i.i.i1389:                         ; preds = %for.body.i.i.i1387.prol.loopexit, %for.body.i.i.i1387, %middle.block1766, %for.cond.cleanup.i.i.i1381
...
if.end9.i.i.i1392:                                ; preds = %delete.notnull.i.i.i1389, %for.cond.cleanup.i.i.i1381, %call.i.i.i.noexc1399
  %431 = phi i32 [ %.pre.i.i1388, %delete.notnull.i.i.i1389 ], [ %410, %for.cond.cleanup.i.i.i1381 ], [ %410, %call.i.i.i.noexc1399 ]
  store ptr %call.i.i.i1400, ptr %methodsString, align 8, !tbaa !55
  %idxprom13.i.i.i1390 = sext i32 %431 to i64
...
call2.i.noexc1269:                                ; preds = %if.end9.i.i.i1392, %if.end.i.i1372, %if.else308
  %432 = phi i32 [ %410, %if.else308 ], [ %410, %if.end.i.i1372 ], [ %431, %if.end9.i.i.i1392 ]
  %433 = load ptr, ptr %methodsString, align 8, !tbaa !55
  %idxprom.i1393 = sext i32 %432 to i64
  %arrayidx.i1394 = getelementptr inbounds i32, ptr %433, i64 %idxprom.i1393
  store i32 %cond.i.i, ptr %arrayidx.i1394, align 4, !tbaa !47
  %inc.i1395 = add nsw i32 %432, 1
  store i32 %inc.i1395, ptr %_length.i583, align 8, !tbaa !58
  %idxprom4.i1396 = sext i32 %inc.i1395 to i64
  %arrayidx5.i1397 = getelementptr inbounds i32, ptr %433, i64 %idxprom4.i1396
  store i32 0, ptr %arrayidx5.i1397, align 4, !tbaa !47
  %434 = and i8 %408, 15
  %conv.i9.i = zext i8 %434 to i32
  %cmp.i10.i = icmp ult i8 %434, 10
...
for.inc:                                          ; preds = %call2.i.noexc1269
  %435 = load i64, ptr %_capacity.i1150, align 8, !tbaa !110
  %cmp295 = icmp ult i64 %add300, %435
...
cleanupthread-pre-split.loopexit:                 ; preds = %for.inc
  ...
  %.pre1643.pre = load i32, ptr %_capacity.i, align 4, !tbaa !57
  br label %cleanup
...
cleanup:                                          ; preds = %_ZN11CStringBaseIwE10GrowLengthEi.exit.i1196, %cleanupthread-pre-split.loopexit, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i1254
  %436 = phi i32 [ %404, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i1254 ], [ %.pre1643.pre, %cleanupthread-pre-split.loopexit ], [ %.pre16431646, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i1196 ]
  %437 = phi i32 [ %add.i1261, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i1254 ], [ %.pr.pre, %cleanupthread-pre-split.loopexit ], [ %add.i1203, %_ZN11CStringBaseIwE10GrowLengthEi.exit.i1196 ]
  %438 = xor i32 %437, -1
  %sub2.i.i1274 = add i32 %436, %438
...
if.end.i.i1288:                                   ; preds = %cleanup
  %cmp4.i.i1276 = icmp sgt i32 %436, 64
  %div24.i.i1277 = lshr i32 %436, 1
  %cmp8.i.i1278 = icmp sgt i32 %436, 8
  ...
  %add18.i.i1285 = add nsw i32 %delta.1.i.i1284, %436
  %add.i.i.i1286 = add nsw i32 %add18.i.i1285, 1
  %cmp.i.i.i1287 = icmp eq i32 %add.i.i.i1286, %436
...
if.end.i.i.i1291:                                 ; preds = %if.end.i.i1288
  ...
  %439 = icmp slt i32 %add18.i.i1285, -1
  %440 = shl nuw nsw i64 %conv.i.i.i1289, 2
  %441 = select i1 %439, i64 -1, i64 %440
  %call.i.i.i1316 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %441) #23
          to label %call.i.i.i.noexc1315 unwind label %lpad117

call.i.i.i.noexc1315:                             ; preds = %if.end.i.i.i1291
  %call.i.i.i13161744 = ptrtoint ptr %call.i.i.i1316 to i64
  %cmp3.i.i.i1290 = icmp sgt i32 %436, 0
...
for.cond.preheader.i.i.i1293:                     ; preds = %call.i.i.i.noexc1315
  %cmp522.i.i.i1292 = icmp sgt i32 %437, 0
  %442 = load ptr, ptr %methodsString, align 8, !tbaa !55
...
for.body.lr.ph.i.i.i1295:                         ; preds = %for.cond.preheader.i.i.i1293
  ...
  %wide.trip.count.i.i.i1294 = zext i32 %437 to i64
  %min.iters.check = icmp ult i32 %437, 8
  %444 = sub i64 %call.i.i.i13161744, %443
  %diff.check = icmp ult i64 %444, 32
  %or.cond1915 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond1915, label %for.body.i.i.i1303.preheader, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index1745 = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %445 = getelementptr inbounds i32, ptr %442, i64 %index1745
  %wide.load = load <4 x i32>, ptr %445, align 4, !tbaa !47
  %446 = getelementptr inbounds i32, ptr %445, i64 4
  %wide.load1746 = load <4 x i32>, ptr %446, align 4, !tbaa !47
  %447 = getelementptr inbounds i32, ptr %call.i.i.i1316, i64 %index1745
  store <4 x i32> %wide.load, ptr %447, align 4, !tbaa !47
  %448 = getelementptr inbounds i32, ptr %447, i64 4
  store <4 x i32> %wide.load1746, ptr %448, align 4, !tbaa !47
  %index.next = add nuw i64 %index1745, 8
  %449 = icmp eq i64 %index.next, %n.vec
  br i1 %449, label %middle.block, label %vector.body, !llvm.loop !142
...
for.body.i.i.i1303.preheader:                     ; preds = %for.body.lr.ph.i.i.i1295, %middle.block
  ...
  %450 = xor i64 %indvars.iv.i.i.i1298.ph, -1
  %451 = add nsw i64 %450, %wide.trip.count.i.i.i1294
  %xtraiter1989 = and i64 %wide.trip.count.i.i.i1294, 3
  %lcmp.mod1990.not = icmp eq i64 %xtraiter1989, 0
  br i1 %lcmp.mod1990.not, label %for.body.i.i.i1303.prol.loopexit, label %for.body.i.i.i1303.prol
...
for.body.i.i.i1303.prol:                          ; preds = %for.body.i.i.i1303.preheader, %for.body.i.i.i1303.prol
  ...
  %prol.iter1991 = phi i64 [ %prol.iter1991.next, %for.body.i.i.i1303.prol ], [ 0, %for.body.i.i.i1303.preheader ]
  %arrayidx.i.i.i1299.prol = getelementptr inbounds i32, ptr %442, i64 %indvars.iv.i.i.i1298.prol
  %452 = load i32, ptr %arrayidx.i.i.i1299.prol, align 4, !tbaa !47
  %arrayidx7.i.i.i1300.prol = getelementptr inbounds i32, ptr %call.i.i.i1316, i64 %indvars.iv.i.i.i1298.prol
  store i32 %452, ptr %arrayidx7.i.i.i1300.prol, align 4, !tbaa !47
  ...
  br i1 %prol.iter1991.cmp.not, label %for.body.i.i.i1303.prol.loopexit, label %for.body.i.i.i1303.prol, !llvm.loop !143
...
for.body.i.i.i1303.prol.loopexit:                 ; preds = %for.body.i.i.i1303.prol, %for.body.i.i.i1303.preheader
  ...
  br i1 %453, label %delete.notnull.i.i.i1305, label %for.body.i.i.i1303

for.cond.cleanup.i.i.i1297:                       ; preds = %for.cond.preheader.i.i.i1293
  %isnull.i.i.i1296 = icmp eq ptr %442, null
...
for.body.i.i.i1303:                               ; preds = %for.body.i.i.i1303.prol.loopexit, %for.body.i.i.i1303
  ...
  %arrayidx.i.i.i1299 = getelementptr inbounds i32, ptr %442, i64 %indvars.iv.i.i.i1298
  %454 = load i32, ptr %arrayidx.i.i.i1299, align 4, !tbaa !47
  %arrayidx7.i.i.i1300 = getelementptr inbounds i32, ptr %call.i.i.i1316, i64 %indvars.iv.i.i.i1298
  store i32 %454, ptr %arrayidx7.i.i.i1300, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1301 = add nuw nsw i64 %indvars.iv.i.i.i1298, 1
  %arrayidx.i.i.i1299.1 = getelementptr inbounds i32, ptr %442, i64 %indvars.iv.next.i.i.i1301
  %455 = load i32, ptr %arrayidx.i.i.i1299.1, align 4, !tbaa !47
  %arrayidx7.i.i.i1300.1 = getelementptr inbounds i32, ptr %call.i.i.i1316, i64 %indvars.iv.next.i.i.i1301
  store i32 %455, ptr %arrayidx7.i.i.i1300.1, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1301.1 = add nuw nsw i64 %indvars.iv.i.i.i1298, 2
  %arrayidx.i.i.i1299.2 = getelementptr inbounds i32, ptr %442, i64 %indvars.iv.next.i.i.i1301.1
  %456 = load i32, ptr %arrayidx.i.i.i1299.2, align 4, !tbaa !47
  %arrayidx7.i.i.i1300.2 = getelementptr inbounds i32, ptr %call.i.i.i1316, i64 %indvars.iv.next.i.i.i1301.1
  store i32 %456, ptr %arrayidx7.i.i.i1300.2, align 4, !tbaa !47
  %indvars.iv.next.i.i.i1301.2 = add nuw nsw i64 %indvars.iv.i.i.i1298, 3
  %arrayidx.i.i.i1299.3 = getelementptr inbounds i32, ptr %442, i64 %indvars.iv.next.i.i.i1301.2
  %457 = load i32, ptr %arrayidx.i.i.i1299.3, align 4, !tbaa !47
  %arrayidx7.i.i.i1300.3 = getelementptr inbounds i32, ptr %call.i.i.i1316, i64 %indvars.iv.next.i.i.i1301.2
  store i32 %457, ptr %arrayidx7.i.i.i1300.3, align 4, !tbaa !47
...
if.end9.i.i.i1308:                                ; preds = %delete.notnull.i.i.i1305, %for.cond.cleanup.i.i.i1297, %call.i.i.i.noexc1315
  %458 = phi i32 [ %.pre.i.i1304, %delete.notnull.i.i.i1305 ], [ %437, %for.cond.cleanup.i.i.i1297 ], [ %437, %call.i.i.i.noexc1315 ]
  store ptr %call.i.i.i1316, ptr %methodsString, align 8, !tbaa !55
  %idxprom13.i.i.i1306 = sext i32 %458 to i64
...
_ZN11CStringBaseIwEpLEw.exit1317:                 ; preds = %cleanup, %if.end.i.i1288, %if.end9.i.i.i1308
  %459 = phi i32 [ %437, %cleanup ], [ %437, %if.end.i.i1288 ], [ %458, %if.end9.i.i.i1308 ]
  %460 = load ptr, ptr %methodsString, align 8, !tbaa !55
  %idxprom.i1309 = sext i32 %459 to i64
  %arrayidx.i1310 = getelementptr inbounds i32, ptr %460, i64 %idxprom.i1309
  %inc.i1311 = add nsw i32 %459, 1
  store i32 %inc.i1311, ptr %_length.i583, align 8, !tbaa !58
  store <2 x i32> <i32 93, i32 0>, ptr %arrayidx.i1310, align 4, !tbaa !47
  br label %if.end319
...
delete.notnull.i1319:                             ; preds = %if.end319.thread, %if.end319
  ...
  call void @_ZdaPv(ptr noundef nonnull %propsString.sroa.0.1114701519) #24
  br label %_ZN11CStringBaseIwED2Ev.exit1320

_ZN11CStringBaseIwED2Ev.exit1320:                 ; preds = %if.end319, %delete.notnull.i1319
  %461 = load ptr, ptr %methodName, align 8, !tbaa !55
  %isnull.i1321 = icmp eq ptr %461, null
...
delete.notnull.i1325:                             ; preds = %lpad259, %lpad261, %delete.notnull.i1049, %lpad218, %lpad220, %delete.notnull.i990, %lpad142, %lpad146, %delete.notnull.i725, %ehcleanup130, %lpad211, %ehcleanup240, %ehcleanup198, %ehcleanup171, %ehcleanup320
  %.pn4911525 = phi { ptr, i32 } [ %.pn491, %ehcleanup320 ], [ %303, %delete.notnull.i1049 ], [ %303, %lpad261 ], [ %302, %lpad259 ], [ %284, %delete.notnull.i990 ], [ %284, %lpad220 ], [ %283, %lpad218 ], [ %214, %delete.notnull.i725 ], [ %214, %lpad146 ], [ %213, %lpad142 ], [ %282, %lpad211 ], [ %.pn482, %ehcleanup240 ], [ %.pn476, %ehcleanup130 ], [ %.pn486, %ehcleanup198 ], [ %.pn488, %ehcleanup171 ]
  ...
  call void @_ZdaPv(ptr noundef nonnull %propsString.sroa.0.121524) #24
...
delete.notnull.i1328:                             ; preds = %ehcleanup322.thread, %ehcleanup322
  ...
  %462 = phi ptr [ %call.i.i591, %ehcleanup322.thread ], [ %.pr1527, %ehcleanup322 ]
...
invoke.cont333:                                   ; preds = %for.cond.cleanup
  %463 = load ptr, ptr %methodsString, align 8, !tbaa !55
  %isnull.i1330 = icmp eq ptr %463, null
...
ehcleanup335:                                     ; preds = %lpad104, %ehcleanup324, %lpad330
  %.pn491.pn.pn.pn.pn = phi { ptr, i32 } [ %464, %lpad330 ], [ %.pn491.pn.pn, %ehcleanup324 ], [ %132, %lpad104 ]
  %465 = load ptr, ptr %methodsString, align 8, !tbaa !55
  %isnull.i1333 = icmp eq ptr %465, null
  br i1 %isnull.i1333, label %ehcleanup336, label %delete.notnull.i1334

delete.notnull.i1334:                             ; preds = %ehcleanup335
  call void @_ZdaPv(ptr noundef nonnull %465) #24
  br label %ehcleanup336
...
sw.bb340:                                         ; preds = %entry
  ...
  %466 = load ptr, ptr %_items.i1336, align 8, !tbaa !49
  %arrayidx.i1338 = getelementptr inbounds i32, ptr %466, i64 %idxprom.i.i
  %467 = load i32, ptr %arrayidx.i1338, align 4, !tbaa !42
  %cmp347.not = icmp eq i32 %467, -1
  br i1 %cmp347.not, label %sw.epilog, label %if.then348

if.then348:                                       ; preds = %sw.bb340
  %call350 = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN8NWindows4NCOM12CPropVariantaSEj(ptr noundef nonnull align 8 dereferenceable(16) %prop, i32 noundef %467)
...
sw.bb353:                                         ; preds = %entry, %entry, %entry, %entry, %entry
  ...
  %469 = load ptr, ptr %_items.i1339, align 8, !tbaa !49
  %arrayidx.i1341 = getelementptr inbounds i32, ptr %469, i64 %idxprom.i.i
  %470 = load i32, ptr %arrayidx.i1341, align 4, !tbaa !42
  %cmp360.not = icmp eq i32 %470, -1
  br i1 %cmp360.not, label %if.else390, label %invoke.cont366

invoke.cont366:                                   ; preds = %sw.bb353
  %idxprom.i.i1343 = sext i32 %470 to i64
  %_items.i1345 = getelementptr inbounds %"class.NArchive::N7z::CHandler", ptr %this, i64 0, i32 6, i32 4, i32 0, i32 3
  %471 = load ptr, ptr %_items.i1345, align 8, !tbaa !49
  %arrayidx.i1347 = getelementptr inbounds i32, ptr %471, i64 %idxprom.i.i1343
  %472 = load i32, ptr %arrayidx.i1347, align 4, !tbaa !42
  %cmp372 = icmp eq i32 %472, %index
...
land.lhs.true373:                                 ; preds = %invoke.cont366
  ...
  %473 = load ptr, ptr %_items.i.i1342, align 8, !tbaa !49
  %arrayidx.i.i1344 = getelementptr inbounds ptr, ptr %473, i64 %idxprom.i.i1343
  %474 = load ptr, ptr %arrayidx.i.i1344, align 8, !tbaa !50
  %_size.i1348 = getelementptr inbounds %"struct.NArchive::N7z::CFolder", ptr %474, i64 0, i32 2, i32 0, i32 2
  %475 = load i32, ptr %_size.i1348, align 4, !tbaa !41
  %sub376 = add nsw i32 %propID, -65536
  %cmp377 = icmp sgt i32 %475, %sub376
...
invoke.cont381:                                   ; preds = %land.lhs.true373
  ...
  %476 = load ptr, ptr %_items.i.i1349, align 8, !tbaa !49
  %arrayidx.i.i1351 = getelementptr inbounds i32, ptr %476, i64 %idxprom.i.i1343
  %477 = load i32, ptr %arrayidx.i.i1351, align 4, !tbaa !42
  %add.i1352 = add i32 %477, %sub376
  %_items.i3.i = getelementptr inbounds %"class.NArchive::N7z::CHandler", ptr %this, i64 0, i32 6, i32 0, i32 0, i32 0, i32 3
  %478 = load ptr, ptr %_items.i3.i, align 8, !tbaa !49
  %idxprom.i4.i = sext i32 %add.i1352 to i64
  %arrayidx.i5.i = getelementptr inbounds i64, ptr %478, i64 %idxprom.i4.i
  %479 = load i64, ptr %arrayidx.i5.i, align 8, !tbaa !53
...
if.else385.invoke:                                ; preds = %invoke.cont366, %land.lhs.true373, %invoke.cont381
  %482 = phi i64 [ %479, %invoke.cont381 ], [ 0, %land.lhs.true373 ], [ 0, %invoke.cont366 ]
  %483 = invoke noundef nonnull align 8 dereferenceable(16) ptr @_ZN8NWindows4NCOM12CPropVariantaSEy(ptr noundef nonnull align 8 dereferenceable(16) %prop, i64 noundef %482)
...
ehcleanup398:                                     ; preds = %lpad357, %lpad365, %ehcleanup336, %lpad344, %lpad44, %lpad23, %ehcleanup, %lpad4
  %.pn501 = phi { ptr, i32 } [ %5, %lpad4 ], [ %468, %lpad344 ], [ %59, %lpad44 ], [ %51, %lpad23 ], [ %.pn500, %ehcleanup ], [ %.pn491.pn.pn.pn.pn.pn, %ehcleanup336 ], [ %481, %lpad365 ], [ %480, %lpad357 ]
...
_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1355:     ; preds = %ehcleanup398
  ...
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %prop) #21
  %488 = call i32 @llvm.eh.typeid.for(ptr nonnull @_ZTIPKc) #21
  %matches = icmp eq i32 %ehselector.slot.17, %488
  %489 = call ptr @__cxa_begin_catch(ptr %exn.slot.17) #21
  br i1 %matches, label %catch406, label %catch

catch406:                                         ; preds = %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit1355
  %exception = call ptr @__cxa_allocate_exception(i64 8) #21
  store ptr %489, ptr %exception, align 16, !tbaa !50
  invoke void @__cxa_throw(ptr nonnull %exception, ptr nonnull @_ZTIPKc, ptr null) #25
...
_Z11MyStringLenIwEiPKT_.exit.i.i63:               ; preds = %for.cond.i.i.i60
  ...
  %call.i.i.i6676 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %10) #23
...
_Z11MyStringLenIwEiPKT_.exit.i.i90:               ; preds = %for.cond.i.i.i87
  ...
  %call.i.i.i93104 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %21) #23
...
_Z11MyStringLenIwEiPKT_.exit.i.i121:              ; preds = %for.cond.i.i.i118
  ...
  %call.i.i.i124135 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %31) #23
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local void @_ZN8NArchive3N7z10CInArchiveD2Ev(ptr noundef nonnull align 8 dereferenceable(96) %this) unnamed_addr #2 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
...
; Function Attrs: mustprogress uwtable
define dso_local noundef i32 @_ZN8NArchive3N7z8CHandler5CloseEv(ptr noundef nonnull align 8 dereferenceable(912) %this) unnamed_addr #5 align 2 personality ptr @__gxx_personality_v0 {
entry:
  %_inStream = getelementptr inbounds %"class.NArchive::N7z::CHandler", ptr %this, i64 0, i32 5
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local noundef i32 @_ZN8NArchive3N7z8CHandler14QueryInterfaceERK4GUIDPPv(ptr noundef nonnull align 8 dereferenceable(912) %this, ptr noundef nonnull align 4 dereferenceable(16) %iid, ptr noundef %outObject) unnamed_addr #5 comdat align 2 {
entry:
...
define linkonce_odr dso_local noundef i32 @_ZN8NArchive3N7z8CHandler6AddRefEv(ptr noundef nonnull align 8 dereferenceable(912) %this) unnamed_addr #11 comdat align 2 {
entry:
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr dso_local noundef i32 @_ZN8NArchive3N7z8CHandler7ReleaseEv(ptr noundef nonnull align 8 dereferenceable(912) %this) unnamed_addr #11 comdat align 2 {
entry:
  %add.ptr = getelementptr inbounds i8, ptr %this, i64 128
  %0 = load i32, ptr %add.ptr, align 8, !tbaa !14
  %dec = add i32 %0, -1
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local void @_ZN8NArchive3N7z8CHandlerD2Ev(ptr noundef nonnull align 8 dereferenceable(912) %this) unnamed_addr #2 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
  store ptr getelementptr inbounds ({ [20 x ptr], [8 x ptr], [9 x ptr] }, ptr @_ZTVN8NArchive3N7z8CHandlerE, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !12
  %add.ptr = getelementptr inbounds i8, ptr %this, i64 112
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local void @_ZN8NArchive3N7z8CHandlerD0Ev(ptr noundef nonnull align 8 dereferenceable(912) %this) unnamed_addr #2 comdat align 2 {
entry:
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local void @_ZThn112_N8NArchive3N7z8CHandlerD1Ev(ptr noundef %this) unnamed_addr #2 comdat align 2 {
entry:
  %0 = getelementptr inbounds i8, ptr %this, i64 -112
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local void @_ZThn112_N8NArchive3N7z8CHandlerD0Ev(ptr noundef %this) unnamed_addr #2 comdat align 2 {
entry:
  %0 = getelementptr inbounds i8, ptr %this, i64 -112
  tail call void @_ZN8NArchive3N7z8CHandlerD2Ev(ptr noundef nonnull align 8 dereferenceable(912) %0) #21
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local void @_ZThn120_N8NArchive3N7z8CHandlerD1Ev(ptr noundef %this) unnamed_addr #2 comdat align 2 {
entry:
  %0 = getelementptr inbounds i8, ptr %this, i64 -120
  tail call void @_ZN8NArchive3N7z8CHandlerD2Ev(ptr noundef nonnull align 8 dereferenceable(912) %0) #21
  ret void
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local void @_ZThn120_N8NArchive3N7z8CHandlerD0Ev(ptr noundef %this) unnamed_addr #2 comdat align 2 {
entry:
  %0 = getelementptr inbounds i8, ptr %this, i64 -120
  tail call void @_ZN8NArchive3N7z8CHandlerD2Ev(ptr noundef nonnull align 8 dereferenceable(912) %0) #21
  tail call void @_ZdlPv(ptr noundef nonnull %0) #24
...
define linkonce_odr dso_local void @_ZN13CObjectVectorIN8NArchive14COneMethodInfoEED2Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) unnamed_addr #12 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN13CObjectVectorIN8NArchive14COneMethodInfoEED0Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) unnamed_addr #12 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN8NArchive14COneMethodInfoEE, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !12
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %this)
          to label %_ZN13CObjectVectorIN8NArchive14COneMethodInfoEED2Ev.exit unwind label %terminate.lpad.i
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN13CObjectVectorI5CPropED2Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) unnamed_addr #12 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN13CObjectVectorI5CPropED0Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) unnamed_addr #12 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorI5CPropE, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !12
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %this)
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local void @_ZN8NArchive3N7z16CArchiveDatabaseD2Ev(ptr noundef nonnull align 8 dereferenceable(480) %this) unnamed_addr #2 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN13CObjectVectorIN8NArchive3N7z9CFileItemEED2Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) unnamed_addr #12 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN13CObjectVectorIN8NArchive3N7z7CFolderEED2Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) unnamed_addr #12 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local void @_ZN13CRecordVectorIbED0Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) unnamed_addr #2 comdat align 2 {
entry:
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) #21
  tail call void @_ZdlPv(ptr noundef nonnull %this) #24
  ret void
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN13CObjectVectorIN8NArchive3N7z7CFolderEED0Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) unnamed_addr #12 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN8NArchive3N7z7CFolderEE, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !12
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %this)
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN13CObjectVectorIN8NArchive3N7z10CCoderInfoEED2Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) unnamed_addr #12 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN13CObjectVectorIN8NArchive3N7z10CCoderInfoEED0Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) unnamed_addr #12 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN8NArchive3N7z10CCoderInfoEE, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !12
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %this)
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN13CObjectVectorIN8NArchive3N7z9CFileItemEED0Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) unnamed_addr #12 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN8NArchive3N7z9CFileItemEE, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !12
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %this)
          to label %_ZN13CObjectVectorIN8NArchive3N7z9CFileItemEED2Ev.exit unwind label %terminate.lpad.i
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN13CObjectVectorIN8NArchive3N7z8CInByte2EED2Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) unnamed_addr #12 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN13CObjectVectorIN8NArchive3N7z8CInByte2EED0Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) unnamed_addr #12 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
  store ptr getelementptr inbounds ({ [5 x ptr] }, ptr @_ZTV13CObjectVectorIN8NArchive3N7z8CInByte2EE, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !12
  invoke void @_ZN17CBaseRecordVector5ClearEv(ptr noundef nonnull align 8 dereferenceable(32) %this)
          to label %_ZN13CObjectVectorIN8NArchive3N7z8CInByte2EED2Ev.exit unwind label %terminate.lpad.i
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZN13CObjectVectorIN8NArchive3N7z8CInByte2EE6DeleteEii(ptr noundef nonnull align 8 dereferenceable(32) %this, i32 noundef %index, i32 noundef %num) unnamed_addr #5 comdat align 2 {
entry:
  %add.i = add nsw i32 %num, %index
  %_size.i = getelementptr inbounds %class.CBaseRecordVector, ptr %this, i64 0, i32 2
  %0 = load i32, ptr %_size.i, align 4, !tbaa !41
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZN8NArchive3N7z16CArchiveDatabase5ClearEv(ptr noundef nonnull align 8 dereferenceable(480) %this) local_unnamed_addr #5 comdat align 2 {
entry:
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local void @_ZN13CRecordVectorIN8NArchive3N7z5CBindEED0Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) unnamed_addr #2 comdat align 2 {
entry:
  tail call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %this) #21
  tail call void @_ZdlPv(ptr noundef nonnull %this) #24
  ret void
