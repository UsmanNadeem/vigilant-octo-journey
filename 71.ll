; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/lambda-0.1.3/node.cc'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/lambda-0.1.3/node.cc"
...
if.end16:                                         ; preds = %land.lhs.true
  ...
  %or.cond = select i1 %tobool18.not, i1 true, i1 %tobool23.not
...
if.end58:                                         ; preds = %land.lhs.true53
  ...
  %or.cond453 = select i1 %tobool60.not, i1 true, i1 %tobool65.not
...
if.end182:                                        ; preds = %land.lhs.true177
  ...
  %or.cond454 = select i1 %tobool184.not, i1 true, i1 %tobool189.not
