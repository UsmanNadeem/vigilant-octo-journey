; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/order.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/order.c"
...
@.str.1 = private unnamed_addr constant [91 x i8] c"/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/order.c\00", align 1
...
if.then127:                                       ; preds = %land.lhs.true119, %if.else115.thread, %if.else115
  %18 = phi ptr [ %Lit2.addr.0.val761.val, %if.else115 ], [ %Lit2.addr.0.val761.val, %if.else115.thread ], [ %Lit2.addr.0.val771.val.val, %land.lhs.true119 ]
  %19 = phi ptr [ %Lit2.addr.0.val771.val.val, %if.else115 ], [ %Lit2.addr.0.val771.val.val, %if.else115.thread ], [ %Lit2.addr.0.val761.val, %land.lhs.true119 ]
...
if.end331:                                        ; preds = %lor.lhs.false326
  ...
  %or.cond460.not = select i1 %cmp332, i1 %cmp335, i1 false
...
if.end351:                                        ; preds = %lor.lhs.false346
  ...
  %or.cond461 = select i1 %cmp352, i1 true, i1 %cmp355
