; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/d/lex.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/d/lex.c"
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc73
  ...
  %or.cond = select i1 %tobool.not, i1 %cmp3195, i1 false
...
for.body80:                                       ; preds = %for.body80.lr.ph, %for.inc96
  %14 = phi i32 [ 0, %for.body80.lr.ph ], [ %460, %for.inc96 ]
...
if.end38.i1164.i:                                 ; preds = %if.else24.i1159.i, %if.then12.i1152.i
  ...
  %.pre1818.i = load i32, ptr %chars.i, align 8, !tbaa !37
  br label %new_NFAState.exit1165.i

new_NFAState.exit1165.i:                          ; preds = %if.end38.i1164.i, %if.then28.i1163.i, %if.then16.i1156.i, %if.then.i1148.i
  %29 = phi i32 [ 0, %if.then.i1148.i ], [ 0, %if.then16.i1156.i ], [ 0, %if.then28.i1163.i ], [ %.pre1818.i, %if.end38.i1164.i ]
...
for.body731.i:                                    ; preds = %for.inc871.i, %for.body731.lr.ph.i
  %indvars.iv1815.i = phi i64 [ 0, %for.body731.lr.ph.i ], [ %indvars.iv.next1816.i, %for.inc871.i ]
  %one.21764.i = phi i32 [ %one.1.i, %for.body731.lr.ph.i ], [ %one.3.i, %for.inc871.i ]
  %151 = load ptr, ptr %v.i, align 8, !tbaa !20
  %arrayidx735.i = getelementptr inbounds ptr, ptr %151, i64 %indvars.iv1815.i
...
new_NFAState.exit1570.i:                          ; preds = %if.end38.i1569.i, %if.then28.i1568.i, %if.then16.i1561.i, %if.then.i1553.i
  %168 = phi i32 [ %163, %if.then.i1553.i ], [ %163, %if.then16.i1561.i ], [ %163, %if.then28.i1568.i ], [ %.pre1820.i, %if.end38.i1569.i ]
...
if.end38.i1596.i:                                 ; preds = %if.else24.i1591.i, %if.then12.i1584.i
  ...
  %.pre1819.i = load i32, ptr %epsilon.i, align 8, !tbaa !50
  br label %new_NFAState.exit1597.i

new_NFAState.exit1597.i:                          ; preds = %if.end38.i1596.i, %if.then28.i1595.i, %if.then16.i1588.i, %if.then.i1580.i
  %174 = phi i32 [ %163, %if.then.i1580.i ], [ %163, %if.then16.i1588.i ], [ %163, %if.then28.i1595.i ], [ %.pre1819.i, %if.end38.i1596.i ]
...
for.inc871.i:                                     ; preds = %if.end866.i, %if.then856.i, %if.then842.i, %if.then818.i, %land.lhs.true739.i, %for.body731.i
  ...
  %cmp729.i = icmp ult i64 %indvars.iv.next1816.i, %189
...
for.end873.i:                                     ; preds = %for.inc871.i, %for.cond726.preheader.i
  ...
  br i1 %tobool874.not.i, label %if.end877.i, label %for.cond1.preheader.lr.ph.i.i

for.cond1.preheader.lr.ph.i.i:                    ; preds = %for.end873.i
...
for.cond1.preheader.i.i:                          ; preds = %for.inc105.i.i, %for.cond1.preheader.lr.ph.i.i
  %190 = phi i32 [ 1, %for.cond1.preheader.lr.ph.i.i ], [ %206, %for.inc105.i.i ]
  %191 = phi ptr [ %e.i1653.i, %for.cond1.preheader.lr.ph.i.i ], [ %207, %for.inc105.i.i ]
  %indvars.iv166.i.i = phi i64 [ 0, %for.cond1.preheader.lr.ph.i.i ], [ %indvars.iv.next167.i.i, %for.inc105.i.i ]
...
do.body.thread.i.i:                               ; preds = %for.cond6.preheader.i.i
  ...
  %.pre1823.i = load ptr, ptr %v59.i.phi.trans.insert.i, align 8, !tbaa !49
  %arrayidx61.i.phi.trans.insert.i = getelementptr inbounds ptr, ptr %.pre1823.i, i64 %indvars.iv163.i.i
  %.pre1824.i = load ptr, ptr %arrayidx61.i.phi.trans.insert.i, align 8, !tbaa !14
...
if.end92.i.i:                                     ; preds = %if.else70.i.i, %if.then49.i.i, %do.body.thread.i.i
  %201 = phi ptr [ %198, %if.else70.i.i ], [ %198, %if.then49.i.i ], [ %.pre1824.i, %do.body.thread.i.i ]
...
nfa_closure.exit.i:                               ; preds = %for.inc105.i.i
  ...
  call void @qsort(ptr noundef nonnull %207, i64 noundef %209, i64 noundef 8, ptr noundef nonnull @nfacmp) #13
...
for.body.i.i:                                     ; preds = %for.inc192.i.i, %nfa_closure.exit.i
  ...
  %indvars.iv343.i.i = phi i64 [ 0, %nfa_closure.exit.i ], [ %indvars.iv.next344.i.i, %for.inc192.i.i ]
  %211 = load ptr, ptr %v41.i.i, align 8, !tbaa !38
  %arrayidx85.i.i = getelementptr inbounds ptr, ptr %211, i64 %indvars.iv343.i.i
...
for.cond89.preheader.i.i:                         ; preds = %for.body.i.i, %for.cond89.preheader.ithread-pre-split.i
  ...
  %indvars.iv339.i.i = phi i64 [ %indvars.iv.next340.i.i, %for.cond89.preheader.ithread-pre-split.i ], [ 0, %for.body.i.i ]
  %cmp92304.not.i.i = icmp eq i32 %215, 0
  br i1 %cmp92304.not.i.i, label %for.inc189.i.i, label %for.cond94.preheader.lr.ph.i.i
...
for.cond94.preheader.i.i:                         ; preds = %for.inc121.i.i, %for.cond94.preheader.lr.ph.i.i
  ...
  %indvars.iv328.i.i = phi i64 [ 0, %for.cond94.preheader.lr.ph.i.i ], [ %indvars.iv.next329.i.i, %for.inc121.i.i ]
  %y.0305.i.i = phi ptr [ null, %for.cond94.preheader.lr.ph.i.i ], [ %y.1.lcssa.i.i, %for.inc121.i.i ]
  %arrayidx98299.i.i = getelementptr inbounds ptr, ptr %217, i64 %indvars.iv328.i.i
  %218 = load ptr, ptr %arrayidx98299.i.i, align 8, !tbaa !14
  %arrayidx100300.i.i = getelementptr inbounds %struct.NFAState, ptr %218, i64 0, i32 1, i64 %indvars.iv339.i.i
  %219 = load i32, ptr %arrayidx100300.i.i, align 8, !tbaa !37
  %cmp102301.not.i.i = icmp eq i32 %219, 0
  br i1 %cmp102301.not.i.i, label %for.inc121.i.i, label %for.body103.i.i
...
for.body103.i.i:                                  ; preds = %for.cond94.preheader.i.i, %if.end107.i.i
  ...
  %y.1302.i.i = phi ptr [ %y.2.i.i, %if.end107.i.i ], [ %y.0305.i.i, %for.cond94.preheader.i.i ]
  %tobool104.not.i.i = icmp eq ptr %y.1302.i.i, null
...
if.end107.i.i:                                    ; preds = %if.then105.i.i, %for.body103.i.i
  %y.2.i.i = phi ptr [ %y.1302.i.i, %for.body103.i.i ], [ %calloc.i250.i.i, %if.then105.i.i ]
  %v116.i.i = getelementptr inbounds %struct.NFAState, ptr %220, i64 0, i32 1, i64 %indvars.iv339.i.i, i32 2
  ...
  %arrayidx98.i.i = getelementptr inbounds ptr, ptr %223, i64 %indvars.iv328.i.i
  %224 = load ptr, ptr %arrayidx98.i.i, align 8, !tbaa !14
  %arrayidx100.i.i = getelementptr inbounds %struct.NFAState, ptr %224, i64 0, i32 1, i64 %indvars.iv339.i.i
...
for.inc121.loopexit.i.i:                          ; preds = %if.end107.i.i
  %.pre346.i.i = load i32, ptr %212, align 8, !tbaa !55
  br label %for.inc121.i.i

for.inc121.i.i:                                   ; preds = %for.inc121.loopexit.i.i, %for.cond94.preheader.i.i
  %227 = phi i32 [ %216, %for.cond94.preheader.i.i ], [ %.pre346.i.i, %for.inc121.loopexit.i.i ]
  %228 = phi ptr [ %217, %for.cond94.preheader.i.i ], [ %223, %for.inc121.loopexit.i.i ]
  %y.1.lcssa.i.i = phi ptr [ %y.0305.i.i, %for.cond94.preheader.i.i ], [ %y.2.i.i, %for.inc121.loopexit.i.i ]
  %indvars.iv.next329.i.i = add nuw nsw i64 %indvars.iv328.i.i, 1
  %229 = zext i32 %227 to i64
  %cmp92.i.i = icmp ult i64 %indvars.iv.next329.i.i, %229
...
do.body.thread.i.i.i:                             ; preds = %for.cond6.preheader.i.i.i
  ...
  %.pre349.i.i = load ptr, ptr %v59.i.phi.trans.insert.i.i, align 8, !tbaa !49
  %arrayidx61.i.phi.trans.insert.i.i = getelementptr inbounds ptr, ptr %.pre349.i.i, i64 %indvars.iv163.i.i.i
  %.pre350.i.i = load ptr, ptr %arrayidx61.i.phi.trans.insert.i.i, align 8, !tbaa !14
...
if.end92.i.i.i:                                   ; preds = %if.else70.i.i.i, %if.then49.i.i.i, %do.body.thread.i.i.i
  %242 = phi ptr [ %239, %if.else70.i.i.i ], [ %239, %if.then49.i.i.i ], [ %.pre350.i.i, %do.body.thread.i.i.i ]
...
nfa_closure.exit.i.i:                             ; preds = %for.inc105.i.i.i, %entry.for.end107_crit_edge.i.i.i
  ...
  %cmp129310.not.i.i = icmp eq i32 %251, 0
  %.pre352.i.i = load ptr, ptr %v41.i.i, align 8, !tbaa !38
  br i1 %cmp129310.not.i.i, label %do.body144.i.i, label %for.body130.lr.ph.i.i
...
for.body130.lr.ph.i.i:                            ; preds = %nfa_closure.exit.i.i
  ...
  %wide.trip.count337.i.i = zext i32 %251 to i64
...
for.body130.us.i.i:                               ; preds = %for.body130.lr.ph.i.i, %for.inc141.us.i.i
  %indvars.iv334.i.i = phi i64 [ %indvars.iv.next335.i.i, %for.inc141.us.i.i ], [ 0, %for.body130.lr.ph.i.i ]
  %arrayidx133.us.i.i = getelementptr inbounds ptr, ptr %.pre352.i.i, i64 %indvars.iv334.i.i
  ...
  br i1 %cmp.not.i.us.i.i, label %for.cond.preheader.i.us.i.i, label %for.inc141.us.i.i

for.cond.preheader.i.us.i.i:                      ; preds = %for.body130.us.i.i
  %.pre351.i.i = load ptr, ptr %v109.phi.trans.insert.i.i.i, align 8, !tbaa !53
...
for.inc141.us.i.i:                                ; preds = %for.body130.us.i.i
  ...
  br i1 %exitcond338.not.i.i, label %if.else155.i.i, label %for.body130.us.i.i, !llvm.loop !61

for.body130.i.i:                                  ; preds = %for.body130.lr.ph.i.i, %for.inc141.i.i
  %indvars.iv331.i.i = phi i64 [ %indvars.iv.next332.i.i, %for.inc141.i.i ], [ 0, %for.body130.lr.ph.i.i ]
  %arrayidx133.i.i = getelementptr inbounds ptr, ptr %.pre352.i.i, i64 %indvars.iv331.i.i
...
if.then136.i.i:                                   ; preds = %for.cond.i.i.i, %for.cond.preheader.i.us.i.i
  %261 = phi ptr [ %.pre351.i.i, %for.cond.preheader.i.us.i.i ], [ %257, %for.cond.i.i.i ]
  %idxprom132297.in.in.i.i = phi i64 [ %indvars.iv334.i.i, %for.cond.preheader.i.us.i.i ], [ %indvars.iv331.i.i, %for.cond.i.i.i ]
  %idxprom132297.i.i = and i64 %idxprom132297.in.in.i.i, 4294967295
...
free_DFAState.exit.i.i:                           ; preds = %if.then.i.i.i, %if.then136.i.i
  ...
  %arrayidx139.i.i = getelementptr inbounds ptr, ptr %262, i64 %idxprom132297.i.i
...
for.inc141.i.i:                                   ; preds = %for.body.i.i.i, %for.body130.i.i
  ...
  %exitcond.not.i.i = icmp eq i64 %indvars.iv.next332.i.i, %wide.trip.count337.i.i
...
do.body144.i.i:                                   ; preds = %for.inc141.i.i, %nfa_closure.exit.i.i
  %tobool146.not.i.i = icmp eq ptr %.pre352.i.i, null
...
if.else155.i.i:                                   ; preds = %for.inc141.us.i.i, %do.body144.i.i
  %cmp159.i.i = icmp eq ptr %.pre352.i.i, %e44.i.i
...
if.then174.i.i:                                   ; preds = %if.else170.i.i
  ...
  %arrayidx179.i.i = getelementptr inbounds ptr, ptr %.pre352.i.i, i64 %idxprom178.i.i
...
Lnext.i.i:                                        ; preds = %if.end182.i.i, %if.then174.i.i, %if.then163.i.i, %if.then147.i.i, %free_DFAState.exit.i.i
  ...
  %arrayidx187.i.i = getelementptr inbounds %struct.DFAState, ptr %212, i64 0, i32 1, i64 %indvars.iv339.i.i
...
for.inc189.i.i:                                   ; preds = %Lnext.i.i, %for.end123.i.i, %for.cond89.preheader.i.i
  ...
  %exitcond342.not.i.i = icmp eq i64 %indvars.iv.next340.i.i, 256
  br i1 %exitcond342.not.i.i, label %for.inc192.i.loopexit1772.i, label %for.cond89.preheader.ithread-pre-split.i, !llvm.loop !63

for.inc192.i.loopexit1772.i:                      ; preds = %for.inc189.i.i
  %.pre1825.i = load i32, ptr %alldfas.i.i, align 8, !tbaa !37
  br label %for.inc192.i.i

for.inc192.i.i:                                   ; preds = %for.inc192.i.loopexit1772.i, %for.body.i.i
  %264 = phi i32 [ %.pre1825.i, %for.inc192.i.loopexit1772.i ], [ %210, %for.body.i.i ]
  %indvars.iv.next344.i.i = add nuw nsw i64 %indvars.iv343.i.i, 1
  %265 = zext i32 %264 to i64
  %cmp82.i.i = icmp ult i64 %indvars.iv.next344.i.i, %265
...
for.cond57.preheader.i.i.i:                       ; preds = %for.inc.i.i.i
  %cmp59457.not.i.i.i = icmp eq i32 %275, 0
  br i1 %cmp59457.not.i.i.i, label %do.body.i283.i.i, label %for.cond61.preheader.i.i.i
...
if.end49.i.i.i:                                   ; preds = %if.else34.i.i.i, %if.then21.i.i.i
  ...
  %.pre353.i.i = load i32, ptr %alldfas.i.i, align 8, !tbaa !37
  br label %for.inc.i.i.i

for.inc.i.i.i:                                    ; preds = %if.end49.i.i.i, %if.then37.i.i.i, %if.then24.i.i.i, %if.then.i264.i.i
  %275 = phi i32 [ %.pre353.i.i, %if.end49.i.i.i ], [ %266, %if.then37.i.i.i ], [ %266, %if.then24.i.i.i ], [ %266, %if.then.i264.i.i ]
...
for.cond61.preheader.i.i.i:                       ; preds = %for.cond57.preheader.i.i.i, %for.inc319.i.i.i
  ...
  %indvars.iv478.i.i.i = phi i64 [ %indvars.iv.next479.i.i.i, %for.inc319.i.i.i ], [ 0, %for.cond57.preheader.i.i.i ]
  br label %for.body63.i.i.i

for.cond89.preheader.i.i.i:                       ; preds = %for.inc86.i.i.i.1
  %278 = load ptr, ptr %v41.i.i, align 8, !tbaa !38
  %arrayidx92.i.i.i = getelementptr inbounds ptr, ptr %278, i64 %indvars.iv478.i.i.i
...
for.cond96.preheader.lr.ph.i.i.i:                 ; preds = %for.cond89.preheader.i.i.i
  ...
  %wide.trip.count470.i.i.i = zext i32 %280 to i64
  br label %for.cond96.preheader.i.i.i

for.body63.i.i.i:                                 ; preds = %for.inc86.i.i.i.1, %for.cond61.preheader.i.i.i
  %indvars.iv460.i.i.i = phi i64 [ 0, %for.cond61.preheader.i.i.i ], [ %indvars.iv.next461.i.i.i.1, %for.inc86.i.i.i.1 ]
  %282 = load ptr, ptr %v41.i.i, align 8, !tbaa !38
  %arrayidx66.i.i.i = getelementptr inbounds ptr, ptr %282, i64 %indvars.iv478.i.i.i
  %283 = load ptr, ptr %arrayidx66.i.i.i, align 8, !tbaa !14
  %arrayidx68.i269.i.i = getelementptr inbounds %struct.DFAState, ptr %283, i64 0, i32 1, i64 %indvars.iv460.i.i.i
...
if.then70.i.i.i:                                  ; preds = %for.body63.i.i.i
  ...
  %arrayidx84.i.i.i = getelementptr inbounds %struct.ScanState, ptr %286, i64 0, i32 1, i64 %indvars.iv460.i.i.i
...
for.inc86.i.i.i:                                  ; preds = %if.then70.i.i.i, %for.body63.i.i.i
  %indvars.iv.next461.i.i.i = or i64 %indvars.iv460.i.i.i, 1
  %287 = load ptr, ptr %v41.i.i, align 8, !tbaa !38
  %arrayidx66.i.i.i.1 = getelementptr inbounds ptr, ptr %287, i64 %indvars.iv478.i.i.i
  %288 = load ptr, ptr %arrayidx66.i.i.i.1, align 8, !tbaa !14
  %arrayidx68.i269.i.i.1 = getelementptr inbounds %struct.DFAState, ptr %288, i64 0, i32 1, i64 %indvars.iv.next461.i.i.i
...
if.then70.i.i.i.1:                                ; preds = %for.inc86.i.i.i
  ...
  %arrayidx84.i.i.i.1 = getelementptr inbounds %struct.ScanState, ptr %291, i64 0, i32 1, i64 %indvars.iv.next461.i.i.i
...
for.inc86.i.i.i.1:                                ; preds = %if.then70.i.i.i.1, %for.inc86.i.i.i
  %indvars.iv.next461.i.i.i.1 = add nuw nsw i64 %indvars.iv460.i.i.i, 2
  %exitcond.not.i270.i.i.1 = icmp eq i64 %indvars.iv.next461.i.i.i.1, 256
...
for.cond96.preheader.i.i.i:                       ; preds = %for.inc124.i.i.i, %for.cond96.preheader.lr.ph.i.i.i
  %indvars.iv467.i.i.i = phi i64 [ 0, %for.cond96.preheader.lr.ph.i.i.i ], [ %indvars.iv.next468.i.i.i, %for.inc124.i.i.i ]
  %highest.0446.i.i.i = phi i32 [ -2147483648, %for.cond96.preheader.lr.ph.i.i.i ], [ %highest.1.lcssa.i.i.i, %for.inc124.i.i.i ]
  %arrayidx103.i.i.i = getelementptr inbounds ptr, ptr %281, i64 %indvars.iv467.i.i.i
...
for.body106.i.i.i:                                ; preds = %for.body106.i.i.i, %for.body106.lr.ph.i.i.i.new
  %indvars.iv463.i.i.i = phi i64 [ 0, %for.body106.lr.ph.i.i.i.new ], [ %indvars.iv.next464.i.i.i.3, %for.body106.i.i.i ]
  ...
  %arrayidx117.i.i.i = getelementptr inbounds ptr, ptr %294, i64 %indvars.iv463.i.i.i
  %296 = load ptr, ptr %arrayidx117.i.i.i, align 8, !tbaa !14
  %term.i.i.i = getelementptr inbounds %struct.Action, ptr %296, i64 0, i32 1
  %297 = load ptr, ptr %term.i.i.i, align 8, !tbaa !23
  ...
  %indvars.iv.next464.i.i.i = or i64 %indvars.iv463.i.i.i, 1
  %arrayidx117.i.i.i.1 = getelementptr inbounds ptr, ptr %294, i64 %indvars.iv.next464.i.i.i
  ...
  %300 = load ptr, ptr %term.i.i.i.1, align 8, !tbaa !23
  ...
  %indvars.iv.next464.i.i.i.1 = or i64 %indvars.iv463.i.i.i, 2
  %arrayidx117.i.i.i.2 = getelementptr inbounds ptr, ptr %294, i64 %indvars.iv.next464.i.i.i.1
  ...
  %303 = load ptr, ptr %term.i.i.i.2, align 8, !tbaa !23
  ...
  %indvars.iv.next464.i.i.i.2 = or i64 %indvars.iv463.i.i.i, 3
  %arrayidx117.i.i.i.3 = getelementptr inbounds ptr, ptr %294, i64 %indvars.iv.next464.i.i.i.2
  ...
  %306 = load ptr, ptr %term.i.i.i.3, align 8, !tbaa !23
  ...
  %indvars.iv.next464.i.i.i.3 = add nuw nsw i64 %indvars.iv463.i.i.i, 4
...
for.inc124.i.i.i.loopexit.unr-lcssa:              ; preds = %for.body106.i.i.i, %for.body106.lr.ph.i.i.i
  ...
  %indvars.iv463.i.i.i.unr = phi i64 [ 0, %for.body106.lr.ph.i.i.i ], [ %indvars.iv.next464.i.i.i.3, %for.body106.i.i.i ]
...
for.body106.i.i.i.epil:                           ; preds = %for.inc124.i.i.i.loopexit.unr-lcssa, %for.body106.i.i.i.epil
  %indvars.iv463.i.i.i.epil = phi i64 [ %indvars.iv.next464.i.i.i.epil, %for.body106.i.i.i.epil ], [ %indvars.iv463.i.i.i.unr, %for.inc124.i.i.i.loopexit.unr-lcssa ]
  ...
  %arrayidx117.i.i.i.epil = getelementptr inbounds ptr, ptr %294, i64 %indvars.iv463.i.i.i.epil
  ...
  %309 = load ptr, ptr %term.i.i.i.epil, align 8, !tbaa !23
  ...
  %indvars.iv.next464.i.i.i.epil = add nuw nsw i64 %indvars.iv463.i.i.i.epil, 1
...
for.inc124.i.i.i:                                 ; preds = %for.inc124.i.i.i.loopexit.unr-lcssa, %for.body106.i.i.i.epil, %for.cond96.preheader.i.i.i
  ...
  %indvars.iv.next468.i.i.i = add nuw nsw i64 %indvars.iv467.i.i.i, 1
  %exitcond471.not.i.i.i = icmp eq i64 %indvars.iv.next468.i.i.i, %wide.trip.count470.i.i.i
  br i1 %exitcond471.not.i.i.i, label %for.cond135.preheader.i.i.i, label %for.cond96.preheader.i.i.i, !llvm.loop !75
...
for.cond135.preheader.i.i.i:                      ; preds = %for.inc124.i.i.i, %for.inc316.i.i.i
  ...
  %.pre.i272.i.i = phi ptr [ %.pre483.i.i.i, %for.inc316.i.i.i ], [ %279, %for.inc124.i.i.i ]
  %indvars.iv475.i.i.i = phi i64 [ %indvars.iv.next476.i.i.i, %for.inc316.i.i.i ], [ 0, %for.inc124.i.i.i ]
  %v140449.i.i.i = getelementptr inbounds %struct.anon.13, ptr %.pre.i272.i.i, i64 0, i32 2
  %313 = load ptr, ptr %v140449.i.i.i, align 8, !tbaa !53
  %arrayidx142450.i.i.i = getelementptr inbounds ptr, ptr %313, i64 %indvars.iv475.i.i.i
  %314 = load ptr, ptr %arrayidx142450.i.i.i, align 8, !tbaa !14
  %accepts143451.i.i.i = getelementptr inbounds %struct.NFAState, ptr %314, i64 0, i32 3
  %315 = load i32, ptr %accepts143451.i.i.i, align 8, !tbaa !40
  %cmp145452.not.i.i.i = icmp eq i32 %315, 0
  br i1 %cmp145452.not.i.i.i, label %for.inc316.i.i.i, label %for.body146.i.i.i
...
for.body146.i.i.i:                                ; preds = %for.cond135.preheader.i.i.i, %for.inc313.i.i.i
  ...
  %indvars.iv472.i.i.i = phi i64 [ %indvars.iv.next473.i.i.i, %for.inc313.i.i.i ], [ 0, %for.cond135.preheader.i.i.i ]
  ...
  %arrayidx157.i.i.i = getelementptr inbounds ptr, ptr %319, i64 %indvars.iv472.i.i.i
  %320 = load ptr, ptr %arrayidx157.i.i.i, align 8, !tbaa !14
  %term158.i.i.i = getelementptr inbounds %struct.Action, ptr %320, i64 0, i32 1
  %321 = load ptr, ptr %term158.i.i.i, align 8, !tbaa !23
...
if.then170.i.i.i:                                 ; preds = %do.body162.i.i.i
  ...
  %arrayidx197.i.i.i = getelementptr inbounds ptr, ptr %316, i64 %indvars.iv478.i.i.i
...
for.inc313.i.i.i:                                 ; preds = %if.end293.i.i.i, %if.then264.i.i.i, %if.then227.i.i.i, %if.then170.i.i.i, %for.body146.i.i.i
  %indvars.iv.next473.i.i.i = add nuw nsw i64 %indvars.iv472.i.i.i, 1
  %329 = load ptr, ptr %v41.i.i, align 8, !tbaa !38
  %arrayidx138.i.i.i = getelementptr inbounds ptr, ptr %329, i64 %indvars.iv478.i.i.i
  ...
  %arrayidx142.i.i.i = getelementptr inbounds ptr, ptr %331, i64 %indvars.iv475.i.i.i
  ...
  %cmp145.i.i.i = icmp ult i64 %indvars.iv.next473.i.i.i, %334
...
for.inc316.loopexit.i.i.i:                        ; preds = %for.inc313.i.i.i
  %.pre484.i.i.i = load i32, ptr %330, align 8, !tbaa !55
...
for.inc316.i.i.i:                                 ; preds = %for.inc316.loopexit.i.i.i, %for.cond135.preheader.i.i.i
  ...
  %336 = phi i32 [ %.pre484.i.i.i, %for.inc316.loopexit.i.i.i ], [ %312, %for.cond135.preheader.i.i.i ]
  %.pre483.i.i.i = phi ptr [ %330, %for.inc316.loopexit.i.i.i ], [ %.pre.i272.i.i, %for.cond135.preheader.i.i.i ]
  %indvars.iv.next476.i.i.i = add nuw nsw i64 %indvars.iv475.i.i.i, 1
  %337 = zext i32 %336 to i64
  %cmp133.i.i.i = icmp ult i64 %indvars.iv.next476.i.i.i, %337
...
for.inc319.loopexit.i.i.i:                        ; preds = %for.inc316.i.i.i
  %.pre481.i.i.i = load i32, ptr %alldfas.i.i, align 8, !tbaa !37
  br label %for.inc319.i.i.i

for.inc319.i.i.i:                                 ; preds = %for.inc319.loopexit.i.i.i, %for.cond89.preheader.i.i.i
  %338 = phi i32 [ %.pre481.i.i.i, %for.inc319.loopexit.i.i.i ], [ %277, %for.cond89.preheader.i.i.i ]
  %indvars.iv.next479.i.i.i = add nuw nsw i64 %indvars.iv478.i.i.i, 1
  %339 = zext i32 %338 to i64
  %cmp59.i.i.i = icmp ult i64 %indvars.iv.next479.i.i.i, %339
...
while.cond.loopexit.i.i.i:                        ; preds = %for.inc27.i.i.i
  ...
  %or.cond.i.i = select i1 %tobool.not.i.i1660.i, i1 true, i1 %cmp469.not.i.i.i
...
for.body11.i.i.i:                                 ; preds = %for.inc24.i.i.i, %for.body5.i.i.i
  ...
  %or.cond.i.i1661.i = select i1 %tobool14.not.i.i.i, i1 true, i1 %cmp15.not.i.i.i
...
for.body.i7.i.i:                                  ; preds = %for.inc63.i.i.i, %for.body.lr.ph.i3.i.i
  %indvars.iv204.i.i.i = phi i64 [ 0, %for.body.lr.ph.i3.i.i ], [ %indvars.iv.next205.i.i.i, %for.inc63.i.i.i ]
  ...
  %arrayidx.i4.i.i = getelementptr inbounds ptr, ptr %361, i64 %indvars.iv204.i.i.i
...
Lagainc.preheader.i.i.i.i:                        ; preds = %if.then62.i.i.i.i, %Lagainc.preheader.lr.ph.i.i.i.i
  %365 = phi i32 [ %364, %Lagainc.preheader.lr.ph.i.i.i.i ], [ %387, %if.then62.i.i.i.i ]
...
Lagainb.preheader.i.i.i.i:                        ; preds = %if.end137.i.i.i.i, %Lagainb.preheader.preheader.i.i.i.i
  %368 = phi i32 [ %365, %Lagainb.preheader.preheader.i.i.i.i ], [ %387, %if.end137.i.i.i.i ]
  %369 = phi i32 [ %365, %Lagainb.preheader.preheader.i.i.i.i ], [ %388, %if.end137.i.i.i.i ]
  %indvars.iv229.i.i.i.i = phi i64 [ %367, %Lagainb.preheader.preheader.i.i.i.i ], [ %indvars.iv.next230.i.i.i.i, %if.end137.i.i.i.i ]
  %bb.1210.i.i.i.i = phi i32 [ %bb.0214.i.i.i.i, %Lagainb.preheader.preheader.i.i.i.i ], [ %402, %if.end137.i.i.i.i ]
  %370 = sext i32 %bb.1210.i.i.i.i to i64
  br label %Lagainb.i.i.i.i

while.cond4.preheader.i.i.i.i.loopexit:           ; preds = %if.end137.i.i.i.i
  %371 = trunc i64 %indvars.iv.i.i.i.i to i32
  br label %while.cond4.preheader.i.i.i.i

while.cond4.preheader.i.i.i.i:                    ; preds = %Lagainc.preheader.i.i.i.i, %while.cond4.preheader.i.i.i.i.loopexit
  %372 = phi i32 [ %388, %while.cond4.preheader.i.i.i.i.loopexit ], [ %365, %Lagainc.preheader.i.i.i.i ]
  %bb.1.lcssa.i.i.i.i = phi i32 [ %371, %while.cond4.preheader.i.i.i.i.loopexit ], [ %bb.0214.i.i.i.i, %Lagainc.preheader.i.i.i.i ]
  %cmp6216.i.i.i.i = icmp ult i32 %bb.1.lcssa.i.i.i.i, %372
...
do.body.lr.ph.i.i.i.i:                            ; preds = %while.cond4.preheader.i.i.i.i
  %373 = sext i32 %bb.1.lcssa.i.i.i.i to i64
  br label %do.body.i.i.i.i

do.body.i.i.i.i:                                  ; preds = %do.end.i.i.i.i, %do.body.lr.ph.i.i.i.i
  %indvars.iv232.i.i.i.i = phi i64 [ %373, %do.body.lr.ph.i.i.i.i ], [ %indvars.iv.next233.i.i.i.i, %do.end.i.i.i.i ]
  %374 = load ptr, ptr %v77.i.i.i.i, align 8, !tbaa !38
  %tobool.not.i.i.i1668.i = icmp eq ptr %374, null
  br i1 %tobool.not.i.i.i1668.i, label %if.then8.i.i.i.i, label %if.else.i.i.i.i

if.then8.i.i.i.i:                                 ; preds = %do.body.i.i.i.i
  %375 = load ptr, ptr %v54.i.i.i.i, align 8, !tbaa !38
  %arrayidx.i.i.i.i = getelementptr inbounds ptr, ptr %375, i64 %indvars.iv232.i.i.i.i
  %376 = load ptr, ptr %arrayidx.i.i.i.i, align 8, !tbaa !14
  store ptr %e93.i.i.i.i, ptr %v77.i.i.i.i, align 8, !tbaa !38
  %377 = load i32, ptr %live_diff.i.i.i, align 8, !tbaa !37
  %inc12.i.i.i.i = add i32 %377, 1
  store i32 %inc12.i.i.i.i, ptr %live_diff.i.i.i, align 8, !tbaa !37
  %idxprom13.i.i.i.i = zext i32 %377 to i64
  %arrayidx14.i.i.i.i = getelementptr inbounds ptr, ptr %e93.i.i.i.i, i64 %idxprom13.i.i.i.i
  store ptr %376, ptr %arrayidx14.i.i.i.i, align 8, !tbaa !14
  br label %do.end.i.i.i.i

if.else.i.i.i.i:                                  ; preds = %do.body.i.i.i.i
  %cmp18.i.i.i.i = icmp eq ptr %374, %e93.i.i.i.i
  %378 = load i32, ptr %live_diff.i.i.i, align 8, !tbaa !37
  br i1 %cmp18.i.i.i.i, label %if.then19.i.i.i.i, label %if.else33.i.i.i.i

if.then19.i.i.i.i:                                ; preds = %if.else.i.i.i.i
  %cmp21.i.i.i.i = icmp ult i32 %378, 3
...
if.then22.i.i.i.i:                                ; preds = %if.then19.i.i.i.i
  ...
  %arrayidx26.i.i.i.i = getelementptr inbounds ptr, ptr %379, i64 %indvars.iv232.i.i.i.i
  %380 = load ptr, ptr %arrayidx26.i.i.i.i, align 8, !tbaa !14
...
if.then36.i.i.i.i:                                ; preds = %if.else33.i.i.i.i
  ...
  %arrayidx40.i.i.i.i = getelementptr inbounds ptr, ptr %381, i64 %indvars.iv232.i.i.i.i
  %382 = load ptr, ptr %arrayidx40.i.i.i.i, align 8, !tbaa !14
  %inc43.i.i.i.i = add i32 %378, 1
  store i32 %inc43.i.i.i.i, ptr %live_diff.i.i.i, align 8, !tbaa !37
  %idxprom44.i.i.i.i = zext i32 %378 to i64
  %arrayidx45.i.i.i.i = getelementptr inbounds ptr, ptr %374, i64 %idxprom44.i.i.i.i
  store ptr %382, ptr %arrayidx45.i.i.i.i, align 8, !tbaa !14
  br label %do.end.i.i.i.i

if.end48.i.i.i.i:                                 ; preds = %if.else33.i.i.i.i, %if.then19.i.i.i.i
  %383 = load ptr, ptr %v54.i.i.i.i, align 8, !tbaa !38
  %arrayidx52.i.i.i.i = getelementptr inbounds ptr, ptr %383, i64 %indvars.iv232.i.i.i.i
  %384 = load ptr, ptr %arrayidx52.i.i.i.i, align 8, !tbaa !14
  call void @vec_add_internal(ptr noundef nonnull %live_diff.i.i.i, ptr noundef %384) #13
  br label %do.end.i.i.i.i
...
do.end.i.i.i.i:                                   ; preds = %if.end48.i.i.i.i, %if.then36.i.i.i.i, %if.then22.i.i.i.i, %if.then8.i.i.i.i
  ...
  %385 = load i32, ptr %live.i5.i.i, align 8, !tbaa !37
  %386 = trunc i64 %indvars.iv.next233.i.i.i.i to i32
  %cmp6.i.i.i.i = icmp ugt i32 %385, %386
...
Lagainb.i.i.i.i:                                  ; preds = %do.end132.i.i.i.i, %Lagainb.preheader.i.i.i.i
  %387 = phi i32 [ %368, %Lagainb.preheader.i.i.i.i ], [ %400, %do.end132.i.i.i.i ]
  %388 = phi i32 [ %369, %Lagainb.preheader.i.i.i.i ], [ %400, %do.end132.i.i.i.i ]
  %indvars.iv.i.i.i.i = phi i64 [ %370, %Lagainb.preheader.i.i.i.i ], [ %indvars.iv.next.i.i.i.i, %do.end132.i.i.i.i ]
  %389 = load ptr, ptr %v54.i.i.i.i, align 8, !tbaa !38
  %arrayidx56.i.i.i.i = getelementptr inbounds ptr, ptr %389, i64 %indvars.iv.i.i.i.i
  %390 = load ptr, ptr %arrayidx56.i.i.i.i, align 8, !tbaa !14
  %index.i.i.i.i = getelementptr inbounds %struct.Action, ptr %390, i64 0, i32 4
  %391 = load i32, ptr %index.i.i.i.i, align 8, !tbaa !87
  %392 = load ptr, ptr %v57.i.i.i.i, align 8, !tbaa !38
  %arrayidx59.i.i.i.i = getelementptr inbounds ptr, ptr %392, i64 %indvars.iv229.i.i.i.i
  %393 = load ptr, ptr %arrayidx59.i.i.i.i, align 8, !tbaa !14
  %index60.i.i.i.i = getelementptr inbounds %struct.Action, ptr %393, i64 0, i32 4
  %394 = load i32, ptr %index60.i.i.i.i, align 8, !tbaa !87
  %cmp61.i.i.i.i = icmp eq i32 %391, %394
  br i1 %cmp61.i.i.i.i, label %if.then62.i.i.i.i, label %if.end65.i.i.i.i

if.then62.i.i.i.i:                                ; preds = %Lagainb.i.i.i.i
  %395 = trunc i64 %indvars.iv229.i.i.i.i to i32
  %396 = trunc i64 %indvars.iv.i.i.i.i to i32
  %inc63.i.i.i.i = add nsw i32 %396, 1
  %inc64.i.i.i.i = add nsw i32 %395, 1
  %cmp.not.i.i.i1669.i = icmp ult i32 %inc63.i.i.i.i, %387
...
if.end65.i.i.i.i:                                 ; preds = %Lagainb.i.i.i.i
  %cmp74.i.i.i.i = icmp ult i32 %391, %394
  br i1 %cmp74.i.i.i.i, label %do.body76.i.i.i.i, label %if.end137.i.i.i.i

do.body76.i.i.i.i:                                ; preds = %if.end65.i.i.i.i
  %397 = load ptr, ptr %v77.i.i.i.i, align 8, !tbaa !38
  %tobool78.not.i.i.i.i = icmp eq ptr %397, null
...
if.then114.i.i.i.i:                               ; preds = %if.else110.i.i.i.i
  %inc121.i.i.i.i = add i32 %399, 1
  store i32 %inc121.i.i.i.i, ptr %live_diff.i.i.i, align 8, !tbaa !37
  %idxprom122.i.i.i.i = zext i32 %399 to i64
  %arrayidx123.i.i.i.i = getelementptr inbounds ptr, ptr %397, i64 %idxprom122.i.i.i.i
  store ptr %390, ptr %arrayidx123.i.i.i.i, align 8, !tbaa !14
  br label %do.end132.i.i.i.i

if.end126.i.i.i.i:                                ; preds = %if.else110.i.i.i.i, %if.then96.i.i.i.i
  call void @vec_add_internal(ptr noundef nonnull %live_diff.i.i.i, ptr noundef nonnull %390) #13
  br label %do.end132.i.i.i.i

do.end132.i.i.i.i:                                ; preds = %if.end126.i.i.i.i, %if.then114.i.i.i.i, %if.then99.i.i.i.i, %if.then79.i.i.i.i
  %indvars.iv.next.i.i.i.i = add nsw i64 %indvars.iv.i.i.i.i, 1
  %400 = load i32, ptr %live.i5.i.i, align 8, !tbaa !37
  %401 = trunc i64 %indvars.iv.next.i.i.i.i to i32
  %cmp134.not.i.i.i.i = icmp ugt i32 %400, %401
  br i1 %cmp134.not.i.i.i.i, label %Lagainb.i.i.i.i, label %action_diff.exit.i.i.i

if.end137.i.i.i.i:                                ; preds = %if.end65.i.i.i.i
  %402 = trunc i64 %indvars.iv.i.i.i.i to i32
  %indvars.iv.next230.i.i.i.i = add nsw i64 %indvars.iv229.i.i.i.i, 1
  %403 = load i32, ptr %live12.i.i.i, align 8, !tbaa !37
  %404 = trunc i64 %indvars.iv.next230.i.i.i.i to i32
  %cmp2.not.i.i.i.i = icmp ugt i32 %403, %404
  br i1 %cmp2.not.i.i.i.i, label %Lagainb.preheader.i.i.i.i, label %while.cond4.preheader.i.i.i.i.loopexit
...
action_diff.exit.i.i.i:                           ; preds = %if.then62.i.i.i.i, %do.end.i.i.i.i, %do.end132.i.i.i.i, %while.cond4.preheader.i.i.i.i, %if.then8.i.i.i
  ...
  %405 = load i32, ptr %accepts.i6.i.i, align 8, !tbaa !37
  %cmp.not125.not.i.i.i.i = icmp eq i32 %405, 0
  br i1 %cmp.not125.not.i.i.i.i, label %if.end14.i.i.i, label %Lagainc.preheader.lr.ph.i124.i.i.i

Lagainc.preheader.lr.ph.i124.i.i.i:               ; preds = %action_diff.exit.i.i.i
  ...
  br label %Lagainc.preheader.i125.i.i.i

Lagainc.preheader.i125.i.i.i:                     ; preds = %do.end.i136.i.i.i, %Lagainc.preheader.lr.ph.i124.i.i.i
  %406 = phi i32 [ %405, %Lagainc.preheader.lr.ph.i124.i.i.i ], [ %421, %do.end.i136.i.i.i ]
  %cc.0127.i.i.i.i = phi i32 [ 0, %Lagainc.preheader.lr.ph.i124.i.i.i ], [ %inc59.i.i.i.i, %do.end.i136.i.i.i ]
  %bb.0126.i.i.i.i = phi i32 [ 0, %Lagainc.preheader.lr.ph.i124.i.i.i ], [ %bb.3.i.i.i.i, %do.end.i136.i.i.i ]
  %407 = load i32, ptr %live_diff.i.i.i, align 8, !tbaa !37
  %cmp2.not122.i.i.i.i = icmp ult i32 %cc.0127.i.i.i.i, %407
  br i1 %cmp2.not122.i.i.i.i, label %Lagainb.preheader.lr.ph.i.i.i.i, label %if.end14.i.i.i

Lagainb.preheader.lr.ph.i.i.i.i:                  ; preds = %Lagainc.preheader.i125.i.i.i
  %408 = load ptr, ptr %v.i.i.i1665.i, align 8, !tbaa !38
  %409 = load ptr, ptr %v5.i.i.i.i, align 8, !tbaa !38
  %410 = sext i32 %cc.0127.i.i.i.i to i64
  br label %Lagainb.preheader.i126.i.i.i

Lagainb.preheader.i126.i.i.i:                     ; preds = %if.end76.i.i.i.i, %Lagainb.preheader.lr.ph.i.i.i.i
  %indvars.iv137.i.i.i.i = phi i64 [ %410, %Lagainb.preheader.lr.ph.i.i.i.i ], [ %indvars.iv.next138.i.i.i.i, %if.end76.i.i.i.i ]
  %bb.1123.i.i.i.i = phi i32 [ %bb.0126.i.i.i.i, %Lagainb.preheader.lr.ph.i.i.i.i ], [ %423, %if.end76.i.i.i.i ]
  %arrayidx7.i.i.i.i = getelementptr inbounds ptr, ptr %409, i64 %indvars.iv137.i.i.i.i
  %411 = load ptr, ptr %arrayidx7.i.i.i.i, align 8, !tbaa !14
  %index8.i.i.i.i = getelementptr inbounds %struct.Action, ptr %411, i64 0, i32 4
  %412 = load i32, ptr %index8.i.i.i.i, align 8, !tbaa !87
  %413 = sext i32 %bb.1123.i.i.i.i to i64
  br label %Lagainb.i130.i.i.i

Lagainb.i130.i.i.i:                               ; preds = %if.then70.i.i.i.i, %Lagainb.preheader.i126.i.i.i
  %indvars.iv.i127.i.i.i = phi i64 [ %413, %Lagainb.preheader.i126.i.i.i ], [ %indvars.iv.next.i137.i.i.i, %if.then70.i.i.i.i ]
  %arrayidx.i128.i.i.i = getelementptr inbounds ptr, ptr %408, i64 %indvars.iv.i127.i.i.i
  %414 = load ptr, ptr %arrayidx.i128.i.i.i, align 8, !tbaa !14
  %index.i129.i.i.i = getelementptr inbounds %struct.Action, ptr %414, i64 0, i32 4
  %415 = load i32, ptr %index.i129.i.i.i, align 8, !tbaa !87
  %cmp9.i.i.i.i = icmp eq i32 %415, %412
  br i1 %cmp9.i.i.i.i, label %do.body.i132.i.i.i, label %if.end60.i.i.i.i

do.body.i132.i.i.i:                               ; preds = %Lagainb.i130.i.i.i
  %416 = trunc i64 %indvars.iv137.i.i.i.i to i32
  %417 = trunc i64 %indvars.iv.i127.i.i.i to i32
  %418 = load ptr, ptr %v11.i.i.i.i, align 8, !tbaa !38
  %tobool.not.i131.i.i.i = icmp eq ptr %418, null
  br i1 %tobool.not.i131.i.i.i, label %if.then12.i.i.i.i, label %if.else.i133.i.i.i

if.then12.i.i.i.i:                                ; preds = %do.body.i132.i.i.i
  store ptr %e22.i.i.i.i, ptr %v11.i.i.i.i, align 8, !tbaa !38
  %419 = load i32, ptr %accepts_diff.i.i.i, align 8, !tbaa !37
  %inc18.i.i.i.i = add i32 %419, 1
  store i32 %inc18.i.i.i.i, ptr %accepts_diff.i.i.i, align 8, !tbaa !37
  %idxprom19.i.i.i.i = zext i32 %419 to i64
  %arrayidx20.i.i.i.i = getelementptr inbounds ptr, ptr %e22.i.i.i.i, i64 %idxprom19.i.i.i.i
  store ptr %414, ptr %arrayidx20.i.i.i.i, align 8, !tbaa !14
  br label %do.end.i136.i.i.i

if.else.i133.i.i.i:                               ; preds = %do.body.i132.i.i.i
  %cmp24.i.i.i.i = icmp eq ptr %418, %e22.i.i.i.i
  %420 = load i32, ptr %accepts_diff.i.i.i, align 8, !tbaa !37
  br i1 %cmp24.i.i.i.i, label %if.then25.i.i.i.i, label %if.else39.i.i.i.i

if.then25.i.i.i.i:                                ; preds = %if.else.i133.i.i.i
  %cmp27.i.i.i.i = icmp ult i32 %420, 3
...
if.else39.i.i.i.i:                                ; preds = %if.else.i133.i.i.i
  %and.i134.i.i.i = and i32 %420, 7
  %tobool41.not.i.i.i.i = icmp eq i32 %and.i134.i.i.i, 0
  br i1 %tobool41.not.i.i.i.i, label %if.end54.i.i.i.i, label %if.then42.i.i.i.i

if.then42.i.i.i.i:                                ; preds = %if.else39.i.i.i.i
  %inc49.i.i.i.i = add i32 %420, 1
  store i32 %inc49.i.i.i.i, ptr %accepts_diff.i.i.i, align 8, !tbaa !37
  %idxprom50.i.i.i.i = zext i32 %420 to i64
  %arrayidx51.i.i.i.i = getelementptr inbounds ptr, ptr %418, i64 %idxprom50.i.i.i.i
  store ptr %414, ptr %arrayidx51.i.i.i.i, align 8, !tbaa !14
  br label %do.end.i136.i.i.i

if.end54.i.i.i.i:                                 ; preds = %if.else39.i.i.i.i, %if.then25.i.i.i.i
  call void @vec_add_internal(ptr noundef nonnull %accepts_diff.i.i.i, ptr noundef nonnull %414) #13
  br label %do.end.i136.i.i.i

do.end.i136.i.i.i:                                ; preds = %if.end54.i.i.i.i, %if.then42.i.i.i.i, %if.then28.i.i.i.i, %if.then12.i.i.i.i
  %bb.3.i.i.i.i = add nsw i32 %417, 1
  %inc59.i.i.i.i = add nsw i32 %416, 1
  %421 = load i32, ptr %accepts.i6.i.i, align 8, !tbaa !37
  %cmp.not.i135.i.i.i = icmp ult i32 %bb.3.i.i.i.i, %421
  br i1 %cmp.not.i135.i.i.i, label %Lagainc.preheader.i125.i.i.i, label %if.end14.i.i.i

if.end60.i.i.i.i:                                 ; preds = %Lagainb.i130.i.i.i
  %cmp69.i.i.i.i = icmp ult i32 %415, %412
  br i1 %cmp69.i.i.i.i, label %if.then70.i.i.i.i, label %if.end76.i.i.i.i

if.then70.i.i.i.i:                                ; preds = %if.end60.i.i.i.i
  %indvars.iv.next.i137.i.i.i = add nsw i64 %indvars.iv.i127.i.i.i, 1
  %422 = trunc i64 %indvars.iv.next.i137.i.i.i to i32
  %cmp73.not.i.i.i.i = icmp ugt i32 %406, %422
  br i1 %cmp73.not.i.i.i.i, label %Lagainb.i130.i.i.i, label %if.end14.i.i.i

if.end76.i.i.i.i:                                 ; preds = %if.end60.i.i.i.i
  %423 = trunc i64 %indvars.iv.i127.i.i.i to i32
  %indvars.iv.next138.i.i.i.i = add nsw i64 %indvars.iv137.i.i.i.i, 1
  %lftr.wideiv = trunc i64 %indvars.iv.next138.i.i.i.i to i32
  %exitcond266 = icmp eq i32 %407, %lftr.wideiv
  br i1 %exitcond266, label %if.end14.i.i.i, label %Lagainb.preheader.i126.i.i.i

if.end14.i.i.i:                                   ; preds = %do.end.i136.i.i.i, %Lagainc.preheader.i125.i.i.i, %if.end76.i.i.i.i, %if.then70.i.i.i.i, %action_diff.exit.i.i.i, %if.end.i.i.i
...
do.body.i.i1671.i:                                ; preds = %if.end14.i.i.i
  ...
  %424 = load ptr, ptr %v19.i.i.i, align 8, !tbaa !88
  %tobool20.not.i10.i.i = icmp eq ptr %424, null
  %e.i.i1670.i = getelementptr inbounds %struct.ScanStateTransition, ptr %trans.2.i.i.i, i64 0, i32 1, i32 3
  %cmp24.not.i.i.i = icmp eq ptr %424, %e.i.i1670.i
...
do.body29.i.i.i:                                  ; preds = %if.then25.i.i.i, %do.body.i.i1671.i
  ...
  %425 = load ptr, ptr %v38.i.i.i, align 8, !tbaa !91
  %tobool39.not.i.i.i = icmp eq ptr %425, null
  %e44.i.i.i = getelementptr inbounds %struct.ScanStateTransition, ptr %trans.2.i.i.i, i64 0, i32 2, i32 3
  %cmp46.not.i.i.i = icmp eq ptr %425, %e44.i.i.i
  %or.cond123.i.i.i = select i1 %tobool39.not.i.i.i, i1 true, i1 %cmp46.not.i.i.i
  br i1 %or.cond123.i.i.i, label %do.body51.i.i.i, label %if.then47.i.i.i

if.then47.i.i.i:                                  ; preds = %do.body29.i.i.i
  call void @free(ptr noundef nonnull %425) #13
...
if.end60.i.i.i:                                   ; preds = %do.body51.i.i.i, %if.end14.i.i.i
  ...
  %exitcond203.not.i.i.i = icmp eq i64 %indvars.iv.next.i12.i.i, 256
  br i1 %exitcond203.not.i.i.i, label %for.inc63.i.i.i, label %for.body4.i.i.i, !llvm.loop !93

for.inc63.i.i.i:                                  ; preds = %if.end60.i.i.i
  %indvars.iv.next205.i.i.i = add nuw nsw i64 %indvars.iv204.i.i.i, 1
  %426 = load i32, ptr %scanner.i, align 8, !tbaa !37
  %427 = zext i32 %426 to i64
  %cmp.i13.i.i = icmp ult i64 %indvars.iv.next205.i.i.i, %427
...
for.end65.i.i.i:                                  ; preds = %for.inc63.i.i.i, %for.end65.i.sink.split.i.i, %compute_liveness.exit.i.i
  ...
  %428 = load i32, ptr %transitions66.i.i.i, align 8, !tbaa !95
  %cmp70173.not.i.i.i = icmp eq i32 %428, 0
...
for.body71.lr.ph.i.i.i:                           ; preds = %for.end65.i.i.i
  ...
  %429 = load ptr, ptr %v73.i.i.i, align 8, !tbaa !96
  %wide.trip.count.i.i1672.i = zext i32 %428 to i64
  %xtraiter431 = and i64 %wide.trip.count.i.i1672.i, 7
  %430 = icmp ult i32 %428, 8
  br i1 %430, label %compute_transitions.exit.i.loopexit.unr-lcssa, label %for.body71.lr.ph.i.i.i.new

for.body71.lr.ph.i.i.i.new:                       ; preds = %for.body71.lr.ph.i.i.i
  %unroll_iter434 = and i64 %wide.trip.count.i.i1672.i, 4294967288
  br label %for.body71.i.i.i

for.body71.i.i.i:                                 ; preds = %for.body71.i.i.i, %for.body71.lr.ph.i.i.i.new
  %indvars.iv207.i.i.i = phi i64 [ 0, %for.body71.lr.ph.i.i.i.new ], [ %indvars.iv.next208.i.i.i.7, %for.body71.i.i.i ]
  %niter435 = phi i64 [ 0, %for.body71.lr.ph.i.i.i.new ], [ %niter435.next.7, %for.body71.i.i.i ]
  %arrayidx75.i.i.i = getelementptr inbounds ptr, ptr %429, i64 %indvars.iv207.i.i.i
  %431 = load ptr, ptr %arrayidx75.i.i.i, align 8, !tbaa !14
  %432 = trunc i64 %indvars.iv207.i.i.i to i32
  store i32 %432, ptr %431, align 8, !tbaa !97
  %indvars.iv.next208.i.i.i = or i64 %indvars.iv207.i.i.i, 1
  %arrayidx75.i.i.i.1 = getelementptr inbounds ptr, ptr %429, i64 %indvars.iv.next208.i.i.i
  %433 = load ptr, ptr %arrayidx75.i.i.i.1, align 8, !tbaa !14
  %434 = trunc i64 %indvars.iv.next208.i.i.i to i32
  store i32 %434, ptr %433, align 8, !tbaa !97
  %indvars.iv.next208.i.i.i.1 = or i64 %indvars.iv207.i.i.i, 2
  %arrayidx75.i.i.i.2 = getelementptr inbounds ptr, ptr %429, i64 %indvars.iv.next208.i.i.i.1
  %435 = load ptr, ptr %arrayidx75.i.i.i.2, align 8, !tbaa !14
  %436 = trunc i64 %indvars.iv.next208.i.i.i.1 to i32
  store i32 %436, ptr %435, align 8, !tbaa !97
  %indvars.iv.next208.i.i.i.2 = or i64 %indvars.iv207.i.i.i, 3
  %arrayidx75.i.i.i.3 = getelementptr inbounds ptr, ptr %429, i64 %indvars.iv.next208.i.i.i.2
  %437 = load ptr, ptr %arrayidx75.i.i.i.3, align 8, !tbaa !14
  %438 = trunc i64 %indvars.iv.next208.i.i.i.2 to i32
  store i32 %438, ptr %437, align 8, !tbaa !97
  %indvars.iv.next208.i.i.i.3 = or i64 %indvars.iv207.i.i.i, 4
  %arrayidx75.i.i.i.4 = getelementptr inbounds ptr, ptr %429, i64 %indvars.iv.next208.i.i.i.3
  %439 = load ptr, ptr %arrayidx75.i.i.i.4, align 8, !tbaa !14
  %440 = trunc i64 %indvars.iv.next208.i.i.i.3 to i32
  store i32 %440, ptr %439, align 8, !tbaa !97
  %indvars.iv.next208.i.i.i.4 = or i64 %indvars.iv207.i.i.i, 5
  %arrayidx75.i.i.i.5 = getelementptr inbounds ptr, ptr %429, i64 %indvars.iv.next208.i.i.i.4
  %441 = load ptr, ptr %arrayidx75.i.i.i.5, align 8, !tbaa !14
  %442 = trunc i64 %indvars.iv.next208.i.i.i.4 to i32
  store i32 %442, ptr %441, align 8, !tbaa !97
  %indvars.iv.next208.i.i.i.5 = or i64 %indvars.iv207.i.i.i, 6
  %arrayidx75.i.i.i.6 = getelementptr inbounds ptr, ptr %429, i64 %indvars.iv.next208.i.i.i.5
  %443 = load ptr, ptr %arrayidx75.i.i.i.6, align 8, !tbaa !14
  %444 = trunc i64 %indvars.iv.next208.i.i.i.5 to i32
  store i32 %444, ptr %443, align 8, !tbaa !97
  %indvars.iv.next208.i.i.i.6 = or i64 %indvars.iv207.i.i.i, 7
  %arrayidx75.i.i.i.7 = getelementptr inbounds ptr, ptr %429, i64 %indvars.iv.next208.i.i.i.6
  %445 = load ptr, ptr %arrayidx75.i.i.i.7, align 8, !tbaa !14
  %446 = trunc i64 %indvars.iv.next208.i.i.i.6 to i32
  store i32 %446, ptr %445, align 8, !tbaa !97
  %indvars.iv.next208.i.i.i.7 = add nuw nsw i64 %indvars.iv207.i.i.i, 8
  %niter435.next.7 = add i64 %niter435, 8
  %niter435.ncmp.7 = icmp eq i64 %niter435.next.7, %unroll_iter434
  br i1 %niter435.ncmp.7, label %compute_transitions.exit.i.loopexit.unr-lcssa, label %for.body71.i.i.i, !llvm.loop !98

compute_transitions.exit.i.loopexit.unr-lcssa:    ; preds = %for.body71.i.i.i, %for.body71.lr.ph.i.i.i
  %indvars.iv207.i.i.i.unr = phi i64 [ 0, %for.body71.lr.ph.i.i.i ], [ %indvars.iv.next208.i.i.i.7, %for.body71.i.i.i ]
  %lcmp.mod433.not = icmp eq i64 %xtraiter431, 0
  br i1 %lcmp.mod433.not, label %compute_transitions.exit.i, label %for.body71.i.i.i.epil

for.body71.i.i.i.epil:                            ; preds = %compute_transitions.exit.i.loopexit.unr-lcssa, %for.body71.i.i.i.epil
  %indvars.iv207.i.i.i.epil = phi i64 [ %indvars.iv.next208.i.i.i.epil, %for.body71.i.i.i.epil ], [ %indvars.iv207.i.i.i.unr, %compute_transitions.exit.i.loopexit.unr-lcssa ]
  %epil.iter432 = phi i64 [ %epil.iter432.next, %for.body71.i.i.i.epil ], [ 0, %compute_transitions.exit.i.loopexit.unr-lcssa ]
  %arrayidx75.i.i.i.epil = getelementptr inbounds ptr, ptr %429, i64 %indvars.iv207.i.i.i.epil
  %447 = load ptr, ptr %arrayidx75.i.i.i.epil, align 8, !tbaa !14
  %448 = trunc i64 %indvars.iv207.i.i.i.epil to i32
  store i32 %448, ptr %447, align 8, !tbaa !97
  %indvars.iv.next208.i.i.i.epil = add nuw nsw i64 %indvars.iv207.i.i.i.epil, 1
  %epil.iter432.next = add i64 %epil.iter432, 1
  %epil.iter432.cmp.not = icmp eq i64 %epil.iter432.next, %xtraiter431
  br i1 %epil.iter432.cmp.not, label %compute_transitions.exit.i, label %for.body71.i.i.i.epil, !llvm.loop !99

compute_transitions.exit.i:                       ; preds = %compute_transitions.exit.i.loopexit.unr-lcssa, %for.body71.i.i.i.epil, %for.end65.i.i.i
  %449 = load i32, ptr %transitions81.i.i.i, align 8, !tbaa !100
  %add.i.i.i = add i32 %449, %428
...
if.end877.i:                                      ; preds = %compute_transitions.exit.i, %for.end873.i
  %450 = load i32, ptr %allnfas.i.i, align 8, !tbaa !37
  %cmp19.not.i.i = icmp eq i32 %450, 0
...
for.body.i1676.i:                                 ; preds = %if.end877.i, %free_NFAState.exit.i.i
  ...
  %451 = load ptr, ptr %v.i.i, align 8, !tbaa !38
  %arrayidx.i1675.i = getelementptr inbounds ptr, ptr %451, i64 %indvars.iv.i1674.i
  %452 = load ptr, ptr %arrayidx.i1675.i, align 8, !tbaa !14
...
do.body.i.i1683.i:                                ; preds = %do.body13.i.i.i, %for.body.i1676.i
  ...
  %arrayidx.i.i1678.i = getelementptr inbounds %struct.NFAState, ptr %452, i64 0, i32 1, i64 %indvars.iv.i.i1677.i
  %v.i.i1679.i = getelementptr inbounds %struct.NFAState, ptr %452, i64 0, i32 1, i64 %indvars.iv.i.i1677.i, i32 2
  %453 = load ptr, ptr %v.i.i1679.i, align 8, !tbaa !38
  %tobool.not.i.i1680.i = icmp eq ptr %453, null
  %e.i.i1681.i = getelementptr inbounds %struct.NFAState, ptr %452, i64 0, i32 1, i64 %indvars.iv.i.i1677.i, i32 3
  %cmp8.not.i.i.i = icmp eq ptr %453, %e.i.i1681.i
...
do.body23.i.i.i:                                  ; preds = %do.body13.i.i.i
  %epsilon.i.i1687.i = getelementptr inbounds %struct.NFAState, ptr %452, i64 0, i32 2
  %v24.i.i.i = getelementptr inbounds %struct.NFAState, ptr %452, i64 0, i32 2, i32 2
  %454 = load ptr, ptr %v24.i.i.i, align 8, !tbaa !49
  %tobool25.not.i.i.i = icmp eq ptr %454, null
  %e30.i.i.i = getelementptr inbounds %struct.NFAState, ptr %452, i64 0, i32 2, i32 3
  %cmp32.not.i.i.i = icmp eq ptr %454, %e30.i.i.i
...
do.body37.i.i.i:                                  ; preds = %if.then33.i.i.i, %do.body23.i.i.i
  ...
  %v47.i.i.i = getelementptr inbounds %struct.NFAState, ptr %452, i64 0, i32 3, i32 2
  %455 = load ptr, ptr %v47.i.i.i, align 8, !tbaa !39
  %tobool48.not.i.i.i = icmp eq ptr %455, null
  %e53.i.i.i = getelementptr inbounds %struct.NFAState, ptr %452, i64 0, i32 3, i32 3
  %cmp55.not.i.i.i = icmp eq ptr %455, %e53.i.i.i
...
if.then56.i.i.i:                                  ; preds = %do.body37.i.i.i
  call void @free(ptr noundef nonnull %455) #13
...
free_NFAState.exit.i.i:                           ; preds = %if.then56.i.i.i, %do.body37.i.i.i
  ...
  %456 = load i32, ptr %allnfas.i.i, align 8, !tbaa !37
  %457 = zext i32 %456 to i64
  %cmp.i1689.i = icmp ult i64 %indvars.iv.next.i1688.i, %457
...
do.body.i.i:                                      ; preds = %free_NFAState.exit.i.i, %if.end877.i
  %458 = load ptr, ptr %v.i.i, align 8, !tbaa !38
  %tobool.not.i1690.i = icmp eq ptr %458, null
  %cmp3.not.i.i = icmp eq ptr %458, %e.i.i
...
if.then.i1693.i:                                  ; preds = %do.body.i.i
  call void @free(ptr noundef nonnull %458) #13
...
build_state_scanner.exit:                         ; preds = %do.body.i.i, %if.then.i1693.i
  ...
  %459 = load i32, ptr %scanners.i, align 4, !tbaa !103
  %inc878.i = add i32 %459, 1
...
for.inc96:                                        ; preds = %for.body80, %build_state_scanner.exit, %if.then91
  %460 = phi i32 [ %14, %for.body80 ], [ %inc878.i, %build_state_scanner.exit ], [ %14, %if.then91 ]
  %indvars.iv.next268 = add nuw nsw i64 %indvars.iv267, 1
  %461 = load i32, ptr %states, align 8, !tbaa !5
  %462 = zext i32 %461 to i64
  %cmp79 = icmp ult i64 %indvars.iv.next268, %462
  br i1 %cmp79, label %for.body80, label %for.end98, !llvm.loop !104

for.end98:                                        ; preds = %for.inc96, %entry, %for.cond76.preheader
  %463 = phi i32 [ 0, %for.cond76.preheader ], [ 0, %entry ], [ %460, %for.inc96 ]
  %464 = load i32, ptr @verbose_level, align 4, !tbaa !28
  %tobool99.not = icmp eq i32 %464, 0
...
if.then100:                                       ; preds = %for.end98
  ...
  %465 = load i32, ptr %transitions, align 8, !tbaa !100
  %call101 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str, i32 noundef %463, i32 noundef %465)
  br label %if.end102
