; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/rules-ur.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/rules-ur.c"
...
@.str.1 = private unnamed_addr constant [94 x i8] c"/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/rules-ur.c\00", align 1
...
if.then.us:                                       ; preds = %for.body.us
  ...
  br i1 %cmp.i46.not7.us, label %for.inc30.us, label %for.body15.us14.us.preheader

for.body15.us14.us.preheader:                     ; preds = %if.then.us
  %.pre90 = load i32, ptr @fol_NOT, align 4
  br label %for.body15.us14.us

for.inc30.us:                                     ; preds = %for.inc.us42.us, %if.then.us, %for.body.us
  %Result.3.us = phi ptr [ %Result.012.us, %for.body.us ], [ %Result.012.us, %if.then.us ], [ %Result.2.us43.us, %for.inc.us42.us ]
...
for.body15.us14.us:                               ; preds = %for.body15.us14.us.preheader, %for.inc.us42.us
  %9 = phi i32 [ %16, %for.inc.us42.us ], [ %.pre90, %for.body15.us14.us.preheader ]
  %Result.19.us15.us = phi ptr [ %Result.2.us43.us, %for.inc.us42.us ], [ %Result.012.us, %for.body15.us14.us.preheader ]
  %LitScan.08.us16.us = phi ptr [ %LitScan.0.val45.us44.us, %for.inc.us42.us ], [ %call10.us, %for.body15.us14.us.preheader ]
  %10 = getelementptr i8, ptr %LitScan.08.us16.us, i64 8
  %LitScan.0.val.us17.us = load ptr, ptr %10, align 8
  %11 = getelementptr i8, ptr %LitScan.0.val.us17.us, i64 16
  %call16.val.us18.us = load ptr, ptr %11, align 8
  %12 = getelementptr i8, ptr %call16.val.us18.us, i64 64
  %Clause.val.i.us19.us = load i32, ptr %12, align 8
  %13 = getelementptr i8, ptr %call16.val.us18.us, i64 68
  %Clause.val6.i.us20.us = load i32, ptr %13, align 4
  %add.i.us21.us = add nsw i32 %Clause.val6.i.us20.us, %Clause.val.i.us19.us
  %14 = getelementptr i8, ptr %call16.val.us18.us, i64 72
  %Clause.val7.i.us22.us = load i32, ptr %14, align 8
  %add3.i.us23.us = add nsw i32 %add.i.us21.us, %Clause.val7.i.us22.us
  %Lit.val.us24.us = load ptr, ptr %2, align 8
  %Lit.val.val.us25.us = load i32, ptr %Lit.val.us24.us, align 8
  %cmp.i.not.i.us26.us = icmp eq i32 %9, %Lit.val.val.us25.us
  %15 = getelementptr i8, ptr %LitScan.0.val.us17.us, i64 24
  %L2.val10.i.us27.us = load ptr, ptr %15, align 8
  %L2.val10.val.i.us28.us = load i32, ptr %L2.val10.i.us27.us, align 8
  br i1 %cmp.i.not.i.us26.us, label %land.lhs.true.i.us29.us, label %lor.rhs.i.us31.us

land.lhs.true.i.us29.us:                          ; preds = %for.body15.us14.us
  %cmp.i.i.not.i.us30.us = icmp eq i32 %L2.val10.val.i.us28.us, %9
  br i1 %cmp.i.i.not.i.us30.us, label %lor.rhs.i.us31.us, label %land.lhs.true.us36.us

lor.rhs.i.us31.us:                                ; preds = %land.lhs.true.i.us29.us, %for.body15.us14.us
  %L2.val.val.i.us32.us = phi i32 [ %9, %land.lhs.true.i.us29.us ], [ %L2.val10.val.i.us28.us, %for.body15.us14.us ]
  %cmp.i11.not.i.us33.us = icmp eq i32 %9, %L2.val.val.i.us32.us
  %cmp.i.i13.i.not.us34.us = icmp ne i32 %9, %Lit.val.val.us25.us
  %or.cond6.us35.us.not88 = select i1 %cmp.i11.not.i.us33.us, i1 %cmp.i.i13.i.not.us34.us, i1 false
  %cmp.us.us = icmp eq i32 %add3.i.us23.us, 1
  %or.cond86 = select i1 %or.cond6.us35.us.not88, i1 %cmp.us.us, i1 false
  br i1 %or.cond86, label %if.then26.us39.us, label %for.inc.us42.us

land.lhs.true.us36.us:                            ; preds = %land.lhs.true.i.us29.us
  %cmp.us.us.old = icmp eq i32 %add3.i.us23.us, 1
  br i1 %cmp.us.us.old, label %if.then26.us39.us, label %for.inc.us42.us

if.then26.us39.us:                                ; preds = %lor.rhs.i.us31.us, %land.lhs.true.us36.us
  %call.i.us40.us = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.us41.us = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.us40.us, i64 0, i32 1
  store ptr %LitScan.0.val.us17.us, ptr %car.i.us41.us, align 8
  store ptr %Result.19.us15.us, ptr %call.i.us40.us, align 8
  %.pre = load i32, ptr @fol_NOT, align 4
  br label %for.inc.us42.us

for.inc.us42.us:                                  ; preds = %land.lhs.true.us36.us, %if.then26.us39.us, %lor.rhs.i.us31.us
  %16 = phi i32 [ %.pre, %if.then26.us39.us ], [ %9, %lor.rhs.i.us31.us ], [ %9, %land.lhs.true.us36.us ]
  %Result.2.us43.us = phi ptr [ %call.i.us40.us, %if.then26.us39.us ], [ %Result.19.us15.us, %lor.rhs.i.us31.us ], [ %Result.19.us15.us, %land.lhs.true.us36.us ]
  %LitScan.0.val45.us44.us = load ptr, ptr %LitScan.08.us16.us, align 8
  %cmp.i46.not.us45.us = icmp eq ptr %LitScan.0.val45.us44.us, null
  br i1 %cmp.i46.not.us45.us, label %for.inc30.us, label %for.body15.us14.us, !llvm.loop !14
...
if.then:                                          ; preds = %for.body
  ...
  br i1 %cmp.i46.not7, label %for.inc30, label %for.body15.us.preheader

for.body15.us.preheader:                          ; preds = %if.then
  %.pre92 = load i32, ptr @fol_NOT, align 4
  br label %for.body15.us

for.body15.us:                                    ; preds = %for.body15.us.preheader, %for.inc.us
  %18 = phi i32 [ %25, %for.inc.us ], [ %.pre92, %for.body15.us.preheader ]
  %Result.19.us = phi ptr [ %Result.2.us, %for.inc.us ], [ %Result.012, %for.body15.us.preheader ]
  %LitScan.08.us = phi ptr [ %LitScan.0.val45.us, %for.inc.us ], [ %call10, %for.body15.us.preheader ]
  %19 = getelementptr i8, ptr %LitScan.08.us, i64 8
  %LitScan.0.val.us = load ptr, ptr %19, align 8
  %20 = getelementptr i8, ptr %LitScan.0.val.us, i64 16
  %call16.val.us = load ptr, ptr %20, align 8
  %21 = getelementptr i8, ptr %call16.val.us, i64 64
  %Clause.val.i.us = load i32, ptr %21, align 8
  %22 = getelementptr i8, ptr %call16.val.us, i64 68
  %Clause.val6.i.us = load i32, ptr %22, align 4
  %add.i.us = add nsw i32 %Clause.val6.i.us, %Clause.val.i.us
  %23 = getelementptr i8, ptr %call16.val.us, i64 72
  %Clause.val7.i.us = load i32, ptr %23, align 8
  %add3.i.us = add nsw i32 %add.i.us, %Clause.val7.i.us
  %Lit.val.us = load ptr, ptr %2, align 8
  %Lit.val.val.us = load i32, ptr %Lit.val.us, align 8
  %cmp.i.not.i.us = icmp eq i32 %18, %Lit.val.val.us
  %24 = getelementptr i8, ptr %LitScan.0.val.us, i64 24
  %L2.val10.i.us = load ptr, ptr %24, align 8
  %L2.val10.val.i.us = load i32, ptr %L2.val10.i.us, align 8
  br i1 %cmp.i.not.i.us, label %land.lhs.true.i.us, label %lor.rhs.i.us

land.lhs.true.i.us:                               ; preds = %for.body15.us
  %cmp.i.i.not.i.us = icmp eq i32 %L2.val10.val.i.us, %18
  br i1 %cmp.i.i.not.i.us, label %lor.rhs.i.us, label %land.lhs.true.us

lor.rhs.i.us:                                     ; preds = %land.lhs.true.i.us, %for.body15.us
  %L2.val.val.i.us = phi i32 [ %18, %land.lhs.true.i.us ], [ %L2.val10.val.i.us, %for.body15.us ]
  %cmp.i11.not.i.us = icmp eq i32 %18, %L2.val.val.i.us
  %cmp.i.i13.i.not.us = icmp ne i32 %18, %Lit.val.val.us
  %or.cond6.us.not87 = select i1 %cmp.i11.not.i.us, i1 %cmp.i.i13.i.not.us, i1 false
  %cmp25.us = icmp ne i32 %add3.i.us, 1
  %or.cond = select i1 %or.cond6.us.not87, i1 %cmp25.us, i1 false
  br i1 %or.cond, label %if.then26.us, label %for.inc.us

land.lhs.true.us:                                 ; preds = %land.lhs.true.i.us
  %cmp25.us.old.not = icmp eq i32 %add3.i.us, 1
  br i1 %cmp25.us.old.not, label %for.inc.us, label %if.then26.us

if.then26.us:                                     ; preds = %lor.rhs.i.us, %land.lhs.true.us
  %call.i.us = tail call ptr @memory_Malloc(i32 noundef 16) #11
  %car.i.us = getelementptr inbounds %struct.LIST_HELP, ptr %call.i.us, i64 0, i32 1
  store ptr %LitScan.0.val.us, ptr %car.i.us, align 8
  store ptr %Result.19.us, ptr %call.i.us, align 8
  %.pre91 = load i32, ptr @fol_NOT, align 4
  br label %for.inc.us

for.inc.us:                                       ; preds = %if.then26.us, %land.lhs.true.us, %lor.rhs.i.us
  %25 = phi i32 [ %.pre91, %if.then26.us ], [ %18, %land.lhs.true.us ], [ %18, %lor.rhs.i.us ]
  %Result.2.us = phi ptr [ %call.i.us, %if.then26.us ], [ %Result.19.us, %land.lhs.true.us ], [ %Result.19.us, %lor.rhs.i.us ]
  %LitScan.0.val45.us = load ptr, ptr %LitScan.08.us, align 8
  %cmp.i46.not.us = icmp eq ptr %LitScan.0.val45.us, null
  br i1 %cmp.i46.not.us, label %for.inc30, label %for.body15.us, !llvm.loop !14

for.inc30:                                        ; preds = %for.inc.us, %if.then, %for.body
  %Result.3 = phi ptr [ %Result.012, %for.body ], [ %Result.012, %if.then ], [ %Result.2.us, %for.inc.us ]
