; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/spiff/output.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/spiff/output.c"
...
if.end119.thread:                                 ; preds = %_O_con_line.exit247.thread, %_O_con_line.exit261, %_O_con_line.exit247
  ...
  %call.i = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %25)
  br label %if.then127
...
if.end105:                                        ; preds = %_O_con_line.exit317.thread, %_O_con_line.exit331, %_O_con_line.exit317
  ...
  %call.i332 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %26)
  br label %if.then109
...
for.body.i:                                       ; preds = %for.body.i.preheader, %for.body.i
  ...
  %call.i.i = call i32 @_IO_putc(i32 noundef %conv.i, ptr noundef %8)
...
for.end:                                          ; preds = %for.inc, %for.end.split.loop.exit
  ...
  %call59 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %13) #12
  %14 = trunc i64 %call59 to i32
  %conv60 = add i32 %12, %14
  %15 = load i32, ptr %pos, align 4, !tbaa !24
  %cmp3.i100 = icmp slt i32 %15, %conv60
...
for.body.i109:                                    ; preds = %for.body.i109, %for.body.preheader.i101
  %indvars.iv.i102 = phi i64 [ %16, %for.body.preheader.i101 ], [ %indvars.iv.next.i106, %for.body.i109 ]
  %arrayidx.i103 = getelementptr inbounds i8, ptr %linetext, i64 %indvars.iv.i102
  %17 = load i8, ptr %arrayidx.i103, align 1, !tbaa !23
  %conv.i104 = sext i8 %17 to i32
  %18 = load ptr, ptr @stdout, align 8, !tbaa !19
  %call.i.i105 = call i32 @_IO_putc(i32 noundef %conv.i104, ptr noundef %18)
...
for.body.i129:                                    ; preds = %for.body.i129, %for.body.preheader.i121
  %indvars.iv.i122 = phi i64 [ %19, %for.body.preheader.i121 ], [ %indvars.iv.next.i126, %for.body.i129 ]
  %arrayidx.i123 = getelementptr inbounds i8, ptr %linetext, i64 %indvars.iv.i122
  %20 = load i8, ptr %arrayidx.i123, align 1, !tbaa !23
  %conv.i124 = sext i8 %20 to i32
  %21 = load ptr, ptr @stdout, align 8, !tbaa !19
  %call.i.i125 = call i32 @_IO_putc(i32 noundef %conv.i124, ptr noundef %21)
...
for.inc68:                                        ; preds = %for.body, %_O_pchars.exit130
  %lastline.1 = phi i32 [ %3, %_O_pchars.exit130 ], [ %lastline.0136, %for.body ]
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
  %lftr.wideiv = trunc i64 %indvars.iv.next to i32
