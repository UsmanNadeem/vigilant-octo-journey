; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C++/CLAMR/genmalloc.c"
...
entry:
  ...
  store ptr %storemerge26.i, ptr @genmalloc_memory_item, align 8, !tbaa !10
  %tobool.not27.i = icmp eq ptr %storemerge26.i, null
  br i1 %tobool.not27.i, label %genmalloc_memory_remove_p.exit23, label %for.body.i
...
genmalloc_memory_remove_p.exit23:                 ; preds = %for.cond.i7, %entry, %genmalloc_memory_remove_p.exit, %do.end15.i22
  ret void
}
