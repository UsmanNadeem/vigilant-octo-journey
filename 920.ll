; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Bullet/btCollisionDispatcher.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Bullet/btCollisionDispatcher.cpp"
...
entry:
  %0 = load i32, ptr @gNumManifold, align 4, !tbaa !44
  %inc = add nsw i32 %0, 1
  store i32 %inc, ptr @gNumManifold, align 4, !tbaa !44
  %m_collisionShape.i = getelementptr inbounds %class.btCollisionObject, ptr %b0, i64 0, i32 9
  %1 = load ptr, ptr %m_collisionShape.i, align 8, !tbaa !45
  ...
  %3 = load ptr, ptr %m_collisionShape.i27, align 8, !tbaa !45
  ...
  %5 = load float, ptr %m_contactProcessingThreshold.i, align 4, !tbaa !47
  %m_contactProcessingThreshold.i28 = getelementptr inbounds %class.btCollisionObject, ptr %b1, i64 0, i32 7
  %6 = load float, ptr %m_contactProcessingThreshold.i28, align 4, !tbaa !47
  ...
  %14 = load i32, ptr %m_freeCount.i, align 8, !tbaa !48
  %tobool.not = icmp eq i32 %14, 0
  br i1 %tobool.not, label %if.else, label %if.then

if.then:                                          ; preds = %entry
  %m_firstFree.i = getelementptr inbounds %class.btPoolAllocator, ptr %13, i64 0, i32 3
  %15 = load ptr, ptr %m_firstFree.i, align 8, !tbaa !50
  %16 = load ptr, ptr %15, align 8, !tbaa !32
  store ptr %16, ptr %m_firstFree.i, align 8, !tbaa !50
  %dec.i = add nsw i32 %14, -1
  store i32 %dec.i, ptr %m_freeCount.i, align 8, !tbaa !48
...
invoke.cont:                                      ; preds = %if.then, %if.else
  ...
  store i32 1, ptr %mem.0, align 8, !tbaa !51
  ...
  store i32 %17, ptr %m_index1a, align 4, !tbaa !63
  %m_capacity.i.i = getelementptr inbounds %class.btCollisionDispatcher, ptr %this, i64 0, i32 3, i32 3
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil
  ...
  br i1 %epil.iter.cmp.not, label %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i, label %for.body.i.i.i.epil, !llvm.loop !64
...
entry:
  ...
  %0 = load i32, ptr %m_cachedPoints.i, align 8, !tbaa !62
...
for.body.i:                                       ; preds = %entry, %for.body.i
  ...
  %1 = load i32, ptr %m_cachedPoints.i, align 8, !tbaa !62
  %2 = sext i32 %1 to i64
...
if.then.i:
  %0 = load i32, ptr @gNumManifold, align 4, !tbaa !44
  %dec = add nsw i32 %0, -1
  store i32 %dec, ptr @gNumManifold, align 4, !tbaa !44
  ...
  %2 = load i32, ptr %m_index1a, align 4, !tbaa !63
  %m_size.i = getelementptr inbounds %class.btCollisionDispatcher, ptr %this, i64 0, i32 3, i32 2
  ...
  store i32 %2, ptr %m_index1a5, align 4, !tbaa !63
  ...
  %11 = load ptr, ptr %m_pool.i, align 8, !tbaa !66
...
land.lhs.true.i:                                  ; preds = %if.then.i
  ...
  %12 = load i32, ptr %m_maxElements.i, align 4, !tbaa !67
...
_ZN15btPoolAllocator10freeMemoryEPv.exit:         ; preds = %land.lhs.true.i
  ...
  %14 = load ptr, ptr %m_firstFree.i, align 8, !tbaa !50
  store ptr %14, ptr %manifold, align 8, !tbaa !32
  store ptr %manifold, ptr %m_firstFree.i, align 8, !tbaa !50
  %m_freeCount.i = getelementptr inbounds %class.btPoolAllocator, ptr %10, i64 0, i32 2
  %15 = load i32, ptr %m_freeCount.i, align 8, !tbaa !48
  %inc.i = add nsw i32 %15, 1
  store i32 %inc.i, ptr %m_freeCount.i, align 8, !tbaa !48
  br label %if.end
...
entry:
  ...
  %0 = load i32, ptr %m_collisionFlags.i, align 8, !tbaa !74
  %and.i = and i32 %0, 4
...
land.rhs:                                         ; preds = %entry
  ...
  %1 = load i32, ptr %m_collisionFlags.i12, align 8, !tbaa !74
  %and.i13 = and i32 %1, 4
...
entry:
  ...
  %0 = load i32, ptr %m_activationState1.i.i, align 4, !tbaa !75
...
land.lhs.true:                                    ; preds = %entry, %entry
  ...
  %1 = load i32, ptr %m_activationState1.i.i8, align 4, !tbaa !75
...
if.else:                                          ; preds = %land.lhs.true, %entry
  ...
  %2 = load i8, ptr %m_checkCollideWith.i, align 8, !tbaa !76, !range !77, !noundef !78
...
entry:
  ...
  %1 = load i32, ptr %m_freeCount.i, align 8, !tbaa !48
  %tobool.not = icmp eq i32 %1, 0
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %m_firstFree.i = getelementptr inbounds %class.btPoolAllocator, ptr %0, i64 0, i32 3
  %2 = load ptr, ptr %m_firstFree.i, align 8, !tbaa !50
  %3 = load ptr, ptr %2, align 8, !tbaa !32
  store ptr %3, ptr %m_firstFree.i, align 8, !tbaa !50
...
_ZN15btPoolAllocator10freeMemoryEPv.exit:         ; preds = %land.lhs.true.i
  %m_firstFree.i = getelementptr inbounds %class.btPoolAllocator, ptr %0, i64 0, i32 3
  %4 = load ptr, ptr %m_firstFree.i, align 8, !tbaa !50
  store ptr %4, ptr %ptr, align 8, !tbaa !32
  store ptr %ptr, ptr %m_firstFree.i, align 8, !tbaa !50
  %m_freeCount.i = getelementptr inbounds %class.btPoolAllocator, ptr %0, i64 0, i32 2
  %5 = load i32, ptr %m_freeCount.i, align 8, !tbaa !48
