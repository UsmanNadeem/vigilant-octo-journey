; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/C/BwtSort.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/C/BwtSort.c"
...
for.end204:                                       ; preds = %for.body196.prol.loopexit, %for.body196, %for.cond194.preheader
  %call = tail call i32 @SortGroup(i32 noundef %BlockSize, i32 noundef %NumSortedBytes, i32 noundef %groupOffset.tr507, i32 noundef %i.2454, i32 noundef %NumRefBits, ptr noundef %Indices, i32 noundef %left.addr.0659, i32 noundef %shr127)
...
for.body3:                                        ; preds = %for.body3, %for.body3.preheader.new
  ...
  %4 = load i8, ptr %arrayidx5.1, align 1, !tbaa !23
  ...
  %5 = load i8, ptr %arrayidx7.1, align 1, !tbaa !23
  ...
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %for.end14.loopexit.unr-lcssa, label %for.body3, !llvm.loop !24
...
for.body3.epil:                                   ; preds = %for.end14.loopexit.unr-lcssa
  ...
  %7 = load i8, ptr %arrayidx5.epil, align 1, !tbaa !23
  ...
  %8 = load i8, ptr %arrayidx7.epil, align 1, !tbaa !23
...
for.end14:                                        ; preds = %entry, %for.end14.loopexit
  ...
  %11 = load i8, ptr %arrayidx16, align 1, !tbaa !23
  %conv17 = zext i8 %11 to i64
  %shl18 = shl nuw nsw i64 %conv17, 8
  %12 = load i8, ptr %data, align 1, !tbaa !23
...
for.end61.thread:                                 ; preds = %for.cond41.preheader
  %14 = load i8, ptr %data, align 1, !tbaa !23
...
for.body29:                                       ; preds = %for.body29, %for.end14
  ...
  br i1 %exitcond471.not.3, label %for.cond41.preheader, label %for.body29, !llvm.loop !25
...
for.body45:                                       ; preds = %for.body45, %for.body45.preheader.new
  ...
  %22 = load i8, ptr %arrayidx47, align 1, !tbaa !23
  ...
  %23 = load i8, ptr %arrayidx52, align 1, !tbaa !23
  ...
  %25 = load i8, ptr %arrayidx47.1, align 1, !tbaa !23
  ...
  %26 = load i8, ptr %arrayidx52.1, align 1, !tbaa !23
  ...
  br i1 %niter502.ncmp.1, label %for.end61.unr-lcssa, label %for.body45, !llvm.loop !26
...
for.body45.epil:                                  ; preds = %for.end61.unr-lcssa
  ...
  %28 = load i8, ptr %arrayidx47.epil, align 1, !tbaa !23
  ...
  %29 = load i8, ptr %arrayidx52.epil, align 1, !tbaa !23
...
for.end61:                                        ; preds = %for.end61.unr-lcssa, %for.body45.epil
  ...
  %32 = load i8, ptr %arrayidx63, align 1, !tbaa !23
  %conv64 = zext i8 %32 to i64
  %shl65 = shl nuw nsw i64 %conv64, 8
  %33 = load i8, ptr %data, align 1, !tbaa !23
...
for.body77:                                       ; preds = %for.body77, %for.body77.preheader.new
  ...
  %36 = load i8, ptr %arrayidx79, align 1, !tbaa !23
  ...
  %37 = load i8, ptr %arrayidx84, align 1, !tbaa !23
  ...
  %40 = load i8, ptr %arrayidx79.1, align 1, !tbaa !23
  ...
  %41 = load i8, ptr %arrayidx84.1, align 1, !tbaa !23
  ...
  br i1 %niter506.ncmp.1, label %for.end94.loopexit.unr-lcssa, label %for.body77, !llvm.loop !27
...
for.body77.epil:                                  ; preds = %for.end94.loopexit.unr-lcssa
  ...
  %44 = load i8, ptr %arrayidx79.epil, align 1, !tbaa !23
  ...
  %45 = load i8, ptr %arrayidx84.epil, align 1, !tbaa !23
...
for.end94:                                        ; preds = %for.body77.epil, %for.end94.loopexit.unr-lcssa, %for.end61, %for.end61.thread
  ...
  %48 = load i8, ptr %arrayidx96, align 1, !tbaa !23
  %conv97 = zext i8 %48 to i64
  %shl98 = shl nuw nsw i64 %conv97, 8
  %49 = load i8, ptr %data, align 1, !tbaa !23
...
cleanup:                                          ; preds = %for.body110, %SetGroupSize.exit
  ...
  br i1 %exitcond485.not, label %for.cond125, label %for.body110, !llvm.loop !28
...
for.cond125:                                      ; preds = %cleanup, %for.cond125
  ...
  br i1 %cmp127.not, label %for.end132, label %for.cond125, !llvm.loop !29
...
for.body229.us:                                   ; preds = %for.body229.us, %for.body229.us.preheader.new
  ...
  br i1 %niter510.ncmp.3, label %cleanup245.us.loopexit.unr-lcssa, label %for.body229.us, !llvm.loop !30

if.else.us:                                       ; preds = %cleanup.cont222.us
  %call.us = tail call i32 @SortGroup(i32 noundef %blockSize, i32 noundef %NumSortedBytes.0.us, i32 noundef %i.6462.us, i32 noundef %inc172.us, i32 noundef %spec.store.select, ptr noundef nonnull %Indices, i32 noundef 0, i32 noundef %blockSize)
...
for.body229.us.epil:                              ; preds = %cleanup245.us.loopexit.unr-lcssa, %for.body229.us.epil
  ...
  br i1 %epil.iter.cmp.not, label %cleanup245.us, label %for.body229.us.epil, !llvm.loop !31
...
if.end285:                                        ; preds = %for.body263, %if.then274
  ...
  br i1 %cmp261, label %for.body263, label %for.end291, !llvm.loop !32
