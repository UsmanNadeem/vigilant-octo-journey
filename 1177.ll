; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mafft/tddis.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mafft/tddis.c"
...
for.end87:                                        ; preds = %for.end87.loopexit179.unr-lcssa, %for.body.epil, %for.cond.loopexit.us, %entry
  ...
  %call96 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %19, ptr noundef nonnull @.str, double noundef %conv95) #18
  ret float %conv94
}
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @cpmx_calc(ptr nocapture noundef readonly %seq, ptr nocapture noundef readonly %cpmx, ptr nocapture noundef readonly %eff, i32 noundef %lgth, i32 noundef %clus) local_unnamed_addr #0 {
entry:
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @cpmx_calc_new_bk(ptr nocapture noundef readonly %seq, ptr nocapture noundef readonly %cpmx, ptr nocapture noundef readonly %eff, i32 noundef %lgth, i32 noundef %clus) local_unnamed_addr #0 {
entry:
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @cpmx_calc_new(ptr nocapture noundef readonly %seq, ptr nocapture noundef readonly %cpmx, ptr nocapture noundef readonly %eff, i32 noundef %lgth, i32 noundef %clus) local_unnamed_addr #0 {
entry:
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @MScpmx_calc_new(ptr nocapture noundef readonly %seq, ptr nocapture noundef readonly %cpmx, ptr nocapture noundef readonly %eff, i32 noundef %lgth, i32 noundef %clus) local_unnamed_addr #0 {
entry:
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @cpmx_ribosum(ptr nocapture noundef readonly %seq, ptr nocapture noundef readonly %seqr, ptr nocapture noundef readonly %dir, ptr nocapture noundef readonly %cpmx, ptr nocapture noundef readonly %eff, i32 noundef %lgth, i32 noundef %clus) local_unnamed_addr #0 {
entry:
...
for.cond18.preheader.us.preheader:                ; preds = %for.cond15.preheader
  ...
  %uglygep256 = getelementptr i8, ptr %effarr1, i64 %24
...
vector.memcheck255:                               ; preds = %for.cond18.preheader.us
  ...
  %27 = add nuw i64 %26, 8
  %uglygep258 = getelementptr i8, ptr %effarr1, i64 %27
  %uglygep257 = getelementptr i8, ptr %effarr1, i64 %26
  %uglygep = getelementptr i8, ptr %25, i64 %24
  %bound0 = icmp ult ptr %25, %uglygep256
  %bound1 = icmp ugt ptr %uglygep, %effarr1
  %found.conflict = and i1 %bound0, %bound1
  %bound0259 = icmp ult ptr %25, %uglygep258
  %bound1260 = icmp ult ptr %uglygep257, %uglygep
...
for.body5:                                        ; preds = %for.body5.preheader, %for.body5
  ...
  %call = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %arrayidx8, ptr noundef nonnull dereferenceable(1) %arrayidx10) #19
...
for.cond38.preheader.us.preheader:                ; preds = %for.cond38.preheader.lr.ph
  ...
  %uglygep282 = getelementptr i8, ptr %effarr2, i64 %55
...
vector.memcheck277:                               ; preds = %for.cond38.preheader.us
  ...
  %60 = add nuw i64 %59, 8
  %uglygep281 = getelementptr i8, ptr %effarr1, i64 %60
  %uglygep280 = getelementptr i8, ptr %effarr1, i64 %59
  %uglygep278 = getelementptr i8, ptr %58, i64 %52
  %uglygep279 = getelementptr i8, ptr %58, i64 %54
  %bound0283 = icmp ult ptr %uglygep278, %uglygep281
  %bound1284 = icmp ult ptr %uglygep280, %uglygep279
  %found.conflict285 = and i1 %bound0283, %bound1284
  %bound0286 = icmp ult ptr %uglygep278, %uglygep282
  %bound1287 = icmp ugt ptr %uglygep279, %effarr2
...
for.cond61.preheader.us.preheader:                ; preds = %for.cond61.preheader.lr.ph
  ...
  %uglygep310 = getelementptr i8, ptr %effarr1, i64 %74
...
vector.memcheck306:                               ; preds = %for.cond61.preheader.us
  ...
  %78 = add i64 %77, 8
  %uglygep309 = getelementptr i8, ptr %effarr2, i64 %78
  %uglygep308 = getelementptr i8, ptr %effarr2, i64 %77
  %uglygep307 = getelementptr i8, ptr %76, i64 %74
  %bound0311 = icmp ult ptr %76, %uglygep309
  %bound1312 = icmp ult ptr %uglygep308, %uglygep307
  %found.conflict313 = and i1 %bound0311, %bound1312
  %bound0314 = icmp ult ptr %76, %uglygep310
  %bound1315 = icmp ugt ptr %uglygep307, %effarr1
...
for.cond84.preheader.us.preheader:                ; preds = %for.cond57.preheader.thread242, %for.cond61.preheader.lr.ph, %for.cond80.preheader
  ...
  %105 = sub i64 %104, %102
  %uglygep337 = getelementptr i8, ptr %effarr2, i64 %105
...
vector.memcheck333:                               ; preds = %for.cond84.preheader.us
  ...
  %111 = add i64 %110, 8
  %uglygep341 = getelementptr i8, ptr %effarr2, i64 %111
  %uglygep340 = getelementptr i8, ptr %effarr2, i64 %110
  %uglygep334 = getelementptr i8, ptr %109, i64 %102
  %uglygep336 = getelementptr i8, ptr %109, i64 %104
  %bound0342 = icmp ult ptr %uglygep334, %uglygep337
  %bound1343 = icmp ugt ptr %uglygep336, %effarr2
  %found.conflict344 = and i1 %bound0342, %bound1343
  %bound0345 = icmp ult ptr %uglygep334, %uglygep341
  %bound1346 = icmp ult ptr %uglygep340, %uglygep336
...
define dso_local void @strnbcat(ptr nocapture noundef readonly %s1, ptr noundef %s2, i32 noundef %m) local_unnamed_addr #7 {
entry:
  %conv = sext i32 %m to i64
  %call = tail call ptr @strncpy(ptr noundef nonnull @strnbcat.b, ptr noundef %s1, i64 noundef %conv) #19
  %arrayidx = getelementptr inbounds [5000000 x i8], ptr @strnbcat.b, i64 0, i64 %conv
  store i8 0, ptr %arrayidx, align 1, !tbaa !11
  %call1 = tail call ptr @strcat(ptr noundef nonnull dereferenceable(1) @strnbcat.b, ptr noundef nonnull dereferenceable(1) %s2) #19
  %call2 = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %s2, ptr noundef nonnull dereferenceable(1) @strnbcat.b) #19
  ret void
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %b) #19
...
for.body:                                         ; preds = %for.body.preheader, %if.end
  ...
  %call = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %b, ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %5) #19
  %call1 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %d) #17
  %cmp2 = icmp ult i64 %call1, 100
  br i1 %cmp2, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %call4 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %d, ptr noundef nonnull dereferenceable(1) %b) #19
  br label %if.end
...
for.end23:                                        ; preds = %for.body18, %middle.block, %entry, %for.cond16.preheader
  ...
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %b) #19
  ret i32 %k.0.lcssa61
}
...
define dso_local void @makegrouprna(ptr nocapture noundef writeonly %group, ptr nocapture noundef readonly %all, ptr nocapture noundef readonly %memlist) local_unnamed_addr #8 {
entry:
...
; Function Attrs: nofree norecurse nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none) uwtable
define dso_local void @makegrouprnait(ptr nocapture noundef writeonly %group, ptr nocapture noundef readonly %all, ptr nocapture noundef readonly %pair, i32 noundef %s) local_unnamed_addr #8 {
entry:
  %0 = load i32, ptr @njob, align 4, !tbaa !5
...
for.body:                                         ; preds = %entry, %if.end
  ...
  %call = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %b, ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %add) #19
...
if.then:                                          ; preds = %for.body
  ...
  %call = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %b, ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %7) #19
  %call6 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %d) #17
  %cmp7 = icmp ult i64 %call6, 100
  br i1 %cmp7, label %if.then9, label %if.end

if.then9:                                         ; preds = %if.then
  %call11 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %d, ptr noundef nonnull dereferenceable(1) %b) #19
  br label %if.end
...
if.then:                                          ; preds = %for.body
  ...
  %call = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %b, ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %4) #19
  %call6 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %d) #17
  %cmp7 = icmp ult i64 %call6, 100
  br i1 %cmp7, label %if.then9, label %if.end
...
define dso_local void @chardelete(ptr noundef %seq, i32 noundef %d) local_unnamed_addr #9 {
entry:
  %b = alloca [5000000 x i8], align 16
  call void @llvm.lifetime.start.p0(i64 5000000, ptr nonnull %b) #19
  %idx.ext = sext i32 %d to i64
  %add.ptr = getelementptr inbounds i8, ptr %seq, i64 %idx.ext
  %add.ptr1 = getelementptr inbounds i8, ptr %add.ptr, i64 1
  %call = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %b, ptr noundef nonnull dereferenceable(1) %add.ptr1) #19
  %call5 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %add.ptr, ptr noundef nonnull dereferenceable(1) %b) #19
  call void @llvm.lifetime.end.p0(i64 5000000, ptr nonnull %b) #19
  ret void
}

; Function Attrs: nofree norecurse nosync nounwind memory(read, inaccessiblemem: none) uwtable
define dso_local i32 @RootBranchNode(i32 noundef %nseq, ptr nocapture noundef readonly %topol, i32 noundef %step, i32 noundef %branch) local_unnamed_addr #10 {
entry:
...
; Function Attrs: nofree norecurse nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none) uwtable
define dso_local void @BranchLeafNode(i32 noundef %nseq, ptr nocapture noundef readonly %topol, ptr nocapture noundef %node, i32 noundef %step, i32 noundef %branch) local_unnamed_addr #8 {
entry:
...
; Function Attrs: nofree norecurse nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none) uwtable
define dso_local void @RootLeafNode(i32 noundef %nseq, ptr nocapture noundef readonly %topol, ptr nocapture noundef %node) local_unnamed_addr #8 {
entry:
...
define dso_local void @nodeFromABranch(i32 noundef %nseq, ptr nocapture noundef writeonly %result, ptr nocapture noundef readonly %pairwisenode, ptr nocapture noundef readonly %topol, ptr nocapture noundef readnone %len, i32 noundef %step, i32 noundef %num) local_unnamed_addr #11 {
entry:
...
if.then:                                          ; preds = %entry
  %call = tail call ptr @AllocateIntVec(i32 noundef %nseq) #19
  store ptr %call, ptr @nodeFromABranch.outergroup2, align 8, !tbaa !9
  %call1 = tail call ptr @AllocateIntVec(i32 noundef %nseq) #19
...
declare ptr @AllocateIntVec(i32 noundef) local_unnamed_addr #12
...
for.body26.preheader:                             ; preds = %for.end23
  ...
  %.pre80 = load i32, ptr %s1, align 4, !tbaa !5
...
for.body26.prol:                                  ; preds = %for.body26.preheader
  %idxprom27.prol = sext i32 %.pre80 to i64
  %arrayidx28.prol = getelementptr inbounds ptr, ptr %pair, i64 %idxprom27.prol
  %18 = load ptr, ptr %arrayidx28.prol, align 8, !tbaa !9
  %arrayidx30.prol = getelementptr inbounds i8, ptr %18, i64 %15
  %19 = load i8, ptr %arrayidx30.prol, align 1, !tbaa !11
  %tobool31.not.prol = icmp eq i8 %19, 0
  br i1 %tobool31.not.prol, label %if.then32.prol, label %for.inc38.prol

if.then32.prol:                                   ; preds = %for.body26.prol
  %20 = load i32, ptr %s2, align 4, !tbaa !5
  %idxprom33.prol = sext i32 %20 to i64
  %arrayidx34.prol = getelementptr inbounds ptr, ptr %pair, i64 %idxprom33.prol
  %21 = load ptr, ptr %arrayidx34.prol, align 8, !tbaa !9
  %arrayidx36.prol = getelementptr inbounds i8, ptr %21, i64 %15
  store i8 1, ptr %arrayidx36.prol, align 1, !tbaa !11
  %.pre.prol = load i32, ptr %s1, align 4, !tbaa !5
  br label %for.inc38.prol

for.inc38.prol:                                   ; preds = %if.then32.prol, %for.body26.prol
  %22 = phi i32 [ %.pre80, %for.body26.prol ], [ %.pre.prol, %if.then32.prol ]
...
for.body26.prol.loopexit:                         ; preds = %for.inc38.prol, %for.body26.preheader
  %.unr = phi i32 [ %.pre80, %for.body26.preheader ], [ %22, %for.inc38.prol ]
...
for.body26:                                       ; preds = %for.body26.prol.loopexit, %for.inc38.1
  %25 = phi i32 [ %35, %for.inc38.1 ], [ %.unr, %for.body26.prol.loopexit ]
...
if.then32:                                        ; preds = %for.body26
  ...
  %.pre = load i32, ptr %s1, align 4, !tbaa !5
  br label %for.inc38

for.inc38:                                        ; preds = %for.body26, %if.then32
  %30 = phi i32 [ %25, %for.body26 ], [ %.pre, %if.then32 ]
...
if.then32.1:                                      ; preds = %for.inc38
  ...
  %.pre.1 = load i32, ptr %s1, align 4, !tbaa !5
  br label %for.inc38.1

for.inc38.1:                                      ; preds = %if.then32.1, %for.inc38
  %35 = phi i32 [ %30, %for.inc38 ], [ %.pre.1, %if.then32.1 ]
...
define dso_local void @makeEffMtx(i32 noundef %nseq, ptr nocapture noundef readonly %mtx, ptr nocapture noundef readonly %vec) local_unnamed_addr #13 {
entry:
...
for.cond1.preheader.us.preheader:                 ; preds = %entry
  ...
  %uglygep31 = getelementptr i8, ptr %vec, i64 %0
...
vector.memcheck:                                  ; preds = %for.cond1.preheader.us
  ...
  %3 = add nuw i64 %2, 8
  %uglygep33 = getelementptr i8, ptr %vec, i64 %3
  %uglygep32 = getelementptr i8, ptr %vec, i64 %2
  %uglygep = getelementptr i8, ptr %1, i64 %0
  %bound0 = icmp ult ptr %1, %uglygep31
  %bound1 = icmp ugt ptr %uglygep, %vec
  %found.conflict = and i1 %bound0, %bound1
  %bound034 = icmp ult ptr %1, %uglygep33
  %bound135 = icmp ult ptr %uglygep32, %uglygep
...
; Function Attrs: nounwind uwtable
define dso_local void @node_eff(i32 noundef %nseq, ptr nocapture noundef writeonly %eff, ptr nocapture noundef readonly %node) local_unnamed_addr #11 {
entry:
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %call = tail call double @ipower(double noundef 5.000000e-01, i32 noundef %0) #19
...
declare double @ipower(double noundef, i32 noundef) local_unnamed_addr #12
...
define dso_local i32 @msshrinklocalhom(ptr nocapture noundef readonly %pair, i32 noundef %s1, i32 noundef %s2, ptr nocapture noundef readonly %localhom, ptr nocapture noundef readonly %localhomshrink) local_unnamed_addr #14 {
entry:
  %0 = load i32, ptr @njob, align 4, !tbaa !5
  %.fr = freeze i32 %0
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local i32 @msfastshrinklocalhom(ptr nocapture noundef readonly %mem1, ptr nocapture noundef readonly %mem2, ptr nocapture noundef readonly %localhom, ptr nocapture noundef readonly %localhomshrink) local_unnamed_addr #0 {
entry:
  %0 = load i32, ptr %mem1, align 4, !tbaa !5
...
attributes #5 = { nofree nounwind memory(write, argmem: readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #7 = { mustprogress nofree nounwind willreturn memory(readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #13 = { nofree norecurse nosync nounwind memory(write, argmem: readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
