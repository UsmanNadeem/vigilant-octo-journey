; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/machine.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/machine.c"
...
if.then17:                                        ; preds = %if.else11
  %call18 = call ptr @fopen(ptr noundef nonnull %NAME, ptr noundef nonnull @.str.62)
  store ptr %call18, ptr %STREAM, align 8, !tbaa !11
  br label %if.end29

if.else22:                                        ; preds = %if.else11
  %call24 = call ptr @fopen(ptr noundef nonnull %NAME, ptr noundef nonnull @.str.63)
