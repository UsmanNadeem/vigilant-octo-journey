; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z03.c"
...
@file_mode = internal unnamed_addr constant [11 x ptr] [ptr @.str.27, ptr @.str.27, ptr @.str.27, ptr @.str.27, ptr @.str.27, ptr @.str.27, ptr @.str.27, ptr @.str.27, ptr @.str.27, ptr @.str.27, ptr @.str.27], align 16
...
if.end:                                           ; preds = %entry
  ...
  br i1 %cmp1, label %land.lhs.true, label %if.end389

land.lhs.true:                                    ; preds = %if.end
  %call2 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %str) #18
  %conv = trunc i64 %call2 to i32
  %cmp3 = icmp sgt i32 %conv, 2
  br i1 %cmp3, label %cond.false126, label %if.end389

cond.false126:                                    ; preds = %land.lhs.true
  %conv128 = and i64 %call2, 4294967295
  %sub129 = add nsw i64 %conv128, -3
  %arrayidx130 = getelementptr inbounds i8, ptr %str, i64 %sub129
  %1 = load i8, ptr %arrayidx130, align 1, !tbaa !5
  %conv134 = zext i8 %1 to i32
  %sub135.neg = add nsw i32 %conv134, -46
  %cmp139 = icmp eq i8 %1, 46
  br i1 %cmp139, label %if.then141, label %cond.end182

if.then141:                                       ; preds = %cond.false126
  %arrayidx143 = getelementptr inbounds i8, ptr %arrayidx130, i64 1
  %2 = load i8, ptr %arrayidx143, align 1, !tbaa !5
  %conv144 = zext i8 %2 to i32
  %sub145.neg = add nsw i32 %conv144, -108
  %cmp149 = icmp eq i8 %2, 108
  br i1 %cmp149, label %if.then151, label %cond.end182

if.then151:                                       ; preds = %if.then141
  %arrayidx153 = getelementptr inbounds i8, ptr %arrayidx130, i64 2
  %3 = load i8, ptr %arrayidx153, align 1, !tbaa !5
  %conv154 = zext i8 %3 to i32
  %sub155.neg = add nsw i32 %conv154, -100
  %cmp159 = icmp eq i8 %3, 100
  br i1 %cmp159, label %if.then161, label %cond.end182

if.then161:                                       ; preds = %if.then151
  %arrayidx163 = getelementptr inbounds i8, ptr %str, i64 %conv128
  %4 = load i8, ptr %arrayidx163, align 1, !tbaa !5
  %conv164 = zext i8 %4 to i32
  br label %cond.end182

cond.end182:                                      ; preds = %cond.false126, %if.then151, %if.then161, %if.then141
  %__result131.0.neg = phi i32 [ %conv164, %if.then161 ], [ %sub155.neg, %if.then151 ], [ %sub145.neg, %if.then141 ], [ %sub135.neg, %cond.false126 ]
  %cmp184 = icmp eq i32 %__result131.0.neg, 0
  br i1 %cmp184, label %if.then186, label %cond.false326

if.then186:                                       ; preds = %cond.end182
  %call187 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 3, i32 noundef 3, ptr noundef nonnull @.str.5, i32 noundef 1, ptr noundef %xfpos, ptr noundef nonnull %str) #16
  %.pre = load i8, ptr %arrayidx130, align 1, !tbaa !5
  %.pre563 = zext i8 %.pre to i32
  %.pre564 = add nsw i32 %.pre563, -46
  br label %cond.false326

cond.false326:                                    ; preds = %if.then186, %cond.end182
  %sub335.neg.pre-phi = phi i32 [ %.pre564, %if.then186 ], [ %sub135.neg, %cond.end182 ]
  %5 = phi i8 [ %.pre, %if.then186 ], [ %1, %cond.end182 ]
  %cmp339 = icmp eq i8 %5, 46
  br i1 %cmp339, label %if.then341, label %cond.end382

if.then341:                                       ; preds = %cond.false326
  %arrayidx343 = getelementptr inbounds i8, ptr %arrayidx130, i64 1
  %6 = load i8, ptr %arrayidx343, align 1, !tbaa !5
  %conv344 = zext i8 %6 to i32
  %sub345.neg = add nsw i32 %conv344, -108
  %cmp349 = icmp eq i8 %6, 108
  br i1 %cmp349, label %if.then351, label %cond.end382

if.then351:                                       ; preds = %if.then341
  %arrayidx353 = getelementptr inbounds i8, ptr %arrayidx130, i64 2
  %7 = load i8, ptr %arrayidx353, align 1, !tbaa !5
  %conv354 = zext i8 %7 to i32
  %sub355.neg = add nsw i32 %conv354, -105
  %cmp359 = icmp eq i8 %7, 105
  br i1 %cmp359, label %if.then361, label %cond.end382

if.then361:                                       ; preds = %if.then351
  %arrayidx363 = getelementptr inbounds i8, ptr %str, i64 %conv128
  %8 = load i8, ptr %arrayidx363, align 1, !tbaa !5
  %conv364 = zext i8 %8 to i32
  br label %cond.end382

cond.end382:                                      ; preds = %cond.false326, %if.then351, %if.then361, %if.then341
  %__result331.0.neg = phi i32 [ %conv364, %if.then361 ], [ %sub355.neg, %if.then351 ], [ %sub345.neg, %if.then341 ], [ %sub335.neg.pre-phi, %cond.false326 ]
  %cmp384 = icmp eq i32 %__result331.0.neg, 0
  br i1 %cmp384, label %if.then386, label %if.end389

if.then386:                                       ; preds = %cond.end382
  %call387 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 3, i32 noundef 4, ptr noundef nonnull @.str.7, i32 noundef 1, ptr noundef %xfpos, ptr noundef nonnull %str) #16
  br label %if.end389

if.end389:                                        ; preds = %if.end.thread, %cond.end382, %if.then386, %land.lhs.true, %if.end
  %call390 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %str) #18
  %call391 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %suffix) #18
  %add = add i64 %call391, %call390
  %cmp392 = icmp ugt i64 %add, 2047
  br i1 %cmp392, label %if.then394, label %if.end396

if.then394:                                       ; preds = %if.end389
  %9 = load ptr, ptr @no_fpos, align 8, !tbaa !10
  %call395 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 3, i32 noundef 5, ptr noundef nonnull @.str.8, i32 noundef 1, ptr noundef %9, ptr noundef %str, ptr noundef %suffix) #16
  br label %if.end396

if.end396:                                        ; preds = %if.then394, %if.end389
  %call397 = tail call ptr @MakeWordTwo(i32 noundef 11, ptr noundef %str, ptr noundef %suffix, ptr noundef %xfpos) #16
  %10 = load i8, ptr @zz_lengths, align 1, !tbaa !5
  %conv398 = zext i8 %10 to i32
  store i32 %conv398, ptr @zz_size, align 4, !tbaa !8
  %conv399 = zext i8 %10 to i64
  %arrayidx404 = getelementptr inbounds [0 x ptr], ptr @zz_free, i64 0, i64 %conv399
  %11 = load ptr, ptr %arrayidx404, align 8, !tbaa !10
  %cmp405 = icmp eq ptr %11, null
  br i1 %cmp405, label %if.then407, label %if.else409

if.then407:                                       ; preds = %if.end396
  %12 = load ptr, ptr @no_fpos, align 8, !tbaa !10
  %call408 = tail call ptr @GetMemory(i32 noundef %conv398, ptr noundef %12) #16
  br label %if.end416

if.else409:                                       ; preds = %if.end396
  store ptr %11, ptr @zz_hold, align 8, !tbaa !10
  %13 = load ptr, ptr %11, align 8, !tbaa !5
  store ptr %13, ptr %arrayidx404, align 8, !tbaa !10
  br label %if.end416

if.end416:                                        ; preds = %if.then407, %if.else409
  %14 = phi ptr [ %call408, %if.then407 ], [ %11, %if.else409 ]
  %ou1 = getelementptr inbounds %struct.word_type, ptr %14, i64 0, i32 1
  store i8 0, ptr %ou1, align 8, !tbaa !5
  %osucc = getelementptr inbounds [2 x %struct.LIST], ptr %14, i64 0, i64 1, i32 1
  store ptr %14, ptr %osucc, align 8, !tbaa !5
  %arrayidx420 = getelementptr inbounds [2 x %struct.LIST], ptr %14, i64 0, i64 1
  store ptr %14, ptr %arrayidx420, align 8, !tbaa !5
  %osucc424 = getelementptr inbounds %struct.LIST, ptr %14, i64 0, i32 1
  store ptr %14, ptr %osucc424, align 8, !tbaa !5
  store ptr %14, ptr %14, align 8, !tbaa !5
  store ptr %14, ptr @xx_link, align 8, !tbaa !10
  store ptr %14, ptr @zz_res, align 8, !tbaa !10
  %idxprom428 = sext i32 %ftype to i64
  %arrayidx429 = getelementptr inbounds [11 x ptr], ptr @file_type, i64 0, i64 %idxprom428
  %15 = load ptr, ptr %arrayidx429, align 8, !tbaa !10
  store ptr %15, ptr @zz_hold, align 8, !tbaa !10
  %cmp430 = icmp eq ptr %15, null
  br i1 %cmp430, label %cond.end461, label %cond.false437

cond.false437:                                    ; preds = %if.end416
  ...
  %osucc452 = getelementptr inbounds %struct.LIST, ptr %20, i64 0, i32 1
  store ptr %18, ptr %osucc452, align 8, !tbaa !5
  ...
  %osucc458 = getelementptr inbounds %struct.LIST, ptr %23, i64 0, i32 1
  store ptr %22, ptr %osucc458, align 8, !tbaa !5
  %.pre562 = load ptr, ptr @xx_link, align 8, !tbaa !10
  br label %cond.end461

cond.end461:                                      ; preds = %if.end416, %cond.false437
  %24 = phi ptr [ %14, %if.end416 ], [ %.pre562, %cond.false437 ]
  store ptr %24, ptr @zz_res, align 8, !tbaa !10
  store ptr %call397, ptr @zz_hold, align 8, !tbaa !10
  %cmp463 = icmp eq ptr %call397, null
  %cmp467 = icmp eq ptr %24, null
  %or.cond560 = select i1 %cmp463, i1 true, i1 %cmp467
  br i1 %or.cond560, label %cond.end494, label %cond.false470

cond.false470:                                    ; preds = %cond.end461
  %arrayidx472 = getelementptr inbounds [2 x %struct.LIST], ptr %call397, i64 0, i64 1
  %25 = load ptr, ptr %arrayidx472, align 8, !tbaa !5
  store ptr %25, ptr @zz_tmp, align 8, !tbaa !10
  %arrayidx475 = getelementptr inbounds [2 x %struct.LIST], ptr %24, i64 0, i64 1
  %26 = load ptr, ptr %arrayidx475, align 8, !tbaa !5
  store ptr %26, ptr %arrayidx472, align 8, !tbaa !5
  %27 = load ptr, ptr %arrayidx475, align 8, !tbaa !5
  %osucc485 = getelementptr inbounds [2 x %struct.LIST], ptr %27, i64 0, i64 1, i32 1
  store ptr %call397, ptr %osucc485, align 8, !tbaa !5
  store ptr %25, ptr %arrayidx475, align 8, !tbaa !5
  %osucc491 = getelementptr inbounds [2 x %struct.LIST], ptr %25, i64 0, i64 1, i32 1
  store ptr %24, ptr %osucc491, align 8, !tbaa !5
  br label %cond.end494

cond.end494:                                      ; preds = %cond.end461, %cond.false470
  %ou3 = getelementptr inbounds %struct.word_type, ptr %call397, i64 0, i32 3
  store i32 %fpath, ptr %ou3, align 8, !tbaa !5
  %ofwd = getelementptr inbounds %struct.word_type, ptr %call397, i64 0, i32 3, i32 1
  store i32 0, ptr %ofwd, align 8, !tbaa !5
  %arrayidx501 = getelementptr inbounds %struct.word_type, ptr %call397, i64 0, i32 3, i32 1, i64 4
  store i32 0, ptr %arrayidx501, align 4, !tbaa !5
  %ou2 = getelementptr inbounds %struct.word_type, ptr %call397, i64 0, i32 2
  ...
  tail call fastcc void @ftab_insert(ptr noundef %call397, ptr noundef nonnull @file_tab)
  %bf.load507 = load i32, ptr %ou2, align 8
  %28 = trunc i32 %bf.load507 to i16
  %conv509 = and i16 %28, 4095
  ret i16 %conv509
}
...
if.then:                                          ; preds = %entry
  ...
  %call.i182 = tail call noalias ptr @malloc(i64 noundef %add.i) #17
...
if.end.i:                                         ; preds = %if.then.i183, %if.then
  store i32 %mul, ptr %call.i182, align 8, !tbaa !12
  %filetab_count.i184 = getelementptr inbounds %struct.anon.14, ptr %call.i182, i64 0, i32 1
...
for.body.preheader.i:                             ; preds = %if.end.i
  %uglygep.i = getelementptr i8, ptr %call.i182, i64 8
  %4 = zext i32 %mul to i64
  %5 = shl nuw nsw i64 %4, 4
  tail call void @llvm.memset.p0.i64(ptr align 8 %uglygep.i, i8 0, i64 %5, i1 false), !tbaa !10
  br label %ftab_new.exit

ftab_new.exit:                                    ; preds = %if.end.i, %for.body.preheader.i
  store ptr %call.i182, ptr %NewS.i, align 8, !tbaa !10
...
for.cond1.i.preheader:                            ; preds = %for.body.i, %ftab_new.exit
  ...
  br i1 %cmp2.i187, label %for.body3.i, label %ftab_rehash.exit
...
for.body.i:                                       ; preds = %ftab_new.exit, %for.body.i
  ...
  br i1 %cmp.not.i.not, label %for.body.i, label %for.cond1.i.preheader, !llvm.loop !17
...
for.body3.i:                                      ; preds = %for.cond1.i.preheader, %for.inc13.i
  ...
  %by_name_hash.i = getelementptr inbounds %struct.anon.14, ptr %0, i64 0, i32 2, i64 %indvars.iv193, i32 1
...
ftab_rehash.exit:                                 ; preds = %for.inc13.i, %for.cond1.i.preheader
  ...
  %.pre196 = load i32, ptr %filetab_count2.phi.trans.insert, align 4, !tbaa !14
  br label %if.end

if.end:                                           ; preds = %ftab_rehash.exit, %entry
  %16 = phi i32 [ %.pre196, %ftab_rehash.exit ], [ %1, %entry ]
...
if.end72:                                         ; preds = %if.then61, %if.else63
  ...
  %37 = load ptr, ptr %by_name_hash90, align 8, !tbaa !19
...
cond.false96:                                     ; preds = %if.end72
  ...
  %.pre197 = load ptr, ptr @xx_link, align 8, !tbaa !10
...
for.end.i:                                        ; preds = %for.cond9.i
  ...
  %call189.i = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %buff, ptr noundef nonnull dereferenceable(1) %ostring187.i) #16
  %cmp196.i = icmp eq i32 %call189.i, 0
  br i1 %cmp196.i, label %cond.false, label %for.cond.i, !llvm.loop !26
...
FileName.exit:                                    ; preds = %for.cond.i, %if.end.i
  ...
  %call2 = tail call zeroext i16 @FileNum(ptr noundef nonnull %ostring.i, ptr noundef nonnull @.str.4)
  %cmp = icmp eq i16 %call2, 0
  br i1 %cmp, label %if.then, label %sw.epilog

if.then:                                          ; preds = %FileName.exit
  %call4 = tail call zeroext i16 @DefineFile(ptr noundef nonnull %ostring.i, ptr noundef nonnull @.str.4, ptr noundef %xfpos.tr, i32 noundef 3, i32 noundef 0)
  br label %sw.epilog
...
for.cond:                                         ; preds = %if.then1, %for.cond
  ...
  br i1 %cmp10, label %for.cond, label %if.end15, !llvm.loop !31
...
for.cond39:                                       ; preds = %if.else, %for.cond39
  ...
  br i1 %cmp43, label %for.cond39, label %if.end51, !llvm.loop !32
...
for.cond.i:                                       ; preds = %if.then1.i, %for.cond.i
  ...
  br i1 %cmp10.i, label %for.cond.i, label %if.end15.i, !llvm.loop !31
...
for.cond39.i:                                     ; preds = %if.else.i, %for.cond39.i
  ...
  br i1 %cmp43.i, label %for.cond39.i, label %if.end51.i, !llvm.loop !32
...
for.cond:                                         ; preds = %entry, %for.cond
  ...
  %cmp7 = icmp eq i8 %3, 0
  br i1 %cmp7, label %for.cond, label %for.end, !llvm.loop !33
...
for.end:                                          ; preds = %for.cond
  ...
  %arrayidx13 = getelementptr inbounds [11 x ptr], ptr @file_mode, i64 0, i64 %idxprom12
  %4 = load ptr, ptr %arrayidx13, align 8, !tbaa !10
  %call = tail call ptr @fopen(ptr noundef nonnull %ostring, ptr noundef %4)
  br label %if.end132
...
if.else:                                          ; preds = %entry
  ...
  %6 = load ptr, ptr %arrayidx18, align 8, !tbaa !10
  ...
  %bf.load21 = load i32, ptr %ou220, align 8
  %bf.lshr22 = lshr i32 %bf.load21, 12
  %bf.clear23 = and i32 %bf.lshr22, 1023
  %idxprom24 = zext i32 %bf.clear23 to i64
  %arrayidx25 = getelementptr inbounds [11 x ptr], ptr @file_mode, i64 0, i64 %idxprom24
  %7 = load ptr, ptr %arrayidx25, align 8, !tbaa !10
  %call26 = call fastcc ptr @SearchPath(ptr noundef nonnull %ostring14, ptr noundef %6, i32 noundef %check_ld, i32 noundef %check_lt, ptr noundef nonnull %full_name, ptr noundef nonnull %ou119, ptr noundef %7, ptr noundef nonnull %used_source_suffix)
  %8 = load ptr, ptr %full_name, align 8, !tbaa !10
  %cmp27.not = icmp eq ptr %8, null
  br i1 %cmp27.not, label %if.end128, label %if.then29

if.then29:                                        ; preds = %if.else
  %9 = load i8, ptr @zz_lengths, align 1, !tbaa !5
...
if.then41:                                        ; preds = %if.then29
  %11 = load ptr, ptr @no_fpos, align 8, !tbaa !10
  %call42 = tail call ptr @GetMemory(i32 noundef %conv30, ptr noundef %11) #16
  br label %cond.end93
...
cond.end93:                                       ; preds = %if.then41, %if.else43
  ...
  %ou152 = getelementptr inbounds %struct.word_type, ptr %13, i64 0, i32 1
  store i8 0, ptr %ou152, align 8, !tbaa !5
  %osucc56 = getelementptr inbounds [2 x %struct.LIST], ptr %13, i64 0, i64 1, i32 1
  store ptr %13, ptr %osucc56, align 8, !tbaa !5
  %arrayidx58 = getelementptr inbounds [2 x %struct.LIST], ptr %13, i64 0, i64 1
  store ptr %13, ptr %arrayidx58, align 8, !tbaa !5
  %osucc62 = getelementptr inbounds %struct.LIST, ptr %13, i64 0, i32 1
  store ptr %13, ptr %osucc62, align 8, !tbaa !5
  ...
  %osucc86 = getelementptr inbounds %struct.LIST, ptr %18, i64 0, i32 1
  ...
  %21 = load ptr, ptr @zz_tmp, align 8, !tbaa !10
  %osucc92 = getelementptr inbounds %struct.LIST, ptr %21, i64 0, i32 1
  store ptr %20, ptr %osucc92, align 8, !tbaa !5
  %22 = load ptr, ptr @xx_link, align 8, !tbaa !10
  store ptr %22, ptr @zz_res, align 8, !tbaa !10
  store ptr %8, ptr @zz_hold, align 8, !tbaa !10
  %cmp99 = icmp eq ptr %22, null
  br i1 %cmp99, label %if.end128, label %cond.false102

cond.false102:                                    ; preds = %cond.end93
  %arrayidx104 = getelementptr inbounds [2 x %struct.LIST], ptr %8, i64 0, i64 1
  %23 = load ptr, ptr %arrayidx104, align 8, !tbaa !5
  store ptr %23, ptr @zz_tmp, align 8, !tbaa !10
  %arrayidx107 = getelementptr inbounds [2 x %struct.LIST], ptr %22, i64 0, i64 1
  %24 = load ptr, ptr %arrayidx107, align 8, !tbaa !5
  store ptr %24, ptr %arrayidx104, align 8, !tbaa !5
  %25 = load ptr, ptr %arrayidx107, align 8, !tbaa !5
  %osucc117 = getelementptr inbounds [2 x %struct.LIST], ptr %25, i64 0, i64 1, i32 1
  store ptr %8, ptr %osucc117, align 8, !tbaa !5
  store ptr %23, ptr %arrayidx107, align 8, !tbaa !5
  %osucc123 = getelementptr inbounds [2 x %struct.LIST], ptr %23, i64 0, i64 1, i32 1
  store ptr %22, ptr %osucc123, align 8, !tbaa !5
  br label %if.end128

if.end128:                                        ; preds = %cond.end93, %cond.false102, %if.else
  %26 = load i32, ptr %used_source_suffix, align 4, !tbaa !8
  %bf.load130 = load i32, ptr %ou220, align 8
  %bf.value = shl i32 %26, 31
...
if.then77:                                        ; preds = %entry
  %arrayidx79 = getelementptr inbounds i8, ptr %str, i64 1
  %1 = load i8, ptr %arrayidx79, align 1, !tbaa !5
  %conv80 = zext i8 %1 to i32
  br label %cond.end115

cond.end115:                                      ; preds = %entry, %if.then77
  %__result67.0.neg = phi i32 [ %conv80, %if.then77 ], [ %sub71.neg, %entry ]
  %cmp117 = icmp eq i32 %__result67.0.neg, 0
...
if.end120:                                        ; preds = %cond.end115
  %call121 = tail call i32 @StringBeginsWith(ptr noundef nonnull %str, ptr noundef nonnull @.str.37) #16
  %tobool.not = icmp eq i32 %call121, 0
  %3 = load ptr, ptr @empty_path, align 8
  %cond125 = select i1 %tobool.not, ptr %fpath, ptr %3
  %link.0.in335 = getelementptr inbounds %struct.LIST, ptr %cond125, i64 0, i32 1
  %link.0336 = load ptr, ptr %link.0.in335, align 8, !tbaa !5
  %cmp130337.not = icmp eq ptr %link.0336, %cond125
  br i1 %cmp130337.not, label %cond.end267, label %for.cond135.preheader.lr.ph

for.cond135.preheader.lr.ph:                      ; preds = %if.end120
  %tobool173 = icmp ne i32 %check_ld, 0
  %st_mtim = getelementptr inbounds %struct.stat, ptr %datastat, i64 0, i32 12
  %st_mtim217 = getelementptr inbounds %struct.stat, ptr %indexstat, i64 0, i32 12
  %tobool229.not = icmp eq i32 %check_lt, 0
  br label %for.cond135.preheader

for.cond135.preheader:                            ; preds = %for.cond135.preheader.lr.ph, %for.inc250
  %link.0338 = phi ptr [ %link.0336, %for.cond135.preheader.lr.ph ], [ %link.0, %for.inc250 ]
  br label %for.cond135

for.cond135:                                      ; preds = %for.cond135.preheader, %for.cond135
  %link.0.pn = phi ptr [ %y.1, %for.cond135 ], [ %link.0338, %for.cond135.preheader ]
  ...
  %4 = load i8, ptr %ou1, align 8, !tbaa !5
  %cmp137 = icmp eq i8 %4, 0
  br i1 %cmp137, label %for.cond135, label %for.end, !llvm.loop !34
...
for.end:                                          ; preds = %for.cond135
  ...
  %call143 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %ostring) #18
  %cmp144 = icmp eq i64 %call143, 0
  br i1 %cmp144, label %if.then146, label %if.else

if.then146:                                       ; preds = %for.end
  %call148 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %buff, ptr noundef nonnull dereferenceable(1) %str) #16
  br label %if.end170

if.else:                                          ; preds = %for.end
  %add = add i64 %call143, 1
  %call152 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %str) #18
  %add153 = add i64 %add, %call152
  %cmp154 = icmp ugt i64 %add153, 511
  br i1 %cmp154, label %if.then156, label %if.end161

if.then156:                                       ; preds = %if.else
  %call160 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 3, i32 noundef 15, ptr noundef nonnull @.str.39, i32 noundef 1, ptr noundef nonnull %ou1.le, ptr noundef nonnull %ostring, ptr noundef nonnull @.str.37, ptr noundef nonnull %str) #16
  br label %if.end161

if.end161:                                        ; preds = %if.then156, %if.else
  %call165 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %buff, ptr noundef nonnull dereferenceable(1) %ostring) #16
  ...
  %call169 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %buff, ptr noundef nonnull dereferenceable(1) %str) #16
  br label %if.end170

if.end170:                                        ; preds = %if.end161, %if.then146
  %call172 = call ptr @fopen(ptr noundef nonnull %buff, ptr noundef %read_mode)
  %cmp175 = icmp eq ptr %call172, null
  %or.cond279 = and i1 %tobool173, %cmp175
  br i1 %or.cond279, label %if.then177, label %if.end193

if.then177:                                       ; preds = %if.end170
  %call180 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %buff2, ptr noundef nonnull dereferenceable(1) %buff) #16
  %call182 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %buff2) #18
  %sub183 = add i64 %call182, -3
  %arrayidx184 = getelementptr inbounds [512 x i8], ptr %buff2, i64 0, i64 %sub183
  store i32 6581294, ptr %arrayidx184, align 1
  %call187 = call ptr @fopen(ptr noundef nonnull %buff2, ptr noundef nonnull @.str.27)
  %cmp188.not = icmp eq ptr %call187, null
  br i1 %cmp188.not, label %if.end228, label %if.then190

if.then190:                                       ; preds = %if.then177
  %call191 = call i32 @fclose(ptr noundef nonnull %call187)
  store ptr null, ptr %full_name, align 8, !tbaa !10
  br label %cleanup269

if.end193:                                        ; preds = %if.end170
  %cmp196 = icmp ne ptr %call172, null
  %or.cond280 = and i1 %tobool173, %cmp196
  br i1 %or.cond280, label %if.then198, label %if.end228
...
if.then198:                                       ; preds = %if.end193
  ...
  %call201 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %buff2, ptr noundef nonnull dereferenceable(1) %buff) #16
  %call203 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %buff2) #18
  %sub204 = add i64 %call203, -3
  %arrayidx205 = getelementptr inbounds [512 x i8], ptr %buff2, i64 0, i64 %sub204
  store i32 6581294, ptr %arrayidx205, align 1
  %call.i = call i32 @__xstat(i32 noundef 1, ptr noundef nonnull %buff, ptr noundef nonnull %indexstat) #16
  %cmp209 = icmp eq i32 %call.i, 0
  br i1 %cmp209, label %land.lhs.true211, label %cleanup

land.lhs.true211:                                 ; preds = %if.then198
  %call.i323 = call i32 @__xstat(i32 noundef 1, ptr noundef nonnull %buff2, ptr noundef nonnull %datastat) #16
  %cmp214 = icmp eq i32 %call.i323, 0
  br i1 %cmp214, label %if.then216, label %cleanup

if.then216:                                       ; preds = %land.lhs.true211
  %5 = load i64, ptr %st_mtim, align 8, !tbaa !35
  %6 = load i64, ptr %st_mtim217, align 8, !tbaa !35
  %cmp219 = icmp sgt i64 %5, %6
  br i1 %cmp219, label %if.then221, label %cleanup

if.then221:                                       ; preds = %if.then216
  %call222 = call i32 @fclose(ptr noundef nonnull %call172)
  %call224 = call i32 @remove(ptr noundef nonnull %buff) #16
  store ptr null, ptr %full_name, align 8, !tbaa !10
...
cleanup:                                          ; preds = %if.then198, %land.lhs.true211, %if.then216
  call void @llvm.lifetime.end.p0(i64 144, ptr nonnull %datastat) #16
  call void @llvm.lifetime.end.p0(i64 144, ptr nonnull %indexstat) #16
  br label %if.end228

if.end228:                                        ; preds = %if.then177, %cleanup, %if.end193
  %cmp196326 = phi i1 [ true, %cleanup ], [ %cmp196, %if.end193 ], [ false, %if.then177 ]
  br i1 %tobool229.not, label %for.inc250, label %if.then230

if.then230:                                       ; preds = %if.end228
  %call233 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %buff2, ptr noundef nonnull dereferenceable(1) %buff) #16
  %strlen321 = call i64 @strlen(ptr nonnull dereferenceable(1) %buff2)
  %endptr322 = getelementptr inbounds i8, ptr %buff2, i64 %strlen321
  store i32 7629870, ptr %endptr322, align 1
  %call237 = call ptr @fopen(ptr noundef nonnull %buff2, ptr noundef nonnull @.str.27)
  %cmp238.not = icmp eq ptr %call237, null
  br i1 %cmp238.not, label %for.inc250, label %if.then240

if.then240:                                       ; preds = %if.then230
  br i1 %cmp196326, label %if.then243, label %for.inc250.thread

if.then243:                                       ; preds = %if.then240
  %call246 = call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 3, i32 noundef 16, ptr noundef nonnull @.str.40, i32 noundef 1, ptr noundef %xfpos, ptr noundef nonnull %buff, ptr noundef nonnull %buff2) #16
  br label %for.inc250.thread

for.inc250.thread:                                ; preds = %if.then240, %if.then243
  store i32 1, ptr %used_source_suffix, align 4, !tbaa !8
  br label %lor.lhs.false257

for.inc250:                                       ; preds = %if.end228, %if.then230
  %link.0.in = getelementptr inbounds %struct.LIST, ptr %link.0338, i64 0, i32 1
  %link.0 = load ptr, ptr %link.0.in, align 8, !tbaa !5
  %cmp127 = icmp eq ptr %call172, null
  %cmp130 = icmp ne ptr %link.0, %cond125
  %7 = select i1 %cmp127, i1 %cmp130, i1 false
  br i1 %7, label %for.cond135.preheader, label %for.end254, !llvm.loop !39

for.end254:                                       ; preds = %for.inc250
  br i1 %cmp127, label %cond.end267, label %lor.lhs.false257

lor.lhs.false257:                                 ; preds = %for.inc250.thread, %for.end254
  %fp.0.lcssa357 = phi ptr [ %call237, %for.inc250.thread ], [ %call172, %for.end254 ]
  %ostring258 = getelementptr inbounds %struct.word_type, ptr %y.1, i64 0, i32 4
  %char0 = load i8, ptr %ostring258, align 1
  %cmp261 = icmp eq i8 %char0, 0
  br i1 %cmp261, label %cond.end267, label %cond.false264

cond.false264:                                    ; preds = %lor.lhs.false257
  %call266 = call ptr @MakeWord(i32 noundef 11, ptr noundef nonnull %buff, ptr noundef %xfpos) #16
  br label %cond.end267

cond.end267:                                      ; preds = %if.end120, %for.end254, %lor.lhs.false257, %cond.false264
  %fp.0.lcssa356 = phi ptr [ %fp.0.lcssa357, %cond.false264 ], [ %fp.0.lcssa357, %lor.lhs.false257 ], [ %call172, %for.end254 ], [ null, %if.end120 ]
  %cond268 = phi ptr [ %call266, %cond.false264 ], [ null, %lor.lhs.false257 ], [ null, %for.end254 ], [ null, %if.end120 ]
  store ptr %cond268, ptr %full_name, align 8, !tbaa !10
  br label %cleanup269

cleanup269:                                       ; preds = %if.then221, %cond.end267, %if.then190, %if.then119
  %retval.3 = phi ptr [ %2, %if.then119 ], [ null, %if.then190 ], [ %fp.0.lcssa356, %cond.end267 ], [ null, %if.then221 ]
...
; Function Attrs: nounwind
declare i32 @__xstat(i32 noundef, ptr noundef, ptr noundef) local_unnamed_addr #6
...
!34 = distinct !{!34, !18}
!35 = !{!36, !37, i64 88}
!36 = !{!"stat", !37, i64 0, !37, i64 8, !37, i64 16, !9, i64 24, !9, i64 28, !9, i64 32, !9, i64 36, !37, i64 40, !37, i64 48, !37, i64 56, !37, i64 64, !38, i64 72, !38, i64 88, !38, i64 104, !6, i64 120}
!37 = !{!"long", !6, i64 0}
