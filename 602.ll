; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/lua/lgc.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/lua/lgc.c"
...
propagateall.exit.i:                              ; preds = %while.body.i.i, %if.else, %remarkupvals.exit.i
  ...
  %11 = load ptr, ptr %weak.i, align 8, !tbaa !50
...
while.body.i44.i:                                 ; preds = %if.end.i, %while.body.i44.i
  %call.i41.i = tail call fastcc i64 @propagatemark(ptr noundef nonnull %0)
  %15 = load ptr, ptr %gray, align 8, !tbaa !46
  %tobool.not.i43.i = icmp eq ptr %15, null
  br i1 %tobool.not.i43.i, label %propagateall.exit46.i, label %while.body.i44.i, !llvm.loop !49
...
propagateall.exit46.i:                            ; preds = %while.body.i44.i, %if.end.i
  ...
  %16 = load ptr, ptr %grayagain.i, align 8, !tbaa !51
...
while.body.i53.i:                                 ; preds = %propagateall.exit46.i, %while.body.i53.i
  %call.i50.i = tail call fastcc i64 @propagatemark(ptr noundef nonnull %0)
  %17 = load ptr, ptr %gray, align 8, !tbaa !46
  %tobool.not.i52.i = icmp eq ptr %17, null
  br i1 %tobool.not.i52.i, label %propagateall.exit55.i, label %while.body.i53.i, !llvm.loop !49
...
do.body.i.i:                                      ; preds = %do.body.i.i, %do.body.preheader.i.i
  ...
  br i1 %cmp.not.i65.i, label %marktmu.exit.i, label %do.body.i.i, !llvm.loop !52
...
while.body.i72.i:                                 ; preds = %marktmu.exit.i, %while.body.i72.i
  ...
  %call.i69.i = tail call fastcc i64 @propagatemark(ptr noundef nonnull %0)
  %add.i70.i = add i64 %call.i69.i, %m.04.i68.i
  %48 = load ptr, ptr %gray, align 8, !tbaa !46
  %tobool.not.i71.i = icmp eq ptr %48, null
  br i1 %tobool.not.i71.i, label %propagateall.exit74.i, label %while.body.i72.i, !llvm.loop !49
...
propagateall.exit74.i:                            ; preds = %while.body.i72.i, %marktmu.exit.i
  ...
  %49 = load ptr, ptr %weak.i, align 8, !tbaa !50
  %tobool.not91.i.i = icmp eq ptr %49, null
  br i1 %tobool.not91.i.i, label %atomic.exit, label %while.body.i76.i

while.body.i76.i:                                 ; preds = %propagateall.exit74.i, %while.end26.i.i
  %l.addr.092.i.i = phi ptr [ %82, %while.end26.i.i ], [ %49, %propagateall.exit74.i ]
  %marked.i75.i = getelementptr inbounds %struct.Table, ptr %l.addr.092.i.i, i64 0, i32 2
  %50 = load i8, ptr %marked.i75.i, align 1, !tbaa !53
  %51 = and i8 %50, 16
...
while.cond2.preheader.i.i:                        ; preds = %while.body.i76.i
  %sizearray.i.i = getelementptr inbounds %struct.Table, ptr %l.addr.092.i.i, i64 0, i32 10
  %52 = load i32, ptr %sizearray.i.i, align 8, !tbaa !54
  %tobool3.not87.i.i = icmp eq i32 %52, 0
  br i1 %tobool3.not87.i.i, label %if.end7.i.i, label %while.body4.lr.ph.i.i

while.body4.lr.ph.i.i:                            ; preds = %while.cond2.preheader.i.i
  %array.i.i = getelementptr inbounds %struct.Table, ptr %l.addr.092.i.i, i64 0, i32 6
...
while.body4.i.i:                                  ; preds = %if.end.i.i, %while.body4.lr.ph.i.i
  ...
  %54 = load ptr, ptr %array.i.i, align 8, !tbaa !55
...
if.end7.i.i:                                      ; preds = %if.end.i.i, %while.cond2.preheader.i.i, %while.body.i76.i
  %lsizenode.i.i = getelementptr inbounds %struct.Table, ptr %l.addr.092.i.i, i64 0, i32 4
  %63 = load i8, ptr %lsizenode.i.i, align 1, !tbaa !57
  %conv8.i.i = zext i8 %63 to i32
  %node.i.i = getelementptr inbounds %struct.Table, ptr %l.addr.092.i.i, i64 0, i32 7
  %notmask.i.i = shl nsw i32 -1, %conv8.i.i
  %dec1089.i.i = xor i32 %notmask.i.i, -1
  %64 = sext i32 %dec1089.i.i to i64
  br label %while.body12.i.i

while.body12.i.i:                                 ; preds = %if.end25.i.i, %if.end7.i.i
  %indvars.iv95.i.i = phi i64 [ %64, %if.end7.i.i ], [ %indvars.iv.next96.i.i, %if.end25.i.i ]
  %65 = load ptr, ptr %node.i.i, align 8, !tbaa !58
  %arrayidx14.i.i = getelementptr inbounds %struct.Node, ptr %65, i64 %indvars.iv95.i.i
  %tt15.i.i = getelementptr inbounds %struct.lua_TValue, ptr %arrayidx14.i.i, i64 0, i32 1
  %66 = load i32, ptr %tt15.i.i, align 8, !tbaa !59
  %cmp.i.i = icmp eq i32 %66, 0
  br i1 %cmp.i.i, label %if.end25.i.i, label %land.lhs.true.i.i

land.lhs.true.i.i:                                ; preds = %while.body12.i.i
  %i_key.i.i = getelementptr inbounds %struct.Node, ptr %65, i64 %indvars.iv95.i.i, i32 1
...
lor.lhs.false.i.i:                                ; preds = %if.end5.i50.i.i, %if.then3.i47.i.i, %land.lhs.true.i.i
  %73 = phi i32 [ %66, %if.end5.i50.i.i ], [ %.pre.i79.i, %if.then3.i47.i.i ], [ %66, %land.lhs.true.i.i ]
...
lor.rhs.i65.i.i:                                  ; preds = %if.end5.i63.i.i
  ...
  %or.cond85.i.i = select i1 %cmp11.i64.not.i.i, i1 true, i1 %tobool21.not.i.i
  br i1 %or.cond85.i.i, label %if.end25.i.i, label %if.then22.i80.i

if.then22.i80.i:                                  ; preds = %lor.rhs.i65.i.i, %if.end5.i63.i.i, %if.end5.i50.i.i
  store i32 0, ptr %tt15.i.i, align 8, !tbaa !59
  %tt.i70.i.i = getelementptr inbounds %struct.Node, ptr %65, i64 %indvars.iv95.i.i, i32 1, i32 0, i32 1
...
if.end25.i.i:                                     ; preds = %if.then.i.i.i, %if.then22.i80.i, %lor.rhs.i65.i.i, %if.then3.i60.i.i, %lor.lhs.false.i.i, %while.body12.i.i
  ...
  %81 = icmp eq i64 %indvars.iv95.i.i, 0
  br i1 %81, label %while.end26.i.i, label %while.body12.i.i, !llvm.loop !61

while.end26.i.i:                                  ; preds = %if.end25.i.i
  %gclist.i.i = getelementptr inbounds %struct.Table, ptr %l.addr.092.i.i, i64 0, i32 9
  %82 = load ptr, ptr %gclist.i.i, align 8, !tbaa !62
  %tobool.not.i81.i = icmp eq ptr %82, null
  br i1 %tobool.not.i81.i, label %atomic.exit, label %while.body.i76.i, !llvm.loop !63
...
sw.bb2:                                           ; preds = %entry
  ...
  %89 = load i32, ptr %sweepstrgc, align 4, !tbaa !64
  ...
  %90 = load i32, ptr %sweepstrgc, align 4, !tbaa !64
  %size = getelementptr inbounds %struct.stringtable, ptr %0, i64 0, i32 2
...
sw.bb11:                                          ; preds = %entry
  ...
  %95 = load ptr, ptr %sweepgc, align 8, !tbaa !65
...
if.end.i68:                                       ; preds = %if.then.i67, %if.then19
  ...
  %100 = load i64, ptr %buffsize.i, align 8, !tbaa !66
...
if.then9.i:                                       ; preds = %if.end.i68
  ...
  %101 = load ptr, ptr %buff.i, align 8, !tbaa !67
  ...
  store i64 %div1239.i, ptr %buffsize.i, align 8, !tbaa !66
...
sw.bb:                                            ; preds = %entry
  ...
  br i1 %tobool.not.i, label %if.then68.i, label %if.then.i
...
if.end5.i:                                        ; preds = %if.then.i
  ...
  br i1 %cmp.i, label %if.then68.i, label %cond.false.i

cond.false.i:                                     ; preds = %if.end5.i, %if.then.i
  %.pr247.i = phi ptr [ %.pr.pre.i, %if.end5.i ], [ %5, %if.then.i ]
  %flags.i = getelementptr inbounds %struct.Table, ptr %.pr247.i, i64 0, i32 3
  %8 = load i8, ptr %flags.i, align 2, !tbaa !21
  %9 = and i8 %8, 8
  %tobool11.not.i = icmp eq i8 %9, 0
  br i1 %tobool11.not.i, label %cond.end15.i, label %if.then68.i
...
cond.end15.i:                                     ; preds = %cond.false.i
  ...
  %call.i = tail call ptr @luaT_gettm(ptr noundef nonnull %.pr247.i, i32 noundef 3, ptr noundef %10) #7
  %tobool17.not.i = icmp eq ptr %call.i, null
  br i1 %tobool17.not.i, label %if.then68.i, label %land.lhs.true.i
...
land.lhs.true.i:                                  ; preds = %cond.end15.i
  ...
  br i1 %cmp18.i, label %cond.false24.i, label %if.then68.i

cond.false24.i:                                   ; preds = %land.lhs.true.i
  %12 = load ptr, ptr %call.i, align 8, !tbaa !20
  %add.ptr26.i = getelementptr inbounds %union.TString, ptr %12, i64 1
  %call27.i = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %add.ptr26.i, i32 noundef 107) #7
  %call27.fr.i = freeze ptr %call27.i
  %cmp30.i = icmp ne ptr %call27.fr.i, null
  %call40.i = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %add.ptr26.i, i32 noundef 118) #7
  %cmp43.i = icmp ne ptr %call40.i, null
  %or.cond.i = select i1 %cmp30.i, i1 true, i1 %cmp43.i
  br i1 %or.cond.i, label %if.end61.i, label %if.then68.i

if.end61.i:                                       ; preds = %cond.false24.i
  %13 = load i8, ptr %marked, align 1, !tbaa !53
  %14 = and i8 %13, -25
  %shl.i = select i1 %cmp30.i, i8 8, i8 0
  %shl52.i = select i1 %cmp43.i, i8 16, i8 0
  %or.i = or i8 %shl52.i, %shl.i
  %or57.i = or i8 %or.i, %14
  store i8 %or57.i, ptr %marked, align 1, !tbaa !53
  ...
  %or.cond144.i = select i1 %cmp30.i, i1 %cmp43.i, i1 false
  br i1 %or.cond144.i, label %if.then, label %if.end66.i

if.end66.i:                                       ; preds = %if.end61.i
  br i1 %cmp43.i, label %if.end89.thread.i, label %if.then68.i

if.then68.i:                                      ; preds = %if.end66.i, %cond.false24.i, %land.lhs.true.i, %cond.end15.i, %cond.false.i, %if.end5.i, %sw.bb
  %weakkey.0197203.i = phi i1 [ %cmp30.i, %if.end66.i ], [ false, %sw.bb ], [ false, %cond.false.i ], [ false, %if.end5.i ], [ false, %cond.end15.i ], [ false, %land.lhs.true.i ], [ false, %cond.false24.i ]
  %sizearray.i = getelementptr inbounds %struct.Table, ptr %0, i64 0, i32 10
  %16 = load i32, ptr %sizearray.i, align 8, !tbaa !54
  %tobool69.not206.i = icmp eq i32 %16, 0
  br i1 %tobool69.not206.i, label %if.end89.i, label %while.body.lr.ph.i

while.body.lr.ph.i:                               ; preds = %if.then68.i
  %array.i = getelementptr inbounds %struct.Table, ptr %0, i64 0, i32 6
  %17 = sext i32 %16 to i64
  br label %while.body.i

while.body.i:                                     ; preds = %if.end88.i, %while.body.lr.ph.i
  %indvars.iv.i = phi i64 [ %17, %while.body.lr.ph.i ], [ %indvars.iv.next.i, %if.end88.i ]
  %indvars.iv.next.i = add nsw i64 %indvars.iv.i, -1
  %18 = load ptr, ptr %array.i, align 8, !tbaa !55
  %tt71.i = getelementptr inbounds %struct.lua_TValue, ptr %18, i64 %indvars.iv.next.i, i32 1
  %19 = load i32, ptr %tt71.i, align 8, !tbaa !33
  %cmp72.i = icmp sgt i32 %19, 3
  br i1 %cmp72.i, label %land.lhs.true74.i, label %if.end88.i

land.lhs.true74.i:                                ; preds = %while.body.i
  %arrayidx70.i = getelementptr inbounds %struct.lua_TValue, ptr %18, i64 %indvars.iv.next.i
  %20 = load ptr, ptr %arrayidx70.i, align 8, !tbaa !20
  %marked79.i = getelementptr inbounds %struct.GCheader, ptr %20, i64 0, i32 2
  %21 = load i8, ptr %marked79.i, align 1, !tbaa !20
  %22 = and i8 %21, 3
  %tobool82.not.i = icmp eq i8 %22, 0
...
if.end88.i:                                       ; preds = %if.then83.i, %land.lhs.true74.i, %while.body.i
  %23 = and i64 %indvars.iv.next.i, 4294967295
  %tobool69.not.i = icmp eq i64 %23, 0
  br i1 %tobool69.not.i, label %if.end89.i, label %while.body.i, !llvm.loop !73

if.end89.i:                                       ; preds = %if.end88.i, %if.then68.i
  %lsizenode.i = getelementptr inbounds %struct.Table, ptr %0, i64 0, i32 4
  %24 = load i8, ptr %lsizenode.i, align 1, !tbaa !57
  %conv90.i = zext i8 %24 to i32
  %node.i = getelementptr inbounds %struct.Table, ptr %0, i64 0, i32 7
  %notmask.i = shl nsw i32 -1, %conv90.i
  %dec93208.i = xor i32 %notmask.i, -1
  %25 = sext i32 %dec93208.i to i64
  br i1 %weakkey.0197203.i, label %while.body95.us.i, label %while.body95.i

if.end89.thread.i:                                ; preds = %if.end66.i
  %lsizenode252.i = getelementptr inbounds %struct.Table, ptr %0, i64 0, i32 4
  %26 = load i8, ptr %lsizenode252.i, align 1, !tbaa !57
  %conv90253.i = zext i8 %26 to i32
  %node254.i = getelementptr inbounds %struct.Table, ptr %0, i64 0, i32 7
  %notmask255.i = shl nsw i32 -1, %conv90253.i
  %dec93208256.i = xor i32 %notmask255.i, -1
  %27 = sext i32 %dec93208256.i to i64
  br i1 %cmp30.i, label %while.body95.us.us.i.preheader, label %while.body95.us210.i

while.body95.us.us.i.preheader:                   ; preds = %if.end89.thread.i
  %28 = and i64 %27, 1
  %lcmp.mod.not.not = icmp eq i64 %28, 0
  br i1 %lcmp.mod.not.not, label %while.body95.us.us.i.prol, label %while.body95.us.us.i.prol.loopexit

while.body95.us.us.i.prol:                        ; preds = %while.body95.us.us.i.preheader
  %29 = load ptr, ptr %node254.i, align 8, !tbaa !58
  %tt98.us.us.i.prol = getelementptr inbounds %struct.Node, ptr %29, i64 %27, i32 0, i32 1
  %30 = load i32, ptr %tt98.us.us.i.prol, align 8, !tbaa !59
  %cmp99.us.us.i.prol = icmp eq i32 %30, 0
  br i1 %cmp99.us.us.i.prol, label %if.then101.us.us.i.prol, label %if.end137.us.us.i.prol

if.then101.us.us.i.prol:                          ; preds = %while.body95.us.us.i.prol
  ...
  br i1 %cmp.i.us.us.i.prol, label %if.then.i.us.us.i.prol, label %if.end137.us.us.i.prol

if.then.i.us.us.i.prol:                           ; preds = %if.then101.us.us.i.prol
  store i32 11, ptr %tt.i.us.us.i.prol, align 8, !tbaa !20
  br label %if.end137.us.us.i.prol

if.end137.us.us.i.prol:                           ; preds = %if.then.i.us.us.i.prol, %if.then101.us.us.i.prol, %while.body95.us.us.i.prol
  %indvars.iv.next241.i.prol = add nsw i64 %27, -1
  br label %while.body95.us.us.i.prol.loopexit

while.body95.us.us.i.prol.loopexit:               ; preds = %if.end137.us.us.i.prol, %while.body95.us.us.i.preheader
  %indvars.iv240.i.unr = phi i64 [ %27, %while.body95.us.us.i.preheader ], [ %indvars.iv.next241.i.prol, %if.end137.us.us.i.prol ]
  %32 = icmp eq i8 %26, 0
  br i1 %32, label %if.then, label %while.body95.us.us.i

while.body95.us.us.i:                             ; preds = %while.body95.us.us.i.prol.loopexit, %if.end137.us.us.i.1
  %indvars.iv240.i = phi i64 [ %indvars.iv.next241.i.1, %if.end137.us.us.i.1 ], [ %indvars.iv240.i.unr, %while.body95.us.us.i.prol.loopexit ]
  %33 = load ptr, ptr %node254.i, align 8, !tbaa !58
  %tt98.us.us.i = getelementptr inbounds %struct.Node, ptr %33, i64 %indvars.iv240.i, i32 0, i32 1
  %34 = load i32, ptr %tt98.us.us.i, align 8, !tbaa !59
  %cmp99.us.us.i = icmp eq i32 %34, 0
  br i1 %cmp99.us.us.i, label %if.then101.us.us.i, label %if.end137.us.us.i

if.then101.us.us.i:                               ; preds = %while.body95.us.us.i
  %tt.i.us.us.i = getelementptr inbounds %struct.Node, ptr %33, i64 %indvars.iv240.i, i32 1, i32 0, i32 1
  %35 = load i32, ptr %tt.i.us.us.i, align 8, !tbaa !20
  %cmp.i.us.us.i = icmp sgt i32 %35, 3
  br i1 %cmp.i.us.us.i, label %if.then.i.us.us.i, label %if.end137.us.us.i

if.then.i.us.us.i:                                ; preds = %if.then101.us.us.i
  store i32 11, ptr %tt.i.us.us.i, align 8, !tbaa !20
  br label %if.end137.us.us.i

if.end137.us.us.i:                                ; preds = %if.then.i.us.us.i, %if.then101.us.us.i, %while.body95.us.us.i
  %indvars.iv.next241.i = add nsw i64 %indvars.iv240.i, -1
  %36 = load ptr, ptr %node254.i, align 8, !tbaa !58
  %tt98.us.us.i.1 = getelementptr inbounds %struct.Node, ptr %36, i64 %indvars.iv.next241.i, i32 0, i32 1
  %37 = load i32, ptr %tt98.us.us.i.1, align 8, !tbaa !59
  %cmp99.us.us.i.1 = icmp eq i32 %37, 0
  br i1 %cmp99.us.us.i.1, label %if.then101.us.us.i.1, label %if.end137.us.us.i.1

if.then101.us.us.i.1:                             ; preds = %if.end137.us.us.i
  %tt.i.us.us.i.1 = getelementptr inbounds %struct.Node, ptr %36, i64 %indvars.iv.next241.i, i32 1, i32 0, i32 1
  %38 = load i32, ptr %tt.i.us.us.i.1, align 8, !tbaa !20
  %cmp.i.us.us.i.1 = icmp sgt i32 %38, 3
  br i1 %cmp.i.us.us.i.1, label %if.then.i.us.us.i.1, label %if.end137.us.us.i.1

if.then.i.us.us.i.1:                              ; preds = %if.then101.us.us.i.1
  store i32 11, ptr %tt.i.us.us.i.1, align 8, !tbaa !20
  br label %if.end137.us.us.i.1

if.end137.us.us.i.1:                              ; preds = %if.then.i.us.us.i.1, %if.then101.us.us.i.1, %if.end137.us.us.i
  %indvars.iv.next241.i.1 = add nsw i64 %indvars.iv240.i, -2
  %39 = icmp eq i64 %indvars.iv.next241.i, 0
  br i1 %39, label %if.then, label %while.body95.us.us.i, !llvm.loop !74

while.body95.us.i:                                ; preds = %if.end89.i, %if.end137.us.i
  %indvars.iv236.i = phi i64 [ %indvars.iv.next237.i, %if.end137.us.i ], [ %25, %if.end89.i ]
  %40 = load ptr, ptr %node.i, align 8, !tbaa !58
  %arrayidx97.us.i = getelementptr inbounds %struct.Node, ptr %40, i64 %indvars.iv236.i
  %tt98.us.i = getelementptr inbounds %struct.lua_TValue, ptr %arrayidx97.us.i, i64 0, i32 1
  %41 = load i32, ptr %tt98.us.i, align 8, !tbaa !59
  %cmp99.us.i = icmp eq i32 %41, 0
  br i1 %cmp99.us.i, label %if.then101.us.i, label %if.else.us.i

if.else.us.i:                                     ; preds = %while.body95.us.i
  %cmp123.us.i = icmp sgt i32 %41, 3
  br i1 %cmp123.us.i, label %land.lhs.true125.us.i, label %if.end137.us.i

land.lhs.true125.us.i:                            ; preds = %if.else.us.i
  %42 = load ptr, ptr %arrayidx97.us.i, align 8, !tbaa !20
  %marked128.us.i = getelementptr inbounds %struct.GCheader, ptr %42, i64 0, i32 2
  %43 = load i8, ptr %marked128.us.i, align 1, !tbaa !20
  %44 = and i8 %43, 3
  %tobool131.not.us.i = icmp eq i8 %44, 0
  br i1 %tobool131.not.us.i, label %if.end137.us.i, label %if.then132.us.i

if.then132.us.i:                                  ; preds = %land.lhs.true125.us.i
  tail call fastcc void @reallymarkobject(ptr noundef %g, ptr noundef nonnull %42)
  br label %if.end137.us.i

if.then101.us.i:                                  ; preds = %while.body95.us.i
  %tt.i.us.i = getelementptr inbounds %struct.Node, ptr %40, i64 %indvars.iv236.i, i32 1, i32 0, i32 1
  %45 = load i32, ptr %tt.i.us.i, align 8, !tbaa !20
  %cmp.i.us.i = icmp sgt i32 %45, 3
  br i1 %cmp.i.us.i, label %if.then.i.us.i, label %if.end137.us.i

if.then.i.us.i:                                   ; preds = %if.then101.us.i
  store i32 11, ptr %tt.i.us.i, align 8, !tbaa !20
  br label %if.end137.us.i

if.end137.us.i:                                   ; preds = %if.then.i.us.i, %if.then101.us.i, %if.then132.us.i, %land.lhs.true125.us.i, %if.else.us.i
  %indvars.iv.next237.i = add nsw i64 %indvars.iv236.i, -1
  %46 = icmp eq i64 %indvars.iv236.i, 0
  br i1 %46, label %if.then, label %while.body95.us.i, !llvm.loop !74

while.body95.us210.i:                             ; preds = %if.end89.thread.i, %if.end137.us222.i
  %indvars.iv232.i = phi i64 [ %indvars.iv.next233.i, %if.end137.us222.i ], [ %27, %if.end89.thread.i ]
  %47 = load ptr, ptr %node254.i, align 8, !tbaa !58
  %tt98.us214.i = getelementptr inbounds %struct.Node, ptr %47, i64 %indvars.iv232.i, i32 0, i32 1
  %48 = load i32, ptr %tt98.us214.i, align 8, !tbaa !59
  %cmp99.us215.i = icmp eq i32 %48, 0
  br i1 %cmp99.us215.i, label %if.then101.us218.i, label %if.else.us216.i

if.else.us216.i:                                  ; preds = %while.body95.us210.i
  %i_key.us.i = getelementptr inbounds %struct.Node, ptr %47, i64 %indvars.iv232.i, i32 1
  %tt104.us.i = getelementptr inbounds %struct.anon.0, ptr %i_key.us.i, i64 0, i32 1
  %49 = load i32, ptr %tt104.us.i, align 8, !tbaa !20
  %cmp105.us.i = icmp sgt i32 %49, 3
  br i1 %cmp105.us.i, label %land.lhs.true107.us.i, label %if.end137.us222.i

land.lhs.true107.us.i:                            ; preds = %if.else.us216.i
  %50 = load ptr, ptr %i_key.us.i, align 8, !tbaa !20
  %marked110.us.i = getelementptr inbounds %struct.GCheader, ptr %50, i64 0, i32 2
  %51 = load i8, ptr %marked110.us.i, align 1, !tbaa !20
  %52 = and i8 %51, 3
  %tobool113.not.us.i = icmp eq i8 %52, 0
  br i1 %tobool113.not.us.i, label %if.end137.us222.i, label %if.then114.us.i

if.then114.us.i:                                  ; preds = %land.lhs.true107.us.i
  tail call fastcc void @reallymarkobject(ptr noundef %g, ptr noundef nonnull %50)
  br label %if.end137.us222.i

if.then101.us218.i:                               ; preds = %while.body95.us210.i
  %tt.i.us219.i = getelementptr inbounds %struct.Node, ptr %47, i64 %indvars.iv232.i, i32 1, i32 0, i32 1
  %53 = load i32, ptr %tt.i.us219.i, align 8, !tbaa !20
  %cmp.i.us220.i = icmp sgt i32 %53, 3
  br i1 %cmp.i.us220.i, label %if.then.i.us221.i, label %if.end137.us222.i

if.then.i.us221.i:                                ; preds = %if.then101.us218.i
  store i32 11, ptr %tt.i.us219.i, align 8, !tbaa !20
  br label %if.end137.us222.i

if.end137.us222.i:                                ; preds = %if.then.i.us221.i, %if.then101.us218.i, %if.then114.us.i, %land.lhs.true107.us.i, %if.else.us216.i
  %indvars.iv.next233.i = add nsw i64 %indvars.iv232.i, -1
  %54 = icmp eq i64 %indvars.iv232.i, 0
  br i1 %54, label %if.then, label %while.body95.us210.i, !llvm.loop !74

while.body95.i:                                   ; preds = %if.end89.i, %if.end137.i
  %indvars.iv229.i = phi i64 [ %indvars.iv.next230.i, %if.end137.i ], [ %25, %if.end89.i ]
  %55 = load ptr, ptr %node.i, align 8, !tbaa !58
  %arrayidx97.i = getelementptr inbounds %struct.Node, ptr %55, i64 %indvars.iv229.i
  %tt98.i = getelementptr inbounds %struct.lua_TValue, ptr %arrayidx97.i, i64 0, i32 1
  %56 = load i32, ptr %tt98.i, align 8, !tbaa !59
  %cmp99.i = icmp eq i32 %56, 0
  br i1 %cmp99.i, label %if.then101.i, label %if.else.i

if.then101.i:                                     ; preds = %while.body95.i
  %tt.i.i = getelementptr inbounds %struct.Node, ptr %55, i64 %indvars.iv229.i, i32 1, i32 0, i32 1
  %57 = load i32, ptr %tt.i.i, align 8, !tbaa !20
  %cmp.i.i = icmp sgt i32 %57, 3
  br i1 %cmp.i.i, label %if.then.i.i, label %if.end137.i

if.then.i.i:                                      ; preds = %if.then101.i
  store i32 11, ptr %tt.i.i, align 8, !tbaa !20
  br label %if.end137.i

if.else.i:                                        ; preds = %while.body95.i
  %i_key.i = getelementptr inbounds %struct.Node, ptr %55, i64 %indvars.iv229.i, i32 1
  %tt104.i = getelementptr inbounds %struct.anon.0, ptr %i_key.i, i64 0, i32 1
  %58 = load i32, ptr %tt104.i, align 8, !tbaa !20
  %cmp105.i = icmp sgt i32 %58, 3
  br i1 %cmp105.i, label %land.lhs.true107.i, label %if.end118.i

land.lhs.true107.i:                               ; preds = %if.else.i
  %59 = load ptr, ptr %i_key.i, align 8, !tbaa !20
  %marked110.i = getelementptr inbounds %struct.GCheader, ptr %59, i64 0, i32 2
  %60 = load i8, ptr %marked110.i, align 1, !tbaa !20
  %61 = and i8 %60, 3
  %tobool113.not.i = icmp eq i8 %61, 0
  br i1 %tobool113.not.i, label %if.end118.i, label %if.then114.i

if.then114.i:                                     ; preds = %land.lhs.true107.i
  tail call fastcc void @reallymarkobject(ptr noundef %g, ptr noundef nonnull %59)
  %.pre.i = load i32, ptr %tt98.i, align 8, !tbaa !59
  br label %if.end118.i

if.end118.i:                                      ; preds = %if.then114.i, %land.lhs.true107.i, %if.else.i
  %62 = phi i32 [ %56, %if.else.i ], [ %56, %land.lhs.true107.i ], [ %.pre.i, %if.then114.i ]
  %cmp123.i = icmp sgt i32 %62, 3
  br i1 %cmp123.i, label %land.lhs.true125.i, label %if.end137.i

land.lhs.true125.i:                               ; preds = %if.end118.i
  %63 = load ptr, ptr %arrayidx97.i, align 8, !tbaa !20
  %marked128.i = getelementptr inbounds %struct.GCheader, ptr %63, i64 0, i32 2
  %64 = load i8, ptr %marked128.i, align 1, !tbaa !20
  %65 = and i8 %64, 3
  %tobool131.not.i = icmp eq i8 %65, 0
  br i1 %tobool131.not.i, label %if.end137.i, label %if.then132.i

if.then132.i:                                     ; preds = %land.lhs.true125.i
  tail call fastcc void @reallymarkobject(ptr noundef %g, ptr noundef nonnull %63)
  br label %if.end137.i

if.end137.i:                                      ; preds = %if.then132.i, %land.lhs.true125.i, %if.end118.i, %if.then.i.i, %if.then101.i
  %indvars.iv.next230.i = add nsw i64 %indvars.iv229.i, -1
  %66 = icmp eq i64 %indvars.iv229.i, 0
  br i1 %66, label %if.end, label %while.body95.i, !llvm.loop !74

if.then:                                          ; preds = %if.end137.us222.i, %while.body95.us.us.i.prol.loopexit, %if.end137.us.us.i.1, %if.end137.us.i, %if.end61.i
  %67 = load i8, ptr %marked, align 1, !tbaa !20
  %68 = and i8 %67, -5
  store i8 %68, ptr %marked, align 1, !tbaa !20
  br label %if.end

if.end:                                           ; preds = %if.end137.i, %if.then
  %sizearray = getelementptr inbounds %struct.Table, ptr %0, i64 0, i32 10
  %69 = load i32, ptr %sizearray, align 8, !tbaa !54
  ...
  %70 = load i8, ptr %lsizenode, align 1, !tbaa !57
...
for.inc.i:                                        ; preds = %if.then15.i, %land.lhs.true.i109, %for.body.i
  ...
  br i1 %cmp.i112, label %for.body.i, label %traverseclosure.exit, !llvm.loop !75
...
sw.bb30:                                          ; preds = %entry
  ...
  %96 = load ptr, ptr %gclist31, align 8, !tbaa !77
  store ptr %96, ptr %gray, align 8, !tbaa !46
  %grayagain = getelementptr inbounds %struct.global_State, ptr %g, i64 0, i32 9
  %97 = load ptr, ptr %grayagain, align 8, !tbaa !51
  store ptr %97, ptr %gclist31, align 8, !tbaa !77
  ...
  %100 = load i32, ptr %tt.i114, align 8, !tbaa !70
...
if.end.i120:                                      ; preds = %if.then.i119, %land.lhs.true.i118, %sw.bb30
  ...
  %105 = load ptr, ptr %base_ci.i, align 8, !tbaa !78
  %ci4.i = getelementptr inbounds %struct.lua_State, ptr %0, i64 0, i32 7
  %106 = load ptr, ptr %ci4.i, align 8, !tbaa !79
...
for.body.i121:                                    ; preds = %if.end.i120, %for.body.i121
  ...
  %107 = load ptr, ptr %top7.i, align 8, !tbaa !80
  ...
  br i1 %cmp5.not.i, label %for.end.i, label %for.body.i121, !llvm.loop !82
...
for.end.i:                                        ; preds = %for.body.i121, %if.end.i120
  ...
  %108 = load ptr, ptr %stack.i, align 8, !tbaa !83
...
for.end40.i:                                      ; preds = %for.body36.i, %for.cond33.preheader.i
  %115 = load ptr, ptr %stack.i, align 8, !tbaa !83
...
if.end15.i.i:                                     ; preds = %if.then13.i.i, %if.end.i.i
  ...
  %119 = load i32, ptr %stacksize.i.i, align 8, !tbaa !87
...
traversestack.exit:                               ; preds = %for.end40.i, %if.end15.i.i, %if.then23.i.i
  ...
  %120 = load i32, ptr %stacksize, align 8, !tbaa !87
  %conv39 = sext i32 %120 to i64
  %mul40 = shl nsw i64 %conv39, 4
  %add41 = add nsw i64 %mul40, 184
  %121 = load i32, ptr %size_ci.i.i, align 4, !tbaa !86
...
if.end.i127:                                      ; preds = %if.then.i126, %sw.bb45
  ...
  %126 = load i32, ptr %sizek.i, align 4, !tbaa !91
...
for.cond19.preheader.i:                           ; preds = %for.inc.i136, %if.end.i127
  ...
  %127 = load i32, ptr %sizeupvalues.i, align 8, !tbaa !92
...
for.body.i130:                                    ; preds = %for.inc.i136, %for.body.lr.ph.i
  ...
  %129 = load ptr, ptr %k.i, align 8, !tbaa !93
...
if.then13.i:                                      ; preds = %land.lhs.true.i132
  ...
  %.pre.i133 = load i32, ptr %sizek.i, align 4, !tbaa !91
...
for.cond38.preheader.i:                           ; preds = %for.inc35.i, %for.cond19.preheader.i
  ...
  %136 = load i32, ptr %sizep.i, align 8, !tbaa !95
...
for.body22.i:                                     ; preds = %for.inc35.i, %for.body22.lr.ph.i
  ...
  %138 = load ptr, ptr %upvalues.i, align 8, !tbaa !96
...
for.cond62.preheader.i:                           ; preds = %for.inc59.i, %for.cond38.preheader.i
  ...
  %145 = load i32, ptr %sizelocvars.i, align 4, !tbaa !98
...
for.body41.i:                                     ; preds = %for.inc59.i, %for.body41.lr.ph.i
  ...
  %147 = load ptr, ptr %p.i137, align 8, !tbaa !99
...
for.body65.i:                                     ; preds = %for.inc79.i, %for.body65.lr.ph.i
  ...
  %154 = load ptr, ptr %locvars.i, align 8, !tbaa !101
  %arrayidx67.i = getelementptr inbounds %struct.LocVar, ptr %154, i64 %indvars.iv133.i
  %155 = load ptr, ptr %arrayidx67.i, align 8, !tbaa !102
...
traverseproto.exit:                               ; preds = %for.cond62.preheader.i.traverseproto.exit_crit_edge, %traverseproto.exit.loopexit
  %conv60.pre-phi = phi i64 [ %.pre157, %for.cond62.preheader.i.traverseproto.exit_crit_edge ], [ %159, %traverseproto.exit.loopexit ]
  ...
  %161 = load i32, ptr %sizecode, align 8, !tbaa !105
  %conv48 = sext i32 %161 to i64
  %conv51 = sext i32 %160 to i64
  %162 = load i32, ptr %sizek.i, align 4, !tbaa !91
  %conv54 = sext i32 %162 to i64
  %sizelineinfo = getelementptr inbounds %struct.Proto, ptr %0, i64 0, i32 13
  %163 = load i32, ptr %sizelineinfo, align 4, !tbaa !106
  %conv57 = sext i32 %163 to i64
  %164 = load i32, ptr %sizeupvalues.i, align 8, !tbaa !92
  %conv63 = sext i32 %164 to i64
  %reass.add = add nsw i64 %conv60.pre-phi, %conv54
  %reass.mul = shl nsw i64 %reass.add, 4
  %reass.add147 = add nsw i64 %conv63, %conv51
  %reass.mul148 = shl nsw i64 %reass.add147, 3
  %reass.add149 = add nsw i64 %conv57, %conv48
  %reass.mul150 = shl nsw i64 %reass.add149, 2
  %add59 = add nsw i64 %reass.mul150, 120
  %add62 = add nsw i64 %add59, %reass.mul
  %add65 = add nsw i64 %add62, %reass.mul148
  br label %cleanup
...
!79 = !{!6, !7, i64 40}
!80 = !{!81, !7, i64 16}
!81 = !{!"CallInfo", !7, i64 0, !7, i64 8, !7, i64 16, !7, i64 24, !10, i64 32, !10, i64 36}
!82 = distinct !{!82, !25}
!83 = !{!6, !7, i64 64}
!84 = distinct !{!84, !25}
!85 = distinct !{!85, !25}
...
!87 = !{!6, !10, i64 88}
!88 = !{!89, !7, i64 104}
!89 = !{!"Proto", !7, i64 0, !8, i64 8, !8, i64 9, !7, i64 16, !7, i64 24, !7, i64 32, !7, i64 40, !7, i64 48, !7, i64 56, !7, i64 64, !10, i64 72, !10, i64 76, !10, i64 80, !10, i64 84, !10, i64 88, !10, i64 92, !10, i64 96, !10, i64 100, !7, i64 104, !8, i64 112, !8, i64 113, !8, i64 114, !8, i64 115}
!90 = !{!89, !7, i64 64}
!91 = !{!89, !10, i64 76}
!92 = !{!89, !10, i64 72}
!93 = !{!89, !7, i64 16}
...
!101 = !{!89, !7, i64 48}
!102 = !{!103, !7, i64 0}
!103 = !{!"LocVar", !7, i64 0, !10, i64 8, !10, i64 12}
!104 = distinct !{!104, !25}
!105 = !{!89, !10, i64 80}
!106 = !{!89, !10, i64 84}
