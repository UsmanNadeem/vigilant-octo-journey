; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/partitionEntries.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/VersaBench/dbms/partitionEntries.c"
...
if.else61:                                        ; preds = %if.else51
  ...
  %brmerge = select i1 %cmp34, i1 true, i1 %cmp33.not
