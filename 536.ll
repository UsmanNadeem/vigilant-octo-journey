; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/configfile.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/configfile.c"
...
InitEncoderParams.exit:                           ; preds = %if.end20.i, %entry
  ...
  br i1 %cmp, label %cond.false143, label %if.end152

cond.false143:                                    ; preds = %InitEncoderParams.exit
  %arrayidx144 = getelementptr inbounds ptr, ptr %av, i64 1
  %7 = load ptr, ptr %arrayidx144, align 8, !tbaa !5
  %call145 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %7, ptr noundef nonnull dereferenceable(3) @.str.227, i64 noundef 2) #20
  %cmp148 = icmp eq i32 %call145, 0
  br i1 %cmp148, label %if.then150, label %if.end509

if.then150:                                       ; preds = %cond.false143
  %8 = load ptr, ptr @stderr, align 8, !tbaa !5
  %9 = tail call i64 @fwrite(ptr nonnull @.str.224, i64 955, i64 1, ptr %8) #18
  tail call void @exit(i32 noundef -1) #19
  unreachable

if.end152:                                        ; preds = %InitEncoderParams.exit
  %cmp153 = icmp sgt i32 %ac, 2
  br i1 %cmp153, label %cond.false323, label %if.end509

cond.false323:                                    ; preds = %if.end152
  %arrayidx324 = getelementptr inbounds ptr, ptr %av, i64 1
  %10 = load ptr, ptr %arrayidx324, align 8, !tbaa !5
  %call325 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %10, ptr noundef nonnull dereferenceable(3) @.str.228, i64 noundef 2) #20
  %cmp328 = icmp eq i32 %call325, 0
  br i1 %cmp328, label %if.then330, label %cond.false500

if.then330:                                       ; preds = %cond.false323
  %arrayidx331 = getelementptr inbounds ptr, ptr %av, i64 2
  %11 = load ptr, ptr %arrayidx331, align 8, !tbaa !5
  br label %cond.false500

cond.false500:                                    ; preds = %cond.false323, %if.then330
  %CLcount.0 = phi i32 [ 3, %if.then330 ], [ 1, %cond.false323 ]
  %filename.0 = phi ptr [ %11, %if.then330 ], [ @.str.225, %cond.false323 ]
  %call502 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %10, ptr noundef nonnull dereferenceable(3) @.str.227, i64 noundef 2) #20
  %cmp505 = icmp eq i32 %call502, 0
  br i1 %cmp505, label %if.then507, label %if.end509

if.then507:                                       ; preds = %cond.false500
  %12 = load ptr, ptr @stderr, align 8, !tbaa !5
  %13 = tail call i64 @fwrite(ptr nonnull @.str.224, i64 955, i64 1, ptr %12) #18
  tail call void @exit(i32 noundef -1) #19
  unreachable

if.end509:                                        ; preds = %cond.false143, %cond.false500, %if.end152
  %CLcount.1 = phi i32 [ %CLcount.0, %cond.false500 ], [ 1, %if.end152 ], [ 1, %cond.false143 ]
  %filename.1 = phi ptr [ %filename.0, %cond.false500 ], [ @.str.225, %if.end152 ], [ @.str.225, %cond.false143 ]
  ...
  %call511 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.229, ptr noundef %cond.i)
  %call512 = tail call ptr @GetConfigFileContent(ptr noundef %filename.1)
  %cmp513 = icmp eq ptr %call512, null
...
if.end516:                                        ; preds = %if.then515, %if.end509
  %call517 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call512) #20
  %conv518 = trunc i64 %call517 to i32
  tail call fastcc void @ParseContent(ptr noundef %call512, i32 noundef %conv518)
  %putchar = tail call i32 @putchar(i32 10)
  tail call void @free(ptr noundef %call512) #21
  %cmp5201274 = icmp slt i32 %CLcount.1, %ac
  br i1 %cmp5201274, label %cond.false706, label %while.end1183

cond.false706:                                    ; preds = %if.end516, %if.end1182
  %CLcount.21275 = phi i32 [ %CLcount.4, %if.end1182 ], [ %CLcount.1, %if.end516 ]
  %idxprom707 = sext i32 %CLcount.21275 to i64
  %arrayidx708 = getelementptr inbounds ptr, ptr %av, i64 %idxprom707
  %14 = load ptr, ptr %arrayidx708, align 8, !tbaa !5
  %call709 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %14, ptr noundef nonnull dereferenceable(3) @.str.227, i64 noundef 2) #20
  %cmp712 = icmp eq i32 %call709, 0
  br i1 %cmp712, label %if.then714, label %cond.false901

if.then714:                                       ; preds = %cond.false706
  %15 = load ptr, ptr @stderr, align 8, !tbaa !5
  %16 = tail call i64 @fwrite(ptr nonnull @.str.224, i64 955, i64 1, ptr %15) #18
  tail call void @exit(i32 noundef -1) #19
  unreachable

cond.false901:                                    ; preds = %cond.false706
  %call904 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %14, ptr noundef nonnull dereferenceable(3) @.str.231, i64 noundef 2) #20
  %cmp907 = icmp eq i32 %call904, 0
  br i1 %cmp907, label %if.then909, label %cond.false1110

if.then909:                                       ; preds = %cond.false901
  %add = add nsw i32 %CLcount.21275, 1
  %idxprom910 = sext i32 %add to i64
  %arrayidx911 = getelementptr inbounds ptr, ptr %av, i64 %idxprom910
  %17 = load ptr, ptr %arrayidx911, align 8, !tbaa !5
  %call912 = tail call ptr @GetConfigFileContent(ptr noundef %17)
  %cmp913 = icmp eq ptr %call912, null
  br i1 %cmp913, label %if.then915, label %if.end916

if.then915:                                       ; preds = %if.then909
  tail call void @error(ptr noundef nonnull @errortext, i32 noundef 300) #21
  br label %if.end916

if.end916:                                        ; preds = %if.then915, %if.then909
  %18 = load ptr, ptr %arrayidx911, align 8, !tbaa !5
  %call920 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.229, ptr noundef %18)
  %call921 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call912) #20
  %conv922 = trunc i64 %call921 to i32
  tail call fastcc void @ParseContent(ptr noundef %call912, i32 noundef %conv922)
  %putchar1245 = tail call i32 @putchar(i32 10)
  tail call void @free(ptr noundef %call912) #21
  %add924 = add nsw i32 %CLcount.21275, 2
  br label %if.end1182

cond.false1110:                                   ; preds = %cond.false901
  %call1113 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %14, ptr noundef nonnull dereferenceable(3) @.str.232, i64 noundef 2) #20
  %cmp1116 = icmp eq i32 %call1113, 0
  br i1 %cmp1116, label %if.then1118, label %if.else1177

if.then1118:                                      ; preds = %cond.false1110
  %inc = add nsw i32 %CLcount.21275, 1
  %cmp11201265 = icmp slt i32 %inc, %ac
  br i1 %cmp11201265, label %land.rhs1122.preheader, label %while.end

land.rhs1122.preheader:                           ; preds = %if.then1118
  %19 = sext i32 %inc to i64
  br label %land.rhs1122

land.rhs1122:                                     ; preds = %land.rhs1122.preheader, %while.body1130
  %indvars.iv = phi i64 [ %19, %land.rhs1122.preheader ], [ %indvars.iv.next, %while.body1130 ]
  %ContentLen.01266 = phi i32 [ 0, %land.rhs1122.preheader ], [ %conv1137, %while.body1130 ]
  %arrayidx1124 = getelementptr inbounds ptr, ptr %av, i64 %indvars.iv
  %20 = load ptr, ptr %arrayidx1124, align 8, !tbaa !5
  %21 = load i8, ptr %20, align 1, !tbaa !20
  %cmp1127.not = icmp eq i8 %21, 45
  br i1 %cmp1127.not, label %while.end.loopexit.split.loop.exit1286, label %while.body1130

while.body1130:                                   ; preds = %land.rhs1122
  %indvars.iv.next = add nsw i64 %indvars.iv, 1
  %call1134 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %20) #20
  %22 = trunc i64 %call1134 to i32
  %conv1137 = add i32 %ContentLen.01266, %22
  %lftr.wideiv = trunc i64 %indvars.iv.next to i32
  %exitcond.not = icmp eq i32 %lftr.wideiv, %ac
  br i1 %exitcond.not, label %while.end, label %land.rhs1122, !llvm.loop !21

while.end.loopexit.split.loop.exit1286:           ; preds = %land.rhs1122
  %23 = trunc i64 %indvars.iv to i32
  br label %while.end

while.end:                                        ; preds = %while.body1130, %while.end.loopexit.split.loop.exit1286, %if.then1118
  %ContentLen.0.lcssa = phi i32 [ 0, %if.then1118 ], [ %ContentLen.01266, %while.end.loopexit.split.loop.exit1286 ], [ %conv1137, %while.body1130 ]
  %NumberParams.0.lcssa = phi i32 [ %inc, %if.then1118 ], [ %23, %while.end.loopexit.split.loop.exit1286 ], [ %ac, %while.body1130 ]
  %add1138 = add nsw i32 %ContentLen.0.lcssa, 1000
  %conv1139 = sext i32 %add1138 to i64
  %call1140 = tail call noalias ptr @malloc(i64 noundef %conv1139) #22
  %cmp1141 = icmp eq ptr %call1140, null
  br i1 %cmp1141, label %if.then1143, label %if.end1144

if.then1143:                                      ; preds = %while.end
  tail call void @no_mem_exit(ptr noundef nonnull @.str.233) #21
  br label %if.end1144

if.end1144:                                       ; preds = %if.then1143, %while.end
  store i8 0, ptr %call1140, align 1, !tbaa !20
  %cmp11471271 = icmp slt i32 %inc, %NumberParams.0.lcssa
  br i1 %cmp11471271, label %while.body1149.preheader, label %while.end1172

while.body1149.preheader:                         ; preds = %if.end1144
  %24 = sext i32 %inc to i64
  br label %while.body1149

while.body1149:                                   ; preds = %while.body1149.preheader, %while.end1170
  %indvars.iv1278 = phi i64 [ %24, %while.body1149.preheader ], [ %indvars.iv.next1279, %while.end1170 ]
  %arrayidx1151 = getelementptr inbounds ptr, ptr %av, i64 %indvars.iv1278
  %25 = load ptr, ptr %arrayidx1151, align 8, !tbaa !5
  %call1153 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call1140) #20
  %arrayidx1154 = getelementptr inbounds i8, ptr %call1140, i64 %call1153
  br label %while.cond1155

while.cond1155:                                   ; preds = %if.end1168, %while.body1149
  %source.0 = phi ptr [ %25, %while.body1149 ], [ %incdec.ptr1169, %if.end1168 ]
  %destin.0 = phi ptr [ %arrayidx1154, %while.body1149 ], [ %destin.1, %if.end1168 ]
  %26 = load i8, ptr %source.0, align 1, !tbaa !20
  switch i8 %26, label %if.else1166 [
    i8 0, label %while.end1170
    i8 61, label %if.then1163
  ]

if.then1163:                                      ; preds = %while.cond1155
  %incdec.ptr = getelementptr inbounds i8, ptr %destin.0, i64 1
  store i8 32, ptr %destin.0, align 1, !tbaa !20
  %incdec.ptr1164 = getelementptr inbounds i8, ptr %destin.0, i64 2
  store i8 61, ptr %incdec.ptr, align 1, !tbaa !20
  %incdec.ptr1165 = getelementptr inbounds i8, ptr %destin.0, i64 3
  store i8 32, ptr %incdec.ptr1164, align 1, !tbaa !20
  br label %if.end1168

if.else1166:                                      ; preds = %while.cond1155
  %incdec.ptr1167 = getelementptr inbounds i8, ptr %destin.0, i64 1
  store i8 %26, ptr %destin.0, align 1, !tbaa !20
  br label %if.end1168

if.end1168:                                       ; preds = %if.else1166, %if.then1163
  %destin.1 = phi ptr [ %incdec.ptr1165, %if.then1163 ], [ %incdec.ptr1167, %if.else1166 ]
  %incdec.ptr1169 = getelementptr inbounds i8, ptr %source.0, i64 1
  br label %while.cond1155, !llvm.loop !22

while.end1170:                                    ; preds = %while.cond1155
  ...
  %exitcond1282.not = icmp eq i32 %NumberParams.0.lcssa, %lftr.wideiv1281
  br i1 %exitcond1282.not, label %while.end1172, label %while.body1149, !llvm.loop !23

while.end1172:                                    ; preds = %while.end1170, %if.end1144
  %CLcount.3.lcssa = phi i32 [ %inc, %if.end1144 ], [ %NumberParams.0.lcssa, %while.end1170 ]
  %call1173 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.234, ptr noundef nonnull @.str.235)
  %call1174 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call1140) #20
  %conv1175 = trunc i64 %call1174 to i32
  tail call fastcc void @ParseContent(ptr noundef nonnull %call1140, i32 noundef %conv1175)
  tail call void @free(ptr noundef %call1140) #21
  %putchar1243 = tail call i32 @putchar(i32 10)
  br label %if.end1182

if.else1177:                                      ; preds = %cond.false1110
  %call1180 = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.236, i32 noundef %CLcount.21275, ptr noundef %14) #21
  tail call void @error(ptr noundef nonnull @errortext, i32 noundef 300) #21
  br label %if.end1182

if.end1182:                                       ; preds = %while.end1172, %if.else1177, %if.end916
  %CLcount.4 = phi i32 [ %add924, %if.end916 ], [ %CLcount.3.lcssa, %while.end1172 ], [ %CLcount.21275, %if.else1177 ]
  %cmp520 = icmp slt i32 %CLcount.4, %ac
  br i1 %cmp520, label %cond.false706, label %while.end1183, !llvm.loop !24

while.end1183:                                    ; preds = %if.end1182, %if.end516
  %putchar1242 = tail call i32 @putchar(i32 10)
...
while.body.lr.ph.i.i:                             ; preds = %while.end1183
...
TestEncoderParams.exit.i:                         ; preds = %if.end181.i.i, %while.end1183
  ...
  br i1 %cmp.i, label %if.then.i1248, label %if.end.i

if.then.i1248:                                    ; preds = %TestEncoderParams.exit.i
  store double 3.000000e+01, ptr %FrameRate.i, align 8, !tbaa !31
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i1248, %TestEncoderParams.exit.i
  ...
  %tobool.not.i1249 = icmp eq i32 %54, 0
  br i1 %tobool.not.i1249, label %cond.end.i, label %cond.true.i
...
cond.end.i:                                       ; preds = %cond.true.i, %if.end.i
  %cond.i1250 = phi i32 [ %add.i, %cond.true.i ], [ 1, %if.end.i ]
...
if.then85.i:                                      ; preds = %cond.end.i
  ...
  %mul86.i = mul nsw i32 %57, %cond.i1250
...
land.lhs.true276.i:                               ; preds = %if.then272.i
  %call279.i = tail call ptr @fopen64(ptr noundef nonnull %SliceGroupConfigFileName.i, ptr noundef nonnull @.str.237)
...
if.then288.i:                                     ; preds = %if.else285.i
  ...
  %conv.i1251 = sext i32 %add290.i to i64
  %mul291.i = shl nsw i64 %conv.i1251, 2
...
for.body302.i:                                    ; preds = %if.end297.i, %for.body302.i
  ...
  %add.ptr.i1252 = getelementptr inbounds i32, ptr %125, i64 %indvars.iv883.i
  %call304.i = tail call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %sgfile.0.i, ptr noundef nonnull @.str.245, ptr noundef %add.ptr.i1252) #21
...
for.body381.i:                                    ; preds = %if.end398.i, %for.body381.preheader.i
  %indvars.iv.i1253 = phi i64 [ 0, %for.body381.preheader.i ], [ %indvars.iv.next.i1254, %if.end398.i ]
  ...
  %arrayidx386.i = getelementptr inbounds i8, ptr %151, i64 %indvars.iv.i1253
  ...
  %add.ptr389.i = getelementptr inbounds i8, ptr %153, i64 %indvars.iv.i1253
...
if.end398.i:                                      ; preds = %if.then394.i, %for.body381.i
  ...
  %indvars.iv.next.i1254 = add nuw nsw i64 %indvars.iv.i1253, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i1254, %wide.trip.count.i
...
if.then11.i.i:                                    ; preds = %lor.lhs.false9.i.i, %land.lhs.true7.i.i
  ...
  call void @error(ptr noundef nonnull @errortext, i32 noundef 500) #21
  %.pre1284 = load ptr, ptr @input, align 8, !tbaa !5
  br label %PatchInp.exit

PatchInp.exit:                                    ; preds = %if.end.i855.i, %lor.lhs.false9.i.i, %if.then11.i.i
  %343 = phi ptr [ %339, %if.end.i855.i ], [ %339, %lor.lhs.false9.i.i ], [ %.pre1284, %if.then11.i.i ]
  ...
  br i1 %tobool.not, label %if.end1187, label %if.then1185

if.then1185:                                      ; preds = %PatchInp.exit
  ...
  br i1 %cmp.not54.i, label %DisplayEncoderParams.exit, label %while.body.i1257

while.body.i1257:                                 ; preds = %if.then1185, %if.end38.i
  %indvars.iv.i1255 = phi i64 [ %indvars.iv.next.i1260, %if.end38.i ], [ 0, %if.then1185 ]
  %346 = phi ptr [ %353, %if.end38.i ], [ %345, %if.then1185 ]
  %Type.i1256 = getelementptr inbounds [225 x %struct.Mapping], ptr @Map, i64 0, i64 %indvars.iv.i1255, i32 2
  %347 = load i32, ptr %Type.i1256, align 8, !tbaa !13
  switch i32 %347, label %if.end38.i [
    i32 0, label %if.then.i1259
    i32 1, label %if.then16.i
    i32 2, label %if.then29.i
  ]

if.then.i1259:                                    ; preds = %while.body.i1257
  %Place.i1258 = getelementptr inbounds [225 x %struct.Mapping], ptr @Map, i64 0, i64 %indvars.iv.i1255, i32 1
  %348 = load ptr, ptr %Place.i1258, align 8, !tbaa !15
...
if.then16.i:                                      ; preds = %while.body.i1257
  %Place22.i = getelementptr inbounds [225 x %struct.Mapping], ptr @Map, i64 0, i64 %indvars.iv.i1255, i32 1
...
if.then29.i:                                      ; preds = %while.body.i1257
  %Place35.i = getelementptr inbounds [225 x %struct.Mapping], ptr @Map, i64 0, i64 %indvars.iv.i1255, i32 1
...
if.end38.i:                                       ; preds = %if.then29.i, %if.then16.i, %if.then.i1259, %while.body.i1257
  %indvars.iv.next.i1260 = add nuw i64 %indvars.iv.i1255, 1
  %arrayidx.i1261 = getelementptr inbounds [225 x %struct.Mapping], ptr @Map, i64 0, i64 %indvars.iv.next.i1260
  %353 = load ptr, ptr %arrayidx.i1261, align 8, !tbaa !9
  %cmp.not.i1262 = icmp eq ptr %353, null
  br i1 %cmp.not.i1262, label %DisplayEncoderParams.exit, label %while.body.i1257, !llvm.loop !101

DisplayEncoderParams.exit:                        ; preds = %if.end38.i, %if.then1185
  %puts53.i = call i32 @puts(ptr nonnull dereferenceable(1) @str.334)
  br label %if.end1187

if.end1187:                                       ; preds = %DisplayEncoderParams.exit, %PatchInp.exit
  ret void
}
...
entry:
  %call = tail call ptr @fopen64(ptr noundef %Filename, ptr noundef nonnull @.str.237)
