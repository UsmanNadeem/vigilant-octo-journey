; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/routenet.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/routenet.c"
...
if.end18:                                         ; preds = %if.end18.sink.split, %if.end
  %or.cond297468 = phi i1 [ false, %if.end ], [ %cmp, %if.end18.sink.split ]
...
for.body25.lr.ph:                                 ; preds = %for.cond22.preheader
  ...
  %or.cond493 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond493, label %for.body25.preheader, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %13 = add nsw <8 x i32> %broadcast.splat, %vec.ind
  %14 = trunc <8 x i32> %13 to <8 x i16>
  %15 = getelementptr inbounds i16, ptr %6, i64 %offset.idx
  store <8 x i16> %14, ptr %15, align 2, !tbaa !13
  %16 = getelementptr inbounds i16, ptr %7, i64 %offset.idx
  store <8 x i16> zeroinitializer, ptr %16, align 2, !tbaa !13
...
for.body25.preheader:                             ; preds = %for.body25.lr.ph, %middle.block
  ...
  %18 = sub nsw i64 %wide.trip.count, %indvars.iv.ph
...
for.body25.prol.loopexit:                         ; preds = %for.body25.prol, %for.body25.preheader
  ...
  br i1 %22, label %for.end31, label %for.body25
...
for.body:                                         ; preds = %if.end18, %for.body
  ...
  %23 = load i32, ptr @MAXPATHS, align 4, !tbaa !5
  %mul19 = shl nsw i32 %23, 1
...
for.body36.lr.ph:                                 ; preds = %for.end31
  %28 = load ptr, ptr @targetList, align 8, !tbaa !11
  %29 = load ptr, ptr @addTargetList, align 8, !tbaa !11
  %30 = add nuw i32 %add33, 1
  %wide.trip.count432 = zext i32 %30 to i64
  %31 = add nsw i64 %wide.trip.count432, -1
  %min.iters.check480 = icmp ult i64 %31, 16
  %32 = ptrtoint ptr %29 to i64
  %33 = ptrtoint ptr %28 to i64
  %34 = sub i64 %32, %33
  %diff.check477 = icmp ult i64 %34, 32
  %or.cond496 = select i1 %min.iters.check480, i1 true, i1 %diff.check477
  br i1 %or.cond496, label %for.body36.preheader, label %vector.ph481

vector.ph481:                                     ; preds = %for.body36.lr.ph
  %n.vec483 = and i64 %31, -16
  %ind.end484 = or i64 %n.vec483, 1
  br label %vector.body487

vector.body487:                                   ; preds = %vector.body487, %vector.ph481
  %index488 = phi i64 [ 0, %vector.ph481 ], [ %index.next490, %vector.body487 ]
  %offset.idx489 = or i64 %index488, 1
  %35 = getelementptr inbounds i16, ptr %28, i64 %offset.idx489
  store <8 x i16> zeroinitializer, ptr %35, align 2, !tbaa !13
  %36 = getelementptr inbounds i16, ptr %35, i64 8
  store <8 x i16> zeroinitializer, ptr %36, align 2, !tbaa !13
  %37 = getelementptr inbounds i16, ptr %29, i64 %offset.idx489
  store <8 x i16> zeroinitializer, ptr %37, align 2, !tbaa !13
  %38 = getelementptr inbounds i16, ptr %37, i64 8
  store <8 x i16> zeroinitializer, ptr %38, align 2, !tbaa !13
  %index.next490 = add nuw i64 %index488, 16
  %39 = icmp eq i64 %index.next490, %n.vec483
  br i1 %39, label %middle.block478, label %vector.body487, !llvm.loop !22

middle.block478:                                  ; preds = %vector.body487
  %cmp.n486 = icmp eq i64 %31, %n.vec483
  br i1 %cmp.n486, label %for.end43, label %for.body36.preheader

for.body36.preheader:                             ; preds = %for.body36.lr.ph, %middle.block478
  %indvars.iv429.ph = phi i64 [ 1, %for.body36.lr.ph ], [ %ind.end484, %middle.block478 ]
  %40 = sub nsw i64 %wide.trip.count432, %indvars.iv429.ph
  %41 = xor i64 %indvars.iv429.ph, -1
  %42 = add nsw i64 %41, %wide.trip.count432
  %xtraiter500 = and i64 %40, 3
  %lcmp.mod501.not = icmp eq i64 %xtraiter500, 0
  br i1 %lcmp.mod501.not, label %for.body36.prol.loopexit, label %for.body36.prol

for.body36.prol:                                  ; preds = %for.body36.preheader, %for.body36.prol
  %indvars.iv429.prol = phi i64 [ %indvars.iv.next430.prol, %for.body36.prol ], [ %indvars.iv429.ph, %for.body36.preheader ]
  %prol.iter502 = phi i64 [ %prol.iter502.next, %for.body36.prol ], [ 0, %for.body36.preheader ]
  %arrayidx38.prol = getelementptr inbounds i16, ptr %28, i64 %indvars.iv429.prol
  store i16 0, ptr %arrayidx38.prol, align 2, !tbaa !13
  %arrayidx40.prol = getelementptr inbounds i16, ptr %29, i64 %indvars.iv429.prol
  store i16 0, ptr %arrayidx40.prol, align 2, !tbaa !13
  %indvars.iv.next430.prol = add nuw nsw i64 %indvars.iv429.prol, 1
  %prol.iter502.next = add i64 %prol.iter502, 1
  %prol.iter502.cmp.not = icmp eq i64 %prol.iter502.next, %xtraiter500
  br i1 %prol.iter502.cmp.not, label %for.body36.prol.loopexit, label %for.body36.prol, !llvm.loop !23

for.body36.prol.loopexit:                         ; preds = %for.body36.prol, %for.body36.preheader
  %indvars.iv429.unr = phi i64 [ %indvars.iv429.ph, %for.body36.preheader ], [ %indvars.iv.next430.prol, %for.body36.prol ]
  %43 = icmp ult i64 %42, 3
  br i1 %43, label %for.end43, label %for.body36

for.body36:                                       ; preds = %for.body36.prol.loopexit, %for.body36
  %indvars.iv429 = phi i64 [ %indvars.iv.next430.3, %for.body36 ], [ %indvars.iv429.unr, %for.body36.prol.loopexit ]
  %arrayidx38 = getelementptr inbounds i16, ptr %28, i64 %indvars.iv429
  store i16 0, ptr %arrayidx38, align 2, !tbaa !13
  %arrayidx40 = getelementptr inbounds i16, ptr %29, i64 %indvars.iv429
  store i16 0, ptr %arrayidx40, align 2, !tbaa !13
  %indvars.iv.next430 = add nuw nsw i64 %indvars.iv429, 1
  %arrayidx38.1 = getelementptr inbounds i16, ptr %28, i64 %indvars.iv.next430
  store i16 0, ptr %arrayidx38.1, align 2, !tbaa !13
  %arrayidx40.1 = getelementptr inbounds i16, ptr %29, i64 %indvars.iv.next430
  store i16 0, ptr %arrayidx40.1, align 2, !tbaa !13
  %indvars.iv.next430.1 = add nuw nsw i64 %indvars.iv429, 2
  %arrayidx38.2 = getelementptr inbounds i16, ptr %28, i64 %indvars.iv.next430.1
  store i16 0, ptr %arrayidx38.2, align 2, !tbaa !13
  %arrayidx40.2 = getelementptr inbounds i16, ptr %29, i64 %indvars.iv.next430.1
  store i16 0, ptr %arrayidx40.2, align 2, !tbaa !13
  %indvars.iv.next430.2 = add nuw nsw i64 %indvars.iv429, 3
  %arrayidx38.3 = getelementptr inbounds i16, ptr %28, i64 %indvars.iv.next430.2
  store i16 0, ptr %arrayidx38.3, align 2, !tbaa !13
  %arrayidx40.3 = getelementptr inbounds i16, ptr %29, i64 %indvars.iv.next430.2
  store i16 0, ptr %arrayidx40.3, align 2, !tbaa !13
  %indvars.iv.next430.3 = add nuw nsw i64 %indvars.iv429, 4
  %exitcond433.not.3 = icmp eq i64 %indvars.iv.next430.3, %wide.trip.count432
  br i1 %exitcond433.not.3, label %for.end43, label %for.body36, !llvm.loop !24

for.end43:                                        ; preds = %for.body36.prol.loopexit, %for.body36, %middle.block478, %for.end31
  store i32 0, ptr @targetPtr, align 4, !tbaa !5
  store i32 0, ptr @segPtr, align 4, !tbaa !5
  %storemerge361389 = add i32 %.pre, 1
  store i32 %storemerge361389, ptr %i, align 4, !tbaa !5
  %cmp47.not.not390 = icmp slt i32 %.pre, %add33
  %44 = load ptr, ptr @pnodeArray, align 8, !tbaa !11
  br i1 %cmp47.not.not390, label %for.body49.lr.ph, label %for.end147

for.body49.lr.ph:                                 ; preds = %for.end43
  %cmp56.not.not381 = icmp sgt i32 %numpnodes, 0
  %45 = sext i32 %storemerge361389 to i64
  %46 = sext i32 %.pre to i64
  %47 = sext i32 %add33 to i64
  %smax = tail call i32 @llvm.smax.i32(i32 %storemerge361389, i32 %add33)
  br label %for.body49

for.cond45.loopexit:                              ; preds = %for.inc142, %for.body49
  %min.1.lcssa = phi i32 [ %min.0391, %for.body49 ], [ %min.2, %for.inc142 ]
  %savei.1.lcssa = phi i32 [ %savei.0392, %for.body49 ], [ %savei.2, %for.inc142 ]
  %storemerge361 = add i32 %storemerge361.in396, 1
  store i32 %storemerge361, ptr %i, align 4, !tbaa !5
  %exitcond441.not = icmp eq i32 %storemerge361.in396, %smax
  br i1 %exitcond441.not, label %for.end147, label %for.body49, !llvm.loop !25

for.body49:                                       ; preds = %for.body49.lr.ph, %for.cond45.loopexit
  %storemerge361.in396 = phi i32 [ %storemerge361389, %for.body49.lr.ph ], [ %storemerge361, %for.cond45.loopexit ]
  %storemerge361.in393 = phi i32 [ %.pre, %for.body49.lr.ph ], [ %storemerge361.in396, %for.cond45.loopexit ]
  %savei.0392 = phi i32 [ undef, %for.body49.lr.ph ], [ %savei.1.lcssa, %for.cond45.loopexit ]
  %min.0391 = phi i32 [ 1000000000, %for.body49.lr.ph ], [ %min.1.lcssa, %for.cond45.loopexit ]
  %sub50 = sub nsw i32 %storemerge361.in396, %.pre
  %idxprom51 = sext i32 %sub50 to i64
  %nodeList = getelementptr inbounds %struct.pnode, ptr %44, i64 %idxprom51, i32 1
  %48 = load ptr, ptr %nodeList, align 8, !tbaa !26
  store i32 %storemerge361389, ptr %j, align 4, !tbaa !5
  br i1 %cmp56.not.not381, label %for.body58.lr.ph, label %for.cond45.loopexit

for.body58.lr.ph:                                 ; preds = %for.body49
  %arrayidx65 = getelementptr inbounds %struct.pnode, ptr %44, i64 %idxprom51
  br label %for.body58

for.body58:                                       ; preds = %for.body58.lr.ph, %for.inc142
  %indvars.iv434 = phi i64 [ %45, %for.body58.lr.ph ], [ %indvars.iv.next435, %for.inc142 ]
  %savei.1384 = phi i32 [ %savei.0392, %for.body58.lr.ph ], [ %savei.2, %for.inc142 ]
  %min.1383 = phi i32 [ %min.0391, %for.body58.lr.ph ], [ %min.2, %for.inc142 ]
  %storemerge364.in382 = phi i32 [ %.pre, %for.body58.lr.ph ], [ %55, %for.inc142 ]
  %cmp59 = icmp eq i32 %storemerge361.in393, %storemerge364.in382
  br i1 %cmp59, label %for.inc142, label %if.end62

if.end62:                                         ; preds = %for.body58
  %49 = load i32, ptr %arrayidx65, align 8, !tbaa !28
  %cmp66.not = icmp eq i32 %49, 0
  %50 = sub nsw i64 %indvars.iv434, %46
  %arrayidx98 = getelementptr inbounds %struct.pnode, ptr %44, i64 %50
  %51 = load i32, ptr %arrayidx98, align 8, !tbaa !28
...
land.lhs.true95:                                  ; preds = %if.end62
  %cmp126 = icmp eq i32 %51, %sub50
  %or.cond472 = select i1 %cmp100, i1 %cmp126, i1 false
  br i1 %or.cond472, label %for.inc142, label %if.end132

if.then110:                                       ; preds = %land.lhs.true68
  %52 = trunc i64 %50 to i32
  %cmp116 = icmp eq i32 %49, %52
  br i1 %cmp116, label %for.inc142, label %if.end132

if.end132:                                        ; preds = %land.lhs.true95, %if.then110, %if.then75
  %distance = getelementptr inbounds %struct.nnode, ptr %48, i64 %indvars.iv434, i32 1
  %53 = load i32, ptr %distance, align 4, !tbaa !29
  %cmp135 = icmp slt i32 %53, %min.1383
  %spec.select = tail call i32 @llvm.smin.i32(i32 %53, i32 %min.1383)
  %spec.select366 = select i1 %cmp135, i32 %storemerge361.in396, i32 %savei.1384
  br label %for.inc142

for.inc142:                                       ; preds = %land.lhs.true95, %if.end132, %if.then110, %if.then75, %for.body58
  %min.2 = phi i32 [ %min.1383, %for.body58 ], [ %min.1383, %if.then75 ], [ %min.1383, %if.then110 ], [ %spec.select, %if.end132 ], [ %min.1383, %land.lhs.true95 ]
  %savei.2 = phi i32 [ %savei.1384, %for.body58 ], [ %savei.1384, %if.then75 ], [ %savei.1384, %if.then110 ], [ %spec.select366, %if.end132 ], [ %savei.1384, %land.lhs.true95 ]
  %indvars.iv.next435 = add nsw i64 %indvars.iv434, 1
  %54 = trunc i64 %indvars.iv.next435 to i32
  store i32 %54, ptr %j, align 4, !tbaa !5
  %cmp56.not.not = icmp slt i64 %indvars.iv434, %47
  %55 = trunc i64 %indvars.iv434 to i32
...
for.end147:                                       ; preds = %for.cond45.loopexit, %for.end43
  ...
  %56 = load ptr, ptr @delSourceList, align 8, !tbaa !11
  %arrayidx149 = getelementptr inbounds i16, ptr %56, i64 1
  store i16 %conv148, ptr %arrayidx149, align 2, !tbaa !13
  %57 = load ptr, ptr @addTargetList, align 8, !tbaa !11
  %arrayidx151 = getelementptr inbounds i16, ptr %57, i64 1
  store i16 %conv148, ptr %arrayidx151, align 2, !tbaa !13
  %sub152 = sub nsw i32 %savei.0.lcssa, %.pre
  %idxprom153 = sext i32 %sub152 to i64
  %arrayidx154 = getelementptr inbounds %struct.pnode, ptr %44, i64 %idxprom153
  %58 = load i32, ptr %arrayidx154, align 8, !tbaa !28
  %cmp156.not = icmp eq i32 %58, 0
  br i1 %cmp156.not, label %if.else195, label %if.then158

if.then158:                                       ; preds = %for.end147
  %add163 = add nsw i32 %58, %.pre
  %conv164 = trunc i32 %add163 to i16
  %arrayidx165 = getelementptr inbounds i16, ptr %56, i64 2
  store i16 %conv164, ptr %arrayidx165, align 2, !tbaa !13
  %arrayidx167 = getelementptr inbounds i16, ptr %57, i64 2
  store i16 %conv164, ptr %arrayidx167, align 2, !tbaa !13
  %idxprom172 = sext i32 %58 to i64
  %equiv = getelementptr inbounds %struct.pnode, ptr %44, i64 %idxprom172, i32 2
  %lptr.0397402 = load ptr, ptr %equiv, align 8, !tbaa !11
  %cmp175.not398403 = icmp eq ptr %lptr.0397402, null
  br i1 %cmp175.not398403, label %for.body222.lr.ph, label %while.body177.lr.ph

while.body177.lr.ph:                              ; preds = %if.then158, %if.end183
  %indvars.iv442 = phi i64 [ %indvars.iv.next443, %if.end183 ], [ 1, %if.then158 ]
  %lptr.0397405 = phi ptr [ %lptr.0397, %if.end183 ], [ %lptr.0397402, %if.then158 ]
  br label %while.body177

while.body177:                                    ; preds = %while.body177.lr.ph, %if.then182
  %lptr.0399 = phi ptr [ %lptr.0397405, %while.body177.lr.ph ], [ %lptr.0, %if.then182 ]
  %59 = load i32, ptr %lptr.0399, align 8, !tbaa !32
  %add179 = add nsw i32 %59, %.pre
  %cmp180 = icmp eq i32 %add179, %savei.0.lcssa
  br i1 %cmp180, label %if.then182, label %if.end183

if.then182:                                       ; preds = %while.body177
  %next = getelementptr inbounds %struct.list2, ptr %lptr.0399, i64 0, i32 1
  %lptr.0 = load ptr, ptr %next, align 8, !tbaa !11
  %cmp175.not = icmp eq ptr %lptr.0, null
  br i1 %cmp175.not, label %if.end217.loopexit423, label %while.body177, !llvm.loop !34

if.end183:                                        ; preds = %while.body177
  %conv184 = trunc i32 %add179 to i16
  %indvars.iv.next443 = add nuw i64 %indvars.iv442, 1
  %60 = add nuw nsw i64 %indvars.iv442, 2
  %arrayidx188 = getelementptr inbounds i16, ptr %56, i64 %60
  store i16 %conv184, ptr %arrayidx188, align 2, !tbaa !13
  %arrayidx192 = getelementptr inbounds i16, ptr %57, i64 %60
  store i16 %conv184, ptr %arrayidx192, align 2, !tbaa !13
  %next193 = getelementptr inbounds %struct.list2, ptr %lptr.0399, i64 0, i32 1
  %lptr.0397 = load ptr, ptr %next193, align 8, !tbaa !11
  %cmp175.not398 = icmp eq ptr %lptr.0397, null
  br i1 %cmp175.not398, label %if.end217.loopexit424, label %while.body177.lr.ph, !llvm.loop !34

if.else195:                                       ; preds = %for.end147
  %equiv199 = getelementptr inbounds %struct.pnode, ptr %44, i64 %idxprom153, i32 2
  %lptr.1407 = load ptr, ptr %equiv199, align 8, !tbaa !11
  %cmp201.not408 = icmp eq ptr %lptr.1407, null
  br i1 %cmp201.not408, label %for.body222.lr.ph, label %while.body203

while.body203:                                    ; preds = %if.else195, %while.body203
  %indvars.iv446 = phi i64 [ %indvars.iv.next447, %while.body203 ], [ 0, %if.else195 ]
  %lptr.1410 = phi ptr [ %lptr.1, %while.body203 ], [ %lptr.1407, %if.else195 ]
  %61 = load i32, ptr %lptr.1410, align 8, !tbaa !32
  %add205 = add nsw i32 %61, %.pre
  %conv206 = trunc i32 %add205 to i16
  %indvars.iv.next447 = add nuw i64 %indvars.iv446, 1
  %62 = add nuw nsw i64 %indvars.iv446, 2
  %arrayidx210 = getelementptr inbounds i16, ptr %56, i64 %62
  store i16 %conv206, ptr %arrayidx210, align 2, !tbaa !13
  %arrayidx214 = getelementptr inbounds i16, ptr %57, i64 %62
  store i16 %conv206, ptr %arrayidx214, align 2, !tbaa !13
  %next215 = getelementptr inbounds %struct.list2, ptr %lptr.1410, i64 0, i32 1
...
if.end217.loopexit:                               ; preds = %while.body203
  %63 = trunc i64 %indvars.iv.next447 to i32
  br label %for.body222.lr.ph

if.end217.loopexit423:                            ; preds = %if.then182
  %64 = trunc i64 %indvars.iv442 to i32
  br label %for.body222.lr.ph

if.end217.loopexit424:                            ; preds = %if.end183
  %65 = trunc i64 %indvars.iv.next443 to i32
  br label %for.body222.lr.ph

for.body222.lr.ph:                                ; preds = %if.else195, %if.then158, %if.end217.loopexit, %if.end217.loopexit423, %if.end217.loopexit424
  %count.2 = phi i32 [ 0, %if.else195 ], [ 1, %if.then158 ], [ %63, %if.end217.loopexit ], [ %64, %if.end217.loopexit423 ], [ %65, %if.end217.loopexit424 ]
  %add219 = add nsw i32 %count.2, 1
  %66 = load ptr, ptr @gnodeArray, align 8, !tbaa !11
  %smax453 = tail call i32 @llvm.smax.i32(i32 %add219, i32 1)
  %67 = add nuw i32 %smax453, 1
  %wide.trip.count454 = zext i32 %67 to i64
  br label %for.body222

for.body222:                                      ; preds = %for.body222.lr.ph, %for.inc246
  %indvars.iv450 = phi i64 [ 1, %for.body222.lr.ph ], [ %indvars.iv.next451, %for.inc246 ]
  %arrayidx224 = getelementptr inbounds i16, ptr %57, i64 %indvars.iv450
  %68 = load i16, ptr %arrayidx224, align 2, !tbaa !13
  %conv225 = sext i16 %68 to i32
  %idxprom226 = sext i16 %68 to i64
  %arrayidx227 = getelementptr inbounds ptr, ptr %66, i64 %idxprom226
  %gptr.0412 = load ptr, ptr %arrayidx227, align 8, !tbaa !11
  %cmp229.not413 = icmp eq ptr %gptr.0412, null
  br i1 %cmp229.not413, label %for.inc246, label %for.body231

for.body231:                                      ; preds = %for.body222, %if.then239
  %gptr.0414 = phi ptr [ %gptr.0, %if.then239 ], [ %gptr.0412, %for.body222 ]
  %69 = load i32, ptr %gptr.0414, align 8, !tbaa !36
  %idxprom233 = sext i32 %69 to i64
  %arrayidx234 = getelementptr inbounds ptr, ptr %66, i64 %idxprom233
...
for.cond235:                                      ; preds = %for.cond235, %for.body231
  ...
  %70 = load i32, ptr %gptr1.0, align 8, !tbaa !36
  %cmp237 = icmp eq i32 %70, %conv225
...
if.then239:                                       ; preds = %for.cond235
  ...
  %next244 = getelementptr inbounds %struct.gnode, ptr %gptr.0414, i64 0, i32 7
...
for.inc246:                                       ; preds = %if.then239, %for.body222
  ...
  %exitcond455 = icmp eq i64 %indvars.iv.next451, %wide.trip.count454
  br i1 %exitcond455, label %for.body255.lr.ph, label %for.body222, !llvm.loop !40
...
for.body255.lr.ph:                                ; preds = %for.inc246
  ...
  %71 = load ptr, ptr @addTargetList, align 8, !tbaa !11
  %72 = load ptr, ptr @gnodeArray, align 8, !tbaa !11
  %smax459 = tail call i32 @llvm.smax.i32(i32 %add219, i32 1)
  %73 = add nuw i32 %smax459, 1
  %wide.trip.count460 = zext i32 %73 to i64
  br label %for.body255

for.body255:                                      ; preds = %for.body255.lr.ph, %for.inc280
  %indvars.iv456 = phi i64 [ 1, %for.body255.lr.ph ], [ %indvars.iv.next457, %for.inc280 ]
  %arrayidx257 = getelementptr inbounds i16, ptr %71, i64 %indvars.iv456
  %74 = load i16, ptr %arrayidx257, align 2, !tbaa !13
  %conv258 = sext i16 %74 to i32
  %idxprom259 = sext i16 %74 to i64
  %arrayidx260 = getelementptr inbounds ptr, ptr %72, i64 %idxprom259
  %gptr.1418 = load ptr, ptr %arrayidx260, align 8, !tbaa !11
  %cmp262.not419 = icmp eq ptr %gptr.1418, null
  br i1 %cmp262.not419, label %for.inc280, label %for.body264

for.body264:                                      ; preds = %for.body255, %if.then272
  %gptr.1420 = phi ptr [ %gptr.1, %if.then272 ], [ %gptr.1418, %for.body255 ]
  %75 = load i32, ptr %gptr.1420, align 8, !tbaa !36
  %idxprom266 = sext i32 %75 to i64
  %arrayidx267 = getelementptr inbounds ptr, ptr %72, i64 %idxprom266
...
for.cond268:                                      ; preds = %for.cond268, %for.body264
  ...
  %76 = load i32, ptr %gptr1.1, align 8, !tbaa !36
  %cmp270 = icmp eq i32 %76, %conv258
...
if.then272:                                       ; preds = %for.cond268
  ...
  %next278 = getelementptr inbounds %struct.gnode, ptr %gptr.1420, i64 0, i32 7
...
for.inc280:                                       ; preds = %if.then272, %for.body255
  ...
  %77 = trunc i64 %indvars.iv.next457 to i32
  store i32 %77, ptr %i, align 4, !tbaa !5
  %exitcond461 = icmp eq i64 %indvars.iv.next457, %wide.trip.count460
  br i1 %exitcond461, label %for.end282, label %for.body255, !llvm.loop !42

for.end282:                                       ; preds = %for.inc280
  %78 = load ptr, ptr @indexRoot, align 8, !tbaa !11
  %cmp283.not = icmp eq ptr %78, null
...
for.cond286:                                      ; preds = %for.end282, %for.cond286
  ...
  %79 = load ptr, ptr %tptr, align 8, !tbaa !11
  %cmp287 = icmp eq ptr %79, null
  br i1 %cmp287, label %if.end292, label %for.cond286

if.end292:                                        ; preds = %for.cond286, %for.end282
  br i1 %or.cond297468, label %if.then295, label %if.end296
...
for.body.lr.ph:                                   ; preds = %if.then
  ...
  %min.iters.check1287 = icmp ult i64 %8, 16
...
for.body46.lr.ph:                                 ; preds = %for.end38
  ...
  %uglygep = getelementptr i8, ptr %call42, i64 2
  %uglygep1093 = getelementptr i8, ptr %29, i64 2
  %30 = zext i32 %dsptr to i64
  %31 = shl nuw nsw i64 %30, 1
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 2 %uglygep, ptr align 2 %uglygep1093, i64 %31, i1 false), !tbaa !13
  br label %for.end53
...
for.body63.lr.ph:                                 ; preds = %for.end53
  ...
  %uglygep1097 = getelementptr i8, ptr %call58, i64 2
  %uglygep1098 = getelementptr i8, ptr %32, i64 2
  %33 = add nsw i32 %add54, -1
  %34 = zext i32 %33 to i64
  %35 = shl nuw nsw i64 %34, 1
  %36 = add nuw nsw i64 %35, 2
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 2 dereferenceable(1) %uglygep1097, ptr noundef nonnull align 2 dereferenceable(1) %uglygep1098, i64 %36, i1 false), !tbaa !13
...
for.body103.lr.ph:                                ; preds = %for.cond99.preheader
  ...
  %40 = shl nsw i64 %39, 1
  %41 = add nsw i64 %40, 2
  %uglygep1112 = getelementptr i8, ptr %38, i64 %41
  %uglygep1113 = getelementptr i8, ptr %call58, i64 2
  %42 = add nsw i32 %add54, -1
  %43 = zext i32 %42 to i64
  %44 = shl nuw nsw i64 %43, 1
  %45 = add nuw nsw i64 %44, 2
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 2 dereferenceable(1) %uglygep1112, ptr noundef nonnull align 2 dereferenceable(1) %uglygep1113, i64 %45, i1 false), !tbaa !13
...
for.body81:                                       ; preds = %for.body81.preheader, %for.inc93
  %indvars.iv1102 = phi i64 [ 1, %for.body81.preheader ], [ %indvars.iv.next1103, %for.inc93 ]
...
if.then87:                                        ; preds = %for.body81
  %idxprom82.le = and i64 %indvars.iv1102, 4294967295
  %arrayidx83.le = getelementptr inbounds i16, ptr %37, i64 %idxprom82.le
...
for.inc96:                                        ; preds = %for.inc93, %for.body74, %if.then87
  %dec968 = phi i32 [ %dec, %if.then87 ], [ %dec969971, %for.body74 ], [ %dec969971, %for.inc93 ]
...
for.end321:                                       ; preds = %for.inc319, %for.body160, %if.end156
  ...
  %111 = load i32, ptr @Mpaths, align 4, !tbaa !5
...
for.body599.lr.ph:                                ; preds = %if.end595
  ...
  %uglygep1203 = getelementptr i8, ptr %187, i64 %190
  %uglygep1204 = getelementptr i8, ptr %call42, i64 2
  %191 = zext i32 %dsptr to i64
  %192 = shl nuw nsw i64 %191, 1
  call void @llvm.memcpy.p0.p0.i64(ptr align 2 %uglygep1203, ptr align 2 %uglygep1204, i64 %192, i1 false), !tbaa !13
