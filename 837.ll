; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/compiler/error.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/compiler/error.c"
...
if.end:                                           ; preds = %entry
  ...
  %.pre17 = load i32, ptr @lookahead, align 4, !tbaa !5
  br label %while.cond
...
if.then9:                                         ; preds = %while.body, %if.end7.thread
  ...
  %.pre = load i32, ptr @lookahead, align 4, !tbaa !5
