; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/preprocess.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/agrep/preprocess.c"
...
while.cond.preheader:                             ; preds = %if.end367
  ...
  %or.cond577593 = select i1 %cmp373.not591, i1 %cmp375592, i1 false
