; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Benchmarks/Stanford/Puzzle.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Benchmarks/Stanford/Puzzle.c"
...
Place.exit:                                       ; preds = %for.inc23.i, %for.end.i, %cleanup.loopexit.split.loop.exit49.i
  ...
  %call6 = tail call i32 @Trial(i32 noundef %retval.0.i34)
...
pred.store.continue74:                            ; preds = %pred.store.if73, %pred.store.continue72
  ...
  br i1 %87, label %middle.block, label %vector.body, !llvm.loop !22
...
for.inc.i47:                                      ; preds = %if.then.i44, %for.body.i42
  ...
  br i1 %exitcond.not.i46, label %Remove.exit, label %for.body.i42, !llvm.loop !23
...
vector.body:                                      ; preds = %vector.body, %entry
  ...
  br i1 %8, label %for.cond4.preheader.preheader, label %vector.body, !llvm.loop !25
...
if.end:                                           ; preds = %if.else, %Place.exit
  ...
  %call353 = tail call i32 @Trial(i32 noundef %36)
