; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/minisat/Main.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/minisat/Main.cpp"
...
entry:
  ...
  %call3.i.i = call ptr @fopen(ptr noundef nonnull %name.i.i, ptr noundef nonnull @.str.35)
...
if.end.i.i:                                       ; preds = %entry
  ...
  %call5.i.i = call i32 (ptr, ptr, ...) @fscanf(ptr noundef nonnull %call3.i.i, ptr noundef nonnull @.str.51, ptr noundef nonnull %value.i.i)
...
if.then26:                                        ; preds = %_Z9hasPrefixPKcS0_.exit356
  ...
  %call27 = call i32 (ptr, ptr, ...) @sscanf(ptr noundef nonnull %call3.i353, ptr noundef nonnull @.str.22, ptr noundef nonnull %rnd) #22
...
if.then46:                                        ; preds = %_Z9hasPrefixPKcS0_.exit366
  ...
  %call47 = call i32 (ptr, ptr, ...) @sscanf(ptr noundef nonnull %call3.i363, ptr noundef nonnull @.str.22, ptr noundef nonnull %decay) #22
...
if.then106:                                       ; preds = %if.else101
  ...
  %arrayidx.le = getelementptr inbounds ptr, ptr %argv, i64 %idxprom.le
  %17 = load ptr, ptr @stdout, align 8, !tbaa !5
...
cond.false:                                       ; preds = %for.end
  ...
  %call151 = call ptr @fopen(ptr noundef %33, ptr noundef nonnull @.str.35)
  br label %cond.end
...
cond.true183:                                     ; preds = %invoke.cont179
  ...
  %call187 = call ptr @fopen(ptr noundef %109, ptr noundef nonnull @.str.40)
...
invoke.cont211:                                   ; preds = %if.end209
  call void @_Z10printStatsR6Solver(ptr noundef nonnull align 8 dereferenceable(536) %S)
...
if.then225:                                       ; preds = %invoke.cont211
...
if.end266:                                        ; preds = %if.end263, %invoke.cont211
