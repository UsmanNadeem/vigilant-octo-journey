; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/term.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/term.c"
...
if.end27:                                         ; preds = %if.then24, %if.end20
  %2 = load i32, ptr @contextsize, align 4, !tbaa !10
...
while.cond90:                                     ; preds = %while.cond90, %if.then87
  ...
  %call.i = call i32 @_IO_getc(ptr noundef %18)
