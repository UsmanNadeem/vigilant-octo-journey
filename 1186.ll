; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Benchmarks/McGill/exptree.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Benchmarks/McGill/exptree.c"
...
while.cond:                                       ; preds = %while.body, %entry
  ...
  %call.i = call i32 @_IO_getc(ptr noundef %0)
...
while.end:                                        ; preds = %while.cond, %while.cond
  ...
  %i.0.op = add nsw i32 %3, -1
  %sub = select i1 %cmp8, i32 3, i32 %i.0.op
  ...
  %4 = load i32, ptr %arrayidx10, align 4, !tbaa !9
  store i32 %4, ptr @goal, align 4, !tbaa !9
...
if.else.i:                                        ; preds = %while.end
  ...
  %6 = call i64 @fwrite(ptr nonnull @.str, i64 28, i64 1, ptr %5) #14
...
if.else.i22:                                      ; preds = %newWorkList.exit
  ...
  %8 = call i64 @fwrite(ptr nonnull @.str.1, i64 35, i64 1, ptr %7) #14
  call void @exit(i32 noundef 1) #15
  unreachable
...
if.else.i26:                                      ; preds = %newCombList.exit
  ...
  %10 = call i64 @fwrite(ptr nonnull @.str.1, i64 35, i64 1, ptr %9) #14
  call void @exit(i32 noundef 1) #15
  unreachable
...
for.body.preheader.i29:                           ; preds = %newCombList.exit27
  ...
  %11 = shl nuw nsw i64 %wide.trip.count.i, 2
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %call.i18, ptr nonnull align 16 %nums, i64 %11, i1 false), !tbaa !9
  %xtraiter = and i64 %wide.trip.count.i, 3
  %12 = icmp ult i32 %sub, 4
  br i1 %12, label %for.body.i41.preheader.unr-lcssa, label %for.body.preheader.i29.new
...
for.body.i41.preheader:                           ; preds = %for.body.i33.epil, %for.body.i41.preheader.unr-lcssa
  ...
  br i1 %13, label %initCombList.exit42.loopexit.unr-lcssa, label %for.body.i41.preheader.new
...
; Function Attrs: nofree nounwind
declare noundef i32 @_IO_getc(ptr nocapture noundef) local_unnamed_addr #8
