; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/get_audio.c"
...
entry:
  ...
  %0 = load i8, ptr %inPath, align 1, !tbaa !18
...
if.then77:                                        ; preds = %entry
  %arrayidx79 = getelementptr inbounds i8, ptr %inPath, i64 1
  %1 = load i8, ptr %arrayidx79, align 1, !tbaa !18
...
cond.end115:                                      ; preds = %entry, %if.then77
  ...
  br i1 %tobool.not, label %if.then117, label %if.else

if.then117:                                       ; preds = %cond.end115
  %2 = load ptr, ptr @stdin, align 8, !tbaa !19
  store ptr %2, ptr @musicin, align 8, !tbaa !19
  br label %if.end124

if.else:                                          ; preds = %cond.end115
  %call118 = tail call ptr @fopen(ptr noundef nonnull %inPath, ptr noundef nonnull @.str.2)
  store ptr %call118, ptr @musicin, align 8, !tbaa !19
...
if.then121:                                       ; preds = %if.else
  ...
  %call122 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %3, ptr noundef nonnull @.str.3, ptr noundef nonnull %inPath) #13
  tail call void @exit(i32 noundef 1) #14
  unreachable

if.end124:                                        ; preds = %if.else, %if.then117
  %4 = phi ptr [ %call118, %if.else ], [ %2, %if.then117 ]
  ...
  %5 = load i32, ptr %input_format, align 8, !tbaa !20
  switch i32 %5, label %if.end139 [
    i32 3, label %if.then127
    i32 4, label %if.then143
  ]

if.then127:                                       ; preds = %if.end124
  %call128 = tail call i32 @lame_decode_initfile(ptr noundef %4, ptr noundef nonnull @num_channels, ptr noundef nonnull @samp_freq, ptr noundef nonnull @input_bitrate, ptr noundef nonnull @num_samples) #12
  %cmp129 = icmp eq i32 %call128, -1
  br i1 %cmp129, label %if.then131, label %if.end153

if.then131:                                       ; preds = %if.then127
  %6 = load ptr, ptr @stderr, align 8, !tbaa !19
  %call132 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %6, ptr noundef nonnull @.str.4, ptr noundef nonnull %inPath) #13
  tail call void @exit(i32 noundef 1) #14
  unreachable

if.end139:                                        ; preds = %if.end124
  tail call void @parse_file_header(ptr noundef nonnull %gfp, ptr noundef %4)
  %.pr = load i32, ptr %input_format, align 8, !tbaa !20
  %cmp141 = icmp eq i32 %.pr, 4
  br i1 %cmp141, label %if.then143, label %if.end153

if.then143:                                       ; preds = %if.end124, %if.end139
  %7 = load ptr, ptr @stderr, align 8, !tbaa !19
  %8 = tail call i64 @fwrite(ptr nonnull @.str.5, i64 27, i64 1, ptr %7) #13
  %swapbytes = getelementptr inbounds %struct.lame_global_flags, ptr %gfp, i64 0, i32 30
  %9 = load i32, ptr %swapbytes, align 4, !tbaa !21
  %cmp145 = icmp eq i32 %9, 1
  %10 = load ptr, ptr @stderr, align 8, !tbaa !19
  br i1 %cmp145, label %if.then147, label %if.else149

if.then147:                                       ; preds = %if.then143
  %11 = tail call i64 @fwrite(ptr nonnull @.str.6, i64 25, i64 1, ptr %10) #13
  br label %if.end153
...
if.end153:                                        ; preds = %if.end139, %if.else149, %if.then147, %if.then127
  %12 = load i64, ptr @num_samples, align 8, !tbaa !16
  %cmp154 = icmp eq i64 %12, 4294967295
  br i1 %cmp154, label %land.lhs.true156, label %if.end185

land.lhs.true156:                                 ; preds = %if.end153
  %13 = load ptr, ptr @musicin, align 8, !tbaa !19
  %14 = load ptr, ptr @stdin, align 8, !tbaa !19
  %cmp157.not = icmp eq ptr %13, %14
  br i1 %cmp157.not, label %if.end185, label %if.then159

if.then159:                                       ; preds = %land.lhs.true156
  %call.i = call i32 @__xstat(i32 noundef 1, ptr noundef nonnull %inPath, ptr noundef nonnull %sb) #12
  %cmp161 = icmp eq i32 %call.i, 0
  br i1 %cmp161, label %if.then163, label %if.end185

if.then163:                                       ; preds = %if.then159
  %15 = load i32, ptr %input_format, align 8, !tbaa !20
  %cmp165 = icmp eq i32 %15, 3
  %st_size = getelementptr inbounds %struct.stat, ptr %sb, i64 0, i32 8
  %16 = load i64, ptr %st_size, align 8, !tbaa !22
  br i1 %cmp165, label %if.then167, label %if.else177

if.then167:                                       ; preds = %if.then163
  %conv168 = sitofp i64 %16 to double
  %mul = fmul double %conv168, 8.000000e+00
  %17 = load i32, ptr @input_bitrate, align 4, !tbaa !15
  %conv170 = sitofp i32 %17 to double
  %mul171 = fmul double %conv170, 1.000000e+03
  %div = fdiv double %mul, %mul171
  %conv172 = fptrunc double %div to float
  %18 = load i32, ptr @samp_freq, align 4, !tbaa !15
  %conv174 = sitofp i32 %18 to float
  %mul175 = fmul float %conv174, %conv172
  %conv176 = fptoui float %mul175 to i64
  br label %if.end185.sink.split

if.else177:                                       ; preds = %if.then163
  %19 = load i32, ptr @num_channels, align 4, !tbaa !15
  %mul180 = shl nsw i32 %19, 1
  %conv181 = sext i32 %mul180 to i64
  %div182 = sdiv i64 %16, %conv181
  br label %if.end185.sink.split

if.end185.sink.split:                             ; preds = %if.then167, %if.else177
  %div182.sink = phi i64 [ %div182, %if.else177 ], [ %conv176, %if.then167 ]
  store i64 %div182.sink, ptr @num_samples, align 8, !tbaa !16
  br label %if.end185

if.end185:                                        ; preds = %if.end185.sink.split, %if.then159, %land.lhs.true156, %if.end153
  %20 = load ptr, ptr @musicin, align 8, !tbaa !19
...
entry:
  %0 = load ptr, ptr @musicin, align 8, !tbaa !19
...
if.then.i:                                        ; preds = %entry
  ...
  %2 = tail call i64 @fwrite(ptr nonnull @.str, i64 33, i64 1, ptr %1) #13
...
if.then9:                                         ; preds = %if.end
  ...
  store i64 %3, ptr %totalframes7, align 8, !tbaa !26
  br label %if.end12
...
if.then12:                                        ; preds = %if.end9
  %6 = load ptr, ptr @musicin, align 8, !tbaa !19
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x i16>, ptr %9, align 16, !tbaa !28
  %10 = getelementptr inbounds [1152 x i16], ptr %buffer, i64 0, i64 %index
  store <8 x i16> %wide.load, ptr %10, align 2, !tbaa !28
  %11 = getelementptr inbounds [1152 x i16], ptr %buffer, i64 1, i64 %index
  store <8 x i16> zeroinitializer, ptr %11, align 2, !tbaa !28
...
vector.body93:                                    ; preds = %vector.body93, %vector.ph88
  ...
  %wide.vec = load <8 x i16>, ptr %19, align 16, !tbaa !28
  ...
  store <4 x i16> %strided.vec, ptr %20, align 2, !tbaa !28
  %21 = getelementptr inbounds [1152 x i16], ptr %buffer, i64 1, i64 %index94
  store <4 x i16> %strided.vec95, ptr %21, align 2, !tbaa !28
  %index.next96 = add nuw i64 %index94, 4
  %22 = icmp eq i64 %index.next96, %n.vec90
  br i1 %22, label %middle.block85, label %vector.body93, !llvm.loop !34
...
if.then:                                          ; preds = %entry
  %3 = load ptr, ptr @stderr, align 8, !tbaa !19
  %4 = tail call i64 @fwrite(ptr nonnull @.str.8, i64 25, i64 1, ptr %3) #13
  tail call void @exit(i32 noundef 2) #14
  unreachable

if.end:                                           ; preds = %entry
  %5 = load i32, ptr @NativeByteOrder, align 4, !tbaa !18
  %cmp5 = icmp eq i32 %5, 0
  br i1 %cmp5, label %if.then7, label %if.end14

if.then7:                                         ; preds = %if.end
  %call8 = tail call i32 @DetermineByteOrder() #12
  store i32 %call8, ptr @NativeByteOrder, align 4, !tbaa !18
  %cmp9 = icmp eq i32 %call8, 0
  br i1 %cmp9, label %if.then11, label %if.end14

if.then11:                                        ; preds = %if.then7
  %6 = load ptr, ptr @stderr, align 8, !tbaa !19
  %7 = tail call i64 @fwrite(ptr nonnull @.str.9, i64 26, i64 1, ptr %6) #13
  tail call void @exit(i32 noundef 1) #14
  unreachable
...
for.inc.preheader:                                ; preds = %if.end29
  ...
  %uglygep = getelementptr i8, ptr %sample_buffer, i64 %11
  %12 = xor i32 %spec.store.select, -1
  %13 = add i32 %12, %frame_size
  %14 = zext i32 %13 to i64
  %15 = shl nuw nsw i64 %14, 1
  %16 = add nuw nsw i64 %15, 2
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 2 dereferenceable(1) %uglygep, i8 0, i64 %16, i1 false), !tbaa !28
  br label %if.end39
...
entry:
  ...
  %data.i101.i30 = alloca [1024 x i8], align 16
  %data.i.i31 = alloca [1024 x i8], align 16
  ...
  store i1 false, ptr @count_samples_carefully, align 4
  %input_format = getelementptr inbounds %struct.lame_global_flags, ptr %gfp, i64 0, i32 29
  store i32 4, ptr %input_format, align 8, !tbaa !20
...
for.body.i:                                       ; preds = %if.then, %for.inc.i
  ...
  %wave_info.sroa.7114.0146.i = phi i32 [ %wave_info.sroa.7114.1.i, %for.inc.i ], [ 0, %if.then ]
...
if.else46.i:                                      ; preds = %for.body.i
  ...
  %cmp8.i102.i = icmp sgt i32 %call47.i, 0
  br i1 %cmp8.i102.i, label %while.body.i108.i, label %fskip.exit111.i

while.body.i108.i:                                ; preds = %if.else46.i, %while.body.i108.i
  %num_bytes.addr.09.i103.i = phi i64 [ %sub.i106.i, %while.body.i108.i ], [ %conv48.i, %if.else46.i ]
...
fskip.exit111.i:                                  ; preds = %while.body.i108.i, %if.else46.i
  %num_bytes.addr.0.lcssa.i109.i = phi i64 [ %conv48.i, %if.else46.i ], [ %sub.i106.i, %while.body.i108.i ]
  call void @llvm.lifetime.end.p0(i64 1024, ptr nonnull %data.i101.i) #12
  %1 = and i64 %num_bytes.addr.0.lcssa.i109.i, 4294967295
  %cmp50.not.i = icmp eq i64 %1, 0
  br i1 %cmp50.not.i, label %for.inc.i, label %if.end12

for.inc.i:                                        ; preds = %fskip.exit111.i, %fskip.exit.i, %if.end14.i
  %wave_info.sroa.4.1.i = phi i16 [ %wave_info.sroa.4.0145.i, %fskip.exit111.i ], [ %conv18.i, %if.end14.i ], [ %conv18.i, %fskip.exit.i ]
  %wave_info.sroa.7114.1.i = phi i32 [ %wave_info.sroa.7114.0146.i, %fskip.exit111.i ], [ %call20.i, %if.end14.i ], [ %call20.i, %fskip.exit.i ]
  %wave_info.sroa.11.1.i = phi i16 [ %wave_info.sroa.11.0147.i, %fskip.exit111.i ], [ %conv30.i, %if.end14.i ], [ %conv30.i, %fskip.exit.i ]
...
if.then.i.i:                                      ; preds = %if.then56.i
  ...
  %call.i112.i = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %2, ptr noundef nonnull @.str.11, i32 noundef %conv.i.i) #13
  tail call void @exit(i32 noundef 1) #14
  unreachable

if.then2:                                         ; preds = %if.then56.i
  %conv58.i = zext i16 %wave_info.sroa.4.0145.i to i32
  store i32 %conv58.i, ptr @num_channels, align 4, !tbaa !15
  store i32 %wave_info.sroa.7114.0146.i, ptr @samp_freq, align 4, !tbaa !15
  ...
  store i32 1, ptr %input_format, align 8, !tbaa !20
  store i1 true, ptr @count_samples_carefully, align 4
  br label %if.end21

if.then5:                                         ; preds = %entry
  %call.i32 = tail call i32 @Read32BitsHighLow(ptr noundef %sf) #12
  %call1.i33 = tail call i32 @Read32BitsHighLow(ptr noundef %sf) #12
  %cmp.not.i34 = icmp eq i32 %call1.i33, 1095321158
  %cmp3160.i = icmp sgt i32 %call.i32, 0
  %or.cond.i = select i1 %cmp.not.i34, i1 %cmp3160.i, i1 false
  br i1 %or.cond.i, label %while.body.preheader.i, label %if.end12

while.body.preheader.i:                           ; preds = %if.then5
  %conv.i = zext i32 %call.i32 to i64
...
while.body.i:                                     ; preds = %cleanup.i, %while.body.preheader.i
  ...
  %call5.i35 = tail call i32 @Read32BitsHighLow(ptr noundef %sf) #12
  switch i32 %call5.i35, label %if.else49.i [
    i32 1129270605, label %if.then8.i39
    i32 1397968452, label %if.then31.i
  ]

if.then8.i39:                                     ; preds = %while.body.i
  %call9.i36 = tail call i32 @Read32BitsHighLow(ptr noundef %sf) #12
  %conv10.i37 = sext i32 %call9.i36 to i64
  %call12.i = tail call i32 @Read16BitsHighLow(ptr noundef %sf) #12
  %conv13.i = trunc i32 %call12.i to i16
  %call15.i38 = tail call i32 @Read32BitsHighLow(ptr noundef %sf) #12
  %conv16.i = sext i32 %call15.i38 to i64
  ...
  %sub23.i = add nsw i64 %conv10.i37, -18
  call void @llvm.lifetime.start.p0(i64 1024, ptr nonnull %data.i.i31) #12
  %cmp8.i.i = icmp sgt i32 %call9.i36, 18
  br i1 %cmp8.i.i, label %while.body.i.i45, label %fskip.exit.i46

while.body.i.i45:                                 ; preds = %if.then8.i39, %while.body.i.i45
  %num_bytes.addr.09.i.i40 = phi i64 [ %sub.i.i43, %while.body.i.i45 ], [ %sub23.i, %if.then8.i39 ]
  %cond.i.i41 = tail call i64 @llvm.smin.i64(i64 %num_bytes.addr.09.i.i40, i64 1024)
  %call.i.i42 = call i64 @fread(ptr noundef nonnull %data.i.i31, i64 noundef 1, i64 noundef %cond.i.i41, ptr noundef %sf)
  %sub.i.i43 = sub i64 %num_bytes.addr.09.i.i40, %call.i.i42
  %cmp.i.i44 = icmp sgt i64 %sub.i.i43, 0
  br i1 %cmp.i.i44, label %while.body.i.i45, label %fskip.exit.i46, !llvm.loop !37

fskip.exit.i46:                                   ; preds = %while.body.i.i45, %if.then8.i39
  %num_bytes.addr.0.lcssa.i.i = phi i64 [ %sub23.i, %if.then8.i39 ], [ %sub.i.i43, %while.body.i.i45 ]
  call void @llvm.lifetime.end.p0(i64 1024, ptr nonnull %data.i.i31) #12
...
if.then31.i:                                      ; preds = %while.body.i
  ...
  call void @llvm.lifetime.start.p0(i64 1024, ptr nonnull %data.i101.i30) #12
  %cmp8.i102.i47 = icmp sgt i32 %call35.i, 0
  br i1 %cmp8.i102.i47, label %while.body.i108.i53, label %fskip.exit111.i55

while.body.i108.i53:                              ; preds = %if.then31.i, %while.body.i108.i53
  %num_bytes.addr.09.i103.i48 = phi i64 [ %sub.i106.i51, %while.body.i108.i53 ], [ %conv36.i, %if.then31.i ]
  %cond.i104.i49 = tail call i64 @llvm.smin.i64(i64 %num_bytes.addr.09.i103.i48, i64 1024)
  %call.i105.i50 = call i64 @fread(ptr noundef nonnull %data.i101.i30, i64 noundef 1, i64 noundef %cond.i104.i49, ptr noundef %sf)
  %sub.i106.i51 = sub i64 %num_bytes.addr.09.i103.i48, %call.i105.i50
  %cmp.i107.i52 = icmp sgt i64 %sub.i106.i51, 0
  br i1 %cmp.i107.i52, label %while.body.i108.i53, label %fskip.exit111.i55, !llvm.loop !37

fskip.exit111.i55:                                ; preds = %while.body.i108.i53, %if.then31.i
  %num_bytes.addr.0.lcssa.i109.i54 = phi i64 [ %conv36.i, %if.then31.i ], [ %sub.i106.i51, %while.body.i108.i53 ]
  call void @llvm.lifetime.end.p0(i64 1024, ptr nonnull %data.i101.i30) #12
  %4 = and i64 %num_bytes.addr.0.lcssa.i109.i54, 4294967295
  %cmp45.not.i = icmp eq i64 %4, 0
  br i1 %cmp45.not.i, label %if.end.i.i, label %if.end12
...
cleanup.i:                                        ; preds = %fskip.exit122.i, %fskip.exit.i46
  %aiff_info.sroa.6125.1.i = phi i64 [ %aiff_info.sroa.6125.0161.i, %fskip.exit122.i ], [ %conv16.i, %fskip.exit.i46 ]
  %aiff_info.sroa.8.1.i = phi i16 [ %aiff_info.sroa.8.0162.i, %fskip.exit122.i ], [ %conv19.i, %fskip.exit.i46 ]
  %aiff_info.sroa.0.1.i = phi i16 [ %aiff_info.sroa.0.0163.i, %fskip.exit122.i ], [ %conv13.i, %fskip.exit.i46 ]
  %aiff_info.sroa.10126.1.i = phi float [ %aiff_info.sroa.10126.0164.i, %fskip.exit122.i ], [ %conv22.i, %fskip.exit.i46 ]
  %conv10.pn.i = phi i64 [ %conv51.i, %fskip.exit122.i ], [ %conv10.i37, %fskip.exit.i46 ]
  %chunkSize.1.i = sub i64 %sub.i, %conv10.pn.i
  %cmp3.i = icmp sgt i64 %chunkSize.1.i, 0
  br i1 %cmp3.i, label %while.body.i, label %if.end12

if.end.i.i:                                       ; preds = %fskip.exit111.i55
  %cmp1.not.i.i = icmp eq i16 %aiff_info.sroa.8.0162.i, 16
  br i1 %cmp1.not.i.i, label %if.end5.i.i, label %if.then3.i.i

if.then3.i.i:                                     ; preds = %if.end.i.i
  %6 = load ptr, ptr @stderr, align 8, !tbaa !19
  %call4.i.i = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %6, ptr noundef nonnull @.str.13, i32 noundef 16, ptr noundef nonnull @.str.10) #13
  tail call void @exit(i32 noundef 1) #14
  unreachable
...
if.then13.i.i:                                    ; preds = %if.end5.i.i
  %7 = load ptr, ptr @stderr, align 8, !tbaa !19
  %call14.i.i = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %7, ptr noundef nonnull @.str.14, ptr noundef nonnull @.str.10) #13
  tail call void @exit(i32 noundef 1) #14
  unreachable
...
if.then18.i.i:                                    ; preds = %if.end15.i.i
  ...
  %call19.i.i = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %8, ptr noundef nonnull @.str.15, i32 noundef 0, ptr noundef nonnull @.str.10) #13
  tail call void @exit(i32 noundef 1) #14
  unreachable

if.end20.i.i:                                     ; preds = %if.end15.i.i
  %cmp22.not.i.i = icmp eq i32 %call35.i, 0
  br i1 %cmp22.not.i.i, label %if.then8, label %if.then24.i.i

if.then24.i.i:                                    ; preds = %if.end20.i.i
  %9 = load ptr, ptr @stderr, align 8, !tbaa !19
  %call25.i.i = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %9, ptr noundef nonnull @.str.16, i32 noundef 0, ptr noundef nonnull @.str.10) #13
  tail call void @exit(i32 noundef 1) #14
  unreachable

if.then8:                                         ; preds = %if.end20.i.i
  ...
  store i32 2, ptr %input_format, align 8, !tbaa !20
  store i1 true, ptr @count_samples_carefully, align 4
  br label %if.end21

if.end12:                                         ; preds = %cleanup.i, %fskip.exit.i46, %fskip.exit122.i, %fskip.exit111.i, %fskip.exit.i, %if.then8.i, %for.inc.i, %fskip.exit111.i55, %if.then5, %if.then
  %.pr = load i32, ptr %input_format, align 8, !tbaa !20
...
declare i32 @__xstat(i32 noundef, ptr noundef, ptr noundef) local_unnamed_addr #8
...
attributes #7 = { nofree nounwind memory(read) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!21 = !{!6, !10, i64 124}
!22 = !{!23, !7, i64 48}
!23 = !{!"stat", !7, i64 0, !7, i64 8, !7, i64 16, !10, i64 24, !10, i64 28, !10, i64 32, !10, i64 36, !7, i64 40, !7, i64 48, !7, i64 56, !7, i64 64, !24, i64 72, !24, i64 88, !24, i64 104, !8, i64 120}
!24 = !{!"timespec", !7, i64 0, !7, i64 8}
!25 = !{!6, !7, i64 168}
!26 = !{!6, !7, i64 176}
!27 = !{!6, !10, i64 200}
!28 = !{!29, !29, i64 0}
...
!34 = distinct !{!34, !31, !32, !33}
!35 = distinct !{!35, !31, !33, !32}
