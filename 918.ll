; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Bullet/btBox2dBox2dCollisionAlgorithm.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Bullet/btBox2dBox2dCollisionAlgorithm.cpp"
...
if.end:                                           ; preds = %entry
  ...
  tail call void @_Z17b2CollidePolygonsP16btManifoldResultPK12btBox2dShapeRK11btTransformS3_S6_(ptr noundef nonnull %resultOut, ptr noundef %1, ptr noundef nonnull align 4 dereferenceable(64) %m_worldTransform.i, ptr noundef %2, ptr noundef nonnull align 4 dereferenceable(64) %m_worldTransform.i14)
  %m_ownManifold = getelementptr inbounds %class.btBox2dBox2dCollisionAlgorithm, ptr %this, i64 0, i32 1
...
return:                                           ; preds = %if.else.i, %if.then5.i, %if.then7, %if.end, %entry
  ret void
}
...
if.end4:                                          ; preds = %if.end
  ...
  %38 = load float, ptr %arrayidx19.i, align 4, !tbaa !35
  %arrayidx7.i.i.i.i = getelementptr inbounds [4 x float], ptr %arrayidx19.i, i64 0, i64 1
  %39 = load float, ptr %arrayidx7.i.i.i.i, align 4, !tbaa !35
  %arrayidx12.i.i.i.i = getelementptr inbounds [4 x float], ptr %arrayidx19.i, i64 0, i64 2
  %40 = load float, ptr %arrayidx12.i.i.i.i, align 4, !tbaa !35
  %41 = insertelement <2 x float> poison, float %xf2.sroa.6.0, i64 0
  %42 = insertelement <2 x float> %41, float %xf2.sroa.14.0, i64 1
  %43 = insertelement <2 x float> poison, float %39, i64 0
  %44 = shufflevector <2 x float> %43, <2 x float> poison, <2 x i32> zeroinitializer
  %45 = fmul <2 x float> %42, %44
  %46 = insertelement <2 x float> poison, float %xf2.sroa.0.0, i64 0
  %47 = insertelement <2 x float> %46, float %xf2.sroa.10449.0, i64 1
  ...
  %51 = insertelement <2 x float> poison, float %xf2.sroa.8.0, i64 0
  %52 = insertelement <2 x float> %51, float %xf2.sroa.16.0, i64 1
  ...
  %56 = fadd <2 x float> %22, %55
  %mul8.i29.i.i.i = fmul float %xf2.sroa.22.0, %39
  %57 = tail call float @llvm.fmuladd.f32(float %xf2.sroa.18457.0, float %38, float %mul8.i29.i.i.i)
  %58 = tail call float @llvm.fmuladd.f32(float %xf2.sroa.24.0, float %40, float %57)
  %add17.i.i.i = fadd float %xf2.sroa.32.0, %58
  %retval.sroa.3.12.vec.insert.i.i.i = insertelement <2 x float> <float poison, float 0.000000e+00>, float %add17.i.i.i, i64 0
  store <2 x float> %56, ptr %incidentEdge, align 16, !tbaa.struct !36
  store <2 x float> %retval.sroa.3.12.vec.insert.i.i.i, ptr %ref.tmp17.sroa.4.0.v.sroa_idx.i, align 8, !tbaa.struct !38
  %59 = zext i32 %add.i to i64
  %idxprom24.i = select i1 %cmp14.3.i, i64 0, i64 %59
  ...
  %65 = fmul <2 x float> %42, %64
  %66 = insertelement <2 x float> poison, float %60, i64 0
  %67 = shufflevector <2 x float> %66, <2 x float> poison, <2 x i32> zeroinitializer
  %68 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %47, <2 x float> %67, <2 x float> %65)
  %69 = insertelement <2 x float> poison, float %62, i64 0
  %70 = shufflevector <2 x float> %69, <2 x float> poison, <2 x i32> zeroinitializer
  %71 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %52, <2 x float> %70, <2 x float> %68)
  ...
  %sub.i = extractelement <2 x float> %75, i64 0
  ...
  %v12.sroa.12.8.vec.extract = extractelement <2 x float> %v12.sroa.12.0.copyload, i64 0
  %v11.sroa.14.8.vec.extract = extractelement <2 x float> %v11.sroa.14.0.copyload, i64 0
  %76 = fsub <2 x float> %v12.sroa.12.0.copyload, %v11.sroa.14.0.copyload
  %sub14.i = extractelement <2 x float> %76, i64 0
  %mul8.i.i193 = fmul float %xf1.sroa.8.0, %sub8.i
  %77 = tail call float @llvm.fmuladd.f32(float %xf1.sroa.0.0, float %sub.i, float %mul8.i.i193)
  %78 = tail call float @llvm.fmuladd.f32(float %xf1.sroa.12.0, float %sub14.i, float %77)
  %mul8.i14.i = fmul float %xf1.sroa.22.0, %sub8.i
  %79 = tail call float @llvm.fmuladd.f32(float %xf1.sroa.16486.0, float %sub.i, float %mul8.i14.i)
  %80 = tail call float @llvm.fmuladd.f32(float %xf1.sroa.26.0, float %sub14.i, float %79)
  %mul8.i20.i = fmul float %xf1.sroa.36.0, %sub8.i
  %81 = tail call float @llvm.fmuladd.f32(float %xf1.sroa.30500.0, float %sub.i, float %mul8.i20.i)
  %82 = tail call float @llvm.fmuladd.f32(float %xf1.sroa.40.0, float %sub14.i, float %81)
  ...
  %mul8.i.i.i206 = fmul float %xf1.sroa.8.0, %v11.sroa.0.4.vec.extract
  %85 = tail call float @llvm.fmuladd.f32(float %xf1.sroa.0.0, float %v11.sroa.0.0.vec.extract, float %mul8.i.i.i206)
  %86 = tail call float @llvm.fmuladd.f32(float %xf1.sroa.12.0, float %v11.sroa.14.8.vec.extract, float %85)
  %add.i.i = fadd float %xf1.sroa.44514.0, %86
  %mul8.i22.i.i = fmul float %xf1.sroa.22.0, %v11.sroa.0.4.vec.extract
  %87 = tail call float @llvm.fmuladd.f32(float %xf1.sroa.16486.0, float %v11.sroa.0.0.vec.extract, float %mul8.i22.i.i)
  %88 = tail call float @llvm.fmuladd.f32(float %xf1.sroa.26.0, float %v11.sroa.14.8.vec.extract, float %87)
  %add10.i.i = fadd float %xf1.sroa.48.0, %88
  %mul8.i29.i.i = fmul float %xf1.sroa.36.0, %v11.sroa.0.4.vec.extract
  %89 = tail call float @llvm.fmuladd.f32(float %xf1.sroa.30500.0, float %v11.sroa.0.0.vec.extract, float %mul8.i29.i.i)
  %90 = tail call float @llvm.fmuladd.f32(float %xf1.sroa.40.0, float %v11.sroa.14.8.vec.extract, float %89)
  %mul8.i.i.i213 = fmul float %xf1.sroa.8.0, %v12.sroa.0.4.vec.extract
  %91 = tail call float @llvm.fmuladd.f32(float %xf1.sroa.0.0, float %v12.sroa.0.0.vec.extract, float %mul8.i.i.i213)
  %92 = tail call float @llvm.fmuladd.f32(float %xf1.sroa.12.0, float %v12.sroa.12.8.vec.extract, float %91)
  %add.i.i217 = fadd float %xf1.sroa.44514.0, %92
  %mul8.i22.i.i220 = fmul float %xf1.sroa.22.0, %v12.sroa.0.4.vec.extract
  %93 = tail call float @llvm.fmuladd.f32(float %xf1.sroa.16486.0, float %v12.sroa.0.0.vec.extract, float %mul8.i22.i.i220)
  %94 = tail call float @llvm.fmuladd.f32(float %xf1.sroa.26.0, float %v12.sroa.12.8.vec.extract, float %93)
  %add10.i.i223 = fadd float %xf1.sroa.48.0, %94
  %mul8.i29.i.i226 = fmul float %xf1.sroa.36.0, %v12.sroa.0.4.vec.extract
  %95 = tail call float @llvm.fmuladd.f32(float %xf1.sroa.30500.0, float %v12.sroa.0.0.vec.extract, float %mul8.i29.i.i226)
  %96 = tail call float @llvm.fmuladd.f32(float %xf1.sroa.40.0, float %v12.sroa.12.8.vec.extract, float %95)
  ...
  %109 = insertelement <2 x float> poison, float %add.i.i, i64 0
  %110 = shufflevector <2 x float> %109, <2 x float> %102, <2 x i32> <i32 0, i32 2>
  ...
  %shift = shufflevector <2 x float> %116, <2 x float> poison, <2 x i32> <i32 1, i32 undef>
...
entry:
  ...
  %1 = shufflevector <4 x float> %0, <4 x float> poison, <2 x i32> <i32 0, i32 undef>
  %2 = load <4 x float>, ptr %arrayidx5.i27.i.i, align 4
  %3 = shufflevector <4 x float> %2, <4 x float> poison, <2 x i32> <i32 0, i32 undef>
  %4 = load <4 x float>, ptr %arrayidx10.i30.i.i, align 4
  %5 = shufflevector <4 x float> %4, <4 x float> poison, <2 x i32> <i32 0, i32 undef>
  ...
  %shift = shufflevector <2 x float> %49, <2 x float> poison, <2 x i32> <i32 1, i32 undef>
  %72 = fsub <2 x float> %49, %shift
  %sub.i = extractelement <2 x float> %72, i64 0
  %shift216 = shufflevector <2 x float> %58, <2 x float> poison, <2 x i32> <i32 1, i32 undef>
  %73 = fsub <2 x float> %58, %shift216
  %sub8.i = extractelement <2 x float> %73, i64 0
  %shift217 = shufflevector <2 x float> %71, <2 x float> poison, <2 x i32> <i32 1, i32 undef>
  ...
  %call16 = tail call fastcc noundef float @_ZL14EdgeSeparationPK12btBox2dShapeRK11btTransformiS1_S4_(ptr noundef nonnull %poly1, ptr noundef nonnull align 4 dereferenceable(64) %xf1, i32 noundef %edge.1.3, ptr noundef nonnull %poly2, ptr noundef nonnull align 4 dereferenceable(64) %xf2)
...
for.cond45.us:                                    ; preds = %if.end36, %if.end68.us
  ...
  %call65.us = tail call fastcc noundef float @_ZL14EdgeSeparationPK12btBox2dShapeRK11btTransformiS1_S4_(ptr noundef nonnull %poly1, ptr noundef nonnull align 4 dereferenceable(64) %xf1, i32 noundef %cond55.us, ptr noundef nonnull %poly2, ptr noundef nonnull align 4 dereferenceable(64) %xf2)
...
for.cond45:                                       ; preds = %if.else, %if.end68
  ...
  %call65 = tail call fastcc noundef float @_ZL14EdgeSeparationPK12btBox2dShapeRK11btTransformiS1_S4_(ptr noundef nonnull %poly1, ptr noundef nonnull align 4 dereferenceable(64) %xf1, i32 noundef %cond63, ptr noundef nonnull %poly2, ptr noundef nonnull align 4 dereferenceable(64) %xf2)
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i.new
  ...
  %7 = load ptr, ptr %arrayidx3.i.i.i, align 8, !tbaa !47
  store ptr %7, ptr %arrayidx.i.i.i, align 8, !tbaa !47
  ...
  %9 = load ptr, ptr %arrayidx3.i.i.i.1, align 8, !tbaa !47
  store ptr %9, ptr %arrayidx.i.i.i.1, align 8, !tbaa !47
  ...
  %11 = load ptr, ptr %arrayidx3.i.i.i.2, align 8, !tbaa !47
  store ptr %11, ptr %arrayidx.i.i.i.2, align 8, !tbaa !47
  ...
  %13 = load ptr, ptr %arrayidx3.i.i.i.3, align 8, !tbaa !47
  store ptr %13, ptr %arrayidx.i.i.i.3, align 8, !tbaa !47
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil
  ...
  %15 = load ptr, ptr %arrayidx3.i.i.i.epil, align 8, !tbaa !47
  store ptr %15, ptr %arrayidx.i.i.i.epil, align 8, !tbaa !47
...
_ZN20btAlignedObjectArrayIP20btPersistentManifoldE10deallocateEv.exit.i.i: ; preds = %if.then3.i.i.i, %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i
  ...
  %.pre = load ptr, ptr %m_manifoldPtr, align 8, !tbaa !47
...
_ZN20btAlignedObjectArrayIP20btPersistentManifoldE9push_backERKS1_.exit: ; preds = %if.then, %if.then.i, %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE10deallocateEv.exit.i.i
  ...
  store ptr %18, ptr %arrayidx.i, align 8, !tbaa !47
...
entry:
  ...
  %20 = load float, ptr %arrayidx6.i, align 4, !tbaa !35, !noalias !51
  %21 = load float, ptr %arrayidx.i27.i, align 4, !tbaa !35, !noalias !51
  %22 = load float, ptr %arrayidx.i30.i, align 4, !tbaa !35, !noalias !51
  ...
  %29 = load float, ptr %xf2, align 4, !tbaa !35, !noalias !51
  %30 = load float, ptr %arrayidx.i.i38, align 4, !tbaa !35, !noalias !51
  %31 = load float, ptr %arrayidx.i28.i, align 4, !tbaa !35, !noalias !51
  ...
  %47 = load float, ptr %arrayidx3.i, align 4, !tbaa !35, !noalias !51
  %48 = load float, ptr %arrayidx.i26.i, align 4, !tbaa !35, !noalias !51
  %49 = load float, ptr %arrayidx.i29.i, align 4, !tbaa !35, !noalias !51
  ...
  %64 = tail call float @llvm.fmuladd.f32(float %12, float %55, float %mul8.i91.3)
  %65 = tail call float @llvm.fmuladd.f32(float %14, float %57, float %64)
  %cmp13.3 = fcmp olt float %65, %minDot.1.2
  %66 = load float, ptr %arrayidx15, align 4, !tbaa !35
  %67 = load float, ptr %arrayidx7.i.i.i, align 4, !tbaa !35
  %68 = load float, ptr %arrayidx12.i.i.i, align 4, !tbaa !35
  %69 = zext i1 %cmp13.1 to i64
  %70 = select i1 %cmp13.2, i64 2, i64 %69
  %idxprom18 = select i1 %cmp13.3, i64 3, i64 %70
  ...
  %shift104 = shufflevector <2 x float> %95, <2 x float> poison, <2 x i32> <i32 1, i32 undef>
  %110 = fsub <2 x float> %95, %shift104
  %sub8.i = extractelement <2 x float> %110, i64 0
  %shift105 = shufflevector <2 x float> %108, <2 x float> poison, <2 x i32> <i32 1, i32 undef>
...
attributes #7 = { nofree nosync nounwind memory(argmem: readwrite, inaccessiblemem: readwrite) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #8 = { mustprogress nocallback nofree nosync nounwind speculatable willreturn memory(none) }
attributes #9 = { mustprogress nocallback nofree nounwind willreturn memory(argmem: readwrite) }
attributes #10 = { nofree nosync nounwind memory(argmem: read, inaccessiblemem: readwrite) uwtable "min-legal-vector-width"="64" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
