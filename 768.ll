; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/cfrac.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/cfrac.c"
...
if.then:                                          ; preds = %for.body
  ...
  %call7 = call i32 @_IO_putc(i32 noundef 10, ptr noundef %5)
  br label %if.end
...
while.body.us:                                    ; preds = %while.body.lr.ph, %while.body.us
  ...
  %call1.i.us = call ptr @pmul(ptr noundef %call.i.us, ptr noundef %n) #10
...
if.end24:                                         ; preds = %if.end18
  %incdec.ptr15 = getelementptr inbounds ptr, ptr %incdec.ptr, i64 1
...
if.then45:                                        ; preds = %if.end39
  %24 = load ptr, ptr @stdout, align 8, !tbaa !5
  %call46 = call i32 @_IO_putc(i32 noundef 10, ptr noundef %24)
  %25 = load ptr, ptr @stdout, align 8, !tbaa !5
...
if.end63:                                         ; preds = %if.end53
  ...
  %call62 = call i32 @_IO_putc(i32 noundef 10, ptr noundef %50)
