; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr68328.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr68328.c"
...
entry:
  ...
  %.pre22 = load i32, ptr @c, align 4, !tbaa !7
  %.pre24 = load i32, ptr @d, align 4
  %.pre26 = load i32, ptr @a, align 4, !tbaa !7
  br label %for.cond

for.cond:                                         ; preds = %if.end15, %entry
  %0 = phi i32 [ %.pre26, %entry ], [ %5, %if.end15 ]
  %1 = phi i32 [ %.pre24, %entry ], [ %6, %if.end15 ]
  %2 = phi i32 [ %.pre22, %entry ], [ %7, %if.end15 ]
  ...
  %3 = xor i8 %h.1, 1
  %4 = add i8 %3, -120
  %cmp1021 = icmp sgt i8 %4, 97
  %cmp10 = select i1 %cmp, i1 %cmp1021, i1 false
...
if.end15:                                         ; preds = %if.then14, %for.cond
  %5 = phi i32 [ %.pre25, %if.then14 ], [ %0, %for.cond ]
  %6 = phi i32 [ %.pre23, %if.then14 ], [ %1, %for.cond ]
...
entry:
  ...
  %.pre22.i = load i32, ptr @c, align 4, !tbaa !7
  %.pre24.i = load i32, ptr @d, align 4
  %.pre26.i = load i32, ptr @a, align 4, !tbaa !7
  br label %for.cond.i

for.cond.i:                                       ; preds = %if.end15.i, %entry
  %0 = phi i32 [ %.pre26.i, %entry ], [ %5, %if.end15.i ]
  %1 = phi i32 [ %.pre24.i, %entry ], [ %6, %if.end15.i ]
  %2 = phi i32 [ %.pre22.i, %entry ], [ %7, %if.end15.i ]
  ...
  %3 = xor i8 %h.1.i, 1
  %4 = add i8 %3, -120
  %cmp1021.i = icmp sgt i8 %4, 97
  %cmp10.i = select i1 %cmp.i, i1 %cmp1021.i, i1 false
...
if.end15.i:                                       ; preds = %if.then14.i, %for.cond.i
  %5 = phi i32 [ %.pre25.i, %if.then14.i ], [ %0, %for.cond.i ]
  %6 = phi i32 [ %.pre23.i, %if.then14.i ], [ %1, %for.cond.i ]
