; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/Bitcode/Regression/fft/modules/FftConvolve64x64xCHalide_x86_64_linux_avx_c_plus_plus_name_mangling_no_runtime_sse41.bc'
...
@str.15 = private constant [85 x i8] c"FftConvolve64x64xCHalide_x86_64_linux_avx_c_plus_plus_name_mangling_no_runtime_sse41\00", align 32
@_Z93FftConvolve64x64xCHalide_x86_64_linux_avx_c_plus_plus_name_mangling_no_runtime_sse41_metadatav_storage = private constant %struct.halide_filter_metadata_t { i32 0, i32 3, ptr @0, ptr @str.14, ptr @str.15 }
...
define i32 @_Z84FftConvolve64x64xCHalide_x86_64_linux_avx_c_plus_plus_name_mangling_no_runtime_sse41P15halide_buffer_tS0_S0_(ptr noalias %input.buffer, ptr noalias %kernel.buffer, ptr noalias %"result$1.buffer") local_unnamed_addr #1 {
entry:
  %"inv_fft1_S8_R8_n1$1.014" = alloca [4096 x float], align 32
  %"inv_exchange_S1_R8_n1$1.115" = alloca [512 x float], align 32
  %"inv_exchange_S1_R8_n1$1.016" = alloca [512 x float], align 32
  %0 = alloca %closure_t, align 8
  %"inv_X8$7.123" = alloca [4096 x float], align 32
  %"inv_X8$7.024" = alloca [4096 x float], align 32
...
"assert succeeded4":                              ; preds = %"assert succeeded2"
  ...
  %59 = getelementptr inbounds %struct.halide_buffer_t, ptr %"result$1.buffer", i64 0, i32 2
  %60 = load ptr, ptr %59, align 8, !tbaa !6
  %61 = getelementptr inbounds %struct.halide_buffer_t, ptr %"result$1.buffer", i64 0, i32 4, i32 0
  %62 = load i8, ptr %61, align 8, !tbaa !15
  %63 = getelementptr inbounds %struct.halide_buffer_t, ptr %"result$1.buffer", i64 0, i32 4, i32 1
  %64 = load i8, ptr %63, align 1, !tbaa !16
  %65 = getelementptr inbounds %struct.halide_buffer_t, ptr %"result$1.buffer", i64 0, i32 4, i32 2
  %66 = load i16, ptr %65, align 2, !tbaa !17
  %67 = getelementptr inbounds %struct.halide_buffer_t, ptr %"result$1.buffer", i64 0, i32 6
  ...
  %b15 = add nsw i32 %89, -1
  %90 = tail call i32 @llvm.smin.i32(i32 %b15, i32 %a14)
  %b16 = add nsw i32 %89, -8
  %91 = tail call i32 @llvm.smin.i32(i32 %b16, i32 %69)
  %"result$1.extent.0.required.s" = sub nsw i32 %90, %91
...
_halide_buffer_is_bounds_query.exit70:            ; preds = %after_bb7
  %112 = load i64, ptr %"result$1.buffer", align 8, !tbaa !23
...
true_bb8:                                         ; preds = %_halide_buffer_is_bounds_query.exit70
  ...
  %115 = add nsw i32 %"result$1.extent.0.required.s", 1
  ...
  %117 = getelementptr inbounds %struct.halide_buffer_t, ptr %"result$1.buffer", i64 0, i32 5
  ...
  %122 = getelementptr inbounds %struct.halide_buffer_t, ptr %"result$1.buffer", i64 0, i32 3
...
138:                                              ; preds = %_halide_buffer_is_bounds_query.exit74
  %139 = load i64, ptr %"result$1.buffer", align 8, !tbaa !23
...
"assert failed40":                                ; preds = %"assert succeeded39"
  %211 = tail call i32 @halide_error_access_out_of_bounds(ptr null, ptr nonnull @str.6, i32 0, i32 %91, i32 %90, i32 %69, i32 %b15) #8
  br label %call_destructor.exit62.thread918
...
"assert succeeded53":                             ; preds = %"assert succeeded51"
  ...
  %"result$1.total_extent.1" = mul nuw nsw i64 %226, %227
  %228 = sext i32 %31 to i64
  %x18 = mul nsw i64 %228, %222
  %229 = tail call i64 @llvm.abs.i64(i64 %x18, i1 true)
...
"assert succeeded59":                             ; preds = %"assert succeeded57"
  ...
  %x20 = mul nsw i64 %235, %234
  %236 = tail call i64 @llvm.abs.i64(i64 %x20, i1 true)
...
"assert succeeded65":                             ; preds = %"assert succeeded61"
  ...
  %x24 = mul nsw i64 %242, %224
  %243 = tail call i64 @llvm.abs.i64(i64 %x24, i1 true)
...
"assert succeeded71":                             ; preds = %"assert succeeded67"
  ...
  %x28 = mul nsw i64 %248, %226
  %249 = tail call i64 @llvm.abs.i64(i64 %x28, i1 true)
...
"assert succeeded73":                             ; preds = %"assert succeeded71"
  %252 = icmp ult i64 %"result$1.total_extent.1", 2147483648
  br i1 %252, label %"assert succeeded75", label %"assert failed74", !prof !26

"assert failed74":                                ; preds = %"assert succeeded73"
  %253 = tail call i32 @halide_error_buffer_extents_too_large(ptr null, ptr nonnull @str, i64 %"result$1.total_extent.1", i64 2147483647) #8
  br label %call_destructor.exit62.thread918

"assert succeeded75":                             ; preds = %"assert succeeded73"
  %254 = zext i32 %83 to i64
  %255 = sext i32 %85 to i64
  %x30 = mul nsw i64 %255, %254
  %256 = tail call i64 @llvm.abs.i64(i64 %x30, i1 true)
...
"assert succeeded77":                             ; preds = %"assert succeeded75"
  %259 = mul nuw nsw i64 %"result$1.total_extent.1", %254
  %260 = icmp ult i64 %259, 2147483648
  br i1 %260, label %"produce f5", label %"assert failed78", !prof !26
...
"produce f5":                                     ; preds = %"assert succeeded77"
  ...
  %262 = getelementptr inbounds float, ptr %f5.032, i64 4
  %263 = getelementptr inbounds float, ptr %f5.131, i64 4
  %264 = getelementptr inbounds float, ptr %f5.032, i64 5
  %265 = getelementptr inbounds float, ptr %f5.131, i64 5
  %266 = getelementptr inbounds float, ptr %f5.032, i64 7
  ...
  %267 = getelementptr inbounds float, ptr %f5.131, i64 7
  ...
  %268 = getelementptr inbounds float, ptr %f5.032, i64 8
  %269 = getelementptr inbounds float, ptr %f5.131, i64 8
  %270 = getelementptr inbounds float, ptr %f5.032, i64 10
  %271 = getelementptr inbounds float, ptr %f5.131, i64 10
  ...
  %272 = getelementptr inbounds float, ptr %f5.032, i64 12
  %273 = getelementptr inbounds float, ptr %f5.131, i64 12
  %274 = getelementptr inbounds float, ptr %f5.032, i64 14
  %275 = getelementptr inbounds float, ptr %f5.131, i64 14
  ...
  %276 = getelementptr inbounds float, ptr %f5.032, i64 16
  %277 = getelementptr inbounds float, ptr %f5.131, i64 16
  %278 = getelementptr inbounds float, ptr %f5.032, i64 18
  %279 = getelementptr inbounds float, ptr %f5.131, i64 18
  ...
  %280 = getelementptr inbounds float, ptr %f5.032, i64 20
  %281 = getelementptr inbounds float, ptr %f5.131, i64 20
  %282 = getelementptr inbounds float, ptr %f5.032, i64 21
  %283 = getelementptr inbounds float, ptr %f5.131, i64 21
  ...
  %284 = getelementptr inbounds float, ptr %f5.032, i64 24
  %285 = getelementptr inbounds float, ptr %f5.131, i64 24
  %286 = getelementptr inbounds float, ptr %f5.032, i64 25
  %287 = getelementptr inbounds float, ptr %f5.131, i64 25
  ...
  %288 = getelementptr inbounds float, ptr %f5.032, i64 28
  %289 = getelementptr inbounds float, ptr %f5.131, i64 28
  %290 = getelementptr inbounds float, ptr %f5.032, i64 30
  %291 = getelementptr inbounds float, ptr %f5.131, i64 30
  ...
  %292 = getelementptr inbounds float, ptr %f5.032, i64 32
  %293 = getelementptr inbounds float, ptr %f5.131, i64 32
  %294 = getelementptr inbounds float, ptr %f5.032, i64 35
  ...
  %295 = getelementptr inbounds float, ptr %f5.131, i64 35
  ...
  %296 = getelementptr inbounds float, ptr %f5.032, i64 36
  %297 = getelementptr inbounds float, ptr %f5.131, i64 36
  ...
  %298 = getelementptr inbounds float, ptr %f5.032, i64 40
  %299 = getelementptr inbounds float, ptr %f5.131, i64 40
  %300 = getelementptr inbounds float, ptr %f5.032, i64 42
  %301 = getelementptr inbounds float, ptr %f5.131, i64 42
  ...
  %302 = getelementptr inbounds float, ptr %f5.032, i64 44
  %303 = getelementptr inbounds float, ptr %f5.131, i64 44
  ...
  %304 = getelementptr inbounds float, ptr %f5.032, i64 48
  %305 = getelementptr inbounds float, ptr %f5.131, i64 48
  %306 = getelementptr inbounds float, ptr %f5.032, i64 49
  store <2 x float> <float 0x3E499BC5C0000000, float 0x3FB917ABA0000000>, ptr %304, align 32, !tbaa !110
  %307 = getelementptr inbounds float, ptr %f5.131, i64 49
  ...
  %308 = getelementptr inbounds float, ptr %f3.030, i64 4
  %309 = getelementptr inbounds float, ptr %f3.129, i64 4
  %310 = getelementptr inbounds float, ptr %f3.030, i64 5
  %311 = getelementptr inbounds float, ptr %f3.129, i64 5
  %312 = getelementptr inbounds float, ptr %f3.030, i64 7
  ...
  %313 = getelementptr inbounds float, ptr %f3.129, i64 7
  ...
  %314 = getelementptr inbounds float, ptr %f3.030, i64 8
  %315 = getelementptr inbounds float, ptr %f3.129, i64 8
  %316 = getelementptr inbounds float, ptr %f3.030, i64 10
  %317 = getelementptr inbounds float, ptr %f3.129, i64 10
  ...
  %318 = getelementptr inbounds float, ptr %f3.030, i64 12
  %319 = getelementptr inbounds float, ptr %f3.129, i64 12
  %320 = getelementptr inbounds float, ptr %f3.030, i64 14
  %321 = getelementptr inbounds float, ptr %f3.129, i64 14
  ...
  %322 = getelementptr inbounds float, ptr %f3.030, i64 16
  %323 = getelementptr inbounds float, ptr %f3.129, i64 16
  %324 = getelementptr inbounds float, ptr %f3.030, i64 18
  %325 = getelementptr inbounds float, ptr %f3.129, i64 18
  ...
  %326 = getelementptr inbounds float, ptr %f3.030, i64 20
  %327 = getelementptr inbounds float, ptr %f3.129, i64 20
  %328 = getelementptr inbounds float, ptr %f3.030, i64 21
  %329 = getelementptr inbounds float, ptr %f3.129, i64 21
  ...
  %330 = getelementptr inbounds float, ptr %f3.030, i64 24
  %331 = getelementptr inbounds float, ptr %f3.129, i64 24
  %332 = getelementptr inbounds float, ptr %f3.030, i64 25
  %333 = getelementptr inbounds float, ptr %f3.129, i64 25
  ...
  %334 = getelementptr inbounds float, ptr %f3.030, i64 28
  %335 = getelementptr inbounds float, ptr %f3.129, i64 28
  %336 = getelementptr inbounds float, ptr %f3.030, i64 30
  %337 = getelementptr inbounds float, ptr %f3.129, i64 30
  ...
  %338 = getelementptr inbounds float, ptr %f3.030, i64 32
  %339 = getelementptr inbounds float, ptr %f3.129, i64 32
  %340 = getelementptr inbounds float, ptr %f3.030, i64 35
  ...
  %341 = getelementptr inbounds float, ptr %f3.129, i64 35
  ...
  %342 = getelementptr inbounds float, ptr %f3.030, i64 36
  %343 = getelementptr inbounds float, ptr %f3.129, i64 36
  ...
  %344 = getelementptr inbounds float, ptr %f3.030, i64 40
  %345 = getelementptr inbounds float, ptr %f3.129, i64 40
  %346 = getelementptr inbounds float, ptr %f3.030, i64 42
  %347 = getelementptr inbounds float, ptr %f3.129, i64 42
  ...
  %348 = getelementptr inbounds float, ptr %f3.030, i64 44
  %349 = getelementptr inbounds float, ptr %f3.129, i64 44
  ...
  %350 = getelementptr inbounds float, ptr %f3.030, i64 48
  %351 = getelementptr inbounds float, ptr %f3.129, i64 48
  %352 = getelementptr inbounds float, ptr %f3.030, i64 49
  store <2 x float> <float 0x3E499BC5C0000000, float 0x3FB917ABA0000000>, ptr %350, align 32, !tbaa !202
  %353 = getelementptr inbounds float, ptr %f3.129, i64 49
  ...
  %354 = getelementptr inbounds float, ptr %f4.028, i64 4
  %355 = getelementptr inbounds float, ptr %f4.127, i64 4
  %356 = getelementptr inbounds float, ptr %f4.028, i64 5
  %357 = getelementptr inbounds float, ptr %f4.127, i64 5
  %358 = getelementptr inbounds float, ptr %f4.028, i64 7
  ...
  %359 = getelementptr inbounds float, ptr %f4.127, i64 7
  ...
  %360 = getelementptr inbounds float, ptr %f4.028, i64 8
  %361 = getelementptr inbounds float, ptr %f4.127, i64 8
  %362 = getelementptr inbounds float, ptr %f4.028, i64 10
  %363 = getelementptr inbounds float, ptr %f4.127, i64 10
  ...
  %364 = getelementptr inbounds float, ptr %f4.028, i64 12
  %365 = getelementptr inbounds float, ptr %f4.127, i64 12
  %366 = getelementptr inbounds float, ptr %f4.028, i64 14
  %367 = getelementptr inbounds float, ptr %f4.127, i64 14
  ...
  %368 = getelementptr inbounds float, ptr %f4.028, i64 16
  %369 = getelementptr inbounds float, ptr %f4.127, i64 16
  %370 = getelementptr inbounds float, ptr %f4.028, i64 18
  %371 = getelementptr inbounds float, ptr %f4.127, i64 18
  ...
  %372 = getelementptr inbounds float, ptr %f4.028, i64 20
  %373 = getelementptr inbounds float, ptr %f4.127, i64 20
  %374 = getelementptr inbounds float, ptr %f4.028, i64 21
  %375 = getelementptr inbounds float, ptr %f4.127, i64 21
  ...
  %376 = getelementptr inbounds float, ptr %f4.028, i64 24
  %377 = getelementptr inbounds float, ptr %f4.127, i64 24
  %378 = getelementptr inbounds float, ptr %f4.028, i64 25
  %379 = getelementptr inbounds float, ptr %f4.127, i64 25
  ...
  %380 = getelementptr inbounds float, ptr %f4.028, i64 28
  %381 = getelementptr inbounds float, ptr %f4.127, i64 28
  %382 = getelementptr inbounds float, ptr %f4.028, i64 30
  %383 = getelementptr inbounds float, ptr %f4.127, i64 30
  ...
  %384 = getelementptr inbounds float, ptr %f4.028, i64 32
  %385 = getelementptr inbounds float, ptr %f4.127, i64 32
  %386 = getelementptr inbounds float, ptr %f4.028, i64 35
  ...
  %387 = getelementptr inbounds float, ptr %f4.127, i64 35
  ...
  %388 = getelementptr inbounds float, ptr %f4.028, i64 36
  %389 = getelementptr inbounds float, ptr %f4.127, i64 36
  ...
  %390 = getelementptr inbounds float, ptr %f4.028, i64 40
  %391 = getelementptr inbounds float, ptr %f4.127, i64 40
  %392 = getelementptr inbounds float, ptr %f4.028, i64 42
  %393 = getelementptr inbounds float, ptr %f4.127, i64 42
  ...
  %394 = getelementptr inbounds float, ptr %f4.028, i64 44
  %395 = getelementptr inbounds float, ptr %f4.127, i64 44
  ...
  %396 = getelementptr inbounds float, ptr %f4.028, i64 48
  %397 = getelementptr inbounds float, ptr %f4.127, i64 48
  %398 = getelementptr inbounds float, ptr %f4.028, i64 49
  store <2 x float> <float 0x3E499BC5C0000000, float 0x3FB917ABA0000000>, ptr %396, align 32, !tbaa !294
  %399 = getelementptr inbounds float, ptr %f4.127, i64 49
...
"for k$1.s0.n1.preheader":                        ; preds = %"assert succeeded81"
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 32 dereferenceable(16384) %"inv_X8$7.123", i8 0, i64 16384, i1 false), !tbaa !304
...
"for k$1.s0.n1":                                  ; preds = %"for k$1.s0.n1", %"for k$1.s0.n1.preheader"
  ...
  %uglygep1211 = getelementptr i8, ptr %"inv_X8$7.024", i64 %411
  %412 = mul nsw i64 %409, %indvar
  %413 = add i64 %408, %412
  %uglygep1212 = getelementptr i8, ptr %39, i64 %413
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 32 dereferenceable(256) %uglygep1211, ptr noundef nonnull align 4 dereferenceable(256) %uglygep1212, i64 256, i1 false)
  %indvar.next = or i64 %indvar, 1
  %414 = shl nuw nsw i64 %indvar.next, 8
  %uglygep1211.1 = getelementptr i8, ptr %"inv_X8$7.024", i64 %414
  %415 = mul nsw i64 %409, %indvar.next
  %416 = add i64 %408, %415
  %uglygep1212.1 = getelementptr i8, ptr %39, i64 %416
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 32 dereferenceable(256) %uglygep1211.1, ptr noundef nonnull align 4 dereferenceable(256) %uglygep1212.1, i64 256, i1 false)
...
"for kernel_fft0_S8_R8_n0$1.s1.n1.preheader":     ; preds = %"for k$1.s0.n1"
  %417 = load <8 x float>, ptr %f4.028, align 32, !tbaa !306
  %418 = load <8 x float>, ptr %f4.127, align 32, !tbaa !307
...
"for kernel_fft0_S8_R8_n0$1.s1.n1":               ; preds = %"for kernel_fft0_S8_R8_n0$1.s1.n1.preheader", %"for kernel_fft0_S8_R8_n0$1.s1.n1"
  ...
  %541 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %540
  %542 = load <8 x float>, ptr %541, align 32, !tbaa !314
  %543 = or i64 %540, 32
  %544 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %543
  %545 = load <8 x float>, ptr %544, align 32, !tbaa !314
  %546 = fadd <8 x float> %542, %545
  %547 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %540
  %548 = load <8 x float>, ptr %547, align 32, !tbaa !304
  %549 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %543
  %550 = load <8 x float>, ptr %549, align 32, !tbaa !304
  %551 = fadd <8 x float> %548, %550
  %552 = or i64 %540, 16
  %553 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %552
  %554 = load <8 x float>, ptr %553, align 32, !tbaa !314
  %555 = or i64 %540, 48
  %556 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %555
  %557 = load <8 x float>, ptr %556, align 32, !tbaa !314
  %558 = fadd <8 x float> %554, %557
  %559 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %552
  %560 = load <8 x float>, ptr %559, align 32, !tbaa !304
  %561 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %555
  ...
  %576 = or i64 %540, 8
  %577 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %576
  %578 = load <8 x float>, ptr %577, align 32, !tbaa !314
  %579 = or i64 %540, 40
  %580 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %579
  %581 = load <8 x float>, ptr %580, align 32, !tbaa !314
  %582 = fadd <8 x float> %578, %581
  %583 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %576
  %584 = load <8 x float>, ptr %583, align 32, !tbaa !304
  %585 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %579
  %586 = load <8 x float>, ptr %585, align 32, !tbaa !304
  %587 = fadd <8 x float> %584, %586
  %588 = or i64 %540, 24
  %589 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %588
  %590 = load <8 x float>, ptr %589, align 32, !tbaa !314
  %591 = or i64 %540, 56
  %592 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %591
  %593 = load <8 x float>, ptr %592, align 32, !tbaa !314
  %594 = fadd <8 x float> %590, %593
  %595 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %588
  %596 = load <8 x float>, ptr %595, align 32, !tbaa !304
  %597 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %591
...
"consume kernel_fft0_S8_R8_n0$1":                 ; preds = %"for kernel_fft0_S8_R8_n0$1.s1.n1"
  ...
  store ptr %f4.127, ptr %791, align 8
  ...
  store ptr %"kernel_fft1_S8_R8_n1$1.026", ptr %797, align 8
  ...
  store ptr %"kernel_fft1_S8_R8_n1$1.125", ptr %799, align 8
  %800 = getelementptr inbounds %closure_t, ptr %0, i64 0, i32 11
  store ptr null, ptr %800, align 8
  %801 = call i32 @halide_do_par_for(ptr null, ptr nonnull @"par_for__Z84FftConvolve64x64xCHalide_x86_64_linux_avx_c_plus_plus_name_mangling_no_runtime_sse41P15halide_buffer_tS0_S0__kernel_fft1_S8_R8_n1$1.s1.n0.g", i32 0, i32 8, ptr nonnull %0)
  %802 = icmp eq i32 %801, 0
  br i1 %802, label %call_destructor.exit77, label %call_destructor.exit62, !prof !26

call_destructor.exit77:                           ; preds = %"consume kernel_fft0_S8_R8_n0$1"
  call void @halide_free(ptr null, ptr nonnull %400) #9
  call void @halide_free(ptr null, ptr nonnull %402) #9
  %803 = icmp sgt i32 %83, 0
  br i1 %803, label %"for result$1.s0.i.preheader", label %call_destructor.exit62.thread918, !prof !26

"for result$1.s0.i.preheader":                    ; preds = %call_destructor.exit77
  ...
  %810 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 64
  %811 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 64
  %812 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 80
  %813 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 80
  %814 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 56
  %815 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 56
  %816 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 40
  %817 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 40
  %818 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 72
  %819 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 72
  %820 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 88
  %821 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 88
  %822 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 48
  %823 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 48
  %824 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 32
  %825 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 32
  %826 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 96
  %827 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 96
  %828 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 112
  %829 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 112
  %830 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 24
  %831 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 24
  %832 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 8
  %833 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 8
  %834 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 104
  %835 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 104
  %836 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 120
  %837 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 120
  %838 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 16
  %839 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 16
  %840 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 64
  %841 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 64
  %842 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 80
  %843 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 80
  %844 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 56
  %845 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 56
  %846 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 40
  %847 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 40
  %848 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 72
  %849 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 72
  %850 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 88
  %851 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 88
  %852 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 48
  %853 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 48
  %854 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 32
  %855 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 32
  %856 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 96
  %857 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 96
  %858 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 112
  %859 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 112
  %860 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 24
  %861 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 24
  %862 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 8
  %863 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 8
  %864 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 104
  %865 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 104
  %866 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 120
  %867 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 120
  %868 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 16
  %869 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 16
  %870 = icmp sgt i32 %77, 0
  %a25 = lshr i32 %71, 3
  %.not925 = icmp ult i32 %71, 8
  %871 = add nsw i32 %71, 7
  %872 = ashr i32 %871, 3
  %873 = icmp slt i32 %a25, %872
  ...
  %880 = zext i32 %a25 to i64
  %xtraiter = and i64 %880, 1
  %881 = icmp eq i32 %a25, 1
...
"for result$1.s0.i":                              ; preds = %"for result$1.s0.i.preheader", %"end for result$1.s0.n1"
  %indvars.iv1248 = phi i64 [ %876, %"for result$1.s0.i.preheader" ], [ %indvars.iv.next1249, %"end for result$1.s0.n1" ]
...
"assert failed86":                                ; preds = %"for result$1.s0.i"
  %883 = call i32 @halide_error_out_of_memory(ptr null) #8
  br label %call_destructor.exit62.thread918

"assert succeeded87":                             ; preds = %"for result$1.s0.i"
  %884 = call ptr @halide_malloc(ptr null, i64 30724)
  %.not42 = icmp eq ptr %884, null
  br i1 %.not42, label %call_destructor.exit60, label %"for fwd_fft0_S8_R8_n0$1.s1.n1.preheader", !prof !5

"for fwd_fft0_S8_R8_n0$1.s1.n1.preheader":        ; preds = %"assert succeeded87"
  ...
  %887 = load <8 x float>, ptr %f3.030, align 32, !tbaa !320
  %888 = load <8 x float>, ptr %f3.129, align 32, !tbaa !321
...
"for fwd_fft0_S8_R8_n0$1.s1.n1":                  ; preds = %"for fwd_fft0_S8_R8_n0$1.s1.n1.preheader", %"for fwd_fft0_S8_R8_n0$1.s1.n1"
  %indvars.iv1216 = phi i64 [ 0, %"for fwd_fft0_S8_R8_n0$1.s1.n1.preheader" ], [ %indvars.iv.next1217, %"for fwd_fft0_S8_R8_n0$1.s1.n1" ]
  %1011 = trunc i64 %indvars.iv1216 to i32
  %reass.add940 = sub i32 %1011, %27
  %reass.mul941 = mul i32 %reass.add940, %31
  %t3473 = add i32 %886, %reass.mul941
  %1012 = sext i32 %t3473 to i64
  ...
  br i1 %.not43, label %"for fwd_fft1_S8_R8_n1$1.s1.n0.g", label %"for fwd_fft0_S8_R8_n0$1.s1.n1"

"for fwd_fft1_S8_R8_n1$1.s1.n0.g":                ; preds = %"for fwd_fft0_S8_R8_n0$1.s1.n1", %"end for fwd_fft1_S8_R8_n1$1.s1.r30330$y"
  %indvars.iv1226 = phi i64 [ %indvars.iv.next1227, %"end for fwd_fft1_S8_R8_n1$1.s1.r30330$y" ], [ 0, %"for fwd_fft0_S8_R8_n0$1.s1.n1" ]
  %1228 = shl nsw i64 %indvars.iv1226, 3
  br label %"for fwd_exchange_S1_R8_n1$1.s1.r30325$y"

call_destructor.exit79:                           ; preds = %"end for fwd_fft1_S8_R8_n1$1.s1.r30330$y"
...
"for fwd_exchange_S1_R8_n1$1.s1.r30325$y":        ; preds = %"for fwd_fft1_S8_R8_n1$1.s1.n0.g", %"for fwd_exchange_S1_R8_n1$1.s1.r30325$y"
  %indvars.iv1219 = phi i64 [ 0, %"for fwd_fft1_S8_R8_n1$1.s1.n0.g" ], [ %indvars.iv.next1220, %"for fwd_exchange_S1_R8_n1$1.s1.r30325$y" ]
  ...
  %1328 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %1327
  store <8 x float> %1311, ptr %1328, align 32, !tbaa !334
  %1329 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %1327
  store <8 x float> %1312, ptr %1329, align 32, !tbaa !336
  %1330 = or i64 %1327, 8
  %1331 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %1330
  store <8 x float> %1313, ptr %1331, align 32, !tbaa !334
  %1332 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %1330
  store <8 x float> %1314, ptr %1332, align 32, !tbaa !336
  %1333 = or i64 %1327, 16
  %1334 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %1333
  store <8 x float> %1315, ptr %1334, align 32, !tbaa !334
  %1335 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %1333
  store <8 x float> %1316, ptr %1335, align 32, !tbaa !336
  %1336 = or i64 %1327, 24
  %1337 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %1336
  store <8 x float> %1317, ptr %1337, align 32, !tbaa !334
  %1338 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %1336
  store <8 x float> %1318, ptr %1338, align 32, !tbaa !336
  %1339 = or i64 %1327, 32
  %1340 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %1339
  store <8 x float> %1319, ptr %1340, align 32, !tbaa !334
  %1341 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %1339
  store <8 x float> %1320, ptr %1341, align 32, !tbaa !336
  %1342 = or i64 %1327, 40
  %1343 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %1342
  store <8 x float> %1321, ptr %1343, align 32, !tbaa !334
  %1344 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %1342
  store <8 x float> %1322, ptr %1344, align 32, !tbaa !336
  %1345 = or i64 %1327, 48
  %1346 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %1345
  store <8 x float> %1323, ptr %1346, align 32, !tbaa !334
  %1347 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %1345
  store <8 x float> %1324, ptr %1347, align 32, !tbaa !336
  %1348 = or i64 %1327, 56
  %1349 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %1348
  store <8 x float> %1325, ptr %1349, align 32, !tbaa !334
  %1350 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %1348
  ...
  br i1 %.not44, label %"for fwd_fft1_S8_R8_n1$1.s1.r30330$y", label %"for fwd_exchange_S1_R8_n1$1.s1.r30325$y"

"for fwd_fft1_S8_R8_n1$1.s1.r30330$y":            ; preds = %"for fwd_exchange_S1_R8_n1$1.s1.r30325$y", %"for fwd_fft1_S8_R8_n1$1.s1.r30330$y"
  %indvars.iv1223 = phi i64 [ %indvars.iv.next1224, %"for fwd_fft1_S8_R8_n1$1.s1.r30330$y" ], [ 0, %"for fwd_exchange_S1_R8_n1$1.s1.r30325$y" ]
  %1351 = shl nuw nsw i64 %indvars.iv1223, 3
  %1352 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %1351
  %1353 = load <8 x float>, ptr %1352, align 32, !tbaa !334
  %1354 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %1351
  %1355 = load <8 x float>, ptr %1354, align 32, !tbaa !336
  %1356 = add nuw nsw i64 %1351, 64
  %1357 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %1356
  %1358 = load <8 x float>, ptr %1357, align 32, !tbaa !334
  %1359 = getelementptr inbounds float, ptr %f3.030, i64 %indvars.iv1223
  ...
  %1364 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %1356
  %1365 = load <8 x float>, ptr %1364, align 32, !tbaa !336
  %1366 = getelementptr inbounds float, ptr %f3.129, i64 %indvars.iv1223
  ...
  %1376 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %1375
  %1377 = load <8 x float>, ptr %1376, align 32, !tbaa !334
  %1378 = shl nuw nsw i64 %indvars.iv1223, 1
  %1379 = getelementptr inbounds float, ptr %f3.030, i64 %1378
  ...
  %1384 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %1375
  %1385 = load <8 x float>, ptr %1384, align 32, !tbaa !336
  %1386 = getelementptr inbounds float, ptr %f3.129, i64 %1378
  ...
  %1396 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %1395
  %1397 = load <8 x float>, ptr %1396, align 32, !tbaa !334
  %1398 = mul nuw nsw i64 %indvars.iv1223, 3
  %1399 = getelementptr inbounds float, ptr %f3.030, i64 %1398
  ...
  %1404 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %1395
  %1405 = load <8 x float>, ptr %1404, align 32, !tbaa !336
  %1406 = getelementptr inbounds float, ptr %f3.129, i64 %1398
  ...
  %1416 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %1415
  %1417 = load <8 x float>, ptr %1416, align 32, !tbaa !334
  %1418 = shl nuw nsw i64 %indvars.iv1223, 2
  %1419 = getelementptr inbounds float, ptr %f3.030, i64 %1418
  ...
  %1424 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %1415
  %1425 = load <8 x float>, ptr %1424, align 32, !tbaa !336
  %1426 = getelementptr inbounds float, ptr %f3.129, i64 %1418
  ...
  %1436 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %1435
  %1437 = load <8 x float>, ptr %1436, align 32, !tbaa !334
  %1438 = mul nuw nsw i64 %indvars.iv1223, 5
  %1439 = getelementptr inbounds float, ptr %f3.030, i64 %1438
  ...
  %1444 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %1435
  %1445 = load <8 x float>, ptr %1444, align 32, !tbaa !336
  %1446 = getelementptr inbounds float, ptr %f3.129, i64 %1438
  ...
  %1456 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %1455
  %1457 = load <8 x float>, ptr %1456, align 32, !tbaa !334
  %1458 = mul nuw nsw i64 %indvars.iv1223, 6
  %1459 = getelementptr inbounds float, ptr %f3.030, i64 %1458
  ...
  %1464 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %1455
  %1465 = load <8 x float>, ptr %1464, align 32, !tbaa !336
  %1466 = getelementptr inbounds float, ptr %f3.129, i64 %1458
  ...
  %1476 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %1475
  %1477 = load <8 x float>, ptr %1476, align 32, !tbaa !334
  %1478 = mul nuw nsw i64 %indvars.iv1223, 7
  %1479 = getelementptr inbounds float, ptr %f3.030, i64 %1478
  ...
  %1484 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %1475
  %1485 = load <8 x float>, ptr %1484, align 32, !tbaa !336
  %1486 = getelementptr inbounds float, ptr %f3.129, i64 %1478
  ...
  %1554 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %1553
  store <8 x float> %1536, ptr %1554, align 32, !tbaa !314
  %1555 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %1553
  store <8 x float> %1537, ptr %1555, align 32, !tbaa !304
  %1556 = add nuw nsw i64 %1553, 512
  %1557 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %1556
  store <8 x float> %1538, ptr %1557, align 32, !tbaa !314
  %1558 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %1556
  store <8 x float> %1539, ptr %1558, align 32, !tbaa !304
  %1559 = add nuw nsw i64 %1553, 1024
  %1560 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %1559
  store <8 x float> %1540, ptr %1560, align 32, !tbaa !314
  %1561 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %1559
  store <8 x float> %1541, ptr %1561, align 32, !tbaa !304
  %1562 = add nuw nsw i64 %1553, 1536
  %1563 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %1562
  store <8 x float> %1542, ptr %1563, align 32, !tbaa !314
  %1564 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %1562
  store <8 x float> %1543, ptr %1564, align 32, !tbaa !304
  %1565 = add nuw nsw i64 %1553, 2048
  %1566 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %1565
  store <8 x float> %1544, ptr %1566, align 32, !tbaa !314
  %1567 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %1565
  store <8 x float> %1545, ptr %1567, align 32, !tbaa !304
  %1568 = add nuw nsw i64 %1553, 2560
  %1569 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %1568
  store <8 x float> %1546, ptr %1569, align 32, !tbaa !314
  %1570 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %1568
  store <8 x float> %1547, ptr %1570, align 32, !tbaa !304
  %1571 = add nuw nsw i64 %1553, 3072
  %1572 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %1571
  store <8 x float> %1548, ptr %1572, align 32, !tbaa !314
  %1573 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %1571
  store <8 x float> %1549, ptr %1573, align 32, !tbaa !304
  %1574 = add nuw nsw i64 %1553, 3584
  %1575 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %1574
  store <8 x float> %1550, ptr %1575, align 32, !tbaa !314
  %1576 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %1574
  ...
  br i1 %.not45, label %"end for fwd_fft1_S8_R8_n1$1.s1.r30330$y", label %"for fwd_fft1_S8_R8_n1$1.s1.r30330$y"

"end for fwd_fft1_S8_R8_n1$1.s1.r30330$y":        ; preds = %"for fwd_fft1_S8_R8_n1$1.s1.r30330$y"
  %indvars.iv.next1227 = add nuw nsw i64 %indvars.iv1226, 1
  %.not46 = icmp eq i64 %indvars.iv.next1227, 8
  br i1 %.not46, label %call_destructor.exit79, label %"for fwd_fft1_S8_R8_n1$1.s1.n0.g"

"assert failed90":                                ; preds = %call_destructor.exit79
  %1577 = call i32 @halide_error_explicit_bounds_too_small(ptr null, ptr nonnull @str.11, ptr nonnull @str.12, i32 0, i32 63, i32 %91, i32 %b15) #8
  br label %call_destructor.exit62.thread918
...
"assert failed92":                                ; preds = %"assert succeeded91"
  ...
  %a18 = add nsw i32 %807, -1
  %1579 = call i32 @halide_error_explicit_bounds_too_small(ptr null, ptr nonnull @str.13, ptr nonnull @str.12, i32 0, i32 63, i32 %1578, i32 %a18) #8
  br label %call_destructor.exit62.thread918

"assert succeeded93":                             ; preds = %"assert succeeded91"
  br i1 %809, label %"assert failed94", label %"produce inv_fft1_S8_R8_n1$1", !prof !5
...
"produce inv_fft1_S8_R8_n1$1":                    ; preds = %"assert succeeded93"
...
"assert failed100":                               ; preds = %"produce inv_fft1_S8_R8_n1$1"
  %1582 = call i32 @halide_error_out_of_memory(ptr null) #8
  br label %call_destructor.exit62.thread918

"assert succeeded101":                            ; preds = %"produce inv_fft1_S8_R8_n1$1"
  %1583 = call ptr @halide_malloc(ptr null, i64 30724)
  %.not48 = icmp eq ptr %1583, null
  br i1 %.not48, label %call_destructor.exit, label %"for inv_fft0_S8_R8_n0$1.s1.n1.preheader", !prof !5

"for inv_fft0_S8_R8_n0$1.s1.n1.preheader":        ; preds = %"assert succeeded101"
  %1584 = load <8 x float>, ptr %f5.032, align 32, !tbaa !340
  %1585 = load <8 x float>, ptr %f5.131, align 32, !tbaa !341
...
"for inv_fft0_S8_R8_n0$1.s1.n1":                  ; preds = %"for inv_fft0_S8_R8_n0$1.s1.n1.preheader", %"for inv_fft0_S8_R8_n0$1.s1.n1"
  %indvars.iv1229 = phi i64 [ 0, %"for inv_fft0_S8_R8_n0$1.s1.n1.preheader" ], [ %indvars.iv.next1230, %"for inv_fft0_S8_R8_n0$1.s1.n1" ]
  %1708 = shl nuw nsw i64 %indvars.iv1229, 6
  %1709 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %1708
  %1710 = load <8 x float>, ptr %1709, align 32, !tbaa !314
  %1711 = getelementptr inbounds float, ptr %"kernel_fft1_S8_R8_n1$1.026", i64 %1708
  %1712 = load <8 x float>, ptr %1711, align 32, !tbaa !348
  %1713 = fmul <8 x float> %1710, %1712
  %1714 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %1708
  %1715 = load <8 x float>, ptr %1714, align 32, !tbaa !304
  %1716 = getelementptr inbounds float, ptr %"kernel_fft1_S8_R8_n1$1.125", i64 %1708
  %1717 = load <8 x float>, ptr %1716, align 32, !tbaa !350
  %1718 = fmul <8 x float> %1715, %1717
  %1719 = fsub <8 x float> %1713, %1718
  %1720 = or i64 %1708, 32
  %1721 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %1720
  %1722 = load <8 x float>, ptr %1721, align 32, !tbaa !314
  %1723 = getelementptr inbounds float, ptr %"kernel_fft1_S8_R8_n1$1.026", i64 %1720
  %1724 = load <8 x float>, ptr %1723, align 32, !tbaa !348
  %1725 = fmul <8 x float> %1722, %1724
  %1726 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %1720
  %1727 = load <8 x float>, ptr %1726, align 32, !tbaa !304
  %1728 = getelementptr inbounds float, ptr %"kernel_fft1_S8_R8_n1$1.125", i64 %1720
  ...
  %1740 = or i64 %1708, 16
  %1741 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %1740
  %1742 = load <8 x float>, ptr %1741, align 32, !tbaa !314
  %1743 = getelementptr inbounds float, ptr %"kernel_fft1_S8_R8_n1$1.026", i64 %1740
  %1744 = load <8 x float>, ptr %1743, align 32, !tbaa !348
  %1745 = fmul <8 x float> %1742, %1744
  %1746 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %1740
  %1747 = load <8 x float>, ptr %1746, align 32, !tbaa !304
  %1748 = getelementptr inbounds float, ptr %"kernel_fft1_S8_R8_n1$1.125", i64 %1740
  %1749 = load <8 x float>, ptr %1748, align 32, !tbaa !350
  %1750 = fmul <8 x float> %1747, %1749
  %1751 = fsub <8 x float> %1745, %1750
  %1752 = or i64 %1708, 48
  %1753 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %1752
  %1754 = load <8 x float>, ptr %1753, align 32, !tbaa !314
  %1755 = getelementptr inbounds float, ptr %"kernel_fft1_S8_R8_n1$1.026", i64 %1752
  %1756 = load <8 x float>, ptr %1755, align 32, !tbaa !348
  %1757 = fmul <8 x float> %1754, %1756
  %1758 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %1752
  %1759 = load <8 x float>, ptr %1758, align 32, !tbaa !304
  %1760 = getelementptr inbounds float, ptr %"kernel_fft1_S8_R8_n1$1.125", i64 %1752
  ...
  %1786 = or i64 %1708, 8
  %1787 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %1786
  %1788 = load <8 x float>, ptr %1787, align 32, !tbaa !314
  %1789 = getelementptr inbounds float, ptr %"kernel_fft1_S8_R8_n1$1.026", i64 %1786
  %1790 = load <8 x float>, ptr %1789, align 32, !tbaa !348
  %1791 = fmul <8 x float> %1788, %1790
  %1792 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %1786
  %1793 = load <8 x float>, ptr %1792, align 32, !tbaa !304
  %1794 = getelementptr inbounds float, ptr %"kernel_fft1_S8_R8_n1$1.125", i64 %1786
  %1795 = load <8 x float>, ptr %1794, align 32, !tbaa !350
  %1796 = fmul <8 x float> %1793, %1795
  %1797 = fsub <8 x float> %1791, %1796
  %1798 = or i64 %1708, 40
  %1799 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %1798
  %1800 = load <8 x float>, ptr %1799, align 32, !tbaa !314
  %1801 = getelementptr inbounds float, ptr %"kernel_fft1_S8_R8_n1$1.026", i64 %1798
  %1802 = load <8 x float>, ptr %1801, align 32, !tbaa !348
  %1803 = fmul <8 x float> %1800, %1802
  %1804 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %1798
  %1805 = load <8 x float>, ptr %1804, align 32, !tbaa !304
  %1806 = getelementptr inbounds float, ptr %"kernel_fft1_S8_R8_n1$1.125", i64 %1798
  ...
  %1818 = or i64 %1708, 24
  %1819 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %1818
  %1820 = load <8 x float>, ptr %1819, align 32, !tbaa !314
  %1821 = getelementptr inbounds float, ptr %"kernel_fft1_S8_R8_n1$1.026", i64 %1818
  %1822 = load <8 x float>, ptr %1821, align 32, !tbaa !348
  %1823 = fmul <8 x float> %1820, %1822
  %1824 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %1818
  %1825 = load <8 x float>, ptr %1824, align 32, !tbaa !304
  %1826 = getelementptr inbounds float, ptr %"kernel_fft1_S8_R8_n1$1.125", i64 %1818
  %1827 = load <8 x float>, ptr %1826, align 32, !tbaa !350
  %1828 = fmul <8 x float> %1825, %1827
  %1829 = fsub <8 x float> %1823, %1828
  %1830 = or i64 %1708, 56
  %1831 = getelementptr inbounds float, ptr %"inv_X8$7.024", i64 %1830
  %1832 = load <8 x float>, ptr %1831, align 32, !tbaa !314
  %1833 = getelementptr inbounds float, ptr %"kernel_fft1_S8_R8_n1$1.026", i64 %1830
  %1834 = load <8 x float>, ptr %1833, align 32, !tbaa !348
  %1835 = fmul <8 x float> %1832, %1834
  %1836 = getelementptr inbounds float, ptr %"inv_X8$7.123", i64 %1830
  %1837 = load <8 x float>, ptr %1836, align 32, !tbaa !304
  %1838 = getelementptr inbounds float, ptr %"kernel_fft1_S8_R8_n1$1.125", i64 %1830
  ...
  br i1 %.not49, label %"for inv_fft1_S8_R8_n1$1.s1.n0.g.preheader", label %"for inv_fft0_S8_R8_n0$1.s1.n1"
...
"for inv_fft1_S8_R8_n1$1.s1.n0.g.preheader":      ; preds = %"for inv_fft0_S8_R8_n0$1.s1.n1"
  ...
  store <8 x float> %1998, ptr %"inv_exchange_S1_R8_n1$1.016", align 32, !tbaa !452
  store <8 x float> %2001, ptr %"inv_exchange_S1_R8_n1$1.115", align 32, !tbaa !454
  br label %"for inv_fft1_S8_R8_n1$1.s1.n0.g"

"for inv_fft1_S8_R8_n1$1.s1.n0.g":                ; preds = %"for inv_fft1_S8_R8_n1$1.s1.n0.g.preheader", %"end for inv_fft1_S8_R8_n1$1.s1.r30424$y"
  %indvars.iv1239 = phi i64 [ 0, %"for inv_fft1_S8_R8_n1$1.s1.n0.g.preheader" ], [ %indvars.iv.next1240, %"end for inv_fft1_S8_R8_n1$1.s1.r30424$y" ]
  %2042 = shl nsw i64 %indvars.iv1239, 3
  br label %"for inv_exchange_S1_R8_n1$1.s1.r30419$y"

call_destructor.exit81:                           ; preds = %"end for inv_fft1_S8_R8_n1$1.s1.r30424$y"
  ...
  store <8 x float> %2359, ptr %"inv_X8$7.024", align 32, !tbaa !552
  store <8 x float> %2060, ptr %"inv_X8$7.123", align 32, !tbaa !554
  call void @halide_free(ptr null, ptr nonnull %1581) #9
  call void @halide_free(ptr null, ptr nonnull %1583) #9
  br i1 %870, label %"for result$1.s0.n1.preheader", label %"end for result$1.s0.n1", !prof !26

"for result$1.s0.n1.preheader":                   ; preds = %call_destructor.exit81
  %reass.add947 = sub nsw i64 %indvars.iv1248, %876
  %reass.mul948 = mul nsw i64 %reass.add947, %255
  %2069 = sub i64 %reass.mul948, %874
  %2070 = add nsw i64 %879, %reass.mul948
  br label %"for result$1.s0.n1"

"for inv_exchange_S1_R8_n1$1.s1.r30419$y":        ; preds = %"for inv_fft1_S8_R8_n1$1.s1.n0.g", %"for inv_exchange_S1_R8_n1$1.s1.r30419$y"
  %indvars.iv1232 = phi i64 [ 0, %"for inv_fft1_S8_R8_n1$1.s1.n0.g" ], [ %indvars.iv.next1233, %"for inv_exchange_S1_R8_n1$1.s1.r30419$y" ]
  ...
  %2170 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %2169
  store <8 x float> %2153, ptr %2170, align 32, !tbaa !334
  %2171 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %2169
  ...
  %2174 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %2172
  store <8 x float> %2156, ptr %2174, align 32, !tbaa !336
  %2175 = or i64 %2169, 16
  %2176 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %2175
  store <8 x float> %2157, ptr %2176, align 32, !tbaa !334
  %2177 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %2175
  store <8 x float> %2158, ptr %2177, align 32, !tbaa !336
  %2178 = or i64 %2169, 24
  %2179 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %2178
  store <8 x float> %2159, ptr %2179, align 32, !tbaa !334
  %2180 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %2178
  store <8 x float> %2160, ptr %2180, align 32, !tbaa !336
  %2181 = or i64 %2169, 32
  %2182 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %2181
  store <8 x float> %2161, ptr %2182, align 32, !tbaa !334
  %2183 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %2181
  store <8 x float> %2162, ptr %2183, align 32, !tbaa !336
  %2184 = or i64 %2169, 40
  %2185 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %2184
  store <8 x float> %2163, ptr %2185, align 32, !tbaa !334
  %2186 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %2184
  store <8 x float> %2164, ptr %2186, align 32, !tbaa !336
  %2187 = or i64 %2169, 48
  %2188 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %2187
  store <8 x float> %2165, ptr %2188, align 32, !tbaa !334
  %2189 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %2187
  store <8 x float> %2166, ptr %2189, align 32, !tbaa !336
  %2190 = or i64 %2169, 56
  %2191 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %2190
  store <8 x float> %2167, ptr %2191, align 32, !tbaa !334
  %2192 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %2190
  ...
  br i1 %.not50, label %"for inv_fft1_S8_R8_n1$1.s1.r30424$y", label %"for inv_exchange_S1_R8_n1$1.s1.r30419$y"

"for inv_fft1_S8_R8_n1$1.s1.r30424$y":            ; preds = %"for inv_exchange_S1_R8_n1$1.s1.r30419$y", %"for inv_fft1_S8_R8_n1$1.s1.r30424$y"
  %indvars.iv1236 = phi i64 [ %indvars.iv.next1237, %"for inv_fft1_S8_R8_n1$1.s1.r30424$y" ], [ 0, %"for inv_exchange_S1_R8_n1$1.s1.r30419$y" ]
  %2193 = shl nuw nsw i64 %indvars.iv1236, 3
  %2194 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %2193
  %2195 = load <8 x float>, ptr %2194, align 32, !tbaa !334
  %2196 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %2193
  %2197 = load <8 x float>, ptr %2196, align 32, !tbaa !336
  %2198 = add nuw nsw i64 %2193, 64
  %2199 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %2198
  %2200 = load <8 x float>, ptr %2199, align 32, !tbaa !334
  %2201 = getelementptr inbounds float, ptr %f5.032, i64 %indvars.iv1236
  ...
  %2206 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %2198
  %2207 = load <8 x float>, ptr %2206, align 32, !tbaa !336
  %2208 = getelementptr inbounds float, ptr %f5.131, i64 %indvars.iv1236
  ...
  %2218 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %2217
  %2219 = load <8 x float>, ptr %2218, align 32, !tbaa !334
  %2220 = shl nuw nsw i64 %indvars.iv1236, 1
  %2221 = getelementptr inbounds float, ptr %f5.032, i64 %2220
  ...
  %2226 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %2217
  %2227 = load <8 x float>, ptr %2226, align 32, !tbaa !336
  %2228 = getelementptr inbounds float, ptr %f5.131, i64 %2220
  ...
  %2238 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %2237
  %2239 = load <8 x float>, ptr %2238, align 32, !tbaa !334
  %2240 = mul nuw nsw i64 %indvars.iv1236, 3
  %2241 = getelementptr inbounds float, ptr %f5.032, i64 %2240
  ...
  %2246 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %2237
  %2247 = load <8 x float>, ptr %2246, align 32, !tbaa !336
  %2248 = getelementptr inbounds float, ptr %f5.131, i64 %2240
  ...
  %2258 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %2257
  %2259 = load <8 x float>, ptr %2258, align 32, !tbaa !334
  %2260 = shl nuw nsw i64 %indvars.iv1236, 2
  %2261 = getelementptr inbounds float, ptr %f5.032, i64 %2260
  ...
  %2266 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %2257
  %2267 = load <8 x float>, ptr %2266, align 32, !tbaa !336
  %2268 = getelementptr inbounds float, ptr %f5.131, i64 %2260
  ...
  %2275 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %2274
  %2276 = load <8 x float>, ptr %2275, align 32, !tbaa !334
  %2277 = mul nuw nsw i64 %indvars.iv1236, 5
  %2278 = getelementptr inbounds float, ptr %f5.032, i64 %2277
  ...
  %2283 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %2274
  %2284 = load <8 x float>, ptr %2283, align 32, !tbaa !336
  %2285 = getelementptr inbounds float, ptr %f5.131, i64 %2277
  ...
  %2295 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %2294
  %2296 = load <8 x float>, ptr %2295, align 32, !tbaa !334
  %2297 = mul nuw nsw i64 %indvars.iv1236, 6
  %2298 = getelementptr inbounds float, ptr %f5.032, i64 %2297
  ...
  %2303 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %2294
  %2304 = load <8 x float>, ptr %2303, align 32, !tbaa !336
  %2305 = getelementptr inbounds float, ptr %f5.131, i64 %2297
  ...
  %2315 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.016", i64 %2314
  %2316 = load <8 x float>, ptr %2315, align 32, !tbaa !334
  %2317 = mul nuw nsw i64 %indvars.iv1236, 7
  %2318 = getelementptr inbounds float, ptr %f5.032, i64 %2317
  ...
  %2323 = getelementptr inbounds float, ptr %"inv_exchange_S1_R8_n1$1.115", i64 %2314
  %2324 = load <8 x float>, ptr %2323, align 32, !tbaa !336
  %2325 = getelementptr inbounds float, ptr %f5.131, i64 %2317
  ...
  %2370 = getelementptr inbounds float, ptr %"inv_fft1_S8_R8_n1$1.014", i64 %2369
  store <8 x float> %2360, ptr %2370, align 32, !tbaa !558
  %2371 = add nuw nsw i64 %2369, 512
  %2372 = getelementptr inbounds float, ptr %"inv_fft1_S8_R8_n1$1.014", i64 %2371
  store <8 x float> %2361, ptr %2372, align 32, !tbaa !558
  %2373 = add nuw nsw i64 %2369, 1024
  %2374 = getelementptr inbounds float, ptr %"inv_fft1_S8_R8_n1$1.014", i64 %2373
  store <8 x float> %2362, ptr %2374, align 32, !tbaa !558
  %2375 = add nuw nsw i64 %2369, 1536
  %2376 = getelementptr inbounds float, ptr %"inv_fft1_S8_R8_n1$1.014", i64 %2375
  store <8 x float> %2363, ptr %2376, align 32, !tbaa !558
  %2377 = add nuw nsw i64 %2369, 2048
  %2378 = getelementptr inbounds float, ptr %"inv_fft1_S8_R8_n1$1.014", i64 %2377
  store <8 x float> %2364, ptr %2378, align 32, !tbaa !558
  %2379 = add nuw nsw i64 %2369, 2560
  %2380 = getelementptr inbounds float, ptr %"inv_fft1_S8_R8_n1$1.014", i64 %2379
  store <8 x float> %2365, ptr %2380, align 32, !tbaa !558
  %2381 = add nuw nsw i64 %2369, 3072
  %2382 = getelementptr inbounds float, ptr %"inv_fft1_S8_R8_n1$1.014", i64 %2381
  store <8 x float> %2366, ptr %2382, align 32, !tbaa !558
  %2383 = add nuw nsw i64 %2369, 3584
  %2384 = getelementptr inbounds float, ptr %"inv_fft1_S8_R8_n1$1.014", i64 %2383
  ...
  br i1 %.not51, label %"end for inv_fft1_S8_R8_n1$1.s1.r30424$y", label %"for inv_fft1_S8_R8_n1$1.s1.r30424$y"

"end for inv_fft1_S8_R8_n1$1.s1.r30424$y":        ; preds = %"for inv_fft1_S8_R8_n1$1.s1.r30424$y"
  %indvars.iv.next1240 = add nuw nsw i64 %indvars.iv1239, 1
  %.not52 = icmp eq i64 %indvars.iv.next1240, 8
  br i1 %.not52, label %call_destructor.exit81, label %"for inv_fft1_S8_R8_n1$1.s1.n0.g"

"for result$1.s0.n1":                             ; preds = %"for result$1.s0.n1.preheader", %"end for result$1.s0.n0.n0105"
  %indvars.iv1245 = phi i64 [ %875, %"for result$1.s0.n1.preheader" ], [ %indvars.iv.next1246, %"end for result$1.s0.n0.n0105" ]
  br i1 %.not925, label %"end for result$1.s0.n0.n0", label %"for result$1.s0.n0.n0.preheader", !prof !5
...
"for result$1.s0.n0.n0.preheader":                ; preds = %"for result$1.s0.n1"
  ...
  %reass.mul950 = mul nsw i64 %reass.add949, %248
  %2386 = add nsw i64 %2069, %reass.mul950
  br i1 %881, label %"end for result$1.s0.n0.n0.loopexit.unr-lcssa", label %"for result$1.s0.n0.n0"

"end for result$1.s0.n1":                         ; preds = %"end for result$1.s0.n0.n0105", %call_destructor.exit81
  %indvars.iv.next1249 = add nsw i64 %indvars.iv1248, 1
  %2387 = trunc i64 %indvars.iv.next1249 to i32
  %.not53 = icmp eq i32 %180, %2387
  br i1 %.not53, label %call_destructor.exit62.thread918, label %"for result$1.s0.i"

"for result$1.s0.n0.n0":                          ; preds = %"for result$1.s0.n0.n0.preheader", %"for result$1.s0.n0.n0"
  %indvars.iv1242 = phi i64 [ %indvars.iv.next1243.1, %"for result$1.s0.n0.n0" ], [ 0, %"for result$1.s0.n0.n0.preheader" ]
  ...
  %2391 = getelementptr inbounds float, ptr %"inv_fft1_S8_R8_n1$1.014", i64 %2390
  ...
  %2399 = getelementptr inbounds float, ptr %"inv_fft1_S8_R8_n1$1.014", i64 %2398
...
"end for result$1.s0.n0.n0.loopexit.unr-lcssa":   ; preds = %"for result$1.s0.n0.n0", %"for result$1.s0.n0.n0.preheader"
  %indvars.iv1242.unr = phi i64 [ 0, %"for result$1.s0.n0.n0.preheader" ], [ %indvars.iv.next1243.1, %"for result$1.s0.n0.n0" ]
...
"for result$1.s0.n0.n0.epil":                     ; preds = %"end for result$1.s0.n0.n0.loopexit.unr-lcssa"
  ...
  %2407 = getelementptr inbounds float, ptr %"inv_fft1_S8_R8_n1$1.014", i64 %2406
...
"end for result$1.s0.n0.n0":                      ; preds = %"for result$1.s0.n0.n0.epil", %"end for result$1.s0.n0.n0.loopexit.unr-lcssa", %"for result$1.s0.n1"
  br i1 %873, label %"for result$1.s0.n0.n0104.preheader", label %"end for result$1.s0.n0.n0105", !prof !26

"for result$1.s0.n0.n0104.preheader":             ; preds = %"end for result$1.s0.n0.n0"
  %2412 = shl nsw i64 %indvars.iv1245, 6
  %2413 = add nsw i64 %878, %2412
  %2414 = getelementptr inbounds float, ptr %"inv_fft1_S8_R8_n1$1.014", i64 %2413
  ...
  %reass.mul959 = mul nsw i64 %reass.add958, %248
  %2417 = add nsw i64 %2070, %reass.mul959
  %2418 = getelementptr inbounds float, ptr %60, i64 %2417
  store <8 x float> %2416, ptr %2418, align 4, !tbaa !560
  br label %"end for result$1.s0.n0.n0105"

"end for result$1.s0.n0.n0105":                   ; preds = %"for result$1.s0.n0.n0104.preheader", %"end for result$1.s0.n0.n0"
  %indvars.iv.next1246 = add nsw i64 %indvars.iv1245, 1
  %2419 = trunc i64 %indvars.iv.next1246 to i32
  %.not54 = icmp eq i32 %807, %2419
  br i1 %.not54, label %"end for result$1.s0.n1", label %"for result$1.s0.n1"
}

; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none)
define internal i32 @"par_for__Z84FftConvolve64x64xCHalide_x86_64_linux_avx_c_plus_plus_name_mangling_no_runtime_sse41P15halide_buffer_tS0_S0__kernel_fft1_S8_R8_n1$1.s1.n0.g"(ptr nocapture readnone %__user_context, i32 %"kernel_fft1_S8_R8_n1$1.s1.n0.g", ptr noalias nocapture readonly %closure) #2 {
entry:
  ...
  %6 = sext i32 %5 to i64
  br label %"for kernel_exchange_S1_R8_n1$1.s1.r30371$y"

"for kernel_exchange_S1_R8_n1$1.s1.r30371$y":     ; preds = %entry, %"for kernel_exchange_S1_R8_n1$1.s1.r30371$y"
  %indvars.iv = phi i64 [ 0, %entry ], [ %indvars.iv.next, %"for kernel_exchange_S1_R8_n1$1.s1.r30371$y" ]
  ...
  br i1 %.not, label %"for kernel_fft1_S8_R8_n1$1.s1.r30376$y.preheader", label %"for kernel_exchange_S1_R8_n1$1.s1.r30371$y"

"for kernel_fft1_S8_R8_n1$1.s1.r30376$y.preheader": ; preds = %"for kernel_exchange_S1_R8_n1$1.s1.r30371$y"
  %129 = sext i32 %"kernel_fft1_S8_R8_n1$1.s1.n0.g" to i64
  %130 = shl nsw i64 %129, 3
  br label %"for kernel_fft1_S8_R8_n1$1.s1.r30376$y"

"for kernel_fft1_S8_R8_n1$1.s1.r30376$y":         ; preds = %"for kernel_fft1_S8_R8_n1$1.s1.r30376$y.preheader", %"for kernel_fft1_S8_R8_n1$1.s1.r30376$y"
  %indvars.iv144 = phi i64 [ 0, %"for kernel_fft1_S8_R8_n1$1.s1.r30376$y.preheader" ], [ %indvars.iv.next145, %"for kernel_fft1_S8_R8_n1$1.s1.r30376$y" ]
  ...
  br i1 %.not7, label %destructor_block, label %"for kernel_fft1_S8_R8_n1$1.s1.r30376$y"

destructor_block:                                 ; preds = %"for kernel_fft1_S8_R8_n1$1.s1.r30376$y"
  ret i32 0
}

define i32 @_Z89FftConvolve64x64xCHalide_x86_64_linux_avx_c_plus_plus_name_mangling_no_runtime_sse41_argvPPv(ptr nocapture readonly %0) local_unnamed_addr {
entry:
  ...
  %6 = tail call i32 @_Z84FftConvolve64x64xCHalide_x86_64_linux_avx_c_plus_plus_name_mangling_no_runtime_sse41P15halide_buffer_tS0_S0_(ptr %1, ptr %3, ptr %5) #10
  ret i32 %6
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none)
define nonnull ptr @_Z93FftConvolve64x64xCHalide_x86_64_linux_avx_c_plus_plus_name_mangling_no_runtime_sse41_metadatav() local_unnamed_addr #3 {
entry:
  ret ptr @_Z93FftConvolve64x64xCHalide_x86_64_linux_avx_c_plus_plus_name_mangling_no_runtime_sse41_metadatav_storage
}

; Function Attrs: nounwind
define i32 @_Z84FftConvolve64x64xCHalide_x86_64_linux_avx_c_plus_plus_name_mangling_no_runtime_sse41P8buffer_tS0_S0_(ptr %input, ptr %kernel, ptr %"result$1") local_unnamed_addr #4 {
entry:
  %0 = alloca %struct.halide_buffer_t, align 8
  %t3521 = alloca [12 x i32], align 4
  %1 = alloca %struct.halide_buffer_t, align 8
  %t3517 = alloca [8 x i32], align 4
  %2 = alloca %struct.halide_buffer_t, align 8
  %t3513 = alloca [12 x i32], align 4
  %3 = getelementptr inbounds %struct.halide_buffer_t, ptr %2, i64 0, i32 2
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %t3513, i8 0, i64 48, i1 false)
  ...
  store ptr %t3513, ptr %8, align 8, !tbaa !18
  %9 = getelementptr inbounds %struct.halide_buffer_t, ptr %2, i64 0, i32 3
  store i64 0, ptr %9, align 8, !tbaa !25
  %10 = getelementptr inbounds %struct.halide_buffer_t, ptr %1, i64 0, i32 2
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(32) %t3517, i8 0, i64 32, i1 false)
  ...
  store ptr %t3517, ptr %15, align 8, !tbaa !18
  %16 = getelementptr inbounds %struct.halide_buffer_t, ptr %1, i64 0, i32 3
  store i64 0, ptr %16, align 8, !tbaa !25
  %17 = getelementptr inbounds %struct.halide_buffer_t, ptr %0, i64 0, i32 2
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(48) %t3521, i8 0, i64 48, i1 false)
  ...
  store ptr %t3521, ptr %22, align 8, !tbaa !18
  %23 = getelementptr inbounds %struct.halide_buffer_t, ptr %0, i64 0, i32 3
  store i64 0, ptr %23, align 8, !tbaa !25
  %t3516 = call i32 @halide_upgrade_buffer_t(ptr null, ptr nonnull @str.3, ptr %input, ptr nonnull %2) #8
  %24 = icmp eq i32 %t3516, 0
  br i1 %24, label %"assert succeeded", label %destructor_block, !prof !26

"assert succeeded":                               ; preds = %entry
  %t3520 = call i32 @halide_upgrade_buffer_t(ptr null, ptr nonnull @str.2, ptr %kernel, ptr nonnull %1) #8
  %25 = icmp eq i32 %t3520, 0
  br i1 %25, label %"assert succeeded2", label %destructor_block, !prof !26

destructor_block:                                 ; preds = %false_bb19, %true_bb18, %false_bb12, %true_bb11, %false_bb, %true_bb, %"assert succeeded4", %"assert succeeded2", %"assert succeeded", %entry
  %26 = phi i32 [ %t3516, %entry ], [ %t3520, %"assert succeeded" ], [ %t3524, %"assert succeeded2" ], [ %t3525, %"assert succeeded4" ], [ %t3514, %true_bb ], [ %t3515, %false_bb ], [ %t3518, %true_bb11 ], [ %t3519, %false_bb12 ], [ %t3522, %true_bb18 ], [ %t3523, %false_bb19 ]
  ret i32 %26

"assert succeeded2":                              ; preds = %"assert succeeded"
  %t3524 = call i32 @halide_upgrade_buffer_t(ptr null, ptr nonnull @str, ptr %"result$1", ptr nonnull %0) #8
  %27 = icmp eq i32 %t3524, 0
  br i1 %27, label %"assert succeeded4", label %destructor_block, !prof !26

"assert succeeded4":                              ; preds = %"assert succeeded2"
  %t3525 = call i32 @_Z84FftConvolve64x64xCHalide_x86_64_linux_avx_c_plus_plus_name_mangling_no_runtime_sse41P15halide_buffer_tS0_S0_(ptr nonnull %2, ptr nonnull %1, ptr nonnull %0) #8
  %28 = icmp eq i32 %t3525, 0
...
true_bb:                                          ; preds = %"assert succeeded6"
  %t3514 = call i32 @halide_downgrade_buffer_t(ptr null, ptr nonnull @str.3, ptr nonnull %2, ptr %input) #8
  %33 = icmp eq i32 %t3514, 0
  br i1 %33, label %after_bb, label %destructor_block, !prof !26

false_bb:                                         ; preds = %"assert succeeded6"
  %t3515 = call i32 @halide_downgrade_buffer_t_device_fields(ptr null, ptr nonnull @str.3, ptr nonnull %2, ptr %input) #8
  %34 = icmp eq i32 %t3515, 0
...
true_bb11:                                        ; preds = %after_bb
  %t3518 = call i32 @halide_downgrade_buffer_t(ptr null, ptr nonnull @str.2, ptr nonnull %1, ptr %kernel) #8
  %39 = icmp eq i32 %t3518, 0
  br i1 %39, label %after_bb13, label %destructor_block, !prof !26

false_bb12:                                       ; preds = %after_bb
  %t3519 = call i32 @halide_downgrade_buffer_t_device_fields(ptr null, ptr nonnull @str.2, ptr nonnull %1, ptr %kernel) #8
  %40 = icmp eq i32 %t3519, 0
...
true_bb18:                                        ; preds = %after_bb13
  %t3522 = call i32 @halide_downgrade_buffer_t(ptr null, ptr nonnull @str, ptr nonnull %0, ptr %"result$1") #8
  br label %destructor_block

false_bb19:                                       ; preds = %after_bb13
  %t3523 = call i32 @halide_downgrade_buffer_t_device_fields(ptr null, ptr nonnull @str, ptr nonnull %0, ptr %"result$1") #8
  br label %destructor_block
}
...
!456 = !{!457, !457, i64 0}
!457 = !{!"k$1.0.width8.base64", !458, i64 0}
!458 = !{!"k$1.0.width16.base64", !459, i64 0}
!459 = !{!"k$1.0.width32.base64", !460, i64 0}
!460 = !{!"k$1.0.width64.base64", !461, i64 0}
!461 = !{!"k$1.0.width128.base0", !462, i64 0}
!462 = !{!"k$1.0.width256.base0", !463, i64 0}
!463 = !{!"k$1.0.width512.base0", !464, i64 0}
!464 = !{!"k$1.0.width1024.base0", !315, i64 0}
!465 = !{!466, !466, i64 0}
!466 = !{!"k$1.1.width8.base64", !467, i64 0}
!467 = !{!"k$1.1.width16.base64", !468, i64 0}
!468 = !{!"k$1.1.width32.base64", !469, i64 0}
!469 = !{!"k$1.1.width64.base64", !470, i64 0}
!470 = !{!"k$1.1.width128.base0", !471, i64 0}
!471 = !{!"k$1.1.width256.base0", !472, i64 0}
!472 = !{!"k$1.1.width512.base0", !473, i64 0}
!473 = !{!"k$1.1.width1024.base0", !305, i64 0}
!474 = !{!475, !475, i64 0}
!475 = !{!"k$1.0.width8.base80", !476, i64 0}
!476 = !{!"k$1.0.width16.base80", !459, i64 0}
!477 = !{!478, !478, i64 0}
!478 = !{!"k$1.1.width8.base80", !479, i64 0}
!479 = !{!"k$1.1.width16.base80", !468, i64 0}
!480 = !{!481, !481, i64 0}
!481 = !{!"k$1.0.width8.base56", !482, i64 0}
!482 = !{!"k$1.0.width16.base48", !483, i64 0}
!483 = !{!"k$1.0.width32.base32", !484, i64 0}
!484 = !{!"k$1.0.width64.base0", !461, i64 0}
!485 = !{!486, !486, i64 0}
!486 = !{!"k$1.1.width8.base56", !487, i64 0}
!487 = !{!"k$1.1.width16.base48", !488, i64 0}
!488 = !{!"k$1.1.width32.base32", !489, i64 0}
!489 = !{!"k$1.1.width64.base0", !470, i64 0}
!490 = !{!491, !491, i64 0}
!491 = !{!"k$1.0.width8.base40", !492, i64 0}
!492 = !{!"k$1.0.width16.base32", !483, i64 0}
!493 = !{!494, !494, i64 0}
!494 = !{!"k$1.1.width8.base40", !495, i64 0}
!495 = !{!"k$1.1.width16.base32", !488, i64 0}
!496 = !{!497, !497, i64 0}
!497 = !{!"k$1.0.width8.base72", !458, i64 0}
!498 = !{!499, !499, i64 0}
!499 = !{!"k$1.1.width8.base72", !467, i64 0}
!500 = !{!501, !501, i64 0}
!501 = !{!"k$1.0.width8.base88", !476, i64 0}
!502 = !{!503, !503, i64 0}
!503 = !{!"k$1.1.width8.base88", !479, i64 0}
!504 = !{!505, !505, i64 0}
!505 = !{!"k$1.0.width8.base48", !482, i64 0}
!506 = !{!507, !507, i64 0}
!507 = !{!"k$1.1.width8.base48", !487, i64 0}
!508 = !{!509, !509, i64 0}
!509 = !{!"k$1.0.width8.base32", !492, i64 0}
!510 = !{!511, !511, i64 0}
!511 = !{!"k$1.1.width8.base32", !495, i64 0}
!512 = !{!513, !513, i64 0}
!513 = !{!"k$1.0.width8.base96", !514, i64 0}
!514 = !{!"k$1.0.width16.base96", !515, i64 0}
!515 = !{!"k$1.0.width32.base96", !460, i64 0}
!516 = !{!517, !517, i64 0}
!517 = !{!"k$1.1.width8.base96", !518, i64 0}
!518 = !{!"k$1.1.width16.base96", !519, i64 0}
!519 = !{!"k$1.1.width32.base96", !469, i64 0}
!520 = !{!521, !521, i64 0}
!521 = !{!"k$1.0.width8.base112", !522, i64 0}
!522 = !{!"k$1.0.width16.base112", !515, i64 0}
!523 = !{!524, !524, i64 0}
!524 = !{!"k$1.1.width8.base112", !525, i64 0}
!525 = !{!"k$1.1.width16.base112", !519, i64 0}
!526 = !{!527, !527, i64 0}
!527 = !{!"k$1.0.width8.base24", !528, i64 0}
!528 = !{!"k$1.0.width16.base16", !529, i64 0}
!529 = !{!"k$1.0.width32.base0", !484, i64 0}
!530 = !{!531, !531, i64 0}
!531 = !{!"k$1.1.width8.base24", !532, i64 0}
!532 = !{!"k$1.1.width16.base16", !533, i64 0}
!533 = !{!"k$1.1.width32.base0", !489, i64 0}
!534 = !{!535, !535, i64 0}
!535 = !{!"k$1.0.width8.base8", !536, i64 0}
!536 = !{!"k$1.0.width16.base0", !529, i64 0}
!537 = !{!538, !538, i64 0}
!538 = !{!"k$1.1.width8.base8", !539, i64 0}
!539 = !{!"k$1.1.width16.base0", !533, i64 0}
!540 = !{!541, !541, i64 0}
!541 = !{!"k$1.0.width8.base104", !514, i64 0}
!542 = !{!543, !543, i64 0}
!543 = !{!"k$1.1.width8.base104", !518, i64 0}
!544 = !{!545, !545, i64 0}
!545 = !{!"k$1.0.width8.base120", !522, i64 0}
!546 = !{!547, !547, i64 0}
!547 = !{!"k$1.1.width8.base120", !525, i64 0}
!548 = !{!549, !549, i64 0}
!549 = !{!"k$1.0.width8.base16", !528, i64 0}
!550 = !{!551, !551, i64 0}
!551 = !{!"k$1.1.width8.base16", !532, i64 0}
!552 = !{!553, !553, i64 0}
!553 = !{!"k$1.0.width8.base0", !536, i64 0}
!554 = !{!555, !555, i64 0}
!555 = !{!"k$1.1.width8.base0", !539, i64 0}
!556 = !{!37, !37, i64 0}
!557 = !{!49, !49, i64 0}
!558 = !{!559, !559, i64 0}
!559 = !{!"inv_fft1_S8_R8_n1$1.0", !38, i64 0}
!560 = !{!561, !561, i64 0}
!561 = !{!"result$1", !38, i64 0}
!562 = !{!563, !563, i64 0}
!563 = !{!"kernel_exchange_S1_R8_n1$1.0", !38, i64 0}
!564 = !{!565, !565, i64 0}
!565 = !{!"kernel_exchange_S1_R8_n1$1.1", !38, i64 0}
!566 = !{!222, !222, i64 0}
!567 = !{!233, !233, i64 0}
