; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_suecrypt.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_suecrypt.c"
...
if.end36:                                         ; preds = %if.then21, %for.inc, %for.inc.1, %if.then34, %if.end18
  ...
  %cmp80286.not = icmp eq i16 %sects, 0
  br i1 %cmp80286.not, label %if.end61.us302, label %if.end61.us.preheader
...
if.end61.us:                                      ; preds = %if.end61.us.preheader, %while.cond.us
  ...
  %mul294.us = phi i64 [ 0, %if.end61.us.preheader ], [ %mul.us, %while.cond.us ]
  %idx.ext.us = and i64 %mul294.us, 4294967288
...
if.end77.us:                                      ; preds = %if.end61.us
  ...
  br i1 %cmp86.us, label %if.then142, label %for.body82.us295

for.body82.us295:                                 ; preds = %if.end77.us, %for.inc136.us
...
land.lhs.true94.us:                               ; preds = %for.body82.us295
...
if.end117.us:                                     ; preds = %land.lhs.true99.us
  ...
  %cmp130290.us = icmp ugt i32 %xor74.us, 3
  br i1 %cmp130290.us, label %while.body132.us.preheader, label %for.end138.us
...
while.body132.us.preheader:                       ; preds = %if.end117.us
  ...
  %idxprom.le.us = and i64 %indvars.iv, 4294967295
  %raw.us = getelementptr inbounds %struct.cli_exe_section, ptr %sections, i64 %idxprom.le.us, i32 2
...
while.body132.us.preheader339:                    ; preds = %while.body132.us.preheader, %middle.block
  %sz.1292.us.ph = phi i32 [ %xor74.us, %while.body132.us.preheader ], [ %ind.end, %middle.block ]
  %hunk.0291.us.ph = phi ptr [ %add.ptr128.us, %while.body132.us.preheader ], [ %ind.end333, %middle.block ]
...
while.body132.us:                                 ; preds = %while.body132.us.preheader339, %while.body132.us
  %sz.1292.us = phi i32 [ %sub.us, %while.body132.us ], [ %sz.1292.us.ph, %while.body132.us.preheader339 ]
  %hunk.0291.us = phi ptr [ %add.ptr135.us, %while.body132.us ], [ %hunk.0291.us.ph, %while.body132.us.preheader339 ]
  %hunk.0.val.us = load i32, ptr %hunk.0291.us, align 1
  %xor134.us = xor i32 %hunk.0.val.us, %key.2
  store i32 %xor134.us, ptr %hunk.0291.us, align 1
  %add.ptr135.us = getelementptr inbounds i8, ptr %hunk.0291.us, i64 4
  %sub.us = add i32 %sz.1292.us, -4
  %cmp130.us = icmp ugt i32 %sub.us, 3
  br i1 %cmp130.us, label %while.body132.us, label %for.end138.us, !llvm.loop !16

for.inc136.us:                                    ; preds = %land.lhs.true99.us, %land.lhs.true94.us, %for.body82.us295
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %if.then142, label %for.body82.us295, !llvm.loop !17

if.end61.us302:                                   ; preds = %if.end36
  %add.ptr38.ptr.ptr.us307 = getelementptr inbounds i8, ptr %buff, i64 -88
  %add.ptr38.ptr.ptr.val.us308 = load i32, ptr %add.ptr38.ptr.ptr.us307, align 1
  %xor67.us309 = xor i32 %add.ptr38.ptr.ptr.val.us308, %bkey
  %tobool75.not.us313 = icmp eq i32 %xor67.us309, 0
  br i1 %tobool75.not.us313, label %while.end145, label %if.end77.us314

if.end77.us314:                                   ; preds = %if.end61.us302
  %add.ptr72.val.us311 = load i32, ptr %add.ptr69, align 1
  %xor74.us312 = xor i32 %add.ptr72.val.us311, %bkey
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.5, i32 noundef 0, i32 noundef %xor67.us309, i32 noundef %xor74.us312) #6
  br label %if.then142
...
if.then142:                                       ; preds = %if.end77.us, %for.end138.us, %for.inc136.us, %if.end77.us314
  tail call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.6) #6
  tail call void @free(ptr noundef %call) #6
  br label %cleanup

while.end145:                                     ; preds = %if.end61.us, %if.end61.us302
