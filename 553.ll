; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/me_umhex.c"
...
if.then36:                                        ; preds = %if.end34
  %9 = load i32, ptr %block_a, align 4, !tbaa !94
...
cond.end43:                                       ; preds = %if.then36, %cond.true39
  ...
  %14 = load i32, ptr %block_b, align 4, !tbaa !94
...
cond.end56:                                       ; preds = %cond.end43, %cond.true47
  ...
  %19 = load i32, ptr %block_c, align 4, !tbaa !94
...
if.else71:                                        ; preds = %if.end34
  ...
  %27 = load i32, ptr %block_a, align 4, !tbaa !94
...
cond.end105:                                      ; preds = %cond.true79, %if.then76
  ...
  %34 = load i32, ptr %block_b, align 4, !tbaa !94
...
cond.end136:                                      ; preds = %cond.true109, %cond.end105
  ...
  %41 = load i32, ptr %block_c, align 4, !tbaa !94
...
cond.end198:                                      ; preds = %if.else169, %cond.true179, %cond.false187
  ...
  %55 = load i32, ptr %block_b, align 4, !tbaa !94
...
cond.end229:                                      ; preds = %cond.end198, %cond.true209, %cond.false218
  ...
  %63 = load i32, ptr %block_c, align 4, !tbaa !94
...
if.else275:                                       ; preds = %if.end263
  ...
  %brmerge = select i1 %or.cond991.not, i1 true, i1 %cmp265
...
if.then474:                                       ; preds = %cond.end464, %lor.lhs.false.if.end466_crit_edge
  ...
  %tobool741 = icmp ne i32 %72, 0
  %tobool744 = icmp ne i32 %71, 0
  %or.cond862 = select i1 %tobool741, i1 true, i1 %tobool744
  ...
  %117 = load i32, ptr @UMHEX_blocktype, align 4
  %idxprom813 = sext i32 %117 to i64
...
cond.true477:                                     ; preds = %if.then474
  %118 = load ptr, ptr %arrayidx540, align 8, !tbaa !9
  %arrayidx483 = getelementptr inbounds ptr, ptr %118, i64 %idxprom542
  %119 = load ptr, ptr %arrayidx483, align 8, !tbaa !9
  %120 = load i16, ptr %119, align 2, !tbaa !30
  %conv486 = sext i16 %120 to i32
...
cond.true492:                                     ; preds = %cond.end488
  %121 = load ptr, ptr %arrayidx574, align 8, !tbaa !9
  %arrayidx498 = getelementptr inbounds ptr, ptr %121, i64 %idxprom576
  %122 = load ptr, ptr %arrayidx498, align 8, !tbaa !9
  %123 = load i16, ptr %122, align 2, !tbaa !30
  %conv501 = sext i16 %123 to i32
...
cond.true507:                                     ; preds = %cond.end503
  %124 = load ptr, ptr %arrayidx609, align 8, !tbaa !9
  %arrayidx513 = getelementptr inbounds ptr, ptr %124, i64 %idxprom611
  %125 = load ptr, ptr %arrayidx513, align 8, !tbaa !9
  %126 = load i16, ptr %125, align 2, !tbaa !30
  %conv516 = sext i16 %126 to i32
  br label %if.end739
...
sw.bb:                                            ; preds = %if.end739
  br i1 %or.cond862, label %if.else746, label %sw.epilog
...
if.else746:                                       ; preds = %sw.bb
  ...
  %127 = add nsw i32 %cond.i999, %cond.i997
  %sub753 = sub nsw i32 %add747, %127
  br label %sw.epilog
...
if.then771:                                       ; preds = %if.then763
  %128 = load i32, ptr %search_range800, align 4, !tbaa !20
  br label %for.inc
...
if.end805:                                        ; preds = %if.then795, %if.else799, %if.then788
  ...
  %cond.i1009 = call i32 @llvm.smin.i32(i32 %131, i32 %cond.i1008)
  %132 = load i32, ptr %arrayidx814, align 4, !tbaa !19
  %cmp815 = icmp sgt i32 %cond.i1011, %132
  %spec.store.select = select i1 %cmp815, i32 %131, i32 %cond.i1009
  br label %for.inc

for.inc:                                          ; preds = %if.end805, %sw.epilog, %if.then771
  %dsr_temp_search_range.sroa.0.0 = phi i32 [ undef, %sw.epilog ], [ %128, %if.then771 ], [ %spec.store.select, %if.end805 ]
  br i1 %tobool35.not, label %if.then474.1, label %if.else520.1

if.else520.1:                                     ; preds = %for.inc
  %133 = load ptr, ptr %mb_data521, align 8, !tbaa !25
  %134 = load i32, ptr %current_mb_nr522, align 4, !tbaa !26
  %idxprom523.1 = sext i32 %134 to i64
  %mb_field525.1 = getelementptr inbounds %struct.macroblock, ptr %133, i64 %idxprom523.1, i32 19
  %135 = load i32, ptr %mb_field525.1, align 8, !tbaa !27
  %tobool526.not.1 = icmp eq i32 %135, 0
...
cond.true530.1:                                   ; preds = %if.then527.1
  %mb_field535.1 = getelementptr inbounds %struct.macroblock, ptr %133, i64 %idxprom533, i32 19
  %136 = load i32, ptr %mb_field535.1, align 8, !tbaa !27
  %tobool536.not.1 = icmp eq i32 %136, 0
  %137 = load ptr, ptr %arrayidx540, align 8, !tbaa !9
  %arrayidx553.1 = getelementptr inbounds ptr, ptr %137, i64 %idxprom542
  %138 = load ptr, ptr %arrayidx553.1, align 8, !tbaa !9
  %arrayidx555.1 = getelementptr inbounds i16, ptr %138, i64 1
  %139 = load i16, ptr %arrayidx555.1, align 2, !tbaa !30
  br i1 %tobool536.not.1, label %cond.false547.1, label %cond.true537.1

cond.true537.1:                                   ; preds = %cond.true530.1
  %conv546.1 = sext i16 %139 to i32
  br label %cond.end560.1

cond.false547.1:                                  ; preds = %cond.true530.1
  %140 = sdiv i16 %139, 2
  %div.1 = sext i16 %140 to i32
  br label %cond.end560.1
...
cond.true564.1:                                   ; preds = %cond.end560.1
  %mb_field569.1 = getelementptr inbounds %struct.macroblock, ptr %133, i64 %idxprom567, i32 19
  %141 = load i32, ptr %mb_field569.1, align 8, !tbaa !27
  %tobool570.not.1 = icmp eq i32 %141, 0
  %142 = load ptr, ptr %arrayidx574, align 8, !tbaa !9
  %arrayidx587.1 = getelementptr inbounds ptr, ptr %142, i64 %idxprom576
  %143 = load ptr, ptr %arrayidx587.1, align 8, !tbaa !9
  %arrayidx589.1 = getelementptr inbounds i16, ptr %143, i64 1
  %144 = load i16, ptr %arrayidx589.1, align 2, !tbaa !30
  br i1 %tobool570.not.1, label %cond.false581.1, label %cond.true571.1

cond.true571.1:                                   ; preds = %cond.true564.1
  %conv580.1 = sext i16 %144 to i32
  br label %cond.end595.1

cond.false581.1:                                  ; preds = %cond.true564.1
  %145 = sdiv i16 %144, 2
  %div591.1 = sext i16 %145 to i32
  br label %cond.end595.1
...
cond.true599.1:                                   ; preds = %cond.end595.1
  %mb_field604.1 = getelementptr inbounds %struct.macroblock, ptr %133, i64 %idxprom602, i32 19
  %146 = load i32, ptr %mb_field604.1, align 8, !tbaa !27
  %tobool605.not.1 = icmp eq i32 %146, 0
  %147 = load ptr, ptr %arrayidx609, align 8, !tbaa !9
  %arrayidx622.1 = getelementptr inbounds ptr, ptr %147, i64 %idxprom611
  %148 = load ptr, ptr %arrayidx622.1, align 8, !tbaa !9
  %arrayidx624.1 = getelementptr inbounds i16, ptr %148, i64 1
  %149 = load i16, ptr %arrayidx624.1, align 2, !tbaa !30
  br i1 %tobool605.not.1, label %cond.false616.1, label %cond.true606.1

cond.true606.1:                                   ; preds = %cond.true599.1
  %conv615.1 = sext i16 %149 to i32
  br label %if.end739.1

cond.false616.1:                                  ; preds = %cond.true599.1
  %150 = sdiv i16 %149, 2
  %div626.1 = sext i16 %150 to i32
  br label %if.end739.1
...
cond.true635.1:                                   ; preds = %if.else632.1
  %mb_field640.1 = getelementptr inbounds %struct.macroblock, ptr %133, i64 %idxprom533, i32 19
  %151 = load i32, ptr %mb_field640.1, align 8, !tbaa !27
  %tobool641.not.1 = icmp ne i32 %151, 0
  %152 = load ptr, ptr %arrayidx540, align 8, !tbaa !9
  %arrayidx659.1 = getelementptr inbounds ptr, ptr %152, i64 %idxprom542
  %153 = load ptr, ptr %arrayidx659.1, align 8, !tbaa !9
  %arrayidx661.1 = getelementptr inbounds i16, ptr %153, i64 1
  %154 = load i16, ptr %arrayidx661.1, align 2, !tbaa !30
  %conv662.1 = sext i16 %154 to i32
...
cond.true670.1:                                   ; preds = %cond.end666.1
  %mb_field675.1 = getelementptr inbounds %struct.macroblock, ptr %133, i64 %idxprom567, i32 19
  %155 = load i32, ptr %mb_field675.1, align 8, !tbaa !27
  %tobool676.not.1 = icmp ne i32 %155, 0
  %156 = load ptr, ptr %arrayidx574, align 8, !tbaa !9
  %arrayidx694.1 = getelementptr inbounds ptr, ptr %156, i64 %idxprom576
  %157 = load ptr, ptr %arrayidx694.1, align 8, !tbaa !9
  %arrayidx696.1 = getelementptr inbounds i16, ptr %157, i64 1
  %158 = load i16, ptr %arrayidx696.1, align 2, !tbaa !30
  %conv697.1 = sext i16 %158 to i32
...
cond.true705.1:                                   ; preds = %cond.end701.1
  %mb_field710.1 = getelementptr inbounds %struct.macroblock, ptr %133, i64 %idxprom602, i32 19
  %159 = load i32, ptr %mb_field710.1, align 8, !tbaa !27
  %tobool711.not.1 = icmp ne i32 %159, 0
  %160 = load ptr, ptr %arrayidx609, align 8, !tbaa !9
  %arrayidx729.1 = getelementptr inbounds ptr, ptr %160, i64 %idxprom611
  %161 = load ptr, ptr %arrayidx729.1, align 8, !tbaa !9
  %arrayidx731.1 = getelementptr inbounds i16, ptr %161, i64 1
  %162 = load i16, ptr %arrayidx731.1, align 2, !tbaa !30
  %conv732.1 = sext i16 %162 to i32
...
cond.true477.1:                                   ; preds = %if.then474.1
  %163 = load ptr, ptr %arrayidx540, align 8, !tbaa !9
  %arrayidx483.1 = getelementptr inbounds ptr, ptr %163, i64 %idxprom542
  %164 = load ptr, ptr %arrayidx483.1, align 8, !tbaa !9
  %arrayidx485.1 = getelementptr inbounds i16, ptr %164, i64 1
  %165 = load i16, ptr %arrayidx485.1, align 2, !tbaa !30
  %conv486.1 = sext i16 %165 to i32
...
cond.true492.1:                                   ; preds = %cond.end488.1
  %166 = load ptr, ptr %arrayidx574, align 8, !tbaa !9
  %arrayidx498.1 = getelementptr inbounds ptr, ptr %166, i64 %idxprom576
  %167 = load ptr, ptr %arrayidx498.1, align 8, !tbaa !9
  %arrayidx500.1 = getelementptr inbounds i16, ptr %167, i64 1
  %168 = load i16, ptr %arrayidx500.1, align 2, !tbaa !30
  %conv501.1 = sext i16 %168 to i32
...
cond.true507.1:                                   ; preds = %cond.end503.1
  %169 = load ptr, ptr %arrayidx609, align 8, !tbaa !9
  %arrayidx513.1 = getelementptr inbounds ptr, ptr %169, i64 %idxprom611
  %170 = load ptr, ptr %arrayidx513.1, align 8, !tbaa !9
  %arrayidx515.1 = getelementptr inbounds i16, ptr %170, i64 1
  %171 = load i16, ptr %arrayidx515.1, align 2, !tbaa !30
  %conv516.1 = sext i16 %171 to i32
  br label %if.end739.1
...
sw.bb.1:                                          ; preds = %if.end739.1
  br i1 %or.cond862, label %if.else746.1, label %sw.epilog.1
...
if.else746.1:                                     ; preds = %sw.bb.1
  ...
  %172 = add i32 %cond.i999.1, %cond.i997.1
  %sub753.1 = sub i32 %add747.1, %172
  br label %sw.epilog.1
...
if.end805.1:                                      ; preds = %if.then788.1, %if.then795.1, %if.else799.1
  ...
  %cond.i1009.1 = call i32 @llvm.smin.i32(i32 %175, i32 %cond.i1008.1)
  %176 = load i32, ptr %arrayidx814, align 4, !tbaa !19
  %cmp815.1 = icmp sgt i32 %cond.i1011, %176
  %spec.store.select.1 = select i1 %cmp815.1, i32 %175, i32 %cond.i1009.1
  br label %if.then826

if.then771.1:                                     ; preds = %if.then763.1
  %177 = load i32, ptr %search_range800, align 4, !tbaa !20
  br label %if.then826

if.then826:                                       ; preds = %if.then771.1, %if.end805.1
  %dsr_temp_search_range.sroa.6.0.ph = phi i32 [ %spec.store.select.1, %if.end805.1 ], [ %177, %if.then771.1 ]
  ...
  %178 = load i32, ptr %full_search, align 4, !tbaa !101
  switch i32 %178, label %if.else842 [
...
if.else842:                                       ; preds = %if.then826
  ...
  %179 = load i32, ptr %arrayidx853, align 4, !tbaa !19
  %cond.i1015 = call i32 @llvm.smin.i32(i32 %179, i32 2)
