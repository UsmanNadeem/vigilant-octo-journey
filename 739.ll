; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/FreeBench/pcompress2/unarithmetic.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/FreeBench/pcompress2/unarithmetic.c"
...
for.cond:                                         ; preds = %input_bit.exit.i, %for.cond.backedge
  ...
  %sub1.i = sub i64 1, %mul46.i48
  %add2.i = add i64 %sub1.i, %add51.i50
