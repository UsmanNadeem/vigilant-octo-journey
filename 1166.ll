; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mafft/fftFunctions.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mafft/fftFunctions.c"
...
for.body172:                                      ; preds = %for.body172.preheader, %for.inc228
  %74 = phi i32 [ %62, %for.body172.preheader ], [ %87, %for.inc228 ]
  %75 = phi double [ %.pre439, %for.body172.preheader ], [ %88, %for.inc228 ]
  %76 = phi ptr [ %.pre437, %for.body172.preheader ], [ %89, %for.inc228 ]
...
if.then184:                                       ; preds = %for.body172
  ...
  %length.0.op = add nsw i32 %length.0385, 1
  %inc188 = select i1 %tobool185.not, i32 1, i32 %length.0.op
...
if.then200:                                       ; preds = %if.then197
  ...
  %82 = trunc i64 %indvars.iv431 to i32
  store i32 %82, ptr %end, align 4, !tbaa !61
  %add203 = add nsw i32 %starttmp.2, %82
  %83 = load i32, ptr @fftWinSize, align 4, !tbaa !22
  %add204 = add nsw i32 %add203, %83
  ...
  %84 = getelementptr inbounds %struct._Segment, ptr %seg.addr.0384, i64 0, i32 4
  store i32 %spec.select, ptr %84, align 8
  %85 = getelementptr inbounds %struct._Segment, ptr %seg.addr.0384, i64 1, i32 5
...
if.end221:                                        ; preds = %if.then197.if.end221_crit_edge, %if.then200
  %.pre-phi = phi i32 [ %.pre441, %if.then197.if.end221_crit_edge ], [ %82, %if.then200 ]
  %86 = phi i32 [ %74, %if.then197.if.end221_crit_edge ], [ %83, %if.then200 ]
...
for.inc228:                                       ; preds = %if.end190, %if.end221, %if.then224
  %87 = phi i32 [ %.pre440, %if.then224 ], [ %86, %if.end221 ], [ %74, %if.end190 ]
  %88 = phi double [ %.pre438, %if.then224 ], [ %75, %if.end221 ], [ %75, %if.end190 ]
  %89 = phi ptr [ %.pre, %if.then224 ], [ %76, %if.end221 ], [ %76, %if.end190 ]
  ...
  %sub = sub nsw i32 %conv, %87
  %90 = sext i32 %sub to i64
  %cmp170 = icmp slt i64 %indvars.iv.next432, %90
...
for.end230:                                       ; preds = %for.inc228
  ...
  %cmp232 = icmp sgt i32 %length.3, %87
...
if.then234:                                       ; preds = %for.end230
  %91 = trunc i64 %indvars.iv.next432 to i32
  %end235 = getelementptr inbounds %struct._Segment, ptr %seg.addr.2, i64 0, i32 1
  store i32 %91, ptr %end235, align 4, !tbaa !61
  store i32 %starttmp.3, ptr %seg.addr.2, align 8, !tbaa !60
  %add237 = add nsw i32 %starttmp.3, %91
  %92 = load i32, ptr @fftWinSize, align 4, !tbaa !22
  %add238 = add nsw i32 %add237, %92
...
; Function Attrs: nounwind uwtable
define dso_local void @blockAlign2(ptr nocapture noundef %cut1, ptr nocapture noundef %cut2, ptr nocapture noundef readonly %seg1, ptr nocapture noundef readonly %seg2, ptr nocapture noundef readonly %ocrossscore, ptr nocapture noundef %ncut) local_unnamed_addr #6 {
entry:
...
for.cond42.preheader:                             ; preds = %for.cond42.preheader.preheader, %for.inc158
  %indvar571 = phi i32 [ 0, %for.cond42.preheader.preheader ], [ %indvar.next572, %for.inc158 ]
  %32 = phi i32 [ %8, %for.cond42.preheader.preheader ], [ %96, %for.inc158 ]
...
for.body44.lr.ph:                                 ; preds = %for.cond42.preheader
  %36 = add nsw i64 %indvars.iv518, -1
  %arrayidx67 = getelementptr inbounds ptr, ptr %30, i64 %36
  %cmp83428 = icmp ugt i64 %indvars.iv518, 2
  %37 = load ptr, ptr %arrayidx67, align 8, !tbaa !5
  %arrayidx129 = getelementptr inbounds ptr, ptr %31, i64 %indvars.iv518
  %38 = load ptr, ptr %arrayidx129, align 8, !tbaa !5
  %arrayidx151 = getelementptr inbounds ptr, ptr %30, i64 %indvars.iv518
  %39 = load ptr, ptr %arrayidx151, align 8, !tbaa !5
  %40 = trunc i64 %indvars.iv518 to i32
  %xtraiter573 = and i64 %35, 1
  %41 = icmp eq i32 %34, 1
  %unroll_iter578 = and i64 %35, 4294967294
  %lcmp.mod575.not = icmp eq i64 %xtraiter573, 0
  %xtraiter580 = and i64 %33, 1
  %42 = icmp eq i32 %indvars.iv504, 1
  %unroll_iter585 = and i64 %33, 4294967294
  %lcmp.mod582.not = icmp eq i64 %xtraiter580, 0
  br label %for.body44

for.body44:                                       ; preds = %for.body44.lr.ph, %for.end118
  %indvar = phi i32 [ 0, %for.body44.lr.ph ], [ %indvar.next, %for.end118 ]
  %indvars.iv513 = phi i64 [ 1, %for.body44.lr.ph ], [ %indvars.iv.next514, %for.end118 ]
  %43 = phi i32 [ %32, %for.body44.lr.ph ], [ %94, %for.end118 ]
  %44 = phi double [ %add121.lcssa458460, %for.body44.lr.ph ], [ %add121, %for.end118 ]
  %45 = add i32 %indvar, -1
...
for.body47.lr.ph:                                 ; preds = %for.body44
  %sub49 = add nsw i32 %43, -1
  %47 = sext i32 %sub49 to i64
  %cmp53 = icmp slt i64 %indvars.iv513, %47
...
for.body47.preheader:                             ; preds = %for.body47.lr.ph
  %xtraiter567 = and i64 %46, 1
  %48 = icmp eq i32 %45, 1
  br i1 %48, label %for.end80.loopexit.unr-lcssa, label %for.body47.preheader.new
...
if.end64.us.peel:                                 ; preds = %for.body47.lr.ph
  %49 = load double, ptr %37, align 8, !tbaa !9
  %cmp70.us.peel = fcmp ogt double %49, %44
  %50 = select i1 %cmp70.us.peel, double %49, double 0.000000e+00
  br label %for.end80
...
for.body47:                                       ; preds = %for.body47, %for.body47.preheader.new
  ...
  %51 = phi double [ 0.000000e+00, %for.body47.preheader.new ], [ %56, %for.body47 ]
  ...
  %arrayidx69 = getelementptr inbounds double, ptr %37, i64 %indvars.iv488
  %52 = load double, ptr %arrayidx69, align 8, !tbaa !9
  %cmp70 = fcmp ogt double %52, %44
  %53 = select i1 %cmp70, double %52, double %51
  %54 = trunc i64 %indvars.iv488 to i32
  %k.0427.us432 = select i1 %cmp70, i32 %54, i32 %k.0427.us433
  %indvars.iv.next489 = or i64 %indvars.iv488, 1
  %arrayidx69.1 = getelementptr inbounds double, ptr %37, i64 %indvars.iv.next489
  %55 = load double, ptr %arrayidx69.1, align 8, !tbaa !9
  %cmp70.1 = fcmp ogt double %55, %44
  %56 = select i1 %cmp70.1, double %55, double %53
  %57 = trunc i64 %indvars.iv.next489 to i32
  %k.0427.us432.1 = select i1 %cmp70.1, i32 %57, i32 %k.0427.us432
...
for.end80.loopexit.unr-lcssa:                     ; preds = %for.body47, %for.body47.preheader
  %.lcssa562.ph = phi double [ undef, %for.body47.preheader ], [ %56, %for.body47 ]
  ...
  %.unr = phi double [ 0.000000e+00, %for.body47.preheader ], [ %56, %for.body47 ]
...
for.body47.epil:                                  ; preds = %for.end80.loopexit.unr-lcssa
  %arrayidx69.epil = getelementptr inbounds double, ptr %37, i64 %indvars.iv488.unr
  %58 = load double, ptr %arrayidx69.epil, align 8, !tbaa !9
  %cmp70.epil = fcmp ogt double %58, %44
  %59 = select i1 %cmp70.epil, double %58, double %.unr
  %60 = trunc i64 %indvars.iv488.unr to i32
  %k.0427.us432.epil = select i1 %cmp70.epil, i32 %60, i32 %k.0427.us433.unr
  br label %for.end80
...
for.end80:                                        ; preds = %for.body47.epil, %for.end80.loopexit.unr-lcssa, %if.end64.us.peel, %for.body44
  ...
  %61 = phi double [ 0.000000e+00, %for.body44 ], [ %50, %if.end64.us.peel ], [ %.lcssa562.ph, %for.end80.loopexit.unr-lcssa ], [ %59, %for.body47.epil ]
...
for.body84.lr.ph:                                 ; preds = %for.end80
  %sub87 = add nsw i32 %43, -1
  %62 = sext i32 %sub87 to i64
  %cmp91 = icmp slt i64 %indvars.iv518, %62
  %63 = add nsw i64 %indvars.iv513, -1
...
for.body84.us.preheader:                          ; preds = %for.body84.lr.ph
  br i1 %41, label %for.end118.loopexit561.unr-lcssa, label %for.body84.us

for.body84.preheader:                             ; preds = %for.body84.lr.ph
  br i1 %42, label %for.end118.loopexit.unr-lcssa, label %for.body84
...
for.body84.us:                                    ; preds = %for.body84.us.preheader, %for.body84.us
  ...
  %64 = phi double [ %72, %for.body84.us ], [ 0.000000e+00, %for.body84.us.preheader ]
  %niter579 = phi i64 [ %niter579.next.1, %for.body84.us ], [ 0, %for.body84.us.preheader ]
  %arrayidx104.us = getelementptr inbounds ptr, ptr %30, i64 %indvars.iv501
  %65 = load ptr, ptr %arrayidx104.us, align 8, !tbaa !5
  %arrayidx107.us = getelementptr inbounds double, ptr %65, i64 %63
  %66 = load double, ptr %arrayidx107.us, align 8, !tbaa !9
  %cmp108.us = fcmp ogt double %66, %64
  %67 = trunc i64 %indvars.iv501 to i32
  %k.1429.us438 = select i1 %cmp108.us, i32 %67, i32 %k.1429.us439
  %68 = select i1 %cmp108.us, double %66, double %64
  %indvars.iv.next502 = or i64 %indvars.iv501, 1
  %arrayidx104.us.1 = getelementptr inbounds ptr, ptr %30, i64 %indvars.iv.next502
  %69 = load ptr, ptr %arrayidx104.us.1, align 8, !tbaa !5
  %arrayidx107.us.1 = getelementptr inbounds double, ptr %69, i64 %63
  %70 = load double, ptr %arrayidx107.us.1, align 8, !tbaa !9
  %cmp108.us.1 = fcmp ogt double %70, %68
  %71 = trunc i64 %indvars.iv.next502 to i32
  %k.1429.us438.1 = select i1 %cmp108.us.1, i32 %71, i32 %k.1429.us438
  %72 = select i1 %cmp108.us.1, double %70, double %68
  %indvars.iv.next502.1 = add nuw nsw i64 %indvars.iv501, 2
  %niter579.next.1 = add i64 %niter579, 2
  %niter579.ncmp.1 = icmp eq i64 %niter579.next.1, %unroll_iter578
  br i1 %niter579.ncmp.1, label %for.end118.loopexit561.unr-lcssa, label %for.body84.us, !llvm.loop !81
...
for.body84:                                       ; preds = %for.body84.preheader, %for.inc116.1
  ...
  %73 = phi double [ %81, %for.inc116.1 ], [ 0.000000e+00, %for.body84.preheader ]
  %niter586 = phi i64 [ %niter586.next.1, %for.inc116.1 ], [ 0, %for.body84.preheader ]
  %tobool85.not = icmp ne i64 %indvars.iv508, 0
  %cmp88 = icmp slt i64 %indvars.iv508, %62
...
if.end102:                                        ; preds = %for.body84
  ...
  %74 = load ptr, ptr %arrayidx104, align 8, !tbaa !5
  %arrayidx107 = getelementptr inbounds double, ptr %74, i64 %63
  %75 = load double, ptr %arrayidx107, align 8, !tbaa !9
  %cmp108 = fcmp ogt double %75, %73
  br i1 %cmp108, label %if.then109, label %for.inc116

if.then109:                                       ; preds = %if.end102
  %76 = trunc i64 %indvars.iv508 to i32
  br label %for.inc116

for.inc116:                                       ; preds = %for.body84, %if.end102, %if.then109
  %k.1429.us440 = phi i32 [ %k.1429.us441, %if.end102 ], [ %76, %if.then109 ], [ %k.1429.us441, %for.body84 ]
  %77 = phi double [ %73, %if.end102 ], [ %75, %if.then109 ], [ %73, %for.body84 ]
  %indvars.iv.next509 = or i64 %indvars.iv508, 1
  %cmp88.1 = icmp slt i64 %indvars.iv.next509, %62
...
if.end102.1:                                      ; preds = %for.inc116
  ...
  %78 = load ptr, ptr %arrayidx104.1, align 8, !tbaa !5
  %arrayidx107.1 = getelementptr inbounds double, ptr %78, i64 %63
  %79 = load double, ptr %arrayidx107.1, align 8, !tbaa !9
  %cmp108.1 = fcmp ogt double %79, %77
  br i1 %cmp108.1, label %if.then109.1, label %for.inc116.1

if.then109.1:                                     ; preds = %if.end102.1
  %80 = trunc i64 %indvars.iv.next509 to i32
  br label %for.inc116.1

for.inc116.1:                                     ; preds = %if.then109.1, %if.end102.1, %for.inc116
  %k.1429.us440.1 = phi i32 [ %k.1429.us440, %if.end102.1 ], [ %80, %if.then109.1 ], [ %k.1429.us440, %for.inc116 ]
  %81 = phi double [ %77, %if.end102.1 ], [ %79, %if.then109.1 ], [ %77, %for.inc116 ]
  ...
  br i1 %niter586.ncmp.1, label %for.end118.loopexit.unr-lcssa, label %for.body84, !llvm.loop !81
...
for.end118.loopexit.unr-lcssa:                    ; preds = %for.inc116.1, %for.body84.preheader
  ...
  %.lcssa564.ph = phi double [ undef, %for.body84.preheader ], [ %81, %for.inc116.1 ]
  ...
  %.unr581 = phi double [ 0.000000e+00, %for.body84.preheader ], [ %81, %for.inc116.1 ]
  br i1 %lcmp.mod582.not, label %for.end118, label %for.body84.epil

for.body84.epil:                                  ; preds = %for.end118.loopexit.unr-lcssa
  %tobool85.not.epil = icmp ne i64 %indvars.iv508.unr, 0
  %cmp88.epil = icmp slt i64 %indvars.iv508.unr, %62
...
if.end102.epil:                                   ; preds = %for.body84.epil
  ...
  %82 = load ptr, ptr %arrayidx104.epil, align 8, !tbaa !5
  %arrayidx107.epil = getelementptr inbounds double, ptr %82, i64 %63
  %83 = load double, ptr %arrayidx107.epil, align 8, !tbaa !9
  %cmp108.epil = fcmp ogt double %83, %.unr581
  br i1 %cmp108.epil, label %if.then109.epil, label %for.end118

if.then109.epil:                                  ; preds = %if.end102.epil
  %84 = trunc i64 %indvars.iv508.unr to i32
  br label %for.end118
...
for.end118.loopexit561.unr-lcssa:                 ; preds = %for.body84.us, %for.body84.us.preheader
  ...
  %.lcssa563.ph = phi double [ undef, %for.body84.us.preheader ], [ %72, %for.body84.us ]
  ...
  %.unr574 = phi double [ 0.000000e+00, %for.body84.us.preheader ], [ %72, %for.body84.us ]
  br i1 %lcmp.mod575.not, label %for.end118, label %for.body84.us.epil
...
for.body84.us.epil:                               ; preds = %for.end118.loopexit561.unr-lcssa
  ...
  %85 = load ptr, ptr %arrayidx104.us.epil, align 8, !tbaa !5
  %arrayidx107.us.epil = getelementptr inbounds double, ptr %85, i64 %63
  %86 = load double, ptr %arrayidx107.us.epil, align 8, !tbaa !9
  %cmp108.us.epil = fcmp ogt double %86, %.unr574
  %87 = trunc i64 %indvars.iv501.unr to i32
  %k.1429.us438.epil = select i1 %cmp108.us.epil, i32 %87, i32 %k.1429.us439.unr
  %88 = select i1 %cmp108.us.epil, double %86, double %.unr574
  br label %for.end118
...
for.end118:                                       ; preds = %for.body84.us.epil, %for.end118.loopexit561.unr-lcssa, %for.end118.loopexit.unr-lcssa, %if.then109.epil, %if.end102.epil, %for.body84.epil, %for.end80.for.end118_crit_edge
  %.pre-phi = phi i64 [ %.pre531, %for.end80.for.end118_crit_edge ], [ %63, %for.body84.epil ], [ %63, %if.end102.epil ], [ %63, %if.then109.epil ], [ %63, %for.end118.loopexit.unr-lcssa ], [ %63, %for.end118.loopexit561.unr-lcssa ], [ %63, %for.body84.us.epil ]
  %k.1429.us451 = phi i32 [ 0, %for.end80.for.end118_crit_edge ], [ %k.1429.us440.lcssa.ph, %for.end118.loopexit.unr-lcssa ], [ %k.1429.us441.unr, %if.end102.epil ], [ %84, %if.then109.epil ], [ %k.1429.us441.unr, %for.body84.epil ], [ %k.1429.us438.lcssa.ph, %for.end118.loopexit561.unr-lcssa ], [ %k.1429.us438.epil, %for.body84.us.epil ]
  %89 = phi double [ 0.000000e+00, %for.end80.for.end118_crit_edge ], [ %.lcssa564.ph, %for.end118.loopexit.unr-lcssa ], [ %.unr581, %if.end102.epil ], [ %83, %if.then109.epil ], [ %.unr581, %for.body84.epil ], [ %.lcssa563.ph, %for.end118.loopexit561.unr-lcssa ], [ %88, %for.body84.us.epil ]
  %90 = load i32, ptr @penalty, align 4, !tbaa !22
  %conv = sitofp i32 %90 to double
  %add119 = fadd double %61, %conv
  %add121 = fadd double %89, %conv
  %arrayidx127 = getelementptr inbounds double, ptr %37, i64 %.pre-phi
  %91 = load double, ptr %arrayidx127, align 8, !tbaa !9
  %arrayidx131 = getelementptr inbounds i32, ptr %38, i64 %indvars.iv513
  %cmp132 = fcmp olt double %91, %add119
  %maximum.0 = select i1 %cmp132, double %add119, double %91
  %cmp141 = fcmp olt double %maximum.0, %add121
  %maximum.1 = select i1 %cmp141, double %add121, double %maximum.0
  %sub144 = sub nsw i32 %k.1429.us451, %40
  %92 = trunc i64 %indvars.iv513 to i32
  %sub135 = sub nsw i32 %92, %k.0427.us449
  ...
  %arrayidx153 = getelementptr inbounds double, ptr %39, i64 %indvars.iv513
  %93 = load double, ptr %arrayidx153, align 8, !tbaa !9
  %add154 = fadd double %maximum.1, %93
  store double %add154, ptr %arrayidx153, align 8, !tbaa !9
  %indvars.iv.next514 = add nuw nsw i64 %indvars.iv513, 1
  %94 = load i32, ptr %ncut, align 4, !tbaa !22
  %95 = sext i32 %94 to i64
  %cmp43 = icmp slt i64 %indvars.iv.next514, %95
...
for.end160:                                       ; preds = %for.inc158, %for.cond39.preheader.for.end160_crit_edge
  %97 = phi ptr [ %.pre528, %for.cond39.preheader.for.end160_crit_edge ], [ %31, %for.inc158 ]
  %.lcssa = phi i32 [ %8, %for.cond39.preheader.for.end160_crit_edge ], [ %96, %for.inc158 ]
  %sub161 = add nsw i32 %.lcssa, -1
...
for.body166:                                      ; preds = %for.end160, %for.inc218
  ...
  %98 = load i32, ptr %arrayidx168, align 4, !tbaa !22
  %arrayidx170 = getelementptr inbounds [100000 x i32], ptr @blockAlign2.result2, i64 0, i64 %idxprom167
  %99 = load i32, ptr %arrayidx170, align 4, !tbaa !22
  %cmp171 = icmp eq i32 %98, 0
  %cmp173 = icmp eq i32 %99, 0
  %or.cond = select i1 %cmp171, i1 true, i1 %cmp173
  br i1 %or.cond, label %for.end219, label %if.end176

if.end176:                                        ; preds = %for.body166
  %idxprom177 = sext i32 %98 to i64
  %arrayidx178 = getelementptr inbounds ptr, ptr %97, i64 %idxprom177
  %100 = load ptr, ptr %arrayidx178, align 8, !tbaa !5
  %idxprom179 = sext i32 %99 to i64
  %arrayidx180 = getelementptr inbounds i32, ptr %100, i64 %idxprom179
  %101 = load i32, ptr %arrayidx180, align 4, !tbaa !22
...
for.body223.preheader:                            ; preds = %for.inc218, %for.end219
  ...
  %102 = zext i32 %i.3.lcssa537 to i64
  br label %for.body223

for.body223:                                      ; preds = %for.body223.preheader, %for.inc289
  %indvars.iv523 = phi i64 [ %102, %for.body223.preheader ], [ %indvars.iv.next524, %for.inc289 ]
  ...
  %103 = load i32, ptr %arrayidx225, align 4, !tbaa !22
  %idxprom226 = sext i32 %103 to i64
  %arrayidx227 = getelementptr inbounds ptr, ptr %ocrossscore, i64 %idxprom226
  %104 = load ptr, ptr %arrayidx227, align 8, !tbaa !5
  %arrayidx229 = getelementptr inbounds [100000 x i32], ptr @blockAlign2.result2, i64 0, i64 %indvars.iv523
  %105 = load i32, ptr %arrayidx229, align 4, !tbaa !22
  %idxprom230 = sext i32 %105 to i64
  %arrayidx231 = getelementptr inbounds double, ptr %104, i64 %idxprom230
  %106 = load double, ptr %arrayidx231, align 8, !tbaa !9
  %cmp232 = fcmp oeq double %106, 0.000000e+00
  br i1 %cmp232, label %for.inc289, label %if.end235

if.end235:                                        ; preds = %for.body223
  %107 = add nsw i64 %indvars.iv523, -1
  %arrayidx240 = getelementptr inbounds [100000 x i32], ptr @blockAlign2.result1, i64 0, i64 %107
  %108 = load i32, ptr %arrayidx240, align 4, !tbaa !22
  %cmp241 = icmp eq i32 %103, %108
  %arrayidx267.phi.trans.insert = getelementptr inbounds [100000 x i32], ptr @blockAlign2.result2, i64 0, i64 %107
...
lor.lhs.false243:                                 ; preds = %if.end235
  %cmp249 = icmp eq i32 %105, %.pre529
  br i1 %cmp249, label %if.then251, label %if.end275

if.then251:                                       ; preds = %if.end235.if.then251_crit_edge, %lor.lhs.false243
  %idxprom268.pre-phi = phi i64 [ %.pre530, %if.end235.if.then251_crit_edge ], [ %idxprom230, %lor.lhs.false243 ]
  %idxprom263 = sext i32 %108 to i64
  %arrayidx264 = getelementptr inbounds ptr, ptr %ocrossscore, i64 %idxprom263
  %109 = load ptr, ptr %arrayidx264, align 8, !tbaa !5
  %arrayidx269 = getelementptr inbounds double, ptr %109, i64 %idxprom268.pre-phi
  %110 = load double, ptr %arrayidx269, align 8, !tbaa !9
  %cmp270 = fcmp ogt double %106, %110
  br i1 %cmp270, label %if.then272, label %if.end275
...
if.end275:                                        ; preds = %if.then251, %if.then272, %lor.lhs.false243
  ...
  %111 = load i32, ptr %arrayidx279, align 4, !tbaa !22
  %idxprom280 = sext i32 %count.1 to i64
  %arrayidx281 = getelementptr inbounds i32, ptr %cut1, i64 %idxprom280
  store i32 %111, ptr %arrayidx281, align 4, !tbaa !22
  %arrayidx285 = getelementptr inbounds [100000 x i32], ptr @blockAlign2.ocut2, i64 0, i64 %idxprom230
  %112 = load i32, ptr %arrayidx285, align 4, !tbaa !22
  %arrayidx287 = getelementptr inbounds i32, ptr %cut2, i64 %idxprom280
  store i32 %112, ptr %arrayidx287, align 4, !tbaa !22
  %inc288 = add nsw i32 %count.1, 1
  br label %for.inc289
...
; Function Attrs: nounwind uwtable
define dso_local void @blockAlign3(ptr nocapture noundef %cut1, ptr nocapture noundef %cut2, ptr nocapture noundef readonly %seg1, ptr nocapture noundef readonly %seg2, ptr nocapture noundef readonly %ocrossscore, ptr nocapture noundef %ncut) local_unnamed_addr #6 {
entry:
...
for.cond21.preheader.lr.ph:                       ; preds = %if.end19
  ...
  %n.vec = and i64 %wide.trip.count435, 4294967292
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count435
  %xtraiter = and i64 %wide.trip.count435, 3
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
...
for.cond21.preheader.us:                          ; preds = %for.cond21.for.inc30_crit_edge.us, %for.cond21.preheader.lr.ph
  %indvars.iv432 = phi i64 [ %indvars.iv.next433, %for.cond21.for.inc30_crit_edge.us ], [ 0, %for.cond21.preheader.lr.ph ]
  %arrayidx.us = getelementptr inbounds ptr, ptr %ocrossscore, i64 %indvars.iv432
  %14 = load ptr, ptr %arrayidx.us, align 8, !tbaa !5
  %arrayidx27.us = getelementptr inbounds ptr, ptr %13, i64 %indvars.iv432
  %15 = load ptr, ptr %arrayidx27.us, align 8, !tbaa !5
  %16 = ptrtoint ptr %15 to i64
  %17 = ptrtoint ptr %14 to i64
  %18 = sub i64 %16, %17
  %diff.check = icmp ult i64 %18, 32
  %or.cond475 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond475, label %for.body23.us.preheader, label %vector.body
...
vector.body:                                      ; preds = %for.cond21.preheader.us, %vector.body
  ...
  %wide.load472 = load <2 x double>, ptr %20, align 8, !tbaa !9
  ...
  store <2 x double> %wide.load472, ptr %22, align 8, !tbaa !9
  %index.next = add nuw i64 %index, 4
...
for.body23.us.preheader:                          ; preds = %for.cond21.preheader.us, %middle.block
  ...
  %25 = add nsw i64 %24, %wide.trip.count435
...
for.body23.us:                                    ; preds = %for.body23.us.prol.loopexit, %for.body23.us
  ...
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %exitcond.not.3 = icmp eq i64 %indvars.iv.next.3, %wide.trip.count435
...
for.cond21.for.inc30_crit_edge.us:                ; preds = %for.body23.us.prol.loopexit, %for.body23.us, %middle.block
  ...
  br i1 %exitcond436.not, label %for.cond33.preheader, label %for.cond21.preheader.us, !llvm.loop !89
...
for.body49:                                       ; preds = %for.body49.lr.ph, %for.body49
  %indvars.iv440 = phi i64 [ 0, %for.body49.lr.ph ], [ %indvars.iv.next441, %for.body49 ]
  %arrayidx51 = getelementptr inbounds double, ptr %34, i64 %indvars.iv440
  store double -9.999990e+02, ptr %arrayidx51, align 8, !tbaa !9
  %arrayidx53 = getelementptr inbounds i32, ptr %35, i64 %indvars.iv440
  store i32 -1, ptr %arrayidx53, align 4, !tbaa !22
  %indvars.iv.next441 = add nuw nsw i64 %indvars.iv440, 1
  %36 = load i32, ptr %ncut, align 4, !tbaa !22
  %37 = sext i32 %36 to i64
  %cmp48 = icmp slt i64 %indvars.iv.next441, %37
  br i1 %cmp48, label %for.body49, label %for.cond57.preheader, !llvm.loop !90

for.body59:                                       ; preds = %for.cond57.preheader, %for.inc153
  %38 = phi i32 [ %.lcssa468.sink, %for.inc153 ], [ %36, %for.cond57.preheader ]
  %indvars.iv447 = phi i64 [ %indvars.iv.next448, %for.inc153 ], [ 1, %for.cond57.preheader ]
...
for.body62.lr.ph:                                 ; preds = %for.body59
  %39 = add nsw i64 %indvars.iv447, -1
  %40 = trunc i64 %indvars.iv447 to i32
  br label %for.body62

for.body62:                                       ; preds = %for.body62.lr.ph, %for.inc150
  %indvars.iv443 = phi i64 [ 1, %for.body62.lr.ph ], [ %indvars.iv.next444, %for.inc150 ]
  %41 = load ptr, ptr @stderr, align 8, !tbaa !5
  %42 = trunc i64 %indvars.iv443 to i32
  ...
  %45 = add nsw i64 %indvars.iv443, -1
  ...
  %arrayidx70 = getelementptr inbounds ptr, ptr %47, i64 %indvars.iv447
  %48 = load ptr, ptr %arrayidx70, align 8, !tbaa !5
  %arrayidx72 = getelementptr inbounds i32, ptr %48, i64 %indvars.iv443
  ...
  %arrayidx88 = getelementptr inbounds double, ptr %50, i64 %indvars.iv443
  %arrayidx112 = getelementptr inbounds ptr, ptr %43, i64 %indvars.iv447
  %51 = load ptr, ptr %arrayidx112, align 8, !tbaa !5
  %arrayidx114 = getelementptr inbounds double, ptr %51, i64 %indvars.iv443
  %52 = load double, ptr %arrayidx114, align 8, !tbaa !9
  %add115 = fadd double %46, %52
  store double %add115, ptr %arrayidx114, align 8, !tbaa !9
  %arrayidx120 = getelementptr inbounds double, ptr %44, i64 %indvars.iv443
...
if.then139:                                       ; preds = %if.end129
  ...
  %arrayidx148 = getelementptr inbounds i32, ptr %56, i64 %indvars.iv443
...
for.inc150:                                       ; preds = %if.end129, %if.then139
  ...
  %cmp61 = icmp slt i64 %indvars.iv.next444, %58
  br i1 %cmp61, label %for.body62, label %for.inc153, !llvm.loop !91

for.inc153:                                       ; preds = %for.inc150, %for.body59
  %.lcssa468.sink = phi i32 [ %38, %for.body59 ], [ %57, %for.inc150 ]
  %59 = sext i32 %.lcssa468.sink to i64
  %indvars.iv.next448 = add nuw nsw i64 %indvars.iv447, 1
  %cmp58 = icmp slt i64 %indvars.iv.next448, %59
...
for.end155:                                       ; preds = %for.inc153, %for.cond33.preheader, %if.end19, %for.cond57.preheader
  %.lcssa = phi i32 [ %36, %for.cond57.preheader ], [ %12, %if.end19 ], [ %12, %for.cond33.preheader ], [ %.lcssa468.sink, %for.inc153 ]
...
for.body218.preheader:                            ; preds = %for.inc213, %for.end214
  %i.3.lcssa462 = phi i32 [ %i.3425, %for.end214 ], [ 0, %for.inc213 ]
  %65 = zext i32 %i.3.lcssa462 to i64
  br label %for.body218

for.body218:                                      ; preds = %for.body218.preheader, %for.inc284
  %indvars.iv451 = phi i64 [ %65, %for.body218.preheader ], [ %indvars.iv.next452, %for.inc284 ]
  %count.0428 = phi i32 [ 0, %for.body218.preheader ], [ %count.2, %for.inc284 ]
  %arrayidx220 = getelementptr inbounds [100000 x i32], ptr @blockAlign3.result1, i64 0, i64 %indvars.iv451
  ...
  %arrayidx224 = getelementptr inbounds [100000 x i32], ptr @blockAlign3.result2, i64 0, i64 %indvars.iv451
...
if.end230:                                        ; preds = %for.body218
  %70 = add nsw i64 %indvars.iv451, -1
...
for.inc284:                                       ; preds = %for.body218, %if.end270
  ...
  %exitcond455.not = icmp eq i64 %indvars.iv.next452, 100000
  br i1 %exitcond455.not, label %for.end286, label %for.body218, !llvm.loop !94
