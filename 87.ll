; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/siod/sliba.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/siod/sliba.c"
...
entry:
  ...
  %0 = load i16, ptr %type, align 2, !tbaa !14
  %conv = sext i16 %0 to i32
  switch i32 %conv, label %sw.epilog167 [
    i32 13, label %sw.bb
...
sw.bb:                                            ; preds = %entry
  ...
  %data35 = getelementptr inbounds %struct.obj, ptr %ptr, i64 0, i32 2, i32 0, i32 1
  %1 = load ptr, ptr %data35, align 8, !tbaa !17
  %call36 = tail call i64 @strcspn(ptr noundef %1, ptr noundef nonnull @.str.1) #25
  %call51 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %1) #26
  %cmp52 = icmp eq i64 %call36, %call51
...
if.else:                                          ; preds = %sw.bb
  ...
  %cmp60245 = icmp sgt i32 %conv59, 0
  br i1 %cmp60245, label %for.body.lr.ph, label %for.end

for.body.lr.ph:                                   ; preds = %if.else
  %arrayidx68 = getelementptr inbounds [3 x i8], ptr %cbuff, i64 0, i64 1
  %arrayidx69 = getelementptr inbounds [3 x i8], ptr %cbuff, i64 0, i64 2
  %wide.trip.count = and i64 %call51, 4294967295
  br label %for.body

for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %indvars.iv257 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next258, %for.inc ]
  %2 = load ptr, ptr %data35, align 8, !tbaa !17
  %arrayidx = getelementptr inbounds i8, ptr %2, i64 %indvars.iv257
  %3 = load i8, ptr %arrayidx, align 1, !tbaa !17
  %conv64 = sext i8 %3 to i32
  switch i32 %conv64, label %sw.default [
    i32 92, label %sw.bb65
    i32 34, label %sw.bb65
    i32 10, label %for.inc
    i32 13, label %sw.bb71
    i32 9, label %sw.bb72
  ]

sw.bb65:                                          ; preds = %for.body, %for.body
  store i8 92, ptr %cbuff, align 1, !tbaa !17
  store i8 %3, ptr %arrayidx68, align 1, !tbaa !17
  store i8 0, ptr %arrayidx69, align 1, !tbaa !17
  br label %for.inc
...
sw.default:                                       ; preds = %for.body
  ...
  store i8 0, ptr %arrayidx68, align 1, !tbaa !17
  br label %for.inc

for.inc:                                          ; preds = %for.body, %sw.bb65, %sw.bb71, %sw.bb72, %sw.default
  %cbuff.sink = phi ptr [ %cbuff, %sw.bb65 ], [ @.str.3, %sw.bb71 ], [ @.str.4, %sw.bb72 ], [ %cbuff, %sw.default ], [ @.str.2, %for.body ]
...
sw.bb77:                                          ; preds = %entry
  ...
  %storage_as80 = getelementptr inbounds %struct.obj, ptr %ptr, i64 0, i32 2
  %4 = load i64, ptr %storage_as80, align 8, !tbaa !17
  %cmp81242 = icmp sgt i64 %4, 0
  br i1 %cmp81242, label %for.body83.lr.ph, label %for.end98

for.body83.lr.ph:                                 ; preds = %sw.bb77
  %data85 = getelementptr inbounds %struct.obj, ptr %ptr, i64 0, i32 2, i32 0, i32 1
  br label %for.body83

for.body83:                                       ; preds = %for.body83.lr.ph, %for.inc96
  %indvars.iv254 = phi i64 [ 0, %for.body83.lr.ph ], [ %indvars.iv.next255, %for.inc96 ]
  %5 = load ptr, ptr @tkbuffer, align 8, !tbaa !13
  %6 = load ptr, ptr %data85, align 8, !tbaa !17
  %arrayidx87 = getelementptr inbounds double, ptr %6, i64 %indvars.iv254
  %7 = load double, ptr %arrayidx87, align 8, !tbaa !22
  %call88 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %5, ptr noundef nonnull dereferenceable(1) @.str.6, double noundef %7) #25
  %8 = load ptr, ptr @tkbuffer, align 8, !tbaa !13
  tail call void @gput_st(ptr noundef %f, ptr noundef %8) #25
  %indvars.iv.next255 = add nuw nsw i64 %indvars.iv254, 1
  %9 = load i64, ptr %storage_as80, align 8, !tbaa !17
  %cmp92 = icmp sgt i64 %9, %indvars.iv.next255
...
if.then94:                                        ; preds = %for.body83
  ...
  %.pre261 = load i64, ptr %storage_as80, align 8, !tbaa !17
  br label %for.inc96

for.inc96:                                        ; preds = %for.body83, %if.then94
  %10 = phi i64 [ %9, %for.body83 ], [ %.pre261, %if.then94 ]
  %cmp81 = icmp sgt i64 %10, %indvars.iv.next255
  br i1 %cmp81, label %for.body83, label %for.end98, !llvm.loop !24

for.end98:                                        ; preds = %for.inc96, %sw.bb77
  tail call void @gput_st(ptr noundef %f, ptr noundef nonnull @.str.8) #25
  br label %sw.epilog167

sw.bb99:                                          ; preds = %entry
  tail call void @gput_st(ptr noundef %f, ptr noundef nonnull @.str.5) #25
  %storage_as102 = getelementptr inbounds %struct.obj, ptr %ptr, i64 0, i32 2
  %11 = load i64, ptr %storage_as102, align 8, !tbaa !17
  %cmp104236 = icmp sgt i64 %11, 0
  br i1 %cmp104236, label %for.body106.lr.ph, label %for.end122

for.body106.lr.ph:                                ; preds = %sw.bb99
  %data108 = getelementptr inbounds %struct.obj, ptr %ptr, i64 0, i32 2, i32 0, i32 1
  br label %for.body106

for.body106:                                      ; preds = %for.body106.lr.ph, %for.inc120
  %indvars.iv248 = phi i64 [ 0, %for.body106.lr.ph ], [ %indvars.iv.next249, %for.inc120 ]
  %12 = load ptr, ptr @tkbuffer, align 8, !tbaa !13
  %13 = load ptr, ptr %data108, align 8, !tbaa !17
  %arrayidx110 = getelementptr inbounds i64, ptr %13, i64 %indvars.iv248
  %14 = load i64, ptr %arrayidx110, align 8, !tbaa !25
  %call111 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %12, ptr noundef nonnull dereferenceable(1) @.str.9, i64 noundef %14) #25
  %15 = load ptr, ptr @tkbuffer, align 8, !tbaa !13
  tail call void @gput_st(ptr noundef %f, ptr noundef %15) #25
  %indvars.iv.next249 = add nuw nsw i64 %indvars.iv248, 1
  %16 = load i64, ptr %storage_as102, align 8, !tbaa !17
  %cmp116 = icmp sgt i64 %16, %indvars.iv.next249
  br i1 %cmp116, label %if.then118, label %for.inc120

if.then118:                                       ; preds = %for.body106
  tail call void @gput_st(ptr noundef %f, ptr noundef nonnull @.str.7) #25
  %.pre260 = load i64, ptr %storage_as102, align 8, !tbaa !17
  br label %for.inc120

for.inc120:                                       ; preds = %for.body106, %if.then118
  %17 = phi i64 [ %16, %for.body106 ], [ %.pre260, %if.then118 ]
  %cmp104 = icmp sgt i64 %17, %indvars.iv.next249
  br i1 %cmp104, label %for.body106, label %for.end122, !llvm.loop !27

for.end122:                                       ; preds = %for.inc120, %sw.bb99
  tail call void @gput_st(ptr noundef %f, ptr noundef nonnull @.str.8) #25
  br label %sw.bb123

sw.bb123:                                         ; preds = %entry, %for.end122
  %18 = load ptr, ptr @tkbuffer, align 8, !tbaa !13
  %storage_as124 = getelementptr inbounds %struct.obj, ptr %ptr, i64 0, i32 2
  %19 = load i64, ptr %storage_as124, align 8, !tbaa !17
  %call126 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %18, ptr noundef nonnull dereferenceable(1) @.str.10, i64 noundef %19) #25
  %20 = load ptr, ptr @tkbuffer, align 8, !tbaa !13
  tail call void @gput_st(ptr noundef %f, ptr noundef %20) #25
  %21 = load i64, ptr %storage_as124, align 8, !tbaa !17
  %cmp131239 = icmp sgt i64 %21, 0
  br i1 %cmp131239, label %for.body133.lr.ph, label %for.end142

for.body133.lr.ph:                                ; preds = %sw.bb123
  %data135 = getelementptr inbounds %struct.obj, ptr %ptr, i64 0, i32 2, i32 0, i32 1
  br label %for.body133

for.body133:                                      ; preds = %for.body133.lr.ph, %for.body133
  %indvars.iv251 = phi i64 [ 0, %for.body133.lr.ph ], [ %indvars.iv.next252, %for.body133 ]
  %22 = load ptr, ptr @tkbuffer, align 8, !tbaa !13
  %23 = load ptr, ptr %data135, align 8, !tbaa !17
  %arrayidx137 = getelementptr inbounds i8, ptr %23, i64 %indvars.iv251
  %24 = load i8, ptr %arrayidx137, align 1, !tbaa !17
  %conv138232 = zext i8 %24 to i32
  %call139 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %22, ptr noundef nonnull dereferenceable(1) @.str.11, i32 noundef %conv138232) #25
  %25 = load ptr, ptr @tkbuffer, align 8, !tbaa !13
  tail call void @gput_st(ptr noundef %f, ptr noundef %25) #25
  %indvars.iv.next252 = add nuw nsw i64 %indvars.iv251, 1
  %26 = load i64, ptr %storage_as124, align 8, !tbaa !17
  %cmp131 = icmp sgt i64 %26, %indvars.iv.next252
  br i1 %cmp131, label %for.body133, label %for.end142, !llvm.loop !28

for.end142:                                       ; preds = %for.body133, %sw.bb123
  tail call void @gput_st(ptr noundef %f, ptr noundef nonnull @.str) #25
  br label %sw.epilog167

sw.bb143:                                         ; preds = %entry
  tail call void @gput_st(ptr noundef %f, ptr noundef nonnull @.str.5) #25
  %storage_as146 = getelementptr inbounds %struct.obj, ptr %ptr, i64 0, i32 2
  %27 = load i64, ptr %storage_as146, align 8, !tbaa !17
  %cmp148233 = icmp sgt i64 %27, 0
  br i1 %cmp148233, label %for.body150.lr.ph, label %for.end166

for.body150.lr.ph:                                ; preds = %sw.bb143
  %data152 = getelementptr inbounds %struct.obj, ptr %ptr, i64 0, i32 2, i32 0, i32 1
  br label %for.body150

for.body150:                                      ; preds = %for.body150.lr.ph, %for.inc164
  %indvars.iv = phi i64 [ 0, %for.body150.lr.ph ], [ %indvars.iv.next, %for.inc164 ]
  %28 = load ptr, ptr %data152, align 8, !tbaa !17
  %arrayidx154 = getelementptr inbounds ptr, ptr %28, i64 %indvars.iv
  %29 = load ptr, ptr %arrayidx154, align 8, !tbaa !13
  %call155 = tail call ptr @lprin1g(ptr noundef %29, ptr noundef %f) #25
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %30 = load i64, ptr %storage_as146, align 8, !tbaa !17
  %cmp160 = icmp sgt i64 %30, %indvars.iv.next
  br i1 %cmp160, label %if.then162, label %for.inc164

if.then162:                                       ; preds = %for.body150
  tail call void @gput_st(ptr noundef %f, ptr noundef nonnull @.str.7) #25
  %.pre = load i64, ptr %storage_as146, align 8, !tbaa !17
  br label %for.inc164

for.inc164:                                       ; preds = %for.body150, %if.then162
  %31 = phi i64 [ %30, %for.body150 ], [ %.pre, %if.then162 ]
  %cmp148 = icmp sgt i64 %31, %indvars.iv.next
  br i1 %cmp148, label %for.body150, label %for.end166, !llvm.loop !29

for.end166:                                       ; preds = %for.inc164, %sw.bb143
  tail call void @gput_st(ptr noundef %f, ptr noundef nonnull @.str.8) #25
  br label %sw.epilog167

sw.epilog167:                                     ; preds = %entry, %for.end166, %for.end142, %for.end98, %if.end
  ret void
}
...
sw.bb:                                            ; preds = %entry, %entry
  %call4 = tail call i32 @_IO_putc(i32 noundef %conv, ptr noundef %call1)
  %storage_as = getelementptr inbounds %struct.obj, ptr %ptr, i64 0, i32 2
  %1 = load i64, ptr %storage_as, align 8, !tbaa !17
  %sext74 = shl i64 %1, 32
  %conv6 = ashr exact i64 %sext74, 32
...
sw.bb20:                                          ; preds = %entry
  %call21 = tail call i32 @_IO_putc(i32 noundef 15, ptr noundef %call1)
  ...
  store i64 %conv26, ptr %i.addr.i77, align 8, !tbaa !25
...
sw.bb31:                                          ; preds = %entry
  %call32 = tail call i32 @_IO_putc(i32 noundef 16, ptr noundef %call1)
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %i.addr.i79)
  store i64 %conv36, ptr %i.addr.i79, align 8, !tbaa !25
  %call.i80 = call i64 @fwrite(ptr noundef nonnull %i.addr.i79, i64 noundef 8, i64 noundef 1, ptr noundef %call1)
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %i.addr.i79)
...
get_c_long.exit:                                  ; preds = %cond.false.i, %if.then.i
  ...
  br i1 %cmp, label %if.then, label %cond.false.i27

if.then:                                          ; preds = %get_c_long.exit
  %3 = load i64, ptr %n, align 8, !tbaa !25
  br label %if.end

cond.false.i27:                                   ; preds = %get_c_long.exit
  %type.i26 = getelementptr inbounds %struct.obj, ptr %end, i64 0, i32 1
  %4 = load i16, ptr %type.i26, align 2, !tbaa !14
  %5 = icmp eq i16 %4, 2
  br i1 %5, label %get_c_long.exit32, label %if.then.i29

if.then.i29:                                      ; preds = %cond.false.i27
  %call.i28 = call ptr @err(ptr noundef nonnull @.str.44, ptr noundef nonnull %end) #25
  br label %get_c_long.exit32

get_c_long.exit32:                                ; preds = %cond.false.i27, %if.then.i29
  %storage_as.i30 = getelementptr inbounds %struct.obj, ptr %end, i64 0, i32 2
  %6 = load double, ptr %storage_as.i30, align 8, !tbaa !17
  %conv3.i31 = fptosi double %6 to i64
  br label %if.end

if.end:                                           ; preds = %get_c_long.exit32, %if.then
  %e.0 = phi i64 [ %3, %if.then ], [ %conv3.i31, %get_c_long.exit32 ]
...
if.end7:                                          ; preds = %if.end, %if.then5
  ...
  %or.cond24 = select i1 %cmp8, i1 true, i1 %cmp10
  br i1 %or.cond24, label %if.then11, label %if.end13
...
if.end13:                                         ; preds = %if.end7, %if.then11
  ...
  %call.i33 = call i64 @no_interrupt(i64 noundef 1) #25
  %call1.i = call ptr @cons(ptr noundef null, ptr noundef null) #25
  %type.i34 = getelementptr inbounds %struct.obj, ptr %call1.i, i64 0, i32 1
  store i16 13, ptr %type.i34, align 2, !tbaa !14
  %cmp.i35 = icmp eq i64 %sub, -1
  br i1 %cmp.i35, label %if.then.i36, label %if.end.i

if.then.i36:                                      ; preds = %if.end13
  %call2.i = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx) #26
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i36, %if.end13
  %length.addr.0.i = phi i64 [ %call2.i, %if.then.i36 ], [ %sub, %if.end13 ]
  %add.i = add nsw i64 %length.addr.0.i, 1
  %call3.i = call ptr @must_malloc(i64 noundef %add.i) #25
  %storage_as.i37 = getelementptr inbounds %struct.obj, ptr %call1.i, i64 0, i32 2
  %data4.i = getelementptr inbounds %struct.obj, ptr %call1.i, i64 0, i32 2, i32 0, i32 1
  store ptr %call3.i, ptr %data4.i, align 8, !tbaa !17
  store i64 %length.addr.0.i, ptr %storage_as.i37, align 8, !tbaa !17
...
strcons.exit:                                     ; preds = %if.end.i, %if.then6.i
  ...
  store i8 0, ptr %arrayidx.i, align 1, !tbaa !17
  %call12.i = call i64 @no_interrupt(i64 noundef %call.i33) #25
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %n) #25
  ret ptr %call1.i
}
...
entry:
  ...
  %tobool.not54 = icmp eq i8 %0, 0
  br i1 %tobool.not54, label %while.end, label %land.rhs

land.rhs:                                         ; preds = %entry, %while.body
  %1 = phi i8 [ %4, %while.body ], [ %0, %entry ]
  %start.055 = phi ptr [ %incdec.ptr, %while.body ], [ %call, %entry ]
  %conv53 = zext i8 %1 to i64
  %memchr.bounds50 = icmp ugt i8 %1, 63
  %2 = shl nuw i64 1, %conv53
  %3 = and i64 %2, 4294977025
  %memchr.bits51 = icmp eq i64 %3, 0
  %memchr52.not = select i1 %memchr.bounds50, i1 true, i1 %memchr.bits51
  br i1 %memchr52.not, label %while.end, label %while.body

while.body:                                       ; preds = %land.rhs
  %incdec.ptr = getelementptr inbounds i8, ptr %start.055, i64 1
  %4 = load i8, ptr %incdec.ptr, align 1, !tbaa !17
  %tobool.not = icmp eq i8 %4, 0
  br i1 %tobool.not, label %while.end, label %land.rhs, !llvm.loop !71

while.end:                                        ; preds = %land.rhs, %while.body, %entry
  %start.0.lcssa = phi ptr [ %call, %entry ], [ %incdec.ptr, %while.body ], [ %start.055, %land.rhs ]
  %call9 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %start.0.lcssa) #26
  %arrayidx = getelementptr inbounds i8, ptr %start.0.lcssa, i64 %call9
  br label %while.cond10

while.cond10:                                     ; preds = %land.rhs13, %while.end
  %end.0 = phi ptr [ %arrayidx, %while.end ], [ %add.ptr, %land.rhs13 ]
  %cmp11 = icmp ugt ptr %end.0, %start.0.lcssa
  br i1 %cmp11, label %land.rhs13, label %while.end34

land.rhs13:                                       ; preds = %while.cond10
  %add.ptr = getelementptr inbounds i8, ptr %end.0, i64 -1
  %5 = load i8, ptr %add.ptr, align 1, !tbaa !17
  %conv2649 = zext i8 %5 to i64
  %memchr.bounds = icmp ugt i8 %5, 63
  %6 = shl nuw i64 1, %conv2649
  %7 = and i64 %6, 4294977025
  %memchr.bits = icmp eq i64 %7, 0
  %memchr48.not = select i1 %memchr.bounds, i1 true, i1 %memchr.bits
  br i1 %memchr48.not, label %while.end34, label %while.cond10, !llvm.loop !72

while.end34:                                      ; preds = %while.cond10, %land.rhs13
...
if.then.i:                                        ; preds = %while.end34
  %call2.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %start.0.lcssa) #26
  br label %strcons.exit

strcons.exit:                                     ; preds = %if.then.i, %while.end34
  %length.addr.0.i = phi i64 [ %call2.i, %if.then.i ], [ %sub.ptr.sub, %while.end34 ]
  %add.i = add nsw i64 %length.addr.0.i, 1
  %call3.i = tail call ptr @must_malloc(i64 noundef %add.i) #25
  %storage_as.i = getelementptr inbounds %struct.obj, ptr %call1.i, i64 0, i32 2
  %data4.i = getelementptr inbounds %struct.obj, ptr %call1.i, i64 0, i32 2, i32 0, i32 1
...
entry:
  ...
  br i1 %tobool.not20, label %while.end, label %land.rhs

land.rhs:                                         ; preds = %entry, %while.body
  %1 = phi i8 [ %4, %while.body ], [ %0, %entry ]
  %start.021 = phi ptr [ %incdec.ptr, %while.body ], [ %call, %entry ]
  %conv19 = zext i8 %1 to i64
  %memchr.bounds = icmp ugt i8 %1, 63
  %2 = shl nuw i64 1, %conv19
  %3 = and i64 %2, 4294977025
  %memchr.bits = icmp eq i64 %3, 0
  %memchr18.not = select i1 %memchr.bounds, i1 true, i1 %memchr.bits
  br i1 %memchr18.not, label %while.end, label %while.body

while.body:                                       ; preds = %land.rhs
  %incdec.ptr = getelementptr inbounds i8, ptr %start.021, i64 1
  %4 = load i8, ptr %incdec.ptr, align 1, !tbaa !17
  %tobool.not = icmp eq i8 %4, 0
  br i1 %tobool.not, label %while.end, label %land.rhs, !llvm.loop !73

while.end:                                        ; preds = %land.rhs, %while.body, %entry
  %start.0.lcssa = phi ptr [ %call, %entry ], [ %incdec.ptr, %while.body ], [ %start.021, %land.rhs ]
  %call9 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %start.0.lcssa) #26
  %call.i = tail call i64 @no_interrupt(i64 noundef 1) #25
  %call1.i = tail call ptr @cons(ptr noundef null, ptr noundef null) #25
  %type.i = getelementptr inbounds %struct.obj, ptr %call1.i, i64 0, i32 1
  store i16 13, ptr %type.i, align 2, !tbaa !14
  %cmp.i = icmp eq i64 %call9, -1
  br i1 %cmp.i, label %if.then.i, label %strcons.exit
...
strcons.exit:                                     ; preds = %if.then.i, %while.end
  %length.addr.0.i = phi i64 [ %call2.i, %if.then.i ], [ %call9, %while.end ]
  %add.i = add nsw i64 %length.addr.0.i, 1
  %call3.i = tail call ptr @must_malloc(i64 noundef %add.i) #25
  %storage_as.i = getelementptr inbounds %struct.obj, ptr %call1.i, i64 0, i32 2
  %data4.i = getelementptr inbounds %struct.obj, ptr %call1.i, i64 0, i32 2, i32 0, i32 1
...
land.rhs:                                         ; preds = %while.cond
  ...
  %conv1022 = zext i8 %0 to i64
  %memchr.bounds = icmp ugt i8 %0, 63
  %1 = shl nuw i64 1, %conv1022
  %2 = and i64 %1, 4294977025
  %memchr.bits = icmp eq i64 %2, 0
  %memchr21.not = select i1 %memchr.bounds, i1 true, i1 %memchr.bits
  br i1 %memchr21.not, label %while.end, label %while.cond, !llvm.loop !74
...
if.end:                                           ; preds = %entry
  ...
  br i1 %cmp5.not, label %if.end9, label %cond.false.i

cond.false.i:                                     ; preds = %if.end
  %call7 = tail call i32 @_IO_putc(i32 noundef 127, ptr noundef %call1)
...
if.end9:                                          ; preds = %if.end
  ...
  br i1 %cmp13, label %cleanup, label %cond.false.i40

cond.false.i40:                                   ; preds = %if.end9
  ...
  %call21 = tail call i32 @_IO_putc(i32 noundef 126, ptr noundef %call1)
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %1 = load ptr, ptr %obj.addr, align 8, !tbaa !13
...
sw.bb:                                            ; preds = %if.end, %cond.end
  %call3 = call i32 @_IO_putc(i32 noundef 0, ptr noundef %call1)
  br label %cleanup
...
if.then17:                                        ; preds = %for.end.thread, %for.end
  %call18 = call i32 @_IO_putc(i32 noundef 1, ptr noundef %call1)
  %4 = load ptr, ptr %obj.addr, align 8, !tbaa !13
...
if.then25:                                        ; preds = %for.end
  %call26 = call i32 @_IO_putc(i32 noundef 125, ptr noundef %call1)
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %i.addr.i)
...
if.else45:                                        ; preds = %for.end.thread
  %call46 = call i32 @_IO_putc(i32 noundef 124, ptr noundef %call1)
...
sw.bb69:                                          ; preds = %cond.end
  %call70 = call i32 @_IO_putc(i32 noundef 2, ptr noundef %call1)
...
sw.bb73:                                          ; preds = %cond.end
  %call74 = call i64 @fast_print_table(ptr noundef nonnull %1, ptr noundef %table)
  %tobool.not = icmp eq i64 %call74, 0
  br i1 %tobool.not, label %cleanup, label %if.then75

if.then75:                                        ; preds = %sw.bb73
  %call76 = call i32 @_IO_putc(i32 noundef 3, ptr noundef %call1)
...
tailrecurse:                                      ; preds = %while.cond, %entry
  %call = tail call ptr @car(ptr noundef %table) #25
  %call1 = tail call ptr @get_c_file(ptr noundef %call, ptr noundef null) #25
  %call2 = tail call i32 @_IO_getc(ptr noundef %call1)
...
while.cond:                                       ; preds = %tailrecurse, %while.cond
  %call3 = tail call i32 @_IO_getc(ptr noundef %call1)
...
while.body.i:                                     ; preds = %get_c_long.exit.i, %while.body.i
  ...
  br i1 %cmp.i, label %while.body.i, label %make_list.exit, !llvm.loop !94
...
while.body34:                                     ; preds = %make_list.exit, %while.body34
  ...
  br i1 %cmp32, label %while.body34, label %while.end38, !llvm.loop !95
...
if.end14:                                         ; preds = %if.end, %if.then12, %cond.end8
  ...
  br i1 %cmp15.not, label %if.end26, label %cond.false.i188

cond.false.i188:                                  ; preds = %if.end14
  %type.i187 = getelementptr inbounds %struct.obj, ptr %p, i64 0, i32 1
  %5 = load i16, ptr %type.i187, align 2, !tbaa !14
  %6 = icmp eq i16 %5, 2
  br i1 %6, label %cond.end20, label %if.then.i190

if.then.i190:                                     ; preds = %cond.false.i188
  %call.i189 = tail call ptr @err(ptr noundef nonnull @.str.44, ptr noundef nonnull %p) #25
  br label %cond.end20

cond.end20:                                       ; preds = %if.then.i190, %cond.false.i188
  %storage_as.i191 = getelementptr inbounds %struct.obj, ptr %p, i64 0, i32 2
  %7 = load double, ptr %storage_as.i191, align 8, !tbaa !17
  %conv3.i192 = fptosi double %7 to i64
  %cmp22 = icmp sgt i64 %conv3.i192, 100
...
if.end26:                                         ; preds = %if.end14, %if.then24, %cond.end20
  %cond21214 = phi i64 [ %conv3.i192, %if.then24 ], [ %conv3.i192, %cond.end20 ], [ -1, %if.end14 ]
  %cmp27 = icmp eq ptr %b, null
  %8 = load ptr, ptr @sym_e, align 8
  %cmp29 = icmp eq ptr %8, %b
  %or.cond183 = select i1 %cmp27, i1 true, i1 %cmp29
  %9 = load ptr, ptr @sym_f, align 8
  %cmp32 = icmp eq ptr %9, %b
  %or.cond184 = select i1 %or.cond183, i1 true, i1 %cmp32
  br i1 %or.cond184, label %if.then34, label %cond.false.i196
...
cond.false.i196:                                  ; preds = %if.end26
  %type.i195 = getelementptr inbounds %struct.obj, ptr %b, i64 0, i32 1
  %10 = load i16, ptr %type.i195, align 2, !tbaa !14
  %11 = icmp eq i16 %10, 2
  br i1 %11, label %get_c_long.exit201, label %if.then.i198

if.then.i198:                                     ; preds = %cond.false.i196
  %call.i197 = tail call ptr @err(ptr noundef nonnull @.str.44, ptr noundef nonnull %b) #25
  br label %get_c_long.exit201

get_c_long.exit201:                               ; preds = %cond.false.i196, %if.then.i198
  %storage_as.i199 = getelementptr inbounds %struct.obj, ptr %b, i64 0, i32 2
  %12 = load double, ptr %storage_as.i199, align 8, !tbaa !17
  %conv3.i200 = fptosi double %12 to i64
  %cmp96 = icmp eq i64 %conv3.i200, 10
  %cmp99 = icmp eq i64 %conv3.i200, 8
  switch i64 %conv3.i200, label %if.else134 [
    i64 16, label %if.then104
    i64 10, label %if.then104
    i64 8, label %if.then104
  ]

if.then104:                                       ; preds = %get_c_long.exit201, %get_c_long.exit201, %get_c_long.exit201
...
if.else120:                                       ; preds = %if.then104
  ...
  %spec.select185 = select i1 %cmp96, ptr @.str.9, ptr %cond128
  %call132 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %buffer, ptr noundef nonnull dereferenceable(1) %spec.select185, i64 noundef %conv118) #25
  br label %if.end137

if.else134:                                       ; preds = %get_c_long.exit201
...
if.end137:                                        ; preds = %if.else134, %if.else120, %if.then107, %if.then39, %if.then67, %if.else79, %if.then52
  ...
  %call.i202 = tail call i64 @no_interrupt(i64 noundef 1) #25
  %call1.i = tail call ptr @cons(ptr noundef null, ptr noundef null) #25
  %type.i203 = getelementptr inbounds %struct.obj, ptr %call1.i, i64 0, i32 1
  store i16 13, ptr %type.i203, align 2, !tbaa !14
  %add.i = add nsw i64 %call139, 1
  %call3.i = tail call ptr @must_malloc(i64 noundef %add.i) #25
  %storage_as.i206 = getelementptr inbounds %struct.obj, ptr %call1.i, i64 0, i32 2
  %data4.i = getelementptr inbounds %struct.obj, ptr %call1.i, i64 0, i32 2, i32 0, i32 1
  store ptr %call3.i, ptr %data4.i, align 8, !tbaa !17
  store i64 %call139, ptr %storage_as.i206, align 8, !tbaa !17
  ...
  store i8 0, ptr %arrayidx.i, align 1, !tbaa !17
  %call12.i = tail call i64 @no_interrupt(i64 noundef %call.i202) #25
...
for.inc:                                          ; preds = %if.then28, %if.then40, %if.else32
  ...
  br i1 %tobool.not, label %if.end55, label %for.body, !llvm.loop !96
...
entry:
  ...
  %call2 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %call, ptr noundef nonnull dereferenceable(1) %call1) #25
...
while.body:                                       ; preds = %entry, %strcons.exit
  %result.022 = phi ptr [ %call7, %strcons.exit ], [ null, %entry ]
  %start.021 = phi ptr [ %cond, %strcons.exit ], [ %call, %entry ]
...
strcons.exit:                                     ; preds = %if.then.i, %if.end
...
while.end:                                        ; preds = %strcons.exit, %entry
  %result.0.lcssa = phi ptr [ null, %entry ], [ %call7, %strcons.exit ]
...
for.inc:                                          ; preds = %for.body
  ...
  br i1 %cmp, label %cleanup, label %cond.end, !llvm.loop !101
...
for.body:                                         ; preds = %cond.end
  ...
  br i1 %exitcond.not, label %for.end, label %land.rhs, !llvm.loop !104
...
get_c_long.exit:                                  ; preds = %cond.false.i, %if.then.i
  ...
  %2 = load double, ptr %storage_as.i, align 8, !tbaa !17
  %conv3.i = fptosi double %2 to i64
  %cmp.not41 = icmp eq ptr %li, null
  br i1 %cmp.not41, label %cleanup, label %while.body

while.body:                                       ; preds = %get_c_long.exit, %if.end26
  %j.043 = phi i64 [ %j.1, %if.end26 ], [ 0, %get_c_long.exit ]
  %l.042 = phi ptr [ %l.1, %if.end26 ], [ %li, %get_c_long.exit ]
  %call1 = tail call ptr @car(ptr noundef nonnull %l.042) #25
...
cond.end:                                         ; preds = %while.body
  ...
  br i1 %cmp3, label %cond.false15, label %if.else

cond.false15:                                     ; preds = %cond.end
  %call16 = tail call ptr @get_c_string(ptr noundef nonnull %call1) #25
  %4 = load i8, ptr %call16, align 1, !tbaa !17
  %conv1738 = zext i8 %4 to i64
  %memchr.bounds = icmp ugt i8 %4, 63
  %5 = shl nuw i64 1, %conv1738
  %6 = and i64 %5, 288265560523800577
  %memchr.bits = icmp eq i64 %6, 0
  %memchr37.not = select i1 %memchr.bounds, i1 true, i1 %memchr.bits
  br i1 %memchr37.not, label %if.else, label %if.then

if.then:                                          ; preds = %cond.false15
  %call20 = tail call ptr @cdr(ptr noundef nonnull %l.042) #25
  br label %if.end26

if.else:                                          ; preds = %while.body, %cond.false15, %cond.end
  %cmp21 = icmp eq i64 %j.043, %conv3.i
  br i1 %cmp21, label %cleanup, label %if.else24

if.else24:                                        ; preds = %if.else
  %call25 = tail call ptr @cdr(ptr noundef nonnull %l.042) #25
  %inc = add nsw i64 %j.043, 1
  br label %if.end26

if.end26:                                         ; preds = %if.else24, %if.then
  %l.1 = phi ptr [ %call20, %if.then ], [ %call25, %if.else24 ]
  %j.1 = phi i64 [ %j.043, %if.then ], [ %inc, %if.else24 ]
  %cmp.not = icmp eq ptr %l.1, null
  br i1 %cmp.not, label %cleanup, label %while.body, !llvm.loop !106

cleanup:                                          ; preds = %if.else, %if.end26, %get_c_long.exit
  %retval.0 = phi ptr [ %dval, %get_c_long.exit ], [ %dval, %if.end26 ], [ %call1, %if.else ]
  ret ptr %retval.0
}
...
entry:
  ...
  %call1 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call) #26
  %cmp.not229 = icmp eq ptr %li, null
  br i1 %cmp.not229, label %cleanup, label %while.body.lr.ph

while.body.lr.ph:                                 ; preds = %entry
  %add = add nsw i64 %call1, 1
  br label %while.body

while.body:                                       ; preds = %while.body.lr.ph, %if.end209
  %l.0230 = phi ptr [ %li, %while.body.lr.ph ], [ %call210, %if.end209 ]
  %call2 = tail call ptr @car(ptr noundef nonnull %l.0230) #25
  %cmp3 = icmp eq ptr %call2, null
  br i1 %cmp3, label %if.end209, label %cond.end

cond.end:                                         ; preds = %while.body
  %type = getelementptr inbounds %struct.obj, ptr %call2, i64 0, i32 1
  %0 = load i16, ptr %type, align 2, !tbaa !14
  %cmp4 = icmp eq i16 %0, 13
  br i1 %cmp4, label %land.lhs.true, label %if.end209
...
land.lhs.true:                                    ; preds = %cond.end
  ...
  br i1 %cmp8, label %land.lhs.true10, label %if.end209

land.lhs.true10:                                  ; preds = %land.lhs.true
  %arrayidx191 = getelementptr inbounds i8, ptr %call6, i64 1
  %call192 = tail call i32 @strncmp(ptr noundef nonnull %arrayidx191, ptr noundef %call, i64 noundef %call1) #26
  %cmp195 = icmp eq i32 %call192, 0
  br i1 %cmp195, label %land.lhs.true197, label %if.end209

land.lhs.true197:                                 ; preds = %land.lhs.true10
  %arrayidx198 = getelementptr inbounds i8, ptr %call6, i64 %add
  %2 = load i8, ptr %arrayidx198, align 1, !tbaa !17
  %cmp200 = icmp eq i8 %2, 61
  br i1 %cmp200, label %if.then202, label %if.end209

if.then202:                                       ; preds = %land.lhs.true197
  %add203 = add nsw i64 %call1, 2
  %arrayidx204 = getelementptr inbounds i8, ptr %call6, i64 %add203
  %call205 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx204) #26
  %call.i = tail call i64 @no_interrupt(i64 noundef 1) #25
  %call1.i = tail call ptr @cons(ptr noundef null, ptr noundef null) #25
  %type.i = getelementptr inbounds %struct.obj, ptr %call1.i, i64 0, i32 1
  store i16 13, ptr %type.i, align 2, !tbaa !14
  %cmp.i = icmp eq i64 %call205, -1
  br i1 %cmp.i, label %if.then.i, label %strcons.exit

if.then.i:                                        ; preds = %if.then202
  %call2.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %arrayidx204) #26
  br label %strcons.exit

strcons.exit:                                     ; preds = %if.then.i, %if.then202
  %length.addr.0.i = phi i64 [ %call2.i, %if.then.i ], [ %call205, %if.then202 ]
  %add.i = add nsw i64 %length.addr.0.i, 1
  %call3.i = tail call ptr @must_malloc(i64 noundef %add.i) #25
  %storage_as.i = getelementptr inbounds %struct.obj, ptr %call1.i, i64 0, i32 2
  %data4.i = getelementptr inbounds %struct.obj, ptr %call1.i, i64 0, i32 2, i32 0, i32 1
  store ptr %call3.i, ptr %data4.i, align 8, !tbaa !17
  store i64 %length.addr.0.i, ptr %storage_as.i, align 8, !tbaa !17
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %call3.i, ptr nonnull align 1 %arrayidx204, i64 %length.addr.0.i, i1 false)
  %.pre.i = load ptr, ptr %data4.i, align 8, !tbaa !17
  %arrayidx.i = getelementptr inbounds i8, ptr %.pre.i, i64 %length.addr.0.i
  store i8 0, ptr %arrayidx.i, align 1, !tbaa !17
  %call12.i = tail call i64 @no_interrupt(i64 noundef %call.i) #25
...
if.end209:                                        ; preds = %while.body, %land.lhs.true197, %land.lhs.true10, %land.lhs.true, %cond.end
  %call210 = tail call ptr @cdr(ptr noundef nonnull %l.0230) #25
  %cmp.not = icmp eq ptr %call210, null
  br i1 %cmp.not, label %cleanup, label %while.body, !llvm.loop !107

cleanup:                                          ; preds = %if.end209, %entry, %strcons.exit
  %retval.0 = phi ptr [ %call1.i, %strcons.exit ], [ %dval, %entry ], [ %dval, %if.end209 ]
  ret ptr %retval.0
}
...
for.body:                                         ; preds = %cond.end
  ...
  br i1 %cmp1, label %sw.epilog, label %cond.end, !llvm.loop !108
...
cond.end13:                                       ; preds = %while.body
  ...
  br i1 %cmp15, label %while.body, label %while.end, !llvm.loop !109
...
while.body:                                       ; preds = %cond.end13.preheader, %cond.end13
  ...
  br i1 %cmp7, label %while.end, label %cond.end13, !llvm.loop !109
...
cond.end13.i:                                     ; preds = %while.body.i
  ...
  br i1 %cmp15.i, label %while.body.i, label %last.exit, !llvm.loop !109
...
while.body.i:                                     ; preds = %cond.end13.i.preheader, %cond.end13.i
  ...
  br i1 %cmp7.i, label %last.exit, label %cond.end13.i, !llvm.loop !109
...
for.inc:                                          ; preds = %cond.end
  ...
  br i1 %cmp, label %if.end8, label %cond.end, !llvm.loop !110
...
for.body13:                                       ; preds = %for.body13, %for.body13.preheader.new
  ...
  br i1 %niter.ncmp.7, label %for.end18.loopexit.unr-lcssa, label %for.body13, !llvm.loop !111
...
for.body13.epil:                                  ; preds = %for.end18.loopexit.unr-lcssa, %for.body13.epil
  ...
  br i1 %epil.iter.cmp.not, label %for.end18, label %for.body13.epil, !llvm.loop !112
...
for.inc57:                                        ; preds = %for.body23, %if.else, %if.then48
  ...
  br i1 %cmp21.not, label %for.end61, label %for.body23, !llvm.loop !113
...
cond.end13.i.i:                                   ; preds = %while.body.i.i
  ...
  br i1 %cmp15.i.i, label %while.body.i.i, label %last.exit.i, !llvm.loop !109
...
while.body.i.i:                                   ; preds = %cond.end13.i.preheader.i, %cond.end13.i.i
  ...
  br i1 %cmp7.i.i, label %last.exit.i, label %cond.end13.i.i, !llvm.loop !109
...
for.body.us:                                      ; preds = %for.body.lr.ph, %for.body.us
  ...
  br i1 %exitcond23.not, label %for.end, label %for.body.us, !llvm.loop !115
...
for.body:                                         ; preds = %cond.end
  ...
  %cmp4 = icmp eq ptr %3, null
  br i1 %cmp4, label %cleanup, label %cond.end, !llvm.loop !117
...
for.body.us:                                      ; preds = %cond.end16.us
  ...
  br i1 %cmp7.us, label %cleanup, label %cond.end.us, !llvm.loop !118
...
funcall2.exit63:                                  ; preds = %if.end.i57, %sw.default.i61
  ...
  br i1 %cmp7, label %cleanup, label %cond.end, !llvm.loop !118
...
for.inc:                                          ; preds = %for.body, %if.then
  ...
  br i1 %cmp, label %for.end, label %cond.end, !llvm.loop !119
...
for.inc.us:                                       ; preds = %land.lhs.true.us, %cond.end9.us, %for.body.us
  ...
  br i1 %cmp.us, label %cleanup, label %cond.end.us, !llvm.loop !120
...
for.inc:                                          ; preds = %for.body, %cond.end9, %funcall2.exit
  ...
  br i1 %cmp, label %cleanup, label %cond.end, !llvm.loop !120
...
while.body:                                       ; preds = %entry, %while.body
  ...
  br i1 %cmp, label %while.body, label %for.cond.preheader, !llvm.loop !121
...
for.body:                                         ; preds = %for.cond.preheader, %for.body
  ...
  br i1 %cmp3.not, label %for.cond8.preheader, label %for.body, !llvm.loop !122
...
for.body10:                                       ; preds = %for.cond8.preheader, %for.body10
  ...
  br i1 %cmp9.not, label %for.end16, label %for.body10, !llvm.loop !123
...
vaarg.end:                                        ; preds = %vaarg.in_mem, %vaarg.in_reg
  ...
  br i1 %exitcond24.not, label %for.end9, label %for.body3, !llvm.loop !125
...
if.end11.us:                                      ; preds = %if.then9.us, %while.body.us
  ...
  br i1 %cmp7.not.us, label %while.end, label %while.body.us, !llvm.loop !126
...
if.end11:                                         ; preds = %if.then9, %while.body
  ...
  br i1 %cmp7.not, label %while.end, label %while.body, !llvm.loop !126
...
for.body:                                         ; preds = %if.end18, %for.body
  ...
  br i1 %cmp34.not, label %for.end, label %for.body, !llvm.loop !127
...
get_c_long.exit:                                  ; preds = %cond.false.i70, %if.then.i72
  ...
  %or.cond = select i1 %cmp9102, i1 %cmp12100, i1 false
...
for.body14.us:                                    ; preds = %for.cond11.preheader.us, %for.body14.us
  ...
  br i1 %exitcond.not, label %for.cond11.for.inc19_crit_edge.us, label %for.body14.us, !llvm.loop !128
...
for.cond11.for.inc19_crit_edge.us:                ; preds = %for.body14.us
  ...
  br i1 %exitcond105.not, label %sw.epilog, label %for.cond11.preheader.us, !llvm.loop !129
...
entry:
  ...
  %call1 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call) #26
  %div20 = lshr i64 %call1, 1
  %call.i = tail call i64 @no_interrupt(i64 noundef 1) #25
  %call1.i = tail call ptr @cons(ptr noundef null, ptr noundef null) #25
  %storage_as47.i = getelementptr inbounds %struct.obj, ptr %call1.i, i64 0, i32 2
  store i64 %div20, ptr %storage_as47.i, align 8, !tbaa !17
  %call49.i = tail call ptr @must_malloc(i64 noundef %div20) #25
  %data51.i = getelementptr inbounds %struct.obj, ptr %call1.i, i64 0, i32 2, i32 0, i32 1
  store ptr %call49.i, ptr %data51.i, align 8, !tbaa !17
  %type.i = getelementptr inbounds %struct.obj, ptr %call1.i, i64 0, i32 1
  store i16 18, ptr %type.i, align 2, !tbaa !14
...
for.body.lr.ph:                                   ; preds = %entry
  %call.i21 = tail call ptr @__ctype_b_loc() #27
  %umax = tail call i64 @llvm.umax.i64(i64 %div20, i64 1)
  br label %for.body

for.body:                                         ; preds = %for.body.lr.ph, %xdigitvalue.exit43
  %j.045 = phi i64 [ 0, %for.body.lr.ph ], [ %inc, %xdigitvalue.exit43 ]
  %mul = shl nuw nsw i64 %j.045, 1
  %arrayidx = getelementptr inbounds i8, ptr %call, i64 %mul
  %1 = load i8, ptr %arrayidx, align 1, !tbaa !17
  %2 = load ptr, ptr %call.i21, align 8, !tbaa !13
...
xdigitvalue.exit:                                 ; preds = %if.then.i, %if.end.i, %if.end16.i
  ...
  %idxprom.i23 = sext i8 %6 to i64
  %arrayidx.i24 = getelementptr inbounds i16, ptr %2, i64 %idxprom.i23
  %7 = load i16, ptr %arrayidx.i24, align 2, !tbaa !81
  %conv.i25 = zext i16 %7 to i32
  %and.i26 = and i32 %conv.i25, 2048
  %tobool.not.i27 = icmp eq i32 %and.i26, 0
  br i1 %tobool.not.i27, label %if.end.i32, label %if.then.i29

if.then.i29:                                      ; preds = %xdigitvalue.exit
  %conv746 = zext i8 %6 to i32
  %sub.i28 = add nsw i32 %conv746, -48
  br label %xdigitvalue.exit43

if.end.i32:                                       ; preds = %xdigitvalue.exit
  %and5.i30 = and i32 %conv.i25, 4096
  %tobool6.not.i31 = icmp eq i32 %and5.i30, 0
  br i1 %tobool6.not.i31, label %xdigitvalue.exit43, label %if.end16.i41

if.end16.i41:                                     ; preds = %if.end.i32
  %call.i.i36 = tail call ptr @__ctype_toupper_loc() #27
  %8 = load ptr, ptr %call.i.i36, align 8, !tbaa !13
  %arrayidx.i.i37 = getelementptr inbounds i32, ptr %8, i64 %idxprom.i23
  %9 = load i32, ptr %arrayidx.i.i37, align 4, !tbaa !75
  %add.i40 = add nsw i32 %9, -55
  br label %xdigitvalue.exit43

xdigitvalue.exit43:                               ; preds = %if.then.i29, %if.end.i32, %if.end16.i41
  %retval.0.i42 = phi i32 [ %sub.i28, %if.then.i29 ], [ %add.i40, %if.end16.i41 ], [ 0, %if.end.i32 ]
  %add9 = add i32 %retval.0.i42, %mul4
...
for.end:                                          ; preds = %xdigitvalue.exit43, %entry
  ret ptr %call1.i
}
...
for.inc:                                          ; preds = %for.body
  ...
  br i1 %cmp.not, label %cleanup, label %for.body, !llvm.loop !132
...
while.body14:                                     ; preds = %if.else, %while.body14
  ...
  br i1 %cmp13.not, label %while.end, label %while.body14, !llvm.loop !134
...
if.end19:                                         ; preds = %while.body
  ...
  br i1 %cmp2.not, label %while.end21, label %while.body, !llvm.loop !135
...
while.body36:                                     ; preds = %if.end32, %while.body36
  ...
  br i1 %cmp35.not, label %while.end40, label %while.body36, !llvm.loop !136
...
entry:
  ...
  %call2 = tail call i64 @strspn(ptr noundef %call, ptr noundef %call1) #25
...
entry:
  %call = tail call ptr @get_c_string(ptr noundef %str1) #25
  %call1 = tail call ptr @get_c_string(ptr noundef %str2) #25
  %call2 = tail call i64 @strcspn(ptr noundef %call, ptr noundef %call1) #25
  %conv = uitofp i64 %call2 to double
  %call3 = tail call ptr @flocons(double noundef %conv) #25
  ret ptr %call3
}
...
cond.end:                                         ; preds = %entry, %get_c_long.exit
  ...
  br i1 %cmp3, label %cond.true4, label %cond.false.i43
...
cond.false.i43:                                   ; preds = %cond.end
  %type.i42 = getelementptr inbounds %struct.obj, ptr %end, i64 0, i32 1
  %4 = load i16, ptr %type.i42, align 2, !tbaa !14
  %5 = icmp eq i16 %4, 2
  br i1 %5, label %get_c_long.exit48, label %if.then.i45

if.then.i45:                                      ; preds = %cond.false.i43
  %call.i44 = call ptr @err(ptr noundef nonnull @.str.44, ptr noundef nonnull %end) #25
  br label %get_c_long.exit48

get_c_long.exit48:                                ; preds = %cond.false.i43, %if.then.i45
  %storage_as.i46 = getelementptr inbounds %struct.obj, ptr %end, i64 0, i32 2
  %6 = load double, ptr %storage_as.i46, align 8, !tbaa !17
  %conv3.i47 = fptosi double %6 to i64
  br label %cond.end7

cond.end7:                                        ; preds = %get_c_long.exit48, %cond.true4
  %cond8 = phi i64 [ %3, %cond.true4 ], [ %conv3.i47, %get_c_long.exit48 ]
...
lor.lhs.false:                                    ; preds = %cond.end7
  ...
  %or.cond40 = select i1 %or.cond, i1 true, i1 %cmp14
  br i1 %or.cond40, label %cleanup, label %lor.lhs.false15
...
while.body.i:                                     ; preds = %get_c_long.exit.i, %while.body.i
  ...
  %dec.i = add nsw i64 %n.05.i, -1
  %cmp.i = icmp ugt i64 %n.05.i, 1
  br i1 %cmp.i, label %while.body.i, label %cond.end, !llvm.loop !94
...
last.exit.i:                                      ; preds = %while.body.i.i, %cond.end13.i.i, %cond.end13.i.preheader.i, %cond.end5.i.i
  ...
  %call1.i17 = tail call ptr @setcdr(ptr noundef nonnull %v1.0.lcssa.i.i, ptr noundef %call1.i) #25
  br label %if.end
