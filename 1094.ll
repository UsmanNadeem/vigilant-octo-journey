; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/Common/CommandLineParser.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/Common/CommandLineParser.cpp"
...
for.body.lr.ph.i:                                 ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i385, %call.i.i32.i.noexc
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %ref.tmp.sroa.0.3, ptr align 4 %temp.sroa.0.2, i64 %26, i1 false), !tbaa !28, !noalias !38
  br label %invoke.cont
...
entry:
  ...
  %0 = load i32, ptr %_length, align 8, !tbaa !25
