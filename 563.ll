; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/slice.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/slice.c"
...
for.inc.peel:                                     ; preds = %if.then8.peel, %if.else17.peel
  ...
  br i1 %12, label %if.end6, label %for.end

if.end6:                                          ; preds = %for.inc.peel
  %13 = load ptr, ptr %partArr, align 8, !tbaa !24
  %arrayidx = getelementptr inbounds %struct.datapartition, ptr %13, i64 1
  %14 = load ptr, ptr %arrayidx, align 8, !tbaa !25
  %write_flag = getelementptr inbounds %struct.Bitstream, ptr %14, i64 0, i32 10
...
if.then8:                                         ; preds = %if.end6
  %15 = load ptr, ptr %partArr, align 8, !tbaa !24
  %ee_cabac = getelementptr inbounds %struct.datapartition, ptr %15, i64 1, i32 1
  %bits_to_go = getelementptr inbounds %struct.Bitstream, ptr %14, i64 0, i32 1
  %16 = load i32, ptr %bits_to_go, align 4, !tbaa !31
  %cmp12.not = icmp eq i32 %16, 8
  %add15 = select i1 %cmp12.not, i32 0, i32 %16
  %spec.select = add nsw i32 %add15, %header_len.1
  tail call void @writeVlcByteAlign(ptr noundef nonnull %14) #12
  %streamBuffer = getelementptr inbounds %struct.Bitstream, ptr %14, i64 0, i32 9
  %17 = load ptr, ptr %streamBuffer, align 8, !tbaa !32
  tail call void @arienco_start_encoding(ptr noundef nonnull %ee_cabac, ptr noundef %17, ptr noundef nonnull %14) #12
  tail call void @cabac_new_slice() #12
  br label %for.inc
...
for.inc:                                          ; preds = %if.then8, %if.else17
  ...
  %18 = load ptr, ptr %partArr, align 8, !tbaa !24
  %arrayidx.1 = getelementptr inbounds %struct.datapartition, ptr %18, i64 2
  %19 = load ptr, ptr %arrayidx.1, align 8, !tbaa !25
  %write_flag.1 = getelementptr inbounds %struct.Bitstream, ptr %19, i64 0, i32 10
...
if.then8.1:                                       ; preds = %for.inc
  %20 = load ptr, ptr %partArr, align 8, !tbaa !24
  %ee_cabac.1 = getelementptr inbounds %struct.datapartition, ptr %20, i64 2, i32 1
  %bits_to_go.1 = getelementptr inbounds %struct.Bitstream, ptr %19, i64 0, i32 1
  %21 = load i32, ptr %bits_to_go.1, align 4, !tbaa !31
  %cmp12.not.1 = icmp eq i32 %21, 8
  %add15.1 = select i1 %cmp12.not.1, i32 0, i32 %21
  %spec.select.1 = add nsw i32 %add15.1, %header_len.1.1
  tail call void @writeVlcByteAlign(ptr noundef nonnull %19) #12
  %streamBuffer.1 = getelementptr inbounds %struct.Bitstream, ptr %19, i64 0, i32 9
  %22 = load ptr, ptr %streamBuffer.1, align 8, !tbaa !32
  tail call void @arienco_start_encoding(ptr noundef nonnull %ee_cabac.1, ptr noundef %22, ptr noundef nonnull %19) #12
  tail call void @cabac_new_slice() #12
  br label %for.end
...
for.end:                                          ; preds = %if.else17.1, %if.then8.1, %for.inc.peel
  ...
  %symbol_mode19 = getelementptr inbounds %struct.InputParameters, ptr %23, i64 0, i32 74
  %24 = load i32, ptr %symbol_mode19, align 8, !tbaa !30
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %stuffing_bytes.094 = phi i32 [ 0, %for.body.lr.ph ], [ %stuffing_bytes.2, %for.inc ]
...
if.end43:                                         ; preds = %if.then18, %if.then37, %land.lhs.true, %if.else
  %stuffing_bytes.1 = phi i32 [ %sub39, %if.then37 ], [ %stuffing_bytes.094, %if.then18 ], [ %stuffing_bytes.094, %land.lhs.true ], [ %stuffing_bytes.094, %if.else ]
...
for.inc:                                          ; preds = %if.then4, %if.end43
  ...
  %stuffing_bytes.2 = phi i32 [ %stuffing_bytes.094, %if.then4 ], [ %stuffing_bytes.1, %if.end43 ]
...
if.then26.i:                                      ; preds = %land.lhs.true.i
  ...
  %cmp29.not.i = icmp eq i32 %46, 0
  %add30.i = select i1 %cmp29.not.i, i32 1, i32 2
  %mul.i = mul nsw i32 %add30.i, %45
...
if.then39.i:                                      ; preds = %if.then37.i
  ...
  %50 = load i32, ptr %structure42.i, align 8, !tbaa !79
  %cmp43.not.i = icmp eq i32 %50, 0
  %add45.i = select i1 %cmp43.not.i, i32 1, i32 2
  %mul46.i = mul nsw i32 %add45.i, %49
  %cond.i382.i = tail call i32 @llvm.smin.i32(i32 %48, i32 %mul46.i)
...
if.end49.i:                                       ; preds = %if.then39.i, %if.then37.i
  ...
  %51 = load i32, ptr %B_List1_refs.i, align 4, !tbaa !81
...
if.then51.i:                                      ; preds = %if.end49.i
  ...
  %52 = load i32, ptr %structure54.i, align 8, !tbaa !79
  %cmp55.not.i = icmp eq i32 %52, 0
  %add57.i = select i1 %cmp55.not.i, i32 1, i32 2
  %mul58.i = mul nsw i32 %add57.i, %51
...
if.end62.i:                                       ; preds = %if.then51.i, %if.end49.i, %if.end33.i, %if.end21.i
  ...
  %53 = load i32, ptr %structure64.i, align 8, !tbaa !79
  tail call void @init_lists(i32 noundef %44, i32 noundef %53) #12
  %54 = load ptr, ptr @img, align 8, !tbaa !5
  %num_ref_idx_l0_active65.i = getelementptr inbounds %struct.ImageParameters, ptr %54, i64 0, i32 88
  %55 = load <2 x i32>, ptr @listXsize, align 16, !tbaa !43
  store <2 x i32> %55, ptr %num_ref_idx_l0_active65.i, align 8, !tbaa !43
  %nal_reference_idc.i = getelementptr inbounds %struct.ImageParameters, ptr %54, i64 0, i32 122
  %56 = load i32, ptr %nal_reference_idc.i, align 8, !tbaa !82
  %tobool67.not.i = icmp eq i32 %56, 0
...
land.lhs.true68.i:                                ; preds = %if.end62.i
  ...
  %PocMemoryManagement.i = getelementptr inbounds %struct.InputParameters, ptr %57, i64 0, i32 73
  %58 = load i32, ptr %PocMemoryManagement.i, align 4, !tbaa !83
  %tobool69.not.i = icmp eq i32 %58, 0
  br i1 %tobool69.not.i, label %if.end74.i, label %land.lhs.true70.i

land.lhs.true70.i:                                ; preds = %land.lhs.true68.i
  %59 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 5), align 8, !tbaa !84
  %60 = load ptr, ptr @active_sps, align 8, !tbaa !5
  %num_ref_frames.i = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %60, i64 0, i32 21
  %61 = load i32, ptr %num_ref_frames.i, align 4, !tbaa !86
  %cmp71.i = icmp eq i32 %59, %61
  br i1 %cmp71.i, label %if.then73.i, label %if.end74.i

if.then73.i:                                      ; preds = %land.lhs.true70.i
  %frame_num.i = getelementptr inbounds %struct.ImageParameters, ptr %54, i64 0, i32 115
  %62 = load i32, ptr %frame_num.i, align 4, !tbaa !87
  tail call void @poc_based_ref_management(i32 noundef %62) #12
  br label %if.end74.i

if.end74.i:                                       ; preds = %if.then73.i, %land.lhs.true70.i, %land.lhs.true68.i, %if.end62.i
  %63 = load ptr, ptr @input, align 8, !tbaa !5
  %EnableOpenGOP.i = getelementptr inbounds %struct.InputParameters, ptr %63, i64 0, i32 31
  %64 = load i32, ptr %EnableOpenGOP.i, align 4, !tbaa !88
  %tobool75.not.i = icmp eq i32 %64, 0
  br i1 %tobool75.not.i, label %if.end118.i, label %for.cond77.preheader.i

for.cond77.preheader.i:                           ; preds = %if.end74.i
  %65 = load i32, ptr @listXsize, align 16, !tbaa !43
  %cmp78403.i = icmp sgt i32 %65, 0
...
for.body80.lr.ph.i:                               ; preds = %for.cond77.preheader.i
  ...
  %last_valid_reference.i = getelementptr inbounds %struct.ImageParameters, ptr %67, i64 0, i32 169
  %68 = load i32, ptr %last_valid_reference.i, align 4, !tbaa !89
  %ThisPOC.i = getelementptr inbounds %struct.ImageParameters, ptr %67, i64 0, i32 114
  %wide.trip.count420.i = zext i32 %65 to i64
...
for.body80.i:                                     ; preds = %for.inc93.i, %for.body80.lr.ph.i
  ...
  %arrayidx82.i = getelementptr inbounds ptr, ptr %66, i64 %indvars.iv417.i
  %69 = load ptr, ptr %arrayidx82.i, align 8, !tbaa !5
  %poc.i = getelementptr inbounds %struct.storable_picture, ptr %69, i64 0, i32 1
  %70 = load i32, ptr %poc.i, align 4, !tbaa !90
  %cmp83.i = icmp slt i32 %70, %68
  br i1 %cmp83.i, label %land.lhs.true85.i, label %for.inc93.i

land.lhs.true85.i:                                ; preds = %for.body80.i
  %71 = load i32, ptr %ThisPOC.i, align 8, !tbaa !92
  %cmp87.i = icmp sgt i32 %71, %68
  br i1 %cmp87.i, label %if.then89.i, label %for.inc93.i

if.then89.i:                                      ; preds = %land.lhs.true85.i
  %72 = trunc i64 %indvars.iv417.i to i32
  %cond.i384.i = tail call i32 @llvm.smax.i32(i32 %72, i32 1)
  %num_ref_idx_l0_active91.i = getelementptr inbounds %struct.ImageParameters, ptr %67, i64 0, i32 88
...
for.end95.i:                                      ; preds = %for.inc93.i, %if.then89.i, %for.cond77.preheader.i
  %73 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 1), align 4, !tbaa !43
  %cmp97405.i = icmp sgt i32 %73, 0
  br i1 %cmp97405.i, label %for.body99.lr.ph.i, label %if.end118.i

for.body99.lr.ph.i:                               ; preds = %for.end95.i
  %74 = load ptr, ptr getelementptr inbounds ([6 x ptr], ptr @listX, i64 0, i64 1), align 8, !tbaa !5
  %75 = load ptr, ptr @img, align 8, !tbaa !5
  %last_valid_reference103.i = getelementptr inbounds %struct.ImageParameters, ptr %75, i64 0, i32 169
  %76 = load i32, ptr %last_valid_reference103.i, align 4, !tbaa !89
  %ThisPOC107.i = getelementptr inbounds %struct.ImageParameters, ptr %75, i64 0, i32 114
  %wide.trip.count425.i = zext i32 %73 to i64
...
for.body99.i:                                     ; preds = %for.inc115.i, %for.body99.lr.ph.i
  ...
  %arrayidx101.i = getelementptr inbounds ptr, ptr %74, i64 %indvars.iv422.i
...
if.then111.i:                                     ; preds = %land.lhs.true106.i
  ...
  %num_ref_idx_l1_active113.i = getelementptr inbounds %struct.ImageParameters, ptr %75, i64 0, i32 89
...
land.lhs.true122.i:                               ; preds = %if.end118.i
  %ReferenceReorder.i = getelementptr inbounds %struct.InputParameters, ptr %63, i64 0, i32 72
...
for.end148.i:                                     ; preds = %for.end148.loopexit.i, %for.cond134.preheader.i
  ...
  %94 = phi i32 [ %.pre.i, %for.end148.loopexit.i ], [ %86, %for.cond134.preheader.i ]
...
if.end202.i:                                      ; preds = %if.then190.i, %if.then177.i, %if.end169.i, %if.end169.i, %land.lhs.true122.i, %if.end118.i
  %124 = phi ptr [ %.pre442.i, %if.then190.i ], [ %112, %if.then177.i ], [ %85, %if.end169.i ], [ %85, %if.end169.i ], [ %81, %land.lhs.true122.i ], [ %81, %if.end118.i ]
...
if.end207.i:                                      ; preds = %if.then206.i, %if.end202.i
  %126 = phi ptr [ %.pre443.i, %if.then206.i ], [ %124, %if.end202.i ]
...
lor.lhs.false214.i:                               ; preds = %land.lhs.true211.i
  ...
  %or.cond.i = select i1 %cmp215.not.i, i1 %cmp219.i, i1 false
...
for.body.i394.i:                                  ; preds = %for.body.i394.i, %for.body.lr.ph.i.i
  ...
  %arrayidx.i387.i = getelementptr inbounds ptr, ptr %137, i64 %indvars.iv.i386.i
  %142 = load ptr, ptr %arrayidx.i387.i, align 8, !tbaa !5
  %poc.i.i = getelementptr inbounds %struct.storable_picture, ptr %142, i64 0, i32 1
  %143 = load i32, ptr %poc.i.i, align 4, !tbaa !90
  %mul.i388.i = shl nsw i32 %143, 1
...
for.end63.i.i:                                    ; preds = %for.body24.i.i, %for.cond21.preheader.i.i
  ...
  %tobool.not.i395.i = icmp eq i32 %155, 0
...
land.lhs.true.i.i:                                ; preds = %for.end63.i.i
  %structure64.i.i = getelementptr inbounds %struct.ImageParameters, ptr %156, i64 0, i32 6
  %157 = load i32, ptr %structure64.i.i, align 8, !tbaa !79
  %cmp65.i.i = icmp eq i32 %157, 0
...
for.cond67.preheader.i.i:                         ; preds = %land.lhs.true.i.i
  %158 = load ptr, ptr @enc_picture, align 8
  %159 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 2), align 8, !tbaa !43
  %cmp74170.i.i = icmp sgt i32 %159, 0
  br i1 %cmp74170.i.i, label %for.body76.lr.ph.i.i, label %for.inc122.i.i

for.body76.lr.ph.i.i:                             ; preds = %for.cond67.preheader.i.i
  %160 = load ptr, ptr getelementptr inbounds ([6 x ptr], ptr @listX, i64 0, i64 2), align 16, !tbaa !5
  %wide.trip.count182.i.i = zext i32 %159 to i64
...
for.body76.i.i:                                   ; preds = %for.body76.i.i, %for.body76.lr.ph.i.i
  ...
  %arrayidx80.i.i = getelementptr inbounds ptr, ptr %160, i64 %indvars.iv179.i.i
  %161 = load ptr, ptr %arrayidx80.i.i, align 8, !tbaa !5
  %poc81.i.i = getelementptr inbounds %struct.storable_picture, ptr %161, i64 0, i32 1
  %162 = load i32, ptr %poc81.i.i, align 4, !tbaa !90
  %mul82.i.i = shl nsw i32 %162, 1
  %163 = load i32, ptr %161, align 8, !tbaa !108
  %cmp84.i.i = icmp eq i32 %163, 2
  %cond86.i.i = zext i1 %cmp84.i.i to i32
  %add87.i.i = or i32 %mul82.i.i, %cond86.i.i
  %conv88.i.i = sext i32 %add87.i.i to i64
  %arrayidx93.i.i = getelementptr inbounds %struct.storable_picture, ptr %158, i64 0, i32 6, i64 2, i64 %indvars.iv179.i.i
  store i64 %conv88.i.i, ptr %arrayidx93.i.i, align 8, !tbaa !109
  %frame_poc94.i.i = getelementptr inbounds %struct.storable_picture, ptr %161, i64 0, i32 4
  %164 = load i32, ptr %frame_poc94.i.i, align 8, !tbaa !110
  %mul95.i.i = shl nsw i32 %164, 1
  %conv96.i.i = sext i32 %mul95.i.i to i64
  %arrayidx101.i.i = getelementptr inbounds %struct.storable_picture, ptr %158, i64 0, i32 7, i64 2, i64 %indvars.iv179.i.i
  store i64 %conv96.i.i, ptr %arrayidx101.i.i, align 8, !tbaa !109
  %top_poc102.i.i = getelementptr inbounds %struct.storable_picture, ptr %161, i64 0, i32 2
  %165 = load i32, ptr %top_poc102.i.i, align 8, !tbaa !111
  %mul103.i.i = shl nsw i32 %165, 1
  %conv104.i.i = sext i32 %mul103.i.i to i64
  %arrayidx109.i.i = getelementptr inbounds %struct.storable_picture, ptr %158, i64 0, i32 8, i64 2, i64 %indvars.iv179.i.i
  store i64 %conv104.i.i, ptr %arrayidx109.i.i, align 8, !tbaa !109
  %bottom_poc110.i.i = getelementptr inbounds %struct.storable_picture, ptr %161, i64 0, i32 3
  %166 = load i32, ptr %bottom_poc110.i.i, align 4, !tbaa !112
  %mul111.i.i = shl nsw i32 %166, 1
  %add112.i.i = or i32 %mul111.i.i, 1
  %conv113.i.i = sext i32 %add112.i.i to i64
  %arrayidx118.i.i = getelementptr inbounds %struct.storable_picture, ptr %158, i64 0, i32 9, i64 2, i64 %indvars.iv179.i.i
...
for.inc122.i.i:                                   ; preds = %for.body76.i.i, %for.cond67.preheader.i.i
  %167 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 3), align 4, !tbaa !43
  %cmp74170.1.i.i = icmp sgt i32 %167, 0
  br i1 %cmp74170.1.i.i, label %for.body76.lr.ph.1.i.i, label %for.inc122.1.i.i

for.body76.lr.ph.1.i.i:                           ; preds = %for.inc122.i.i
  %168 = load ptr, ptr getelementptr inbounds ([6 x ptr], ptr @listX, i64 0, i64 3), align 8, !tbaa !5
  %wide.trip.count182.1.i.i = zext i32 %167 to i64
...
for.body76.1.i.i:                                 ; preds = %for.body76.1.i.i, %for.body76.lr.ph.1.i.i
  ...
  %arrayidx80.1.i.i = getelementptr inbounds ptr, ptr %168, i64 %indvars.iv179.1.i.i
  %169 = load ptr, ptr %arrayidx80.1.i.i, align 8, !tbaa !5
  %poc81.1.i.i = getelementptr inbounds %struct.storable_picture, ptr %169, i64 0, i32 1
  %170 = load i32, ptr %poc81.1.i.i, align 4, !tbaa !90
  %mul82.1.i.i = shl nsw i32 %170, 1
  %171 = load i32, ptr %169, align 8, !tbaa !108
  %cmp84.1.i.i = icmp eq i32 %171, 2
  ...
  %arrayidx93.1.i.i = getelementptr inbounds %struct.storable_picture, ptr %158, i64 0, i32 6, i64 3, i64 %indvars.iv179.1.i.i
  store i64 %conv88.1.i.i, ptr %arrayidx93.1.i.i, align 8, !tbaa !109
  %frame_poc94.1.i.i = getelementptr inbounds %struct.storable_picture, ptr %169, i64 0, i32 4
  %172 = load i32, ptr %frame_poc94.1.i.i, align 8, !tbaa !110
  %mul95.1.i.i = shl nsw i32 %172, 1
  %conv96.1.i.i = sext i32 %mul95.1.i.i to i64
  %arrayidx101.1.i.i = getelementptr inbounds %struct.storable_picture, ptr %158, i64 0, i32 7, i64 3, i64 %indvars.iv179.1.i.i
  store i64 %conv96.1.i.i, ptr %arrayidx101.1.i.i, align 8, !tbaa !109
  %top_poc102.1.i.i = getelementptr inbounds %struct.storable_picture, ptr %169, i64 0, i32 2
  %173 = load i32, ptr %top_poc102.1.i.i, align 8, !tbaa !111
  %mul103.1.i.i = shl nsw i32 %173, 1
  %conv104.1.i.i = sext i32 %mul103.1.i.i to i64
  %arrayidx109.1.i.i = getelementptr inbounds %struct.storable_picture, ptr %158, i64 0, i32 8, i64 3, i64 %indvars.iv179.1.i.i
  store i64 %conv104.1.i.i, ptr %arrayidx109.1.i.i, align 8, !tbaa !109
  %bottom_poc110.1.i.i = getelementptr inbounds %struct.storable_picture, ptr %169, i64 0, i32 3
  %174 = load i32, ptr %bottom_poc110.1.i.i, align 4, !tbaa !112
  %mul111.1.i.i = shl nsw i32 %174, 1
  %add112.1.i.i = or i32 %mul111.1.i.i, 1
  %conv113.1.i.i = sext i32 %add112.1.i.i to i64
  %arrayidx118.1.i.i = getelementptr inbounds %struct.storable_picture, ptr %158, i64 0, i32 9, i64 3, i64 %indvars.iv179.1.i.i
...
for.inc122.1.i.i:                                 ; preds = %for.body76.1.i.i, %for.inc122.i.i
  %175 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 4), align 16, !tbaa !43
  %cmp74170.2.i.i = icmp sgt i32 %175, 0
  br i1 %cmp74170.2.i.i, label %for.body76.lr.ph.2.i.i, label %for.inc122.2.i.i

for.body76.lr.ph.2.i.i:                           ; preds = %for.inc122.1.i.i
  %176 = load ptr, ptr getelementptr inbounds ([6 x ptr], ptr @listX, i64 0, i64 4), align 16, !tbaa !5
  %wide.trip.count182.2.i.i = zext i32 %175 to i64
...
for.body76.2.i.i:                                 ; preds = %for.body76.2.i.i, %for.body76.lr.ph.2.i.i
  ...
  %arrayidx80.2.i.i = getelementptr inbounds ptr, ptr %176, i64 %indvars.iv179.2.i.i
  %177 = load ptr, ptr %arrayidx80.2.i.i, align 8, !tbaa !5
  %poc81.2.i.i = getelementptr inbounds %struct.storable_picture, ptr %177, i64 0, i32 1
  %178 = load i32, ptr %poc81.2.i.i, align 4, !tbaa !90
  %mul82.2.i.i = shl nsw i32 %178, 1
  %179 = load i32, ptr %177, align 8, !tbaa !108
  %cmp84.2.i.i = icmp eq i32 %179, 2
  ...
  %arrayidx93.2.i.i = getelementptr inbounds %struct.storable_picture, ptr %158, i64 0, i32 6, i64 4, i64 %indvars.iv179.2.i.i
  store i64 %conv88.2.i.i, ptr %arrayidx93.2.i.i, align 8, !tbaa !109
  %frame_poc94.2.i.i = getelementptr inbounds %struct.storable_picture, ptr %177, i64 0, i32 4
  %180 = load i32, ptr %frame_poc94.2.i.i, align 8, !tbaa !110
  %mul95.2.i.i = shl nsw i32 %180, 1
  %conv96.2.i.i = sext i32 %mul95.2.i.i to i64
  %arrayidx101.2.i.i = getelementptr inbounds %struct.storable_picture, ptr %158, i64 0, i32 7, i64 4, i64 %indvars.iv179.2.i.i
  store i64 %conv96.2.i.i, ptr %arrayidx101.2.i.i, align 8, !tbaa !109
  %top_poc102.2.i.i = getelementptr inbounds %struct.storable_picture, ptr %177, i64 0, i32 2
  %181 = load i32, ptr %top_poc102.2.i.i, align 8, !tbaa !111
  %mul103.2.i.i = shl nsw i32 %181, 1
  %conv104.2.i.i = sext i32 %mul103.2.i.i to i64
  %arrayidx109.2.i.i = getelementptr inbounds %struct.storable_picture, ptr %158, i64 0, i32 8, i64 4, i64 %indvars.iv179.2.i.i
  store i64 %conv104.2.i.i, ptr %arrayidx109.2.i.i, align 8, !tbaa !109
  %bottom_poc110.2.i.i = getelementptr inbounds %struct.storable_picture, ptr %177, i64 0, i32 3
  %182 = load i32, ptr %bottom_poc110.2.i.i, align 4, !tbaa !112
  %mul111.2.i.i = shl nsw i32 %182, 1
  %add112.2.i.i = or i32 %mul111.2.i.i, 1
  %conv113.2.i.i = sext i32 %add112.2.i.i to i64
  %arrayidx118.2.i.i = getelementptr inbounds %struct.storable_picture, ptr %158, i64 0, i32 9, i64 4, i64 %indvars.iv179.2.i.i
...
for.inc122.2.i.i:                                 ; preds = %for.body76.2.i.i, %for.inc122.1.i.i
  %183 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 5), align 4, !tbaa !43
  %cmp74170.3.i.i = icmp sgt i32 %183, 0
...
for.body76.lr.ph.3.i.i:                           ; preds = %for.inc122.2.i.i
  %184 = load ptr, ptr getelementptr inbounds ([6 x ptr], ptr @listX, i64 0, i64 5), align 8, !tbaa !5
  %wide.trip.count182.3.i.i = zext i32 %183 to i64
...
for.body76.3.i.i:                                 ; preds = %for.body76.3.i.i, %for.body76.lr.ph.3.i.i
  ...
  %arrayidx80.3.i.i = getelementptr inbounds ptr, ptr %184, i64 %indvars.iv179.3.i.i
  %185 = load ptr, ptr %arrayidx80.3.i.i, align 8, !tbaa !5
  %poc81.3.i.i = getelementptr inbounds %struct.storable_picture, ptr %185, i64 0, i32 1
  %186 = load i32, ptr %poc81.3.i.i, align 4, !tbaa !90
  %mul82.3.i.i = shl nsw i32 %186, 1
  %187 = load i32, ptr %185, align 8, !tbaa !108
  %cmp84.3.i.i = icmp eq i32 %187, 2
  ...
  %arrayidx93.3.i.i = getelementptr inbounds %struct.storable_picture, ptr %158, i64 0, i32 6, i64 5, i64 %indvars.iv179.3.i.i
  store i64 %conv88.3.i.i, ptr %arrayidx93.3.i.i, align 8, !tbaa !109
  %frame_poc94.3.i.i = getelementptr inbounds %struct.storable_picture, ptr %185, i64 0, i32 4
  %188 = load i32, ptr %frame_poc94.3.i.i, align 8, !tbaa !110
  %mul95.3.i.i = shl nsw i32 %188, 1
  %conv96.3.i.i = sext i32 %mul95.3.i.i to i64
  %arrayidx101.3.i.i = getelementptr inbounds %struct.storable_picture, ptr %158, i64 0, i32 7, i64 5, i64 %indvars.iv179.3.i.i
  store i64 %conv96.3.i.i, ptr %arrayidx101.3.i.i, align 8, !tbaa !109
  %top_poc102.3.i.i = getelementptr inbounds %struct.storable_picture, ptr %185, i64 0, i32 2
  %189 = load i32, ptr %top_poc102.3.i.i, align 8, !tbaa !111
  %mul103.3.i.i = shl nsw i32 %189, 1
  %conv104.3.i.i = sext i32 %mul103.3.i.i to i64
  %arrayidx109.3.i.i = getelementptr inbounds %struct.storable_picture, ptr %158, i64 0, i32 8, i64 5, i64 %indvars.iv179.3.i.i
  store i64 %conv104.3.i.i, ptr %arrayidx109.3.i.i, align 8, !tbaa !109
  %bottom_poc110.3.i.i = getelementptr inbounds %struct.storable_picture, ptr %185, i64 0, i32 3
  %190 = load i32, ptr %bottom_poc110.3.i.i, align 4, !tbaa !112
  %mul111.3.i.i = shl nsw i32 %190, 1
  %add112.3.i.i = or i32 %mul111.3.i.i, 1
  %conv113.3.i.i = sext i32 %add112.3.i.i to i64
  %arrayidx118.3.i.i = getelementptr inbounds %struct.storable_picture, ptr %158, i64 0, i32 9, i64 5, i64 %indvars.iv179.3.i.i
...
set_ref_pic_num.exit.i:                           ; preds = %for.body76.3.i.i, %for.inc122.2.i.i, %land.lhs.true.i.i, %for.end63.i.i
  %type244.i = getelementptr inbounds %struct.ImageParameters, ptr %156, i64 0, i32 5
  %191 = load i32, ptr %type244.i, align 4, !tbaa !77
  %cmp245.i = icmp eq i32 %191, 1
  br i1 %cmp245.i, label %if.then247.i, label %if.end248.i

if.then247.i:                                     ; preds = %set_ref_pic_num.exit.i
  %192 = load ptr, ptr @Co_located, align 8, !tbaa !5
  tail call void @compute_colocated(ptr noundef %192, ptr noundef nonnull @listX) #12
...
if.end248.i:                                      ; preds = %if.then247.i, %set_ref_pic_num.exit.i
  %193 = phi i32 [ %.pre446.i, %if.then247.i ], [ %191, %set_ref_pic_num.exit.i ]
  %cmp250.not.i = icmp eq i32 %193, 2
  br i1 %cmp250.not.i, label %if.end256.i, label %land.lhs.true252.i

land.lhs.true252.i:                               ; preds = %if.end248.i
  %194 = load ptr, ptr @input, align 8, !tbaa !5
  %SearchMode.i = getelementptr inbounds %struct.InputParameters, ptr %194, i64 0, i32 169
  %195 = load i32, ptr %SearchMode.i, align 4, !tbaa !117
  %cmp253.i = icmp eq i32 %195, 3
  br i1 %cmp253.i, label %if.then255.i, label %if.end256.i

if.then255.i:                                     ; preds = %land.lhs.true252.i
  %196 = load ptr, ptr @EPZSCo_located, align 8, !tbaa !5
  tail call void @EPZSSliceInit(ptr noundef %196, ptr noundef nonnull @listX) #12
  br label %if.end256.i

if.end256.i:                                      ; preds = %if.then255.i, %land.lhs.true252.i, %if.end248.i
  %197 = load ptr, ptr @input, align 8, !tbaa !5
  %symbol_mode.i = getelementptr inbounds %struct.InputParameters, ptr %197, i64 0, i32 74
  %198 = load i32, ptr %symbol_mode.i, align 8, !tbaa !30
  %cmp257.i = icmp eq i32 %198, 0
...
if.then259.i:                                     ; preds = %if.end256.i
  ...
  %199 = load i32, ptr @listXsize, align 16, !tbaa !43
  %200 = icmp ult i32 %199, 3
  br i1 %200, label %switch.lookup, label %for.inc276.i

switch.lookup:                                    ; preds = %if.then259.i
  %201 = sext i32 %199 to i64
  %switch.gep = getelementptr inbounds [3 x ptr], ptr @switch.table.encode_one_slice.11, i64 0, i64 %201
...
for.inc276.i:                                     ; preds = %if.then259.i, %switch.lookup
  ...
  %202 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 1), align 4, !tbaa !43
  %203 = icmp ult i32 %202, 3
  br i1 %203, label %switch.lookup403, label %for.inc276.1.i

switch.lookup403:                                 ; preds = %for.inc276.i
  %204 = sext i32 %202 to i64
  %switch.gep404 = getelementptr inbounds [3 x ptr], ptr @switch.table.encode_one_slice.11, i64 0, i64 %204
...
for.inc276.1.i:                                   ; preds = %for.inc276.i, %switch.lookup403
  ...
  %205 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 2), align 8, !tbaa !43
  %206 = icmp ult i32 %205, 3
  br i1 %206, label %switch.lookup406, label %for.inc276.2.i

switch.lookup406:                                 ; preds = %for.inc276.1.i
  %207 = sext i32 %205 to i64
  %switch.gep407 = getelementptr inbounds [3 x ptr], ptr @switch.table.encode_one_slice.11, i64 0, i64 %207
...
for.inc276.2.i:                                   ; preds = %for.inc276.1.i, %switch.lookup406
  ...
  %208 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 3), align 4, !tbaa !43
  %209 = icmp ult i32 %208, 3
  br i1 %209, label %switch.lookup409, label %for.inc276.3.i

switch.lookup409:                                 ; preds = %for.inc276.2.i
  %210 = sext i32 %208 to i64
  %switch.gep410 = getelementptr inbounds [3 x ptr], ptr @switch.table.encode_one_slice.11, i64 0, i64 %210
...
for.inc276.3.i:                                   ; preds = %for.inc276.2.i, %switch.lookup409
  ...
  %211 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 4), align 16, !tbaa !43
  %212 = icmp ult i32 %211, 3
  br i1 %212, label %switch.lookup412, label %for.inc276.4.i

switch.lookup412:                                 ; preds = %for.inc276.3.i
  %213 = sext i32 %211 to i64
  %switch.gep413 = getelementptr inbounds [3 x ptr], ptr @switch.table.encode_one_slice.11, i64 0, i64 %213
...
for.inc276.4.i:                                   ; preds = %for.inc276.3.i, %switch.lookup412
  ...
  %214 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 5), align 4, !tbaa !43
  %215 = icmp ult i32 %214, 3
  br i1 %215, label %switch.lookup415, label %init_slice.exit
...
if.else279.i:                                     ; preds = %if.end256.i
  ...
  %216 = load i32, ptr @listXsize, align 16, !tbaa !43
  %switch.selectcmp.i = icmp ult i32 %216, 2
  %217 = select i1 %switch.selectcmp.i, ptr @writeSE_Dummy, ptr @writeRefFrame_CABAC
  store ptr %217, ptr @writeRefFrame, align 16, !tbaa !5
  %218 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 1), align 4, !tbaa !43
  ...
  %219 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 2), align 8, !tbaa !43
  %switch.selectcmp459.i = icmp ult i32 %219, 2
  %220 = select i1 %switch.selectcmp459.i, ptr @writeSE_Dummy, ptr @writeRefFrame_CABAC
  store ptr %220, ptr getelementptr inbounds ([6 x ptr], ptr @writeRefFrame, i64 0, i64 2), align 16, !tbaa !5
  %221 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 3), align 4, !tbaa !43
  %switch464.i = icmp ult i32 %221, 2
  ...
  %222 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 4), align 16, !tbaa !43
  %switch.selectcmp461.i = icmp ult i32 %222, 2
  %223 = select i1 %switch.selectcmp461.i, ptr @writeSE_Dummy, ptr @writeRefFrame_CABAC
  store ptr %223, ptr getelementptr inbounds ([6 x ptr], ptr @writeRefFrame, i64 0, i64 4), align 16, !tbaa !5
  %224 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 5), align 4, !tbaa !43
  %switch462.i = icmp ult i32 %224, 2
...
switch.lookup415:                                 ; preds = %for.inc276.4.i
  ...
  %switch.gep416 = getelementptr inbounds [3 x ptr], ptr @switch.table.encode_one_slice.11, i64 0, i64 %225
...
init_slice.exit:                                  ; preds = %for.inc276.4.i, %switch.lookup415, %if.else279.i
  ...
  %currentSlice = getelementptr inbounds %struct.ImageParameters, ptr %226, i64 0, i32 60
  %227 = load ptr, ptr %currentSlice, align 8, !tbaa !9
  %partArr = getelementptr inbounds %struct.Slice, ptr %227, i64 0, i32 6
  %228 = load ptr, ptr %partArr, align 8, !tbaa !24
  %229 = load ptr, ptr %228, align 8, !tbaa !25
  %230 = load i32, ptr %229, align 8, !tbaa !34
  store i32 %230, ptr @Bytes_After_Header, align 4, !tbaa !43
  tail call void @SetLagrangianMultipliers()
  %231 = load ptr, ptr @input, align 8, !tbaa !5
  %symbol_mode = getelementptr inbounds %struct.InputParameters, ptr %231, i64 0, i32 74
  %232 = load i32, ptr %symbol_mode, align 8, !tbaa !30
  %cmp = icmp eq i32 %232, 1
  br i1 %cmp, label %if.then, label %if.end
...
if.end:                                           ; preds = %if.then, %init_slice.exit
  %233 = phi ptr [ %.pre354, %if.then ], [ %231, %init_slice.exit ]
  %rdopt = getelementptr inbounds %struct.InputParameters, ptr %233, i64 0, i32 113
  %234 = load i32, ptr %rdopt, align 8, !tbaa !118
  %tobool.not = icmp eq i32 %234, 0
  br i1 %tobool.not, label %land.end, label %land.lhs.true

land.lhs.true:                                    ; preds = %if.end
  %RestrictRef = getelementptr inbounds %struct.InputParameters, ptr %233, i64 0, i32 128
  %235 = load i32, ptr %RestrictRef, align 4, !tbaa !119
  %tobool1.not = icmp eq i32 %235, 0
  br i1 %tobool1.not, label %land.end, label %land.rhs

land.rhs:                                         ; preds = %land.lhs.true
  %236 = load ptr, ptr @img, align 8, !tbaa !5
  %type = getelementptr inbounds %struct.ImageParameters, ptr %236, i64 0, i32 5
  %237 = load i32, ptr %type, align 4, !tbaa !77
  %cmp2 = icmp eq i32 %237, 0
  %cmp4 = icmp eq i32 %237, 3
  %spec.select = or i1 %cmp2, %cmp4
  %238 = zext i1 %spec.select to i16
  br label %land.end

land.end:                                         ; preds = %land.rhs, %land.lhs.true, %if.end
  %conv = phi i16 [ 0, %land.lhs.true ], [ 0, %if.end ], [ %238, %land.rhs ]
  %239 = load ptr, ptr @img, align 8, !tbaa !5
  %checkref = getelementptr inbounds %struct.ImageParameters, ptr %239, i64 0, i32 168
  store i16 %conv, ptr %checkref, align 8, !tbaa !120
  %call5 = tail call i32 @start_slice()
  %240 = load ptr, ptr @input, align 8, !tbaa !5
  %RCEnable = getelementptr inbounds %struct.InputParameters, ptr %240, i64 0, i32 157
  %241 = load i32, ptr %RCEnable, align 4, !tbaa !121
  %tobool6.not = icmp eq i32 %241, 0
...
if.then7:                                         ; preds = %land.end
  %242 = load ptr, ptr @generic_RC, align 8, !tbaa !5
  %NumberofHeaderBits = getelementptr inbounds %struct.rc_generic, ptr %242, i64 0, i32 4
  %243 = load i32, ptr %NumberofHeaderBits, align 8, !tbaa !122
  %add = add nsw i32 %243, %call5
  store i32 %add, ptr %NumberofHeaderBits, align 8, !tbaa !122
  %244 = load ptr, ptr @img, align 8, !tbaa !5
  %BasicUnit = getelementptr inbounds %struct.ImageParameters, ptr %244, i64 0, i32 132
  %245 = load i32, ptr %BasicUnit, align 4, !tbaa !124
  %FrameSizeInMbs = getelementptr inbounds %struct.ImageParameters, ptr %244, i64 0, i32 120
  %246 = load i32, ptr %FrameSizeInMbs, align 8, !tbaa !57
  %cmp8 = icmp ult i32 %245, %246
  br i1 %cmp8, label %if.then10, label %if.end13

if.then10:                                        ; preds = %if.then7
  %NumberofBasicUnitHeaderBits = getelementptr inbounds %struct.rc_generic, ptr %242, i64 0, i32 6
  %247 = load i32, ptr %NumberofBasicUnitHeaderBits, align 8, !tbaa !125
  %add11 = add nsw i32 %247, %call5
...
if.end13:                                         ; preds = %land.end.if.end13_crit_edge, %if.then7, %if.then10
  %248 = phi ptr [ %.pre355, %land.end.if.end13_crit_edge ], [ %244, %if.then7 ], [ %244, %if.then10 ]
  %249 = load ptr, ptr @stats, align 8, !tbaa !5
  %bit_slice = getelementptr inbounds %struct.StatParameters, ptr %249, i64 0, i32 6
  %250 = load i32, ptr %bit_slice, align 8, !tbaa !126
  %add14 = add nsw i32 %250, %call5
  store i32 %add14, ptr %bit_slice, align 8, !tbaa !126
  %conv15 = sext i32 %call5 to i64
  %type16 = getelementptr inbounds %struct.ImageParameters, ptr %248, i64 0, i32 5
  %251 = load i32, ptr %type16, align 4, !tbaa !77
  %idxprom = sext i32 %251 to i64
  %arrayidx17 = getelementptr inbounds %struct.StatParameters, ptr %249, i64 0, i32 26, i64 %idxprom
  %252 = load i64, ptr %arrayidx17, align 8, !tbaa !109
  %add18 = add nsw i64 %252, %conv15
  store i64 %add18, ptr %arrayidx17, align 8, !tbaa !109
  %253 = load i32, ptr %end_of_slice, align 4, !tbaa !51
  %cmp19347 = icmp eq i32 %253, 0
...
while.body:                                       ; preds = %if.end13, %if.end301
  ...
  %AdaptiveRounding = getelementptr inbounds %struct.ImageParameters, ptr %254, i64 0, i32 98
  %255 = load i32, ptr %AdaptiveRounding, align 4, !tbaa !127
  %tobool21.not = icmp eq i32 %255, 0
...
land.lhs.true22:                                  ; preds = %while.body
  ...
  %AdaptRndPeriod = getelementptr inbounds %struct.InputParameters, ptr %256, i64 0, i32 186
  %257 = load i32, ptr %AdaptRndPeriod, align 8, !tbaa !128
  %tobool23.not = icmp eq i32 %257, 0
  br i1 %tobool23.not, label %if.end32, label %land.lhs.true24

land.lhs.true24:                                  ; preds = %land.lhs.true22
  %current_mb_nr = getelementptr inbounds %struct.ImageParameters, ptr %254, i64 0, i32 3
  %258 = load i32, ptr %current_mb_nr, align 4, !tbaa !53
  %rem = srem i32 %258, %257
...
if.then28:                                        ; preds = %land.lhs.true24
  ...
  %Transform8x8Mode = getelementptr inbounds %struct.InputParameters, ptr %259, i64 0, i32 153
  %260 = load i32, ptr %Transform8x8Mode, align 4, !tbaa !129
  %tobool29.not = icmp eq i32 %260, 0
...
if.end32:                                         ; preds = %if.then28, %if.then30, %land.lhs.true24, %land.lhs.true22, %while.body
  ...
  %MbaffFrameFlag = getelementptr inbounds %struct.ImageParameters, ptr %261, i64 0, i32 100
  %262 = load i32, ptr %MbaffFrameFlag, align 4, !tbaa !130
  %tobool33.not = icmp eq i32 %262, 0
...
if.then34:                                        ; preds = %if.end32
  ...
  %263 = load ptr, ptr @encode_one_macroblock, align 8, !tbaa !5
  call void %263() #12
  ...
  %264 = load i32, ptr %recode_macroblock, align 4, !tbaa !51
  %cmp35 = icmp eq i32 %264, 0
...
if.else:                                          ; preds = %if.then34
  ...
  %current_mb_nr43 = getelementptr inbounds %struct.ImageParameters, ptr %265, i64 0, i32 3
  %266 = load i32, ptr %current_mb_nr43, align 4, !tbaa !53
  %call44 = call i32 @FmoGetPreviousMBNr(i32 noundef %266) #12
  %267 = load ptr, ptr @img, align 8, !tbaa !5
  %current_mb_nr45 = getelementptr inbounds %struct.ImageParameters, ptr %267, i64 0, i32 3
...
if.else53:                                        ; preds = %if.end32
  %write_macroblock = getelementptr inbounds %struct.ImageParameters, ptr %261, i64 0, i32 133
  store i32 0, ptr %write_macroblock, align 8, !tbaa !131
  %268 = load ptr, ptr @input, align 8, !tbaa !5
  %MbInterlace = getelementptr inbounds %struct.InputParameters, ptr %268, i64 0, i32 122
  %269 = load i32, ptr %MbInterlace, align 4, !tbaa !132
  %270 = and i32 %269, -2
  %switch = icmp eq i32 %270, 2
  br i1 %switch, label %if.then59, label %if.end117

if.then59:                                        ; preds = %if.else53
  store i32 0, ptr %recode_macroblock, align 4, !tbaa !51
  %field_mode = getelementptr inbounds %struct.ImageParameters, ptr %261, i64 0, i32 90
  store i32 0, ptr %field_mode, align 8, !tbaa !133
  %top_field = getelementptr inbounds %struct.ImageParameters, ptr %261, i64 0, i32 91
  store i32 0, ptr %top_field, align 4, !tbaa !134
  %bot_MB = getelementptr inbounds %struct.ImageParameters, ptr %261, i64 0, i32 134
  store i32 0, ptr %bot_MB, align 4, !tbaa !135
  %RCEnable61 = getelementptr inbounds %struct.InputParameters, ptr %268, i64 0, i32 157
  %271 = load i32, ptr %RCEnable61, align 4, !tbaa !121
  %tobool62.not = icmp ne i32 %271, 0
  %cmp65 = icmp eq i32 %269, 2
  %or.cond343 = select i1 %tobool62.not, i1 %cmp65, i1 false
  br i1 %or.cond343, label %land.lhs.true67, label %if.end77

land.lhs.true67:                                  ; preds = %if.then59
  %NumberofCodedMacroBlocks = getelementptr inbounds %struct.ImageParameters, ptr %261, i64 0, i32 128
  %272 = load i32, ptr %NumberofCodedMacroBlocks, align 4, !tbaa !136
  %cmp68 = icmp sgt i32 %272, 0
  br i1 %cmp68, label %land.lhs.true70, label %land.lhs.true80

land.lhs.true70:                                  ; preds = %land.lhs.true67
  %BasicUnit72 = getelementptr inbounds %struct.ImageParameters, ptr %261, i64 0, i32 132
  %273 = load i32, ptr %BasicUnit72, align 4, !tbaa !124
  %rem73 = urem i32 %272, %273
  %cmp74 = icmp eq i32 %rem73, 0
  br i1 %cmp74, label %if.then76, label %land.lhs.true80

if.then76:                                        ; preds = %land.lhs.true70
  %274 = load ptr, ptr @quadratic_RC_init, align 8, !tbaa !5
  %275 = load ptr, ptr @quadratic_RC, align 8, !tbaa !5
  call void @copy_rc_jvt(ptr noundef %274, ptr noundef %275) #12
...
if.end77:                                         ; preds = %if.then76, %if.then59
  %276 = phi i32 [ %.pre357, %if.then76 ], [ %271, %if.then59 ]
  %277 = phi ptr [ %.pre356, %if.then76 ], [ %268, %if.then59 ]
  %tobool79.not = icmp eq i32 %276, 0
  br i1 %tobool79.not, label %if.end85, label %land.lhs.true80

land.lhs.true80:                                  ; preds = %land.lhs.true67, %land.lhs.true70, %if.end77
  %278 = phi ptr [ %277, %if.end77 ], [ %268, %land.lhs.true70 ], [ %268, %land.lhs.true67 ]
  %MbInterlace81 = getelementptr inbounds %struct.InputParameters, ptr %278, i64 0, i32 122
  %279 = load i32, ptr %MbInterlace81, align 4, !tbaa !132
  %cmp82 = icmp eq i32 %279, 2
  br i1 %cmp82, label %if.then84, label %if.end85

if.then84:                                        ; preds = %land.lhs.true80
  %280 = load ptr, ptr @generic_RC_init, align 8, !tbaa !5
  %281 = load ptr, ptr @generic_RC, align 8, !tbaa !5
  call void @copy_rc_generic(ptr noundef %280, ptr noundef %281) #12
  br label %if.end85

if.end85:                                         ; preds = %if.then84, %land.lhs.true80, %if.end77
  call void @start_macroblock(i32 noundef %CurrentMbAddr.0349, i32 noundef 0) #12
  store ptr @rddata_top_frame_mb, ptr @rdopt, align 8, !tbaa !5
  %282 = load ptr, ptr @encode_one_macroblock, align 8, !tbaa !5
  call void %282() #12
  %283 = load ptr, ptr @rdopt, align 8, !tbaa !5
  %284 = load double, ptr %283, align 8, !tbaa !137
  %285 = load ptr, ptr @img, align 8, !tbaa !5
  %bot_MB86 = getelementptr inbounds %struct.ImageParameters, ptr %285, i64 0, i32 134
  store i32 1, ptr %bot_MB86, align 4, !tbaa !135
  %field_mode87 = getelementptr inbounds %struct.ImageParameters, ptr %285, i64 0, i32 90
  ...
  %286 = load ptr, ptr @encode_one_macroblock, align 8, !tbaa !5
  call void %286() #12
  %287 = load ptr, ptr @input, align 8, !tbaa !5
  %RCEnable89 = getelementptr inbounds %struct.InputParameters, ptr %287, i64 0, i32 157
  %288 = load i32, ptr %RCEnable89, align 4, !tbaa !121
  %tobool90.not = icmp eq i32 %288, 0
  br i1 %tobool90.not, label %if.end114, label %land.lhs.true91

land.lhs.true91:                                  ; preds = %if.end85
  %MbInterlace92 = getelementptr inbounds %struct.InputParameters, ptr %287, i64 0, i32 122
  %289 = load i32, ptr %MbInterlace92, align 4, !tbaa !132
  %cmp93 = icmp eq i32 %289, 2
  br i1 %cmp93, label %land.lhs.true95, label %land.lhs.true109

land.lhs.true95:                                  ; preds = %land.lhs.true91
  %290 = load ptr, ptr @img, align 8, !tbaa !5
  %NumberofCodedMacroBlocks96 = getelementptr inbounds %struct.ImageParameters, ptr %290, i64 0, i32 128
  %291 = load i32, ptr %NumberofCodedMacroBlocks96, align 4, !tbaa !136
  %cmp97 = icmp sgt i32 %291, 0
  br i1 %cmp97, label %land.lhs.true99, label %land.lhs.true109

land.lhs.true99:                                  ; preds = %land.lhs.true95
  %BasicUnit101 = getelementptr inbounds %struct.ImageParameters, ptr %290, i64 0, i32 132
  %292 = load i32, ptr %BasicUnit101, align 4, !tbaa !124
  %rem102 = urem i32 %291, %292
  %cmp103 = icmp eq i32 %rem102, 0
  br i1 %cmp103, label %if.end106, label %land.lhs.true109

if.end106:                                        ; preds = %land.lhs.true99
  %293 = load ptr, ptr @quadratic_RC_best, align 8, !tbaa !5
  %294 = load ptr, ptr @quadratic_RC, align 8, !tbaa !5
  call void @copy_rc_jvt(ptr noundef %293, ptr noundef %294) #12
...
land.lhs.true109:                                 ; preds = %land.lhs.true91, %land.lhs.true95, %land.lhs.true99, %if.end106
  %295 = phi ptr [ %.pre358, %if.end106 ], [ %287, %land.lhs.true99 ], [ %287, %land.lhs.true95 ], [ %287, %land.lhs.true91 ]
  %MbInterlace110 = getelementptr inbounds %struct.InputParameters, ptr %295, i64 0, i32 122
  %296 = load i32, ptr %MbInterlace110, align 4, !tbaa !132
  %cmp111 = icmp eq i32 %296, 2
  br i1 %cmp111, label %if.then113, label %if.end114

if.then113:                                       ; preds = %land.lhs.true109
  %297 = load ptr, ptr @generic_RC_best, align 8, !tbaa !5
  %298 = load ptr, ptr @generic_RC, align 8, !tbaa !5
  call void @copy_rc_generic(ptr noundef %297, ptr noundef %298) #12
  %.pre360.pre = load ptr, ptr @input, align 8, !tbaa !5
  br label %if.end114

if.end114:                                        ; preds = %if.end85, %if.then113, %land.lhs.true109, %if.end106
  %.pre360 = phi ptr [ %.pre360.pre, %if.then113 ], [ %295, %land.lhs.true109 ], [ %.pre358, %if.end106 ], [ %287, %if.end85 ]
  %299 = load ptr, ptr @rdopt, align 8, !tbaa !5
  %300 = load double, ptr %299, align 8, !tbaa !137
  %add116 = fadd double %284, %300
...
if.end117:                                        ; preds = %if.else53, %if.end114
  %301 = phi i32 [ %.pre361, %if.end114 ], [ %269, %if.else53 ]
  %302 = phi ptr [ %.pre360, %if.end114 ], [ %268, %if.else53 ]
  %FrameRDCost.1 = phi double [ %add116, %if.end114 ], [ %FrameRDCost.0350, %if.else53 ]
  %.off337 = add i32 %301, -1
  %switch338 = icmp ult i32 %.off337, 2
  %303 = load ptr, ptr @img, align 8, !tbaa !5
  br i1 %switch338, label %if.then125, label %if.end165.thread

if.end165.thread:                                 ; preds = %if.end117
  %write_mbaff_frame377 = getelementptr inbounds %struct.ImageParameters, ptr %303, i64 0, i32 135
  store i32 0, ptr %write_mbaff_frame377, align 8, !tbaa !139
  br label %lor.lhs.false172

if.then125:                                       ; preds = %if.end117
  %bot_MB126 = getelementptr inbounds %struct.ImageParameters, ptr %303, i64 0, i32 134
  store i32 0, ptr %bot_MB126, align 4, !tbaa !135
  %field_mode127 = getelementptr inbounds %struct.ImageParameters, ptr %303, i64 0, i32 90
  store i32 1, ptr %field_mode127, align 8, !tbaa !133
  %top_field128 = getelementptr inbounds %struct.ImageParameters, ptr %303, i64 0, i32 91
  store i32 1, ptr %top_field128, align 4, !tbaa !134
  %buf_cycle = getelementptr inbounds %struct.ImageParameters, ptr %303, i64 0, i32 93
  %304 = load i32, ptr %buf_cycle, align 8, !tbaa !140
  %shl = shl i32 %304, 1
  store i32 %shl, ptr %buf_cycle, align 8, !tbaa !140
  %num_ref_frames = getelementptr inbounds %struct.InputParameters, ptr %302, i64 0, i32 8
  %305 = load i32, ptr %num_ref_frames, align 8, !tbaa !141
  %shl129 = shl i32 %305, 1
  store i32 %shl129, ptr %num_ref_frames, align 8, !tbaa !141
  %num_ref_idx_l0_active = getelementptr inbounds %struct.ImageParameters, ptr %303, i64 0, i32 88
  %306 = load i32, ptr %num_ref_idx_l0_active, align 8, !tbaa !71
  %shl130 = shl i32 %306, 1
  %add132 = or i32 %shl130, 1
  store i32 %add132, ptr %num_ref_idx_l0_active, align 8, !tbaa !71
  %RCEnable133 = getelementptr inbounds %struct.InputParameters, ptr %302, i64 0, i32 157
  %307 = load i32, ptr %RCEnable133, align 4, !tbaa !121
  %tobool134.not = icmp ne i32 %307, 0
  %cmp137 = icmp eq i32 %301, 2
  %or.cond344 = select i1 %tobool134.not, i1 %cmp137, i1 false
  br i1 %or.cond344, label %land.lhs.true139, label %if.end150

land.lhs.true139:                                 ; preds = %if.then125
  %NumberofCodedMacroBlocks140 = getelementptr inbounds %struct.ImageParameters, ptr %303, i64 0, i32 128
  %308 = load i32, ptr %NumberofCodedMacroBlocks140, align 4, !tbaa !136
  %cmp141 = icmp sgt i32 %308, 0
  br i1 %cmp141, label %land.lhs.true143, label %land.lhs.true153

land.lhs.true143:                                 ; preds = %land.lhs.true139
  %BasicUnit145 = getelementptr inbounds %struct.ImageParameters, ptr %303, i64 0, i32 132
  %309 = load i32, ptr %BasicUnit145, align 4, !tbaa !124
  %rem146 = urem i32 %308, %309
  %cmp147 = icmp eq i32 %rem146, 0
  br i1 %cmp147, label %if.then149, label %land.lhs.true153

if.then149:                                       ; preds = %land.lhs.true143
  %310 = load ptr, ptr @quadratic_RC, align 8, !tbaa !5
  %311 = load ptr, ptr @quadratic_RC_init, align 8, !tbaa !5
  call void @copy_rc_jvt(ptr noundef %310, ptr noundef %311) #12
...
if.end150:                                        ; preds = %if.then149, %if.then125
  %312 = phi i32 [ %.pre363, %if.then149 ], [ %307, %if.then125 ]
  %313 = phi ptr [ %.pre362, %if.then149 ], [ %302, %if.then125 ]
  %tobool152.not = icmp eq i32 %312, 0
...
land.lhs.true153:                                 ; preds = %land.lhs.true139, %land.lhs.true143, %if.end150
  %314 = phi ptr [ %313, %if.end150 ], [ %302, %land.lhs.true143 ], [ %302, %land.lhs.true139 ]
  %MbInterlace154 = getelementptr inbounds %struct.InputParameters, ptr %314, i64 0, i32 122
  %315 = load i32, ptr %MbInterlace154, align 4, !tbaa !132
  %cmp155 = icmp eq i32 %315, 2
  br i1 %cmp155, label %if.then157, label %if.end165

if.then157:                                       ; preds = %land.lhs.true153
  %316 = load ptr, ptr @generic_RC, align 8, !tbaa !5
  %317 = load ptr, ptr @generic_RC_init, align 8, !tbaa !5
  call void @copy_rc_generic(ptr noundef %316, ptr noundef %317) #12
  br label %if.end165
...
if.end165:                                        ; preds = %if.end150, %land.lhs.true153, %if.then157
  ...
  %318 = load ptr, ptr @encode_one_macroblock, align 8, !tbaa !5
  call void %318() #12
  %319 = load ptr, ptr @rdopt, align 8, !tbaa !5
  %320 = load double, ptr %319, align 8, !tbaa !137
  %321 = load ptr, ptr @img, align 8, !tbaa !5
  %bot_MB160 = getelementptr inbounds %struct.ImageParameters, ptr %321, i64 0, i32 134
  store i32 1, ptr %bot_MB160, align 4, !tbaa !135
  %top_field161 = getelementptr inbounds %struct.ImageParameters, ptr %321, i64 0, i32 91
  ...
  %322 = load ptr, ptr @encode_one_macroblock, align 8, !tbaa !5
  call void %322() #12
  %323 = load ptr, ptr @rdopt, align 8, !tbaa !5
  %324 = load double, ptr %323, align 8, !tbaa !137
  %add164 = fadd double %320, %324
  ...
  %write_mbaff_frame = getelementptr inbounds %struct.ImageParameters, ptr %325, i64 0, i32 135
...
lor.lhs.false172:                                 ; preds = %if.end165.thread, %if.end165
  ...
  %326 = phi ptr [ %303, %if.end165.thread ], [ %325, %if.end165 ]
  %327 = phi ptr [ %302, %if.end165.thread ], [ %.pre364, %if.end165 ]
  %328 = phi i32 [ %301, %if.end165.thread ], [ %.pre365, %if.end165 ]
  %cmp174 = icmp eq i32 %328, 3
  %field_mode177339 = getelementptr inbounds %struct.ImageParameters, ptr %326, i64 0, i32 90
...
if.then181:                                       ; preds = %if.end165
  %field_mode177 = getelementptr inbounds %struct.ImageParameters, ptr %325, i64 0, i32 90
  store i32 0, ptr %field_mode177, align 8, !tbaa !133
  store i32 0, ptr @MBPairIsField, align 4, !tbaa !43
  %buf_cycle182 = getelementptr inbounds %struct.ImageParameters, ptr %325, i64 0, i32 93
  %329 = load i32, ptr %buf_cycle182, align 8, !tbaa !140
  %shr = ashr i32 %329, 1
  ...
  %330 = load i32, ptr %num_ref_frames183, align 8, !tbaa !141
  %shr184 = ashr i32 %330, 1
  store i32 %shr184, ptr %num_ref_frames183, align 8, !tbaa !141
  %num_ref_idx_l0_active185 = getelementptr inbounds %struct.ImageParameters, ptr %325, i64 0, i32 88
  %331 = load i32, ptr %num_ref_idx_l0_active185, align 8, !tbaa !71
  %sub = add nsw i32 %331, -1
...
if.end188:                                        ; preds = %if.then176.thread, %if.then181
  ...
  %332 = phi ptr [ %326, %if.then176.thread ], [ %325, %if.then181 ]
  %333 = phi ptr [ %327, %if.then176.thread ], [ %.pre364, %if.then181 ]
  %RCEnable189 = getelementptr inbounds %struct.InputParameters, ptr %333, i64 0, i32 157
...
land.lhs.true195:                                 ; preds = %land.lhs.true191
  %NumberofCodedMacroBlocks196 = getelementptr inbounds %struct.ImageParameters, ptr %332, i64 0, i32 128
...
land.lhs.true199:                                 ; preds = %land.lhs.true195
  %BasicUnit201 = getelementptr inbounds %struct.ImageParameters, ptr %332, i64 0, i32 132
...
land.lhs.true209:                                 ; preds = %land.lhs.true191, %land.lhs.true195, %land.lhs.true199, %if.end206
  %339 = phi ptr [ %.pre366, %if.end206 ], [ %333, %land.lhs.true199 ], [ %333, %land.lhs.true195 ], [ %333, %land.lhs.true191 ]
...
if.end218.thread:                                 ; preds = %lor.lhs.false172
  ...
  %write_macroblock219341 = getelementptr inbounds %struct.ImageParameters, ptr %326, i64 0, i32 133
...
if.end225:                                        ; preds = %if.end218, %if.end218.thread
  %.sink399 = phi ptr [ %326, %if.end218.thread ], [ %343, %if.end218 ]
...
if.then280:                                       ; preds = %if.end278
  ...
  %361 = load i32, ptr %buf_cycle281, align 8, !tbaa !140
  ...
  %363 = load i32, ptr %num_ref_frames283, align 8, !tbaa !141
...
while.end:                                        ; preds = %while.end.loopexit, %if.end13
  %366 = phi ptr [ %248, %if.end13 ], [ %.pre369, %while.end.loopexit ]
