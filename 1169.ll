; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mafft/Lalignmm.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mafft/Lalignmm.c"
...
vector.memcheck:                                  ; preds = %for.body57.lr.ph
  ...
  %uglygep354 = getelementptr i8, ptr %call20, i64 %15
  %bound0 = icmp ult ptr %call16, %uglygep354
...
vector.memcheck356:                               ; preds = %for.body82.lr.ph
  ...
  %uglygep357 = getelementptr i8, ptr %call18, i64 %29
  %uglygep358 = getelementptr i8, ptr %call22, i64 %29
  %bound0359 = icmp ult ptr %call18, %uglygep358
  %bound1360 = icmp ult ptr %call22, %uglygep357
...
for.body.lr.ph.i:                                 ; preds = %for.cond.preheader.i
  ...
  %wide.trip.count215.i = zext i32 %icyc to i64
  br label %for.body.i
...
for.body32.lr.ph.i:                               ; preds = %for.cond29.preheader.i
  %cmp37.not87.i = icmp slt i32 %conv5, 1
  %wide.trip.count222.i = zext i32 %jcyc to i64
  br label %for.body32.i

for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  %indvars.iv211.i = phi i64 [ 0, %for.body.lr.ph.i ], [ %indvars.iv.next212.i, %for.body.i ]
  %arrayidx18.i = getelementptr inbounds ptr, ptr %call11, i64 %indvars.iv211.i
  %48 = load ptr, ptr %arrayidx18.i, align 8, !tbaa !9
  %arrayidx20.i = getelementptr inbounds ptr, ptr %seq1, i64 %indvars.iv211.i
  ...
  %exitcond216.not.i = icmp eq i64 %indvars.iv.next212.i, %wide.trip.count215.i
  br i1 %exitcond216.not.i, label %for.cond29.preheader.i, label %for.body.i, !llvm.loop !33

for.body32.i:                                     ; preds = %for.inc46.i, %for.body32.lr.ph.i
  %indvars.iv218.i = phi i64 [ 0, %for.body32.lr.ph.i ], [ %indvars.iv.next219.i, %for.inc46.i ]
  %arrayidx34.i = getelementptr inbounds ptr, ptr %call13, i64 %indvars.iv218.i
  %51 = load ptr, ptr %arrayidx34.i, align 8, !tbaa !9
  store i8 0, ptr %51, align 1, !tbaa !32
  br i1 %cmp37.not87.i, label %for.inc46.i, label %for.body39.i

for.body39.i:                                     ; preds = %for.body32.i, %for.body39.i
  %j.088.i = phi i32 [ %inc44.i, %for.body39.i ], [ 0, %for.body32.i ]
  ...
  %exitcond217.not.i = icmp eq i32 %j.088.i, %sub110
  br i1 %exitcond217.not.i, label %for.inc46.i, label %for.body39.i, !llvm.loop !34

for.inc46.i:                                      ; preds = %for.body39.i, %for.body32.i
  %indvars.iv.next219.i = add nuw nsw i64 %indvars.iv218.i, 1
  %exitcond223.not.i = icmp eq i64 %indvars.iv.next219.i, %wide.trip.count222.i
  br i1 %exitcond223.not.i, label %MSalignmm_rec.exit, label %for.body32.i, !llvm.loop !35
...
for.body65.preheader.i:                           ; preds = %for.cond62.preheader.i
  %wide.trip.count98.i = zext i32 %jcyc to i64
...
vector.ph400:                                     ; preds = %for.body65.preheader.i
  %n.vec402 = and i64 %wide.trip.count98.i, 4294967292
...
middle.block397:                                  ; preds = %vector.body405
  %cmp.n404 = icmp eq i64 %n.vec402, %wide.trip.count98.i
...
for.body65.i.preheader:                           ; preds = %for.body65.preheader.i, %middle.block397
  %indvars.iv95.i.ph = phi i64 [ 0, %for.body65.preheader.i ], [ %n.vec402, %middle.block397 ]
  %69 = xor i64 %indvars.iv95.i.ph, -1
  %70 = add nsw i64 %69, %wide.trip.count98.i
  %xtraiter677 = and i64 %wide.trip.count98.i, 3
...
for.body65.i.prol:                                ; preds = %for.body65.i.preheader, %for.body65.i.prol
  %indvars.iv95.i.prol = phi i64 [ %indvars.iv.next96.i.prol, %for.body65.i.prol ], [ %indvars.iv95.i.ph, %for.body65.i.preheader ]
  %prol.iter679 = phi i64 [ %prol.iter679.next, %for.body65.i.prol ], [ 0, %for.body65.i.preheader ]
  %arrayidx67.i.prol = getelementptr inbounds ptr, ptr %call13, i64 %indvars.iv95.i.prol
  %71 = load ptr, ptr %arrayidx67.i.prol, align 8, !tbaa !9
  %arrayidx69.i.prol = getelementptr inbounds ptr, ptr %call50.i, i64 %indvars.iv95.i.prol
  store ptr %71, ptr %arrayidx69.i.prol, align 8, !tbaa !9
  %indvars.iv.next96.i.prol = add nuw nsw i64 %indvars.iv95.i.prol, 1
...
for.body65.i.prol.loopexit:                       ; preds = %for.body65.i.prol, %for.body65.i.preheader
  %indvars.iv95.i.unr = phi i64 [ %indvars.iv95.i.ph, %for.body65.i.preheader ], [ %indvars.iv.next96.i.prol, %for.body65.i.prol ]
...
for.body65.i:                                     ; preds = %for.body65.i.prol.loopexit, %for.body65.i
  %indvars.iv95.i = phi i64 [ %indvars.iv.next96.i.3, %for.body65.i ], [ %indvars.iv95.i.unr, %for.body65.i.prol.loopexit ]
  %arrayidx67.i = getelementptr inbounds ptr, ptr %call13, i64 %indvars.iv95.i
  %77 = load ptr, ptr %arrayidx67.i, align 8, !tbaa !9
  %arrayidx69.i = getelementptr inbounds ptr, ptr %call50.i, i64 %indvars.iv95.i
  store ptr %77, ptr %arrayidx69.i, align 8, !tbaa !9
  %indvars.iv.next96.i = add nuw nsw i64 %indvars.iv95.i, 1
  %arrayidx67.i.1 = getelementptr inbounds ptr, ptr %call13, i64 %indvars.iv.next96.i
  %78 = load ptr, ptr %arrayidx67.i.1, align 8, !tbaa !9
  %arrayidx69.i.1 = getelementptr inbounds ptr, ptr %call50.i, i64 %indvars.iv.next96.i
  store ptr %78, ptr %arrayidx69.i.1, align 8, !tbaa !9
  %indvars.iv.next96.i.1 = add nuw nsw i64 %indvars.iv95.i, 2
  %arrayidx67.i.2 = getelementptr inbounds ptr, ptr %call13, i64 %indvars.iv.next96.i.1
  %79 = load ptr, ptr %arrayidx67.i.2, align 8, !tbaa !9
  %arrayidx69.i.2 = getelementptr inbounds ptr, ptr %call50.i, i64 %indvars.iv.next96.i.1
  store ptr %79, ptr %arrayidx69.i.2, align 8, !tbaa !9
  %indvars.iv.next96.i.2 = add nuw nsw i64 %indvars.iv95.i, 3
  %arrayidx67.i.3 = getelementptr inbounds ptr, ptr %call13, i64 %indvars.iv.next96.i.2
  %80 = load ptr, ptr %arrayidx67.i.3, align 8, !tbaa !9
  %arrayidx69.i.3 = getelementptr inbounds ptr, ptr %call50.i, i64 %indvars.iv.next96.i.2
  store ptr %80, ptr %arrayidx69.i.3, align 8, !tbaa !9
  %indvars.iv.next96.i.3 = add nuw nsw i64 %indvars.iv95.i, 4
  %exitcond99.not.i.3 = icmp eq i64 %indvars.iv.next96.i.3, %wide.trip.count98.i
  br i1 %exitcond99.not.i.3, label %for.end72.i, label %for.body65.i, !llvm.loop !42
...
for.body145.preheader.i:                          ; preds = %for.end72.i
  ...
  %wide.trip.count104.i = zext i32 %smax.i to i64
  %81 = add nsw i64 %wide.trip.count104.i, -1
  %min.iters.check423 = icmp ult i64 %81, 12
...
vector.memcheck410:                               ; preds = %for.body145.preheader.i
  %uglygep411 = getelementptr i8, ptr %call104.i, i64 4
  %82 = shl nuw nsw i64 %wide.trip.count104.i, 2
  %uglygep412 = getelementptr i8, ptr %call104.i, i64 %82
  %83 = add nsw i64 %82, -4
  %uglygep414 = getelementptr i8, ptr %call20, i64 %83
  %bound0415 = icmp ult ptr %call104.i, %call16
  %bound1416 = icmp ult ptr %call16, %uglygep412
  %found.conflict417 = and i1 %bound0415, %bound1416
  %bound0418 = icmp ult ptr %uglygep411, %uglygep414
  %bound1419 = icmp ult ptr %call20, %uglygep412
...
for.body145.i.preheader:                          ; preds = %vector.memcheck410, %for.body145.preheader.i, %middle.block421
  %indvars.iv100.i.ph = phi i64 [ 1, %vector.memcheck410 ], [ 1, %for.body145.preheader.i ], [ %ind.end, %middle.block421 ]
  %94 = xor i64 %indvars.iv100.i.ph, -1
  %95 = and i64 %wide.trip.count104.i, 1
...
for.body145.i.prol:                               ; preds = %for.body145.i.preheader
  ...
  %97 = add nsw i64 %indvars.iv100.i.ph, -1
  ...
  %arrayidx152.i.prol = getelementptr inbounds float, ptr %call104.i, i64 %indvars.iv100.i.ph
  ...
  %indvars.iv.next101.i.prol = add nuw nsw i64 %indvars.iv100.i.ph, 1
  br label %for.body145.i.prol.loopexit

for.body145.i.prol.loopexit:                      ; preds = %for.body145.i.prol, %for.body145.i.preheader
  %indvars.iv100.i.unr = phi i64 [ %indvars.iv100.i.ph, %for.body145.i.preheader ], [ %indvars.iv.next101.i.prol, %for.body145.i.prol ]
  %100 = sub nsw i64 0, %wide.trip.count104.i
...
for.cond157.preheader.i:                          ; preds = %for.body145.i.prol.loopexit, %for.body145.i, %middle.block421
  ...
  %smax110.i = tail call i32 @llvm.smax.i32(i32 %add158.i, i32 2)
  %wide.trip.count111.i = zext i32 %smax110.i to i64
  %102 = add nsw i64 %wide.trip.count111.i, -1
  %min.iters.check454 = icmp ult i64 %102, 12
...
vector.memcheck440:                               ; preds = %for.cond157.preheader.i
  %uglygep441 = getelementptr i8, ptr %call82.i, i64 4
  %103 = shl nuw nsw i64 %wide.trip.count111.i, 2
  %uglygep442 = getelementptr i8, ptr %call82.i, i64 %103
  %104 = add nsw i64 %103, -4
  %uglygep444 = getelementptr i8, ptr %call22, i64 %104
  %bound0445 = icmp ult ptr %call82.i, %call18
  %bound1446 = icmp ult ptr %call18, %uglygep442
  %found.conflict447 = and i1 %bound0445, %bound1446
  %bound0448 = icmp ult ptr %uglygep441, %uglygep444
  %bound1449 = icmp ult ptr %call22, %uglygep442
...
for.body161.i.preheader:                          ; preds = %vector.memcheck440, %for.cond157.preheader.i, %middle.block452
  %indvars.iv106.i.ph = phi i64 [ 1, %vector.memcheck440 ], [ 1, %for.cond157.preheader.i ], [ %ind.end458, %middle.block452 ]
  %115 = xor i64 %indvars.iv106.i.ph, -1
  %116 = and i64 %wide.trip.count111.i, 1
...
for.body161.i.prol:                               ; preds = %for.body161.i.preheader
  ...
  %118 = add nsw i64 %indvars.iv106.i.ph, -1
  ...
  %arrayidx168.i.prol = getelementptr inbounds float, ptr %call82.i, i64 %indvars.iv106.i.ph
  ...
  %indvars.iv.next107.i.prol = add nuw nsw i64 %indvars.iv106.i.ph, 1
  br label %for.body161.i.prol.loopexit

for.body161.i.prol.loopexit:                      ; preds = %for.body161.i.prol, %for.body161.i.preheader
  %indvars.iv106.i.unr = phi i64 [ %indvars.iv106.i.ph, %for.body161.i.preheader ], [ %indvars.iv.next107.i.prol, %for.body161.i.prol ]
  %121 = sub nsw i64 0, %wide.trip.count111.i
...
for.body145.i:                                    ; preds = %for.body145.i.prol.loopexit, %for.body145.i
  %indvars.iv100.i = phi i64 [ %indvars.iv.next101.i.1, %for.body145.i ], [ %indvars.iv100.i.unr, %for.body145.i.prol.loopexit ]
  %123 = load float, ptr %call16, align 4, !tbaa !14
  %124 = add nsw i64 %indvars.iv100.i, -1
  ...
  %arrayidx152.i = getelementptr inbounds float, ptr %call104.i, i64 %indvars.iv100.i
  ...
  %arrayidx149.i.1 = getelementptr inbounds float, ptr %call20, i64 %indvars.iv100.i
  %128 = load float, ptr %arrayidx149.i.1, align 4, !tbaa !14
  %add150.i.1 = fadd float %127, %128
  %arrayidx152.i.1 = getelementptr inbounds float, ptr %call104.i, i64 %indvars.iv.next101.i
  ...
  %indvars.iv.next101.i.1 = add nuw nsw i64 %indvars.iv100.i, 2
  %exitcond105.not.i.1 = icmp eq i64 %indvars.iv.next101.i.1, %wide.trip.count104.i
  br i1 %exitcond105.not.i.1, label %for.cond157.preheader.i, label %for.body145.i, !llvm.loop !61

for.body161.i:                                    ; preds = %for.body161.i.prol.loopexit, %for.body161.i
  %indvars.iv106.i = phi i64 [ %indvars.iv.next107.i.1, %for.body161.i ], [ %indvars.iv106.i.unr, %for.body161.i.prol.loopexit ]
  %130 = load float, ptr %call18, align 4, !tbaa !14
  %131 = add nsw i64 %indvars.iv106.i, -1
  ...
  %arrayidx168.i = getelementptr inbounds float, ptr %call82.i, i64 %indvars.iv106.i
  ...
  %arrayidx165.i.1 = getelementptr inbounds float, ptr %call22, i64 %indvars.iv106.i
  %135 = load float, ptr %arrayidx165.i.1, align 4, !tbaa !14
  %add166.i.1 = fadd float %134, %135
  %arrayidx168.i.1 = getelementptr inbounds float, ptr %call82.i, i64 %indvars.iv.next107.i
  ...
  %exitcond112.not.i.1 = icmp eq i64 %indvars.iv.next107.i.1, %wide.trip.count111.i
  br i1 %exitcond112.not.i.1, label %for.end172.i, label %for.body161.i, !llvm.loop !62
...
for.end172.i:                                     ; preds = %for.body161.i.prol.loopexit, %for.body161.i, %middle.block452
  ...
  %140 = add nsw i64 %wide.trip.count104.i, -2
...
for.body180.i:                                    ; preds = %for.body180.i, %for.end172.i.new
  %indvars.iv113.i = phi i64 [ 1, %for.end172.i.new ], [ %indvars.iv.next114.i.3, %for.body180.i ]
  %niter = phi i64 [ 0, %for.end172.i.new ], [ %niter.next.3, %for.body180.i ]
  %arrayidx182.i = getelementptr inbounds float, ptr %call104.i, i64 %indvars.iv113.i
  %142 = load float, ptr %arrayidx182.i, align 4, !tbaa !14
  %arrayidx184.i = getelementptr inbounds ptr, ptr %call131.i, i64 %indvars.iv113.i
  %143 = load ptr, ptr %arrayidx184.i, align 8, !tbaa !9
  store float %142, ptr %143, align 4, !tbaa !14
  %indvars.iv.next114.i = add nuw nsw i64 %indvars.iv113.i, 1
  %arrayidx182.i.1 = getelementptr inbounds float, ptr %call104.i, i64 %indvars.iv.next114.i
  %144 = load float, ptr %arrayidx182.i.1, align 4, !tbaa !14
  %arrayidx184.i.1 = getelementptr inbounds ptr, ptr %call131.i, i64 %indvars.iv.next114.i
  %145 = load ptr, ptr %arrayidx184.i.1, align 8, !tbaa !9
  store float %144, ptr %145, align 4, !tbaa !14
  %indvars.iv.next114.i.1 = add nuw nsw i64 %indvars.iv113.i, 2
  %arrayidx182.i.2 = getelementptr inbounds float, ptr %call104.i, i64 %indvars.iv.next114.i.1
  %146 = load float, ptr %arrayidx182.i.2, align 4, !tbaa !14
  %arrayidx184.i.2 = getelementptr inbounds ptr, ptr %call131.i, i64 %indvars.iv.next114.i.1
  %147 = load ptr, ptr %arrayidx184.i.2, align 8, !tbaa !9
  store float %146, ptr %147, align 4, !tbaa !14
  %indvars.iv.next114.i.2 = add nuw nsw i64 %indvars.iv113.i, 3
  %arrayidx182.i.3 = getelementptr inbounds float, ptr %call104.i, i64 %indvars.iv.next114.i.2
  %148 = load float, ptr %arrayidx182.i.3, align 4, !tbaa !14
  %arrayidx184.i.3 = getelementptr inbounds ptr, ptr %call131.i, i64 %indvars.iv.next114.i.2
  %149 = load ptr, ptr %arrayidx184.i.3, align 8, !tbaa !9
  store float %148, ptr %149, align 4, !tbaa !14
  %indvars.iv.next114.i.3 = add nuw nsw i64 %indvars.iv113.i, 4
...
for.body193.i.preheader.unr-lcssa:                ; preds = %for.body180.i, %for.end172.i
  %indvars.iv113.i.unr = phi i64 [ 1, %for.end172.i ], [ %indvars.iv.next114.i.3, %for.body180.i ]
...
for.body180.i.epil:                               ; preds = %for.body193.i.preheader.unr-lcssa, %for.body180.i.epil
  %indvars.iv113.i.epil = phi i64 [ %indvars.iv.next114.i.epil, %for.body180.i.epil ], [ %indvars.iv113.i.unr, %for.body193.i.preheader.unr-lcssa ]
  %epil.iter = phi i64 [ %epil.iter.next, %for.body180.i.epil ], [ 0, %for.body193.i.preheader.unr-lcssa ]
  %arrayidx182.i.epil = getelementptr inbounds float, ptr %call104.i, i64 %indvars.iv113.i.epil
  %150 = load float, ptr %arrayidx182.i.epil, align 4, !tbaa !14
  %arrayidx184.i.epil = getelementptr inbounds ptr, ptr %call131.i, i64 %indvars.iv113.i.epil
...
for.body193.i.preheader:                          ; preds = %for.body180.i.epil, %for.body193.i.preheader.unr-lcssa
  %152 = add nsw i64 %wide.trip.count111.i, -1
  %min.iters.check478 = icmp ult i64 %152, 12
...
for.body193.i.preheader674:                       ; preds = %for.body193.i.preheader, %middle.block476
  %indvars.iv120.i.ph = phi i64 [ 1, %for.body193.i.preheader ], [ %ind.end482, %middle.block476 ]
  %159 = sub nsw i64 %wide.trip.count111.i, %indvars.iv120.i.ph
  %160 = xor i64 %indvars.iv120.i.ph, -1
  %161 = add nsw i64 %160, %wide.trip.count111.i
...
for.body193.i.prol:                               ; preds = %for.body193.i.preheader674, %for.body193.i.prol
  %indvars.iv120.i.prol = phi i64 [ %indvars.iv.next121.i.prol, %for.body193.i.prol ], [ %indvars.iv120.i.ph, %for.body193.i.preheader674 ]
  %prol.iter690 = phi i64 [ %prol.iter690.next, %for.body193.i.prol ], [ 0, %for.body193.i.preheader674 ]
  %arrayidx195.i.prol = getelementptr inbounds float, ptr %call82.i, i64 %indvars.iv120.i.prol
  %162 = load float, ptr %arrayidx195.i.prol, align 4, !tbaa !14
  %arrayidx198.i.prol = getelementptr inbounds float, ptr %138, i64 %indvars.iv120.i.prol
  store float %162, ptr %arrayidx198.i.prol, align 4, !tbaa !14
  %indvars.iv.next121.i.prol = add nuw nsw i64 %indvars.iv120.i.prol, 1
...
for.body193.i.prol.loopexit:                      ; preds = %for.body193.i.prol, %for.body193.i.preheader674
  %indvars.iv120.i.unr = phi i64 [ %indvars.iv120.i.ph, %for.body193.i.preheader674 ], [ %indvars.iv.next121.i.prol, %for.body193.i.prol ]
...
for.body206.lr.ph.i:                              ; preds = %for.body193.i.prol.loopexit, %for.body193.i, %middle.block476
  ...
  %164 = add nsw i64 %wide.trip.count111.i, -1
  %min.iters.check505 = icmp ult i64 %164, 12
...
vector.memcheck491:                               ; preds = %for.body206.lr.ph.i
  %uglygep492 = getelementptr i8, ptr %call108.i, i64 4
  %165 = shl nuw nsw i64 %wide.trip.count111.i, 2
  %uglygep493 = getelementptr i8, ptr %call108.i, i64 %165
  %166 = add nsw i64 %165, -4
  %uglygep494 = getelementptr i8, ptr %call82.i, i64 %166
  %uglygep495 = getelementptr i8, ptr %call16, i64 8
  %bound0496 = icmp ult ptr %uglygep492, %uglygep494
  %bound1497 = icmp ult ptr %call82.i, %uglygep493
  %found.conflict498 = and i1 %bound0496, %bound1497
  %bound0499 = icmp ult ptr %uglygep492, %uglygep495
  %bound1500 = icmp ult ptr %arrayidx210.i, %uglygep493
...
for.body206.i.preheader:                          ; preds = %vector.memcheck491, %for.body206.lr.ph.i, %middle.block503
  %indvars.iv126.i.ph = phi i64 [ 1, %vector.memcheck491 ], [ 1, %for.body206.lr.ph.i ], [ %ind.end509, %middle.block503 ]
  %177 = xor i64 %indvars.iv126.i.ph, -1
  %178 = and i64 %wide.trip.count111.i, 1
...
for.body206.i.prol:                               ; preds = %for.body206.i.preheader
  %179 = add nsw i64 %indvars.iv126.i.ph, -1
  ...
  %arrayidx213.i.prol = getelementptr inbounds float, ptr %call108.i, i64 %indvars.iv126.i.ph
  store float %add211.i.prol, ptr %arrayidx213.i.prol, align 4, !tbaa !14
  %arrayidx215.i.prol = getelementptr inbounds i32, ptr %call110.i, i64 %indvars.iv126.i.ph
  store i32 0, ptr %arrayidx215.i.prol, align 4, !tbaa !5
  %indvars.iv.next127.i.prol = add nuw nsw i64 %indvars.iv126.i.ph, 1
  br label %for.body206.i.prol.loopexit

for.body206.i.prol.loopexit:                      ; preds = %for.body206.i.prol, %for.body206.i.preheader
  %indvars.iv126.i.unr = phi i64 [ %indvars.iv126.i.ph, %for.body206.i.preheader ], [ %indvars.iv.next127.i.prol, %for.body206.i.prol ]
  %182 = sub nsw i64 0, %wide.trip.count111.i
...
for.body193.i:                                    ; preds = %for.body193.i.prol.loopexit, %for.body193.i
  %indvars.iv120.i = phi i64 [ %indvars.iv.next121.i.3, %for.body193.i ], [ %indvars.iv120.i.unr, %for.body193.i.prol.loopexit ]
  %arrayidx195.i = getelementptr inbounds float, ptr %call82.i, i64 %indvars.iv120.i
  %184 = load float, ptr %arrayidx195.i, align 4, !tbaa !14
  %arrayidx198.i = getelementptr inbounds float, ptr %138, i64 %indvars.iv120.i
  store float %184, ptr %arrayidx198.i, align 4, !tbaa !14
  %indvars.iv.next121.i = add nuw nsw i64 %indvars.iv120.i, 1
  %arrayidx195.i.1 = getelementptr inbounds float, ptr %call82.i, i64 %indvars.iv.next121.i
  %185 = load float, ptr %arrayidx195.i.1, align 4, !tbaa !14
  %arrayidx198.i.1 = getelementptr inbounds float, ptr %138, i64 %indvars.iv.next121.i
  store float %185, ptr %arrayidx198.i.1, align 4, !tbaa !14
  %indvars.iv.next121.i.1 = add nuw nsw i64 %indvars.iv120.i, 2
  %arrayidx195.i.2 = getelementptr inbounds float, ptr %call82.i, i64 %indvars.iv.next121.i.1
  %186 = load float, ptr %arrayidx195.i.2, align 4, !tbaa !14
  %arrayidx198.i.2 = getelementptr inbounds float, ptr %138, i64 %indvars.iv.next121.i.1
  store float %186, ptr %arrayidx198.i.2, align 4, !tbaa !14
  %indvars.iv.next121.i.2 = add nuw nsw i64 %indvars.iv120.i, 3
  %arrayidx195.i.3 = getelementptr inbounds float, ptr %call82.i, i64 %indvars.iv.next121.i.2
  %187 = load float, ptr %arrayidx195.i.3, align 4, !tbaa !14
  %arrayidx198.i.3 = getelementptr inbounds float, ptr %138, i64 %indvars.iv.next121.i.2
  store float %187, ptr %arrayidx198.i.3, align 4, !tbaa !14
  %indvars.iv.next121.i.3 = add nuw nsw i64 %indvars.iv120.i, 4
  %exitcond125.not.i.3 = icmp eq i64 %indvars.iv.next121.i.3, %wide.trip.count111.i
  br i1 %exitcond125.not.i.3, label %for.body206.lr.ph.i, label %for.body193.i, !llvm.loop !76

for.body206.i:                                    ; preds = %for.body206.i.prol.loopexit, %for.body206.i
  %indvars.iv126.i = phi i64 [ %indvars.iv.next127.i.1, %for.body206.i ], [ %indvars.iv126.i.unr, %for.body206.i.prol.loopexit ]
  %188 = add nsw i64 %indvars.iv126.i, -1
  ...
  %arrayidx213.i = getelementptr inbounds float, ptr %call108.i, i64 %indvars.iv126.i
  store float %add211.i, ptr %arrayidx213.i, align 4, !tbaa !14
  %arrayidx215.i = getelementptr inbounds i32, ptr %call110.i, i64 %indvars.iv126.i
  store i32 0, ptr %arrayidx215.i, align 4, !tbaa !5
  %indvars.iv.next127.i = add nuw nsw i64 %indvars.iv126.i, 1
  %arrayidx209.i.1 = getelementptr inbounds float, ptr %call82.i, i64 %indvars.iv126.i
  ...
  %arrayidx213.i.1 = getelementptr inbounds float, ptr %call108.i, i64 %indvars.iv.next127.i
  store float %add211.i.1, ptr %arrayidx213.i.1, align 4, !tbaa !14
  %arrayidx215.i.1 = getelementptr inbounds i32, ptr %call110.i, i64 %indvars.iv.next127.i
  store i32 0, ptr %arrayidx215.i.1, align 4, !tbaa !5
  %indvars.iv.next127.i.1 = add nuw nsw i64 %indvars.iv126.i, 2
  %exitcond132.not.i.1 = icmp eq i64 %indvars.iv.next127.i.1, %wide.trip.count111.i
  br i1 %exitcond132.not.i.1, label %for.end218.i, label %for.body206.i, !llvm.loop !77
...
for.body229.i:                                    ; preds = %for.end321.i, %for.end218.i
  %indvars.iv147.i = phi i64 [ 1, %for.end218.i ], [ %indvars.iv.next148.i, %for.end321.i ]
  ...
  %195 = add nsw i64 %indvars.iv147.i, -1
  ...
  %197 = trunc i64 %indvars.iv147.i to i32
...
for.body260.preheader.i:                          ; preds = %for.body229.i
  ...
  %add252227.i = fadd float %205, %206
  %arrayidx279228.i = getelementptr inbounds float, ptr %call20, i64 %195
  %arrayidx295229.i = getelementptr inbounds ptr, ptr %call131.i, i64 %indvars.iv147.i
  %207 = load ptr, ptr %arrayidx295229.i, align 8, !tbaa !9
  %arrayidx299230.i = getelementptr inbounds ptr, ptr %call132.i, i64 %indvars.iv147.i
  %208 = load ptr, ptr %arrayidx299230.i, align 8, !tbaa !9
  %209 = trunc i64 %195 to i32
  br label %for.body260.i

for.body260.us.i:                                 ; preds = %if.end292.us.i, %if.end249.i
  %indvars.iv140.i = phi i64 [ 1, %if.end249.i ], [ %indvars.iv.next141.i, %if.end292.us.i ]
  ...
  %previousw.029.pn236.i = phi ptr [ %previousw.029.i, %if.end249.i ], [ %curpt.025.us.i, %if.end292.us.i ]
  ...
  %curpt.025.us.i = getelementptr inbounds float, ptr %previousw.029.pn236.i, i64 1
  %210 = load float, ptr %prept.022.us.i, align 4, !tbaa !14
  %211 = add nsw i64 %indvars.iv140.i, -1
  ...
  %arrayidx270.us.i = getelementptr inbounds float, ptr %call18, i64 %indvars.iv140.i
...
if.end292.us.i:                                   ; preds = %if.then290.us.i, %for.body260.us.if.end292.us_crit_edge.i
  ...
  %arrayidx297.us.i = getelementptr inbounds float, ptr %202, i64 %indvars.iv140.i
  store float %add293.us.i, ptr %arrayidx297.us.i, align 4, !tbaa !14
  %220 = load float, ptr %mjpt.027.us.i, align 4, !tbaa !14
  %arrayidx301.us.i = getelementptr inbounds float, ptr %203, i64 %indvars.iv140.i
  store float %220, ptr %arrayidx301.us.i, align 4, !tbaa !14
  %arrayidx306.us.i = getelementptr inbounds i32, ptr %call94.i, i64 %indvars.iv140.i
  store i32 %218, ptr %arrayidx306.us.i, align 4, !tbaa !5
  %arrayidx308.us.i = getelementptr inbounds i32, ptr %call92.i, i64 %indvars.iv140.i
  store i32 %mpi.1.us.i, ptr %arrayidx308.us.i, align 4, !tbaa !5
  %221 = load float, ptr %curpt.025.us.i, align 4, !tbaa !14
  %arrayidx310.us.i = getelementptr inbounds float, ptr %call86.i, i64 %indvars.iv140.i
  store float %221, ptr %arrayidx310.us.i, align 4, !tbaa !14
  %222 = load float, ptr %mjpt.027.us.i, align 4, !tbaa !14
  %arrayidx312.us.i = getelementptr inbounds float, ptr %call90.i, i64 %indvars.iv140.i
  store float %222, ptr %arrayidx312.us.i, align 4, !tbaa !14
  %arrayidx314.us.i = getelementptr inbounds float, ptr %call88.i, i64 %indvars.iv140.i
  ...
  %exitcond146.not.i = icmp eq i64 %indvars.iv.next141.i, %wide.trip.count111.i
  br i1 %exitcond146.not.i, label %for.end321.i, label %for.body260.us.i, !llvm.loop !78

for.body260.i:                                    ; preds = %if.end292.i, %for.body260.preheader.i
  %indvars.iv133.i = phi i64 [ 1, %for.body260.preheader.i ], [ %indvars.iv.next134.i, %if.end292.i ]
  ...
  %arrayidx270.i = getelementptr inbounds float, ptr %call18, i64 %indvars.iv133.i
  ...
  %228 = load float, ptr %arrayidx279228.i, align 4, !tbaa !14
...
if.end292.i:                                      ; preds = %if.then290.i, %for.body260.i
  ...
  %arrayidx297.i = getelementptr inbounds float, ptr %207, i64 %indvars.iv133.i
  store float %add293.i, ptr %arrayidx297.i, align 4, !tbaa !14
  %231 = load float, ptr %mjpt.027.i, align 4, !tbaa !14
  %arrayidx301.i = getelementptr inbounds float, ptr %208, i64 %indvars.iv133.i
  ...
  %exitcond139.not.i = icmp eq i64 %indvars.iv.next134.i, %wide.trip.count111.i
  br i1 %exitcond139.not.i, label %for.end321.i, label %for.body260.i, !llvm.loop !78
...
for.end321.i:                                     ; preds = %if.end292.i, %if.end292.us.i
  ...
  %arrayidx326.i = getelementptr inbounds float, ptr %call106.i, i64 %indvars.iv147.i
  ...
  %exitcond153.not.i = icmp eq i64 %indvars.iv.next148.i, %wide.trip.count104.i
  br i1 %exitcond153.not.i, label %for.end336.i, label %for.body229.i, !llvm.loop !79
...
vector.memcheck522:                               ; preds = %for.end336.i
  ...
  %uglygep523 = getelementptr i8, ptr %call104.i, i64 %235
  %236 = add nuw nsw i64 %235, 4
  %uglygep524 = getelementptr i8, ptr %call20, i64 %236
  %uglygep525 = getelementptr i8, ptr %call16, i64 %236
  %bound0526 = icmp ult ptr %call104.i, %uglygep524
  %bound1527 = icmp ult ptr %arrayidx354.i, %uglygep523
  %found.conflict528 = and i1 %bound0526, %bound1527
  %bound0529 = icmp ult ptr %call104.i, %uglygep525
  %bound1530 = icmp ult ptr %arrayidx210.i, %uglygep523
...
for.body351.i.preheader:                          ; preds = %vector.memcheck522, %for.end336.i, %middle.block533
  %indvars.iv154.i.ph = phi i64 [ 0, %vector.memcheck522 ], [ 0, %for.end336.i ], [ %n.vec538, %middle.block533 ]
  %248 = xor i64 %indvars.iv154.i.ph, -1
...
for.body351.i.prol:                               ; preds = %for.body351.i.preheader
  ...
  %indvars.iv.next155.i.prol = or i64 %indvars.iv154.i.ph, 1
  %arrayidx357.i.prol = getelementptr inbounds float, ptr %call16, i64 %indvars.iv.next155.i.prol
  %250 = load float, ptr %arrayidx357.i.prol, align 4, !tbaa !14
  %add358.i.prol = fadd float %249, %250
  %arrayidx360.i.prol = getelementptr inbounds float, ptr %call104.i, i64 %indvars.iv154.i.ph
...
for.body351.i.prol.loopexit:                      ; preds = %for.body351.i.prol, %for.body351.i.preheader
  %indvars.iv154.i.unr = phi i64 [ %indvars.iv154.i.ph, %for.body351.i.preheader ], [ %indvars.iv.next155.i.prol, %for.body351.i.prol ]
...
for.cond365.preheader.i:                          ; preds = %for.body351.i.prol.loopexit, %for.body351.i, %middle.block533
  ...
  %wide.trip.count162.i = zext i32 %sub111 to i64
...
vector.memcheck552:                               ; preds = %for.cond365.preheader.i
  %254 = shl nuw nsw i64 %wide.trip.count162.i, 2
  %uglygep553 = getelementptr i8, ptr %previousw.029.i, i64 %254
  %255 = shl nsw i64 %idxprom220.i, 2
  %256 = add nsw i64 %255, 4
  %uglygep554 = getelementptr i8, ptr %call22, i64 %256
  %uglygep555 = getelementptr i8, ptr %call18, i64 4
  %257 = add nuw nsw i64 %254, 4
  %uglygep556 = getelementptr i8, ptr %call18, i64 %257
  %bound0557 = icmp ult ptr %previousw.029.i, %uglygep554
  %bound1558 = icmp ult ptr %arrayidx372.i, %uglygep553
  %found.conflict559 = and i1 %bound0557, %bound1558
  %bound0560 = icmp ult ptr %previousw.029.i, %uglygep556
  %bound1561 = icmp ult ptr %uglygep555, %uglygep553
...
vector.ph567:                                     ; preds = %vector.memcheck552
  %n.vec569 = and i64 %wide.trip.count162.i, 4294967288
...
middle.block564:                                  ; preds = %vector.body572
  %cmp.n571 = icmp eq i64 %n.vec569, %wide.trip.count162.i
...
for.body369.i.preheader:                          ; preds = %vector.memcheck552, %for.cond365.preheader.i, %middle.block564
  %indvars.iv159.i.ph = phi i64 [ 0, %vector.memcheck552 ], [ 0, %for.cond365.preheader.i ], [ %n.vec569, %middle.block564 ]
  %269 = xor i64 %indvars.iv159.i.ph, -1
  %xtraiter697 = and i64 %wide.trip.count162.i, 1
...
for.body369.i.prol:                               ; preds = %for.body369.i.preheader
  ...
  %indvars.iv.next160.i.prol = or i64 %indvars.iv159.i.ph, 1
  %arrayidx375.i.prol = getelementptr inbounds float, ptr %call18, i64 %indvars.iv.next160.i.prol
  %271 = load float, ptr %arrayidx375.i.prol, align 4, !tbaa !14
  %add376.i.prol = fadd float %270, %271
  %arrayidx378.i.prol = getelementptr inbounds float, ptr %previousw.029.i, i64 %indvars.iv159.i.ph
...
for.body369.i.prol.loopexit:                      ; preds = %for.body369.i.prol, %for.body369.i.preheader
  %indvars.iv159.i.unr = phi i64 [ %indvars.iv159.i.ph, %for.body369.i.preheader ], [ %indvars.iv.next160.i.prol, %for.body369.i.prol ]
  %273 = sub nsw i64 0, %wide.trip.count162.i
...
for.body351.i:                                    ; preds = %for.body351.i.prol.loopexit, %for.body351.i
  %indvars.iv154.i = phi i64 [ %indvars.iv.next155.i.1, %for.body351.i ], [ %indvars.iv154.i.unr, %for.body351.i.prol.loopexit ]
  %276 = load float, ptr %arrayidx354.i, align 4, !tbaa !14
  %indvars.iv.next155.i = add nuw nsw i64 %indvars.iv154.i, 1
  %arrayidx357.i = getelementptr inbounds float, ptr %call16, i64 %indvars.iv.next155.i
  %277 = load float, ptr %arrayidx357.i, align 4, !tbaa !14
  %add358.i = fadd float %276, %277
  %arrayidx360.i = getelementptr inbounds float, ptr %call104.i, i64 %indvars.iv154.i
  ...
  %arrayidx357.i.1 = getelementptr inbounds float, ptr %call16, i64 %indvars.iv.next155.i.1
  %280 = load float, ptr %arrayidx357.i.1, align 4, !tbaa !14
  %add358.i.1 = fadd float %279, %280
  %arrayidx360.i.1 = getelementptr inbounds float, ptr %call104.i, i64 %indvars.iv.next155.i
  ...
  %exitcond158.not.i.1 = icmp eq i64 %indvars.iv.next155.i.1, %idxprom353.i
  br i1 %exitcond158.not.i.1, label %for.cond365.preheader.i, label %for.body351.i, !llvm.loop !98

for.body369.i:                                    ; preds = %for.body369.i.prol.loopexit, %for.body369.i
  %indvars.iv159.i = phi i64 [ %indvars.iv.next160.i.1, %for.body369.i ], [ %indvars.iv159.i.unr, %for.body369.i.prol.loopexit ]
  %282 = load float, ptr %arrayidx372.i, align 4, !tbaa !14
  %indvars.iv.next160.i = add nuw nsw i64 %indvars.iv159.i, 1
  %arrayidx375.i = getelementptr inbounds float, ptr %call18, i64 %indvars.iv.next160.i
  %283 = load float, ptr %arrayidx375.i, align 4, !tbaa !14
  %add376.i = fadd float %282, %283
  %arrayidx378.i = getelementptr inbounds float, ptr %previousw.029.i, i64 %indvars.iv159.i
  ...
  %arrayidx375.i.1 = getelementptr inbounds float, ptr %call18, i64 %indvars.iv.next160.i.1
  %286 = load float, ptr %arrayidx375.i.1, align 4, !tbaa !14
  %add376.i.1 = fadd float %285, %286
  %arrayidx378.i.1 = getelementptr inbounds float, ptr %previousw.029.i, i64 %indvars.iv.next160.i
  ...
  %exitcond163.not.i.1 = icmp eq i64 %indvars.iv.next160.i.1, %wide.trip.count162.i
  br i1 %exitcond163.not.i.1, label %for.body387.i.preheader, label %for.body369.i, !llvm.loop !99

for.body408.lr.ph.i.unr-lcssa:                    ; preds = %for.body387.i, %for.body387.i.preheader
  %indvars.iv164.i.unr = phi i64 [ 0, %for.body387.i.preheader ], [ %indvars.iv.next165.i.1, %for.body387.i ]
...
for.body387.i.epil:                               ; preds = %for.body408.lr.ph.i.unr-lcssa
  ...
  %indvars.iv.next165.i.epil = add nuw nsw i64 %indvars.iv164.i.unr, 1
  %arrayidx393.i.epil = getelementptr inbounds float, ptr %call16, i64 %indvars.iv.next165.i.epil
  %289 = load float, ptr %arrayidx393.i.epil, align 4, !tbaa !14
  %add394.i.epil = fadd float %288, %289
  %arrayidx396.i.epil = getelementptr inbounds ptr, ptr %call131.i, i64 %indvars.iv164.i.unr
...
vector.memcheck583:                               ; preds = %for.body408.lr.ph.i
  %293 = shl nuw nsw i64 %wide.trip.count162.i, 2
  %uglygep584 = getelementptr i8, ptr %292, i64 %293
  %294 = shl nsw i64 %idxprom220.i, 2
  %295 = add nsw i64 %294, 4
  %uglygep585 = getelementptr i8, ptr %call22, i64 %295
  %uglygep586 = getelementptr i8, ptr %call18, i64 4
  %296 = add nuw nsw i64 %293, 4
  %uglygep587 = getelementptr i8, ptr %call18, i64 %296
  %bound0588 = icmp ult ptr %292, %uglygep585
  %bound1589 = icmp ult ptr %arrayidx372.i, %uglygep584
  %found.conflict590 = and i1 %bound0588, %bound1589
  %bound0591 = icmp ult ptr %292, %uglygep587
  %bound1592 = icmp ult ptr %uglygep586, %uglygep584
...
vector.ph598:                                     ; preds = %vector.memcheck583
  %n.vec600 = and i64 %wide.trip.count162.i, 4294967288
...
middle.block595:                                  ; preds = %vector.body603
  %cmp.n602 = icmp eq i64 %n.vec600, %wide.trip.count162.i
...
for.body408.i.preheader:                          ; preds = %vector.memcheck583, %for.body408.lr.ph.i, %middle.block595
  %indvars.iv169.i.ph = phi i64 [ 0, %vector.memcheck583 ], [ 0, %for.body408.lr.ph.i ], [ %n.vec600, %middle.block595 ]
  %308 = xor i64 %indvars.iv169.i.ph, -1
  %xtraiter705 = and i64 %wide.trip.count162.i, 1
...
for.body408.i.prol:                               ; preds = %for.body408.i.preheader
  ...
  %indvars.iv.next170.i.prol = or i64 %indvars.iv169.i.ph, 1
  %arrayidx414.i.prol = getelementptr inbounds float, ptr %call18, i64 %indvars.iv.next170.i.prol
  %310 = load float, ptr %arrayidx414.i.prol, align 4, !tbaa !14
  %add415.i.prol = fadd float %309, %310
  %arrayidx420.i.prol = getelementptr inbounds float, ptr %292, i64 %indvars.iv169.i.ph
...
for.body408.i.prol.loopexit:                      ; preds = %for.body408.i.prol, %for.body408.i.preheader
  %indvars.iv169.i.unr = phi i64 [ %indvars.iv169.i.ph, %for.body408.i.preheader ], [ %indvars.iv.next170.i.prol, %for.body408.i.prol ]
  %312 = sub nsw i64 0, %wide.trip.count162.i
...
for.body387.i:                                    ; preds = %for.body387.i, %for.body387.i.preheader.new
  %indvars.iv164.i = phi i64 [ 0, %for.body387.i.preheader.new ], [ %indvars.iv.next165.i.1, %for.body387.i ]
  ...
  %arrayidx393.i = getelementptr inbounds float, ptr %call16, i64 %indvars.iv.next165.i
  %315 = load float, ptr %arrayidx393.i, align 4, !tbaa !14
  %add394.i = fadd float %314, %315
  %arrayidx396.i = getelementptr inbounds ptr, ptr %call131.i, i64 %indvars.iv164.i
  ...
  %arrayidx393.i.1 = getelementptr inbounds float, ptr %call16, i64 %indvars.iv.next165.i.1
  %319 = load float, ptr %arrayidx393.i.1, align 4, !tbaa !14
  %add394.i.1 = fadd float %318, %319
  %arrayidx396.i.1 = getelementptr inbounds ptr, ptr %call131.i, i64 %indvars.iv.next165.i
...
vector.scevcheck:                                 ; preds = %for.body429.lr.ph.i
  ...
  %326 = add nsw i64 %umin.neg, %wide.trip.count162.i
  %327 = add i32 %conv8, -2
...
vector.memcheck615:                               ; preds = %vector.scevcheck
  ...
  %uglygep617 = getelementptr i8, ptr %previousw.029.i, i64 %332
  %333 = shl nuw nsw i64 %wide.trip.count162.i, 2
  %334 = add nuw nsw i64 %333, 4
  %uglygep618 = getelementptr i8, ptr %previousw.029.i, i64 %334
  %335 = shl nuw nsw i64 %idxprom433.i, 2
  %336 = add nuw nsw i64 %332, %335
  %337 = sub nsw i64 %336, %333
  %uglygep619 = getelementptr i8, ptr %call108.i, i64 %337
  %338 = add nuw nsw i64 %335, 4
  %uglygep620 = getelementptr i8, ptr %call108.i, i64 %338
  %uglygep621 = getelementptr i8, ptr %call22, i64 %338
  %bound0622 = icmp ult ptr %uglygep617, %uglygep620
  %bound1623 = icmp ult ptr %uglygep619, %uglygep618
  %found.conflict624 = and i1 %bound0622, %bound1623
  %bound0625 = icmp ult ptr %arrayidx434.i, %uglygep620
  %bound1626 = icmp ult ptr %uglygep619, %uglygep621
...
vector.ph633:                                     ; preds = %vector.memcheck615
  ...
  %ind.end636 = sub nsw i64 %wide.trip.count162.i, %n.vec635
  ...
  %339 = getelementptr float, ptr %previousw.029.i, i64 -3
  %340 = load float, ptr %arrayidx434.i, align 4, !tbaa !14, !alias.scope !110, !noalias !113
  %broadcast.splatinsert643 = insertelement <4 x float> poison, float %340, i64 0
  %broadcast.splat644 = shufflevector <4 x float> %broadcast.splatinsert643, <4 x float> poison, <4 x i32> zeroinitializer
  %341 = getelementptr float, ptr %call108.i, i64 -3
  %342 = getelementptr i32, ptr %call110.i, i64 -3
...
vector.body639:                                   ; preds = %vector.body639, %vector.ph633
  ...
  %offset.idx641 = sub i64 %wide.trip.count162.i, %index640
  %343 = getelementptr float, ptr %339, i64 %offset.idx641
  %wide.load642 = load <4 x float>, ptr %343, align 4, !tbaa !14, !alias.scope !115, !noalias !113
  %reverse = shufflevector <4 x float> %wide.load642, <4 x float> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %344 = fadd <4 x float> %reverse, %broadcast.splat644
  %345 = add i64 %offset.idx641, 4294967295
  %346 = and i64 %345, 4294967295
  %reverse645 = shufflevector <4 x float> %344, <4 x float> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %347 = getelementptr float, ptr %341, i64 %346
  store <4 x float> %reverse645, ptr %347, align 4, !tbaa !14, !alias.scope !113
  %348 = getelementptr i32, ptr %342, i64 %offset.idx641
  store <4 x i32> %broadcast.splat647, ptr %348, align 4, !tbaa !5
  %index.next649 = add nuw i64 %index640, 4
  %349 = icmp eq i64 %index.next649, %n.vec635
  br i1 %349, label %middle.block630, label %vector.body639, !llvm.loop !117
...
for.body429.i.preheader:                          ; preds = %vector.memcheck615, %vector.scevcheck, %for.body429.lr.ph.i, %middle.block630
  %indvars.iv174.i.ph = phi i64 [ %wide.trip.count162.i, %vector.memcheck615 ], [ %wide.trip.count162.i, %vector.scevcheck ], [ %wide.trip.count162.i, %for.body429.lr.ph.i ], [ %ind.end636, %middle.block630 ]
  br label %for.body429.i

for.body408.i:                                    ; preds = %for.body408.i.prol.loopexit, %for.body408.i
  %indvars.iv169.i = phi i64 [ %indvars.iv.next170.i.1, %for.body408.i ], [ %indvars.iv169.i.unr, %for.body408.i.prol.loopexit ]
  %350 = load float, ptr %arrayidx372.i, align 4, !tbaa !14
  %indvars.iv.next170.i = add nuw nsw i64 %indvars.iv169.i, 1
  %arrayidx414.i = getelementptr inbounds float, ptr %call18, i64 %indvars.iv.next170.i
  %351 = load float, ptr %arrayidx414.i, align 4, !tbaa !14
  %add415.i = fadd float %350, %351
  %arrayidx420.i = getelementptr inbounds float, ptr %292, i64 %indvars.iv169.i
  %352 = load float, ptr %arrayidx420.i, align 4, !tbaa !14
  %add421.i = fadd float %add415.i, %352
  store float %add421.i, ptr %arrayidx420.i, align 4, !tbaa !14
  %353 = load float, ptr %arrayidx372.i, align 4, !tbaa !14
  %indvars.iv.next170.i.1 = add nuw nsw i64 %indvars.iv169.i, 2
  %arrayidx414.i.1 = getelementptr inbounds float, ptr %call18, i64 %indvars.iv.next170.i.1
  %354 = load float, ptr %arrayidx414.i.1, align 4, !tbaa !14
  %add415.i.1 = fadd float %353, %354
  %arrayidx420.i.1 = getelementptr inbounds float, ptr %292, i64 %indvars.iv.next170.i
  %355 = load float, ptr %arrayidx420.i.1, align 4, !tbaa !14
  %add421.i.1 = fadd float %add415.i.1, %355
  store float %add421.i.1, ptr %arrayidx420.i.1, align 4, !tbaa !14
  %exitcond173.not.i.1 = icmp eq i64 %indvars.iv.next170.i.1, %wide.trip.count162.i
  br i1 %exitcond173.not.i.1, label %for.body429.lr.ph.i, label %for.body408.i, !llvm.loop !118

for.body449.lr.ph.i:                              ; preds = %for.body429.i, %middle.block630
  %add.ptr474.i = getelementptr inbounds float, ptr %call108.i, i64 %idxprom332.i
  %add.ptr475.i = getelementptr inbounds float, ptr %add.ptr474.i, i64 -2
  %add.ptr483.i = getelementptr inbounds i32, ptr %call110.i, i64 %idxprom332.i
  %add.ptr484.i = getelementptr inbounds i32, ptr %add.ptr483.i, i64 -2
  %arrayidx595.i = getelementptr inbounds float, ptr %call86.i, i64 1
  %smax192.i = tail call i32 @llvm.smax.i32(i32 %add158.i, i32 1)
  %wide.trip.count193.i = zext i32 %smax192.i to i64
  %xtraiter708 = and i64 %wide.trip.count162.i, 1
  %356 = icmp eq i32 %sub111, 3
  %357 = and i64 %wide.trip.count162.i, 4294967294
  %358 = add nsw i64 %357, -4
  %lcmp.mod710.not = icmp eq i64 %xtraiter708, 0
  %xtraiter715 = and i64 %wide.trip.count193.i, 1
  %359 = icmp slt i32 %add158.i, 2
  %unroll_iter720 = and i64 %wide.trip.count193.i, 2147483646
  %lcmp.mod717.not = icmp eq i64 %xtraiter715, 0
  br label %for.body449.i

for.body429.i:                                    ; preds = %for.body429.i.preheader, %for.body429.i
  %indvars.iv174.i = phi i64 [ %indvars.iv.next175.i, %for.body429.i ], [ %indvars.iv174.i.ph, %for.body429.i.preheader ]
  %arrayidx431.i = getelementptr inbounds float, ptr %previousw.029.i, i64 %indvars.iv174.i
  %360 = load float, ptr %arrayidx431.i, align 4, !tbaa !14
  %361 = load float, ptr %arrayidx434.i, align 4, !tbaa !14
  %add435.i = fadd float %360, %361
  %indvars.iv.next175.i = add nsw i64 %indvars.iv174.i, -1
  %idxprom437.i = and i64 %indvars.iv.next175.i, 4294967295
...
for.body449.i:                                    ; preds = %for.inc675.i, %for.body449.lr.ph.i
  %indvars.iv195.i = phi i64 [ %idxprom353.i, %for.body449.lr.ph.i ], [ %indvars.iv.next196.i, %for.inc675.i ]
  %firstmp.078.i = phi i32 [ %sub110, %for.body449.lr.ph.i ], [ %firstmp.1.i, %for.inc675.i ]
  %firstm.077.i = phi float [ -1.000000e+07, %for.body449.lr.ph.i ], [ %firstm.1.i, %for.inc675.i ]
  %imid.075.i = phi i32 [ %conv224.i, %for.body449.lr.ph.i ], [ %imid.1.i, %for.inc675.i ]
  %jmid.074.i = phi i32 [ 0, %for.body449.lr.ph.i ], [ %jmid.6.i, %for.inc675.i ]
  %jumpj.073.i = phi i32 [ 0, %for.body449.lr.ph.i ], [ %jumpj.3.i, %for.inc675.i ]
  %jumpi.072.i = phi i32 [ 0, %for.body449.lr.ph.i ], [ %jumpi.3.i, %for.inc675.i ]
  %currentw.171.i = phi ptr [ %previousw.029.i, %for.body449.lr.ph.i ], [ %previousw.170.i, %for.inc675.i ]
  %previousw.170.i = phi ptr [ %currentw.030.i, %for.body449.lr.ph.i ], [ %currentw.171.i, %for.inc675.i ]
  %maxwm.069.i = phi float [ 0.000000e+00, %for.body449.lr.ph.i ], [ %maxwm.5.i, %for.inc675.i ]
  %indvars.iv.next196.i = add nsw i64 %indvars.iv195.i, -1
  %indvars197.i = trunc i64 %indvars.iv.next196.i to i32
  %arrayidx452.i = getelementptr inbounds float, ptr %call104.i, i64 %indvars.iv195.i
  %362 = load float, ptr %arrayidx452.i, align 4, !tbaa !14
  %arrayidx455.i = getelementptr inbounds float, ptr %currentw.171.i, i64 %idxprom220.i
  store float %362, ptr %arrayidx455.i, align 4, !tbaa !14
  tail call fastcc void @match_calc(ptr noundef %previousw.170.i, ptr noundef %call24, ptr noundef %call26, i32 noundef %indvars197.i, i32 noundef %conv8, ptr noundef %call122.i, ptr noundef %call130.i, i32 noundef 0)
  %idxprom460.i = and i64 %indvars.iv.next196.i, 4294967295
  %arrayidx461.i = getelementptr inbounds float, ptr %call104.i, i64 %idxprom460.i
  %363 = load float, ptr %arrayidx461.i, align 4, !tbaa !14
  %arrayidx464.i = getelementptr inbounds float, ptr %previousw.170.i, i64 %idxprom220.i
  store float %363, ptr %arrayidx464.i, align 4, !tbaa !14
  %add.ptr477.i = getelementptr inbounds float, ptr %currentw.171.i, i64 %idxprom332.i
  %prept.144.i = getelementptr inbounds float, ptr %add.ptr477.i, i64 -1
  %add.ptr480.i = getelementptr inbounds float, ptr %previousw.170.i, i64 %idxprom332.i
  %add.ptr481.i = getelementptr inbounds float, ptr %add.ptr480.i, i64 -2
  %364 = load float, ptr %arrayidx455.i, align 4, !tbaa !14
  %365 = load float, ptr %arrayidx434.i, align 4, !tbaa !14
  %add471.i = fadd float %364, %365
  %arrayidx511.i = getelementptr inbounds float, ptr %call16, i64 %indvars.iv195.i
  %arrayidx519.i = getelementptr inbounds float, ptr %call20, i64 %idxprom460.i
  %cmp526.i = icmp eq i32 %jumpi.072.i, %indvars197.i
  %366 = zext i32 %imid.075.i to i64
  %cmp530.i = icmp eq i64 %indvars.iv195.i, %366
  %or.cond1237.i = select i1 %cmp526.i, i1 true, i1 %cmp530.i
  %cmp538.i = icmp eq i32 %imid.075.i, %indvars197.i
  %arrayidx558.i = getelementptr inbounds ptr, ptr %call131.i, i64 %idxprom460.i
  %367 = load ptr, ptr %arrayidx558.i, align 8, !tbaa !9
  %arrayidx563.i = getelementptr inbounds ptr, ptr %call132.i, i64 %idxprom460.i
  %368 = load ptr, ptr %arrayidx563.i, align 8, !tbaa !9
  %369 = trunc i64 %indvars.iv195.i to i32
  br label %for.body489.i

for.body489.i:                                    ; preds = %if.end556.i, %for.body449.i
  %indvars.iv177.i = phi i64 [ %idxprom433.i, %for.body449.i ], [ %indvars.iv.next178.i, %if.end556.i ]
  %prept.152.i = phi ptr [ %prept.144.i, %for.body449.i ], [ %prept.1.i, %if.end556.i ]
  %mpjpt.150.i = phi ptr [ %add.ptr484.i, %for.body449.i ], [ %incdec.ptr570.i, %if.end556.i ]
  %mpi.249.i = phi i32 [ %sub111, %for.body449.i ], [ %mpi.3.i, %if.end556.i ]
  %mjpt.148.i = phi ptr [ %add.ptr475.i, %for.body449.i ], [ %incdec.ptr568.i, %if.end556.i ]
  ...
  %370 = load float, ptr %prept.152.i, align 4, !tbaa !14
  %371 = add nuw nsw i64 %indvars.iv177.i, 1
  %arrayidx494.i = getelementptr inbounds float, ptr %call18, i64 %371
  %372 = load float, ptr %arrayidx494.i, align 4, !tbaa !14
  %add495.i = fadd float %mi.246.i, %372
  %cmp496.i = fcmp ogt float %add495.i, %370
  %wm.2.i = select i1 %cmp496.i, float %add495.i, float %370
  %373 = trunc i64 %371 to i32
  %ijpj.0.i = select i1 %cmp496.i, i32 %mpi.249.i, i32 %373
  %arrayidx502.i = getelementptr inbounds float, ptr %call22, i64 %indvars.iv177.i
  %374 = load float, ptr %arrayidx502.i, align 4, !tbaa !14
  %add503.i = fadd float %370, %374
  %cmp504.i = fcmp ult float %add503.i, %mi.246.i
  %mi.3.i = select i1 %cmp504.i, float %mi.246.i, float %add503.i
  %mpi.3.i = select i1 %cmp504.i, i32 %mpi.249.i, i32 %373
  %375 = load float, ptr %mjpt.148.i, align 4, !tbaa !14
  %376 = load float, ptr %arrayidx511.i, align 4, !tbaa !14
  %add512.i = fadd float %375, %376
...
if.then515.i:                                     ; preds = %for.body489.i
  %377 = load i32, ptr %mpjpt.150.i, align 4, !tbaa !5
...
if.end517.i:                                      ; preds = %if.then515.i, %for.body489.i
  ...
  %ijpi.1.i = phi i32 [ %377, %if.then515.i ], [ %369, %for.body489.i ]
  %ijpj.1.i = phi i32 [ %373, %if.then515.i ], [ %ijpj.0.i, %for.body489.i ]
  %378 = load float, ptr %arrayidx519.i, align 4, !tbaa !14
  %add520.i = fadd float %370, %378
  %cmp521.i = fcmp ult float %add520.i, %375
...
if.then523.i:                                     ; preds = %if.end517.i
  ...
  store i32 %369, ptr %mpjpt.150.i, align 4, !tbaa !5
...
if.then532.i:                                     ; preds = %if.end525.i
  %arrayidx534.i = getelementptr inbounds i32, ptr %call96.i, i64 %indvars.iv177.i
  store i32 %ijpi.1.i, ptr %arrayidx534.i, align 4, !tbaa !5
  %arrayidx536.i = getelementptr inbounds i32, ptr %call98.i, i64 %indvars.iv177.i
...
if.then540.i:                                     ; preds = %if.end537.i
  %arrayidx542.i = getelementptr inbounds float, ptr %call86.i, i64 %indvars.iv177.i
  %379 = load float, ptr %arrayidx542.i, align 4, !tbaa !14
  %add543.i = fadd float %wm.3.i, %379
  store float %add543.i, ptr %arrayidx542.i, align 4, !tbaa !14
  %380 = load float, ptr %mjpt.148.i, align 4, !tbaa !14
  %arrayidx546.i = getelementptr inbounds float, ptr %call90.i, i64 %371
  %381 = load float, ptr %arrayidx546.i, align 4, !tbaa !14
  %add547.i = fadd float %380, %381
...
if.then552.i:                                     ; preds = %if.end548.i
  %arrayidx554.i = getelementptr inbounds float, ptr %call88.i, i64 %indvars.iv177.i
  %382 = load float, ptr %arrayidx554.i, align 4, !tbaa !14
  %add555.i = fadd float %mi.3.i, %382
  store float %add555.i, ptr %arrayidx554.i, align 4, !tbaa !14
  br label %if.end556.i

if.end556.i:                                      ; preds = %if.then552.i, %if.end548.i
  %arrayidx560.i = getelementptr inbounds float, ptr %367, i64 %indvars.iv177.i
  %383 = load float, ptr %arrayidx560.i, align 4, !tbaa !14
  %add561.i = fadd float %wm.3.i, %383
  store float %add561.i, ptr %arrayidx560.i, align 4, !tbaa !14
  %384 = load float, ptr %curpt.147.i, align 4, !tbaa !14
  %arrayidx565.i = getelementptr inbounds float, ptr %368, i64 %indvars.iv177.i
  %385 = load float, ptr %arrayidx565.i, align 4, !tbaa !14
  %add566.i = fadd float %384, %385
  store float %add566.i, ptr %arrayidx565.i, align 4, !tbaa !14
  %386 = load float, ptr %curpt.147.i, align 4, !tbaa !14
  %add567.i = fadd float %wm.3.i, %386
  ...
  %cmp487.i = icmp sgt i64 %indvars.iv177.i, 0
  br i1 %cmp487.i, label %for.body489.i, label %for.end574.i, !llvm.loop !120

for.end574.i:                                     ; preds = %if.end556.i
  %387 = load float, ptr %prept.1.i, align 4, !tbaa !14
  %388 = load float, ptr %arrayidx519.i, align 4, !tbaa !14
  %add577.i = fadd float %387, %388
  %cmp578.i = fcmp olt float %firstm.077.i, %add577.i
  %firstm.1.i = select i1 %cmp578.i, float %add577.i, float %firstm.077.i
  %firstmp.1.i = select i1 %cmp578.i, i32 %369, i32 %firstmp.078.i
  br i1 %cmp538.i, label %if.then585.i, label %if.end590.i

if.then585.i:                                     ; preds = %for.end574.i
  %389 = load float, ptr %call90.i, align 4, !tbaa !14
  %add589.i = fadd float %firstm.1.i, %389
  store float %add589.i, ptr %call90.i, align 4, !tbaa !14
  br label %if.end590.i

if.end590.i:                                      ; preds = %if.then585.i, %for.end574.i
  %sub591.i = add nsw i32 %imid.075.i, -1
  br i1 %cmp530.i, label %if.then594.i, label %if.end654.i

if.then594.i:                                     ; preds = %if.end590.i
  %390 = load float, ptr %arrayidx595.i, align 4, !tbaa !14
  br i1 %356, label %for.body614.i.preheader.unr-lcssa, label %for.body600.i

for.body600.i:                                    ; preds = %if.then594.i, %for.body600.i
  %indvars.iv182.i = phi i64 [ %indvars.iv.next183.i.1, %for.body600.i ], [ 2, %if.then594.i ]
  %jmid.157.i = phi i32 [ %jmid.2.i.1, %for.body600.i ], [ 0, %if.then594.i ]
  %maxwm.156.i = phi float [ %maxwm.2.i.1, %for.body600.i ], [ %390, %if.then594.i ]
  %niter714 = phi i64 [ %niter714.next.1, %for.body600.i ], [ 0, %if.then594.i ]
  %arrayidx602.i = getelementptr inbounds float, ptr %call86.i, i64 %indvars.iv182.i
  %391 = load float, ptr %arrayidx602.i, align 4, !tbaa !14
  %cmp603.i = fcmp ogt float %391, %maxwm.156.i
  %maxwm.2.i = select i1 %cmp603.i, float %391, float %maxwm.156.i
  %392 = trunc i64 %indvars.iv182.i to i32
  %jmid.2.i = select i1 %cmp603.i, i32 %392, i32 %jmid.157.i
  %indvars.iv.next183.i = or i64 %indvars.iv182.i, 1
  %arrayidx602.i.1 = getelementptr inbounds float, ptr %call86.i, i64 %indvars.iv.next183.i
  %393 = load float, ptr %arrayidx602.i.1, align 4, !tbaa !14
  %cmp603.i.1 = fcmp ogt float %393, %maxwm.2.i
  %maxwm.2.i.1 = select i1 %cmp603.i.1, float %393, float %maxwm.2.i
  %394 = trunc i64 %indvars.iv.next183.i to i32
  %jmid.2.i.1 = select i1 %cmp603.i.1, i32 %394, i32 %jmid.2.i
  %indvars.iv.next183.i.1 = add nuw nsw i64 %indvars.iv182.i, 2
  %niter714.next.1 = add i64 %niter714, 2
  %niter714.ncmp.1 = icmp eq i64 %niter714, %358
...
for.body614.i.preheader.unr-lcssa:                ; preds = %for.body600.i, %if.then594.i
  ...
  %indvars.iv182.i.unr = phi i64 [ 2, %if.then594.i ], [ %indvars.iv.next183.i.1, %for.body600.i ]
  %jmid.157.i.unr = phi i32 [ 0, %if.then594.i ], [ %jmid.2.i.1, %for.body600.i ]
  %maxwm.156.i.unr = phi float [ %390, %if.then594.i ], [ %maxwm.2.i.1, %for.body600.i ]
...
for.body600.i.epil:                               ; preds = %for.body614.i.preheader.unr-lcssa
  %arrayidx602.i.epil = getelementptr inbounds float, ptr %call86.i, i64 %indvars.iv182.i.unr
  %395 = load float, ptr %arrayidx602.i.epil, align 4, !tbaa !14
  %cmp603.i.epil = fcmp ogt float %395, %maxwm.156.i.unr
  %maxwm.2.i.epil = select i1 %cmp603.i.epil, float %395, float %maxwm.156.i.unr
  %396 = trunc i64 %indvars.iv182.i.unr to i32
  %jmid.2.i.epil = select i1 %cmp603.i.epil, i32 %396, i32 %jmid.157.i.unr
...
for.body614.i.preheader:                          ; preds = %for.body614.i.preheader.unr-lcssa, %for.body600.i.epil
  ...
  br i1 %359, label %for.end623.i.unr-lcssa, label %for.body614.i

for.body614.i:                                    ; preds = %for.body614.i.preheader, %for.body614.i
  %indvars.iv188.i = phi i64 [ %indvars.iv.next189.i.1, %for.body614.i ], [ 0, %for.body614.i.preheader ]
  ...
  %arrayidx616.i = getelementptr inbounds float, ptr %call90.i, i64 %indvars.iv188.i
  %397 = load float, ptr %arrayidx616.i, align 4, !tbaa !14
  %cmp617.i = fcmp ogt float %397, %maxwm.362.i
  %maxwm.4.i = select i1 %cmp617.i, float %397, float %maxwm.362.i
  %398 = trunc i64 %indvars.iv188.i to i32
  %jmid.4.i = select i1 %cmp617.i, i32 %398, i32 %jmid.363.i
  %indvars.iv.next189.i = or i64 %indvars.iv188.i, 1
  %arrayidx616.i.1 = getelementptr inbounds float, ptr %call90.i, i64 %indvars.iv.next189.i
  %399 = load float, ptr %arrayidx616.i.1, align 4, !tbaa !14
  %cmp617.i.1 = fcmp ogt float %399, %maxwm.4.i
  %maxwm.4.i.1 = select i1 %cmp617.i.1, float %399, float %maxwm.4.i
  %400 = trunc i64 %indvars.iv.next189.i to i32
  %jmid.4.i.1 = select i1 %cmp617.i.1, i32 %400, i32 %jmid.4.i
  %indvars.iv.next189.i.1 = add nuw nsw i64 %indvars.iv188.i, 2
...
for.end623.i.unr-lcssa:                           ; preds = %for.body614.i, %for.body614.i.preheader
  ...
  %indvars.iv188.i.unr = phi i64 [ 0, %for.body614.i.preheader ], [ %indvars.iv.next189.i.1, %for.body614.i ]
...
for.body614.i.epil:                               ; preds = %for.end623.i.unr-lcssa
  %arrayidx616.i.epil = getelementptr inbounds float, ptr %call90.i, i64 %indvars.iv188.i.unr
  %401 = load float, ptr %arrayidx616.i.epil, align 4, !tbaa !14
  %cmp617.i.epil = fcmp ogt float %401, %maxwm.362.i.unr
  %maxwm.4.i.epil = select i1 %cmp617.i.epil, float %401, float %maxwm.362.i.unr
  %402 = trunc i64 %indvars.iv188.i.unr to i32
  %jmid.4.i.epil = select i1 %cmp617.i.epil, i32 %402, i32 %jmid.363.i.unr
...
for.end623.i:                                     ; preds = %for.end623.i.unr-lcssa, %for.body614.i.epil
  ...
  %403 = load float, ptr %arrayidx625.i, align 4, !tbaa !14
...
land.lhs.true.i:                                  ; preds = %for.end623.i
  ...
  %404 = load float, ptr %arrayidx632.i, align 4, !tbaa !14
  %cmp633.i = fcmp ogt float %404, %403
...
if.then635.i:                                     ; preds = %land.lhs.true.i
  ...
  %405 = load i32, ptr %arrayidx638.i, align 4, !tbaa !5
  br label %if.end642.i

if.end642.i:                                      ; preds = %if.then635.i, %land.lhs.true.i, %for.end623.i
  %wm.4.i = phi float [ %404, %if.then635.i ], [ %403, %land.lhs.true.i ], [ %403, %for.end623.i ]
  %jumpj.1.i = phi i32 [ %405, %if.then635.i ], [ %sub627.i, %land.lhs.true.i ], [ %sub627.i, %for.end623.i ]
  %arrayidx644.i = getelementptr inbounds float, ptr %call90.i, i64 %idxprom624.i
  %406 = load float, ptr %arrayidx644.i, align 4, !tbaa !14
  %cmp645.i = fcmp ogt float %406, %wm.4.i
...
if.then647.i:                                     ; preds = %if.end642.i
  ...
  %407 = load i32, ptr %arrayidx649.i, align 4, !tbaa !5
  br label %if.end654.i

if.end654.i:                                      ; preds = %if.then647.i, %if.end642.i, %if.end590.i
  %maxwm.5.i = phi float [ %maxwm.4.i.lcssa, %if.then647.i ], [ %maxwm.4.i.lcssa, %if.end642.i ], [ %maxwm.069.i, %if.end590.i ]
  %jumpi.2.i = phi i32 [ %407, %if.then647.i ], [ %sub591.i, %if.end642.i ], [ %jumpi.072.i, %if.end590.i ]
  %jumpj.2.i = phi i32 [ %sub627.i, %if.then647.i ], [ %jumpj.1.i, %if.end642.i ], [ %jumpj.073.i, %if.end590.i ]
  %jmid.5.i = phi i32 [ %jmid.4.i.lcssa, %if.then647.i ], [ %jmid.4.i.lcssa, %if.end642.i ], [ %jmid.074.i, %if.end590.i ]
  %cmp655.i = icmp eq i32 %jumpi.2.i, %indvars197.i
...
if.else667.i:                                     ; preds = %if.else.i
  ...
  %408 = load i32, ptr %arrayidx669.i, align 4, !tbaa !5
  %arrayidx671.i = getelementptr inbounds i32, ptr %call98.i, i64 %idxprom668.i
  %409 = load i32, ptr %arrayidx671.i, align 4, !tbaa !5
  br label %for.inc675.i

for.inc675.i:                                     ; preds = %if.else667.i, %if.else.i, %if.then660.i, %if.end654.i
  %jumpi.3.i = phi i32 [ %sub661.i, %if.then660.i ], [ %indvars197.i, %if.else667.i ], [ %jumpi.2.i, %if.end654.i ], [ %sub591.i, %if.else.i ]
  %jumpj.3.i = phi i32 [ 0, %if.then660.i ], [ %jumpj.2.i, %if.else667.i ], [ %jumpj.2.i, %if.end654.i ], [ %sub111, %if.else.i ]
  %jmid.6.i = phi i32 [ 1, %if.then660.i ], [ %409, %if.else667.i ], [ %jmid.5.i, %if.end654.i ], [ %conv8, %if.else.i ]
  %imid.1.i = phi i32 [ %firstmp.1.i, %if.then660.i ], [ %408, %if.else667.i ], [ %imid.075.i, %if.end654.i ], [ %imid.075.i, %if.else.i ]
  %cmp447.i = icmp sgt i64 %indvars.iv195.i, 1
...
for.cond682.preheader.i:                          ; preds = %for.cond682.for.inc697_crit_edge.i, %for.cond678.preheader.i
  %indvars.iv205.i = phi i64 [ 0, %for.cond678.preheader.i ], [ %indvars.iv.next206.i, %for.cond682.for.inc697_crit_edge.i ]
  %arrayidx687.i = getelementptr inbounds ptr, ptr %call131.i, i64 %indvars.iv205.i
  %410 = load ptr, ptr %arrayidx687.i, align 8, !tbaa !9
  %arrayidx691.i = getelementptr inbounds ptr, ptr %map, i64 %indvars.iv205.i
  %411 = load ptr, ptr %arrayidx691.i, align 8, !tbaa !9
  %412 = ptrtoint ptr %411 to i64
  %413 = ptrtoint ptr %410 to i64
  %414 = sub i64 %412, %413
  %diff.check651 = icmp ult i64 %414, 16
...
vector.body660:                                   ; preds = %for.cond682.preheader.i, %vector.body660
  ...
  %415 = getelementptr inbounds float, ptr %410, i64 %index661
  %wide.load662 = load <4 x float>, ptr %415, align 4, !tbaa !14
  %416 = fdiv <4 x float> %wide.load662, %broadcast.splat664
  %417 = getelementptr inbounds float, ptr %411, i64 %index661
  store <4 x float> %416, ptr %417, align 4, !tbaa !14
  %index.next665 = add nuw i64 %index661, 4
  %418 = icmp eq i64 %index.next665, %n.vec657
  br i1 %418, label %middle.block652, label %vector.body660, !llvm.loop !124
...
for.body685.i.preheader:                          ; preds = %for.cond682.preheader.i, %middle.block652
  %indvars.iv199.i.ph = phi i64 [ 0, %for.cond682.preheader.i ], [ %n.vec657, %middle.block652 ]
  %419 = sub i64 %call7, %indvars.iv199.i.ph
  %420 = xor i64 %indvars.iv199.i.ph, -1
  %421 = add nsw i64 %322, %420
  %xtraiter722 = and i64 %419, 3
...
for.body685.i.prol:                               ; preds = %for.body685.i.preheader, %for.body685.i.prol
  %indvars.iv199.i.prol = phi i64 [ %indvars.iv.next200.i.prol, %for.body685.i.prol ], [ %indvars.iv199.i.ph, %for.body685.i.preheader ]
  %prol.iter724 = phi i64 [ %prol.iter724.next, %for.body685.i.prol ], [ 0, %for.body685.i.preheader ]
  %arrayidx689.i.prol = getelementptr inbounds float, ptr %410, i64 %indvars.iv199.i.prol
  %422 = load float, ptr %arrayidx689.i.prol, align 4, !tbaa !14
  %div.i.prol = fdiv float %422, %maxwm.5.i
  %arrayidx693.i.prol = getelementptr inbounds float, ptr %411, i64 %indvars.iv199.i.prol
  store float %div.i.prol, ptr %arrayidx693.i.prol, align 4, !tbaa !14
  %indvars.iv.next200.i.prol = add nuw nsw i64 %indvars.iv199.i.prol, 1
...
for.body685.i.prol.loopexit:                      ; preds = %for.body685.i.prol, %for.body685.i.preheader
  %indvars.iv199.i.unr = phi i64 [ %indvars.iv199.i.ph, %for.body685.i.preheader ], [ %indvars.iv.next200.i.prol, %for.body685.i.prol ]
  %423 = icmp ult i64 %421, 3
  br i1 %423, label %for.cond682.for.inc697_crit_edge.i, label %for.body685.i

for.body685.i:                                    ; preds = %for.body685.i.prol.loopexit, %for.body685.i
  %indvars.iv199.i = phi i64 [ %indvars.iv.next200.i.3, %for.body685.i ], [ %indvars.iv199.i.unr, %for.body685.i.prol.loopexit ]
  %arrayidx689.i = getelementptr inbounds float, ptr %410, i64 %indvars.iv199.i
  %424 = load float, ptr %arrayidx689.i, align 4, !tbaa !14
  %div.i = fdiv float %424, %maxwm.5.i
  %arrayidx693.i = getelementptr inbounds float, ptr %411, i64 %indvars.iv199.i
  store float %div.i, ptr %arrayidx693.i, align 4, !tbaa !14
  %indvars.iv.next200.i = add nuw nsw i64 %indvars.iv199.i, 1
  %arrayidx689.i.1 = getelementptr inbounds float, ptr %410, i64 %indvars.iv.next200.i
  %425 = load float, ptr %arrayidx689.i.1, align 4, !tbaa !14
  %div.i.1 = fdiv float %425, %maxwm.5.i
  %arrayidx693.i.1 = getelementptr inbounds float, ptr %411, i64 %indvars.iv.next200.i
  store float %div.i.1, ptr %arrayidx693.i.1, align 4, !tbaa !14
  %indvars.iv.next200.i.1 = add nuw nsw i64 %indvars.iv199.i, 2
  %arrayidx689.i.2 = getelementptr inbounds float, ptr %410, i64 %indvars.iv.next200.i.1
  %426 = load float, ptr %arrayidx689.i.2, align 4, !tbaa !14
  %div.i.2 = fdiv float %426, %maxwm.5.i
  %arrayidx693.i.2 = getelementptr inbounds float, ptr %411, i64 %indvars.iv.next200.i.1
  store float %div.i.2, ptr %arrayidx693.i.2, align 4, !tbaa !14
  %indvars.iv.next200.i.2 = add nuw nsw i64 %indvars.iv199.i, 3
  %arrayidx689.i.3 = getelementptr inbounds float, ptr %410, i64 %indvars.iv.next200.i.2
  %427 = load float, ptr %arrayidx689.i.3, align 4, !tbaa !14
  %div.i.3 = fdiv float %427, %maxwm.5.i
  %arrayidx693.i.3 = getelementptr inbounds float, ptr %411, i64 %indvars.iv.next200.i.2
  store float %div.i.3, ptr %arrayidx693.i.3, align 4, !tbaa !14
  %indvars.iv.next200.i.3 = add nuw nsw i64 %indvars.iv199.i, 4
  %exitcond204.not.i.3 = icmp eq i64 %indvars.iv.next200.i.3, %idxprom332.i
  br i1 %exitcond204.not.i.3, label %for.cond682.for.inc697_crit_edge.i, label %for.body685.i, !llvm.loop !126

for.cond682.for.inc697_crit_edge.i:               ; preds = %for.body685.i.prol.loopexit, %for.body685.i, %middle.block652
  %indvars.iv.next206.i = add nuw nsw i64 %indvars.iv205.i, 1
  %exitcond210.not.i = icmp eq i64 %indvars.iv.next206.i, %wide.trip.count209.i
  br i1 %exitcond210.not.i, label %for.end699.i, label %for.cond682.preheader.i, !llvm.loop !127
...
MSalignmm_rec.exit:                               ; preds = %for.inc46.i, %for.cond29.preheader.i, %if.then77.i, %for.end699.i
  ...
  %428 = load ptr, ptr %seq2, align 8, !tbaa !9
  %call117 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %428) #13
  br i1 %cmp300, label %for.body122.lr.ph, label %for.cond136.preheader

for.body122.lr.ph:                                ; preds = %MSalignmm_rec.exit
  %429 = load ptr, ptr %seq1, align 8, !tbaa !9
  %call114 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %429) #13
...
for.body122:                                      ; preds = %for.body122.lr.ph, %for.inc133
  ...
  %430 = load ptr, ptr %arrayidx124, align 8, !tbaa !9
  %call125 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %430) #13
  %cmp127.not = icmp eq i64 %call125, %conv126
  br i1 %cmp127.not, label %for.inc133, label %if.then129

if.then129:                                       ; preds = %for.body122
  %431 = trunc i64 %indvars.iv334 to i32
  %432 = load ptr, ptr @stderr, align 8, !tbaa !9
  %call130 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %432, ptr noundef nonnull @.str, i32 noundef %431, i32 noundef %icyc) #14
  %433 = load ptr, ptr @stderr, align 8, !tbaa !9
  %434 = tail call i64 @fwrite(ptr nonnull @.str.3, i64 42, i64 1, ptr %433) #14
  tail call void @exit(i32 noundef 1) #15
  unreachable
...
for.body139:                                      ; preds = %for.body139.lr.ph, %for.inc150
  ...
  %435 = load ptr, ptr %arrayidx141, align 8, !tbaa !9
  %call142 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %435) #13
  %cmp144.not = icmp eq i64 %call142, %conv143
  br i1 %cmp144.not, label %for.inc150, label %if.then146

if.then146:                                       ; preds = %for.body139
  %436 = trunc i64 %indvars.iv339 to i32
  %437 = load ptr, ptr @stderr, align 8, !tbaa !9
  %call147 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %437, ptr noundef nonnull @.str.2, i32 noundef %436, i32 noundef %jcyc) #14
  %438 = load ptr, ptr @stderr, align 8, !tbaa !9
  %439 = tail call i64 @fwrite(ptr nonnull @.str.3, i64 42, i64 1, ptr %438) #14
  tail call void @exit(i32 noundef 1) #15
  unreachable
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  %indvars.iv.next212.i = add nuw nsw i64 %indvars.iv211.i, 1
  %exitcond216.not.i = icmp eq i64 %indvars.iv.next212.i, %wide.trip.count215.i
  br i1 %exitcond216.not.i, label %for.cond29.preheader.i, label %for.body.i, !llvm.loop !146
...
for.body39.i:                                     ; preds = %for.body32.i, %for.body39.i
  ...
  %inc44.i = add nuw i32 %j.088.i, 1
  %exitcond217.not.i = icmp eq i32 %j.088.i, %sub110
  br i1 %exitcond217.not.i, label %for.inc46.i, label %for.body39.i, !llvm.loop !147

for.inc46.i:                                      ; preds = %for.body39.i, %for.body32.i
  %indvars.iv.next219.i = add nuw nsw i64 %indvars.iv218.i, 1
  %exitcond223.not.i = icmp eq i64 %indvars.iv.next219.i, %wide.trip.count222.i
  br i1 %exitcond223.not.i, label %MSalign2m2m_rec.exit, label %for.body32.i, !llvm.loop !148
...
for.body65.i:                                     ; preds = %for.body65.i.prol.loopexit, %for.body65.i
  ...
  %indvars.iv.next96.i.3 = add nuw nsw i64 %indvars.iv95.i, 4
  %exitcond99.not.i.3 = icmp eq i64 %indvars.iv.next96.i.3, %wide.trip.count98.i
  br i1 %exitcond99.not.i.3, label %for.end72.i, label %for.body65.i, !llvm.loop !154
...
for.body145.i:                                    ; preds = %for.body145.i.prol.loopexit, %for.body145.i
  ...
  %indvars.iv.next101.i.1 = add nuw nsw i64 %indvars.iv100.i, 2
  %exitcond105.not.i.1 = icmp eq i64 %indvars.iv.next101.i.1, %wide.trip.count104.i
  br i1 %exitcond105.not.i.1, label %for.cond157.preheader.i, label %for.body145.i, !llvm.loop !173
...
for.body161.i:                                    ; preds = %for.body161.i.prol.loopexit, %for.body161.i
  ...
  %indvars.iv.next107.i.1 = add nuw nsw i64 %indvars.iv106.i, 2
  %exitcond112.not.i.1 = icmp eq i64 %indvars.iv.next107.i.1, %wide.trip.count111.i
  br i1 %exitcond112.not.i.1, label %for.end172.i, label %for.body161.i, !llvm.loop !174
...
for.body193.i:                                    ; preds = %for.body193.i.prol.loopexit, %for.body193.i
  ...
  %indvars.iv.next121.i.3 = add nuw nsw i64 %indvars.iv120.i, 4
  %exitcond125.not.i.3 = icmp eq i64 %indvars.iv.next121.i.3, %wide.trip.count111.i
  br i1 %exitcond125.not.i.3, label %for.body206.lr.ph.i, label %for.body193.i, !llvm.loop !188
...
for.body206.i:                                    ; preds = %for.body206.i.prol.loopexit, %for.body206.i
  ...
  %indvars.iv.next127.i.1 = add nuw nsw i64 %indvars.iv126.i, 2
  %exitcond132.not.i.1 = icmp eq i64 %indvars.iv.next127.i.1, %wide.trip.count111.i
  br i1 %exitcond132.not.i.1, label %for.end218.i, label %for.body206.i, !llvm.loop !189
...
if.end292.us.i:                                   ; preds = %if.then290.us.i, %for.body260.us.if.end292.us_crit_edge.i
  ...
  %mjpt.0.us.i = getelementptr inbounds float, ptr %mjpt.027.us.i, i64 1
  %exitcond146.not.i = icmp eq i64 %indvars.iv.next141.i, %wide.trip.count111.i
  br i1 %exitcond146.not.i, label %for.end321.i, label %for.body260.us.i, !llvm.loop !190
...
if.end292.i:                                      ; preds = %if.then290.i, %for.body260.i
  ...
  %mjpt.0.i = getelementptr inbounds float, ptr %mjpt.027.i, i64 1
  %exitcond139.not.i = icmp eq i64 %indvars.iv.next134.i, %wide.trip.count111.i
  br i1 %exitcond139.not.i, label %for.end321.i, label %for.body260.i, !llvm.loop !190
...
for.end321.i:                                     ; preds = %if.end292.i, %if.end292.us.i
  ...
  %indvars.iv.next148.i = add nuw nsw i64 %indvars.iv147.i, 1
  %exitcond153.not.i = icmp eq i64 %indvars.iv.next148.i, %wide.trip.count104.i
  br i1 %exitcond153.not.i, label %for.end336.i, label %for.body229.i, !llvm.loop !191
...
for.body351.i:                                    ; preds = %for.body351.i.prol.loopexit, %for.body351.i
  ...
  store float %add361.i.1, ptr %arrayidx360.i.1, align 4, !tbaa !14
  %exitcond158.not.i.1 = icmp eq i64 %indvars.iv.next155.i.1, %idxprom353.i
  br i1 %exitcond158.not.i.1, label %for.cond365.preheader.i, label %for.body351.i, !llvm.loop !210
...
for.body369.i:                                    ; preds = %for.body369.i.prol.loopexit, %for.body369.i
  ...
  store float %add379.i.1, ptr %arrayidx378.i.1, align 4, !tbaa !14
  %exitcond163.not.i.1 = icmp eq i64 %indvars.iv.next160.i.1, %wide.trip.count162.i
  br i1 %exitcond163.not.i.1, label %for.body387.i.preheader, label %for.body369.i, !llvm.loop !211
...
vector.ph633:                                     ; preds = %vector.memcheck615
  ...
  %broadcast.splat647 = shufflevector <4 x i32> %broadcast.splatinsert646, <4 x i32> poison, <4 x i32> zeroinitializer
  %339 = getelementptr float, ptr %previousw.029.i, i64 -3
  %340 = load float, ptr %arrayidx434.i, align 4, !tbaa !14, !alias.scope !222, !noalias !225
  %broadcast.splatinsert643 = insertelement <4 x float> poison, float %340, i64 0
  %broadcast.splat644 = shufflevector <4 x float> %broadcast.splatinsert643, <4 x float> poison, <4 x i32> zeroinitializer
  %341 = getelementptr float, ptr %call108.i, i64 -3
  %342 = getelementptr i32, ptr %call110.i, i64 -3
...
vector.body639:                                   ; preds = %vector.body639, %vector.ph633
  ...
  %offset.idx641 = sub i64 %wide.trip.count162.i, %index640
  %343 = getelementptr float, ptr %339, i64 %offset.idx641
  %wide.load642 = load <4 x float>, ptr %343, align 4, !tbaa !14, !alias.scope !227, !noalias !225
  %reverse = shufflevector <4 x float> %wide.load642, <4 x float> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %344 = fadd <4 x float> %reverse, %broadcast.splat644
  %345 = add i64 %offset.idx641, 4294967295
  %346 = and i64 %345, 4294967295
  %reverse645 = shufflevector <4 x float> %344, <4 x float> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
  %347 = getelementptr float, ptr %341, i64 %346
  store <4 x float> %reverse645, ptr %347, align 4, !tbaa !14, !alias.scope !225
  %348 = getelementptr i32, ptr %342, i64 %offset.idx641
  store <4 x i32> %broadcast.splat647, ptr %348, align 4, !tbaa !5
  %index.next649 = add nuw i64 %index640, 4
  %349 = icmp eq i64 %index.next649, %n.vec635
  br i1 %349, label %middle.block630, label %vector.body639, !llvm.loop !229
...
for.body408.i:                                    ; preds = %for.body408.i.prol.loopexit, %for.body408.i
  ...
  store float %add421.i.1, ptr %arrayidx420.i.1, align 4, !tbaa !14
  %exitcond173.not.i.1 = icmp eq i64 %indvars.iv.next170.i.1, %wide.trip.count162.i
  br i1 %exitcond173.not.i.1, label %for.body429.lr.ph.i, label %for.body408.i, !llvm.loop !230
...
for.body449.i:                                    ; preds = %for.inc675.i, %for.body449.lr.ph.i
  ...
  %arrayidx455.i = getelementptr inbounds float, ptr %currentw.171.i, i64 %idxprom220.i
  store float %362, ptr %arrayidx455.i, align 4, !tbaa !14
  tail call fastcc void @match_ribosum(ptr noundef %previousw.170.i, ptr noundef %call24, ptr noundef %call26, i32 noundef %indvars197.i, i32 noundef %conv8, ptr noundef %call122.i, ptr noundef %call130.i, i32 noundef 0)
  %idxprom460.i = and i64 %indvars.iv.next196.i, 4294967295
  %arrayidx461.i = getelementptr inbounds float, ptr %call104.i, i64 %idxprom460.i
  %363 = load float, ptr %arrayidx461.i, align 4, !tbaa !14
  %arrayidx464.i = getelementptr inbounds float, ptr %previousw.170.i, i64 %idxprom220.i
...
vector.body660:                                   ; preds = %for.cond682.preheader.i, %vector.body660
  ...
  %index.next665 = add nuw i64 %index661, 4
  %418 = icmp eq i64 %index.next665, %n.vec657
  br i1 %418, label %middle.block652, label %vector.body660, !llvm.loop !236
...
for.body685.i:                                    ; preds = %for.body685.i.prol.loopexit, %for.body685.i
  ...
  %indvars.iv.next200.i.3 = add nuw nsw i64 %indvars.iv199.i, 4
  %exitcond204.not.i.3 = icmp eq i64 %indvars.iv.next200.i.3, %idxprom332.i
  br i1 %exitcond204.not.i.3, label %for.cond682.for.inc697_crit_edge.i, label %for.body685.i, !llvm.loop !238

for.cond682.for.inc697_crit_edge.i:               ; preds = %for.body685.i.prol.loopexit, %for.body685.i, %middle.block652
  %indvars.iv.next206.i = add nuw nsw i64 %indvars.iv205.i, 1
  %exitcond210.not.i = icmp eq i64 %indvars.iv.next206.i, %wide.trip.count209.i
  br i1 %exitcond210.not.i, label %for.end699.i, label %for.cond682.preheader.i, !llvm.loop !239
...
; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define internal fastcc void @match_ribosum(ptr nocapture noundef %match, ptr nocapture noundef readonly %cpmx1, ptr nocapture noundef readonly %cpmx2, i32 noundef %i1, i32 noundef %lgth2, ptr nocapture noundef readonly %floatwork, ptr nocapture noundef readonly %intwork, i32 noundef %initialize) unnamed_addr #8 {
entry:
