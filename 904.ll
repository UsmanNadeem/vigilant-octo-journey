; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/recon.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/recon.c"
...
vector.memcheck852:                               ; preds = %iter.check863
  ...
  %9 = add i64 %6, %8
  %uglygep856 = getelementptr i8, ptr %src, i64 %9
  %10 = add i64 %3, %8
  %uglygep855 = getelementptr i8, ptr %dst, i64 %10
  %bound0857 = icmp ult ptr %d.0527.us, %uglygep856
  %bound1858 = icmp ult ptr %s.0526.us, %uglygep855
...
vector.memcheck765:                               ; preds = %iter.check782
  ...
  %81 = add i64 %78, %80
  %uglygep771 = getelementptr i8, ptr %src, i64 %81
  %82 = add i64 %76, %80
  %uglygep770 = getelementptr i8, ptr %src, i64 %82
  %83 = add i64 %75, %80
  %uglygep769 = getelementptr i8, ptr %src, i64 %83
  %84 = add i64 %72, %80
  %uglygep768 = getelementptr i8, ptr %dst, i64 %84
  %bound0772 = icmp ult ptr %d.2515.us, %uglygep770
  %bound1773 = icmp ult ptr %uglygep769, %uglygep768
  %found.conflict774 = and i1 %bound0772, %bound1773
  %bound0775 = icmp ult ptr %d.2515.us, %uglygep771
  %bound1776 = icmp ult ptr %s.2514.us, %uglygep768
...
vector.memcheck:                                  ; preds = %iter.check
  ...
  %194 = add i64 %191, %193
  %uglygep613 = getelementptr i8, ptr %src, i64 %194
  %195 = add i64 %187, %193
  %uglygep = getelementptr i8, ptr %dst, i64 %195
  %bound0 = icmp ult ptr %d.4491.us, %uglygep613
  %bound1 = icmp ult ptr %s.4490.us, %uglygep
...
vector.memcheck625:                               ; preds = %iter.check636
  ...
  %245 = add i64 %242, %244
  %uglygep629 = getelementptr i8, ptr %src, i64 %245
  %246 = add i64 %238, %244
  %uglygep628 = getelementptr i8, ptr %dst, i64 %246
  %bound0630 = icmp ult ptr %d.5497.us, %uglygep629
  %bound1631 = icmp ult ptr %s.5496.us, %uglygep628
...
vector.memcheck666:                               ; preds = %iter.check682
  ...
  %298 = add i64 %296, %297
  %uglygep672 = getelementptr i8, ptr %src, i64 %298
  %299 = add i64 %293, %297
  %uglygep671 = getelementptr i8, ptr %src, i64 %299
  %300 = add i64 %291, %297
  %uglygep670 = getelementptr i8, ptr %src, i64 %300
  %301 = add i64 %288, %297
  %uglygep669 = getelementptr i8, ptr %dst, i64 %301
  %bound0673 = icmp ult ptr %d.6503.us, %uglygep671
  %bound1674 = icmp ult ptr %uglygep670, %uglygep669
  %found.conflict675 = and i1 %bound0673, %bound1674
  %bound0676 = icmp ult ptr %d.6503.us, %uglygep672
  %bound1677 = icmp ult ptr %s.6502.us, %uglygep669
...
vector.memcheck716:                               ; preds = %iter.check733
  ...
  %367 = add i64 %365, %366
  %uglygep722 = getelementptr i8, ptr %src, i64 %367
  %368 = add i64 %362, %366
  %uglygep721 = getelementptr i8, ptr %src, i64 %368
  %369 = add i64 %360, %366
  %uglygep720 = getelementptr i8, ptr %src, i64 %369
  %370 = add i64 %357, %366
  %uglygep719 = getelementptr i8, ptr %dst, i64 %370
  %bound0723 = icmp ult ptr %d.7509.us, %uglygep721
  %bound1724 = icmp ult ptr %uglygep720, %uglygep719
  %found.conflict725 = and i1 %bound0723, %bound1724
  %bound0726 = icmp ult ptr %d.7509.us, %uglygep722
  %bound1727 = icmp ult ptr %s.7508.us, %uglygep719
