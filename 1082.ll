; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/good.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/good.c"
...
lor.lhs.false:                                    ; preds = %if.then8
  %call10 = call i32 @cap_ok(ptr noundef nonnull %w, ptr noundef nonnull @hits, i32 noundef %conv)
...
land.lhs.true21:                                  ; preds = %land.lhs.true
  ...
  %7 = load i64, ptr %mask, align 8, !tbaa !16
...
if.then38:                                        ; preds = %if.end35
  ...
  %call.i = call i32 @_IO_putc(i32 noundef 10, ptr noundef %10)
  br label %if.end40
...
if.end:                                           ; preds = %if.then2, %if.then3
  ...
  %3 = load ptr, ptr %suffix, align 8, !tbaa !23
...
cond.true:                                        ; preds = %if.end
  ...
  %4 = load i16, ptr %affl10, align 4, !tbaa !19
...
for.cond.us:                                      ; preds = %for.cond.us.preheader, %if.end118.us
  ...
  %5 = load i64, ptr %mask.us, align 8, !tbaa !16
...
if.else26.us:                                     ; preds = %for.cond.us
  ...
  %6 = load ptr, ptr %word35.us, align 8, !tbaa !24
...
for.inc.us:                                       ; preds = %for.body.us
  ...
  br i1 %cmp44.us, label %for.body.us, label %while.cond.us.preheader, !llvm.loop !26
...
for.cond89.us:                                    ; preds = %for.body91.us
  ...
  br i1 %tobool90.not.us, label %if.end112.us, label %for.body91.us, !llvm.loop !27
...
for.cond101.us:                                   ; preds = %for.body103.us
  ...
  br i1 %tobool102.not.us, label %if.end112.us, label %for.body103.us, !llvm.loop !28
...
if.end112.us:                                     ; preds = %for.cond89.us, %for.cond101.us, %for.cond89.preheader.us, %for.cond101.preheader.us
  %20 = load ptr, ptr %prefix.i285, align 8, !tbaa !18
...
land.lhs.true.i216.us:                            ; preds = %if.end112.us
  %21 = load i64, ptr %mask.us, align 8, !tbaa !16
  %flagbit.i210.us = getelementptr inbounds %struct.flagent, ptr %20, i64 0, i32 2
  %22 = load i16, ptr %flagbit.i210.us, align 8, !tbaa !29
...
if.end.i219.us:                                   ; preds = %land.lhs.true.i216.us, %if.end112.us
  %23 = load ptr, ptr %suffix.i286, align 8, !tbaa !23
...
land.lhs.true4.i227.us:                           ; preds = %if.end.i219.us
  %24 = load i64, ptr %mask.us, align 8, !tbaa !16
  %flagbit8.i221.us = getelementptr inbounds %struct.flagent, ptr %23, i64 0, i32 2
  %25 = load i16, ptr %flagbit8.i221.us, align 8, !tbaa !29
...
while.body.us:                                    ; preds = %while.cond.us
  ...
  br i1 %cmp80.not.us, label %while.cond.us, label %if.end118.us, !llvm.loop !30
...
if.end118.us:                                     ; preds = %for.body.us, %for.body55.us, %while.body.us, %for.body91.us, %for.body103.us, %for.cond.us, %land.lhs.true4.i227.us, %land.lhs.true.i216.us
  %30 = load i64, ptr %mask.us, align 8, !tbaa !16
...
for.inc61.us:                                     ; preds = %for.body55.us
  ...
  br i1 %cmp53.us, label %for.body55.us, label %while.cond.us.preheader, !llvm.loop !31
...
for.cond.us255:                                   ; preds = %if.end13.split, %if.end118.us265
  ...
  %31 = load i64, ptr %mask.us258, align 8, !tbaa !16
...
if.else26.us264:                                  ; preds = %for.cond.us255
  %32 = load ptr, ptr %prefix.i, align 8, !tbaa !18
...
land.lhs.true.i192.us:                            ; preds = %if.else26.us264
  ...
  %33 = load i16, ptr %flagbit.i186.us, align 8, !tbaa !29
...
if.end.i195.us:                                   ; preds = %land.lhs.true.i192.us, %if.else26.us264
  %34 = load ptr, ptr %suffix.i, align 8, !tbaa !23
...
land.lhs.true4.i203.us:                           ; preds = %if.end.i195.us
  ...
  %35 = load i16, ptr %flagbit8.i197.us, align 8, !tbaa !29
...
for.cond:                                         ; preds = %if.end13.split, %if.end118
  ...
  %36 = load i64, ptr %mask, align 8, !tbaa !16
...
if.end.i:                                         ; preds = %land.lhs.true.i, %land.lhs.true21
  %39 = load ptr, ptr %suffix.i, align 8, !tbaa !23
...
land.lhs.true4.i:                                 ; preds = %if.end.i
  ...
  %40 = load i16, ptr %flagbit8.i, align 8, !tbaa !29
...
if.else26:                                        ; preds = %for.cond
  %41 = load ptr, ptr %prefix.i, align 8, !tbaa !18
...
land.lhs.true.i192:                               ; preds = %if.else26
  ...
  %42 = load i16, ptr %flagbit.i186, align 8, !tbaa !29
...
if.end.i195:                                      ; preds = %land.lhs.true.i192, %if.else26
  %43 = load ptr, ptr %suffix.i, align 8, !tbaa !23
...
land.lhs.true4.i203:                              ; preds = %if.end.i195
  ...
  %44 = load i16, ptr %flagbit8.i197, align 8, !tbaa !29
...
for.cond:                                         ; preds = %for.body
  ...
  br i1 %cmp5, label %for.body, label %if.end26, !llvm.loop !32
...
for.cond11:                                       ; preds = %for.body16
  ...
  br i1 %cmp14, label %for.body16, label %if.end26, !llvm.loop !33
...
for.cond39:                                       ; preds = %for.body43
  ...
  br i1 %cmp41.not, label %if.end72, label %for.body43, !llvm.loop !34
...
for.cond58:                                       ; preds = %for.body62
  ...
  br i1 %cmp60.not, label %if.end72, label %for.body62, !llvm.loop !35
...
if.end72:                                         ; preds = %for.cond39, %for.cond58, %for.cond39.preheader, %for.cond58.preheader, %if.end26
  ...
  %call.i = tail call i32 @_IO_putc(i32 noundef 32, ptr noundef %16)
...
while.body:                                       ; preds = %while.cond.preheader, %while.body
  ...
  br i1 %cmp80, label %while.body, label %if.end99, !llvm.loop !36
...
while.body91:                                     ; preds = %while.cond87.preheader, %while.body91
  ...
  br i1 %cmp89, label %while.body91, label %if.end99, !llvm.loop !37
...
for.body105:                                      ; preds = %if.end99, %for.body105
  ...
  br i1 %cmp103, label %for.body105, label %for.end112, !llvm.loop !38
...
while.body127:                                    ; preds = %while.cond125.preheader, %while.body127
  ...
  br i1 %tobool126.not, label %if.end135, label %while.body127, !llvm.loop !39

if.end135:                                        ; preds = %while.body127, %while.cond125.preheader, %if.then121
  %37 = load i8, ptr getelementptr inbounds (%struct.hashheader, ptr @hashheader, i64 0, i32 19), align 4, !tbaa !40
  %conv136 = sext i8 %37 to i32
  %38 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call.i186 = tail call i32 @_IO_putc(i32 noundef %conv136, ptr noundef %38)
  br i1 %cmp, label %if.then140, label %if.end142

if.then140:                                       ; preds = %if.end135
  %39 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call.i187 = tail call i32 @_IO_putc(i32 noundef %preflag, ptr noundef %39)
  br label %if.end142
...
if.then145:                                       ; preds = %if.end142
  ...
  %call.i188 = tail call i32 @_IO_putc(i32 noundef %sufflag, ptr noundef %40)
  br label %cleanup
...
!18 = !{!15, !13, i64 8}
!19 = !{!20, !21, i64 20}
!20 = !{!"flagent", !13, i64 0, !13, i64 8, !21, i64 16, !21, i64 18, !21, i64 20, !21, i64 22, !21, i64 24, !6, i64 26}
!21 = !{!"short", !6, i64 0}
!22 = !{!20, !21, i64 18}
!23 = !{!15, !13, i64 16}
!24 = !{!25, !13, i64 8}
!25 = !{!"dent", !13, i64 0, !13, i64 8, !6, i64 16}
!26 = distinct !{!26, !9}
!27 = distinct !{!27, !9}
!28 = distinct !{!28, !9}
!29 = !{!20, !21, i64 16}
...
!39 = distinct !{!39, !9}
!40 = !{!41, !6, i64 68}
!41 = !{!"hashheader", !21, i64 0, !21, i64 2, !21, i64 4, !21, i64 6, !21, i64 8, !21, i64 10, !11, i64 12, !11, i64 16, !11, i64 20, !11, i64 24, !11, i64 28, !11, i64 32, !11, i64 36, !11, i64 40, !11, i64 44, !6, i64 48, !6, i64 53, !6, i64 66, !6, i64 67, !6, i64 68, !6, i64 70, !6, i64 526, !6, i64 754, !6, i64 982, !6, i64 1210, !6, i64 1438, !6, i64 1666, !6, i64 1894, !6, i64 2022, !6, i64 3124, !6, i64 3524, !21, i64 3924}
