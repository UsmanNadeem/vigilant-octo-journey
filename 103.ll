; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/support.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/archie-client/support.c"
...
; Function Attrs: nounwind uwtable
define dso_local i32 @ul_insert(ptr noundef %ul, ptr noundef %vd, ptr noundef %p) local_unnamed_addr #0 {
entry:
...
if.then:                                          ; preds = %entry
  %call = tail call i32 @ul_insert(ptr noundef nonnull %vl, ptr noundef %vd, ptr noundef null)
  br label %cleanup

if.end:                                           ; preds = %entry
  %links = getelementptr inbounds %struct.vdir, ptr %vd, i64 0, i32 5
  %1 = load ptr, ptr %links, align 8, !tbaa !21
  %cmp3 = icmp eq ptr %1, null
  br i1 %cmp3, label %if.then5, label %if.end7

if.then5:                                         ; preds = %if.end
  store ptr %vl, ptr %links, align 8, !tbaa !21
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %previous, i8 0, i64 16, i1 false)
  store ptr %vl, ptr %lastlink, align 8, !tbaa !22
  br label %cleanup
...
if.then10:                                        ; preds = %if.end7
  ...
  %2 = load ptr, ptr %lastlink11, align 8, !tbaa !22
...
while.body:                                       ; preds = %while.cond
  ...
  br i1 %tobool.not, label %if.then35, label %while.cond, !llvm.loop !23
...
if.then35:                                        ; preds = %while.body
  ...
  store ptr %vl, ptr %lastlink39, align 8, !tbaa !22
  br label %cleanup
...
if.end47:                                         ; preds = %if.then43
  ...
  %5 = load i64, ptr %f_magic_no, align 8, !tbaa !24
...
land.lhs.true:                                    ; preds = %if.end47
  ...
  %6 = load i64, ptr %f_magic_no50, align 8, !tbaa !24
...
if.then61:                                        ; preds = %if.end57
  store i64 -1, ptr %f_magic_no58, align 8, !tbaa !24
  br label %if.end63
...
if.end63:                                         ; preds = %if.end57.thread, %if.then61, %if.end57
  ...
  %8 = load ptr, ptr %replicas, align 8, !tbaa !25
...
if.then65:                                        ; preds = %if.end63
  store ptr %vl, ptr %replicas, align 8, !tbaa !25
...
while.body72:                                     ; preds = %while.cond69.preheader, %if.end82
  ...
  %12 = load i64, ptr %f_magic_no73, align 8, !tbaa !24
...
if.then80:                                        ; preds = %while.body72
  ...
  store i64 %dec, ptr %f_magic_no58196, align 8, !tbaa !24
  br label %if.end82
...
if.end82:                                         ; preds = %if.then80, %while.body72
  ...
  br i1 %tobool71.not, label %while.end84, label %while.body72, !llvm.loop !26
...
while.end84:                                      ; preds = %if.end82, %while.cond69.preheader
  ...
  %16 = load i64, ptr %f_magic_no85, align 8, !tbaa !24
...
if.then92:                                        ; preds = %while.end84
  ...
  store i64 %dec94, ptr %f_magic_no58196, align 8, !tbaa !24
  br label %if.end95
...
while.body:                                       ; preds = %while.cond
  ...
  br i1 %cmp9, label %cleanup, label %while.cond, !llvm.loop !27
...
if.then3:                                         ; preds = %if.end
  store i32 251, ptr @perrno, align 4, !tbaa !29
  ...
  %0 = load i32, ptr @perrno, align 4, !tbaa !29
  br label %return
...
if.then13:                                        ; preds = %if.then8
  store i32 1, ptr @pwarn, align 4, !tbaa !29
  br label %return
...
if.then17:                                        ; preds = %if.end14
  store i32 2, ptr @pwarn, align 4, !tbaa !29
  br label %return

if.end18:                                         ; preds = %if.end14
  store i32 255, ptr @pwarn, align 4, !tbaa !29
...
if.end27:                                         ; preds = %if.then24, %if.then22
  store i32 253, ptr @perrno, align 4, !tbaa !29
  br label %return
...
if.then31:                                        ; preds = %if.else28
  %2 = load i32, ptr @pwarn, align 4, !tbaa !29
  %cmp32 = icmp eq i32 %2, 0
  br i1 %cmp32, label %if.then33, label %return

if.then33:                                        ; preds = %if.then31
  store i8 0, ptr @p_warn_string, align 1, !tbaa !5
  store i32 3, ptr @pwarn, align 4, !tbaa !29
...
if.then41:                                        ; preds = %if.end38
  store i32 255, ptr @perrno, align 4, !tbaa !29
  br label %return
...
if.then47:                                        ; preds = %if.end42
  store i32 244, ptr @perrno, align 4, !tbaa !29
  br label %return
...
if.then51:                                        ; preds = %if.else48
  store i32 243, ptr @perrno, align 4, !tbaa !29
  br label %return
...
if.then55:                                        ; preds = %if.else52
  store i32 247, ptr @perrno, align 4, !tbaa !29
  br label %return
...
if.then59:                                        ; preds = %if.else56
  store i32 248, ptr @perrno, align 4, !tbaa !29
  br label %return
...
if.then63:                                        ; preds = %if.else60
  store i32 254, ptr @perrno, align 4, !tbaa !29
  br label %return
...
if.then67:                                        ; preds = %if.else64
  store i32 246, ptr @perrno, align 4, !tbaa !29
  br label %return
...
if.then9:                                         ; preds = %if.then
  store i32 252, ptr @perrno, align 4, !tbaa !29
  br label %cleanup97
...
if.end39.sink.split:                              ; preds = %if.else29, %if.else23, %if.else, %if.then13
  ...
  store i8 %.sink, ptr %call11, align 8, !tbaa !30
  br label %if.end39
...
if.end39:                                         ; preds = %if.end39.sink.split, %if.else29, %if.end10
  ...
  store ptr %call41, ptr %aname, align 8, !tbaa !32
  ...
  store ptr %call43, ptr %avtype, align 8, !tbaa !33
...
if.then66:                                        ; preds = %if.then54
  ...
  store ptr %call68, ptr %type, align 8, !tbaa !34
...
if.end7.i:                                        ; preds = %if.then5.i, %while.cond.i
  ...
  br i1 %tobool8.not.i, label %while.cond.i, label %if.then9.i, !llvm.loop !35
...
if.then9.i:                                       ; preds = %if.end7.i
  ...
  br label %while.cond.i.outer, !llvm.loop !35
...
if.end7:                                          ; preds = %while.cond, %if.then5
  ...
  br i1 %tobool8.not, label %while.cond, label %if.then9, !llvm.loop !35
...
!29 = !{!12, !12, i64 0}
!30 = !{!31, !6, i64 0}
!31 = !{!"pattrib", !6, i64 0, !14, i64 8, !14, i64 16, !6, i64 24, !14, i64 32, !14, i64 40}
!32 = !{!31, !14, i64 8}
!33 = !{!31, !14, i64 16}
!34 = !{!16, !14, i64 24}
!35 = distinct !{!35, !9}
