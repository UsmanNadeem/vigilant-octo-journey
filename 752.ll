; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/ialloc.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/ialloc.c"
...
vector.scevcheck:                                 ; preds = %while.body.preheader
  ...
  %uglygep = getelementptr i8, ptr %obj, i64 %8
  %9 = sub i64 0, %7
  %10 = getelementptr i8, ptr %uglygep, i64 %9
  %11 = icmp ugt ptr %10, %uglygep
  %12 = add nsw i64 %idx.ext, -1
  %uglygep62 = getelementptr i8, ptr %obj, i64 %12
  %13 = sub i64 0, %7
  %14 = getelementptr i8, ptr %uglygep62, i64 %13
  %15 = icmp ugt ptr %14, %uglygep62
  %16 = or i1 %11, %15
