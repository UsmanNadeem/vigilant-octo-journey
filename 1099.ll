; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/Windows/FileDir.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/Windows/FileDir.cpp"
...
if.end11:                                         ; preds = %if.end
  %cmp13 = icmp ult i32 %0, 128
  br i1 %cmp13, label %land.lhs.true, label %if.end34

land.lhs.true:                                    ; preds = %if.end11
  %arrayidx14 = getelementptr inbounds i32, ptr %name, i64 1
  %2 = load i32, ptr %arrayidx14, align 4, !tbaa !5
  %cmp15 = icmp eq i32 %2, 58
  br i1 %cmp15, label %if.then16, label %if.end34

if.then16:                                        ; preds = %land.lhs.true
  %cmp18.not = icmp ult i32 %conv, %len
  br i1 %cmp18.not, label %if.end20, label %return

if.end20:                                         ; preds = %if.then16
  %call21 = tail call ptr @wcscpy(ptr noundef %buffer, ptr noundef nonnull %name) #22
  store ptr %buffer, ptr %lastpart, align 8, !tbaa !25
  br label %while.cond23

while.cond23:                                     ; preds = %if.end29, %if.end20
  %ptr22.0 = phi ptr [ %buffer, %if.end20 ], [ %incdec.ptr30, %if.end29 ]
  %3 = load i32, ptr %ptr22.0, align 4, !tbaa !5
  switch i32 %3, label %if.end29 [
    i32 0, label %return
    i32 47, label %if.then27
  ]

if.then27:                                        ; preds = %while.cond23
  %add.ptr28 = getelementptr inbounds i32, ptr %ptr22.0, i64 1
  store ptr %add.ptr28, ptr %lastpart, align 8, !tbaa !25
  br label %if.end29

if.end29:                                         ; preds = %while.cond23, %if.then27
  %incdec.ptr30 = getelementptr inbounds i32, ptr %ptr22.0, i64 1
  br label %while.cond23, !llvm.loop !27

if.end34:                                         ; preds = %land.lhs.true, %if.end11
  %cmp35 = icmp ult i32 %len, 2
...
if.end37:                                         ; preds = %if.end34
  ...
  %arrayidx40 = getelementptr inbounds [1024 x i8], ptr %begin, i64 0, i64 1
  store i8 58, ptr %arrayidx40, align 1, !tbaa !20
  %add.ptr41 = getelementptr inbounds i8, ptr %begin, i64 2
  %call42 = call ptr @getcwd(ptr noundef nonnull %add.ptr41, i64 noundef 1021) #22
  %tobool43.not = icmp eq ptr %call42, null
  br i1 %tobool43.not, label %cleanup76, label %if.end48

if.end48:                                         ; preds = %if.end37
  %call46 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %begin) #25
  %conv47 = trunc i64 %call46 to i32
  %cmp49.not = icmp eq i32 %conv47, 0
  br i1 %cmp49.not, label %cleanup76, label %if.then50

if.then50:                                        ; preds = %if.end48
  %add51 = add i32 %conv, 1
  %add52 = add i32 %add51, %conv47
  %cmp53.not = icmp ult i32 %add52, %len
  br i1 %cmp53.not, label %if.end55, label %cleanup76
...
for.cond.i.i:                                     ; preds = %for.cond.i.i, %if.end55
  %indvars.iv.i.i = phi i64 [ %indvars.iv.next.i.i, %for.cond.i.i ], [ 0, %if.end55 ]
...
_ZN11CStringBaseIcED2Ev.exit:                     ; preds = %invoke.cont, %delete.notnull.i
  ...
  %call60 = call ptr @wcscpy(ptr noundef %buffer, ptr noundef %8) #22
  %call61 = call ptr @wcscat(ptr noundef %buffer, ptr noundef nonnull @.str.1) #22
  %call62 = call ptr @wcscat(ptr noundef %buffer, ptr noundef nonnull %name) #22
  %idx.ext = and i64 %call46, 4294967295
  %add.ptr63 = getelementptr inbounds i32, ptr %buffer, i64 %idx.ext
  %add.ptr64 = getelementptr inbounds i32, ptr %add.ptr63, i64 1
  store ptr %add.ptr64, ptr %lastpart, align 8, !tbaa !25
  br label %while.cond66

while.cond66:                                     ; preds = %if.end72, %_ZN11CStringBaseIcED2Ev.exit
  %ptr65.0 = phi ptr [ %buffer, %_ZN11CStringBaseIcED2Ev.exit ], [ %incdec.ptr73, %if.end72 ]
  %9 = load i32, ptr %ptr65.0, align 4, !tbaa !5
  switch i32 %9, label %if.end72 [
    i32 0, label %while.end74
    i32 47, label %if.then70
  ]

if.then70:                                        ; preds = %while.cond66
  %add.ptr71 = getelementptr inbounds i32, ptr %ptr65.0, i64 1
  store ptr %add.ptr71, ptr %lastpart, align 8, !tbaa !25
  br label %if.end72
...
lpad:                                             ; preds = %_ZN11CStringBaseIcEC2EPKc.exit
  ...
  %isnull.i132 = icmp eq ptr %11, null
  br i1 %isnull.i132, label %_ZN11CStringBaseIcED2Ev.exit134, label %delete.notnull.i133

delete.notnull.i133:                              ; preds = %lpad
  call void @_ZdaPv(ptr noundef nonnull %11) #24
  br label %_ZN11CStringBaseIcED2Ev.exit134

_ZN11CStringBaseIcED2Ev.exit134:                  ; preds = %lpad, %delete.notnull.i133
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp) #22
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %wbegin) #22
  call void @llvm.lifetime.end.p0(i64 1024, ptr nonnull %begin) #22
  resume { ptr, i32 } %10

if.end72:                                         ; preds = %while.cond66, %if.then70
  %incdec.ptr73 = getelementptr inbounds i32, ptr %ptr65.0, i64 1
  br label %while.cond66, !llvm.loop !28

while.end74:                                      ; preds = %while.cond66
  %12 = load ptr, ptr %wbegin, align 8, !tbaa !11
  %isnull.i135 = icmp eq ptr %12, null
  br i1 %isnull.i135, label %_ZN11CStringBaseIwED2Ev.exit, label %delete.notnull.i136

delete.notnull.i136:                              ; preds = %while.end74
  call void @_ZdaPv(ptr noundef nonnull %12) #24
  br label %_ZN11CStringBaseIwED2Ev.exit

_ZN11CStringBaseIwED2Ev.exit:                     ; preds = %while.end74, %delete.notnull.i136
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %wbegin) #22
  br label %cleanup76

cleanup76:                                        ; preds = %if.end37, %_ZN11CStringBaseIwED2Ev.exit, %if.end48, %if.then50
  %retval.2 = phi i32 [ 0, %if.then50 ], [ %add52, %_ZN11CStringBaseIwED2Ev.exit ], [ 0, %if.end48 ], [ 0, %if.end37 ]
  call void @llvm.lifetime.end.p0(i64 1024, ptr nonnull %begin) #22
  br label %return

return:                                           ; preds = %while.cond23, %while.cond, %cleanup76, %if.then2, %if.then16, %if.end34, %entry
  %retval.4 = phi i32 [ 0, %entry ], [ %retval.2, %cleanup76 ], [ 0, %if.then2 ], [ 0, %if.then16 ], [ 0, %if.end34 ], [ %add, %while.cond ], [ %conv, %while.cond23 ]
  ret i32 %retval.4
}
...
if.end:                                           ; preds = %invoke.cont14
  ...
  %call.i = call i32 @__xstat64(i32 noundef 1, ptr noundef nonnull %0, ptr noundef nonnull %info_file) #22
...
if.end27:                                         ; preds = %if.end
  ...
  %and = and i32 %8, %7
  %call26 = call i32 @chmod(ptr noundef %1, i32 noundef %and) #22
...
if.end33:                                         ; preds = %if.end27
  %call32 = call i32 @unlink(ptr noundef %0) #22
...
_ZL16nameWindowToUnixPKc.exit:                    ; preds = %_ZN11CStringBaseIwED2Ev.exit, %land.lhs.true.i
  ...
  %call.i = call i32 @__xstat64(i32 noundef 1, ptr noundef nonnull %retval.0.i, ptr noundef nonnull %oldbuf) #22
...
if.end38:                                         ; preds = %invoke.cont34, %if.end19
  %call39 = call i32 @utime(ptr noundef nonnull %retval.0.i, ptr noundef nonnull %buf) #22
...
if.then2:                                         ; preds = %if.end
  %call.i85 = call i32 @__lxstat64(i32 noundef 1, ptr noundef nonnull %1, ptr noundef nonnull %stat_info) #22
  %cmp.not = icmp eq i32 %call.i85, 0
  br i1 %cmp.not, label %if.end12, label %cleanup

if.else:                                          ; preds = %if.end
  %call.i86 = call i32 @__xstat64(i32 noundef 1, ptr noundef nonnull %1, ptr noundef nonnull %stat_info) #22
  %cmp9.not = icmp eq i32 %call.i86, 0
...
if.then14:                                        ; preds = %if.end12
  ...
  store i32 %shr, ptr %st_mode, align 8, !tbaa !41
...
if.then18:                                        ; preds = %if.then14
  %call.i87 = call ptr @fopen64(ptr noundef %1, ptr noundef nonnull @.str.10)
...
if.then.i:                                        ; preds = %if.then18
  ...
  %call1.i = call ptr @fgets(ptr noundef nonnull %buf.i, i32 noundef 1024, ptr noundef nonnull %call.i87)
  %call2.i = call i32 @fclose(ptr noundef nonnull %call.i87)
...
if.then4.i:                                       ; preds = %if.then.i
  ...
  br i1 %cmp.i, label %invoke.cont21, label %invoke.cont21.thread93

invoke.cont21.thread93:                           ; preds = %if.then4.i
...
if.then40:                                        ; preds = %if.then14
  %or = or i32 %shr, 448
  store i32 %or, ptr %st_mode, align 8, !tbaa !41
...
if.else50:                                        ; preds = %if.end12
  ...
  %trunc96 = and i16 %4, -4096
  switch i16 %trunc96, label %if.else64 [
...
if.then67:                                        ; preds = %if.else64
  %and69 = and i32 %3, -147
  store i32 %and69, ptr %st_mode51, align 8, !tbaa !41
  br label %if.end78.sink.split

if.end78.sink.split:                              ; preds = %if.else64, %if.then67, %if.else50, %if.then14, %if.then40
  %.sink97 = phi i32 [ %or, %if.then40 ], [ %shr, %if.then14 ], [ %3, %if.else50 ], [ %and69, %if.then67 ], [ %3, %if.else64 ]
  %5 = load i32, ptr @_ZL9gbl_umask.1, align 4, !tbaa !45
  %and74 = and i32 %5, %.sink97
  %call75 = call i32 @chmod(ptr noundef %1, i32 noundef %and74) #22
  br label %if.end78

if.end78:                                         ; preds = %if.end78.sink.split, %if.else50, %if.then14, %invoke.cont21
  br label %cleanup

cleanup:                                          ; preds = %invoke.cont21.thread93, %invoke.cont21, %if.end78, %cleanup.i, %if.then18, %if.else, %if.then2
  %retval.0 = phi i1 [ false, %if.else ], [ false, %if.then2 ], [ false, %invoke.cont21.thread93 ], [ false, %invoke.cont21 ], [ true, %if.end78 ], [ false, %cleanup.i ], [ false, %if.then18 ]
  call void @llvm.lifetime.end.p0(i64 144, ptr nonnull %stat_info) #22
  %isnull.i88 = icmp eq ptr %1, null
  br i1 %isnull.i88, label %_ZN11CStringBaseIcED2Ev.exit90, label %delete.notnull.i89

delete.notnull.i89:                               ; preds = %cleanup
  call void @_ZdaPv(ptr noundef nonnull %1) #24
  br label %_ZN11CStringBaseIcED2Ev.exit90

_ZN11CStringBaseIcED2Ev.exit90:                   ; preds = %cleanup, %delete.notnull.i89
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %name) #22
  br label %return

return:                                           ; preds = %_ZN11CStringBaseIcED2Ev.exit90, %if.then
  %retval.1 = phi i1 [ %retval.0, %_ZN11CStringBaseIcED2Ev.exit90 ], [ false, %if.then ]
  ret i1 %retval.1
}
...
if.then4.i:                                       ; preds = %if.end
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr align 4 %add.ptr.i.i, ptr align 4 %add.ptr4.i.i, i64 %mul.i.i, i1 false)
...
if.end.i.i142:                                    ; preds = %while.cond.i.i.i56
  ...
  %cmp13.i.i136 = icmp eq i32 %delta.0.i.i134, 0
  %delta.1.i.i138 = select i1 %cmp13.i.i136, i32 1, i32 %delta.0.i.i134
...
_ZN11CStringBaseIwED2Ev.exit:                     ; preds = %_ZN11CStringBaseIcED2Ev.exit, %delete.notnull.i85
  ...
  %call23 = call ptr @fopen64(ptr noundef %27, ptr noundef nonnull @.str.6)
...
; Function Attrs: nounwind
declare i32 @__xstat64(i32 noundef, ptr noundef, ptr noundef) local_unnamed_addr #4

; Function Attrs: nofree nounwind
declare noundef i32 @rmdir(ptr nocapture noundef readonly) local_unnamed_addr #6

; Function Attrs: nounwind
declare i32 @__lxstat64(i32 noundef, ptr noundef, ptr noundef) local_unnamed_addr #4
