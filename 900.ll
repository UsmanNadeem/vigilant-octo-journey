; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/rdbmp.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/rdbmp.c"
...
for.body.i:                                       ; preds = %read_byte.exit82.i, %for.body.lr.ph.i
  ...
  %call.i.i = tail call i32 @_IO_getc(ptr noundef %86)
...
read_byte.exit.i:                                 ; preds = %if.then.i.i, %for.body.i
  ...
  %call.i70.i = tail call i32 @_IO_getc(ptr noundef %92)
...
read_byte.exit75.i:                               ; preds = %if.then.i74.i, %read_byte.exit.i
  ...
  %call.i77.i = tail call i32 @_IO_getc(ptr noundef %98)
...
for.body18.i:                                     ; preds = %read_byte.exit110.i, %for.body18.lr.ph.i
  ...
  %call.i84.i = tail call i32 @_IO_getc(ptr noundef %104)
...
read_byte.exit89.i:                               ; preds = %if.then.i88.i, %for.body18.i
  ...
  %call.i91.i = tail call i32 @_IO_getc(ptr noundef %110)
...
read_byte.exit96.i:                               ; preds = %if.then.i95.i, %read_byte.exit89.i
  ...
  %call.i98.i = tail call i32 @_IO_getc(ptr noundef %116)
...
read_byte.exit103.i:                              ; preds = %if.then.i102.i, %read_byte.exit96.i
  ...
  %call.i105.i = tail call i32 @_IO_getc(ptr noundef %122)
...
while.body:                                       ; preds = %while.body.lr.ph, %read_byte.exit
  ...
  %call.i = tail call i32 @_IO_getc(ptr noundef %131)
...
for.body11.us:                                    ; preds = %for.body11.us.preheader, %if.end17.us
  ...
  %call12.us = tail call i32 @_IO_getc(ptr noundef %0)
...
for.body11:                                       ; preds = %for.body11.preheader, %if.end17
  ...
  %call12 = tail call i32 @_IO_getc(ptr noundef %0)
