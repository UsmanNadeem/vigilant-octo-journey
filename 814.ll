; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/loadpg.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/loadpg.c"
...
for.body:                                         ; preds = %for.body.preheader, %if.end92
  ...
  %call = call i32 @identify2(ptr noundef nonnull %node1, ptr noundef nonnull %node2, i32 noundef %8, ptr noundef nonnull %bound1, ptr noundef nonnull %bound2, ptr noundef nonnull %gptr)
...
if.end15:                                         ; preds = %for.body
  ...
  %29 = load i32, ptr %capacity16, align 8, !tbaa !16
...
if.then19:                                        ; preds = %if.end15
  ...
  store i32 1000000000, ptr %length, align 8, !tbaa !18
  %cost = getelementptr inbounds %struct.gnode, ptr %28, i64 0, i32 3
  store i32 1000000000, ptr %cost, align 4, !tbaa !19
...
while.cond:                                       ; preds = %while.cond, %if.then19
  ...
  %34 = load i32, ptr %storemerge412, align 8, !tbaa !20
  %cmp20.not = icmp eq i32 %34, %30
  %next = getelementptr inbounds %struct.gnode, ptr %storemerge412, i64 0, i32 7
  br i1 %cmp20.not, label %while.end, label %while.cond, !llvm.loop !21
...
while.end:                                        ; preds = %while.cond
  ...
  store i32 1000000000, ptr %length21, align 8, !tbaa !18
  %cost22 = getelementptr inbounds %struct.gnode, ptr %storemerge412, i64 0, i32 3
  store i32 1000000000, ptr %cost22, align 4, !tbaa !19
  br label %if.end69
...
if.then27:                                        ; preds = %if.else23
  ...
  %37 = load ptr, ptr %next28, align 8, !tbaa !23
...
while.cond34:                                     ; preds = %if.else23, %while.cond34
  ...
  %38 = load ptr, ptr %next35, align 8, !tbaa !23
  %cmp36.not = icmp eq ptr %38, %28
  br i1 %cmp36.not, label %while.end39, label %while.cond34, !llvm.loop !24
...
while.end39:                                      ; preds = %while.cond34
  ...
  %39 = load ptr, ptr %next40, align 8, !tbaa !23
  store ptr %39, ptr %next35.le, align 8, !tbaa !23
...
if.then47:                                        ; preds = %if.end42
  ...
  %43 = load ptr, ptr %next52, align 8, !tbaa !23
...
while.cond58:                                     ; preds = %if.end42, %while.cond58
  ...
  %44 = load ptr, ptr %next59, align 8, !tbaa !23
  %45 = load i32, ptr %44, align 8, !tbaa !20
  %cmp61.not = icmp eq i32 %45, %30
  br i1 %cmp61.not, label %while.end64, label %while.cond58, !llvm.loop !25
...
while.end64:                                      ; preds = %while.cond58
  ...
  %46 = load ptr, ptr %next66, align 8, !tbaa !23
  store ptr %46, ptr %next59.le, align 8, !tbaa !23
...
if.then71:                                        ; preds = %if.end69
  ...
  store i32 0, ptr %arrayidx73, align 8, !tbaa !26
  br label %if.end92
...
for.body224:                                      ; preds = %for.body224.lr.ph, %cond.end
  ...
  %69 = load i32, ptr %storemerge435, align 8, !tbaa !20
...
for.body288:                                      ; preds = %for.body288.preheader, %if.end293
  ...
  %75 = load i32, ptr %storemerge410428, align 8, !tbaa !20
...
if.then291:                                       ; preds = %for.body288
  ...
  store i32 1000000000, ptr %cost292, align 4, !tbaa !19
  br label %for.end295
...
if.end293:                                        ; preds = %for.body288
  ...
  br i1 %tobool.not, label %for.end295, label %for.body288, !llvm.loop !36
...
for.body298:                                      ; preds = %for.end295, %if.end303
  ...
  %76 = load i32, ptr %storemerge411431, align 8, !tbaa !20
...
if.then301:                                       ; preds = %for.body298
  ...
  store i32 1000000000, ptr %cost302, align 4, !tbaa !19
  br label %cond.end

if.end303:                                        ; preds = %for.body298
  %next304 = getelementptr inbounds %struct.gnode, ptr %storemerge411431, i64 0, i32 7
  %77 = load ptr, ptr %next304, align 8, !tbaa !23
  %tobool297.not = icmp eq ptr %77, null
  br i1 %tobool297.not, label %for.inc310, label %for.body298, !llvm.loop !37
...
cond.end:                                         ; preds = %if.then301, %if.then266, %land.lhs.true255, %if.then240, %for.body224
  ...
  %78 = load ptr, ptr %next308, align 8, !tbaa !23
  %cmp223.not = icmp eq ptr %78, null
  br i1 %cmp223.not, label %for.inc310, label %for.body224, !llvm.loop !38
...
for.inc310:                                       ; preds = %for.end295, %cond.end, %if.end303, %for.body218
  ...
  br i1 %exitcond450.not, label %for.end312, label %for.body218, !llvm.loop !39
...
entry:
  ...
  store i16 %conv, ptr %arrayidx6, align 2, !tbaa !40
  ...
  store i16 %conv, ptr %arrayidx6.1, align 2, !tbaa !40
  ...
  store i16 %conv, ptr %arrayidx6.2, align 2, !tbaa !40
  ...
  store i16 %conv, ptr %arrayidx6.3, align 2, !tbaa !40
...
for.body10:                                       ; preds = %for.body10.lr.ph, %for.inc23
  ...
  %12 = load i32, ptr %length, align 8, !tbaa !18
...
if.end:                                           ; preds = %for.body10
  ...
  %13 = load i32, ptr %gptr.0218, align 8, !tbaa !20
...
for.inc23:                                        ; preds = %for.body10, %if.end
  ...
  %16 = load ptr, ptr %next, align 8, !tbaa !23
  %cmp8.not = icmp eq ptr %16, null
  br i1 %cmp8.not, label %for.cond25.preheader, label %for.body10, !llvm.loop !42
...
while.cond.preheader:                             ; preds = %while.cond.preheader.lr.ph, %for.inc73
  ...
  %19 = load i16, ptr %arrayidx35221, align 2, !tbaa !40
...
while.body:                                       ; preds = %while.cond.preheader, %if.end62
  ...
  %25 = load i16, ptr %arrayidx46, align 2, !tbaa !40
...
if.then60:                                        ; preds = %while.body
  ...
  %28 = load ptr, ptr %next61, align 8, !tbaa !23
  %.pre = load i32, ptr %28, align 8, !tbaa !20
  br label %if.end62
...
if.end62:                                         ; preds = %if.then60, %while.body
  ...
  %inc70 = add i16 %24, 1
  store i16 %inc70, ptr %17, align 2, !tbaa !40
  %idxprom71 = sext i16 %inc70 to i64
  %arrayidx72 = getelementptr inbounds i16, ptr %17, i64 %idxprom71
  store i16 %conv64, ptr %arrayidx72, align 2, !tbaa !40
  %30 = load i16, ptr %17, align 2, !tbaa !40
  %idxprom34 = sext i16 %30 to i64
  %arrayidx35 = getelementptr inbounds i16, ptr %17, i64 %idxprom34
  %31 = load i16, ptr %arrayidx35, align 2, !tbaa !40
  %conv36 = sext i16 %31 to i32
  %cmp37 = icmp slt i32 %10, %conv36
  br i1 %cmp37, label %while.body, label %for.inc73, !llvm.loop !43

for.inc73:                                        ; preds = %if.end62, %while.cond.preheader
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.cond76.preheader, label %while.cond.preheader, !llvm.loop !44
...
for.body79:                                       ; preds = %for.body79.lr.ph, %for.inc92
  ...
  %34 = load i16, ptr %arrayidx86, align 2, !tbaa !40
...
for.inc92:                                        ; preds = %for.body79
  ...
  br i1 %exitcond240.not, label %cleanup, label %for.body79, !llvm.loop !45
...
for.body106:                                      ; preds = %for.cond103
  ...
  %39 = load i16, ptr %arrayidx110, align 2, !tbaa !40
  ...
  %40 = load i16, ptr %arrayidx118, align 2, !tbaa !40
...
if.end137:                                        ; preds = %for.end133
  ...
  %43 = load i16, ptr %arrayidx141, align 2, !tbaa !40
  ...
  %44 = load i16, ptr %arrayidx147, align 2, !tbaa !40
...
!25 = distinct !{!25, !22}
!26 = !{!27, !6, i64 0}
!27 = !{!"pnode", !6, i64 0, !10, i64 8, !10, i64 16}
!28 = !{!27, !10, i64 16}
!29 = !{!30, !10, i64 8}
!30 = !{!"list2", !6, i64 0, !10, i64 8}
!31 = !{!30, !6, i64 0}
!32 = !{!17, !6, i64 4}
!33 = !{!17, !6, i64 20}
!34 = !{!17, !6, i64 24}
