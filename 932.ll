; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Bullet/btConvexShape.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Bullet/btConvexShape.cpp"
...
for.body:                                         ; preds = %_ZNK13btConvexShape19getMarginNonVirtualEv.exit264, %for.body
  ...
  %80 = shufflevector <2 x float> %70, <2 x float> undef, <2 x i32> <i32 1, i32 1>
  ...
  %130 = shufflevector <2 x float> %119, <2 x float> undef, <2 x i32> <i32 1, i32 1>
...
sw.bb10.i503:                                     ; preds = %entry, %entry
  ...
  %197 = load float, ptr %arrayidx30.i.i.i, align 4, !tbaa !14, !noalias !44
  ...
  %199 = load float, ptr %arrayidx.i46.i.i.i, align 4, !tbaa !14, !noalias !44
  ...
  %201 = load float, ptr %arrayidx.i47.i.i.i, align 4, !tbaa !14, !noalias !44
...
!44 = !{!45}
!45 = distinct !{!45, !46, !"_ZNK11btMatrix3x38absoluteEv: %agg.result"}
