; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr19005.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/pr19005.c"
...
for.body:                                         ; preds = %foo.exit.2, %entry
  %storemerge2 = phi i32 [ -10, %entry ], [ %conv1.i.3, %foo.exit.2 ]
  br i1 %tobool.not.i.i, label %foo.exit.2, label %if.then19.i.i
...
foo.exit.2:                                       ; preds = %for.body
  %conv1.i.3 = add nsw i32 %storemerge2, 4
  %exitcond.not.3 = icmp eq i32 %conv1.i.3, 266
  br i1 %exitcond.not.3, label %for.end, label %for.body, !llvm.loop !9

for.end:                                          ; preds = %foo.exit.2
