; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/UI/Common/OpenArchive.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/UI/Common/OpenArchive.cpp"
...
ehcleanup:                                        ; preds = %delete.notnull.i800, %lpad6, %lpad4
  ...
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp) #16
  br label %_ZN11CStringBaseIwED2Ev.exit1274
...
for.cond.preheader:                               ; preds = %if.end
  ...
  %cmp201433 = icmp sgt i32 %17, 0
  br i1 %cmp201433, label %invoke.cont22.lr.ph, label %for.end.thread
...
invoke.cont22:                                    ; preds = %invoke.cont22.lr.ph, %for.inc
  ...
  %numFinded.01434 = phi i32 [ 0, %invoke.cont22.lr.ph ], [ %numFinded.1, %for.inc ]
...
if.then27:                                        ; preds = %invoke.cont24
  invoke void @_ZN17CBaseRecordVector13InsertOneItemEi(ptr noundef nonnull align 8 dereferenceable(32) %orderIndices, i32 noundef %numFinded.01434)
...
_ZN13CRecordVectorIiE6InsertEii.exit:             ; preds = %if.then27
  %inc = add nsw i32 %numFinded.01434, 1
  %31 = load ptr, ptr %_items.i809, align 8, !tbaa !50
  %idxprom.i807 = sext i32 %numFinded.01434 to i64
...
for.inc:                                          ; preds = %_ZN13CRecordVectorIiE3AddEi.exit814, %_ZN13CRecordVectorIiE6InsertEii.exit
  %numFinded.1 = phi i32 [ %inc, %_ZN13CRecordVectorIiE6InsertEii.exit ], [ %numFinded.01434, %_ZN13CRecordVectorIiE3AddEi.exit814 ]
...
for.end.thread:                                   ; preds = %for.cond.preheader
  %tobool.not1516 = icmp eq ptr %stream, null
  br i1 %tobool.not1516, label %_ZN11CStringBaseIwED2Ev.exit1266, label %if.end39.thread1521

if.then34:                                        ; preds = %for.end
  %cmp35.not = icmp eq i32 %numFinded.1, 1
  br i1 %cmp35.not, label %if.end37, label %_ZN11CStringBaseIwED2Ev.exit1266
...
if.end39.thread1521:                              ; preds = %for.end.thread
  %_size.i8151523 = getelementptr inbounds %class.CBaseRecordVector, ptr %orderIndices, i64 0, i32 2
  %40 = load i32, ptr %_size.i8151523, align 4, !tbaa !49
  %cmp421524 = icmp sgt i32 %40, 1
  br i1 %cmp421524, label %if.end.i823, label %if.else275

if.end39.thread:                                  ; preds = %if.end37
  %_size.i8151306 = getelementptr inbounds %class.CBaseRecordVector, ptr %orderIndices, i64 0, i32 2
  %41 = load i32, ptr %_size.i8151306, align 4, !tbaa !49
  %cmp421307 = icmp sgt i32 %41, 1
  br i1 %cmp421307, label %lor.lhs.false, label %if.else275
...
lor.lhs.false:                                    ; preds = %if.end39.thread, %land.lhs.true
  %_size.i81513081315 = phi ptr [ %_size.i815, %land.lhs.true ], [ %_size.i8151306, %if.end39.thread ]
...
if.end.i823:                                      ; preds = %if.end39.thread1521, %land.lhs.true, %invoke.cont44
  %_size.i81513081316 = phi ptr [ %_size.i81513081315, %invoke.cont44 ], [ %_size.i815, %land.lhs.true ], [ %_size.i8151523, %if.end39.thread1521 ]
...
invoke.cont83:                                    ; preds = %if.end76
  ...
  %47 = load i32, ptr %_size.i81513081316, align 4, !tbaa !49
...
for.cond94.preheader:                             ; preds = %invoke.cont83
  %cmp981442 = icmp sgt i32 %47, 0
  br i1 %cmp981442, label %invoke.cont104.lr.ph, label %for.end134
...
invoke.cont104:                                   ; preds = %invoke.cont104.lr.ph, %cleanup126
  ...
  %indvars.iv1499 = phi i64 [ 0, %invoke.cont104.lr.ph ], [ %indvars.iv.next1500, %cleanup126 ]
  %50 = load ptr, ptr %_items.i835, align 8, !tbaa !50
  %arrayidx.i837 = getelementptr inbounds i32, ptr %50, i64 %indvars.iv1499
...
if.end111:                                        ; preds = %invoke.cont104
  ...
  %arrayidx121 = getelementptr inbounds [256 x i8], ptr %prevs, i64 0, i64 %indvars.iv1499
  store i8 %59, ptr %arrayidx121, align 1, !tbaa !15
  %conv122 = trunc i64 %indvars.iv1499 to i8
  store i8 %conv122, ptr %arrayidx119, align 1, !tbaa !15
  %.pre = load i32, ptr %_size.i81513081316, align 4, !tbaa !49
  br label %cleanup126
...
cleanup126:                                       ; preds = %invoke.cont104, %if.end111
  ...
  %cmp98 = icmp slt i64 %indvars.iv.next1500, %61
...
for.end134:                                       ; preds = %cleanup126, %for.cond94.preheader
  ...
  %cmp1371451.not = icmp eq i64 %sub, 0
  br i1 %cmp1371451.not, label %cleanup226, label %for.cond139.preheader.lr.ph
...
for.cond139.preheader:                            ; preds = %for.cond139.preheader.lr.ph, %do.end
  ...
  %pos.01452 = phi i32 [ 0, %for.cond139.preheader.lr.ph ], [ %add167, %do.end ]
  br label %for.cond139

for.cond139:                                      ; preds = %for.cond139.preheader, %land.rhs
  %pos.1 = phi i32 [ %add145, %land.rhs ], [ %pos.01452, %for.cond139.preheader ]
...
for.end158:                                       ; preds = %for.cond139, %land.rhs
  %conv140.le = zext i32 %pos.1 to i64
  %cmp160 = icmp eq i64 %64, %conv140.le
  br i1 %cmp160, label %cleanup226.loopexit, label %if.end162

if.end162:                                        ; preds = %for.end158
  %arrayidx165 = getelementptr inbounds i8, ptr %call.i824828, i64 %conv140.le
...
land.lhs.true198:                                 ; preds = %land.lhs.true191
  ...
  %cmp3.not.i1447 = icmp eq i8 %78, %79
  br i1 %cmp3.not.i1447, label %for.cond.i856, label %if.else212

for.cond.i856:                                    ; preds = %land.lhs.true198, %for.body.i859
  %i.08.i1448 = phi i64 [ %inc.i854, %for.body.i859 ], [ 0, %land.lhs.true198 ]
  %inc.i854 = add nuw i64 %i.08.i1448, 1
...
cleanup226.loopexit:                              ; preds = %for.end158, %do.end
  %.pre1511 = load i32, ptr %_size.i81513081316, align 4, !tbaa !49
  br label %cleanup226

cleanup226:                                       ; preds = %cleanup226.loopexit, %for.end134
  %90 = phi i32 [ %.pre1511, %cleanup226.loopexit ], [ %62, %for.end134 ]
  %cmp2321453 = icmp sgt i32 %90, 0
  br i1 %cmp2321453, label %for.body233.lr.ph, label %for.end245
...
for.body233:                                      ; preds = %for.body233.lr.ph, %if.end241
  ...
  %indvars.iv1502 = phi i64 [ 0, %for.body233.lr.ph ], [ %indvars.iv.next1503, %if.end241 ]
  %92 = load ptr, ptr %_items.i870, align 8, !tbaa !50
  %arrayidx.i872 = getelementptr inbounds i32, ptr %92, i64 %indvars.iv1502
...
_ZN13CRecordVectorIiE3AddEi.exit878:              ; preds = %if.then238
  ...
  %.pre1512 = load i32, ptr %_size.i81513081316, align 4, !tbaa !49
  br label %if.end241
...
if.end241:                                        ; preds = %_ZN13CRecordVectorIiE3AddEi.exit878, %for.body233
  %98 = phi i32 [ %.pre1512, %_ZN13CRecordVectorIiE3AddEi.exit878 ], [ %91, %for.body233 ]
  %indvars.iv.next1503 = add nuw nsw i64 %indvars.iv1502, 1
  %99 = sext i32 %98 to i64
  %cmp232 = icmp slt i64 %indvars.iv.next1503, %99
...
cleanup249:                                       ; preds = %for.end245
  %.pr1317 = load ptr, ptr %_items.i832, align 8, !tbaa !56
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %prevs) #16
  store ptr getelementptr inbounds ({ [4 x ptr] }, ptr @_ZTV7CBufferIhE, i64 0, inrange i32 0, i64 2), ptr %hashBuffer, align 8, !tbaa !13
  %isnull.i880 = icmp eq ptr %.pr1317, null
...
delete.notnull.i881:                              ; preds = %cleanup249.thread, %cleanup249
  %retval.21323 = phi i32 [ 1, %cleanup249.thread ], [ 0, %cleanup249 ]
  %100 = phi ptr [ %46, %cleanup249.thread ], [ %.pr1317, %cleanup249 ]
...
_ZN7CBufferIhED2Ev.exit:                          ; preds = %cleanup249, %delete.notnull.i881
  %retval.21324 = phi i32 [ 0, %cleanup249 ], [ %retval.21323, %delete.notnull.i881 ]
...
cleanup261:                                       ; preds = %cleanup.cont72, %invoke.cont65, %_ZN7CBufferIhED2Ev.exit
  %cleanup.dest.slot.3 = phi i32 [ %retval.21324, %_ZN7CBufferIhED2Ev.exit ], [ 1, %invoke.cont65 ], [ 1, %cleanup.cont72 ]
  %retval.3 = phi i32 [ %retval.21324, %_ZN7CBufferIhED2Ev.exit ], [ %call66, %invoke.cont65 ], [ 1, %cleanup.cont72 ]
...
_ZN7CBufferIhED2Ev.exit887:                       ; preds = %invoke.cont55, %cleanup261
  ...
  br i1 %cond649, label %if.end380, label %_ZN11CStringBaseIwED2Ev.exit1266
...
_ZN7CBufferIhED2Ev.exit897:                       ; preds = %ehcleanup264, %delete.notnull.i895
  %.pn778.pn.pn.pn1330 = phi { ptr, i32 } [ %102, %ehcleanup264 ], [ %.pn778.pn.pn.pn.ph, %delete.notnull.i895 ]
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %orderIndices2) #16
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %orderIndices2) #16
  br label %ehcleanup625

if.else275:                                       ; preds = %if.end39.thread1521, %if.end39.thread, %invoke.cont44, %if.end39
  %_size.i8151310 = phi ptr [ %_size.i8151306, %if.end39.thread ], [ %_size.i81513081315, %invoke.cont44 ], [ %_size.i815, %if.end39 ], [ %_size.i8151523, %if.end39.thread1521 ]
...
invoke.cont295:                                   ; preds = %invoke.cont287
  ...
  br i1 %cmp297.not, label %cleanup.cont302, label %_ZN11CStringBaseIwED2Ev.exit1266.sink.split
...
cleanup.cont314:                                  ; preds = %invoke.cont307
  ...
  %op.rdx1605 = and i1 %113, %cmp3.not.i930.5
  %114 = select i1 %op.rdx1605, i1 %cmp316, i1 false
  %op.rdx1606 = select i1 %114, i1 %cmp324, i1 false
  br i1 %op.rdx1606, label %land.lhs.true325, label %_ZN7CBufferIhED2Ev.exit950.thread1335, !llvm.loop !61
...
land.lhs.true325:                                 ; preds = %cleanup.cont314
  ...
  br i1 %cmp328.not, label %_ZN7CBufferIhED2Ev.exit950.thread1335, label %for.cond331.preheader

for.cond331.preheader:                            ; preds = %land.lhs.true325
  %117 = load i32, ptr %_size.i8151310, align 4, !tbaa !49
  %cmp3351440 = icmp sgt i32 %117, 0
  br i1 %cmp3351440, label %invoke.cont345.lr.ph, label %_ZN7CBufferIhED2Ev.exit950.thread1335
...
invoke.cont345:                                   ; preds = %invoke.cont345.lr.ph, %for.inc359
  %indvars.iv1496 = phi i64 [ 0, %invoke.cont345.lr.ph ], [ %indvars.iv.next1497, %for.inc359 ]
  %118 = load ptr, ptr %_items.i935, align 8, !tbaa !50
  %arrayidx.i937 = getelementptr inbounds i32, ptr %118, i64 %indvars.iv1496
...
if.end351:                                        ; preds = %invoke.cont347
  %123 = trunc i64 %indvars.iv1496 to i32
...
cleanup354.thread:                                ; preds = %invoke.cont352
  ...
  br label %_ZN7CBufferIhED2Ev.exit950.thread1335

for.inc359:                                       ; preds = %invoke.cont347
  %indvars.iv.next1497 = add nuw nsw i64 %indvars.iv1496, 1
  %125 = load i32, ptr %_size.i8151310, align 4, !tbaa !49
  %126 = sext i32 %125 to i64
  %cmp335 = icmp slt i64 %indvars.iv.next1497, %126
  br i1 %cmp335, label %invoke.cont345, label %_ZN7CBufferIhED2Ev.exit950.thread1335, !llvm.loop !65

_ZN7CBufferIhED2Ev.exit950.thread1335:            ; preds = %for.inc359, %for.cond331.preheader, %land.lhs.true325, %cleanup354.thread, %cleanup.cont314
...
_ZN7CBufferIhED2Ev.exit950:                       ; preds = %invoke.cont307
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %processedSize304) #16
  br label %_ZN11CStringBaseIwED2Ev.exit1266.sink.split
...
if.end380:                                        ; preds = %_ZN7CBufferIhED2Ev.exit950.thread1335, %invoke.cont279, %_ZN7CBufferIhED2Ev.exit887
  %_size.i8151309 = phi ptr [ %_size.i81513081316, %_ZN7CBufferIhED2Ev.exit887 ], [ %_size.i8151310, %invoke.cont279 ], [ %_size.i8151310, %_ZN7CBufferIhED2Ev.exit950.thread1335 ]
  %retval.8 = phi i32 [ %retval.4, %_ZN7CBufferIhED2Ev.exit887 ], [ undef, %invoke.cont279 ], [ 0, %_ZN7CBufferIhED2Ev.exit950.thread1335 ]
  %128 = load i32, ptr %_size.i8151309, align 4, !tbaa !49
...
_ZN11CStringBaseIwED2Ev.exit1002:                 ; preds = %invoke.cont397, %delete.notnull.i1000
  ...
  %131 = load i32, ptr %_size.i8151309, align 4, !tbaa !49
  %cmp4061455 = icmp sgt i32 %131, 0
  br i1 %cmp4061455, label %for.body408.lr.ph, label %if.end445
...
for.cond.cleanup407.unr-lcssa:                    ; preds = %for.body408, %for.body408.lr.ph
  ...
  %indvars.iv1505.unr = phi i64 [ 0, %for.body408.lr.ph ], [ %indvars.iv.next1506.3, %for.body408 ]
  %iUdf.01457.unr = phi i32 [ -1, %for.body408.lr.ph ], [ %iUdf.1.3, %for.body408 ]
  %iIso.01456.unr = phi i32 [ -1, %for.body408.lr.ph ], [ %spec.select.3, %for.body408 ]
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
...
for.body408.epil:                                 ; preds = %for.cond.cleanup407.unr-lcssa, %for.body408.epil
  %indvars.iv1505.epil = phi i64 [ %indvars.iv.next1506.epil, %for.body408.epil ], [ %indvars.iv1505.unr, %for.cond.cleanup407.unr-lcssa ]
  %iUdf.01457.epil = phi i32 [ %iUdf.1.epil, %for.body408.epil ], [ %iUdf.01457.unr, %for.cond.cleanup407.unr-lcssa ]
  %iIso.01456.epil = phi i32 [ %spec.select.epil, %for.body408.epil ], [ %iIso.01456.unr, %for.cond.cleanup407.unr-lcssa ]
  %epil.iter = phi i64 [ %epil.iter.next, %for.body408.epil ], [ 0, %for.cond.cleanup407.unr-lcssa ]
  %arrayidx.i1014.epil = getelementptr inbounds i32, ptr %132, i64 %indvars.iv1505.epil
  %134 = load i32, ptr %arrayidx.i1014.epil, align 4, !tbaa !51
  %cmp411.epil = icmp eq i32 %134, %call390
  %135 = trunc i64 %indvars.iv1505.epil to i32
  %spec.select.epil = select i1 %cmp411.epil, i32 %135, i32 %iIso.01456.epil
  %cmp416.epil = icmp eq i32 %134, %call398
  %iUdf.1.epil = select i1 %cmp416.epil, i32 %135, i32 %iUdf.01457.epil
  %indvars.iv.next1506.epil = add nuw nsw i64 %indvars.iv1505.epil, 1
...
for.body408:                                      ; preds = %for.body408, %for.body408.lr.ph.new
  %indvars.iv1505 = phi i64 [ 0, %for.body408.lr.ph.new ], [ %indvars.iv.next1506.3, %for.body408 ]
  %iUdf.01457 = phi i32 [ -1, %for.body408.lr.ph.new ], [ %iUdf.1.3, %for.body408 ]
  %iIso.01456 = phi i32 [ -1, %for.body408.lr.ph.new ], [ %spec.select.3, %for.body408 ]
  %niter = phi i64 [ 0, %for.body408.lr.ph.new ], [ %niter.next.3, %for.body408 ]
  %arrayidx.i1014 = getelementptr inbounds i32, ptr %132, i64 %indvars.iv1505
  %142 = load i32, ptr %arrayidx.i1014, align 4, !tbaa !51
  %cmp411 = icmp eq i32 %142, %call390
  %143 = trunc i64 %indvars.iv1505 to i32
  %spec.select = select i1 %cmp411, i32 %143, i32 %iIso.01456
  %cmp416 = icmp eq i32 %142, %call398
  %iUdf.1 = select i1 %cmp416, i32 %143, i32 %iUdf.01457
  %indvars.iv.next1506 = or i64 %indvars.iv1505, 1
  %arrayidx.i1014.1 = getelementptr inbounds i32, ptr %132, i64 %indvars.iv.next1506
  %144 = load i32, ptr %arrayidx.i1014.1, align 4, !tbaa !51
  %cmp411.1 = icmp eq i32 %144, %call390
  %145 = trunc i64 %indvars.iv.next1506 to i32
  ...
  %indvars.iv.next1506.1 = or i64 %indvars.iv1505, 2
  %arrayidx.i1014.2 = getelementptr inbounds i32, ptr %132, i64 %indvars.iv.next1506.1
  %146 = load i32, ptr %arrayidx.i1014.2, align 4, !tbaa !51
  %cmp411.2 = icmp eq i32 %146, %call390
  %147 = trunc i64 %indvars.iv.next1506.1 to i32
  ...
  %indvars.iv.next1506.2 = or i64 %indvars.iv1505, 3
  %arrayidx.i1014.3 = getelementptr inbounds i32, ptr %132, i64 %indvars.iv.next1506.2
  %148 = load i32, ptr %arrayidx.i1014.3, align 4, !tbaa !51
  %cmp411.3 = icmp eq i32 %148, %call390
  %149 = trunc i64 %indvars.iv.next1506.2 to i32
  ...
  %indvars.iv.next1506.3 = add nuw nsw i64 %indvars.iv1505, 4
...
if.end445:                                        ; preds = %_ZN11CStringBaseIwED2Ev.exit1002, %for.cond.cleanup407, %if.then427, %if.end380, %_ZN13CRecordVectorIiE3AddEi.exit
  ...
  %cmp451.not1461 = icmp sgt i32 %151, 0
  br i1 %cmp451.not1461, label %for.body453.lr.ph, label %_ZN11CStringBaseIwED2Ev.exit1266
...
for.body453.lr.ph:                                ; preds = %if.end445
  ...
  %cmp.i1214 = icmp eq ptr %ref.tmp597, %DefaultName600
  %_length.i.i1215 = getelementptr inbounds %struct.CArc, ptr %this, i64 0, i32 2, i32 1
  %_length.i1216 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp597, i64 0, i32 1
  %_capacity.i.i1218 = getelementptr inbounds %struct.CArc, ptr %this, i64 0, i32 2, i32 2
  %_capacity.i1103 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp569, i64 0, i32 2
  %_length.i1121 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp569, i64 0, i32 1
  %_capacity.i1125 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp572, i64 0, i32 2
  %_length.i1143 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp572, i64 0, i32 1
  %cmp.i1147 = icmp eq ptr %ref.tmp568, %DefaultName600
  %_length.i1149 = getelementptr inbounds %class.CStringBase, ptr %ref.tmp568, i64 0, i32 1
  br label %for.body453

for.body453:                                      ; preds = %for.body453.lr.ph, %for.inc618
  %indvars.iv1508 = phi i64 [ 0, %for.body453.lr.ph ], [ %indvars.iv.next1509, %for.inc618 ]
  %retval.111464 = phi i32 [ %retval.10, %for.body453.lr.ph ], [ %retval.1913621371, %for.inc618 ]
...
invoke.cont460:                                   ; preds = %if.then455
  ...
  br i1 %cmp462.not, label %if.end469, label %_ZN11CStringBaseIwED2Ev.exit1266
...
if.end469:                                        ; preds = %invoke.cont460, %for.body453
  ...
  %arrayidx.i1027 = getelementptr inbounds i32, ptr %155, i64 %indvars.iv1508
  ...
  %call2.i1032 = invoke noundef ptr %159()
          to label %call2.i.noexc unwind label %ehcleanup614.thread1384
...
if.then.i.i:                                      ; preds = %call2.i.noexc
  ...
  %call.i.i1034 = invoke noundef i32 %160(ptr noundef nonnull align 8 dereferenceable(8) %call2.i1032)
          to label %if.end490 unwind label %ehcleanup614.thread1384

ehcleanup614.thread1384:                          ; preds = %if.end469, %if.then.i.i
...
cleanup518:                                       ; preds = %if.end511
  %.pr1346 = load ptr, ptr %openSeq, align 8, !tbaa !73
  %tobool.not.i1047 = icmp eq ptr %.pr1346, null
...
if.then.i1051:                                    ; preds = %cleanup518
  %vtable.i1048 = load ptr, ptr %.pr1346, align 8, !tbaa !13
  %vfn.i1049 = getelementptr inbounds ptr, ptr %vtable.i1048, i64 2
  %172 = load ptr, ptr %vfn.i1049, align 8
  %call.i1050 = invoke noundef i32 %172(ptr noundef nonnull align 8 dereferenceable(8) %.pr1346)
...
if.end524:                                        ; preds = %_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit1054.thread, %if.then492
  ...
  switch i32 %result.2, label %if.then.i1252.fold.split [
    i32 1, label %if.then.i1252
...
if.then567:                                       ; preds = %invoke.cont562
  ...
  %call.i.i1123 = invoke noalias noundef nonnull dereferenceable(4) ptr @_Znam(i64 noundef 4) #18
          to label %call.i.i.noexc1122 unwind label %lpad570

call.i.i.noexc1122:                               ; preds = %if.then567
  store ptr %call.i.i1123, ptr %ref.tmp569, align 8, !tbaa !22
  store i32 1, ptr %_capacity.i1103, align 4, !tbaa !27
  store i32 0, ptr %call.i.i1123, align 4, !tbaa !23
  store i32 0, ptr %_length.i1121, align 8, !tbaa !19
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %ref.tmp572) #16
  %call.i.i1145 = invoke noalias noundef nonnull dereferenceable(4) ptr @_Znam(i64 noundef 4) #18
          to label %call.i.i.noexc1144 unwind label %lpad573

call.i.i.noexc1144:                               ; preds = %call.i.i.noexc1122
  store ptr %call.i.i1145, ptr %ref.tmp572, align 8, !tbaa !22
  store i32 1, ptr %_capacity.i1125, align 4, !tbaa !27
  store i32 0, ptr %call.i.i1145, align 4, !tbaa !23
  store i32 0, ptr %_length.i1143, align 8, !tbaa !19
...
invoke.cont576:                                   ; preds = %call.i.i.noexc1144
  br i1 %cmp.i1147, label %invoke.cont576.invoke.cont578_crit_edge, label %if.end.i1153

invoke.cont576.invoke.cont578_crit_edge:          ; preds = %invoke.cont576
  %.pre1514 = load ptr, ptr %ref.tmp568, align 8, !tbaa !22
  br label %invoke.cont578

if.end.i1153:                                     ; preds = %invoke.cont576
  store i32 0, ptr %_length.i.i1215, align 8, !tbaa !19
  %199 = load ptr, ptr %DefaultName600, align 8, !tbaa !22
  store i32 0, ptr %199, align 4, !tbaa !23
  %200 = load i32, ptr %_length.i1149, align 8, !tbaa !19
  %add.i.i1150 = add nsw i32 %200, 1
  %201 = load i32, ptr %_capacity.i.i1218, align 4, !tbaa !27
  %cmp.i.i1152 = icmp eq i32 %add.i.i1150, %201
  br i1 %cmp.i.i1152, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1162, label %if.end.i.i1156

if.end.i.i1156:                                   ; preds = %if.end.i1153
  %conv.i.i1154 = zext i32 %add.i.i1150 to i64
  %202 = icmp slt i32 %200, -1
  %203 = shl nuw nsw i64 %conv.i.i1154, 2
  %204 = select i1 %202, i64 -1, i64 %203
  %call.i.i1170 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %204) #18
          to label %call.i.i.noexc1169 unwind label %lpad577

call.i.i.noexc1169:                               ; preds = %if.end.i.i1156
  %cmp3.i.i1155 = icmp sgt i32 %201, 0
  br i1 %cmp3.i.i1155, label %delete.notnull.i.i1158, label %if.end9.i.i1161

delete.notnull.i.i1158:                           ; preds = %call.i.i.noexc1169
  call void @_ZdaPv(ptr noundef nonnull %199) #19
  %.pre.i1157 = load i32, ptr %_length.i.i1215, align 8, !tbaa !19
  %205 = sext i32 %.pre.i1157 to i64
  br label %if.end9.i.i1161

if.end9.i.i1161:                                  ; preds = %delete.notnull.i.i1158, %call.i.i.noexc1169
  %idxprom13.i.i1159 = phi i64 [ %205, %delete.notnull.i.i1158 ], [ 0, %call.i.i.noexc1169 ]
  store ptr %call.i.i1170, ptr %DefaultName600, align 8, !tbaa !22
  %arrayidx14.i.i1160 = getelementptr inbounds i32, ptr %call.i.i1170, i64 %idxprom13.i.i1159
  store i32 0, ptr %arrayidx14.i.i1160, align 4, !tbaa !23
  store i32 %add.i.i1150, ptr %_capacity.i.i1218, align 4, !tbaa !27
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1162

_ZN11CStringBaseIwE11SetCapacityEi.exit.i1162:    ; preds = %if.end9.i.i1161, %if.end.i1153
  %206 = phi ptr [ %199, %if.end.i1153 ], [ %call.i.i1170, %if.end9.i.i1161 ]
  %207 = load ptr, ptr %ref.tmp568, align 8, !tbaa !22
  br label %while.cond.i.i1168

while.cond.i.i1168:                               ; preds = %while.cond.i.i1168, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1162
  %src.addr.0.i.i1163 = phi ptr [ %207, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1162 ], [ %incdec.ptr.i.i1165, %while.cond.i.i1168 ]
  %dest.addr.0.i.i1164 = phi ptr [ %206, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1162 ], [ %incdec.ptr1.i.i1166, %while.cond.i.i1168 ]
  %incdec.ptr.i.i1165 = getelementptr inbounds i32, ptr %src.addr.0.i.i1163, i64 1
  %208 = load i32, ptr %src.addr.0.i.i1163, align 4, !tbaa !23
  %incdec.ptr1.i.i1166 = getelementptr inbounds i32, ptr %dest.addr.0.i.i1164, i64 1
  store i32 %208, ptr %dest.addr.0.i.i1164, align 4, !tbaa !23
  %cmp.not.i.i1167 = icmp eq i32 %208, 0
  br i1 %cmp.not.i.i1167, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i, label %while.cond.i.i1168, !llvm.loop !28

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i:            ; preds = %while.cond.i.i1168
  %209 = load i32, ptr %_length.i1149, align 8, !tbaa !19
  store i32 %209, ptr %_length.i.i1215, align 8, !tbaa !19
  br label %invoke.cont578

invoke.cont578:                                   ; preds = %invoke.cont576.invoke.cont578_crit_edge, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i
  %210 = phi ptr [ %.pre1514, %invoke.cont576.invoke.cont578_crit_edge ], [ %207, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i ]
  %isnull.i1172 = icmp eq ptr %210, null
  br i1 %isnull.i1172, label %_ZN11CStringBaseIwED2Ev.exit1175, label %delete.notnull.i1173

delete.notnull.i1173:                             ; preds = %invoke.cont578
  call void @_ZdaPv(ptr noundef nonnull %210) #19
  br label %_ZN11CStringBaseIwED2Ev.exit1175

_ZN11CStringBaseIwED2Ev.exit1175:                 ; preds = %invoke.cont578, %delete.notnull.i1173
  %211 = load ptr, ptr %ref.tmp572, align 8, !tbaa !22
  %isnull.i1176 = icmp eq ptr %211, null
  br i1 %isnull.i1176, label %_ZN11CStringBaseIwED2Ev.exit1179, label %delete.notnull.i1177

delete.notnull.i1177:                             ; preds = %_ZN11CStringBaseIwED2Ev.exit1175
  call void @_ZdaPv(ptr noundef nonnull %211) #19
  br label %_ZN11CStringBaseIwED2Ev.exit1179

_ZN11CStringBaseIwED2Ev.exit1179:                 ; preds = %_ZN11CStringBaseIwED2Ev.exit1175, %delete.notnull.i1177
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp572) #16
  %212 = load ptr, ptr %ref.tmp569, align 8, !tbaa !22
  %isnull.i1180 = icmp eq ptr %212, null
  br i1 %isnull.i1180, label %_ZN11CStringBaseIwED2Ev.exit1183, label %delete.notnull.i1181

delete.notnull.i1181:                             ; preds = %_ZN11CStringBaseIwED2Ev.exit1179
  call void @_ZdaPv(ptr noundef nonnull %212) #19
  br label %_ZN11CStringBaseIwED2Ev.exit1183

_ZN11CStringBaseIwED2Ev.exit1183:                 ; preds = %_ZN11CStringBaseIwED2Ev.exit1179, %delete.notnull.i1181
...
lpad573:                                          ; preds = %call.i.i.noexc1122
  %214 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup582

lpad575:                                          ; preds = %call.i.i.noexc1144
  %215 = landingpad { ptr, i32 }
          cleanup
  br label %ehcleanup581

lpad577:                                          ; preds = %if.end.i.i1156
  %216 = landingpad { ptr, i32 }
          cleanup
  %217 = load ptr, ptr %ref.tmp568, align 8, !tbaa !22
  %isnull.i1184 = icmp eq ptr %217, null
  br i1 %isnull.i1184, label %ehcleanup581, label %delete.notnull.i1185

delete.notnull.i1185:                             ; preds = %lpad577
  call void @_ZdaPv(ptr noundef nonnull %217) #19
  br label %ehcleanup581

ehcleanup581:                                     ; preds = %delete.notnull.i1185, %lpad577, %lpad575
  %.pn760 = phi { ptr, i32 } [ %215, %lpad575 ], [ %216, %lpad577 ], [ %216, %delete.notnull.i1185 ]
  %218 = load ptr, ptr %ref.tmp572, align 8, !tbaa !22
  %isnull.i1188 = icmp eq ptr %218, null
  br i1 %isnull.i1188, label %ehcleanup582, label %delete.notnull.i1189

delete.notnull.i1189:                             ; preds = %ehcleanup581
  call void @_ZdaPv(ptr noundef nonnull %218) #19
  br label %ehcleanup582

ehcleanup582:                                     ; preds = %delete.notnull.i1189, %ehcleanup581, %lpad573
  %.pn760.pn = phi { ptr, i32 } [ %214, %lpad573 ], [ %.pn760, %ehcleanup581 ], [ %.pn760, %delete.notnull.i1189 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp572) #16
  %219 = load ptr, ptr %ref.tmp569, align 8, !tbaa !22
  %isnull.i1192 = icmp eq ptr %219, null
  br i1 %isnull.i1192, label %ehcleanup584, label %delete.notnull.i1193

delete.notnull.i1193:                             ; preds = %ehcleanup582
  call void @_ZdaPv(ptr noundef nonnull %219) #19
  br label %ehcleanup584

ehcleanup584:                                     ; preds = %delete.notnull.i1193, %ehcleanup582, %lpad570
  %.pn760.pn.pn = phi { ptr, i32 } [ %213, %lpad570 ], [ %.pn760.pn, %ehcleanup582 ], [ %.pn760.pn, %delete.notnull.i1193 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp569) #16
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp568) #16
  br label %if.then.i1259

if.else586:                                       ; preds = %invoke.cont562
  %_items.i.i.i1196 = getelementptr inbounds %struct.CArcInfoEx, ptr %197, i64 0, i32 5, i32 0, i32 0, i32 3
  %cmp.not9.i1198 = icmp sgt i32 %198, 0
  br i1 %cmp.not9.i1198, label %for.body.i1202, label %invoke.cont588

for.body.i1202:                                   ; preds = %if.else586, %for.inc.i1205
  %indvars.iv.i1199 = phi i64 [ %indvars.iv.next.i1203, %for.inc.i1205 ], [ 0, %if.else586 ]
  %220 = load ptr, ptr %_items.i.i.i1196, align 8, !tbaa !50
  %arrayidx.i.i.i1200 = getelementptr inbounds ptr, ptr %220, i64 %indvars.iv.i1199
  %221 = load ptr, ptr %arrayidx.i.i.i1200, align 8, !tbaa !52
  %222 = load ptr, ptr %221, align 8, !tbaa !22
  %call.i.i1209 = invoke noundef i32 @_Z21MyStringCompareNoCasePKwS0_(ptr noundef %extension.sroa.0.1, ptr noundef %222)
          to label %call.i.i.noexc1208 unwind label %lpad587

call.i.i.noexc1208:                               ; preds = %for.body.i1202
  %cmp5.i1201 = icmp eq i32 %call.i.i1209, 0
  br i1 %cmp5.i1201, label %cleanup.loopexit.split.loop.exit.i1206, label %for.inc.i1205

for.inc.i1205:                                    ; preds = %call.i.i.noexc1208
  %indvars.iv.next.i1203 = add nuw nsw i64 %indvars.iv.i1199, 1
  %223 = load i32, ptr %_size.i1102, align 4, !tbaa !49
  %224 = sext i32 %223 to i64
  %cmp.not.i1204 = icmp slt i64 %indvars.iv.next.i1203, %224
  br i1 %cmp.not.i1204, label %for.body.i1202, label %invoke.cont588, !llvm.loop !53

cleanup.loopexit.split.loop.exit.i1206:           ; preds = %call.i.i.noexc1208
  %225 = trunc i64 %indvars.iv.i1199 to i32
  br label %invoke.cont588

invoke.cont588:                                   ; preds = %for.inc.i1205, %cleanup.loopexit.split.loop.exit.i1206, %if.else586
  %spec.select.i1207 = phi i32 [ -1, %if.else586 ], [ %225, %cleanup.loopexit.split.loop.exit.i1206 ], [ -1, %for.inc.i1205 ]
  %spec.store.select = call i32 @llvm.smax.i32(i32 %spec.select.i1207, i32 0)
  %226 = load ptr, ptr %_items.i.i.i1196, align 8, !tbaa !50
  %idxprom.i.i1212 = zext i32 %spec.store.select to i64
  %arrayidx.i.i1213 = getelementptr inbounds ptr, ptr %226, i64 %idxprom.i.i1212
  %227 = load ptr, ptr %arrayidx.i.i1213, align 8, !tbaa !52
...
lpad587:                                          ; preds = %for.body.i1202
  %228 = landingpad { ptr, i32 }
          cleanup
  br label %if.then.i1259

invoke.cont599:                                   ; preds = %invoke.cont588
  br i1 %cmp.i1214, label %invoke.cont599.invoke.cont602_crit_edge, label %if.end.i1220

invoke.cont599.invoke.cont602_crit_edge:          ; preds = %invoke.cont599
  %.pre1513 = load ptr, ptr %ref.tmp597, align 8, !tbaa !22
  br label %invoke.cont602

if.end.i1220:                                     ; preds = %invoke.cont599
  store i32 0, ptr %_length.i.i1215, align 8, !tbaa !19
  %229 = load ptr, ptr %DefaultName600, align 8, !tbaa !22
  store i32 0, ptr %229, align 4, !tbaa !23
  %230 = load i32, ptr %_length.i1216, align 8, !tbaa !19
  %add.i.i1217 = add nsw i32 %230, 1
  %231 = load i32, ptr %_capacity.i.i1218, align 4, !tbaa !27
  %cmp.i.i1219 = icmp eq i32 %add.i.i1217, %231
  br i1 %cmp.i.i1219, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1229, label %if.end.i.i1223

if.end.i.i1223:                                   ; preds = %if.end.i1220
  %conv.i.i1221 = zext i32 %add.i.i1217 to i64
  %232 = icmp slt i32 %230, -1
  %233 = shl nuw nsw i64 %conv.i.i1221, 2
  %234 = select i1 %232, i64 -1, i64 %233
  %call.i.i1238 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %234) #18
          to label %call.i.i.noexc1237 unwind label %lpad601

call.i.i.noexc1237:                               ; preds = %if.end.i.i1223
  %cmp3.i.i1222 = icmp sgt i32 %231, 0
  br i1 %cmp3.i.i1222, label %delete.notnull.i.i1225, label %if.end9.i.i1228

delete.notnull.i.i1225:                           ; preds = %call.i.i.noexc1237
  call void @_ZdaPv(ptr noundef nonnull %229) #19
  %.pre.i1224 = load i32, ptr %_length.i.i1215, align 8, !tbaa !19
  %235 = sext i32 %.pre.i1224 to i64
  br label %if.end9.i.i1228

if.end9.i.i1228:                                  ; preds = %delete.notnull.i.i1225, %call.i.i.noexc1237
  %idxprom13.i.i1226 = phi i64 [ %235, %delete.notnull.i.i1225 ], [ 0, %call.i.i.noexc1237 ]
  store ptr %call.i.i1238, ptr %DefaultName600, align 8, !tbaa !22
  %arrayidx14.i.i1227 = getelementptr inbounds i32, ptr %call.i.i1238, i64 %idxprom13.i.i1226
  store i32 0, ptr %arrayidx14.i.i1227, align 4, !tbaa !23
  store i32 %add.i.i1217, ptr %_capacity.i.i1218, align 4, !tbaa !27
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1229

_ZN11CStringBaseIwE11SetCapacityEi.exit.i1229:    ; preds = %if.end9.i.i1228, %if.end.i1220
  %236 = phi ptr [ %229, %if.end.i1220 ], [ %call.i.i1238, %if.end9.i.i1228 ]
  %237 = load ptr, ptr %ref.tmp597, align 8, !tbaa !22
  br label %while.cond.i.i1235

while.cond.i.i1235:                               ; preds = %while.cond.i.i1235, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1229
  %src.addr.0.i.i1230 = phi ptr [ %237, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1229 ], [ %incdec.ptr.i.i1232, %while.cond.i.i1235 ]
  %dest.addr.0.i.i1231 = phi ptr [ %236, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1229 ], [ %incdec.ptr1.i.i1233, %while.cond.i.i1235 ]
  %incdec.ptr.i.i1232 = getelementptr inbounds i32, ptr %src.addr.0.i.i1230, i64 1
  %238 = load i32, ptr %src.addr.0.i.i1230, align 4, !tbaa !23
  %incdec.ptr1.i.i1233 = getelementptr inbounds i32, ptr %dest.addr.0.i.i1231, i64 1
  store i32 %238, ptr %dest.addr.0.i.i1231, align 4, !tbaa !23
  %cmp.not.i.i1234 = icmp eq i32 %238, 0
  br i1 %cmp.not.i.i1234, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i1236, label %while.cond.i.i1235, !llvm.loop !28

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i1236:        ; preds = %while.cond.i.i1235
  %239 = load i32, ptr %_length.i1216, align 8, !tbaa !19
  store i32 %239, ptr %_length.i.i1215, align 8, !tbaa !19
  br label %invoke.cont602

invoke.cont602:                                   ; preds = %invoke.cont599.invoke.cont602_crit_edge, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i1236
  %240 = phi ptr [ %.pre1513, %invoke.cont599.invoke.cont602_crit_edge ], [ %237, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i1236 ]
  %isnull.i1240 = icmp eq ptr %240, null
  br i1 %isnull.i1240, label %_ZN11CStringBaseIwED2Ev.exit1243, label %delete.notnull.i1241

delete.notnull.i1241:                             ; preds = %invoke.cont602
  call void @_ZdaPv(ptr noundef nonnull %240) #19
  br label %_ZN11CStringBaseIwED2Ev.exit1243

_ZN11CStringBaseIwED2Ev.exit1243:                 ; preds = %invoke.cont602, %delete.notnull.i1241
...
lpad601:                                          ; preds = %if.end.i.i1223
  %242 = landingpad { ptr, i32 }
          cleanup
  %243 = load ptr, ptr %ref.tmp597, align 8, !tbaa !22
  %isnull.i1244 = icmp eq ptr %243, null
  br i1 %isnull.i1244, label %ehcleanup605, label %delete.notnull.i1245

delete.notnull.i1245:                             ; preds = %lpad601
  call void @_ZdaPv(ptr noundef nonnull %243) #19
  br label %ehcleanup605

ehcleanup605:                                     ; preds = %delete.notnull.i1245, %lpad601, %lpad598
  %.pn = phi { ptr, i32 } [ %241, %lpad598 ], [ %242, %lpad601 ], [ %242, %delete.notnull.i1245 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %ref.tmp597) #16
  br label %if.then.i1259

if.then.i1252.fold.split:                         ; preds = %if.end524
  br label %if.then.i1252

if.then.i1252:                                    ; preds = %_ZN11CStringBaseIwED2Ev.exit1183, %_ZN11CStringBaseIwED2Ev.exit1243, %if.end524, %if.then.i1252.fold.split, %_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit1054
  %retval.191361 = phi i32 [ %retval.111464, %if.end524 ], [ -2147467263, %_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit1054 ], [ %result.2, %if.then.i1252.fold.split ], [ 0, %_ZN11CStringBaseIwED2Ev.exit1243 ], [ 0, %_ZN11CStringBaseIwED2Ev.exit1183 ]
  %cond640 = phi i1 [ true, %if.end524 ], [ false, %_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit1054 ], [ false, %if.then.i1252.fold.split ], [ false, %_ZN11CStringBaseIwED2Ev.exit1243 ], [ false, %_ZN11CStringBaseIwED2Ev.exit1183 ]
  %vtable.i1249 = load ptr, ptr %call2.i1032, align 8, !tbaa !13
  %vfn.i1250 = getelementptr inbounds ptr, ptr %vtable.i1249, i64 2
  %244 = load ptr, ptr %vfn.i1250, align 8
  %call.i1251 = invoke noundef i32 %244(ptr noundef nonnull align 8 dereferenceable(8) %call2.i1032)
          to label %_ZN9CMyComPtrI10IInArchiveED2Ev.exit unwind label %terminate.lpad.i1254
...
_ZN9CMyComPtrI10IInArchiveED2Ev.exit:             ; preds = %if.then.i1252
  br i1 %cond640, label %for.inc618, label %_ZN11CStringBaseIwED2Ev.exit1266

if.then.i1259:                                    ; preds = %ehcleanup584, %ehcleanup605, %lpad587, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit, %_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit, %lpad493
  %.pn760.pn.pn.pn.pn.pn1382 = phi { ptr, i32 } [ %166, %_ZN9CMyComPtrI15IArchiveOpenSeqED2Ev.exit ], [ %163, %lpad493 ], [ %187, %_ZN8NWindows4NCOM12CPropVariantD2Ev.exit ], [ %.pn760.pn.pn, %ehcleanup584 ], [ %.pn, %ehcleanup605 ], [ %228, %lpad587 ]
  %vtable.i1256 = load ptr, ptr %call2.i1032, align 8, !tbaa !13
  %vfn.i1257 = getelementptr inbounds ptr, ptr %vtable.i1256, i64 2
  %247 = load ptr, ptr %vfn.i1257, align 8
  %call.i1258 = invoke noundef i32 %247(ptr noundef nonnull align 8 dereferenceable(8) %call2.i1032)
          to label %ehcleanup625 unwind label %terminate.lpad.i1261
...
for.inc618:                                       ; preds = %call2.i.noexc, %_ZN9CMyComPtrI10IInArchiveED2Ev.exit
  %retval.1913621371 = phi i32 [ %retval.191361, %_ZN9CMyComPtrI10IInArchiveED2Ev.exit ], [ %retval.111464, %call2.i.noexc ]
  %indvars.iv.next1509 = add nuw nsw i64 %indvars.iv1508, 1
  %250 = load i32, ptr %_size.i1024, align 4, !tbaa !49
  %251 = sext i32 %250 to i64
  %cmp451.not = icmp slt i64 %indvars.iv.next1509, %251
  br i1 %cmp451.not, label %for.body453, label %_ZN11CStringBaseIwED2Ev.exit1266, !llvm.loop !75

_ZN11CStringBaseIwED2Ev.exit1266.sink.split:      ; preds = %invoke.cont295, %_ZN7CBufferIhED2Ev.exit950
  %retval.21.ph = phi i32 [ %call308, %_ZN7CBufferIhED2Ev.exit950 ], [ %call296, %invoke.cont295 ]
  call void @_ZdaPv(ptr noundef nonnull %call.i909919) #19
  br label %_ZN11CStringBaseIwED2Ev.exit1266

_ZN11CStringBaseIwED2Ev.exit1266:                 ; preds = %for.inc618, %invoke.cont460, %_ZN9CMyComPtrI10IInArchiveED2Ev.exit, %_ZN11CStringBaseIwED2Ev.exit1266.sink.split, %for.end.thread, %if.end445, %if.then34, %_ZN7CBufferIhED2Ev.exit887
  %retval.21 = phi i32 [ -2147467263, %if.then34 ], [ %retval.4, %_ZN7CBufferIhED2Ev.exit887 ], [ 1, %if.end445 ], [ -2147467263, %for.end.thread ], [ %retval.21.ph, %_ZN11CStringBaseIwED2Ev.exit1266.sink.split ], [ %retval.191361, %_ZN9CMyComPtrI10IInArchiveED2Ev.exit ], [ %call461, %invoke.cont460 ], [ 1, %for.inc618 ]
  ...
  %isnull.i1267 = icmp eq ptr %252, null
  br i1 %isnull.i1267, label %_ZN11CStringBaseIwED2Ev.exit1270, label %delete.notnull.i1268

delete.notnull.i1268:                             ; preds = %_ZN11CStringBaseIwED2Ev.exit1266
  call void @_ZdaPv(ptr noundef nonnull %252) #19
  br label %_ZN11CStringBaseIwED2Ev.exit1270

_ZN11CStringBaseIwED2Ev.exit1270:                 ; preds = %_ZN11CStringBaseIwED2Ev.exit1266, %delete.notnull.i1268
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %fileName) #16
  ret i32 %retval.21

ehcleanup625:                                     ; preds = %lpad17.loopexit, %lpad17.loopexit.split-lp.loopexit.split-lp, %lpad17.loopexit.split-lp.loopexit, %if.then.i1259, %ehcleanup614.thread1384, %delete.notnull.i953, %ehcleanup372, %lpad459, %_ZN7CBufferIhED2Ev.exit897, %ehcleanup400, %ehcleanup392, %lpad14
  %.pn760.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %21, %lpad14 ], [ %.pn778.pn.pn.pn1330, %_ZN7CBufferIhED2Ev.exit897 ], [ %.pn770, %ehcleanup400 ], [ %.pn768, %ehcleanup392 ], [ %154, %lpad459 ], [ %127, %ehcleanup372 ], [ %.pn773.pn.pn.ph, %delete.notnull.i953 ], [ %.pn760.pn.pn.pn.pn.pn1382, %if.then.i1259 ], [ %161, %ehcleanup614.thread1384 ], [ %lpad.loopexit1399, %lpad17.loopexit ], [ %lpad.loopexit1402, %lpad17.loopexit.split-lp.loopexit ], [ %lpad.loopexit.split-lp1403, %lpad17.loopexit.split-lp.loopexit.split-lp ]
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %orderIndices) #16
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %orderIndices) #16
  br label %_ZN11CStringBaseIwED2Ev.exit1274

_ZN11CStringBaseIwED2Ev.exit1274:                 ; preds = %ehcleanup, %ehcleanup625
...
ehcleanup631:                                     ; preds = %_ZN11CStringBaseIwED2Ev.exit1274, %lpad
  %.pn760.pn.pn.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %.pn760.pn.pn.pn.pn.pn.pn.pn.pn.ph, %_ZN11CStringBaseIwED2Ev.exit1274 ], [ %13, %lpad ]
  %253 = load ptr, ptr %fileName, align 8, !tbaa !22
  %isnull.i1275 = icmp eq ptr %253, null
  br i1 %isnull.i1275, label %_ZN11CStringBaseIwED2Ev.exit1278, label %delete.notnull.i1276

delete.notnull.i1276:                             ; preds = %ehcleanup631
  call void @_ZdaPv(ptr noundef nonnull %253) #19
  br label %_ZN11CStringBaseIwED2Ev.exit1278

_ZN11CStringBaseIwED2Ev.exit1278:                 ; preds = %ehcleanup631, %delete.notnull.i1276
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %fileName) #16
...
define linkonce_odr dso_local void @_ZN4CArcD2Ev(ptr noundef nonnull align 8 dereferenceable(80) %this) unnamed_addr #9 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
  %ErrorMessage = getelementptr inbounds %struct.CArc, ptr %this, i64 0, i32 7
...
; Function Attrs: inlinehint nounwind uwtable
define linkonce_odr dso_local void @_ZN8NWindows5NFile3NIO7CInFileD0Ev(ptr noundef nonnull align 8 dereferenceable(1084) %this) unnamed_addr #9 comdat align 2 {
entry:
