; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/resolve.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-smail/resolve.c"
...
if.then33:                                        ; preds = %if.end20.if.then33_crit_edge, %lor.lhs.false
  ...
  %or.cond110 = select i1 %cmp34, i1 %cmp36, i1 false
  %spec.store.select = zext i1 %or.cond110 to i32
  %call40 = call i32 @route(ptr noundef %domain, ptr noundef %user, i32 noundef %spec.store.select, ptr noundef nonnull %temp, ptr noundef %cost)
...
if.else52:                                        ; preds = %lor.lhs.false
  %12 = load i32, ptr @getcost, align 4, !tbaa !10
  %tobool.not = icmp ne i32 %12, 0
  %brmerge.not = select i1 %tobool.not, i1 %cmp30, i1 false
...
if.then59:                                        ; preds = %if.else52
  ...
  %call61 = call i32 @route(ptr noundef %domain, ptr noundef %user, i32 noundef 0, ptr noundef nonnull %junk, ptr noundef %cost)
...
for.end:                                          ; preds = %for.inc, %if.else52, %if.then59, %if.end, %if.end43, %if.then47
  ...
  %or.cond111 = select i1 %cmp74, i1 %cmp76, i1 false
...
if.then:                                          ; preds = %lor.lhs.false, %entry
  store i32 0, ptr %cost, align 4, !tbaa !10
...
for.inc:                                          ; preds = %lor.lhs.false29
  ...
  br i1 %exitcond.not, label %for.end.thread, label %for.body, !llvm.loop !14
...
if.then59:                                        ; preds = %route_complete
  ...
  %8 = load i32, ptr %cost, align 4, !tbaa !10
