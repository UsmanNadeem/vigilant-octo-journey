; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z15.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z15.c"
...
if.then247:                                       ; preds = %sw.bb237
  ...
  %33 = load i32, ptr %yc, align 4, !tbaa !12
  %obfc250 = getelementptr inbounds %struct.CONSTRAINT, ptr %yc, i64 0, i32 1
  %34 = load i32, ptr %obfc250, align 4, !tbaa !11
  ...
  %35 = load i32, ptr %ofc262, align 4, !tbaa !9
...
cond.end318.thread:                               ; preds = %if.end306
  %41 = load i32, ptr %yc, align 4, !tbaa !12
...
cond.false332:                                    ; preds = %if.end306
  ...
  %43 = load i32, ptr %yc, align 4, !tbaa !12
...
cond.end339:                                      ; preds = %cond.end318.thread, %cond.false332
  ...
  %45 = load i32, ptr %ofc341, align 4, !tbaa !9
...
if.end.i.thread:                                  ; preds = %cond.end97.i, %cond.end190.i
  ...
  %106 = load i32, ptr %yc.i, align 4, !tbaa !12
...
if.end.i:                                         ; preds = %sw.bb214.i, %sw.bb203.i, %sw.bb192.i, %sw.bb114.i, %sw.bb108.i, %sw.bb.i
  ...
  %108 = load i32, ptr %yc.i, align 4, !tbaa !12
...
land.lhs.true234.i:                               ; preds = %land.lhs.true229.i
  %112 = load i32, ptr %ofc.i902, align 4, !tbaa !9
