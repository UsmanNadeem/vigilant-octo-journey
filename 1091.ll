; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/UI/Console/BenchCon.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/UI/Console/BenchCon.cpp"
...
_ZL11MyMultDiv64yyy.exit:                         ; preds = %while.body.i.i, %entry
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %s.i) #11
  ...
  %call2.i = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s.i) #12
...
_ZL11PrintNumberP8_IO_FILEyi.exit:                ; preds = %for.body.i, %_ZL11MyMultDiv64yyy.exit
  ...
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %s.i) #11
...
if.then2:                                         ; preds = %entry
  ...
  call void @llvm.lifetime.start.p0(i64 56, ptr nonnull %info2) #11
  ...
  call void @llvm.lifetime.end.p0(i64 56, ptr nonnull %info2) #11
  br label %return
...
for.inc39.1:                                      ; preds = %for.end, %if.end
  ...
  call void @llvm.lifetime.start.p0(i64 88, ptr nonnull %callback) #11
...
cleanup84:                                        ; preds = %cleanup74, %_ZN14CBenchCallback9NormalizeEv.exit
  ...
  call void @llvm.lifetime.end.p0(i64 88, ptr nonnull %callback) #11
  br label %return
...
if.end:                                           ; preds = %entry
  ...
  %call.i = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %0) #13
...
if.end25.us.us:                                   ; preds = %for.body22.us.us
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %speed) #11
...
.noexc.us.us:                                     ; preds = %cleanup.cont.us.us
  ...
  %call2.i.us.us = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s.i) #12
...
for.cond30.for.inc66_crit_edge.us.us:             ; preds = %invoke.cont46.us.us
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %speed) #11
...
for.body87:                                       ; preds = %if.then79, %for.inc94
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %s.i157) #11
...
.noexc168:                                        ; preds = %for.body87
  ...
  %call2.i159 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s.i157) #12
...
for.inc94:                                        ; preds = %for.body.i167, %.noexc168
  ...
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %s.i157) #11
...
_ZN11CTempValuesD2Ev.exit:                        ; preds = %for.cond.cleanup.thread, %for.cond.cleanup, %for.end77, %for.cond.cleanup86, %cleanup74
  ...
  call void @_ZdaPv(ptr noundef nonnull %call.i) #14
  br label %return
...
_ZL11PrintNumberP8_IO_FILEyi.exit:                ; preds = %for.body.i, %entry
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %s.i.i) #11
  ...
  %call2.i.i = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s.i.i) #12
...
_ZL11PrintRatingP8_IO_FILEy.exit:                 ; preds = %for.body.i.i, %_ZL11PrintNumberP8_IO_FILEyi.exit
  ...
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %s.i.i) #11
  %div.i4 = udiv i64 %rating, 1000000
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %s.i.i3) #11
  ...
  %call2.i.i6 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s.i.i3) #12
...
_ZL11PrintRatingP8_IO_FILEy.exit15:               ; preds = %for.body.i.i13, %_ZL11PrintRatingP8_IO_FILEy.exit
  ...
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %s.i.i3) #11
  ret void
}
