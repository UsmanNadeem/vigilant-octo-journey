; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pdivmod.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/cfrac/pdivmod.c"
...
land.end186:                                      ; preds = %land.rhs183, %do.end174
  ...
  %incdec.ptr221 = getelementptr inbounds i16, ptr %incdec.ptr205, i64 -1
  br label %do.body194
...
if.else210:                                       ; preds = %do.body194
  ...
  %incdec.ptr222 = getelementptr inbounds i16, ptr %incdec.ptr213, i64 -1
...
while.body:                                       ; preds = %while.cond
  ...
  br i1 %cmp234, label %while.end, label %while.cond, !llvm.loop !18

while.end:                                        ; preds = %while.body, %while.cond
  %qd.1 = phi i16 [ %dec231, %while.body ], [ %qd.0, %while.cond ]
  %add.ptr238 = getelementptr inbounds i16, ptr %incdec.ptr222, i64 2
  br label %if.end239

if.end239:                                        ; preds = %do.body194, %while.end
  %LastPtr.0 = phi ptr [ %add.ptr238, %while.end ], [ %add.ptr203, %do.body194 ]
  %qd.2 = phi i16 [ %qd.1, %while.end ], [ -1, %do.body194 ]
...
do.body242:                                       ; preds = %do.body242, %if.end239
  ...
  %cmp263 = icmp ult ptr %incdec.ptr261, %LastPtr.0
...
do.end265:                                        ; preds = %do.body242
  ...
  br i1 %cmp280, label %if.then282, label %if.end314

if.then282:                                       ; preds = %do.end265
  %add.ptr287 = getelementptr inbounds i16, ptr %add.ptr278, i64 %idx.ext21
  br label %do.body288

do.body288:                                       ; preds = %do.body288, %if.then282
  %vPtr.3 = phi ptr [ %value196, %if.then282 ], [ %incdec.ptr290, %do.body288 ]
  %carry.1 = phi i32 [ 0, %if.then282 ], [ %shr295, %do.body288 ]
  %uPtr.5 = phi ptr [ %add.ptr278, %if.then282 ], [ %incdec.ptr299, %do.body288 ]
  ...
  %cmp301 = icmp ult ptr %incdec.ptr299, %add.ptr287
