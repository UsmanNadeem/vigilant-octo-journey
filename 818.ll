; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/perimeter.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/perimeter.c"
...
if.then:                                          ; preds = %for.body
  ...
  %shift = shufflevector <2 x i32> %7, <2 x i32> poison, <2 x i32> <i32 1, i32 undef>
...
if.else:                                          ; preds = %for.body
  ...
  %shift135 = shufflevector <2 x i32> %13, <2 x i32> poison, <2 x i32> <i32 1, i32 undef>
