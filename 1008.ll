; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniAMR/refine.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniAMR/refine.c"
...
for.body81.preheader:                             ; preds = %if.end76
  ...
  %min.iters.check = icmp ult i64 %34, 12
  br i1 %min.iters.check, label %for.body81.preheader255, label %vector.memcheck

vector.memcheck:                                  ; preds = %for.body81.preheader
  %uglygep = getelementptr i8, ptr %30, i64 4
  %35 = shl nuw nsw i64 %wide.trip.count, 2
  %uglygep252 = getelementptr i8, ptr %30, i64 %35
  %bound0 = icmp ugt ptr %uglygep252, @global_active
  %bound1 = icmp ult ptr %uglygep, getelementptr inbounds (i32, ptr @global_active, i64 1)
