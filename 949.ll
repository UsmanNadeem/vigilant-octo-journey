; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Bullet/btSimpleBroadphase.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Bullet/btSimpleBroadphase.cpp"
...
define dso_local void @_ZN18btSimpleBroadphaseC2EiP22btOverlappingPairCache(ptr nocapture noundef nonnull align 8 dereferenceable(64) %this, i32 noundef %maxProxies, ptr noundef %overlappingPairCache) unnamed_addr #2 align 2 personality ptr @__gxx_personality_v0 {
entry:
...
; Function Attrs: mustprogress nofree nosync willreturn memory(readwrite, inaccessiblemem: none) uwtable
...
for.body66:                                       ; preds = %for.body66.lr.ph, %if.end90
  ...
  %47 = load ptr, ptr %arrayidx.i, align 8, !tbaa !43
...
if.then82:                                        ; preds = %if.then70, %land.lhs.true.i.i, %land.lhs.true10.i.i, %land.lhs.true18.i.i, %land.lhs.true26.i.i, %for.body66, %_ZN18btSimpleBroadphase15testAabbOverlapEP17btBroadphaseProxyS1_.exit
  ...
  %65 = load i32, ptr @gOverlappingPairs, align 4, !tbaa !45
  %dec = add nsw i32 %65, -1
  store i32 %dec, ptr @gOverlappingPairs, align 4, !tbaa !45
...
_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI29btBroadphasePairSortPredicateEEvT_.exit142: ; preds = %_ZN20btAlignedObjectArrayI16btBroadphasePairE9quickSortI29btBroadphasePairSortPredicateEEvT_.exit, %for.end93, %if.then.i141
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %ref.tmp98) #14
  ...
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %ref.tmp98) #14
  store i32 0, ptr %m_invalidPair, align 4, !tbaa !16
  br label %if.end101
...
if.then5:                                         ; preds = %if.else
  ...
  %1 = load i32, ptr %m_capacity.i.i, align 8, !tbaa !46
...
for.body.i.i:                                     ; preds = %for.body.i.i, %for.body.lr.ph.i.i
  ...
  %4 = load <2 x ptr>, ptr %arrayidx3.i.i, align 8, !tbaa !47
  store <2 x ptr> %4, ptr %arrayidx.i.i, align 8, !tbaa !47
  ...
  %5 = load ptr, ptr %m_algorithm4.i.i.i, align 8, !tbaa !48
  store ptr %5, ptr %m_algorithm.i.i.i, align 8, !tbaa !48
...
if.end:                                           ; preds = %_ZNK20btAlignedObjectArrayI16btBroadphasePairE4copyEiiPS0_.exit.i, %if.then3.i.i
  store i8 1, ptr %m_ownsMemory.i.i, align 8, !tbaa !49
  store ptr %retval.0.i.i, ptr %m_data.i9.i, align 8, !tbaa !42
  store i32 %newsize, ptr %m_capacity.i.i, align 8, !tbaa !46
...
for.body10:                                       ; preds = %for.body10.lr.ph, %for.body10
  ...
  %14 = load <2 x ptr>, ptr %fillData, align 8, !tbaa !47
  store <2 x ptr> %14, ptr %arrayidx13, align 8, !tbaa !47
  %m_algorithm.i = getelementptr inbounds %struct.btBroadphasePair, ptr %13, i64 %indvars.iv, i32 2
  %15 = load ptr, ptr %m_algorithm4.i, align 8, !tbaa !48
  store ptr %15, ptr %m_algorithm.i, align 8, !tbaa !48
...
define dso_local void @_ZN18btSimpleBroadphase9resetPoolEP12btDispatcher(ptr nocapture nonnull align 8 %this, ptr nocapture %dispatcher) unnamed_addr #10 align 2 {
entry:
  ret void
}

; Function Attrs: nounwind uwtable
define linkonce_odr dso_local noundef ptr @_ZN18btSimpleBroadphase23getOverlappingPairCacheEv(ptr noundef nonnull align 8 dereferenceable(64) %this) unnamed_addr #11 comdat align 2 {
entry:
  %m_pairCache = getelementptr inbounds %class.btSimpleBroadphase, ptr %this, i64 0, i32 7
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local noundef ptr @_ZNK18btSimpleBroadphase23getOverlappingPairCacheEv(ptr noundef nonnull align 8 dereferenceable(64) %this) unnamed_addr #11 comdat align 2 {
entry:
  %m_pairCache = getelementptr inbounds %class.btSimpleBroadphase, ptr %this, i64 0, i32 7
  %0 = load ptr, ptr %m_pairCache, align 8, !tbaa !8
  ret ptr %0
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN18btSimpleBroadphase10printStatsEv(ptr noundef nonnull align 8 dereferenceable(64) %this) unnamed_addr #11 comdat align 2 {
entry:
  ret void
}
...
tailrecurse:                                      ; preds = %if.end17, %entry
  ...
  %1 = load ptr, ptr %arrayidx, align 8, !tbaa !43
  ...
  %3 = load ptr, ptr %m_algorithm4.i, align 8, !tbaa !48
...
while.cond:                                       ; preds = %while.body, %do.body
  ...
  %6 = load ptr, ptr %arrayidx4, align 8, !tbaa !43
...
land.rhs.i:                                       ; preds = %land.lhs.true33.i
  ...
  %14 = load ptr, ptr %m_algorithm.i43, align 8, !tbaa !48
...
cond.end.i49:                                     ; preds = %cond.true.i46, %while.cond5
  ...
  %16 = load ptr, ptr %arrayidx8, align 8, !tbaa !43
...
land.rhs.i78:                                     ; preds = %land.lhs.true33.i74
  ...
  %21 = load ptr, ptr %m_algorithm37.i76, align 8, !tbaa !48
...
attributes #5 = { mustprogress nofree nosync willreturn memory(readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!42 = !{!40, !13, i64 16}
!43 = !{!44, !13, i64 0}
!44 = !{!"_ZTS16btBroadphasePair", !13, i64 0, !13, i64 8, !13, i64 16, !12, i64 24}
!45 = !{!11, !11, i64 0}
!46 = !{!40, !11, i64 8}
!47 = !{!13, !13, i64 0}
!48 = !{!44, !13, i64 16}
!49 = !{!40, !14, i64 24}
!50 = !{!44, !13, i64 8}
!51 = !{i64 0, i64 8, !47, i64 8, i64 8, !47, i64 16, i64 8, !47, i64 24, i64 8, !47, i64 24, i64 4, !45}
!52 = !{i64 0, i64 8, !47, i64 8, i64 8, !47, i64 16, i64 8, !47, i64 16, i64 4, !45}
