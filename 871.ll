; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/yacr2/assign.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/yacr2/assign.c"
...
for.body:                                         ; preds = %entry, %for.body
  ...
  %call3 = tail call noalias ptr @malloc(i64 noundef %.pre30) #8
...
for.end:                                          ; preds = %for.body, %entry
  %call6 = tail call noalias ptr @malloc(i64 noundef %.pre30) #8
  store ptr %call6, ptr @tracksNotPref, align 8, !tbaa !9
  %call9 = tail call noalias ptr @malloc(i64 noundef %.pre30) #8
  store ptr %call9, ptr @tracksTopNotPref, align 8, !tbaa !9
  %call12 = tail call noalias ptr @malloc(i64 noundef %.pre30) #8
  store ptr %call12, ptr @tracksBotNotPref, align 8, !tbaa !9
  %call15 = tail call noalias ptr @malloc(i64 noundef %.pre30) #8
  store ptr %call15, ptr @tracksNoHCV, align 8, !tbaa !9
  %call18 = tail call noalias ptr @malloc(i64 noundef %.pre30) #8
  store ptr %call18, ptr @tracksAssign, align 8, !tbaa !9
  %call21 = tail call noalias ptr @malloc(i64 noundef %mul) #8
  store ptr %call21, ptr @netsAssign, align 8, !tbaa !9
  %call24 = tail call noalias ptr @malloc(i64 noundef %mul) #8
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %inc = add nuw i64 %net.04, 1
  %2 = load i64, ptr @channelNets, align 8, !tbaa !5
  %cmp.not.not = icmp ult i64 %net.04, %2
...
for.inc:                                          ; preds = %if.then, %if.else
  ...
  %inc6 = add nuw i64 %net.019, 1
  %7 = load i64, ptr @channelNets, align 8, !tbaa !5
  %cmp.not.not = icmp ult i64 %net.019, %7
  br i1 %cmp.not.not, label %for.body, label %while.cond.preheader, !llvm.loop !15
...
for.body.lr.ph.i:                                 ; preds = %while.body
  ...
  br i1 %cmp3.not22.i, label %for.body.us.i.preheader, label %for.body.i.preheader

for.body.i.preheader:                             ; preds = %for.body.lr.ph.i
  %min.iters.check = icmp ult i64 %.fr.i, 4
  %n.vec = and i64 %.fr.i, -4
  %ind.end = or i64 %n.vec, 1
  %cmp.n = icmp eq i64 %.fr.i, %n.vec
  br label %for.body.i

for.body.us.i.preheader:                          ; preds = %for.body.lr.ph.i
  %xtraiter = and i64 %12, 1
  %15 = icmp eq i64 %12, 1
  br i1 %15, label %Select.exit.loopexit.unr-lcssa, label %for.body.us.i.preheader.new
...
for.body.us.i:                                    ; preds = %for.body.us.i, %for.body.us.i.preheader.new
  ...
  %16 = load i64, ptr %arrayidx.us.i, align 8, !tbaa !5
  %tobool.not.us.i = icmp eq i64 %16, 0
  ...
  %17 = load i64, ptr %arrayidx.us.i.1, align 8, !tbaa !5
  %tobool.not.us.i.1 = icmp eq i64 %17, 0
...
for.body.i:                                       ; preds = %for.body.i.preheader, %for.inc9.i
  %largest.028.i = phi i64 [ %largest.1.i, %for.inc9.i ], [ -1, %for.body.i.preheader ]
  %net.027.i = phi i64 [ %inc10.i, %for.inc9.i ], [ 1, %for.body.i.preheader ]
  %select.026.i = phi i64 [ %select.1.i, %for.inc9.i ], [ 0, %for.body.i.preheader ]
  %arrayidx.i = getelementptr inbounds i64, ptr %11, i64 %net.027.i
  %18 = load i64, ptr %arrayidx.i, align 8, !tbaa !5
...
if.then.i:                                        ; preds = %for.body.i
  ...
  %19 = load ptr, ptr %arrayidx1.i, align 8, !tbaa !9
...
vector.body:                                      ; preds = %if.then.i, %vector.body
  ...
  %vec.phi = phi <2 x i64> [ %22, %vector.body ], [ zeroinitializer, %if.then.i ]
  %vec.phi29 = phi <2 x i64> [ %23, %vector.body ], [ zeroinitializer, %if.then.i ]
  %offset.idx = or i64 %index, 1
  %20 = getelementptr inbounds i64, ptr %19, i64 %offset.idx
  %wide.load = load <2 x i64>, ptr %20, align 8, !tbaa !5
  %21 = getelementptr inbounds i64, ptr %20, i64 2
  %wide.load30 = load <2 x i64>, ptr %21, align 8, !tbaa !5
  %22 = add <2 x i64> %wide.load, %vec.phi
  %23 = add <2 x i64> %wide.load30, %vec.phi29
...
for.body4.i.preheader:                            ; preds = %if.then.i, %middle.block
  %cost.024.i.ph = phi i64 [ 0, %if.then.i ], [ %25, %middle.block ]
...
for.body4.i:                                      ; preds = %for.body4.i.preheader, %for.body4.i
  ...
  %arrayidx5.i = getelementptr inbounds i64, ptr %19, i64 %track.023.i
  %26 = load i64, ptr %arrayidx5.i, align 8, !tbaa !5
  %add.i = add nsw i64 %26, %cost.024.i
  %inc.i = add nuw i64 %track.023.i, 1
  %exitcond.i = icmp eq i64 %track.023.i, %.fr.i
...
for.cond2.for.end_crit_edge.i:                    ; preds = %for.body4.i, %middle.block
  %add.i.lcssa = phi i64 [ %25, %middle.block ], [ %add.i, %for.body4.i ]
...
for.inc9.i:                                       ; preds = %for.cond2.for.end_crit_edge.i, %for.body.i
  ...
  %exitcond31.i = icmp eq i64 %net.027.i, %12
  br i1 %exitcond31.i, label %Select.exit, label %for.body.i, !llvm.loop !16
...
for.body.us.i.epil:                               ; preds = %Select.exit.loopexit.unr-lcssa
  ...
  %27 = load i64, ptr %arrayidx.us.i.epil, align 8, !tbaa !5
  %tobool.not.us.i.epil = icmp eq i64 %27, 0
...
Select.exit:                                      ; preds = %for.inc9.i, %for.body.us.i.epil, %Select.exit.loopexit.unr-lcssa, %while.body
  ...
  %28 = load ptr, ptr @VCG, align 8, !tbaa !9
  %29 = load ptr, ptr @netsAssign, align 8, !tbaa !9
  tail call void @Assign(ptr noundef %28, ptr noundef %29, i64 noundef %select.0.lcssa.i)
  %30 = load ptr, ptr @CROSSING, align 8, !tbaa !9
  %arrayidx8 = getelementptr inbounds i64, ptr %30, i64 %select.0.lcssa.i
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  store i64 0, ptr %arrayidx, align 8, !tbaa !5
  %inc = add nuw i64 %net.081, 1
  %2 = load i64, ptr @channelNets, align 8, !tbaa !5
  %cmp.not.not = icmp ult i64 %net.081, %2
...
while.body:                                       ; preds = %while.body.preheader, %Select.exit
  %19 = phi ptr [ %70, %Select.exit ], [ %.pre, %while.body.preheader ]
...
for.body3.i:                                      ; preds = %for.body.i68, %for.body3.i
  ...
  %inc.i69 = add nuw i64 %track.097.i, 1
  %31 = load i64, ptr @channelTracks, align 8, !tbaa !5
  %cmp2.not.not.i = icmp ult i64 %track.097.i, %31
  br i1 %cmp2.not.not.i, label %for.body3.i, label %for.inc5.loopexit.i, !llvm.loop !23
...
for.inc5.i:                                       ; preds = %for.inc5.loopexit.i, %for.body.i68
  ...
  %inc6.i = add nuw i64 %net.099.i, 1
  %cmp.not.not.i = icmp ult i64 %net.099.i, %.pr
  br i1 %cmp.not.not.i, label %for.body.i68, label %for.cond8.preheader.i, !llvm.loop !24
...
if.then.i71:                                      ; preds = %for.body10.i
  ...
  tail call void @LongestPathVCG(ptr noundef %20, i64 noundef %net.1105.i) #9
  %38 = load ptr, ptr @tracksNoHCV, align 8, !tbaa !9
  tail call void @NoHCV(ptr noundef %21, i64 noundef %net.1105.i, ptr noundef %22, ptr noundef %38) #9
  ...
  %.pre107.i = load i64, ptr @channelTracks, align 8, !tbaa !5
...
for.inc53.i:                                      ; preds = %if.else50.i, %if.then40.i, %if.end37.i
  %inc54.i = add nuw i64 %track.1101.i, 1
  %51 = load i64, ptr @channelTracks, align 8, !tbaa !5
  %cmp14.not.not.i = icmp ult i64 %track.1101.i, %51
  br i1 %cmp14.not.not.i, label %for.body15.i, label %for.inc57.i, !llvm.loop !26
...
BuildCostMatrix.exit:                             ; preds = %for.inc57.i
  %.fr.i.le = freeze i64 %52
  %cmp.not25.i = icmp eq i64 %53, 0
  br i1 %cmp.not25.i, label %Select.exit, label %for.body.lr.ph.i

for.body.lr.ph.i:                                 ; preds = %BuildCostMatrix.exit
  %54 = load ptr, ptr @costMatrix, align 8
  %cmp3.not22.i = icmp eq i64 %.fr.i.le, 0
  br i1 %cmp3.not22.i, label %for.body.us.i.preheader, label %for.body.i.preheader

for.body.i.preheader:                             ; preds = %for.body.lr.ph.i
  %min.iters.check = icmp ult i64 %.fr.i.le, 4
  %n.vec = and i64 %.fr.i.le, -4
  %ind.end = or i64 %n.vec, 1
  %cmp.n = icmp eq i64 %.fr.i.le, %n.vec
  br label %for.body.i
...
for.body.us.i:                                    ; preds = %for.body.us.i, %for.body.us.i.preheader.new
  ...
  %56 = load i64, ptr %arrayidx.us.i, align 8, !tbaa !5
  %tobool.not.us.i = icmp eq i64 %56, 0
  %cmp6.us.i = icmp slt i64 %largest.028.us.i, 0
  %spec.select.us.i = select i1 %cmp6.us.i, i64 %net.027.us.i, i64 %select.026.us.i
  %select.1.us.i = select i1 %tobool.not.us.i, i64 %select.026.us.i, i64 %spec.select.us.i
  %largest.1.us.i = select i1 %tobool.not.us.i, i64 %largest.028.us.i, i64 0
  ...
  %57 = load i64, ptr %arrayidx.us.i.1, align 8, !tbaa !5
  %tobool.not.us.i.1 = icmp eq i64 %57, 0
  %cmp6.us.i.1 = icmp slt i64 %largest.1.us.i, 0
  %spec.select.us.i.1 = select i1 %cmp6.us.i.1, i64 %inc10.us.i, i64 %select.1.us.i
  %select.1.us.i.1 = select i1 %tobool.not.us.i.1, i64 %select.1.us.i, i64 %spec.select.us.i.1
  %largest.1.us.i.1 = select i1 %tobool.not.us.i.1, i64 %largest.1.us.i, i64 0
...
for.body.i:                                       ; preds = %for.body.i.preheader, %for.inc9.i
  ...
  %58 = load i64, ptr %arrayidx.i, align 8, !tbaa !5
  %tobool.not.i = icmp eq i64 %58, 0
  br i1 %tobool.not.i, label %for.inc9.i, label %if.then.i

if.then.i:                                        ; preds = %for.body.i
  %arrayidx1.i = getelementptr inbounds ptr, ptr %54, i64 %net.027.i
  %59 = load ptr, ptr %arrayidx1.i, align 8, !tbaa !9
  br i1 %min.iters.check, label %for.body4.i.preheader, label %vector.body

vector.body:                                      ; preds = %if.then.i, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %if.then.i ]
  %vec.phi = phi <2 x i64> [ %62, %vector.body ], [ zeroinitializer, %if.then.i ]
  %vec.phi102 = phi <2 x i64> [ %63, %vector.body ], [ zeroinitializer, %if.then.i ]
  %offset.idx = or i64 %index, 1
  %60 = getelementptr inbounds i64, ptr %59, i64 %offset.idx
  %wide.load = load <2 x i64>, ptr %60, align 8, !tbaa !5
  %61 = getelementptr inbounds i64, ptr %60, i64 2
  %wide.load103 = load <2 x i64>, ptr %61, align 8, !tbaa !5
  %62 = add <2 x i64> %wide.load, %vec.phi
  %63 = add <2 x i64> %wide.load103, %vec.phi102
  %index.next = add nuw i64 %index, 4
  %64 = icmp eq i64 %index.next, %n.vec
  br i1 %64, label %middle.block, label %vector.body, !llvm.loop !28

middle.block:                                     ; preds = %vector.body
  %bin.rdx = add <2 x i64> %63, %62
  %65 = tail call i64 @llvm.vector.reduce.add.v2i64(<2 x i64> %bin.rdx)
  br i1 %cmp.n, label %for.cond2.for.end_crit_edge.i, label %for.body4.i.preheader

for.body4.i.preheader:                            ; preds = %if.then.i, %middle.block
  %cost.024.i.ph = phi i64 [ 0, %if.then.i ], [ %65, %middle.block ]
  %track.023.i.ph = phi i64 [ 1, %if.then.i ], [ %ind.end, %middle.block ]
  br label %for.body4.i
...
for.body4.i:                                      ; preds = %for.body4.i.preheader, %for.body4.i
  %cost.024.i = phi i64 [ %add.i, %for.body4.i ], [ %cost.024.i.ph, %for.body4.i.preheader ]
  %track.023.i = phi i64 [ %inc.i, %for.body4.i ], [ %track.023.i.ph, %for.body4.i.preheader ]
  %arrayidx5.i = getelementptr inbounds i64, ptr %59, i64 %track.023.i
  %66 = load i64, ptr %arrayidx5.i, align 8, !tbaa !5
  %add.i = add nsw i64 %66, %cost.024.i
  %inc.i = add nuw i64 %track.023.i, 1
  %exitcond.i = icmp eq i64 %track.023.i, %.fr.i.le
  br i1 %exitcond.i, label %for.cond2.for.end_crit_edge.i, label %for.body4.i, !llvm.loop !29

for.cond2.for.end_crit_edge.i:                    ; preds = %for.body4.i, %middle.block
  %add.i.lcssa = phi i64 [ %65, %middle.block ], [ %add.i, %for.body4.i ]
  %cmp6.i = icmp sgt i64 %add.i.lcssa, %largest.028.i
  %spec.select.i = select i1 %cmp6.i, i64 %net.027.i, i64 %select.026.i
  %spec.select21.i = tail call i64 @llvm.smax.i64(i64 %add.i.lcssa, i64 %largest.028.i)
  br label %for.inc9.i
...
for.inc9.i:                                       ; preds = %for.cond2.for.end_crit_edge.i, %for.body.i
  ...
  %largest.1.i = phi i64 [ %largest.028.i, %for.body.i ], [ %spec.select21.i, %for.cond2.for.end_crit_edge.i ]
  %inc10.i = add nuw i64 %net.027.i, 1
  %exitcond31.i = icmp eq i64 %net.027.i, %53
  br i1 %exitcond31.i, label %Select.exit, label %for.body.i, !llvm.loop !16
...
for.body.us.i.epil:                               ; preds = %Select.exit.loopexit.unr-lcssa
  ...
  %67 = load i64, ptr %arrayidx.us.i.epil, align 8, !tbaa !5
  %tobool.not.us.i.epil = icmp eq i64 %67, 0
  %cmp6.us.i.epil = icmp slt i64 %largest.028.us.i.unr, 0
  %spec.select.us.i.epil = select i1 %cmp6.us.i.epil, i64 %net.027.us.i.unr, i64 %select.026.us.i.unr
  %select.1.us.i.epil = select i1 %tobool.not.us.i.epil, i64 %select.026.us.i.unr, i64 %spec.select.us.i.epil
  br label %Select.exit
...
Select.exit:                                      ; preds = %for.inc9.i, %for.body.us.i.epil, %Select.exit.loopexit.unr-lcssa, %for.cond8.preheader.i, %while.body, %BuildCostMatrix.exit
  ...
  %68 = load ptr, ptr @VCG, align 8, !tbaa !9
  %69 = load ptr, ptr @netsAssign, align 8, !tbaa !9
  tail call void @Assign(ptr noundef %68, ptr noundef %69, i64 noundef %select.0.lcssa.i)
  %70 = load ptr, ptr @CROSSING, align 8, !tbaa !9
  %arrayidx35 = getelementptr inbounds i64, ptr %70, i64 %select.0.lcssa.i
...
while.body:                                       ; preds = %while.body.preheader, %Select.exit
  %20 = phi ptr [ %71, %Select.exit ], [ %.pre, %while.body.preheader ]
  %netsCrossing.383 = phi i64 [ %dec, %Select.exit ], [ %netsCrossing.2, %while.body.preheader ]
...
for.body3.i:                                      ; preds = %for.body.i68, %for.body3.i
  ...
  store i64 0, ptr %arrayidx4.i, align 8, !tbaa !5
  %inc.i69 = add nuw i64 %track.097.i, 1
  %32 = load i64, ptr @channelTracks, align 8, !tbaa !5
  %cmp2.not.not.i = icmp ult i64 %track.097.i, %32
  br i1 %cmp2.not.not.i, label %for.body3.i, label %for.inc5.loopexit.i, !llvm.loop !23
...
if.then.i71:                                      ; preds = %for.body10.i
  ...
  tail call void @LongestPathVCG(ptr noundef %21, i64 noundef %net.1105.i) #9
  %39 = load ptr, ptr @tracksNoHCV, align 8, !tbaa !9
  tail call void @NoHCV(ptr noundef %22, i64 noundef %net.1105.i, ptr noundef %23, ptr noundef %39) #9
...
for.inc53.i:                                      ; preds = %if.else50.i, %if.then40.i, %if.end37.i
  ...
  %cmp14.not.not.i = icmp ult i64 %track.1101.i, %52
  br i1 %cmp14.not.not.i, label %for.body15.i, label %for.inc57.i, !llvm.loop !26
...
for.body.us.i:                                    ; preds = %for.body.us.i, %for.body.us.i.preheader.new
  ...
  %57 = load i64, ptr %arrayidx.us.i, align 8, !tbaa !5
  %tobool.not.us.i = icmp eq i64 %57, 0
  %cmp6.us.i = icmp slt i64 %largest.028.us.i, 0
  %spec.select.us.i = select i1 %cmp6.us.i, i64 %net.027.us.i, i64 %select.026.us.i
  %select.1.us.i = select i1 %tobool.not.us.i, i64 %select.026.us.i, i64 %spec.select.us.i
  %largest.1.us.i = select i1 %tobool.not.us.i, i64 %largest.028.us.i, i64 0
  ...
  %58 = load i64, ptr %arrayidx.us.i.1, align 8, !tbaa !5
  %tobool.not.us.i.1 = icmp eq i64 %58, 0
  %cmp6.us.i.1 = icmp slt i64 %largest.1.us.i, 0
  %spec.select.us.i.1 = select i1 %cmp6.us.i.1, i64 %inc10.us.i, i64 %select.1.us.i
  %select.1.us.i.1 = select i1 %tobool.not.us.i.1, i64 %select.1.us.i, i64 %spec.select.us.i.1
  %largest.1.us.i.1 = select i1 %tobool.not.us.i.1, i64 %largest.1.us.i, i64 0
...
for.body.i:                                       ; preds = %for.body.i.preheader, %for.inc9.i
  ...
  %59 = load i64, ptr %arrayidx.i, align 8, !tbaa !5
  %tobool.not.i = icmp eq i64 %59, 0
  br i1 %tobool.not.i, label %for.inc9.i, label %if.then.i

if.then.i:                                        ; preds = %for.body.i
  %arrayidx1.i = getelementptr inbounds ptr, ptr %55, i64 %net.027.i
  %60 = load ptr, ptr %arrayidx1.i, align 8, !tbaa !9
  br i1 %min.iters.check, label %for.body4.i.preheader, label %vector.body

vector.body:                                      ; preds = %if.then.i, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %if.then.i ]
  %vec.phi = phi <2 x i64> [ %63, %vector.body ], [ zeroinitializer, %if.then.i ]
  %vec.phi102 = phi <2 x i64> [ %64, %vector.body ], [ zeroinitializer, %if.then.i ]
  %offset.idx = or i64 %index, 1
  %61 = getelementptr inbounds i64, ptr %60, i64 %offset.idx
  %wide.load = load <2 x i64>, ptr %61, align 8, !tbaa !5
  %62 = getelementptr inbounds i64, ptr %61, i64 2
  %wide.load103 = load <2 x i64>, ptr %62, align 8, !tbaa !5
  %63 = add <2 x i64> %wide.load, %vec.phi
  %64 = add <2 x i64> %wide.load103, %vec.phi102
  %index.next = add nuw i64 %index, 4
  %65 = icmp eq i64 %index.next, %n.vec
  br i1 %65, label %middle.block, label %vector.body, !llvm.loop !33
...
for.body4.i.preheader:                            ; preds = %if.then.i, %middle.block
  %cost.024.i.ph = phi i64 [ 0, %if.then.i ], [ %66, %middle.block ]
  %track.023.i.ph = phi i64 [ 1, %if.then.i ], [ %ind.end, %middle.block ]
  br label %for.body4.i
...
for.body4.i:                                      ; preds = %for.body4.i.preheader, %for.body4.i
  %cost.024.i = phi i64 [ %add.i, %for.body4.i ], [ %cost.024.i.ph, %for.body4.i.preheader ]
  %track.023.i = phi i64 [ %inc.i, %for.body4.i ], [ %track.023.i.ph, %for.body4.i.preheader ]
  %arrayidx5.i = getelementptr inbounds i64, ptr %60, i64 %track.023.i
  %67 = load i64, ptr %arrayidx5.i, align 8, !tbaa !5
  %add.i = add nsw i64 %67, %cost.024.i
  %inc.i = add nuw i64 %track.023.i, 1
  %exitcond.i = icmp eq i64 %track.023.i, %.fr.i.le
  br i1 %exitcond.i, label %for.cond2.for.end_crit_edge.i, label %for.body4.i, !llvm.loop !34

for.cond2.for.end_crit_edge.i:                    ; preds = %for.body4.i, %middle.block
  %add.i.lcssa = phi i64 [ %66, %middle.block ], [ %add.i, %for.body4.i ]
  %cmp6.i = icmp sgt i64 %add.i.lcssa, %largest.028.i
  %spec.select.i = select i1 %cmp6.i, i64 %net.027.i, i64 %select.026.i
  %spec.select21.i = tail call i64 @llvm.smax.i64(i64 %add.i.lcssa, i64 %largest.028.i)
  br label %for.inc9.i
...
for.inc9.i:                                       ; preds = %for.cond2.for.end_crit_edge.i, %for.body.i
  ...
  %largest.1.i = phi i64 [ %largest.028.i, %for.body.i ], [ %spec.select21.i, %for.cond2.for.end_crit_edge.i ]
  %inc10.i = add nuw i64 %net.027.i, 1
  %exitcond31.i = icmp eq i64 %net.027.i, %54
  br i1 %exitcond31.i, label %Select.exit, label %for.body.i, !llvm.loop !16
...
for.body.us.i.epil:                               ; preds = %Select.exit.loopexit.unr-lcssa
  ...
  %68 = load i64, ptr %arrayidx.us.i.epil, align 8, !tbaa !5
  %tobool.not.us.i.epil = icmp eq i64 %68, 0
  %cmp6.us.i.epil = icmp slt i64 %largest.028.us.i.unr, 0
  %spec.select.us.i.epil = select i1 %cmp6.us.i.epil, i64 %net.027.us.i.unr, i64 %select.026.us.i.unr
  %select.1.us.i.epil = select i1 %tobool.not.us.i.epil, i64 %select.026.us.i.unr, i64 %spec.select.us.i.epil
  br label %Select.exit
...
Select.exit:                                      ; preds = %for.inc9.i, %for.body.us.i.epil, %Select.exit.loopexit.unr-lcssa, %for.cond8.preheader.i, %while.body, %BuildCostMatrix.exit
  %select.0.lcssa.i = phi i64 [ 0, %BuildCostMatrix.exit ], [ 0, %while.body ], [ 0, %for.cond8.preheader.i ], [ %select.1.us.i.lcssa.ph, %Select.exit.loopexit.unr-lcssa ], [ %select.1.us.i.epil, %for.body.us.i.epil ], [ %select.1.i, %for.inc9.i ]
  %69 = load ptr, ptr @VCG, align 8, !tbaa !9
  %70 = load ptr, ptr @netsAssign, align 8, !tbaa !9
  tail call void @Assign(ptr noundef %69, ptr noundef %70, i64 noundef %select.0.lcssa.i)
  %71 = load ptr, ptr @CROSSING, align 8, !tbaa !9
  %arrayidx35 = getelementptr inbounds i64, ptr %71, i64 %select.0.lcssa.i
  store i64 0, ptr %arrayidx35, align 8, !tbaa !5
  %dec = add i64 %netsCrossing.383, -1
  %cmp34.not = icmp eq i64 %dec, 0
...
for.inc37:                                        ; preds = %Select.exit, %if.then33, %lor.lhs.false
  ...
  %cmp2.not = icmp ugt i64 %col.0, %72
...
for.body.us.preheader:                            ; preds = %for.body.lr.ph
  ...
  %3 = icmp eq i64 %0, 1
  br i1 %3, label %for.end11.loopexit.unr-lcssa, label %for.body.us.preheader.new
...
for.body.us:                                      ; preds = %for.body.us, %for.body.us.preheader.new
  ...
  %5 = load i64, ptr %arrayidx.us.1, align 8, !tbaa !5
  %tobool.not.us.1 = icmp eq i64 %5, 0
...
vector.body:                                      ; preds = %if.then, %vector.body
  ...
  %vec.phi = phi <2 x i64> [ %10, %vector.body ], [ zeroinitializer, %if.then ]
  %vec.phi35 = phi <2 x i64> [ %11, %vector.body ], [ zeroinitializer, %if.then ]
  %offset.idx = or i64 %index, 1
  %8 = getelementptr inbounds i64, ptr %7, i64 %offset.idx
  %wide.load = load <2 x i64>, ptr %8, align 8, !tbaa !5
  %9 = getelementptr inbounds i64, ptr %8, i64 2
  %wide.load36 = load <2 x i64>, ptr %9, align 8, !tbaa !5
  %10 = add <2 x i64> %wide.load, %vec.phi
  %11 = add <2 x i64> %wide.load36, %vec.phi35
  %index.next = add nuw i64 %index, 4
...
for.body4:                                        ; preds = %for.body4.preheader, %for.body4
  ...
  %arrayidx5 = getelementptr inbounds i64, ptr %7, i64 %track.023
  %14 = load i64, ptr %arrayidx5, align 8, !tbaa !5
  %add = add nsw i64 %14, %cost.024
  %inc = add nuw i64 %track.023, 1
  %exitcond = icmp eq i64 %track.023, %.fr
...
for.cond2.for.end_crit_edge:                      ; preds = %for.body4, %middle.block
  %add.lcssa = phi i64 [ %13, %middle.block ], [ %add, %for.body4 ]
...
for.inc9:                                         ; preds = %for.cond2.for.end_crit_edge, %for.body
  ...
  %exitcond31 = icmp eq i64 %net.027, %0
  br i1 %exitcond31, label %for.end11, label %for.body, !llvm.loop !16
...
for.body.us.epil:                                 ; preds = %for.end11.loopexit.unr-lcssa
  ...
  %15 = load i64, ptr %arrayidx.us.epil, align 8, !tbaa !5
  %tobool.not.us.epil = icmp eq i64 %15, 0
...
entry:
  tail call void @LongestPathVCG(ptr noundef %VCG, i64 noundef %select) #9
  %0 = load ptr, ptr @HCG, align 8, !tbaa !9
  %1 = load ptr, ptr @tracksNoHCV, align 8, !tbaa !9
  tail call void @NoHCV(ptr noundef %0, i64 noundef %select, ptr noundef %assign, ptr noundef %1) #9
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %inc = add nuw i64 %track.0150, 1
  %8 = load i64, ptr @channelTracks, align 8, !tbaa !5
  %cmp.not.not = icmp ult i64 %track.0150, %8
  br i1 %cmp.not.not, label %for.body, label %for.cond2.preheader, !llvm.loop !39
...
for.inc10:                                        ; preds = %for.body4, %land.lhs.true, %if.then
  ...
  %inc11 = add nuw i64 %track.1153, 1
  %cmp3.not.not = icmp ult i64 %track.1153, %12
  br i1 %cmp3.not.not, label %for.body4, label %for.end12, !llvm.loop !40
...
for.inc30:                                        ; preds = %for.body17, %land.lhs.true20, %land.lhs.true23, %if.then26
  ...
  %inc31 = add nuw i64 %track.2156, 1
  %cmp16.not.not = icmp ult i64 %track.2156, %21
  br i1 %cmp16.not.not, label %for.body17, label %if.end33, !llvm.loop !41
...
if.then72:                                        ; preds = %for.body69
  ...
  %call = tail call i64 @VCV(ptr noundef %VCG, i64 noundef %select, i64 noundef %track.4164, ptr noundef %38) #9
...
for.body3:                                        ; preds = %for.body, %for.body3
  ...
  %inc = add nuw i64 %track.097, 1
  %7 = load i64, ptr @channelTracks, align 8, !tbaa !5
  %cmp2.not.not = icmp ult i64 %track.097, %7
  br i1 %cmp2.not.not, label %for.body3, label %for.inc5.loopexit, !llvm.loop !23
...
for.inc5:                                         ; preds = %for.inc5.loopexit, %for.body
  ...
  %inc6 = add nuw i64 %net.099, 1
  %cmp.not.not = icmp ult i64 %net.099, %8
  br i1 %cmp.not.not, label %for.body, label %for.cond8.preheader, !llvm.loop !24
...
if.then:                                          ; preds = %for.body10
  ...
  tail call void @LongestPathVCG(ptr noundef %VCG, i64 noundef %net.1105) #9
  %13 = load ptr, ptr @tracksNoHCV, align 8, !tbaa !9
  tail call void @NoHCV(ptr noundef %HCG, i64 noundef %net.1105, ptr noundef %netsAssign, ptr noundef %13) #9
...
for.inc53:                                        ; preds = %if.else50, %if.then40, %if.end37
  %inc54 = add nuw i64 %track.1101, 1
  %26 = load i64, ptr @channelTracks, align 8, !tbaa !5
  %cmp14.not.not = icmp ult i64 %track.1101, %26
  br i1 %cmp14.not.not, label %for.body15, label %for.inc57, !llvm.loop !26
