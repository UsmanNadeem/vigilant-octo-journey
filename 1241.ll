; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20020508-1.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/20020508-1.c"
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@uc = dso_local local_unnamed_addr global i8 52, align 1
@us = dso_local local_unnamed_addr global i16 -3532, align 2
@ui = dso_local local_unnamed_addr global i32 62004, align 4
@ul = dso_local local_unnamed_addr global i64 4063516280, align 8
@ull = dso_local local_unnamed_addr global i64 1090791845765373680, align 8
...
if.end12:                                         ; preds = %if.end
  ...
  %cmp21.not = icmp eq i32 %or20, 253972259
...
if.end24:                                         ; preds = %if.end12
  ...
  %cmp30.not = icmp eq i32 %or29, 253972259
...
if.end60:                                         ; preds = %if.end50
  %cmp64.not = icmp eq i64 %4, 4063516280
...
if.end77:                                         ; preds = %if.end67
  %cmp81.not = icmp eq i64 %5, 1090791845765373680
...
if.end84:                                         ; preds = %if.end77
  ...
  %shr86 = lshr i64 1090791845765373680, %sh_prom85
  %conv87 = sext i32 %6 to i64
  %sub88 = sub nsw i64 64, %conv87
  %shl89 = shl i64 1090791845765373680, %sub88
...
if.end122:                                        ; preds = %if.end101
  ...
  %cmp131.not = icmp eq i32 %or130, 992079
...
if.end134:                                        ; preds = %if.end122
  ...
  %cmp140.not = icmp eq i32 %or139, 992079
...
if.end143:                                        ; preds = %if.end134
  %shl144 = shl i32 62004, %1
  %shr148 = lshr i32 62004, %sub36
...
if.end160:                                        ; preds = %if.end143
  %shl162 = shl i64 4063516280, %sh_prom51
  %shr165 = lshr i64 4063516280, %sub54
...
if.end177:                                        ; preds = %if.end160
  %shl179 = shl i64 1090791845765373680, %sh_prom51
  %shr182 = lshr i64 1090791845765373680, %sub54
...
if.end194:                                        ; preds = %if.end177
  %shl196 = shl i64 1090791845765373680, %sh_prom85
  %shr199 = lshr i64 1090791845765373680, %sub88
