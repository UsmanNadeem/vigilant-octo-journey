; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/subsumption.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/subsumption.c"
...
while.body.i143.i.preheader:                      ; preds = %if.end46.i
  ...
  br i1 %lcmp.mod31.not, label %while.body.i143.i.prol.loopexit, label %while.body.i143.i.prol
...
while.body.i143.i.prol.loopexit:                  ; preds = %while.body.i143.i.prol, %while.body.i143.i.preheader
  %.unr32 = phi i32 [ %.pr.i137.i, %while.body.i143.i.preheader ], [ %dec.i.i.i141.i.prol, %while.body.i143.i.prol ]
...
while.body.i143.i:                                ; preds = %while.body.i143.i.prol.loopexit, %while.body.i143.i
  %58 = phi i32 [ %dec.i.i.i141.i.1, %while.body.i143.i ], [ %.unr32, %while.body.i143.i.prol.loopexit ]
...
while.end.i.i:                                    ; preds = %while.body.i143.i.prol.loopexit, %while.body.i143.i, %if.end46.i
  ...
  br i1 %cmp.i.not.i.i, label %cont_BackTrack.exit.i, label %if.then.i146.i
...
if.end10:                                         ; preds = %if.then5, %if.end
  %call11 = tail call fastcc i32 @subs_STMultiIntern(i32 noundef 0, ptr noundef %c1, ptr noundef %c2)
  br label %cleanup
...
if.end:                                           ; preds = %if.then6
  ...
  %call13 = tail call fastcc i32 @subs_STMultiIntern(i32 noundef %add, ptr noundef nonnull %c1, ptr noundef nonnull %c2)
...
while.end.i133:                                   ; preds = %while.body.i131.prol.loopexit, %while.body.i131, %if.then15
  ...
  %cmp.i.not.i132 = icmp eq i32 %42, 0
  br i1 %cmp.i.not.i132, label %cleanup, label %cleanup.sink.split
...
while.end.i148:                                   ; preds = %while.body.i146.prol.loopexit, %while.body.i146, %if.end20
  ...
  %cmp.i.not.i147 = icmp eq i32 %55, 0
  br i1 %cmp.i.not.i147, label %cont_BackTrack.exit153, label %if.then.i152
...
while.end.i217:                                   ; preds = %while.body.i215.prol.loopexit, %while.body.i215, %if.then60
  ...
  %cmp.i.not.i216 = icmp eq i32 %97, 0
  br i1 %cmp.i.not.i216, label %cleanup, label %cleanup.sink.split

if.end62:                                         ; preds = %if.then56
  %98 = load i32, ptr @stamp, align 4
  store i32 %98, ptr %arrayidx, align 4
  %call66 = tail call fastcc i32 @subs_STMultiIntern(i32 noundef %add, ptr noundef nonnull %c1, ptr noundef %c2)
...
while.end.i232:                                   ; preds = %while.body.i230.prol.loopexit, %while.body.i230, %if.then68
  ...
  %cmp.i.not.i231 = icmp eq i32 %110, 0
  br i1 %cmp.i.not.i231, label %cleanup, label %cleanup.sink.split
...
while.end.i247:                                   ; preds = %while.body.i245.prol.loopexit, %while.body.i245, %if.end73
  ...
  %cmp.i.not.i246 = icmp eq i32 %122, 0
  br i1 %cmp.i.not.i246, label %if.end76, label %if.then.i251
...
if.end76:                                         ; preds = %fol_Atom.exit.thread, %if.then.i251, %while.end.i247, %cont_BackTrack.exit153, %fol_Atom.exit, %fol_Atom.exit165, %lor.lhs.false, %while.body
  ...
  br i1 %exitcond.not, label %cleanup, label %while.body, !llvm.loop !10
...
while.cond.i:                                     ; preds = %while.cond.i, %land.lhs.true
  ...
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  br i1 %18, label %while.cond.i, label %while.cond3.preheader.i, !llvm.loop !11
...
while.body.i176.i.preheader:                      ; preds = %if.end57.i
  ...
  br i1 %lcmp.mod56.not, label %while.body.i176.i.prol.loopexit, label %while.body.i176.i.prol
...
while.body.i176.i.prol.loopexit:                  ; preds = %while.body.i176.i.prol, %while.body.i176.i.preheader
  %.unr57 = phi i32 [ %.pr.i170.i, %while.body.i176.i.preheader ], [ %dec.i.i.i174.i.prol, %while.body.i176.i.prol ]
...
while.body.i176.i:                                ; preds = %while.body.i176.i.prol.loopexit, %while.body.i176.i
  %72 = phi i32 [ %dec.i.i.i174.i.1, %while.body.i176.i ], [ %.unr57, %while.body.i176.i.prol.loopexit ]
...
while.end.i.i:                                    ; preds = %while.body.i176.i.prol.loopexit, %while.body.i176.i, %if.end57.i
  ...
  br i1 %cmp.i.not.i.i, label %do.cond.i, label %if.then.i179.i
...
do.cond.i:                                        ; preds = %if.then.i179.i, %while.end.i.i, %if.then.i
  ...
  br i1 %81, label %do.body.i, label %do.end.i, !llvm.loop !12
...
do.body67.i:                                      ; preds = %do.body67.i, %do.body67.preheader.i
  ...
  %84 = select i1 %cmp72.i, i1 %cmp74.i, i1 false
  br i1 %84, label %do.body67.i, label %do.end76.i, !llvm.loop !13

do.end76.i:                                       ; preds = %do.body67.i
  %85 = trunc i64 %indvars.iv.next185.i to i32
  %cmp4.i = icmp sgt i32 %add3.i, %85
  br i1 %cmp4.i, label %while.body5.i, label %if.end24, !llvm.loop !14

if.end24:                                         ; preds = %do.end76.i, %while.cond3.preheader.i, %if.end16
  %call25 = tail call fastcc i32 @subs_STMultiExceptIntern(ptr noundef %C1, ptr noundef %C2)
  br label %cleanup
...
if.else:                                          ; preds = %if.then
  br i1 %cmp.i.not.i.i, label %if.then.i.i154, label %clause_GetLiteralAtom.exit156

if.then.i.i154:                                   ; preds = %if.else
  %15 = getelementptr i8, ptr %call.val.i, i64 16
  %call1.val.i.i152 = load ptr, ptr %15, align 8
  %16 = getelementptr i8, ptr %call1.val.i.i152, i64 8
  %call1.val.val.i.i153 = load ptr, ptr %16, align 8
  br label %clause_GetLiteralAtom.exit156

clause_GetLiteralAtom.exit156:                    ; preds = %if.else, %if.then.i.i154
  %retval.0.i.i155 = phi ptr [ %call1.val.val.i.i153, %if.then.i.i154 ], [ %call.val.i, %if.else ]
  %call8 = tail call i32 @term_NumberOfVarOccs(ptr noundef %retval.0.i.i155) #7
...
if.then29:                                        ; preds = %if.then25
  ...
  %call32 = tail call fastcc i32 @subs_STMultiExceptIntern(ptr noundef %C1, ptr noundef nonnull %C2)
...
if.end39:                                         ; preds = %if.end36, %if.then25
  ...
  br i1 %cmp2.i168, label %while.body.i174.preheader, label %while.end.i176

while.body.i174.preheader:                        ; preds = %if.end39
  %xtraiter = and i32 %.pr.i167, 1
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %while.body.i174.prol.loopexit, label %while.body.i174.prol

while.body.i174.prol:                             ; preds = %while.body.i174.preheader
  %46 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %46, ptr @cont_CURRENTBINDING, align 8
  %47 = getelementptr i8, ptr %46, i64 24
  %call.val.i.i.i169.prol = load ptr, ptr %47, align 8
  store ptr %call.val.i.i.i169.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i170.prol = getelementptr inbounds %struct.binding, ptr %46, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i170.prol, i8 0, i64 20, i1 false)
  %48 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i171.prol = getelementptr inbounds %struct.binding, ptr %48, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i171.prol, align 8
  %dec.i.i.i172.prol = add nsw i32 %.pr.i167, -1
  store i32 %dec.i.i.i172.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i174.prol.loopexit

while.body.i174.prol.loopexit:                    ; preds = %while.body.i174.prol, %while.body.i174.preheader
  %.unr = phi i32 [ %.pr.i167, %while.body.i174.preheader ], [ %dec.i.i.i172.prol, %while.body.i174.prol ]
  %49 = icmp eq i32 %.pr.i167, 1
  br i1 %49, label %while.end.i176, label %while.body.i174

while.body.i174:                                  ; preds = %while.body.i174.prol.loopexit, %while.body.i174
  %50 = phi i32 [ %dec.i.i.i172.1, %while.body.i174 ], [ %.unr, %while.body.i174.prol.loopexit ]
  %51 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %51, ptr @cont_CURRENTBINDING, align 8
  %52 = getelementptr i8, ptr %51, i64 24
  %call.val.i.i.i169 = load ptr, ptr %52, align 8
  store ptr %call.val.i.i.i169, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i170 = getelementptr inbounds %struct.binding, ptr %51, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i170, i8 0, i64 20, i1 false)
  %53 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i171 = getelementptr inbounds %struct.binding, ptr %53, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i171, align 8
  %dec.i.i.i172 = add nsw i32 %50, -1
  store i32 %dec.i.i.i172, ptr @cont_BINDINGS, align 4
  %54 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %54, ptr @cont_CURRENTBINDING, align 8
  %55 = getelementptr i8, ptr %54, i64 24
  %call.val.i.i.i169.1 = load ptr, ptr %55, align 8
  store ptr %call.val.i.i.i169.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i170.1 = getelementptr inbounds %struct.binding, ptr %54, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i170.1, i8 0, i64 20, i1 false)
  %56 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i171.1 = getelementptr inbounds %struct.binding, ptr %56, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i171.1, align 8
  %dec.i.i.i172.1 = add nsw i32 %50, -2
  store i32 %dec.i.i.i172.1, ptr @cont_BINDINGS, align 4
  %cmp.i173.1 = icmp ugt i32 %dec.i.i.i172, 1
  br i1 %cmp.i173.1, label %while.body.i174, label %while.end.i176, !llvm.loop !8

while.end.i176:                                   ; preds = %while.body.i174.prol.loopexit, %while.body.i174, %if.end39
  %57 = phi i32 [ %.pr.i167, %if.end39 ], [ 0, %while.body.i174 ], [ 0, %while.body.i174.prol.loopexit ]
  %58 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i175 = icmp eq i32 %58, 0
  br i1 %cmp.i.not.i175, label %cont_BackTrack.exit181, label %if.then.i180

if.then.i180:                                     ; preds = %while.end.i176
  %dec.i.i177 = add nsw i32 %58, -1
  store i32 %dec.i.i177, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i178 = sext i32 %dec.i.i177 to i64
  %arrayidx.i.i179 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i178
  %59 = load i32, ptr %arrayidx.i.i179, align 4
  store i32 %59, ptr @cont_BINDINGS, align 4
  br label %cont_BackTrack.exit181

cont_BackTrack.exit181:                           ; preds = %while.end.i176, %if.then.i180
  %60 = phi i32 [ 0, %while.end.i176 ], [ %dec.i.i177, %if.then.i180 ]
  %61 = phi i32 [ %57, %while.end.i176 ], [ %59, %if.then.i180 ]
...
fol_Atom.exit193:                                 ; preds = %fol_Atom.exit
  ...
  %Lit.val4.i189 = load ptr, ptr %66, align 8
  %67 = getelementptr i8, ptr %Lit.val4.i189, i64 8
  %Lit.val4.val.i190 = load ptr, ptr %67, align 8
  %call49.val.pre = load i32, ptr %Lit.val4.val.i190, align 8
...
if.then59:                                        ; preds = %lor.lhs.false, %land.lhs.true52
  ...
  br i1 %cmp.i204, label %if.then.i207, label %fol_Atom.exit209

if.then.i207:                                     ; preds = %if.then59
  %Lit.val4.i205 = load ptr, ptr %24, align 8
  %73 = getelementptr i8, ptr %Lit.val4.i205, i64 8
  %Lit.val4.val.i206 = load ptr, ptr %73, align 8
  br label %fol_Atom.exit209

fol_Atom.exit209:                                 ; preds = %if.then59, %if.then.i207
  %retval.0.i208 = phi ptr [ %Lit.val4.val.i206, %if.then.i207 ], [ %call.val.i159, %if.then59 ]
  %74 = getelementptr i8, ptr %retval.0.i208, i64 16
  ...
  br i1 %cmp.i211, label %if.then.i214, label %fol_Atom.exit216

if.then.i214:                                     ; preds = %fol_Atom.exit209
  %76 = getelementptr i8, ptr %call.val.i162, i64 16
  %Lit.val4.i212 = load ptr, ptr %76, align 8
  %77 = getelementptr i8, ptr %Lit.val4.i212, i64 8
  %Lit.val4.val.i213 = load ptr, ptr %77, align 8
  br label %fol_Atom.exit216

fol_Atom.exit216:                                 ; preds = %fol_Atom.exit209, %if.then.i214
  %retval.0.i215 = phi ptr [ %Lit.val4.val.i213, %if.then.i214 ], [ %call.val.i162, %fol_Atom.exit209 ]
  %78 = getelementptr i8, ptr %retval.0.i215, i64 16
...
land.lhs.true67:                                  ; preds = %fol_Atom.exit216
  ...
  br i1 %cmp.i218, label %if.then.i221, label %fol_Atom.exit223

if.then.i221:                                     ; preds = %land.lhs.true67
  %Lit.val4.i219 = load ptr, ptr %24, align 8
  %82 = getelementptr i8, ptr %Lit.val4.i219, i64 8
  %Lit.val4.val.i220 = load ptr, ptr %82, align 8
  br label %fol_Atom.exit223

fol_Atom.exit223:                                 ; preds = %land.lhs.true67, %if.then.i221
  %retval.0.i222 = phi ptr [ %Lit.val4.val.i220, %if.then.i221 ], [ %call.val.i159, %land.lhs.true67 ]
  %83 = getelementptr i8, ptr %retval.0.i222, i64 16
  ...
  br i1 %cmp.i225, label %if.then.i228, label %fol_Atom.exit230

if.then.i228:                                     ; preds = %fol_Atom.exit223
  %85 = getelementptr i8, ptr %call.val.i162, i64 16
  %Lit.val4.i226 = load ptr, ptr %85, align 8
  %86 = getelementptr i8, ptr %Lit.val4.i226, i64 8
  %Lit.val4.val.i227 = load ptr, ptr %86, align 8
  br label %fol_Atom.exit230

fol_Atom.exit230:                                 ; preds = %fol_Atom.exit223, %if.then.i228
  %retval.0.i229 = phi ptr [ %Lit.val4.val.i227, %if.then.i228 ], [ %call.val.i162, %fol_Atom.exit223 ]
  %87 = getelementptr i8, ptr %retval.0.i229, i64 16
...
if.then75:                                        ; preds = %fol_Atom.exit230
  ...
  %call78 = tail call fastcc i32 @subs_STMultiExceptIntern(ptr noundef nonnull %C1, ptr noundef %C2)
...
if.then80:                                        ; preds = %if.then75
  ...
  br i1 %cmp2.i232, label %while.body.i238.preheader, label %while.end.i240

while.body.i238.preheader:                        ; preds = %if.then80
  %xtraiter294 = and i32 %.pr.i231, 1
  %lcmp.mod295.not = icmp eq i32 %xtraiter294, 0
  br i1 %lcmp.mod295.not, label %while.body.i238.prol.loopexit, label %while.body.i238.prol

while.body.i238.prol:                             ; preds = %while.body.i238.preheader
  %90 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %90, ptr @cont_CURRENTBINDING, align 8
  %91 = getelementptr i8, ptr %90, i64 24
  %call.val.i.i.i233.prol = load ptr, ptr %91, align 8
  store ptr %call.val.i.i.i233.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i234.prol = getelementptr inbounds %struct.binding, ptr %90, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i234.prol, i8 0, i64 20, i1 false)
  %92 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i235.prol = getelementptr inbounds %struct.binding, ptr %92, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i235.prol, align 8
  %dec.i.i.i236.prol = add nsw i32 %.pr.i231, -1
  store i32 %dec.i.i.i236.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i238.prol.loopexit

while.body.i238.prol.loopexit:                    ; preds = %while.body.i238.prol, %while.body.i238.preheader
  %.unr296 = phi i32 [ %.pr.i231, %while.body.i238.preheader ], [ %dec.i.i.i236.prol, %while.body.i238.prol ]
  %93 = icmp eq i32 %.pr.i231, 1
  br i1 %93, label %while.end.i240, label %while.body.i238

while.body.i238:                                  ; preds = %while.body.i238.prol.loopexit, %while.body.i238
  %94 = phi i32 [ %dec.i.i.i236.1, %while.body.i238 ], [ %.unr296, %while.body.i238.prol.loopexit ]
  %95 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %95, ptr @cont_CURRENTBINDING, align 8
  %96 = getelementptr i8, ptr %95, i64 24
  %call.val.i.i.i233 = load ptr, ptr %96, align 8
  store ptr %call.val.i.i.i233, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i234 = getelementptr inbounds %struct.binding, ptr %95, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i234, i8 0, i64 20, i1 false)
  %97 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i235 = getelementptr inbounds %struct.binding, ptr %97, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i235, align 8
  %dec.i.i.i236 = add nsw i32 %94, -1
  store i32 %dec.i.i.i236, ptr @cont_BINDINGS, align 4
  %98 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %98, ptr @cont_CURRENTBINDING, align 8
  %99 = getelementptr i8, ptr %98, i64 24
  %call.val.i.i.i233.1 = load ptr, ptr %99, align 8
  store ptr %call.val.i.i.i233.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i234.1 = getelementptr inbounds %struct.binding, ptr %98, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i234.1, i8 0, i64 20, i1 false)
  %100 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i235.1 = getelementptr inbounds %struct.binding, ptr %100, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i235.1, align 8
  %dec.i.i.i236.1 = add nsw i32 %94, -2
  store i32 %dec.i.i.i236.1, ptr @cont_BINDINGS, align 4
  %cmp.i237.1 = icmp ugt i32 %dec.i.i.i236, 1
  br i1 %cmp.i237.1, label %while.body.i238, label %while.end.i240, !llvm.loop !8

while.end.i240:                                   ; preds = %while.body.i238.prol.loopexit, %while.body.i238, %if.then80
  %101 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i239 = icmp eq i32 %101, 0
  br i1 %cmp.i.not.i239, label %cleanup, label %if.then.i244

if.then.i244:                                     ; preds = %while.end.i240
  %dec.i.i241 = add nsw i32 %101, -1
  store i32 %dec.i.i241, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i242 = sext i32 %dec.i.i241 to i64
  %arrayidx.i.i243 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i242
  %102 = load i32, ptr %arrayidx.i.i243, align 4
...
if.end85:                                         ; preds = %if.end82, %fol_Atom.exit230, %fol_Atom.exit216
  ...
  br i1 %cmp2.i247, label %while.body.i253.preheader, label %while.end.i255

while.body.i253.preheader:                        ; preds = %if.end85
  %xtraiter288 = and i32 %.pr.i246, 1
  %lcmp.mod289.not = icmp eq i32 %xtraiter288, 0
  br i1 %lcmp.mod289.not, label %while.body.i253.prol.loopexit, label %while.body.i253.prol

while.body.i253.prol:                             ; preds = %while.body.i253.preheader
  %103 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %103, ptr @cont_CURRENTBINDING, align 8
  %104 = getelementptr i8, ptr %103, i64 24
  %call.val.i.i.i248.prol = load ptr, ptr %104, align 8
  store ptr %call.val.i.i.i248.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i249.prol = getelementptr inbounds %struct.binding, ptr %103, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i249.prol, i8 0, i64 20, i1 false)
  %105 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i250.prol = getelementptr inbounds %struct.binding, ptr %105, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i250.prol, align 8
  %dec.i.i.i251.prol = add nsw i32 %.pr.i246, -1
  store i32 %dec.i.i.i251.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i253.prol.loopexit

while.body.i253.prol.loopexit:                    ; preds = %while.body.i253.prol, %while.body.i253.preheader
  %.unr290 = phi i32 [ %.pr.i246, %while.body.i253.preheader ], [ %dec.i.i.i251.prol, %while.body.i253.prol ]
  %106 = icmp eq i32 %.pr.i246, 1
  br i1 %106, label %while.end.i255, label %while.body.i253

while.body.i253:                                  ; preds = %while.body.i253.prol.loopexit, %while.body.i253
  %107 = phi i32 [ %dec.i.i.i251.1, %while.body.i253 ], [ %.unr290, %while.body.i253.prol.loopexit ]
  %108 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %108, ptr @cont_CURRENTBINDING, align 8
  %109 = getelementptr i8, ptr %108, i64 24
  %call.val.i.i.i248 = load ptr, ptr %109, align 8
  store ptr %call.val.i.i.i248, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i249 = getelementptr inbounds %struct.binding, ptr %108, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i249, i8 0, i64 20, i1 false)
  %110 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i250 = getelementptr inbounds %struct.binding, ptr %110, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i250, align 8
  %dec.i.i.i251 = add nsw i32 %107, -1
  store i32 %dec.i.i.i251, ptr @cont_BINDINGS, align 4
  %111 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %111, ptr @cont_CURRENTBINDING, align 8
  %112 = getelementptr i8, ptr %111, i64 24
  %call.val.i.i.i248.1 = load ptr, ptr %112, align 8
  store ptr %call.val.i.i.i248.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i249.1 = getelementptr inbounds %struct.binding, ptr %111, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i249.1, i8 0, i64 20, i1 false)
  %113 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i250.1 = getelementptr inbounds %struct.binding, ptr %113, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i250.1, align 8
  %dec.i.i.i251.1 = add nsw i32 %107, -2
  store i32 %dec.i.i.i251.1, ptr @cont_BINDINGS, align 4
  %cmp.i252.1 = icmp ugt i32 %dec.i.i.i251, 1
  br i1 %cmp.i252.1, label %while.body.i253, label %while.end.i255, !llvm.loop !8

while.end.i255:                                   ; preds = %while.body.i253.prol.loopexit, %while.body.i253, %if.end85
  %114 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i254 = icmp eq i32 %114, 0
  br i1 %cmp.i.not.i254, label %if.end88, label %if.then.i259

if.then.i259:                                     ; preds = %while.end.i255
  %dec.i.i256 = add nsw i32 %114, -1
  store i32 %dec.i.i256, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i257 = sext i32 %dec.i.i256 to i64
  %arrayidx.i.i258 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i257
  %115 = load i32, ptr %arrayidx.i.i258, align 4
  store i32 %115, ptr @cont_BINDINGS, align 4
  br label %if.end88

if.end88:                                         ; preds = %fol_Atom.exit.thread, %if.then.i259, %while.end.i255, %cont_BackTrack.exit181, %fol_Atom.exit, %fol_Atom.exit193, %lor.lhs.false, %while.body21
  %indvars.iv.next274 = add nuw nsw i64 %indvars.iv273, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next274, %wide.trip.count
  br i1 %exitcond.not, label %while.end90, label %while.body21, !llvm.loop !16

while.end90:                                      ; preds = %if.end88, %if.end15
  store i32 0, ptr %arrayidx18, align 4
  br label %cleanup

cleanup:                                          ; preds = %entry, %if.then.i244, %while.end.i240, %if.then.i, %while.end.i, %while.end, %while.end90
  %retval.0 = phi i32 [ 0, %while.end90 ], [ 1, %while.end ], [ 1, %while.end.i ], [ 1, %if.then.i ], [ 1, %while.end.i240 ], [ 1, %if.then.i244 ], [ 1, %entry ]
  ret i32 %retval.0
}
...
land.lhs.true:                                    ; preds = %if.end40
  %call44 = tail call fastcc i32 @subs_PartnerTest(ptr noundef nonnull %C1, i32 noundef 0, i32 noundef %C1.val105, ptr noundef nonnull %C2, i32 noundef 0, i32 noundef %C2.val104)
  %tobool.not = icmp eq i32 %call44, 0
  br i1 %tobool.not, label %cleanup, label %lor.lhs.false45

lor.lhs.false45:                                  ; preds = %land.lhs.true
  %call46 = tail call fastcc i32 @subs_PartnerTest(ptr noundef nonnull %C1, i32 noundef %C1.val105, i32 noundef %add.i, ptr noundef nonnull %C2, i32 noundef %C2.val104, i32 noundef %add.i111)
  %tobool47.not = icmp eq i32 %call46, 0
  br i1 %tobool47.not, label %cleanup, label %lor.lhs.false48

lor.lhs.false48:                                  ; preds = %lor.lhs.false45
  %call49 = tail call fastcc i32 @subs_PartnerTest(ptr noundef nonnull %C1, i32 noundef %add.i, i32 noundef %add3.i, ptr noundef nonnull %C2, i32 noundef %add.i111, i32 noundef %add3.i116)
  %tobool50.not = icmp eq i32 %call49, 0
  br i1 %tobool50.not, label %cleanup, label %if.end52

if.end52:                                         ; preds = %lor.lhs.false48, %if.end40
  %call53 = tail call fastcc i32 @subs_SubsumesInternBasic(ptr noundef nonnull %C1, i32 noundef %C1.val105, i32 noundef %add.i, i32 noundef %add3.i, ptr noundef nonnull %C2, i32 noundef %C2.val104, i32 noundef %add.i111, i32 noundef %add3.i116)
  br label %cleanup
...
while.cond:                                       ; preds = %while.cond, %while.cond.preheader
  ...
  br i1 %4, label %while.cond, label %while.end, !llvm.loop !17
...
while.end.i:                                      ; preds = %while.body.i180.prol.loopexit, %while.body.i180, %if.end61
  ...
  br i1 %cmp.i.not.i, label %do.cond, label %if.then.i183
...
do.cond:                                          ; preds = %if.then.i183, %while.end.i, %if.then11
  ...
  br i1 %68, label %do.body7, label %do.end, !llvm.loop !18
...
do.body71:                                        ; preds = %do.body71.preheader, %do.body71
  ...
  %71 = select i1 %cmp76, i1 %cmp78, i1 false
  br i1 %71, label %do.body71, label %do.cond81, !llvm.loop !19

do.cond81:                                        ; preds = %do.body71
  br i1 %cmp78, label %do.body, label %cleanup, !llvm.loop !20
...
if.else:                                          ; preds = %if.then
  br i1 %cmp.i.not.i.i, label %if.then.i.i171, label %clause_GetLiteralAtom.exit173

if.then.i.i171:                                   ; preds = %if.else
  %9 = getelementptr i8, ptr %call.val.i, i64 16
  %call1.val.i.i169 = load ptr, ptr %9, align 8
  %10 = getelementptr i8, ptr %call1.val.i.i169, i64 8
  %call1.val.val.i.i170 = load ptr, ptr %10, align 8
  br label %clause_GetLiteralAtom.exit173

clause_GetLiteralAtom.exit173:                    ; preds = %if.else, %if.then.i.i171
  %retval.0.i.i172 = phi ptr [ %call1.val.val.i.i170, %if.then.i.i171 ], [ %call.val.i, %if.else ]
  %call7 = tail call i32 @term_NumberOfVarOccs(ptr noundef %retval.0.i.i172) #7
...
if.then37:                                        ; preds = %if.then33
  ...
  %call40 = tail call fastcc i32 @subs_SubsumesInternBasic(ptr noundef %C1, i32 noundef %c1fa, i32 noundef %c1fs, i32 noundef %c1l, ptr noundef nonnull %C2, i32 noundef %c2fa, i32 noundef %c2fs, i32 noundef %c2l)
...
if.end47:                                         ; preds = %if.end44, %if.then33
  ...
  br i1 %cmp2.i185, label %while.body.i191.preheader, label %while.end.i193

while.body.i191.preheader:                        ; preds = %if.end47
...
while.body.i191.prol:                             ; preds = %while.body.i191.preheader
  ...
  store ptr %40, ptr @cont_CURRENTBINDING, align 8
  %41 = getelementptr i8, ptr %40, i64 24
  %call.val.i.i.i186.prol = load ptr, ptr %41, align 8
  store ptr %call.val.i.i.i186.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i187.prol = getelementptr inbounds %struct.binding, ptr %40, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i187.prol, i8 0, i64 20, i1 false)
  %42 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i188.prol = getelementptr inbounds %struct.binding, ptr %42, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i188.prol, align 8
  %dec.i.i.i189.prol = add nsw i32 %.pr.i184, -1
  store i32 %dec.i.i.i189.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i191.prol.loopexit

while.body.i191.prol.loopexit:                    ; preds = %while.body.i191.prol, %while.body.i191.preheader
  %.unr = phi i32 [ %.pr.i184, %while.body.i191.preheader ], [ %dec.i.i.i189.prol, %while.body.i191.prol ]
  %43 = icmp eq i32 %.pr.i184, 1
  br i1 %43, label %while.end.i193, label %while.body.i191

while.body.i191:                                  ; preds = %while.body.i191.prol.loopexit, %while.body.i191
  %44 = phi i32 [ %dec.i.i.i189.1, %while.body.i191 ], [ %.unr, %while.body.i191.prol.loopexit ]
  %45 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %45, ptr @cont_CURRENTBINDING, align 8
  %46 = getelementptr i8, ptr %45, i64 24
  %call.val.i.i.i186 = load ptr, ptr %46, align 8
  store ptr %call.val.i.i.i186, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i187 = getelementptr inbounds %struct.binding, ptr %45, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i187, i8 0, i64 20, i1 false)
  %47 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i188 = getelementptr inbounds %struct.binding, ptr %47, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i188, align 8
  %dec.i.i.i189 = add nsw i32 %44, -1
  store i32 %dec.i.i.i189, ptr @cont_BINDINGS, align 4
  %48 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %48, ptr @cont_CURRENTBINDING, align 8
  %49 = getelementptr i8, ptr %48, i64 24
  %call.val.i.i.i186.1 = load ptr, ptr %49, align 8
  store ptr %call.val.i.i.i186.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i187.1 = getelementptr inbounds %struct.binding, ptr %48, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i187.1, i8 0, i64 20, i1 false)
  %50 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i188.1 = getelementptr inbounds %struct.binding, ptr %50, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i188.1, align 8
  %dec.i.i.i189.1 = add nsw i32 %44, -2
  store i32 %dec.i.i.i189.1, ptr @cont_BINDINGS, align 4
  %cmp.i190.1 = icmp ugt i32 %dec.i.i.i189, 1
  br i1 %cmp.i190.1, label %while.body.i191, label %while.end.i193, !llvm.loop !8

while.end.i193:                                   ; preds = %while.body.i191.prol.loopexit, %while.body.i191, %if.end47
  %51 = phi i32 [ %.pr.i184, %if.end47 ], [ 0, %while.body.i191 ], [ 0, %while.body.i191.prol.loopexit ]
  %52 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i192 = icmp eq i32 %52, 0
  br i1 %cmp.i.not.i192, label %cont_BackTrack.exit198, label %if.then.i197

if.then.i197:                                     ; preds = %while.end.i193
  %dec.i.i194 = add nsw i32 %52, -1
  store i32 %dec.i.i194, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i195 = sext i32 %dec.i.i194 to i64
  %arrayidx.i.i196 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i195
  %53 = load i32, ptr %arrayidx.i.i196, align 4
  store i32 %53, ptr @cont_BINDINGS, align 4
  br label %cont_BackTrack.exit198

cont_BackTrack.exit198:                           ; preds = %while.end.i193, %if.then.i197
  %54 = phi i32 [ 0, %while.end.i193 ], [ %dec.i.i194, %if.then.i197 ]
  %55 = phi i32 [ %51, %while.end.i193 ], [ %53, %if.then.i197 ]
...
fol_Atom.exit210:                                 ; preds = %fol_Atom.exit
  ...
  %Lit.val4.i206 = load ptr, ptr %60, align 8
  %61 = getelementptr i8, ptr %Lit.val4.i206, i64 8
  %Lit.val4.val.i207 = load ptr, ptr %61, align 8
  %call57.val.pre = load i32, ptr %Lit.val4.val.i207, align 8
...
if.then67:                                        ; preds = %lor.lhs.false, %land.lhs.true60
  ...
  br i1 %cmp.i221, label %if.then.i224, label %fol_Atom.exit226

if.then.i224:                                     ; preds = %if.then67
  %Lit.val4.i222 = load ptr, ptr %17, align 8
  %67 = getelementptr i8, ptr %Lit.val4.i222, i64 8
  %Lit.val4.val.i223 = load ptr, ptr %67, align 8
  br label %fol_Atom.exit226

fol_Atom.exit226:                                 ; preds = %if.then67, %if.then.i224
  %retval.0.i225 = phi ptr [ %Lit.val4.val.i223, %if.then.i224 ], [ %call.val.i176, %if.then67 ]
  %68 = getelementptr i8, ptr %retval.0.i225, i64 16
  ...
  br i1 %cmp.i228, label %if.then.i231, label %fol_Atom.exit233

if.then.i231:                                     ; preds = %fol_Atom.exit226
  %70 = getelementptr i8, ptr %call.val.i179, i64 16
  %Lit.val4.i229 = load ptr, ptr %70, align 8
  %71 = getelementptr i8, ptr %Lit.val4.i229, i64 8
  %Lit.val4.val.i230 = load ptr, ptr %71, align 8
  br label %fol_Atom.exit233

fol_Atom.exit233:                                 ; preds = %fol_Atom.exit226, %if.then.i231
  %retval.0.i232 = phi ptr [ %Lit.val4.val.i230, %if.then.i231 ], [ %call.val.i179, %fol_Atom.exit226 ]
  %72 = getelementptr i8, ptr %retval.0.i232, i64 16
...
land.lhs.true75:                                  ; preds = %fol_Atom.exit233
  ...
  br i1 %cmp.i235, label %if.then.i238, label %fol_Atom.exit240

if.then.i238:                                     ; preds = %land.lhs.true75
  %Lit.val4.i236 = load ptr, ptr %17, align 8
  %76 = getelementptr i8, ptr %Lit.val4.i236, i64 8
  %Lit.val4.val.i237 = load ptr, ptr %76, align 8
  br label %fol_Atom.exit240

fol_Atom.exit240:                                 ; preds = %land.lhs.true75, %if.then.i238
  %retval.0.i239 = phi ptr [ %Lit.val4.val.i237, %if.then.i238 ], [ %call.val.i176, %land.lhs.true75 ]
  %77 = getelementptr i8, ptr %retval.0.i239, i64 16
  ...
  br i1 %cmp.i242, label %if.then.i245, label %fol_Atom.exit247

if.then.i245:                                     ; preds = %fol_Atom.exit240
  %79 = getelementptr i8, ptr %call.val.i179, i64 16
  %Lit.val4.i243 = load ptr, ptr %79, align 8
  %80 = getelementptr i8, ptr %Lit.val4.i243, i64 8
  %Lit.val4.val.i244 = load ptr, ptr %80, align 8
  br label %fol_Atom.exit247

fol_Atom.exit247:                                 ; preds = %fol_Atom.exit240, %if.then.i245
  %retval.0.i246 = phi ptr [ %Lit.val4.val.i244, %if.then.i245 ], [ %call.val.i179, %fol_Atom.exit240 ]
  %81 = getelementptr i8, ptr %retval.0.i246, i64 16
...
if.then83:                                        ; preds = %fol_Atom.exit247
  ...
  %call86 = tail call fastcc i32 @subs_SubsumesInternBasic(ptr noundef nonnull %C1, i32 noundef %c1fa, i32 noundef %c1fs, i32 noundef %c1l, ptr noundef %C2, i32 noundef %c2fa, i32 noundef %c2fs, i32 noundef %c2l)
...
if.then88:                                        ; preds = %if.then83
  ...
  br i1 %cmp2.i249, label %while.body.i255.preheader, label %while.end.i257

while.body.i255.preheader:                        ; preds = %if.then88
  %xtraiter307 = and i32 %.pr.i248, 1
  %lcmp.mod308.not = icmp eq i32 %xtraiter307, 0
  br i1 %lcmp.mod308.not, label %while.body.i255.prol.loopexit, label %while.body.i255.prol

while.body.i255.prol:                             ; preds = %while.body.i255.preheader
  %84 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %84, ptr @cont_CURRENTBINDING, align 8
  %85 = getelementptr i8, ptr %84, i64 24
  %call.val.i.i.i250.prol = load ptr, ptr %85, align 8
  store ptr %call.val.i.i.i250.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i251.prol = getelementptr inbounds %struct.binding, ptr %84, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i251.prol, i8 0, i64 20, i1 false)
  %86 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i252.prol = getelementptr inbounds %struct.binding, ptr %86, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i252.prol, align 8
  %dec.i.i.i253.prol = add nsw i32 %.pr.i248, -1
  store i32 %dec.i.i.i253.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i255.prol.loopexit

while.body.i255.prol.loopexit:                    ; preds = %while.body.i255.prol, %while.body.i255.preheader
  %.unr309 = phi i32 [ %.pr.i248, %while.body.i255.preheader ], [ %dec.i.i.i253.prol, %while.body.i255.prol ]
  %87 = icmp eq i32 %.pr.i248, 1
  br i1 %87, label %while.end.i257, label %while.body.i255

while.body.i255:                                  ; preds = %while.body.i255.prol.loopexit, %while.body.i255
  %88 = phi i32 [ %dec.i.i.i253.1, %while.body.i255 ], [ %.unr309, %while.body.i255.prol.loopexit ]
  %89 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %89, ptr @cont_CURRENTBINDING, align 8
  %90 = getelementptr i8, ptr %89, i64 24
  %call.val.i.i.i250 = load ptr, ptr %90, align 8
  store ptr %call.val.i.i.i250, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i251 = getelementptr inbounds %struct.binding, ptr %89, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i251, i8 0, i64 20, i1 false)
  %91 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i252 = getelementptr inbounds %struct.binding, ptr %91, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i252, align 8
  %dec.i.i.i253 = add nsw i32 %88, -1
  store i32 %dec.i.i.i253, ptr @cont_BINDINGS, align 4
  %92 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %92, ptr @cont_CURRENTBINDING, align 8
  %93 = getelementptr i8, ptr %92, i64 24
  %call.val.i.i.i250.1 = load ptr, ptr %93, align 8
  store ptr %call.val.i.i.i250.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i251.1 = getelementptr inbounds %struct.binding, ptr %92, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i251.1, i8 0, i64 20, i1 false)
  %94 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i252.1 = getelementptr inbounds %struct.binding, ptr %94, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i252.1, align 8
  %dec.i.i.i253.1 = add nsw i32 %88, -2
  store i32 %dec.i.i.i253.1, ptr @cont_BINDINGS, align 4
  %cmp.i254.1 = icmp ugt i32 %dec.i.i.i253, 1
  br i1 %cmp.i254.1, label %while.body.i255, label %while.end.i257, !llvm.loop !8

while.end.i257:                                   ; preds = %while.body.i255.prol.loopexit, %while.body.i255, %if.then88
  %95 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i256 = icmp eq i32 %95, 0
  br i1 %cmp.i.not.i256, label %cleanup, label %if.then.i261

if.then.i261:                                     ; preds = %while.end.i257
  %dec.i.i258 = add nsw i32 %95, -1
  ...
  %96 = load i32, ptr %arrayidx.i.i260, align 4
...
if.end93:                                         ; preds = %if.end90, %fol_Atom.exit247, %fol_Atom.exit233
  ...
  br i1 %cmp2.i264, label %while.body.i270.preheader, label %while.end.i272

while.body.i270.preheader:                        ; preds = %if.end93
  %xtraiter301 = and i32 %.pr.i263, 1
  %lcmp.mod302.not = icmp eq i32 %xtraiter301, 0
  br i1 %lcmp.mod302.not, label %while.body.i270.prol.loopexit, label %while.body.i270.prol

while.body.i270.prol:                             ; preds = %while.body.i270.preheader
  %97 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %97, ptr @cont_CURRENTBINDING, align 8
  %98 = getelementptr i8, ptr %97, i64 24
  %call.val.i.i.i265.prol = load ptr, ptr %98, align 8
  store ptr %call.val.i.i.i265.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i266.prol = getelementptr inbounds %struct.binding, ptr %97, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i266.prol, i8 0, i64 20, i1 false)
  %99 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i267.prol = getelementptr inbounds %struct.binding, ptr %99, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i267.prol, align 8
  %dec.i.i.i268.prol = add nsw i32 %.pr.i263, -1
  store i32 %dec.i.i.i268.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i270.prol.loopexit

while.body.i270.prol.loopexit:                    ; preds = %while.body.i270.prol, %while.body.i270.preheader
  %.unr303 = phi i32 [ %.pr.i263, %while.body.i270.preheader ], [ %dec.i.i.i268.prol, %while.body.i270.prol ]
  %100 = icmp eq i32 %.pr.i263, 1
  br i1 %100, label %while.end.i272, label %while.body.i270

while.body.i270:                                  ; preds = %while.body.i270.prol.loopexit, %while.body.i270
  %101 = phi i32 [ %dec.i.i.i268.1, %while.body.i270 ], [ %.unr303, %while.body.i270.prol.loopexit ]
  %102 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %102, ptr @cont_CURRENTBINDING, align 8
  %103 = getelementptr i8, ptr %102, i64 24
  %call.val.i.i.i265 = load ptr, ptr %103, align 8
  store ptr %call.val.i.i.i265, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i266 = getelementptr inbounds %struct.binding, ptr %102, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i266, i8 0, i64 20, i1 false)
  %104 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i267 = getelementptr inbounds %struct.binding, ptr %104, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i267, align 8
  %dec.i.i.i268 = add nsw i32 %101, -1
  store i32 %dec.i.i.i268, ptr @cont_BINDINGS, align 4
  %105 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %105, ptr @cont_CURRENTBINDING, align 8
  %106 = getelementptr i8, ptr %105, i64 24
  %call.val.i.i.i265.1 = load ptr, ptr %106, align 8
  store ptr %call.val.i.i.i265.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i266.1 = getelementptr inbounds %struct.binding, ptr %105, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i266.1, i8 0, i64 20, i1 false)
  %107 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i267.1 = getelementptr inbounds %struct.binding, ptr %107, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i267.1, align 8
  %dec.i.i.i268.1 = add nsw i32 %101, -2
  store i32 %dec.i.i.i268.1, ptr @cont_BINDINGS, align 4
  %cmp.i269.1 = icmp ugt i32 %dec.i.i.i268, 1
  br i1 %cmp.i269.1, label %while.body.i270, label %while.end.i272, !llvm.loop !8

while.end.i272:                                   ; preds = %while.body.i270.prol.loopexit, %while.body.i270, %if.end93
  %108 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i271 = icmp eq i32 %108, 0
  br i1 %cmp.i.not.i271, label %if.end96, label %if.then.i276

if.then.i276:                                     ; preds = %while.end.i272
  %dec.i.i273 = add nsw i32 %108, -1
  store i32 %dec.i.i273, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i274 = sext i32 %dec.i.i273 to i64
  %arrayidx.i.i275 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i274
  %109 = load i32, ptr %arrayidx.i.i275, align 4
  store i32 %109, ptr @cont_BINDINGS, align 4
  br label %if.end96

if.end96:                                         ; preds = %fol_Atom.exit.thread, %if.then.i276, %while.end.i272, %cont_BackTrack.exit198, %fol_Atom.exit, %fol_Atom.exit210, %lor.lhs.false, %while.body29
  ...
  br i1 %exitcond288.not, label %while.end98, label %while.body29, !llvm.loop !22

while.end98:                                      ; preds = %if.end96, %if.end14
  store i32 0, ptr %arrayidx17, align 4
  br label %cleanup

cleanup:                                          ; preds = %entry, %if.then.i261, %while.end.i257, %if.then.i, %while.end.i, %while.end, %while.end98
  %retval.0 = phi i32 [ 0, %while.end98 ], [ 1, %while.end ], [ 1, %while.end.i ], [ 1, %if.then.i ], [ 1, %while.end.i257 ], [ 1, %if.then.i261 ], [ 1, %entry ]
  ret i32 %retval.0
}
...
entry:
  ...
  %or.cond44 = select i1 %or.cond, i1 true, i1 %cmp11
...
for.body.i:                                       ; preds = %if.end18, %for.body.i.1
  ...
  br i1 %exitcond.not.i, label %term_NewMark.exit, label %for.body.i.1, !llvm.loop !23
...
term_NewMark.exit:                                ; preds = %for.body.i, %if.end18
  ...
  %call20 = tail call fastcc i32 @subs_SubsumesInternWithSignature(i32 noundef 0, ptr noundef %C1, ptr noundef %C2, i32 noundef %Variants, ptr noundef %Bindings)
...
for.cond.i:                                       ; preds = %if.end.i, %for.cond.i
  ...
  br i1 %cmp.i20.not.i, label %for.end.i, label %for.cond.i, !llvm.loop !24
...
if.end:                                           ; preds = %if.then6
  ...
  %call13 = call fastcc i32 @subs_SubsumesInternWithSignature(i32 noundef %add, ptr noundef nonnull %c1, ptr noundef nonnull %c2, i32 noundef %Variants, ptr noundef nonnull %NewBindings)
  %tobool14.not = icmp eq i32 %call13, 0
  br i1 %tobool14.not, label %if.end17, label %if.then15
...
if.then15:                                        ; preds = %if.end
  ...
  br i1 %cmp.i.not.i158, label %cleanup.sink.split, label %if.end.i160

if.end.i160:                                      ; preds = %if.then15
  %cmp.i18.not.i159 = icmp eq ptr %22, null
  br i1 %cmp.i18.not.i159, label %cleanup.sink.split, label %for.cond.i164
...
for.cond.i164:                                    ; preds = %if.end.i160, %for.cond.i164
  ...
  br i1 %cmp.i20.not.i163, label %for.end.i165, label %for.cond.i164, !llvm.loop !24
...
for.inc:                                          ; preds = %if.then26, %if.else
  ...
  br i1 %cmp.i.not, label %while.body.i, label %for.body, !llvm.loop !25
...
while.body.i:                                     ; preds = %for.inc, %while.body.i
  ...
  br i1 %cmp.i.not.i174, label %list_Delete.exit, label %while.body.i, !llvm.loop !26
...
fol_Atom.exit:                                    ; preds = %list_Delete.exit, %if.then.i
  ...
  br i1 %cmp.i178, label %if.then.i181, label %fol_Atom.exit183

if.then.i181:                                     ; preds = %fol_Atom.exit
  %34 = getelementptr i8, ptr %call.val.i150, i64 16
  %Lit.val4.i179 = load ptr, ptr %34, align 8
  %35 = getelementptr i8, ptr %Lit.val4.i179, i64 8
  %Lit.val4.val.i180 = load ptr, ptr %35, align 8
  %call34.val.pre = load i32, ptr %Lit.val4.val.i180, align 8
  br label %fol_Atom.exit183

fol_Atom.exit183:                                 ; preds = %fol_Atom.exit, %if.then.i181
  %call34.val = phi i32 [ %call34.val.pre, %if.then.i181 ], [ %Lit.val.i177, %fol_Atom.exit ]
...
fol_Atom.exit192:                                 ; preds = %land.lhs.true
  %Lit.val4.i188 = load ptr, ptr %11, align 8
  %36 = getelementptr i8, ptr %Lit.val4.i188, i64 8
  %Lit.val4.val.i189 = load ptr, ptr %36, align 8
  %call38.val = load i32, ptr %Lit.val4.val.i189, align 8
...
fol_Atom.exit201:                                 ; preds = %fol_Atom.exit192, %fol_Atom.exit192.thread
  %retval.0.i200 = phi ptr [ %call.val.i, %fol_Atom.exit192.thread ], [ %Lit.val4.val.i189, %fol_Atom.exit192 ]
  %39 = getelementptr i8, ptr %retval.0.i200, i64 16
  %call42.val = load ptr, ptr %39, align 8
  %40 = getelementptr i8, ptr %call42.val, i64 8
  %call42.val.val = load ptr, ptr %40, align 8
  br i1 %cmp.i178, label %if.then.i206, label %fol_Atom.exit208

if.then.i206:                                     ; preds = %fol_Atom.exit201
  %41 = getelementptr i8, ptr %call.val.i150, i64 16
  %Lit.val4.i204 = load ptr, ptr %41, align 8
  %42 = getelementptr i8, ptr %Lit.val4.i204, i64 8
  %Lit.val4.val.i205 = load ptr, ptr %42, align 8
  br label %fol_Atom.exit208

fol_Atom.exit208:                                 ; preds = %fol_Atom.exit201, %if.then.i206
  %retval.0.i207 = phi ptr [ %Lit.val4.val.i205, %if.then.i206 ], [ %call.val.i150, %fol_Atom.exit201 ]
  %43 = getelementptr i8, ptr %retval.0.i207, i64 16
...
if.then.i213:                                     ; preds = %land.lhs.true48
  %Lit.val4.i211 = load ptr, ptr %11, align 8
  %46 = getelementptr i8, ptr %Lit.val4.i211, i64 8
  %Lit.val4.val.i212 = load ptr, ptr %46, align 8
  br label %fol_Atom.exit215

fol_Atom.exit215:                                 ; preds = %land.lhs.true48, %if.then.i213
  %retval.0.i214 = phi ptr [ %Lit.val4.val.i212, %if.then.i213 ], [ %call.val.i, %land.lhs.true48 ]
  %47 = getelementptr i8, ptr %retval.0.i214, i64 16
...
if.then.i220:                                     ; preds = %fol_Atom.exit215
  ...
  %Lit.val4.i218 = load ptr, ptr %49, align 8
  %50 = getelementptr i8, ptr %Lit.val4.i218, i64 8
  %Lit.val4.val.i219 = load ptr, ptr %50, align 8
  br label %fol_Atom.exit222

fol_Atom.exit222:                                 ; preds = %fol_Atom.exit215, %if.then.i220
  %retval.0.i221 = phi ptr [ %Lit.val4.val.i219, %if.then.i220 ], [ %call.val.i150, %fol_Atom.exit215 ]
  %51 = getelementptr i8, ptr %retval.0.i221, i64 16
...
if.then59:                                        ; preds = %if.then55
  ...
  br i1 %cmp.i.not.i228, label %cleanup.sink.split, label %if.end.i230

if.end.i230:                                      ; preds = %if.then59
  %cmp.i18.not.i229 = icmp eq ptr %54, null
  br i1 %cmp.i18.not.i229, label %cleanup.sink.split, label %for.cond.i234

for.cond.i234:                                    ; preds = %if.end.i230, %for.cond.i234
  %List1.addr.0.i231 = phi ptr [ %List1.addr.0.val17.i232, %for.cond.i234 ], [ %53, %if.end.i230 ]
  %List1.addr.0.val17.i232 = load ptr, ptr %List1.addr.0.i231, align 8
  %cmp.i20.not.i233 = icmp eq ptr %List1.addr.0.val17.i232, null
  br i1 %cmp.i20.not.i233, label %for.end.i235, label %for.cond.i234, !llvm.loop !24

for.end.i235:                                     ; preds = %for.cond.i234
  store ptr %54, ptr %List1.addr.0.i231, align 8
  br label %cleanup.sink.split

if.end61:                                         ; preds = %if.then55
  %55 = load i32, ptr @stamp, align 4
  store i32 %55, ptr %arrayidx, align 4
  %call65 = call fastcc i32 @subs_SubsumesInternWithSignature(i32 noundef %add, ptr noundef nonnull %c1, ptr noundef %c2, i32 noundef %Variants, ptr noundef nonnull %NewBindings)
  %tobool66.not = icmp eq i32 %call65, 0
...
if.then67:                                        ; preds = %if.end61
  ...
  br i1 %cmp.i.not.i238, label %cleanup.sink.split, label %if.end.i240

if.end.i240:                                      ; preds = %if.then67
  %cmp.i18.not.i239 = icmp eq ptr %57, null
  br i1 %cmp.i18.not.i239, label %cleanup.sink.split, label %for.cond.i244

for.cond.i244:                                    ; preds = %if.end.i240, %for.cond.i244
  %List1.addr.0.i241 = phi ptr [ %List1.addr.0.val17.i242, %for.cond.i244 ], [ %56, %if.end.i240 ]
  %List1.addr.0.val17.i242 = load ptr, ptr %List1.addr.0.i241, align 8
  %cmp.i20.not.i243 = icmp eq ptr %List1.addr.0.val17.i242, null
  br i1 %cmp.i20.not.i243, label %for.end.i245, label %for.cond.i244, !llvm.loop !24

for.end.i245:                                     ; preds = %for.cond.i244
  store ptr %57, ptr %List1.addr.0.i241, align 8
  br label %cleanup.sink.split
...
for.inc86:                                        ; preds = %if.then81, %if.else83
  ...
  br i1 %cmp.i248.not, label %while.body.i265, label %for.body77, !llvm.loop !27

while.body.i265:                                  ; preds = %for.inc86, %while.body.i265
  %Current.06.i259 = phi ptr [ %Current.0.val.i260, %while.body.i265 ], [ %58, %for.inc86 ]
  %Current.0.val.i260 = load ptr, ptr %Current.06.i259, align 8
  %62 = load ptr, ptr getelementptr ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i261 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %62, i64 0, i32 4
  %63 = load i32, ptr %total_size.i.i.i261, align 8
  %conv26.i.i.i262 = sext i32 %63 to i64
  %64 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i263 = add i64 %64, %conv26.i.i.i262
  store i64 %add27.i.i.i263, ptr @memory_FREEDBYTES, align 8
  %65 = load ptr, ptr %62, align 8
  store ptr %65, ptr %Current.06.i259, align 8
  %66 = load ptr, ptr getelementptr ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i259, ptr %66, align 8
  %cmp.i.not.i264 = icmp eq ptr %Current.0.val.i260, null
  br i1 %cmp.i.not.i264, label %list_Delete.exit266, label %while.body.i265, !llvm.loop !26

list_Delete.exit266:                              ; preds = %while.body.i265, %if.end72
  store ptr null, ptr %NewBindings, align 8
  br label %if.end91
...
if.end91:                                         ; preds = %fol_Atom.exit192.thread, %fol_Atom.exit183, %fol_Atom.exit192, %list_Delete.exit266, %while.body
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %cleanup, label %while.body, !llvm.loop !28

cleanup.sink.split:                               ; preds = %for.end.i245, %if.end.i240, %if.then67, %for.end.i235, %if.end.i230, %if.then59, %for.end.i165, %if.end.i160, %if.then15, %for.end.i, %if.end.i, %if.then9
  %retval.0.i246.sink = phi ptr [ %18, %for.end.i ], [ %19, %if.then9 ], [ %18, %if.end.i ], [ %21, %for.end.i165 ], [ %22, %if.then15 ], [ %21, %if.end.i160 ], [ %53, %for.end.i235 ], [ %54, %if.then59 ], [ %53, %if.end.i230 ], [ %56, %for.end.i245 ], [ %57, %if.then67 ], [ %56, %if.end.i240 ]
...
land.lhs.true:                                    ; preds = %if.end38
  %call42 = tail call fastcc i32 @subs_PartnerTest(ptr noundef nonnull %C1, i32 noundef 0, i32 noundef %add.i, ptr noundef nonnull %C2, i32 noundef 0, i32 noundef %add.i94)
  %tobool.not = icmp eq i32 %call42, 0
  br i1 %tobool.not, label %cleanup, label %lor.lhs.false43

lor.lhs.false43:                                  ; preds = %land.lhs.true
  %call44 = tail call fastcc i32 @subs_PartnerTest(ptr noundef nonnull %C1, i32 noundef %add.i, i32 noundef %add3.i, ptr noundef nonnull %C2, i32 noundef %add.i94, i32 noundef %add3.i99)
  %tobool45.not = icmp eq i32 %call44, 0
  br i1 %tobool45.not, label %cleanup, label %if.end47

if.end47:                                         ; preds = %lor.lhs.false43, %if.end38
  %call48 = tail call fastcc i32 @subs_SubsumesIntern(ptr noundef nonnull %C1, i32 noundef %add.i, i32 noundef %add3.i, ptr noundef nonnull %C2, i32 noundef %add.i94, i32 noundef %add3.i99)
  br label %cleanup
...
if.else:                                          ; preds = %if.then
  br i1 %cmp.i.not.i.i, label %if.then.i.i161, label %clause_GetLiteralAtom.exit163

if.then.i.i161:                                   ; preds = %if.else
  %9 = getelementptr i8, ptr %call.val.i, i64 16
  %call1.val.i.i159 = load ptr, ptr %9, align 8
  %10 = getelementptr i8, ptr %call1.val.i.i159, i64 8
  %call1.val.val.i.i160 = load ptr, ptr %10, align 8
  br label %clause_GetLiteralAtom.exit163

clause_GetLiteralAtom.exit163:                    ; preds = %if.else, %if.then.i.i161
  %retval.0.i.i162 = phi ptr [ %call1.val.val.i.i160, %if.then.i.i161 ], [ %call.val.i, %if.else ]
  %call7 = tail call i32 @term_NumberOfVarOccs(ptr noundef %retval.0.i.i162) #7
...
if.end11:                                         ; preds = %clause_GetLiteralAtom.exit163, %clause_GetLiteralAtom.exit, %while.body
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %while.end, label %while.body, !llvm.loop !29
...
if.then33:                                        ; preds = %if.then29
  ...
  %call36 = tail call fastcc i32 @subs_SubsumesIntern(ptr noundef %C1, i32 noundef %c1fs, i32 noundef %c1l, ptr noundef nonnull %C2, i32 noundef %c2fs, i32 noundef %c2l)
...
if.end43:                                         ; preds = %if.end40, %if.then29
  ...
  br i1 %cmp2.i175, label %while.body.i181.preheader, label %while.end.i183

while.body.i181.preheader:                        ; preds = %if.end43
  %xtraiter = and i32 %.pr.i174, 1
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %while.body.i181.prol.loopexit, label %while.body.i181.prol

while.body.i181.prol:                             ; preds = %while.body.i181.preheader
  %40 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %40, ptr @cont_CURRENTBINDING, align 8
  %41 = getelementptr i8, ptr %40, i64 24
  %call.val.i.i.i176.prol = load ptr, ptr %41, align 8
  store ptr %call.val.i.i.i176.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i177.prol = getelementptr inbounds %struct.binding, ptr %40, i64 0, i32 1
  ...
  %42 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i178.prol = getelementptr inbounds %struct.binding, ptr %42, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i178.prol, align 8
  %dec.i.i.i179.prol = add nsw i32 %.pr.i174, -1
  store i32 %dec.i.i.i179.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i181.prol.loopexit

while.body.i181.prol.loopexit:                    ; preds = %while.body.i181.prol, %while.body.i181.preheader
  %.unr = phi i32 [ %.pr.i174, %while.body.i181.preheader ], [ %dec.i.i.i179.prol, %while.body.i181.prol ]
  %43 = icmp eq i32 %.pr.i174, 1
  br i1 %43, label %while.end.i183, label %while.body.i181

while.body.i181:                                  ; preds = %while.body.i181.prol.loopexit, %while.body.i181
  %44 = phi i32 [ %dec.i.i.i179.1, %while.body.i181 ], [ %.unr, %while.body.i181.prol.loopexit ]
  %45 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %45, ptr @cont_CURRENTBINDING, align 8
  %46 = getelementptr i8, ptr %45, i64 24
  %call.val.i.i.i176 = load ptr, ptr %46, align 8
  store ptr %call.val.i.i.i176, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i177 = getelementptr inbounds %struct.binding, ptr %45, i64 0, i32 1
  ...
  %47 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i178 = getelementptr inbounds %struct.binding, ptr %47, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i178, align 8
  %dec.i.i.i179 = add nsw i32 %44, -1
  store i32 %dec.i.i.i179, ptr @cont_BINDINGS, align 4
  %48 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %48, ptr @cont_CURRENTBINDING, align 8
  %49 = getelementptr i8, ptr %48, i64 24
  %call.val.i.i.i176.1 = load ptr, ptr %49, align 8
  store ptr %call.val.i.i.i176.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i177.1 = getelementptr inbounds %struct.binding, ptr %48, i64 0, i32 1
  ...
  %50 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i178.1 = getelementptr inbounds %struct.binding, ptr %50, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i178.1, align 8
  %dec.i.i.i179.1 = add nsw i32 %44, -2
  store i32 %dec.i.i.i179.1, ptr @cont_BINDINGS, align 4
  %cmp.i180.1 = icmp ugt i32 %dec.i.i.i179, 1
  br i1 %cmp.i180.1, label %while.body.i181, label %while.end.i183, !llvm.loop !8

while.end.i183:                                   ; preds = %while.body.i181.prol.loopexit, %while.body.i181, %if.end43
  %51 = phi i32 [ %.pr.i174, %if.end43 ], [ 0, %while.body.i181 ], [ 0, %while.body.i181.prol.loopexit ]
  %52 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i182 = icmp eq i32 %52, 0
  br i1 %cmp.i.not.i182, label %cont_BackTrack.exit188, label %if.then.i187

if.then.i187:                                     ; preds = %while.end.i183
  %dec.i.i184 = add nsw i32 %52, -1
  store i32 %dec.i.i184, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i185 = sext i32 %dec.i.i184 to i64
  %arrayidx.i.i186 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i185
  %53 = load i32, ptr %arrayidx.i.i186, align 4
  store i32 %53, ptr @cont_BINDINGS, align 4
  br label %cont_BackTrack.exit188

cont_BackTrack.exit188:                           ; preds = %while.end.i183, %if.then.i187
  %54 = phi i32 [ 0, %while.end.i183 ], [ %dec.i.i184, %if.then.i187 ]
  %55 = phi i32 [ %51, %while.end.i183 ], [ %53, %if.then.i187 ]
...
fol_Atom.exit200:                                 ; preds = %fol_Atom.exit
  ...
  %Lit.val4.i196 = load ptr, ptr %60, align 8
  %61 = getelementptr i8, ptr %Lit.val4.i196, i64 8
  %Lit.val4.val.i197 = load ptr, ptr %61, align 8
  %call53.val.pre = load i32, ptr %Lit.val4.val.i197, align 8
...
if.then.i214:                                     ; preds = %if.then63
  %Lit.val4.i212 = load ptr, ptr %17, align 8
  %67 = getelementptr i8, ptr %Lit.val4.i212, i64 8
  %Lit.val4.val.i213 = load ptr, ptr %67, align 8
  br label %fol_Atom.exit216

fol_Atom.exit216:                                 ; preds = %if.then63, %if.then.i214
  %retval.0.i215 = phi ptr [ %Lit.val4.val.i213, %if.then.i214 ], [ %call.val.i166, %if.then63 ]
  %68 = getelementptr i8, ptr %retval.0.i215, i64 16
...
if.then.i221:                                     ; preds = %fol_Atom.exit216
  %70 = getelementptr i8, ptr %call.val.i169, i64 16
  %Lit.val4.i219 = load ptr, ptr %70, align 8
  %71 = getelementptr i8, ptr %Lit.val4.i219, i64 8
  %Lit.val4.val.i220 = load ptr, ptr %71, align 8
  br label %fol_Atom.exit223

fol_Atom.exit223:                                 ; preds = %fol_Atom.exit216, %if.then.i221
  %retval.0.i222 = phi ptr [ %Lit.val4.val.i220, %if.then.i221 ], [ %call.val.i169, %fol_Atom.exit216 ]
  %72 = getelementptr i8, ptr %retval.0.i222, i64 16
...
if.then.i228:                                     ; preds = %land.lhs.true71
  %Lit.val4.i226 = load ptr, ptr %17, align 8
  %76 = getelementptr i8, ptr %Lit.val4.i226, i64 8
  %Lit.val4.val.i227 = load ptr, ptr %76, align 8
  br label %fol_Atom.exit230

fol_Atom.exit230:                                 ; preds = %land.lhs.true71, %if.then.i228
  %retval.0.i229 = phi ptr [ %Lit.val4.val.i227, %if.then.i228 ], [ %call.val.i166, %land.lhs.true71 ]
  %77 = getelementptr i8, ptr %retval.0.i229, i64 16
  ...
  br i1 %cmp.i232, label %if.then.i235, label %fol_Atom.exit237

if.then.i235:                                     ; preds = %fol_Atom.exit230
  %79 = getelementptr i8, ptr %call.val.i169, i64 16
  %Lit.val4.i233 = load ptr, ptr %79, align 8
  %80 = getelementptr i8, ptr %Lit.val4.i233, i64 8
  %Lit.val4.val.i234 = load ptr, ptr %80, align 8
  br label %fol_Atom.exit237

fol_Atom.exit237:                                 ; preds = %fol_Atom.exit230, %if.then.i235
  %retval.0.i236 = phi ptr [ %Lit.val4.val.i234, %if.then.i235 ], [ %call.val.i169, %fol_Atom.exit230 ]
  %81 = getelementptr i8, ptr %retval.0.i236, i64 16
...
if.then79:                                        ; preds = %fol_Atom.exit237
  ...
  %call82 = tail call fastcc i32 @subs_SubsumesIntern(ptr noundef nonnull %C1, i32 noundef %c1fs, i32 noundef %c1l, ptr noundef %C2, i32 noundef %c2fs, i32 noundef %c2l)
...
while.body.i245.preheader:                        ; preds = %if.then84
  %xtraiter299 = and i32 %.pr.i238, 1
  %lcmp.mod300.not = icmp eq i32 %xtraiter299, 0
  br i1 %lcmp.mod300.not, label %while.body.i245.prol.loopexit, label %while.body.i245.prol

while.body.i245.prol:                             ; preds = %while.body.i245.preheader
  %84 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %84, ptr @cont_CURRENTBINDING, align 8
  %85 = getelementptr i8, ptr %84, i64 24
  %call.val.i.i.i240.prol = load ptr, ptr %85, align 8
  store ptr %call.val.i.i.i240.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i241.prol = getelementptr inbounds %struct.binding, ptr %84, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i241.prol, i8 0, i64 20, i1 false)
  %86 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i242.prol = getelementptr inbounds %struct.binding, ptr %86, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i242.prol, align 8
  %dec.i.i.i243.prol = add nsw i32 %.pr.i238, -1
  store i32 %dec.i.i.i243.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i245.prol.loopexit
...
while.body.i245.prol.loopexit:                    ; preds = %while.body.i245.prol, %while.body.i245.preheader
  %.unr301 = phi i32 [ %.pr.i238, %while.body.i245.preheader ], [ %dec.i.i.i243.prol, %while.body.i245.prol ]
  %87 = icmp eq i32 %.pr.i238, 1
  br i1 %87, label %while.end.i247, label %while.body.i245

while.body.i245:                                  ; preds = %while.body.i245.prol.loopexit, %while.body.i245
  %88 = phi i32 [ %dec.i.i.i243.1, %while.body.i245 ], [ %.unr301, %while.body.i245.prol.loopexit ]
  %89 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %89, ptr @cont_CURRENTBINDING, align 8
  %90 = getelementptr i8, ptr %89, i64 24
  %call.val.i.i.i240 = load ptr, ptr %90, align 8
  store ptr %call.val.i.i.i240, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i241 = getelementptr inbounds %struct.binding, ptr %89, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i241, i8 0, i64 20, i1 false)
  %91 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i242 = getelementptr inbounds %struct.binding, ptr %91, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i242, align 8
  %dec.i.i.i243 = add nsw i32 %88, -1
  store i32 %dec.i.i.i243, ptr @cont_BINDINGS, align 4
  %92 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %92, ptr @cont_CURRENTBINDING, align 8
  %93 = getelementptr i8, ptr %92, i64 24
  %call.val.i.i.i240.1 = load ptr, ptr %93, align 8
  store ptr %call.val.i.i.i240.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i241.1 = getelementptr inbounds %struct.binding, ptr %92, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i241.1, i8 0, i64 20, i1 false)
  %94 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i242.1 = getelementptr inbounds %struct.binding, ptr %94, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i242.1, align 8
  %dec.i.i.i243.1 = add nsw i32 %88, -2
  store i32 %dec.i.i.i243.1, ptr @cont_BINDINGS, align 4
  %cmp.i244.1 = icmp ugt i32 %dec.i.i.i243, 1
  br i1 %cmp.i244.1, label %while.body.i245, label %while.end.i247, !llvm.loop !8

while.end.i247:                                   ; preds = %while.body.i245.prol.loopexit, %while.body.i245, %if.then84
  %95 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i246 = icmp eq i32 %95, 0
  br i1 %cmp.i.not.i246, label %cleanup, label %if.then.i251

if.then.i251:                                     ; preds = %while.end.i247
  %dec.i.i248 = add nsw i32 %95, -1
  store i32 %dec.i.i248, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i249 = sext i32 %dec.i.i248 to i64
  %arrayidx.i.i250 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i249
  %96 = load i32, ptr %arrayidx.i.i250, align 4
  store i32 %96, ptr @cont_BINDINGS, align 4
  br label %cleanup
...
if.end89:                                         ; preds = %if.end86, %fol_Atom.exit237, %fol_Atom.exit223
  ...
  br i1 %cmp2.i254, label %while.body.i260.preheader, label %while.end.i262

while.body.i260.preheader:                        ; preds = %if.end89
  %xtraiter293 = and i32 %.pr.i253, 1
  %lcmp.mod294.not = icmp eq i32 %xtraiter293, 0
  br i1 %lcmp.mod294.not, label %while.body.i260.prol.loopexit, label %while.body.i260.prol

while.body.i260.prol:                             ; preds = %while.body.i260.preheader
  %97 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %97, ptr @cont_CURRENTBINDING, align 8
  %98 = getelementptr i8, ptr %97, i64 24
  %call.val.i.i.i255.prol = load ptr, ptr %98, align 8
  store ptr %call.val.i.i.i255.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i256.prol = getelementptr inbounds %struct.binding, ptr %97, i64 0, i32 1
  ...
  %99 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i257.prol = getelementptr inbounds %struct.binding, ptr %99, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i257.prol, align 8
  %dec.i.i.i258.prol = add nsw i32 %.pr.i253, -1
  store i32 %dec.i.i.i258.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i260.prol.loopexit

while.body.i260.prol.loopexit:                    ; preds = %while.body.i260.prol, %while.body.i260.preheader
  %.unr295 = phi i32 [ %.pr.i253, %while.body.i260.preheader ], [ %dec.i.i.i258.prol, %while.body.i260.prol ]
  %100 = icmp eq i32 %.pr.i253, 1
  br i1 %100, label %while.end.i262, label %while.body.i260

while.body.i260:                                  ; preds = %while.body.i260.prol.loopexit, %while.body.i260
  %101 = phi i32 [ %dec.i.i.i258.1, %while.body.i260 ], [ %.unr295, %while.body.i260.prol.loopexit ]
  %102 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %102, ptr @cont_CURRENTBINDING, align 8
  %103 = getelementptr i8, ptr %102, i64 24
  %call.val.i.i.i255 = load ptr, ptr %103, align 8
  store ptr %call.val.i.i.i255, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i256 = getelementptr inbounds %struct.binding, ptr %102, i64 0, i32 1
  ...
  %104 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i257 = getelementptr inbounds %struct.binding, ptr %104, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i257, align 8
  %dec.i.i.i258 = add nsw i32 %101, -1
  store i32 %dec.i.i.i258, ptr @cont_BINDINGS, align 4
  %105 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %105, ptr @cont_CURRENTBINDING, align 8
  %106 = getelementptr i8, ptr %105, i64 24
  %call.val.i.i.i255.1 = load ptr, ptr %106, align 8
  store ptr %call.val.i.i.i255.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i256.1 = getelementptr inbounds %struct.binding, ptr %105, i64 0, i32 1
  ...
  %107 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i257.1 = getelementptr inbounds %struct.binding, ptr %107, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i257.1, align 8
  %dec.i.i.i258.1 = add nsw i32 %101, -2
  store i32 %dec.i.i.i258.1, ptr @cont_BINDINGS, align 4
  %cmp.i259.1 = icmp ugt i32 %dec.i.i.i258, 1
  br i1 %cmp.i259.1, label %while.body.i260, label %while.end.i262, !llvm.loop !8

while.end.i262:                                   ; preds = %while.body.i260.prol.loopexit, %while.body.i260, %if.end89
  %108 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i261 = icmp eq i32 %108, 0
  br i1 %cmp.i.not.i261, label %if.end92, label %if.then.i266

if.then.i266:                                     ; preds = %while.end.i262
  %dec.i.i263 = add nsw i32 %108, -1
  store i32 %dec.i.i263, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i264 = sext i32 %dec.i.i263 to i64
  %arrayidx.i.i265 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i264
  %109 = load i32, ptr %arrayidx.i.i265, align 4
  store i32 %109, ptr @cont_BINDINGS, align 4
  br label %if.end92

if.end92:                                         ; preds = %fol_Atom.exit.thread, %if.then.i266, %while.end.i262, %cont_BackTrack.exit188, %fol_Atom.exit, %fol_Atom.exit200, %lor.lhs.false, %while.body25
  ...
  br i1 %exitcond280.not, label %while.end94, label %while.body25, !llvm.loop !30

while.end94:                                      ; preds = %if.end92, %if.end14
  store i32 0, ptr %arrayidx17, align 4
  br label %cleanup

cleanup:                                          ; preds = %entry, %if.then.i251, %while.end.i247, %if.then.i, %while.end.i, %while.end, %while.end94
  %retval.0 = phi i32 [ 0, %while.end94 ], [ 1, %while.end ], [ 1, %while.end.i ], [ 1, %if.then.i ], [ 1, %while.end.i247 ], [ 1, %if.then.i251 ], [ 1, %entry ]
  ret i32 %retval.0
}

; Function Attrs: nounwind uwtable
define dso_local i32 @subs_ST(i32 noundef %i, i32 noundef %j, ptr noundef %c1, ptr noundef %c2) local_unnamed_addr #2 {
entry:
  %0 = getelementptr i8, ptr %c2, i64 64
  %1 = getelementptr i8, ptr %c2, i64 68
  %2 = getelementptr i8, ptr %c2, i64 72
...
cont_BackTrackAndStart.exit:                      ; preds = %while.body.i.prol.loopexit, %while.body.i, %while.body
  ...
  br i1 %cmp, label %land.rhs, label %while.end.loopexit, !llvm.loop !31
...
lor.lhs.false:                                    ; preds = %if.end
  %call11 = tail call i32 @subs_ST(i32 noundef %add, i32 noundef 0, ptr noundef nonnull %c1, ptr noundef nonnull %c2)
...
while.end.i71:                                    ; preds = %while.body.i69.prol.loopexit, %while.body.i69, %if.else
  ...
  %cmp.i.not.i70 = icmp eq i32 %53, 0
  br i1 %cmp.i.not.i70, label %cont_BackTrack.exit76, label %if.then.i75
...
land.rhs:                                         ; preds = %cont_BackTrack.exit
  ...
  br i1 %cmp8, label %do.body, label %cleanup, !llvm.loop !32
...
for.inc:                                          ; preds = %cont_BackTrack.exit
  ...
  br i1 %cmp, label %for.body, label %cleanup, !llvm.loop !33
...
for.cond.i:                                       ; preds = %for.end.i
  ...
  br i1 %cmp.i, label %for.cond1.preheader.i, label %if.then, !llvm.loop !34
...
cont_BackTrack.exit.i:                            ; preds = %if.then.i.i, %while.end.i.i
  ...
  br i1 %cmp3.i, label %for.body4.i, label %for.end.i, !llvm.loop !35
...
if.then:                                          ; preds = %for.cond.i
  %cmp56 = icmp sgt i32 %add3.i.i, 0
  br i1 %cmp56, label %for.body.lr.ph, label %list_Delete.exit.thread
...
for.inc.i:                                        ; preds = %if.then.i29, %for.body.i
  ...
  br i1 %cmp.i.not.i, label %for.end.i30, label %for.body.i, !llvm.loop !36

for.end.i30:                                      ; preds = %for.inc.i
  %cmp.i34.not.i = icmp eq ptr %insert.1.i, null
  br i1 %cmp.i34.not.i, label %if.then9, label %while.body.i.i32

while.body.i.i32:                                 ; preds = %for.end.i30, %while.body.i.i32
  %Current.06.i.i = phi ptr [ %Current.0.val.i.i, %while.body.i.i32 ], [ %insert.1.i, %for.end.i30 ]
  ...
  br i1 %cmp.i.not.i.i31, label %list_Delete.exit.i, label %while.body.i.i32, !llvm.loop !26

list_Delete.exit.i:                               ; preds = %while.body.i.i32
...
if.then9:                                         ; preds = %if.else.i, %for.end.i30
...
list_Delete.exit.thread:                          ; preds = %entry, %if.then
  %call1270 = tail call ptr @litptr_Create(ptr noundef null, ptr noundef null) #7
  store ptr %call1270, ptr %litptr, align 8
  br label %cleanup
...
while.body.i:                                     ; preds = %for.end, %while.body.i
  ...
  br i1 %cmp.i.not.i36, label %list_Delete.exit, label %while.body.i, !llvm.loop !26

list_Delete.exit:                                 ; preds = %while.body.i, %for.end
  %cmp.i.not5.i37 = icmp eq ptr %TermIndexlist.1, null
  br i1 %cmp.i.not5.i37, label %cleanup, label %while.body.i44

while.body.i44:                                   ; preds = %list_Delete.exit, %while.body.i44
  %Current.06.i38 = phi ptr [ %Current.0.val.i39, %while.body.i44 ], [ %TermIndexlist.1, %list_Delete.exit ]
  %Current.0.val.i39 = load ptr, ptr %Current.06.i38, align 8
  %51 = load ptr, ptr getelementptr ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i40 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %51, i64 0, i32 4
  %52 = load i32, ptr %total_size.i.i.i40, align 8
  %conv26.i.i.i41 = sext i32 %52 to i64
  %53 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i42 = add i64 %53, %conv26.i.i.i41
  store i64 %add27.i.i.i42, ptr @memory_FREEDBYTES, align 8
  %54 = load ptr, ptr %51, align 8
  store ptr %54, ptr %Current.06.i38, align 8
  %55 = load ptr, ptr getelementptr ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i38, ptr %55, align 8
  %cmp.i.not.i43 = icmp eq ptr %Current.0.val.i39, null
  br i1 %cmp.i.not.i43, label %cleanup, label %while.body.i44, !llvm.loop !26

cleanup:                                          ; preds = %for.end.i, %while.body.i44, %list_Delete.exit.thread, %list_Delete.exit
  %retval.0 = phi i32 [ 1, %list_Delete.exit ], [ 1, %list_Delete.exit.thread ], [ 1, %while.body.i44 ], [ 0, %for.end.i ]
  ret i32 %retval.0
}
...
for.end:                                          ; preds = %for.body, %entry
  %call2 = tail call fastcc i32 @subs_InternIdc(ptr noundef nonnull %c1, i32 noundef %0, ptr noundef %c2)
...
while.body.i:                                     ; preds = %while.body.i, %while.body.preheader.i
  ...
  br i1 %tobool.not.i, label %cont_Reset.exit, label %while.body.i, !llvm.loop !39
...
for.cond.i.i:                                     ; preds = %for.end.i.i
  ...
  br i1 %cmp.i.i, label %for.cond1.preheader.i.i, label %if.then.i, !llvm.loop !40
...
cont_BackTrack.exit.i.i:                          ; preds = %if.then.i.i.i, %while.end.i.i.i
  ...
  br i1 %cmp3.i.i, label %for.body4.i.i, label %for.end.i.i, !llvm.loop !41
...
for.inc.i.i:                                      ; preds = %if.then.i33.i, %for.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %for.end.i34.i, label %for.body.i.i, !llvm.loop !36

for.end.i34.i:                                    ; preds = %for.inc.i.i
  %cmp.i34.not.i.i = icmp eq ptr %insert.1.i.i, null
  br i1 %cmp.i34.not.i.i, label %if.then10.i, label %while.body.i.i36.i

while.body.i.i36.i:                               ; preds = %for.end.i34.i, %while.body.i.i36.i
  %Current.06.i.i.i = phi ptr [ %Current.0.val.i.i.i, %while.body.i.i36.i ], [ %insert.1.i.i, %for.end.i34.i ]
  ...
  br i1 %cmp.i.not.i.i35.i, label %list_Delete.exit.i.i, label %while.body.i.i36.i, !llvm.loop !26

list_Delete.exit.i.i:                             ; preds = %while.body.i.i36.i
...
if.then10.i:                                      ; preds = %if.else.i.i, %for.end.i34.i
...
while.body.i.i:                                   ; preds = %for.end.i, %while.body.i.i
  ...
  br i1 %cmp.i.not.i42.i, label %list_Delete.exit.i, label %while.body.i.i, !llvm.loop !26

list_Delete.exit.i:                               ; preds = %while.body.i.i, %for.end.i
  %cmp.i.not5.i43.i = icmp eq ptr %TermIndexlist.1.i, null
  br i1 %cmp.i.not5.i43.i, label %if.end, label %while.body.i50.i

while.body.i50.i:                                 ; preds = %list_Delete.exit.i, %while.body.i50.i
  %Current.06.i44.i = phi ptr [ %Current.0.val.i45.i, %while.body.i50.i ], [ %TermIndexlist.1.i, %list_Delete.exit.i ]
  %Current.0.val.i45.i = load ptr, ptr %Current.06.i44.i, align 8
  %54 = load ptr, ptr getelementptr ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i46.i = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %54, i64 0, i32 4
  %55 = load i32, ptr %total_size.i.i.i46.i, align 8
  %conv26.i.i.i47.i = sext i32 %55 to i64
  %56 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i48.i = add i64 %56, %conv26.i.i.i47.i
  store i64 %add27.i.i.i48.i, ptr @memory_FREEDBYTES, align 8
  %57 = load ptr, ptr %54, align 8
  store ptr %57, ptr %Current.06.i44.i, align 8
  %58 = load ptr, ptr getelementptr ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %Current.06.i44.i, ptr %58, align 8
  %cmp.i.not.i49.i = icmp eq ptr %Current.0.val.i45.i, null
  br i1 %cmp.i.not.i49.i, label %if.end, label %while.body.i50.i, !llvm.loop !26

if.end:                                           ; preds = %while.body.i50.i, %list_Delete.exit.i, %list_Delete.exit.thread.i
  %litptr.0.ph = phi ptr [ %call1465.i, %list_Delete.exit.thread.i ], [ %call14.i, %list_Delete.exit.i ], [ %call14.i, %while.body.i50.i ]
...
while.body.i60.preheader:                         ; preds = %while.body.i
  ...
  %lcmp.mod111.not = icmp eq i32 %xtraiter110, 0
  br i1 %lcmp.mod111.not, label %while.body.i60.prol.loopexit, label %while.body.i60.prol
...
while.body.i60.prol.loopexit:                     ; preds = %while.body.i60.prol, %while.body.i60.preheader
  %.unr112 = phi i32 [ %.pr.i54, %while.body.i60.preheader ], [ %dec.i.i.i58.prol, %while.body.i60.prol ]
...
while.body.i60:                                   ; preds = %while.body.i60.prol.loopexit, %while.body.i60
  %78 = phi i32 [ %dec.i.i.i58.1, %while.body.i60 ], [ %.unr112, %while.body.i60.prol.loopexit ]
...
cont_BackTrackAndStart.exit:                      ; preds = %while.body.i60.prol.loopexit, %while.body.i60, %while.body.i
  ...
  br i1 %cmp.i19, label %land.rhs.i, label %while.end.i.loopexit, !llvm.loop !43
...
while.end.i:                                      ; preds = %while.end.i.loopexit, %do.body.i
  ...
  br i1 %cmp8.not.i, label %if.end.i, label %if.then.i22

if.then.i22:                                      ; preds = %while.end.i
...
while.body.i40.preheader:                         ; preds = %if.then.i22
  %xtraiter116 = and i32 %.pr.i33, 1
  %lcmp.mod117.not = icmp eq i32 %xtraiter116, 0
  br i1 %lcmp.mod117.not, label %while.body.i40.prol.loopexit, label %while.body.i40.prol
...
while.body.i40.prol.loopexit:                     ; preds = %while.body.i40.prol, %while.body.i40.preheader
  %.unr118 = phi i32 [ %.pr.i33, %while.body.i40.preheader ], [ %dec.i.i.i38.prol, %while.body.i40.prol ]
...
while.body.i40:                                   ; preds = %while.body.i40.prol.loopexit, %while.body.i40
  %90 = phi i32 [ %dec.i.i.i38.1, %while.body.i40 ], [ %.unr118, %while.body.i40.prol.loopexit ]
  %91 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %91, ptr @cont_CURRENTBINDING, align 8
  %92 = getelementptr i8, ptr %91, i64 24
...
while.end.i42:                                    ; preds = %while.body.i40.prol.loopexit, %while.body.i40, %if.then.i22
  %97 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i41 = icmp eq i32 %97, 0
  br i1 %cmp.i.not.i41, label %if.then7, label %if.then.i46
...
if.end13.i:                                       ; preds = %if.end.i
  %call14.i23 = tail call fastcc i32 @subs_InternIdc(ptr noundef %c1, i32 noundef %59, ptr noundef nonnull %c2)
  %tobool15.not.i = icmp eq i32 %call14.i23, 0
...
while.body.i27.preheader:                         ; preds = %if.else.i
  %xtraiter113 = and i32 %.pr.i, 1
  %lcmp.mod114.not = icmp eq i32 %xtraiter113, 0
  br i1 %lcmp.mod114.not, label %while.body.i27.prol.loopexit, label %while.body.i27.prol
...
while.body.i27.prol:                              ; preds = %while.body.i27.preheader
  ...
  %call.val.i.i.i25.prol = load ptr, ptr %101, align 8
  store ptr %call.val.i.i.i25.prol, ptr @cont_LASTBINDING, align 8
...
while.body.i27.prol.loopexit:                     ; preds = %while.body.i27.prol, %while.body.i27.preheader
  %.unr115 = phi i32 [ %.pr.i, %while.body.i27.preheader ], [ %dec.i.i.i.prol, %while.body.i27.prol ]
  %103 = icmp eq i32 %.pr.i, 1
  br i1 %103, label %while.end.i28, label %while.body.i27

while.body.i27:                                   ; preds = %while.body.i27.prol.loopexit, %while.body.i27
  %104 = phi i32 [ %dec.i.i.i.1, %while.body.i27 ], [ %.unr115, %while.body.i27.prol.loopexit ]
  %105 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %105, ptr @cont_CURRENTBINDING, align 8
  %106 = getelementptr i8, ptr %105, i64 24
  %call.val.i.i.i25 = load ptr, ptr %106, align 8
  store ptr %call.val.i.i.i25, ptr @cont_LASTBINDING, align 8
  ...
  store ptr %108, ptr @cont_CURRENTBINDING, align 8
  %109 = getelementptr i8, ptr %108, i64 24
  %call.val.i.i.i25.1 = load ptr, ptr %109, align 8
  store ptr %call.val.i.i.i25.1, ptr @cont_LASTBINDING, align 8
...
while.end.i28:                                    ; preds = %while.body.i27.prol.loopexit, %while.body.i27, %if.else.i
  %111 = phi i32 [ %.pr.i, %if.else.i ], [ 0, %while.body.i27 ], [ 0, %while.body.i27.prol.loopexit ]
  %112 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i = icmp eq i32 %112, 0
  br i1 %cmp.i.not.i, label %cont_BackTrack.exit, label %if.then.i31
...
cont_BackTrack.exit:                              ; preds = %while.end.i28, %if.then.i31
  ...
  br i1 %cmp21.i, label %do.body.i, label %if.then7, !llvm.loop !44

if.then7:                                         ; preds = %cont_BackTrack.exit, %while.end.i42, %if.then.i46
...
do.cond:                                          ; preds = %do.body, %if.else
  ...
  br i1 %tobool11.not, label %do.body, label %cleanup.sink.split, !llvm.loop !45
...
for.end:                                          ; preds = %for.body, %entry
  %call2 = tail call fastcc i32 @subs_InternIdcEq(ptr noundef nonnull %c1, i32 noundef %0, ptr noundef %c2)
  store i32 %0, ptr @vec_MAX, align 4
  %7 = load ptr, ptr @cont_LASTBINDING, align 8
  %tobool.not2.i = icmp eq ptr %7, null
  br i1 %tobool.not2.i, label %cont_Reset.exit, label %while.body.preheader.i
...
for.cond.us.i.i:                                  ; preds = %for.cond4.for.end_crit_edge.us.i.i
  ...
  br i1 %cmp.us.i.i, label %for.body.us.i.i, label %if.then.i, !llvm.loop !47
...
while.body.i99.us.i.i.preheader:                  ; preds = %if.else.us.i.i
  ...
  br i1 %lcmp.mod172.not, label %while.body.i99.us.i.i.prol.loopexit, label %while.body.i99.us.i.i.prol
...
while.body.i99.us.i.i.prol.loopexit:              ; preds = %while.body.i99.us.i.i.prol, %while.body.i99.us.i.i.preheader
  %.unr173 = phi i32 [ %.pr.i92.us.i.i, %while.body.i99.us.i.i.preheader ], [ %dec.i.i.i97.us.i.i.prol, %while.body.i99.us.i.i.prol ]
...
while.body.i99.us.i.i:                            ; preds = %while.body.i99.us.i.i.prol.loopexit, %while.body.i99.us.i.i
  %34 = phi i32 [ %dec.i.i.i97.us.i.i.1, %while.body.i99.us.i.i ], [ %.unr173, %while.body.i99.us.i.i.prol.loopexit ]
  %35 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %35, ptr @cont_CURRENTBINDING, align 8
  %36 = getelementptr i8, ptr %35, i64 24
...
while.end.i101.us.i.i:                            ; preds = %while.body.i99.us.i.i.prol.loopexit, %while.body.i99.us.i.i, %if.else.us.i.i
  ...
  %42 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i100.us.i.i = icmp eq i32 %42, 0
  br i1 %cmp.i.not.i100.us.i.i, label %cont_BackTrack.exit106.us.i.i, label %if.then.i105.us.i.i
...
while.body.i167.us.i.i.preheader:                 ; preds = %if.end.us.i.i
  ...
  br i1 %lcmp.mod175.not, label %while.body.i167.us.i.i.prol.loopexit, label %while.body.i167.us.i.i.prol
...
while.body.i167.us.i.i.prol.loopexit:             ; preds = %while.body.i167.us.i.i.prol, %while.body.i167.us.i.i.preheader
  %.unr176 = phi i32 [ %.pr.i160.us.i.i, %while.body.i167.us.i.i.preheader ], [ %dec.i.i.i165.us.i.i.prol, %while.body.i167.us.i.i.prol ]
...
while.body.i167.us.i.i:                           ; preds = %while.body.i167.us.i.i.prol.loopexit, %while.body.i167.us.i.i
  %79 = phi i32 [ %dec.i.i.i165.us.i.i.1, %while.body.i167.us.i.i ], [ %.unr176, %while.body.i167.us.i.i.prol.loopexit ]
...
while.end.i169.us.i.i:                            ; preds = %while.body.i167.us.i.i.prol.loopexit, %while.body.i167.us.i.i, %if.end.us.i.i
  ...
  %cmp.i.not.i168.us.i.i = icmp eq i32 %87, 0
  br i1 %cmp.i.not.i168.us.i.i, label %for.inc.us.i.i, label %for.inc.us.sink.split.i.i
...
for.inc.us.i.i:                                   ; preds = %for.inc.us.sink.split.i.i, %while.end.i169.us.i.i, %lor.lhs.false.us.i.i, %fol_Atom.exit118.us.i.i, %fol_Atom.exit.us.thread.i.i, %fol_Atom.exit.us.i.i, %cont_BackTrack.exit106.us.i.i, %while.end.i.us.i.i
  ...
  br i1 %cmp5.us.i.i, label %for.body6.us.i.i, label %for.cond4.for.end_crit_edge.us.i.i, !llvm.loop !48
...
for.inc.i.i:                                      ; preds = %if.then.i.i, %for.body.i.i
  ...
  %scan.0.val31.i.i = load ptr, ptr %scan.039.i.i, align 8
  %cmp.i.not.i.i = icmp eq ptr %scan.0.val31.i.i, null
  br i1 %cmp.i.not.i.i, label %for.end.i.i, label %for.body.i.i, !llvm.loop !36
...
while.body.i.i.i:                                 ; preds = %for.end.i.i, %while.body.i.i.i
  ...
  br i1 %cmp.i.not.i.i.i, label %list_Delete.exit.i.i, label %while.body.i.i.i, !llvm.loop !26
...
for.inc.i:                                        ; preds = %if.then10.i, %list_Delete.exit.i.i, %for.body.i
  ...
  br i1 %cmp.i, label %for.body.i, label %for.end.i, !llvm.loop !49
...
while.body.i.i:                                   ; preds = %for.end.i, %while.body.i.i
  ...
  br i1 %cmp.i.not.i35.i, label %list_Delete.exit.i, label %while.body.i.i, !llvm.loop !26
...
while.body.i43.i:                                 ; preds = %list_Delete.exit.i, %while.body.i43.i
  %Current.06.i37.i = phi ptr [ %Current.0.val.i38.i, %while.body.i43.i ], [ %TermIndexlist.1.i, %list_Delete.exit.i ]
  ...
  br i1 %cmp.i.not.i42.i, label %if.end, label %while.body.i43.i, !llvm.loop !26

if.end:                                           ; preds = %while.body.i43.i, %list_Delete.exit.i, %list_Delete.exit.thread.i
  %litptr.0.ph = phi ptr [ %call1461.i, %list_Delete.exit.thread.i ], [ %call14.i, %list_Delete.exit.i ], [ %call14.i, %while.body.i43.i ]
...
fol_Atom.exit117:                                 ; preds = %land.lhs.true.i
  %Lit.val4.i113 = load ptr, ptr %123, align 8
  %130 = getelementptr i8, ptr %Lit.val4.i113, i64 8
  %Lit.val4.val.i114 = load ptr, ptr %130, align 8
  %call11.val.i.pre = load i32, ptr %Lit.val4.val.i114, align 8
...
fol_Atom.exit108:                                 ; preds = %fol_Atom.exit117
  ...
  %Lit.val4.i104 = load ptr, ptr %133, align 8
  %134 = getelementptr i8, ptr %Lit.val4.i104, i64 8
  %Lit.val4.val.i105 = load ptr, ptr %134, align 8
  %call15.val.i.pre = load i32, ptr %Lit.val4.val.i105, align 8
...
land.lhs.true18.i:                                ; preds = %fol_Atom.exit117.thread, %fol_Atom.exit108
  %c1.val.i20 = load ptr, ptr %118, align 8
  %arrayidx.i99 = getelementptr inbounds ptr, ptr %c1.val.i20, i64 %idxprom.i.i129
...
if.then25.i:                                      ; preds = %lor.lhs.false.i, %land.lhs.true18.i
  ...
  br i1 %cmp1.i, label %while.body.i94.preheader, label %cont_BackTrackAndStart.exit

while.body.i94.preheader:                         ; preds = %if.then25.i
  %xtraiter177 = and i32 %.pr.i88, 1
  %lcmp.mod178.not = icmp eq i32 %xtraiter177, 0
  br i1 %lcmp.mod178.not, label %while.body.i94.prol.loopexit, label %while.body.i94.prol

while.body.i94.prol:                              ; preds = %while.body.i94.preheader
  %139 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %139, ptr @cont_CURRENTBINDING, align 8
  %140 = getelementptr i8, ptr %139, i64 24
  %call.val.i.i.i89.prol = load ptr, ptr %140, align 8
  store ptr %call.val.i.i.i89.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i90.prol = getelementptr inbounds %struct.binding, ptr %139, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i90.prol, i8 0, i64 20, i1 false)
  %141 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i91.prol = getelementptr inbounds %struct.binding, ptr %141, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i91.prol, align 8
  %dec.i.i.i92.prol = add nsw i32 %.pr.i88, -1
  store i32 %dec.i.i.i92.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i94.prol.loopexit

while.body.i94.prol.loopexit:                     ; preds = %while.body.i94.prol, %while.body.i94.preheader
  %.unr179 = phi i32 [ %.pr.i88, %while.body.i94.preheader ], [ %dec.i.i.i92.prol, %while.body.i94.prol ]
  %142 = icmp eq i32 %.pr.i88, 1
  br i1 %142, label %cont_BackTrackAndStart.exit.loopexit, label %while.body.i94

while.body.i94:                                   ; preds = %while.body.i94.prol.loopexit, %while.body.i94
  %143 = phi i32 [ %dec.i.i.i92.1, %while.body.i94 ], [ %.unr179, %while.body.i94.prol.loopexit ]
  %144 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %144, ptr @cont_CURRENTBINDING, align 8
  %145 = getelementptr i8, ptr %144, i64 24
  %call.val.i.i.i89 = load ptr, ptr %145, align 8
  store ptr %call.val.i.i.i89, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i90 = getelementptr inbounds %struct.binding, ptr %144, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i90, i8 0, i64 20, i1 false)
  %146 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i91 = getelementptr inbounds %struct.binding, ptr %146, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i91, align 8
  %dec.i.i.i92 = add nsw i32 %143, -1
  store i32 %dec.i.i.i92, ptr @cont_BINDINGS, align 4
  %147 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %147, ptr @cont_CURRENTBINDING, align 8
  %148 = getelementptr i8, ptr %147, i64 24
  %call.val.i.i.i89.1 = load ptr, ptr %148, align 8
  store ptr %call.val.i.i.i89.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i90.1 = getelementptr inbounds %struct.binding, ptr %147, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i90.1, i8 0, i64 20, i1 false)
  %149 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i91.1 = getelementptr inbounds %struct.binding, ptr %149, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i91.1, align 8
  %dec.i.i.i92.1 = add nsw i32 %143, -2
  store i32 %dec.i.i.i92.1, ptr @cont_BINDINGS, align 4
  %cmp.i93.1 = icmp ugt i32 %dec.i.i.i92, 1
  br i1 %cmp.i93.1, label %while.body.i94, label %cont_BackTrackAndStart.exit.loopexit, !llvm.loop !7

cont_BackTrackAndStart.exit.loopexit:             ; preds = %while.body.i94, %while.body.i94.prol.loopexit
...
cont_BackTrackAndStart.exit:                      ; preds = %cont_BackTrackAndStart.exit.loopexit, %if.then25.i
  ...
  br i1 %cmp.i82, label %if.then.i85, label %fol_Atom.exit87

if.then.i85:                                      ; preds = %cont_BackTrackAndStart.exit
  %Lit.val4.i83 = load ptr, ptr %123, align 8
  %151 = getelementptr i8, ptr %Lit.val4.i83, i64 8
  %Lit.val4.val.i84 = load ptr, ptr %151, align 8
  br label %fol_Atom.exit87

fol_Atom.exit87:                                  ; preds = %cont_BackTrackAndStart.exit, %if.then.i85
  %retval.0.i86 = phi ptr [ %Lit.val4.val.i84, %if.then.i85 ], [ %call.val.i131, %cont_BackTrackAndStart.exit ]
  %152 = getelementptr i8, ptr %retval.0.i86, i64 16
  ...
  br i1 %cmp.i75, label %if.then.i78, label %fol_Atom.exit80

if.then.i78:                                      ; preds = %fol_Atom.exit87
  %154 = getelementptr i8, ptr %call.val.i, i64 16
  %Lit.val4.i76 = load ptr, ptr %154, align 8
  %155 = getelementptr i8, ptr %Lit.val4.i76, i64 8
  %Lit.val4.val.i77 = load ptr, ptr %155, align 8
  br label %fol_Atom.exit80

fol_Atom.exit80:                                  ; preds = %fol_Atom.exit87, %if.then.i78
  %retval.0.i79 = phi ptr [ %Lit.val4.val.i77, %if.then.i78 ], [ %call.val.i, %fol_Atom.exit87 ]
  %156 = getelementptr i8, ptr %retval.0.i79, i64 16
...
land.lhs.true34.i:                                ; preds = %fol_Atom.exit80
  ...
  br i1 %cmp.i68, label %if.then.i71, label %fol_Atom.exit73

if.then.i71:                                      ; preds = %land.lhs.true34.i
  %Lit.val4.i69 = load ptr, ptr %123, align 8
  %160 = getelementptr i8, ptr %Lit.val4.i69, i64 8
  %Lit.val4.val.i70 = load ptr, ptr %160, align 8
  br label %fol_Atom.exit73

fol_Atom.exit73:                                  ; preds = %land.lhs.true34.i, %if.then.i71
  %retval.0.i72 = phi ptr [ %Lit.val4.val.i70, %if.then.i71 ], [ %call.val.i131, %land.lhs.true34.i ]
  %161 = getelementptr i8, ptr %retval.0.i72, i64 16
  ...
  br i1 %cmp.i64, label %if.then.i65, label %fol_Atom.exit

if.then.i65:                                      ; preds = %fol_Atom.exit73
...
fol_Atom.exit:                                    ; preds = %fol_Atom.exit73, %if.then.i65
  %retval.0.i66 = phi ptr [ %Lit.val4.val.i, %if.then.i65 ], [ %call.val.i, %fol_Atom.exit73 ]
  %165 = getelementptr i8, ptr %retval.0.i66, i64 16
...
if.then45.i:                                      ; preds = %fol_Atom.exit117.thread, %fol_Atom.exit, %fol_Atom.exit80, %lor.lhs.false.i, %fol_Atom.exit108, %fol_Atom.exit117, %if.else.i
  %inc.i21 = add nsw i32 %a.1.i148, 1
  %.pr.i49 = load i32, ptr @cont_BINDINGS, align 4
  %cmp2.i50 = icmp sgt i32 %.pr.i49, 0
  br i1 %cmp2.i50, label %while.body.i56.preheader, label %while.end.i58

while.body.i56.preheader:                         ; preds = %if.then45.i
  %xtraiter180 = and i32 %.pr.i49, 1
  %lcmp.mod181.not = icmp eq i32 %xtraiter180, 0
  br i1 %lcmp.mod181.not, label %while.body.i56.prol.loopexit, label %while.body.i56.prol
...
while.body.i56.prol:                              ; preds = %while.body.i56.preheader
  ...
  %call.val.i.i.i51.prol = load ptr, ptr %168, align 8
  store ptr %call.val.i.i.i51.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i52.prol = getelementptr inbounds %struct.binding, ptr %167, i64 0, i32 1
  ...
  %link.i.i.i.i53.prol = getelementptr inbounds %struct.binding, ptr %169, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i53.prol, align 8
  %dec.i.i.i54.prol = add nsw i32 %.pr.i49, -1
...
while.body.i56.prol.loopexit:                     ; preds = %while.body.i56.prol, %while.body.i56.preheader
  %.unr182 = phi i32 [ %.pr.i49, %while.body.i56.preheader ], [ %dec.i.i.i54.prol, %while.body.i56.prol ]
  %170 = icmp eq i32 %.pr.i49, 1
  br i1 %170, label %while.end.i58, label %while.body.i56

while.body.i56:                                   ; preds = %while.body.i56.prol.loopexit, %while.body.i56
  %171 = phi i32 [ %dec.i.i.i54.1, %while.body.i56 ], [ %.unr182, %while.body.i56.prol.loopexit ]
  ...
  %call.val.i.i.i51 = load ptr, ptr %173, align 8
  store ptr %call.val.i.i.i51, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i52 = getelementptr inbounds %struct.binding, ptr %172, i64 0, i32 1
  ...
  %link.i.i.i.i53 = getelementptr inbounds %struct.binding, ptr %174, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i53, align 8
  %dec.i.i.i54 = add nsw i32 %171, -1
  ...
  %call.val.i.i.i51.1 = load ptr, ptr %176, align 8
  store ptr %call.val.i.i.i51.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i52.1 = getelementptr inbounds %struct.binding, ptr %175, i64 0, i32 1
  ...
  %link.i.i.i.i53.1 = getelementptr inbounds %struct.binding, ptr %177, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i53.1, align 8
  %dec.i.i.i54.1 = add nsw i32 %171, -2
  store i32 %dec.i.i.i54.1, ptr @cont_BINDINGS, align 4
  %cmp.i55.1 = icmp ugt i32 %dec.i.i.i54, 1
  br i1 %cmp.i55.1, label %while.body.i56, label %while.end.i58, !llvm.loop !8

while.end.i58:                                    ; preds = %while.body.i56.prol.loopexit, %while.body.i56, %if.then45.i
  %178 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i57 = icmp eq i32 %178, 0
  br i1 %cmp.i.not.i57, label %if.end48.i, label %if.then.i62

if.then.i62:                                      ; preds = %while.end.i58
  %dec.i.i59 = add nsw i32 %178, -1
  store i32 %dec.i.i59, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i60 = sext i32 %dec.i.i59 to i64
  %arrayidx.i.i61 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i60
  %179 = load i32, ptr %arrayidx.i.i61, align 4
  store i32 %179, ptr @cont_BINDINGS, align 4
  br label %if.end48.i

if.end48.i:                                       ; preds = %if.then.i62, %while.end.i58, %fol_Atom.exit, %while.body.i
  %tobool.i = phi i1 [ true, %if.then.i62 ], [ true, %while.end.i58 ], [ false, %fol_Atom.exit ], [ false, %while.body.i ]
  %a.2.i = phi i32 [ %inc.i21, %if.then.i62 ], [ %inc.i21, %while.end.i58 ], [ %a.1.i148, %fol_Atom.exit ], [ %a.1.i148, %while.body.i ]
  ...
  br i1 %180, label %while.body.i, label %while.end.i, !llvm.loop !50
...
if.then51.i:                                      ; preds = %do.body.i, %while.end.i
  ...
  br i1 %cmp2.i30, label %while.body.i36.preheader, label %while.end.i38

while.body.i36.preheader:                         ; preds = %if.then51.i
  %xtraiter186 = and i32 %.pr.i29, 1
  %lcmp.mod187.not = icmp eq i32 %xtraiter186, 0
  br i1 %lcmp.mod187.not, label %while.body.i36.prol.loopexit, label %while.body.i36.prol

while.body.i36.prol:                              ; preds = %while.body.i36.preheader
  ...
  %call.val.i.i.i31.prol = load ptr, ptr %182, align 8
  store ptr %call.val.i.i.i31.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i32.prol = getelementptr inbounds %struct.binding, ptr %181, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i32.prol, i8 0, i64 20, i1 false)
  %183 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i33.prol = getelementptr inbounds %struct.binding, ptr %183, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i33.prol, align 8
  %dec.i.i.i34.prol = add nsw i32 %.pr.i29, -1
  store i32 %dec.i.i.i34.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i36.prol.loopexit

while.body.i36.prol.loopexit:                     ; preds = %while.body.i36.prol, %while.body.i36.preheader
  %.unr188 = phi i32 [ %.pr.i29, %while.body.i36.preheader ], [ %dec.i.i.i34.prol, %while.body.i36.prol ]
  %184 = icmp eq i32 %.pr.i29, 1
  br i1 %184, label %while.end.i38, label %while.body.i36

while.body.i36:                                   ; preds = %while.body.i36.prol.loopexit, %while.body.i36
  %185 = phi i32 [ %dec.i.i.i34.1, %while.body.i36 ], [ %.unr188, %while.body.i36.prol.loopexit ]
  ...
  %call.val.i.i.i31 = load ptr, ptr %187, align 8
  store ptr %call.val.i.i.i31, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i32 = getelementptr inbounds %struct.binding, ptr %186, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i32, i8 0, i64 20, i1 false)
  %188 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i33 = getelementptr inbounds %struct.binding, ptr %188, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i33, align 8
  %dec.i.i.i34 = add nsw i32 %185, -1
  store i32 %dec.i.i.i34, ptr @cont_BINDINGS, align 4
  ...
  %call.val.i.i.i31.1 = load ptr, ptr %190, align 8
  store ptr %call.val.i.i.i31.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i32.1 = getelementptr inbounds %struct.binding, ptr %189, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i32.1, i8 0, i64 20, i1 false)
  %191 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i33.1 = getelementptr inbounds %struct.binding, ptr %191, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i33.1, align 8
  %dec.i.i.i34.1 = add nsw i32 %185, -2
  store i32 %dec.i.i.i34.1, ptr @cont_BINDINGS, align 4
  %cmp.i35.1 = icmp ugt i32 %dec.i.i.i34, 1
  br i1 %cmp.i35.1, label %while.body.i36, label %while.end.i38, !llvm.loop !8

while.end.i38:                                    ; preds = %while.body.i36.prol.loopexit, %while.body.i36, %if.then51.i
  %192 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i37 = icmp eq i32 %192, 0
  br i1 %cmp.i.not.i37, label %if.then7, label %if.then.i42

if.then.i42:                                      ; preds = %while.end.i38
  %dec.i.i39 = add nsw i32 %192, -1
  store i32 %dec.i.i39, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i40 = sext i32 %dec.i.i39 to i64
  %arrayidx.i.i41 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i40
  %193 = load i32, ptr %arrayidx.i.i41, align 4
...
if.end57.i:                                       ; preds = %if.end53.i
  %call58.i = tail call fastcc i32 @subs_InternIdcEq(ptr noundef %c1, i32 noundef %117, ptr noundef nonnull %c2)
...
if.else61.i:                                      ; preds = %if.end57.i
  %.pr.i = load i32, ptr @cont_BINDINGS, align 4
  %cmp2.i = icmp sgt i32 %.pr.i, 0
  br i1 %cmp2.i, label %while.body.i24.preheader, label %while.end.i25

while.body.i24.preheader:                         ; preds = %if.else61.i
  %xtraiter183 = and i32 %.pr.i, 1
  %lcmp.mod184.not = icmp eq i32 %xtraiter183, 0
  br i1 %lcmp.mod184.not, label %while.body.i24.prol.loopexit, label %while.body.i24.prol

while.body.i24.prol:                              ; preds = %while.body.i24.preheader
  ...
  %dec.i.i.i.prol = add nsw i32 %.pr.i, -1
  store i32 %dec.i.i.i.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i24.prol.loopexit

while.body.i24.prol.loopexit:                     ; preds = %while.body.i24.prol, %while.body.i24.preheader
  %.unr185 = phi i32 [ %.pr.i, %while.body.i24.preheader ], [ %dec.i.i.i.prol, %while.body.i24.prol ]
  %198 = icmp eq i32 %.pr.i, 1
  br i1 %198, label %while.end.i25, label %while.body.i24

while.body.i24:                                   ; preds = %while.body.i24.prol.loopexit, %while.body.i24
  %199 = phi i32 [ %dec.i.i.i.1, %while.body.i24 ], [ %.unr185, %while.body.i24.prol.loopexit ]
  ...
  store i32 %dec.i.i.i.1, ptr @cont_BINDINGS, align 4
  %cmp.i23.1 = icmp ugt i32 %dec.i.i.i, 1
  br i1 %cmp.i23.1, label %while.body.i24, label %while.end.i25, !llvm.loop !8

while.end.i25:                                    ; preds = %while.body.i24.prol.loopexit, %while.body.i24, %if.else61.i
  %206 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i = icmp eq i32 %206, 0
  br i1 %cmp.i.not.i, label %cont_BackTrack.exit, label %if.then.i28

if.then.i28:                                      ; preds = %while.end.i25
  %dec.i.i = add nsw i32 %206, -1
  store i32 %dec.i.i, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i26 = sext i32 %dec.i.i to i64
  %arrayidx.i.i27 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i26
  %207 = load i32, ptr %arrayidx.i.i27, align 4
  store i32 %207, ptr @cont_BINDINGS, align 4
  br label %cont_BackTrack.exit

cont_BackTrack.exit:                              ; preds = %while.end.i25, %if.then.i28
  ...
  br i1 %cmp66.i, label %do.body.i, label %if.then7, !llvm.loop !51

if.then7:                                         ; preds = %cont_BackTrack.exit, %while.end.i38, %if.then.i42
...
do.cond:                                          ; preds = %do.body, %if.else
  %call10 = tail call i32 @litptr_AllUsed(ptr noundef %litptr.0.ph) #7
  %tobool11.not = icmp eq i32 %call10, 0
  br i1 %tobool11.not, label %do.body, label %cleanup.sink.split, !llvm.loop !52
...
for.end:                                          ; preds = %for.body, %entry
  ...
  %call3 = tail call fastcc i32 @subs_InternIdcEq(ptr noundef nonnull %c1, i32 noundef %0, ptr noundef %c2)
  store i32 %0, ptr @vec_MAX, align 4
...
for.end:                                          ; preds = %for.body, %entry
  %call2 = tail call fastcc i32 @subs_InternIdcRes(ptr noundef nonnull %c1, i32 noundef %0, i32 noundef %beg, i32 noundef %end)
  store i32 %0, ptr @vec_MAX, align 4
  %7 = load ptr, ptr @cont_LASTBINDING, align 8
  %tobool.not2.i = icmp eq ptr %7, null
  br i1 %tobool.not2.i, label %cont_Reset.exit, label %while.body.preheader.i
...
cont_BackTrack.exit.us.i.i:                       ; preds = %if.then.i.us.i.i, %while.end.i.us.i.i
  ...
  br i1 %cmp2.us.i.i, label %for.body3.us.i.i, label %for.cond1.for.end_crit_edge.us.i.i, !llvm.loop !55
...
for.cond.us.i.i:                                  ; preds = %for.cond1.for.end_crit_edge.us.i.i
  ...
  br i1 %cmp.us.i.i, label %for.cond1.preheader.us.i.i, label %if.then.i, !llvm.loop !56
...
while.body.i.i:                                   ; preds = %for.end.i, %while.body.i.i
  ...
  br i1 %cmp.i.not.i34.i, label %list_Delete.exit.i, label %while.body.i.i, !llvm.loop !26
...
while.body.i42.i:                                 ; preds = %list_Delete.exit.i, %while.body.i42.i
  %Current.06.i36.i = phi ptr [ %Current.0.val.i37.i, %while.body.i42.i ], [ %TermIndexlist.1.i, %list_Delete.exit.i ]
  %Current.0.val.i37.i = load ptr, ptr %Current.06.i36.i, align 8
  %51 = load ptr, ptr getelementptr ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  ...
  %cmp.i.not.i41.i = icmp eq ptr %Current.0.val.i37.i, null
  br i1 %cmp.i.not.i41.i, label %if.end, label %while.body.i42.i, !llvm.loop !26

if.end:                                           ; preds = %while.body.i42.i, %list_Delete.exit.i, %list_Delete.exit.thread.i
  %litptr.0.ph = phi ptr [ %call1460.i, %list_Delete.exit.thread.i ], [ %call14.i, %list_Delete.exit.i ], [ %call14.i, %while.body.i42.i ]
...
for.inc.us.i:                                     ; preds = %while.cond.while.end_crit_edge.us.i
  ...
  br i1 %cmp.us.i, label %while.cond.preheader.us.i, label %subs_SearchTopRes.exit, !llvm.loop !58
...
cont_BackTrack.exit.us.i:                         ; preds = %if.then.i.us.i, %while.end.i.us.i
  ...
  br i1 %85, label %while.body.us.i, label %while.cond.while.end_crit_edge.us.i, !llvm.loop !59
...
subs_SearchTopRes.exit:                           ; preds = %for.inc.us.i, %if.then4, %if.then14.loopexit.i
  %.pre87 = phi i32 [ %.pre8794, %if.then14.loopexit.i ], [ %.pre87.pre, %if.then4 ], [ %.pre8794, %for.inc.us.i ]
  %.pre = phi i32 [ %.pre91, %if.then14.loopexit.i ], [ %.pre.pre, %if.then4 ], [ %.pre91, %for.inc.us.i ]
...
do.body.i:                                        ; preds = %cont_BackTrack.exit, %subs_SearchTopRes.exit
  ...
  br i1 %cmp.i2080, label %land.rhs.i, label %while.end.i41

land.rhs.i:                                       ; preds = %do.body.i, %cont_BackTrackAndStart.exit
  %a.1.i81 = phi i32 [ %inc.i22, %cont_BackTrackAndStart.exit ], [ %a.0.i, %do.body.i ]
...
while.body.i54.preheader:                         ; preds = %while.body.i
  ...
  br i1 %lcmp.mod118.not, label %while.body.i54.prol.loopexit, label %while.body.i54.prol
...
while.body.i54.prol.loopexit:                     ; preds = %while.body.i54.prol, %while.body.i54.preheader
  %.unr119 = phi i32 [ %.pr.i48, %while.body.i54.preheader ], [ %dec.i.i.i52.prol, %while.body.i54.prol ]
  %98 = icmp eq i32 %.pr.i48, 1
  br i1 %98, label %cont_BackTrackAndStart.exit, label %while.body.i54

while.body.i54:                                   ; preds = %while.body.i54.prol.loopexit, %while.body.i54
  %99 = phi i32 [ %dec.i.i.i52.1, %while.body.i54 ], [ %.unr119, %while.body.i54.prol.loopexit ]
  %100 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %100, ptr @cont_CURRENTBINDING, align 8
  %101 = getelementptr i8, ptr %100, i64 24
...
cont_BackTrackAndStart.exit:                      ; preds = %while.body.i54.prol.loopexit, %while.body.i54, %while.body.i
  ...
  br i1 %cmp.i20, label %land.rhs.i, label %while.end.i41, !llvm.loop !60

while.end.i41:                                    ; preds = %do.body.i, %cont_BackTrackAndStart.exit
  %106 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i40 = icmp eq i32 %106, 0
  br i1 %cmp.i.not.i40, label %if.then7, label %if.then.i45
...
if.end12.i:                                       ; preds = %if.end.i
  %call13.i = tail call fastcc i32 @subs_InternIdcRes(ptr noundef nonnull %c1, i32 noundef %56, i32 noundef %beg, i32 noundef %end)
...
while.body.i26.preheader:                         ; preds = %if.else.i
  ...
  br i1 %lcmp.mod121.not, label %while.body.i26.prol.loopexit, label %while.body.i26.prol
...
while.body.i26.prol.loopexit:                     ; preds = %while.body.i26.prol, %while.body.i26.preheader
  %.unr122 = phi i32 [ %.pr.i, %while.body.i26.preheader ], [ %dec.i.i.i.prol, %while.body.i26.prol ]
...
while.body.i26:                                   ; preds = %while.body.i26.prol.loopexit, %while.body.i26
  %113 = phi i32 [ %dec.i.i.i.1, %while.body.i26 ], [ %.unr122, %while.body.i26.prol.loopexit ]
...
while.end.i27:                                    ; preds = %while.body.i26.prol.loopexit, %while.body.i26, %if.else.i
  ...
  br i1 %cmp.i.not.i, label %cont_BackTrack.exit, label %if.then.i30
...
cont_BackTrack.exit:                              ; preds = %while.end.i27, %if.then.i30
  ...
  br i1 %cmp19.i, label %do.body.i, label %if.then7, !llvm.loop !61

if.then7:                                         ; preds = %cont_BackTrack.exit, %while.end.i41, %if.then.i45
...
do.cond:                                          ; preds = %do.body, %if.else
  %call10 = tail call i32 @litptr_AllUsed(ptr noundef %litptr.0.ph) #7
  %tobool11.not = icmp eq i32 %call10, 0
  br i1 %tobool11.not, label %do.body, label %cleanup.sink.split, !llvm.loop !62
...
for.inc:                                          ; preds = %for.body, %if.then5
  ...
  br i1 %cmp3, label %for.body, label %for.end, !llvm.loop !63

for.end:                                          ; preds = %for.inc, %if.else
  %9 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  tail call void @unify_EstablishMatcher(ptr noundef %9, ptr noundef %subst) #7
  %call7 = tail call fastcc i32 @subs_InternIdcEqExcept(ptr noundef nonnull %c1, i32 noundef %3, ptr noundef %c2, i32 noundef %i2)
...
for.cond.us.i.i:                                  ; preds = %for.cond4.for.end_crit_edge.us.i.i
  ...
  br i1 %cmp.us.i.i, label %for.body.us.i.i, label %if.then.i, !llvm.loop !64
...
while.body.i148.us.i.i.preheader:                 ; preds = %if.end51.us.i.i
  ...
  br i1 %lcmp.mod170.not, label %while.body.i148.us.i.i.prol.loopexit, label %while.body.i148.us.i.i.prol
...
while.body.i148.us.i.i.prol.loopexit:             ; preds = %while.body.i148.us.i.i.prol, %while.body.i148.us.i.i.preheader
  %.unr171 = phi i32 [ %.pr.i142.us.i.i, %while.body.i148.us.i.i.preheader ], [ %dec.i.i.i146.us.i.i.prol, %while.body.i148.us.i.i.prol ]
...
while.body.i148.us.i.i:                           ; preds = %while.body.i148.us.i.i.prol.loopexit, %while.body.i148.us.i.i
  %61 = phi i32 [ %dec.i.i.i146.us.i.i.1, %while.body.i148.us.i.i ], [ %.unr171, %while.body.i148.us.i.i.prol.loopexit ]
  %62 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %62, ptr @cont_CURRENTBINDING, align 8
  %63 = getelementptr i8, ptr %62, i64 24
...
while.end.i.us.i.i:                               ; preds = %while.body.i148.us.i.i.prol.loopexit, %while.body.i148.us.i.i, %if.end51.us.i.i
  ...
  br i1 %cmp.i.not.i.us.i.i, label %for.inc.us.i.i, label %if.then.i151.us.i.i
...
for.inc.us.i.i:                                   ; preds = %if.then.i151.us.i.i, %while.end.i.us.i.i, %for.body6.us.i.i
  ...
  %inc.us.i.i = add nsw i32 %j.2.us.i.i, 1
  %cmp5.us.i.i = icmp slt i32 %inc.us.i.i, %add3.i.i.i
  br i1 %cmp5.us.i.i, label %for.body6.us.i.i, label %for.cond4.for.end_crit_edge.us.i.i, !llvm.loop !65
...
for.inc.i:                                        ; preds = %if.then10.i, %list_Delete.exit.i.i, %for.body.i
  ...
  br i1 %cmp.i, label %for.body.i, label %for.end.i, !llvm.loop !66
...
while.body.i:                                     ; preds = %do.body.i, %if.end53.i
  ...
  br i1 %cmp3.not.i, label %if.end53.i, label %if.then.i21
...
while.body.i97.preheader:                         ; preds = %if.then27.i
  ...
  br i1 %lcmp.mod173.not, label %while.body.i97.prol.loopexit, label %while.body.i97.prol
...
while.body.i97.prol.loopexit:                     ; preds = %while.body.i97.prol, %while.body.i97.preheader
  %.unr174 = phi i32 [ %.pr.i91, %while.body.i97.preheader ], [ %dec.i.i.i95.prol, %while.body.i97.prol ]
...
while.body.i97:                                   ; preds = %while.body.i97.prol.loopexit, %while.body.i97
  %123 = phi i32 [ %dec.i.i.i95.1, %while.body.i97 ], [ %.unr174, %while.body.i97.prol.loopexit ]
...
if.then47.i:                                      ; preds = %fol_Atom.exit120.thread, %fol_Atom.exit, %fol_Atom.exit83, %lor.lhs.false.i, %fol_Atom.exit111, %fol_Atom.exit120, %if.else.i
  %inc.i24 = add nsw i32 %a.1.i150, 1
...
while.body.i59.preheader:                         ; preds = %if.then47.i
  ...
  br i1 %lcmp.mod176.not, label %while.body.i59.prol.loopexit, label %while.body.i59.prol
...
while.body.i59.prol.loopexit:                     ; preds = %while.body.i59.prol, %while.body.i59.preheader
  %.unr177 = phi i32 [ %.pr.i52, %while.body.i59.preheader ], [ %dec.i.i.i57.prol, %while.body.i59.prol ]
...
while.body.i59:                                   ; preds = %while.body.i59.prol.loopexit, %while.body.i59
  %151 = phi i32 [ %dec.i.i.i57.1, %while.body.i59 ], [ %.unr177, %while.body.i59.prol.loopexit ]
...
while.end.i61:                                    ; preds = %while.body.i59.prol.loopexit, %while.body.i59, %if.then47.i
  ...
  %cmp.i.not.i60 = icmp eq i32 %158, 0
  br i1 %cmp.i.not.i60, label %if.end53.i, label %if.then.i65
...
if.end53.i:                                       ; preds = %while.body.i, %if.then.i65, %while.end.i61, %fol_Atom.exit, %if.then.i21
  %tobool.i = phi i1 [ true, %if.then.i65 ], [ true, %while.end.i61 ], [ false, %fol_Atom.exit ], [ false, %if.then.i21 ], [ true, %while.body.i ]
  %a.2.i = phi i32 [ %inc.i24, %if.then.i65 ], [ %inc.i24, %while.end.i61 ], [ %a.1.i150, %fol_Atom.exit ], [ %a.1.i150, %if.then.i21 ], [ %inc52.i, %while.body.i ]
  ...
  br i1 %160, label %while.body.i, label %while.end.i, !llvm.loop !67
...
while.body.i39.preheader:                         ; preds = %if.then56.i
  ...
  br i1 %lcmp.mod182.not, label %while.body.i39.prol.loopexit, label %while.body.i39.prol
...
while.body.i39.prol.loopexit:                     ; preds = %while.body.i39.prol, %while.body.i39.preheader
  %.unr183 = phi i32 [ %.pr.i32, %while.body.i39.preheader ], [ %dec.i.i.i37.prol, %while.body.i39.prol ]
...
while.body.i39:                                   ; preds = %while.body.i39.prol.loopexit, %while.body.i39
  %165 = phi i32 [ %dec.i.i.i37.1, %while.body.i39 ], [ %.unr183, %while.body.i39.prol.loopexit ]
...
while.end.i41:                                    ; preds = %while.body.i39.prol.loopexit, %while.body.i39, %if.then56.i
  ...
  %cmp.i.not.i40 = icmp eq i32 %172, 0
  br i1 %cmp.i.not.i40, label %if.then7, label %if.then.i45
...
if.end62.i:                                       ; preds = %if.end58.i
  %call63.i = tail call fastcc i32 @subs_InternIdcEqExcept(ptr noundef %c1, i32 noundef %97, ptr noundef nonnull %c2, i32 noundef %i2)
...
while.body.i27.preheader:                         ; preds = %if.else66.i
  ...
  br i1 %lcmp.mod179.not, label %while.body.i27.prol.loopexit, label %while.body.i27.prol
...
while.body.i27.prol.loopexit:                     ; preds = %while.body.i27.prol, %while.body.i27.preheader
  %.unr180 = phi i32 [ %.pr.i, %while.body.i27.preheader ], [ %dec.i.i.i.prol, %while.body.i27.prol ]
  %178 = icmp eq i32 %.pr.i, 1
  br i1 %178, label %while.end.i28, label %while.body.i27

while.body.i27:                                   ; preds = %while.body.i27.prol.loopexit, %while.body.i27
  %179 = phi i32 [ %dec.i.i.i.1, %while.body.i27 ], [ %.unr180, %while.body.i27.prol.loopexit ]
...
cont_BackTrack.exit:                              ; preds = %while.end.i28, %if.then.i31
  ...
  br i1 %cmp71.i, label %do.body.i, label %if.then7, !llvm.loop !68
...
do.cond:                                          ; preds = %do.body, %if.else
  %call10 = tail call i32 @litptr_AllUsed(ptr noundef %litptr.0.ph) #7
  %tobool11.not = icmp eq i32 %call10, 0
  br i1 %tobool11.not, label %do.body, label %cleanup.sink.split, !llvm.loop !69
...
for.inc:                                          ; preds = %for.body, %if.then5
  ...
  br i1 %cmp2, label %for.body, label %for.end, !llvm.loop !70
...
for.inc41.us:                                     ; preds = %if.then32.us, %land.lhs.true.us, %for.body22.us
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.cond19.for.inc44_crit_edge.us, label %for.body22.us, !llvm.loop !71
...
for.cond19.for.inc44_crit_edge.us:                ; preds = %for.inc41.us
  ...
  br i1 %cmp.i.not.us, label %while.body.i, label %for.body17.us, !llvm.loop !72
...
while.body.i:                                     ; preds = %for.cond19.for.inc44_crit_edge.us, %while.body.i
  ...
  br i1 %cmp.i.not.i, label %if.end48, label %while.body.i, !llvm.loop !26
...
cont_BackTrack.exit:                              ; preds = %while.end.i, %if.then.i
  ...
  br i1 %33, label %while.body, label %while.end, !llvm.loop !73
...
for.inc:                                          ; preds = %while.end
  ...
  br i1 %cmp, label %while.cond.preheader, label %cleanup, !llvm.loop !74
