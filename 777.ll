; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/ch.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/ch.c"
...
define dso_local ptr @get_points_on_hull(ptr noundef readonly %left, ptr noundef readnone %right) local_unnamed_addr #2 {
entry:
...
entry:
  ...
  br i1 %cmp.i121, label %tailrecurse.outer.split.us.lr.ph, label %tailrecurse.outer.split
...
tailrecurse.outer.split.us:                       ; preds = %if.then7.us, %tailrecurse.outer.split.us.lr.ph
  %act.tr.ph123 = phi ptr [ %act, %tailrecurse.outer.split.us.lr.ph ], [ %3, %if.then7.us ]
  %n.tr.ph122 = phi ptr [ %n, %tailrecurse.outer.split.us.lr.ph ], [ %call8.us, %if.then7.us ]
  %0 = load i64, ptr %act.tr.ph123, align 8
  %1 = load i64, ptr %n.tr.ph122, align 8
  %.not.us = icmp eq i64 %0, %1
  %v2.us = getelementptr inbounds %struct.DCEL_segment, ptr %act.tr.ph123, i64 0, i32 1
  %p.sroa.0.0.in.us = select i1 %.not.us, ptr %v2.us, ptr %act.tr.ph123
  %p.sroa.0.0.us = load i64, ptr %p.sroa.0.0.in.us, align 8
  %v24.us = getelementptr inbounds %struct.DCEL_segment, ptr %n.tr.ph122, i64 0, i32 1
  %2 = load i64, ptr %v24.us, align 8
  ...
  %p2.sroa.0.0.extract.trunc.i.i.us = trunc i64 %2 to i32
  %p2.sroa.3.0.extract.shift.i.i.us = lshr i64 %2, 32
  ...
  %cmp1.i.us = icmp sgt i32 %sub14.i.i.us, -1
  br i1 %cmp1.i.us, label %if.end51, label %if.then7.us
...
if.then7.us:                                      ; preds = %tailrecurse.outer.split.us
  ...
  store i64 %2, ptr %v210.us, align 8
  %p1 = getelementptr inbounds %struct.DCEL_segment, ptr %act.tr.ph123, i64 0, i32 2
  %3 = load ptr, ptr %p1, align 8, !tbaa !17
  %p113 = getelementptr inbounds %struct.DCEL_segment, ptr %call8.us, i64 0, i32 2
  store ptr %3, ptr %p113, align 8, !tbaa !17
  %p2 = getelementptr inbounds %struct.DCEL_segment, ptr %call8.us, i64 0, i32 3
  store ptr %n.tr.ph122, ptr %p2, align 8, !tbaa !18
  %q1 = getelementptr inbounds %struct.DCEL_segment, ptr %call8.us, i64 0, i32 4
  store ptr %act.tr.ph123, ptr %q1, align 8, !tbaa !9
  %q2 = getelementptr inbounds %struct.DCEL_segment, ptr %call8.us, i64 0, i32 5
  store ptr %first, ptr %q2, align 8, !tbaa !19
  %q214 = getelementptr inbounds %struct.DCEL_segment, ptr %n.tr.ph122, i64 0, i32 5
  store ptr %call8.us, ptr %q214, align 8, !tbaa !19
  %4 = load i64, ptr %3, align 8
  %.not111 = icmp eq i64 %4, %p.sroa.0.0.us
  %q224 = getelementptr inbounds %struct.DCEL_segment, ptr %3, i64 0, i32 5
  %q121 = getelementptr inbounds %struct.DCEL_segment, ptr %3, i64 0, i32 4
  %q224.sink = select i1 %.not111, ptr %q121, ptr %q224
...
tailrecurse.outer.split.us.i:                     ; preds = %if.then7.us.i, %while.body
  %act.tr.ph123.i = phi ptr [ %left.073, %while.body ], [ %7, %if.then7.us.i ]
  %n.tr.ph122.i = phi ptr [ %call12, %while.body ], [ %call8.us.i, %if.then7.us.i ]
  %4 = load i64, ptr %act.tr.ph123.i, align 8
  %5 = load i64, ptr %n.tr.ph122.i, align 8
  %.not.us.i = icmp eq i64 %4, %5
  %v2.us.i = getelementptr inbounds %struct.DCEL_segment, ptr %act.tr.ph123.i, i64 0, i32 1
  %p.sroa.0.0.in.us.i = select i1 %.not.us.i, ptr %v2.us.i, ptr %act.tr.ph123.i
  %p.sroa.0.0.us.i = load i64, ptr %p.sroa.0.0.in.us.i, align 8
  %v24.us.i = getelementptr inbounds %struct.DCEL_segment, ptr %n.tr.ph122.i, i64 0, i32 1
  %6 = load i64, ptr %v24.us.i, align 8
  ...
  %p2.sroa.0.0.extract.trunc.i.i.us.i = trunc i64 %6 to i32
  %p2.sroa.3.0.extract.shift.i.i.us.i = lshr i64 %6, 32
  ...
  %cmp1.i.us.i = icmp sgt i32 %sub14.i.i.us.i, -1
  br i1 %cmp1.i.us.i, label %add_segments.exit, label %if.then7.us.i
...
if.then7.us.i:                                    ; preds = %tailrecurse.outer.split.us.i
  ...
  store i64 %6, ptr %v210.us.i, align 8
  %p1.i = getelementptr inbounds %struct.DCEL_segment, ptr %act.tr.ph123.i, i64 0, i32 2
  %7 = load ptr, ptr %p1.i, align 8, !tbaa !17
  %p113.i = getelementptr inbounds %struct.DCEL_segment, ptr %call8.us.i, i64 0, i32 2
  store ptr %7, ptr %p113.i, align 8, !tbaa !17
  %p2.i = getelementptr inbounds %struct.DCEL_segment, ptr %call8.us.i, i64 0, i32 3
  store ptr %n.tr.ph122.i, ptr %p2.i, align 8, !tbaa !18
  %q1.i = getelementptr inbounds %struct.DCEL_segment, ptr %call8.us.i, i64 0, i32 4
  store ptr %act.tr.ph123.i, ptr %q1.i, align 8, !tbaa !9
  %q2.i = getelementptr inbounds %struct.DCEL_segment, ptr %call8.us.i, i64 0, i32 5
  store ptr %call12, ptr %q2.i, align 8, !tbaa !19
  %q214.i = getelementptr inbounds %struct.DCEL_segment, ptr %n.tr.ph122.i, i64 0, i32 5
  store ptr %call8.us.i, ptr %q214.i, align 8, !tbaa !19
  %8 = load i64, ptr %7, align 8
  %.not111.i = icmp eq i64 %8, %p.sroa.0.0.us.i
  %q224.i = getelementptr inbounds %struct.DCEL_segment, ptr %7, i64 0, i32 5
  %q121.i = getelementptr inbounds %struct.DCEL_segment, ptr %7, i64 0, i32 4
  %q224.sink.i = select i1 %.not111.i, ptr %q121.i, ptr %q224.i
