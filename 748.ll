; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/matrix.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/matrix.c"
...
entry:
  %call = tail call noalias dereferenceable_or_null(88) ptr @malloc(i64 noundef 88) #14
...
for.body:                                         ; preds = %entry, %for.body
  ...
  tail call void (ptr, ...) @sm_row_free(ptr noundef nonnull %prow.034) #15
...
for.body3:                                        ; preds = %for.end, %for.body3
  ...
  tail call void (ptr, ...) @sm_col_free(ptr noundef nonnull %pcol.036) #15
...
if.then15:                                        ; preds = %if.end, %if.then10
  tail call void @free(ptr noundef nonnull %A) #15
  ret void
}
...
cond.true6:                                       ; preds = %if.then
  %call = tail call ptr @realloc(ptr noundef nonnull %1, i64 noundef %mul11) #16
  %.pre = load i32, ptr %rows_size, align 8, !tbaa !13
  br label %cond.end13

cond.false9:                                      ; preds = %if.then
  %call12 = tail call noalias ptr @malloc(i64 noundef %mul11) #14
  br label %cond.end13
...
cond.true37:                                      ; preds = %if.then23
  %call41 = tail call ptr @realloc(ptr noundef nonnull %14, i64 noundef %mul44) #16
  %.pre108 = load i32, ptr %cols_size, align 8, !tbaa !12
  br label %cond.end46

cond.false42:                                     ; preds = %if.then23
  %call45 = tail call noalias ptr @malloc(i64 noundef %mul44) #14
  br label %cond.end46
...
if.then3:                                         ; preds = %if.end
  %call = tail call ptr (...) @sm_row_alloc() #15
  %4 = load ptr, ptr %A, align 8, !tbaa !5
...
if.then65:                                        ; preds = %if.end61
  %call66 = tail call ptr (...) @sm_col_alloc() #15
...
if.end131:                                        ; preds = %if.end131.sink.split, %for.end112, %if.end61
  ...
  %call132 = tail call noalias dereferenceable_or_null(48) ptr @malloc(i64 noundef 48) #14
...
if.then267:                                       ; preds = %if.else266
  tail call void @free(ptr noundef nonnull %call132) #15
  br label %if.end269
...
if.then16:                                        ; preds = %if.end
  %call = tail call ptr (ptr, i32, ...) @sm_row_find(ptr noundef nonnull %2, i32 noundef %colnum) #15
  br label %cleanup

if.else17:                                        ; preds = %if.end
  %call18 = tail call ptr (ptr, i32, ...) @sm_col_find(ptr noundef nonnull %5, i32 noundef %rownum) #15
  br label %cleanup
...
if.then16.i:                                      ; preds = %if.end.i
  %call.i = tail call ptr (ptr, i32, ...) @sm_row_find(ptr noundef nonnull %2, i32 noundef %colnum) #15
  br label %sm_find.exit

if.else17.i:                                      ; preds = %if.end.i
  %call18.i = tail call ptr (ptr, i32, ...) @sm_col_find(ptr noundef nonnull %5, i32 noundef %rownum) #15
  br label %sm_find.exit
...
cond.end13.i:                                     ; preds = %cond.true8.i, %land.lhs.true5.i, %for.body.i
  ...
  tail call void (ptr, ptr, ...) @sm_col_remove_element(ptr noundef %cond14.i, ptr noundef nonnull %p.074.i) #15
...
if.then16.i:                                      ; preds = %cond.end13.i
  ...
  tail call void @sm_delcol(ptr noundef nonnull %A, i32 noundef %19) #17
  br label %for.inc.i
...
if.end27.i:                                       ; preds = %if.else.i, %if.then22.i
  ...
  tail call void (ptr, ...) @sm_row_free(ptr noundef nonnull %11) #15
  br label %if.end24
...
cond.end13.i130:                                  ; preds = %cond.true8.i126, %land.lhs.true5.i123, %for.body.i121
  ...
  tail call void (ptr, ptr, ...) @sm_row_remove_element(ptr noundef %cond14.i127, ptr noundef nonnull %p.074.i118) #15
...
if.then16.i131:                                   ; preds = %cond.end13.i130
  ...
  tail call void @sm_delrow(ptr noundef %A, i32 noundef %44) #17
...
if.end27.i146:                                    ; preds = %if.else.i143, %if.then22.i141
  ...
  tail call void (ptr, ...) @sm_col_free(ptr noundef nonnull %36) #15
  br label %if.then59

if.then59:                                        ; preds = %if.end42, %if.end27.i146, %cond.end.i112, %land.lhs.true.i107
  tail call void @free(ptr noundef %p) #15
  br label %cleanup
...
cond.end13:                                       ; preds = %for.body, %land.lhs.true5, %cond.true8
  ...
  tail call void (ptr, ptr, ...) @sm_col_remove_element(ptr noundef %cond14, ptr noundef nonnull %p.074) #15
...
if.end27:                                         ; preds = %if.else, %if.then22
  ...
  tail call void (ptr, ...) @sm_row_free(ptr noundef nonnull %2) #15
  br label %if.end38
...
cond.end13:                                       ; preds = %for.body, %land.lhs.true5, %cond.true8
  %cond14 = phi ptr [ %8, %cond.true8 ], [ null, %land.lhs.true5 ], [ null, %for.body ]
  tail call void (ptr, ptr, ...) @sm_row_remove_element(ptr noundef %cond14, ptr noundef nonnull %p.074) #15
...
if.end27:                                         ; preds = %if.else, %if.then22
  ...
  tail call void (ptr, ...) @sm_col_free(ptr noundef nonnull %2) #15
  br label %if.end38
...
; Function Attrs: nofree norecurse nosync nounwind memory(read, inaccessiblemem: none) uwtable
define dso_local i32 @sm_num_elements(ptr nocapture noundef readonly %A) local_unnamed_addr #7 {
entry:
  %first_row = getelementptr inbounds %struct.sm_matrix_struct, ptr %A, i64 0, i32 4
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %j) #15
  %call.i = tail call noalias dereferenceable_or_null(88) ptr @malloc(i64 noundef 88) #14
  store ptr null, ptr %call.i, align 8, !tbaa !5
  %cols.i = getelementptr inbounds %struct.sm_matrix_struct, ptr %call.i, i64 0, i32 2
  store ptr null, ptr %cols.i, align 8, !tbaa !11
  ...
  %call112 = tail call i32 @feof(ptr noundef %fp) #15
  %tobool.not13 = icmp eq i32 %call112, 0
  br i1 %tobool.not13, label %while.body, label %cleanup

while.body:                                       ; preds = %entry, %if.end5
  %call2 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %i, ptr noundef nonnull %j) #15
...
if.end5:                                          ; preds = %while.body
  ...
  %call1 = call i32 @feof(ptr noundef %fp) #15
...
cleanup:                                          ; preds = %while.body, %cleanup.loopexit, %entry
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %j) #15
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %nrows) #15
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %ncols) #15
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %x) #15
  %call.i = tail call noalias dereferenceable_or_null(88) ptr @malloc(i64 noundef 88) #14
  store ptr null, ptr %call.i, align 8, !tbaa !5
  %cols.i = getelementptr inbounds %struct.sm_matrix_struct, ptr %call.i, i64 0, i32 2
  store ptr null, ptr %cols.i, align 8, !tbaa !11
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(20) %first_col.i, i8 0, i64 20, i1 false)
  store ptr %call.i, ptr %A, align 8, !tbaa !25
  %call1 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str, ptr noundef nonnull %nrows, ptr noundef nonnull %ncols) #15
...
for.body:                                         ; preds = %if.end, %for.inc22
  ...
  %call3 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.1, ptr noundef nonnull %x) #15
...
for.body9:                                        ; preds = %for.cond7.preheader, %for.inc20
  ...
  %call10 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %fp, ptr noundef nonnull @.str.1, ptr noundef nonnull %x) #15
...
cleanup:                                          ; preds = %for.body, %for.inc22, %for.body9, %if.end, %entry
  ...
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %x) #15
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %ncols) #15
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %nrows) #15
  ret i32 %retval.0
}

; Function Attrs: nofree nounwind uwtable
define dso_local void @sm_write(ptr nocapture noundef %fp, ptr nocapture noundef readonly %A) local_unnamed_addr #9 {
entry:
  %first_row = getelementptr inbounds %struct.sm_matrix_struct, ptr %A, i64 0, i32 4
...
for.end:                                          ; preds = %for.body, %if.then
  %call4 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %fp)
...
for.end20:                                        ; preds = %for.body13, %if.then8
  %call21 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %fp)
  br label %if.end22
...
for.end33:                                        ; preds = %for.body27, %if.end22
  %call34 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %fp)
...
for.end43:                                        ; preds = %for.body39, %for.end33
  %call44 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %fp)
  %first_row = getelementptr inbounds %struct.sm_matrix_struct, ptr %A, i64 0, i32 4
...
for.body52:                                       ; preds = %for.body47, %for.body52
  ...
  %call54 = tail call ptr (ptr, i32, ...) @sm_row_find(ptr noundef nonnull %prow.0116, i32 noundef %11) #15
  %tobool.not = icmp eq ptr %call54, null
  %cond = select i1 %tobool.not, i32 46, i32 49
  %call55 = tail call i32 @_IO_putc(i32 noundef %cond, ptr noundef %fp)
...
for.end58:                                        ; preds = %for.body52, %for.body47
  %call59 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %fp)
...
define dso_local void @sm_cleanup() local_unnamed_addr #10 {
entry:
  ret void
}
