; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/tableau.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/tableau.c"
...
entry:
  %cmp.i.not = icmp eq ptr %T, null
  br i1 %cmp.i.not, label %common.ret35, label %if.end

if.end:                                           ; preds = %entry
  %T.val28 = load ptr, ptr %T, align 8
...
clause_IsEmptyClause.exit.i:                      ; preds = %land.lhs.true1.i.i
  ...
  br i1 %cmp.i13.i.not.i, label %common.ret35, label %for.inc.i
...
if.end12:                                         ; preds = %lor.lhs.false
  %call14 = tail call i32 @tab_IsClosed(ptr noundef nonnull %T.val)
  %tobool15.not = icmp eq i32 %call14, 0
  br i1 %tobool15.not, label %common.ret35, label %land.rhs

common.ret35:                                     ; preds = %if.end12, %entry, %if.then9, %clause_IsEmptyClause.exit.i, %land.rhs
  %common.ret35.op = phi i32 [ %8, %land.rhs ], [ 0, %if.then9 ], [ 0, %entry ], [ 0, %if.end12 ], [ 1, %clause_IsEmptyClause.exit.i ]
  ret i32 %common.ret35.op

land.rhs:                                         ; preds = %if.end12
  %T.val27 = load ptr, ptr %5, align 8
  %call17 = tail call i32 @tab_IsClosed(ptr noundef %T.val27)
  %tobool18 = icmp ne i32 %call17, 0
  %8 = zext i1 %tobool18 to i32
  br label %common.ret35
}
...
while.body.i33:                                   ; preds = %if.then5, %while.body.i33
  ...
  br i1 %cmp.i.not.i32, label %if.end9, label %while.body.i33, !llvm.loop !10
...
for.cond.i:                                       ; preds = %if.end.i, %for.cond.i
  ...
  br i1 %cmp.i20.not.i, label %for.end.i, label %for.cond.i, !llvm.loop !11
...
for.body.i.us.prol:                               ; preds = %for.body.lr.ph.i.us, %for.body.i.us.prol
  ...
  br i1 %prol.iter.cmp.not, label %for.body.i.us.prol.loopexit, label %for.body.i.us.prol, !llvm.loop !12
...
for.body.i.us:                                    ; preds = %for.body.i.us.prol.loopexit, %for.body.i.us
  ...
  %cmp.i34.not.us.3 = icmp eq i64 %indvars.iv.next.2, 0
  br i1 %cmp.i34.not.us.3, label %clause_ClearSplitField.exit.us.loopexit, label %for.body.i.us, !llvm.loop !14
...
clause_ClearSplitField.exit.us.loopexit:          ; preds = %for.body.i.us, %for.body.i.us.prol.loopexit
  ...
  %splitfield_length.i35.us.phi.trans.insert = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Scan.0.val26.us.pre, i64 0, i32 5
  %.pre = load i32, ptr %splitfield_length.i35.us.phi.trans.insert, align 8
...
clause_ClearSplitField.exit.us:                   ; preds = %clause_ClearSplitField.exit.us.loopexit, %for.body.us
  ...
  %splitfield_length.i35.us = getelementptr inbounds %struct.CLAUSE_HELP, ptr %Scan.0.val26.us, i64 0, i32 5
  %cmp.not.i.us = icmp ult i32 %storemerge.i.i, %15
...
if.then.i.us:                                     ; preds = %clause_ClearSplitField.exit.us
  ...
  %16 = load i32, ptr %splitfield_length.i35.us, align 8
...
for.body.i.i.us:                                  ; preds = %for.body.i.i.us, %for.body.lr.ph.i.i.us
  ...
  %19 = load i32, ptr %splitfield_length.i35.us, align 8
  %20 = zext i32 %19 to i64
  %cmp3.i.i.us = icmp ult i64 %indvars.iv.next.i.i.us, %20
  br i1 %cmp3.i.i.us, label %for.body.i.i.us, label %for.cond8.preheader.i.i.us, !llvm.loop !15
...
for.body11.preheader.i.i.us:                      ; preds = %if.then.i.us, %for.cond8.preheader.i.i.us
  ...
  %uglygep.i.i.us = getelementptr i8, ptr %call.i.i.us, i64 %22
  %23 = sub i32 %storemerge.i.i, %.lcssa.i11.i.us
  %24 = zext i32 %23 to i64
  %25 = shl nuw nsw i64 %24, 3
  %26 = add nuw nsw i64 %25, 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %uglygep.i.i.us, i8 0, i64 %26, i1 false)
...
if.then20.i.i.us:                                 ; preds = %for.end16.i.i.us
  %28 = load i32, ptr %splitfield_length.i35.us, align 8
...
if.then.i.i.i.us:                                 ; preds = %if.then20.i.i.us
  ...
  %add.ptr.i.i.i.us54 = getelementptr i8, ptr %27, i64 -16
  %add.ptr1.i.i.i.us = getelementptr i8, ptr %add.ptr.i.i.i.us54, i64 %idx.neg.i.i.i.us
  %30 = load ptr, ptr %add.ptr1.i.i.i.us, align 8
  %cmp2.not.i.i.i.us = icmp eq ptr %30, null
  %next6.i.i.i.us = getelementptr inbounds %struct.MEMORY_BIGBLOCKHEADERHELP, ptr %add.ptr1.i.i.i.us, i64 0, i32 1
...
if.end.i.i.us:                                    ; preds = %if.else25.i.i.i.us, %if.end23.i.i.i.us, %for.end16.i.i.us
  ...
  store i32 %add.i, ptr %splitfield_length.i35.us, align 8
...
clause_SetSplitFieldBit.exit.us:                  ; preds = %entry.if.end_crit_edge.i.us, %if.end.i.i.us
  ...
  br i1 %cmp.i32.not.us, label %for.end, label %for.body.us, !llvm.loop !16
...
if.then.i.i:                                      ; preds = %if.then2.i
  ...
  %add.ptr.i.i53 = getelementptr i8, ptr %46, i64 -16
  %add.ptr1.i.i = getelementptr i8, ptr %add.ptr.i.i53, i64 %idx.neg.i.i
...
for.inc:                                          ; preds = %if.else.i, %for.body
  ...
  br i1 %cmp.i32.not, label %for.end, label %for.body, !llvm.loop !16
...
while.body.i:                                     ; preds = %if.then3, %while.body.i
  ...
  br i1 %cmp.i.not.i40, label %list_Delete.exit, label %while.body.i, !llvm.loop !10
...
for.inc:                                          ; preds = %for.body, %land.lhs.true.i, %land.lhs.true1.i, %clause_IsEmptyClause.exit, %if.then8
  ...
  br i1 %cmp.i53.not, label %for.end, label %for.body, !llvm.loop !17
...
while.body.i:                                     ; preds = %if.end31, %while.body.i
  ...
  br i1 %cmp.i.not.i68, label %list_Delete.exit, label %while.body.i, !llvm.loop !10
...
; Function Attrs: nounwind uwtable
define dso_local void @tab_GetEarliestEmptyClauses(ptr noundef readonly %T, ptr noundef %L) local_unnamed_addr #0 {
entry:
...
for.inc:                                          ; preds = %if.else, %for.body, %land.lhs.true.i, %land.lhs.true1.i, %if.then11, %clause_IsEmptyClause.exit
  ...
  br i1 %cmp.i55.not, label %for.end, label %for.body, !llvm.loop !18
...
; Function Attrs: nounwind uwtable
define dso_local void @tab_ToClauseList(ptr noundef readonly %T, ptr noundef %Proof) local_unnamed_addr #0 {
entry:
...
; Function Attrs: nofree nosync nounwind memory(argmem: readwrite) uwtable
define internal fastcc void @tab_LabelNodesRec(ptr noundef %T, ptr noundef %Num) unnamed_addr #9 {
entry:
...
; Function Attrs: nofree nounwind uwtable
define internal fastcc void @tab_FPrintEdgesCgFormat(ptr noundef %File, ptr noundef readonly %T) unnamed_addr #6 {
entry:
...
if.then3:                                         ; preds = %if.end
  ...
  %call5.i = tail call i32 @_IO_putc(i32 noundef 48, ptr noundef %File)
...
if.then9:                                         ; preds = %if.end6
  ...
  %call5.i38 = tail call i32 @_IO_putc(i32 noundef 49, ptr noundef %File)
...
for.body:                                         ; preds = %if.else, %for.body
  ...
  br i1 %cmp.i77.not, label %if.end, label %for.body, !llvm.loop !19
...
for.body33:                                       ; preds = %if.then21, %for.body33
  ...
  br i1 %cmp.i81.not, label %if.end40, label %for.body33, !llvm.loop !20

if.end40:                                         ; preds = %for.body33, %if.then25, %if.end
  %call41 = tail call i32 @_IO_putc(i32 noundef 34, ptr noundef %File)
  ret void
}
...
tailrecurse:                                      ; preds = %if.then29, %entry
  ...
  %call3 = tail call i32 @_IO_putc(i32 noundef 91, ptr noundef %File)
...
if.then13:                                        ; preds = %if.then10
  %call14 = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %File)
...
if.then23:                                        ; preds = %if.end19
  %call24 = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %File)
...
if.then29:                                        ; preds = %if.end26
  %call30 = tail call i32 @_IO_putc(i32 noundef 44, ptr noundef %File)
