; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/lame.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-lame/lame.c"
...
entry:
  ...
  %stereo1096 = getelementptr inbounds %struct.lame_global_flags, ptr %gfp, i64 0, i32 46
  %mode11097 = getelementptr inbounds %struct.lame_global_flags, ptr %gfp, i64 0, i32 8
...
if.end:                                           ; preds = %entry
  ...
  %cmp2 = icmp eq i32 %.pre.fr, 3
  br i1 %cmp2, label %1, label %3

1:                                                ; preds = %if.end.thread, %if.end
  %2 = phi i32 [ 3, %if.end.thread ], [ %.pre.fr, %if.end ]
  br label %3

3:                                                ; preds = %if.end, %1
  %4 = phi i32 [ %2, %1 ], [ %.pre.fr, %if.end ]
  %5 = phi i32 [ 1, %1 ], [ 2, %if.end ]
  store i32 %5, ptr %stereo1096, align 4
...
if.end38:                                         ; preds = %if.else27, %if.else22, %if.else17, %if.else, %if.then7
  ...
  %8 = load i32, ptr %brate, align 8, !tbaa !16
  %cmp39 = icmp sgt i32 %8, 0
  br i1 %cmp39, label %if.then40, label %if.end98

if.then40:                                        ; preds = %if.end38
  %mul = shl nuw nsw i32 %5, 4
  %mul43 = mul nuw nsw i32 %mul, %.sink
  %conv = sitofp i32 %mul43 to double
  %conv45 = sitofp i32 %8 to double
  ...
  %9 = load i32, ptr %VBR, align 8, !tbaa !18
...
if.end98:                                         ; preds = %if.end.if.end98_crit_edge, %if.end38, %if.then63, %if.then75, %if.then87, %if.else89, %if.then81, %if.then69, %if.then40
  %10 = phi i32 [ %8, %if.end38 ], [ %8, %if.then63 ], [ %8, %if.then75 ], [ %8, %if.then87 ], [ %8, %if.else89 ], [ %8, %if.then81 ], [ %8, %if.then69 ], [ %8, %if.then40 ], [ %.pre1089, %if.end.if.end98_crit_edge ]
  %11 = phi i32 [ %.sink, %if.end38 ], [ 16000, %if.then63 ], [ 24000, %if.then75 ], [ 44100, %if.then87 ], [ 48000, %if.else89 ], [ 32000, %if.then81 ], [ 22050, %if.then69 ], [ %.sink, %if.then40 ], [ %6, %if.end.if.end98_crit_edge ]
  %cmp100 = icmp slt i32 %11, 24001
  ...
  %mul103 = mul nuw nsw i32 %cond, 576
...
if.end115:                                        ; preds = %if.then107, %if.end98
  ...
  %13 = load i32, ptr %in_samplerate117, align 4, !tbaa !17
  %cmp118.not = icmp eq i32 %11, %13
  br i1 %cmp118.not, label %if.end127, label %if.then120

if.then120:                                       ; preds = %if.end115
  %conv122 = sitofp i32 %13 to float
  %conv124 = sitofp i32 %11 to float
...
if.end127:                                        ; preds = %if.then120, %if.end115
  %14 = phi float [ %div125, %if.then120 ], [ 1.000000e+00, %if.end115 ]
  %totalframes = getelementptr inbounds %struct.lame_global_flags, ptr %gfp, i64 0, i32 40
  %15 = load i64, ptr %gfp, align 8, !tbaa !23
  %conv128 = uitofp i64 %15 to float
  %conv131 = sitofp i32 %mul103 to float
  %mul132 = fmul float %14, %conv131
...
if.end127.if.end141_crit_edge:                    ; preds = %if.end127
  %.pre1090 = load i32, ptr %VBR140, align 8, !tbaa !18
  br label %if.end141
...
if.end141:                                        ; preds = %if.end127.if.end141_crit_edge, %if.then139
  %16 = phi i32 [ %.pre1090, %if.end127.if.end141_crit_edge ], [ 0, %if.then139 ]
  %mul143 = shl nuw nsw i32 %5, 4
  %mul145 = mul i32 %mul143, %11
  %conv146 = sitofp i32 %mul145 to double
  %conv148 = sitofp i32 %12 to double
...
if.then157:                                       ; preds = %if.end141
  ...
  %17 = load i32, ptr %VBR_q, align 4, !tbaa !25
  %conv158 = sitofp i32 %17 to double
...
if.end161:                                        ; preds = %if.then157, %if.end141
  ...
  %18 = load i32, ptr %mode_fixed, align 8, !tbaa !26
  %tobool162.not = icmp eq i32 %18, 0
  br i1 %tobool162.not, label %land.lhs.true163, label %if.end173

land.lhs.true163:                                 ; preds = %if.end161
  %cmp165 = icmp ne i32 %4, 3
...
if.then170:                                       ; preds = %land.lhs.true163
  store i32 0, ptr %mode11097, align 4, !tbaa !14
  br label %if.end173
...
for.body:                                         ; preds = %for.cond.preheader, %for.inc
  %minband.01078 = phi i32 [ 999, %for.cond.preheader ], [ %minband.1, %for.inc ]
...
if.end325:                                        ; preds = %if.then316, %for.body
  ...
  %or.cond1073 = select i1 %cmp328, i1 %cmp333, i1 false
...
if.then335:                                       ; preds = %if.end325
  ...
  %42 = fcmp oeq double %div356, 0xFFF0000000000000
  %43 = fcmp oeq double %div356, 0x7FF0000000000000
  %44 = or i1 %43, %42
  br i1 %44, label %cdce.call, label %for.inc, !prof !36
...
for.inc:                                          ; preds = %cdce.call, %if.then335, %if.end325
  %minband.1 = phi i32 [ %minband.01078, %if.end325 ], [ %cond341, %if.then335 ], [ %cond341, %cdce.call ]
  %inc = add nuw nsw i32 %band303.01076, 1
  %exitcond.not = icmp eq i32 %inc, 32
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !37

for.end:                                          ; preds = %for.inc
  %cmp359 = icmp eq i32 %minband.1, 999
  %45 = load i32, ptr %lowpass_band, align 8, !tbaa !35
  %.minband.1.lcssa = select i1 %cmp359, i32 %45, i32 %minband.1
  %storemerge.in.in.in = sitofp i32 %.minband.1.lcssa to double
  %storemerge.in.in = fadd double %storemerge.in.in.in, -7.500000e-01
  %conv376 = sitofp i32 %45 to double
  %46 = insertelement <2 x double> poison, double %storemerge.in.in, i64 0
  %47 = insertelement <2 x double> %46, double %conv376, i64 1
  %48 = fdiv <2 x double> %47, <double 3.100000e+01, double 3.100000e+01>
  %49 = fptrunc <2 x double> %48 to <2 x float>
  store <2 x float> %49, ptr %lowpass1304, align 8, !tbaa !32
  br label %if.end380

if.end380:                                        ; preds = %for.end, %if.then302
  %highpass2381 = getelementptr inbounds %struct.lame_global_flags, ptr %gfp, i64 0, i32 56
  %50 = load float, ptr %highpass2381, align 4, !tbaa !39
  %cmp382 = fcmp ogt float %50, 0.000000e+00
  %conv386 = fpext float %50 to double
...
if.then389:                                       ; preds = %if.end380
  ...
  %52 = tail call i64 @fwrite(ptr nonnull @.str, i64 64, i64 1, ptr %51) #19
  %.pr = load float, ptr %highpass2381, align 4, !tbaa !39
  br label %if.end394

if.end394:                                        ; preds = %if.then389, %if.end380
  %53 = phi float [ %.pr, %if.then389 ], [ %50, %if.end380 ]
  %cmp396 = fcmp ogt float %53, 0.000000e+00
...
for.body402:                                      ; preds = %for.cond399.preheader, %for.inc452
  %maxband.21080 = phi i32 [ -1, %for.cond399.preheader ], [ %maxband.3, %for.inc452 ]
  ...
  %54 = load float, ptr %highpass1405, align 8, !tbaa !41
  %conv406 = fpext float %54 to double
...
if.then409:                                       ; preds = %for.body402
  ...
  %.band303.1 = tail call i32 @llvm.smax.i32(i32 %55, i32 %band303.11079)
...
land.lhs.true423:                                 ; preds = %if.end418
  %56 = load float, ptr %highpass2381, align 4, !tbaa !39
  %conv425 = fpext float %56 to double
...
if.then428:                                       ; preds = %land.lhs.true423
  ...
  %sub447 = fsub float %56, %54
  %conv448 = fpext float %sub447 to double
  %div449 = fdiv double %mul444, %conv448
  %57 = fcmp oeq double %div449, 0xFFF0000000000000
  %58 = fcmp oeq double %div449, 0x7FF0000000000000
  %59 = or i1 %58, %57
  br i1 %59, label %cdce.call1074, label %for.inc452, !prof !36
...
for.end454:                                       ; preds = %for.inc452
  %60 = load i32, ptr %highpass_band, align 4, !tbaa !42
  %conv456 = sitofp i32 %60 to double
  ...
  %61 = insertelement <2 x double> poison, double %conv456, i64 0
  %62 = insertelement <2 x double> %61, double %add471, i64 1
  %63 = fdiv <2 x double> %62, <double 3.100000e+01, double 3.100000e+01>
  %64 = fptrunc <2 x double> %63 to <2 x float>
  store <2 x float> %64, ptr %highpass1405, align 8, !tbaa !32
  br label %if.end477
...
if.end477:                                        ; preds = %for.end454, %if.end394, %if.end299
  ...
  %65 = load i32, ptr %mode11097, align 4, !tbaa !14
  %cmp484 = icmp eq i32 %65, 3
  %cond486 = select i1 %cmp484, i32 1, i32 2
  store i32 %cond486, ptr %stereo1096, align 4, !tbaa !45
  %66 = load i32, ptr %out_samplerate, align 8, !tbaa !15
  %conv489 = sext i32 %66 to i64
...
if.end495:                                        ; preds = %if.end477
  %68 = load i32, ptr %brate104, align 8, !tbaa !16
  %69 = load i32, ptr %version, align 8, !tbaa !47
  %70 = load i32, ptr %out_samplerate, align 8, !tbaa !15
  %call499 = tail call i32 @BitrateIndex(i32 noundef %68, i32 noundef %69, i32 noundef %70) #18
...
if.then502:                                       ; preds = %if.end495
  ...
  tail call void @display_bitrates(ptr noundef %71) #18
  tail call void @exit(i32 noundef 1) #20
  unreachable

if.end503:                                        ; preds = %if.end495
  %72 = load i32, ptr %VBR152, align 8, !tbaa !18
  %tobool505.not = icmp eq i32 %72, 0
...
if.then506:                                       ; preds = %if.end503
  ...
  %73 = load i32, ptr %VBR_max_bitrate_kbps, align 4, !tbaa !49
  %cmp507 = icmp eq i32 %73, 0
...
if.then509:                                       ; preds = %if.then506
  ...
  %74 = load i32, ptr %VBR_min_bitrate_kbps, align 8, !tbaa !50
  %cmp510 = icmp sgt i32 %74, 255
  %VBR_q515 = getelementptr inbounds %struct.lame_global_flags, ptr %gfp, i64 0, i32 22
  %75 = load i32, ptr %VBR_q515, align 4, !tbaa !25
  %cmp516 = icmp eq i32 %75, 0
  %76 = select i1 %cmp516, i1 true, i1 %cmp510
  %spec.store.select1053 = select i1 %76, i32 14, i32 13
  %cmp522 = icmp sgt i32 %75, 3
  %spec.store.select1054 = select i1 %cmp522, i32 12, i32 %spec.store.select1053
  %cmp528 = icmp sgt i32 %75, 7
...
if.else533:                                       ; preds = %if.then506
  ...
  %call537 = tail call i32 @BitrateIndex(i32 noundef %73, i32 noundef %77, i32 noundef %78) #18
...
if.else533.if.end543_crit_edge:                   ; preds = %if.else533
  ...
  %.pre1092 = load i32, ptr %VBR_min_bitrate_kbps544.phi.trans.insert, align 8, !tbaa !50
  br label %if.end543
...
if.end543:                                        ; preds = %if.else533.if.end543_crit_edge, %if.then509
  %80 = phi i32 [ %.pre1092, %if.else533.if.end543_crit_edge ], [ %74, %if.then509 ]
  %cmp545 = icmp eq i32 %80, 0
...
if.else548:                                       ; preds = %if.end543
  %81 = load i32, ptr %version, align 8, !tbaa !47
  %82 = load i32, ptr %out_samplerate, align 8, !tbaa !15
  %call552 = tail call i32 @BitrateIndex(i32 noundef %80, i32 noundef %81, i32 noundef %82) #18
...
if.then556:                                       ; preds = %if.else548
  ...
  tail call void @display_bitrates(ptr noundef %83) #18
  tail call void @exit(i32 noundef 1) #20
  unreachable

if.end559:                                        ; preds = %if.then547, %if.else548
  %.pr1056 = load i32, ptr %VBR152, align 8, !tbaa !18
  %tobool561.not = icmp eq i32 %.pr1056, 0
...
if.then562:                                       ; preds = %if.end559
  ...
  %84 = load i32, ptr %quality, align 4, !tbaa !53
  %spec.select = tail call i32 @llvm.smin.i32(i32 %84, i32 2)
...
if.end571:                                        ; preds = %if.end503, %if.then562, %if.end559
  ...
  %85 = load i32, ptr %mode11097, align 4, !tbaa !14
  %cmp573 = icmp eq i32 %85, 3
...
if.end576:                                        ; preds = %if.then575, %if.end571
  br i1 %tobool561.not1058, label %if.then580, label %if.end581
...
if.end581:                                        ; preds = %if.then580, %if.end576
  ...
  %86 = load ptr, ptr %outPath, align 8, !tbaa !56
  %cmp582.not = icmp eq ptr %86, null
...
lor.lhs.false:                                    ; preds = %land.lhs.true584
  ...
  %.pr1059 = load i8, ptr %86, align 1, !tbaa !57
...
if.end601:                                        ; preds = %land.lhs.true584, %if.then600, %lor.lhs.false
  ...
  %88 = load i32, ptr %gtkflag, align 4, !tbaa !60
  %tobool602.not = icmp eq i32 %88, 0
...
if.end605:                                        ; preds = %if.then603, %if.end601
  ...
  %89 = load i32, ptr %quality606, align 4, !tbaa !53
  switch i32 %89, label %for.body694.preheader [
    i32 9, label %if.end617.thread1104
    i32 8, label %if.end617.thread
    i32 7, label %if.end628.thread
    i32 6, label %if.end634.thread
    i32 5, label %if.end645.thread
    i32 4, label %if.end668.thread.sink.split
    i32 3, label %if.end668.thread.sink.split
    i32 2, label %if.end668.thread
    i32 1, label %if.then672
    i32 0, label %if.then683
  ]

if.end617.thread1104:                             ; preds = %if.end605
...
if.end617.thread:                                 ; preds = %if.end605
  ...
  br label %if.end628.thread

if.end628.thread:                                 ; preds = %if.end605, %if.end617.thread
...
if.end634.thread:                                 ; preds = %if.end605
  ...
  br label %if.end645.thread

if.end645.thread:                                 ; preds = %if.end605, %if.end634.thread
...
if.end668.thread.sink.split:                      ; preds = %if.end605, %if.end605
  store i32 2, ptr %quality606, align 4, !tbaa !53
  br label %if.end668.thread

if.end668.thread:                                 ; preds = %if.end605, %if.end668.thread.sink.split
...
for.body694.preheader:                            ; preds = %if.end605, %if.end645.thread, %if.end617.thread1104, %if.end628.thread, %if.then672, %if.end668.thread
  %90 = load i32, ptr %samplerate_index, align 8, !tbaa !46
  %91 = load i32, ptr %version, align 8, !tbaa !47
  %mul697 = mul nsw i32 %91, 3
  %add698 = add nsw i32 %mul697, %90
  ...
  %92 = load <4 x i32>, ptr %arrayidx699, align 4, !tbaa !62
  store <4 x i32> %92, ptr @scalefac_band, align 4, !tbaa !62
  %arrayidx701.4 = getelementptr inbounds [23 x i32], ptr %arrayidx699, i64 0, i64 4
  %93 = load <4 x i32>, ptr %arrayidx701.4, align 4, !tbaa !62
  store <4 x i32> %93, ptr getelementptr inbounds (%struct.scalefac_struct, ptr @scalefac_band, i64 0, i32 0, i64 4), align 4, !tbaa !62
  %arrayidx701.8 = getelementptr inbounds [23 x i32], ptr %arrayidx699, i64 0, i64 8
  %94 = load <4 x i32>, ptr %arrayidx701.8, align 4, !tbaa !62
  store <4 x i32> %94, ptr getelementptr inbounds (%struct.scalefac_struct, ptr @scalefac_band, i64 0, i32 0, i64 8), align 4, !tbaa !62
  %arrayidx701.12 = getelementptr inbounds [23 x i32], ptr %arrayidx699, i64 0, i64 12
  %95 = load <4 x i32>, ptr %arrayidx701.12, align 4, !tbaa !62
  store <4 x i32> %95, ptr getelementptr inbounds (%struct.scalefac_struct, ptr @scalefac_band, i64 0, i32 0, i64 12), align 4, !tbaa !62
  %arrayidx701.16 = getelementptr inbounds [23 x i32], ptr %arrayidx699, i64 0, i64 16
  %96 = load <4 x i32>, ptr %arrayidx701.16, align 4, !tbaa !62
  store <4 x i32> %96, ptr getelementptr inbounds (%struct.scalefac_struct, ptr @scalefac_band, i64 0, i32 0, i64 16), align 4, !tbaa !62
  %arrayidx701.20 = getelementptr inbounds [23 x i32], ptr %arrayidx699, i64 0, i64 20
  %97 = load <4 x i32>, ptr %arrayidx701.20, align 4, !tbaa !62
  store <4 x i32> %97, ptr getelementptr inbounds (%struct.scalefac_struct, ptr @scalefac_band, i64 0, i32 0, i64 20), align 4, !tbaa !62
  %arrayidx718.1 = getelementptr inbounds [6 x %struct.scalefac_struct], ptr @sfBandIndex, i64 0, i64 %idxprom, i32 1, i64 1
  %98 = load <4 x i32>, ptr %arrayidx718.1, align 4, !tbaa !62
  store <4 x i32> %98, ptr getelementptr inbounds (%struct.scalefac_struct, ptr @scalefac_band, i64 0, i32 1, i64 1), align 4, !tbaa !62
  %arrayidx718.5 = getelementptr inbounds [6 x %struct.scalefac_struct], ptr @sfBandIndex, i64 0, i64 %idxprom, i32 1, i64 5
  %99 = load <4 x i32>, ptr %arrayidx718.5, align 4, !tbaa !62
  store <4 x i32> %99, ptr getelementptr inbounds (%struct.scalefac_struct, ptr @scalefac_band, i64 0, i32 1, i64 5), align 4, !tbaa !62
  %100 = load i32, ptr %samplerate_index, align 8, !tbaa !46
  %101 = load i32, ptr %version, align 8, !tbaa !47
  %mul713.9 = mul nsw i32 %101, 3
  %add714.9 = add nsw i32 %mul713.9, %100
  ...
  %102 = load <4 x i32>, ptr %arrayidx718.9, align 4, !tbaa !62
  store <4 x i32> %102, ptr getelementptr inbounds (%struct.scalefac_struct, ptr @scalefac_band, i64 0, i32 1, i64 9), align 4, !tbaa !62
  %arrayidx718.13 = getelementptr inbounds [6 x %struct.scalefac_struct], ptr @sfBandIndex, i64 0, i64 %idxprom715.9, i32 1, i64 13
  %103 = load i32, ptr %arrayidx718.13, align 4, !tbaa !62
  store i32 %103, ptr getelementptr inbounds (%struct.scalefac_struct, ptr @scalefac_band, i64 0, i32 1, i64 13), align 4, !tbaa !62
  %bWriteVbrTag724 = getelementptr inbounds %struct.lame_global_flags, ptr %gfp, i64 0, i32 5
  %104 = load i32, ptr %bWriteVbrTag724, align 8, !tbaa !55
  %tobool725.not = icmp eq i32 %104, 0
...
if.then726:                                       ; preds = %for.body694.preheader
  %sub728 = sub nsw i32 1, %101
  %105 = load i32, ptr %mode11097, align 4, !tbaa !14
  %call731 = tail call i32 @InitVbrTag(ptr noundef nonnull @bs, i32 noundef %sub728, i32 noundef %105, i32 noundef %100) #18
  br label %if.end732
...
if.end45:                                         ; preds = %if.then36, %if.end32
  ...
  %inPath140 = getelementptr inbounds %struct.lame_global_flags, ptr %gfp, i64 0, i32 31
  %19 = load ptr, ptr %inPath140, align 8, !tbaa !64
...
if.else:                                          ; preds = %if.end45
  ...
  %conv144 = zext i8 %20 to i32
  %sub145.neg = add nsw i32 %conv144, -45
  %cmp149 = icmp eq i8 %20, 45
  br i1 %cmp149, label %if.then151, label %cond.end190

if.then151:                                       ; preds = %if.else
  %arrayidx153 = getelementptr inbounds i8, ptr %19, i64 1
  %21 = load i8, ptr %arrayidx153, align 1, !tbaa !57
  %conv154 = zext i8 %21 to i32
  br label %cond.end190

cond.end190:                                      ; preds = %if.else, %if.then151
  %__result141.0.neg = phi i32 [ %conv154, %if.then151 ], [ %sub145.neg, %if.else ]
  %tobool192.not = icmp eq i32 %__result141.0.neg, 0
  br i1 %tobool192.not, label %cond.false305, label %cond.true193
...
cond.false305:                                    ; preds = %cond.end190, %cond.true193
  %cond198 = phi ptr [ %cond.i, %cond.true193 ], [ @.str.12, %cond.end190 ]
  %outPath307 = getelementptr inbounds %struct.lame_global_flags, ptr %gfp, i64 0, i32 32
  %22 = load ptr, ptr %outPath307, align 8, !tbaa !56
  %23 = load i8, ptr %22, align 1, !tbaa !57
  %conv311 = zext i8 %23 to i32
  %sub312.neg = add nsw i32 %conv311, -45
  %cmp316 = icmp eq i8 %23, 45
  br i1 %cmp316, label %if.then318, label %cond.end357

if.then318:                                       ; preds = %cond.false305
  %arrayidx320 = getelementptr inbounds i8, ptr %22, i64 1
  %24 = load i8, ptr %arrayidx320, align 1, !tbaa !57
  %conv321 = zext i8 %24 to i32
  br label %cond.end357

cond.end357:                                      ; preds = %cond.false305, %if.then318
  %__result308.0.neg = phi i32 [ %conv321, %if.then318 ], [ %sub312.neg, %cond.false305 ]
  %tobool359.not = icmp eq i32 %__result308.0.neg, 0
  br i1 %tobool359.not, label %cond.end364, label %cond.true360

cond.true360:                                     ; preds = %cond.end357
  %call.i451 = tail call ptr @strrchr(ptr noundef nonnull dereferenceable(1) %22, i32 noundef 47) #21
  %tobool.not.i452 = icmp eq ptr %call.i451, null
  %add.ptr.i453 = getelementptr inbounds i8, ptr %call.i451, i64 1
  %cond.i454 = select i1 %tobool.not.i452, ptr %22, ptr %add.ptr.i453
  br label %cond.end364

cond.end364:                                      ; preds = %cond.end357, %cond.true360
  %cond365 = phi ptr [ %cond.i454, %cond.true360 ], [ @.str.13, %cond.end357 ]
  %call366 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %18, ptr noundef nonnull @.str.10, ptr noundef %cond198, ptr noundef nonnull %cond365) #19
  %VBR = getelementptr inbounds %struct.lame_global_flags, ptr %gfp, i64 0, i32 21
  %25 = load i32, ptr %VBR, align 8, !tbaa !18
  %tobool367.not = icmp eq i32 %25, 0
  %26 = load ptr, ptr @stderr, align 8, !tbaa !40
  %27 = load i32, ptr %out_samplerate1, align 8, !tbaa !15
  %conv377 = sitofp i32 %27 to double
  %div378 = fdiv double %conv377, 1.000000e+03
  %quality386 = getelementptr inbounds %struct.lame_global_flags, ptr %gfp, i64 0, i32 6
  %28 = load i32, ptr %quality386, align 4, !tbaa !53
  br i1 %tobool367.not, label %if.else375, label %if.then368

if.then368:                                       ; preds = %cond.end364
  %VBR_q = getelementptr inbounds %struct.lame_global_flags, ptr %gfp, i64 0, i32 22
  %29 = load i32, ptr %VBR_q, align 4, !tbaa !25
  %mode = getelementptr inbounds %struct.lame_global_flags, ptr %gfp, i64 0, i32 8
  %30 = load i32, ptr %mode, align 4, !tbaa !14
  %idxprom = sext i32 %30 to i64
  %arrayidx372 = getelementptr inbounds [4 x ptr], ptr @lame_print_config.mode_names, i64 0, i64 %idxprom
  %31 = load ptr, ptr %arrayidx372, align 8, !tbaa !40
  %version = getelementptr inbounds %struct.lame_global_flags, ptr %gfp, i64 0, i32 43
  %32 = load i32, ptr %version, align 8, !tbaa !47
  %sub373 = sub nsw i32 2, %32
  %call374 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %26, ptr noundef nonnull @.str.14, double noundef %div378, i32 noundef %29, ptr noundef %31, i32 noundef %sub373, i32 noundef %28) #19
  br label %if.end389

if.else375:                                       ; preds = %cond.end364
  %33 = load i32, ptr %brate, align 8, !tbaa !16
  %mode380 = getelementptr inbounds %struct.lame_global_flags, ptr %gfp, i64 0, i32 8
  %34 = load i32, ptr %mode380, align 4, !tbaa !14
  %idxprom381 = sext i32 %34 to i64
  %arrayidx382 = getelementptr inbounds [4 x ptr], ptr @lame_print_config.mode_names, i64 0, i64 %idxprom381
  %35 = load ptr, ptr %arrayidx382, align 8, !tbaa !40
  %version383 = getelementptr inbounds %struct.lame_global_flags, ptr %gfp, i64 0, i32 43
  %36 = load i32, ptr %version383, align 8, !tbaa !47
  %sub384 = sub nsw i32 2, %36
  %conv385 = fpext float %div7 to double
  %call387 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %26, ptr noundef nonnull @.str.15, double noundef %div378, i32 noundef %33, ptr noundef %35, i32 noundef %sub384, double noundef %conv385, i32 noundef %28) #19
  br label %if.end389

if.end389:                                        ; preds = %if.then368, %if.else375, %if.then46
  %37 = load ptr, ptr @stderr, align 8, !tbaa !40
  %call390 = tail call i32 @fflush(ptr noundef %37)
  ret void
}
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end30
  ...
  br i1 %cmp27.not, label %if.end30, label %for.end.loopexit300.split.loop.exit
...
if.end30:                                         ; preds = %for.body
  ...
  %spec.select308 = tail call i32 @llvm.smax.i32(i32 %conv137, i32 -32767)
  %.sink309 = tail call i32 @llvm.smin.i32(i32 %spec.select308, i32 32767)
  %.sink = trunc i32 %.sink309 to i16
...
for.end.loopexit.split.loop.exit:                 ; preds = %for.body.us
  %15 = trunc i64 %indvars.iv288 to i32
  br label %for.end

for.end.loopexit300.split.loop.exit:              ; preds = %for.body
  %16 = trunc i64 %indvars.iv to i32
  br label %for.end

for.end:                                          ; preds = %if.end30, %if.end30.us, %for.end.loopexit300.split.loop.exit, %for.end.loopexit.split.loop.exit, %if.end12.for.end_crit_edge
  %idxprom178.pre-phi = phi i64 [ %idxprom178.phi.trans.insert, %if.end12.for.end_crit_edge ], [ %idxprom22, %for.end.loopexit.split.loop.exit ], [ %idxprom22, %for.end.loopexit300.split.loop.exit ], [ %idxprom22, %if.end30.us ], [ %idxprom22, %if.end30 ]
  %17 = phi double [ %.pre, %if.end12.for.end_crit_edge ], [ %6, %for.end.loopexit.split.loop.exit ], [ %6, %for.end.loopexit300.split.loop.exit ], [ %6, %if.end30.us ], [ %6, %if.end30 ]
  %k.0.lcssa = phi i32 [ 0, %if.end12.for.end_crit_edge ], [ %15, %for.end.loopexit.split.loop.exit ], [ %16, %for.end.loopexit300.split.loop.exit ], [ %desired_len, %if.end30.us ], [ %desired_len, %if.end30 ]
  %j.1 = phi i32 [ 0, %if.end12.for.end_crit_edge ], [ %conv25.us, %for.end.loopexit.split.loop.exit ], [ %conv25, %for.end.loopexit300.split.loop.exit ], [ %conv25.us, %if.end30.us ], [ %conv25, %if.end30 ]
  ...
  %18 = tail call float @llvm.fmuladd.f32(float %neg176, float %3, float %conv172)
  %conv177 = fpext float %18 to double
  %arrayidx179 = getelementptr inbounds [2 x double], ptr @fill_buffer_resample.itime, i64 0, i64 %idxprom178.pre-phi
  %add180 = fadd double %17, %conv177
...
define dso_local i32 @fill_buffer(ptr nocapture noundef readnone %gfp, ptr nocapture noundef writeonly %outbuf, i32 noundef %desired_len, ptr nocapture noundef readonly %inbuf, i32 noundef %len) local_unnamed_addr #9 {
entry:
...
vector.memcheck:                                  ; preds = %for.body.preheader
  ...
  %uglygep = getelementptr i8, ptr %buffer_l, i64 %5
  %uglygep193 = getelementptr i8, ptr %buffer_r, i64 %5
  %bound0 = icmp ugt ptr %uglygep193, %buffer_l
  %bound1 = icmp ugt ptr %uglygep, %buffer_r
...
vector.ph:                                        ; preds = %for.body46.preheader
  %n.vec = and i64 %wide.trip.count, 4294967292
  %16 = getelementptr i16, ptr %buffer, i64 -1
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %17 = shl nuw nsw i64 %index, 1
  %18 = getelementptr inbounds i16, ptr %buffer, i64 %17
  %wide.vec = load <8 x i16>, ptr %18, align 2, !tbaa !91
  ...
  %19 = sext <4 x i16> %strided.vec to <4 x i32>
  %20 = or i64 %17, 1
  %21 = sext <4 x i16> %strided.vec278 to <4 x i32>
  %22 = add nsw <4 x i32> %21, %19
  %23 = sdiv <4 x i32> %22, <i32 2, i32 2, i32 2, i32 2>
  %24 = trunc <4 x i32> %23 to <4 x i16>
  %25 = getelementptr i16, ptr %16, i64 %20
  %interleaved.vec = shufflevector <4 x i16> %24, <4 x i16> zeroinitializer, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x i16> %interleaved.vec, ptr %25, align 2, !tbaa !91
  %index.next = add nuw i64 %index, 4
  %26 = icmp eq i64 %index.next, %n.vec
  br i1 %26, label %middle.block, label %vector.body, !llvm.loop !108
...
for.body46:                                       ; preds = %for.body46.preheader323, %for.body46
  ...
  %arrayidx49 = getelementptr inbounds i16, ptr %buffer, i64 %27
  %28 = load i16, ptr %arrayidx49, align 2, !tbaa !91
  %conv50 = sext i16 %28 to i32
  %29 = or i64 %27, 1
  %arrayidx54 = getelementptr inbounds i16, ptr %buffer, i64 %29
  %30 = load i16, ptr %arrayidx54, align 2, !tbaa !91
  %conv55 = sext i16 %30 to i32
...
while.body:                                       ; preds = %while.body.lr.ph, %cleanup140
  %31 = phi i32 [ %.pre, %while.body.lr.ph ], [ %89, %cleanup140 ]
  ...
  %.nsamples.addr.0 = tail call i32 @llvm.smin.i32(i32 %31, i32 %nsamples.addr.0239)
  %cmp76230 = icmp sgt i32 %.nsamples.addr.0, 0
  %32 = load i32, ptr @mf_size, align 4, !tbaa !62
...
vector.memcheck291:                               ; preds = %for.body78.lr.ph
  %34 = shl nsw i64 %33, 1
  %uglygep = getelementptr i8, ptr @mfbuf, i64 %34
  %35 = add nsw i64 %33, %wide.trip.count255
  %36 = shl nsw i64 %35, 1
  %uglygep292 = getelementptr i8, ptr getelementptr inbounds ([2 x [3056 x i16]], ptr @mfbuf, i64 0, i64 1, i64 0), i64 %36
  %37 = shl nuw nsw i64 %wide.trip.count255, 2
  %uglygep293 = getelementptr i8, ptr %buffer.addr.0240, i64 %37
  %bound0 = icmp ult ptr %uglygep, %uglygep293
  %bound1 = icmp ult ptr %buffer.addr.0240, %uglygep292
  %found.conflict = and i1 %bound0, %bound1
...
vector.body302:                                   ; preds = %vector.body302, %vector.ph297
  ...
  %38 = shl nuw nsw i64 %index303, 1
  %39 = getelementptr inbounds i16, ptr %buffer.addr.0240, i64 %38
  %wide.vec304 = load <8 x i16>, ptr %39, align 2, !tbaa !91
  ...
  %40 = add nsw i64 %index303, %33
  %41 = getelementptr inbounds [3056 x i16], ptr @mfbuf, i64 0, i64 %40
  store <4 x i16> %strided.vec305, ptr %41, align 2, !tbaa !91, !alias.scope !110, !noalias !113
  %42 = getelementptr inbounds [2 x [3056 x i16]], ptr @mfbuf, i64 0, i64 1, i64 %40
  store <4 x i16> %strided.vec306, ptr %42, align 2, !tbaa !91, !alias.scope !110, !noalias !113
  %index.next307 = add nuw i64 %index303, 4
  %43 = icmp eq i64 %index.next307, %n.vec299
  br i1 %43, label %middle.block294, label %vector.body302, !llvm.loop !115
...
for.body78.prol:                                  ; preds = %for.body78.preheader
  %45 = shl nuw nsw i64 %indvars.iv249.ph, 1
  %arrayidx81.prol = getelementptr inbounds i16, ptr %buffer.addr.0240, i64 %45
  %46 = load i16, ptr %arrayidx81.prol, align 2, !tbaa !91
  %47 = add nsw i64 %indvars.iv249.ph, %33
  %arrayidx84.prol = getelementptr inbounds [3056 x i16], ptr @mfbuf, i64 0, i64 %47
  store i16 %46, ptr %arrayidx84.prol, align 2, !tbaa !91
  %48 = or i64 %45, 1
  %arrayidx88.prol = getelementptr inbounds i16, ptr %buffer.addr.0240, i64 %48
  %49 = load i16, ptr %arrayidx88.prol, align 2, !tbaa !91
  %arrayidx91.prol = getelementptr inbounds [2 x [3056 x i16]], ptr @mfbuf, i64 0, i64 1, i64 %47
  store i16 %49, ptr %arrayidx91.prol, align 2, !tbaa !91
...
for.body78.prol.loopexit:                         ; preds = %for.body78.prol, %for.body78.preheader
  ...
  %50 = sub nsw i64 0, %wide.trip.count255
  %51 = icmp eq i64 %44, %50
  br i1 %51, label %for.end94, label %for.body78
...
for.body78:                                       ; preds = %for.body78.prol.loopexit, %for.body78
  ...
  %52 = shl nuw nsw i64 %indvars.iv249, 1
  %arrayidx81 = getelementptr inbounds i16, ptr %buffer.addr.0240, i64 %52
  %53 = load i16, ptr %arrayidx81, align 2, !tbaa !91
  %54 = add nsw i64 %indvars.iv249, %33
  %arrayidx84 = getelementptr inbounds [3056 x i16], ptr @mfbuf, i64 0, i64 %54
  store i16 %53, ptr %arrayidx84, align 2, !tbaa !91
  %55 = or i64 %52, 1
  %arrayidx88 = getelementptr inbounds i16, ptr %buffer.addr.0240, i64 %55
  %56 = load i16, ptr %arrayidx88, align 2, !tbaa !91
  %arrayidx91 = getelementptr inbounds [2 x [3056 x i16]], ptr @mfbuf, i64 0, i64 1, i64 %54
  store i16 %56, ptr %arrayidx91, align 2, !tbaa !91
  %indvars.iv.next250 = add nuw nsw i64 %indvars.iv249, 1
  %57 = shl nuw nsw i64 %indvars.iv.next250, 1
  %arrayidx81.1 = getelementptr inbounds i16, ptr %buffer.addr.0240, i64 %57
  %58 = load i16, ptr %arrayidx81.1, align 2, !tbaa !91
  %59 = add nsw i64 %indvars.iv.next250, %33
  %arrayidx84.1 = getelementptr inbounds [3056 x i16], ptr @mfbuf, i64 0, i64 %59
  store i16 %58, ptr %arrayidx84.1, align 2, !tbaa !91
  %60 = or i64 %57, 1
  %arrayidx88.1 = getelementptr inbounds i16, ptr %buffer.addr.0240, i64 %60
  %61 = load i16, ptr %arrayidx88.1, align 2, !tbaa !91
  %arrayidx91.1 = getelementptr inbounds [2 x [3056 x i16]], ptr @mfbuf, i64 0, i64 1, i64 %59
  store i16 %61, ptr %arrayidx91.1, align 2, !tbaa !91
...
for.end94:                                        ; preds = %for.body78.prol.loopexit, %for.body78, %middle.block294, %while.body
  ...
  %add97 = add nsw i32 %32, %.nsamples.addr.0
  store i32 %add97, ptr @mf_size, align 4, !tbaa !62
  %62 = load i32, ptr @mf_samples_to_encode, align 4, !tbaa !62
  %add98 = add nsw i32 %62, %.nsamples.addr.0
...
if.end106:                                        ; preds = %if.then101
  ...
  %63 = load i32, ptr %framesize, align 4, !tbaa !21
  %64 = load i32, ptr @mf_size, align 4, !tbaa !62
  %sub111 = sub i32 %64, %63
  store i32 %sub111, ptr @mf_size, align 4, !tbaa !62
  %65 = load i32, ptr @mf_samples_to_encode, align 4, !tbaa !62
  %sub113 = sub nsw i32 %65, %63
  store i32 %sub113, ptr @mf_samples_to_encode, align 4, !tbaa !62
  %66 = load i32, ptr %stereo115, align 4, !tbaa !45
  %cmp116234 = icmp sgt i32 %66, 0
...
for.cond119.preheader.us.preheader:               ; preds = %if.end106
  ...
  %68 = shl nsw i64 %67, 1
  %69 = add i64 %68, ptrtoint (ptr @mfbuf to i64)
  ...
  %70 = sub nsw i64 0, %wide.trip.count262
...
vector.memcheck:                                  ; preds = %for.cond119.preheader.us
  %71 = mul nuw nsw i64 %indvars.iv264, 6112
  %72 = add i64 %69, %71
  %73 = add i64 %71, ptrtoint (ptr @mfbuf to i64)
  %74 = sub i64 %73, %72
...
vector.body287:                                   ; preds = %vector.memcheck, %vector.body287
  ...
  %75 = add nsw i64 %index288, %67
  %76 = getelementptr inbounds [2 x [3056 x i16]], ptr @mfbuf, i64 0, i64 %indvars.iv264, i64 %75
  %wide.load = load <8 x i16>, ptr %76, align 2, !tbaa !91
  %77 = getelementptr inbounds i16, ptr %76, i64 8
  %wide.load289 = load <8 x i16>, ptr %77, align 2, !tbaa !91
  %78 = getelementptr inbounds [2 x [3056 x i16]], ptr @mfbuf, i64 0, i64 %indvars.iv264, i64 %index288
  store <8 x i16> %wide.load, ptr %78, align 16, !tbaa !91
  %79 = getelementptr inbounds i16, ptr %78, i64 8
  store <8 x i16> %wide.load289, ptr %79, align 16, !tbaa !91
  %index.next290 = add nuw i64 %index288, 16
  %80 = icmp eq i64 %index.next290, %n.vec284
  br i1 %80, label %middle.block279, label %vector.body287, !llvm.loop !117
...
for.body122.us.prol:                              ; preds = %for.body122.us.preheader
  %82 = add nsw i64 %indvars.iv258.ph, %67
  %arrayidx128.us.prol = getelementptr inbounds [2 x [3056 x i16]], ptr @mfbuf, i64 0, i64 %indvars.iv264, i64 %82
  %83 = load i16, ptr %arrayidx128.us.prol, align 2, !tbaa !91
  %arrayidx132.us.prol = getelementptr inbounds [2 x [3056 x i16]], ptr @mfbuf, i64 0, i64 %indvars.iv264, i64 %indvars.iv258.ph
  store i16 %83, ptr %arrayidx132.us.prol, align 16, !tbaa !91
...
for.body122.us.prol.loopexit:                     ; preds = %for.body122.us.prol, %for.body122.us.preheader
  ...
  %84 = icmp eq i64 %81, %70
  br i1 %84, label %for.cond119.for.inc136_crit_edge.us, label %for.body122.us
...
for.body122.us:                                   ; preds = %for.body122.us.prol.loopexit, %for.body122.us
  ...
  %85 = add nsw i64 %indvars.iv258, %67
  %arrayidx128.us = getelementptr inbounds [2 x [3056 x i16]], ptr @mfbuf, i64 0, i64 %indvars.iv264, i64 %85
  %86 = load i16, ptr %arrayidx128.us, align 2, !tbaa !91
  %arrayidx132.us = getelementptr inbounds [2 x [3056 x i16]], ptr @mfbuf, i64 0, i64 %indvars.iv264, i64 %indvars.iv258
  store i16 %86, ptr %arrayidx132.us, align 2, !tbaa !91
  %indvars.iv.next259 = add nuw nsw i64 %indvars.iv258, 1
  %87 = add nsw i64 %indvars.iv.next259, %67
  %arrayidx128.us.1 = getelementptr inbounds [2 x [3056 x i16]], ptr @mfbuf, i64 0, i64 %indvars.iv264, i64 %87
  %88 = load i16, ptr %arrayidx128.us.1, align 2, !tbaa !91
  %arrayidx132.us.1 = getelementptr inbounds [2 x [3056 x i16]], ptr @mfbuf, i64 0, i64 %indvars.iv264, i64 %indvars.iv.next259
  store i16 %88, ptr %arrayidx132.us.1, align 2, !tbaa !91
...
cleanup140:                                       ; preds = %for.cond119.for.inc136_crit_edge.us, %if.end106, %for.end94
  %89 = phi i32 [ %31, %for.end94 ], [ %63, %if.end106 ], [ %63, %for.cond119.for.inc136_crit_edge.us ]
...
attributes #13 = { mustprogress nofree norecurse nosync nounwind willreturn memory(write, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
