; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/builtin-bitops-1.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/builtin-bitops-1.c"
...
; Function Attrs: nofree norecurse nosync nounwind memory(none) uwtable
define dso_local i32 @my_ffsl(i64 noundef %x) local_unnamed_addr #0 {
entry:
  %cmp = icmp eq i64 %x, 0
...
; Function Attrs: nofree norecurse nosync nounwind memory(none) uwtable
define dso_local i32 @my_ctzl(i64 noundef %x) local_unnamed_addr #0 {
entry:
  br label %for.body
...
; Function Attrs: nofree norecurse nosync nounwind memory(none) uwtable
define dso_local i32 @my_clzl(i64 noundef %x) local_unnamed_addr #0 {
entry:
  br label %for.body
...
; Function Attrs: nofree norecurse nosync nounwind memory(none) uwtable
define dso_local i32 @my_clrsbl(i64 noundef %x) local_unnamed_addr #0 {
entry:
  %shr = lshr i64 %x, 63
  br label %for.body
...
; Function Attrs: nofree norecurse nosync nounwind memory(none) uwtable
define dso_local i32 @my_popcountl(i64 noundef %x) local_unnamed_addr #0 {
entry:
...
; Function Attrs: nofree norecurse nosync nounwind memory(none) uwtable
define dso_local i32 @my_parityl(i64 noundef %x) local_unnamed_addr #0 {
entry:
  %broadcast.splatinsert = insertelement <4 x i64> poison, i64 %x, i64 0
  %broadcast.splat = shufflevector <4 x i64> %broadcast.splatinsert, <4 x i64> poison, <4 x i32> zeroinitializer
  br label %vector.body
...
; Function Attrs: nofree norecurse nosync nounwind memory(none) uwtable
define dso_local i32 @my_ffsll(i64 noundef %x) local_unnamed_addr #0 {
entry:
  %cmp = icmp eq i64 %x, 0
  br i1 %cmp, label %cleanup, label %for.body
...
; Function Attrs: nofree norecurse nosync nounwind memory(none) uwtable
define dso_local i32 @my_ctzll(i64 noundef %x) local_unnamed_addr #0 {
entry:
  br label %for.body
...
; Function Attrs: nofree norecurse nosync nounwind memory(none) uwtable
define dso_local i32 @my_clzll(i64 noundef %x) local_unnamed_addr #0 {
entry:
  br label %for.body
...
; Function Attrs: nofree norecurse nosync nounwind memory(none) uwtable
define dso_local i32 @my_clrsbll(i64 noundef %x) local_unnamed_addr #0 {
entry:
  %shr = lshr i64 %x, 63
  br label %for.body
...
; Function Attrs: nofree norecurse nosync nounwind memory(none) uwtable
define dso_local i32 @my_popcountll(i64 noundef %x) local_unnamed_addr #0 {
entry:
  %broadcast.splatinsert = insertelement <4 x i64> poison, i64 %x, i64 0
  %broadcast.splat = shufflevector <4 x i64> %broadcast.splatinsert, <4 x i64> poison, <4 x i32> zeroinitializer
  br label %vector.body
...
; Function Attrs: nofree norecurse nosync nounwind memory(none) uwtable
define dso_local i32 @my_parityll(i64 noundef %x) local_unnamed_addr #0 {
entry:
  %broadcast.splatinsert = insertelement <4 x i64> poison, i64 %x, i64 0
  %broadcast.splat = shufflevector <4 x i64> %broadcast.splatinsert, <4 x i64> poison, <4 x i32> zeroinitializer
  br label %vector.body
...
if.end50:                                         ; preds = %if.end41
  %8 = and i32 %7, 1
  %call55 = tail call i32 @my_parity(i32 noundef %0)
...
for.cond60:                                       ; preds = %middle.block
  ...
  %exitcond2382.not = icmp eq i64 %indvars.iv.next2380, 13
  br i1 %exitcond2382.not, label %for.body145, label %for.body64, !llvm.loop !26

for.body64:                                       ; preds = %for.cond, %for.cond60
  %indvars.iv2379 = phi i64 [ %indvars.iv.next2380, %for.cond60 ], [ 0, %for.cond ]
  %arrayidx66 = getelementptr inbounds [13 x i64], ptr @longs, i64 0, i64 %indvars.iv2379
  %9 = load i64, ptr %arrayidx66, align 8, !tbaa !27
  %10 = tail call i64 @llvm.cttz.i64(i64 %9, i1 true), !range !29
...
for.inc.i:                                        ; preds = %for.body.i
  ...
  br i1 %tobool.not.i.1, label %for.inc.i.1, label %for.end.split.loop.exit.i.split.loop.exit2475

for.inc.i.1:                                      ; preds = %for.inc.i
  %shl.i.2 = shl i64 4, %indvars.iv.i
  %and.i.2 = and i64 %shl.i.2, %9
  %tobool.not.i.2 = icmp eq i64 %and.i.2, 0
  br i1 %tobool.not.i.2, label %for.inc.i.2, label %for.end.split.loop.exit.i.split.loop.exit2473
...
for.end.split.loop.exit.i.split.loop.exit2473:    ; preds = %for.inc.i.1
  %indvars.iv.next.i.1.le = or i64 %indvars.iv.i, 2
  br label %for.end.split.loop.exit.i

for.end.split.loop.exit.i.split.loop.exit2475:    ; preds = %for.inc.i
  %indvars.iv.next.i.le = or i64 %indvars.iv.i, 1
  br label %for.end.split.loop.exit.i

for.end.split.loop.exit.i:                        ; preds = %for.body.i, %for.end.split.loop.exit.i.split.loop.exit2475, %for.end.split.loop.exit.i.split.loop.exit2473, %for.end.split.loop.exit.i.split.loop.exit
  %indvars.iv.i.lcssa = phi i64 [ %indvars.iv.next.i.2.le, %for.end.split.loop.exit.i.split.loop.exit ], [ %indvars.iv.next.i.1.le, %for.end.split.loop.exit.i.split.loop.exit2473 ], [ %indvars.iv.next.i.le, %for.end.split.loop.exit.i.split.loop.exit2475 ], [ %indvars.iv.i, %for.body.i ]
...
land.lhs.true80:                                  ; preds = %my_ffsl.exit
  %15 = tail call i64 @llvm.ctlz.i64(i64 %9, i1 true), !range !29
...
for.inc.i1014:                                    ; preds = %for.body.i1011
  ...
  br i1 %tobool.not.i1010.1, label %for.inc.i1014.1, label %my_clzl.exit.split.loop.exit2484
...
for.inc.i1014.1:                                  ; preds = %for.inc.i1014
  ...
  br i1 %tobool.not.i1010.2, label %for.inc.i1014.2, label %my_clzl.exit.split.loop.exit2482
...
my_clzl.exit.split.loop.exit2482:                 ; preds = %for.inc.i1014.1
  %indvars.iv.next.i1012.1.le = or i64 %indvars.iv.i1007, 2
  br label %my_clzl.exit

my_clzl.exit.split.loop.exit2484:                 ; preds = %for.inc.i1014
  %indvars.iv.next.i1012.le = or i64 %indvars.iv.i1007, 1
  br label %my_clzl.exit

my_clzl.exit:                                     ; preds = %for.body.i1011, %my_clzl.exit.split.loop.exit2484, %my_clzl.exit.split.loop.exit2482, %my_clzl.exit.split.loop.exit
  %indvars.iv.i1007.lcssa = phi i64 [ %indvars.iv.next.i1012.2.le, %my_clzl.exit.split.loop.exit ], [ %indvars.iv.next.i1012.1.le, %my_clzl.exit.split.loop.exit2482 ], [ %indvars.iv.next.i1012.le, %my_clzl.exit.split.loop.exit2484 ], [ %indvars.iv.i1007, %for.body.i1011 ]
...
for.inc.i1025:                                    ; preds = %for.body.i1022
  ...
  br i1 %tobool.not.i1021.1, label %for.inc.i1025.1, label %my_ctzl.exit.split.loop.exit2493
...
for.inc.i1025.1:                                  ; preds = %for.inc.i1025
  ...
  br i1 %tobool.not.i1021.2, label %for.inc.i1025.2, label %my_ctzl.exit.split.loop.exit2491
...
my_ctzl.exit.split.loop.exit2491:                 ; preds = %for.inc.i1025.1
  %indvars.iv.next.i1023.1.le = or i64 %indvars.iv.i1018, 2
  br label %my_ctzl.exit

my_ctzl.exit.split.loop.exit2493:                 ; preds = %for.inc.i1025
  %indvars.iv.next.i1023.le = or i64 %indvars.iv.i1018, 1
  br label %my_ctzl.exit

my_ctzl.exit:                                     ; preds = %for.body.i1022, %my_ctzl.exit.split.loop.exit2493, %my_ctzl.exit.split.loop.exit2491, %my_ctzl.exit.split.loop.exit
  %indvars.iv.i1018.lcssa = phi i64 [ %indvars.iv.next.i1023.2.le, %my_ctzl.exit.split.loop.exit ], [ %indvars.iv.next.i1023.1.le, %my_ctzl.exit.split.loop.exit2491 ], [ %indvars.iv.next.i1023.le, %my_ctzl.exit.split.loop.exit2493 ], [ %indvars.iv.i1018, %for.body.i1022 ]
...
if.end105:                                        ; preds = %for.body64, %my_ctzl.exit
  ...
  %19 = tail call i64 @llvm.ctlz.i64(i64 %18, i1 false), !range !29
...
for.inc.i1033:                                    ; preds = %for.body.i1030
  ...
  br i1 %cmp8.not.i.1, label %for.inc.i1033.1, label %for.end.split.loop.exit.i1034.split.loop.exit2500
...
for.end.split.loop.exit.i1034.split.loop.exit2500: ; preds = %for.inc.i1033
  %indvars.iv.next.i1031.le = add nuw nsw i64 %indvars.iv.i1029, 1
  br label %for.end.split.loop.exit.i1034

for.end.split.loop.exit.i1034:                    ; preds = %for.body.i1030, %for.end.split.loop.exit.i1034.split.loop.exit2500, %for.end.split.loop.exit.i1034.split.loop.exit
  %indvars.iv.i1029.lcssa = phi i64 [ %indvars.iv.next.i1031.1.le, %for.end.split.loop.exit.i1034.split.loop.exit ], [ %indvars.iv.next.i1031.le, %for.end.split.loop.exit.i1034.split.loop.exit2500 ], [ %indvars.iv.i1029, %for.body.i1030 ]
...
if.end117:                                        ; preds = %my_clrsbl.exit
  %23 = tail call i64 @llvm.ctpop.i64(i64 %9), !range !29
  %broadcast.splatinsert2423 = insertelement <4 x i64> poison, i64 %9, i64 0
  %broadcast.splat2424 = shufflevector <4 x i64> %broadcast.splatinsert2423, <4 x i64> poison, <4 x i32> zeroinitializer
  br label %vector.body2418

vector.body2418:                                  ; preds = %vector.body2418, %if.end117
  %index2419 = phi i64 [ 0, %if.end117 ], [ %index.next2425, %vector.body2418 ]
  %vec.ind2420 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %if.end117 ], [ %vec.ind.next2421, %vector.body2418 ]
  %vec.phi2422 = phi <4 x i32> [ zeroinitializer, %if.end117 ], [ %28, %vector.body2418 ]
  %24 = shl nuw <4 x i64> <i64 1, i64 1, i64 1, i64 1>, %vec.ind2420
  %25 = and <4 x i64> %24, %broadcast.splat2424
  %26 = icmp ne <4 x i64> %25, zeroinitializer
  %27 = zext <4 x i1> %26 to <4 x i32>
  %28 = add <4 x i32> %vec.phi2422, %27
  %index.next2425 = add nuw i64 %index2419, 4
  %vec.ind.next2421 = add <4 x i64> %vec.ind2420, <i64 4, i64 4, i64 4, i64 4>
  %29 = icmp eq i64 %index.next2425, 64
  br i1 %29, label %middle.block2413, label %vector.body2418, !llvm.loop !30

middle.block2413:                                 ; preds = %vector.body2418
...
vector.ph:                                        ; preds = %middle.block2413
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %36, label %middle.block, label %vector.body, !llvm.loop !31
...
if.then126:                                       ; preds = %middle.block2413
  tail call void @abort() #5
  unreachable
...
for.cond141:                                      ; preds = %middle.block2427
  %indvars.iv.next2384 = add nuw nsw i64 %indvars.iv2383, 1
  %exitcond2386.not = icmp eq i64 %indvars.iv.next2384, 13
  br i1 %exitcond2386.not, label %if.end952, label %for.body145, !llvm.loop !32

for.body145:                                      ; preds = %for.cond60, %for.cond141
  %indvars.iv2383 = phi i64 [ %indvars.iv.next2384, %for.cond141 ], [ 0, %for.cond60 ]
  %arrayidx147 = getelementptr inbounds [13 x i64], ptr @longlongs, i64 0, i64 %indvars.iv2383
  %40 = load i64, ptr %arrayidx147, align 8, !tbaa !33
  %41 = tail call i64 @llvm.cttz.i64(i64 %40, i1 true), !range !29
...
for.inc.i1063:                                    ; preds = %for.body.i1060
  ...
  br i1 %tobool.not.i1059.1, label %for.inc.i1063.1, label %for.end.split.loop.exit.i1064.split.loop.exit2508
...
for.inc.i1063.1:                                  ; preds = %for.inc.i1063
  ...
  br i1 %tobool.not.i1059.2, label %for.inc.i1063.2, label %for.end.split.loop.exit.i1064.split.loop.exit2506
...
for.end.split.loop.exit.i1064.split.loop.exit2506: ; preds = %for.inc.i1063.1
  %indvars.iv.next.i1061.1.le = or i64 %indvars.iv.i1056, 2
  br label %for.end.split.loop.exit.i1064

for.end.split.loop.exit.i1064.split.loop.exit2508: ; preds = %for.inc.i1063
  %indvars.iv.next.i1061.le = or i64 %indvars.iv.i1056, 1
  br label %for.end.split.loop.exit.i1064

for.end.split.loop.exit.i1064:                    ; preds = %for.body.i1060, %for.end.split.loop.exit.i1064.split.loop.exit2508, %for.end.split.loop.exit.i1064.split.loop.exit2506, %for.end.split.loop.exit.i1064.split.loop.exit
  %indvars.iv.i1056.lcssa = phi i64 [ %indvars.iv.next.i1061.2.le, %for.end.split.loop.exit.i1064.split.loop.exit ], [ %indvars.iv.next.i1061.1.le, %for.end.split.loop.exit.i1064.split.loop.exit2506 ], [ %indvars.iv.next.i1061.le, %for.end.split.loop.exit.i1064.split.loop.exit2508 ], [ %indvars.iv.i1056, %for.body.i1060 ]
...
land.lhs.true162:                                 ; preds = %my_ffsll.exit
  %46 = tail call i64 @llvm.ctlz.i64(i64 %40, i1 true), !range !29
...
for.inc.i1075:                                    ; preds = %for.body.i1072
  ...
  br i1 %tobool.not.i1071.1, label %for.inc.i1075.1, label %my_clzll.exit.split.loop.exit2517
...
for.inc.i1075.1:                                  ; preds = %for.inc.i1075
  ...
  br i1 %tobool.not.i1071.2, label %for.inc.i1075.2, label %my_clzll.exit.split.loop.exit2515
...
my_clzll.exit.split.loop.exit2515:                ; preds = %for.inc.i1075.1
  %indvars.iv.next.i1073.1.le = or i64 %indvars.iv.i1068, 2
  br label %my_clzll.exit

my_clzll.exit.split.loop.exit2517:                ; preds = %for.inc.i1075
  %indvars.iv.next.i1073.le = or i64 %indvars.iv.i1068, 1
  br label %my_clzll.exit

my_clzll.exit:                                    ; preds = %for.body.i1072, %my_clzll.exit.split.loop.exit2517, %my_clzll.exit.split.loop.exit2515, %my_clzll.exit.split.loop.exit
  %indvars.iv.i1068.lcssa = phi i64 [ %indvars.iv.next.i1073.2.le, %my_clzll.exit.split.loop.exit ], [ %indvars.iv.next.i1073.1.le, %my_clzll.exit.split.loop.exit2515 ], [ %indvars.iv.next.i1073.le, %my_clzll.exit.split.loop.exit2517 ], [ %indvars.iv.i1068, %for.body.i1072 ]
...
for.inc.i1086:                                    ; preds = %for.body.i1083
  ...
  br i1 %tobool.not.i1082.1, label %for.inc.i1086.1, label %my_ctzll.exit.split.loop.exit2526
...
for.inc.i1086.1:                                  ; preds = %for.inc.i1086
  ...
  br i1 %tobool.not.i1082.2, label %for.inc.i1086.2, label %my_ctzll.exit.split.loop.exit2524
...
my_ctzll.exit.split.loop.exit2524:                ; preds = %for.inc.i1086.1
  %indvars.iv.next.i1084.1.le = or i64 %indvars.iv.i1079, 2
  br label %my_ctzll.exit

my_ctzll.exit.split.loop.exit2526:                ; preds = %for.inc.i1086
  %indvars.iv.next.i1084.le = or i64 %indvars.iv.i1079, 1
  br label %my_ctzll.exit

my_ctzll.exit:                                    ; preds = %for.body.i1083, %my_ctzll.exit.split.loop.exit2526, %my_ctzll.exit.split.loop.exit2524, %my_ctzll.exit.split.loop.exit
  %indvars.iv.i1079.lcssa = phi i64 [ %indvars.iv.next.i1084.2.le, %my_ctzll.exit.split.loop.exit ], [ %indvars.iv.next.i1084.1.le, %my_ctzll.exit.split.loop.exit2524 ], [ %indvars.iv.next.i1084.le, %my_ctzll.exit.split.loop.exit2526 ], [ %indvars.iv.i1079, %for.body.i1083 ]
...
if.end187:                                        ; preds = %for.body145, %my_ctzll.exit
  ...
  %49 = xor i64 %.lobit, %40
  %50 = tail call i64 @llvm.ctlz.i64(i64 %49, i1 false), !range !29
...
for.inc.i1099:                                    ; preds = %for.body.i1096
  ...
  br i1 %cmp8.not.i1095.1, label %for.inc.i1099.1, label %for.end.split.loop.exit.i1100.split.loop.exit2533
...
for.end.split.loop.exit.i1100.split.loop.exit2533: ; preds = %for.inc.i1099
  %indvars.iv.next.i1097.le = add nuw nsw i64 %indvars.iv.i1091, 1
  br label %for.end.split.loop.exit.i1100

for.end.split.loop.exit.i1100:                    ; preds = %for.body.i1096, %for.end.split.loop.exit.i1100.split.loop.exit2533, %for.end.split.loop.exit.i1100.split.loop.exit
  %indvars.iv.i1091.lcssa = phi i64 [ %indvars.iv.next.i1097.1.le, %for.end.split.loop.exit.i1100.split.loop.exit ], [ %indvars.iv.next.i1097.le, %for.end.split.loop.exit.i1100.split.loop.exit2533 ], [ %indvars.iv.i1091, %for.body.i1096 ]
...
if.end199:                                        ; preds = %my_clrsbll.exit
  %54 = tail call i64 @llvm.ctpop.i64(i64 %40), !range !29
  %broadcast.splatinsert2451 = insertelement <4 x i64> poison, i64 %40, i64 0
  %broadcast.splat2452 = shufflevector <4 x i64> %broadcast.splatinsert2451, <4 x i64> poison, <4 x i32> zeroinitializer
  br label %vector.body2446

vector.body2446:                                  ; preds = %vector.body2446, %if.end199
  %index2447 = phi i64 [ 0, %if.end199 ], [ %index.next2453, %vector.body2446 ]
  %vec.ind2448 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %if.end199 ], [ %vec.ind.next2449, %vector.body2446 ]
  %vec.phi2450 = phi <4 x i32> [ zeroinitializer, %if.end199 ], [ %59, %vector.body2446 ]
  %55 = shl nuw <4 x i64> <i64 1, i64 1, i64 1, i64 1>, %vec.ind2448
  %56 = and <4 x i64> %55, %broadcast.splat2452
  %57 = icmp ne <4 x i64> %56, zeroinitializer
  %58 = zext <4 x i1> %57 to <4 x i32>
  %59 = add <4 x i32> %vec.phi2450, %58
  %index.next2453 = add nuw i64 %index2447, 4
  %vec.ind.next2449 = add <4 x i64> %vec.ind2448, <i64 4, i64 4, i64 4, i64 4>
  %60 = icmp eq i64 %index.next2453, 64
  br i1 %60, label %middle.block2441, label %vector.body2446, !llvm.loop !35

middle.block2441:                                 ; preds = %vector.body2446
  %61 = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %59)
  %cast202 = trunc i64 %54 to i32
  %cmp206.not = icmp eq i32 %61, %cast202
  br i1 %cmp206.not, label %vector.ph2429, label %if.then208

vector.ph2429:                                    ; preds = %middle.block2441
  %broadcast.splatinsert2437 = insertelement <4 x i64> poison, i64 %40, i64 0
  %broadcast.splat2438 = shufflevector <4 x i64> %broadcast.splatinsert2437, <4 x i64> poison, <4 x i32> zeroinitializer
  br label %vector.body2432

vector.body2432:                                  ; preds = %vector.body2432, %vector.ph2429
  %index2433 = phi i64 [ 0, %vector.ph2429 ], [ %index.next2439, %vector.body2432 ]
  %vec.ind2434 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph2429 ], [ %vec.ind.next2435, %vector.body2432 ]
  %vec.phi2436 = phi <4 x i32> [ zeroinitializer, %vector.ph2429 ], [ %66, %vector.body2432 ]
  %62 = shl nuw <4 x i64> <i64 1, i64 1, i64 1, i64 1>, %vec.ind2434
  %63 = and <4 x i64> %62, %broadcast.splat2438
  %64 = icmp ne <4 x i64> %63, zeroinitializer
  %65 = zext <4 x i1> %64 to <4 x i32>
  %66 = add <4 x i32> %vec.phi2436, %65
  %index.next2439 = add nuw i64 %index2433, 4
  %vec.ind.next2435 = add <4 x i64> %vec.ind2434, <i64 4, i64 4, i64 4, i64 4>
  %67 = icmp eq i64 %index.next2439, 64
  br i1 %67, label %middle.block2427, label %vector.body2432, !llvm.loop !36

middle.block2427:                                 ; preds = %vector.body2432
...
if.then208:                                       ; preds = %middle.block2441
  tail call void @abort() #5
  unreachable

if.then218:                                       ; preds = %middle.block2427
  tail call void @abort() #5
  unreachable

if.end952:                                        ; preds = %for.cond141
