...
while.body139:                                    ; preds = %while.body139.lr.ph, %cleanup443
  ...
  %74 = load ptr, ptr %p.5801, align 8, !tbaa !5
...
if.then150:                                       ; preds = %cond.true.i
  ...
  %call152 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %79, ptr noundef nonnull @.str.9, ptr noundef %str.0803)
...
_ZN8looplist3popEv.exit:                          ; preds = %for.cond.cleanup157, %if.then.i
  ...
  %spec.select820 = select i1 %cmp.i664, ptr %call.i661, ptr %72
...
cond.true.i669:                                   ; preds = %cond.true.i, %_ZN8looplist3popEv.exit
  ...
  %87 = phi ptr [ %spec.select820, %_ZN8looplist3popEv.exit ], [ %72, %cond.true.i ]
...
_ZN8looplist3popEv.exit676:                       ; preds = %for.cond.cleanup188, %if.then.i675
  ...
  %spec.select822 = select i1 %cmp.i680, ptr %call.i677, ptr %88
...
if.end199:                                        ; preds = %if.then143, %cond.true.i669, %land.lhs.true, %_ZN8looplist3popEv.exit
  ...
  %104 = phi ptr [ %87, %cond.true.i669 ], [ %87, %land.lhs.true ], [ %spec.select820, %_ZN8looplist3popEv.exit ], [ %72, %if.then143 ]
...
if.end264:                                        ; preds = %if.else249, %delete.notnull257, %if.then245, %if.else260
  ...
  %spec.select823 = select i1 %cmp.i699, ptr null, ptr %105
  %spec.select824 = select i1 %cmp.i699, ptr null, ptr %104
...
if.then280:                                       ; preds = %while.body.i
  ...
  %139 = load ptr, ptr %p.5801, align 8, !tbaa !5
...
if.then311:                                       ; preds = %cond.end308
  ...
  %151 = load ptr, ptr %p.5801, align 8, !tbaa !5
...
if.then357:                                       ; preds = %if.then353
  ...
  %166 = load ptr, ptr %p.5801, align 8, !tbaa !5
...
if.then416:                                       ; preds = %if.end413
  ...
  %193 = load ptr, ptr %p.5801, align 8, !tbaa !5
...
cleanup443:                                       ; preds = %for.body384, %for.body290, %for.body272, %for.body322, %_ZN8looplist3popEv.exit676, %delete.end375, %if.then280, %if.end264, %if.then311, %if.end413, %while.body139, %delete.notnull440
  ...
  %205 = phi ptr [ %105, %delete.notnull440 ], [ %71, %while.body139 ], [ %105, %if.end413 ], [ %105, %if.then311 ], [ %spec.select823, %if.end264 ], [ %105, %if.then280 ], [ %105, %delete.end375 ], [ %spec.select821, %_ZN8looplist3popEv.exit676 ], [ %105, %for.body322 ], [ %spec.select823, %for.body272 ], [ %105, %for.body290 ], [ %105, %for.body384 ]
  %206 = phi ptr [ %104, %delete.notnull440 ], [ %72, %while.body139 ], [ %104, %if.end413 ], [ %104, %if.then311 ], [ %spec.select824, %if.end264 ], [ %104, %if.then280 ], [ %104, %delete.end375 ], [ %spec.select822, %_ZN8looplist3popEv.exit676 ], [ %104, %for.body322 ], [ %spec.select824, %for.body272 ], [ %104, %for.body290 ], [ %104, %for.body384 ]
