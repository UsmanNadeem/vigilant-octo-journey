; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Ppmd8Enc.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Ppmd8Enc.c"
...
do.body220.preheader:                             ; preds = %do.body214
  ...
  %xtraiter606 = and i32 %i182.0, 1
  %lcmp.mod607.not = icmp eq i32 %xtraiter606, 0
  br i1 %lcmp.mod607.not, label %do.body220.prol.loopexit, label %do.body220.prol
