; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/idebug.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/idebug.c"
...
for.body.i:                                       ; preds = %for.body.i, %for.body.preheader.i
  ...
  %call.i.i = tail call i32 @_IO_putc(i32 noundef %conv3.i, ptr noundef %22)
...
for.body:                                         ; preds = %for.body.preheader, %for.body
  ...
  %call.i = tail call i32 @_IO_putc(i32 noundef %conv3, ptr noundef %1)
...
if.then24:                                        ; preds = %for.cond
  ...
  %call.i = tail call i32 @_IO_putc(i32 noundef %spec.select64, ptr noundef %3)
  br label %for.inc
...
sw.epilog:                                        ; preds = %for.end, %sw.bb40, %sw.bb
  ...
  %call.i65 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %8)
...
while.body:                                       ; preds = %if.end, %while.end
  %p.023 = phi ptr [ %p.1.lcssa, %while.end ], [ %from, %if.end ]
  %add.ptr = getelementptr inbounds i8, ptr %p.023, i64 16
  %cmp2 = icmp ult ptr %add.ptr, %to
  %cond = select i1 %cmp2, ptr %add.ptr, ptr %to
  %0 = ptrtoint ptr %p.023 to i64
  %call4 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.38, i64 noundef %0)
  %cmp6.not20 = icmp eq ptr %p.023, %cond
  br i1 %cmp6.not20, label %while.end, label %while.body7

while.body7:                                      ; preds = %while.body, %while.body7
  %p.121 = phi ptr [ %incdec.ptr, %while.body7 ], [ %p.023, %while.body ]
...
while.end:                                        ; preds = %while.body7, %while.body
  ...
  br i1 %cmp1.not, label %while.end10, label %while.body, !llvm.loop !25
