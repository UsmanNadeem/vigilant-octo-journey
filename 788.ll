...
for.end.i31:                                      ; preds = %for.end.loopexit.i28, %if.end
  ...
  %mindist.0.call9.i = select i1 %cmp12.i, double %mindist.0.lcssa.i, double %sqrt.i279.pre-phi.i
  %call10.mindist.0.i = select i1 %cmp12.i, double %74, double %mindist.0.lcssa.i
...
for.end26.i:                                      ; preds = %for.end26.loopexit.i, %for.end.i31
  ...
  %shift33 = shufflevector <2 x double> %102, <2 x double> poison, <2 x i32> <i32 1, i32 undef>
  ...
  %min.0..val220.i = load double, ptr %105, align 8, !tbaa !14
  %106 = getelementptr i8, ptr %min.0..i, i64 16
  %min.0..val221.i = load double, ptr %106, align 8, !tbaa !15
  ...
  %.min.0.val214.i = load double, ptr %111, align 8, !tbaa !14
  %112 = getelementptr i8, ptr %.min.0.i, i64 16
  %.min.0.val215.i = load double, ptr %112, align 8, !tbaa !15
  %113 = insertelement <2 x i1> poison, i1 %cmp35.i, i64 0
  %114 = shufflevector <2 x i1> %113, <2 x i1> poison, <2 x i32> zeroinitializer
  %115 = shufflevector <2 x double> %87, <2 x double> poison, <2 x i32> <i32 1, i32 undef>
  %116 = shufflevector <2 x double> %115, <2 x double> %102, <2 x i32> <i32 0, i32 2>
  %117 = select <2 x i1> %114, <2 x double> %116, <2 x double> %87
  %min.2..val222.i = load double, ptr %107, align 8, !tbaa !14
  %min.2..val223.i = load double, ptr %108, align 8, !tbaa !15
  %.min.2.val218.i = load double, ptr %109, align 8, !tbaa !14
  %.min.2.val219.i = load double, ptr %110, align 8, !tbaa !15
  %118 = insertelement <2 x double> poison, double %min.0..val220.i, i64 0
  %119 = shufflevector <2 x double> %118, <2 x double> poison, <2 x i32> zeroinitializer
  %120 = insertelement <2 x double> poison, double %.min.2.val218.i, i64 0
  %121 = insertelement <2 x double> %120, double %min.2..val222.i, i64 1
  %122 = fsub <2 x double> %119, %121
  %123 = insertelement <2 x double> poison, double %min.0..val221.i, i64 0
  %124 = shufflevector <2 x double> %123, <2 x double> poison, <2 x i32> zeroinitializer
  %125 = insertelement <2 x double> poison, double %.min.2.val219.i, i64 0
  %126 = insertelement <2 x double> %125, double %min.2..val223.i, i64 1
  ...
  %133 = insertelement <2 x double> poison, double %call10.mindist.0.i, i64 0
  ...
  %add49.i = fadd double %mindist.0.call9.i, %139
  ...
  %add54.i = fadd double %mindist.0.call9.i, %140
