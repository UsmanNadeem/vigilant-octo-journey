; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Ppmd7Dec.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Ppmd7Dec.c"
...
do.body216:                                       ; preds = %if.end221, %for.cond208
  %add.ptr226501 = phi ptr [ %add.ptr226, %if.end221 ], [ %53, %for.cond208 ]
  %inc499 = phi i32 [ %inc, %if.end221 ], [ %OrderFall.promoted, %for.cond208 ]
  %inc = add i32 %inc499, 1
  %Suffix218 = getelementptr inbounds %struct.CPpmd7_Context_, ptr %add.ptr226501, i64 0, i32 3
...
for.end280:                                       ; preds = %for.cond271
  %conv273.le = zext i8 %65 to i32
  %66 = load ptr, ptr %Decode314, align 8, !tbaa !31
  call void %66(ptr noundef nonnull %rc, i32 noundef %hiCnt211.1, i32 noundef %conv273.le) #6
...
if.end313:                                        ; preds = %if.end309
  ...
  %xtraiter569 = and i32 %sub243, 3
  %lcmp.mod570.not = icmp eq i32 %xtraiter569, 0
  br i1 %lcmp.mod570.not, label %do.body321.prol.loopexit, label %do.body321.prol

do.body321.prol:                                  ; preds = %if.end313, %do.body321.prol
  %i212.1.prol = phi i32 [ %dec323.prol, %do.body321.prol ], [ %sub243, %if.end313 ]
  %prol.iter571 = phi i32 [ %prol.iter571.next, %do.body321.prol ], [ 0, %if.end313 ]
  ...
  br i1 %prol.iter571.cmp.not, label %do.body321.prol.loopexit, label %do.body321.prol, !llvm.loop !58
