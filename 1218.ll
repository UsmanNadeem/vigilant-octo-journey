; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/strcpy-1.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Regression/C/gcc-c-torture/execute/strcpy-1.c"
...
for.cond2.preheader:                              ; preds = %entry, %for.inc93
  ...
  %uglygep156 = getelementptr i8, ptr getelementptr (i8, ptr @u1, i64 1), i64 %0
  %uglygep154 = getelementptr i8, ptr @u1, i64 %0
...
for.cond12.preheader.us.us:                       ; preds = %for.cond73.us.us.7, %for.cond7.preheader.us
  ...
  %indvars.iv157 = phi ptr [ %uglygep158, %for.cond73.us.us.7 ], [ %uglygep156, %for.cond7.preheader.us ]
...
for.cond73.us.us.7:                               ; preds = %for.cond73.us.us.6
  ...
  %uglygep158 = getelementptr i8, ptr %indvars.iv157, i64 1
...
for.body50.us.us:                                 ; preds = %for.inc42.us.us, %for.inc62.us.us
  ...
  %q.1136.us.us = phi ptr [ %incdec.ptr64.us.us, %for.inc62.us.us ], [ %uglygep156, %for.inc42.us.us ]
...
for.inc42.us.us:                                  ; preds = %for.body36.us.us
  ...
  %exitcond155.not = icmp eq ptr %q.0134.us.us, %uglygep154
...
for.cond12.preheader:                             ; preds = %for.cond7.preheader, %for.cond73.7
  ...
  %indvars.iv177 = phi ptr [ @u1, %for.cond7.preheader ], [ %uglygep178, %for.cond73.7 ]
  %indvars.iv175 = phi ptr [ getelementptr (i8, ptr @u1, i64 1), %for.cond7.preheader ], [ %uglygep176, %for.cond73.7 ]
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(97) @u1, i8 97, i64 97, i1 false), !tbaa !5
  br label %for.body16
...
for.cond73.7:                                     ; preds = %for.cond73.6
  ...
  %uglygep176 = getelementptr i8, ptr %indvars.iv175, i64 1
  %uglygep178 = getelementptr i8, ptr %indvars.iv177, i64 1
