; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/gethdr.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/mpeg2/mpeg2dec/gethdr.c"
...
vector.memcheck:                                  ; preds = %sw.bb
  %uglygep = getelementptr i8, ptr %2, i64 2104
  %uglygep31 = getelementptr i8, ptr %2, i64 2360
  %bound0 = icmp ult ptr %uglygep, getelementptr inbounds ([64 x i8], ptr @default_intra_quantizer_matrix, i64 1, i64 0)
  %bound1 = icmp ugt ptr %uglygep31, @default_intra_quantizer_matrix
...
sw.bb2:                                           ; preds = %next_start_code.exit
  ...
  %112 = load i32, ptr @picture_coding_type, align 4, !tbaa !14
  %113 = and i32 %112, -2
...
if.end17.i.i:                                     ; preds = %if.then15.i.i, %if.end10.i.i
  ...
  %121 = load i32, ptr @True_Framenum_max, align 4, !tbaa !14
