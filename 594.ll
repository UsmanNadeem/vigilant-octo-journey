; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/minisat/Solver.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/minisat/Solver.cpp"
...
; Function Attrs: uwtable
define dso_local noundef i32 @_ZN6Solver6newVarEbb(ptr noundef nonnull align 8 dereferenceable(536) %this, i1 noundef zeroext %sign, i1 noundef zeroext %dvar) local_unnamed_addr #0 align 2 {
entry:
...
if.then.i:                                        ; preds = %entry
  ...
  %call6.i = tail call ptr @realloc(ptr noundef %3, i64 noundef %mul5.i) #23
...
if.then.i28:                                      ; preds = %_ZN3vecIS_IP6ClauseEE4pushEv.exit
  ...
  %call6.i26 = tail call ptr @realloc(ptr noundef %8, i64 noundef %mul5.i25) #23
...
if.then.i45:                                      ; preds = %_ZN3vecIS_IP6ClauseEE4pushEv.exit32
  ...
  %call6.i44 = tail call ptr @realloc(ptr noundef %14, i64 noundef %mul5.i43) #23
...
if.then.i61:                                      ; preds = %_ZN3vecIP6ClauseE4pushERKS1_.exit
  ...
  %call6.i59 = tail call ptr @realloc(ptr noundef %19, i64 noundef %conv.i58) #23
...
if.then.i78:                                      ; preds = %_ZN3vecIcE4pushERKc.exit
  ...
  %call6.i76 = tail call ptr @realloc(ptr noundef %24, i64 noundef %mul5.i75) #23
...
if.then.i95:                                      ; preds = %_ZN3vecIiE4pushERKi.exit
  ...
  %call6.i93 = tail call ptr @realloc(ptr noundef %29, i64 noundef %mul5.i92) #23
...
if.then.i111:                                     ; preds = %_ZN3vecIdE4pushERKd.exit
  ...
  %call6.i109 = tail call ptr @realloc(ptr noundef %34, i64 noundef %conv.i108) #23
...
if.then.i128:                                     ; preds = %_ZN3vecIcE4pushERKc.exit115
  ...
  %call6.i126 = tail call ptr @realloc(ptr noundef %39, i64 noundef %conv.i125) #23
...
if.then.i145:                                     ; preds = %_ZN3vecIcE4pushERKc.exit132
  ...
  %call6.i143 = tail call ptr @realloc(ptr noundef %44, i64 noundef %conv.i142) #23
...
; Function Attrs: uwtable
define dso_local noundef zeroext i1 @_ZN6Solver9addClauseER3vecI3LitE(ptr nocapture noundef nonnull align 8 dereferenceable(536) %this, ptr nocapture noundef nonnull align 8 dereferenceable(16) %ps) local_unnamed_addr #0 align 2 {
entry:
  %ok = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 21
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  ...
  %agg.tmp.sroa.0.0.copyload = load i32, ptr %arrayidx.i, align 4, !tbaa.struct !64
...
if.then46:                                        ; preds = %if.end38
  ...
  %agg.tmp47.sroa.0.0.copyload = load i32, ptr %14, align 4, !tbaa.struct !64
...
if.then.i.i:                                      ; preds = %if.then46
  ...
  %call6.i.i = tail call ptr @realloc(ptr noundef %21, i64 noundef %mul5.i.i) #23
...
if.else53:                                        ; preds = %if.end38
  ...
  %call1.i = tail call noalias ptr @malloc(i64 noundef %add.i) #24
...
for.body.lr.ph.i.i:                               ; preds = %if.else53
  ...
  %uglygep.i = getelementptr i8, ptr %call1.i, i64 8
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 4 %uglygep.i, ptr align 4 %24, i64 %mul.i, i1 false), !tbaa !61
  br label %for.cond.cleanup.i.i
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i.preheader, %for.body.i.i.i
  ...
  %agg.tmp.sroa.0.0.copyload.i.i.i = load i32, ptr %arrayidx.i13.i.i, align 4, !tbaa.struct !64
...
if.then.i:                                        ; preds = %_Z10Clause_newI3vecI3LitEEP6ClauseRKT_b.exit
  ...
  %call6.i = tail call ptr @realloc(ptr noundef %40, i64 noundef %mul5.i) #23
...
define dso_local void @_ZN6Solver16uncheckedEnqueueE3LitP6Clause(ptr nocapture noundef nonnull align 8 dereferenceable(536) %this, i32 %p.coerce, ptr noundef %from) local_unnamed_addr #5 align 2 {
entry:
...
if.then.i:                                        ; preds = %entry
  ...
  %call6.i = tail call ptr @realloc(ptr noundef %6, i64 noundef %mul5.i) #23
...
while.body:                                       ; preds = %while.body.lr.ph, %_ZN3vecIP6ClauseE6shrinkEi.exit
  ...
  %p.sroa.0.0.copyload = load i32, ptr %arrayidx.i, align 4, !tbaa.struct !64
...
for.body:                                         ; preds = %for.body.lr.ph, %FoundWatch
  ...
  %11 = load i32, ptr %arrayidx.i130, align 4, !tbaa !73
...
if.then:                                          ; preds = %for.body
  ...
  store i32 %xor.i, ptr %arrayidx.i131, align 4, !tbaa.struct !64
  br label %if.end
...
for.body35:                                       ; preds = %for.body35.preheader, %for.inc
  %indvars.iv = phi i64 [ 2, %for.body35.preheader ], [ %indvars.iv.next, %for.inc ]
  %arrayidx.i137 = getelementptr inbounds %class.Clause, ptr %10, i64 0, i32 2, i64 %indvars.iv
  %agg.tmp37.sroa.0.0.copyload = load i32, ptr %arrayidx.i137, align 4, !tbaa.struct !64
  ...
  br i1 %cmp.i146.not, label %for.inc, label %if.then45

if.then45:                                        ; preds = %for.body35
  %idxprom.i136.le = and i64 %indvars.iv, 4294967295
  %arrayidx.i137.le = getelementptr inbounds %class.Clause, ptr %10, i64 0, i32 2, i64 %idxprom.i136.le
  ...
  store i32 %xor.i, ptr %arrayidx.i137.le, align 4, !tbaa.struct !64
  %agg.tmp51.sroa.0.0.copyload = load i32, ptr %arrayidx.i149, align 4, !tbaa.struct !64
...
if.then.i:                                        ; preds = %if.then45
  ...
  %call6.i = tail call ptr @realloc(ptr noundef %20, i64 noundef %mul5.i) #23
...
for.inc:                                          ; preds = %for.body35
  ...
  br i1 %exitcond.not, label %for.end, label %for.body35, !llvm.loop !75
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %38, label %middle.block, label %vector.body, !llvm.loop !76
...
while.body77:                                     ; preds = %while.body77.preheader217, %while.body77
  ...
  br i1 %cmp76, label %while.body77, label %FoundWatch, !llvm.loop !77
...
if.then.i.i:                                      ; preds = %if.else80
  ...
  %conv.i.i = zext i32 %add.i.i.i to i64
  %mul5.i.i = shl nuw nsw i64 %conv.i.i, 2
  %call6.i.i = tail call ptr @realloc(ptr noundef %45, i64 noundef %mul5.i.i) #23
...
FoundWatch:                                       ; preds = %while.body77, %middle.block, %if.then71, %cleanup, %if.then30, %_ZN6Solver16uncheckedEnqueueE3LitP6Clause.exit
  ...
  br i1 %cmp10.not, label %for.end85, label %for.body, !llvm.loop !78
...
_ZN3vecIP6ClauseE6shrinkEi.exit:                  ; preds = %for.end85, %for.body.lr.ph.i
  ...
  br i1 %cmp, label %while.body, label %while.end86.loopexit, !llvm.loop !79
...
while.end86:                                      ; preds = %while.end86.loopexit, %entry
  ...
  %53 = load i64, ptr %propagations, align 8, !tbaa !80
  %add = add i64 %53, %num_props.0.lcssa
  store i64 %add, ptr %propagations, align 8, !tbaa !80
  %simpDB_props = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 37
  %54 = load i64, ptr %simpDB_props, align 8, !tbaa !81
  %sub = sub nsw i64 %54, %num_props.0.lcssa
  store i64 %sub, ptr %simpDB_props, align 8, !tbaa !81
  ret ptr %confl.0.lcssa
}

; Function Attrs: mustprogress nounwind willreturn uwtable
define dso_local void @_ZN6Solver12attachClauseER6Clause(ptr nocapture noundef nonnull align 8 dereferenceable(536) %this, ptr noundef nonnull align 4 dereferenceable(8) %c) local_unnamed_addr #5 align 2 {
entry:
  %watches = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 27
  %arrayidx.i = getelementptr inbounds %class.Clause, ptr %c, i64 0, i32 2, i64 0
  %agg.tmp2.sroa.0.0.copyload = load i32, ptr %arrayidx.i, align 4, !tbaa.struct !64
...
_ZN3vecIP6ClauseE4pushERKS1_.exit:                ; preds = %entry.if.end_crit_edge.i, %if.then.i
  ...
  %agg.tmp10.sroa.0.0.copyload = load i32, ptr %arrayidx.i33, align 4, !tbaa.struct !64
...
if.then.i50:                                      ; preds = %_ZN3vecIP6ClauseE4pushERKS1_.exit
  ...
  %call6.i48 = tail call ptr @realloc(ptr noundef %9, i64 noundef %mul5.i47) #23
...
_ZN3vecIP6ClauseE4pushERKS1_.exit54:              ; preds = %entry.if.end_crit_edge.i41, %if.then.i50
  ...
  %13 = load i64, ptr %clauses_literals.sink57, align 8, !tbaa !82
  %add23 = add i64 %13, %conv22
  store i64 %add23, ptr %clauses_literals.sink57, align 8, !tbaa !82
  ret void
}

; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @_ZN6Solver12detachClauseER6Clause(ptr nocapture noundef nonnull align 8 dereferenceable(536) %this, ptr noundef nonnull align 4 dereferenceable(8) %c) local_unnamed_addr #6 align 2 {
entry:
  %watches = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 27
  %arrayidx.i = getelementptr inbounds %class.Clause, ptr %c, i64 0, i32 2, i64 0
  %agg.tmp2.sroa.0.0.copyload = load i32, ptr %arrayidx.i, align 4, !tbaa.struct !64
...
for.inc.i:                                        ; preds = %land.rhs.i
  ...
  br i1 %exitcond.not.i, label %for.end.thread.i, label %land.rhs.i, !llvm.loop !83
...
for.body6.i.prol:                                 ; preds = %for.body6.preheader.i, %for.body6.i.prol
  ...
  br i1 %prol.iter.cmp.not, label %for.body6.i.prol.loopexit, label %for.body6.i.prol, !llvm.loop !84
...
for.body6.i:                                      ; preds = %for.body6.i.prol.loopexit, %for.body6.i
  ...
  br i1 %cmp5.i.3, label %for.body6.i, label %_ZL6removeI3vecIP6ClauseES2_EvRT_RKT0_.exit.loopexit, !llvm.loop !86
...
_ZL6removeI3vecIP6ClauseES2_EvRT_RKT0_.exit:      ; preds = %_ZL6removeI3vecIP6ClauseES2_EvRT_RKT0_.exit.loopexit, %for.end.thread.i, %for.end.i
  ...
  %agg.tmp10.sroa.0.0.copyload = load i32, ptr %arrayidx.i31, align 4, !tbaa.struct !64
...
for.inc.i45:                                      ; preds = %land.rhs.i42
  ...
  br i1 %exitcond.not.i44, label %for.end.thread.i47, label %land.rhs.i42, !llvm.loop !83
...
for.body6.i59.prol:                               ; preds = %for.body6.preheader.i53, %for.body6.i59.prol
  ...
  br i1 %prol.iter76.cmp.not, label %for.body6.i59.prol.loopexit, label %for.body6.i59.prol, !llvm.loop !87
...
for.body6.i59:                                    ; preds = %for.body6.i59.prol.loopexit, %for.body6.i59
  ...
  br i1 %cmp5.i58.3, label %for.body6.i59, label %_ZL6removeI3vecIP6ClauseES2_EvRT_RKT0_.exit61, !llvm.loop !86
...
_ZL6removeI3vecIP6ClauseES2_EvRT_RKT0_.exit61:    ; preds = %for.body6.i59.prol.loopexit, %for.body6.i59, %for.end.thread.i47, %for.end.i52
  ...
  %45 = load i64, ptr %clauses_literals.sink69, align 8, !tbaa !82
  %sub23 = sub i64 %45, %conv22
  store i64 %sub23, ptr %clauses_literals.sink69, align 8, !tbaa !82
  ret void
}

; Function Attrs: mustprogress nounwind uwtable
define dso_local void @_ZN6Solver12removeClauseER6Clause(ptr nocapture noundef nonnull align 8 dereferenceable(536) %this, ptr noundef nonnull align 4 dereferenceable(8) %c) local_unnamed_addr #7 align 2 {
entry:
  ...
  tail call void @free(ptr noundef nonnull %c) #22
  ret void
}

; Function Attrs: nofree nosync nounwind memory(read, inaccessiblemem: none) uwtable
define dso_local noundef zeroext i1 @_ZNK6Solver9satisfiedERK6Clause(ptr nocapture noundef nonnull readonly align 8 dereferenceable(536) %this, ptr nocapture noundef nonnull readonly align 4 dereferenceable(8) %c) local_unnamed_addr #8 align 2 {
entry:
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %retval.sroa.0.0.copyload.i17 = load i32, ptr %arrayidx.i16, align 4, !tbaa.struct !64
...
for.cond:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %cleanup.loopexit, label %for.body, !llvm.loop !88

for.body:                                         ; preds = %for.cond
  %arrayidx.i = getelementptr inbounds %class.Clause, ptr %c, i64 0, i32 2, i64 %indvars.iv.next
  %retval.sroa.0.0.copyload.i = load i32, ptr %arrayidx.i, align 4, !tbaa.struct !64
  ...
  %cmp.i = icmp eq i8 %retval.sroa.0.0.i.i, 1
  br i1 %cmp.i, label %cleanup.loopexit, label %for.cond, !llvm.loop !88
...
define dso_local void @_ZN6Solver11cancelUntilEi(ptr noundef nonnull align 8 dereferenceable(536) %this, i32 noundef %level) local_unnamed_addr #9 align 2 {
entry:
  %sz.i.i = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 32, i32 1
...
for.body:                                         ; preds = %for.body.lr.ph, %_ZN6Solver14insertVarOrderEi.exit
  ...
  %agg.tmp.sroa.0.0.copyload = load i32, ptr %arrayidx.i43, align 4, !tbaa.struct !64
...
_ZN6Solver14insertVarOrderEi.exit:                ; preds = %_ZNK4HeapIN6Solver10VarOrderLtEE6inHeapEi.exit.i, %land.lhs.true.i, %if.then.i
  ...
  br i1 %cmp4.not.not, label %for.body, label %for.cond.cleanup.loopexit, !llvm.loop !89
...
; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local i32 @_ZN6Solver13pickBranchLitEid(ptr nocapture noundef nonnull align 8 dereferenceable(536) %this, i32 noundef %polarity_mode, double noundef %random_var_freq) local_unnamed_addr #6 align 2 {
entry:
  %random_seed = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 40
...
if.then14:                                        ; preds = %land.rhs
  ...
  %10 = load i64, ptr %rnd_decisions, align 8, !tbaa !90
  %inc = add i64 %10, 1
  store i64 %inc, ptr %rnd_decisions, align 8, !tbaa !90
  br label %if.end15
...
if.then.i:                                        ; preds = %entry
  ...
  %conv.i = zext i32 %add.i.i to i64
  %mul5.i = shl nuw nsw i64 %conv.i, 2
  %call6.i = tail call ptr @realloc(ptr noundef %2, i64 noundef %mul5.i) #23
...
_ZN3vecI3LitE4pushEv.exit:                        ; preds = %entry.if.end_crit_edge.i, %if.then.i
  ...
  store i32 -2, ptr %arrayidx.i, align 4, !tbaa !73
...
_ZNK4HeapIN6Solver10VarOrderLtEE6inHeapEi.exit.i: ; preds = %if.end.i
  %39 = load ptr, ptr %indices.i.i, align 8, !tbaa !45
...
if.then.i333:                                     ; preds = %if.else
  ...
  %call6.i332 = tail call ptr @realloc(ptr noundef %53, i64 noundef %mul5.i331) #23
...
while.cond:                                       ; preds = %while.cond.preheader, %while.cond
  ...
  %agg.tmp49.sroa.0.0.copyload = load i32, ptr %arrayidx.i345, align 4, !tbaa.struct !64
...
do.end:                                           ; preds = %while.end
  ...
  store i32 %xor.i, ptr %65, align 4, !tbaa.struct !64
  %expensive_ccmin = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 9
...
for.body80:                                       ; preds = %for.body80, %for.body80.lr.ph.new
  ...
  %agg.tmp81.sroa.0.0.copyload = load i32, ptr %arrayidx.i359, align 4, !tbaa.struct !64
  ...
  %agg.tmp81.sroa.0.0.copyload.1 = load i32, ptr %arrayidx.i359.1, align 4, !tbaa.struct !64
...
for.body80.epil:                                  ; preds = %for.end88.loopexit.unr-lcssa
  ...
  %agg.tmp81.sroa.0.0.copyload.epil = load i32, ptr %arrayidx.i359.epil, align 4, !tbaa.struct !64
...
if.end11.i.i.i:                                   ; preds = %do.body.i.i.i, %if.then4.i.i.i
  ...
  %call.i.i.i = tail call ptr @realloc(ptr noundef %75, i64 noundef %mul13.i.i.i) #23
...
vector.body586:                                   ; preds = %vector.body586, %vector.ph581
  ...
  store <4 x i32> <i32 -2, i32 -2, i32 -2, i32 -2>, ptr %83, align 4, !tbaa !73
  %84 = getelementptr inbounds i32, ptr %83, i64 4
  store <4 x i32> <i32 -2, i32 -2, i32 -2, i32 -2>, ptr %84, align 4, !tbaa !73
...
for.body.i.i:                                     ; preds = %for.body.i.i.preheader, %for.body.i.i
  ...
  store i32 -2, ptr %arrayidx.i.i368, align 4, !tbaa !73
...
for.body92:                                       ; preds = %_ZNK3vecI3LitE6copyToERS1_.exit, %for.inc109
  ...
  %agg.tmp94.sroa.0.0.copyload = load i32, ptr %arrayidx.i378, align 4, !tbaa.struct !64
...
if.end11.i.i.i415:                                ; preds = %do.body.i.i.i409, %if.then4.i.i.i403
  ...
  %call.i.i.i413 = tail call ptr @realloc(ptr noundef %99, i64 noundef %mul13.i.i.i412) #23
...
vector.body598:                                   ; preds = %vector.body598, %vector.ph592
  ...
  store <4 x i32> <i32 -2, i32 -2, i32 -2, i32 -2>, ptr %107, align 4, !tbaa !73
  %108 = getelementptr inbounds i32, ptr %107, i64 4
  store <4 x i32> <i32 -2, i32 -2, i32 -2, i32 -2>, ptr %108, align 4, !tbaa !73
...
for.body.i.i426:                                  ; preds = %for.body.i.i426.preheader, %for.body.i.i426
  ...
  store i32 -2, ptr %arrayidx.i.i423, align 4, !tbaa !73
...
for.body117:                                      ; preds = %for.body117.lr.ph, %cleanup
  ...
  %agg.tmp120.sroa.0.0.copyload = load i32, ptr %arrayidx.i440, align 4, !tbaa.struct !64
...
for.body129:                                      ; preds = %for.body129.lr.ph, %for.inc150
  ...
  %agg.tmp131.sroa.0.0.copyload = load i32, ptr %arrayidx.i446, align 4, !tbaa.struct !64
...
for.body172.epil:                                 ; preds = %for.cond.cleanup171.loopexit.unr-lcssa
  ...
  %agg.tmp174.sroa.0.0.copyload.epil = load i32, ptr %arrayidx.i476.epil, align 4, !tbaa.struct !64
  ...
  %agg.tmp180.sroa.0.0.copyload.epil = load i32, ptr %arrayidx.i481.epil, align 4, !tbaa.struct !64
...
for.cond.cleanup171:                              ; preds = %for.cond168.preheader, %for.cond.cleanup171.loopexit
  ...
  %p192.sroa.0.0.copyload = load i32, ptr %arrayidx.i467, align 4, !tbaa.struct !64
  ...
  store i32 %p192.sroa.0.0.copyload, ptr %arrayidx.i468, align 4, !tbaa.struct !64
...
for.body172:                                      ; preds = %for.body172, %for.body172.lr.ph.new
  ...
  %agg.tmp174.sroa.0.0.copyload = load i32, ptr %arrayidx.i476, align 4, !tbaa.struct !64
  ...
  %agg.tmp180.sroa.0.0.copyload = load i32, ptr %arrayidx.i481, align 4, !tbaa.struct !64
  ...
  %agg.tmp174.sroa.0.0.copyload.1 = load i32, ptr %arrayidx.i476.1, align 4, !tbaa.struct !64
  ...
  %agg.tmp180.sroa.0.0.copyload.1 = load i32, ptr %arrayidx.i481.1, align 4, !tbaa.struct !64
...
for.body209:                                      ; preds = %for.body209.lr.ph, %for.body209
  ...
  %agg.tmp211.sroa.0.0.copyload = load i32, ptr %arrayidx.i487, align 4, !tbaa.struct !64
...
; Function Attrs: mustprogress nounwind uwtable
define dso_local noundef zeroext i1 @_ZN6Solver12litRedundantE3Litj(ptr nocapture noundef nonnull align 8 dereferenceable(536) %this, i32 %p.coerce, i32 noundef %abstract_levels) local_unnamed_addr #7 align 2 {
entry:
  %analyze_stack = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 44
...
if.then.i:                                        ; preds = %_ZN3vecI3LitE5clearEb.exit
  ...
  %conv.i = zext i32 %add.i.i to i64
  %mul5.i = shl nuw nsw i64 %conv.i, 2
  %call6.i = tail call ptr @realloc(ptr noundef %0, i64 noundef %mul5.i) #23
...
while.body:                                       ; preds = %while.body.lr.ph, %while.cond.loopexit
  ...
  %agg.tmp.sroa.0.0.copyload = load i32, ptr %arrayidx.i84, align 4, !tbaa.struct !64
...
if.then.i118:                                     ; preds = %if.then36
  ...
  %call6.i116 = tail call ptr @realloc(ptr noundef %23, i64 noundef %mul5.i115) #23
...
if.then.i136:                                     ; preds = %_ZN3vecI3LitE4pushERKS0_.exit122
  ...
  %call6.i134 = tail call ptr @realloc(ptr noundef %28, i64 noundef %mul5.i133) #23
...
for.body49:                                       ; preds = %for.body49.preheader, %for.body49
  ...
  %agg.tmp51.sroa.0.0.copyload = load i32, ptr %arrayidx.i145, align 4, !tbaa.struct !64
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end49
  ...
  %agg.tmp8.sroa.0.0.copyload = load i32, ptr %arrayidx.i78, align 4, !tbaa.struct !64
...
if.then.i99:                                      ; preds = %if.then18
  ...
  %call6.i97 = tail call ptr @realloc(ptr noundef %21, i64 noundef %mul5.i96) #23
...
for.body31:                                       ; preds = %for.cond27.preheader, %for.inc
  ...
  %agg.tmp32.sroa.0.0.copyload = load i32, ptr %arrayidx.i108, align 4, !tbaa.struct !64
...
; Function Attrs: uwtable
define dso_local void @_ZN6Solver8reduceDBEv(ptr nocapture noundef nonnull align 8 dereferenceable(536) %this) local_unnamed_addr #0 align 2 {
entry:
  %cla_inc = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 24
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %retval.sroa.0.0.copyload.i.i = load i32, ptr %arrayidx.i.i, align 4, !tbaa.struct !64
...
land.lhs.true29:                                  ; preds = %for.body24
  ...
  %retval.sroa.0.0.copyload.i.i85 = load i32, ptr %arrayidx.i.i84, align 4, !tbaa.struct !64
...
for.inc49:                                        ; preds = %if.then39, %if.else42
  ...
  br i1 %cmp23, label %for.body24, label %for.end51.loopexit, !llvm.loop !122

for.end51.loopexit:                               ; preds = %for.inc49
  %28 = trunc i64 %indvars.iv.next122 to i32
  br label %for.end51

for.end51:                                        ; preds = %for.end51.loopexit, %for.cond20.preheader
  %j.2.lcssa = phi i32 [ %j.0.lcssa, %for.cond20.preheader ], [ %j.3, %for.end51.loopexit ]
  %i.1.lcssa = phi i32 [ %i.0.lcssa, %for.cond20.preheader ], [ %28, %for.end51.loopexit ]
  %.lcssa = phi i32 [ %5, %for.cond20.preheader ], [ %26, %for.end51.loopexit ]
  %sub = sub nsw i32 %i.1.lcssa, %j.2.lcssa
  %cmp4.i = icmp sgt i32 %sub, 0
  br i1 %cmp4.i, label %for.body.lr.ph.i, label %_ZN3vecIP6ClauseE6shrinkEi.exit

for.body.lr.ph.i:                                 ; preds = %for.end51
  %29 = sub i32 %.lcssa, %sub
  store i32 %29, ptr %sz.i, align 8, !tbaa !35
  br label %_ZN3vecIP6ClauseE6shrinkEi.exit
...
for.body.lr.ph.i:                                 ; preds = %for.body
  ...
  %retval.sroa.0.0.copyload.i.i29 = load i32, ptr %arrayidx.i.i28, align 4, !tbaa.struct !64
...
for.cond.i:                                       ; preds = %for.body.lr.ph.i, %for.body.i
  ...
  br i1 %exitcond.not.i, label %_ZNK6Solver9satisfiedERK6Clause.exit, label %for.body.i, !llvm.loop !88
...
for.body.i:                                       ; preds = %for.cond.i
  ...
  %cmp.i.i = icmp eq i8 %retval.sroa.0.0.i.i.i, 1
  br i1 %cmp.i.i, label %_ZNK6Solver9satisfiedERK6Clause.exit, label %for.cond.i, !llvm.loop !88
...
; Function Attrs: uwtable
define dso_local noundef zeroext i1 @_ZN6Solver8simplifyEv(ptr noundef nonnull align 8 dereferenceable(536) %this) local_unnamed_addr #0 align 2 {
entry:
...
lor.lhs.false5:                                   ; preds = %if.end
  %simpDB_props = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 37
  %3 = load i64, ptr %simpDB_props, align 8, !tbaa !81
...
if.end11:                                         ; preds = %if.then10, %if.end8
  ...
  %add = add i64 %7, %6
  store i64 %add, ptr %simpDB_props, align 8, !tbaa !81
  br label %return
...
; Function Attrs: uwtable
define linkonce_odr dso_local void @_ZN4HeapIN6Solver10VarOrderLtEE6filterINS0_9VarFilterEEEvRKT_(ptr noundef nonnull align 8 dereferenceable(40) %this, ptr noundef nonnull align 8 dereferenceable(8) %filt) local_unnamed_addr #0 comdat align 2 {
entry:
...
; Function Attrs: uwtable
define dso_local i8 @_ZN6Solver6searchEii(ptr noundef nonnull align 8 dereferenceable(536) %this, i32 noundef %nof_conflicts, i32 noundef %nof_learnts) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %backtrack_level) #22
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %learnt_clause) #22
  ...
  %sz.i302 = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 38, i32 1
  %assumptions = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 38
  %cap.i.i315 = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 32, i32 2
...
lpad.loopexit:                                    ; preds = %if.then.i.i286
...
for.body.i:                                       ; preds = %_ZN6Solver14insertVarOrderEi.exit.i, %for.body.lr.ph.i
  ...
  %agg.tmp.sroa.0.0.copyload.i = load i32, ptr %arrayidx.i43.i, align 4, !tbaa.struct !64
...
_ZN6Solver14insertVarOrderEi.exit.i:              ; preds = %if.then.i.i, %land.lhs.true.i.i, %_ZNK4HeapIN6Solver10VarOrderLtEE6inHeapEi.exit.i.i
  ...
  br i1 %cmp4.not.not.i, label %for.body.i, label %for.cond.cleanup.loopexit.i, !llvm.loop !89
...
if.then14:                                        ; preds = %invoke.cont10
  ...
  %agg.tmp.sroa.0.0.copyload = load i32, ptr %24, align 4, !tbaa.struct !64
  %and.i.i = and i32 %agg.tmp.sroa.0.0.copyload, 1
  %tobool.i.not.i = icmp eq i32 %and.i.i, 0
  %conv2.i.i = select i1 %tobool.i.not.i, i8 1, i8 -1
...
if.then.i.i177:                                   ; preds = %if.then14
  ...
  %conv.i.i = zext i32 %add.i.i.i to i64
  %mul5.i.i = shl nuw nsw i64 %conv.i.i, 2
  %call6.i.i = call ptr @realloc(ptr noundef %31, i64 noundef %mul5.i.i) #23
  store ptr %call6.i.i, ptr %trail.i, align 8, !tbaa !39
...
if.else:                                          ; preds = %invoke.cont10
  ...
  %mul.i = shl nsw i64 %conv.i, 2
  %add.i = add nsw i64 %mul.i, 8
  %call1.i = call noalias ptr @malloc(i64 noundef %add.i) #24
...
for.body.lr.ph.i.i179:                            ; preds = %if.else
  ...
  %uglygep.i = getelementptr i8, ptr %call1.i, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %uglygep.i, ptr align 4 %32, i64 %mul.i, i1 false), !tbaa !61
...
if.then.i188:                                     ; preds = %invoke.cont19
  ...
  %call6.i = call ptr @realloc(ptr noundef %35, i64 noundef %mul5.i) #23
...
invoke.cont23:                                    ; preds = %for.cond.cleanup.i195, %invoke.cont21
  ...
  %agg.tmp24.sroa.0.0.copyload = load i32, ptr %49, align 4, !tbaa.struct !64
...
if.then.i.i227:                                   ; preds = %invoke.cont23
  ...
  %call6.i.i225 = call ptr @realloc(ptr noundef %56, i64 noundef %mul5.i.i224) #23
...
if.end29:                                         ; preds = %entry.if.end_crit_edge.i.i218, %if.then.i.i227, %if.then.i.i177, %entry.if.end_crit_edge.i.i
  %.sink474 = phi i32 [ %29, %entry.if.end_crit_edge.i.i ], [ %.pre10.i.i, %if.then.i.i177 ], [ %54, %entry.if.end_crit_edge.i.i218 ], [ %.pre10.i.i226, %if.then.i.i227 ]
  ...
  %inc.i.i = add nsw i32 %.sink474, 1
  store i32 %inc.i.i, ptr %sz.i.i169, align 8, !tbaa !40
  %idxprom.i26.i = sext i32 %.sink474 to i64
...
if.then35:                                        ; preds = %if.else32
  ...
  %cmp.not32.i = icmp slt i32 %63, 0
  br i1 %cmp.not32.i, label %invoke.cont36.thread, label %cond.end.peel.i

invoke.cont36.thread:                             ; preds = %if.then35
  %div19.i406 = fdiv double 0.000000e+00, %conv.i236
  %progress_estimate407 = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 41
  store double %div19.i406, ptr %progress_estimate407, align 8, !tbaa !135
  br label %cleanup138
...
cond.end.peel.i:                                  ; preds = %if.then35
  ...
  %conv16.peel.i = sitofp i32 %cond13.peel.i to double
  br i1 %cmp6.peel.i, label %invoke.cont36.thread451, label %cond.end.i

invoke.cont36.thread451:                          ; preds = %cond.end.peel.i
  %div19.i455 = fdiv double %conv16.peel.i, %conv.i236
  %progress_estimate456 = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 41
  store double %div19.i455, ptr %progress_estimate456, align 8, !tbaa !135
  br label %cleanup138

cond.end.i:                                       ; preds = %cond.end.peel.i, %cond.end.i
  %indvars.iv.i243 = phi i64 [ %indvars.iv.next.i246, %cond.end.i ], [ 1, %cond.end.peel.i ]
  %64 = phi i32 [ %71, %cond.end.i ], [ %63, %cond.end.peel.i ]
  %progress.034.i = phi double [ %70, %cond.end.i ], [ %conv16.peel.i, %cond.end.peel.i ]
  %65 = load ptr, ptr %trail_lim.i, align 8, !tbaa !45
  ...
  %arrayidx.i31.i = getelementptr inbounds i32, ptr %65, i64 %indvars.iv.i243
  %cond13.in.i = select i1 %cmp6.i, ptr %sz.i.i169, ptr %arrayidx.i31.i
  %cond13.i = load i32, ptr %cond13.in.i, align 4, !tbaa !61
  %69 = trunc i64 %indvars.iv.i243 to i32
  %conv.i.i245 = sitofp i32 %69 to double
  %call.i.i = call double @pow(double noundef %div.i, double noundef %conv.i.i245) #22
  %sub15.i = sub nsw i32 %cond13.i, %67
  %conv16.i = sitofp i32 %sub15.i to double
  %70 = call double @llvm.fmuladd.f64(double %call.i.i, double %conv16.i, double %progress.034.i)
...
invoke.cont36:                                    ; preds = %cond.end.i
  %.pre39.i.pre = load i32, ptr %sz.i.i.i235, align 8, !tbaa !43
  %.pre450 = sitofp i32 %.pre39.i.pre to double
  %73 = icmp sgt i32 %71, 0
  %div19.i = fdiv double %70, %.pre450
  %progress_estimate = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 41
  store double %div19.i, ptr %progress_estimate, align 8, !tbaa !135
  br i1 %73, label %if.then.i253, label %cleanup138

if.then.i253:                                     ; preds = %invoke.cont36
  %74 = load i32, ptr %sz.i.i169, align 8, !tbaa !40
  %75 = load ptr, ptr %trail_lim.i, align 8, !tbaa !45
  %76 = load i32, ptr %75, align 4, !tbaa !61
  %cmp4.not.not48.i252 = icmp sgt i32 %74, %76
  br i1 %cmp4.not.not48.i252, label %for.body.lr.ph.i259, label %for.cond.cleanup.i266

for.body.lr.ph.i259:                              ; preds = %if.then.i253
  %77 = sext i32 %74 to i64
  br label %for.body.i279

for.cond.cleanup.loopexit.i261:                   ; preds = %_ZN6Solver14insertVarOrderEi.exit.i288
  %.pre.i260 = load i32, ptr %sz.i.i169, align 8, !tbaa !40
  br label %for.cond.cleanup.i266

for.cond.cleanup.i266:                            ; preds = %for.cond.cleanup.loopexit.i261, %if.then.i253
  %78 = phi i32 [ %74, %if.then.i253 ], [ %.pre.i260, %for.cond.cleanup.loopexit.i261 ]
  %.lcssa46.i262 = phi ptr [ %75, %if.then.i253 ], [ %88, %for.cond.cleanup.loopexit.i261 ]
  %.lcssa.i263 = phi i32 [ %76, %if.then.i253 ], [ %89, %for.cond.cleanup.loopexit.i261 ]
  store i32 %.lcssa.i263, ptr %qhead.i, align 8, !tbaa !72
  %79 = load i32, ptr %.lcssa46.i262, align 4, !tbaa !61
  %cmp4.i.i265 = icmp sgt i32 %78, %79
  br i1 %cmp4.i.i265, label %for.body.lr.ph.i.i267, label %_ZN3vecI3LitE6shrinkEi.exit.i269

for.body.lr.ph.i.i267:                            ; preds = %for.cond.cleanup.i266
  store i32 %79, ptr %sz.i.i169, align 8, !tbaa !40
  br label %_ZN3vecI3LitE6shrinkEi.exit.i269

_ZN3vecI3LitE6shrinkEi.exit.i269:                 ; preds = %for.body.lr.ph.i.i267, %for.cond.cleanup.i266
  %80 = load i32, ptr %sz.i.i, align 8, !tbaa !46
  %cmp4.i38.i268 = icmp sgt i32 %80, 0
  br i1 %cmp4.i38.i268, label %for.body.lr.ph.i41.i270, label %cleanup138

for.body.lr.ph.i41.i270:                          ; preds = %_ZN3vecI3LitE6shrinkEi.exit.i269
  store i32 0, ptr %sz.i.i, align 8, !tbaa !46
  br label %cleanup138

for.body.i279:                                    ; preds = %_ZN6Solver14insertVarOrderEi.exit.i288, %for.body.lr.ph.i259
  %indvars.iv.i271 = phi i64 [ %77, %for.body.lr.ph.i259 ], [ %indvars.iv.next.i272, %_ZN6Solver14insertVarOrderEi.exit.i288 ]
  %indvars.iv.next.i272 = add nsw i64 %indvars.iv.i271, -1
  %81 = load ptr, ptr %trail.i, align 8, !tbaa !39
  %arrayidx.i43.i273 = getelementptr inbounds %class.Lit, ptr %81, i64 %indvars.iv.next.i272
  %agg.tmp.sroa.0.0.copyload.i274 = load i32, ptr %arrayidx.i43.i273, align 4, !tbaa.struct !64
  %shr.i.i275 = ashr i32 %agg.tmp.sroa.0.0.copyload.i274, 1
  %82 = load ptr, ptr %assigns.i, align 8, !tbaa !42
  %idxprom.i44.i276 = sext i32 %shr.i.i275 to i64
  %arrayidx.i45.i277 = getelementptr inbounds i8, ptr %82, i64 %idxprom.i44.i276
  store i8 0, ptr %arrayidx.i45.i277, align 1, !tbaa !60
  %83 = load i32, ptr %sz.i.i.i.i, align 8, !tbaa !46
  %cmp.i.i.i278 = icmp sgt i32 %83, %shr.i.i275
  br i1 %cmp.i.i.i278, label %_ZNK4HeapIN6Solver10VarOrderLtEE6inHeapEi.exit.i.i282, label %land.lhs.true.i.i285

_ZNK4HeapIN6Solver10VarOrderLtEE6inHeapEi.exit.i.i282: ; preds = %for.body.i279
  %84 = load ptr, ptr %indices.i.i.i, align 8, !tbaa !45
  %arrayidx.i.i.i.i280 = getelementptr inbounds i32, ptr %84, i64 %idxprom.i44.i276
  %85 = load i32, ptr %arrayidx.i.i.i.i280, align 4, !tbaa !61
  %cmp4.i.i.i281 = icmp sgt i32 %85, -1
  br i1 %cmp4.i.i.i281, label %_ZN6Solver14insertVarOrderEi.exit.i288, label %land.lhs.true.i.i285

land.lhs.true.i.i285:                             ; preds = %_ZNK4HeapIN6Solver10VarOrderLtEE6inHeapEi.exit.i.i282, %for.body.i279
  %86 = load ptr, ptr %decision_var.i.i, align 8, !tbaa !42
  %arrayidx.i.i.i283 = getelementptr inbounds i8, ptr %86, i64 %idxprom.i44.i276
  %87 = load i8, ptr %arrayidx.i.i.i283, align 1, !tbaa !60
  %tobool.not.i.i284 = icmp eq i8 %87, 0
  br i1 %tobool.not.i.i284, label %_ZN6Solver14insertVarOrderEi.exit.i288, label %if.then.i.i286

if.then.i.i286:                                   ; preds = %land.lhs.true.i.i285
  invoke void @_ZN4HeapIN6Solver10VarOrderLtEE6insertEi(ptr noundef nonnull align 8 dereferenceable(40) %order_heap.i.i, i32 noundef %shr.i.i275)
          to label %_ZN6Solver14insertVarOrderEi.exit.i288 unwind label %lpad.loopexit

_ZN6Solver14insertVarOrderEi.exit.i288:           ; preds = %if.then.i.i286, %land.lhs.true.i.i285, %_ZNK4HeapIN6Solver10VarOrderLtEE6inHeapEi.exit.i.i282
  %88 = load ptr, ptr %trail_lim.i, align 8, !tbaa !45
  %89 = load i32, ptr %88, align 4, !tbaa !61
  %90 = sext i32 %89 to i64
  %cmp4.not.not.i287 = icmp sgt i64 %indvars.iv.next.i272, %90
  br i1 %cmp4.not.not.i287, label %for.body.i279, label %for.cond.cleanup.loopexit.i261, !llvm.loop !89
...
lor.lhs.false.i:                                  ; preds = %land.lhs.true43
  ...
  %cmp.not.i292 = icmp eq ptr %call.i, null
  br i1 %cmp.not.i292, label %if.end.i, label %invoke.cont44
...
if.end.i:                                         ; preds = %lor.lhs.false.i
  ...
  %cmp6.i295 = icmp sgt i64 %95, 0
  %or.cond439 = select i1 %cmp4.i, i1 true, i1 %cmp6.i295
  br i1 %or.cond439, label %if.end47, label %if.end8.i
...
if.end11.i:                                       ; preds = %if.then10.i, %if.end8.i
  ...
  invoke void @_ZN4HeapIN6Solver10VarOrderLtEE6filterINS0_9VarFilterEEEvRKT_(ptr noundef nonnull align 8 dereferenceable(40) %order_heap.i.i, ptr noundef nonnull align 8 dereferenceable(8) %ref.tmp.i)
          to label %.noexc298 unwind label %lpad.loopexit.split-lp.loopexit.split-lp

.noexc298:                                        ; preds = %if.end11.i
  ...
  %add.i297 = add i64 %99, %98
  store i64 %add.i297, ptr %simpDB_props.i, align 8, !tbaa !81
  br label %if.end47
...
if.end47:                                         ; preds = %if.end.i, %.noexc298, %invoke.cont40
...
if.end58:                                         ; preds = %if.then56, %invoke.cont53, %if.end47
  ...
  %103 = load i32, ptr %sz.i302, align 8, !tbaa !40
  %cmp64438 = icmp slt i32 %102, %103
  br i1 %cmp64438, label %invoke.cont74, label %if.then110

invoke.cont74:                                    ; preds = %if.end58, %cleanup
  %104 = phi i32 [ %113, %cleanup ], [ %102, %if.end58 ]
  %105 = load ptr, ptr %assumptions, align 8, !tbaa !39
  %idxprom.i304 = sext i32 %104 to i64
  %arrayidx.i305 = getelementptr inbounds %class.Lit, ptr %105, i64 %idxprom.i304
  %p.sroa.0.0.copyload = load i32, ptr %arrayidx.i305, align 4, !tbaa.struct !64
  %shr.i.i307 = ashr i32 %p.sroa.0.0.copyload, 1
  %106 = load ptr, ptr %assigns.i, align 8, !tbaa !42
  %idxprom.i.i308 = sext i32 %shr.i.i307 to i64
  %arrayidx.i.i309 = getelementptr inbounds i8, ptr %106, i64 %idxprom.i.i308
  %107 = load i8, ptr %arrayidx.i.i309, align 1, !tbaa !60
  %and.i.i310 = and i32 %p.sroa.0.0.copyload, 1
  %tobool.i.not.i311 = icmp eq i32 %and.i.i310, 0
  %sub.i.i = sub i8 0, %107
  %retval.sroa.0.0.i.i = select i1 %tobool.i.not.i311, i8 %107, i8 %sub.i.i
...
if.then81:                                        ; preds = %invoke.cont74
  ...
  %109 = load i32, ptr %cap.i.i315, align 4, !tbaa !47
  %cmp.i.i316 = icmp eq i32 %104, %109
  br i1 %cmp.i.i316, label %if.then.i.i327, label %entry.if.end_crit_edge.i.i318

entry.if.end_crit_edge.i.i318:                    ; preds = %if.then81
  %.pre.i.i317 = load ptr, ptr %trail_lim.i, align 8, !tbaa !45
  br label %cleanup

if.then.i.i327:                                   ; preds = %if.then81
  %mul.i.i319 = mul nsw i32 %104, 3
  %add.i.i320 = add nsw i32 %mul.i.i319, 1
  %shr.i.i321 = ashr i32 %add.i.i320, 1
  %add.i.i.i322 = call i32 @llvm.smax.i32(i32 %shr.i.i321, i32 2)
  store i32 %add.i.i.i322, ptr %cap.i.i315, align 4, !tbaa !47
  %110 = load ptr, ptr %trail_lim.i, align 8, !tbaa !45
  %conv.i.i323 = zext i32 %add.i.i.i322 to i64
  %mul5.i.i324 = shl nuw nsw i64 %conv.i.i323, 2
  %call6.i.i325 = call ptr @realloc(ptr noundef %110, i64 noundef %mul5.i.i324) #23
  store ptr %call6.i.i325, ptr %trail_lim.i, align 8, !tbaa !45
  %.pre10.i.i326 = load i32, ptr %sz.i.i, align 8, !tbaa !46
  %.pre449 = sext i32 %.pre10.i.i326 to i64
  br label %cleanup
...
cleanup:                                          ; preds = %if.then.i.i327, %entry.if.end_crit_edge.i.i318
  %idxprom.i.i329.pre-phi = phi i64 [ %.pre449, %if.then.i.i327 ], [ %idxprom.i304, %entry.if.end_crit_edge.i.i318 ]
  %111 = phi i32 [ %.pre10.i.i326, %if.then.i.i327 ], [ %104, %entry.if.end_crit_edge.i.i318 ]
  %112 = phi ptr [ %call6.i.i325, %if.then.i.i327 ], [ %.pre.i.i317, %entry.if.end_crit_edge.i.i318 ]
  %inc.i.i328 = add nsw i32 %111, 1
  store i32 %inc.i.i328, ptr %sz.i.i, align 8, !tbaa !46
  %arrayidx.i.i330 = getelementptr inbounds i32, ptr %112, i64 %idxprom.i.i329.pre-phi
  store i32 %108, ptr %arrayidx.i.i330, align 4, !tbaa !61
  %113 = load i32, ptr %sz.i.i, align 8, !tbaa !46
  %114 = load i32, ptr %sz.i302, align 8, !tbaa !40
  %cmp64 = icmp slt i32 %113, %114
  br i1 %cmp64, label %invoke.cont74, label %if.then110

while.end:                                        ; preds = %invoke.cont74
  %cmp.i340 = icmp eq i32 %p.sroa.0.0.copyload, -2
  br i1 %cmp.i340, label %if.then110, label %if.end124
...
if.then110:                                       ; preds = %cleanup, %if.end58, %while.end
  ...
  %cmp.i341 = icmp eq i32 %call115, -2
  br i1 %cmp.i341, label %cleanup138, label %if.then110.if.end124_crit_edge

if.then110.if.end124_crit_edge:                   ; preds = %if.then110
  %.pre448 = load i32, ptr %sz.i.i, align 8, !tbaa !46
  br label %if.end124

if.end124:                                        ; preds = %if.then110.if.end124_crit_edge, %while.end
  %118 = phi i32 [ %.pre448, %if.then110.if.end124_crit_edge ], [ %104, %while.end ]
  ...
  %120 = load i32, ptr %cap.i.i315, align 4, !tbaa !47
  %cmp.i.i346 = icmp eq i32 %118, %120
  br i1 %cmp.i.i346, label %if.then.i.i357, label %entry.if.end_crit_edge.i.i348

entry.if.end_crit_edge.i.i348:                    ; preds = %if.end124
  %.pre.i.i347 = load ptr, ptr %trail_lim.i, align 8, !tbaa !45
  br label %invoke.cont125

if.then.i.i357:                                   ; preds = %if.end124
  %mul.i.i349 = mul nsw i32 %118, 3
  %add.i.i350 = add nsw i32 %mul.i.i349, 1
  %shr.i.i351 = ashr i32 %add.i.i350, 1
  %add.i.i.i352 = call i32 @llvm.smax.i32(i32 %shr.i.i351, i32 2)
  store i32 %add.i.i.i352, ptr %cap.i.i315, align 4, !tbaa !47
  %121 = load ptr, ptr %trail_lim.i, align 8, !tbaa !45
  %conv.i.i353 = zext i32 %add.i.i.i352 to i64
  %mul5.i.i354 = shl nuw nsw i64 %conv.i.i353, 2
  %call6.i.i355 = call ptr @realloc(ptr noundef %121, i64 noundef %mul5.i.i354) #23
  store ptr %call6.i.i355, ptr %trail_lim.i, align 8, !tbaa !45
  %.pre10.i.i356 = load i32, ptr %sz.i.i, align 8, !tbaa !46
  br label %invoke.cont125

invoke.cont125:                                   ; preds = %if.then.i.i357, %entry.if.end_crit_edge.i.i348
  %122 = phi i32 [ %118, %entry.if.end_crit_edge.i.i348 ], [ %.pre10.i.i356, %if.then.i.i357 ]
  %123 = phi ptr [ %.pre.i.i347, %entry.if.end_crit_edge.i.i348 ], [ %call6.i.i355, %if.then.i.i357 ]
  %inc.i.i358 = add nsw i32 %122, 1
  store i32 %inc.i.i358, ptr %sz.i.i, align 8, !tbaa !46
  %idxprom.i.i359 = sext i32 %122 to i64
  %arrayidx.i.i360 = getelementptr inbounds i32, ptr %123, i64 %idxprom.i.i359
  store i32 %119, ptr %arrayidx.i.i360, align 4, !tbaa !61
  %and.i.i362 = and i32 %next.sroa.0.3, 1
  %tobool.i.not.i363 = icmp eq i32 %and.i.i362, 0
  %conv2.i.i364 = select i1 %tobool.i.not.i363, i8 1, i8 -1
  %shr.i.i366 = ashr i32 %next.sroa.0.3, 1
  %124 = load ptr, ptr %assigns.i, align 8, !tbaa !42
  %idxprom.i.i367 = sext i32 %shr.i.i366 to i64
  %arrayidx.i.i368 = getelementptr inbounds i8, ptr %124, i64 %idxprom.i.i367
  store i8 %conv2.i.i364, ptr %arrayidx.i.i368, align 1, !tbaa !60
  %125 = load i32, ptr %sz.i.i, align 8, !tbaa !46
  %126 = load ptr, ptr %level.i209, align 8, !tbaa !45
  %arrayidx.i21.i371 = getelementptr inbounds i32, ptr %126, i64 %idxprom.i.i367
  store i32 %125, ptr %arrayidx.i21.i371, align 4, !tbaa !61
  %127 = load ptr, ptr %reason.i211, align 8, !tbaa !36
  %arrayidx.i24.i373 = getelementptr inbounds ptr, ptr %127, i64 %idxprom.i.i367
  store ptr null, ptr %arrayidx.i24.i373, align 8, !tbaa !33
  %128 = load i32, ptr %sz.i.i169, align 8, !tbaa !40
  %129 = load i32, ptr %cap.i.i215, align 4, !tbaa !41
  %cmp.i.i377 = icmp eq i32 %128, %129
  br i1 %cmp.i.i377, label %if.then.i.i388, label %entry.if.end_crit_edge.i.i379

entry.if.end_crit_edge.i.i379:                    ; preds = %invoke.cont125
  %.pre.i.i378 = load ptr, ptr %trail.i, align 8, !tbaa !39
  br label %cleanup129

if.then.i.i388:                                   ; preds = %invoke.cont125
  %mul.i.i380 = mul nsw i32 %128, 3
  %add.i.i381 = add nsw i32 %mul.i.i380, 1
  %shr.i25.i382 = ashr i32 %add.i.i381, 1
  %add.i.i.i383 = call i32 @llvm.smax.i32(i32 %shr.i25.i382, i32 2)
  store i32 %add.i.i.i383, ptr %cap.i.i215, align 4, !tbaa !41
  %130 = load ptr, ptr %trail.i, align 8, !tbaa !39
  %conv.i.i384 = zext i32 %add.i.i.i383 to i64
  %mul5.i.i385 = shl nuw nsw i64 %conv.i.i384, 2
  %call6.i.i386 = call ptr @realloc(ptr noundef %130, i64 noundef %mul5.i.i385) #23
  store ptr %call6.i.i386, ptr %trail.i, align 8, !tbaa !39
  %.pre10.i.i387 = load i32, ptr %sz.i.i169, align 8, !tbaa !40
  br label %cleanup129

cleanup129:                                       ; preds = %if.then.i.i388, %entry.if.end_crit_edge.i.i379
  %131 = phi i32 [ %128, %entry.if.end_crit_edge.i.i379 ], [ %.pre10.i.i387, %if.then.i.i388 ]
  %132 = phi ptr [ %.pre.i.i378, %entry.if.end_crit_edge.i.i379 ], [ %call6.i.i386, %if.then.i.i388 ]
  %inc.i.i389 = add nsw i32 %131, 1
  store i32 %inc.i.i389, ptr %sz.i.i169, align 8, !tbaa !40
  %idxprom.i26.i390 = sext i32 %131 to i64
  %arrayidx.i27.i391 = getelementptr inbounds %class.Lit, ptr %132, i64 %idxprom.i26.i390
  store i32 %next.sroa.0.3, ptr %arrayidx.i27.i391, align 4, !tbaa !61
...
_ZN3vecI3LitED2Ev.exit:                           ; preds = %lpad, %for.cond.preheader.i.i
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %learnt_clause) #22
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %backtrack_level) #22
  resume { ptr, i32 } %lpad.phi

cleanup138:                                       ; preds = %if.then110, %invoke.cont4, %invoke.cont36.thread451, %invoke.cont99, %invoke.cont44, %invoke.cont36.thread, %invoke.cont36, %_ZN3vecI3LitE6shrinkEi.exit.i269, %for.body.lr.ph.i41.i270
  %retval.sroa.0.6.ph = phi i8 [ 0, %for.body.lr.ph.i41.i270 ], [ 0, %_ZN3vecI3LitE6shrinkEi.exit.i269 ], [ 0, %invoke.cont36 ], [ 0, %invoke.cont36.thread ], [ -1, %invoke.cont44 ], [ -1, %invoke.cont99 ], [ 0, %invoke.cont36.thread451 ], [ 1, %if.then110 ], [ -1, %invoke.cont4 ]
  %cmp.not.i.i394 = icmp eq ptr %.ph, null
  br i1 %cmp.not.i.i394, label %_ZN3vecI3LitED2Ev.exit398, label %for.cond.preheader.i.i397

for.cond.preheader.i.i397:                        ; preds = %cleanup138
  store i32 0, ptr %sz.le.i, align 8, !tbaa !40
  call void @free(ptr noundef nonnull %.ph) #22
  br label %_ZN3vecI3LitED2Ev.exit398

_ZN3vecI3LitED2Ev.exit398:                        ; preds = %cleanup138, %for.cond.preheader.i.i397
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %learnt_clause) #22
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %backtrack_level) #22
...
define dso_local noundef double @_ZNK6Solver16progressEstimateEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(536) %this) local_unnamed_addr #10 align 2 {
entry:
  %sz.i.i = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 28, i32 1
  %0 = load i32, ptr %sz.i.i, align 8, !tbaa !43
  %conv = sitofp i32 %0 to double
  %div = fdiv double 1.000000e+00, %conv
  %sz.i.i27 = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 32, i32 1
  %1 = load i32, ptr %sz.i.i27, align 8, !tbaa !46
  %cmp.not32 = icmp slt i32 %1, 0
  br i1 %cmp.not32, label %for.cond.cleanup, label %cond.end.peel
...
cond.end.peel:                                    ; preds = %entry
  ...
  %conv16.peel = sitofp i32 %cond13.peel to double
  %2 = load i32, ptr %sz.i.i27, align 8, !tbaa !46
...
for.cond.cleanup.loopexit:                        ; preds = %cond.end, %cond.end.peel
  %.lcssa = phi double [ %conv16.peel, %cond.end.peel ], [ %9, %cond.end ]
  %.pre39 = load i32, ptr %sz.i.i, align 8, !tbaa !43
  %.pre40 = sitofp i32 %.pre39 to double
  br label %for.cond.cleanup

for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %entry
  %conv18.pre-phi = phi double [ %.pre40, %for.cond.cleanup.loopexit ], [ %conv, %entry ]
...
cond.end:                                         ; preds = %cond.end.peel, %cond.end
  ...
  %progress.034 = phi double [ %9, %cond.end ], [ %conv16.peel, %cond.end.peel ]
  %4 = load ptr, ptr %trail_lim, align 8, !tbaa !45
  ...
  %arrayidx.i31 = getelementptr inbounds i32, ptr %4, i64 %indvars.iv
  %cond13.in = select i1 %cmp6, ptr %sz.i, ptr %arrayidx.i31
  %cond13 = load i32, ptr %cond13.in, align 4, !tbaa !61
  %8 = trunc i64 %indvars.iv to i32
  %conv.i = sitofp i32 %8 to double
  %call.i = tail call double @pow(double noundef %div, double noundef %conv.i) #22
  %sub15 = sub nsw i32 %cond13, %6
  %conv16 = sitofp i32 %sub15 to double
  %9 = tail call double @llvm.fmuladd.f64(double %call.i, double %conv16, double %progress.034)
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %10 = load i32, ptr %sz.i.i27, align 8, !tbaa !46
  %11 = sext i32 %10 to i64
...
; Function Attrs: uwtable
define dso_local noundef zeroext i1 @_ZN6Solver5solveERK3vecI3LitE(ptr noundef nonnull align 8 dereferenceable(536) %this, ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) %assumps) local_unnamed_addr #0 align 2 {
entry:
...
if.end11.i.i.i:                                   ; preds = %do.body.i.i.i, %if.then4.i.i.i
  ...
  %conv.i.i.i = sext i32 %storemerge.i.i.i to i64
  %mul13.i.i.i = shl nsw i64 %conv.i.i.i, 2
  %call.i.i.i = tail call ptr @realloc(ptr noundef %3, i64 noundef %mul13.i.i.i) #23
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> <i32 -2, i32 -2, i32 -2, i32 -2>, ptr %11, align 4, !tbaa !73
  %12 = getelementptr inbounds i32, ptr %11, i64 4
  store <4 x i32> <i32 -2, i32 -2, i32 -2, i32 -2>, ptr %12, align 4, !tbaa !73
  %index.next = add nuw i64 %index, 8
...
for.body.i.i:                                     ; preds = %for.body.i.i.preheader, %for.body.i.i
  ...
  store i32 -2, ptr %arrayidx.i.i, align 4, !tbaa !73
  %indvars.iv.next.i.i = add nsw i64 %indvars.iv.i.i, 1
  %exitcond.not.i.i = icmp eq i64 %indvars.iv.next.i.i, %wide.trip.count.i.i
...
if.end11.i.i:                                     ; preds = %do.body.i.i, %if.then4.i.i
  ...
  %call.i.i = tail call ptr @realloc(ptr noundef %28, i64 noundef %conv.i.i) #23
...
for.body.lr.ph.i49:                               ; preds = %_ZN3vecI5lboolE4growEi.exit.i
  ...
  %uglygep.i = getelementptr i8, ptr %30, i64 %31
  %32 = xor i32 %29, -1
  %33 = add i32 %25, %32
  %34 = zext i32 %33 to i64
  %35 = add nuw nsw i64 %34, 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %uglygep.i, i8 0, i64 %35, i1 false), !tbaa !145
  br label %for.cond.cleanup.i
...
_ZN6Solver14insertVarOrderEi.exit.i:              ; preds = %if.then.i.i, %land.lhs.true.i.i, %_ZNK4HeapIN6Solver10VarOrderLtEE6inHeapEi.exit.i.i
  ...
  br i1 %cmp4.not.not.i, label %for.body.i64, label %for.cond.cleanup.loopexit.i, !llvm.loop !89
...
define dso_local void @_ZN6Solver11verifyModelEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(536) %this) local_unnamed_addr #12 align 2 {
entry:
  %clauses = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 22
...
for.cond.cleanup:                                 ; preds = %next, %entry
  ...
  %3 = load i32, ptr %sz.i, align 8, !tbaa !35
  %call30 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %2, ptr noundef nonnull @.str.6, i32 noundef %3) #25
...
for.body8:                                        ; preds = %for.body8.lr.ph, %for.cond4
  ...
  %agg.tmp.sroa.0.0.copyload = load i32, ptr %arrayidx.i40, align 4, !tbaa.struct !64
  %shr.i.i = ashr i32 %agg.tmp.sroa.0.0.copyload, 1
  %idxprom.i.i = sext i32 %shr.i.i to i64
...
for.end:                                          ; preds = %for.cond4, %for.body
  ...
  %13 = tail call i64 @fwrite(ptr nonnull @.str, i64 20, i64 1, ptr %12) #25
...
for.body.i:                                       ; preds = %for.end, %for.body.i
  ...
  %retval.sroa.0.0.copyload.i.i = load i32, ptr %arrayidx.i.i43, align 4, !tbaa.struct !64
  ...
  %call24.i.i = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %19, ptr noundef nonnull @.str.9, ptr noundef nonnull %cond.i.i, i32 noundef %add.i.i, i32 noundef %cond23.i.i) #25
...
define dso_local void @_ZN6Solver17checkLiteralCountEv(ptr nocapture noundef nonnull readonly align 8 dereferenceable(536) %this) local_unnamed_addr #14 align 2 {
entry:
  %sz.i = getelementptr inbounds %class.Solver, ptr %this, i64 0, i32 22, i32 1
  %0 = load i32, ptr %sz.i, align 8, !tbaa !35
...
if.then10:                                        ; preds = %for.cond.cleanup
  ...
  %call13 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %13, ptr noundef nonnull @.str.7, i32 noundef %conv, i32 noundef %cnt.0.lcssa) #25
  br label %if.end14
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_ZN4HeapIN6Solver10VarOrderLtEE6insertEi(ptr noundef nonnull align 8 dereferenceable(40) %this, i32 noundef %n) local_unnamed_addr #9 comdat align 2 {
entry:
  %indices = getelementptr inbounds %class.Heap, ptr %this, i64 0, i32 2
  %add = add nsw i32 %n, 1
...
if.end11.i.i:                                     ; preds = %do.body.i.i, %if.then4.i.i
  ...
  %call.i.i = tail call ptr @realloc(ptr noundef %2, i64 noundef %mul13.i.i) #23
...
for.body.lr.ph.i:                                 ; preds = %_ZN3vecIiE4growEi.exit.i
  ...
  tail call void @llvm.memset.p0.i64(ptr align 4 %uglygep, i8 -1, i64 %10, i1 false), !tbaa !61
  br label %for.cond.cleanup.i
...
_ZN3vecIiE6growToEiRKi.exit:                      ; preds = %entry, %for.cond.cleanup.i
  ...
  %12 = load ptr, ptr %indices, align 8, !tbaa !45
  %idxprom.i = sext i32 %n to i64
  %arrayidx.i8 = getelementptr inbounds i32, ptr %12, i64 %idxprom.i
  store i32 %11, ptr %arrayidx.i8, align 4, !tbaa !61
  %13 = load i32, ptr %sz.i7, align 8, !tbaa !46
  %cap.i = getelementptr inbounds %class.Heap, ptr %this, i64 0, i32 1, i32 2
  %14 = load i32, ptr %cap.i, align 4, !tbaa !47
...
if.then.i:                                        ; preds = %_ZN3vecIiE6growToEiRKi.exit
  ...
  %15 = load ptr, ptr %heap, align 8, !tbaa !45
  %conv.i = zext i32 %add.i.i11 to i64
  %mul5.i = shl nuw nsw i64 %conv.i, 2
  %call6.i = tail call ptr @realloc(ptr noundef %15, i64 noundef %mul5.i) #23
  store ptr %call6.i, ptr %heap, align 8, !tbaa !45
  %.pre10.i = load i32, ptr %sz.i7, align 8, !tbaa !46
  %.pre = load ptr, ptr %indices, align 8, !tbaa !45
  br label %_ZN3vecIiE4pushERKi.exit

_ZN3vecIiE4pushERKi.exit:                         ; preds = %entry.if.end_crit_edge.i, %if.then.i
  %16 = phi ptr [ %12, %entry.if.end_crit_edge.i ], [ %.pre, %if.then.i ]
  %17 = phi i32 [ %13, %entry.if.end_crit_edge.i ], [ %.pre10.i, %if.then.i ]
  %18 = phi ptr [ %.pre.i10, %entry.if.end_crit_edge.i ], [ %call6.i, %if.then.i ]
  %inc.i = add nsw i32 %17, 1
  store i32 %inc.i, ptr %sz.i7, align 8, !tbaa !46
  %idxprom.i12 = sext i32 %17 to i64
  %arrayidx.i13 = getelementptr inbounds i32, ptr %18, i64 %idxprom.i12
  store i32 %n, ptr %arrayidx.i13, align 4, !tbaa !61
  %arrayidx.i16 = getelementptr inbounds i32, ptr %16, i64 %idxprom.i
  %19 = load i32, ptr %arrayidx.i16, align 4, !tbaa !61
  %idxprom.i.i = sext i32 %19 to i64
  %arrayidx.i.i = getelementptr inbounds i32, ptr %18, i64 %idxprom.i.i
  %20 = load i32, ptr %arrayidx.i.i, align 4, !tbaa !61
  %cmp.not52.i = icmp eq i32 %19, 0
  %.pre56.i = sext i32 %20 to i64
...
land.rhs.lr.ph.i:                                 ; preds = %_ZN3vecIiE4pushERKi.exit
  %21 = load ptr, ptr %this, align 8, !tbaa !97
  %22 = load ptr, ptr %21, align 8, !tbaa !53
  %arrayidx.i.i.i = getelementptr inbounds double, ptr %22, i64 %.pre56.i
  %23 = load double, ptr %arrayidx.i.i.i, align 8, !tbaa !5
  br label %land.rhs.i

land.rhs.i:                                       ; preds = %while.body.i, %land.rhs.lr.ph.i
  %i.addr.053.i = phi i32 [ %19, %land.rhs.lr.ph.i ], [ %shr.i.i18, %while.body.i ]
  %sub.i.i = add nsw i32 %i.addr.053.i, -1
  %shr.i.i18 = ashr i32 %sub.i.i, 1
  %idxprom.i32.i = sext i32 %shr.i.i18 to i64
  %arrayidx.i33.i = getelementptr inbounds i32, ptr %18, i64 %idxprom.i32.i
  %24 = load i32, ptr %arrayidx.i33.i, align 4, !tbaa !61
  %idxprom.i4.i.i = sext i32 %24 to i64
  %arrayidx.i5.i.i = getelementptr inbounds double, ptr %22, i64 %idxprom.i4.i.i
  %25 = load double, ptr %arrayidx.i5.i.i, align 8, !tbaa !5
  %cmp.i.i = fcmp ogt double %23, %25
  %idxprom.i40.i = sext i32 %i.addr.053.i to i64
  %arrayidx.i41.i = getelementptr inbounds i32, ptr %18, i64 %idxprom.i40.i
  br i1 %cmp.i.i, label %while.body.i, label %_ZN4HeapIN6Solver10VarOrderLtEE11percolateUpEi.exit

while.body.i:                                     ; preds = %land.rhs.i
  store i32 %24, ptr %arrayidx.i41.i, align 4, !tbaa !61
...
_ZN4HeapIN6Solver10VarOrderLtEE11percolateUpEi.exit: ; preds = %while.body.i, %land.rhs.i, %_ZN3vecIiE4pushERKi.exit
  ...
  %phi.call.i = phi ptr [ %18, %_ZN3vecIiE4pushERKi.exit ], [ %18, %while.body.i ], [ %arrayidx.i41.i, %land.rhs.i ]
  store i32 %20, ptr %phi.call.i, align 4, !tbaa !61
...
; Function Attrs: uwtable
define linkonce_odr dso_local void @_Z4sortI3Lit16LessThan_defaultIS0_EEvPT_iT0_(ptr noundef %array, i32 noundef %size) local_unnamed_addr #0 comdat {
entry:
...
for.body3.i:                                      ; preds = %for.body.i, %for.body3.i
  ...
  %agg.tmp.sroa.0.0.copyload.i = load i32, ptr %arrayidx.i, align 4, !tbaa.struct !64
  %idxprom5.i = sext i32 %best_i.036.i to i64
  %arrayidx6.i = getelementptr inbounds %class.Lit, ptr %array.tr.lcssa, i64 %idxprom5.i
  %agg.tmp4.sroa.0.0.copyload.i = load i32, ptr %arrayidx6.i, align 4, !tbaa.struct !64
...
if.else:                                          ; preds = %entry, %for.end
  ...
  %pivot.sroa.0.0.copyload = load i32, ptr %arrayidx, align 4, !tbaa.struct !64
  br label %for.cond
...
do.body:                                          ; preds = %do.body, %for.cond
  ...
  %agg.tmp1.sroa.0.0.copyload = load i32, ptr %arrayidx3, align 4, !tbaa.struct !64
...
do.body6:                                         ; preds = %do.body6.preheader, %do.body6
  ...
  %agg.tmp9.sroa.0.0.copyload = load i32, ptr %arrayidx11, align 4, !tbaa.struct !64
...
for.end:                                          ; preds = %do.end15
  ...
  tail call void @_Z4sortI3Lit16LessThan_defaultIS0_EEvPT_iT0_(ptr noundef nonnull %array.tr59, i32 noundef %9)
  %sub = sub nsw i32 %size.tr60, %9
...
; Function Attrs: mustprogress uwtable
define linkonce_odr dso_local void @_Z4sortIP6Clause11reduceDB_ltEvPT_iT0_(ptr noundef %array, i32 noundef %size) local_unnamed_addr #9 comdat {
entry:
...
attributes #14 = { mustprogress nofree nounwind uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
