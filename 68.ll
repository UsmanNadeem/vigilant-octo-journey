...
if.then26:                                        ; preds = %for.cond.i, %for.cond.i.1, %for.body.i.2, %for.cond.preheader.i, %if.end10.i, %for.inc31.i, %for.inc31.1.i, %for.inc31.2.i, %for.inc31.3.i, %if.else.4.i
  %free_znodes.i = getelementptr inbounds %struct.Parser, ptr %p, i64 0, i32 23
  %36 = load ptr, ptr %free_znodes.i, align 8, !tbaa !137
  %tobool.not.i271 = icmp eq ptr %36, null
...
if.else.i272:                                     ; preds = %if.then26
  ...
  store ptr %37, ptr %free_znodes.i, align 8, !tbaa !137
  br label %new_ZNode.exit

new_ZNode.exit:                                   ; preds = %if.then.i, %if.else.i272
  %z.0.i = phi ptr [ %36, %if.else.i272 ], [ %call.i, %if.then.i ]
  ...
  %40 = load i32, ptr %reductions292, align 8, !tbaa !255
...
for.body:                                         ; preds = %new_ZNode.exit, %for.inc
  ...
  %42 = load ptr, ptr %v, align 8, !tbaa !256
...
for.inc:                                          ; preds = %for.body, %if.then37
  ...
  %46 = load i32, ptr %reductions, align 8, !tbaa !255
...
for.end:                                          ; preds = %for.inc, %new_ZNode.exit
  ...
  %49 = load ptr, ptr %shift, align 8, !tbaa !259
...
for.cond48.preheader:                             ; preds = %for.end
  ...
  %50 = load i32, ptr %right_epsilon_hints297, align 8, !tbaa !316
...
for.body53:                                       ; preds = %for.body53.lr.ph, %cleanup
  ...
  %54 = load ptr, ptr %v56, align 8, !tbaa !317
  ...
  %55 = load i16, ptr %preceeding_state, align 2, !tbaa !318
  ...
  %tobool.not.i273 = icmp eq ptr %58, null
...
if.then.i276:                                     ; preds = %for.body53
  ...
  %add.i274 = add i32 %shl.i, %60
  %61 = ptrtoint ptr %57 to i64
  %62 = trunc i64 %61 to i32
  %add1.i = add i32 %add.i274, %62
  %63 = load i32, ptr %m.i, align 4, !tbaa !41
  %rem.i = urem i32 %add1.i, %63
  %idxprom.i = zext i32 %rem.i to i64
  %arrayidx.i275 = getelementptr inbounds ptr, ptr %58, i64 %idxprom.i
...
for.cond66.preheader:                             ; preds = %land.lhs.true9.i
  ...
  %69 = load i32, ptr %zns67, align 8, !tbaa !157
...
for.body71:                                       ; preds = %for.body71.lr.ph, %for.inc89
  ...
  %70 = load ptr, ptr %v73, align 8, !tbaa !158
...
if.then77:                                        ; preds = %for.body71
  %72 = load ptr, ptr %reduction, align 8, !tbaa !320
...
if.then84:                                        ; preds = %if.then77
  ...
  %73 = load i16, ptr %arrayidx58, align 8, !tbaa !321
...
for.inc89:                                        ; preds = %if.then77, %if.then84, %for.body71
  ...
  %74 = load i32, ptr %zns67, align 8, !tbaa !157
...
cleanup:                                          ; preds = %for.inc.i, %cleanup.loopexit, %for.cond66.preheader, %if.then.i276, %for.body53
  %76 = phi ptr [ %.pre317, %cleanup.loopexit ], [ %53, %for.cond66.preheader ], [ %53, %if.then.i276 ], [ %53, %for.body53 ], [ %53, %for.inc.i ]
  %indvars.iv.next312 = add nuw nsw i64 %indvars.iv311, 1
  %right_epsilon_hints = getelementptr inbounds %struct.D_State, ptr %76, i64 0, i32 3
  %77 = load i32, ptr %right_epsilon_hints, align 8, !tbaa !316
...
if.end96:                                         ; preds = %for.body.lr.ph.i, %for.body.i.1, %for.body.i.2, %cleanup, %for.body53.lr.ph, %for.cond48.preheader, %if.else.4.i, %if.else.3.i, %if.else.2.i, %if.else.1.i, %if.else.i, %for.end
  ...
  %79 = load i32, ptr %sns, align 8, !tbaa !170
...
do.body174:                                       ; preds = %do.end170
  ...
  %81 = load i32, ptr %refcount175, align 8, !tbaa !100
  %inc176 = add i32 %81, 1
