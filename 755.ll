; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/interp.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/interp.c"
...
for.body:                                         ; preds = %entry, %for.body
  %op.018 = phi ptr [ @ostack, %entry ], [ %incdec.ptr, %for.body ]
  store i16 0, ptr %op.018, align 8, !tbaa !9
  %type_attrs = getelementptr inbounds %struct.ref_s, ptr %op.018, i64 0, i32 1
  store i16 -4, ptr %type_attrs, align 8, !tbaa !10
  %incdec.ptr = getelementptr inbounds %struct.ref_s, ptr %op.018, i64 1
  %cmp = icmp ult ptr %incdec.ptr, getelementptr inbounds ([520 x %struct.ref_s], ptr @ostack, i64 0, i64 10)
  br i1 %cmp, label %for.body, label %for.body4.preheader, !llvm.loop !13
...
entry:
  ...
  br i1 %cmp1.not, label %if.then, label %while.cond.1, !llvm.loop !15
...
while.cond.1:                                     ; preds = %entry
  ...
  br i1 %cmp1.not.1, label %if.then, label %while.cond.2, !llvm.loop !15
...
while.cond.2:                                     ; preds = %while.cond.1
  ...
  br i1 %cmp1.not.2, label %if.then, label %while.cond.3, !llvm.loop !15
...
while.cond.3:                                     ; preds = %while.cond.2
  ...
  br i1 %cmp1.not.3, label %if.then, label %while.cond.4, !llvm.loop !15
...
while.cond.4:                                     ; preds = %while.cond.3
  ...
  br i1 %cmp1.not.4, label %if.then, label %while.cond.5, !llvm.loop !15
...
while.cond.5:                                     ; preds = %while.cond.4
  ...
  br i1 %cmp1.not.5, label %if.then, label %while.cond.6, !llvm.loop !15

while.cond.6:                                     ; preds = %while.cond.5
  %7 = load ptr, ptr @special_ops, align 16, !tbaa !5
  %cmp1.not.6 = icmp eq ptr %0, %7
  br i1 %cmp1.not.6, label %if.then, label %if.end, !llvm.loop !15
...
lor.lhs.false14:                                  ; preds = %sw.epilog
  ...
  %7 = load i16, ptr %size, align 2, !tbaa !16
...
if.end26:                                         ; preds = %if.end18
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %erref, ptr noundef nonnull align 8 dereferenceable(16) %10, i64 16, i1 false), !tbaa.struct !17
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %incdec.ptr27, ptr noundef nonnull align 8 dereferenceable(16) @error_object, i64 16, i1 false), !tbaa.struct !17
...
if.then:                                          ; preds = %entry
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) @error_object, ptr noundef nonnull align 8 dereferenceable(16) %pref, i64 16, i1 false), !tbaa.struct !17
  br label %cleanup400

if.end:                                           ; preds = %entry
  %incdec.ptr = getelementptr inbounds %struct.ref_s, ptr %1, i64 1
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %incdec.ptr, ptr noundef nonnull align 8 dereferenceable(16) %pref, i64 16, i1 false), !tbaa.struct !17
...
sw.bb:                                            ; preds = %top, %top, %top, %top, %top, %top, %top, %top, %top, %top
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) @error_object, ptr noundef nonnull align 8 dereferenceable(16) %iref.0, i64 16, i1 false), !tbaa.struct !17
  br label %cleanup400
...
if.end16:                                         ; preds = %sw.bb12
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %incdec.ptr17, ptr noundef nonnull align 8 dereferenceable(16) %iosp.0, i64 16, i1 false), !tbaa.struct !17
...
if.end29:                                         ; preds = %sw.bb25
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %token, ptr noundef nonnull align 8 dereferenceable(16) %iosp.0, i64 16, i1 false), !tbaa.struct !17
  %arrayidx31 = getelementptr inbounds %struct.ref_s, ptr %iosp.0, i64 -1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %iosp.0, ptr noundef nonnull align 8 dereferenceable(16) %arrayidx31, i64 16, i1 false), !tbaa.struct !17
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx31, ptr noundef nonnull align 8 dereferenceable(16) %token, i64 16, i1 false), !tbaa.struct !17
...
cond.true:                                        ; preds = %if.end51
  ...
  store i16 %conv55, ptr %size, align 2, !tbaa !16
  br label %cond.end
...
sw.default:                                       ; preds = %cond.end
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %arrayidx70, ptr noundef nonnull align 8 dereferenceable(16) %cond66, i64 16, i1 false), !tbaa.struct !17
  br label %top.backedge
...
sw.epilog:                                        ; preds = %cond.end, %cond.end
  ...
  %12 = load i16, ptr %size76, align 2, !tbaa !16
...
if.else86:                                        ; preds = %sw.epilog
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %incdec.ptr87, ptr noundef nonnull align 8 dereferenceable(16) %cond66, i64 16, i1 false), !tbaa.struct !17
  br label %top.backedge
...
sw.bb158:                                         ; preds = %sw.bb131
  ...
  %18 = load i16, ptr %size160, align 2, !tbaa !16
...
sw.bb175:                                         ; preds = %top
  ...
  %20 = load ptr, ptr %pvalue177, align 8, !tbaa !23
...
cond.true196:                                     ; preds = %sw.bb193
  ...
  store i16 %conv199, ptr %size200, align 2, !tbaa !16
...
if.then207:                                       ; preds = %cond.end203
  store ptr %iesp.0, ptr @esp, align 8, !tbaa !5
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) @error_object, ptr noundef nonnull align 8 dereferenceable(16) %pvalue.1, i64 16, i1 false), !tbaa.struct !17
  br label %cleanup400

if.end208:                                        ; preds = %cond.end203
  %incdec.ptr209 = getelementptr inbounds %struct.ref_s, ptr %iesp.0, i64 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %incdec.ptr209, ptr noundef nonnull align 8 dereferenceable(16) %pvalue.1, i64 16, i1 false), !tbaa.struct !17
  %25 = load ptr, ptr %pvalue.1, align 8, !tbaa !9
  %size211 = getelementptr inbounds %struct.ref_s, ptr %pvalue.1, i64 0, i32 2
  %26 = load i16, ptr %size211, align 2, !tbaa !16
...
sw.bb249:                                         ; preds = %sw.bb222
  ...
  %31 = load i16, ptr %size251, align 2, !tbaa !16
...
if.end271:                                        ; preds = %sw.bb267
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %incdec.ptr272, ptr noundef nonnull align 8 dereferenceable(16) %pvalue.1, i64 16, i1 false), !tbaa.struct !17
...
cond.true282:                                     ; preds = %sw.default279
  ...
  store i16 %conv285, ptr %size286, align 2, !tbaa !16
  br label %top.backedge
...
up.preheader.sink.split:                          ; preds = %if.then231, %if.then140
  ...
  store i16 %conv237, ptr %size238, align 2, !tbaa !16
...
cond.true303:                                     ; preds = %sw.bb300
  ...
  store i16 %conv306, ptr %size307, align 2, !tbaa !16
...
cleanup324.thread946:                             ; preds = %cond.end310
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %incdec.ptr316, ptr noundef nonnull align 8 dereferenceable(16) %iref.0, i64 16, i1 false), !tbaa.struct !17
...
sw.bb326:                                         ; preds = %top
  ...
  %37 = load i16, ptr %size328, align 2, !tbaa !16
...
cond.true334:                                     ; preds = %sw.bb331
  ...
  store i16 %conv337, ptr %size338, align 2, !tbaa !16
...
cleanup360.thread951:                             ; preds = %cond.end341
  ...
  %40 = load ptr, ptr %ss, align 8, !tbaa !25
  %add.ptr350 = getelementptr inbounds i8, ptr %40, i64 1
  store ptr %add.ptr350, ptr %incdec.ptr347, align 8, !tbaa !9
  %41 = load ptr, ptr %cbuf, align 8, !tbaa !29
  %42 = load i32, ptr %bsize, align 8, !tbaa !30
  ...
  store i16 %conv356, ptr %size357, align 2, !tbaa !16
...
if.end366:                                        ; preds = %sw.epilog362
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %incdec.ptr367, ptr noundef nonnull align 8 dereferenceable(16) %iref.0, i64 16, i1 false), !tbaa.struct !17
  br label %bot.backedge
...
sw.epilog386:                                     ; preds = %up, %up
  ...
  %46 = load i16, ptr %size388, align 2, !tbaa !16
