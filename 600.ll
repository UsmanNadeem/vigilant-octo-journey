; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/lua/ldebug.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/lua/ldebug.c"
...
auxgetinfo.exit:                                  ; preds = %for.inc.i, %for.cond.preheader.i
  ...
  %call13 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %what.addr.0, i32 noundef 102) #11
  %tobool14.not = icmp eq ptr %call13, null
  br i1 %tobool14.not, label %cond.false38.thread, label %if.else20

auxgetinfo.exit.thread:                           ; preds = %if.end11, %if.else
  %what.addr.078 = phi ptr [ %what.addr.0, %if.end11 ], [ %what, %if.else ]
  ...
  %call1386 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %what.addr.078, i32 noundef 102) #11
  %tobool14.not87 = icmp eq ptr %call1386, null
  br i1 %tobool14.not87, label %cond.false38, label %if.then18

if.then18:                                        ; preds = %auxgetinfo.exit.thread
  %top19 = getelementptr inbounds %struct.lua_State, ptr %L, i64 0, i32 4
  %51 = load ptr, ptr %top19, align 8, !tbaa !34
  %tt = getelementptr inbounds %struct.lua_TValue, ptr %51, i64 0, i32 1
  store i32 0, ptr %tt, align 8, !tbaa !27
  br label %if.end24

if.else20:                                        ; preds = %auxgetinfo.exit
  %top21 = getelementptr inbounds %struct.lua_State, ptr %L, i64 0, i32 4
  %52 = load ptr, ptr %top21, align 8, !tbaa !34
  store ptr %f.0, ptr %52, align 8, !tbaa !21
  %tt23 = getelementptr inbounds %struct.lua_TValue, ptr %52, i64 0, i32 1
  store i32 6, ptr %tt23, align 8, !tbaa !27
  %.pre = load ptr, ptr %top21, align 8, !tbaa !34
  br label %if.end24

if.end24:                                         ; preds = %if.else20, %if.then18
  %cmp.i7988106 = phi i1 [ false, %if.else20 ], [ true, %if.then18 ]
  %what.addr.07790104 = phi ptr [ %what.addr.0, %if.else20 ], [ %what.addr.078, %if.then18 ]
  %f.07492102 = phi ptr [ %f.0, %if.else20 ], [ null, %if.then18 ]
  %retval.0.i94100 = phi i32 [ %retval.0.i, %if.else20 ], [ 1, %if.then18 ]
  %53 = phi ptr [ %.pre, %if.else20 ], [ %51, %if.then18 ]
  %stack_last = getelementptr inbounds %struct.lua_State, ptr %L, i64 0, i32 9
  %54 = load ptr, ptr %stack_last, align 8, !tbaa !49
  %top25 = getelementptr inbounds %struct.lua_State, ptr %L, i64 0, i32 4
  %sub.ptr.lhs.cast = ptrtoint ptr %54 to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %53 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %cmp26 = icmp slt i64 %sub.ptr.sub, 17
...
if.end30:                                         ; preds = %if.end24, %if.then28
  %55 = load ptr, ptr %top25, align 8, !tbaa !34
  %incdec.ptr32 = getelementptr inbounds %struct.lua_TValue, ptr %55, i64 1
  store ptr %incdec.ptr32, ptr %top25, align 8, !tbaa !34
  br label %cond.false38

cond.false38:                                     ; preds = %auxgetinfo.exit.thread, %if.end30
  %retval.0.i95 = phi i32 [ 1, %auxgetinfo.exit.thread ], [ %retval.0.i94100, %if.end30 ]
  %f.07493 = phi ptr [ null, %auxgetinfo.exit.thread ], [ %f.07492102, %if.end30 ]
  %what.addr.07791 = phi ptr [ %what.addr.078, %auxgetinfo.exit.thread ], [ %what.addr.07790104, %if.end30 ]
  %cmp.i7989 = phi i1 [ true, %auxgetinfo.exit.thread ], [ %cmp.i7988106, %if.end30 ]
  %call39 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %what.addr.07791, i32 noundef 76) #11
  %tobool40.not = icmp eq ptr %call39, null
  br i1 %tobool40.not, label %if.end42, label %if.then41

cond.false38.thread:                              ; preds = %auxgetinfo.exit
  %call39112 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %what.addr.0, i32 noundef 76) #11
  %tobool40.not113 = icmp eq ptr %call39112, null
  br i1 %tobool40.not113, label %if.end42, label %lor.lhs.false.i

if.then41:                                        ; preds = %cond.false38
  br i1 %cmp.i7989, label %if.then.i67, label %lor.lhs.false.i

lor.lhs.false.i:                                  ; preds = %cond.false38.thread, %if.then41
  %retval.0.i95114123 = phi i32 [ %retval.0.i95, %if.then41 ], [ %retval.0.i, %cond.false38.thread ]
  %f.07493116121 = phi ptr [ %f.07493, %if.then41 ], [ %f.0, %cond.false38.thread ]
  %isC.i = getelementptr inbounds %struct.CClosure, ptr %f.07493116121, i64 0, i32 3
  %56 = load i8, ptr %isC.i, align 2, !tbaa !21
  %tobool.not.i66 = icmp eq i8 %56, 0
  br i1 %tobool.not.i66, label %if.else.i, label %if.then.i67

if.then.i67:                                      ; preds = %lor.lhs.false.i, %if.then41
  %retval.0.i95114124 = phi i32 [ %retval.0.i95114123, %lor.lhs.false.i ], [ %retval.0.i95, %if.then41 ]
  %top.i = getelementptr inbounds %struct.lua_State, ptr %L, i64 0, i32 4
...
if.else.i:                                        ; preds = %lor.lhs.false.i
  ...
  %p.i = getelementptr inbounds %struct.LClosure, ptr %f.07493116121, i64 0, i32 7
  ...
  br i1 %cmp334.i, label %for.body.i68, label %for.end.i

for.body.i68:                                     ; preds = %if.else.i, %for.body.i68
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %for.body.i68 ], [ 0, %if.else.i ]
  ...
  br i1 %cmp3.i, label %for.body.i68, label %for.end.i, !llvm.loop !51

for.end.i:                                        ; preds = %for.body.i68, %if.else.i
...
if.end.i:                                         ; preds = %for.end.i, %if.then.i67
  %retval.0.i95114122 = phi i32 [ %retval.0.i95114123, %for.end.i ], [ %retval.0.i95114124, %if.then.i67 ]
  %66 = phi ptr [ %.pre.i, %for.end.i ], [ %57, %if.then.i67 ]
...
if.then14.i:                                      ; preds = %if.end.i
  ...
  %.pre81 = load ptr, ptr %top11.i.phi.trans.insert, align 8, !tbaa !34
  br label %collectvalidlines.exit

collectvalidlines.exit:                           ; preds = %if.end.i, %if.then14.i
  %68 = phi ptr [ %66, %if.end.i ], [ %.pre81, %if.then14.i ]
  %top11.i = getelementptr inbounds %struct.lua_State, ptr %L, i64 0, i32 4
  %incdec.ptr.i69 = getelementptr inbounds %struct.lua_TValue, ptr %68, i64 1
  store ptr %incdec.ptr.i69, ptr %top11.i, align 8, !tbaa !34
  br label %if.end42

if.end42:                                         ; preds = %cond.false38.thread, %collectvalidlines.exit, %cond.false38
  %retval.0.i95115 = phi i32 [ %retval.0.i, %cond.false38.thread ], [ %retval.0.i95114122, %collectvalidlines.exit ], [ %retval.0.i95, %cond.false38 ]
  ret i32 %retval.0.i95115
}
...
if.end.i:                                         ; preds = %entry
  ...
  %or.cond57.i = select i1 %cmp6.not.i, i1 true, i1 %or.cond.i
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc417
  ...
  %or.cond646 = select i1 %cmp3, i1 %cmp6, i1 false
...
sw.bb.i:                                          ; preds = %sw.bb
  %cmp.i578 = icmp ult i32 %11, 8388608
  br i1 %cmp.i578, label %if.end26, label %cleanup423
...
if.end26:                                         ; preds = %cond.false.i, %cond.true.i, %sw.bb1.i, %sw.bb.i, %sw.bb
  ...
  switch i32 %and31, label %sw.epilog [
    i32 0, label %sw.bb.i584
    i32 3, label %sw.bb6.i591
    i32 2, label %sw.bb1.i588
  ]

sw.bb.i584:                                       ; preds = %if.end26
  %cmp.i583 = icmp eq i32 %and17, 0
  br i1 %cmp.i583, label %sw.epilog, label %cleanup423

sw.bb1.i588:                                      ; preds = %if.end26
  %cmp2.i587 = icmp ult i32 %and17, %conv.i
  br i1 %cmp2.i587, label %sw.epilog, label %cleanup423

sw.bb6.i591:                                      ; preds = %if.end26
  %16 = and i32 %11, 4194304
  %tobool.not.i590 = icmp eq i32 %16, 0
  br i1 %tobool.not.i590, label %cond.false.i599, label %cond.true.i595

cond.true.i595:                                   ; preds = %sw.bb6.i591
  %and7.i592 = and i32 %shr16, 255
  %17 = load i32, ptr %sizek, align 4, !tbaa !58
  %cmp8.i594 = icmp slt i32 %and7.i592, %17
  br i1 %cmp8.i594, label %sw.epilog, label %cleanup423

cond.false.i599:                                  ; preds = %sw.bb6.i591
  %cmp12.i598 = icmp ult i32 %and17, %conv.i
  br i1 %cmp12.i598, label %sw.epilog, label %cleanup423
...
for.body78:                                       ; preds = %for.body78.preheader, %for.inc
  ...
  br i1 %or.cond567, label %for.inc, label %for.end.split.loop.exit656
...
for.end.split.loop.exit656:                       ; preds = %for.body78
  %24 = trunc i64 %indvars.iv to i32
  br label %for.end

for.end:                                          ; preds = %for.inc, %for.end.split.loop.exit656
  %j.0.lcssa.ph = phi i32 [ %24, %for.end.split.loop.exit656 ], [ %add64, %for.inc ]
  %and95 = and i32 %j.0.lcssa.ph, 1
  %cmp96 = icmp eq i32 %and95, 0
  br i1 %cmp96, label %sw.epilog, label %cleanup423

sw.epilog:                                        ; preds = %cond.false.i599, %cond.true.i595, %sw.bb1.i588, %sw.bb.i584, %if.end26, %if.end71, %for.end, %sw.bb52, %sw.bb36, %if.then46, %if.end9
  %c.0 = phi i32 [ 0, %if.end9 ], [ 0, %sw.bb52 ], [ 0, %if.then46 ], [ 0, %sw.bb36 ], [ 0, %for.end ], [ 0, %if.end71 ], [ %and17, %if.end26 ], [ 0, %sw.bb.i584 ], [ %and17, %sw.bb1.i588 ], [ %and17, %cond.true.i595 ], [ %and17, %cond.false.i599 ]
  %b.0 = phi i32 [ 0, %if.end9 ], [ %sub55, %sw.bb52 ], [ %shr37, %if.then46 ], [ %shr37, %sw.bb36 ], [ %sub55, %for.end ], [ %sub55, %if.end71 ], [ %shr14, %if.end26 ], [ %shr14, %sw.bb.i584 ], [ %shr14, %sw.bb1.i588 ], [ %shr14, %cond.true.i595 ], [ %shr14, %cond.false.i599 ]
  %25 = and i8 %12, 64
  %tobool112.not = icmp ne i8 %25, 0
  %cmp114 = icmp eq i32 %and2, %reg
  %or.cond568 = select i1 %tobool112.not, i1 %cmp114, i1 false
...
if.end151:                                        ; preds = %if.then145
  %add153 = add nsw i32 %pc.0644, 1
  %idxprom154 = sext i32 %add153 to i64
  %arrayidx155 = getelementptr inbounds i32, ptr %8, i64 %idxprom154
  %27 = load i32, ptr %arrayidx155, align 4, !tbaa !41
  %28 = and i32 %27, 8372287
  %or.cond569 = icmp eq i32 %28, 34
...
sw.bb185:                                         ; preds = %if.end141, %if.end141
  %29 = load ptr, ptr %k, align 8, !tbaa !60
  %idxprom186 = sext i32 %b.0 to i64
  %tt = getelementptr inbounds %struct.lua_TValue, ptr %29, i64 %idxprom186, i32 1
  %30 = load i32, ptr %tt, align 8, !tbaa !27
  %cmp188 = icmp eq i32 %30, 4
...
if.then267:                                       ; preds = %if.end264
  %add269 = add nsw i32 %pc.0644, 1
  %idxprom270 = sext i32 %add269 to i64
  %arrayidx271 = getelementptr inbounds i32, ptr %8, i64 %idxprom270
  %31 = load i32, ptr %arrayidx271, align 4, !tbaa !41
  %and.i603 = and i32 %31, 63
...
luaG_checkopenop.exit:                            ; preds = %if.then267, %if.then267, %if.then267, %if.then267
  %cmp.i604 = icmp ugt i32 %31, 8388607
  br i1 %cmp.i604, label %cleanup423, label %if.end288
...
sw.bb330:                                         ; preds = %if.end141
  %32 = load i32, ptr %sizep, align 8, !tbaa !61
  %cmp332 = icmp slt i32 %b.0, %32
  br i1 %cmp332, label %if.end335, label %cleanup423

if.end335:                                        ; preds = %sw.bb330
  %33 = load ptr, ptr %p, align 8, !tbaa !62
  %idxprom336 = sext i32 %b.0 to i64
  %arrayidx337 = getelementptr inbounds ptr, ptr %33, i64 %idxprom336
  %34 = load ptr, ptr %arrayidx337, align 8, !tbaa !33
  %nups338 = getelementptr inbounds %struct.Proto, ptr %34, i64 0, i32 19
  %35 = load i8, ptr %nups338, align 8, !tbaa !57
  %conv339 = zext i8 %35 to i32
...
for.cond346:                                      ; preds = %for.body349
  ...
  br i1 %exitcond654.not, label %cleanup374, label %for.body349, !llvm.loop !63
...
for.body349:                                      ; preds = %for.body349.preheader, %for.cond346
  ...
  %37 = add nsw i64 %indvars.iv649, %idxprom
  %arrayidx353 = getelementptr inbounds i32, ptr %8, i64 %37
  %38 = load i32, ptr %arrayidx353, align 4, !tbaa !41
  %39 = and i32 %38, 59
...
luaG_checkopenop.exit612:                         ; preds = %if.then391, %if.then391, %if.then391, %if.then391
  %cmp.i608 = icmp ugt i32 %40, 8388607
  %add401 = add nsw i32 %dec388, %and2
  %cmp405.not = icmp sgt i32 %add401, %conv.i
  %or.cond632 = select i1 %cmp.i608, i1 true, i1 %cmp405.not
...
for.inc417:                                       ; preds = %luaG_checkopenop.exit612, %cleanup374, %sw.bb171, %if.end288, %if.end222, %if.end199, %if.end141, %if.end400, %if.end318, %if.then321, %sw.bb293, %if.then297, %sw.bb205, %sw.bb185, %sw.bb179, %sw.bb142, %if.end151, %sw.bb236
...
for.end419:                                       ; preds = %for.inc417, %if.end
  ...
  %41 = load i32, ptr %arrayidx422, align 4, !tbaa !41
  br label %cleanup423

cleanup423:                                       ; preds = %sw.bb307, %if.else, %sw.bb252, %if.then391, %if.end335, %sw.bb330, %if.then267, %cond.true.i595, %cond.false.i599, %sw.bb1.i588, %sw.bb.i584, %cond.true.i, %cond.false.i, %sw.bb1.i, %sw.bb.i, %for.end, %if.then63, %if.end400, %luaG_checkopenop.exit612, %sw.bb377, %if.then321, %if.then297, %luaG_checkopenop.exit, %sw.bb228, %if.end214, %sw.bb210, %sw.bb205, %sw.bb192, %sw.bb185, %sw.bb179, %if.end151, %if.then145, %if.end130, %if.then124, %if.then46, %for.body, %for.body349, %if.end23.i, %if.end18.i, %if.end.i, %entry, %precheck.exit, %for.end419
  %retval.10 = phi i32 [ %41, %for.end419 ], [ 0, %precheck.exit ], [ 0, %entry ], [ 0, %if.end.i ], [ 0, %if.end18.i ], [ 0, %if.end23.i ], [ 0, %for.body349 ], [ 0, %for.body ], [ 0, %if.then46 ], [ 0, %if.then124 ], [ 0, %if.end130 ], [ 0, %if.then145 ], [ 0, %if.end151 ], [ 0, %sw.bb179 ], [ 0, %sw.bb185 ], [ 0, %sw.bb192 ], [ 0, %sw.bb205 ], [ 0, %sw.bb210 ], [ 0, %if.end214 ], [ 0, %sw.bb228 ], [ 0, %luaG_checkopenop.exit ], [ 0, %if.then297 ], [ 0, %if.then321 ], [ 0, %sw.bb377 ], [ 0, %luaG_checkopenop.exit612 ], [ 0, %if.end400 ], [ 0, %if.then63 ], [ 0, %for.end ], [ 0, %sw.bb.i ], [ 0, %sw.bb1.i ], [ 0, %cond.false.i ], [ 0, %cond.true.i ], [ 0, %sw.bb.i584 ], [ 0, %sw.bb1.i588 ], [ 0, %cond.false.i599 ], [ 0, %cond.true.i595 ], [ 0, %if.then267 ], [ 0, %sw.bb330 ], [ 0, %if.end335 ], [ 0, %if.then391 ], [ 0, %sw.bb252 ], [ 0, %if.else ], [ 0, %sw.bb307 ]
  ret i32 %retval.10
}
