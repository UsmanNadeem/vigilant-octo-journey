; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c"
...
@.str.1 = private unnamed_addr constant [108 x i8] c"/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/makedent.c\00", align 1
...
if.end16:                                         ; preds = %if.then15, %if.end
  %call18 = call i32 @strtoichar(ptr noundef nonnull %ibuf, ptr noundef nonnull %lbuf, i32 noundef 100, i32 noundef 1)
...
land.rhs.i:                                       ; preds = %if.end29.i
  ...
  br i1 %cmp1.not.i, label %ichartostr.exit, label %while.body.i, !llvm.loop !17
...
while.cond21.i:                                   ; preds = %while.cond21.i, %if.else.i
  ...
  br i1 %cmp25.not.i, label %if.end29.i, label %while.cond21.i, !llvm.loop !19
...
if.end29.i:                                       ; preds = %while.cond21.i, %if.then.i
  ...
  br i1 %cmp.i, label %land.rhs.i, label %ichartostr.exit.thread, !llvm.loop !17
...
for.inc.i:                                        ; preds = %for.body.i
  ...
  br i1 %tobool.not.i, label %whatcap.exit, label %for.body.i, !llvm.loop !22
...
for.cond4.i:                                      ; preds = %for.body6.i
  ...
  br i1 %tobool5.not.i, label %if.then18.i, label %for.body6.i, !llvm.loop !23
...
for.body28.i:                                     ; preds = %for.cond24.i
  ...
  br i1 %tobool31.not.i, label %for.cond24.i, label %whatcap.exit, !llvm.loop !24
...
if.end60:                                         ; preds = %whatcap.exit
  ...
  store ptr %call61, ptr %word, align 8, !tbaa !25
...
if.then75:                                        ; preds = %if.end67
  %27 = load ptr, ptr %word, align 8, !tbaa !25
...
land.rhs7:                                        ; preds = %for.body
  %2 = load i32, ptr getelementptr inbounds (%struct.hashheader, ptr @hashheader, i64 0, i32 12), align 4, !tbaa !27
...
if.end.i:                                         ; preds = %while.body4.i
  ...
  br i1 %tobool3.not.i, label %if.then12.i, label %while.body4.i, !llvm.loop !28
...
if.then12.i:                                      ; preds = %if.end.i, %while.body.i
  ...
  %9 = load i32, ptr %arrayidx14.i, align 4, !tbaa !29
...
if.else45.i:                                      ; preds = %if.else36.i
  ...
  %14 = load i32, ptr %arrayidx47.i, align 4, !tbaa !29
...
if.end56.i:                                       ; preds = %if.else52.i, %if.then50.i, %if.then43.i, %if.then34.i
  ...
  br i1 %cmp.not.i, label %stringcharlen.exit.thread, label %while.body.i, !llvm.loop !30

stringcharlen.exit.thread:                        ; preds = %if.end56.i, %land.rhs7
  store i32 -1, ptr @laststringch, align 4, !tbaa !29
  br label %if.else
...
stringcharlen.exit:                               ; preds = %if.then12.i
  ...
  %15 = load i32, ptr %arrayidx19.i, align 4, !tbaa !29
  store i32 %15, ptr @laststringch, align 4, !tbaa !29
...
land.rhs.us:                                      ; preds = %if.end29.us
  ...
  br i1 %cmp1.not.us, label %while.end30, label %while.body.us, !llvm.loop !17
...
if.else.us:                                       ; preds = %while.body.us
  ...
  %3 = load i32, ptr getelementptr inbounds (%struct.hashheader, ptr @hashheader, i64 0, i32 12), align 4, !tbaa !27
...
for.body.us:                                      ; preds = %for.body.lr.ph.us, %if.end.us
  ...
  %4 = load i32, ptr %arrayidx.us, align 4, !tbaa !29
...
land.lhs.true.us:                                 ; preds = %for.body.us
  ...
  %5 = load i32, ptr %arrayidx14.us, align 4, !tbaa !29
...
if.end.us:                                        ; preds = %land.lhs.true.us, %for.body.us
  ...
  br i1 %cmp9.us, label %for.body.us, label %if.end18.loopexit.us, !llvm.loop !32
...
while.cond21.us:                                  ; preds = %while.cond21.us, %if.end18.loopexit.us
  ...
  br i1 %cmp25.not.us, label %if.end29.us, label %while.cond21.us, !llvm.loop !19
...
if.end29.us:                                      ; preds = %while.cond21.us, %if.then.us
  ...
  br i1 %cmp.us, label %land.rhs.us, label %while.end30, !llvm.loop !17
...
for.body.lr.ph.us:                                ; preds = %if.else.us
  %7 = load i32, ptr @defdupchar, align 4, !tbaa !29
  %8 = zext i32 %3 to i64
...
land.rhs:                                         ; preds = %if.end29
  ...
  br i1 %cmp1.not, label %while.end30, label %while.body, !llvm.loop !17
...
while.cond21:                                     ; preds = %while.cond21, %if.else
  ...
  br i1 %cmp25.not, label %if.end29, label %while.cond21, !llvm.loop !19
...
if.end29:                                         ; preds = %while.cond21, %if.then
  ...
  br i1 %cmp, label %land.rhs, label %while.end30, !llvm.loop !17
...
for.inc:                                          ; preds = %for.body
  ...
  br i1 %tobool.not, label %cleanup, label %for.body, !llvm.loop !22
...
for.cond4:                                        ; preds = %for.body6
  ...
  br i1 %tobool5.not, label %if.then18, label %for.body6, !llvm.loop !23
...
for.body28:                                       ; preds = %for.cond24
  ...
  %9 = load i8, ptr %arrayidx30, align 1, !tbaa !5
  %tobool31.not = icmp eq i8 %9, 0
  br i1 %tobool31.not, label %for.cond24, label %cleanup, !llvm.loop !24
...
entry:
  %call.i = tail call i32 @strtoichar(ptr noundef nonnull @strtosichar.out, ptr noundef %s, i32 noundef 184, i32 noundef 1)
...
strtosichar.exit:                                 ; preds = %entry, %if.then.i
  %1 = load i8, ptr @strtosichar.out, align 16, !tbaa !5
...
while.body.i:                                     ; preds = %strtosichar.exit, %while.body.i
  ...
  br i1 %tobool.not.i6, label %upcase.exit.loopexit, label %while.body.i, !llvm.loop !33
...
land.rhs.i:                                       ; preds = %if.end29.i
  ...
  br i1 %cmp1.not.i, label %ichartostr.exit, label %while.body.i7, !llvm.loop !17
...
if.end29.i:                                       ; preds = %while.cond21.i, %if.then.i8
  ...
  br i1 %cmp.i, label %land.rhs.i, label %ichartostr.exit, !llvm.loop !17
...
if.then:                                          ; preds = %entry
  ...
  %1 = load ptr, ptr %word, align 8, !tbaa !25
  %call1 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.3, ptr noundef %1) #17
  br label %cleanup

if.end:                                           ; preds = %entry
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %call, ptr noundef nonnull align 8 dereferenceable(24) %dp, i64 24, i1 false), !tbaa.struct !34
...
if.then3:                                         ; preds = %if.end
  store ptr null, ptr %word5, align 8, !tbaa !25
  br label %if.end19

if.else:                                          ; preds = %if.end
  %3 = load ptr, ptr %word5, align 8, !tbaa !25
  ...
  store ptr %call7, ptr %word5, align 8, !tbaa !25
...
if.then12:                                        ; preds = %if.else
  ...
  %5 = load ptr, ptr %word13, align 8, !tbaa !25
...
if.end15:                                         ; preds = %if.else
  ...
  %6 = load ptr, ptr %word17, align 8, !tbaa !25
...
if.end19:                                         ; preds = %if.end15, %if.then3
  ...
  %7 = load ptr, ptr %word20, align 8, !tbaa !25
...
while.body:                                       ; preds = %while.cond
  ...
  %call = tail call fastcc i32 @combine_two_entries(ptr noundef %hdrp, ptr noundef %2, ptr noundef %newp)
  %cmp5.not = icmp eq i32 %call, 0
  br i1 %cmp5.not, label %while.cond, label %cleanup, !llvm.loop !35

if.end8:                                          ; preds = %entry
  %call7 = tail call fastcc i32 @combine_two_entries(ptr noundef nonnull %hdrp, ptr noundef nonnull %hdrp, ptr noundef %newp)
...
if.then11.i:                                      ; preds = %land.lhs.true.i, %if.then10
  %call.i = tail call i32 @addvheader(ptr noundef nonnull %hdrp)
...
if.then13:                                        ; preds = %forcevheader.exit
  ...
  %7 = load ptr, ptr %word, align 8, !tbaa !25
...
if.end15:                                         ; preds = %forcevheader.exit
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %call11, ptr noundef nonnull align 8 dereferenceable(24) %newp, i64 24, i1 false), !tbaa.struct !34
...
if.else.i:                                        ; preds = %entry
  ...
  %or.cond255.i = icmp eq i64 %3, 0
  br i1 %or.cond255.i, label %if.then26.i, label %if.else

if.end18.thread.i:                                ; preds = %if.then.i
  %and24253.i = and i64 %xor.i, 805306368
  %cmp25254.i = icmp eq i64 %and24253.i, 0
  br i1 %cmp25254.i, label %if.then26.i, label %if.else214.i
...
lor.lhs.false.i:                                  ; preds = %if.then26.i
  %word197.i = getelementptr inbounds %struct.dent, ptr %oldp, i64 0, i32 1
  %4 = load ptr, ptr %word197.i, align 8, !tbaa !25
  %word198.i = getelementptr inbounds %struct.dent, ptr %newp, i64 0, i32 1
  %5 = load ptr, ptr %word198.i, align 8, !tbaa !25
  %call199.i = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %4, ptr noundef nonnull dereferenceable(1) %5) #15
  %cmp206.i = icmp eq i32 %call199.i, 0
  br i1 %cmp206.i, label %if.then, label %if.else

if.else214.i:                                     ; preds = %if.end18.thread.i
  %and217.i = and i64 %entb.val.i, 805306368
  %cmp218.i = icmp eq i64 %and217.i, 268435456
  br i1 %cmp218.i, label %if.then, label %acoversb.exit

acoversb.exit:                                    ; preds = %if.else214.i
  %and224.i = and i64 %enta.val.i, 805306368
  %cmp225.i = icmp eq i64 %and224.i, 0
  %cmp231.i = icmp eq i64 %and217.i, 536870912
  %or.cond248.i = select i1 %cmp225.i, i1 %cmp231.i, i1 false
  br i1 %or.cond248.i, label %if.then, label %if.else

if.then:                                          ; preds = %lor.lhs.false.i, %if.else214.i, %if.then26.i, %acoversb.exit
  ...
  %word = getelementptr inbounds %struct.dent, ptr %newp, i64 0, i32 1
  %9 = load ptr, ptr %word, align 8, !tbaa !25
...
if.then.i84:                                      ; preds = %if.else
  ...
  %or.cond.i83 = select i1 %cmp3.not.i80, i1 %cmp7.i82, i1 false
  br i1 %or.cond.i83, label %return, label %if.end18.thread.i89

if.else.i86:                                      ; preds = %if.else
  %11 = and i64 %xor.i, 939524096
  %or.cond255.i85 = icmp eq i64 %11, 0
  br i1 %or.cond255.i85, label %if.then26.i92, label %return

if.end18.thread.i89:                              ; preds = %if.then.i84
  %and24253.i87 = and i64 %xor.i, 805306368
  %cmp25254.i88 = icmp eq i64 %and24253.i87, 0
  br i1 %cmp25254.i88, label %if.then26.i92, label %if.else214.i100
...
lor.lhs.false.i97:                                ; preds = %if.then26.i92
  %word197.i93 = getelementptr inbounds %struct.dent, ptr %newp, i64 0, i32 1
  %12 = load ptr, ptr %word197.i93, align 8, !tbaa !25
  %word198.i94 = getelementptr inbounds %struct.dent, ptr %oldp, i64 0, i32 1
  %13 = load ptr, ptr %word198.i94, align 8, !tbaa !25
  %call199.i95 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %12, ptr noundef nonnull dereferenceable(1) %13) #15
  %cmp206.i96 = icmp eq i32 %call199.i95, 0
  br i1 %cmp206.i96, label %if.then11, label %return

if.else214.i100:                                  ; preds = %if.end18.thread.i89
  %and217.i98 = and i64 %enta.val.i, 805306368
  %cmp218.i99 = icmp eq i64 %and217.i98, 268435456
  br i1 %cmp218.i99, label %if.then11, label %acoversb.exit108

acoversb.exit108:                                 ; preds = %if.else214.i100
  %and224.i101 = and i64 %entb.val.i, 805306368
  %cmp225.i102 = icmp eq i64 %and224.i101, 0
  %cmp231.i103 = icmp eq i64 %and217.i98, 536870912
  %or.cond248.i104 = select i1 %cmp225.i102, i1 %cmp231.i103, i1 false
  br i1 %or.cond248.i104, label %if.then11, label %return

if.then11:                                        ; preds = %lor.lhs.false.i97, %if.else214.i100, %if.then26.i92, %acoversb.exit108
  ...
  %17 = load ptr, ptr %word25, align 8, !tbaa !25
...
if.then26:                                        ; preds = %if.then11
  ...
  %18 = load ptr, ptr %word28, align 8, !tbaa !25
...
if.end:                                           ; preds = %if.then26, %if.then11
  ...
  %19 = load ptr, ptr %word30, align 8, !tbaa !25
  tail call void @myfree(ptr noundef %19) #15
  %20 = load ptr, ptr %word25, align 8, !tbaa !25
  store ptr %20, ptr %word30, align 8, !tbaa !25
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %oldp, ptr noundef nonnull align 8 dereferenceable(24) %newp, i64 24, i1 false), !tbaa.struct !34
...
if.then41:                                        ; preds = %land.lhs.true
  %call42 = tail call i32 @addvheader(ptr noundef nonnull %hdrp)
  br label %return
...
entry:
  %call = tail call i32 @strtoichar(ptr noundef nonnull @strtosichar.out, ptr noundef %in, i32 noundef 184, i32 noundef %canonical)
...
entry:
  ...
  %0 = load ptr, ptr %word, align 8, !tbaa !25
  %call = call i32 @strtoichar(ptr noundef nonnull %wbuf, ptr noundef %0, i32 noundef 100, i32 noundef 1)
  %tobool.not = icmp eq i32 %call, 0
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %1 = load ptr, ptr @stderr, align 8, !tbaa !20
  %2 = load ptr, ptr %word, align 8, !tbaa !25
...
while.body.i:                                     ; preds = %sw.bb, %while.body.i
  ...
  br i1 %tobool.not.i, label %lowcase.exit, label %while.body.i, !llvm.loop !36
...
land.rhs.i.i:                                     ; preds = %if.end29.i.i
  ...
  br i1 %cmp1.not.i.i, label %ichartostr.exit.thread.i, label %while.body.i.i, !llvm.loop !17
...
while.cond21.i.i:                                 ; preds = %while.cond21.i.i, %if.else.i.i
  ...
  br i1 %cmp25.not.i.i, label %if.end29.i.i, label %while.cond21.i.i, !llvm.loop !19
...
if.end29.i.i:                                     ; preds = %while.cond21.i.i, %if.then.i.i
  ...
  br i1 %cmp.i.i, label %land.rhs.i.i, label %if.then.i, !llvm.loop !17
...
if.then.i.i57:                                    ; preds = %if.then.i56
  ...
  %call.i.i = tail call i32 @_IO_putc(i32 noundef %conv.i.i, ptr noundef %toutfile)
...
while.body.i64:                                   ; preds = %if.then18, %while.body.i64
  ...
  br i1 %tobool.not.i63, label %upcase.exit, label %while.body.i64, !llvm.loop !33
...
land.rhs.i.i68:                                   ; preds = %if.end29.i.i90
  ...
  br i1 %cmp1.not.i.i67, label %ichartostr.exit.thread.i92, label %while.body.i.i74, !llvm.loop !17
...
while.cond21.i.i87:                               ; preds = %while.cond21.i.i87, %if.else.i.i81
  ...
  br i1 %cmp25.not.i.i86, label %if.end29.i.i90, label %while.cond21.i.i87, !llvm.loop !19
...
if.end29.i.i90:                                   ; preds = %while.cond21.i.i87, %if.then.i.i76
  ...
  br i1 %cmp.i.i89, label %land.rhs.i.i68, label %if.then.i94, !llvm.loop !17
...
if.then.i.i107:                                   ; preds = %if.then.i104
  ...
  %call.i.i106 = tail call i32 @_IO_putc(i32 noundef %conv.i.i105, ptr noundef %toutfile)
...
flagout.exit.i109:                                ; preds = %if.then.i.i107, %if.then.i104
  ...
  %27 = add i32 %26, 65
  %call1.i.i108 = tail call i32 @_IO_putc(i32 noundef %27, ptr noundef %toutfile)
...
for.inc.i112:                                     ; preds = %flagout.exit.i109, %for.body.i102
  ...
  br i1 %exitcond.not.i111, label %if.end32.sink.split, label %for.body.i102, !llvm.loop !37
...
while.body.i121:                                  ; preds = %sw.bb23, %while.body.i121
  ...
  br i1 %tobool.not.i120, label %lowcase.exit122.loopexit, label %while.body.i121, !llvm.loop !36
...
land.rhs.i.i126:                                  ; preds = %if.end29.i.i148
  ...
  br i1 %cmp1.not.i.i125, label %ichartostr.exit.thread.i150, label %while.body.i.i132, !llvm.loop !17
...
while.cond21.i.i145:                              ; preds = %while.cond21.i.i145, %if.else.i.i139
  ...
  br i1 %cmp25.not.i.i144, label %if.end29.i.i148, label %while.cond21.i.i145, !llvm.loop !19
...
if.end29.i.i148:                                  ; preds = %while.cond21.i.i145, %if.then.i.i134
  ...
  br i1 %cmp.i.i147, label %land.rhs.i.i126, label %if.then.i152, !llvm.loop !17
...
if.then.i.i165:                                   ; preds = %if.then.i162
  ...
  %call.i.i164 = tail call i32 @_IO_putc(i32 noundef %conv.i.i163, ptr noundef %toutfile)
...
flagout.exit.i167:                                ; preds = %if.then.i.i165, %if.then.i162
  ...
  %41 = add i32 %40, 65
  %call1.i.i166 = tail call i32 @_IO_putc(i32 noundef %41, ptr noundef %toutfile)
...
for.inc.i170:                                     ; preds = %flagout.exit.i167, %for.body.i160
  ...
  br i1 %exitcond.not.i169, label %if.end32.sink.split, label %for.body.i160, !llvm.loop !37

sw.bb30:                                          ; preds = %if.then5
  %word31 = getelementptr inbounds %struct.dent, ptr %cent.0, i64 0, i32 1
  %42 = load ptr, ptr %word31, align 8, !tbaa !25
  store i1 false, ptr @has_marker, align 4
...
if.then.i.i184:                                   ; preds = %if.then.i181
  ...
  %call.i.i183 = tail call i32 @_IO_putc(i32 noundef %conv.i.i182, ptr noundef %toutfile)
...
flagout.exit.i186:                                ; preds = %if.then.i.i184, %if.then.i181
  ...
  %46 = add i32 %45, 65
  %call1.i.i185 = tail call i32 @_IO_putc(i32 noundef %46, ptr noundef %toutfile)
...
for.inc.i189:                                     ; preds = %flagout.exit.i186, %for.body.i179
  ...
  br i1 %exitcond.not.i188, label %if.end32.sink.split, label %for.body.i179, !llvm.loop !37
...
land.rhs.us.i:                                    ; preds = %if.end29.us.i
  ...
  br i1 %cmp1.not.us.i, label %ichartostr.exit.thread, label %while.body.us.i, !llvm.loop !17
...
for.body.us.i:                                    ; preds = %for.body.lr.ph.us.i, %if.end.us.i
  ...
  %4 = load i32, ptr %arrayidx.us.i, align 4, !tbaa !29
...
land.lhs.true.us.i:                               ; preds = %for.body.us.i
  ...
  %5 = load i32, ptr %arrayidx14.us.i, align 4, !tbaa !29
...
if.end.us.i:                                      ; preds = %land.lhs.true.us.i, %for.body.us.i
  ...
  br i1 %cmp9.us.i, label %for.body.us.i, label %if.end18.loopexit.us.i, !llvm.loop !32
...
while.cond21.us.i:                                ; preds = %if.end18.loopexit.us.i, %while.cond21.us.i
  ...
  br i1 %cmp25.not.us.i, label %if.end29.us.i, label %while.cond21.us.i, !llvm.loop !19
...
if.end29.us.i:                                    ; preds = %while.cond21.us.i, %if.then.us.i
  ...
  br i1 %cmp.us.i, label %land.rhs.us.i, label %if.then, !llvm.loop !17
...
land.rhs.i:                                       ; preds = %if.end29.i
  ...
  br i1 %cmp1.not.i, label %ichartostr.exit.thread, label %while.body.i, !llvm.loop !17
...
if.end29.i:                                       ; preds = %while.cond21.i, %if.then.i
  ...
  br i1 %cmp.i, label %land.rhs.i, label %if.then, !llvm.loop !17
...
entry:
  %0 = load i32, ptr getelementptr inbounds (%struct.hashheader, ptr @hashheader, i64 0, i32 12), align 4, !tbaa !27
  %tobool.not = icmp eq i32 %canonical, 0
...
if.end:                                           ; preds = %while.body4
  ...
  br i1 %tobool3.not, label %if.then12, label %while.body4, !llvm.loop !28
...
if.then12:                                        ; preds = %if.end, %while.body
  ...
  %7 = load i32, ptr %arrayidx14, align 4, !tbaa !29
...
if.then17:                                        ; preds = %if.then12
  ...
  %8 = load i32, ptr %arrayidx19, align 4, !tbaa !29
  store i32 %8, ptr @laststringch, align 4, !tbaa !29
...
if.else45:                                        ; preds = %if.else36
  ...
  %13 = load i32, ptr %arrayidx47, align 4, !tbaa !29
...
if.end56:                                         ; preds = %if.then43, %if.else52, %if.then50, %if.then34
  ...
  br i1 %cmp.not, label %while.end57, label %while.body, !llvm.loop !30
...
entry:
  ...
  %.pre = load i32, ptr getelementptr inbounds (%struct.hashheader, ptr @hashheader, i64 0, i32 13), align 4, !tbaa !38
  br i1 %tobool.not, label %if.end403, label %for.cond.preheader

for.cond.preheader:                               ; preds = %entry
  %cmp899 = icmp sgt i32 %.pre, 0
  br i1 %cmp899, label %for.body.lr.ph, label %cleanup

for.body.lr.ph:                                   ; preds = %for.cond.preheader
  %0 = load ptr, ptr @chartypes, align 8, !tbaa !20
  %wide.trip.count = zext i32 %.pre to i64
  br label %for.body

for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %indvars.iv = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next, %for.inc ]
  %arrayidx189 = getelementptr inbounds %struct.strchartype, ptr %0, i64 %indvars.iv
  %1 = load ptr, ptr %arrayidx189, align 8, !tbaa !39
  %call191 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(1) %1) #15
  %cmp198 = icmp eq i32 %call191, 0
  br i1 %cmp198, label %if.then200, label %for.inc

if.then200:                                       ; preds = %for.body
  %2 = trunc i64 %indvars.iv to i32
  %cmp201.not = icmp eq ptr %deformatter, null
  br i1 %cmp201.not, label %cleanup, label %cond.false341

cond.false341:                                    ; preds = %if.then200
  %idxprom188.le = and i64 %indvars.iv, 4294967295
  %deformatter345 = getelementptr inbounds %struct.strchartype, ptr %0, i64 %idxprom188.le, i32 1
  %3 = load ptr, ptr %deformatter345, align 8, !tbaa !41
  %4 = load i8, ptr %3, align 1, !tbaa !5
  %conv349 = zext i8 %4 to i32
  %sub350.neg = add nsw i32 %conv349, -116
  %cmp354 = icmp eq i8 %4, 116
  br i1 %cmp354, label %if.then356, label %cleanup.sink.split

if.then356:                                       ; preds = %cond.false341
  %arrayidx358 = getelementptr inbounds i8, ptr %3, i64 1
  %5 = load i8, ptr %arrayidx358, align 1, !tbaa !5
  %conv359 = zext i8 %5 to i32
  %sub360.neg = add nsw i32 %conv359, -101
  %cmp364 = icmp eq i8 %5, 101
  br i1 %cmp364, label %if.then366, label %cleanup.sink.split

if.then366:                                       ; preds = %if.then356
  %arrayidx368 = getelementptr inbounds i8, ptr %3, i64 2
  %6 = load i8, ptr %arrayidx368, align 1, !tbaa !5
  %conv369 = zext i8 %6 to i32
  %sub370.neg = add nsw i32 %conv369, -120
  %cmp374 = icmp eq i8 %6, 120
  br i1 %cmp374, label %cleanup.sink.split.sink.split, label %cleanup.sink.split

for.inc:                                          ; preds = %for.body
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %if.end403, label %for.body, !llvm.loop !42

if.end403:                                        ; preds = %for.inc, %entry
  %cmp405903 = icmp sgt i32 %.pre, 0
  br i1 %cmp405903, label %for.body407.lr.ph, label %cleanup

for.body407.lr.ph:                                ; preds = %if.end403
  %7 = load ptr, ptr @chartypes, align 8, !tbaa !20
  %wide.trip.count911 = zext i32 %.pre to i64
  br label %for.body407

for.body407:                                      ; preds = %for.body407.lr.ph, %for.inc844
  %indvars.iv908 = phi i64 [ 0, %for.body407.lr.ph ], [ %indvars.iv.next909, %for.inc844 ]
  %suffixes = getelementptr inbounds %struct.strchartype, ptr %7, i64 %indvars.iv908, i32 2
  %8 = load ptr, ptr %suffixes, align 8, !tbaa !43
  %9 = load i8, ptr %8, align 1, !tbaa !5
  %cmp412.not901 = icmp eq i8 %9, 0
  br i1 %cmp412.not901, label %for.inc844, label %for.body414

for.body414:                                      ; preds = %for.body407, %for.inc841
  %cp.0902 = phi ptr [ %add.ptr842, %for.inc841 ], [ %8, %for.body407 ]
  %call415 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %cp.0902) #16
  %conv416 = trunc i64 %call415 to i32
  %cmp417.not = icmp slt i32 %conv, %conv416
  br i1 %cmp417.not, label %for.inc841, label %land.lhs.true419

land.lhs.true419:                                 ; preds = %for.body414
  %sub626 = sub i64 %call, %call415
  %sext895 = shl i64 %sub626, 32
  %idxprom627 = ashr exact i64 %sext895, 32
  %arrayidx628 = getelementptr inbounds i8, ptr %name, i64 %idxprom627
  %call629 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %arrayidx628, ptr noundef nonnull dereferenceable(1) %cp.0902) #15
  %cmp636 = icmp eq i32 %call629, 0
  br i1 %cmp636, label %if.then638, label %for.inc841

if.then638:                                       ; preds = %land.lhs.true419
  %10 = trunc i64 %indvars.iv908 to i32
  %cmp639.not = icmp eq ptr %deformatter, null
  br i1 %cmp639.not, label %cleanup, label %cond.false779

cond.false779:                                    ; preds = %if.then638
  %idxprom408.le = and i64 %indvars.iv908, 4294967295
  %deformatter783 = getelementptr inbounds %struct.strchartype, ptr %7, i64 %idxprom408.le, i32 1
  %11 = load ptr, ptr %deformatter783, align 8, !tbaa !41
  %12 = load i8, ptr %11, align 1, !tbaa !5
  %conv787 = zext i8 %12 to i32
  %sub788.neg = add nsw i32 %conv787, -116
  %cmp792 = icmp eq i8 %12, 116
  br i1 %cmp792, label %if.then794, label %cleanup.sink.split

if.then794:                                       ; preds = %cond.false779
  %arrayidx796 = getelementptr inbounds i8, ptr %11, i64 1
  %13 = load i8, ptr %arrayidx796, align 1, !tbaa !5
  %conv797 = zext i8 %13 to i32
  %sub798.neg = add nsw i32 %conv797, -101
  %cmp802 = icmp eq i8 %13, 101
  br i1 %cmp802, label %if.then804, label %cleanup.sink.split

if.then804:                                       ; preds = %if.then794
  %arrayidx806 = getelementptr inbounds i8, ptr %11, i64 2
  %14 = load i8, ptr %arrayidx806, align 1, !tbaa !5
  %conv807 = zext i8 %14 to i32
  %sub808.neg = add nsw i32 %conv807, -120
  %cmp812 = icmp eq i8 %14, 120
  br i1 %cmp812, label %cleanup.sink.split.sink.split, label %cleanup.sink.split

for.inc841:                                       ; preds = %for.body414, %land.lhs.true419
  %add = shl i64 %call415, 32
  %sext = add i64 %add, 4294967296
  %idx.ext = ashr exact i64 %sext, 32
  %add.ptr842 = getelementptr inbounds i8, ptr %cp.0902, i64 %idx.ext
  %15 = load i8, ptr %add.ptr842, align 1, !tbaa !5
  %cmp412.not = icmp eq i8 %15, 0
  br i1 %cmp412.not, label %for.inc844, label %for.body414, !llvm.loop !44

for.inc844:                                       ; preds = %for.inc841, %for.body407
  %indvars.iv.next909 = add nuw nsw i64 %indvars.iv908, 1
  %exitcond912.not = icmp eq i64 %indvars.iv.next909, %wide.trip.count911
  br i1 %exitcond912.not, label %cleanup, label %for.body407, !llvm.loop !45

cleanup.sink.split.sink.split:                    ; preds = %if.then804, %if.then366
  %.sink = phi ptr [ %3, %if.then366 ], [ %11, %if.then804 ]
  %retval.0.ph.ph = phi i32 [ %2, %if.then366 ], [ %10, %if.then804 ]
  %arrayidx816 = getelementptr inbounds i8, ptr %.sink, i64 3
  %16 = load i8, ptr %arrayidx816, align 1, !tbaa !5
  %conv817 = zext i8 %16 to i32
  br label %cleanup.sink.split

cleanup.sink.split:                               ; preds = %cleanup.sink.split.sink.split, %if.then794, %if.then804, %cond.false779, %if.then356, %if.then366, %cond.false341
  %__result784.0.neg.sink = phi i32 [ %sub370.neg, %if.then366 ], [ %sub360.neg, %if.then356 ], [ %sub350.neg, %cond.false341 ], [ %sub808.neg, %if.then804 ], [ %sub798.neg, %if.then794 ], [ %sub788.neg, %cond.false779 ], [ %conv817, %cleanup.sink.split.sink.split ]
  %retval.0.ph = phi i32 [ %2, %if.then366 ], [ %2, %if.then356 ], [ %2, %cond.false341 ], [ %10, %if.then804 ], [ %10, %if.then794 ], [ %10, %cond.false779 ], [ %retval.0.ph.ph, %cleanup.sink.split.sink.split ]
  %cmp837 = icmp eq i32 %__result784.0.neg.sink, 0
  %conv838 = zext i1 %cmp837 to i32
  store i32 %conv838, ptr %deformatter, align 4, !tbaa !29
  br label %cleanup

cleanup:                                          ; preds = %for.inc844, %cleanup.sink.split, %for.cond.preheader, %if.end403, %if.then638, %if.then200
  %retval.0 = phi i32 [ %2, %if.then200 ], [ %10, %if.then638 ], [ -1, %if.end403 ], [ -1, %for.cond.preheader ], [ %retval.0.ph, %cleanup.sink.split ], [ -1, %for.inc844 ]
  ret i32 %retval.0
}
...
!32 = distinct !{!32, !18}
!33 = distinct !{!33, !18}
!34 = !{i64 0, i64 8, !20, i64 8, i64 8, !20, i64 16, i64 8, !5}
!35 = distinct !{!35, !18}
!36 = distinct !{!36, !18}
!37 = distinct !{!37, !18}
!38 = !{!14, !16, i64 40}
!39 = !{!40, !10, i64 0}
!40 = !{!"strchartype", !10, i64 0, !10, i64 8, !10, i64 16}
!41 = !{!40, !10, i64 8}
!42 = distinct !{!42, !18}
!43 = !{!40, !10, i64 16}
!44 = distinct !{!44, !18}
