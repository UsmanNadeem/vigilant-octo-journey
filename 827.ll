; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/test2loop.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/test2loop.c"
...
cond.end119:                                      ; preds = %cond.true111, %cond.false114, %cond.true104
  ...
  %36 = insertelement <2 x i32> poison, i32 %cond120, i64 0
  %37 = insertelement <2 x i32> %36, i32 %cond81, i64 1
  %38 = sub <2 x i32> <i32 1, i32 1>, %37
  %mul143 = mul nsw i32 %add45, 1103515245
  %add144 = add nsw i32 %mul143, 12345
  %39 = insertelement <2 x i32> poison, i32 %cond139, i64 0
  %40 = insertelement <2 x i32> %39, i32 %cond100, i64 1
...
lor.lhs.false:                                    ; preds = %if.else223
  ...
  %or.cond516 = select i1 %cmp230, i1 %cmp235.not, i1 false
  br i1 %or.cond516, label %if.end238, label %do.body.backedge

if.end238:                                        ; preds = %lor.lhs.false
  %orient.le573 = getelementptr inbounds %struct.cellbox, ptr %32, i64 0, i32 5
  %68 = load i32, ptr %orient.le573, align 8, !tbaa !20
