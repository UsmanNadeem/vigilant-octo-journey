; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/SimpleMOC/solver.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/SimpleMOC/solver.c"
...
vector.memcheck941:                               ; preds = %for.body183.lr.ph
  ...
  %uglygep = getelementptr i8, ptr %6, i64 %163
  %uglygep942 = getelementptr i8, ptr %8, i64 %163
  %uglygep943 = getelementptr i8, ptr %10, i64 %163
  %uglygep944 = getelementptr i8, ptr %162, i64 %163
  %bound0 = icmp ult ptr %6, %uglygep942
  %bound1 = icmp ult ptr %8, %uglygep
  %found.conflict = and i1 %bound0, %bound1
  %bound0945 = icmp ult ptr %6, %uglygep943
  %bound1946 = icmp ult ptr %10, %uglygep
  %found.conflict947 = and i1 %bound0945, %bound1946
  %conflict.rdx948 = or i1 %found.conflict, %found.conflict947
  %bound0949 = icmp ult ptr %6, %uglygep944
  %bound1950 = icmp ult ptr %162, %uglygep
  %found.conflict951 = and i1 %bound0949, %bound1950
  %conflict.rdx952 = or i1 %conflict.rdx948, %found.conflict951
  %bound0953 = icmp ult ptr %8, %uglygep943
  %bound1954 = icmp ult ptr %10, %uglygep942
  %found.conflict955 = and i1 %bound0953, %bound1954
  %conflict.rdx956 = or i1 %conflict.rdx952, %found.conflict955
  %bound0957 = icmp ult ptr %8, %uglygep944
  %bound1958 = icmp ult ptr %162, %uglygep942
  %found.conflict959 = and i1 %bound0957, %bound1958
  %conflict.rdx960 = or i1 %conflict.rdx956, %found.conflict959
  %bound0961 = icmp ult ptr %10, %uglygep944
  %bound1962 = icmp ult ptr %162, %uglygep943
...
vector.memcheck1065:                              ; preds = %for.body331.preheader
  ...
  %uglygep1066 = getelementptr i8, ptr %32, i64 %281
  %uglygep1067 = getelementptr i8, ptr %18, i64 %281
  %bound01068 = icmp ult ptr %32, %uglygep1067
  %bound11069 = icmp ult ptr %18, %uglygep1066
...
for.cond47.preheader.preheader:                   ; preds = %for.cond47.preheader.lr.ph
  ...
  %uglygep406 = getelementptr i8, ptr %call7, i64 %9
  %10 = mul nsw i64 %idx.ext, 36
  %uglygep412 = getelementptr i8, ptr %call7, i64 %10
  %11 = mul nsw i64 %idx.ext, 12
  %uglygep416 = getelementptr i8, ptr %call7, i64 %11
  %12 = mul nsw i64 %idx.ext, 24
  %uglygep418 = getelementptr i8, ptr %call7, i64 %12
...
for.cond.cleanup80:                               ; preds = %while.end, %for.body67.for.cond.cleanup80_crit_edge
  %36 = phi i64 [ %.pre396, %for.body67.for.cond.cleanup80_crit_edge ], [ %133, %while.end ]
  %37 = phi ptr [ %.pre395, %for.body67.for.cond.cleanup80_crit_edge ], [ %132, %while.end ]
...
if.else113:                                       ; preds = %while.body
  ...
  %48 = load float, ptr %z_height95, align 4, !tbaa !40
  %sub = fsub float %z.0, %48
...
if.end150:                                        ; preds = %if.else113, %while.body, %if.then142
  ...
  %ds.0 = phi float [ %conv131, %if.then142 ], [ %s.0358, %while.body ], [ %conv131, %if.else113 ]
  ...
  %z.1 = phi float [ %z.0, %if.then142 ], [ %conv101, %while.body ], [ %z.0, %if.else113 ]
  %call151 = tail call i32 @glibc_compat_rand() #17
  %conv152 = sext i32 %call151 to i64
  %49 = load i64, ptr %n_source_regions_per_node, align 8, !tbaa !120
  %rem = srem i64 %conv152, %49
  %50 = load i32, ptr %axial_exp, align 8, !tbaa !121
  switch i32 %50, label %if.else171 [
    i32 2, label %if.then155
    i32 0, label %if.then164
  ]

if.then155:                                       ; preds = %if.end150
  %51 = load ptr, ptr %sources165, align 8, !tbaa !122
  %arrayidx156 = getelementptr inbounds %struct.Source, ptr %51, i64 %rem
  %52 = load ptr, ptr %params, align 8, !tbaa !112
  %arrayidx158 = getelementptr inbounds %struct.Track2D, ptr %52, i64 %i.0383
  %53 = load float, ptr %arrayidx158, align 8, !tbaa !123
  call void @attenuate_fluxes(ptr noundef nonnull %arrayidx86, i1 noundef zeroext true, ptr noundef %arrayidx156, ptr noundef nonnull %I, ptr noundef nonnull %params, float noundef %ds.0, float noundef %conv60, float noundef %53, ptr noundef nonnull %A)
  %.pre = load ptr, ptr %params, align 8, !tbaa !112
  br label %if.end175

if.then164:                                       ; preds = %if.end150
  %54 = load ptr, ptr %sources165, align 8, !tbaa !122
  %arrayidx166 = getelementptr inbounds %struct.Source, ptr %54, i64 %rem
  %55 = load ptr, ptr %params, align 8, !tbaa !112
  %arrayidx168 = getelementptr inbounds %struct.Track2D, ptr %55, i64 %i.0383
  %56 = load float, ptr %arrayidx168, align 8, !tbaa !123
  ...
  %57 = load float, ptr %height, align 4, !tbaa !100
  %58 = load i32, ptr %fai, align 4, !tbaa !103
  %59 = load i32, ptr %decomp_assemblies_ax, align 4, !tbaa !101
  %mul.i = mul nsw i32 %59, %58
  %60 = load i32, ptr %cai, align 8, !tbaa !102
  %mul5.i = mul nsw i32 %mul.i, %60
  %conv.i345 = sitofp i32 %mul5.i to float
  %div.i346 = fdiv float %57, %conv.i345
  %61 = load float, ptr %z_height95, align 4, !tbaa !40
  %div7.i = fdiv float %61, %div.i346
  %conv8.i = fptosi float %div7.i to i32
  %rem.i = srem i32 %conv8.i, %58
  %62 = load float, ptr %arrayidx86, align 8, !tbaa !42
  %mul15.i = fmul float %56, %62
  %mul16.i = fmul float %mul15.i, %conv60
  %63 = load ptr, ptr %arrayidx166, align 8, !tbaa !43
  %idxprom.i = sext i32 %rem.i to i64
  %arrayidx.i = getelementptr inbounds ptr, ptr %63, i64 %idxprom.i
  %64 = load ptr, ptr %arrayidx.i, align 8, !tbaa !16
  %65 = load i32, ptr %n_egroups, align 4, !tbaa !104
  %cmp131.i = icmp sgt i32 %65, 0
  br i1 %cmp131.i, label %for.body.lr.ph.i, label %if.end175

for.body.lr.ph.i:                                 ; preds = %if.then164
  %sigT18.i = getelementptr inbounds %struct.Source, ptr %54, i64 %rem, i32 3
  %66 = load ptr, ptr %sigT18.i, align 8, !tbaa !54
  %wide.trip.count.i = zext i32 %65 to i64
  %min.iters.check474 = icmp ult i32 %65, 20
...
vector.ph475:                                     ; preds = %vector.memcheck462
  ...
  %broadcast.splatinsert484 = insertelement <4 x float> poison, float %ds.0, i64 0
  %broadcast.splat485 = shufflevector <4 x float> %broadcast.splatinsert484, <4 x float> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert486 = insertelement <4 x float> poison, float %ds.0, i64 0
...
vector.body480:                                   ; preds = %vector.body480, %vector.ph475
  ...
  %72 = getelementptr inbounds float, ptr %66, i64 %index481
  %wide.load482 = load <4 x float>, ptr %72, align 4, !tbaa !10
  %73 = getelementptr inbounds float, ptr %72, i64 4
  %wide.load483 = load <4 x float>, ptr %73, align 4, !tbaa !10
  %74 = getelementptr inbounds float, ptr %add.ptr14, i64 %index481
  store <4 x float> %wide.load482, ptr %74, align 4, !tbaa !10
  %75 = getelementptr inbounds float, ptr %74, i64 4
  store <4 x float> %wide.load483, ptr %75, align 4, !tbaa !10
  %76 = fmul <4 x float> %broadcast.splat485, %wide.load482
  %77 = fmul <4 x float> %broadcast.splat487, %wide.load483
  %78 = getelementptr inbounds float, ptr %add.ptr17, i64 %index481
  store <4 x float> %76, ptr %78, align 4, !tbaa !10
  %79 = getelementptr inbounds float, ptr %78, i64 4
  store <4 x float> %77, ptr %79, align 4, !tbaa !10
  %index.next488 = add nuw i64 %index481, 8
  %80 = icmp eq i64 %index.next488, %n.vec477
  br i1 %80, label %middle.block472, label %vector.body480, !llvm.loop !124
...
for.body.i.preheader:                             ; preds = %vector.memcheck462, %for.body.lr.ph.i, %middle.block472
  ...
  %81 = xor i64 %indvars.iv.i.ph, -1
  %xtraiter = and i64 %wide.trip.count.i, 1
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %for.body.i.prol.loopexit, label %for.body.i.prol

for.body.i.prol:                                  ; preds = %for.body.i.preheader
  %arrayidx20.i.prol = getelementptr inbounds float, ptr %66, i64 %indvars.iv.i.ph
  %82 = load float, ptr %arrayidx20.i.prol, align 4, !tbaa !10
  %arrayidx22.i.prol = getelementptr inbounds float, ptr %add.ptr14, i64 %indvars.iv.i.ph
  store float %82, ptr %arrayidx22.i.prol, align 4, !tbaa !10
  %mul25.i.prol = fmul float %ds.0, %82
...
for.body.i.prol.loopexit:                         ; preds = %for.body.i.prol, %for.body.i.preheader
  ...
  %83 = sub nsw i64 0, %wide.trip.count.i
  %84 = icmp eq i64 %81, %83
  br i1 %84, label %for.body34.i.preheader, label %for.body.i
...
for.body.i:                                       ; preds = %for.body.i.prol.loopexit, %for.body.i
  ...
  %arrayidx20.i = getelementptr inbounds float, ptr %66, i64 %indvars.iv.i
  %85 = load float, ptr %arrayidx20.i, align 4, !tbaa !10
  %arrayidx22.i = getelementptr inbounds float, ptr %add.ptr14, i64 %indvars.iv.i
  store float %85, ptr %arrayidx22.i, align 4, !tbaa !10
  %mul25.i = fmul float %ds.0, %85
  ...
  %arrayidx20.i.1 = getelementptr inbounds float, ptr %66, i64 %indvars.iv.next.i
  %86 = load float, ptr %arrayidx20.i.1, align 4, !tbaa !10
  %arrayidx22.i.1 = getelementptr inbounds float, ptr %add.ptr14, i64 %indvars.iv.next.i
  store float %86, ptr %arrayidx22.i.1, align 4, !tbaa !10
  %mul25.i.1 = fmul float %ds.0, %86
...
for.body48.lr.ph.i:                               ; preds = %interpolateTable.exit.i
  ...
  %fine_source.i = getelementptr inbounds %struct.Source, ptr %54, i64 %rem, i32 1
  %87 = load ptr, ptr %fine_source.i, align 8, !tbaa !45
  %arrayidx50.i = getelementptr inbounds ptr, ptr %87, i64 %idxprom.i
  %88 = load ptr, ptr %arrayidx50.i, align 8, !tbaa !16
  %min.iters.check448 = icmp ult i32 %65, 8
...
vector.memcheck411:                               ; preds = %for.body48.lr.ph.i
  %89 = shl nuw nsw i64 %wide.trip.count.i, 2
  %uglygep413 = getelementptr i8, ptr %uglygep412, i64 %89
  %uglygep414 = getelementptr i8, ptr %psi.0.i, i64 %89
  %uglygep415 = getelementptr i8, ptr %88, i64 %89
  %uglygep417 = getelementptr i8, ptr %uglygep416, i64 %89
  %uglygep419 = getelementptr i8, ptr %uglygep418, i64 %89
  %bound0420 = icmp ult ptr %add.ptr32, %uglygep414
  %bound1421 = icmp ult ptr %psi.0.i, %uglygep413
  %found.conflict422 = and i1 %bound0420, %bound1421
  %bound0423 = icmp ult ptr %add.ptr32, %uglygep415
  %bound1424 = icmp ult ptr %88, %uglygep413
  %found.conflict425 = and i1 %bound0423, %bound1424
  %conflict.rdx = or i1 %found.conflict422, %found.conflict425
  %bound0426 = icmp ult ptr %add.ptr32, %uglygep417
  %bound1427 = icmp ult ptr %add.ptr14, %uglygep413
  %found.conflict428 = and i1 %bound0426, %bound1427
  %conflict.rdx429 = or i1 %conflict.rdx, %found.conflict428
  %bound0430 = icmp ult ptr %add.ptr32, %uglygep419
  %bound1431 = icmp ult ptr %add.ptr23, %uglygep413
  %found.conflict432 = and i1 %bound0430, %bound1431
  %conflict.rdx433 = or i1 %conflict.rdx429, %found.conflict432
  %bound0434 = icmp ult ptr %psi.0.i, %uglygep415
  %bound1435 = icmp ult ptr %88, %uglygep414
  %found.conflict436 = and i1 %bound0434, %bound1435
  %conflict.rdx437 = or i1 %conflict.rdx433, %found.conflict436
  %bound0438 = icmp ult ptr %psi.0.i, %uglygep417
  %bound1439 = icmp ult ptr %add.ptr14, %uglygep414
  %found.conflict440 = and i1 %bound0438, %bound1439
  %conflict.rdx441 = or i1 %conflict.rdx437, %found.conflict440
  %bound0442 = icmp ult ptr %psi.0.i, %uglygep419
  %bound1443 = icmp ult ptr %add.ptr23, %uglygep414
...
vector.body454:                                   ; preds = %vector.body454, %vector.ph449
  ...
  %90 = getelementptr inbounds float, ptr %88, i64 %index455
  %wide.load456 = load <4 x float>, ptr %90, align 4, !tbaa !10, !alias.scope !126
  %91 = getelementptr inbounds float, ptr %add.ptr14, i64 %index455
  %wide.load457 = load <4 x float>, ptr %91, align 4, !tbaa !10, !alias.scope !129
  %92 = fdiv <4 x float> %wide.load456, %wide.load457
  %93 = getelementptr inbounds float, ptr %psi.0.i, i64 %index455
  %wide.load458 = load <4 x float>, ptr %93, align 4, !tbaa !10, !alias.scope !131, !noalias !133
  %94 = fsub <4 x float> %wide.load458, %92
  %95 = getelementptr inbounds float, ptr %add.ptr23, i64 %index455
  %wide.load459 = load <4 x float>, ptr %95, align 4, !tbaa !10, !alias.scope !135
  %96 = fmul <4 x float> %94, %wide.load459
  %97 = fmul <4 x float> %broadcast.splat, %96
  %98 = getelementptr inbounds float, ptr %add.ptr32, i64 %index455
  store <4 x float> %97, ptr %98, align 4, !tbaa !10, !alias.scope !136, !noalias !138
  %wide.load460 = load <4 x float>, ptr %93, align 4, !tbaa !10, !alias.scope !131, !noalias !133
  %99 = fsub <4 x float> %wide.load460, %96
  store <4 x float> %99, ptr %93, align 4, !tbaa !10, !alias.scope !131, !noalias !133
  %index.next461 = add nuw i64 %index455, 4
  %100 = icmp eq i64 %index.next461, %n.vec451
  br i1 %100, label %middle.block446, label %vector.body454, !llvm.loop !139
...
for.body34.i:                                     ; preds = %for.body34.i.preheader, %interpolateTable.exit.i
  ...
  %101 = load float, ptr %arrayidx36.i, align 4, !tbaa !10
  %cmp.i.i = fcmp olt float %params.sroa.5.0.copyload.i, %101
  br i1 %cmp.i.i, label %interpolateTable.exit.i, label %if.else.i.i

if.else.i.i:                                      ; preds = %for.body34.i
  %div.i.i = fdiv float %101, %params.sroa.4.0.copyload.i
  %102 = tail call float @llvm.fmuladd.f32(float %params.sroa.4.0.copyload.i, float 5.000000e-01, float %div.i.i)
  %conv.i.i = fptosi float %102 to i32
  ...
  %103 = load float, ptr %arrayidx.i.i, align 4, !tbaa !10
  ...
  %104 = load float, ptr %arrayidx5.i.i, align 4, !tbaa !10
  %105 = tail call float @llvm.fmuladd.f32(float %103, float %101, float %104)
  br label %interpolateTable.exit.i

interpolateTable.exit.i:                          ; preds = %if.else.i.i, %for.body34.i
  %retval.0.i.i = phi float [ %105, %if.else.i.i ], [ 1.000000e+00, %for.body34.i ]
...
for.body48.i:                                     ; preds = %for.body48.i.preheader, %for.body48.i
  ...
  %arrayidx52.i = getelementptr inbounds float, ptr %88, i64 %indvars.iv145.i
  %106 = load float, ptr %arrayidx52.i, align 4, !tbaa !10
  %arrayidx54.i = getelementptr inbounds float, ptr %add.ptr14, i64 %indvars.iv145.i
  %107 = load float, ptr %arrayidx54.i, align 4, !tbaa !10
  %div55.i = fdiv float %106, %107
  %arrayidx57.i = getelementptr inbounds float, ptr %psi.0.i, i64 %indvars.iv145.i
  %108 = load float, ptr %arrayidx57.i, align 4, !tbaa !10
  %sub.i = fsub float %108, %div55.i
  %arrayidx59.i = getelementptr inbounds float, ptr %add.ptr23, i64 %indvars.iv145.i
  %109 = load float, ptr %arrayidx59.i, align 4, !tbaa !10
  %mul60.i = fmul float %sub.i, %109
  ...
  %110 = load float, ptr %arrayidx57.i, align 4, !tbaa !10
  %sub66.i = fsub float %110, %mul60.i
...
vector.memcheck:                                  ; preds = %for.body76.i.preheader
  %111 = shl nuw nsw i64 %wide.trip.count.i, 2
  %uglygep = getelementptr i8, ptr %64, i64 %111
  %uglygep407 = getelementptr i8, ptr %uglygep406, i64 %111
  %bound0 = icmp ult ptr %64, %uglygep407
  %bound1 = icmp ult ptr %add.ptr32, %uglygep
  %found.conflict = and i1 %bound0, %bound1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %112 = getelementptr inbounds float, ptr %add.ptr32, i64 %index
  %wide.load = load <4 x float>, ptr %112, align 4, !tbaa !10, !alias.scope !141
  %113 = getelementptr inbounds float, ptr %112, i64 4
  %wide.load408 = load <4 x float>, ptr %113, align 4, !tbaa !10, !alias.scope !141
  %114 = getelementptr inbounds float, ptr %64, i64 %index
  %wide.load409 = load <4 x float>, ptr %114, align 4, !tbaa !10, !alias.scope !144, !noalias !141
  %115 = getelementptr inbounds float, ptr %114, i64 4
  %wide.load410 = load <4 x float>, ptr %115, align 4, !tbaa !10, !alias.scope !144, !noalias !141
  %116 = fadd <4 x float> %wide.load, %wide.load409
  %117 = fadd <4 x float> %wide.load408, %wide.load410
  store <4 x float> %116, ptr %114, align 4, !tbaa !10, !alias.scope !144, !noalias !141
  store <4 x float> %117, ptr %115, align 4, !tbaa !10, !alias.scope !144, !noalias !141
  %index.next = add nuw i64 %index, 8
  %118 = icmp eq i64 %index.next, %n.vec
  br i1 %118, label %middle.block, label %vector.body, !llvm.loop !146
...
for.body76.i.preheader489:                        ; preds = %vector.memcheck, %for.body76.i.preheader, %middle.block
  ...
  %119 = xor i64 %indvars.iv150.i.ph, -1
  %120 = add nsw i64 %119, %wide.trip.count.i
...
for.body76.i.prol:                                ; preds = %for.body76.i.preheader489, %for.body76.i.prol
  ...
  %121 = load float, ptr %arrayidx78.i.prol, align 4, !tbaa !10
  %arrayidx80.i.prol = getelementptr inbounds float, ptr %64, i64 %indvars.iv150.i.prol
  %122 = load float, ptr %arrayidx80.i.prol, align 4, !tbaa !10
  %add81.i.prol = fadd float %121, %122
...
for.body76.i.prol.loopexit:                       ; preds = %for.body76.i.prol, %for.body76.i.preheader489
  ...
  %123 = icmp ult i64 %120, 3
  br i1 %123, label %if.end175, label %for.body76.i
...
for.body76.i:                                     ; preds = %for.body76.i.prol.loopexit, %for.body76.i
  ...
  %124 = load float, ptr %arrayidx78.i, align 4, !tbaa !10
  %arrayidx80.i = getelementptr inbounds float, ptr %64, i64 %indvars.iv150.i
  %125 = load float, ptr %arrayidx80.i, align 4, !tbaa !10
  %add81.i = fadd float %124, %125
  ...
  %126 = load float, ptr %arrayidx78.i.1, align 4, !tbaa !10
  %arrayidx80.i.1 = getelementptr inbounds float, ptr %64, i64 %indvars.iv.next151.i
  %127 = load float, ptr %arrayidx80.i.1, align 4, !tbaa !10
  %add81.i.1 = fadd float %126, %127
  ...
  %128 = load float, ptr %arrayidx78.i.2, align 4, !tbaa !10
  %arrayidx80.i.2 = getelementptr inbounds float, ptr %64, i64 %indvars.iv.next151.i.1
  %129 = load float, ptr %arrayidx80.i.2, align 4, !tbaa !10
  %add81.i.2 = fadd float %128, %129
  ...
  %130 = load float, ptr %arrayidx78.i.3, align 4, !tbaa !10
  %arrayidx80.i.3 = getelementptr inbounds float, ptr %64, i64 %indvars.iv.next151.i.2
  %131 = load float, ptr %arrayidx80.i.3, align 4, !tbaa !10
  %add81.i.3 = fadd float %130, %131
...
if.end175:                                        ; preds = %for.body76.i.prol.loopexit, %for.body76.i, %middle.block, %if.then164, %if.then155
  %132 = phi ptr [ %55, %if.then164 ], [ %.pre, %if.then155 ], [ %55, %middle.block ], [ %55, %for.body76.i ], [ %55, %for.body76.i.prol.loopexit ]
  %segments_processed.5 = add nsw i64 %segments_processed.4361, 1
  %n_segments179 = getelementptr inbounds %struct.Track2D, ptr %132, i64 %i.0383, i32 1
  %133 = load i64, ptr %n_segments179, align 8, !tbaa !113
  %sub180 = add nsw i64 %133, -1
...
if.then186:                                       ; preds = %if.end175
  %134 = load float, ptr %axial_z_sep, align 8, !tbaa !149
  br i1 %tobool.not, label %if.else192, label %if.then188

if.then188:                                       ; preds = %if.then186
  %mul190 = fmul float %134, %conv189
  br label %if.end200

if.else192:                                       ; preds = %if.then186
  %mul195 = fmul float %134, %conv194
  br label %if.end200

if.end200:                                        ; preds = %if.end175, %if.then188, %if.else192
  %mul190.sink = phi float [ %mul190, %if.then188 ], [ %mul195, %if.else192 ], [ %z.1, %if.end175 ]
  store float %mul190.sink, ptr %z_height95, align 4, !tbaa !40
  %135 = and i8 %seg_complete.2, 1
  %tobool94.not = icmp eq i8 %135, 0
  br i1 %tobool94.not, label %while.body, label %while.end

while.end:                                        ; preds = %if.end200
  %136 = sext i32 %end_stacked.4 to i64
  %cmp78 = icmp slt i64 %indvars.iv.next, %136
...
vector.memcheck165:                               ; preds = %for.body48.lr.ph
  ...
  %uglygep = getelementptr i8, ptr %0, i64 %37
  %uglygep166 = getelementptr i8, ptr %psi.0, i64 %37
  %uglygep167 = getelementptr i8, ptr %36, i64 %37
  %uglygep168 = getelementptr i8, ptr %2, i64 %37
  %uglygep169 = getelementptr i8, ptr %1, i64 %37
  %38 = insertelement <4 x ptr> poison, ptr %0, i64 0
  %39 = shufflevector <4 x ptr> %38, <4 x ptr> poison, <4 x i32> zeroinitializer
  %40 = insertelement <4 x ptr> poison, ptr %uglygep167, i64 0
  %41 = insertelement <4 x ptr> %40, ptr %uglygep166, i64 1
  %42 = insertelement <4 x ptr> %41, ptr %uglygep168, i64 2
  %43 = insertelement <4 x ptr> %42, ptr %uglygep169, i64 3
  ...
  %49 = insertelement <4 x ptr> poison, ptr %uglygep, i64 0
  %50 = shufflevector <4 x ptr> %49, <4 x ptr> poison, <4 x i32> zeroinitializer
  %51 = icmp ult <4 x ptr> %48, %50
  %52 = and <4 x i1> %44, %51
  %bound0182 = icmp ult ptr %psi.0, %uglygep167
  %bound1183 = icmp ult ptr %36, %uglygep166
  %found.conflict184 = and i1 %bound0182, %bound1183
  %bound0186 = icmp ult ptr %psi.0, %uglygep168
  %bound1187 = icmp ult ptr %2, %uglygep166
  %found.conflict188 = and i1 %bound0186, %bound1187
  %bound0190 = icmp ult ptr %psi.0, %uglygep169
  %bound1191 = icmp ult ptr %1, %uglygep166
...
vector.memcheck212:                               ; preds = %for.body76.preheader
  ...
  %uglygep213 = getelementptr i8, ptr %13, i64 %71
  %uglygep214 = getelementptr i8, ptr %0, i64 %71
  %bound0215 = icmp ult ptr %13, %uglygep214
  %bound1216 = icmp ult ptr %0, %uglygep213
...
for.body.lr.ph:                                   ; preds = %if.end
  ...
  %uglygep862 = getelementptr i8, ptr %call7, i64 %7
  %8 = mul nsw i64 %idx.ext, 36
  %uglygep879 = getelementptr i8, ptr %call7, i64 %8
  %9 = mul nsw i64 %idx.ext, 12
  %uglygep883 = getelementptr i8, ptr %call7, i64 %9
  %10 = mul nsw i64 %idx.ext, 24
  %uglygep885 = getelementptr i8, ptr %call7, i64 %10
  %11 = shl nsw i64 %idx.ext, 4
  %12 = add i64 %11, %call7932
  %13 = mul nsw i64 %idx.ext, 12
  %14 = add i64 %13, %call7932
  %15 = mul nsw i64 %idx.ext, 36
  %uglygep960 = getelementptr i8, ptr %call7, i64 %15
  %16 = mul nsw i64 %idx.ext, 36
  %uglygep981 = getelementptr i8, ptr %call7, i64 %16
  %17 = mul nsw i64 %idx.ext, 12
  %uglygep985 = getelementptr i8, ptr %call7, i64 %17
  %18 = mul nsw i64 %idx.ext, 24
  %uglygep987 = getelementptr i8, ptr %call7, i64 %18
...
vector.memcheck980:                               ; preds = %for.body48.lr.ph.i
  ...
  %uglygep982 = getelementptr i8, ptr %uglygep981, i64 %102
  %uglygep983 = getelementptr i8, ptr %psi.0.i, i64 %102
  %uglygep984 = getelementptr i8, ptr %101, i64 %102
  %uglygep986 = getelementptr i8, ptr %uglygep985, i64 %102
  %uglygep988 = getelementptr i8, ptr %uglygep987, i64 %102
  %bound0989 = icmp ult ptr %add.ptr32, %uglygep983
  %bound1990 = icmp ult ptr %psi.0.i, %uglygep982
  %found.conflict991 = and i1 %bound0989, %bound1990
  %bound0992 = icmp ult ptr %add.ptr32, %uglygep984
  %bound1993 = icmp ult ptr %101, %uglygep982
  %found.conflict994 = and i1 %bound0992, %bound1993
  %conflict.rdx995 = or i1 %found.conflict991, %found.conflict994
  %bound0996 = icmp ult ptr %add.ptr32, %uglygep986
  %bound1997 = icmp ult ptr %add.ptr14, %uglygep982
  %found.conflict998 = and i1 %bound0996, %bound1997
  %conflict.rdx999 = or i1 %conflict.rdx995, %found.conflict998
  %bound01000 = icmp ult ptr %add.ptr32, %uglygep988
  %bound11001 = icmp ult ptr %add.ptr23, %uglygep982
  %found.conflict1002 = and i1 %bound01000, %bound11001
  %conflict.rdx1003 = or i1 %conflict.rdx999, %found.conflict1002
  %bound01004 = icmp ult ptr %psi.0.i, %uglygep984
  %bound11005 = icmp ult ptr %101, %uglygep983
  %found.conflict1006 = and i1 %bound01004, %bound11005
  %conflict.rdx1007 = or i1 %conflict.rdx1003, %found.conflict1006
  %bound01008 = icmp ult ptr %psi.0.i, %uglygep986
  %bound11009 = icmp ult ptr %add.ptr14, %uglygep983
  %found.conflict1010 = and i1 %bound01008, %bound11009
  %conflict.rdx1011 = or i1 %conflict.rdx1007, %found.conflict1010
  %bound01012 = icmp ult ptr %psi.0.i, %uglygep988
  %bound11013 = icmp ult ptr %add.ptr23, %uglygep983
...
vector.memcheck958:                               ; preds = %for.body76.i.preheader
  ...
  %uglygep959 = getelementptr i8, ptr %77, i64 %124
  %uglygep961 = getelementptr i8, ptr %uglygep960, i64 %124
  %bound0962 = icmp ult ptr %77, %uglygep961
  %bound1963 = icmp ult ptr %add.ptr32, %uglygep959
...
vector.memcheck878:                               ; preds = %for.body48.lr.ph.i703
  ...
  %uglygep880 = getelementptr i8, ptr %uglygep879, i64 %240
  %uglygep881 = getelementptr i8, ptr %psi.0.i698, i64 %240
  %uglygep882 = getelementptr i8, ptr %239, i64 %240
  %uglygep884 = getelementptr i8, ptr %uglygep883, i64 %240
  %uglygep886 = getelementptr i8, ptr %uglygep885, i64 %240
  %bound0887 = icmp ult ptr %add.ptr32, %uglygep881
  %bound1888 = icmp ult ptr %psi.0.i698, %uglygep880
  %found.conflict889 = and i1 %bound0887, %bound1888
  %bound0890 = icmp ult ptr %add.ptr32, %uglygep882
  %bound1891 = icmp ult ptr %239, %uglygep880
  %found.conflict892 = and i1 %bound0890, %bound1891
  %conflict.rdx = or i1 %found.conflict889, %found.conflict892
  %bound0893 = icmp ult ptr %add.ptr32, %uglygep884
  %bound1894 = icmp ult ptr %add.ptr14, %uglygep880
  %found.conflict895 = and i1 %bound0893, %bound1894
  %conflict.rdx896 = or i1 %conflict.rdx, %found.conflict895
  %bound0897 = icmp ult ptr %add.ptr32, %uglygep886
  %bound1898 = icmp ult ptr %add.ptr23, %uglygep880
  %found.conflict899 = and i1 %bound0897, %bound1898
  %conflict.rdx900 = or i1 %conflict.rdx896, %found.conflict899
  %bound0901 = icmp ult ptr %psi.0.i698, %uglygep882
  %bound1902 = icmp ult ptr %239, %uglygep881
  %found.conflict903 = and i1 %bound0901, %bound1902
  %conflict.rdx904 = or i1 %conflict.rdx900, %found.conflict903
  %bound0905 = icmp ult ptr %psi.0.i698, %uglygep884
  %bound1906 = icmp ult ptr %add.ptr14, %uglygep881
  %found.conflict907 = and i1 %bound0905, %bound1906
  %conflict.rdx908 = or i1 %conflict.rdx904, %found.conflict907
  %bound0909 = icmp ult ptr %psi.0.i698, %uglygep886
  %bound1910 = icmp ult ptr %add.ptr23, %uglygep881
...
vector.memcheck:                                  ; preds = %for.body76.i745.preheader
  ...
  %uglygep = getelementptr i8, ptr %215, i64 %262
  %uglygep863 = getelementptr i8, ptr %uglygep862, i64 %262
  %bound0 = icmp ult ptr %215, %uglygep863
  %bound1 = icmp ult ptr %add.ptr32, %uglygep
  %found.conflict = and i1 %bound0, %bound1
...
for.body61.lr.ph:                                 ; preds = %for.cond.cleanup
  ...
  %or.cond = select i1 %cmp78224, i1 %cmp85222, i1 false
...
for.cond111.preheader.lr.ph:                      ; preds = %for.cond105.preheader
  ...
  %brmerge = select i1 %or.cond329.not330, i1 true, i1 %cmp125235
...
vector.memcheck:                                  ; preds = %for.cond123.preheader.us.us.us.us.us.us
  %uglygep = getelementptr i8, ptr %34, i64 %30
  %uglygep336 = getelementptr i8, ptr %35, i64 %30
  %bound0 = icmp ult ptr %34, %uglygep336
  %bound1 = icmp ult ptr %35, %uglygep
  %found.conflict = and i1 %bound0, %bound1
...
entry:
  ...
  %call15313 = ptrtoint ptr %call15 to i64
  %cmp213 = icmp sgt i64 %2, 0
...
for.body.lr.ph.split.us:                          ; preds = %for.body.lr.ph
  ...
  br i1 %cmp26164, label %for.body.us.us.us.us.preheader, label %for.body.us

for.body.us.us.us.us.preheader:                   ; preds = %for.body.lr.ph.split.us
  %wide.trip.count291 = zext i32 %.fr to i64
  %xtraiter = and i64 %wide.trip.count291, 1
  %4 = icmp eq i32 %.fr, 1
  %unroll_iter = and i64 %wide.trip.count291, 4294967294
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  %min.iters.check = icmp ult i32 %.fr, 8
  %n.vec = and i64 %wide.trip.count291, 4294967288
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count291
  %xtraiter320 = and i64 %wide.trip.count291, 3
  %lcmp.mod321.not = icmp eq i64 %xtraiter320, 0
  br label %for.body.us.us.us.us

for.body.us.us.us.us:                             ; preds = %for.body.us.us.us.us.preheader, %for.cond18.for.cond.cleanup22_crit_edge.split.us.us.us.split.us.us.split.us.us
  %i.0214.us.us.us.us = phi i64 [ %inc113.us.us.us.us, %for.cond18.for.cond.cleanup22_crit_edge.split.us.us.us.split.us.us.split.us.us ], [ 0, %for.body.us.us.us.us.preheader ]
  %arrayidx.us.us.us.us = getelementptr inbounds %struct.Source, ptr %3, i64 %i.0214.us.us.us.us
  %src.sroa.0.0.copyload.us.us.us.us = load ptr, ptr %arrayidx.us.us.us.us, align 8, !tbaa.struct !232
  %src.sroa.5.0.arrayidx.sroa_idx.us.us.us.us = getelementptr inbounds i8, ptr %arrayidx.us.us.us.us, i64 8
  %src.sroa.5.0.copyload.us.us.us.us = load ptr, ptr %src.sroa.5.0.arrayidx.sroa_idx.us.us.us.us, align 8, !tbaa.struct !247
  %src.sroa.7145.0.arrayidx.sroa_idx.us.us.us.us = getelementptr inbounds i8, ptr %arrayidx.us.us.us.us, i64 32
  %src.sroa.7145.0.copyload.us.us.us.us = load ptr, ptr %src.sroa.7145.0.arrayidx.sroa_idx.us.us.us.us, align 8, !tbaa.struct !234
  %src.sroa.9.0.arrayidx.sroa_idx.us.us.us.us = getelementptr inbounds i8, ptr %arrayidx.us.us.us.us, i64 40
  %src.sroa.9.0.copyload.us.us.us.us = load ptr, ptr %src.sroa.9.0.arrayidx.sroa_idx.us.us.us.us, align 8, !tbaa.struct !248
  br label %for.cond24.preheader.us.us.us.us.us.us.us

for.cond24.preheader.us.us.us.us.us.us.us:        ; preds = %for.cond44.for.cond.cleanup48_crit_edge.split.us.us.us.us.us.us.us.us, %for.body.us.us.us.us
  %indvars.iv303 = phi i64 [ %indvars.iv.next304, %for.cond44.for.cond.cleanup48_crit_edge.split.us.us.us.us.us.us.us.us ], [ 0, %for.body.us.us.us.us ]
  %arrayidx30.us.us.us.us.us.us.us = getelementptr inbounds ptr, ptr %src.sroa.0.0.copyload.us.us.us.us, i64 %indvars.iv303
  %5 = load ptr, ptr %arrayidx30.us.us.us.us.us.us.us, align 8, !tbaa !16
  br i1 %4, label %for.cond24.for.cond.cleanup28_crit_edge.us.us.us.us.us.us.us.unr-lcssa, label %for.body29.us.us.us.us.us.us.us

for.body29.us.us.us.us.us.us.us:                  ; preds = %for.cond24.preheader.us.us.us.us.us.us.us, %for.body29.us.us.us.us.us.us.us
  %indvars.iv288 = phi i64 [ %indvars.iv.next289.1, %for.body29.us.us.us.us.us.us.us ], [ 0, %for.cond24.preheader.us.us.us.us.us.us.us ]
  %niter = phi i64 [ %niter.next.1, %for.body29.us.us.us.us.us.us.us ], [ 0, %for.cond24.preheader.us.us.us.us.us.us.us ]
  %arrayidx32.us.us.us.us.us.us.us = getelementptr inbounds float, ptr %5, i64 %indvars.iv288
  %6 = load float, ptr %arrayidx32.us.us.us.us.us.us.us, align 4, !tbaa !10
  %arrayidx34.us.us.us.us.us.us.us = getelementptr inbounds ptr, ptr %src.sroa.7145.0.copyload.us.us.us.us, i64 %indvars.iv288
  %7 = load ptr, ptr %arrayidx34.us.us.us.us.us.us.us, align 8, !tbaa !16
  %8 = load float, ptr %7, align 4, !tbaa !10
  %mul36.us.us.us.us.us.us.us = fmul float %6, %8
  %arrayidx38.us.us.us.us.us.us.us = getelementptr inbounds float, ptr %call11, i64 %indvars.iv288
  store float %mul36.us.us.us.us.us.us.us, ptr %arrayidx38.us.us.us.us.us.us.us, align 4, !tbaa !10
  %indvars.iv.next289 = or i64 %indvars.iv288, 1
  %arrayidx32.us.us.us.us.us.us.us.1 = getelementptr inbounds float, ptr %5, i64 %indvars.iv.next289
  %9 = load float, ptr %arrayidx32.us.us.us.us.us.us.us.1, align 4, !tbaa !10
  %arrayidx34.us.us.us.us.us.us.us.1 = getelementptr inbounds ptr, ptr %src.sroa.7145.0.copyload.us.us.us.us, i64 %indvars.iv.next289
  %10 = load ptr, ptr %arrayidx34.us.us.us.us.us.us.us.1, align 8, !tbaa !16
  %11 = load float, ptr %10, align 4, !tbaa !10
  %mul36.us.us.us.us.us.us.us.1 = fmul float %9, %11
  %arrayidx38.us.us.us.us.us.us.us.1 = getelementptr inbounds float, ptr %call11, i64 %indvars.iv.next289
  store float %mul36.us.us.us.us.us.us.us.1, ptr %arrayidx38.us.us.us.us.us.us.us.1, align 4, !tbaa !10
  %indvars.iv.next289.1 = add nuw nsw i64 %indvars.iv288, 2
  %niter.next.1 = add i64 %niter, 2
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %for.cond24.for.cond.cleanup28_crit_edge.us.us.us.us.us.us.us.unr-lcssa, label %for.body29.us.us.us.us.us.us.us

for.cond24.for.cond.cleanup28_crit_edge.us.us.us.us.us.us.us.unr-lcssa: ; preds = %for.body29.us.us.us.us.us.us.us, %for.cond24.preheader.us.us.us.us.us.us.us
  %indvars.iv288.unr = phi i64 [ 0, %for.cond24.preheader.us.us.us.us.us.us.us ], [ %indvars.iv.next289.1, %for.body29.us.us.us.us.us.us.us ]
  br i1 %lcmp.mod.not, label %for.cond24.for.cond.cleanup28_crit_edge.us.us.us.us.us.us.us, label %for.body29.us.us.us.us.us.us.us.epil

for.body29.us.us.us.us.us.us.us.epil:             ; preds = %for.cond24.for.cond.cleanup28_crit_edge.us.us.us.us.us.us.us.unr-lcssa
  %arrayidx32.us.us.us.us.us.us.us.epil = getelementptr inbounds float, ptr %5, i64 %indvars.iv288.unr
  %12 = load float, ptr %arrayidx32.us.us.us.us.us.us.us.epil, align 4, !tbaa !10
  %arrayidx34.us.us.us.us.us.us.us.epil = getelementptr inbounds ptr, ptr %src.sroa.7145.0.copyload.us.us.us.us, i64 %indvars.iv288.unr
  %13 = load ptr, ptr %arrayidx34.us.us.us.us.us.us.us.epil, align 8, !tbaa !16
  %14 = load float, ptr %13, align 4, !tbaa !10
  %mul36.us.us.us.us.us.us.us.epil = fmul float %12, %14
  %arrayidx38.us.us.us.us.us.us.us.epil = getelementptr inbounds float, ptr %call11, i64 %indvars.iv288.unr
  store float %mul36.us.us.us.us.us.us.us.epil, ptr %arrayidx38.us.us.us.us.us.us.us.epil, align 4, !tbaa !10
  br label %for.cond24.for.cond.cleanup28_crit_edge.us.us.us.us.us.us.us

for.cond24.for.cond.cleanup28_crit_edge.us.us.us.us.us.us.us: ; preds = %for.cond24.for.cond.cleanup28_crit_edge.us.us.us.us.us.us.us.unr-lcssa, %for.body29.us.us.us.us.us.us.us.epil
  %call41.us.us.us.us.us.us.us = tail call float @pairwise_sum(ptr noundef nonnull %call11, i64 noundef %conv2) #17
  %mul42.us.us.us.us.us.us.us = fmul float %conv1, %call41.us.us.us.us.us.us.us
  %arrayidx83.us.us.us.us.us.us.us = getelementptr inbounds ptr, ptr %src.sroa.5.0.copyload.us.us.us.us, i64 %indvars.iv303
  br label %for.cond50.preheader.us.us.us.us.us.us.us.us

for.cond50.preheader.us.us.us.us.us.us.us.us:     ; preds = %for.cond50.for.cond.cleanup54_crit_edge.us.us.us.us.us.us.us.us, %for.cond24.for.cond.cleanup28_crit_edge.us.us.us.us.us.us.us
  %indvars.iv298 = phi i64 [ %indvars.iv.next299, %for.cond50.for.cond.cleanup54_crit_edge.us.us.us.us.us.us.us.us ], [ 0, %for.cond24.for.cond.cleanup28_crit_edge.us.us.us.us.us.us.us ]
  %arrayidx57.us.us.us.us.us.us.us.us = getelementptr inbounds ptr, ptr %src.sroa.9.0.copyload.us.us.us.us, i64 %indvars.iv298
  %15 = load ptr, ptr %arrayidx57.us.us.us.us.us.us.us.us, align 8, !tbaa !16
  %16 = load ptr, ptr %arrayidx30.us.us.us.us.us.us.us, align 8, !tbaa !16
  br i1 %min.iters.check, label %for.body55.us.us.us.us.us.us.us.us.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %for.cond50.preheader.us.us.us.us.us.us.us.us
  %17 = ptrtoint ptr %16 to i64
  %18 = ptrtoint ptr %15 to i64
  %19 = sub i64 %call15313, %18
  %diff.check = icmp ult i64 %19, 32
  %20 = sub i64 %call15313, %17
  %diff.check314 = icmp ult i64 %20, 32
  %conflict.rdx = or i1 %diff.check, %diff.check314
  br i1 %conflict.rdx, label %for.body55.us.us.us.us.us.us.us.us.preheader, label %vector.body
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %wide.load315 = load <4 x float>, ptr %22, align 4, !tbaa !10
  %23 = getelementptr inbounds float, ptr %16, i64 %index
  %wide.load316 = load <4 x float>, ptr %23, align 4, !tbaa !10
  %24 = getelementptr inbounds float, ptr %23, i64 4
  %wide.load317 = load <4 x float>, ptr %24, align 4, !tbaa !10
  %25 = fmul <4 x float> %wide.load, %wide.load316
  %26 = fmul <4 x float> %wide.load315, %wide.load317
...
middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %for.cond50.for.cond.cleanup54_crit_edge.us.us.us.us.us.us.us.us, label %for.body55.us.us.us.us.us.us.us.us.preheader

for.body55.us.us.us.us.us.us.us.us.preheader:     ; preds = %vector.memcheck, %for.cond50.preheader.us.us.us.us.us.us.us.us, %middle.block
  %indvars.iv293.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %for.cond50.preheader.us.us.us.us.us.us.us.us ], [ %n.vec, %middle.block ]
  %30 = xor i64 %indvars.iv293.ph, -1
  %31 = add nsw i64 %30, %wide.trip.count291
  br i1 %lcmp.mod321.not, label %for.body55.us.us.us.us.us.us.us.us.prol.loopexit, label %for.body55.us.us.us.us.us.us.us.us.prol

for.body55.us.us.us.us.us.us.us.us.prol:          ; preds = %for.body55.us.us.us.us.us.us.us.us.preheader, %for.body55.us.us.us.us.us.us.us.us.prol
  %indvars.iv293.prol = phi i64 [ %indvars.iv.next294.prol, %for.body55.us.us.us.us.us.us.us.us.prol ], [ %indvars.iv293.ph, %for.body55.us.us.us.us.us.us.us.us.preheader ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body55.us.us.us.us.us.us.us.us.prol ], [ 0, %for.body55.us.us.us.us.us.us.us.us.preheader ]
  %arrayidx59.us.us.us.us.us.us.us.us.prol = getelementptr inbounds float, ptr %15, i64 %indvars.iv293.prol
  %32 = load float, ptr %arrayidx59.us.us.us.us.us.us.us.us.prol, align 4, !tbaa !10
  %arrayidx64.us.us.us.us.us.us.us.us.prol = getelementptr inbounds float, ptr %16, i64 %indvars.iv293.prol
  %33 = load float, ptr %arrayidx64.us.us.us.us.us.us.us.us.prol, align 4, !tbaa !10
  %mul65.us.us.us.us.us.us.us.us.prol = fmul float %32, %33
  %arrayidx67.us.us.us.us.us.us.us.us.prol = getelementptr inbounds float, ptr %call15, i64 %indvars.iv293.prol
  store float %mul65.us.us.us.us.us.us.us.us.prol, ptr %arrayidx67.us.us.us.us.us.us.us.us.prol, align 4, !tbaa !10
  %indvars.iv.next294.prol = add nuw nsw i64 %indvars.iv293.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter320
  br i1 %prol.iter.cmp.not, label %for.body55.us.us.us.us.us.us.us.us.prol.loopexit, label %for.body55.us.us.us.us.us.us.us.us.prol, !llvm.loop !250

for.body55.us.us.us.us.us.us.us.us.prol.loopexit: ; preds = %for.body55.us.us.us.us.us.us.us.us.prol, %for.body55.us.us.us.us.us.us.us.us.preheader
  %indvars.iv293.unr = phi i64 [ %indvars.iv293.ph, %for.body55.us.us.us.us.us.us.us.us.preheader ], [ %indvars.iv.next294.prol, %for.body55.us.us.us.us.us.us.us.us.prol ]
  %34 = icmp ult i64 %31, 3
  br i1 %34, label %for.cond50.for.cond.cleanup54_crit_edge.us.us.us.us.us.us.us.us, label %for.body55.us.us.us.us.us.us.us.us

for.body55.us.us.us.us.us.us.us.us:               ; preds = %for.body55.us.us.us.us.us.us.us.us.prol.loopexit, %for.body55.us.us.us.us.us.us.us.us
  %indvars.iv293 = phi i64 [ %indvars.iv.next294.3, %for.body55.us.us.us.us.us.us.us.us ], [ %indvars.iv293.unr, %for.body55.us.us.us.us.us.us.us.us.prol.loopexit ]
  %arrayidx59.us.us.us.us.us.us.us.us = getelementptr inbounds float, ptr %15, i64 %indvars.iv293
  %35 = load float, ptr %arrayidx59.us.us.us.us.us.us.us.us, align 4, !tbaa !10
  %arrayidx64.us.us.us.us.us.us.us.us = getelementptr inbounds float, ptr %16, i64 %indvars.iv293
  %36 = load float, ptr %arrayidx64.us.us.us.us.us.us.us.us, align 4, !tbaa !10
  %mul65.us.us.us.us.us.us.us.us = fmul float %35, %36
  %arrayidx67.us.us.us.us.us.us.us.us = getelementptr inbounds float, ptr %call15, i64 %indvars.iv293
  store float %mul65.us.us.us.us.us.us.us.us, ptr %arrayidx67.us.us.us.us.us.us.us.us, align 4, !tbaa !10
  %indvars.iv.next294 = add nuw nsw i64 %indvars.iv293, 1
  %arrayidx59.us.us.us.us.us.us.us.us.1 = getelementptr inbounds float, ptr %15, i64 %indvars.iv.next294
  %37 = load float, ptr %arrayidx59.us.us.us.us.us.us.us.us.1, align 4, !tbaa !10
  %arrayidx64.us.us.us.us.us.us.us.us.1 = getelementptr inbounds float, ptr %16, i64 %indvars.iv.next294
  %38 = load float, ptr %arrayidx64.us.us.us.us.us.us.us.us.1, align 4, !tbaa !10
  %mul65.us.us.us.us.us.us.us.us.1 = fmul float %37, %38
  %arrayidx67.us.us.us.us.us.us.us.us.1 = getelementptr inbounds float, ptr %call15, i64 %indvars.iv.next294
  store float %mul65.us.us.us.us.us.us.us.us.1, ptr %arrayidx67.us.us.us.us.us.us.us.us.1, align 4, !tbaa !10
  %indvars.iv.next294.1 = add nuw nsw i64 %indvars.iv293, 2
  %arrayidx59.us.us.us.us.us.us.us.us.2 = getelementptr inbounds float, ptr %15, i64 %indvars.iv.next294.1
  %39 = load float, ptr %arrayidx59.us.us.us.us.us.us.us.us.2, align 4, !tbaa !10
  %arrayidx64.us.us.us.us.us.us.us.us.2 = getelementptr inbounds float, ptr %16, i64 %indvars.iv.next294.1
  %40 = load float, ptr %arrayidx64.us.us.us.us.us.us.us.us.2, align 4, !tbaa !10
  %mul65.us.us.us.us.us.us.us.us.2 = fmul float %39, %40
  %arrayidx67.us.us.us.us.us.us.us.us.2 = getelementptr inbounds float, ptr %call15, i64 %indvars.iv.next294.1
  store float %mul65.us.us.us.us.us.us.us.us.2, ptr %arrayidx67.us.us.us.us.us.us.us.us.2, align 4, !tbaa !10
  %indvars.iv.next294.2 = add nuw nsw i64 %indvars.iv293, 3
  %arrayidx59.us.us.us.us.us.us.us.us.3 = getelementptr inbounds float, ptr %15, i64 %indvars.iv.next294.2
  %41 = load float, ptr %arrayidx59.us.us.us.us.us.us.us.us.3, align 4, !tbaa !10
  %arrayidx64.us.us.us.us.us.us.us.us.3 = getelementptr inbounds float, ptr %16, i64 %indvars.iv.next294.2
  %42 = load float, ptr %arrayidx64.us.us.us.us.us.us.us.us.3, align 4, !tbaa !10
  %mul65.us.us.us.us.us.us.us.us.3 = fmul float %41, %42
  %arrayidx67.us.us.us.us.us.us.us.us.3 = getelementptr inbounds float, ptr %call15, i64 %indvars.iv.next294.2
  store float %mul65.us.us.us.us.us.us.us.us.3, ptr %arrayidx67.us.us.us.us.us.us.us.us.3, align 4, !tbaa !10
  %indvars.iv.next294.3 = add nuw nsw i64 %indvars.iv293, 4
  %exitcond297.not.3 = icmp eq i64 %indvars.iv.next294.3, %wide.trip.count291
  br i1 %exitcond297.not.3, label %for.cond50.for.cond.cleanup54_crit_edge.us.us.us.us.us.us.us.us, label %for.body55.us.us.us.us.us.us.us.us, !llvm.loop !251

for.cond50.for.cond.cleanup54_crit_edge.us.us.us.us.us.us.us.us: ; preds = %for.body55.us.us.us.us.us.us.us.us.prol.loopexit, %for.body55.us.us.us.us.us.us.us.us, %middle.block
  %call73.us.us.us.us.us.us.us.us = tail call float @pairwise_sum(ptr noundef nonnull %call15, i64 noundef %conv2) #17
  %arrayidx76.us.us.us.us.us.us.us.us = getelementptr inbounds ptr, ptr %src.sroa.7145.0.copyload.us.us.us.us, i64 %indvars.iv298
  %43 = load ptr, ptr %arrayidx76.us.us.us.us.us.us.us.us, align 8, !tbaa !16
  %arrayidx77.us.us.us.us.us.us.us.us = getelementptr inbounds float, ptr %43, i64 2
  %44 = load float, ptr %arrayidx77.us.us.us.us.us.us.us.us, align 4, !tbaa !10
  %45 = tail call float @llvm.fmuladd.f32(float %mul42.us.us.us.us.us.us.us, float %44, float %call73.us.us.us.us.us.us.us.us)
  %conv79.us.us.us.us.us.us.us.us = fpext float %45 to double
  %div80.us.us.us.us.us.us.us.us = fdiv double %conv79.us.us.us.us.us.us.us.us, 0x402921FB54442D18
  %conv81.us.us.us.us.us.us.us.us = fptrunc double %div80.us.us.us.us.us.us.us.us to float
  %46 = load ptr, ptr %arrayidx83.us.us.us.us.us.us.us, align 8, !tbaa !16
  %arrayidx85.us.us.us.us.us.us.us.us = getelementptr inbounds float, ptr %46, i64 %indvars.iv298
  %47 = load float, ptr %arrayidx85.us.us.us.us.us.us.us.us, align 4, !tbaa !10
  %sub.us.us.us.us.us.us.us.us = fsub float %conv81.us.us.us.us.us.us.us.us, %47
  %mul87.us.us.us.us.us.us.us.us = fmul float %sub.us.us.us.us.us.us.us.us, %sub.us.us.us.us.us.us.us.us
  %mul88.us.us.us.us.us.us.us.us = fmul float %47, %47
  %div89.us.us.us.us.us.us.us.us = fdiv float %mul87.us.us.us.us.us.us.us.us, %mul88.us.us.us.us.us.us.us.us
  %arrayidx91.us.us.us.us.us.us.us.us = getelementptr inbounds float, ptr %call, i64 %indvars.iv298
  store float %div89.us.us.us.us.us.us.us.us, ptr %arrayidx91.us.us.us.us.us.us.us.us, align 4, !tbaa !10
  store float %conv81.us.us.us.us.us.us.us.us, ptr %arrayidx85.us.us.us.us.us.us.us.us, align 4, !tbaa !10
  %indvars.iv.next299 = add nuw nsw i64 %indvars.iv298, 1
  %exitcond302.not = icmp eq i64 %indvars.iv.next299, %wide.trip.count291
  br i1 %exitcond302.not, label %for.cond44.for.cond.cleanup48_crit_edge.split.us.us.us.us.us.us.us.us, label %for.cond50.preheader.us.us.us.us.us.us.us.us

for.cond44.for.cond.cleanup48_crit_edge.split.us.us.us.us.us.us.us.us: ; preds = %for.cond50.for.cond.cleanup54_crit_edge.us.us.us.us.us.us.us.us
  %call102.us.us.us.us.us.us.us = tail call float @pairwise_sum(ptr noundef nonnull %call, i64 noundef %conv2) #17
  %arrayidx104.us.us.us.us.us.us.us = getelementptr inbounds float, ptr %call5, i64 %indvars.iv303
  store float %call102.us.us.us.us.us.us.us, ptr %arrayidx104.us.us.us.us.us.us.us, align 4, !tbaa !10
  %indvars.iv.next304 = add nuw nsw i64 %indvars.iv303, 1
  %exitcond307.not = icmp eq i64 %indvars.iv.next304, %wide.trip.count306
  br i1 %exitcond307.not, label %for.cond18.for.cond.cleanup22_crit_edge.split.us.us.us.split.us.us.split.us.us, label %for.cond24.preheader.us.us.us.us.us.us.us

for.cond18.for.cond.cleanup22_crit_edge.split.us.us.us.split.us.us.split.us.us: ; preds = %for.cond44.for.cond.cleanup48_crit_edge.split.us.us.us.us.us.us.us.us
  %call110.us.us.us.us = tail call float @pairwise_sum(ptr noundef nonnull %call5, i64 noundef %conv3) #17
  %arrayidx111.us.us.us.us = getelementptr inbounds float, ptr %call7, i64 %i.0214.us.us.us.us
  store float %call110.us.us.us.us, ptr %arrayidx111.us.us.us.us, align 4, !tbaa !10
  %inc113.us.us.us.us = add nuw nsw i64 %i.0214.us.us.us.us, 1
  %exitcond308.not = icmp eq i64 %inc113.us.us.us.us, %2
  br i1 %exitcond308.not, label %for.cond.cleanup, label %for.body.us.us.us.us

for.body.us:                                      ; preds = %for.body.lr.ph.split.us, %for.cond18.for.cond.cleanup22_crit_edge.split.split.us223
  %i.0214.us = phi i64 [ %inc113.us, %for.cond18.for.cond.cleanup22_crit_edge.split.split.us223 ], [ 0, %for.body.lr.ph.split.us ]
  br label %for.cond24.preheader.us215

for.cond24.preheader.us215:                       ; preds = %for.body.us, %for.cond24.preheader.us215
  %indvars.iv = phi i64 [ 0, %for.body.us ], [ %indvars.iv.next, %for.cond24.preheader.us215 ]
  %call41.us217 = tail call float @pairwise_sum(ptr noundef %call11, i64 noundef %conv2) #17
  %call102.us218 = tail call float @pairwise_sum(ptr noundef %call, i64 noundef %conv2) #17
  %arrayidx104.us220 = getelementptr inbounds float, ptr %call5, i64 %indvars.iv
  store float %call102.us218, ptr %arrayidx104.us220, align 4, !tbaa !10
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond243.not = icmp eq i64 %indvars.iv.next, %wide.trip.count306
  br i1 %exitcond243.not, label %for.cond18.for.cond.cleanup22_crit_edge.split.split.us223, label %for.cond24.preheader.us215

for.cond18.for.cond.cleanup22_crit_edge.split.split.us223: ; preds = %for.cond24.preheader.us215
  %call110.us = tail call float @pairwise_sum(ptr noundef nonnull %call5, i64 noundef %conv3) #17
  %arrayidx111.us = getelementptr inbounds float, ptr %call7, i64 %i.0214.us
  store float %call110.us, ptr %arrayidx111.us, align 4, !tbaa !10
  %inc113.us = add nuw nsw i64 %i.0214.us, 1
  %exitcond244.not = icmp eq i64 %inc113.us, %2
  br i1 %exitcond244.not, label %for.cond.cleanup, label %for.body.us

for.cond.cleanup:                                 ; preds = %for.body, %for.cond18.for.cond.cleanup22_crit_edge.split.split.us223, %for.cond18.for.cond.cleanup22_crit_edge.split.us.us.us.split.us.us.split.us.us, %entry
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  %i.0214 = phi i64 [ %inc113, %for.body ], [ 0, %for.body.lr.ph ]
  %call110 = tail call float @pairwise_sum(ptr noundef %call5, i64 noundef %conv3) #17
  %arrayidx111 = getelementptr inbounds float, ptr %call7, i64 %i.0214
  store float %call110, ptr %arrayidx111, align 4, !tbaa !10
  %inc113 = add nuw nsw i64 %i.0214, 1
...
entry:
  ...
  %call4311 = ptrtoint ptr %call4 to i64
  %fai = getelementptr inbounds %struct.Input, ptr %I, i64 0, i32 3
  %1 = load i32, ptr %fai, align 4, !tbaa !103
...
for.cond.cleanup.thread:                          ; preds = %entry
  %call64301 = tail call float @pairwise_sum(ptr noundef %call9, i64 noundef %2) #17
...
for.body.lr.ph.split.us:                          ; preds = %for.body.lr.ph
  br i1 %cmp14186, label %for.body.us.us.preheader, label %for.body.us.preheader
...
for.body.us.us.preheader:                         ; preds = %for.body.lr.ph.split.us
  %wide.trip.count267 = zext i32 %0 to i64
  %wide.trip.count277 = zext i32 %1 to i64
  %wide.trip.count272 = zext i32 %0 to i64
  %xtraiter339 = and i64 %wide.trip.count267, 3
  %4 = icmp ult i32 %0, 4
  %unroll_iter342 = and i64 %wide.trip.count267, 4294967292
  %lcmp.mod341.not = icmp eq i64 %xtraiter339, 0
  %min.iters.check = icmp ult i32 %0, 8
  %n.vec = and i64 %wide.trip.count267, 4294967288
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count267
  %xtraiter344 = and i64 %wide.trip.count267, 3
...
for.body17.us.us:                                 ; preds = %for.body17.us.us.preheader, %for.body17.us.us
  %indvars.iv264 = phi i64 [ %indvars.iv.next265.3, %for.body17.us.us ], [ 0, %for.body17.us.us.preheader ]
  %niter343 = phi i64 [ %niter343.next.3, %for.body17.us.us ], [ 0, %for.body17.us.us.preheader ]
  %arrayidx18.us.us = getelementptr inbounds ptr, ptr %src.sroa.4161.0.copyload.us.us, i64 %indvars.iv264
  ...
  %arrayidx21.us.us = getelementptr inbounds float, ptr %call, i64 %indvars.iv264
  store float %6, ptr %arrayidx21.us.us, align 4, !tbaa !10
  %indvars.iv.next265 = or i64 %indvars.iv264, 1
  %arrayidx18.us.us.1 = getelementptr inbounds ptr, ptr %src.sroa.4161.0.copyload.us.us, i64 %indvars.iv.next265
  ...
  %arrayidx21.us.us.1 = getelementptr inbounds float, ptr %call, i64 %indvars.iv.next265
  store float %8, ptr %arrayidx21.us.us.1, align 4, !tbaa !10
  %indvars.iv.next265.1 = or i64 %indvars.iv264, 2
  %arrayidx18.us.us.2 = getelementptr inbounds ptr, ptr %src.sroa.4161.0.copyload.us.us, i64 %indvars.iv.next265.1
  ...
  %arrayidx21.us.us.2 = getelementptr inbounds float, ptr %call, i64 %indvars.iv.next265.1
  store float %10, ptr %arrayidx21.us.us.2, align 4, !tbaa !10
  %indvars.iv.next265.2 = or i64 %indvars.iv264, 3
  %arrayidx18.us.us.3 = getelementptr inbounds ptr, ptr %src.sroa.4161.0.copyload.us.us, i64 %indvars.iv.next265.2
  ...
  %arrayidx21.us.us.3 = getelementptr inbounds float, ptr %call, i64 %indvars.iv.next265.2
  store float %12, ptr %arrayidx21.us.us.3, align 4, !tbaa !10
  %indvars.iv.next265.3 = add nuw nsw i64 %indvars.iv264, 4
  %niter343.next.3 = add i64 %niter343, 4
  %niter343.ncmp.3 = icmp eq i64 %niter343.next.3, %unroll_iter342
  br i1 %niter343.ncmp.3, label %for.body27.us.us.us.preheader.unr-lcssa, label %for.body17.us.us

for.body27.us.us.us.preheader.unr-lcssa:          ; preds = %for.body17.us.us, %for.body17.us.us.preheader
  %indvars.iv264.unr = phi i64 [ 0, %for.body17.us.us.preheader ], [ %indvars.iv.next265.3, %for.body17.us.us ]
  br i1 %lcmp.mod341.not, label %for.body27.us.us.us.preheader, label %for.body17.us.us.epil

for.body17.us.us.epil:                            ; preds = %for.body27.us.us.us.preheader.unr-lcssa, %for.body17.us.us.epil
  %indvars.iv264.epil = phi i64 [ %indvars.iv.next265.epil, %for.body17.us.us.epil ], [ %indvars.iv264.unr, %for.body27.us.us.us.preheader.unr-lcssa ]
  %epil.iter340 = phi i64 [ %epil.iter340.next, %for.body17.us.us.epil ], [ 0, %for.body27.us.us.us.preheader.unr-lcssa ]
  %arrayidx18.us.us.epil = getelementptr inbounds ptr, ptr %src.sroa.4161.0.copyload.us.us, i64 %indvars.iv264.epil
  ...
  %arrayidx21.us.us.epil = getelementptr inbounds float, ptr %call, i64 %indvars.iv264.epil
  store float %14, ptr %arrayidx21.us.us.epil, align 4, !tbaa !10
  %indvars.iv.next265.epil = add nuw nsw i64 %indvars.iv264.epil, 1
  %epil.iter340.next = add i64 %epil.iter340, 1
  %epil.iter340.cmp.not = icmp eq i64 %epil.iter340.next, %xtraiter339
  br i1 %epil.iter340.cmp.not, label %for.body27.us.us.us.preheader, label %for.body17.us.us.epil, !llvm.loop !252
...
for.body27.us.us.us:                              ; preds = %for.body27.us.us.us.preheader, %for.cond32.for.cond.cleanup36_crit_edge.us.us.us
  %indvars.iv274 = phi i64 [ %indvars.iv.next275, %for.cond32.for.cond.cleanup36_crit_edge.us.us.us ], [ 0, %for.body27.us.us.us.preheader ]
  %arrayidx30.us.us.us = getelementptr inbounds ptr, ptr %src.sroa.0.0.copyload.us.us, i64 %indvars.iv274
  %15 = load ptr, ptr %arrayidx30.us.us.us, align 8, !tbaa !16
  %16 = ptrtoint ptr %15 to i64
  %17 = sub i64 %call4311, %16
  %diff.check = icmp ult i64 %17, 32
...
vector.body:                                      ; preds = %for.body27.us.us.us, %vector.body
  ...
  %wide.load312 = load <4 x float>, ptr %19, align 4, !tbaa !10
  %20 = getelementptr inbounds float, ptr %15, i64 %index
  %wide.load313 = load <4 x float>, ptr %20, align 4, !tbaa !10
  %21 = getelementptr inbounds float, ptr %20, i64 4
  %wide.load314 = load <4 x float>, ptr %21, align 4, !tbaa !10
  %22 = fmul <4 x float> %wide.load, %wide.load313
  %23 = fmul <4 x float> %wide.load312, %wide.load314
...
for.body37.us.us.us.preheader:                    ; preds = %for.body27.us.us.us, %middle.block
  %indvars.iv269.ph = phi i64 [ 0, %for.body27.us.us.us ], [ %n.vec, %middle.block ]
  %27 = xor i64 %indvars.iv269.ph, -1
  %28 = add nsw i64 %27, %wide.trip.count267
  br i1 %lcmp.mod345.not, label %for.body37.us.us.us.prol.loopexit, label %for.body37.us.us.us.prol

for.body37.us.us.us.prol:                         ; preds = %for.body37.us.us.us.preheader, %for.body37.us.us.us.prol
  %indvars.iv269.prol = phi i64 [ %indvars.iv.next270.prol, %for.body37.us.us.us.prol ], [ %indvars.iv269.ph, %for.body37.us.us.us.preheader ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body37.us.us.us.prol ], [ 0, %for.body37.us.us.us.preheader ]
  %arrayidx39.us.us.us.prol = getelementptr inbounds float, ptr %call, i64 %indvars.iv269.prol
  %29 = load float, ptr %arrayidx39.us.us.us.prol, align 4, !tbaa !10
  %arrayidx41.us.us.us.prol = getelementptr inbounds float, ptr %15, i64 %indvars.iv269.prol
  %30 = load float, ptr %arrayidx41.us.us.us.prol, align 4, !tbaa !10
  %mul42.us.us.us.prol = fmul float %29, %30
  %arrayidx44.us.us.us.prol = getelementptr inbounds float, ptr %call4, i64 %indvars.iv269.prol
  store float %mul42.us.us.us.prol, ptr %arrayidx44.us.us.us.prol, align 4, !tbaa !10
  %indvars.iv.next270.prol = add nuw nsw i64 %indvars.iv269.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
...
for.body37.us.us.us.prol.loopexit:                ; preds = %for.body37.us.us.us.prol, %for.body37.us.us.us.preheader
  %indvars.iv269.unr = phi i64 [ %indvars.iv269.ph, %for.body37.us.us.us.preheader ], [ %indvars.iv.next270.prol, %for.body37.us.us.us.prol ]
...
for.body37.us.us.us:                              ; preds = %for.body37.us.us.us.prol.loopexit, %for.body37.us.us.us
  %indvars.iv269 = phi i64 [ %indvars.iv.next270.3, %for.body37.us.us.us ], [ %indvars.iv269.unr, %for.body37.us.us.us.prol.loopexit ]
  %arrayidx39.us.us.us = getelementptr inbounds float, ptr %call, i64 %indvars.iv269
  %32 = load float, ptr %arrayidx39.us.us.us, align 4, !tbaa !10
  %arrayidx41.us.us.us = getelementptr inbounds float, ptr %15, i64 %indvars.iv269
  %33 = load float, ptr %arrayidx41.us.us.us, align 4, !tbaa !10
  %mul42.us.us.us = fmul float %32, %33
  %arrayidx44.us.us.us = getelementptr inbounds float, ptr %call4, i64 %indvars.iv269
  store float %mul42.us.us.us, ptr %arrayidx44.us.us.us, align 4, !tbaa !10
  %indvars.iv.next270 = add nuw nsw i64 %indvars.iv269, 1
  %arrayidx39.us.us.us.1 = getelementptr inbounds float, ptr %call, i64 %indvars.iv.next270
  %34 = load float, ptr %arrayidx39.us.us.us.1, align 4, !tbaa !10
  %arrayidx41.us.us.us.1 = getelementptr inbounds float, ptr %15, i64 %indvars.iv.next270
  %35 = load float, ptr %arrayidx41.us.us.us.1, align 4, !tbaa !10
  %mul42.us.us.us.1 = fmul float %34, %35
  %arrayidx44.us.us.us.1 = getelementptr inbounds float, ptr %call4, i64 %indvars.iv.next270
  ...
  %arrayidx39.us.us.us.2 = getelementptr inbounds float, ptr %call, i64 %indvars.iv.next270.1
  %36 = load float, ptr %arrayidx39.us.us.us.2, align 4, !tbaa !10
  %arrayidx41.us.us.us.2 = getelementptr inbounds float, ptr %15, i64 %indvars.iv.next270.1
  %37 = load float, ptr %arrayidx41.us.us.us.2, align 4, !tbaa !10
  %mul42.us.us.us.2 = fmul float %36, %37
  %arrayidx44.us.us.us.2 = getelementptr inbounds float, ptr %call4, i64 %indvars.iv.next270.1
  store float %mul42.us.us.us.2, ptr %arrayidx44.us.us.us.2, align 4, !tbaa !10
  %indvars.iv.next270.2 = add nuw nsw i64 %indvars.iv269, 3
  %arrayidx39.us.us.us.3 = getelementptr inbounds float, ptr %call, i64 %indvars.iv.next270.2
  %38 = load float, ptr %arrayidx39.us.us.us.3, align 4, !tbaa !10
  %arrayidx41.us.us.us.3 = getelementptr inbounds float, ptr %15, i64 %indvars.iv.next270.2
  %39 = load float, ptr %arrayidx41.us.us.us.3, align 4, !tbaa !10
  %mul42.us.us.us.3 = fmul float %38, %39
  %arrayidx44.us.us.us.3 = getelementptr inbounds float, ptr %call4, i64 %indvars.iv.next270.2
  ...
  %exitcond273.not.3 = icmp eq i64 %indvars.iv.next270.3, %wide.trip.count272
  br i1 %exitcond273.not.3, label %for.cond32.for.cond.cleanup36_crit_edge.us.us.us, label %for.body37.us.us.us, !llvm.loop !255
...
for.cond32.for.cond.cleanup36_crit_edge.us.us.us: ; preds = %for.body37.us.us.us.prol.loopexit, %for.body37.us.us.us, %middle.block
  ...
  %arrayidx52.us.us.us = getelementptr inbounds float, ptr %call7, i64 %indvars.iv274
  store float %call50.us.us.us, ptr %arrayidx52.us.us.us, align 4, !tbaa !10
  %indvars.iv.next275 = add nuw nsw i64 %indvars.iv274, 1
  %exitcond278.not = icmp eq i64 %indvars.iv.next275, %wide.trip.count277
  br i1 %exitcond278.not, label %for.cond22.for.cond.cleanup26_crit_edge.split.us.us.us, label %for.body27.us.us.us
...
for.cond22.for.cond.cleanup26_crit_edge.split.us.us.us: ; preds = %for.cond32.for.cond.cleanup36_crit_edge.us.us.us
  ...
  %exitcond279.not = icmp eq i64 %inc61.us.us, %2
  br i1 %exitcond279.not, label %for.cond.cleanup, label %for.body17.us.us.preheader

for.body.us:                                      ; preds = %for.body.us.preheader, %for.cond22.for.cond.cleanup26_crit_edge.split.us201
  %i.0193.us = phi i64 [ %inc61.us, %for.cond22.for.cond.cleanup26_crit_edge.split.us201 ], [ 0, %for.body.us.preheader ]
  br label %for.body27.us194

for.body27.us194:                                 ; preds = %for.body.us, %for.body27.us194
  %indvars.iv258 = phi i64 [ 0, %for.body.us ], [ %indvars.iv.next259, %for.body27.us194 ]
  %call50.us197 = tail call float @pairwise_sum(ptr noundef %call4, i64 noundef %conv) #17
  %arrayidx52.us198 = getelementptr inbounds float, ptr %call7, i64 %indvars.iv258
  store float %call50.us197, ptr %arrayidx52.us198, align 4, !tbaa !10
  %indvars.iv.next259 = add nuw nsw i64 %indvars.iv258, 1
  %exitcond262.not = icmp eq i64 %indvars.iv.next259, %wide.trip.count261
  br i1 %exitcond262.not, label %for.cond22.for.cond.cleanup26_crit_edge.split.us201, label %for.body27.us194
...
for.cond22.for.cond.cleanup26_crit_edge.split.us201: ; preds = %for.body27.us194
  ...
  %exitcond263.not = icmp eq i64 %inc61.us, %2
  br i1 %exitcond263.not, label %for.cond.cleanup, label %for.body.us
...
for.body.us203:                                   ; preds = %for.body.us203.preheader, %for.cond12.for.cond22.preheader_crit_edge.us222
  %i.0193.us204 = phi i64 [ %inc61.us219, %for.cond12.for.cond22.preheader_crit_edge.us222 ], [ 0, %for.body.us203.preheader ]
  %src.sroa.4161.0.arrayidx.sroa_idx.us206 = getelementptr inbounds %struct.Source, ptr %3, i64 %i.0193.us204, i32 4
  %src.sroa.4161.0.copyload.us207 = load ptr, ptr %src.sroa.4161.0.arrayidx.sroa_idx.us206, align 8, !tbaa.struct !234
  br i1 %40, label %for.cond12.for.cond22.preheader_crit_edge.us222.unr-lcssa, label %for.body17.us208

for.body17.us208:                                 ; preds = %for.body.us203, %for.body17.us208
  %indvars.iv = phi i64 [ %indvars.iv.next.3, %for.body17.us208 ], [ 0, %for.body.us203 ]
  %niter = phi i64 [ %niter.next.3, %for.body17.us208 ], [ 0, %for.body.us203 ]
  %arrayidx18.us211 = getelementptr inbounds ptr, ptr %src.sroa.4161.0.copyload.us207, i64 %indvars.iv
  %41 = load ptr, ptr %arrayidx18.us211, align 8, !tbaa !16
  %arrayidx19.us212 = getelementptr inbounds float, ptr %41, i64 1
  %42 = load float, ptr %arrayidx19.us212, align 4, !tbaa !10
  %arrayidx21.us213 = getelementptr inbounds float, ptr %call, i64 %indvars.iv
  store float %42, ptr %arrayidx21.us213, align 4, !tbaa !10
  %indvars.iv.next = or i64 %indvars.iv, 1
  %arrayidx18.us211.1 = getelementptr inbounds ptr, ptr %src.sroa.4161.0.copyload.us207, i64 %indvars.iv.next
  %43 = load ptr, ptr %arrayidx18.us211.1, align 8, !tbaa !16
  %arrayidx19.us212.1 = getelementptr inbounds float, ptr %43, i64 1
  %44 = load float, ptr %arrayidx19.us212.1, align 4, !tbaa !10
  %arrayidx21.us213.1 = getelementptr inbounds float, ptr %call, i64 %indvars.iv.next
  store float %44, ptr %arrayidx21.us213.1, align 4, !tbaa !10
  %indvars.iv.next.1 = or i64 %indvars.iv, 2
  %arrayidx18.us211.2 = getelementptr inbounds ptr, ptr %src.sroa.4161.0.copyload.us207, i64 %indvars.iv.next.1
  %45 = load ptr, ptr %arrayidx18.us211.2, align 8, !tbaa !16
  %arrayidx19.us212.2 = getelementptr inbounds float, ptr %45, i64 1
  %46 = load float, ptr %arrayidx19.us212.2, align 4, !tbaa !10
  %arrayidx21.us213.2 = getelementptr inbounds float, ptr %call, i64 %indvars.iv.next.1
  store float %46, ptr %arrayidx21.us213.2, align 4, !tbaa !10
  %indvars.iv.next.2 = or i64 %indvars.iv, 3
  %arrayidx18.us211.3 = getelementptr inbounds ptr, ptr %src.sroa.4161.0.copyload.us207, i64 %indvars.iv.next.2
  %47 = load ptr, ptr %arrayidx18.us211.3, align 8, !tbaa !16
  %arrayidx19.us212.3 = getelementptr inbounds float, ptr %47, i64 1
  %48 = load float, ptr %arrayidx19.us212.3, align 4, !tbaa !10
  %arrayidx21.us213.3 = getelementptr inbounds float, ptr %call, i64 %indvars.iv.next.2
  store float %48, ptr %arrayidx21.us213.3, align 4, !tbaa !10
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4
  %niter.next.3 = add i64 %niter, 4
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %for.cond12.for.cond22.preheader_crit_edge.us222.unr-lcssa, label %for.body17.us208

for.cond12.for.cond22.preheader_crit_edge.us222.unr-lcssa: ; preds = %for.body17.us208, %for.body.us203
  %indvars.iv.unr = phi i64 [ 0, %for.body.us203 ], [ %indvars.iv.next.3, %for.body17.us208 ]
  br i1 %lcmp.mod.not, label %for.cond12.for.cond22.preheader_crit_edge.us222, label %for.body17.us208.epil

for.body17.us208.epil:                            ; preds = %for.cond12.for.cond22.preheader_crit_edge.us222.unr-lcssa, %for.body17.us208.epil
  %indvars.iv.epil = phi i64 [ %indvars.iv.next.epil, %for.body17.us208.epil ], [ %indvars.iv.unr, %for.cond12.for.cond22.preheader_crit_edge.us222.unr-lcssa ]
  %epil.iter = phi i64 [ %epil.iter.next, %for.body17.us208.epil ], [ 0, %for.cond12.for.cond22.preheader_crit_edge.us222.unr-lcssa ]
  %arrayidx18.us211.epil = getelementptr inbounds ptr, ptr %src.sroa.4161.0.copyload.us207, i64 %indvars.iv.epil
  %49 = load ptr, ptr %arrayidx18.us211.epil, align 8, !tbaa !16
  %arrayidx19.us212.epil = getelementptr inbounds float, ptr %49, i64 1
  %50 = load float, ptr %arrayidx19.us212.epil, align 4, !tbaa !10
  %arrayidx21.us213.epil = getelementptr inbounds float, ptr %call, i64 %indvars.iv.epil
  store float %50, ptr %arrayidx21.us213.epil, align 4, !tbaa !10
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %for.cond12.for.cond22.preheader_crit_edge.us222, label %for.body17.us208.epil, !llvm.loop !256

for.cond12.for.cond22.preheader_crit_edge.us222:  ; preds = %for.body17.us208.epil, %for.cond12.for.cond22.preheader_crit_edge.us222.unr-lcssa
  %call58.us217 = tail call float @pairwise_sum(ptr noundef %call7, i64 noundef %conv5) #17
  %arrayidx59.us218 = getelementptr inbounds float, ptr %call9, i64 %i.0193.us204
  store float %call58.us217, ptr %arrayidx59.us218, align 4, !tbaa !10
  %inc61.us219 = add nuw nsw i64 %i.0193.us204, 1
  %exitcond257.not = icmp eq i64 %inc61.us219, %2
  br i1 %exitcond257.not, label %for.cond.cleanup, label %for.body.us203

for.cond.cleanup:                                 ; preds = %for.body, %for.cond12.for.cond22.preheader_crit_edge.us222, %for.cond22.for.cond.cleanup26_crit_edge.split.us201, %for.cond22.for.cond.cleanup26_crit_edge.split.us.us.us
...
for.body71.lr.ph:                                 ; preds = %for.cond.cleanup
  ...
  %cmp78243 = icmp sgt i32 %0, 0
  %cmp94247 = icmp sgt i32 %1, 0
  %wide.trip.count283 = zext i32 %0 to i64
  %wide.trip.count288 = zext i32 %1 to i64
  %wide.trip.count298 = zext i32 %1 to i64
  %wide.trip.count293 = zext i32 %0 to i64
  %xtraiter346 = and i64 %wide.trip.count283, 3
  %52 = icmp ult i32 %0, 4
  %unroll_iter349 = and i64 %wide.trip.count283, 4294967292
  %lcmp.mod348.not = icmp eq i64 %xtraiter346, 0
  %min.iters.check319 = icmp ult i32 %0, 8
  %n.vec322 = and i64 %wide.trip.count283, 4294967288
  %cmp.n324 = icmp eq i64 %n.vec322, %wide.trip.count283
  %xtraiter351 = and i64 %wide.trip.count283, 3
...
for.cond.cleanup70:                               ; preds = %for.cond.cleanup96, %for.cond.cleanup.thread, %for.cond.cleanup
  %call64302 = phi float [ %call64301, %for.cond.cleanup.thread ], [ %call64, %for.cond.cleanup ], [ %call64, %for.cond.cleanup96 ]
...
for.body71:                                       ; preds = %for.body71.lr.ph, %for.cond.cleanup96
  %i65.0250 = phi i64 [ 0, %for.body71.lr.ph ], [ %inc132, %for.cond.cleanup96 ]
  %arrayidx74 = getelementptr inbounds %struct.Source, ptr %51, i64 %i65.0250
  ...
  br i1 %cmp78243, label %for.body81.preheader, label %for.cond92.preheader.thread
...
for.cond92.preheader.unr-lcssa:                   ; preds = %for.body81, %for.body81.preheader
  %indvars.iv280.unr = phi i64 [ 0, %for.body81.preheader ], [ %indvars.iv.next281.3, %for.body81 ]
  br i1 %lcmp.mod348.not, label %for.cond92.preheader, label %for.body81.epil

for.body81.epil:                                  ; preds = %for.cond92.preheader.unr-lcssa, %for.body81.epil
  %indvars.iv280.epil = phi i64 [ %indvars.iv.next281.epil, %for.body81.epil ], [ %indvars.iv280.unr, %for.cond92.preheader.unr-lcssa ]
  %epil.iter347 = phi i64 [ %epil.iter347.next, %for.body81.epil ], [ 0, %for.cond92.preheader.unr-lcssa ]
  %arrayidx84.epil = getelementptr inbounds ptr, ptr %src72.sroa.4147.0.copyload, i64 %indvars.iv280.epil
  %55 = load ptr, ptr %arrayidx84.epil, align 8, !tbaa !16
  %56 = load float, ptr %55, align 4, !tbaa !10
  %arrayidx87.epil = getelementptr inbounds float, ptr %call, i64 %indvars.iv280.epil
  store float %56, ptr %arrayidx87.epil, align 4, !tbaa !10
  %indvars.iv.next281.epil = add nuw nsw i64 %indvars.iv280.epil, 1
  %epil.iter347.next = add i64 %epil.iter347, 1
  %epil.iter347.cmp.not = icmp eq i64 %epil.iter347.next, %xtraiter346
  br i1 %epil.iter347.cmp.not, label %for.cond92.preheader, label %for.body81.epil, !llvm.loop !258

for.cond92.preheader:                             ; preds = %for.body81.epil, %for.cond92.preheader.unr-lcssa
  br i1 %cmp94247, label %for.body97.lr.ph, label %for.cond.cleanup96

for.cond92.preheader.thread:                      ; preds = %for.body71
  br i1 %cmp94247, label %for.body97.preheader, label %for.cond.cleanup96

for.body97.lr.ph:                                 ; preds = %for.cond92.preheader
  br i1 %cmp78243, label %for.body97.us, label %for.body97.preheader
...
for.body97.us:                                    ; preds = %for.body97.lr.ph, %for.cond103.for.cond.cleanup107_crit_edge.us
  %indvars.iv295 = phi i64 [ %indvars.iv.next296, %for.cond103.for.cond.cleanup107_crit_edge.us ], [ 0, %for.body97.lr.ph ]
  %arrayidx101.us = getelementptr inbounds ptr, ptr %src72.sroa.0.0.copyload, i64 %indvars.iv295
  %57 = load ptr, ptr %arrayidx101.us, align 8, !tbaa !16
  %58 = ptrtoint ptr %57 to i64
  %59 = sub i64 %call4311, %58
  %diff.check316 = icmp ult i64 %59, 32
  %or.cond334 = select i1 %min.iters.check319, i1 true, i1 %diff.check316
  br i1 %or.cond334, label %for.body108.us.preheader, label %vector.body325

vector.body325:                                   ; preds = %for.body97.us, %vector.body325
  %index326 = phi i64 [ %index.next331, %vector.body325 ], [ 0, %for.body97.us ]
  %60 = getelementptr inbounds float, ptr %call, i64 %index326
  %wide.load327 = load <4 x float>, ptr %60, align 4, !tbaa !10
  %61 = getelementptr inbounds float, ptr %60, i64 4
  %wide.load328 = load <4 x float>, ptr %61, align 4, !tbaa !10
  %62 = getelementptr inbounds float, ptr %57, i64 %index326
  %wide.load329 = load <4 x float>, ptr %62, align 4, !tbaa !10
  %63 = getelementptr inbounds float, ptr %62, i64 4
  %wide.load330 = load <4 x float>, ptr %63, align 4, !tbaa !10
  %64 = fmul <4 x float> %wide.load327, %wide.load329
  %65 = fmul <4 x float> %wide.load328, %wide.load330
  %66 = getelementptr inbounds float, ptr %call4, i64 %index326
  ...
  %index.next331 = add nuw i64 %index326, 8
  %68 = icmp eq i64 %index.next331, %n.vec322
  br i1 %68, label %middle.block317, label %vector.body325, !llvm.loop !259

middle.block317:                                  ; preds = %vector.body325
  br i1 %cmp.n324, label %for.cond103.for.cond.cleanup107_crit_edge.us, label %for.body108.us.preheader

for.body108.us.preheader:                         ; preds = %for.body97.us, %middle.block317
  %indvars.iv290.ph = phi i64 [ 0, %for.body97.us ], [ %n.vec322, %middle.block317 ]
  %69 = xor i64 %indvars.iv290.ph, -1
  %70 = add nsw i64 %69, %wide.trip.count283
  br i1 %lcmp.mod352.not, label %for.body108.us.prol.loopexit, label %for.body108.us.prol

for.body108.us.prol:                              ; preds = %for.body108.us.preheader, %for.body108.us.prol
  %indvars.iv290.prol = phi i64 [ %indvars.iv.next291.prol, %for.body108.us.prol ], [ %indvars.iv290.ph, %for.body108.us.preheader ]
  %prol.iter353 = phi i64 [ %prol.iter353.next, %for.body108.us.prol ], [ 0, %for.body108.us.preheader ]
  %arrayidx110.us.prol = getelementptr inbounds float, ptr %call, i64 %indvars.iv290.prol
  %71 = load float, ptr %arrayidx110.us.prol, align 4, !tbaa !10
  %arrayidx112.us.prol = getelementptr inbounds float, ptr %57, i64 %indvars.iv290.prol
  %72 = load float, ptr %arrayidx112.us.prol, align 4, !tbaa !10
  %mul113.us.prol = fmul float %71, %72
  %arrayidx115.us.prol = getelementptr inbounds float, ptr %call4, i64 %indvars.iv290.prol
  ...
  %prol.iter353.next = add i64 %prol.iter353, 1
  %prol.iter353.cmp.not = icmp eq i64 %prol.iter353.next, %xtraiter351
  br i1 %prol.iter353.cmp.not, label %for.body108.us.prol.loopexit, label %for.body108.us.prol, !llvm.loop !260

for.body108.us.prol.loopexit:                     ; preds = %for.body108.us.prol, %for.body108.us.preheader
  %indvars.iv290.unr = phi i64 [ %indvars.iv290.ph, %for.body108.us.preheader ], [ %indvars.iv.next291.prol, %for.body108.us.prol ]
...
for.body108.us:                                   ; preds = %for.body108.us.prol.loopexit, %for.body108.us
  %indvars.iv290 = phi i64 [ %indvars.iv.next291.3, %for.body108.us ], [ %indvars.iv290.unr, %for.body108.us.prol.loopexit ]
  %arrayidx110.us = getelementptr inbounds float, ptr %call, i64 %indvars.iv290
  %74 = load float, ptr %arrayidx110.us, align 4, !tbaa !10
  %arrayidx112.us = getelementptr inbounds float, ptr %57, i64 %indvars.iv290
  %75 = load float, ptr %arrayidx112.us, align 4, !tbaa !10
  %mul113.us = fmul float %74, %75
  %arrayidx115.us = getelementptr inbounds float, ptr %call4, i64 %indvars.iv290
  store float %mul113.us, ptr %arrayidx115.us, align 4, !tbaa !10
  %indvars.iv.next291 = add nuw nsw i64 %indvars.iv290, 1
  %arrayidx110.us.1 = getelementptr inbounds float, ptr %call, i64 %indvars.iv.next291
  %76 = load float, ptr %arrayidx110.us.1, align 4, !tbaa !10
  %arrayidx112.us.1 = getelementptr inbounds float, ptr %57, i64 %indvars.iv.next291
  %77 = load float, ptr %arrayidx112.us.1, align 4, !tbaa !10
  %mul113.us.1 = fmul float %76, %77
  %arrayidx115.us.1 = getelementptr inbounds float, ptr %call4, i64 %indvars.iv.next291
  store float %mul113.us.1, ptr %arrayidx115.us.1, align 4, !tbaa !10
  %indvars.iv.next291.1 = add nuw nsw i64 %indvars.iv290, 2
  %arrayidx110.us.2 = getelementptr inbounds float, ptr %call, i64 %indvars.iv.next291.1
  %78 = load float, ptr %arrayidx110.us.2, align 4, !tbaa !10
  %arrayidx112.us.2 = getelementptr inbounds float, ptr %57, i64 %indvars.iv.next291.1
  %79 = load float, ptr %arrayidx112.us.2, align 4, !tbaa !10
  %mul113.us.2 = fmul float %78, %79
  %arrayidx115.us.2 = getelementptr inbounds float, ptr %call4, i64 %indvars.iv.next291.1
  store float %mul113.us.2, ptr %arrayidx115.us.2, align 4, !tbaa !10
  %indvars.iv.next291.2 = add nuw nsw i64 %indvars.iv290, 3
  %arrayidx110.us.3 = getelementptr inbounds float, ptr %call, i64 %indvars.iv.next291.2
  %80 = load float, ptr %arrayidx110.us.3, align 4, !tbaa !10
  %arrayidx112.us.3 = getelementptr inbounds float, ptr %57, i64 %indvars.iv.next291.2
  %81 = load float, ptr %arrayidx112.us.3, align 4, !tbaa !10
  %mul113.us.3 = fmul float %80, %81
  %arrayidx115.us.3 = getelementptr inbounds float, ptr %call4, i64 %indvars.iv.next291.2
  ...
  br i1 %exitcond294.not.3, label %for.cond103.for.cond.cleanup107_crit_edge.us, label %for.body108.us, !llvm.loop !261

for.cond103.for.cond.cleanup107_crit_edge.us:     ; preds = %for.body108.us.prol.loopexit, %for.body108.us, %middle.block317
  %call121.us = tail call float @pairwise_sum(ptr noundef nonnull %call4, i64 noundef %conv) #17
  %arrayidx123.us = getelementptr inbounds float, ptr %call7, i64 %indvars.iv295
  store float %call121.us, ptr %arrayidx123.us, align 4, !tbaa !10
  %indvars.iv.next296 = add nuw nsw i64 %indvars.iv295, 1
  %exitcond299.not = icmp eq i64 %indvars.iv.next296, %wide.trip.count298
  br i1 %exitcond299.not, label %for.cond.cleanup96, label %for.body97.us

for.body81:                                       ; preds = %for.body81.preheader, %for.body81
  %indvars.iv280 = phi i64 [ %indvars.iv.next281.3, %for.body81 ], [ 0, %for.body81.preheader ]
  %niter350 = phi i64 [ %niter350.next.3, %for.body81 ], [ 0, %for.body81.preheader ]
  %arrayidx84 = getelementptr inbounds ptr, ptr %src72.sroa.4147.0.copyload, i64 %indvars.iv280
  %82 = load ptr, ptr %arrayidx84, align 8, !tbaa !16
  %83 = load float, ptr %82, align 4, !tbaa !10
  %arrayidx87 = getelementptr inbounds float, ptr %call, i64 %indvars.iv280
  store float %83, ptr %arrayidx87, align 4, !tbaa !10
  %indvars.iv.next281 = or i64 %indvars.iv280, 1
  %arrayidx84.1 = getelementptr inbounds ptr, ptr %src72.sroa.4147.0.copyload, i64 %indvars.iv.next281
  %84 = load ptr, ptr %arrayidx84.1, align 8, !tbaa !16
  %85 = load float, ptr %84, align 4, !tbaa !10
  %arrayidx87.1 = getelementptr inbounds float, ptr %call, i64 %indvars.iv.next281
  store float %85, ptr %arrayidx87.1, align 4, !tbaa !10
  %indvars.iv.next281.1 = or i64 %indvars.iv280, 2
  %arrayidx84.2 = getelementptr inbounds ptr, ptr %src72.sroa.4147.0.copyload, i64 %indvars.iv.next281.1
  %86 = load ptr, ptr %arrayidx84.2, align 8, !tbaa !16
  %87 = load float, ptr %86, align 4, !tbaa !10
  %arrayidx87.2 = getelementptr inbounds float, ptr %call, i64 %indvars.iv.next281.1
  store float %87, ptr %arrayidx87.2, align 4, !tbaa !10
  %indvars.iv.next281.2 = or i64 %indvars.iv280, 3
  %arrayidx84.3 = getelementptr inbounds ptr, ptr %src72.sroa.4147.0.copyload, i64 %indvars.iv.next281.2
  %88 = load ptr, ptr %arrayidx84.3, align 8, !tbaa !16
  %89 = load float, ptr %88, align 4, !tbaa !10
  %arrayidx87.3 = getelementptr inbounds float, ptr %call, i64 %indvars.iv.next281.2
  store float %89, ptr %arrayidx87.3, align 4, !tbaa !10
  %indvars.iv.next281.3 = add nuw nsw i64 %indvars.iv280, 4
  %niter350.next.3 = add i64 %niter350, 4
  %niter350.ncmp.3 = icmp eq i64 %niter350.next.3, %unroll_iter349
  br i1 %niter350.ncmp.3, label %for.cond92.preheader.unr-lcssa, label %for.body81
...
for.cond.cleanup96:                               ; preds = %for.body97, %for.cond103.for.cond.cleanup107_crit_edge.us, %for.cond92.preheader.thread, %for.cond92.preheader
  ...
  %arrayidx130 = getelementptr inbounds float, ptr %call9, i64 %i65.0250
  store float %call129, ptr %arrayidx130, align 4, !tbaa !10
  %inc132 = add nuw nsw i64 %i65.0250, 1
  %exitcond300.not = icmp eq i64 %inc132, %2
  br i1 %exitcond300.not, label %for.cond.cleanup70, label %for.body71

for.body97:                                       ; preds = %for.body97.preheader, %for.body97
  %indvars.iv285 = phi i64 [ %indvars.iv.next286, %for.body97 ], [ 0, %for.body97.preheader ]
  %call121 = tail call float @pairwise_sum(ptr noundef %call4, i64 noundef %conv) #17
  %arrayidx123 = getelementptr inbounds float, ptr %call7, i64 %indvars.iv285
  store float %call121, ptr %arrayidx123, align 4, !tbaa !10
  %indvars.iv.next286 = add nuw nsw i64 %indvars.iv285, 1
  %exitcond289.not = icmp eq i64 %indvars.iv.next286, %wide.trip.count288
  br i1 %exitcond289.not, label %for.cond.cleanup96, label %for.body97
}
