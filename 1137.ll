; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/Zip/ZipUpdate.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/Zip/ZipUpdate.cpp"
...
if.end84.i:                                       ; preds = %if.then43.i
  ...
  %cmp55.i = icmp eq i32 %74, 0
  %spec.store.select714.i = select i1 %cmp55.i, i32 1, i32 %74
  ...
  %cmp65.i = icmp eq i32 %spec.select949.i, 0
  %spec.store.select715.i = select i1 %cmp65.i, i32 1, i32 %spec.select949.i
...
invoke.cont16.i.i:                                ; preds = %invoke.cont13.i.i
  ...
  %84 = load i8, ptr %NewProperties.i.i, align 1, !tbaa !121, !range !35
...
invoke.cont408.i:                                 ; preds = %invoke.cont404.i
  ...
  %270 = load i8, ptr %NewProperties409.i, align 1, !tbaa !121, !range !35
...
if.end:                                           ; preds = %if.else, %_ZN11CStringBaseIcEaSERKS0_.exit
  ...
  %39 = load i8, ptr %PasswordIsDefined, align 4
