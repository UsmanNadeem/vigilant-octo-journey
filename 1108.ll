; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/UI/Common/Bench.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/UI/Common/Bench.cpp"
...
_ZL13NormalizeValsRyS_.exit14:                    ; preds = %while.body.i13, %_ZL13NormalizeValsRyS_.exit
  ...
  %cmp = icmp eq i64 %userFreq.1, 0
  %spec.select = select i1 %cmp, i64 1, i64 %userFreq.1
  %cmp1 = icmp eq i64 %globalTime.1, 0
  %globalTime.2 = select i1 %cmp1, i64 1, i64 %globalTime.1
...
_ZL13NormalizeValsRyS_.exit14:                    ; preds = %while.body.i13, %_ZL13NormalizeValsRyS_.exit
  ...
  %cmp = icmp eq i64 %globalFreq.1, 0
  %spec.select = select i1 %cmp, i64 1, i64 %globalFreq.1
  %cmp1 = icmp eq i64 %userTime.1, 0
  %userTime.2 = select i1 %cmp1, i64 1, i64 %userTime.1
...
_ZL11MyMultDiv64yyy.exit:                         ; preds = %while.body.i.i, %_ZL10GetLogSizej.exit
  ...
  %cmp.i = icmp eq i64 %elTime.1.i, 0
  %spec.select.i5 = select i1 %cmp.i, i64 1, i64 %elTime.1.i
...
define dso_local noundef i64 @_Z19GetDecompressRatingyyyyj(i64 noundef %elapsedTime, i64 noundef %freq, i64 noundef %outSize, i64 noundef %inSize, i32 noundef %numIterations) local_unnamed_addr #10 {
entry:
  %cmp3.i.i = icmp ugt i64 %freq, 1000000
  br i1 %cmp3.i.i, label %while.body.i.i, label %_ZL11MyMultDiv64yyy.exit
...
_ZL11MyMultDiv64yyy.exit:                         ; preds = %while.body.i.i, %entry
  ...
  %cmp.i = icmp eq i64 %elTime.1.i, 0
  %spec.select.i = select i1 %cmp.i, i64 1, i64 %elTime.1.i
  %mul.i = mul i64 %mul2, %freq.addr.0.i
...
cleanup.cont212:                                  ; preds = %invoke.cont205
  ...
  %mul = mul nuw nsw i32 %cond, %cond2
...
for.body218:                                      ; preds = %for.body218.lr.ph, %for.inc287
  ...
  %55 = load i32, ptr %kBufferSize222, align 4, !tbaa !62
  %div223 = udiv i32 67108864, %55
...
if.then227:                                       ; preds = %for.body218
  %56 = load ptr, ptr %progressInfoSpec185, align 8, !tbaa !90
  %callback230 = getelementptr inbounds %class.CBenchProgressInfo, ptr %56, i64 0, i32 5
  store ptr %callback, ptr %callback230, align 8, !tbaa !39
  %57 = load ptr, ptr %progressInfoSpec185, align 8, !tbaa !90
  %NumIterations234 = getelementptr inbounds %class.CBenchProgressInfo, ptr %57, i64 0, i32 3, i32 6
  store i32 %mul, ptr %NumIterations234, align 8, !tbaa !103
  %BenchInfo237 = getelementptr inbounds %class.CBenchProgressInfo, ptr %57, i64 0, i32 3
  %GlobalFreq.i619 = getelementptr inbounds %class.CBenchProgressInfo, ptr %57, i64 0, i32 3, i32 1
  store i64 1000000, ptr %GlobalFreq.i619, align 8, !tbaa !42
  %UserFreq.i620 = getelementptr inbounds %class.CBenchProgressInfo, ptr %57, i64 0, i32 3, i32 3
...
if.then.i.i626:                                   ; preds = %if.then227
  %58 = load i64, ptr %v.i.i618, align 8, !tbaa !44
  %mul.i.i623 = mul i64 %58, 1000000
  %59 = load i64, ptr %tv_usec.i.i624, align 8, !tbaa !46
  %add.i.i625 = add i64 %mul.i.i623, %59
...
_ZL12SetStartTimeR10CBenchInfo.exit633:           ; preds = %if.then.i.i626, %if.end.i.i629
  ...
  %UserTime.i632 = getelementptr inbounds %class.CBenchProgressInfo, ptr %57, i64 0, i32 3, i32 2
...
for.body247:                                      ; preds = %if.end240, %for.cond244
  ...
  %cmp249 = icmp eq i64 %indvars.iv723, 0
  %60 = select i1 %cmp226, i1 %cmp249, i1 false
  %frombool.i = zext i1 %60 to i8
  %arrayidx.i = getelementptr inbounds %struct.CEncoderInfo, ptr %arrayidx221, i64 0, i32 5, i64 %indvars.iv723
  %DecoderIndex.i = getelementptr inbounds %struct.CEncoderInfo, ptr %arrayidx221, i64 0, i32 5, i64 %indvars.iv723, i32 1
  ...
  %CallbackMode.i = getelementptr inbounds %struct.CEncoderInfo, ptr %arrayidx221, i64 0, i32 5, i64 %indvars.iv723, i32 2
...
invoke.cont308:                                   ; preds = %for.body300
  ...
  %64 = load i32, ptr %arrayidx311, align 4, !tbaa !20
  %cmp312.not = icmp eq i32 %64, 0
  %spec.select = select i1 %cmp312.not, i32 %res290.1672, i32 %64
...
cleanup.cont342:                                  ; preds = %cleanup.cont334
  %66 = load ptr, ptr %progressInfoSpec185, align 8, !tbaa !90
  %BenchInfo346 = getelementptr inbounds %class.CBenchProgressInfo, ptr %66, i64 0, i32 3
  ...
  %67 = load i32, ptr %NumIterations352, align 8, !tbaa !91
  %mul353 = mul i32 %67, %cond2
  store i32 %mul353, ptr %NumIterations.i, align 8, !tbaa !102
  %xtraiter810 = and i64 %conv.i, 3
  %68 = icmp ult i32 %cond, 4
  br i1 %68, label %for.cond355.for.end371_crit_edge.unr-lcssa, label %cleanup.cont342.new
...
for.body357:                                      ; preds = %for.body357, %cleanup.cont342.new
  ...
  %69 = phi <2 x i64> [ zeroinitializer, %cleanup.cont342.new ], [ %81, %for.body357 ]
  ...
  %70 = load <2 x i32>, ptr %kBufferSize361, align 4, !tbaa !20
  %71 = zext <2 x i32> %70 to <2 x i64>
  %72 = add <2 x i64> %69, %71
  ...
  %73 = load <2 x i32>, ptr %kBufferSize361.1, align 4, !tbaa !20
  ...
  %76 = load <2 x i32>, ptr %kBufferSize361.2, align 4, !tbaa !20
  ...
  %79 = load <2 x i32>, ptr %kBufferSize361.3, align 4, !tbaa !20
...
for.cond355.for.end371_crit_edge.unr-lcssa:       ; preds = %for.body357, %cleanup.cont342
  %.lcssa.ph = phi <2 x i64> [ undef, %cleanup.cont342 ], [ %81, %for.body357 ]
  %indvars.iv745.unr = phi i64 [ 0, %cleanup.cont342 ], [ %indvars.iv.next746.3, %for.body357 ]
  %.unr812 = phi <2 x i64> [ zeroinitializer, %cleanup.cont342 ], [ %81, %for.body357 ]
...
for.body357.epil:                                 ; preds = %for.cond355.for.end371_crit_edge.unr-lcssa, %for.body357.epil
  ...
  %82 = phi <2 x i64> [ %85, %for.body357.epil ], [ %.unr812, %for.cond355.for.end371_crit_edge.unr-lcssa ]
  ...
  %83 = load <2 x i32>, ptr %kBufferSize361.epil, align 4, !tbaa !20
...
for.cond355.for.end371_crit_edge:                 ; preds = %for.body357.epil, %for.cond355.for.end371_crit_edge.unr-lcssa
  %.lcssa = phi <2 x i64> [ %.lcssa.ph, %for.cond355.for.end371_crit_edge.unr-lcssa ], [ %85, %for.body357.epil ]
  store <2 x i64> %.lcssa, ptr %UnpackSize, align 8, !tbaa !41
  br label %for.end371

for.end371.critedge:                              ; preds = %cleanup.cont212
  %86 = load ptr, ptr %progressInfoSpec185, align 8, !tbaa !90
  %BenchInfo346.c = getelementptr inbounds %class.CBenchProgressInfo, ptr %86, i64 0, i32 3
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %UnpackSize, i8 0, i64 16, i1 false)
  %87 = load i32, ptr %NumIterations352.c, align 8, !tbaa !91
  %mul353.c = mul i32 %87, %cond2
...
for.end371:                                       ; preds = %for.end371.critedge, %for.cond355.for.end371_crit_edge
  ...
  %88 = load ptr, ptr %vfn374, align 8
  %call377 = invoke noundef i32 %88(ptr noundef nonnull align 8 dereferenceable(8) %callback, ptr noundef nonnull align 8 dereferenceable(52) %info, i1 noundef zeroext false)
...
cleanup.cont383:                                  ; preds = %invoke.cont376
  ...
  %90 = load ptr, ptr %vfn387, align 8
  %call390 = invoke noundef i32 %90(ptr noundef nonnull align 8 dereferenceable(8) %callback, ptr noundef nonnull align 8 dereferenceable(52) %info, i1 noundef zeroext true)
...
ehcleanup403:                                     ; preds = %lpad272, %lpad250, %lpad388, %lpad375, %lpad307, %lpad204
  %.pn580.pn.pn = phi { ptr, i32 } [ %54, %lpad204 ], [ %62, %lpad250 ], [ %63, %lpad272 ], [ %65, %lpad307 ], [ %91, %lpad388 ], [ %89, %lpad375 ]
  call void @llvm.lifetime.end.p0(i64 56, ptr nonnull %info) #21
  br label %ehcleanup405
...
delete.notnull.i:                                 ; preds = %invoke.cont, %cleanup.cont, %cleanup.cont39, %invoke.cont32, %cleanup408
  ...
  %92 = load i64, ptr %call.i, align 8
  %arraydestroy.isempty.i = icmp eq i64 %92, 0
...
arraydestroy.body.preheader.i:                    ; preds = %delete.notnull.i
  %delete.end.i = getelementptr inbounds %struct.CEncoderInfo, ptr %2, i64 %92
...
define linkonce_odr dso_local void @_ZN14CBenchEncodersD2Ev(ptr noundef nonnull align 8 dereferenceable(8) %this) unnamed_addr #13 comdat align 2 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local noundef i64 @_Z19GetBenchMemoryUsagejj(i32 noundef %numThreads, i32 noundef %dictionary) local_unnamed_addr #10 {
entry:
...
if.end.i:
  ...
  %spec.store.select = select i1 %cmp, i32 1, i32 %numThreads
...
invoke.cont10:                                    ; preds = %invoke.cont
  ...
  %cmp15 = icmp ugt i32 %spec.store.select, 1
...
invoke.cont22:                                    ; preds = %invoke.cont19, %invoke.cont22
  ...
  br i1 %arrayctor.done, label %for.body.preheader, label %invoke.cont22

for.body.preheader:                               ; preds = %invoke.cont22
  store ptr %3, ptr %Items.i, align 8, !tbaa !126
  %cmp3.not.i.i = icmp eq i32 %bufferSize, 0
  %4 = add nsw i64 %conv, -1
  %xtraiter284 = and i64 %conv, 1
  %5 = icmp eq i64 %4, 0
  %unroll_iter287 = and i64 %conv, 4294967294
  %lcmp.mod285.not = icmp eq i64 %xtraiter284, 0
  %xtraiter289 = and i64 %conv, 1
  %6 = icmp eq i64 %4, 0
  %unroll_iter292 = and i64 %conv, 4294967294
  %lcmp.mod290.not = icmp eq i64 %xtraiter289, 0
  br label %for.body

for.body:                                         ; preds = %for.body.preheader, %_ZL10RandGenCrcPhjR20CBaseRandomGenerator.exit
  %indvars.iv = phi i64 [ 0, %for.body.preheader ], [ %indvars.iv.next, %_ZL10RandGenCrcPhjR20CBaseRandomGenerator.exit ]
  %RG.sroa.8.0250 = phi i32 [ 521288629, %for.body.preheader ], [ %RG.sroa.8.2, %_ZL10RandGenCrcPhjR20CBaseRandomGenerator.exit ]
...
for.body.i.i:                                     ; preds = %for.body.i.i.preheader, %for.body.i.i
  %RG.sroa.8.1 = phi i32 [ %add8.i.i.i.1, %for.body.i.i ], [ %RG.sroa.8.0250, %for.body.i.i.preheader ]
  %indvars.iv.i.i = phi i64 [ %indvars.iv.next.i.i.1, %for.body.i.i ], [ 0, %for.body.i.i.preheader ]
  %niter288 = phi i64 [ %niter288.next.1, %for.body.i.i ], [ 0, %for.body.i.i.preheader ]
  ...
  br i1 %niter288.ncmp.1, label %for.body.i8.i.preheader.unr-lcssa, label %for.body.i.i, !llvm.loop !121
...
for.body.i8.i.preheader.unr-lcssa:                ; preds = %for.body.i.i, %for.body.i.i.preheader
  ...
  %RG.sroa.8.1.unr = phi i32 [ %RG.sroa.8.0250, %for.body.i.i.preheader ], [ %add8.i.i.i.1, %for.body.i.i ]
  %indvars.iv.i.i.unr = phi i64 [ 0, %for.body.i.i.preheader ], [ %indvars.iv.next.i.i.1, %for.body.i.i ]
  br i1 %lcmp.mod285.not, label %for.body.i8.i.preheader, label %for.body.i.i.epil
...
for.cond.cleanup.loopexit.i.i.unr-lcssa:          ; preds = %for.body.i8.i, %for.body.i8.i.preheader
  ...
  br i1 %lcmp.mod290.not, label %for.cond.cleanup.loopexit.i.i, label %for.body.i8.i.epil
...
for.body.i8.i:                                    ; preds = %for.body.i8.i.preheader, %for.body.i8.i
  ...
  %niter293 = phi i64 [ %niter293.next.1, %for.body.i8.i ], [ 0, %for.body.i8.i.preheader ]
  ...
  br i1 %niter293.ncmp.1, label %for.cond.cleanup.loopexit.i.i.unr-lcssa, label %for.body.i8.i, !llvm.loop !120

_ZL10RandGenCrcPhjR20CBaseRandomGenerator.exit:   ; preds = %for.body, %for.cond.cleanup.loopexit.i.i
  %RG.sroa.8.2 = phi i32 [ %RG.sroa.8.0250, %for.body ], [ %add8.i.i.i.lcssa, %for.cond.cleanup.loopexit.i.i ]
...
for.body37.preheader:                             ; preds = %if.end.i167, %if.then.i
  %retval.0.i168 = phi i64 [ %add.i, %if.then.i ], [ %mul2.i, %if.end.i167 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %v.i) #21
  %.pre = load ptr, ptr %Items.i, align 8, !tbaa !126
  br label %for.body37

for.body37:                                       ; preds = %for.body37.preheader, %cleanup.cont
  %indvars.iv260 = phi i64 [ 0, %for.body37.preheader ], [ %indvars.iv.next261, %cleanup.cont ]
  %arrayidx41 = getelementptr inbounds %struct.CCrcInfo, ptr %.pre, i64 %indvars.iv260
...
cleanup.cont:                                     ; preds = %invoke.cont43
  ...
  %exitcond264.not = icmp eq i64 %indvars.iv.next261, %conv1
  br i1 %exitcond264.not, label %for.end54, label %for.body37, !llvm.loop !133

for.end54:                                        ; preds = %cleanup.cont
  %cmp5.not.i = icmp eq i32 %inc48, 0
  %.pre272 = load ptr, ptr %Items.i, align 8, !tbaa !126
  br i1 %cmp5.not.i, label %for.body58.preheader, label %for.body.i.preheader
...
for.body.i:                                       ; preds = %for.body.i.preheader, %call.i4.i.i.noexc
  ...
  %arrayidx.i = getelementptr inbounds %struct.CCrcInfo, ptr %.pre272, i64 %indvars.iv.i
...
call.i4.i.i.noexc:                                ; preds = %call.i.i.i.noexc
  ...
  br i1 %cmp.i172, label %for.body.i, label %for.body58.preheader, !llvm.loop !134

for.body58.preheader:                             ; preds = %call.i4.i.i.noexc, %for.end54
  store i32 0, ptr %threads, align 8, !tbaa !124
  br label %for.body58

for.cond56:                                       ; preds = %for.body58
  %indvars.iv.next266 = add nuw nsw i64 %indvars.iv265, 1
  %exitcond269.not = icmp eq i64 %indvars.iv.next266, %conv1
  br i1 %exitcond269.not, label %if.end83, label %for.body58, !llvm.loop !135

for.body58:                                       ; preds = %for.body58.preheader, %for.cond56
  %indvars.iv265 = phi i64 [ 0, %for.body58.preheader ], [ %indvars.iv.next266, %for.cond56 ]
  %Res = getelementptr inbounds %struct.CCrcInfo, ptr %.pre272, i64 %indvars.iv265, i32 5
...
for.body.i8.i205.preheader.new:                   ; preds = %for.body.i8.i205.preheader
  %unroll_iter282 = and i64 %conv, 4294967294
...
for.cond.cleanup.loopexit.i.i193.unr-lcssa:       ; preds = %for.body.i8.i205, %for.body.i8.i205.preheader
  ...
  br i1 %lcmp.mod280.not, label %for.cond.cleanup.loopexit.i.i193, label %for.body.i8.i205.epil
...
for.body.i8.i205:                                 ; preds = %for.body.i8.i205, %for.body.i8.i205.preheader.new
  ...
  %niter283 = phi i64 [ 0, %for.body.i8.i205.preheader.new ], [ %niter283.next.1, %for.body.i8.i205 ]
  ...
  br i1 %niter283.ncmp.1, label %for.cond.cleanup.loopexit.i.i193.unr-lcssa, label %for.body.i8.i205, !llvm.loop !120
...
_ZL12GetTimeCountv.exit235:                       ; preds = %if.then.i230, %if.end.i233
  ...
  %spec.store.select120 = select i1 %cmp86, i64 1, i64 %sub
  %conv89 = zext i32 %add12 to i64
  %cmp.i236 = icmp eq i64 %spec.store.select120, 0
  %spec.select.i = select i1 %cmp.i236, i64 1, i64 %spec.store.select120
  %mul90 = mul i64 %mul, 1000000
  %mul.i237 = mul i64 %mul90, %conv89
  %div.i = udiv i64 %mul.i237, %spec.select.i
...
ehcleanup111:                                     ; preds = %ehcleanup99, %lpad
  ...
  invoke void @MidFree(ptr noundef %buffer.sroa.8.2)
          to label %_ZN12CBenchBufferD2Ev.exit240 unwind label %terminate.lpad.i239

terminate.lpad.i239:                              ; preds = %ehcleanup111
...
_ZN12CBenchBufferD2Ev.exit240:                    ; preds = %ehcleanup111
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN11CCrcThreadsD2Ev(ptr noundef nonnull align 8 dereferenceable(16) %this) unnamed_addr #13 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN8IUnknownD2Ev(ptr noundef nonnull align 8 dereferenceable(8) %this) unnamed_addr #13 comdat align 2 {
entry:
  ret void
}
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN12CBenchBufferD0Ev(ptr noundef nonnull align 8 dereferenceable(24) %this) unnamed_addr #13 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
  store ptr getelementptr inbounds ({ [4 x ptr] }, ptr @_ZTV12CBenchBuffer, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !54
...
; Function Attrs: nounwind uwtable
define linkonce_odr dso_local void @_ZN12CBenchBufferD2Ev(ptr noundef nonnull align 8 dereferenceable(24) %this) unnamed_addr #13 comdat align 2 personality ptr @__gxx_personality_v0 {
entry:
  store ptr getelementptr inbounds ({ [4 x ptr] }, ptr @_ZTV12CBenchBuffer, i64 0, inrange i32 0, i64 2), ptr %this, align 8, !tbaa !54
