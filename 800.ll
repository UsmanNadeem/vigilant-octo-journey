; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lalr.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/lalr.c"
...
entry:
  ...
  br i1 %cmp128, label %for.body, label %for.end51
...
for.end51:                                        ; preds = %entry, %for.end51.loopexit
  %idxprom53.pre-phi.in = phi i32 [ %20, %for.end51.loopexit ], [ %2, %entry ]
  %22 = phi ptr [ %.pre, %for.end51.loopexit ], [ %call5, %entry ]
  %count.0.lcssa = phi i32 [ %count.1, %for.end51.loopexit ], [ 0, %entry ]
  %idxprom53.pre-phi = sext i32 %idxprom53.pre-phi.in to i64
...
entry:
  ...
  %mul3 = add i32 %add, 2
  %call5 = tail call ptr (i32, ...) @mallocate(i32 noundef %mul3) #7
  %call5277 = ptrtoint ptr %call5 to i64
  ...
  br i1 %cmp225, label %for.body, label %for.end114

for.body:                                         ; preds = %entry, %for.inc112
  %indvars.iv242 = phi i64 [ %indvars.iv.next243, %for.inc112 ], [ 0, %entry ]
  %4 = load ptr, ptr @from_state, align 8, !tbaa !9
  %arrayidx = getelementptr inbounds i16, ptr %4, i64 %indvars.iv242
  ...
  %arrayidx14 = getelementptr inbounds i16, ptr %7, i64 %indvars.iv242
  ...
  %cmp22219 = icmp sgt i16 %12, 0
  br i1 %cmp22219, label %for.body24.lr.ph, label %for.inc112

for.body24.lr.ph:                                 ; preds = %for.body
  %conv16.i = trunc i64 %indvars.iv242 to i16
  %.pre252 = load ptr, ptr @ritem, align 8, !tbaa !9
  br label %for.body24

for.body24:                                       ; preds = %for.body24.lr.ph, %for.inc86
  %.pre250254 = phi ptr [ %.pre252, %for.body24.lr.ph ], [ %.pre250255263, %for.inc86 ]
  %13 = phi ptr [ %.pre252, %for.body24.lr.ph ], [ %51, %for.inc86 ]
  %rulep.0221 = phi ptr [ %11, %for.body24.lr.ph ], [ %incdec.ptr87, %for.inc86 ]
  %nedges.0220 = phi i32 [ 0, %for.body24.lr.ph ], [ %nedges.2264, %for.inc86 ]
  store i16 %5, ptr %call10, align 2, !tbaa !17
  %14 = load ptr, ptr @rrhs, align 8, !tbaa !9
  %15 = load i16, ptr %rulep.0221, align 2, !tbaa !17
  ...
  %cmp32209 = icmp sgt i16 %17, 0
  br i1 %cmp32209, label %for.body34.lr.ph, label %for.end56
...
for.body34:                                       ; preds = %for.body34.lr.ph, %for.end
  %indvars.iv235 = phi i64 [ 1, %for.body34.lr.ph ], [ %indvars.iv.next236, %for.end ]
  %20 = phi i16 [ %17, %for.body34.lr.ph ], [ %25, %for.end ]
  %rp.0212 = phi ptr [ %add.ptr, %for.body34.lr.ph ], [ %incdec.ptr, %for.end ]
  %stateno.0210 = phi i32 [ %conv12, %for.body34.lr.ph ], [ %stateno.2, %for.end ]
  %idxprom36 = sext i32 %stateno.0210 to i64
  ...
  %cmp40207 = icmp sgt i16 %22, 0
  br i1 %cmp40207, label %for.body42.preheader, label %for.end

for.body42.preheader:                             ; preds = %for.body34
  %conv38 = zext i16 %22 to i64
  br label %for.body42

for.cond39:                                       ; preds = %for.body42
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %conv38
  br i1 %exitcond.not, label %for.end.loopexit, label %for.body42, !llvm.loop !54

for.body42:                                       ; preds = %for.body42.preheader, %for.cond39
  %indvars.iv = phi i64 [ 0, %for.body42.preheader ], [ %indvars.iv.next, %for.cond39 ]
  %arrayidx44 = getelementptr inbounds %struct.shifts, ptr %21, i64 0, i32 3, i64 %indvars.iv
  %23 = load i16, ptr %arrayidx44, align 2, !tbaa !17
  %idxprom46 = sext i16 %23 to i64
  %arrayidx47 = getelementptr inbounds i16, ptr %19, i64 %idxprom46
  %24 = load i16, ptr %arrayidx47, align 2, !tbaa !17
  %cmp49 = icmp eq i16 %24, %20
  br i1 %cmp49, label %for.end.split.loop.exit, label %for.cond39

for.end.split.loop.exit:                          ; preds = %for.body42
  %conv45.le = sext i16 %23 to i32
  br label %for.end

for.end.loopexit:                                 ; preds = %for.cond39
  %conv45 = sext i16 %23 to i32
  br label %for.end

for.end:                                          ; preds = %for.end.loopexit, %for.body34, %for.end.split.loop.exit
  %stateno.2 = phi i32 [ %conv45.le, %for.end.split.loop.exit ], [ %stateno.0210, %for.body34 ], [ %conv45, %for.end.loopexit ]
  %conv51 = trunc i32 %stateno.2 to i16
  %indvars.iv.next236 = add nuw i64 %indvars.iv235, 1
  %arrayidx54 = getelementptr inbounds i16, ptr %call10, i64 %indvars.iv235
  store i16 %conv51, ptr %arrayidx54, align 2, !tbaa !17
  %incdec.ptr = getelementptr inbounds i16, ptr %rp.0212, i64 1
  %25 = load i16, ptr %incdec.ptr, align 2, !tbaa !17
  %cmp32 = icmp sgt i16 %25, 0
  br i1 %cmp32, label %for.body34, label %for.end56.loopexit, !llvm.loop !55

for.end56.loopexit:                               ; preds = %for.end
  %26 = trunc i64 %indvars.iv235 to i32
  br label %for.end56

for.end56:                                        ; preds = %for.end56.loopexit, %for.body24
  %stateno.0.lcssa = phi i32 [ %conv12, %for.body24 ], [ %stateno.2, %for.end56.loopexit ]
  %length.0.lcssa = phi i32 [ 0, %for.body24 ], [ %26, %for.end56.loopexit ]
  %rp.0.lcssa = phi ptr [ %add.ptr, %for.body24 ], [ %incdec.ptr, %for.end56.loopexit ]
  %27 = load ptr, ptr @consistent, align 8, !tbaa !9
  %idxprom57 = sext i32 %stateno.0.lcssa to i64
  %arrayidx58 = getelementptr inbounds i8, ptr %27, i64 %idxprom57
  %28 = load i8, ptr %arrayidx58, align 1, !tbaa !28
  %tobool.not = icmp eq i8 %28, 0
  br i1 %tobool.not, label %if.then59, label %while.body.preheader

if.then59:                                        ; preds = %for.end56
  %29 = load i16, ptr %rulep.0221, align 2, !tbaa !17
  %30 = load ptr, ptr @lookaheads, align 8, !tbaa !9
  %arrayidx.i = getelementptr inbounds i16, ptr %30, i64 %idxprom57
  %31 = load i16, ptr %arrayidx.i, align 2, !tbaa !17
  %conv.i = sext i16 %31 to i32
  %add.i = add nsw i32 %stateno.0.lcssa, 1
  %idxprom1.i = sext i32 %add.i to i64
  %arrayidx2.i = getelementptr inbounds i16, ptr %30, i64 %idxprom1.i
  %32 = load i16, ptr %arrayidx2.i, align 2, !tbaa !17
  %conv3.i = sext i16 %32 to i32
  %cmp27.i = icmp slt i16 %31, %32
...
while.body.i:                                     ; preds = %while.body.i, %while.body.lr.ph.i
  ...
  %arrayidx6.i = getelementptr inbounds i16, ptr %33, i64 %idxprom5.i
  %34 = load i16, ptr %arrayidx6.i, align 2, !tbaa !17
  %cmp8.i = icmp ne i16 %34, %29
  %inc.i = zext i1 %cmp8.i to i32
  %i.1.i = add nsw i32 %i.029.i, %inc.i
  %cmp.i = icmp slt i32 %i.1.i, %conv3.i
  %35 = select i1 %cmp8.i, i1 %cmp.i, i1 false
  br i1 %35, label %while.body.i, label %while.end.i, !llvm.loop !56
...
add_lookback_edge.exit:                           ; preds = %while.end.i, %if.then12.i
  ...
  %36 = load ptr, ptr @lookback, align 8, !tbaa !9
  %idxprom14.i = sext i32 %i.0.lcssa34.i to i64
  %arrayidx15.i = getelementptr inbounds ptr, ptr %36, i64 %idxprom14.i
  %37 = load ptr, ptr %arrayidx15.i, align 8, !tbaa !9
  store ptr %37, ptr %call.i, align 8, !tbaa !57
  ...
  %.pre250.pre = load ptr, ptr @ritem, align 8, !tbaa !9
  br label %while.body.preheader

while.body.preheader:                             ; preds = %add_lookback_edge.exit, %for.end56
  %.ph = phi ptr [ %.pre250254, %for.end56 ], [ %.pre250.pre, %add_lookback_edge.exit ]
  br label %while.body

while.body:                                       ; preds = %while.body.preheader, %if.end85
  %.pre250256 = phi ptr [ %.pre250253, %if.end85 ], [ %.ph, %while.body.preheader ]
  %38 = phi ptr [ %47, %if.end85 ], [ %.ph, %while.body.preheader ]
  %rp.1218 = phi ptr [ %incdec.ptr63, %if.end85 ], [ %rp.0.lcssa, %while.body.preheader ]
  %length.1217 = phi i32 [ %dec70, %if.end85 ], [ %length.0.lcssa, %while.body.preheader ]
  %nedges.1216 = phi i32 [ %inc77, %if.end85 ], [ %nedges.0220, %while.body.preheader ]
  %incdec.ptr63 = getelementptr inbounds i16, ptr %rp.1218, i64 -1
  %cmp64.not = icmp ult ptr %incdec.ptr63, %38
  br i1 %cmp64.not, label %for.inc86, label %land.lhs.true

land.lhs.true:                                    ; preds = %while.body
  %39 = load i16, ptr %incdec.ptr63, align 2, !tbaa !17
  %conv66 = sext i16 %39 to i32
  %40 = load i32, ptr @ntokens, align 4, !tbaa !5
  %cmp67.not = icmp sgt i32 %40, %conv66
  br i1 %cmp67.not, label %for.inc86, label %if.then69

if.then69:                                        ; preds = %land.lhs.true
  %dec70 = add nsw i32 %length.1217, -1
  %idxprom71 = sext i32 %dec70 to i64
  %arrayidx72 = getelementptr inbounds i16, ptr %call10, i64 %idxprom71
  %41 = load i16, ptr %arrayidx72, align 2, !tbaa !17
  %42 = load ptr, ptr @goto_map, align 8, !tbaa !9
  %idxprom.i193 = sext i16 %39 to i64
  %arrayidx.i194 = getelementptr inbounds i16, ptr %42, i64 %idxprom.i193
  %43 = load i16, ptr %arrayidx.i194, align 2, !tbaa !17
  %add.i195 = add nsw i32 %conv66, 1
  %idxprom1.i196 = sext i32 %add.i195 to i64
  %arrayidx2.i197 = getelementptr inbounds i16, ptr %42, i64 %idxprom1.i196
  %44 = load i16, ptr %arrayidx2.i197, align 2, !tbaa !17
  %cmp.not28.i = icmp sgt i16 %43, %44
  br i1 %cmp.not28.i, label %while.end.i202, label %while.body.lr.ph.i200

while.body.lr.ph.i200:                            ; preds = %if.then69
  %conv3.i198 = sext i16 %44 to i32
  %conv.i199 = sext i16 %43 to i32
  %45 = load ptr, ptr @from_state, align 8, !tbaa !9
...
while.body.i201:                                  ; preds = %if.else.i, %while.body.lr.ph.i200
  ...
  %div.i = sdiv i32 %add5.i, 2
  %idxprom6.i = sext i32 %div.i to i64
  %arrayidx7.i = getelementptr inbounds i16, ptr %45, i64 %idxprom6.i
  %46 = load i16, ptr %arrayidx7.i, align 2, !tbaa !17
  %cmp9.i = icmp eq i16 %46, %41
  br i1 %cmp9.i, label %if.end85, label %if.else.i

if.else.i:                                        ; preds = %while.body.i201
  %cmp11.i = icmp slt i16 %46, %41
  %add14.i = add nsw i32 %div.i, 1
  %sub.i = add nsw i32 %div.i, -1
  %low.1.i = select i1 %cmp11.i, i32 %add14.i, i32 %low.029.i
  %high.1.i = select i1 %cmp11.i, i32 %high.030.i, i32 %sub.i
...
if.end85:                                         ; preds = %while.body.i201, %while.end.i202
  %.pre250253 = phi ptr [ %.pre, %while.end.i202 ], [ %.pre250256, %while.body.i201 ]
  %47 = phi ptr [ %.pre, %while.end.i202 ], [ %38, %while.body.i201 ]
  %retval.0.i = phi i32 [ undef, %while.end.i202 ], [ %div.i, %while.body.i201 ]
  %conv76 = trunc i32 %retval.0.i to i16
  %inc77 = add nsw i32 %nedges.1216, 1
  %idxprom78 = sext i32 %nedges.1216 to i64
  %arrayidx79 = getelementptr inbounds i16, ptr %call5, i64 %idxprom78
  store i16 %conv76, ptr %arrayidx79, align 2, !tbaa !17
  %48 = load ptr, ptr @nullable, align 8, !tbaa !9
  %49 = load i16, ptr %incdec.ptr63, align 2, !tbaa !17
  %idxprom80 = sext i16 %49 to i64
  %arrayidx81 = getelementptr inbounds i8, ptr %48, i64 %idxprom80
  %50 = load i8, ptr %arrayidx81, align 1, !tbaa !28
  %tobool82.not.not = icmp eq i8 %50, 0
  br i1 %tobool82.not.not, label %for.inc86, label %while.body, !llvm.loop !60

for.inc86:                                        ; preds = %while.body, %land.lhs.true, %if.end85
  %nedges.2264 = phi i32 [ %inc77, %if.end85 ], [ %nedges.1216, %land.lhs.true ], [ %nedges.1216, %while.body ]
  %51 = phi ptr [ %47, %if.end85 ], [ %38, %land.lhs.true ], [ %38, %while.body ]
  %.pre250255263 = phi ptr [ %.pre250253, %if.end85 ], [ %.pre250256, %land.lhs.true ], [ %.pre250256, %while.body ]
  %incdec.ptr87 = getelementptr inbounds i16, ptr %rulep.0221, i64 1
  %52 = load i16, ptr %incdec.ptr87, align 2, !tbaa !17
  %cmp22 = icmp sgt i16 %52, 0
  br i1 %cmp22, label %for.body24, label %for.end88, !llvm.loop !61

for.end88:                                        ; preds = %for.inc86
  %tobool89.not = icmp eq i32 %nedges.2264, 0
  br i1 %tobool89.not, label %for.inc112, label %if.then90

if.then90:                                        ; preds = %for.end88
  %add91 = shl i32 %nedges.2264, 1
  %mul93 = add i32 %add91, 2
  %call95 = tail call ptr (i32, ...) @mallocate(i32 noundef %mul93) #7
  %53 = load ptr, ptr @includes, align 8, !tbaa !9
  %arrayidx97 = getelementptr inbounds ptr, ptr %53, i64 %indvars.iv242
  store ptr %call95, ptr %arrayidx97, align 8, !tbaa !9
  %cmp99223 = icmp sgt i32 %nedges.2264, 0
  br i1 %cmp99223, label %for.body101.preheader, label %for.end108

for.body101.preheader:                            ; preds = %if.then90
  %call95276 = ptrtoint ptr %call95 to i64
  %wide.trip.count240 = zext i32 %nedges.2264 to i64
  %min.iters.check = icmp ult i32 %nedges.2264, 16
  %54 = sub i64 %call95276, %call5277
  %diff.check = icmp ult i64 %54, 32
  %or.cond = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond, label %for.body101.preheader279, label %vector.ph

vector.ph:                                        ; preds = %for.body101.preheader
  %n.vec = and i64 %wide.trip.count240, 4294967280
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %55 = getelementptr inbounds i16, ptr %call5, i64 %index
  %wide.load = load <8 x i16>, ptr %55, align 2, !tbaa !17
  %56 = getelementptr inbounds i16, ptr %55, i64 8
  %wide.load278 = load <8 x i16>, ptr %56, align 2, !tbaa !17
  %57 = getelementptr inbounds i16, ptr %call95, i64 %index
  store <8 x i16> %wide.load, ptr %57, align 2, !tbaa !17
  %58 = getelementptr inbounds i16, ptr %57, i64 8
  store <8 x i16> %wide.load278, ptr %58, align 2, !tbaa !17
  %index.next = add nuw i64 %index, 16
  %59 = icmp eq i64 %index.next, %n.vec
  br i1 %59, label %middle.block, label %vector.body, !llvm.loop !62

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count240
  br i1 %cmp.n, label %for.end108, label %for.body101.preheader279

for.body101.preheader279:                         ; preds = %for.body101.preheader, %middle.block
  %indvars.iv237.ph = phi i64 [ 0, %for.body101.preheader ], [ %n.vec, %middle.block ]
  %60 = xor i64 %indvars.iv237.ph, -1
  %61 = add nsw i64 %60, %wide.trip.count240
  %xtraiter = and i64 %wide.trip.count240, 3
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %for.body101.prol.loopexit, label %for.body101.prol

for.body101.prol:                                 ; preds = %for.body101.preheader279, %for.body101.prol
  %indvars.iv237.prol = phi i64 [ %indvars.iv.next238.prol, %for.body101.prol ], [ %indvars.iv237.ph, %for.body101.preheader279 ]
  %prol.iter = phi i64 [ %prol.iter.next, %for.body101.prol ], [ 0, %for.body101.preheader279 ]
  %arrayidx103.prol = getelementptr inbounds i16, ptr %call5, i64 %indvars.iv237.prol
  %62 = load i16, ptr %arrayidx103.prol, align 2, !tbaa !17
  %arrayidx105.prol = getelementptr inbounds i16, ptr %call95, i64 %indvars.iv237.prol
  store i16 %62, ptr %arrayidx105.prol, align 2, !tbaa !17
  %indvars.iv.next238.prol = add nuw nsw i64 %indvars.iv237.prol, 1
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %for.body101.prol.loopexit, label %for.body101.prol, !llvm.loop !63

for.body101.prol.loopexit:                        ; preds = %for.body101.prol, %for.body101.preheader279
  %indvars.iv237.unr = phi i64 [ %indvars.iv237.ph, %for.body101.preheader279 ], [ %indvars.iv.next238.prol, %for.body101.prol ]
  %63 = icmp ult i64 %61, 3
  br i1 %63, label %for.end108, label %for.body101

for.body101:                                      ; preds = %for.body101.prol.loopexit, %for.body101
  %indvars.iv237 = phi i64 [ %indvars.iv.next238.3, %for.body101 ], [ %indvars.iv237.unr, %for.body101.prol.loopexit ]
  %arrayidx103 = getelementptr inbounds i16, ptr %call5, i64 %indvars.iv237
  %64 = load i16, ptr %arrayidx103, align 2, !tbaa !17
  %arrayidx105 = getelementptr inbounds i16, ptr %call95, i64 %indvars.iv237
  store i16 %64, ptr %arrayidx105, align 2, !tbaa !17
  %indvars.iv.next238 = add nuw nsw i64 %indvars.iv237, 1
  %arrayidx103.1 = getelementptr inbounds i16, ptr %call5, i64 %indvars.iv.next238
  %65 = load i16, ptr %arrayidx103.1, align 2, !tbaa !17
  %arrayidx105.1 = getelementptr inbounds i16, ptr %call95, i64 %indvars.iv.next238
  store i16 %65, ptr %arrayidx105.1, align 2, !tbaa !17
  %indvars.iv.next238.1 = add nuw nsw i64 %indvars.iv237, 2
  %arrayidx103.2 = getelementptr inbounds i16, ptr %call5, i64 %indvars.iv.next238.1
  %66 = load i16, ptr %arrayidx103.2, align 2, !tbaa !17
  %arrayidx105.2 = getelementptr inbounds i16, ptr %call95, i64 %indvars.iv.next238.1
  store i16 %66, ptr %arrayidx105.2, align 2, !tbaa !17
  %indvars.iv.next238.2 = add nuw nsw i64 %indvars.iv237, 3
  %arrayidx103.3 = getelementptr inbounds i16, ptr %call5, i64 %indvars.iv.next238.2
  %67 = load i16, ptr %arrayidx103.3, align 2, !tbaa !17
  %arrayidx105.3 = getelementptr inbounds i16, ptr %call95, i64 %indvars.iv.next238.2
  store i16 %67, ptr %arrayidx105.3, align 2, !tbaa !17
  ...
  br i1 %exitcond241.not.3, label %for.end108, label %for.body101, !llvm.loop !64

for.end108:                                       ; preds = %for.body101.prol.loopexit, %for.body101, %middle.block, %if.then90
  %idxprom109 = sext i32 %nedges.2264 to i64
...
for.inc112:                                       ; preds = %for.body, %for.end88, %for.end108
  ...
  %68 = load i32, ptr @ngotos, align 4, !tbaa !5
  %69 = sext i32 %68 to i64
  %cmp = icmp slt i64 %indvars.iv.next243, %69
  br i1 %cmp, label %for.body, label %for.end114, !llvm.loop !65

for.end114:                                       ; preds = %for.inc112, %entry
  %.lcssa = phi i32 [ %3, %entry ], [ %68, %for.inc112 ]
  %70 = load ptr, ptr @includes, align 8, !tbaa !9
  %call115 = tail call ptr @transpose(ptr noundef %70, i32 noundef %.lcssa)
  %71 = load i32, ptr @ngotos, align 4, !tbaa !5
  %cmp117228 = icmp sgt i32 %71, 0
  %72 = load ptr, ptr @includes, align 8, !tbaa !9
  br i1 %cmp117228, label %for.body119.lr.ph, label %for.end134

for.body119.lr.ph:                                ; preds = %for.end114
  %wide.trip.count248 = zext i32 %71 to i64
  br label %for.body119

for.body119:                                      ; preds = %for.body119.lr.ph, %for.inc132
  %indvars.iv245 = phi i64 [ 0, %for.body119.lr.ph ], [ %indvars.iv.next246, %for.inc132 ]
  %arrayidx121 = getelementptr inbounds ptr, ptr %72, i64 %indvars.iv245
  %73 = load ptr, ptr %arrayidx121, align 8, !tbaa !9
...
for.inc132:                                       ; preds = %for.body119, %if.then127
  ...
  br i1 %exitcond249.not, label %if.then136, label %for.body119, !llvm.loop !66

for.end134:                                       ; preds = %for.end114
  %tobool135.not = icmp eq ptr %72, null
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %uglygep74 = getelementptr i8, ptr %5, i64 4
  br label %for.body
...
for.body5.us.preheader:                           ; preds = %for.body
  ...
  %uglygep = getelementptr i8, ptr %rowp.059, i64 4
  ...
  %11 = add i64 %umax, %10
  %12 = and i64 %11, -4
  %uglygep73 = getelementptr i8, ptr %uglygep, i64 %12
  %uglygep75 = getelementptr i8, ptr %uglygep74, i64 %12
...
vector.memcheck:                                  ; preds = %for.body5.us
  ...
  %uglygep76 = getelementptr i8, ptr %uglygep75, i64 %24
  %bound0 = icmp ult ptr %rowp.059, %uglygep76
  %bound1 = icmp ult ptr %add.ptr8.us, %uglygep73
...
while.body.us.preheader:                          ; preds = %while.body.lr.ph
  ...
  %19 = add i64 %18, %11
  %20 = add i64 %19, 4
  %uglygep = getelementptr i8, ptr %3, i64 %20
  %21 = add i64 %18, 4
...
vector.memcheck:                                  ; preds = %if.end29.us
  %uglygep129 = getelementptr i8, ptr %41, i64 %21
  %43 = shl nsw i64 %idx.ext31.us, 2
  %uglygep130 = getelementptr i8, ptr %uglygep129, i64 %43
  %bound0 = icmp ult ptr %add.ptr, %uglygep130
  %bound1 = icmp ult ptr %add.ptr32.us, %uglygep
  %found.conflict = and i1 %bound0, %bound1
