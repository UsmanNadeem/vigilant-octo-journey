; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Benchmarks/Dhrystone/fldry.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Benchmarks/Dhrystone/fldry.c"
...
; Function Attrs: mustprogress nosync nounwind willreturn memory(readwrite, inaccessiblemem: none) uwtable
...
entry:
  ...
  %0 = insertelement <2 x double> poison, double %IntParI2, i64 0
  %1 = shufflevector <2 x double> %0, <2 x double> poison, <2 x i32> zeroinitializer
  store <2 x double> %1, ptr %arrayidx, align 8, !tbaa !15
...
for.end:                                          ; preds = %for.body, %entry
  ...
  %2 = load double, ptr %arrayidx25, align 8, !tbaa !15
  %inc26 = fadd double %2, 1.000000e+00
  ...
  store double %3, ptr %arrayidx36, align 8, !tbaa !15
  store double 5.000000e+00, ptr @IntGlob, align 8, !tbaa !15
  ret i32 undef
}
...
entry:
  %call162 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %StrParI1, ptr noundef nonnull dereferenceable(1) %StrParI2) #15
  %cmp169 = icmp sgt i32 %call162, 0
  %. = zext i1 %cmp169 to i32
  ret i32 %.
}
...
attributes #6 = { mustprogress nosync nounwind willreturn memory(readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #12 = { nofree nounwind memory(argmem: read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
