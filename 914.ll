; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C++/fsm/fsm.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C++/fsm/fsm.cpp"
...
entry:
  ...
  %call1 = call i32 (ptr, ...) @scanf(ptr noundef nonnull @.str.1, ptr noundef nonnull %input_string)
  %0 = load i32, ptr @_ZN6sample5edgesE, align 16, !tbaa !11
