; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Benchmarks/Polybench/linear-algebra/kernels/cholesky/cholesky.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Benchmarks/Polybench/linear-algebra/kernels/cholesky/cholesky.c"
...
define dso_local void @polybench_prepare_instruments() local_unnamed_addr #3 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(write, argmem: none, inaccessiblemem: none) uwtable
define dso_local void @polybench_timer_start() local_unnamed_addr #4 {
entry:
...
entry:
  ...
  %call.i.i = call i32 @posix_memalign(ptr noundef nonnull %new.i.i, i64 noundef 32, i64 noundef 8388608) #13
...
if.then.i.i:                                      ; preds = %entry
  ...
  %3 = call i64 @fwrite(ptr nonnull @.str.1, i64 50, i64 1, ptr %2) #14
  call void @exit(i32 noundef 1) #15
  unreachable

polybench_alloc_data.exit:                        ; preds = %entry
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %new.i.i) #13
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %new.i.i30) #13
  store ptr null, ptr %new.i.i30, align 8, !tbaa !9
  %call.i.i31 = call i32 @posix_memalign(ptr noundef nonnull %new.i.i30, i64 noundef 32, i64 noundef 8192) #13
...
if.then.i.i35:                                    ; preds = %polybench_alloc_data.exit
  ...
  %6 = call i64 @fwrite(ptr nonnull @.str.1, i64 50, i64 1, ptr %5) #14
  call void @exit(i32 noundef 1) #15
  unreachable

polybench_alloc_data.exit36:                      ; preds = %polybench_alloc_data.exit
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %new.i.i30) #13
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %new.i.i37) #13
  store ptr null, ptr %new.i.i37, align 8, !tbaa !9
  %call.i.i38 = call i32 @posix_memalign(ptr noundef nonnull %new.i.i37, i64 noundef 32, i64 noundef 8388608) #13
...
if.then.i.i42:                                    ; preds = %polybench_alloc_data.exit36
  ...
  %10 = call i64 @fwrite(ptr nonnull @.str.1, i64 50, i64 1, ptr %9) #14
  call void @exit(i32 noundef 1) #15
  unreachable

polybench_alloc_data.exit43:                      ; preds = %polybench_alloc_data.exit36
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %new.i.i37) #13
  br label %for.body.i
...
for.end.i:                                        ; preds = %for.end.i.loopexit.unr-lcssa, %for.body6.i.epil, %for.body.i44
  ...
  %call.i = call double @sqrt(double noundef %x.0.lcssa.i) #13
...
for.end.i66:                                      ; preds = %for.end.i66.loopexit.unr-lcssa, %for.body6.i61.epil, %for.body.i56
  ...
  %call.i63 = call double @sqrt(double noundef %x.0.lcssa.i62) #13
...
check_FP.exit.thread:                             ; preds = %for.inc.i, %for.body3.i
  ...
  %call.i77 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %79, ptr noundef nonnull @.str.2, i32 noundef %77, i32 noundef %78, double noundef %.lcssa128, i32 noundef %77, i32 noundef %78, double noundef %.lcssa, double noundef 1.000000e-05) #14
  br label %cleanup
...
if.end:                                           ; preds = %for.inc13.i
  %call.i80 = call noalias dereferenceable_or_null(16385) ptr @malloc(i64 noundef 16385) #16
...
for.end.i87:                                      ; preds = %for.body6.i86
  ...
  %call12.i = call i32 @fputs(ptr noundef nonnull %call.i80, ptr noundef %98) #14
...
print_array.exit:                                 ; preds = %for.end.i87
  call void @free(ptr noundef nonnull %call.i80) #13
