; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mafft/partSalignmm.c"
...
entry:
  ...
  %1 = load i32, ptr @partA__align.orlgth1, align 4, !tbaa !11
  %cmp = icmp eq i32 %1, 0
...
if.then:                                          ; preds = %entry
  ...
  %.pre = load i32, ptr @partA__align.orlgth1, align 4, !tbaa !11
  br label %if.end
...
for.end101:                                       ; preds = %for.body93.prol.loopexit, %for.body93, %middle.block1006, %for.cond90.preheader
  %74 = load i32, ptr @commonAlloc1, align 4, !tbaa !11
...
if.then112:                                       ; preds = %if.then107
  ...
  %.pre988 = load i32, ptr @partA__align.orlgth1, align 4, !tbaa !11
  %.pre989 = load i32, ptr @commonAlloc1, align 4, !tbaa !11
  %.pre990 = load i32, ptr @partA__align.orlgth2, align 4, !tbaa !11
  %.pre991 = load i32, ptr @commonAlloc2, align 4, !tbaa !11
  br label %if.end113
...
vector.memcheck1019:                              ; preds = %for.body136.lr.ph
  ...
  %uglygep = getelementptr i8, ptr %90, i64 %92
  %uglygep1020 = getelementptr i8, ptr %91, i64 %92
  %bound0 = icmp ult ptr %90, %uglygep1020
  %bound1 = icmp ult ptr %91, %uglygep
...
vector.memcheck1034:                              ; preds = %for.body163.lr.ph
  ...
  %uglygep1035 = getelementptr i8, ptr %106, i64 %108
  %uglygep1036 = getelementptr i8, ptr %107, i64 %108
  %bound01037 = icmp ult ptr %106, %uglygep1036
  %bound11038 = icmp ult ptr %107, %uglygep1035
...
vector.memcheck1087:                              ; preds = %for.body204.lr.ph
  %uglygep1088 = getelementptr i8, ptr %184, i64 4
  %187 = shl nuw nsw i64 %wide.trip.count944, 2
  %uglygep1089 = getelementptr i8, ptr %184, i64 %187
  %188 = add nsw i64 %187, -4
  %uglygep1091 = getelementptr i8, ptr %183, i64 %188
  %bound01092 = icmp ult ptr %184, %182
  %bound11093 = icmp ult ptr %182, %uglygep1089
  %found.conflict1094 = and i1 %bound01092, %bound11093
  %bound01095 = icmp ult ptr %uglygep1088, %uglygep1091
  %bound11096 = icmp ult ptr %183, %uglygep1089
...
vector.memcheck1119:                              ; preds = %for.body220.lr.ph
  %uglygep1120 = getelementptr i8, ptr %126, i64 4
  %208 = shl nuw nsw i64 %wide.trip.count950, 2
  %uglygep1121 = getelementptr i8, ptr %126, i64 %208
  %209 = add nsw i64 %208, -4
  %uglygep1123 = getelementptr i8, ptr %205, i64 %209
  %bound01124 = icmp ult ptr %126, %204
  %bound11125 = icmp ult ptr %204, %uglygep1121
  %found.conflict1126 = and i1 %bound01124, %bound11125
  %bound01127 = icmp ult ptr %uglygep1120, %uglygep1123
  %bound11128 = icmp ult ptr %205, %uglygep1121
...
vector.memcheck1152:                              ; preds = %for.body269.lr.ph
  %uglygep1153 = getelementptr i8, ptr %256, i64 4
  %260 = shl nuw nsw i64 %wide.trip.count956, 2
  %uglygep1154 = getelementptr i8, ptr %256, i64 %260
  %261 = add nsw i64 %260, -4
  %uglygep1155 = getelementptr i8, ptr %126, i64 %261
  %uglygep1156 = getelementptr i8, ptr %255, i64 8
  %bound01157 = icmp ult ptr %uglygep1153, %uglygep1155
  %bound11158 = icmp ult ptr %126, %uglygep1154
  %found.conflict1159 = and i1 %bound01157, %bound11158
  %bound01160 = icmp ult ptr %uglygep1153, %uglygep1156
  %bound11161 = icmp ult ptr %arrayidx273, %uglygep1154
...
while.end187.i845:                                ; preds = %for.end185.i842, %while.end.i827
  ...
  %or.cond.i844 = select i1 %cmp188.i, i1 true, i1 %cmp190.i
