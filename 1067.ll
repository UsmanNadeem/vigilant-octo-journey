; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/telecomm-gsm/lpc.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/telecomm-gsm/lpc.c"
...
entry:
  ...
  %rdx.minmax.select = tail call <8 x i16> @llvm.umax.v8i16(<8 x i16> %135, <8 x i16> %136)
  %137 = tail call i16 @llvm.vector.reduce.umax.v8i16(<8 x i16> %rdx.minmax.select)
...
if.end.i:                                         ; preds = %Autocorrelation.exit
  %call.i4 = tail call signext i16 @gsm_norm(i64 noundef %shl399.8.i) #5
...
if.end65.i:                                       ; preds = %if.end65.i.preheader, %for.inc167.i
  ...
  %call67.i = tail call signext i16 @gsm_div(i16 noundef signext %cond49.i63, i16 noundef signext %723) #5
...
Transformation_to_Log_Area_Ratios.exit:           ; preds = %if.else25.7.i, %if.then21.7.i, %if.then.7.i
  ...
  %814 = shufflevector <2 x i64> %807, <2 x i64> poison, <8 x i32> <i32 0, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
