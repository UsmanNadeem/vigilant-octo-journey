; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/makebins.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/makebins.c"
...
for.body5:                                        ; preds = %for.cond2.preheader, %for.cond2
  ...
  %call = tail call double @pow(double noundef %add, double noundef 4.000000e+00) #6
  %call8 = tail call double @sqrt(double noundef %conv) #6
  %0 = tail call double @llvm.fmuladd.f64(double %call8, double 2.000000e+00, double 2.000000e+00)
  %call9 = tail call double @pow(double noundef %add, double noundef 3.000000e+00) #6
  %neg = fneg double %0
  %1 = tail call double @llvm.fmuladd.f64(double %neg, double %call9, double %call)
  %call10 = tail call double @sqrt(double noundef %conv) #6
...
for.end17:                                        ; preds = %for.inc15, %for.body5
  ...
  %add19 = add i32 %conv18, 1
  %add22 = shl nsw i32 %add19, 1
  %sub23 = add nsw i32 %add22, -2
...
for.body27.lr.ph:                                 ; preds = %for.end17
  ...
  %smax = tail call i32 @llvm.smax.i32(i32 %add19, i32 1)
...
for.body55.lr.ph:                                 ; preds = %for.cond52.preheader
  ...
  %smax316 = tail call i32 @llvm.smax.i32(i32 %add19, i32 1)
  br label %for.body55
...
if.end34:                                         ; preds = %for.body27
  %9 = tail call double @llvm.fmuladd.f64(double %neg38, double %add, double %conv29)
  %conv39 = sitofp i32 %diff.0294 to double
  %cmp40 = fcmp olt double %9, %conv39
  br i1 %cmp40, label %if.then42, label %for.inc49

if.then42:                                        ; preds = %if.end34
  %conv47 = fptosi double %9 to i32
  br label %for.inc49
...
if.end34.1:                                       ; preds = %for.inc49
  %10 = tail call double @llvm.fmuladd.f64(double %neg38, double %add, double %conv29.1)
  %conv39.1 = sitofp i32 %diff.1 to double
  %cmp40.1 = fcmp olt double %10, %conv39.1
  br i1 %cmp40.1, label %if.then42.1, label %for.inc49.1

if.then42.1:                                      ; preds = %if.end34.1
  %conv47.1 = fptosi double %10 to i32
...
for.end109.thread:                                ; preds = %for.cond52.preheader
  %cmp112354 = icmp slt i32 %saveHx.1.lcssa, 100
  br i1 %cmp112354, label %if.end148, label %if.end131.thread
...
for.body84.lr.ph:                                 ; preds = %for.cond81.preheader
  %11 = tail call double @llvm.fmuladd.f64(double %add, double %add, double -5.000000e-01)
  %neg96 = fneg double %add
  %xtraiter413 = and i32 %smax, 1
  %12 = icmp eq i32 %5, 0
  br i1 %12, label %for.end109.loopexit.unr-lcssa, label %for.body84.lr.ph.new

for.body84.lr.ph.new:                             ; preds = %for.body84.lr.ph
  %unroll_iter417 = and i32 %smax, 2147483646
  br label %for.body84
...
if.end63:                                         ; preds = %for.body55
  %14 = tail call double @llvm.fmuladd.f64(double %neg67, double %add, double %conv58)
  %conv68 = sitofp i32 %diff.2300 to double
  %cmp69 = fcmp olt double %14, %conv68
  br i1 %cmp69, label %if.then71, label %for.inc78

if.then71:                                        ; preds = %if.end63
  %conv76 = fptosi double %14 to i32
  br label %for.inc78
...
for.inc78:                                        ; preds = %if.end63, %if.then71, %for.body55
  ...
  %exitcond317 = icmp eq i32 %x.1299, %smax316
  br i1 %exitcond317, label %for.cond81.preheader, label %for.body55, !llvm.loop !9
...
for.body84:                                       ; preds = %for.inc107.1, %for.body84.lr.ph.new
  ...
  %niter418 = phi i32 [ 0, %for.body84.lr.ph.new ], [ %niter418.next.1, %for.inc107.1 ]
  %sub85 = sub i32 %sub23, %x.2306
  %mul86 = mul nsw i32 %sub85, %x.2306
  %conv87 = sitofp i32 %mul86 to double
  %cmp89 = fcmp ogt double %11, %conv87
  br i1 %cmp89, label %for.inc107, label %if.end92

if.end92:                                         ; preds = %for.body84
  %15 = tail call double @llvm.fmuladd.f64(double %neg96, double %add, double %conv87)
  %conv97 = sitofp i32 %diff.4307 to double
  %cmp98 = fcmp olt double %15, %conv97
  br i1 %cmp98, label %if.then100, label %for.inc107

if.then100:                                       ; preds = %if.end92
  %conv105 = fptosi double %15 to i32
  br label %for.inc107
...
for.inc107.1:                                     ; preds = %if.then100.1, %if.end92.1, %for.inc107
  ...
  %niter418.next.1 = add i32 %niter418, 2
  %niter418.ncmp.1 = icmp eq i32 %niter418.next.1, %unroll_iter417
  br i1 %niter418.ncmp.1, label %for.end109.loopexit.unr-lcssa, label %for.body84, !llvm.loop !10
...
for.end109.loopexit.unr-lcssa:                    ; preds = %for.inc107.1, %for.body84.lr.ph
  ...
  %lcmp.mod414.not = icmp eq i32 %xtraiter413, 0
  br i1 %lcmp.mod414.not, label %for.end109, label %for.body84.epil

for.body84.epil:                                  ; preds = %for.end109.loopexit.unr-lcssa
  %sub85.epil = sub i32 %sub23, %x.2306.unr
  %mul86.epil = mul nsw i32 %sub85.epil, %x.2306.unr
  %conv87.epil = sitofp i32 %mul86.epil to double
  %cmp89.epil = fcmp ogt double %11, %conv87.epil
  br i1 %cmp89.epil, label %for.end109, label %if.end92.epil

if.end92.epil:                                    ; preds = %for.body84.epil
  %17 = tail call double @llvm.fmuladd.f64(double %neg96, double %add, double %conv87.epil)
  %conv97.epil = sitofp i32 %diff.4307.unr to double
  %cmp98.epil = fcmp olt double %17, %conv97.epil
...
if.else121:                                       ; preds = %for.end109
  %brmerge = select i1 %cmp112, i1 true, i1 %cmp110
...
if.end148:                                        ; preds = %if.else121, %for.end109.thread, %if.end131.thread, %if.then139, %if.then136
  ...
  %18 = load ptr, ptr @fpo, align 8, !tbaa !15
  %call149 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %18, ptr noundef nonnull @.str, i32 noundef %xbins.1)
  %19 = load ptr, ptr @fpo, align 8, !tbaa !15
  %20 = load i32, ptr @numBinsY, align 4, !tbaa !11
  %call150 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %19, ptr noundef nonnull @.str.1, i32 noundef %20)
  %21 = load i32, ptr @numBinsX, align 4, !tbaa !11
  %add151 = add i32 %21, 1
  %conv152 = sext i32 %add151 to i64
  %mul153 = shl nsw i64 %conv152, 3
  %call154 = tail call noalias ptr @malloc(i64 noundef %mul153) #7
  store ptr %call154, ptr @blockarray, align 8, !tbaa !15
  %cmp156.not312 = icmp slt i32 %21, 0
  br i1 %cmp156.not312, label %for.end180, label %for.body158.lr.ph

for.body158.lr.ph:                                ; preds = %if.end148
  %22 = load i32, ptr @numBinsY, align 4, !tbaa !11
  %add159 = add i32 %22, 1
  %conv160 = sext i32 %add159 to i64
  %mul161 = shl nsw i64 %conv160, 3
  %cmp164.not310 = icmp slt i32 %22, 0
  %23 = load i32, ptr @numcells, align 4
  %add167 = add nsw i32 %23, 5
  %conv168 = sext i32 %add167 to i64
  %mul169 = shl nsw i64 %conv168, 2
  %wide.trip.count330 = zext i32 %add151 to i64
...
for.body158.us:                                   ; preds = %for.body158.lr.ph, %for.body158.us
  %indvars.iv327 = phi i64 [ %indvars.iv.next328, %for.body158.us ], [ 0, %for.body158.lr.ph ]
  %call162.us = tail call noalias ptr @malloc(i64 noundef %mul161) #7
  %24 = load ptr, ptr @blockarray, align 8, !tbaa !15
  %arrayidx.us = getelementptr inbounds ptr, ptr %24, i64 %indvars.iv327
  ...
  br i1 %exitcond331.not, label %for.end180, label %for.body158.us, !llvm.loop !17

for.body158:                                      ; preds = %for.body158.preheader, %for.cond163.for.inc178_crit_edge
  %indvars.iv322 = phi i64 [ 0, %for.body158.preheader ], [ %indvars.iv.next323, %for.cond163.for.inc178_crit_edge ]
  %call162 = tail call noalias ptr @malloc(i64 noundef %mul161) #7
  %25 = load ptr, ptr @blockarray, align 8, !tbaa !15
  %arrayidx = getelementptr inbounds ptr, ptr %25, i64 %indvars.iv322
...
for.body166:                                      ; preds = %for.body158, %for.body166
  ...
  %call170 = tail call noalias ptr @malloc(i64 noundef %mul169) #7
  %26 = load ptr, ptr @blockarray, align 8, !tbaa !15
  %arrayidx172 = getelementptr inbounds ptr, ptr %26, i64 %indvars.iv322
  %27 = load ptr, ptr %arrayidx172, align 8, !tbaa !15
  %arrayidx174 = getelementptr inbounds ptr, ptr %27, i64 %indvars.iv
  store ptr %call170, ptr %arrayidx174, align 8, !tbaa !15
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond321.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond321.not, label %for.cond163.for.inc178_crit_edge, label %for.body166, !llvm.loop !18
...
for.cond163.for.inc178_crit_edge:                 ; preds = %for.body166
  ...
  br i1 %exitcond326.not, label %for.end180, label %for.body158, !llvm.loop !17

for.end180:                                       ; preds = %for.cond163.for.inc178_crit_edge, %for.body158.us, %if.end148
  %28 = load ptr, ptr @blockarray, align 8, !tbaa !15
  %29 = load ptr, ptr %28, align 8, !tbaa !15
  %30 = load ptr, ptr %29, align 8, !tbaa !15
  store ptr %30, ptr @bucket, align 8, !tbaa !15
  ret void
}
