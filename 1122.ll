; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/7z/7zDecode.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/7z/7zDecode.cpp"
...
vector.ph:                                        ; preds = %for.body324.preheader
  ...
  %221 = getelementptr i8, ptr %call.i951953, i64 -1
  %222 = getelementptr i8, ptr %call.i951953, i64 -1
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %223 = getelementptr inbounds i32, ptr %password.sroa.0.1, i64 %index
  %wide.load = load <4 x i32>, ptr %223, align 4, !tbaa !90
  %224 = getelementptr inbounds i32, ptr %223, i64 4
  %wide.load1449 = load <4 x i32>, ptr %224, align 4, !tbaa !90
  %225 = trunc <4 x i32> %wide.load to <4 x i8>
  %226 = trunc <4 x i32> %wide.load1449 to <4 x i8>
  %227 = shl nuw nsw i64 %index, 1
  %228 = shl i64 %index, 1
  %229 = lshr <4 x i32> %wide.load, <i32 8, i32 8, i32 8, i32 8>
  %230 = lshr <4 x i32> %wide.load1449, <i32 8, i32 8, i32 8, i32 8>
  %231 = trunc <4 x i32> %229 to <4 x i8>
  %232 = trunc <4 x i32> %230 to <4 x i8>
  %233 = or i64 %227, 1
  %234 = or i64 %228, 9
  %235 = getelementptr i8, ptr %221, i64 %233
  %236 = getelementptr i8, ptr %222, i64 %234
  %interleaved.vec = shufflevector <4 x i8> %225, <4 x i8> %231, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x i8> %interleaved.vec, ptr %235, align 1, !tbaa !94
  %interleaved.vec1450 = shufflevector <4 x i8> %226, <4 x i8> %232, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x i8> %interleaved.vec1450, ptr %236, align 1, !tbaa !94
  %index.next = add nuw i64 %index, 8
  %237 = icmp eq i64 %index.next, %n.vec
  br i1 %237, label %middle.block, label %vector.body, !llvm.loop !95
...
for.cond.cleanup323:                              ; preds = %for.body324, %middle.block, %invoke.cont311, %_ZN7CBufferIhE11SetCapacityEm.exit
  ...
  %238 = load ptr, ptr %cryptoSetPassword, align 8, !tbaa !86
  %vtable355 = load ptr, ptr %238, align 8, !tbaa !12
  %vfn356 = getelementptr inbounds ptr, ptr %vtable355, i64 5
  %239 = load ptr, ptr %vfn356, align 8
  %call358 = invoke noundef i32 %239(ptr noundef nonnull align 8 dereferenceable(8) %238, ptr noundef %buffer.sroa.9.11351, i32 noundef %mul)
...
for.body324:                                      ; preds = %for.body324.preheader1454, %for.body324
  ...
  %242 = load i32, ptr %arrayidx329, align 4, !tbaa !90
  %conv330 = trunc i32 %242 to i8
  %243 = shl nuw nsw i64 %indvars.iv1327, 1
  %arrayidx335 = getelementptr inbounds i8, ptr %call.i951953, i64 %243
  store i8 %conv330, ptr %arrayidx335, align 1, !tbaa !94
  %244 = lshr i32 %242, 8
  %conv336 = trunc i32 %244 to i8
  %245 = or i64 %243, 1
  %arrayidx342 = getelementptr inbounds i8, ptr %call.i951953, i64 %245
...
cleanup376:                                       ; preds = %delete.notnull.i963, %_ZN11CStringBaseIwED2Ev.exit, %invoke.cont297
  ...
  %247 = load ptr, ptr %passwordBSTR, align 8, !tbaa !88
  invoke void @SysFreeString(ptr noundef %247)
...
ehcleanup367:                                     ; preds = %lpad350, %lpad312
  ...
  %.pn661 = phi { ptr, i32 } [ %246, %lpad350 ], [ %241, %lpad312 ]
...
ehcleanup377:                                     ; preds = %delete.notnull.i973, %ehcleanup371, %ehcleanup371.thread, %lpad292
  %.pn661.pn.pn = phi { ptr, i32 } [ %213, %lpad292 ], [ %240, %ehcleanup371.thread ], [ %.pn661, %ehcleanup371 ], [ %.pn661, %delete.notnull.i973 ]
  %250 = load ptr, ptr %passwordBSTR, align 8, !tbaa !88
  invoke void @SysFreeString(ptr noundef %250)
...
if.then.i983:                                     ; preds = %if.then285, %cleanup383
  ...
  %253 = phi ptr [ %.pr1352, %cleanup383 ], [ %210, %if.then285 ]
  %vtable.i980 = load ptr, ptr %253, align 8, !tbaa !12
  %vfn.i981 = getelementptr inbounds ptr, ptr %vtable.i980, i64 2
  %254 = load ptr, ptr %vfn.i981, align 8
  %call.i982 = invoke noundef i32 %254(ptr noundef nonnull align 8 dereferenceable(8) %253)
...
cleanup.cont387:                                  ; preds = %_ZN9CMyComPtrI18ICryptoSetPasswordED2Ev.exit
  ...
  %257 = load i32, ptr %NumInStreams, align 8, !tbaa !57
  %NumOutStreams = getelementptr inbounds %"struct.NArchive::N7z::CCoderInfo", ptr %175, i64 0, i32 3
  %258 = load i32, ptr %NumOutStreams, align 4, !tbaa !60
  ...
  invoke void @_ZN17CBaseRecordVector7ReserveEi(ptr noundef nonnull align 8 dereferenceable(32) %packSizesPointers, i32 noundef %257)
          to label %invoke.cont395 unwind label %lpad394

invoke.cont395:                                   ; preds = %cleanup.cont387
  invoke void @_ZN17CBaseRecordVector7ReserveEi(ptr noundef nonnull align 8 dereferenceable(32) %unpackSizesPointers, i32 noundef %258)
          to label %for.cond398.preheader unwind label %lpad394

for.cond398.preheader:                            ; preds = %invoke.cont395
  %cmp3991254.not = icmp eq i32 %258, 0
...
for.body400.preheader:                            ; preds = %for.cond398.preheader
  %259 = add i32 %unpackStreamIndex.01271, %258
  br label %for.body400

for.cond410.preheader:                            ; preds = %for.inc406, %for.cond398.preheader
  %unpackStreamIndex.1.lcssa = phi i32 [ %unpackStreamIndex.01271, %for.cond398.preheader ], [ %259, %for.inc406 ]
  %cmp411.not1258.not = icmp eq i32 %257, 0
...
for.body412.preheader:                            ; preds = %for.cond410.preheader
  %260 = add i32 %packStreamIndex.01272, %257
...
for.body400:                                      ; preds = %for.body400.preheader, %for.inc406
  ...
  %261 = load ptr, ptr %_items.i988, align 8, !tbaa !47
...
for.inc406:                                       ; preds = %for.body400
  ...
  %arrayidx.i = getelementptr inbounds i64, ptr %261, i64 %idxprom.i
  %262 = load ptr, ptr %_items.i989, align 8, !tbaa !47
  %263 = load i32, ptr %_size.i990, align 4, !tbaa !31
  %idxprom.i991 = sext i32 %263 to i64
  %arrayidx.i992 = getelementptr inbounds ptr, ptr %262, i64 %idxprom.i991
  store ptr %arrayidx.i, ptr %arrayidx.i992, align 8, !tbaa !48
  %inc.i = add nsw i32 %263, 1
  store i32 %inc.i, ptr %_size.i990, align 4, !tbaa !31
  %inc408 = add i32 %unpackStreamIndex.11255, 1
  %exitcond1336.not = icmp eq i32 %inc408, %259
...
ehcleanup384:                                     ; preds = %_ZN10CMyComBSTRD2Ev.exit978, %lpad277
  ...
  %264 = load ptr, ptr %cryptoSetPassword, align 8, !tbaa !86
  %tobool.not.i994 = icmp eq ptr %264, null
...
if.then.i998:                                     ; preds = %ehcleanup384
  %vtable.i995 = load ptr, ptr %264, align 8, !tbaa !12
  %vfn.i996 = getelementptr inbounds ptr, ptr %vtable.i995, i64 2
  %265 = load ptr, ptr %vfn.i996, align 8
  %call.i997 = invoke noundef i32 %265(ptr noundef nonnull align 8 dereferenceable(8) %264)
...
for.body412:                                      ; preds = %for.body412.preheader, %for.inc445
  ...
  %269 = load i32, ptr %_size.i.i748, align 4, !tbaa !31
  %cmp.not8.i = icmp sgt i32 %269, 0
  br i1 %cmp.not8.i, label %for.body.lr.ph.i1005, label %if.else425

for.body.lr.ph.i1005:                             ; preds = %for.body412
  %270 = load ptr, ptr %_items.i.i1003, align 8, !tbaa !47
  %wide.trip.count.i1004 = zext i32 %269 to i64
...
for.body.i1008:                                   ; preds = %for.inc.i, %for.body.lr.ph.i1005
  ...
  %arrayidx.i.i1007 = getelementptr inbounds %"struct.NArchive::N7z::CBindPair", ptr %270, i64 %indvars.iv.i1006
  %271 = load i32, ptr %arrayidx.i.i1007, align 4, !tbaa !51
  %cmp4.i = icmp eq i32 %271, %packStreamIndex.11259
...
invoke.cont414:                                   ; preds = %for.body.i1008
  %272 = and i64 %indvars.iv.i1006, 2147483648
  %cmp416 = icmp eq i64 %272, 0
...
if.then417:                                       ; preds = %invoke.cont414
  ...
  %OutIndex = getelementptr inbounds %"struct.NArchive::N7z::CBindPair", ptr %270, i64 %idxprom.i1012, i32 1
  %273 = load i32, ptr %OutIndex, align 4, !tbaa !53
  %274 = load ptr, ptr %_items.i988, align 8, !tbaa !47
...
_ZN13CRecordVectorIPKyE3AddES1_.exit1023:         ; preds = %if.then417
  %idxprom.i1015 = sext i32 %273 to i64
  %arrayidx.i1016 = getelementptr inbounds i64, ptr %274, i64 %idxprom.i1015
  br label %for.inc445
...
if.else425:                                       ; preds = %for.inc.i, %for.body412, %invoke.cont414
  %276 = load i32, ptr %_size.i, align 4, !tbaa !31
  %cmp.not8.i1025 = icmp sgt i32 %276, 0
  br i1 %cmp.not8.i1025, label %for.body.lr.ph.i1028, label %cleanup471

for.body.lr.ph.i1028:                             ; preds = %if.else425
  %277 = load ptr, ptr %_items.i.i1026, align 8, !tbaa !47
  %wide.trip.count.i1027 = zext i32 %276 to i64
...
for.body.i1032:                                   ; preds = %for.inc.i1035, %for.body.lr.ph.i1028
  ...
  %arrayidx.i.i1030 = getelementptr inbounds i32, ptr %277, i64 %indvars.iv.i1029
  %278 = load i32, ptr %arrayidx.i.i1030, align 4, !tbaa !55
  %cmp4.i1031 = icmp eq i32 %278, %packStreamIndex.11259
...
_ZNK8NArchive3N7z7CFolder24FindPackStreamArrayIndexEj.exit: ; preds = %for.body.i1032
  %279 = and i64 %indvars.iv.i1029, 2147483648
  %cmp429 = icmp eq i64 %279, 0
...
for.inc445:                                       ; preds = %cleanup436, %_ZN13CRecordVectorIPKyE3AddES1_.exit1023
  ...
  %281 = load ptr, ptr %_items.i1038, align 8, !tbaa !47
  %282 = load i32, ptr %_size.i1039, align 4, !tbaa !31
  %idxprom.i1040 = sext i32 %282 to i64
  %arrayidx.i1041 = getelementptr inbounds ptr, ptr %281, i64 %idxprom.i1040
  store ptr %arrayidx433.sink, ptr %arrayidx.i1041, align 8, !tbaa !48
  %storemerge = add nsw i32 %282, 1
  ...
  %cmp411.not = icmp ult i32 %inc446, %257
  %exitcond1337.not = icmp eq i32 %inc446, %257
...
invoke.cont452:                                   ; preds = %for.inc445, %for.cond410.preheader
  %packStreamIndex.1.lcssa = phi i32 [ %packStreamIndex.01272, %for.cond410.preheader ], [ %260, %for.inc445 ]
  %cmp411.not.lcssa = phi i1 [ false, %for.cond410.preheader ], [ %cmp411.not, %for.inc445 ]
  %283 = load ptr, ptr %_mixerCoderCommon174, align 8, !tbaa !71
  %284 = load ptr, ptr %_items.i1038, align 8, !tbaa !47
  %285 = load ptr, ptr %_items.i989, align 8, !tbaa !47
  %vtable454 = load ptr, ptr %283, align 8, !tbaa !12
  %vfn455 = getelementptr inbounds ptr, ptr %vtable454, i64 2
  %286 = load ptr, ptr %vfn455, align 8
  %287 = trunc i64 %indvars.iv1338 to i32
  invoke void %286(ptr noundef nonnull align 8 dereferenceable(8) %283, i32 noundef %287, ptr noundef nonnull %284, ptr noundef nonnull %285)
...
ehcleanup460:                                     ; preds = %lpad401.loopexit, %lpad401.loopexit.split-lp, %lpad426, %lpad413, %lpad394
  %.pn657.pn = phi { ptr, i32 } [ %268, %lpad394 ], [ %275, %lpad413 ], [ %280, %lpad426 ], [ %lpad.loopexit1178, %lpad401.loopexit ], [ %lpad.loopexit.split-lp1179, %lpad401.loopexit.split-lp ]
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %unpackSizesPointers) #14
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %unpackSizesPointers) #14
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %packSizesPointers) #14
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %packSizesPointers) #14
...
for.end479:                                       ; preds = %for.cond179, %for.cond179.preheader
  ...
  %288 = load i32, ptr %_size.i.i1048, align 4, !tbaa !31
  %cmp15.not.i = icmp eq i32 %288, 0
...
for.body.lr.ph.i1050:                             ; preds = %for.end479
  ...
  %289 = load ptr, ptr %_items.i1047, align 8, !tbaa !47
  ...
  %291 = load ptr, ptr %_items.i.i1049, align 8, !tbaa !47
...
for.body.i1054:                                   ; preds = %for.inc.i1057, %for.body.lr.ph.i1050
  ...
  %streamIndex.addr.017.i = phi i32 [ %290, %for.body.lr.ph.i1050 ], [ %sub.i, %for.inc.i1057 ]
  %idxprom.i.i1051 = sext i32 %mainCoder.0 to i64
  %NumOutStreams.i1052 = getelementptr inbounds %"struct.NCoderMixer::CCoderStreamsInfo", ptr %291, i64 %idxprom.i.i1051, i32 1
  %292 = load i32, ptr %NumOutStreams.i1052, align 4, !tbaa !103
  %cmp4.i1053 = icmp ult i32 %streamIndex.addr.017.i, %292
  br i1 %cmp4.i1053, label %invoke.cont483, label %for.inc.i1057

for.inc.i1057:                                    ; preds = %for.body.i1054
  %sub.i = sub i32 %streamIndex.addr.017.i, %292
  %inc.i1055 = add nuw i32 %mainCoder.0, 1
  %exitcond1345.not = icmp eq i32 %inc.i1055, %288
...
invoke.cont483:                                   ; preds = %for.body.i1054
  ...
  %293 = load i8, ptr %_multiThread484, align 8, !tbaa !16, !range !66, !noundef !67
  %tobool485.not = icmp eq i8 %293, 0
...
if.then486:                                       ; preds = %invoke.cont483
  ...
  %294 = load ptr, ptr %_mixerCoderMTSpec487, align 8, !tbaa !72
  %_progressCoderIndex.i = getelementptr inbounds %"class.NCoderMixer::CCoderMixer2MT", ptr %294, i64 0, i32 5
...
if.end492:                                        ; preds = %if.end489
  ...
  %296 = load i32, ptr %_size.i1062, align 4, !tbaa !31
  invoke void @_ZN17CBaseRecordVector7ReserveEi(ptr noundef nonnull align 8 dereferenceable(32) %inStreamPointers, i32 noundef %296)
          to label %for.cond499.preheader unwind label %lpad495.loopexit.split-lp

for.cond499.preheader:                            ; preds = %if.end492
  %297 = load i32, ptr %_size.i1062, align 4, !tbaa !31
  %cmp5021276 = icmp sgt i32 %297, 0
...
for.body503:                                      ; preds = %for.body503.lr.ph, %for.inc510
  ...
  %298 = load ptr, ptr %_items.i.i1064, align 8, !tbaa !47
  %arrayidx.i.i1066 = getelementptr inbounds ptr, ptr %298, i64 %indvars.iv1346
  %299 = load ptr, ptr %arrayidx.i.i1066, align 8, !tbaa !48
...
for.inc510:                                       ; preds = %for.body503
  %301 = load ptr, ptr %_items.i1067, align 8, !tbaa !47
  %302 = load i32, ptr %_size.i1068, align 4, !tbaa !31
  %idxprom.i1069 = sext i32 %302 to i64
  %arrayidx.i1070 = getelementptr inbounds ptr, ptr %301, i64 %idxprom.i1069
  store ptr %300, ptr %arrayidx.i1070, align 8, !tbaa !48
  %inc.i1071 = add nsw i32 %302, 1
  store i32 %inc.i1071, ptr %_size.i1068, align 4, !tbaa !31
  %indvars.iv.next1347 = add nuw nsw i64 %indvars.iv1346, 1
  %303 = load i32, ptr %_size.i1062, align 4, !tbaa !31
  %304 = sext i32 %303 to i64
  %cmp502 = icmp slt i64 %indvars.iv.next1347, %304
...
invoke.cont517:                                   ; preds = %for.inc510, %for.cond499.preheader
  %.lcssa = phi i32 [ %297, %for.cond499.preheader ], [ %303, %for.inc510 ]
  ...
  %305 = load ptr, ptr %_mixerCoder513, align 8, !tbaa !14
  %_items.i.i1073 = getelementptr inbounds %class.CBaseRecordVector, ptr %inStreamPointers, i64 0, i32 3
  %306 = load ptr, ptr %_items.i.i1073, align 8, !tbaa !47
  %vtable521 = load ptr, ptr %305, align 8, !tbaa !12
  %vfn522 = getelementptr inbounds ptr, ptr %vtable521, i64 5
  %307 = load ptr, ptr %vfn522, align 8
  %call524 = invoke noundef i32 %307(ptr noundef nonnull align 8 dereferenceable(8) %305, ptr noundef nonnull %306, ptr noundef null, i32 noundef %.lcssa, ptr noundef nonnull %outStreamPointer, ptr noundef null, i32 noundef 1, ptr noundef %compressProgress)
...
ehcleanup528:                                     ; preds = %lpad495.loopexit, %lpad495.loopexit.split-lp, %lpad514
  %.pn = phi { ptr, i32 } [ %308, %lpad514 ], [ %lpad.loopexit, %lpad495.loopexit ], [ %lpad.loopexit.split-lp, %lpad495.loopexit.split-lp ]
  call void @_ZN17CBaseRecordVectorD2Ev(ptr noundef nonnull align 8 dereferenceable(32) %inStreamPointers) #14
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %inStreamPointers) #14
  br label %ehcleanup546
...
cleanup543:                                       ; preds = %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit, %_ZN9CMyComPtrI30ICompressSetDecoderProperties2ED2Ev.exit, %_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit, %_ZN9CMyComPtrI18ICryptoSetPasswordED2Ev.exit, %cleanup471, %invoke.cont72, %invoke.cont523, %if.end489
  ...
  %309 = load ptr, ptr %lockedInStream, align 8, !tbaa !29
  %tobool.not.i.i1081 = icmp eq ptr %309, null
  br i1 %tobool.not.i.i1081, label %_ZN15CLockedInStreamD2Ev.exit, label %if.then.i.i1084

if.then.i.i1084:                                  ; preds = %cleanup543
  %vtable.i.i1082 = load ptr, ptr %309, align 8, !tbaa !12
  %vfn.i.i1083 = getelementptr inbounds ptr, ptr %vtable.i.i1082, i64 2
  %310 = load ptr, ptr %vfn.i.i1083, align 8
  %call.i2.i = invoke noundef i32 %310(ptr noundef nonnull align 8 dereferenceable(8) %309)
...
ehcleanup546:                                     ; preds = %lpad53.loopexit, %lpad53.loopexit.split-lp, %lpad43.loopexit, %lpad43.loopexit.split-lp.loopexit.split-lp.loopexit, %lpad43.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp, %lpad43.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit, %lpad43.loopexit.split-lp.loopexit, %lpad480, %ehcleanup528, %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit886, %lpad71, %_ZN9CMyComPtrI30ICompressSetDecoderProperties2ED2Ev.exit919, %_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit934, %_ZN9CMyComPtrI18ICryptoSetPasswordED2Ev.exit1001, %ehcleanup460, %lpad177
  %.pn657.pn.pn.pn.pn.pn.pn.pn = phi { ptr, i32 } [ %123, %lpad71 ], [ %.pn672, %_ZN9CMyComPtrI14ICompressCoderED2Ev.exit886 ], [ %182, %lpad177 ], [ %.pn657.pn, %ehcleanup460 ], [ %.pn661.pn.pn.pn, %_ZN9CMyComPtrI18ICryptoSetPasswordED2Ev.exit1001 ], [ %.pn666, %_ZN9CMyComPtrI19ICompressSetCoderMtED2Ev.exit934 ], [ %.pn654, %_ZN9CMyComPtrI30ICompressSetDecoderProperties2ED2Ev.exit919 ], [ %.pn, %ehcleanup528 ], [ %295, %lpad480 ], [ %lpad.loopexit1187, %lpad43.loopexit ], [ %lpad.loopexit1190, %lpad43.loopexit.split-lp.loopexit ], [ %lpad.loopexit1193, %lpad43.loopexit.split-lp.loopexit.split-lp.loopexit ], [ %lpad.loopexit1196, %lpad43.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit ], [ %lpad.loopexit.split-lp1197, %lpad43.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp ], [ %lpad.loopexit1181, %lpad53.loopexit ], [ %lpad.loopexit.split-lp1182, %lpad53.loopexit.split-lp ]
