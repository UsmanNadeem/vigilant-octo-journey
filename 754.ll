; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/idict.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/idict.c"
...
entry:
  ...
  %size.op = add i32 %size, 1
  %add = select i1 %cmp, i32 2, i32 %size.op
...
while.body.preheader:                             ; preds = %if.end5
  ...
  %umax = tail call i32 @llvm.umax.i32(i32 %size, i32 1)
...
entry:
  ...
  %cmp.i = icmp eq i32 %new_size, 0
  %size.op.i = add i32 %new_size, 1
  %add.i = select i1 %cmp.i, i32 2, i32 %size.op.i
...
while.body.i.preheader:                           ; preds = %if.end5.i
  %umax = tail call i32 @llvm.umax.i32(i32 %new_size, i32 1)
