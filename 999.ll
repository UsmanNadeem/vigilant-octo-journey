; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/main.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/main.c"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 23, ptr nonnull %defaultFile) #13
  ...
  %call = tail call ptr (...) @Configuration_new() #13
  call void @llvm.lifetime.start.p0(i64 200, ptr nonnull %commandLine) #13
...
while.cond.preheader:                             ; preds = %if.end
  %call4150 = tail call i32 @getopt(i32 noundef %argc, ptr noundef %argv, ptr noundef nonnull @.str.2) #13
...
for.body.us:                                      ; preds = %sw.bb49.us, %for.body.us
  ...
  %call55.us = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %commandLine, ptr noundef nonnull dereferenceable(1) @.str.9, ptr noundef nonnull %commandLine, ptr noundef %0) #13
...
sw.bb43.us:                                       ; preds = %while.body.us
  ...
  %call.i121.us = call i64 @strtol(ptr nocapture noundef nonnull %1, ptr noundef null, i32 noundef 10) #13
...
sw.epilog.us:                                     ; preds = %sw.bb36.us, %sw.bb37.us, %sw.bb38.us, %sw.bb39.us, %sw.bb41.us, %sw.bb43.us, %for.cond.for.end_crit_edge.us, %while.body.us
  ...
  %call4.us = call i32 @getopt(i32 noundef %argc, ptr noundef %argv, ptr noundef nonnull @.str.2) #13
...
for.cond.for.end_crit_edge.us:                    ; preds = %for.body.us
  call void @YAMLWriteString(ptr noundef nonnull @.str.10, ptr noundef nonnull %add.ptr) #13
  br label %sw.epilog.us

if.then3:                                         ; preds = %if.end
  %call.i = call ptr @parseFile(ptr noundef nonnull %defaultFile) #13
...
if.then2.i:                                       ; preds = %if.end.i
  ...
  %call4.i = call i32 @findAllPossibleLegs(ptr noundef nonnull %call.i, i32 noundef %10) #13
  br label %if.end7.i

if.else.i:                                        ; preds = %if.end.i
  %call6.i = call i32 @findAndLogAllPossibleLegs(ptr noundef nonnull %call.i, ptr noundef nonnull %8) #13
  br label %if.end7.i
...
if.end7.i:                                        ; preds = %if.else.i, %if.then2.i
  ...
  call void @Graph_delete(ptr noundef nonnull %call.i) #13
  br label %if.end83

sw.bb:                                            ; preds = %while.body.us
  %11 = load i32, ptr @optopt, align 4, !tbaa !23
...
if.then11:                                        ; preds = %sw.bb
  ...
  %13 = call i64 @fwrite(ptr nonnull @.str.3, i64 37, i64 1, ptr %12) #15
  br label %cleanup

if.then18:                                        ; preds = %sw.bb, %sw.bb
  %14 = load ptr, ptr @stderr, align 8, !tbaa !8
  %15 = call i64 @fwrite(ptr nonnull @.str.4, i64 28, i64 1, ptr %14) #15
  br label %cleanup

if.then23:                                        ; preds = %sw.bb
  %16 = load ptr, ptr @stderr, align 8, !tbaa !8
  %17 = call i64 @fwrite(ptr nonnull @.str.5, i64 41, i64 1, ptr %16) #15
  br label %cleanup

if.then28:                                        ; preds = %sw.bb
  %18 = load ptr, ptr @stderr, align 8, !tbaa !8
  %19 = call i64 @fwrite(ptr nonnull @.str.6, i64 57, i64 1, ptr %18) #15
  br label %cleanup
...
if.then60:                                        ; preds = %while.end
  ...
  %21 = call i64 @fwrite(ptr nonnull @.str.11, i64 75, i64 1, ptr %20) #15
  br label %cleanup
...
if.then67:                                        ; preds = %if.end62
  ...
  %23 = call i64 @fwrite(ptr nonnull @.str.12, i64 73, i64 1, ptr %22) #15
  br label %cleanup

if.end69:                                         ; preds = %if.end62
  %tobool70 = icmp eq i32 %oFlag.0.lcssa, 0
  %tobool71 = icmp ne i32 %xFlag.0.lcssa, 0
  %or.cond97 = select i1 %tobool70, i1 true, i1 %tobool71
  br i1 %or.cond97, label %if.end74, label %if.then72

if.then72:                                        ; preds = %if.end69
  %24 = load ptr, ptr @stderr, align 8, !tbaa !8
  %25 = call i64 @fwrite(ptr nonnull @.str.13, i64 79, i64 1, ptr %24) #15
  br label %cleanup
...
if.else80:                                        ; preds = %if.else77
  %call.i122 = call ptr @parseFile(ptr noundef %fileName.0.lcssa) #13
...
if.then2.i131:                                    ; preds = %if.end.i129
  ...
  %call4.i130 = call i32 @findAllPossibleLegs(ptr noundef nonnull %call.i122, i32 noundef %28) #13
  br label %if.end7.i136

if.else.i133:                                     ; preds = %if.end.i129
  %call6.i132 = call i32 @findAndLogAllPossibleLegs(ptr noundef nonnull %call.i122, ptr noundef nonnull %26) #13
  br label %if.end7.i136
...
if.end7.i136:                                     ; preds = %if.else.i133, %if.then2.i131
  ...
  call void @Graph_delete(ptr noundef nonnull %call.i122) #13
  br label %if.end83

if.end83:                                         ; preds = %if.end7.i136, %if.else80, %if.end7.i, %if.then3, %if.then76, %if.then79
  call void (...) @YAMLClose() #13
  br label %cleanup
...
cleanup:                                          ; preds = %sw.bb, %if.then11, %if.then23, %if.then28, %if.then18, %if.end83, %if.then72, %if.then67, %if.then60, %sw.bb34
  ...
  call void @llvm.lifetime.end.p0(i64 200, ptr nonnull %commandLine) #13
  call void @llvm.lifetime.end.p0(i64 23, ptr nonnull %defaultFile) #13
  ret i32 %retval.0
}
...
entry:
  %call = tail call ptr @parseFile(ptr noundef %fileName) #13
...
if.then2:                                         ; preds = %if.end
  ...
  %call4 = tail call i32 @findAllPossibleLegs(ptr noundef nonnull %call, i32 noundef %2) #13
  br label %if.end7

if.else:                                          ; preds = %if.end
  %call6 = tail call i32 @findAndLogAllPossibleLegs(ptr noundef nonnull %call, ptr noundef nonnull %0) #13
  br label %if.end7
...
if.end7:                                          ; preds = %if.else, %if.then2
  ...
  tail call void @Graph_delete(ptr noundef nonnull %call) #13
  br label %cleanup
...
if.end:                                           ; preds = %entry
  %call1 = tail call double (...) @currentTime() #13
  %call2 = tail call zeroext i1 @parseConfigFile(ptr noundef nonnull %configFile, ptr noundef %config) #13
  %call3 = tail call double (...) @currentTime() #13
  %sub = fsub double %call3, %call1
  %conv = fptosi double %sub to i32
  %div = sdiv i32 %conv, 3600
  %call4 = tail call double @fmod(double noundef %sub, double noundef 3.600000e+03) #13
  %conv5 = fptosi double %call4 to i32
  %div6 = sdiv i32 %conv5, 60
  %call7 = tail call double @fmod(double noundef %call4, double noundef 6.000000e+01) #13
...
if.then10:                                        ; preds = %if.end
  tail call void @doMultiSearches(ptr noundef %config) #13
  br label %if.end11
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 200, ptr nonnull %stringBuffer) #13
  call void @llvm.lifetime.start.p0(i64 200, ptr nonnull %labels) #13
  %call = tail call ptr @parseFile(ptr noundef %fileName) #13
  %tobool.not = icmp eq ptr %call, null
...
if.then:                                          ; preds = %entry
  call void @llvm.lifetime.end.p0(i64 200, ptr nonnull %labels) #13
  call void @llvm.lifetime.end.p0(i64 200, ptr nonnull %stringBuffer) #13
  ret void
...
if.end.i:                                         ; preds = %do.body
  %call3.i = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %stringBuffer) #16
...
mygets.exit:                                      ; preds = %if.end.i, %land.lhs.true.i, %if.then9.i
  ...
  %cmp138 = icmp eq i32 %bcmp, 0
  br i1 %cmp138, label %if.then140, label %if.end289

if.then140:                                       ; preds = %mygets.exit
  call void @exit(i32 noundef 1) #14
  unreachable

if.end289:                                        ; preds = %mygets.exit
  %2 = load i8, ptr %stringBuffer, align 16, !tbaa !5
  %cmp303.not = icmp eq i8 %2, 0
  br i1 %cmp303.not, label %do.end, label %do.cond

do.cond:                                          ; preds = %if.end289
  %call335 = call noalias ptr @__strdup(ptr noundef nonnull %stringBuffer) #13
  %idxprom = zext i32 %i.0 to i64
  %arrayidx338 = getelementptr inbounds [25 x ptr], ptr %labels, i64 0, i64 %idxprom
  store ptr %call335, ptr %arrayidx338, align 8, !tbaa !8
  %inc = add nuw nsw i32 %i.0, 1
  %.pre = load i8, ptr %stringBuffer, align 16
  %cmp340 = icmp ugt i32 %i.0, 23
  %cmp504.not = icmp eq i8 %.pre, 0
  %or.cond = select i1 %cmp340, i1 true, i1 %cmp504.not
  br i1 %or.cond, label %do.end, label %do.body.backedge

do.body.backedge:                                 ; preds = %do.cond, %if.end531
  %i.0.be = phi i32 [ %inc, %do.cond ], [ 0, %if.end531 ]
  br label %do.body, !llvm.loop !24

do.end:                                           ; preds = %if.end289, %do.cond
  %i.1587 = phi i32 [ %inc, %do.cond ], [ %i.0, %if.end289 ]
  %idxprom507 = sext i32 %i.1587 to i64
  %arrayidx508 = getelementptr inbounds [25 x ptr], ptr %labels, i64 0, i64 %idxprom507
  store ptr null, ptr %arrayidx508, align 8, !tbaa !8
  %call509 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.21)
  %cmp510580 = icmp sgt i32 %i.1587, 0
  br i1 %cmp510580, label %for.body.lr.ph, label %for.end

for.body.lr.ph:                                   ; preds = %do.end
  %sub515 = add nsw i32 %i.1587, -1
  %3 = zext i32 %sub515 to i64
  %wide.trip.count = zext i32 %i.1587 to i64
  br label %for.body

for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %indvars.iv = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next, %for.inc ]
  %arrayidx513 = getelementptr inbounds [25 x ptr], ptr %labels, i64 0, i64 %indvars.iv
  %4 = load ptr, ptr %arrayidx513, align 8, !tbaa !8
  %call514 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, ptr noundef %4)
  %cmp516 = icmp ult i64 %indvars.iv, %3
  br i1 %cmp516, label %if.then518, label %if.else

if.then518:                                       ; preds = %for.body
  %call519 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.23)
  br label %for.inc

if.else:                                          ; preds = %for.body
  %puts579 = call i32 @puts(ptr nonnull dereferenceable(1) @str.32)
  br label %for.inc

for.inc:                                          ; preds = %if.then518, %if.else
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !25

for.end:                                          ; preds = %for.inc, %do.end
  %call523 = call ptr @NodePtrVec_new(i32 noundef 50) #13
  %5 = load ptr, ptr %searchOptions, align 8, !tbaa !15
  %6 = load i32, ptr %5, align 8, !tbaa !22
  %call525 = call zeroext i1 @findLabelPath(ptr noundef nonnull %call, ptr noundef nonnull %labels, ptr noundef %call523, i32 noundef %6) #13
  br i1 %call525, label %if.then527, label %if.else529

if.then527:                                       ; preds = %for.end
  %7 = load i32, ptr %call523, align 8, !tbaa !26
  %call528 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.25, i32 noundef %7)
  br label %if.end531

if.else529:                                       ; preds = %for.end
  %puts578 = call i32 @puts(ptr nonnull dereferenceable(1) @str.31)
  br label %if.end531

if.end531:                                        ; preds = %if.else529, %if.then527
  call void @NodePtrVec_delete(ptr noundef %call523) #13
...
declare noalias ptr @__strdup(ptr nocapture noundef readonly) local_unnamed_addr #9
