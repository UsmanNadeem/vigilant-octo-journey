; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/ldecod/sei.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/ldecod/sei.c"
...
sw.bb37:                                          ; preds = %while.end19
  ...
  %call1.i = tail call i32 @ue_v(ptr noundef nonnull @.str.34, ptr noundef %call.i) #12
  %call2.i = tail call i32 @u_1(ptr noundef nonnull @.str.35, ptr noundef %call.i) #12
  %call3.i = tail call i32 @u_1(ptr noundef nonnull @.str.36, ptr noundef %call.i) #12
  %call4.i = tail call i32 @u_v(i32 noundef 2, ptr noundef nonnull @.str.37, ptr noundef %call.i) #12
...
sw.bb46:                                          ; preds = %while.end19
  ...
  %call.i200 = tail call noalias dereferenceable_or_null(32) ptr @malloc(i64 noundef 32) #11
  ...
  store i32 0, ptr @UsedBits, align 4, !tbaa !17
  %call1.i204 = tail call i32 @ue_v(ptr noundef nonnull @.str.24, ptr noundef %call.i200) #12
  %call2.i205 = tail call i32 @ue_v(ptr noundef nonnull @.str.25, ptr noundef %call.i200) #12
  %cmp.i = icmp sgt i32 %call2.i205, 3
  br i1 %cmp.i, label %if.then.i, label %interpret_scene_information.exit

if.then.i:                                        ; preds = %sw.bb46
  %call3.i206 = tail call i32 @ue_v(ptr noundef nonnull @.str.25, ptr noundef nonnull %call.i200) #12
  br label %interpret_scene_information.exit

interpret_scene_information.exit:                 ; preds = %sw.bb46, %if.then.i
  tail call void @free(ptr noundef nonnull %call.i200) #12
  br label %sw.epilog
...
sw.bb52:                                          ; preds = %while.end19
  ...
  %call.i207 = tail call noalias dereferenceable_or_null(32) ptr @malloc(i64 noundef 32) #11
  ...
  store i32 0, ptr @UsedBits, align 4, !tbaa !17
  %call1.i211 = tail call i32 @ue_v(ptr noundef nonnull @.str.14, ptr noundef %call.i207) #12
...
for.body.i:                                       ; preds = %sw.bb52, %for.body.i
  ...
  %call4.i212 = tail call i32 @u_1(ptr noundef nonnull @.str.15, ptr noundef %call.i207) #12
  %call6.i = tail call i32 @u_v(i32 noundef 16, ptr noundef nonnull @.str.16, ptr noundef %call.i207) #12
  %call8.i = tail call i32 @u_v(i32 noundef 16, ptr noundef nonnull @.str.17, ptr noundef %call.i207) #12
...
interpret_subsequence_layer_characteristics_info.exit: ; preds = %for.body.i, %sw.bb52
  tail call void @free(ptr noundef %call.i207) #12
  br label %sw.epilog
...
sw.bb64:                                          ; preds = %while.end19
  ...
  %call.i213 = tail call noalias dereferenceable_or_null(32) ptr @malloc(i64 noundef 32) #11
  ...
  store i32 0, ptr @UsedBits, align 4, !tbaa !17
  %call1.i217 = tail call i32 @ue_v(ptr noundef nonnull @.str.40, ptr noundef %call.i213) #12
  tail call void @free(ptr noundef %call.i213) #12
  br label %sw.epilog
...
sw.bb67:                                          ; preds = %while.end19
  ...
  %call.i218 = tail call noalias dereferenceable_or_null(32) ptr @malloc(i64 noundef 32) #11
  ...
  store i32 0, ptr @UsedBits, align 4, !tbaa !17
  %call1.i222 = tail call i32 @ue_v(ptr noundef nonnull @.str.41, ptr noundef %call.i218) #12
  tail call void @free(ptr noundef %call.i218) #12
  br label %sw.epilog
...
sw.bb70:                                          ; preds = %while.end19
  ...
  %call.i223 = tail call noalias dereferenceable_or_null(32) ptr @malloc(i64 noundef 32) #11
  ...
  store i32 0, ptr @UsedBits, align 4, !tbaa !17
  %call1.i227 = tail call i32 @ue_v(ptr noundef nonnull @.str.41, ptr noundef %call.i223) #12
  tail call void @free(ptr noundef %call.i223) #12
  br label %sw.epilog
...
sw.bb79:                                          ; preds = %while.end19
  ...
  %call.i228 = tail call noalias dereferenceable_or_null(32) ptr @malloc(i64 noundef 32) #11
  ...
  %call1.i232 = tail call i32 @u_1(ptr noundef nonnull @.str.64, ptr noundef %call.i228) #12
...
if.then.i236:                                     ; preds = %sw.bb79
  %call2.i233 = tail call i32 @u_1(ptr noundef nonnull @.str.65, ptr noundef nonnull %call.i228) #12
  %call3.i234 = tail call i32 @u_1(ptr noundef nonnull @.str.66, ptr noundef nonnull %call.i228) #12
  %call4.i235 = tail call i32 @ue_v(ptr noundef nonnull @.str.67, ptr noundef nonnull %call.i228) #12
...
interpret_deblocking_filter_display_preference_info.exit: ; preds = %sw.bb79, %if.then.i236
  tail call void @free(ptr noundef nonnull %call.i228) #12
  br label %sw.epilog
...
entry:
  ...
  store i32 0, ptr @UsedBits, align 4, !tbaa !17
  %call1 = tail call i32 @ue_v(ptr noundef nonnull @.str.74, ptr noundef %call) #12
  ...
  tail call void @activate_sps(ptr noundef nonnull %arrayidx) #12
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %add7 = add i32 %3, 1
  %call8 = tail call i32 @u_v(i32 noundef %add7, ptr noundef nonnull @.str.75, ptr noundef %call) #12
  %4 = load i32, ptr %initial_cpb_removal_delay_length_minus1, align 8, !tbaa !32
  %add12 = add i32 %4, 1
  %call13 = tail call i32 @u_v(i32 noundef %add12, ptr noundef nonnull @.str.76, ptr noundef %call) #12
...
for.body22:                                       ; preds = %for.body22.lr.ph, %for.body22
  ...
  %add26 = add i32 %8, 1
  %call27 = tail call i32 @u_v(i32 noundef %add26, ptr noundef nonnull @.str.75, ptr noundef %call) #12
  %9 = load i32, ptr %initial_cpb_removal_delay_length_minus125, align 8, !tbaa !36
  %add31 = add i32 %9, 1
  %call32 = tail call i32 @u_v(i32 noundef %add31, ptr noundef nonnull @.str.76, ptr noundef %call) #12
...
if.then:                                          ; preds = %entry
  ...
  %2 = tail call i64 @fwrite(ptr nonnull @.str.77, i64 52, i64 1, ptr %1) #13
  br label %cleanup

if.end:                                           ; preds = %entry
  %call1 = tail call noalias dereferenceable_or_null(32) ptr @malloc(i64 noundef 32) #11
...
if.end42:                                         ; preds = %if.end31, %lor.lhs.false
  ...
  %call39 = tail call i32 @u_v(i32 noundef %cpb_removal_len.0164, ptr noundef nonnull @.str.78, ptr noundef nonnull %call1) #12
  %call40 = tail call i32 @u_v(i32 noundef %dpb_output_len.0166, ptr noundef nonnull @.str.79, ptr noundef nonnull %call1) #12
...
if.then50:                                        ; preds = %if.else46
  %call51 = tail call i32 @u_v(i32 noundef 4, ptr noundef nonnull @.str.80, ptr noundef nonnull %call1) #12
  %10 = icmp ult i32 %call51, 9
  br i1 %10, label %switch.lookup, label %sw.epilog

sw.epilog:                                        ; preds = %if.then50
  tail call void @error(ptr noundef nonnull @.str.81, i32 noundef 500) #12
  br label %if.end111
...
for.body:                                         ; preds = %switch.lookup, %for.inc
  ...
  %call55 = tail call i32 @u_1(ptr noundef nonnull @.str.82, ptr noundef %call1) #12
  %tobool56.not = icmp eq i32 %call55, 0
  br i1 %tobool56.not, label %for.inc, label %if.then57

if.then57:                                        ; preds = %for.body
  %call58 = tail call i32 @u_v(i32 noundef 2, ptr noundef nonnull @.str.83, ptr noundef %call1) #12
  %call59 = tail call i32 @u_1(ptr noundef nonnull @.str.84, ptr noundef %call1) #12
  %call60 = tail call i32 @u_v(i32 noundef 5, ptr noundef nonnull @.str.85, ptr noundef %call1) #12
  %call61 = tail call i32 @u_1(ptr noundef nonnull @.str.86, ptr noundef %call1) #12
  %call62 = tail call i32 @u_1(ptr noundef nonnull @.str.87, ptr noundef %call1) #12
  %call63 = tail call i32 @u_1(ptr noundef nonnull @.str.88, ptr noundef %call1) #12
  %call64 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.89, ptr noundef %call1) #12
  %tobool65.not = icmp eq i32 %call61, 0
  br i1 %tobool65.not, label %if.else70, label %if.then66

if.then66:                                        ; preds = %if.then57
  %call67 = tail call i32 @u_v(i32 noundef 6, ptr noundef nonnull @.str.90, ptr noundef %call1) #12
  %call68 = tail call i32 @u_v(i32 noundef 6, ptr noundef nonnull @.str.91, ptr noundef %call1) #12
  br label %if.end86.sink.split

if.else70:                                        ; preds = %if.then57
  %call71 = tail call i32 @u_1(ptr noundef nonnull @.str.93, ptr noundef %call1) #12
  %tobool72.not = icmp eq i32 %call71, 0
  br i1 %tobool72.not, label %if.end86, label %if.then73

if.then73:                                        ; preds = %if.else70
  %call74 = tail call i32 @u_v(i32 noundef 6, ptr noundef nonnull @.str.90, ptr noundef %call1) #12
  %call75 = tail call i32 @u_1(ptr noundef nonnull @.str.94, ptr noundef %call1) #12
  %tobool76.not = icmp eq i32 %call75, 0
  br i1 %tobool76.not, label %if.end86, label %if.then77

if.then77:                                        ; preds = %if.then73
  %call78 = tail call i32 @u_v(i32 noundef 6, ptr noundef nonnull @.str.91, ptr noundef %call1) #12
  %call79 = tail call i32 @u_1(ptr noundef nonnull @.str.95, ptr noundef %call1) #12
  %tobool80.not = icmp eq i32 %call79, 0
  br i1 %tobool80.not, label %if.end86, label %if.end86.sink.split

if.end86.sink.split:                              ; preds = %if.then77, %if.then66
  %call82 = tail call i32 @u_v(i32 noundef 5, ptr noundef nonnull @.str.92, ptr noundef %call1) #12
  br label %if.end86
...
if.then106:                                       ; preds = %if.else94, %if.end104
  ...
  %call107 = tail call i32 @u_v(i32 noundef %time_offset_length.0170, ptr noundef nonnull @.str.96, ptr noundef %call1) #12
  br label %for.inc
...
entry:
  ...
  store i32 0, ptr %frame_bitoffset, align 8, !tbaa !16
  store i32 0, ptr @UsedBits, align 4, !tbaa !17
  %call1 = tail call i32 @ue_v(ptr noundef nonnull @.str.26, ptr noundef %call) #12
  %call2 = tail call i32 @u_1(ptr noundef nonnull @.str.27, ptr noundef %call) #12
  %tobool.not = icmp eq i32 %call2, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %call3 = tail call i32 @ue_v(ptr noundef nonnull @.str.28, ptr noundef nonnull %call) #12
  %cmp.not21 = icmp slt i32 %call3, 0
  br i1 %cmp.not21, label %for.end, label %for.body

for.body:                                         ; preds = %if.then, %for.body
  %i.022 = phi i32 [ %inc, %for.body ], [ 0, %if.then ]
  %call4 = tail call i32 @se_v(ptr noundef nonnull @.str.29, ptr noundef %call) #12
  %call5 = tail call i32 @se_v(ptr noundef nonnull @.str.30, ptr noundef %call) #12
  %call6 = tail call i32 @se_v(ptr noundef nonnull @.str.31, ptr noundef %call) #12
  %call7 = tail call i32 @se_v(ptr noundef nonnull @.str.32, ptr noundef %call) #12
  %inc = add nuw i32 %i.022, 1
  %exitcond.not = icmp eq i32 %i.022, %call3
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !41

for.end:                                          ; preds = %for.body, %if.then
  %call8 = tail call i32 @ue_v(ptr noundef nonnull @.str.33, ptr noundef %call) #12
  br label %if.end
...
define dso_local void @interpret_user_data_unregistered_info(ptr nocapture noundef %payload, i32 noundef %size, ptr nocapture noundef %img) local_unnamed_addr #3 {
entry:
  ret void
}
...
entry:
  ...
  store i32 0, ptr %frame_bitoffset, align 8, !tbaa !16
  store i32 0, ptr @UsedBits, align 4, !tbaa !17
  %call1 = tail call i32 @ue_v(ptr noundef nonnull @.str.34, ptr noundef %call) #12
  %call2 = tail call i32 @u_1(ptr noundef nonnull @.str.35, ptr noundef %call) #12
  %call3 = tail call i32 @u_1(ptr noundef nonnull @.str.36, ptr noundef %call) #12
  %call4 = tail call i32 @u_v(i32 noundef 2, ptr noundef nonnull @.str.37, ptr noundef %call) #12
...
entry:
  ...
  store i32 0, ptr %frame_bitoffset, align 8, !tbaa !16
  store i32 0, ptr @UsedBits, align 4, !tbaa !17
  %call1 = tail call i32 @u_1(ptr noundef nonnull @.str.38, ptr noundef %call) #12
  %call2 = tail call i32 @ue_v(ptr noundef nonnull @.str.39, ptr noundef %call) #12
  ...
  tail call void @dec_ref_pic_marking(ptr noundef %call) #12
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %map) #12
  store i32 0, ptr @UsedBits, align 4, !tbaa !17
  %call = tail call noalias dereferenceable_or_null(32) ptr @malloc(i64 noundef 32) #11
  %bitstream_length = getelementptr inbounds %struct.Bitstream, ptr %call, i64 0, i32 3
  store i32 %size, ptr %bitstream_length, align 4, !tbaa !11
  ...
  %frame_bitoffset = getelementptr inbounds %struct.Bitstream, ptr %call, i64 0, i32 2
  store i32 0, ptr %frame_bitoffset, align 8, !tbaa !16
  %call1 = tail call i32 @ue_v(ptr noundef nonnull @.str, ptr noundef %call) #12
  %call2 = tail call i32 @ue_v(ptr noundef nonnull @.str.1, ptr noundef %call) #12
  %add = add i32 %call2, 1
  ...
  %div3 = sdiv i32 %1, 16
  %call4 = call i32 @get_mem3D(ptr noundef nonnull %map, i32 noundef %add, i32 noundef %div, i32 noundef %div3) #12
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc221
  ...
  %call9 = call i32 @ue_v(ptr noundef nonnull @.str.2, ptr noundef %call) #12
  %call15 = call i32 @ue_v(ptr noundef nonnull @.str.3, ptr noundef %call) #12
...
for.body43:                                       ; preds = %for.cond39.preheader, %for.body43
  ...
  %call44 = call i32 @u_1(ptr noundef nonnull @.str.4, ptr noundef %call) #12
...
if.then80:                                        ; preds = %for.body77
  %call81 = call i32 @ue_v(ptr noundef nonnull @.str.5, ptr noundef %call) #12
  br label %if.end82
...
for.end223:                                       ; preds = %for.inc221, %entry
  ...
  call void @free_mem3D(ptr noundef %36, i32 noundef %add) #12
  call void @free(ptr noundef %call) #12
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %map) #12
  ret void
}
...
entry:
  ...
  store i32 0, ptr %frame_bitoffset, align 8, !tbaa !16
  store i32 0, ptr @UsedBits, align 4, !tbaa !17
  %call1 = tail call i32 @ue_v(ptr noundef nonnull @.str.24, ptr noundef %call) #12
  %call2 = tail call i32 @ue_v(ptr noundef nonnull @.str.25, ptr noundef %call) #12
  %cmp = icmp sgt i32 %call2, 3
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %call3 = tail call i32 @ue_v(ptr noundef nonnull @.str.25, ptr noundef nonnull %call) #12
  br label %if.end
...
entry:
  ...
  store i32 0, ptr %frame_bitoffset, align 8, !tbaa !16
  store i32 0, ptr @UsedBits, align 4, !tbaa !17
  %call1 = tail call i32 @ue_v(ptr noundef nonnull @.str.7, ptr noundef %call) #12
  %call2 = tail call i32 @ue_v(ptr noundef nonnull @.str.8, ptr noundef %call) #12
  %call3 = tail call i32 @u_1(ptr noundef nonnull @.str.9, ptr noundef %call) #12
  %call4 = tail call i32 @u_1(ptr noundef nonnull @.str.10, ptr noundef %call) #12
  %call5 = tail call i32 @u_1(ptr noundef nonnull @.str.11, ptr noundef %call) #12
  %call6 = tail call i32 @u_1(ptr noundef nonnull @.str.12, ptr noundef %call) #12
  %tobool.not = icmp eq i32 %call6, 0
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %call7 = tail call i32 @ue_v(ptr noundef nonnull @.str.13, ptr noundef nonnull %call) #12
  br label %if.end
...
entry:
  ...
  store i32 0, ptr %frame_bitoffset, align 8, !tbaa !16
  store i32 0, ptr @UsedBits, align 4, !tbaa !17
  %call1 = tail call i32 @ue_v(ptr noundef nonnull @.str.14, ptr noundef %call) #12
  %cmp.not18 = icmp slt i32 %call1, 0
  br i1 %cmp.not18, label %for.end, label %for.body

for.body:                                         ; preds = %entry, %for.body
  %i.019 = phi i32 [ %inc, %for.body ], [ 0, %entry ]
  %call4 = tail call i32 @u_1(ptr noundef nonnull @.str.15, ptr noundef %call) #12
  %call6 = tail call i32 @u_v(i32 noundef 16, ptr noundef nonnull @.str.16, ptr noundef %call) #12
  %call8 = tail call i32 @u_v(i32 noundef 16, ptr noundef nonnull @.str.17, ptr noundef %call) #12
...
entry:
  ...
  %call1 = tail call i32 @ue_v(ptr noundef nonnull @.str.7, ptr noundef %call) #12
  %call2 = tail call i32 @ue_v(ptr noundef nonnull @.str.8, ptr noundef %call) #12
  %call3 = tail call i32 @u_1(ptr noundef nonnull @.str.18, ptr noundef %call) #12
  %tobool.not = icmp eq i32 %call3, 0
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %entry
  %call4 = tail call i32 @u_v(i32 noundef 32, ptr noundef nonnull @.str.18, ptr noundef nonnull %call) #12
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %call5 = tail call i32 @u_1(ptr noundef nonnull @.str.19, ptr noundef nonnull %call) #12
  %tobool6.not = icmp eq i32 %call5, 0
  br i1 %tobool6.not, label %if.end13, label %if.then7

if.then7:                                         ; preds = %if.end
  %call8 = tail call i32 @u_1(ptr noundef nonnull @.str.15, ptr noundef nonnull %call) #12
  %call9 = tail call i32 @u_v(i32 noundef 16, ptr noundef nonnull @.str.16, ptr noundef nonnull %call) #12
  %call11 = tail call i32 @u_v(i32 noundef 16, ptr noundef nonnull @.str.17, ptr noundef nonnull %call) #12
  br label %if.end13

if.end13:                                         ; preds = %if.then7, %if.end
  %call14 = tail call i32 @ue_v(ptr noundef nonnull @.str.20, ptr noundef nonnull %call) #12
  %cmp35 = icmp sgt i32 %call14, 0
  br i1 %cmp35, label %for.body, label %for.end

for.body:                                         ; preds = %if.end13, %for.body
  %i.036 = phi i32 [ %inc, %for.body ], [ 0, %if.end13 ]
  %call16 = tail call i32 @ue_v(ptr noundef nonnull @.str.21, ptr noundef %call) #12
  %call17 = tail call i32 @ue_v(ptr noundef nonnull @.str.22, ptr noundef %call) #12
  %call18 = tail call i32 @u_1(ptr noundef nonnull @.str.23, ptr noundef %call) #12
...
define dso_local void @interpret_full_frame_freeze_info(ptr nocapture noundef %payload, i32 noundef %size, ptr nocapture noundef %img) local_unnamed_addr #4 {
entry:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local void @interpret_full_frame_freeze_release_info(ptr nocapture noundef %payload, i32 noundef %size, ptr nocapture noundef %img) local_unnamed_addr #4 {
entry:
  ret void
}
...
entry:
  ...
  store i32 0, ptr %frame_bitoffset, align 8, !tbaa !16
  store i32 0, ptr @UsedBits, align 4, !tbaa !17
  %call1 = tail call i32 @ue_v(ptr noundef nonnull @.str.40, ptr noundef %call) #12
  tail call void @free(ptr noundef %call) #12
  ret void
}
...
entry:
  ...
  store i32 0, ptr %frame_bitoffset, align 8, !tbaa !16
  store i32 0, ptr @UsedBits, align 4, !tbaa !17
  %call1 = tail call i32 @ue_v(ptr noundef nonnull @.str.41, ptr noundef %call) #12
  tail call void @free(ptr noundef %call) #12
  ret void
}
...
entry:
  ...
  store i32 0, ptr %frame_bitoffset, align 8, !tbaa !16
  store i32 0, ptr @UsedBits, align 4, !tbaa !17
  %call1 = tail call i32 @ue_v(ptr noundef nonnull @.str.43, ptr noundef %call) #12
  %add = add i32 %call1, 1
  %call2 = tail call i32 @CeilLog2(i32 noundef %add) #12
  %cmp.not17 = icmp slt i32 %call1, 0
  br i1 %cmp.not17, label %for.end, label %for.body

for.body:                                         ; preds = %entry, %for.body
  %i.018 = phi i32 [ %inc, %for.body ], [ 0, %entry ]
  %call3 = tail call i32 @u_v(i32 noundef %call2, ptr noundef nonnull @.str.44, ptr noundef %call) #12
  %inc = add nuw i32 %i.018, 1
  %exitcond.not = icmp eq i32 %i.018, %call1
  br i1 %exitcond.not, label %for.end, label %for.body, !llvm.loop !58

for.end:                                          ; preds = %for.body, %entry
  %call4 = tail call i32 @u_1(ptr noundef nonnull @.str.35, ptr noundef %call) #12
  %call5 = tail call i32 @u_1(ptr noundef nonnull @.str.45, ptr noundef %call) #12
  %tobool.not = icmp eq i32 %call5, 0
  br i1 %tobool.not, label %if.end, label %if.then

if.then:                                          ; preds = %for.end
  %call6 = tail call i32 @ue_v(ptr noundef nonnull @.str.26, ptr noundef %call) #12
  br label %if.end
...
entry:
  ...
  %frame_bitoffset = getelementptr inbounds %struct.Bitstream, ptr %call, i64 0, i32 2
  store i32 0, ptr %frame_bitoffset, align 8, !tbaa !16
  %call1 = tail call i32 @u_1(ptr noundef nonnull @.str.46, ptr noundef %call) #12
  %tobool.not = icmp eq i32 %call1, 0
  br i1 %tobool.not, label %if.then, label %if.end44

if.then:                                          ; preds = %entry
  %call2 = tail call i32 @u_v(i32 noundef 2, ptr noundef nonnull @.str.47, ptr noundef nonnull %call) #12
  %call3 = tail call i32 @u_1(ptr noundef nonnull @.str.48, ptr noundef nonnull %call) #12
  %tobool4.not = icmp eq i32 %call3, 0
  br i1 %tobool4.not, label %if.end, label %if.then5

if.then5:                                         ; preds = %if.then
  %call6 = tail call i32 @u_v(i32 noundef 3, ptr noundef nonnull @.str.49, ptr noundef nonnull %call) #12
  %call7 = tail call i32 @u_v(i32 noundef 3, ptr noundef nonnull @.str.50, ptr noundef nonnull %call) #12
  %call8 = tail call i32 @u_v(i32 noundef 1, ptr noundef nonnull @.str.51, ptr noundef nonnull %call) #12
  %call9 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.52, ptr noundef nonnull %call) #12
  %call10 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.53, ptr noundef nonnull %call) #12
  %call11 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.54, ptr noundef nonnull %call) #12
  br label %if.end

if.end:                                           ; preds = %if.then5, %if.then
  %call12 = tail call i32 @u_v(i32 noundef 2, ptr noundef nonnull @.str.55, ptr noundef nonnull %call) #12
  %call13 = tail call i32 @u_v(i32 noundef 4, ptr noundef nonnull @.str.56, ptr noundef nonnull %call) #12
  %call14 = tail call i32 @u_1(ptr noundef nonnull @.str.57, ptr noundef nonnull %call) #12
  %call14.1 = tail call i32 @u_1(ptr noundef nonnull @.str.57, ptr noundef nonnull %call) #12
  %call14.2 = tail call i32 @u_1(ptr noundef nonnull @.str.57, ptr noundef nonnull %call) #12
  %tobool20.not = icmp eq i32 %call14, 0
  br i1 %tobool20.not, label %for.inc40, label %if.then21

if.then21:                                        ; preds = %if.end
  %call22 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.58, ptr noundef nonnull %call) #12
  %call23 = tail call i32 @u_v(i32 noundef 3, ptr noundef nonnull @.str.59, ptr noundef nonnull %call) #12
...
for.body26.us:                                    ; preds = %for.body26.lr.ph, %for.body26.us
  ...
  %call27.us = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.60, ptr noundef %call) #12
  %call28.us = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.61, ptr noundef %call) #12
...
for.body26:                                       ; preds = %for.body26.lr.ph, %for.cond29.for.inc36_crit_edge
  ...
  %call27 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.60, ptr noundef %call) #12
  %call28 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.61, ptr noundef %call) #12
  br label %for.body31

for.body31:                                       ; preds = %for.body26, %for.body31
  %j.075 = phi i32 [ 0, %for.body26 ], [ %inc34, %for.body31 ]
  %call32 = tail call i32 @se_v(ptr noundef nonnull @.str.62, ptr noundef %call) #12
...
if.then21.1:                                      ; preds = %for.inc40
  %call22.1 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.58, ptr noundef %call) #12
  %call23.1 = tail call i32 @u_v(i32 noundef 3, ptr noundef nonnull @.str.59, ptr noundef %call) #12
...
for.body26.1:                                     ; preds = %for.body26.lr.ph.1, %for.cond29.for.inc36_crit_edge.1
  ...
  %call27.1 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.60, ptr noundef %call) #12
  %call28.1 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.61, ptr noundef %call) #12
  br label %for.body31.1

for.body31.1:                                     ; preds = %for.body31.1, %for.body26.1
  %j.075.1 = phi i32 [ 0, %for.body26.1 ], [ %inc34.1, %for.body31.1 ]
  %call32.1 = tail call i32 @se_v(ptr noundef nonnull @.str.62, ptr noundef %call) #12
...
for.body26.us.1:                                  ; preds = %for.body26.lr.ph.1, %for.body26.us.1
  ...
  %call27.us.1 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.60, ptr noundef %call) #12
  %call28.us.1 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.61, ptr noundef %call) #12
...
if.then21.2:                                      ; preds = %for.inc40.1
  %call22.2 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.58, ptr noundef %call) #12
  %call23.2 = tail call i32 @u_v(i32 noundef 3, ptr noundef nonnull @.str.59, ptr noundef %call) #12
...
for.body26.2:                                     ; preds = %for.body26.lr.ph.2, %for.cond29.for.inc36_crit_edge.2
  ...
  %call27.2 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.60, ptr noundef %call) #12
  %call28.2 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.61, ptr noundef %call) #12
  br label %for.body31.2

for.body31.2:                                     ; preds = %for.body31.2, %for.body26.2
  %j.075.2 = phi i32 [ 0, %for.body26.2 ], [ %inc34.2, %for.body31.2 ]
  %call32.2 = tail call i32 @se_v(ptr noundef nonnull @.str.62, ptr noundef %call) #12
...
for.body26.us.2:                                  ; preds = %for.body26.lr.ph.2, %for.body26.us.2
  ...
  %call27.us.2 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.60, ptr noundef %call) #12
  %call28.us.2 = tail call i32 @u_v(i32 noundef 8, ptr noundef nonnull @.str.61, ptr noundef %call) #12
...
for.inc40.2:                                      ; preds = %for.cond29.for.inc36_crit_edge.2, %for.body26.us.2, %if.then21.2, %for.inc40.1
  %call43 = tail call i32 @ue_v(ptr noundef nonnull @.str.63, ptr noundef %call) #12
  br label %if.end44
...
entry:
  ...
  %frame_bitoffset = getelementptr inbounds %struct.Bitstream, ptr %call, i64 0, i32 2
  store i32 0, ptr %frame_bitoffset, align 8, !tbaa !16
  %call1 = tail call i32 @u_1(ptr noundef nonnull @.str.64, ptr noundef %call) #12
  %tobool.not = icmp eq i32 %call1, 0
  br i1 %tobool.not, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %call2 = tail call i32 @u_1(ptr noundef nonnull @.str.65, ptr noundef nonnull %call) #12
  %call3 = tail call i32 @u_1(ptr noundef nonnull @.str.66, ptr noundef nonnull %call) #12
  %call4 = tail call i32 @ue_v(ptr noundef nonnull @.str.67, ptr noundef nonnull %call) #12
  br label %if.end
...
entry:
  ...
  %frame_bitoffset = getelementptr inbounds %struct.Bitstream, ptr %call, i64 0, i32 2
  store i32 0, ptr %frame_bitoffset, align 8, !tbaa !16
  %call1 = tail call i32 @u_1(ptr noundef nonnull @.str.68, ptr noundef %call) #12
  %tobool.not = icmp eq i32 %call1, 0
  br i1 %tobool.not, label %if.else, label %if.end

if.else:                                          ; preds = %entry
  %call3 = tail call i32 @u_1(ptr noundef nonnull @.str.70, ptr noundef nonnull %call) #12
  br label %if.end

if.end:                                           ; preds = %entry, %if.else
  %.str.71.sink = phi ptr [ @.str.71, %if.else ], [ @.str.69, %entry ]
  %call4 = tail call i32 @u_1(ptr noundef nonnull %.str.71.sink, ptr noundef nonnull %call) #12
  %call5 = tail call i32 @u_1(ptr noundef nonnull @.str.72, ptr noundef nonnull %call) #12
  %call6 = tail call i32 @u_1(ptr noundef nonnull @.str.73, ptr noundef nonnull %call) #12
  tail call void @free(ptr noundef nonnull %call) #12
  ret void
}

; Function Attrs: nofree norecurse nosync nounwind memory(none) uwtable
define dso_local void @interpret_reserved_info(ptr nocapture noundef %payload, i32 noundef %size, ptr nocapture noundef %img) local_unnamed_addr #3 {
entry:
  ret void
}
...
declare i32 @ue_v(ptr noundef, ptr noundef) local_unnamed_addr #6

declare i32 @get_mem3D(ptr noundef, i32 noundef, i32 noundef, i32 noundef) local_unnamed_addr #6

declare i32 @u_1(ptr noundef, ptr noundef) local_unnamed_addr #6
...
declare void @free_mem3D(ptr noundef, i32 noundef) local_unnamed_addr #6

; Function Attrs: mustprogress nounwind willreturn allockind("free") memory(argmem: readwrite, inaccessiblemem: readwrite)
declare void @free(ptr allocptr nocapture noundef) local_unnamed_addr #9

declare i32 @u_v(i32 noundef, ptr noundef, ptr noundef) local_unnamed_addr #6

declare i32 @se_v(ptr noundef, ptr noundef) local_unnamed_addr #6

declare void @dec_ref_pic_marking(ptr noundef) local_unnamed_addr #6
...
entry:
  ...
  store i32 0, ptr @UsedBits, align 4, !tbaa !17
  %call1 = tail call i32 @ue_v(ptr noundef nonnull @.str.41, ptr noundef %call) #12
  %call2 = tail call i32 @ue_v(ptr noundef nonnull @.str.42, ptr noundef %call) #12
  tail call void @free(ptr noundef %call) #12
  ret void
}

declare i32 @CeilLog2(i32 noundef) local_unnamed_addr #6

declare void @activate_sps(ptr noundef) local_unnamed_addr #6
