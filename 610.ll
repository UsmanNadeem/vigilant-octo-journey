; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/lua/lstrlib.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/lua/lstrlib.c"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8216, ptr nonnull %b) #10
  call void @luaL_buffinit(ptr noundef %L, ptr noundef nonnull %b) #10
  %cmp138 = icmp sgt i64 %0, 0
  br i1 %cmp138, label %while.body.lr.ph, label %while.end

while.body.lr.ph:                                 ; preds = %entry
  %add.ptr3 = getelementptr inbounds %struct.luaL_Buffer, ptr %b, i64 1
  %incdec.ptr66.i = getelementptr inbounds i8, ptr %form, i64 1
  br label %while.body

while.body:                                       ; preds = %while.body.lr.ph, %while.cond.backedge
  %arg.0140 = phi i32 [ 1, %while.body.lr.ph ], [ %arg.0.be, %while.cond.backedge ]
  %strfrmt.0139 = phi ptr [ %call, %while.body.lr.ph ], [ %strfrmt.0.be, %while.cond.backedge ]
  %1 = load i8, ptr %strfrmt.0139, align 1, !tbaa !9
...
lor.rhs:                                          ; preds = %if.then
  ...
  %.pre = load i8, ptr %strfrmt.0139, align 1, !tbaa !9
  %.pre141 = load ptr, ptr %b, align 8, !tbaa !12
  br label %lor.end

lor.end:                                          ; preds = %lor.rhs, %if.then
  %3 = phi ptr [ %.pre141, %lor.rhs ], [ %2, %if.then ]
  %4 = phi i8 [ %.pre, %lor.rhs ], [ %1, %if.then ]
  %incdec.ptr = getelementptr inbounds i8, ptr %strfrmt.0139, i64 1
...
if.else:                                          ; preds = %while.body
  %incdec.ptr9 = getelementptr inbounds i8, ptr %strfrmt.0139, i64 1
...
lor.rhs20:                                        ; preds = %if.then13
  ...
  %.pre142 = load i8, ptr %incdec.ptr9, align 1, !tbaa !9
  %.pre143 = load ptr, ptr %b, align 8, !tbaa !12
  br label %lor.end23

lor.end23:                                        ; preds = %lor.rhs20, %if.then13
  %7 = phi ptr [ %.pre143, %lor.rhs20 ], [ %6, %if.then13 ]
  %8 = phi i8 [ %.pre142, %lor.rhs20 ], [ 37, %if.then13 ]
  %incdec.ptr25 = getelementptr inbounds i8, ptr %strfrmt.0139, i64 2
...
if.else28:                                        ; preds = %if.else
  ...
  %inc = add nsw i32 %arg.0140, 1
  %cmp.not107.i = icmp eq i8 %5, 0
  br i1 %cmp.not107.i, label %while.end.i, label %land.rhs.i

land.rhs.i:                                       ; preds = %if.else28, %while.body.i
  %9 = phi i8 [ %12, %while.body.i ], [ %5, %if.else28 ]
  %p.0108.i = phi ptr [ %incdec.ptr.i, %while.body.i ], [ %incdec.ptr9, %if.else28 ]
  %conv102.i = zext i8 %9 to i64
  %memchr.bounds.i = icmp ugt i8 %9, 63
  %10 = shl nuw i64 1, %conv102.i
  %11 = and i64 %10, 325494096527361
  %memchr.bits.i = icmp eq i64 %11, 0
  %memchr101.not.i = select i1 %memchr.bounds.i, i1 true, i1 %memchr.bits.i
  br i1 %memchr101.not.i, label %while.end.i, label %while.body.i

while.body.i:                                     ; preds = %land.rhs.i
  %incdec.ptr.i = getelementptr inbounds i8, ptr %p.0108.i, i64 1
...
while.end.i:                                      ; preds = %while.body.i, %land.rhs.i, %if.else28
  ...
  %p.0.lcssa.i = phi ptr [ %incdec.ptr9, %if.else28 ], [ %p.0108.i, %land.rhs.i ], [ %incdec.ptr.i, %while.body.i ]
  %sub.ptr.lhs.cast.i = ptrtoint ptr %p.0.lcssa.i to i64
  %sub.ptr.rhs.cast.i = ptrtoint ptr %incdec.ptr9 to i64
  %sub.ptr.sub.i = sub i64 %sub.ptr.lhs.cast.i, %sub.ptr.rhs.cast.i
  %cmp11.i = icmp ugt i64 %sub.ptr.sub.i, 5
  br i1 %cmp11.i, label %if.then.i, label %if.end.i

if.then.i:                                        ; preds = %while.end.i
  %call13.i = call i32 (ptr, ptr, ...) @luaL_error(ptr noundef %L, ptr noundef nonnull @.str.30) #10
  %.pre.i = load i8, ptr %p.0.lcssa.i, align 1, !tbaa !9
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i, %while.end.i
  %14 = phi i8 [ %.pre.i, %if.then.i ], [ %13, %while.end.i ]
  %call14.i = tail call ptr @__ctype_b_loc() #11
  %15 = load ptr, ptr %call14.i, align 8, !tbaa !18
  ...
  %idxprom22.i = zext i8 %18 to i64
  %arrayidx23.i = getelementptr inbounds i16, ptr %15, i64 %idxprom22.i
  %19 = load i16, ptr %arrayidx23.i, align 2, !tbaa !19
  %20 = lshr i16 %19, 11
  %.lobit105.i = and i16 %20, 1
  %p.2.idx.i = zext i16 %.lobit105.i to i64
  %p.2.i = getelementptr i8, ptr %spec.select.i, i64 %p.2.idx.i
  %21 = load i8, ptr %p.2.i, align 1, !tbaa !9
  %cmp31.i = icmp eq i8 %21, 46
  br i1 %cmp31.i, label %if.then33.i, label %if.end55.i

if.then33.i:                                      ; preds = %if.end.i
  %incdec.ptr34.i = getelementptr inbounds i8, ptr %p.2.i, i64 1
  %22 = load i8, ptr %incdec.ptr34.i, align 1, !tbaa !9
  %idxprom37.i = zext i8 %22 to i64
  %arrayidx38.i = getelementptr inbounds i16, ptr %15, i64 %idxprom37.i
  %23 = load i16, ptr %arrayidx38.i, align 2, !tbaa !19
  %24 = and i16 %23, 2048
  %tobool41.not.i = icmp eq i16 %24, 0
  %incdec.ptr43.i = getelementptr inbounds i8, ptr %p.2.i, i64 2
  %spec.select103.i = select i1 %tobool41.not.i, ptr %incdec.ptr34.i, ptr %incdec.ptr43.i
  %25 = load i8, ptr %spec.select103.i, align 1, !tbaa !9
  %idxprom47.i = zext i8 %25 to i64
  %arrayidx48.i = getelementptr inbounds i16, ptr %15, i64 %idxprom47.i
  %26 = load i16, ptr %arrayidx48.i, align 2, !tbaa !19
  %27 = lshr i16 %26, 11
  %.lobit106.i = and i16 %27, 1
  %spec.select104.idx.i = zext i16 %.lobit106.i to i64
  %spec.select104.i = getelementptr i8, ptr %spec.select103.i, i64 %spec.select104.idx.i
  %.pre110.i = load i8, ptr %spec.select104.i, align 1, !tbaa !9
  br label %if.end55.i

if.end55.i:                                       ; preds = %if.then33.i, %if.end.i
  %28 = phi i8 [ %21, %if.end.i ], [ %.pre110.i, %if.then33.i ]
  %p.4.i = phi ptr [ %p.2.i, %if.end.i ], [ %spec.select104.i, %if.then33.i ]
  %idxprom58.i = zext i8 %28 to i64
  %arrayidx59.i = getelementptr inbounds i16, ptr %15, i64 %idxprom58.i
  %29 = load i16, ptr %arrayidx59.i, align 2, !tbaa !19
  %30 = and i16 %29, 2048
  %tobool62.not.i = icmp eq i16 %30, 0
  br i1 %tobool62.not.i, label %scanformat.exit, label %if.then63.i

if.then63.i:                                      ; preds = %if.end55.i
  %call64.i = call i32 (ptr, ptr, ...) @luaL_error(ptr noundef %L, ptr noundef nonnull @.str.31) #10
  br label %scanformat.exit

scanformat.exit:                                  ; preds = %if.end55.i, %if.then63.i
  store i8 37, ptr %form, align 16, !tbaa !9
  %sub.ptr.lhs.cast67.i = ptrtoint ptr %p.4.i to i64
  %sub.ptr.sub69.i = sub i64 %sub.ptr.lhs.cast67.i, %sub.ptr.rhs.cast.i
  %add.i = add nsw i64 %sub.ptr.sub69.i, 1
  %call70.i = call ptr @strncpy(ptr noundef nonnull %incdec.ptr66.i, ptr noundef nonnull %incdec.ptr9, i64 noundef %add.i) #10
  %add.ptr.i = getelementptr inbounds i8, ptr %incdec.ptr66.i, i64 %add.i
  ...
  switch i32 %conv32, label %cleanup81.thread [
    i32 99, label %sw.bb
...
sw.bb38:                                          ; preds = %scanformat.exit, %scanformat.exit
  ...
  %arrayidx.i117 = getelementptr inbounds i8, ptr %form, i64 %sub.i
  %32 = load i8, ptr %arrayidx.i117, align 1, !tbaa !9
  %add.ptr.i118 = getelementptr inbounds i8, ptr %form, i64 %call.i
  %add.ptr1.i = getelementptr inbounds i8, ptr %add.ptr.i118, i64 -1
  store i16 108, ptr %add.ptr1.i, align 1
  store i8 %32, ptr %add.ptr.i118, align 1, !tbaa !9
...
sw.bb45:                                          ; preds = %scanformat.exit, %scanformat.exit, %scanformat.exit, %scanformat.exit
  %call.i119 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %form) #12
  %sub.i120 = add i64 %call.i119, -1
  %arrayidx.i121 = getelementptr inbounds i8, ptr %form, i64 %sub.i120
  %33 = load i8, ptr %arrayidx.i121, align 1, !tbaa !9
  %add.ptr.i122 = getelementptr inbounds i8, ptr %form, i64 %call.i119
  %add.ptr1.i123 = getelementptr inbounds i8, ptr %add.ptr.i122, i64 -1
  store i16 108, ptr %add.ptr1.i123, align 1
  store i8 %33, ptr %add.ptr.i122, align 1, !tbaa !9
  %sub6.i124 = add i64 %call.i119, 1
  %arrayidx7.i125 = getelementptr inbounds i8, ptr %form, i64 %sub6.i124
  store i8 0, ptr %arrayidx7.i125, align 1, !tbaa !9
...
sw.bb57:                                          ; preds = %scanformat.exit
  ...
  %call.i126 = call ptr @luaL_checklstring(ptr noundef %L, i32 noundef %inc, ptr noundef nonnull %l.i) #10
...
lor.rhs.i:                                        ; preds = %sw.bb57
  ...
  %.pre.i128 = load ptr, ptr %b, align 8, !tbaa !12
  br label %lor.end.i

lor.end.i:                                        ; preds = %lor.rhs.i, %sw.bb57
  %35 = phi ptr [ %.pre.i128, %lor.rhs.i ], [ %34, %sw.bb57 ]
  %incdec.ptr.i129 = getelementptr inbounds i8, ptr %35, i64 1
  store ptr %incdec.ptr.i129, ptr %b, align 8, !tbaa !12
  ...
  br i1 %tobool3.not84.i, label %while.end.i131, label %while.body.i130

while.body.i130:                                  ; preds = %lor.end.i, %sw.epilog.i
  %s.085.i = phi ptr [ %incdec.ptr45.i, %sw.epilog.i ], [ %call.i126, %lor.end.i ]
...
sw.bb.i:                                          ; preds = %while.body.i130, %while.body.i130, %while.body.i130
...
sw.epilog.i:                                      ; preds = %lor.end41.i, %sw.bb31.i, %sw.bb30.i, %lor.end26.i
  ...
  br i1 %tobool3.not.i, label %while.end.i131, label %while.body.i130, !llvm.loop !21

while.end.i131:                                   ; preds = %sw.epilog.i, %lor.end.i
  %47 = load ptr, ptr %b, align 8, !tbaa !12
  %cmp50.i = icmp ult ptr %47, %add.ptr3
  br i1 %cmp50.i, label %addquoted.exit, label %lor.rhs52.i

lor.rhs52.i:                                      ; preds = %while.end.i131
  %call53.i = call ptr @luaL_prepbuffer(ptr noundef nonnull %b) #10
  %.pre90.i = load ptr, ptr %b, align 8, !tbaa !12
  br label %addquoted.exit

addquoted.exit:                                   ; preds = %while.end.i131, %lor.rhs52.i
  %48 = phi ptr [ %.pre90.i, %lor.rhs52.i ], [ %47, %while.end.i131 ]
  ...
  br label %cleanup81, !llvm.loop !22

sw.bb58:                                          ; preds = %scanformat.exit
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %l) #10
  %call59 = call ptr @luaL_checklstring(ptr noundef %L, i32 noundef %inc, ptr noundef nonnull %l) #10
  %call64 = call ptr @strchr(ptr noundef nonnull dereferenceable(1) %form, i32 noundef 46) #10
  %tobool65 = icmp ne ptr %call64, null
  %49 = load i64, ptr %l, align 8
  %cmp67 = icmp ult i64 %49, 100
  %or.cond.not = select i1 %tobool65, i1 true, i1 %cmp67
  br i1 %or.cond.not, label %cleanup.thread, label %cleanup

cleanup.thread:                                   ; preds = %sw.bb58
  %call73 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %buff, ptr noundef nonnull dereferenceable(1) %form, ptr noundef %call59) #10
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %l) #10
  br label %cleanup81.thread135
...
cleanup81.thread:                                 ; preds = %scanformat.exit
  %conv32.le = sext i8 %31 to i32
  %call77 = call i32 (ptr, ptr, ...) @luaL_error(ptr noundef %L, ptr noundef nonnull @.str.28, i32 noundef %conv32.le) #10
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %buff) #10
  call void @llvm.lifetime.end.p0(i64 18, ptr nonnull %form) #10
  br label %cleanup85

cleanup81.thread135:                              ; preds = %sw.bb, %sw.bb38, %sw.bb45, %sw.bb52, %cleanup.thread
  %call80 = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %buff) #12
  call void @luaL_addlstring(ptr noundef nonnull %b, ptr noundef nonnull %buff, i64 noundef %call80) #10
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %buff) #10
  call void @llvm.lifetime.end.p0(i64 18, ptr nonnull %form) #10
  br label %while.cond.backedge

cleanup81:                                        ; preds = %cleanup, %addquoted.exit
  call void @llvm.lifetime.end.p0(i64 512, ptr nonnull %buff) #10
  call void @llvm.lifetime.end.p0(i64 18, ptr nonnull %form) #10
  br label %while.cond.backedge

while.cond.backedge:                              ; preds = %lor.end, %lor.end23, %cleanup81.thread135, %cleanup81
  %strfrmt.0.be = phi ptr [ %incdec.ptr31, %cleanup81 ], [ %incdec.ptr, %lor.end ], [ %incdec.ptr25, %lor.end23 ], [ %incdec.ptr31, %cleanup81.thread135 ]
  %arg.0.be = phi i32 [ %inc, %cleanup81 ], [ %arg.0140, %lor.end ], [ %arg.0140, %lor.end23 ], [ %inc, %cleanup81.thread135 ]
...
cleanup85:                                        ; preds = %cleanup81.thread, %while.end
  %retval.3 = phi i32 [ 1, %while.end ], [ %call77, %cleanup81.thread ]
  call void @llvm.lifetime.end.p0(i64 8216, ptr nonnull %b) #10
...
if.then9:                                         ; preds = %entry
  ...
  %sub = sub nsw i64 1, %spec.store.select
  %add = add i64 %sub, %spec.select
...
entry:
  ...
  %0 = load i64, ptr %l1, align 8, !tbaa !5
  ...
  br i1 %tobool.not, label %if.else57, label %land.lhs.true

land.lhs.true:                                    ; preds = %entry
  %call7 = call i32 @lua_toboolean(ptr noundef %L, i32 noundef 4) #10
  %tobool8.not = icmp eq i32 %call7, 0
  br i1 %tobool8.not, label %cond.false32, label %if.then46

cond.false32:                                     ; preds = %land.lhs.true
  %call33 = call ptr @strpbrk(ptr noundef %call1, ptr noundef nonnull @.str.19) #10
  %1 = icmp eq ptr %call33, null
  br i1 %1, label %if.then46, label %cond.false32.if.else57_crit_edge

cond.false32.if.else57_crit_edge:                 ; preds = %cond.false32
  %.pre = load i64, ptr %l1, align 8, !tbaa !5
  br label %if.else57

if.then46:                                        ; preds = %cond.false32, %land.lhs.true
  %add.ptr47 = getelementptr inbounds i8, ptr %call, i64 %init.0
  %2 = load i64, ptr %l1, align 8, !tbaa !5
  %sub48 = sub i64 %2, %init.0
  %3 = load i64, ptr %l2, align 8, !tbaa !5
  %cmp.i149 = icmp eq i64 %3, 0
  br i1 %cmp.i149, label %lmemfind.exit, label %if.else.i

if.else.i:                                        ; preds = %if.then46
  %cmp1.i = icmp ugt i64 %3, %sub48
  br i1 %cmp1.i, label %if.end99, label %if.else3.i

if.else3.i:                                       ; preds = %if.else.i
  %dec.i = add i64 %3, -1
  %sub.i = sub i64 %sub48, %dec.i
  %cmp4.not29.i = icmp eq i64 %sub.i, 0
  br i1 %cmp4.not29.i, label %if.end99, label %land.rhs.lr.ph.i

land.rhs.lr.ph.i:                                 ; preds = %if.else3.i
  %4 = load i8, ptr %call1, align 1, !tbaa !9
...
land.rhs.i:                                       ; preds = %if.else12.i, %land.rhs.lr.ph.i
  ...
  %s1.addr.030.i = phi ptr [ %add.ptr47, %land.rhs.lr.ph.i ], [ %incdec.ptr.i, %if.else12.i ]
  ...
  br i1 %cmp5.not.i, label %if.end99, label %while.body.i
...
while.body.i:                                     ; preds = %land.rhs.i
  ...
  br i1 %cmp8.i, label %if.then51, label %if.else12.i
...
if.else12.i:                                      ; preds = %while.body.i
  ...
  br i1 %cmp4.not.i, label %if.end99, label %land.rhs.i, !llvm.loop !38

lmemfind.exit:                                    ; preds = %if.then46
  %tobool50.not = icmp eq ptr %call, null
  br i1 %tobool50.not, label %if.end99, label %if.then51

if.then51:                                        ; preds = %while.body.i, %lmemfind.exit
  %retval.1.i171 = phi ptr [ %add.ptr47, %lmemfind.exit ], [ %call.i, %while.body.i ]
  %sub.ptr.lhs.cast = ptrtoint ptr %retval.1.i171 to i64
  %sub.ptr.rhs.cast = ptrtoint ptr %call to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
  %add = add nsw i64 %sub.ptr.sub, 1
  call void @lua_pushinteger(ptr noundef %L, i64 noundef %add) #10
  %5 = load i64, ptr %l2, align 8, !tbaa !5
  %add55 = add i64 %sub.ptr.sub, %5
  call void @lua_pushinteger(ptr noundef %L, i64 noundef %add55) #10
  br label %cleanup100

if.else57:                                        ; preds = %cond.false32.if.else57_crit_edge, %entry
  %6 = phi i64 [ %.pre, %cond.false32.if.else57_crit_edge ], [ %0, %entry ]
  call void @llvm.lifetime.start.p0(i64 544, ptr nonnull %ms) #10
  %7 = load i8, ptr %call1, align 1, !tbaa !9
  %.fr = freeze i8 %7
  %cmp59 = icmp ne i8 %.fr, 94
  %not.cmp59 = xor i1 %cmp59, true
  %spec.select148.idx = zext i1 %not.cmp59 to i64
  %spec.select148 = getelementptr i8, ptr %call1, i64 %spec.select148.idx
  %add.ptr65 = getelementptr inbounds i8, ptr %call, i64 %init.0
  %L66 = getelementptr inbounds %struct.MatchState, ptr %ms, i64 0, i32 2
  store ptr %L, ptr %L66, align 8, !tbaa !23
  store ptr %call, ptr %ms, align 8, !tbaa !25
  %add.ptr67 = getelementptr inbounds i8, ptr %call, i64 %6
  %src_end = getelementptr inbounds %struct.MatchState, ptr %ms, i64 0, i32 1
  store ptr %add.ptr67, ptr %src_end, align 8, !tbaa !26
  %level = getelementptr inbounds %struct.MatchState, ptr %ms, i64 0, i32 3
  %sub.ptr.rhs.cast75 = ptrtoint ptr %call to i64
  %sub.ptr.sub76 = sub i64 1, %sub.ptr.rhs.cast75
  br i1 %tobool.not, label %if.else57.split.us, label %do.body

if.else57.split.us:                               ; preds = %if.else57
  br i1 %cmp59, label %do.body.us, label %do.body.us.us

do.body.us.us:                                    ; preds = %if.else57.split.us
  store i32 0, ptr %level, align 8, !tbaa !27
  %call68.us.us = call fastcc ptr @match(ptr noundef nonnull %ms, ptr noundef %add.ptr65, ptr noundef nonnull %spec.select148)
  %cmp69.not.us.us = icmp eq ptr %call68.us.us, null
  br i1 %cmp69.not.us.us, label %cleanup94, label %if.then71.us.us

if.then71.us.us:                                  ; preds = %do.body.us.us
  %8 = load i32, ptr %level, align 8, !tbaa !27
  %cmp.i152.us.us = icmp eq i32 %8, 0
  %tobool.i.us.us = icmp ne ptr %call, null
  %or.cond.i.us.us = and i1 %tobool.i.us.us, %cmp.i152.us.us
  %spec.select.i.us.us = select i1 %or.cond.i.us.us, i32 1, i32 %8
  %9 = load ptr, ptr %L66, align 8, !tbaa !23
  call void @luaL_checkstack(ptr noundef %9, i32 noundef %spec.select.i.us.us, ptr noundef nonnull @.str.21) #10
  %cmp211.i154.us.us = icmp sgt i32 %spec.select.i.us.us, 0
  br i1 %cmp211.i154.us.us, label %for.body.i158.us.us, label %cleanup100.critedge

for.body.i158.us.us:                              ; preds = %if.then71.us.us, %for.body.i158.us.us
  %i.012.i155.us.us = phi i32 [ %inc.i156.us.us, %for.body.i158.us.us ], [ 0, %if.then71.us.us ]
  call fastcc void @push_onecapture(ptr noundef nonnull %ms, i32 noundef %i.012.i155.us.us, ptr noundef %add.ptr65, ptr noundef nonnull %call68.us.us)
  %inc.i156.us.us = add nuw nsw i32 %i.012.i155.us.us, 1
  %exitcond.not.i157.us.us = icmp eq i32 %inc.i156.us.us, %spec.select.i.us.us
  br i1 %exitcond.not.i157.us.us, label %cleanup100.critedge, label %for.body.i158.us.us, !llvm.loop !29

do.body.us:                                       ; preds = %if.else57.split.us, %do.cond.us
  %s1.0.us = phi ptr [ %incdec.ptr89.us, %do.cond.us ], [ %add.ptr65, %if.else57.split.us ]
  store i32 0, ptr %level, align 8, !tbaa !27
  %call68.us = call fastcc ptr @match(ptr noundef nonnull %ms, ptr noundef %s1.0.us, ptr noundef nonnull %spec.select148)
  %cmp69.not.us = icmp eq ptr %call68.us, null
  br i1 %cmp69.not.us, label %do.cond.us, label %if.then71.us

if.then71.us:                                     ; preds = %do.body.us
  %10 = load i32, ptr %level, align 8, !tbaa !27
  %cmp.i152.us = icmp eq i32 %10, 0
  %tobool.i.us = icmp ne ptr %s1.0.us, null
  %or.cond.i.us = and i1 %tobool.i.us, %cmp.i152.us
  %spec.select.i.us = select i1 %or.cond.i.us, i32 1, i32 %10
  %11 = load ptr, ptr %L66, align 8, !tbaa !23
  call void @luaL_checkstack(ptr noundef %11, i32 noundef %spec.select.i.us, ptr noundef nonnull @.str.21) #10
  %cmp211.i154.us = icmp sgt i32 %spec.select.i.us, 0
  br i1 %cmp211.i154.us, label %for.body.i158.us, label %cleanup100.critedge

for.body.i158.us:                                 ; preds = %if.then71.us, %for.body.i158.us
  %i.012.i155.us = phi i32 [ %inc.i156.us, %for.body.i158.us ], [ 0, %if.then71.us ]
  call fastcc void @push_onecapture(ptr noundef nonnull %ms, i32 noundef %i.012.i155.us, ptr noundef %s1.0.us, ptr noundef nonnull %call68.us)
  %inc.i156.us = add nuw nsw i32 %i.012.i155.us, 1
  %exitcond.not.i157.us = icmp eq i32 %inc.i156.us, %spec.select.i.us
  br i1 %exitcond.not.i157.us, label %cleanup100.critedge, label %for.body.i158.us, !llvm.loop !29

do.cond.us:                                       ; preds = %do.body.us
  %incdec.ptr89.us = getelementptr inbounds i8, ptr %s1.0.us, i64 1
  %12 = load ptr, ptr %src_end, align 8, !tbaa !26
  %cmp91.us = icmp ult ptr %s1.0.us, %12
  br i1 %cmp91.us, label %do.body.us, label %cleanup94, !llvm.loop !39

do.body:                                          ; preds = %if.else57, %do.cond
  %s1.0 = phi ptr [ %incdec.ptr89, %do.cond ], [ %add.ptr65, %if.else57 ]
  store i32 0, ptr %level, align 8, !tbaa !27
  %call68 = call fastcc ptr @match(ptr noundef nonnull %ms, ptr noundef %s1.0, ptr noundef nonnull %spec.select148)
  %cmp69.not = icmp eq ptr %call68, null
  br i1 %cmp69.not, label %do.cond, label %if.then71

if.then71:                                        ; preds = %do.body
  %sub.ptr.lhs.cast74 = ptrtoint ptr %s1.0 to i64
  %add77 = add i64 %sub.ptr.sub76, %sub.ptr.lhs.cast74
  call void @lua_pushinteger(ptr noundef %L, i64 noundef %add77) #10
  %sub.ptr.lhs.cast78 = ptrtoint ptr %call68 to i64
  %sub.ptr.sub80 = sub i64 %sub.ptr.lhs.cast78, %sub.ptr.rhs.cast75
  call void @lua_pushinteger(ptr noundef %L, i64 noundef %sub.ptr.sub80) #10
  %13 = load i32, ptr %level, align 8, !tbaa !27
  %14 = load ptr, ptr %L66, align 8, !tbaa !23
  call void @luaL_checkstack(ptr noundef %14, i32 noundef %13, ptr noundef nonnull @.str.21) #10
  %cmp211.i = icmp sgt i32 %13, 0
  br i1 %cmp211.i, label %for.body.i.preheader, label %cleanup100.critedge.split

for.body.i.preheader:                             ; preds = %if.then71
  %15 = zext i32 %13 to i64
  %16 = load i32, ptr %level, align 8, !tbaa !27
  %cmp.not.i.peel = icmp sgt i32 %16, 0
  br i1 %cmp.not.i.peel, label %if.else4.i.peel, label %if.then2.i.peel

if.then2.i.peel:                                  ; preds = %for.body.i.preheader
  %17 = load ptr, ptr %L66, align 8, !tbaa !23
  call void @lua_pushlstring(ptr noundef %17, ptr noundef null, i64 noundef 0) #10
...
if.else4.i.peel:                                  ; preds = %for.body.i.preheader
  ...
  %18 = load i64, ptr %len.i.peel, align 8, !tbaa !30
  switch i64 %18, label %if.else19.i.peel [
    i64 -1, label %if.then6.i.peel
    i64 -2, label %if.then11.i.peel
  ]

if.then11.i.peel:                                 ; preds = %if.else4.i.peel
  %19 = load ptr, ptr %L66, align 8, !tbaa !23
  %20 = load ptr, ptr %arrayidx.i.peel, align 8, !tbaa !32
  %21 = load ptr, ptr %ms, align 8, !tbaa !25
  %sub.ptr.lhs.cast16.i.peel = ptrtoint ptr %20 to i64
  %sub.ptr.rhs.cast17.i.peel = ptrtoint ptr %21 to i64
  %sub.ptr.sub18.i.peel = add i64 %sub.ptr.lhs.cast16.i.peel, 1
  %add.i165.peel = sub i64 %sub.ptr.sub18.i.peel, %sub.ptr.rhs.cast17.i.peel
  call void @lua_pushinteger(ptr noundef %19, i64 noundef %add.i165.peel) #10
  br label %push_onecapture.exit.peel

if.then6.i.peel:                                  ; preds = %if.else4.i.peel
  %22 = load ptr, ptr %L66, align 8, !tbaa !23
  %call8.i.peel = call i32 (ptr, ptr, ...) @luaL_error(ptr noundef %22, ptr noundef nonnull @.str.27) #10
  br label %if.else19.i.peel

if.else19.i.peel:                                 ; preds = %if.then6.i.peel, %if.else4.i.peel
  %23 = load ptr, ptr %L66, align 8, !tbaa !23
  %24 = load ptr, ptr %arrayidx.i.peel, align 8, !tbaa !32
  call void @lua_pushlstring(ptr noundef %23, ptr noundef %24, i64 noundef %18) #10
  br label %push_onecapture.exit.peel

push_onecapture.exit.peel:                        ; preds = %if.else19.i.peel, %if.then11.i.peel, %if.then2.i.peel
  %exitcond.not.i.peel = icmp eq i32 %13, 1
  br i1 %exitcond.not.i.peel, label %cleanup100.critedge.split, label %for.body.i
...
for.body.i:                                       ; preds = %push_onecapture.exit.peel, %push_onecapture.exit
  ...
  %25 = load i32, ptr %level, align 8, !tbaa !27
  %26 = sext i32 %25 to i64
  %cmp.not.i = icmp slt i64 %indvars.iv, %26
  br i1 %cmp.not.i, label %if.else4.i, label %if.else.i164

if.else.i164:                                     ; preds = %for.body.i
  %27 = load ptr, ptr %L66, align 8, !tbaa !23
  %call.i163 = call i32 (ptr, ptr, ...) @luaL_error(ptr noundef %27, ptr noundef nonnull @.str.26) #10
...
if.else4.i:                                       ; preds = %for.body.i
  ...
  %28 = load i64, ptr %len.i, align 8, !tbaa !30
  switch i64 %28, label %if.else19.i [
    i64 -1, label %if.then6.i
    i64 -2, label %if.then11.i
  ]

if.then6.i:                                       ; preds = %if.else4.i
  %29 = load ptr, ptr %L66, align 8, !tbaa !23
  %call8.i = call i32 (ptr, ptr, ...) @luaL_error(ptr noundef %29, ptr noundef nonnull @.str.27) #10
  br label %if.else19.i

if.then11.i:                                      ; preds = %if.else4.i
  %30 = load ptr, ptr %L66, align 8, !tbaa !23
  %31 = load ptr, ptr %arrayidx.i, align 8, !tbaa !32
  %32 = load ptr, ptr %ms, align 8, !tbaa !25
  %sub.ptr.lhs.cast16.i = ptrtoint ptr %31 to i64
  %sub.ptr.rhs.cast17.i = ptrtoint ptr %32 to i64
  %sub.ptr.sub18.i = add i64 %sub.ptr.lhs.cast16.i, 1
  %add.i165 = sub i64 %sub.ptr.sub18.i, %sub.ptr.rhs.cast17.i
  call void @lua_pushinteger(ptr noundef %30, i64 noundef %add.i165) #10
  br label %push_onecapture.exit

if.else19.i:                                      ; preds = %if.then6.i, %if.else4.i
  %33 = load ptr, ptr %L66, align 8, !tbaa !23
  %34 = load ptr, ptr %arrayidx.i, align 8, !tbaa !32
  call void @lua_pushlstring(ptr noundef %33, ptr noundef %34, i64 noundef %28) #10
  br label %push_onecapture.exit

push_onecapture.exit:                             ; preds = %if.else.i164, %if.then11.i, %if.else19.i
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next, %15
  br i1 %exitcond.not.i, label %cleanup100.critedge.split, label %for.body.i, !llvm.loop !40

do.cond:                                          ; preds = %do.body
  %incdec.ptr89 = getelementptr inbounds i8, ptr %s1.0, i64 1
  %35 = load ptr, ptr %src_end, align 8, !tbaa !26
  %cmp91 = icmp ult ptr %s1.0, %35
  %36 = and i1 %cmp59, %cmp91
  br i1 %36, label %do.body, label %cleanup94, !llvm.loop !39

cleanup94:                                        ; preds = %do.cond, %do.cond.us, %do.body.us.us
  call void @llvm.lifetime.end.p0(i64 544, ptr nonnull %ms) #10
  br label %if.end99

if.end99:                                         ; preds = %if.else12.i, %land.rhs.i, %if.else3.i, %if.else.i, %cleanup94, %lmemfind.exit
  call void @lua_pushnil(ptr noundef %L) #10
  br label %cleanup100

cleanup100.critedge.split:                        ; preds = %push_onecapture.exit, %if.then71, %push_onecapture.exit.peel
  %add82.le = add nsw i32 %13, 2
  br label %cleanup100.critedge

cleanup100.critedge:                              ; preds = %for.body.i158.us.us, %for.body.i158.us, %if.then71.us, %if.then71.us.us, %cleanup100.critedge.split
  %.us-phi = phi i32 [ %add82.le, %cleanup100.critedge.split ], [ %8, %if.then71.us.us ], [ %10, %if.then71.us ], [ %spec.select.i.us, %for.body.i158.us ], [ %spec.select.i.us.us, %for.body.i158.us.us ]
  call void @llvm.lifetime.end.p0(i64 544, ptr nonnull %ms) #10
  br label %cleanup100

cleanup100:                                       ; preds = %if.then51, %cleanup100.critedge, %if.end99
  %retval.3 = phi i32 [ 1, %if.end99 ], [ 2, %if.then51 ], [ %.us-phi, %cleanup100.critedge ]
...
while.body.preheader.i:                           ; preds = %if.else.i
  ...
  %25 = sub i64 %24, %s52.i
  %uglygep.i = getelementptr i8, ptr %s.addr.0.ph.ph, i64 %25
...
if.then8.i:                                       ; preds = %while.body.i220
  ...
  %call.i221 = tail call fastcc i32 @match_class(i32 noundef %conv33, i32 noundef %conv10.i)
...
if.end39.i:                                       ; preds = %if.else32.i, %land.lhs.true26.i, %if.then20.i, %if.then8.i
  ...
  br i1 %cmp3.i226, label %while.body.i220, label %matchbracketclass.exit, !llvm.loop !45
...
if.then8.i242:                                    ; preds = %while.body.i238
  ...
  %call.i240 = tail call fastcc i32 @match_class(i32 noundef %conv36, i32 noundef %conv10.i239)
...
if.end39.i260:                                    ; preds = %if.else32.i256, %land.lhs.true26.i253, %if.then20.i250, %if.then8.i242
  ...
  br i1 %cmp3.i259, label %while.body.i238, label %matchbracketclass.exit263, !llvm.loop !45
...
sw.bb1.i:                                         ; preds = %land.rhs
  ...
  %call.i312 = tail call fastcc i32 @match_class(i32 noundef %conv78, i32 noundef %conv2.i)
...
if.then8.i.i:                                     ; preds = %while.body.i.i
  ...
  %call.i.i315 = tail call fastcc i32 @match_class(i32 noundef %conv78, i32 noundef %conv10.i.i)
...
if.end39.i.i:                                     ; preds = %if.else32.i.i, %land.lhs.true26.i.i, %if.then20.i.i, %if.then8.i.i
  ...
  br i1 %cmp3.i.i316, label %while.body.i.i, label %matchbracketclass.exit.i, !llvm.loop !45
...
sw.bb1.i381:                                      ; preds = %land.rhs.i
  ...
  %call.i380 = tail call fastcc i32 @match_class(i32 noundef %conv.i323, i32 noundef %conv2.i379)
...
if.then8.i.i398:                                  ; preds = %while.body.i.i394
  ...
  %call.i.i396 = tail call fastcc i32 @match_class(i32 noundef %conv.i323, i32 noundef %conv10.i.i395)
...
if.end39.i.i416:                                  ; preds = %if.else32.i.i412, %land.lhs.true26.i.i409, %if.then20.i.i406, %if.then8.i.i398
  ...
  br i1 %cmp3.i.i415, label %while.body.i.i394, label %matchbracketclass.exit.i419, !llvm.loop !45
...
while.body.i327:                                  ; preds = %land.rhs.i, %singlematch.exit425
  ...
  br i1 %exitcond676.not, label %while.end.i, label %land.rhs.i, !llvm.loop !46
...
while.body5.i:                                    ; preds = %while.cond2.i
  ...
  br i1 %tobool9.not.i, label %while.cond2.i, label %return, !llvm.loop !47
...
sw.bb1.i430:                                      ; preds = %land.rhs.i340
  ...
  %call.i429 = tail call fastcc i32 @match_class(i32 noundef %conv.i337, i32 noundef %conv2.i428)
...
if.then8.i.i447:                                  ; preds = %while.body.i.i443
  ...
  %call.i.i445 = tail call fastcc i32 @match_class(i32 noundef %conv.i337, i32 noundef %conv10.i.i444)
...
if.end39.i.i465:                                  ; preds = %if.else32.i.i461, %land.lhs.true26.i.i458, %if.then20.i.i455, %if.then8.i.i447
  ...
  br i1 %cmp3.i.i464, label %while.body.i.i443, label %matchbracketclass.exit.i468, !llvm.loop !45
...
while.body.i342:                                  ; preds = %land.rhs.i340, %singlematch.exit474
  ...
  br i1 %exitcond.not, label %while.end.i343, label %land.rhs.i340, !llvm.loop !46
...
while.body5.i355:                                 ; preds = %while.cond2.i347
  ...
  br i1 %tobool9.not.i351, label %while.cond2.i347, label %return, !llvm.loop !47
...
sw.bb1.i479:                                      ; preds = %land.lhs.true.i366
  ...
  %call.i478 = tail call fastcc i32 @match_class(i32 noundef %conv.i364, i32 noundef %conv2.i477)
...
if.then8.i.i496:                                  ; preds = %while.body.i.i492
  ...
  %call.i.i494 = tail call fastcc i32 @match_class(i32 noundef %conv.i364, i32 noundef %conv10.i.i493)
...
if.end39.i.i514:                                  ; preds = %if.else32.i.i510, %land.lhs.true26.i.i507, %if.then20.i.i504, %if.then8.i.i496
  ...
  br i1 %cmp3.i.i513, label %while.body.i.i492, label %matchbracketclass.exit.i517, !llvm.loop !45
...
push_onecapture.exit:                             ; preds = %if.else.i, %if.then11.i, %if.else19.i
  ...
  br i1 %exitcond.not.i, label %cleanup12, label %for.body.i, !llvm.loop !48
...
for.inc:                                          ; preds = %for.body
  ...
  br i1 %cmp.not, label %cleanup12, label %for.body, !llvm.loop !49
