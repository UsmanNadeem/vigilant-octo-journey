; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/GzHandler.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/GzHandler.cpp"
...
_ZN9NCompress8NDeflate8NDecoder6CCoder8ReadByteEv.exit.1: ; preds = %if.end.i.i.i.1
  ...
  %retval.0.i.i.1 = select i1 %cmp.i.i.1, i1 %cmp3.i.i.1, i1 false
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i64, ptr %_packSize, align 8, !tbaa !47
...
invoke.cont6:                                     ; preds = %if.then
  %2 = load ptr, ptr %ref.tmp, align 8, !tbaa !58
...
invoke.cont10:                                    ; preds = %invoke.cont6
  %3 = load ptr, ptr %ref.tmp, align 8, !tbaa !58
...
sw.bb12:                                          ; preds = %entry
  ...
  %8 = load i32, ptr %Time, align 4, !tbaa !60
...
sw.bb23:                                          ; preds = %entry
  ...
  %10 = load ptr, ptr %_stream, align 8, !tbaa !61
...
if.then26:                                        ; preds = %sw.bb23
  ...
  %11 = load i32, ptr %Size32, align 4, !tbaa !62
  %conv = zext i32 %11 to i64
  br label %if.then33.invoke

sw.bb31:                                          ; preds = %entry
  %_packSizeDefined = getelementptr inbounds %"class.NArchive::NGz::CHandler", ptr %this, i64 0, i32 9
  %12 = load i8, ptr %_packSizeDefined, align 8, !tbaa !63, !range !64, !noundef !65
  %tobool32.not = icmp eq i8 %12, 0
  br i1 %tobool32.not, label %sw.epilog, label %if.then33

if.then33:                                        ; preds = %sw.bb31
  %_packSize = getelementptr inbounds %"class.NArchive::NGz::CHandler", ptr %this, i64 0, i32 8
  %13 = load i64, ptr %_packSize, align 8, !tbaa !47
  br label %if.then33.invoke
...
sw.bb45:                                          ; preds = %entry
  ...
  %17 = load ptr, ptr %_stream46, align 8, !tbaa !61
...
invoke.cont13:                                    ; preds = %if.then9
  ...
  %sub = sub i64 %add, %7
  %_packSize = getelementptr inbounds %"class.NArchive::NGz::CHandler", ptr %this, i64 0, i32 8
  store i64 %sub, ptr %_packSize, align 8, !tbaa !47
  %_packSizeDefined = getelementptr inbounds %"class.NArchive::NGz::CHandler", ptr %this, i64 0, i32 9
  store i8 1, ptr %_packSizeDefined, align 8, !tbaa !63
...
try.cont:                                         ; preds = %if.end.i, %if.then2.i
  store ptr %stream, ptr %_stream, align 8, !tbaa !61
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %endPos) #20
...
entry:
  %_packSizeDefined = getelementptr inbounds %"class.NArchive::NGz::CHandler", ptr %this, i64 0, i32 9
  store i8 0, ptr %_packSizeDefined, align 8, !tbaa !63
  %_stream = getelementptr inbounds %"class.NArchive::NGz::CHandler", ptr %this, i64 0, i32 10
  %0 = load ptr, ptr %_stream, align 8, !tbaa !61
...
if.then.i:                                        ; preds = %entry
  ...
  store ptr null, ptr %_stream, align 8, !tbaa !61
...
if.end6:                                          ; preds = %entry, %lor.lhs.false
  %_stream = getelementptr inbounds %"class.NArchive::NGz::CHandler", ptr %this, i64 0, i32 10
  %1 = load ptr, ptr %_stream, align 8, !tbaa !61
  %tobool.not = icmp eq ptr %1, null
  br i1 %tobool.not, label %if.end10, label %if.then7

if.then7:                                         ; preds = %if.end6
  %_packSize = getelementptr inbounds %"class.NArchive::NGz::CHandler", ptr %this, i64 0, i32 8
  %2 = load i64, ptr %_packSize, align 8, !tbaa !47
...
invoke.cont68:                                    ; preds = %invoke.cont66
  %21 = load ptr, ptr %_stream, align 8, !tbaa !61
...
invoke.cont94:                                    ; preds = %if.end91, %_ZN8NArchive3NGz5CItemD2Ev.exit
  ...
  store i64 %sub3.i.i, ptr %_packSize96, align 8, !tbaa !47
...
if.end.i:                                         ; preds = %invoke.cont59
  %27 = load ptr, ptr %name, align 8, !tbaa !58
...
lpad67:                                           ; preds = %invoke.cont66
  %33 = landingpad { ptr, i32 }
          cleanup
  %34 = load ptr, ptr %ref.tmp, align 8, !tbaa !58
...
if.end88:                                         ; preds = %if.then84, %_ZN11CStringBaseIcED2Ev.exit
  %42 = load ptr, ptr %name, align 8, !tbaa !58
...
ehcleanup89:                                      ; preds = %ehcleanup80, %ehcleanup71
  ...
  %43 = load ptr, ptr %name, align 8, !tbaa !58
...
if.end180:                                        ; preds = %if.end177
  %_stream = getelementptr inbounds %"class.NArchive::NGz::CHandler", ptr %this, i64 0, i32 10
  %69 = load ptr, ptr %_stream, align 8, !tbaa !61
...
invoke.cont189:                                   ; preds = %if.then188
  ...
  %.pre = load ptr, ptr %_stream, align 8, !tbaa !61
  br label %if.end192
...
cleanup.cont207:                                  ; preds = %invoke.cont200
  %77 = load ptr, ptr %_stream, align 8, !tbaa !61
...
_ZN11CStringBaseIwE11SetCapacityEi.exit:          ; preds = %if.end, %if.end9.i
  ...
  %8 = load ptr, ptr %s, align 8, !tbaa !58
  br label %while.cond.i
...
_ZN9CMyComPtrI14ICompressCoderED2Ev.exit:         ; preds = %entry, %if.then.i
  %_stream = getelementptr inbounds %"class.NArchive::NGz::CHandler", ptr %this, i64 0, i32 10
  %4 = load ptr, ptr %_stream, align 8, !tbaa !61
...
_ZN9CMyComPtrI14ICompressCoderED2Ev.exit.i:       ; preds = %if.then.i.i, %entry
  ...
  %4 = load ptr, ptr %_stream.i, align 8, !tbaa !61
...
_ZN9CMyComPtrI14ICompressCoderED2Ev.exit.i:       ; preds = %if.then.i.i, %entry
  ...
  %5 = load ptr, ptr %_stream.i, align 8, !tbaa !61
...
_ZN9CMyComPtrI14ICompressCoderED2Ev.exit.i.i:     ; preds = %if.then.i.i.i, %entry
  ...
  %5 = load ptr, ptr %_stream.i.i, align 8, !tbaa !61
...
_ZN9CMyComPtrI14ICompressCoderED2Ev.exit:         ; preds = %ehcleanup, %if.then.i
  %14 = load ptr, ptr %_stream, align 8, !tbaa !61
...
entry:
  ...
  %_length = getelementptr inbounds %class.CStringBase.5, ptr %this, i64 0, i32 1
  %0 = load i32, ptr %_length, align 8, !tbaa !107
...
if.end9.i.i:                                      ; preds = %if.then7
  ...
  store ptr %call.i.i, ptr %agg.result, align 8, !tbaa !58
...
_ZN11CStringBaseIwE11SetCapacityEi.exit.i:        ; preds = %if.end9.i.i, %if.then7
  ...
  %5 = load ptr, ptr %this, align 8, !tbaa !58
...
if.end8:                                          ; preds = %entry
  ...
  store ptr %call.i.i32, ptr %agg.result, align 8, !tbaa !58
...
_ZN11CStringBaseIwE11SetCapacityEi.exit:          ; preds = %if.end.i
  ...
  store ptr %call.i36, ptr %agg.result, align 8, !tbaa !58
...
for.body.lr.ph:                                   ; preds = %if.end8, %_ZN11CStringBaseIwE11SetCapacityEi.exit
  ...
  %11 = load ptr, ptr %this, align 8, !tbaa !58
