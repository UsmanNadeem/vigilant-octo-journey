; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/debugger.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/simulator/debugger.c"
...
for.body56.preheader:                             ; preds = %for.body.6, %for.body.5, %for.body.4, %for.body.3, %for.body.2, %for.body.1, %for.body
  ...
  %uglygep = getelementptr i8, ptr %SYMBOL, i64 %27
  %narrow = sub nuw nsw i32 8, %LOOP.0.lcssa.ph
  %28 = zext i32 %narrow to i64
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %uglygep, i8 32, i64 %28, i1 false), !tbaa !7
  br label %for.end61
...
for.end:                                          ; preds = %for.cond
  ...
  %9 = select i1 %cmp2872, i1 %cmp3073, i1 false
