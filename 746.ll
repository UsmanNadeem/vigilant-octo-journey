; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/hack.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/espresso/hack.c"
...
for.cond.preheader:                               ; preds = %lor.lhs.false
  ...
  %cmp31127 = icmp sgt i32 %2, 0
  br i1 %cmp31127, label %cond.false182.preheader, label %cleanup

cond.false182.preheader:                          ; preds = %for.cond.preheader
  %mul = shl nuw i32 %2, 1
  %smax = tail call i32 @llvm.smax.i32(i32 %mul, i32 1)
  %wide.trip.count = zext i32 %smax to i64
  br label %cond.false182

cond.false182:                                    ; preds = %cond.false182.preheader, %for.inc
  %indvars.iv1144 = phi i32 [ 0, %cond.false182.preheader ], [ %indvars.iv.next1145, %for.inc ]
  %indvars.iv = phi i64 [ 0, %cond.false182.preheader ], [ %indvars.iv.next, %for.inc ]
  %arrayidx185 = getelementptr inbounds ptr, ptr %0, i64 %indvars.iv
  %3 = load ptr, ptr %arrayidx185, align 8, !tbaa !11
  %call186 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %3, ptr noundef nonnull dereferenceable(10) @.str, i64 noundef 9) #10
  %cmp189 = icmp eq i32 %call186, 0
  br i1 %cmp189, label %for.end, label %cond.false395

cond.false395:                                    ; preds = %cond.false182
  %call399 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %3, ptr noundef nonnull dereferenceable(9) @.str.1, i64 noundef 8) #10
  %cmp402 = icmp eq i32 %call399, 0
  br i1 %cmp402, label %for.end, label %cond.false608

cond.false608:                                    ; preds = %cond.false395
  %call612 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %3, ptr noundef nonnull dereferenceable(10) @.str.2, i64 noundef 9) #10
  %cmp615 = icmp eq i32 %call612, 0
  br i1 %cmp615, label %for.end, label %cond.false821

cond.false821:                                    ; preds = %cond.false608
  %call825 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %3, ptr noundef nonnull dereferenceable(9) @.str.3, i64 noundef 8) #10
  %cmp828 = icmp eq i32 %call825, 0
  br i1 %cmp828, label %for.end, label %for.inc

for.inc:                                          ; preds = %cond.false821
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  %indvars.iv.next1145 = add nuw nsw i32 %indvars.iv1144, 1
  br i1 %exitcond.not, label %cleanup, label %cond.false182

for.end:                                          ; preds = %cond.false182, %cond.false395, %cond.false608, %cond.false821
  %4 = trunc i64 %indvars.iv to i32
  %div1122 = lshr i32 %4, 1
  %5 = load ptr, ptr getelementptr inbounds (%struct.cube_struct, ptr @cube, i64 0, i32 12), align 8, !tbaa !14
  %6 = load i32, ptr %5, align 4, !tbaa !15
  %and = shl i32 %6, 5
  %mul837 = and i32 %and, 32736
  %cmp838 = icmp ult i32 %mul837, 33
  %sub845 = add nsw i32 %mul837, -1
  %7 = lshr i32 %sub845, 3
  %add846 = and i32 %7, 536870908
  %8 = add nuw nsw i32 %add846, 8
  %narrow = select i1 %cmp838, i32 8, i32 %8
  %cond848 = zext i32 %narrow to i64
  %call851 = tail call noalias ptr @malloc(i64 noundef %cond848) #11
  %call852 = tail call ptr (ptr, ptr, ...) @set_copy(ptr noundef %call851, ptr noundef nonnull %5) #9
  %9 = load ptr, ptr getelementptr inbounds (%struct.cube_struct, ptr @cube, i64 0, i32 12), align 8, !tbaa !14
  %10 = load i32, ptr %9, align 4, !tbaa !15
  %and854 = shl i32 %10, 5
  %mul855 = and i32 %and854, 32736
  %cmp856 = icmp ult i32 %mul855, 33
  %sub863 = add nsw i32 %mul855, -1
  %11 = lshr i32 %sub863, 3
  %add866 = and i32 %11, 536870908
  %12 = add nuw nsw i32 %add866, 8
  %narrow1125 = select i1 %cmp856, i32 8, i32 %12
  %cond868 = zext i32 %narrow1125 to i64
  %call871 = tail call noalias ptr @malloc(i64 noundef %cond868) #11
  %call872 = tail call ptr (ptr, ptr, ...) @set_copy(ptr noundef %call871, ptr noundef nonnull %9) #9
  %mul873 = and i32 %4, 2147483646
  %and874 = and i32 %4, 30
  %shl = shl nuw nsw i32 1, %and874
  %not = xor i32 %shl, -1
  %shr876 = lshr i32 %4, 5
  %add877 = add nuw nsw i32 %shr876, 1
  %idxprom878 = zext i32 %add877 to i64
  %arrayidx879 = getelementptr inbounds i32, ptr %call852, i64 %idxprom878
  %13 = load i32, ptr %arrayidx879, align 4, !tbaa !15
  %and880 = and i32 %13, %not
  store i32 %and880, ptr %arrayidx879, align 4, !tbaa !15
  %add882 = or i32 %4, 1
  %and883 = and i32 %add882, 31
  %shl884 = shl nuw i32 1, %and883
  %14 = freeze i32 %shl884
  %not885 = xor i32 %14, -1
  %arrayidx891 = getelementptr inbounds i32, ptr %call872, i64 %idxprom878
  %15 = load i32, ptr %arrayidx891, align 4, !tbaa !15
  %and892 = and i32 %15, %not885
  store i32 %and892, ptr %arrayidx891, align 4, !tbaa !15
  %call893 = tail call i64 (...) @util_cpu_time() #9
  %16 = load ptr, ptr %PLA, align 8, !tbaa !16
  %call894 = tail call ptr (ptr, ...) @cube1list(ptr noundef %16) #9
  %call895 = tail call ptr (ptr, ptr, ...) @cofactor(ptr noundef %call894, ptr noundef %call852) #9
  call void (ptr, ptr, ptr, ...) @simp_comp(ptr noundef %call895, ptr noundef nonnull %Tplus, ptr noundef nonnull %Tplusbar) #9
  %17 = load i32, ptr @trace, align 4, !tbaa !15
  %tobool.not = icmp eq i32 %17, 0
  br i1 %tobool.not, label %if.end899, label %if.then896

if.then896:                                       ; preds = %for.end
  %18 = load ptr, ptr %Tplus, align 8, !tbaa !11
  %call897 = call i64 (...) @util_cpu_time() #9
  %sub898 = sub nsw i64 %call897, %call893
  call void (ptr, ptr, i64, ...) @print_trace(ptr noundef %18, ptr noundef nonnull @.str.4, i64 noundef %sub898) #9
  br label %if.end899

if.end899:                                        ; preds = %if.then896, %for.end
  %call901 = call i64 (...) @util_cpu_time() #9
  %19 = load ptr, ptr %PLA, align 8, !tbaa !16
  %call903 = call ptr (ptr, ...) @cube1list(ptr noundef %19) #9
  %call904 = call ptr (ptr, ptr, ...) @cofactor(ptr noundef %call903, ptr noundef nonnull %call872) #9
  call void (ptr, ptr, ptr, ...) @simp_comp(ptr noundef %call904, ptr noundef nonnull %Tminus, ptr noundef nonnull %Tminusbar) #9
  %20 = load i32, ptr @trace, align 4, !tbaa !15
  %tobool905.not = icmp eq i32 %20, 0
  br i1 %tobool905.not, label %if.end909, label %if.then906

if.then906:                                       ; preds = %if.end899
  %21 = load ptr, ptr %Tminus, align 8, !tbaa !11
  %call907 = call i64 (...) @util_cpu_time() #9
  %sub908 = sub nsw i64 %call907, %call901
  call void (ptr, ptr, i64, ...) @print_trace(ptr noundef %21, ptr noundef nonnull @.str.5, i64 noundef %sub908) #9
  br label %if.end909

if.end909:                                        ; preds = %if.then906, %if.end899
  %call911 = call i64 (...) @util_cpu_time() #9
  %22 = load ptr, ptr %Tplus, align 8, !tbaa !11
  %23 = load ptr, ptr %Tminusbar, align 8, !tbaa !11
  %call912 = call ptr (ptr, ptr, ...) @cv_intersect(ptr noundef %22, ptr noundef %23) #9
  %24 = load i32, ptr @trace, align 4, !tbaa !15
  %tobool913.not = icmp eq i32 %24, 0
  br i1 %tobool913.not, label %if.end917, label %if.then914

if.then914:                                       ; preds = %if.end909
  %call915 = call i64 (...) @util_cpu_time() #9
  %sub916 = sub nsw i64 %call915, %call911
  call void (ptr, ptr, i64, ...) @print_trace(ptr noundef %call912, ptr noundef nonnull @.str.6, i64 noundef %sub916) #9
  br label %if.end917

if.end917:                                        ; preds = %if.then914, %if.end909
  %call919 = call i64 (...) @util_cpu_time() #9
  %25 = load ptr, ptr %Tminus, align 8, !tbaa !11
  %26 = load ptr, ptr %Tplusbar, align 8, !tbaa !11
  %call920 = call ptr (ptr, ptr, ...) @cv_intersect(ptr noundef %25, ptr noundef %26) #9
  %27 = load i32, ptr @trace, align 4, !tbaa !15
  %tobool921.not = icmp eq i32 %27, 0
  br i1 %tobool921.not, label %if.end925, label %if.then922

if.then922:                                       ; preds = %if.end917
  %call923 = call i64 (...) @util_cpu_time() #9
  %sub924 = sub nsw i64 %call923, %call919
  call void (ptr, ptr, i64, ...) @print_trace(ptr noundef %call920, ptr noundef nonnull @.str.7, i64 noundef %sub924) #9
  br label %if.end925

if.end925:                                        ; preds = %if.then922, %if.end917
  %call927 = call i64 (...) @util_cpu_time() #9
  %call928 = call ptr (ptr, ptr, ...) @sf_union(ptr noundef %call912, ptr noundef %call920) #9
  %28 = load i32, ptr @trace, align 4, !tbaa !15
  %tobool929.not = icmp eq i32 %28, 0
  br i1 %tobool929.not, label %if.end933, label %if.then930

if.then930:                                       ; preds = %if.end925
  %call931 = call i64 (...) @util_cpu_time() #9
  %sub932 = sub nsw i64 %call931, %call927
  call void (ptr, ptr, i64, ...) @print_trace(ptr noundef %call928, ptr noundef nonnull @.str.8, i64 noundef %sub932) #9
  br label %if.end933

if.end933:                                        ; preds = %if.then930, %if.end925
  %call935 = call i64 (...) @util_cpu_time() #9
  %call936 = call ptr (ptr, ...) @cube1list(ptr noundef %call928) #9
  %D = getelementptr inbounds %struct.PLA_t, ptr %PLA, i64 0, i32 1
  call void (ptr, ptr, ptr, ...) @simp_comp(ptr noundef %call936, ptr noundef nonnull %D, ptr noundef nonnull %dcsetbar) #9
  %29 = load i32, ptr @trace, align 4, !tbaa !15
  %tobool937.not = icmp eq i32 %29, 0
  br i1 %tobool937.not, label %if.end942, label %if.then938

if.then938:                                       ; preds = %if.end933
  %30 = load ptr, ptr %D, align 8, !tbaa !17
  %call940 = call i64 (...) @util_cpu_time() #9
  %sub941 = sub nsw i64 %call940, %call935
  call void (ptr, ptr, i64, ...) @print_trace(ptr noundef %30, ptr noundef nonnull @.str.9, i64 noundef %sub941) #9
  br label %if.end942

if.end942:                                        ; preds = %if.then938, %if.end933
  %call944 = call i64 (...) @util_cpu_time() #9
  %31 = load ptr, ptr %PLA, align 8, !tbaa !16
  %32 = load ptr, ptr %dcsetbar, align 8, !tbaa !11
  %call946 = call ptr (ptr, ptr, ...) @cv_intersect(ptr noundef %31, ptr noundef %32) #9
  %33 = load i32, ptr @trace, align 4, !tbaa !15
  %tobool947.not = icmp eq i32 %33, 0
  br i1 %tobool947.not, label %if.end952, label %if.then948

if.then948:                                       ; preds = %if.end942
  %34 = load ptr, ptr %PLA, align 8, !tbaa !16
  %call950 = call i64 (...) @util_cpu_time() #9
  %sub951 = sub nsw i64 %call950, %call944
  call void (ptr, ptr, i64, ...) @print_trace(ptr noundef %34, ptr noundef nonnull @.str.10, i64 noundef %sub951) #9
  br label %if.end952

if.end952:                                        ; preds = %if.then948, %if.end942
  %35 = load ptr, ptr %PLA, align 8, !tbaa !16
  call void (ptr, ...) @sf_free(ptr noundef %35) #9
  store ptr %call946, ptr %PLA, align 8, !tbaa !16
  ...
  %call956 = call ptr (ptr, ...) @sf_active(ptr noundef %41) #9
  ...
  %mul960 = mul nsw i32 %45, %44
  %idx.ext = sext i32 %mul960 to i64
  %add.ptr961 = getelementptr inbounds i32, ptr %43, i64 %idx.ext
  %cmp9631129 = icmp sgt i32 %mul960, 0
  br i1 %cmp9631129, label %for.body965.lr.ph, label %for.end998

for.body965.lr.ph:                                ; preds = %if.end952
  %46 = or i32 %14, %shl
  br label %for.body965

for.body965:                                      ; preds = %for.body965.lr.ph, %for.inc993
  %47 = phi i32 [ %45, %for.body965.lr.ph ], [ %51, %for.inc993 ]
  %p.01130 = phi ptr [ %43, %for.body965.lr.ph ], [ %add.ptr997, %for.inc993 ]
  %arrayidx970 = getelementptr inbounds i32, ptr %p.01130, i64 %idxprom878
  %48 = load i32, ptr %arrayidx970, align 4, !tbaa !15
  %49 = and i32 %48, %46
  %or.cond.not = icmp eq i32 %49, %46
  br i1 %or.cond.not, label %for.inc993, label %if.then989

if.then989:                                       ; preds = %for.body965
  %50 = load i32, ptr %p.01130, align 4, !tbaa !15
  %and991 = and i32 %50, -8193
  store i32 %and991, ptr %p.01130, align 4, !tbaa !15
  %.pre = load i32, ptr %42, align 8, !tbaa !21
  br label %for.inc993

for.inc993:                                       ; preds = %for.body965, %if.then989
  %51 = phi i32 [ %47, %for.body965 ], [ %.pre, %if.then989 ]
  %idx.ext996 = sext i32 %51 to i64
  %add.ptr997 = getelementptr inbounds i32, ptr %p.01130, i64 %idx.ext996
  %cmp963 = icmp ult ptr %add.ptr997, %add.ptr961
  br i1 %cmp963, label %for.body965, label %for.end998

for.end998:                                       ; preds = %for.inc993, %if.end952
  %call1000 = call ptr (ptr, ...) @sf_inactive(ptr noundef nonnull %42) #9
  store ptr %call1000, ptr %PLA, align 8, !tbaa !16
  call void (...) @setdown_cube() #9
  %add1003 = add nuw nsw i32 %mul873, 2
  %52 = load i32, ptr @cube, align 8, !tbaa !22
  %cmp10051131 = icmp slt i32 %add1003, %52
  br i1 %cmp10051131, label %for.body1007.preheader, label %for.cond1019.preheader

for.body1007.preheader:                           ; preds = %for.end998
  ...
  %56 = add i32 %52, %55
  %57 = and i32 %indvars.iv1144, 2147483646
  %58 = sub i32 %56, %57
  %wide.trip.count1147 = zext i32 %58 to i64
  br label %for.body1007

for.cond1019.preheader:                           ; preds = %for.body1007, %for.end998
  %i.21133 = add nuw nsw i32 %div1122, 1
  %59 = load i32, ptr getelementptr inbounds (%struct.cube_struct, ptr @cube, i64 0, i32 1), align 4, !tbaa !23
  %cmp10201134 = icmp slt i32 %i.21133, %59
  br i1 %cmp10201134, label %for.body1022.lr.ph, label %for.end1030

for.body1022.lr.ph:                               ; preds = %for.cond1019.preheader
...
for.body1007:                                     ; preds = %for.body1007.preheader, %for.body1007
  %indvars.iv1141 = phi i64 [ %54, %for.body1007.preheader ], [ %indvars.iv.next1142, %for.body1007 ]
  %63 = load ptr, ptr %label, align 8, !tbaa !5
  %arrayidx1010 = getelementptr inbounds ptr, ptr %63, i64 %indvars.iv1141
  %64 = load ptr, ptr %arrayidx1010, align 8, !tbaa !11
  %65 = add nsw i64 %indvars.iv1141, -2
  %arrayidx1014 = getelementptr inbounds ptr, ptr %63, i64 %65
  store ptr %64, ptr %arrayidx1014, align 8, !tbaa !11
  %indvars.iv.next1142 = add nuw nsw i64 %indvars.iv1141, 1
  %exitcond1148.not = icmp eq i64 %indvars.iv.next1142, %wide.trip.count1147
  br i1 %exitcond1148.not, label %for.cond1019.preheader, label %for.body1007

for.body1022:                                     ; preds = %for.body1022.lr.ph, %for.body1022
  %indvars.iv1153 = phi i64 [ %61, %for.body1022.lr.ph ], [ %indvars.iv.next1154, %for.body1022 ]
  %indvars.iv1151 = phi i64 [ %62, %for.body1022.lr.ph ], [ %indvars.iv.next1152, %for.body1022 ]
  %arrayidx1024 = getelementptr inbounds i32, ptr %60, i64 %indvars.iv1151
  %66 = load i32, ptr %arrayidx1024, align 4, !tbaa !15
  %arrayidx1027 = getelementptr inbounds i32, ptr %60, i64 %indvars.iv1153
  store i32 %66, ptr %arrayidx1027, align 4, !tbaa !15
  ...
  %cmp1020 = icmp slt i64 %indvars.iv.next1152, %68
  %indvars.iv.next1154 = add nuw nsw i64 %indvars.iv1153, 1
  br i1 %cmp1020, label %for.body1022, label %for.end1030

for.end1030:                                      ; preds = %for.body1022, %for.cond1019.preheader
  %.lcssa = phi i32 [ %59, %for.cond1019.preheader ], [ %67, %for.body1022 ]
  ...
  %dec1031 = add nsw i32 %.lcssa, -1
  store i32 %dec1031, ptr getelementptr inbounds (%struct.cube_struct, ptr @cube, i64 0, i32 1), align 4, !tbaa !23
  call void (...) @cube_setup() #9
  %70 = load ptr, ptr %PLA, align 8, !tbaa !16
  %call1036 = call ptr (ptr, i32, i32, ...) @sf_delc(ptr noundef %70, i32 noundef %mul873, i32 noundef %add882) #9
  store ptr %call1036, ptr %PLA, align 8, !tbaa !16
  %71 = load ptr, ptr %D, align 8, !tbaa !17
  %call1042 = call ptr (ptr, i32, i32, ...) @sf_delc(ptr noundef %71, i32 noundef %mul873, i32 noundef %add882) #9
  store ptr %call1042, ptr %D, align 8, !tbaa !17
  br label %cleanup

cleanup:                                          ; preds = %for.inc, %for.cond.preheader, %entry, %lor.lhs.false, %for.end1030
...
for.body43:                                       ; preds = %for.cond40.preheader, %for.end71
  %p1.0202 = phi ptr [ %36, %for.end71 ], [ %list, %for.cond40.preheader ]
...
for.body48:                                       ; preds = %for.body48.preheader, %for.inc69
  %24 = phi i32 [ %21, %for.body48.preheader ], [ %34, %for.inc69 ]
...
if.then51:                                        ; preds = %for.body48
  ...
  %25 = load ptr, ptr %label, align 8, !tbaa !5
  %26 = add nsw i64 %indvars.iv212, %23
  %arrayidx56 = getelementptr inbounds ptr, ptr %25, i64 %26
  store ptr %call52, ptr %arrayidx56, align 8, !tbaa !11
  %27 = load ptr, ptr %label, align 8, !tbaa !5
  %arrayidx60 = getelementptr inbounds ptr, ptr %27, i64 %26
...
if.else62:                                        ; preds = %for.body48
  ...
  %32 = add nsw i64 %indvars.iv212, %23
  %arrayidx67 = getelementptr inbounds ptr, ptr %31, i64 %32
  ...
  %33 = load ptr, ptr %next, align 8, !tbaa !51
  br label %for.inc69

for.inc69:                                        ; preds = %if.then51, %if.else62
  %34 = phi i32 [ %.pre223, %if.then51 ], [ %24, %if.else62 ]
  %p3.1 = phi ptr [ null, %if.then51 ], [ %33, %if.else62 ]
  %indvars.iv.next213 = add nuw nsw i64 %indvars.iv212, 1
  %shl45 = shl nuw i32 1, %34
  %35 = sext i32 %shl45 to i64
  %cmp46 = icmp slt i64 %indvars.iv.next213, %35
...
for.end71:                                        ; preds = %for.inc69, %for.body43
  ...
  %36 = load ptr, ptr %next76, align 8, !tbaa !52
  %cmp41.not = icmp eq ptr %36, null
...
for.end77:                                        ; preds = %for.end77.loopexit, %for.cond40.preheader
  %37 = phi i32 [ %10, %for.cond40.preheader ], [ %.pre225, %for.end77.loopexit ]
  %38 = phi ptr [ %11, %for.cond40.preheader ], [ %.pre224, %for.end77.loopexit ]
  %base.2.lcssa = phi i32 [ %base.0.lcssa, %for.cond40.preheader ], [ %add74, %for.end77.loopexit ]
  %idxprom78 = sext i32 %37 to i64
  %arrayidx79 = getelementptr inbounds i32, ptr %38, i64 %idxprom78
  %39 = load i32, ptr %arrayidx79, align 4, !tbaa !15
  %cmp81204 = icmp slt i32 %39, %old_size
...
if.end9:                                          ; preds = %if.then6, %if.end
  ...
  %add14.op = add nuw nsw i32 %add14, 8
  %19 = select i1 %cmp12, i32 8, i32 %add14.op
...
for.body.preheader:                               ; preds = %if.end9
  ...
  %20 = icmp eq i32 %9, 1
  br i1 %20, label %for.end.loopexit.unr-lcssa, label %for.body.preheader.new
...
for.body:                                         ; preds = %for.body, %for.body.preheader.new
  ...
  %21 = load i32, ptr %arrayidx24, align 4, !tbaa !15
  %or = or i32 %21, %shl
  ...
  %22 = load i32, ptr %arrayidx24.1, align 4, !tbaa !15
  %or.1 = or i32 %22, %shl.1
...
for.body.epil:                                    ; preds = %for.end.loopexit.unr-lcssa
  ...
  %23 = load i32, ptr %arrayidx24.epil, align 4, !tbaa !15
  %or.epil = or i32 %23, %shl.epil
  store i32 %or.epil, ptr %arrayidx24.epil, align 4, !tbaa !15
  br label %for.end

for.end:                                          ; preds = %for.body.epil, %for.end.loopexit.unr-lcssa, %if.end9
  %24 = load ptr, ptr getelementptr inbounds (%struct.cube_struct, ptr @cube, i64 0, i32 3), align 8, !tbaa !31
  %25 = load i32, ptr getelementptr inbounds (%struct.cube_struct, ptr @cube, i64 0, i32 2), align 8, !tbaa !12
  %add25 = add nsw i32 %25, 1
  %idxprom26 = sext i32 %add25 to i64
  %arrayidx27 = getelementptr inbounds i32, ptr %24, i64 %idxprom26
  %26 = load i32, ptr %arrayidx27, align 4, !tbaa !15
  %27 = load i32, ptr @cube, align 8, !tbaa !22
  %cmp28 = icmp slt i32 %27, 33
  %sub32 = add nsw i32 %27, -1
  %28 = lshr i32 %sub32, 3
  %add35 = and i32 %28, 536870908
  %add35.op = add nuw nsw i32 %add35, 8
  %29 = select i1 %cmp28, i32 8, i32 %add35.op
  %mul39 = zext i32 %29 to i64
  %call40 = tail call noalias ptr @malloc(i64 noundef %mul39) #11
  %call41 = tail call ptr (ptr, i32, ...) @set_clear(ptr noundef %call40, i32 noundef %27) #9
  br i1 %cmp17541, label %for.body45.preheader, label %for.end57

for.body45.preheader:                             ; preds = %for.end
  %xtraiter583 = and i32 %9, 1
  %30 = icmp eq i32 %9, 1
  br i1 %30, label %for.end57.loopexit.unr-lcssa, label %for.body45.preheader.new
...
for.body45:                                       ; preds = %for.body45, %for.body45.preheader.new
  ...
  %31 = load i32, ptr %arrayidx53, align 4, !tbaa !15
  %or54 = or i32 %31, %shl48
  store i32 %or54, ptr %arrayidx53, align 4, !tbaa !15
  %inc56 = or i32 %i.1544, 1
  %add46.1 = add nsw i32 %inc56, %26
  ...
  %32 = load i32, ptr %arrayidx53.1, align 4, !tbaa !15
  %or54.1 = or i32 %32, %shl48.1
...
for.body45.epil:                                  ; preds = %for.end57.loopexit.unr-lcssa
  %add46.epil = add nsw i32 %i.1544.unr, %26
  ...
  %33 = load i32, ptr %arrayidx53.epil, align 4, !tbaa !15
  %or54.epil = or i32 %33, %shl48.epil
...
for.end57:                                        ; preds = %for.body45.epil, %for.end57.loopexit.unr-lcssa, %for.end
  %34 = load i32, ptr @cube, align 8, !tbaa !22
  %cmp58 = icmp slt i32 %34, 33
  %sub62 = add nsw i32 %34, -1
  %35 = lshr i32 %sub62, 3
  %add65 = and i32 %35, 536870908
  %add65.op = add nuw nsw i32 %add65, 8
  %36 = select i1 %cmp58, i32 8, i32 %add65.op
  %mul69 = zext i32 %36 to i64
  %call70 = tail call noalias ptr @malloc(i64 noundef %mul69) #11
  %call71 = tail call ptr (ptr, i32, ...) @set_clear(ptr noundef %call70, i32 noundef %34) #9
  %call72 = tail call ptr (ptr, ptr, ptr, ...) @set_or(ptr noundef %call71, ptr noundef %call41, ptr noundef %call16) #9
  %37 = load i32, ptr @cube, align 8, !tbaa !22
  %call73 = tail call ptr (i32, i32, ...) @sf_new(i32 noundef 10, i32 noundef %37) #9
...
for.body77:                                       ; preds = %for.body77.lr.ph, %for.inc145
  ...
  %call78 = tail call ptr (i32, i32, ...) @sf_new(i32 noundef 10, i32 noundef %38) #9
  %39 = load ptr, ptr %PLA, align 8, !tbaa !16
  %data = getelementptr inbounds %struct.set_family, ptr %39, i64 0, i32 5
  %40 = load ptr, ptr %data, align 8, !tbaa !18
  %count = getelementptr inbounds %struct.set_family, ptr %39, i64 0, i32 3
  %41 = load i32, ptr %count, align 4, !tbaa !20
  %42 = load i32, ptr %39, align 8, !tbaa !21
  %mul82 = mul nsw i32 %42, %41
...
for.body86:                                       ; preds = %for.body86.lr.ph, %for.inc103
  ...
  %p.0546 = phi ptr [ %40, %for.body86.lr.ph ], [ %add.ptr107, %for.inc103 ]
...
if.then88:                                        ; preds = %for.body86
  ...
  %43 = load i32, ptr %arrayidx93, align 4, !tbaa !15
  %and97 = and i32 %43, %shl96
...
for.end108:                                       ; preds = %for.inc103, %for.body77
  ...
  %46 = load i32, ptr %count109, align 4, !tbaa !20
  %cmp110 = icmp sgt i32 %46, 0
  br i1 %cmp110, label %if.then112, label %for.inc145

if.then112:                                       ; preds = %for.end108
  %47 = load i32, ptr @cube, align 8, !tbaa !22
  %call.i = tail call ptr (i32, i32, ...) @sf_new(i32 noundef 0, i32 noundef %47) #9
  ...
  %48 = load ptr, ptr %data114, align 8, !tbaa !18
  %count115 = getelementptr inbounds %struct.set_family, ptr %call3.i, i64 0, i32 3
  %49 = load i32, ptr %count115, align 4, !tbaa !20
  %50 = load i32, ptr %call3.i, align 8, !tbaa !21
  %mul117 = mul nsw i32 %50, %49
  %idx.ext118 = sext i32 %mul117 to i64
  %add.ptr119 = getelementptr inbounds i32, ptr %48, i64 %idx.ext118
...
for.body123:                                      ; preds = %for.body123.lr.ph, %for.body123
  %p.1549 = phi ptr [ %48, %for.body123.lr.ph ], [ %add.ptr136, %for.body123 ]
  %arrayidx131 = getelementptr inbounds i32, ptr %p.1549, i64 %idxprom130
  %51 = load i32, ptr %arrayidx131, align 4, !tbaa !15
  %or132 = or i32 %51, %shl126
  store i32 %or132, ptr %arrayidx131, align 4, !tbaa !15
  %52 = load i32, ptr %call3.i, align 8, !tbaa !21
  %idx.ext135 = sext i32 %52 to i64
...
for.end137:                                       ; preds = %for.end137.loopexit, %if.then112
  %53 = phi i32 [ %.pre580, %for.end137.loopexit ], [ %49, %if.then112 ]
...
if.then141:                                       ; preds = %for.end137
  %call142 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.20, i32 noundef %i.2551, i32 noundef %46, i32 noundef %53)
  br label %for.inc145
...
for.end147:                                       ; preds = %for.inc145, %for.end57
  ...
  %54 = load i32, ptr @cube, align 8, !tbaa !22
  %call148 = tail call ptr (i32, i32, ...) @sf_new(i32 noundef 10, i32 noundef %54) #9
  %55 = load ptr, ptr %PLA, align 8, !tbaa !16
  %data150 = getelementptr inbounds %struct.set_family, ptr %55, i64 0, i32 5
  %56 = load ptr, ptr %data150, align 8, !tbaa !18
  %count152 = getelementptr inbounds %struct.set_family, ptr %55, i64 0, i32 3
  %57 = load i32, ptr %count152, align 4, !tbaa !20
  %58 = load i32, ptr %55, align 8, !tbaa !21
  %mul155 = mul nsw i32 %58, %57
  %idx.ext156 = sext i32 %mul155 to i64
  %add.ptr157 = getelementptr inbounds i32, ptr %56, i64 %idx.ext156
...
for.body161:                                      ; preds = %for.end147, %for.inc167
  ...
  %p.2555 = phi ptr [ %add.ptr171, %for.inc167 ], [ %56, %for.end147 ]
...
for.inc167:                                       ; preds = %for.body161, %if.then164
  ...
  %59 = load ptr, ptr %PLA, align 8, !tbaa !16
  %60 = load i32, ptr %59, align 8, !tbaa !21
  %idx.ext170 = sext i32 %60 to i64
...
for.end172:                                       ; preds = %for.inc167, %for.end147
  ...
  %61 = load i32, ptr %count173, align 4, !tbaa !20
  %62 = load i32, ptr getelementptr inbounds (%struct.cube_struct, ptr @cube, i64 0, i32 2), align 8, !tbaa !12
  %call174 = tail call ptr (ptr, i32, i32, ...) @unravel_range(ptr noundef %go_nowhere.0.lcssa, i32 noundef %62, i32 noundef %62) #9
  %count175 = getelementptr inbounds %struct.set_family, ptr %call174, i64 0, i32 3
  %63 = load i32, ptr %count175, align 4, !tbaa !20
...
if.then178:                                       ; preds = %for.end172
  %call179 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.21, i32 noundef %61, i32 noundef %63)
  br label %if.end180
...
for.body188.us:                                   ; preds = %for.cond185.preheader.us, %for.inc316.us
  ...
  %64 = load i32, ptr @cube, align 8, !tbaa !22
  %call189.us = tail call ptr (i32, i32, ...) @sf_new(i32 noundef 10, i32 noundef %64) #9
  %65 = load ptr, ptr %PLA, align 8, !tbaa !16
  %data191.us = getelementptr inbounds %struct.set_family, ptr %65, i64 0, i32 5
  %66 = load ptr, ptr %data191.us, align 8, !tbaa !18
  %count193.us = getelementptr inbounds %struct.set_family, ptr %65, i64 0, i32 3
  %67 = load i32, ptr %count193.us, align 4, !tbaa !20
  %68 = load i32, ptr %65, align 8, !tbaa !21
  %mul196.us = mul nsw i32 %68, %67
  %idx.ext197.us = sext i32 %mul196.us to i64
  %add.ptr198.us = getelementptr inbounds i32, ptr %66, i64 %idx.ext197.us
...
for.end279.us:                                    ; preds = %for.inc274.us, %for.body188.us
  ...
  %69 = load i32, ptr %count280.us, align 4, !tbaa !20
  %cmp281.us = icmp sgt i32 %69, 0
  br i1 %cmp281.us, label %if.then283.us, label %for.inc316.us

if.then283.us:                                    ; preds = %for.end279.us
  %70 = load i32, ptr @cube, align 8, !tbaa !22
  %call.i537.us = tail call ptr (i32, i32, ...) @sf_new(i32 noundef 0, i32 noundef %70) #9
  ...
  %71 = load ptr, ptr %data285.us, align 8, !tbaa !18
  %count286.us = getelementptr inbounds %struct.set_family, ptr %call3.i540.us, i64 0, i32 3
  %72 = load i32, ptr %count286.us, align 4, !tbaa !20
  %73 = load i32, ptr %call3.i540.us, align 8, !tbaa !21
  %mul288.us = mul nsw i32 %73, %72
  %idx.ext289.us = sext i32 %mul288.us to i64
  %add.ptr290.us = getelementptr inbounds i32, ptr %71, i64 %idx.ext289.us
...
for.end308.us:                                    ; preds = %for.end308.us.loopexit, %if.then283.us
  %74 = phi i32 [ %.pre581, %for.end308.us.loopexit ], [ %72, %if.then283.us ]
...
if.then312.us:                                    ; preds = %for.end308.us
  %call313.us = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.22, i32 noundef %i.3569.us, i32 noundef %j.0565.us, i32 noundef %69, i32 noundef %74)
...
for.body294.us:                                   ; preds = %for.body294.lr.ph.us, %for.body294.us
  %p.4563.us = phi ptr [ %71, %for.body294.lr.ph.us ], [ %add.ptr307.us, %for.body294.us ]
  %arrayidx302.us = getelementptr inbounds i32, ptr %p.4563.us, i64 %idxprom301.us
  %75 = load i32, ptr %arrayidx302.us, align 4, !tbaa !15
  %or303.us = or i32 %75, %shl297.us
  store i32 %or303.us, ptr %arrayidx302.us, align 4, !tbaa !15
  %76 = load i32, ptr %call3.i540.us, align 8, !tbaa !21
  %idx.ext306.us = sext i32 %76 to i64
...
for.body202.us:                                   ; preds = %for.body202.lr.ph.us, %for.inc274.us
  ...
  %p.3559.us = phi ptr [ %66, %for.body202.lr.ph.us ], [ %add.ptr278.us, %for.inc274.us ]
...
if.then205.us:                                    ; preds = %for.body202.us
  ...
  %77 = load i32, ptr %arrayidx210.us, align 4, !tbaa !15
  %and214.us = and i32 %77, %shl213.us
...
if.then216.us:                                    ; preds = %if.then205.us
  ...
  %78 = load i32, ptr %arrayidx221.us, align 4, !tbaa !15
  %and225.us = and i32 %78, %shl224.us
...
if.then269.us:                                    ; preds = %if.then216.us
  %79 = load i32, ptr %p.3559.us, align 4, !tbaa !15
  %and229.us = shl i32 %79, 5
  %mul230.us = and i32 %and229.us, 32736
  %cmp231.us = icmp ult i32 %mul230.us, 33
  %sub238.us = add nsw i32 %mul230.us, -1
  %80 = lshr i32 %sub238.us, 3
  %add241.us = and i32 %80, 536870908
  %add241.op.us = add nuw nsw i32 %add241.us, 8
  %81 = select i1 %cmp231.us, i32 8, i32 %add241.op.us
  %mul245.us = zext i32 %81 to i64
  ...
  %82 = load i32, ptr %arrayidx256.us, align 4, !tbaa !15
  %or257.us = or i32 %82, %shl213.us
  ...
  %83 = load i32, ptr %arrayidx265.us, align 4, !tbaa !15
  %or266.us = or i32 %83, %shl224.us
...
for.inc274.us:                                    ; preds = %if.then269.us, %if.then216.us, %if.then205.us, %for.body202.us
  ...
  %84 = load ptr, ptr %PLA, align 8, !tbaa !16
  %85 = load i32, ptr %84, align 8, !tbaa !21
  %idx.ext277.us = sext i32 %85 to i64
...
for.body202.lr.ph.us:                             ; preds = %for.body188.us
  %add217.us = add nsw i32 %j.0565.us, %26
...
for.body294.lr.ph.us:                             ; preds = %if.then283.us
  %add295.us = add nsw i32 %j.0565.us, %26
...
if.end330:                                        ; preds = %if.then329, %if.end327
  %86 = load ptr, ptr %PLA, align 8, !tbaa !16
  tail call void (ptr, ...) @sf_free(ptr noundef %86) #9
  store ptr %F.2.lcssa, ptr %PLA, align 8, !tbaa !16
  %D = getelementptr inbounds %struct.PLA_t, ptr %PLA, i64 0, i32 1
  %87 = load ptr, ptr %D, align 8, !tbaa !17
  tail call void (ptr, ...) @sf_free(ptr noundef %87) #9
  %88 = load i32, ptr @cube, align 8, !tbaa !22
  %call333 = tail call ptr (i32, i32, ...) @sf_new(i32 noundef 0, i32 noundef %88) #9
  store ptr %call333, ptr %D, align 8, !tbaa !17
  tail call void (...) @setdown_cube() #9
  %89 = load ptr, ptr getelementptr inbounds (%struct.cube_struct, ptr @cube, i64 0, i32 5), align 8, !tbaa !24
  %tobool335.not = icmp eq ptr %89, null
...
if.end337:                                        ; preds = %if.then336, %if.end330
  ...
  %data352 = getelementptr inbounds %struct.set_family, ptr %90, i64 0, i32 5
  %91 = load ptr, ptr %data352, align 8, !tbaa !18
  %count354 = getelementptr inbounds %struct.set_family, ptr %90, i64 0, i32 3
  %92 = load i32, ptr %count354, align 4, !tbaa !20
  %93 = load i32, ptr %90, align 8, !tbaa !21
  %mul357 = mul nsw i32 %93, %92
  %idx.ext358 = sext i32 %mul357 to i64
  %add.ptr359 = getelementptr inbounds i32, ptr %91, i64 %idx.ext358
  %cmp361572 = icmp sgt i32 %mul357, 0
  br i1 %cmp361572, label %for.body363, label %for.end370

for.body363:                                      ; preds = %if.end337, %for.body363
  %p.5573 = phi ptr [ %add.ptr369, %for.body363 ], [ %91, %if.end337 ]
  %94 = load ptr, ptr @stdout, align 8, !tbaa !11
  %call364 = tail call i32 (ptr, ptr, ptr, ptr, ...) @kiss_print_cube(ptr noundef %94, ptr noundef nonnull %PLA, ptr noundef %p.5573, ptr noundef nonnull @.str.23) #9
  %95 = load ptr, ptr %PLA, align 8, !tbaa !16
  %96 = load i32, ptr %95, align 8, !tbaa !21
  %idx.ext368 = sext i32 %96 to i64
