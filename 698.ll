; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_upx.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_upx.c"
...
doubleebx.exit:                                   ; preds = %while.cond1, %if.end.i
  ...
  %cond = icmp slt i32 %oldebx.0.i, 0
  br i1 %cond, label %while.body2, label %while.cond11.preheader
...
while.end152:                                     ; preds = %if.end28
  ...
  %call153 = tail call fastcc i32 @pefromupx(ptr noundef nonnull %src, i32 noundef %ssize, ptr noundef %dst, ptr noundef %dsize, i32 noundef %ep, i32 noundef %upx0, i32 noundef %upx1, ptr noundef nonnull @__const.upx_inflate2b.magic, i32 noundef %61)
  br label %cleanup
...
if.then50:                                        ; preds = %land.lhs.true45
  ...
  %9 = sub i64 2, %8
  %sub56 = add i64 %9, %sub.ptr.lhs.cast51
  %10 = trunc i64 %sub56 to i32
...
if.else:                                          ; preds = %if.then101
  ...
  %or.cond559670 = select i1 %cmp123, i1 true, i1 %cmp126.not669
...
while.cond167.preheader:                          ; preds = %land.rhs161
  %uglygep = getelementptr i8, ptr %pehdr.1665, i64 1
  %cmp174.not = icmp uge ptr %uglygep, %dst
...
while.body216.us.preheader:                       ; preds = %while.body216.lr.ph
  ...
  %21 = sub i64 0, %20
  %uglygep716 = getelementptr i8, ptr %dst, i64 %21
...
while.end222:                                     ; preds = %if.end220, %land.lhs.true36.i605, %while.body216.us.preheader
  %pehdr.4.lcssa = phi ptr [ %uglygep716, %while.body216.us.preheader ], [ %pehdr.4680, %land.lhs.true36.i605 ], [ %incdec.ptr221, %if.end220 ]
...
for.body345.lr.ph.new:                            ; preds = %for.body345.lr.ph
  ...
  %add.ptr353733 = getelementptr i8, ptr %dst, i64 %idx.neg355
  %add.ptr353733.1 = getelementptr i8, ptr %dst, i64 %idx.neg355
...
for.body345:                                      ; preds = %for.body345, %for.body345.lr.ph.new
  ...
  %add.ptr356 = getelementptr i8, ptr %add.ptr353733, i64 %idx.ext352
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %add.ptr349, ptr align 1 %add.ptr356, i64 %conv359, i1 false)
  ...
  %add.ptr356.1 = getelementptr i8, ptr %add.ptr353733.1, i64 %idx.ext352.1
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %add.ptr349.1, ptr align 1 %add.ptr356.1, i64 %conv359.1, i1 false)
...
for.body345.epil:                                 ; preds = %for.end363.loopexit.unr-lcssa
  ...
  %add.ptr353733.epil = getelementptr i8, ptr %dst, i64 %idx.neg355
  %add.ptr356.epil = getelementptr i8, ptr %add.ptr353733.epil, i64 %idx.ext352.epil
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %add.ptr349.epil, ptr align 1 %add.ptr356.epil, i64 %conv359.epil, i1 false)
  br label %for.end363
...
while.end158:                                     ; preds = %if.end34
  ...
  %call159 = tail call fastcc i32 @pefromupx(ptr noundef nonnull %src, i32 noundef %ssize, ptr noundef %dst, ptr noundef %dsize, i32 noundef %ep, i32 noundef %upx0, i32 noundef %upx1, ptr noundef nonnull @__const.upx_inflate2d.magic, i32 noundef %59)
  br label %cleanup
...
for.end169:                                       ; preds = %if.end30
  %59 = trunc i64 %indvars.iv to i32
  %call170 = tail call fastcc i32 @pefromupx(ptr noundef nonnull %src, i32 noundef %ssize, ptr noundef %dst, ptr noundef %dsize, i32 noundef %ep, i32 noundef %upx0, i32 noundef %upx1, ptr noundef nonnull @__const.upx_inflate2e.magic, i32 noundef %59)
  br label %cleanup
