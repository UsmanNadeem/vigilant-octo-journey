; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/uloop.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/uloop.c"
...
if.end54:                                         ; preds = %if.then50.us
  ...
  %22 = load i32, ptr @blockl, align 4, !tbaa !5
  ...
  %24 = load i32, ptr @blockb, align 4, !tbaa !5
...
entry:
  ...
  %sub7 = sub i32 1, %div
  %add = add i32 %sub7, %div2
  %sub8 = sub i32 1, %div4
  %add9 = add i32 %sub8, %div6
