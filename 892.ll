; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/jdphuff.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/jdphuff.c"
...
entry:
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %uglygep, i8 0, i64 32, i1 false), !tbaa !22
...
for.cond14.preheader:                             ; preds = %entry, %for.cond14.preheader
  ...
  %coef_bit_ptr.043 = phi ptr [ %uglygep46, %for.cond14.preheader ], [ %call5, %entry ]
  ...
  %uglygep46 = getelementptr i8, ptr %coef_bit_ptr.043, i64 256
