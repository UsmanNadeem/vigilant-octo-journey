; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/7z/7zHandlerOut.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/7z/7zHandlerOut.cpp"
...
if.end270:                                        ; preds = %cleanup.cont260
  %.pre1114 = load i8, ptr %AttribDefined89, align 8
...
invoke.cont446:                                   ; preds = %if.end412, %if.then418, %_ZN11CStringBaseIwEaSERKS0_.exit908, %if.end412.thread
  ...
  %191 = load i8, ptr %_autoFilter, align 8
...
for.cond.preheader:                               ; preds = %invoke.cont
  %cmp.not95 = icmp sgt i32 %numProperties, 0
  br i1 %cmp.not95, label %for.body.lr.ph, label %return
...
if.then4.i:                                       ; preds = %if.then15
  %spec.select.i = call i32 @llvm.smin.i32(i32 %9, i32 1)
  %idx.ext3.i.i = zext i32 %spec.select.i to i64
  %add.ptr4.i.i = getelementptr inbounds i32, ptr %12, i64 %idx.ext3.i.i
  ...
  %sub7.i = sub nsw i32 %14, %spec.select.i
...
invoke.cont16:                                    ; preds = %if.then4.i, %if.then15
  ...
  %call.i86 = invoke fastcc noundef i32 @_ZN8NArchive3N7zL15GetBindInfoPartER11CStringBaseIwERjS4_(ptr noundef nonnull align 8 dereferenceable(16) %name, ptr noundef nonnull align 4 dereferenceable(4) %OutCoder.i, ptr noundef nonnull align 4 dereferenceable(4) %OutStream.i)
          to label %call.i.noexc unwind label %lpad18

call.i.noexc:                                     ; preds = %invoke.cont16
  %cmp.not.not.i = icmp eq i32 %call.i86, 0
  br i1 %cmp.not.not.i, label %cleanup.cont.i, label %cleanup28

cleanup.cont.i:                                   ; preds = %call.i.noexc
  %15 = load ptr, ptr %name, align 8, !tbaa !28
  %16 = load i32, ptr %15, align 4, !tbaa !32
  %cmp2.not.i = icmp eq i32 %16, 58
...
if.end4.i:                                        ; preds = %cleanup.cont.i
  ...
  br i1 %cmp3.i.i, label %if.then4.i.i, label %_ZN11CStringBaseIwE6DeleteEii.exit.i

if.then4.i.i:                                     ; preds = %if.end4.i
  %spec.select.i.i = call i32 @llvm.smin.i32(i32 %17, i32 1)
  %idx.ext3.i.i.i = zext i32 %spec.select.i.i to i64
  %add.ptr4.i.i.i = getelementptr inbounds i32, ptr %15, i64 %idx.ext3.i.i.i
  %conv.i.i.i = zext i32 %17 to i64
  %mul.i.i.i = shl nuw nsw i64 %conv.i.i.i, 2
  call void @llvm.memmove.p0.p0.i64(ptr nonnull align 4 %15, ptr nonnull align 4 %add.ptr4.i.i.i, i64 %mul.i.i.i, i1 false)
  %18 = load i32, ptr %_length.i, align 8, !tbaa !31
  %sub7.i.i = sub nsw i32 %18, %spec.select.i.i
  store i32 %sub7.i.i, ptr %_length.i, align 8, !tbaa !31
  br label %_ZN11CStringBaseIwE6DeleteEii.exit.i

_ZN11CStringBaseIwE6DeleteEii.exit.i:             ; preds = %if.then4.i.i, %if.end4.i
  %call7.i87 = invoke fastcc noundef i32 @_ZN8NArchive3N7zL15GetBindInfoPartER11CStringBaseIwERjS4_(ptr noundef nonnull align 8 dereferenceable(16) %name, ptr noundef nonnull align 4 dereferenceable(4) %bind, ptr noundef nonnull align 4 dereferenceable(4) %InStream.i)
          to label %call7.i.noexc unwind label %lpad18

call7.i.noexc:                                    ; preds = %_ZN11CStringBaseIwE6DeleteEii.exit.i
  %cmp8.not.not.i = icmp eq i32 %call7.i87, 0
  br i1 %cmp8.not.not.i, label %cleanup.cont13.i, label %cleanup28

cleanup.cont13.i:                                 ; preds = %call7.i.noexc
  %19 = load i32, ptr %_length.i, align 8, !tbaa !31
  %cmp.i29.i = icmp eq i32 %19, 0
  br i1 %cmp.i29.i, label %cleanup.cont, label %cleanup28

lpad18:                                           ; preds = %_ZN11CStringBaseIwE6DeleteEii.exit.i, %invoke.cont16
  %20 = landingpad { ptr, i32 }
          catch ptr @_ZTIPKc
          catch ptr null
  br label %ehcleanup
...
cleanup.cont:                                     ; preds = %cleanup.cont13.i
  %21 = load <2 x i64>, ptr %bind, align 16
...
_ZN13CRecordVectorIN8NArchive3N7z5CBindEE3AddES2_.exit: ; preds = %cleanup.cont
  %22 = load ptr, ptr %_items.i, align 8, !tbaa !19
  %23 = load i32, ptr %_size.i, align 4, !tbaa !18
  %idxprom.i = sext i32 %23 to i64
  %arrayidx.i = getelementptr inbounds %"struct.NArchive::N7z::CBind", ptr %22, i64 %idxprom.i
  store <2 x i64> %21, ptr %arrayidx.i, align 4
  %24 = load i32, ptr %_size.i, align 4, !tbaa !18
...
cleanup28:                                        ; preds = %call.i.noexc, %call7.i.noexc, %cleanup.cont.i, %cleanup.cont13.i, %_ZN13CRecordVectorIN8NArchive3N7z5CBindEE3AddES2_.exit
  %retval.0.call2094 = phi i32 [ %retval.097, %_ZN13CRecordVectorIN8NArchive3N7z5CBindEE3AddES2_.exit ], [ -2147024809, %cleanup.cont13.i ], [ -2147024809, %cleanup.cont.i ], [ %call7.i87, %call7.i.noexc ], [ %call.i86, %call.i.noexc ]
  %cleanup.dest.slot.1 = phi i32 [ 4, %_ZN13CRecordVectorIN8NArchive3N7z5CBindEE3AddES2_.exit ], [ 1, %cleanup.cont13.i ], [ 1, %cleanup.cont.i ], [ 1, %call7.i.noexc ], [ 1, %call.i.noexc ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %bind) #16
  br label %cleanup46

ehcleanup:                                        ; preds = %lpad25, %lpad18
  %.pn = phi { ptr, i32 } [ %25, %lpad25 ], [ %20, %lpad18 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %bind) #16
  br label %ehcleanup47
...
cleanup46:                                        ; preds = %cleanup28, %invoke.cont35, %invoke.cont6
  ...
  %retval.4 = phi i32 [ -2147024809, %invoke.cont6 ], [ %retval.0.call2094, %cleanup28 ], [ %retval.0.call36, %invoke.cont35 ]
  %27 = load ptr, ptr %name, align 8, !tbaa !28
...
ehcleanup47:                                      ; preds = %ehcleanup, %lpad32, %lpad5
  %.pn.pn.pn = phi { ptr, i32 } [ %11, %lpad5 ], [ %.pn, %ehcleanup ], [ %26, %lpad32 ]
  %28 = load ptr, ptr %name, align 8, !tbaa !28
  %isnull.i88 = icmp eq ptr %28, null
  br i1 %isnull.i88, label %ehcleanup51, label %delete.notnull.i89

delete.notnull.i89:                               ; preds = %ehcleanup47
  call void @_ZdaPv(ptr noundef nonnull %28) #18
  br label %ehcleanup51

ehcleanup51:                                      ; preds = %delete.notnull.i89, %ehcleanup47, %lpad3
  %.pn.pn.pn.pn = phi { ptr, i32 } [ %10, %lpad3 ], [ %.pn.pn.pn, %ehcleanup47 ], [ %.pn.pn.pn, %delete.notnull.i89 ]
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %name) #16
  br label %catch.dispatch
  ...
  %29 = call i32 @llvm.eh.typeid.for(ptr nonnull @_ZTIPKc) #16
  %matches = icmp eq i32 %ehselector.slot.4, %29
  %30 = call ptr @__cxa_begin_catch(ptr %exn.slot.4) #16
  br i1 %matches, label %catch56, label %catch

catch56:                                          ; preds = %catch.dispatch
  %exception = call ptr @__cxa_allocate_exception(i64 8) #16
  store ptr %30, ptr %exception, align 16, !tbaa !41
  invoke void @__cxa_throw(ptr nonnull %exception, ptr nonnull @_ZTIPKc, ptr null) #20
...
; Function Attrs: mustprogress uwtable
define internal fastcc noundef i32 @_ZN8NArchive3N7zL15GetBindInfoPartER11CStringBaseIwERjS4_(ptr noundef nonnull align 8 dereferenceable(16) %srcString, ptr noundef nonnull align 4 dereferenceable(4) %coder, ptr noundef nonnull align 4 dereferenceable(4) %stream) unnamed_addr #6 {
entry:
  store i32 0, ptr %stream, align 4, !tbaa !5
  %call = tail call noundef i32 @_Z19ParseStringToUInt32RK11CStringBaseIwERj(ptr noundef nonnull align 8 dereferenceable(16) %srcString, ptr noundef nonnull align 4 dereferenceable(4) %coder)
  %cmp = icmp eq i32 %call, 0
  br i1 %cmp, label %cleanup13, label %if.end

if.end:                                           ; preds = %entry
  %_length.i = getelementptr inbounds %class.CStringBase, ptr %srcString, i64 0, i32 1
  %0 = load i32, ptr %_length.i, align 8, !tbaa !31
  %spec.select.i = tail call i32 @llvm.smin.i32(i32 %call, i32 %0)
...
if.then4.i:                                       ; preds = %if.end
  %1 = load ptr, ptr %srcString, align 8, !tbaa !28
  %idx.ext3.i.i = zext i32 %spec.select.i to i64
  %add.ptr4.i.i = getelementptr inbounds i32, ptr %1, i64 %idx.ext3.i.i
  %sub.i.i = add i32 %0, 1
  %add.i.i = sub i32 %sub.i.i, %spec.select.i
  %conv.i.i = sext i32 %add.i.i to i64
  %mul.i.i = shl nsw i64 %conv.i.i, 2
  tail call void @llvm.memmove.p0.p0.i64(ptr align 4 %1, ptr nonnull align 4 %add.ptr4.i.i, i64 %mul.i.i, i1 false)
  %2 = load i32, ptr %_length.i, align 8, !tbaa !31
  %sub7.i = sub nsw i32 %2, %spec.select.i
  store i32 %sub7.i, ptr %_length.i, align 8, !tbaa !31
  br label %_ZN11CStringBaseIwE6DeleteEii.exit

_ZN11CStringBaseIwE6DeleteEii.exit:               ; preds = %if.end, %if.then4.i
  %3 = phi i32 [ %0, %if.end ], [ %sub7.i, %if.then4.i ]
  %4 = load ptr, ptr %srcString, align 8, !tbaa !28
  %5 = load i32, ptr %4, align 4, !tbaa !32
  %cmp3 = icmp eq i32 %5, 83
  br i1 %cmp3, label %if.then4, label %cleanup13

if.then4:                                         ; preds = %_ZN11CStringBaseIwE6DeleteEii.exit
  %cmp3.i25 = icmp sgt i32 %3, 0
  br i1 %cmp3.i25, label %if.then4.i33, label %_ZN11CStringBaseIwE6DeleteEii.exit34

if.then4.i33:                                     ; preds = %if.then4
  %spec.select.i24 = tail call i32 @llvm.smin.i32(i32 %3, i32 1)
  %idx.ext3.i.i26 = zext i32 %spec.select.i24 to i64
  %add.ptr4.i.i27 = getelementptr inbounds i32, ptr %4, i64 %idx.ext3.i.i26
  %conv.i.i30 = zext i32 %3 to i64
  %mul.i.i31 = shl nuw nsw i64 %conv.i.i30, 2
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 4 %4, ptr nonnull align 4 %add.ptr4.i.i27, i64 %mul.i.i31, i1 false)
  %6 = load i32, ptr %_length.i, align 8, !tbaa !31
  %sub7.i32 = sub nsw i32 %6, %spec.select.i24
  store i32 %sub7.i32, ptr %_length.i, align 8, !tbaa !31
  br label %_ZN11CStringBaseIwE6DeleteEii.exit34

_ZN11CStringBaseIwE6DeleteEii.exit34:             ; preds = %if.then4, %if.then4.i33
  %call7 = tail call noundef i32 @_Z19ParseStringToUInt32RK11CStringBaseIwERj(ptr noundef nonnull align 8 dereferenceable(16) %srcString, ptr noundef nonnull align 4 dereferenceable(4) %stream)
  %cmp8.not = icmp eq i32 %call7, 0
  br i1 %cmp8.not, label %cleanup13, label %if.end10

if.end10:                                         ; preds = %_ZN11CStringBaseIwE6DeleteEii.exit34
  %7 = load i32, ptr %_length.i, align 8, !tbaa !31
  %spec.select.i37 = tail call i32 @llvm.smin.i32(i32 %call7, i32 %7)
  %cmp3.i38 = icmp sgt i32 %spec.select.i37, 0
  br i1 %cmp3.i38, label %if.then4.i46, label %cleanup13

if.then4.i46:                                     ; preds = %if.end10
  %8 = load ptr, ptr %srcString, align 8, !tbaa !28
  %idx.ext3.i.i39 = zext i32 %spec.select.i37 to i64
  %add.ptr4.i.i40 = getelementptr inbounds i32, ptr %8, i64 %idx.ext3.i.i39
  %sub.i.i41 = add i32 %7, 1
  %add.i.i42 = sub i32 %sub.i.i41, %spec.select.i37
  %conv.i.i43 = sext i32 %add.i.i42 to i64
  %mul.i.i44 = shl nsw i64 %conv.i.i43, 2
  tail call void @llvm.memmove.p0.p0.i64(ptr align 4 %8, ptr nonnull align 4 %add.ptr4.i.i40, i64 %mul.i.i44, i1 false)
  %9 = load i32, ptr %_length.i, align 8, !tbaa !31
  %sub7.i45 = sub nsw i32 %9, %spec.select.i37
  store i32 %sub7.i45, ptr %_length.i, align 8, !tbaa !31
  br label %cleanup13

cleanup13:                                        ; preds = %if.then4.i46, %if.end10, %_ZN11CStringBaseIwE6DeleteEii.exit, %_ZN11CStringBaseIwE6DeleteEii.exit34, %entry
  %retval.1 = phi i32 [ -2147024809, %entry ], [ -2147024809, %_ZN11CStringBaseIwE6DeleteEii.exit34 ], [ 0, %_ZN11CStringBaseIwE6DeleteEii.exit ], [ 0, %if.end10 ], [ 0, %if.then4.i46 ]
  ret i32 %retval.1
}
