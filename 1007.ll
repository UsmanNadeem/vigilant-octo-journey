; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniAMR/move.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/miniAMR/move.c"
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc239
  ...
  %3 = phi i32 [ %1, %for.body.lr.ph ], [ %124, %for.inc239 ]
...
if.then113:                                       ; preds = %land.lhs.true
  ...
  %76 = load double, ptr %arrayidx37, align 8, !tbaa !13
  %77 = extractelement <2 x double> %70, i64 1
  %add150 = fadd double %77, %76
  store double %add150, ptr %arrayidx37, align 8, !tbaa !13
  %78 = load i32, ptr @z_block_size, align 4, !tbaa !5
  %conv152 = sitofp i32 %78 to double
  %div153 = fdiv double %conv119, %conv152
  %79 = load i32, ptr getelementptr inbounds ([3 x i32], ptr @mesh_size, i64 0, i64 2), align 4, !tbaa !5
  %conv154 = sitofp i32 %79 to double
  %div155 = fdiv double %div153, %conv154
  %80 = load double, ptr %arrayidx44, align 16, !tbaa !13
  %sub158 = fsub double %80, %div155
  store double %sub158, ptr %arrayidx44, align 16, !tbaa !13
  %81 = load double, ptr %arrayidx53, align 8, !tbaa !13
  %add166 = fadd double %div155, %81
...
if.end174:                                        ; preds = %if.end174thread-pre-split, %land.lhs.true
  %82 = phi i32 [ %.pr, %if.end174thread-pre-split ], [ 0, %land.lhs.true ]
  %83 = load i32, ptr @num_refine, align 4, !tbaa !5
  %cmp176 = icmp eq i32 %82, %83
  %refine179 = getelementptr inbounds %struct.block, ptr %6, i64 %idxprom4, i32 2
  %84 = load i32, ptr %refine179, align 8, !tbaa !22
  %cmp180 = icmp eq i32 %84, 1
  %or.cond = select i1 %cmp176, i1 %cmp180, i1 false
  %tobool183.not = icmp eq i32 %84, 0
...
if.then184:                                       ; preds = %if.end174
  ...
  %85 = load i32, ptr %parent, align 8, !tbaa !23
  %cmp186.not = icmp eq i32 %85, -1
...
land.lhs.true188:                                 ; preds = %if.then184
  ...
  %86 = load i32, ptr %parent_node, align 4, !tbaa !24
  %87 = load i32, ptr @my_pe, align 4, !tbaa !5
  %cmp189 = icmp eq i32 %86, %87
  br i1 %cmp189, label %if.then191, label %if.end228

if.then191:                                       ; preds = %land.lhs.true188
  %88 = load ptr, ptr @parents, align 8, !tbaa !9
  %idxprom193 = sext i32 %85 to i64
  %refine195 = getelementptr inbounds %struct.parent, ptr %88, i64 %idxprom193, i32 5
  store i32 0, ptr %refine195, align 4, !tbaa !25
  %89 = load ptr, ptr @blocks, align 8
  %arrayidx201 = getelementptr inbounds %struct.parent, ptr %88, i64 %idxprom193, i32 7, i64 0
  %90 = load i32, ptr %arrayidx201, align 4, !tbaa !5
  %91 = load i32, ptr @my_pe, align 4, !tbaa !5
  %cmp202 = icmp eq i32 %90, %91
  br i1 %cmp202, label %land.lhs.true204, label %for.inc

land.lhs.true204:                                 ; preds = %if.then191
  %arrayidx206 = getelementptr inbounds %struct.parent, ptr %88, i64 %idxprom193, i32 6, i64 0
  %92 = load i32, ptr %arrayidx206, align 4, !tbaa !5
  %cmp207 = icmp sgt i32 %92, -1
  br i1 %cmp207, label %if.then209, label %for.inc

if.then209:                                       ; preds = %land.lhs.true204
  %idxprom213 = zext i32 %92 to i64
  %refine215 = getelementptr inbounds %struct.block, ptr %89, i64 %idxprom213, i32 2
  %93 = load i32, ptr %refine215, align 8, !tbaa !22
  %cmp216 = icmp eq i32 %93, -1
...
for.inc:                                          ; preds = %if.then191, %land.lhs.true204, %if.then218, %if.then209
  %94 = phi i32 [ %91, %if.then191 ], [ %90, %land.lhs.true204 ], [ %.pre300, %if.then218 ], [ %90, %if.then209 ]
  %arrayidx201.1 = getelementptr inbounds %struct.parent, ptr %88, i64 %idxprom193, i32 7, i64 1
  %95 = load i32, ptr %arrayidx201.1, align 4, !tbaa !5
  %cmp202.1 = icmp eq i32 %95, %94
  br i1 %cmp202.1, label %land.lhs.true204.1, label %for.inc.1

land.lhs.true204.1:                               ; preds = %for.inc
  %arrayidx206.1 = getelementptr inbounds %struct.parent, ptr %88, i64 %idxprom193, i32 6, i64 1
  %96 = load i32, ptr %arrayidx206.1, align 4, !tbaa !5
  %cmp207.1 = icmp sgt i32 %96, -1
  br i1 %cmp207.1, label %if.then209.1, label %for.inc.1

if.then209.1:                                     ; preds = %land.lhs.true204.1
  %idxprom213.1 = zext i32 %96 to i64
  %refine215.1 = getelementptr inbounds %struct.block, ptr %89, i64 %idxprom213.1, i32 2
  %97 = load i32, ptr %refine215.1, align 8, !tbaa !22
  %cmp216.1 = icmp eq i32 %97, -1
...
for.inc.1:                                        ; preds = %if.then218.1, %if.then209.1, %land.lhs.true204.1, %for.inc
  %98 = phi i32 [ %.pre301, %if.then218.1 ], [ %94, %if.then209.1 ], [ %94, %land.lhs.true204.1 ], [ %94, %for.inc ]
  %arrayidx201.2 = getelementptr inbounds %struct.parent, ptr %88, i64 %idxprom193, i32 7, i64 2
  %99 = load i32, ptr %arrayidx201.2, align 4, !tbaa !5
  %cmp202.2 = icmp eq i32 %99, %98
  br i1 %cmp202.2, label %land.lhs.true204.2, label %for.inc.2

land.lhs.true204.2:                               ; preds = %for.inc.1
  %arrayidx206.2 = getelementptr inbounds %struct.parent, ptr %88, i64 %idxprom193, i32 6, i64 2
  %100 = load i32, ptr %arrayidx206.2, align 4, !tbaa !5
  %cmp207.2 = icmp sgt i32 %100, -1
  br i1 %cmp207.2, label %if.then209.2, label %for.inc.2

if.then209.2:                                     ; preds = %land.lhs.true204.2
  %idxprom213.2 = zext i32 %100 to i64
  %refine215.2 = getelementptr inbounds %struct.block, ptr %89, i64 %idxprom213.2, i32 2
  %101 = load i32, ptr %refine215.2, align 8, !tbaa !22
  %cmp216.2 = icmp eq i32 %101, -1
...
for.inc.2:                                        ; preds = %if.then218.2, %if.then209.2, %land.lhs.true204.2, %for.inc.1
  %102 = phi i32 [ %.pre302, %if.then218.2 ], [ %98, %if.then209.2 ], [ %98, %land.lhs.true204.2 ], [ %98, %for.inc.1 ]
  %arrayidx201.3 = getelementptr inbounds %struct.parent, ptr %88, i64 %idxprom193, i32 7, i64 3
  %103 = load i32, ptr %arrayidx201.3, align 4, !tbaa !5
  %cmp202.3 = icmp eq i32 %103, %102
  br i1 %cmp202.3, label %land.lhs.true204.3, label %for.inc.3

land.lhs.true204.3:                               ; preds = %for.inc.2
  %arrayidx206.3 = getelementptr inbounds %struct.parent, ptr %88, i64 %idxprom193, i32 6, i64 3
  %104 = load i32, ptr %arrayidx206.3, align 4, !tbaa !5
  %cmp207.3 = icmp sgt i32 %104, -1
  br i1 %cmp207.3, label %if.then209.3, label %for.inc.3

if.then209.3:                                     ; preds = %land.lhs.true204.3
  %idxprom213.3 = zext i32 %104 to i64
  %refine215.3 = getelementptr inbounds %struct.block, ptr %89, i64 %idxprom213.3, i32 2
  %105 = load i32, ptr %refine215.3, align 8, !tbaa !22
  %cmp216.3 = icmp eq i32 %105, -1
...
for.inc.3:                                        ; preds = %if.then218.3, %if.then209.3, %land.lhs.true204.3, %for.inc.2
  %106 = phi i32 [ %.pre303, %if.then218.3 ], [ %102, %if.then209.3 ], [ %102, %land.lhs.true204.3 ], [ %102, %for.inc.2 ]
  %arrayidx201.4 = getelementptr inbounds %struct.parent, ptr %88, i64 %idxprom193, i32 7, i64 4
  %107 = load i32, ptr %arrayidx201.4, align 4, !tbaa !5
  %cmp202.4 = icmp eq i32 %107, %106
  br i1 %cmp202.4, label %land.lhs.true204.4, label %for.inc.4

land.lhs.true204.4:                               ; preds = %for.inc.3
  %arrayidx206.4 = getelementptr inbounds %struct.parent, ptr %88, i64 %idxprom193, i32 6, i64 4
  %108 = load i32, ptr %arrayidx206.4, align 4, !tbaa !5
  %cmp207.4 = icmp sgt i32 %108, -1
  br i1 %cmp207.4, label %if.then209.4, label %for.inc.4

if.then209.4:                                     ; preds = %land.lhs.true204.4
  %idxprom213.4 = zext i32 %108 to i64
  %refine215.4 = getelementptr inbounds %struct.block, ptr %89, i64 %idxprom213.4, i32 2
  %109 = load i32, ptr %refine215.4, align 8, !tbaa !22
  %cmp216.4 = icmp eq i32 %109, -1
...
for.inc.4:                                        ; preds = %if.then218.4, %if.then209.4, %land.lhs.true204.4, %for.inc.3
  %110 = phi i32 [ %.pre304, %if.then218.4 ], [ %106, %if.then209.4 ], [ %106, %land.lhs.true204.4 ], [ %106, %for.inc.3 ]
  %arrayidx201.5 = getelementptr inbounds %struct.parent, ptr %88, i64 %idxprom193, i32 7, i64 5
  %111 = load i32, ptr %arrayidx201.5, align 4, !tbaa !5
  %cmp202.5 = icmp eq i32 %111, %110
  br i1 %cmp202.5, label %land.lhs.true204.5, label %for.inc.5

land.lhs.true204.5:                               ; preds = %for.inc.4
  %arrayidx206.5 = getelementptr inbounds %struct.parent, ptr %88, i64 %idxprom193, i32 6, i64 5
  %112 = load i32, ptr %arrayidx206.5, align 4, !tbaa !5
  %cmp207.5 = icmp sgt i32 %112, -1
  br i1 %cmp207.5, label %if.then209.5, label %for.inc.5

if.then209.5:                                     ; preds = %land.lhs.true204.5
  %idxprom213.5 = zext i32 %112 to i64
  %refine215.5 = getelementptr inbounds %struct.block, ptr %89, i64 %idxprom213.5, i32 2
  %113 = load i32, ptr %refine215.5, align 8, !tbaa !22
  %cmp216.5 = icmp eq i32 %113, -1
...
for.inc.5:                                        ; preds = %if.then218.5, %if.then209.5, %land.lhs.true204.5, %for.inc.4
  %114 = phi i32 [ %.pre305, %if.then218.5 ], [ %110, %if.then209.5 ], [ %110, %land.lhs.true204.5 ], [ %110, %for.inc.4 ]
  %arrayidx201.6 = getelementptr inbounds %struct.parent, ptr %88, i64 %idxprom193, i32 7, i64 6
  %115 = load i32, ptr %arrayidx201.6, align 4, !tbaa !5
  %cmp202.6 = icmp eq i32 %115, %114
  br i1 %cmp202.6, label %land.lhs.true204.6, label %for.inc.6

land.lhs.true204.6:                               ; preds = %for.inc.5
  %arrayidx206.6 = getelementptr inbounds %struct.parent, ptr %88, i64 %idxprom193, i32 6, i64 6
  %116 = load i32, ptr %arrayidx206.6, align 4, !tbaa !5
  %cmp207.6 = icmp sgt i32 %116, -1
  br i1 %cmp207.6, label %if.then209.6, label %for.inc.6

if.then209.6:                                     ; preds = %land.lhs.true204.6
  %idxprom213.6 = zext i32 %116 to i64
  %refine215.6 = getelementptr inbounds %struct.block, ptr %89, i64 %idxprom213.6, i32 2
  %117 = load i32, ptr %refine215.6, align 8, !tbaa !22
  %cmp216.6 = icmp eq i32 %117, -1
...
for.inc.6:                                        ; preds = %if.then218.6, %if.then209.6, %land.lhs.true204.6, %for.inc.5
  %118 = phi i32 [ %.pre306, %if.then218.6 ], [ %114, %if.then209.6 ], [ %114, %land.lhs.true204.6 ], [ %114, %for.inc.5 ]
  %arrayidx201.7 = getelementptr inbounds %struct.parent, ptr %88, i64 %idxprom193, i32 7, i64 7
  %119 = load i32, ptr %arrayidx201.7, align 4, !tbaa !5
  %cmp202.7 = icmp eq i32 %119, %118
  br i1 %cmp202.7, label %land.lhs.true204.7, label %if.end228

land.lhs.true204.7:                               ; preds = %for.inc.6
  %arrayidx206.7 = getelementptr inbounds %struct.parent, ptr %88, i64 %idxprom193, i32 6, i64 7
  %120 = load i32, ptr %arrayidx206.7, align 4, !tbaa !5
  %cmp207.7 = icmp sgt i32 %120, -1
  br i1 %cmp207.7, label %if.then209.7, label %if.end228

if.then209.7:                                     ; preds = %land.lhs.true204.7
  %idxprom213.7 = zext i32 %120 to i64
  %refine215.7 = getelementptr inbounds %struct.block, ptr %89, i64 %idxprom213.7, i32 2
  %121 = load i32, ptr %refine215.7, align 8, !tbaa !22
  %cmp216.7 = icmp eq i32 %121, -1
...
land.lhs.true231:                                 ; preds = %if.end228
  ...
  %122 = load i32, ptr %refine232, align 8, !tbaa !22
  %cmp233 = icmp eq i32 %122, -1
...
for.inc239:                                       ; preds = %for.body, %if.then235, %land.lhs.true231, %if.end228
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %123 = load ptr, ptr @sorted_index, align 8, !tbaa !9
  %124 = load i32, ptr @num_refine, align 4, !tbaa !5
  %add = add nsw i32 %124, 1
  %idxprom = sext i32 %add to i64
  %arrayidx = getelementptr inbounds i32, ptr %123, i64 %idxprom
  %125 = load i32, ptr %arrayidx, align 4, !tbaa !5
...
if.then27:                                        ; preds = %land.lhs.true
  ...
  %or.cond3246 = select i1 %cmp35, i1 %cmp44, i1 false
...
lor.lhs.false45:                                  ; preds = %if.then27
  ...
  %or.cond3309 = select i1 %cmp53, i1 %cmp62, i1 false
...
if.then118:                                       ; preds = %land.lhs.true109
  ...
  %or.cond3247 = select i1 %cmp126, i1 %cmp135, i1 false
...
lor.lhs.false136:                                 ; preds = %if.then118
  ...
  %or.cond3310 = select i1 %cmp144, i1 %cmp153, i1 false
...
if.then193:                                       ; preds = %land.lhs.true184
  ...
  %or.cond3248 = select i1 %cmp201, i1 %cmp210, i1 false
...
lor.lhs.false211:                                 ; preds = %if.then193
  ...
  %or.cond3311 = select i1 %cmp219, i1 %cmp228, i1 false
...
if.end1129:                                       ; preds = %if.else794, %land.lhs.true833, %if.then896, %if.then719, %land.lhs.true729, %if.then792, %if.else1005, %land.lhs.true1062, %if.then1125, %if.then901, %land.lhs.true940, %if.then1003, %if.else456, %land.lhs.true466, %if.then529, %if.then391, %if.then454, %if.else609, %land.lhs.true648, %if.then711, %if.then534, %land.lhs.true544, %if.then607
  ...
  %or.cond = select i1 %cmp1131, i1 %tobool1133, i1 false
...
if.end1498:                                       ; preds = %if.then1263, %if.else1352, %if.then1391, %if.then1340, %if.then1350, %if.else1437, %if.then1494, %if.then1396, %if.then1435, %if.else1266, %if.then1276, %if.else1293, %if.then1332, %if.then1281, %if.then1291
  ...
  %or.cond2314 = select i1 %cmp1500, i1 %tobool1502, i1 false
