; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/vectorUtils.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/vectorUtils.c"
...
; Function Attrs: nounwind uwtable
define dso_local ptr @NodePtrVec_copy(ptr noundef readonly %from, i1 noundef zeroext %exact_copy) local_unnamed_addr #4 {
entry:
