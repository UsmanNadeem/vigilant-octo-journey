; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-jpeg/rdcolmap.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-jpeg/rdcolmap.c"
...
entry:
  ...
  %call1 = tail call i32 @_IO_getc(ptr noundef %infile)
...
sw.bb:                                            ; preds = %entry
  %call.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
for.inc.i:                                        ; preds = %if.then.i, %sw.bb
  %call.1.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
for.inc.1.i:                                      ; preds = %if.then.1.i, %for.inc.i
  %call.2.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
for.inc.2.i:                                      ; preds = %if.then.2.i, %for.inc.1.i
  %call.3.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
for.inc.3.i:                                      ; preds = %if.then.3.i, %for.inc.2.i
  %call.4.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
for.inc.4.i:                                      ; preds = %if.then.4.i, %for.inc.3.i
  %call.5.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
for.inc.5.i:                                      ; preds = %if.then.5.i, %for.inc.4.i
  %call.6.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
for.inc.6.i:                                      ; preds = %if.then.6.i, %for.inc.5.i
  %call.7.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
for.inc.7.i:                                      ; preds = %if.then.7.i, %for.inc.6.i
  %call.8.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
for.inc.8.i:                                      ; preds = %if.then.8.i, %for.inc.7.i
  %call.9.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
for.inc.9.i:                                      ; preds = %if.then.9.i, %for.inc.8.i
  %call.10.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
for.inc.10.i:                                     ; preds = %if.then.10.i, %for.inc.9.i
  %call.11.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
for.body25.i:                                     ; preds = %add_map_entry.exit.i, %if.end20.i
  ...
  %call26.i = tail call i32 @_IO_getc(ptr noundef %infile)
  %call27.i = tail call i32 @_IO_getc(ptr noundef %infile)
  %call28.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
sw.bb2:                                           ; preds = %entry
  %call.i14 = tail call i32 @_IO_getc(ptr noundef %infile)
...
for.cond26.preheader.i:                           ; preds = %if.end14.i
  %brmerge = select i1 %cmp4.i15, i1 true, i1 %cmp.i
...
for.body31.us.i:                                  ; preds = %add_map_entry.exit211.us.i, %for.cond29.preheader.us.i
  ...
  %call.i.us.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
do.body.i161.us.i:                                ; preds = %for.body31.us.i, %do.body.i161.us.i
  %call1.i.us.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
pbm_getc.exit.us.i:                               ; preds = %do.body.i161.us.i, %do.body.i161.us.i, %for.body31.us.i
  ...
  %call.i162.us.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
do.body.i165.us.i:                                ; preds = %pbm_getc.exit.us.i, %do.body.i165.us.i
  %call1.i164.us.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
pbm_getc.exit167.us.i:                            ; preds = %do.body.i165.us.i, %do.body.i165.us.i, %pbm_getc.exit.us.i
  ...
  %call.i168.us.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
do.body.i171.us.i:                                ; preds = %pbm_getc.exit167.us.i, %do.body.i171.us.i
  %call1.i170.us.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
for.cond.preheader.i:                             ; preds = %if.end14.i
  %brmerge23 = select i1 %cmp4.i15, i1 true, i1 %cmp.i
...
do.body.i.us.i:                                   ; preds = %do.body.i.us.i.backedge, %do.body.i.preheader.us.i
  %call.i.i.us.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
do.body.i.i.us.i:                                 ; preds = %do.body.i.us.i, %do.body.i.i.us.i
  %call1.i.i.us.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
while.cond.i.us.i:                                ; preds = %while.body.i.us.i, %if.end15.i.us.i
  ...
  %call.i40.i.us.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
do.body.i43.i.us.i:                               ; preds = %while.cond.i.us.i, %do.body.i43.i.us.i
  %call1.i42.i.us.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
do.body.i106.us.i:                                ; preds = %pbm_getc.exit45.i.us.i, %do.body.i106.us.i.backedge
  %call.i.i104.us.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
do.body.i.i108.us.i:                              ; preds = %do.body.i106.us.i, %do.body.i.i108.us.i
  %call1.i.i107.us.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
while.cond.i123.us.i:                             ; preds = %while.body.i130.us.i, %if.end15.i119.us.i
  ...
  %call.i40.i121.us.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
do.body.i43.i125.us.i:                            ; preds = %while.cond.i123.us.i, %do.body.i43.i125.us.i
  %call1.i42.i124.us.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
do.body.i134.us.i:                                ; preds = %pbm_getc.exit45.i127.us.i, %do.body.i134.us.i.backedge
  %call.i.i132.us.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
do.body.i.i136.us.i:                              ; preds = %do.body.i134.us.i, %do.body.i.i136.us.i
  %call1.i.i135.us.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
while.cond.i151.us.i:                             ; preds = %while.body.i158.us.i, %if.end15.i147.us.i
  ...
  %call.i40.i149.us.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
do.body.i43.i153.us.i:                            ; preds = %while.cond.i151.us.i, %do.body.i43.i153.us.i
  %call1.i42.i152.us.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
do.body.i:                                        ; preds = %do.body, %do.body.i
  %call1.i = tail call i32 @_IO_getc(ptr noundef %infile)
...
while.cond:                                       ; preds = %while.body, %if.end15
  ...
  %call.i40 = tail call i32 @_IO_getc(ptr noundef %infile)
...
do.body.i43:                                      ; preds = %while.cond, %do.body.i43
  %call1.i42 = tail call i32 @_IO_getc(ptr noundef %infile)
