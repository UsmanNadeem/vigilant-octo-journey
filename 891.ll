; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/jdhuff.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/jdhuff.c"
...
for.body77.us.preheader:                          ; preds = %for.inc61.15
  ...
  %uglygep209 = getelementptr i8, ptr %3, i64 872
  %uglygep211 = getelementptr i8, ptr %3, i64 1384
  %uglygep213 = getelementptr i8, ptr %3, i64 1512
...
for.body77.us:                                    ; preds = %for.body77.us.preheader, %for.cond84.for.inc98_crit_edge.us
  ...
  %uglygep216 = getelementptr i8, ptr %htbl, i64 %154
  %155 = add nuw i64 %indvars.iv199, 17
  %uglygep215 = getelementptr i8, ptr %htbl, i64 %155
  %156 = shl nsw i64 %153, 2
  %uglygep208 = getelementptr i8, ptr %uglygep, i64 %156
  %uglygep210 = getelementptr i8, ptr %uglygep209, i64 %156
  %uglygep212 = getelementptr i8, ptr %uglygep211, i64 %153
  %uglygep214 = getelementptr i8, ptr %uglygep213, i64 %153
  %bound0 = icmp ult ptr %uglygep208, %uglygep214
  %bound1 = icmp ult ptr %uglygep212, %uglygep210
  %found.conflict = and i1 %bound0, %bound1
  %bound0217 = icmp ult ptr %uglygep208, %uglygep216
  %bound1218 = icmp ult ptr %uglygep215, %uglygep210
  %found.conflict219 = and i1 %bound0217, %bound1218
  %conflict.rdx = or i1 %found.conflict, %found.conflict219
  %bound0220 = icmp ult ptr %uglygep212, %uglygep216
  %bound1221 = icmp ult ptr %uglygep215, %uglygep214
...
for.body77.us.preheader.1:                        ; preds = %for.inc102
  ...
  %uglygep228 = getelementptr i8, ptr %3, i64 360
  %uglygep230 = getelementptr i8, ptr %3, i64 616
  %uglygep232 = getelementptr i8, ptr %3, i64 1384
  %uglygep234 = getelementptr i8, ptr %3, i64 1448
...
for.body77.us.1:                                  ; preds = %for.cond84.for.inc98_crit_edge.us.1, %for.body77.us.preheader.1
  ...
  %uglygep237 = getelementptr i8, ptr %htbl, i64 %247
  %248 = add i64 %243, %indvar
  %uglygep236 = getelementptr i8, ptr %htbl, i64 %248
  %249 = shl nsw i64 %246, 2
  %uglygep229 = getelementptr i8, ptr %uglygep228, i64 %249
  %uglygep231 = getelementptr i8, ptr %uglygep230, i64 %249
  %uglygep233 = getelementptr i8, ptr %uglygep232, i64 %246
  %uglygep235 = getelementptr i8, ptr %uglygep234, i64 %246
  %bound0238 = icmp ult ptr %uglygep229, %uglygep235
  %bound1239 = icmp ult ptr %uglygep233, %uglygep231
  %found.conflict240 = and i1 %bound0238, %bound1239
  %bound0241 = icmp ult ptr %uglygep229, %uglygep237
  %bound1242 = icmp ult ptr %uglygep236, %uglygep231
  %found.conflict243 = and i1 %bound0241, %bound1242
  %conflict.rdx244 = or i1 %found.conflict240, %found.conflict243
  %bound0245 = icmp ult ptr %uglygep233, %uglygep237
  %bound1246 = icmp ult ptr %uglygep236, %uglygep235
...
if.end19:                                         ; preds = %if.end16, %while.body
  ...
  br i1 %cmp7, label %while.body, label %while.end.loopexit, !llvm.loop !63
...
entry:
  ...
  store ptr %call, ptr %entropy1, align 8, !tbaa !64
  store ptr @start_pass_huff_decoder, ptr %call, align 8, !tbaa !65
  %decode_mcu = getelementptr inbounds %struct.jpeg_entropy_decoder, ptr %call, i64 0, i32 1
  store ptr @decode_mcu, ptr %decode_mcu, align 8, !tbaa !70
  %uglygep = getelementptr i8, ptr %call, i64 56
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(64) %uglygep, i8 0, i64 64, i1 false)
  ret void
}
...
lor.lhs.false3:                                   ; preds = %lor.lhs.false
  ...
  %3 = load i32, ptr %Ah, align 4, !tbaa !73
...
lor.lhs.false5:                                   ; preds = %lor.lhs.false3
  ...
  %4 = load i32, ptr %Al, align 8, !tbaa !74
...
if.end:                                           ; preds = %if.then, %lor.lhs.false5
  ...
  %7 = load i32, ptr %comps_in_scan, align 8, !tbaa !75
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end38
  ...
  %9 = load i32, ptr %dc_tbl_no, align 4, !tbaa !76
  %ac_tbl_no = getelementptr inbounds %struct.jpeg_component_info, ptr %8, i64 0, i32 6
  %10 = load i32, ptr %ac_tbl_no, align 8, !tbaa !78
...
if.end38:                                         ; preds = %if.then30, %lor.lhs.false26
  ...
  %21 = load i32, ptr %comps_in_scan, align 8, !tbaa !75
  %22 = sext i32 %21 to i64
  %cmp8 = icmp slt i64 %indvars.iv.next, %22
  br i1 %cmp8, label %for.body, label %for.end, !llvm.loop !80
...
for.end:                                          ; preds = %if.end38, %if.end
  ...
  %23 = load i32, ptr %restart_interval, align 8, !tbaa !81
  %restarts_to_go = getelementptr inbounds %struct.huff_entropy_decoder, ptr %0, i64 0, i32 3
  store i32 %23, ptr %restarts_to_go, align 8, !tbaa !82
  ret void
}
...
for.cond.preheader.i:                             ; preds = %if.then2
  ...
  %7 = load i32, ptr %comps_in_scan.i, align 8, !tbaa !75
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  %8 = load i32, ptr %comps_in_scan.i, align 8, !tbaa !75
  %9 = sext i32 %8 to i64
  %cmp.i = icmp slt i64 %indvars.iv.next.i, %9
  br i1 %cmp.i, label %for.body.i, label %process_restart.exit, !llvm.loop !88

process_restart.exit:                             ; preds = %for.body.i, %for.cond.preheader.i
  %10 = load i32, ptr %restart_interval, align 8, !tbaa !81
  store i32 %10, ptr %restarts_to_go, align 8, !tbaa !82
  %printed_eod.i = getelementptr inbounds %struct.huff_entropy_decoder, ptr %0, i64 0, i32 1, i32 2
  store i32 0, ptr %printed_eod.i, align 4, !tbaa !89
  br label %if.end6
...
if.end6:                                          ; preds = %process_restart.exit, %if.then, %entry
  ...
  %14 = load i32, ptr %unread_marker, align 4, !tbaa !90
  ...
  %saved = getelementptr inbounds %struct.huff_entropy_decoder, ptr %0, i64 0, i32 2
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %state, ptr noundef nonnull align 8 dereferenceable(16) %saved, i64 16, i1 false), !tbaa.struct !92
  %blocks_in_MCU = getelementptr inbounds %struct.jpeg_decompress_struct, ptr %cinfo, i64 0, i32 66
  %17 = load i32, ptr %blocks_in_MCU, align 8, !tbaa !93
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc265
  ...
  %21 = load i32, ptr %dc_tbl_no, align 4, !tbaa !76
  ...
  %23 = load i32, ptr %ac_tbl_no, align 8, !tbaa !78
...
if.then34.split:                                  ; preds = %if.end30
  %call46429 = call i32 @jpeg_huff_decode(ptr noundef nonnull %br_state, i64 noundef %get_buffer.addr.0110.i, i32 noundef %bits_left.addr.0111.i, ptr noundef %22, i32 noundef 1)
  br label %label1
...
if.end79:                                         ; preds = %cond.true, %if.end66, %cleanup.cont
  ...
  %75 = load i32, ptr %component_needed, align 8, !tbaa !94
...
if.end82:                                         ; preds = %if.end79
  ...
  store i16 %conv89, ptr %18, align 2, !tbaa !95
  %DCT_scaled_size = getelementptr inbounds %struct.jpeg_component_info, ptr %20, i64 0, i32 9
  %77 = load i32, ptr %DCT_scaled_size, align 4, !tbaa !96
...
if.then111.split:                                 ; preds = %if.end106
  %call131431 = call i32 @jpeg_huff_decode(ptr noundef nonnull %br_state, i64 noundef %get_buffer.addr.0110.i532, i32 noundef %bits_left.addr.0111.i531, ptr noundef %24, i32 noundef 1)
  br label %label2
...
cond.end174:                                      ; preds = %if.end157, %cond.true169
  ...
  store i16 %conv176, ptr %arrayidx180, align 2, !tbaa !95
  br label %for.inc
...
for.inc:                                          ; preds = %cond.end174, %if.end185
  ...
  br i1 %cmp95, label %for.body97, label %for.inc265, !llvm.loop !97
...
if.then206.split:                                 ; preds = %if.end201
  %call226434 = call i32 @jpeg_huff_decode(ptr noundef nonnull %br_state, i64 noundef %get_buffer.addr.0110.i680, i32 noundef %bits_left.addr.0111.i679, ptr noundef %24, i32 noundef 1)
  br label %label3
...
for.inc261:                                       ; preds = %if.else254, %if.end252
  ...
  br i1 %cmp190, label %for.body192, label %for.inc265, !llvm.loop !98
...
for.inc265:                                       ; preds = %if.else181, %for.inc, %if.else254, %for.inc261
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %177 = load i32, ptr %blocks_in_MCU, align 8, !tbaa !93
  %178 = sext i32 %177 to i64
  %cmp16 = icmp slt i64 %indvars.iv.next, %178
  br i1 %cmp16, label %for.body, label %for.end267.loopexit, !llvm.loop !99
...
for.end267:                                       ; preds = %for.end267.loopexit, %if.end6
  ...
  store i32 %179, ptr %unread_marker, align 4, !tbaa !90
  store i64 %get_buffer.0.lcssa, ptr %bitstate, align 8, !tbaa !91
  store i32 %bits_left.0.lcssa, ptr %bits_left14, align 8, !tbaa !83
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %saved, ptr noundef nonnull align 4 dereferenceable(16) %state, i64 16, i1 false), !tbaa.struct !92
  %restarts_to_go281 = getelementptr inbounds %struct.huff_entropy_decoder, ptr %0, i64 0, i32 3
  %183 = load i32, ptr %restarts_to_go281, align 8, !tbaa !82
  %dec = add i32 %183, -1
  store i32 %dec, ptr %restarts_to_go281, align 8, !tbaa !82
  br label %cleanup282
...
!64 = !{!10, !6, i64 576}
!65 = !{!66, !6, i64 0}
!66 = !{!"", !67, i64 0, !68, i64 16, !69, i64 32, !11, i64 48, !7, i64 56, !7, i64 88}
!67 = !{!"jpeg_entropy_decoder", !6, i64 0, !6, i64 8}
!68 = !{!"", !16, i64 0, !11, i64 8, !11, i64 12}
!69 = !{!"", !7, i64 0}
!70 = !{!66, !6, i64 8}
!71 = !{!10, !11, i64 508}
!72 = !{!10, !11, i64 512}
...
!75 = !{!10, !11, i64 416}
!76 = !{!77, !11, i64 20}
!77 = !{!"", !11, i64 0, !11, i64 4, !11, i64 8, !11, i64 12, !11, i64 16, !11, i64 20, !11, i64 24, !11, i64 28, !11, i64 32, !11, i64 36, !11, i64 40, !11, i64 44, !11, i64 48, !11, i64 52, !11, i64 56, !11, i64 60, !11, i64 64, !11, i64 68, !11, i64 72, !6, i64 80, !6, i64 88}
!78 = !{!77, !11, i64 24}
!79 = !{!58, !6, i64 0}
!80 = distinct !{!80, !22}
!81 = !{!10, !11, i64 360}
...
!84 = !{!10, !6, i64 568}
!85 = !{!86, !11, i64 172}
!86 = !{!"jpeg_marker_reader", !6, i64 0, !6, i64 8, !6, i64 16, !6, i64 24, !7, i64 32, !11, i64 160, !11, i64 164, !11, i64 168, !11, i64 172}
!87 = !{!86, !6, i64 16}
!88 = distinct !{!88, !22}
!89 = !{!66, !11, i64 28}
!90 = !{!10, !11, i64 524}
