; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/Bitcode/Benchmarks/Halide/common/x86_halide_runtime.bc'
...
for.body48.preheader666:                          ; preds = %for.body48.preheader, %vector.body.preheader.for.body48.preheader666_crit_edge, %min.iters.checked
  ...
  %uglygep7 = getelementptr i8, ptr %buffer, i64 %i.1592.ph667
  call void @llvm.memset.p0.i64(ptr align 1 %uglygep7, i8 0, i64 %.pre-phi, i1 false), !tbaa !8
...
vector.body.preheader:                            ; preds = %min.iters.checked
  %uglygep = getelementptr i8, ptr %buffer, i64 %i.1592.ph.ph
  %12 = sub nuw nsw i64 44, %i.1592.ph.ph
  %13 = and i64 %12, -4
  %14 = add nuw nsw i64 %13, 4
  call void @llvm.memset.p0.i64(ptr align 1 %uglygep, i8 0, i64 %14, i1 false), !tbaa !8
...
for.body56.lr.ph:                                 ; preds = %for.cond54.preheader
  ...
  %umax = tail call i64 @llvm.umax.i64(i64 %conv18, i64 1)
  %min.iters.check617 = icmp ult i64 %umax, 4
...
middle.block615:                                  ; preds = %vector.body614.epil, %middle.block615.unr-lcssa
  %cmp.n630 = icmp eq i64 %umax, %n.vec620
...
for.body67.lr.ph:                                 ; preds = %for.cond64.preheader
  ...
  %71 = add nuw nsw i64 %mul20, 47
  %72 = add nsw i64 %71, %conv18
...
for.body67.preheader:                             ; preds = %for.body67.lr.ph
  %umax13 = call i64 @llvm.umax.i64(i64 %mul20, i64 1)
  br label %for.body67
...
for.body67:                                       ; preds = %for.body67, %for.body67.preheader
  ...
  %exitcond.not.3 = icmp eq i64 %inc73.3, %umax13
