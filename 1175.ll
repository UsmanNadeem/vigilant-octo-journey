; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mafft/Ralignmm.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mafft/Ralignmm.c"
...
if.then17:                                        ; preds = %if.then12
  ...
  tail call void @FreeFloatMtx(ptr noundef %32) #13
  %33 = load ptr, ptr @R__align.cpmx2, align 8, !tbaa !5
  tail call void @FreeFloatMtx(ptr noundef %33) #13
  ...
  tail call void @FreeIntMtx(ptr noundef %35) #13
...
if.end18:                                         ; preds = %if.then17, %if.then12
  ...
  %call54 = tail call ptr @AllocateCharMtx(i32 noundef %38, i32 noundef %add53) #13
  ...
  %call88 = tail call ptr @AllocateFloatMtx(i32 noundef 26, i32 noundef %add45) #13
  store ptr %call88, ptr @R__align.cpmx1, align 8, !tbaa !5
  %call90 = tail call ptr @AllocateFloatMtx(i32 noundef 26, i32 noundef %add39) #13
  ...
  %call98 = tail call ptr @AllocateFloatMtx(i32 noundef %add97, i32 noundef 26) #13
  store ptr %call98, ptr @R__align.floatwork, align 8, !tbaa !5
  %call106 = tail call ptr @AllocateIntMtx(i32 noundef %add97, i32 noundef 27) #13
...
if.then144:                                       ; preds = %if.then139
  ...
  tail call void @FreeIntMtx(ptr noundef %64) #13
  %.pre1540 = load i32, ptr @R__align.orlgth1, align 4, !tbaa !11
  %.pre1541 = load i32, ptr @commonAlloc1, align 4, !tbaa !11
  %.pre1542 = load i32, ptr @R__align.orlgth2, align 4, !tbaa !11
  %.pre1543 = load i32, ptr @commonAlloc2, align 4, !tbaa !11
  br label %if.end145
...
if.end145:                                        ; preds = %if.then144, %if.then139
  ...
  %call160 = tail call ptr @AllocateIntMtx(i32 noundef %add158, i32 noundef %add159) #13
...
if.end161:                                        ; preds = %lor.lhs.false136.if.end161_crit_edge, %if.end145
  ...
  tail call void @cpmx_calc_new(ptr noundef nonnull %seq1, ptr noundef %70, ptr noundef %eff1, i32 noundef %conv4, i32 noundef %icyc) #13
  %71 = load ptr, ptr @R__align.cpmx2, align 8, !tbaa !5
  tail call void @cpmx_calc_new(ptr noundef nonnull %seq2, ptr noundef %71, ptr noundef %eff2, i32 noundef %conv7, i32 noundef %jcyc) #13
...
if.then163:                                       ; preds = %if.end161
  tail call void @new_OpeningGapCount_zure(ptr noundef %72, i32 noundef %icyc, ptr noundef nonnull %seq1, ptr noundef %eff1, i32 noundef %conv4, ptr noundef nonnull %sgap1, ptr noundef %egap1) #13
  %73 = load ptr, ptr @R__align.ogcp2g, align 8, !tbaa !5
  tail call void @new_OpeningGapCount_zure(ptr noundef %73, i32 noundef %jcyc, ptr noundef nonnull %seq2, ptr noundef %eff2, i32 noundef %conv7, ptr noundef %sgap2, ptr noundef %egap2) #13
  %74 = load ptr, ptr @R__align.fgcp1g, align 8, !tbaa !5
  tail call void @new_FinalGapCount_zure(ptr noundef %74, i32 noundef %icyc, ptr noundef nonnull %seq1, ptr noundef %eff1, i32 noundef %conv4, ptr noundef nonnull %sgap1, ptr noundef %egap1) #13
  %75 = load ptr, ptr @R__align.fgcp2g, align 8, !tbaa !5
  tail call void @new_FinalGapCount_zure(ptr noundef %75, i32 noundef %jcyc, ptr noundef nonnull %seq2, ptr noundef %eff2, i32 noundef %conv7, ptr noundef %sgap2, ptr noundef %egap2) #13
  %76 = load ptr, ptr @R__align.digf1, align 8, !tbaa !5
  tail call void @getdigapfreq_part(ptr noundef %76, i32 noundef %icyc, ptr noundef nonnull %seq1, ptr noundef %eff1, i32 noundef %conv4, ptr noundef nonnull %sgap1, ptr noundef %egap1) #13
  %77 = load ptr, ptr @R__align.digf2, align 8, !tbaa !5
  tail call void @getdigapfreq_part(ptr noundef %77, i32 noundef %jcyc, ptr noundef nonnull %seq2, ptr noundef %eff2, i32 noundef %conv7, ptr noundef %sgap2, ptr noundef %egap2) #13
  %78 = load ptr, ptr @R__align.diaf1, align 8, !tbaa !5
  tail call void @getdiaminofreq_part(ptr noundef %78, i32 noundef %icyc, ptr noundef nonnull %seq1, ptr noundef %eff1, i32 noundef %conv4, ptr noundef nonnull %sgap1, ptr noundef %egap1) #13
  %79 = load ptr, ptr @R__align.diaf2, align 8, !tbaa !5
  tail call void @getdiaminofreq_part(ptr noundef %79, i32 noundef %jcyc, ptr noundef nonnull %seq2, ptr noundef %eff2, i32 noundef %conv7, ptr noundef %sgap2, ptr noundef %egap2) #13
  %80 = load ptr, ptr @R__align.gapf1, align 8, !tbaa !5
  tail call void @getgapfreq(ptr noundef %80, i32 noundef %icyc, ptr noundef nonnull %seq1, ptr noundef %eff1, i32 noundef %conv4) #13
  %81 = load ptr, ptr @R__align.gapf2, align 8, !tbaa !5
  tail call void @getgapfreq(ptr noundef %81, i32 noundef %jcyc, ptr noundef nonnull %seq2, ptr noundef %eff2, i32 noundef %conv7) #13
  %82 = load ptr, ptr @R__align.gapz1, align 8, !tbaa !5
  tail call void @getgapfreq_zure_part(ptr noundef %82, i32 noundef %icyc, ptr noundef nonnull %seq1, ptr noundef %eff1, i32 noundef %conv4, ptr noundef nonnull %sgap1) #13
  %83 = load ptr, ptr @R__align.gapz2, align 8, !tbaa !5
  tail call void @getgapfreq_zure_part(ptr noundef %83, i32 noundef %jcyc, ptr noundef nonnull %seq2, ptr noundef %eff2, i32 noundef %conv7, ptr noundef nonnull %sgap1) #13
  br label %if.end164

if.else:                                          ; preds = %if.end161
  tail call void @st_OpeningGapCount(ptr noundef %72, i32 noundef %icyc, ptr noundef nonnull %seq1, ptr noundef %eff1, i32 noundef %conv4) #13
  %84 = load ptr, ptr @R__align.ogcp2g, align 8, !tbaa !5
  tail call void @st_OpeningGapCount(ptr noundef %84, i32 noundef %jcyc, ptr noundef nonnull %seq2, ptr noundef %eff2, i32 noundef %conv7) #13
  %85 = load ptr, ptr @R__align.fgcp1g, align 8, !tbaa !5
  tail call void @st_FinalGapCount_zure(ptr noundef %85, i32 noundef %icyc, ptr noundef nonnull %seq1, ptr noundef %eff1, i32 noundef %conv4) #13
  %86 = load ptr, ptr @R__align.fgcp2g, align 8, !tbaa !5
  tail call void @st_FinalGapCount_zure(ptr noundef %86, i32 noundef %jcyc, ptr noundef nonnull %seq2, ptr noundef %eff2, i32 noundef %conv7) #13
...
vector.memcheck:                                  ; preds = %while.body.preheader.i
  ...
  %uglygep1556 = getelementptr i8, ptr %127, i64 %134
  %bound0 = icmp ult ptr %95, %uglygep1556
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %ind.end1559 = getelementptr i8, ptr %95, i64 %136
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %138 = shl i64 %index, 2
  %next.gep1562 = getelementptr i8, ptr %95, i64 %138
  %wide.load = load <4 x float>, ptr %next.gep, align 4, !tbaa !9, !alias.scope !42
  %139 = getelementptr float, ptr %next.gep, i64 4
  %wide.load1564 = load <4 x float>, ptr %139, align 4, !tbaa !9, !alias.scope !42
  %wide.load1565 = load <4 x float>, ptr %next.gep1562, align 4, !tbaa !9, !alias.scope !45, !noalias !42
  %140 = getelementptr float, ptr %next.gep1562, i64 4
  %wide.load1566 = load <4 x float>, ptr %140, align 4, !tbaa !9, !alias.scope !45, !noalias !42
  %141 = fadd <4 x float> %wide.load, %wide.load1565
  %142 = fadd <4 x float> %wide.load1564, %wide.load1566
  store <4 x float> %141, ptr %next.gep1562, align 4, !tbaa !9, !alias.scope !45, !noalias !42
...
while.body.i.prol:                                ; preds = %while.body.i.preheader, %while.body.i.prol
  ...
  %add.i1237.prol = fadd float %145, %146
...
while.body.i.prol.loopexit:                       ; preds = %while.body.i.prol, %while.body.i.preheader
  ...
  br i1 %147, label %if.end170, label %while.body.i
...
if.end170.critedge:                               ; preds = %if.end164
  %156 = load ptr, ptr @R__align.cpmx1, align 8, !tbaa !5
  %157 = load ptr, ptr @R__align.cpmx2, align 8, !tbaa !5
  %158 = load ptr, ptr @R__align.floatwork, align 8, !tbaa !5
  %159 = load ptr, ptr @R__align.intwork, align 8, !tbaa !5
...
for.body398.lr.ph:                                ; preds = %for.cond394.preheader
  ...
  %163 = add i64 %call6, 1
  %wide.trip.count1472 = and i64 %163, 4294967295
  %164 = add nsw i64 %wide.trip.count1472, -1
  %min.iters.check1569 = icmp ult i64 %164, 4
  br i1 %min.iters.check1569, label %for.body398.preheader, label %vector.ph1570

vector.ph1570:                                    ; preds = %for.body398.lr.ph
  %n.vec1572 = and i64 %164, -4
...
vector.body1576:                                  ; preds = %vector.body1576, %vector.ph1570
  ...
  %wide.load1578 = load <4 x float>, ptr %168, align 4, !tbaa !9
  %169 = fpext <4 x float> %wide.load1578 to <4 x double>
  ...
  %172 = icmp eq i64 %index.next1579, %n.vec1572
  br i1 %172, label %middle.block1567, label %vector.body1576, !llvm.loop !52

middle.block1567:                                 ; preds = %vector.body1576
  %cmp.n1575 = icmp eq i64 %164, %n.vec1572
...
if.then173:                                       ; preds = %if.end170.thread, %if.end170
  %173 = load ptr, ptr @R__align.ogcp1g, align 8, !tbaa !5
  %174 = load float, ptr %173, align 4, !tbaa !9
  %conv175 = fpext float %174 to double
  %175 = load ptr, ptr @R__align.ogcp2g, align 8, !tbaa !5
  %176 = load float, ptr %175, align 4, !tbaa !9
  %conv177 = fpext float %176 to double
  ...
  %177 = tail call double @llvm.fmuladd.f64(double %mul181, double 5.000000e-01, double 0.000000e+00)
  %conv184 = fptrunc double %177 to float
  ...
  %178 = tail call double @llvm.fmuladd.f64(double %mul192, double 5.000000e-01, double %conv194)
  %conv195 = fptrunc double %178 to float
  %179 = load ptr, ptr @R__align.fgcp1g, align 8, !tbaa !5
  %180 = load float, ptr %179, align 4, !tbaa !9
  %conv197 = fpext float %180 to double
  %181 = load ptr, ptr @R__align.fgcp2g, align 8, !tbaa !5
  %182 = load float, ptr %181, align 4, !tbaa !9
  %conv199 = fpext float %182 to double
  ...
  %183 = tail call double @llvm.fmuladd.f64(double %mul203, double 5.000000e-01, double %conv205)
  %conv206 = fptrunc double %183 to float
  ...
  %184 = tail call double @llvm.fmuladd.f64(double %mul214, double 5.000000e-01, double %conv216)
  %conv217 = fptrunc double %184 to float
  %185 = load ptr, ptr @R__align.initverticalw, align 8, !tbaa !5
  %186 = load float, ptr %185, align 4, !tbaa !9
  %add219 = fadd float %186, %conv217
  store float %add219, ptr %185, align 4, !tbaa !9
  %187 = load float, ptr %95, align 4, !tbaa !9
  %add221 = fadd float %187, %conv217
...
for.body226.lr.ph:                                ; preds = %if.then173
  %188 = load ptr, ptr @R__align.gapz2, align 8, !tbaa !5
  %189 = load ptr, ptr @R__align.digf1, align 8, !tbaa !5
  %190 = load ptr, ptr @R__align.diaf1, align 8, !tbaa !5
  %arrayidx251 = getelementptr inbounds float, ptr %188, i64 1
  %191 = add i64 %call3, 1
  %wide.trip.count1482 = and i64 %191, 4294967295
...
if.end425.thread:                                 ; preds = %for.cond306.preheader
  %192 = load ptr, ptr @R__align.m, align 8, !tbaa !5
  store float 0.000000e+00, ptr %192, align 4, !tbaa !9
  br label %for.end442

for.body310.lr.ph:                                ; preds = %for.cond306.preheader
  %193 = load ptr, ptr @R__align.gapz1, align 8, !tbaa !5
  %194 = load ptr, ptr @R__align.digf2, align 8, !tbaa !5
  %195 = load ptr, ptr @R__align.diaf2, align 8, !tbaa !5
  %arrayidx337 = getelementptr inbounds float, ptr %193, i64 1
  %196 = add i64 %call6, 1
  %wide.trip.count1487 = and i64 %196, 4294967295
...
for.body226:                                      ; preds = %for.body226.lr.ph, %for.body226
  ...
  %197 = load float, ptr %188, align 4, !tbaa !9
  %conv228 = fpext float %197 to double
  %sub229 = fsub double 1.000000e+00, %conv228
  %198 = load float, ptr %173, align 4, !tbaa !9
  %conv231 = fpext float %198 to double
  %sub232 = fsub double 1.000000e+00, %conv231
  %add233 = fadd double %sub232, 0.000000e+00
  %199 = load float, ptr %189, align 4, !tbaa !9
  %conv238 = fpext float %199 to double
  %sub239 = fsub double 1.000000e+00, %conv238
  %200 = load float, ptr %190, align 4, !tbaa !9
  %conv241 = fpext float %200 to double
  %sub242 = fsub double %sub239, %conv241
  %mul243 = fmul double %sub242, %conv228
  %201 = tail call double @llvm.fmuladd.f64(double %sub229, double %add233, double %mul243)
  %mul244 = fmul double %201, 5.000000e-01
  %mul246 = fmul double %mul244, %conv180
  %conv247 = fptrunc double %mul246 to float
  %arrayidx249 = getelementptr inbounds float, ptr %185, i64 %indvars.iv1479
  %202 = load float, ptr %arrayidx249, align 4, !tbaa !9
  %add250 = fadd float %202, %conv247
  store float %add250, ptr %arrayidx249, align 4, !tbaa !9
  %203 = load float, ptr %arrayidx251, align 4, !tbaa !9
  %conv252 = fpext float %203 to double
  %sub253 = fsub double 1.000000e+00, %conv252
  %arrayidx255 = getelementptr inbounds float, ptr %179, i64 %indvars.iv1479
  %204 = load float, ptr %arrayidx255, align 4, !tbaa !9
  %conv256 = fpext float %204 to double
  %sub257 = fsub double 1.000000e+00, %conv256
  %arrayidx259 = getelementptr inbounds float, ptr %173, i64 %indvars.iv1479
  %205 = load float, ptr %arrayidx259, align 4, !tbaa !9
  %conv260 = fpext float %205 to double
  %add261 = fadd double %sub257, %conv260
  %arrayidx266 = getelementptr inbounds float, ptr %189, i64 %indvars.iv1479
  %206 = load float, ptr %arrayidx266, align 4, !tbaa !9
  %conv267 = fpext float %206 to double
  %sub268 = fsub double 1.000000e+00, %conv267
  %arrayidx270 = getelementptr inbounds float, ptr %190, i64 %indvars.iv1479
  %207 = load float, ptr %arrayidx270, align 4, !tbaa !9
  %conv271 = fpext float %207 to double
  %sub272 = fsub double %sub268, %conv271
  %mul273 = fmul double %sub272, %conv252
  %208 = tail call double @llvm.fmuladd.f64(double %sub253, double %add261, double %mul273)
  %mul274 = fmul double %208, 5.000000e-01
  ...
  %209 = load float, ptr %arrayidx259, align 4, !tbaa !9
  %210 = load float, ptr %arrayidx255, align 4, !tbaa !9
  %add286 = fadd float %209, %210
  %mul287 = fmul float %add286, %conv
  %conv288 = fpext float %mul287 to double
  %conv290 = fpext float %cumpenal.01420 to double
  %211 = tail call double @llvm.fmuladd.f64(double %conv288, double 5.000000e-01, double %conv290)
  %conv291 = fptrunc double %211 to float
  %conv292 = fpext float %conv291 to double
  %mul295 = fmul float %210, %conv
  %conv296 = fpext float %mul295 to double
  %neg = fneg double %conv296
  %212 = tail call double @llvm.fmuladd.f64(double %neg, double 5.000000e-01, double %conv292)
  %conv300 = fpext float %add280 to double
  %add301 = fadd double %212, %conv300
...
for.body310:                                      ; preds = %for.body310.lr.ph, %for.body310
  ...
  %213 = load float, ptr %193, align 4, !tbaa !9
  %conv312 = fpext float %213 to double
  %sub313 = fsub double 1.000000e+00, %conv312
  %214 = load float, ptr %175, align 4, !tbaa !9
  %conv315 = fpext float %214 to double
  %sub316 = fsub double 1.000000e+00, %conv315
  %add317 = fadd double %sub316, 0.000000e+00
  %arrayidx322 = getelementptr inbounds float, ptr %194, i64 %indvars.iv1484
  %215 = load float, ptr %arrayidx322, align 4, !tbaa !9
  %conv323 = fpext float %215 to double
  %sub324 = fsub double 1.000000e+00, %conv323
  %arrayidx326 = getelementptr inbounds float, ptr %195, i64 %indvars.iv1484
  %216 = load float, ptr %arrayidx326, align 4, !tbaa !9
  %conv327 = fpext float %216 to double
  %sub328 = fsub double %sub324, %conv327
  %mul329 = fmul double %sub328, %conv312
  %217 = tail call double @llvm.fmuladd.f64(double %sub313, double %add317, double %mul329)
  %mul330 = fmul double %217, 5.000000e-01
  ...
  %218 = load float, ptr %arrayidx335, align 4, !tbaa !9
  %add336 = fadd float %218, %conv333
  store float %add336, ptr %arrayidx335, align 4, !tbaa !9
  %219 = load float, ptr %arrayidx337, align 4, !tbaa !9
  %conv338 = fpext float %219 to double
  %sub339 = fsub double 1.000000e+00, %conv338
  %arrayidx341 = getelementptr inbounds float, ptr %181, i64 %indvars.iv1484
  %220 = load float, ptr %arrayidx341, align 4, !tbaa !9
  %conv342 = fpext float %220 to double
  %sub343 = fsub double 1.000000e+00, %conv342
  %arrayidx345 = getelementptr inbounds float, ptr %175, i64 %indvars.iv1484
  %221 = load float, ptr %arrayidx345, align 4, !tbaa !9
  %conv346 = fpext float %221 to double
  %add347 = fadd double %sub343, %conv346
  %222 = load float, ptr %arrayidx322, align 4, !tbaa !9
  %conv353 = fpext float %222 to double
  %sub354 = fsub double 1.000000e+00, %conv353
  %223 = load float, ptr %arrayidx326, align 4, !tbaa !9
  %conv357 = fpext float %223 to double
  %sub358 = fsub double %sub354, %conv357
  %mul359 = fmul double %sub358, %conv338
  %224 = tail call double @llvm.fmuladd.f64(double %sub339, double %add347, double %mul359)
  %mul360 = fmul double %224, 5.000000e-01
  ...
  %225 = load float, ptr %arrayidx345, align 4, !tbaa !9
  %226 = load float, ptr %arrayidx341, align 4, !tbaa !9
  %add372 = fadd float %225, %226
  %mul373 = fmul float %add372, %conv
  %conv374 = fpext float %mul373 to double
  %conv376 = fpext float %cumpenal.11423 to double
  %227 = tail call double @llvm.fmuladd.f64(double %conv374, double 5.000000e-01, double %conv376)
  %conv377 = fptrunc double %227 to float
  %conv378 = fpext float %conv377 to double
  %mul381 = fmul float %226, %conv
  %conv382 = fpext float %mul381 to double
  %neg384 = fneg double %conv382
  %228 = tail call double @llvm.fmuladd.f64(double %neg384, double 5.000000e-01, double %conv378)
  %conv387 = fpext float %add366 to double
  %add388 = fadd double %228, %conv387
...
for.body413.lr.ph:                                ; preds = %for.cond409.preheader
  ...
  %230 = load ptr, ptr @R__align.initverticalw, align 8, !tbaa !5
  %231 = add i64 %call3, 1
  %wide.trip.count1477 = and i64 %231, 4294967295
  %232 = add nsw i64 %wide.trip.count1477, -1
  %min.iters.check1582 = icmp ult i64 %232, 4
  br i1 %min.iters.check1582, label %for.body413.preheader, label %vector.ph1583

vector.ph1583:                                    ; preds = %for.body413.lr.ph
  %n.vec1585 = and i64 %232, -4
  %ind.end1586 = or i64 %n.vec1585, 1
  %broadcast.splatinsert1594 = insertelement <4 x i32> poison, i32 %229, i64 0
...
vector.body1589:                                  ; preds = %vector.body1589, %vector.ph1583
  ...
  %233 = mul nsw <4 x i32> %broadcast.splat1595, %vec.ind1591
  ...
  %236 = getelementptr inbounds float, ptr %230, i64 %offset.idx1593
  %wide.load1596 = load <4 x float>, ptr %236, align 4, !tbaa !9
  %237 = fpext <4 x float> %wide.load1596 to <4 x double>
  ...
  %240 = icmp eq i64 %index.next1597, %n.vec1585
  br i1 %240, label %middle.block1580, label %vector.body1589, !llvm.loop !55

middle.block1580:                                 ; preds = %vector.body1589
  %cmp.n1588 = icmp eq i64 %232, %n.vec1585
...
for.body398:                                      ; preds = %for.body398.preheader, %for.body398
  ...
  %241 = trunc i64 %indvars.iv1469 to i32
  %mul399 = mul nsw i32 %162, %241
  ...
  %242 = load float, ptr %arrayidx402, align 4, !tbaa !9
  %conv403 = fpext float %242 to double
...
for.body413:                                      ; preds = %for.body413.preheader, %for.body413
  ...
  %243 = trunc i64 %indvars.iv1474 to i32
  %mul414 = mul nsw i32 %229, %243
  %conv415 = sitofp i32 %mul414 to double
  %div416 = fmul double %conv415, 5.000000e-01
  %arrayidx418 = getelementptr inbounds float, ptr %230, i64 %indvars.iv1474
  %244 = load float, ptr %arrayidx418, align 4, !tbaa !9
  %conv419 = fpext float %244 to double
...
if.end425:                                        ; preds = %for.body413, %for.body310, %middle.block1580, %for.cond409.preheader
  %245 = load ptr, ptr @R__align.m, align 8, !tbaa !5
...
for.body431.lr.ph:                                ; preds = %if.end425
  %247 = load ptr, ptr @R__align.mp, align 8, !tbaa !5
  %248 = add i64 %call6, 1
  %wide.trip.count1493 = and i64 %248, 4294967295
  %249 = add nsw i64 %wide.trip.count1493, -1
  %min.iters.check1601 = icmp ult i64 %249, 8
...
vector.body1608:                                  ; preds = %vector.body1608, %vector.ph1602
  ...
  %252 = getelementptr inbounds i32, ptr %247, i64 %offset.idx1610
  ...
  %254 = getelementptr inbounds float, ptr %95, i64 %index1609
  %wide.load1611 = load <4 x float>, ptr %254, align 4, !tbaa !9
  %255 = getelementptr inbounds float, ptr %254, i64 4
  %wide.load1612 = load <4 x float>, ptr %255, align 4, !tbaa !9
  %256 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %broadcast.splat1614, <4 x float> <float 1.000000e+04, float 1.000000e+04, float 1.000000e+04, float 1.000000e+04>, <4 x float> %wide.load1611)
  %257 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %broadcast.splat1616, <4 x float> <float 1.000000e+04, float 1.000000e+04, float 1.000000e+04, float 1.000000e+04>, <4 x float> %wide.load1612)
  %258 = getelementptr inbounds float, ptr %245, i64 %offset.idx1610
  store <4 x float> %256, ptr %258, align 4, !tbaa !9
  %259 = getelementptr inbounds float, ptr %258, i64 4
  store <4 x float> %257, ptr %259, align 4, !tbaa !9
  %index.next1617 = add nuw i64 %index1609, 8
  %260 = icmp eq i64 %index.next1617, %n.vec1604
  br i1 %260, label %middle.block1599, label %vector.body1608, !llvm.loop !58

middle.block1599:                                 ; preds = %vector.body1608
  %cmp.n1607 = icmp eq i64 %249, %n.vec1604
...
for.body431.prol:                                 ; preds = %for.body431.preheader
  %arrayidx433.prol = getelementptr inbounds i32, ptr %247, i64 %indvars.iv1489.ph
  store i32 0, ptr %arrayidx433.prol, align 4, !tbaa !11
  %261 = add nsw i64 %indvars.iv1489.ph, -1
  %arrayidx436.prol = getelementptr inbounds float, ptr %95, i64 %261
  %262 = load float, ptr %arrayidx436.prol, align 4, !tbaa !9
  %263 = tail call float @llvm.fmuladd.f32(float %conv, float 1.000000e+04, float %262)
  %arrayidx439.prol = getelementptr inbounds float, ptr %245, i64 %indvars.iv1489.ph
  store float %263, ptr %arrayidx439.prol, align 4, !tbaa !9
...
for.body431.prol.loopexit:                        ; preds = %for.body431.prol, %for.body431.preheader
  ...
  %264 = icmp eq i64 %wide.trip.count1493, %.neg
  br i1 %264, label %for.end442, label %for.body431
...
for.body431:                                      ; preds = %for.body431.prol.loopexit, %for.body431
  ...
  %arrayidx433 = getelementptr inbounds i32, ptr %247, i64 %indvars.iv1489
  store i32 0, ptr %arrayidx433, align 4, !tbaa !11
  %265 = add nsw i64 %indvars.iv1489, -1
  %arrayidx436 = getelementptr inbounds float, ptr %95, i64 %265
  %266 = load float, ptr %arrayidx436, align 4, !tbaa !9
  %267 = tail call float @llvm.fmuladd.f32(float %conv, float 1.000000e+04, float %266)
  %arrayidx439 = getelementptr inbounds float, ptr %245, i64 %indvars.iv1489
  store float %267, ptr %arrayidx439, align 4, !tbaa !9
  %indvars.iv.next1490 = add nuw nsw i64 %indvars.iv1489, 1
  %arrayidx433.1 = getelementptr inbounds i32, ptr %247, i64 %indvars.iv.next1490
  store i32 0, ptr %arrayidx433.1, align 4, !tbaa !11
  %arrayidx436.1 = getelementptr inbounds float, ptr %95, i64 %indvars.iv1489
  %268 = load float, ptr %arrayidx436.1, align 4, !tbaa !9
  %269 = tail call float @llvm.fmuladd.f32(float %conv, float 1.000000e+04, float %268)
  %arrayidx439.1 = getelementptr inbounds float, ptr %245, i64 %indvars.iv.next1490
  store float %269, ptr %arrayidx439.1, align 4, !tbaa !9
...
if.then445:                                       ; preds = %for.end442
  ...
  store float 0.000000e+00, ptr %270, align 4, !tbaa !9
  br label %if.end452
...
if.else447:                                       ; preds = %for.end442
  ...
  %271 = load float, ptr %arrayidx450, align 4, !tbaa !9
  %272 = load ptr, ptr @R__align.lastverticalw, align 8, !tbaa !5
  store float %271, ptr %272, align 4, !tbaa !9
  br label %if.end452

if.end452:                                        ; preds = %if.else447, %if.then445
  %273 = phi ptr [ %272, %if.else447 ], [ %270, %if.then445 ]
  %274 = load i32, ptr @outgap, align 4, !tbaa !11
  %tobool453.not = icmp ne i32 %274, 0
...
for.body461.lr.ph:                                ; preds = %if.end452
  ...
  %wide.trip.count1499 = and i64 %275, 4294967295
  ...
  %282 = insertelement <2 x double> poison, double %conv498, i64 0
  %283 = shufflevector <2 x double> %282, <2 x double> poison, <2 x i32> zeroinitializer
  %284 = insertelement <2 x double> <double 5.000000e-01, double poison>, double %conv498, i64 1
  %285 = insertelement <2 x double> <double poison, double 5.000000e-01>, double %conv498, i64 0
  %min.iters.check1626 = icmp ult i32 %276, 7
  %n.vec1629 = and i64 %281, -8
  %286 = shl nuw nsw i64 %n.vec1629, 2
  %.cast1632 = trunc i64 %n.vec1629 to i32
  %ind.end1633 = sub i32 %conv7, %.cast1632
  %287 = shl nuw nsw i64 %n.vec1629, 2
  %cmp.n1637 = icmp eq i64 %281, %n.vec1629
  br label %for.body461

for.body461:                                      ; preds = %for.body461.lr.ph, %for.end730
  %288 = phi ptr [ %.pre1545, %for.body461.lr.ph ], [ %317, %for.end730 ]
  ...
  %289 = add nsw i64 %indvars.iv1502, -1
  %arrayidx464 = getelementptr inbounds float, ptr %288, i64 %289
  %290 = load float, ptr %arrayidx464, align 4, !tbaa !9
  store float %290, ptr %currentw.01446, align 4, !tbaa !9
  %291 = load ptr, ptr @R__align.cpmx1, align 8, !tbaa !5
  %292 = load ptr, ptr @R__align.cpmx2, align 8, !tbaa !5
  %293 = load ptr, ptr @R__align.floatwork, align 8, !tbaa !5
  %294 = load ptr, ptr @R__align.intwork, align 8, !tbaa !5
  %295 = trunc i64 %indvars.iv1502 to i32
  tail call fastcc void @match_calc(ptr noundef %previousw.01445, ptr noundef %291, ptr noundef %292, i32 noundef %295, i32 noundef %conv7, ptr noundef %293, ptr noundef %294, i32 noundef 0)
...
while.body.preheader.i1240:                       ; preds = %for.body461
  ...
  %arrayidx.i1239 = getelementptr inbounds ptr, ptr %296, i64 %indvars.iv1502
  %297 = load ptr, ptr %arrayidx.i1239, align 8, !tbaa !5
...
vector.memcheck1618:                              ; preds = %while.body.preheader.i1240
  %uglygep1619 = getelementptr i8, ptr %previousw.01445, i64 %279
  %uglygep1620 = getelementptr i8, ptr %297, i64 %279
  %bound01621 = icmp ult ptr %previousw.01445, %uglygep1620
  %bound11622 = icmp ult ptr %297, %uglygep1619
...
vector.ph1627:                                    ; preds = %vector.memcheck1618
  %ind.end1630 = getelementptr i8, ptr %297, i64 %286
  %ind.end1635 = getelementptr i8, ptr %previousw.01445, i64 %287
...
vector.body1638:                                  ; preds = %vector.body1638, %vector.ph1627
  ...
  %298 = shl i64 %index1639, 2
  %next.gep1640 = getelementptr i8, ptr %297, i64 %298
  %299 = shl i64 %index1639, 2
  %next.gep1642 = getelementptr i8, ptr %previousw.01445, i64 %299
  %wide.load1644 = load <4 x float>, ptr %next.gep1640, align 4, !tbaa !9, !alias.scope !60
  %300 = getelementptr float, ptr %next.gep1640, i64 4
  %wide.load1645 = load <4 x float>, ptr %300, align 4, !tbaa !9, !alias.scope !60
  %wide.load1646 = load <4 x float>, ptr %next.gep1642, align 4, !tbaa !9, !alias.scope !63, !noalias !60
  %301 = getelementptr float, ptr %next.gep1642, i64 4
  %wide.load1647 = load <4 x float>, ptr %301, align 4, !tbaa !9, !alias.scope !63, !noalias !60
  %302 = fadd <4 x float> %wide.load1644, %wide.load1646
  %303 = fadd <4 x float> %wide.load1645, %wide.load1647
  store <4 x float> %302, ptr %next.gep1642, align 4, !tbaa !9, !alias.scope !63, !noalias !60
  store <4 x float> %303, ptr %301, align 4, !tbaa !9, !alias.scope !63, !noalias !60
  %index.next1648 = add nuw i64 %index1639, 8
  %304 = icmp eq i64 %index.next1648, %n.vec1629
  br i1 %304, label %middle.block1624, label %vector.body1638, !llvm.loop !65
...
while.body.i1249.preheader:                       ; preds = %vector.memcheck1618, %while.body.preheader.i1240, %middle.block1624
  %pt.05.i1241.ph = phi ptr [ %297, %vector.memcheck1618 ], [ %297, %while.body.preheader.i1240 ], [ %ind.end1630, %middle.block1624 ]
  ...
  %305 = add nsw i32 %lgth2.addr.04.i1242.ph, -1
...
while.body.i1249.prol:                            ; preds = %while.body.i1249.preheader, %while.body.i1249.prol
  ...
  %306 = load float, ptr %pt.05.i1241.prol, align 4, !tbaa !9
  %incdec.ptr1.i1246.prol = getelementptr inbounds float, ptr %imp.addr.03.i1243.prol, i64 1
  %307 = load float, ptr %imp.addr.03.i1243.prol, align 4, !tbaa !9
  %add.i1247.prol = fadd float %306, %307
...
while.body.i1249.prol.loopexit:                   ; preds = %while.body.i1249.prol, %while.body.i1249.preheader
  ...
  br i1 %308, label %if.end468, label %while.body.i1249
...
while.body.i1249:                                 ; preds = %while.body.i1249.prol.loopexit, %while.body.i1249
  ...
  %309 = load float, ptr %pt.05.i1241, align 4, !tbaa !9
  %incdec.ptr1.i1246 = getelementptr inbounds float, ptr %imp.addr.03.i1243, i64 1
  %310 = load float, ptr %imp.addr.03.i1243, align 4, !tbaa !9
  %add.i1247 = fadd float %309, %310
  ...
  %311 = load float, ptr %incdec.ptr.i1245, align 4, !tbaa !9
  %incdec.ptr1.i1246.1 = getelementptr inbounds float, ptr %imp.addr.03.i1243, i64 2
  %312 = load float, ptr %incdec.ptr1.i1246, align 4, !tbaa !9
  %add.i1247.1 = fadd float %311, %312
  ...
  %313 = load float, ptr %incdec.ptr.i1245.1, align 4, !tbaa !9
  %incdec.ptr1.i1246.2 = getelementptr inbounds float, ptr %imp.addr.03.i1243, i64 3
  %314 = load float, ptr %incdec.ptr1.i1246.1, align 4, !tbaa !9
  %add.i1247.2 = fadd float %313, %314
  ...
  %315 = load float, ptr %incdec.ptr.i1245.2, align 4, !tbaa !9
  %incdec.ptr1.i1246.3 = getelementptr inbounds float, ptr %imp.addr.03.i1243, i64 4
  %316 = load float, ptr %incdec.ptr1.i1246.2, align 4, !tbaa !9
  %add.i1247.3 = fadd float %315, %316
...
if.end468:                                        ; preds = %while.body.i1249.prol.loopexit, %while.body.i1249, %middle.block1624, %for.body461
  %317 = load ptr, ptr @R__align.initverticalw, align 8, !tbaa !5
  %arrayidx470 = getelementptr inbounds float, ptr %317, i64 %indvars.iv1502
  %318 = load float, ptr %arrayidx470, align 4, !tbaa !9
  store float %318, ptr %previousw.01445, align 4, !tbaa !9
  %319 = load float, ptr %currentw.01446, align 4, !tbaa !9
  %320 = tail call float @llvm.fmuladd.f32(float %conv, float 1.000000e+04, float %319)
  %321 = load ptr, ptr @R__align.m, align 8, !tbaa !5
...
for.body489.lr.ph:                                ; preds = %if.end468
  %322 = load ptr, ptr @R__align.ijp, align 8, !tbaa !5
  %arrayidx475 = getelementptr inbounds ptr, ptr %322, i64 %indvars.iv1502
  %323 = load ptr, ptr %arrayidx475, align 8, !tbaa !5
  %324 = load ptr, ptr @R__align.mp, align 8, !tbaa !5
  %325 = load ptr, ptr @R__align.ogcp1g, align 8, !tbaa !5
  %arrayidx491 = getelementptr inbounds float, ptr %325, i64 %indvars.iv1502
  %326 = load ptr, ptr @R__align.ogcp2g, align 8, !tbaa !5
  %327 = load ptr, ptr @R__align.fgcp1g, align 8, !tbaa !5
  %arrayidx517 = getelementptr inbounds float, ptr %327, i64 %indvars.iv1502
  %328 = load ptr, ptr @R__align.fgcp2g, align 8, !tbaa !5
  %329 = load ptr, ptr @R__align.gapz1, align 8, !tbaa !5
  %330 = add nuw nsw i64 %indvars.iv1502, 1
  %arrayidx544 = getelementptr inbounds float, ptr %329, i64 %330
  %331 = load ptr, ptr @R__align.digf2, align 8, !tbaa !5
  %332 = load ptr, ptr @R__align.diaf2, align 8, !tbaa !5
  %arrayidx581 = getelementptr inbounds float, ptr %329, i64 %indvars.iv1502
  %333 = load ptr, ptr @R__align.gapz2, align 8, !tbaa !5
  %334 = load ptr, ptr @R__align.digf1, align 8, !tbaa !5
  %arrayidx650 = getelementptr inbounds float, ptr %334, i64 %indvars.iv1502
  %335 = load ptr, ptr @R__align.diaf1, align 8, !tbaa !5
  %arrayidx654 = getelementptr inbounds float, ptr %335, i64 %indvars.iv1502
  %cmp703.not = icmp eq i64 %indvars.iv1502, 1
  %mpjpt.01440.peel = getelementptr inbounds i32, ptr %324, i64 1
  %mjpt.01441.peel = getelementptr inbounds float, ptr %321, i64 1
  %ijppt.01442.peel = getelementptr inbounds i32, ptr %323, i64 1
  %curpt.01443.peel = getelementptr inbounds float, ptr %previousw.01445, i64 1
  %arrayidx494.peel = getelementptr inbounds float, ptr %326, i64 1
  %arrayidx520.peel = getelementptr inbounds float, ptr %328, i64 1
  %336 = load float, ptr %arrayidx491, align 4, !tbaa !9
  %337 = load float, ptr %arrayidx494.peel, align 4, !tbaa !9
  %338 = load float, ptr %arrayidx517, align 4, !tbaa !9
  %339 = insertelement <2 x float> poison, float %338, i64 0
  %340 = insertelement <2 x float> %339, float %337, i64 1
  %341 = fpext <2 x float> %340 to <2 x double>
  %342 = load float, ptr %arrayidx520.peel, align 4, !tbaa !9
  %343 = insertelement <2 x float> poison, float %336, i64 0
  %344 = insertelement <2 x float> %343, float %342, i64 1
  %345 = fpext <2 x float> %344 to <2 x double>
  %346 = fsub <2 x double> <double 1.000000e+00, double 1.000000e+00>, %341
  %347 = extractelement <2 x double> %345, i64 0
  %shift = shufflevector <2 x double> %346, <2 x double> poison, <2 x i32> <i32 1, i32 undef>
  %348 = fmul <2 x double> %shift, %345
  %mul497.peel = extractelement <2 x double> %348, i64 0
  ...
  %add502.peel = fadd float %319, %conv501.peel
  %sub509.peel = fsub double 1.000000e+00, %347
  %349 = extractelement <2 x double> %341, i64 1
  %mul510.peel = fmul double %sub509.peel, %349
  ...
  %sub522.peel = fsub double 1.000000e+00, %350
  %351 = extractelement <2 x double> %341, i64 0
  %mul523.peel = fmul double %sub522.peel, %351
  ...
  %352 = extractelement <2 x double> %346, i64 0
  %mul536.peel = fmul double %352, %350
  store i32 0, ptr %ijppt.01442.peel, align 4, !tbaa !11
  %353 = load float, ptr %arrayidx544, align 4, !tbaa !9
  %conv545.peel = fpext float %353 to double
  %sub546.peel = fsub double 1.000000e+00, %conv545.peel
  %add554.peel = fadd double %sub522.peel, %349
  %arrayidx561.peel = getelementptr inbounds float, ptr %331, i64 1
  %354 = load float, ptr %arrayidx561.peel, align 4, !tbaa !9
  %conv562.peel = fpext float %354 to double
  %sub563.peel = fsub double 1.000000e+00, %conv562.peel
  %arrayidx565.peel = getelementptr inbounds float, ptr %332, i64 1
  %355 = load float, ptr %arrayidx565.peel, align 4, !tbaa !9
  %conv566.peel = fpext float %355 to double
  %sub567.peel = fsub double %sub563.peel, %conv566.peel
  %mul568.peel = fmul double %sub567.peel, %conv545.peel
  %356 = tail call double @llvm.fmuladd.f64(double %sub546.peel, double %add554.peel, double %mul568.peel)
  %357 = insertelement <2 x double> poison, double %356, i64 0
  %358 = insertelement <2 x double> %357, double %mul536.peel, i64 1
  %359 = fmul <2 x double> %358, %284
  %360 = fmul <2 x double> %359, %285
  %361 = fptrunc <2 x double> %360 to <2 x float>
  %362 = insertelement <2 x float> poison, float %320, i64 0
  %363 = insertelement <2 x float> %362, float %add528.peel, i64 1
  %364 = fadd <2 x float> %363, %361
  %365 = extractelement <2 x float> %364, i64 0
  %366 = extractelement <2 x float> %364, i64 1
  %cmp574.peel = fcmp ogt float %365, %366
...
if.end579.peel:                                   ; preds = %if.then576.peel, %for.body489.lr.ph
  %wm.2.peel = phi float [ %365, %if.then576.peel ], [ %366, %for.body489.lr.ph ]
  %367 = fadd <2 x double> %346, %345
  %arrayidx633.peel = getelementptr inbounds float, ptr %333, i64 2
  %368 = load float, ptr %arrayidx650, align 4, !tbaa !9
  %conv651.peel = fpext float %368 to double
  %sub652.peel = fsub double 1.000000e+00, %conv651.peel
  %369 = load float, ptr %arrayidx654, align 4, !tbaa !9
  %conv655.peel = fpext float %369 to double
  %sub656.peel = fsub double %sub652.peel, %conv655.peel
  %370 = load float, ptr %mjpt.01441.peel, align 4, !tbaa !9
  %371 = load float, ptr %arrayidx581, align 4, !tbaa !9
  %372 = load float, ptr %arrayidx633.peel, align 4, !tbaa !9
  %373 = insertelement <2 x float> poison, float %372, i64 0
  %374 = insertelement <2 x float> %373, float %371, i64 1
  %375 = fpext <2 x float> %374 to <2 x double>
  %376 = fsub <2 x double> <double 1.000000e+00, double 1.000000e+00>, %375
  %377 = insertelement <2 x double> poison, double %sub656.peel, i64 0
  %378 = insertelement <2 x double> %377, double %sub567.peel, i64 1
  %379 = fmul <2 x double> %378, %375
  %380 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %376, <2 x double> %367, <2 x double> %379)
  %381 = fmul <2 x double> %380, <double 5.000000e-01, double 5.000000e-01>
  %382 = fmul <2 x double> %381, %283
  %383 = fptrunc <2 x double> %382 to <2 x float>
  %384 = insertelement <2 x float> poison, float %370, i64 0
  %385 = insertelement <2 x float> %384, float %319, i64 1
  %386 = fadd <2 x float> %385, %383
  %387 = extractelement <2 x float> %386, i64 1
  %388 = fcmp ult float %387, %320
  %389 = extractelement <2 x float> %386, i64 1
  %conv6281427.peel = select i1 %388, float %320, float %389
  %390 = extractelement <2 x float> %386, i64 0
  %391 = fcmp ogt float %390, %wm.2.peel
  br i1 %391, label %if.then665.peel, label %if.end667.peel

if.then665.peel:                                  ; preds = %if.end579.peel
  %392 = load i32, ptr %mpjpt.01440.peel, align 4, !tbaa !11
  %sub666.peel = sub nsw i32 %295, %392
  store i32 %sub666.peel, ptr %ijppt.01442.peel, align 4, !tbaa !11
  %393 = extractelement <2 x float> %386, i64 0
  br label %if.end667.peel

if.end667.peel:                                   ; preds = %if.then665.peel, %if.end579.peel
  %wm.3.peel = phi float [ %393, %if.then665.peel ], [ %wm.2.peel, %if.end579.peel ]
  %arrayidx669.peel = getelementptr inbounds float, ptr %333, i64 1
  %394 = load float, ptr %arrayidx669.peel, align 4, !tbaa !9
  %conv670.peel = fpext float %394 to double
  %sub671.peel = fsub double 1.000000e+00, %conv670.peel
  %add679.peel = fadd double %sub509.peel, %351
  %mul692.peel = fmul double %sub656.peel, %conv670.peel
  %395 = tail call double @llvm.fmuladd.f64(double %sub671.peel, double %add679.peel, double %mul692.peel)
  %mul693.peel = fmul double %395, 5.000000e-01
  %mul695.peel = fmul double %mul693.peel, %conv498
  %conv696.peel = fptrunc double %mul695.peel to float
  %add697.peel = fadd float %319, %conv696.peel
  %cmp698.peel = fcmp ult float %add697.peel, %370
...
if.then700.peel:                                  ; preds = %if.end667.peel
  ...
  %396 = trunc i64 %289 to i32
  store i32 %396, ptr %mpjpt.01440.peel, align 4, !tbaa !11
...
if.then705.peel:                                  ; preds = %if.else702.peel
  %add711.peel = fadd float %336, %338
  %mul712.peel = fmul float %add711.peel, %conv
  %conv713.peel = fpext float %mul712.peel to double
  %conv717.peel = fpext float %370 to double
  %397 = tail call double @llvm.fmuladd.f64(double %conv713.peel, double 5.000000e-01, double %conv717.peel)
  %conv718.peel = fptrunc double %397 to float
...
if.end720.peel:                                   ; preds = %if.then705.peel, %if.else702.peel, %if.then700.peel
  %398 = load float, ptr %curpt.01443.peel, align 4, !tbaa !9
  %add721.peel = fadd float %wm.3.peel, %398
...
for.body489:                                      ; preds = %for.body489.peel.next, %if.end720
  ...
  %400 = load float, ptr %prept.01438, align 4, !tbaa !9
  %401 = load float, ptr %arrayidx491, align 4, !tbaa !9
  %conv492 = fpext float %401 to double
  %arrayidx494 = getelementptr inbounds float, ptr %326, i64 %indvars.iv1495
  %402 = load float, ptr %arrayidx494, align 4, !tbaa !9
  %conv495 = fpext float %402 to double
  ...
  %403 = load float, ptr %arrayidx517, align 4, !tbaa !9
  %conv518 = fpext float %403 to double
  %arrayidx520 = getelementptr inbounds float, ptr %328, i64 %indvars.iv1495
  %404 = load float, ptr %arrayidx520, align 4, !tbaa !9
  %conv521 = fpext float %404 to double
  ...
  %405 = load float, ptr %arrayidx544, align 4, !tbaa !9
  %conv545 = fpext float %405 to double
  %sub546 = fsub double 1.000000e+00, %conv545
  %add554 = fadd double %sub522, %conv495
  %arrayidx561 = getelementptr inbounds float, ptr %331, i64 %indvars.iv1495
  %406 = load float, ptr %arrayidx561, align 4, !tbaa !9
  %conv562 = fpext float %406 to double
  %sub563 = fsub double 1.000000e+00, %conv562
  %arrayidx565 = getelementptr inbounds float, ptr %332, i64 %indvars.iv1495
  %407 = load float, ptr %arrayidx565, align 4, !tbaa !9
  %conv566 = fpext float %407 to double
  %sub567 = fsub double %sub563, %conv566
  %mul568 = fmul double %sub567, %conv545
  %408 = tail call double @llvm.fmuladd.f64(double %sub546, double %add554, double %mul568)
  %409 = insertelement <2 x double> poison, double %408, i64 0
  %410 = insertelement <2 x double> %409, double %mul536, i64 1
  %411 = fmul <2 x double> %410, %284
  %412 = fmul <2 x double> %411, %285
  %413 = fptrunc <2 x double> %412 to <2 x float>
  %414 = insertelement <2 x float> poison, float %conv62814281437, i64 0
  %415 = insertelement <2 x float> %414, float %add528, i64 1
  %416 = fadd <2 x float> %415, %413
  %417 = extractelement <2 x float> %416, i64 0
  %418 = extractelement <2 x float> %416, i64 1
  %cmp574 = fcmp ogt float %417, %418
  br i1 %cmp574, label %if.then576, label %if.end579

if.then576:                                       ; preds = %for.body489
  %419 = trunc i64 %indvars.iv1495 to i32
  %sub577.neg = sub i32 %sub61314301436, %419
  store i32 %sub577.neg, ptr %ijppt.01442, align 4, !tbaa !11
  br label %if.end579

if.end579:                                        ; preds = %if.then576, %for.body489
  %wm.2 = phi float [ %417, %if.then576 ], [ %418, %for.body489 ]
  %420 = load float, ptr %arrayidx581, align 4, !tbaa !9
  %conv582 = fpext float %420 to double
  %sub583 = fsub double 1.000000e+00, %conv582
  %add591 = fadd double %sub496, %conv521
  %mul604 = fmul double %sub567, %conv582
  %421 = tail call double @llvm.fmuladd.f64(double %sub583, double %add591, double %mul604)
  %mul605 = fmul double %421, 5.000000e-01
  %mul607 = fmul double %mul605, %conv498
  %conv608 = fptrunc double %mul607 to float
  %add609 = fadd float %400, %conv608
  %cmp610 = fcmp ult float %add609, %conv62814281437
  br i1 %cmp610, label %if.then617, label %if.then612

if.then612:                                       ; preds = %if.end579
  %422 = trunc i64 %indvars.iv1495 to i32
  %423 = add i32 %422, -1
  br label %if.end630

if.then617:                                       ; preds = %if.end579
  %add623 = fadd float %402, %404
  %mul624 = fmul float %add623, %conv
  %conv625 = fpext float %mul624 to double
  %conv627 = fpext float %conv62814281437 to double
  %424 = tail call double @llvm.fmuladd.f64(double %conv625, double 5.000000e-01, double %conv627)
  %conv628 = fptrunc double %424 to float
  br label %if.end630

if.end630:                                        ; preds = %if.then617, %if.then612
  %sub6131429 = phi i32 [ %sub61314301436, %if.then617 ], [ %423, %if.then612 ]
  %conv6281427 = phi float [ %conv628, %if.then617 ], [ %add609, %if.then612 ]
  %indvars.iv.next1496 = add nuw nsw i64 %indvars.iv1495, 1
  %arrayidx633 = getelementptr inbounds float, ptr %333, i64 %indvars.iv.next1496
  %425 = load float, ptr %arrayidx633, align 4, !tbaa !9
  %conv634 = fpext float %425 to double
  %sub635 = fsub double 1.000000e+00, %conv634
  %add643 = fadd double %sub535, %conv492
  %426 = load float, ptr %arrayidx650, align 4, !tbaa !9
  %conv651 = fpext float %426 to double
  %sub652 = fsub double 1.000000e+00, %conv651
  %427 = load float, ptr %arrayidx654, align 4, !tbaa !9
  %conv655 = fpext float %427 to double
  %sub656 = fsub double %sub652, %conv655
  %mul657 = fmul double %sub656, %conv634
  %428 = tail call double @llvm.fmuladd.f64(double %sub635, double %add643, double %mul657)
  %mul658 = fmul double %428, 5.000000e-01
  %mul660 = fmul double %mul658, %conv498
  %conv661 = fptrunc double %mul660 to float
  %429 = load float, ptr %mjpt.01441, align 4, !tbaa !9
  %add662 = fadd float %429, %conv661
  %cmp663 = fcmp ogt float %add662, %wm.2
  br i1 %cmp663, label %if.then665, label %if.end667

if.then665:                                       ; preds = %if.end630
  %430 = load i32, ptr %mpjpt.01440, align 4, !tbaa !11
  %sub666 = sub nsw i32 %295, %430
...
if.end667:                                        ; preds = %if.then665, %if.end630
  ...
  %arrayidx669 = getelementptr inbounds float, ptr %333, i64 %indvars.iv1495
  %431 = load float, ptr %arrayidx669, align 4, !tbaa !9
  %conv670 = fpext float %431 to double
  %sub671 = fsub double 1.000000e+00, %conv670
  %add679 = fadd double %sub509, %conv518
  %mul692 = fmul double %sub656, %conv670
  %432 = tail call double @llvm.fmuladd.f64(double %sub671, double %add679, double %mul692)
  %mul693 = fmul double %432, 5.000000e-01
  %mul695 = fmul double %mul693, %conv498
  %conv696 = fptrunc double %mul695 to float
  %add697 = fadd float %400, %conv696
  %cmp698 = fcmp ult float %add697, %429
  br i1 %cmp698, label %if.else702, label %if.then700

if.then700:                                       ; preds = %if.end667
  store float %add697, ptr %mjpt.01441, align 4, !tbaa !9
  store i32 %399, ptr %mpjpt.01440, align 4, !tbaa !11
  br label %if.end720
...
if.then705:                                       ; preds = %if.else702
  %add711 = fadd float %401, %403
  %mul712 = fmul float %add711, %conv
  %conv713 = fpext float %mul712 to double
  %arrayidx716 = getelementptr inbounds float, ptr %321, i64 %indvars.iv1495
  %433 = load float, ptr %arrayidx716, align 4, !tbaa !9
  %conv717 = fpext float %433 to double
  %434 = tail call double @llvm.fmuladd.f64(double %conv713, double 5.000000e-01, double %conv717)
  %conv718 = fptrunc double %434 to float
  store float %conv718, ptr %arrayidx716, align 4, !tbaa !9
  br label %if.end720

if.end720:                                        ; preds = %if.else702, %if.then705, %if.then700
  %435 = load float, ptr %curpt.01443, align 4, !tbaa !9
  %add721 = fadd float %wm.3, %435
...
for.end730:                                       ; preds = %if.end720, %if.end720.peel, %if.end468.for.end730_crit_edge
  %indvars.iv.next1503.pre-phi = phi i64 [ %.pre1547, %if.end468.for.end730_crit_edge ], [ %330, %if.end720.peel ], [ %330, %if.end720 ]
  ...
  %436 = load float, ptr %arrayidx733, align 4, !tbaa !9
  %437 = load ptr, ptr @R__align.lastverticalw, align 8, !tbaa !5
  %arrayidx735 = getelementptr inbounds float, ptr %437, i64 %indvars.iv1502
  store float %436, ptr %arrayidx735, align 4, !tbaa !9
...
for.end738:                                       ; preds = %for.end738.loopexit, %if.end452
  %438 = phi ptr [ %273, %if.end452 ], [ %437, %for.end738.loopexit ]
  %439 = phi i32 [ %274, %if.end452 ], [ %.pre1546, %for.end738.loopexit ]
  ...
  %tobool739.not = icmp eq i32 %439, 0
...
for.body745.lr.ph:                                ; preds = %for.cond741.preheader
  %440 = load i32, ptr @offset, align 4, !tbaa !11
  %441 = add i64 %call6, 1
  %wide.trip.count1512 = and i64 %441, 4294967295
  %442 = add nsw i64 %wide.trip.count1512, -1
  %min.iters.check1651 = icmp ult i64 %442, 4
  br i1 %min.iters.check1651, label %for.body745.preheader, label %vector.ph1652

vector.ph1652:                                    ; preds = %for.body745.lr.ph
  %n.vec1654 = and i64 %442, -4
  ...
  %broadcast.splatinsert1665 = insertelement <4 x i32> poison, i32 %440, i64 0
...
vector.body1658:                                  ; preds = %vector.body1658, %vector.ph1652
  ...
  %443 = sub nsw <4 x i32> %broadcast.splat1664, %vec.ind1660
  %444 = mul nsw <4 x i32> %broadcast.splat1666, %443
  %445 = sitofp <4 x i32> %444 to <4 x double>
  %446 = fmul <4 x double> %445, <double 5.000000e-01, double 5.000000e-01, double 5.000000e-01, double 5.000000e-01>
  %447 = getelementptr inbounds float, ptr %currentw.0.lcssa, i64 %offset.idx1662
  %wide.load1667 = load <4 x float>, ptr %447, align 4, !tbaa !9
  %448 = fpext <4 x float> %wide.load1667 to <4 x double>
  %449 = fsub <4 x double> %448, %446
  %450 = fptrunc <4 x double> %449 to <4 x float>
  store <4 x float> %450, ptr %447, align 4, !tbaa !9
  %index.next1668 = add nuw i64 %index1659, 4
  %vec.ind.next1661 = add <4 x i32> %vec.ind1660, <i32 4, i32 4, i32 4, i32 4>
  %451 = icmp eq i64 %index.next1668, %n.vec1654
  br i1 %451, label %middle.block1649, label %vector.body1658, !llvm.loop !71

middle.block1649:                                 ; preds = %vector.body1658
  %cmp.n1657 = icmp eq i64 %442, %n.vec1654
...
for.body762.lr.ph:                                ; preds = %for.cond758.preheader
  %452 = load i32, ptr @offset, align 4, !tbaa !11
  %conv763 = sitofp i32 %452 to double
  %conv764 = sitofp i32 %conv4 to double
  %neg772 = fneg double %conv763
  %453 = add i64 %call3, 1
  %wide.trip.count1517 = and i64 %453, 4294967295
  %454 = add nsw i64 %wide.trip.count1517, -1
  %min.iters.check1671 = icmp ult i64 %454, 4
  br i1 %min.iters.check1671, label %for.body762.preheader, label %vector.ph1672

vector.ph1672:                                    ; preds = %for.body762.lr.ph
  %n.vec1674 = and i64 %454, -4
...
vector.body1678:                                  ; preds = %vector.body1678, %vector.ph1672
  ...
  %455 = sitofp <4 x i32> %vec.ind1680 to <4 x double>
  %456 = fmul <4 x double> %455, <double 5.000000e-01, double 5.000000e-01, double 5.000000e-01, double 5.000000e-01>
  %457 = fsub <4 x double> %broadcast.splat1684, %456
  %458 = getelementptr inbounds float, ptr %438, i64 %offset.idx1682
  %wide.load1685 = load <4 x float>, ptr %458, align 4, !tbaa !9
  %459 = fpext <4 x float> %wide.load1685 to <4 x double>
  %460 = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %broadcast.splat1687, <4 x double> %457, <4 x double> %459)
  %461 = fptrunc <4 x double> %460 to <4 x float>
  store <4 x float> %461, ptr %458, align 4, !tbaa !9
  %index.next1688 = add nuw i64 %index1679, 4
  %vec.ind.next1681 = add <4 x i32> %vec.ind1680, <i32 4, i32 4, i32 4, i32 4>
  %462 = icmp eq i64 %index.next1688, %n.vec1674
  br i1 %462, label %middle.block1669, label %vector.body1678, !llvm.loop !72

middle.block1669:                                 ; preds = %vector.body1678
  %cmp.n1677 = icmp eq i64 %454, %n.vec1674
...
for.body745:                                      ; preds = %for.body745.preheader, %for.body745
  ...
  %463 = trunc i64 %indvars.iv1509 to i32
  %sub746 = sub nsw i32 %conv7, %463
  %mul747 = mul nsw i32 %440, %sub746
  ...
  %464 = load float, ptr %arrayidx751, align 4, !tbaa !9
  %conv752 = fpext float %464 to double
...
for.body762:                                      ; preds = %for.body762.preheader, %for.body762
  ...
  %465 = trunc i64 %indvars.iv1514 to i32
  %conv765 = sitofp i32 %465 to double
  %div766 = fmul double %conv765, 5.000000e-01
  %sub767 = fsub double %conv764, %div766
  %arrayidx770 = getelementptr inbounds float, ptr %438, i64 %indvars.iv1514
  %466 = load float, ptr %arrayidx770, align 4, !tbaa !9
  %conv771 = fpext float %466 to double
  %467 = tail call double @llvm.fmuladd.f64(double %neg772, double %sub767, double %conv771)
  %conv773 = fptrunc double %467 to float
...
if.end777:                                        ; preds = %for.body762, %middle.block1669, %for.cond758.preheader, %for.end738
  %468 = load ptr, ptr @R__align.mseq1, align 8, !tbaa !5
  %469 = load ptr, ptr @R__align.mseq2, align 8, !tbaa !5
  %470 = load ptr, ptr @R__align.ijp, align 8, !tbaa !5
  %471 = load ptr, ptr %seq1, align 8, !tbaa !5
  %call.i1263 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %471) #14
  %conv.i1264 = trunc i64 %call.i1263 to i32
  %472 = load ptr, ptr %seq2, align 8, !tbaa !5
  %call2.i1265 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %472) #14
  %conv3.i1266 = trunc i64 %call2.i1265 to i32
  %add.i1267 = add nsw i32 %conv3.i1266, %conv.i1264
  %add4.i1268 = add nsw i32 %add.i1267, 1
  %call5.i1269 = tail call ptr @AllocateCharVec(i32 noundef %add4.i1268) #13
  %call8.i1270 = tail call ptr @AllocateCharVec(i32 noundef %add4.i1268) #13
  %473 = load i32, ptr @outgap, align 4, !tbaa !11
  %cmp.i1271 = icmp eq i32 %473, 1
...
if.else.i:                                        ; preds = %if.then779
  %474 = load float, ptr %438, align 4, !tbaa !9
...
for.body.lr.ph.i1253:                             ; preds = %if.else.i
  ...
  %arrayidx21.i = getelementptr inbounds ptr, ptr %470, i64 %idxprom20.i
  ...
  %475 = icmp eq i64 %wide.trip.count.i1252, 1
  br i1 %475, label %for.cond24.preheader.i.loopexit.unr-lcssa, label %for.body.lr.ph.i1253.new
...
for.cond24.preheader.i.loopexit.unr-lcssa:        ; preds = %for.inc.i.1, %for.body.lr.ph.i1253
  ...
  %wm.02.i.unr = phi float [ %474, %for.body.lr.ph.i1253 ], [ %wm.1.i.1, %for.inc.i.1 ]
...
for.body.i1255.epil:                              ; preds = %for.cond24.preheader.i.loopexit.unr-lcssa
  %arrayidx13.i.epil = getelementptr inbounds float, ptr %438, i64 %indvars.iv.i1254.unr
  %476 = load float, ptr %arrayidx13.i.epil, align 4, !tbaa !9
  %cmp14.i.epil = fcmp ult float %476, %wm.02.i.unr
  br i1 %cmp14.i.epil, label %for.cond24.preheader.i, label %if.then16.i.epil

if.then16.i.epil:                                 ; preds = %for.body.i1255.epil
  %477 = trunc i64 %indvars.iv.i1254.unr to i32
  %sub19.i.epil = sub nsw i32 %conv.i1264, %477
  %478 = load ptr, ptr %arrayidx21.i, align 8, !tbaa !5
  %arrayidx23.i.epil = getelementptr inbounds i32, ptr %478, i64 %idxprom22.i
...
for.cond24.preheader.i:                           ; preds = %for.cond24.preheader.i.loopexit.unr-lcssa, %if.then16.i.epil, %for.body.i1255.epil, %if.else.i
  %wm.0.lcssa.i = phi float [ %474, %if.else.i ], [ %wm.1.i.lcssa.ph, %for.cond24.preheader.i.loopexit.unr-lcssa ], [ %476, %if.then16.i.epil ], [ %wm.02.i.unr, %for.body.i1255.epil ]
...
for.body27.lr.ph.i:                               ; preds = %for.cond24.preheader.i
  ...
  %arrayidx39.i = getelementptr inbounds ptr, ptr %470, i64 %idxprom38.i
  ...
  %479 = icmp eq i64 %wide.trip.count47.i, 1
  br i1 %479, label %if.end46.i.loopexit.unr-lcssa, label %for.body27.lr.ph.i.new
...
for.body.i1255:                                   ; preds = %for.inc.i.1, %for.body.lr.ph.i1253.new
  ...
  %wm.02.i = phi float [ %474, %for.body.lr.ph.i1253.new ], [ %wm.1.i.1, %for.inc.i.1 ]
  %niter1862 = phi i64 [ 0, %for.body.lr.ph.i1253.new ], [ %niter1862.next.1, %for.inc.i.1 ]
  %arrayidx13.i = getelementptr inbounds float, ptr %438, i64 %indvars.iv.i1254
  %480 = load float, ptr %arrayidx13.i, align 4, !tbaa !9
  %cmp14.i = fcmp ult float %480, %wm.02.i
  br i1 %cmp14.i, label %for.inc.i, label %if.then16.i

if.then16.i:                                      ; preds = %for.body.i1255
  %481 = trunc i64 %indvars.iv.i1254 to i32
  %sub19.i = sub nsw i32 %conv.i1264, %481
  %482 = load ptr, ptr %arrayidx21.i, align 8, !tbaa !5
  %arrayidx23.i = getelementptr inbounds i32, ptr %482, i64 %idxprom22.i
  store i32 %sub19.i, ptr %arrayidx23.i, align 4, !tbaa !11
  br label %for.inc.i

for.inc.i:                                        ; preds = %if.then16.i, %for.body.i1255
  %wm.1.i = phi float [ %480, %if.then16.i ], [ %wm.02.i, %for.body.i1255 ]
  %indvars.iv.next.i1256 = or i64 %indvars.iv.i1254, 1
  %arrayidx13.i.1 = getelementptr inbounds float, ptr %438, i64 %indvars.iv.next.i1256
  %483 = load float, ptr %arrayidx13.i.1, align 4, !tbaa !9
  %cmp14.i.1 = fcmp ult float %483, %wm.1.i
  br i1 %cmp14.i.1, label %for.inc.i.1, label %if.then16.i.1

if.then16.i.1:                                    ; preds = %for.inc.i
  %484 = trunc i64 %indvars.iv.next.i1256 to i32
  %sub19.i.1 = sub nsw i32 %conv.i1264, %484
  %485 = load ptr, ptr %arrayidx21.i, align 8, !tbaa !5
  %arrayidx23.i.1 = getelementptr inbounds i32, ptr %485, i64 %idxprom22.i
  store i32 %sub19.i.1, ptr %arrayidx23.i.1, align 4, !tbaa !11
  br label %for.inc.i.1

for.inc.i.1:                                      ; preds = %if.then16.i.1, %for.inc.i
  %wm.1.i.1 = phi float [ %483, %if.then16.i.1 ], [ %wm.1.i, %for.inc.i ]
...
for.body27.i:                                     ; preds = %for.inc43.i.1, %for.body27.lr.ph.i.new
  ...
  %486 = load float, ptr %arrayidx29.i, align 4, !tbaa !9
  %cmp30.i = fcmp ult float %486, %wm.25.i
  br i1 %cmp30.i, label %for.inc43.i, label %if.then32.i

if.then32.i:                                      ; preds = %for.body27.i
  %487 = trunc i64 %indvars.iv44.i to i32
  %sub36.neg.i = sub i32 %487, %conv3.i1266
  %488 = load ptr, ptr %arrayidx39.i, align 8, !tbaa !5
  %arrayidx41.i = getelementptr inbounds i32, ptr %488, i64 %idxprom40.i
  store i32 %sub36.neg.i, ptr %arrayidx41.i, align 4, !tbaa !11
  br label %for.inc43.i

for.inc43.i:                                      ; preds = %if.then32.i, %for.body27.i
  %wm.3.i = phi float [ %486, %if.then32.i ], [ %wm.25.i, %for.body27.i ]
  ...
  %489 = load float, ptr %arrayidx29.i.1, align 4, !tbaa !9
  %cmp30.i.1 = fcmp ult float %489, %wm.3.i
  br i1 %cmp30.i.1, label %for.inc43.i.1, label %if.then32.i.1

if.then32.i.1:                                    ; preds = %for.inc43.i
  %490 = trunc i64 %indvars.iv.next45.i to i32
  %sub36.neg.i.1 = sub i32 %490, %conv3.i1266
  %491 = load ptr, ptr %arrayidx39.i, align 8, !tbaa !5
  %arrayidx41.i.1 = getelementptr inbounds i32, ptr %491, i64 %idxprom40.i
...
for.inc43.i.1:                                    ; preds = %if.then32.i.1, %for.inc43.i
  %wm.3.i.1 = phi float [ %489, %if.then32.i.1 ], [ %wm.3.i, %for.inc43.i ]
...
for.body27.i.epil:                                ; preds = %if.end46.i.loopexit.unr-lcssa
  ...
  %492 = load float, ptr %arrayidx29.i.epil, align 4, !tbaa !9
  %cmp30.i.epil = fcmp ult float %492, %wm.25.i.unr
  br i1 %cmp30.i.epil, label %if.end46.i, label %if.then32.i.epil

if.then32.i.epil:                                 ; preds = %for.body27.i.epil
  %493 = trunc i64 %indvars.iv44.i.unr to i32
  %sub36.neg.i.epil = sub i32 %493, %conv3.i1266
  %494 = load ptr, ptr %arrayidx39.i, align 8, !tbaa !5
  %arrayidx41.i.epil = getelementptr inbounds i32, ptr %494, i64 %idxprom40.i
...
for.body51.preheader.i:                           ; preds = %if.end46.i
  %495 = add i64 %call.i1263, 1
  %wide.trip.count52.i = and i64 %495, 4294967295
  %496 = add nsw i64 %wide.trip.count52.i, -1
  %xtraiter1868 = and i64 %495, 7
  %497 = icmp ult i64 %496, 7
  br i1 %497, label %for.cond59.preheader.i.loopexit.unr-lcssa, label %for.body51.preheader.i.new
...
for.body51.i.epil:                                ; preds = %for.cond59.preheader.i.loopexit.unr-lcssa, %for.body51.i.epil
  ...
  %arrayidx54.i.epil = getelementptr inbounds ptr, ptr %470, i64 %indvars.iv49.i.epil
  %498 = load ptr, ptr %arrayidx54.i.epil, align 8, !tbaa !5
  %499 = trunc i64 %indvars.iv.next50.i.epil to i32
  store i32 %499, ptr %498, align 4, !tbaa !11
...
for.body63.lr.ph.i:                               ; preds = %for.cond59.preheader.i
  %500 = load ptr, ptr %470, align 8, !tbaa !5
  %501 = add i64 %call2.i1265, 1
  %wide.trip.count58.i = and i64 %501, 4294967295
...
vector.body1697:                                  ; preds = %vector.body1697, %vector.ph1692
  ...
  %502 = xor <4 x i32> %vec.ind1699, <i32 -1, i32 -1, i32 -1, i32 -1>
  %503 = sub <4 x i32> <i32 -5, i32 -5, i32 -5, i32 -5>, %vec.ind1699
  %504 = getelementptr inbounds i32, ptr %500, i64 %index1698
  store <4 x i32> %502, ptr %504, align 4, !tbaa !11
  %505 = getelementptr inbounds i32, ptr %504, i64 4
  store <4 x i32> %503, ptr %505, align 4, !tbaa !11
  %index.next1702 = add nuw i64 %index1698, 8
  %vec.ind.next1701 = add <4 x i32> %vec.ind1699, <i32 8, i32 8, i32 8, i32 8>
  %506 = icmp eq i64 %index.next1702, %n.vec1694
  br i1 %506, label %middle.block1689, label %vector.body1697, !llvm.loop !78
...
for.body51.i:                                     ; preds = %for.body51.i, %for.body51.preheader.i.new
  ...
  %arrayidx54.i = getelementptr inbounds ptr, ptr %470, i64 %indvars.iv49.i
  %507 = load ptr, ptr %arrayidx54.i, align 8, !tbaa !5
  %508 = trunc i64 %indvars.iv.next50.i to i32
  store i32 %508, ptr %507, align 4, !tbaa !11
  %indvars.iv.next50.i.1 = or i64 %indvars.iv49.i, 2
  %arrayidx54.i.1 = getelementptr inbounds ptr, ptr %470, i64 %indvars.iv.next50.i
  %509 = load ptr, ptr %arrayidx54.i.1, align 8, !tbaa !5
  %510 = trunc i64 %indvars.iv.next50.i.1 to i32
  store i32 %510, ptr %509, align 4, !tbaa !11
  %indvars.iv.next50.i.2 = or i64 %indvars.iv49.i, 3
  %arrayidx54.i.2 = getelementptr inbounds ptr, ptr %470, i64 %indvars.iv.next50.i.1
  %511 = load ptr, ptr %arrayidx54.i.2, align 8, !tbaa !5
  %512 = trunc i64 %indvars.iv.next50.i.2 to i32
  store i32 %512, ptr %511, align 4, !tbaa !11
  %indvars.iv.next50.i.3 = or i64 %indvars.iv49.i, 4
  %arrayidx54.i.3 = getelementptr inbounds ptr, ptr %470, i64 %indvars.iv.next50.i.2
  %513 = load ptr, ptr %arrayidx54.i.3, align 8, !tbaa !5
  %514 = trunc i64 %indvars.iv.next50.i.3 to i32
  store i32 %514, ptr %513, align 4, !tbaa !11
  %indvars.iv.next50.i.4 = or i64 %indvars.iv49.i, 5
  %arrayidx54.i.4 = getelementptr inbounds ptr, ptr %470, i64 %indvars.iv.next50.i.3
  %515 = load ptr, ptr %arrayidx54.i.4, align 8, !tbaa !5
  %516 = trunc i64 %indvars.iv.next50.i.4 to i32
  store i32 %516, ptr %515, align 4, !tbaa !11
  %indvars.iv.next50.i.5 = or i64 %indvars.iv49.i, 6
  %arrayidx54.i.5 = getelementptr inbounds ptr, ptr %470, i64 %indvars.iv.next50.i.4
  %517 = load ptr, ptr %arrayidx54.i.5, align 8, !tbaa !5
  %518 = trunc i64 %indvars.iv.next50.i.5 to i32
  store i32 %518, ptr %517, align 4, !tbaa !11
  %indvars.iv.next50.i.6 = or i64 %indvars.iv49.i, 7
  %arrayidx54.i.6 = getelementptr inbounds ptr, ptr %470, i64 %indvars.iv.next50.i.5
  %519 = load ptr, ptr %arrayidx54.i.6, align 8, !tbaa !5
  %520 = trunc i64 %indvars.iv.next50.i.6 to i32
  store i32 %520, ptr %519, align 4, !tbaa !11
  %indvars.iv.next50.i.7 = add nuw nsw i64 %indvars.iv49.i, 8
  %arrayidx54.i.7 = getelementptr inbounds ptr, ptr %470, i64 %indvars.iv.next50.i.6
  %521 = load ptr, ptr %arrayidx54.i.7, align 8, !tbaa !5
  %522 = trunc i64 %indvars.iv.next50.i.7 to i32
...
for.body63.i:                                     ; preds = %for.body63.i.preheader, %for.body63.i
  ...
  %arrayidx68.i = getelementptr inbounds i32, ptr %500, i64 %indvars.iv54.i
...
for.body82.lr.ph.i:                               ; preds = %for.end71.i
  %523 = load ptr, ptr @impmtx, align 8
...
for.body82.i:                                     ; preds = %if.end142.i, %for.body82.lr.ph.i
  ...
  %iin.031.i = phi i32 [ %conv.i1264, %for.body82.lr.ph.i ], [ %ifi.0.i, %if.end142.i ]
  %jin.030.i = phi i32 [ %conv3.i1266, %for.body82.lr.ph.i ], [ %jfi.0.i, %if.end142.i ]
  ...
  %arrayidx84.i = getelementptr inbounds ptr, ptr %470, i64 %idxprom83.i
  %524 = load ptr, ptr %arrayidx84.i, align 8, !tbaa !5
  %idxprom85.i = sext i32 %jin.030.i to i64
  %arrayidx86.i = getelementptr inbounds i32, ptr %524, i64 %idxprom85.i
  %525 = load i32, ptr %arrayidx86.i, align 4, !tbaa !11
  %cmp87.i = icmp slt i32 %525, 0
...
if.end114.i:                                      ; preds = %if.else110.i, %if.then103.i, %if.then89.i
  ...
  %.pn.i = phi i32 [ %525, %if.then89.i ], [ -1, %if.then103.i ], [ -1, %if.else110.i ]
  %jfi.0.i = add nsw i32 %.pn.i, %jin.030.i
  %526 = xor i32 %ifi.0.i, -1
  %dec11.i = add i32 %iin.031.i, %526
...
while.body.preheader.i1258:                       ; preds = %if.end114.i
  %527 = add i32 %iin.031.i, -1
  %528 = add i32 %iin.031.i, -2
  %529 = sub i32 %528, %ifi.0.i
  %530 = zext i32 %529 to i64
  %531 = add nuw nsw i64 %530, 1
  %min.iters.check1735 = icmp ult i32 %529, 15
  %532 = sub i64 %gaptable1.033.i1730, %gaptable2.034.i1731
  %diff.check1732 = icmp ult i64 %532, 16
...
vector.ph1736:                                    ; preds = %while.body.preheader.i1258
  %n.vec1738 = and i64 %531, -16
  %.cast1739 = trunc i64 %n.vec1738 to i32
  %ind.end1740 = sub i32 %dec11.i, %.cast1739
  %533 = sub nsw i64 0, %n.vec1738
  %ind.end1742 = getelementptr i8, ptr %gaptable2.034.i, i64 %533
  %534 = sub nsw i64 0, %n.vec1738
  %ind.end1744 = getelementptr i8, ptr %gaptable1.033.i, i64 %534
  %535 = getelementptr i8, ptr %gaptable1.033.i, i64 -16
  %536 = getelementptr i8, ptr %gaptable2.034.i, i64 -16
...
vector.body1747:                                  ; preds = %vector.body1747, %vector.ph1736
  ...
  %537 = sub i64 0, %index1748
  %538 = sub i64 0, %index1748
  %539 = getelementptr i8, ptr %535, i64 %538
  store <16 x i8> <i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111>, ptr %539, align 1, !tbaa !13
  %540 = getelementptr i8, ptr %536, i64 %537
  store <16 x i8> <i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45>, ptr %540, align 1, !tbaa !13
  %index.next1751 = add nuw i64 %index1748, 16
  %541 = icmp eq i64 %index.next1751, %n.vec1738
  br i1 %541, label %middle.block1733, label %vector.body1747, !llvm.loop !81

middle.block1733:                                 ; preds = %vector.body1747
  %cmp.n1746 = icmp eq i64 %531, %n.vec1738
...
while.body.i1262.prol.loopexit:                   ; preds = %while.body.i1262.prol, %while.body.i1262.preheader
  ...
  br i1 %543, label %while.end.loopexit.i, label %while.body.i1262
...
while.end.loopexit.i:                             ; preds = %while.body.i1262.prol.loopexit, %while.body.i1262, %middle.block1733
  ...
  %544 = add i32 %527, %k.032.i
  %545 = sub i32 %544, %ifi.0.i
  br label %while.end.i

while.end.i:                                      ; preds = %while.end.loopexit.i, %if.end114.i
  %k.1.lcssa.i = phi i32 [ %k.032.i, %if.end114.i ], [ %545, %while.end.loopexit.i ]
...
while.body122.preheader.i:                        ; preds = %while.end.i
  ...
  %min.iters.check1709 = icmp ult i32 %546, 7
  %549 = sub i64 %gaptable1.1.lcssa.i1704, %gaptable2.1.lcssa.i1705
  %diff.check1706 = icmp ult i64 %549, 8
...
vector.ph1710:                                    ; preds = %while.body122.preheader.i
  %n.vec1712 = and i64 %548, -8
  %.cast1713 = trunc i64 %n.vec1712 to i32
  %ind.end1714 = sub i32 %dec12020.i, %.cast1713
  %550 = sub nsw i64 0, %n.vec1712
  %ind.end1716 = getelementptr i8, ptr %gaptable2.1.lcssa.i, i64 %550
  %551 = sub nsw i64 0, %n.vec1712
  %ind.end1718 = getelementptr i8, ptr %gaptable1.1.lcssa.i, i64 %551
  %552 = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %k.1.lcssa.i, i64 0
...
vector.body1721:                                  ; preds = %vector.body1721, %vector.ph1710
  ...
  %vec.phi = phi <4 x i32> [ %552, %vector.ph1710 ], [ %563, %vector.body1721 ]
  %vec.phi1727 = phi <4 x i32> [ zeroinitializer, %vector.ph1710 ], [ %564, %vector.body1721 ]
  %553 = sub i64 0, %index1722
  %554 = sub i64 0, %index1722
  %555 = getelementptr i8, ptr %next.gep17251825, i64 %554
  %556 = getelementptr inbounds i8, ptr %555, i64 -3
  store <4 x i8> <i8 45, i8 45, i8 45, i8 45>, ptr %556, align 1, !tbaa !13
  %557 = getelementptr inbounds i8, ptr %555, i64 -4
  %558 = getelementptr inbounds i8, ptr %557, i64 -3
  store <4 x i8> <i8 45, i8 45, i8 45, i8 45>, ptr %558, align 1, !tbaa !13
  %559 = getelementptr i8, ptr %next.gep17231826, i64 %553
  %560 = getelementptr inbounds i8, ptr %559, i64 -3
  store <4 x i8> <i8 111, i8 111, i8 111, i8 111>, ptr %560, align 1, !tbaa !13
  %561 = getelementptr inbounds i8, ptr %559, i64 -4
  %562 = getelementptr inbounds i8, ptr %561, i64 -3
  store <4 x i8> <i8 111, i8 111, i8 111, i8 111>, ptr %562, align 1, !tbaa !13
  %563 = add <4 x i32> %vec.phi, <i32 1, i32 1, i32 1, i32 1>
  %564 = add <4 x i32> %vec.phi1727, <i32 1, i32 1, i32 1, i32 1>
  %index.next1728 = add nuw i64 %index1722, 8
  %565 = icmp eq i64 %index.next1728, %n.vec1712
  br i1 %565, label %middle.block1707, label %vector.body1721, !llvm.loop !84

middle.block1707:                                 ; preds = %vector.body1721
  %bin.rdx = add <4 x i32> %564, %563
  %566 = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx)
  %cmp.n1720 = icmp eq i64 %548, %n.vec1712
...
while.body122.i.preheader:                        ; preds = %while.body122.preheader.i, %middle.block1707
  ...
  %k.222.i.ph = phi i32 [ %k.1.lcssa.i, %while.body122.preheader.i ], [ %566, %middle.block1707 ]
  %567 = add nsw i32 %dec12025.i.ph, -1
...
while.body122.i.prol.loopexit:                    ; preds = %while.body122.i.prol, %while.body122.i.preheader
  ...
  %568 = icmp ult i32 %567, 3
  br i1 %568, label %while.end126.i, label %while.body122.i
...
while.end126.i:                                   ; preds = %while.body122.i.prol.loopexit, %while.body122.i, %middle.block1707, %while.end.i
  %k.2.lcssa.i = phi i32 [ %k.1.lcssa.i, %while.end.i ], [ %566, %middle.block1707 ], [ %inc125.i.lcssa.unr, %while.body122.i.prol.loopexit ], [ %inc125.i.3, %while.body122.i ]
...
if.else132.i:                                     ; preds = %while.end126.i
  %arrayidx.i.i = getelementptr inbounds ptr, ptr %523, i64 %idxprom83.i
  %569 = load ptr, ptr %arrayidx.i.i, align 8, !tbaa !5
  %arrayidx2.i.i = getelementptr inbounds float, ptr %569, i64 %idxprom85.i
  %570 = load float, ptr %arrayidx2.i.i, align 4, !tbaa !9
  %571 = load float, ptr %impmatch, align 4, !tbaa !9
  %add134.i = fadd float %570, %571
...
for.body152.i:                                    ; preds = %for.body152.i, %for.body152.preheader.i
  ...
  %arrayidx154.i = getelementptr inbounds ptr, ptr %468, i64 %indvars.iv64.i
  %572 = load ptr, ptr %arrayidx154.i, align 8, !tbaa !5
  %arrayidx156.i = getelementptr inbounds ptr, ptr %seq1, i64 %indvars.iv64.i
  %573 = load ptr, ptr %arrayidx156.i, align 8, !tbaa !5
  tail call void @gapireru(ptr noundef %572, ptr noundef %573, ptr noundef %gaptable1.3.i) #13
...
for.body163.i:                                    ; preds = %for.body163.i, %for.body163.preheader.i
  ...
  %arrayidx165.i = getelementptr inbounds ptr, ptr %469, i64 %indvars.iv69.i
  %574 = load ptr, ptr %arrayidx165.i, align 8, !tbaa !5
  %arrayidx167.i = getelementptr inbounds ptr, ptr %seq2, i64 %indvars.iv69.i
  %575 = load ptr, ptr %arrayidx167.i, align 8, !tbaa !5
  tail call void @gapireru(ptr noundef %574, ptr noundef %575, ptr noundef %gaptable2.3.i) #13
...
if.else.i1273:                                    ; preds = %if.else780
  %576 = load float, ptr %438, align 4, !tbaa !9
...
for.body.lr.ph.i1278:                             ; preds = %if.else.i1273
  ...
  %arrayidx21.i1275 = getelementptr inbounds ptr, ptr %470, i64 %idxprom20.i1274
  ...
  %577 = icmp eq i64 %wide.trip.count.i1277, 1
  br i1 %577, label %for.cond24.preheader.i1281.loopexit.unr-lcssa, label %for.body.lr.ph.i1278.new
...
for.cond24.preheader.i1281.loopexit.unr-lcssa:    ; preds = %for.inc.i1298.1, %for.body.lr.ph.i1278
  ...
  %wm.02.i1288.unr = phi float [ %576, %for.body.lr.ph.i1278 ], [ %wm.1.i1295.1, %for.inc.i1298.1 ]
...
for.body.i1291.epil:                              ; preds = %for.cond24.preheader.i1281.loopexit.unr-lcssa
  %arrayidx13.i1289.epil = getelementptr inbounds float, ptr %438, i64 %indvars.iv.i1287.unr
  %578 = load float, ptr %arrayidx13.i1289.epil, align 4, !tbaa !9
  %cmp14.i1290.epil = fcmp ult float %578, %wm.02.i1288.unr
...
if.then16.i1294.epil:                             ; preds = %for.body.i1291.epil
  %579 = trunc i64 %indvars.iv.i1287.unr to i32
  %sub19.i1292.epil = sub nsw i32 %conv.i1264, %579
  %580 = load ptr, ptr %arrayidx21.i1275, align 8, !tbaa !5
  %arrayidx23.i1293.epil = getelementptr inbounds i32, ptr %580, i64 %idxprom22.i1276
...
for.cond24.preheader.i1281:                       ; preds = %for.cond24.preheader.i1281.loopexit.unr-lcssa, %if.then16.i1294.epil, %for.body.i1291.epil, %if.else.i1273
  %wm.0.lcssa.i1279 = phi float [ %576, %if.else.i1273 ], [ %wm.1.i1295.lcssa.ph, %for.cond24.preheader.i1281.loopexit.unr-lcssa ], [ %578, %if.then16.i1294.epil ], [ %wm.02.i1288.unr, %for.body.i1291.epil ]
...
for.body27.lr.ph.i1286:                           ; preds = %for.cond24.preheader.i1281
  ...
  %arrayidx39.i1283 = getelementptr inbounds ptr, ptr %470, i64 %idxprom38.i1282
  ...
  %581 = icmp eq i64 %wide.trip.count47.i1285, 1
  br i1 %581, label %if.end46.i1312.loopexit.unr-lcssa, label %for.body27.lr.ph.i1286.new
...
for.body.i1291:                                   ; preds = %for.inc.i1298.1, %for.body.lr.ph.i1278.new
  ...
  %wm.02.i1288 = phi float [ %576, %for.body.lr.ph.i1278.new ], [ %wm.1.i1295.1, %for.inc.i1298.1 ]
  %niter1884 = phi i64 [ 0, %for.body.lr.ph.i1278.new ], [ %niter1884.next.1, %for.inc.i1298.1 ]
  %arrayidx13.i1289 = getelementptr inbounds float, ptr %438, i64 %indvars.iv.i1287
  %582 = load float, ptr %arrayidx13.i1289, align 4, !tbaa !9
  %cmp14.i1290 = fcmp ult float %582, %wm.02.i1288
  br i1 %cmp14.i1290, label %for.inc.i1298, label %if.then16.i1294

if.then16.i1294:                                  ; preds = %for.body.i1291
  %583 = trunc i64 %indvars.iv.i1287 to i32
  %sub19.i1292 = sub nsw i32 %conv.i1264, %583
  %584 = load ptr, ptr %arrayidx21.i1275, align 8, !tbaa !5
  %arrayidx23.i1293 = getelementptr inbounds i32, ptr %584, i64 %idxprom22.i1276
...
for.inc.i1298:                                    ; preds = %if.then16.i1294, %for.body.i1291
  %wm.1.i1295 = phi float [ %582, %if.then16.i1294 ], [ %wm.02.i1288, %for.body.i1291 ]
  %indvars.iv.next.i1296 = or i64 %indvars.iv.i1287, 1
  %arrayidx13.i1289.1 = getelementptr inbounds float, ptr %438, i64 %indvars.iv.next.i1296
  %585 = load float, ptr %arrayidx13.i1289.1, align 4, !tbaa !9
  %cmp14.i1290.1 = fcmp ult float %585, %wm.1.i1295
  br i1 %cmp14.i1290.1, label %for.inc.i1298.1, label %if.then16.i1294.1

if.then16.i1294.1:                                ; preds = %for.inc.i1298
  %586 = trunc i64 %indvars.iv.next.i1296 to i32
  %sub19.i1292.1 = sub nsw i32 %conv.i1264, %586
  %587 = load ptr, ptr %arrayidx21.i1275, align 8, !tbaa !5
  %arrayidx23.i1293.1 = getelementptr inbounds i32, ptr %587, i64 %idxprom22.i1276
...
for.inc.i1298.1:                                  ; preds = %if.then16.i1294.1, %for.inc.i1298
  %wm.1.i1295.1 = phi float [ %585, %if.then16.i1294.1 ], [ %wm.1.i1295, %for.inc.i1298 ]
...
for.body27.i1303:                                 ; preds = %for.inc43.i1310.1, %for.body27.lr.ph.i1286.new
  ...
  %588 = load float, ptr %arrayidx29.i1301, align 4, !tbaa !9
  %cmp30.i1302 = fcmp ult float %588, %wm.25.i1300
  br i1 %cmp30.i1302, label %for.inc43.i1310, label %if.then32.i1306

if.then32.i1306:                                  ; preds = %for.body27.i1303
  %589 = trunc i64 %indvars.iv44.i1299 to i32
  %sub36.neg.i1304 = sub i32 %589, %conv3.i1266
  %590 = load ptr, ptr %arrayidx39.i1283, align 8, !tbaa !5
  %arrayidx41.i1305 = getelementptr inbounds i32, ptr %590, i64 %idxprom40.i1284
...
for.inc43.i1310:                                  ; preds = %if.then32.i1306, %for.body27.i1303
  %wm.3.i1307 = phi float [ %588, %if.then32.i1306 ], [ %wm.25.i1300, %for.body27.i1303 ]
  ...
  %591 = load float, ptr %arrayidx29.i1301.1, align 4, !tbaa !9
  %cmp30.i1302.1 = fcmp ult float %591, %wm.3.i1307
  br i1 %cmp30.i1302.1, label %for.inc43.i1310.1, label %if.then32.i1306.1

if.then32.i1306.1:                                ; preds = %for.inc43.i1310
  %592 = trunc i64 %indvars.iv.next45.i1308 to i32
  %sub36.neg.i1304.1 = sub i32 %592, %conv3.i1266
  %593 = load ptr, ptr %arrayidx39.i1283, align 8, !tbaa !5
  %arrayidx41.i1305.1 = getelementptr inbounds i32, ptr %593, i64 %idxprom40.i1284
...
for.inc43.i1310.1:                                ; preds = %if.then32.i1306.1, %for.inc43.i1310
  %wm.3.i1307.1 = phi float [ %591, %if.then32.i1306.1 ], [ %wm.3.i1307, %for.inc43.i1310 ]
...
for.body27.i1303.epil:                            ; preds = %if.end46.i1312.loopexit.unr-lcssa
  ...
  %594 = load float, ptr %arrayidx29.i1301.epil, align 4, !tbaa !9
  %cmp30.i1302.epil = fcmp ult float %594, %wm.25.i1300.unr
  br i1 %cmp30.i1302.epil, label %if.end46.i1312, label %if.then32.i1306.epil

if.then32.i1306.epil:                             ; preds = %for.body27.i1303.epil
  %595 = trunc i64 %indvars.iv44.i1299.unr to i32
  %sub36.neg.i1304.epil = sub i32 %595, %conv3.i1266
  %596 = load ptr, ptr %arrayidx39.i1283, align 8, !tbaa !5
  %arrayidx41.i1305.epil = getelementptr inbounds i32, ptr %596, i64 %idxprom40.i1284
...
for.body51.preheader.i1314:                       ; preds = %if.end46.i1312
  %597 = add i64 %call.i1263, 1
  %wide.trip.count52.i1313 = and i64 %597, 4294967295
  %598 = add nsw i64 %wide.trip.count52.i1313, -1
  %xtraiter1890 = and i64 %597, 7
  %599 = icmp ult i64 %598, 7
  br i1 %599, label %for.cond59.preheader.i1316.loopexit.unr-lcssa, label %for.body51.preheader.i1314.new
...
for.body51.i1323.epil:                            ; preds = %for.cond59.preheader.i1316.loopexit.unr-lcssa, %for.body51.i1323.epil
  ...
  %arrayidx54.i1321.epil = getelementptr inbounds ptr, ptr %470, i64 %indvars.iv49.i1319.epil
  %600 = load ptr, ptr %arrayidx54.i1321.epil, align 8, !tbaa !5
  %601 = trunc i64 %indvars.iv.next50.i1320.epil to i32
...
for.body63.lr.ph.i1318:                           ; preds = %for.cond59.preheader.i1316
  %602 = load ptr, ptr %470, align 8, !tbaa !5
  %603 = add i64 %call2.i1265, 1
  %wide.trip.count58.i1317 = and i64 %603, 4294967295
...
vector.body1760:                                  ; preds = %vector.body1760, %vector.ph1755
  ...
  %604 = xor <4 x i32> %vec.ind1762, <i32 -1, i32 -1, i32 -1, i32 -1>
  %605 = sub <4 x i32> <i32 -5, i32 -5, i32 -5, i32 -5>, %vec.ind1762
  %606 = getelementptr inbounds i32, ptr %602, i64 %index1761
  store <4 x i32> %604, ptr %606, align 4, !tbaa !11
  %607 = getelementptr inbounds i32, ptr %606, i64 4
  store <4 x i32> %605, ptr %607, align 4, !tbaa !11
  %index.next1766 = add nuw i64 %index1761, 8
  %vec.ind.next1765 = add <4 x i32> %vec.ind1762, <i32 8, i32 8, i32 8, i32 8>
  %608 = icmp eq i64 %index.next1766, %n.vec1757
  br i1 %608, label %middle.block1752, label %vector.body1760, !llvm.loop !93
...
for.body51.i1323:                                 ; preds = %for.body51.i1323, %for.body51.preheader.i1314.new
  ...
  %arrayidx54.i1321 = getelementptr inbounds ptr, ptr %470, i64 %indvars.iv49.i1319
  %609 = load ptr, ptr %arrayidx54.i1321, align 8, !tbaa !5
  %610 = trunc i64 %indvars.iv.next50.i1320 to i32
  store i32 %610, ptr %609, align 4, !tbaa !11
  %indvars.iv.next50.i1320.1 = or i64 %indvars.iv49.i1319, 2
  %arrayidx54.i1321.1 = getelementptr inbounds ptr, ptr %470, i64 %indvars.iv.next50.i1320
  %611 = load ptr, ptr %arrayidx54.i1321.1, align 8, !tbaa !5
  %612 = trunc i64 %indvars.iv.next50.i1320.1 to i32
  store i32 %612, ptr %611, align 4, !tbaa !11
  %indvars.iv.next50.i1320.2 = or i64 %indvars.iv49.i1319, 3
  %arrayidx54.i1321.2 = getelementptr inbounds ptr, ptr %470, i64 %indvars.iv.next50.i1320.1
  %613 = load ptr, ptr %arrayidx54.i1321.2, align 8, !tbaa !5
  %614 = trunc i64 %indvars.iv.next50.i1320.2 to i32
  store i32 %614, ptr %613, align 4, !tbaa !11
  %indvars.iv.next50.i1320.3 = or i64 %indvars.iv49.i1319, 4
  %arrayidx54.i1321.3 = getelementptr inbounds ptr, ptr %470, i64 %indvars.iv.next50.i1320.2
  %615 = load ptr, ptr %arrayidx54.i1321.3, align 8, !tbaa !5
  %616 = trunc i64 %indvars.iv.next50.i1320.3 to i32
  store i32 %616, ptr %615, align 4, !tbaa !11
  %indvars.iv.next50.i1320.4 = or i64 %indvars.iv49.i1319, 5
  %arrayidx54.i1321.4 = getelementptr inbounds ptr, ptr %470, i64 %indvars.iv.next50.i1320.3
  %617 = load ptr, ptr %arrayidx54.i1321.4, align 8, !tbaa !5
  %618 = trunc i64 %indvars.iv.next50.i1320.4 to i32
  store i32 %618, ptr %617, align 4, !tbaa !11
  %indvars.iv.next50.i1320.5 = or i64 %indvars.iv49.i1319, 6
  %arrayidx54.i1321.5 = getelementptr inbounds ptr, ptr %470, i64 %indvars.iv.next50.i1320.4
  %619 = load ptr, ptr %arrayidx54.i1321.5, align 8, !tbaa !5
  %620 = trunc i64 %indvars.iv.next50.i1320.5 to i32
  store i32 %620, ptr %619, align 4, !tbaa !11
  %indvars.iv.next50.i1320.6 = or i64 %indvars.iv49.i1319, 7
  %arrayidx54.i1321.6 = getelementptr inbounds ptr, ptr %470, i64 %indvars.iv.next50.i1320.5
  %621 = load ptr, ptr %arrayidx54.i1321.6, align 8, !tbaa !5
  %622 = trunc i64 %indvars.iv.next50.i1320.6 to i32
  store i32 %622, ptr %621, align 4, !tbaa !11
  %indvars.iv.next50.i1320.7 = add nuw nsw i64 %indvars.iv49.i1319, 8
  %arrayidx54.i1321.7 = getelementptr inbounds ptr, ptr %470, i64 %indvars.iv.next50.i1320.6
  %623 = load ptr, ptr %arrayidx54.i1321.7, align 8, !tbaa !5
  %624 = trunc i64 %indvars.iv.next50.i1320.7 to i32
  store i32 %624, ptr %623, align 4, !tbaa !11
...
for.body63.i1330:                                 ; preds = %for.body63.i1330.preheader, %for.body63.i1330
  ...
  %arrayidx68.i1328 = getelementptr inbounds i32, ptr %602, i64 %indvars.iv54.i1324
...
for.body82.i1350:                                 ; preds = %for.end71.i1339, %if.end132.i
  ...
  %arrayidx84.i1346 = getelementptr inbounds ptr, ptr %470, i64 %idxprom83.i1345
  %625 = load ptr, ptr %arrayidx84.i1346, align 8, !tbaa !5
  %idxprom85.i1347 = sext i32 %jin.030.i1344 to i64
  %arrayidx86.i1348 = getelementptr inbounds i32, ptr %625, i64 %idxprom85.i1347
  %626 = load i32, ptr %arrayidx86.i1348, align 4, !tbaa !11
  %cmp87.i1349 = icmp slt i32 %626, 0
...
if.end114.i1364:                                  ; preds = %if.else110.i1358, %if.then103.i1356, %if.then89.i1352
  ...
  %.pn.i1360 = phi i32 [ %626, %if.then89.i1352 ], [ -1, %if.then103.i1356 ], [ -1, %if.else110.i1358 ]
  %jfi.0.i1361 = add nsw i32 %.pn.i1360, %jin.030.i1344
  %627 = xor i32 %ifi.0.i1359, -1
  %dec11.i1362 = add i32 %iin.031.i1343, %627
...
while.body.preheader.i1365:                       ; preds = %if.end114.i1364
  %628 = add i32 %iin.031.i1343, -1
  %629 = add i32 %iin.031.i1343, -2
  %630 = sub i32 %629, %ifi.0.i1359
  %631 = zext i32 %630 to i64
  %632 = add nuw nsw i64 %631, 1
  %min.iters.check1802 = icmp ult i32 %630, 15
  %633 = sub i64 %gaptable1.033.i13411797, %gaptable2.034.i13401798
  %diff.check1799 = icmp ult i64 %633, 16
...
vector.ph1803:                                    ; preds = %while.body.preheader.i1365
  %n.vec1805 = and i64 %632, -16
  %.cast1806 = trunc i64 %n.vec1805 to i32
  %ind.end1807 = sub i32 %dec11.i1362, %.cast1806
  %634 = sub nsw i64 0, %n.vec1805
  %ind.end1809 = getelementptr i8, ptr %gaptable2.034.i1340, i64 %634
  %635 = sub nsw i64 0, %n.vec1805
  %ind.end1811 = getelementptr i8, ptr %gaptable1.033.i1341, i64 %635
  %636 = getelementptr i8, ptr %gaptable1.033.i1341, i64 -16
  %637 = getelementptr i8, ptr %gaptable2.034.i1340, i64 -16
...
vector.body1814:                                  ; preds = %vector.body1814, %vector.ph1803
  ...
  %638 = sub i64 0, %index1815
  %639 = sub i64 0, %index1815
  %640 = getelementptr i8, ptr %636, i64 %639
  store <16 x i8> <i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111, i8 111>, ptr %640, align 1, !tbaa !13
  %641 = getelementptr i8, ptr %637, i64 %638
  store <16 x i8> <i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45, i8 45>, ptr %641, align 1, !tbaa !13
  %index.next1818 = add nuw i64 %index1815, 16
  %642 = icmp eq i64 %index.next1818, %n.vec1805
  br i1 %642, label %middle.block1800, label %vector.body1814, !llvm.loop !96

middle.block1800:                                 ; preds = %vector.body1814
  %cmp.n1813 = icmp eq i64 %632, %n.vec1805
...
while.body.i1373.preheader:                       ; preds = %while.body.preheader.i1365, %middle.block1800
  ...
  %643 = add nsw i32 %dec16.i1366.ph, -1
...
while.body.i1373.prol.loopexit:                   ; preds = %while.body.i1373.prol, %while.body.i1373.preheader
  ...
  br i1 %644, label %while.end.loopexit.i1374, label %while.body.i1373
...
while.end.loopexit.i1374:                         ; preds = %while.body.i1373.prol.loopexit, %while.body.i1373, %middle.block1800
  ...
  %645 = add i32 %628, %k.032.i1342
  %646 = sub i32 %645, %ifi.0.i1359
  br label %while.end.i1379

while.end.i1379:                                  ; preds = %while.end.loopexit.i1374, %if.end114.i1364
  %k.1.lcssa.i1375 = phi i32 [ %k.032.i1342, %if.end114.i1364 ], [ %646, %while.end.loopexit.i1374 ]
...
while.body122.preheader.i1381:                    ; preds = %while.end.i1379
  ...
  %647 = sub i32 -2, %.pn.i1360
  %648 = zext i32 %647 to i64
  %649 = add nuw nsw i64 %648, 1
  %min.iters.check1773 = icmp ult i32 %647, 7
  %650 = sub i64 %gaptable1.1.lcssa.i13761768, %gaptable2.1.lcssa.i13771769
  %diff.check1770 = icmp ult i64 %650, 8
...
vector.ph1774:                                    ; preds = %while.body122.preheader.i1381
  %n.vec1776 = and i64 %649, -8
  %.cast1777 = trunc i64 %n.vec1776 to i32
  %ind.end1778 = sub i32 %dec12020.i1380, %.cast1777
  %651 = sub nsw i64 0, %n.vec1776
  %ind.end1780 = getelementptr i8, ptr %gaptable2.1.lcssa.i1377, i64 %651
  %652 = sub nsw i64 0, %n.vec1776
  %ind.end1782 = getelementptr i8, ptr %gaptable1.1.lcssa.i1376, i64 %652
  %653 = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %k.1.lcssa.i1375, i64 0
...
vector.body1785:                                  ; preds = %vector.body1785, %vector.ph1774
  ...
  %vec.phi1791 = phi <4 x i32> [ %653, %vector.ph1774 ], [ %664, %vector.body1785 ]
  %vec.phi1792 = phi <4 x i32> [ zeroinitializer, %vector.ph1774 ], [ %665, %vector.body1785 ]
  %654 = sub i64 0, %index1786
  %655 = sub i64 0, %index1786
  %656 = getelementptr i8, ptr %next.gep17891829, i64 %655
  %657 = getelementptr inbounds i8, ptr %656, i64 -3
  store <4 x i8> <i8 45, i8 45, i8 45, i8 45>, ptr %657, align 1, !tbaa !13
  %658 = getelementptr inbounds i8, ptr %656, i64 -4
  %659 = getelementptr inbounds i8, ptr %658, i64 -3
  store <4 x i8> <i8 45, i8 45, i8 45, i8 45>, ptr %659, align 1, !tbaa !13
  %660 = getelementptr i8, ptr %next.gep17871830, i64 %654
  %661 = getelementptr inbounds i8, ptr %660, i64 -3
  store <4 x i8> <i8 111, i8 111, i8 111, i8 111>, ptr %661, align 1, !tbaa !13
  %662 = getelementptr inbounds i8, ptr %660, i64 -4
  %663 = getelementptr inbounds i8, ptr %662, i64 -3
  store <4 x i8> <i8 111, i8 111, i8 111, i8 111>, ptr %663, align 1, !tbaa !13
  %664 = add <4 x i32> %vec.phi1791, <i32 1, i32 1, i32 1, i32 1>
  %665 = add <4 x i32> %vec.phi1792, <i32 1, i32 1, i32 1, i32 1>
  %index.next1793 = add nuw i64 %index1786, 8
  %666 = icmp eq i64 %index.next1793, %n.vec1776
  br i1 %666, label %middle.block1771, label %vector.body1785, !llvm.loop !99

middle.block1771:                                 ; preds = %vector.body1785
  %bin.rdx1794 = add <4 x i32> %665, %664
  %667 = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %bin.rdx1794)
  %cmp.n1784 = icmp eq i64 %649, %n.vec1776
...
while.body122.i1391.preheader:                    ; preds = %while.body122.preheader.i1381, %middle.block1771
  ...
  %k.222.i1385.ph = phi i32 [ %k.1.lcssa.i1375, %while.body122.preheader.i1381 ], [ %667, %middle.block1771 ]
  %668 = add nsw i32 %dec12025.i1382.ph, -1
...
while.body122.i1391.prol.loopexit:                ; preds = %while.body122.i1391.prol, %while.body122.i1391.preheader
  ...
  br i1 %669, label %while.end126.i1398, label %while.body122.i1391
...
while.end126.i1398:                               ; preds = %while.body122.i1391.prol.loopexit, %while.body122.i1391, %middle.block1771, %while.end.i1379
  %k.2.lcssa.i1392 = phi i32 [ %k.1.lcssa.i1375, %while.end.i1379 ], [ %667, %middle.block1771 ], [ %inc125.i1388.lcssa.unr, %while.body122.i1391.prol.loopexit ], [ %inc125.i1388.3, %while.body122.i1391 ]
...
for.body142.i:                                    ; preds = %for.body142.i, %for.body142.preheader.i
  ...
  %arrayidx144.i = getelementptr inbounds ptr, ptr %468, i64 %indvars.iv64.i1404
  %670 = load ptr, ptr %arrayidx144.i, align 8, !tbaa !5
  %arrayidx146.i = getelementptr inbounds ptr, ptr %seq1, i64 %indvars.iv64.i1404
  %671 = load ptr, ptr %arrayidx146.i, align 8, !tbaa !5
  tail call void @gapireru(ptr noundef %670, ptr noundef %671, ptr noundef %gaptable1.3.i1400) #13
...
for.body153.i:                                    ; preds = %for.body153.i, %for.body153.preheader.i
  ...
  %arrayidx155.i = getelementptr inbounds ptr, ptr %469, i64 %indvars.iv69.i1407
  %672 = load ptr, ptr %arrayidx155.i, align 8, !tbaa !5
  %arrayidx157.i = getelementptr inbounds ptr, ptr %seq2, i64 %indvars.iv69.i1407
  %673 = load ptr, ptr %arrayidx157.i, align 8, !tbaa !5
  tail call void @gapireru(ptr noundef %672, ptr noundef %673, ptr noundef %gaptable2.3.i1401) #13
...
if.end782:                                        ; preds = %for.body163.i, %for.body153.i, %for.cond150.preheader.i, %for.cond160.preheader.i
  tail call void @free(ptr noundef %call5.i1269) #13
  tail call void @free(ptr noundef %call8.i1270) #13
  %674 = load ptr, ptr @R__align.mseq1, align 8, !tbaa !5
  %675 = load ptr, ptr %674, align 8, !tbaa !5
  %call784 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %675) #14
...
if.then791:                                       ; preds = %if.end782
  %676 = load ptr, ptr @stderr, align 8, !tbaa !5
  %call792 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %676, ptr noundef nonnull @.str, i32 noundef %alloclen, i32 noundef %conv785, i32 noundef 5000000) #15
...
for.body797.lr.ph:                                ; preds = %if.end793
  %677 = load ptr, ptr @R__align.mseq1, align 8, !tbaa !5
...
for.body809.lr.ph:                                ; preds = %for.cond806.preheader
  %678 = load ptr, ptr @R__align.mseq2, align 8, !tbaa !5
...
for.body797:                                      ; preds = %for.body797.lr.ph, %for.body797
  ...
  %679 = load ptr, ptr %arrayidx799, align 8, !tbaa !5
  %arrayidx801 = getelementptr inbounds ptr, ptr %677, i64 %indvars.iv1527
  %680 = load ptr, ptr %arrayidx801, align 8, !tbaa !5
  %call802 = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %679, ptr noundef nonnull dereferenceable(1) %680) #13
...
for.body809:                                      ; preds = %for.body809.lr.ph, %for.body809
  ...
  %681 = load ptr, ptr %arrayidx811, align 8, !tbaa !5
  %arrayidx813 = getelementptr inbounds ptr, ptr %678, i64 %indvars.iv1532
  %682 = load ptr, ptr %arrayidx813, align 8, !tbaa !5
  %call814 = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %681, ptr noundef nonnull dereferenceable(1) %682) #13
...
for.end817:                                       ; preds = %for.body809, %for.cond806.preheader
  %683 = load ptr, ptr @stderr, align 8, !tbaa !5
  %conv818 = fpext float %wm.0.lcssa to double
  %call819 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %683, ptr noundef nonnull @.str.2, double noundef %conv818) #15
