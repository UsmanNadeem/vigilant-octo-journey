; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Benchmarks/Misc-C++/mandel-text.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Benchmarks/Misc-C++/mandel-text.cpp"
...
if.end40:                                         ; preds = %for.end.thread, %for.cond.cleanup7
  ...
  %call.i70 = tail call i32 @_IO_putc(i32 noundef %.sink, ptr noundef %5)
