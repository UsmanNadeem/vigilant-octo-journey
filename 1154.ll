; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/C/MtCoder.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/C/MtCoder.c"
...
entry:
  ...
  %uglygep.i = getelementptr %struct._CMtCoder, ptr %p, i64 0, i32 10, i32 5
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(512) %uglygep.i, i8 0, i64 512, i1 false)
...
if.then23.i:                                      ; preds = %lor.lhs.false20.i, %if.end18.if.then23_crit_edge.i
  ...
  %21 = load i64, ptr %destBlockSize31.i, align 8, !tbaa !53
  %outBufSize32.i = getelementptr inbounds %struct._CMtCoder, ptr %p, i64 0, i32 11, i64 %indvars.iv, i32 2
  store i64 %21, ptr %outBufSize32.i, align 8, !tbaa !52
...
if.end45.i:                                       ; preds = %if.then23.i, %lor.lhs.false20.i
  ...
  store <2 x i32> zeroinitializer, ptr %stopReading.i, align 8, !tbaa !54
  %canRead.i = getelementptr inbounds %struct._CMtCoder, ptr %p, i64 0, i32 11, i64 %indvars.iv, i32 9
...
for.inc22:                                        ; preds = %LoopThread_Create.exit, %for.body6
  ...
  br i1 %exitcond161.not, label %for.cond27.preheader, label %for.body6, !llvm.loop !55
...
cleanup41:                                        ; preds = %for.body29
  ...
  store i32 1, ptr %stopReading, align 8, !tbaa !56
  br label %for.end46

for.inc44:                                        ; preds = %for.body29
  %indvars.iv.next163 = add nuw nsw i64 %indvars.iv162, 1
  %exitcond166.not = icmp eq i64 %indvars.iv.next163, %wide.trip.count165
  br i1 %exitcond166.not, label %for.end46, label %for.body29, !llvm.loop !57
...
if.end.i:                                         ; preds = %for.cond
  ...
  %6 = load i32, ptr %stopReading.i, align 8, !tbaa !56
...
if.then4.i:                                       ; preds = %if.end.i
  ...
  store i32 1, ptr %stopReading5.i, align 8, !tbaa !56
...
if.end10.i:                                       ; preds = %if.end.i
  ...
  %8 = load i64, ptr %outBufSize.i, align 8, !tbaa !52
  store i64 %8, ptr %destSize.i, align 8, !tbaa !60
...
while.body.i.i:                                   ; preds = %while.cond.i.i
  ...
  store i64 %size.0.i.i, ptr %curSize.i.i, align 8, !tbaa !60
  ...
  %12 = load i64, ptr %curSize.i.i, align 8, !tbaa !60
...
cleanup.cont.i:                                   ; preds = %while.cond.i.i, %FullRead.exit.i
  ...
  store i32 %conv.i, ptr %stopReading20.i, align 8, !tbaa !56
...
if.end47.i:                                       ; preds = %cleanup.cont40.i
  %24 = load i32, ptr %stopWriting.i, align 4, !tbaa !64
...
if.end50.i:                                       ; preds = %if.end47.i
  ...
  %26 = load ptr, ptr %outStream.i, align 8, !tbaa !65
  %27 = load ptr, ptr %26, align 8, !tbaa !28
  %28 = load ptr, ptr %outBuf.i, align 8, !tbaa !32
  %29 = load i64, ptr %destSize.i, align 8, !tbaa !60
  %call55.i = call i64 %27(ptr noundef nonnull %26, ptr noundef %28, i64 noundef %29) #6
  %30 = load i64, ptr %destSize.i, align 8, !tbaa !60
...
cleanup.thread:                                   ; preds = %if.then.i32, %MtCoder_SetError.exit
  ...
  store <2 x i32> <i32 1, i32 1>, ptr %stopReading, align 8, !tbaa !54
