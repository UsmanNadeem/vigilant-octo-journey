; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z51.c"
...
entry:
  ...
  %cmp.not21 = icmp slt i32 %div2, 0
  %cmp7.not19 = icmp slt i32 %div, 0
  %or.cond = select i1 %cmp.not21, i1 true, i1 %cmp7.not19
  br i1 %or.cond, label %for.end14, label %for.cond6.preheader.preheader

for.cond6.preheader.preheader:                    ; preds = %entry
  %2 = zext i32 %div to i64
  %3 = add nuw nsw i64 %2, 1
  %4 = zext i32 %div2 to i64
  %5 = add nuw nsw i64 %4, 1
  %6 = mul nuw nsw i64 %3, %5
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %call, i8 32, i64 %6, i1 false), !tbaa !11
  br label %for.end14
...
for.body10:                                       ; preds = %for.end, %for.body10
  ...
  %call = tail call i32 @_IO_putc(i32 noundef %conv15, ptr noundef %11)
...
for.end17:                                        ; preds = %for.cond2, %for.body10, %for.end
  ...
  %call18 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %12)
...
if.then:                                          ; preds = %for.end21
  ...
  %call22 = tail call i32 @_IO_putc(i32 noundef 12, ptr noundef %14)
  br label %if.end
...
if.end37:                                         ; preds = %if.end, %if.then32
  %cmp3979 = icmp sgt i32 %div26, -1
  %cmp4377 = icmp sgt i32 %div, -1
  %or.cond92 = select i1 %cmp3979, i1 %cmp4377, i1 false
...
for.cond42.preheader.us.preheader:                ; preds = %if.end37
  ...
  %21 = zext i32 %add24 to i64
  %22 = zext i32 %add27 to i64
  %23 = mul nuw nsw i64 %21, %22
  tail call void @llvm.memset.p0.i64(ptr align 1 %20, i8 32, i64 %23, i1 false), !tbaa !11
  br label %for.end55
...
attributes #5 = { nofree nounwind memory(readwrite, argmem: write) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
