...
for.inc1664.sink.split:                           ; preds = %cond.false1637, %cond.false1166
  %.sink3766 = phi ptr [ %192, %cond.false1166 ], [ %270, %cond.false1637 ]
  %.sink3765 = phi ptr [ %191, %cond.false1166 ], [ %269, %cond.false1637 ]
  %osucc1187 = getelementptr inbounds [2 x %struct.LIST], ptr %.sink3766, i64 0, i64 1, i32 1
  store ptr %.sink3765, ptr %osucc1187, align 8, !tbaa !5
...
for.end2228:                                      ; preds = %for.inc2224, %if.end1902
  %.lcssa3651 = phi ptr [ %309, %if.end1902 ], [ %link.2, %for.inc2224 ]
...
if.then2919:                                      ; preds = %land.lhs.true2910
  ...
  %spec.select3767 = select i1 %cmp2689, i32 128, i32 %conv2894
  %spec.select3768 = select i1 %cmp2689, i32 %conv2894, i32 128
  %430 = getelementptr inbounds %struct.closure_type, ptr %408, i64 0, i32 4
  store i32 %spec.select3767, ptr %430, align 8
  %431 = getelementptr inbounds %struct.closure_type, ptr %408, i64 0, i32 4, i32 0, i32 2
  store i32 %spec.select3768, ptr %431, align 8
...
for.end2962:                                      ; preds = %for.end2962.loopexit, %if.end2293
  ...
  %.lcssa3649 = phi ptr [ %347, %if.end2293 ], [ %zlink.0, %for.end2962.loopexit ]
