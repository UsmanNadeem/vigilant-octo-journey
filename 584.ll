; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/spiff/strings.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/spiff/strings.c"
...
entry:
  ...
  %call150 = tail call i32 @strncmp(ptr noundef %s1, ptr noundef %s2, i64 noundef %call) #10
  ret i32 %call150
}
