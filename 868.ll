; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/storage.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/storage.c"
...
for.body14:                                       ; preds = %for.body14.preheader, %for.body14
  ...
  %uglygep = getelementptr i8, ptr %19, i64 %18
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(128) %uglygep, i8 0, i64 128, i1 false), !tbaa !9
...
if.then32:                                        ; preds = %while.body26
  ...
  %uglygep = getelementptr i8, ptr %call27, i64 136
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(120) %uglygep, i8 0, i64 120, i1 false), !tbaa !9
  br label %if.end51
...
for.body82.preheader:                             ; preds = %if.then68
  %uglygep191 = getelementptr i8, ptr %call69, i64 128
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(128) %uglygep191, i8 0, i64 128, i1 false), !tbaa !9
  br label %if.end106
