; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/ldecod/cabac.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/ldecod/cabac.c"
...
; Function Attrs: nounwind uwtable
define dso_local void @readMB_skip_flagInfo_CABAC(ptr nocapture noundef %se, ptr nocapture noundef readonly %img, ptr noundef %dep_dp) local_unnamed_addr #0 {
entry:
  %type = getelementptr inbounds %struct.img_par, ptr %img, i64 0, i32 10
  %0 = load i32, ptr %type, align 4, !tbaa !32
  %cmp = icmp eq i32 %0, 1
...
for.body.lr.ph:                                   ; preds = %if.end
  ...
  %uglygep = getelementptr i8, ptr %coeff.addr.0, i64 4
  %13 = add i32 %i1.0, 1
  br label %for.body
...
for.body55.preheader:                             ; preds = %for.cond53.preheader
  ...
  %uglygep121 = getelementptr i8, ptr %uglygep, i64 %16
  %17 = xor i32 %i.0118, -1
  %18 = add i32 %i1.0, %17
  %19 = zext i32 %18 to i64
  %20 = shl nuw nsw i64 %19, 2
  %21 = add nuw nsw i64 %20, 4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %uglygep121, i8 0, i64 %21, i1 false), !tbaa !19
  br label %for.inc63
...
if.end6:                                          ; preds = %if.then2, %entry
  ...
  %value21641 = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 2
...
if.then7:                                         ; preds = %if.end6
  ...
  store i32 0, ptr %value21641, align 8, !tbaa !37
  %idxprom846 = sext i32 %readRunLevel_CABAC.pos.promoted to i64
  %arrayidx947 = getelementptr inbounds [64 x i32], ptr @readRunLevel_CABAC.coeff, i64 0, i64 %idxprom846
  %7 = load i32, ptr %arrayidx947, align 4, !tbaa !19
  %cmp1048 = icmp eq i32 %7, 0
  br i1 %cmp1048, label %for.inc, label %if.end18

for.inc:                                          ; preds = %if.then7, %for.inc
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ %idxprom846, %if.then7 ]
  %storemerge50 = phi i32 [ %inc12, %for.inc ], [ 0, %if.then7 ]
  %indvars.iv.next = add i64 %indvars.iv, 1
  %inc12 = add nuw nsw i32 %storemerge50, 1
  store i32 %inc12, ptr %value21641, align 8, !tbaa !37
...
if.end18:                                         ; preds = %for.cond.if.end18_crit_edge, %if.then7
  %.lcssa44 = phi i32 [ %9, %for.cond.if.end18_crit_edge ], [ %readRunLevel_CABAC.pos.promoted, %if.then7 ]
  %.lcssa = phi i32 [ %8, %for.cond.if.end18_crit_edge ], [ %7, %if.then7 ]
  %inc13 = add nsw i32 %.lcssa44, 1
...
if.then20:                                        ; preds = %if.end6, %if.else
  %value216.sink = phi ptr [ %value216, %if.else ], [ %value21641, %if.end6 ]
  store i32 0, ptr %value216.sink, align 8, !tbaa !37
