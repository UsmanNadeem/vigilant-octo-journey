; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/ldecod/annexb.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/ldecod/annexb.c"
...
entry:
  %call = tail call ptr @fopen64(ptr noundef %fn, ptr noundef nonnull @.str.6)
...
if.end29:                                         ; preds = %if.then26, %if.then27, %land.lhs.true23, %lor.lhs.false20
  ...
  %narrow.not = select i1 %cmp30, i1 %switch, i1 false
