; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/tm.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/tm.c"
...
for.cond36.preheader:                             ; preds = %for.end32
  %cmp37148 = icmp ugt ptr %str.addr.1, %str
  br i1 %cmp37148, label %for.body39, label %if.end52

for.body39:                                       ; preds = %for.cond36.preheader, %for.inc49
  %str.addr.2149 = phi ptr [ %add.ptr40, %for.inc49 ], [ %str.addr.1, %for.cond36.preheader ]
  %add.ptr40 = getelementptr inbounds i8, ptr %str.addr.2149, i64 -1
...
if.end63:                                         ; preds = %if.end52, %for.end, %if.then60
  %str.addr.4 = phi ptr [ %16, %if.then60 ], [ %ba.0, %for.end ], [ %str.addr.2146, %if.end52 ]
