; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_packlibs.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_packlibs.c"
...
if.then.i:                                        ; preds = %while.cond
  ...
  %cmp5.not.i = icmp ult ptr %csrc.0, %add.ptr4.i
...
if.then.i349:                                     ; preds = %if.end6
  ...
  %cmp5.not.i347 = icmp ult ptr %csrc.1, %add.ptr4.i
  %or.cond.i348 = select i1 %cmp.i343, i1 %cmp5.not.i347, i1 false
...
if.then.i368:                                     ; preds = %if.end12
  ...
  %cmp5.not.i366 = icmp ult ptr %csrc.3, %add.ptr4.i
  %or.cond.i367 = select i1 %cmp.i362, i1 %cmp5.not.i366, i1 false
...
if.then.i387:                                     ; preds = %while.body21
  ...
  %cmp5.not.i385 = icmp ult ptr %csrc.7611, %add.ptr4.i
  %or.cond.i386 = select i1 %cmp.i381, i1 %cmp5.not.i385, i1 false
...
if.else:                                          ; preds = %doubledl.exit378
  %cmp35.not = icmp ult ptr %csrc.5, %add.ptr.i
...
if.then.i406:                                     ; preds = %do.body
  ...
  %cmp5.not.i404 = icmp ult ptr %csrc.10, %add.ptr4.i
  %or.cond.i405 = select i1 %cmp.i400, i1 %cmp5.not.i404, i1 false
...
if.then.i425:                                     ; preds = %doubledl.exit416
  ...
  %cmp5.not.i423 = icmp ult ptr %csrc.11, %add.ptr4.i
  %or.cond.i424 = select i1 %cmp.i419, i1 %cmp5.not.i423, i1 false
...
if.then.i444:                                     ; preds = %do.body65
  ...
  %cmp5.not.i442 = icmp ult ptr %csrc.15, %add.ptr4.i
  %or.cond.i443 = select i1 %cmp.i438, i1 %cmp5.not.i442, i1 false
...
if.then.i463:                                     ; preds = %doubledl.exit454
  ...
  %cmp5.not.i461 = icmp ult ptr %csrc.16, %add.ptr4.i
  %or.cond.i462 = select i1 %cmp.i457, i1 %cmp5.not.i461, i1 false
...
if.else81:                                        ; preds = %do.end
  %cmp84.not = icmp ult ptr %csrc.13, %add.ptr.i
...
if.then.i482:                                     ; preds = %do.body92
  ...
  %cmp5.not.i480 = icmp ult ptr %csrc.20, %add.ptr4.i
...
if.then.i501:                                     ; preds = %doubledl.exit492
  ...
  %cmp5.not.i499 = icmp ult ptr %csrc.21, %add.ptr4.i
...
while.body183.preheader:                          ; preds = %land.lhs.true161
  ...
  %min.iters.check = icmp ult i32 %27, 31
  %diff.check = icmp ult i32 %backbytes.2, 32
  %or.cond726 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond726, label %while.body183.preheader727, label %vector.ph

vector.ph:                                        ; preds = %while.body183.preheader
  %n.vec = and i64 %29, -32
  %ind.end = getelementptr i8, ptr %cdst.0, i64 %n.vec
  %.cast = trunc i64 %n.vec to i32
  %ind.end722 = sub i32 %backsize.7, %.cast
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %next.gep = getelementptr i8, ptr %cdst.0, i64 %index
  %30 = getelementptr inbounds i8, ptr %next.gep, i64 %idx.neg
  %wide.load = load <16 x i8>, ptr %30, align 1, !tbaa !5
  %31 = getelementptr inbounds i8, ptr %30, i64 16
  %wide.load725 = load <16 x i8>, ptr %31, align 1, !tbaa !5
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !5
  %32 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load725, ptr %32, align 1, !tbaa !5
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %while.cond.outer.outer.backedge, label %while.body183.preheader727
...
while.body183.preheader727:                       ; preds = %while.body183.preheader, %middle.block
  %cdst.1615.ph = phi ptr [ %cdst.0, %while.body183.preheader ], [ %ind.end, %middle.block ]
  %backsize.8614.ph = phi i32 [ %backsize.7, %while.body183.preheader ], [ %ind.end722, %middle.block ]
  %34 = add i32 %backsize.8614.ph, -1
  %xtraiter = and i32 %backsize.8614.ph, 7
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %while.body183.prol.loopexit, label %while.body183.prol

while.body183.prol:                               ; preds = %while.body183.preheader727, %while.body183.prol
  %cdst.1615.prol = phi ptr [ %incdec.ptr187.prol, %while.body183.prol ], [ %cdst.1615.ph, %while.body183.preheader727 ]
  %backsize.8614.prol = phi i32 [ %dec.prol, %while.body183.prol ], [ %backsize.8614.ph, %while.body183.preheader727 ]
  %prol.iter = phi i32 [ %prol.iter.next, %while.body183.prol ], [ 0, %while.body183.preheader727 ]
  %dec.prol = add i32 %backsize.8614.prol, -1
  %add.ptr186.prol = getelementptr inbounds i8, ptr %cdst.1615.prol, i64 %idx.neg
  %35 = load i8, ptr %add.ptr186.prol, align 1, !tbaa !5
  store i8 %35, ptr %cdst.1615.prol, align 1, !tbaa !5
  %incdec.ptr187.prol = getelementptr inbounds i8, ptr %cdst.1615.prol, i64 1
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %while.body183.prol.loopexit, label %while.body183.prol, !llvm.loop !13

while.body183.prol.loopexit:                      ; preds = %while.body183.prol, %while.body183.preheader727
  %incdec.ptr187.lcssa.unr = phi ptr [ undef, %while.body183.preheader727 ], [ %incdec.ptr187.prol, %while.body183.prol ]
  %cdst.1615.unr = phi ptr [ %cdst.1615.ph, %while.body183.preheader727 ], [ %incdec.ptr187.prol, %while.body183.prol ]
  %backsize.8614.unr = phi i32 [ %backsize.8614.ph, %while.body183.preheader727 ], [ %dec.prol, %while.body183.prol ]
  %36 = icmp ult i32 %34, 7
  br i1 %36, label %while.cond.outer.outer.backedge, label %while.body183

while.body183:                                    ; preds = %while.body183.prol.loopexit, %while.body183
  %cdst.1615 = phi ptr [ %incdec.ptr187.7, %while.body183 ], [ %cdst.1615.unr, %while.body183.prol.loopexit ]
  %backsize.8614 = phi i32 [ %dec.7, %while.body183 ], [ %backsize.8614.unr, %while.body183.prol.loopexit ]
  %add.ptr186 = getelementptr inbounds i8, ptr %cdst.1615, i64 %idx.neg
  %37 = load i8, ptr %add.ptr186, align 1, !tbaa !5
  store i8 %37, ptr %cdst.1615, align 1, !tbaa !5
  %incdec.ptr187 = getelementptr inbounds i8, ptr %cdst.1615, i64 1
  %add.ptr186.1 = getelementptr inbounds i8, ptr %incdec.ptr187, i64 %idx.neg
  %38 = load i8, ptr %add.ptr186.1, align 1, !tbaa !5
  store i8 %38, ptr %incdec.ptr187, align 1, !tbaa !5
  %incdec.ptr187.1 = getelementptr inbounds i8, ptr %cdst.1615, i64 2
  %add.ptr186.2 = getelementptr inbounds i8, ptr %incdec.ptr187.1, i64 %idx.neg
  %39 = load i8, ptr %add.ptr186.2, align 1, !tbaa !5
  store i8 %39, ptr %incdec.ptr187.1, align 1, !tbaa !5
  %incdec.ptr187.2 = getelementptr inbounds i8, ptr %cdst.1615, i64 3
  %add.ptr186.3 = getelementptr inbounds i8, ptr %incdec.ptr187.2, i64 %idx.neg
  %40 = load i8, ptr %add.ptr186.3, align 1, !tbaa !5
  store i8 %40, ptr %incdec.ptr187.2, align 1, !tbaa !5
  %incdec.ptr187.3 = getelementptr inbounds i8, ptr %cdst.1615, i64 4
  %add.ptr186.4 = getelementptr inbounds i8, ptr %incdec.ptr187.3, i64 %idx.neg
  %41 = load i8, ptr %add.ptr186.4, align 1, !tbaa !5
  store i8 %41, ptr %incdec.ptr187.3, align 1, !tbaa !5
  %incdec.ptr187.4 = getelementptr inbounds i8, ptr %cdst.1615, i64 5
  %add.ptr186.5 = getelementptr inbounds i8, ptr %incdec.ptr187.4, i64 %idx.neg
  %42 = load i8, ptr %add.ptr186.5, align 1, !tbaa !5
  store i8 %42, ptr %incdec.ptr187.4, align 1, !tbaa !5
  %incdec.ptr187.5 = getelementptr inbounds i8, ptr %cdst.1615, i64 6
  %add.ptr186.6 = getelementptr inbounds i8, ptr %incdec.ptr187.5, i64 %idx.neg
  %43 = load i8, ptr %add.ptr186.6, align 1, !tbaa !5
  store i8 %43, ptr %incdec.ptr187.5, align 1, !tbaa !5
  %incdec.ptr187.6 = getelementptr inbounds i8, ptr %cdst.1615, i64 7
  %dec.7 = add i32 %backsize.8614, -8
  %add.ptr186.7 = getelementptr inbounds i8, ptr %incdec.ptr187.6, i64 %idx.neg
  %44 = load i8, ptr %add.ptr186.7, align 1, !tbaa !5
  store i8 %44, ptr %incdec.ptr187.6, align 1, !tbaa !5
  %incdec.ptr187.7 = getelementptr inbounds i8, ptr %cdst.1615, i64 8
...
lor.lhs.false197:                                 ; preds = %if.else189
  ...
  %cmp203.not = icmp ult ptr %csrc.1, %add.ptr.i
...
if.end206:                                        ; preds = %lor.lhs.false197
  ...
  %45 = load i8, ptr %csrc.1, align 1, !tbaa !5
  %incdec.ptr208 = getelementptr inbounds i8, ptr %cdst.0, i64 1
  store i8 %45, ptr %cdst.0, align 1, !tbaa !5
  br label %while.cond.outer
...
if.then.i451:                                     ; preds = %if.end
  ...
  %cmp5.not.i449 = icmp ult ptr %csrc.1, %add.ptr4.i
  %or.cond.i450 = select i1 %cmp.i445, i1 %cmp5.not.i449, i1 false
...
if.then.i470:                                     ; preds = %if.end8
  ...
  %cmp5.not.i468 = icmp ult ptr %csrc.3, %add.ptr4.i
  %or.cond.i469 = select i1 %cmp.i464, i1 %cmp5.not.i468, i1 false
...
if.then.i489:                                     ; preds = %while.body17
  ...
  %cmp5.not.i487 = icmp ult ptr %csrc.7724, %add.ptr4.i
  %or.cond.i488 = select i1 %cmp.i483, i1 %cmp5.not.i487, i1 false
...
if.then.i508:                                     ; preds = %do.body
  ...
  %cmp5.not.i506 = icmp ult ptr %csrc.10, %add.ptr4.i
  %or.cond.i507 = select i1 %cmp.i502, i1 %cmp5.not.i506, i1 false
...
if.then.i527:                                     ; preds = %doubledl.exit518
  ...
  %cmp5.not.i525 = icmp ult ptr %csrc.11, %add.ptr4.i
  %or.cond.i526 = select i1 %cmp.i521, i1 %cmp5.not.i525, i1 false
...
if.then.i546:                                     ; preds = %do.body61
  ...
  %cmp5.not.i544 = icmp ult ptr %csrc.15, %add.ptr4.i
  %or.cond.i545 = select i1 %cmp.i540, i1 %cmp5.not.i544, i1 false
...
if.then.i565:                                     ; preds = %doubledl.exit556
  ...
  %cmp5.not.i563 = icmp ult ptr %csrc.16, %add.ptr4.i
  %or.cond.i564 = select i1 %cmp.i559, i1 %cmp5.not.i563, i1 false
...
if.then.i584:                                     ; preds = %do.body88
  ...
  %cmp5.not.i582 = icmp ult ptr %csrc.20, %add.ptr4.i
  %or.cond.i583 = select i1 %cmp.i578, i1 %cmp5.not.i582, i1 false
...
if.then.i603:                                     ; preds = %doubledl.exit594
  ...
  %cmp5.not.i601 = icmp ult ptr %csrc.21, %add.ptr4.i
  %or.cond.i602 = select i1 %cmp.i597, i1 %cmp5.not.i601, i1 false
...
while.body237.preheader:                          ; preds = %land.lhs.true156
  %27 = add i32 %myecx_backsize.7, -1
  %28 = zext i32 %27 to i64
  %29 = add nuw nsw i64 %28, 1
  %min.iters.check = icmp ult i32 %27, 31
  %diff.check = icmp ult i32 %myeax_backbytes.2, 32
  %or.cond = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond, label %while.body237.preheader862, label %vector.ph

vector.ph:                                        ; preds = %while.body237.preheader
  %n.vec = and i64 %29, -32
  %ind.end = getelementptr i8, ptr %cdst.0, i64 %n.vec
  %.cast = trunc i64 %n.vec to i32
  %ind.end858 = sub i32 %myecx_backsize.7, %.cast
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %30, align 1, !tbaa !5
  %31 = getelementptr inbounds i8, ptr %30, i64 16
  %wide.load861 = load <16 x i8>, ptr %31, align 1, !tbaa !5
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !5
  %32 = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load861, ptr %32, align 1, !tbaa !5
  %index.next = add nuw i64 %index, 32
  %33 = icmp eq i64 %index.next, %n.vec
  br i1 %33, label %middle.block, label %vector.body, !llvm.loop !19

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %29, %n.vec
  br i1 %cmp.n, label %while.cond.outer.outer.backedge, label %while.body237.preheader862
...
while.body237.preheader862:                       ; preds = %while.body237.preheader, %middle.block
  %cdst.1728.ph = phi ptr [ %cdst.0, %while.body237.preheader ], [ %ind.end, %middle.block ]
  %myecx_backsize.8727.ph = phi i32 [ %myecx_backsize.7, %while.body237.preheader ], [ %ind.end858, %middle.block ]
  %34 = add i32 %myecx_backsize.8727.ph, -1
  %xtraiter = and i32 %myecx_backsize.8727.ph, 7
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %while.body237.prol.loopexit, label %while.body237.prol

while.body237.prol:                               ; preds = %while.body237.preheader862, %while.body237.prol
  %cdst.1728.prol = phi ptr [ %incdec.ptr241.prol, %while.body237.prol ], [ %cdst.1728.ph, %while.body237.preheader862 ]
  %myecx_backsize.8727.prol = phi i32 [ %dec.prol, %while.body237.prol ], [ %myecx_backsize.8727.ph, %while.body237.preheader862 ]
  %prol.iter = phi i32 [ %prol.iter.next, %while.body237.prol ], [ 0, %while.body237.preheader862 ]
  %dec.prol = add i32 %myecx_backsize.8727.prol, -1
  %add.ptr240.prol = getelementptr inbounds i8, ptr %cdst.1728.prol, i64 %idx.neg
  %35 = load i8, ptr %add.ptr240.prol, align 1, !tbaa !5
  store i8 %35, ptr %cdst.1728.prol, align 1, !tbaa !5
  %incdec.ptr241.prol = getelementptr inbounds i8, ptr %cdst.1728.prol, i64 1
  %prol.iter.next = add i32 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %while.body237.prol.loopexit, label %while.body237.prol, !llvm.loop !20

while.body237.prol.loopexit:                      ; preds = %while.body237.prol, %while.body237.preheader862
  %incdec.ptr241.lcssa.unr = phi ptr [ undef, %while.body237.preheader862 ], [ %incdec.ptr241.prol, %while.body237.prol ]
  %cdst.1728.unr = phi ptr [ %cdst.1728.ph, %while.body237.preheader862 ], [ %incdec.ptr241.prol, %while.body237.prol ]
  %myecx_backsize.8727.unr = phi i32 [ %myecx_backsize.8727.ph, %while.body237.preheader862 ], [ %dec.prol, %while.body237.prol ]
  %36 = icmp ult i32 %34, 7
  br i1 %36, label %while.cond.outer.outer.backedge, label %while.body237
...
land.end:                                         ; preds = %if.end120, %land.lhs.true186
  %or.cond431767 = phi i1 [ false, %land.lhs.true186 ], [ %or.cond431, %if.end120 ]
  ...
  %or.cond440 = select i1 %or.cond431767, i1 true, i1 %cmp212.not
...
land.rhs224:                                      ; preds = %land.lhs.true214
  ...
  %37 = zext i1 %cmp230 to i32
  br label %land.end232

land.end232:                                      ; preds = %land.rhs224, %land.lhs.true214, %land.end
  %land.ext233 = phi i32 [ 0, %land.lhs.true214 ], [ 0, %land.end ], [ %37, %land.rhs224 ]
...
while.body237:                                    ; preds = %while.body237.prol.loopexit, %while.body237
  %cdst.1728 = phi ptr [ %incdec.ptr241.7, %while.body237 ], [ %cdst.1728.unr, %while.body237.prol.loopexit ]
  %myecx_backsize.8727 = phi i32 [ %dec.7, %while.body237 ], [ %myecx_backsize.8727.unr, %while.body237.prol.loopexit ]
  %add.ptr240 = getelementptr inbounds i8, ptr %cdst.1728, i64 %idx.neg
  %38 = load i8, ptr %add.ptr240, align 1, !tbaa !5
  store i8 %38, ptr %cdst.1728, align 1, !tbaa !5
  %incdec.ptr241 = getelementptr inbounds i8, ptr %cdst.1728, i64 1
  %add.ptr240.1 = getelementptr inbounds i8, ptr %incdec.ptr241, i64 %idx.neg
  %39 = load i8, ptr %add.ptr240.1, align 1, !tbaa !5
  store i8 %39, ptr %incdec.ptr241, align 1, !tbaa !5
  %incdec.ptr241.1 = getelementptr inbounds i8, ptr %cdst.1728, i64 2
  %add.ptr240.2 = getelementptr inbounds i8, ptr %incdec.ptr241.1, i64 %idx.neg
  %40 = load i8, ptr %add.ptr240.2, align 1, !tbaa !5
  store i8 %40, ptr %incdec.ptr241.1, align 1, !tbaa !5
  %incdec.ptr241.2 = getelementptr inbounds i8, ptr %cdst.1728, i64 3
  %add.ptr240.3 = getelementptr inbounds i8, ptr %incdec.ptr241.2, i64 %idx.neg
  %41 = load i8, ptr %add.ptr240.3, align 1, !tbaa !5
  store i8 %41, ptr %incdec.ptr241.2, align 1, !tbaa !5
  %incdec.ptr241.3 = getelementptr inbounds i8, ptr %cdst.1728, i64 4
  %add.ptr240.4 = getelementptr inbounds i8, ptr %incdec.ptr241.3, i64 %idx.neg
  %42 = load i8, ptr %add.ptr240.4, align 1, !tbaa !5
  store i8 %42, ptr %incdec.ptr241.3, align 1, !tbaa !5
  %incdec.ptr241.4 = getelementptr inbounds i8, ptr %cdst.1728, i64 5
  %add.ptr240.5 = getelementptr inbounds i8, ptr %incdec.ptr241.4, i64 %idx.neg
  %43 = load i8, ptr %add.ptr240.5, align 1, !tbaa !5
  store i8 %43, ptr %incdec.ptr241.4, align 1, !tbaa !5
  %incdec.ptr241.5 = getelementptr inbounds i8, ptr %cdst.1728, i64 6
  %add.ptr240.6 = getelementptr inbounds i8, ptr %incdec.ptr241.5, i64 %idx.neg
  %44 = load i8, ptr %add.ptr240.6, align 1, !tbaa !5
  store i8 %44, ptr %incdec.ptr241.5, align 1, !tbaa !5
  %incdec.ptr241.6 = getelementptr inbounds i8, ptr %cdst.1728, i64 7
  %dec.7 = add i32 %myecx_backsize.8727, -8
  %add.ptr240.7 = getelementptr inbounds i8, ptr %incdec.ptr241.6, i64 %idx.neg
  %45 = load i8, ptr %add.ptr240.7, align 1, !tbaa !5
  store i8 %45, ptr %incdec.ptr241.6, align 1, !tbaa !5
  %incdec.ptr241.7 = getelementptr inbounds i8, ptr %cdst.1728, i64 8
...
if.end264:                                        ; preds = %lor.lhs.false251
  ...
  %46 = load i8, ptr %csrc.1, align 1, !tbaa !5
  %incdec.ptr266 = getelementptr inbounds i8, ptr %cdst.0, i64 1
  store i8 %46, ptr %cdst.0, align 1, !tbaa !5
  br label %while.cond.outer
