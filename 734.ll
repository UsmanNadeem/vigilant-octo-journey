; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/ASC_Sequoia/AMGmk/csr_matrix.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/ASC_Sequoia/AMGmk/csr_matrix.c"
...
entry:
  %call = tail call ptr @hypre_CAlloc(i32 noundef 1, i32 noundef 56) #11
...
if.then:                                          ; preds = %entry
  ...
  tail call void @hypre_Free(ptr noundef %0) #11
...
if.then3:                                         ; preds = %if.then
  tail call void @hypre_Free(ptr noundef nonnull %1) #11
  store ptr null, ptr %rownnz, align 8, !tbaa !5
  br label %if.end
...
if.then7:                                         ; preds = %if.end
  ...
  tail call void @hypre_Free(ptr noundef %3) #11
  ...
  tail call void @hypre_Free(ptr noundef %4) #11
  store ptr null, ptr %j, align 8, !tbaa !18
  br label %if.end10

if.end10:                                         ; preds = %if.then7, %if.end
  tail call void @hypre_Free(ptr noundef nonnull %matrix) #11
  br label %if.end11
...
if.then:                                          ; preds = %entry
  %call = tail call ptr @hypre_CAlloc(i32 noundef %1, i32 noundef 8) #11
...
if.then6:                                         ; preds = %if.end
  %add = add nsw i32 %0, 1
  %call7 = tail call ptr @hypre_CAlloc(i32 noundef %add, i32 noundef 4) #11
...
if.then13:                                        ; preds = %if.end9
  %call14 = tail call ptr @hypre_CAlloc(i32 noundef %1, i32 noundef 4) #11
...
if.else:                                          ; preds = %for.end
  %call = tail call ptr @hypre_CAlloc(i32 noundef %spec.select.lcssa, i32 noundef 4) #11
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %num_rows) #11
  %call = tail call ptr @fopen(ptr noundef %file_name, ptr noundef nonnull @.str)
  %call1 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %call, ptr noundef nonnull @.str.1, ptr noundef nonnull %num_rows) #11
  %0 = load i32, ptr %num_rows, align 4, !tbaa !19
  %add = add nsw i32 %0, 1
  %call2 = call ptr @hypre_CAlloc(i32 noundef %add, i32 noundef 4) #11
  %1 = load i32, ptr %num_rows, align 4, !tbaa !19
  %cmp.not81 = icmp slt i32 %1, 0
  br i1 %cmp.not81, label %for.end, label %for.body

for.body:                                         ; preds = %entry, %for.body
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.body ], [ 0, %entry ]
  %arrayidx = getelementptr inbounds i32, ptr %call2, i64 %indvars.iv
  %call4 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %call, ptr noundef nonnull @.str.1, ptr noundef %arrayidx) #11
...
for.end:                                          ; preds = %for.body, %entry
  %.lcssa105.sink = phi i32 [ %1, %entry ], [ %3, %for.body ]
  %5 = sext i32 %.lcssa105.sink to i64
  %arrayidx8 = getelementptr inbounds i32, ptr %call2, i64 %5
  %6 = load i32, ptr %arrayidx8, align 4, !tbaa !19
  %call.i = call ptr @hypre_CAlloc(i32 noundef 1, i32 noundef 56) #11
...
if.then6.i:                                       ; preds = %if.end.i
  %add.i = add nsw i32 %.lcssa105.sink, 1
  %call7.i = call ptr @hypre_CAlloc(i32 noundef %add.i, i32 noundef 4) #11
...
if.end9.i:                                        ; preds = %if.then6.i, %if.end.i
  ...
  %7 = load ptr, ptr %j.i, align 8, !tbaa !18
  %tobool10.i = icmp eq ptr %7, null
  %or.cond17.i = and i1 %tobool10.i, %tobool3.i
  br i1 %or.cond17.i, label %if.then13.i, label %hypre_CSRMatrixInitialize.exit

if.then13.i:                                      ; preds = %if.end9.i
  %call14.i = call ptr @hypre_CAlloc(i32 noundef %6, i32 noundef 4) #11
...
hypre_CSRMatrixInitialize.exit:                   ; preds = %if.end9.i, %if.then13.i
  %8 = phi ptr [ %7, %if.end9.i ], [ %call14.i, %if.then13.i ]
  %cmp1583 = icmp sgt i32 %6, 0
...
for.body16:                                       ; preds = %for.body16.preheader, %for.body16
  ...
  %arrayidx18 = getelementptr inbounds i32, ptr %8, i64 %indvars.iv93
  %call19 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %call, ptr noundef nonnull @.str.1, ptr noundef %arrayidx18) #11
  %9 = load i32, ptr %arrayidx18, align 4, !tbaa !19
...
for.end30.loopexit:                               ; preds = %for.body16
  %10 = add nuw nsw i32 %spec.select, 1
  br label %for.end30

for.end30:                                        ; preds = %for.end, %for.end30.loopexit, %hypre_CSRMatrixInitialize.exit
  %max_col.0.lcssa = phi i32 [ 1, %hypre_CSRMatrixInitialize.exit ], [ %10, %for.end30.loopexit ], [ 1, %for.end ]
  %11 = load ptr, ptr %call.i, align 8, !tbaa !17
  %12 = load i32, ptr %num_rows, align 4, !tbaa !19
  %idxprom3287 = sext i32 %12 to i64
  %arrayidx3388 = getelementptr inbounds i32, ptr %call2, i64 %idxprom3287
  %13 = load i32, ptr %arrayidx3388, align 4, !tbaa !19
  %cmp3489 = icmp sgt i32 %13, 0
...
for.body35:                                       ; preds = %for.end30, %for.body35
  ...
  %arrayidx37 = getelementptr inbounds double, ptr %11, i64 %indvars.iv96
  %call38 = call i32 (ptr, ptr, ...) @__isoc99_fscanf(ptr noundef %call, ptr noundef nonnull @.str.2, ptr noundef %arrayidx37) #11
  %indvars.iv.next97 = add nuw nsw i64 %indvars.iv96, 1
  %14 = load i32, ptr %num_rows, align 4, !tbaa !19
  %idxprom32 = sext i32 %14 to i64
  %arrayidx33 = getelementptr inbounds i32, ptr %call2, i64 %idxprom32
  %15 = load i32, ptr %arrayidx33, align 4, !tbaa !19
  %16 = sext i32 %15 to i64
  %cmp34 = icmp slt i64 %indvars.iv.next97, %16
...
for.end41:                                        ; preds = %for.body35, %for.end30
  ...
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %num_rows) #11
  ret ptr %call.i
}
...
entry:
  ...
  %call = tail call ptr @fopen(ptr noundef %file_name, ptr noundef nonnull @.str.3)
...
entry:
  ...
  %call.i = tail call ptr @hypre_CAlloc(i32 noundef 1, i32 noundef 56) #11
  %rownnz.i = getelementptr inbounds %struct.hypre_CSRMatrix, ptr %call.i, i64 0, i32 6
  store ptr null, ptr %rownnz.i, align 8, !tbaa !5
  %num_rows1.i = getelementptr inbounds %struct.hypre_CSRMatrix, ptr %call.i, i64 0, i32 3
...
if.end.i:                                         ; preds = %entry
  %call.i43 = tail call ptr @hypre_CAlloc(i32 noundef %0, i32 noundef 8) #11
...
if.then6.i:                                       ; preds = %if.end.i.thread, %if.end.i
  ...
  %call7.i = tail call ptr @hypre_CAlloc(i32 noundef %add.i, i32 noundef 4) #11
...
if.then13.i:                                      ; preds = %if.end9.i
  %call14.i = tail call ptr @hypre_CAlloc(i32 noundef %0, i32 noundef 4) #11
  store ptr %call14.i, ptr %j.i, align 8, !tbaa !18
  br label %hypre_CSRMatrixInitialize.exit
...
for.end.i:                                        ; preds = %for.body.i, %middle.block79
  ...
  %or.cond.i47 = select i1 %cmp7.i, i1 true, i1 %cmp8.i
  br i1 %or.cond.i47, label %hypre_CSRMatrixSetRownnz.exit, label %for.body12.preheader.i

for.body12.preheader.i:                           ; preds = %for.end.i
  %call.i48 = tail call ptr @hypre_CAlloc(i32 noundef %spec.select.i.lcssa, i32 noundef 4) #11
...
; Function Attrs: nounwind uwtable
define dso_local ptr @hypre_CSRMatrixUnion(ptr nocapture noundef readonly %A, ptr nocapture noundef readonly %B, ptr noundef readonly %col_map_offd_A, ptr noundef readonly %col_map_offd_B, ptr nocapture noundef %col_map_offd_C) local_unnamed_addr #0 {
entry:
...
if.else:                                          ; preds = %entry
  %call = tail call ptr @hypre_CAlloc(i32 noundef %2, i32 noundef 4) #11
...
if.then32:                                        ; preds = %for.body, %for.inc27.us, %middle.block
  ...
  %call33 = tail call ptr @hypre_CAlloc(i32 noundef %num_cols3.0.lcssa, i32 noundef 4) #11
...
if.then32.thread:                                 ; preds = %if.else
  %call33575 = tail call ptr @hypre_CAlloc(i32 noundef %1, i32 noundef 4) #11
...
if.end.i:                                         ; preds = %for.end123
  %call.i338 = tail call ptr @hypre_CAlloc(i32 noundef %num_nonzeros.0.lcssa, i32 noundef 8) #11
...
if.then13.i:                                      ; preds = %if.end9.i
  %call14.i = tail call ptr @hypre_CAlloc(i32 noundef %num_nonzeros.0.lcssa, i32 noundef 4) #11
  store ptr %call14.i, ptr %j.i, align 8, !tbaa !18
  br label %hypre_CSRMatrixInitialize.exit
...
if.then203:                                       ; preds = %for.end201
  tail call void @hypre_Free(ptr noundef nonnull %jC.0341552) #11
  br label %if.end204
