; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Compress/LzxDecoder.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Compress/LzxDecoder.cpp"
...
if.end38:                                         ; preds = %if.then26, %_ZN9NCompress4NLzx8CDecoder8ReadBitsEj.exit172
  ...
  %add42 = sub nuw nsw i32 17, %number.0
  %sub = add nuw nsw i32 %add42, %conv41
  %rem.lhs.trunc = trunc i32 %sub to i16
...
entry:
  ...
  %uglygep = getelementptr inbounds i8, ptr %lenCounts, i64 4
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(64) %uglygep, i8 0, i64 64, i1 false), !tbaa !46
...
if.end.19:                                        ; preds = %if.end.18
  ...
  %uglygep138 = getelementptr i8, ptr %this, i64 216
  br label %for.body21
...
for.body54.lr.ph:                                 ; preds = %if.then48
  ...
  %uglygep139 = getelementptr i8, ptr %uglygep138, i64 %47
  %48 = xor i32 %index.0130, -1
  %49 = add i32 %shr, %48
  %50 = zext i32 %49 to i64
  %51 = add nuw nsw i64 %50, 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %uglygep139, i8 %conv55, i64 %51, i1 false), !tbaa !41
  br label %for.inc62
...
if.then28:                                        ; preds = %if.end18
  ...
  %and.i = and i32 %55, 15
  %sub = sub nuw nsw i32 16, %and.i
  %add.i.i.i201 = add i32 %sub, %55
  store i32 %add.i.i.i201, ptr %m_BitPos.i, align 4, !tbaa !38
  %cmp19.i.i.i.i202 = icmp ugt i32 %add.i.i.i201, 15
  br i1 %cmp19.i.i.i.i202, label %for.body.lr.ph.i.i.i.i204, label %_ZN9NCompress4NLzx8CDecoder8ReadBitsEj.exit232
...
_ZN9NCompress4NLzx8CDecoder8ReadBitsEj.exit232:   ; preds = %_ZN9CInBuffer8ReadByteEv.exit18.i.i.i.i227, %if.then28
  %66 = phi i32 [ %add.i.i.i201, %if.then28 ], [ %sub.i.i.i.i225, %_ZN9CInBuffer8ReadByteEv.exit18.i.i.i.i227 ]
  %cmp.not.i = icmp eq i32 %66, 0
  br i1 %cmp.not.i, label %if.end35, label %cleanup108

if.end35:                                         ; preds = %_ZN9NCompress4NLzx8CDecoder8ReadBitsEj.exit232
...
for.body90.preheader:                             ; preds = %if.end84
  ...
  %uglygep = getelementptr i8, ptr %newLevels, i64 %109
  %110 = sub nsw i32 399, %108
  %111 = zext i32 %110 to i64
  %112 = add nuw nsw i64 %111, 1
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %uglygep, i8 0, i64 %112, i1 false), !tbaa !41
...
for.cond.cleanup89:                               ; preds = %for.body90.preheader, %if.end84
  ...
  %uglygep.i = getelementptr inbounds i8, ptr %lenCounts.i, i64 4
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(64) %uglygep.i, i8 0, i64 64, i1 false), !tbaa !46
...
for.end15.i:                                      ; preds = %if.end.i279.1
  ...
  %uglygep138.i = getelementptr %"class.NCompress::NLzx::CDecoder", ptr %this, i64 0, i32 10, i32 3
...
for.body54.lr.ph.i:                               ; preds = %if.then48.i
  ...
  %uglygep139.i = getelementptr i8, ptr %uglygep138.i, i64 %123
  %124 = xor i32 %index.0130.i, -1
  %125 = add i32 %shr.i, %124
  %126 = zext i32 %125 to i64
  %127 = add nuw nsw i64 %126, 1
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %uglygep139.i, i8 %conv55.i, i64 %127, i1 false), !tbaa !41
...
if.end105:                                        ; preds = %_ZN9NCompress8NHuffman8CDecoderILi16ELj656EE14SetCodeLengthsEPKh.exit
  ...
  %uglygep.i282 = getelementptr inbounds i8, ptr %lenCounts.i280, i64 4
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(64) %uglygep.i282, i8 0, i64 64, i1 false), !tbaa !46
...
for.end15.i296:                                   ; preds = %if.end.i293
  ...
  %uglygep138.i295 = getelementptr %"class.NCompress::NLzx::CDecoder", ptr %this, i64 0, i32 11, i32 3
...
for.body54.lr.ph.i323:                            ; preds = %if.then48.i319
  ...
  %uglygep139.i321 = getelementptr i8, ptr %uglygep138.i295, i64 %144
  %145 = xor i32 %index.0130.i300, -1
  %146 = add i32 %shr.i317, %145
  %147 = zext i32 %146 to i64
  %148 = add nuw nsw i64 %147, 1
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %uglygep139.i321, i8 %conv55.i320, i64 %148, i1 false), !tbaa !41
...
if.end.7:                                         ; preds = %if.end.6
  ...
  store i32 0, ptr %m_Positions, align 4, !tbaa !46
  %uglygep138 = getelementptr i8, ptr %this, i64 168
  br label %for.body21
...
for.body54.lr.ph:                                 ; preds = %if.then48
  ...
  %uglygep139 = getelementptr i8, ptr %uglygep138, i64 %23
  %24 = xor i32 %index.0130, -1
  %25 = add i32 %shr, %24
  %26 = zext i32 %25 to i64
  %27 = add nuw nsw i64 %26, 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %uglygep139, i8 %conv55, i64 %27, i1 false), !tbaa !41
  br label %for.inc62
...
entry:
  %uglygep = getelementptr i8, ptr %this, i64 6472
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(905) %uglygep, i8 0, i64 905, i1 false)
  ret void
}
...
if.then8:                                         ; preds = %if.end
  ...
  %uglygep.i = getelementptr i8, ptr %this, i64 6472
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(905) %uglygep.i, i8 0, i64 905, i1 false)
  %_wimMode = getelementptr inbounds %"class.NCompress::NLzx::CDecoder", ptr %this, i64 0, i32 24
...
if.end17:                                         ; preds = %_ZN9NCompress4NLzx8CDecoder8ReadBitsEj.exit, %_ZN9NCompress4NLzx8CDecoder8ReadBitsEj.exit295, %if.then8
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(12) %uglygep, i8 0, i64 12, i1 false), !tbaa !46
  br label %if.end21
