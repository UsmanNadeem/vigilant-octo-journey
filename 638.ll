; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/iaparser.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/iaparser.c"
...
yysetstate:                                       ; preds = %yynewstate, %entry
  ...
  %add.ptr923 = getelementptr i16, ptr %yyss.0, i64 -1
  %add.ptr2 = getelementptr i16, ptr %add.ptr923, i64 %yystacksize.0
...
if.end:                                           ; preds = %if.then
  ...
  %add.ptr39924 = getelementptr %union.yystype, ptr %add.ptr18, i64 -1
  %add.ptr40 = getelementptr %union.yystype, ptr %add.ptr39924, i64 %add
...
sw.bb218:                                         ; preds = %yyreduce
  ...
  %or.cond926 = select i1 %tobool.not.i, i1 %cmp.i720.not, i1 false
...
sw.epilog:                                        ; preds = %for.end.i752, %sw.bb246, %for.end.i711, %sw.bb202, %for.end.i, %sw.bb129, %yyreduce, %sw.bb243, %sw.bb241, %sw.bb239, %if.end234, %if.end215, %sw.bb199, %sw.bb196, %sw.bb194, %sw.bb192, %sw.bb190, %sw.bb188, %sw.bb186, %sw.bb184, %sw.bb182, %sw.bb180, %sw.bb178, %sw.bb174, %sw.bb173, %ia_CreateQuantifier.exit, %sw.bb167, %sw.bb166, %sw.bb162, %sw.bb158, %sw.bb151, %sw.bb146, %sw.bb142, %sw.bb138, %sw.bb134, %sw.bb126
  ...
  %add.ptr251925 = getelementptr %union.yystype, ptr %yyvsp.3, i64 1
  %add.ptr254 = getelementptr inbounds i16, ptr %yyssp.3, i64 %idx.neg
  %incdec.ptr255 = getelementptr %union.yystype, ptr %add.ptr251925, i64 %idx.neg
...
cond.end305:                                      ; preds = %if.then296, %cond.true300
  ...
  %sub310 = sub nsw i32 0, %conv51.le
  %cond313 = select i1 %cmp307, i32 %sub310, i32 0
  %cmp314839 = icmp slt i32 %cond313, 40
  br i1 %cmp314839, label %for.body.preheader, label %for.end
...
for.body:                                         ; preds = %for.body.preheader, %for.inc
  ...
  %yycount.0842 = phi i32 [ 0, %for.body.preheader ], [ %yycount.1, %for.inc ]
  %yysize297.0840 = phi i64 [ 0, %for.body.preheader ], [ %yysize297.1, %for.inc ]
...
if.then325:                                       ; preds = %for.body
  ...
  %add329 = add i64 %yysize297.0840, 15
  %add330 = add i64 %add329, %call328
  %inc331 = add nsw i32 %yycount.0842, 1
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.then325
  %yysize297.1 = phi i64 [ %add330, %if.then325 ], [ %yysize297.0840, %for.body ]
  %yycount.1 = phi i32 [ %inc331, %if.then325 ], [ %yycount.0842, %for.body ]
...
for.end:                                          ; preds = %for.inc, %cond.end305
  ...
  %uglygep = getelementptr i8, ptr %156, i64 24
  br label %while.cond.i760

while.cond.i760:                                  ; preds = %for.end, %while.cond.i760
  %yyd.0.i755 = phi ptr [ %incdec.ptr1.i758, %while.cond.i760 ], [ %uglygep, %for.end ]
...
yystpcpy.exit761:                                 ; preds = %while.cond.i760
  ...
  %or.cond848 = and i1 %cmp346, %cmp314839
  br i1 %or.cond848, label %for.body359.preheader, label %if.end381
...
for.body359:                                      ; preds = %for.body359.preheader, %for.inc378
  %indvars.iv881 = phi i64 [ %158, %for.body359.preheader ], [ %indvars.iv.next882, %for.inc378 ]
  %yyp.0847 = phi ptr [ %yyd.0.i755, %for.body359.preheader ], [ %yyp.1, %for.inc378 ]
  %yycount.2846 = phi i32 [ 0, %for.body359.preheader ], [ %yycount.3, %for.inc378 ]
  %160 = add nsw i64 %indvars.iv881, %159
...
while.cond.i767:                                  ; preds = %while.cond.i767, %if.then369
  %yyd.0.i762 = phi ptr [ %yyp.0847, %if.then369 ], [ %incdec.ptr1.i765, %while.cond.i767 ]
...
yystpcpy.exit768:                                 ; preds = %while.cond.i767
  %arrayidx374 = getelementptr inbounds [40 x ptr], ptr @yytname, i64 0, i64 %indvars.iv881
...
yystpcpy.exit775:                                 ; preds = %while.cond.i774
  %inc376 = add nsw i32 %yycount.2846, 1
  br label %for.inc378

for.inc378:                                       ; preds = %for.body359, %yystpcpy.exit775
  %yycount.3 = phi i32 [ %inc376, %yystpcpy.exit775 ], [ %yycount.2846, %for.body359 ]
  %yyp.1 = phi ptr [ %yyd.0.i769, %yystpcpy.exit775 ], [ %yyp.0847, %for.body359 ]
  %indvars.iv.next882 = add nsw i64 %indvars.iv881, 1
  %cmp357 = icmp slt i64 %indvars.iv881, 39
...
if.end:                                           ; preds = %if.else
  %scan.060.i = load ptr, ptr @ia_VARLIST, align 8
  %cmp.i.not61.not.i = icmp eq ptr %scan.060.i, null
  br i1 %cmp.i.not61.not.i, label %if.else.i, label %while.body.i

while.body.i:                                     ; preds = %if.end, %while.end.i
  %scan.062.i = phi ptr [ %scan.0.i, %while.end.i ], [ %scan.060.i, %if.end ]
  %35 = getelementptr i8, ptr %scan.062.i, i64 8
...
if.then.i.i.i:                                    ; preds = %if.then.i15
  ...
  %RealSize.1.i.i.i.i.i = add i32 %add7.i.i.i.i.i, %conv.i55.i
...
if.then24.i:                                      ; preds = %if.else.i
  %call.i56.i = tail call ptr @memory_Malloc(i32 noundef 16) #13
  store ptr %Name, ptr %call.i56.i, align 8
  ...
  %symbol27.i = getelementptr inbounds %struct.IA_VARENTRY, ptr %call.i56.i, i64 0, i32 1
  store i32 %inc.i.i, ptr %symbol27.i, align 8
  %54 = load ptr, ptr @ia_VARLIST, align 8
  %55 = getelementptr i8, ptr %54, i64 8
  %.val.i = load ptr, ptr %55, align 8
  %call.i57.i = tail call ptr @memory_Malloc(i32 noundef 16) #13
  %car.i.i = getelementptr inbounds %struct.LIST_HELP, ptr %call.i57.i, i64 0, i32 1
  store ptr %call.i56.i, ptr %car.i.i, align 8
  store ptr %.val.i, ptr %call.i57.i, align 8
  store ptr %call.i57.i, ptr %55, align 8
  br label %ia_VarLookup.exit
...
ia_VarLookup.exit:                                ; preds = %ia_StringFree.exit.i, %if.then24.i
  %call.i56.pn.i = phi ptr [ %call.i56.i, %if.then24.i ], [ %scan2.0.val.i, %ia_StringFree.exit.i ]
  %symbol.0.in.i = getelementptr i8, ptr %call.i56.pn.i, i64 8
