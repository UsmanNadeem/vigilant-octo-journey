; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/reader.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/bison/reader.c"
...
while.cond.i:                                     ; preds = %while.cond.i.backedge, %sw.bb8
  ...
  %call2.i = tail call i32 @_IO_getc(ptr noundef %2)
...
if.end.i21:                                       ; preds = %if.then.i20, %while.body6.i
  ...
  %call8.i = tail call i32 @_IO_getc(ptr noundef %5)
...
while.cond:                                       ; preds = %while.cond.backedge, %entry
  ...
  switch i32 %t.0, label %if.else365 [
    i32 7, label %while.end
    i32 0, label %while.end
    i32 1, label %if.then5
    i32 5, label %if.end9.thread560
    i32 9, label %if.then338
    i32 10, label %if.then343
    i32 12, label %if.then348
    i32 13, label %if.then353
    i32 23, label %if.then358
    i32 14, label %if.then363
  ]
...
if.end9.thread560:                                ; preds = %while.cond
  %2 = load i32, ptr @nrules, align 4, !tbaa !5
  %cmp10563 = icmp eq i32 %2, 0
  br i1 %cmp10563, label %if.then13, label %if.end17

if.end9.thread:                                   ; preds = %if.then5
  %3 = load i32, ptr @nrules, align 4, !tbaa !5
  %cmp10511 = icmp eq i32 %3, 0
  br i1 %cmp10511, label %if.end14, label %if.end17

if.then11:                                        ; preds = %if.end9
  %cmp12 = icmp eq i32 %call6, 5
  br i1 %cmp12, label %if.then13, label %if.end14

if.then13:                                        ; preds = %if.end9.thread560, %if.then11
  %lhs.1564569 = phi ptr [ %0, %if.then11 ], [ %lhs.0, %if.end9.thread560 ]
  tail call void @fatal(ptr noundef nonnull @.str.51) #12
  br label %if.end14

if.end14:                                         ; preds = %if.end9.thread, %if.then13, %if.then11
  %lhs.1513518 = phi ptr [ %lhs.1564569, %if.then13 ], [ %0, %if.then11 ], [ %0, %if.end9.thread ]
  %4 = load i32, ptr @start_flag, align 4, !tbaa !5
  %tobool.not = icmp eq i32 %4, 0
  br i1 %tobool.not, label %if.then15, label %if.end17

if.then15:                                        ; preds = %if.end14
  store ptr %lhs.1513518, ptr @startval, align 8, !tbaa !9
  br label %if.end17

if.end17:                                         ; preds = %if.end9.thread560, %if.end9.thread, %if.end14, %if.then15, %if.end9
  %lhs.1512 = phi ptr [ %0, %if.end9.thread ], [ %lhs.1513518, %if.end14 ], [ %lhs.1513518, %if.then15 ], [ %0, %if.end9 ], [ %lhs.0, %if.end9.thread560 ]
...
record_rule_line.exit:                            ; preds = %if.end17, %if.then.i, %if.then4.i
  ...
  store ptr %lhs.1512, ptr %sym, align 8, !tbaa !19
  ...
  %class = getelementptr inbounds %struct.bucket, ptr %lhs.1512, i64 0, i32 8
...
if.then25:                                        ; preds = %record_rule_line.exit
  ...
  %value = getelementptr inbounds %struct.bucket, ptr %lhs.1512, i64 0, i32 4
...
if.then34:                                        ; preds = %record_rule_line.exit
  %tag = getelementptr inbounds %struct.bucket, ptr %lhs.1512, i64 0, i32 2
...
if.end92.thread:                                  ; preds = %if.then47
  %call85528 = tail call ptr (i32, ...) @mallocate(i32 noundef 24) #12
  store ptr %call85528, ptr %p1.1, align 8, !tbaa !23
  br label %if.else108
...
if.then57:                                        ; preds = %if.end52
  ...
  %call.i486 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) @token_buffer, ptr noundef nonnull dereferenceable(1) @.str.49, i32 noundef %inc.i) #12
  ...
  %conv.i487 = trunc i32 %21 to i16
  %value.i = getelementptr inbounds %struct.bucket, ptr %call1.i, i64 0, i32 4
  store i16 %conv.i487, ptr %value.i, align 8, !tbaa !21
  ...
  %cmp.not.i488 = icmp slt i32 %inc59, %24
  br i1 %cmp.not.i488, label %record_rule_line.exit499, label %if.then.i494

if.then.i494:                                     ; preds = %if.then57
  %mul.i489 = shl nsw i32 %inc59, 1
  store i32 %mul.i489, ptr @rline_allocated, align 4, !tbaa !5
  %25 = load ptr, ptr @rline, align 8, !tbaa !9
  %conv.i490 = sext i32 %mul.i489 to i64
  %mul1.i491 = shl nsw i64 %conv.i490, 1
  %call.i492 = tail call ptr @realloc(ptr noundef %25, i64 noundef %mul1.i491) #14
  store ptr %call.i492, ptr @rline, align 8, !tbaa !9
  %cmp2.i493 = icmp eq ptr %call.i492, null
  br i1 %cmp2.i493, label %if.then4.i495, label %record_rule_line.exit499

if.then4.i495:                                    ; preds = %if.then.i494
  %26 = load ptr, ptr @stderr, align 8, !tbaa !9
  %27 = tail call i64 @fwrite(ptr nonnull @.str.60, i64 24, i64 1, ptr %26) #15
  tail call void @done(i32 noundef 1) #12
  br label %record_rule_line.exit499

record_rule_line.exit499:                         ; preds = %if.then57, %if.then.i494, %if.then4.i495
  %28 = load i32, ptr @lineno, align 4, !tbaa !5
  %conv7.i496 = trunc i32 %28 to i16
  %29 = load ptr, ptr @rline, align 8, !tbaa !9
  %30 = load i32, ptr @nrules, align 4, !tbaa !5
  %idxprom.i497 = sext i32 %30 to i64
  %arrayidx.i498 = getelementptr inbounds i16, ptr %29, i64 %idxprom.i497
  store i16 %conv7.i496, ptr %arrayidx.i498, align 2, !tbaa !18
...
cleanup.thread:                                   ; preds = %if.end52, %record_rule_line.exit499
  %crule1.1 = phi ptr [ %call68, %record_rule_line.exit499 ], [ %crule1.0, %if.end52 ]
  %p1.2 = phi ptr [ %call72, %record_rule_line.exit499 ], [ %p1.1, %if.end52 ]
...
if.else108:                                       ; preds = %if.end92.thread, %if.end92
  %t.2540 = phi i32 [ 1, %if.end92.thread ], [ %t.2, %if.end92 ]
  %call85532538 = phi ptr [ %call85528, %if.end92.thread ], [ %call85, %if.end92 ]
  %tobool109 = icmp eq i32 %xactions.0, 0
  %tobool110 = icmp ne ptr %first_rhs.0, null
  %or.cond404 = select i1 %tobool109, i1 %tobool110, i1 false
  br i1 %or.cond404, label %land.lhs.true111, label %if.end329

land.lhs.true111:                                 ; preds = %if.else108
  %type_name = getelementptr inbounds %struct.bucket, ptr %lhs.1512, i64 0, i32 3
  ...
  br i1 %cmp113.not, label %if.end329, label %if.then115

if.then115:                                       ; preds = %land.lhs.true111
  %cmp117 = icmp eq ptr %36, null
  %cmp121 = icmp eq ptr %37, null
  %or.cond = select i1 %cmp117, i1 true, i1 %cmp121
  br i1 %or.cond, label %if.then310, label %lor.lhs.false123

lor.lhs.false123:                                 ; preds = %if.then115
  %call302 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %36, ptr noundef nonnull dereferenceable(1) %37) #12
  %tobool309.not = icmp eq i32 %call302, 0
  br i1 %tobool309.not, label %if.end329, label %if.then310

if.then310:                                       ; preds = %lor.lhs.false123, %if.then115
  %38 = load ptr, ptr @stderr, align 8, !tbaa !9
  %39 = load ptr, ptr @infile, align 8, !tbaa !9
  %40 = load i32, ptr @lineno, align 4, !tbaa !5
  %spec.select485 = select i1 %cmp117, ptr @.str.56, ptr %36
  %cond324 = select i1 %cmp121, ptr @.str.56, ptr %37
  %call325 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %38, ptr noundef nonnull @.str.55, ptr noundef %39, i32 noundef %40, ptr noundef nonnull %spec.select485, ptr noundef nonnull %cond324) #15
  br label %if.end329

if.end329:                                        ; preds = %if.end106, %lor.lhs.false123, %if.then310, %land.lhs.true111, %if.else108, %if.end98
  %call85532537 = phi ptr [ %call85, %if.end98 ], [ %call85, %if.end106 ], [ %call85532538, %if.then310 ], [ %call85532538, %lor.lhs.false123 ], [ %call85532538, %land.lhs.true111 ], [ %call85532538, %if.else108 ]
  %t.3 = phi i32 [ %call99, %if.end98 ], [ %call107, %if.end106 ], [ %t.2540, %if.then310 ], [ %t.2540, %lor.lhs.false123 ], [ %t.2540, %land.lhs.true111 ], [ %t.2540, %if.else108 ]
  %cmp330 = icmp eq i32 %t.3, 4
  br i1 %cmp330, label %if.then332, label %while.cond.backedge

while.cond.backedge:                              ; preds = %if.end329, %if.then332, %if.then338, %if.then348, %parse_expect_decl.exit, %if.else365, %parse_start_decl.exit, %if.then353, %if.then343
  %p1.0.be = phi ptr [ %p1.0, %if.then338 ], [ %p1.0, %if.then343 ], [ %p1.0, %if.then348 ], [ %p1.0, %if.then353 ], [ %p1.0, %parse_expect_decl.exit ], [ %p1.0, %parse_start_decl.exit ], [ %p1.0, %if.else365 ], [ %call85532537, %if.then332 ], [ %call85532537, %if.end329 ]
  %lhs.0.be = phi ptr [ %lhs.0, %if.then338 ], [ %lhs.0, %if.then343 ], [ %lhs.0, %if.then348 ], [ %lhs.0, %if.then353 ], [ %lhs.0, %parse_expect_decl.exit ], [ %lhs.0, %parse_start_decl.exit ], [ %lhs.0, %if.else365 ], [ %lhs.1512, %if.then332 ], [ %lhs.1512, %if.end329 ]
  %t.0.be = phi i32 [ %call339, %if.then338 ], [ %call344, %if.then343 ], [ %call349, %if.then348 ], [ %call354, %if.then353 ], [ %call359, %parse_expect_decl.exit ], [ %call364, %parse_start_decl.exit ], [ %t.0, %if.else365 ], [ %call333, %if.then332 ], [ %t.3, %if.end329 ]
  br label %while.cond, !llvm.loop !26

if.then332:                                       ; preds = %if.end329
  %call333 = tail call i32 @lex() #12
  br label %while.cond.backedge

if.then338:                                       ; preds = %while.cond
  tail call void @parse_token_decl(i32 noundef 1, i32 noundef 2)
  %call339 = tail call i32 @lex() #12
  br label %while.cond.backedge

if.then343:                                       ; preds = %while.cond
  tail call void @parse_token_decl(i32 noundef 2, i32 noundef 1)
  %call344 = tail call i32 @lex() #12
  br label %while.cond.backedge

if.then348:                                       ; preds = %while.cond
  %call349 = tail call i32 @get_type()
  br label %while.cond.backedge

if.then353:                                       ; preds = %while.cond
  tail call void @parse_union_decl()
  %call354 = tail call i32 @lex() #12
  br label %while.cond.backedge

if.then358:                                       ; preds = %while.cond
  call void @llvm.lifetime.start.p0(i64 20, ptr nonnull %buffer.i) #12
  br label %while.cond.i

while.cond.i:                                     ; preds = %while.cond.i.backedge, %if.then358
  %41 = load ptr, ptr @finput, align 8, !tbaa !9
  %call2.i = tail call i32 @_IO_getc(ptr noundef %41)
  switch i32 %call2.i, label %while.cond3.preheader.i [
    i32 32, label %while.cond.i.backedge
    i32 9, label %while.cond.i.backedge
  ]
...
while.body6.i:                                    ; preds = %while.cond3.preheader.i, %if.end.i
  ...
  %cmp7.i = icmp slt i32 %count.019.i, 20
  br i1 %cmp7.i, label %if.then.i504, label %if.end.i

if.then.i504:                                     ; preds = %while.body6.i
  %conv.i500 = trunc i32 %c.118.i to i8
  %inc.i501 = add nsw i32 %count.019.i, 1
  %idxprom.i502 = sext i32 %count.019.i to i64
  %arrayidx.i503 = getelementptr inbounds [20 x i8], ptr %buffer.i, i64 0, i64 %idxprom.i502
  store i8 %conv.i500, ptr %arrayidx.i503, align 1, !tbaa !16
  br label %if.end.i

if.end.i:                                         ; preds = %if.then.i504, %while.body6.i
  %count.1.i = phi i32 [ %inc.i501, %if.then.i504 ], [ %count.019.i, %while.body6.i ]
  %44 = load ptr, ptr @finput, align 8, !tbaa !9
  %call8.i = tail call i32 @_IO_getc(ptr noundef %44)
...
parse_expect_decl.exit:                           ; preds = %if.end.i, %while.cond3.preheader.i
  ...
  store i32 %conv.i.i, ptr @expected_conflicts, align 4, !tbaa !5
  call void @llvm.lifetime.end.p0(i64 20, ptr nonnull %buffer.i) #12
  %call359 = tail call i32 @lex() #12
  br label %while.cond.backedge

if.then363:                                       ; preds = %while.cond
  %48 = load i32, ptr @start_flag, align 4, !tbaa !5
  %tobool.not.i = icmp eq i32 %48, 0
  br i1 %tobool.not.i, label %if.end.i508, label %if.then.i505

if.then.i505:                                     ; preds = %if.then363
  tail call void @fatal(ptr noundef nonnull @.str.14) #12
  br label %if.end.i508

if.end.i508:                                      ; preds = %if.then.i505, %if.then363
  store i32 1, ptr @start_flag, align 4, !tbaa !5
  %call.i506 = tail call i32 @lex() #12
  %cmp.not.i507 = icmp eq i32 %call.i506, 1
  br i1 %cmp.not.i507, label %parse_start_decl.exit, label %if.then1.i

if.then1.i:                                       ; preds = %if.end.i508
  tail call void @fatal(ptr noundef nonnull @.str.15) #12
  br label %parse_start_decl.exit

parse_start_decl.exit:                            ; preds = %if.end.i508, %if.then1.i
  %49 = load ptr, ptr @symval, align 8, !tbaa !9
  store ptr %49, ptr @startval, align 8, !tbaa !9
  %call364 = tail call i32 @lex() #12
  br label %while.cond.backedge

if.else365:                                       ; preds = %while.cond
...
while.end:                                        ; preds = %while.cond, %while.cond
  ...
  %cmp373 = icmp eq i32 %50, 0
  br i1 %cmp373, label %if.then375, label %if.end376

if.then375:                                       ; preds = %while.end
  tail call void @fatal(ptr noundef nonnull @.str.5) #12
  br label %if.end376

if.end376:                                        ; preds = %if.then375, %while.end
  %.b = load i1, ptr @typed, align 4
  br i1 %.b, label %if.end385, label %if.then379
...
if.then379:                                       ; preds = %if.end376
  ...
  %tobool381.not = icmp eq ptr %53, null
  br i1 %tobool381.not, label %if.end385, label %if.then382

if.then382:                                       ; preds = %if.then379
  %54 = tail call i64 @fwrite(ptr nonnull @.str.58, i64 43, i64 1, ptr nonnull %53)
  br label %if.end385

if.end385:                                        ; preds = %if.then379, %if.then382, %if.end376
  %bp.0549 = load ptr, ptr @firstsymbol, align 8, !tbaa !9
  %tobool387.not550 = icmp eq ptr %bp.0549, null
  br i1 %tobool387.not550, label %for.end401, label %for.body

for.body:                                         ; preds = %if.end385, %for.inc
  %bp.0551 = phi ptr [ %bp.0, %for.inc ], [ %bp.0549, %if.end385 ]
  %class388 = getelementptr inbounds %struct.bucket, ptr %bp.0551, i64 0, i32 8
  %55 = load i8, ptr %class388, align 8, !tbaa !11
  %cmp390 = icmp eq i8 %55, 0
  br i1 %cmp390, label %if.then392, label %for.inc

if.then392:                                       ; preds = %for.body
  %56 = load ptr, ptr @stderr, align 8, !tbaa !9
  %tag393 = getelementptr inbounds %struct.bucket, ptr %bp.0551, i64 0, i32 2
  %57 = load ptr, ptr %tag393, align 8, !tbaa !22
  %call394 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %56, ptr noundef nonnull @.str.59, ptr noundef %57) #15
  store i32 1, ptr @failure, align 4, !tbaa !5
  store i8 2, ptr %class388, align 8, !tbaa !11
  %58 = load i32, ptr @nvars, align 4, !tbaa !5
  %inc396 = add nsw i32 %58, 1
  store i32 %inc396, ptr @nvars, align 4, !tbaa !5
  %conv397 = trunc i32 %58 to i16
  %value398 = getelementptr inbounds %struct.bucket, ptr %bp.0551, i64 0, i32 4
  store i16 %conv397, ptr %value398, align 8, !tbaa !21
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.then392
  %next400 = getelementptr inbounds %struct.bucket, ptr %bp.0551, i64 0, i32 1
  %bp.0 = load ptr, ptr %next400, align 8, !tbaa !9
  %tobool387.not = icmp eq ptr %bp.0, null
  br i1 %tobool387.not, label %for.end401, label %for.body, !llvm.loop !27

for.end401:                                       ; preds = %for.inc, %if.end385
  %59 = load i32, ptr @nsyms, align 4, !tbaa !5
  %60 = load i32, ptr @nvars, align 4, !tbaa !5
  %sub402 = sub nsw i32 %59, %60
  store i32 %sub402, ptr @ntokens, align 4, !tbaa !5
  ret void
}
...
for.end:                                          ; preds = %if.end31, %entry
  ...
  %18 = load i32, ptr @translations, align 4, !tbaa !5
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call2 = tail call i32 @_IO_getc(ptr noundef %4)
  br label %for.cond
...
sw.bb:                                            ; preds = %for.cond
  ...
  %call3 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %5)
...
sw.bb5:                                           ; preds = %for.cond, %for.cond
  ...
  %call6 = tail call i32 @_IO_putc(i32 noundef %c.0, ptr noundef %7)
  %8 = load ptr, ptr @finput, align 8, !tbaa !9
  %call7 = tail call i32 @_IO_getc(ptr noundef %8)
...
if.end11.thread:                                  ; preds = %while.body, %while.body
  ...
  %call12105 = tail call i32 @_IO_putc(i32 noundef %c.1114, ptr noundef %9)
  br label %if.end26

if.end11:                                         ; preds = %while.body
  %10 = load ptr, ptr @fattrs, align 8, !tbaa !9
  %call12 = tail call i32 @_IO_putc(i32 noundef %c.1114, ptr noundef %10)
  %cmp13 = icmp eq i32 %c.1114, 92
  br i1 %cmp13, label %if.then14, label %if.end26

if.then14:                                        ; preds = %if.end11
  %11 = load ptr, ptr @finput, align 8, !tbaa !9
  %call15 = tail call i32 @_IO_getc(ptr noundef %11)
...
if.end20:                                         ; preds = %if.then14, %if.then19
  %12 = load ptr, ptr @fattrs, align 8, !tbaa !9
  %call21 = tail call i32 @_IO_putc(i32 noundef %call15, ptr noundef %12)
...
if.end26:                                         ; preds = %if.end11.thread, %if.end20, %if.then23, %if.end11
  ...
  %call27 = tail call i32 @_IO_getc(ptr noundef %14)
...
while.end:                                        ; preds = %if.end26, %sw.bb5
  ...
  %call28 = tail call i32 @_IO_putc(i32 noundef %c.0, ptr noundef %15)
  br label %sw.epilog.thread

sw.bb29:                                          ; preds = %for.cond
  %16 = load ptr, ptr @fattrs, align 8, !tbaa !9
  %call30 = tail call i32 @_IO_putc(i32 noundef 47, ptr noundef %16)
  %17 = load ptr, ptr @finput, align 8, !tbaa !9
  %call31 = tail call i32 @_IO_getc(ptr noundef %17)
...
if.end34:                                         ; preds = %sw.bb29
  ...
  %call35 = tail call i32 @_IO_putc(i32 noundef 42, ptr noundef %18)
  %19 = load ptr, ptr @finput, align 8, !tbaa !9
  %call36 = tail call i32 @_IO_getc(ptr noundef %19)
...
while.body44:                                     ; preds = %while.cond42
  ...
  %call45 = tail call i32 @_IO_putc(i32 noundef 42, ptr noundef %20)
  %21 = load ptr, ptr @finput, align 8, !tbaa !9
  %call46 = tail call i32 @_IO_getc(ptr noundef %21)
...
if.then53:                                        ; preds = %while.body39
  ...
  %call55 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %23)
  %24 = load ptr, ptr @finput, align 8, !tbaa !9
  %call56 = tail call i32 @_IO_getc(ptr noundef %24)
...
if.else60:                                        ; preds = %while.body39
  ...
  %call61 = tail call i32 @_IO_putc(i32 noundef %c.2111, ptr noundef %25)
  %26 = load ptr, ptr @finput, align 8, !tbaa !9
  %call62 = tail call i32 @_IO_getc(ptr noundef %26)
  br label %while.body39.backedge
...
if.end74:                                         ; preds = %if.then71
  ...
  %call75 = tail call i32 @_IO_putc(i32 noundef 37, ptr noundef %31)
  br label %for.cond.backedge
...
if.end10:                                         ; preds = %if.then8, %if.end5
  %8 = load ptr, ptr @finput, align 8, !tbaa !9
  %call11 = tail call i32 @_IO_getc(ptr noundef %8)
...
while.body:                                       ; preds = %if.end10, %sw.epilog
  ...
  %9 = load ptr, ptr @fattrs, align 8, !tbaa !9
  %call12 = tail call i32 @_IO_putc(i32 noundef %c.096, ptr noundef %9)
  %10 = load ptr, ptr @fdefines, align 8, !tbaa !9
  %tobool13.not = icmp eq ptr %10, null
  br i1 %tobool13.not, label %if.end16, label %if.then14

if.then14:                                        ; preds = %while.body
  %call15 = tail call i32 @_IO_putc(i32 noundef %c.096, ptr noundef nonnull %10)
  br label %if.end16
...
sw.bb17:                                          ; preds = %if.end16
  ...
  %call18 = tail call i32 @_IO_getc(ptr noundef %12)
...
if.else22:                                        ; preds = %sw.bb17
  %14 = load ptr, ptr @fattrs, align 8, !tbaa !9
  %call23 = tail call i32 @_IO_putc(i32 noundef 42, ptr noundef %14)
  %15 = load ptr, ptr @fdefines, align 8, !tbaa !9
  %tobool24.not = icmp eq ptr %15, null
  br i1 %tobool24.not, label %if.end27, label %if.then25

if.then25:                                        ; preds = %if.else22
  %call26 = tail call i32 @_IO_putc(i32 noundef 42, ptr noundef nonnull %15)
  br label %if.end27

if.end27:                                         ; preds = %if.then25, %if.else22
  %16 = load ptr, ptr @finput, align 8, !tbaa !9
  %call28 = tail call i32 @_IO_getc(ptr noundef %16)
...
if.end34:                                         ; preds = %if.then33, %while.body31
  ...
  %call35 = tail call i32 @_IO_putc(i32 noundef %c.194, ptr noundef %17)
  %18 = load ptr, ptr @fdefines, align 8, !tbaa !9
  %tobool36.not = icmp eq ptr %18, null
  br i1 %tobool36.not, label %if.end39, label %if.then37

if.then37:                                        ; preds = %if.end34
  %call38 = tail call i32 @_IO_putc(i32 noundef %c.194, ptr noundef nonnull %18)
  br label %if.end39

if.end39:                                         ; preds = %if.then37, %if.end34
  %cmp40 = icmp eq i32 %c.194, 42
  %19 = load ptr, ptr @finput, align 8, !tbaa !9
  %call42 = tail call i32 @_IO_getc(ptr noundef %19)
...
if.then44:                                        ; preds = %if.end39
  %20 = load ptr, ptr @fattrs, align 8, !tbaa !9
  %call45 = tail call i32 @_IO_putc(i32 noundef 47, ptr noundef %20)
...
if.then47:                                        ; preds = %if.then44
  %call48 = tail call i32 @_IO_putc(i32 noundef 47, ptr noundef nonnull %21)
  br label %sw.epilog
...
sw.epilog:                                        ; preds = %if.then44, %if.then47, %sw.bb57, %if.then20, %if.end16, %sw.bb55, %sw.bb
  ...
  %call71 = tail call i32 @_IO_getc(ptr noundef %27)
...
while.cond:                                       ; preds = %while.cond.backedge, %entry
  %0 = load ptr, ptr @finput, align 8, !tbaa !9
  %call2 = tail call i32 @_IO_getc(ptr noundef %0)
...
if.end:                                           ; preds = %if.then, %while.body6
  ...
  %call8 = tail call i32 @_IO_getc(ptr noundef %3)
  %4 = add i32 %call8, -48
  %5 = icmp ult i32 %4, 10
...
if.end5:                                          ; preds = %if.then2, %entry
  ...
  %call6 = tail call i32 @_IO_putc(i32 noundef 123, ptr noundef %7)
  %8 = load ptr, ptr @finput, align 8, !tbaa !9
  %call7 = tail call i32 @_IO_getc(ptr noundef %8)
...
while.cond.outer:                                 ; preds = %while.cond.outer.backedge, %if.end5
  ...
  %count.0.ph = phi i32 [ 0, %if.end5 ], [ %count.0.ph357, %while.cond.outer.backedge ]
  %brace_flag.0.ph = phi i32 [ 0, %if.end5 ], [ %brace_flag.0.ph358, %while.cond.outer.backedge ]
  br label %while.cond.outer355

while.cond.outer355:                              ; preds = %while.cond.outer355.backedge, %while.cond.outer
  %c.0.ph356 = phi i32 [ %c.0.ph, %while.cond.outer ], [ %c.0.ph356.be, %while.cond.outer355.backedge ]
  %count.0.ph357 = phi i32 [ %count.0.ph, %while.cond.outer ], [ %count.0.ph357.be, %while.cond.outer355.backedge ]
  %brace_flag.0.ph358 = phi i32 [ %brace_flag.0.ph, %while.cond.outer ], [ %brace_flag.0.ph358.be, %while.cond.outer355.backedge ]
  %tobool8.not = icmp eq i32 %brace_flag.0.ph358, 0
  %cmp = icmp sgt i32 %count.0.ph357, 0
  br label %while.cond

while.cond:                                       ; preds = %while.cond.outer355, %sw.bb56
  %c.0 = phi i32 [ %call58, %sw.bb56 ], [ %c.0.ph356, %while.cond.outer355 ]
  %cmp9 = icmp ne i32 %c.0, 59
  %cond.in = select i1 %tobool8.not, i1 %cmp9, i1 %cmp
  br i1 %cond.in, label %while.body, label %while.end198
...
sw.bb:                                            ; preds = %while.body
  ...
  %call12 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %9)
...
sw.bb13:                                          ; preds = %while.body
  ...
  %call14 = tail call i32 @_IO_putc(i32 noundef 123, ptr noundef %11)
  %inc15 = add nsw i32 %count.0.ph357, 1
  br label %if.then195

sw.bb16:                                          ; preds = %while.body
  %12 = load ptr, ptr @fguard, align 8, !tbaa !9
  %call17 = tail call i32 @_IO_putc(i32 noundef 125, ptr noundef %12)
  br i1 %cmp, label %if.then20, label %if.else

if.then20:                                        ; preds = %sw.bb16
  %dec = add nsw i32 %count.0.ph357, -1
  br label %sw.epilog
...
sw.bb22:                                          ; preds = %while.body, %while.body
  ...
  %call23 = tail call i32 @_IO_putc(i32 noundef %c.0, ptr noundef %13)
  %14 = load ptr, ptr @finput, align 8, !tbaa !9
  %call24 = tail call i32 @_IO_getc(ptr noundef %14)
  %cmp26.not392 = icmp eq i32 %call24, %c.0
  br i1 %cmp26.not392, label %while.end, label %while.body28

while.body28:                                     ; preds = %sw.bb22, %if.end53
  %c.1393 = phi i32 [ %call54, %if.end53 ], [ %call24, %sw.bb22 ]
  switch i32 %c.1393, label %if.end34 [
...
if.end34.thread:                                  ; preds = %while.body28, %while.body28
  ...
  %call35326 = tail call i32 @_IO_putc(i32 noundef %c.1393, ptr noundef %15)
  br label %if.end53

if.end34:                                         ; preds = %while.body28
  %16 = load ptr, ptr @fguard, align 8, !tbaa !9
  %call35 = tail call i32 @_IO_putc(i32 noundef %c.1393, ptr noundef %16)
  %cmp36 = icmp eq i32 %c.1393, 92
  br i1 %cmp36, label %if.then38, label %if.end53

if.then38:                                        ; preds = %if.end34
  %17 = load ptr, ptr @finput, align 8, !tbaa !9
  %call39 = tail call i32 @_IO_getc(ptr noundef %17)
...
if.end46:                                         ; preds = %if.then38, %if.then45
  ...
  %call47 = tail call i32 @_IO_putc(i32 noundef %call39, ptr noundef %18)
  br i1 %cmp43, label %if.then50, label %if.end53

if.then50:                                        ; preds = %if.end46
  %19 = load i32, ptr @lineno, align 4, !tbaa !5
  %inc51 = add nsw i32 %19, 1
...
if.end53:                                         ; preds = %if.end34.thread, %if.end46, %if.then50, %if.end34
  ...
  %call54 = tail call i32 @_IO_getc(ptr noundef %20)
  %cmp26.not = icmp eq i32 %call54, %c.0
  br i1 %cmp26.not, label %while.end, label %while.body28, !llvm.loop !48

while.end:                                        ; preds = %if.end53, %sw.bb22
  %21 = load ptr, ptr @fguard, align 8, !tbaa !9
  %call55 = tail call i32 @_IO_putc(i32 noundef %c.0, ptr noundef %21)
  br label %sw.epilog

sw.bb56:                                          ; preds = %while.body
  %22 = load ptr, ptr @fguard, align 8, !tbaa !9
  %call57 = tail call i32 @_IO_putc(i32 noundef 47, ptr noundef %22)
  %23 = load ptr, ptr @finput, align 8, !tbaa !9
  %call58 = tail call i32 @_IO_getc(ptr noundef %23)
  %cmp59.not = icmp eq i32 %call58, 42
  br i1 %cmp59.not, label %if.end62, label %while.cond, !llvm.loop !49

if.end62:                                         ; preds = %sw.bb56
  %24 = load ptr, ptr @fguard, align 8, !tbaa !9
  %call63 = tail call i32 @_IO_putc(i32 noundef 42, ptr noundef %24)
  %25 = load ptr, ptr @finput, align 8, !tbaa !9
  %call64 = tail call i32 @_IO_getc(ptr noundef %25)
  br label %while.body67

while.body67:                                     ; preds = %while.body67.backedge, %if.end62
  %c.2390 = phi i32 [ %call64, %if.end62 ], [ %c.2390.be, %while.body67.backedge ]
  switch i32 %c.2390, label %if.else94 [
...
while.cond71:                                     ; preds = %while.body67, %while.body74
  %c.3 = phi i32 [ %call76, %while.body74 ], [ %c.2390, %while.body67 ]
...
while.body74:                                     ; preds = %while.cond71
  ...
  %call75 = tail call i32 @_IO_putc(i32 noundef 42, ptr noundef %26)
  %27 = load ptr, ptr @finput, align 8, !tbaa !9
  %call76 = tail call i32 @_IO_getc(ptr noundef %27)
  br label %while.cond71, !llvm.loop !51

if.then86:                                        ; preds = %while.body67
  %28 = load i32, ptr @lineno, align 4, !tbaa !5
  %inc87 = add nsw i32 %28, 1
  store i32 %inc87, ptr @lineno, align 4, !tbaa !5
  %29 = load ptr, ptr @fguard, align 8, !tbaa !9
  %call88 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %29)
  %30 = load ptr, ptr @finput, align 8, !tbaa !9
  %call89 = tail call i32 @_IO_getc(ptr noundef %30)
  br label %while.body67.backedge

while.body67.backedge:                            ; preds = %while.cond71, %if.then86, %if.else94, %if.then93
  %c.2390.be = phi i32 [ %call89, %if.then86 ], [ -1, %if.then93 ], [ %call96, %if.else94 ], [ %c.3, %while.cond71 ]
...
if.else94:                                        ; preds = %while.body67
  ...
  %call95 = tail call i32 @_IO_putc(i32 noundef %c.2390, ptr noundef %31)
  %32 = load ptr, ptr @finput, align 8, !tbaa !9
  %call96 = tail call i32 @_IO_getc(ptr noundef %32)
  br label %while.body67.backedge

sw.bb101:                                         ; preds = %while.body
  %33 = load ptr, ptr @finput, align 8, !tbaa !9
  %call102 = tail call i32 @_IO_getc(ptr noundef %33)
...
while.cond106.preheader:                          ; preds = %sw.bb101
  ...
  %call107385 = tail call i32 @_IO_getc(ptr noundef %34)
  %cmp108386 = icmp ne i32 %call107385, 62
  %cmp110387 = icmp sgt i32 %call107385, 0
  %35 = and i1 %cmp108386, %cmp110387
  br i1 %35, label %while.body112, label %if.end116

while.body112:                                    ; preds = %while.cond106.preheader, %while.body112
  %call107389 = phi i32 [ %call107, %while.body112 ], [ %call107385, %while.cond106.preheader ]
  %cp.0388 = phi ptr [ %incdec.ptr, %while.body112 ], [ @token_buffer, %while.cond106.preheader ]
  %conv113 = trunc i32 %call107389 to i8
  %incdec.ptr = getelementptr inbounds i8, ptr %cp.0388, i64 1
  store i8 %conv113, ptr %cp.0388, align 1, !tbaa !16
  %36 = load ptr, ptr @finput, align 8, !tbaa !9
  %call107 = tail call i32 @_IO_getc(ptr noundef %36)
  %cmp108 = icmp ne i32 %call107, 62
  %cmp110 = icmp sgt i32 %call107, 0
  %37 = and i1 %cmp108, %cmp110
  br i1 %37, label %while.body112, label %if.end116, !llvm.loop !52
...
if.end116:                                        ; preds = %while.body112, %while.cond106.preheader
  ...
  %call115 = tail call i32 @_IO_getc(ptr noundef %38)
...
if.then119:                                       ; preds = %if.end116
  %39 = load ptr, ptr @fguard, align 8, !tbaa !9
...
if.end124:                                        ; preds = %if.end116.thread
  ...
  %43 = load ptr, ptr %sym, align 8, !tbaa !19
  %type_name123 = getelementptr inbounds %struct.bucket, ptr %43, i64 0, i32 3
  %44 = load ptr, ptr %type_name123, align 8, !tbaa !25
  %tobool125.not = icmp eq ptr %44, null
  br i1 %tobool125.not, label %if.end128, label %if.end128.thread

if.end128.thread:                                 ; preds = %if.then119, %if.end124
  %type_name.1337 = phi ptr [ %44, %if.end124 ], [ @token_buffer, %if.then119 ]
  %45 = load ptr, ptr @fguard, align 8, !tbaa !9
  %call127 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %45, ptr noundef nonnull @.str.38, ptr noundef nonnull %type_name.1337)
  br label %if.then195

if.end128:                                        ; preds = %if.end124
  %.b294 = load i1, ptr @typed, align 4
  br i1 %.b294, label %if.then131, label %if.then195

if.then131:                                       ; preds = %if.end128
  %46 = load ptr, ptr @stderr, align 8, !tbaa !9
  %47 = load ptr, ptr @infile, align 8, !tbaa !9
  %48 = load i32, ptr @lineno, align 4, !tbaa !5
  %tag = getelementptr inbounds %struct.bucket, ptr %43, i64 0, i32 2
  %49 = load ptr, ptr %tag, align 8, !tbaa !22
  %call133 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %46, ptr noundef nonnull @.str.39, ptr noundef %47, i32 noundef %48, ptr noundef %49) #15
  br label %if.then195
...
if.else135:                                       ; preds = %if.end116.thread, %if.end116
  ...
  %50 = load ptr, ptr %call136, align 8, !tbaa !9
  %idxprom = sext i32 %c.5331 to i64
  %arrayidx = getelementptr inbounds i16, ptr %50, i64 %idxprom
  %51 = load i16, ptr %arrayidx, align 2, !tbaa !18
  %52 = and i16 %51, 2048
  %tobool138 = icmp ne i16 %52, 0
...
if.then142:                                       ; preds = %if.else135
  %53 = load ptr, ptr @finput, align 8, !tbaa !9
  %call143 = tail call i32 @ungetc(i32 noundef %c.5331, ptr noundef %53)
  %54 = load ptr, ptr @finput, align 8, !tbaa !9
  %call.i295 = tail call i32 @_IO_getc(ptr noundef %54)
  %cmp.i = icmp eq i32 %call.i295, 45
  br i1 %cmp.i, label %if.then.i, label %if.end.i

if.then.i:                                        ; preds = %if.then142
  %call1.i = tail call i32 @_IO_getc(ptr noundef %54)
  br label %if.end.i
...
if.end.i:                                         ; preds = %if.then.i, %if.then142
  ...
  %55 = load ptr, ptr %call136, align 8, !tbaa !9
  %idxprom13.i = sext i32 %c.0.i to i64
  %arrayidx14.i = getelementptr inbounds i16, ptr %55, i64 %idxprom13.i
  %56 = load i16, ptr %arrayidx14.i, align 2, !tbaa !18
  %57 = and i16 %56, 2048
  %tobool.not15.i = icmp eq i16 %57, 0
...
while.body.i:                                     ; preds = %if.end.i, %while.body.i
  ...
  %call3.i = tail call i32 @_IO_getc(ptr noundef %54)
  %58 = load ptr, ptr %call136, align 8, !tbaa !9
  %idxprom.i = sext i32 %call3.i to i64
  %arrayidx.i = getelementptr inbounds i16, ptr %58, i64 %idxprom.i
  %59 = load i16, ptr %arrayidx.i, align 2, !tbaa !18
  %60 = and i16 %59, 2048
  %tobool.not.i296 = icmp eq i16 %60, 0
...
read_signed_integer.exit:                         ; preds = %while.body.i, %if.end.i
  ...
  %call4.i = tail call i32 @ungetc(i32 noundef %c.1.lcssa.i, ptr noundef %54)
  %mul5.i = mul nsw i32 %n.0.lcssa.i, %sign.0.i
  %61 = load ptr, ptr @finput, align 8, !tbaa !9
  %call145 = tail call i32 @_IO_getc(ptr noundef %61)
...
while.body.i299:                                  ; preds = %read_signed_integer.exit, %if.end5.i
  %rp.014.i = phi ptr [ %62, %if.end5.i ], [ %rule, %read_signed_integer.exit ]
  %i.013.i = phi i32 [ %inc.i, %if.end5.i ], [ 0, %read_signed_integer.exit ]
  %62 = load ptr, ptr %rp.014.i, align 8, !tbaa !23
  %cmp2.i = icmp eq ptr %62, null
  br i1 %cmp2.i, label %if.then4.i, label %lor.lhs.false.i

lor.lhs.false.i:                                  ; preds = %while.body.i299
  %sym.i = getelementptr inbounds %struct.symbol_list, ptr %62, i64 0, i32 1
  %63 = load ptr, ptr %sym.i, align 8, !tbaa !19
  %cmp3.i = icmp eq ptr %63, null
...
get_type_name.exit:                               ; preds = %if.end5.i
  %sym6.i = getelementptr inbounds %struct.symbol_list, ptr %62, i64 0, i32 1
  %64 = load ptr, ptr %sym6.i, align 8, !tbaa !19
  %type_name.i = getelementptr inbounds %struct.bucket, ptr %64, i64 0, i32 3
  %65 = load ptr, ptr %type_name.i, align 8, !tbaa !25
  br label %if.end152

if.end152:                                        ; preds = %get_type_name.exit, %read_signed_integer.exit
  %type_name.2 = phi ptr [ %65, %get_type_name.exit ], [ %type_name.0332, %read_signed_integer.exit ]
  %66 = load ptr, ptr @fguard, align 8, !tbaa !9
  %sub = sub nsw i32 %mul5.i, %spec.select
  %call153 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %66, ptr noundef nonnull @.str.40, i32 noundef %sub)
...
if.end157.thread:                                 ; preds = %if.end152
  %67 = load ptr, ptr @fguard, align 8, !tbaa !9
  %call156 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %67, ptr noundef nonnull @.str.38, ptr noundef nonnull %type_name.2)
...
if.then161:                                       ; preds = %if.end157
  ...
  %69 = load ptr, ptr @infile, align 8, !tbaa !9
  %70 = load i32, ptr @lineno, align 4, !tbaa !5
  %71 = load ptr, ptr %sym, align 8, !tbaa !19
  %tag163 = getelementptr inbounds %struct.bucket, ptr %71, i64 0, i32 2
  %72 = load ptr, ptr %tag163, align 8, !tbaa !22
  %call164 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %68, ptr noundef nonnull @.str.41, ptr noundef %69, i32 noundef %70, i32 noundef %mul5.i, ptr noundef %72) #15
  br label %while.cond.outer.backedge
...
sw.bb169:                                         ; preds = %while.body
  ...
  %call170 = tail call i32 @_IO_getc(ptr noundef %73)
  %call171 = tail call ptr @__ctype_b_loc() #16
  %74 = load ptr, ptr %call171, align 8, !tbaa !9
  %idxprom172 = sext i32 %call170 to i64
  %arrayidx173 = getelementptr inbounds i16, ptr %74, i64 %idxprom172
  %75 = load i16, ptr %arrayidx173, align 2, !tbaa !18
  %76 = and i16 %75, 2048
  %tobool176 = icmp ne i16 %76, 0
...
if.then180:                                       ; preds = %sw.bb169
  ...
  %call181 = tail call i32 @ungetc(i32 noundef %call170, ptr noundef %77)
  %78 = load ptr, ptr @finput, align 8, !tbaa !9
  %call.i300 = tail call i32 @_IO_getc(ptr noundef %78)
  %cmp.i301 = icmp eq i32 %call.i300, 45
  br i1 %cmp.i301, label %if.then.i303, label %if.end.i310

if.then.i303:                                     ; preds = %if.then180
  %call1.i302 = tail call i32 @_IO_getc(ptr noundef %78)
...
if.end.i310:                                      ; preds = %if.then.i303, %if.then180
  ...
  %79 = load ptr, ptr %call171, align 8, !tbaa !9
  %idxprom13.i307 = sext i32 %c.0.i304 to i64
  %arrayidx14.i308 = getelementptr inbounds i16, ptr %79, i64 %idxprom13.i307
  %80 = load i16, ptr %arrayidx14.i308, align 2, !tbaa !18
  %81 = and i16 %80, 2048
  %tobool.not15.i309 = icmp eq i16 %81, 0
...
while.body.i320:                                  ; preds = %if.end.i310, %while.body.i320
  ...
  %call3.i316 = tail call i32 @_IO_getc(ptr noundef %78)
  %82 = load ptr, ptr %call171, align 8, !tbaa !9
  %idxprom.i317 = sext i32 %call3.i316 to i64
  %arrayidx.i318 = getelementptr inbounds i16, ptr %82, i64 %idxprom.i317
  %83 = load i16, ptr %arrayidx.i318, align 2, !tbaa !18
  %84 = and i16 %83, 2048
  %tobool.not.i319 = icmp eq i16 %84, 0
...
read_signed_integer.exit325:                      ; preds = %while.body.i320, %if.end.i310
  ...
  %call4.i323 = tail call i32 @ungetc(i32 noundef %c.1.lcssa.i321, ptr noundef %78)
  %mul5.i324 = mul nsw i32 %n.0.lcssa.i322, %sign.0.i305
  %85 = load ptr, ptr @finput, align 8, !tbaa !9
  %call183 = tail call i32 @_IO_getc(ptr noundef %85)
  br label %if.end185
...
if.end185:                                        ; preds = %if.else184, %read_signed_integer.exit325
  ...
  %86 = load ptr, ptr @fguard, align 8, !tbaa !9
  %sub186 = sub nsw i32 %n.1, %spec.select
  %call187 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %86, ptr noundef nonnull @.str.44, i32 noundef %sub186)
...
sw.default:                                       ; preds = %while.body, %sw.bb188
  %87 = load ptr, ptr @fguard, align 8, !tbaa !9
  %call189 = tail call i32 @_IO_putc(i32 noundef %c.0, ptr noundef %87)
  br label %sw.epilog

sw.epilog.thread:                                 ; preds = %while.cond71
  %88 = load ptr, ptr @fguard, align 8, !tbaa !9
  %call81 = tail call i32 @_IO_putc(i32 noundef 47, ptr noundef %88)
  br label %if.then195

sw.epilog:                                        ; preds = %if.else166, %if.then20, %if.else, %sw.default, %while.end
  %c.7 = phi i32 [ %c.0, %sw.default ], [ %c.5331, %if.else166 ], [ %c.0, %while.end ], [ 125, %if.then20 ], [ 125, %if.else ]
  %count.1 = phi i32 [ %count.0.ph357, %sw.default ], [ %count.0.ph357, %if.else166 ], [ %count.0.ph357, %while.end ], [ %dec, %if.then20 ], [ %count.0.ph357, %if.else ]
  %brace_flag.1 = phi i32 [ %brace_flag.0.ph358, %sw.default ], [ %brace_flag.0.ph358, %if.else166 ], [ %brace_flag.0.ph358, %while.end ], [ 1, %if.then20 ], [ 1, %if.else ]
  %cmp190 = icmp ne i32 %c.7, 125
  %cmp193 = icmp ne i32 %count.1, 0
  %or.cond223 = select i1 %cmp190, i1 true, i1 %cmp193
  br i1 %or.cond223, label %if.then195, label %while.cond.outer355.backedge

while.cond.outer355.backedge:                     ; preds = %sw.epilog, %if.then195
  %c.0.ph356.be = phi i32 [ %call196, %if.then195 ], [ 125, %sw.epilog ]
  %count.0.ph357.be = phi i32 [ %count.1352, %if.then195 ], [ 0, %sw.epilog ]
  %brace_flag.0.ph358.be = phi i32 [ %brace_flag.1354, %if.then195 ], [ %brace_flag.1, %sw.epilog ]
  br label %while.cond.outer355, !llvm.loop !49

if.then195:                                       ; preds = %sw.epilog.thread, %if.end128.thread, %sw.bb, %sw.bb13, %if.end128, %if.then131, %sw.epilog
  %brace_flag.1354 = phi i32 [ %brace_flag.1, %sw.epilog ], [ %brace_flag.0.ph358, %if.then131 ], [ %brace_flag.0.ph358, %if.end128 ], [ %brace_flag.0.ph358, %sw.bb13 ], [ %brace_flag.0.ph358, %sw.bb ], [ %brace_flag.0.ph358, %if.end128.thread ], [ %brace_flag.0.ph358, %sw.epilog.thread ]
  %count.1352 = phi i32 [ %count.1, %sw.epilog ], [ %count.0.ph357, %if.then131 ], [ %count.0.ph357, %if.end128 ], [ %inc15, %sw.bb13 ], [ %count.0.ph357, %sw.bb ], [ %count.0.ph357, %if.end128.thread ], [ %count.0.ph357, %sw.epilog.thread ]
  %89 = load ptr, ptr @finput, align 8, !tbaa !9
  %call196 = tail call i32 @_IO_getc(ptr noundef %89)
  br label %while.cond.outer355.backedge

while.end198:                                     ; preds = %while.cond
  %call199 = tail call i32 @skip_white_space() #12
  %90 = load ptr, ptr @fguard, align 8, !tbaa !9
  %91 = tail call i64 @fwrite(ptr nonnull @.str.46, i64 13, i64 1, ptr %90)
...
if.then207:                                       ; preds = %while.end198
  ...
  %call208 = tail call i32 @_IO_getc(ptr noundef %92)
...
if.else213:                                       ; preds = %while.end198
  ...
  %call214 = tail call i32 @ungetc(i32 noundef %call199, ptr noundef %93)
  br label %if.end216
...
entry:
  %call = tail call i32 @_IO_getc(ptr noundef %stream)
  %cmp = icmp eq i32 %call, 45
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %call1 = tail call i32 @_IO_getc(ptr noundef %stream)
  br label %if.end
...
while.body:                                       ; preds = %if.end, %while.body
  ...
  %call3 = tail call i32 @_IO_getc(ptr noundef %stream)
...
while.cond8.outer.outer:                          ; preds = %while.cond8.outer.outer.backedge, %if.end5
  ...
  %count.1.ph.ph = phi i32 [ 1, %if.end5 ], [ %count.1.ph290, %while.cond8.outer.outer.backedge ]
...
while.cond8.outer:                                ; preds = %while.cond8.outer.outer, %if.end168
  ...
  br label %while.cond8.outer288

while.cond8.outer288:                             ; preds = %while.cond8.outer, %sw.epilog
  %c.1.ph289 = phi i32 [ %c.1.ph, %while.cond8.outer ], [ %call162, %sw.epilog ]
  %count.1.ph290 = phi i32 [ %count.1.ph, %while.cond8.outer ], [ %count.2, %sw.epilog ]
  br label %while.cond8

while.cond8:                                      ; preds = %while.cond8.outer288, %sw.bb40
  %c.1 = phi i32 [ %call42, %sw.bb40 ], [ %c.1.ph289, %while.cond8.outer288 ]
...
sw.bb:                                            ; preds = %while.cond8
  ...
  %call11 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %9)
  %10 = load i32, ptr @lineno, align 4, !tbaa !5
  %inc = add nsw i32 %10, 1
  store i32 %inc, ptr @lineno, align 4, !tbaa !5
  br label %sw.epilog
...
sw.bb12:                                          ; preds = %while.cond8
  ...
  %call13 = tail call i32 @_IO_putc(i32 noundef 123, ptr noundef %11)
  %inc14 = add nsw i32 %count.1.ph290, 1
  br label %sw.epilog

sw.bb15:                                          ; preds = %while.cond8, %while.cond8
  %12 = load ptr, ptr @faction, align 8, !tbaa !9
  %call16 = tail call i32 @_IO_putc(i32 noundef %c.1, ptr noundef %12)
  %13 = load ptr, ptr @finput, align 8, !tbaa !9
  %call17 = tail call i32 @_IO_getc(ptr noundef %13)
  %cmp19.not311 = icmp eq i32 %call17, %c.1
  br i1 %cmp19.not311, label %while.end, label %while.body20

while.body20:                                     ; preds = %sw.bb15, %if.end37
  %c.2312 = phi i32 [ %call38, %if.end37 ], [ %call17, %sw.bb15 ]
  switch i32 %c.2312, label %if.end24 [
...
if.end24.thread:                                  ; preds = %while.body20, %while.body20
  ...
  %call25267 = tail call i32 @_IO_putc(i32 noundef %c.2312, ptr noundef %14)
  br label %if.end37

if.end24:                                         ; preds = %while.body20
  %15 = load ptr, ptr @faction, align 8, !tbaa !9
  %call25 = tail call i32 @_IO_putc(i32 noundef %c.2312, ptr noundef %15)
  %cmp26 = icmp eq i32 %c.2312, 92
...
if.end31.thread:                                  ; preds = %if.then27
  ...
  %call32269 = tail call i32 @_IO_putc(i32 noundef -1, ptr noundef %17)
  br label %if.end37

if.end31:                                         ; preds = %if.then27
  %18 = load ptr, ptr @faction, align 8, !tbaa !9
  %call32 = tail call i32 @_IO_putc(i32 noundef %call28, ptr noundef %18)
...
if.end37:                                         ; preds = %if.end31.thread, %if.end24.thread, %if.end31, %if.then34, %if.end24
  %20 = load ptr, ptr @finput, align 8, !tbaa !9
  %call38 = tail call i32 @_IO_getc(ptr noundef %20)
...
while.end:                                        ; preds = %if.end37, %sw.bb15
  ...
  %call39 = tail call i32 @_IO_putc(i32 noundef %c.1, ptr noundef %21)
  br label %sw.epilog

sw.bb40:                                          ; preds = %while.cond8
  %22 = load ptr, ptr @faction, align 8, !tbaa !9
  %call41 = tail call i32 @_IO_putc(i32 noundef 47, ptr noundef %22)
  %23 = load ptr, ptr @finput, align 8, !tbaa !9
  %call42 = tail call i32 @_IO_getc(ptr noundef %23)
...
if.end45:                                         ; preds = %sw.bb40
  ...
  %call46 = tail call i32 @_IO_putc(i32 noundef 42, ptr noundef %24)
  %25 = load ptr, ptr @finput, align 8, !tbaa !9
  %call47 = tail call i32 @_IO_getc(ptr noundef %25)
  br label %while.body50

while.body50:                                     ; preds = %while.body50.backedge, %if.end45
  %c.3309 = phi i32 [ %call47, %if.end45 ], [ %c.3309.be, %while.body50.backedge ]
  switch i32 %c.3309, label %if.else71 [
...
while.cond53:                                     ; preds = %while.body50, %while.body55
  %c.4 = phi i32 [ %call57, %while.body55 ], [ %c.3309, %while.body50 ]
...
while.body55:                                     ; preds = %while.cond53
  ...
  %call56 = tail call i32 @_IO_putc(i32 noundef 42, ptr noundef %26)
  %27 = load ptr, ptr @finput, align 8, !tbaa !9
  %call57 = tail call i32 @_IO_getc(ptr noundef %27)
...
if.then64:                                        ; preds = %while.body50
  ...
  %call66 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %29)
  %30 = load ptr, ptr @finput, align 8, !tbaa !9
  %call67 = tail call i32 @_IO_getc(ptr noundef %30)
  br label %while.body50.backedge

while.body50.backedge:                            ; preds = %while.cond53, %if.then64, %if.else71, %if.then70
  %c.3309.be = phi i32 [ %call67, %if.then64 ], [ -1, %if.then70 ], [ %call73, %if.else71 ], [ %c.4, %while.cond53 ]
...
if.else71:                                        ; preds = %while.body50
  ...
  %call72 = tail call i32 @_IO_putc(i32 noundef %c.3309, ptr noundef %31)
  %32 = load ptr, ptr @finput, align 8, !tbaa !9
  %call73 = tail call i32 @_IO_getc(ptr noundef %32)
  br label %while.body50.backedge

sw.bb78:                                          ; preds = %while.cond8
  %33 = load ptr, ptr @finput, align 8, !tbaa !9
  %call79 = tail call i32 @_IO_getc(ptr noundef %33)
...
while.cond82.preheader:                           ; preds = %sw.bb78
  %34 = load ptr, ptr @finput, align 8, !tbaa !9
  %call83304 = tail call i32 @_IO_getc(ptr noundef %34)
  %cmp84305 = icmp ne i32 %call83304, 62
  %cmp85306 = icmp sgt i32 %call83304, 0
  %35 = and i1 %cmp84305, %cmp85306
  br i1 %35, label %while.body86, label %if.end89

while.body86:                                     ; preds = %while.cond82.preheader, %while.body86
  %call83308 = phi i32 [ %call83, %while.body86 ], [ %call83304, %while.cond82.preheader ]
  %cp.0307 = phi ptr [ %incdec.ptr, %while.body86 ], [ @token_buffer, %while.cond82.preheader ]
  %conv = trunc i32 %call83308 to i8
  %incdec.ptr = getelementptr inbounds i8, ptr %cp.0307, i64 1
  store i8 %conv, ptr %cp.0307, align 1, !tbaa !16
  %36 = load ptr, ptr @finput, align 8, !tbaa !9
  %call83 = tail call i32 @_IO_getc(ptr noundef %36)
...
if.end89:                                         ; preds = %while.body86, %while.cond82.preheader
  ...
  store i8 0, ptr %cp.0.lcssa, align 1, !tbaa !16
  %38 = load ptr, ptr @finput, align 8, !tbaa !9
  %call88 = tail call i32 @_IO_getc(ptr noundef %38)
...
if.end97:                                         ; preds = %if.end89.thread
  ...
  br i1 %tobool98.not, label %if.end101, label %if.end101.thread

if.end101.thread:                                 ; preds = %if.then92, %if.end97
...
if.end101:                                        ; preds = %if.end97
  ...
  br i1 %.b233, label %if.then104, label %sw.epilog
...
if.then104:                                       ; preds = %if.end101
  ...
  %tag = getelementptr inbounds %struct.bucket, ptr %43, i64 0, i32 2
  %49 = load ptr, ptr %tag, align 8, !tbaa !22
  %call105 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %46, ptr noundef nonnull @.str.39, ptr noundef %47, i32 noundef %48, ptr noundef %49) #15
  br label %sw.epilog
...
if.else107:                                       ; preds = %if.end89.thread, %if.end89
  ...
  %50 = load ptr, ptr %call108, align 8, !tbaa !9
  %idxprom = sext i32 %c.6274 to i64
  %arrayidx = getelementptr inbounds i16, ptr %50, i64 %idxprom
  %51 = load i16, ptr %arrayidx, align 2, !tbaa !18
  %52 = and i16 %51, 2048
  %tobool110 = icmp ne i16 %52, 0
...
if.then114:                                       ; preds = %if.else107
  %53 = load ptr, ptr @finput, align 8, !tbaa !9
  %call115 = tail call i32 @ungetc(i32 noundef %c.6274, ptr noundef %53)
  %54 = load ptr, ptr @finput, align 8, !tbaa !9
  %call.i234 = tail call i32 @_IO_getc(ptr noundef %54)
...
if.end.i:                                         ; preds = %if.then.i, %if.then114
  ...
  %55 = load ptr, ptr %call108, align 8, !tbaa !9
  %idxprom13.i = sext i32 %c.0.i to i64
  %arrayidx14.i = getelementptr inbounds i16, ptr %55, i64 %idxprom13.i
  %56 = load i16, ptr %arrayidx14.i, align 2, !tbaa !18
  %57 = and i16 %56, 2048
...
while.body.i:                                     ; preds = %if.end.i, %while.body.i
  ...
  %add.i = add nsw i32 %sub.i, %mul.i
  %call3.i = tail call i32 @_IO_getc(ptr noundef %54)
  %58 = load ptr, ptr %call108, align 8, !tbaa !9
  %idxprom.i = sext i32 %call3.i to i64
  %arrayidx.i = getelementptr inbounds i16, ptr %58, i64 %idxprom.i
  %59 = load i16, ptr %arrayidx.i, align 2, !tbaa !18
  %60 = and i16 %59, 2048
  %tobool.not.i235 = icmp eq i16 %60, 0
...
read_signed_integer.exit:                         ; preds = %while.body.i, %if.end.i
  ...
  %mul5.i = mul nsw i32 %n.0.lcssa.i, %sign.0.i
  %61 = load ptr, ptr @finput, align 8, !tbaa !9
  %call117 = tail call i32 @_IO_getc(ptr noundef %61)
...
get_type_name.exit:                               ; preds = %if.end5.i
  %sym6.i239 = getelementptr inbounds %struct.symbol_list, ptr %62, i64 0, i32 1
  %64 = load ptr, ptr %sym6.i239, align 8, !tbaa !19
  %type_name.i240 = getelementptr inbounds %struct.bucket, ptr %64, i64 0, i32 3
  %65 = load ptr, ptr %type_name.i240, align 8, !tbaa !25
  br label %if.end124

if.end124:                                        ; preds = %get_type_name.exit, %read_signed_integer.exit
  %type_name.2 = phi ptr [ %65, %get_type_name.exit ], [ %type_name.0275, %read_signed_integer.exit ]
  %66 = load ptr, ptr @faction, align 8, !tbaa !9
  %sub = sub nsw i32 %mul5.i, %spec.select
  %call125 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %66, ptr noundef nonnull @.str.40, i32 noundef %sub)
...
if.end129.thread:                                 ; preds = %if.end124
  ...
  %call128 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %67, ptr noundef nonnull @.str.38, ptr noundef nonnull %type_name.2)
...
if.then133:                                       ; preds = %if.end129
  ...
  %69 = load ptr, ptr @infile, align 8, !tbaa !9
  %70 = load i32, ptr @lineno, align 4, !tbaa !5
  %71 = load ptr, ptr %sym6.i, align 8, !tbaa !19
  %tag135 = getelementptr inbounds %struct.bucket, ptr %71, i64 0, i32 2
  %72 = load ptr, ptr %tag135, align 8, !tbaa !22
  %call136 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %68, ptr noundef nonnull @.str.41, ptr noundef %69, i32 noundef %70, i32 noundef %mul5.i, ptr noundef %72) #15
  br label %while.cond8.outer.outer.backedge
...
sw.bb141:                                         ; preds = %while.cond8
  %73 = load ptr, ptr @finput, align 8, !tbaa !9
  %call142 = tail call i32 @_IO_getc(ptr noundef %73)
  %call143 = tail call ptr @__ctype_b_loc() #16
  %74 = load ptr, ptr %call143, align 8, !tbaa !9
  %idxprom144 = sext i32 %call142 to i64
  %arrayidx145 = getelementptr inbounds i16, ptr %74, i64 %idxprom144
  %75 = load i16, ptr %arrayidx145, align 2, !tbaa !18
  %76 = and i16 %75, 2048
  %tobool148 = icmp ne i16 %76, 0
...
if.then152:                                       ; preds = %sw.bb141
  %77 = load ptr, ptr @finput, align 8, !tbaa !9
  %call153 = tail call i32 @ungetc(i32 noundef %call142, ptr noundef %77)
  %78 = load ptr, ptr @finput, align 8, !tbaa !9
  %call.i241 = tail call i32 @_IO_getc(ptr noundef %78)
  %cmp.i242 = icmp eq i32 %call.i241, 45
  br i1 %cmp.i242, label %if.then.i244, label %if.end.i251

if.then.i244:                                     ; preds = %if.then152
  %call1.i243 = tail call i32 @_IO_getc(ptr noundef %78)
...
if.end.i251:                                      ; preds = %if.then.i244, %if.then152
  ...
  %79 = load ptr, ptr %call143, align 8, !tbaa !9
  %idxprom13.i248 = sext i32 %c.0.i245 to i64
  %arrayidx14.i249 = getelementptr inbounds i16, ptr %79, i64 %idxprom13.i248
  %80 = load i16, ptr %arrayidx14.i249, align 2, !tbaa !18
  %81 = and i16 %80, 2048
  %tobool.not15.i250 = icmp eq i16 %81, 0
...
while.body.i261:                                  ; preds = %if.end.i251, %while.body.i261
  ...
  %call3.i257 = tail call i32 @_IO_getc(ptr noundef %78)
  %82 = load ptr, ptr %call143, align 8, !tbaa !9
  %idxprom.i258 = sext i32 %call3.i257 to i64
  %arrayidx.i259 = getelementptr inbounds i16, ptr %82, i64 %idxprom.i258
  %83 = load i16, ptr %arrayidx.i259, align 2, !tbaa !18
  %84 = and i16 %83, 2048
  %tobool.not.i260 = icmp eq i16 %84, 0
...
read_signed_integer.exit266:                      ; preds = %while.body.i261, %if.end.i251
  ...
  %call4.i264 = tail call i32 @ungetc(i32 noundef %c.1.lcssa.i262, ptr noundef %78)
  %mul5.i265 = mul nsw i32 %n.0.lcssa.i263, %sign.0.i246
  %85 = load ptr, ptr @finput, align 8, !tbaa !9
  %call155 = tail call i32 @_IO_getc(ptr noundef %85)
  br label %if.end157
...
if.end157:                                        ; preds = %if.else156, %read_signed_integer.exit266
  ...
  %86 = load ptr, ptr @faction, align 8, !tbaa !9
  %sub158 = sub nsw i32 %n.2, %spec.select
  %call159 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %86, ptr noundef nonnull @.str.44, i32 noundef %sub158)
  store i1 true, ptr @yylsp_needed, align 4
  br label %while.cond8.outer.outer.backedge
...
sw.default:                                       ; preds = %while.cond8, %sw.bb160
  ...
  %call161 = tail call i32 @_IO_putc(i32 noundef %c.1, ptr noundef %87)
  br label %sw.epilog

sw.epilog.loopexit:                               ; preds = %while.cond53
  %88 = load ptr, ptr @faction, align 8, !tbaa !9
  %call61 = tail call i32 @_IO_putc(i32 noundef 47, ptr noundef %88)
  br label %sw.epilog

sw.epilog:                                        ; preds = %sw.epilog.loopexit, %if.end101.thread, %if.else138, %if.then104, %if.end101, %sw.default, %while.end, %sw.bb12, %sw.bb
  %count.2 = phi i32 [ %count.1.ph290, %sw.default ], [ %count.1.ph290, %if.then104 ], [ %count.1.ph290, %if.end101 ], [ %count.1.ph290, %if.else138 ], [ %count.1.ph290, %while.end ], [ %inc14, %sw.bb12 ], [ %count.1.ph290, %sw.bb ], [ %count.1.ph290, %if.end101.thread ], [ %count.1.ph290, %sw.epilog.loopexit ]
  %89 = load ptr, ptr @finput, align 8, !tbaa !9
  %call162 = tail call i32 @_IO_getc(ptr noundef %89)
  br label %while.cond8.outer288, !llvm.loop !55

while.end163:                                     ; preds = %while.cond8
  %dec = add nsw i32 %count.1.ph290, -1
...
if.end168:                                        ; preds = %while.end163
  ...
  %call166 = tail call i32 @_IO_putc(i32 noundef 125, ptr noundef %90)
  %91 = load ptr, ptr @finput, align 8, !tbaa !9
  %call167 = tail call i32 @_IO_getc(ptr noundef %91)
  %cmp = icmp sgt i32 %count.1.ph290, 1
  br i1 %cmp, label %while.cond8.outer, label %while.end169, !llvm.loop !59

while.end169:                                     ; preds = %while.end163, %if.end168
  %92 = load ptr, ptr @faction, align 8, !tbaa !9
  %93 = tail call i64 @fwrite(ptr nonnull @.str.46, i64 13, i64 1, ptr %92)
  ret void
}
...
cond.true:                                        ; preds = %if.then18
  ...
  %.pre = sext i16 %8 to i32
  br label %cond.end

cond.end:                                         ; preds = %if.then18, %cond.true
  %cond.pre-phi = phi i32 [ %conv, %if.then18 ], [ %.pre, %cond.true ]
  %call = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %file, ptr noundef nonnull @.str.66, ptr noundef nonnull %3, i32 noundef %cond.pre-phi)
...
for.end:                                          ; preds = %for.inc, %entry
  %call37 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %file)
  ret void
}
