; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c"
...
@.str = private unnamed_addr constant [95 x i8] c"/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/obsequi/negamax.c\00", align 1
...
for.body60:                                       ; preds = %for.body60.lr.ph, %if.end739
  ...
  br i1 %cmp736, label %for.end746.split.loop.exit1170, label %if.end739
...
for.end746.split.loop.exit1170:                   ; preds = %for.body60
  %76 = trunc i64 %indvars.iv1138 to i32
  br label %for.end746

for.end746:                                       ; preds = %if.end739, %for.end746.split.loop.exit1170
  %i.1.lcssa = phi i32 [ %76, %for.end746.split.loop.exit1170 ], [ %num_moves.01132, %if.end739 ]
...
if.then749:                                       ; preds = %for.end746.thread, %for.end746
  ...
  %77 = load i32, ptr %arrayidx765, align 4, !tbaa !13
  ...
  store i32 %77, ptr %col.row, align 4, !tbaa !9
  %78 = load i32, ptr %mask_index769, align 4, !tbaa !15
  store i32 %78, ptr %row.col, align 4, !tbaa !9
  %79 = load i64, ptr @g_num_nodes, align 8, !tbaa !16
  store i64 %79, ptr %nodes, align 8, !tbaa !16
...
for.body778:                                      ; preds = %for.body778.preheader, %for.inc797
  ...
  %80 = load i32, ptr %info781, align 4, !tbaa !33
  %cmp782 = icmp slt i32 %80, -4999
...
if.then789:                                       ; preds = %if.else786
  %81 = trunc i64 %indvars.iv1143 to i32
  %sub790 = sub nsw i32 %81, %rem774.01121
...
for.body808:                                      ; preds = %for.body808.preheader, %for.inc849
  ...
  %cmp8141123 = icmp ult i64 %indvars.iv.next1158, %82
  %83 = trunc i64 %indvars.iv1157 to i32
...
for.body816.preheader:                            ; preds = %for.body808
  ...
  %84 = load i32, ptr %info811, align 4, !tbaa !33
...
for.body816:                                      ; preds = %for.body816.preheader, %for.body816
  ...
  %index.01125 = phi i32 [ %83, %for.body816.preheader ], [ %spec.select1097, %for.body816 ]
  %max.01124 = phi i32 [ %84, %for.body816.preheader ], [ %spec.select1096, %for.body816 ]
  %info819 = getelementptr inbounds [256 x %struct.Move], ptr %movelist, i64 0, i64 %indvars.iv1150, i32 2
  %85 = load i32, ptr %info819, align 4, !tbaa !33
  %cmp820 = icmp sgt i32 %85, %max.01124
  %spec.select1096 = call i32 @llvm.smax.i32(i32 %85, i32 %max.01124)
  %86 = trunc i64 %indvars.iv1150 to i32
  %spec.select1097 = select i1 %cmp820, i32 %86, i32 %index.01125
  %indvars.iv.next1151 = add nuw nsw i64 %indvars.iv1150, 1
  %87 = trunc i64 %indvars.iv.next1151 to i32
  %cmp814 = icmp sgt i32 %sub800, %87
  br i1 %cmp814, label %for.body816, label %for.end829, !llvm.loop !37

for.end829:                                       ; preds = %for.body816, %for.body808
  %index.0.lcssa = phi i32 [ %83, %for.body808 ], [ %spec.select1097, %for.body816 ]
  %88 = zext i32 %index.0.lcssa to i64
  %cmp830.not = icmp eq i64 %indvars.iv1157, %88
...
for.body838:                                      ; preds = %if.then832, %for.body838
  ...
  %89 = and i64 %indvars.iv.next1155, 4294967295
  %cmp836.not = icmp eq i64 %89, %indvars.iv1157
  br i1 %cmp836.not, label %for.end845, label %for.body838, !llvm.loop !38

for.end845:                                       ; preds = %for.body838
...
for.inc849:                                       ; preds = %for.end829, %for.end845
...
for.end861:                                       ; preds = %for.end799, %for.inc859
  store i32 -1, ptr %row, align 4, !tbaa !9
  store i32 -1, ptr %col, align 4, !tbaa !9
  %91 = load i64, ptr @g_num_nodes, align 8, !tbaa !16
  store i64 %91, ptr %nodes, align 8, !tbaa !16
  br label %cleanup862
...
if.then753:                                       ; preds = %for.body
  ...
  %74 = load i32, ptr @starting_depth, align 4, !tbaa !9
  %sub756 = sub nsw i32 %74, %depth_remaining
  %idxprom757 = sext i32 %sub756 to i64
  %arrayidx758 = getelementptr inbounds [40 x i32], ptr @stat_cutoffs, i64 0, i64 %idxprom757
  %75 = load i32, ptr %arrayidx758, align 4, !tbaa !9
  %inc759 = add nsw i32 %75, 1
  store i32 %inc759, ptr %arrayidx758, align 4, !tbaa !9
  %cmp760 = icmp slt i32 %73, 5
...
if.then762:                                       ; preds = %if.then753
  ...
  %76 = load i32, ptr %arrayidx767, align 4, !tbaa !9
  %inc768 = add nsw i32 %76, 1
...
if.else769:                                       ; preds = %if.then753
  ...
  %77 = load i32, ptr %arrayidx773, align 4, !tbaa !9
  %inc774 = add nsw i32 %77, 1
  store i32 %inc774, ptr %arrayidx773, align 4, !tbaa !9
  br label %for.end

if.end776:                                        ; preds = %for.body
  %78 = load i32, ptr %alpha.addr, align 4, !tbaa !9
  %cmp777 = icmp sgt i32 %71, %78
...
for.end:                                          ; preds = %for.inc, %if.end81.for.end_crit_edge, %if.then762, %if.else769
  %79 = phi i32 [ %72, %if.then762 ], [ %72, %if.else769 ], [ %.pre992, %if.end81.for.end_crit_edge ], [ %72, %for.inc ]
  %80 = phi i32 [ %71, %if.then762 ], [ %71, %if.else769 ], [ %.pre, %if.end81.for.end_crit_edge ], [ %71, %for.inc ]
  %i.1984 = phi i32 [ %73, %if.then762 ], [ %73, %if.else769 ], [ %i.0, %if.end81.for.end_crit_edge ], [ %num_moves.1, %for.inc ]
  %cmp784 = icmp slt i32 %80, %79
  %or.cond = and i1 %cmp63, %cmp784
  br i1 %or.cond, label %while.body, label %while.end, !llvm.loop !42

while.end:                                        ; preds = %for.end
  %81 = load i32, ptr %alpha.addr, align 4, !tbaa !9
  %82 = load i64, ptr @g_num_nodes, align 8, !tbaa !16
  %conv788 = and i64 %0, 4294967295
  %sub789 = sub i64 %82, %conv788
  %shr = lshr i64 %sub789, 5
  %conv790 = trunc i64 %shr to i32
  call void @hashstore(i32 noundef %81, i32 noundef %alpha, i32 noundef %beta, i32 noundef %conv790, i32 noundef %depth_remaining, ptr noundef nonnull byval(%struct.Move) align 8 %best, i32 noundef %and) #10
  %83 = load i32, ptr %alpha.addr, align 4, !tbaa !9
  br label %cleanup791

cleanup791:                                       ; preds = %if.end, %if.then, %while.end, %if.then47, %if.then41, %if.then35, %if.then31, %if.then20
  %retval.1 = phi i32 [ 5000, %if.then20 ], [ -5000, %if.then31 ], [ %9, %if.then35 ], [ 5000, %if.then41 ], [ -5000, %if.then47 ], [ %83, %while.end ], [ 5000, %if.then ], [ %spec.select, %if.end ]
