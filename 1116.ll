; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/LzmaHandler.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/LzmaHandler.cpp"
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i64, ptr %_packSize, align 8, !tbaa !39
...
sw.bb:                                            ; preds = %entry
  ...
  %1 = load ptr, ptr %_stream, align 8, !tbaa !48
...
sw.bb7:                                           ; preds = %entry
  %_packSizeDefined = getelementptr inbounds %"class.NArchive::NLzma::CHandler", ptr %this, i64 0, i32 7
  %4 = load i8, ptr %_packSizeDefined, align 8, !tbaa !49, !range !50, !noundef !51
  %tobool8.not = icmp eq i8 %4, 0
  br i1 %tobool8.not, label %sw.epilog, label %if.then9

if.then9:                                         ; preds = %sw.bb7
  %_packSize = getelementptr inbounds %"class.NArchive::NLzma::CHandler", ptr %this, i64 0, i32 6
  %5 = load i64, ptr %_packSize, align 8, !tbaa !39
...
sw.bb13:                                          ; preds = %entry
  ...
  %8 = load ptr, ptr %_stream14, align 8, !tbaa !48
...
cleanup.cont10:                                   ; preds = %cleanup.cont
  ...
  %3 = load i8, ptr %_lzma86, align 8, !tbaa !55, !range !50, !noundef !51
...
if.end14:                                         ; preds = %cleanup.cont10
  %4 = load i8, ptr %_lzma86, align 8, !tbaa !55, !range !50, !noundef !51
...
if.end.i:                                         ; preds = %if.end19
  ...
  %sub = sub i64 %7, %8
  %_packSize = getelementptr inbounds %"class.NArchive::NLzma::CHandler", ptr %this, i64 0, i32 6
  store i64 %sub, ptr %_packSize, align 8, !tbaa !39
  %_packSizeDefined = getelementptr inbounds %"class.NArchive::NLzma::CHandler", ptr %this, i64 0, i32 7
  store i8 1, ptr %_packSizeDefined, align 8, !tbaa !49
  %_stream = getelementptr inbounds %"class.NArchive::NLzma::CHandler", ptr %this, i64 0, i32 8
  ...
  %10 = load ptr, ptr %_stream, align 8, !tbaa !48
...
if.end.i53:                                       ; preds = %if.end.i, %if.then2.i
  store ptr %inStream, ptr %_stream, align 8, !tbaa !48
...
entry:
  %_packSizeDefined = getelementptr inbounds %"class.NArchive::NLzma::CHandler", ptr %this, i64 0, i32 7
  store i8 0, ptr %_packSizeDefined, align 8, !tbaa !49
  %_stream = getelementptr inbounds %"class.NArchive::NLzma::CHandler", ptr %this, i64 0, i32 8
  %0 = load ptr, ptr %_stream, align 8, !tbaa !48
  %tobool.not.i = icmp eq ptr %0, null
...
if.then.i:                                        ; preds = %entry
  ...
  store ptr null, ptr %_stream, align 8, !tbaa !48
...
if.then7:                                         ; preds = %if.end6
  %_packSize = getelementptr inbounds %"class.NArchive::NLzma::CHandler", ptr %this, i64 0, i32 6
  %2 = load i64, ptr %_packSize, align 8, !tbaa !39
...
invoke.cont56:                                    ; preds = %invoke.cont54
  %19 = load ptr, ptr %_stream, align 8, !tbaa !48
...
invoke.cont79:                                    ; preds = %invoke.cont56, %invoke.cont69
  ...
  %_lzma86 = getelementptr inbounds %"class.NArchive::NLzma::CHandler", ptr %this, i64 0, i32 4
  %30 = load i8, ptr %_lzma86, align 8, !tbaa !55, !range !50, !noundef !51
...
invoke.cont96.preheader:                          ; preds = %invoke.cont84
  ...
  store i64 %34, ptr %_packSize98, align 8, !tbaa !39
...
cleanup.cont108.peel:                             ; preds = %invoke.cont101.peel
  ...
  %35 = load i8, ptr %_lzma86, align 8, !tbaa !55, !range !50, !noundef !51
...
if.end124.peel:                                   ; preds = %cleanup.cont121.peel
  %38 = load i8, ptr %_lzma86, align 8, !tbaa !55, !range !50, !noundef !51
...
invoke.cont96:                                    ; preds = %cleanup152.peel, %cleanup152
  ...
  store i64 %42, ptr %_packSize98, align 8, !tbaa !39
...
cleanup.cont108:                                  ; preds = %invoke.cont101
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %st) #19
  call void @llvm.lifetime.start.p0(i64 14, ptr nonnull %buf) #19
  %44 = load i8, ptr %_lzma86, align 8, !tbaa !55, !range !50, !noundef !51
...
if.end124:                                        ; preds = %cleanup.cont121
  %47 = load i8, ptr %_lzma86, align 8, !tbaa !55, !range !50, !noundef !51
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit:    ; preds = %entry, %if.then.i
  %_stream = getelementptr inbounds %"class.NArchive::NLzma::CHandler", ptr %this, i64 0, i32 8
  %4 = load ptr, ptr %_stream, align 8, !tbaa !48
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i:  ; preds = %if.then.i.i, %entry
  ...
  %4 = load ptr, ptr %_stream.i, align 8, !tbaa !48
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i:  ; preds = %if.then.i.i, %entry
  ...
  %5 = load ptr, ptr %_stream.i, align 8, !tbaa !48
...
_ZN9CMyComPtrI19ISequentialInStreamED2Ev.exit.i.i: ; preds = %if.then.i.i.i, %entry
  ...
  %5 = load ptr, ptr %_stream.i.i, align 8, !tbaa !48
...
; Function Attrs: uwtable
define internal noundef nonnull ptr @_ZN8NArchive5NLzmaL9CreateArcEv() #2 personality ptr @__gxx_personality_v0 {
invoke.cont:
...
; Function Attrs: uwtable
define internal noundef nonnull ptr @_ZN8NArchive5NLzmaL11CreateArc86Ev() #2 personality ptr @__gxx_personality_v0 {
invoke.cont:
  %call = tail call noalias noundef nonnull dereferenceable(88) ptr @_Znwm(i64 noundef 88) #17
  %0 = getelementptr inbounds i8, ptr %call, i64 8
  %1 = getelementptr inbounds i8, ptr %call, i64 16
