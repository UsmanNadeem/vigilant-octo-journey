; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z16.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z16.c"
...
; Function Attrs: nounwind uwtable
define dso_local void @SetNeighbours(ptr nocapture noundef readonly %link, i32 noundef %ratm, ptr nocapture noundef %pg, ptr nocapture noundef writeonly %pdef, ptr nocapture noundef %sg, ptr nocapture noundef writeonly %sdef, ptr nocapture noundef writeonly %side) local_unnamed_addr #0 {
entry:
...
FindShift.exit:                                   ; preds = %sw.epilog.i, %sw.bb14.i, %sw.bb20.i, %sw.default22.i
  ...
  %110 = load i32, ptr %b.addr, align 4, !tbaa !19
  ...
  %111 = load i32, ptr %f.addr, align 4, !tbaa !19
