; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tree.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tree.c"
...
@.str.18 = private unnamed_addr constant [104 x i8] c"/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tree.c\00", align 1

; Function Attrs: nounwind uwtable
define dso_local void @treeinit(ptr noundef %p, ptr noundef %LibDict) local_unnamed_addr #0 {
entry:
  %buf.i542 = alloca [8192 x i8], align 16
  %buf.i535 = alloca [8192 x i8], align 16
  %buf.i528 = alloca [8192 x i8], align 16
...
if.then6:                                         ; preds = %if.end4
  ...
  %call2.i = tail call ptr @fopen(ptr noundef nonnull @personaldict, ptr noundef nonnull @.str.7)
...
if.end.i:                                         ; preds = %if.then6, %if.then4.i
  ...
  %call2.i471 = call ptr @fopen(ptr noundef nonnull %seconddict, ptr noundef nonnull @.str.7)
  %cmp3.i472 = icmp eq ptr %call2.i471, null
  br i1 %cmp3.i472, label %trydict.exit474, label %if.end31

trydict.exit474:                                  ; preds = %if.end.i
...
if.then11:                                        ; preds = %trydict.exit474
  %call.i475 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) @personaldict, ptr noundef nonnull dereferenceable(1) @.str.16, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #17
  %call2.i477 = tail call ptr @fopen(ptr noundef nonnull @personaldict, ptr noundef nonnull @.str.7)
  %cmp3.i478 = icmp eq ptr %call2.i477, null
  br i1 %cmp3.i478, label %if.then4.i480, label %if.end.i489

if.then4.i480:                                    ; preds = %if.then11
  store i8 0, ptr @personaldict, align 16, !tbaa !5
  br label %if.end.i489

if.end.i489:                                      ; preds = %if.then11, %if.then4.i480
  store ptr %call2.i477, ptr @dictf, align 8, !tbaa !8
  %call1.i485 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %seconddict, ptr noundef nonnull dereferenceable(1) @.str.4, ptr noundef nonnull %call1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #17
  %call2.i487 = call ptr @fopen(ptr noundef nonnull %seconddict, ptr noundef nonnull @.str.7)
  %cmp3.i488 = icmp eq ptr %call2.i487, null
  br i1 %cmp3.i488, label %if.end15, label %if.end31

if.end15:                                         ; preds = %if.end.i489
  store i8 0, ptr %seconddict, align 16, !tbaa !5
...
if.then19:                                        ; preds = %if.end15
  %call.i492 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) @personaldict, ptr noundef nonnull dereferenceable(1) @.str.16, ptr noundef nonnull @.str.2, ptr noundef %LibDict) #17
  %call2.i494 = tail call ptr @fopen(ptr noundef nonnull @personaldict, ptr noundef nonnull @.str.7)
  %cmp3.i495 = icmp eq ptr %call2.i494, null
  br i1 %cmp3.i495, label %if.then4.i497, label %if.end.i506

if.then4.i497:                                    ; preds = %if.then19
  store i8 0, ptr @personaldict, align 16, !tbaa !5
  br label %if.end.i506

if.end.i506:                                      ; preds = %if.then19, %if.then4.i497
  store ptr %call2.i494, ptr @dictf, align 8, !tbaa !8
  %call1.i502 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %seconddict, ptr noundef nonnull dereferenceable(1) @.str.4, ptr noundef nonnull %call1, ptr noundef nonnull @.str.2, ptr noundef %LibDict) #17
  %call2.i504 = call ptr @fopen(ptr noundef nonnull %seconddict, ptr noundef nonnull @.str.7)
  %cmp3.i505 = icmp eq ptr %call2.i504, null
  br i1 %cmp3.i505, label %if.end23, label %if.end31

if.end23:                                         ; preds = %if.end.i506
  store i8 0, ptr %seconddict, align 16, !tbaa !5
  %.pre560 = load ptr, ptr @dictf, align 8, !tbaa !8
  %cmp24 = icmp eq ptr %.pre560, null
  br i1 %cmp24, label %if.then27, label %if.end31

if.then27:                                        ; preds = %if.end23
  %call.i509 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) @personaldict, ptr noundef nonnull dereferenceable(1) @.str.16, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #17
  %call2.i511 = tail call ptr @fopen(ptr noundef nonnull @personaldict, ptr noundef nonnull @.str.7)
  %cmp3.i512 = icmp eq ptr %call2.i511, null
  br i1 %cmp3.i512, label %if.then4.i514, label %if.end.i523

if.then4.i514:                                    ; preds = %if.then27
  store i8 0, ptr @personaldict, align 16, !tbaa !5
  br label %if.end.i523

if.end.i523:                                      ; preds = %if.then27, %if.then4.i514
  store ptr %call2.i511, ptr @dictf, align 8, !tbaa !8
  %call1.i519 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %seconddict, ptr noundef nonnull dereferenceable(1) @.str.4, ptr noundef nonnull %call1, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #17
  %call2.i521 = call ptr @fopen(ptr noundef nonnull %seconddict, ptr noundef nonnull @.str.7)
  %cmp3.i522 = icmp eq ptr %call2.i521, null
  br i1 %cmp3.i522, label %if.then4.i524, label %if.end31

if.then4.i524:                                    ; preds = %if.end.i523
  store i8 0, ptr %seconddict, align 16, !tbaa !5
  br label %if.end31

if.end31:                                         ; preds = %trydict.exit474, %if.end15, %if.end.i, %if.end.i489, %if.end.i506, %if.then4.i524, %if.end.i523, %if.end23
  %secondf.2 = phi ptr [ null, %if.end23 ], [ %call2.i521, %if.end.i523 ], [ null, %if.then4.i524 ], [ %call2.i504, %if.end.i506 ], [ %call2.i487, %if.end.i489 ], [ %call2.i471, %if.end.i ], [ null, %if.end15 ], [ null, %trydict.exit474 ]
...
if.then46:                                        ; preds = %if.end43
  ...
  %call2.i526 = call ptr @fgets(ptr noundef nonnull %buf.i, i32 noundef 8192, ptr noundef nonnull %3)
  %cmp.not3.i = icmp eq ptr %call2.i526, null
...
while.body.i:                                     ; preds = %if.then46, %while.body.i
  ...
  %call.i527 = call ptr @fgets(ptr noundef nonnull %buf.i, i32 noundef 8192, ptr noundef nonnull %3)
  %cmp.not.i = icmp eq ptr %call.i527, null
...
if.end48:                                         ; preds = %treeload.exit, %if.end43
  ...
  br i1 %cmp49.not, label %if.end396, label %if.then51

if.then51:                                        ; preds = %if.end48
  call void @llvm.lifetime.start.p0(i64 8192, ptr nonnull %buf.i528) #17
  %call2.i529 = call ptr @fgets(ptr noundef nonnull %buf.i528, i32 noundef 8192, ptr noundef nonnull %secondf.2)
  %cmp.not3.i530 = icmp eq ptr %call2.i529, null
  br i1 %cmp.not3.i530, label %treeload.exit534, label %while.body.i533

while.body.i533:                                  ; preds = %if.then51, %while.body.i533
  call void @treeinsert(ptr noundef nonnull %buf.i528, i32 noundef 8192, i32 noundef 1)
  %call.i531 = call ptr @fgets(ptr noundef nonnull %buf.i528, i32 noundef 8192, ptr noundef nonnull %secondf.2)
  %cmp.not.i532 = icmp eq ptr %call.i531, null
  br i1 %cmp.not.i532, label %treeload.exit534, label %while.body.i533, !llvm.loop !10

treeload.exit534:                                 ; preds = %while.body.i533, %if.then51
  store i32 0, ptr @newwords, align 4, !tbaa !12
  call void @llvm.lifetime.end.p0(i64 8192, ptr nonnull %buf.i528) #17
...
if.else54:                                        ; preds = %if.end4
  ...
  br i1 %cmp56, label %if.then363, label %cond.false196

cond.false196:                                    ; preds = %if.else54
  %call197 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %p.addr.0, ptr noundef nonnull dereferenceable(3) @.str.5, i64 noundef 2) #18
  %6 = icmp eq i32 %call197, 0
  br i1 %6, label %if.then363, label %cond.false356

cond.false356:                                    ; preds = %cond.false196
  %call357 = tail call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %p.addr.0, ptr noundef nonnull dereferenceable(4) @.str.6, i64 noundef 3) #18
  %7 = icmp eq i32 %call357, 0
  br i1 %7, label %if.then363, label %if.else371

if.then363:                                       ; preds = %cond.false196, %if.else54, %cond.false356
  %call364 = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) @personaldict, ptr noundef nonnull dereferenceable(1) %p.addr.0) #17
  %call365 = tail call ptr @fopen(ptr noundef nonnull @personaldict, ptr noundef nonnull @.str.7)
  store ptr %call365, ptr @dictf, align 8, !tbaa !8
  %cmp366.not = icmp eq ptr %call365, null
  br i1 %cmp366.not, label %if.end396, label %if.then368

if.then368:                                       ; preds = %if.then363
  call void @llvm.lifetime.start.p0(i64 8192, ptr nonnull %buf.i535) #17
  %call2.i536 = call ptr @fgets(ptr noundef nonnull %buf.i535, i32 noundef 8192, ptr noundef nonnull %call365)
  %cmp.not3.i537 = icmp eq ptr %call2.i536, null
  br i1 %cmp.not3.i537, label %treeload.exit541, label %while.body.i540

while.body.i540:                                  ; preds = %if.then368, %while.body.i540
  call void @treeinsert(ptr noundef nonnull %buf.i535, i32 noundef 8192, i32 noundef 1)
  %call.i538 = call ptr @fgets(ptr noundef nonnull %buf.i535, i32 noundef 8192, ptr noundef nonnull %call365)
  %cmp.not.i539 = icmp eq ptr %call.i538, null
  br i1 %cmp.not.i539, label %treeload.exit541, label %while.body.i540, !llvm.loop !10

treeload.exit541:                                 ; preds = %while.body.i540, %if.then368
  store i32 0, ptr @newwords, align 4, !tbaa !12
  call void @llvm.lifetime.end.p0(i64 8192, ptr nonnull %buf.i535) #17
  %8 = load ptr, ptr @dictf, align 8, !tbaa !8
  %call369 = call i32 @fclose(ptr noundef %8)
  br label %if.end396

if.else371:                                       ; preds = %cond.false356
  %call372 = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) @personaldict, ptr noundef nonnull dereferenceable(1) %p.addr.0) #17
  %call373 = tail call ptr @fopen(ptr noundef nonnull @personaldict, ptr noundef nonnull @.str.7)
  store ptr %call373, ptr @dictf, align 8, !tbaa !8
  %cmp374.not = icmp eq ptr %call373, null
  br i1 %cmp374.not, label %if.then380, label %if.then376

if.then376:                                       ; preds = %if.else371
  call void @llvm.lifetime.start.p0(i64 8192, ptr nonnull %buf.i542) #17
  %call2.i543 = call ptr @fgets(ptr noundef nonnull %buf.i542, i32 noundef 8192, ptr noundef nonnull %call373)
  %cmp.not3.i544 = icmp eq ptr %call2.i543, null
  br i1 %cmp.not3.i544, label %treeload.exit548, label %while.body.i547

while.body.i547:                                  ; preds = %if.then376, %while.body.i547
  call void @treeinsert(ptr noundef nonnull %buf.i542, i32 noundef 8192, i32 noundef 1)
  %call.i545 = call ptr @fgets(ptr noundef nonnull %buf.i542, i32 noundef 8192, ptr noundef nonnull %call373)
  %cmp.not.i546 = icmp eq ptr %call.i545, null
  br i1 %cmp.not.i546, label %treeload.exit548, label %while.body.i547, !llvm.loop !10

treeload.exit548:                                 ; preds = %while.body.i547, %if.then376
  store i32 0, ptr @newwords, align 4, !tbaa !12
  call void @llvm.lifetime.end.p0(i64 8192, ptr nonnull %buf.i542) #17
  %9 = load ptr, ptr @dictf, align 8, !tbaa !8
  %call377 = call i32 @fclose(ptr noundef %9)
  br label %if.end389

if.then380:                                       ; preds = %if.else371
  %call381 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) @personaldict, ptr noundef nonnull dereferenceable(1) @.str.8, ptr noundef nonnull %call1, ptr noundef nonnull %p.addr.0) #17
  %call382 = tail call ptr @fopen(ptr noundef nonnull @personaldict, ptr noundef nonnull @.str.7)
  store ptr %call382, ptr @dictf, align 8, !tbaa !8
  %cmp383.not = icmp eq ptr %call382, null
  br i1 %cmp383.not, label %if.then392, label %if.then385

if.then385:                                       ; preds = %if.then380
  tail call fastcc void @treeload(ptr noundef nonnull %call382)
  %10 = load ptr, ptr @dictf, align 8, !tbaa !8
  %call386 = tail call i32 @fclose(ptr noundef %10)
  br label %if.end389

if.end389:                                        ; preds = %if.then385, %treeload.exit548
  %.pr = load ptr, ptr @dictf, align 8, !tbaa !8
  %cmp390 = icmp eq ptr %.pr, null
  br i1 %cmp390, label %if.then392, label %if.end396

if.then392:                                       ; preds = %if.then380, %if.end389
  %11 = load ptr, ptr @stderr, align 8, !tbaa !8
  %call393 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %11, ptr noundef nonnull @.str.9, ptr noundef nonnull %p.addr.0) #19
  call void @perror(ptr noundef nonnull @.str.10) #19
  br label %cleanup

if.end396:                                        ; preds = %treeload.exit541, %if.then363, %if.end389, %if.end48, %treeload.exit534
  %12 = load i32, ptr @lflag, align 4, !tbaa !12
  %tobool397 = icmp ne i32 %12, 0
  %13 = load i32, ptr @aflag, align 4
  %tobool399 = icmp ne i32 %13, 0
  %or.cond423 = select i1 %tobool397, i1 true, i1 %tobool399
  br i1 %or.cond423, label %cleanup, label %land.lhs.true400

land.lhs.true400:                                 ; preds = %if.end396
  %call401 = call i32 @access(ptr noundef nonnull @personaldict, i32 noundef 2) #17
  %cmp402 = icmp slt i32 %call401, 0
  br i1 %cmp402, label %land.lhs.true404, label %cleanup

land.lhs.true404:                                 ; preds = %land.lhs.true400
  %call405 = tail call ptr @__errno_location() #20
  %14 = load i32, ptr %call405, align 4, !tbaa !12
  %cmp406.not = icmp eq i32 %14, 2
  br i1 %cmp406.not, label %cleanup, label %if.then408

if.then408:                                       ; preds = %land.lhs.true404
  %15 = load ptr, ptr @stderr, align 8, !tbaa !8
  %call409 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %15, ptr noundef nonnull @.str.11, ptr noundef nonnull @personaldict) #19
  %call410 = call i32 @sleep(i32 noundef 2) #17
  br label %cleanup

cleanup:                                          ; preds = %if.end396, %land.lhs.true400, %land.lhs.true404, %if.then408, %if.end, %if.then392
...
entry:
  ...
  %.b220 = load i1, ptr @pershsize, align 4
  br i1 %.b220, label %if.end, label %cleanup
...
if.end:                                           ; preds = %entry
  ...
  %cmp2.not215 = icmp eq ptr %1, null
  br i1 %cmp2.not215, label %cleanup, label %land.rhs.preheader
...
land.rhs:                                         ; preds = %land.rhs.preheader, %while.end
  %hp.0216 = phi ptr [ %6, %while.end ], [ %arrayidx, %land.rhs.preheader ]
  %mask = getelementptr inbounds %struct.dent, ptr %hp.0216, i64 0, i32 2
...
while.body:                                       ; preds = %land.rhs
  %word172 = getelementptr inbounds %struct.dent, ptr %hp.0216, i64 0, i32 1
  %3 = load ptr, ptr %word172, align 8, !tbaa !16
  %call173 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %chword, ptr noundef nonnull dereferenceable(1) %3) #17
  %cmp180 = icmp eq i32 %call173, 0
  br i1 %cmp180, label %cleanup, label %while.cond184.preheader

while.cond184.preheader:                          ; preds = %while.body
  %and187212 = and i64 %2, 1073741824
  %tobool188.not213 = icmp eq i64 %and187212, 0
  br i1 %tobool188.not213, label %while.end, label %while.body189

while.body189:                                    ; preds = %while.cond184.preheader, %while.body189
  %hp.1214 = phi ptr [ %4, %while.body189 ], [ %hp.0216, %while.cond184.preheader ]
  %4 = load ptr, ptr %hp.1214, align 8, !tbaa !19
  %mask185 = getelementptr inbounds %struct.dent, ptr %4, i64 0, i32 2
  %5 = load i64, ptr %mask185, align 8, !tbaa !14
  %and187 = and i64 %5, 1073741824
  %tobool188.not = icmp eq i64 %and187, 0
  br i1 %tobool188.not, label %while.end, label %while.body189, !llvm.loop !21

while.end:                                        ; preds = %while.body189, %while.cond184.preheader
  %hp.1.lcssa = phi ptr [ %hp.0216, %while.cond184.preheader ], [ %4, %while.body189 ]
...
cleanup:                                          ; preds = %while.body, %while.end, %land.rhs, %if.end, %entry
  %retval.0 = phi ptr [ null, %entry ], [ null, %if.end ], [ %hp.0216, %while.body ], [ null, %while.end ], [ null, %land.rhs ]
...
if.end:                                           ; preds = %entry
  %call = tail call ptr @fopen(ptr noundef nonnull @personaldict, ptr noundef nonnull @.str.14)
