; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/zlib_inftrees.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/zlib_inftrees.c"
...
if.then268:                                       ; preds = %for.end265
  %conv129.le = trunc i32 %sub128 to i8
  ...
  store i8 %conv129.le, ptr %here.sroa.11.0.arrayidx275.sroa_idx, align 1, !tbaa.struct !19
