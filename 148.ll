; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/UI/Common/ArchiveCommandLine.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/UI/Common/ArchiveCommandLine.cpp"
...
entry:
  %end.i1438 = alloca ptr, align 8
  %end.i1415 = alloca ptr, align 8
...
common.resume:                                    ; preds = %ehcleanup390, %ehcleanup622, %delete.notnull.i1499, %lpad.i.i1268, %delete.notnull.i.i.i, %ehcleanup65.i, %_ZN11CStringBaseIwED2Ev.exit33.i, %_ZN11CStringBaseIwED2Ev.exit.i.i, %_ZN11CStringBaseIwED2Ev.exit43.i, %lpad.i.i1503, %lpad.i.i1384, %lpad.i891, %lpad.i.i817, %lpad.i.i804, %lpad.i.i800, %_ZN11CStringBaseIwED2Ev.exit28.i, %lpad.i.i
  %common.resume.op = phi { ptr, i32 } [ %1, %lpad.i.i ], [ %.pn.pn.i, %_ZN11CStringBaseIwED2Ev.exit28.i ], [ %18, %lpad.i.i800 ], [ %34, %lpad.i.i804 ], [ %49, %lpad.i.i817 ], [ %127, %lpad.i891 ], [ %464, %lpad.i.i1384 ], [ %502, %lpad.i.i1503 ], [ %80, %_ZN11CStringBaseIwED2Ev.exit.i.i ], [ %89, %_ZN11CStringBaseIwED2Ev.exit43.i ], [ %52, %_ZN11CStringBaseIwED2Ev.exit33.i ], [ %.pn.pn.i1318, %ehcleanup65.i ], [ %292, %delete.notnull.i.i.i ], [ %292, %lpad.i.i1268 ], [ %.pn781.pn, %ehcleanup390 ], [ %.pn763, %ehcleanup622 ], [ %.pn7631669, %delete.notnull.i1499 ]
...
if.end50:                                         ; preds = %if.then45, %if.end40
  ...
  %StdInMode = getelementptr inbounds %struct.CArchiveCommandLineOptions, ptr %options, i64 0, i32 5
  %32 = load i8, ptr %StdInMode, align 1
  %tobool71.not = icmp eq i8 %32, 0
  %or.cond = select i1 %31, i1 true, i1 %tobool71.not
  %33 = and i1 %or.cond, %tobool54.not
  %spec.select796 = select i1 %33, i1 %spec.select, i1 false
...
for.body.i:                                       ; preds = %if.end15.i, %for.body.lr.ph.i
  ...
  %58 = load i32, ptr %_length.i36.i, align 8, !tbaa !48
...
vector.memcheck:                                  ; preds = %for.body.lr.ph.i.i
  ...
  %ref.tmp10.sroa.0.1.i1965 = ptrtoint ptr %ref.tmp10.sroa.0.1.i to i64
  %67 = add nuw i64 %66, 4
  %68 = sub i64 %ref.tmp10.sroa.0.1.i1965, %67
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load1966 = load <4 x i32>, ptr %71, align 4, !tbaa !50, !noalias !59
  ...
  store <4 x i32> %wide.load1966, ptr %73, align 4, !tbaa !50, !noalias !59
...
invoke.cont223:                                   ; preds = %invoke.cont219
  ...
  %or.cond1672 = select i1 %cmp225.not, i1 true, i1 %cmp228
  br i1 %or.cond1672, label %if.then229, label %if.end230
...
_ZN13CObjectVectorI11CStringBaseIwEED2Ev.exit:    ; preds = %if.end230
  ...
  %cmp2391749 = icmp sgt i32 %172, 0
  br i1 %cmp2391749, label %for.body.lr.ph, label %for.cond.cleanup
...
_ZN9CDirItemsD2Ev.exit.if.end267_crit_edge:       ; preds = %_ZN9CDirItemsD2Ev.exit
  ...
  %.pre1834 = load i32, ptr %_size.i1119.phi.trans.insert, align 4, !tbaa !49
  br label %if.end267

for.body:                                         ; preds = %for.body.lr.ph, %if.end255
  %177 = phi i32 [ %172, %for.body.lr.ph ], [ %196, %if.end255 ]
  %indvars.iv1821 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next1822, %if.end255 ]
  %178 = load ptr, ptr %_items.i.i1055, align 8, !tbaa !47
  %arrayidx.i.i1057 = getelementptr inbounds ptr, ptr %178, i64 %indvars.iv1821
...
if.then246:                                       ; preds = %for.body
  ...
  %181 = trunc i64 %indvars.iv1821 to i32
...
_ZN11CStringBaseIwED2Ev.exit1088:                 ; preds = %invoke.cont251, %delete.notnull.i1087
  ...
  %.pre1833 = load i32, ptr %_size.i1051, align 4, !tbaa !49
  br label %if.end255
...
if.end255:                                        ; preds = %_ZN11CStringBaseIwED2Ev.exit1088, %for.body
  %196 = phi i32 [ %.pre1833, %_ZN11CStringBaseIwED2Ev.exit1088 ], [ %177, %for.body ]
  %indvars.iv.next1822 = add nuw nsw i64 %indvars.iv1821, 1
  %197 = sext i32 %196 to i64
  %cmp239 = icmp slt i64 %indvars.iv.next1822, %197
...
if.end267:                                        ; preds = %_ZN9CDirItemsD2Ev.exit.if.end267_crit_edge, %_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit1118
  %209 = phi i32 [ %.pre1834, %_ZN9CDirItemsD2Ev.exit.if.end267_crit_edge ], [ %inc.i.i1113, %_ZN13CObjectVectorI11CStringBaseIwEE3AddERKS1_.exit1118 ]
...
if.end273:                                        ; preds = %if.end267
  ...
  %cmp2811751 = icmp sgt i32 %209, 0
  br i1 %cmp2811751, label %for.body282.lr.ph, label %for.end298
...
for.body282:                                      ; preds = %for.body282.lr.ph, %_ZN11CStringBaseIwED2Ev.exit1159
  %indvars.iv1824 = phi i64 [ 0, %for.body282.lr.ph ], [ %indvars.iv.next1825, %_ZN11CStringBaseIwED2Ev.exit1159 ]
...
invoke.cont284:                                   ; preds = %for.body282
  ...
  %arrayidx.i.i1129 = getelementptr inbounds ptr, ptr %211, i64 %indvars.iv1824
...
_ZN11CStringBaseIwED2Ev.exit1159:                 ; preds = %invoke.cont292, %delete.notnull.i1158
  ...
  %cmp281 = icmp slt i64 %indvars.iv.next1825, %226
...
for.cond311.preheader:                            ; preds = %invoke.cont306
  ...
  %cmp3141753 = icmp sgt i32 %232, 0
  br i1 %cmp3141753, label %for.body315.lr.ph, label %for.end332
...
for.body315:                                      ; preds = %for.body315.lr.ph, %for.inc330
  %indvars.iv1827 = phi i64 [ 0, %for.body315.lr.ph ], [ %indvars.iv.next1828, %for.inc330 ]
  %233 = load ptr, ptr %_items.i, align 8, !tbaa !47
  %arrayidx.i = getelementptr inbounds i32, ptr %233, i64 %indvars.iv1827
...
invoke.cont321:                                   ; preds = %invoke.cont.i1193
  ...
  %arrayidx.i1200 = getelementptr inbounds i32, ptr %247, i64 %indvars.iv1827
...
for.inc330:                                       ; preds = %invoke.cont.i1226
  ...
  %cmp314 = icmp slt i64 %indvars.iv.next1828, %262
...
invoke.cont32.thread.i.i:                         ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i172.i.i, %call.i.i32.i.noexc.i.i
  ...
  %uglygep.i.i = getelementptr i8, ptr %postString.sroa.0.1.i.i, i64 4
  %356 = shl nuw nsw i64 %355, 2
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %archivePath.sroa.0.1.i.i, ptr align 4 %uglygep.i.i, i64 %356, i1 false), !tbaa !50, !noalias !95
...
if.then431._ZN11CStringBaseIwEaSERKS0_.exit1344_crit_edge: ; preds = %if.then431
  %.pre1832 = load i32, ptr %_length.i1345.phi.trans.insert, align 8, !tbaa !48
...
_ZN11CStringBaseIwEaSERKS0_.exit1344:             ; preds = %if.then431._ZN11CStringBaseIwEaSERKS0_.exit1344_crit_edge, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i1343
  %438 = phi i32 [ %.pre1832, %if.then431._ZN11CStringBaseIwEaSERKS0_.exit1344_crit_edge ], [ %437, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i1343 ]
...
_ZN11CStringBaseIwE6DeleteEii.exit:               ; preds = %if.then440
  ...
  %conv.i.i1350 = zext i32 %438 to i64
  %mul.i.i = shl nuw nsw i64 %conv.i.i1350, 2
...
if.then477:                                       ; preds = %if.end474
  ...
  %_items.i.i.i1351 = getelementptr inbounds %"struct.NCommandLineParser::CSwitchResult", ptr %call479, i64 0, i32 3, i32 0, i32 0, i32 3
  %446 = load ptr, ptr %_items.i.i.i1351, align 8, !tbaa !47
  ...
  %cmp.i1352 = icmp eq ptr %447, %StdInFileName
  br i1 %cmp.i1352, label %if.end637, label %if.end.i1358

if.end.i1358:                                     ; preds = %if.then477
  %_length.i.i1353 = getelementptr inbounds %struct.CArchiveCommandLineOptions, ptr %options, i64 0, i32 23, i32 8, i32 1
  store i32 0, ptr %_length.i.i1353, align 8, !tbaa !48
  ...
  %449 = load i32, ptr %_length.i1354, align 8, !tbaa !48
  ...
  %450 = load i32, ptr %_capacity.i.i1356, align 4, !tbaa !52
  %cmp.i.i1357 = icmp eq i32 %add.i.i1355, %450
  br i1 %cmp.i.i1357, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1368, label %if.end.i.i1362

if.end.i.i1362:                                   ; preds = %if.end.i1358
  ...
  %call.i.i1360 = call noalias noundef nonnull ptr @_Znam(i64 noundef %453) #20
  %cmp3.i.i1361 = icmp sgt i32 %450, 0
  br i1 %cmp3.i.i1361, label %delete.notnull.i.i1364, label %if.end9.i.i1367

delete.notnull.i.i1364:                           ; preds = %if.end.i.i1362
  call void @_ZdaPv(ptr noundef nonnull %448) #18
  %.pre.i1363 = load i32, ptr %_length.i.i1353, align 8, !tbaa !48
  %454 = sext i32 %.pre.i1363 to i64
  br label %if.end9.i.i1367

if.end9.i.i1367:                                  ; preds = %delete.notnull.i.i1364, %if.end.i.i1362
  %idxprom13.i.i1365 = phi i64 [ %454, %delete.notnull.i.i1364 ], [ 0, %if.end.i.i1362 ]
  store ptr %call.i.i1360, ptr %StdInFileName, align 8, !tbaa !10
  %arrayidx14.i.i1366 = getelementptr inbounds i32, ptr %call.i.i1360, i64 %idxprom13.i.i1365
  store i32 0, ptr %arrayidx14.i.i1366, align 4, !tbaa !50
  store i32 %add.i.i1355, ptr %_capacity.i.i1356, align 4, !tbaa !52
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1368

_ZN11CStringBaseIwE11SetCapacityEi.exit.i1368:    ; preds = %if.end9.i.i1367, %if.end.i1358
  %455 = phi ptr [ %448, %if.end.i1358 ], [ %call.i.i1360, %if.end9.i.i1367 ]
  %456 = load ptr, ptr %447, align 8, !tbaa !10
  br label %while.cond.i.i1374

while.cond.i.i1374:                               ; preds = %while.cond.i.i1374, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1368
  %src.addr.0.i.i1369 = phi ptr [ %456, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1368 ], [ %incdec.ptr.i.i1371, %while.cond.i.i1374 ]
  %dest.addr.0.i.i1370 = phi ptr [ %455, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1368 ], [ %incdec.ptr1.i.i1372, %while.cond.i.i1374 ]
  %incdec.ptr.i.i1371 = getelementptr inbounds i32, ptr %src.addr.0.i.i1369, i64 1
  %457 = load i32, ptr %src.addr.0.i.i1369, align 4, !tbaa !50
  %incdec.ptr1.i.i1372 = getelementptr inbounds i32, ptr %dest.addr.0.i.i1370, i64 1
  store i32 %457, ptr %dest.addr.0.i.i1370, align 4, !tbaa !50
  %cmp.not.i.i1373 = icmp eq i32 %457, 0
  br i1 %cmp.not.i.i1373, label %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i1375, label %while.cond.i.i1374, !llvm.loop !53

_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i1375:        ; preds = %while.cond.i.i1374
  %458 = load i32, ptr %_length.i1354, align 8, !tbaa !48
  store i32 %458, ptr %_length.i.i1353, align 8, !tbaa !48
  br label %if.end637
...
if.then490:                                       ; preds = %if.then488
  ...
  %idxprom.i.i1378 = zext i32 %curCommandIndex.0 to i64
  %arrayidx.i.i1379 = getelementptr inbounds ptr, ptr %459, i64 %idxprom.i.i1378
  %460 = load ptr, ptr %arrayidx.i.i1379, align 8, !tbaa !19
  %461 = load ptr, ptr %460, align 8, !tbaa !10
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %end.i) #19
  %call.i1380 = call noundef i64 @_Z21ConvertStringToUInt64PKwPS0_(ptr noundef %461, ptr noundef nonnull %end.i)
  %462 = load ptr, ptr %end.i, align 8, !tbaa !19
  %463 = load i32, ptr %462, align 4, !tbaa !50
  %cmp.not.i = icmp eq i32 %463, 0
  %cmp1.i = icmp ult i64 %call.i1380, 4294967296
...
_ZL21ConvertStringToUInt32PKwRj.exit.thread:      ; preds = %if.then490
  %conv.i = trunc i64 %call.i1380 to i32
...
if.then496:                                       ; preds = %if.then490
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %end.i) #19
  %exception.i.i1382 = call ptr @__cxa_allocate_exception(i64 16) #19
  invoke void @_ZN28CArchiveCommandLineExceptionC2EPKc(ptr noundef nonnull align 8 dereferenceable(16) %exception.i.i1382, ptr noundef nonnull @.str.41)
          to label %invoke.cont.i.i1383 unwind label %lpad.i.i1384

invoke.cont.i.i1383:                              ; preds = %if.then496
  call void @__cxa_throw(ptr nonnull %exception.i.i1382, ptr nonnull @_ZTI28CArchiveCommandLineException, ptr nonnull @_ZN11CStringBaseIcED2Ev) #21
  unreachable

lpad.i.i1384:                                     ; preds = %if.then496
  %464 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_free_exception(ptr %exception.i.i1382) #19
  br label %common.resume

if.end498:                                        ; preds = %_ZL21ConvertStringToUInt32PKwRj.exit.thread, %if.then488
  %call5021744 = call noundef nonnull align 8 dereferenceable(44) ptr @_ZNK18NCommandLineParser7CParserixEm(ptr noundef nonnull align 8 dereferenceable(48) %this, i64 noundef 8)
  %_size.i13861745 = getelementptr inbounds %"struct.NCommandLineParser::CSwitchResult", ptr %call5021744, i64 0, i32 3, i32 0, i32 0, i32 2
  %465 = load i32, ptr %_size.i13861745, align 4, !tbaa !49
  %cmp5051746 = icmp sgt i32 %465, 0
  br i1 %cmp5051746, label %for.body507.lr.ph, label %if.end637
...
for.body507:                                      ; preds = %for.body507.lr.ph, %_ZN11CStringBaseIwED2Ev.exit1497
  %indvars.iv = phi i64 [ 0, %for.body507.lr.ph ], [ %indvars.iv.next, %_ZN11CStringBaseIwED2Ev.exit1497 ]
  ...
  %_items.i.i1387 = getelementptr inbounds %"struct.NCommandLineParser::CSwitchResult", ptr %call509, i64 0, i32 3, i32 0, i32 0, i32 3
  %466 = load ptr, ptr %_items.i.i1387, align 8, !tbaa !47
  %arrayidx.i.i1389 = getelementptr inbounds ptr, ptr %466, i64 %indvars.iv
  %467 = load ptr, ptr %arrayidx.i.i1389, align 8, !tbaa !19
  %_length2.i1390 = getelementptr inbounds %class.CStringBase, ptr %467, i64 0, i32 1
  %468 = load i32, ptr %_length2.i1390, align 8, !tbaa !48
  %add.i.i1391 = add nsw i32 %468, 1
  %cmp.i.i1392 = icmp eq i32 %add.i.i1391, 0
  br i1 %cmp.i.i1392, label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1397, label %if.end9.i.i1396

if.end9.i.i1396:                                  ; preds = %for.body507
  %conv.i.i1394 = zext i32 %add.i.i1391 to i64
  %469 = icmp slt i32 %468, -1
  %470 = shl nuw nsw i64 %conv.i.i1394, 2
  %471 = select i1 %469, i64 -1, i64 %470
  %call.i.i1395 = call noalias noundef nonnull ptr @_Znam(i64 noundef %471) #20
  store i32 0, ptr %call.i.i1395, align 4, !tbaa !50
  br label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1397

_ZN11CStringBaseIwE11SetCapacityEi.exit.i1397:    ; preds = %if.end9.i.i1396, %for.body507
  %postString.sroa.0.1 = phi ptr [ null, %for.body507 ], [ %call.i.i1395, %if.end9.i.i1396 ]
  %472 = load ptr, ptr %467, align 8, !tbaa !10
  br label %while.cond.i.i1403

while.cond.i.i1403:                               ; preds = %while.cond.i.i1403, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1397
  %src.addr.0.i.i1398 = phi ptr [ %472, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1397 ], [ %incdec.ptr.i.i1400, %while.cond.i.i1403 ]
  %dest.addr.0.i.i1399 = phi ptr [ %postString.sroa.0.1, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1397 ], [ %incdec.ptr1.i.i1401, %while.cond.i.i1403 ]
  %incdec.ptr.i.i1400 = getelementptr inbounds i32, ptr %src.addr.0.i.i1398, i64 1
  %473 = load i32, ptr %src.addr.0.i.i1398, align 4, !tbaa !50
  %incdec.ptr1.i.i1401 = getelementptr inbounds i32, ptr %dest.addr.0.i.i1399, i64 1
  store i32 %473, ptr %dest.addr.0.i.i1399, align 4, !tbaa !50
  %cmp.not.i.i1402 = icmp eq i32 %473, 0
  br i1 %cmp.not.i.i1402, label %_ZN11CStringBaseIwEC2ERKS0_.exit1406, label %while.cond.i.i1403, !llvm.loop !53

_ZN11CStringBaseIwEC2ERKS0_.exit1406:             ; preds = %while.cond.i.i1403
  %call.i14071408 = invoke noundef ptr @_Z13MyStringUpperPw(ptr noundef %postString.sroa.0.1)
          to label %invoke.cont513 unwind label %lpad512.loopexit

invoke.cont513:                                   ; preds = %_ZN11CStringBaseIwEC2ERKS0_.exit1406
  %cmp516 = icmp slt i32 %468, 2
  br i1 %cmp516, label %if.end9.i.i.i1511, label %if.end519

if.end9.i.i.i1511:                                ; preds = %invoke.cont513
  %exception.i.i1410 = call ptr @__cxa_allocate_exception(i64 16) #19
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %exception.i.i1410, i8 0, i64 16, i1 false)
  %call.i.i.i15101518 = invoke noalias noundef nonnull dereferenceable(23) ptr @_Znam(i64 noundef 23) #20
          to label %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i unwind label %lpad.i.i1412

_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i:      ; preds = %if.end9.i.i.i1511
  store ptr %call.i.i.i15101518, ptr %exception.i.i1410, align 8, !tbaa !14
  br label %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i.invoke

_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i.invoke: ; preds = %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1615, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i
  %call.i.i.i16131623.sink = phi ptr [ %call.i.i.i16131623, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1615 ], [ %call.i.i.i15101518, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i ]
  %exception.i.i1488.sink = phi ptr [ %exception.i.i1488, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1615 ], [ %exception.i.i1410, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i ]
  %_capacity.i.i1611.sink = getelementptr inbounds %class.CStringBase.9, ptr %exception.i.i1488.sink, i64 0, i32 2
  store i32 23, ptr %_capacity.i.i1611.sink, align 4, !tbaa !16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(23) %call.i.i.i16131623.sink, ptr noundef nonnull align 1 dereferenceable(23) @.str.41, i64 23, i1 false), !tbaa !17
  %_length.i.i1622 = getelementptr inbounds %class.CStringBase.9, ptr %exception.i.i1488.sink, i64 0, i32 1
  store i32 22, ptr %_length.i.i1622, align 8, !tbaa !18
  invoke void @__cxa_throw(ptr nonnull %exception.i.i1488.sink, ptr nonnull @_ZTI28CArchiveCommandLineException, ptr nonnull @_ZN11CStringBaseIcED2Ev) #21
...
lpad.i.i1412:                                     ; preds = %if.end9.i.i.i1511
  %474 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_free_exception(ptr nonnull %exception.i.i1410) #19
  br label %ehcleanup622

lpad512.loopexit:                                 ; preds = %_ZN11CStringBaseIwEC2ERKS0_.exit1406
...
if.end519:                                        ; preds = %invoke.cont513
  ...
  switch i32 %475, label %if.end9.i.i.i1614 [
...
if.then524:                                       ; preds = %if.end519
  ...
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %end.i1415) #19
  %call.i14161423 = invoke noundef i64 @_Z21ConvertStringToUInt64PKwPS0_(ptr noundef nonnull %add.ptr, ptr noundef nonnull %end.i1415)
          to label %call.i1416.noexc unwind label %lpad534.loopexit

call.i1416.noexc:                                 ; preds = %if.then524
  %477 = load ptr, ptr %end.i1415, align 8, !tbaa !19
  %478 = load i32, ptr %477, align 4, !tbaa !50
  %cmp.not.i1417 = icmp eq i32 %478, 0
  %cmp1.i1418 = icmp ult i64 %call.i14161423, 4294967296
  %or.cond.not.i1419 = and i1 %cmp1.i1418, %cmp.not.i1417
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %end.i1415) #19
  br i1 %or.cond.not.i1419, label %if.end541, label %if.end9.i.i.i1530

if.end9.i.i.i1530:                                ; preds = %call.i1416.noexc
  %exception.i.i1425 = call ptr @__cxa_allocate_exception(i64 16) #19
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %exception.i.i1425, i8 0, i64 16, i1 false)
  %call.i.i.i15291539 = invoke noalias noundef nonnull dereferenceable(23) ptr @_Znam(i64 noundef 23) #20
          to label %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1531 unwind label %lpad.i.i1427

_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1531:  ; preds = %if.end9.i.i.i1530
  store ptr %call.i.i.i15291539, ptr %exception.i.i1425, align 8, !tbaa !14
  br label %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1531.invoke

_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1531.invoke: ; preds = %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1553, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1531
  %call.i.i.i15511561.sink = phi ptr [ %call.i.i.i15511561, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1553 ], [ %call.i.i.i15291539, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1531 ]
  %exception.i.i1431.sink = phi ptr [ %exception.i.i1431, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1553 ], [ %exception.i.i1425, %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1531 ]
  %_capacity.i.i1549.sink = getelementptr inbounds %class.CStringBase.9, ptr %exception.i.i1431.sink, i64 0, i32 2
  store i32 23, ptr %_capacity.i.i1549.sink, align 4, !tbaa !16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(23) %call.i.i.i15511561.sink, ptr noundef nonnull align 1 dereferenceable(23) @.str.41, i64 23, i1 false), !tbaa !17
  %_length.i.i1560 = getelementptr inbounds %class.CStringBase.9, ptr %exception.i.i1431.sink, i64 0, i32 1
  store i32 22, ptr %_length.i.i1560, align 8, !tbaa !18
  invoke void @__cxa_throw(ptr nonnull %exception.i.i1431.sink, ptr nonnull @_ZTI28CArchiveCommandLineException, ptr nonnull @_ZN11CStringBaseIcED2Ev) #21
          to label %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1531.cont unwind label %lpad534.loopexit.split-lp

_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1531.cont: ; preds = %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1531.invoke
  unreachable

lpad.i.i1427:                                     ; preds = %if.end9.i.i.i1530
  %479 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_free_exception(ptr nonnull %exception.i.i1425) #19
  br label %delete.notnull.i1499
...
lpad534.loopexit.split-lp:                        ; preds = %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1531.invoke
  %lpad.loopexit.split-lp1682 = landingpad { ptr, i32 }
          cleanup
  br label %delete.notnull.i1499

if.end541:                                        ; preds = %call.i1416.noexc
  %conv.i1420 = trunc i64 %call.i14161423 to i32
  %cmp542 = icmp ugt i32 %conv.i1420, 31
  br i1 %cmp542, label %if.end9.i.i.i1552, label %if.end545

if.end9.i.i.i1552:                                ; preds = %if.end541
  %exception.i.i1431 = call ptr @__cxa_allocate_exception(i64 16) #19
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %exception.i.i1431, i8 0, i64 16, i1 false)
  %call.i.i.i15511561 = invoke noalias noundef nonnull dereferenceable(23) ptr @_Znam(i64 noundef 23) #20
          to label %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1553 unwind label %lpad.i.i1433

_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1553:  ; preds = %if.end9.i.i.i1552
  store ptr %call.i.i.i15511561, ptr %exception.i.i1431, align 8, !tbaa !14
  br label %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1531.invoke

lpad.i.i1433:                                     ; preds = %if.end9.i.i.i1552
  %480 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_free_exception(ptr nonnull %exception.i.i1431) #19
  br label %delete.notnull.i1499

if.end545:                                        ; preds = %if.end541
  %shl = shl nuw i32 1, %conv.i1420
  store i32 %shl, ptr %DictionarySize, align 4, !tbaa !108
  br label %_ZN11CStringBaseIwED2Ev.exit1497
...
land.lhs.true554:                                 ; preds = %if.end519
  ...
  switch i32 %481, label %if.end9.i.i.i1614 [
...
if.then559:                                       ; preds = %land.lhs.true554
  ...
  br i1 %cmp574.not, label %_ZN11CStringBaseIwED2Ev.exit1497, label %if.then575
...
lpad561.loopexit.split-lp:                        ; preds = %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1575
  %lpad.loopexit.split-lp1679 = landingpad { ptr, i32 }
          cleanup
  br label %delete.notnull.i1499

if.then575:                                       ; preds = %if.then559
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %end.i1438) #19
  %call.i14391446 = invoke noundef i64 @_Z21ConvertStringToUInt64PKwPS0_(ptr noundef nonnull %arrayidx573, ptr noundef nonnull %end.i1438)
          to label %call.i1439.noexc unwind label %lpad561.loopexit

call.i1439.noexc:                                 ; preds = %if.then575
  %484 = load ptr, ptr %end.i1438, align 8, !tbaa !19
  %485 = load i32, ptr %484, align 4, !tbaa !50
  %cmp.not.i1440 = icmp eq i32 %485, 0
  %cmp1.i1441 = icmp ult i64 %call.i14391446, 4294967296
  %or.cond.not.i1442 = and i1 %cmp1.i1441, %cmp.not.i1440
  br i1 %or.cond.not.i1442, label %invoke.cont581.thread, label %if.end9.i.i.i1574

invoke.cont581.thread:                            ; preds = %call.i1439.noexc
  %conv.i1443 = trunc i64 %call.i14391446 to i32
  store i32 %conv.i1443, ptr %NumThreads, align 8, !tbaa !70
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %end.i1438) #19
  br label %_ZN11CStringBaseIwED2Ev.exit1497

if.end9.i.i.i1574:                                ; preds = %call.i1439.noexc
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %end.i1438) #19
  %exception.i.i1448 = call ptr @__cxa_allocate_exception(i64 16) #19
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %exception.i.i1448, i8 0, i64 16, i1 false)
  %call.i.i.i15731583 = invoke noalias noundef nonnull dereferenceable(23) ptr @_Znam(i64 noundef 23) #20
          to label %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1575 unwind label %lpad.i.i1450

_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1575:  ; preds = %if.end9.i.i.i1574
  %_capacity.i.i1571 = getelementptr inbounds %class.CStringBase.9, ptr %exception.i.i1448, i64 0, i32 2
  store ptr %call.i.i.i15731583, ptr %exception.i.i1448, align 8, !tbaa !14
  store i32 23, ptr %_capacity.i.i1571, align 4, !tbaa !16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(23) %call.i.i.i15731583, ptr noundef nonnull align 1 dereferenceable(23) @.str.41, i64 23, i1 false), !tbaa !17
  %_length.i.i1582 = getelementptr inbounds %class.CStringBase.9, ptr %exception.i.i1448, i64 0, i32 1
  store i32 22, ptr %_length.i.i1582, align 8, !tbaa !18
  invoke void @__cxa_throw(ptr nonnull %exception.i.i1448, ptr nonnull @_ZTI28CArchiveCommandLineException, ptr nonnull @_ZN11CStringBaseIcED2Ev) #21
          to label %.noexc1451 unwind label %lpad561.loopexit.split-lp

.noexc1451:                                       ; preds = %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1575
  unreachable

lpad.i.i1450:                                     ; preds = %if.end9.i.i.i1574
  %486 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_free_exception(ptr nonnull %exception.i.i1448) #19
  br label %delete.notnull.i1499
...
if.then598:                                       ; preds = %land.lhs.true554
  ...
  br i1 %cmp605.not, label %_ZN11CStringBaseIwED2Ev.exit1497, label %if.then606

if.then606:                                       ; preds = %if.then598
  %sub.i = add nsw i32 %468, -2
  %call.i.i32.i1601 = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znam(i64 noundef 16) #20
          to label %call.i.i32.i.noexc unwind label %lpad608

call.i.i32.i.noexc:                               ; preds = %if.then606
  store i32 0, ptr %call.i.i32.i1601, align 4, !tbaa !50, !noalias !110
  %add.i.i1589 = add nsw i32 %468, -1
  %cmp.i.i1590 = icmp eq i32 %add.i.i1589, 4
  br i1 %cmp.i.i1590, label %for.body.lr.ph.i1595, label %if.end.i.i1592

if.end.i.i1592:                                   ; preds = %call.i.i32.i.noexc
  %conv.i.i1591 = zext i32 %add.i.i1589 to i64
  %488 = shl nuw nsw i64 %conv.i.i1591, 2
  %call.i36.i = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %488) #20
          to label %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1593 unwind label %_ZN11CStringBaseIwED2Ev.exit.i1596, !noalias !110

_ZN11CStringBaseIwE11SetCapacityEi.exit.i1593:    ; preds = %if.end.i.i1592
  call void @_ZdaPv(ptr noundef nonnull %call.i.i32.i1601) #18, !noalias !110
...
for.body.lr.ph.i1595:                             ; preds = %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1593, %call.i.i32.i.noexc
  %ref.tmp607.sroa.0.1 = phi ptr [ %call.i.i32.i1601, %call.i.i32.i.noexc ], [ %call.i36.i, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1593 ]
  %489 = zext i32 %sub.i to i64
  %490 = shl nuw nsw i64 %489, 2
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %ref.tmp607.sroa.0.1, ptr nonnull align 4 %arrayidx604, i64 %490, i1 false), !tbaa !50, !noalias !110
  br label %invoke.cont609

_ZN11CStringBaseIwED2Ev.exit.i1596:               ; preds = %if.end.i.i1592
...
invoke.cont609:                                   ; preds = %for.body.lr.ph.i1595, %_ZN11CStringBaseIwE11SetCapacityEi.exit.i1593
  ...
  store i32 0, ptr %_length.i.i1457, align 8, !tbaa !48
  %492 = load ptr, ptr %Method, align 8, !tbaa !10
  store i32 0, ptr %492, align 4, !tbaa !50
  %493 = load i32, ptr %_capacity.i.i1460, align 4, !tbaa !52
  %cmp.i.i1461 = icmp eq i32 %add.i.i1589, %493
  br i1 %cmp.i.i1461, label %while.cond.i.i1478.preheader, label %if.end.i.i1466

if.end.i.i1466:                                   ; preds = %invoke.cont609
  %conv.i.i1463 = zext i32 %add.i.i1589 to i64
  %494 = shl nuw nsw i64 %conv.i.i1463, 2
  %call.i.i14641480 = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %494) #20
          to label %call.i.i1464.noexc unwind label %delete.notnull.i1486

call.i.i1464.noexc:                               ; preds = %if.end.i.i1466
  %cmp3.i.i1465 = icmp sgt i32 %493, 0
  br i1 %cmp3.i.i1465, label %delete.notnull.i.i1468, label %if.end9.i.i1471

delete.notnull.i.i1468:                           ; preds = %call.i.i1464.noexc
  call void @_ZdaPv(ptr noundef nonnull %492) #18
  %.pre.i1467 = load i32, ptr %_length.i.i1457, align 8, !tbaa !48
  %495 = sext i32 %.pre.i1467 to i64
  br label %if.end9.i.i1471

if.end9.i.i1471:                                  ; preds = %delete.notnull.i.i1468, %call.i.i1464.noexc
  %idxprom13.i.i1469 = phi i64 [ %495, %delete.notnull.i.i1468 ], [ 0, %call.i.i1464.noexc ]
  store ptr %call.i.i14641480, ptr %Method, align 8, !tbaa !10
  %arrayidx14.i.i1470 = getelementptr inbounds i32, ptr %call.i.i14641480, i64 %idxprom13.i.i1469
  store i32 0, ptr %arrayidx14.i.i1470, align 4, !tbaa !50
  store i32 %add.i.i1589, ptr %_capacity.i.i1460, align 4, !tbaa !52
  br label %while.cond.i.i1478.preheader

while.cond.i.i1478.preheader:                     ; preds = %if.end9.i.i1471, %invoke.cont609
  %dest.addr.0.i.i1474.ph = phi ptr [ %492, %invoke.cont609 ], [ %call.i.i14641480, %if.end9.i.i1471 ]
  br label %while.cond.i.i1478

while.cond.i.i1478:                               ; preds = %while.cond.i.i1478.preheader, %while.cond.i.i1478
  %src.addr.0.i.i1473 = phi ptr [ %incdec.ptr.i.i1475, %while.cond.i.i1478 ], [ %ref.tmp607.sroa.0.2, %while.cond.i.i1478.preheader ]
  %dest.addr.0.i.i1474 = phi ptr [ %incdec.ptr1.i.i1476, %while.cond.i.i1478 ], [ %dest.addr.0.i.i1474.ph, %while.cond.i.i1478.preheader ]
  %incdec.ptr.i.i1475 = getelementptr inbounds i32, ptr %src.addr.0.i.i1473, i64 1
  %496 = load i32, ptr %src.addr.0.i.i1473, align 4, !tbaa !50
  %incdec.ptr1.i.i1476 = getelementptr inbounds i32, ptr %dest.addr.0.i.i1474, i64 1
  store i32 %496, ptr %dest.addr.0.i.i1474, align 4, !tbaa !50
  %cmp.not.i.i1477 = icmp eq i32 %496, 0
  br i1 %cmp.not.i.i1477, label %_ZN11CStringBaseIwED2Ev.exit1484, label %while.cond.i.i1478, !llvm.loop !53

_ZN11CStringBaseIwED2Ev.exit1484:                 ; preds = %while.cond.i.i1478
  store i32 %sub.i, ptr %_length.i.i1457, align 8, !tbaa !48
...
delete.notnull.i1486:                             ; preds = %if.end.i.i1466
  %498 = landingpad { ptr, i32 }
          cleanup
  call void @_ZdaPv(ptr noundef nonnull %ref.tmp607.sroa.0.2) #18
  br label %delete.notnull.i1499

if.end9.i.i.i1614:                                ; preds = %land.lhs.true554, %if.end519
  %exception.i.i1488 = call ptr @__cxa_allocate_exception(i64 16) #19
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %exception.i.i1488, i8 0, i64 16, i1 false)
  %call.i.i.i16131623 = invoke noalias noundef nonnull dereferenceable(23) ptr @_Znam(i64 noundef 23) #20
          to label %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1615 unwind label %lpad.i.i1490

_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i1615:  ; preds = %if.end9.i.i.i1614
  store ptr %call.i.i.i16131623, ptr %exception.i.i1488, align 8, !tbaa !14
  br label %_ZN11CStringBaseIcE11SetCapacityEi.exit.i.i.invoke

lpad.i.i1490:                                     ; preds = %if.end9.i.i.i1614
  %499 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_free_exception(ptr nonnull %exception.i.i1488) #19
  br label %delete.notnull.i1499

_ZN11CStringBaseIwED2Ev.exit1497:                 ; preds = %invoke.cont581.thread, %if.then598, %_ZN11CStringBaseIwED2Ev.exit1484, %if.then559, %if.end545
  ...
  %_size.i1386 = getelementptr inbounds %"struct.NCommandLineParser::CSwitchResult", ptr %call502, i64 0, i32 3, i32 0, i32 0, i32 2
  %500 = load i32, ptr %_size.i1386, align 4, !tbaa !49
  %501 = sext i32 %500 to i64
  %cmp505 = icmp slt i64 %indvars.iv.next, %501
  br i1 %cmp505, label %for.body507, label %if.end637, !llvm.loop !113

ehcleanup622:                                     ; preds = %lpad512.loopexit, %lpad512.loopexit.split-lp, %lpad.i.i1412
  %.pn763 = phi { ptr, i32 } [ %474, %lpad.i.i1412 ], [ %lpad.loopexit1675, %lpad512.loopexit ], [ %lpad.loopexit.split-lp1676, %lpad512.loopexit.split-lp ]
  %isnull.i1498 = icmp eq ptr %postString.sroa.0.1, null
  br i1 %isnull.i1498, label %common.resume, label %delete.notnull.i1499

delete.notnull.i1499:                             ; preds = %lpad.i.i1490, %lpad.i.i1433, %lpad.i.i1427, %lpad.i.i1450, %lpad534.loopexit.split-lp, %lpad534.loopexit, %lpad561.loopexit.split-lp, %lpad561.loopexit, %delete.notnull.i1486, %lpad608, %_ZN11CStringBaseIwED2Ev.exit.i1596, %ehcleanup622
  %.pn7631669 = phi { ptr, i32 } [ %.pn763, %ehcleanup622 ], [ %497, %lpad608 ], [ %491, %_ZN11CStringBaseIwED2Ev.exit.i1596 ], [ %498, %delete.notnull.i1486 ], [ %lpad.loopexit.split-lp1679, %lpad561.loopexit.split-lp ], [ %lpad.loopexit1678, %lpad561.loopexit ], [ %lpad.loopexit.split-lp1682, %lpad534.loopexit.split-lp ], [ %lpad.loopexit1681, %lpad534.loopexit ], [ %486, %lpad.i.i1450 ], [ %480, %lpad.i.i1433 ], [ %479, %lpad.i.i1427 ], [ %499, %lpad.i.i1490 ]
  call void @_ZdaPv(ptr noundef nonnull %postString.sroa.0.1) #18
  br label %common.resume

if.else633:                                       ; preds = %if.else484
  %exception.i.i1501 = call ptr @__cxa_allocate_exception(i64 16) #19
  invoke void @_ZN28CArchiveCommandLineExceptionC2EPKc(ptr noundef nonnull align 8 dereferenceable(16) %exception.i.i1501, ptr noundef nonnull @.str.41)
          to label %invoke.cont.i.i1502 unwind label %lpad.i.i1503

invoke.cont.i.i1502:                              ; preds = %if.else633
  call void @__cxa_throw(ptr nonnull %exception.i.i1501, ptr nonnull @_ZTI28CArchiveCommandLineException, ptr nonnull @_ZN11CStringBaseIcED2Ev) #21
  unreachable

lpad.i.i1503:                                     ; preds = %if.else633
  %502 = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_free_exception(ptr %exception.i.i1501) #19
  br label %common.resume

if.end637:                                        ; preds = %_ZN11CStringBaseIwED2Ev.exit1497, %if.end498, %_Z12MyStringCopyIwEPT_S1_PKS0_.exit.i1375, %if.then477, %if.else484, %if.end474, %_ZN9NWildcard7CCensorD2Ev.exit
