; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/jquant2.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/jquant2.c"
...
entry:
  ...
  %call = tail call ptr %1(ptr noundef %cinfo, i32 noundef 1, i64 noundef 88) #10
...
if.then:                                          ; preds = %entry
  ...
  tail call void %4(ptr noundef nonnull %cinfo) #10
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %5 = load ptr, ptr %mem, align 8, !tbaa !5
  %6 = load ptr, ptr %5, align 8, !tbaa !13
  %call6 = tail call ptr %6(ptr noundef nonnull %cinfo, i32 noundef 1, i64 noundef 256) #10
...
for.body:                                         ; preds = %if.end, %for.body
  ...
  %call9 = tail call ptr %8(ptr noundef nonnull %cinfo, i32 noundef 1, i64 noundef 4096) #10
...
if.end30.sink.split:                              ; preds = %if.end20, %if.then11
  ...
  tail call void %15(ptr noundef nonnull %cinfo) #10
  br label %if.end30
...
if.end30:                                         ; preds = %if.end30.sink.split, %if.end20
  ...
  %call32 = tail call ptr %17(ptr noundef nonnull %cinfo, i32 noundef 1, i32 noundef %11, i32 noundef 3) #10
...
if.then42:                                        ; preds = %if.end35
  ...
  %call45 = tail call ptr %20(ptr noundef nonnull %cinfo, i32 noundef 1, i64 noundef %mul) #10
  ...
  %call.i = tail call ptr %24(ptr noundef nonnull %cinfo, i32 noundef 1, i64 noundef 2044) #10
...
if.end31.sink.split:                              ; preds = %if.end21, %if.end14
  ...
  tail call void %8(ptr noundef nonnull %cinfo) #10
  br label %if.end31
...
if.then37:                                        ; preds = %if.then34
  ...
  %call = tail call ptr %13(ptr noundef nonnull %cinfo, i32 noundef 1, i64 noundef %mul) #10
  store ptr %call, ptr %fserrors, align 8, !tbaa !21
  br label %if.end39

if.end39:                                         ; preds = %if.then37, %if.then34
  %14 = phi ptr [ %call, %if.then37 ], [ %11, %if.then34 ]
  tail call void @jzero_far(ptr noundef %14, i64 noundef %mul) #10
...
if.then43:                                        ; preds = %if.end39
  ...
  %call.i = tail call ptr %18(ptr noundef nonnull %cinfo, i32 noundef 1, i64 noundef 2044) #10
  %add.ptr.i = getelementptr inbounds i32, ptr %call.i, i64 255
...
entry:
  ...
  %call.i = tail call ptr %4(ptr noundef %cinfo, i32 noundef 1, i64 noundef %mul.i) #10
...
select_colors.exit:                               ; preds = %compute_color.exit.i, %median_cut.exit.i
  ...
  tail call void %59(ptr noundef nonnull %cinfo, i32 noundef 1) #10
  %needs_zeroed = getelementptr inbounds %struct.my_cquantizer, ptr %0, i64 0, i32 4
  store i32 1, ptr %needs_zeroed, align 8, !tbaa !33
  ret void
}
...
define internal fastcc void @update_box(ptr %cinfo.608.val.48.val, ptr nocapture noundef %boxp) unnamed_addr #7 {
entry:
...
entry:
  ...
  %histogram2 = getelementptr inbounds %struct.my_cquantizer, ptr %0, i64 0, i32 3
  %1 = load ptr, ptr %histogram2, align 8, !tbaa !28
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %colorlist) #10
  call void @llvm.lifetime.start.p0(i64 128, ptr nonnull %bestcolor) #10
  %2 = shl i32 %c0, 3
  %shl = and i32 %2, -32
  %add = or i32 %shl, 4
  %3 = shl i32 %c1, 2
  ...
  call void @llvm.lifetime.start.p0(i64 2048, ptr nonnull %mindist.i) #10
  %add.i = or i32 %2, 28
...
find_nearby_colors.exit:                          ; preds = %find_nearby_colors.exit.loopexit.unr-lcssa, %if.then157.i.epil, %for.body152.i.epil, %entry
  ...
  call void @llvm.lifetime.end.p0(i64 2048, ptr nonnull %mindist.i) #10
  call void @llvm.lifetime.start.p0(i64 1024, ptr nonnull %bestdist.i) #10
...
find_best_colors.exit:                            ; preds = %for.inc68.i, %find_nearby_colors.exit
  call void @llvm.lifetime.end.p0(i64 1024, ptr nonnull %bestdist.i) #10
  %shl11 = and i32 %c0, -4
  %shl12 = and i32 %c1, -8
  %shl13 = and i32 %c2, -4
...
for.end35:                                        ; preds = %for.cond15.preheader
  call void @llvm.lifetime.end.p0(i64 128, ptr nonnull %bestcolor) #10
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %colorlist) #10
  ret void
}
