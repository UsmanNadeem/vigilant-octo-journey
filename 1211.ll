; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/UnitTests/Float/classify.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/UnitTests/Float/classify.c"
...
@.str.1 = private unnamed_addr constant [96 x i8] c"/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/UnitTests/Float/classify-f32.h\00", align 1
...
@.str.17 = private unnamed_addr constant [96 x i8] c"/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/UnitTests/Float/classify-f64.h\00", align 1
...
@.str.20 = private unnamed_addr constant [100 x i8] c"/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/UnitTests/Float/classify-ldouble.h\00", align 1
...
do.body181.1:                                     ; preds = %for.cond
  %2 = tail call float @llvm.fabs.f32(float %.cast607.1) #5
...
do.body194.1:                                     ; preds = %do.body187.1
  %isnormal.1 = fcmp uge float %2, 0x3810000000000000
  %and.1 = fcmp olt float %2, 0x7FF0000000000000
  %and195.1 = and i1 %and.1, %isnormal.1
...
do.body181.2:                                     ; preds = %for.cond.1
  %4 = tail call float @llvm.fabs.f32(float %.cast607.2) #5
...
do.body194.2:                                     ; preds = %do.body187.2
  %isnormal.2 = fcmp uge float %4, 0x3810000000000000
  %and.2 = fcmp olt float %4, 0x7FF0000000000000
  %and195.2 = and i1 %and.2, %isnormal.2
...
do.body181.3:                                     ; preds = %for.cond.2
  %6 = tail call float @llvm.fabs.f32(float %.cast607.3) #5
...
do.body194.3:                                     ; preds = %do.body187.3
  %isnormal.3 = fcmp uge float %6, 0x3810000000000000
  %and.3 = fcmp olt float %6, 0x7FF0000000000000
  %and195.3 = and i1 %and.3, %isnormal.3
...
do.body181.4:                                     ; preds = %for.cond.3
  %8 = tail call float @llvm.fabs.f32(float %.cast607.4) #5
...
do.body194.4:                                     ; preds = %do.body187.4
  %isnormal.4 = fcmp uge float %8, 0x3810000000000000
  %and.4 = fcmp olt float %8, 0x7FF0000000000000
  %and195.4 = and i1 %and.4, %isnormal.4
...
do.body181.5:                                     ; preds = %for.cond.4
  %10 = tail call float @llvm.fabs.f32(float %.cast607.5) #5
...
do.body194.5:                                     ; preds = %do.body187.5
  %isnormal.5 = fcmp uge float %10, 0x3810000000000000
  %and.5 = fcmp olt float %10, 0x7FF0000000000000
  %and195.5 = and i1 %and.5, %isnormal.5
...
do.body181.6:                                     ; preds = %for.cond.5
  %12 = tail call float @llvm.fabs.f32(float %.cast607.6) #5
...
do.body194.6:                                     ; preds = %do.body187.6
  %isnormal.6 = fcmp uge float %12, 0x3810000000000000
  %and.6 = fcmp olt float %12, 0x7FF0000000000000
  %and195.6 = and i1 %and.6, %isnormal.6
...
do.body181.7:                                     ; preds = %for.cond.6
  %14 = tail call float @llvm.fabs.f32(float %.cast607.7) #5
...
do.body194.7:                                     ; preds = %do.body187.7
  %isnormal.7 = fcmp uge float %14, 0x3810000000000000
  %and.7 = fcmp olt float %14, 0x7FF0000000000000
  %and195.7 = and i1 %and.7, %isnormal.7
...
do.body181:                                       ; preds = %entry
  %16 = tail call float @llvm.fabs.f32(float %.cast607) #5
...
do.body194:                                       ; preds = %do.body187
  %isnormal = fcmp uge float %16, 0x3810000000000000
  %and = fcmp olt float %16, 0x7FF0000000000000
  %and195 = and i1 %and, %isnormal
...
do.body231.1:                                     ; preds = %for.cond213
  %18 = tail call float @llvm.fabs.f32(float %.cast606.1) #5
...
do.body245.1:                                     ; preds = %do.body238.1
  %isnormal248.1 = fcmp uge float %18, 0x3810000000000000
  %and249.1 = fcmp olt float %18, 0x7FF0000000000000
  %and250.1 = and i1 %and249.1, %isnormal248.1
...
do.body231.2:                                     ; preds = %for.cond213.1
  %20 = tail call float @llvm.fabs.f32(float %.cast606.2) #5
...
do.body245.2:                                     ; preds = %do.body238.2
  %isnormal248.2 = fcmp uge float %20, 0x3810000000000000
  %and249.2 = fcmp olt float %20, 0x7FF0000000000000
  %and250.2 = and i1 %and249.2, %isnormal248.2
...
do.body231.3:                                     ; preds = %for.cond213.2
  %22 = tail call float @llvm.fabs.f32(float %.cast606.3) #5
...
do.body245.3:                                     ; preds = %do.body238.3
  %isnormal248.3 = fcmp uge float %22, 0x3810000000000000
  %and249.3 = fcmp olt float %22, 0x7FF0000000000000
  %and250.3 = and i1 %and249.3, %isnormal248.3
...
do.body231.4:                                     ; preds = %for.cond213.3
  %24 = tail call float @llvm.fabs.f32(float %.cast606.4) #5
...
do.body245.4:                                     ; preds = %do.body238.4
  %isnormal248.4 = fcmp uge float %24, 0x3810000000000000
  %and249.4 = fcmp olt float %24, 0x7FF0000000000000
  %and250.4 = and i1 %and249.4, %isnormal248.4
...
do.body231.5:                                     ; preds = %for.cond213.4
  %26 = tail call float @llvm.fabs.f32(float %.cast606.5) #5
...
do.body245.5:                                     ; preds = %do.body238.5
  %isnormal248.5 = fcmp uge float %26, 0x3810000000000000
  %and249.5 = fcmp olt float %26, 0x7FF0000000000000
  %and250.5 = and i1 %and249.5, %isnormal248.5
...
do.body231:                                       ; preds = %for.cond.7
  %28 = tail call float @llvm.fabs.f32(float %.cast606) #5
...
do.body245:                                       ; preds = %do.body238
  %isnormal248 = fcmp uge float %28, 0x3810000000000000
  %and249 = fcmp olt float %28, 0x7FF0000000000000
  %and250 = and i1 %and249, %isnormal248
...
do.body295.1:                                     ; preds = %for.cond277
  %30 = tail call float @llvm.fabs.f32(float %.cast605.1) #5
  %cmpinf296.1 = fcmp oeq float %30, 0x7FF0000000000000
  br i1 %cmpinf296.1, label %do.body320.1, label %if.then297

do.body320.1:                                     ; preds = %do.body295.1
...
do.body295:                                       ; preds = %for.cond213.5
  %32 = tail call float @llvm.fabs.f32(float %.cast605) #5
  %cmpinf296 = fcmp oeq float %32, 0x7FF0000000000000
  br i1 %cmpinf296, label %do.body320, label %if.then297
...
do.body359.1:                                     ; preds = %for.cond341
  %34 = tail call float @llvm.fabs.f32(float %.cast604.1) #5
...
do.body373.1:                                     ; preds = %do.body366.1
  %isnormal376.1 = fcmp uge float %34, 0x3810000000000000
  %and377.1 = fcmp olt float %34, 0x7FF0000000000000
  %and378.1 = and i1 %and377.1, %isnormal376.1
...
do.body359:                                       ; preds = %for.cond277.1
  %36 = tail call float @llvm.fabs.f32(float %.cast604) #5
...
do.body373:                                       ; preds = %do.body366
  %isnormal376 = fcmp uge float %36, 0x3810000000000000
  %and377 = fcmp olt float %36, 0x7FF0000000000000
  %and378 = and i1 %and377, %isnormal376
...
do.body423.1:                                     ; preds = %for.cond405
  %38 = tail call float @llvm.fabs.f32(float %.cast603.1) #5
...
do.body423.2:                                     ; preds = %for.cond405.1
  %40 = tail call float @llvm.fabs.f32(float %.cast603.2) #5
...
do.body423.3:                                     ; preds = %for.cond405.2
  %42 = tail call float @llvm.fabs.f32(float %.cast603.3) #5
...
do.body423:                                       ; preds = %for.cond341.1
  %43 = tail call float @llvm.fabs.f32(float %.cast603) #5
...
do.body487:                                       ; preds = %for.body474
  %45 = tail call float @llvm.fabs.f32(float %.cast) #5
...
do.body501:                                       ; preds = %do.body494
  %isnormal504 = fcmp uge float %45, 0x3810000000000000
  %and505 = fcmp olt float %45, 0x7FF0000000000000
  %and506 = and i1 %and505, %isnormal504
...
do.body156.1:                                     ; preds = %for.cond
  %2 = tail call double @llvm.fabs.f64(double %.cast582.1) #5
...
do.body169.1:                                     ; preds = %do.body162.1
  %isnormal.1 = fcmp uge double %2, 0x10000000000000
  %and.1 = fcmp olt double %2, 0x7FF0000000000000
  %and170.1 = and i1 %and.1, %isnormal.1
...
do.body156.2:                                     ; preds = %for.cond.1
  %4 = tail call double @llvm.fabs.f64(double %.cast582.2) #5
...
do.body169.2:                                     ; preds = %do.body162.2
  %isnormal.2 = fcmp uge double %4, 0x10000000000000
  %and.2 = fcmp olt double %4, 0x7FF0000000000000
  %and170.2 = and i1 %and.2, %isnormal.2
...
do.body156.3:                                     ; preds = %for.cond.2
  %6 = tail call double @llvm.fabs.f64(double %.cast582.3) #5
...
do.body169.3:                                     ; preds = %do.body162.3
  %isnormal.3 = fcmp uge double %6, 0x10000000000000
  %and.3 = fcmp olt double %6, 0x7FF0000000000000
  %and170.3 = and i1 %and.3, %isnormal.3
...
do.body156.4:                                     ; preds = %for.cond.3
  %8 = tail call double @llvm.fabs.f64(double %.cast582.4) #5
...
do.body169.4:                                     ; preds = %do.body162.4
  %isnormal.4 = fcmp uge double %8, 0x10000000000000
  %and.4 = fcmp olt double %8, 0x7FF0000000000000
  %and170.4 = and i1 %and.4, %isnormal.4
...
do.body156.5:                                     ; preds = %for.cond.4
  %10 = tail call double @llvm.fabs.f64(double %.cast582.5) #5
...
do.body169.5:                                     ; preds = %do.body162.5
  %isnormal.5 = fcmp uge double %10, 0x10000000000000
  %and.5 = fcmp olt double %10, 0x7FF0000000000000
  %and170.5 = and i1 %and.5, %isnormal.5
...
do.body156.6:                                     ; preds = %for.cond.5
  %12 = tail call double @llvm.fabs.f64(double %.cast582.6) #5
...
do.body169.6:                                     ; preds = %do.body162.6
  %isnormal.6 = fcmp uge double %12, 0x10000000000000
  %and.6 = fcmp olt double %12, 0x7FF0000000000000
  %and170.6 = and i1 %and.6, %isnormal.6
...
do.body156.7:                                     ; preds = %for.cond.6
  %14 = tail call double @llvm.fabs.f64(double %.cast582.7) #5
...
do.body169.7:                                     ; preds = %do.body162.7
  %isnormal.7 = fcmp uge double %14, 0x10000000000000
  %and.7 = fcmp olt double %14, 0x7FF0000000000000
  %and170.7 = and i1 %and.7, %isnormal.7
...
do.body156:                                       ; preds = %entry
  %16 = tail call double @llvm.fabs.f64(double %.cast582) #5
...
do.body169:                                       ; preds = %do.body162
  %isnormal = fcmp uge double %16, 0x10000000000000
  %and = fcmp olt double %16, 0x7FF0000000000000
  %and170 = and i1 %and, %isnormal
...
do.body206.1:                                     ; preds = %for.cond188
  %18 = tail call double @llvm.fabs.f64(double %.cast581.1) #5
...
do.body220.1:                                     ; preds = %do.body213.1
  %isnormal223.1 = fcmp uge double %18, 0x10000000000000
  %and224.1 = fcmp olt double %18, 0x7FF0000000000000
  %and225.1 = and i1 %and224.1, %isnormal223.1
...
do.body206.2:                                     ; preds = %for.cond188.1
  %20 = tail call double @llvm.fabs.f64(double %.cast581.2) #5
...
do.body220.2:                                     ; preds = %do.body213.2
  %isnormal223.2 = fcmp uge double %20, 0x10000000000000
  %and224.2 = fcmp olt double %20, 0x7FF0000000000000
  %and225.2 = and i1 %and224.2, %isnormal223.2
...
do.body206.3:                                     ; preds = %for.cond188.2
  %22 = tail call double @llvm.fabs.f64(double %.cast581.3) #5
...
do.body220.3:                                     ; preds = %do.body213.3
  %isnormal223.3 = fcmp uge double %22, 0x10000000000000
  %and224.3 = fcmp olt double %22, 0x7FF0000000000000
  %and225.3 = and i1 %and224.3, %isnormal223.3
...
do.body206.4:                                     ; preds = %for.cond188.3
  %24 = tail call double @llvm.fabs.f64(double %.cast581.4) #5
...
do.body220.4:                                     ; preds = %do.body213.4
  %isnormal223.4 = fcmp uge double %24, 0x10000000000000
  %and224.4 = fcmp olt double %24, 0x7FF0000000000000
  %and225.4 = and i1 %and224.4, %isnormal223.4
...
do.body206.5:                                     ; preds = %for.cond188.4
  %26 = tail call double @llvm.fabs.f64(double %.cast581.5) #5
...
do.body220.5:                                     ; preds = %do.body213.5
  %isnormal223.5 = fcmp uge double %26, 0x10000000000000
  %and224.5 = fcmp olt double %26, 0x7FF0000000000000
  %and225.5 = and i1 %and224.5, %isnormal223.5
...
do.body206:                                       ; preds = %for.cond.7
  %28 = tail call double @llvm.fabs.f64(double %.cast581) #5
...
do.body220:                                       ; preds = %do.body213
  %isnormal223 = fcmp uge double %28, 0x10000000000000
  %and224 = fcmp olt double %28, 0x7FF0000000000000
  %and225 = and i1 %and224, %isnormal223
...
do.body270.1:                                     ; preds = %for.cond252
  %30 = tail call double @llvm.fabs.f64(double %.cast580.1) #5
  %cmpinf271.1 = fcmp oeq double %30, 0x7FF0000000000000
  br i1 %cmpinf271.1, label %do.body295.1, label %if.then272

do.body295.1:                                     ; preds = %do.body270.1
...
do.body270:                                       ; preds = %for.cond188.5
  %32 = tail call double @llvm.fabs.f64(double %.cast580) #5
  %cmpinf271 = fcmp oeq double %32, 0x7FF0000000000000
  br i1 %cmpinf271, label %do.body295, label %if.then272
...
do.body334.1:                                     ; preds = %for.cond316
  %34 = tail call double @llvm.fabs.f64(double %.cast579.1) #5
...
do.body348.1:                                     ; preds = %do.body341.1
  %isnormal351.1 = fcmp uge double %34, 0x10000000000000
  %and352.1 = fcmp olt double %34, 0x7FF0000000000000
  %and353.1 = and i1 %and352.1, %isnormal351.1
...
do.body334:                                       ; preds = %for.cond252.1
  %36 = tail call double @llvm.fabs.f64(double %.cast579) #5
...
do.body348:                                       ; preds = %do.body341
  %isnormal351 = fcmp uge double %36, 0x10000000000000
  %and352 = fcmp olt double %36, 0x7FF0000000000000
  %and353 = and i1 %and352, %isnormal351
...
do.body398.1:                                     ; preds = %for.cond380
  %38 = tail call double @llvm.fabs.f64(double %.cast578.1) #5
...
do.body398.2:                                     ; preds = %for.cond380.1
  %40 = tail call double @llvm.fabs.f64(double %.cast578.2) #5
...
do.body398.3:                                     ; preds = %for.cond380.2
  %42 = tail call double @llvm.fabs.f64(double %.cast578.3) #5
...
do.body398:                                       ; preds = %for.cond316.1
  %43 = tail call double @llvm.fabs.f64(double %.cast578) #5
...
do.body462:                                       ; preds = %for.body449
  %45 = tail call double @llvm.fabs.f64(double %.cast) #5
...
do.body476:                                       ; preds = %do.body469
  %isnormal479 = fcmp uge double %45, 0x10000000000000
  %and480 = fcmp olt double %45, 0x7FF0000000000000
  %and481 = and i1 %and480, %isnormal479
...
do.body3.1:                                       ; preds = %for.cond
  %2 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %1) #5
...
do.body16.1:                                      ; preds = %do.body9.1
  %isnormal.1 = fcmp uge x86_fp80 %2, 0xK00018000000000000000
  %and.1 = fcmp olt x86_fp80 %2, 0xK7FFF8000000000000000
  %and17.1 = and i1 %and.1, %isnormal.1
...
do.body3.2:                                       ; preds = %for.cond.1
  %4 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %3) #5
...
do.body16.2:                                      ; preds = %do.body9.2
  %isnormal.2 = fcmp uge x86_fp80 %4, 0xK00018000000000000000
  %and.2 = fcmp olt x86_fp80 %4, 0xK7FFF8000000000000000
  %and17.2 = and i1 %and.2, %isnormal.2
...
do.body3.3:                                       ; preds = %for.cond.2
  %6 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %5) #5
...
do.body16.3:                                      ; preds = %do.body9.3
  %isnormal.3 = fcmp uge x86_fp80 %6, 0xK00018000000000000000
  %and.3 = fcmp olt x86_fp80 %6, 0xK7FFF8000000000000000
  %and17.3 = and i1 %and.3, %isnormal.3
...
do.body3:                                         ; preds = %entry
  %8 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %0) #5
...
do.body16:                                        ; preds = %do.body9
  %isnormal = fcmp uge x86_fp80 %8, 0xK00018000000000000000
  %and = fcmp olt x86_fp80 %8, 0xK7FFF8000000000000000
  %and17 = and i1 %and, %isnormal
...
do.body51.1:                                      ; preds = %for.cond35
  %10 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %9) #5
...
do.body65.1:                                      ; preds = %do.body58.1
  %isnormal68.1 = fcmp uge x86_fp80 %10, 0xK00018000000000000000
  %and69.1 = fcmp olt x86_fp80 %10, 0xK7FFF8000000000000000
  %and70.1 = and i1 %and69.1, %isnormal68.1
...
do.body51.2:                                      ; preds = %for.cond35.1
  %12 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %11) #5
...
do.body65.2:                                      ; preds = %do.body58.2
  %isnormal68.2 = fcmp uge x86_fp80 %12, 0xK00018000000000000000
  %and69.2 = fcmp olt x86_fp80 %12, 0xK7FFF8000000000000000
  %and70.2 = and i1 %and69.2, %isnormal68.2
...
do.body51.3:                                      ; preds = %for.cond35.2
  %14 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %13) #5
...
do.body65.3:                                      ; preds = %do.body58.3
  %isnormal68.3 = fcmp uge x86_fp80 %14, 0xK00018000000000000000
  %and69.3 = fcmp olt x86_fp80 %14, 0xK7FFF8000000000000000
  %and70.3 = and i1 %and69.3, %isnormal68.3
...
do.body51:                                        ; preds = %for.cond.3
  %16 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %7) #5
...
do.body65:                                        ; preds = %do.body58
  %isnormal68 = fcmp uge x86_fp80 %16, 0xK00018000000000000000
  %and69 = fcmp olt x86_fp80 %16, 0xK7FFF8000000000000000
  %and70 = and i1 %and69, %isnormal68
...
do.body113.1:                                     ; preds = %for.cond97
  %18 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %17) #5
  %cmpinf114.1 = fcmp oeq x86_fp80 %18, 0xK7FFF8000000000000000
  br i1 %cmpinf114.1, label %do.body138.1, label %if.then115

do.body138.1:                                     ; preds = %do.body113.1
...
do.body113:                                       ; preds = %for.cond35.3
  %20 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %15) #5
  %cmpinf114 = fcmp oeq x86_fp80 %20, 0xK7FFF8000000000000000
  br i1 %cmpinf114, label %do.body138, label %if.then115
...
do.body175.1:                                     ; preds = %for.cond159
  %22 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %21) #5
...
do.body189.1:                                     ; preds = %do.body182.1
  %isnormal192.1 = fcmp uge x86_fp80 %22, 0xK00018000000000000000
  %and193.1 = fcmp olt x86_fp80 %22, 0xK7FFF8000000000000000
  %and194.1 = and i1 %and193.1, %isnormal192.1
...
do.body175:                                       ; preds = %for.cond97.1
  %24 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %19) #5
...
do.body189:                                       ; preds = %do.body182
  %isnormal192 = fcmp uge x86_fp80 %24, 0xK00018000000000000000
  %and193 = fcmp olt x86_fp80 %24, 0xK7FFF8000000000000000
  %and194 = and i1 %and193, %isnormal192
...
do.body237.1:                                     ; preds = %for.cond221
  %26 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %25) #5
...
do.body237:                                       ; preds = %for.cond159.1
  %28 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %23) #5
...
do.body299.1:                                     ; preds = %for.cond283
  %30 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %29) #5
...
do.body313.1:                                     ; preds = %do.body306.1
  %isnormal316.1 = fcmp uge x86_fp80 %30, 0xK00018000000000000000
  %and317.1 = fcmp olt x86_fp80 %30, 0xK7FFF8000000000000000
  %and318.1 = and i1 %and317.1, %isnormal316.1
...
do.body299.2:                                     ; preds = %for.cond283.1
  %32 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %31) #5
...
do.body313.2:                                     ; preds = %do.body306.2
  %isnormal316.2 = fcmp uge x86_fp80 %32, 0xK00018000000000000000
  %and317.2 = fcmp olt x86_fp80 %32, 0xK7FFF8000000000000000
  %and318.2 = and i1 %and317.2, %isnormal316.2
...
do.body299.3:                                     ; preds = %for.cond283.2
  %34 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %33) #5
...
do.body313.3:                                     ; preds = %do.body306.3
  %isnormal316.3 = fcmp uge x86_fp80 %34, 0xK00018000000000000000
  %and317.3 = fcmp olt x86_fp80 %34, 0xK7FFF8000000000000000
  %and318.3 = and i1 %and317.3, %isnormal316.3
...
do.body299.4:                                     ; preds = %for.cond283.3
  %36 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %35) #5
...
do.body313.4:                                     ; preds = %do.body306.4
  %isnormal316.4 = fcmp uge x86_fp80 %36, 0xK00018000000000000000
  %and317.4 = fcmp olt x86_fp80 %36, 0xK7FFF8000000000000000
  %and318.4 = and i1 %and317.4, %isnormal316.4
...
do.body299.5:                                     ; preds = %for.cond283.4
  %38 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %37) #5
...
do.body313.5:                                     ; preds = %do.body306.5
  %isnormal316.5 = fcmp uge x86_fp80 %38, 0xK00018000000000000000
  %and317.5 = fcmp olt x86_fp80 %38, 0xK7FFF8000000000000000
  %and318.5 = and i1 %and317.5, %isnormal316.5
...
do.body299:                                       ; preds = %for.cond221.1
  %39 = tail call x86_fp80 @llvm.fabs.f80(x86_fp80 %27) #5
...
do.body313:                                       ; preds = %do.body306
  %isnormal316 = fcmp uge x86_fp80 %39, 0xK00018000000000000000
  %and317 = fcmp olt x86_fp80 %39, 0xK7FFF8000000000000000
  %and318 = and i1 %and317, %isnormal316
