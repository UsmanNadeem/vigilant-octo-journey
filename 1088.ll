; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tgood.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/office-ispell/tgood.c"
...
entry:
  ...
  %cmp5 = icmp sgt i32 %ind.8.val, 0
  br i1 %cmp5, label %for.body.lr.ph, label %cleanup

for.body.lr.ph:                                   ; preds = %entry
  %and3 = and i32 %optflags, 2
  %cmp4 = icmp eq i32 %and3, 0
  %tobool266.not = icmp eq i32 %ignoreflagbits, 0
  %sub.ptr.rhs.cast = ptrtoint ptr %tword2 to i64
  %tobool336.not = icmp eq i32 %allhits, 0
  %or = or i32 %sfxopts, 1
  br label %for.body

for.body:                                         ; preds = %for.body.lr.ph, %for.inc355
  %flent.07 = phi ptr [ %ind.0.val, %for.body.lr.ph ], [ %incdec.ptr356, %for.inc355 ]
  %entcount.06 = phi i32 [ %ind.8.val, %for.body.lr.ph ], [ %dec, %for.inc355 ]
  %flagflags = getelementptr inbounds %struct.flagent, ptr %flent.07, i64 0, i32 6
  %0 = load i16, ptr %flagflags, align 8, !tbaa !14
  %1 = and i16 %0, 2
  %cmp1.not = icmp ne i16 %1, 0
  %or.cond = and i1 %cmp4, %cmp1.not
  br i1 %or.cond, label %for.inc355, label %if.end
...
land.lhs.true8:                                   ; preds = %if.end
  %conv10428 = zext i16 %0 to i32
  %xor = xor i32 %conv10428, %optflags
  %and11 = and i32 %xor, 2
  %cmp12.not = icmp eq i32 %and11, 0
  br i1 %cmp12.not, label %if.end15, label %for.inc355

if.end15:                                         ; preds = %land.lhs.true8, %if.end
  %affl = getelementptr inbounds %struct.flagent, ptr %flent.07, i64 0, i32 4
  %3 = load i16, ptr %affl, align 4, !tbaa !18
  %conv16 = sext i16 %3 to i32
  %sub = sub nsw i32 %len, %conv16
  %cmp17 = icmp sgt i32 %sub, 0
  br i1 %cmp17, label %land.lhs.true19, label %for.inc355

land.lhs.true19:                                  ; preds = %if.end15
  %cmp22 = icmp eq i16 %3, 0
  br i1 %cmp22, label %land.lhs.true216, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %land.lhs.true19
  %affix208 = getelementptr inbounds %struct.flagent, ptr %flent.07, i64 0, i32 1
  %4 = load ptr, ptr %affix208, align 8, !tbaa !19
  %conv210 = sext i16 %3 to i64
  %call211 = call i32 @strncmp(ptr noundef %4, ptr noundef %ucword, i64 noundef %conv210) #7
  %cmp214 = icmp eq i32 %call211, 0
  br i1 %cmp214, label %land.lhs.true216, label %for.inc355

land.lhs.true216:                                 ; preds = %lor.lhs.false, %land.lhs.true19
  %stripl = getelementptr inbounds %struct.flagent, ptr %flent.07, i64 0, i32 3
  %5 = load i16, ptr %stripl, align 2, !tbaa !20
  %conv217 = sext i16 %5 to i32
  %add = add nsw i32 %sub, %conv217
  %numconds = getelementptr inbounds %struct.flagent, ptr %flent.07, i64 0, i32 5
  %6 = load i16, ptr %numconds, align 2, !tbaa !21
  %conv218 = sext i16 %6 to i32
  %cmp219.not = icmp slt i32 %add, %conv218
  br i1 %cmp219.not, label %for.inc355, label %if.then221

if.then221:                                       ; preds = %land.lhs.true216
  %tobool.not = icmp eq i16 %5, 0
  br i1 %tobool.not, label %if.end225, label %if.then223

if.then223:                                       ; preds = %if.then221
  %7 = load ptr, ptr %flent.07, align 8, !tbaa !22
  %call224 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %tword, ptr noundef nonnull dereferenceable(1) %7) #6
  br label %if.end225

if.end225:                                        ; preds = %if.then223, %if.then221
  %idx.ext = sext i16 %5 to i64
  %add.ptr229 = getelementptr inbounds i8, ptr %tword, i64 %idx.ext
  %idx.ext232 = sext i16 %3 to i64
  %add.ptr233 = getelementptr inbounds i8, ptr %ucword, i64 %idx.ext232
  %call234 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %add.ptr229, ptr noundef nonnull dereferenceable(1) %add.ptr233) #6
  %cmp2391 = icmp sgt i16 %6, 0
  br i1 %cmp2391, label %for.body241, label %if.then253

for.body241:                                      ; preds = %if.end225, %for.inc
  %cond.03 = phi i32 [ %inc, %for.inc ], [ 0, %if.end225 ]
  %cp.02 = phi ptr [ %incdec.ptr, %for.inc ], [ %tword, %if.end225 ]
  %8 = load i8, ptr %cp.02, align 1, !tbaa !5
  %idxprom = zext i8 %8 to i64
  %arrayidx242 = getelementptr inbounds %struct.flagent, ptr %flent.07, i64 0, i32 7, i64 %idxprom
  %9 = load i8, ptr %arrayidx242, align 1, !tbaa !5
  %conv243 = sext i8 %9 to i32
  %shl = shl nuw i32 1, %cond.03
  %and244 = and i32 %shl, %conv243
  %cmp245 = icmp eq i32 %and244, 0
  br i1 %cmp245, label %for.inc355, label %for.inc

for.inc:                                          ; preds = %for.body241
  %incdec.ptr = getelementptr inbounds i8, ptr %cp.02, i64 1
  %inc = add nuw nsw i32 %cond.03, 1
  %exitcond.not = icmp eq i32 %inc, %conv218
  br i1 %exitcond.not, label %if.then253, label %for.body241, !llvm.loop !23

if.then253:                                       ; preds = %for.inc, %if.end225
  %10 = load i32, ptr @cflag, align 4, !tbaa !13
  %tobool257.not = icmp eq i32 %10, 0
  br i1 %tobool257.not, label %if.else, label %if.then258

if.then258:                                       ; preds = %if.then253
  %flagbit = getelementptr inbounds %struct.flagent, ptr %flent.07, i64 0, i32 2
  %11 = load i16, ptr %flagbit, align 8, !tbaa !24
  %conv260 = sext i16 %11 to i32
  %add261 = add nsw i32 %conv260, 65
  call void @flagpr(ptr noundef nonnull %tword, i32 noundef %add261, i32 noundef %conv217, i32 noundef %conv16, i32 noundef -1, i32 noundef 0) #6
  br label %if.end345

if.else:                                          ; preds = %if.then253
  %call314 = call ptr @lookup(ptr noundef nonnull %tword, i32 noundef 1) #6
  %cmp315.not = icmp eq ptr %call314, null
  br i1 %tobool266.not, label %if.else312, label %if.then267

if.then267:                                       ; preds = %if.else
  br i1 %cmp315.not, label %if.end345, label %if.then272

if.then272:                                       ; preds = %if.then267
  %12 = load i16, ptr %affl, align 4, !tbaa !18
  %tobool275.not = icmp eq i16 %12, 0
  br i1 %tobool275.not, label %if.end284, label %if.then276

if.then276:                                       ; preds = %if.then272
  %affix277 = getelementptr inbounds %struct.flagent, ptr %flent.07, i64 0, i32 1
  %13 = load ptr, ptr %affix277, align 8, !tbaa !19
  %call278 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %tword2, ptr noundef nonnull dereferenceable(1) %13) #6
  %idx.ext281 = sext i16 %12 to i64
  %add.ptr282 = getelementptr inbounds i8, ptr %tword2, i64 %idx.ext281
  %incdec.ptr283 = getelementptr inbounds i8, ptr %add.ptr282, i64 1
  store i8 43, ptr %add.ptr282, align 1, !tbaa !5
  %.pre = ptrtoint ptr %incdec.ptr283 to i64
  br label %if.end284

if.end284:                                        ; preds = %if.then276, %if.then272
  %sub.ptr.lhs.cast.pre-phi = phi i64 [ %.pre, %if.then276 ], [ %sub.ptr.rhs.cast, %if.then272 ]
  %cp.1 = phi ptr [ %incdec.ptr283, %if.then276 ], [ %tword2, %if.then272 ]
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast.pre-phi, %sub.ptr.rhs.cast
  %conv286 = trunc i64 %sub.ptr.sub to i32
  %call288 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %cp.1, ptr noundef nonnull dereferenceable(1) %tword) #6
  %idx.ext289 = sext i32 %add to i64
  %add.ptr290 = getelementptr inbounds i8, ptr %cp.1, i64 %idx.ext289
  %14 = load i16, ptr %stripl, align 2, !tbaa !20
  %tobool292.not = icmp eq i16 %14, 0
  br i1 %tobool292.not, label %if.end297, label %if.then293

if.then293:                                       ; preds = %if.end284
  %incdec.ptr294 = getelementptr inbounds i8, ptr %add.ptr290, i64 1
  store i8 45, ptr %add.ptr290, align 1, !tbaa !5
  %15 = load ptr, ptr %flent.07, align 8, !tbaa !22
  %call296 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %incdec.ptr294, ptr noundef nonnull dereferenceable(1) %15) #6
  br label %if.end297

if.end297:                                        ; preds = %if.then293, %if.end284
  %cp.2 = phi ptr [ %incdec.ptr294, %if.then293 ], [ %add.ptr290, %if.end284 ]
  %conv300 = sext i16 %14 to i32
  %sub.ptr.lhs.cast302 = ptrtoint ptr %cp.2 to i64
  %16 = add i64 %sub.ptr.lhs.cast.pre-phi, %idx.ext289
  %sub308 = sub i64 %sub.ptr.lhs.cast302, %16
  %conv309 = trunc i64 %sub308 to i32
  %call310 = call i32 @ins_root_cap(ptr noundef nonnull %tword2, ptr noundef %word, i32 noundef %conv300, i32 noundef %conv286, i32 noundef 0, i32 noundef %conv309, ptr noundef nonnull %call314, ptr noundef nonnull %flent.07, ptr noundef null) #6
  br label %if.end345

if.else312:                                       ; preds = %if.else
  br i1 %cmp315.not, label %if.end345, label %land.lhs.true317

land.lhs.true317:                                 ; preds = %if.else312
  %mask = getelementptr inbounds %struct.dent, ptr %call314, i64 0, i32 2
  %17 = load i64, ptr %mask, align 8, !tbaa !25
  %flagbit319 = getelementptr inbounds %struct.flagent, ptr %flent.07, i64 0, i32 2
  %18 = load i16, ptr %flagbit319, align 8, !tbaa !24
  %conv320 = sext i16 %18 to i64
  %sh_prom = and i64 %conv320, 4294967295
  %shl321 = shl nuw i64 1, %sh_prom
  %and322 = and i64 %shl321, %17
  %tobool323.not = icmp eq i64 %and322, 0
  br i1 %tobool323.not, label %if.end345, label %if.then324

if.then324:                                       ; preds = %land.lhs.true317
  %19 = load i32, ptr @numhits, align 4, !tbaa !13
  %cmp325 = icmp slt i32 %19, 10
  br i1 %cmp325, label %if.then327, label %if.end335

if.then327:                                       ; preds = %if.then324
  %idxprom328 = sext i32 %19 to i64
  %arrayidx329 = getelementptr inbounds [10 x %struct.success], ptr @hits, i64 0, i64 %idxprom328
  store ptr %call314, ptr %arrayidx329, align 8, !tbaa !27
  %prefix = getelementptr inbounds [10 x %struct.success], ptr @hits, i64 0, i64 %idxprom328, i32 1
  store ptr %flent.07, ptr %prefix, align 8, !tbaa !29
  %suffix = getelementptr inbounds [10 x %struct.success], ptr @hits, i64 0, i64 %idxprom328, i32 2
  store ptr null, ptr %suffix, align 8, !tbaa !30
  %inc334 = add nsw i32 %19, 1
  store i32 %inc334, ptr @numhits, align 4, !tbaa !13
  br label %if.end335

if.end335:                                        ; preds = %if.then327, %if.then324
  br i1 %tobool336.not, label %if.then337, label %if.end345

if.then337:                                       ; preds = %if.end335
  %call338 = call i32 @cap_ok(ptr noundef %word, ptr noundef nonnull @hits, i32 noundef %len) #6
  %tobool339.not = icmp eq i32 %call338, 0
  br i1 %tobool339.not, label %if.end341, label %cleanup

if.end341:                                        ; preds = %if.then337
  store i32 0, ptr @numhits, align 4, !tbaa !13
  br label %if.end345

if.end345:                                        ; preds = %if.end297, %if.then267, %if.end335, %if.end341, %land.lhs.true317, %if.else312, %if.then258
  %20 = load i16, ptr %flagflags, align 8, !tbaa !14
  %21 = and i16 %20, 1
  %tobool349.not = icmp eq i16 %21, 0
  br i1 %tobool349.not, label %for.inc355, label %if.then350

if.then350:                                       ; preds = %if.end345
  call fastcc void @chk_suf(ptr noundef %word, ptr noundef nonnull %tword, i32 noundef %add, i32 noundef %or, ptr noundef nonnull %flent.07, i32 noundef %ignoreflagbits, i32 noundef %allhits)
  br label %for.inc355

for.inc355:                                       ; preds = %for.body241, %for.body, %if.end15, %lor.lhs.false, %land.lhs.true216, %if.end345, %if.then350, %land.lhs.true8
  %incdec.ptr356 = getelementptr inbounds %struct.flagent, ptr %flent.07, i64 1
  %dec = add nsw i32 %entcount.06, -1
  %cmp = icmp sgt i32 %entcount.06, 1
  br i1 %cmp, label %for.body, label %cleanup, !llvm.loop !31

cleanup:                                          ; preds = %if.then337, %for.inc355, %entry
...
for.body.preheader.i:                             ; preds = %if.end7.i
  ...
  %uglygep.i = getelementptr i8, ptr %rootword, i64 %7
  br label %for.body.i
...
for.end.i:                                        ; preds = %for.inc.i, %if.end7.i
  %nextc.0.lcssa.i = phi ptr [ %rootword, %if.end7.i ], [ %uglygep.i, %for.inc.i ]
...
if.then63.i:                                      ; preds = %for.body53.i
  ...
  %or.cond.i = select i1 %tobool69.not.i, i1 %cmp3.i.i, i1 false
...
for.body.i.preheader.i:                           ; preds = %if.then63.i
  ...
  %uglygep187.i = getelementptr i8, ptr %tword.i, i64 %23
...
for.body.i.i:                                     ; preds = %for.body.i.i.prol.loopexit, %for.body.i.i
  ...
  %exitcond188.not.i.3 = icmp eq ptr %incdec.ptr.i.i.2, %uglygep187.i
  br i1 %exitcond188.not.i.3, label %if.end89.i, label %for.body.i.i, !llvm.loop !39

if.else.i:                                        ; preds = %for.cond51.i
  %cmp3.i153.i = icmp sgt i32 %add.i, 1
  br i1 %cmp3.i153.i, label %for.body.i161.preheader.i, label %if.end89.i

for.body.i161.preheader.i:                        ; preds = %if.else.i
  %35 = add i32 %conv.i, -2
  %36 = sub i32 %35, %conv3.i
  %37 = add i32 %36, %conv8.i
  %38 = zext i32 %37 to i64
  %39 = add nuw nsw i64 %38, 1
  %uglygep189.i = getelementptr i8, ptr %tword.i, i64 %39
  %xtraiter36 = and i64 %39, 3
  %lcmp.mod37.not = icmp eq i64 %xtraiter36, 0
  br i1 %lcmp.mod37.not, label %for.body.i161.i.prol.loopexit, label %for.body.i161.i.prol

for.body.i161.i.prol:                             ; preds = %for.body.i161.preheader.i, %for.body.i161.i.prol
  %dst.addr.04.i155.i.prol = phi ptr [ %incdec.ptr.i159.i.prol, %for.body.i161.i.prol ], [ %add.ptr76.i, %for.body.i161.preheader.i ]
  %prol.iter38 = phi i64 [ %prol.iter38.next, %for.body.i161.i.prol ], [ 0, %for.body.i161.preheader.i ]
  %40 = load i8, ptr %dst.addr.04.i155.i.prol, align 1, !tbaa !5
  %idxprom.i157.i.prol = zext i8 %40 to i64
  %arrayidx.i158.i.prol = getelementptr inbounds %struct.hashheader, ptr @hashheader, i64 0, i32 21, i64 %idxprom.i157.i.prol
  %41 = load i8, ptr %arrayidx.i158.i.prol, align 1, !tbaa !5
  store i8 %41, ptr %dst.addr.04.i155.i.prol, align 1, !tbaa !5
  %incdec.ptr.i159.i.prol = getelementptr inbounds i8, ptr %dst.addr.04.i155.i.prol, i64 1
  %prol.iter38.next = add i64 %prol.iter38, 1
  %prol.iter38.cmp.not = icmp eq i64 %prol.iter38.next, %xtraiter36
  br i1 %prol.iter38.cmp.not, label %for.body.i161.i.prol.loopexit, label %for.body.i161.i.prol, !llvm.loop !40

for.body.i161.i.prol.loopexit:                    ; preds = %for.body.i161.i.prol, %for.body.i161.preheader.i
  %dst.addr.04.i155.i.unr = phi ptr [ %add.ptr76.i, %for.body.i161.preheader.i ], [ %incdec.ptr.i159.i.prol, %for.body.i161.i.prol ]
  %42 = icmp ult i32 %37, 3
  br i1 %42, label %if.end89.i, label %for.body.i161.i

for.body.i161.i:                                  ; preds = %for.body.i161.i.prol.loopexit, %for.body.i161.i
  %dst.addr.04.i155.i = phi ptr [ %incdec.ptr.i159.i.3, %for.body.i161.i ], [ %dst.addr.04.i155.i.unr, %for.body.i161.i.prol.loopexit ]
  %43 = load i8, ptr %dst.addr.04.i155.i, align 1, !tbaa !5
  %idxprom.i157.i = zext i8 %43 to i64
  %arrayidx.i158.i = getelementptr inbounds %struct.hashheader, ptr @hashheader, i64 0, i32 21, i64 %idxprom.i157.i
  %44 = load i8, ptr %arrayidx.i158.i, align 1, !tbaa !5
  store i8 %44, ptr %dst.addr.04.i155.i, align 1, !tbaa !5
  %incdec.ptr.i159.i = getelementptr inbounds i8, ptr %dst.addr.04.i155.i, i64 1
  %45 = load i8, ptr %incdec.ptr.i159.i, align 1, !tbaa !5
  %idxprom.i157.i.1 = zext i8 %45 to i64
  %arrayidx.i158.i.1 = getelementptr inbounds %struct.hashheader, ptr @hashheader, i64 0, i32 21, i64 %idxprom.i157.i.1
  %46 = load i8, ptr %arrayidx.i158.i.1, align 1, !tbaa !5
  store i8 %46, ptr %incdec.ptr.i159.i, align 1, !tbaa !5
  %incdec.ptr.i159.i.1 = getelementptr inbounds i8, ptr %dst.addr.04.i155.i, i64 2
  %47 = load i8, ptr %incdec.ptr.i159.i.1, align 1, !tbaa !5
  %idxprom.i157.i.2 = zext i8 %47 to i64
  %arrayidx.i158.i.2 = getelementptr inbounds %struct.hashheader, ptr @hashheader, i64 0, i32 21, i64 %idxprom.i157.i.2
  %48 = load i8, ptr %arrayidx.i158.i.2, align 1, !tbaa !5
  store i8 %48, ptr %incdec.ptr.i159.i.1, align 1, !tbaa !5
  %incdec.ptr.i159.i.2 = getelementptr inbounds i8, ptr %dst.addr.04.i155.i, i64 3
  %49 = load i8, ptr %incdec.ptr.i159.i.2, align 1, !tbaa !5
  %idxprom.i157.i.3 = zext i8 %49 to i64
  %arrayidx.i158.i.3 = getelementptr inbounds %struct.hashheader, ptr @hashheader, i64 0, i32 21, i64 %idxprom.i157.i.3
  %50 = load i8, ptr %arrayidx.i158.i.3, align 1, !tbaa !5
  store i8 %50, ptr %incdec.ptr.i159.i.2, align 1, !tbaa !5
  %incdec.ptr.i159.i.3 = getelementptr inbounds i8, ptr %dst.addr.04.i155.i, i64 4
  %exitcond190.not.i.3 = icmp eq ptr %incdec.ptr.i159.i.2, %uglygep189.i
  br i1 %exitcond190.not.i.3, label %if.end89.i, label %for.body.i161.i, !llvm.loop !39
...
if.then84.i:                                      ; preds = %if.else80.i
  ...
  %cmp3.i163.i = icmp sgt i16 %53, 0
  br i1 %cmp3.i163.i, label %for.body.i171.preheader.i, label %if.end89.i

for.body.i171.preheader.i:                        ; preds = %if.then84.i
  %conv87.i = zext i16 %53 to i64
  %54 = add nuw nsw i64 %conv87.i, 4294967295
  %55 = and i64 %54, 4294967295
  %uglygep191.i = getelementptr i8, ptr %tword.i, i64 %55
  %xtraiter39 = and i64 %conv87.i, 3
  %lcmp.mod40.not = icmp eq i64 %xtraiter39, 0
  br i1 %lcmp.mod40.not, label %for.body.i171.i.prol.loopexit, label %for.body.i171.i.prol

for.body.i171.i.prol:                             ; preds = %for.body.i171.preheader.i, %for.body.i171.i.prol
  %dst.addr.04.i165.i.prol = phi ptr [ %incdec.ptr.i169.i.prol, %for.body.i171.i.prol ], [ %tword.i, %for.body.i171.preheader.i ]
  %prol.iter41 = phi i64 [ %prol.iter41.next, %for.body.i171.i.prol ], [ 0, %for.body.i171.preheader.i ]
  %56 = load i8, ptr %dst.addr.04.i165.i.prol, align 1, !tbaa !5
  %idxprom.i167.i.prol = zext i8 %56 to i64
  %arrayidx.i168.i.prol = getelementptr inbounds %struct.hashheader, ptr @hashheader, i64 0, i32 21, i64 %idxprom.i167.i.prol
  %57 = load i8, ptr %arrayidx.i168.i.prol, align 1, !tbaa !5
  store i8 %57, ptr %dst.addr.04.i165.i.prol, align 1, !tbaa !5
  %incdec.ptr.i169.i.prol = getelementptr inbounds i8, ptr %dst.addr.04.i165.i.prol, i64 1
  %prol.iter41.next = add i64 %prol.iter41, 1
  %prol.iter41.cmp.not = icmp eq i64 %prol.iter41.next, %xtraiter39
  br i1 %prol.iter41.cmp.not, label %for.body.i171.i.prol.loopexit, label %for.body.i171.i.prol, !llvm.loop !41

for.body.i171.i.prol.loopexit:                    ; preds = %for.body.i171.i.prol, %for.body.i171.preheader.i
  %dst.addr.04.i165.i.unr = phi ptr [ %tword.i, %for.body.i171.preheader.i ], [ %incdec.ptr.i169.i.prol, %for.body.i171.i.prol ]
  %58 = icmp ult i64 %55, 3
  br i1 %58, label %if.end89.i, label %for.body.i171.i

for.body.i171.i:                                  ; preds = %for.body.i171.i.prol.loopexit, %for.body.i171.i
  %dst.addr.04.i165.i = phi ptr [ %incdec.ptr.i169.i.3, %for.body.i171.i ], [ %dst.addr.04.i165.i.unr, %for.body.i171.i.prol.loopexit ]
  %59 = load i8, ptr %dst.addr.04.i165.i, align 1, !tbaa !5
  %idxprom.i167.i = zext i8 %59 to i64
  %arrayidx.i168.i = getelementptr inbounds %struct.hashheader, ptr @hashheader, i64 0, i32 21, i64 %idxprom.i167.i
  %60 = load i8, ptr %arrayidx.i168.i, align 1, !tbaa !5
  store i8 %60, ptr %dst.addr.04.i165.i, align 1, !tbaa !5
  %incdec.ptr.i169.i = getelementptr inbounds i8, ptr %dst.addr.04.i165.i, i64 1
  %61 = load i8, ptr %incdec.ptr.i169.i, align 1, !tbaa !5
  %idxprom.i167.i.1 = zext i8 %61 to i64
  %arrayidx.i168.i.1 = getelementptr inbounds %struct.hashheader, ptr @hashheader, i64 0, i32 21, i64 %idxprom.i167.i.1
  %62 = load i8, ptr %arrayidx.i168.i.1, align 1, !tbaa !5
  store i8 %62, ptr %incdec.ptr.i169.i, align 1, !tbaa !5
  %incdec.ptr.i169.i.1 = getelementptr inbounds i8, ptr %dst.addr.04.i165.i, i64 2
  %63 = load i8, ptr %incdec.ptr.i169.i.1, align 1, !tbaa !5
  %idxprom.i167.i.2 = zext i8 %63 to i64
  %arrayidx.i168.i.2 = getelementptr inbounds %struct.hashheader, ptr @hashheader, i64 0, i32 21, i64 %idxprom.i167.i.2
  %64 = load i8, ptr %arrayidx.i168.i.2, align 1, !tbaa !5
  store i8 %64, ptr %incdec.ptr.i169.i.1, align 1, !tbaa !5
  %incdec.ptr.i169.i.2 = getelementptr inbounds i8, ptr %dst.addr.04.i165.i, i64 3
  %65 = load i8, ptr %incdec.ptr.i169.i.2, align 1, !tbaa !5
  %idxprom.i167.i.3 = zext i8 %65 to i64
  %arrayidx.i168.i.3 = getelementptr inbounds %struct.hashheader, ptr @hashheader, i64 0, i32 21, i64 %idxprom.i167.i.3
  %66 = load i8, ptr %arrayidx.i168.i.3, align 1, !tbaa !5
  store i8 %66, ptr %incdec.ptr.i169.i.2, align 1, !tbaa !5
  %incdec.ptr.i169.i.3 = getelementptr inbounds i8, ptr %dst.addr.04.i165.i, i64 4
  %exitcond192.not.i.3 = icmp eq ptr %incdec.ptr.i169.i.2, %uglygep191.i
  br i1 %exitcond192.not.i.3, label %if.end89.i, label %for.body.i171.i, !llvm.loop !39

if.end89.i:                                       ; preds = %for.cond38.i, %for.body.i.i.prol.loopexit, %for.body.i.i, %for.body.i161.i.prol.loopexit, %for.body.i161.i, %for.body.i171.i.prol.loopexit, %for.body.i171.i, %if.then84.i, %if.else80.i, %if.else.i, %if.then63.i
...
if.then25.i:                                      ; preds = %for.end.i
  ...
  %or.cond.i = select i1 %tobool30.not.i, i1 %cmp3.i.i, i1 false
...
entry:
  ...
  %cmp17 = icmp sgt i32 %ind.8.val, 0
...
for.body.lr.ph:                                   ; preds = %entry
  ...
  %stripl281 = getelementptr inbounds %struct.flagent, ptr %pfxent, i64 0, i32 3
  %affl283 = getelementptr inbounds %struct.flagent, ptr %pfxent, i64 0, i32 4
  %tobool299.not = icmp eq i32 %ignoreflagbits, 0
  %affix315 = getelementptr inbounds %struct.flagent, ptr %pfxent, i64 0, i32 1
  %sub.ptr.rhs.cast4 = ptrtoint ptr %tword2 to i64
  %tobool425.not = icmp eq i32 %allhits, 0
  br label %for.body

for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %entcount.020 = phi i32 [ %ind.8.val, %for.body.lr.ph ], [ %dec438, %for.inc ]
  %flent.018 = phi ptr [ %ind.0.val, %for.body.lr.ph ], [ %incdec.ptr437, %for.inc ]
  %flagflags5.phi.trans.insert = getelementptr inbounds %struct.flagent, ptr %flent.018, i64 0, i32 6
  %.pre = load i16, ptr %flagflags5.phi.trans.insert, align 8, !tbaa !14
  %0 = and i16 %.pre, 1
  %cmp3 = icmp eq i16 %0, 0
  %or.cond22 = select i1 %cmp1.not, i1 %cmp3, i1 false
  br i1 %or.cond22, label %for.inc, label %if.end
...
land.lhs.true18:                                  ; preds = %if.end15
  %conv20532 = zext i16 %.pre to i32
  %xor = xor i32 %conv20532, %optflags
  %and21 = and i32 %xor, 2
  %cmp22.not = icmp eq i32 %and21, 0
  br i1 %cmp22.not, label %if.end25, label %for.inc

if.end25:                                         ; preds = %land.lhs.true18, %if.end15
  %affl = getelementptr inbounds %struct.flagent, ptr %flent.018, i64 0, i32 4
  %3 = load i16, ptr %affl, align 4, !tbaa !18
...
land.lhs.true29:                                  ; preds = %if.end25
  ...
  br i1 %cmp32, label %land.lhs.true236, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %land.lhs.true29
  %affix224 = getelementptr inbounds %struct.flagent, ptr %flent.018, i64 0, i32 1
  %4 = load ptr, ptr %affix224, align 8, !tbaa !19
  %idx.ext225 = zext i32 %sub to i64
  %add.ptr226 = getelementptr inbounds i8, ptr %ucword, i64 %idx.ext225
  %call227 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %4, ptr noundef nonnull dereferenceable(1) %add.ptr226) #6
  %cmp234 = icmp eq i32 %call227, 0
  br i1 %cmp234, label %land.lhs.true236, label %for.inc

land.lhs.true236:                                 ; preds = %lor.lhs.false, %land.lhs.true29
  %stripl = getelementptr inbounds %struct.flagent, ptr %flent.018, i64 0, i32 3
  %5 = load i16, ptr %stripl, align 2, !tbaa !20
  %conv237 = sext i16 %5 to i32
  %add = add nsw i32 %sub, %conv237
  %numconds = getelementptr inbounds %struct.flagent, ptr %flent.018, i64 0, i32 5
  %6 = load i16, ptr %numconds, align 2, !tbaa !21
  %conv238 = sext i16 %6 to i32
  %cmp239.not = icmp slt i32 %add, %conv238
  br i1 %cmp239.not, label %for.inc, label %if.then241

if.then241:                                       ; preds = %land.lhs.true236
  %call243 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %tword, ptr noundef nonnull dereferenceable(1) %ucword) #6
  %idx.ext245 = zext i32 %sub to i64
  %add.ptr246 = getelementptr inbounds i8, ptr %tword, i64 %idx.ext245
  %tobool.not = icmp eq i16 %5, 0
  br i1 %tobool.not, label %if.else, label %if.then248

if.then248:                                       ; preds = %if.then241
  %7 = load ptr, ptr %flent.018, align 8, !tbaa !22
  %call249 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %add.ptr246, ptr noundef nonnull dereferenceable(1) %7) #6
  %idx.ext254 = sext i32 %add to i64
  %add.ptr255 = getelementptr inbounds i8, ptr %tword, i64 %idx.ext254
  br label %if.end256

if.else:                                          ; preds = %if.then241
  store i8 0, ptr %add.ptr246, align 1, !tbaa !5
  br label %if.end256

if.end256:                                        ; preds = %if.else, %if.then248
  %tlen.0 = phi i32 [ %add, %if.then248 ], [ %sub, %if.else ]
  %cp.0 = phi ptr [ %add.ptr255, %if.then248 ], [ %add.ptr246, %if.else ]
  br label %for.cond259

for.cond259:                                      ; preds = %for.body262, %if.end256
  %cond.0 = phi i32 [ %conv238, %if.end256 ], [ %dec, %for.body262 ]
  %cp.1 = phi ptr [ %cp.0, %if.end256 ], [ %incdec.ptr, %for.body262 ]
  %cmp260 = icmp sgt i32 %cond.0, 0
  br i1 %cmp260, label %for.body262, label %if.then272
...
for.body262:                                      ; preds = %for.cond259
  ...
  %idxprom = zext i8 %8 to i64
  %arrayidx263 = getelementptr inbounds %struct.flagent, ptr %flent.018, i64 0, i32 7, i64 %idxprom
  %9 = load i8, ptr %arrayidx263, align 1, !tbaa !5
  %conv264 = sext i8 %9 to i32
  %shl = shl nuw i32 1, %dec
  %and265 = and i32 %shl, %conv264
  %cmp266 = icmp eq i32 %and265, 0
  br i1 %cmp266, label %for.inc, label %for.cond259, !llvm.loop !46

if.then272:                                       ; preds = %for.cond259
  %10 = load i32, ptr @cflag, align 4, !tbaa !13
  %tobool273.not = icmp eq i32 %10, 0
  br i1 %tobool273.not, label %if.else298, label %if.then274

if.then274:                                       ; preds = %if.then272
  br i1 %cmp1.not, label %if.then277, label %if.else290

if.then277:                                       ; preds = %if.then274
  %11 = load i16, ptr %flagbit, align 8, !tbaa !24
  %conv279 = sext i16 %11 to i32
  %add280 = add nsw i32 %conv279, 65
  %12 = load i16, ptr %stripl281, align 2, !tbaa !20
  %conv282 = sext i16 %12 to i32
  %13 = load i16, ptr %affl283, align 4, !tbaa !18
  %conv284 = sext i16 %13 to i32
  %flagbit285 = getelementptr inbounds %struct.flagent, ptr %flent.018, i64 0, i32 2
  %14 = load i16, ptr %flagbit285, align 8, !tbaa !24
  %conv286 = sext i16 %14 to i32
  %add287 = add nsw i32 %conv286, 65
  call void @flagpr(ptr noundef nonnull %tword, i32 noundef %add280, i32 noundef %conv282, i32 noundef %conv284, i32 noundef %add287, i32 noundef %conv26) #6
  br label %for.inc

if.else290:                                       ; preds = %if.then274
  %flagbit292 = getelementptr inbounds %struct.flagent, ptr %flent.018, i64 0, i32 2
  %15 = load i16, ptr %flagbit292, align 8, !tbaa !24
  %conv293 = sext i16 %15 to i32
  %add294 = add nsw i32 %conv293, 65
  call void @flagpr(ptr noundef nonnull %tword, i32 noundef -1, i32 noundef 0, i32 noundef 0, i32 noundef %add294, i32 noundef %conv26) #6
  br label %for.inc

if.else298:                                       ; preds = %if.then272
  %call391 = call ptr @lookup(ptr noundef nonnull %tword, i32 noundef 1) #6
  %cmp392.not = icmp eq ptr %call391, null
  br i1 %tobool299.not, label %if.else389, label %if.then300

if.then300:                                       ; preds = %if.else298
  br i1 %cmp392.not, label %for.inc, label %if.then305

if.then305:                                       ; preds = %if.then300
  br i1 %cmp1.not, label %land.lhs.true309, label %if.end322

land.lhs.true309:                                 ; preds = %if.then305
  %16 = load i16, ptr %affl283, align 4, !tbaa !18
  %cmp312.not = icmp eq i16 %16, 0
  br i1 %cmp312.not, label %land.lhs.true331, label %if.then314

if.then314:                                       ; preds = %land.lhs.true309
  %17 = load ptr, ptr %affix315, align 8, !tbaa !19
  %call316 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %tword2, ptr noundef nonnull dereferenceable(1) %17) #6
  %idx.ext319 = sext i16 %16 to i64
  %add.ptr320 = getelementptr inbounds i8, ptr %tword2, i64 %idx.ext319
  %incdec.ptr321 = getelementptr inbounds i8, ptr %add.ptr320, i64 1
  store i8 43, ptr %add.ptr320, align 1, !tbaa !5
  %.pre21 = ptrtoint ptr %incdec.ptr321 to i64
  br label %land.lhs.true331

if.end322:                                        ; preds = %if.then305
  %call326 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %tword2, ptr noundef nonnull dereferenceable(1) %tword) #6
  %idx.ext327 = sext i32 %tlen.0 to i64
  %add.ptr328 = getelementptr inbounds i8, ptr %tword2, i64 %idx.ext327
  br label %if.end344

land.lhs.true331:                                 ; preds = %if.then314, %land.lhs.true309
  %sub.ptr.lhs.cast3.pre-phi = phi i64 [ %.pre21, %if.then314 ], [ %sub.ptr.rhs.cast4, %land.lhs.true309 ]
  %cp.2.ph = phi ptr [ %incdec.ptr321, %if.then314 ], [ %tword2, %land.lhs.true309 ]
  %sub.ptr.sub5 = sub i64 %sub.ptr.lhs.cast3.pre-phi, %sub.ptr.rhs.cast4
  %call3267 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %cp.2.ph, ptr noundef nonnull dereferenceable(1) %tword) #6
  %idx.ext3278 = sext i32 %tlen.0 to i64
  %add.ptr3289 = getelementptr inbounds i8, ptr %cp.2.ph, i64 %idx.ext3278
  %18 = load i16, ptr %stripl281, align 2, !tbaa !20
  %cmp334.not = icmp eq i16 %18, 0
  br i1 %cmp334.not, label %if.end344, label %if.then336

if.then336:                                       ; preds = %land.lhs.true331
  %incdec.ptr337 = getelementptr inbounds i8, ptr %add.ptr3289, i64 1
  store i8 45, ptr %add.ptr3289, align 1, !tbaa !5
  %19 = load ptr, ptr %pfxent, align 8, !tbaa !22
  %call339 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %incdec.ptr337, ptr noundef nonnull dereferenceable(1) %19) #6
  %idx.ext342 = sext i16 %18 to i64
  %add.ptr343 = getelementptr inbounds i8, ptr %incdec.ptr337, i64 %idx.ext342
  br label %if.end344

if.end344:                                        ; preds = %if.end322, %if.then336, %land.lhs.true331
  %idx.ext32715 = phi i64 [ %idx.ext3278, %if.then336 ], [ %idx.ext3278, %land.lhs.true331 ], [ %idx.ext327, %if.end322 ]
  %conv32413.in = phi i64 [ %sub.ptr.sub5, %if.then336 ], [ %sub.ptr.sub5, %land.lhs.true331 ], [ 0, %if.end322 ]
  %sub.ptr.lhs.cast11 = phi i64 [ %sub.ptr.lhs.cast3.pre-phi, %if.then336 ], [ %sub.ptr.lhs.cast3.pre-phi, %land.lhs.true331 ], [ %sub.ptr.rhs.cast4, %if.end322 ]
  %cp.3 = phi ptr [ %add.ptr343, %if.then336 ], [ %add.ptr3289, %land.lhs.true331 ], [ %add.ptr328, %if.end322 ]
  %conv32413 = trunc i64 %conv32413.in to i32
  %20 = load i16, ptr %stripl, align 2, !tbaa !20
  %tobool346.not = icmp eq i16 %20, 0
  br i1 %tobool346.not, label %if.end355, label %if.then347

if.then347:                                       ; preds = %if.end344
  %incdec.ptr348 = getelementptr inbounds i8, ptr %cp.3, i64 1
  store i8 45, ptr %cp.3, align 1, !tbaa !5
  %21 = load ptr, ptr %flent.018, align 8, !tbaa !22
  %call350 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %incdec.ptr348, ptr noundef nonnull dereferenceable(1) %21) #6
  %22 = load i16, ptr %stripl, align 2, !tbaa !20
  %idx.ext353 = sext i16 %22 to i64
  %add.ptr354 = getelementptr inbounds i8, ptr %incdec.ptr348, i64 %idx.ext353
  br label %if.end355

if.end355:                                        ; preds = %if.then347, %if.end344
  %cp.4 = phi ptr [ %add.ptr354, %if.then347 ], [ %cp.3, %if.end344 ]
  %23 = load i16, ptr %affl, align 4, !tbaa !18
  %tobool357.not = icmp eq i16 %23, 0
  br i1 %tobool357.not, label %if.end366, label %if.then358

if.then358:                                       ; preds = %if.end355
  %incdec.ptr359 = getelementptr inbounds i8, ptr %cp.4, i64 1
  store i8 43, ptr %cp.4, align 1, !tbaa !5
  %affix360 = getelementptr inbounds %struct.flagent, ptr %flent.018, i64 0, i32 1
  %24 = load ptr, ptr %affix360, align 8, !tbaa !19
  %call361 = call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %incdec.ptr359, ptr noundef nonnull dereferenceable(1) %24) #6
  %25 = load i16, ptr %affl, align 4, !tbaa !18
  %idx.ext364 = sext i16 %25 to i64
  %add.ptr365 = getelementptr inbounds i8, ptr %incdec.ptr359, i64 %idx.ext364
  br label %if.end366

if.end366:                                        ; preds = %if.then358, %if.end355
  %cp.5 = phi ptr [ %add.ptr365, %if.then358 ], [ %cp.4, %if.end355 ]
  br i1 %cmp1.not, label %cond.true370, label %cond.end374

cond.true370:                                     ; preds = %if.end366
  %26 = load i16, ptr %stripl281, align 2, !tbaa !20
  %conv372 = sext i16 %26 to i32
  br label %cond.end374

cond.end374:                                      ; preds = %if.end366, %cond.true370
  %cond375 = phi i32 [ %conv372, %cond.true370 ], [ 0, %if.end366 ]
  %27 = load i16, ptr %stripl, align 2, !tbaa !20
  %conv377 = sext i16 %27 to i32
  %sub.ptr.lhs.cast379 = ptrtoint ptr %cp.5 to i64
  %28 = add i64 %sub.ptr.lhs.cast11, %idx.ext32715
  %sub385 = sub i64 %sub.ptr.lhs.cast379, %28
  %conv386 = trunc i64 %sub385 to i32
  %call387 = call i32 @ins_root_cap(ptr noundef nonnull %tword2, ptr noundef %word, i32 noundef %cond375, i32 noundef %conv32413, i32 noundef %conv377, i32 noundef %conv386, ptr noundef nonnull %call391, ptr noundef %pfxent, ptr noundef nonnull %flent.018) #6
  br label %for.inc

if.else389:                                       ; preds = %if.else298
  br i1 %cmp392.not, label %for.inc, label %land.lhs.true394

land.lhs.true394:                                 ; preds = %if.else389
  %mask = getelementptr inbounds %struct.dent, ptr %call391, i64 0, i32 2
  %29 = load i64, ptr %mask, align 8, !tbaa !25
  %flagbit396 = getelementptr inbounds %struct.flagent, ptr %flent.018, i64 0, i32 2
  %30 = load i16, ptr %flagbit396, align 8, !tbaa !24
  %conv397 = sext i16 %30 to i64
  %sh_prom = and i64 %conv397, 4294967295
  %shl398 = shl nuw i64 1, %sh_prom
  %and399 = and i64 %shl398, %29
  %tobool400.not = icmp eq i64 %and399, 0
  br i1 %tobool400.not, label %for.inc, label %land.lhs.true401

land.lhs.true401:                                 ; preds = %land.lhs.true394
  br i1 %cmp1.not, label %lor.lhs.false405, label %if.then414

lor.lhs.false405:                                 ; preds = %land.lhs.true401
  %31 = load i16, ptr %flagbit, align 8, !tbaa !24
  %conv409 = sext i16 %31 to i64
  %sh_prom410 = and i64 %conv409, 4294967295
  %shl411 = shl nuw i64 1, %sh_prom410
  %and412 = and i64 %shl411, %29
  %tobool413.not = icmp eq i64 %and412, 0
  br i1 %tobool413.not, label %for.inc, label %if.then414

if.then414:                                       ; preds = %lor.lhs.false405, %land.lhs.true401
  %32 = load i32, ptr @numhits, align 4, !tbaa !13
  %cmp415 = icmp slt i32 %32, 10
  br i1 %cmp415, label %if.then417, label %if.end424

if.then417:                                       ; preds = %if.then414
  %idxprom418 = sext i32 %32 to i64
  %arrayidx419 = getelementptr inbounds [10 x %struct.success], ptr @hits, i64 0, i64 %idxprom418
  store ptr %call391, ptr %arrayidx419, align 8, !tbaa !27
  %prefix = getelementptr inbounds [10 x %struct.success], ptr @hits, i64 0, i64 %idxprom418, i32 1
  store ptr %pfxent, ptr %prefix, align 8, !tbaa !29
  %suffix = getelementptr inbounds [10 x %struct.success], ptr @hits, i64 0, i64 %idxprom418, i32 2
  store ptr %flent.018, ptr %suffix, align 8, !tbaa !30
  %inc = add nsw i32 %32, 1
  store i32 %inc, ptr @numhits, align 4, !tbaa !13
  br label %if.end424

if.end424:                                        ; preds = %if.then417, %if.then414
  br i1 %tobool425.not, label %if.then426, label %for.inc

if.then426:                                       ; preds = %if.end424
  %call427 = call i32 @cap_ok(ptr noundef %word, ptr noundef nonnull @hits, i32 noundef %len) #6
  %tobool428.not = icmp eq i32 %call427, 0
  br i1 %tobool428.not, label %if.end430, label %cleanup

if.end430:                                        ; preds = %if.then426
  store i32 0, ptr @numhits, align 4, !tbaa !13
  br label %for.inc

for.inc:                                          ; preds = %for.body262, %for.body, %if.end, %if.end25, %lor.lhs.false, %land.lhs.true236, %if.else290, %if.then277, %if.else389, %land.lhs.true394, %lor.lhs.false405, %if.end430, %if.end424, %if.then300, %cond.end374, %land.lhs.true18
  %incdec.ptr437 = getelementptr inbounds %struct.flagent, ptr %flent.018, i64 1
  %dec438 = add nsw i32 %entcount.020, -1
  %cmp = icmp sgt i32 %entcount.020, 1
  br i1 %cmp, label %for.body, label %cleanup, !llvm.loop !47

cleanup:                                          ; preds = %if.then426, %for.inc, %entry
  call void @llvm.lifetime.end.p0(i64 184, ptr nonnull %tword2) #6
  call void @llvm.lifetime.end.p0(i64 184, ptr nonnull %tword) #6
  ret void
}
