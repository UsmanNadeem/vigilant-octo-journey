; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Benchmarks/BenchmarkGame/spectral-norm.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/SingleSource/Benchmarks/BenchmarkGame/spectral-norm.c"
...
define dso_local void @eval_A_times_u(i32 noundef %N, ptr nocapture noundef readonly %u, ptr nocapture noundef %Au) local_unnamed_addr #1 {
entry:
...
; Function Attrs: nofree nosync nounwind memory(argmem: readwrite) uwtable
define dso_local void @eval_At_times_u(i32 noundef %N, ptr nocapture noundef readonly %u, ptr nocapture noundef %Au) local_unnamed_addr #1 {
entry:
