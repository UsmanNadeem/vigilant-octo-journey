; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/treecc/gen.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/treecc/gen.c"
...
if.else12.i:                                      ; preds = %if.end.i
  ...
  %23 = select i1 %cmp1485.i, i1 %cmp1786.i, i1 false
...
while.body20.i:                                   ; preds = %if.else12.i, %while.body20.i
  ...
  %25 = select i1 %cmp14.i, i1 %cmp17.i, i1 false
...
if.else19.i:                                      ; preds = %if.end11.i
  ...
  %48 = select i1 %cmp2186.i, i1 %cmp2487.i, i1 false
...
while.body27.i:                                   ; preds = %if.else19.i, %while.body27.i
  ...
  %50 = select i1 %cmp21.i, i1 %cmp24.i, i1 false
...
; Function Attrs: nounwind uwtable
define internal fastcc void @GenerateSplitMultiSwitch(ptr noundef %context, ptr noundef %stream, ptr nocapture noundef readonly %nonVirt, ptr noundef %oper, ptr nocapture noundef readonly %sortedCases, i32 noundef %base, i32 noundef %multiplier, ptr noundef %nextParam, i32 noundef %triggerNum) unnamed_addr #0 {
entry:
...
if.else12:                                        ; preds = %if.end6
  ...
  %9 = select i1 %cmp1485, i1 %cmp1786, i1 false
...
while.body20:                                     ; preds = %if.else12, %while.body20
  ...
  %11 = select i1 %cmp14, i1 %cmp17, i1 false
...
if.then40.us:                                     ; preds = %do.body.us
  ...
  %call42.us = call fastcc i32 @GenerateSelectors(ptr noundef %context, ptr noundef %stream, ptr noundef nonnull %nonVirt, ptr noundef %12, i32 noundef %shl, i32 noundef %triggerNum)
...
if.end46.us:                                      ; preds = %if.then44.us, %if.then40.us, %do.body.us
  %16 = load ptr, ptr %genEndSelectors, align 8, !tbaa !58
  ...
  %17 = load ptr, ptr %genEndCase, align 8, !tbaa !59
...
while.body35:                                     ; preds = %do.body, %while.body35
  ...
  br i1 %18, label %while.body35, label %while.end38, !llvm.loop !60
...
if.then40:                                        ; preds = %while.end38
  ...
  %call42 = call fastcc i32 @GenerateSelectors(ptr noundef %context, ptr noundef %stream, ptr noundef %nonVirt, ptr noundef %19, i32 noundef %shl, i32 noundef %triggerNum)
  %tobool43.not = icmp eq i32 %call42, 0
  br i1 %tobool43.not, label %if.then44, label %if.end46

if.then44:                                        ; preds = %if.then40
  %20 = load ptr, ptr %input, align 8, !tbaa !55
  %filename = getelementptr inbounds %struct._tagTreeCCOperationCase, ptr %operCase, i64 0, i32 4
  %21 = load ptr, ptr %filename, align 8, !tbaa !56
  %linenum = getelementptr inbounds %struct._tagTreeCCOperationCase, ptr %operCase, i64 0, i32 5
  %22 = load i64, ptr %linenum, align 8, !tbaa !57
...
if.end46:                                         ; preds = %do.body, %if.then40, %if.then44, %while.end38
  %23 = load ptr, ptr %genEndSelectors, align 8, !tbaa !58
  ...
  %24 = load ptr, ptr %genEndCase, align 8, !tbaa !59
...
if.else19:                                        ; preds = %if.end11
  ...
  %11 = select i1 %cmp2186, i1 %cmp2487, i1 false
...
while.body27:                                     ; preds = %if.else19, %while.body27
  ...
  %13 = select i1 %cmp21, i1 %cmp24, i1 false
...
if.then:                                          ; preds = %entry
  ...
  %1 = load i32, ptr %position, align 8, !tbaa !61
  ...
  %2 = load i32, ptr %size, align 4, !tbaa !62
...
while.body:                                       ; preds = %if.end, %while.body
  ...
  br i1 %cmp3.not, label %while.end, label %while.body, !llvm.loop !63
...
if.else12:                                        ; preds = %if.then
  ...
  %10 = load ptr, ptr %genCaseSplit, align 8, !tbaa !65
...
if.end15:                                         ; preds = %if.then6, %if.else, %if.else12
  %genEndCase = getelementptr inbounds %struct.TreeCCNonVirtual, ptr %nonVirt, i64 0, i32 10
  %12 = load ptr, ptr %genEndCase, align 8, !tbaa !59
...
while.body:                                       ; preds = %if.end16, %while.body
  ...
  br i1 %cmp17.not, label %while.end, label %while.body, !llvm.loop !66
...
while.body:                                       ; preds = %if.end, %while.body
  ...
  %call = tail call fastcc i32 @GenerateSelectors(ptr noundef %context, ptr noundef %stream, ptr noundef %nonVirt, ptr noundef nonnull %node.addr.017, i32 noundef %markBit, i32 noundef %triggerNum)
  ...
  br i1 %cmp2.not, label %return, label %while.body, !llvm.loop !67
...
if.then:                                          ; preds = %entry
  ...
  %add = add nsw i32 %mul, %base
  %size = getelementptr inbounds %struct._tagTreeCCParam, ptr %nextParam, i64 0, i32 3
  %4 = load i32, ptr %size, align 4, !tbaa !62
  ...
  %genEndCase = getelementptr inbounds %struct.TreeCCNonVirtual, ptr %nonVirt, i64 0, i32 10
  %6 = load ptr, ptr %genEndCase, align 8, !tbaa !59
...
while.body:                                       ; preds = %if.end, %while.body
  ...
  %node.addr.0 = load ptr, ptr %nextSibling, align 8, !tbaa !11
  %cmp3.not = icmp eq ptr %node.addr.0, null
  br i1 %cmp3.not, label %while.end, label %while.body, !llvm.loop !68
