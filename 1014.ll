; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/SimpleMOC/tracks.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/SimpleMOC/tracks.c"
...
for.cond.cleanup.i:                               ; preds = %for.cond.cleanup.thread, %for.cond.cleanup.loopexit.i, %for.cond.cleanup
  ...
  %3 = load i64, ptr %nbytes, align 8, !tbaa !14
  %add5.i = add i64 %3, %total_segments.0.lcssa.i
  store i64 %add5.i, ptr %nbytes, align 8, !tbaa !14
...
for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  ...
  store i64 %conv5.i.i, ptr %n_segments.i, align 8, !tbaa !15
...
for.body11.i:                                     ; preds = %for.body11.i, %for.body11.i.preheader.new
  ...
  store ptr %arrayidx12.i, ptr %segments.i, align 8, !tbaa !17
  %n_segments15.i = getelementptr inbounds %struct.Track2D, ptr %call, i64 %i6.073.i, i32 1
  %5 = load i64, ptr %n_segments15.i, align 8, !tbaa !15
  ...
  store ptr %arrayidx12.i.1, ptr %segments.i.1, align 8, !tbaa !17
  %n_segments15.i.1 = getelementptr inbounds %struct.Track2D, ptr %call, i64 %inc18.i, i32 1
  %6 = load i64, ptr %n_segments15.i.1, align 8, !tbaa !15
...
for.body11.i.epil:                                ; preds = %for.cond26.preheader.i.preheader.unr-lcssa
  ...
  store ptr %arrayidx12.i.epil, ptr %segments.i.epil, align 8, !tbaa !17
...
for.cond26.preheader.i:                           ; preds = %for.cond26.preheader.i.preheader, %for.cond.cleanup30.i
  ...
  %7 = load i64, ptr %n_segments28.i, align 8, !tbaa !15
...
for.body31.i:                                     ; preds = %for.body31.i, %for.body31.lr.ph.i
  ...
  %8 = load ptr, ptr %segments37.i, align 8, !tbaa !17
  %arrayidx38.i = getelementptr inbounds %struct.Segment, ptr %8, i64 %j.075.i
  store float %div.i, ptr %arrayidx38.i, align 8, !tbaa !18
...
for.body:                                         ; preds = %entry, %for.body
  ...
  store float %call5, ptr %arrayidx, align 8, !tbaa !20
...
for.cond.cleanup:                                 ; preds = %for.cond.cleanup.loopexit, %entry
  ...
  %2 = load i64, ptr %nbytes, align 8, !tbaa !14
  %add5 = add i64 %2, %total_segments.0.lcssa
  store i64 %add5, ptr %nbytes, align 8, !tbaa !14
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  store i64 %conv5.i, ptr %n_segments, align 8, !tbaa !15
...
for.body11.epil:                                  ; preds = %for.cond21.preheader.unr-lcssa
  ...
  store ptr %arrayidx12.epil, ptr %segments.epil, align 8, !tbaa !17
...
for.body11:                                       ; preds = %for.body11, %for.body11.preheader.new
  ...
  store ptr %arrayidx12, ptr %segments, align 8, !tbaa !17
  %n_segments15 = getelementptr inbounds %struct.Track2D, ptr %tracks, i64 %i6.073, i32 1
  %5 = load i64, ptr %n_segments15, align 8, !tbaa !15
  ...
  store ptr %arrayidx12.1, ptr %segments.1, align 8, !tbaa !17
  %n_segments15.1 = getelementptr inbounds %struct.Track2D, ptr %tracks, i64 %inc18, i32 1
  %6 = load i64, ptr %n_segments15.1, align 8, !tbaa !15
...
for.cond26.preheader:                             ; preds = %for.cond26.preheader.lr.ph, %for.cond.cleanup30
  ...
  %7 = load i64, ptr %n_segments28, align 8, !tbaa !15
...
for.body31:                                       ; preds = %for.body31.lr.ph, %for.body31
  ...
  %8 = load i64, ptr %n_segments28, align 8, !tbaa !15
  %conv = sitofp i64 %8 to float
  %div = fdiv float %mul33, %conv
  %9 = load ptr, ptr %segments37, align 8, !tbaa !17
  %arrayidx38 = getelementptr inbounds %struct.Segment, ptr %9, i64 %j.075
  store float %div, ptr %arrayidx38, align 8, !tbaa !18
...
entry:
  ...
  %0 = load ptr, ptr %segments, align 8, !tbaa !17
...
for.cond.cleanup29:                               ; preds = %for.cond31.for.cond.cleanup35_crit_edge.us, %entry, %for.cond31.preheader.lr.ph, %for.cond25.preheader
  ...
  store i64 %add59, ptr %nbytes, align 8, !tbaa !14
...
entry:
  ...
  %call = tail call ptr @fopen(ptr noundef %fname, ptr noundef nonnull @.str)
  ...
  %ntracks_2D = getelementptr inbounds %struct.Input, ptr %I, i64 0, i32 18
  store i64 0, ptr %ntracks_2D, align 8, !tbaa !5
...
for.cond.for.cond.cleanup_crit_edge:              ; preds = %for.body, %middle.block
  ...
  store i64 %add.lcssa, ptr %ntracks_2D, align 8, !tbaa !5
...
for.cond.cleanup:                                 ; preds = %for.cond.for.cond.cleanup_crit_edge, %entry
  ...
  store i64 %add45, ptr %nbytes, align 8, !tbaa !14
...
for.cond.cleanup52:                               ; preds = %for.cond.cleanup59, %for.cond.cleanup59.us, %for.cond.cleanup
  ...
  %30 = load i64, ptr %nbytes, align 8, !tbaa !14
  %add85 = add i64 %30, %mul82
  store i64 %add85, ptr %nbytes, align 8, !tbaa !14
...
for.cond.cleanup92:                               ; preds = %for.cond.cleanup100, %for.cond.cleanup52
  %38 = load i64, ptr %ntracks_2D, align 8, !tbaa !5
  ...
  %39 = load i64, ptr %ntracks_2D, align 8, !tbaa !5
  %n_polar_angles = getelementptr inbounds %struct.Input, ptr %I, i64 0, i32 8
...
for.body101:                                      ; preds = %for.body101.preheader, %for.cond.cleanup136
  ...
  store i64 %conv116, ptr %n_segments, align 8, !tbaa !15
  ...
  store ptr %arrayidx120, ptr %segments, align 8, !tbaa !17
  %add127 = add i32 %45, %idx.1284
  %call129 = call float @urand() #14
  store float %call129, ptr %arrayidx118, align 8, !tbaa !20
...
for.body137.us:                                   ; preds = %for.body137.lr.ph, %for.body137.us
  ...
  store float %conv144.us, ptr %arrayidx149.us, align 8, !tbaa !18
...
for.body137:                                      ; preds = %for.body137.lr.ph, %for.body137
  ...
  store float %conv144, ptr %arrayidx149, align 8, !tbaa !18
