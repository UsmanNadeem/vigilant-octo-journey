; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/searchAlgorithms.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/DOE-ProxyApps-C/Pathfinder/searchAlgorithms.c"
...
for.end:                                          ; preds = %for.body, %for.inc, %for.inc.us, %if.end32.us, %for.cond.preheader
  %tobool16.lcssa = phi i1 [ false, %for.cond.preheader ], [ %tobool33.not.us, %if.end32.us ], [ %tobool33.not.us, %for.inc.us ], [ %call30, %for.inc ], [ %call30, %for.body ]
...
if.end7:                                          ; preds = %if.end
  ...
  %edge.0270 = load ptr, ptr %edges, align 8, !tbaa !11
  %cmp.not271 = icmp eq ptr %edge.0270, null
  br i1 %cmp.not271, label %for.end234, label %for.body.lr.ph

for.body.lr.ph:                                   ; preds = %if.end7
  %arrayidx205 = getelementptr inbounds ptr, ptr %labels, i64 1
  br label %for.body

for.cond222.preheader:                            ; preds = %for.inc
  %edge.1273.pre = load ptr, ptr %edges, align 8, !tbaa !11
  %cmp223.not274 = icmp eq ptr %edge.1273.pre, null
  br i1 %cmp223.not274, label %for.end234, label %for.body225

for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %edge.0272 = phi ptr [ %edge.0270, %for.body.lr.ph ], [ %edge.0, %for.inc ]
  %targetNode = getelementptr inbounds %struct.EdgeListStruct, ptr %edge.0272, i64 0, i32 1
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %call195 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %8, ptr noundef nonnull dereferenceable(1) %9) #10
  %cmp202 = icmp eq i32 %call195, 0
  br i1 %cmp202, label %if.then204, label %for.inc

if.then204:                                       ; preds = %land.lhs.true
  %10 = load ptr, ptr %arrayidx205, align 8, !tbaa !11
  %cmp206.not = icmp eq ptr %10, null
  br i1 %cmp206.not, label %if.else, label %if.then208

if.then208:                                       ; preds = %if.then204
  %call209 = tail call ptr @NodePtrVec_new(i32 noundef 50) #10
  %11 = load i32, ptr %visited, align 8, !tbaa !36
  %call210 = tail call ptr @Bitfield_new(i32 noundef %11) #10
  %12 = load ptr, ptr %targetNode, align 8, !tbaa !32
  %call213 = tail call zeroext i1 @findNextLabel(ptr noundef %12, ptr noundef nonnull %arrayidx205, ptr noundef %call209, ptr noundef %call210)
  tail call void @Bitfield_delete(ptr noundef %call210) #10
  br i1 %call213, label %if.then215, label %for.inc

if.then215:                                       ; preds = %if.then208
  tail call void @NodePtrVec_appendVectors(ptr noundef nonnull %result, ptr noundef %call209, i1 noundef zeroext true) #10
  tail call void @NodePtrVec_delete(ptr noundef %call209) #10
  br label %cleanup

if.else:                                          ; preds = %if.then204
  %call218 = tail call zeroext i1 @NodePtrVec_push(ptr noundef nonnull %result, ptr noundef nonnull %7) #10
  br label %cleanup

for.inc:                                          ; preds = %for.body, %land.lhs.true, %if.then208
  %nextEdge = getelementptr inbounds %struct.EdgeListStruct, ptr %edge.0272, i64 0, i32 2
  %edge.0 = load ptr, ptr %nextEdge, align 8, !tbaa !11
  %cmp.not = icmp eq ptr %edge.0, null
  br i1 %cmp.not, label %for.cond222.preheader, label %for.body, !llvm.loop !38

for.cond222:                                      ; preds = %for.body225
  %nextEdge233 = getelementptr inbounds %struct.EdgeListStruct, ptr %edge.1275, i64 0, i32 2
  %edge.1 = load ptr, ptr %nextEdge233, align 8, !tbaa !11
  %cmp223.not = icmp eq ptr %edge.1, null
  br i1 %cmp223.not, label %for.end234, label %for.body225, !llvm.loop !39

for.body225:                                      ; preds = %for.cond222.preheader, %for.cond222
  %edge.1275 = phi ptr [ %edge.1, %for.cond222 ], [ %edge.1273.pre, %for.cond222.preheader ]
  %targetNode226 = getelementptr inbounds %struct.EdgeListStruct, ptr %edge.1275, i64 0, i32 1
  %13 = load ptr, ptr %targetNode226, align 8, !tbaa !32
  %call227 = tail call zeroext i1 @findNextLabel(ptr noundef %13, ptr noundef nonnull %labels, ptr noundef nonnull %result, ptr noundef nonnull %visited)
  br i1 %call227, label %cleanup, label %for.cond222

for.end234:                                       ; preds = %for.cond222, %if.end7, %for.cond222.preheader
  %call235 = tail call ptr @NodePtrVec_pop(ptr noundef nonnull %result) #10
  br label %cleanup

cleanup:                                          ; preds = %for.body225, %if.end, %entry, %for.end234, %if.else, %if.then215
  %retval.0 = phi i1 [ true, %if.then215 ], [ true, %if.else ], [ false, %for.end234 ], [ false, %entry ], [ false, %if.end ], [ true, %for.body225 ]
  ret i1 %retval.0
}
...
if.end9:                                          ; preds = %if.end
  ...
  %edges = getelementptr inbounds %struct.NodeStruct, ptr %node, i64 0, i32 7
  %edge.0271 = load ptr, ptr %edges, align 8, !tbaa !11
  %cmp.not272 = icmp eq ptr %edge.0271, null
  br i1 %cmp.not272, label %for.end230, label %for.body.lr.ph

for.body.lr.ph:                                   ; preds = %if.end9
  %arrayidx207 = getelementptr inbounds ptr, ptr %labels, i64 1
  %arrayidx214 = getelementptr inbounds i32, ptr %labelIdxs, i64 1
...
for.body.us:                                      ; preds = %for.body.lr.ph, %for.inc.us
  %edge.0273.us = phi ptr [ %edge.0.us, %for.inc.us ], [ %edge.0271, %for.body.lr.ph ]
  %targetNode.us = getelementptr inbounds %struct.EdgeListStruct, ptr %edge.0273.us, i64 0, i32 1
...
land.lhs.true.us:                                 ; preds = %for.body.us
  %9 = load ptr, ptr %labels, align 8, !tbaa !11
  %call197.us = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %8, ptr noundef nonnull dereferenceable(1) %9) #10
  %cmp204.us = icmp eq i32 %call197.us, 0
  br i1 %cmp204.us, label %if.then206.us, label %for.inc.us

if.then206.us:                                    ; preds = %land.lhs.true.us
  %10 = load ptr, ptr %arrayidx207, align 8, !tbaa !11
  %cmp208.not.us = icmp eq ptr %10, null
  br i1 %cmp208.not.us, label %if.else.us, label %if.then210.us

if.then210.us:                                    ; preds = %if.then206.us
  %11 = load i32, ptr %visited, align 8, !tbaa !36
...
if.else.us:                                       ; preds = %if.then206.us
  %call216.us = tail call zeroext i1 @NodePtrVec_push(ptr noundef nonnull %result, ptr noundef nonnull %7) #10
  %13 = load ptr, ptr %targetNode.us, align 8, !tbaa !32
  %call218.us = tail call zeroext i1 @Bitfield_nodeVisited(ptr noundef nonnull %visited, ptr noundef %13) #10
  %call.i.us = tail call ptr @NodePtrVec_new(i32 noundef 2) #10
  %call219.us = tail call ptr @NodePtrVec_pop(ptr noundef nonnull %result) #10
  br label %for.inc.us

for.inc.us:                                       ; preds = %if.else.us, %if.then210.us, %land.lhs.true.us, %for.body.us
  %nextEdge.us = getelementptr inbounds %struct.EdgeListStruct, ptr %edge.0273.us, i64 0, i32 2
  %edge.0.us = load ptr, ptr %nextEdge.us, align 8, !tbaa !11
  %cmp.not.us = icmp eq ptr %edge.0.us, null
  br i1 %cmp.not.us, label %for.cond223.preheader, label %for.body.us, !llvm.loop !40

for.cond223.preheader:                            ; preds = %for.inc, %for.inc.us
  %edge.1274.pr = load ptr, ptr %edges, align 8, !tbaa !11
  %cmp224.not275 = icmp eq ptr %edge.1274.pr, null
  br i1 %cmp224.not275, label %for.end230, label %for.body226

for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %edge.0273 = phi ptr [ %edge.0, %for.inc ], [ %edge.0271, %for.body.lr.ph ]
  %targetNode = getelementptr inbounds %struct.EdgeListStruct, ptr %edge.0273, i64 0, i32 1
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %call197 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %15, ptr noundef nonnull dereferenceable(1) %16) #10
  %cmp204 = icmp eq i32 %call197, 0
  br i1 %cmp204, label %if.then206, label %for.inc

if.then206:                                       ; preds = %land.lhs.true
  %17 = load ptr, ptr %arrayidx207, align 8, !tbaa !11
  %cmp208.not = icmp eq ptr %17, null
  br i1 %cmp208.not, label %if.else, label %if.then210

if.then210:                                       ; preds = %if.then206
  %18 = load i32, ptr %visited, align 8, !tbaa !36
  %call211 = tail call ptr @Bitfield_new(i32 noundef %18) #10
  %19 = load ptr, ptr %targetNode, align 8, !tbaa !32
  tail call void @findAndRecordAllPaths(ptr noundef %19, ptr noundef nonnull %arrayidx207, ptr noundef nonnull %arrayidx214, ptr noundef nonnull %result, ptr noundef %call211, ptr noundef nonnull %storage, ptr noundef %options)
  tail call void @Bitfield_delete(ptr noundef %call211) #10
  br label %for.inc

if.else:                                          ; preds = %if.then206
  %call216 = tail call zeroext i1 @NodePtrVec_push(ptr noundef nonnull %result, ptr noundef nonnull %14) #10
  %20 = load ptr, ptr %targetNode, align 8, !tbaa !32
  %call218 = tail call zeroext i1 @Bitfield_nodeVisited(ptr noundef nonnull %visited, ptr noundef %20) #10
...
logResult.exit:                                   ; preds = %if.else, %if.end16.i
  %call219 = tail call ptr @NodePtrVec_pop(ptr noundef nonnull %result) #10
  br label %for.inc

for.inc:                                          ; preds = %for.body, %land.lhs.true, %logResult.exit, %if.then210
  %nextEdge = getelementptr inbounds %struct.EdgeListStruct, ptr %edge.0273, i64 0, i32 2
  %edge.0 = load ptr, ptr %nextEdge, align 8, !tbaa !11
  %cmp.not = icmp eq ptr %edge.0, null
  br i1 %cmp.not, label %for.cond223.preheader, label %for.body, !llvm.loop !40

for.body226:                                      ; preds = %for.cond223.preheader, %for.body226
  %edge.1276 = phi ptr [ %edge.1, %for.body226 ], [ %edge.1274.pr, %for.cond223.preheader ]
  %targetNode227 = getelementptr inbounds %struct.EdgeListStruct, ptr %edge.1276, i64 0, i32 1
  %31 = load ptr, ptr %targetNode227, align 8, !tbaa !32
  ...
  %nextEdge229 = getelementptr inbounds %struct.EdgeListStruct, ptr %edge.1276, i64 0, i32 2
  %edge.1 = load ptr, ptr %nextEdge229, align 8, !tbaa !11
  %cmp224.not = icmp eq ptr %edge.1, null
  br i1 %cmp224.not, label %for.end230, label %for.body226, !llvm.loop !45

for.end230:                                       ; preds = %for.body226, %if.end9, %for.cond223.preheader
  %call231 = tail call ptr @NodePtrVec_pop(ptr noundef nonnull %result) #10
  br label %cleanup

cleanup:                                          ; preds = %if.end, %entry, %for.end230
  ret void
}
...
; Function Attrs: nounwind uwtable
define dso_local i32 @findAllPossibleLegs(ptr noundef readonly %graph, i32 noundef %searchType) local_unnamed_addr #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %call2 = tail call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #11
