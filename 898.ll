; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/rdgif.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/rdgif.c"
...
for.cond:                                         ; preds = %for.cond.backedge, %if.end112
  ...
  %call.i = tail call i32 @_IO_getc(ptr noundef %24)
...
if.then124:                                       ; preds = %for.cond
  ...
  %call.i.i = tail call i32 @_IO_getc(ptr noundef %26)
...
while.cond.i.i:                                   ; preds = %GetDataBlock.exit.i.i, %ReadByte.exit.i
  ...
  %call.i.i.i.i = tail call i32 @_IO_getc(ptr noundef %35)
...
if.end178:                                        ; preds = %if.then172, %if.end148
  ...
  %call.i349 = tail call i32 @_IO_getc(ptr noundef %55)
...
ReadByte.exit:                                    ; preds = %for.body, %if.then.i
  ...
  %call.i21 = tail call i32 @_IO_getc(ptr noundef %5)
...
ReadByte.exit26:                                  ; preds = %ReadByte.exit, %if.then.i25
  ...
  %call.i28 = tail call i32 @_IO_getc(ptr noundef %10)
...
if.end4.thread:                                   ; preds = %entry
  ...
  %clear_code5168 = getelementptr inbounds %struct.gif_source_struct, ptr %sinfo, i64 0, i32 9
  br label %if.then8
...
if.then8:                                         ; preds = %if.end4.thread, %if.end4
  %clear_code5170 = phi ptr [ %clear_code5168, %if.end4.thread ], [ %clear_code5, %if.end4 ]
...
do.body:                                          ; preds = %do.body, %if.then8
  ...
  %8 = load i32, ptr %clear_code5170, align 8, !tbaa !39
...
while.cond.i:                                     ; preds = %GetDataBlock.exit.i, %if.then26
  ...
  %call.i.i.i = tail call i32 @_IO_getc(ptr noundef %14)
...
while.body:                                       ; preds = %while.body.lr.ph, %while.body
  ...
  br i1 %cmp59.not, label %while.end.loopexit, label %while.body, !llvm.loop !80

while.end.loopexit:                               ; preds = %while.body
  %conv65.le = zext i16 %33 to i32
  br label %while.end

while.end:                                        ; preds = %while.end.loopexit, %if.end57
  %code.3.lcssa = phi i32 [ %code.2, %if.end57 ], [ %conv65.le, %while.end.loopexit ]
