; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/ldecod/erc_api.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/ldecod/erc_api.c"
...
define dso_local void @ercMarkCurrSegmentLost(i32 noundef %picSizeX, ptr noundef %errorVar) local_unnamed_addr #9 {
land.lhs.true:
  %currSegment = getelementptr inbounds %struct.ercVariables_s, ptr %errorVar, i64 0, i32 6
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  store <2 x i32> <i32 1, i32 1>, ptr %arrayidx14, align 4, !tbaa !28
  %add33 = or i32 %shl, 1
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @ercMarkCurrSegmentOK(i32 noundef %picSizeX, ptr noundef readonly %errorVar) local_unnamed_addr #9 {
land.lhs.true:
  %concealment = getelementptr inbounds %struct.ercVariables_s, ptr %errorVar, i64 0, i32 10
  %0 = load i32, ptr %concealment, align 8, !tbaa !13
  %tobool1.not = icmp eq i32 %0, 0
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  store <2 x i32> <i32 3, i32 3>, ptr %arrayidx11, align 4, !tbaa !28
  %add30 = or i32 %shl, 1
...
sw.bb:                                            ; preds = %if.then
  ...
  store <2 x i32> <i32 2, i32 2>, ptr %arrayidx, align 4, !tbaa !28
  %add26 = or i32 %shl, 1
