; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/sharing.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/sharing.c"
...
entry:
  ...
  %uglygep = getelementptr i8, ptr %call, i64 8
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(56008) %uglygep, i8 0, i64 56008, i1 false)
...
entry:
  ...
  %RealSize.1.i.i.i = select i1 %tobool3.not.i.i.i, i32 56024, i32 %sub6.i.i.i.op
...
entry:
  ...
  %cmp.i.i = icmp slt i32 %Term.val11, 1
...
if.end.i.i:                                       ; preds = %while.body.i.i
  ...
  br i1 %cmp.i.not.i.i, label %if.then, label %while.body.i.i, !llvm.loop !8

if.then:                                          ; preds = %if.end.i.i, %land.lhs.true
  %1 = getelementptr i8, ptr %Term, i64 16
  %ArgList.018 = load ptr, ptr %1, align 8
  %cmp.i.not19 = icmp eq ptr %ArgList.018, null
  br i1 %cmp.i.not19, label %while.end, label %while.body

while.body:                                       ; preds = %if.then, %while.body
  %ArgList.020 = phi ptr [ %ArgList.0, %while.body ], [ %ArgList.018, %if.then ]
  %2 = getelementptr i8, ptr %ArgList.020, i64 8
  %ArgList.0.val = load ptr, ptr %2, align 8
...
entry:
  ...
  %cmp.i.i = icmp slt i32 %Term.val14, 1
  br i1 %cmp.i.i, label %land.lhs.true, label %if.end
...
land.lhs.true:                                    ; preds = %entry
  ...
  %cmp.i.not = icmp eq i32 %1, %Term.val15
...
entry:
  ...
  %cmp.i.not249.i = icmp eq i32 %1, %0
  br i1 %cmp.i.not249.i, label %sharing_InsertIntoSharing.exit, label %while.body.lr.ph.i
...
while.body.i:                                     ; preds = %if.end104.i, %while.body.lr.ph.i
  %4 = phi i32 [ %1, %while.body.lr.ph.i ], [ %27, %if.end104.i ]
  %dec.i.i = add i32 %4, -1
  ...
  %cmp.i.i.i = icmp slt i32 %call3.val174.i, 1
...
if.else.i:                                        ; preds = %while.body.i
  ...
  br i1 %cmp.i.not.i.i, label %term_IsConstant.exit.i, label %if.else40.i

term_IsConstant.exit.i:                           ; preds = %if.else.i
  ...
  br i1 %cmp.i204.not.i, label %if.then26.i, label %if.end104.i

if.then26.i:                                      ; preds = %term_IsConstant.exit.i
  ...
  %.pre252.i = sub nsw i32 0, %call3.val180.pre.i
  %.pre253.i = ashr i32 %.pre252.i, %3
  %.pre254.i = zext i32 %.pre253.i to i64
  %arrayidx.i219.i.phi.trans.insert = getelementptr inbounds %struct.SHARED_INDEX_NODE, ptr %SharedIndex, i64 0, i32 2, i64 %.pre254.i
  %.pre = load ptr, ptr %arrayidx.i219.i.phi.trans.insert, align 8
  br label %if.end104.i

if.else40.i:                                      ; preds = %if.else.i
  %13 = getelementptr i8, ptr %T.val4.i.i, i64 8
  %call3.val189.val.i = load ptr, ptr %13, align 8
  %14 = getelementptr i8, ptr %call3.val189.val.i, i64 8
  %call41.val.i = load ptr, ptr %14, align 8
  %15 = getelementptr i8, ptr %call41.val.i, i64 8
  %call42.val.i = load ptr, ptr %15, align 8
  %cmp.i221.not.i = icmp eq ptr %call42.val.i, null
  br i1 %cmp.i221.not.i, label %if.then86.i, label %while.body56.i

while.body56.i:                                   ; preds = %if.else40.i, %if.end75.i
  %HelpList.0245.i7 = phi ptr [ %HelpList.0.val.i, %if.end75.i ], [ %call42.val.i, %if.else40.i ]
  %16 = getelementptr i8, ptr %HelpList.0245.i7, i64 8
  %HelpList.0.val188.i = load ptr, ptr %16, align 8
  %call57.val170.i = load i32, ptr %HelpList.0.val188.i, align 8
  %cmp.i = icmp eq i32 %call57.val170.i, %call3.val174.i
  br i1 %cmp.i, label %if.then60.i, label %if.end75.i

if.then60.i:                                      ; preds = %while.body56.i
  %17 = getelementptr i8, ptr %HelpList.0.val188.i, i64 16
  br label %land.rhs66.i

land.rhs66.i:                                     ; preds = %while.body72.i, %if.then60.i
  %DuplHelpArgList.0243.in.i = phi ptr [ %17, %if.then60.i ], [ %DuplHelpArgList.0243.i, %while.body72.i ]
  %OrigHelpArgList.0242.i = phi ptr [ %T.val4.i.i, %if.then60.i ], [ %OrigHelpArgList.0.val.i, %while.body72.i ]
  %DuplHelpArgList.0243.i = load ptr, ptr %DuplHelpArgList.0243.in.i, align 8
  %18 = getelementptr i8, ptr %OrigHelpArgList.0242.i, i64 8
  %OrigHelpArgList.0.val187.i = load ptr, ptr %18, align 8
  %19 = getelementptr i8, ptr %OrigHelpArgList.0.val187.i, i64 8
  %call67.val.i = load ptr, ptr %19, align 8
  %20 = getelementptr i8, ptr %DuplHelpArgList.0243.i, i64 8
  %DuplHelpArgList.0.val186.i = load ptr, ptr %20, align 8
  %cmp70.not.i = icmp eq ptr %call67.val.i, %DuplHelpArgList.0.val186.i
  br i1 %cmp70.not.i, label %while.body72.i, label %if.end75.i

while.body72.i:                                   ; preds = %land.rhs66.i
  %OrigHelpArgList.0.val.i = load ptr, ptr %OrigHelpArgList.0242.i, align 8
  %cmp.i225.not.i = icmp eq ptr %OrigHelpArgList.0.val.i, null
  br i1 %cmp.i225.not.i, label %if.end104.i, label %land.rhs66.i, !llvm.loop !15

if.end75.i:                                       ; preds = %land.rhs66.i, %while.body56.i
  %HelpList.0.val.i = load ptr, ptr %HelpList.0245.i7, align 8
  %cmp.i223.not.i = icmp eq ptr %HelpList.0.val.i, null
  br i1 %cmp.i223.not.i, label %if.then86.i, label %while.body56.i
...
if.then86.i:                                      ; preds = %if.end75.i, %if.else40.i
  ...
  %HelpList.1246.i = load ptr, ptr %9, align 8
  %cmp.i227.not247.i = icmp eq ptr %HelpList.1246.i, null
  br i1 %cmp.i227.not247.i, label %for.end.i, label %for.body.lr.ph.i

for.body.lr.ph.i:                                 ; preds = %if.then86.i
  %21 = getelementptr i8, ptr %call49.i, i64 16
  br label %for.body.i

for.body.i:                                       ; preds = %for.body.i, %for.body.lr.ph.i
  %HelpList.1248.i = phi ptr [ %HelpList.1246.i, %for.body.lr.ph.i ], [ %HelpList.1.i, %for.body.i ]
  %22 = getelementptr i8, ptr %HelpList.1248.i, i64 8
  %HelpList.1.val185.i = load ptr, ptr %22, align 8
  %23 = getelementptr i8, ptr %HelpList.1.val185.i, i64 8
  %call91.val.i = load ptr, ptr %23, align 8
  %SharedDuplicate.1.val166.i = load ptr, ptr %21, align 8
  ...
  %24 = getelementptr i8, ptr %call91.val.i, i64 8
  %call92.val.i = load ptr, ptr %24, align 8
  ...
  store ptr %call.i229.i, ptr %24, align 8
  %HelpList.1.i = load ptr, ptr %HelpList.1248.i, align 8
  %cmp.i227.not.i = icmp eq ptr %HelpList.1.i, null
  br i1 %cmp.i227.not.i, label %for.end.i, label %for.body.i, !llvm.loop !16

for.end.i:                                        ; preds = %for.body.i, %if.then86.i
  %25 = getelementptr i8, ptr %call49.i, i64 16
  %SharedDuplicate.1.val.i = load ptr, ptr %25, align 8
  %call99.i = tail call ptr @list_NReverse(ptr noundef %SharedDuplicate.1.val.i) #10
  store ptr %call99.i, ptr %25, align 8
  %SharedIndex.val.i = load ptr, ptr %SharedIndex, align 8
  %26 = load ptr, ptr @cont_LEFTCONTEXT, align 8
  tail call void @st_EntryCreate(ptr noundef %SharedIndex.val.i, ptr noundef %call49.i, ptr noundef %call49.i, ptr noundef %26) #10
  br label %if.end104.i

if.end104.i:                                      ; preds = %while.body72.i, %term_IsConstant.exit.i, %if.then26.i, %for.end.i, %if.then8.i, %if.then.i
  %.sink.i = phi ptr [ %.pre.i, %if.then8.i ], [ %6, %if.then.i ], [ %call49.i, %for.end.i ], [ %.pre, %if.then26.i ], [ %10, %term_IsConstant.exit.i ], [ %HelpList.0.val188.i, %while.body72.i ]
  ...
  br i1 %cmp.i.not.i, label %sharing_InsertIntoSharing.exit, label %while.body.i, !llvm.loop !17

sharing_InsertIntoSharing.exit:                   ; preds = %if.end104.i, %entry
  %InsTerm.0.lcssa.i = phi ptr [ %2, %entry ], [ %5, %if.end104.i ]
  %28 = getelementptr i8, ptr %InsTerm.0.lcssa.i, i64 8
  %InsTerm.0.val.i = load ptr, ptr %28, align 8
  %29 = getelementptr i8, ptr %InsTerm.0.val.i, i64 8
  %call.val = load ptr, ptr %29, align 8
...
entry:
  ...
  %cmp.i.i.not = icmp eq ptr %call1, null
...
entry:
  ...
  br i1 %cmp.i.not, label %term_IsConstant.exit, label %while.body

while.body:                                       ; preds = %entry, %if.end
  %Args.058 = phi ptr [ %Args.0.val, %if.end ], [ %Term.val42, %entry ]
  %2 = getelementptr i8, ptr %Args.058, i64 8
  %Args.0.val44 = load ptr, ptr %2, align 8
  %Args.0.val = load ptr, ptr %Args.058, align 8
  ...
  br i1 %cmp.i.i.not, label %if.then13, label %if.end
...
if.end:                                           ; preds = %if.then13, %while.body
  ...
  br i1 %cmp.i47.not, label %if.end21, label %while.body, !llvm.loop !18

term_IsConstant.exit:                             ; preds = %entry
...
if.end21:                                         ; preds = %if.end, %term_IsConstant.exit
...
while.body.i:                                     ; preds = %if.end21, %while.body.i
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i ], [ %Term.val45, %if.end21 ]
  ...
  %cmp.i.not.i51 = icmp eq ptr %Current.0.val.i, null
  br i1 %cmp.i.not.i51, label %list_Delete.exit, label %while.body.i, !llvm.loop !19
...
for.inc.i:                                        ; preds = %if.then.i, %for.body.i
  ...
  br i1 %exitcond.not.i, label %for.body6.i, label %for.body.i, !llvm.loop !20
...
for.inc11.i:                                      ; preds = %if.then9.i, %for.body6.i
  ...
  br i1 %exitcond31.not.i, label %if.end, label %for.body6.i, !llvm.loop !21
...
for.inc:                                          ; preds = %for.body, %if.then
  ...
  br i1 %exitcond.not, label %for.body6, label %for.body, !llvm.loop !20
...
for.inc11:                                        ; preds = %for.body6, %if.then9
  ...
  br i1 %exitcond31.not, label %for.end13, label %for.body6, !llvm.loop !21
...
if.then:                                          ; preds = %term_IsAtom.exit
  ...
  %Term.val23 = load ptr, ptr %1, align 8
  %call2 = tail call ptr @list_Copy(ptr noundef %Term.val23) #10
  br label %return

if.else:                                          ; preds = %entry, %term_IsAtom.exit
  %2 = getelementptr i8, ptr %Term, i64 8
  %SuperList.028 = load ptr, ptr %2, align 8
  %cmp.i.not29 = icmp eq ptr %SuperList.028, null
  br i1 %cmp.i.not29, label %return, label %for.body.preheader
...
for.body:                                         ; preds = %for.body.preheader, %if.end
  %3 = phi i32 [ %7, %if.end ], [ %.pre, %for.body.preheader ]
  %SuperList.031 = phi ptr [ %SuperList.0, %if.end ], [ %SuperList.028, %for.body.preheader ]
  %DataList.030 = phi ptr [ %DataList.1, %if.end ], [ null, %for.body.preheader ]
  %4 = getelementptr i8, ptr %SuperList.031, i64 8
  %SuperList.0.val = load ptr, ptr %4, align 8
  %5 = getelementptr i8, ptr %SuperList.0.val, i64 24
  %call7.val = load i32, ptr %5, align 8
  %cmp.i24.not = icmp eq i32 %3, %call7.val
  br i1 %cmp.i24.not, label %if.end, label %if.then10
...
if.end.i:                                         ; preds = %if.then10
  %cmp.i18.not.i = icmp eq ptr %DataList.030, null
...
for.cond.i:                                       ; preds = %if.end.i, %for.cond.i
  ...
  br i1 %cmp.i20.not.i, label %for.end.i, label %for.cond.i, !llvm.loop !22

for.end.i:                                        ; preds = %for.cond.i
  store ptr %DataList.030, ptr %List1.addr.0.i, align 8
  br label %list_Nconc.exit

list_Nconc.exit:                                  ; preds = %if.then10, %if.end.i, %for.end.i
  %retval.0.i = phi ptr [ %call11, %for.end.i ], [ %DataList.030, %if.then10 ], [ %call11, %if.end.i ]
  %6 = load i32, ptr @term_STAMP, align 4
  store i32 %6, ptr %5, align 8
  br label %if.end

if.end:                                           ; preds = %list_Nconc.exit, %for.body
  %7 = phi i32 [ %3, %for.body ], [ %6, %list_Nconc.exit ]
  %DataList.1 = phi ptr [ %DataList.030, %for.body ], [ %retval.0.i, %list_Nconc.exit ]
  %SuperList.0 = load ptr, ptr %SuperList.031, align 8
...
entry:
  ...
  br i1 %cmp.i.not, label %while.cond.preheader, label %if.end54.sink.split

while.cond.preheader:                             ; preds = %entry
  %sharing_STACKPOINTER.promoted100 = load ptr, ptr @sharing_STACKPOINTER, align 8
  %cmp104 = icmp ugt ptr %sharing_STACKPOINTER.promoted100, @sharing_STACK
  br i1 %cmp104, label %do.body.preheader.lr.ph, label %if.end54
...
do.body.preheader:                                ; preds = %do.body.preheader.lr.ph, %while.end44
  ...
  %sharing_STACKPOINTER.promoted94101105 = phi ptr [ %sharing_STACKPOINTER.promoted100, %do.body.preheader.lr.ph ], [ %sharing_STACKPOINTER.promoted94102, %while.end44 ]
  br label %do.body

do.body:                                          ; preds = %do.body.preheader, %do.cond15
  %incdec.ptr93 = phi ptr [ %sharing_STACKPOINTER.promoted94101105, %do.body.preheader ], [ %incdec.ptr, %do.cond15 ]
  %incdec.ptr = getelementptr inbounds ptr, ptr %incdec.ptr93, i64 -1
  store ptr %incdec.ptr, ptr @sharing_STACKPOINTER, align 8
...
do.body6:                                         ; preds = %land.rhs10, %do.body
  ...
  %cmp.i77.not = icmp ne ptr %superlist.1.val, null
  br i1 %cmp.i77.not, label %land.rhs10, label %do.cond15
...
land.rhs10:                                       ; preds = %do.body6
  ...
  %cmp.i79.not = icmp eq i32 %2, %call11.val
  br i1 %cmp.i79.not, label %do.body6, label %land.rhs25, !llvm.loop !25

do.cond15:                                        ; preds = %do.body6
  %cmp16 = icmp ule ptr %incdec.ptr, @sharing_STACK
  %brmerge = or i1 %cmp16, %cmp.i77.not
  br i1 %brmerge, label %while.end44, label %do.body

land.rhs25:                                       ; preds = %land.rhs10, %while.end
  %superlist.298 = phi ptr [ %superlist.3, %while.end ], [ %superlist.1.val, %land.rhs10 ]
  %incdec.ptr319597 = phi ptr [ %incdec.ptr31, %while.end ], [ %incdec.ptr, %land.rhs10 ]
  %7 = getelementptr i8, ptr %superlist.298, i64 8
...
while.body30:                                     ; preds = %land.rhs25, %term_IsAtom.exit
  %incdec.ptr31 = getelementptr inbounds ptr, ptr %incdec.ptr319597, i64 1
  store ptr %incdec.ptr31, ptr @sharing_STACKPOINTER, align 8
  store ptr %superlist.298, ptr %incdec.ptr319597, align 8
...
while.cond34:                                     ; preds = %land.rhs37, %while.body30
  ...
  %cmp.i85.not = icmp eq ptr %superlist.3, null
  br i1 %cmp.i85.not, label %while.end44, label %land.rhs37
...
land.rhs37:                                       ; preds = %while.cond34
  ...
  %cmp.i87.not = icmp eq i32 %9, %call38.val
  br i1 %cmp.i87.not, label %while.cond34, label %while.end, !llvm.loop !26

while.end:                                        ; preds = %land.rhs37
  br label %land.rhs25, !llvm.loop !27

while.end44:                                      ; preds = %do.cond15, %while.cond34
  %12 = phi i32 [ %9, %while.cond34 ], [ %2, %do.cond15 ]
  %sharing_STACKPOINTER.promoted94102 = phi ptr [ %incdec.ptr31, %while.cond34 ], [ %incdec.ptr, %do.cond15 ]
  %cmp = icmp ugt ptr %sharing_STACKPOINTER.promoted94102, @sharing_STACK
  br i1 %cmp, label %do.body.preheader, label %if.end54, !llvm.loop !28

if.then48:                                        ; preds = %term_IsAtom.exit
  %incdec.ptr49 = getelementptr inbounds ptr, ptr %incdec.ptr319597, i64 1
  store ptr %incdec.ptr49, ptr @sharing_STACKPOINTER, align 8
  store ptr %superlist.298, ptr %incdec.ptr319597, align 8
  %13 = getelementptr i8, ptr %superlist.298, i64 8
...
if.end.i:                                         ; preds = %if.then6
  %cmp.i18.not.i = icmp eq ptr %Result.049, null
...
for.inc:                                          ; preds = %for.end.i, %if.end.i, %if.then6, %for.body
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, 3001
  br i1 %exitcond.not, label %for.body13, label %for.body, !llvm.loop !29
...
if.then16:                                        ; preds = %for.body13
  ...
  %cmp.i.not.i38 = icmp eq ptr %call17, null
  br i1 %cmp.i.not.i38, label %for.inc20, label %if.end.i40

if.end.i40:                                       ; preds = %if.then16
  %cmp.i18.not.i39 = icmp eq ptr %Result.251, null
  br i1 %cmp.i18.not.i39, label %for.inc20, label %for.cond.i44
...
for.cond.i44:                                     ; preds = %if.end.i40, %for.cond.i44
  ...
  br i1 %cmp.i20.not.i43, label %for.end.i45, label %for.cond.i44, !llvm.loop !22
...
for.inc20:                                        ; preds = %for.end.i45, %if.end.i40, %if.then16, %for.body13
  ...
  br i1 %exitcond56.not, label %for.end22, label %for.body13, !llvm.loop !30
...
term_IsAtom.exit:                                 ; preds = %entry
  ...
  %and.i.i.i = and i32 %0, %sub.i.i.i
  %cmp.i.i.not = icmp eq i32 %and.i.i.i, 2
  br i1 %cmp.i.i.not, label %if.end9, label %if.then

if.then:                                          ; preds = %entry, %term_IsAtom.exit
  %1 = getelementptr i8, ptr %Term, i64 8
  %SuperList.021 = load ptr, ptr %1, align 8
  %cmp.i.not22 = icmp eq ptr %SuperList.021, null
  br i1 %cmp.i.not22, label %if.end9, label %for.body

for.body:                                         ; preds = %if.then, %for.inc
  %SuperList.023 = phi ptr [ %SuperList.0, %for.inc ], [ %SuperList.021, %if.then ]
  %2 = getelementptr i8, ptr %SuperList.023, i64 8
  %SuperList.0.val = load ptr, ptr %2, align 8
  %3 = getelementptr i8, ptr %SuperList.0.val, i64 24
  %call4.val = load i32, ptr %3, align 8
  %cmp.i17.not = icmp eq i32 %call4.val, 0
  br i1 %cmp.i17.not, label %for.inc, label %if.then7
...
for.inc:                                          ; preds = %for.body, %if.then7
  %SuperList.0 = load ptr, ptr %SuperList.023, align 8
  %cmp.i.not = icmp eq ptr %SuperList.0, null
  br i1 %cmp.i.not, label %if.end9, label %for.body, !llvm.loop !31

if.end9:                                          ; preds = %for.inc, %if.then, %term_IsAtom.exit
  ret void
}
...
if.then:                                          ; preds = %term_IsAtom.exit
  %1 = getelementptr i8, ptr %Term, i64 8
  %Term.val16 = load ptr, ptr %1, align 8
  %call2 = tail call i32 @list_Length(ptr noundef %Term.val16) #10
  br label %return

if.else:                                          ; preds = %entry, %term_IsAtom.exit
  %2 = getelementptr i8, ptr %Term, i64 8
  %Scan.019 = load ptr, ptr %2, align 8
  %cmp.i.not20 = icmp eq ptr %Scan.019, null
  br i1 %cmp.i.not20, label %return, label %for.body

for.body:                                         ; preds = %if.else, %for.body
  %Scan.022 = phi ptr [ %Scan.0, %for.body ], [ %Scan.019, %if.else ]
  %Result.021 = phi i32 [ %add, %for.body ], [ 0, %if.else ]
...
for.inc16:                                        ; preds = %for.body9, %if.then12
  ...
  br i1 %exitcond41.not, label %for.end18, label %for.body9, !llvm.loop !39
...
if.else:                                          ; preds = %entry, %term_IsAtom.exit
  ...
  br i1 %cmp.i.not, label %if.end12, label %if.then5

if.then5:                                         ; preds = %if.else
  %3 = load ptr, ptr @stdout, align 8
  %call.i22 = tail call i32 @_IO_putc(i32 noundef 91, ptr noundef %3)
...
while.body:                                       ; preds = %if.then5, %while.body
  %HelpList.028 = phi ptr [ %Term.val, %if.then5 ], [ %HelpList.0.val20, %while.body ]
  %4 = getelementptr i8, ptr %HelpList.028, i64 8
  %HelpList.0.val = load ptr, ptr %4, align 8
  tail call fastcc void @sharing_PrintWithSuperterms(ptr noundef %HelpList.0.val)
  %HelpList.0.val20 = load ptr, ptr %HelpList.028, align 8
  %cmp.i23.not = icmp eq ptr %HelpList.0.val20, null
  br i1 %cmp.i23.not, label %if.end12, label %while.body, !llvm.loop !40
...
while.body:                                       ; preds = %entry, %if.end
  ...
  %cmp.i14.not = icmp eq ptr %call2.val, null
...
if.end:                                           ; preds = %if.then, %while.body
  ...
  br i1 %cmp.i.not, label %while.end, label %while.body, !llvm.loop !41
...
while.body:                                       ; preds = %entry, %while.body
  ...
  %3 = load ptr, ptr @stdout, align 8
  %call.i = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %3)
