; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/d/lr.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/d/lr.c"
...
for.end39.i49:                                    ; preds = %goto_State.exit.i, %if.then.i
  ...
  %or.cond.i = select i1 %tobool40.not.i, i1 true, i1 %tobool43.not.i
...
build_right_epsilon_hints.exit:                   ; preds = %for.inc130.i
  ...
  br i1 %123, label %build_error_recovery.exit, label %for.body.lr.ph.i58

for.body.lr.ph.i58:                               ; preds = %build_right_epsilon_hints.exit
  %v.i57 = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 3, i32 2
  br label %for.body.i61

for.body.i61:                                     ; preds = %for.end342.i, %for.body.lr.ph.i58
  %indvars.iv426.i = phi i64 [ 0, %for.body.lr.ph.i58 ], [ %indvars.iv.next427.i, %for.end342.i ]
  %124 = load ptr, ptr %v.i57, align 8, !tbaa !49
  %arrayidx.i59 = getelementptr inbounds ptr, ptr %124, i64 %indvars.iv426.i
  %125 = load ptr, ptr %arrayidx.i59, align 8, !tbaa !22
  %items.i60 = getelementptr inbounds %struct.State, ptr %125, i64 0, i32 2
  %126 = load i32, ptr %items.i60, align 8, !tbaa !44
  %cmp4417.not.i = icmp eq i32 %126, 0
  br i1 %cmp4417.not.i, label %for.end342.i, label %for.body5.lr.ph.i63

for.body5.lr.ph.i63:                              ; preds = %for.body.i61
  %v7.i62 = getelementptr inbounds %struct.State, ptr %125, i64 0, i32 2, i32 2
  ...
  %e302.i = getelementptr inbounds %struct.State, ptr %125, i64 0, i32 8, i32 3
  br label %for.body5.i67

for.body5.i67:                                    ; preds = %for.inc340.i, %for.body5.lr.ph.i63
  %127 = phi i32 [ %126, %for.body5.lr.ph.i63 ], [ %150, %for.inc340.i ]
  %indvars.iv423.i = phi i64 [ 0, %for.body5.lr.ph.i63 ], [ %indvars.iv.next424.i, %for.inc340.i ]
  %128 = load ptr, ptr %v7.i62, align 8, !tbaa !43
  %arrayidx9.i64 = getelementptr inbounds ptr, ptr %128, i64 %indvars.iv423.i
  %129 = load ptr, ptr %arrayidx9.i64, align 8, !tbaa !22
  %rule.i65 = getelementptr inbounds %struct.Elem, ptr %129, i64 0, i32 2
  %130 = load ptr, ptr %rule.i65, align 8, !tbaa !62
  %elems.i66 = getelementptr inbounds %struct.Rule, ptr %130, i64 0, i32 6
  %131 = load i32, ptr %elems.i66, align 8, !tbaa !70
  %cmp11.i = icmp ugt i32 %131, 1
  br i1 %cmp11.i, label %land.lhs.true.i, label %for.inc340.i

land.lhs.true.i:                                  ; preds = %for.body5.i67
  ...
  br i1 %cmp18.i, label %land.lhs.true19.i, label %for.inc340.i
...
land.lhs.true19.i:                                ; preds = %land.lhs.true.i
  ...
  br i1 %cmp29.i, label %if.then.i70, label %for.inc340.i

if.then.i70:                                      ; preds = %land.lhs.true19.i
  %index.i68 = getelementptr inbounds %struct.Elem, ptr %129, i64 0, i32 1
  %137 = load i32, ptr %index.i68, align 4, !tbaa !69
  %138 = load i32, ptr %error_recovery_hints.i, align 8, !tbaa !83
  %cmp43415.not.i = icmp eq i32 %138, 0
  %.pre.i69 = load ptr, ptr %v46.i, align 8, !tbaa !84
  br i1 %cmp43415.not.i, label %do.body.i75, label %for.body44.lr.ph.i

for.body44.lr.ph.i:                               ; preds = %if.then.i70
  %string_len.i = getelementptr inbounds %struct.Term, ptr %135, i64 0, i32 6
  %139 = load i32, ptr %string_len.i, align 8, !tbaa !85
  %string259.i = getelementptr inbounds %struct.Term, ptr %135, i64 0, i32 5
  %wide.trip.count.i = zext i32 %138 to i64
  br label %for.body44.i

for.body44.i:                                     ; preds = %for.inc.i74, %for.body44.lr.ph.i
  %indvars.iv.i71 = phi i64 [ 0, %for.body44.lr.ph.i ], [ %indvars.iv.next.i73, %for.inc.i74 ]
  %arrayidx48.i = getelementptr inbounds ptr, ptr %.pre.i69, i64 %indvars.iv.i71
  ...
  br i1 %cmp60.i, label %land.lhs.true61.i, label %for.inc.i74

land.lhs.true61.i:                                ; preds = %for.body44.i
  %147 = load ptr, ptr %string259.i, align 8, !tbaa !86
  %string261.i = getelementptr inbounds %struct.Term, ptr %145, i64 0, i32 5
  %148 = load ptr, ptr %string261.i, align 8, !tbaa !86
  %call262.i = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %147, ptr noundef nonnull dereferenceable(1) %148) #12
  %tobool.not.i72 = icmp eq i32 %call262.i, 0
  br i1 %tobool.not.i72, label %if.then269.i, label %for.inc.i74

if.then269.i:                                     ; preds = %land.lhs.true61.i
  %149 = load i32, ptr %140, align 8, !tbaa !75
  %cmp275.i = icmp ugt i32 %149, %137
  br i1 %cmp275.i, label %if.then277.i, label %for.inc340.i

if.then277.i:                                     ; preds = %if.then269.i
  store i32 %137, ptr %140, align 8, !tbaa !75
  br label %for.inc340.i

for.inc.i74:                                      ; preds = %land.lhs.true61.i, %for.body44.i
  %indvars.iv.next.i73 = add nuw nsw i64 %indvars.iv.i71, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i73, %wide.trip.count.i
  br i1 %exitcond.not.i, label %if.else.i79, label %for.body44.i, !llvm.loop !87

do.body.i75:                                      ; preds = %if.then.i70
  %tobool287.not.i = icmp eq ptr %.pre.i69, null
  br i1 %tobool287.not.i, label %if.then288.i, label %if.else.thread.i

if.then288.i:                                     ; preds = %do.body.i75
  %call.i.i76 = tail call noalias dereferenceable_or_null(24) ptr @malloc(i64 noundef 24) #13
  store i32 %137, ptr %call.i.i76, align 8, !tbaa !75
  %state.i.i77 = getelementptr inbounds %struct.Hint, ptr %call.i.i76, i64 0, i32 1
  store ptr null, ptr %state.i.i77, align 8, !tbaa !77
  %rule.i.i78 = getelementptr inbounds %struct.Hint, ptr %call.i.i76, i64 0, i32 2
  store ptr %130, ptr %rule.i.i78, align 8, !tbaa !78
  store ptr %e302.i, ptr %v46.i, align 8, !tbaa !84
  store i32 1, ptr %error_recovery_hints.i, align 8, !tbaa !83
  store ptr %call.i.i76, ptr %e302.i, align 8, !tbaa !22
  br label %for.inc340.i

if.else.i79:                                      ; preds = %for.inc.i74
  %cmp304.i = icmp eq ptr %.pre.i69, %e302.i
  br i1 %cmp304.i, label %if.then306.i, label %if.else321.i

if.else.thread.i:                                 ; preds = %do.body.i75
  %cmp304431.i = icmp eq ptr %.pre.i69, %e302.i
  br i1 %cmp304431.i, label %if.then311.i, label %if.end336.i

if.then306.i:                                     ; preds = %if.else.i79
  %cmp309.i = icmp ult i32 %138, 3
  br i1 %cmp309.i, label %if.then311.i, label %if.end336.i

if.then311.i:                                     ; preds = %if.else.thread.i, %if.then306.i
  %idxprom318.i.pre-phi = phi i64 [ %wide.trip.count.i, %if.then306.i ], [ 0, %if.else.thread.i ]
  %call.i403.i = tail call noalias dereferenceable_or_null(24) ptr @malloc(i64 noundef 24) #13
  store i32 %137, ptr %call.i403.i, align 8, !tbaa !75
  %state.i404.i = getelementptr inbounds %struct.Hint, ptr %call.i403.i, i64 0, i32 1
  store ptr null, ptr %state.i404.i, align 8, !tbaa !77
  %rule.i405.i = getelementptr inbounds %struct.Hint, ptr %call.i403.i, i64 0, i32 2
...
if.else321.i:                                     ; preds = %if.else.i79
  %and.i80 = and i32 %138, 7
  %tobool324.not.i = icmp eq i32 %and.i80, 0
  br i1 %tobool324.not.i, label %if.end336.i, label %if.then325.i

if.then325.i:                                     ; preds = %if.else321.i
  %call.i406.i = tail call noalias dereferenceable_or_null(24) ptr @malloc(i64 noundef 24) #13
  store i32 %137, ptr %call.i406.i, align 8, !tbaa !75
  %state.i407.i = getelementptr inbounds %struct.Hint, ptr %call.i406.i, i64 0, i32 1
  store ptr null, ptr %state.i407.i, align 8, !tbaa !77
  %rule.i408.i = getelementptr inbounds %struct.Hint, ptr %call.i406.i, i64 0, i32 2
  store ptr %130, ptr %rule.i408.i, align 8, !tbaa !78
  %inc331.i = add i32 %138, 1
  store i32 %inc331.i, ptr %error_recovery_hints.i, align 8, !tbaa !83
  %arrayidx333.i = getelementptr inbounds ptr, ptr %.pre.i69, i64 %wide.trip.count.i
  store ptr %call.i406.i, ptr %arrayidx333.i, align 8, !tbaa !22
  br label %for.inc340.i

if.end336.i:                                      ; preds = %if.else321.i, %if.then306.i, %if.else.thread.i
  %call.i409.i = tail call noalias dereferenceable_or_null(24) ptr @malloc(i64 noundef 24) #13
  store i32 %137, ptr %call.i409.i, align 8, !tbaa !75
  %state.i410.i = getelementptr inbounds %struct.Hint, ptr %call.i409.i, i64 0, i32 1
  store ptr null, ptr %state.i410.i, align 8, !tbaa !77
  %rule.i411.i = getelementptr inbounds %struct.Hint, ptr %call.i409.i, i64 0, i32 2
  store ptr %130, ptr %rule.i411.i, align 8, !tbaa !78
  tail call void @vec_add_internal(ptr noundef nonnull %error_recovery_hints.i, ptr noundef nonnull %call.i409.i) #12
  %.pre429.i = load i32, ptr %items.i60, align 8, !tbaa !44
  br label %for.inc340.i

for.inc340.i:                                     ; preds = %if.end336.i, %if.then325.i, %if.then311.i, %if.then288.i, %if.then277.i, %if.then269.i, %land.lhs.true19.i, %land.lhs.true.i, %for.body5.i67
  %150 = phi i32 [ %127, %for.body5.i67 ], [ %127, %land.lhs.true.i ], [ %127, %land.lhs.true19.i ], [ %127, %if.then288.i ], [ %127, %if.then311.i ], [ %127, %if.then325.i ], [ %.pre429.i, %if.end336.i ], [ %127, %if.then269.i ], [ %127, %if.then277.i ]
  %indvars.iv.next424.i = add nuw nsw i64 %indvars.iv423.i, 1
  %151 = zext i32 %150 to i64
  %cmp4.i81 = icmp ult i64 %indvars.iv.next424.i, %151
  br i1 %cmp4.i81, label %for.body5.i67, label %for.end342.i, !llvm.loop !88

for.end342.i:                                     ; preds = %for.inc340.i, %for.body.i61
  %error_recovery_hints343.i = getelementptr inbounds %struct.State, ptr %125, i64 0, i32 8
  %v344.i = getelementptr inbounds %struct.State, ptr %125, i64 0, i32 8, i32 2
  %152 = load ptr, ptr %v344.i, align 8, !tbaa !84
  %153 = load i32, ptr %error_recovery_hints343.i, align 8, !tbaa !83
  %conv347.i = zext i32 %153 to i64
  tail call void @qsort(ptr noundef %152, i64 noundef %conv347.i, i64 noundef 8, ptr noundef nonnull @hintcmp) #12
  %indvars.iv.next427.i = add nuw nsw i64 %indvars.iv426.i, 1
  %154 = load i32, ptr %states.i.i, align 8, !tbaa !48
  %155 = zext i32 %154 to i64
  %cmp.i82 = icmp ult i64 %indvars.iv.next427.i, %155
  br i1 %cmp.i82, label %for.body.i61, label %build_error_recovery.exit, !llvm.loop !89

build_error_recovery.exit:                        ; preds = %for.end342.i, %build_new_states.exit.i, %build_LR_sets.exit, %build_actions.exit.thread, %build_actions.exit, %build_right_epsilon_hints.exit
  ret void
}
...
entry:
  ...
  %cmp116.not = icmp eq i32 %0, 0
  br i1 %cmp116.not, label %for.end27, label %for.body.lr.ph
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end
  ...
  %indvars.iv128 = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next129, %if.end ]
  %2 = load ptr, ptr %v, align 8, !tbaa !43
  %arrayidx = getelementptr inbounds ptr, ptr %2, i64 %indvars.iv128
  %3 = load ptr, ptr %arrayidx, align 8, !tbaa !22
...
if.then:                                          ; preds = %for.body
  ...
  %rules113 = getelementptr inbounds %struct.Production, ptr %5, i64 0, i32 2
  %6 = load i32, ptr %rules113, align 8, !tbaa !90
  %cmp7114.not = icmp eq i32 %6, 0
  br i1 %cmp7114.not, label %if.end, label %for.body8.lr.ph
...
for.end27:                                        ; preds = %if.end, %entry
  ...
  %.fr = freeze i32 %19
  %cmp35119.not = icmp eq i32 %.fr, 0
  br i1 %cmp35119.not, label %for.end70.thread, label %for.body37.lr.ph
...
for.body37.lr.ph:                                 ; preds = %for.end27
  ...
  %21 = icmp eq i32 %.fr, 1
  br i1 %21, label %for.end70.unr-lcssa, label %for.body37.lr.ph.new
...
for.body37:                                       ; preds = %for.body37, %for.body37.lr.ph.new
  %indvars.iv131 = phi i64 [ 0, %for.body37.lr.ph.new ], [ %indvars.iv.next132.1, %for.body37 ]
  %22 = phi i64 [ 0, %for.body37.lr.ph.new ], [ %add67.1, %for.body37 ]
  %niter = phi i64 [ 0, %for.body37.lr.ph.new ], [ %niter.next.1, %for.body37 ]
  %arrayidx41 = getelementptr inbounds ptr, ptr %20, i64 %indvars.iv131
  ...
  %arrayidx41.1 = getelementptr inbounds ptr, ptr %20, i64 %indvars.iv.next132
  ...
  br i1 %niter.ncmp.1, label %for.end70.unr-lcssa, label %for.body37, !llvm.loop !95

for.end70.unr-lcssa:                              ; preds = %for.body37, %for.body37.lr.ph
  %add67.lcssa.ph = phi i64 [ undef, %for.body37.lr.ph ], [ %add67.1, %for.body37 ]
  %indvars.iv131.unr = phi i64 [ 0, %for.body37.lr.ph ], [ %indvars.iv.next132.1, %for.body37 ]
  %.unr = phi i64 [ 0, %for.body37.lr.ph ], [ %add67.1, %for.body37 ]
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %for.end70, label %for.body37.epil

for.body37.epil:                                  ; preds = %for.end70.unr-lcssa
  %arrayidx41.epil = getelementptr inbounds ptr, ptr %20, i64 %indvars.iv131.unr
...
for.end70:                                        ; preds = %for.end70.unr-lcssa, %for.body37.epil
  %add67.lcssa = phi i64 [ %add67.lcssa.ph, %for.end70.unr-lcssa ], [ %add67.epil, %for.body37.epil ]
  store i64 %add67.lcssa, ptr %hash, align 8, !tbaa !93
  %states.i = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 3
  %35 = load i32, ptr %states.i, align 8, !tbaa !48
  %cmp139.not.i = icmp eq i32 %35, 0
  br i1 %cmp139.not.i, label %entry.for.end38_crit_edge.i, label %for.body.lr.ph.i

for.end70.thread:                                 ; preds = %for.end27
  %states.i134 = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 3
  %36 = load i32, ptr %states.i134, align 8, !tbaa !48
  %cmp139.not.i135 = icmp eq i32 %36, 0
  br i1 %cmp139.not.i135, label %entry.for.end38_crit_edge.i, label %for.body.lr.ph.i.thread

for.body.lr.ph.i.thread:                          ; preds = %for.end70.thread
  %v.i101140 = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 3, i32 2
  %37 = load ptr, ptr %v.i101140, align 8, !tbaa !49
  %wide.trip.count148.i141 = zext i32 %36 to i64
  br label %for.body.i.us.preheader

entry.for.end38_crit_edge.i:                      ; preds = %for.end70.thread, %for.end70
  %states.i138 = phi ptr [ %states.i134, %for.end70.thread ], [ %states.i, %for.end70 ]
  %v42.phi.trans.insert.i = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 3, i32 2
  %.pre150.i = load ptr, ptr %v42.phi.trans.insert.i, align 8, !tbaa !49
  br label %for.end38.i

for.body.lr.ph.i:                                 ; preds = %for.end70
  %v.i101 = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 3, i32 2
  %38 = load ptr, ptr %v.i101, align 8, !tbaa !49
  %wide.trip.count148.i = zext i32 %35 to i64
  %wide.trip.count.i = zext i32 %.fr to i64
  br i1 %cmp35119.not, label %for.body.i.us.preheader, label %for.body.i

for.body.i.us.preheader:                          ; preds = %for.body.lr.ph.i.thread, %for.body.lr.ph.i
  %wide.trip.count148.i146 = phi i64 [ %wide.trip.count148.i141, %for.body.lr.ph.i.thread ], [ %wide.trip.count148.i, %for.body.lr.ph.i ]
  %39 = phi ptr [ %37, %for.body.lr.ph.i.thread ], [ %38, %for.body.lr.ph.i ]
  %v.i101145 = phi ptr [ %v.i101140, %for.body.lr.ph.i.thread ], [ %v.i101, %for.body.lr.ph.i ]
  %40 = phi i64 [ 0, %for.body.lr.ph.i.thread ], [ %add67.lcssa, %for.body.lr.ph.i ]
  %states.i137143 = phi ptr [ %states.i134, %for.body.lr.ph.i.thread ], [ %states.i, %for.body.lr.ph.i ]
  %41 = phi i32 [ %36, %for.body.lr.ph.i.thread ], [ %35, %for.body.lr.ph.i ]
  br label %for.body.i.us

for.body.i.us:                                    ; preds = %for.body.i.us.preheader, %for.inc36.i.us
  %indvars.iv145.i.us = phi i64 [ %indvars.iv.next146.i.us, %for.inc36.i.us ], [ 0, %for.body.i.us.preheader ]
  %arrayidx.i103.us = getelementptr inbounds ptr, ptr %39, i64 %indvars.iv145.i.us
  %42 = load ptr, ptr %arrayidx.i103.us, align 8, !tbaa !22
  %hash2.i.us = getelementptr inbounds %struct.State, ptr %42, i64 0, i32 1
  %43 = load i64, ptr %hash2.i.us, align 8, !tbaa !93
  %cmp3.i.us = icmp eq i64 %40, %43
  br i1 %cmp3.i.us, label %land.lhs.true.i.us, label %for.inc36.i.us

land.lhs.true.i.us:                               ; preds = %for.body.i.us
  %items9.i.us = getelementptr inbounds %struct.State, ptr %42, i64 0, i32 2
  %44 = load i32, ptr %items9.i.us, align 8, !tbaa !44
  %cmp11.i.us = icmp eq i32 %44, 0
  br i1 %cmp11.i.us, label %for.cond12.preheader.for.end_crit_edge.i, label %for.inc36.i.us

for.inc36.i.us:                                   ; preds = %land.lhs.true.i.us, %for.body.i.us
  %indvars.iv.next146.i.us = add nuw nsw i64 %indvars.iv145.i.us, 1
  %exitcond149.not.i.us = icmp eq i64 %indvars.iv.next146.i.us, %wide.trip.count148.i146
  br i1 %exitcond149.not.i.us, label %for.end38.i.thread, label %for.body.i.us, !llvm.loop !96

for.end38.i.thread:                               ; preds = %for.inc36.i.us
  store i32 %41, ptr %s, align 8, !tbaa !97
  br label %if.else.i105

for.body.i:                                       ; preds = %for.body.lr.ph.i, %for.inc36.i
  %indvars.iv145.i = phi i64 [ %indvars.iv.next146.i, %for.inc36.i ], [ 0, %for.body.lr.ph.i ]
  %arrayidx.i103 = getelementptr inbounds ptr, ptr %38, i64 %indvars.iv145.i
  %45 = load ptr, ptr %arrayidx.i103, align 8, !tbaa !22
  %hash2.i = getelementptr inbounds %struct.State, ptr %45, i64 0, i32 1
  %46 = load i64, ptr %hash2.i, align 8, !tbaa !93
  %cmp3.i = icmp eq i64 %add67.lcssa, %46
  br i1 %cmp3.i, label %land.lhs.true.i, label %for.inc36.i

land.lhs.true.i:                                  ; preds = %for.body.i
  %items9.i = getelementptr inbounds %struct.State, ptr %45, i64 0, i32 2
  %47 = load i32, ptr %items9.i, align 8, !tbaa !44
  %cmp11.i = icmp eq i32 %.fr, %47
  br i1 %cmp11.i, label %for.cond12.preheader.i, label %for.inc36.i

for.cond12.preheader.i:                           ; preds = %land.lhs.true.i
  %48 = load ptr, ptr %v29, align 8, !tbaa !43
  %v26.i = getelementptr inbounds %struct.State, ptr %45, i64 0, i32 2, i32 2
  %49 = load ptr, ptr %v26.i, align 8, !tbaa !43
  br label %for.body16.i

for.cond12.i:                                     ; preds = %for.body16.i
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %for.end.i, label %for.body16.i, !llvm.loop !98

for.body16.i:                                     ; preds = %for.cond12.i, %for.cond12.preheader.i
  %indvars.iv.i = phi i64 [ 0, %for.cond12.preheader.i ], [ %indvars.iv.next.i, %for.cond12.i ]
  %arrayidx20.i = getelementptr inbounds ptr, ptr %48, i64 %indvars.iv.i
  %50 = load ptr, ptr %arrayidx20.i, align 8, !tbaa !22
  %arrayidx28.i = getelementptr inbounds ptr, ptr %49, i64 %indvars.iv.i
  %51 = load ptr, ptr %arrayidx28.i, align 8, !tbaa !22
  %cmp29.not.i = icmp eq ptr %50, %51
  br i1 %cmp29.not.i, label %for.cond12.i, label %for.inc36.i

for.cond12.preheader.for.end_crit_edge.i:         ; preds = %land.lhs.true.i.us
  %.pre.i = load ptr, ptr %v29, align 8, !tbaa !43
  br label %for.end.i

for.end.i:                                        ; preds = %for.cond12.i, %for.cond12.preheader.for.end_crit_edge.i
  %v.i101144 = phi ptr [ %v.i101145, %for.cond12.preheader.for.end_crit_edge.i ], [ %v.i101, %for.cond12.i ]
  %indvars.iv145.i110 = phi i64 [ %indvars.iv145.i.us, %for.cond12.preheader.for.end_crit_edge.i ], [ %indvars.iv145.i, %for.cond12.i ]
  %52 = phi ptr [ %.pre.i, %for.cond12.preheader.for.end_crit_edge.i ], [ %48, %for.cond12.i ]
  %idxprom.lcssa.i = and i64 %indvars.iv145.i110, 4294967295
  %tobool.not.i.i = icmp eq ptr %52, null
  %e.i.i = getelementptr inbounds %struct.State, ptr %s, i64 0, i32 2, i32 3
  %cmp.not.i.i = icmp eq ptr %52, %e.i.i
...
do.body6.i.i:                                     ; preds = %if.then.i.i, %for.end.i
  ...
  %53 = load ptr, ptr %v12.i.i, align 8, !tbaa !99
  %tobool13.not.i.i = icmp eq ptr %53, null
  %e18.i.i = getelementptr inbounds %struct.State, ptr %s, i64 0, i32 3, i32 3
  %cmp20.not.i.i = icmp eq ptr %53, %e18.i.i
...
free_state.exit.i:                                ; preds = %if.then21.i.i, %do.body6.i.i
  ...
  %54 = load ptr, ptr %v.i101144, align 8, !tbaa !49
  %arrayidx34.i = getelementptr inbounds ptr, ptr %54, i64 %idxprom.lcssa.i
  %55 = load ptr, ptr %arrayidx34.i, align 8, !tbaa !22
...
for.inc36.i:                                      ; preds = %for.body16.i, %land.lhs.true.i, %for.body.i
  ...
  br i1 %exitcond149.not.i, label %for.end38.i, label %for.body.i, !llvm.loop !96

for.end38.i:                                      ; preds = %for.inc36.i, %entry.for.end38_crit_edge.i
  %56 = phi i32 [ 0, %entry.for.end38_crit_edge.i ], [ %35, %for.inc36.i ]
  %states.i136 = phi ptr [ %states.i138, %entry.for.end38_crit_edge.i ], [ %states.i, %for.inc36.i ]
  %57 = phi ptr [ %.pre150.i, %entry.for.end38_crit_edge.i ], [ %38, %for.inc36.i ]
  store i32 %56, ptr %s, align 8, !tbaa !97
  %tobool.not.i104 = icmp eq ptr %57, null
...
if.then43.i:                                      ; preds = %for.end38.i
  ...
  %inc49.i = add i32 %56, 1
  store i32 %inc49.i, ptr %states.i136, align 8, !tbaa !48
  %idxprom50.i = zext i32 %56 to i64
  %arrayidx51.i = getelementptr inbounds ptr, ptr %e.i, i64 %idxprom50.i
  store ptr %s, ptr %arrayidx51.i, align 8, !tbaa !22
  br label %maybe_add_state.exit

if.else.i105:                                     ; preds = %for.end38.i.thread, %for.end38.i
  %58 = phi ptr [ %39, %for.end38.i.thread ], [ %57, %for.end38.i ]
  %states.i136149 = phi ptr [ %states.i137143, %for.end38.i.thread ], [ %states.i136, %for.end38.i ]
  %59 = phi i32 [ %41, %for.end38.i.thread ], [ %56, %for.end38.i ]
  %e55.i = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 3, i32 3
  %cmp57.i = icmp eq ptr %58, %e55.i
  br i1 %cmp57.i, label %if.then58.i, label %if.else71.i

if.then58.i:                                      ; preds = %if.else.i105
  %cmp61.i = icmp ult i32 %59, 3
  br i1 %cmp61.i, label %if.then62.i, label %if.end85.i

if.then62.i:                                      ; preds = %if.then58.i
  %inc67.i = add nuw nsw i32 %59, 1
  store i32 %inc67.i, ptr %states.i136149, align 8, !tbaa !48
  %idxprom68.i = zext i32 %59 to i64
  %arrayidx69.i = getelementptr inbounds ptr, ptr %58, i64 %idxprom68.i
  store ptr %s, ptr %arrayidx69.i, align 8, !tbaa !22
  br label %maybe_add_state.exit

if.else71.i:                                      ; preds = %if.else.i105
  %and.i106 = and i32 %59, 7
...
if.then75.i:                                      ; preds = %if.else71.i
  %inc80.i = add i32 %59, 1
  store i32 %inc80.i, ptr %states.i136149, align 8, !tbaa !48
  %idxprom81.i = zext i32 %59 to i64
  %arrayidx82.i = getelementptr inbounds ptr, ptr %58, i64 %idxprom81.i
  store ptr %s, ptr %arrayidx82.i, align 8, !tbaa !22
  br label %maybe_add_state.exit

if.end85.i:                                       ; preds = %if.else71.i, %if.then58.i
  tail call void @vec_add_internal(ptr noundef nonnull %states.i136149, ptr noundef nonnull %s) #12
  br label %maybe_add_state.exit

maybe_add_state.exit:                             ; preds = %free_state.exit.i, %if.then43.i, %if.then62.i, %if.then75.i, %if.end85.i
  %retval.0.i107 = phi ptr [ %55, %free_state.exit.i ], [ %s, %if.end85.i ], [ %s, %if.then75.i ], [ %s, %if.then62.i ], [ %s, %if.then43.i ]
