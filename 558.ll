; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/q_matrix.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/q_matrix.c"
...
entry:
  ...
  %call185 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(14) @MatrixType4x4, ptr noundef nonnull dereferenceable(1) %s) #13
  %cmp192 = icmp eq i32 %call185, 0
  br i1 %cmp192, label %cleanup, label %if.else

if.else:                                          ; preds = %entry
  %call185.1 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(17) getelementptr inbounds ([6 x [20 x i8]], ptr @MatrixType4x4, i64 0, i64 1), ptr noundef nonnull dereferenceable(1) %s) #13
  %cmp192.1 = icmp eq i32 %call185.1, 0
  br i1 %cmp192.1, label %cleanup, label %if.else.1

if.else.1:                                        ; preds = %if.else
  %call185.2 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(17) getelementptr inbounds ([6 x [20 x i8]], ptr @MatrixType4x4, i64 0, i64 2), ptr noundef nonnull dereferenceable(1) %s) #13
  %cmp192.2 = icmp eq i32 %call185.2, 0
  br i1 %cmp192.2, label %cleanup, label %if.else.2

if.else.2:                                        ; preds = %if.else.1
  %call185.3 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(14) getelementptr inbounds ([6 x [20 x i8]], ptr @MatrixType4x4, i64 0, i64 3), ptr noundef nonnull dereferenceable(1) %s) #13
  %cmp192.3 = icmp eq i32 %call185.3, 0
  br i1 %cmp192.3, label %cleanup, label %if.else.3

if.else.3:                                        ; preds = %if.else.2
  %call185.4 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(17) getelementptr inbounds ([6 x [20 x i8]], ptr @MatrixType4x4, i64 0, i64 4), ptr noundef nonnull dereferenceable(1) %s) #13
  %cmp192.4 = icmp eq i32 %call185.4, 0
  br i1 %cmp192.4, label %cleanup, label %if.else.4

if.else.4:                                        ; preds = %if.else.3
  %call185.5 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(17) getelementptr inbounds ([6 x [20 x i8]], ptr @MatrixType4x4, i64 0, i64 5), ptr noundef nonnull dereferenceable(1) %s) #13
...
if.else.5:                                        ; preds = %if.else.4
  ...
  %call416 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(14) @MatrixType8x8, ptr noundef nonnull dereferenceable(1) %s) #13
  %cmp423 = icmp eq i32 %call416, 0
  br i1 %cmp423, label %cleanup, label %if.else426

if.else426:                                       ; preds = %if.else.5
  %call416.1 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(14) getelementptr inbounds ([2 x [20 x i8]], ptr @MatrixType8x8, i64 0, i64 1), ptr noundef nonnull dereferenceable(1) %s) #13
  %cmp423.1 = icmp eq i32 %call416.1, 0
  %spec.select = select i1 %cmp423.1, i32 1, i32 -1
  br label %cleanup

cleanup:                                          ; preds = %if.else426, %entry, %if.else, %if.else.1, %if.else.2, %if.else.3, %if.else.4, %if.else.5
  %retval.0 = phi i32 [ 0, %if.else.5 ], [ 0, %entry ], [ 1, %if.else ], [ 2, %if.else.1 ], [ 3, %if.else.2 ], [ 4, %if.else.3 ], [ 5, %if.else.4 ], [ %spec.select, %if.else426 ]
  ret i32 %retval.0
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 8000, ptr nonnull %items) #13
  %idxprom = sext i32 %bufsize to i64
  %arrayidx = getelementptr inbounds i8, ptr %buf, i64 %idxprom
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %IntContent) #13
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %type) #13
  %cmp334 = icmp sgt i32 %bufsize, 0
  br i1 %cmp334, label %while.body, label %for.end274

while.body:                                       ; preds = %entry, %sw.epilog
  %item.0338 = phi i32 [ %item.3, %sw.epilog ], [ 0, %entry ]
  %InString.0337 = phi i32 [ %InString.1, %sw.epilog ], [ 0, %entry ]
  %InItem.0336 = phi i32 [ %InItem.3, %sw.epilog ], [ 0, %entry ]
  %p.0335 = phi ptr [ %p.2, %sw.epilog ], [ %buf, %entry ]
  %0 = load i8, ptr %p.0335, align 1, !tbaa !9
...
sw.bb:                                            ; preds = %while.body
  %incdec.ptr = getelementptr inbounds i8, ptr %p.0335, i64 1
  br label %sw.epilog

sw.bb1:                                           ; preds = %while.body
  store i8 0, ptr %p.0335, align 1, !tbaa !9
  br label %while.cond2

while.cond2:                                      ; preds = %while.cond2, %sw.bb1
  %p.1 = phi ptr [ %p.0335, %sw.bb1 ], [ %incdec.ptr9, %while.cond2 ]
...
sw.bb10:                                          ; preds = %while.body
  %incdec.ptr11 = getelementptr inbounds i8, ptr %p.0335, i64 1
  store i8 0, ptr %p.0335, align 1, !tbaa !9
  br label %sw.epilog

sw.bb12:                                          ; preds = %while.body, %while.body
  %tobool.not = icmp eq i32 %InString.0337, 0
  %incdec.ptr14 = getelementptr inbounds i8, ptr %p.0335, i64 1
...
sw.bb15:                                          ; preds = %while.body
  %incdec.ptr16 = getelementptr inbounds i8, ptr %p.0335, i64 1
  store i8 0, ptr %p.0335, align 1, !tbaa !9
  %tobool17.not = icmp eq i32 %InString.0337, 0
  br i1 %tobool17.not, label %if.then18, label %if.end22

if.then18:                                        ; preds = %sw.bb15
  %inc = add nsw i32 %item.0338, 1
  %idxprom19 = sext i32 %item.0338 to i64
  ...
  %not = xor i32 %InItem.0336, -1
  br label %if.end22

if.end22:                                         ; preds = %sw.bb15, %if.then18
  %InItem.1 = phi i32 [ %not, %if.then18 ], [ 0, %sw.bb15 ]
  %item.1 = phi i32 [ %inc, %if.then18 ], [ %item.0338, %sw.bb15 ]
  %not23 = xor i32 %InString.0337, -1
  br label %sw.epilog

sw.bb24:                                          ; preds = %while.body
  %incdec.ptr25 = getelementptr inbounds i8, ptr %p.0335, i64 1
  br label %sw.epilog

sw.default:                                       ; preds = %while.body
  %tobool26.not = icmp eq i32 %InItem.0336, 0
  br i1 %tobool26.not, label %if.then27, label %if.end32

if.then27:                                        ; preds = %sw.default
  %inc28 = add nsw i32 %item.0338, 1
  %idxprom29 = sext i32 %item.0338 to i64
  %arrayidx30 = getelementptr inbounds [1000 x ptr], ptr %items, i64 0, i64 %idxprom29
  store ptr %p.0335, ptr %arrayidx30, align 8, !tbaa !12
  br label %if.end32

if.end32:                                         ; preds = %if.then27, %sw.default
  %item.2 = phi i32 [ %item.0338, %sw.default ], [ %inc28, %if.then27 ]
  %incdec.ptr33 = getelementptr inbounds i8, ptr %p.0335, i64 1
  br label %sw.epilog
...
sw.epilog:                                        ; preds = %while.cond2, %sw.bb12, %if.else, %if.end32, %sw.bb24, %if.end22, %sw.bb10, %sw.bb
  ...
  %InItem.3 = phi i32 [ -1, %if.end32 ], [ 0, %sw.bb24 ], [ %InItem.1, %if.end22 ], [ 0, %if.else ], [ 0, %sw.bb10 ], [ %InItem.0336, %sw.bb ], [ %InItem.0336, %sw.bb12 ], [ 0, %while.cond2 ]
  %InString.1 = phi i32 [ %InString.0337, %if.end32 ], [ %InString.0337, %sw.bb24 ], [ %not23, %if.end22 ], [ 0, %if.else ], [ 0, %sw.bb10 ], [ %InString.0337, %sw.bb ], [ -1, %sw.bb12 ], [ 0, %while.cond2 ]
  %item.3 = phi i32 [ %item.2, %if.end32 ], [ %item.0338, %sw.bb24 ], [ %item.1, %if.end22 ], [ %item.0338, %if.else ], [ %item.0338, %sw.bb10 ], [ %item.0338, %sw.bb ], [ %item.0338, %sw.bb12 ], [ %item.0338, %while.cond2 ]
...
while.end34:                                      ; preds = %sw.epilog
  ...
  %cmp35340 = icmp sgt i32 %item.3, 1
  br i1 %cmp35340, label %for.body, label %for.end274

for.body:                                         ; preds = %while.end34, %for.end
  %i.0341 = phi i32 [ %add273, %for.end ], [ 0, %while.end34 ]
  %idxprom37 = zext i32 %i.0341 to i64
...
if.then41:                                        ; preds = %for.body
  %call45 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str, ptr noundef %3) #13
  call void @error(ptr noundef nonnull @errortext, i32 noundef 300) #13
  br label %cond.false90

cond.false90:                                     ; preds = %if.then41, %for.body
  %add91 = add nuw nsw i32 %i.0341, 1
  %idxprom92 = zext i32 %add91 to i64
  %arrayidx93 = getelementptr inbounds [1000 x ptr], ptr %items, i64 0, i64 %idxprom92
  %4 = load ptr, ptr %arrayidx93, align 8, !tbaa !12
...
if.then103:                                       ; preds = %cond.false90
  ...
  %6 = load i8, ptr %arrayidx105, align 1, !tbaa !9
...
if.end231:                                        ; preds = %if.then229, %cond.end226
  %7 = load i32, ptr %type, align 4, !tbaa !5
  %tobool233.not = icmp eq i32 %7, 0
  %idxprom235 = sext i32 %call to i64
  %arrayidx241 = getelementptr inbounds [2 x [64 x i16]], ptr @ScalingList8x8input, i64 0, i64 %idxprom235
  %arrayidx244 = getelementptr inbounds [2 x i32], ptr @matrix8x8_check, i64 0, i64 %idxprom235
  %arrayidx236 = getelementptr inbounds [6 x [16 x i16]], ptr @ScalingList4x4input, i64 0, i64 %idxprom235
  %arrayidx238 = getelementptr inbounds [6 x i32], ptr @matrix4x4_check, i64 0, i64 %idxprom235
  %arrayidx244.sink = select i1 %tobool233.not, ptr %arrayidx238, ptr %arrayidx244
  %range.0 = select i1 %tobool233.not, i32 16, i32 64
  %ScalingList.0 = select i1 %tobool233.not, ptr %arrayidx236, ptr %arrayidx241
  store i32 1, ptr %arrayidx244.sink, align 4, !tbaa !5
  %add250 = add i32 %i.0341, 2
  %8 = zext i32 %add250 to i64
  %wide.trip.count = zext i32 %range.0 to i64
  br label %for.body249

for.body249:                                      ; preds = %if.end231, %if.end265
  %indvars.iv = phi i64 [ 0, %if.end231 ], [ %indvars.iv.next, %if.end265 ]
  %9 = add nuw nsw i64 %indvars.iv, %8
  %arrayidx253 = getelementptr inbounds [1000 x ptr], ptr %items, i64 0, i64 %9
  %10 = load ptr, ptr %arrayidx253, align 8, !tbaa !12
  %call254 = call i32 (ptr, ptr, ...) @__isoc99_sscanf(ptr noundef %10, ptr noundef nonnull @.str.3, ptr noundef nonnull %IntContent) #13
  %cmp255.not = icmp eq i32 %call254, 1
  br i1 %cmp255.not, label %if.end265, label %if.then257

if.then257:                                       ; preds = %for.body249
  %call264 = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) @errortext, i64 noundef 300, ptr noundef nonnull @.str.4, ptr noundef %3, ptr noundef %10) #13
  call void @error(ptr noundef nonnull @errortext, i32 noundef 300) #13
  br label %if.end265

if.end265:                                        ; preds = %if.then257, %for.body249
  %11 = load i32, ptr %IntContent, align 4, !tbaa !5
  %conv266 = trunc i32 %11 to i16
  %arrayidx268 = getelementptr inbounds i16, ptr %ScalingList.0, i64 %indvars.iv
  store i16 %conv266, ptr %arrayidx268, align 2, !tbaa !15
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %for.end, label %for.body249, !llvm.loop !17

for.end:                                          ; preds = %if.end265
  %putchar = call i32 @putchar(i32 46)
  %add273 = add i32 %add250, %range.0
  %cmp35 = icmp slt i32 %add273, %dec
  br i1 %cmp35, label %for.body, label %for.end274, !llvm.loop !18

for.end274:                                       ; preds = %for.end, %entry, %while.end34
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %type) #13
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %IntContent) #13
  call void @llvm.lifetime.end.p0(i64 8000, ptr nonnull %items) #13
  ret void
}
...
entry:
  ...
  %call = tail call noalias ptr @malloc(i64 noundef %mul1) #14
...
if.end:                                           ; preds = %if.then, %entry
  %call6 = tail call noalias ptr @malloc(i64 noundef %mul1) #14
...
for.end:                                          ; preds = %for.body, %middle.block, %if.end10
  %call17 = tail call i32 @get_mem4Dint(ptr noundef nonnull @LevelScale4x4Luma, i32 noundef 2, i32 noundef 6, i32 noundef 4, i32 noundef 4) #13
  %call18 = tail call i32 @get_mem5Dint(ptr noundef nonnull @LevelScale4x4Chroma, i32 noundef 2, i32 noundef 2, i32 noundef 6, i32 noundef 4, i32 noundef 4) #13
  %call19 = tail call i32 @get_mem4Dint(ptr noundef nonnull @LevelScale8x8Luma, i32 noundef 2, i32 noundef 6, i32 noundef 8, i32 noundef 8) #13
  %call20 = tail call i32 @get_mem4Dint(ptr noundef nonnull @InvLevelScale4x4Luma, i32 noundef 2, i32 noundef 6, i32 noundef 4, i32 noundef 4) #13
  %call21 = tail call i32 @get_mem5Dint(ptr noundef nonnull @InvLevelScale4x4Chroma, i32 noundef 2, i32 noundef 2, i32 noundef 6, i32 noundef 4, i32 noundef 4) #13
  %call22 = tail call i32 @get_mem4Dint(ptr noundef nonnull @InvLevelScale8x8Luma, i32 noundef 2, i32 noundef 6, i32 noundef 8, i32 noundef 8) #13
  ret void
}
...
entry:
  ...
  tail call void @free_mem4Dint(ptr noundef %2, i32 noundef 2, i32 noundef 6) #13
  %3 = load ptr, ptr @LevelScale4x4Chroma, align 8, !tbaa !12
  tail call void @free_mem5Dint(ptr noundef %3, i32 noundef 2, i32 noundef 2, i32 noundef 6) #13
  %4 = load ptr, ptr @LevelScale8x8Luma, align 8, !tbaa !12
  tail call void @free_mem4Dint(ptr noundef %4, i32 noundef 2, i32 noundef 6) #13
  %5 = load ptr, ptr @InvLevelScale4x4Luma, align 8, !tbaa !12
  tail call void @free_mem4Dint(ptr noundef %5, i32 noundef 2, i32 noundef 6) #13
  %6 = load ptr, ptr @InvLevelScale4x4Chroma, align 8, !tbaa !12
  tail call void @free_mem5Dint(ptr noundef %6, i32 noundef 2, i32 noundef 2, i32 noundef 6) #13
  %7 = load ptr, ptr @InvLevelScale8x8Luma, align 8, !tbaa !12
  tail call void @free_mem4Dint(ptr noundef %7, i32 noundef 2, i32 noundef 6) #13
  ret void
}
...
if.then:                                          ; preds = %entry
  ...
  %call3 = tail call ptr @GetConfigFileContent(ptr noundef nonnull %QmatrixFile1, i32 noundef 0) #13
  %cmp.not = icmp eq ptr %call3, null
  br i1 %cmp.not, label %if.else, label %if.then4

if.then4:                                         ; preds = %if.then
  %call5 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call3) #15
...
if.end:                                           ; preds = %entry
  %uglygep = getelementptr i8, ptr %0, i64 40
  %present.sroa.0.0.copyload = load i32, ptr %uglygep, align 4, !tbaa !5
  %present.sroa.9.0.uglygep.sroa_idx = getelementptr i8, ptr %0, i64 44
  %present.sroa.13.0.uglygep.sroa_idx = getelementptr i8, ptr %0, i64 48
  %present.sroa.17.0.uglygep.sroa_idx = getelementptr i8, ptr %0, i64 52
  %present.sroa.17.0.copyload = load i32, ptr %present.sroa.17.0.uglygep.sroa_idx, align 4, !tbaa !5
  %present.sroa.21.0.uglygep.sroa_idx = getelementptr i8, ptr %0, i64 56
  %present.sroa.25.0.uglygep.sroa_idx = getelementptr i8, ptr %0, i64 60
...
if.else221:                                       ; preds = %for.inc27.5, %if.end
  ...
  %present.sroa.9.2.in = phi ptr [ %present.sroa.9.0.uglygep.sroa_idx, %if.end ], [ %arrayidx23.1, %for.inc27.5 ]
  %present.sroa.13.2.in = phi ptr [ %present.sroa.13.0.uglygep.sroa_idx, %if.end ], [ %arrayidx23.2, %for.inc27.5 ]
  %present.sroa.17.2 = phi i32 [ %present.sroa.17.0.copyload, %if.end ], [ %or.3, %for.inc27.5 ]
  %present.sroa.21.2.in = phi ptr [ %present.sroa.21.0.uglygep.sroa_idx, %if.end ], [ %arrayidx23.4, %for.inc27.5 ]
  %present.sroa.25.2.in = phi ptr [ %present.sroa.25.0.uglygep.sroa_idx, %if.end ], [ %arrayidx23.5, %for.inc27.5 ]
...
if.end:                                           ; preds = %entry
  %uglygep = getelementptr i8, ptr %0, i64 64
  %present.sroa.0.0.copyload = load i32, ptr %uglygep, align 4, !tbaa !5
  %present.sroa.8.0.uglygep.sroa_idx = getelementptr i8, ptr %0, i64 68
  %present.sroa.8.0.copyload = load i32, ptr %present.sroa.8.0.uglygep.sroa_idx, align 4, !tbaa !5
  %.pre = load ptr, ptr @active_pps, align 8, !tbaa !12
  %pic_scaling_matrix_present_flag7.phi.trans.insert = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %.pre, i64 0, i32 5
