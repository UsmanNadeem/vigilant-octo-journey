; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/placepin.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/placepin.c"
...
for.body120.preheader:                            ; preds = %for.cond114.preheader
  ...
  %min.iters.check = icmp ult i64 %174, 9
