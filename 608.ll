; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/lua/lauxlib.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/lua/lauxlib.c"
...
if.end:                                           ; preds = %entry
  ...
  %namewhat130 = getelementptr inbounds %struct.lua_Debug, ptr %ar, i64 0, i32 2
  %0 = load ptr, ptr %namewhat130, align 8, !tbaa !5
  %call131 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(7) @.str.2) #16
  %cmp138 = icmp eq i32 %call131, 0
  br i1 %cmp138, label %if.then140, label %if.end146

if.then140:                                       ; preds = %if.end
  %dec = add nsw i32 %narg, -1
  %cmp141 = icmp eq i32 %dec, 0
...
if.then143:                                       ; preds = %if.then140
  ...
  %call144 = call i32 (ptr, ptr, ...) @luaL_error(ptr noundef %L, ptr noundef nonnull @.str.3, ptr noundef %1, ptr noundef %extramsg)
  br label %cleanup

if.end146:                                        ; preds = %if.then140, %if.end
  %narg.addr.0 = phi i32 [ %dec, %if.then140 ], [ %narg, %if.end ]
  %name147 = getelementptr inbounds %struct.lua_Debug, ptr %ar, i64 0, i32 1
  %2 = load ptr, ptr %name147, align 8, !tbaa !11
  %cmp148 = icmp eq ptr %2, null
  br i1 %cmp148, label %if.then150, label %if.end152

if.then150:                                       ; preds = %if.end146
  store ptr @.str.4, ptr %name147, align 8, !tbaa !11
  br label %if.end152

if.end152:                                        ; preds = %if.then150, %if.end146
  %3 = phi ptr [ @.str.4, %if.then150 ], [ %2, %if.end146 ]
  %call154 = call i32 (ptr, ptr, ...) @luaL_error(ptr noundef %L, ptr noundef nonnull @.str.5, i32 noundef %narg.addr.0, ptr noundef nonnull %3, ptr noundef %extramsg)
  br label %cleanup

cleanup:                                          ; preds = %if.end152, %if.then143, %if.then
  %retval.0 = phi i32 [ %call144, %if.then143 ], [ %call154, %if.end152 ], [ %call1, %if.then ]
...
cond.end:                                         ; preds = %if.then.i, %cond.false, %cond.true
  ...
  %tobool2.not197 = icmp eq ptr %0, null
  br i1 %tobool2.not197, label %for.end, label %for.body

for.body:                                         ; preds = %cond.end, %for.inc
  %indvars.iv = phi i64 [ %indvars.iv.next, %for.inc ], [ 0, %cond.end ]
  %1 = phi ptr [ %2, %for.inc ], [ %0, %cond.end ]
  %call171 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(1) %cond) #16
  %cmp178 = icmp eq i32 %call171, 0
  br i1 %cmp178, label %cleanup.loopexit, label %for.inc
...
for.end:                                          ; preds = %for.inc, %cond.end
  %call182 = tail call ptr (ptr, ptr, ...) @lua_pushfstring(ptr noundef %L, ptr noundef nonnull @.str.10, ptr noundef %cond) #16
  %call183 = tail call i32 @luaL_argerror(ptr noundef %L, i32 noundef %narg, ptr noundef %call182)
  br label %cleanup
...
cleanup:                                          ; preds = %cleanup.loopexit, %for.end
  %retval.0 = phi i32 [ %call183, %for.end ], [ %3, %cleanup.loopexit ]
  ret i32 %retval.0
}
...
do.body:                                          ; preds = %if.end20, %entry
  %fname.addr.0 = phi ptr [ %fname, %entry ], [ %add.ptr21, %if.end20 ]
  %call1 = tail call ptr @strchr(ptr noundef nonnull dereferenceable(1) %fname.addr.0, i32 noundef 46) #16
  %cmp = icmp eq ptr %call1, null
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %do.body
  %call2 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %fname.addr.0) #17
  %add.ptr = getelementptr inbounds i8, ptr %fname.addr.0, i64 %call2
  br label %if.end

if.end:                                           ; preds = %if.then, %do.body
  %e.0 = phi ptr [ %add.ptr, %if.then ], [ %call1, %do.body ]
...
if.then5:                                         ; preds = %if.end
  ...
  %cond11 = select i1 %cmp6, i32 1, i32 %szhint
  tail call void @lua_createtable(ptr noundef %L, i32 noundef 0, i32 noundef %cond11) #16
  tail call void @lua_pushlstring(ptr noundef %L, ptr noundef %fname.addr.0, i64 noundef %sub.ptr.sub) #16
...
if.else:                                          ; preds = %if.end
  %call15 = tail call i32 @lua_type(ptr noundef %L, i32 noundef -1) #16
...
if.end20:                                         ; preds = %if.else, %if.then5
  tail call void @lua_remove(ptr noundef %L, i32 noundef -2) #16
  %add.ptr21 = getelementptr inbounds i8, ptr %e.0, i64 1
  %1 = load i8, ptr %e.0, align 1, !tbaa !24
  %cmp23 = icmp eq i8 %1, 46
  br i1 %cmp23, label %do.body, label %cleanup, !llvm.loop !25

cleanup:                                          ; preds = %if.end20, %if.then18
  %retval.0 = phi ptr [ %fname.addr.0, %if.then18 ], [ null, %if.end20 ]
  ret ptr %retval.0
}
...
do.end.i.i:                                       ; preds = %do.body.i.i
  ...
  %sub13.i.i = sub nsw i32 1, %toget.1.i.i
  %add14.i.i = add i32 %sub13.i.i, %5
...
do.end.i.i67:                                     ; preds = %do.body.i.i64
  ...
  %sub13.i.i65 = sub nsw i32 1, %toget.1.i.i61
  %add14.i.i66 = add i32 %sub13.i.i65, %13
...
do.end.i:                                         ; preds = %do.body.i
  ...
  %5 = load i32, ptr %lvl.i, align 8, !tbaa !29
  %sub13.i = sub nsw i32 1, %toget.1.i
  %add14.i = add i32 %sub13.i, %5
...
if.else:                                          ; preds = %entry
  ...
  %call2 = tail call ptr @fopen(ptr noundef nonnull %filename, ptr noundef nonnull @.str.17)
...
if.end8:                                          ; preds = %if.else, %if.then
  ...
  %call10 = tail call i32 @_IO_getc(ptr noundef %2)
...
while.cond:                                       ; preds = %while.cond, %if.then12
  %call15 = tail call i32 @_IO_getc(ptr noundef %2)
...
if.then19:                                        ; preds = %while.cond
  %call21 = tail call i32 @_IO_getc(ptr noundef %2)
  br label %if.end23
...
while.cond36:                                     ; preds = %if.then26, %while.cond36
  %call38 = tail call i32 @_IO_getc(ptr noundef nonnull %call28)
