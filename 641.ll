; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/list.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/list.c"
...
; Function Attrs: nounwind uwtable
define dso_local ptr @list_PointerDeleteElementFree(ptr noundef %List, ptr noundef readnone %Element, ptr nocapture noundef readonly %Free) local_unnamed_addr #0 {
entry:
