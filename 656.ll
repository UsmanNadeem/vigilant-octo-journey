; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/st.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/st.c"
...
@.str.1 = private unnamed_addr constant [88 x i8] c"/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/st.c\00", align 1
...
; Function Attrs: nounwind uwtable
define dso_local void @st_EntryCreate(ptr noundef %StIndex, ptr noundef %Pointer, ptr noundef %Term, ptr noundef %Context) local_unnamed_addr #0 {
entry:
  %SubstOld = alloca ptr, align 8
  %SubstNew = alloca ptr, align 8
  tail call void @cont_Check() #9
  %call = tail call i32 @term_ComputeSize(ptr noundef %Term) #9
...
cont_NextIndexVariable.exit:                      ; preds = %cont_NextIndexVariable.exit.loopexit, %if.then.i, %if.then11.i
  %7 = phi i32 [ %inc.i19.i, %if.then11.i ], [ %inc.i.i, %if.then.i ], [ %6, %cont_NextIndexVariable.exit.loopexit ]
  ...
  %context.i.i.i96 = getelementptr inbounds %struct.binding, ptr %8, i64 0, i32 3
  store ptr %Context, ptr %context.i.i.i96, align 8
  %9 = load ptr, ptr @cont_LASTBINDING, align 8
  %link.i.i.i = getelementptr inbounds %struct.binding, ptr %8, i64 0, i32 4
  store ptr %9, ptr %link.i.i.i, align 8
  store ptr %8, ptr @cont_LASTBINDING, align 8
  %10 = load i32, ptr @cont_BINDINGS, align 4
  %inc.i = add nsw i32 %10, 1
  store i32 %inc.i, ptr @cont_BINDINGS, align 4
  %11 = getelementptr i8, ptr %StIndex, i64 24
  %StIndex.val = load i16, ptr %11, align 8
...
if.then:                                          ; preds = %cont_NextIndexVariable.exit
  store i16 %conv, ptr %11, align 8
  br label %if.end13

if.else:                                          ; preds = %cont_NextIndexVariable.exit
  %12 = getelementptr i8, ptr %StIndex, i64 26
  %StIndex.val95 = load i16, ptr %12, align 2
  %conv8 = zext i16 %StIndex.val95 to i32
  %cmp10 = icmp ult i32 %conv5, %conv8
  br i1 %cmp10, label %if.then12, label %if.end13

if.then12:                                        ; preds = %if.else
  store i16 %conv, ptr %12, align 2
  br label %if.end13

if.end13:                                         ; preds = %if.else, %if.then12, %if.then
  %13 = getelementptr i8, ptr %StIndex, i64 16
  %StIndex.addr.0.val151 = load ptr, ptr %13, align 8
  %cmp.i.i.not152 = icmp eq ptr %StIndex.addr.0.val151, null
  br i1 %cmp.i.i.not152, label %land.rhs, label %while.end
...
land.rhs:                                         ; preds = %if.end13, %if.end31
  ...
  %14 = load ptr, ptr %subnodes, align 8
  %cmp.i.not45.i = icmp eq ptr %14, null
...
for.body.i:                                       ; preds = %for.inc.i, %for.body.preheader.i
  ...
  %15 = phi i32 [ %.pre49.i, %for.body.preheader.i ], [ %35, %for.inc.i ]
  %16 = phi i32 [ %.pre.i, %for.body.preheader.i ], [ %36, %for.inc.i ]
  %EmptyVariant.047.i = phi ptr [ null, %for.body.preheader.i ], [ %EmptyVariant.1.i, %for.inc.i ]
  %Subnodes.addr.046.i = phi ptr [ %14, %for.body.preheader.i ], [ %Subnodes.addr.0.val33.i, %for.inc.i ]
  %17 = getelementptr i8, ptr %Subnodes.addr.046.i, i64 8
  %Subnodes.addr.0.val.i = load ptr, ptr %17, align 8
  %inc.i.i.i = add nsw i32 %15, 1
  store i32 %inc.i.i.i, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i.i97 = sext i32 %15 to i64
  %arrayidx.i.i.i98 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i.i97
  store i32 %16, ptr %arrayidx.i.i.i98, align 4
  store i32 0, ptr @cont_BINDINGS, align 4
  %18 = load ptr, ptr %Subnodes.addr.0.val.i, align 8
  %call2.i = tail call i32 @subst_Variation(ptr noundef %Context, ptr noundef %18) #9
  %tobool3.not.i = icmp eq i32 %call2.i, 0
  br i1 %tobool3.not.i, label %if.else9.i, label %if.then.i99

if.then.i99:                                      ; preds = %for.body.i
  %19 = load ptr, ptr %Subnodes.addr.0.val.i, align 8
  %cmp.i34.not.i = icmp eq ptr %19, null
...
if.then10.i:                                      ; preds = %if.else9.i
  %20 = load ptr, ptr %Subnodes.addr.0.val.i, align 8
  %call12.i = tail call i32 @subst_MatchTops(ptr noundef %Context, ptr noundef %20) #9
  %tobool13.not.i = icmp eq i32 %call12.i, 0
  %spec.select = select i1 %tobool13.not.i, ptr null, ptr %Subnodes.addr.0.val.i
  br label %if.end17.i

if.end17.i:                                       ; preds = %if.then10.i, %if.else9.i, %if.then.i99
  %BestNonVariant.2 = phi ptr [ %BestNonVariant.1, %if.else9.i ], [ %BestNonVariant.1, %if.then.i99 ], [ %spec.select, %if.then10.i ]
  %EmptyVariant.1.i = phi ptr [ %EmptyVariant.047.i, %if.else9.i ], [ %Subnodes.addr.0.val.i, %if.then.i99 ], [ %EmptyVariant.047.i, %if.then10.i ]
...
while.body.i.i.prol:                              ; preds = %while.body.i.i.preheader
  ...
  %call.val.i.i.i.i.prol = load ptr, ptr %22, align 8
  store ptr %call.val.i.i.i.i.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i.i.prol = getelementptr inbounds %struct.binding, ptr %21, i64 0, i32 1
  ...
  %link.i.i.i.i.i.prol = getelementptr inbounds %struct.binding, ptr %23, i64 0, i32 4
...
while.body.i.i.prol.loopexit:                     ; preds = %while.body.i.i.prol, %while.body.i.i.preheader
  ...
  %24 = icmp eq i32 %.pr.i.i, 1
  br i1 %24, label %while.end.i.i, label %while.body.i.i

while.body.i.i:                                   ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i
  %25 = phi i32 [ %dec.i.i.i.i.1, %while.body.i.i ], [ %.unr, %while.body.i.i.prol.loopexit ]
  %26 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %26, ptr @cont_CURRENTBINDING, align 8
  %27 = getelementptr i8, ptr %26, i64 24
  %call.val.i.i.i.i = load ptr, ptr %27, align 8
  store ptr %call.val.i.i.i.i, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i.i = getelementptr inbounds %struct.binding, ptr %26, i64 0, i32 1
  ...
  %link.i.i.i.i.i = getelementptr inbounds %struct.binding, ptr %28, i64 0, i32 4
  ...
  %call.val.i.i.i.i.1 = load ptr, ptr %30, align 8
  store ptr %call.val.i.i.i.i.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i.i.1 = getelementptr inbounds %struct.binding, ptr %29, i64 0, i32 1
  ...
  %link.i.i.i.i.i.1 = getelementptr inbounds %struct.binding, ptr %31, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i.i.1, align 8
  %dec.i.i.i.i.1 = add nsw i32 %25, -2
...
while.end.i.i:                                    ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i, %if.end17.i
  %32 = phi i32 [ %.pr.i.i, %if.end17.i ], [ 0, %while.body.i.i ], [ 0, %while.body.i.i.prol.loopexit ]
  %33 = load i32, ptr @cont_STACKPOINTER, align 4
  %cmp.i.not.i.i = icmp eq i32 %33, 0
  br i1 %cmp.i.not.i.i, label %for.inc.i, label %if.then.i.i
...
if.then.i.i:                                      ; preds = %while.end.i.i
  ...
  %34 = load i32, ptr %arrayidx.i.i38.i, align 4
  store i32 %34, ptr @cont_BINDINGS, align 4
  br label %for.inc.i

st_FirstVariant.exit.thread127:                   ; preds = %if.then.i99
  tail call void @subst_CloseVariables(ptr noundef %Context, ptr noundef nonnull %19) #9
  br label %while.body

for.inc.i:                                        ; preds = %if.then.i.i, %while.end.i.i
  %35 = phi i32 [ 0, %while.end.i.i ], [ %dec.i.i.i, %if.then.i.i ]
  %36 = phi i32 [ %32, %while.end.i.i ], [ %34, %if.then.i.i ]
  %Subnodes.addr.0.val33.i = load ptr, ptr %Subnodes.addr.046.i, align 8
  %cmp.i.not.i100 = icmp eq ptr %Subnodes.addr.0.val33.i, null
  br i1 %cmp.i.not.i100, label %st_FirstVariant.exit, label %for.body.i, !llvm.loop !7
...
while.body:                                       ; preds = %st_FirstVariant.exit.thread127, %st_FirstVariant.exit
  ...
  %37 = getelementptr i8, ptr %retval.2.i132, i64 24
  %call15.val = load i16, ptr %37, align 8
  %conv18 = zext i16 %call15.val to i32
  %cmp20 = icmp ugt i32 %conv5, %conv18
  br i1 %cmp20, label %if.then22, label %if.else23

if.then22:                                        ; preds = %while.body
  store i16 %conv, ptr %37, align 8
  br label %if.end31

if.else23:                                        ; preds = %while.body
  %38 = getelementptr i8, ptr %retval.2.i132, i64 26
  %call15.val94 = load i16, ptr %38, align 2
  %conv25 = zext i16 %call15.val94 to i32
  %cmp27 = icmp ult i32 %conv5, %conv25
  br i1 %cmp27, label %if.then29, label %if.end31

if.then29:                                        ; preds = %if.else23
  store i16 %conv, ptr %38, align 2
  br label %if.end31

if.end31:                                         ; preds = %if.else23, %if.then29, %if.then22
  %39 = getelementptr i8, ptr %retval.2.i132, i64 16
  %StIndex.addr.0.val = load ptr, ptr %39, align 8
  %cmp.i.i.not = icmp eq ptr %StIndex.addr.0.val, null
  br i1 %cmp.i.i.not, label %land.rhs, label %while.end, !llvm.loop !8

while.end:                                        ; preds = %if.end31, %if.end13
  %40 = phi ptr [ %StIndex.addr.0.val151, %if.end13 ], [ %StIndex.addr.0.val, %if.end31 ]
  ...
  %41 = load i32, ptr @cont_BINDINGS, align 4
  %cmp33 = icmp eq i32 %41, 0
  br i1 %cmp33, label %if.then39, label %if.else42

if.then39:                                        ; preds = %while.end
  %42 = getelementptr i8, ptr %StIndex.addr.0.lcssa, i64 16
  ...
  store ptr %40, ptr %call.i, align 8
  store ptr %call.i, ptr %42, align 8
  br label %if.end60
...
if.then44:                                        ; preds = %if.else42
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %SubstOld) #9
  call void @llvm.lifetime.start.p0(i64 8, ptr nonnull %SubstNew) #9
  %43 = getelementptr i8, ptr %BestNonVariant.4138, i64 16
...
if.then47:                                        ; preds = %if.then44
  ...
  %44 = load ptr, ptr %subnodes48, align 8
  tail call fastcc void @st_CloseUsedVariables(ptr noundef %Context, ptr noundef %44)
  br label %if.end49

if.end49:                                         ; preds = %if.then47, %if.then44
  %45 = load ptr, ptr %BestNonVariant.4138, align 8
  %call50 = call ptr @subst_ComGen(ptr noundef %Context, ptr noundef %45, ptr noundef nonnull %SubstOld, ptr noundef nonnull %SubstNew) #9
  %46 = load ptr, ptr %SubstOld, align 8
  %47 = load ptr, ptr %SubstNew, align 8
  %call51 = call ptr @subst_CloseOpenVariables(ptr noundef %47) #9
  %call.i.i = call ptr @memory_Malloc(i32 noundef 32) #9
  store ptr %46, ptr %call.i.i, align 8
  %48 = load ptr, ptr %43, align 8
  %entries1.i = getelementptr inbounds %struct.st, ptr %call.i.i, i64 0, i32 2
  store ptr %48, ptr %entries1.i, align 8
  %subnodes.i = getelementptr inbounds %struct.st, ptr %BestNonVariant.4138, i64 0, i32 1
  %49 = load ptr, ptr %subnodes.i, align 8
  %subnodes2.i = getelementptr inbounds %struct.st, ptr %call.i.i, i64 0, i32 1
  store ptr %49, ptr %subnodes2.i, align 8
  %50 = getelementptr i8, ptr %BestNonVariant.4138, i64 24
  %StIndex.val43.i = load i16, ptr %50, align 8
  %max.i.i = getelementptr inbounds %struct.st, ptr %call.i.i, i64 0, i32 3
  store i16 %StIndex.val43.i, ptr %max.i.i, align 8
  %51 = getelementptr i8, ptr %BestNonVariant.4138, i64 26
  %StIndex.val45.i = load i16, ptr %51, align 2
  %min.i.i = getelementptr inbounds %struct.st, ptr %call.i.i, i64 0, i32 4
  store i16 %StIndex.val45.i, ptr %min.i.i, align 2
  %52 = load ptr, ptr %BestNonVariant.4138, align 8
  call void @subst_Delete(ptr noundef %52) #9
  store ptr %call50, ptr %BestNonVariant.4138, align 8
  store ptr null, ptr %43, align 8
  %call.i.i.i = call ptr @memory_Malloc(i32 noundef 32) #9
  %subnodes.i.i = getelementptr inbounds %struct.st, ptr %call.i.i.i, i64 0, i32 1
  store ptr null, ptr %subnodes.i.i, align 8
  %call.i.i.i.i = call ptr @memory_Malloc(i32 noundef 16) #9
  ...
  %call.i.i46.i = call ptr @memory_Malloc(i32 noundef 16) #9
  ...
  %call.i47.i = call ptr @memory_Malloc(i32 noundef 16) #9
...
if.then21.i:                                      ; preds = %if.else.i
  store i16 %conv, ptr %51, align 2
  br label %st_NodeAddInner.exit

st_NodeAddInner.exit:                             ; preds = %if.then.i108, %if.else.i, %if.then21.i
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %SubstNew) #9
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %SubstOld) #9
  br label %if.end60

if.else52:                                        ; preds = %land.rhs, %if.else42
  %StIndex.addr.0145 = phi ptr [ %StIndex.addr.0146, %if.else42 ], [ %StIndex.addr.0153, %land.rhs ]
  %call54 = tail call ptr @subst_CloseOpenVariables(ptr noundef null) #9
  %call.i.i109 = tail call ptr @memory_Malloc(i32 noundef 32) #9
  %subnodes.i110 = getelementptr inbounds %struct.st, ptr %call.i.i109, i64 0, i32 1
  store ptr null, ptr %subnodes.i110, align 8
  %call.i.i.i111 = tail call ptr @memory_Malloc(i32 noundef 16) #9
  ...
  %53 = load ptr, ptr %subnodes56, align 8
  %call.i116 = tail call ptr @memory_Malloc(i32 noundef 16) #9
  %car.i117 = getelementptr inbounds %struct.LIST_HELP, ptr %call.i116, i64 0, i32 1
  store ptr %call.i.i109, ptr %car.i117, align 8
  store ptr %53, ptr %call.i116, align 8
...
if.end60:                                         ; preds = %st_NodeAddInner.exit, %if.else52, %if.then39
  ...
  %tobool.not2.i = icmp eq ptr %54, null
...
while.body.i:                                     ; preds = %while.body.i, %while.body.preheader.i
  %55 = phi ptr [ %58, %while.body.i ], [ %54, %while.body.preheader.i ]
  ...
  %call.val.i.i.i = load ptr, ptr %56, align 8
  store ptr %call.val.i.i.i, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i = getelementptr inbounds %struct.binding, ptr %55, i64 0, i32 1
  ...
  %link.i.i.i.i = getelementptr inbounds %struct.binding, ptr %57, i64 0, i32 4
...
while.body.i:                                     ; preds = %if.else, %while.body.i
  %Current.06.i = phi ptr [ %Current.0.val.i, %while.body.i ], [ %StIndex.val, %if.else ]
...
if.else2:                                         ; preds = %if.else
  ...
  tail call void @list_DeleteWithElement(ptr noundef %6, ptr noundef nonnull @st_IndexDelete) #9
  br label %if.end3

if.end3:                                          ; preds = %while.body.i, %if.else2
  %7 = load ptr, ptr %StIndex, align 8
  tail call void @subst_Delete(ptr noundef %7) #9
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 4, ptr nonnull %Found) #9
  tail call void @cont_Check() #9
  ...
  %subnodes = getelementptr inbounds %struct.st, ptr %StIndex, i64 0, i32 1
  %Subnodes.0111 = load ptr, ptr %subnodes, align 8
  %cmp.i.not112 = icmp eq ptr %Subnodes.0111, null
  br i1 %cmp.i.not112, label %for.end49, label %for.body.preheader

for.body.preheader:                               ; preds = %entry
  %.pre = load i32, ptr @cont_STACKPOINTER, align 4
  br label %for.body

for.body:                                         ; preds = %for.body.preheader, %for.inc47
  %2 = phi i32 [ %28, %for.inc47 ], [ %.pre, %for.body.preheader ]
  %3 = phi i32 [ %29, %for.inc47 ], [ %inc.i, %for.body.preheader ]
  %Subnodes.0113 = phi ptr [ %Subnodes.0, %for.inc47 ], [ %Subnodes.0111, %for.body.preheader ]
  %4 = getelementptr i8, ptr %Subnodes.0113, i64 8
  ...
  %call4 = tail call i32 @subst_Variation(ptr noundef %Context, ptr noundef %5) #9
...
if.then8:                                         ; preds = %if.then
  %7 = load ptr, ptr %subnodes, align 8
  %call10 = tail call ptr @list_PointerDeleteElement(ptr noundef %7, ptr noundef null) #9
...
if.then15:                                        ; preds = %if.then8
  ...
  %Subnodes.1114 = load ptr, ptr %call10, align 8
  %cmp.i91.not115 = icmp eq ptr %Subnodes.1114, null
  br i1 %cmp.i91.not115, label %for.end49, label %for.body25

for.body25:                                       ; preds = %if.then15, %for.inc
  %StIndex.val84121 = phi i16 [ %StIndex.val84120, %for.inc ], [ %call17.val86, %if.then15 ]
  %StIndex.val118 = phi i16 [ %StIndex.val117, %for.inc ], [ %call17.val, %if.then15 ]
  %Subnodes.1116 = phi ptr [ %Subnodes.1, %for.inc ], [ %Subnodes.1114, %if.then15 ]
  %11 = getelementptr i8, ptr %Subnodes.1116, i64 8
  %Subnodes.1.val = load ptr, ptr %11, align 8
  %12 = getelementptr i8, ptr %Subnodes.1.val, i64 24
  %call26.val82 = load i16, ptr %12, align 8
  %cmp = icmp ugt i16 %call26.val82, %StIndex.val118
...
if.end:                                           ; preds = %if.then31, %for.body25
  %StIndex.val117 = phi i16 [ %call26.val82, %if.then31 ], [ %StIndex.val118, %for.body25 ]
  %13 = getelementptr i8, ptr %Subnodes.1.val, i64 26
  %call26.val85 = load i16, ptr %13, align 2
  %cmp37 = icmp ult i16 %call26.val85, %StIndex.val84121
...
for.inc:                                          ; preds = %if.end, %if.then39
  %StIndex.val84120 = phi i16 [ %StIndex.val84121, %if.end ], [ %call26.val85, %if.then39 ]
  %Subnodes.1 = load ptr, ptr %Subnodes.1116, align 8
...
while.end.i:                                      ; preds = %while.body.i.prol.loopexit, %while.body.i, %if.end45
  ...
  br i1 %cmp.i.not.i, label %for.inc47, label %if.then.i
...
for.inc47:                                        ; preds = %while.end.i, %if.then.i
  %28 = phi i32 [ 0, %while.end.i ], [ %dec.i.i, %if.then.i ]
  %29 = phi i32 [ %25, %while.end.i ], [ %27, %if.then.i ]
  %Subnodes.0 = load ptr, ptr %Subnodes.0113, align 8
  %cmp.i.not = icmp eq ptr %Subnodes.0, null
  br i1 %cmp.i.not, label %for.end49, label %for.body, !llvm.loop !14

for.end49:                                        ; preds = %for.inc47, %for.inc, %entry, %if.then15, %if.else
  %30 = phi i32 [ 0, %entry ], [ %6, %if.then15 ], [ %6, %if.else ], [ %6, %for.inc ], [ 0, %for.inc47 ]
...
cont_Reset.exit:                                  ; preds = %while.body.i104, %for.end49
  ...
  store i32 1, ptr @cont_STACKPOINTER, align 4
  store i32 2000, ptr @cont_INDEXVARSCANNER, align 4
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %Found) #9
  ret i32 %30
}
...
if.then:                                          ; preds = %entry
  %call1 = tail call i32 @list_DeleteFromList(ptr noundef nonnull %0, ptr noundef %Pointer) #9
...
if.else6:                                         ; preds = %entry
  %subnodes = getelementptr inbounds %struct.st, ptr %StIndex, i64 0, i32 1
  %Subnodes.0125 = load ptr, ptr %subnodes, align 8
  %cmp.i108.not126 = icmp eq ptr %Subnodes.0125, null
  br i1 %cmp.i108.not126, label %return, label %for.body.preheader

for.body.preheader:                               ; preds = %if.else6
  %.pre = load i32, ptr @cont_BINDINGS, align 4
  %.pre137 = load i32, ptr @cont_STACKPOINTER, align 4
  br label %for.body

for.body:                                         ; preds = %for.body.preheader, %for.inc58
  %2 = phi i32 [ %39, %for.inc58 ], [ %.pre137, %for.body.preheader ]
  %3 = phi i32 [ %40, %for.inc58 ], [ %.pre, %for.body.preheader ]
  %Subnodes.0127 = phi ptr [ %Subnodes.0, %for.inc58 ], [ %Subnodes.0125, %for.body.preheader ]
  %4 = getelementptr i8, ptr %Subnodes.0127, i64 8
  %Subnodes.0.val = load ptr, ptr %4, align 8
  %inc.i.i = add nsw i32 %2, 1
  store i32 %inc.i.i, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i = sext i32 %2 to i64
  ...
  store i32 0, ptr @cont_BINDINGS, align 4
  %5 = load ptr, ptr %Subnodes.0.val, align 8
  %call11 = tail call i32 @subst_Variation(ptr noundef %Context, ptr noundef %5) #9
...
if.then16:                                        ; preds = %if.then13
  %call18 = tail call i32 @list_DeleteFromList(ptr noundef nonnull %subnodes, ptr noundef null) #9
  %tobool19.not = icmp eq i32 %call18, 0
  %.pre138 = load ptr, ptr %subnodes, align 8
  br i1 %tobool19.not, label %if.end26, label %if.then20

if.then20:                                        ; preds = %if.then16
  %.val107 = load ptr, ptr %.pre138, align 8
  %cmp.i110.not = icmp eq ptr %.val107, null
  br i1 %cmp.i110.not, label %if.then25, label %if.end26

if.then25:                                        ; preds = %if.then20
  %7 = getelementptr i8, ptr %.pre138, i64 8
  %.val.i = load ptr, ptr %7, align 8
  %8 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  %total_size.i.i.i.i143 = getelementptr inbounds %struct.MEMORY_RESOURCEHELP, ptr %8, i64 0, i32 4
  %9 = load i32, ptr %total_size.i.i.i.i143, align 8
  %conv26.i.i.i.i144 = sext i32 %9 to i64
  %10 = load i64, ptr @memory_FREEDBYTES, align 8
  %add27.i.i.i.i145 = add i64 %10, %conv26.i.i.i.i144
  store i64 %add27.i.i.i.i145, ptr @memory_FREEDBYTES, align 8
  %11 = load ptr, ptr %8, align 8
  store ptr %11, ptr %.pre138, align 8
  %12 = load ptr, ptr getelementptr inbounds ([0 x ptr], ptr @memory_ARRAY, i64 0, i64 16), align 8
  store ptr %.pre138, ptr %12, align 8
  %13 = load ptr, ptr %.val.i, align 8
  %14 = load ptr, ptr %StIndex, align 8
  %call3.i = tail call ptr @subst_Merge(ptr noundef %13, ptr noundef %14) #9
...
if.end26:                                         ; preds = %if.then16, %if.then20
  %19 = getelementptr i8, ptr %.pre138, i64 8
  ...
  %Subnodes.1128 = load ptr, ptr %.pre138, align 8
  %cmp.i112.not129 = icmp eq ptr %Subnodes.1128, null
  br i1 %cmp.i112.not129, label %return, label %for.body36

for.body36:                                       ; preds = %if.end26, %for.inc
  %StIndex.val101135 = phi i16 [ %StIndex.val101134, %for.inc ], [ %call28.val103, %if.end26 ]
  %StIndex.val132 = phi i16 [ %StIndex.val131, %for.inc ], [ %call28.val, %if.end26 ]
  %Subnodes.1130 = phi ptr [ %Subnodes.1, %for.inc ], [ %Subnodes.1128, %if.end26 ]
  %22 = getelementptr i8, ptr %Subnodes.1130, i64 8
  %Subnodes.1.val = load ptr, ptr %22, align 8
  %23 = getelementptr i8, ptr %Subnodes.1.val, i64 24
  %call37.val99 = load i16, ptr %23, align 8
  %cmp = icmp ugt i16 %call37.val99, %StIndex.val132
...
if.end44:                                         ; preds = %if.then42, %for.body36
  %StIndex.val131 = phi i16 [ %call37.val99, %if.then42 ], [ %StIndex.val132, %for.body36 ]
  %24 = getelementptr i8, ptr %Subnodes.1.val, i64 26
  %call37.val102 = load i16, ptr %24, align 2
  %cmp49 = icmp ult i16 %call37.val102, %StIndex.val101135
...
for.inc:                                          ; preds = %if.end44, %if.then51
  %StIndex.val101134 = phi i16 [ %StIndex.val101135, %if.end44 ], [ %call37.val102, %if.then51 ]
  %Subnodes.1 = load ptr, ptr %Subnodes.1130, align 8
...
while.end.i:                                      ; preds = %while.body.i.prol.loopexit, %while.body.i, %if.end56
  ...
  %cmp.i.not.i = icmp eq i32 %37, 0
  br i1 %cmp.i.not.i, label %for.inc58, label %if.then.i

if.then.i:                                        ; preds = %while.end.i
  %dec.i.i = add nsw i32 %37, -1
  store i32 %dec.i.i, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i117 = sext i32 %dec.i.i to i64
  %arrayidx.i.i118 = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i117
  %38 = load i32, ptr %arrayidx.i.i118, align 4
  store i32 %38, ptr @cont_BINDINGS, align 4
  br label %for.inc58

for.inc58:                                        ; preds = %while.end.i, %if.then.i
  %39 = phi i32 [ 0, %while.end.i ], [ %dec.i.i, %if.then.i ]
  %40 = phi i32 [ %36, %while.end.i ], [ %38, %if.then.i ]
  %Subnodes.0 = load ptr, ptr %Subnodes.0127, align 8
...
return.sink.split:                                ; preds = %if.then, %if.then25
  ...
  tail call void @subst_Delete(ptr noundef %41) #9
...
return:                                           ; preds = %for.inc58, %for.inc, %return.sink.split, %if.else6, %if.end26, %if.then
  %retval.3 = phi ptr [ %StIndex, %if.then ], [ %StIndex, %if.end26 ], [ %StIndex, %if.else6 ], [ %retval.3.ph, %return.sink.split ], [ %StIndex, %for.inc ], [ %StIndex, %for.inc58 ]
  ret ptr %retval.3
}
...
for.cond.i:                                       ; preds = %for.cond.i.backedge, %entry
  ...
  %cmp.i.not.i = icmp eq ptr %CurrentList.0.i, null
  br i1 %cmp.i.not.i, label %if.then.i, label %if.end8.i
...
cont_StopAndBackTrack.exit.i:                     ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i, %if.then.i
  ...
  %cmp.i43.not.i = icmp eq i32 %17, %3
  br i1 %cmp.i43.not.i, label %st_TraverseTreeUnifier.exit, label %if.end.i
...
if.end8.i:                                        ; preds = %if.end.i, %for.cond.i
  ...
  %call116.i = tail call i32 @subst_Unify(ptr noundef %IndexContext, ptr noundef %19) #9
...
if.end.i.i:                                       ; preds = %for.body.i
  %cmp.i20.not.i.i = icmp eq ptr %Result.0.i, null
  %call4.i.i = tail call ptr @list_Copy(ptr noundef nonnull %CurrentNode.0.val.i) #9
  br i1 %cmp.i20.not.i.i, label %for.end.i, label %for.cond.i.i
...
if.else.i:                                        ; preds = %for.body.i
  ...
  %cmp.i45.not.i = icmp eq ptr %CurrentList.2.val39.i, null
  br i1 %cmp.i45.not.i, label %if.else22.i, label %if.then20.i
...
if.then20.i:                                      ; preds = %if.else.i
  ...
  %idxprom.i47.i = zext i32 %21 to i64
  %arrayidx.i48.i = getelementptr inbounds [10000 x ptr], ptr @stack_STACK, i64 0, i64 %idxprom.i47.i
  store ptr %CurrentList.2.val39.i, ptr %arrayidx.i48.i, align 8
  %22 = load i32, ptr @cont_BINDINGS, align 4
  %23 = load i32, ptr @cont_STACKPOINTER, align 4
  %inc.i.i49.i = add nsw i32 %23, 1
  store i32 %inc.i.i49.i, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i50.i = sext i32 %23 to i64
  %arrayidx.i.i51.i = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i50.i
  store i32 %22, ptr %arrayidx.i.i51.i, align 4
  br label %for.inc.i

if.else22.i:                                      ; preds = %if.else.i
  %24 = load i32, ptr @cont_STACKPOINTER, align 4
  %sub.i.i.i = add nsw i32 %24, -1
  %idxprom.i.i52.i = sext i32 %sub.i.i.i to i64
  %arrayidx.i.i53.i = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i52.i
  %25 = load i32, ptr %arrayidx.i.i53.i, align 4
  %26 = load i32, ptr @cont_BINDINGS, align 4
  %add.i.i = add nsw i32 %26, %25
  store i32 %add.i.i, ptr %arrayidx.i.i53.i, align 4
  br label %for.inc.i
...
for.inc.i:                                        ; preds = %if.else22.i, %if.then20.i
  ...
  %call11.i = tail call i32 @subst_Unify(ptr noundef %IndexContext, ptr noundef %28) #9
...
for.end.i:                                        ; preds = %for.inc.i, %for.end.i.i, %if.end.i.i, %if.end8.i
  ...
  %.pr.i.i = load i32, ptr @cont_BINDINGS, align 4
  %cmp1.i54.i = icmp sgt i32 %.pr.i.i, 0
  br i1 %cmp1.i54.i, label %while.body.i60.i.preheader, label %for.cond.i.backedge

for.cond.i.backedge:                              ; preds = %while.body.i60.i.prol.loopexit, %while.body.i60.i, %for.end.i
  br label %for.cond.i

while.body.i60.i.preheader:                       ; preds = %for.end.i
  %xtraiter17 = and i32 %.pr.i.i, 1
  %lcmp.mod18.not = icmp eq i32 %xtraiter17, 0
  br i1 %lcmp.mod18.not, label %while.body.i60.i.prol.loopexit, label %while.body.i60.i.prol

while.body.i60.i.prol:                            ; preds = %while.body.i60.i.preheader
  %29 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %29, ptr @cont_CURRENTBINDING, align 8
  %30 = getelementptr i8, ptr %29, i64 24
  %call.val.i.i.i55.i.prol = load ptr, ptr %30, align 8
  store ptr %call.val.i.i.i55.i.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i56.i.prol = getelementptr inbounds %struct.binding, ptr %29, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i56.i.prol, i8 0, i64 20, i1 false)
  %31 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i57.i.prol = getelementptr inbounds %struct.binding, ptr %31, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i57.i.prol, align 8
  %dec.i.i.i58.i.prol = add nsw i32 %.pr.i.i, -1
  store i32 %dec.i.i.i58.i.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i60.i.prol.loopexit

while.body.i60.i.prol.loopexit:                   ; preds = %while.body.i60.i.prol, %while.body.i60.i.preheader
  %.unr = phi i32 [ %.pr.i.i, %while.body.i60.i.preheader ], [ %dec.i.i.i58.i.prol, %while.body.i60.i.prol ]
  %32 = icmp eq i32 %.pr.i.i, 1
  br i1 %32, label %for.cond.i.backedge, label %while.body.i60.i

while.body.i60.i:                                 ; preds = %while.body.i60.i.prol.loopexit, %while.body.i60.i
  %33 = phi i32 [ %dec.i.i.i58.i.1, %while.body.i60.i ], [ %.unr, %while.body.i60.i.prol.loopexit ]
  %34 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %34, ptr @cont_CURRENTBINDING, align 8
  %35 = getelementptr i8, ptr %34, i64 24
  %call.val.i.i.i55.i = load ptr, ptr %35, align 8
  store ptr %call.val.i.i.i55.i, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i56.i = getelementptr inbounds %struct.binding, ptr %34, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i56.i, i8 0, i64 20, i1 false)
  %36 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i57.i = getelementptr inbounds %struct.binding, ptr %36, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i57.i, align 8
  %dec.i.i.i58.i = add nsw i32 %33, -1
  store i32 %dec.i.i.i58.i, ptr @cont_BINDINGS, align 4
  %37 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %37, ptr @cont_CURRENTBINDING, align 8
  %38 = getelementptr i8, ptr %37, i64 24
  %call.val.i.i.i55.i.1 = load ptr, ptr %38, align 8
  store ptr %call.val.i.i.i55.i.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i56.i.1 = getelementptr inbounds %struct.binding, ptr %37, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i56.i.1, i8 0, i64 20, i1 false)
  %39 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i57.i.1 = getelementptr inbounds %struct.binding, ptr %39, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i57.i.1, align 8
  %dec.i.i.i58.i.1 = add nsw i32 %33, -2
  store i32 %dec.i.i.i58.i.1, ptr @cont_BINDINGS, align 4
  %cmp.i59.i.1 = icmp ugt i32 %dec.i.i.i58.i, 1
  br i1 %cmp.i59.i.1, label %while.body.i60.i, label %for.cond.i.backedge, !llvm.loop !20
...
cont_StopAndBackTrack.exit.i:                     ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i, %if.then.i
  ...
  %cmp.i42.not.i = icmp eq i32 %18, %4
  br i1 %cmp.i42.not.i, label %st_TraverseTreeGen.exit, label %if.end.i
...
if.end8.i:                                        ; preds = %if.end.i, %for.cond.i
  ...
  %call116.i = tail call i32 @subst_Match(ptr noundef %IndexContext, ptr noundef %20) #9
  %tobool12.not7.i = icmp eq i32 %call116.i, 0
  br i1 %tobool12.not7.i, label %for.end.i, label %for.body.i
...
if.then19.i:                                      ; preds = %if.else.i
  ...
  store i32 %inc.i.i, ptr @stack_POINTER, align 4
  %idxprom.i44.i = zext i32 %22 to i64
  %arrayidx.i45.i = getelementptr inbounds [10000 x ptr], ptr @stack_STACK, i64 0, i64 %idxprom.i44.i
  store ptr %CurrentList.2.val38.i, ptr %arrayidx.i45.i, align 8
  %23 = load i32, ptr @cont_BINDINGS, align 4
  %24 = load i32, ptr @cont_STACKPOINTER, align 4
  %inc.i.i46.i = add nsw i32 %24, 1
  store i32 %inc.i.i46.i, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i47.i = sext i32 %24 to i64
  %arrayidx.i.i48.i = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i47.i
  store i32 %23, ptr %arrayidx.i.i48.i, align 4
  br label %for.inc.i

if.else21.i:                                      ; preds = %if.else.i
  %25 = load i32, ptr @cont_STACKPOINTER, align 4
  %sub.i.i.i = add nsw i32 %25, -1
  %idxprom.i.i49.i = sext i32 %sub.i.i.i to i64
  %arrayidx.i.i50.i = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i49.i
  %26 = load i32, ptr %arrayidx.i.i50.i, align 4
  %27 = load i32, ptr @cont_BINDINGS, align 4
  %add.i.i = add nsw i32 %27, %26
  store i32 %add.i.i, ptr %arrayidx.i.i50.i, align 4
  br label %for.inc.i
...
for.inc.i:                                        ; preds = %if.else21.i, %if.then19.i
  ...
  %call11.i = tail call i32 @subst_Match(ptr noundef %IndexContext, ptr noundef %29) #9
  %tobool12.not.i = icmp eq i32 %call11.i, 0
...
for.end.i:                                        ; preds = %for.inc.i, %for.end.i.i, %if.end.i.i, %if.end8.i
  ...
  %CurrentList.2.val.i = load ptr, ptr %CurrentList.23.i, align 8
  %.pr.i.i = load i32, ptr @cont_BINDINGS, align 4
  %cmp1.i51.i = icmp sgt i32 %.pr.i.i, 0
  br i1 %cmp1.i51.i, label %while.body.i57.i.preheader, label %for.cond.i.backedge

for.cond.i.backedge:                              ; preds = %while.body.i57.i.prol.loopexit, %while.body.i57.i, %for.end.i
  br label %for.cond.i

while.body.i57.i.preheader:                       ; preds = %for.end.i
  %xtraiter18 = and i32 %.pr.i.i, 1
  %lcmp.mod19.not = icmp eq i32 %xtraiter18, 0
  br i1 %lcmp.mod19.not, label %while.body.i57.i.prol.loopexit, label %while.body.i57.i.prol

while.body.i57.i.prol:                            ; preds = %while.body.i57.i.preheader
  %30 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %30, ptr @cont_CURRENTBINDING, align 8
  %31 = getelementptr i8, ptr %30, i64 24
  %call.val.i.i.i52.i.prol = load ptr, ptr %31, align 8
  store ptr %call.val.i.i.i52.i.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i53.i.prol = getelementptr inbounds %struct.binding, ptr %30, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i53.i.prol, i8 0, i64 20, i1 false)
  %32 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i54.i.prol = getelementptr inbounds %struct.binding, ptr %32, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i54.i.prol, align 8
  %dec.i.i.i55.i.prol = add nsw i32 %.pr.i.i, -1
  store i32 %dec.i.i.i55.i.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i57.i.prol.loopexit

while.body.i57.i.prol.loopexit:                   ; preds = %while.body.i57.i.prol, %while.body.i57.i.preheader
  %.unr = phi i32 [ %.pr.i.i, %while.body.i57.i.preheader ], [ %dec.i.i.i55.i.prol, %while.body.i57.i.prol ]
  %33 = icmp eq i32 %.pr.i.i, 1
  br i1 %33, label %for.cond.i.backedge, label %while.body.i57.i

while.body.i57.i:                                 ; preds = %while.body.i57.i.prol.loopexit, %while.body.i57.i
  %34 = phi i32 [ %dec.i.i.i55.i.1, %while.body.i57.i ], [ %.unr, %while.body.i57.i.prol.loopexit ]
  %35 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %35, ptr @cont_CURRENTBINDING, align 8
  %36 = getelementptr i8, ptr %35, i64 24
  %call.val.i.i.i52.i = load ptr, ptr %36, align 8
  store ptr %call.val.i.i.i52.i, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i53.i = getelementptr inbounds %struct.binding, ptr %35, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i53.i, i8 0, i64 20, i1 false)
  %37 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i54.i = getelementptr inbounds %struct.binding, ptr %37, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i54.i, align 8
  %dec.i.i.i55.i = add nsw i32 %34, -1
  store i32 %dec.i.i.i55.i, ptr @cont_BINDINGS, align 4
  %38 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %38, ptr @cont_CURRENTBINDING, align 8
  %39 = getelementptr i8, ptr %38, i64 24
  %call.val.i.i.i52.i.1 = load ptr, ptr %39, align 8
  store ptr %call.val.i.i.i52.i.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i53.i.1 = getelementptr inbounds %struct.binding, ptr %38, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i53.i.1, i8 0, i64 20, i1 false)
  %40 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i54.i.1 = getelementptr inbounds %struct.binding, ptr %40, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i54.i.1, align 8
  %dec.i.i.i55.i.1 = add nsw i32 %34, -2
  store i32 %dec.i.i.i55.i.1, ptr @cont_BINDINGS, align 4
  %cmp.i56.i.1 = icmp ugt i32 %dec.i.i.i55.i, 1
  br i1 %cmp.i56.i.1, label %while.body.i57.i, label %for.cond.i.backedge, !llvm.loop !20
...
entry:
  ...
  %inc.i = add nsw i32 %2, 1
  store i32 %inc.i, ptr @cont_BINDINGS, align 4
  %call3 = tail call i32 @term_ComputeSize(ptr noundef %Term) #9
...
cont_StopAndBackTrack.exit.i:                     ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i, %if.then.i
  ...
  %cmp.i47.not.i = icmp eq i32 %19, %4
  br i1 %cmp.i47.not.i, label %st_TraverseTreeGenPreTest.exit, label %if.end.i
...
land.rhs.i:                                       ; preds = %if.end8.i, %for.inc.i
  ...
  %call14.i = tail call i32 @subst_Match(ptr noundef %IndexContext, ptr noundef %22) #9
...
if.end.i.i:                                       ; preds = %for.body.i
  %cmp.i20.not.i.i = icmp eq ptr %Result.0.i, null
  %call4.i.i = tail call ptr @list_Copy(ptr noundef nonnull %CurrentNode.0.val41.i) #9
  br i1 %cmp.i20.not.i.i, label %for.end.i, label %for.cond.i.i
...
if.then22.i:                                      ; preds = %if.else.i
  ...
  store i32 %inc.i.i, ptr @stack_POINTER, align 4
  %idxprom.i49.i = zext i32 %24 to i64
  %arrayidx.i50.i = getelementptr inbounds [10000 x ptr], ptr @stack_STACK, i64 0, i64 %idxprom.i49.i
  store ptr %CurrentList.2.val43.i, ptr %arrayidx.i50.i, align 8
  %25 = load i32, ptr @cont_BINDINGS, align 4
  %26 = load i32, ptr @cont_STACKPOINTER, align 4
  %inc.i.i51.i = add nsw i32 %26, 1
  store i32 %inc.i.i51.i, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i52.i = sext i32 %26 to i64
  %arrayidx.i.i53.i = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i52.i
  store i32 %25, ptr %arrayidx.i.i53.i, align 4
  br label %for.inc.i

if.else24.i:                                      ; preds = %if.else.i
  %27 = load i32, ptr @cont_STACKPOINTER, align 4
  %sub.i.i.i = add nsw i32 %27, -1
  %idxprom.i.i54.i = sext i32 %sub.i.i.i to i64
  %arrayidx.i.i55.i = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i54.i
  %28 = load i32, ptr %arrayidx.i.i55.i, align 4
  %29 = load i32, ptr @cont_BINDINGS, align 4
  %add.i.i = add nsw i32 %29, %28
  store i32 %add.i.i, ptr %arrayidx.i.i55.i, align 4
  br label %for.inc.i
...
for.end.i:                                        ; preds = %for.inc.i, %land.rhs.i, %for.end.i.i, %if.end.i.i, %if.end8.i
  ...
  %CurrentList.2.val.i = load ptr, ptr %CurrentList.23.i, align 8
  %.pr.i.i = load i32, ptr @cont_BINDINGS, align 4
  %cmp1.i56.i = icmp sgt i32 %.pr.i.i, 0
  br i1 %cmp1.i56.i, label %while.body.i62.i.preheader, label %for.cond.i.backedge

for.cond.i.backedge:                              ; preds = %while.body.i62.i.prol.loopexit, %while.body.i62.i, %for.end.i
  br label %for.cond.i

while.body.i62.i.preheader:                       ; preds = %for.end.i
  %xtraiter15 = and i32 %.pr.i.i, 1
  %lcmp.mod16.not = icmp eq i32 %xtraiter15, 0
  br i1 %lcmp.mod16.not, label %while.body.i62.i.prol.loopexit, label %while.body.i62.i.prol

while.body.i62.i.prol:                            ; preds = %while.body.i62.i.preheader
  %32 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %32, ptr @cont_CURRENTBINDING, align 8
  %33 = getelementptr i8, ptr %32, i64 24
  %call.val.i.i.i57.i.prol = load ptr, ptr %33, align 8
  store ptr %call.val.i.i.i57.i.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i58.i.prol = getelementptr inbounds %struct.binding, ptr %32, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i58.i.prol, i8 0, i64 20, i1 false)
  %34 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i59.i.prol = getelementptr inbounds %struct.binding, ptr %34, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i59.i.prol, align 8
  %dec.i.i.i60.i.prol = add nsw i32 %.pr.i.i, -1
  store i32 %dec.i.i.i60.i.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i62.i.prol.loopexit

while.body.i62.i.prol.loopexit:                   ; preds = %while.body.i62.i.prol, %while.body.i62.i.preheader
  %.unr = phi i32 [ %.pr.i.i, %while.body.i62.i.preheader ], [ %dec.i.i.i60.i.prol, %while.body.i62.i.prol ]
  %35 = icmp eq i32 %.pr.i.i, 1
  br i1 %35, label %for.cond.i.backedge, label %while.body.i62.i

while.body.i62.i:                                 ; preds = %while.body.i62.i.prol.loopexit, %while.body.i62.i
  %36 = phi i32 [ %dec.i.i.i60.i.1, %while.body.i62.i ], [ %.unr, %while.body.i62.i.prol.loopexit ]
  %37 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %37, ptr @cont_CURRENTBINDING, align 8
  %38 = getelementptr i8, ptr %37, i64 24
  %call.val.i.i.i57.i = load ptr, ptr %38, align 8
  store ptr %call.val.i.i.i57.i, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i58.i = getelementptr inbounds %struct.binding, ptr %37, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i58.i, i8 0, i64 20, i1 false)
  %39 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i59.i = getelementptr inbounds %struct.binding, ptr %39, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i59.i, align 8
  %dec.i.i.i60.i = add nsw i32 %36, -1
  store i32 %dec.i.i.i60.i, ptr @cont_BINDINGS, align 4
  %40 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %40, ptr @cont_CURRENTBINDING, align 8
  %41 = getelementptr i8, ptr %40, i64 24
  %call.val.i.i.i57.i.1 = load ptr, ptr %41, align 8
  store ptr %call.val.i.i.i57.i.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i58.i.1 = getelementptr inbounds %struct.binding, ptr %40, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i58.i.1, i8 0, i64 20, i1 false)
  %42 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i59.i.1 = getelementptr inbounds %struct.binding, ptr %42, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i59.i.1, align 8
  %dec.i.i.i60.i.1 = add nsw i32 %36, -2
  store i32 %dec.i.i.i60.i.1, ptr @cont_BINDINGS, align 4
  %cmp.i61.i.1 = icmp ugt i32 %dec.i.i.i60.i, 1
  br i1 %cmp.i61.i.1, label %while.body.i62.i, label %for.cond.i.backedge, !llvm.loop !20
...
cont_StopAndBackTrack.exit.i:                     ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i, %if.then.i
  %cont_BINDINGS.promoted.i = phi i32 [ %6, %if.then.i ], [ 0, %while.body.i.i ], [ 0, %while.body.i.i.prol.loopexit ]
  %17 = load i32, ptr @stack_POINTER, align 4
  %cmp.i42.not.i = icmp eq i32 %17, %3
  br i1 %cmp.i42.not.i, label %st_TraverseTreeInstance.exit, label %if.end.i
...
if.end8.i:                                        ; preds = %if.end.i, %for.cond.i
  ...
  %CurrentNode.05.i = load ptr, ptr %CurrentNode.0.in4.i, align 8
  %19 = load ptr, ptr %CurrentNode.05.i, align 8
  %call116.i = tail call i32 @subst_MatchReverse(ptr noundef %IndexContext, ptr noundef %19) #9
  %tobool12.not7.i = icmp eq i32 %call116.i, 0
  br i1 %tobool12.not7.i, label %for.end.i, label %for.body.i
...
if.then19.i:                                      ; preds = %if.else.i
  ...
  %inc.i.i = add i32 %21, 1
  store i32 %inc.i.i, ptr @stack_POINTER, align 4
  %idxprom.i44.i = zext i32 %21 to i64
  %arrayidx.i45.i = getelementptr inbounds [10000 x ptr], ptr @stack_STACK, i64 0, i64 %idxprom.i44.i
  store ptr %CurrentList.2.val38.i, ptr %arrayidx.i45.i, align 8
  %22 = load i32, ptr @cont_BINDINGS, align 4
  %23 = load i32, ptr @cont_STACKPOINTER, align 4
  %inc.i.i46.i = add nsw i32 %23, 1
  store i32 %inc.i.i46.i, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i47.i = sext i32 %23 to i64
  %arrayidx.i.i48.i = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i47.i
  store i32 %22, ptr %arrayidx.i.i48.i, align 4
  br label %for.inc.i
...
if.else21.i:                                      ; preds = %if.else.i
  ...
  %idxprom.i.i49.i = sext i32 %sub.i.i.i to i64
  %arrayidx.i.i50.i = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i49.i
  %25 = load i32, ptr %arrayidx.i.i50.i, align 4
  %26 = load i32, ptr @cont_BINDINGS, align 4
  %add.i.i = add nsw i32 %26, %25
  store i32 %add.i.i, ptr %arrayidx.i.i50.i, align 4
  br label %for.inc.i
...
for.inc.i:                                        ; preds = %if.else21.i, %if.then19.i
  ...
  %CurrentNode.0.i = load ptr, ptr %CurrentNode.0.in.i, align 8
  %28 = load ptr, ptr %CurrentNode.0.i, align 8
  %call11.i = tail call i32 @subst_MatchReverse(ptr noundef %IndexContext, ptr noundef %28) #9
  %tobool12.not.i = icmp eq i32 %call11.i, 0
...
while.body.i57.i.prol:                            ; preds = %while.body.i57.i.preheader
  ...
  store ptr %29, ptr @cont_CURRENTBINDING, align 8
  %30 = getelementptr i8, ptr %29, i64 24
  %call.val.i.i.i52.i.prol = load ptr, ptr %30, align 8
  store ptr %call.val.i.i.i52.i.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i53.i.prol = getelementptr inbounds %struct.binding, ptr %29, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i53.i.prol, i8 0, i64 20, i1 false)
  %31 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i54.i.prol = getelementptr inbounds %struct.binding, ptr %31, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i54.i.prol, align 8
  %dec.i.i.i55.i.prol = add nsw i32 %.pr.i.i, -1
  store i32 %dec.i.i.i55.i.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i57.i.prol.loopexit
...
while.body.i57.i.prol.loopexit:                   ; preds = %while.body.i57.i.prol, %while.body.i57.i.preheader
  %.unr = phi i32 [ %.pr.i.i, %while.body.i57.i.preheader ], [ %dec.i.i.i55.i.prol, %while.body.i57.i.prol ]
  %32 = icmp eq i32 %.pr.i.i, 1
  br i1 %32, label %for.cond.i.backedge, label %while.body.i57.i

while.body.i57.i:                                 ; preds = %while.body.i57.i.prol.loopexit, %while.body.i57.i
  %33 = phi i32 [ %dec.i.i.i55.i.1, %while.body.i57.i ], [ %.unr, %while.body.i57.i.prol.loopexit ]
  %34 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %34, ptr @cont_CURRENTBINDING, align 8
  %35 = getelementptr i8, ptr %34, i64 24
  %call.val.i.i.i52.i = load ptr, ptr %35, align 8
  store ptr %call.val.i.i.i52.i, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i53.i = getelementptr inbounds %struct.binding, ptr %34, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i53.i, i8 0, i64 20, i1 false)
  %36 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i54.i = getelementptr inbounds %struct.binding, ptr %36, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i54.i, align 8
  %dec.i.i.i55.i = add nsw i32 %33, -1
  store i32 %dec.i.i.i55.i, ptr @cont_BINDINGS, align 4
  %37 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %37, ptr @cont_CURRENTBINDING, align 8
  %38 = getelementptr i8, ptr %37, i64 24
  %call.val.i.i.i52.i.1 = load ptr, ptr %38, align 8
  store ptr %call.val.i.i.i52.i.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i53.i.1 = getelementptr inbounds %struct.binding, ptr %37, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i53.i.1, i8 0, i64 20, i1 false)
  %39 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i54.i.1 = getelementptr inbounds %struct.binding, ptr %39, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i54.i.1, align 8
  %dec.i.i.i55.i.1 = add nsw i32 %33, -2
  store i32 %dec.i.i.i55.i.1, ptr @cont_BINDINGS, align 4
  %cmp.i56.i.1 = icmp ugt i32 %dec.i.i.i55.i, 1
  br i1 %cmp.i56.i.1, label %while.body.i57.i, label %for.cond.i.backedge, !llvm.loop !20
...
entry:
  ...
  %inc.i = add nsw i32 %1, 1
  store i32 %inc.i, ptr @cont_BINDINGS, align 4
  %call2 = tail call i32 @term_ComputeSize(ptr noundef %Term) #9
...
cont_StopAndBackTrack.exit.i:                     ; preds = %while.body.i.i.prol.loopexit, %while.body.i.i, %if.then.i
  %cont_BINDINGS.promoted.i = phi i32 [ %7, %if.then.i ], [ 0, %while.body.i.i ], [ 0, %while.body.i.i.prol.loopexit ]
  %18 = load i32, ptr @stack_POINTER, align 4
  %cmp.i47.not.i = icmp eq i32 %18, %3
  br i1 %cmp.i47.not.i, label %st_TraverseTreeInstancePreTest.exit, label %if.end.i
...
land.rhs.i:                                       ; preds = %if.end8.i, %for.inc.i
  ...
  %call14.i = tail call i32 @subst_MatchReverse(ptr noundef %IndexContext, ptr noundef %21) #9
  %tobool15.not.i = icmp eq i32 %call14.i, 0
  br i1 %tobool15.not.i, label %for.end.i, label %for.body.i
...
if.then22.i:                                      ; preds = %if.else.i
  ...
  store i32 %inc.i.i, ptr @stack_POINTER, align 4
  %idxprom.i49.i = zext i32 %23 to i64
  %arrayidx.i50.i = getelementptr inbounds [10000 x ptr], ptr @stack_STACK, i64 0, i64 %idxprom.i49.i
  store ptr %CurrentList.2.val43.i, ptr %arrayidx.i50.i, align 8
  %24 = load i32, ptr @cont_BINDINGS, align 4
  %25 = load i32, ptr @cont_STACKPOINTER, align 4
  %inc.i.i51.i = add nsw i32 %25, 1
  store i32 %inc.i.i51.i, ptr @cont_STACKPOINTER, align 4
  %idxprom.i.i52.i = sext i32 %25 to i64
  %arrayidx.i.i53.i = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i52.i
  store i32 %24, ptr %arrayidx.i.i53.i, align 4
  br label %for.inc.i
...
if.else24.i:                                      ; preds = %if.else.i
  ...
  %idxprom.i.i54.i = sext i32 %sub.i.i.i to i64
  %arrayidx.i.i55.i = getelementptr inbounds [1000 x i32], ptr @cont_STACK, i64 0, i64 %idxprom.i.i54.i
  %27 = load i32, ptr %arrayidx.i.i55.i, align 4
...
while.body.i62.i.prol:                            ; preds = %while.body.i62.i.preheader
  ...
  %call.val.i.i.i57.i.prol = load ptr, ptr %32, align 8
  store ptr %call.val.i.i.i57.i.prol, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i58.i.prol = getelementptr inbounds %struct.binding, ptr %31, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i58.i.prol, i8 0, i64 20, i1 false)
  %33 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i59.i.prol = getelementptr inbounds %struct.binding, ptr %33, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i59.i.prol, align 8
  %dec.i.i.i60.i.prol = add nsw i32 %.pr.i.i, -1
  store i32 %dec.i.i.i60.i.prol, ptr @cont_BINDINGS, align 4
  br label %while.body.i62.i.prol.loopexit
...
while.body.i62.i.prol.loopexit:                   ; preds = %while.body.i62.i.prol, %while.body.i62.i.preheader
  ...
  br i1 %34, label %for.cond.i.backedge, label %while.body.i62.i

while.body.i62.i:                                 ; preds = %while.body.i62.i.prol.loopexit, %while.body.i62.i
  %35 = phi i32 [ %dec.i.i.i60.i.1, %while.body.i62.i ], [ %.unr, %while.body.i62.i.prol.loopexit ]
  %36 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %36, ptr @cont_CURRENTBINDING, align 8
  %37 = getelementptr i8, ptr %36, i64 24
  %call.val.i.i.i57.i = load ptr, ptr %37, align 8
  store ptr %call.val.i.i.i57.i, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i58.i = getelementptr inbounds %struct.binding, ptr %36, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i58.i, i8 0, i64 20, i1 false)
  %38 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i59.i = getelementptr inbounds %struct.binding, ptr %38, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i59.i, align 8
  %dec.i.i.i60.i = add nsw i32 %35, -1
  store i32 %dec.i.i.i60.i, ptr @cont_BINDINGS, align 4
  %39 = load ptr, ptr @cont_LASTBINDING, align 8
  store ptr %39, ptr @cont_CURRENTBINDING, align 8
  %40 = getelementptr i8, ptr %39, i64 24
  %call.val.i.i.i57.i.1 = load ptr, ptr %40, align 8
  store ptr %call.val.i.i.i57.i.1, ptr @cont_LASTBINDING, align 8
  %renaming.i.i.i.i58.i.1 = getelementptr inbounds %struct.binding, ptr %39, i64 0, i32 1
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %renaming.i.i.i.i58.i.1, i8 0, i64 20, i1 false)
  %41 = load ptr, ptr @cont_CURRENTBINDING, align 8
  %link.i.i.i.i59.i.1 = getelementptr inbounds %struct.binding, ptr %41, i64 0, i32 4
  store ptr null, ptr %link.i.i.i.i59.i.1, align 8
  %dec.i.i.i60.i.1 = add nsw i32 %35, -2
  store i32 %dec.i.i.i60.i.1, ptr @cont_BINDINGS, align 4
  %cmp.i61.i.1 = icmp ugt i32 %dec.i.i.i60.i, 1
  br i1 %cmp.i61.i.1, label %while.body.i62.i, label %for.cond.i.backedge, !llvm.loop !20
...
entry:
  ...
  %1 = tail call i64 @fwrite(ptr nonnull @.str.12, i64 2, i64 1, ptr %0) #10
...
land.rhs.i:                                       ; preds = %entry
  ...
  br i1 %cmp.i.i.not.i, label %st_Exist.exit, label %if.then

st_Exist.exit:                                    ; preds = %land.rhs.i
  %1 = getelementptr i8, ptr %StIndex, i64 8
  %ST.val5.i = load ptr, ptr %1, align 8
  %cmp.i.i6.i.not = icmp eq ptr %ST.val5.i, null
  br i1 %cmp.i.i6.i.not, label %cleanup, label %if.then

if.then:                                          ; preds = %land.rhs.i, %st_Exist.exit
...
if.then5:                                         ; preds = %if.then
  ...
  br i1 %cmp.not.i15, label %cleanup, label %if.then.i
...
for.cond:                                         ; preds = %for.cond.backedge, %entry
  ...
  %cmp.i.not = icmp eq ptr %CurrentList.0, null
...
cont_StopAndBackTrack.exit:                       ; preds = %while.body.i.prol.loopexit, %while.body.i, %if.then
  ...
  %cmp.i43.not = icmp eq i32 %13, %12
  br i1 %cmp.i43.not, label %cleanup, label %if.end
...
if.end7:                                          ; preds = %if.end, %for.cond
  ...
  %call1067 = tail call i32 @subst_Unify(ptr noundef %IndexContext, ptr noundef %15) #9
...
for.inc:                                          ; preds = %if.end17
  ...
  %call10 = tail call i32 @subst_Unify(ptr noundef %IndexContext, ptr noundef %28) #9
...
if.then6:                                         ; preds = %if.then
  ...
  br i1 %cmp.not.i16, label %cleanup, label %if.then.i
...
if.end7:                                          ; preds = %if.end, %for.cond
  ...
  %CurrentNode.066 = load ptr, ptr %CurrentNode.0.in65, align 8
  %15 = load ptr, ptr %CurrentNode.066, align 8
  %call1067 = tail call i32 @subst_Match(ptr noundef %IndexContext, ptr noundef %15) #9
  %tobool11.not68 = icmp eq i32 %call1067, 0
  br i1 %tobool11.not68, label %for.end, label %for.body
...
for.inc:                                          ; preds = %if.end17
  ...
  %CurrentNode.0 = load ptr, ptr %CurrentNode.0.in, align 8
  %28 = load ptr, ptr %CurrentNode.0, align 8
  %call10 = tail call i32 @subst_Match(ptr noundef %IndexContext, ptr noundef %28) #9
  %tobool11.not = icmp eq i32 %call10, 0
...
if.then7:                                         ; preds = %if.then
  ...
  br i1 %cmp.not.i19, label %cleanup, label %if.then.i
...
cont_StopAndBackTrack.exit:                       ; preds = %while.body.i.prol.loopexit, %while.body.i, %if.then
  %12 = load i32, ptr @st_STACKSAVE, align 4
  %13 = load i32, ptr @st_STACKPOINTER, align 4
  %cmp.i48.not = icmp eq i32 %13, %12
  br i1 %cmp.i48.not, label %cleanup, label %if.end
...
land.rhs:                                         ; preds = %if.end7, %for.inc
  ...
  %call13 = tail call i32 @subst_Match(ptr noundef %IndexContext, ptr noundef %17) #9
...
if.end7:                                          ; preds = %if.end, %for.cond
  ...
  %CurrentNode.066 = load ptr, ptr %CurrentNode.0.in65, align 8
  %15 = load ptr, ptr %CurrentNode.066, align 8
  %call1067 = tail call i32 @subst_MatchReverse(ptr noundef %IndexContext, ptr noundef %15) #9
  %tobool11.not68 = icmp eq i32 %call1067, 0
  br i1 %tobool11.not68, label %for.end, label %for.body
...
for.inc:                                          ; preds = %if.end17
  ...
  %CurrentNode.0 = load ptr, ptr %CurrentNode.0.in, align 8
  %28 = load ptr, ptr %CurrentNode.0, align 8
  %call10 = tail call i32 @subst_MatchReverse(ptr noundef %IndexContext, ptr noundef %28) #9
  %tobool11.not = icmp eq i32 %call10, 0
...
land.rhs:                                         ; preds = %if.end7, %for.inc
  ...
  %CurrentList.274 = phi ptr [ %29, %for.inc ], [ %CurrentList.1, %if.end7 ]
  %17 = load ptr, ptr %CurrentNode.075, align 8
  %call13 = tail call i32 @subst_MatchReverse(ptr noundef %IndexContext, ptr noundef %17) #9
  %tobool14.not = icmp eq i32 %call13, 0
  br i1 %tobool14.not, label %for.end, label %for.body
...
sw.default:                                       ; preds = %if.then4, %sw.bb12
  ...
  %call15 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %10, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 1577) #10
  tail call void (ptr, ...) @misc_ErrorReport(ptr noundef nonnull @.str.4) #9
  %11 = load ptr, ptr @stderr, align 8
  %12 = tail call i64 @fwrite(ptr nonnull @.str.3, i64 132, i64 1, ptr %11) #10
...
if.else17:                                        ; preds = %if.else
  ...
  %call19 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %14, ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 1582) #10
  tail call void (ptr, ...) @misc_ErrorReport(ptr noundef nonnull @.str.5) #9
  %15 = load ptr, ptr @stderr, align 8
  %16 = tail call i64 @fwrite(ptr nonnull @.str.3, i64 132, i64 1, ptr %15) #10
  %17 = load ptr, ptr @stderr, align 8
  %18 = tail call i64 @fwrite(ptr nonnull @.str.12, i64 2, i64 1, ptr %17) #10
...
if.end:                                           ; preds = %sw.bb, %sw.bb6, %sw.bb8, %sw.bb10
  ...
  %cmp21 = icmp eq ptr %NewResult.1, null
  br i1 %cmp21, label %if.then22, label %cleanup

if.then22:                                        ; preds = %if.end
  %22 = load i32, ptr @st_CURRENT_RETRIEVAL, align 4
  %cmp.not.i = icmp eq i32 %22, 0
  br i1 %cmp.not.i, label %cleanup, label %if.then.i

if.then.i:                                        ; preds = %if.then22
  %23 = load i32, ptr @st_STACKSAVE, align 4
  store i32 %23, ptr @st_STACKPOINTER, align 4
  %.b3.i = load i1, ptr @st_WHICH_CONTEXTS, align 4
  br i1 %.b3.i, label %sw.epilog.i, label %sw.bb.i

sw.bb.i:                                          ; preds = %if.then.i
  %24 = load ptr, ptr @cont_LASTBINDING, align 8
  %tobool.not2.i.i = icmp eq ptr %24, null
  br i1 %tobool.not2.i.i, label %cont_Reset.exit.i, label %while.body.preheader.i.i
...
while.body.i.i:                                   ; preds = %while.body.i.i, %while.body.preheader.i.i
  %25 = phi ptr [ %28, %while.body.i.i ], [ %24, %while.body.preheader.i.i ]
  %dec.i.i13.i.i = phi i32 [ %dec.i.i.i.i, %while.body.i.i ], [ %cont_BINDINGS.promoted.i.i, %while.body.preheader.i.i ]
  store ptr %25, ptr @cont_CURRENTBINDING, align 8
  %26 = getelementptr i8, ptr %25, i64 24
...
lor.rhs.i:                                        ; preds = %entry
  ...
  %ST.val.i = load ptr, ptr %0, align 8
  %cmp.i.i.not.i = icmp eq ptr %ST.val.i, null
  br i1 %cmp.i.i.not.i, label %st_Empty.exit, label %if.end

st_Empty.exit:                                    ; preds = %lor.rhs.i
  %1 = getelementptr i8, ptr %StIndex, i64 8
  %ST.val5.i = load ptr, ptr %1, align 8
  %cmp.i.i6.not.i.not = icmp eq ptr %ST.val5.i, null
  br i1 %cmp.i.i6.not.i.not, label %cleanup, label %if.end

if.end:                                           ; preds = %lor.rhs.i, %st_Empty.exit
  ...
  tail call void @subst_Print(ptr noundef %6) #9
  %7 = load ptr, ptr @stdout, align 8
  %call.i = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %7)
...
if.then13:                                        ; preds = %if.then10
  %cmp.not59 = icmp eq ptr %10, null
  br i1 %cmp.not59, label %cleanup, label %for.body

for.body:                                         ; preds = %if.then13, %for.body
  %Scan.060 = phi ptr [ %Scan.0, %for.body ], [ %10, %if.then13 ]
  %11 = load ptr, ptr @stdout, align 8
  %call.i51 = tail call i32 @_IO_putc(i32 noundef 32, ptr noundef %11)
  %12 = getelementptr i8, ptr %Scan.060, i64 8
  %Scan.0.val = load ptr, ptr %12, align 8
  tail call void %Print(ptr noundef %Scan.0.val) #9
  %Scan.0 = load ptr, ptr %Scan.060, align 8
  %cmp.not = icmp eq ptr %Scan.0, null
  br i1 %cmp.not, label %cleanup, label %for.body, !llvm.loop !30

if.else:                                          ; preds = %if.then10
  %call19 = tail call i32 @list_Length(ptr noundef %10) #9
  %call20 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.10, i32 noundef %call19)
  br label %cleanup

if.else22:                                        ; preds = %if.end
  %subnodes = getelementptr inbounds %struct.st, ptr %StIndex, i64 0, i32 1
  %Scan.161 = load ptr, ptr %subnodes, align 8
  %cmp24.not62 = icmp eq ptr %Scan.161, null
  br i1 %cmp24.not62, label %cleanup, label %for.body26

for.body26:                                       ; preds = %if.else22, %for.body26
  %Scan.163 = phi ptr [ %Scan.1, %for.body26 ], [ %Scan.161, %if.else22 ]
  %13 = getelementptr i8, ptr %Scan.163, i64 8
  ...
  %Scan.1 = load ptr, ptr %Scan.163, align 8
  %cmp24.not = icmp eq ptr %Scan.1, null
  br i1 %cmp24.not, label %cleanup, label %for.body26, !llvm.loop !31

cleanup:                                          ; preds = %for.body, %for.body26, %if.else, %if.else22, %if.then13, %st_Empty.exit, %entry
  %.str.11.sink = phi ptr [ @.str.6, %entry ], [ @.str.6, %st_Empty.exit ], [ @.str.11, %if.then13 ], [ @.str.11, %if.else22 ], [ @.str.11, %if.else ], [ @.str.11, %for.body26 ], [ @.str.11, %for.body ]
...
for.body:                                         ; preds = %for.cond.preheader, %for.body
  ...
  %call.i = tail call i32 @_IO_putc(i32 noundef 32, ptr noundef %0)
...
for.body5:                                        ; preds = %for.end, %for.body5
  ...
  %call.i79 = tail call i32 @_IO_putc(i32 noundef 32, ptr noundef %1)
...
for.end9:                                         ; preds = %for.body5, %for.end.thread, %for.end
  ...
  tail call void @subst_Print(ptr noundef %6) #9
  %7 = load ptr, ptr @stdout, align 8
  %call.i80 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %7)
...
for.body21:                                       ; preds = %for.cond18.preheader, %for.body21
  ...
  %9 = load ptr, ptr @stdout, align 8
  %call.i81 = tail call i32 @_IO_putc(i32 noundef 32, ptr noundef %9)
...
for.body32:                                       ; preds = %if.then28, %for.body32
  ...
  %13 = load ptr, ptr @stdout, align 8
  %call.i82 = tail call i32 @_IO_putc(i32 noundef 32, ptr noundef %13)
...
if.else:                                          ; preds = %for.end25
  %call39 = tail call i32 @list_Length(ptr noundef %12) #9
...
if.end41:                                         ; preds = %for.body32, %if.then28, %if.else
  ...
  %call.i83 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %15)
  br label %cleanup
