; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/lua/lcode.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/lua/lcode.c"
...
entry:
  ...
  %shl2.i = select i1 %cmp, i32 0, i32 %tostore.op
  br i1 %cmp1, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  %shl4.i = shl i32 %add, 14
  %0 = or i32 %shl2.i, %shl4.i
  %or3.i = or i32 %0, %shl1.i
...
if.else:                                          ; preds = %entry
  ...
  %1 = load ptr, ptr %ls.i19, align 8, !tbaa !18
  %lastline.i20 = getelementptr inbounds %struct.LexState, ptr %1, i64 0, i32 2
  %2 = load i32, ptr %lastline.i20, align 8, !tbaa !19
  %call.i21 = tail call fastcc i32 @luaK_code(ptr noundef %fs, i32 noundef %or3.i18, i32 noundef %2)
  br label %if.end

if.end:                                           ; preds = %if.else, %if.then
  %ls.i19.sink = phi ptr [ %ls.i19, %if.else ], [ %ls.i, %if.then ]
  %add.sink = phi i32 [ %add, %if.else ], [ %or5.i, %if.then ]
  %3 = load ptr, ptr %ls.i19.sink, align 8, !tbaa !18
  %lastline = getelementptr inbounds %struct.LexState, ptr %3, i64 0, i32 2
  %4 = load i32, ptr %lastline, align 8, !tbaa !19
  %call3 = tail call fastcc i32 @luaK_code(ptr noundef %fs, i32 noundef %add.sink, i32 noundef %4)
