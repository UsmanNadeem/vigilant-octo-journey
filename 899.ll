; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/rdtarga.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/mediabench/jpeg/jpeg-6a/rdtarga.c"
...
while.body:                                       ; preds = %while.body.lr.ph, %read_byte.exit
  ...
  %call.i = tail call i32 @_IO_getc(ptr noundef %50)
...
for.body.i:                                       ; preds = %read_byte.exit43.i, %for.body.lr.ph.i
  ...
  %call.i.i = tail call i32 @_IO_getc(ptr noundef %63)
...
read_byte.exit.i:                                 ; preds = %if.then.i.i, %for.body.i
  ...
  %call.i31.i = tail call i32 @_IO_getc(ptr noundef %69)
...
read_byte.exit36.i:                               ; preds = %if.then.i35.i, %read_byte.exit.i
  ...
  %call.i38.i = tail call i32 @_IO_getc(ptr noundef %75)
...
for.body:                                         ; preds = %if.end12, %for.body
  ...
  %call14 = tail call i32 @_IO_getc(ptr noundef %0)
