; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Bullet/btSoftSoftCollisionAlgorithm.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Bullet/btSoftSoftCollisionAlgorithm.cpp"
...
; Function Attrs: uwtable
define dso_local void @_ZN28btSoftSoftCollisionAlgorithmD0Ev(ptr noundef nonnull align 8 dereferenceable(48) %this) unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
invoke.cont:
...
if.then.i.i.i:                                    ; preds = %if.then.i.i
  ...
  %.pre.i = load i32, ptr %m_size.i.i, align 4, !tbaa !14
...
for.body.i.i.i:                                   ; preds = %for.body.i.i.i, %for.body.lr.ph.i.i.i.new
  ...
  %6 = load ptr, ptr %m_data.i.i.i, align 8, !tbaa !19
  %arrayidx3.i.i.i = getelementptr inbounds ptr, ptr %6, i64 %indvars.iv.i.i.i
  %7 = load ptr, ptr %arrayidx3.i.i.i, align 8, !tbaa !20
  store ptr %7, ptr %arrayidx.i.i.i, align 8, !tbaa !20
  ...
  %8 = load ptr, ptr %m_data.i.i.i, align 8, !tbaa !19
  %arrayidx3.i.i.i.1 = getelementptr inbounds ptr, ptr %8, i64 %indvars.iv.next.i.i.i
  %9 = load ptr, ptr %arrayidx3.i.i.i.1, align 8, !tbaa !20
  store ptr %9, ptr %arrayidx.i.i.i.1, align 8, !tbaa !20
  ...
  %10 = load ptr, ptr %m_data.i.i.i, align 8, !tbaa !19
  %arrayidx3.i.i.i.2 = getelementptr inbounds ptr, ptr %10, i64 %indvars.iv.next.i.i.i.1
  %11 = load ptr, ptr %arrayidx3.i.i.i.2, align 8, !tbaa !20
  store ptr %11, ptr %arrayidx.i.i.i.2, align 8, !tbaa !20
  ...
  %12 = load ptr, ptr %m_data.i.i.i, align 8, !tbaa !19
  %arrayidx3.i.i.i.3 = getelementptr inbounds ptr, ptr %12, i64 %indvars.iv.next.i.i.i.2
  %13 = load ptr, ptr %arrayidx3.i.i.i.3, align 8, !tbaa !20
  store ptr %13, ptr %arrayidx.i.i.i.3, align 8, !tbaa !20
...
for.body.i.i.i.epil:                              ; preds = %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil
  ...
  %14 = load ptr, ptr %m_data.i.i.i, align 8, !tbaa !19
  %arrayidx3.i.i.i.epil = getelementptr inbounds ptr, ptr %14, i64 %indvars.iv.i.i.i.epil
  %15 = load ptr, ptr %arrayidx3.i.i.i.epil, align 8, !tbaa !20
  store ptr %15, ptr %arrayidx.i.i.i.epil, align 8, !tbaa !20
  %indvars.iv.next.i.i.i.epil = add nuw nsw i64 %indvars.iv.i.i.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i, label %for.body.i.i.i.epil, !llvm.loop !21
...
_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i: ; preds = %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i.loopexit.unr-lcssa, %for.body.i.i.i.epil, %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE8allocateEi.exit.i.i
  ...
  %16 = load ptr, ptr %m_data.i9.i.i, align 8, !tbaa !19
...
if.then3.i.i.i:                                   ; preds = %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i
  ...
  %.pre7.pre.i = load i32, ptr %m_size.i.i, align 4, !tbaa !14
...
_ZN20btAlignedObjectArrayIP20btPersistentManifoldE10deallocateEv.exit.i.i: ; preds = %if.then3.i.i.i, %_ZNK20btAlignedObjectArrayIP20btPersistentManifoldE4copyEiiPS1_.exit.i.i
  ...
  store ptr %retval.0.i.i.i, ptr %m_data.i9.i.i, align 8, !tbaa !19
  store i32 %cond.i.i, ptr %m_capacity.i.i, align 8, !tbaa !18
  %.pre = load ptr, ptr %m_manifoldPtr, align 8, !tbaa !20
...
_ZN20btAlignedObjectArrayIP20btPersistentManifoldE9push_backERKS1_.exit: ; preds = %if.then, %if.then.i, %_ZN20btAlignedObjectArrayIP20btPersistentManifoldE10deallocateEv.exit.i.i
  ...
  %20 = load ptr, ptr %m_data.i, align 8, !tbaa !19
  %idxprom.i = sext i32 %19 to i64
  %arrayidx.i = getelementptr inbounds ptr, ptr %20, i64 %idxprom.i
  store ptr %18, ptr %arrayidx.i, align 8, !tbaa !20
  %inc.i = add nsw i32 %19, 1
  store i32 %inc.i, ptr %m_size.i.i, align 4, !tbaa !14
  br label %if.end
