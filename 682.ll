; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_nulsft.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_nulsft.c"
...
@.str.16 = private unnamed_addr constant [136 x i8] c"NSIS: out of memory at /local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_nulsft.c:236\0A\00", align 1
@.str.17 = private unnamed_addr constant [143 x i8] c"NSIS: cannot read %u bytes at /local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_nulsft.c:241\0A\00", align 1
@.str.18 = private unnamed_addr constant [147 x i8] c"NSIS: cannot write output file at /local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_nulsft.c:248\0A\00", align 1
@.str.19 = private unnamed_addr constant [147 x i8] c"NSIS: decompressor init failed at /local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_nulsft.c:255\0A\00", align 1
@.str.20 = private unnamed_addr constant [147 x i8] c"NSIS: cannot write output file at /local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_nulsft.c:270\0A\00", align 1
@.str.21 = private unnamed_addr constant [147 x i8] c"NSIS: xs looping, breaking out at /local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_nulsft.c:286\0A\00", align 1
@.str.22 = private unnamed_addr constant [133 x i8] c"NSIS: bad stream at /local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_nulsft.c:293\0A\00", align 1
@.str.23 = private unnamed_addr constant [147 x i8] c"NSIS: cannot write output file at /local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_nulsft.c:300\0A\00", align 1
...
@.str.26 = private unnamed_addr constant [143 x i8] c"NSIS: cannot read %u bytes at /local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_nulsft.c:324\0A\00", align 1
@.str.27 = private unnamed_addr constant [147 x i8] c"NSIS: xs looping, breaking out at /local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_nulsft.c:344\0A\00", align 1
@.str.28 = private unnamed_addr constant [133 x i8] c"NSIS: bad stream at /local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_nulsft.c:351\0A\00", align 1
...
@.str.30 = private unnamed_addr constant [147 x i8] c"NSIS: xs looping, breaking out at /local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_nulsft.c:378\0A\00", align 1
@.str.31 = private unnamed_addr constant [133 x i8] c"NSIS: bad stream at /local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_nsis_nulsft.c:391\0A\00", align 1
...
cond.false.i:                                     ; preds = %do.body
  ...
  %call.i.i.i = call i32 @__fxstat(i32 noundef 1, i32 noundef %6, ptr noundef nonnull %st.i.i) #9
...
if.then21.i.i:                                    ; preds = %if.end.i.i
  ...
  %13 = load i64, ptr %st_size.i.i, align 8, !tbaa !29
  %14 = load i64, ptr %off, align 8, !tbaa !23
  %sub24.i.i = sub nsw i64 %13, %14
...
if.end36.i.i:                                     ; preds = %if.then34.i.i, %if.else.i.i, %if.then21.i.i
  %15 = phi i32 [ %12, %if.else.i.i ], [ %.pre.i.i, %if.then34.i.i ], [ %conv25.i.i, %if.then21.i.i ]
  %sub38.i.i = add i32 %15, -28
  store i32 %sub38.i.i, ptr %asz.i.i, align 8, !tbaa !28
  %cmp41204.not.i.i = icmp eq i32 %15, 32
...
for.body.lr.ph.i.i:                               ; preds = %if.end36.i.i
  %16 = load i32, ptr %nsist, align 8, !tbaa !16
  %call46.peel.i.i = call i32 @cli_readn(i32 noundef %16, ptr noundef nonnull %add.ptr45.i.i, i32 noundef 4) #9
...
if.end58.peel.i.i:                                ; preds = %for.body.lr.ph.i.i
  ...
  %17 = and i32 %add.ptr45.val.peel.i.i, 255
  %cmp.i.peel.i.i = icmp eq i32 %17, 49
...
if.then60.peel.i.i:                               ; preds = %if.end58.peel.i.i
  %18 = load i32, ptr %nsist, align 8, !tbaa !16
  %call65.peel.i.i = call i32 @cli_readn(i32 noundef %18, ptr noundef nonnull %add.ptr45.i.i, i32 noundef 4) #9
...
if.end69.peel.i.i:                                ; preds = %if.then60.peel.i.i
  %19 = load i8, ptr %add.ptr45.i.i, align 4, !tbaa !25
  %cmp.i186.peel.i.i = icmp eq i8 %19, 49
  ...
  %20 = load i8, ptr %arrayidx.peel.i.i, align 1, !tbaa !25
  %inc73.peel.i.i = add i8 %20, 1
...
if.end75.peel.i.i:                                ; preds = %if.end69.peel.i.i, %if.end58.peel.i.i
  ...
  %21 = load i32, ptr %asz.i.i, align 8, !tbaa !28
  %cmp79.peel.i.i = icmp ugt i32 %add77.peel.i.i, %21
  br i1 %cmp79.peel.i.i, label %cleanup.i.i, label %if.end82.peel.i.i

if.end82.peel.i.i:                                ; preds = %if.end75.peel.i.i
  %22 = load i32, ptr %nsist, align 8, !tbaa !16
  %conv84.peel.i.i = sext i32 %nextsz.0.peel.i.i to i64
  %call85.peel.i.i = call i64 @lseek(i32 noundef %22, i64 noundef %conv84.peel.i.i, i32 noundef 1) #9
...
for.inc.peel.i.i:                                 ; preds = %if.end82.peel.i.i
  %23 = load i32, ptr %asz.i.i, align 8, !tbaa !28
  %sub40.peel.i.i = add i32 %23, -4
...
for.body.i.i:                                     ; preds = %for.inc.peel.i.i, %for.inc.i.i
  ...
  %call46.i.i = call i32 @cli_readn(i32 noundef %24, ptr noundef nonnull %add.ptr45.i.i, i32 noundef 4) #9
...
if.then60.i.i:                                    ; preds = %if.end58.i.i
  %25 = load i32, ptr %nsist, align 8, !tbaa !16
  %call65.i.i = call i32 @cli_readn(i32 noundef %25, ptr noundef nonnull %add.ptr45.i.i, i32 noundef 4) #9
...
if.end69.i.i:                                     ; preds = %if.then60.i.i
  ...
  %26 = load i8, ptr %add.ptr45.i.i, align 4, !tbaa !25
  %cmp.i186.i.i = icmp eq i8 %26, 49
  ...
  %27 = load i8, ptr %arrayidx.i.i, align 1, !tbaa !25
  %inc73.i.i = add i8 %27, 1
...
if.end75.i.i:                                     ; preds = %if.end69.i.i, %if.end58.i.i
  ...
  %28 = load i32, ptr %asz.i.i, align 8, !tbaa !28
  %cmp79.i.i = icmp ugt i32 %add77.i.i, %28
  br i1 %cmp79.i.i, label %cleanup.i.i, label %if.end82.i.i

if.end82.i.i:                                     ; preds = %if.end75.i.i
  %29 = load i32, ptr %nsist, align 8, !tbaa !16
  %conv84.i.i = sext i32 %nextsz.0.i.i to i64
  %call85.i.i = call i64 @lseek(i32 noundef %29, i64 noundef %conv84.i.i, i32 noundef 1) #9
...
for.inc.i.i:                                      ; preds = %if.end82.i.i
  ...
  %30 = load i32, ptr %asz.i.i, align 8, !tbaa !28
  %sub40.i.i = add i32 %30, -4
...
for.end.if.end97_crit_edge.i.i:                   ; preds = %for.end.i.i, %for.inc.peel.i.i, %if.end36.i.i
  ...
  %31 = icmp eq i8 %.pre210.i.i, 0
  %32 = select i1 %31, ptr @.str.37, ptr @.str.36
...
if.end97.i.i:                                     ; preds = %if.then95.i.i, %for.end.if.end97_crit_edge.i.i
  %tobool100.not.i.i = phi ptr [ %32, %for.end.if.end97_crit_edge.i.i ], [ @.str.37, %if.then95.i.i ]
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.35, ptr noundef nonnull %tobool100.not.i.i) #9
  %33 = load i8, ptr %solid.i.i, align 1, !tbaa !33
  %tobool102.not.i.i = icmp eq i8 %33, 0
  br i1 %tobool102.not.i.i, label %if.then103.i.i, label %if.end133.i.i

if.then103.i.i:                                   ; preds = %if.end97.i.i
  %34 = load i8, ptr %arrayidx104.i.i, align 1, !tbaa !25
  %conv105.i.i = zext i8 %34 to i32
  %35 = load i8, ptr %arrayidx106.i.i, align 2, !tbaa !25
  %conv107.i.i = zext i8 %35 to i32
  %36 = load i8, ptr %arrayidx108.i.i, align 1, !tbaa !25
  %conv109.i.i = zext i8 %36 to i32
  ...
  %cmp114.i.i = icmp ult i8 %34, %35
  %cmp120.i.i = icmp ult i8 %35, %36
  %cond122.i.i = select i1 %cmp120.i.i, i8 3, i8 2
  %cmp127.i.i = icmp ult i8 %34, %36
...
if.end133.i.i:                                    ; preds = %if.then103.i.i, %if.end97.i.i
  %37 = load i32, ptr %nsist, align 8, !tbaa !16
  %38 = load i64, ptr %off, align 8, !tbaa !23
  %add136.i.i = add nsw i64 %38, 28
  %call137.i.i = call i64 @lseek(i32 noundef %37, i64 noundef %add136.i.i, i32 noundef 0) #9
...
if.then26:                                        ; preds = %cli_nsis_unpack.exit
  %39 = load i32, ptr %options, align 8, !tbaa !37
  %and = and i32 %39, 256
  %tobool27.not = icmp eq i32 %and, 0
  br i1 %tobool27.not, label %if.else, label %do.end.thread91

do.end.thread91:                                  ; preds = %if.then26
  %40 = load ptr, ptr %ctx, align 8, !tbaa !38
  store ptr @.str.4, ptr %40, align 8, !tbaa !39
  br label %do.end.thread

if.else:                                          ; preds = %if.then26
  %41 = load i8, ptr %solid.i.i, align 1, !tbaa !33
  %tobool29.not = icmp eq i8 %41, 0
  br i1 %tobool29.not, label %do.cond, label %do.end.thread

if.else32:                                        ; preds = %cli_nsis_unpack.exit
  %42 = load i32, ptr %fno.i, align 8, !tbaa !26
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.5, i32 noundef %42) #9
  %43 = load i32, ptr %ofd, align 4, !tbaa !40
  %call33 = call i64 @lseek(i32 noundef %43, i64 noundef 0, i32 noundef 0) #9
  %44 = load i32, ptr %fno.i, align 8, !tbaa !26
...
if.then37:                                        ; preds = %if.else32
  %call39 = call i32 @cli_scandesc(i32 noundef %45, ptr noundef %ctx, i8 noundef zeroext 0, i32 noundef 0, i8 noundef zeroext 0, ptr noundef null) #9
  br label %if.end43

if.else40:                                        ; preds = %if.else32
  %call42 = call i32 @cli_magic_scandesc(i32 noundef %45, ptr noundef %ctx) #9
  br label %if.end43

if.end43:                                         ; preds = %if.else40, %if.then37
  %ret.0 = phi i32 [ %call39, %if.then37 ], [ %call42, %if.else40 ]
  %46 = load i32, ptr %ofd, align 4, !tbaa !40
  %call45 = call i32 @close(i32 noundef %46) #9
  %47 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
...
do.cond:                                          ; preds = %if.else, %cli_nsis_unpack.exit, %if.then47, %if.end43
  ...
  switch i32 %ret.1.fr, label %do.end.thread.loopexit104 [
    i32 0, label %do.body
    i32 2, label %do.end.thread
  ]

do.end.thread.loopexit104:                        ; preds = %do.cond
  %ret.1.fr.le = freeze i32 %ret.1
  br label %do.end.thread

do.end.thread:                                    ; preds = %if.else, %do.cond, %do.end.thread.loopexit104, %do.end.thread91
  %48 = phi i32 [ 1, %do.end.thread91 ], [ %ret.1.fr.le, %do.end.thread.loopexit104 ], [ 0, %do.cond ], [ 0, %if.else ]
  %freecomp.i.i = getelementptr inbounds %struct.nsis_st, ptr %nsist, i64 0, i32 14
  %49 = load i8, ptr %freecomp.i.i, align 2, !tbaa !41
...
if.end.i.i83:                                     ; preds = %do.end.thread
  %50 = load i8, ptr %comp.i.i, align 8, !tbaa !32
  switch i8 %50, label %sw.epilog.i.i [
...
sw.bb.i.i:                                        ; preds = %if.end.i.i83
  ...
  %call.i.i = call i32 @nsis_BZ2_bzDecompressEnd(ptr noundef nonnull %bz.i.i) #9
...
nsis_shutdown.exit.i:                             ; preds = %sw.epilog.i.i, %do.end.thread
  %51 = load i8, ptr %solid.i.i, align 1, !tbaa !33
  %tobool.not.i84 = icmp eq i8 %51, 0
  br i1 %tobool.not.i84, label %cli_nsis_free.exit, label %land.lhs.true.i

land.lhs.true.i:                                  ; preds = %nsis_shutdown.exit.i
  %freeme.i = getelementptr inbounds %struct.nsis_st, ptr %nsist, i64 0, i32 11
  %52 = load ptr, ptr %freeme.i, align 8, !tbaa !42
...
cli_nsis_free.exit:                               ; preds = %nsis_shutdown.exit.i, %land.lhs.true.i, %if.then.i
  %53 = load i8, ptr @cli_leavetemps_flag, align 1, !tbaa !25
...
if.then58:                                        ; preds = %cli_nsis_free.exit
  ...
  %call60 = call i32 @cli_rmdirs(ptr noundef %54) #9
  br label %if.end61

if.end61:                                         ; preds = %if.then58, %cli_nsis_free.exit
  %55 = load ptr, ptr %dir, align 8, !tbaa !24
  call void @free(ptr noundef %55) #9
  %56 = load i32, ptr %arec21, align 4, !tbaa !15
  %dec = add i32 %56, -1
  store i32 %dec, ptr %arec21, align 4, !tbaa !15
  br label %cleanup

cleanup:                                          ; preds = %if.end, %if.end61, %if.then13, %if.then
  %retval.0 = phi i32 [ -100, %if.then ], [ -118, %if.then13 ], [ %48, %if.end61 ], [ -118, %if.end ]
...
land.lhs.true57:                                  ; preds = %if.end52
  ...
  %or.cond542 = select i1 %tobool59.not, i1 %cmp63, i1 false
  br i1 %or.cond542, label %if.then65, label %if.end77
...
if.end77:                                         ; preds = %if.end52.if.end77_crit_edge, %land.lhs.true57
  %conv78.pre-phi = phi i64 [ %.pre551, %if.end52.if.end77_crit_edge ], [ %conv, %land.lhs.true57 ]
...
if.else108:                                       ; preds = %if.end94
  %call109 = call fastcc i32 @nsis_init(ptr noundef nonnull %n)
...
while.cond:                                       ; preds = %while.cond.backedge, %if.end115
  ...
  %call120 = call fastcc i32 @nsis_decomp(ptr noundef nonnull %n)
...
while.body:                                       ; preds = %while.cond
  %29 = load ptr, ptr %next_out, align 8, !tbaa !49
...
land.lhs.true147:                                 ; preds = %if.end139
  ...
  %or.cond543 = select i1 %tobool150.not, i1 %cmp155, i1 false
  br i1 %or.cond543, label %if.then157, label %while.cond.backedge
...
if.end175:                                        ; preds = %while.cond, %while.end.thread
  ...
  %38 = load ptr, ptr %next_out, align 8, !tbaa !49
  ...
  %39 = load ptr, ptr %next_out, align 8, !tbaa !49
...
if.else200.if.end239_crit_edge:                   ; preds = %if.else200
  ...
  %.pre = load i32, ptr %nsis240.phi.trans.insert, align 8, !tbaa !47
  br label %if.end239
...
if.end232:                                        ; preds = %if.end218
  ...
  store ptr %50, ptr %next_in235, align 8, !tbaa !48
  store i32 %48, ptr %nsis234, align 8, !tbaa !47
  br label %if.end239
...
if.end267.9:                                      ; preds = %while.body257.9
  %call254.10 = call fastcc i32 @nsis_decomp(ptr noundef nonnull %n)
...
while.body257.10:                                 ; preds = %if.end267.9
  %63 = load ptr, ptr %next_out250, align 8, !tbaa !49
...
if.end267.10:                                     ; preds = %while.body257.10
  %call254.11 = call fastcc i32 @nsis_decomp(ptr noundef nonnull %n)
...
while.body257.11:                                 ; preds = %if.end267.10
  %64 = load ptr, ptr %next_out250, align 8, !tbaa !49
...
if.end267.11:                                     ; preds = %while.body257.11
  %call254.12 = call fastcc i32 @nsis_decomp(ptr noundef nonnull %n)
...
while.body257.12:                                 ; preds = %if.end267.11
  %65 = load ptr, ptr %next_out250, align 8, !tbaa !49
...
if.end267.12:                                     ; preds = %while.body257.12
  %call254.13 = call fastcc i32 @nsis_decomp(ptr noundef nonnull %n)
...
while.body257.13:                                 ; preds = %if.end267.12
  %66 = load ptr, ptr %next_out250, align 8, !tbaa !49
...
if.end267.13:                                     ; preds = %while.body257.13
  %call254.14 = call fastcc i32 @nsis_decomp(ptr noundef nonnull %n)
...
while.body257.14:                                 ; preds = %if.end267.13
  %67 = load ptr, ptr %next_out250, align 8, !tbaa !49
...
if.end267.14:                                     ; preds = %while.body257.14
  %call254.15 = call fastcc i32 @nsis_decomp(ptr noundef nonnull %n)
...
while.body257.15:                                 ; preds = %if.end267.14
  %68 = load ptr, ptr %next_out250, align 8, !tbaa !49
...
if.end267.15:                                     ; preds = %while.body257.15
  %call254.16 = call fastcc i32 @nsis_decomp(ptr noundef nonnull %n)
...
while.body257.16:                                 ; preds = %if.end267.15
  %69 = load ptr, ptr %next_out250, align 8, !tbaa !49
...
if.end267.16:                                     ; preds = %while.body257.16
  %call254.17 = call fastcc i32 @nsis_decomp(ptr noundef nonnull %n)
...
while.body257.17:                                 ; preds = %if.end267.16
  %70 = load ptr, ptr %next_out250, align 8, !tbaa !49
...
if.end267.17:                                     ; preds = %while.body257.17
  %call254.18 = call fastcc i32 @nsis_decomp(ptr noundef nonnull %n)
...
while.body257.18:                                 ; preds = %if.end267.17
  %71 = load ptr, ptr %next_out250, align 8, !tbaa !49
...
if.end267.18:                                     ; preds = %while.body257.18
  %call254.19 = call fastcc i32 @nsis_decomp(ptr noundef nonnull %n)
...
while.body257.19:                                 ; preds = %if.end267.18
  %72 = load ptr, ptr %next_out250, align 8, !tbaa !49
...
if.end267.19:                                     ; preds = %while.body257.19
  %call254.20 = call fastcc i32 @nsis_decomp(ptr noundef nonnull %n)
...
while.body257.20:                                 ; preds = %if.end267.19
  %73 = load ptr, ptr %next_out250, align 8, !tbaa !49
...
if.end299:                                        ; preds = %land.lhs.true284, %if.end279
  ...
  store i32 %cond, ptr %avail_out252, align 8, !tbaa !50
  %tobool308.not546 = icmp eq i32 %obuf.val, 0
  br i1 %tobool308.not546, label %cleanup388, label %land.rhs

land.rhs:                                         ; preds = %if.end299, %cleanup
  %loops.3547 = phi i32 [ %loops.5, %cleanup ], [ 0, %if.end299 ]
  %call309 = call fastcc i32 @nsis_decomp(ptr noundef nonnull %n)
...
while.body312:                                    ; preds = %land.rhs
  %78 = load ptr, ptr %next_out250, align 8, !tbaa !49
...
if.end332:                                        ; preds = %if.then321
  ...
  store i32 %cond342, ptr %avail_out252, align 8, !tbaa !50
  br label %cleanup

if.else345:                                       ; preds = %while.body312
  %inc346 = add i32 %loops.3547, 1
...
if.else345.cleanup_crit_edge:                     ; preds = %if.else345
  %.pre550 = load i32, ptr %size, align 4, !tbaa !45
  br label %cleanup
...
cleanup:                                          ; preds = %if.else345.cleanup_crit_edge, %if.end332
  %82 = phi i32 [ %sub333, %if.end332 ], [ %.pre550, %if.else345.cleanup_crit_edge ]
  %loops.5 = phi i32 [ %loops.3547, %if.end332 ], [ %inc346, %if.else345.cleanup_crit_edge ]
...
if.then355:                                       ; preds = %land.rhs, %while.end352.thread
  ...
  %84 = load ptr, ptr %next_out250, align 8, !tbaa !49
  ...
  %85 = load ptr, ptr %next_out250, align 8, !tbaa !49
...
sw.bb:                                            ; preds = %entry
  %nsis = getelementptr inbounds %struct.nsis_st, ptr %n, i64 0, i32 7
  %1 = load i32, ptr %nsis, align 8, !tbaa !47
  %bz = getelementptr inbounds %struct.nsis_st, ptr %n, i64 0, i32 8
  %avail_in1 = getelementptr inbounds %struct.nsis_st, ptr %n, i64 0, i32 8, i32 1
  store i32 %1, ptr %avail_in1, align 8, !tbaa !58
  %next_in = getelementptr inbounds %struct.nsis_st, ptr %n, i64 0, i32 7, i32 1
  %2 = load ptr, ptr %next_in, align 8, !tbaa !48
  store ptr %2, ptr %bz, align 8, !tbaa !59
  %avail_out = getelementptr inbounds %struct.nsis_st, ptr %n, i64 0, i32 7, i32 2
  %3 = load i32, ptr %avail_out, align 8, !tbaa !50
  %avail_out7 = getelementptr inbounds %struct.nsis_st, ptr %n, i64 0, i32 8, i32 5
  store i32 %3, ptr %avail_out7, align 8, !tbaa !60
  %next_out = getelementptr inbounds %struct.nsis_st, ptr %n, i64 0, i32 7, i32 3
  %4 = load ptr, ptr %next_out, align 8, !tbaa !49
  %next_out10 = getelementptr inbounds %struct.nsis_st, ptr %n, i64 0, i32 8, i32 4
  store ptr %4, ptr %next_out10, align 8, !tbaa !61
...
sw.bb67:                                          ; preds = %entry
  ...
  %9 = load i32, ptr %nsis68, align 8, !tbaa !47
...
sw.epilog104.sink.split:                          ; preds = %sw.bb, %sw.bb30, %sw.bb67
  ...
  store i32 %13, ptr %nsis68.sink, align 8, !tbaa !47
  %14 = load ptr, ptr %z.sink, align 8, !tbaa !39
  store ptr %14, ptr %next_in72.sink, align 8, !tbaa !48
  %15 = load i32, ptr %avail_out78.sink, align 8, !tbaa !45
  store i32 %15, ptr %avail_out76.sink, align 8, !tbaa !50
  %16 = load ptr, ptr %next_out82.sink, align 8, !tbaa !39
  store ptr %16, ptr %next_out80.sink, align 8, !tbaa !49
