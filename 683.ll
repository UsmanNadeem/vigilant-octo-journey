; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_ole2_extract.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/libclamav_ole2_extract.c"
...
if.end:                                           ; preds = %if.then
  ...
  %call6 = call ptr @mmap(ptr noundef null, i64 noundef %0, i32 noundef 1, i32 noundef 2, i32 noundef %fd, i64 noundef 0) #12
...
if.end16.thread99:                                ; preds = %if.end
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(520) %hdr, ptr noundef nonnull align 1 dereferenceable(520) %1, i64 520, i1 false)
  br label %if.end26
...
if.then46:                                        ; preds = %if.end42
  ...
  %2 = load ptr, ptr %m_area, align 8, !tbaa !9
  %cmp48.not = icmp eq ptr %2, null
  br i1 %cmp48.not, label %cleanup.sink.split, label %cleanup.sink.split.sink.split

if.end56:                                         ; preds = %if.end42
  %3 = load i16, ptr %log2_big_block_size, align 2, !tbaa !20
  %cmp59.not = icmp eq i16 %3, 9
...
if.end62:                                         ; preds = %if.end56
  %4 = load i32, ptr %log2_small_block_size, align 8, !tbaa !21
  %cmp64.not = icmp eq i32 %4, 6
...
if.end67:                                         ; preds = %if.end62
  %5 = load i32, ptr %sbat_cutoff, align 8, !tbaa !22
  %cmp69.not = icmp eq i32 %5, 4096
...
if.end72:                                         ; preds = %if.end67
  ...
  %6 = load i64, ptr %st_size73, align 8, !tbaa !14
  %div = sdiv i64 %6, 9
  ...
  %8 = load i8, ptr %hdr, align 8, !tbaa !24
  ...
  %9 = load i8, ptr %arrayidx.1.i, align 1, !tbaa !24
  %conv.1.i = zext i8 %9 to i32
  ...
  %10 = load i8, ptr %arrayidx.2.i, align 2, !tbaa !24
  %conv.2.i = zext i8 %10 to i32
  ...
  %11 = load i8, ptr %arrayidx.3.i, align 1, !tbaa !24
  ...
  %12 = load i8, ptr %arrayidx.4.i, align 4, !tbaa !24
  ...
  %13 = load i8, ptr %arrayidx.5.i, align 1, !tbaa !24
  %conv.5.i = zext i8 %13 to i32
  ...
  %14 = load i8, ptr %arrayidx.6.i, align 2, !tbaa !24
  %conv.6.i = zext i8 %14 to i32
  ...
  %15 = load i8, ptr %arrayidx.7.i, align 1, !tbaa !24
  %conv.7.i = zext i8 %15 to i32
  ...
  %16 = load i8, ptr %arrayidx6.i, align 8, !tbaa !24
  ...
  %17 = load i8, ptr %arrayidx6.1.i, align 1, !tbaa !24
  %conv7.1.i = zext i8 %17 to i32
  ...
  %18 = load i8, ptr %arrayidx6.2.i, align 2, !tbaa !24
  %conv7.2.i = zext i8 %18 to i32
  ...
  %19 = load i8, ptr %arrayidx6.3.i, align 1, !tbaa !24
  %conv7.3.i = zext i8 %19 to i32
  ...
  %20 = load i8, ptr %arrayidx6.4.i, align 4, !tbaa !24
  %conv7.4.i = zext i8 %20 to i32
  ...
  %21 = load i8, ptr %arrayidx6.5.i, align 1, !tbaa !24
  %conv7.5.i = zext i8 %21 to i32
  ...
  %22 = load i8, ptr %arrayidx6.6.i, align 2, !tbaa !24
  %conv7.6.i = zext i8 %22 to i32
  ...
  %23 = load i8, ptr %arrayidx6.7.i, align 1, !tbaa !24
  %conv7.7.i = zext i8 %23 to i32
  ...
  %24 = load i8, ptr %arrayidx6.8.i, align 8, !tbaa !24
  %conv7.8.i = zext i8 %24 to i32
  ...
  %25 = load i8, ptr %arrayidx6.9.i, align 1, !tbaa !24
  %conv7.9.i = zext i8 %25 to i32
  ...
  %26 = load i8, ptr %arrayidx6.10.i, align 2, !tbaa !24
  %conv7.10.i = zext i8 %26 to i32
  ...
  %27 = load i8, ptr %arrayidx6.11.i, align 1, !tbaa !24
  %conv7.11.i = zext i8 %27 to i32
  ...
  %28 = load i8, ptr %arrayidx6.12.i, align 4, !tbaa !24
  %conv7.12.i = zext i8 %28 to i32
  ...
  %29 = load i8, ptr %arrayidx6.13.i, align 1, !tbaa !24
  %conv7.13.i = zext i8 %29 to i32
  ...
  %30 = load i8, ptr %arrayidx6.14.i, align 2, !tbaa !24
  %conv7.14.i = zext i8 %30 to i32
  ...
  %31 = load i8, ptr %arrayidx6.15.i, align 1, !tbaa !24
  %conv7.15.i = zext i8 %31 to i32
  ...
  %32 = load i16, ptr %minor_version.i, align 8, !tbaa !25
  %conv11.i = zext i16 %32 to i32
  ...
  %33 = load i16, ptr %dll_version.i, align 2, !tbaa !26
  ...
  %34 = load i16, ptr %byte_order.i, align 4, !tbaa !27
  %conv13.i = sext i16 %34 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.15, i32 noundef %conv13.i) #12
  %35 = load i16, ptr %log2_big_block_size, align 2, !tbaa !20
  %conv14.i = zext i16 %35 to i32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.16, i32 noundef %conv14.i) #12
  %36 = load i32, ptr %log2_small_block_size, align 8, !tbaa !21
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.17, i32 noundef %36) #12
  %bat_count.i = getelementptr inbounds %struct.ole2_header_tag, ptr %hdr, i64 0, i32 8
  %37 = load i32, ptr %bat_count.i, align 4, !tbaa !28
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.18, i32 noundef %37) #12
  %prop_start.i = getelementptr inbounds %struct.ole2_header_tag, ptr %hdr, i64 0, i32 9
  %38 = load i32, ptr %prop_start.i, align 8, !tbaa !29
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.19, i32 noundef %38) #12
  %39 = load i32, ptr %sbat_cutoff, align 8, !tbaa !22
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.20, i32 noundef %39) #12
  %sbat_start.i = getelementptr inbounds %struct.ole2_header_tag, ptr %hdr, i64 0, i32 12
  %40 = load i32, ptr %sbat_start.i, align 4, !tbaa !30
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.21, i32 noundef %40) #12
  %sbat_block_count.i = getelementptr inbounds %struct.ole2_header_tag, ptr %hdr, i64 0, i32 13
  %41 = load i32, ptr %sbat_block_count.i, align 8, !tbaa !31
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.22, i32 noundef %41) #12
  %xbat_start.i = getelementptr inbounds %struct.ole2_header_tag, ptr %hdr, i64 0, i32 14
  %42 = load i32, ptr %xbat_start.i, align 4, !tbaa !32
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.23, i32 noundef %42) #12
  %xbat_count.i = getelementptr inbounds %struct.ole2_header_tag, ptr %hdr, i64 0, i32 15
  %43 = load i32, ptr %xbat_count.i, align 8, !tbaa !33
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.24, i32 noundef %43) #12
  %44 = load i32, ptr %max_block_no, align 8, !tbaa !23
  call void (ptr, ...) @cli_dbgmsg(ptr noundef nonnull @.str.6, i32 noundef %44) #12
...
abort:                                            ; preds = %if.end72, %if.then71, %if.then66, %if.then61
  %45 = load ptr, ptr %m_area, align 8, !tbaa !9
  %cmp79.not = icmp eq ptr %45, null
...
cleanup.sink.split.sink.split:                    ; preds = %abort, %if.then46
  %.sink = phi ptr [ %2, %if.then46 ], [ %45, %abort ]
  ...
  %46 = load i64, ptr %m_length83, align 8, !tbaa !17
  %call84 = call i32 @munmap(ptr noundef nonnull %.sink, i64 noundef %46) #12
...
cleanup.sink.split:                               ; preds = %cleanup.sink.split.sink.split, %abort, %if.then46
  ...
  %47 = load ptr, ptr %bitset, align 8, !tbaa !19
  call void @cli_bitset_free(ptr noundef %47) #12
  br label %cleanup
...
land.lhs.true:                                    ; preds = %if.end
  ...
  %or.cond326 = select i1 %tobool6.not, i1 %cmp9, i1 false
...
sw.bb130:                                         ; preds = %if.end101
  ...
  %call134 = call fastcc i32 @handler_writefile(i32 noundef %fd, ptr noundef nonnull %hdr, ptr noundef nonnull %arrayidx, ptr noundef %dir)
...
if.end:                                           ; preds = %entry
  ...
  %1 = load i16, ptr %name_size, align 1, !tbaa !45
...
if.end33:                                         ; preds = %if.end27
  ...
  %4 = load i32, ptr %size, align 1, !tbaa !46
  %log2_big_block_size = getelementptr inbounds %struct.ole2_header_tag, ptr %hdr, i64 0, i32 5
...
if.end66:                                         ; preds = %if.end60
  %8 = load i32, ptr %size, align 1, !tbaa !46
...
while.body.i:                                     ; preds = %while.body.i, %while.body.preheader.i
  ...
  br i1 %cmp5.i, label %while.body.i, label %while.end.i, !llvm.loop !47
...
while.body.i257:                                  ; preds = %while.body.i257, %while.body.preheader.i253
  ...
  br i1 %cmp1.i256, label %while.body.i257, label %while.end.i259, !llvm.loop !48
...
if.end149:                                        ; preds = %if.end134, %ole2_get_next_sbat_block.exit
  ...
  br i1 %30, label %while.body, label %while.end, !llvm.loop !49
...
if.end10.i:                                       ; preds = %if.end30.i61.i, %if.end8.i51.i
  ...
  br i1 %cmp6.i, label %while.body.i, label %while.end.i, !llvm.loop !50
...
entry:
  ...
  %0 = load i16, ptr %name_size, align 1, !tbaa !45
...
sw.epilog:                                        ; preds = %sw.default, %sw.bb8, %sw.bb7, %sw.bb
  ...
  %2 = load i8, ptr %color, align 1, !tbaa !51
...
for.inc:                                          ; preds = %land.lhs.true, %if.end101
  ...
  br i1 %cmp10, label %for.body, label %for.end.loopexit, !llvm.loop !55
