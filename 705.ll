; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/zlib_gzlib.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/zlib_gzlib.c"
...
if.end96:                                         ; preds = %if.then93, %if.end91
  ...
  %16 = load i64, ptr %pos98, align 8, !tbaa !31
  %add99 = add nsw i64 %16, %offset.addr.2
  br label %cleanup
...
if.then7:                                         ; preds = %if.end5
  %err = getelementptr inbounds %struct.gz_state, ptr %file, i64 0, i32 17
  %1 = load i32, ptr %err, align 4, !tbaa !30
  store i32 %1, ptr %errnum, align 4, !tbaa !36
  br label %if.end8
