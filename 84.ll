; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/shared_output.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/ClamAV/shared_output.c"
...
if.then4:                                         ; preds = %if.then
  ...
  %call5 = call ptr @fopen(ptr noundef %2, ptr noundef nonnull @.str)
...
if.then20:                                        ; preds = %if.end18
  ...
  %call.i = call i32 @__xstat(i32 noundef 1, ptr noundef nonnull %7, ptr noundef nonnull %sb) #14
  %cmp22.not = icmp eq i32 %call.i, -1
