; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Aes.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/C/Aes.c"
...
define dso_local void @AesCbc_Decode(ptr nocapture noundef %p, ptr nocapture noundef %data, i64 noundef %numBlocks) #3 {
entry:
...
Aes_Decode.exit:                                  ; preds = %for.cond.i
  %idxprom216.i.le = zext i32 %and215.i to i64
  %arrayidx217.i = getelementptr inbounds [256 x i8], ptr @InvS, i64 0, i64 %idxprom216.i.le
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end
  ...
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %temp) #7
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %11 = shufflevector <2 x i32> %8, <2 x i32> poison, <16 x i32> <i32 0, i32 1, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  %12 = shufflevector <16 x i32> %10, <16 x i32> %11, <16 x i32> <i32 0, i32 1, i32 16, i32 17, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef, i32 undef>
  ...
  call void @llvm.lifetime.end.p0(i64 16, ptr nonnull %temp) #7
...
; Function Attrs: nofree norecurse nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none) uwtable
define internal fastcc void @Aes_Encode(ptr nocapture noundef readonly %w, ptr nocapture noundef writeonly %dest, ptr nocapture noundef readonly %src) unnamed_addr #4 {
entry:
...
for.end:                                          ; preds = %for.cond
  ...
  %uglygep = getelementptr i8, ptr %w, i64 %51
  %add.ptr215 = getelementptr inbounds i32, ptr %uglygep, i64 12
  ...
  %arrayidx274 = getelementptr inbounds i32, ptr %uglygep, i64 13
  ...
  %arrayidx306 = getelementptr inbounds i32, ptr %uglygep, i64 14
  ...
  %arrayidx338 = getelementptr inbounds i32, ptr %uglygep, i64 15
