; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/pointlis.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/McCat/09-vor/pointlis.c"
...
; Function Attrs: nounwind uwtable
define dso_local ptr @remove_points(ptr noundef readonly %PL) local_unnamed_addr #0 {
entry:
...
land.lhs.true:                                    ; preds = %while.body
  ...
  %or.cond = select i1 %cmp19, i1 %cmp23, i1 false
...
lor.lhs.false:                                    ; preds = %land.lhs.true
  ...
  %or.cond238 = select i1 %cmp26, i1 %cmp30, i1 false
...
lor.lhs.false31:                                  ; preds = %lor.lhs.false
  ...
  %or.cond239 = select i1 %cmp34, i1 %cmp38, i1 false
  %cmp42 = icmp slt i32 %a.sroa.18.0.copyload, %b.sroa.20.0.copyload
  %or.cond240 = select i1 %or.cond239, i1 %cmp42, i1 false
  %cmp46 = icmp slt i32 %b.sroa.20.0.copyload, %c.sroa.14.0.copyload
  %or.cond241 = select i1 %or.cond240, i1 %cmp46, i1 false
...
lor.lhs.false47:                                  ; preds = %lor.lhs.false31
  ...
  %or.cond243 = select i1 %or.cond239, i1 %cmp58, i1 false
  %cmp62 = icmp sgt i32 %b.sroa.20.0.copyload, %c.sroa.14.0.copyload
  %or.cond244 = select i1 %or.cond243, i1 %cmp62, i1 false
...
if.then:                                          ; preds = %lor.lhs.false47, %lor.lhs.false31, %lor.lhs.false, %land.lhs.true
  ...
  %3 = load ptr, ptr %prev, align 8, !tbaa !16
  %next68 = getelementptr inbounds %struct.CHpoints, ptr %3, i64 0, i32 3
  store ptr %1, ptr %next68, align 8, !tbaa !15
  %4 = load ptr, ptr %next1, align 8, !tbaa !15
  tail call void @free(ptr noundef nonnull %temp.0254) #11
  %5 = load i32, ptr @CHno, align 4, !tbaa !6
  %dec = add nsw i32 %5, -1
...
while.end:                                        ; preds = %land.rhs, %if.end, %entry
  %temp.0.lcssa = phi ptr [ %0, %entry ], [ %PL, %if.end ], [ %temp.0254, %land.rhs ]
...
land.lhs.true92:                                  ; preds = %while.end
  ...
  %or.cond245 = select i1 %cmp95, i1 %cmp99, i1 false
...
lor.lhs.false100:                                 ; preds = %land.lhs.true92
  ...
  %or.cond246 = select i1 %cmp103, i1 %cmp107, i1 false
...
lor.lhs.false108:                                 ; preds = %lor.lhs.false100
  ...
  %or.cond247 = select i1 %cmp111, i1 %cmp115, i1 false
  %cmp119 = icmp slt i32 %a.sroa.18.0.copyload208, %b.sroa.20.0.copyload166
  %or.cond248 = select i1 %or.cond247, i1 %cmp119, i1 false
  %cmp123 = icmp slt i32 %b.sroa.20.0.copyload166, %c.sroa.14.0.copyload188
  %or.cond249 = select i1 %or.cond248, i1 %cmp123, i1 false
...
lor.lhs.false124:                                 ; preds = %lor.lhs.false108
  ...
  %or.cond251 = select i1 %or.cond247, i1 %cmp135, i1 false
  %cmp139 = icmp sgt i32 %b.sroa.20.0.copyload166, %c.sroa.14.0.copyload188
  %or.cond252 = select i1 %or.cond251, i1 %cmp139, i1 false
...
if.then140:                                       ; preds = %lor.lhs.false124, %lor.lhs.false108, %lor.lhs.false100, %land.lhs.true92
  ...
  %dec148 = add nsw i32 %10, -1
  store i32 %dec148, ptr @CHno, align 4, !tbaa !6
  br label %if.end149

if.end149:                                        ; preds = %if.then140, %lor.lhs.false124, %while.end
  %temp.2 = phi ptr [ %9, %if.then140 ], [ %temp.0.lcssa, %lor.lhs.false124 ], [ %temp.0.lcssa, %while.end ]
  ret ptr %temp.2
}
