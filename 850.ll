; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/te.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/unix-tbl/te.c"
...
if.end8:                                          ; preds = %if.then3
  ...
  %call9 = tail call i32 @_IO_getc(ptr noundef %8)
  br label %if.end10
