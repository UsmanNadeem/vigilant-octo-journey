; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/Burg/map.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/Burg/map.c"
...
; Function Attrs: nounwind uwtable
define dso_local ptr @encode(ptr nocapture noundef %m, ptr noundef %ts, ptr nocapture noundef writeonly %new) local_unnamed_addr #0 {
entry:
...
cleanup10.thread:                                 ; preds = %for.inc
...
cleanup52:                                        ; preds = %cleanup31, %cleanup10.thread, %if.end39
  %retval.4 = phi ptr [ %22, %cleanup31 ], [ %ts, %if.end39 ], [ %1, %cleanup10.thread ]
  ret ptr %retval.4
}
