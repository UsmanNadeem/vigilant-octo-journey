; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/Burg/fe.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/Burg/fe.c"
...
for.body:                                         ; preds = %if.then, %if.end
  ...
  %3 = load ptr, ptr %next, align 8, !tbaa !43
