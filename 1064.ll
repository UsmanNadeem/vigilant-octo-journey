; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z49.c"
...
if.end59:                                         ; preds = %if.then47, %if.then55, %if.end41
  ...
  %call.i395 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %20, ptr noundef nonnull @.str.34, double noundef 2.000000e+01, double noundef 2.000000e+01)
  store i32 0, ptr @cpexists, align 4, !tbaa !9
  ...
  %call.i396 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %23, ptr noundef nonnull @.str.33, i32 noundef %sub68, i32 noundef %sub72)
  store i32 0, ptr @cpexists, align 4, !tbaa !9
...
cond.end154:                                      ; preds = %if.end111, %cond.false131
  ...
  %or.cond392 = select i1 %cmp156, i1 true, i1 %cmp160
  br i1 %or.cond392, label %sw.epilog.sink.split, label %cond.false163
...
if.end212:                                        ; preds = %if.then207, %if.end203
  %call.i397 = call i32 @StringBeginsWith(ptr noundef nonnull %buff, ptr noundef nonnull @.str.35) #11
  %tobool.not.i = icmp eq i32 %call.i397, 0
...
cond.end301:                                      ; preds = %if.end255, %cond.false277
  ...
  %or.cond394 = select i1 %cmp303, i1 true, i1 %cmp307
  br i1 %or.cond394, label %sw.epilog.sink.split, label %cond.false310
...
if.else341:                                       ; preds = %sw.bb226
  %call.i398 = call i32 @StringBeginsWith(ptr noundef nonnull %buff, ptr noundef nonnull @.str.35) #11
  %tobool.not.i399 = icmp eq i32 %call.i398, 0
  br i1 %tobool.not.i399, label %strip_out.exit405, label %sw.epilog.sink.split

strip_out.exit405:                                ; preds = %if.else341
  %call1.i400 = call i32 @StringBeginsWith(ptr noundef nonnull %buff, ptr noundef nonnull @.str.36) #11
  %tobool2.not.i401.not = icmp eq i32 %call1.i400, 0
  br i1 %tobool2.not.i401.not, label %if.then345, label %sw.epilog.sink.split

if.then345:                                       ; preds = %strip_out.exit405
  %67 = load ptr, ptr @out_fp, align 8, !tbaa !5
  %call347 = call i32 @fputs(ptr noundef nonnull %buff, ptr noundef %67)
  br label %sw.epilog.sink.split

sw.epilog.sink.split:                             ; preds = %strip_out.exit405, %if.then345, %if.else341, %cond.false310, %cond.end301, %strip_out.exit, %if.then216, %if.end212, %cond.false163, %cond.end154
  %.sink = phi i32 [ 1, %cond.end154 ], [ 1, %cond.false163 ], [ 0, %if.end212 ], [ 0, %if.then216 ], [ 0, %strip_out.exit ], [ 1, %cond.end301 ], [ 1, %cond.false310 ], [ 0, %if.else341 ], [ 0, %if.then345 ], [ 0, %strip_out.exit405 ]
  %x.addr.1.ph = phi ptr [ %x.addr.0.ph, %cond.end154 ], [ %x.addr.0.ph, %cond.false163 ], [ %x.addr.0.ph, %if.end212 ], [ %x.addr.0.ph, %if.then216 ], [ %x.addr.0.ph, %strip_out.exit ], [ %call232, %cond.end301 ], [ %call232, %cond.false310 ], [ %x.addr.0.ph, %if.else341 ], [ %x.addr.0.ph, %if.then345 ], [ %x.addr.0.ph, %strip_out.exit405 ]
...
for.body:                                         ; preds = %for.body.lr.ph, %if.end
  ...
  %p.053 = phi ptr [ %ostring, %for.body.lr.ph ], [ %incdec.ptr32, %if.end ]
  %q.052 = phi ptr [ %arrayidx, %for.body.lr.ph ], [ %q.1, %if.end ]
  %cmp3.not = icmp ult ptr %q.052, getelementptr inbounds ([200 x i8], ptr @ConvertToPDFName.buff, i64 0, i64 199)
...
if.then:                                          ; preds = %for.body
  ...
  %.pre = load i8, ptr %p.053, align 1, !tbaa !19
  br label %if.end
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  %3 = and i8 %2, -33
  %4 = add i8 %3, -65
  %or.cond49 = icmp ult i8 %4, 26
  %5 = add i8 %2, -48
  %or.cond48 = icmp ult i8 %5, 10
  %or.cond50 = select i1 %or.cond49, i1 true, i1 %or.cond48
  %storemerge = select i1 %or.cond50, i8 %2, i8 95
  %q.1 = getelementptr inbounds i8, ptr %q.052, i64 1
  store i8 %storemerge, ptr %q.052, align 1, !tbaa !19
  %incdec.ptr32 = getelementptr inbounds i8, ptr %p.053, i64 1
...
if.then11:                                        ; preds = %if.then
  %call12 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %6)
  store i32 0, ptr @wordcount, align 4, !tbaa !9
  br label %if.end14

if.else:                                          ; preds = %if.then
  %call13 = tail call i32 @_IO_putc(i32 noundef 32, ptr noundef %6)
  br label %if.end14
...
if.then33:                                        ; preds = %if.then27
  %call34 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %10)
  store i32 0, ptr @wordcount, align 4, !tbaa !9
  br label %if.end39

if.else35:                                        ; preds = %if.then27
  %call36 = tail call i32 @_IO_putc(i32 noundef 32, ptr noundef %10)
  br label %if.end39
...
land.lhs.true:                                    ; preds = %while.cond66.preheader, %while.body78
  ...
  %or.cond = select i1 %cmp73.not, i1 true, i1 %cmp76.not
...
do.end:                                           ; preds = %do.cond
  ...
  %or.cond591 = select i1 %tobool111.not, i1 %cmp113, i1 false
  br i1 %or.cond591, label %if.then115, label %if.else146
...
if.else119:                                       ; preds = %if.then115
  ...
  %34 = load ptr, ptr @out_fp, align 8, !tbaa !5
  %call121 = tail call i32 @_IO_putc(i32 noundef 45, ptr noundef %34)
...
do.body133:                                       ; preds = %do.body133.preheader, %do.body133
  ...
  %38 = load ptr, ptr @out_fp, align 8, !tbaa !5
  %call137 = tail call i32 @_IO_putc(i32 noundef %conv136, ptr noundef %38)
...
if.else153:                                       ; preds = %if.else146
  ...
  %call155 = tail call i32 @_IO_putc(i32 noundef 45, ptr noundef %41)
...
do.body169:                                       ; preds = %do.body169.preheader, %do.body169
  ...
  %call174 = tail call i32 @_IO_putc(i32 noundef %conv173, ptr noundef %45)
...
do.end177:                                        ; preds = %do.body169
  ...
  %47 = load ptr, ptr @out_fp, align 8, !tbaa !5
  %call178 = tail call i32 @_IO_putc(i32 noundef 32, ptr noundef %47)
...
if.else185:                                       ; preds = %do.end177
  ...
  %call187 = tail call i32 @_IO_putc(i32 noundef 45, ptr noundef %49)
...
do.body201:                                       ; preds = %do.body201.preheader, %do.body201
  ...
  %call206 = tail call i32 @_IO_putc(i32 noundef %conv205, ptr noundef %53)
...
if.end216:                                        ; preds = %do.end209, %do.end140
  ...
  %56 = load ptr, ptr @out_fp, align 8, !tbaa !5
  %call217 = tail call i32 @_IO_putc(i32 noundef 40, ptr noundef %56)
...
if.else257:                                       ; preds = %PrintComposite.exit
  ...
  %72 = load ptr, ptr @out_fp, align 8, !tbaa !5
  %call269 = tail call i32 @_IO_putc(i32 noundef 45, ptr noundef %72)
...
do.body283:                                       ; preds = %do.body283.preheader, %do.body283
  ...
  %76 = load ptr, ptr @out_fp, align 8, !tbaa !5
  %call288 = tail call i32 @_IO_putc(i32 noundef %conv287, ptr noundef %76)
...
do.end291:                                        ; preds = %do.body283
  ...
  %78 = load ptr, ptr @out_fp, align 8, !tbaa !5
  %call292 = tail call i32 @_IO_putc(i32 noundef 40, ptr noundef %78)
...
if.end371:                                        ; preds = %for.end
  %idxprom343.le = and i64 %indvars.iv663, 4294967295
  ...
  %arrayidx366 = getelementptr inbounds i8, ptr %97, i64 %idxprom343.le
...
if.then388:                                       ; preds = %if.end384
  ...
  %cmp.not10.i592 = icmp eq i8 %108, 0
  br i1 %cmp.not10.i592, label %PrintComposite.exit606, label %while.body.lr.ph.i595

while.body.lr.ph.i595:                            ; preds = %if.then388
  %bf.load395 = load i32, ptr %ou2, align 8
  %109 = and i32 %bf.load395, 4194304
  %tobool.not.i593 = icmp eq i32 %109, 0
  %cond.i594 = select i1 %tobool.not.i593, ptr @.str.188, ptr @.str.187
  br label %while.body.i605

while.body.i605:                                  ; preds = %while.body.i605, %while.body.lr.ph.i595
  %110 = phi i8 [ %108, %while.body.lr.ph.i595 ], [ %113, %while.body.i605 ]
  %cp.addr.011.i596 = phi ptr [ %arrayidx393, %while.body.lr.ph.i595 ], [ %incdec.ptr.i603, %while.body.i605 ]
  %conv.i597 = zext i8 %110 to i32
  %x_offset.i598 = getelementptr inbounds %struct.composite_rec, ptr %cp.addr.011.i596, i64 0, i32 1
  %111 = load i16, ptr %x_offset.i598, align 2, !tbaa !53
  %conv2.i599 = sext i16 %111 to i32
  %y_offset.i600 = getelementptr inbounds %struct.composite_rec, ptr %cp.addr.011.i596, i64 0, i32 2
  %112 = load i16, ptr %y_offset.i600, align 2, !tbaa !54
  %conv3.i601 = sext i16 %112 to i32
  %call.i602 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %107, ptr noundef nonnull @.str.186, i32 noundef %conv2.i599, i32 noundef %conv3.i601, i32 noundef %conv.i597, ptr noundef nonnull %cond.i594)
  %incdec.ptr.i603 = getelementptr inbounds %struct.composite_rec, ptr %cp.addr.011.i596, i64 1
  %113 = load i8, ptr %incdec.ptr.i603, align 2, !tbaa !51
  %cmp.not.i604 = icmp eq i8 %113, 0
  br i1 %cmp.not.i604, label %PrintComposite.exit606.loopexit, label %while.body.i605, !llvm.loop !55

PrintComposite.exit606.loopexit:                  ; preds = %while.body.i605
  %.pre677 = load i8, ptr %p.2629, align 1, !tbaa !19
  %.pre680 = zext i8 %.pre677 to i64
  br label %PrintComposite.exit606

PrintComposite.exit606:                           ; preds = %PrintComposite.exit606.loopexit, %if.then388
  %idxprom407.pre-phi = phi i64 [ %.pre680, %PrintComposite.exit606.loopexit ], [ %idxprom390, %if.then388 ]
...
if.else424:                                       ; preds = %PrintComposite.exit606
  %sub435 = sub nsw i32 0, %conv410
  %117 = load ptr, ptr @out_fp, align 8, !tbaa !5
  %call436 = tail call i32 @_IO_putc(i32 noundef 45, ptr noundef %117)
  br label %do.body438.preheader

do.body438.preheader:                             ; preds = %PrintComposite.exit606, %if.else424
  %y400.1.ph = phi i32 [ %sub435, %if.else424 ], [ %conv410, %PrintComposite.exit606 ]
  br label %do.body438
...
do.body450:                                       ; preds = %do.body450.preheader, %do.body450
  ...
  %call455 = tail call i32 @_IO_putc(i32 noundef %conv454, ptr noundef %121)
...
do.end458:                                        ; preds = %do.body450
  ...
  %call459 = tail call i32 @_IO_putc(i32 noundef 40, ptr noundef %123)
...
if.then5:                                         ; preds = %if.then2
  %call6 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %3)
  store i32 0, ptr @wordcount, align 4, !tbaa !9
  br label %if.end9

if.else:                                          ; preds = %if.then2
  %call7 = tail call i32 @_IO_putc(i32 noundef 32, ptr noundef %3)
  br label %if.end9
...
entry:
  ...
  %cmp.not51.i = icmp eq i8 %1, 0
  br i1 %cmp.not51.i, label %ConvertToPDFName.exit, label %for.body.lr.ph.i
...
for.body.i:                                       ; preds = %if.end.i, %for.body.lr.ph.i
  ...
  %p.053.i = phi ptr [ %ostring.i, %for.body.lr.ph.i ], [ %incdec.ptr32.i, %if.end.i ]
  %q.052.i = phi ptr [ %arrayidx.i, %for.body.lr.ph.i ], [ %q.1.i, %if.end.i ]
  %cmp3.not.i = icmp ult ptr %q.052.i, getelementptr inbounds ([200 x i8], ptr @ConvertToPDFName.buff, i64 0, i64 199)
...
if.then.i:                                        ; preds = %for.body.i
  ...
  %.pre.i = load i8, ptr %p.053.i, align 1, !tbaa !19
  br label %if.end.i
...
if.end.i:                                         ; preds = %if.then.i, %for.body.i
  ...
  %4 = and i8 %3, -33
  %5 = add i8 %4, -65
  %or.cond49.i = icmp ult i8 %5, 26
  %6 = add i8 %3, -48
  %or.cond48.i = icmp ult i8 %6, 10
  %or.cond50.i = select i1 %or.cond49.i, i1 true, i1 %or.cond48.i
  %storemerge.i = select i1 %or.cond50.i, i8 %3, i8 95
  %q.1.i = getelementptr inbounds i8, ptr %q.052.i, i64 1
  store i8 %storemerge.i, ptr %q.052.i, align 1, !tbaa !19
  %incdec.ptr32.i = getelementptr inbounds i8, ptr %p.053.i, i64 1
...
for.end.i:                                        ; preds = %for.cond9.i
  ...
  %call189.i = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %ostring, ptr noundef nonnull dereferenceable(1) %ostring187.i) #11
  %cmp196.i = icmp eq i32 %call189.i, 0
  br i1 %cmp196.i, label %if.else, label %for.cond.i, !llvm.loop !74
...
if.then:                                          ; preds = %entry
  ...
  %call.i432 = tail call noalias ptr @malloc(i64 noundef %add.i) #13
...
if.end.i:                                         ; preds = %if.then.i433, %if.then
  store i32 %mul, ptr %call.i432, align 8, !tbaa !25
  %linktab_count.i = getelementptr inbounds %struct.anon.14, ptr %call.i432, i64 0, i32 1
...
for.inc.i:                                        ; preds = %if.then.i, %for.body.i
  ...
  br i1 %cmp.not.i.not, label %for.body.i, label %ltab_rehash.exit.loopexit, !llvm.loop !76
...
if.end27:                                         ; preds = %if.then18, %if.else20
  ...
  %arrayidx45.phi.trans.insert = getelementptr inbounds %struct.anon.14, ptr %.pre446, i64 0, i32 2, i64 %idxprom
...
if.end42:                                         ; preds = %if.end27, %while.end
  ...
  %link.0441 = load ptr, ptr %link.0.in440, align 8, !tbaa !19
...
for.end:                                          ; preds = %for.cond54
  ...
  %call274 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %ostring, ptr noundef nonnull dereferenceable(1) %ostring272) #11
...
if.then283:                                       ; preds = %for.end
  ...
  %call288 = tail call ptr @EchoFilePos(ptr noundef nonnull %ou155.le) #11
  %call289 = tail call ptr (i32, i32, ptr, i32, ptr, ...) @Error(i32 noundef 43, i32 noundef 2, ptr noundef nonnull @.str.196, i32 noundef 2, ptr noundef nonnull %ou1284, ptr noundef nonnull %ostring, ptr noundef %call288) #11
  br label %for.inc291
...
for.inc291:                                       ; preds = %for.end, %if.then283
  ...
  br i1 %cmp49.not, label %for.end295, label %for.cond54.preheader, !llvm.loop !79

for.end295:                                       ; preds = %for.inc291, %if.end42
  %27 = load i8, ptr @zz_lengths, align 1, !tbaa !19
  %conv296 = zext i8 %27 to i32
  store i32 %conv296, ptr @zz_size, align 4, !tbaa !9
...
if.then307:                                       ; preds = %for.end295
  %29 = load ptr, ptr @no_fpos, align 8, !tbaa !5
  %call308 = tail call ptr @GetMemory(i32 noundef %conv296, ptr noundef %29) #11
...
if.end318:                                        ; preds = %if.then307, %if.else309
  ...
  store i8 0, ptr %ou1319, align 8, !tbaa !19
  %osucc323 = getelementptr inbounds [2 x %struct.LIST], ptr %31, i64 0, i64 1, i32 1
  store ptr %31, ptr %osucc323, align 8, !tbaa !19
  %arrayidx325 = getelementptr inbounds [2 x %struct.LIST], ptr %31, i64 0, i64 1
  store ptr %31, ptr %arrayidx325, align 8, !tbaa !19
  %osucc329 = getelementptr inbounds %struct.LIST, ptr %31, i64 0, i32 1
  store ptr %31, ptr %osucc329, align 8, !tbaa !19
  store ptr %31, ptr %31, align 8, !tbaa !19
  store ptr %31, ptr @xx_link, align 8, !tbaa !5
  store ptr %31, ptr @zz_res, align 8, !tbaa !5
  %32 = load ptr, ptr %S, align 8, !tbaa !5
  %arrayidx335 = getelementptr inbounds %struct.anon.14, ptr %32, i64 0, i32 2, i64 %idxprom
...
cond.false343:                                    ; preds = %if.end318
  ...
  store ptr %36, ptr %osucc358, align 8, !tbaa !19
  ...
  store ptr %40, ptr %osucc364, align 8, !tbaa !19
...
cond.false376:                                    ; preds = %cond.end367
  ...
  %43 = load ptr, ptr %arrayidx378, align 8, !tbaa !19
  store ptr %43, ptr @zz_tmp, align 8, !tbaa !5
  %arrayidx381 = getelementptr inbounds [2 x %struct.LIST], ptr %42, i64 0, i64 1
  %44 = load ptr, ptr %arrayidx381, align 8, !tbaa !19
  store ptr %44, ptr %arrayidx378, align 8, !tbaa !19
  %45 = load ptr, ptr %arrayidx381, align 8, !tbaa !19
  %osucc391 = getelementptr inbounds [2 x %struct.LIST], ptr %45, i64 0, i64 1, i32 1
  store ptr %x, ptr %osucc391, align 8, !tbaa !19
  store ptr %43, ptr %arrayidx381, align 8, !tbaa !19
  %osucc397 = getelementptr inbounds [2 x %struct.LIST], ptr %43, i64 0, i64 1, i32 1
  store ptr %42, ptr %osucc397, align 8, !tbaa !19
...
for.end.i:                                        ; preds = %for.cond9.i
  ...
  %call189.i = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %ostring, ptr noundef nonnull dereferenceable(1) %ostring187.i) #11
  %cmp196.i = icmp eq i32 %call189.i, 0
  br i1 %cmp196.i, label %for.inc29, label %for.cond.i, !llvm.loop !74
