; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/cdecl/cdecl.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/cdecl/cdecl.c"
...
if.end:                                           ; preds = %entry, %yystack.backedge
  %incdec.ptr2053 = phi ptr [ %yys, %entry ], [ %incdec.ptr, %yystack.backedge ]
  %yystate.02052 = phi i16 [ 0, %entry ], [ %yystate.0.be, %yystack.backedge ]
  %yypv.02051 = phi ptr [ getelementptr inbounds ([150 x %union.YYSTYPE], ptr @yyv, i64 -1, i64 149), %entry ], [ %yypv.0.be, %yystack.backedge ]
  store i16 %yystate.02052, ptr %incdec.ptr2053, align 2, !tbaa !9
  %incdec.ptr2 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 1
  ...
  %idxprom = sext i16 %yystate.02052 to i64
...
if.then45:                                        ; preds = %yydefault
  %8 = load i32, ptr @yychar, align 4, !tbaa !5
  %cmp46 = icmp slt i32 %8, 0
  br i1 %cmp46, label %if.then48, label %if.end54

if.then48:                                        ; preds = %if.then45
  %call49 = call i32 @yylex()
  %spec.store.select1728 = call i32 @llvm.smax.i32(i32 %call49, i32 0)
  store i32 %spec.store.select1728, ptr @yychar, align 4
  br label %if.end54

if.end54:                                         ; preds = %if.then48, %if.then45
  %9 = phi i32 [ %spec.store.select1728, %if.then48 ], [ %8, %if.then45 ]
  br label %for.cond
...
lor.rhs:                                          ; preds = %for.cond
  ...
  %cmp61.not = icmp eq i16 %11, %yystate.02052
...
while.cond:                                       ; preds = %lor.rhs, %while.cond
  ...
  %or.cond1993 = select i1 %cmp65, i1 true, i1 %cmp68
  br i1 %or.cond1993, label %while.end, label %while.cond
...
sw.bb:                                            ; preds = %if.then82
  %puts.i1996 = call i32 @puts(ptr nonnull dereferenceable(1) @.str.2)
...
sw.bb84:                                          ; preds = %if.then82, %if.then82, %sw.bb
  ...
  %cmp86.not2047 = icmp ult ptr %incdec.ptr2053, %yys
  br i1 %cmp86.not2047, label %cleanup, label %while.body88

while.body88:                                     ; preds = %sw.bb84, %if.end111
  %yyps.12049 = phi ptr [ %incdec.ptr114, %if.end111 ], [ %incdec.ptr2053, %sw.bb84 ]
  %yypv.12048 = phi ptr [ %incdec.ptr115, %if.end111 ], [ %incdec.ptr2, %sw.bb84 ]
  %16 = load i16, ptr %yyps.12049, align 2, !tbaa !9
  ...
  %or.cond1729 = icmp ult i16 %add92, 322
  br i1 %or.cond1729, label %land.lhs.true100, label %if.end111
...
if.end111:                                        ; preds = %land.lhs.true100, %while.body88
  %incdec.ptr114 = getelementptr inbounds i16, ptr %yyps.12049, i64 -1
  %incdec.ptr115 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.12048, i64 -1
...
if.end122:                                        ; preds = %if.then82, %if.end78
  ...
  %add.ptr126 = getelementptr inbounds i16, ptr %incdec.ptr2053, i64 %idx.neg
...
if.end160:                                        ; preds = %if.then155, %lor.lhs.false146
  ...
  switch i32 %conv79.le, label %yystack.backedge [
    ...
    i32 54, label %sw.bb1094
    i32 55, label %sw.bb1096
    i32 56, label %sw.bb1101
    i32 57, label %sw.bb1103
    i32 58, label %sw.bb1104
    i32 59, label %sw.bb1106
    i32 60, label %sw.bb1108
    i32 61, label %sw.bb1113
    i32 64, label %sw.bb1118
    i32 66, label %sw.bb1120
    i32 67, label %sw.bb1122
    i32 68, label %sw.bb1124
    i32 69, label %sw.bb1127
    i32 70, label %sw.bb1130
    i32 71, label %sw.bb1133
    i32 72, label %sw.bb1136
    i32 73, label %sw.bb1141
    i32 74, label %sw.bb1143
    i32 75, label %sw.bb1145
    i32 76, label %sw.bb1325
    i32 77, label %sw.bb1328
    i32 78, label %sw.bb1331
    i32 79, label %sw.bb1334
    i32 80, label %sw.bb1337
    i32 81, label %sw.bb1524
    i32 82, label %sw.bb1526
    i32 86, label %sw.bb1713
    i32 87, label %sw.bb1715
    i32 88, label %sw.bb1717
  ]

sw.bb162:                                         ; preds = %if.end160
  call void @prompt()
  store i8 0, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge
...
sw.bb164:                                         ; preds = %if.end160
  %arrayidx165 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -3
  %28 = load ptr, ptr %arrayidx165, align 8, !tbaa !14
  %arrayidx166 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -1
  %29 = load ptr, ptr %arrayidx166, align 8, !tbaa !14
  %30 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  %right = getelementptr inbounds %struct.anon, ptr %yypv.02051, i64 0, i32 1
  %31 = load ptr, ptr %right, align 8, !tbaa !14
  %type = getelementptr inbounds %struct.anon, ptr %yypv.02051, i64 0, i32 2
  %32 = load ptr, ptr %type, align 8, !tbaa !14
  call void @dodeclare(ptr noundef %28, ptr noundef %29, ptr noundef %30, ptr noundef %31, ptr noundef %32)
  br label %yystack.backedge

sw.bb170:                                         ; preds = %if.end160
  %arrayidx171 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -1
  %33 = load ptr, ptr %arrayidx171, align 8, !tbaa !14
  %34 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  %right175 = getelementptr inbounds %struct.anon, ptr %yypv.02051, i64 0, i32 1
  %35 = load ptr, ptr %right175, align 8, !tbaa !14
  %type177 = getelementptr inbounds %struct.anon, ptr %yypv.02051, i64 0, i32 2
  %36 = load ptr, ptr %type177, align 8, !tbaa !14
  call void @dodeclare(ptr noundef null, ptr noundef %33, ptr noundef %34, ptr noundef %35, ptr noundef %36)
  br label %yystack.backedge

sw.bb178:                                         ; preds = %if.end160
  %arrayidx179 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -2
  %37 = load ptr, ptr %arrayidx179, align 8, !tbaa !14
  %38 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  %right183 = getelementptr inbounds %struct.anon, ptr %yypv.02051, i64 0, i32 1
  %39 = load ptr, ptr %right183, align 8, !tbaa !14
  %type185 = getelementptr inbounds %struct.anon, ptr %yypv.02051, i64 0, i32 2
  %40 = load ptr, ptr %type185, align 8, !tbaa !14
  call void @docast(ptr noundef %37, ptr noundef %38, ptr noundef %39, ptr noundef %40)
  br label %yystack.backedge

sw.bb186:                                         ; preds = %if.end160
  %41 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  %right190 = getelementptr inbounds %struct.anon, ptr %yypv.02051, i64 0, i32 1
  %42 = load ptr, ptr %right190, align 8, !tbaa !14
  %type192 = getelementptr inbounds %struct.anon, ptr %yypv.02051, i64 0, i32 2
  %43 = load ptr, ptr %type192, align 8, !tbaa !14
  call void @docast(ptr noundef null, ptr noundef %41, ptr noundef %42, ptr noundef %43)
  br label %yystack.backedge

sw.bb193:                                         ; preds = %if.end160
  %arrayidx194 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -3
  %44 = load ptr, ptr %arrayidx194, align 8, !tbaa !14
  %arrayidx195 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -2
  %45 = load ptr, ptr %arrayidx195, align 8, !tbaa !14
  %arrayidx196 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -1
  %46 = load ptr, ptr %arrayidx196, align 8, !tbaa !14
  %47 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  call void @dodexplain(ptr noundef %44, ptr noundef %45, ptr noundef %46, ptr noundef %47)
  br label %yystack.backedge

sw.bb198:                                         ; preds = %if.end160
  %arrayidx199 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -2
  %48 = load ptr, ptr %arrayidx199, align 8, !tbaa !14
  %arrayidx200 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -1
  %49 = load ptr, ptr %arrayidx200, align 8, !tbaa !14
  %50 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  call void @dodexplain(ptr noundef %48, ptr noundef %49, ptr noundef null, ptr noundef %50)
  br label %yystack.backedge

sw.bb202:                                         ; preds = %if.end160
  %arrayidx203 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -2
  %51 = load ptr, ptr %arrayidx203, align 8, !tbaa !14
  %arrayidx204 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -1
  %52 = load ptr, ptr %arrayidx204, align 8, !tbaa !14
  %53 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  call void @dodexplain(ptr noundef %51, ptr noundef %52, ptr noundef null, ptr noundef %53)
  br label %yystack.backedge

sw.bb206:                                         ; preds = %if.end160
  %arrayidx207 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -4
  %54 = load ptr, ptr %arrayidx207, align 8, !tbaa !14
  %arrayidx208 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -3
  %55 = load ptr, ptr %arrayidx208, align 8, !tbaa !14
  %arrayidx209 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -2
  %56 = load ptr, ptr %arrayidx209, align 8, !tbaa !14
  %57 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  call void @docexplain(ptr noundef %54, ptr noundef %55, ptr noundef %56, ptr noundef %57)
  br label %yystack.backedge

sw.bb211:                                         ; preds = %if.end160
  %58 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
...
sw.bb216:                                         ; preds = %if.end160
  %59 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %59, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb218:                                         ; preds = %if.end160
  %call219 = call ptr @ds(ptr noundef nonnull @unknown_name)
  store ptr %call219, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb220:                                         ; preds = %if.end160
  %60 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %61 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  %char01992 = load i8, ptr %61, align 1
  %tobool.not = icmp eq i8 %char01992, 0
  ...
  store ptr %call226, ptr @yyval, align 8, !tbaa !14
  store i8 112, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge
...
if.end230:                                        ; preds = %if.then229, %sw.bb227
  %64 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %call232 = call ptr @ds(ptr noundef nonnull @.str.6)
  %arrayidx233 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -2
  %65 = load ptr, ptr %arrayidx233, align 8, !tbaa !14
  ...
  store ptr %call235, ptr @yyval, align 8, !tbaa !14
  store i8 112, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge
...
if.then238:                                       ; preds = %sw.bb236
  ...
  %call4.i.i1999 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %67, ptr noundef nonnull @.str.67, ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.8)
  br label %if.end239

if.end239:                                        ; preds = %if.then238, %sw.bb236
  %68 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %69 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  %char01991 = load i8, ptr %69, align 1
  %tobool244.not = icmp eq i8 %char01991, 0
  ...
  store ptr %call247, ptr @yyval, align 8, !tbaa !14
  store i8 114, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge

sw.bb248:                                         ; preds = %if.end160
  %arrayidx249 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -1
  %70 = load ptr, ptr %arrayidx249, align 8, !tbaa !14
  ...
  store ptr %call251, ptr @yyval, align 8, !tbaa !14
  store i8 102, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge

sw.bb252:                                         ; preds = %if.end160
  %arrayidx253 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -2
  %71 = load ptr, ptr %arrayidx253, align 8, !tbaa !14
  %call254 = call ptr @ds(ptr noundef nonnull @.str.12)
  %72 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  ...
  store ptr %call257, ptr @yyval, align 8, !tbaa !14
  store i8 102, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge

sw.bb258:                                         ; preds = %if.end160
  %73 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  %call260 = call ptr @ds(ptr noundef nonnull @.str.14)
  %74 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %call262 = call ptr (ptr, ...) @cat(ptr noundef %73, ptr noundef %call260, ptr noundef %74, ptr noundef null)
  store ptr %call262, ptr @yyval, align 8, !tbaa !14
  store i8 97, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge

sw.bb263:                                         ; preds = %if.end160
  %75 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  store ptr %75, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb265:                                         ; preds = %if.end160
  %76 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %76, ptr @savedname, align 8, !tbaa !12
  %call267 = call ptr @ds(ptr noundef nonnull @.str.15)
  store ptr %call267, ptr @yyval, align 8, !tbaa !14
  store i8 110, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge

sw.bb268:                                         ; preds = %if.end160
  %arrayidx269 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -1
  %77 = load ptr, ptr %arrayidx269, align 8, !tbaa !14
  %call270 = call ptr @ds(ptr noundef nonnull @.str.16)
  %78 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %call272 = call ptr (ptr, ...) @cat(ptr noundef %77, ptr noundef %call270, ptr noundef %78, ptr noundef null)
  store ptr %call272, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb273:                                         ; preds = %if.end160
  %79 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %arrayidx275 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -1
  %80 = load ptr, ptr %arrayidx275, align 8, !tbaa !14
  %char01990 = load i8, ptr %80, align 1
  %tobool278.not = icmp eq i8 %char01990, 0
  %cond279 = select i1 %tobool278.not, ptr @.str.15, ptr @.str.7
  %call280 = call ptr @ds(ptr noundef nonnull %cond279)
  %81 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  %call282 = call ptr (ptr, ...) @cat(ptr noundef %79, ptr noundef nonnull %80, ptr noundef %call280, ptr noundef %81, ptr noundef null)
  store ptr %call282, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb283:                                         ; preds = %if.end160
  %82 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %82, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb285:                                         ; preds = %if.end160
  %call286 = call ptr @ds(ptr noundef nonnull @.str.15)
  store ptr %call286, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb287:                                         ; preds = %if.end160
  %arrayidx288 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -1
  %83 = load ptr, ptr %arrayidx288, align 8, !tbaa !14
  %call289 = call ptr @ds(ptr noundef nonnull @.str.16)
  %84 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %call291 = call ptr (ptr, ...) @cat(ptr noundef %83, ptr noundef %call289, ptr noundef %84, ptr noundef null)
  store ptr %call291, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb292:                                         ; preds = %if.end160
  %85 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %85, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb294:                                         ; preds = %if.end160
  %type296 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 1, i32 0, i32 2
  %86 = load ptr, ptr %type296, align 8, !tbaa !14
  %call297 = call ptr @ds(ptr noundef nonnull @.str.7)
  %87 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %right301 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 1, i32 0, i32 1
  %88 = load ptr, ptr %right301, align 8, !tbaa !14
  %call302 = call ptr (ptr, ...) @cat(ptr noundef %86, ptr noundef %call297, ptr noundef %87, ptr noundef %88, ptr noundef null)
  store ptr %call302, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb303:                                         ; preds = %if.end160
  %type305 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 1, i32 0, i32 2
  %89 = load ptr, ptr %type305, align 8, !tbaa !14
  %call306 = call ptr @ds(ptr noundef nonnull @.str.7)
  %90 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %arrayidx309 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -1
  %91 = load ptr, ptr %arrayidx309, align 8, !tbaa !14
  %right311 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 1, i32 0, i32 1
  %92 = load ptr, ptr %right311, align 8, !tbaa !14
  ...
  store ptr %call312, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb313:                                         ; preds = %if.end160
  %call314 = call ptr @ds(ptr noundef nonnull @.str.15)
  store ptr %call314, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb315:                                         ; preds = %if.end160
  %call316 = call ptr @ds(ptr noundef nonnull @.str.11)
  store ptr %call316, ptr @yyval, align 8, !tbaa !14
  store i8 102, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge

sw.bb317:                                         ; preds = %if.end160
  %arrayidx318 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -2
  %93 = load ptr, ptr %arrayidx318, align 8, !tbaa !14
  ...
  store ptr %call320, ptr @yyval, align 8, !tbaa !14
  store i8 102, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge

sw.bb321:                                         ; preds = %if.end160
  %arrayidx322 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -3
  %94 = load ptr, ptr %arrayidx322, align 8, !tbaa !14
  %call323 = call ptr @ds(ptr noundef nonnull @.str.12)
  %95 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  ...
  store ptr %call326, ptr @yyval, align 8, !tbaa !14
  store i8 102, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge

sw.bb327:                                         ; preds = %if.end160
  %96 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  store ptr %96, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge
...
if.then331:                                       ; preds = %sw.bb329
  ...
  %call4.i.i2002 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %98, ptr noundef nonnull @.str.67, ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.5)
  br label %if.end332

if.end332:                                        ; preds = %if.then331, %sw.bb329
  %99 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %call334 = call ptr @ds(ptr noundef nonnull @.str.6)
  %arrayidx335 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -2
  %100 = load ptr, ptr %arrayidx335, align 8, !tbaa !14
  ...
  store ptr %call337, ptr @yyval, align 8, !tbaa !14
  store i8 112, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge

sw.bb338:                                         ; preds = %if.end160
  %101 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  ...
  store ptr %call341, ptr @yyval, align 8, !tbaa !14
  store i8 112, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge
...
if.then344:                                       ; preds = %sw.bb342
  ...
  %call4.i.i2005 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %103, ptr noundef nonnull @.str.67, ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.8)
  br label %if.end345

if.end345:                                        ; preds = %if.then344, %sw.bb342
  %104 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  ...
  store ptr %call348, ptr @yyval, align 8, !tbaa !14
  store i8 114, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge

sw.bb349:                                         ; preds = %if.end160
  %105 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  %call351 = call ptr @ds(ptr noundef nonnull @.str.14)
  %106 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %call353 = call ptr (ptr, ...) @cat(ptr noundef %105, ptr noundef %call351, ptr noundef %106, ptr noundef null)
  store ptr %call353, ptr @yyval, align 8, !tbaa !14
  store i8 97, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge

sw.bb354:                                         ; preds = %if.end160
  %call355 = call ptr @ds(ptr noundef nonnull @.str.17)
  store ptr %call355, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb356:                                         ; preds = %if.end160
  %107 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  ...
  store ptr %call359, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb360:                                         ; preds = %if.end160
  %108 = load i8, ptr @prev, align 1, !tbaa !14
...
if.else:                                          ; preds = %sw.bb360
  %109 = and i8 %108, -33
  %or.cond1730 = icmp eq i8 %109, 65
  br i1 %or.cond1730, label %if.then372, label %if.end374
...
if.end374:                                        ; preds = %if.then372, %if.else, %if.then364
  %110 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %110, ptr @yyval, align 8, !tbaa !14
  %call377 = call ptr @ds(ptr noundef nonnull @.str.23)
  %right379 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 1, i32 0, i32 1
  %111 = load ptr, ptr %right379, align 8, !tbaa !14
  %call380 = call ptr (ptr, ...) @cat(ptr noundef %call377, ptr noundef %111, ptr noundef null)
  store ptr %call380, ptr getelementptr inbounds (%union.YYSTYPE, ptr @yyval, i64 0, i32 0, i32 1), align 8, !tbaa !14
  %type382 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 1, i32 0, i32 2
  %112 = load ptr, ptr %type382, align 8, !tbaa !14
  store ptr %112, ptr getelementptr inbounds (%union.YYSTYPE, ptr @yyval, i64 0, i32 0, i32 2), align 8, !tbaa !14
  store i8 102, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge

sw.bb383:                                         ; preds = %if.end160
  %113 = load i8, ptr @prev, align 1, !tbaa !14
...
if.else388:                                       ; preds = %sw.bb383
  %114 = and i8 %113, -33
  %or.cond1731 = icmp eq i8 %114, 65
  br i1 %or.cond1731, label %if.then396, label %if.end398
...
if.end398:                                        ; preds = %if.then396, %if.else388, %if.then387
  %115 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %115, ptr @yyval, align 8, !tbaa !14
  %call401 = call ptr @ds(ptr noundef nonnull @.str.24)
  %arrayidx402 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -2
  %116 = load ptr, ptr %arrayidx402, align 8, !tbaa !14
  %call403 = call ptr @ds(ptr noundef nonnull @.str.25)
  %right405 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 1, i32 0, i32 1
  %117 = load ptr, ptr %right405, align 8, !tbaa !14
  %call406 = call ptr (ptr, ...) @cat(ptr noundef %call401, ptr noundef %116, ptr noundef %call403, ptr noundef %117, ptr noundef null)
  store ptr %call406, ptr getelementptr inbounds (%union.YYSTYPE, ptr @yyval, i64 0, i32 0, i32 1), align 8, !tbaa !14
  %type408 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 1, i32 0, i32 2
  %118 = load ptr, ptr %type408, align 8, !tbaa !14
  store ptr %118, ptr getelementptr inbounds (%union.YYSTYPE, ptr @yyval, i64 0, i32 0, i32 2), align 8, !tbaa !14
  store i8 102, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge

sw.bb409:                                         ; preds = %if.end160
  %119 = load i8, ptr @prev, align 1, !tbaa !14
...
if.end426:                                        ; preds = %sw.bb409, %if.then418, %if.then423, %if.then413
  ...
  store i8 %., ptr @prev, align 1, !tbaa !14
  %121 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %121, ptr @yyval, align 8, !tbaa !14
  %arrayidx433 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -1
  %122 = load ptr, ptr %arrayidx433, align 8, !tbaa !14
  %right435 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 1, i32 0, i32 1
  %123 = load ptr, ptr %right435, align 8, !tbaa !14
  %call436 = call ptr (ptr, ...) @cat(ptr noundef %122, ptr noundef %123, ptr noundef null)
  store ptr %call436, ptr getelementptr inbounds (%union.YYSTYPE, ptr @yyval, i64 0, i32 0, i32 1), align 8, !tbaa !14
  %type438 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 1, i32 0, i32 2
  %124 = load ptr, ptr %type438, align 8, !tbaa !14
  store ptr %124, ptr getelementptr inbounds (%union.YYSTYPE, ptr @yyval, i64 0, i32 0, i32 2), align 8, !tbaa !14
  br label %yystack.backedge

sw.bb439:                                         ; preds = %if.end160
  %125 = load i8, ptr @prev, align 1, !tbaa !14
...
if.then443:                                       ; preds = %sw.bb439
  ...
  %.pr = load i8, ptr @prev, align 1, !tbaa !14
  br label %if.end444
...
if.end457:                                        ; preds = %if.end444, %if.then456
  ...
  %arrayidx458 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -2
  %127 = load ptr, ptr %arrayidx458, align 8, !tbaa !14
  %char01989 = load i8, ptr %127, align 1
  %cmp460.not = icmp eq i8 %char01989, 0
  %spec.select = select i1 %cmp460.not, ptr @.str.15, ptr @.str.7
  %128 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  ...
  %129 = load ptr, ptr %arrayidx458, align 8, !tbaa !14
  ...
  store ptr %call471, ptr @yyval, align 8, !tbaa !14
  %call472 = call ptr @ds(ptr noundef nonnull %cp.0)
  %right474 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 1, i32 0, i32 1
  %130 = load ptr, ptr %right474, align 8, !tbaa !14
  %call475 = call ptr (ptr, ...) @cat(ptr noundef %call472, ptr noundef %130, ptr noundef null)
  store ptr %call475, ptr getelementptr inbounds (%union.YYSTYPE, ptr @yyval, i64 0, i32 0, i32 1), align 8, !tbaa !14
  %type477 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 1, i32 0, i32 2
  %131 = load ptr, ptr %type477, align 8, !tbaa !14
  store ptr %131, ptr getelementptr inbounds (%union.YYSTYPE, ptr @yyval, i64 0, i32 0, i32 2), align 8, !tbaa !14
  store i8 112, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge
...
if.then483:                                       ; preds = %sw.bb478
  ...
  %call4.i.i2008 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %133, ptr noundef nonnull @.str.67, ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.5)
  br label %if.end484

if.end484:                                        ; preds = %if.then483, %sw.bb478
  %134 = load i8, ptr @prev, align 1, !tbaa !14
  %cmp486 = icmp eq i8 %134, 97
  br i1 %cmp486, label %if.then488, label %if.end489

if.then488:                                       ; preds = %if.end484
  call void @unsupp(ptr noundef nonnull @.str.32, ptr noundef nonnull @.str.33)
  %.pr2036 = load i8, ptr @prev, align 1, !tbaa !14
  br label %if.end489

if.end489:                                        ; preds = %if.then488, %if.end484
  %135 = phi i8 [ %.pr2036, %if.then488 ], [ %134, %if.end484 ]
...
if.end502:                                        ; preds = %if.end489, %if.then501
  ...
  %arrayidx503 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -6
  %136 = load ptr, ptr %arrayidx503, align 8, !tbaa !14
  %char01988 = load i8, ptr %136, align 1
  %cmp505.not = icmp eq i8 %char01988, 0
  %spec.select1994 = select i1 %cmp505.not, ptr @.str.15, ptr @.str.7
  %137 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %call511 = call ptr @ds(ptr noundef nonnull %op479.0)
  %138 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  %call513 = call ptr @ds(ptr noundef nonnull @.str.35)
  %call514 = call ptr @ds(ptr noundef nonnull %spec.select1994)
  %139 = load ptr, ptr %arrayidx503, align 8, !tbaa !14
  %call516 = call ptr @ds(ptr noundef nonnull %spec.select1994)
  ...
  store ptr %call517, ptr @yyval, align 8, !tbaa !14
  %call518 = call ptr @ds(ptr noundef nonnull %cp480.0)
  %right520 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 1, i32 0, i32 1
  %140 = load ptr, ptr %right520, align 8, !tbaa !14
  %call521 = call ptr (ptr, ...) @cat(ptr noundef %call518, ptr noundef %140, ptr noundef null)
  store ptr %call521, ptr getelementptr inbounds (%union.YYSTYPE, ptr @yyval, i64 0, i32 0, i32 1), align 8, !tbaa !14
  %type523 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 1, i32 0, i32 2
  %141 = load ptr, ptr %type523, align 8, !tbaa !14
  store ptr %141, ptr getelementptr inbounds (%union.YYSTYPE, ptr @yyval, i64 0, i32 0, i32 2), align 8, !tbaa !14
  store i8 112, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge
...
if.then529:                                       ; preds = %sw.bb524
  ...
  %call4.i.i2011 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %143, ptr noundef nonnull @.str.67, ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.8)
  br label %if.end530

if.end530:                                        ; preds = %if.then529, %sw.bb524
  %144 = load i8, ptr @prev, align 1, !tbaa !14
...
if.end541thread-pre-split:                        ; preds = %if.then534, %if.then539
  %.pr2037 = load i8, ptr @prev, align 1, !tbaa !14
  br label %if.end541

if.end541:                                        ; preds = %if.end541thread-pre-split, %if.end530
  %145 = phi i8 [ %.pr2037, %if.end541thread-pre-split ], [ %144, %if.end530 ]
...
if.end554:                                        ; preds = %if.end541, %if.then553
  ...
  %arrayidx555 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 -2
  %146 = load ptr, ptr %arrayidx555, align 8, !tbaa !14
  %char01987 = load i8, ptr %146, align 1
  %cmp557.not = icmp eq i8 %char01987, 0
  %spec.select1995 = select i1 %cmp557.not, ptr @.str.15, ptr @.str.7
  %147 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %call563 = call ptr @ds(ptr noundef nonnull %op525.0)
  %call564 = call ptr @ds(ptr noundef nonnull @.str.39)
  %call565 = call ptr @ds(ptr noundef nonnull %spec.select1995)
  %148 = load ptr, ptr %arrayidx555, align 8, !tbaa !14
  %call567 = call ptr @ds(ptr noundef nonnull %spec.select1995)
  ...
  store ptr %call568, ptr @yyval, align 8, !tbaa !14
  %call569 = call ptr @ds(ptr noundef nonnull %cp526.0)
  %right571 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 1, i32 0, i32 1
  %149 = load ptr, ptr %right571, align 8, !tbaa !14
  %call572 = call ptr (ptr, ...) @cat(ptr noundef %call569, ptr noundef %149, ptr noundef null)
  store ptr %call572, ptr getelementptr inbounds (%union.YYSTYPE, ptr @yyval, i64 0, i32 0, i32 1), align 8, !tbaa !14
  %type574 = getelementptr inbounds %union.YYSTYPE, ptr %yypv.02051, i64 1, i32 0, i32 2
  %150 = load ptr, ptr %type574, align 8, !tbaa !14
  store ptr %150, ptr getelementptr inbounds (%union.YYSTYPE, ptr @yyval, i64 0, i32 0, i32 2), align 8, !tbaa !14
  store i8 114, ptr @prev, align 1, !tbaa !14
  br label %yystack.backedge

sw.bb575:                                         ; preds = %if.end160
  %call576 = call ptr @ds(ptr noundef nonnull @.str.15)
  store ptr %call576, ptr @yyval, align 8, !tbaa !14
  %call577 = call ptr @ds(ptr noundef nonnull @.str.15)
  store ptr %call577, ptr getelementptr inbounds (%union.YYSTYPE, ptr @yyval, i64 0, i32 0, i32 1), align 8, !tbaa !14
  %151 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %call722 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %151, ptr noundef nonnull dereferenceable(5) @.str.40) #22
  %cmp729 = icmp eq i32 %call722, 0
  br i1 %cmp729, label %if.end1085, label %cond.false900

cond.false900:                                    ; preds = %sw.bb575
  %call902 = call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %151, ptr noundef nonnull dereferenceable(7) @.str.41, i64 noundef 6) #23
  %cmp905 = icmp eq i32 %call902, 0
  br i1 %cmp905, label %if.end1085, label %cond.false1075

cond.false1075:                                   ; preds = %cond.false900
  %call1077 = call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %151, ptr noundef nonnull dereferenceable(6) @.str.42, i64 noundef 5) #23
  %cmp1080 = icmp eq i32 %call1077, 0
  %spec.select2068 = select i1 %cmp1080, i8 115, i8 116
  br label %if.end1085

if.end1085:                                       ; preds = %cond.false1075, %cond.false900, %sw.bb575
  %.sink = phi i8 [ 118, %sw.bb575 ], [ 115, %cond.false900 ], [ %spec.select2068, %cond.false1075 ]
  store i8 %.sink, ptr @prev, align 1, !tbaa !14
  %152 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  %char01986 = load i8, ptr %152, align 1
  %tobool1089.not = icmp eq i8 %char01986, 0
  %cond1090 = select i1 %tobool1089.not, ptr @.str.15, ptr @.str.7
  %call1091 = call ptr @ds(ptr noundef nonnull %cond1090)
  %153 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %call1093 = call ptr (ptr, ...) @cat(ptr noundef nonnull %152, ptr noundef %call1091, ptr noundef %153, ptr noundef null)
  store ptr %call1093, ptr getelementptr inbounds (%union.YYSTYPE, ptr @yyval, i64 0, i32 0, i32 2), align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1094:                                        ; preds = %if.end160
  store i32 1, ptr @arbdims, align 4, !tbaa !5
  %call1095 = call ptr @ds(ptr noundef nonnull @.str.43)
  store ptr %call1095, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1096:                                        ; preds = %if.end160
  store i32 0, ptr @arbdims, align 4, !tbaa !5
  %call1097 = call ptr @ds(ptr noundef nonnull @.str.44)
  %154 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %call1099 = call ptr @ds(ptr noundef nonnull @.str.45)
  %call1100 = call ptr (ptr, ...) @cat(ptr noundef %call1097, ptr noundef %154, ptr noundef %call1099, ptr noundef null)
  store ptr %call1100, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1101:                                        ; preds = %if.end160
  call void @mbcheck()
  %155 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %155, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1103:                                        ; preds = %if.end160
  store i32 0, ptr @modbits, align 4, !tbaa !5
  br label %yystack.backedge

sw.bb1104:                                        ; preds = %if.end160
  %156 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %156, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1106:                                        ; preds = %if.end160
  %157 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %157, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1108:                                        ; preds = %if.end160
  %158 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  %call1110 = call ptr @ds(ptr noundef nonnull @.str.7)
  %159 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %call1112 = call ptr (ptr, ...) @cat(ptr noundef %158, ptr noundef %call1110, ptr noundef %159, ptr noundef null)
  store ptr %call1112, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1113:                                        ; preds = %if.end160
  %160 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  %call1115 = call ptr @ds(ptr noundef nonnull @.str.7)
  %161 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %call1117 = call ptr (ptr, ...) @cat(ptr noundef %160, ptr noundef %call1115, ptr noundef %161, ptr noundef null)
  store ptr %call1117, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1118:                                        ; preds = %if.end160
  %162 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %162, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1120:                                        ; preds = %if.end160
  %163 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %163, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1122:                                        ; preds = %if.end160
  %164 = load i32, ptr @modbits, align 4, !tbaa !5
  %or = or i32 %164, 8
  store i32 %or, ptr @modbits, align 4, !tbaa !5
  %165 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %165, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1124:                                        ; preds = %if.end160
  %166 = load i32, ptr @modbits, align 4, !tbaa !5
  %or1125 = or i32 %166, 16
  store i32 %or1125, ptr @modbits, align 4, !tbaa !5
  %167 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %167, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1127:                                        ; preds = %if.end160
  %168 = load i32, ptr @modbits, align 4, !tbaa !5
  %or1128 = or i32 %168, 32
  store i32 %or1128, ptr @modbits, align 4, !tbaa !5
  %169 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %169, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1130:                                        ; preds = %if.end160
  %170 = load i32, ptr @modbits, align 4, !tbaa !5
  %or1131 = or i32 %170, 64
  store i32 %or1131, ptr @modbits, align 4, !tbaa !5
  %171 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %171, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1133:                                        ; preds = %if.end160
  %172 = load i32, ptr @modbits, align 4, !tbaa !5
  %or1134 = or i32 %172, 128
  store i32 %or1134, ptr @modbits, align 4, !tbaa !5
  %173 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %173, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1136:                                        ; preds = %if.end160
  %174 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  %call1138 = call ptr @ds(ptr noundef nonnull @.str.7)
  %175 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %call1140 = call ptr (ptr, ...) @cat(ptr noundef %174, ptr noundef %call1138, ptr noundef %175, ptr noundef null)
  store ptr %call1140, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1141:                                        ; preds = %if.end160
  %176 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %176, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1143:                                        ; preds = %if.end160
  %177 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %177, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1145:                                        ; preds = %if.end160
  %178 = load i32, ptr @PreANSIFlag, align 4, !tbaa !5
  %tobool1146.not = icmp eq i32 %178, 0
  br i1 %tobool1146.not, label %if.else1149, label %if.then1147

if.then1147:                                      ; preds = %sw.bb1145
  %179 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
...
if.else1149:                                      ; preds = %sw.bb1145
  %182 = load i32, ptr @RitchieFlag, align 4, !tbaa !5
  %tobool1150.not = icmp eq i32 %182, 0
  %183 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  br i1 %tobool1150.not, label %cond.end1313, label %if.then1151

if.then1151:                                      ; preds = %if.else1149
  %184 = load i32, ptr @CplusplusFlag, align 4, !tbaa !5
  %tobool2.not.i2012 = icmp eq i32 %184, 0
  %cond3.i2013 = select i1 %tobool2.not.i2012, ptr @.str.15, ptr @.str.66
  %185 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call4.i2014 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %185, ptr noundef nonnull @.str.67, ptr noundef nonnull @.str.47, ptr noundef nonnull %cond3.i2013, ptr noundef %183)
  br label %if.end1323

cond.end1313:                                     ; preds = %if.else1149
  %call1308 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %183, ptr noundef nonnull dereferenceable(8) @.str.48) #22
  %cmp1315 = icmp eq i32 %call1308, 0
  %186 = load i32, ptr @CplusplusFlag, align 4
  %tobool1318 = icmp ne i32 %186, 0
  %or.cond1744 = select i1 %cmp1315, i1 %tobool1318, i1 false
  br i1 %or.cond1744, label %if.then1319, label %if.end1323

if.then1319:                                      ; preds = %cond.end1313
  %187 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call4.i.i2017 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %187, ptr noundef nonnull @.str.67, ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.66, ptr noundef %183)
  br label %if.end1323

if.end1323:                                       ; preds = %if.then1151, %if.then1319, %cond.end1313, %if.then1147
  %188 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %188, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1325:                                        ; preds = %if.end160
  %189 = load i32, ptr @modbits, align 4, !tbaa !5
  %or1326 = or i32 %189, 4
  store i32 %or1326, ptr @modbits, align 4, !tbaa !5
  %190 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %190, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1328:                                        ; preds = %if.end160
  %191 = load i32, ptr @modbits, align 4, !tbaa !5
  %or1329 = or i32 %191, 256
  store i32 %or1329, ptr @modbits, align 4, !tbaa !5
  %192 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %192, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1331:                                        ; preds = %if.end160
  %193 = load i32, ptr @modbits, align 4, !tbaa !5
  %or1332 = or i32 %193, 2
  store i32 %or1332, ptr @modbits, align 4, !tbaa !5
  %194 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %194, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1334:                                        ; preds = %if.end160
  %195 = load i32, ptr @modbits, align 4, !tbaa !5
  %or1335 = or i32 %195, 1
  store i32 %or1335, ptr @modbits, align 4, !tbaa !5
  %196 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %196, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1337:                                        ; preds = %if.end160
  %197 = load i32, ptr @PreANSIFlag, align 4, !tbaa !5
  %tobool1338.not = icmp eq i32 %197, 0
  br i1 %tobool1338.not, label %if.else1341, label %if.then1339

if.then1339:                                      ; preds = %sw.bb1337
  %198 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  %199 = load i32, ptr @CplusplusFlag, align 4, !tbaa !5
  %tobool2.not.i2018 = icmp eq i32 %199, 0
  %cond3.i2019 = select i1 %tobool2.not.i2018, ptr @.str.15, ptr @.str.66
  %200 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call4.i2020 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %200, ptr noundef nonnull @.str.67, ptr noundef nonnull @.str.46, ptr noundef nonnull %cond3.i2019, ptr noundef %198)
  br label %if.end1515

if.else1341:                                      ; preds = %sw.bb1337
  %201 = load i32, ptr @RitchieFlag, align 4, !tbaa !5
  %tobool1342.not = icmp eq i32 %201, 0
  %202 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  br i1 %tobool1342.not, label %cond.end1505, label %if.then1343

if.then1343:                                      ; preds = %if.else1341
  %203 = load i32, ptr @CplusplusFlag, align 4, !tbaa !5
  %tobool2.not.i2021 = icmp eq i32 %203, 0
  %cond3.i2022 = select i1 %tobool2.not.i2021, ptr @.str.15, ptr @.str.66
  %204 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call4.i2023 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %204, ptr noundef nonnull @.str.67, ptr noundef nonnull @.str.47, ptr noundef nonnull %cond3.i2022, ptr noundef %202)
  br label %if.end1515

cond.end1505:                                     ; preds = %if.else1341
  %call1500 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %202, ptr noundef nonnull dereferenceable(8) @.str.48) #22
  %cmp1507 = icmp eq i32 %call1500, 0
  %205 = load i32, ptr @CplusplusFlag, align 4
  %tobool1510 = icmp ne i32 %205, 0
  %or.cond1748 = select i1 %cmp1507, i1 %tobool1510, i1 false
  br i1 %or.cond1748, label %if.then1511, label %if.end1515

if.then1511:                                      ; preds = %cond.end1505
  %206 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call4.i.i2026 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %206, ptr noundef nonnull @.str.67, ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.66, ptr noundef %202)
  br label %if.end1515

if.end1515:                                       ; preds = %if.then1343, %if.then1511, %cond.end1505, %if.then1339
  %207 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  %208 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %char01985 = load i8, ptr %208, align 1
  %tobool1519.not = icmp eq i8 %char01985, 0
  %cond1520 = select i1 %tobool1519.not, ptr @.str.15, ptr @.str.7
  %call1521 = call ptr @ds(ptr noundef nonnull %cond1520)
  %209 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %call1523 = call ptr (ptr, ...) @cat(ptr noundef %207, ptr noundef %call1521, ptr noundef %209, ptr noundef null)
  store ptr %call1523, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1524:                                        ; preds = %if.end160
  %call1525 = call ptr @ds(ptr noundef nonnull @.str.15)
  store ptr %call1525, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1526:                                        ; preds = %if.end160
  %210 = load i32, ptr @PreANSIFlag, align 4, !tbaa !5
  %tobool1527.not = icmp eq i32 %210, 0
  br i1 %tobool1527.not, label %if.else1530, label %if.then1528

if.then1528:                                      ; preds = %sw.bb1526
  %211 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  %212 = load i32, ptr @CplusplusFlag, align 4, !tbaa !5
  %tobool2.not.i2027 = icmp eq i32 %212, 0
  %cond3.i2028 = select i1 %tobool2.not.i2027, ptr @.str.15, ptr @.str.66
  %213 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call4.i2029 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %213, ptr noundef nonnull @.str.67, ptr noundef nonnull @.str.46, ptr noundef nonnull %cond3.i2028, ptr noundef %211)
  br label %if.end1704

if.else1530:                                      ; preds = %sw.bb1526
  %214 = load i32, ptr @RitchieFlag, align 4, !tbaa !5
  %tobool1531.not = icmp eq i32 %214, 0
  %215 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  br i1 %tobool1531.not, label %cond.end1694, label %if.then1532

if.then1532:                                      ; preds = %if.else1530
  %216 = load i32, ptr @CplusplusFlag, align 4, !tbaa !5
  %tobool2.not.i2030 = icmp eq i32 %216, 0
  %cond3.i2031 = select i1 %tobool2.not.i2030, ptr @.str.15, ptr @.str.66
  %217 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call4.i2032 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %217, ptr noundef nonnull @.str.67, ptr noundef nonnull @.str.47, ptr noundef nonnull %cond3.i2031, ptr noundef %215)
  br label %if.end1704

cond.end1694:                                     ; preds = %if.else1530
  %call1689 = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %215, ptr noundef nonnull dereferenceable(8) @.str.48) #22
  %cmp1696 = icmp eq i32 %call1689, 0
  %218 = load i32, ptr @CplusplusFlag, align 4
  %tobool1699 = icmp ne i32 %218, 0
  %or.cond1752 = select i1 %cmp1696, i1 %tobool1699, i1 false
  br i1 %or.cond1752, label %if.then1700, label %if.end1704

if.then1700:                                      ; preds = %cond.end1694
  %219 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call4.i.i2035 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %219, ptr noundef nonnull @.str.67, ptr noundef nonnull @.str.15, ptr noundef nonnull @.str.66, ptr noundef %215)
  br label %if.end1704

if.end1704:                                       ; preds = %if.then1532, %if.then1700, %cond.end1694, %if.then1528
  %220 = load ptr, ptr %yypv.02051, align 8, !tbaa !14
  %221 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %char0 = load i8, ptr %221, align 1
  %tobool1708.not = icmp eq i8 %char0, 0
  %cond1709 = select i1 %tobool1708.not, ptr @.str.15, ptr @.str.7
  %call1710 = call ptr @ds(ptr noundef nonnull %cond1709)
  %222 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  %call1712 = call ptr (ptr, ...) @cat(ptr noundef %220, ptr noundef %call1710, ptr noundef %222, ptr noundef null)
  store ptr %call1712, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1713:                                        ; preds = %if.end160
  %223 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %223, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1715:                                        ; preds = %if.end160
  %224 = load ptr, ptr %incdec.ptr2, align 8, !tbaa !14
  store ptr %224, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge

sw.bb1717:                                        ; preds = %if.end160
  %call1718 = call ptr @ds(ptr noundef nonnull @.str.15)
  store ptr %call1718, ptr @yyval, align 8, !tbaa !14
  br label %yystack.backedge
...
entry:
  ...
  %1 = load ptr, ptr @helptext, align 16, !tbaa !15
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %4 = load ptr, ptr %cpptext, align 8, !tbaa !17
...
for.inc:                                          ; preds = %land.lhs.true, %if.else
  ...
  %5 = load ptr, ptr %incdec.ptr, align 8, !tbaa !15
...
entry:
  %0 = load i8, ptr @prev, align 1, !tbaa !14
...
if.end:                                           ; preds = %if.then, %entry
  %4 = load i8, ptr %storage, align 1, !tbaa !14
  %cmp3 = icmp eq i8 %4, 114
  br i1 %cmp3, label %if.then5, label %if.end9

if.then5:                                         ; preds = %if.end
  %5 = load i8, ptr @prev, align 1, !tbaa !14
...
if.end9thread-pre-split:                          ; preds = %if.then5, %sw.bb8, %sw.bb7
  ...
  %tobool2.not.i.i53 = icmp eq i32 %6, 0
  %cond3.i.i54 = select i1 %tobool2.not.i.i53, ptr @.str.15, ptr @.str.66
  %7 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call4.i.i55 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %7, ptr noundef nonnull @.str.67, ptr noundef nonnull @.str.15, ptr noundef nonnull %cond3.i.i54, ptr noundef nonnull %.str.132.sink)
  %.pr = load i8, ptr %storage, align 1, !tbaa !14
  br label %if.end9
...
entry:
  ...
  br i1 %tobool.not, label %if.end137, label %cond.end116

cond.end116:                                      ; preds = %entry
  %call111 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %type, ptr noundef nonnull dereferenceable(5) @.str.40) #22
  %cmp118 = icmp eq i32 %call111, 0
  br i1 %cmp118, label %if.then120, label %if.end137

if.then120:                                       ; preds = %cond.end116
  %0 = load i8, ptr @prev, align 1, !tbaa !14
  switch i8 %0, label %if.end137 [
    i8 110, label %if.end137.sink.split
    i8 97, label %if.then128
    i8 114, label %if.then133
  ]
...
if.end137.sink.split:                             ; preds = %if.then120, %if.then128, %if.then133
  %.str.128.sink = phi ptr [ @.str.142, %if.then133 ], [ @.str.140, %if.then128 ], [ @.str.128, %if.then120 ]
  %.str.129.sink = phi ptr [ @.str.31, %if.then133 ], [ @.str.141, %if.then128 ], [ @.str.129, %if.then120 ]
  %1 = load i32, ptr @CplusplusFlag, align 4, !tbaa !5
  %tobool2.not.i.i = icmp eq i32 %1, 0
  %cond3.i.i = select i1 %tobool2.not.i.i, ptr @.str.15, ptr @.str.66
  %2 = load ptr, ptr @stdout, align 8, !tbaa !12
...
if.end137:                                        ; preds = %if.end137.sink.split, %if.then120, %cond.end116, %entry
  %4 = load i8, ptr %storage, align 1, !tbaa !14
  %cmp139 = icmp eq i8 %4, 114
  br i1 %cmp139, label %if.then141, label %if.end145

if.then141:                                       ; preds = %if.end137
  %5 = load i8, ptr @prev, align 1, !tbaa !14
  %conv142 = sext i8 %5 to i32
  switch i32 %conv142, label %if.end145 [
    i32 102, label %if.end145.sink.split
    i32 65, label %sw.bb143
    i32 97, label %sw.bb143
    i32 115, label %sw.bb144
  ]

sw.bb143:                                         ; preds = %if.then141, %if.then141
  br label %if.end145.sink.split

sw.bb144:                                         ; preds = %if.then141
  br label %if.end145.sink.split

if.end145.sink.split:                             ; preds = %if.then141, %sw.bb144, %sw.bb143
  %.str.130.sink = phi ptr [ @.str.131, %sw.bb143 ], [ @.str.143, %sw.bb144 ], [ @.str.130, %if.then141 ]
  %6 = load i32, ptr @CplusplusFlag, align 4, !tbaa !5
  %tobool2.not.i.i188 = icmp eq i32 %6, 0
  %cond3.i.i189 = select i1 %tobool2.not.i.i188, ptr @.str.15, ptr @.str.66
  %7 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call4.i.i190 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %7, ptr noundef nonnull @.str.67, ptr noundef nonnull @.str.15, ptr noundef nonnull %cond3.i.i189, ptr noundef nonnull %.str.130.sink)
  br label %if.end145

if.end145:                                        ; preds = %if.end145.sink.split, %if.then141, %if.end137
  %8 = load ptr, ptr @savedname, align 8, !tbaa !12
  %call146 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.144, ptr noundef %8)
  %9 = load i8, ptr %storage, align 1, !tbaa !14
  %tobool147.not = icmp eq i8 %9, 0
  br i1 %tobool147.not, label %if.end150, label %if.then148

if.then148:                                       ; preds = %if.end145
  %call149 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.133, ptr noundef nonnull %storage)
  br label %if.end150

if.end150:                                        ; preds = %if.then148, %if.end145
  %call151 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.145, ptr noundef %decl)
  %10 = load i8, ptr %constvol, align 1, !tbaa !14
  %tobool152.not = icmp eq i8 %10, 0
  br i1 %tobool152.not, label %if.end155, label %if.then153

if.then153:                                       ; preds = %if.end150
  %call154 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.133, ptr noundef nonnull %constvol)
  br label %if.end155

if.end155:                                        ; preds = %if.then153, %if.end150
  %cond160 = select i1 %tobool.not, ptr @.str.52, ptr %type
  %puts = tail call i32 @puts(ptr nonnull dereferenceable(1) %cond160)
  ret void
}
...
entry:
  %call110 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %type, ptr noundef nonnull dereferenceable(5) @.str.40) #22
  %cmp117 = icmp eq i32 %call110, 0
  br i1 %cmp117, label %if.then119, label %if.end130

if.then119:                                       ; preds = %entry
  %0 = load i8, ptr @prev, align 1, !tbaa !14
  switch i8 %0, label %if.end130 [
    i8 97, label %if.end130.sink.split
    i8 114, label %if.then127
  ]

if.then127:                                       ; preds = %if.then119
  br label %if.end130.sink.split

if.end130.sink.split:                             ; preds = %if.then119, %if.then127
  %.str.140.sink = phi ptr [ @.str.142, %if.then127 ], [ @.str.140, %if.then119 ]
  %.str.141.sink = phi ptr [ @.str.31, %if.then127 ], [ @.str.141, %if.then119 ]
  %1 = load i32, ptr @CplusplusFlag, align 4, !tbaa !5
  %tobool2.not.i.i = icmp eq i32 %1, 0
  %cond3.i.i = select i1 %tobool2.not.i.i, ptr @.str.15, ptr @.str.66
  %2 = load ptr, ptr @stdout, align 8, !tbaa !12
...
if.end130:                                        ; preds = %if.end130.sink.split, %if.then119, %entry
  %call131 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.146, ptr noundef %name, ptr noundef %cast)
  %char0 = load i8, ptr %constvol, align 1
  %cmp133.not = icmp eq i8 %char0, 0
  br i1 %cmp133.not, label %if.end137, label %if.then135

if.then135:                                       ; preds = %if.end130
  %call136 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.133, ptr noundef nonnull %constvol)
  br label %if.end137
...
entry:
  %call110 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %opt, ptr noundef nonnull dereferenceable(7) @.str.147) #22
  %cmp117 = icmp eq i32 %call110, 0
  br i1 %cmp117, label %if.then119, label %cond.end262

if.then119:                                       ; preds = %entry
  store i32 1, ptr @MkProgramFlag, align 4, !tbaa !5
  br label %if.end1506

cond.end262:                                      ; preds = %entry
  %call257 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %opt, ptr noundef nonnull dereferenceable(9) @.str.148) #22
  %cmp264 = icmp eq i32 %call257, 0
  br i1 %cmp264, label %if.then266, label %cond.end410

if.then266:                                       ; preds = %cond.end262
  store i32 0, ptr @MkProgramFlag, align 4, !tbaa !5
  br label %if.end1506

cond.end410:                                      ; preds = %cond.end262
  %call405 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %opt, ptr noundef nonnull dereferenceable(12) @.str.149) #22
  %cmp412 = icmp eq i32 %call405, 0
  br i1 %cmp412, label %if.then414, label %cond.end558

if.then414:                                       ; preds = %cond.end410
  store i32 1, ptr @Interactive, align 4, !tbaa !5
  br label %if.end1506

cond.end558:                                      ; preds = %cond.end410
  %call553 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %opt, ptr noundef nonnull dereferenceable(14) @.str.150) #22
  %cmp560 = icmp eq i32 %call553, 0
  br i1 %cmp560, label %if.then562, label %cond.end706

if.then562:                                       ; preds = %cond.end558
  store i32 0, ptr @Interactive, align 4, !tbaa !5
  store i32 0, ptr @OnATty, align 4, !tbaa !5
  br label %if.end1506

cond.end706:                                      ; preds = %cond.end558
  %call701 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %opt, ptr noundef nonnull dereferenceable(8) @.str.151) #22
  %cmp708 = icmp eq i32 %call701, 0
  br i1 %cmp708, label %if.then710, label %cond.end854

if.then710:                                       ; preds = %cond.end706
...
cond.end854:                                      ; preds = %cond.end706
  %call849 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %opt, ptr noundef nonnull dereferenceable(8) @.str.152) #22
  %cmp856 = icmp eq i32 %call849, 0
  br i1 %cmp856, label %if.then858, label %cond.end1002
...
cond.end1002:                                     ; preds = %cond.end854
  %call997 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %opt, ptr noundef nonnull dereferenceable(5) @.str.153) #22
  %cmp1004 = icmp eq i32 %call997, 0
  br i1 %cmp1004, label %if.then1006, label %cond.end1150

if.then1006:                                      ; preds = %cond.end1002
  store i32 0, ptr @CplusplusFlag, align 4, !tbaa !5
  store i32 0, ptr @RitchieFlag, align 4, !tbaa !5
  store i32 0, ptr @PreANSIFlag, align 4, !tbaa !5
  br label %if.end1506

cond.end1150:                                     ; preds = %cond.end1002
  %call1145 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %opt, ptr noundef nonnull dereferenceable(10) @.str.154) #22
  %cmp1152 = icmp eq i32 %call1145, 0
  br i1 %cmp1152, label %if.then1154, label %if.else1155

if.then1154:                                      ; preds = %cond.end1150
  store i32 1, ptr @CplusplusFlag, align 4, !tbaa !5
  store i32 0, ptr @RitchieFlag, align 4, !tbaa !5
  store i32 0, ptr @PreANSIFlag, align 4, !tbaa !5
  br label %if.end1506

if.else1155:                                      ; preds = %cond.end1150
  %call1298 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %opt, ptr noundef nonnull dereferenceable(1) @unknown_name) #22
  %cmp1305.not = icmp eq i32 %call1298, 0
  br i1 %cmp1305.not, label %if.end1456, label %cond.end1450

cond.end1450:                                     ; preds = %if.else1155
  %call1445 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %opt, ptr noundef nonnull dereferenceable(8) @.str.155) #22
  %cmp1452.not = icmp eq i32 %call1445, 0
  br i1 %cmp1452.not, label %if.end1456, label %if.then1454

if.then1454:                                      ; preds = %cond.end1450
  %call1455 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.156, ptr noundef %opt)
  br label %if.end1456

if.end1456:                                       ; preds = %if.then1454, %cond.end1450, %if.else1155
  %puts = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.179)
  %puts1635 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.180)
  %puts1636 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.181)
  %puts1637 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.182)
  %puts1638 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.183)
  %puts1639 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.184)
  %0 = load i32, ptr @MkProgramFlag, align 4, !tbaa !5
  %tobool.not = icmp eq i32 %0, 0
  %cond1463 = select i1 %tobool.not, ptr @.str.165, ptr @.str.164
  %call1464 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.163, ptr noundef nonnull %cond1463)
  %1 = load i32, ptr @OnATty, align 4, !tbaa !5
  %tobool1465 = icmp ne i32 %1, 0
  %2 = load i32, ptr @Interactive, align 4
  %tobool1467 = icmp ne i32 %2, 0
  %3 = select i1 %tobool1465, i1 true, i1 %tobool1467
  %cond1469 = select i1 %3, ptr @.str.164, ptr @.str.165
  %call1470 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.166, ptr noundef nonnull %cond1469)
  %4 = load i32, ptr @RitchieFlag, align 4, !tbaa !5
  %tobool1471.not = icmp eq i32 %4, 0
  %str.185.str.192 = select i1 %tobool1471.not, ptr @str.185, ptr @str.192
  %puts1640 = tail call i32 @puts(ptr nonnull dereferenceable(1) %str.185.str.192)
  %5 = load i32, ptr @PreANSIFlag, align 4, !tbaa !5
  %tobool1477.not = icmp eq i32 %5, 0
  %str.186.sink = select i1 %tobool1477.not, ptr @str.186, ptr @str.191
  %puts1641 = tail call i32 @puts(ptr nonnull dereferenceable(1) %str.186.sink)
  %6 = load i32, ptr @RitchieFlag, align 4, !tbaa !5
  %tobool1483 = icmp ne i32 %6, 0
  %7 = load i32, ptr @PreANSIFlag, align 4
  %tobool1485 = icmp ne i32 %7, 0
  %or.cond1533 = select i1 %tobool1483, i1 true, i1 %tobool1485
  %8 = load i32, ptr @CplusplusFlag, align 4
  %tobool1487 = icmp ne i32 %8, 0
  %or.cond1534 = select i1 %or.cond1533, i1 true, i1 %tobool1487
  %str.190.sink = select i1 %or.cond1534, ptr @str.190, ptr @str.187
  %puts1645 = tail call i32 @puts(ptr nonnull dereferenceable(1) %str.190.sink)
  %9 = load i32, ptr @CplusplusFlag, align 4, !tbaa !5
  %tobool1493.not = icmp eq i32 %9, 0
  br i1 %tobool1493.not, label %if.else1496, label %if.then1494

if.then1494:                                      ; preds = %if.end1456
  %puts1644 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.189)
  br label %if.end1506

if.else1496:                                      ; preds = %if.end1456
  %puts1643 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.188)
  br label %if.end1506

if.end1506:                                       ; preds = %if.then266, %if.then562, %if.then858, %if.then1154, %if.else1496, %if.then1494, %if.then1006, %if.then710, %if.then414, %if.then119
  ret void
}
...
if.end:                                           ; preds = %for.end
  store i8 0, ptr %call5, align 1, !tbaa !14
  call void @llvm.va_start(ptr nonnull %args)
...
for.body:                                         ; preds = %entry, %for.inc54
  ...
  %1 = load i32, ptr %bit, align 8, !tbaa !18
  %and = and i32 %1, %0
...
for.body4:                                        ; preds = %for.body, %for.inc
  ...
  %3 = load i32, ptr %bit7, align 8, !tbaa !18
  %and8 = and i32 %3, %2
...
if.end:                                           ; preds = %for.body4
  ...
  %4 = load i8, ptr %arrayidx13, align 1, !tbaa !14
  %cmp14 = icmp eq i8 %4, 0
  br i1 %cmp14, label %for.inc, label %if.end17

if.end17:                                         ; preds = %if.end
  %5 = load ptr, ptr %arrayidx, align 16, !tbaa !20
  %6 = load ptr, ptr %arrayidx6, align 16, !tbaa !20
...
yyfussy:                                          ; preds = %if.end, %sw.epilog
  ...
  switch i32 %call96, label %sw.default [
    i32 0, label %cleanup.loopexit100
    i32 1, label %cleanup.loopexit
    i32 2, label %cleanup.loopexit101
    i32 3, label %cleanup.loopexit102
    i32 4, label %cleanup.loopexit103
    i32 5, label %cleanup.loopexit100
    i32 6, label %cleanup
    i32 7, label %sw.bb11
    i32 8, label %sw.bb12
    i32 9, label %sw.bb13
    ...
    i32 15, label %cleanup.loopexit100
...
sw.bb87:                                          ; preds = %yyfussy
  ...
  %4 = load i8, ptr @yytext, align 16, !tbaa !14
...
cleanup.loopexit:                                 ; preds = %sw.epilog, %yyfussy, %yyfussy, %if.end
  %retval.0.ph = phi i32 [ 0, %if.end ], [ 257, %yyfussy ], [ 257, %yyfussy ], [ 0, %sw.epilog ]
  br label %cleanup

cleanup.loopexit100:                              ; preds = %yyfussy, %yyfussy, %yyfussy
  br label %cleanup
...
cleanup.loopexit103:                              ; preds = %yyfussy
  br label %cleanup

cleanup:                                          ; preds = %yyfussy, %cleanup.loopexit103, %cleanup.loopexit102, %cleanup.loopexit101, %cleanup.loopexit100, %cleanup.loopexit, %sw.bb87, %sw.bb86, %sw.bb82, %sw.bb80, %sw.bb78, %sw.bb76, %sw.bb74, %sw.bb72, %sw.bb70, %sw.bb68, %sw.bb66, %sw.bb64, %sw.bb62, %sw.bb60, %sw.bb58, %sw.bb56, %sw.bb54, %sw.bb52, %sw.bb50, %sw.bb48, %sw.bb46, %sw.bb44, %sw.bb42, %sw.bb40, %sw.bb38, %sw.bb36, %sw.bb34, %sw.bb32, %sw.bb30, %sw.bb29, %sw.bb28, %sw.bb27, %sw.bb25, %sw.bb24, %sw.bb23, %sw.bb22, %sw.bb21, %sw.bb20, %sw.bb18, %sw.bb17, %sw.bb16, %sw.bb15, %sw.bb14, %sw.bb13, %sw.bb12, %sw.bb11
  %retval.0 = phi i32 [ %conv91, %sw.bb87 ], [ %conv, %sw.bb86 ], [ 283, %sw.bb82 ], [ 282, %sw.bb80 ], [ 276, %sw.bb78 ], [ 289, %sw.bb76 ], [ 288, %sw.bb74 ], [ 287, %sw.bb72 ], [ 286, %sw.bb70 ], [ 286, %sw.bb68 ], [ 293, %sw.bb66 ], [ 285, %sw.bb64 ], [ 284, %sw.bb62 ], [ 292, %sw.bb60 ], [ 276, %sw.bb58 ], [ 281, %sw.bb56 ], [ 280, %sw.bb54 ], [ 280, %sw.bb52 ], [ 279, %sw.bb50 ], [ 291, %sw.bb48 ], [ 278, %sw.bb46 ], [ 278, %sw.bb44 ], [ 277, %sw.bb42 ], [ 276, %sw.bb40 ], [ 276, %sw.bb38 ], [ 275, %sw.bb36 ], [ 274, %sw.bb34 ], [ 274, %sw.bb32 ], [ 290, %sw.bb30 ], [ 260, %sw.bb29 ], [ 265, %sw.bb28 ], [ 262, %sw.bb27 ], [ 273, %sw.bb25 ], [ 272, %sw.bb24 ], [ 271, %sw.bb23 ], [ 271, %sw.bb22 ], [ 270, %sw.bb21 ], [ 270, %sw.bb20 ], [ 269, %sw.bb18 ], [ 269, %sw.bb17 ], [ 267, %sw.bb16 ], [ 268, %sw.bb15 ], [ 266, %sw.bb14 ], [ 265, %sw.bb13 ], [ 264, %sw.bb12 ], [ 264, %sw.bb11 ], [ %retval.0.ph, %cleanup.loopexit ], [ 0, %cleanup.loopexit100 ], [ 258, %cleanup.loopexit101 ], [ 259, %cleanup.loopexit102 ], [ 261, %cleanup.loopexit103 ], [ 263, %yyfussy ]
  ret i32 %retval.0
}
...
if.end:                                           ; preds = %entry, %if.else
  ...
  %.pre421 = load i32, ptr @yyprevious, align 4, !tbaa !5
  br label %for.cond

for.cond:                                         ; preds = %for.cond.backedge, %if.end
  %2 = phi i32 [ %.pre421, %if.end ], [ %.be, %for.cond.backedge ]
...
for.cond3:                                        ; preds = %for.cond3.backedge, %for.cond
  ...
  %4 = load ptr, ptr %yystate.1, align 8, !tbaa !21
...
if.then6:                                         ; preds = %for.cond3
  ...
  %5 = load ptr, ptr %yyother, align 8, !tbaa !23
...
cond.true:                                        ; preds = %if.end14
  ...
  %8 = load i8, ptr %incdec.ptr16, align 1, !tbaa !14
...
cond.end21:                                       ; preds = %cond.end, %cond.true19
  ...
  store i8 %conv29, ptr %yylastch.2, align 1, !tbaa !14
...
tryagain:                                         ; preds = %tryagain.preheader, %land.lhs.true166
  %yyt.0 = phi ptr [ %32, %land.lhs.true166 ], [ %4, %tryagain.preheader ]
  %yystate.2 = phi ptr [ %31, %land.lhs.true166 ], [ %yystate.1, %tryagain.preheader ]
...
land.lhs.true43:                                  ; preds = %if.then38
  %15 = load i8, ptr %add.ptr40, align 1, !tbaa !24
...
if.then49:                                        ; preds = %land.lhs.true43
  ...
  %16 = load i8, ptr %advance, align 1, !tbaa !26
  %cmp53 = icmp eq i8 %16, 0
  br i1 %cmp53, label %if.then55, label %if.end64

if.then55:                                        ; preds = %if.then49
  %conv29.le468 = trunc i32 %cond28 to i8
  %sext336 = shl i32 %cond28, 24
  %conv57 = ashr exact i32 %sext336, 24
  store i32 %conv57, ptr @yytchar, align 4, !tbaa !5
  %cmp58 = icmp eq i8 %conv29.le468, 10
  br i1 %cmp58, label %if.then60, label %if.end61

if.then60:                                        ; preds = %if.then55
  %17 = load i32, ptr @yylineno, align 4, !tbaa !5
  %dec = add nsw i32 %17, -1
  store i32 %dec, ptr @yylineno, align 4, !tbaa !5
  br label %if.end61

if.end61:                                         ; preds = %if.then60, %if.then55
  %18 = load ptr, ptr @yysptr, align 8, !tbaa !12
  %incdec.ptr63 = getelementptr inbounds i8, ptr %18, i64 1
  store ptr %incdec.ptr63, ptr @yysptr, align 8, !tbaa !12
  store i8 %conv29.le468, ptr %18, align 1, !tbaa !14
  br label %for.end
...
if.then72:                                        ; preds = %if.end64
  %19 = load ptr, ptr @yyout, align 8, !tbaa !12
  %call73 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %19, ptr noundef nonnull @.str.55, i32 noundef 8192)
  tail call void @exit(i32 noundef 1) #26
  unreachable
...
land.lhs.true85:                                  ; preds = %if.then79
  %20 = load i8, ptr %add.ptr82, align 2, !tbaa !24
  %idx.ext88 = zext i8 %20 to i64
...
if.then92:                                        ; preds = %land.lhs.true85
  %advance93 = getelementptr inbounds %struct.yywork, ptr %add.ptr82, i64 0, i32 1
  %21 = load i8, ptr %advance93, align 1, !tbaa !26
  %cmp97 = icmp eq i8 %21, 0
  br i1 %cmp97, label %if.then99, label %if.end109

if.then99:                                        ; preds = %if.then92
  %conv29.le472 = trunc i32 %cond28 to i8
  %sext335 = shl i32 %cond28, 24
  %conv101 = ashr exact i32 %sext335, 24
  store i32 %conv101, ptr @yytchar, align 4, !tbaa !5
  %cmp102 = icmp eq i8 %conv29.le472, 10
  br i1 %cmp102, label %if.then104, label %if.end106

if.then104:                                       ; preds = %if.then99
  %22 = load i32, ptr @yylineno, align 4, !tbaa !5
  %dec105 = add nsw i32 %22, -1
  store i32 %dec105, ptr @yylineno, align 4, !tbaa !5
  br label %if.end106

if.end106:                                        ; preds = %if.then104, %if.then99
  %23 = load ptr, ptr @yysptr, align 8, !tbaa !12
  %incdec.ptr108 = getelementptr inbounds i8, ptr %23, i64 1
  store ptr %incdec.ptr108, ptr @yysptr, align 8, !tbaa !12
  store i8 %conv29.le472, ptr %23, align 1, !tbaa !14
  br label %for.end

if.end109:                                        ; preds = %if.then92
  %idx.ext95 = zext i8 %21 to i64
...
if.then117:                                       ; preds = %if.end109
  ...
  %call118 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %24, ptr noundef nonnull @.str.55, i32 noundef 8192)
  tail call void @exit(i32 noundef 1) #26
  unreachable

if.end120:                                        ; preds = %land.lhs.true85, %if.then79
  %25 = load i8, ptr %arrayidx, align 1, !tbaa !14
  %idx.ext122 = sext i8 %25 to i64
...
land.lhs.true126:                                 ; preds = %if.end120
  %26 = load i8, ptr %add.ptr123, align 2, !tbaa !24
  %idx.ext129 = zext i8 %26 to i64
...
if.then133:                                       ; preds = %land.lhs.true126
  %advance134 = getelementptr inbounds %struct.yywork, ptr %add.ptr123, i64 0, i32 1
  %27 = load i8, ptr %advance134, align 1, !tbaa !26
  %cmp138 = icmp eq i8 %27, 0
  br i1 %cmp138, label %if.then140, label %if.end150

if.then140:                                       ; preds = %if.then133
  %conv29.le470 = trunc i32 %cond28 to i8
  %sext334 = shl i32 %cond28, 24
  %conv142 = ashr exact i32 %sext334, 24
  store i32 %conv142, ptr @yytchar, align 4, !tbaa !5
  %cmp143 = icmp eq i8 %conv29.le470, 10
  br i1 %cmp143, label %if.then145, label %if.end147

if.then145:                                       ; preds = %if.then140
  %28 = load i32, ptr @yylineno, align 4, !tbaa !5
  %dec146 = add nsw i32 %28, -1
  store i32 %dec146, ptr @yylineno, align 4, !tbaa !5
  br label %if.end147

if.end147:                                        ; preds = %if.then145, %if.then140
  %29 = load ptr, ptr @yysptr, align 8, !tbaa !12
  %incdec.ptr149 = getelementptr inbounds i8, ptr %29, i64 1
  store ptr %incdec.ptr149, ptr @yysptr, align 8, !tbaa !12
  store i8 %conv29.le470, ptr %29, align 1, !tbaa !14
  br label %for.end

if.end150:                                        ; preds = %if.then133
  %idx.ext136 = zext i8 %27 to i64
...
if.then158:                                       ; preds = %if.end150
  %30 = load ptr, ptr @yyout, align 8, !tbaa !12
  %call159 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %30, ptr noundef nonnull @.str.55, i32 noundef 8192)
  tail call void @exit(i32 noundef 1) #26
  unreachable
...
if.end163:                                        ; preds = %if.else76, %land.lhs.true126, %if.end120, %if.then38, %land.lhs.true43
  ...
  %31 = load ptr, ptr %yyother164, align 8, !tbaa !23
  %tobool165.not = icmp eq ptr %31, null
  br i1 %tobool165.not, label %if.else171, label %land.lhs.true166

land.lhs.true166:                                 ; preds = %if.end163
  %32 = load ptr, ptr %31, align 8, !tbaa !21
  %cmp168.not = icmp eq ptr %32, @yycrank
  br i1 %cmp168.not, label %if.else171, label %tryagain

if.else171:                                       ; preds = %land.lhs.true166, %if.end163
  %conv29.le = trunc i32 %cond28 to i8
  %sext = shl i32 %cond28, 24
  %conv173 = ashr exact i32 %sext, 24
  store i32 %conv173, ptr @yytchar, align 4, !tbaa !5
  %cmp174 = icmp eq i8 %conv29.le, 10
  br i1 %cmp174, label %if.then176, label %if.end178

if.then176:                                       ; preds = %if.else171
  %33 = load i32, ptr @yylineno, align 4, !tbaa !5
  %dec177 = add nsw i32 %33, -1
  store i32 %dec177, ptr @yylineno, align 4, !tbaa !5
  br label %if.end178

if.end178:                                        ; preds = %if.then176, %if.else171
  %34 = load ptr, ptr @yysptr, align 8, !tbaa !12
  %incdec.ptr180 = getelementptr inbounds i8, ptr %34, i64 1
  store ptr %incdec.ptr180, ptr @yysptr, align 8, !tbaa !12
  store i8 %conv29.le, ptr %34, align 1, !tbaa !14
  br label %for.end

for.end:                                          ; preds = %if.end9, %if.then6, %if.end178, %if.end147, %if.end106, %if.end61
  %cmp182384 = icmp ugt ptr %lsp.0, @yylstate
  br i1 %cmp182384, label %while.body, label %while.end231

while.body:                                       ; preds = %for.end, %if.end228
  %incdec.ptr181386.pn = phi ptr [ %incdec.ptr181386, %if.end228 ], [ %lsp.0, %for.end ]
  %yylastch.4385 = phi ptr [ %incdec.ptr184, %if.end228 ], [ %yylastch.2, %for.end ]
  %incdec.ptr181386 = getelementptr inbounds ptr, ptr %incdec.ptr181386.pn, i64 -1
  %incdec.ptr184 = getelementptr inbounds i8, ptr %yylastch.4385, i64 -1
  store i8 0, ptr %yylastch.4385, align 1, !tbaa !14
  %35 = load ptr, ptr %incdec.ptr181386, align 8, !tbaa !12
  %cmp185.not = icmp eq ptr %35, null
  br i1 %cmp185.not, label %if.end222, label %land.lhs.true187

land.lhs.true187:                                 ; preds = %while.body
  %yystops = getelementptr inbounds %struct.yysvf, ptr %35, i64 0, i32 2
  %36 = load ptr, ptr %yystops, align 8, !tbaa !27
  store ptr %36, ptr @yyfnd, align 8, !tbaa !12
...
land.lhs.true189:                                 ; preds = %land.lhs.true187
  ...
  %cmp190 = icmp sgt i32 %37, 0
  br i1 %cmp190, label %if.then192, label %if.end222

if.then192:                                       ; preds = %land.lhs.true189
  store ptr %incdec.ptr181386, ptr @yyolsp, align 8, !tbaa !12
  %idxprom193 = zext i32 %37 to i64
  %arrayidx194 = getelementptr inbounds [65 x i8], ptr @yyextra, i64 0, i64 %idxprom193
  %38 = load i8, ptr %arrayidx194, align 1, !tbaa !14
  %tobool195.not = icmp eq i8 %38, 0
  br i1 %tobool195.not, label %if.end215, label %while.cond197

while.cond197:                                    ; preds = %if.then192, %if.end212
  %39 = phi i32 [ %.pre423, %if.end212 ], [ %37, %if.then192 ]
  %40 = phi ptr [ %.pre422, %if.end212 ], [ %36, %if.then192 ]
  %lsp.3 = phi ptr [ %incdec.ptr205, %if.end212 ], [ %incdec.ptr181386, %if.then192 ]
  %yylastch.5 = phi ptr [ %incdec.ptr206, %if.end212 ], [ %incdec.ptr184, %if.then192 ]
  %41 = load ptr, ptr %lsp.3, align 8, !tbaa !12
  %yystops198 = getelementptr inbounds %struct.yysvf, ptr %41, i64 0, i32 2
  %42 = load ptr, ptr %yystops198, align 8, !tbaa !27
...
while.cond.i:                                     ; preds = %while.cond197, %while.body.i
  %p.addr.0.i = phi ptr [ %incdec.ptr.i, %while.body.i ], [ %42, %while.cond197 ]
  %43 = load i32, ptr %p.addr.0.i, align 4, !tbaa !5
...
while.body204:                                    ; preds = %yyback.exit
  ...
  %44 = load i8, ptr %yylastch.5, align 1, !tbaa !14
  %conv207 = sext i8 %44 to i32
  store i32 %conv207, ptr @yytchar, align 4, !tbaa !5
  %cmp208 = icmp eq i8 %44, 10
  br i1 %cmp208, label %if.then210, label %if.end212

if.then210:                                       ; preds = %while.body204
  %45 = load i32, ptr @yylineno, align 4, !tbaa !5
  %dec211 = add nsw i32 %45, -1
  store i32 %dec211, ptr @yylineno, align 4, !tbaa !5
  br label %if.end212

if.end212:                                        ; preds = %if.then210, %while.body204
  %46 = load ptr, ptr @yysptr, align 8, !tbaa !12
  %incdec.ptr214 = getelementptr inbounds i8, ptr %46, i64 1
  store ptr %incdec.ptr214, ptr @yysptr, align 8, !tbaa !12
  store i8 %44, ptr %46, align 1, !tbaa !14
  %.pre422 = load ptr, ptr @yyfnd, align 8, !tbaa !12
  %.pre423 = load i32, ptr %.pre422, align 4, !tbaa !5
  br label %while.cond197

if.end215:                                        ; preds = %yyback.exit, %while.body.i, %if.then192
  %47 = phi ptr [ %36, %if.then192 ], [ %40, %while.body.i ], [ %40, %yyback.exit ]
  %lsp.4 = phi ptr [ %incdec.ptr181386, %if.then192 ], [ %lsp.3, %while.body.i ], [ %lsp.3, %yyback.exit ]
  %yylastch.6 = phi ptr [ %incdec.ptr184, %if.then192 ], [ %yylastch.5, %while.body.i ], [ %yylastch.5, %yyback.exit ]
  %48 = load i8, ptr %yylastch.6, align 1, !tbaa !14
  %conv216 = sext i8 %48 to i32
  ...
  %49 = trunc i64 %sub.ptr.lhs.cast to i32
  %50 = sub i32 %49, ptrtoint (ptr @yytext to i32)
  %conv218 = add i32 %50, 1
  ...
  store i8 0, ptr %arrayidx220, align 1, !tbaa !14
  %incdec.ptr221 = getelementptr inbounds i32, ptr %47, i64 1
...
if.end236:                                        ; preds = %while.end231
  %56 = load ptr, ptr @yysptr, align 8, !tbaa !12
  %cmp237 = icmp ugt ptr %56, @yysbuf
  br i1 %cmp237, label %cond.true239, label %cond.false242

cond.true239:                                     ; preds = %if.end236
  %incdec.ptr240 = getelementptr inbounds i8, ptr %56, i64 -1
  store ptr %incdec.ptr240, ptr @yysptr, align 8, !tbaa !12
  %57 = load i8, ptr %incdec.ptr240, align 1, !tbaa !14
  %conv241 = sext i8 %57 to i32
  br label %cond.end244

cond.false242:                                    ; preds = %if.end236
  %58 = load ptr, ptr @yyin, align 8, !tbaa !12
  %call243 = tail call i32 @_IO_getc(ptr noundef %58)
  br label %cond.end244
...
cond.true248:                                     ; preds = %cond.end244
  %59 = load i32, ptr @yylineno, align 4, !tbaa !5
  %inc249 = add nsw i32 %59, 1
...
cond.end251:                                      ; preds = %cond.end244, %cond.true248
  ...
  %60 = trunc i32 %cond245 to i8
  %conv259 = select i1 %cmp253, i8 0, i8 %60
  store i8 %conv259, ptr @yytext, align 16, !tbaa !14
...
if.then263:                                       ; preds = %cond.end251
  ...
  %call264 = tail call i32 @_IO_putc(i32 noundef %conv260, ptr noundef %61)
...
cleanup:                                          ; preds = %if.then235, %if.end215
  %retval.0 = phi i32 [ %51, %if.end215 ], [ 0, %if.then235 ]
  ret i32 %retval.0
}
...
if.then:                                          ; preds = %entry
  ...
  store i8 %conv2, ptr @visible.buf, align 1, !tbaa !14
  store i8 0, ptr getelementptr inbounds ([5 x i8], ptr @visible.buf, i64 0, i64 1), align 1, !tbaa !14
  br label %if.end
...
; Function Attrs: nofree nounwind
declare noundef i32 @_IO_getc(ptr nocapture noundef) local_unnamed_addr #7
...
cond.true:                                        ; preds = %entry
  ...
  %1 = load i8, ptr %incdec.ptr, align 1, !tbaa !14
  %conv = sext i8 %1 to i32
  br label %cond.end

cond.false:                                       ; preds = %entry
  %2 = load ptr, ptr @yyin, align 8, !tbaa !12
  %call = tail call i32 @_IO_getc(ptr noundef %2)
  br label %cond.end
...
entry:
  ...
  %call = tail call i32 @_IO_putc(i32 noundef %c, ptr noundef %0)
  ret void
}
...
if.end:                                           ; preds = %if.then, %entry
  ...
  store ptr %incdec.ptr, ptr @yysptr, align 8, !tbaa !12
  store i8 %conv, ptr %1, align 1, !tbaa !14
  ret void
}
...
entry:
  ...
  %call129 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(8) @.str.109, ptr noundef nonnull dereferenceable(1) %0) #22
  %cmp136 = icmp eq i32 %call129, 0
  br i1 %cmp136, label %if.then138, label %for.cond

for.cond:                                         ; preds = %entry
  %call129.1 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(8) @.str.110, ptr noundef nonnull dereferenceable(1) %0) #22
  %cmp136.1 = icmp eq i32 %call129.1, 0
  br i1 %cmp136.1, label %if.then138, label %for.cond.1

for.cond.1:                                       ; preds = %for.cond
  %call129.2 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(5) @.str.111, ptr noundef nonnull dereferenceable(1) %0) #22
  %cmp136.2 = icmp eq i32 %call129.2, 0
  br i1 %cmp136.2, label %if.then138, label %for.cond.2

for.cond.2:                                       ; preds = %for.cond.1
  %call129.3 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(5) @.str.112, ptr noundef nonnull dereferenceable(1) %0) #22
  %cmp136.3 = icmp eq i32 %call129.3, 0
  br i1 %cmp136.3, label %if.then138, label %for.cond.3

for.cond.3:                                       ; preds = %for.cond.2
  %call129.4 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(2) @.str.113, ptr noundef nonnull dereferenceable(1) %0) #22
  %cmp136.4 = icmp eq i32 %call129.4, 0
  br i1 %cmp136.4, label %if.then138, label %for.cond.4

for.cond.4:                                       ; preds = %for.cond.3
  %call129.5 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(4) @.str.114, ptr noundef nonnull dereferenceable(1) %0) #22
  %cmp136.5 = icmp eq i32 %call129.5, 0
  br i1 %cmp136.5, label %if.then138, label %for.cond.5

for.cond.5:                                       ; preds = %for.cond.4
  %call301 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(8) @.str.109, ptr noundef nonnull dereferenceable(1) %argn) #22
  %cmp308 = icmp eq i32 %call301, 0
  br i1 %cmp308, label %cleanup, label %for.cond140

if.then138:                                       ; preds = %for.cond.4, %for.cond.3, %for.cond.2, %for.cond.1, %for.cond, %entry
  store i32 1, ptr @KeywordName, align 4, !tbaa !5
  br label %cleanup

for.cond140:                                      ; preds = %for.cond.5
  %call301.1 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(8) @.str.110, ptr noundef nonnull dereferenceable(1) %argn) #22
  %cmp308.1 = icmp eq i32 %call301.1, 0
  br i1 %cmp308.1, label %cleanup, label %for.cond140.1

for.cond140.1:                                    ; preds = %for.cond140
  %call301.2 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(5) @.str.111, ptr noundef nonnull dereferenceable(1) %argn) #22
  %cmp308.2 = icmp eq i32 %call301.2, 0
  br i1 %cmp308.2, label %cleanup, label %for.cond140.2

for.cond140.2:                                    ; preds = %for.cond140.1
  %call301.3 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(5) @.str.112, ptr noundef nonnull dereferenceable(1) %argn) #22
  %cmp308.3 = icmp eq i32 %call301.3, 0
  br i1 %cmp308.3, label %cleanup, label %for.cond140.3

for.cond140.3:                                    ; preds = %for.cond140.2
  %call301.4 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(2) @.str.113, ptr noundef nonnull dereferenceable(1) %argn) #22
  %cmp308.4 = icmp eq i32 %call301.4, 0
  br i1 %cmp308.4, label %cleanup, label %for.cond140.4

for.cond140.4:                                    ; preds = %for.cond140.3
  %call301.5 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(4) @.str.114, ptr noundef nonnull dereferenceable(1) %argn) #22
  %cmp308.5 = icmp eq i32 %call301.5, 0
  %spec.select = zext i1 %cmp308.5 to i32
  br label %cleanup

cleanup:                                          ; preds = %for.cond140.4, %for.cond.5, %for.cond140, %for.cond140.1, %for.cond140.2, %for.cond140.3, %if.then138
  %retval.0 = phi i32 [ 1, %if.then138 ], [ 1, %for.cond.5 ], [ 1, %for.cond140 ], [ 1, %for.cond140.1 ], [ 1, %for.cond140.2 ], [ 1, %for.cond140.3 ], [ %spec.select, %for.cond140.4 ]
  ret i32 %retval.0
}
...
for.end:                                          ; preds = %for.inc, %if.end14
  %call20 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef nonnull %call)
...
entry:
  ...
  %cmp192 = icmp slt i32 %0, %argc
  br i1 %cmp192, label %cond.false95, label %for.end

cond.false95:                                     ; preds = %entry, %for.inc
  %1 = phi i32 [ %inc173, %for.inc ], [ %0, %entry ]
  %ret.0193 = phi i32 [ %ret.1, %for.inc ], [ 0, %entry ]
  %idxprom97 = sext i32 %1 to i64
  %arrayidx98 = getelementptr inbounds ptr, ptr %argv, i64 %idxprom97
  %2 = load ptr, ptr %arrayidx98, align 8, !tbaa !12
  %3 = load i8, ptr %2, align 1, !tbaa !14
  %conv102 = zext i8 %3 to i32
  %sub103.neg = add nsw i32 %conv102, -45
  %cmp107 = icmp eq i8 %3, 45
  br i1 %cmp107, label %if.then109, label %cond.end149

if.then109:                                       ; preds = %cond.false95
  %arrayidx111 = getelementptr inbounds i8, ptr %2, i64 1
  %4 = load i8, ptr %arrayidx111, align 1, !tbaa !14
  %conv112 = zext i8 %4 to i32
  br label %cond.end149

cond.end149:                                      ; preds = %cond.false95, %if.then109
  %__result99.0.neg = phi i32 [ %conv112, %if.then109 ], [ %sub103.neg, %cond.false95 ]
  %cmp151 = icmp eq i32 %__result99.0.neg, 0
...
if.then.i:                                        ; preds = %if.then153
  ...
  %6 = load i32, ptr @OnATty, align 4, !tbaa !5
  %tobool.i.i = icmp eq i32 %6, 0
  ...
  %8 = select i1 %or.cond.not.i.i, i1 true, i1 %.b.i.i
  br i1 %8, label %dostdin.exit, label %if.then.i.i

if.then.i.i:                                      ; preds = %if.then.i
  %9 = load ptr, ptr @progname, align 8, !tbaa !12
  %call.i.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.108, ptr noundef %9)
  %10 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call3.i.i = tail call i32 @fflush(ptr noundef %10)
  br label %dostdin.exit

dostdin.exit:                                     ; preds = %if.then153, %if.then.i, %if.then.i.i
  %11 = load ptr, ptr @stdin, align 8, !tbaa !12
  store ptr %11, ptr @yyin, align 8, !tbaa !12
  %call3.i = tail call i32 @yyparse()
  store i32 0, ptr @OnATty, align 4, !tbaa !5
  br label %for.inc

if.else:                                          ; preds = %cond.end149
  %call157 = tail call ptr @fopen(ptr noundef nonnull %2, ptr noundef nonnull @.str.120)
  %cmp158 = icmp eq ptr %call157, null
  br i1 %cmp158, label %if.then160, label %if.else168

if.then160:                                       ; preds = %if.else
  %call161 = tail call ptr @__errno_location() #27
  %12 = load i32, ptr %call161, align 4, !tbaa !5
  %13 = load ptr, ptr @stderr, align 8, !tbaa !12
  %14 = load ptr, ptr @progname, align 8, !tbaa !12
  %15 = load i32, ptr @optind, align 4, !tbaa !5
  %idxprom162 = sext i32 %15 to i64
  %arrayidx163 = getelementptr inbounds ptr, ptr %argv, i64 %idxprom162
  %16 = load ptr, ptr %arrayidx163, align 8, !tbaa !12
  %call164 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %13, ptr noundef nonnull @.str.121, ptr noundef %14, ptr noundef %16) #24
  store i32 %12, ptr %call161, align 4, !tbaa !5
  %17 = load i32, ptr @optind, align 4, !tbaa !5
  %idxprom166 = sext i32 %17 to i64
  %arrayidx167 = getelementptr inbounds ptr, ptr %argv, i64 %idxprom166
  %18 = load ptr, ptr %arrayidx167, align 8, !tbaa !12
  tail call void @perror(ptr noundef %18) #24
  br label %for.inc

if.else168:                                       ; preds = %if.else
  store ptr %call157, ptr @yyin, align 8, !tbaa !12
  %call169 = tail call i32 @yyparse()
  br label %for.inc

for.inc:                                          ; preds = %dostdin.exit, %if.else168, %if.then160
  %call154.pn = phi i32 [ %call3.i, %dostdin.exit ], [ 1, %if.then160 ], [ %call169, %if.else168 ]
  %ret.1 = add nsw i32 %call154.pn, %ret.0193
  %19 = load i32, ptr @optind, align 4, !tbaa !5
  %inc173 = add nsw i32 %19, 1
  store i32 %inc173, ptr @optind, align 4, !tbaa !5
  %cmp = icmp slt i32 %inc173, %argc
  br i1 %cmp, label %cond.false95, label %for.end
...
entry:
  ...
  %call111 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %storemerge.i, ptr noundef nonnull dereferenceable(8) @.str.176) #22
  %cmp118 = icmp eq i32 %call111, 0
  br i1 %cmp118, label %if.then120, label %while.cond.preheader

if.then120:                                       ; preds = %entry
  store i32 1, ptr @CplusplusFlag, align 4, !tbaa !5
  br label %while.cond.preheader

while.cond.preheader:                             ; preds = %if.then120, %entry
  br label %while.cond

while.cond:                                       ; preds = %while.cond.backedge, %while.cond.preheader
  %call122 = tail call i32 @getopt(i32 noundef %argc, ptr noundef nonnull %argv, ptr noundef nonnull @.str.177) #22
  switch i32 %call122, label %while.cond.backedge [
    i32 -1, label %while.end
    i32 99, label %sw.bb
    i32 105, label %sw.bb125
    i32 114, label %sw.bb126
    i32 112, label %sw.bb127
    i32 97, label %sw.bb128
    i32 43, label %sw.bb129
    i32 86, label %sw.bb130
    i32 63, label %sw.bb131
  ]

while.cond.backedge:                              ; preds = %while.cond, %sw.bb129, %sw.bb128, %sw.bb127, %sw.bb126, %sw.bb125, %sw.bb
  br label %while.cond
...
sw.bb130:                                         ; preds = %while.cond
  %call.i167 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.175, ptr noundef nonnull @cdeclsccsid, ptr noundef nonnull @cdgramsccsid, ptr noundef nonnull @cdlexsccsid)
  tail call void @exit(i32 noundef 0) #26
  unreachable
...
while.end:                                        ; preds = %while.cond
  ...
  %cmp132 = icmp eq i32 %1, %argc
  br i1 %cmp132, label %if.then134, label %if.else

if.then134:                                       ; preds = %while.end
  %call.i168 = tail call i32 @isatty(i32 noundef 0) #22
  store i32 %call.i168, ptr @OnATty, align 4, !tbaa !5
  %tobool.i = icmp ne i32 %call.i168, 0
  %2 = load i32, ptr @Interactive, align 4
...
dostdin.exit:                                     ; preds = %if.then134, %if.then.i, %if.then.i.i
...
if.else:                                          ; preds = %while.end
  ...
  %arrayidx136 = getelementptr inbounds ptr, ptr %argv, i64 %idxprom
  %9 = load ptr, ptr %arrayidx136, align 8, !tbaa !12
  %call137 = tail call i32 @namedkeyword(ptr noundef %9)
  %tobool.not = icmp eq i32 %call137, 0
  br i1 %tobool.not, label %if.else141, label %if.then138

if.then138:                                       ; preds = %if.else
  %call139 = tail call i32 @dotmpfile(i32 noundef %argc, ptr noundef nonnull %argv)
  br label %if.end145

if.else141:                                       ; preds = %if.else
  %call142 = tail call i32 @dofileargs(i32 noundef %argc, ptr noundef nonnull %argv)
  br label %if.end145

if.end145:                                        ; preds = %if.then138, %if.else141, %dostdin.exit
  %ret.0 = phi i32 [ %call3.i, %dostdin.exit ], [ %call139, %if.then138 ], [ %call142, %if.else141 ]
  ret i32 %ret.0
}
...
attributes #18 = { nofree nounwind memory(readwrite, argmem: read, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!14 = !{!7, !7, i64 0}
!15 = !{!16, !13, i64 0}
!16 = !{!"helpstruct", !13, i64 0, !13, i64 8}
!17 = !{!16, !13, i64 8}
!18 = !{!19, !6, i64 8}
!19 = !{!"", !13, i64 0, !6, i64 8}
!20 = !{!19, !13, i64 0}
!21 = !{!22, !13, i64 0}
!22 = !{!"yysvf", !13, i64 0, !13, i64 8, !13, i64 16}
!23 = !{!22, !13, i64 8}
!24 = !{!25, !7, i64 0}
!25 = !{!"yywork", !7, i64 0, !7, i64 1}
!26 = !{!25, !7, i64 1}
!27 = !{!22, !13, i64 16}
