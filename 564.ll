; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/vlc.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/vlc.c"
...
define dso_local void @writeUVLC2buffer(ptr nocapture noundef readonly %se, ptr nocapture noundef %currStream) local_unnamed_addr #3 {
entry:
...
; Function Attrs: nofree nosync nounwind memory(write, argmem: readwrite, inaccessiblemem: none) uwtable
define dso_local i32 @se_v(ptr nocapture noundef readnone %tracestring, i32 noundef %value, ptr nocapture noundef %bitstream) local_unnamed_addr #0 {
entry:
...
; Function Attrs: nofree nosync nounwind memory(write, argmem: readwrite, inaccessiblemem: none) uwtable
define dso_local i32 @u_1(ptr nocapture noundef readnone %tracestring, i32 noundef %value, ptr nocapture noundef %bitstream) local_unnamed_addr #0 {
for.body.lr.ph.i:
  %byte_buf.i = getelementptr inbounds %struct.Bitstream, ptr %bitstream, i64 0, i32 2
  %bits_to_go.i = getelementptr inbounds %struct.Bitstream, ptr %bitstream, i64 0, i32 1
  %.pre.i = load i8, ptr %byte_buf.i, align 8, !tbaa !7
...
; Function Attrs: nofree nosync nounwind memory(write, argmem: readwrite, inaccessiblemem: none) uwtable
define dso_local i32 @u_v(i32 noundef %n, ptr nocapture noundef readnone %tracestring, i32 noundef %value, ptr nocapture noundef %bitstream) local_unnamed_addr #0 {
entry:
...
define dso_local void @cbp_linfo_intra(i32 noundef %cbp, i32 noundef %dummy, ptr nocapture noundef writeonly %len, ptr nocapture noundef writeonly %info) local_unnamed_addr #5 {
entry:
...
; Function Attrs: nofree norecurse nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none) uwtable
define dso_local void @cbp_linfo_inter(i32 noundef %cbp, i32 noundef %dummy, ptr nocapture noundef writeonly %len, ptr nocapture noundef writeonly %info) local_unnamed_addr #5 {
entry:
  %0 = load ptr, ptr @img, align 8, !tbaa !24
  %yuv_format = getelementptr inbounds %struct.ImageParameters, ptr %0, i64 0, i32 160
  %1 = load i32, ptr %yuv_format, align 8, !tbaa !25
...
define dso_local void @writeSE_UVLC(ptr nocapture noundef %se, ptr nocapture noundef readonly %dp) local_unnamed_addr #6 {
entry:
...
define dso_local void @writeSE_SVLC(ptr nocapture noundef %se, ptr nocapture noundef readonly %dp) local_unnamed_addr #7 {
entry:
  %value1 = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 1
  %0 = load i32, ptr %value1, align 4, !tbaa !32
  %len = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 3
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @writeCBP_VLC(ptr nocapture noundef %se, ptr nocapture noundef readonly %dp) local_unnamed_addr #6 {
entry:
  %0 = load ptr, ptr @img, align 8, !tbaa !24
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @writeIntraPredMode_CAVLC(ptr nocapture noundef %se, ptr nocapture noundef readonly %dp) local_unnamed_addr #6 {
entry:
  %value1 = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 1
  %0 = load i32, ptr %value1, align 4, !tbaa !32
  %cmp = icmp eq i32 %0, -1
...
define dso_local i32 @writeSyntaxElement2Buf_UVLC(ptr noundef %se, ptr nocapture noundef %this_streamBuffer) local_unnamed_addr #8 {
entry:
  ...
  %len = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 3
  %inf = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 4
  tail call void %0(i32 noundef %1, i32 noundef %2, ptr noundef nonnull %len, ptr noundef nonnull %inf) #15
...
; Function Attrs: nofree norecurse nosync nounwind memory(write, argmem: readwrite, inaccessiblemem: none) uwtable
define dso_local i32 @writeSyntaxElement2Buf_Fixed(ptr nocapture noundef readonly %se, ptr nocapture noundef %this_streamBuffer) local_unnamed_addr #3 {
entry:
  %len.i = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 3
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @writeSE_Flag(ptr nocapture noundef %se, ptr nocapture noundef readonly %dp) local_unnamed_addr #6 {
for.body.lr.ph.i:
  %len = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 3
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @writeSE_invFlag(ptr nocapture noundef %se, ptr nocapture noundef readonly %dp) local_unnamed_addr #6 {
for.body.lr.ph.i:
  %len = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 3
  store i32 1, ptr %len, align 4, !tbaa !19
  %value1 = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 1
...
define dso_local void @writeSE_Dummy(ptr nocapture noundef writeonly %se, ptr nocapture noundef readnone %dp) local_unnamed_addr #9 {
entry:
  %len = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 3
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @writeSE_Fix(ptr nocapture noundef readonly %se, ptr nocapture noundef readonly %dp) local_unnamed_addr #6 {
entry:
...
define dso_local i32 @symbol2vlc(ptr nocapture noundef %sym) local_unnamed_addr #10 {
entry:
  %len = getelementptr inbounds %struct.syntaxelement, ptr %sym, i64 0, i32 3
  %0 = load i32, ptr %len, align 4, !tbaa !19
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local i32 @writeSyntaxElement_VLC(ptr nocapture noundef %se, ptr nocapture noundef readonly %dp) local_unnamed_addr #6 {
entry:
  %value1 = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 1
  %0 = load i32, ptr %value1, align 4, !tbaa !32
  %inf = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 4
...
; Function Attrs: nounwind uwtable
define dso_local i32 @writeSyntaxElement_NumCoeffTrailingOnes(ptr nocapture noundef %se, ptr nocapture noundef readonly %dp) local_unnamed_addr #8 {
entry:
  %len = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 3
  %0 = load i32, ptr %len, align 4, !tbaa !19
  %cmp = icmp eq i32 %0, 3
...
; Function Attrs: nounwind uwtable
define dso_local i32 @writeSyntaxElement_NumCoeffTrailingOnesChromaDC(ptr nocapture noundef %se, ptr nocapture noundef readonly %dp) local_unnamed_addr #8 {
entry:
  %0 = load ptr, ptr @img, align 8, !tbaa !24
  %yuv_format = getelementptr inbounds %struct.ImageParameters, ptr %0, i64 0, i32 160
  %1 = load i32, ptr %yuv_format, align 8, !tbaa !25
...
; Function Attrs: nounwind uwtable
define dso_local i32 @writeSyntaxElement_TotalZeros(ptr nocapture noundef %se, ptr nocapture noundef readonly %dp) local_unnamed_addr #8 {
entry:
  %len = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 3
  %0 = load i32, ptr %len, align 4, !tbaa !19
  %idxprom = sext i32 %0 to i64
...
; Function Attrs: nounwind uwtable
define dso_local i32 @writeSyntaxElement_TotalZerosChromaDC(ptr nocapture noundef %se, ptr nocapture noundef readonly %dp) local_unnamed_addr #8 {
entry:
  %0 = load ptr, ptr @img, align 8, !tbaa !24
  %yuv_format = getelementptr inbounds %struct.ImageParameters, ptr %0, i64 0, i32 160
  %1 = load i32, ptr %yuv_format, align 8, !tbaa !25
...
; Function Attrs: nounwind uwtable
define dso_local i32 @writeSyntaxElement_Run(ptr nocapture noundef %se, ptr nocapture noundef readonly %dp) local_unnamed_addr #8 {
entry:
  %len = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 3
  %0 = load i32, ptr %len, align 4, !tbaa !19
  %idxprom = sext i32 %0 to i64
...
; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local i32 @writeSyntaxElement_Level_VLC1(ptr nocapture noundef %se, ptr nocapture noundef readonly %dp, i32 noundef %profile_idc) local_unnamed_addr #7 {
entry:
  %value1 = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 1
  %0 = load i32, ptr %value1, align 4, !tbaa !32
...
; Function Attrs: nofree nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local i32 @writeSyntaxElement_Level_VLCN(ptr nocapture noundef %se, i32 noundef %vlc, ptr nocapture noundef readonly %dp, i32 noundef %profile_idc) local_unnamed_addr #7 {
entry:
  %value1 = getelementptr inbounds %struct.syntaxelement, ptr %se, i64 0, i32 1
  %0 = load i32, ptr %value1, align 4, !tbaa !32
  %cond.i = tail call i32 @llvm.abs.i32(i32 %0, i1 true)
...
define dso_local void @writeVlcByteAlign(ptr nocapture noundef %currStream) local_unnamed_addr #13 {
entry:
  %bits_to_go = getelementptr inbounds %struct.Bitstream, ptr %currStream, i64 0, i32 1
...
attributes #3 = { nofree norecurse nosync nounwind memory(write, argmem: readwrite, inaccessiblemem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
