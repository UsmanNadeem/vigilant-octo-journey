; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/mbuffer.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/mbuffer.c"
...
for.body530.preheader:                            ; preds = %for.cond527.preheader
  ...
  %uglygep = getelementptr i8, ptr %call441, i64 %259
  %260 = xor i32 %list0idx.12.lcssa, -1
  %261 = add i32 %list0idx.14.lcssa, %260
  %262 = zext i32 %261 to i64
  %263 = shl nuw nsw i64 %262, 3
  %264 = add nuw nsw i64 %263, 8
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %call447, ptr noundef nonnull align 8 dereferenceable(1) %uglygep, i64 %264, i1 false), !tbaa !5
  br label %for.end538
...
if.end553:                                        ; preds = %for.end233, %gen_pic_list_from_frame_list.exit940, %for.end430, %gen_pic_list_from_frame_list.exit1408
  ...
  %421 = load i32, ptr @listXsize, align 16, !tbaa !38
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @mm_update_max_long_term_frame_idx(i32 noundef %max_long_term_frame_idx_plus1) local_unnamed_addr #8 {
entry:
...
for.body13.preheader.i:                           ; preds = %for.cond11.preheader.i
  ...
  %xtraiter774 = and i64 %wide.trip.count112.i, 3
...
for.body13.preheader.i.new:                       ; preds = %for.body13.preheader.i
  %unroll_iter777 = and i64 %wide.trip.count112.i, 4294967292
...
for.body13.i:                                     ; preds = %for.body13.i, %for.body13.preheader.i.new
  ...
  %niter778 = phi i64 [ 0, %for.body13.preheader.i.new ], [ %niter778.next.3, %for.body13.i ]
  %24 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 2), align 8, !tbaa !35
  ...
  %niter778.next.3 = add i64 %niter778, 4
  %niter778.ncmp.3 = icmp eq i64 %niter778.next.3, %unroll_iter777
  br i1 %niter778.ncmp.3, label %if.end.thread.i.loopexit.unr-lcssa, label %for.body13.i, !llvm.loop !158
...
if.end.thread.i.loopexit.unr-lcssa:               ; preds = %for.body13.i, %for.body13.preheader.i
  ...
  %lcmp.mod776.not = icmp eq i64 %xtraiter774, 0
  br i1 %lcmp.mod776.not, label %if.end.thread.i, label %for.body13.i.epil
...
for.body13.i.epil:                                ; preds = %if.end.thread.i.loopexit.unr-lcssa, %for.body13.i.epil
  ...
  %epil.iter775 = phi i64 [ %epil.iter775.next, %for.body13.i.epil ], [ 0, %if.end.thread.i.loopexit.unr-lcssa ]
  ...
  %epil.iter775.next = add i64 %epil.iter775, 1
  %epil.iter775.cmp.not = icmp eq i64 %epil.iter775.next, %xtraiter774
  br i1 %epil.iter775.cmp.not, label %if.end.thread.i, label %for.body13.i.epil, !llvm.loop !159
...
while.body.preheader.i.i:                         ; preds = %for.end.i.i
  ...
  %xtraiter779 = and i64 %45, 3
  %lcmp.mod780.not = icmp eq i64 %xtraiter779, 0
  br i1 %lcmp.mod780.not, label %while.body.i.i.prol.loopexit, label %while.body.i.i.prol
...
while.body.i.i.prol:                              ; preds = %while.body.preheader.i.i, %while.body.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter779
...
while.body.preheader.i91.i:                       ; preds = %for.end.i89.i
  ...
  %xtraiter781 = and i64 %69, 3
  %lcmp.mod782.not = icmp eq i64 %xtraiter781, 0
  br i1 %lcmp.mod782.not, label %while.body.i96.i.prol.loopexit, label %while.body.i96.i.prol
...
while.body.i96.i.prol:                            ; preds = %while.body.preheader.i91.i, %while.body.i96.i.prol
  ...
  %prol.iter783 = phi i64 [ %prol.iter783.next, %while.body.i96.i.prol ], [ 0, %while.body.preheader.i91.i ]
  ...
  %prol.iter783.next = add i64 %prol.iter783, 1
  %prol.iter783.cmp.not = icmp eq i64 %prol.iter783.next, %xtraiter781
  br i1 %prol.iter783.cmp.not, label %while.body.i96.i.prol.loopexit, label %while.body.i96.i.prol, !llvm.loop !161
...
if.then6:                                         ; preds = %land.lhs.true
  %dec_ref_pic_marking_buffer572.i = getelementptr inbounds %struct.ImageParameters, ptr %0, i64 0, i32 126
  %82 = load ptr, ptr %dec_ref_pic_marking_buffer572.i, align 8, !tbaa !164
  %tobool.not573.i = icmp eq ptr %82, null
  br i1 %tobool.not573.i, label %if.end7, label %while.body.lr.ph.i

while.body.lr.ph.i:                               ; preds = %if.then6
  %pic_num.i519.i = getelementptr inbounds %struct.storable_picture, ptr %p, i64 0, i32 11
...
while.body.i:                                     ; preds = %sw.epilog.i, %while.body.lr.ph.i
  %83 = phi ptr [ %0, %while.body.lr.ph.i ], [ %387, %sw.epilog.i ]
  %84 = phi ptr [ %82, %while.body.lr.ph.i ], [ %388, %sw.epilog.i ]
...
if.then28.i.i:                                    ; preds = %if.then23.i.i
  %is_reference16.i.i.le688 = getelementptr inbounds %struct.frame_store, ptr %95, i64 0, i32 1
  ...
  store i32 %and35.i.i, ptr %is_reference16.i.i.le688, align 4, !tbaa !85
...
while.body.preheader.i.i188:                      ; preds = %for.end.i.i186
  ...
  %xtraiter799 = and i64 %124, 3
  %lcmp.mod800.not = icmp eq i64 %xtraiter799, 0
  br i1 %lcmp.mod800.not, label %while.body.i.i193.prol.loopexit, label %while.body.i.i193.prol
...
while.body.i.i193.prol:                           ; preds = %while.body.preheader.i.i188, %while.body.i.i193.prol
  ...
  %prol.iter801 = phi i64 [ %prol.iter801.next, %while.body.i.i193.prol ], [ 0, %while.body.preheader.i.i188 ]
  ...
  br i1 %prol.iter801.cmp.not, label %while.body.i.i193.prol.loopexit, label %while.body.i.i193.prol, !llvm.loop !171
...
if.then29.i.i:                                    ; preds = %if.then24.i.i
  %is_reference17.i.i.le685 = getelementptr inbounds %struct.frame_store, ptr %147, i64 0, i32 1
  ...
  store i32 %and40.i.i, ptr %is_reference17.i.i.le685, align 4, !tbaa !85
...
while.body.preheader.i150.i:                      ; preds = %for.end.i148.i
  ...
  %xtraiter796 = and i64 %175, 3
  %lcmp.mod797.not = icmp eq i64 %xtraiter796, 0
  br i1 %lcmp.mod797.not, label %while.body.i155.i.prol.loopexit, label %while.body.i155.i.prol
...
while.body.i155.i.prol:                           ; preds = %while.body.preheader.i150.i, %while.body.i155.i.prol
  ...
  %prol.iter798 = phi i64 [ %prol.iter798.next, %while.body.i155.i.prol ], [ 0, %while.body.preheader.i150.i ]
  ...
  br i1 %prol.iter798.cmp.not, label %while.body.i155.i.prol.loopexit, label %while.body.i155.i.prol, !llvm.loop !174
...
for.cond.preheader.i.i:                           ; preds = %sw.bb4.i
  ...
  %cmp2.not63.not.i.i = icmp eq i32 %188, 0
  br i1 %cmp2.not63.not.i.i, label %if.then23.i176.i, label %for.body.lr.ph.i163.i
...
if.end66.i.i.i:                                   ; preds = %if.else65.i.i.i, %if.end25.i.i
  ...
  %cmp6810.not.i.i.i = icmp eq i32 %215, 0
  br i1 %cmp6810.not.i.i.i, label %for.end210.i.i.i, label %for.body69.lr.ph.i.i.i
...
for.body69.lr.ph.i.i.i:                           ; preds = %if.end66.i.i.i
  ...
  %wide.trip.count23.i.i.i = zext i32 %215 to i64
  br label %for.body69.i.i.i

for.body69.i.i.i:                                 ; preds = %for.inc208.i.i.i, %for.body69.lr.ph.i.i.i
  %indvars.iv20.i.i.i = phi i64 [ 0, %for.body69.lr.ph.i.i.i ], [ %indvars.iv.next21.i.i.i, %for.inc208.i.i.i ]
  %arrayidx71.i.i.i = getelementptr inbounds ptr, ptr %216, i64 %indvars.iv20.i.i.i
...
if.then86.i.i.i:                                  ; preds = %land.lhs.true80.i.i.i
  %idxprom70.le8.i.i.i = and i64 %indvars.iv20.i.i.i, 4294967295
...
if.end98.i.i.i:                                   ; preds = %if.then96.i.i.i, %land.lhs.true91.i.i.i, %if.then86.i.i.i
  %224 = phi ptr [ %.pre.i.i.i, %if.then96.i.i.i ], [ %216, %land.lhs.true91.i.i.i ], [ %216, %if.then86.i.i.i ]
  %arrayidx100.i.i.i = getelementptr inbounds ptr, ptr %224, i64 %idxprom70.le8.i.i.i
  %225 = load ptr, ptr %arrayidx100.i.i.i, align 8, !tbaa !5
  %top_field101.i.i.i = getelementptr inbounds %struct.frame_store, ptr %225, i64 0, i32 11
  %226 = load ptr, ptr %top_field101.i.i.i, align 8, !tbaa !44
  %long_term_frame_idx102.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %226, i64 0, i32 13
  store i32 %185, ptr %long_term_frame_idx102.i.i.i, align 4, !tbaa !82
  %long_term_frame_idx105.i.i.i = getelementptr inbounds %struct.frame_store, ptr %225, i64 0, i32 7
  ...
  %long_term_pic_num109.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %226, i64 0, i32 12
  store i32 %add.i53.i.i, ptr %long_term_pic_num109.i.i.i, align 8, !tbaa !83
  %is_long_term113.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %226, i64 0, i32 14
  store i32 1, ptr %is_long_term113.i.i.i, align 8, !tbaa !76
  %is_long_term116.i.i.i = getelementptr inbounds %struct.frame_store, ptr %225, i64 0, i32 2
  %227 = load i32, ptr %is_long_term116.i.i.i, align 8, !tbaa !87
  %or.i.i.i = or i32 %227, 1
...
if.then121.i.i.i:                                 ; preds = %if.end98.i.i.i
  %frame124.i.i.i = getelementptr inbounds %struct.frame_store, ptr %225, i64 0, i32 10
  %228 = load ptr, ptr %frame124.i.i.i, align 8, !tbaa !42
  %is_long_term125.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %228, i64 0, i32 14
  store i32 1, ptr %is_long_term125.i.i.i, align 8, !tbaa !76
  %long_term_pic_num129.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %228, i64 0, i32 12
  store i32 %185, ptr %long_term_pic_num129.i.i.i, align 8, !tbaa !83
  %long_term_frame_idx133.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %228, i64 0, i32 13
...
if.then142.i.i.i:                                 ; preds = %if.end136.i.i.i
  ...
  %229 = load ptr, ptr %bottom_field145.i.i.i, align 8, !tbaa !45
  %is_long_term146.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %229, i64 0, i32 14
  %230 = load i32, ptr %is_long_term146.i.i.i, align 8, !tbaa !76
  %tobool147.not.i.i.i = icmp eq i32 %230, 0
...
land.lhs.true148.i.i.i:                           ; preds = %if.then142.i.i.i
  %pic_num152.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %229, i64 0, i32 11
  %231 = load i32, ptr %pic_num152.i.i.i, align 4, !tbaa !80
  %cmp153.i.i.i = icmp eq i32 %231, %sub.i.i161.i
  br i1 %cmp153.i.i.i, label %if.then154.i.i.i, label %for.inc208.i.i.i

if.then154.i.i.i:                                 ; preds = %land.lhs.true148.i.i.i
  %idxprom70.le.i.i.i = and i64 %indvars.iv20.i.i.i, 4294967295
  %is_long_term157.i.i.i = getelementptr inbounds %struct.frame_store, ptr %217, i64 0, i32 2
  %232 = load i32, ptr %is_long_term157.i.i.i, align 8, !tbaa !87
  %tobool158.not.i.i.i = icmp eq i32 %232, 0
...
land.lhs.true159.i.i.i:                           ; preds = %if.then154.i.i.i
  ...
  %233 = load i32, ptr %long_term_frame_idx162.i.i.i, align 4, !tbaa !128
  %cmp163.not.i.i.i = icmp eq i32 %233, %185
...
if.then164.i.i.i:                                 ; preds = %land.lhs.true159.i.i.i
  ...
  %.pre25.i.i.i = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  br label %if.end166.i.i.i

if.end166.i.i.i:                                  ; preds = %if.then164.i.i.i, %land.lhs.true159.i.i.i, %if.then154.i.i.i
  %234 = phi ptr [ %.pre25.i.i.i, %if.then164.i.i.i ], [ %216, %land.lhs.true159.i.i.i ], [ %216, %if.then154.i.i.i ]
  %arrayidx168.i.i.i = getelementptr inbounds ptr, ptr %234, i64 %idxprom70.le.i.i.i
  %235 = load ptr, ptr %arrayidx168.i.i.i, align 8, !tbaa !5
  %bottom_field169.i.i.i = getelementptr inbounds %struct.frame_store, ptr %235, i64 0, i32 12
  %236 = load ptr, ptr %bottom_field169.i.i.i, align 8, !tbaa !45
  %long_term_frame_idx170.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %236, i64 0, i32 13
  ...
  %long_term_pic_num179.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %236, i64 0, i32 12
  store i32 %add175.i.i.i, ptr %long_term_pic_num179.i.i.i, align 8, !tbaa !83
  %is_long_term183.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %236, i64 0, i32 14
  ...
  %237 = load i32, ptr %is_long_term186.i.i.i, align 8, !tbaa !87
  %or187.i.i.i = or i32 %237, 2
...
if.then192.i.i.i:                                 ; preds = %if.end166.i.i.i
  ...
  %238 = load ptr, ptr %frame195.i.i.i, align 8, !tbaa !42
  %is_long_term196.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %238, i64 0, i32 14
  store i32 1, ptr %is_long_term196.i.i.i, align 8, !tbaa !76
  %long_term_pic_num200.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %238, i64 0, i32 12
  store i32 %185, ptr %long_term_pic_num200.i.i.i, align 8, !tbaa !83
  %long_term_frame_idx204.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %238, i64 0, i32 13
...
for.inc208.i.i.i:                                 ; preds = %land.lhs.true148.i.i.i, %if.then142.i.i.i, %if.end136.i.i.i
  ...
  br i1 %exitcond24.not.i.i.i, label %for.end210.i.i.i, label %for.body69.i.i.i, !llvm.loop !179
...
mm_assign_long_term_frame_idx.exit.i:             ; preds = %for.end210.i.i.i, %if.then192.i.i.i, %if.end166.i.i.i, %if.then121.i.i.i, %if.end98.i.i.i, %for.end.i.i.i, %if.end.i.i.i
  %239 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 4), align 4, !tbaa !31
  %cmp18.not.i184.i = icmp eq i32 %239, 0
...
for.body.preheader.i187.i:                        ; preds = %mm_assign_long_term_frame_idx.exit.i
  %wide.trip.count.i185.i = zext i32 %239 to i64
...
for.body.i192.i:                                  ; preds = %for.inc.i232.i, %for.body.preheader.i187.i
  %240 = phi ptr [ %.pre29.i186.i, %for.body.preheader.i187.i ], [ %253, %for.inc.i232.i ]
  ...
  %arrayidx.i190.i = getelementptr inbounds ptr, ptr %240, i64 %indvars.iv.i188.i
  %241 = load ptr, ptr %arrayidx.i190.i, align 8, !tbaa !5
  %242 = load i32, ptr %241, align 8, !tbaa !77
  %cmp.i.i191.i = icmp eq i32 %242, 3
  br i1 %cmp.i.i191.i, label %if.then.i.i196.i, label %if.end4.i.i202.i

if.then.i.i196.i:                                 ; preds = %for.body.i192.i
  %frame.i.i193.i = getelementptr inbounds %struct.frame_store, ptr %241, i64 0, i32 10
  %243 = load ptr, ptr %frame.i.i193.i, align 8, !tbaa !42
  %used_for_reference.i.i194.i = getelementptr inbounds %struct.storable_picture, ptr %243, i64 0, i32 15
  %244 = load i32, ptr %used_for_reference.i.i194.i, align 4, !tbaa !75
  %tobool.not.i.i195.i = icmp eq i32 %244, 0
...
land.lhs.true.i.i199.i:                           ; preds = %if.then.i.i196.i
  %is_long_term.i.i197.i = getelementptr inbounds %struct.storable_picture, ptr %243, i64 0, i32 14
  %245 = load i32, ptr %is_long_term.i.i197.i, align 8, !tbaa !76
  %tobool2.not.i.i198.i = icmp eq i32 %245, 0
  br i1 %tobool2.not.i.i198.i, label %if.then.i228.i, label %if.then7.i.i205.i

if.end4.i.i202.i:                                 ; preds = %for.body.i192.i
  %and.i.i200.i = and i32 %242, 1
...
if.then7.i.i205.i:                                ; preds = %if.end4.i.i202.i, %land.lhs.true.i.i199.i, %if.then.i.i196.i
  %top_field.i.i203.i = getelementptr inbounds %struct.frame_store, ptr %241, i64 0, i32 11
  %246 = load ptr, ptr %top_field.i.i203.i, align 8, !tbaa !44
  %tobool8.not.i.i204.i = icmp eq ptr %246, null
  br i1 %tobool8.not.i.i204.i, label %if.end20.i.i214.i, label %if.then9.i.i208.i

if.then9.i.i208.i:                                ; preds = %if.then7.i.i205.i
  %used_for_reference11.i.i206.i = getelementptr inbounds %struct.storable_picture, ptr %246, i64 0, i32 15
  %247 = load i32, ptr %used_for_reference11.i.i206.i, align 4, !tbaa !75
  %tobool12.not.i.i207.i = icmp eq i32 %247, 0
...
land.lhs.true13.i.i211.i:                         ; preds = %if.then9.i.i208.i
  %is_long_term15.i.i209.i = getelementptr inbounds %struct.storable_picture, ptr %246, i64 0, i32 14
  %248 = load i32, ptr %is_long_term15.i.i209.i, align 8, !tbaa !76
  %tobool16.not.i.i210.i = icmp eq i32 %248, 0
...
if.then24.i.i217.i:                               ; preds = %if.end20.i.i214.i
  %bottom_field.i.i215.i = getelementptr inbounds %struct.frame_store, ptr %241, i64 0, i32 12
  %249 = load ptr, ptr %bottom_field.i.i215.i, align 8, !tbaa !45
  %tobool25.not.i.i216.i = icmp eq ptr %249, null
  br i1 %tobool25.not.i.i216.i, label %for.inc.i232.i, label %if.then26.i.i220.i

if.then26.i.i220.i:                               ; preds = %if.then24.i.i217.i
  %used_for_reference28.i.i218.i = getelementptr inbounds %struct.storable_picture, ptr %249, i64 0, i32 15
  %250 = load i32, ptr %used_for_reference28.i.i218.i, align 4, !tbaa !75
  %tobool29.not.i.i219.i = icmp eq i32 %250, 0
...
land.lhs.true30.i.i223.i:                         ; preds = %if.then26.i.i220.i
  %is_long_term32.i.i221.i = getelementptr inbounds %struct.storable_picture, ptr %249, i64 0, i32 14
  %251 = load i32, ptr %is_long_term32.i.i221.i, align 8, !tbaa !76
  %tobool33.not.i.i222.i = icmp eq i32 %251, 0
...
if.then.i228.i:                                   ; preds = %land.lhs.true30.i.i223.i, %land.lhs.true13.i.i211.i, %land.lhs.true.i.i199.i
  %252 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  %inc.i224.i = add i32 %j.020.i189.i, 1
  %idxprom3.i225.i = zext i32 %j.020.i189.i to i64
  %arrayidx4.i226.i = getelementptr inbounds ptr, ptr %252, i64 %idxprom3.i225.i
  store ptr %241, ptr %arrayidx4.i226.i, align 8, !tbaa !5
...
for.inc.i232.i:                                   ; preds = %if.then.i228.i, %land.lhs.true30.i.i223.i, %if.then26.i.i220.i, %if.then24.i.i217.i, %if.end20.i.i214.i
  %253 = phi ptr [ %.pre.i227.i, %if.then.i228.i ], [ %240, %if.end20.i.i214.i ], [ %240, %if.then24.i.i217.i ], [ %240, %if.then26.i.i220.i ], [ %240, %land.lhs.true30.i.i223.i ]
...
for.end.i235.i:                                   ; preds = %for.inc.i232.i, %mm_assign_long_term_frame_idx.exit.i
  ...
  %254 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 3), align 8, !tbaa !28
  %cmp621.i234.i = icmp ult i32 %j.0.lcssa.i233.i, %254
...
while.body.preheader.i237.i:                      ; preds = %for.end.i235.i
  %255 = zext i32 %j.0.lcssa.i233.i to i64
  %wide.trip.count27.i236.i = zext i32 %254 to i64
  %256 = sub nsw i64 %wide.trip.count27.i236.i, %255
  %257 = xor i64 %255, -1
  %258 = add nsw i64 %257, %wide.trip.count27.i236.i
  %xtraiter790 = and i64 %256, 3
  %lcmp.mod791.not = icmp eq i64 %xtraiter790, 0
  br i1 %lcmp.mod791.not, label %while.body.i242.i.prol.loopexit, label %while.body.i242.i.prol

while.body.i242.i.prol:                           ; preds = %while.body.preheader.i237.i, %while.body.i242.i.prol
  %indvars.iv24.i238.i.prol = phi i64 [ %indvars.iv.next25.i239.i.prol, %while.body.i242.i.prol ], [ %255, %while.body.preheader.i237.i ]
  %prol.iter792 = phi i64 [ %prol.iter792.next, %while.body.i242.i.prol ], [ 0, %while.body.preheader.i237.i ]
  ...
  %arrayidx9.i240.i.prol = getelementptr inbounds ptr, ptr %259, i64 %indvars.iv24.i238.i.prol
  ...
  br i1 %prol.iter792.cmp.not, label %while.body.i242.i.prol.loopexit, label %while.body.i242.i.prol, !llvm.loop !180

while.body.i242.i.prol.loopexit:                  ; preds = %while.body.i242.i.prol, %while.body.preheader.i237.i
  %indvars.iv24.i238.i.unr = phi i64 [ %255, %while.body.preheader.i237.i ], [ %indvars.iv.next25.i239.i.prol, %while.body.i242.i.prol ]
  %260 = icmp ult i64 %258, 3
  br i1 %260, label %update_ref_list.exit243.i, label %while.body.i242.i
...
while.body.i242.i:                                ; preds = %while.body.i242.i.prol.loopexit, %while.body.i242.i
  ...
  %arrayidx9.i240.i = getelementptr inbounds ptr, ptr %261, i64 %indvars.iv24.i238.i
  ...
  %arrayidx9.i240.i.1 = getelementptr inbounds ptr, ptr %262, i64 %indvars.iv.next25.i239.i
  store ptr null, ptr %arrayidx9.i240.i.1, align 8, !tbaa !5
  %263 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  %indvars.iv.next25.i239.i.2 = add nuw nsw i64 %indvars.iv24.i238.i, 3
  %arrayidx9.i240.i.2 = getelementptr inbounds ptr, ptr %263, i64 %indvars.iv.next25.i239.i.1
  store ptr null, ptr %arrayidx9.i240.i.2, align 8, !tbaa !5
  %264 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  %indvars.iv.next25.i239.i.3 = add nuw nsw i64 %indvars.iv24.i238.i, 4
  %arrayidx9.i240.i.3 = getelementptr inbounds ptr, ptr %264, i64 %indvars.iv.next25.i239.i.2
...
for.body.preheader.i247.i:                        ; preds = %update_ref_list.exit243.i
  %wide.trip.count.i245.i = zext i32 %239 to i64
...
for.body.i252.i:                                  ; preds = %for.inc.i292.i, %for.body.preheader.i247.i
  %265 = phi ptr [ %.pre29.i246.i, %for.body.preheader.i247.i ], [ %278, %for.inc.i292.i ]
  ...
  %arrayidx.i250.i = getelementptr inbounds ptr, ptr %265, i64 %indvars.iv.i248.i
  %266 = load ptr, ptr %arrayidx.i250.i, align 8, !tbaa !5
  %267 = load i32, ptr %266, align 8, !tbaa !77
  %cmp.i.i251.i = icmp eq i32 %267, 3
  br i1 %cmp.i.i251.i, label %if.then.i.i256.i, label %if.end4.i.i262.i

if.then.i.i256.i:                                 ; preds = %for.body.i252.i
  %frame.i.i253.i = getelementptr inbounds %struct.frame_store, ptr %266, i64 0, i32 10
  %268 = load ptr, ptr %frame.i.i253.i, align 8, !tbaa !42
  %used_for_reference.i.i254.i = getelementptr inbounds %struct.storable_picture, ptr %268, i64 0, i32 15
  %269 = load i32, ptr %used_for_reference.i.i254.i, align 4, !tbaa !75
  %tobool.not.i.i255.i = icmp eq i32 %269, 0
...
land.lhs.true.i.i259.i:                           ; preds = %if.then.i.i256.i
  %is_long_term.i.i257.i = getelementptr inbounds %struct.storable_picture, ptr %268, i64 0, i32 14
  %270 = load i32, ptr %is_long_term.i.i257.i, align 8, !tbaa !76
  %tobool2.not.i.i258.i = icmp eq i32 %270, 0
  br i1 %tobool2.not.i.i258.i, label %if.then7.i.i265.i, label %if.then.i288.i

if.end4.i.i262.i:                                 ; preds = %for.body.i252.i
  %and.i.i260.i = and i32 %267, 1
...
if.then7.i.i265.i:                                ; preds = %if.end4.i.i262.i, %land.lhs.true.i.i259.i, %if.then.i.i256.i
  %top_field.i.i263.i = getelementptr inbounds %struct.frame_store, ptr %266, i64 0, i32 11
  %271 = load ptr, ptr %top_field.i.i263.i, align 8, !tbaa !44
  %tobool8.not.i.i264.i = icmp eq ptr %271, null
  br i1 %tobool8.not.i.i264.i, label %if.end20.i.i274.i, label %if.then9.i.i268.i

if.then9.i.i268.i:                                ; preds = %if.then7.i.i265.i
  %used_for_reference11.i.i266.i = getelementptr inbounds %struct.storable_picture, ptr %271, i64 0, i32 15
  %272 = load i32, ptr %used_for_reference11.i.i266.i, align 4, !tbaa !75
  %tobool12.not.i.i267.i = icmp eq i32 %272, 0
...
land.lhs.true13.i.i271.i:                         ; preds = %if.then9.i.i268.i
  %is_long_term15.i.i269.i = getelementptr inbounds %struct.storable_picture, ptr %271, i64 0, i32 14
  %273 = load i32, ptr %is_long_term15.i.i269.i, align 8, !tbaa !76
  %tobool16.not.i.i270.i = icmp eq i32 %273, 0
...
if.then24.i.i277.i:                               ; preds = %if.end20.i.i274.i
  %bottom_field.i.i275.i = getelementptr inbounds %struct.frame_store, ptr %266, i64 0, i32 12
  %274 = load ptr, ptr %bottom_field.i.i275.i, align 8, !tbaa !45
  %tobool25.not.i.i276.i = icmp eq ptr %274, null
  br i1 %tobool25.not.i.i276.i, label %for.inc.i292.i, label %if.then26.i.i280.i

if.then26.i.i280.i:                               ; preds = %if.then24.i.i277.i
  %used_for_reference28.i.i278.i = getelementptr inbounds %struct.storable_picture, ptr %274, i64 0, i32 15
  %275 = load i32, ptr %used_for_reference28.i.i278.i, align 4, !tbaa !75
  %tobool29.not.i.i279.i = icmp eq i32 %275, 0
...
land.lhs.true30.i.i283.i:                         ; preds = %if.then26.i.i280.i
  %is_long_term32.i.i281.i = getelementptr inbounds %struct.storable_picture, ptr %274, i64 0, i32 14
  %276 = load i32, ptr %is_long_term32.i.i281.i, align 8, !tbaa !76
  %tobool33.not.i.i282.i = icmp eq i32 %276, 0
...
if.then.i288.i:                                   ; preds = %land.lhs.true30.i.i283.i, %land.lhs.true13.i.i271.i, %land.lhs.true.i.i259.i
  %277 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 2), align 8, !tbaa !35
  %inc.i284.i = add i32 %j.020.i249.i, 1
  %idxprom3.i285.i = zext i32 %j.020.i249.i to i64
  %arrayidx4.i286.i = getelementptr inbounds ptr, ptr %277, i64 %idxprom3.i285.i
  store ptr %266, ptr %arrayidx4.i286.i, align 8, !tbaa !5
...
for.inc.i292.i:                                   ; preds = %if.then.i288.i, %land.lhs.true30.i.i283.i, %if.then26.i.i280.i, %if.then24.i.i277.i, %if.end20.i.i274.i
  %278 = phi ptr [ %.pre.i287.i, %if.then.i288.i ], [ %265, %if.end20.i.i274.i ], [ %265, %if.then24.i.i277.i ], [ %265, %if.then26.i.i280.i ], [ %265, %land.lhs.true30.i.i283.i ]
...
for.end.i295.i:                                   ; preds = %for.inc.i292.i, %update_ref_list.exit243.i
  ...
  %cmp621.i294.i = icmp ult i32 %j.0.lcssa.i293.i, %254
  br i1 %cmp621.i294.i, label %while.body.preheader.i297.i, label %sw.epilog.i

while.body.preheader.i297.i:                      ; preds = %for.end.i295.i
  %279 = zext i32 %j.0.lcssa.i293.i to i64
  %wide.trip.count27.i296.i = zext i32 %254 to i64
  %280 = sub nsw i64 %wide.trip.count27.i296.i, %279
  %281 = xor i64 %279, -1
  %282 = add nsw i64 %281, %wide.trip.count27.i296.i
  %xtraiter793 = and i64 %280, 3
  %lcmp.mod794.not = icmp eq i64 %xtraiter793, 0
  br i1 %lcmp.mod794.not, label %while.body.i302.i.prol.loopexit, label %while.body.i302.i.prol

while.body.i302.i.prol:                           ; preds = %while.body.preheader.i297.i, %while.body.i302.i.prol
  %indvars.iv24.i298.i.prol = phi i64 [ %indvars.iv.next25.i299.i.prol, %while.body.i302.i.prol ], [ %279, %while.body.preheader.i297.i ]
  %prol.iter795 = phi i64 [ %prol.iter795.next, %while.body.i302.i.prol ], [ 0, %while.body.preheader.i297.i ]
  ...
  %arrayidx9.i300.i.prol = getelementptr inbounds ptr, ptr %283, i64 %indvars.iv24.i298.i.prol
  ...
  br i1 %prol.iter795.cmp.not, label %while.body.i302.i.prol.loopexit, label %while.body.i302.i.prol, !llvm.loop !181

while.body.i302.i.prol.loopexit:                  ; preds = %while.body.i302.i.prol, %while.body.preheader.i297.i
  %indvars.iv24.i298.i.unr = phi i64 [ %279, %while.body.preheader.i297.i ], [ %indvars.iv.next25.i299.i.prol, %while.body.i302.i.prol ]
  %284 = icmp ult i64 %282, 3
  br i1 %284, label %sw.epilog.i, label %while.body.i302.i
...
while.body.i302.i:                                ; preds = %while.body.i302.i.prol.loopexit, %while.body.i302.i
  ...
  %arrayidx9.i300.i = getelementptr inbounds ptr, ptr %285, i64 %indvars.iv24.i298.i
  ...
  %arrayidx9.i300.i.1 = getelementptr inbounds ptr, ptr %286, i64 %indvars.iv.next25.i299.i
  store ptr null, ptr %arrayidx9.i300.i.1, align 8, !tbaa !5
  %287 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 2), align 8, !tbaa !35
  %indvars.iv.next25.i299.i.2 = add nuw nsw i64 %indvars.iv24.i298.i, 3
  %arrayidx9.i300.i.2 = getelementptr inbounds ptr, ptr %287, i64 %indvars.iv.next25.i299.i.1
  store ptr null, ptr %arrayidx9.i300.i.2, align 8, !tbaa !5
  %288 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 2), align 8, !tbaa !35
  %indvars.iv.next25.i299.i.3 = add nuw nsw i64 %indvars.iv24.i298.i, 4
  %arrayidx9.i300.i.3 = getelementptr inbounds ptr, ptr %288, i64 %indvars.iv.next25.i299.i.2
...
sw.bb6.i:                                         ; preds = %while.body.i
  ...
  %289 = load i32, ptr %max_long_term_frame_idx_plus1.i, align 8, !tbaa !182
  %sub.i.i = add nsw i32 %289, -1
  store i32 %sub.i.i, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 8), align 4, !tbaa !147
  %290 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 6), align 4, !tbaa !19
  %cmp7.not.i.i = icmp eq i32 %290, 0
...
for.body.lr.ph.i305.i:                            ; preds = %sw.bb6.i
  ...
  %wide.trip.count.i304.i = zext i32 %290 to i64
...
for.body.i308.i:                                  ; preds = %for.inc.i329.i, %for.body.lr.ph.i305.i
  ...
  %arrayidx.i307.i = getelementptr inbounds ptr, ptr %291, i64 %indvars.iv.i306.i
  %292 = load ptr, ptr %arrayidx.i307.i, align 8, !tbaa !5
  %long_term_frame_idx.i.i = getelementptr inbounds %struct.frame_store, ptr %292, i64 0, i32 7
  %293 = load i32, ptr %long_term_frame_idx.i.i, align 4, !tbaa !128
  %cmp1.not.i.i = icmp slt i32 %293, %289
  br i1 %cmp1.not.i.i, label %for.inc.i329.i, label %if.then.i311.i

if.then.i311.i:                                   ; preds = %for.body.i308.i
  %294 = load i32, ptr %292, align 8, !tbaa !77
  %and.i.i309.i = and i32 %294, 1
...
if.then.i.i313.i:                                 ; preds = %if.then.i311.i
  %top_field.i.i312.i = getelementptr inbounds %struct.frame_store, ptr %292, i64 0, i32 11
  %295 = load ptr, ptr %top_field.i.i312.i, align 8, !tbaa !44
  %tobool1.not.i.i.i = icmp eq ptr %295, null
  br i1 %tobool1.not.i.i.i, label %if.end5.i.i.i, label %if.then2.i.i.i

if.then2.i.i.i:                                   ; preds = %if.then.i.i313.i
  %used_for_reference.i.i314.i = getelementptr inbounds %struct.storable_picture, ptr %295, i64 0, i32 15
  store i32 0, ptr %used_for_reference.i.i314.i, align 4, !tbaa !75
  %is_long_term.i.i315.i = getelementptr inbounds %struct.storable_picture, ptr %295, i64 0, i32 14
...
if.then9.i.i318.i:                                ; preds = %if.end5.i.i.i
  %bottom_field.i.i317.i = getelementptr inbounds %struct.frame_store, ptr %292, i64 0, i32 12
  %296 = load ptr, ptr %bottom_field.i.i317.i, align 8, !tbaa !45
  %tobool10.not.i.i.i = icmp eq ptr %296, null
  br i1 %tobool10.not.i.i.i, label %if.end17.i.i.i, label %if.then11.i.i.i

if.then11.i.i.i:                                  ; preds = %if.then9.i.i318.i
  %used_for_reference13.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %296, i64 0, i32 15
  store i32 0, ptr %used_for_reference13.i.i.i, align 4, !tbaa !75
  %is_long_term15.i.i319.i = getelementptr inbounds %struct.storable_picture, ptr %296, i64 0, i32 14
...
if.end17.i.i.i:                                   ; preds = %if.then11.i.i.i, %if.then9.i.i318.i, %if.end5.i.i.i
  %cmp.i.i320.i = icmp eq i32 %294, 3
...
if.then19.i.i.i:                                  ; preds = %if.end17.i.i.i
  %top_field20.i.i.i = getelementptr inbounds %struct.frame_store, ptr %292, i64 0, i32 11
  %297 = load ptr, ptr %top_field20.i.i.i, align 8, !tbaa !44
  %tobool21.not.i.i.i = icmp eq ptr %297, null
  br i1 %tobool21.not.i.i.i, label %if.end33.i.i.i, label %land.lhs.true.i.i322.i

land.lhs.true.i.i322.i:                           ; preds = %if.then19.i.i.i
  %bottom_field22.i.i.i = getelementptr inbounds %struct.frame_store, ptr %292, i64 0, i32 12
  %298 = load ptr, ptr %bottom_field22.i.i.i, align 8, !tbaa !45
  %tobool23.not.i.i321.i = icmp eq ptr %298, null
  br i1 %tobool23.not.i.i321.i, label %if.end33.i.i.i, label %if.then24.i.i324.i

if.then24.i.i324.i:                               ; preds = %land.lhs.true.i.i322.i
  %used_for_reference26.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %297, i64 0, i32 15
  store i32 0, ptr %used_for_reference26.i.i.i, align 4, !tbaa !75
  %is_long_term28.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %297, i64 0, i32 14
  store i32 0, ptr %is_long_term28.i.i.i, align 8, !tbaa !76
  %used_for_reference30.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %298, i64 0, i32 15
  store i32 0, ptr %used_for_reference30.i.i.i, align 4, !tbaa !75
  %is_long_term32.i.i323.i = getelementptr inbounds %struct.storable_picture, ptr %298, i64 0, i32 14
...
if.end33.i.i.i:                                   ; preds = %if.then24.i.i324.i, %land.lhs.true.i.i322.i, %if.then19.i.i.i
  %frame.i.i325.i = getelementptr inbounds %struct.frame_store, ptr %292, i64 0, i32 10
  %299 = load ptr, ptr %frame.i.i325.i, align 8, !tbaa !42
  %used_for_reference34.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %299, i64 0, i32 15
  store i32 0, ptr %used_for_reference34.i.i.i, align 4, !tbaa !75
  %is_long_term36.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %299, i64 0, i32 14
...
unmark_for_long_term_reference.exit.i.i:          ; preds = %if.end33.i.i.i, %if.end17.i.i.i
  %is_reference.i.i326.i = getelementptr inbounds %struct.frame_store, ptr %292, i64 0, i32 1
  store i32 0, ptr %is_reference.i.i326.i, align 4, !tbaa !85
  %is_long_term38.i.i.i = getelementptr inbounds %struct.frame_store, ptr %292, i64 0, i32 2
...
mm_update_max_long_term_frame_idx.exit.i:         ; preds = %for.inc.i329.i, %sw.bb6.i
  %300 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 4), align 4, !tbaa !31
  %cmp18.not.i331.i = icmp eq i32 %300, 0
...
for.body.preheader.i334.i:                        ; preds = %mm_update_max_long_term_frame_idx.exit.i
  %wide.trip.count.i332.i = zext i32 %300 to i64
...
for.body.i339.i:                                  ; preds = %for.inc.i379.i, %for.body.preheader.i334.i
  %301 = phi ptr [ %.pre29.i333.i, %for.body.preheader.i334.i ], [ %314, %for.inc.i379.i ]
  ...
  %arrayidx.i337.i = getelementptr inbounds ptr, ptr %301, i64 %indvars.iv.i335.i
  %302 = load ptr, ptr %arrayidx.i337.i, align 8, !tbaa !5
  %303 = load i32, ptr %302, align 8, !tbaa !77
  %cmp.i.i338.i = icmp eq i32 %303, 3
  br i1 %cmp.i.i338.i, label %if.then.i.i343.i, label %if.end4.i.i349.i

if.then.i.i343.i:                                 ; preds = %for.body.i339.i
  %frame.i.i340.i = getelementptr inbounds %struct.frame_store, ptr %302, i64 0, i32 10
  %304 = load ptr, ptr %frame.i.i340.i, align 8, !tbaa !42
  %used_for_reference.i.i341.i = getelementptr inbounds %struct.storable_picture, ptr %304, i64 0, i32 15
  %305 = load i32, ptr %used_for_reference.i.i341.i, align 4, !tbaa !75
  %tobool.not.i.i342.i = icmp eq i32 %305, 0
...
land.lhs.true.i.i346.i:                           ; preds = %if.then.i.i343.i
  %is_long_term.i.i344.i = getelementptr inbounds %struct.storable_picture, ptr %304, i64 0, i32 14
  %306 = load i32, ptr %is_long_term.i.i344.i, align 8, !tbaa !76
  %tobool2.not.i.i345.i = icmp eq i32 %306, 0
  br i1 %tobool2.not.i.i345.i, label %if.then7.i.i352.i, label %if.then.i375.i

if.end4.i.i349.i:                                 ; preds = %for.body.i339.i
  %and.i.i347.i = and i32 %303, 1
...
if.then7.i.i352.i:                                ; preds = %if.end4.i.i349.i, %land.lhs.true.i.i346.i, %if.then.i.i343.i
  %top_field.i.i350.i = getelementptr inbounds %struct.frame_store, ptr %302, i64 0, i32 11
  %307 = load ptr, ptr %top_field.i.i350.i, align 8, !tbaa !44
  %tobool8.not.i.i351.i = icmp eq ptr %307, null
  br i1 %tobool8.not.i.i351.i, label %if.end20.i.i361.i, label %if.then9.i.i355.i

if.then9.i.i355.i:                                ; preds = %if.then7.i.i352.i
  %used_for_reference11.i.i353.i = getelementptr inbounds %struct.storable_picture, ptr %307, i64 0, i32 15
  %308 = load i32, ptr %used_for_reference11.i.i353.i, align 4, !tbaa !75
  %tobool12.not.i.i354.i = icmp eq i32 %308, 0
...
land.lhs.true13.i.i358.i:                         ; preds = %if.then9.i.i355.i
  %is_long_term15.i.i356.i = getelementptr inbounds %struct.storable_picture, ptr %307, i64 0, i32 14
  %309 = load i32, ptr %is_long_term15.i.i356.i, align 8, !tbaa !76
  %tobool16.not.i.i357.i = icmp eq i32 %309, 0
...
if.then24.i.i364.i:                               ; preds = %if.end20.i.i361.i
  %bottom_field.i.i362.i = getelementptr inbounds %struct.frame_store, ptr %302, i64 0, i32 12
  %310 = load ptr, ptr %bottom_field.i.i362.i, align 8, !tbaa !45
  %tobool25.not.i.i363.i = icmp eq ptr %310, null
  br i1 %tobool25.not.i.i363.i, label %for.inc.i379.i, label %if.then26.i.i367.i

if.then26.i.i367.i:                               ; preds = %if.then24.i.i364.i
  %used_for_reference28.i.i365.i = getelementptr inbounds %struct.storable_picture, ptr %310, i64 0, i32 15
  %311 = load i32, ptr %used_for_reference28.i.i365.i, align 4, !tbaa !75
  %tobool29.not.i.i366.i = icmp eq i32 %311, 0
...
land.lhs.true30.i.i370.i:                         ; preds = %if.then26.i.i367.i
  %is_long_term32.i.i368.i = getelementptr inbounds %struct.storable_picture, ptr %310, i64 0, i32 14
  %312 = load i32, ptr %is_long_term32.i.i368.i, align 8, !tbaa !76
  %tobool33.not.i.i369.i = icmp eq i32 %312, 0
...
if.then.i375.i:                                   ; preds = %land.lhs.true30.i.i370.i, %land.lhs.true13.i.i358.i, %land.lhs.true.i.i346.i
  %313 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 2), align 8, !tbaa !35
  %inc.i371.i = add i32 %j.020.i336.i, 1
  %idxprom3.i372.i = zext i32 %j.020.i336.i to i64
  %arrayidx4.i373.i = getelementptr inbounds ptr, ptr %313, i64 %idxprom3.i372.i
  store ptr %302, ptr %arrayidx4.i373.i, align 8, !tbaa !5
...
for.inc.i379.i:                                   ; preds = %if.then.i375.i, %land.lhs.true30.i.i370.i, %if.then26.i.i367.i, %if.then24.i.i364.i, %if.end20.i.i361.i
  %314 = phi ptr [ %.pre.i374.i, %if.then.i375.i ], [ %301, %if.end20.i.i361.i ], [ %301, %if.then24.i.i364.i ], [ %301, %if.then26.i.i367.i ], [ %301, %land.lhs.true30.i.i370.i ]
...
for.end.i382.i:                                   ; preds = %for.inc.i379.i, %mm_update_max_long_term_frame_idx.exit.i
  ...
  %315 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 3), align 8, !tbaa !28
  %cmp621.i381.i = icmp ult i32 %j.0.lcssa.i380.i, %315
  br i1 %cmp621.i381.i, label %while.body.preheader.i384.i, label %sw.epilog.i

while.body.preheader.i384.i:                      ; preds = %for.end.i382.i
  %316 = zext i32 %j.0.lcssa.i380.i to i64
  %wide.trip.count27.i383.i = zext i32 %315 to i64
  %317 = sub nsw i64 %wide.trip.count27.i383.i, %316
  %318 = xor i64 %316, -1
  %319 = add nsw i64 %318, %wide.trip.count27.i383.i
  %xtraiter787 = and i64 %317, 3
  %lcmp.mod788.not = icmp eq i64 %xtraiter787, 0
  br i1 %lcmp.mod788.not, label %while.body.i389.i.prol.loopexit, label %while.body.i389.i.prol

while.body.i389.i.prol:                           ; preds = %while.body.preheader.i384.i, %while.body.i389.i.prol
  %indvars.iv24.i385.i.prol = phi i64 [ %indvars.iv.next25.i386.i.prol, %while.body.i389.i.prol ], [ %316, %while.body.preheader.i384.i ]
  %prol.iter789 = phi i64 [ %prol.iter789.next, %while.body.i389.i.prol ], [ 0, %while.body.preheader.i384.i ]
  ...
  %arrayidx9.i387.i.prol = getelementptr inbounds ptr, ptr %320, i64 %indvars.iv24.i385.i.prol
  store ptr null, ptr %arrayidx9.i387.i.prol, align 8, !tbaa !5
  %prol.iter789.next = add i64 %prol.iter789, 1
  %prol.iter789.cmp.not = icmp eq i64 %prol.iter789.next, %xtraiter787
  br i1 %prol.iter789.cmp.not, label %while.body.i389.i.prol.loopexit, label %while.body.i389.i.prol, !llvm.loop !183

while.body.i389.i.prol.loopexit:                  ; preds = %while.body.i389.i.prol, %while.body.preheader.i384.i
  %indvars.iv24.i385.i.unr = phi i64 [ %316, %while.body.preheader.i384.i ], [ %indvars.iv.next25.i386.i.prol, %while.body.i389.i.prol ]
  %321 = icmp ult i64 %319, 3
  br i1 %321, label %sw.epilog.i, label %while.body.i389.i
...
while.body.i389.i:                                ; preds = %while.body.i389.i.prol.loopexit, %while.body.i389.i
  ...
  %arrayidx9.i387.i = getelementptr inbounds ptr, ptr %322, i64 %indvars.iv24.i385.i
  ...
  %arrayidx9.i387.i.1 = getelementptr inbounds ptr, ptr %323, i64 %indvars.iv.next25.i386.i
  store ptr null, ptr %arrayidx9.i387.i.1, align 8, !tbaa !5
  %324 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 2), align 8, !tbaa !35
  %indvars.iv.next25.i386.i.2 = add nuw nsw i64 %indvars.iv24.i385.i, 3
  %arrayidx9.i387.i.2 = getelementptr inbounds ptr, ptr %324, i64 %indvars.iv.next25.i386.i.1
  ...
  %arrayidx9.i387.i.3 = getelementptr inbounds ptr, ptr %325, i64 %indvars.iv.next25.i386.i.2
...
sw.bb7.i:                                         ; preds = %while.body.i
  %326 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 5), align 8, !tbaa !21
  %cmp3.not.i.i = icmp eq i32 %326, 0
...
for.body.i394.i:                                  ; preds = %sw.bb7.i, %for.body.i394.i
  ...
  %327 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  %arrayidx.i392.i = getelementptr inbounds ptr, ptr %327, i64 %indvars.iv.i391.i
  %328 = load ptr, ptr %arrayidx.i392.i, align 8, !tbaa !5
  tail call fastcc void @unmark_for_reference(ptr noundef %328)
  %indvars.iv.next.i393.i = add nuw nsw i64 %indvars.iv.i391.i, 1
  %329 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 5), align 8, !tbaa !21
  %330 = zext i32 %329 to i64
  %cmp.i.i195 = icmp ult i64 %indvars.iv.next.i393.i, %330
  br i1 %cmp.i.i195, label %for.body.i394.i, label %for.end.i395.i, !llvm.loop !184

for.end.i395.i:                                   ; preds = %for.body.i394.i, %sw.bb7.i
  %331 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 4), align 4, !tbaa !31
  %cmp18.not.i.i.i = icmp eq i32 %331, 0
  br i1 %cmp18.not.i.i.i, label %for.end.i.i421.i, label %for.body.preheader.i.i.i

for.body.preheader.i.i.i:                         ; preds = %for.end.i395.i
  %wide.trip.count.i.i396.i = zext i32 %331 to i64
  %.pre29.i.i.i = load ptr, ptr @dpb, align 8, !tbaa !33
  br label %for.body.i.i400.i

for.body.i.i400.i:                                ; preds = %for.inc.i.i420.i, %for.body.preheader.i.i.i
  %332 = phi ptr [ %.pre29.i.i.i, %for.body.preheader.i.i.i ], [ %345, %for.inc.i.i420.i ]
  %indvars.iv.i.i397.i = phi i64 [ 0, %for.body.preheader.i.i.i ], [ %indvars.iv.next.i.i418.i, %for.inc.i.i420.i ]
  %j.020.i.i.i = phi i32 [ 0, %for.body.preheader.i.i.i ], [ %j.1.i.i.i, %for.inc.i.i420.i ]
  %arrayidx.i.i398.i = getelementptr inbounds ptr, ptr %332, i64 %indvars.iv.i.i397.i
  %333 = load ptr, ptr %arrayidx.i.i398.i, align 8, !tbaa !5
  %334 = load i32, ptr %333, align 8, !tbaa !77
  %cmp.i.i.i399.i = icmp eq i32 %334, 3
  br i1 %cmp.i.i.i399.i, label %if.then.i.i.i404.i, label %if.end4.i.i.i.i

if.then.i.i.i404.i:                               ; preds = %for.body.i.i400.i
  %frame.i.i.i401.i = getelementptr inbounds %struct.frame_store, ptr %333, i64 0, i32 10
  %335 = load ptr, ptr %frame.i.i.i401.i, align 8, !tbaa !42
  %used_for_reference.i.i.i402.i = getelementptr inbounds %struct.storable_picture, ptr %335, i64 0, i32 15
  %336 = load i32, ptr %used_for_reference.i.i.i402.i, align 4, !tbaa !75
  %tobool.not.i.i.i403.i = icmp eq i32 %336, 0
...
land.lhs.true.i.i.i406.i:                         ; preds = %if.then.i.i.i404.i
  %is_long_term.i.i.i405.i = getelementptr inbounds %struct.storable_picture, ptr %335, i64 0, i32 14
  %337 = load i32, ptr %is_long_term.i.i.i405.i, align 8, !tbaa !76
  %tobool2.not.i.i.i.i = icmp eq i32 %337, 0
  br i1 %tobool2.not.i.i.i.i, label %if.then.i.i417.i, label %if.then7.i.i.i.i

if.end4.i.i.i.i:                                  ; preds = %for.body.i.i400.i
  %and.i.i.i407.i = and i32 %334, 1
...
if.then7.i.i.i.i:                                 ; preds = %if.end4.i.i.i.i, %land.lhs.true.i.i.i406.i, %if.then.i.i.i404.i
  %top_field.i.i.i408.i = getelementptr inbounds %struct.frame_store, ptr %333, i64 0, i32 11
  %338 = load ptr, ptr %top_field.i.i.i408.i, align 8, !tbaa !44
  %tobool8.not.i.i.i409.i = icmp eq ptr %338, null
  br i1 %tobool8.not.i.i.i409.i, label %if.end20.i.i.i.i, label %if.then9.i.i.i410.i

if.then9.i.i.i410.i:                              ; preds = %if.then7.i.i.i.i
  %used_for_reference11.i.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %338, i64 0, i32 15
  %339 = load i32, ptr %used_for_reference11.i.i.i.i, align 4, !tbaa !75
  %tobool12.not.i.i.i.i = icmp eq i32 %339, 0
...
land.lhs.true13.i.i.i.i:                          ; preds = %if.then9.i.i.i410.i
  %is_long_term15.i.i.i411.i = getelementptr inbounds %struct.storable_picture, ptr %338, i64 0, i32 14
  %340 = load i32, ptr %is_long_term15.i.i.i411.i, align 8, !tbaa !76
  %tobool16.not.i.i.i.i = icmp eq i32 %340, 0
  br i1 %tobool16.not.i.i.i.i, label %if.then.i.i417.i, label %if.end20.i.i.i.i

if.end20.i.i.i.i:                                 ; preds = %land.lhs.true13.i.i.i.i, %if.then9.i.i.i410.i, %if.then7.i.i.i.i, %if.end4.i.i.i.i
  %and22.i.i.i.i = and i32 %334, 2
  %tobool23.not.i.i.i412.i = icmp eq i32 %and22.i.i.i.i, 0
  br i1 %tobool23.not.i.i.i412.i, label %for.inc.i.i420.i, label %if.then24.i.i.i414.i

if.then24.i.i.i414.i:                             ; preds = %if.end20.i.i.i.i
  %bottom_field.i.i.i413.i = getelementptr inbounds %struct.frame_store, ptr %333, i64 0, i32 12
  %341 = load ptr, ptr %bottom_field.i.i.i413.i, align 8, !tbaa !45
  %tobool25.not.i.i.i.i = icmp eq ptr %341, null
  br i1 %tobool25.not.i.i.i.i, label %for.inc.i.i420.i, label %if.then26.i.i.i.i

if.then26.i.i.i.i:                                ; preds = %if.then24.i.i.i414.i
  %used_for_reference28.i.i.i.i = getelementptr inbounds %struct.storable_picture, ptr %341, i64 0, i32 15
  %342 = load i32, ptr %used_for_reference28.i.i.i.i, align 4, !tbaa !75
  %tobool29.not.i.i.i.i = icmp eq i32 %342, 0
  br i1 %tobool29.not.i.i.i.i, label %for.inc.i.i420.i, label %land.lhs.true30.i.i.i.i

land.lhs.true30.i.i.i.i:                          ; preds = %if.then26.i.i.i.i
  %is_long_term32.i.i.i415.i = getelementptr inbounds %struct.storable_picture, ptr %341, i64 0, i32 14
  %343 = load i32, ptr %is_long_term32.i.i.i415.i, align 8, !tbaa !76
  %tobool33.not.i.i.i.i = icmp eq i32 %343, 0
  br i1 %tobool33.not.i.i.i.i, label %if.then.i.i417.i, label %for.inc.i.i420.i

if.then.i.i417.i:                                 ; preds = %land.lhs.true30.i.i.i.i, %land.lhs.true13.i.i.i.i, %land.lhs.true.i.i.i406.i
  %344 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  %inc.i.i.i = add i32 %j.020.i.i.i, 1
  %idxprom3.i.i.i = zext i32 %j.020.i.i.i to i64
  %arrayidx4.i.i.i = getelementptr inbounds ptr, ptr %344, i64 %idxprom3.i.i.i
  store ptr %333, ptr %arrayidx4.i.i.i, align 8, !tbaa !5
  %.pre.i.i416.i = load ptr, ptr @dpb, align 8, !tbaa !33
  br label %for.inc.i.i420.i

for.inc.i.i420.i:                                 ; preds = %if.then.i.i417.i, %land.lhs.true30.i.i.i.i, %if.then26.i.i.i.i, %if.then24.i.i.i414.i, %if.end20.i.i.i.i
  %345 = phi ptr [ %.pre.i.i416.i, %if.then.i.i417.i ], [ %332, %if.end20.i.i.i.i ], [ %332, %if.then24.i.i.i414.i ], [ %332, %if.then26.i.i.i.i ], [ %332, %land.lhs.true30.i.i.i.i ]
  %j.1.i.i.i = phi i32 [ %inc.i.i.i, %if.then.i.i417.i ], [ %j.020.i.i.i, %if.end20.i.i.i.i ], [ %j.020.i.i.i, %if.then24.i.i.i414.i ], [ %j.020.i.i.i, %if.then26.i.i.i.i ], [ %j.020.i.i.i, %land.lhs.true30.i.i.i.i ]
  %indvars.iv.next.i.i418.i = add nuw nsw i64 %indvars.iv.i.i397.i, 1
  %exitcond.not.i.i419.i = icmp eq i64 %indvars.iv.next.i.i418.i, %wide.trip.count.i.i396.i
  br i1 %exitcond.not.i.i419.i, label %for.end.i.i421.i, label %for.body.i.i400.i, !llvm.loop !141

for.end.i.i421.i:                                 ; preds = %for.inc.i.i420.i, %for.end.i395.i
  %j.0.lcssa.i.i.i = phi i32 [ 0, %for.end.i395.i ], [ %j.1.i.i.i, %for.inc.i.i420.i ]
  store i32 %j.0.lcssa.i.i.i, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 5), align 8, !tbaa !21
  %346 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 3), align 8, !tbaa !28
  %cmp621.i.i.i = icmp ult i32 %j.0.lcssa.i.i.i, %346
  br i1 %cmp621.i.i.i, label %while.body.preheader.i.i.i, label %mm_unmark_all_short_term_for_reference.exit.i

while.body.preheader.i.i.i:                       ; preds = %for.end.i.i421.i
  %347 = zext i32 %j.0.lcssa.i.i.i to i64
  %wide.trip.count27.i.i.i = zext i32 %346 to i64
  %348 = sub nsw i64 %wide.trip.count27.i.i.i, %347
  %349 = xor i64 %347, -1
  %350 = add nsw i64 %349, %wide.trip.count27.i.i.i
  %xtraiter784 = and i64 %348, 3
  %lcmp.mod785.not = icmp eq i64 %xtraiter784, 0
  br i1 %lcmp.mod785.not, label %while.body.i.i.i.prol.loopexit, label %while.body.i.i.i.prol

while.body.i.i.i.prol:                            ; preds = %while.body.preheader.i.i.i, %while.body.i.i.i.prol
  %indvars.iv24.i.i.i.prol = phi i64 [ %indvars.iv.next25.i.i.i.prol, %while.body.i.i.i.prol ], [ %347, %while.body.preheader.i.i.i ]
  %prol.iter786 = phi i64 [ %prol.iter786.next, %while.body.i.i.i.prol ], [ 0, %while.body.preheader.i.i.i ]
  ...
  %arrayidx9.i.i.i.prol = getelementptr inbounds ptr, ptr %351, i64 %indvars.iv24.i.i.i.prol
  store ptr null, ptr %arrayidx9.i.i.i.prol, align 8, !tbaa !5
  %prol.iter786.next = add i64 %prol.iter786, 1
  %prol.iter786.cmp.not = icmp eq i64 %prol.iter786.next, %xtraiter784
  br i1 %prol.iter786.cmp.not, label %while.body.i.i.i.prol.loopexit, label %while.body.i.i.i.prol, !llvm.loop !185

while.body.i.i.i.prol.loopexit:                   ; preds = %while.body.i.i.i.prol, %while.body.preheader.i.i.i
  %indvars.iv24.i.i.i.unr = phi i64 [ %347, %while.body.preheader.i.i.i ], [ %indvars.iv.next25.i.i.i.prol, %while.body.i.i.i.prol ]
  %352 = icmp ult i64 %350, 3
  br i1 %352, label %mm_unmark_all_short_term_for_reference.exit.i, label %while.body.i.i.i
...
while.body.i.i.i:                                 ; preds = %while.body.i.i.i.prol.loopexit, %while.body.i.i.i
  ...
  %arrayidx9.i.i.i = getelementptr inbounds ptr, ptr %353, i64 %indvars.iv24.i.i.i
  ...
  %arrayidx9.i.i.i.1 = getelementptr inbounds ptr, ptr %354, i64 %indvars.iv.next25.i.i.i
  store ptr null, ptr %arrayidx9.i.i.i.1, align 8, !tbaa !5
  %355 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  %indvars.iv.next25.i.i.i.2 = add nuw nsw i64 %indvars.iv24.i.i.i, 3
  %arrayidx9.i.i.i.2 = getelementptr inbounds ptr, ptr %355, i64 %indvars.iv.next25.i.i.i.1
  store ptr null, ptr %arrayidx9.i.i.i.2, align 8, !tbaa !5
  %356 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  %indvars.iv.next25.i.i.i.3 = add nuw nsw i64 %indvars.iv24.i.i.i, 4
  %arrayidx9.i.i.i.3 = getelementptr inbounds ptr, ptr %356, i64 %indvars.iv.next25.i.i.i.2
...
mm_unmark_all_short_term_for_reference.exit.i:    ; preds = %while.body.i.i.i.prol.loopexit, %while.body.i.i.i, %for.end.i.i421.i
  store i32 -1, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 8), align 4, !tbaa !147
  %357 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 6), align 4, !tbaa !19
  %cmp7.not.i.i.i = icmp eq i32 %357, 0
...
for.body.lr.ph.i.i423.i:                          ; preds = %mm_unmark_all_short_term_for_reference.exit.i
  %358 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 2), align 8, !tbaa !35
  %wide.trip.count.i.i422.i = zext i32 %357 to i64
  br label %for.body.i.i426.i

for.body.i.i426.i:                                ; preds = %for.inc.i.i467.i, %for.body.lr.ph.i.i423.i
  %indvars.iv.i.i424.i = phi i64 [ 0, %for.body.lr.ph.i.i423.i ], [ %indvars.iv.next.i.i465.i, %for.inc.i.i467.i ]
  %arrayidx.i.i425.i = getelementptr inbounds ptr, ptr %358, i64 %indvars.iv.i.i424.i
  %359 = load ptr, ptr %arrayidx.i.i425.i, align 8, !tbaa !5
  %long_term_frame_idx.i.i.i = getelementptr inbounds %struct.frame_store, ptr %359, i64 0, i32 7
  %360 = load i32, ptr %long_term_frame_idx.i.i.i, align 4, !tbaa !128
  %cmp1.not.i.i.i = icmp slt i32 %360, 0
  br i1 %cmp1.not.i.i.i, label %for.inc.i.i467.i, label %if.then.i.i429.i

if.then.i.i429.i:                                 ; preds = %for.body.i.i426.i
  %361 = load i32, ptr %359, align 8, !tbaa !77
  %and.i.i.i427.i = and i32 %361, 1
  %tobool.not.i.i.i428.i = icmp eq i32 %and.i.i.i427.i, 0
  br i1 %tobool.not.i.i.i428.i, label %if.end5.i.i.i438.i, label %if.then.i.i.i432.i

if.then.i.i.i432.i:                               ; preds = %if.then.i.i429.i
  %top_field.i.i.i430.i = getelementptr inbounds %struct.frame_store, ptr %359, i64 0, i32 11
  %362 = load ptr, ptr %top_field.i.i.i430.i, align 8, !tbaa !44
  %tobool1.not.i.i.i431.i = icmp eq ptr %362, null
  br i1 %tobool1.not.i.i.i431.i, label %if.end5.i.i.i438.i, label %if.then2.i.i.i435.i

if.then2.i.i.i435.i:                              ; preds = %if.then.i.i.i432.i
  %used_for_reference.i.i.i433.i = getelementptr inbounds %struct.storable_picture, ptr %362, i64 0, i32 15
  store i32 0, ptr %used_for_reference.i.i.i433.i, align 4, !tbaa !75
  %is_long_term.i.i.i434.i = getelementptr inbounds %struct.storable_picture, ptr %362, i64 0, i32 14
  store i32 0, ptr %is_long_term.i.i.i434.i, align 8, !tbaa !76
  br label %if.end5.i.i.i438.i

if.end5.i.i.i438.i:                               ; preds = %if.then2.i.i.i435.i, %if.then.i.i.i432.i, %if.then.i.i429.i
  %and7.i.i.i436.i = and i32 %361, 2
  %tobool8.not.i.i.i437.i = icmp eq i32 %and7.i.i.i436.i, 0
  br i1 %tobool8.not.i.i.i437.i, label %if.end17.i.i.i446.i, label %if.then9.i.i.i441.i

if.then9.i.i.i441.i:                              ; preds = %if.end5.i.i.i438.i
  %bottom_field.i.i.i439.i = getelementptr inbounds %struct.frame_store, ptr %359, i64 0, i32 12
  %363 = load ptr, ptr %bottom_field.i.i.i439.i, align 8, !tbaa !45
  %tobool10.not.i.i.i440.i = icmp eq ptr %363, null
  br i1 %tobool10.not.i.i.i440.i, label %if.end17.i.i.i446.i, label %if.then11.i.i.i444.i

if.then11.i.i.i444.i:                             ; preds = %if.then9.i.i.i441.i
  %used_for_reference13.i.i.i442.i = getelementptr inbounds %struct.storable_picture, ptr %363, i64 0, i32 15
  store i32 0, ptr %used_for_reference13.i.i.i442.i, align 4, !tbaa !75
  %is_long_term15.i.i.i443.i = getelementptr inbounds %struct.storable_picture, ptr %363, i64 0, i32 14
  store i32 0, ptr %is_long_term15.i.i.i443.i, align 8, !tbaa !76
  br label %if.end17.i.i.i446.i

if.end17.i.i.i446.i:                              ; preds = %if.then11.i.i.i444.i, %if.then9.i.i.i441.i, %if.end5.i.i.i438.i
  %cmp.i.i.i445.i = icmp eq i32 %361, 3
  br i1 %cmp.i.i.i445.i, label %if.then19.i.i.i449.i, label %unmark_for_long_term_reference.exit.i.i464.i

if.then19.i.i.i449.i:                             ; preds = %if.end17.i.i.i446.i
  %top_field20.i.i.i447.i = getelementptr inbounds %struct.frame_store, ptr %359, i64 0, i32 11
  %364 = load ptr, ptr %top_field20.i.i.i447.i, align 8, !tbaa !44
  %tobool21.not.i.i.i448.i = icmp eq ptr %364, null
  br i1 %tobool21.not.i.i.i448.i, label %if.end33.i.i.i461.i, label %land.lhs.true.i.i.i452.i

land.lhs.true.i.i.i452.i:                         ; preds = %if.then19.i.i.i449.i
  %bottom_field22.i.i.i450.i = getelementptr inbounds %struct.frame_store, ptr %359, i64 0, i32 12
  %365 = load ptr, ptr %bottom_field22.i.i.i450.i, align 8, !tbaa !45
  %tobool23.not.i.i.i451.i = icmp eq ptr %365, null
  br i1 %tobool23.not.i.i.i451.i, label %if.end33.i.i.i461.i, label %if.then24.i.i.i457.i

if.then24.i.i.i457.i:                             ; preds = %land.lhs.true.i.i.i452.i
  %used_for_reference26.i.i.i453.i = getelementptr inbounds %struct.storable_picture, ptr %364, i64 0, i32 15
  store i32 0, ptr %used_for_reference26.i.i.i453.i, align 4, !tbaa !75
  %is_long_term28.i.i.i454.i = getelementptr inbounds %struct.storable_picture, ptr %364, i64 0, i32 14
  store i32 0, ptr %is_long_term28.i.i.i454.i, align 8, !tbaa !76
  %used_for_reference30.i.i.i455.i = getelementptr inbounds %struct.storable_picture, ptr %365, i64 0, i32 15
  store i32 0, ptr %used_for_reference30.i.i.i455.i, align 4, !tbaa !75
  %is_long_term32.i.i.i456.i = getelementptr inbounds %struct.storable_picture, ptr %365, i64 0, i32 14
  store i32 0, ptr %is_long_term32.i.i.i456.i, align 8, !tbaa !76
  br label %if.end33.i.i.i461.i

if.end33.i.i.i461.i:                              ; preds = %if.then24.i.i.i457.i, %land.lhs.true.i.i.i452.i, %if.then19.i.i.i449.i
  %frame.i.i.i458.i = getelementptr inbounds %struct.frame_store, ptr %359, i64 0, i32 10
  %366 = load ptr, ptr %frame.i.i.i458.i, align 8, !tbaa !42
  %used_for_reference34.i.i.i459.i = getelementptr inbounds %struct.storable_picture, ptr %366, i64 0, i32 15
  store i32 0, ptr %used_for_reference34.i.i.i459.i, align 4, !tbaa !75
  %is_long_term36.i.i.i460.i = getelementptr inbounds %struct.storable_picture, ptr %366, i64 0, i32 14
  store i32 0, ptr %is_long_term36.i.i.i460.i, align 8, !tbaa !76
  br label %unmark_for_long_term_reference.exit.i.i464.i

unmark_for_long_term_reference.exit.i.i464.i:     ; preds = %if.end33.i.i.i461.i, %if.end17.i.i.i446.i
  %is_reference.i.i.i462.i = getelementptr inbounds %struct.frame_store, ptr %359, i64 0, i32 1
  store i32 0, ptr %is_reference.i.i.i462.i, align 4, !tbaa !85
  %is_long_term38.i.i.i463.i = getelementptr inbounds %struct.frame_store, ptr %359, i64 0, i32 2
  store i32 0, ptr %is_long_term38.i.i.i463.i, align 8, !tbaa !87
  br label %for.inc.i.i467.i

for.inc.i.i467.i:                                 ; preds = %unmark_for_long_term_reference.exit.i.i464.i, %for.body.i.i426.i
  %indvars.iv.next.i.i465.i = add nuw nsw i64 %indvars.iv.i.i424.i, 1
  %exitcond.not.i.i466.i = icmp eq i64 %indvars.iv.next.i.i465.i, %wide.trip.count.i.i422.i
  br i1 %exitcond.not.i.i466.i, label %mm_unmark_all_long_term_for_reference.exit.i, label %for.body.i.i426.i, !llvm.loop !148

mm_unmark_all_long_term_for_reference.exit.i:     ; preds = %for.inc.i.i467.i, %mm_unmark_all_short_term_for_reference.exit.i
  %367 = load ptr, ptr @img, align 8, !tbaa !5
  %last_has_mmco_58.i = getelementptr inbounds %struct.ImageParameters, ptr %367, i64 0, i32 138
...
sw.bb9.i:                                         ; preds = %while.body.i
  ...
  %368 = load i32, ptr %long_term_frame_idx10.i, align 4, !tbaa !175
  %369 = load i32, ptr %p, align 8, !tbaa !51
  %cmp.i468.i = icmp eq i32 %369, 0
  br i1 %cmp.i468.i, label %if.then.i470.i, label %if.else.i.i

if.then.i470.i:                                   ; preds = %sw.bb9.i
  %370 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 6), align 4, !tbaa !19
  %cmp8.not.i.i469.i = icmp eq i32 %370, 0
  br i1 %cmp8.not.i.i469.i, label %mm_mark_current_picture_long_term.exit.i, label %for.body.lr.ph.i.i472.i

for.body.lr.ph.i.i472.i:                          ; preds = %if.then.i470.i
  %371 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 2), align 8, !tbaa !35
  %wide.trip.count.i.i471.i = zext i32 %370 to i64
  br label %for.body.i.i477.i

for.body.i.i477.i:                                ; preds = %for.inc.i.i518.i, %for.body.lr.ph.i.i472.i
  %indvars.iv.i.i473.i = phi i64 [ 0, %for.body.lr.ph.i.i472.i ], [ %indvars.iv.next.i.i516.i, %for.inc.i.i518.i ]
  %arrayidx.i.i474.i = getelementptr inbounds ptr, ptr %371, i64 %indvars.iv.i.i473.i
  %372 = load ptr, ptr %arrayidx.i.i474.i, align 8, !tbaa !5
  %long_term_frame_idx1.i.i475.i = getelementptr inbounds %struct.frame_store, ptr %372, i64 0, i32 7
  %373 = load i32, ptr %long_term_frame_idx1.i.i475.i, align 4, !tbaa !128
  %cmp2.i.i476.i = icmp eq i32 %373, %368
  br i1 %cmp2.i.i476.i, label %if.then.i.i480.i, label %for.inc.i.i518.i

if.then.i.i480.i:                                 ; preds = %for.body.i.i477.i
  %374 = load i32, ptr %372, align 8, !tbaa !77
  %and.i.i.i478.i = and i32 %374, 1
  %tobool.not.i.i.i479.i = icmp eq i32 %and.i.i.i478.i, 0
  br i1 %tobool.not.i.i.i479.i, label %if.end5.i.i.i489.i, label %if.then.i.i.i483.i

if.then.i.i.i483.i:                               ; preds = %if.then.i.i480.i
  %top_field.i.i.i481.i = getelementptr inbounds %struct.frame_store, ptr %372, i64 0, i32 11
  %375 = load ptr, ptr %top_field.i.i.i481.i, align 8, !tbaa !44
  %tobool1.not.i.i.i482.i = icmp eq ptr %375, null
  br i1 %tobool1.not.i.i.i482.i, label %if.end5.i.i.i489.i, label %if.then2.i.i.i486.i

if.then2.i.i.i486.i:                              ; preds = %if.then.i.i.i483.i
  %used_for_reference.i.i.i484.i = getelementptr inbounds %struct.storable_picture, ptr %375, i64 0, i32 15
  store i32 0, ptr %used_for_reference.i.i.i484.i, align 4, !tbaa !75
  %is_long_term.i.i.i485.i = getelementptr inbounds %struct.storable_picture, ptr %375, i64 0, i32 14
  store i32 0, ptr %is_long_term.i.i.i485.i, align 8, !tbaa !76
  br label %if.end5.i.i.i489.i

if.end5.i.i.i489.i:                               ; preds = %if.then2.i.i.i486.i, %if.then.i.i.i483.i, %if.then.i.i480.i
  %and7.i.i.i487.i = and i32 %374, 2
  %tobool8.not.i.i.i488.i = icmp eq i32 %and7.i.i.i487.i, 0
  br i1 %tobool8.not.i.i.i488.i, label %if.end17.i.i.i497.i, label %if.then9.i.i.i492.i

if.then9.i.i.i492.i:                              ; preds = %if.end5.i.i.i489.i
  %bottom_field.i.i.i490.i = getelementptr inbounds %struct.frame_store, ptr %372, i64 0, i32 12
  %376 = load ptr, ptr %bottom_field.i.i.i490.i, align 8, !tbaa !45
  %tobool10.not.i.i.i491.i = icmp eq ptr %376, null
  br i1 %tobool10.not.i.i.i491.i, label %if.end17.i.i.i497.i, label %if.then11.i.i.i495.i

if.then11.i.i.i495.i:                             ; preds = %if.then9.i.i.i492.i
  %used_for_reference13.i.i.i493.i = getelementptr inbounds %struct.storable_picture, ptr %376, i64 0, i32 15
  store i32 0, ptr %used_for_reference13.i.i.i493.i, align 4, !tbaa !75
  %is_long_term15.i.i.i494.i = getelementptr inbounds %struct.storable_picture, ptr %376, i64 0, i32 14
  store i32 0, ptr %is_long_term15.i.i.i494.i, align 8, !tbaa !76
  br label %if.end17.i.i.i497.i

if.end17.i.i.i497.i:                              ; preds = %if.then11.i.i.i495.i, %if.then9.i.i.i492.i, %if.end5.i.i.i489.i
  %cmp.i.i.i496.i = icmp eq i32 %374, 3
  br i1 %cmp.i.i.i496.i, label %if.then19.i.i.i500.i, label %unmark_for_long_term_reference.exit.i.i515.i

if.then19.i.i.i500.i:                             ; preds = %if.end17.i.i.i497.i
  %top_field20.i.i.i498.i = getelementptr inbounds %struct.frame_store, ptr %372, i64 0, i32 11
  %377 = load ptr, ptr %top_field20.i.i.i498.i, align 8, !tbaa !44
  %tobool21.not.i.i.i499.i = icmp eq ptr %377, null
  br i1 %tobool21.not.i.i.i499.i, label %if.end33.i.i.i512.i, label %land.lhs.true.i.i.i503.i

land.lhs.true.i.i.i503.i:                         ; preds = %if.then19.i.i.i500.i
  %bottom_field22.i.i.i501.i = getelementptr inbounds %struct.frame_store, ptr %372, i64 0, i32 12
  %378 = load ptr, ptr %bottom_field22.i.i.i501.i, align 8, !tbaa !45
  %tobool23.not.i.i.i502.i = icmp eq ptr %378, null
  br i1 %tobool23.not.i.i.i502.i, label %if.end33.i.i.i512.i, label %if.then24.i.i.i508.i

if.then24.i.i.i508.i:                             ; preds = %land.lhs.true.i.i.i503.i
  %used_for_reference26.i.i.i504.i = getelementptr inbounds %struct.storable_picture, ptr %377, i64 0, i32 15
  store i32 0, ptr %used_for_reference26.i.i.i504.i, align 4, !tbaa !75
  %is_long_term28.i.i.i505.i = getelementptr inbounds %struct.storable_picture, ptr %377, i64 0, i32 14
  store i32 0, ptr %is_long_term28.i.i.i505.i, align 8, !tbaa !76
  %used_for_reference30.i.i.i506.i = getelementptr inbounds %struct.storable_picture, ptr %378, i64 0, i32 15
  store i32 0, ptr %used_for_reference30.i.i.i506.i, align 4, !tbaa !75
  %is_long_term32.i.i.i507.i = getelementptr inbounds %struct.storable_picture, ptr %378, i64 0, i32 14
  store i32 0, ptr %is_long_term32.i.i.i507.i, align 8, !tbaa !76
  br label %if.end33.i.i.i512.i

if.end33.i.i.i512.i:                              ; preds = %if.then24.i.i.i508.i, %land.lhs.true.i.i.i503.i, %if.then19.i.i.i500.i
  %frame.i.i.i509.i = getelementptr inbounds %struct.frame_store, ptr %372, i64 0, i32 10
  %379 = load ptr, ptr %frame.i.i.i509.i, align 8, !tbaa !42
  %used_for_reference34.i.i.i510.i = getelementptr inbounds %struct.storable_picture, ptr %379, i64 0, i32 15
  store i32 0, ptr %used_for_reference34.i.i.i510.i, align 4, !tbaa !75
  %is_long_term36.i.i.i511.i = getelementptr inbounds %struct.storable_picture, ptr %379, i64 0, i32 14
  store i32 0, ptr %is_long_term36.i.i.i511.i, align 8, !tbaa !76
  br label %unmark_for_long_term_reference.exit.i.i515.i

unmark_for_long_term_reference.exit.i.i515.i:     ; preds = %if.end33.i.i.i512.i, %if.end17.i.i.i497.i
  %is_reference.i.i.i513.i = getelementptr inbounds %struct.frame_store, ptr %372, i64 0, i32 1
  store i32 0, ptr %is_reference.i.i.i513.i, align 4, !tbaa !85
  %is_long_term38.i.i.i514.i = getelementptr inbounds %struct.frame_store, ptr %372, i64 0, i32 2
  store i32 0, ptr %is_long_term38.i.i.i514.i, align 8, !tbaa !87
  br label %for.inc.i.i518.i

for.inc.i.i518.i:                                 ; preds = %unmark_for_long_term_reference.exit.i.i515.i, %for.body.i.i477.i
  %indvars.iv.next.i.i516.i = add nuw nsw i64 %indvars.iv.i.i473.i, 1
  %exitcond.not.i.i517.i = icmp eq i64 %indvars.iv.next.i.i516.i, %wide.trip.count.i.i471.i
  br i1 %exitcond.not.i.i517.i, label %mm_mark_current_picture_long_term.exit.i, label %for.body.i.i477.i, !llvm.loop !176

if.else.i.i:                                      ; preds = %sw.bb9.i
  %380 = load i32, ptr %pic_num.i519.i, align 4, !tbaa !80
  tail call fastcc void @unmark_long_term_field_for_reference_by_frame_idx(i32 noundef %369, i32 noundef %368, i32 noundef 1, i32 noundef %380, i32 noundef 0)
  %.pre.i = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 6), align 4, !tbaa !19
  %.pre611.i = load ptr, ptr @img, align 8, !tbaa !5
  br label %mm_mark_current_picture_long_term.exit.i

mm_mark_current_picture_long_term.exit.i:         ; preds = %for.inc.i.i518.i, %if.else.i.i, %if.then.i470.i
  %381 = phi ptr [ %83, %if.then.i470.i ], [ %.pre611.i, %if.else.i.i ], [ %83, %for.inc.i.i518.i ]
  %382 = phi i32 [ 0, %if.then.i470.i ], [ %.pre.i, %if.else.i.i ], [ %370, %for.inc.i.i518.i ]
  store i32 1, ptr %is_long_term.i.i, align 8, !tbaa !76
  store i32 %368, ptr %long_term_frame_idx2.i.i, align 4, !tbaa !82
  %383 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 5), align 8, !tbaa !21
  %add.i.i = add i32 %383, %382
  %num_ref_frames.i.i = getelementptr inbounds %struct.ImageParameters, ptr %381, i64 0, i32 7
  %384 = load i32, ptr %num_ref_frames.i.i, align 4, !tbaa !22
  %cond.i.i.i = tail call i32 @llvm.smax.i32(i32 %384, i32 1)
  %cmp.i520.i = icmp sgt i32 %add.i.i, %cond.i.i.i
  br i1 %cmp.i520.i, label %if.then.i521.i, label %sw.epilog.i

if.then.i521.i:                                   ; preds = %mm_mark_current_picture_long_term.exit.i
  tail call void @error(ptr noundef nonnull @.str.1, i32 noundef 500) #15
  br label %sw.epilog.i
...
sw.epilog.i:                                      ; preds = %while.body.i389.i.prol.loopexit, %while.body.i389.i, %while.body.i302.i.prol.loopexit, %while.body.i302.i, %while.body.i155.i.prol.loopexit, %while.body.i155.i, %while.body.i.i193.prol.loopexit, %while.body.i.i193, %sw.default.i, %if.then.i521.i, %mm_mark_current_picture_long_term.exit.i, %mm_unmark_all_long_term_for_reference.exit.i, %for.end.i382.i, %for.end.i295.i, %for.end.i148.i, %for.end.i.i186, %if.then.i, %sw.bb.i
  %Next11.i = getelementptr inbounds %struct.DecRefPicMarking_s, ptr %84, i64 0, i32 5
  %385 = load ptr, ptr %Next11.i, align 8, !tbaa !167
  %386 = load ptr, ptr @img, align 8, !tbaa !5
  %dec_ref_pic_marking_buffer12.i = getelementptr inbounds %struct.ImageParameters, ptr %386, i64 0, i32 126
  store ptr %385, ptr %dec_ref_pic_marking_buffer12.i, align 8, !tbaa !164
  tail call void @free(ptr noundef %84) #15
  %387 = load ptr, ptr @img, align 8, !tbaa !5
  %dec_ref_pic_marking_buffer.i = getelementptr inbounds %struct.ImageParameters, ptr %387, i64 0, i32 126
  %388 = load ptr, ptr %dec_ref_pic_marking_buffer.i, align 8, !tbaa !164
  %tobool.not.i196 = icmp eq ptr %388, null
  br i1 %tobool.not.i196, label %while.end.i, label %while.body.i, !llvm.loop !186

while.end.i:                                      ; preds = %sw.epilog.i
  %last_has_mmco_513.phi.trans.insert.i = getelementptr inbounds %struct.ImageParameters, ptr %387, i64 0, i32 138
  %.pre612.i = load i32, ptr %last_has_mmco_513.phi.trans.insert.i, align 4, !tbaa !41
  %389 = icmp eq i32 %.pre612.i, 0
  br i1 %389, label %if.end7, label %if.then15.i

if.then15.i:                                      ; preds = %while.end.i
  store i32 0, ptr %frame_num.i.i.i, align 8, !tbaa !169
  store i32 0, ptr %pic_num.i519.i, align 4, !tbaa !80
  %390 = load i32, ptr %p, align 8, !tbaa !51
  switch i32 %390, label %if.then15.sw.epilog33_crit_edge.i [
...
if.then15.sw.epilog33_crit_edge.i:                ; preds = %if.then15.i
  ...
  %.pre613.i = load i32, ptr %poc34.phi.trans.insert.i, align 4, !tbaa !105
  br label %sw.epilog33.i

sw.bb16.i:                                        ; preds = %if.then15.i
  %toppoc.i = getelementptr inbounds %struct.ImageParameters, ptr %387, i64 0, i32 111
...
sw.bb17.i:                                        ; preds = %if.then15.i
  %bottompoc.i = getelementptr inbounds %struct.ImageParameters, ptr %387, i64 0, i32 112
...
sw.bb19.i:                                        ; preds = %if.then15.i
  ...
  %391 = load i32, ptr %poc20.i, align 4, !tbaa !105
  %top_poc21.i = getelementptr inbounds %struct.storable_picture, ptr %p, i64 0, i32 2
  %392 = load i32, ptr %top_poc21.i, align 8, !tbaa !188
  %sub.i = sub nsw i32 %392, %391
  ...
  %393 = load i32, ptr %bottom_poc23.i, align 4, !tbaa !190
  %sub24.i = sub nsw i32 %393, %391
  store i32 %sub24.i, ptr %bottom_poc23.i, align 4, !tbaa !190
  %toppoc26.i = getelementptr inbounds %struct.ImageParameters, ptr %387, i64 0, i32 111
  store i32 %sub.i, ptr %toppoc26.i, align 4, !tbaa !187
  %bottompoc28.i = getelementptr inbounds %struct.ImageParameters, ptr %387, i64 0, i32 112
  ...
  %framepoc.i = getelementptr inbounds %struct.ImageParameters, ptr %387, i64 0, i32 113
...
sw.epilog33.i:                                    ; preds = %sw.bb19.i, %sw.bb17.i, %sw.bb16.i, %if.then15.sw.epilog33_crit_edge.i
  %394 = phi i32 [ %.pre613.i, %if.then15.sw.epilog33_crit_edge.i ], [ %cond.i.i, %sw.bb19.i ], [ 0, %sw.bb17.i ], [ 0, %sw.bb16.i ]
  %ThisPOC.i = getelementptr inbounds %struct.ImageParameters, ptr %387, i64 0, i32 114
  store i32 %394, ptr %ThisPOC.i, align 8, !tbaa !111
  tail call void @flush_dpb()
  br label %if.end7

if.end7:                                          ; preds = %sw.epilog33.i, %while.end.i, %if.then6, %if.else, %land.lhs.true, %idr_memory_management.exit
  %395 = load i32, ptr %p, align 8, !tbaa !51
  %cmp9 = icmp eq i32 %395, 1
  br i1 %cmp9, label %if.then14, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %if.end7
  %cmp12 = icmp eq i32 %395, 2
  %396 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 10), align 8
  %tobool15 = icmp ne ptr %396, null
...
if.then16:                                        ; preds = %if.then14
  ...
  %397 = load i32, ptr %frame_num, align 4, !tbaa !78
  %pic_num = getelementptr inbounds %struct.storable_picture, ptr %p, i64 0, i32 11
  %398 = load i32, ptr %pic_num, align 4, !tbaa !80
  %cmp17 = icmp eq i32 %397, %398
  br i1 %cmp17, label %land.lhs.true23, label %if.end52

if.then16.thread:                                 ; preds = %lor.lhs.false
  %frame_num516 = getelementptr inbounds %struct.frame_store, ptr %396, i64 0, i32 5
  %399 = load i32, ptr %frame_num516, align 4, !tbaa !78
  %pic_num517 = getelementptr inbounds %struct.storable_picture, ptr %p, i64 0, i32 11
  %400 = load i32, ptr %pic_num517, align 4, !tbaa !80
  %cmp17518 = icmp eq i32 %399, %400
  br i1 %cmp17518, label %land.lhs.true30, label %if.end52

land.lhs.true23:                                  ; preds = %if.then16
  %401 = load i32, ptr %.old, align 8, !tbaa !77
  %cmp24 = icmp eq i32 %401, 2
  br i1 %cmp24, label %if.then34, label %if.end52

land.lhs.true30:                                  ; preds = %if.then16.thread
  %402 = load i32, ptr %396, align 8, !tbaa !77
  %cmp32 = icmp eq i32 %402, 1
  br i1 %cmp32, label %if.then34, label %if.end52

if.then34:                                        ; preds = %land.lhs.true30, %land.lhs.true23
  %403 = phi ptr [ %396, %land.lhs.true30 ], [ %.old, %land.lhs.true23 ]
  %404 = load i32, ptr %used_for_reference, align 4, !tbaa !75
  %tobool36.not = icmp eq i32 %404, 0
  %is_orig_reference44 = getelementptr inbounds %struct.frame_store, ptr %403, i64 0, i32 3
  %405 = load i32, ptr %is_orig_reference44, align 4, !tbaa !191
...
if.then47:                                        ; preds = %land.lhs.true43, %land.lhs.true37
  tail call fastcc void @insert_picture_in_dpb(ptr noundef nonnull %403, ptr noundef nonnull %p)
  %406 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 4), align 4, !tbaa !31
  %cmp18.not.i = icmp eq i32 %406, 0
  br i1 %cmp18.not.i, label %for.end.i, label %for.body.preheader.i

for.body.preheader.i:                             ; preds = %if.then47
  %wide.trip.count.i197 = zext i32 %406 to i64
  %.pre29.i = load ptr, ptr @dpb, align 8, !tbaa !33
  br label %for.body.i201

for.body.i201:                                    ; preds = %for.inc.i, %for.body.preheader.i
  %407 = phi ptr [ %.pre29.i, %for.body.preheader.i ], [ %420, %for.inc.i ]
  ...
  %arrayidx.i199 = getelementptr inbounds ptr, ptr %407, i64 %indvars.iv.i198
  %408 = load ptr, ptr %arrayidx.i199, align 8, !tbaa !5
  %409 = load i32, ptr %408, align 8, !tbaa !77
  %cmp.i.i200 = icmp eq i32 %409, 3
  br i1 %cmp.i.i200, label %if.then.i.i205, label %if.end4.i.i

if.then.i.i205:                                   ; preds = %for.body.i201
  %frame.i.i202 = getelementptr inbounds %struct.frame_store, ptr %408, i64 0, i32 10
  %410 = load ptr, ptr %frame.i.i202, align 8, !tbaa !42
  %used_for_reference.i.i203 = getelementptr inbounds %struct.storable_picture, ptr %410, i64 0, i32 15
  %411 = load i32, ptr %used_for_reference.i.i203, align 4, !tbaa !75
  %tobool.not.i.i204 = icmp eq i32 %411, 0
  br i1 %tobool.not.i.i204, label %if.then7.i.i, label %land.lhs.true.i.i

land.lhs.true.i.i:                                ; preds = %if.then.i.i205
  %is_long_term.i.i206 = getelementptr inbounds %struct.storable_picture, ptr %410, i64 0, i32 14
  %412 = load i32, ptr %is_long_term.i.i206, align 8, !tbaa !76
  %tobool2.not.i.i = icmp eq i32 %412, 0
  br i1 %tobool2.not.i.i, label %if.then.i214, label %if.then7.i.i

if.end4.i.i:                                      ; preds = %for.body.i201
  %and.i.i207 = and i32 %409, 1
...
if.then7.i.i:                                     ; preds = %if.end4.i.i, %land.lhs.true.i.i, %if.then.i.i205
  %top_field.i.i208 = getelementptr inbounds %struct.frame_store, ptr %408, i64 0, i32 11
  %413 = load ptr, ptr %top_field.i.i208, align 8, !tbaa !44
  %tobool8.not.i.i = icmp eq ptr %413, null
  br i1 %tobool8.not.i.i, label %if.end20.i.i, label %if.then9.i.i

if.then9.i.i:                                     ; preds = %if.then7.i.i
  %used_for_reference11.i.i = getelementptr inbounds %struct.storable_picture, ptr %413, i64 0, i32 15
  %414 = load i32, ptr %used_for_reference11.i.i, align 4, !tbaa !75
  %tobool12.not.i.i = icmp eq i32 %414, 0
  br i1 %tobool12.not.i.i, label %if.end20.i.i, label %land.lhs.true13.i.i

land.lhs.true13.i.i:                              ; preds = %if.then9.i.i
  %is_long_term15.i.i = getelementptr inbounds %struct.storable_picture, ptr %413, i64 0, i32 14
  %415 = load i32, ptr %is_long_term15.i.i, align 8, !tbaa !76
  %tobool16.not.i.i = icmp eq i32 %415, 0
...
if.then24.i.i212:                                 ; preds = %if.end20.i.i
  %bottom_field.i.i211 = getelementptr inbounds %struct.frame_store, ptr %408, i64 0, i32 12
  %416 = load ptr, ptr %bottom_field.i.i211, align 8, !tbaa !45
  %tobool25.not.i.i = icmp eq ptr %416, null
  br i1 %tobool25.not.i.i, label %for.inc.i, label %if.then26.i.i

if.then26.i.i:                                    ; preds = %if.then24.i.i212
  %used_for_reference28.i.i = getelementptr inbounds %struct.storable_picture, ptr %416, i64 0, i32 15
  %417 = load i32, ptr %used_for_reference28.i.i, align 4, !tbaa !75
  %tobool29.not.i.i = icmp eq i32 %417, 0
  br i1 %tobool29.not.i.i, label %for.inc.i, label %land.lhs.true30.i.i

land.lhs.true30.i.i:                              ; preds = %if.then26.i.i
  %is_long_term32.i.i = getelementptr inbounds %struct.storable_picture, ptr %416, i64 0, i32 14
  %418 = load i32, ptr %is_long_term32.i.i, align 8, !tbaa !76
  %tobool33.not.i.i = icmp eq i32 %418, 0
...
if.then.i214:                                     ; preds = %land.lhs.true30.i.i, %land.lhs.true13.i.i, %land.lhs.true.i.i
  %419 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  %inc.i = add i32 %j.020.i, 1
  %idxprom3.i = zext i32 %j.020.i to i64
  %arrayidx4.i = getelementptr inbounds ptr, ptr %419, i64 %idxprom3.i
  store ptr %408, ptr %arrayidx4.i, align 8, !tbaa !5
...
for.inc.i:                                        ; preds = %if.then.i214, %land.lhs.true30.i.i, %if.then26.i.i, %if.then24.i.i212, %if.end20.i.i
  %420 = phi ptr [ %.pre.i213, %if.then.i214 ], [ %407, %if.end20.i.i ], [ %407, %if.then24.i.i212 ], [ %407, %if.then26.i.i ], [ %407, %land.lhs.true30.i.i ]
...
for.end.i:                                        ; preds = %for.inc.i, %if.then47
  ...
  %421 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 3), align 8, !tbaa !28
  %cmp621.i = icmp ult i32 %j.0.lcssa.i, %421
  br i1 %cmp621.i, label %while.body.preheader.i, label %update_ref_list.exit

while.body.preheader.i:                           ; preds = %for.end.i
  %422 = zext i32 %j.0.lcssa.i to i64
  %wide.trip.count27.i = zext i32 %421 to i64
  %423 = sub nsw i64 %wide.trip.count27.i, %422
  %424 = xor i64 %422, -1
  %425 = add nsw i64 %424, %wide.trip.count27.i
  %xtraiter802 = and i64 %423, 3
  %lcmp.mod803.not = icmp eq i64 %xtraiter802, 0
  br i1 %lcmp.mod803.not, label %while.body.i217.prol.loopexit, label %while.body.i217.prol

while.body.i217.prol:                             ; preds = %while.body.preheader.i, %while.body.i217.prol
  %indvars.iv24.i.prol = phi i64 [ %indvars.iv.next25.i.prol, %while.body.i217.prol ], [ %422, %while.body.preheader.i ]
  %prol.iter804 = phi i64 [ %prol.iter804.next, %while.body.i217.prol ], [ 0, %while.body.preheader.i ]
  ...
  %arrayidx9.i.prol = getelementptr inbounds ptr, ptr %426, i64 %indvars.iv24.i.prol
  ...
  br i1 %prol.iter804.cmp.not, label %while.body.i217.prol.loopexit, label %while.body.i217.prol, !llvm.loop !192

while.body.i217.prol.loopexit:                    ; preds = %while.body.i217.prol, %while.body.preheader.i
  %indvars.iv24.i.unr = phi i64 [ %422, %while.body.preheader.i ], [ %indvars.iv.next25.i.prol, %while.body.i217.prol ]
  %427 = icmp ult i64 %425, 3
  br i1 %427, label %update_ref_list.exit, label %while.body.i217
...
while.body.i217:                                  ; preds = %while.body.i217.prol.loopexit, %while.body.i217
  ...
  %arrayidx9.i = getelementptr inbounds ptr, ptr %428, i64 %indvars.iv24.i
  ...
  %arrayidx9.i.1 = getelementptr inbounds ptr, ptr %429, i64 %indvars.iv.next25.i
  store ptr null, ptr %arrayidx9.i.1, align 8, !tbaa !5
  %430 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  %indvars.iv.next25.i.2 = add nuw nsw i64 %indvars.iv24.i, 3
  %arrayidx9.i.2 = getelementptr inbounds ptr, ptr %430, i64 %indvars.iv.next25.i.1
  store ptr null, ptr %arrayidx9.i.2, align 8, !tbaa !5
  %431 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  %indvars.iv.next25.i.3 = add nuw nsw i64 %indvars.iv24.i, 4
  %arrayidx9.i.3 = getelementptr inbounds ptr, ptr %431, i64 %indvars.iv.next25.i.2
...
for.body.preheader.i222:                          ; preds = %update_ref_list.exit
  %wide.trip.count.i220 = zext i32 %406 to i64
...
for.body.i227:                                    ; preds = %for.inc.i267, %for.body.preheader.i222
  %432 = phi ptr [ %.pre29.i221, %for.body.preheader.i222 ], [ %445, %for.inc.i267 ]
  ...
  %arrayidx.i225 = getelementptr inbounds ptr, ptr %432, i64 %indvars.iv.i223
  %433 = load ptr, ptr %arrayidx.i225, align 8, !tbaa !5
  %434 = load i32, ptr %433, align 8, !tbaa !77
  %cmp.i.i226 = icmp eq i32 %434, 3
  br i1 %cmp.i.i226, label %if.then.i.i231, label %if.end4.i.i237

if.then.i.i231:                                   ; preds = %for.body.i227
  %frame.i.i228 = getelementptr inbounds %struct.frame_store, ptr %433, i64 0, i32 10
  %435 = load ptr, ptr %frame.i.i228, align 8, !tbaa !42
  %used_for_reference.i.i229 = getelementptr inbounds %struct.storable_picture, ptr %435, i64 0, i32 15
  %436 = load i32, ptr %used_for_reference.i.i229, align 4, !tbaa !75
  %tobool.not.i.i230 = icmp eq i32 %436, 0
  br i1 %tobool.not.i.i230, label %if.then7.i.i240, label %land.lhs.true.i.i234

land.lhs.true.i.i234:                             ; preds = %if.then.i.i231
  %is_long_term.i.i232 = getelementptr inbounds %struct.storable_picture, ptr %435, i64 0, i32 14
  %437 = load i32, ptr %is_long_term.i.i232, align 8, !tbaa !76
  %tobool2.not.i.i233 = icmp eq i32 %437, 0
  br i1 %tobool2.not.i.i233, label %if.then7.i.i240, label %if.then.i263

if.end4.i.i237:                                   ; preds = %for.body.i227
  %and.i.i235 = and i32 %434, 1
...
if.then7.i.i240:                                  ; preds = %if.end4.i.i237, %land.lhs.true.i.i234, %if.then.i.i231
  %top_field.i.i238 = getelementptr inbounds %struct.frame_store, ptr %433, i64 0, i32 11
  %438 = load ptr, ptr %top_field.i.i238, align 8, !tbaa !44
  %tobool8.not.i.i239 = icmp eq ptr %438, null
  br i1 %tobool8.not.i.i239, label %if.end20.i.i249, label %if.then9.i.i243

if.then9.i.i243:                                  ; preds = %if.then7.i.i240
  %used_for_reference11.i.i241 = getelementptr inbounds %struct.storable_picture, ptr %438, i64 0, i32 15
  %439 = load i32, ptr %used_for_reference11.i.i241, align 4, !tbaa !75
  %tobool12.not.i.i242 = icmp eq i32 %439, 0
  br i1 %tobool12.not.i.i242, label %if.end20.i.i249, label %land.lhs.true13.i.i246

land.lhs.true13.i.i246:                           ; preds = %if.then9.i.i243
  %is_long_term15.i.i244 = getelementptr inbounds %struct.storable_picture, ptr %438, i64 0, i32 14
  %440 = load i32, ptr %is_long_term15.i.i244, align 8, !tbaa !76
  %tobool16.not.i.i245 = icmp eq i32 %440, 0
...
if.then24.i.i252:                                 ; preds = %if.end20.i.i249
  %bottom_field.i.i250 = getelementptr inbounds %struct.frame_store, ptr %433, i64 0, i32 12
  %441 = load ptr, ptr %bottom_field.i.i250, align 8, !tbaa !45
  %tobool25.not.i.i251 = icmp eq ptr %441, null
  br i1 %tobool25.not.i.i251, label %for.inc.i267, label %if.then26.i.i255

if.then26.i.i255:                                 ; preds = %if.then24.i.i252
  %used_for_reference28.i.i253 = getelementptr inbounds %struct.storable_picture, ptr %441, i64 0, i32 15
  %442 = load i32, ptr %used_for_reference28.i.i253, align 4, !tbaa !75
  %tobool29.not.i.i254 = icmp eq i32 %442, 0
  br i1 %tobool29.not.i.i254, label %for.inc.i267, label %land.lhs.true30.i.i258

land.lhs.true30.i.i258:                           ; preds = %if.then26.i.i255
  %is_long_term32.i.i256 = getelementptr inbounds %struct.storable_picture, ptr %441, i64 0, i32 14
  %443 = load i32, ptr %is_long_term32.i.i256, align 8, !tbaa !76
  %tobool33.not.i.i257 = icmp eq i32 %443, 0
...
if.then.i263:                                     ; preds = %land.lhs.true30.i.i258, %land.lhs.true13.i.i246, %land.lhs.true.i.i234
  %444 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 2), align 8, !tbaa !35
  %inc.i259 = add i32 %j.020.i224, 1
  %idxprom3.i260 = zext i32 %j.020.i224 to i64
  %arrayidx4.i261 = getelementptr inbounds ptr, ptr %444, i64 %idxprom3.i260
  store ptr %433, ptr %arrayidx4.i261, align 8, !tbaa !5
...
for.inc.i267:                                     ; preds = %if.then.i263, %land.lhs.true30.i.i258, %if.then26.i.i255, %if.then24.i.i252, %if.end20.i.i249
  %445 = phi ptr [ %.pre.i262, %if.then.i263 ], [ %432, %if.end20.i.i249 ], [ %432, %if.then24.i.i252 ], [ %432, %if.then26.i.i255 ], [ %432, %land.lhs.true30.i.i258 ]
...
for.end.i270:                                     ; preds = %for.inc.i267, %update_ref_list.exit
  ...
  %cmp621.i269 = icmp ult i32 %j.0.lcssa.i268, %421
...
while.body.preheader.i272:                        ; preds = %for.end.i270
  %446 = zext i32 %j.0.lcssa.i268 to i64
  %wide.trip.count27.i271 = zext i32 %421 to i64
  %447 = sub nsw i64 %wide.trip.count27.i271, %446
  %448 = xor i64 %446, -1
  %449 = add nsw i64 %448, %wide.trip.count27.i271
  %xtraiter805 = and i64 %447, 3
  %lcmp.mod806.not = icmp eq i64 %xtraiter805, 0
  br i1 %lcmp.mod806.not, label %while.body.i277.prol.loopexit, label %while.body.i277.prol

while.body.i277.prol:                             ; preds = %while.body.preheader.i272, %while.body.i277.prol
  %indvars.iv24.i273.prol = phi i64 [ %indvars.iv.next25.i274.prol, %while.body.i277.prol ], [ %446, %while.body.preheader.i272 ]
  %prol.iter807 = phi i64 [ %prol.iter807.next, %while.body.i277.prol ], [ 0, %while.body.preheader.i272 ]
  ...
  %arrayidx9.i275.prol = getelementptr inbounds ptr, ptr %450, i64 %indvars.iv24.i273.prol
  ...
  br i1 %prol.iter807.cmp.not, label %while.body.i277.prol.loopexit, label %while.body.i277.prol, !llvm.loop !193

while.body.i277.prol.loopexit:                    ; preds = %while.body.i277.prol, %while.body.preheader.i272
  %indvars.iv24.i273.unr = phi i64 [ %446, %while.body.preheader.i272 ], [ %indvars.iv.next25.i274.prol, %while.body.i277.prol ]
  %451 = icmp ult i64 %449, 3
  br i1 %451, label %update_ltref_list.exit, label %while.body.i277
...
while.body.i277:                                  ; preds = %while.body.i277.prol.loopexit, %while.body.i277
  ...
  %arrayidx9.i275 = getelementptr inbounds ptr, ptr %452, i64 %indvars.iv24.i273
  ...
  %arrayidx9.i275.1 = getelementptr inbounds ptr, ptr %453, i64 %indvars.iv.next25.i274
  store ptr null, ptr %arrayidx9.i275.1, align 8, !tbaa !5
  %454 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 2), align 8, !tbaa !35
  %indvars.iv.next25.i274.2 = add nuw nsw i64 %indvars.iv24.i273, 3
  %arrayidx9.i275.2 = getelementptr inbounds ptr, ptr %454, i64 %indvars.iv.next25.i274.1
  store ptr null, ptr %arrayidx9.i275.2, align 8, !tbaa !5
  %455 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 2), align 8, !tbaa !35
  %indvars.iv.next25.i274.3 = add nuw nsw i64 %indvars.iv24.i273, 4
  %arrayidx9.i275.3 = getelementptr inbounds ptr, ptr %455, i64 %indvars.iv.next25.i274.2
...
if.end52:                                         ; preds = %land.lhs.true23, %land.lhs.true37, %if.then16.thread, %if.then14, %land.lhs.true30, %land.lhs.true43, %if.then16, %lor.lhs.false
  ...
  %currentPicture53 = getelementptr inbounds %struct.ImageParameters, ptr %456, i64 0, i32 59
  %457 = load ptr, ptr %currentPicture53, align 8, !tbaa !151
  %idr_flag54 = getelementptr inbounds %struct.Picture, ptr %457, i64 0, i32 1
  %458 = load i32, ptr %idr_flag54, align 4, !tbaa !152
  %tobool55.not = icmp eq i32 %458, 0
  br i1 %tobool55.not, label %land.lhs.true56, label %if.end63

land.lhs.true56:                                  ; preds = %if.end52
  %459 = load i32, ptr %used_for_reference, align 4, !tbaa !75
  %tobool58.not = icmp eq i32 %459, 0
  br i1 %tobool58.not, label %if.end63, label %land.lhs.true59

land.lhs.true59:                                  ; preds = %land.lhs.true56
  %adaptive_ref_pic_buffering_flag60 = getelementptr inbounds %struct.ImageParameters, ptr %456, i64 0, i32 123
  %460 = load i32, ptr %adaptive_ref_pic_buffering_flag60, align 4, !tbaa !163
  %tobool61.not = icmp eq i32 %460, 0
  br i1 %tobool61.not, label %if.then62, label %if.end63

if.then62:                                        ; preds = %land.lhs.true59
  %461 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 5), align 8, !tbaa !21
  %462 = load ptr, ptr @active_sps, align 8, !tbaa !5
  %num_ref_frames.i = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %462, i64 0, i32 21
  %463 = load i32, ptr %num_ref_frames.i, align 4, !tbaa !194
  %464 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 6), align 4, !tbaa !19
  %sub.i279 = sub i32 %463, %464
  %cmp.i280 = icmp eq i32 %461, %sub.i279
...
for.cond.preheader.i281:                          ; preds = %if.then62
  ...
  %cmp115.not.i = icmp eq i32 %465, 0
...
for.body.lr.ph.i:                                 ; preds = %for.cond.preheader.i281
  %466 = load ptr, ptr @dpb, align 8, !tbaa !33
  %wide.trip.count.i282 = zext i32 %465 to i64
...
for.body.i286:                                    ; preds = %for.inc.i348, %for.body.lr.ph.i
  ...
  %arrayidx.i284 = getelementptr inbounds ptr, ptr %466, i64 %indvars.iv.i283
  %467 = load ptr, ptr %arrayidx.i284, align 8, !tbaa !5
  %is_reference.i = getelementptr inbounds %struct.frame_store, ptr %467, i64 0, i32 1
  %468 = load i32, ptr %is_reference.i, align 4, !tbaa !85
  %tobool.not.i285 = icmp eq i32 %468, 0
  br i1 %tobool.not.i285, label %for.inc.i348, label %land.lhs.true.i

land.lhs.true.i:                                  ; preds = %for.body.i286
  %is_long_term.i = getelementptr inbounds %struct.frame_store, ptr %467, i64 0, i32 2
  %469 = load i32, ptr %is_long_term.i, align 8, !tbaa !87
  %tobool4.not.i = icmp eq i32 %469, 0
  br i1 %tobool4.not.i, label %if.then5.i, label %for.inc.i348

if.then5.i:                                       ; preds = %land.lhs.true.i
  tail call fastcc void @unmark_for_reference(ptr noundef nonnull %467)
  %470 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 4), align 4, !tbaa !31
  %cmp18.not.i.i287 = icmp eq i32 %470, 0
  br i1 %cmp18.not.i.i287, label %for.end.i.i338, label %for.body.preheader.i.i290

for.body.preheader.i.i290:                        ; preds = %if.then5.i
  %wide.trip.count.i.i288 = zext i32 %470 to i64
...
for.body.i.i295:                                  ; preds = %for.inc.i.i335, %for.body.preheader.i.i290
  %471 = phi ptr [ %.pre29.i.i289, %for.body.preheader.i.i290 ], [ %484, %for.inc.i.i335 ]
  ...
  %arrayidx.i.i293 = getelementptr inbounds ptr, ptr %471, i64 %indvars.iv.i.i291
  %472 = load ptr, ptr %arrayidx.i.i293, align 8, !tbaa !5
  %473 = load i32, ptr %472, align 8, !tbaa !77
  %cmp.i.i.i294 = icmp eq i32 %473, 3
  br i1 %cmp.i.i.i294, label %if.then.i.i.i299, label %if.end4.i.i.i305

if.then.i.i.i299:                                 ; preds = %for.body.i.i295
  %frame.i.i.i296 = getelementptr inbounds %struct.frame_store, ptr %472, i64 0, i32 10
  %474 = load ptr, ptr %frame.i.i.i296, align 8, !tbaa !42
  %used_for_reference.i.i.i297 = getelementptr inbounds %struct.storable_picture, ptr %474, i64 0, i32 15
  %475 = load i32, ptr %used_for_reference.i.i.i297, align 4, !tbaa !75
  %tobool.not.i.i.i298 = icmp eq i32 %475, 0
...
land.lhs.true.i.i.i302:                           ; preds = %if.then.i.i.i299
  %is_long_term.i.i.i300 = getelementptr inbounds %struct.storable_picture, ptr %474, i64 0, i32 14
  %476 = load i32, ptr %is_long_term.i.i.i300, align 8, !tbaa !76
  %tobool2.not.i.i.i301 = icmp eq i32 %476, 0
  br i1 %tobool2.not.i.i.i301, label %if.then.i.i331, label %if.then7.i.i.i308

if.end4.i.i.i305:                                 ; preds = %for.body.i.i295
  %and.i.i.i303 = and i32 %473, 1
...
if.then7.i.i.i308:                                ; preds = %if.end4.i.i.i305, %land.lhs.true.i.i.i302, %if.then.i.i.i299
  %top_field.i.i.i306 = getelementptr inbounds %struct.frame_store, ptr %472, i64 0, i32 11
  %477 = load ptr, ptr %top_field.i.i.i306, align 8, !tbaa !44
  %tobool8.not.i.i.i307 = icmp eq ptr %477, null
  br i1 %tobool8.not.i.i.i307, label %if.end20.i.i.i317, label %if.then9.i.i.i311

if.then9.i.i.i311:                                ; preds = %if.then7.i.i.i308
  %used_for_reference11.i.i.i309 = getelementptr inbounds %struct.storable_picture, ptr %477, i64 0, i32 15
  %478 = load i32, ptr %used_for_reference11.i.i.i309, align 4, !tbaa !75
  %tobool12.not.i.i.i310 = icmp eq i32 %478, 0
...
land.lhs.true13.i.i.i314:                         ; preds = %if.then9.i.i.i311
  %is_long_term15.i.i.i312 = getelementptr inbounds %struct.storable_picture, ptr %477, i64 0, i32 14
  %479 = load i32, ptr %is_long_term15.i.i.i312, align 8, !tbaa !76
  %tobool16.not.i.i.i313 = icmp eq i32 %479, 0
...
if.then24.i.i.i320:                               ; preds = %if.end20.i.i.i317
  %bottom_field.i.i.i318 = getelementptr inbounds %struct.frame_store, ptr %472, i64 0, i32 12
  %480 = load ptr, ptr %bottom_field.i.i.i318, align 8, !tbaa !45
  %tobool25.not.i.i.i319 = icmp eq ptr %480, null
  br i1 %tobool25.not.i.i.i319, label %for.inc.i.i335, label %if.then26.i.i.i323

if.then26.i.i.i323:                               ; preds = %if.then24.i.i.i320
  %used_for_reference28.i.i.i321 = getelementptr inbounds %struct.storable_picture, ptr %480, i64 0, i32 15
  %481 = load i32, ptr %used_for_reference28.i.i.i321, align 4, !tbaa !75
  %tobool29.not.i.i.i322 = icmp eq i32 %481, 0
...
land.lhs.true30.i.i.i326:                         ; preds = %if.then26.i.i.i323
  %is_long_term32.i.i.i324 = getelementptr inbounds %struct.storable_picture, ptr %480, i64 0, i32 14
  %482 = load i32, ptr %is_long_term32.i.i.i324, align 8, !tbaa !76
  %tobool33.not.i.i.i325 = icmp eq i32 %482, 0
...
if.then.i.i331:                                   ; preds = %land.lhs.true30.i.i.i326, %land.lhs.true13.i.i.i314, %land.lhs.true.i.i.i302
  %483 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  %inc.i.i327 = add i32 %j.020.i.i292, 1
  %idxprom3.i.i328 = zext i32 %j.020.i.i292 to i64
  %arrayidx4.i.i329 = getelementptr inbounds ptr, ptr %483, i64 %idxprom3.i.i328
  store ptr %472, ptr %arrayidx4.i.i329, align 8, !tbaa !5
...
for.inc.i.i335:                                   ; preds = %if.then.i.i331, %land.lhs.true30.i.i.i326, %if.then26.i.i.i323, %if.then24.i.i.i320, %if.end20.i.i.i317
  %484 = phi ptr [ %.pre.i.i330, %if.then.i.i331 ], [ %471, %if.end20.i.i.i317 ], [ %471, %if.then24.i.i.i320 ], [ %471, %if.then26.i.i.i323 ], [ %471, %land.lhs.true30.i.i.i326 ]
...
for.end.i.i338:                                   ; preds = %for.inc.i.i335, %if.then5.i
  ...
  %485 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 3), align 8, !tbaa !28
  %cmp621.i.i337 = icmp ult i32 %j.0.lcssa.i.i336, %485
...
while.body.preheader.i.i340:                      ; preds = %for.end.i.i338
  %486 = zext i32 %j.0.lcssa.i.i336 to i64
  %wide.trip.count27.i.i339 = zext i32 %485 to i64
  %487 = sub nsw i64 %wide.trip.count27.i.i339, %486
  %488 = xor i64 %486, -1
  %489 = add nsw i64 %488, %wide.trip.count27.i.i339
  %xtraiter808 = and i64 %487, 3
  %lcmp.mod809.not = icmp eq i64 %xtraiter808, 0
  br i1 %lcmp.mod809.not, label %while.body.i.i345.prol.loopexit, label %while.body.i.i345.prol

while.body.i.i345.prol:                           ; preds = %while.body.preheader.i.i340, %while.body.i.i345.prol
  %indvars.iv24.i.i341.prol = phi i64 [ %indvars.iv.next25.i.i342.prol, %while.body.i.i345.prol ], [ %486, %while.body.preheader.i.i340 ]
  %prol.iter810 = phi i64 [ %prol.iter810.next, %while.body.i.i345.prol ], [ 0, %while.body.preheader.i.i340 ]
  ...
  %arrayidx9.i.i343.prol = getelementptr inbounds ptr, ptr %490, i64 %indvars.iv24.i.i341.prol
  ...
  br i1 %prol.iter810.cmp.not, label %while.body.i.i345.prol.loopexit, label %while.body.i.i345.prol, !llvm.loop !195

while.body.i.i345.prol.loopexit:                  ; preds = %while.body.i.i345.prol, %while.body.preheader.i.i340
  %indvars.iv24.i.i341.unr = phi i64 [ %486, %while.body.preheader.i.i340 ], [ %indvars.iv.next25.i.i342.prol, %while.body.i.i345.prol ]
  %491 = icmp ult i64 %489, 3
  br i1 %491, label %sliding_window_memory_management.exit, label %while.body.i.i345
...
while.body.i.i345:                                ; preds = %while.body.i.i345.prol.loopexit, %while.body.i.i345
  ...
  %arrayidx9.i.i343 = getelementptr inbounds ptr, ptr %492, i64 %indvars.iv24.i.i341
  ...
  %arrayidx9.i.i343.1 = getelementptr inbounds ptr, ptr %493, i64 %indvars.iv.next25.i.i342
  store ptr null, ptr %arrayidx9.i.i343.1, align 8, !tbaa !5
  %494 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  %indvars.iv.next25.i.i342.2 = add nuw nsw i64 %indvars.iv24.i.i341, 3
  %arrayidx9.i.i343.2 = getelementptr inbounds ptr, ptr %494, i64 %indvars.iv.next25.i.i342.1
  store ptr null, ptr %arrayidx9.i.i343.2, align 8, !tbaa !5
  %495 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  %indvars.iv.next25.i.i342.3 = add nuw nsw i64 %indvars.iv24.i.i341, 4
  %arrayidx9.i.i343.3 = getelementptr inbounds ptr, ptr %495, i64 %indvars.iv.next25.i.i342.2
...
if.end63:                                         ; preds = %sliding_window_memory_management.exit, %land.lhs.true59, %land.lhs.true56, %if.end52
  %496 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 4), align 4, !tbaa !31
  %497 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 3), align 8, !tbaa !28
  %cmp64 = icmp ne i32 %496, %497
  %cmp11.not.i = icmp eq i32 %496, 0
...
for.body.lr.ph.i350:                              ; preds = %if.end63
  %498 = load ptr, ptr @dpb, align 8, !tbaa !33
  %wide.trip.count.i349 = zext i32 %496 to i64
...
for.body.i354:                                    ; preds = %for.inc.i373, %for.body.lr.ph.i350
  ...
  %arrayidx.i352 = getelementptr inbounds ptr, ptr %498, i64 %indvars.iv.i351
  %499 = load ptr, ptr %arrayidx.i352, align 8, !tbaa !5
  %is_output.i = getelementptr inbounds %struct.frame_store, ptr %499, i64 0, i32 8
  %500 = load i32, ptr %is_output.i, align 8, !tbaa !197
  %tobool.not.i353 = icmp eq i32 %500, 0
  br i1 %tobool.not.i353, label %for.inc.i373, label %land.lhs.true.i357

land.lhs.true.i357:                               ; preds = %for.body.i354
  %is_reference.i.i355 = getelementptr inbounds %struct.frame_store, ptr %499, i64 0, i32 1
  %501 = load i32, ptr %is_reference.i.i355, align 4, !tbaa !85
  %tobool.not.i.i356 = icmp eq i32 %501, 0
  br i1 %tobool.not.i.i356, label %if.end.i.i359, label %for.inc.i373

if.end.i.i359:                                    ; preds = %land.lhs.true.i357
  %502 = load i32, ptr %499, align 8, !tbaa !77
  %cmp.i.i358 = icmp eq i32 %502, 3
  br i1 %cmp.i.i358, label %if.then1.i.i, label %if.end5.i.i

if.then1.i.i:                                     ; preds = %if.end.i.i359
  %frame.i.i360 = getelementptr inbounds %struct.frame_store, ptr %499, i64 0, i32 10
  %503 = load ptr, ptr %frame.i.i360, align 8, !tbaa !42
  %used_for_reference.i.i361 = getelementptr inbounds %struct.storable_picture, ptr %503, i64 0, i32 15
  %504 = load i32, ptr %used_for_reference.i.i361, align 4, !tbaa !75
  %tobool2.not.i.i362 = icmp eq i32 %504, 0
  br i1 %tobool2.not.i.i362, label %if.then8.i.i, label %for.inc.i373

if.end5.i.i:                                      ; preds = %if.end.i.i359
  %and.i.i363 = and i32 %502, 1
...
if.then8.i.i:                                     ; preds = %if.end5.i.i, %if.then1.i.i
  %top_field.i.i364 = getelementptr inbounds %struct.frame_store, ptr %499, i64 0, i32 11
  %505 = load ptr, ptr %top_field.i.i364, align 8, !tbaa !44
  %tobool9.not.i.i = icmp eq ptr %505, null
  br i1 %tobool9.not.i.i, label %if.end17.i.i, label %if.then10.i.i366

if.then10.i.i366:                                 ; preds = %if.then8.i.i
  %used_for_reference12.i.i = getelementptr inbounds %struct.storable_picture, ptr %505, i64 0, i32 15
  %506 = load i32, ptr %used_for_reference12.i.i, align 4, !tbaa !75
  %tobool13.not.i.i365 = icmp eq i32 %506, 0
...
if.then21.i.i:                                    ; preds = %if.end17.i.i
  %bottom_field.i.i367 = getelementptr inbounds %struct.frame_store, ptr %499, i64 0, i32 12
  %507 = load ptr, ptr %bottom_field.i.i367, align 8, !tbaa !45
  %tobool22.not.i.i368 = icmp eq ptr %507, null
  br i1 %tobool22.not.i.i368, label %if.then.i370, label %if.then23.i.i369

if.then23.i.i369:                                 ; preds = %if.then21.i.i
  %used_for_reference25.i.i = getelementptr inbounds %struct.storable_picture, ptr %507, i64 0, i32 15
  %508 = load i32, ptr %used_for_reference25.i.i, align 4, !tbaa !75
  %tobool26.not.i.i = icmp eq i32 %508, 0
...
if.then.i370:                                     ; preds = %if.then23.i.i369, %if.then21.i.i, %if.end17.i.i
  %509 = trunc i64 %indvars.iv.i351 to i32
  tail call fastcc void @remove_frame_from_dpb(i32 noundef %509)
  %.pre = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 4), align 4, !tbaa !31
  %.pre626 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 3), align 8, !tbaa !28
  br label %if.end67
...
if.end67:                                         ; preds = %if.then.i370, %if.end63
  %510 = phi i32 [ %.pre626, %if.then.i370 ], [ %497, %if.end63 ]
  %511 = phi i32 [ %.pre, %if.then.i370 ], [ %496, %if.end63 ]
  %cmp68579 = icmp eq i32 %511, %510
  br i1 %cmp68579, label %while.body.lr.ph, label %while.end

while.body.lr.ph:                                 ; preds = %for.inc.i373, %if.end67
  %512 = phi i32 [ %510, %if.end67 ], [ %496, %for.inc.i373 ]
  %poc76 = getelementptr inbounds %struct.storable_picture, ptr %p, i64 0, i32 1
  br label %while.body

while.body:                                       ; preds = %while.body.lr.ph, %if.end81
  %513 = phi i32 [ %512, %while.body.lr.ph ], [ %533, %if.end81 ]
  %514 = load i32, ptr %used_for_reference, align 4, !tbaa !75
  %tobool71.not = icmp eq i32 %514, 0
  br i1 %tobool71.not, label %if.then72, label %if.end81

if.then72:                                        ; preds = %while.body
  %cmp.i374 = icmp eq i32 %513, 0
...
if.end.i376:                                      ; preds = %if.then72
  ...
  %.pre627 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 4), align 4, !tbaa !31
  %cmp119.not.i = icmp eq i32 %.pre627, 0
  br i1 %cmp119.not.i, label %if.then79, label %for.body.lr.ph.i377

for.body.lr.ph.i377:                              ; preds = %if.then72, %if.end.i376
  %515 = phi i32 [ %.pre627, %if.end.i376 ], [ %513, %if.then72 ]
  %516 = load ptr, ptr @dpb, align 8, !tbaa !33
  %517 = zext i32 %515 to i64
  %xtraiter811 = and i64 %517, 1
  %518 = icmp eq i32 %515, 1
  br i1 %518, label %get_smallest_poc.exit.unr-lcssa, label %for.body.lr.ph.i377.new

for.body.lr.ph.i377.new:                          ; preds = %for.body.lr.ph.i377
  %unroll_iter816 = and i64 %517, 4294967294
...
for.body.i380:                                    ; preds = %for.inc.i386.1, %for.body.lr.ph.i377.new
  ...
  %niter817 = phi i64 [ 0, %for.body.lr.ph.i377.new ], [ %niter817.next.1, %for.inc.i386.1 ]
  %arrayidx.i379 = getelementptr inbounds ptr, ptr %516, i64 %indvars.iv.i378
  %519 = load ptr, ptr %arrayidx.i379, align 8, !tbaa !5
  %poc2.i = getelementptr inbounds %struct.frame_store, ptr %519, i64 0, i32 9
  %520 = load i32, ptr %poc2.i, align 4, !tbaa !112
  %cmp3.i = icmp sgt i32 %poc.0, %520
  br i1 %cmp3.i, label %land.lhs.true.i383, label %for.inc.i386

land.lhs.true.i383:                               ; preds = %for.body.i380
  %is_output.i381 = getelementptr inbounds %struct.frame_store, ptr %519, i64 0, i32 8
  %521 = load i32, ptr %is_output.i381, align 8, !tbaa !197
  %tobool.not.i382 = icmp eq i32 %521, 0
  %522 = trunc i64 %indvars.iv.i378 to i32
  %spec.select = select i1 %tobool.not.i382, i32 %520, i32 %poc.0
  %spec.select524 = select i1 %tobool.not.i382, i32 %522, i32 %pos.0
...
for.inc.i386:                                     ; preds = %land.lhs.true.i383, %for.body.i380
  ...
  %arrayidx.i379.1 = getelementptr inbounds ptr, ptr %516, i64 %indvars.iv.next.i385
  %523 = load ptr, ptr %arrayidx.i379.1, align 8, !tbaa !5
  %poc2.i.1 = getelementptr inbounds %struct.frame_store, ptr %523, i64 0, i32 9
  %524 = load i32, ptr %poc2.i.1, align 4, !tbaa !112
  %cmp3.i.1 = icmp sgt i32 %poc.1, %524
  br i1 %cmp3.i.1, label %land.lhs.true.i383.1, label %for.inc.i386.1

land.lhs.true.i383.1:                             ; preds = %for.inc.i386
  %is_output.i381.1 = getelementptr inbounds %struct.frame_store, ptr %523, i64 0, i32 8
  %525 = load i32, ptr %is_output.i381.1, align 8, !tbaa !197
  %tobool.not.i382.1 = icmp eq i32 %525, 0
  %526 = trunc i64 %indvars.iv.next.i385 to i32
  %spec.select.1 = select i1 %tobool.not.i382.1, i32 %524, i32 %poc.1
  %spec.select524.1 = select i1 %tobool.not.i382.1, i32 %526, i32 %pos.1
...
for.inc.i386.1:                                   ; preds = %land.lhs.true.i383.1, %for.inc.i386
  ...
  %niter817.next.1 = add i64 %niter817, 2
  %niter817.ncmp.1 = icmp eq i64 %niter817.next.1, %unroll_iter816
  br i1 %niter817.ncmp.1, label %get_smallest_poc.exit.unr-lcssa, label %for.body.i380, !llvm.loop !199
...
get_smallest_poc.exit.unr-lcssa:                  ; preds = %for.inc.i386.1, %for.body.lr.ph.i377
  ...
  %lcmp.mod813.not = icmp eq i64 %xtraiter811, 0
  br i1 %lcmp.mod813.not, label %get_smallest_poc.exit, label %for.body.i380.epil

for.body.i380.epil:                               ; preds = %get_smallest_poc.exit.unr-lcssa
  %arrayidx.i379.epil = getelementptr inbounds ptr, ptr %516, i64 %indvars.iv.i378.unr
  %527 = load ptr, ptr %arrayidx.i379.epil, align 8, !tbaa !5
  %poc2.i.epil = getelementptr inbounds %struct.frame_store, ptr %527, i64 0, i32 9
  %528 = load i32, ptr %poc2.i.epil, align 4, !tbaa !112
  %cmp3.i.epil = icmp sgt i32 %poc.0.unr, %528
...
land.lhs.true.i383.epil:                          ; preds = %for.body.i380.epil
  %is_output.i381.epil = getelementptr inbounds %struct.frame_store, ptr %527, i64 0, i32 8
  %529 = load i32, ptr %is_output.i381.epil, align 8, !tbaa !197
  %tobool.not.i382.epil = icmp eq i32 %529, 0
  %530 = trunc i64 %indvars.iv.i378.unr to i32
  %spec.select.epil = select i1 %tobool.not.i382.epil, i32 %528, i32 %poc.0.unr
  %spec.select524.epil = select i1 %tobool.not.i382.epil, i32 %530, i32 %pos.0.unr
...
lor.lhs.false75:                                  ; preds = %get_smallest_poc.exit
  %531 = load i32, ptr %poc76, align 4, !tbaa !105
  %cmp77 = icmp slt i32 %531, %poc.1.lcssa
  br i1 %cmp77, label %if.then79, label %if.end81

if.then79:                                        ; preds = %if.end.i376, %lor.lhs.false75, %get_smallest_poc.exit
  %532 = load i32, ptr @p_dec, align 4, !tbaa !38
  tail call void @direct_output(ptr noundef nonnull %p, i32 noundef %532) #15
  br label %cleanup

if.end81:                                         ; preds = %lor.lhs.false75, %while.body
  tail call fastcc void @output_one_frame_from_dpb()
  %533 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 4), align 4, !tbaa !31
  %534 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 3), align 8, !tbaa !28
  %cmp68 = icmp eq i32 %533, %534
  br i1 %cmp68, label %while.body, label %while.end, !llvm.loop !200

while.end:                                        ; preds = %if.end81, %if.end67
  %535 = phi i32 [ %511, %if.end67 ], [ %533, %if.end81 ]
  %536 = load i32, ptr %used_for_reference, align 4, !tbaa !75
  %tobool83.not = icmp eq i32 %536, 0
...
land.lhs.true84:                                  ; preds = %while.end
  ...
  %537 = load i32, ptr %is_long_term, align 8, !tbaa !76
  %tobool85.not = icmp eq i32 %537, 0
  %538 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 5), align 8
  %cmp87580 = icmp ne i32 %538, 0
  %or.cond583 = select i1 %tobool85.not, i1 %cmp87580, i1 false
  br i1 %or.cond583, label %for.body.lr.ph, label %if.end95

for.body.lr.ph:                                   ; preds = %land.lhs.true84
  %frame_num90 = getelementptr inbounds %struct.storable_picture, ptr %p, i64 0, i32 10
  %.pre629 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  br label %for.body

for.body:                                         ; preds = %for.body.lr.ph, %for.inc
  %539 = phi i32 [ %538, %for.body.lr.ph ], [ %544, %for.inc ]
  %540 = phi ptr [ %.pre629, %for.body.lr.ph ], [ %545, %for.inc ]
  %indvars.iv = phi i64 [ 0, %for.body.lr.ph ], [ %indvars.iv.next, %for.inc ]
  %arrayidx = getelementptr inbounds ptr, ptr %540, i64 %indvars.iv
  %541 = load ptr, ptr %arrayidx, align 8, !tbaa !5
  %frame_num89 = getelementptr inbounds %struct.frame_store, ptr %541, i64 0, i32 5
  %542 = load i32, ptr %frame_num89, align 4, !tbaa !78
  %543 = load i32, ptr %frame_num90, align 8, !tbaa !169
  %cmp91 = icmp eq i32 %542, %543
...
if.then93:                                        ; preds = %for.body
  ...
  %.pre628 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  %.pre630 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 5), align 8, !tbaa !21
  br label %for.inc

for.inc:                                          ; preds = %for.body, %if.then93
  %544 = phi i32 [ %539, %for.body ], [ %.pre630, %if.then93 ]
  %545 = phi ptr [ %540, %for.body ], [ %.pre628, %if.then93 ]
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %546 = zext i32 %544 to i64
  %cmp87 = icmp ult i64 %indvars.iv.next, %546
...
if.end95:                                         ; preds = %if.end95.loopexit, %land.lhs.true84, %while.end
  %547 = phi i32 [ %.pre631, %if.end95.loopexit ], [ %535, %land.lhs.true84 ], [ %535, %while.end ]
  %548 = load ptr, ptr @dpb, align 8, !tbaa !33
  %idxprom96 = zext i32 %547 to i64
  %arrayidx97 = getelementptr inbounds ptr, ptr %548, i64 %idxprom96
  %549 = load ptr, ptr %arrayidx97, align 8, !tbaa !5
  tail call fastcc void @insert_picture_in_dpb(ptr noundef %549, ptr noundef nonnull %p)
  %550 = load i32, ptr %p, align 8, !tbaa !51
  %cmp99.not = icmp eq i32 %550, 0
  br i1 %cmp99.not, label %if.end95.if.end105_crit_edge, label %if.then101

if.end95.if.end105_crit_edge:                     ; preds = %if.end95
  %.pre632 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 4), align 4, !tbaa !31
  br label %if.end105

if.then101:                                       ; preds = %if.end95
  %551 = load ptr, ptr @dpb, align 8, !tbaa !33
  %552 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 4), align 4, !tbaa !31
  %idxprom102 = zext i32 %552 to i64
  %arrayidx103 = getelementptr inbounds ptr, ptr %551, i64 %idxprom102
  %553 = load ptr, ptr %arrayidx103, align 8, !tbaa !5
  br label %if.end105

if.end105:                                        ; preds = %if.end95.if.end105_crit_edge, %if.then101
  %554 = phi i32 [ %552, %if.then101 ], [ %.pre632, %if.end95.if.end105_crit_edge ]
  %storemerge = phi ptr [ %553, %if.then101 ], [ null, %if.end95.if.end105_crit_edge ]
  store ptr %storemerge, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 10), align 8, !tbaa !32
  %inc106 = add i32 %554, 1
...
for.body.i396:                                    ; preds = %for.inc.i436, %for.body.preheader.i391
  %555 = phi ptr [ %.pre29.i390, %for.body.preheader.i391 ], [ %568, %for.inc.i436 ]
  ...
  %arrayidx.i394 = getelementptr inbounds ptr, ptr %555, i64 %indvars.iv.i392
  %556 = load ptr, ptr %arrayidx.i394, align 8, !tbaa !5
  %557 = load i32, ptr %556, align 8, !tbaa !77
  %cmp.i.i395 = icmp eq i32 %557, 3
  br i1 %cmp.i.i395, label %if.then.i.i400, label %if.end4.i.i406

if.then.i.i400:                                   ; preds = %for.body.i396
  %frame.i.i397 = getelementptr inbounds %struct.frame_store, ptr %556, i64 0, i32 10
  %558 = load ptr, ptr %frame.i.i397, align 8, !tbaa !42
  %used_for_reference.i.i398 = getelementptr inbounds %struct.storable_picture, ptr %558, i64 0, i32 15
  %559 = load i32, ptr %used_for_reference.i.i398, align 4, !tbaa !75
  %tobool.not.i.i399 = icmp eq i32 %559, 0
  br i1 %tobool.not.i.i399, label %if.then7.i.i409, label %land.lhs.true.i.i403

land.lhs.true.i.i403:                             ; preds = %if.then.i.i400
  %is_long_term.i.i401 = getelementptr inbounds %struct.storable_picture, ptr %558, i64 0, i32 14
  %560 = load i32, ptr %is_long_term.i.i401, align 8, !tbaa !76
  %tobool2.not.i.i402 = icmp eq i32 %560, 0
  br i1 %tobool2.not.i.i402, label %if.then.i432, label %if.then7.i.i409

if.end4.i.i406:                                   ; preds = %for.body.i396
  %and.i.i404 = and i32 %557, 1
...
if.then7.i.i409:                                  ; preds = %if.end4.i.i406, %land.lhs.true.i.i403, %if.then.i.i400
  %top_field.i.i407 = getelementptr inbounds %struct.frame_store, ptr %556, i64 0, i32 11
  %561 = load ptr, ptr %top_field.i.i407, align 8, !tbaa !44
  %tobool8.not.i.i408 = icmp eq ptr %561, null
  br i1 %tobool8.not.i.i408, label %if.end20.i.i418, label %if.then9.i.i412

if.then9.i.i412:                                  ; preds = %if.then7.i.i409
  %used_for_reference11.i.i410 = getelementptr inbounds %struct.storable_picture, ptr %561, i64 0, i32 15
  %562 = load i32, ptr %used_for_reference11.i.i410, align 4, !tbaa !75
  %tobool12.not.i.i411 = icmp eq i32 %562, 0
  br i1 %tobool12.not.i.i411, label %if.end20.i.i418, label %land.lhs.true13.i.i415

land.lhs.true13.i.i415:                           ; preds = %if.then9.i.i412
  %is_long_term15.i.i413 = getelementptr inbounds %struct.storable_picture, ptr %561, i64 0, i32 14
  %563 = load i32, ptr %is_long_term15.i.i413, align 8, !tbaa !76
  %tobool16.not.i.i414 = icmp eq i32 %563, 0
...
if.then24.i.i421:                                 ; preds = %if.end20.i.i418
  %bottom_field.i.i419 = getelementptr inbounds %struct.frame_store, ptr %556, i64 0, i32 12
  %564 = load ptr, ptr %bottom_field.i.i419, align 8, !tbaa !45
  %tobool25.not.i.i420 = icmp eq ptr %564, null
  br i1 %tobool25.not.i.i420, label %for.inc.i436, label %if.then26.i.i424

if.then26.i.i424:                                 ; preds = %if.then24.i.i421
  %used_for_reference28.i.i422 = getelementptr inbounds %struct.storable_picture, ptr %564, i64 0, i32 15
  %565 = load i32, ptr %used_for_reference28.i.i422, align 4, !tbaa !75
  %tobool29.not.i.i423 = icmp eq i32 %565, 0
  br i1 %tobool29.not.i.i423, label %for.inc.i436, label %land.lhs.true30.i.i427

land.lhs.true30.i.i427:                           ; preds = %if.then26.i.i424
  %is_long_term32.i.i425 = getelementptr inbounds %struct.storable_picture, ptr %564, i64 0, i32 14
  %566 = load i32, ptr %is_long_term32.i.i425, align 8, !tbaa !76
  %tobool33.not.i.i426 = icmp eq i32 %566, 0
...
if.then.i432:                                     ; preds = %land.lhs.true30.i.i427, %land.lhs.true13.i.i415, %land.lhs.true.i.i403
  %567 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  %inc.i428 = add i32 %j.020.i393, 1
  %idxprom3.i429 = zext i32 %j.020.i393 to i64
  %arrayidx4.i430 = getelementptr inbounds ptr, ptr %567, i64 %idxprom3.i429
  store ptr %556, ptr %arrayidx4.i430, align 8, !tbaa !5
...
for.inc.i436:                                     ; preds = %if.then.i432, %land.lhs.true30.i.i427, %if.then26.i.i424, %if.then24.i.i421, %if.end20.i.i418
  %568 = phi ptr [ %.pre.i431, %if.then.i432 ], [ %555, %if.end20.i.i418 ], [ %555, %if.then24.i.i421 ], [ %555, %if.then26.i.i424 ], [ %555, %land.lhs.true30.i.i427 ]
...
for.end.i439:                                     ; preds = %for.inc.i436, %if.end105
  ...
  %569 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 3), align 8, !tbaa !28
  %cmp621.i438 = icmp ult i32 %j.0.lcssa.i437, %569
...
while.body.preheader.i441:                        ; preds = %for.end.i439
  %570 = zext i32 %j.0.lcssa.i437 to i64
  %wide.trip.count27.i440 = zext i32 %569 to i64
  %571 = sub nsw i64 %wide.trip.count27.i440, %570
  %572 = xor i64 %570, -1
  %573 = add nsw i64 %572, %wide.trip.count27.i440
  %xtraiter818 = and i64 %571, 3
  %lcmp.mod819.not = icmp eq i64 %xtraiter818, 0
  br i1 %lcmp.mod819.not, label %while.body.i446.prol.loopexit, label %while.body.i446.prol

while.body.i446.prol:                             ; preds = %while.body.preheader.i441, %while.body.i446.prol
  %indvars.iv24.i442.prol = phi i64 [ %indvars.iv.next25.i443.prol, %while.body.i446.prol ], [ %570, %while.body.preheader.i441 ]
  %prol.iter820 = phi i64 [ %prol.iter820.next, %while.body.i446.prol ], [ 0, %while.body.preheader.i441 ]
  ...
  %arrayidx9.i444.prol = getelementptr inbounds ptr, ptr %574, i64 %indvars.iv24.i442.prol
  ...
  br i1 %prol.iter820.cmp.not, label %while.body.i446.prol.loopexit, label %while.body.i446.prol, !llvm.loop !202

while.body.i446.prol.loopexit:                    ; preds = %while.body.i446.prol, %while.body.preheader.i441
  %indvars.iv24.i442.unr = phi i64 [ %570, %while.body.preheader.i441 ], [ %indvars.iv.next25.i443.prol, %while.body.i446.prol ]
  %575 = icmp ult i64 %573, 3
  br i1 %575, label %update_ref_list.exit448, label %while.body.i446
...
while.body.i446:                                  ; preds = %while.body.i446.prol.loopexit, %while.body.i446
  ...
  %arrayidx9.i444 = getelementptr inbounds ptr, ptr %576, i64 %indvars.iv24.i442
  ...
  %arrayidx9.i444.1 = getelementptr inbounds ptr, ptr %577, i64 %indvars.iv.next25.i443
  store ptr null, ptr %arrayidx9.i444.1, align 8, !tbaa !5
  %578 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  %indvars.iv.next25.i443.2 = add nuw nsw i64 %indvars.iv24.i442, 3
  %arrayidx9.i444.2 = getelementptr inbounds ptr, ptr %578, i64 %indvars.iv.next25.i443.1
  store ptr null, ptr %arrayidx9.i444.2, align 8, !tbaa !5
  %579 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 1), align 8, !tbaa !34
  %indvars.iv.next25.i443.3 = add nuw nsw i64 %indvars.iv24.i442, 4
  %arrayidx9.i444.3 = getelementptr inbounds ptr, ptr %579, i64 %indvars.iv.next25.i443.2
...
for.body.i457:                                    ; preds = %for.inc.i497, %for.body.preheader.i452
  %580 = phi ptr [ %.pre29.i451, %for.body.preheader.i452 ], [ %593, %for.inc.i497 ]
  ...
  %arrayidx.i455 = getelementptr inbounds ptr, ptr %580, i64 %indvars.iv.i453
  %581 = load ptr, ptr %arrayidx.i455, align 8, !tbaa !5
  %582 = load i32, ptr %581, align 8, !tbaa !77
  %cmp.i.i456 = icmp eq i32 %582, 3
  br i1 %cmp.i.i456, label %if.then.i.i461, label %if.end4.i.i467

if.then.i.i461:                                   ; preds = %for.body.i457
  %frame.i.i458 = getelementptr inbounds %struct.frame_store, ptr %581, i64 0, i32 10
  %583 = load ptr, ptr %frame.i.i458, align 8, !tbaa !42
  %used_for_reference.i.i459 = getelementptr inbounds %struct.storable_picture, ptr %583, i64 0, i32 15
  %584 = load i32, ptr %used_for_reference.i.i459, align 4, !tbaa !75
  %tobool.not.i.i460 = icmp eq i32 %584, 0
  br i1 %tobool.not.i.i460, label %if.then7.i.i470, label %land.lhs.true.i.i464

land.lhs.true.i.i464:                             ; preds = %if.then.i.i461
  %is_long_term.i.i462 = getelementptr inbounds %struct.storable_picture, ptr %583, i64 0, i32 14
  %585 = load i32, ptr %is_long_term.i.i462, align 8, !tbaa !76
  %tobool2.not.i.i463 = icmp eq i32 %585, 0
  br i1 %tobool2.not.i.i463, label %if.then7.i.i470, label %if.then.i493

if.end4.i.i467:                                   ; preds = %for.body.i457
  %and.i.i465 = and i32 %582, 1
...
if.then7.i.i470:                                  ; preds = %if.end4.i.i467, %land.lhs.true.i.i464, %if.then.i.i461
  %top_field.i.i468 = getelementptr inbounds %struct.frame_store, ptr %581, i64 0, i32 11
  %586 = load ptr, ptr %top_field.i.i468, align 8, !tbaa !44
  %tobool8.not.i.i469 = icmp eq ptr %586, null
  br i1 %tobool8.not.i.i469, label %if.end20.i.i479, label %if.then9.i.i473

if.then9.i.i473:                                  ; preds = %if.then7.i.i470
  %used_for_reference11.i.i471 = getelementptr inbounds %struct.storable_picture, ptr %586, i64 0, i32 15
  %587 = load i32, ptr %used_for_reference11.i.i471, align 4, !tbaa !75
  %tobool12.not.i.i472 = icmp eq i32 %587, 0
  br i1 %tobool12.not.i.i472, label %if.end20.i.i479, label %land.lhs.true13.i.i476

land.lhs.true13.i.i476:                           ; preds = %if.then9.i.i473
  %is_long_term15.i.i474 = getelementptr inbounds %struct.storable_picture, ptr %586, i64 0, i32 14
  %588 = load i32, ptr %is_long_term15.i.i474, align 8, !tbaa !76
  %tobool16.not.i.i475 = icmp eq i32 %588, 0
...
if.then24.i.i482:                                 ; preds = %if.end20.i.i479
  %bottom_field.i.i480 = getelementptr inbounds %struct.frame_store, ptr %581, i64 0, i32 12
  %589 = load ptr, ptr %bottom_field.i.i480, align 8, !tbaa !45
  %tobool25.not.i.i481 = icmp eq ptr %589, null
  br i1 %tobool25.not.i.i481, label %for.inc.i497, label %if.then26.i.i485

if.then26.i.i485:                                 ; preds = %if.then24.i.i482
  %used_for_reference28.i.i483 = getelementptr inbounds %struct.storable_picture, ptr %589, i64 0, i32 15
  %590 = load i32, ptr %used_for_reference28.i.i483, align 4, !tbaa !75
  %tobool29.not.i.i484 = icmp eq i32 %590, 0
  br i1 %tobool29.not.i.i484, label %for.inc.i497, label %land.lhs.true30.i.i488

land.lhs.true30.i.i488:                           ; preds = %if.then26.i.i485
  %is_long_term32.i.i486 = getelementptr inbounds %struct.storable_picture, ptr %589, i64 0, i32 14
  %591 = load i32, ptr %is_long_term32.i.i486, align 8, !tbaa !76
  %tobool33.not.i.i487 = icmp eq i32 %591, 0
...
if.then.i493:                                     ; preds = %land.lhs.true30.i.i488, %land.lhs.true13.i.i476, %land.lhs.true.i.i464
  %592 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 2), align 8, !tbaa !35
  %inc.i489 = add i32 %j.020.i454, 1
  %idxprom3.i490 = zext i32 %j.020.i454 to i64
  %arrayidx4.i491 = getelementptr inbounds ptr, ptr %592, i64 %idxprom3.i490
  store ptr %581, ptr %arrayidx4.i491, align 8, !tbaa !5
...
for.inc.i497:                                     ; preds = %if.then.i493, %land.lhs.true30.i.i488, %if.then26.i.i485, %if.then24.i.i482, %if.end20.i.i479
  %593 = phi ptr [ %.pre.i492, %if.then.i493 ], [ %580, %if.end20.i.i479 ], [ %580, %if.then24.i.i482 ], [ %580, %if.then26.i.i485 ], [ %580, %land.lhs.true30.i.i488 ]
...
for.end.i500:                                     ; preds = %for.inc.i497, %update_ref_list.exit448
  ...
  %cmp621.i499 = icmp ult i32 %j.0.lcssa.i498, %569
...
while.body.preheader.i502:                        ; preds = %for.end.i500
  %594 = zext i32 %j.0.lcssa.i498 to i64
  %wide.trip.count27.i501 = zext i32 %569 to i64
  %595 = sub nsw i64 %wide.trip.count27.i501, %594
  %596 = xor i64 %594, -1
  %597 = add nsw i64 %596, %wide.trip.count27.i501
  %xtraiter821 = and i64 %595, 3
  %lcmp.mod822.not = icmp eq i64 %xtraiter821, 0
  br i1 %lcmp.mod822.not, label %while.body.i507.prol.loopexit, label %while.body.i507.prol

while.body.i507.prol:                             ; preds = %while.body.preheader.i502, %while.body.i507.prol
  %indvars.iv24.i503.prol = phi i64 [ %indvars.iv.next25.i504.prol, %while.body.i507.prol ], [ %594, %while.body.preheader.i502 ]
  %prol.iter823 = phi i64 [ %prol.iter823.next, %while.body.i507.prol ], [ 0, %while.body.preheader.i502 ]
  ...
  %arrayidx9.i505.prol = getelementptr inbounds ptr, ptr %598, i64 %indvars.iv24.i503.prol
  store ptr null, ptr %arrayidx9.i505.prol, align 8, !tbaa !5
  %prol.iter823.next = add i64 %prol.iter823, 1
  %prol.iter823.cmp.not = icmp eq i64 %prol.iter823.next, %xtraiter821
  br i1 %prol.iter823.cmp.not, label %while.body.i507.prol.loopexit, label %while.body.i507.prol, !llvm.loop !203

while.body.i507.prol.loopexit:                    ; preds = %while.body.i507.prol, %while.body.preheader.i502
  %indvars.iv24.i503.unr = phi i64 [ %594, %while.body.preheader.i502 ], [ %indvars.iv.next25.i504.prol, %while.body.i507.prol ]
  %599 = icmp ult i64 %597, 3
  br i1 %599, label %update_ltref_list.exit509, label %while.body.i507
...
while.body.i507:                                  ; preds = %while.body.i507.prol.loopexit, %while.body.i507
  ...
  %arrayidx9.i505 = getelementptr inbounds ptr, ptr %600, i64 %indvars.iv24.i503
  ...
  %arrayidx9.i505.1 = getelementptr inbounds ptr, ptr %601, i64 %indvars.iv.next25.i504
  store ptr null, ptr %arrayidx9.i505.1, align 8, !tbaa !5
  %602 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 2), align 8, !tbaa !35
  %indvars.iv.next25.i504.2 = add nuw nsw i64 %indvars.iv24.i503, 3
  %arrayidx9.i505.2 = getelementptr inbounds ptr, ptr %602, i64 %indvars.iv.next25.i504.1
  store ptr null, ptr %arrayidx9.i505.2, align 8, !tbaa !5
  %603 = load ptr, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 2), align 8, !tbaa !35
  %indvars.iv.next25.i504.3 = add nuw nsw i64 %indvars.iv24.i503, 4
  %arrayidx9.i505.3 = getelementptr inbounds ptr, ptr %603, i64 %indvars.iv.next25.i504.2
...
update_ltref_list.exit509:                        ; preds = %while.body.i507.prol.loopexit, %while.body.i507, %for.end.i500
  ...
  %num_ref_frames.i510 = getelementptr inbounds %struct.ImageParameters, ptr %604, i64 0, i32 7
  %605 = load i32, ptr %num_ref_frames.i510, align 4, !tbaa !22
  %cond.i.i511 = tail call i32 @llvm.smax.i32(i32 %605, i32 1)
...
; Function Attrs: nounwind uwtable
define internal fastcc void @insert_picture_in_dpb(ptr noundef %fs, ptr noundef %p) unnamed_addr #1 {
entry:
  %used_for_reference = getelementptr inbounds %struct.storable_picture, ptr %p, i64 0, i32 15
  %0 = load i32, ptr %used_for_reference, align 4, !tbaa !75
  %tobool.not = icmp eq i32 %0, 0
...
; Function Attrs: nounwind uwtable
define dso_local void @dpb_split_field(ptr noundef %fs) local_unnamed_addr #1 {
entry:
  %frame = getelementptr inbounds %struct.frame_store, ptr %fs, i64 0, i32 10
  %0 = load ptr, ptr %frame, align 8, !tbaa !42
...
for.end135:                                       ; preds = %for.body100, %for.cond94.preheader
  ...
  %93 = load i32, ptr %top_poc, align 8, !tbaa !188
  %94 = load ptr, ptr %top_field, align 8, !tbaa !44
  %poc140 = getelementptr inbounds %struct.storable_picture, ptr %94, i64 0, i32 1
  store i32 %93, ptr %poc140, align 4, !tbaa !105
  %bottom_poc = getelementptr inbounds %struct.storable_picture, ptr %92, i64 0, i32 3
  %95 = load ptr, ptr %bottom_field, align 8, !tbaa !45
  %poc143 = getelementptr inbounds %struct.storable_picture, ptr %95, i64 0, i32 1
  %frame_poc = getelementptr inbounds %struct.storable_picture, ptr %92, i64 0, i32 4
  %bottom_poc150 = getelementptr inbounds %struct.storable_picture, ptr %95, i64 0, i32 3
  %bottom_poc152 = getelementptr inbounds %struct.storable_picture, ptr %94, i64 0, i32 3
  %96 = load <2 x i32>, ptr %bottom_poc, align 4, !tbaa !38
  %97 = extractelement <2 x i32> %96, i64 0
  store i32 %97, ptr %poc143, align 4, !tbaa !105
  store i32 %97, ptr %bottom_poc150, align 4, !tbaa !190
  store <2 x i32> %96, ptr %bottom_poc152, align 4, !tbaa !38
  %top_poc156 = getelementptr inbounds %struct.storable_picture, ptr %95, i64 0, i32 2
  store i32 %93, ptr %top_poc156, align 8, !tbaa !188
  %top_poc158 = getelementptr inbounds %struct.storable_picture, ptr %94, i64 0, i32 2
  store i32 %93, ptr %top_poc158, align 8, !tbaa !188
  %98 = load i32, ptr %frame_poc, align 8, !tbaa !218
  %frame_poc162 = getelementptr inbounds %struct.storable_picture, ptr %95, i64 0, i32 4
  store i32 %98, ptr %frame_poc162, align 8, !tbaa !218
  %used_for_reference = getelementptr inbounds %struct.storable_picture, ptr %92, i64 0, i32 15
  %99 = load i32, ptr %used_for_reference, align 4, !tbaa !75
  %used_for_reference165 = getelementptr inbounds %struct.storable_picture, ptr %95, i64 0, i32 15
  store i32 %99, ptr %used_for_reference165, align 4, !tbaa !75
  %used_for_reference167 = getelementptr inbounds %struct.storable_picture, ptr %94, i64 0, i32 15
  store i32 %99, ptr %used_for_reference167, align 4, !tbaa !75
  %is_long_term = getelementptr inbounds %struct.storable_picture, ptr %92, i64 0, i32 14
  %100 = load i32, ptr %is_long_term, align 8, !tbaa !76
  %is_long_term170 = getelementptr inbounds %struct.storable_picture, ptr %95, i64 0, i32 14
  store i32 %100, ptr %is_long_term170, align 8, !tbaa !76
  %is_long_term172 = getelementptr inbounds %struct.storable_picture, ptr %94, i64 0, i32 14
  store i32 %100, ptr %is_long_term172, align 8, !tbaa !76
  %long_term_frame_idx = getelementptr inbounds %struct.storable_picture, ptr %92, i64 0, i32 13
  %101 = load i32, ptr %long_term_frame_idx, align 4, !tbaa !82
  %long_term_frame_idx175 = getelementptr inbounds %struct.storable_picture, ptr %95, i64 0, i32 13
  store i32 %101, ptr %long_term_frame_idx175, align 4, !tbaa !82
  %long_term_frame_idx177 = getelementptr inbounds %struct.storable_picture, ptr %94, i64 0, i32 13
  store i32 %101, ptr %long_term_frame_idx177, align 4, !tbaa !82
  %long_term_frame_idx178 = getelementptr inbounds %struct.frame_store, ptr %fs, i64 0, i32 7
  store i32 %101, ptr %long_term_frame_idx178, align 4, !tbaa !128
  %coded_frame = getelementptr inbounds %struct.storable_picture, ptr %95, i64 0, i32 27
  store i32 1, ptr %coded_frame, align 4, !tbaa !62
  %coded_frame181 = getelementptr inbounds %struct.storable_picture, ptr %94, i64 0, i32 27
  ...
  %102 = load i32, ptr %MbaffFrameFlag, align 8, !tbaa !63
  %MbaffFrameFlag184 = getelementptr inbounds %struct.storable_picture, ptr %95, i64 0, i32 28
  store i32 %102, ptr %MbaffFrameFlag184, align 8, !tbaa !63
  %MbaffFrameFlag186 = getelementptr inbounds %struct.storable_picture, ptr %94, i64 0, i32 28
  store i32 %102, ptr %MbaffFrameFlag186, align 8, !tbaa !63
  %top_field189 = getelementptr inbounds %struct.storable_picture, ptr %92, i64 0, i32 41
  store ptr %94, ptr %top_field189, align 8, !tbaa !129
  %bottom_field192 = getelementptr inbounds %struct.storable_picture, ptr %92, i64 0, i32 42
  store ptr %95, ptr %bottom_field192, align 8, !tbaa !130
  %bottom_field195 = getelementptr inbounds %struct.storable_picture, ptr %94, i64 0, i32 42
  store ptr %95, ptr %bottom_field195, align 8, !tbaa !130
  %frame198 = getelementptr inbounds %struct.storable_picture, ptr %94, i64 0, i32 43
  store ptr %92, ptr %frame198, align 8, !tbaa !219
  %top_field201 = getelementptr inbounds %struct.storable_picture, ptr %95, i64 0, i32 41
  store ptr %94, ptr %top_field201, align 8, !tbaa !129
  %frame204 = getelementptr inbounds %struct.storable_picture, ptr %95, i64 0, i32 43
  ...
  %103 = load i32, ptr %chroma_format_idc, align 8, !tbaa !220
  %chroma_format_idc207 = getelementptr inbounds %struct.storable_picture, ptr %95, i64 0, i32 44
  store i32 %103, ptr %chroma_format_idc207, align 8, !tbaa !220
  %chroma_format_idc209 = getelementptr inbounds %struct.storable_picture, ptr %94, i64 0, i32 44
  store i32 %103, ptr %chroma_format_idc209, align 8, !tbaa !220
  %arrayidx211 = getelementptr inbounds %struct.storable_picture, ptr %94, i64 0, i32 6, i64 1
  %arrayidx214 = getelementptr inbounds %struct.storable_picture, ptr %92, i64 0, i32 6, i64 3
  %104 = load i32, ptr getelementptr inbounds ([6 x i32], ptr @listXsize, i64 0, i64 1), align 4, !tbaa !38
  %mul216 = shl nsw i32 %104, 1
  ...
  %105 = load ptr, ptr %bottom_field, align 8, !tbaa !45
  %arrayidx221 = getelementptr inbounds %struct.storable_picture, ptr %105, i64 0, i32 6, i64 1
  %106 = load ptr, ptr %frame, align 8, !tbaa !42
  %arrayidx225 = getelementptr inbounds %struct.storable_picture, ptr %106, i64 0, i32 6, i64 5
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %arrayidx221, ptr nonnull align 8 %arrayidx225, i64 %mul218, i1 false)
  %107 = load ptr, ptr %top_field, align 8, !tbaa !44
  %ref_pic_num231 = getelementptr inbounds %struct.storable_picture, ptr %107, i64 0, i32 6
  %108 = load ptr, ptr %frame, align 8, !tbaa !42
  %arrayidx236 = getelementptr inbounds %struct.storable_picture, ptr %108, i64 0, i32 6, i64 2
  %109 = load i32, ptr @listXsize, align 16, !tbaa !38
  %mul238 = shl nsw i32 %109, 1
  ...
  %110 = load ptr, ptr %bottom_field, align 8, !tbaa !45
  %ref_pic_num242 = getelementptr inbounds %struct.storable_picture, ptr %110, i64 0, i32 6
  %111 = load ptr, ptr %frame, align 8, !tbaa !42
  %arrayidx247 = getelementptr inbounds %struct.storable_picture, ptr %111, i64 0, i32 6, i64 4
...
if.end:                                           ; preds = %if.else, %for.end135
  %112 = phi ptr [ %0, %if.else ], [ %.pre, %for.end135 ]
  %size_y260 = getelementptr inbounds %struct.storable_picture, ptr %112, i64 0, i32 19
  %113 = load i32, ptr %size_y260, align 4, !tbaa !53
  %div261 = sdiv i32 %113, 4
  %cmp2621590 = icmp sgt i32 %113, 3
  br i1 %cmp2621590, label %for.body264.lr.ph, label %for.end443

for.body264.lr.ph:                                ; preds = %if.end
  %size_x268 = getelementptr inbounds %struct.storable_picture, ptr %112, i64 0, i32 18
  %114 = load i32, ptr %size_x268, align 8, !tbaa !52
  %div269 = sdiv i32 %114, 4
  %cmp2701588 = icmp sgt i32 %114, 3
  %mb_field = getelementptr inbounds %struct.storable_picture, ptr %112, i64 0, i32 34
  %ref_idx = getelementptr inbounds %struct.storable_picture, ptr %112, i64 0, i32 35
  %ref_id = getelementptr inbounds %struct.storable_picture, ptr %112, i64 0, i32 37
  %ref_pic_num405 = getelementptr inbounds %struct.storable_picture, ptr %112, i64 0, i32 6
  br i1 %cmp2701588, label %for.body264.lr.ph.split.us, label %for.end443

for.body264.lr.ph.split.us:                       ; preds = %for.body264.lr.ph
  %MbaffFrameFlag280 = getelementptr inbounds %struct.storable_picture, ptr %112, i64 0, i32 28
  %115 = load i32, ptr %MbaffFrameFlag280, align 8, !tbaa !63
  %tobool281.not.us = icmp eq i32 %115, 0
...
for.body264.lr.ph.split.us.split.us:              ; preds = %for.body264.lr.ph.split.us
  %116 = load ptr, ptr %ref_idx, align 8, !tbaa !64
  %117 = load ptr, ptr %116, align 8, !tbaa !5
  %arrayidx395.us.us.us = getelementptr inbounds ptr, ptr %116, i64 1
  %118 = load ptr, ptr %arrayidx395.us.us.us, align 8, !tbaa !5
  %119 = load ptr, ptr %ref_id, align 8, !tbaa !66
  %120 = load ptr, ptr %119, align 8, !tbaa !5
  %arrayidx432.us.us.us = getelementptr inbounds ptr, ptr %119, i64 1
  %121 = load ptr, ptr %arrayidx432.us.us.us, align 8, !tbaa !5
...
for.body264.us.us:                                ; preds = %for.cond266.for.inc441_crit_edge.split.us.us.us, %for.body264.lr.ph.split.us.split.us
  ...
  %arrayidx389.us.us.us = getelementptr inbounds ptr, ptr %117, i64 %indvars.iv1670
  %122 = load ptr, ptr %arrayidx389.us.us.us, align 8, !tbaa !5
  %arrayidx397.us.us.us = getelementptr inbounds ptr, ptr %118, i64 %indvars.iv1670
  %123 = load ptr, ptr %arrayidx397.us.us.us, align 8, !tbaa !5
  %arrayidx416.us.us.us = getelementptr inbounds ptr, ptr %120, i64 %indvars.iv1670
  %124 = load ptr, ptr %arrayidx416.us.us.us, align 8, !tbaa !5
  %arrayidx434.us.us.us = getelementptr inbounds ptr, ptr %121, i64 %indvars.iv1670
  %125 = load ptr, ptr %arrayidx434.us.us.us, align 8, !tbaa !5
...
for.body272.us.us.us:                             ; preds = %cond.end428.us.us.us, %for.body264.us.us
  ...
  %arrayidx391.us.us.us = getelementptr inbounds i8, ptr %122, i64 %indvars.iv1665
  %126 = load i8, ptr %arrayidx391.us.us.us, align 1, !tbaa !204
  %arrayidx399.us.us.us = getelementptr inbounds i8, ptr %123, i64 %indvars.iv1665
  %127 = load i8, ptr %arrayidx399.us.us.us, align 1, !tbaa !204
  %conv400.us.us.us = sext i8 %127 to i64
  %cmp401.us.us.us = icmp sgt i8 %126, -1
...
cond.true403.us.us.us:                            ; preds = %for.body272.us.us.us
  %conv392.us.us.us = zext i8 %126 to i64
  %arrayidx408.us.us.us = getelementptr inbounds [33 x i64], ptr %ref_pic_num405, i64 0, i64 %conv392.us.us.us
  %128 = load i64, ptr %arrayidx408.us.us.us, align 8, !tbaa !205
  br label %cond.end410.us.us.us

cond.end410.us.us.us:                             ; preds = %cond.true403.us.us.us, %for.body272.us.us.us
  %cond411.us.us.us = phi i64 [ %128, %cond.true403.us.us.us ], [ -1, %for.body272.us.us.us ]
  %arrayidx418.us.us.us = getelementptr inbounds i64, ptr %124, i64 %indvars.iv1665
  store i64 %cond411.us.us.us, ptr %arrayidx418.us.us.us, align 8, !tbaa !205
  %cmp419.us.us.us = icmp sgt i8 %127, -1
...
cond.true421.us.us.us:                            ; preds = %cond.end410.us.us.us
  ...
  %arrayidx426.us.us.us = getelementptr inbounds %struct.storable_picture, ptr %112, i64 0, i32 6, i64 1, i64 %idxprom425.us.us.us
  %129 = load i64, ptr %arrayidx426.us.us.us, align 8, !tbaa !205
  br label %cond.end428.us.us.us

cond.end428.us.us.us:                             ; preds = %cond.true421.us.us.us, %cond.end410.us.us.us
  %cond429.us.us.us = phi i64 [ %129, %cond.true421.us.us.us ], [ -1, %cond.end410.us.us.us ]
  %arrayidx436.us.us.us = getelementptr inbounds i64, ptr %125, i64 %indvars.iv1665
...
for.body264.lr.ph.split.us.split:                 ; preds = %for.body264.lr.ph.split.us
  %130 = load ptr, ptr %mb_field, align 8, !tbaa !49
  %wide.trip.count1663 = zext i32 %div261 to i64
  %wide.trip.count = zext i32 %div269 to i64
  %131 = load ptr, ptr %ref_idx, align 8, !tbaa !64
  %132 = load ptr, ptr %131, align 8, !tbaa !5
  %arrayidx299.us = getelementptr inbounds ptr, ptr %131, i64 1
  %arrayidx395.us1597 = getelementptr inbounds ptr, ptr %131, i64 1
...
for.body264.us:                                   ; preds = %for.cond266.for.inc441_crit_edge.split.us1620, %for.body264.lr.ph.split.us.split
  ...
  %133 = trunc i64 %indvars.iv1660 to i32
  %div2651565.us = lshr i32 %133, 2
  %rem.us = and i32 %div2651565.us, 1
  %div2741567.us = lshr i32 %133, 3
  ...
  %arrayidx389.us1594 = getelementptr inbounds ptr, ptr %132, i64 %indvars.iv1660
  %134 = load ptr, ptr %arrayidx389.us1594, align 8, !tbaa !5
...
for.body272.us1592:                               ; preds = %for.body264.us, %for.inc438.us
  ...
  %135 = trunc i64 %indvars.iv1657 to i32
  %136 = lshr i32 %135, 1
  %mul276.us = and i32 %136, 1073741822
  %add277.us = add nsw i32 %mul276.us, %mul275.us
  %add278.us = or i32 %add277.us, %rem.us
  %idxprom283.us = sext i32 %add278.us to i64
  %arrayidx284.us = getelementptr inbounds i8, ptr %130, i64 %idxprom283.us
  %137 = load i8, ptr %arrayidx284.us, align 1, !tbaa !204
  %tobool286.not.us = icmp eq i8 %137, 0
  %arrayidx391.us1596 = getelementptr inbounds i8, ptr %134, i64 %indvars.iv1657
  %138 = load i8, ptr %arrayidx391.us1596, align 1, !tbaa !204
  br i1 %tobool286.not.us, label %if.else384.us, label %if.then287.us

if.then287.us:                                    ; preds = %for.body272.us1592
  %conv296.us = sext i8 %138 to i32
  %139 = load ptr, ptr %arrayidx299.us, align 8, !tbaa !5
  %arrayidx301.us = getelementptr inbounds ptr, ptr %139, i64 %indvars.iv1660
  %140 = load ptr, ptr %arrayidx301.us, align 8, !tbaa !5
  %arrayidx303.us = getelementptr inbounds i8, ptr %140, i64 %indvars.iv1657
  %141 = load i8, ptr %arrayidx303.us, align 1, !tbaa !204
  %conv304.us = sext i8 %141 to i32
  %cmp305.us = icmp sgt i8 %138, -1
...
cond.true.us:                                     ; preds = %if.then287.us
  ...
  %arrayidx313.us = getelementptr inbounds %struct.storable_picture, ptr %112, i64 0, i32 6, i64 %idxprom310.us, i64 %idxprom312.us
  %142 = load i64, ptr %arrayidx313.us, align 8, !tbaa !205
  br label %cond.end.us

cond.end.us:                                      ; preds = %cond.true.us, %if.then287.us
  %cond314.us = phi i64 [ %142, %cond.true.us ], [ 0, %if.then287.us ]
  %143 = load ptr, ptr %ref_id, align 8, !tbaa !66
  %arrayidx318.us = getelementptr inbounds ptr, ptr %143, i64 %idxprom310.us
  %144 = load ptr, ptr %arrayidx318.us, align 8, !tbaa !5
  %arrayidx320.us = getelementptr inbounds ptr, ptr %144, i64 %indvars.iv1660
  %145 = load ptr, ptr %arrayidx320.us, align 8, !tbaa !5
  %arrayidx322.us = getelementptr inbounds i64, ptr %145, i64 %indvars.iv1657
  store i64 %cond314.us, ptr %arrayidx322.us, align 8, !tbaa !205
  %cmp323.us = icmp sgt i8 %141, -1
...
cond.true325.us:                                  ; preds = %cond.end.us
  ...
  %arrayidx332.us = getelementptr inbounds %struct.storable_picture, ptr %112, i64 0, i32 6, i64 %idxprom329.us, i64 %idxprom331.us
  %146 = load i64, ptr %arrayidx332.us, align 8, !tbaa !205
  br label %cond.end334.us

cond.end334.us:                                   ; preds = %cond.true325.us, %cond.end.us
  %cond335.us = phi i64 [ %146, %cond.true325.us ], [ 0, %cond.end.us ]
  %arrayidx340.us = getelementptr inbounds ptr, ptr %143, i64 %idxprom329.us
  %147 = load ptr, ptr %arrayidx340.us, align 8, !tbaa !5
  %arrayidx342.us = getelementptr inbounds ptr, ptr %147, i64 %indvars.iv1660
  %148 = load ptr, ptr %arrayidx342.us, align 8, !tbaa !5
  %arrayidx344.us = getelementptr inbounds i64, ptr %148, i64 %indvars.iv1657
...
cond.true347.us:                                  ; preds = %cond.end334.us
  ...
  %arrayidx353.us = getelementptr inbounds %struct.storable_picture, ptr %112, i64 0, i32 7, i64 %idxprom310.us, i64 %idxprom352.us
  %149 = load i64, ptr %arrayidx353.us, align 8, !tbaa !205
  br label %cond.end355.us

cond.end355.us:                                   ; preds = %cond.true347.us, %cond.end334.us
  %cond356.us = phi i64 [ %149, %cond.true347.us ], [ 0, %cond.end334.us ]
  %150 = load ptr, ptr %143, align 8, !tbaa !5
  %arrayidx361.us = getelementptr inbounds ptr, ptr %150, i64 %indvars.iv1660
  %151 = load ptr, ptr %arrayidx361.us, align 8, !tbaa !5
  %arrayidx363.us = getelementptr inbounds i64, ptr %151, i64 %indvars.iv1657
...
cond.true366.us:                                  ; preds = %cond.end355.us
  ...
  %arrayidx373.us = getelementptr inbounds %struct.storable_picture, ptr %112, i64 0, i32 7, i64 %idxprom329.us, i64 %idxprom372.us
  br label %for.inc438.us.sink.split

if.else384.us:                                    ; preds = %for.body272.us1592
  %152 = load ptr, ptr %arrayidx395.us1597, align 8, !tbaa !5
  %arrayidx397.us1598 = getelementptr inbounds ptr, ptr %152, i64 %indvars.iv1660
  %153 = load ptr, ptr %arrayidx397.us1598, align 8, !tbaa !5
  %arrayidx399.us1599 = getelementptr inbounds i8, ptr %153, i64 %indvars.iv1657
  %154 = load i8, ptr %arrayidx399.us1599, align 1, !tbaa !204
  %conv400.us1600 = sext i8 %154 to i64
  %cmp401.us1601 = icmp sgt i8 %138, -1
  br i1 %cmp401.us1601, label %cond.true403.us1602, label %cond.end410.us1605

cond.true403.us1602:                              ; preds = %if.else384.us
  %conv392.us1603 = zext i8 %138 to i64
  %arrayidx408.us1604 = getelementptr inbounds [33 x i64], ptr %ref_pic_num405, i64 0, i64 %conv392.us1603
  %155 = load i64, ptr %arrayidx408.us1604, align 8, !tbaa !205
  br label %cond.end410.us1605

cond.end410.us1605:                               ; preds = %cond.true403.us1602, %if.else384.us
  %cond411.us1606 = phi i64 [ %155, %cond.true403.us1602 ], [ -1, %if.else384.us ]
  %156 = load ptr, ptr %ref_id, align 8, !tbaa !66
  %157 = load ptr, ptr %156, align 8, !tbaa !5
  %arrayidx416.us1607 = getelementptr inbounds ptr, ptr %157, i64 %indvars.iv1660
  %158 = load ptr, ptr %arrayidx416.us1607, align 8, !tbaa !5
  %arrayidx418.us1608 = getelementptr inbounds i64, ptr %158, i64 %indvars.iv1657
  store i64 %cond411.us1606, ptr %arrayidx418.us1608, align 8, !tbaa !205
  %cmp419.us1609 = icmp sgt i8 %154, -1
...
cond.true421.us1610:                              ; preds = %cond.end410.us1605
  ...
  %arrayidx426.us1612 = getelementptr inbounds %struct.storable_picture, ptr %112, i64 0, i32 6, i64 1, i64 %idxprom425.us1611
  br label %for.inc438.us.sink.split
...
for.inc438.us.sink.split:                         ; preds = %cond.true366.us, %cond.true421.us1610
  ...
  %.sink.ph = phi ptr [ %156, %cond.true421.us1610 ], [ %143, %cond.true366.us ]
  %159 = load i64, ptr %arrayidx426.us1612.sink, align 8, !tbaa !205
  br label %for.inc438.us

for.inc438.us:                                    ; preds = %for.inc438.us.sink.split, %cond.end410.us1605, %cond.end355.us
  %.sink = phi ptr [ %143, %cond.end355.us ], [ %156, %cond.end410.us1605 ], [ %.sink.ph, %for.inc438.us.sink.split ]
  %cond429.us1614.sink = phi i64 [ 0, %cond.end355.us ], [ -1, %cond.end410.us1605 ], [ %159, %for.inc438.us.sink.split ]
  %arrayidx432.us1615 = getelementptr inbounds ptr, ptr %.sink, i64 1
  %160 = load ptr, ptr %arrayidx432.us1615, align 8, !tbaa !5
  %arrayidx434.us1616 = getelementptr inbounds ptr, ptr %160, i64 %indvars.iv1660
  %161 = load ptr, ptr %arrayidx434.us1616, align 8, !tbaa !5
  %arrayidx436.us1617 = getelementptr inbounds i64, ptr %161, i64 %indvars.iv1657
...
for.end443:                                       ; preds = %for.cond266.for.inc441_crit_edge.split.us1620, %for.cond266.for.inc441_crit_edge.split.us.us.us, %for.body264.lr.ph, %if.end
  %162 = load ptr, ptr @active_sps, align 8, !tbaa !5
  %frame_mbs_only_flag444 = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %162, i64 0, i32 25
  %163 = load i32, ptr %frame_mbs_only_flag444, align 4, !tbaa !15
  %tobool445.not = icmp eq i32 %163, 0
  br i1 %tobool445.not, label %land.lhs.true446, label %if.else1112

land.lhs.true446:                                 ; preds = %for.end443
  %MbaffFrameFlag448 = getelementptr inbounds %struct.storable_picture, ptr %112, i64 0, i32 28
  %164 = load i32, ptr %MbaffFrameFlag448, align 8, !tbaa !63
  %tobool449.not = icmp eq i32 %164, 0
  br i1 %tobool449.not, label %for.cond760.preheader, label %for.cond451.preheader

for.cond451.preheader:                            ; preds = %land.lhs.true446
  %cmp4551629 = icmp sgt i32 %113, 7
...
for.body457:                                      ; preds = %for.body457.lr.ph, %for.inc753
  %165 = phi ptr [ %112, %for.body457.lr.ph ], [ %292, %for.inc753 ]
  %indvars.iv1678 = phi i64 [ 0, %for.body457.lr.ph ], [ %indvars.iv.next1679, %for.inc753 ]
  %size_x4661623 = getelementptr inbounds %struct.storable_picture, ptr %165, i64 0, i32 18
  %166 = load i32, ptr %size_x4661623, align 8, !tbaa !52
  %cmp4681625 = icmp sgt i32 %166, 3
  br i1 %cmp4681625, label %for.body470.lr.ph, label %for.inc753

for.body470.lr.ph:                                ; preds = %for.body457
  %167 = trunc i64 %indvars.iv1678 to i32
  %div4631562 = lshr i32 %167, 1
  %168 = shl nuw nsw i64 %indvars.iv1678, 1
  %169 = trunc i64 %168 to i32
  %mul459 = and i32 %169, 2147483640
  %rem460 = and i32 %167, 3
  %add461 = or i32 %mul459, %rem460
  %add462 = or i32 %add461, 4
  %div4721564 = lshr i32 %167, 2
...
for.body470:                                      ; preds = %for.body470.lr.ph, %for.inc750
  %171 = phi ptr [ %165, %for.body470.lr.ph ], [ %288, %for.inc750 ]
  %172 = phi ptr [ %165, %for.body470.lr.ph ], [ %289, %for.inc750 ]
  %indvars.iv1675 = phi i64 [ 0, %for.body470.lr.ph ], [ %indvars.iv.next1676, %for.inc750 ]
  %173 = trunc i64 %indvars.iv1675 to i32
  %174 = lshr i32 %173, 1
  %mul474 = and i32 %174, 1073741822
  %add475 = add nsw i32 %mul474, %mul473
  %add477 = or i32 %add475, %rem476
  %mb_field479 = getelementptr inbounds %struct.storable_picture, ptr %172, i64 0, i32 34
  %175 = load ptr, ptr %mb_field479, align 8, !tbaa !49
  %idxprom480 = sext i32 %add477 to i64
  %arrayidx481 = getelementptr inbounds i8, ptr %175, i64 %idxprom480
  %176 = load i8, ptr %arrayidx481, align 1, !tbaa !204
  %tobool482.not = icmp eq i8 %176, 0
  br i1 %tobool482.not, label %for.inc750, label %if.then483

if.then483:                                       ; preds = %for.body470
  %177 = load ptr, ptr %top_field484, align 8, !tbaa !44
  %field_frame = getelementptr inbounds %struct.storable_picture, ptr %177, i64 0, i32 40
  %178 = load ptr, ptr %field_frame, align 8, !tbaa !69
  %arrayidx486 = getelementptr inbounds ptr, ptr %178, i64 %indvars.iv1678
  %179 = load ptr, ptr %arrayidx486, align 8, !tbaa !5
  %arrayidx488 = getelementptr inbounds i8, ptr %179, i64 %indvars.iv1675
  store i8 1, ptr %arrayidx488, align 1, !tbaa !204
  %180 = load ptr, ptr %bottom_field489, align 8, !tbaa !45
  %field_frame490 = getelementptr inbounds %struct.storable_picture, ptr %180, i64 0, i32 40
  %181 = load ptr, ptr %field_frame490, align 8, !tbaa !69
  %arrayidx492 = getelementptr inbounds ptr, ptr %181, i64 %indvars.iv1678
  %182 = load ptr, ptr %arrayidx492, align 8, !tbaa !5
  %arrayidx494 = getelementptr inbounds i8, ptr %182, i64 %indvars.iv1675
  store i8 1, ptr %arrayidx494, align 1, !tbaa !204
  %183 = load ptr, ptr %frame, align 8, !tbaa !42
  %field_frame496 = getelementptr inbounds %struct.storable_picture, ptr %183, i64 0, i32 40
  %184 = load ptr, ptr %field_frame496, align 8, !tbaa !69
  %arrayidx500 = getelementptr inbounds ptr, ptr %184, i64 %170
  %185 = load ptr, ptr %arrayidx500, align 8, !tbaa !5
  %arrayidx502 = getelementptr inbounds i8, ptr %185, i64 %indvars.iv1675
  store i8 1, ptr %arrayidx502, align 1, !tbaa !204
  %186 = load ptr, ptr %frame, align 8, !tbaa !42
  %field_frame504 = getelementptr inbounds %struct.storable_picture, ptr %186, i64 0, i32 40
  %187 = load ptr, ptr %field_frame504, align 8, !tbaa !69
  %arrayidx507 = getelementptr inbounds ptr, ptr %187, i64 %168
  %188 = load ptr, ptr %arrayidx507, align 8, !tbaa !5
  %arrayidx509 = getelementptr inbounds i8, ptr %188, i64 %indvars.iv1675
  store i8 1, ptr %arrayidx509, align 1, !tbaa !204
  %189 = load ptr, ptr %frame, align 8, !tbaa !42
  %mv = getelementptr inbounds %struct.storable_picture, ptr %189, i64 0, i32 38
  %190 = load ptr, ptr %mv, align 8, !tbaa !67
  %191 = load ptr, ptr %190, align 8, !tbaa !5
  %arrayidx513 = getelementptr inbounds ptr, ptr %191, i64 %idxprom512
  %192 = load ptr, ptr %arrayidx513, align 8, !tbaa !5
  %arrayidx515 = getelementptr inbounds ptr, ptr %192, i64 %indvars.iv1675
  %193 = load ptr, ptr %arrayidx515, align 8, !tbaa !5
  %194 = load i16, ptr %193, align 2, !tbaa !223
  %195 = load ptr, ptr %bottom_field489, align 8, !tbaa !45
  %mv518 = getelementptr inbounds %struct.storable_picture, ptr %195, i64 0, i32 38
  %196 = load ptr, ptr %mv518, align 8, !tbaa !67
  %197 = load ptr, ptr %196, align 8, !tbaa !5
  %arrayidx521 = getelementptr inbounds ptr, ptr %197, i64 %indvars.iv1678
  %198 = load ptr, ptr %arrayidx521, align 8, !tbaa !5
  %arrayidx523 = getelementptr inbounds ptr, ptr %198, i64 %indvars.iv1675
  %199 = load ptr, ptr %arrayidx523, align 8, !tbaa !5
  store i16 %194, ptr %199, align 2, !tbaa !223
  %arrayidx532 = getelementptr inbounds i16, ptr %193, i64 1
  %200 = load i16, ptr %arrayidx532, align 2, !tbaa !223
  %arrayidx540 = getelementptr inbounds i16, ptr %199, i64 1
  store i16 %200, ptr %arrayidx540, align 2, !tbaa !223
  %arrayidx543 = getelementptr inbounds ptr, ptr %190, i64 1
  %201 = load ptr, ptr %arrayidx543, align 8, !tbaa !5
  %arrayidx545 = getelementptr inbounds ptr, ptr %201, i64 %idxprom512
  %202 = load ptr, ptr %arrayidx545, align 8, !tbaa !5
  %arrayidx547 = getelementptr inbounds ptr, ptr %202, i64 %indvars.iv1675
  %203 = load ptr, ptr %arrayidx547, align 8, !tbaa !5
  %204 = load i16, ptr %203, align 2, !tbaa !223
  %arrayidx551 = getelementptr inbounds ptr, ptr %196, i64 1
  %205 = load ptr, ptr %arrayidx551, align 8, !tbaa !5
  %arrayidx553 = getelementptr inbounds ptr, ptr %205, i64 %indvars.iv1678
  %206 = load ptr, ptr %arrayidx553, align 8, !tbaa !5
  %arrayidx555 = getelementptr inbounds ptr, ptr %206, i64 %indvars.iv1675
  %207 = load ptr, ptr %arrayidx555, align 8, !tbaa !5
  store i16 %204, ptr %207, align 2, !tbaa !223
  %arrayidx564 = getelementptr inbounds i16, ptr %203, i64 1
  %208 = load i16, ptr %arrayidx564, align 2, !tbaa !223
  %arrayidx572 = getelementptr inbounds i16, ptr %207, i64 1
  store i16 %208, ptr %arrayidx572, align 2, !tbaa !223
  %ref_idx574 = getelementptr inbounds %struct.storable_picture, ptr %189, i64 0, i32 35
  %209 = load ptr, ptr %ref_idx574, align 8, !tbaa !64
  %210 = load ptr, ptr %209, align 8, !tbaa !5
  %arrayidx577 = getelementptr inbounds ptr, ptr %210, i64 %idxprom512
  %211 = load ptr, ptr %arrayidx577, align 8, !tbaa !5
  %arrayidx579 = getelementptr inbounds i8, ptr %211, i64 %indvars.iv1675
  %212 = load i8, ptr %arrayidx579, align 1, !tbaa !204
  %ref_idx581 = getelementptr inbounds %struct.storable_picture, ptr %195, i64 0, i32 35
  %213 = load ptr, ptr %ref_idx581, align 8, !tbaa !64
  %214 = load ptr, ptr %213, align 8, !tbaa !5
  %arrayidx584 = getelementptr inbounds ptr, ptr %214, i64 %indvars.iv1678
  %215 = load ptr, ptr %arrayidx584, align 8, !tbaa !5
  %arrayidx586 = getelementptr inbounds i8, ptr %215, i64 %indvars.iv1675
  store i8 %212, ptr %arrayidx586, align 1, !tbaa !204
  %216 = load ptr, ptr %frame, align 8, !tbaa !42
  %ref_idx588 = getelementptr inbounds %struct.storable_picture, ptr %216, i64 0, i32 35
  %217 = load ptr, ptr %ref_idx588, align 8, !tbaa !64
  %arrayidx589 = getelementptr inbounds ptr, ptr %217, i64 1
  %218 = load ptr, ptr %arrayidx589, align 8, !tbaa !5
  %arrayidx591 = getelementptr inbounds ptr, ptr %218, i64 %idxprom512
  %219 = load ptr, ptr %arrayidx591, align 8, !tbaa !5
  %arrayidx593 = getelementptr inbounds i8, ptr %219, i64 %indvars.iv1675
  %220 = load i8, ptr %arrayidx593, align 1, !tbaa !204
  %221 = load ptr, ptr %bottom_field489, align 8, !tbaa !45
  %ref_idx595 = getelementptr inbounds %struct.storable_picture, ptr %221, i64 0, i32 35
  %222 = load ptr, ptr %ref_idx595, align 8, !tbaa !64
  %arrayidx596 = getelementptr inbounds ptr, ptr %222, i64 1
  %223 = load ptr, ptr %arrayidx596, align 8, !tbaa !5
  %arrayidx598 = getelementptr inbounds ptr, ptr %223, i64 %indvars.iv1678
  %224 = load ptr, ptr %arrayidx598, align 8, !tbaa !5
  %arrayidx600 = getelementptr inbounds i8, ptr %224, i64 %indvars.iv1675
  store i8 %220, ptr %arrayidx600, align 1, !tbaa !204
  %225 = load ptr, ptr %frame, align 8, !tbaa !42
  %ref_id602 = getelementptr inbounds %struct.storable_picture, ptr %225, i64 0, i32 37
  %226 = load ptr, ptr %ref_id602, align 8, !tbaa !66
  %arrayidx603 = getelementptr inbounds ptr, ptr %226, i64 4
  %227 = load ptr, ptr %arrayidx603, align 8, !tbaa !5
  %arrayidx605 = getelementptr inbounds ptr, ptr %227, i64 %idxprom512
  %228 = load ptr, ptr %arrayidx605, align 8, !tbaa !5
  %arrayidx607 = getelementptr inbounds i64, ptr %228, i64 %indvars.iv1675
  %229 = load i64, ptr %arrayidx607, align 8, !tbaa !205
  %230 = load ptr, ptr %bottom_field489, align 8, !tbaa !45
  %ref_id609 = getelementptr inbounds %struct.storable_picture, ptr %230, i64 0, i32 37
  %231 = load ptr, ptr %ref_id609, align 8, !tbaa !66
  %232 = load ptr, ptr %231, align 8, !tbaa !5
  %arrayidx612 = getelementptr inbounds ptr, ptr %232, i64 %indvars.iv1678
  %233 = load ptr, ptr %arrayidx612, align 8, !tbaa !5
  %arrayidx614 = getelementptr inbounds i64, ptr %233, i64 %indvars.iv1675
  store i64 %229, ptr %arrayidx614, align 8, !tbaa !205
  %arrayidx617 = getelementptr inbounds ptr, ptr %226, i64 5
  %234 = load ptr, ptr %arrayidx617, align 8, !tbaa !5
  %arrayidx619 = getelementptr inbounds ptr, ptr %234, i64 %idxprom512
  %235 = load ptr, ptr %arrayidx619, align 8, !tbaa !5
  %arrayidx621 = getelementptr inbounds i64, ptr %235, i64 %indvars.iv1675
  %236 = load i64, ptr %arrayidx621, align 8, !tbaa !205
  %arrayidx624 = getelementptr inbounds ptr, ptr %231, i64 1
  %237 = load ptr, ptr %arrayidx624, align 8, !tbaa !5
  %arrayidx626 = getelementptr inbounds ptr, ptr %237, i64 %indvars.iv1678
  %238 = load ptr, ptr %arrayidx626, align 8, !tbaa !5
  %arrayidx628 = getelementptr inbounds i64, ptr %238, i64 %indvars.iv1675
  store i64 %236, ptr %arrayidx628, align 8, !tbaa !205
  %mv630 = getelementptr inbounds %struct.storable_picture, ptr %225, i64 0, i32 38
  %239 = load ptr, ptr %mv630, align 8, !tbaa !67
  %240 = load ptr, ptr %239, align 8, !tbaa !5
  %arrayidx633 = getelementptr inbounds ptr, ptr %240, i64 %idxprom632
  %241 = load ptr, ptr %arrayidx633, align 8, !tbaa !5
  %arrayidx635 = getelementptr inbounds ptr, ptr %241, i64 %indvars.iv1675
  %242 = load ptr, ptr %arrayidx635, align 8, !tbaa !5
  %243 = load i16, ptr %242, align 2, !tbaa !223
  %244 = load ptr, ptr %top_field484, align 8, !tbaa !44
  %mv638 = getelementptr inbounds %struct.storable_picture, ptr %244, i64 0, i32 38
  %245 = load ptr, ptr %mv638, align 8, !tbaa !67
  %246 = load ptr, ptr %245, align 8, !tbaa !5
  %arrayidx641 = getelementptr inbounds ptr, ptr %246, i64 %indvars.iv1678
  %247 = load ptr, ptr %arrayidx641, align 8, !tbaa !5
  %arrayidx643 = getelementptr inbounds ptr, ptr %247, i64 %indvars.iv1675
  %248 = load ptr, ptr %arrayidx643, align 8, !tbaa !5
  store i16 %243, ptr %248, align 2, !tbaa !223
  %arrayidx652 = getelementptr inbounds i16, ptr %242, i64 1
  %249 = load i16, ptr %arrayidx652, align 2, !tbaa !223
  %arrayidx660 = getelementptr inbounds i16, ptr %248, i64 1
  store i16 %249, ptr %arrayidx660, align 2, !tbaa !223
  %arrayidx663 = getelementptr inbounds ptr, ptr %239, i64 1
  %250 = load ptr, ptr %arrayidx663, align 8, !tbaa !5
  %arrayidx665 = getelementptr inbounds ptr, ptr %250, i64 %idxprom632
  %251 = load ptr, ptr %arrayidx665, align 8, !tbaa !5
  %arrayidx667 = getelementptr inbounds ptr, ptr %251, i64 %indvars.iv1675
  %252 = load ptr, ptr %arrayidx667, align 8, !tbaa !5
  %253 = load i16, ptr %252, align 2, !tbaa !223
  %arrayidx671 = getelementptr inbounds ptr, ptr %245, i64 1
  %254 = load ptr, ptr %arrayidx671, align 8, !tbaa !5
  %arrayidx673 = getelementptr inbounds ptr, ptr %254, i64 %indvars.iv1678
  %255 = load ptr, ptr %arrayidx673, align 8, !tbaa !5
  %arrayidx675 = getelementptr inbounds ptr, ptr %255, i64 %indvars.iv1675
  %256 = load ptr, ptr %arrayidx675, align 8, !tbaa !5
  store i16 %253, ptr %256, align 2, !tbaa !223
  %arrayidx684 = getelementptr inbounds i16, ptr %252, i64 1
  %257 = load i16, ptr %arrayidx684, align 2, !tbaa !223
  %arrayidx692 = getelementptr inbounds i16, ptr %256, i64 1
  store i16 %257, ptr %arrayidx692, align 2, !tbaa !223
  %ref_idx694 = getelementptr inbounds %struct.storable_picture, ptr %225, i64 0, i32 35
  %258 = load ptr, ptr %ref_idx694, align 8, !tbaa !64
  %259 = load ptr, ptr %258, align 8, !tbaa !5
  %arrayidx697 = getelementptr inbounds ptr, ptr %259, i64 %idxprom632
  %260 = load ptr, ptr %arrayidx697, align 8, !tbaa !5
  %arrayidx699 = getelementptr inbounds i8, ptr %260, i64 %indvars.iv1675
  %261 = load i8, ptr %arrayidx699, align 1, !tbaa !204
  %ref_idx701 = getelementptr inbounds %struct.storable_picture, ptr %244, i64 0, i32 35
  %262 = load ptr, ptr %ref_idx701, align 8, !tbaa !64
  %263 = load ptr, ptr %262, align 8, !tbaa !5
  %arrayidx704 = getelementptr inbounds ptr, ptr %263, i64 %indvars.iv1678
  %264 = load ptr, ptr %arrayidx704, align 8, !tbaa !5
  %arrayidx706 = getelementptr inbounds i8, ptr %264, i64 %indvars.iv1675
  store i8 %261, ptr %arrayidx706, align 1, !tbaa !204
  %265 = load ptr, ptr %frame, align 8, !tbaa !42
  %ref_idx708 = getelementptr inbounds %struct.storable_picture, ptr %265, i64 0, i32 35
  %266 = load ptr, ptr %ref_idx708, align 8, !tbaa !64
  %arrayidx709 = getelementptr inbounds ptr, ptr %266, i64 1
  %267 = load ptr, ptr %arrayidx709, align 8, !tbaa !5
  %arrayidx711 = getelementptr inbounds ptr, ptr %267, i64 %idxprom632
  %268 = load ptr, ptr %arrayidx711, align 8, !tbaa !5
  %arrayidx713 = getelementptr inbounds i8, ptr %268, i64 %indvars.iv1675
  %269 = load i8, ptr %arrayidx713, align 1, !tbaa !204
  %270 = load ptr, ptr %top_field484, align 8, !tbaa !44
  %ref_idx715 = getelementptr inbounds %struct.storable_picture, ptr %270, i64 0, i32 35
  %271 = load ptr, ptr %ref_idx715, align 8, !tbaa !64
  %arrayidx716 = getelementptr inbounds ptr, ptr %271, i64 1
  %272 = load ptr, ptr %arrayidx716, align 8, !tbaa !5
  %arrayidx718 = getelementptr inbounds ptr, ptr %272, i64 %indvars.iv1678
  %273 = load ptr, ptr %arrayidx718, align 8, !tbaa !5
  %arrayidx720 = getelementptr inbounds i8, ptr %273, i64 %indvars.iv1675
  store i8 %269, ptr %arrayidx720, align 1, !tbaa !204
  %274 = load ptr, ptr %frame, align 8, !tbaa !42
  %ref_id722 = getelementptr inbounds %struct.storable_picture, ptr %274, i64 0, i32 37
  %275 = load ptr, ptr %ref_id722, align 8, !tbaa !66
  %arrayidx723 = getelementptr inbounds ptr, ptr %275, i64 2
  %276 = load ptr, ptr %arrayidx723, align 8, !tbaa !5
  %arrayidx725 = getelementptr inbounds ptr, ptr %276, i64 %idxprom632
  %277 = load ptr, ptr %arrayidx725, align 8, !tbaa !5
  %arrayidx727 = getelementptr inbounds i64, ptr %277, i64 %indvars.iv1675
  %278 = load i64, ptr %arrayidx727, align 8, !tbaa !205
  %279 = load ptr, ptr %top_field484, align 8, !tbaa !44
  %ref_id729 = getelementptr inbounds %struct.storable_picture, ptr %279, i64 0, i32 37
  %280 = load ptr, ptr %ref_id729, align 8, !tbaa !66
  %281 = load ptr, ptr %280, align 8, !tbaa !5
  %arrayidx732 = getelementptr inbounds ptr, ptr %281, i64 %indvars.iv1678
  %282 = load ptr, ptr %arrayidx732, align 8, !tbaa !5
  %arrayidx734 = getelementptr inbounds i64, ptr %282, i64 %indvars.iv1675
  store i64 %278, ptr %arrayidx734, align 8, !tbaa !205
  %arrayidx737 = getelementptr inbounds ptr, ptr %275, i64 3
  %283 = load ptr, ptr %arrayidx737, align 8, !tbaa !5
  %arrayidx739 = getelementptr inbounds ptr, ptr %283, i64 %idxprom632
  %284 = load ptr, ptr %arrayidx739, align 8, !tbaa !5
  %arrayidx741 = getelementptr inbounds i64, ptr %284, i64 %indvars.iv1675
  %285 = load i64, ptr %arrayidx741, align 8, !tbaa !205
  %arrayidx744 = getelementptr inbounds ptr, ptr %280, i64 1
  %286 = load ptr, ptr %arrayidx744, align 8, !tbaa !5
  %arrayidx746 = getelementptr inbounds ptr, ptr %286, i64 %indvars.iv1678
  %287 = load ptr, ptr %arrayidx746, align 8, !tbaa !5
  %arrayidx748 = getelementptr inbounds i64, ptr %287, i64 %indvars.iv1675
  store i64 %285, ptr %arrayidx748, align 8, !tbaa !205
  br label %for.inc750

for.inc750:                                       ; preds = %for.body470, %if.then483
  %288 = phi ptr [ %171, %for.body470 ], [ %274, %if.then483 ]
  %289 = phi ptr [ %172, %for.body470 ], [ %274, %if.then483 ]
  %indvars.iv.next1676 = add nuw nsw i64 %indvars.iv1675, 1
  %size_x466 = getelementptr inbounds %struct.storable_picture, ptr %289, i64 0, i32 18
  %290 = load i32, ptr %size_x466, align 8, !tbaa !52
  %div467 = sdiv i32 %290, 4
  %291 = sext i32 %div467 to i64
  %cmp468 = icmp slt i64 %indvars.iv.next1676, %291
  br i1 %cmp468, label %for.body470, label %for.inc753, !llvm.loop !224

for.inc753:                                       ; preds = %for.inc750, %for.body457
  %292 = phi ptr [ %165, %for.body457 ], [ %288, %for.inc750 ]
  %indvars.iv.next1679 = add nuw nsw i64 %indvars.iv1678, 1
  %size_y453 = getelementptr inbounds %struct.storable_picture, ptr %292, i64 0, i32 19
  %293 = load i32, ptr %size_y453, align 4, !tbaa !53
  %div454 = sdiv i32 %293, 8
  %294 = sext i32 %div454 to i64
  %cmp455 = icmp slt i64 %indvars.iv.next1679, %294
...
for.cond760.preheader:                            ; preds = %land.lhs.true446, %if.end756
  %295 = phi ptr [ %292, %if.end756 ], [ %112, %land.lhs.true446 ]
  %296 = phi i32 [ %293, %if.end756 ], [ %113, %land.lhs.true446 ]
  %cmp7641637 = icmp sgt i32 %296, 7
...
for.body766:                                      ; preds = %for.body766.lr.ph, %for.inc1109
  %297 = phi ptr [ %295, %for.body766.lr.ph ], [ %416, %for.inc1109 ]
  %indvars.iv1685 = phi i64 [ 0, %for.body766.lr.ph ], [ %indvars.iv.next1686, %for.inc1109 ]
  %298 = trunc i64 %indvars.iv1685 to i32
  %and.i = lshr i32 %298, 1
  %and.lobit.i = and i32 %and.i, 1
  %size_x7721631 = getelementptr inbounds %struct.storable_picture, ptr %297, i64 0, i32 18
  %299 = load i32, ptr %size_x7721631, align 8, !tbaa !52
  %cmp7741633 = icmp sgt i32 %299, 3
  br i1 %cmp7741633, label %for.body776.lr.ph, label %for.inc1109

for.body776.lr.ph:                                ; preds = %for.body766
  %and1.i = and i32 %298, 2147483646
  %cond.i = or i32 %and.lobit.i, %and1.i
  %mul768 = shl nuw nsw i32 %cond.i, 1
  %div7791560 = lshr i32 %298, 2
  %mul780 = mul nsw i32 %div7791560, %mul
  %300 = shl nuw nsw i64 %indvars.iv1685, 1
  %301 = or i64 %300, 1
...
for.body776:                                      ; preds = %for.body776.lr.ph, %for.inc1106
  ...
  %302 = phi ptr [ %297, %for.body776.lr.ph ], [ %413, %for.inc1106 ]
  %303 = trunc i64 %indvars.iv1682 to i32
  %and1.i1568 = and i32 %303, 2147483646
  %and.i1569 = lshr i32 %303, 1
  %and.lobit.i1570 = and i32 %and.i1569, 1
  %cond.i1571 = or i32 %and.lobit.i1570, %and1.i1568
  %MbaffFrameFlag786 = getelementptr inbounds %struct.storable_picture, ptr %302, i64 0, i32 28
  %304 = load i32, ptr %MbaffFrameFlag786, align 8, !tbaa !63
  %tobool787.not = icmp eq i32 %304, 0
...
lor.lhs.false:                                    ; preds = %for.body776
  ...
  %mb_field789 = getelementptr inbounds %struct.storable_picture, ptr %302, i64 0, i32 34
  %305 = load ptr, ptr %mb_field789, align 8, !tbaa !49
  %idxprom790 = sext i32 %add784 to i64
  %arrayidx791 = getelementptr inbounds i8, ptr %305, i64 %idxprom790
  %306 = load i8, ptr %arrayidx791, align 1, !tbaa !204
  %tobool792.not = icmp eq i8 %306, 0
  br i1 %tobool792.not, label %if.then793, label %if.else1085

if.then793:                                       ; preds = %lor.lhs.false, %for.body776
  %field_frame795 = getelementptr inbounds %struct.storable_picture, ptr %302, i64 0, i32 40
  %307 = load ptr, ptr %field_frame795, align 8, !tbaa !69
  %arrayidx798 = getelementptr inbounds ptr, ptr %307, i64 %300
  %308 = load ptr, ptr %arrayidx798, align 8, !tbaa !5
  %arrayidx800 = getelementptr inbounds i8, ptr %308, i64 %indvars.iv1682
  store i8 0, ptr %arrayidx800, align 1, !tbaa !204
  %309 = load ptr, ptr %frame, align 8, !tbaa !42
  %field_frame802 = getelementptr inbounds %struct.storable_picture, ptr %309, i64 0, i32 40
  %310 = load ptr, ptr %field_frame802, align 8, !tbaa !69
  %arrayidx806 = getelementptr inbounds ptr, ptr %310, i64 %301
  %311 = load ptr, ptr %arrayidx806, align 8, !tbaa !5
  %arrayidx808 = getelementptr inbounds i8, ptr %311, i64 %indvars.iv1682
  store i8 0, ptr %arrayidx808, align 1, !tbaa !204
  %312 = load ptr, ptr %bottom_field809, align 8, !tbaa !45
  %field_frame810 = getelementptr inbounds %struct.storable_picture, ptr %312, i64 0, i32 40
  %313 = load ptr, ptr %field_frame810, align 8, !tbaa !69
  %arrayidx812 = getelementptr inbounds ptr, ptr %313, i64 %indvars.iv1685
  %314 = load ptr, ptr %arrayidx812, align 8, !tbaa !5
  %arrayidx814 = getelementptr inbounds i8, ptr %314, i64 %indvars.iv1682
  store i8 0, ptr %arrayidx814, align 1, !tbaa !204
  %315 = load ptr, ptr %top_field815, align 8, !tbaa !44
  %field_frame816 = getelementptr inbounds %struct.storable_picture, ptr %315, i64 0, i32 40
  %316 = load ptr, ptr %field_frame816, align 8, !tbaa !69
  %arrayidx818 = getelementptr inbounds ptr, ptr %316, i64 %indvars.iv1685
  %317 = load ptr, ptr %arrayidx818, align 8, !tbaa !5
  %arrayidx820 = getelementptr inbounds i8, ptr %317, i64 %indvars.iv1682
  store i8 0, ptr %arrayidx820, align 1, !tbaa !204
  %318 = load ptr, ptr %frame, align 8, !tbaa !42
  %mv822 = getelementptr inbounds %struct.storable_picture, ptr %318, i64 0, i32 38
  %319 = load ptr, ptr %mv822, align 8, !tbaa !67
  %320 = load ptr, ptr %319, align 8, !tbaa !5
  %arrayidx825 = getelementptr inbounds ptr, ptr %320, i64 %idxprom824
  %321 = load ptr, ptr %arrayidx825, align 8, !tbaa !5
  %idxprom826 = zext i32 %cond.i1571 to i64
  %arrayidx827 = getelementptr inbounds ptr, ptr %321, i64 %idxprom826
  %322 = load ptr, ptr %arrayidx827, align 8, !tbaa !5
  %323 = load i16, ptr %322, align 2, !tbaa !223
  %324 = load ptr, ptr %bottom_field809, align 8, !tbaa !45
  %mv830 = getelementptr inbounds %struct.storable_picture, ptr %324, i64 0, i32 38
  %325 = load ptr, ptr %mv830, align 8, !tbaa !67
  %326 = load ptr, ptr %325, align 8, !tbaa !5
  %arrayidx833 = getelementptr inbounds ptr, ptr %326, i64 %indvars.iv1685
  %327 = load ptr, ptr %arrayidx833, align 8, !tbaa !5
  %arrayidx835 = getelementptr inbounds ptr, ptr %327, i64 %indvars.iv1682
  %328 = load ptr, ptr %arrayidx835, align 8, !tbaa !5
  store i16 %323, ptr %328, align 2, !tbaa !223
  %329 = load ptr, ptr %top_field815, align 8, !tbaa !44
  %mv838 = getelementptr inbounds %struct.storable_picture, ptr %329, i64 0, i32 38
  %330 = load ptr, ptr %mv838, align 8, !tbaa !67
  %331 = load ptr, ptr %330, align 8, !tbaa !5
  %arrayidx841 = getelementptr inbounds ptr, ptr %331, i64 %indvars.iv1685
  %332 = load ptr, ptr %arrayidx841, align 8, !tbaa !5
  %arrayidx843 = getelementptr inbounds ptr, ptr %332, i64 %indvars.iv1682
  %333 = load ptr, ptr %arrayidx843, align 8, !tbaa !5
  store i16 %323, ptr %333, align 2, !tbaa !223
  %arrayidx852 = getelementptr inbounds i16, ptr %322, i64 1
  %334 = load i16, ptr %arrayidx852, align 2, !tbaa !223
  %arrayidx860 = getelementptr inbounds i16, ptr %328, i64 1
  store i16 %334, ptr %arrayidx860, align 2, !tbaa !223
  %arrayidx868 = getelementptr inbounds i16, ptr %333, i64 1
  store i16 %334, ptr %arrayidx868, align 2, !tbaa !223
  %arrayidx871 = getelementptr inbounds ptr, ptr %319, i64 1
  %335 = load ptr, ptr %arrayidx871, align 8, !tbaa !5
  %arrayidx873 = getelementptr inbounds ptr, ptr %335, i64 %idxprom824
  %336 = load ptr, ptr %arrayidx873, align 8, !tbaa !5
  %arrayidx875 = getelementptr inbounds ptr, ptr %336, i64 %idxprom826
  %337 = load ptr, ptr %arrayidx875, align 8, !tbaa !5
  %338 = load i16, ptr %337, align 2, !tbaa !223
  %arrayidx879 = getelementptr inbounds ptr, ptr %325, i64 1
  %339 = load ptr, ptr %arrayidx879, align 8, !tbaa !5
  %arrayidx881 = getelementptr inbounds ptr, ptr %339, i64 %indvars.iv1685
  %340 = load ptr, ptr %arrayidx881, align 8, !tbaa !5
  %arrayidx883 = getelementptr inbounds ptr, ptr %340, i64 %indvars.iv1682
  %341 = load ptr, ptr %arrayidx883, align 8, !tbaa !5
  store i16 %338, ptr %341, align 2, !tbaa !223
  %arrayidx887 = getelementptr inbounds ptr, ptr %330, i64 1
  %342 = load ptr, ptr %arrayidx887, align 8, !tbaa !5
  %arrayidx889 = getelementptr inbounds ptr, ptr %342, i64 %indvars.iv1685
  %343 = load ptr, ptr %arrayidx889, align 8, !tbaa !5
  %arrayidx891 = getelementptr inbounds ptr, ptr %343, i64 %indvars.iv1682
  %344 = load ptr, ptr %arrayidx891, align 8, !tbaa !5
  store i16 %338, ptr %344, align 2, !tbaa !223
  %arrayidx900 = getelementptr inbounds i16, ptr %337, i64 1
  %345 = load i16, ptr %arrayidx900, align 2, !tbaa !223
  %arrayidx908 = getelementptr inbounds i16, ptr %341, i64 1
  store i16 %345, ptr %arrayidx908, align 2, !tbaa !223
  %arrayidx916 = getelementptr inbounds i16, ptr %344, i64 1
  store i16 %345, ptr %arrayidx916, align 2, !tbaa !223
  %ref_idx918 = getelementptr inbounds %struct.storable_picture, ptr %318, i64 0, i32 35
  %346 = load ptr, ptr %ref_idx918, align 8, !tbaa !64
  %347 = load ptr, ptr %346, align 8, !tbaa !5
  %arrayidx921 = getelementptr inbounds ptr, ptr %347, i64 %idxprom824
  %348 = load ptr, ptr %arrayidx921, align 8, !tbaa !5
  %arrayidx923 = getelementptr inbounds i8, ptr %348, i64 %idxprom826
  %349 = load i8, ptr %arrayidx923, align 1, !tbaa !204
  %conv924 = sext i8 %349 to i64
  %cmp925 = icmp eq i8 %349, -1
  %ref_idx929 = getelementptr inbounds %struct.storable_picture, ptr %324, i64 0, i32 35
  %350 = load ptr, ptr %ref_idx929, align 8, !tbaa !64
  %351 = load ptr, ptr %350, align 8, !tbaa !5
  %arrayidx932 = getelementptr inbounds ptr, ptr %351, i64 %indvars.iv1685
  %352 = load ptr, ptr %arrayidx932, align 8, !tbaa !5
  %arrayidx934 = getelementptr inbounds i8, ptr %352, i64 %indvars.iv1682
  br i1 %cmp925, label %if.then927, label %if.else942

if.then927:                                       ; preds = %if.then793
  store i8 -1, ptr %arrayidx934, align 1, !tbaa !204
  %353 = load ptr, ptr %top_field815, align 8, !tbaa !44
  %ref_idx936 = getelementptr inbounds %struct.storable_picture, ptr %353, i64 0, i32 35
  %354 = load ptr, ptr %ref_idx936, align 8, !tbaa !64
  %355 = load ptr, ptr %354, align 8, !tbaa !5
  %arrayidx939 = getelementptr inbounds ptr, ptr %355, i64 %indvars.iv1685
  %356 = load ptr, ptr %arrayidx939, align 8, !tbaa !5
  %arrayidx941 = getelementptr inbounds i8, ptr %356, i64 %indvars.iv1682
  store i8 -1, ptr %arrayidx941, align 1, !tbaa !204
  br label %if.end999

if.else942:                                       ; preds = %if.then793
  store i8 %349, ptr %arrayidx934, align 1, !tbaa !204
  %357 = load ptr, ptr %top_field815, align 8, !tbaa !44
  %ref_idx958 = getelementptr inbounds %struct.storable_picture, ptr %357, i64 0, i32 35
  %358 = load ptr, ptr %ref_idx958, align 8, !tbaa !64
  %359 = load ptr, ptr %358, align 8, !tbaa !5
  %arrayidx961 = getelementptr inbounds ptr, ptr %359, i64 %indvars.iv1685
  %360 = load ptr, ptr %arrayidx961, align 8, !tbaa !5
  %arrayidx963 = getelementptr inbounds i8, ptr %360, i64 %indvars.iv1682
  store i8 %349, ptr %arrayidx963, align 1, !tbaa !204
  %cmp965 = icmp sgt i8 %349, -1
  br i1 %cmp965, label %cond.true967, label %cond.end990.critedge

cond.true967:                                     ; preds = %if.else942
  %361 = load ptr, ptr %frame, align 8, !tbaa !42
  %top_ref_pic_num = getelementptr inbounds %struct.storable_picture, ptr %361, i64 0, i32 8
  ...
  %362 = load i64, ptr %arrayidx971, align 8, !tbaa !205
  %363 = load ptr, ptr %top_field815, align 8, !tbaa !44
  %ref_id976 = getelementptr inbounds %struct.storable_picture, ptr %363, i64 0, i32 37
  %364 = load ptr, ptr %ref_id976, align 8, !tbaa !66
  %365 = load ptr, ptr %364, align 8, !tbaa !5
  %arrayidx979 = getelementptr inbounds ptr, ptr %365, i64 %indvars.iv1685
  %366 = load ptr, ptr %arrayidx979, align 8, !tbaa !5
  %arrayidx981 = getelementptr inbounds i64, ptr %366, i64 %indvars.iv1682
  store i64 %362, ptr %arrayidx981, align 8, !tbaa !205
  %bottom_ref_pic_num = getelementptr inbounds %struct.storable_picture, ptr %361, i64 0, i32 9
  %arrayidx988 = getelementptr inbounds [33 x i64], ptr %bottom_ref_pic_num, i64 0, i64 %idxprom970
  %367 = load i64, ptr %arrayidx988, align 8, !tbaa !205
  br label %cond.end990

cond.end990.critedge:                             ; preds = %if.else942
  %368 = load ptr, ptr %top_field815, align 8, !tbaa !44
  %ref_id976.c = getelementptr inbounds %struct.storable_picture, ptr %368, i64 0, i32 37
  %369 = load ptr, ptr %ref_id976.c, align 8, !tbaa !66
  %370 = load ptr, ptr %369, align 8, !tbaa !5
  %arrayidx979.c = getelementptr inbounds ptr, ptr %370, i64 %indvars.iv1685
  %371 = load ptr, ptr %arrayidx979.c, align 8, !tbaa !5
  %arrayidx981.c = getelementptr inbounds i64, ptr %371, i64 %indvars.iv1682
  store i64 0, ptr %arrayidx981.c, align 8, !tbaa !205
  br label %cond.end990

cond.end990:                                      ; preds = %cond.end990.critedge, %cond.true967
  %cond991 = phi i64 [ %367, %cond.true967 ], [ 0, %cond.end990.critedge ]
  %372 = load ptr, ptr %bottom_field809, align 8, !tbaa !45
  %ref_id993 = getelementptr inbounds %struct.storable_picture, ptr %372, i64 0, i32 37
  %373 = load ptr, ptr %ref_id993, align 8, !tbaa !66
  %374 = load ptr, ptr %373, align 8, !tbaa !5
  %arrayidx996 = getelementptr inbounds ptr, ptr %374, i64 %indvars.iv1685
  %375 = load ptr, ptr %arrayidx996, align 8, !tbaa !5
  %arrayidx998 = getelementptr inbounds i64, ptr %375, i64 %indvars.iv1682
  store i64 %cond991, ptr %arrayidx998, align 8, !tbaa !205
  br label %if.end999

if.end999:                                        ; preds = %cond.end990, %if.then927
  %376 = load ptr, ptr %frame, align 8, !tbaa !42
  %ref_idx1001 = getelementptr inbounds %struct.storable_picture, ptr %376, i64 0, i32 35
  %377 = load ptr, ptr %ref_idx1001, align 8, !tbaa !64
  %arrayidx1002 = getelementptr inbounds ptr, ptr %377, i64 1
  %378 = load ptr, ptr %arrayidx1002, align 8, !tbaa !5
  %arrayidx1004 = getelementptr inbounds ptr, ptr %378, i64 %idxprom824
  %379 = load ptr, ptr %arrayidx1004, align 8, !tbaa !5
  %arrayidx1006 = getelementptr inbounds i8, ptr %379, i64 %idxprom826
  %380 = load i8, ptr %arrayidx1006, align 1, !tbaa !204
  %conv1007 = sext i8 %380 to i64
  %cmp1008 = icmp eq i8 %380, -1
  %381 = load ptr, ptr %bottom_field809, align 8, !tbaa !45
  %ref_idx1012 = getelementptr inbounds %struct.storable_picture, ptr %381, i64 0, i32 35
  %382 = load ptr, ptr %ref_idx1012, align 8, !tbaa !64
  %arrayidx1013 = getelementptr inbounds ptr, ptr %382, i64 1
  %383 = load ptr, ptr %arrayidx1013, align 8, !tbaa !5
  %arrayidx1015 = getelementptr inbounds ptr, ptr %383, i64 %indvars.iv1685
  %384 = load ptr, ptr %arrayidx1015, align 8, !tbaa !5
  %arrayidx1017 = getelementptr inbounds i8, ptr %384, i64 %indvars.iv1682
  br i1 %cmp1008, label %if.then1010, label %if.else1025

if.then1010:                                      ; preds = %if.end999
  store i8 -1, ptr %arrayidx1017, align 1, !tbaa !204
  %385 = load ptr, ptr %top_field815, align 8, !tbaa !44
  %ref_idx1019 = getelementptr inbounds %struct.storable_picture, ptr %385, i64 0, i32 35
  %386 = load ptr, ptr %ref_idx1019, align 8, !tbaa !64
  %arrayidx1020 = getelementptr inbounds ptr, ptr %386, i64 1
  %387 = load ptr, ptr %arrayidx1020, align 8, !tbaa !5
  %arrayidx1022 = getelementptr inbounds ptr, ptr %387, i64 %indvars.iv1685
  %388 = load ptr, ptr %arrayidx1022, align 8, !tbaa !5
  %arrayidx1024 = getelementptr inbounds i8, ptr %388, i64 %indvars.iv1682
  store i8 -1, ptr %arrayidx1024, align 1, !tbaa !204
  br label %for.inc1106

if.else1025:                                      ; preds = %if.end999
  store i8 %380, ptr %arrayidx1017, align 1, !tbaa !204
  %389 = load ptr, ptr %top_field815, align 8, !tbaa !44
  %ref_idx1041 = getelementptr inbounds %struct.storable_picture, ptr %389, i64 0, i32 35
  %390 = load ptr, ptr %ref_idx1041, align 8, !tbaa !64
  %arrayidx1042 = getelementptr inbounds ptr, ptr %390, i64 1
  %391 = load ptr, ptr %arrayidx1042, align 8, !tbaa !5
  %arrayidx1044 = getelementptr inbounds ptr, ptr %391, i64 %indvars.iv1685
  %392 = load ptr, ptr %arrayidx1044, align 8, !tbaa !5
  %arrayidx1046 = getelementptr inbounds i8, ptr %392, i64 %indvars.iv1682
  store i8 %380, ptr %arrayidx1046, align 1, !tbaa !204
  %cmp1048 = icmp sgt i8 %380, -1
  br i1 %cmp1048, label %cond.true1050, label %cond.end1075.critedge

cond.true1050:                                    ; preds = %if.else1025
  %393 = load ptr, ptr %frame, align 8, !tbaa !42
  %idxprom1054 = and i64 %conv1007, 4294967295
  %arrayidx1055 = getelementptr inbounds %struct.storable_picture, ptr %393, i64 0, i32 8, i64 1, i64 %idxprom1054
  %394 = load i64, ptr %arrayidx1055, align 8, !tbaa !205
  %395 = load ptr, ptr %top_field815, align 8, !tbaa !44
  %ref_id1060 = getelementptr inbounds %struct.storable_picture, ptr %395, i64 0, i32 37
  %396 = load ptr, ptr %ref_id1060, align 8, !tbaa !66
  %arrayidx1061 = getelementptr inbounds ptr, ptr %396, i64 1
  %397 = load ptr, ptr %arrayidx1061, align 8, !tbaa !5
  %arrayidx1063 = getelementptr inbounds ptr, ptr %397, i64 %indvars.iv1685
  %398 = load ptr, ptr %arrayidx1063, align 8, !tbaa !5
  %arrayidx1065 = getelementptr inbounds i64, ptr %398, i64 %indvars.iv1682
  store i64 %394, ptr %arrayidx1065, align 8, !tbaa !205
  %arrayidx1073 = getelementptr inbounds %struct.storable_picture, ptr %393, i64 0, i32 9, i64 1, i64 %idxprom1054
  %399 = load i64, ptr %arrayidx1073, align 8, !tbaa !205
  br label %cond.end1075

cond.end1075.critedge:                            ; preds = %if.else1025
  %400 = load ptr, ptr %top_field815, align 8, !tbaa !44
  %ref_id1060.c = getelementptr inbounds %struct.storable_picture, ptr %400, i64 0, i32 37
  %401 = load ptr, ptr %ref_id1060.c, align 8, !tbaa !66
  %arrayidx1061.c = getelementptr inbounds ptr, ptr %401, i64 1
  %402 = load ptr, ptr %arrayidx1061.c, align 8, !tbaa !5
  %arrayidx1063.c = getelementptr inbounds ptr, ptr %402, i64 %indvars.iv1685
  %403 = load ptr, ptr %arrayidx1063.c, align 8, !tbaa !5
  %arrayidx1065.c = getelementptr inbounds i64, ptr %403, i64 %indvars.iv1682
  store i64 0, ptr %arrayidx1065.c, align 8, !tbaa !205
  br label %cond.end1075

cond.end1075:                                     ; preds = %cond.end1075.critedge, %cond.true1050
  %cond1076 = phi i64 [ %399, %cond.true1050 ], [ 0, %cond.end1075.critedge ]
  %404 = load ptr, ptr %bottom_field809, align 8, !tbaa !45
  %ref_id1078 = getelementptr inbounds %struct.storable_picture, ptr %404, i64 0, i32 37
  %405 = load ptr, ptr %ref_id1078, align 8, !tbaa !66
  %arrayidx1079 = getelementptr inbounds ptr, ptr %405, i64 1
  %406 = load ptr, ptr %arrayidx1079, align 8, !tbaa !5
  %arrayidx1081 = getelementptr inbounds ptr, ptr %406, i64 %indvars.iv1685
  %407 = load ptr, ptr %arrayidx1081, align 8, !tbaa !5
  %arrayidx1083 = getelementptr inbounds i64, ptr %407, i64 %indvars.iv1682
  store i64 %cond1076, ptr %arrayidx1083, align 8, !tbaa !205
  br label %for.inc1106

if.else1085:                                      ; preds = %lor.lhs.false
  %field_frame1091 = getelementptr inbounds %struct.storable_picture, ptr %302, i64 0, i32 40
  %408 = load ptr, ptr %field_frame1091, align 8, !tbaa !69
  %arrayidx1094 = getelementptr inbounds ptr, ptr %408, i64 %300
  %409 = load ptr, ptr %arrayidx1094, align 8, !tbaa !5
  %arrayidx1096 = getelementptr inbounds i8, ptr %409, i64 %indvars.iv1682
  store i8 %306, ptr %arrayidx1096, align 1, !tbaa !204
  %410 = load ptr, ptr %frame, align 8, !tbaa !42
  %field_frame1098 = getelementptr inbounds %struct.storable_picture, ptr %410, i64 0, i32 40
  %411 = load ptr, ptr %field_frame1098, align 8, !tbaa !69
  %arrayidx1102 = getelementptr inbounds ptr, ptr %411, i64 %301
  %412 = load ptr, ptr %arrayidx1102, align 8, !tbaa !5
  %arrayidx1104 = getelementptr inbounds i8, ptr %412, i64 %indvars.iv1682
  store i8 %306, ptr %arrayidx1104, align 1, !tbaa !204
  br label %for.inc1106
...
for.inc1106:                                      ; preds = %if.else1085, %cond.end1075, %if.then1010
  ...
  %size_x772 = getelementptr inbounds %struct.storable_picture, ptr %413, i64 0, i32 18
  %414 = load i32, ptr %size_x772, align 8, !tbaa !52
  %div773 = sdiv i32 %414, 4
  %415 = sext i32 %div773 to i64
  %cmp774 = icmp slt i64 %indvars.iv.next1683, %415
  br i1 %cmp774, label %for.body776, label %for.inc1109, !llvm.loop !226

for.inc1109:                                      ; preds = %for.inc1106, %for.body766
  %416 = phi ptr [ %297, %for.body766 ], [ %413, %for.inc1106 ]
  %indvars.iv.next1686 = add nuw nsw i64 %indvars.iv1685, 1
  %size_y762 = getelementptr inbounds %struct.storable_picture, ptr %416, i64 0, i32 19
  %417 = load i32, ptr %size_y762, align 4, !tbaa !53
  %div763 = sdiv i32 %417, 8
  %418 = sext i32 %div763 to i64
  %cmp764 = icmp slt i64 %indvars.iv.next1686, %418
  br i1 %cmp764, label %for.body766, label %if.end1125, !llvm.loop !227

if.else1112:                                      ; preds = %for.end443, %if.end756
  %419 = phi ptr [ %292, %if.end756 ], [ %112, %for.end443 ]
  %420 = phi i32 [ %293, %if.end756 ], [ %113, %for.end443 ]
  %field_frame1114 = getelementptr inbounds %struct.storable_picture, ptr %419, i64 0, i32 40
  %421 = load ptr, ptr %field_frame1114, align 8, !tbaa !69
  %422 = load ptr, ptr %421, align 8, !tbaa !5
  %size_x1120 = getelementptr inbounds %struct.storable_picture, ptr %419, i64 0, i32 18
  %423 = load i32, ptr %size_x1120, align 8, !tbaa !52
  %shr1121 = ashr i32 %423, 4
  %mul1122 = mul nsw i32 %shr1121, %420
  %conv1123 = sext i32 %mul1122 to i64
  tail call void @llvm.memset.p0.i64(ptr align 1 %422, i8 0, i64 %conv1123, i1 false)
  br label %if.end1125
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local void @gen_field_ref_ids(ptr nocapture noundef readonly %p) local_unnamed_addr #8 {
entry:
...
vector.memcheck:                                  ; preds = %for.body.lr.ph
  %uglygep = getelementptr i8, ptr %4, i64 288
  %5 = shl nuw nsw i64 %wide.trip.count, 3
  %6 = add nuw nsw i64 %5, 288
  %uglygep599 = getelementptr i8, ptr %4, i64 %6
  %uglygep600 = getelementptr i8, ptr %2, i64 288
  %7 = shl nuw nsw i64 %wide.trip.count, 4
  %8 = add nuw nsw i64 %7, 280
  %uglygep601 = getelementptr i8, ptr %2, i64 %8
  %uglygep602 = getelementptr i8, ptr %3, i64 288
  %uglygep603 = getelementptr i8, ptr %3, i64 %8
  %bound0 = icmp ult ptr %uglygep, %uglygep601
  %bound1 = icmp ult ptr %uglygep600, %uglygep599
  %found.conflict = and i1 %bound0, %bound1
  %bound0604 = icmp ult ptr %uglygep, %uglygep603
  %bound1605 = icmp ult ptr %uglygep602, %uglygep599
...
vector.memcheck609:                               ; preds = %for.body20.lr.ph
  ...
  %uglygep610 = getelementptr i8, ptr %24, i64 %26
  %27 = shl nuw nsw i64 %wide.trip.count585, 4
  %28 = add nuw nsw i64 %27, 16
  %uglygep611 = getelementptr i8, ptr %22, i64 %28
  %uglygep612 = getelementptr i8, ptr %23, i64 %28
  %bound0613 = icmp ult ptr %ref_pic_num39, %uglygep611
  %bound1614 = icmp ult ptr %ref_pic_num22, %uglygep610
  %found.conflict615 = and i1 %bound0613, %bound1614
  %bound0616 = icmp ult ptr %ref_pic_num39, %uglygep612
  %bound1617 = icmp ult ptr %ref_pic_num30, %uglygep610
...
define dso_local void @free_ref_pic_list_reordering_buffer(ptr nocapture noundef %currSlice) local_unnamed_addr #11 {
entry:
  %reordering_of_pic_nums_idc_l0 = getelementptr inbounds %struct.Slice, ptr %currSlice, i64 0, i32 10
...
define dso_local void @compute_colocated(ptr noundef %p, ptr nocapture noundef readonly %listX) local_unnamed_addr #12 {
entry:
...
for.cond1948.preheader:                           ; preds = %for.cond1858.for.inc1945_crit_edge.split.us2916, %for.cond1858.for.inc1945_crit_edge.split.us.us.us.split.split, %for.cond1858.for.inc1945_crit_edge.split.us.us.us.split.us.us, %for.cond1858.preheader.lr.ph, %for.cond1852.preheader
  ...
  %mul19502930 = shl nsw i32 %668, 2
  %add19512931 = or i32 %mul19502930, 2
  %cmp19522932 = icmp sgt i32 %add19512931, 0
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define internal fastcc void @unmark_long_term_field_for_reference_by_frame_idx(i32 noundef %structure, i32 noundef %long_term_frame_idx, i32 noundef %mark_current, i32 noundef %curr_frame_num, i32 noundef %curr_pic_num) unnamed_addr #8 {
entry:
  %0 = load i32, ptr getelementptr inbounds (%struct.decoded_picture_buffer, ptr @dpb, i64 0, i32 6), align 4, !tbaa !19
