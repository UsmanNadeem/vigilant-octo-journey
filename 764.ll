; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxcolor.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/gxcolor.c"
...
; Function Attrs: mustprogress nofree nosync nounwind willreturn memory(argmem: readwrite) uwtable
define dso_local void @gx_color_from_hsb(ptr nocapture noundef %pcolor, i16 noundef zeroext %hue, i16 noundef zeroext %saturation, i16 noundef zeroext %brightness) local_unnamed_addr #1 {
entry:
...
define dso_local void @gx_sort_ht_order(ptr nocapture noundef %recs, i32 noundef %N) local_unnamed_addr #3 {
entry:
