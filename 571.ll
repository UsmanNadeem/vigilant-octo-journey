; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/d/gram.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/d/gram.c"
...
entry:
  ...
  br i1 %cmp199.not.i, label %if.end, label %for.body.lr.ph.i

for.body.lr.ph.i:                                 ; preds = %entry
  %sext = shl i64 %call, 32
  %conv181.i = ashr exact i64 %sext, 32
...
cleanup.i:                                        ; preds = %for.body.i
  ...
  %call182.i = tail call i32 @strncmp(ptr noundef %3, ptr noundef %name, i64 noundef %conv181.i) #22
  %tobool183.not.not.i = icmp eq i32 %call182.i, 0
  br i1 %tobool183.not.not.i, label %cleanup, label %for.inc.i
...
if.end43:                                         ; preds = %if.then15, %if.else29
  tail call void @vec_add_internal(ptr noundef nonnull %productions.i, ptr noundef nonnull %calloc) #23
  br label %do.end

do.end:                                           ; preds = %if.end43, %if.then33, %if.then20, %if.then4
  store ptr %name, ptr %calloc, align 8, !tbaa !17
  %call46 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %name) #22
...
entry:
  ...
  br i1 %cmp199.not, label %cleanup186, label %for.body.lr.ph

for.body.lr.ph:                                   ; preds = %entry
  %v = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 1, i32 2
  %1 = load ptr, ptr %v, align 8, !tbaa !13
  %conv181 = sext i32 %l to i64
...
cleanup:                                          ; preds = %for.body
  ...
  %call182 = tail call i32 @strncmp(ptr noundef %4, ptr noundef %name, i64 noundef %conv181) #22
  %tobool183.not.not = icmp eq i32 %call182, 0
  br i1 %tobool183.not.not, label %cleanup186, label %for.inc

for.inc:                                          ; preds = %for.body, %cleanup
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %cleanup186, label %for.body, !llvm.loop !18

cleanup186:                                       ; preds = %cleanup, %for.inc, %entry
...
entry:
  %call = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s) #22
  %add = shl i64 %call, 1
  %mul = add i64 %add, 2
...
sw.bb28.i:                                        ; preds = %if.then.i
  %call.i = tail call ptr @__ctype_b_loc() #25
...
sw.bb47.i:                                        ; preds = %if.then.i
  %call48.i = tail call ptr @__ctype_b_loc() #25
...
sw.bb108.i:                                       ; preds = %if.then.i, %if.then.i, %if.then.i, %if.then.i, %if.then.i, %if.then.i, %if.then.i, %if.then.i
  %call110.i = tail call ptr @__ctype_b_loc() #25
...
if.then156.i:                                     ; preds = %sw.bb108.i, %if.then128.i, %Lncont.if.then156_crit_edge.i
  ...
  %call161.i = tail call i64 @strtol(ptr nocapture noundef nonnull %start.3282.i, ptr noundef null, i32 noundef %base.3284.i) #23
...
cleanup.thread.i:                                 ; preds = %if.then156.i
  ...
  tail call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.46, ptr noundef %34) #23
...
for.end.i:                                        ; preds = %for.cond.i
  ...
  %call181.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %37) #22
...
if.then185.i:                                     ; preds = %for.end.i
  tail call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.47, ptr noundef %37) #23
  br label %unescape_term_string.exit
...
entry:
  ...
  %call1 = tail call noalias ptr @malloc(i64 noundef %add) #24
...
if.end52:                                         ; preds = %if.then25, %if.else38
  tail call void @vec_add_internal(ptr noundef nonnull %terminals, ptr noundef nonnull %calloc.i) #23
  br label %do.end
...
if.end38.i:                                       ; preds = %if.else24.i, %if.then12.i
  tail call void @vec_add_internal(ptr noundef nonnull %elems.i, ptr noundef nonnull %calloc.i.i) #23
  br label %new_elem_term.exit
...
entry:
  ...
  %call1 = tail call ptr @dup_str(ptr noundef %s, ptr noundef %e) #23
  %e2 = getelementptr inbounds %struct.Elem, ptr %calloc.i, i64 0, i32 3
  store ptr %call1, ptr %e2, align 8, !tbaa !28
  %call5 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call1) #22
...
if.end47:                                         ; preds = %if.then20, %if.else33
  tail call void @vec_add_internal(ptr noundef nonnull %elems, ptr noundef nonnull %calloc.i) #23
  br label %if.end49
...
entry:
  %call = tail call noalias dereferenceable_or_null(32) ptr @malloc(i64 noundef 32) #24
...
if.then3:                                         ; preds = %if.else
  ...
  %call7 = tail call ptr @realloc(ptr noundef nonnull %0, i64 noundef %mul) #26
  br label %if.end9.sink.split
...
if.end9:                                          ; preds = %if.end9.sink.split, %if.else
  %call10 = tail call ptr @dup_str(ptr noundef %start, ptr noundef %end) #23
...
entry:
  %call = tail call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #24
...
if.end40:                                         ; preds = %if.then14, %if.else26
  tail call void @vec_add_internal(ptr noundef nonnull %declarations, ptr noundef nonnull %call) #23
  br label %do.end
...
sw.default:                                       ; preds = %if.then
  tail call void (ptr, ...) @d_fail(ptr noundef nonnull @.str, i32 noundef %line) #23
  br label %if.end
...
sw.bb7:                                           ; preds = %if.end
  %call = tail call ptr @dup_str(ptr noundef %start, ptr noundef %end) #23
...
sw.bb8:                                           ; preds = %if.end
  tail call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.1, i32 noundef %line) #23
  br label %sw.default9

sw.default9:                                      ; preds = %if.end, %sw.bb8
  %calloc.i.i = tail call dereferenceable_or_null(32) ptr @calloc(i64 1, i64 32)
  store i32 2, ptr %calloc.i.i, align 8, !tbaa !23
  %call1.i = tail call ptr @dup_str(ptr noundef %start, ptr noundef %end) #23
  %e2.i = getelementptr inbounds %struct.Elem, ptr %calloc.i.i, i64 0, i32 3
  store ptr %call1.i, ptr %e2.i, align 8, !tbaa !28
  %call5.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call1.i) #22
  ...
  %call.i = tail call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #24
...
if.end40.i:                                       ; preds = %if.else26.i, %if.then14.i
  tail call void @vec_add_internal(ptr noundef nonnull %declarations.i, ptr noundef nonnull %call.i) #23
  br label %sw.epilog11
...
entry:
  ...
  %tobool.not292 = icmp eq i8 %0, 0
  br i1 %tobool.not292, label %while.end, label %land.rhs.lr.ph
...
land.rhs:                                         ; preds = %land.rhs.lr.ph, %while.body
  ...
  %start.addr.0293 = phi ptr [ %start, %land.rhs.lr.ph ], [ %incdec.ptr, %while.body ]
...
while.body:                                       ; preds = %land.rhs
  %incdec.ptr = getelementptr inbounds i8, ptr %start.addr.0293, i64 1
  %5 = load i8, ptr %incdec.ptr, align 1, !tbaa !28
  %tobool.not = icmp eq i8 %5, 0
  br i1 %tobool.not, label %while.end, label %land.rhs, !llvm.loop !57

while.end:                                        ; preds = %land.rhs, %while.body, %entry
  %start.addr.0.lcssa = phi ptr [ %start, %entry ], [ %incdec.ptr, %while.body ], [ %start.addr.0293, %land.rhs ]
  ...
  %cmp295.not = icmp eq i32 %6, 0
  br i1 %cmp295.not, label %cleanup, label %for.body.lr.ph
...
land.lhs.true:                                    ; preds = %for.body
  ...
  %call270 = tail call i32 @strncmp(ptr noundef %10, ptr noundef nonnull %start.addr.0.lcssa, i64 noundef %conv269) #22
  %tobool271.not = icmp eq i32 %call270, 0
  br i1 %tobool271.not, label %cleanup, label %for.inc
...
entry:
  %0 = load i8, ptr %start, align 1, !tbaa !28
  %tobool.not292.i = icmp eq i8 %0, 0
  br i1 %tobool.not292.i, label %while.end.i, label %land.rhs.lr.ph.i
...
land.rhs.i:                                       ; preds = %while.body.i, %land.rhs.lr.ph.i
  ...
  %start.addr.0293.i = phi ptr [ %start, %land.rhs.lr.ph.i ], [ %incdec.ptr.i, %while.body.i ]
...
while.body.i:                                     ; preds = %land.rhs.i
  %incdec.ptr.i = getelementptr inbounds i8, ptr %start.addr.0293.i, i64 1
...
while.end.i:                                      ; preds = %while.body.i, %land.rhs.i, %entry
  %start.addr.0.lcssa.i = phi ptr [ %start, %entry ], [ %start.addr.0293.i, %land.rhs.i ], [ %incdec.ptr.i, %while.body.i ]
  ...
  %cmp295.not.i = icmp eq i32 %6, 0
  br i1 %cmp295.not.i, label %if.else, label %for.body.lr.ph.i
...
for.body.lr.ph.i:                                 ; preds = %while.end.i
  ...
  %conv269.i = ashr exact i64 %sext.i, 32
...
land.lhs.true.i:                                  ; preds = %for.body.i
  %10 = load ptr, ptr %8, align 8, !tbaa !62
  %call270.i = tail call i32 @strncmp(ptr noundef %10, ptr noundef nonnull %start.addr.0.lcssa.i, i64 noundef %conv269.i) #22
  %tobool271.not.i = icmp eq i32 %call270.i, 0
  br i1 %tobool271.not.i, label %if.then, label %for.inc.i
...
if.then:                                          ; preds = %land.lhs.true.i
  %call1 = tail call ptr @dup_str(ptr noundef nonnull %start, ptr noundef %end) #23
  tail call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.2, ptr noundef %call1, i32 noundef %line) #23
  br label %if.end48

if.else:                                          ; preds = %for.inc.i, %while.end.i
  %call2 = tail call noalias dereferenceable_or_null(24) ptr @malloc(i64 noundef 24) #24
  %call3 = tail call ptr @dup_str(ptr noundef nonnull %start, ptr noundef %end) #23
...
if.end46:                                         ; preds = %if.then19, %if.else32
  tail call void @vec_add_internal(ptr noundef nonnull %passes.i, ptr noundef nonnull %call2) #23
  br label %if.end48
...
land.rhs.i:                                       ; preds = %while.body.i, %land.rhs.lr.ph.i
  %2 = phi i8 [ %0, %land.rhs.lr.ph.i ], [ %5, %while.body.i ]
  %start.addr.0293.i = phi ptr [ %pass_start, %land.rhs.lr.ph.i ], [ %incdec.ptr.i, %while.body.i ]
  %idxprom.i = sext i8 %2 to i64
  %arrayidx.i = getelementptr inbounds i16, ptr %1, i64 %idxprom.i
  %3 = load i16, ptr %arrayidx.i, align 2, !tbaa !33
  %4 = and i16 %3, 8192
...
while.end.i:                                      ; preds = %while.body.i, %land.rhs.i, %entry
  %start.addr.0.lcssa.i = phi ptr [ %pass_start, %entry ], [ %start.addr.0293.i, %land.rhs.i ], [ %incdec.ptr.i, %while.body.i ]
  ...
  %6 = load i32, ptr %passes.i, align 8, !tbaa !58
  %cmp295.not.i = icmp eq i32 %6, 0
  br i1 %cmp295.not.i, label %if.then, label %for.body.lr.ph.i
...
land.lhs.true.i:                                  ; preds = %for.body.i
  ...
  %call270.i = tail call i32 @strncmp(ptr noundef %10, ptr noundef nonnull %start.addr.0.lcssa.i, i64 noundef %conv269.i) #22
  %tobool271.not.i = icmp eq i32 %call270.i, 0
  br i1 %tobool271.not.i, label %if.end, label %for.inc.i
...
if.then:                                          ; preds = %for.inc.i, %while.end.i
  %call1 = tail call ptr @dup_str(ptr noundef nonnull %pass_start, ptr noundef %pass_end) #23
  tail call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.3, ptr noundef %call1, i32 noundef %pass_line) #23
  br label %if.end
...
if.end43:                                         ; preds = %if.then16, %if.else29
  tail call void @vec_add_internal(ptr noundef nonnull %pass_code, ptr noundef null) #23
...
while.end:                                        ; preds = %do.end, %if.end
  ...
  %call45 = tail call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #24
  ...
  %call51 = tail call ptr @dup_str(ptr noundef %code_start, ptr noundef %code_end) #23
...
cond.end:                                         ; preds = %entry, %cond.true
  ...
  %call = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %cond) #22
  %add = add i64 %call, 20
  %call2 = tail call noalias ptr @malloc(i64 noundef %add) #24
  %productions = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 1
  %1 = load i32, ptr %productions, align 8, !tbaa !5
  %call4 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %call2, ptr noundef nonnull dereferenceable(1) @.str.5, ptr noundef %cond, i32 noundef %1) #23
...
if.end139:                                        ; preds = %if.then111, %if.else124
  tail call void @vec_add_internal(ptr noundef nonnull %rules, ptr noundef nonnull %calloc.i) #23
  br label %do.body143
...
if.then170:                                       ; preds = %if.then166
  ...
  %arrayidx178 = getelementptr inbounds ptr, ptr %13, i64 %idxprom177
...
if.end196:                                        ; preds = %if.then166, %if.else180
  ...
  tail call void @vec_add_internal(ptr noundef nonnull %rules, ptr noundef %calloc.i308) #23
  br label %do.end200
...
if.else277:                                       ; preds = %entry
  ...
  store i32 2, ptr %elems, align 8, !tbaa !40
  %arrayidx296 = getelementptr inbounds ptr, ptr %17, i64 1
  store ptr %calloc.i.i598, ptr %arrayidx296, align 8, !tbaa !14
  br label %do.body320

do.body320:                                       ; preds = %if.else277, %do.end132
  %rules = getelementptr inbounds %struct.Production, ptr %call, i64 0, i32 2
...
if.then400:                                       ; preds = %if.then396
  ...
  %arrayidx408 = getelementptr inbounds ptr, ptr %22, i64 %idxprom407
...
if.end426:                                        ; preds = %if.then396, %if.else410
  ...
  tail call void @vec_add_internal(ptr noundef nonnull %rules, ptr noundef %calloc.i628) #23
  br label %do.end430
...
do.end109:                                        ; preds = %entry
  ...
  %call.i595 = tail call noalias dereferenceable_or_null(32) ptr @malloc(i64 noundef 32) #24
...
do.end188:                                        ; preds = %entry
  %call.i604 = tail call noalias dereferenceable_or_null(32) ptr @malloc(i64 noundef 32) #24
...
if.else216:                                       ; preds = %do.end188
  store i32 2, ptr %elems4, align 8, !tbaa !40
  %arrayidx235 = getelementptr inbounds ptr, ptr %11, i64 1
  store ptr %calloc.i.i615, ptr %arrayidx235, align 8, !tbaa !14
  br label %do.body259

do.body259:                                       ; preds = %if.else216, %do.end109, %if.then204
  %rules = getelementptr inbounds %struct.Production, ptr %call, i64 0, i32 2
...
if.then393:                                       ; preds = %if.then389
  ...
  %arrayidx400 = getelementptr inbounds ptr, ptr %16, i64 %idxprom399
...
if.end417:                                        ; preds = %if.then389, %if.else402
  tail call void @vec_add_internal(ptr noundef nonnull %rules, ptr noundef nonnull %calloc.i627) #23
  br label %do.end420
...
entry:
  %call = tail call noalias dereferenceable_or_null(8) ptr @malloc(i64 noundef 8) #24
  %cmp.not = icmp eq ptr %call, null
  br i1 %cmp.not, label %do.body48, label %if.then

if.then:                                          ; preds = %entry
  store i64 32776860187435056, ptr %call, align 1
  br label %do.body48

do.body48:                                        ; preds = %entry, %if.then
  %call2 = tail call ptr @new_production(ptr noundef %g, ptr noundef %call)
  %internal = getelementptr inbounds %struct.Production, ptr %call2, i64 0, i32 4
  %bf.load = load i8, ptr %internal, align 4
  %bf.clear = and i8 %bf.load, -29
  %bf.set = or i8 %bf.clear, 4
  store i8 %bf.set, ptr %internal, align 4
  %calloc.i = tail call dereferenceable_or_null(168) ptr @calloc(i64 1, i64 168)
  %prod.i = getelementptr inbounds %struct.Rule, ptr %calloc.i, i64 0, i32 1
  store ptr %call2, ptr %prod.i, align 8, !tbaa !20
  %calloc.i.i = tail call dereferenceable_or_null(32) ptr @calloc(i64 1, i64 32)
  %end.i = getelementptr inbounds %struct.Rule, ptr %calloc.i, i64 0, i32 7
  store ptr %calloc.i.i, ptr %end.i, align 8, !tbaa !22
  store i32 3, ptr %calloc.i.i, align 8, !tbaa !23
  ...
  %v = getelementptr inbounds %struct.Rule, ptr %calloc.i, i64 0, i32 6, i32 2
  %elems = getelementptr inbounds %struct.Rule, ptr %calloc.i, i64 0, i32 6
  %calloc.i.i168 = tail call dereferenceable_or_null(32) ptr @calloc(i64 1, i64 32)
  %rule.i169 = getelementptr inbounds %struct.Elem, ptr %calloc.i.i168, i64 0, i32 2
  store ptr %calloc.i, ptr %rule.i169, align 8, !tbaa !25
  %e = getelementptr inbounds %struct.Rule, ptr %calloc.i, i64 0, i32 6, i32 3
  store ptr %e, ptr %v, align 8, !tbaa !39
  store i32 1, ptr %elems, align 8, !tbaa !40
  store ptr %calloc.i.i168, ptr %e, align 8, !tbaa !14
  %v49.phi.trans.insert = getelementptr inbounds %struct.Production, ptr %call2, i64 0, i32 2, i32 2
  %.pre = load ptr, ptr %v49.phi.trans.insert, align 8, !tbaa !73
  %rules = getelementptr inbounds %struct.Production, ptr %call2, i64 0, i32 2
  %tobool50.not = icmp eq ptr %.pre, null
  br i1 %tobool50.not, label %if.then51, label %if.else62

if.then51:                                        ; preds = %do.body48
  %v49 = getelementptr inbounds %struct.Production, ptr %call2, i64 0, i32 2, i32 2
  %e53 = getelementptr inbounds %struct.Production, ptr %call2, i64 0, i32 2, i32 3
  store ptr %e53, ptr %v49, align 8, !tbaa !73
  %1 = load i32, ptr %rules, align 8, !tbaa !74
  %inc59 = add i32 %1, 1
  store i32 %inc59, ptr %rules, align 8, !tbaa !74
  %idxprom60 = zext i32 %1 to i64
  %arrayidx61 = getelementptr inbounds ptr, ptr %e53, i64 %idxprom60
  store ptr %calloc.i, ptr %arrayidx61, align 8, !tbaa !14
  br label %cond.true101

if.else62:                                        ; preds = %do.body48
  %e66 = getelementptr inbounds %struct.Production, ptr %call2, i64 0, i32 2, i32 3
  %cmp68 = icmp eq ptr %.pre, %e66
  %2 = load i32, ptr %rules, align 8, !tbaa !74
  br i1 %cmp68, label %if.then69, label %if.else82

if.then69:                                        ; preds = %if.else62
  %cmp72 = icmp ult i32 %2, 3
  br i1 %cmp72, label %if.then73, label %if.end97

if.then73:                                        ; preds = %if.then69
  %inc78 = add nuw nsw i32 %2, 1
  store i32 %inc78, ptr %rules, align 8, !tbaa !74
  %idxprom79 = zext i32 %2 to i64
  %arrayidx80 = getelementptr inbounds ptr, ptr %.pre, i64 %idxprom79
  store ptr %calloc.i, ptr %arrayidx80, align 8, !tbaa !14
  br label %cond.true101
...
if.then87:                                        ; preds = %if.else82
  %inc92 = add i32 %2, 1
  store i32 %inc92, ptr %rules, align 8, !tbaa !74
  %idxprom93 = zext i32 %2 to i64
  %arrayidx94 = getelementptr inbounds ptr, ptr %.pre, i64 %idxprom93
  store ptr %calloc.i, ptr %arrayidx94, align 8, !tbaa !14
  br label %cond.true101

if.end97:                                         ; preds = %if.then69, %if.else82
  tail call void @vec_add_internal(ptr noundef nonnull %rules, ptr noundef nonnull %calloc.i) #23
  br label %cond.true101

cond.true101:                                     ; preds = %if.then51, %if.then73, %if.then87, %if.end97
  %call104 = tail call noalias dereferenceable_or_null(8) ptr @malloc(i64 noundef 8) #24
  %cmp105.not = icmp eq ptr %call104, null
  br i1 %cmp105.not, label %cond.end111, label %if.then106

if.then106:                                       ; preds = %cond.true101
  store i64 32776860187435057, ptr %call104, align 1
  br label %cond.end111

cond.end111:                                      ; preds = %cond.true101, %if.then106
  %call113 = tail call ptr @new_production(ptr noundef nonnull %g, ptr noundef %call104)
  %internal114 = getelementptr inbounds %struct.Production, ptr %call113, i64 0, i32 4
  %bf.load115 = load i8, ptr %internal114, align 4
  %bf.clear116 = and i8 %bf.load115, -29
  %bf.set117 = or i8 %bf.clear116, 4
  store i8 %bf.set117, ptr %internal114, align 4
  %3 = load ptr, ptr %v, align 8, !tbaa !39
  %4 = load ptr, ptr %3, align 8, !tbaa !14
  %e121 = getelementptr inbounds %struct.Elem, ptr %4, i64 0, i32 3
  store ptr %call113, ptr %e121, align 8, !tbaa !28
  ret void
}
...
cond.true:                                        ; preds = %entry
  %call = tail call ptr @escape_string(ptr noundef nonnull %0) #23
  br label %cond.end
...
if.else24:                                        ; preds = %cond.end
  tail call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.13) #23
  br label %if.end28
...
if.then30:                                        ; preds = %if.end28
  tail call void @free(ptr noundef nonnull %cond) #23
  br label %if.end31
...
lor.lhs.false.i:                                  ; preds = %if.then.i156
  %17 = load i8, ptr %16, align 1, !tbaa !28
  %tobool5.not.i = icmp eq i8 %17, 0
  br i1 %tobool5.not.i, label %if.then6.i, label %if.else.i

if.then6.i:                                       ; preds = %lor.lhs.false.i, %if.then.i156
  %call7.i157 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.8)
  br label %if.end28.i
...
if.then30.i:                                      ; preds = %if.end28.i
  tail call void @free(ptr noundef nonnull %cond.i) #23
  br label %print_elem.exit
...
if.then32:                                        ; preds = %if.end30
  ...
  br i1 %cmp3.i, label %if.then.i133, label %for.inc.i

if.then.i133:                                     ; preds = %for.inc.6.i, %for.inc.5.i, %for.inc.4.i, %for.inc.3.i, %for.inc.2.i, %for.inc.1.i, %for.inc.i, %if.then32
...
for.inc.i:                                        ; preds = %if.then32
  ...
  br i1 %cmp3.1.i, label %if.then.i133, label %for.inc.1.i
...
for.inc.1.i:                                      ; preds = %for.inc.i
  ...
  br i1 %cmp3.2.i, label %if.then.i133, label %for.inc.2.i
...
for.inc.2.i:                                      ; preds = %for.inc.1.i
  ...
  br i1 %cmp3.3.i, label %if.then.i133, label %for.inc.3.i
...
for.inc.3.i:                                      ; preds = %for.inc.2.i
  ...
  br i1 %cmp3.4.i, label %if.then.i133, label %for.inc.4.i
...
for.inc.4.i:                                      ; preds = %for.inc.3.i
  ...
  br i1 %cmp3.5.i, label %if.then.i133, label %for.inc.5.i
...
for.inc.5.i:                                      ; preds = %for.inc.4.i
  ...
  br i1 %cmp3.6.i, label %if.then.i133, label %for.inc.6.i
...
for.inc.6.i:                                      ; preds = %for.inc.5.i
  ...
  br i1 %cmp3.7.i, label %if.then.i133, label %assoc_str.exit

assoc_str.exit:                                   ; preds = %if.then.i133, %for.inc.6.i
  %retval.0.in.i = phi ptr [ %s.i, %if.then.i133 ], [ getelementptr inbounds ([8 x %struct.EnumStr], ptr @assoc_strings, i64 0, i64 0, i32 1), %for.inc.6.i ]
...
if.then43:                                        ; preds = %if.end41
  ...
  %cmp3.i134 = icmp eq i32 %35, %34
  br i1 %cmp3.i134, label %if.then.i137, label %for.inc.i139

if.then.i137:                                     ; preds = %for.inc.6.i151, %for.inc.5.i149, %for.inc.4.i147, %for.inc.3.i145, %for.inc.2.i143, %for.inc.1.i141, %for.inc.i139, %if.then43
  %i.010.lcssa.wide.i135 = phi i64 [ 0, %if.then43 ], [ 1, %for.inc.i139 ], [ 2, %for.inc.1.i141 ], [ 3, %for.inc.2.i143 ], [ 4, %for.inc.3.i145 ], [ 5, %for.inc.4.i147 ], [ 6, %for.inc.5.i149 ], [ 7, %for.inc.6.i151 ]
  %s.i136 = getelementptr inbounds [8 x %struct.EnumStr], ptr @assoc_strings, i64 0, i64 %i.010.lcssa.wide.i135, i32 1
  br label %assoc_str.exit154

for.inc.i139:                                     ; preds = %if.then43
  %36 = load i32, ptr getelementptr inbounds ([8 x %struct.EnumStr], ptr @assoc_strings, i64 0, i64 1), align 16, !tbaa !82
  %cmp3.1.i138 = icmp eq i32 %36, %34
  br i1 %cmp3.1.i138, label %if.then.i137, label %for.inc.1.i141

for.inc.1.i141:                                   ; preds = %for.inc.i139
  %37 = load i32, ptr getelementptr inbounds ([8 x %struct.EnumStr], ptr @assoc_strings, i64 0, i64 2), align 16, !tbaa !82
  %cmp3.2.i140 = icmp eq i32 %37, %34
  br i1 %cmp3.2.i140, label %if.then.i137, label %for.inc.2.i143

for.inc.2.i143:                                   ; preds = %for.inc.1.i141
  %38 = load i32, ptr getelementptr inbounds ([8 x %struct.EnumStr], ptr @assoc_strings, i64 0, i64 3), align 16, !tbaa !82
  %cmp3.3.i142 = icmp eq i32 %38, %34
  br i1 %cmp3.3.i142, label %if.then.i137, label %for.inc.3.i145

for.inc.3.i145:                                   ; preds = %for.inc.2.i143
  %39 = load i32, ptr getelementptr inbounds ([8 x %struct.EnumStr], ptr @assoc_strings, i64 0, i64 4), align 16, !tbaa !82
  %cmp3.4.i144 = icmp eq i32 %39, %34
  br i1 %cmp3.4.i144, label %if.then.i137, label %for.inc.4.i147

for.inc.4.i147:                                   ; preds = %for.inc.3.i145
  %40 = load i32, ptr getelementptr inbounds ([8 x %struct.EnumStr], ptr @assoc_strings, i64 0, i64 5), align 16, !tbaa !82
  %cmp3.5.i146 = icmp eq i32 %40, %34
  br i1 %cmp3.5.i146, label %if.then.i137, label %for.inc.5.i149

for.inc.5.i149:                                   ; preds = %for.inc.4.i147
  %41 = load i32, ptr getelementptr inbounds ([8 x %struct.EnumStr], ptr @assoc_strings, i64 0, i64 6), align 16, !tbaa !82
  %cmp3.6.i148 = icmp eq i32 %41, %34
  br i1 %cmp3.6.i148, label %if.then.i137, label %for.inc.6.i151

for.inc.6.i151:                                   ; preds = %for.inc.5.i149
  %42 = load i32, ptr getelementptr inbounds ([8 x %struct.EnumStr], ptr @assoc_strings, i64 0, i64 7), align 16, !tbaa !82
  %cmp3.7.i150 = icmp eq i32 %42, %34
  br i1 %cmp3.7.i150, label %if.then.i137, label %assoc_str.exit154

assoc_str.exit154:                                ; preds = %if.then.i137, %for.inc.6.i151
  %retval.0.in.i152 = phi ptr [ %s.i136, %if.then.i137 ], [ getelementptr inbounds ([8 x %struct.EnumStr], ptr @assoc_strings, i64 0, i64 0, i32 1), %for.inc.6.i151 ]
  %retval.0.i153 = load ptr, ptr %retval.0.in.i152, align 8, !tbaa !84
  %call46 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.14, ptr noundef %retval.0.i153)
  br label %if.end47

if.end47:                                         ; preds = %assoc_str.exit154, %if.end41
...
if.end60:                                         ; preds = %if.then56, %if.end53
  %putchar132 = tail call i32 @putchar(i32 10)
...
for.end64:                                        ; preds = %if.end60, %for.body
  %puts130 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.79)
  %putchar131 = tail call i32 @putchar(i32 10)
...
for.end69:                                        ; preds = %for.end64, %if.end
  %puts128 = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.78)
  %terminals = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 2
...
for.body74:                                       ; preds = %for.body74.lr.ph, %for.body74
  ...
  %putchar129 = tail call i32 @putchar(i32 9)
...
if.then.i.i.i:                                    ; preds = %if.end.i.i
  ...
  %tobool.not.i129.i = icmp eq ptr %18, null
  br i1 %tobool.not.i129.i, label %cond.end.i.i, label %cond.true.i.i

cond.true.i.i:                                    ; preds = %if.then.i.i.i
  %call.i130.i = tail call ptr @escape_string(ptr noundef nonnull %18) #23
  br label %cond.end.i.i

cond.end.i.i:                                     ; preds = %cond.true.i.i, %if.then.i.i.i
  %cond.i.i = phi ptr [ %call.i130.i, %cond.true.i.i ], [ null, %if.then.i.i.i ]
  %19 = load i32, ptr %17, align 8, !tbaa !30
  switch i32 %19, label %if.else24.i.i [
    i32 0, label %if.then.i131.i
    i32 1, label %if.then12.i.i
    i32 2, label %if.then17.i.i
    i32 3, label %if.then22.i.i
  ]

if.then.i131.i:                                   ; preds = %cond.end.i.i
  %20 = load ptr, ptr %string.i.i, align 8, !tbaa !32
  %tobool3.not.i.i = icmp eq ptr %20, null
  br i1 %tobool3.not.i.i, label %if.then6.i133.i, label %lor.lhs.false.i.i

lor.lhs.false.i.i:                                ; preds = %if.then.i131.i
  %21 = load i8, ptr %20, align 1, !tbaa !28
  %tobool5.not.i.i = icmp eq i8 %21, 0
  br i1 %tobool5.not.i.i, label %if.then6.i133.i, label %if.else.i.i

if.then6.i133.i:                                  ; preds = %lor.lhs.false.i.i, %if.then.i131.i
  %call7.i132.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.8)
...
if.end28.i.i:                                     ; preds = %if.else24.i.i, %if.then22.i.i, %if.then17.i.i, %if.then12.i.i, %if.else.i.i, %if.then6.i133.i
...
if.then30.i.i:                                    ; preds = %if.end28.i.i
  tail call void @free(ptr noundef nonnull %cond.i.i) #23
...
if.end.i:                                         ; preds = %for.end.i
  %puts114.i = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.81)
...
for.body11.i:                                     ; preds = %print_elem.exit.i, %for.body11.lr.ph.i
  ...
  %putchar113.i = tail call i32 @putchar(i32 9)
...
if.then.i115.i:                                   ; preds = %for.body11.i
...
cond.true.i33:                                    ; preds = %if.then.i115.i
  %call.i32 = tail call ptr @escape_string(ptr noundef nonnull %37) #23
  br label %cond.end.i35

cond.end.i35:                                     ; preds = %cond.true.i33, %if.then.i115.i
  %cond.i34 = phi ptr [ %call.i32, %cond.true.i33 ], [ null, %if.then.i115.i ]
...
if.then30.i53:                                    ; preds = %if.end28.i52
  tail call void @free(ptr noundef nonnull %cond.i34) #23
...
if.then3.i.i:                                     ; preds = %for.body11.i
  ...
  %call.i116.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.14, ptr noundef %41)
  br label %print_elem.exit.i
...
if.else5.i.i:                                     ; preds = %for.body11.i
  ...
  %call7.i117.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.14, ptr noundef %43)
  br label %print_elem.exit.i
...
for.end25.i:                                      ; preds = %print_elem.exit.i, %if.end.i, %for.end.i
  %puts.i = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.80)
...
cond.true.i58:                                    ; preds = %if.then.i.i16
  %call.i57 = tail call ptr @escape_string(ptr noundef nonnull %65) #23
...
if.then30.i78:                                    ; preds = %if.end28.i77
  tail call void @free(ptr noundef nonnull %cond.i59) #23
...
print_rule.exit:                                  ; preds = %if.end.i29, %if.then7.i
  %putchar112.i = tail call i32 @putchar(i32 10)
...
cond.true.i:                                      ; preds = %if.then57.i
  %call.i6 = tail call ptr @escape_string(ptr noundef nonnull %84) #23
  br label %cond.end.i
...
if.then30.i:                                      ; preds = %if.end28.i
  tail call void @free(ptr noundef nonnull %cond.i7) #23
...
if.end61.i:                                       ; preds = %print_term.exit, %for.body45.i
  %putchar111.i = tail call i32 @putchar(i32 10)
...
for.end65.i:                                      ; preds = %for.end65.loopexit.i, %for.cond42.preheader.i
  ...
  br i1 %cmp68.i, label %if.end70.i, label %print_conflict.exit.i

print_conflict.exit.i:                            ; preds = %for.end65.i
  %puts.i.i = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.82)
  %call1.i.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.64, ptr noundef nonnull @.str.56)
  %putchar.i120.i = tail call i32 @putchar(i32 10)
  %.pr.i = load i32, ptr %reduce_actions.i, align 8, !tbaa !106
  br label %if.end70.i

if.end70.i:                                       ; preds = %print_conflict.exit.i, %for.end65.i
  %93 = phi i32 [ %.pr.i, %print_conflict.exit.i ], [ %92, %for.end65.i ]
...
if.then77.i:                                      ; preds = %land.lhs.true.i
  br i1 %cmp68.i, label %if.then.i124.i, label %print_conflict.exit128.i

if.then.i124.i:                                   ; preds = %if.then77.i
  %puts.i123.i = tail call i32 @puts(ptr nonnull dereferenceable(1) @str.82)
  br label %print_conflict.exit128.i

print_conflict.exit128.i:                         ; preds = %if.then.i124.i, %if.then77.i
  %call1.i125.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.64, ptr noundef nonnull @.str.57)
  %putchar.i126.i = tail call i32 @putchar(i32 10)
  br label %print_state.exit

print_state.exit:                                 ; preds = %if.end70.i, %land.lhs.true.i, %print_conflict.exit128.i
...
define dso_local i32 @state_for_declaration(ptr nocapture noundef readonly %g, i32 noundef %iproduction) local_unnamed_addr #15 {
entry:
  %declarations = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 7
  %0 = load i32, ptr %declarations, align 8, !tbaa !48
...
for.body48:                                       ; preds = %for.body48.lr.ph, %for.inc
  ...
  %call53 = tail call i32 @elem_symbol(ptr noundef %g, ptr noundef %24) #23
  ...
  %call59 = tail call i32 @elem_symbol(ptr noundef %g, ptr noundef %27) #23
...
for.end424:                                       ; preds = %for.inc422, %entry, %for.cond261.preheader, %for.cond317.preheader, %for.cond401.preheader
  tail call void @free(ptr noundef %calloc) #23
  ret void
}
...
entry:
  ...
  %call1 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %pathname) #22
  %add.ptr = getelementptr inbounds i8, ptr %pathname, i64 %call1
  %call2 = tail call ptr @dup_str(ptr noundef %pathname, ptr noundef %add.ptr) #23
  store ptr %call2, ptr %calloc, align 8, !tbaa !137
  ret ptr %calloc
}

; Function Attrs: mustprogress nounwind willreturn uwtable
define dso_local void @free_D_Grammar(ptr nocapture noundef readonly %g) local_unnamed_addr #16 {
entry:
...
entry:
  %0 = load ptr, ptr %g, align 8, !tbaa !137
  %call = tail call ptr @fopen(ptr noundef %0, ptr noundef nonnull @.str.44)
  %tobool.not = icmp eq ptr %call, null
  br i1 %tobool.not, label %cleanup, label %if.end

if.end:                                           ; preds = %entry
  %1 = load ptr, ptr %g, align 8, !tbaa !137
  %call2 = tail call ptr @sbuf_read(ptr noundef %1) #23
  %tobool3.not = icmp eq ptr %call2, null
  br i1 %tobool3.not, label %cleanup, label %if.end5

if.end5:                                          ; preds = %if.end
  tail call void @initialize_productions(ptr noundef nonnull %g)
  %call6 = tail call ptr @new_D_Parser(ptr noundef %t, i32 noundef %sizeof_ParseNode_User) #23
  ...
  %call9 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %call2) #22
  %conv = trunc i64 %call9 to i32
  %call10 = tail call ptr @dparse(ptr noundef nonnull %call6, ptr noundef nonnull %call2, i32 noundef %conv) #23
...
entry:
  ...
  %productions.i = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 1
  %0 = load i32, ptr %productions.i, align 8, !tbaa !5
  %cmp200.not.i = icmp eq i32 %0, 0
  br i1 %cmp200.not.i, label %for.cond74.preheader.i, label %for.body.lr.ph.i.lr.ph.i
...
for.cond74.preheader.i:                           ; preds = %for.inc71.i, %entry
  ...
  %cmp76203.not.i = icmp eq i32 %2, 0
  br i1 %cmp76203.not.i, label %for.end86.i, label %for.body78.lr.ph.i
...
cleanup.i.i:                                      ; preds = %for.body.i.i
  ...
  %call182.i.i = call i32 @strncmp(ptr noundef %12, ptr noundef %8, i64 noundef %conv181.i.i) #22
  %tobool183.not.not.i.i = icmp eq i32 %call182.i.i, 0
  br i1 %tobool183.not.not.i.i, label %lookup_production.exit.i, label %for.inc.i.i
...
if.end.i:                                         ; preds = %if.then.i, %lookup_production.exit.i
  ...
  %cmp6198.not.i = icmp eq i32 %14, 0
  br i1 %cmp6198.not.i, label %for.inc71.i, label %for.body7.lr.ph.i
...
for.body7.i:                                      ; preds = %for.inc68.i, %for.body7.lr.ph.i
  %indvars.iv213.i = phi i64 [ 0, %for.body7.lr.ph.i ], [ %indvars.iv.next214.i, %for.inc68.i ]
  %15 = load ptr, ptr %v9.i, align 8, !tbaa !73
  %arrayidx11.i = getelementptr inbounds ptr, ptr %15, i64 %indvars.iv213.i
  ...
  %cmp16193.not.i = icmp eq i32 %18, 0
  br i1 %cmp16193.not.i, label %for.end.thread.i, label %for.body17.lr.ph.i

for.end.thread.i:                                 ; preds = %for.body7.i
  %end225.i = getelementptr inbounds %struct.Rule, ptr %16, i64 0, i32 7
  %19 = load ptr, ptr %end225.i, align 8, !tbaa !22
  %index59226.i = getelementptr inbounds %struct.Elem, ptr %19, i64 0, i32 1
  store i32 0, ptr %index59226.i, align 4, !tbaa !144
...
for.body17.i:                                     ; preds = %for.inc.i, %for.body17.lr.ph.i
  ...
  %last_term.0195.i = phi ptr [ null, %for.body17.lr.ph.i ], [ %last_term.1.i, %for.inc.i ]
...
if.then24.i:                                      ; preds = %for.body17.i
  ...
  %cmp199.not.i142.i = icmp eq i32 %26, 0
  br i1 %cmp199.not.i142.i, label %if.else.i, label %for.body.lr.ph.i146.i

for.body.lr.ph.i146.i:                            ; preds = %if.then24.i
  %27 = load ptr, ptr %v.i, align 8, !tbaa !13
  %conv181.i144.i = sext i32 %24 to i64
...
cleanup.i154.i:                                   ; preds = %for.body.i151.i
  ...
  %call182.i152.i = call i32 @strncmp(ptr noundef %30, ptr noundef %25, i64 noundef %conv181.i144.i) #22
  %tobool183.not.not.i153.i = icmp eq i32 %call182.i152.i, 0
  br i1 %tobool183.not.not.i153.i, label %if.end49.thread184.i, label %for.inc.i157.i
...
if.end49.thread184.i:                             ; preds = %cleanup.i154.i
...
if.else.i:                                        ; preds = %for.inc.i157.i, %if.then24.i
  ...
  %cmp201.not.i.i = icmp eq i32 %31, 0
  br i1 %cmp201.not.i.i, label %if.else.if.else38_crit_edge.i, label %for.body.lr.ph.i162.i

if.else.if.else38_crit_edge.i:                    ; preds = %if.else.i
  %.pre222.i = sext i32 %24 to i64
  br label %if.else38.i

for.body.lr.ph.i162.i:                            ; preds = %if.else.i
  %32 = load ptr, ptr %v.i160.i, align 8, !tbaa !37
  %conv182.i.i = sext i32 %24 to i64
  %wide.trip.count.i161.i = zext i32 %31 to i64
  br label %for.body.i166.i

for.body.i166.i:                                  ; preds = %for.inc.i170.i, %for.body.lr.ph.i162.i
  %indvars.iv.i163.i = phi i64 [ 0, %for.body.lr.ph.i162.i ], [ %indvars.iv.next.i168.i, %for.inc.i170.i ]
  %arrayidx.i164.i = getelementptr inbounds ptr, ptr %32, i64 %indvars.iv.i163.i
  %33 = load ptr, ptr %arrayidx.i164.i, align 8, !tbaa !14
  %34 = load i32, ptr %33, align 8, !tbaa !30
  %cmp2.not.i165.i = icmp eq i32 %34, 3
  br i1 %cmp2.not.i165.i, label %lor.lhs.false.i.i, label %for.inc.i170.i

lor.lhs.false.i.i:                                ; preds = %for.body.i166.i
  ...
  br i1 %cmp3.not.i.i, label %cleanup.i167.i, label %for.inc.i170.i

cleanup.i167.i:                                   ; preds = %lor.lhs.false.i.i
  %string181.i.i = getelementptr inbounds %struct.Term, ptr %33, i64 0, i32 5
  %36 = load ptr, ptr %string181.i.i, align 8, !tbaa !32
  %call183.i.i = call i32 @strncmp(ptr noundef %36, ptr noundef %25, i64 noundef %conv182.i.i) #22
  %tobool184.not.not.i.i = icmp eq i32 %call183.i.i, 0
  br i1 %tobool184.not.not.i.i, label %if.end49.thread.i, label %for.inc.i170.i

for.inc.i170.i:                                   ; preds = %cleanup.i167.i, %lor.lhs.false.i.i, %for.body.i166.i
  %indvars.iv.next.i168.i = add nuw nsw i64 %indvars.iv.i163.i, 1
  %exitcond.not.i169.i = icmp eq i64 %indvars.iv.next.i168.i, %wide.trip.count.i161.i
  br i1 %exitcond.not.i169.i, label %if.else38.i, label %for.body.i166.i, !llvm.loop !145

if.end49.thread.i:                                ; preds = %cleanup.i167.i
  store i32 1, ptr %21, align 8, !tbaa !23
  store ptr %33, ptr %e25.i, align 8, !tbaa !28
  br label %for.inc.i

if.else38.i:                                      ; preds = %for.inc.i170.i, %if.else.if.else38_crit_edge.i
  %conv.pre-phi.i = phi i64 [ %.pre222.i, %if.else.if.else38_crit_edge.i ], [ %conv182.i.i, %for.inc.i170.i ]
  call void @llvm.lifetime.start.p0(i64 256, ptr nonnull %str.i) #23
  %call41.i = call ptr @strncpy(ptr noundef nonnull %str.i, ptr noundef %25, i64 noundef %conv.pre-phi.i) #23
  ...
  call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.66, ptr noundef nonnull %str.i) #23
  call void @llvm.lifetime.end.p0(i64 256, ptr nonnull %str.i) #23
...
for.inc.i:                                        ; preds = %if.end49.if.then53_crit_edge.i, %if.end49.i, %if.end49.thread.i, %if.end49.thread184.i
  %last_term.1.i = phi ptr [ %last_term.0195.i, %if.end49.i ], [ %last_term.0195.i, %if.end49.thread184.i ], [ %.pre.i, %if.end49.if.then53_crit_edge.i ], [ %33, %if.end49.thread.i ]
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
...
for.inc68.i:                                      ; preds = %if.then64.i, %land.lhs.true.i, %for.end.i, %for.end.thread.i
  ...
  %cmp6.i = icmp ult i64 %indvars.iv.next214.i, %45
...
for.inc71.i:                                      ; preds = %for.inc68.i, %if.end.i
  ...
  %cmp.i = icmp ult i64 %indvars.iv.next217.i, %47
...
for.body78.i:                                     ; preds = %for.body78.i, %for.body78.lr.ph.i.new
  %indvars.iv219.i = phi i64 [ 0, %for.body78.lr.ph.i.new ], [ %indvars.iv.next220.i.7, %for.body78.i ]
  %niter = phi i64 [ 0, %for.body78.lr.ph.i.new ], [ %niter.next.7, %for.body78.i ]
  %arrayidx82.i = getelementptr inbounds ptr, ptr %3, i64 %indvars.iv219.i
  %48 = load ptr, ptr %arrayidx82.i, align 8, !tbaa !14
  %index83.i = getelementptr inbounds %struct.Term, ptr %48, i64 0, i32 1
  %49 = trunc i64 %indvars.iv219.i to i32
  store i32 %49, ptr %index83.i, align 4, !tbaa !151
  %indvars.iv.next220.i = or i64 %indvars.iv219.i, 1
  %arrayidx82.i.1 = getelementptr inbounds ptr, ptr %3, i64 %indvars.iv.next220.i
  %50 = load ptr, ptr %arrayidx82.i.1, align 8, !tbaa !14
  %index83.i.1 = getelementptr inbounds %struct.Term, ptr %50, i64 0, i32 1
  %51 = trunc i64 %indvars.iv.next220.i to i32
  store i32 %51, ptr %index83.i.1, align 4, !tbaa !151
  %indvars.iv.next220.i.1 = or i64 %indvars.iv219.i, 2
  %arrayidx82.i.2 = getelementptr inbounds ptr, ptr %3, i64 %indvars.iv.next220.i.1
  %52 = load ptr, ptr %arrayidx82.i.2, align 8, !tbaa !14
  %index83.i.2 = getelementptr inbounds %struct.Term, ptr %52, i64 0, i32 1
  %53 = trunc i64 %indvars.iv.next220.i.1 to i32
  store i32 %53, ptr %index83.i.2, align 4, !tbaa !151
  %indvars.iv.next220.i.2 = or i64 %indvars.iv219.i, 3
  %arrayidx82.i.3 = getelementptr inbounds ptr, ptr %3, i64 %indvars.iv.next220.i.2
  %54 = load ptr, ptr %arrayidx82.i.3, align 8, !tbaa !14
  %index83.i.3 = getelementptr inbounds %struct.Term, ptr %54, i64 0, i32 1
  %55 = trunc i64 %indvars.iv.next220.i.2 to i32
  store i32 %55, ptr %index83.i.3, align 4, !tbaa !151
  %indvars.iv.next220.i.3 = or i64 %indvars.iv219.i, 4
  %arrayidx82.i.4 = getelementptr inbounds ptr, ptr %3, i64 %indvars.iv.next220.i.3
  %56 = load ptr, ptr %arrayidx82.i.4, align 8, !tbaa !14
  %index83.i.4 = getelementptr inbounds %struct.Term, ptr %56, i64 0, i32 1
  %57 = trunc i64 %indvars.iv.next220.i.3 to i32
  store i32 %57, ptr %index83.i.4, align 4, !tbaa !151
  %indvars.iv.next220.i.4 = or i64 %indvars.iv219.i, 5
  %arrayidx82.i.5 = getelementptr inbounds ptr, ptr %3, i64 %indvars.iv.next220.i.4
  %58 = load ptr, ptr %arrayidx82.i.5, align 8, !tbaa !14
  %index83.i.5 = getelementptr inbounds %struct.Term, ptr %58, i64 0, i32 1
  %59 = trunc i64 %indvars.iv.next220.i.4 to i32
  store i32 %59, ptr %index83.i.5, align 4, !tbaa !151
  %indvars.iv.next220.i.5 = or i64 %indvars.iv219.i, 6
  %arrayidx82.i.6 = getelementptr inbounds ptr, ptr %3, i64 %indvars.iv.next220.i.5
  %60 = load ptr, ptr %arrayidx82.i.6, align 8, !tbaa !14
  %index83.i.6 = getelementptr inbounds %struct.Term, ptr %60, i64 0, i32 1
  %61 = trunc i64 %indvars.iv.next220.i.5 to i32
  store i32 %61, ptr %index83.i.6, align 4, !tbaa !151
  %indvars.iv.next220.i.6 = or i64 %indvars.iv219.i, 7
  %arrayidx82.i.7 = getelementptr inbounds ptr, ptr %3, i64 %indvars.iv.next220.i.6
  %62 = load ptr, ptr %arrayidx82.i.7, align 8, !tbaa !14
  %index83.i.7 = getelementptr inbounds %struct.Term, ptr %62, i64 0, i32 1
  %63 = trunc i64 %indvars.iv.next220.i.6 to i32
  store i32 %63, ptr %index83.i.7, align 4, !tbaa !151
  %indvars.iv.next220.i.7 = add nuw nsw i64 %indvars.iv219.i, 8
...
for.end86.i.loopexit.unr-lcssa:                   ; preds = %for.body78.i, %for.body78.lr.ph.i
  %indvars.iv219.i.unr = phi i64 [ 0, %for.body78.lr.ph.i ], [ %indvars.iv.next220.i.7, %for.body78.i ]
...
for.body78.i.epil:                                ; preds = %for.end86.i.loopexit.unr-lcssa, %for.body78.i.epil
  %indvars.iv219.i.epil = phi i64 [ %indvars.iv.next220.i.epil, %for.body78.i.epil ], [ %indvars.iv219.i.unr, %for.end86.i.loopexit.unr-lcssa ]
  %epil.iter = phi i64 [ %epil.iter.next, %for.body78.i.epil ], [ 0, %for.end86.i.loopexit.unr-lcssa ]
  %arrayidx82.i.epil = getelementptr inbounds ptr, ptr %3, i64 %indvars.iv219.i.epil
  %64 = load ptr, ptr %arrayidx82.i.epil, align 8, !tbaa !14
  %index83.i.epil = getelementptr inbounds %struct.Term, ptr %64, i64 0, i32 1
  %65 = trunc i64 %indvars.iv219.i.epil to i32
  store i32 %65, ptr %index83.i.epil, align 4, !tbaa !151
  %indvars.iv.next220.i.epil = add nuw nsw i64 %indvars.iv219.i.epil, 1
...
for.cond1.preheader.lr.ph.i.i:                    ; preds = %for.end86.i
  %v.i173.i = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 1, i32 2
  %66 = load ptr, ptr %v.i173.i, align 8, !tbaa !13
...
for.cond1.preheader.i.i:                          ; preds = %for.inc27.i.i, %for.cond1.preheader.lr.ph.i.i
  ...
  %arrayidx.i174.i = getelementptr inbounds ptr, ptr %66, i64 %indvars.iv158.i.i
  %67 = load ptr, ptr %arrayidx.i174.i, align 8, !tbaa !14
...
for.body5.lr.ph.i.i:                              ; preds = %for.cond1.preheader.i.i
  ...
  %wide.trip.count.i175.i = zext i32 %68 to i64
...
for.cond1.i.i:                                    ; preds = %for.body5.i.i
  %indvars.iv.next.i176.i = add nuw nsw i64 %indvars.iv.i178.i, 1
  %exitcond.not.i177.i = icmp eq i64 %indvars.iv.next.i176.i, %wide.trip.count.i175.i
  br i1 %exitcond.not.i177.i, label %for.inc27.i.i, label %for.body5.i.i, !llvm.loop !158

for.body5.i.i:                                    ; preds = %for.cond1.i.i, %for.body5.lr.ph.i.i
  %indvars.iv.i178.i = phi i64 [ 0, %for.body5.lr.ph.i.i ], [ %indvars.iv.next.i176.i, %for.cond1.i.i ]
  %arrayidx13.i.i = getelementptr inbounds ptr, ptr %69, i64 %indvars.iv.i178.i
...
convert_regex_productions.exit:                   ; preds = %for.inc57.i, %for.end86.i, %resolve_grammar.exit, %for.cond2.preheader.i
  ...
  br i1 %tobool.not.i33, label %if.end.i39, label %if.then.i36

if.then.i36:                                      ; preds = %convert_regex_productions.exit
  ...
  %call.i.i = call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #24
  store ptr %calloc.i.i.i, ptr %call.i.i, align 8, !tbaa !45
  %kind1.i.i = getelementptr inbounds %struct.Declaration, ptr %call.i.i, i64 0, i32 1
  ...
  %index.i.i = getelementptr inbounds %struct.Declaration, ptr %call.i.i, i64 0, i32 2
  ...
  %tobool.not.i.i35 = icmp eq ptr %115, null
  %e4.i.i = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 7, i32 3
  br i1 %tobool.not.i.i35, label %if.then.i.i38, label %if.else.i.i
...
if.then.i.i38:                                    ; preds = %if.then.i36
  ...
  %arrayidx.i.i37 = getelementptr inbounds ptr, ptr %e4.i.i, i64 %idxprom.i.i
  store ptr %call.i.i, ptr %arrayidx.i.i37, align 8, !tbaa !14
  br label %if.end.i39

if.else.i.i:                                      ; preds = %if.then.i36
...
if.then18.i.i:                                    ; preds = %if.then14.i.i
  ...
  store ptr %call.i.i, ptr %arrayidx25.i.i, align 8, !tbaa !14
  br label %if.end.i39
...
if.then30.i.i:                                    ; preds = %if.else26.i.i
  ...
  store ptr %call.i.i, ptr %arrayidx37.i.i, align 8, !tbaa !14
  br label %if.end.i39

if.end40.i.i:                                     ; preds = %if.else26.i.i, %if.then14.i.i
  call void @vec_add_internal(ptr noundef nonnull %declarations.i.i, ptr noundef nonnull %call.i.i) #23
  br label %if.end.i39

if.end.i39:                                       ; preds = %if.end40.i.i, %if.then30.i.i, %if.then18.i.i, %if.then.i.i38, %convert_regex_productions.exit
...
if.then2.i:                                       ; preds = %if.end.i39
  ...
  %call.i199.i = call noalias dereferenceable_or_null(16) ptr @malloc(i64 noundef 16) #24
...
if.then18.i217.i:                                 ; preds = %if.then14.i213.i
  ...
  %arrayidx25.i216.i = getelementptr inbounds ptr, ptr %120, i64 %idxprom24.i215.i
...
if.end40.i225.i:                                  ; preds = %if.else26.i220.i, %if.then14.i213.i
  call void @vec_add_internal(ptr noundef nonnull %declarations.i201.i, ptr noundef nonnull %call.i199.i) #23
  br label %if.end7.i

if.end7.i:                                        ; preds = %if.end40.i225.i, %if.then30.i224.i, %if.then18.i217.i, %if.then.i209.i, %if.end.i39
  %declarations.i = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 7
  %121 = load i32, ptr %declarations.i, align 8, !tbaa !48
  %cmp234.not.i = icmp eq i32 %121, 0
  br i1 %cmp234.not.i, label %for.cond50.preheader.i, label %for.body.lr.ph.i41

for.body.lr.ph.i41:                               ; preds = %if.end7.i
  %v9.i40 = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 7, i32 2
...
for.cond24.preheader.i:                           ; preds = %for.inc.i62
  %cmp27236.not.i = icmp eq i32 %134, 0
  br i1 %cmp27236.not.i, label %for.cond50.preheader.i, label %for.body28.i

for.body.i44:                                     ; preds = %for.inc.i62, %for.body.lr.ph.i41
  %122 = phi i32 [ %121, %for.body.lr.ph.i41 ], [ %134, %for.inc.i62 ]
  %indvars.iv.i42 = phi i64 [ 0, %for.body.lr.ph.i41 ], [ %indvars.iv.next.i60, %for.inc.i62 ]
  %123 = load ptr, ptr %v9.i40, align 8, !tbaa !50
  %arrayidx10.i43 = getelementptr inbounds ptr, ptr %123, i64 %indvars.iv.i42
  %124 = load ptr, ptr %arrayidx10.i43, align 8, !tbaa !14
...
if.then12.i:                                      ; preds = %for.body.i44
  %e13.i = getelementptr inbounds %struct.Elem, ptr %125, i64 0, i32 3
  %127 = load ptr, ptr %e13.i, align 8, !tbaa !28
  %len.i45 = getelementptr inbounds %struct.Elem, ptr %125, i64 0, i32 3, i32 0, i32 1
  %128 = load i32, ptr %len.i45, align 8, !tbaa !28
  %129 = load i32, ptr %productions.i, align 8, !tbaa !5
  %cmp199.not.i.i = icmp eq i32 %129, 0
  br i1 %cmp199.not.i.i, label %if.then17.i, label %for.body.lr.ph.i.i48

for.body.lr.ph.i.i48:                             ; preds = %if.then12.i
  %130 = load ptr, ptr %v.i227.i, align 8, !tbaa !13
  %conv181.i.i46 = sext i32 %128 to i64
  %wide.trip.count.i.i47 = zext i32 %129 to i64
  br label %for.body.i.i52

for.body.i.i52:                                   ; preds = %for.inc.i.i58, %for.body.lr.ph.i.i48
  %indvars.iv.i.i49 = phi i64 [ 0, %for.body.lr.ph.i.i48 ], [ %indvars.iv.next.i.i56, %for.inc.i.i58 ]
  %arrayidx.i228.i = getelementptr inbounds ptr, ptr %130, i64 %indvars.iv.i.i49
  %131 = load ptr, ptr %arrayidx.i228.i, align 8, !tbaa !14
  %name_len.i.i50 = getelementptr inbounds %struct.Production, ptr %131, i64 0, i32 1
  %132 = load i32, ptr %name_len.i.i50, align 8, !tbaa !15
  %cmp2.not.i.i51 = icmp eq i32 %132, %128
  br i1 %cmp2.not.i.i51, label %cleanup.i.i55, label %for.inc.i.i58

cleanup.i.i55:                                    ; preds = %for.body.i.i52
  %133 = load ptr, ptr %131, align 8, !tbaa !17
  %call182.i.i53 = call i32 @strncmp(ptr noundef %133, ptr noundef %127, i64 noundef %conv181.i.i46) #22
  %tobool183.not.not.i.i54 = icmp eq i32 %call182.i.i53, 0
  br i1 %tobool183.not.not.i.i54, label %if.end20.i, label %for.inc.i.i58

for.inc.i.i58:                                    ; preds = %cleanup.i.i55, %for.body.i.i52
  ...
  br i1 %exitcond.not.i.i57, label %if.then17.i, label %for.body.i.i52, !llvm.loop !18

if.then17.i:                                      ; preds = %for.inc.i.i58, %if.then12.i
  call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.73, ptr noundef %127) #23
  br label %if.end20.i

if.end20.i:                                       ; preds = %cleanup.i.i55, %if.then17.i
  %retval.2.i231.i = phi ptr [ null, %if.then17.i ], [ %131, %cleanup.i.i55 ]
  store i32 0, ptr %125, align 8, !tbaa !23
  store ptr %retval.2.i231.i, ptr %e13.i, align 8, !tbaa !28
  %.pre.i59 = load i32, ptr %declarations.i, align 8, !tbaa !48
  br label %for.inc.i62

for.inc.i62:                                      ; preds = %if.end20.i, %for.body.i44
  %134 = phi i32 [ %122, %for.body.i44 ], [ %.pre.i59, %if.end20.i ]
  %indvars.iv.next.i60 = add nuw nsw i64 %indvars.iv.i42, 1
  %135 = zext i32 %134 to i64
  %cmp.i61 = icmp ult i64 %indvars.iv.next.i60, %135
  br i1 %cmp.i61, label %for.body.i44, label %for.cond24.preheader.i, !llvm.loop !165

for.cond50.preheader.i:                           ; preds = %for.inc47.i, %for.cond24.preheader.i, %if.end7.i
  %136 = load i32, ptr %productions.i, align 8, !tbaa !5
  %cmp53242.not.i = icmp eq i32 %136, 0
  br i1 %cmp53242.not.i, label %merge_identical_terminals.exit.thread, label %for.body54.lr.ph.i
...
for.body28.i:                                     ; preds = %for.cond24.preheader.i, %for.inc47.i
  ...
  %indvars.iv246.i = phi i64 [ %indvars.iv.next247.i, %for.inc47.i ], [ 0, %for.cond24.preheader.i ]
  %138 = load ptr, ptr %v9.i40, align 8, !tbaa !50
  %arrayidx32.i = getelementptr inbounds ptr, ptr %138, i64 %indvars.iv246.i
  %139 = load ptr, ptr %arrayidx32.i, align 8, !tbaa !14
  %140 = getelementptr i8, ptr %139, i64 8
  %.val.i = load i32, ptr %140, align 8, !tbaa !47
  %switch.i.i = icmp ugt i32 %.val.i, 2
  br i1 %switch.i.i, label %for.inc47.i, label %if.then35.i
...
if.then35.i:                                      ; preds = %for.body28.i
  ...
  %.pre258.i = load i32, ptr %declarations.i, align 8, !tbaa !48
  br label %for.inc47.i

for.inc47.i:                                      ; preds = %if.then35.i, %for.body28.i
  %143 = phi i32 [ %137, %for.body28.i ], [ %.pre258.i, %if.then35.i ]
  %indvars.iv.next247.i = add nuw nsw i64 %indvars.iv246.i, 1
  %144 = zext i32 %143 to i64
  %cmp27.i63 = icmp ult i64 %indvars.iv.next247.i, %144
...
for.body54.i:                                     ; preds = %for.inc141.i, %for.body54.lr.ph.i
  ...
  %indvars.iv255.i = phi i64 [ 0, %for.body54.lr.ph.i ], [ %indvars.iv.next256.i, %for.inc141.i ]
  %146 = load ptr, ptr %v56.i, align 8, !tbaa !13
  %arrayidx58.i = getelementptr inbounds ptr, ptr %146, i64 %indvars.iv255.i
  ...
  %cmp61240.not.i = icmp eq i32 %148, 0
  br i1 %cmp61240.not.i, label %for.inc141.i, label %for.body62.lr.ph.i
...
for.body62.i:                                     ; preds = %for.inc138.i, %for.body62.lr.ph.i
  ...
  %indvars.iv252.i = phi i64 [ 0, %for.body62.lr.ph.i ], [ %indvars.iv.next253.i, %for.inc138.i ]
  %150 = load ptr, ptr %v64.i, align 8, !tbaa !73
  %arrayidx66.i = getelementptr inbounds ptr, ptr %150, i64 %indvars.iv252.i
  ...
  %cmp69238.not.i = icmp eq i32 %152, 0
  br i1 %cmp69238.not.i, label %for.inc138.i, label %for.body70.lr.ph.i
...
for.body70.i:                                     ; preds = %for.inc135.i, %for.body70.lr.ph.i
  %indvars.iv249.i = phi i64 [ 0, %for.body70.lr.ph.i ], [ %indvars.iv.next250.i, %for.inc135.i ]
  %153 = load ptr, ptr %v72.i, align 8, !tbaa !39
  %arrayidx74.i = getelementptr inbounds ptr, ptr %153, i64 %indvars.iv249.i
...
for.body.i77:                                     ; preds = %for.inc24.i, %for.body.lr.ph.i74
  %170 = phi i32 [ %.pr, %for.body.lr.ph.i74 ], [ %.pr193, %for.inc24.i ]
...
for.body13.i:                                     ; preds = %for.inc.i94, %for.body13.lr.ph.i
  %178 = phi i32 [ %177, %for.body13.lr.ph.i ], [ %199, %for.inc.i94 ]
  %indvars.iv.i79 = phi i64 [ 0, %for.body13.lr.ph.i ], [ %indvars.iv.next.i93, %for.inc.i94 ]
  ...
  br i1 %cmp18.i, label %if.then.i80, label %for.inc.i94
...
if.then.i80:                                      ; preds = %for.body13.i
  ...
  %cmp343.not.i.i = icmp eq i32 %183, 0
  br i1 %cmp343.not.i.i, label %unique_term.exit.i, label %for.body.lr.ph.i.i83

for.body.lr.ph.i.i83:                             ; preds = %if.then.i80
  ...
  %string303.i.i = getelementptr inbounds %struct.Term, ptr %182, i64 0, i32 5
  %wide.trip.count.i.i82 = zext i32 %183 to i64
  br label %for.body.i.i86

for.body.i.i86:                                   ; preds = %for.inc.i.i91, %for.body.lr.ph.i.i83
  %indvars.iv.i.i84 = phi i64 [ 0, %for.body.lr.ph.i.i83 ], [ %indvars.iv.next.i.i89, %for.inc.i.i91 ]
  %arrayidx.i.i85 = getelementptr inbounds ptr, ptr %185, i64 %indvars.iv.i.i84
  %186 = load ptr, ptr %arrayidx.i.i85, align 8, !tbaa !14
  %187 = load i32, ptr %186, align 8, !tbaa !30
  %cmp3.i.i = icmp eq i32 %184, %187
  br i1 %cmp3.i.i, label %land.lhs.true.i.i, label %for.inc.i.i91

land.lhs.true.i.i:                                ; preds = %for.body.i.i86
  ...
  br i1 %cmp9.i.i, label %land.lhs.true10.i.i, label %for.inc.i.i91
...
land.lhs.true10.i.i:                              ; preds = %land.lhs.true.i.i
  ...
  br i1 %cmp16.i.i, label %land.lhs.true17.i.i, label %for.inc.i.i91

land.lhs.true17.i.i:                              ; preds = %land.lhs.true10.i.i
  %192 = load i32, ptr %set_op_priority_from_rule.i.i, align 8, !tbaa !51
  %tobool.not.i.i87 = icmp eq i32 %192, 0
  br i1 %tobool.not.i.i87, label %land.lhs.true31.i.i, label %lor.lhs.false.i.i88

lor.lhs.false.i.i88:                              ; preds = %land.lhs.true17.i.i
  ...
  br i1 %cmp23.i.i, label %land.lhs.true24.i.i, label %for.inc.i.i91

land.lhs.true24.i.i:                              ; preds = %lor.lhs.false.i.i88
  ...
  br i1 %cmp30.i.i, label %land.lhs.true31.i.i, label %for.inc.i.i91

land.lhs.true31.i.i:                              ; preds = %land.lhs.true24.i.i, %land.lhs.true17.i.i
  %197 = load ptr, ptr %string303.i.i, align 8, !tbaa !32
  %string308.i.i = getelementptr inbounds %struct.Term, ptr %186, i64 0, i32 5
  %198 = load ptr, ptr %string308.i.i, align 8, !tbaa !32
  %conv310.i.i = sext i32 %188 to i64
  %call311.i.i = call i32 @strncmp(ptr noundef %197, ptr noundef %198, i64 noundef %conv310.i.i) #22
  %tobool312.not.i.i = icmp eq i32 %call311.i.i, 0
  br i1 %tobool312.not.i.i, label %unique_term.exit.i, label %for.inc.i.i91

for.inc.i.i91:                                    ; preds = %land.lhs.true31.i.i, %land.lhs.true24.i.i, %lor.lhs.false.i.i88, %land.lhs.true10.i.i, %land.lhs.true.i.i, %for.body.i.i86
  %indvars.iv.next.i.i89 = add nuw nsw i64 %indvars.iv.i.i84, 1
  %exitcond.not.i.i90 = icmp eq i64 %indvars.iv.next.i.i89, %wide.trip.count.i.i82
  br i1 %exitcond.not.i.i90, label %unique_term.exit.i, label %for.body.i.i86, !llvm.loop !171

unique_term.exit.i:                               ; preds = %for.inc.i.i91, %land.lhs.true31.i.i, %if.then.i80
  %retval.0.i.i = phi ptr [ %182, %if.then.i80 ], [ %182, %for.inc.i.i91 ], [ %186, %land.lhs.true31.i.i ]
  store ptr %retval.0.i.i, ptr %e19.i, align 8, !tbaa !28
  %.pre.i92 = load i32, ptr %elems.i78, align 8, !tbaa !40
  br label %for.inc.i94

for.inc.i94:                                      ; preds = %unique_term.exit.i, %for.body13.i
  %199 = phi i32 [ %178, %for.body13.i ], [ %.pre.i92, %unique_term.exit.i ]
  %indvars.iv.next.i93 = add nuw nsw i64 %indvars.iv.i79, 1
  %200 = zext i32 %199 to i64
  %cmp12.i = icmp ult i64 %indvars.iv.next.i93, %200
  br i1 %cmp12.i, label %for.body13.i, label %for.inc21.loopexit.i, !llvm.loop !172

for.inc21.loopexit.i:                             ; preds = %for.inc.i94
...
for.inc24.i:                                      ; preds = %for.inc24.loopexit.i, %for.body.i77
  %.pr193 = phi i32 [ %.pre53.i, %for.inc24.loopexit.i ], [ %170, %for.body.i77 ]
  %indvars.iv.next50.i = add nuw nsw i64 %indvars.iv49.i, 1
  %203 = zext i32 %.pr193 to i64
  %cmp.i95 = icmp ult i64 %indvars.iv.next50.i, %203
  br i1 %cmp.i95, label %for.body.i77, label %merge_identical_terminals.exit, !llvm.loop !174

merge_identical_terminals.exit.thread:            ; preds = %propogate_declarations.exit, %for.cond50.preheader.i
  %v.i97194 = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 1, i32 2
  %204 = load ptr, ptr %v.i97194, align 8, !tbaa !13
  %205 = load ptr, ptr %204, align 8, !tbaa !14
  br label %for.end83.i

merge_identical_terminals.exit:                   ; preds = %for.inc24.i
  %206 = zext i32 %.pr193 to i64
  %207 = load ptr, ptr %v56.i, align 8, !tbaa !13
  %208 = load ptr, ptr %207, align 8, !tbaa !14
  %cmp179.not.i = icmp eq i32 %.pr193, 0
  br i1 %cmp179.not.i, label %for.end83.i, label %for.body.lr.ph.i101

for.body.lr.ph.i101:                              ; preds = %merge_identical_terminals.exit
  %states_for_all_nterms.i = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 13
  %v.i.i99 = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 7, i32 2
  %action_index.i.i = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 26
  br label %for.body.i104

for.body.i104:                                    ; preds = %for.inc81.i, %for.body.lr.ph.i101
  %indvars.iv194.i = phi i64 [ 0, %for.body.lr.ph.i101 ], [ %indvars.iv.next195.i, %for.inc81.i ]
  %arrayidx4.i = getelementptr inbounds ptr, ptr %207, i64 %indvars.iv194.i
  %209 = load ptr, ptr %arrayidx4.i, align 8, !tbaa !14
  %internal.i = getelementptr inbounds %struct.Production, ptr %209, i64 0, i32 4
  %bf.load.i102 = load i8, ptr %internal.i, align 4
  %210 = and i8 %bf.load.i102, 28
  %tobool.not.i103 = icmp eq i8 %210, 0
  br i1 %tobool.not.i103, label %if.then.i105, label %for.inc81.i
...
for.cond13.preheader.i.preheader:                 ; preds = %land.lhs.true.i.i112, %if.then.i105
  br label %for.cond13.preheader.i

lor.lhs.false.i:                                  ; preds = %if.then.i105
  %212 = load i32, ptr %declarations.i, align 8, !tbaa !48
  %cmp13.not.i.i = icmp eq i32 %212, 0
  br i1 %cmp13.not.i.i, label %for.inc81.i, label %for.body.lr.ph.i.i107

for.body.lr.ph.i.i107:                            ; preds = %lor.lhs.false.i
  %213 = load ptr, ptr %v.i.i99, align 8, !tbaa !50
  %wide.trip.count.i.i106 = zext i32 %212 to i64
  br label %for.body.i.i110

for.body.i.i110:                                  ; preds = %for.inc.i.i115, %for.body.lr.ph.i.i107
  %indvars.iv.i.i108 = phi i64 [ 0, %for.body.lr.ph.i.i107 ], [ %indvars.iv.next.i.i113, %for.inc.i.i115 ]
  %arrayidx.i.i109 = getelementptr inbounds ptr, ptr %213, i64 %indvars.iv.i.i108
  %214 = load ptr, ptr %arrayidx.i.i109, align 8, !tbaa !14
  ...
  br i1 %cmp2.i.i, label %land.lhs.true.i.i112, label %for.inc.i.i115

land.lhs.true.i.i112:                             ; preds = %for.body.i.i110
  ...
  %index.i.i111 = getelementptr inbounds %struct.Production, ptr %217, i64 0, i32 3
  %218 = load i32, ptr %index.i.i111, align 8, !tbaa !118
  %219 = zext i32 %218 to i64
  %cmp7.i.i = icmp eq i64 %indvars.iv194.i, %219
  br i1 %cmp7.i.i, label %for.cond13.preheader.i.preheader, label %for.inc.i.i115

for.inc.i.i115:                                   ; preds = %land.lhs.true.i.i112, %for.body.i.i110
  %indvars.iv.next.i.i113 = add nuw nsw i64 %indvars.iv.i.i108, 1
  %exitcond.not.i.i114 = icmp eq i64 %indvars.iv.next.i.i113, %wide.trip.count.i.i106
  br i1 %exitcond.not.i.i114, label %for.inc81.i, label %for.body.i.i110, !llvm.loop !119

for.cond13.preheader.i:                           ; preds = %for.cond13.preheader.i.preheader, %for.inc54.i126
  %indvars.iv189.i = phi i64 [ %indvars.iv.next190.i, %for.inc54.i126 ], [ 0, %for.cond13.preheader.i.preheader ]
  %arrayidx17.i116 = getelementptr inbounds ptr, ptr %207, i64 %indvars.iv189.i
  %220 = load ptr, ptr %arrayidx17.i116, align 8, !tbaa !14
  %rules174.i = getelementptr inbounds %struct.Production, ptr %220, i64 0, i32 2
  %221 = load i32, ptr %rules174.i, align 8, !tbaa !74
  %cmp19175.not.i = icmp eq i32 %221, 0
  br i1 %cmp19175.not.i, label %for.inc54.i126, label %for.body20.i

for.body20.i:                                     ; preds = %for.cond13.preheader.i, %for.inc51.i125
  %222 = phi ptr [ %230, %for.inc51.i125 ], [ %220, %for.cond13.preheader.i ]
  %indvars.iv186.i = phi i64 [ %indvars.iv.next187.i, %for.inc51.i125 ], [ 0, %for.cond13.preheader.i ]
  %v26.i = getelementptr inbounds %struct.Production, ptr %222, i64 0, i32 2, i32 2
  %223 = load ptr, ptr %v26.i, align 8, !tbaa !73
  %arrayidx28.i = getelementptr inbounds ptr, ptr %223, i64 %indvars.iv186.i
  %224 = load ptr, ptr %arrayidx28.i, align 8, !tbaa !14
  %elems.i117 = getelementptr inbounds %struct.Rule, ptr %224, i64 0, i32 6
  %225 = load i32, ptr %elems.i117, align 8, !tbaa !40
  %cmp31172.not.i = icmp eq i32 %225, 0
  br i1 %cmp31172.not.i, label %for.inc51.i125, label %for.body32.lr.ph.i
...
for.body32.lr.ph.i:                               ; preds = %for.body20.i
  ...
  %wide.trip.count.i118 = zext i32 %225 to i64
  br label %for.body32.i

for.cond29.i:                                     ; preds = %for.body32.i
  %indvars.iv.next.i119 = add nuw nsw i64 %indvars.iv.i121, 1
  %exitcond.not.i120 = icmp eq i64 %indvars.iv.next.i119, %wide.trip.count.i118
  br i1 %exitcond.not.i120, label %for.inc51.i125, label %for.body32.i, !llvm.loop !175

for.body32.i:                                     ; preds = %for.cond29.i, %for.body32.lr.ph.i
  %indvars.iv.i121 = phi i64 [ 0, %for.body32.lr.ph.i ], [ %indvars.iv.next.i119, %for.cond29.i ]
  %arrayidx36.i = getelementptr inbounds ptr, ptr %226, i64 %indvars.iv.i121
  %228 = load ptr, ptr %arrayidx36.i, align 8, !tbaa !14
  %e.i122 = getelementptr inbounds %struct.Elem, ptr %228, i64 0, i32 3
  %229 = load ptr, ptr %e.i122, align 8, !tbaa !28
...
if.then42.i:                                      ; preds = %for.body32.i
  ...
  %.pre.i123 = load ptr, ptr %arrayidx17.i116, align 8, !tbaa !14
  br label %for.inc51.i125

for.inc51.i125:                                   ; preds = %for.cond29.i, %if.then42.i, %for.body20.i
  %230 = phi ptr [ %222, %for.body20.i ], [ %.pre.i123, %if.then42.i ], [ %222, %for.cond29.i ]
  %indvars.iv.next187.i = add nuw nsw i64 %indvars.iv186.i, 1
  %rules.i124 = getelementptr inbounds %struct.Production, ptr %230, i64 0, i32 2
  %231 = load i32, ptr %rules.i124, align 8, !tbaa !74
  %232 = zext i32 %231 to i64
  %cmp19.i = icmp ult i64 %indvars.iv.next187.i, %232
  br i1 %cmp19.i, label %for.body20.i, label %for.inc54.i126, !llvm.loop !177

for.inc54.i126:                                   ; preds = %for.inc51.i125, %for.cond13.preheader.i
  %indvars.iv.next190.i = add nuw nsw i64 %indvars.iv189.i, 1
  %exitcond193.not.i = icmp eq i64 %indvars.iv.next190.i, %206
  br i1 %exitcond193.not.i, label %for.cond8.if.then60_crit_edge.i, label %for.cond13.preheader.i, !llvm.loop !178

for.cond8.if.then60_crit_edge.i:                  ; preds = %for.inc54.i126
  ...
  %calloc.i.i.i127 = call dereferenceable_or_null(32) ptr @calloc(i64 1, i64 32)
  %end.i.i = getelementptr inbounds %struct.Rule, ptr %calloc.i.i, i64 0, i32 7
  store ptr %calloc.i.i.i127, ptr %end.i.i, align 8, !tbaa !22
  store i32 3, ptr %calloc.i.i.i127, align 8, !tbaa !23
  %rule.i.i = getelementptr inbounds %struct.Elem, ptr %calloc.i.i.i127, i64 0, i32 2
  ...
  %calloc.i.i143.i = call dereferenceable_or_null(32) ptr @calloc(i64 1, i64 32)
  %e1.i.i128 = getelementptr inbounds %struct.Elem, ptr %calloc.i.i143.i, i64 0, i32 3
  store ptr %233, ptr %e1.i.i128, align 8, !tbaa !28
  %rule.i144.i = getelementptr inbounds %struct.Elem, ptr %calloc.i.i143.i, i64 0, i32 2
  store ptr %calloc.i.i, ptr %rule.i144.i, align 8, !tbaa !25
  %235 = load ptr, ptr %arrayidx4.i, align 8, !tbaa !14
  %elem71.i = getelementptr inbounds %struct.Production, ptr %235, i64 0, i32 9
  store ptr %calloc.i.i143.i, ptr %elem71.i, align 8, !tbaa !176
...
for.inc81.i:                                      ; preds = %for.inc.i.i115, %for.cond8.if.then60_crit_edge.i, %lor.lhs.false.i, %for.body.i104
  %indvars.iv.next195.i = add nuw nsw i64 %indvars.iv194.i, 1
  %exitcond198.not.i = icmp eq i64 %indvars.iv.next195.i, %206
  br i1 %exitcond198.not.i, label %for.end83.i, label %for.body.i104, !llvm.loop !179

for.end83.i:                                      ; preds = %for.inc81.i, %merge_identical_terminals.exit.thread, %merge_identical_terminals.exit
  %cmp179.not.i196 = phi i1 [ true, %merge_identical_terminals.exit.thread ], [ true, %merge_identical_terminals.exit ], [ false, %for.inc81.i ]
  ...
  %242 = phi i32 [ 0, %merge_identical_terminals.exit.thread ], [ 0, %merge_identical_terminals.exit ], [ %.pr193, %for.inc81.i ]
  ...
  br i1 %tobool85.not.i, label %land.lhs.true.i130, label %make_elems_for_productions.exit

land.lhs.true.i130:                               ; preds = %for.end83.i
  ...
  %or.cond.i129 = or i1 %cmp179.not.i196, %tobool86.not.i
  br i1 %or.cond.i129, label %make_elems_for_productions.exit, label %for.body.lr.ph.i147.i

for.body.lr.ph.i147.i:                            ; preds = %land.lhs.true.i130
  %wide.trip.count.i146.i = zext i32 %242 to i64
  br label %for.body.i150.i

for.body.i150.i:                                  ; preds = %for.inc.i153.i, %for.body.lr.ph.i147.i
  %indvars.iv.i148.i = phi i64 [ 0, %for.body.lr.ph.i147.i ], [ %indvars.iv.next.i151.i, %for.inc.i153.i ]
  %arrayidx.i149.i = getelementptr inbounds ptr, ptr %241, i64 %indvars.iv.i148.i
  %245 = load ptr, ptr %arrayidx.i149.i, align 8, !tbaa !14
  %name_len.i.i131 = getelementptr inbounds %struct.Production, ptr %245, i64 0, i32 1
  %246 = load i32, ptr %name_len.i.i131, align 8, !tbaa !15
  %cmp2.not.i.i132 = icmp eq i32 %246, 10
  br i1 %cmp2.not.i.i132, label %cleanup.i.i135, label %for.inc.i153.i

cleanup.i.i135:                                   ; preds = %for.body.i150.i
  %247 = load ptr, ptr %245, align 8, !tbaa !17
  %call182.i.i133 = call i32 @strncmp(ptr noundef nonnull dereferenceable(1) %247, ptr noundef nonnull dereferenceable(11) @.str.75, i64 noundef 10) #22
  %tobool183.not.not.i.i134 = icmp eq i32 %call182.i.i133, 0
  br i1 %tobool183.not.not.i.i134, label %if.then90.i, label %for.inc.i153.i

for.inc.i153.i:                                   ; preds = %cleanup.i.i135, %for.body.i150.i
  %indvars.iv.next.i151.i = add nuw nsw i64 %indvars.iv.i148.i, 1
  %exitcond.not.i152.i = icmp eq i64 %indvars.iv.next.i151.i, %wide.trip.count.i146.i
  br i1 %exitcond.not.i152.i, label %make_elems_for_productions.exit, label %for.body.i150.i, !llvm.loop !18

if.then90.i:                                      ; preds = %cleanup.i.i135
  %calloc.i154.i = call dereferenceable_or_null(168) ptr @calloc(i64 1, i64 168)
  %prod.i155.i = getelementptr inbounds %struct.Rule, ptr %calloc.i154.i, i64 0, i32 1
  store ptr %240, ptr %prod.i155.i, align 8, !tbaa !20
  %calloc.i.i156.i = call dereferenceable_or_null(32) ptr @calloc(i64 1, i64 32)
  %end.i157.i = getelementptr inbounds %struct.Rule, ptr %calloc.i154.i, i64 0, i32 7
  store ptr %calloc.i.i156.i, ptr %end.i157.i, align 8, !tbaa !22
  store i32 3, ptr %calloc.i.i156.i, align 8, !tbaa !23
  %rule.i158.i = getelementptr inbounds %struct.Elem, ptr %calloc.i.i156.i, i64 0, i32 2
  store ptr %calloc.i154.i, ptr %rule.i158.i, align 8, !tbaa !25
  %action_index.i159.i = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 26
  %248 = load i32, ptr %action_index.i159.i, align 8, !tbaa !26
  %action_index4.i160.i = getelementptr inbounds %struct.Rule, ptr %calloc.i154.i, i64 0, i32 11
  store i32 %248, ptr %action_index4.i160.i, align 8, !tbaa !27
  %calloc.i.i161.i = call dereferenceable_or_null(32) ptr @calloc(i64 1, i64 32)
  %e1.i162.i = getelementptr inbounds %struct.Elem, ptr %calloc.i.i161.i, i64 0, i32 3
  store ptr %245, ptr %e1.i162.i, align 8, !tbaa !28
  %rule.i163.i = getelementptr inbounds %struct.Elem, ptr %calloc.i.i161.i, i64 0, i32 2
  store ptr %calloc.i154.i, ptr %rule.i163.i, align 8, !tbaa !25
  %elem93.i = getelementptr inbounds %struct.Production, ptr %245, i64 0, i32 9
  store ptr %calloc.i.i161.i, ptr %elem93.i, align 8, !tbaa !176
  ...
  store i32 %249, ptr %calloc.i154.i, align 8, !tbaa !143
  br label %make_elems_for_productions.exit

make_elems_for_productions.exit:                  ; preds = %for.inc.i153.i, %for.end83.i, %land.lhs.true.i130, %if.then90.i
  br i1 %cmp179.not.i196, label %check_default_actions.exit, label %for.body.lr.ph.i.i140

for.body.lr.ph.i.i140:                            ; preds = %make_elems_for_productions.exit
  %wide.trip.count.i.i139 = zext i32 %242 to i64
  br label %for.body.i.i145

for.body.i.i145:                                  ; preds = %for.inc.i.i150, %for.body.lr.ph.i.i140
  %indvars.iv.i.i141 = phi i64 [ 0, %for.body.lr.ph.i.i140 ], [ %indvars.iv.next.i.i148, %for.inc.i.i150 ]
  %arrayidx.i.i142 = getelementptr inbounds ptr, ptr %241, i64 %indvars.iv.i.i141
  %250 = load ptr, ptr %arrayidx.i.i142, align 8, !tbaa !14
  %name_len.i.i143 = getelementptr inbounds %struct.Production, ptr %250, i64 0, i32 1
  %251 = load i32, ptr %name_len.i.i143, align 8, !tbaa !15
  %cmp2.not.i.i144 = icmp eq i32 %251, 1
  br i1 %cmp2.not.i.i144, label %cleanup.i.i147, label %for.inc.i.i150

cleanup.i.i147:                                   ; preds = %for.body.i.i145
  %252 = load ptr, ptr %250, align 8, !tbaa !17
  %lhsc.i = load i8, ptr %252, align 1
  %tobool183.not.not.i.i146 = icmp eq i8 %lhsc.i, 95
  br i1 %tobool183.not.not.i.i146, label %land.lhs.true.i153, label %for.inc.i.i150

for.inc.i.i150:                                   ; preds = %cleanup.i.i147, %for.body.i.i145
  %indvars.iv.next.i.i148 = add nuw nsw i64 %indvars.iv.i.i141, 1
  %exitcond.not.i.i149 = icmp eq i64 %indvars.iv.next.i.i148, %wide.trip.count.i.i139
  br i1 %exitcond.not.i.i149, label %check_default_actions.exit, label %for.body.i.i145, !llvm.loop !18

land.lhs.true.i153:                               ; preds = %cleanup.i.i147
  %rules.i151 = getelementptr inbounds %struct.Production, ptr %250, i64 0, i32 2
  %253 = load i32, ptr %rules.i151, align 8, !tbaa !74
  %cmp.i152 = icmp ugt i32 %253, 1
  br i1 %cmp.i152, label %if.then.i154, label %check_default_actions.exit

if.then.i154:                                     ; preds = %land.lhs.true.i153
  call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.77) #23
  br label %check_default_actions.exit

check_default_actions.exit:                       ; preds = %for.inc.i.i150, %make_elems_for_productions.exit, %land.lhs.true.i153, %if.then.i154
  call void @build_LR_tables(ptr noundef %g) #23
  ...
  br i1 %cmp63.not.i, label %for.cond2.preheader.i159, label %for.body.lr.ph.i157

for.body.lr.ph.i157:                              ; preds = %check_default_actions.exit
  %v.i156 = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 3, i32 2
  br label %for.body.i169

for.cond2.preheader.i159:                         ; preds = %for.body.i169, %check_default_actions.exit
  %255 = phi i32 [ 0, %check_default_actions.exit ], [ %259, %for.body.i169 ]
  %256 = load i32, ptr %declarations.i, align 8, !tbaa !48
  %cmp465.not.i = icmp eq i32 %256, 0
  br i1 %cmp465.not.i, label %for.cond21.preheader.i, label %for.body5.lr.ph.i162

for.body5.lr.ph.i162:                             ; preds = %for.cond2.preheader.i159
  %v7.i160 = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 7, i32 2
  %v.i.i161 = getelementptr inbounds %struct.Grammar, ptr %g, i64 0, i32 3, i32 2
  br label %for.body5.i173

for.body.i169:                                    ; preds = %for.body.i169, %for.body.lr.ph.i157
  %indvars.iv.i163 = phi i64 [ 0, %for.body.lr.ph.i157 ], [ %indvars.iv.next.i167, %for.body.i169 ]
  %257 = load ptr, ptr %v.i156, align 8, !tbaa !91
  %arrayidx.i164 = getelementptr inbounds ptr, ptr %257, i64 %indvars.iv.i163
  %258 = load ptr, ptr %arrayidx.i164, align 8, !tbaa !14
  %scan_kind.i165 = getelementptr inbounds %struct.State, ptr %258, i64 0, i32 10
  %bf.load.i166 = load i8, ptr %scan_kind.i165, align 8
  %bf.set.i = or i8 %bf.load.i166, 24
  store i8 %bf.set.i, ptr %scan_kind.i165, align 8
  %indvars.iv.next.i167 = add nuw nsw i64 %indvars.iv.i163, 1
  %259 = load i32, ptr %states.i, align 8, !tbaa !90
  %260 = zext i32 %259 to i64
  %cmp.i168 = icmp ult i64 %indvars.iv.next.i167, %260
  br i1 %cmp.i168, label %for.body.i169, label %for.cond2.preheader.i159, !llvm.loop !181

for.cond21.preheader.i:                           ; preds = %for.inc18.i, %for.cond2.preheader.i159
  %261 = phi i32 [ %255, %for.cond2.preheader.i159 ], [ %295, %for.inc18.i ]
  %262 = phi i32 [ %255, %for.cond2.preheader.i159 ], [ %296, %for.inc18.i ]
...
for.body5.i173:                                   ; preds = %for.inc18.i, %for.body5.lr.ph.i162
  %263 = phi i32 [ %255, %for.body5.lr.ph.i162 ], [ %295, %for.inc18.i ]
  %264 = phi i32 [ %255, %for.body5.lr.ph.i162 ], [ %296, %for.inc18.i ]
  %265 = phi i32 [ %256, %for.body5.lr.ph.i162 ], [ %297, %for.inc18.i ]
  %266 = phi i32 [ %255, %for.body5.lr.ph.i162 ], [ %298, %for.inc18.i ]
  %indvars.iv70.i = phi i64 [ 0, %for.body5.lr.ph.i162 ], [ %indvars.iv.next71.i, %for.inc18.i ]
  %267 = load ptr, ptr %v7.i160, align 8, !tbaa !50
  %arrayidx9.i170 = getelementptr inbounds ptr, ptr %267, i64 %indvars.iv70.i
  %268 = load ptr, ptr %arrayidx9.i170, align 8, !tbaa !14
  %269 = getelementptr i8, ptr %268, i64 8
  %.val.i171 = load i32, ptr %269, align 8, !tbaa !47
  %switch.i.i172 = icmp ugt i32 %.val.i171, 2
  br i1 %switch.i.i172, label %for.inc18.i, label %if.then.i175

if.then.i175:                                     ; preds = %for.body5.i173
  %cmp3.not.i.i174 = icmp eq i32 %266, 0
  br i1 %cmp3.not.i.i174, label %for.inc18.i, label %for.body.i.i179

for.body.ithread-pre-split.i:                     ; preds = %for.inc70.i.i
  %.pr.i176 = load i32, ptr %269, align 8, !tbaa !47
  br label %for.body.i.i179

for.body.i.i179:                                  ; preds = %if.then.i175, %for.body.ithread-pre-split.i
  %270 = phi i32 [ %.pr.i176, %for.body.ithread-pre-split.i ], [ %.val.i171, %if.then.i175 ]
  %indvars.iv7.i.i = phi i64 [ %indvars.iv.next8.i.i, %for.body.ithread-pre-split.i ], [ 0, %if.then.i175 ]
  %base_s.05.i.i = phi ptr [ %base_s.1.i.i, %for.body.ithread-pre-split.i ], [ null, %if.then.i175 ]
  %271 = load ptr, ptr %v.i.i161, align 8, !tbaa !91
  %arrayidx.i.i177 = getelementptr inbounds ptr, ptr %271, i64 %indvars.iv7.i.i
  %272 = load ptr, ptr %arrayidx.i.i177, align 8, !tbaa !14
  %cmp2.i.i178 = icmp eq i32 %270, 0
  br i1 %cmp2.i.i178, label %if.then.i.i181, label %for.cond7.preheader.i.i

if.then.i.i181:                                   ; preds = %for.body.i.i179
  %tobool.not.i.i180 = icmp eq ptr %base_s.05.i.i, null
  br i1 %tobool.not.i.i180, label %for.cond7.preheader.i.i, label %if.else.i.i182

if.else.i.i182:                                   ; preds = %if.then.i.i181
...
for.cond1.preheader.lr.ph.i.i.i:                  ; preds = %if.else.i.i182
...
if.then38.i.i.i:                                  ; preds = %if.then34.i.i.i, %if.else.thread.i.i.i
  ...
  %284 = phi ptr [ %278, %if.then34.i.i.i ], [ %.pre.i.i.i, %if.else.thread.i.i.i ]
  %inc47.i.i.i = add nuw nsw i32 %274, 1
  store i32 %inc47.i.i.i, ptr %shift_actions2.i.i.i, align 8, !tbaa !107
  %arrayidx49.i.i.i = getelementptr inbounds ptr, ptr %284, i64 %idxprom48.i.pre-phi.i.i
...
if.end69.i.i.i:                                   ; preds = %if.else51.i.i.i, %if.then34.i.i.i, %if.else.thread.i.i.i
  %285 = phi ptr [ %276, %if.else51.i.i.i ], [ %276, %if.then34.i.i.i ], [ %.pre12.i.i, %if.else.thread.i.i.i ]
  call void @vec_add_internal(ptr noundef nonnull %shift_actions2.i.i.i, ptr noundef %285) #23
  br label %for.inc75.i.i.i
...
for.inc75.i.i.i:                                  ; preds = %for.body5.i.i.i, %if.end69.i.i.i, %if.then55.i.i.i, %if.then38.i.i.i, %if.then15.i.i.i
  ...
  %286 = load i32, ptr %shift_actions.i.i.i, align 8, !tbaa !107
  %287 = zext i32 %286 to i64
  %cmp.i.i.i = icmp ult i64 %indvars.iv.next114.i.i.i, %287
  br i1 %cmp.i.i.i, label %for.cond1.preheader.i.i.i, label %for.cond7.preheader.i.i, !llvm.loop !183

for.cond7.preheader.i.i:                          ; preds = %for.inc75.i.i.i, %if.else.i.i182, %if.then.i.i181, %for.body.i.i179
  %base_s.1.i.i = phi ptr [ %base_s.05.i.i, %for.body.i.i179 ], [ %272, %if.then.i.i181 ], [ %base_s.05.i.i, %if.else.i.i182 ], [ %base_s.05.i.i, %for.inc75.i.i.i ]
  %items.i.i = getelementptr inbounds %struct.State, ptr %272, i64 0, i32 2
  %288 = load i32, ptr %items.i.i, align 8, !tbaa !96
  %cmp91.not.i.i = icmp eq i32 %288, 0
...
for.body10.i.i:                                   ; preds = %for.inc.i.i188, %for.body10.lr.ph.i.i
  %indvars.iv.i.i183 = phi i64 [ 0, %for.body10.lr.ph.i.i ], [ %indvars.iv.next.i.i186, %for.inc.i.i188 ]
  %arrayidx14.i.i = getelementptr inbounds ptr, ptr %.pre13.i.i, i64 %indvars.iv.i.i183
  %290 = load ptr, ptr %arrayidx14.i.i, align 8, !tbaa !14
  %291 = load i32, ptr %290, align 8, !tbaa !23
  %cmp16.i.i184 = icmp eq i32 %291, 1
  br i1 %cmp16.i.i184, label %if.then17.i.i, label %for.inc.i.i188

if.then17.i.i:                                    ; preds = %for.body10.i.i
  %e.i.i185 = getelementptr inbounds %struct.Elem, ptr %290, i64 0, i32 3
  %292 = load ptr, ptr %e.i.i185, align 8, !tbaa !28
  %scan_kind.i.i = getelementptr inbounds %struct.Term, ptr %292, i64 0, i32 7
  %bf.load.i.i = load i8, ptr %scan_kind.i.i, align 4
  %bf.clear.i.i = and i8 %bf.load.i.i, 7
  %bf.cast.i.i = zext i8 %bf.clear.i.i to i32
  switch i32 %bf.cast.i.i, label %for.inc.i.i188 [
...
for.inc.i.i188:                                   ; preds = %for.inc.sink.split.i.i, %if.then17.i.i, %for.body10.i.i
  %indvars.iv.next.i.i186 = add nuw nsw i64 %indvars.iv.i.i183, 1
  %exitcond.not.i187 = icmp eq i64 %indvars.iv.next.i.i186, %289
  br i1 %exitcond.not.i187, label %for.inc70.i.i, label %for.body10.i.i, !llvm.loop !184

for.inc70.i.i:                                    ; preds = %for.inc.i.i188, %for.cond7.preheader.i.i
  %indvars.iv.next8.i.i = add nuw nsw i64 %indvars.iv7.i.i, 1
  %293 = load i32, ptr %states.i, align 8, !tbaa !90
  %294 = zext i32 %293 to i64
  %cmp.i.i189 = icmp ult i64 %indvars.iv.next8.i.i, %294
  br i1 %cmp.i.i189, label %for.body.ithread-pre-split.i, label %for.inc18.loopexit.i, !llvm.loop !185

for.inc18.loopexit.i:                             ; preds = %for.inc70.i.i
  %.pre.i190 = load i32, ptr %declarations.i, align 8, !tbaa !48
  br label %for.inc18.i

for.inc18.i:                                      ; preds = %for.inc18.loopexit.i, %if.then.i175, %for.body5.i173
  %295 = phi i32 [ %293, %for.inc18.loopexit.i ], [ %263, %if.then.i175 ], [ %263, %for.body5.i173 ]
  %296 = phi i32 [ %293, %for.inc18.loopexit.i ], [ %264, %if.then.i175 ], [ %264, %for.body5.i173 ]
  %297 = phi i32 [ %.pre.i190, %for.inc18.loopexit.i ], [ %265, %if.then.i175 ], [ %265, %for.body5.i173 ]
  %298 = phi i32 [ %293, %for.inc18.loopexit.i ], [ 0, %if.then.i175 ], [ %266, %for.body5.i173 ]
  %indvars.iv.next71.i = add nuw nsw i64 %indvars.iv70.i, 1
  %299 = zext i32 %297 to i64
  %cmp4.i191 = icmp ult i64 %indvars.iv.next71.i, %299
  br i1 %cmp4.i191, label %for.body5.i173, label %for.cond21.preheader.i, !llvm.loop !186

for.body25.i:                                     ; preds = %for.inc40.i, %for.body25.lr.ph.i
  %300 = phi i32 [ %261, %for.body25.lr.ph.i ], [ %305, %for.inc40.i ]
  %301 = phi i32 [ %262, %for.body25.lr.ph.i ], [ %306, %for.inc40.i ]
  %indvars.iv73.i = phi i64 [ 0, %for.body25.lr.ph.i ], [ %indvars.iv.next74.i, %for.inc40.i ]
  %302 = load ptr, ptr %v27.i, align 8, !tbaa !91
  %arrayidx29.i = getelementptr inbounds ptr, ptr %302, i64 %indvars.iv73.i
  %303 = load ptr, ptr %arrayidx29.i, align 8, !tbaa !14
  %scan_kind30.i = getelementptr inbounds %struct.State, ptr %303, i64 0, i32 10
  %bf.load31.i = load i8, ptr %scan_kind30.i, align 8
  %304 = and i8 %bf.load31.i, 24
  %cmp33.i = icmp eq i8 %304, 24
...
for.inc40.i:                                      ; preds = %if.then34.i, %for.body25.i
  ...
  %306 = phi i32 [ %301, %for.body25.i ], [ %.pre76.i, %if.then34.i ]
  %indvars.iv.next74.i = add nuw nsw i64 %indvars.iv73.i, 1
  %307 = zext i32 %306 to i64
  %cmp24.i = icmp ult i64 %indvars.iv.next74.i, %307
...
map_declarations_to_states.exit:                  ; preds = %for.inc40.i, %for.cond21.preheader.i
  %308 = phi i32 [ %261, %for.cond21.preheader.i ], [ %305, %for.inc40.i ]
  %309 = load i32, ptr @verbose_level, align 4, !tbaa !188
  %tobool.not = icmp eq i32 %309, 0
  br i1 %tobool.not, label %if.end5, label %if.end

if.end:                                           ; preds = %map_declarations_to_states.exit
  %310 = load i32, ptr %productions.i, align 8, !tbaa !5
  %311 = load i32, ptr %terminals.i, align 8, !tbaa !38
  %312 = load i32, ptr %declarations.i, align 8, !tbaa !48
  %call = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.45, i32 noundef %310, i32 noundef %311, i32 noundef %308, i32 noundef %312)
  %.pr197 = load i32, ptr @verbose_level, align 4, !tbaa !188
  %cmp = icmp sgt i32 %.pr197, 1
...
if.end5:                                          ; preds = %map_declarations_to_states.exit, %if.then4, %if.end
  call void @build_scanners(ptr noundef nonnull %g) #23
...
if.then2:                                         ; preds = %if.end
  ...
  tail call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.67, ptr noundef %2) #23
...
lor.lhs.false:                                    ; preds = %for.body
  ...
  %or.cond561 = select i1 %tobool10.not, i1 %cmp13, i1 false
  br i1 %or.cond561, label %if.then14, label %if.end16

if.then14:                                        ; preds = %lor.lhs.false, %for.body
  %9 = load ptr, ptr %p, align 8, !tbaa !17
  tail call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.68, ptr noundef %9) #23
  br label %if.end16
...
if.then32:                                        ; preds = %if.then26
  ...
  tail call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.69, ptr noundef %15, ptr noundef %16) #23
...
if.then58:                                        ; preds = %lor.lhs.false50, %for.body42
  ...
  tail call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.70, i32 noundef %25, ptr noundef %24) #23
...
if.then75:                                        ; preds = %if.else67
  tail call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.71) #23
  br label %for.inc82.sink.split.sink.split
...
for.end87:                                        ; preds = %for.inc85, %if.end3
  ...
  %call = tail call noalias ptr @malloc(i64 noundef %conv) #24
  %calloc.i = tail call dereferenceable_or_null(48) ptr @calloc(i64 1, i64 48)
...
Lfail:                                            ; preds = %if.then169, %if.end152, %land.lhs.true249, %land.lhs.true221, %if.then145
  ...
  tail call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.72, ptr noundef %38) #23
  br label %if.end152
...
if.then169:                                       ; preds = %if.end152
  ...
  %or.cond562 = select i1 %cmp175.not, i1 true, i1 %cmp183.not
  br i1 %or.cond562, label %if.end186, label %Lfail

if.end186:                                        ; preds = %if.then169
  br i1 %cmp175.not, label %cond.true205, label %cond.end

cond.end:                                         ; preds = %if.end186
  %cmp203 = icmp eq ptr %40, %42
  br i1 %cmp203, label %cond.true205, label %cond.end213

cond.true205:                                     ; preds = %if.end186, %cond.end
  %cond585 = phi ptr [ %42, %cond.end ], [ %40, %if.end186 ]
  br label %cond.end213

cond.end213:                                      ; preds = %cond.end, %cond.true205
  %cond584 = phi ptr [ %cond585, %cond.true205 ], [ %42, %cond.end ]
  %cond214 = phi ptr [ %42, %cond.true205 ], [ %40, %cond.end ]
...
land.lhs.true221:                                 ; preds = %cond.end213
...
if.end229:                                        ; preds = %cond.end213, %land.lhs.true221
...
if.then272:                                       ; preds = %cond.end267
  %call.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %57) #22
  %add.i = shl i64 %call.i, 1
  %mul.i = add i64 %add.i, 2
  %call1.i = tail call noalias ptr @malloc(i64 noundef %mul.i) #24
...
if.end277:                                        ; preds = %cond.end267, %escape_string_for_regex.exit
  ...
  %call278 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s.0) #22
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %incdec.ptr, ptr align 1 %s.0, i64 %call278, i1 false)
  %call279 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s.0) #22
...
if.then283:                                       ; preds = %if.end277
  tail call void @free(ptr noundef %s.0) #23
  br label %if.end284
...
if.then349:                                       ; preds = %cond.end344
  %call.i563 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %72) #22
  %add.i564 = shl i64 %call.i563, 1
  %mul.i565 = add i64 %add.i564, 2
  %call1.i566 = tail call noalias ptr @malloc(i64 noundef %mul.i565) #24
  %73 = load i8, ptr %72, align 1, !tbaa !28
  %tobool.not11.i567 = icmp eq i8 %73, 0
  br i1 %tobool.not11.i567, label %escape_string_for_regex.exit581, label %for.body.i571

for.body.i571:                                    ; preds = %if.then349, %sw.default.i579
  %74 = phi i8 [ %76, %sw.default.i579 ], [ %73, %if.then349 ]
  %s.addr.013.i568 = phi ptr [ %incdec.ptr3.i577, %sw.default.i579 ], [ %72, %if.then349 ]
  %ss.012.i569 = phi ptr [ %incdec.ptr2.i576, %sw.default.i579 ], [ %call1.i566, %if.then349 ]
  %conv.i570 = sext i8 %74 to i32
  switch i32 %conv.i570, label %sw.default.i579 [
    i32 40, label %sw.bb.i574
    i32 41, label %sw.bb.i574
    i32 91, label %sw.bb.i574
    i32 93, label %sw.bb.i574
    i32 45, label %sw.bb.i574
    i32 94, label %sw.bb.i574
    i32 42, label %sw.bb.i574
    i32 63, label %sw.bb.i574
    i32 43, label %sw.bb.i574
  ]

sw.bb.i574:                                       ; preds = %for.body.i571, %for.body.i571, %for.body.i571, %for.body.i571, %for.body.i571, %for.body.i571, %for.body.i571, %for.body.i571, %for.body.i571
  %incdec.ptr.i572 = getelementptr inbounds i8, ptr %ss.012.i569, i64 1
  store i8 92, ptr %ss.012.i569, align 1, !tbaa !28
  %.pre.i573 = load i8, ptr %s.addr.013.i568, align 1, !tbaa !28
  br label %sw.default.i579

sw.default.i579:                                  ; preds = %sw.bb.i574, %for.body.i571
  %75 = phi i8 [ %74, %for.body.i571 ], [ %.pre.i573, %sw.bb.i574 ]
  %ss.1.i575 = phi ptr [ %ss.012.i569, %for.body.i571 ], [ %incdec.ptr.i572, %sw.bb.i574 ]
  %incdec.ptr2.i576 = getelementptr inbounds i8, ptr %ss.1.i575, i64 1
  store i8 %75, ptr %ss.1.i575, align 1, !tbaa !28
  %incdec.ptr3.i577 = getelementptr inbounds i8, ptr %s.addr.013.i568, i64 1
  %76 = load i8, ptr %incdec.ptr3.i577, align 1, !tbaa !28
  %tobool.not.i578 = icmp eq i8 %76, 0
  br i1 %tobool.not.i578, label %escape_string_for_regex.exit581, label %for.body.i571, !llvm.loop !29

escape_string_for_regex.exit581:                  ; preds = %sw.default.i579, %if.then349
  %ss.0.lcssa.i580 = phi ptr [ %call1.i566, %if.then349 ], [ %incdec.ptr2.i576, %sw.default.i579 ]
  store i8 0, ptr %ss.0.lcssa.i580, align 1, !tbaa !28
  br label %if.end354

if.end354:                                        ; preds = %cond.end344, %escape_string_for_regex.exit581
  %s.1 = phi ptr [ %call1.i566, %escape_string_for_regex.exit581 ], [ %72, %cond.end344 ]
  %call355 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s.1) #22
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %b.4602, ptr align 1 %s.1, i64 %call355, i1 false)
  %call356 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %s.1) #22
...
if.then361:                                       ; preds = %if.end354
  tail call void @free(ptr noundef %s.1) #23
  br label %for.inc363
...
if.end396:                                        ; preds = %for.end382, %if.then387, %if.end308, %if.end284
  ...
  %call392 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %85) #22
...
if.then7:                                         ; preds = %if.end
  tail call void (ptr, ...) @d_fail(ptr noundef nonnull @.str.74) #23
  br label %cleanup
...
attributes #16 = { mustprogress nounwind willreturn uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
