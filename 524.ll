; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/ldecod/erc_do_p.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/ldecod/erc_do_p.c"
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %predBlocks) #22
...
if.then4:                                         ; preds = %if.then3
  ...
  %call = tail call noalias ptr @malloc(i64 noundef %mul6) #23
  br label %if.end

if.else:                                          ; preds = %if.then3
  %call7 = tail call noalias dereferenceable_or_null(512) ptr @malloc(i64 noundef 512) #23
  br label %if.end
...
for.body57.us:                                    ; preds = %for.cond54.preheader.us, %if.end76.us
  ...
  %call63.us = call i32 @ercCollect8PredBlocks(ptr noundef nonnull %predBlocks, i32 noundef %shl58.us, i32 noundef %shl25.us, ptr noundef %14, i32 noundef %shl61, i32 noundef %shl62, i32 noundef 2, i8 noundef zeroext 0) #22
...
if.end76.us:                                      ; preds = %if.then66.us, %if.else72.us
  call void @ercMarkCurrMBConcealed(i32 noundef %add68.us, i32 noundef -1, i32 noundef %picSizeX, ptr noundef nonnull %errorVar) #22
...
for.body123.us:                                   ; preds = %for.body123.us.preheader, %if.end150.us
  ...
  %call137.us = call i32 @ercCollect8PredBlocks(ptr noundef nonnull %predBlocks, i32 noundef %shl132.us, i32 noundef %shl25.us, ptr noundef %18, i32 noundef %shl61, i32 noundef %shl62, i32 noundef 2, i8 noundef zeroext 0) #22
...
if.end150.us:                                     ; preds = %if.then140.us, %if.else146.us
  call void @ercMarkCurrMBConcealed(i32 noundef %add142.us, i32 noundef -1, i32 noundef %picSizeX, ptr noundef nonnull %errorVar) #22
...
for.body89.us:                                    ; preds = %for.cond86.preheader.us, %if.end109.us
  ...
  %call96.us = call i32 @ercCollect8PredBlocks(ptr noundef nonnull %predBlocks, i32 noundef %shl91.us, i32 noundef %shl25.us, ptr noundef %21, i32 noundef %shl61, i32 noundef %shl62, i32 noundef 2, i8 noundef zeroext 0) #22
...
if.end109.us:                                     ; preds = %if.then99.us, %if.else105.us
  call void @ercMarkCurrMBConcealed(i32 noundef %add101.us, i32 noundef -1, i32 noundef %picSizeX, ptr noundef nonnull %errorVar) #22
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 12, ptr nonnull %mvPred) #22
...
cond.false113.peel:                               ; preds = %cond.false
  %mv175 = getelementptr inbounds %struct.objectBuffer_t, ptr %object_list, i64 %idx.ext39, i32 3
  %cmp267 = icmp eq i32 %compSplit1.3, %compSplit2.3
  %cond269.neg = select i1 %cmp267, i32 -2, i32 -1
  %cond582 = icmp eq i8 %2, 0
  br i1 %cond582, label %if.then121.peel, label %cond.false113.peel.if.else156.peel_crit_edge

cond.false113.peel.if.else156.peel_crit_edge:     ; preds = %cond.false113.peel
  %.pre562 = zext i32 %compSplit1.3 to i64
  br label %if.else156.peel

cond.true103.peel:                                ; preds = %cond.true66
  %mv175564 = getelementptr inbounds %struct.objectBuffer_t, ptr %object_list, i64 %idx.ext39, i32 3
...
if.else156.peel:                                  ; preds = %cond.true103.peel, %cond.false113.peel.if.else156.peel_crit_edge
  %cond269.neg580 = phi i32 [ %cond269.neg, %cond.false113.peel.if.else156.peel_crit_edge ], [ %cond269.neg566, %cond.true103.peel ]
  %mv175575 = phi ptr [ %mv175, %cond.false113.peel.if.else156.peel_crit_edge ], [ %mv175564, %cond.true103.peel ]
  %conv91570 = phi i32 [ 0, %cond.false113.peel.if.else156.peel_crit_edge ], [ 1, %cond.true103.peel ]
  %idx.ext168.peel.pre-phi = phi i64 [ %.pre562, %cond.false113.peel.if.else156.peel_crit_edge ], [ %idx.ext107.peel, %cond.true103.peel ]
  %add.ptr169.peel = getelementptr inbounds %struct.objectBuffer_t, ptr %add.ptr40, i64 %idx.ext168.peel.pre-phi
  %mv.peel = getelementptr inbounds %struct.objectBuffer_t, ptr %add.ptr169.peel, i64 0, i32 3
  %cond.peel = select i1 %cmp41, ptr %mv.peel, ptr %mv175575
  %6 = load <2 x i32>, ptr %cond.peel, align 4, !tbaa !20
  store <2 x i32> %6, ptr %mvPred, align 8, !tbaa !20
  %arrayidx181.peel = getelementptr inbounds i32, ptr %cond.peel, i64 2
  %7 = load i32, ptr %arrayidx181.peel, align 4, !tbaa !20
...
if.then121.peel:                                  ; preds = %cond.true103.peel, %cond.false113.peel
  ...
  %mv175574 = phi ptr [ %mv175564, %cond.true103.peel ], [ %mv175, %cond.false113.peel ]
...
if.end187.peel:                                   ; preds = %if.else123.peel, %if.else156.peel
  %.sink = phi i32 [ 0, %if.else123.peel ], [ %7, %if.else156.peel ]
  %cond269.neg578 = phi i32 [ %cond269.neg579, %if.else123.peel ], [ %cond269.neg580, %if.else156.peel ]
  %mv175573 = phi ptr [ %mv175574, %if.else123.peel ], [ %mv175575, %if.else156.peel ]
  ...
  %8 = load ptr, ptr @erc_img, align 8, !tbaa !12
  %9 = load i32, ptr %xMin, align 4, !tbaa !28
  %10 = load i32, ptr %yMin, align 4, !tbaa !30
  call fastcc void @buildPredRegionYUV(ptr noundef %8, ptr noundef nonnull %mvPred, i32 noundef %9, i32 noundef %10, ptr noundef %predMB)
  %11 = load ptr, ptr %recfr, align 8, !tbaa !32
  %call.peel = tail call fastcc i32 @edgeDistortion(ptr noundef nonnull %predBlocks, i32 noundef %add9, ptr noundef %predMB, ptr noundef %11, i32 noundef %picSizeX)
...
cond.true222.peel:                                ; preds = %for.body209.preheader.peel
  ...
  %13 = load i8, ptr %add.ptr227.peel, align 4, !tbaa !31
  %cmp230.peel = icmp eq i8 %13, 4
...
for.inc266.peel:                                  ; preds = %cond.true103.peel, %cond.end248.peel, %if.end187.peel, %if.then121.peel
  ...
  %mv175572 = phi ptr [ %mv175574, %if.then121.peel ], [ %mv175573, %if.end187.peel ], [ %mv175573, %cond.end248.peel ], [ %mv175564, %cond.true103.peel ]
...
for.body95:                                       ; preds = %for.inc266.peel
  %14 = load i8, ptr %add.ptr40, align 4, !tbaa !31
  %cmp101 = icmp ugt i8 %14, 2
...
cond.true103:                                     ; preds = %for.body95
  ...
  %15 = load i8, ptr %add.ptr108, align 4, !tbaa !31
...
cond.false113:                                    ; preds = %for.body95
  switch i8 %14, label %cond.false113.if.else156_crit_edge [
    i8 0, label %if.then121
    i8 2, label %for.inc274
  ]

cond.false113.if.else156_crit_edge:               ; preds = %cond.false113
  %.pre = zext i32 %compSplit2.3 to i64
  br label %if.else156
...
if.else156:                                       ; preds = %cond.true103, %cond.false113.if.else156_crit_edge
  %idx.ext168.pre-phi = phi i64 [ %.pre, %cond.false113.if.else156_crit_edge ], [ %idx.ext107, %cond.true103 ]
  %add.ptr169 = getelementptr inbounds %struct.objectBuffer_t, ptr %add.ptr40, i64 %idx.ext168.pre-phi
  %mv = getelementptr inbounds %struct.objectBuffer_t, ptr %add.ptr169, i64 0, i32 3
  %cond = select i1 %cmp101, ptr %mv, ptr %mv175572
  %16 = load <2 x i32>, ptr %cond, align 4, !tbaa !20
  store <2 x i32> %16, ptr %mvPred, align 8, !tbaa !20
  %arrayidx181 = getelementptr inbounds i32, ptr %cond, i64 2
  %17 = load i32, ptr %arrayidx181, align 4, !tbaa !20
  br label %if.end187

if.end187:                                        ; preds = %if.else156, %if.else123
  %.sink588 = phi i32 [ %17, %if.else156 ], [ 0, %if.else123 ]
  ...
  %18 = load ptr, ptr @erc_img, align 8, !tbaa !12
  %19 = load i32, ptr %xMin, align 4, !tbaa !28
  %20 = load i32, ptr %yMin, align 4, !tbaa !30
  call fastcc void @buildPredRegionYUV(ptr noundef %18, ptr noundef nonnull %mvPred, i32 noundef %19, i32 noundef %20, ptr noundef %predMB)
  %21 = load ptr, ptr %recfr, align 8, !tbaa !32
  %call = tail call fastcc i32 @edgeDistortion(ptr noundef nonnull %predBlocks, i32 noundef %add9, ptr noundef %predMB, ptr noundef %21, i32 noundef %picSizeX)
...
for.body209.preheader:                            ; preds = %if.end187
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %mvBest, ptr noundef nonnull align 8 dereferenceable(12) %mvPred, i64 12, i1 false), !tbaa !20
  %22 = load i8, ptr %add.ptr40, align 4, !tbaa !31
  %cmp220 = icmp ugt i8 %22, 2
...
for.end276:                                       ; preds = %for.inc274
  %24 = add nsw i32 %threshold.1, -3
  %cmp277 = icmp ult i32 %24, -2
  %cmp279 = icmp eq i32 %fInterNeighborExists.3, 0
  %25 = select i1 %cmp277, i1 %cmp279, i1 false
  br i1 %25, label %do.body30, label %do.end, !llvm.loop !35
...
if.then282:                                       ; preds = %do.end
  ...
  %26 = load ptr, ptr @erc_img, align 8, !tbaa !12
  %27 = load i32, ptr %xMin, align 4, !tbaa !28
  %28 = load i32, ptr %yMin, align 4, !tbaa !30
  call fastcc void @buildPredRegionYUV(ptr noundef %26, ptr noundef nonnull %mvPred, i32 noundef %27, i32 noundef %28, ptr noundef %predMB)
  %29 = load ptr, ptr %recfr, align 8, !tbaa !32
  %call303 = tail call fastcc i32 @edgeDistortion(ptr noundef nonnull %predBlocks, i32 noundef %add9, ptr noundef %predMB, ptr noundef %29, i32 noundef %picSizeX)
...
if.end339:                                        ; preds = %for.body312.preheader, %if.then282, %do.end
  %30 = mul nsw i64 %idx.ext, 24
  %31 = or i64 %30, 12
  %uglygep = getelementptr i8, ptr %object_list, i64 %31
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %uglygep, ptr noundef nonnull align 4 dereferenceable(12) %mvBest, i64 12, i1 false), !tbaa !20
  ...
  call void @llvm.lifetime.end.p0(i64 12, ptr nonnull %mvPred) #22
...
while.body:                                       ; preds = %while.body.lr.ph, %if.end29
  ...
  %call = tail call ptr @alloc_storable_picture(i32 noundef 0, i32 noundef %6, i32 noundef %7, i32 noundef %8, i32 noundef %9) #22
...
if.end29:                                         ; preds = %if.then19, %copy_prev_pic_to_concealed_pic.exit
  tail call void @store_picture_in_dpb(ptr noundef %call) #22
...
for.end47:                                        ; preds = %for.end47.loopexit.unr-lcssa, %if.then37.epil, %for.body32.epil, %for.cond30.preheader
  ...
  tail call void @qsort(ptr noundef %30, i64 noundef %conv, i64 noundef 8, ptr noundef nonnull @compare_pic_by_pic_num_desc) #22
...
if.end49.if.end151_crit_edge:                     ; preds = %if.end49
  %.pre333 = load i32, ptr @listXsize, align 16, !tbaa !20
...
for.end82:                                        ; preds = %for.inc80, %for.cond56.preheader
  ...
  tail call void @qsort(ptr noundef %41, i64 noundef %conv83, i64 noundef 8, ptr noundef nonnull @compare_pic_by_poc_desc) #22
...
for.end112:                                       ; preds = %for.inc110, %for.end82
  ...
  tail call void @qsort(ptr noundef %arrayidx114, i64 noundef %conv116, i64 noundef 8, ptr noundef nonnull @compare_pic_by_poc_asc) #22
...
for.end141:                                       ; preds = %for.body133.prol.loopexit, %for.body133, %for.cond130.preheader
  ...
  tail call void @qsort(ptr noundef %arrayidx143, i64 noundef 0, i64 noundef 8, ptr noundef nonnull @compare_pic_by_lt_pic_num_asc) #22
  ...
  tail call void @qsort(ptr noundef %arrayidx147, i64 noundef %conv149, i64 noundef 8, ptr noundef nonnull @compare_pic_by_lt_pic_num_asc) #22
  br label %if.end151
...
entry:
  %call = tail call noalias dereferenceable_or_null(24) ptr @calloc(i64 noundef 1, i64 noundef 24) #24
...
define dso_local void @delete_node(ptr nocapture noundef %ptr) local_unnamed_addr #15 {
entry:
  %0 = load ptr, ptr @concealment_head, align 8, !tbaa !12
...
while.body8:                                      ; preds = %if.end5, %while.body8
  ...
  tail call void @free(ptr noundef nonnull %ptr.addr.020) #22
...
if.end:                                           ; preds = %entry
  ...
  tail call void @qsort(ptr noundef nonnull @pocs_in_dpb, i64 noundef %conv, i64 noundef 4, ptr noundef nonnull @comp) #22
...
if.then8:                                         ; preds = %for.body
  ...
  %call = tail call ptr @alloc_storable_picture(i32 noundef 0, i32 noundef %8, i32 noundef %9, i32 noundef %10, i32 noundef %11) #22
...
update_ref_list_for_concealment.exit:             ; preds = %update_ref_list_for_concealment.exit.loopexit, %if.then9.i
  ...
  %call.i = tail call noalias dereferenceable_or_null(24) ptr @calloc(i64 noundef 1, i64 noundef 24) #24
...
entry:
  ...
  %1 = load i32, ptr %conceal_slice_type, align 4, !tbaa !77
...
if.then25:                                        ; preds = %if.then22
  ...
  %call = tail call noalias ptr @malloc(i64 noundef %mul27) #23
  br label %if.end29

if.else:                                          ; preds = %if.then22
  %call28 = tail call noalias dereferenceable_or_null(32) ptr @malloc(i64 noundef 32) #23
  br label %if.end29
...
if.else46:                                        ; preds = %if.end29
  tail call void @init_lists(i32 noundef %1, i32 noundef %73) #22
  br label %if.end50
...
if.end127.us:                                     ; preds = %if.then125.us, %for.body59.us
  ...
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %tmp_block.i) #22
  ...
  call void @get_block(i32 noundef %spec.select.us, ptr noundef %110, i32 noundef %add.i.us, i32 noundef %add15.i.us, ptr noundef %105, ptr noundef nonnull %tmp_block.i) #22
...
buildPredblockRegionYUV.exit.us:                  ; preds = %if.then.i.us, %if.end127.us
  ...
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %tmp_block.i) #22
...
for.end209:                                       ; preds = %for.cond55.for.inc207_crit_edge.us, %for.body.lr.ph, %if.end50
  call void @free(ptr noundef %storeYUV.0) #22
  br label %if.end210
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 72, ptr nonnull %concealment_fs) #22
...
if.then.i:                                        ; preds = %if.then
  ...
  call void @write_stored_frame(ptr noundef nonnull %concealment_fs, i32 noundef %p_out) #22
...
if.end3:                                          ; preds = %if.then, %delete_node.exit, %entry
  call void @llvm.lifetime.end.p0(i64 72, ptr nonnull %concealment_fs) #22
  ret void
}
...
if.then:                                          ; preds = %entry
  ...
  %call = tail call ptr @alloc_storable_picture(i32 noundef 0, i32 noundef %3, i32 noundef %4, i32 noundef %5, i32 noundef %6) #22
...
; Function Attrs: nounwind uwtable
define internal fastcc void @buildPredRegionYUV(ptr noundef %img, ptr nocapture noundef readonly %mv, i32 noundef %x, i32 noundef %y, ptr nocapture noundef writeonly %predMB) unnamed_addr #0 {
entry:
  %tmp_block = alloca [4 x [4 x i32]], align 16
  call void @llvm.lifetime.start.p0(i64 64, ptr nonnull %tmp_block) #22
...
for.body:                                         ; preds = %entry, %for.body
  ...
  call void @get_block(i32 noundef %cond.i, ptr noundef %14, i32 noundef %add20, i32 noundef %add24, ptr noundef nonnull %img, ptr noundef nonnull %tmp_block) #22
  ...
  call void @get_block(i32 noundef %cond.i, ptr noundef %26, i32 noundef %add20.1, i32 noundef %add24.1, ptr noundef nonnull %img, ptr noundef nonnull %tmp_block) #22
  ...
  call void @get_block(i32 noundef %cond.i, ptr noundef %38, i32 noundef %add20.2, i32 noundef %add24.2, ptr noundef nonnull %img, ptr noundef nonnull %tmp_block) #22
  ...
  %50 = load ptr, ptr @listX, align 16, !tbaa !12
  call void @get_block(i32 noundef %cond.i, ptr noundef %50, i32 noundef %add20.3, i32 noundef %add24.3, ptr noundef nonnull %img, ptr noundef nonnull %tmp_block) #22
...
if.end:                                           ; preds = %for.cond232.preheader.us.preheader, %for.cond86.preheader.preheader, %for.end71
  call void @llvm.lifetime.end.p0(i64 64, ptr nonnull %tmp_block) #22
  ret void
}

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: read) uwtable
define internal fastcc i32 @edgeDistortion(ptr nocapture noundef readonly %predBlocks, i32 noundef %currYBlockNum, ptr nocapture noundef readonly %predMB, ptr nocapture noundef readonly %recY, i32 noundef %picSizeX) unnamed_addr #17 {
entry:
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define internal fastcc void @copyPredMB(i32 noundef %currYBlockNum, ptr nocapture noundef readonly %predMB, i32 noundef %picSizeX) unnamed_addr #4 {
entry:
  %0 = load ptr, ptr @dec_picture, align 8, !tbaa !12
  %chroma_format_idc = getelementptr inbounds %struct.storable_picture, ptr %0, i64 0, i32 50
  %1 = load i32, ptr %chroma_format_idc, align 4, !tbaa !40
...
vector.memcheck:                                  ; preds = %for.body31
  ...
  %60 = add i64 %50, %59
  %uglygep5 = getelementptr i8, ptr %predMB, i64 %60
  %61 = add i64 %47, %59
  %uglygep4 = getelementptr i8, ptr %predMB, i64 %61
  %uglygep = getelementptr i8, ptr %57, i64 %39
  %uglygep1 = getelementptr i8, ptr %57, i64 %44
  %uglygep2 = getelementptr i8, ptr %58, i64 %39
  %uglygep3 = getelementptr i8, ptr %58, i64 %44
  %bound0 = icmp ult ptr %uglygep, %uglygep3
  %bound1 = icmp ult ptr %uglygep2, %uglygep1
  %found.conflict = and i1 %bound0, %bound1
  %bound06 = icmp ult ptr %uglygep, %uglygep5
  %bound17 = icmp ult ptr %uglygep4, %uglygep1
  %found.conflict8 = and i1 %bound06, %bound17
  %conflict.rdx = or i1 %found.conflict, %found.conflict8
  %bound09 = icmp ult ptr %uglygep2, %uglygep5
  %bound110 = icmp ult ptr %uglygep4, %uglygep3
...
attributes #17 = { nofree norecurse nosync nounwind memory(argmem: read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
