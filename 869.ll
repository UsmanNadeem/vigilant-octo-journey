; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/util.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Ptrdist/bc/util.c"
...
entry:
  ...
  %add = add i64 %call, 1
  %call1 = tail call noalias ptr @malloc(i64 noundef %add) #19
  %call2 = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %call1, ptr noundef nonnull dereferenceable(1) %str) #20
  ret ptr %call1
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 20, ptr nonnull %sval) #20
...
if.then:                                          ; preds = %entry
  ...
  %call9 = call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %sval, ptr noundef nonnull dereferenceable(1) %.str.41..str.42, i32 noundef %1) #20
  %call12 = call ptr @strcat(ptr noundef nonnull dereferenceable(1) %call, ptr noundef nonnull dereferenceable(1) %sval) #20
  br label %cleanup

if.else:                                          ; preds = %entry
  %conv = sext i32 %len to i64
  %call1 = tail call noalias ptr @malloc(i64 noundef %conv) #19
  store i8 0, ptr %call1, align 1, !tbaa !13
  br label %cleanup

cleanup:                                          ; preds = %if.then, %if.else
  %retval.0 = phi ptr [ %call, %if.then ], [ %call1, %if.else ]
  call void @llvm.lifetime.end.p0(i64 20, ptr nonnull %sval) #20
  ret ptr %retval.0
}
...
while.body:                                       ; preds = %entry, %while.body
  ...
  %0 = load ptr, ptr %next, align 8, !tbaa !11
  tail call void @free(ptr noundef nonnull %temp.05) #20
  %cmp.not = icmp eq ptr %0, null
...
if.end:                                           ; preds = %entry, %if.else
  ...
  %call = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %4, ptr noundef nonnull @.str.37, ptr noundef %name.0, i32 noundef %5) #21
  %6 = load ptr, ptr @stderr, align 8, !tbaa !12
  %call2 = call i32 @vfprintf(ptr noundef %6, ptr noundef %str, ptr noundef nonnull %args) #21
...
if.end:                                           ; preds = %if.then, %if.else
  ...
  %call = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %5, ptr noundef nonnull @.str.37, ptr noundef %name.0, i32 noundef %6) #21
  %7 = load ptr, ptr @stderr, align 8, !tbaa !12
  %call4 = call i32 @vfprintf(ptr noundef %7, ptr noundef %mesg, ptr noundef nonnull %args) #21
...
if.end15:                                         ; preds = %if.then8, %if.else11
  ...
  %call16 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %14, ptr noundef nonnull @.str.38, ptr noundef %name.1, i32 noundef %15) #21
  %16 = load ptr, ptr @stderr, align 8, !tbaa !12
  %call18 = call i32 @vfprintf(ptr noundef %16, ptr noundef %mesg, ptr noundef nonnull %args) #21
...
if.then:                                          ; preds = %entry
  ...
  %call1 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %str) #18
...
if.else:                                          ; preds = %entry
  tail call void @load_code(ptr noundef %str) #20
  br label %if.end6
...
if.then4:                                         ; preds = %if.else
  ...
  %call.i11 = tail call i32 @_IO_putc(i32 noundef 92, ptr noundef %1)
  %2 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call.i12 = tail call i32 @_IO_putc(i32 noundef 10, ptr noundef %2)
...
if.end9:                                          ; preds = %if.end9.sink.split, %if.else
  ...
  %3 = load ptr, ptr @stdout, align 8, !tbaa !12
  %call.i13 = tail call i32 @_IO_putc(i32 noundef %conv.sink, ptr noundef %3)
  ret void
}

; Function Attrs: nofree nounwind memory(read, inaccessiblemem: none) uwtable
define dso_local ptr @find_id(ptr noundef readonly %tree, ptr noundef readonly %id) local_unnamed_addr #11 {
entry:
  %cmp172 = icmp eq ptr %tree, null
  br i1 %cmp172, label %cleanup, label %if.end

if.end:                                           ; preds = %entry, %if.else
  %tree.tr173 = phi ptr [ %tree.tr.be, %if.else ], [ %tree, %entry ]
  %0 = load ptr, ptr %tree.tr173, align 8, !tbaa !23
  %call149 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %id, ptr noundef nonnull dereferenceable(1) %0) #20
  %cmp156 = icmp eq i32 %call149, 0
  br i1 %cmp156, label %cleanup, label %if.else

if.else:                                          ; preds = %if.end
  %cmp159 = icmp slt i32 %call149, 0
  %left = getelementptr inbounds %struct.id_rec, ptr %tree.tr173, i64 0, i32 5
  %right = getelementptr inbounds %struct.id_rec, ptr %tree.tr173, i64 0, i32 6
  %tree.tr.be.in = select i1 %cmp159, ptr %left, ptr %right
...
cleanup:                                          ; preds = %if.else, %if.end, %entry
  %retval.0 = phi ptr [ null, %entry ], [ %tree.tr173, %if.end ], [ null, %if.else ]
  ret ptr %retval.0
}
...
define dso_local i32 @insert_id_rec(ptr nocapture noundef %root, ptr noundef %new_id) local_unnamed_addr #12 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %call165 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(1) %2) #20
  %cmp172 = icmp slt i32 %call165, 0
  br i1 %cmp172, label %if.then174, label %if.else216

if.then174:                                       ; preds = %if.end
  %left175 = getelementptr inbounds %struct.id_rec, ptr %0, i64 0, i32 5
  %call176 = tail call i32 @insert_id_rec(ptr noundef nonnull %left175, ptr noundef nonnull %new_id)
  %tobool.not = icmp eq i32 %call176, 0
  br i1 %tobool.not, label %cleanup, label %if.then177

if.then177:                                       ; preds = %if.then174
  %3 = load ptr, ptr %root, align 8, !tbaa !12
  %balance178 = getelementptr inbounds %struct.id_rec, ptr %3, i64 0, i32 4
  %4 = load i16, ptr %balance178, align 4, !tbaa !26
  %dec = add i16 %4, -1
  store i16 %dec, ptr %balance178, align 4, !tbaa !26
  %cond = icmp eq i16 %dec, -2
  br i1 %cond, label %sw.bb182, label %cleanup

sw.bb182:                                         ; preds = %if.then177
  %left183 = getelementptr inbounds %struct.id_rec, ptr %3, i64 0, i32 5
  %5 = load ptr, ptr %left183, align 8, !tbaa !27
  %balance184 = getelementptr inbounds %struct.id_rec, ptr %5, i64 0, i32 4
  %6 = load i16, ptr %balance184, align 4, !tbaa !26
  %cmp186 = icmp slt i16 %6, 1
  %right189 = getelementptr inbounds %struct.id_rec, ptr %5, i64 0, i32 6
  %7 = load ptr, ptr %right189, align 8, !tbaa !28
  br i1 %cmp186, label %if.then188, label %if.else

if.then188:                                       ; preds = %sw.bb182
  store ptr %7, ptr %left183, align 8, !tbaa !27
  store ptr %3, ptr %right189, align 8, !tbaa !28
  store ptr %5, ptr %root, align 8, !tbaa !12
  store i16 0, ptr %balance178, align 4, !tbaa !26
  store i16 0, ptr %balance184, align 4, !tbaa !26
  br label %cleanup

if.else:                                          ; preds = %sw.bb182
  store ptr %7, ptr %root, align 8, !tbaa !12
  %left195 = getelementptr inbounds %struct.id_rec, ptr %7, i64 0, i32 5
  %8 = load ptr, ptr %left195, align 8, !tbaa !27
  store ptr %8, ptr %right189, align 8, !tbaa !28
  %9 = load ptr, ptr %root, align 8, !tbaa !12
  %right197 = getelementptr inbounds %struct.id_rec, ptr %9, i64 0, i32 6
  %10 = load ptr, ptr %right197, align 8, !tbaa !28
  store ptr %10, ptr %left183, align 8, !tbaa !27
  %11 = load ptr, ptr %root, align 8, !tbaa !12
  %left199 = getelementptr inbounds %struct.id_rec, ptr %11, i64 0, i32 5
  store ptr %5, ptr %left199, align 8, !tbaa !27
  %12 = load ptr, ptr %root, align 8, !tbaa !12
  %right200 = getelementptr inbounds %struct.id_rec, ptr %12, i64 0, i32 6
  store ptr %3, ptr %right200, align 8, !tbaa !28
  %13 = load ptr, ptr %root, align 8, !tbaa !12
  %balance201 = getelementptr inbounds %struct.id_rec, ptr %13, i64 0, i32 4
  %14 = load i16, ptr %balance201, align 4, !tbaa !26
  %conv202 = sext i16 %14 to i32
  %switch.tableidx = add nsw i32 %conv202, 1
...
switch.lookup:                                    ; preds = %if.else
  ...
  %switch.cast338 = zext i32 %switch.tableidx to i48
  %switch.shiftamt339 = shl nuw nsw i48 %switch.cast338, 4
  %switch.downshift340 = lshr i48 -4294967296, %switch.shiftamt339
  %switch.masked341 = trunc i48 %switch.downshift340 to i16
  store i16 %switch.masked, ptr %balance178, align 4, !tbaa !26
  store i16 %switch.masked341, ptr %balance184, align 4, !tbaa !26
  br label %sw.epilog

sw.epilog:                                        ; preds = %if.else, %switch.lookup
  store i16 0, ptr %balance201, align 4, !tbaa !26
  br label %cleanup

if.else216:                                       ; preds = %if.end
  %right217 = getelementptr inbounds %struct.id_rec, ptr %0, i64 0, i32 6
  %call218 = tail call i32 @insert_id_rec(ptr noundef nonnull %right217, ptr noundef nonnull %new_id)
...
if.then220:                                       ; preds = %if.else216
  ...
  %balance221 = getelementptr inbounds %struct.id_rec, ptr %16, i64 0, i32 4
  %17 = load i16, ptr %balance221, align 4, !tbaa !26
  %inc = add i16 %17, 1
  store i16 %inc, ptr %balance221, align 4, !tbaa !26
  %cond334 = icmp eq i16 %inc, 2
  br i1 %cond334, label %sw.bb226, label %cleanup

sw.bb226:                                         ; preds = %if.then220
  %right227 = getelementptr inbounds %struct.id_rec, ptr %16, i64 0, i32 6
  %18 = load ptr, ptr %right227, align 8, !tbaa !28
  %balance228 = getelementptr inbounds %struct.id_rec, ptr %18, i64 0, i32 4
  %19 = load i16, ptr %balance228, align 4, !tbaa !26
  %cmp230 = icmp sgt i16 %19, -1
  %left233 = getelementptr inbounds %struct.id_rec, ptr %18, i64 0, i32 5
  %20 = load ptr, ptr %left233, align 8, !tbaa !27
  br i1 %cmp230, label %if.then232, label %if.else238

if.then232:                                       ; preds = %sw.bb226
  store ptr %20, ptr %right227, align 8, !tbaa !28
  store ptr %16, ptr %left233, align 8, !tbaa !27
  store ptr %18, ptr %root, align 8, !tbaa !12
  store i16 0, ptr %balance221, align 4, !tbaa !26
  store i16 0, ptr %balance228, align 4, !tbaa !26
  br label %cleanup

if.else238:                                       ; preds = %sw.bb226
  store ptr %20, ptr %root, align 8, !tbaa !12
  %right240 = getelementptr inbounds %struct.id_rec, ptr %20, i64 0, i32 6
  %21 = load ptr, ptr %right240, align 8, !tbaa !28
  store ptr %21, ptr %left233, align 8, !tbaa !27
  %22 = load ptr, ptr %root, align 8, !tbaa !12
  %left242 = getelementptr inbounds %struct.id_rec, ptr %22, i64 0, i32 5
  %23 = load ptr, ptr %left242, align 8, !tbaa !27
  store ptr %23, ptr %right227, align 8, !tbaa !28
  %24 = load ptr, ptr %root, align 8, !tbaa !12
  %left244 = getelementptr inbounds %struct.id_rec, ptr %24, i64 0, i32 5
  store ptr %16, ptr %left244, align 8, !tbaa !27
  %25 = load ptr, ptr %root, align 8, !tbaa !12
  %right245 = getelementptr inbounds %struct.id_rec, ptr %25, i64 0, i32 6
  store ptr %18, ptr %right245, align 8, !tbaa !28
  %26 = load ptr, ptr %root, align 8, !tbaa !12
  %balance246 = getelementptr inbounds %struct.id_rec, ptr %26, i64 0, i32 4
  %27 = load i16, ptr %balance246, align 4, !tbaa !26
  %conv247 = sext i16 %27 to i32
  %switch.tableidx343 = add nsw i32 %conv247, 1
  %28 = icmp ult i32 %switch.tableidx343, 3
  br i1 %28, label %switch.lookup342, label %sw.epilog257

switch.lookup342:                                 ; preds = %if.else238
  %switch.cast344 = zext i32 %switch.tableidx343 to i48
  %switch.shiftamt345 = shl nuw nsw i48 %switch.cast344, 4
  %switch.downshift346 = lshr i48 -4294967296, %switch.shiftamt345
  %switch.masked347 = trunc i48 %switch.downshift346 to i16
  %switch.cast348 = zext i32 %switch.tableidx343 to i48
  %switch.shiftamt349 = shl nuw nsw i48 %switch.cast348, 4
  %switch.downshift350 = lshr i48 1, %switch.shiftamt349
  %switch.masked351 = trunc i48 %switch.downshift350 to i16
  store i16 %switch.masked347, ptr %balance221, align 4, !tbaa !26
  store i16 %switch.masked351, ptr %balance228, align 4, !tbaa !26
  br label %sw.epilog257

sw.epilog257:                                     ; preds = %if.else238, %switch.lookup342
  store i16 0, ptr %balance246, align 4, !tbaa !26
  br label %cleanup

cleanup:                                          ; preds = %if.then220, %if.then177, %sw.epilog, %if.then188, %if.then174, %sw.epilog257, %if.then232, %if.else216, %if.then
  %retval.0 = phi i32 [ 1, %if.then ], [ 0, %if.else216 ], [ 0, %if.then232 ], [ 0, %sw.epilog257 ], [ 0, %if.then220 ], [ 0, %if.then174 ], [ 0, %if.then188 ], [ 0, %sw.epilog ], [ 0, %if.then177 ]
  ret i32 %retval.0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(write, argmem: none, inaccessiblemem: none) uwtable
define dso_local void @init_tree() local_unnamed_addr #13 {
entry:
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %cmp172.i = icmp eq ptr %0, null
  br i1 %cmp172.i, label %if.then3, label %if.end.i

if.end.i:                                         ; preds = %if.end, %if.else.i
  %tree.tr173.i = phi ptr [ %tree.tr.be.i, %if.else.i ], [ %0, %if.end ]
  %1 = load ptr, ptr %tree.tr173.i, align 8, !tbaa !23
  %call149.i = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %name, ptr noundef nonnull dereferenceable(1) %1) #20
  %cmp156.i = icmp eq i32 %call149.i, 0
  br i1 %cmp156.i, label %if.end8, label %if.else.i

if.else.i:                                        ; preds = %if.end.i
  %cmp159.i = icmp slt i32 %call149.i, 0
  %left.i = getelementptr inbounds %struct.id_rec, ptr %tree.tr173.i, i64 0, i32 5
  %right.i = getelementptr inbounds %struct.id_rec, ptr %tree.tr173.i, i64 0, i32 6
  %tree.tr.be.in.i = select i1 %cmp159.i, ptr %left.i, ptr %right.i
...
if.then3:                                         ; preds = %if.else.i, %if.end
  %call4 = tail call noalias dereferenceable_or_null(40) ptr @malloc(i64 noundef 40) #19
  %call.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %name) #18
  %add.i = add i64 %call.i, 1
  %call1.i = tail call noalias ptr @malloc(i64 noundef %add.i) #19
  %call2.i = tail call ptr @strcpy(ptr noundef nonnull dereferenceable(1) %call1.i, ptr noundef nonnull dereferenceable(1) %name) #20
  store ptr %call1.i, ptr %call4, align 8, !tbaa !23
  %a_name = getelementptr inbounds %struct.id_rec, ptr %call4, i64 0, i32 1
  store i32 0, ptr %a_name, align 8, !tbaa !29
  %f_name = getelementptr inbounds %struct.id_rec, ptr %call4, i64 0, i32 2
  store i32 0, ptr %f_name, align 4, !tbaa !30
  %v_name = getelementptr inbounds %struct.id_rec, ptr %call4, i64 0, i32 3
  store i32 0, ptr %v_name, align 8, !tbaa !31
  %call7 = tail call i32 @insert_id_rec(ptr noundef nonnull @name_tree, ptr noundef nonnull %call4)
  br label %if.end8

if.end8:                                          ; preds = %if.end.i, %if.then3
  %id.0 = phi ptr [ %call4, %if.then3 ], [ %tree.tr173.i, %if.end.i ]
...
sw.bb:                                            ; preds = %if.end8
  ...
  %2 = load i32, ptr %a_name9, align 8, !tbaa !29
  %cmp10.not = icmp eq i32 %2, 0
  br i1 %cmp10.not, label %if.end13, label %if.then11

if.then11:                                        ; preds = %sw.bb
  tail call void @free(ptr noundef %name) #20
  %3 = load i32, ptr %a_name9, align 8, !tbaa !29
  %sub = sub nsw i32 0, %3
  br label %cleanup
...
if.end13:                                         ; preds = %sw.bb
  ...
  store i32 %4, ptr %a_name9, align 8, !tbaa !29
...
if.then21:                                        ; preds = %if.then18
  tail call void @more_arrays() #20
  %.pre109 = load i32, ptr %a_name9, align 8, !tbaa !29
  br label %if.end22

if.end22:                                         ; preds = %if.then21, %if.then18
  %7 = phi i32 [ %.pre109, %if.then21 ], [ %4, %if.then18 ]
...
if.end31:                                         ; preds = %sw.bb26
  ...
  store i32 %10, ptr %f_name27, align 4, !tbaa !30
...
if.then42:                                        ; preds = %if.then39
  tail call void @more_functions() #20
  %.pre108 = load i32, ptr %f_name27, align 4, !tbaa !30
  br label %cleanup
...
if.end51:                                         ; preds = %sw.bb46
  ...
  store i32 %15, ptr %v_name47, align 8, !tbaa !31
...
if.then63:                                        ; preds = %if.then60
  tail call void @more_variables() #20
  %.pre = load i32, ptr %v_name47, align 8, !tbaa !31
  br label %cleanup
...
cleanup:                                          ; preds = %if.then60, %if.then63, %if.then39, %if.then42, %if.end8, %if.then49, %if.then29, %if.end22, %if.then11
  %retval.0 = phi i32 [ %14, %if.then49 ], [ %9, %if.then29 ], [ %sub, %if.then11 ], [ %sub24, %if.end22 ], [ undef, %if.end8 ], [ %.pre108, %if.then42 ], [ %10, %if.then39 ], [ %.pre, %if.then63 ], [ %15, %if.then60 ]
  ret i32 %retval.0
}
...
entry:
  ...
  call void @llvm.lifetime.start.p0(i64 24, ptr nonnull %args) #20
  call void @llvm.lifetime.start.p0(i64 255, ptr nonnull %error_mesg) #20
  call void @llvm.va_start(ptr nonnull %args)
  %call = call i32 @vsprintf(ptr noundef nonnull %error_mesg, ptr noundef %mesg, ptr noundef nonnull %args) #20
  call void @llvm.va_end(ptr nonnull %args)
  %0 = load ptr, ptr @stderr, align 8, !tbaa !12
  %1 = load ptr, ptr @f_names, align 8, !tbaa !12
  %2 = load i32, ptr @pc, align 4, !tbaa !32
  %idxprom = sext i32 %2 to i64
  %arrayidx = getelementptr inbounds ptr, ptr %1, i64 %idxprom
  %3 = load ptr, ptr %arrayidx, align 8, !tbaa !12
  %4 = load i32, ptr getelementptr inbounds (%struct.program_counter, ptr @pc, i64 0, i32 1), align 4, !tbaa !34
  %call5 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.39, ptr noundef %3, i32 noundef %4, ptr noundef nonnull %error_mesg) #21
  store i8 1, ptr @runtime_error, align 1, !tbaa !13
  call void @llvm.lifetime.end.p0(i64 255, ptr nonnull %error_mesg) #20
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %args) #20
  ret void
}
...
entry:
  ...
  %3 = load ptr, ptr %arrayidx, align 8, !tbaa !12
  %4 = load i32, ptr getelementptr inbounds (%struct.program_counter, ptr @pc, i64 0, i32 1), align 4, !tbaa !34
  %call5 = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %0, ptr noundef nonnull @.str.40, ptr noundef %3, i32 noundef %4, ptr noundef nonnull %error_mesg) #21
  call void @llvm.lifetime.end.p0(i64 255, ptr nonnull %error_mesg) #20
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %args) #20
  ret void
}
...
; Function Attrs: nofree nounwind
declare noundef i32 @_IO_putc(i32 noundef, ptr nocapture noundef) local_unnamed_addr #9
