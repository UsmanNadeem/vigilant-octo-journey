; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/XzHandler.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/CPP/7zip/Archive/XzHandler.cpp"
...
; Function Attrs: uwtable
define internal fastcc void @_ZN8NArchive3NXzL14GetCheckStringERK4CXzs(ptr noalias align 8 %agg.result, i64 %xzs.0.val, ptr %xzs.16.val) unnamed_addr #0 personality ptr @__gxx_personality_v0 {
entry:
  %temp.i = alloca [32 x i8], align 16
...
invoke.cont124:                                   ; preds = %if.end113
  ...
  %32 = load i64, ptr %outLen, align 8, !tbaa !155
  ...
  %cmp131 = icmp eq i64 %31, 0
  %cmp133 = icmp eq i64 %32, 0
  %or.cond274 = select i1 %cmp131, i1 %cmp133, i1 false
...
if.then138:                                       ; preds = %invoke.cont124
  ...
  %or.cond275 = select i1 %tobool142, i1 %cmp144, i1 false
...
ehcleanup196:                                     ; preds = %lpad139, %lpad147, %lpad185, %lpad123
  %.pn321.pn = phi { ptr, i32 } [ %37, %lpad123 ], [ %38, %lpad139 ], [ %44, %lpad185 ], [ %39, %lpad147 ]
  call void @llvm.lifetime.end.p0(i64 4, ptr nonnull %status) #20
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %outLen) #20
  call void @llvm.lifetime.end.p0(i64 8, ptr nonnull %inLen) #20
  br label %ehcleanup227
...
if.then.i341:                                     ; preds = %invoke.cont2.i
  ...
  %54 = load ptr, ptr %vfn.i340, align 8
...
ehcleanup227:                                     ; preds = %lpad207, %lpad214, %ehcleanup196, %lpad99, %lpad77
  %.pn.pn = phi { ptr, i32 } [ %.pn321.pn, %ehcleanup196 ], [ %27, %lpad99 ], [ %22, %lpad77 ], [ %45, %lpad207 ], [ %49, %lpad214 ]
...
if.then.i347:                                     ; preds = %lpad69, %ehcleanup243
  ...
  %57 = load ptr, ptr %vfn.i345, align 8
  %call.i346 = invoke noundef i32 %57(ptr noundef nonnull align 8 dereferenceable(8) %call64)
...
if.then.i354:                                     ; preds = %cleanup250
  ...
  %60 = load ptr, ptr %vfn.i352, align 8
  %call.i353 = invoke noundef i32 %60(ptr noundef nonnull align 8 dereferenceable(8) %.pr)
...
if.then.i360:                                     ; preds = %ehcleanup251
  %vtable.i357 = load ptr, ptr %63, align 8, !tbaa !5
  %vfn.i358 = getelementptr inbounds ptr, ptr %vtable.i357, i64 2
  %64 = load ptr, ptr %vfn.i358, align 8
  %call.i359 = invoke noundef i32 %64(ptr noundef nonnull align 8 dereferenceable(8) %63)
...
ehcleanup257:                                     ; preds = %_ZN9CMyComPtrI20ISequentialOutStreamED2Ev.exit362, %lpad9
  ...
  %67 = call i32 @llvm.eh.typeid.for(ptr nonnull @_ZTIPKc) #20
  %matches = icmp eq i32 %ehselector.slot.10, %67
  %68 = call ptr @__cxa_begin_catch(ptr %exn.slot.10) #20
