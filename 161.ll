...
$_ZNSt3__17__sort4B7v170000INS_17_ClassicAlgPolicyERNS_6__lessINS_4pairIPKciEES6_EEPS6_EEvT1_SA_SA_SA_T0_ = comdat any

$_ZNSt3__17__sort5B7v170000INS_17_ClassicAlgPolicyERNS_6__lessINS_4pairIPKciEES6_EEPS6_EEvT1_SA_SA_SA_SA_T0_ = comdat any
...
while.cond.outer:                                 ; preds = %if.then60, %entry
  ...
  %__leftmost.addr.0.ph = phi i8 [ %__leftmost.addr.0.ph328, %if.then60 ], [ %frombool, %entry ]
  ...
  br label %while.cond.outer326

while.cond.outer326:                              ; preds = %while.cond.outer, %if.end70
  %__first.addr.0.ph327 = phi ptr [ %__first.addr.0.ph, %while.cond.outer ], [ %incdec.ptr72, %if.end70 ]
  %__leftmost.addr.0.ph328 = phi i8 [ %__leftmost.addr.0.ph, %while.cond.outer ], [ 0, %if.end70 ]
  %__depth.addr.0.ph329 = phi i64 [ %__depth.addr.0.ph, %while.cond.outer ], [ %dec, %if.end70 ]
  %tobool46 = icmp ne i8 %__leftmost.addr.0.ph328, 0
  br label %while.cond

while.cond:                                       ; preds = %while.cond.backedge, %while.cond.outer326
  %__first.addr.0 = phi ptr [ %__first.addr.0.ph327, %while.cond.outer326 ], [ %__first.addr.0.be, %while.cond.backedge ]
  %__depth.addr.0 = phi i64 [ %__depth.addr.0.ph329, %while.cond.outer326 ], [ %dec, %while.cond.backedge ]
...
cond.true.i.i.if.then_crit_edge:                  ; preds = %cond.true.i.i
  ...
  %.pre256 = load ptr, ptr %incdec.ptr, align 8, !tbaa !13
  br label %if.then
...
if.then:                                          ; preds = %cond.true.i.i.if.then_crit_edge, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit
  %4 = phi ptr [ %.pre256, %cond.true.i.i.if.then_crit_edge ], [ %2, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit ]
...
sw.bb4:                                           ; preds = %while.cond
  ...
  tail call void @_ZNSt3__17__sort4B7v170000INS_17_ClassicAlgPolicyERNS_6__lessINS_4pairIPKciEES6_EEPS6_EEvT1_SA_SA_SA_T0_(ptr noundef %__first.addr.0, ptr noundef nonnull %add.ptr5, ptr noundef nonnull %add.ptr6, ptr noundef nonnull %incdec.ptr7, ptr noundef nonnull align 1 dereferenceable(1) %__comp)
  br label %cleanup78
...
if.then13:                                        ; preds = %sw.epilog
  %tobool.not = icmp eq i8 %__leftmost.addr.0.ph328, 0
  %cmp.i119 = icmp eq ptr %__first.addr.0, %__last.addr.0.ph
  ...
  %or.cond.i120 = select i1 %cmp.i119, i1 true, i1 %cmp1.not36.i
  br i1 %tobool.not, label %if.else, label %if.then14

if.then14:                                        ; preds = %if.then13
  br i1 %or.cond.i120, label %cleanup78, label %for.body.i
...
if.else:                                          ; preds = %if.then13
  br i1 %or.cond.i120, label %cleanup78, label %for.body.i124

for.body.i124:                                    ; preds = %if.else, %if.end9.i
  %storemerge38.i = phi ptr [ %storemerge.i138, %if.end9.i ], [ %storemerge35.i, %if.else ]
  %__first.pn37.i = phi ptr [ %storemerge38.i, %if.end9.i ], [ %__first.addr.0, %if.else ]
  %second.i.i.i121 = getelementptr inbounds %"struct.std::__1::pair.4", ptr %__first.pn37.i, i64 1, i32 1
  %14 = load i32, ptr %second.i.i.i121, align 8, !tbaa !43
  %second1.i.i.i122 = getelementptr inbounds %"struct.std::__1::pair.4", ptr %__first.pn37.i, i64 0, i32 1
  %15 = load i32, ptr %second1.i.i.i122, align 8, !tbaa !43
  %cmp.not.i.i.i123 = icmp eq i32 %14, %15
  br i1 %cmp.not.i.i.i123, label %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit.i131, label %cond.true.i.i.i126

cond.true.i.i.i126:                               ; preds = %for.body.i124
  %cmp4.i.i.i125 = icmp sgt i32 %14, %15
  br i1 %cmp4.i.i.i125, label %cond.true.i.i.if.then3_crit_edge.i128, label %if.end9.i

cond.true.i.i.if.then3_crit_edge.i128:            ; preds = %cond.true.i.i.i126
  %__t.sroa.0.0.copyload.pre.i127 = load ptr, ptr %storemerge38.i, align 8, !tbaa.struct !58
  br label %if.then3.i133

_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit.i131: ; preds = %for.body.i124
  %16 = load ptr, ptr %storemerge38.i, align 8, !tbaa !45
  %17 = load ptr, ptr %__first.pn37.i, align 8, !tbaa !45
  %call.i.i.i129 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %16, ptr noundef nonnull dereferenceable(1) %17) #25
  %cmp6.i.i.i130 = icmp sgt i32 %call.i.i.i129, 0
  br i1 %cmp6.i.i.i130, label %if.then3.i133, label %if.end9.i

if.then3.i133:                                    ; preds = %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit.i131, %cond.true.i.i.if.then3_crit_edge.i128
  %__t.sroa.0.0.copyload.i132 = phi ptr [ %__t.sroa.0.0.copyload.pre.i127, %cond.true.i.i.if.then3_crit_edge.i128 ], [ %16, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit.i131 ]
  br label %do.body.i

do.body.i:                                        ; preds = %do.body.i.backedge, %if.then3.i133
  %18 = phi i32 [ %15, %if.then3.i133 ], [ %20, %do.body.i.backedge ]
  %__k.0.i = phi ptr [ %__first.pn37.i, %if.then3.i133 ], [ %incdec.ptr.i, %do.body.i.backedge ]
  %__j.0.i = phi ptr [ %storemerge38.i, %if.then3.i133 ], [ %__k.0.i, %do.body.i.backedge ]
  %19 = load ptr, ptr %__k.0.i, align 8, !tbaa !13
  store ptr %19, ptr %__j.0.i, align 8, !tbaa !45
  %second3.i.i134 = getelementptr inbounds %"struct.std::__1::pair.4", ptr %__j.0.i, i64 0, i32 1
  store i32 %18, ptr %second3.i.i134, align 8, !tbaa !43
...
cond.true.i.i21.i:                                ; preds = %do.body.i
  ...
  br i1 %cmp4.i.i20.i, label %do.body.i.backedge, label %do.end.i137
...
_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit26.i: ; preds = %do.body.i
  ...
  %call.i.i22.i = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %__t.sroa.0.0.copyload.i132, ptr noundef nonnull dereferenceable(1) %21) #25
  %cmp6.i.i23.i = icmp sgt i32 %call.i.i22.i, 0
  br i1 %cmp6.i.i23.i, label %do.body.i.backedge, label %do.end.i137
...
do.end.i137:                                      ; preds = %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit26.i, %cond.true.i.i21.i
  %second.i.le.i136 = getelementptr inbounds %"struct.std::__1::pair.4", ptr %__k.0.i, i64 0, i32 1
  store ptr %__t.sroa.0.0.copyload.i132, ptr %__k.0.i, align 8, !tbaa !45
  store i32 %14, ptr %second.i.le.i136, align 8, !tbaa !43
  br label %if.end9.i

if.end9.i:                                        ; preds = %do.end.i137, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit.i131, %cond.true.i.i.i126
  %storemerge.i138 = getelementptr inbounds %"struct.std::__1::pair.4", ptr %storemerge38.i, i64 1
  %cmp1.not.i139 = icmp eq ptr %storemerge.i138, %__last.addr.0.ph
  br i1 %cmp1.not.i139, label %cleanup78, label %for.body.i124, !llvm.loop !62
...
if.then18:                                        ; preds = %if.end16
  %cmp.i140 = icmp eq ptr %__first.addr.0, %__last.addr.0.ph
  br i1 %cmp.i140, label %cleanup78, label %if.then.i.i
...
if.then22:                                        ; preds = %if.end20
  ...
  %second.i.i.i.i141 = getelementptr inbounds %"struct.std::__1::pair.4", ptr %__first.addr.0, i64 0, i32 1
  %second3.i.i.i.i142 = getelementptr inbounds %"struct.std::__1::pair.4", ptr %__first.addr.0, i64 %div118, i32 1
  %24 = load i32, ptr %second.i.i.i.i141, align 8, !tbaa !16
  %25 = load i32, ptr %second3.i.i.i.i142, align 8, !tbaa !16
  store i32 %25, ptr %second.i.i.i.i141, align 8, !tbaa !16
  store i32 %24, ptr %second3.i.i.i.i142, align 8, !tbaa !16
  br label %if.end45
...
land.lhs.true:                                    ; preds = %if.end45
  %second.i.i143 = getelementptr %"struct.std::__1::pair.4", ptr %__first.addr.0, i64 -1, i32 1
  %26 = load i32, ptr %second.i.i143, align 8, !tbaa !43
  %second1.i.i144 = getelementptr inbounds %"struct.std::__1::pair.4", ptr %__first.addr.0, i64 0, i32 1
  %27 = load i32, ptr %second1.i.i144, align 8, !tbaa !43
  %cmp.not.i.i145 = icmp eq i32 %26, %27
  br i1 %cmp.not.i.i145, label %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit152, label %cond.true.i.i147

cond.true.i.i147:                                 ; preds = %land.lhs.true
  %cmp4.i.i146 = icmp sgt i32 %26, %27
  br i1 %cmp4.i.i146, label %if.end51, label %if.then49

_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit152: ; preds = %land.lhs.true
  ...
  %call.i.i148 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %28, ptr noundef nonnull dereferenceable(1) %29) #25
  %cmp6.i.i149 = icmp sgt i32 %call.i.i148, 0
  br i1 %cmp6.i.i149, label %if.end51, label %if.then49

if.then49:                                        ; preds = %cond.true.i.i147, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit152
...
if.end51:                                         ; preds = %cond.true.i.i147, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit152, %if.end45
...
cond.true.i.i.if.then_crit_edge:                  ; preds = %cond.true.i.i
  ...
  %.pre104 = load ptr, ptr %incdec.ptr, align 8, !tbaa !13
  br label %if.then
...
if.then:                                          ; preds = %cond.true.i.i.if.then_crit_edge, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit
  %4 = phi ptr [ %.pre104, %cond.true.i.i.if.then_crit_edge ], [ %2, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit ]
  %5 = phi ptr [ %.pre, %cond.true.i.i.if.then_crit_edge ], [ %3, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit ]
...
sw.bb4:                                           ; preds = %entry
  ...
  tail call void @_ZNSt3__17__sort4B7v170000INS_17_ClassicAlgPolicyERNS_6__lessINS_4pairIPKciEES6_EEPS6_EEvT1_SA_SA_SA_T0_(ptr noundef %__first, ptr noundef nonnull %add.ptr5, ptr noundef nonnull %add.ptr6, ptr noundef nonnull %incdec.ptr7, ptr noundef nonnull align 1 dereferenceable(1) %__comp)
  br label %return
...
sw.epilog:                                        ; preds = %entry
  ...
  %call.i53 = tail call noundef i32 @_ZNSt3__17__sort3B7v170000INS_17_ClassicAlgPolicyERNS_6__lessINS_4pairIPKciEES6_EEPS6_EEjT1_SA_SA_T0_(ptr noundef %__first, ptr noundef nonnull %add.ptr14, ptr noundef nonnull %add.ptr13, ptr noundef nonnull align 1 dereferenceable(1) %__comp)
...
for.body:                                         ; preds = %sw.epilog, %if.end31
  ...
  %second.i.i54 = getelementptr inbounds %"struct.std::__1::pair.4", ptr %storemerge100, i64 0, i32 1
  %6 = load i32, ptr %second.i.i54, align 8, !tbaa !43
  %second1.i.i55 = getelementptr inbounds %"struct.std::__1::pair.4", ptr %__j.0101, i64 0, i32 1
  %7 = load i32, ptr %second1.i.i55, align 8, !tbaa !43
  %cmp.not.i.i56 = icmp eq i32 %6, %7
  br i1 %cmp.not.i.i56, label %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit63, label %cond.true.i.i58

cond.true.i.i58:                                  ; preds = %for.body
  %cmp4.i.i57 = icmp sgt i32 %6, %7
  br i1 %cmp4.i.i57, label %cond.true.i.i58.if.then17_crit_edge, label %if.end31

cond.true.i.i58.if.then17_crit_edge:              ; preds = %cond.true.i.i58
  %__t.sroa.0.0.copyload.pre = load ptr, ptr %storemerge100, align 8, !tbaa.struct !58
  %.pre106 = load ptr, ptr %__j.0101, align 8, !tbaa !13
  br label %if.then17

_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit63: ; preds = %for.body
  %8 = load ptr, ptr %storemerge100, align 8, !tbaa !45
  %9 = load ptr, ptr %__j.0101, align 8, !tbaa !45
  %call.i.i59 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %8, ptr noundef nonnull dereferenceable(1) %9) #25
  %cmp6.i.i60 = icmp sgt i32 %call.i.i59, 0
  br i1 %cmp6.i.i60, label %if.then17, label %if.end31

if.then17:                                        ; preds = %cond.true.i.i58.if.then17_crit_edge, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit63
  %10 = phi ptr [ %.pre106, %cond.true.i.i58.if.then17_crit_edge ], [ %9, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit63 ]
  %__t.sroa.0.0.copyload = phi ptr [ %__t.sroa.0.0.copyload.pre, %cond.true.i.i58.if.then17_crit_edge ], [ %8, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit63 ]
  store ptr %10, ptr %storemerge100, align 8, !tbaa !45
  store i32 %7, ptr %second.i.i54, align 8, !tbaa !43
...
land.rhs:                                         ; preds = %if.then17, %do.body.backedge
  ...
  %incdec.ptr22 = getelementptr inbounds %"struct.std::__1::pair.4", ptr %__k.093, i64 -1
  %second1.i.i65 = getelementptr %"struct.std::__1::pair.4", ptr %__k.093, i64 -1, i32 1
  %11 = load i32, ptr %second1.i.i65, align 8, !tbaa !43
  %cmp.not.i.i66 = icmp eq i32 %6, %11
  br i1 %cmp.not.i.i66, label %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit73, label %cond.true.i.i68

cond.true.i.i68:                                  ; preds = %land.rhs
  %cmp4.i.i67 = icmp sgt i32 %6, %11
  br i1 %cmp4.i.i67, label %cond.true.i.i68.do.body.backedge_crit_edge, label %do.end

cond.true.i.i68.do.body.backedge_crit_edge:       ; preds = %cond.true.i.i68
  %.pre107 = load ptr, ptr %incdec.ptr22, align 8, !tbaa !13
  br label %do.body.backedge

_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit73: ; preds = %land.rhs
  %12 = load ptr, ptr %incdec.ptr22, align 8, !tbaa !45
  %call.i.i69 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %__t.sroa.0.0.copyload, ptr noundef nonnull dereferenceable(1) %12) #25
  %cmp6.i.i70 = icmp sgt i32 %call.i.i69, 0
  br i1 %cmp6.i.i70, label %do.body.backedge, label %do.end

do.body.backedge:                                 ; preds = %cond.true.i.i68.do.body.backedge_crit_edge, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit73
  %13 = phi ptr [ %.pre107, %cond.true.i.i68.do.body.backedge_crit_edge ], [ %12, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit73 ]
  store ptr %13, ptr %__k.093, align 8, !tbaa !45
  %second3.i = getelementptr inbounds %"struct.std::__1::pair.4", ptr %__k.093, i64 0, i32 1
...
cleanup.thread:                                   ; preds = %do.end
  %incdec.ptr27 = getelementptr inbounds %"struct.std::__1::pair.4", ptr %storemerge100, i64 1
  %cmp28 = icmp eq ptr %incdec.ptr27, %__last
  br label %return

if.end31:                                         ; preds = %do.end, %cond.true.i.i58, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit63
  %__count.1 = phi i32 [ %__count.0102, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit63 ], [ %__count.0102, %cond.true.i.i58 ], [ %inc, %do.end ]
  %incdec.ptr32 = getelementptr inbounds %"struct.std::__1::pair.4", ptr %storemerge100, i64 1
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden void @_ZNSt3__17__sort4B7v170000INS_17_ClassicAlgPolicyERNS_6__lessINS_4pairIPKciEES6_EEPS6_EEvT1_SA_SA_SA_T0_(ptr noundef %__x1, ptr noundef %__x2, ptr noundef %__x3, ptr noundef %__x4, ptr noundef nonnull align 1 dereferenceable(1) %__c) local_unnamed_addr #0 comdat {
entry:
...
cond.true.i.i:                                    ; preds = %entry
  %cmp4.i.i = icmp sgt i32 %0, %1
  br i1 %cmp4.i.i, label %cond.true.i.i.if.then_crit_edge, label %if.end7

cond.true.i.i.if.then_crit_edge:                  ; preds = %cond.true.i.i
  %.pre = load ptr, ptr %__x3, align 8, !tbaa !13
  %.pre43 = load ptr, ptr %__x4, align 8, !tbaa !13
  br label %if.then
...
_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit: ; preds = %entry
  ...
  %call.i.i = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %2, ptr noundef nonnull dereferenceable(1) %3) #25
  %cmp6.i.i = icmp sgt i32 %call.i.i, 0
  br i1 %cmp6.i.i, label %if.then, label %if.end7

if.then:                                          ; preds = %cond.true.i.i.if.then_crit_edge, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit
  %4 = phi ptr [ %.pre43, %cond.true.i.i.if.then_crit_edge ], [ %2, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit ]
  %5 = phi ptr [ %.pre, %cond.true.i.i.if.then_crit_edge ], [ %3, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit ]
  ...
  %second1.i.i12 = getelementptr inbounds %"struct.std::__1::pair.4", ptr %__x2, i64 0, i32 1
  %7 = load i32, ptr %second1.i.i12, align 8, !tbaa !43
  %cmp.not.i.i13 = icmp eq i32 %6, %7
  br i1 %cmp.not.i.i13, label %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit20, label %cond.true.i.i15

cond.true.i.i15:                                  ; preds = %if.then
  %cmp4.i.i14 = icmp sgt i32 %6, %7
  br i1 %cmp4.i.i14, label %cond.true.i.i15.if.then3_crit_edge, label %if.end7

cond.true.i.i15.if.then3_crit_edge:               ; preds = %cond.true.i.i15
  %.pre44 = load ptr, ptr %__x2, align 8, !tbaa !13
  %.pre45 = load ptr, ptr %__x3, align 8, !tbaa !13
  br label %if.then3

_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit20: ; preds = %if.then
  %8 = load ptr, ptr %__x3, align 8, !tbaa !45
  %9 = load ptr, ptr %__x2, align 8, !tbaa !45
  %call.i.i16 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %8, ptr noundef nonnull dereferenceable(1) %9) #25
  %cmp6.i.i17 = icmp sgt i32 %call.i.i16, 0
  br i1 %cmp6.i.i17, label %if.then3, label %if.end7

if.then3:                                         ; preds = %cond.true.i.i15.if.then3_crit_edge, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit20
  %10 = phi ptr [ %.pre45, %cond.true.i.i15.if.then3_crit_edge ], [ %8, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit20 ]
  %11 = phi ptr [ %.pre44, %cond.true.i.i15.if.then3_crit_edge ], [ %9, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit20 ]
  store ptr %10, ptr %__x2, align 8, !tbaa !13
  store ptr %11, ptr %__x3, align 8, !tbaa !13
  store i32 %6, ptr %second1.i.i12, align 8, !tbaa !16
  store i32 %7, ptr %second1.i.i, align 8, !tbaa !16
  %12 = load i32, ptr %second1.i.i12, align 8, !tbaa !43
  %second1.i.i24 = getelementptr inbounds %"struct.std::__1::pair.4", ptr %__x1, i64 0, i32 1
  %13 = load i32, ptr %second1.i.i24, align 8, !tbaa !43
  %cmp.not.i.i25 = icmp eq i32 %12, %13
  br i1 %cmp.not.i.i25, label %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit32, label %cond.true.i.i27

cond.true.i.i27:                                  ; preds = %if.then3
  %cmp4.i.i26 = icmp sgt i32 %12, %13
  br i1 %cmp4.i.i26, label %cond.true.i.i27.if.then5_crit_edge, label %if.end7

cond.true.i.i27.if.then5_crit_edge:               ; preds = %cond.true.i.i27
  %.pre46 = load ptr, ptr %__x1, align 8, !tbaa !13
  %.pre47 = load ptr, ptr %__x2, align 8, !tbaa !13
  br label %if.then5

_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit32: ; preds = %if.then3
  %14 = load ptr, ptr %__x2, align 8, !tbaa !45
  %15 = load ptr, ptr %__x1, align 8, !tbaa !45
  %call.i.i28 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %14, ptr noundef nonnull dereferenceable(1) %15) #25
  %cmp6.i.i29 = icmp sgt i32 %call.i.i28, 0
  br i1 %cmp6.i.i29, label %if.then5, label %if.end7

if.then5:                                         ; preds = %cond.true.i.i27.if.then5_crit_edge, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit32
  %16 = phi ptr [ %.pre47, %cond.true.i.i27.if.then5_crit_edge ], [ %14, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit32 ]
  %17 = phi ptr [ %.pre46, %cond.true.i.i27.if.then5_crit_edge ], [ %15, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit32 ]
  store ptr %16, ptr %__x1, align 8, !tbaa !13
  store ptr %17, ptr %__x2, align 8, !tbaa !13
  store i32 %12, ptr %second1.i.i24, align 8, !tbaa !16
  store i32 %13, ptr %second1.i.i12, align 8, !tbaa !16
  br label %if.end7

if.end7:                                          ; preds = %cond.true.i.i27, %cond.true.i.i15, %cond.true.i.i, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit20, %if.then5, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit32, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit
  ret void
}

; Function Attrs: mustprogress uwtable
define linkonce_odr hidden void @_ZNSt3__17__sort5B7v170000INS_17_ClassicAlgPolicyERNS_6__lessINS_4pairIPKciEES6_EEPS6_EEvT1_SA_SA_SA_SA_T0_(ptr noundef %__x1, ptr noundef %__x2, ptr noundef %__x3, ptr noundef %__x4, ptr noundef %__x5, ptr noundef nonnull align 1 dereferenceable(1) %__comp) local_unnamed_addr #0 comdat {
entry:
  tail call void @_ZNSt3__17__sort4B7v170000INS_17_ClassicAlgPolicyERNS_6__lessINS_4pairIPKciEES6_EEPS6_EEvT1_SA_SA_SA_T0_(ptr noundef %__x1, ptr noundef %__x2, ptr noundef %__x3, ptr noundef %__x4, ptr noundef nonnull align 1 dereferenceable(1) %__comp)
...
cond.true.i.i.if.then_crit_edge:                  ; preds = %cond.true.i.i
  ...
  %.pre61 = load ptr, ptr %__x5, align 8, !tbaa !13
  br label %if.then
...
if.then:                                          ; preds = %cond.true.i.i.if.then_crit_edge, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit
  %4 = phi ptr [ %.pre61, %cond.true.i.i.if.then_crit_edge ], [ %2, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit ]
  %5 = phi ptr [ %.pre, %cond.true.i.i.if.then_crit_edge ], [ %3, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit ]
  ...
  store i32 %1, ptr %second.i.i, align 8, !tbaa !16
  %6 = load i32, ptr %second1.i.i, align 8, !tbaa !43
  %second1.i.i15 = getelementptr inbounds %"struct.std::__1::pair.4", ptr %__x3, i64 0, i32 1
  %7 = load i32, ptr %second1.i.i15, align 8, !tbaa !43
  %cmp.not.i.i16 = icmp eq i32 %6, %7
  br i1 %cmp.not.i.i16, label %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit23, label %cond.true.i.i18

cond.true.i.i18:                                  ; preds = %if.then
  %cmp4.i.i17 = icmp sgt i32 %6, %7
  br i1 %cmp4.i.i17, label %cond.true.i.i18.if.then2_crit_edge, label %if.end9

cond.true.i.i18.if.then2_crit_edge:               ; preds = %cond.true.i.i18
  %.pre62 = load ptr, ptr %__x3, align 8, !tbaa !13
  %.pre63 = load ptr, ptr %__x4, align 8, !tbaa !13
  br label %if.then2

_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit23: ; preds = %if.then
  %8 = load ptr, ptr %__x4, align 8, !tbaa !45
  %9 = load ptr, ptr %__x3, align 8, !tbaa !45
  %call.i.i19 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %8, ptr noundef nonnull dereferenceable(1) %9) #25
  %cmp6.i.i20 = icmp sgt i32 %call.i.i19, 0
  br i1 %cmp6.i.i20, label %if.then2, label %if.end9

if.then2:                                         ; preds = %cond.true.i.i18.if.then2_crit_edge, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit23
  %10 = phi ptr [ %.pre63, %cond.true.i.i18.if.then2_crit_edge ], [ %8, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit23 ]
  %11 = phi ptr [ %.pre62, %cond.true.i.i18.if.then2_crit_edge ], [ %9, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit23 ]
  store ptr %10, ptr %__x3, align 8, !tbaa !13
  store ptr %11, ptr %__x4, align 8, !tbaa !13
  store i32 %6, ptr %second1.i.i15, align 8, !tbaa !16
  store i32 %7, ptr %second1.i.i, align 8, !tbaa !16
  %12 = load i32, ptr %second1.i.i15, align 8, !tbaa !43
  %second1.i.i27 = getelementptr inbounds %"struct.std::__1::pair.4", ptr %__x2, i64 0, i32 1
  %13 = load i32, ptr %second1.i.i27, align 8, !tbaa !43
  %cmp.not.i.i28 = icmp eq i32 %12, %13
  br i1 %cmp.not.i.i28, label %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit35, label %cond.true.i.i30

cond.true.i.i30:                                  ; preds = %if.then2
  %cmp4.i.i29 = icmp sgt i32 %12, %13
  br i1 %cmp4.i.i29, label %cond.true.i.i30.if.then4_crit_edge, label %if.end9

cond.true.i.i30.if.then4_crit_edge:               ; preds = %cond.true.i.i30
  %.pre64 = load ptr, ptr %__x2, align 8, !tbaa !13
  %.pre65 = load ptr, ptr %__x3, align 8, !tbaa !13
  br label %if.then4

_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit35: ; preds = %if.then2
  %14 = load ptr, ptr %__x3, align 8, !tbaa !45
  %15 = load ptr, ptr %__x2, align 8, !tbaa !45
  %call.i.i31 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %14, ptr noundef nonnull dereferenceable(1) %15) #25
  %cmp6.i.i32 = icmp sgt i32 %call.i.i31, 0
  br i1 %cmp6.i.i32, label %if.then4, label %if.end9

if.then4:                                         ; preds = %cond.true.i.i30.if.then4_crit_edge, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit35
  %16 = phi ptr [ %.pre65, %cond.true.i.i30.if.then4_crit_edge ], [ %14, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit35 ]
  %17 = phi ptr [ %.pre64, %cond.true.i.i30.if.then4_crit_edge ], [ %15, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit35 ]
  store ptr %16, ptr %__x2, align 8, !tbaa !13
  store ptr %17, ptr %__x3, align 8, !tbaa !13
  store i32 %12, ptr %second1.i.i27, align 8, !tbaa !16
  store i32 %13, ptr %second1.i.i15, align 8, !tbaa !16
  %18 = load i32, ptr %second1.i.i27, align 8, !tbaa !43
  %second1.i.i39 = getelementptr inbounds %"struct.std::__1::pair.4", ptr %__x1, i64 0, i32 1
  %19 = load i32, ptr %second1.i.i39, align 8, !tbaa !43
  %cmp.not.i.i40 = icmp eq i32 %18, %19
  br i1 %cmp.not.i.i40, label %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit47, label %cond.true.i.i42

cond.true.i.i42:                                  ; preds = %if.then4
  %cmp4.i.i41 = icmp sgt i32 %18, %19
  br i1 %cmp4.i.i41, label %cond.true.i.i42.if.then6_crit_edge, label %if.end9

cond.true.i.i42.if.then6_crit_edge:               ; preds = %cond.true.i.i42
  %.pre66 = load ptr, ptr %__x1, align 8, !tbaa !13
  %.pre67 = load ptr, ptr %__x2, align 8, !tbaa !13
  br label %if.then6

_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit47: ; preds = %if.then4
  %20 = load ptr, ptr %__x2, align 8, !tbaa !45
  %21 = load ptr, ptr %__x1, align 8, !tbaa !45
  %call.i.i43 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %20, ptr noundef nonnull dereferenceable(1) %21) #25
  %cmp6.i.i44 = icmp sgt i32 %call.i.i43, 0
  br i1 %cmp6.i.i44, label %if.then6, label %if.end9

if.then6:                                         ; preds = %cond.true.i.i42.if.then6_crit_edge, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit47
  %22 = phi ptr [ %.pre67, %cond.true.i.i42.if.then6_crit_edge ], [ %20, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit47 ]
  %23 = phi ptr [ %.pre66, %cond.true.i.i42.if.then6_crit_edge ], [ %21, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit47 ]
  store ptr %22, ptr %__x1, align 8, !tbaa !13
  store ptr %23, ptr %__x2, align 8, !tbaa !13
  store i32 %18, ptr %second1.i.i39, align 8, !tbaa !16
  store i32 %19, ptr %second1.i.i27, align 8, !tbaa !16
  br label %if.end9

if.end9:                                          ; preds = %cond.true.i.i42, %cond.true.i.i30, %cond.true.i.i18, %cond.true.i.i, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit23, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit47, %if.then6, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit35, %_ZNKSt3__16__lessINS_4pairIPKciEES4_EclB7v170000ERKS4_S7_.exit
  ret void
}
