; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/FreeBench/mason/mason.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/FreeBench/mason/mason.c"
...
entry:
  ...
  %call2 = tail call ptr @fopen(ptr noundef %2, ptr noundef nonnull @.str.4)
...
for.cond:                                         ; preds = %for.cond, %if.end
  ...
  %call8 = call fastcc i32 @mu(ptr noundef nonnull byval(%struct.p_type) align 8 %p, i32 noundef %k.0, i32 noundef 0, i32 noundef -1)
...
if.then10:                                        ; preds = %for.cond
  ...
  %call.i = call i32 @_IO_putc(i32 noundef 10, ptr noundef %6)
...
entry.if.end51_crit_edge:                         ; preds = %entry
  %.pre = load i32, ptr %p, align 8, !tbaa !9
...
if.then:                                          ; preds = %entry
  %b = getelementptr inbounds %struct.p_type, ptr %p, i64 0, i32 1
  %0 = load i32, ptr %b, align 4, !tbaa !12
...
if.end:                                           ; preds = %if.then
  %d = getelementptr inbounds %struct.p_type, ptr %p, i64 0, i32 3
  %3 = load i32, ptr %d, align 4, !tbaa !13
...
if.end8:                                          ; preds = %if.end
  %bi = getelementptr inbounds %struct.p_type, ptr %p, i64 0, i32 4
  %6 = load i32, ptr %bi, align 8, !tbaa !14
...
if.end14:                                         ; preds = %if.end8
  %ar = getelementptr inbounds %struct.p_type, ptr %p, i64 0, i32 5
  %9 = load i32, ptr %ar, align 4, !tbaa !15
...
if.end20:                                         ; preds = %if.end14
  %12 = load i32, ptr %p, align 8, !tbaa !9
...
if.end26:                                         ; preds = %if.end20
  %c = getelementptr inbounds %struct.p_type, ptr %p, i64 0, i32 2
  %15 = load i32, ptr %c, align 8, !tbaa !16
...
if.end32:                                         ; preds = %if.end26
  %g1 = getelementptr inbounds %struct.p_type, ptr %p, i64 0, i32 6
  %18 = load i32, ptr %g1, align 8, !tbaa !17
...
if.end38:                                         ; preds = %if.end32
  %g2 = getelementptr inbounds %struct.p_type, ptr %p, i64 0, i32 7
  %21 = load i32, ptr %g2, align 4, !tbaa !18
...
if.end44:                                         ; preds = %if.end38
  %g3 = getelementptr inbounds %struct.p_type, ptr %p, i64 0, i32 8
  %24 = load i32, ptr %g3, align 8, !tbaa !19
...
cond.false:                                       ; preds = %if.end83
  ...
  %31 = load i32, ptr %arrayidx.i, align 4, !tbaa !23, !noalias !20
  store i32 %31, ptr %agg.tmp, align 8, !tbaa !9, !alias.scope !20
  ...
  %32 = load i32, ptr %arrayidx3.i, align 4, !tbaa !23, !noalias !20
  %b4.i = getelementptr inbounds %struct.p_type, ptr %agg.tmp, i64 0, i32 1
  store i32 %32, ptr %b4.i, align 4, !tbaa !12, !alias.scope !20
  ...
  %33 = load i32, ptr %arrayidx6.i, align 4, !tbaa !23, !noalias !20
  %c7.i = getelementptr inbounds %struct.p_type, ptr %agg.tmp, i64 0, i32 2
  store i32 %33, ptr %c7.i, align 8, !tbaa !16, !alias.scope !20
  ...
  %34 = load i32, ptr %arrayidx9.i, align 4, !tbaa !23, !noalias !20
  %d10.i = getelementptr inbounds %struct.p_type, ptr %agg.tmp, i64 0, i32 3
  store i32 %34, ptr %d10.i, align 4, !tbaa !13, !alias.scope !20
  ...
  %35 = load i32, ptr %arrayidx12.i, align 4, !tbaa !23, !noalias !20
  %bi13.i = getelementptr inbounds %struct.p_type, ptr %agg.tmp, i64 0, i32 4
  store i32 %35, ptr %bi13.i, align 8, !tbaa !14, !alias.scope !20
  ...
  %36 = load i32, ptr %arrayidx15.i, align 4, !tbaa !23, !noalias !20
  %ar16.i = getelementptr inbounds %struct.p_type, ptr %agg.tmp, i64 0, i32 5
  store i32 %36, ptr %ar16.i, align 4, !tbaa !15, !alias.scope !20
  ...
  %37 = load i32, ptr %arrayidx18.i, align 4, !tbaa !23, !noalias !20
  %g119.i = getelementptr inbounds %struct.p_type, ptr %agg.tmp, i64 0, i32 6
  store i32 %37, ptr %g119.i, align 8, !tbaa !17, !alias.scope !20
  ...
  %38 = load i32, ptr %arrayidx21.i, align 4, !tbaa !23, !noalias !20
  %g222.i = getelementptr inbounds %struct.p_type, ptr %agg.tmp, i64 0, i32 7
  store i32 %38, ptr %g222.i, align 4, !tbaa !18, !alias.scope !20
  ...
  %39 = load i32, ptr %arrayidx24.i, align 4, !tbaa !23, !noalias !20
  %g325.i = getelementptr inbounds %struct.p_type, ptr %agg.tmp, i64 0, i32 8
  store i32 %39, ptr %g325.i, align 8, !tbaa !19, !alias.scope !20
  %add85 = add nsw i32 %dep, 1
  %call86 = tail call fastcc i32 @md(ptr noundef nonnull byval(%struct.p_type) align 8 %agg.tmp, i32 noundef %maxdep, i32 noundef %add85, i32 noundef 0)
  %40 = icmp eq i32 %call86, 1
  br i1 %40, label %if.then88, label %if.else94

if.then88:                                        ; preds = %cond.false
  %41 = load ptr, ptr @stdout, align 8, !tbaa !5
  %call.i = tail call i32 @_IO_putc(i32 noundef 48, ptr noundef %41)
  %42 = and i32 %dep, 3
...
if.then91:                                        ; preds = %if.then88
  ...
  %call.i162 = tail call i32 @_IO_putc(i32 noundef 32, ptr noundef %43)
  br label %cleanup
...
cond.false97:                                     ; preds = %if.end83.cond.false97_crit_edge, %if.else94
  ...
  %call100 = tail call fastcc i32 @md(ptr noundef nonnull byval(%struct.p_type) align 8 %p, i32 noundef %maxdep, i32 noundef %add99.pre-phi, i32 noundef 1)
  %44 = icmp eq i32 %call100, 1
  br i1 %44, label %if.then104, label %if.else111

if.then104:                                       ; preds = %cond.false97
  %45 = load ptr, ptr @stdout, align 8, !tbaa !5
  %call.i164 = tail call i32 @_IO_putc(i32 noundef 49, ptr noundef %45)
  %46 = and i32 %dep, 3
...
if.then108:                                       ; preds = %if.then104
  ...
  %call.i165 = tail call i32 @_IO_putc(i32 noundef 32, ptr noundef %47)
  br label %cleanup
...
if.then125:                                       ; preds = %if.then121
  ...
  %call.i202 = tail call i32 @_IO_putc(i32 noundef 32, ptr noundef %59)
  br label %cleanup
...
cleanup:                                          ; preds = %if.else111, %cond.end118, %if.then125, %if.then121, %if.then104, %if.then108, %if.then88, %if.then91, %if.else, %if.end44, %if.end38, %if.end32, %if.end26, %if.end20, %if.end14, %if.end8, %if.end, %if.then, %if.then74
  %retval.0 = phi i32 [ 1, %if.then74 ], [ 0, %if.then ], [ 0, %if.end ], [ 0, %if.end8 ], [ 0, %if.end14 ], [ 0, %if.end20 ], [ 0, %if.end26 ], [ 0, %if.end32 ], [ 0, %if.end38 ], [ 0, %if.end44 ], [ 0, %if.else ], [ 1, %if.then91 ], [ 1, %if.then88 ], [ 1, %if.then108 ], [ 1, %if.then104 ], [ 1, %if.then121 ], [ 1, %if.then125 ], [ %call117, %cond.end118 ], [ 0, %if.else111 ]
  ret i32 %retval.0
}
...
cond.false:                                       ; preds = %if.end
  ...
  %0 = load i32, ptr %arrayidx.i, align 4, !tbaa !23, !noalias !27
  store i32 %0, ptr %agg.tmp, align 8, !tbaa !9, !alias.scope !27
  ...
  %1 = load i32, ptr %arrayidx3.i, align 4, !tbaa !23, !noalias !27
  %b4.i = getelementptr inbounds %struct.p_type, ptr %agg.tmp, i64 0, i32 1
  store i32 %1, ptr %b4.i, align 4, !tbaa !12, !alias.scope !27
  ...
  %2 = load i32, ptr %arrayidx6.i, align 4, !tbaa !23, !noalias !27
  %c7.i = getelementptr inbounds %struct.p_type, ptr %agg.tmp, i64 0, i32 2
  store i32 %2, ptr %c7.i, align 8, !tbaa !16, !alias.scope !27
  ...
  %3 = load i32, ptr %arrayidx9.i, align 4, !tbaa !23, !noalias !27
  %d10.i = getelementptr inbounds %struct.p_type, ptr %agg.tmp, i64 0, i32 3
  store i32 %3, ptr %d10.i, align 4, !tbaa !13, !alias.scope !27
  ...
  %4 = load i32, ptr %arrayidx12.i, align 4, !tbaa !23, !noalias !27
  %bi13.i = getelementptr inbounds %struct.p_type, ptr %agg.tmp, i64 0, i32 4
  store i32 %4, ptr %bi13.i, align 8, !tbaa !14, !alias.scope !27
  ...
  %5 = load i32, ptr %arrayidx15.i, align 4, !tbaa !23, !noalias !27
  %ar16.i = getelementptr inbounds %struct.p_type, ptr %agg.tmp, i64 0, i32 5
  store i32 %5, ptr %ar16.i, align 4, !tbaa !15, !alias.scope !27
  ...
  %6 = load i32, ptr %arrayidx18.i, align 4, !tbaa !23, !noalias !27
  %g119.i = getelementptr inbounds %struct.p_type, ptr %agg.tmp, i64 0, i32 6
  store i32 %6, ptr %g119.i, align 8, !tbaa !17, !alias.scope !27
  ...
  %7 = load i32, ptr %arrayidx21.i, align 4, !tbaa !23, !noalias !27
  %g222.i = getelementptr inbounds %struct.p_type, ptr %agg.tmp, i64 0, i32 7
  store i32 %7, ptr %g222.i, align 4, !tbaa !18, !alias.scope !27
  ...
  %8 = load i32, ptr %arrayidx24.i, align 4, !tbaa !23, !noalias !27
  %g325.i = getelementptr inbounds %struct.p_type, ptr %agg.tmp, i64 0, i32 8
  store i32 %8, ptr %g325.i, align 8, !tbaa !19, !alias.scope !27
  %add = add nsw i32 %dep, 1
  %call = tail call fastcc i32 @mu(ptr noundef nonnull byval(%struct.p_type) align 8 %agg.tmp, i32 noundef %maxdep, i32 noundef %add, i32 noundef 0)
  %9 = icmp eq i32 %call, 1
  br i1 %9, label %if.then3, label %if.else

if.then3:                                         ; preds = %cond.false
  %10 = load ptr, ptr @stdout, align 8, !tbaa !5
  %call.i = tail call i32 @_IO_putc(i32 noundef 48, ptr noundef %10)
  %11 = and i32 %dep, 3
...
cond.false11:                                     ; preds = %if.end.cond.false11_crit_edge, %if.else
  ...
  %call14 = tail call fastcc i32 @mu(ptr noundef nonnull byval(%struct.p_type) align 8 %p, i32 noundef %maxdep, i32 noundef %add13.pre-phi, i32 noundef 1)
  %12 = icmp eq i32 %call14, 1
  br i1 %12, label %if.then18, label %if.else25

if.then18:                                        ; preds = %cond.false11
  %13 = load ptr, ptr @stdout, align 8, !tbaa !5
  %call.i63 = tail call i32 @_IO_putc(i32 noundef 49, ptr noundef %13)
  %14 = and i32 %dep, 3
...
cleanup.sink.split:                               ; preds = %if.then35, %if.then18, %if.then3
  ...
  %call.i101 = tail call i32 @_IO_putc(i32 noundef 32, ptr noundef %26)
  br label %cleanup

cleanup:                                          ; preds = %cleanup.sink.split, %if.else25, %cond.end32, %if.then35, %if.then18, %if.then3, %entry
  %retval.0 = phi i32 [ 0, %entry ], [ 1, %if.then3 ], [ 1, %if.then18 ], [ 1, %if.then35 ], [ %call31, %cond.end32 ], [ 0, %if.else25 ], [ 1, %cleanup.sink.split ]
  ret i32 %retval.0
}
...
!8 = !{!"Simple C/C++ TBAA"}
!9 = !{!10, !11, i64 0}
!10 = !{!"", !11, i64 0, !11, i64 4, !11, i64 8, !11, i64 12, !11, i64 16, !11, i64 20, !11, i64 24, !11, i64 28, !11, i64 32}
!11 = !{!"int", !7, i64 0}
!12 = !{!10, !11, i64 4}
!13 = !{!10, !11, i64 12}
!14 = !{!10, !11, i64 16}
...
!19 = !{!10, !11, i64 32}
!20 = !{!21}
!21 = distinct !{!21, !22, !"m0u: %agg.result"}
!22 = distinct !{!22, !"m0u"}
!23 = !{!11, !11, i64 0}
!24 = !{!25}
!25 = distinct !{!25, !26, !"m2u: %agg.result"}
!26 = distinct !{!26, !"m2u"}
!27 = !{!28}
!28 = distinct !{!28, !29, !"m0d: %agg.result"}
!29 = distinct !{!29, !"m0d"}
!30 = !{!31}
!31 = distinct !{!31, !32, !"m2d: %agg.result"}
!32 = distinct !{!32, !"m2d"}
