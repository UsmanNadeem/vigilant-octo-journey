; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/Burg/table.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/Burg/table.c"
...
restrict.exit:                                    ; preds = %for.inc55.i, %for.body, %for.cond29.preheader.i
  ...
  %17 = load i32, ptr %index_map, align 8, !tbaa !28
  %18 = load i32, ptr %ts, align 8, !tbaa !42
...
if.then:                                          ; preds = %restrict.exit
  ...
  %19 = load ptr, ptr %class5.i, align 8, !tbaa !43
  %20 = load i32, ptr %index_map, align 8, !tbaa !44
  ...
  %21 = load ptr, ptr %class5.i, align 8, !tbaa !43
  ...
  %.pre72 = load i32, ptr %ts, align 8, !tbaa !42
  br label %if.end
...
if.then20:                                        ; preds = %if.end
  ...
  %28 = load i32, ptr %call.i, align 8, !tbaa !42
...
for.end.i.i:                                      ; preds = %if.end50.i.i, %sw.bb.i55
  ...
  %94 = load i32, ptr %call.i, align 8, !tbaa !42
...
for.end.i35.i:                                    ; preds = %if.end94.i.i, %for.body.i21.i
  ...
  %144 = load i32, ptr %call.i, align 8, !tbaa !42
...
for.end.i123.i:                                   ; preds = %if.end94.i115.i, %for.body.i57.i
  ...
  %203 = load i32, ptr %call.i, align 8, !tbaa !42
...
entry:
  %0 = load i32, ptr %r, align 8, !tbaa !44
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %3 = load ptr, ptr %class, align 8, !tbaa !43
...
dumpRelevant.exit:                                ; preds = %for.body.i, %entry
  ...
  %4 = load i32, ptr %index_map, align 8, !tbaa !44
...
for.body.i10:                                     ; preds = %for.body.i10, %for.body.lr.ph.i
  ...
  %7 = load ptr, ptr %class.i, align 8, !tbaa !43
...
if.end.peel:                                      ; preds = %sw.bb1
  ...
  %.pre96 = load i32, ptr %.pre95, align 8, !tbaa !42
...
if.end37.peel:                                    ; preds = %sw.bb.i.peel, %sw.bb1.i.peel, %sw.bb3.i.peel
  ...
  %.pre93 = load i32, ptr %.pre, align 8, !tbaa !42
