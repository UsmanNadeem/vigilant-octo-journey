; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/fmo.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/fmo.c"
...
if.end5.i:                                        ; preds = %if.then4.i, %if.end3.i
  %5 = load i32, ptr @PicSizeInMapUnits, align 4, !tbaa !5
  %conv.i = zext i32 %5 to i64
  %call.i = tail call noalias ptr @malloc(i64 noundef %conv.i) #15
...
land.rhs4.i.i:                                    ; preds = %for.body7.i.i
  ...
  %13 = load i32, ptr @PicSizeInMapUnits, align 4, !tbaa !5
...
for.end.i.i:                                      ; preds = %for.end.i.loopexit.i, %sw.bb23.i
  ...
  br i1 %cmp369.i.i, label %for.body5.i.i, label %FmoGenerateMapUnitToSliceGroupMap.exit

for.cond2.loopexit.i.i:                           ; preds = %for.cond25.for.inc36_crit_edge.i.i, %for.cond25.preheader.lr.ph.i.i, %for.body5.i.i
  %iGroup.0.i.i = add i32 %iGroup.070.i.i, -1
...
for.body5.i.i:                                    ; preds = %for.end.i.i, %for.cond2.loopexit.i.i
  %iGroup.070.i.i = phi i32 [ %iGroup.0.i.i, %for.cond2.loopexit.i.i ], [ %iGroup.068.i.i, %for.end.i.i ]
  %idxprom6.i.i = zext i32 %iGroup.070.i.i to i64
  %arrayidx7.i.i = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 11, i64 %idxprom6.i.i
  %33 = load i32, ptr %arrayidx7.i.i, align 4, !tbaa !5
  %34 = load i32, ptr %PicWidthInMbs.i, align 8, !tbaa !15
  %div.i64.i = udiv i32 %33, %34
  %rem.i65.i = urem i32 %33, %34
  %arrayidx13.i.i = getelementptr inbounds %struct.pic_parameter_set_rbsp_t, ptr %pps, i64 0, i32 12, i64 %idxprom6.i.i
  %35 = load i32, ptr %arrayidx13.i.i, align 4, !tbaa !5
  %div15.i.i = udiv i32 %35, %34
  %rem20.i.i = urem i32 %35, %34
...
for.cond25.preheader.lr.ph.i.i:                   ; preds = %for.body5.i.i
  ...
  %conv29.i.i = trunc i32 %iGroup.070.i.i to i8
...
for.body28.i.i:                                   ; preds = %for.body28.i.i, %for.cond25.preheader.i.i
  ...
  %36 = load ptr, ptr @MapUnitToSliceGroupMap, align 8, !tbaa !19
  %37 = load i32, ptr %PicWidthInMbs.i, align 8, !tbaa !15
  %mul.i66.i = mul i32 %37, %y.067.i.i
  %add.i67.i = add i32 %mul.i66.i, %x.065.i.i
  %idxprom31.i.i = zext i32 %add.i67.i to i64
  %arrayidx32.i.i = getelementptr inbounds i8, ptr %36, i64 %idxprom31.i.i
...
sw.bb24.i:                                        ; preds = %if.end20.i
  ...
  %38 = load i32, ptr %slice_group_change_rate_minus1.i.i, align 8, !tbaa !31
  %add.i68.i = add i32 %38, 1
  %slice_group_change_cycle.i.i = getelementptr inbounds %struct.ImageParameters, ptr %img, i64 0, i32 140
  %39 = load i32, ptr %slice_group_change_cycle.i.i, align 4, !tbaa !32
  %mul.i69.i = mul i32 %add.i68.i, %39
...
for.body.i74.i:                                   ; preds = %sw.bb24.i, %for.body.i74.i
  ...
  %40 = load ptr, ptr @MapUnitToSliceGroupMap, align 8, !tbaa !19
  %arrayidx.i71.i = getelementptr inbounds i8, ptr %40, i64 %indvars.iv.i70.i
  store i8 2, ptr %arrayidx.i71.i, align 1, !tbaa !23
  %indvars.iv.next.i72.i = add nuw nsw i64 %indvars.iv.i70.i, 1
  %41 = load i32, ptr @PicSizeInMapUnits, align 4, !tbaa !5
  %42 = zext i32 %41 to i64
  %cmp.i73.i = icmp ult i64 %indvars.iv.next.i72.i, %42
...
for.end.i76.i:                                    ; preds = %for.body.i74.i
  ...
  br i1 %43, label %FmoGenerateMapUnitToSliceGroupMap.exit, label %for.body9.preheader.i.i

for.body9.preheader.i.i:                          ; preds = %for.end.i76.i
  %44 = load i32, ptr %slice_group_change_direction_flag.i.i, align 4, !tbaa !34
  %sub5.i.i = add i32 %44, -1
  %45 = load i32, ptr %PicHeightInMapUnits.i, align 4, !tbaa !9
  %sub2.i.i = sub i32 %45, %44
  %div3128.i.i = lshr i32 %sub2.i.i, 1
  %46 = load i32, ptr %PicWidthInMbs.i, align 8, !tbaa !15
  %sub.i.i = sub i32 %46, %44
...
for.body9.i.i:                                    ; preds = %for.inc81.i.i, %for.body9.preheader.i.i
  %47 = phi ptr [ %50, %for.inc81.i.i ], [ %.pre149.i.i, %for.body9.preheader.i.i ]
  %k.0147.i.i = phi i32 [ %add82.i.i, %for.inc81.i.i ], [ 0, %for.body9.preheader.i.i ]
  %yDir.0146.i.i = phi i32 [ %yDir.1.i.i, %for.inc81.i.i ], [ %44, %for.body9.preheader.i.i ]
  ...
  %48 = load i32, ptr %PicWidthInMbs.i, align 8, !tbaa !15
  %mul11.i.i = mul i32 %48, %y.0144.i.i
  %add12.i.i = add i32 %mul11.i.i, %x.0143.i.i
  %idxprom13.i.i = zext i32 %add12.i.i to i64
  %arrayidx14.i.i = getelementptr inbounds i8, ptr %47, i64 %idxprom13.i.i
  %49 = load i8, ptr %arrayidx14.i.i, align 1, !tbaa !23
  %cmp15.i.i = icmp eq i8 %49, 2
...
if.end.i.i:                                       ; preds = %if.then.i.i, %for.body9.i.i
  %50 = phi ptr [ %.pre.i77.i, %if.then.i.i ], [ %47, %for.body9.i.i ]
...
if.then29.i.i:                                    ; preds = %if.end.i.i
  %51 = tail call i32 @llvm.smax.i32(i32 %x.0143.i.i, i32 1)
  %cond.i132.i.i = add nsw i32 %51, -1
  %52 = load i32, ptr %slice_group_change_direction_flag.i.i, align 4, !tbaa !34
  %mul33.i.i = shl i32 %52, 1
...
if.then40.i.i:                                    ; preds = %if.else.i.i
  ...
  %53 = load i32, ptr %PicWidthInMbs.i, align 8, !tbaa !15
  %sub43.i.i = add nsw i32 %53, -1
  %cond.i133.i.i = tail call i32 @llvm.smin.i32(i32 %add41.i.i, i32 %sub43.i.i)
  %54 = load i32, ptr %slice_group_change_direction_flag.i.i, align 4, !tbaa !34
  %mul46.i.i = shl i32 %54, 1
...
if.then54.i.i:                                    ; preds = %if.else48.i.i
  %55 = tail call i32 @llvm.smax.i32(i32 %y.0144.i.i, i32 1)
  %cond.i134.i.i = add nsw i32 %55, -1
  %56 = load i32, ptr %slice_group_change_direction_flag.i.i, align 4, !tbaa !34
  %mul58.i.i = shl i32 %56, 1
...
if.then66.i.i:                                    ; preds = %if.else60.i.i
  ...
  %57 = load i32, ptr %PicHeightInMapUnits.i, align 4, !tbaa !9
  %sub69.i.i = add nsw i32 %57, -1
  %cond.i135.i.i = tail call i32 @llvm.smin.i32(i32 %add67.i.i, i32 %sub69.i.i)
  %58 = load i32, ptr %slice_group_change_direction_flag.i.i, align 4, !tbaa !34
  %mul72.i.i = shl i32 %58, 1
...
for.inc81.i.i:                                    ; preds = %if.else74.i.i, %if.then66.i.i, %if.then54.i.i, %if.then40.i.i, %if.then29.i.i
  ...
  %59 = load i32, ptr @PicSizeInMapUnits, align 4, !tbaa !5
  %cmp8.i.i = icmp ult i32 %add82.i.i, %59
...
for.body.preheader.i.i:                           ; preds = %sw.bb25.i
  %60 = getelementptr i8, ptr %img, i64 15436
  %img.val.i = load i32, ptr %60, align 4, !tbaa !32
  %61 = load i32, ptr %slice_group_change_direction_flag.i78.i, align 4, !tbaa !34
  ...
  %62 = load i32, ptr %slice_group_change_rate_minus1.i79.i, align 8, !tbaa !31
  %add.i80.i = add i32 %62, 1
...
for.body.i90.i:                                   ; preds = %for.body.i90.i, %for.body.preheader.i.i
  ...
  %cmp1.i85.i = icmp ult i64 %indvars.iv.i84.i, %63
  %64 = load i32, ptr %slice_group_change_direction_flag.i78.i, align 4, !tbaa !34
  %conv.i86.i = trunc i32 %64 to i8
  %conv5.i.i = sub i8 1, %conv.i86.i
  %conv.sink.i.i = select i1 %cmp1.i85.i, i8 %conv.i86.i, i8 %conv5.i.i
  %65 = load ptr, ptr @MapUnitToSliceGroupMap, align 8, !tbaa !19
  %arrayidx.i87.i = getelementptr inbounds i8, ptr %65, i64 %indvars.iv.i84.i
  store i8 %conv.sink.i.i, ptr %arrayidx.i87.i, align 1, !tbaa !23
  %indvars.iv.next.i88.i = add nuw nsw i64 %indvars.iv.i84.i, 1
  %66 = load i32, ptr @PicSizeInMapUnits, align 4, !tbaa !5
  %67 = zext i32 %66 to i64
  %cmp.i89.i = icmp ult i64 %indvars.iv.next.i88.i, %67
...
sw.bb26.i:                                        ; preds = %if.end20.i
  ...
  %68 = load i32, ptr %slice_group_change_rate_minus1.i92.i, align 8, !tbaa !31
  %add.i93.i = add i32 %68, 1
  %slice_group_change_cycle.i94.i = getelementptr inbounds %struct.ImageParameters, ptr %img, i64 0, i32 140
  %69 = load i32, ptr %slice_group_change_cycle.i94.i, align 4, !tbaa !32
  %mul.i95.i = mul i32 %add.i93.i, %69
  ...
  %70 = load i32, ptr %slice_group_change_direction_flag.i97.i, align 4, !tbaa !34
  %tobool.not.i98.i = icmp eq i32 %70, 0
  %sub.i99.i = sub i32 %5, %cond.i.i96.i
  %cond.i100.i = select i1 %tobool.not.i98.i, i32 %cond.i.i96.i, i32 %sub.i99.i
  %71 = load i32, ptr %PicWidthInMbs.i, align 8, !tbaa !15
  %cmp38.not.i.i = icmp eq i32 %71, 0
...
for.cond1.preheader.lr.ph.i.i:                    ; preds = %sw.bb26.i
  %72 = load i32, ptr %PicHeightInMapUnits.i, align 4, !tbaa !9
...
for.cond1.preheader.i.i:                          ; preds = %for.cond1.preheader.lr.ph.i.i, %for.inc18.i.i
  %73 = phi i32 [ %79, %for.inc18.i.i ], [ %71, %for.cond1.preheader.lr.ph.i.i ]
  %74 = phi i32 [ %80, %for.inc18.i.i ], [ 1, %for.cond1.preheader.lr.ph.i.i ]
  ...
  %cmp235.not.i.i = icmp eq i32 %74, 0
...
for.body3.i.i:                                    ; preds = %for.cond1.preheader.i.i, %for.body3.i.i
  ...
  %75 = load i32, ptr %slice_group_change_direction_flag.i97.i, align 4, !tbaa !34
  %conv.i103.i = trunc i32 %75 to i8
  %conv11.i.i = sub i8 1, %conv.i103.i
  %conv.sink.i104.i = select i1 %cmp4.i.i, i8 %conv.i103.i, i8 %conv11.i.i
  %76 = load ptr, ptr @MapUnitToSliceGroupMap, align 8, !tbaa !19
  %77 = load i32, ptr %PicWidthInMbs.i, align 8, !tbaa !15
  %mul7.i.i = mul i32 %77, %i.036.i.i
  %add8.i.i = add i32 %mul7.i.i, %j.039.i.i
  %idxprom.i105.i = zext i32 %add8.i.i to i64
  %arrayidx.i106.i = getelementptr inbounds i8, ptr %76, i64 %idxprom.i105.i
  store i8 %conv.sink.i104.i, ptr %arrayidx.i106.i, align 1, !tbaa !23
  %inc17.i.i = add nuw i32 %i.036.i.i, 1
  %78 = load i32, ptr %PicHeightInMapUnits.i, align 4, !tbaa !9
  %cmp2.i.i = icmp ult i32 %inc17.i.i, %78
...
for.inc18.i.i:                                    ; preds = %for.inc18.loopexit.i.i, %for.cond1.preheader.i.i
  %79 = phi i32 [ %73, %for.cond1.preheader.i.i ], [ %.pre.i107.i, %for.inc18.loopexit.i.i ]
  %80 = phi i32 [ 0, %for.cond1.preheader.i.i ], [ %78, %for.inc18.loopexit.i.i ]
  %k.1.lcssa.i.i = phi i32 [ %k.040.i.i, %for.cond1.preheader.i.i ], [ %inc.i.i, %for.inc18.loopexit.i.i ]
  %inc19.i.i = add nuw i32 %j.039.i.i, 1
  %cmp.i108.i = icmp ult i32 %inc19.i.i, %79
...
for.body.i114.i:                                  ; preds = %for.body.i114.i, %for.body.lr.ph.i109.i
  ...
  %81 = load ptr, ptr %slice_group_id.i.i, align 8, !tbaa !40
  %arrayidx.i111.i = getelementptr inbounds i8, ptr %81, i64 %indvars.iv.i110.i
  %82 = load i8, ptr %arrayidx.i111.i, align 1, !tbaa !23
  %83 = load ptr, ptr @MapUnitToSliceGroupMap, align 8, !tbaa !19
  %arrayidx2.i.i = getelementptr inbounds i8, ptr %83, i64 %indvars.iv.i110.i
  store i8 %82, ptr %arrayidx2.i.i, align 1, !tbaa !23
  %indvars.iv.next.i112.i = add nuw nsw i64 %indvars.iv.i110.i, 1
  %84 = load i32, ptr @PicSizeInMapUnits, align 4, !tbaa !5
  %85 = zext i32 %84 to i64
  %cmp.i113.i = icmp ult i64 %indvars.iv.next.i112.i, %85
...
FmoGenerateMapUnitToSliceGroupMap.exit:           ; preds = %for.body.i114.i, %for.inc18.i.i, %for.body.i90.i, %for.inc81.i.i, %for.cond2.loopexit.i.i, %for.body.i.i, %do.body.i.i, %do.cond.i.i, %if.then17.i, %sw.bb22.i, %for.end.i.i, %sw.bb24.i, %for.end.i76.i, %sw.bb25.i, %sw.bb26.i, %for.cond1.preheader.lr.ph.i.i, %sw.bb27.i
  %86 = load ptr, ptr @MBAmap, align 8, !tbaa !19
  %tobool.not.i5 = icmp eq ptr %86, null
...
if.end.i:                                         ; preds = %if.then.i6, %FmoGenerateMapUnitToSliceGroupMap.exit
  ...
  %87 = load i32, ptr %PicSizeInMbs.i, align 4, !tbaa !42
  %conv.i7 = zext i32 %87 to i64
  %call.i8 = tail call noalias ptr @malloc(i64 noundef %conv.i7) #15
...
if.then2.i10:                                     ; preds = %if.end.i
  %call7.i = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.3, i32 noundef %87)
  tail call void @exit(i32 noundef -1) #16
  unreachable

if.end8.i:                                        ; preds = %if.end.i
  %frame_mbs_only_flag.i = getelementptr inbounds %struct.seq_parameter_set_rbsp_t, ptr %sps, i64 0, i32 25
  %88 = load i32, ptr %frame_mbs_only_flag.i, align 4, !tbaa !43
...
lor.lhs.false.i:                                  ; preds = %if.end8.i
  ...
  %89 = load i32, ptr %field_picture.i, align 8, !tbaa !47
  %tobool10.not.i = icmp eq i32 %89, 0
  br i1 %tobool10.not.i, label %if.else.i, label %if.then11.i

if.then11.i:                                      ; preds = %lor.lhs.false.i, %if.end8.i
  %cmp1378.not.i = icmp eq i32 %87, 0
  br i1 %cmp1378.not.i, label %FmoGenerateMBAmap.exit, label %for.body.i

for.body.i:                                       ; preds = %if.then11.i, %for.body.i
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %for.body.i ], [ 0, %if.then11.i ]
  %90 = load ptr, ptr @MapUnitToSliceGroupMap, align 8, !tbaa !19
  %arrayidx.i = getelementptr inbounds i8, ptr %90, i64 %indvars.iv.i
  %91 = load i8, ptr %arrayidx.i, align 1, !tbaa !23
  %92 = load ptr, ptr @MBAmap, align 8, !tbaa !19
  %arrayidx16.i = getelementptr inbounds i8, ptr %92, i64 %indvars.iv.i
  store i8 %91, ptr %arrayidx16.i, align 1, !tbaa !23
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
  %93 = load i32, ptr %PicSizeInMbs.i, align 4, !tbaa !42
...
if.else.i:                                        ; preds = %lor.lhs.false.i
  ...
  %95 = load i32, ptr %mb_adaptive_frame_field_flag.i, align 4, !tbaa !49
  %tobool17.not.i = icmp eq i32 %95, 0
  %cmp3682.not.i = icmp eq i32 %87, 0
...
for.body25.i:                                     ; preds = %for.cond21.preheader.i, %for.body25.i
  ...
  %96 = load ptr, ptr @MapUnitToSliceGroupMap, align 8, !tbaa !19
  %div75.i = lshr i64 %indvars.iv87.i, 1
  %idxprom26.i = and i64 %div75.i, 2147483647
  %arrayidx27.i = getelementptr inbounds i8, ptr %96, i64 %idxprom26.i
  %97 = load i8, ptr %arrayidx27.i, align 1, !tbaa !23
  %98 = load ptr, ptr @MBAmap, align 8, !tbaa !19
  %arrayidx29.i = getelementptr inbounds i8, ptr %98, i64 %indvars.iv87.i
  store i8 %97, ptr %arrayidx29.i, align 1, !tbaa !23
  %indvars.iv.next88.i = add nuw nsw i64 %indvars.iv87.i, 1
  %99 = load i32, ptr %PicSizeInMbs.i, align 4, !tbaa !42
  %100 = zext i32 %99 to i64
  %cmp23.i = icmp ult i64 %indvars.iv.next88.i, %100
...
for.body38.i:                                     ; preds = %for.cond34.preheader.i, %for.body38.i
  ...
  %101 = load ptr, ptr @MapUnitToSliceGroupMap, align 8, !tbaa !19
  %102 = load i32, ptr %PicWidthInMbs.i, align 8, !tbaa !15
  %mul39.i = shl i32 %102, 1
  %103 = trunc i64 %indvars.iv90.i to i32
  %div40.i = udiv i32 %103, %mul39.i
  %mul42.i = mul i32 %div40.i, %102
  %rem.i = urem i32 %103, %102
  %add.i12 = add i32 %mul42.i, %rem.i
  %idxprom44.i = zext i32 %add.i12 to i64
  %arrayidx45.i = getelementptr inbounds i8, ptr %101, i64 %idxprom44.i
  %104 = load i8, ptr %arrayidx45.i, align 1, !tbaa !23
  %105 = load ptr, ptr @MBAmap, align 8, !tbaa !19
  %arrayidx47.i = getelementptr inbounds i8, ptr %105, i64 %indvars.iv90.i
  store i8 %104, ptr %arrayidx47.i, align 1, !tbaa !23
  %indvars.iv.next91.i = add nuw nsw i64 %indvars.iv90.i, 1
  %106 = load i32, ptr %PicSizeInMbs.i, align 4, !tbaa !42
  %107 = zext i32 %106 to i64
  %cmp36.i = icmp ult i64 %indvars.iv.next91.i, %107
...
while.end.split.loop.exit13:                      ; preds = %land.rhs
  ...
  %6 = icmp slt i32 %5, 1
  %7 = select i1 %6, i32 -1, i32 %indvars.le
  br label %while.end

while.end:                                        ; preds = %while.cond, %while.end.split.loop.exit13
  %CurrentMbNr.addr.0.in.lcssa = phi i32 [ %7, %while.end.split.loop.exit13 ], [ -1, %while.cond ]
  ret i32 %CurrentMbNr.addr.0.in.lcssa
}
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, argmem: read, inaccessiblemem: none) uwtable
define dso_local void @FmoSetLastMacroblockInSlice(i32 noundef %mb) local_unnamed_addr #3 {
entry:
  %0 = load ptr, ptr @MBAmap, align 8, !tbaa !19
...
define dso_local i32 @FmoGetFirstMacroblockInSlice(i32 noundef %SliceGroup) local_unnamed_addr #7 {
entry:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, argmem: none, inaccessiblemem: none) uwtable
define dso_local i32 @FmoSliceGroupCompletelyCoded(i32 noundef %SliceGroupID) local_unnamed_addr #7 {
entry:
