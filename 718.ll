; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/Burg/plank.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/Burg/plank.c"
...
entry:
  ...
  %op191 = getelementptr inbounds %struct.item_set, ptr %0, i64 0, i32 2
  %1 = load ptr, ptr %op191, align 8, !tbaa !21
  %2 = load ptr, ptr %1, align 8, !tbaa !53
  %3 = load ptr, ptr %t, align 8, !tbaa !5
  %op193 = getelementptr inbounds %struct.item_set, ptr %3, i64 0, i32 2
  %4 = load ptr, ptr %op193, align 8, !tbaa !21
  %5 = load ptr, ptr %4, align 8, !tbaa !53
  %call195 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %2, ptr noundef nonnull dereferenceable(1) %5) #12
...
if.end205:                                        ; preds = %entry
  ...
  %cmp207 = icmp slt i32 %6, %7
  br i1 %cmp207, label %cleanup, label %if.end210

if.end210:                                        ; preds = %if.end205
  %cmp213 = icmp sgt i32 %6, %7
  br i1 %cmp213, label %cleanup, label %if.end216
...
if.end216:                                        ; preds = %if.end210
  ...
  %newNum217 = getelementptr inbounds %struct.item_set, ptr %3, i64 0, i32 1
  %9 = load i32, ptr %newNum217, align 4, !tbaa !20
  %cmp218 = icmp slt i32 %8, %9
  br i1 %cmp218, label %cleanup, label %if.end221

if.end221:                                        ; preds = %if.end216
  %cmp224 = icmp sgt i32 %8, %9
  %. = zext i1 %cmp224 to i32
  br label %cleanup

cleanup:                                          ; preds = %if.end221, %if.end216, %if.end210, %if.end205, %entry
  %retval.0 = phi i32 [ %call195, %entry ], [ -1, %if.end205 ], [ 1, %if.end210 ], [ -1, %if.end216 ], [ %., %if.end221 ]
  ret i32 %retval.0
}
...
entry:
  ...
  %call162 = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %1, ptr noundef nonnull dereferenceable(1) %3) #12
  %cmp169.not = icmp eq i32 %call162, 0
  br i1 %cmp169.not, label %if.end172, label %cleanup

if.end172:                                        ; preds = %entry
  %erulenum = getelementptr inbounds %struct.ruleAST, ptr %0, i64 0, i32 2
  %4 = load i32, ptr %erulenum, align 8, !tbaa !55
  %erulenum173 = getelementptr inbounds %struct.ruleAST, ptr %2, i64 0, i32 2
  %5 = load i32, ptr %erulenum173, align 8, !tbaa !55
  %cmp174 = icmp slt i32 %4, %5
  br i1 %cmp174, label %cleanup, label %if.end177

if.end177:                                        ; preds = %if.end172
  %cmp180 = icmp sgt i32 %4, %5
  %. = zext i1 %cmp180 to i32
  br label %cleanup

cleanup:                                          ; preds = %if.end177, %if.end172, %entry
  %retval.0 = phi i32 [ %call162, %entry ], [ -1, %if.end172 ], [ %., %if.end177 ]
  ret i32 %retval.0
}
...
land.lhs.true.us.us:                              ; preds = %for.body2.us.us
  ...
  %or.cond.us.us = select i1 %cmp8.not.us.us, i1 true, i1 %cmp18.not.us.us
