; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/rpos.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/SPASS/rpos.c"
...
land.rhs:                                         ; preds = %land.rhs.preheader, %for.inc
  ...
  %call21 = tail call i32 @rpos_Equal(ptr noundef %l1.0.val44, ptr noundef %l2.0.val43)
...
for.inc:                                          ; preds = %land.rhs
  ...
  br i1 %cmp.i48.not, label %cleanup, label %land.rhs, !llvm.loop !7
...
for.body13.i:                                     ; preds = %for.cond7.i.preheader, %for.body13.i
  ...
  %call.i130 = tail call i32 @rpos_GreaterEqual(ptr noundef %scan.0.val39.i, ptr noundef %l2.0.val.i), !range !8
  ...
  br i1 %.not, label %for.cond7.i.for.inc18.i_crit_edge, label %for.body13.i, !llvm.loop !9
...
for.cond7.i.for.inc18.i_crit_edge:                ; preds = %for.body13.i
  ...
  br i1 %13, label %for.cond7.i.preheader, label %for.end20.i.loopexit, !llvm.loop !10
...
for.body.i:                                       ; preds = %if.end.i, %for.inc.i
  ...
  %call13.i = tail call i32 @rpos_GreaterEqual(ptr noundef %scan1.0.val107.i, ptr noundef %scan2.0.val106.i), !range !8
...
for.inc.i:                                        ; preds = %for.body.i
  ...
  br i1 %cmp.i183.not, label %if.end68.i, label %for.body.i, !llvm.loop !11
...
land.rhs.i:                                       ; preds = %for.cond28.i
  ...
  %call.i = tail call i32 @rpos_GreaterEqual(ptr noundef nonnull %T1, ptr noundef %scan2.1.val105.i), !range !8
  %cmp.i.i173.not = icmp eq i32 %call.i, 3
  br i1 %cmp.i.i173.not, label %for.cond28.i, label %if.end68.i, !llvm.loop !12
...
for.body56.i:                                     ; preds = %for.cond48.i.preheader, %for.body56.i
  ...
  %call58.i = tail call i32 @rpos_GreaterEqual(ptr noundef %scan1.1.val104.i, ptr noundef nonnull %T2), !range !8
  ...
  br i1 %or.cond, label %if.end68.i.loopexit, label %for.body56.i, !llvm.loop !13
...
for.body:                                         ; preds = %for.cond
  ...
  %call.i121 = tail call i32 @rpos_GreaterEqual(ptr noundef nonnull %T1, ptr noundef %scan.0.val93), !range !8
  %cmp.i191.not = icmp eq i32 %call.i121, 3
  br i1 %cmp.i191.not, label %for.cond, label %cleanup, !llvm.loop !14
...
for.body50:                                       ; preds = %for.cond46
  ...
  %call52 = tail call i32 @rpos_GreaterEqual(ptr noundef %scan.1.val92, ptr noundef nonnull %T2), !range !8
  %cmp.i125.not = icmp eq i32 %call52, 0
  br i1 %cmp.i125.not, label %for.cond46, label %cleanup, !llvm.loop !15
...
entry:
  %call = tail call i32 @rpos_GreaterEqual(ptr noundef %T1, ptr noundef %T2), !range !8
  %cmp.i.not = icmp eq i32 %call, 0
  br i1 %cmp.i.not, label %if.else, label %cleanup

if.else:                                          ; preds = %entry
  %call.i = tail call i32 @rpos_GreaterEqual(ptr noundef %T2, ptr noundef %T1), !range !8
...
; Function Attrs: nounwind uwtable
define dso_local i32 @rpos_ContEqual(ptr noundef %C1, ptr noundef %T1, ptr noundef %C2, ptr noundef %T2) local_unnamed_addr #0 {
entry:
...
land.rhs:                                         ; preds = %land.rhs.preheader, %for.inc
  ...
  %call23 = tail call i32 @rpos_ContEqual(ptr noundef %C1.addr.1, ptr noundef %l1.0.val48, ptr noundef %C2.addr.1, ptr noundef %l2.0.val47)
...
for.inc:                                          ; preds = %land.rhs
  ...
  br i1 %cmp.i71.not, label %cleanup, label %land.rhs, !llvm.loop !16
...
land.lhs.true:                                    ; preds = %for.body8
  ...
  %call12 = tail call i32 @rpos_ContEqual(ptr noundef %C1, ptr noundef nonnull %scan1.0.val28, ptr noundef %C2, ptr noundef %scan2.0.val26)
...
for.inc:                                          ; preds = %for.body8, %land.lhs.true
  ...
  br i1 %cmp.i29.not, label %for.inc15, label %for.body8, !llvm.loop !17

for.inc15:                                        ; preds = %for.inc, %if.then
  %scan2.0 = load ptr, ptr %scan2.036, align 8
  %cmp.i.not = icmp eq ptr %scan2.0, null
  br i1 %cmp.i.not, label %for.end17, label %for.cond4.preheader, !llvm.loop !18
...
land.lhs.true.i:                                  ; preds = %for.body8.i
  ...
  %call12.i164 = tail call i32 @rpos_ContEqual(ptr noundef %C1.addr.1, ptr noundef nonnull %scan1.0.val28.i, ptr noundef %C2.addr.1, ptr noundef %scan2.0.val26.i) #3
...
for.inc.i167:                                     ; preds = %land.lhs.true.i, %for.body8.i
  ...
  br i1 %cmp.i29.not.i, label %for.inc15.i, label %for.body8.i, !llvm.loop !17
...
for.inc15.i:                                      ; preds = %for.inc.i167, %if.then.i165
  ...
  br i1 %cmp.i.not.i169, label %rpos_ContMultisetDifference.exit, label %for.cond4.preheader.i, !llvm.loop !18
...
land.lhs.true.i315:                               ; preds = %for.body8.i312
  ...
  %call12.i = tail call i32 @rpos_ContEqual(ptr noundef %C2.addr.1, ptr noundef nonnull %scan1.0.val28.i310, ptr noundef %C1.addr.1, ptr noundef %scan2.0.val26.i313) #3
...
for.inc.i317:                                     ; preds = %land.lhs.true.i315, %for.body8.i312
  ...
  br i1 %cmp.i29.not.i316, label %for.inc15.i319, label %for.body8.i312, !llvm.loop !17
...
for.inc15.i319:                                   ; preds = %for.inc.i317, %if.then.i
  ...
  br i1 %cmp.i.not.i318, label %rpos_ContMultisetDifference.exit320, label %for.cond4.preheader.i308, !llvm.loop !18
...
for.body13.i:                                     ; preds = %for.cond7.i.preheader, %for.body13.i
  ...
  %call.i153 = tail call i32 @rpos_ContGreaterEqual(ptr noundef %C1.addr.1, ptr noundef %scan.0.val43.i, ptr noundef %C2.addr.1, ptr noundef %l2.0.val.i), !range !8
  ...
  br i1 %.not, label %for.cond7.i.for.inc18.i_crit_edge, label %for.body13.i, !llvm.loop !19
...
for.cond7.i.for.inc18.i_crit_edge:                ; preds = %for.body13.i
  ...
  br i1 %29, label %for.cond7.i.preheader, label %for.end20.i.loopexit, !llvm.loop !20
...
for.body.i:                                       ; preds = %if.end.i, %for.inc.i
  ...
  %call13.i = tail call i32 @rpos_ContGreaterEqual(ptr noundef %C1.addr.1, ptr noundef %scan1.0.val111.i, ptr noundef %C2.addr.1, ptr noundef %scan2.0.val110.i), !range !8
  switch i32 %call13.i, label %for.cond48.i.preheader [
    i32 2, label %for.inc.i
    i32 3, label %for.cond28.i
  ]
...
for.inc.i:                                        ; preds = %for.body.i
  ...
  br i1 %cmp.i213.not, label %if.end68.i, label %for.body.i, !llvm.loop !21
...
land.rhs.i137:                                    ; preds = %for.cond28.i
  ...
  %call.i = tail call i32 @rpos_ContGreaterEqual(ptr noundef %C1.addr.1, ptr noundef nonnull %Term.addr.0.lcssa.i, ptr noundef %C2.addr.1, ptr noundef %scan2.1.val109.i), !range !8
  %cmp.i.i203.not = icmp eq i32 %call.i, 3
  br i1 %cmp.i.i203.not, label %for.cond28.i, label %if.end68.i, !llvm.loop !22
...
for.body56.i:                                     ; preds = %for.cond48.i.preheader, %for.body56.i
  ...
  %call58.i = tail call i32 @rpos_ContGreaterEqual(ptr noundef %C1.addr.1, ptr noundef %scan1.1.val108.i, ptr noundef %C2.addr.1, ptr noundef nonnull %Term.addr.0.lcssa.i116), !range !8
  ...
  br i1 %or.cond, label %if.end68.i.loopexit, label %for.body56.i, !llvm.loop !23
...
for.body:                                         ; preds = %for.cond
  ...
  %call.i142 = tail call i32 @rpos_ContGreaterEqual(ptr noundef %C1.addr.1, ptr noundef nonnull %Term.addr.0.lcssa.i, ptr noundef %C2.addr.1, ptr noundef %scan.0.val97), !range !8
  %cmp.i221.not = icmp eq i32 %call.i142, 3
  br i1 %cmp.i221.not, label %for.cond, label %cleanup, !llvm.loop !24
...
for.body52:                                       ; preds = %for.cond48
  ...
  %call54 = tail call i32 @rpos_ContGreaterEqual(ptr noundef %C1.addr.1, ptr noundef %scan.1.val96, ptr noundef %C2.addr.1, ptr noundef nonnull %Term.addr.0.lcssa.i116), !range !8
  %cmp.i146.not = icmp eq i32 %call54, 0
  br i1 %cmp.i146.not, label %for.cond48, label %cleanup, !llvm.loop !25
...
cont_Deref.exit31:                                ; preds = %while.body.i25, %cleanup.i29, %while.body.i25.preheader, %land.rhs.i21.preheader, %cont_Deref.exit
  ...
  %call2 = tail call i32 @rpos_ContGreaterEqual(ptr noundef %C1.addr.1, ptr noundef nonnull %Term.addr.0.lcssa.i, ptr noundef %C2.addr.1, ptr noundef nonnull %Term.addr.0.lcssa.i30), !range !8
  %cmp.i.not = icmp eq i32 %call2, 0
  br i1 %cmp.i.not, label %if.else, label %cleanup

if.else:                                          ; preds = %cont_Deref.exit31
  %call.i = tail call i32 @rpos_ContGreaterEqual(ptr noundef %C2.addr.1, ptr noundef nonnull %Term.addr.0.lcssa.i30, ptr noundef %C1.addr.1, ptr noundef nonnull %Term.addr.0.lcssa.i), !range !8
  %cmp.i.i.not = icmp eq i32 %call.i, 3
  %spec.select = zext i1 %cmp.i.i.not to i32
  br label %cleanup
