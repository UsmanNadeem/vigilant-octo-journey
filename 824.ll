; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/savewolf.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C/TimberWolfMC/savewolf.c"
...
entry:
  ...
  %call2 = call ptr @fopen(ptr noundef nonnull %filename, ptr noundef nonnull @.str.1)
...
for.body:                                         ; preds = %for.body.lr.ph, %for.inc26
  %indvars.iv1470 = phi i64 [ 1, %for.body.lr.ph ], [ %indvars.iv.next1471, %for.inc26 ]
  %cmp5 = icmp eq i64 %indvars.iv1470, 1
...
if.end:                                           ; preds = %if.end.loopexit.unr-lcssa, %for.body8.epil, %for.cond6.preheader, %for.body
  ...
  %site14 = getelementptr inbounds %struct.uncombox, ptr %14, i64 %indvars.iv1470, i32 1
  ...
  %cmp21 = icmp eq i64 %indvars.iv1470, %19
...
for.inc26:                                        ; preds = %if.end, %if.then22
  ...
  %cmp4.not.not = icmp slt i64 %indvars.iv1470, %22
...
for.body74.preheader:                             ; preds = %if.then40, %if.else
  ...
  %cond = add nsw i32 %add52, %conv46
  %div54.neg1465 = sdiv i32 %cond, -2
  ...
  %cond69 = add nsw i32 %add65, %conv58
  %div70.neg1466 = sdiv i32 %cond69, -2
  %37 = insertelement <2 x i32> poison, i32 %div70.neg1466, i64 0
  ...
  %41 = insertelement <2 x double> poison, double %call41, i64 0
  %42 = shufflevector <2 x double> %41, <2 x double> poison, <2 x i32> zeroinitializer
  %43 = insertelement <2 x i32> poison, i32 %div54.neg1465, i64 0
...
for.body74:                                       ; preds = %for.body74.preheader, %for.body74
  ...
  %48 = sub nsw <2 x i32> %47, %40
  %49 = sitofp <2 x i32> %48 to <2 x double>
  %50 = fdiv <2 x double> %49, %42
  ...
  %56 = add <2 x i32> %38, %51
  %57 = add <2 x i32> %56, %55
  ...
  %59 = sub nsw <2 x i32> %58, %46
  %60 = sitofp <2 x i32> %59 to <2 x double>
  %61 = fmul <2 x double> %42, %60
  ...
  %67 = add <2 x i32> %44, %62
  %68 = add <2 x i32> %67, %66
...
for.body148:                                      ; preds = %for.cond145.preheader, %for.body148
  ...
  %cond163 = add i32 %div70.neg1466, %conv152
  %sub164 = add i32 %cond163, %add159
  ...
  %cond180 = add i32 %div54.neg1465, %conv169
  %sub181 = add i32 %cond180, %add176
...
for.body189:                                      ; preds = %for.cond185.preheader, %for.body189
  ...
  %cond207 = add i32 %div70.neg1466, %conv196
  %sub208 = add i32 %cond207, %add203
  %arrayidx210 = getelementptr inbounds %struct.locbox, ptr %32, i64 %idxprom190
  store i32 %sub208, ptr %arrayidx210, align 4, !tbaa !55
  ...
  %cond229 = add i32 %div54.neg1465, %conv218
  %sub230 = add i32 %cond229, %add225
...
sw.epilog:                                        ; preds = %if.then239.sw.epilog_crit_edge, %sw.bb251, %sw.bb250, %sw.bb249, %sw.bb248, %sw.bb247, %sw.bb246, %sw.bb
  %82 = phi i32 [ %.pre1476, %if.then239.sw.epilog_crit_edge ], [ 6, %sw.bb251 ], [ 7, %sw.bb250 ], [ 5, %sw.bb249 ], [ 4, %sw.bb248 ], [ 3, %sw.bb247 ], [ 2, %sw.bb246 ], [ 1, %sw.bb ]
...
land.lhs.true268:                                 ; preds = %sw.epilog
  %85 = load i32, ptr %orient, align 4, !tbaa !9
  %86 = and i32 %85, -3
...
land.lhs.true277:                                 ; preds = %lor.lhs.false273
  %88 = load i32, ptr %orient, align 4, !tbaa !9
  %89 = and i32 %88, -2
...
land.lhs.true292:                                 ; preds = %if.end288
  %92 = load i32, ptr %orient, align 4, !tbaa !9
  %93 = and i32 %92, -3
...
land.lhs.true302:                                 ; preds = %lor.lhs.false298
  %95 = load i32, ptr %orient, align 4, !tbaa !9
...
land.lhs.true335:                                 ; preds = %for.body317
  %104 = load i32, ptr %orient, align 4, !tbaa !9
  %105 = and i32 %104, -3
...
land.lhs.true345:                                 ; preds = %lor.lhs.false341
  %106 = load i32, ptr %orient, align 4, !tbaa !9
  %107 = and i32 %106, -2
...
land.lhs.true360:                                 ; preds = %if.end356
  %110 = load i32, ptr %orient, align 4, !tbaa !9
  %111 = and i32 %110, -3
...
land.lhs.true370:                                 ; preds = %lor.lhs.false366
  %112 = load i32, ptr %orient, align 4, !tbaa !9
...
land.lhs.true400:                                 ; preds = %if.then387
  %121 = load i32, ptr %orient, align 4, !tbaa !9
  %122 = and i32 %121, -3
...
land.lhs.true410:                                 ; preds = %lor.lhs.false406
  %124 = load i32, ptr %orient, align 4, !tbaa !9
  %125 = and i32 %124, -2
...
land.lhs.true423:                                 ; preds = %if.end419
  %127 = load i32, ptr %orient, align 4, !tbaa !9
  %128 = and i32 %127, -3
...
land.lhs.true433:                                 ; preds = %lor.lhs.false429
  %130 = load i32, ptr %orient, align 4, !tbaa !9
...
land.lhs.true459:                                 ; preds = %for.body447
  %138 = load i32, ptr %orient, align 4, !tbaa !9
  %139 = and i32 %138, -3
...
land.lhs.true469:                                 ; preds = %lor.lhs.false465
  %140 = load i32, ptr %orient, align 4, !tbaa !9
  %141 = and i32 %140, -2
...
land.lhs.true482:                                 ; preds = %if.end478
  %143 = load i32, ptr %orient, align 4, !tbaa !9
  %144 = and i32 %143, -3
...
land.lhs.true492:                                 ; preds = %lor.lhs.false488
  %145 = load i32, ptr %orient, align 4, !tbaa !9
...
land.lhs.true539:                                 ; preds = %for.body517
  %157 = load i32, ptr %orient, align 4, !tbaa !9
  %158 = and i32 %157, -3
...
land.lhs.true549:                                 ; preds = %lor.lhs.false545
  %159 = load i32, ptr %orient, align 4, !tbaa !9
  %160 = and i32 %159, -2
...
land.lhs.true564:                                 ; preds = %if.end560
  %163 = load i32, ptr %orient, align 4, !tbaa !9
  %164 = and i32 %163, -3
...
land.lhs.true574:                                 ; preds = %lor.lhs.false570
  %165 = load i32, ptr %orient, align 4, !tbaa !9
...
land.lhs.true633:                                 ; preds = %if.end612
  %180 = load i32, ptr %orient, align 4, !tbaa !9
  %181 = and i32 %180, -3
...
land.lhs.true643:                                 ; preds = %lor.lhs.false639
  %182 = load i32, ptr %orient, align 4, !tbaa !9
  %183 = and i32 %182, -2
...
land.lhs.true658:                                 ; preds = %if.end654
  %186 = load i32, ptr %orient, align 4, !tbaa !9
  %187 = and i32 %186, -3
...
land.lhs.true668:                                 ; preds = %lor.lhs.false664
  %188 = load i32, ptr %orient, align 4, !tbaa !9
...
land.lhs.true702:                                 ; preds = %for.body684
  %196 = load i32, ptr %orient, align 4, !tbaa !9
  %197 = and i32 %196, -3
...
land.lhs.true712:                                 ; preds = %lor.lhs.false708
  %198 = load i32, ptr %orient, align 4, !tbaa !9
  %199 = and i32 %198, -2
...
land.lhs.true727:                                 ; preds = %if.end723
  %202 = load i32, ptr %orient, align 4, !tbaa !9
  %203 = and i32 %202, -3
...
land.lhs.true737:                                 ; preds = %lor.lhs.false733
  %204 = load i32, ptr %orient, align 4, !tbaa !9
...
land.lhs.true783:                                 ; preds = %if.end766
  %215 = load i32, ptr %orient, align 4, !tbaa !9
  %216 = and i32 %215, -3
...
land.lhs.true793:                                 ; preds = %lor.lhs.false789
  %217 = load i32, ptr %orient, align 4, !tbaa !9
  %218 = and i32 %217, -2
...
land.lhs.true806:                                 ; preds = %if.end802
  %220 = load i32, ptr %orient, align 4, !tbaa !9
  %221 = and i32 %220, -3
...
land.lhs.true816:                                 ; preds = %lor.lhs.false812
  %222 = load i32, ptr %orient, align 4, !tbaa !9
...
for.body830.us.preheader:                         ; preds = %for.body830.lr.ph.split.us
  %.pre1478 = load i32, ptr %orient, align 4, !tbaa !9
...
for.body830.us:                                   ; preds = %for.body830.us.preheader, %for.inc885.us
  %230 = phi i32 [ %234, %for.inc885.us ], [ %.pre1478, %for.body830.us.preheader ]
  ...
  %234 = load i32, ptr %orient, align 4, !tbaa !9
  %235 = and i32 %234, -2
...
for.body830:                                      ; preds = %for.body830.preheader, %for.inc885
  %239 = phi i32 [ %243, %for.inc885 ], [ %.pre1477, %for.body830.preheader ]
  ...
  %243 = load i32, ptr %orient, align 4, !tbaa !9
  %244 = and i32 %243, -3
...
lor.lhs.false848:                                 ; preds = %for.body830
  br i1 %cmp641.not, label %if.end861.thread1481, label %land.lhs.true852
...
if.end861.thread1481:                             ; preds = %lor.lhs.false848
  %or.cond10851482 = icmp eq i32 %244, 1
  br i1 %or.cond10851482, label %if.then881, label %for.inc885

if.end861.thread:                                 ; preds = %land.lhs.true852
  %or.cond10851480 = icmp eq i32 %244, 1
  br i1 %or.cond10851480, label %if.then881, label %land.lhs.true875

lor.lhs.false871:                                 ; preds = %for.body830
  %247 = load i32, ptr %xpos834, align 8, !tbaa !48
  %inc8601485 = add nsw i32 %247, 1
  store i32 %inc8601485, ptr %xpos834, align 8, !tbaa !48
...
if.then881:                                       ; preds = %if.end861.thread1481, %if.end861.thread, %land.lhs.true875, %land.lhs.true875, %if.end861
  %248 = load i32, ptr %ypos836, align 4, !tbaa !50
  %inc883 = add nsw i32 %248, 1
  store i32 %inc883, ptr %ypos836, align 4, !tbaa !50
  br label %for.inc885

for.inc885:                                       ; preds = %if.end861.thread1481, %land.lhs.true875, %lor.lhs.false871, %if.then881
...
land.lhs.true937:                                 ; preds = %for.body915
  %262 = load i32, ptr %orient, align 4, !tbaa !9
  %263 = and i32 %262, -3
...
land.lhs.true947:                                 ; preds = %lor.lhs.false943
  %264 = load i32, ptr %orient, align 4, !tbaa !9
  %265 = and i32 %264, -2
...
land.lhs.true962:                                 ; preds = %if.end958
  %268 = load i32, ptr %orient, align 4, !tbaa !9
  %269 = and i32 %268, -3
...
land.lhs.true972:                                 ; preds = %lor.lhs.false968
  %270 = load i32, ptr %orient, align 4, !tbaa !9
...
for.inc987.loopexit:                              ; preds = %for.inc984
  %.pre1479 = load i32, ptr %orient, align 4, !tbaa !9
  br label %for.inc987

for.inc987:                                       ; preds = %for.inc987.loopexit, %if.end906, %for.body902
  %275 = phi i32 [ %.pre1479, %for.inc987.loopexit ], [ %storemerge14211457, %if.end906 ], [ %3, %for.body902 ]
...
for.body1018.lr.ph:                               ; preds = %for.cond1014.preheader
  ...
  %288 = insertelement <2 x i32> poison, i32 %285, i64 0
  %289 = insertelement <2 x i32> %288, i32 %286, i64 1
  %xtraiter1494 = and i64 %287, 1
  %290 = icmp eq i32 %281, 1
  br i1 %290, label %for.end1051.loopexit.unr-lcssa, label %for.body1018.lr.ph.new

for.body1018.lr.ph.new:                           ; preds = %for.body1018.lr.ph
  %unroll_iter1497 = and i64 %287, -2
...
for.body999:                                      ; preds = %for.body999.lr.ph, %for.body999
  ...
  %291 = load i32, ptr %xpos1000, align 8, !tbaa !48
  %ypos1001 = getelementptr inbounds %struct.termbox, ptr %term.01460, i64 0, i32 2
  %292 = load i32, ptr %ypos1001, align 4, !tbaa !50
  %terminal1002 = getelementptr inbounds %struct.termbox, ptr %term.01460, i64 0, i32 5
  %293 = load i32, ptr %terminal1002, align 8, !tbaa !74
  %idxprom1003 = sext i32 %293 to i64
  %arrayidx1004 = getelementptr inbounds ptr, ptr %278, i64 %idxprom1003
  %294 = load ptr, ptr %arrayidx1004, align 8, !tbaa !5
  %add1005 = add nsw i32 %279, %291
  %termptr1006 = getelementptr inbounds %struct.termnets, ptr %294, i64 0, i32 1
  %295 = load ptr, ptr %termptr1006, align 8, !tbaa !75
  %xpos1007 = getelementptr inbounds %struct.netbox, ptr %295, i64 0, i32 1
  store i32 %add1005, ptr %xpos1007, align 8, !tbaa !77
  %add1008 = add nsw i32 %280, %292
  %ypos1010 = getelementptr inbounds %struct.netbox, ptr %295, i64 0, i32 2
...
for.body1018:                                     ; preds = %for.body1018, %for.body1018.lr.ph.new
  %indvars.iv1473 = phi i64 [ 1, %for.body1018.lr.ph.new ], [ %indvars.iv.next1474.1, %for.body1018 ]
  %niter1498 = phi i64 [ 0, %for.body1018.lr.ph.new ], [ %niter1498.next.1, %for.body1018 ]
  %arrayidx1021 = getelementptr inbounds %struct.uncombox, ptr %282, i64 %indvars.iv1473
  %296 = load i32, ptr %arrayidx1021, align 4, !tbaa !81
  %site1026 = getelementptr inbounds %struct.uncombox, ptr %282, i64 %indvars.iv1473, i32 1
  %297 = load i32, ptr %site1026, align 4, !tbaa !18
  store i32 %297, ptr %site, align 4, !tbaa !9
  %idxprom1031 = sext i32 %297 to i64
  %arrayidx1032 = getelementptr inbounds %struct.locbox, ptr %283, i64 %idxprom1031
  %idxprom1041 = sext i32 %296 to i64
  %arrayidx1042 = getelementptr inbounds ptr, ptr %284, i64 %idxprom1041
  %298 = load ptr, ptr %arrayidx1042, align 8, !tbaa !5
  %termptr1044 = getelementptr inbounds %struct.termnets, ptr %298, i64 0, i32 1
  %299 = load ptr, ptr %termptr1044, align 8, !tbaa !75
  %xpos1045 = getelementptr inbounds %struct.netbox, ptr %299, i64 0, i32 1
  %300 = load <2 x i32>, ptr %arrayidx1032, align 4, !tbaa !9
  %301 = add nsw <2 x i32> %289, %300
  store <2 x i32> %301, ptr %xpos1045, align 8, !tbaa !9
  %indvars.iv.next1474 = add nuw nsw i64 %indvars.iv1473, 1
  %arrayidx1021.1 = getelementptr inbounds %struct.uncombox, ptr %282, i64 %indvars.iv.next1474
  %302 = load i32, ptr %arrayidx1021.1, align 4, !tbaa !81
  %site1026.1 = getelementptr inbounds %struct.uncombox, ptr %282, i64 %indvars.iv.next1474, i32 1
  %303 = load i32, ptr %site1026.1, align 4, !tbaa !18
  store i32 %303, ptr %site, align 4, !tbaa !9
  %idxprom1031.1 = sext i32 %303 to i64
  %arrayidx1032.1 = getelementptr inbounds %struct.locbox, ptr %283, i64 %idxprom1031.1
  %idxprom1041.1 = sext i32 %302 to i64
  %arrayidx1042.1 = getelementptr inbounds ptr, ptr %284, i64 %idxprom1041.1
  %304 = load ptr, ptr %arrayidx1042.1, align 8, !tbaa !5
  %termptr1044.1 = getelementptr inbounds %struct.termnets, ptr %304, i64 0, i32 1
  %305 = load ptr, ptr %termptr1044.1, align 8, !tbaa !75
  %xpos1045.1 = getelementptr inbounds %struct.netbox, ptr %305, i64 0, i32 1
  %306 = load <2 x i32>, ptr %arrayidx1032.1, align 4, !tbaa !9
  %307 = add nsw <2 x i32> %289, %306
  store <2 x i32> %307, ptr %xpos1045.1, align 8, !tbaa !9
  %indvars.iv.next1474.1 = add nuw nsw i64 %indvars.iv1473, 2
  %niter1498.next.1 = add i64 %niter1498, 2
  %niter1498.ncmp.1.not = icmp eq i64 %niter1498.next.1, %unroll_iter1497
  br i1 %niter1498.ncmp.1.not, label %for.end1051.loopexit.unr-lcssa, label %for.body1018, !llvm.loop !82

for.end1051.loopexit.unr-lcssa:                   ; preds = %for.body1018, %for.body1018.lr.ph
  %indvars.iv1473.unr = phi i64 [ 1, %for.body1018.lr.ph ], [ %indvars.iv.next1474.1, %for.body1018 ]
  %lcmp.mod1496.not = icmp eq i64 %xtraiter1494, 0
  br i1 %lcmp.mod1496.not, label %for.end1051, label %for.body1018.epil

for.body1018.epil:                                ; preds = %for.end1051.loopexit.unr-lcssa
  %arrayidx1021.epil = getelementptr inbounds %struct.uncombox, ptr %282, i64 %indvars.iv1473.unr
  %308 = load i32, ptr %arrayidx1021.epil, align 4, !tbaa !81
  %site1026.epil = getelementptr inbounds %struct.uncombox, ptr %282, i64 %indvars.iv1473.unr, i32 1
  %309 = load i32, ptr %site1026.epil, align 4, !tbaa !18
  store i32 %309, ptr %site, align 4, !tbaa !9
  %idxprom1031.epil = sext i32 %309 to i64
  %arrayidx1032.epil = getelementptr inbounds %struct.locbox, ptr %283, i64 %idxprom1031.epil
  %idxprom1041.epil = sext i32 %308 to i64
  %arrayidx1042.epil = getelementptr inbounds ptr, ptr %284, i64 %idxprom1041.epil
  %310 = load ptr, ptr %arrayidx1042.epil, align 8, !tbaa !5
  %termptr1044.epil = getelementptr inbounds %struct.termnets, ptr %310, i64 0, i32 1
  %311 = load ptr, ptr %termptr1044.epil, align 8, !tbaa !75
  %xpos1045.epil = getelementptr inbounds %struct.netbox, ptr %311, i64 0, i32 1
  %312 = load <2 x i32>, ptr %arrayidx1032.epil, align 4, !tbaa !9
  %313 = add nsw <2 x i32> %289, %312
  store <2 x i32> %313, ptr %xpos1045.epil, align 8, !tbaa !9
  br label %for.end1051

for.end1051:                                      ; preds = %for.body1018.epil, %for.end1051.loopexit.unr-lcssa, %for.cond1014.preheader
