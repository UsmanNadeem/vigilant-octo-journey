; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z50.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-typeset/z50.c"
...
land.lhs.true66:                                  ; preds = %while.cond61.preheader, %while.body74
  ...
  %or.cond270 = select i1 %cmp69.not, i1 true, i1 %cmp72.not
...
if.end202:                                        ; preds = %for.end
  %idxprom161.le = and i64 %indvars.iv, 4294967295
  ...
  %arrayidx198 = getelementptr inbounds i8, ptr %50, i64 %idxprom161.le
