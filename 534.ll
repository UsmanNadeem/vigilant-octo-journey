; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/ldecod/vlc.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/ldecod/vlc.c"
...
define dso_local i32 @readSyntaxElement_Intra4x4PredictionMode(ptr nocapture noundef %sym, ptr nocapture noundef readnone %img, ptr nocapture noundef readonly %dP) local_unnamed_addr #8 {
entry:
  %0 = load ptr, ptr %dP, align 8, !tbaa !28
...
; Function Attrs: nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable
define dso_local i32 @GetVLCSymbol_IntraMode(ptr nocapture noundef readonly %buffer, i32 noundef %totbitoffset, ptr nocapture noundef writeonly %info, i32 noundef %bytecount) local_unnamed_addr #7 {
entry:
  %shr = ashr i32 %totbitoffset, 3
  %conv = sext i32 %shr to i64
  %and = and i32 %totbitoffset, 7
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local i32 @code_from_bitstream_2d(ptr nocapture noundef writeonly %sym, ptr nocapture noundef readonly %dP, ptr nocapture noundef readonly %lentab, ptr nocapture noundef readonly %codtab, i32 noundef %tabwidth, i32 noundef %tabheight, ptr nocapture noundef writeonly %code) local_unnamed_addr #4 {
entry:
  %0 = load ptr, ptr %dP, align 8, !tbaa !28
  %frame_bitoffset1 = getelementptr inbounds %struct.Bitstream, ptr %0, i64 0, i32 2
  %1 = load i32, ptr %frame_bitoffset1, align 8, !tbaa !5
...
if.then.i.1:                                      ; preds = %if.end11.i
  %cmp8.not.i.1 = icmp slt i32 %shr.i, %3
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local i32 @readSyntaxElement_Level_VLC0(ptr nocapture noundef writeonly %sym, ptr nocapture noundef readonly %dP) local_unnamed_addr #4 {
entry:
  %0 = load ptr, ptr %dP, align 8, !tbaa !28
  %frame_bitoffset1 = getelementptr inbounds %struct.Bitstream, ptr %0, i64 0, i32 2
  %1 = load i32, ptr %frame_bitoffset1, align 8, !tbaa !5
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none) uwtable
define dso_local i32 @readSyntaxElement_Level_VLCN(ptr nocapture noundef writeonly %sym, i32 noundef %vlc, ptr nocapture noundef readonly %dP) local_unnamed_addr #4 {
entry:
  %0 = load ptr, ptr %dP, align 8, !tbaa !28
  %frame_bitoffset1 = getelementptr inbounds %struct.Bitstream, ptr %0, i64 0, i32 2
  %1 = load i32, ptr %frame_bitoffset1, align 8, !tbaa !5
