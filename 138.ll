...
if.end20:                                         ; preds = %if.then11, %if.else13
  ...
  %op.rdx2672 = or i24 %bf.shl60, %bf.shl66
  %op.rdx = or i24 %bf.set55, %op.rdx2672
  %op.rdx2673 = or i24 %op.rdx, 2097168
  ...
  store i24 %op.rdx2673, ptr %ohas_body, align 1
...
if.end119:                                        ; preds = %if.then107, %land.lhs.true, %if.end20
  ...
  %bf.load121 = phi i24 [ %bf.set118, %if.then107 ], [ %op.rdx2673, %land.lhs.true ], [ %op.rdx2673, %if.end20 ]
...
while.body.preheader:                             ; preds = %if.end1661
  ...
  br i1 %min.iters.check, label %while.body.preheader2676, label %vector.ph
...
vector.ph:                                        ; preds = %while.body.preheader
  ...
  %next.gep2674 = getelementptr i8, ptr %str, i64 1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %66 = getelementptr i8, ptr %next.gep2674, i64 %index
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %while.end, label %while.body.preheader2676

while.body.preheader2676:                         ; preds = %while.body.preheader, %middle.block
...
while.body:                                       ; preds = %while.body.preheader2676, %while.body
  %dec2638 = phi i32 [ %dec, %while.body ], [ %dec2638.ph, %while.body.preheader2676 ]
  %sum.02637 = phi i32 [ %add1668, %while.body ], [ %sum.02637.ph, %while.body.preheader2676 ]
  %str.pn2636 = phi ptr [ %x.0, %while.body ], [ %str.pn2636.ph, %while.body.preheader2676 ]
