; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-jpeg/wrtarga.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MiBench/consumer-jpeg/wrtarga.c"
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  %call = tail call i32 @_IO_putc(i32 noundef %conv, ptr noundef %18)
  ...
  %call25 = tail call i32 @_IO_putc(i32 noundef %conv24, ptr noundef %18)
  ...
  %call31 = tail call i32 @_IO_putc(i32 noundef %conv30, ptr noundef %18)
