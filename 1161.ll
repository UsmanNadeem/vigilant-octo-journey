; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/C/XzEnc.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/7zip/C/XzEnc.c"
...
if.end15.i:                                       ; preds = %if.then14.i, %cleanup.cont9.i
  ...
  %call28.i = call i32 @XzBlock_WriteHeader(ptr noundef nonnull %block.i, ptr noundef nonnull %seqSizeOutStream.i)
...
cleanup.cont35.i:                                 ; preds = %if.end15.i
  store ptr @SeqCheckInStream_Read, ptr %checkInStream.i, align 8, !tbaa !45
  %realStream37.i = getelementptr inbounds %struct.CSeqCheckInStream, ptr %checkInStream.i, i64 0, i32 1
  store ptr %inStream, ptr %realStream37.i, align 8, !tbaa !46
...
cleanup.cont52.i:                                 ; preds = %cleanup.cont35.i
  ...
  %and63159163.i = and i64 %sub55.i, 3
  %cmp64.not160.i = icmp eq i64 %and63159163.i, 0
...
while.end.i:                                      ; preds = %while.body.preheader.i, %cleanup.cont52.i
  %padSize.0.lcssa.i = phi i32 [ 0, %cleanup.cont52.i ], [ %15, %while.body.preheader.i ]
  ...
  %16 = load i16, ptr %xz, align 8, !tbaa !33
  %call73.i = call i32 @XzFlags_GetCheckSize(i16 noundef zeroext %16) #5
  %add74.i = add i32 %call73.i, %padSize.0.lcssa.i
  %17 = load ptr, ptr %seqSizeOutStream.i, align 8, !tbaa !10
  %conv.i.i = zext i32 %add74.i to i64
  %call.i150.i = call i64 %17(ptr noundef nonnull %seqSizeOutStream.i, ptr noundef nonnull %buf.i, i64 noundef %conv.i.i) #5
...
cleanup.cont82.i:                                 ; preds = %while.end.i
  %18 = load i64, ptr %processed.i, align 8, !tbaa !44
  %sub87.i = sub i64 %18, %idx.ext.i
  %blocks.i = getelementptr inbounds %struct.CXzStream, ptr %xz, i64 0, i32 3
  %19 = load ptr, ptr %blocks.i, align 8, !tbaa !28
  %cmp.i5 = icmp eq ptr %19, null
...
if.end.i:                                         ; preds = %if.then.i6
  ...
  %23 = load ptr, ptr @g_Alloc, align 8, !tbaa !35
  %call.i7 = call ptr %23(ptr noundef nonnull @g_Alloc, i64 noundef %mul3.i) #5
  %cmp7.i = icmp eq ptr %call.i7, null
  br i1 %cmp7.i, label %cleanup100.thread155.i, label %if.end9.i

if.end9.i:                                        ; preds = %if.end.i
  %24 = load i64, ptr %numBlocks2.i, align 8, !tbaa !24
  %cmp11.not.i = icmp eq i64 %24, 0
  br i1 %cmp11.not.i, label %cleanup.i, label %if.then12.i

if.then12.i:                                      ; preds = %if.end9.i
  %25 = load ptr, ptr %blocks.i, align 8, !tbaa !28
  %mul15.i = shl i64 %24, 4
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %call.i7, ptr align 8 %25, i64 %mul15.i, i1 false)
...
cleanup.cont105.i:                                ; preds = %cleanup.i, %lor.lhs.false.i
  %26 = phi i64 [ %.pre48.i, %cleanup.i ], [ %21, %lor.lhs.false.i ]
  %27 = phi ptr [ %call.i7, %cleanup.i ], [ %19, %lor.lhs.false.i ]
  ...
  %arrayidx.i = getelementptr inbounds %struct.CXzBlockSizes, ptr %27, i64 %26
  %totalSize24.i = getelementptr inbounds %struct.CXzBlockSizes, ptr %27, i64 %26, i32 1
  ...
  call void @llvm.lifetime.end.p0(i64 24, ptr nonnull %seqSizeOutStream.i) #5
  call void @llvm.lifetime.end.p0(i64 144, ptr nonnull %checkInStream.i) #5
  %call106.i = call i32 @Xz_WriteFooter(ptr noundef nonnull %xz, ptr noundef nonnull %outStream)
  br label %if.then.i
...
Lzma2WithFilters_Free.exit:                       ; preds = %entry, %if.then.i
  %res.015 = phi i32 [ %res.0.ph, %if.then.i ], [ 2, %entry ]
  call void @Xz_Free(ptr noundef nonnull %xz, ptr noundef nonnull @g_Alloc) #5
...
if.then:                                          ; preds = %entry
  %call1 = call i32 @Xz_WriteFooter(ptr noundef nonnull %xz, ptr noundef nonnull %outStream)
  br label %if.end
...
entry:
  ...
  %0 = load ptr, ptr %realStream, align 8, !tbaa !46
  %1 = load ptr, ptr %0, align 8, !tbaa !10
