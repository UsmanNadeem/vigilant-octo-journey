; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/loopFilter.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/JM/lencod/loopFilter.c"
...
entry:
  ...
  %1 = load i32, ptr %mb_y, align 4, !tbaa !23
...
if.end104:                                        ; preds = %if.end87, %if.then93, %for.end
  %or.cond170 = select i1 %tobool105, i1 true, i1 %tobool58
