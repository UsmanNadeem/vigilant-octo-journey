; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zgeneric.c'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/MallocBench/gs/zgeneric.c"
...
if.end.i:                                         ; preds = %sw.bb22
  ...
  %or.cond.i = select i1 %tobool.not.not.i, i1 true, i1 %tobool15.not.not.i
...
if.end:                                           ; preds = %entry
  ...
  %or.cond = select i1 %tobool.not.not, i1 true, i1 %tobool15.not.not
