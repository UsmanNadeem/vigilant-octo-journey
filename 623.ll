; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/kimwitu++/occur.cc'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/kimwitu++/occur.cc"
...
@.str.1 = private unnamed_addr constant [96 x i8] c"/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Applications/kimwitu++/occur.cc\00", align 1
...
if.else15:                                        ; preds = %if.else
  ...
  %7 = getelementptr i8, ptr %id, i64 32
  %id.val26 = load ptr, ptr %7, align 8, !tbaa !20
