; ModuleID = '/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C++/life/life.cpp'
source_filename = "/local/mnt2/workspace2/mnadeem/llvm/llvm-test-suite/MultiSource/Benchmarks/Prolangs-C++/life/life.cpp"
...
define dso_local noundef nonnull ptr @_ZN5grass4nextEPA40_P6living(ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) %this, ptr nocapture noundef readonly %w) unnamed_addr #2 align 2 personality ptr @__gxx_personality_v0 {
entry:
...
; Function Attrs: uwtable
define dso_local noundef nonnull ptr @_ZN5empty4nextEPA40_P6living(ptr nocapture noundef nonnull readonly align 8 dereferenceable(16) %this, ptr nocapture noundef readonly %w) unnamed_addr #2 align 2 personality ptr @__gxx_personality_v0 {
entry:
  %sum = alloca [4 x i32], align 16
  call void @llvm.lifetime.start.p0(i64 16, ptr nonnull %sum) #8
  call void @_ZN6living4sumsEPA40_PS_Pi(ptr noundef nonnull align 8 dereferenceable(16) %this, ptr noundef %w, ptr noundef nonnull %sum)
